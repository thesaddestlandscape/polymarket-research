...
# _capital_ajeno_en_wallet_compartida() (27-Ago) eliminada 03-Sep noche:
# restaba bankroll_actual()+stakes_abiertos_total() (coste) de AMBOS
# free_usdc y total, contando el stake abierto dos veces y usando coste en
# vez de valor de mercado -- bug real, ~3-4€ de más restados a cripto sin
# ningún trade de cripto de por medio. Sustituida en live_balance.py::
# fetch_balance_real() por `_sports_capital_en_free_usdc()` (caja exacta,
# ya vivía ahí desde el fix del 03-Sep para el histórico) +
# `_sports_positions_value_actual()` (valor de mercado real, nueva) --
# ver docstring de esa función para el detalle completo. bankroll_actual()
# de abajo sigue leyendo `real["total"]` sin cambios: el fix vive entero
# en live_balance.py.
