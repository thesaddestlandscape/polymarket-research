...
import fade_depth_universal_fase0
...
OBSERVADORES = [
    ...
    (fade_depth_universal_fase0, "fade_depth_universal_fase0.log", "_log"),
    ...
    # 09-Sep: DRY_RUN de bot_consenso como filtro adicional (no sustituto)
    # del gate de precio ya existente, SOLO para las 3 combinaciones que
