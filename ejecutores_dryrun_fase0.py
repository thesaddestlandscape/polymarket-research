...
# 08-Sep: dispersed_bot_executor_dryrun.py sacado de aquí, MISMO motivo --
# pasó a DRY_RUN=False (SOLO SNIPER#BTC#5min[0.25,0.30), checklist 6
# categorías + 2/2 días de estabilidad, ver su propio docstring). Ahora
# vive en executores_live_consolidado.py -- correcto que este proceso se
# negara a arrancar con el módulo todavía dentro (guardia de abajo).
