...
import candidata9_gate_bucket as _c9gb
import bot_wallets_gate_bucket as _bwgb
...
_GATES_EXTERNOS_POR_ESTRATEGIA = {
    ...
    "CANDIDATA9_BOT_CONSENSO": _c9gb,
    # 08-Sep: familia P-GALLINA (dispersed_bot_executor_dryrun.py), los 4
    # arquetipos comparten el mismo módulo de gate (bot_wallets_gate_
    # bucket.json no separa por arquetipo más allá de la clave de tabla).
    "SNIPER": _bwgb,
    "DISPERSO": _bwgb,
    "WEEKLY_TEMPRANO": _bwgb,
    "WEEKLY_TARDIO": _bwgb,
}
