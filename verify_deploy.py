...
SCREENS = {
    ...
    "ejeclive": {"entry": "executores_live_consolidado.py",
                 # 09-Sep: probe tenía el número de ejecutores hardcodeado
                 # ("arrancando 5 ejecutores") -- cada vez que se añade uno
                 # nuevo (van 8 hoy: +CANDIDATA9_BOT_CONSENSO+DISPERSED_BOT)
                 # el restart es correcto pero el probe da falso positivo de
                 # fallo. Patrón sin el número, mismo texto fijo del resto.
                 "probe": "log:logs/ejecutores_live_consolidado.log:ejecutores consolidados:"},
    ...
    # solo observación (no firma ni envía nada) -- mapea en milisegundos
    # cuándo desaparece la liquidez del libro antes del cierre de BTC#5min.
    "curvacierre": {"entry": "resolution_sniper_precierre_curva_cierre_fase0.py",
                     "probe": "log:logs/resolution_sniper_precierre_curva_cierre_fase0.log:arrancado"},
