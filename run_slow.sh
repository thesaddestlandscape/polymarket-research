...
while true; do
    ...
    # Git: precios, leaderboard e hipótesis LLM -- lógica compartida con
    # run_fast_mantenimiento.sh, ver git_batch_sync.sh (18-Ago, extraído
    # tras /code-review: llevaba cada loop su propia copia casi idéntica).
    (
