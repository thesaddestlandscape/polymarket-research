# Hipótesis automáticas — 2026-07-16 14:48 UTC
_Generado por shadow_postmortem.py sobre 17112 resoluciones (PNL=+3430.03€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.178 (n=1149)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `7344.6882` → IC=+0.179 (n=335)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 7344.6882 (IC base=+0.168)
...
- **PATRÓN** `libro_liquidez` > `7106.2104` → IC=+0.203 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7106.2104 (IC base=+0.203)
...
- **PATRÓN** `libro_liquidez` > `4118.7645` → IC=+0.213 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4118.7645 (IC base=+0.205)
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.264 (n=189)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.137 (n=89)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0044 (IC base=+0.136)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.210 (n=91)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.155 (n=140)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 12.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.154 (n=212)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 18.0 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.2519` → IC=+0.171 (n=74)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.2519 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `1.1207` → IC=+0.126 (n=145)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 1.1207 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.551` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.551 (IC base=+0.136)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.200 (n=235)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0152 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.129 (n=631)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 15.0 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.3506` → IC=+0.171 (n=174)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3506 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.098` → IC=+0.297 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.098 (IC base=+0.112)
...
- **PATRÓN** `dist_vwap_pct` > `0.4306` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.4306 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.68` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 13.68 (IC base=+0.083)
...
- **FILTRO** `sigma_ewma_delta_pct` < `7.064` → IC=-0.125 (n=22)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` < 7.064
  - _Potencial_: sin este filtro IC_bueno=+0.324 (n=49)
...
- **PATRÓN** `sigma_h` > `0.0129` → IC=+0.135 (n=72)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0129 (IC base=+0.082)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.158 (n=74)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 8.0 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` > `0.8694` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.8694 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` < `0.3894` → IC=+0.136 (n=75)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.3894 (IC base=+0.082)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.064` → IC=+0.324 (n=49)
...
### UPDOWN_GBM#15min
- **FILTRO** `sigma_ewma_delta_pct` > `16.748` → IC=-0.145 (n=29)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 16.748
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=153)
...
- **PATRÓN** `dist_vwap_pct` > `0.9401` → IC=+0.152 (n=21)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.9401 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` < `16.748` → IC=+0.126 (n=153)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 16.748 (IC base=+0.045)
...
- **FILTRO** `sigma_ewma_delta_pct` > `20.541` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 20.541
...
- **PATRÓN** `dist_vwap_pct` > `0.974` → IC=+0.214 (n=19)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.974 (IC base=+0.043)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2589 | +0.174 | -55.48€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1668 | +0.211 | +22.27€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 749 | +0.178 | -16.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 556 | +0.203 | -15.26€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 922 | +0.174 | -3.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 553 | +0.215 | +19.39€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 909 | +0.172 | -32.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 550 | +0.216 | +20.41€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 4917 | +0.100 | +1501.68€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4917 | +0.100 | +1501.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1180 | +0.062 | +161.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1180 | +0.062 | +161.08€ | 0 | 3 |
| ✅ GBM_LATE_15M#ETH | 1174 | +0.072 | +189.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1174 | +0.072 | +189.47€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1316 | +0.107 | +519.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1316 | +0.107 | +519.89€ | 1 | 6 |
| ✅ GBM_LATE_15M#XRP | 1247 | +0.156 | +631.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1247 | +0.156 | +631.23€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2134 | +0.146 | +1212.23€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2134 | +0.146 | +1212.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 547 | +0.107 | +259.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 547 | +0.107 | +259.61€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 566 | +0.120 | +244.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 566 | +0.120 | +244.40€ | 0 | 15 |
...
| ✅ GBM_LATE_15M_TARDIO | 2117 | +0.088 | +620.45€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2117 | +0.088 | +620.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 524 | +0.053 | +85.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 524 | +0.053 | +85.03€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 492 | +0.016 | +4.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 492 | +0.016 | +4.99€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 496 | +0.060 | +96.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 496 | +0.060 | +96.01€ | 3 | 6 |
...
| ✅ UPDOWN_GBM | 1605 | +0.009 | +71.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1347 | +0.035 | +108.83€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#ETH | 772 | +0.017 | +34.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 679 | +0.033 | +45.75€ | 2 | 3 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 17 | +0.201 | +0.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 17 | +0.201 | +0.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 6 | +0.037 | -0.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 6 | +0.037 | -0.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 11 | +0.148 | +0.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 11 | +0.148 | +0.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 137 | +0.162 | +30.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 137 | +0.162 | +30.77€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 43 | +0.167 | +2.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 43 | +0.167 | +2.77€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.155: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.002 n=506 | neutral: IC=-0.021 n=376 | overbought(IBS>0.7): IC=+0.134 n=413
  - _Datos_: n=1369 IC=+0.042 PNL=+128.25€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.101 n=9947 | tras_1loss IC=+0.068 n=6955 | tras_2loss IC=+0.038 n=2972/40 | gap=+0.063 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1478 IC=+0.015 PNL=+85.79€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1478 IC=+0.015 PNL=+85.79€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=715 IC=+0.073 PNL=+93.48€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=715 IC=+0.073 PNL=+93.48€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=605 IC=+0.030 PNL=+38.39€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=605 IC=+0.030 PNL=+38.39€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=14654 IC=+0.104 PNL=+3505.91€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=14654 IC=+0.104 PNL=+3505.91€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=160 IC=+0.006 PNL=+6.70€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=160 IC=+0.006 PNL=+6.70€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=500 IC=-0.084 PNL=+80.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=500 IC=-0.084 PNL=+80.97€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.180 < -0.1 con n=408 PNL=-83.46€
  - _Datos_: n=408 IC=-0.180 PNL=-83.46€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.240 > 0.2 con n=360 PNL=+241.48€
  - _Datos_: n=360 IC=+0.240 PNL=+241.48€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.105 > 0.08 con n=160 PNL=+56.66€
  - _Datos_: n=160 IC=+0.105 PNL=+56.66€
