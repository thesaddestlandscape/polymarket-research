# Hipótesis automáticas — 2026-07-29 14:48 UTC
_Generado por shadow_postmortem.py sobre 41896 resoluciones (PNL=+9035.34€)_
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.139 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0055 (IC base=+0.061)
...
| ✅ UPDOWN_GBM | 3092 | +0.038 | +292.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2828 | +0.054 | +331.13€ | 0 | 5 |
...
| ✅ UPDOWN_GBM#ETH | 1148 | +0.040 | +81.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1054 | +0.053 | +93.02€ | 0 | 4 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.159: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.079 n=1832 | neutral: IC=+0.026 n=1430 | overbought(IBS>0.7): IC=+0.185 n=1724
  - _Datos_: n=5320 IC=+0.105 PNL=+1409.67€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.155 n=111 PNL=+50.33€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.130 n=133 PNL=+44.34€ → BOOST | H=22h: IC=+0.173 n=145 PNL=+41.74€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=24948 | tras_1loss IC=+0.078 n=16705 | tras_2loss IC=+0.052 n=7004/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2955 IC=+0.042 PNL=+305.91€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2955 IC=+0.042 PNL=+305.91€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1594 IC=+0.044 PNL=+138.37€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1594 IC=+0.044 PNL=+138.37€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=5576 IC=+0.086 PNL=+1365.01€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5576 IC=+0.086 PNL=+1365.01€
