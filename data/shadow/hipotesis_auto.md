# Hipótesis automáticas — 2026-08-21 14:12 UTC
_Generado por shadow_postmortem.py sobre 102056 resoluciones (PNL=+8573.18€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `156.16` → IC=-0.263 (n=1433)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.16
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4302)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.150 (n=358)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=204)

- **FILTRO** `restante_s_al_confirmar` < `129.49` → IC=-0.324 (n=140)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 129.49
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=422)
...
- **FILTRO** `restante_s_al_confirmar` < `140.79` → IC=-0.253 (n=338)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.79
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1017)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `148.37` → IC=-0.335 (n=282)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.37
  - _Potencial_: sin este filtro IC_bueno=-0.138 (n=848)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=3489)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=1292)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2373.5135` → IC=+0.169 (n=1246)
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.268 (n=2012)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.185 (n=2287)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `4243.0625` → IC=+0.171 (n=952)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 4243.0625 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.213 (n=448)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=384)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.186)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.296 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.188 (n=552)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.298 (n=329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.288)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.295 (n=329)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.288)

- **PATRÓN** `py_entrada` < `0.195` → IC=+0.411 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.195 (IC base=+0.288)

- **PATRÓN** `libro_liquidez` > `2474.0326` → IC=+0.310 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2474.0326 (IC base=+0.288)
...
- **PATRÓN** `py_entrada` > `0.835` → IC=+0.428 (n=221)
...
- **PATRÓN** `libro_liquidez` > `739.7806` → IC=+0.239 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 739.7806 (IC base=+0.212)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.187 (n=3291)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 5.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.193 (n=2907)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=841)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.181 (n=283)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=747)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.224)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.231 (n=656)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.196 (n=521)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.199 (n=6994)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.228 (n=5143)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=1115)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.274 (n=563)
...
- **PATRÓN** `lag_apertura_s` < `5.27` → IC=+0.159 (n=833)

  - _Acción_: Kelly boost +0.79€ cuando `lag_apertura_s` < 5.27 (IC base=+0.132)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.229 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.147)

- **PATRÓN** `restante_min` < `3.76` → IC=+0.182 (n=416)

  - _Acción_: Kelly boost +0.91€ cuando `restante_min` < 3.76 (IC base=+0.147)

- **PATRÓN** `restante_min` > `4.89` → IC=+0.171 (n=420)

  - _Acción_: Kelly boost +0.85€ cuando `restante_min` > 4.89 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=421)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.147)

- **PATRÓN** `lag_apertura_s` < `6.81` → IC=+0.173 (n=414)

  - _Acción_: Kelly boost +0.87€ cuando `lag_apertura_s` < 6.81 (IC base=+0.147)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.186 (n=463)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` < 0.37 (IC base=+0.118)

- **PATRÓN** `restante_min` < `3.95` → IC=+0.137 (n=428)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` < 3.95 (IC base=+0.118)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.162 (n=424)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` > 4.95 (IC base=+0.118)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.124 (n=1280)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 17.0 (IC base=+0.118)

- **PATRÓN** `lag_apertura_s` < `3.29` → IC=+0.164 (n=421)

  - _Acción_: Kelly boost +0.82€ cuando `lag_apertura_s` < 3.29 (IC base=+0.118)
...
- **PATRÓN** `ibs_20min` > `0.9762` → IC=+0.262 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9762 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.2276` → IC=+0.238 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2276 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` < `0.9606` → IC=+0.236 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9606 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.918` → IC=+0.218 (n=692)
...
- **PATRÓN** `volumen_spike_ratio` < `3.2031` → IC=+0.121 (n=862)
  ...
  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 3.2031 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` > `1.502` → IC=+0.132 (n=861)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.502 (IC base=+0.091)

- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.134 (n=1739)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0817` → IC=+0.253 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0817 (IC base=+0.049)

- **PATRÓN** `volumen_spike_ratio` < `1.6719` → IC=+0.225 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6719 (IC base=+0.049)

- **PATRÓN** `volumen_spike_ratio` > `2.625` → IC=+0.215 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.625 (IC base=+0.049)

- **PATRÓN** `ballena_activa_n` < `254.0` → IC=+0.236 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 254.0 (IC base=+0.049)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.176 (n=140)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0022 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.0825` → IC=+0.167 (n=139)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0825 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.145 (n=291)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 8.0 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.140 (n=326)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 18.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.3843` → IC=+0.179 (n=278)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.3843 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.1691` → IC=+0.167 (n=289)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1691 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.1` → IC=+0.243 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.1 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.6237` → IC=+0.148 (n=106)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6237 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.2591` → IC=+0.154 (n=105)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2591 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1155` → IC=+0.247 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1155 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.5786` → IC=+0.208 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5786 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `12094.187` → IC=+0.169 (n=143)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 12094.187 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.202 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 249.0 (IC base=+0.135)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.03` → IC=-0.179 (n=104)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.03
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=774)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.743` → IC=+0.131 (n=82)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 6.743 (IC base=-0.037)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.305` → IC=+0.127 (n=1176)
...
- **PATRÓN** `ibs_20min` < `0.1077` → IC=+0.165 (n=962)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.1077 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` > `0.6258` → IC=+0.204 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6258 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` < `0.2745` → IC=+0.178 (n=564)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.2745 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` > `1.0609` → IC=+0.204 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0609 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` > `0.2629` → IC=+0.349 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2629 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` > `3.1792` → IC=+0.306 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1792 (IC base=+0.039)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.233 (n=200)
...
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.260 (n=389)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.3797` → IC=+0.270 (n=390)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.275` → IC=+0.337 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.275 (IC base=+0.258)

- **PATRÓN** `dist_vwap_pct` < `0.6812` → IC=+0.262 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6812 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.479` → IC=+0.269 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.479 (IC base=+0.258)

- **PATRÓN** `volumen_regimen` > `1.0811` → IC=+0.299 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0811 (IC base=+0.258)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8604` → IC=+0.278 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8604 (IC base=+0.258)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.205 (n=757)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.257 (n=1109)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.7681` → IC=+0.246 (n=305)
...
- **PATRÓN** `volumen_regimen` > `0.7086` → IC=+0.170 (n=906)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.7086 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.106` → IC=+0.183 (n=581)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.106 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `1.984` → IC=+0.142 (n=948)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.984 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.4912` → IC=+0.143 (n=1422)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.4912 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.166 (n=1716)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.04 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `3239.8498` → IC=+0.201 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3239.8498 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.207 (n=1477)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0069 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.2469` → IC=+0.205 (n=1298)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2469 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.241 (n=747)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` < `0.3898` → IC=+0.257 (n=1474)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3898 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` < `0.4326` → IC=+0.177 (n=1327)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.4326 (IC base=+0.192)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.278` → IC=+0.194 (n=1480)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 5.278 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` < `1.195` → IC=+0.168 (n=1174)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.195 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` > `0.6764` → IC=+0.175 (n=1049)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6764 (IC base=+0.192)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6231` → IC=+0.192 (n=384)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.6231 (IC base=+0.192)
...
- **PATRÓN** `ballena_activa_n` < `112.0` → IC=+0.179 (n=381)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 112.0 (IC base=+0.192)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.258 (n=64)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.242 (n=196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2276` → IC=+0.262 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2276 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.258` → IC=+0.313 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.258 (IC base=+0.200)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.297` → IC=+0.328 (n=27)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.297 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `1.4452` → IC=+0.254 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4452 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `2.6687` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6687 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `11057.2809` → IC=+0.246 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11057.2809 (IC base=+0.200)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.192 (n=284)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0039 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.2033` → IC=+0.206 (n=250)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2033 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.207 (n=203)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.3342` → IC=+0.224 (n=284)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0722` → IC=+0.225 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0722 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.8235` → IC=+0.235 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8235 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `13250.1274` → IC=+0.180 (n=95)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 13250.1274 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `211.0` → IC=+0.219 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 211.0 (IC base=+0.168)
...
- **PATRÓN** `sigma_h` < `0.0081` → IC=+0.249 (n=177)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0081 (IC base=+0.226)

- **PATRÓN** `drift_60min` |x|≤ `0.0849` → IC=+0.303 (n=59)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0849 (IC base=+0.226)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.239 (n=182)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.226)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.233 (n=170)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.226)

- **PATRÓN** `ibs_20min` > `0.4752` → IC=+0.289 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4752 (IC base=+0.226)

- **PATRÓN** `dist_vwap_pct` > `0.1741` → IC=+0.242 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1741 (IC base=+0.226)

- **PATRÓN** `dist_vwap_pct` < `0.3391` → IC=+0.248 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3391 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.711` → IC=+0.405 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.711 (IC base=+0.226)

- **PATRÓN** `volumen_regimen` > `0.6433` → IC=+0.254 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6433 (IC base=+0.226)

- **PATRÓN** `volumen_pendiente_norm` > `0.1047` → IC=+0.293 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1047 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` < `1.4673` → IC=+0.259 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4673 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` > `2.2426` → IC=+0.256 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2426 (IC base=+0.226)

- **PATRÓN** `ballena_activa_n` < `222.0` → IC=+0.223 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 222.0 (IC base=+0.226)

- **PATRÓN** `sigma_h` < `0.005` → IC=+0.203 (n=281)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.005 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.3137` → IC=+0.171 (n=281)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3137 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.168 (n=287)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 5.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.154 (n=293)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 18.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.4336` → IC=+0.224 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4336 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.3707` → IC=+0.173 (n=325)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.3707 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.607` → IC=+0.278 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.607 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.1858` → IC=+0.178 (n=281)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 1.1858 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.6086` → IC=+0.157 (n=281)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6086 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.2357` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.2357 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.2535` → IC=+0.171 (n=156)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.2535 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.195 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0072 (IC base=+0.089)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.139 (n=117)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 17.0 (IC base=+0.089)

- **PATRÓN** `ibs_20min` > `0.8571` → IC=+0.205 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8571 (IC base=+0.089)

- **PATRÓN** `dist_vwap_pct` > `0.6618` → IC=+0.256 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6618 (IC base=+0.089)
...
- **PATRÓN** `libro_liquidez` > `2667.202` → IC=+0.167 (n=139)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2667.202 (IC base=+0.089)
...
- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.207 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.987` → IC=+0.182 (n=42)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 6.987 (IC base=+0.101)

- **PATRÓN** `volumen_regimen` > `0.8469` → IC=+0.136 (n=193)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.8469 (IC base=+0.101)

- **PATRÓN** `volumen_pendiente_norm` > `0.0973` → IC=+0.167 (n=76)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0973 (IC base=+0.101)

- **PATRÓN** `volumen_spike_ratio` > `2.4486` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.4486 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `2374.302` → IC=+0.187 (n=132)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2374.302 (IC base=+0.101)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 32.0 (IC base=+0.101)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.214 (n=638)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.704` → IC=+0.226 (n=308)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.704 (IC base=+0.136)
...
- **PATRÓN** `volumen_regimen` > `1.0983` → IC=+0.144 (n=535)
...
- **PATRÓN** `volumen_spike_ratio` < `2.9142` → IC=+0.129 (n=1594)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 2.9142 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.632` → IC=+0.141 (n=1424)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.632 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.146 (n=1927)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.04 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `2737.2776` → IC=+0.182 (n=863)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 2737.2776 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.203 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 162.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.213 (n=1738)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0076 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.3398` → IC=+0.202 (n=1738)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3398 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.213 (n=789)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.193)

- **PATRÓN** `ibs_20min` < `0.5333` → IC=+0.256 (n=1738)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5333 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.6974` → IC=+0.179 (n=1381)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6974 (IC base=+0.193)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.516` → IC=+0.197 (n=1627)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 2.516 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` < `0.6089` → IC=+0.178 (n=420)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6089 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` > `1.2037` → IC=+0.184 (n=419)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.2037 (IC base=+0.193)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7643` → IC=+0.207 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7643 (IC base=+0.193)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.126 (n=410)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 56.0 (IC base=+0.193)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3053` → IC=+0.174 (n=311)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3053 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.169 (n=279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 8.0 (IC base=+0.164)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.170 (n=322)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 18.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` < `0.4901` → IC=+0.209 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4901 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` < `0.2672` → IC=+0.189 (n=307)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.2672 (IC base=+0.164)
...
- **PATRÓN** `volumen_regimen` > `0.8408` → IC=+0.184 (n=207)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.8408 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.166` → IC=+0.300 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.166 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` < `1.7532` → IC=+0.219 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7532 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `12236.1369` → IC=+0.189 (n=104)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 12236.1369 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `326.0` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 326.0 (IC base=+0.164)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.151 (n=81)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0022 (IC base=+0.141)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.175 (n=81)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0067 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.0729` → IC=+0.175 (n=81)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.0729 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=82)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 17.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.140 (n=87)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 6.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.3782` → IC=+0.216 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3782 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.2593` → IC=+0.198 (n=114)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.2593 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.544` → IC=+0.202 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.544 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.7415` → IC=+0.194 (n=106)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.7415 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.1336` → IC=+0.152 (n=110)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.1336 (IC base=+0.141)
...
- **PATRÓN** `libro_liquidez` > `3653.6242` → IC=+0.218 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3653.6242 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `235.0` → IC=+0.248 (n=113)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3707` → IC=+0.150 (n=198)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.3707 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.131 (n=177)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.2384` → IC=+0.224 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2384 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` > `0.1367` → IC=+0.131 (n=109)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.1367 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.6029` → IC=+0.154 (n=209)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.6029 (IC base=+0.126)
...
- **PATRÓN** `volumen_regimen` < `0.5365` → IC=+0.176 (n=66)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.5365 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` < `0.0642` → IC=+0.176 (n=140)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` < 0.0642 (IC base=+0.126)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4048` → IC=+0.178 (n=144)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.4048 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.4473` → IC=+0.185 (n=144)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.4473 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `10155.5917` → IC=+0.132 (n=66)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 10155.5917 (IC base=+0.126)

- **PATRÓN** `ballena_activa_n` < `174.0` → IC=+0.183 (n=80)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 174.0 (IC base=+0.126)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.156 (n=268)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0072 (IC base=+0.103)

- **PATRÓN** `drift_60min` |x|≤ `0.132` → IC=+0.147 (n=134)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.132 (IC base=+0.103)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.169 (n=140)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` < `0.5909` → IC=+0.198 (n=306)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.5909 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` < `0.3583` → IC=+0.141 (n=254)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3583 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.472` → IC=+0.175 (n=38)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 7.472 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` < `0.6176` → IC=+0.144 (n=102)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6176 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` > `1.0614` → IC=+0.124 (n=139)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 1.0614 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` < `0.1535` → IC=+0.161 (n=169)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.1535 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` > `1.5628` → IC=+0.190 (n=143)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 1.5628 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `1204.5314` → IC=+0.154 (n=203)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 1204.5314 (IC base=+0.103)
...
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.292 (n=296)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.3874` → IC=+0.231 (n=444)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3874 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.270 (n=220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` < `0.4643` → IC=+0.285 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4643 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.669` → IC=+0.226 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.669 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.929` → IC=+0.250 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.929 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.873` → IC=+0.222 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.873 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `0.8783` → IC=+0.245 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8783 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` > `0.2909` → IC=+0.308 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2909 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.7712` → IC=+0.250 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7712 (IC base=+0.212)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.123 (n=59)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 18.0 (IC base=+0.110)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.138 (n=45)

  - _Acción_: Kelly boost +0.69€ cuando `py_entrada` > 0.505 (IC base=+0.110)
...
### LIQUIDACIONES_5M
- **FILTRO** `libro_liquidez` < `3812.0159` → IC=-0.167 (n=31)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.240 (n=337)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1038)

- **FILTRO** `ibs_20min` > `0.2738` → IC=-0.225 (n=343)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2738
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1032)
...
- **FILTRO** `ibs_20min` < `0.8306` → IC=-0.136 (n=97)
...
- **PATRÓN** `ibs_20min` > `0.8306` → IC=+0.146 (n=97)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.8306 (IC base=+0.005)
...
- **FILTRO** `ballena_activa_n` > `87.0` → IC=-0.238 (n=59)
...
- **FILTRO** `ibs_20min` > `0.1824` → IC=-0.167 (n=115)

  - _Acción_: SKIP cuando `ibs_20min` > 0.1824
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.185 (n=52)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=194)

- **FILTRO** `ballena_activa_n` > `3.0` → IC=-0.125 (n=78)
...
- **FILTRO** `py_entrada` > `0.56` → IC=-0.289 (n=69)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=142)

- **FILTRO** `drift_20min_pct` |x|> `0.2773` → IC=-0.171 (n=71)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.126 (n=97)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` > 0.505 (IC base=+0.026)

- **PATRÓN** `libro_liquidez` > `2608.645` → IC=+0.144 (n=57)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2608.645 (IC base=+0.026)
...
- **PATRÓN** `drift_7min_pct` |x|≤ `0.0791` → IC=+0.136 (n=42)

  - _Acción_: Kelly boost +0.68€ cuando `drift_7min_pct` |x|≤ 0.0791 (IC base=+0.032)

### MOMENTUM_IBS_5M_BALLENA
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=940)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2380)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.270 (n=830)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2490)

- **FILTRO** `ibs_7min` < `0.734` → IC=-0.215 (n=830)

  - _Acción_: SKIP cuando `ibs_7min` < 0.734
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=2490)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.173 (n=1101)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2219)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.221 (n=972)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3036)

- **FILTRO** `ibs_7min` > `0.704` → IC=-0.158 (n=1001)

  - _Acción_: SKIP cuando `ibs_7min` > 0.704
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3007)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.3` → IC=-0.312 (n=115)

  - _Acción_: SKIP cuando `py_entrada` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=357)

- **FILTRO** `ibs_7min` < `0.9412` → IC=-0.180 (n=311)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9412
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=161)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.210 (n=112)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=360)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.218 (n=179)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=437)

- **FILTRO** `drift_7min_pct` |x|> `0.1293` → IC=-0.187 (n=209)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1293
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=407)

- **FILTRO** `ibs_7min` > `0.8201` → IC=-0.184 (n=153)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8201
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=463)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.145 (n=150)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.163 (n=173)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=534)
...
- **FILTRO** `ibs_7min` < `0.7106` → IC=-0.242 (n=149)
...
- **FILTRO** `ibs_7min` > `0.1692` → IC=-0.130 (n=206)
...
- **FILTRO** `ibs_7min` < `1.0` → IC=-0.130 (n=295)

  - _Acción_: SKIP cuando `ibs_7min` < 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=324)
...
- **FILTRO** `py_entrada` > `0.6` → IC=-0.170 (n=183)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=554)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.290 (n=122)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=381)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.272 (n=125)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=378)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.244 (n=123)
...
- **FILTRO** `drift_7min_pct` |x|> `0.1355` → IC=-0.151 (n=325)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1355
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=329)

- **FILTRO** `ibs_7min` > `0.2943` → IC=-0.188 (n=222)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2943
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=432)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.145 (n=218)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=517)
...
- **FILTRO** `libro_liquidez` < `14155.1344` → IC=-0.214 (n=26)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.684` → IC=+0.132 (n=66)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 8.684 (IC base=+0.044)
...
- **PATRÓN** `libro_liquidez` > `3288.4647` → IC=+0.296 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3288.4647 (IC base=+0.274)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.273 (n=42)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.9071` → IC=+0.291 (n=41)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9071 (IC base=+0.250)
...
- **FILTRO** `sigma_h` > `0.0086` → IC=-0.178 (n=427)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.9071 sube el IC de +0.250 a +0.291 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=41). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 4680 | -0.102 | -535.24€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 549 | -0.070 | -86.36€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 4131 | -0.107 | -448.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 562 | -0.128 | -77.01€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 562 | -0.128 | -77.01€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1355 | -0.006 | +25.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1355 | -0.006 | +25.39€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1130 | -0.187 | -203.79€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1130 | -0.187 | -203.79€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 20137 | +0.113 | -1416.86€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4183 | +0.184 | -162.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 13055 | +0.088 | -1208.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2793 | +0.129 | +2.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2199 | +0.048 | -450.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 16 | -0.089 | -1.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2178 | +0.050 | -442.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 4356 | +0.137 | -74.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1157 | +0.193 | -69.57€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2171 | +0.109 | -56.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 986 | +0.142 | +73.05€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2203 | +0.065 | -355.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 15 | +0.022 | -2.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2187 | +0.066 | -350.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 4700 | +0.127 | -77.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1542 | +0.168 | -8.42€ | 0 | 6 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2171 | +0.106 | -53.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 975 | +0.111 | -6.49€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 4481 | +0.127 | -351.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1439 | +0.199 | -78.49€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2165 | +0.079 | -200.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 832 | +0.134 | -63.64€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2198 | +0.119 | -107.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 14 | +0.000 | -0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2183 | +0.120 | -105.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 4304 | +0.170 | -355.50€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 4304 | +0.170 | -355.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1081 | +0.164 | -124.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1081 | +0.164 | -124.57€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1073 | +0.160 | -132.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1073 | +0.160 | -132.58€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 961 | +0.224 | -37.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 961 | +0.224 | -37.66€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1021 | +0.190 | -74.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1021 | +0.190 | -74.10€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 9301 | +0.196 | -806.24€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 9301 | +0.196 | -806.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1740 | +0.117 | -352.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1740 | +0.117 | -352.55€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1439 | +0.240 | -30.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1439 | +0.240 | -30.01€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1624 | +0.156 | -233.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1624 | +0.156 | -233.00€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 1472 | +0.242 | -26.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 1472 | +0.242 | -26.57€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 1465 | +0.238 | -37.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 1465 | +0.238 | -37.77€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 