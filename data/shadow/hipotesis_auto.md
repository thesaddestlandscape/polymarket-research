# Hipótesis automáticas — 2026-09-16 02:49 UTC
_Generado por shadow_postmortem.py sobre 460426 resoluciones (PNL=+49484.38€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.93` → IC=-0.254 (n=5721)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.93
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=17166)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `139.07` → IC=-0.288 (n=787)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 139.07
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=2362)
...
- **FILTRO** `restante_s_al_confirmar` < `141.37` → IC=-0.151 (n=1473)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.37
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=4420)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.37` → IC=-0.252 (n=1354)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.37
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4064)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.16` → IC=-0.329 (n=1435)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.16
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=2914)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.39` → IC=-0.275 (n=158)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.170 (n=98)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=362)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.195 (n=11612)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=2892)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `5254.774` → IC=+0.167 (n=1844)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 5254.774 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.146 (n=9030)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 17.0 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.142 (n=10657)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 7.0 (IC base=+0.135)

- **PATRÓN** `py_entrada` < `0.345` → IC=+0.246 (n=7895)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.172 (n=5708)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7178.5823` → IC=+0.178 (n=1805)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 7178.5823 (IC base=+0.135)
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.347 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=1680)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.209 (n=1357)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.273 (n=1191)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1746)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `14408.9622` → IC=+0.213 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14408.9622 (IC base=+0.202)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.137 (n=1979)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 15.0 (IC base=+0.137)

- **PATRÓN** `py_entrada` > `0.7` → IC=+0.328 (n=764)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.244 (n=1214)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `3739.5225` → IC=+0.244 (n=517)
...
- **PATRÓN** `libro_liquidez` > `1510.4431` → IC=+0.147 (n=483)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1510.4431 (IC base=+0.126)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.193 (n=1074)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.200 (n=8686)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.196)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.220 (n=3221)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.179 (n=2164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.181 (n=2253)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.287 (n=181)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.284)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.344 (n=350)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.181 (n=2133)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.321 (n=653)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.195 (n=1852)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 15.0 (IC base=+0.192)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.194 (n=1553)
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.445 (n=107)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `12072.2649` → IC=+0.453 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12072.2649 (IC base=+0.438)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.237 (n=10248)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.176 (n=4634)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 15.0 (IC base=+0.170)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=4943)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=4768)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.223)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.272 (n=1719)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.183 (n=4950)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=1711)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.255 (n=2255)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.146 (n=2732)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.198 (n=2033)
...
- **PATRÓN** `restante_min` > `4.96` → IC=+0.146 (n=1912)

  - _Acción_: Kelly boost +0.73€ cuando `restante_min` > 4.96 (IC base=+0.119)

- **PATRÓN** `lag_apertura_s` < `4.36` → IC=+0.144 (n=2483)
...
- **PATRÓN** `libro_liquidez` > `1614.3793` → IC=+0.297 (n=927)
...
- **PATRÓN** `py_entrada` > `0.795` → IC=+0.378 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.795 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `1495.8208` → IC=+0.314 (n=396)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.978` → IC=+0.231 (n=2037)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.978 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.1521` → IC=+0.243 (n=1201)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1521 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.853` → IC=+0.166 (n=2357)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.853 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `0.6095` → IC=+0.254 (n=515)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6095 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.0665` → IC=+0.242 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0665 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.1752` → IC=+0.192 (n=4163)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1752 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.3093` → IC=+0.204 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3093 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.9315` → IC=+0.198 (n=2671)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.9315 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.5684` → IC=+0.130 (n=7507)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.5684 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5877` → IC=+0.182 (n=444)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5877 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3518` → IC=+0.169 (n=2584)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3518 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `1.2072` → IC=+0.168 (n=2432)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2072 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8699` → IC=+0.174 (n=1621)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4653` → IC=+0.198 (n=4050)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4653 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `157.0` → IC=+0.208 (n=3819)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.190 (n=459)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0076 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3232` → IC=+0.167 (n=1371)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3232 (IC base=+0.167)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.190 (n=675)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 8.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.069` → IC=+0.279 (n=599)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.069 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2818` → IC=+0.198 (n=177)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2818 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.634` → IC=+0.156 (n=1264)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.634 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.4401` → IC=+0.167 (n=1263)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.4401 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.190 (n=1259)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1942` → IC=+0.274 (n=685)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0538` → IC=+0.284 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0538 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.212` → IC=+0.244 (n=1147)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.212 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` < `0.0926` → IC=+0.233 (n=859)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2849` → IC=+0.267 (n=127)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2849 (IC base=+0.235)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=1055)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1585.6447` → IC=+0.250 (n=917)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1585.6447 (IC base=+0.235)
...
- **PATRÓN** `ibs_20min` > `0.9222` → IC=+0.255 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9222 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.2129` → IC=+0.220 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2129 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.769` → IC=+0.235 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.769 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.2608` → IC=+0.221 (n=1039)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2608 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.8719` → IC=+0.214 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8719 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.0994` → IC=+0.217 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0994 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4939` → IC=+0.220 (n=445)
...
- **PATRÓN** `libro_liquidez` > `10916.3675` → IC=+0.221 (n=1039)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0761` → IC=+0.168 (n=372)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6723` → IC=+0.177 (n=1116)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6723 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1327` → IC=+0.156 (n=1013)
...
- **PATRÓN** `volumen_regimen` < `1.2044` → IC=+0.152 (n=1116)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2044 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.6842` → IC=+0.142 (n=997)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4323` → IC=+0.156 (n=1007)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4323 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `13247.5111` → IC=+0.157 (n=744)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 13247.5111 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `216.0` → IC=+0.164 (n=313)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 216.0 (IC base=+0.141)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.188 (n=1342)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0057 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.193 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 6.0 (IC base=+0.176)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.253 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.471` → IC=+0.225 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.471 (IC base=+0.176)

- **PATRÓN** `volumen_pendiente_norm` < `0.1063` → IC=+0.182 (n=1138)
...
- **PATRÓN** `volumen_spike_ratio` > `3.0416` → IC=+0.197 (n=569)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 3.0416 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=1533)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.223 (n=1162)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3796` → IC=+0.231 (n=1022)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3796 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.556` → IC=+0.233 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.556 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.378` → IC=+0.215 (n=1270)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2947` → IC=+0.222 (n=689)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2947 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=600)
...
- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.217 (n=437)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1693)
...
- **PATRÓN** `volumen_regimen` < `0.8572` → IC=+0.151 (n=362)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8572 (IC base=+0.001)

- **PATRÓN** `volumen_regimen` > `1.1639` → IC=+0.145 (n=181)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1639 (IC base=+0.001)

- **PATRÓN** `volumen_pendiente_norm` > `0.2693` → IC=+0.232 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2693 (IC base=+0.001)

- **PATRÓN** `volumen_spike_ratio` > `1.5051` → IC=+0.176 (n=439)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.5051 (IC base=+0.001)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.129 (n=1727)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=+0.118 (n=862)

- **FILTRO** `sigma_ewma_delta_pct` > `8.602` → IC=-0.197 (n=282)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.602
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2307)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.199 (n=377)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1339)

- **FILTRO** `ibs_20min` > `0.775` → IC=-0.202 (n=648)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=1952)
...
- **PATRÓN** `dist_vwap_pct` < `0.2666` → IC=+0.240 (n=548)
...
- **PATRÓN** `volumen_spike_ratio` < `2.24` → IC=+0.255 (n=374)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.24 (IC base=-0.028)

- **PATRÓN** `volumen_spike_ratio` > `1.4734` → IC=+0.238 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4734 (IC base=-0.028)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.241 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.028)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.174 (n=2553)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0091 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.9833` → IC=+0.289 (n=2554)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9833 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `0.7179` → IC=+0.281 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7179 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.506` → IC=+0.142 (n=3615)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.506 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6746` → IC=+0.234 (n=2321)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6746 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` < `0.1133` → IC=+0.225 (n=3934)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1133 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` > `0.2481` → IC=+0.256 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2481 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` < `1.4779` → IC=+0.240 (n=1378)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4779 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` > `2.7761` → IC=+0.235 (n=1377)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7761 (IC base=+0.086)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.277 (n=3616)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.140 (n=2605)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0084 (IC base=+0.068)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.150 (n=6858)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5556 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` > `0.6968` → IC=+0.242 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6968 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` < `0.1677` → IC=+0.230 (n=1971)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1677 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` < `0.7126` → IC=+0.231 (n=933)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7126 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` > `1.1996` → IC=+0.252 (n=707)
...
- **PATRÓN** `ibs_20min` > `0.8641` → IC=+0.250 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8641 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.293` → IC=+0.147 (n=703)
...
- **FILTRO** `ibs_20min` > `0.8269` → IC=-0.149 (n=574)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1726)

- **PATRÓN** `dist_vwap_pct` > `0.3046` → IC=+0.139 (n=247)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.3046 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.6495` → IC=+0.136 (n=594)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.6495 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2213` → IC=+0.169 (n=119)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2213 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.164 (n=215)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4239 (IC base=+0.009)

- **PATRÓN** `ballena_activa_n` < `232.0` → IC=+0.185 (n=211)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 232.0 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.217 (n=411)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8012` → IC=+0.218 (n=232)
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.266 (n=1085)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.253 (n=456)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.526` → IC=+0.268 (n=378)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.253 (n=1374)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.236)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.295 (n=972)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.285 (n=975)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3333 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.883` → IC=+0.296 (n=375)
...
- **FILTRO** `ibs_20min` < `0.2437` → IC=-0.211 (n=348)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1044)

- **FILTRO** `ibs_20min` > `0.8097` → IC=-0.186 (n=456)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8097
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=1369)

- **PATRÓN** `ibs_20min` > `0.8031` → IC=+0.143 (n=474)
...
- **PATRÓN** `volumen_regimen` > `0.6109` → IC=+0.191 (n=283)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.6109 (IC base=-0.016)

- **PATRÓN** `volumen_pendiente_norm` < `0.108` → IC=+0.218 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.108 (IC base=-0.016)
...
- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.235 (n=187)
...
- **FILTRO** `ibs_20min` > `0.7143` → IC=-0.236 (n=438)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1322)

- **FILTRO** `sigma_ewma_delta_pct` > `4.704` → IC=-0.172 (n=412)
...
- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.129 (n=885)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.4 (IC base=+0.003)

- **PATRÓN** `dist_vwap_pct` > `0.5901` → IC=+0.207 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5901 (IC base=+0.003)

- **PATRÓN** `dist_vwap_pct` < `0.189` → IC=+0.189 (n=326)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.189 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` < `0.7148` → IC=+0.248 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7148 (IC base=+0.003)

- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.183 (n=323)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5876` → IC=+0.204 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5876 (IC base=+0.003)

- **PATRÓN** `volumen_spike_ratio` > `1.5013` → IC=+0.183 (n=332)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.5013 (IC base=+0.003)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.217 (n=334)
...
- **PATRÓN** `sigma_h` > `0.0142` → IC=+0.294 (n=761)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3925` → IC=+0.304 (n=1141)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2431` → IC=+0.363 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2431 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.266 (n=979)
...
- **PATRÓN** `libro_liquidez` > `2333.317` → IC=+0.275 (n=1019)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.203 (n=2011)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3341` → IC=+0.173 (n=5309)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3341 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6294)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.6944` → IC=+0.229 (n=5390)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6944 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1643` → IC=+0.199 (n=2597)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1643 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.249 (n=1243)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2155` → IC=+0.163 (n=4024)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2155 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6208` → IC=+0.160 (n=4023)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6208 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.1069` → IC=+0.186 (n=2361)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1069 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5658` → IC=+0.173 (n=2522)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5658 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6685` → IC=+0.169 (n=1911)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.6685 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3825.7125` → IC=+0.171 (n=2011)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3825.7125 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.184 (n=4948)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 123.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.188 (n=3909)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0063 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.205 (n=1956)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0794 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.202 (n=2835)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` < `0.4587` → IC=+0.227 (n=5863)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4587 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.2258` → IC=+0.162 (n=4366)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2258 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.251` → IC=+0.195 (n=1015)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.251 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` < `1.1902` → IC=+0.157 (n=4282)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1902 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `0.6245` → IC=+0.151 (n=4281)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6245 (IC base=+0.172)
...
- **PATRÓN** `volumen_spike_ratio` < `1.575` → IC=+0.172 (n=2291)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.575 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `2.6529` → IC=+0.179 (n=1737)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6529 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.172 (n=4824)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.263 (n=247)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1827` → IC=+0.296 (n=494)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1596.68` → IC=+0.253 (n=662)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1596.68 (IC base=+0.237)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0757` → IC=+0.182 (n=294)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4303` → IC=+0.222 (n=879)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4303 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.2181` → IC=+0.215 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2181 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.681` → IC=+0.227 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.681 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.268` → IC=+0.175 (n=880)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.268 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2316` → IC=+0.191 (n=192)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2316 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `1.4127` → IC=+0.201 (n=282)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4127 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `9847.9824` → IC=+0.180 (n=879)
...
- **PATRÓN** `drift_60min` |x|≤ `0.29` → IC=+0.166 (n=999)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.29 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=920)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 7.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.5289` → IC=+0.192 (n=999)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.5289 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.1401` → IC=+0.168 (n=1014)
...
- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.165 (n=999)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2113 (IC base=+0.150)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4411` → IC=+0.163 (n=889)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.4411 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `14761.2112` → IC=+0.150 (n=453)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 14761.2112 (IC base=+0.150)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.197 (n=995)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0058 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.1945` → IC=+0.196 (n=663)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.584` → IC=+0.264 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.584 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` < `0.1074` → IC=+0.184 (n=818)
...
- **PATRÓN** `volumen_spike_ratio` < `1.681` → IC=+0.189 (n=310)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.681 (IC base=+0.188)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=1120)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.222 (n=563)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.250 (n=842)
...
- **PATRÓN** `volumen_spike_ratio` > `3.5269` → IC=+0.247 (n=255)
...
- **PATRÓN** `ibs_20min` > `0.4078` → IC=+0.203 (n=951)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4078 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1355` → IC=+0.196 (n=619)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1355 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` < `0.858` → IC=+0.159 (n=634)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.858 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.1952` → IC=+0.177 (n=317)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.1952 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4014` → IC=+0.167 (n=310)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4014 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `2.5292` → IC=+0.185 (n=309)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.5292 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `7277.355` → IC=+0.190 (n=634)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 7277.355 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.158 (n=782)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 152.0 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.164 (n=1027)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0071 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.3788` → IC=+0.145 (n=1027)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6027` → IC=+0.179 (n=1027)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6027 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.3418` → IC=+0.141 (n=1130)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3418 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.037` → IC=+0.190 (n=201)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 12.037 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` < `0.8596` → IC=+0.142 (n=685)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8596 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` > `0.6094` → IC=+0.130 (n=1026)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.6094 (IC base=+0.129)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.197 (n=150)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` < `1.7906` → IC=+0.136 (n=608)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.7906 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` > `2.4806` → IC=+0.144 (n=304)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 2.4806 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.152 (n=466)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 10007.3401 (IC base=+0.129)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.148 (n=751)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5` → IC=+0.195 (n=1136)
...
- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.121 (n=1126)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=1159)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2895.2022` → IC=+0.195 (n=510)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2895.2022 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.136 (n=824)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 49.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.149 (n=494)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5435` → IC=+0.207 (n=1122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5435 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.7118` → IC=+0.147 (n=199)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.7118 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.1929` → IC=+0.136 (n=1045)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1929 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.358` → IC=+0.160 (n=239)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 7.358 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.041` → IC=+0.129 (n=987)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4638` → IC=+0.131 (n=326)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4638 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.1742` → IC=+0.137 (n=444)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.1742 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3081.0348` → IC=+0.160 (n=374)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 3081.0348 (IC base=+0.114)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` < `0.0271` → IC=+0.203 (n=1069)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0271 (IC base=+0.202)

- **PATRÓN** `sigma_h` > `0.0179` → IC=+0.213 (n=713)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0179 (IC base=+0.202)

- **PATRÓN** `drift_60min` |x|≤ `0.1669` → IC=+0.219 (n=471)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1669 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.216 (n=386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.209 (n=482)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.202)

- **PATRÓN** `ibs_20min` > `0.7255` → IC=+0.257 (n=955)
...
- **PATRÓN** `sigma_h` > `0.0163` → IC=+0.213 (n=758)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.214 (n=519)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.312` → IC=+0.243 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.312 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.6289` → IC=+0.219 (n=1136)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0966` → IC=+0.149 (n=485)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0966 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.178 (n=732)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.3875` → IC=+0.166 (n=1452)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.3875 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.8466` → IC=+0.170 (n=198)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.8466 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.699` → IC=+0.165 (n=661)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.699 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8646` → IC=+0.153 (n=834)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8646 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1639` → IC=+0.164 (n=397)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1639 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.4332` → IC=+0.148 (n=464)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4332 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.5669` → IC=+0.156 (n=463)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.5669 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.140 (n=1606)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8121.9037` → IC=+0.155 (n=659)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 8121.9037 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.156 (n=1234)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 156.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.148 (n=513)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0038 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.3403` → IC=+0.129 (n=1344)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3403 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1543)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.157 (n=1344)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4783 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2173` → IC=+0.124 (n=1354)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.2173 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.998` → IC=+0.138 (n=451)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 5.998 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.2231` → IC=+0.122 (n=1348)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2231 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.1671` → IC=+0.141 (n=394)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.1671 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.134 (n=1284)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1037` → IC=+0.151 (n=144)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1037 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.152 (n=294)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 10.0 (IC base=+0.101)

- **PATRÓN** `ibs_20min` > `0.2836` → IC=+0.141 (n=324)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.2836 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.3078` → IC=+0.144 (n=99)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.3078 (IC base=+0.101)
...
- **PATRÓN** `libro_liquidez` > `9742.4663` → IC=+0.138 (n=324)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 9742.4663 (IC base=+0.101)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.167 (n=100)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 151.0 (IC base=+0.101)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.216 (n=160)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.126)

- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.150 (n=472)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.3402 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.144 (n=425)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 7.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.3447` → IC=+0.207 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3447 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.1865` → IC=+0.146 (n=475)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.1865 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.406` → IC=+0.136 (n=193)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.406 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.074` → IC=+0.127 (n=419)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.074 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.131 (n=472)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.1917 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` > `1.0611` → IC=+0.162 (n=214)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0611 (IC base=+0.126)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1128` → IC=+0.158 (n=407)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1128 (IC base=+0.126)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.160 (n=148)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 159.0 (IC base=+0.126)
...
- **PATRÓN** `ibs_20min` > `0.2605` → IC=+0.225 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2605 (IC base=+0.189)

- **PATRÓN** `dist_vwap_pct` > `0.1466` → IC=+0.217 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1466 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.93` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.93 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` < `0.8293` → IC=+0.194 (n=295)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.8293 (IC base=+0.189)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2479` → IC=+0.315 (n=63)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2479 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.374` → IC=+0.216 (n=146)
...
- **PATRÓN** `ibs_20min` < `0.2943` → IC=+0.157 (n=260)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.2943 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.514` → IC=+0.167 (n=106)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 6.514 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `1.2294` → IC=+0.124 (n=389)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.2294 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` > `0.2214` → IC=+0.172 (n=65)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.2214 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` > `1.5498` → IC=+0.125 (n=329)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.5498 (IC base=+0.108)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.3939` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3939
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=368)
...
- **PATRÓN** `ibs_20min` < `0.4577` → IC=+0.162 (n=288)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.4577 (IC base=+0.082)

- **PATRÓN** `volumen_regimen` < `0.7177` → IC=+0.151 (n=127)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7177 (IC base=+0.082)

- **PATRÓN** `volumen_spike_ratio` < `2.5615` → IC=+0.124 (n=264)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.5615 (IC base=+0.082)

- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.124 (n=235)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 44.0 (IC base=+0.082)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.193 (n=3463)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4722` → IC=+0.213 (n=7635)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4722 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.9144` → IC=+0.203 (n=985)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9144 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.58` → IC=+0.223 (n=3741)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.58 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8818` → IC=+0.166 (n=3430)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8818 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2398` → IC=+0.187 (n=1447)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2398 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.639` → IC=+0.182 (n=2424)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.639 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3789.8405` → IC=+0.170 (n=2545)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3789.8405 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.195 (n=5516)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 94.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.196 (n=4688)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0067 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4797` → IC=+0.184 (n=7027)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.239 (n=7029)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5556 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2359` → IC=+0.164 (n=4453)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2359 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.852` → IC=+0.201 (n=1010)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.852 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.693` → IC=+0.182 (n=6790)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.693 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.6267` → IC=+0.161 (n=1618)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6267 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2027` → IC=+0.161 (n=1618)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.2027 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.249 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.3005` → IC=+0.190 (n=2853)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3005 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.189 (n=2029)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.231 (n=582)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.209 (n=638)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.876` → IC=+0.314 (n=580)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5616` → IC=+0.186 (n=526)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.5616 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.273` → IC=+0.197 (n=542)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.273 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.222 (n=1165)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2035` → IC=+0.281 (n=674)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3402` → IC=+0.283 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3402 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.61` → IC=+0.264 (n=1015)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9027` → IC=+0.282 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9027 (IC base=+0.255)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.255)

- **PATRÓN** `libro_liquidez` > `1590.9711` → IC=+0.268 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1590.9711 (IC base=+0.255)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1831` → IC=+0.153 (n=808)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1831 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1266)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.6903` → IC=+0.243 (n=807)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6903 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.3464` → IC=+0.200 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3464 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.774` → IC=+0.163 (n=283)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 9.774 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.384` → IC=+0.152 (n=1076)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.384 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6916` → IC=+0.182 (n=533)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6916 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1542` → IC=+0.181 (n=330)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1542 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.4203` → IC=+0.157 (n=1158)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4203 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7559` → IC=+0.158 (n=772)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7559 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10762.5448` → IC=+0.168 (n=1082)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 10762.5448 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `494.0` → IC=+0.160 (n=1088)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 494.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.171 (n=1085)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0057 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.2608` → IC=+0.173 (n=954)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6372` → IC=+0.207 (n=1084)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6372 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.5425` → IC=+0.164 (n=215)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.5425 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.168 (n=998)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1332 (IC base=+0.157)
...
- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.168 (n=1084)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4156` → IC=+0.172 (n=987)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.4156 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `12200.4416` → IC=+0.159 (n=723)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12200.4416 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `281.0` → IC=+0.169 (n=297)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 281.0 (IC base=+0.157)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.224 (n=1209)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3648` → IC=+0.267 (n=1025)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3648 (IC base=+0.231)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.708` → IC=+0.275 (n=416)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4315` → IC=+0.138 (n=1295)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7037` → IC=+0.232 (n=864)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.276` → IC=+0.166 (n=551)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 4.276 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8789` → IC=+0.158 (n=864)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5053` → IC=+0.147 (n=548)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5053 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.4658` → IC=+0.160 (n=415)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.4658 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8750.1763` → IC=+0.230 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8750.1763 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.162 (n=392)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 89.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.157 (n=1039)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0075 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.4364` → IC=+0.154 (n=1039)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6883` → IC=+0.193 (n=1039)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6883 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.2054` → IC=+0.145 (n=972)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.2054 (IC base=+0.138)
...
- **PATRÓN** `volumen_regimen` < `0.8608` → IC=+0.143 (n=693)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8608 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.153 (n=347)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5565` → IC=+0.150 (n=427)
...
- **PATRÓN** `libro_liquidez` > `10958.4062` → IC=+0.191 (n=347)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 10958.4062 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `194.0` → IC=+0.144 (n=961)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.166 (n=498)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.4667` → IC=+0.180 (n=1316)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.4667 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `1.0143` → IC=+0.193 (n=223)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 1.0143 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.428` → IC=+0.222 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.428 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=917)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2904.4304` → IC=+0.243 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2904.4304 (IC base=+0.100)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.129 (n=972)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 53.0 (IC base=+0.100)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1246` → IC=+0.153 (n=424)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1246 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.151 (n=602)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 15.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.209 (n=1270)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.4763` → IC=+0.128 (n=1257)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.4763 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.124 (n=1225)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.437 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.156 (n=559)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7176 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2192` → IC=+0.173 (n=194)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.2192 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.4615` → IC=+0.141 (n=371)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4615 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.222` → IC=+0.125 (n=505)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.222 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2911.9343` → IC=+0.166 (n=423)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2911.9343 (IC base=+0.113)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0182` → IC=+0.214 (n=884)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.206 (n=1177)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.1858` → IC=+0.235 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1858 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.067` → IC=+0.264 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.067 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` < `1.2434` → IC=+0.208 (n=1327)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2434 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `0.6266` → IC=+0.209 (n=1326)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6266 (IC base=+0.206)

- **PATRÓN** `volumen_pendiente_norm` > `0.0801` → IC=+0.226 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0801 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `2.5793` → IC=+0.237 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5793 (IC base=+0.206)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1334)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `2567.2944` → IC=+0.211 (n=884)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2567.2944 (IC base=+0.206)

- **PATRÓN** `sigma_h` < `0.0079` → IC=+0.233 (n=488)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0079 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0254` → IC=+0.228 (n=487)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` < `2.2231` → IC=+0.196 (n=1128)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2231 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.197 (n=1281)
...
- **PATRÓN** `libro_liquidez` > `2542.2704` → IC=+0.202 (n=974)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=2569)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.188 (n=649)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0037 (IC base=+0.137)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.163 (n=648)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 4.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` < `0.1794` → IC=+0.161 (n=853)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1794 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.7081` → IC=+0.147 (n=344)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.7081 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.27` → IC=+0.145 (n=1922)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.27 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.1137` → IC=+0.145 (n=1619)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1137 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0721` → IC=+0.152 (n=914)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.0721 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.5724` → IC=+0.141 (n=1919)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.5724 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.8251` → IC=+0.149 (n=1279)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.8251 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=2569)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `7743.0752` → IC=+0.150 (n=1732)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7743.0752 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.140 (n=48)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0114 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` > `0.6259` → IC=+0.226 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6259 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `23.0` → IC=+0.130 (n=44)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 23.0 (IC base=+0.056)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.129 (n=462)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` > 0.5 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2825.677` → IC=+0.173 (n=163)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2825.677 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=511)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2306.5744` → IC=+0.131 (n=537)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2306.5744 (IC base=+0.100)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=6221)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.180 (n=2626)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=7958)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=2709)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8347)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.221 (n=431)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1349)

- **FILTRO** `ibs_20min` < `0.7475` → IC=-0.182 (n=445)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7475
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1335)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.163 (n=452)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1517)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.201 (n=450)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.215 (n=464)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1480)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.202 (n=434)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1325)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.194 (n=485)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1461)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2390)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2402)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=7589)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=17326)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=5794)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=19121)

- **FILTRO** `ibs_7min` < `0.7058` → IC=-0.241 (n=6228)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7058
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=18687)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.161 (n=8261)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=16654)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=7753)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=23472)

- **FILTRO** `ibs_7min` > `0.2967` → IC=-0.178 (n=7803)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2967
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=23422)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.313 (n=940)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3050)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.259 (n=1314)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2676)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.194 (n=956)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3034)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.149 (n=3638)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.098 (n=1801)

- **FILTRO** `drift_7min_pct` |x|> `0.1357` → IC=-0.129 (n=1359)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1357
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=4080)

- **FILTRO** `ibs_7min` > `0.7992` → IC=-0.207 (n=1358)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7992
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4081)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1003)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3354)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.255 (n=1012)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3345)

- **FILTRO** `ibs_7min` < `0.7589` → IC=-0.186 (n=1089)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7589
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3268)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.172 (n=1082)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3275)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.255 (n=1032)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3385)

- **FILTRO** `ibs_7min` > `0.2516` → IC=-0.170 (n=1104)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2516
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3313)

- **FILTRO** `ballena_activa_n` > `152.0` → IC=-0.177 (n=1099)

  - _Acción_: SKIP cuando `ballena_activa_n` > 152.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3318)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.180 (n=911)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2832)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.322 (n=900)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2843)

- **FILTRO** `drift_7min_pct` |x|> `0.1817` → IC=-0.130 (n=1271)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1817
  - _Potencial_: sin este filtro IC_bueno=-0.109 (n=2472)

- **FILTRO** `ibs_7min` < `0.2021` → IC=-0.274 (n=935)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2021
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2808)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.220 (n=899)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2844)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1340)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=4368)

- **FILTRO** `ibs_7min` > `0.2637` → IC=-0.158 (n=1940)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2637
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=3768)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1291)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2804)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.254 (n=991)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3104)

- **FILTRO** `ibs_7min` < `0.7446` → IC=-0.195 (n=1023)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7446
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3072)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.183 (n=1019)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3076)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1028)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3172)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.175 (n=1049)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3151)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.180 (n=1044)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3156)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.252 (n=1056)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3461)

- **FILTRO** `ibs_7min` < `0.7222` → IC=-0.215 (n=1119)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7222
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3398)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.176 (n=1419)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4490)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.281 (n=1013)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3200)

- **FILTRO** `ibs_7min` < `0.7315` → IC=-0.230 (n=1053)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7315
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3160)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.207 (n=1039)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3174)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.204 (n=1318)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=4234)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3987` → IC=+0.137 (n=628)
...
- **PATRÓN** `total_vol_5m` < `469.512` → IC=+0.151 (n=210)

  - _Acción_: Kelly boost +0.75€ cuando `total_vol_5m` < 469.512 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `3712.2533` → IC=+0.124 (n=285)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 3712.2533 (IC base=+0.122)
...
- **PATRÓN** `delta_ratio` |x|> `0.413` → IC=+0.182 (n=86)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.91€ cuando `delta_ratio` |x|> 0.413 (IC base=+0.101)

- **PATRÓN** `total_vol_5m` < `657.7094` → IC=+0.170 (n=113)

  - _Acción_: Kelly boost +0.85€ cuando `total_vol_5m` < 657.7094 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `7894.6804` → IC=+0.124 (n=115)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 7894.6804 (IC base=+0.101)

- **PATRÓN** `ballena_activa_n` < `70.0` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 70.0 (IC base=+0.101)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2319)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1192)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1200)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.186 (n=355)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0039 (IC base=+0.172)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.199 (n=483)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0072 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.0534` → IC=+0.183 (n=355)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0534 (IC base=+0.172)

- **PATRÓN** `delta_ratio_macro` |x|> `0.058` → IC=+0.175 (n=1065)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio_macro` |x|> 0.058 (IC base=+0.172)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3414` → IC=+0.210 (n=744)
...
- **PATRÓN** `ibs_15` > `0.619` → IC=+0.244 (n=1065)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.619 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.1064` → IC=+0.176 (n=710)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1064 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.798` → IC=+0.238 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.798 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `5059.1554` → IC=+0.184 (n=483)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.217 (n=90)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.0602` → IC=+0.272 (n=90)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0602 (IC base=+0.196)
...
- **PATRÓN** `ibs_15` > `0.8791` → IC=+0.296 (n=179)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.68` → IC=+0.250 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.68 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `13829.6156` → IC=+0.234 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13829.6156 (IC base=+0.196)
...
- **FILTRO** `dist_vwap_pct` > `0.5854` → IC=-0.147 (n=114)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.066 (n=592)
...
- **PATRÓN** `sigma_h` > `0.015` → IC=+0.257 (n=204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.015 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.0851` → IC=+0.208 (n=135)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0851 (IC base=+0.182)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0439` → IC=+0.192 (n=306)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.0439 (IC base=+0.182)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.093` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.093 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.230 (n=150)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.182)

- **PATRÓN** `ibs_15` > `0.5385` → IC=+0.276 (n=306)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5385 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` > `0.1729` → IC=+0.199 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1729 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.3071` → IC=+0.183 (n=291)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.3071 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.93` → IC=+0.235 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.93 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.489` → IC=+0.181 (n=271)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 7.489 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.182 (n=331)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.03 (IC base=+0.182)

- **PATRÓN** `libro_liquidez` > `2719.5866` → IC=+0.238 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2719.5866 (IC base=+0.182)

- **PATRÓN** `ibs_15` < `0.1087` → IC=+0.175 (n=337)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` < 0.1087 (IC base=+0.048)
...
- **FILTRO** `ibs_15` < `0.6071` → IC=-0.182 (n=177)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.253 (n=533)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.173 (n=674)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1452)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2866` → IC=+0.223 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2866 (IC base=-0.058)

- **PATRÓN** `ibs_15` > `0.6071` → IC=+0.253 (n=533)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6071 (IC base=-0.058)

- **PATRÓN** `dist_vwap_pct` < `0.1109` → IC=+0.182 (n=328)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1109 (IC base=-0.058)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1193` → IC=+0.239 (n=742)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1193 (IC base=-0.046)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.182` → IC=+0.240 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.182 (IC base=-0.046)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.280 (n=1114)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3557 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` > `0.6644` → IC=+0.274 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6644 (IC base=-0.046)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.202 (n=317)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=954)

- **FILTRO** `sigma_h` < `0.0032` → IC=-0.234 (n=317)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=954)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.210 (n=812)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.177 (n=459)

- **FILTRO** `sigma_ewma_delta_pct` > `19.895` → IC=-0.248 (n=228)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.895
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1043)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.161 (n=110)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0026 (IC base=+0.071)
...
- **PATRÓN** `ibs_15` > `0.8109` → IC=+0.343 (n=106)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8109 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.3651` → IC=+0.269 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3651 (IC base=+0.071)
...
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.252 (n=469)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.225)

- **PATRÓN** `drift_60min` |x|≤ `0.4379` → IC=+0.230 (n=469)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4379 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.766` → IC=+0.230 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.766 (IC base=+0.225)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2064` → IC=+0.258 (n=213)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2064 (IC base=+0.225)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.245 (n=159)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.225)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.242 (n=165)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.225)

- **PATRÓN** `ibs_15` < `0.361` → IC=+0.271 (n=469)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.361 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.3857` → IC=+0.245 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3857 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.178` → IC=+0.236 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.178 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.153` → IC=+0.228 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.153 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3600.0181` → IC=+0.226 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3600.0181 (IC base=+0.225)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0701` → IC=+0.211 (n=206)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0701 (IC base=-0.044)
...
- **PATRÓN** `ibs_15` < `0.3333` → IC=+0.301 (n=329)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.619 sube el IC de +0.172 a +0.244 en UPDOWN_GBM#15min (n=1065). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.8791 sube el IC de +0.196 a +0.296 en UPDOWN_GBM#BTC#15min (n=179). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5385 sube el IC de +0.182 a +0.276 en UPDOWN_GBM#XRP#15min (n=306). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1087 sube el IC de +0.048 a +0.175 en UPDOWN_GBM#XRP#15min (n=337). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6071 sube el IC de -0.058 a +0.253 en UPDOWN_GBM_15M_TARDIO (n=533). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0.046 a +0.280 en UPDOWN_GBM_15M_TARDIO (n=1114). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8109 sube el IC de +0.071 a +0.343 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=106). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.361 sube el IC de +0.225 a +0.271 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=469). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3667 sube el IC de -0.044 a +0.247 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=231). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3333 sube el IC de -0.047 a +0.301 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=329). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 20421 | -0.103 | -2914.52€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1238 | -0.045 | -183.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19183 | -0.106 | -2731.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3149 | -0.121 | -557.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3149 | -0.121 | -557.54€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 5893 | -0.049 | -585.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5893 | -0.049 | -585.87€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5418 | -0.113 | -437.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5418 | -0.113 | -437.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4349 | -0.163 | -989.76€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4349 | -0.163 | -989.76€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 12101 | -0.042 | +4245.62€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3254 | -0.007 | +1852.75€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 8847 | -0.055 | +2392.87€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 12101 | -0.042 | +4245.62€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3254 | -0.007 | +1852.75€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 8847 | -0.055 | +2392.87€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 939 | -0.104 | -140.42€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 62 | -0.078 | -11.18€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 877 | -0.105 | -129.25€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 538 | -0.078 | -69.54€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 42 | -0.068 | -6.08€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 496 | -0.078 | -63.47€ | 1 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 262 | -0.159 | -58.75€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 20 | -0.091 | -5.10€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 74051 | +0.113 | -3815.78€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 11594 | +0.182 | -360.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 285 | -0.117 | -46.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 57048 | +0.100 | -3306.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5124 | +0.116 | -102.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 9508 | +0.097 | -877.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 38 | -0.150 | -1.48€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 9455 | +0.099 | -864.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 14966 | +0.131 | -312.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3538 | +0.201 | -114.52€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 9452 | +0.109 | -192.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1934 | +0.116 | +15.90€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 9547 | +0.089 | -932.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 45 | -0.053 | -1.73€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 9487 | +0.091 | -919.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 15860 | +0.125 | -303.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4473 | +0.172 | -73.07€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 9533 | +0.108 | -174.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1842 | +0.100 | -46.76€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 14648 | +0.116 | -823.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3462 | +0.185 | -180.09€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 188 | -0.074 | +7.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 9650 | +0.092 | -579.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1348 | +0.139 | -71.72€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#XRP | 9522 | +0.103 | -565.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 38 | +0.000 | +10.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 9471 | +0.103 | -576.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 11702 | +0.189 | -803.57€ | 3 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 11702 | +0.189 | -803.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2876 | +0.169 | -306.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2876 | +0.169 | -306.56€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 619 | +0.181 | +6.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 619 | +0.181 | +6.09€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2824 | +0.176 | -265.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2824 | +0.176 | -265.94€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2537 | +0.236 | -77.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2537 | +0.236 | -77.03€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2767 | +0.192 | -173.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2767 | +0.192 | -173.89€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 544 | +0.434 | -9.64€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 544 | +0.434 | -9.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 209 | +0.438 | -1.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 209 | +0.438 | -1.17€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 39979 | +0.195 | -3337.52€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 39979 | +0.195 | -3337.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 6963 | +0.170 | -882.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 6963 | +0.170 | -882.03€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 6342 | +0.223 | -241.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 6342 | +0.223 | -241.34€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 6925 | +0.169 | -881.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 6925 | +0.169 | -881.25€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 6432 | +0.217 | -269.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 6432 | +0.217 | -269.16€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 6598 | +0.203 | -445.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 6598 | +0.203 | -445.17€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 6719 | +0.191 | -618.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 6719 | +0.191 | -618.57€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 14922 | +0.124 | +284.88€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 14922 | +0.124 | +284.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 7400 | +0.130 | +206.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 7400 | +0.130 | +206.45€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 7522 | +0.119 | +78.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 7522 | +0.119 | +78.43€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1236 | +0.287 | -27.02€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1236 | +0.287 | -27.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 546 | +0.272 | -21.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 546 | +0.272 | -21.64€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 591 | +0.291 | -4.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 591 | +0.291 | -4.23€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 26341 | +0.098 | -797.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2219 | +0.094 | +33.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 24122 | +0.099 | -830.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 15037 | +0.102 | -236.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2219 | +0.094 | +33.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 12818 | +0.103 | -269.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 4574 | +0.115 | +33.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 4574 | +0.115 | +33.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 6730 | +0.079 | -594.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 6730 | +0.079 | -594.36€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 19520 | +0.075 | +8770.86€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 19520 | +0.075 | +8770.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 3195 | +0.196 | +2351.92€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 3195 | +0.196 | +2351.92€ | 0 | 20 |
| ✅ GBM_LATE_15M#BTC | 2872 | +0.175 | +1932.57€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2872 | +0.175 | +1932.57€ | 0 | 24 |
| ✅ GBM_LATE_15M#DOGE | 3336 | +0.194 | +2418.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 3336 | +0.194 | +2418.85€ | 0 | 19 |
| ✅ GBM_LATE_15M#ETH | 2919 | +0.003 | +437.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 2919 | +0.003 | +437.38€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 2882 | -0.038 | +620.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2882 | -0.038 | +620.45€ | 4 | 13 |
| ✅ GBM_LATE_15M#XRP | 4316 | -0.050 | +1009.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 4316 | -0.050 | +1009.69€ | 4 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 20591 | +0.077 | +10234.42€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 20591 | +0.077 | +10234.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 3777 | +0.011 | +1944.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 3777 | +0.011 | +1944.63€ | 2 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 4345 | +0.005 | +815.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 4345 | +0.005 | +815.60€ | 1 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 2913 | +0.255 | +2844.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 2913 | +0.255 | +2844.80€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 3217 | -0.018 | +391.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 3217 | -0.018 | +391.44€ | 2 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 3426 | +0.014 | +1208.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 3426 | +0.014 | +1208.87€ | 3 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 2913 | +0.269 | +3029.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 2913 | +0.269 | +3029.08€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 15859 | +0.169 | +11623.07€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 15859 | +0.169 | +11623.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2341 | +0.209 | +1880.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2341 | +0.209 | +1880.12€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 2503 | +0.156 | +1814.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 2503 | +0.156 | +1814.66€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2446 | +0.204 | +1904.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2446 | +0.204 | +1904.55€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 2635 | +0.140 | +1760.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 2635 | +0.140 | +1760.21€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 2995 | +0.113 | +1935.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 2995 | +0.113 | +1935.55€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 2939 | +0.203 | +2327.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 2939 | +0.203 | +2327.99€ | 0 | 28 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 3972 | +0.124 | +1577.50€ | 0 | 23 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 3972 | +0.124 | +1577.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 141 | +0.115 | +56.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 141 | +0.115 | +56.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1060 | +0.116 | +411.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1060 | +0.116 | +411.22€ | 0 | 21 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 368 | +0.149 | +182.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 368 | +0.149 | +182.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1107 | +0.151 | +504.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1107 | +0.151 | +504.07€ | 0 | 20 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 793 | +0.080 | +204.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 793 | +0.080 | +204.57€ | 1 | 8 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 503 | +0.136 | +218.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 503 | +0.136 | +218.58€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO | 19548 | +0.173 | +14106.70€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 19548 | +0.173 | +14106.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3056 | +0.221 | +2578.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3056 | +0.221 | +2578.28€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3059 | +0.152 | +2009.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3059 | +0.152 | +2009.39€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 3163 | +0.220 | +2653.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 3163 | +0.220 | +2653.99€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 3111 | +0.137 | +2004.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 3111 | +0.137 | +2004.29€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 3443 | +0.106 | +1958.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 3443 | +0.106 | +1958.40€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 3716 | +0.203 | +2902.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 3716 | +0.203 | +2902.35€ | 0 | 24 |
| ✅ GBM_LATE_5M | 5949 | +0.141 | +3237.56€ | 1 | 25 |
| ✅ GBM_LATE_5M#5min | 5949 | +0.141 | +3237.56€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#SOL | 315 | +0.039 | +48.25€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 315 | +0.039 | +48.25€ | 2 | 6 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 583 | +0.052 | +106.73€ | 2 | 4 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 583 | +0.052 | +106.73€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC | 228 | +0.039 | +30.12€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 228 | +0.039 | +30.12€ | 4 | 5 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1364 | +0.107 | +403.19€ | 0 | 5 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1364 | +0.107 | +403.19€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1364 | +0.107 | +403.19€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1364 | +0.107 | +403.19€ | 0 | 5 |
...
| ✅ LIQUIDACIONES_60M | 896 | -0.048 | -27.70€ | 4 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 896 | -0.048 | -27.70€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 12912 | -0.011 | -180.07€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 12912 | -0.011 | -180.07€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2354 | -0.022 | -47.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2354 | -0.022 | -47.85€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_15M#SOL | 3145 | -0.017 | -59.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 3145 | -0.017 | -59.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 1679 | -0.006 | -33.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 1679 | -0.006 | -33.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 21640 | -0.012 | +953.47€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 21640 | -0.012 | +953.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 3749 | +0.009 | +479.73€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 3749 | +0.009 | +479.73€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 3508 | -0.026 | -33.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 3508 | -0.026 | -33.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 3775 | +0.003 | +306.24€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 3775 | +0.003 | +306.24€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3284 | -0.043 | -75.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3284 | -0.043 | -75.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 3619 | -0.016 | +146.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 3619 | -0.016 | +146.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 3705 | -0.002 | +129.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 3705 | -0.002 | +129.44€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 4893 | -0.037 | -108.08€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 4893 | -0.037 | -108.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1201 | +0.000 | -16.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1201 | +0.000 | -16.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 1028 | -0.042 | -19.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 1028 | -0.042 | -19.99€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1334 | -0.051 | -22.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1334 | -0.051 | -22.85€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#XRP | 846 | -0.015 | -25.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#XRP#15min | 846 | -0.015 | -25.21€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M | 3309 | +0.005 | -0.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 3309 | +0.005 | -0.16€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#ETH | 1284 | +0.009 | +9.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#ETH#5min | 1284 | +0.009 | +9.25€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL | 1388 | +0.007 | +0.29€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 1388 | +0.007 | +0.29€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 187 | -0.008 | -5.71€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 187 | -0.008 | -5.71€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 56140 | -0.073 | +1071.20€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 56140 | -0.073 | +1071.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 9429 | -0.081 | +552.92€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 9429 | -0.081 | +552.92€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 8774 | -0.087 | -300.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 8774 | -0.087 | -300.84€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 9451 | -0.072 | +420.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 9451 | -0.072 | +420.57€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 8295 | -0.093 | -234.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 8295 | -0.093 | -234.16€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 10426 | -0.048 | +293.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 10426 | -0.048 | +293.79€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 9765 | -0.064 | +338.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 9765 | -0.064 | +338.91€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 6706 | -0.021 | -104.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 6706 | -0.021 | -104.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 996 | -0.017 | -19.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 996 | -0.017 | -19.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1494 | -0.020 | -9.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1494 | -0.020 | -9.32€ | 3 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 994 | -0.035 | -12.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 994 | -0.035 | -12.91€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 737 | -0.021 | -24.17€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 737 | -0.021 | -24.17€ | 1 | 0 |
| ✅ ORDER_FLOW_5M | 973 | +0.113 | +342.20€ | 0 | 5 |
| ✅ ORDER_FLOW_5M#5min | 837 | +0.122 | +329.61€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#ETH | 171 | +0.101 | +58.63€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#ETH#5min | 171 | +0.101 | +58.63€ | 0 | 4 |
...
| ✅ STREAK_MOM_5M | 6374 | +0.021 | +85.40€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 6374 | +0.021 | +85.40€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2037 | +0.020 | +18.70€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2037 | +0.020 | +18.70€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1330 | +0.029 | +32.46€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1330 | +0.029 | +32.46€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 1862 | +0.013 | +3.26€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 1862 | +0.013 | +3.26€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1145 | +0.029 | +30.98€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1145 | +0.029 | +30.98€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 5903 | +0.012 | -32.51€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 5903 | +0.012 | -32.51€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2338 | +0.020 | +1.71€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2338 | +0.020 | +1.71€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2341 | +0.014 | -8.57€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2341 | +0.014 | -8.57€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1224 | -0.006 | -25.65€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1224 | -0.006 | -25.65€ | 2 | 0 |
| ✅ UPDOWN_GBM | 25096 | +0.029 | +1388.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 6709 | +0.058 | +1064.75€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 939 | +0.005 | +9.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 15847 | +0.023 | +320.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 1498 | -0.006 | -10.52€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 2194 | +0.073 | +214.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 273 | +0.122 | +84.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 19 | -0.023 | -0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 1902 | +0.067 | +130.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 4473 | +0.032 | +299.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 806 | +0.083 | +189.35€ | 0 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 267 | +0.024 | +7.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 2698 | +0.027 | +97.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 663 | -0.001 | +3.51€ | 0 | 1 |
| ✅ UPDOWN_GBM#BTC#daily | 39 | -0.110 | +1.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 2979 | +0.032 | +94.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 229 | +0.106 | +55.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 16 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 2734 | +0.026 | +39.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 5092 | +0.016 | +202.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1846 | +0.044 | +196.75€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 254 | +0.008 | +8.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 2420 | +0.004 | +1.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 538 | -0.011 | -9.08€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 34 | -0.139 | +4.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 6544 | +0.016 | +149.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1803 | +0.023 | +103.53€ | 1 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 248 | -0.008 | -2.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 4168 | +0.017 | +52.86€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 297 | -0.008 | -4.95€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 28 | -0.133 | -0.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 3812 | +0.041 | +430.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 1752 | +0.079 | +435.39€ | 0 | 13 |
| ✅ UPDOWN_GBM#XRP#240min | 135 | -0.011 | -3.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 1925 | +0.010 | -1.55€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 8935 | -0.049 | +1842.45€ | 3 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 8935 | -0.049 | +1842.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 403 | -0.053 | +344.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 403 | -0.053 | +344.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1710 | -0.129 | -10.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1710 | -0.129 | -10.82€ | 4 | 4 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 139 | +0.117 | +54.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 139 | +0.117 | +54.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 970 | +0.192 | +546.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 970 | +0.192 | +546.75€ | 2 | 22 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 2868 | -0.062 | +442.96€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 2868 | -0.062 | +442.96€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 2845 | -0.077 | +464.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 2845 | -0.077 | +464.24€ | 2 | 3 |
