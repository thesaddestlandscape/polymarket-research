# Hipótesis automáticas — 2026-07-05 05:32 UTC
_Generado por shadow_postmortem.py sobre 3758 resoluciones (PNL=+124.52€)_
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 963 | +0.090 | +221.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 963 | +0.090 | +221.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 250 | +0.036 | +24.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 250 | +0.036 | +24.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 250 | +0.036 | +16.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 250 | +0.036 | +16.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 248 | +0.132 | +89.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 248 | +0.132 | +89.68€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M | 1537 | +0.011 | +7.98€ | 1 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1401 | +0.006 | -4.61€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 270 | -0.033 | -11.23€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 270 | -0.033 | -11.23€ | 0 | 0 |
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 166 ops con delta_ratio | SOL: 201 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.026 n=1871 | tras_1loss IC=-0.011 n=1787 | tras_2loss IC=-0.028 n=894/40 | gap=+0.054 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=58 IC=+0.033 PNL=+2.18€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=58 IC=+0.033 PNL=+2.18€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1317 IC=+0.059 PNL=+205.66€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1317 IC=+0.059 PNL=+205.66€
