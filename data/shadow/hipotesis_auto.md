# Hipótesis automáticas — 2026-09-21 01:11 UTC
_Generado por shadow_postmortem.py sobre 534266 resoluciones (PNL=+59263.49€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.254 (n=473)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.254 (n=473)
...
- **PATRÓN** `banda_z` > `9.958` → IC=+0.223 (n=171)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 9.958 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.145 (n=356)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 11.0 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=541)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `2876.7023` → IC=+0.144 (n=338)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2876.7023 (IC base=+0.132)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.262 (n=372)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.262 (n=372)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8026` → IC=+0.270 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8026 (IC base=+0.142)

- **PATRÓN** `banda_z` > `11.154` → IC=+0.228 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.154 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.160 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.142)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.145 (n=288)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 12.0 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=456)
...
- **FILTRO** `restante_s_al_confirmar` < `160.64` → IC=-0.232 (n=1525)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.64
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4578)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.81` → IC=-0.364 (n=1280)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.81
  - _Potencial_: sin este filtro IC_bueno=-0.118 (n=3843)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.198 (n=12995)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3248)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5474.7679` → IC=+0.173 (n=2067)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.139 (n=12429)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 7.0 (IC base=+0.130)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.235 (n=9934)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=5309)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `1661.6674` → IC=+0.158 (n=5985)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1661.6674 (IC base=+0.130)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=1979)
...
- **PATRÓN** `py_entrada` > `0.62` → IC=+0.181 (n=302)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.144 (n=2215)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 15.0 (IC base=+0.143)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.335 (n=860)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.243 (n=1382)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.142 (n=607)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=697)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `1296.9414` → IC=+0.147 (n=605)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.430 (n=584)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=9954)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3596)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2432)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=2563)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.260 (n=643)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.257)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.329 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.257)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.324 (n=782)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.192 (n=2340)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 17.0 (IC base=+0.190)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.193 (n=1764)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.435 (n=167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.240 (n=11591)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.179 (n=5305)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 15.0 (IC base=+0.174)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5753)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.226 (n=5496)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=5689)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.222 (n=2087)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.221)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=1958)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.253 (n=2582)
...
- **PATRÓN** `libro_liquidez` > `1573.916` → IC=+0.296 (n=1028)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3547` → IC=+0.126 (n=6347)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3547 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9808` → IC=+0.241 (n=2404)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9808 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.7929` → IC=+0.243 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7929 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.6001` → IC=+0.246 (n=2012)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6001 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.922` → IC=+0.175 (n=2784)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 5.922 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.2117` → IC=+0.245 (n=1910)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2117 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.05` → IC=+0.246 (n=866)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.05 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.211 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.9173` → IC=+0.204 (n=3252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9173 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5712` → IC=+0.132 (n=8711)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5712 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5721` → IC=+0.199 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5721 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1425` → IC=+0.171 (n=2697)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1425 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7028` → IC=+0.176 (n=1306)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7028 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8707` → IC=+0.173 (n=1979)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8707 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.224 (n=1440)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5845` → IC=+0.201 (n=4414)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5845 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.211 (n=4719)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.171 (n=548)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0081 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.341` → IC=+0.168 (n=1636)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.341 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=803)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 15.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.181 (n=616)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.063` → IC=+0.275 (n=710)
...
- **PATRÓN** `volumen_spike_ratio` > `1.44` → IC=+0.166 (n=1521)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.44 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.248 (n=1069)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.39` → IC=+0.248 (n=1254)
...
- **PATRÓN** `libro_liquidez` > `15816.3726` → IC=+0.225 (n=561)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.157 (n=435)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.168 (n=438)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 18.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.166 (n=1297)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6828 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.6791` → IC=+0.137 (n=221)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.6791 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.1254` → IC=+0.151 (n=1162)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1254 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.535` → IC=+0.155 (n=421)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 6.535 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.188` → IC=+0.135 (n=1170)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 4.188 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.2049` → IC=+0.147 (n=1297)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2049 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.8523` → IC=+0.137 (n=865)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.195 (n=605)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 6.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=629)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2145` → IC=+0.187 (n=1575)
...
- **PATRÓN** `volumen_spike_ratio` > `2.922` → IC=+0.206 (n=682)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.922 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1058)
...
- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.221 (n=1211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3824` → IC=+0.231 (n=1193)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3824 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.543` → IC=+0.237 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.543 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.394` → IC=+0.219 (n=1481)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.394 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` > `0.3607` → IC=+0.275 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3607 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2796` → IC=+0.228 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2796 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=846)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1861.22` → IC=+0.229 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1861.22 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.227 (n=796)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2003)

- **PATRÓN** `ibs_20min` > `0.94` → IC=+0.200 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.94 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.3482` → IC=+0.350 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3482 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` < `0.7239` → IC=+0.329 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7239 (IC base=+0.021)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.643` → IC=+0.151 (n=635)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 4.643 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` < `0.6001` → IC=+0.344 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6001 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` > `1.1929` → IC=+0.333 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1929 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` < `0.1672` → IC=+0.326 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1672 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` > `0.2985` → IC=+0.350 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2985 (IC base=+0.021)

- **PATRÓN** `volumen_spike_ratio` < `1.3975` → IC=+0.349 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3975 (IC base=+0.021)

- **PATRÓN** `volumen_spike_ratio` > `2.2012` → IC=+0.333 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2012 (IC base=+0.021)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.342 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 165.0 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.1841` → IC=+0.165 (n=299)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1841 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.8572` → IC=+0.151 (n=480)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8572 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.235 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.175 (n=595)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.5138 (IC base=+0.009)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=1986)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.642` → IC=-0.205 (n=323)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2646)
...
- **FILTRO** `ibs_20min` > `0.7736` → IC=-0.201 (n=750)
...
- **PATRÓN** `dist_vwap_pct` > `1.0024` → IC=+0.316 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0024 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` < `0.7389` → IC=+0.256 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7389 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.296 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.1054` → IC=+0.283 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1054 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `2.2166` → IC=+0.257 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2166 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.248 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.191 (n=2995)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4687` → IC=+0.186 (n=8026)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4687 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `1.0133` → IC=+0.290 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0133 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.553` → IC=+0.153 (n=4271)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.553 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1742` → IC=+0.231 (n=3145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1742 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.6824` → IC=+0.242 (n=2810)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6824 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2993` → IC=+0.259 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2993 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4763` → IC=+0.243 (n=1704)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4763 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.716` → IC=+0.241 (n=1703)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.716 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.270 (n=4607)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.147 (n=3037)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0088 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5517` → IC=+0.149 (n=8006)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5517 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6792` → IC=+0.242 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6792 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1703` → IC=+0.235 (n=2351)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1703 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.237 (n=1145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7176 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.2033` → IC=+0.241 (n=868)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2033 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.2479` → IC=+0.307 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2479 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.4917` → IC=+0.253 (n=1131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4917 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.3592` → IC=+0.259 (n=1537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3592 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.263 (n=3260)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 81.0 (IC base=+0.070)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.5` → IC=-0.163 (n=484)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.5
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1625)

- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.267 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8935 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.678` → IC=+0.200 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.678 (IC base=+0.048)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4451` → IC=+0.185 (n=255)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.4451 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `2.185` → IC=+0.195 (n=346)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.185 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.187 (n=324)
...
- **FILTRO** `ibs_20min` > `0.817` → IC=-0.147 (n=656)

  - _Acción_: SKIP cuando `ibs_20min` > 0.817
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1971)

- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.153 (n=604)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.86 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.2954` → IC=+0.156 (n=321)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2954 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `1.1961` → IC=+0.142 (n=817)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1961 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` > `0.6606` → IC=+0.148 (n=729)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.194 (n=266)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.188 (n=347)
...
- **PATRÓN** `dist_vwap_pct` < `0.1515` → IC=+0.210 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1515 (IC base=-0.000)

- **PATRÓN** `volumen_regimen` > `0.6047` → IC=+0.206 (n=488)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4298` → IC=+0.208 (n=443)
...
- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.290 (n=1131)
...
- **FILTRO** `ibs_20min` < `0.2702` → IC=-0.196 (n=432)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.073 (n=1297)
...
- **PATRÓN** `ibs_20min` > `0.8048` → IC=+0.156 (n=588)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.8048 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` > `0.4471` → IC=+0.230 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4471 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` < `1.0974` → IC=+0.225 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0974 (IC base=+0.006)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4982` → IC=+0.263 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4982 (IC base=+0.006)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.268 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 103.0 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` > `0.1468` → IC=+0.198 (n=177)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1468 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` < `0.4933` → IC=+0.177 (n=367)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.4933 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` < `1.1643` → IC=+0.190 (n=343)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 1.1643 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `0.673` → IC=+0.180 (n=342)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 0.673 (IC base=-0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.1651` → IC=+0.271 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1651 (IC base=-0.010)

- **PATRÓN** `volumen_spike_ratio` < `1.8288` → IC=+0.229 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8288 (IC base=-0.010)

- **PATRÓN** `volumen_spike_ratio` > `2.1518` → IC=+0.254 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1518 (IC base=-0.010)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.234 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.010)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7059` → IC=-0.205 (n=956)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7059
  - _Potencial_: sin este filtro IC_bueno=+0.270 (n=958)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.232 (n=501)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1510)

- **FILTRO** `sigma_ewma_delta_pct` > `4.685` → IC=-0.176 (n=449)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.685
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=1562)

- **PATRÓN** `ibs_20min` > `0.7059` → IC=+0.270 (n=958)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7059 (IC base=+0.033)

- **PATRÓN** `dist_vwap_pct` > `0.8164` → IC=+0.344 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8164 (IC base=+0.033)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.568` → IC=+0.157 (n=301)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.568 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` < `0.8622` → IC=+0.295 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8622 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` > `0.6364` → IC=+0.287 (n=693)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.315 (n=582)
...
- **PATRÓN** `dist_vwap_pct` < `0.2075` → IC=+0.221 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2075 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` < `0.7092` → IC=+0.269 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7092 (IC base=+0.011)

- **PATRÓN** `volumen_pendiente_norm` < `0.0978` → IC=+0.208 (n=433)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5185` → IC=+0.221 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5185 (IC base=+0.011)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.233 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.011)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.016` → IC=+0.319 (n=782)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.016 (IC base=+0.275)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.292 (n=546)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.275)

- **PATRÓN** `ibs_20min` > `0.9097` → IC=+0.346 (n=782)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9097 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `0.1917` → IC=+0.315 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1917 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.483` → IC=+0.300 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.483 (IC base=+0.275)

- **PATRÓN** `volumen_regimen` > `1.0359` → IC=+0.305 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0359 (IC base=+0.275)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.311 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.275)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5366` → IC=+0.292 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5366 (IC base=+0.275)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.279 (n=1235)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2598.9768` → IC=+0.288 (n=782)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2598.9768 (IC base=+0.275)

- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.300 (n=863)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.271 (n=643)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.305 (n=1294)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.47` → IC=+0.290 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.47 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` < `0.6412` → IC=+0.272 (n=432)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5453` → IC=+0.267 (n=1129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5453 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1777` → IC=+0.270 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1777 (IC base=+0.271)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.272 (n=849)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.271)

- **PATRÓN** `libro_liquidez` > `2582.5802` → IC=+0.278 (n=863)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0795` → IC=+0.203 (n=2252)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4763` → IC=+0.225 (n=6752)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4763 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.225` → IC=+0.158 (n=4936)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.225 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.229` → IC=+0.195 (n=1146)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.229 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1802` → IC=+0.151 (n=4924)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1802 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.225 (n=971)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.574` → IC=+0.165 (n=2677)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.574 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.651` → IC=+0.174 (n=2028)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.651 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `119.0` → IC=+0.171 (n=5711)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.252 (n=763)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.1824` → IC=+0.292 (n=570)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.243 (n=411)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.238)

- **PATRÓN** `ibs_20min` < `0.3451` → IC=+0.265 (n=854)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3451 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.049` → IC=+0.253 (n=929)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0745` → IC=+0.204 (n=349)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4147` → IC=+0.227 (n=1045)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4147 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.1993` → IC=+0.212 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1993 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.506` → IC=+0.235 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.506 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `0.6854` → IC=+0.177 (n=460)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6854 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0696` → IC=+0.162 (n=474)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0696 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2334` → IC=+0.194 (n=230)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2334 (IC base=+0.162)
...
- **PATRÓN** `libro_liquidez` > `15752.6972` → IC=+0.172 (n=474)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 15752.6972 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.162 (n=1014)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0049 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2886` → IC=+0.154 (n=1149)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5531` → IC=+0.184 (n=1149)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5531 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.13` → IC=+0.160 (n=1153)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.13 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.856` → IC=+0.209 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.856 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.154 (n=1149)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2113 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1573` → IC=+0.156 (n=353)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1573 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.4465` → IC=+0.145 (n=1039)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4465 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.7587` → IC=+0.135 (n=692)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.7587 (IC base=+0.136)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.225 (n=537)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0094 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.2078` → IC=+0.214 (n=789)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2078 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.223 (n=406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.294 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.783` → IC=+0.276 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.783 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` < `0.2131` → IC=+0.194 (n=1140)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` < 0.2131 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.9287` → IC=+0.209 (n=506)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9287 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=783)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `1932.9398` → IC=+0.204 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1932.9398 (IC base=+0.196)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.237 (n=975)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.223)

- **PATRÓN** `drift_60min` |x|≤ `0.0916` → IC=+0.252 (n=325)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3529` → IC=+0.252 (n=975)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3529 (IC base=+0.223)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6428` → IC=+0.224 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6428 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` > `2.2644` → IC=+0.235 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2644 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `1917.325` → IC=+0.225 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1917.325 (IC base=+0.223)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.163 (n=1125)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4324 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.163 (n=1126)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3938` → IC=+0.203 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3938 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1517` → IC=+0.185 (n=756)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1517 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.003` → IC=+0.246 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.003 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.05` → IC=+0.156 (n=990)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.05 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `1.1924` → IC=+0.158 (n=375)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.1924 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2917` → IC=+0.227 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2917 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.4219` → IC=+0.159 (n=367)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4219 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `2.5331` → IC=+0.177 (n=367)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.5331 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `6913.8034` → IC=+0.186 (n=750)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6913.8034 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.151 (n=1062)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 168.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.159 (n=1184)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3804` → IC=+0.142 (n=1184)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3804 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.187 (n=404)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 18.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6149` → IC=+0.171 (n=1184)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6149 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.344` → IC=+0.137 (n=1273)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.344 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.91` → IC=+0.177 (n=419)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 6.91 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8554` → IC=+0.144 (n=790)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4874` → IC=+0.140 (n=356)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.4874 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9966.3147` → IC=+0.159 (n=537)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 9966.3147 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **FILTRO** `ibs_20min` > `0.5652` → IC=-0.182 (n=435)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5652
  - _Potencial_: sin este filtro IC_bueno=+0.206 (n=1306)

- **PATRÓN** `sigma_h` > `0.01` → IC=+0.160 (n=584)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.01 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1323)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.203 (n=1287)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5156 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `1.0682` → IC=+0.218 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0682 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.569` → IC=+0.251 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.569 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `1.2243` → IC=+0.127 (n=1288)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2243 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` < `0.1663` → IC=+0.130 (n=1284)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1663 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `1.8114` → IC=+0.134 (n=826)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.8114 (IC base=+0.116)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1341)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2881.368` → IC=+0.196 (n=584)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2881.368 (IC base=+0.116)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.134 (n=959)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1029` → IC=+0.139 (n=436)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1029 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.206 (n=1306)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.9627` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.9627 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` < `0.1948` → IC=+0.134 (n=1193)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1948 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.434` → IC=+0.153 (n=272)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.434 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `1.0465` → IC=+0.121 (n=1150)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.0465 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.165 (n=159)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.2757 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.132 (n=387)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4564 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` > `2.1742` → IC=+0.125 (n=526)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.1742 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `3065.2583` → IC=+0.158 (n=436)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3065.2583 (IC base=+0.109)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.208 (n=817)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.1696` → IC=+0.199 (n=539)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1696 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=441)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.197)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.197 (n=555)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 7.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.256 (n=1095)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7333 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` > `1.2245` → IC=+0.223 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2245 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.442` → IC=+0.243 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.442 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.199 (n=1225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2089 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `0.8587` → IC=+0.215 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8587 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.2353` → IC=+0.273 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2353 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `2.1694` → IC=+0.207 (n=1039)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1694 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.8081` → IC=+0.203 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8081 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.198 (n=1282)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `2587.1246` → IC=+0.197 (n=817)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2587.1246 (IC base=+0.197)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.211 (n=587)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` < `0.4426` → IC=+0.245 (n=1287)
...
- **PATRÓN** `volumen_regimen` > `0.6295` → IC=+0.216 (n=1287)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6295 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2833` → IC=+0.284 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2833 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` < `2.2447` → IC=+0.196 (n=1010)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2447 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4601` → IC=+0.197 (n=1147)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4601 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2558.2592` → IC=+0.209 (n=858)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2558.2592 (IC base=+0.204)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.173 (n=557)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4` → IC=+0.180 (n=1662)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.4 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.367` → IC=+0.182 (n=492)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.367 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.177 (n=775)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8725` → IC=+0.163 (n=960)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8725 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.2058` → IC=+0.153 (n=480)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2058 (IC base=+0.146)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4378` → IC=+0.157 (n=532)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4378 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5596` → IC=+0.176 (n=532)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.5596 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=1865)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `2477.0811` → IC=+0.150 (n=1485)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2477.0811 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.165 (n=1440)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.144 (n=245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0069 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.147 (n=344)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 8.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.221 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.8398` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8398 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.329` → IC=+0.195 (n=175)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 5.329 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.0671` → IC=+0.132 (n=324)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0671 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` > `0.7177` → IC=+0.128 (n=329)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.7177 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.204 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.2136` → IC=+0.152 (n=159)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.2136 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3064.7088` → IC=+0.204 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3064.7088 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.158 (n=115)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 21.0 (IC base=+0.112)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.199 (n=3003)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=9014)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9047` → IC=+0.196 (n=1233)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.9047 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.605` → IC=+0.226 (n=4395)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.605 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8814` → IC=+0.165 (n=4017)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8814 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2405` → IC=+0.195 (n=1680)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2405 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6244` → IC=+0.187 (n=2876)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6244 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2324.6402` → IC=+0.169 (n=6002)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2324.6402 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6721)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.191 (n=5460)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0069 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1442` → IC=+0.186 (n=3598)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.566` → IC=+0.238 (n=8176)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.566 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2371` → IC=+0.160 (n=5098)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2371 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.902` → IC=+0.198 (n=1160)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.902 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.706` → IC=+0.182 (n=7925)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.706 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7055` → IC=+0.158 (n=2491)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7055 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.289` → IC=+0.246 (n=1071)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.289 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `1.8751` → IC=+0.187 (n=4959)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.8751 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.196 (n=2474)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.209 (n=1022)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.3426` → IC=+0.192 (n=1534)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.3426 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.195 (n=749)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.190)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.203 (n=1027)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.319 (n=551)
...
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.262 (n=1047)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.257 (n=1062)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` < `0.3469` → IC=+0.289 (n=1028)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8766` → IC=+0.278 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8766 (IC base=+0.256)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1115` → IC=+0.164 (n=632)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1115 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=1502)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3107` → IC=+0.201 (n=1437)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3107 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.1241` → IC=+0.182 (n=813)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1241 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.756` → IC=+0.168 (n=332)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 9.756 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.279` → IC=+0.150 (n=1288)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1195` → IC=+0.158 (n=1216)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1195 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4084` → IC=+0.152 (n=1382)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4084 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `13656.0542` → IC=+0.152 (n=958)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13656.0542 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `481.0` → IC=+0.155 (n=1313)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 481.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.162 (n=1252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0056 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.3178` → IC=+0.157 (n=1252)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3178 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.6443` → IC=+0.191 (n=1252)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6443 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6776` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6776 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.1283` → IC=+0.163 (n=1137)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1283 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.496` → IC=+0.161 (n=216)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.496 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.160 (n=1252)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1913 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1509` → IC=+0.195 (n=339)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1509 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.158 (n=1155)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7547` → IC=+0.159 (n=770)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7547 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `429.0` → IC=+0.153 (n=931)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 429.0 (IC base=+0.147)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.234 (n=964)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `drift_60min` |x|≤ `0.4332` → IC=+0.143 (n=1537)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4332 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8799` → IC=+0.261 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8799 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3604` → IC=+0.172 (n=610)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.3604 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.33` → IC=+0.168 (n=254)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 11.33 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8773` → IC=+0.161 (n=1025)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8773 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5228` → IC=+0.153 (n=653)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5228 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4733` → IC=+0.152 (n=495)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.4733 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8151.7402` → IC=+0.233 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8151.7402 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.155 (n=473)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4388` → IC=+0.150 (n=1248)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4388 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.138 (n=562)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 7.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.6915` → IC=+0.186 (n=1248)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.6915 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.3621` → IC=+0.140 (n=1246)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3621 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.039` → IC=+0.188 (n=187)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 11.039 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.6971` → IC=+0.144 (n=549)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6971 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `1.1867` → IC=+0.139 (n=416)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 1.1867 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2812` → IC=+0.255 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2812 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.150 (n=1177)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4416 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `10998.3764` → IC=+0.208 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10998.3764 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `183.0` → IC=+0.140 (n=1170)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 183.0 (IC base=+0.134)

### GBM_LATE_15M_TARDIO#SOL#15min
- **FILTRO** `ibs_20min` > `0.6364` → IC=-0.175 (n=499)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6364
  - _Potencial_: sin este filtro IC_bueno=+0.205 (n=1498)
...
- **PATRÓN** `ibs_20min` > `0.4695` → IC=+0.186 (n=1527)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4695 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `1.0481` → IC=+0.199 (n=290)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 1.0481 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.408` → IC=+0.230 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.408 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.120 (n=1529)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.02 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2904.4304` → IC=+0.244 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2904.4304 (IC base=+0.105)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.128 (n=1164)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 54.0 (IC base=+0.105)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.132 (n=1498)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0109 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.1279` → IC=+0.151 (n=500)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1279 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=1554)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1498)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2143` → IC=+0.127 (n=1211)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2143 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.125 (n=1448)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.437 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.7204` → IC=+0.154 (n=660)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7204 (IC base=+0.110)
...
- **PATRÓN** `libro_liquidez` > `2839.872` → IC=+0.157 (n=500)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2839.872 (IC base=+0.110)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0187` → IC=+0.213 (n=1017)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.203 (n=1360)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.203)

- **PATRÓN** `ibs_20min` > `0.5116` → IC=+0.244 (n=1525)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5116 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.189` → IC=+0.225 (n=879)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.189 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.487` → IC=+0.248 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.487 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.0734` → IC=+0.203 (n=1342)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0734 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.635` → IC=+0.210 (n=1525)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1754)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.257 (n=1664)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5208 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `1.1311` → IC=+0.202 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1311 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.8436` → IC=+0.204 (n=1857)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8436 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.808` → IC=+0.262 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.808 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.240 (n=555)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2201` → IC=+0.196 (n=1304)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2201 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.201 (n=1482)
...
- **PATRÓN** `libro_liquidez` > `2568.3954` → IC=+0.202 (n=1109)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.170 (n=944)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 4.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.9392` → IC=+0.210 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9392 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1884` → IC=+0.163 (n=953)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1884 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4996` → IC=+0.141 (n=1599)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.4996 (IC base=+0.150)
...
- **PATRÓN** `volumen_regimen` > `0.9041` → IC=+0.163 (n=1132)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.9041 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1734` → IC=+0.184 (n=741)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1734 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.4592` → IC=+0.156 (n=893)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4592 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8933` → IC=+0.162 (n=1784)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8933 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=1791)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `2753.9412` → IC=+0.154 (n=2418)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4792` → IC=+0.153 (n=2111)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.158 (n=712)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.9118` → IC=+0.142 (n=314)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.9118 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.4317` → IC=+0.125 (n=2091)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.4317 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.238` → IC=+0.140 (n=2095)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.238 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `1.2464` → IC=+0.136 (n=2009)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.2464 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.0721` → IC=+0.146 (n=991)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0721 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.5338` → IC=+0.138 (n=920)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5338 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.8153` → IC=+0.141 (n=1392)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8153 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2798)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7398.7168` → IC=+0.145 (n=1885)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 7398.7168 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 1.0 (IC base=+0.054)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.341` → IC=+0.140 (n=84)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 2.341 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` > `0.1605` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1605 (IC base=+0.054)

- **PATRÓN** `sigma_h` > `0.0137` → IC=+0.141 (n=51)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0137 (IC base=+0.051)

- **PATRÓN** `ibs_20min` < `0.1932` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.1932 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.5986` → IC=+0.153 (n=70)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.5986 (IC base=+0.051)
...
- **PATRÓN** `ibs_20min` > `0.5845` → IC=+0.198 (n=694)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5845 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.1941` → IC=+0.162 (n=347)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1941 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.528` → IC=+0.208 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.528 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.2862` → IC=+0.203 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2862 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` < `2.116` → IC=+0.156 (n=515)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.116 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.4062` → IC=+0.132 (n=585)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4062 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.133 (n=565)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `2435.8886` → IC=+0.150 (n=304)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2435.8886 (IC base=+0.102)
...
- **PATRÓN** `ibs_20min` > `0.5717` → IC=+0.197 (n=239)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5717 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.1288` → IC=+0.167 (n=124)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1288 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `1.0527` → IC=+0.132 (n=210)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0527 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` < `0.067` → IC=+0.142 (n=177)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.067 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` > `0.2602` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.2602 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.191 (n=176)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0748` → IC=+0.171 (n=74)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.0748 (IC base=+0.043)
...
- **PATRÓN** `ibs_20min` > `0.6316` → IC=+0.167 (n=217)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.6316 (IC base=+0.077)

- **PATRÓN** `dist_vwap_pct` > `0.1957` → IC=+0.143 (n=124)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.1957 (IC base=+0.077)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.231` → IC=+0.225 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.231 (IC base=+0.077)

- **PATRÓN** `volumen_regimen` > `1.0396` → IC=+0.167 (n=73)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.0396 (IC base=+0.077)

- **PATRÓN** `volumen_pendiente_norm` > `0.0856` → IC=+0.196 (n=90)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.0856 (IC base=+0.077)
...
- **PATRÓN** `libro_liquidez` > `2844.317` → IC=+0.173 (n=203)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2844.317 (IC base=+0.108)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1513)
...
- **FILTRO** `liq_usd_total` < `35898.38` → IC=-0.140 (n=48)
...
- **PATRÓN** `liq_n` > `17.0` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `liq_n` > 17.0 (IC base=+0.027)

- **PATRÓN** `liq_usd_total` > `68754.71` → IC=+0.184 (n=74)

  - _Acción_: Kelly boost +0.92€ cuando `liq_usd_total` > 68754.71 (IC base=+0.027)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7223)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3040)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9534)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3177)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9846)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.219 (n=518)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1646)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.172 (n=546)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1779)

- **PATRÓN** `py_entrada` > `0.495` → IC=+0.123 (n=1450)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.495 (IC base=+0.024)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=576)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1740)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.475` → IC=-0.190 (n=530)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1608)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.190 (n=556)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1762)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2609)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2747)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2753)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8919)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=20154)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.277 (n=7006)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=22067)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.236 (n=7264)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21809)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9823)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19250)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9068)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=27332)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=9096)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27304)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=1134)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3624)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.255 (n=1568)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3190)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.179 (n=1143)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3615)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.152 (n=4222)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=2060)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.127 (n=2127)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4155)

- **FILTRO** `ibs_7min` > `0.7928` → IC=-0.205 (n=1570)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7928
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4712)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1171)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1220)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3825)

- **FILTRO** `ibs_7min` < `0.752` → IC=-0.188 (n=1261)

  - _Acción_: SKIP cuando `ibs_7min` < 0.752
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3784)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.173 (n=1259)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3786)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1257)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3852)

- **FILTRO** `ibs_7min` > `0.2588` → IC=-0.172 (n=1274)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2588
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3835)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.185 (n=1273)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3836)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.173 (n=1101)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3399)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.310 (n=1091)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3409)

- **FILTRO** `ibs_7min` < `0.1972` → IC=-0.258 (n=1125)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1972
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3375)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1090)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3410)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1554)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5116)

- **FILTRO** `ibs_7min` > `0.7576` → IC=-0.178 (n=1667)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7576
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=5003)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1523)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.246 (n=1171)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3606)

- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.181 (n=1194)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3583)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.178 (n=1194)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3583)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1221)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3683)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.172 (n=1225)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3679)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.190 (n=1189)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3715)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.265 (n=1200)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3929)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.229 (n=1281)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3848)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1672)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5228)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.278 (n=1130)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3734)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.231 (n=1215)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3649)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1171)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3693)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.205 (n=1616)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4919)
...
- **FILTRO** `pct_vs_K` |x|> `2.84` → IC=-0.260 (n=169)

  - _Acción_: SKIP cuando `pct_vs_K` |x|> 2.84
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=171)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2657)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1374)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1625` → IC=+0.194 (n=1214)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.1625 (IC base=+0.186)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2178` → IC=+0.188 (n=460)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.191 (n=648)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6129` → IC=+0.261 (n=1380)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6129 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.4456` → IC=+0.186 (n=326)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4456 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.5648` → IC=+0.176 (n=1358)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.5648 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.122` → IC=+0.272 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.122 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `2966.2693` → IC=+0.194 (n=919)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2966.2693 (IC base=+0.186)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0596` → IC=+0.286 (n=110)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0596 (IC base=+0.208)

- **PATRÓN** `drift_15min` |x|≤ `0.3806` → IC=+0.214 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3806 (IC base=+0.208)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1492` → IC=+0.288 (n=111)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1492 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.234 (n=302)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.208)

- **PATRÓN** `ibs_15` > `0.7064` → IC=+0.269 (n=327)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `13.729` → IC=+0.269 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.729 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `14915.5103` → IC=+0.248 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14915.5103 (IC base=+0.208)
...
- **FILTRO** `dist_vwap_pct` > `0.5695` → IC=-0.142 (n=118)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=733)
...
- **PATRÓN** `ibs_15` < `0.1184` → IC=+0.166 (n=417)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.1184 (IC base=+0.046)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.382 (n=168)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.342)

- **PATRÓN** `drift_60min` |x|≤ `0.1105` → IC=+0.353 (n=249)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1105 (IC base=+0.342)
...
- **PATRÓN** `ibs_15` > `0.7856` → IC=+0.384 (n=369)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7856 (IC base=+0.342)

- **PATRÓN** `dist_vwap_pct` > `0.4248` → IC=+0.384 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4248 (IC base=+0.342)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.143` → IC=+0.351 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.143 (IC base=+0.342)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.348 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.342)

- **PATRÓN** `libro_liquidez` > `3505.1277` → IC=+0.360 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3505.1277 (IC base=+0.342)

- **PATRÓN** `ballena_activa_n` < `475.0` → IC=+0.366 (n=297)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.403 (n=70)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.152` → IC=+0.365 (n=139)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.152 (IC base=+0.349)
...
- **PATRÓN** `libro_liquidez` > `15468.9258` → IC=+0.375 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15468.9258 (IC base=+0.349)

- **PATRÓN** `ballena_activa_n` < `585.0` → IC=+0.407 (n=160)
...
- **FILTRO** `sigma_h` > `0.0129` → IC=-0.212 (n=596)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1792)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.188 (n=771)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1617)

- **FILTRO** `libro_liquidez` < `3907.8213` → IC=-0.133 (n=1576)
...
- **PATRÓN** `ibs_15` > `0.6324` → IC=+0.268 (n=589)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6324 (IC base=-0.058)

- **PATRÓN** `dist_vwap_pct` < `0.1102` → IC=+0.186 (n=361)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1102 (IC base=-0.058)

- **PATRÓN** `delta_ratio_macro` |x|> `0.118` → IC=+0.240 (n=963)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.118 (IC base=-0.039)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1786` → IC=+0.240 (n=928)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1786 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.356` → IC=+0.280 (n=1445)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.356 (IC base=-0.039)

- **PATRÓN** `dist_vwap_pct` > `0.8718` → IC=+0.275 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8718 (IC base=-0.039)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.218 (n=360)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1082)
...
- **FILTRO** `hora_utc` > `7.0` → IC=-0.207 (n=914)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.181 (n=528)

- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.244 (n=256)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.716
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1186)
...
- **PATRÓN** `dist_vwap_pct` > `0.1319` → IC=+0.296 (n=96)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1319 (IC base=+0.087)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.047` → IC=-0.133 (n=300)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.047
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2401)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1035` → IC=+0.374 (n=173)
...
- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.305 (n=275)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1438` → IC=+0.300 (n=403)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.8382` → IC=+0.332 (n=605)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8382 (IC base=+0.293)

- **PATRÓN** `dist_vwap_pct` > `0.2727` → IC=+0.336 (n=272)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.295 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.293)

- **PATRÓN** `libro_liquidez` > `14356.961` → IC=+0.309 (n=202)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.300 (n=153)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.345 (n=159)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.285)

- **PATRÓN** `ibs_15` > `0.829` → IC=+0.315 (n=338)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6129 sube el IC de +0.186 a +0.261 en UPDOWN_GBM#15min (n=1380). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7064 sube el IC de +0.208 a +0.269 en UPDOWN_GBM#BTC#15min (n=327). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1184 sube el IC de +0.046 a +0.166 en UPDOWN_GBM#XRP#15min (n=417). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6324 sube el IC de -0.058 a +0.268 en UPDOWN_GBM_15M_TARDIO (n=589). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.356 sube el IC de -0.039 a +0.280 en UPDOWN_GBM_15M_TARDIO (n=1445). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7413 sube el IC de +0.087 a +0.331 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=152). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8382 sube el IC de +0.293 a +0.332 en UPDOWN_GBM_IBS_ALTO (n=605). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.829 sube el IC de +0.285 a +0.315 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=338). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7856 sube el IC de +0.342 a +0.384 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=369). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8112 sube el IC de +0.349 a +0.381 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=208). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1233 | +0.090 | +154.72€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1233 | +0.090 | +154.72€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 905 | +0.100 | +131.37€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min |