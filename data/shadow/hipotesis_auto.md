# Hipótesis automáticas — 2026-07-27 03:37 UTC
_Generado por shadow_postmortem.py sobre 37685 resoluciones (PNL=+7823.97€)_
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.463` → IC=+0.201 (n=530)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.136 (n=374)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.127` → IC=+0.200 (n=78)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.127 (IC base=+0.120)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7548` → IC=+0.219 (n=457)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7548 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.168 (n=221)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.054)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.7548 sube el IC de +0.054 a +0.219 en UPDOWN_GBM#15min (n=457). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ GBM_LATE_15M | 8163 | +0.094 | +2470.76€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8163 | +0.094 | +2470.76€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5394 | +0.117 | +2542.58€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5394 | +0.117 | +2542.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1414 | +0.086 | +498.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1414 | +0.086 | +498.28€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_TARDIO | 5383 | +0.069 | +1453.98€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5383 | +0.069 | +1453.98€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2758 | +0.034 | +243.75€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2495 | +0.051 | +282.27€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#DOGE | 233 | +0.019 | +13.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 230 | +0.022 | +14.42€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1989 | +0.155 | +908.88€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1989 | +0.155 | +908.88€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.171: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.076 n=1511 | neutral: IC=+0.018 n=1225 | overbought(IBS>0.7): IC=+0.188 n=1538
  - _Datos_: n=4556 IC=+0.104 PNL=+1212.00€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=22448 | tras_1loss IC=+0.079 n=15028 | tras_2loss IC=+0.051 n=6293/40 | gap=+0.061 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2621 IC=+0.039 PNL=+257.55€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2621 IC=+0.039 PNL=+257.55€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1088 IC=+0.054 PNL=+140.34€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1088 IC=+0.054 PNL=+140.34€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=494 IC=+0.087 PNL=+83.14€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=494 IC=+0.087 PNL=+83.14€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.087 > 0.08 con n=1334 PNL=+221.60€
  - _Datos_: n=1334 IC=+0.087 PNL=+221.60€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1340 IC=+0.039 PNL=+106.45€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1340 IC=+0.039 PNL=+106.45€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=361 IC=+0.068 PNL=+44.42€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=361 IC=+0.068 PNL=+44.42€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=1423 IC=+0.059 PNL=+183.86€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1423 IC=+0.059 PNL=+183.86€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1238 IC=+0.029 PNL=+109.79€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1238 IC=+0.029 PNL=+109.79€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.161 > 0.1 con n=954 PNL=+323.53€
  - _Datos_: n=954 IC=+0.161 PNL=+323.53€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.122 > 0.08 con n=684 PNL=+186.58€
  - _Datos_: n=684 IC=+0.122 PNL=+186.58€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.172 > 0.08 con n=282 PNL=+102.15€
  - _Datos_: n=282 IC=+0.172 PNL=+102.15€
