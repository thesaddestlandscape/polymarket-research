# Hipótesis automáticas — 2026-09-17 02:57 UTC
_Generado por shadow_postmortem.py sobre 475490 resoluciones (PNL=+51132.01€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.05` → IC=-0.251 (n=5863)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.05
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=17589)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `139.14` → IC=-0.274 (n=806)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 139.14
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2421)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `487.96` → IC=-0.159 (n=315)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 487.96
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=945)
...
- **FILTRO** `restante_s_al_confirmar` < `158.18` → IC=-0.251 (n=1394)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.18
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4184)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `117.26` → IC=-0.367 (n=1130)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 117.26
  - _Potencial_: sin este filtro IC_bueno=-0.103 (n=3394)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.243 (n=270)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=285)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.149 (n=129)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=406)

- **FILTRO** `py_entrada` < `0.48` → IC=-0.151 (n=127)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=408)

### CANDIDATA9_BOT_CONSENSO#BTC#5min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.246 (n=140)
...
- **FILTRO** `py_entrada` < `0.33` → IC=-0.184 (n=36)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.103 (n=114)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.196 (n=11885)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=2961)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `5302.2196` → IC=+0.169 (n=1886)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.143 (n=11014)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 7.0 (IC base=+0.135)

- **PATRÓN** `py_entrada` < `0.345` → IC=+0.247 (n=8116)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.171 (n=5835)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7236.1296` → IC=+0.178 (n=1844)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 7236.1296 (IC base=+0.135)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=1380)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=1729)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `15045.6808` → IC=+0.215 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15045.6808 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.208 (n=1272)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.209 (n=1394)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` < `0.37` → IC=+0.274 (n=1222)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1793)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `13243.0403` → IC=+0.221 (n=629)
...
- **PATRÓN** `py_entrada` < `0.425` → IC=+0.167 (n=577)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` < 0.425 (IC base=+0.129)
...
- **PATRÓN** `libro_liquidez` > `3855.969` → IC=+0.152 (n=423)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3855.969 (IC base=+0.129)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.138 (n=2022)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 15.0 (IC base=+0.138)

- **PATRÓN** `py_entrada` > `0.7` → IC=+0.328 (n=794)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.134 (n=553)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 17.0 (IC base=+0.130)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.225 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=467)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `1924.9732` → IC=+0.160 (n=368)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1924.9732 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `4424.9893` → IC=+0.167 (n=148)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 4424.9893 (IC base=+0.080)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.139 (n=330)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.199 (n=8936)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.221 (n=3303)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2219)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.178 (n=2311)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.284 (n=160)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.278)

- **PATRÓN** `py_entrada` > `0.715` → IC=+0.333 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.715 (IC base=+0.278)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.181 (n=2182)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 17.0 (IC base=+0.178)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.186 (n=1951)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.237 (n=1738)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.237)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.320 (n=686)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.194 (n=1899)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.437 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.439)

- **PATRÓN** `libro_liquidez` > `3238.6179` → IC=+0.435 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3238.6179 (IC base=+0.439)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.238 (n=10507)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.176 (n=4764)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 15.0 (IC base=+0.171)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5108)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.225 (n=4912)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.224)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.272 (n=1766)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=5100)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.220 (n=1877)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.219)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=1749)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.204 (n=4505)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.255 (n=2330)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.192 (n=3700)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1604.9934` → IC=+0.298 (n=946)
...
- **PATRÓN** `libro_liquidez` > `1492.929` → IC=+0.316 (n=405)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9773` → IC=+0.230 (n=2109)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9773 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.2129` → IC=+0.245 (n=1345)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2129 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.874` → IC=+0.168 (n=2443)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.874 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `1.2254` → IC=+0.245 (n=1615)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2254 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.0679` → IC=+0.244 (n=733)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0679 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.1746` → IC=+0.191 (n=4341)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1746 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.3076` → IC=+0.204 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3076 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.923` → IC=+0.197 (n=2787)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.923 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.5682` → IC=+0.130 (n=7751)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.5682 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5727` → IC=+0.186 (n=460)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5727 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3436` → IC=+0.169 (n=2702)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3436 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `1.2053` → IC=+0.169 (n=2537)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.2053 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8712` → IC=+0.177 (n=1691)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8712 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.2443` → IC=+0.226 (n=858)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2443 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4672` → IC=+0.198 (n=4227)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4672 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `155.0` → IC=+0.209 (n=3997)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.181 (n=477)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0049 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.178 (n=477)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0078 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3249` → IC=+0.163 (n=1427)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.183 (n=702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.057` → IC=+0.276 (n=623)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.201 (n=185)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.4339` → IC=+0.163 (n=1316)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4339 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.184 (n=1334)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.04 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.251 (n=947)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.1937` → IC=+0.274 (n=707)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0542` → IC=+0.288 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0542 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.373` → IC=+0.247 (n=1105)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.373 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0922` → IC=+0.230 (n=888)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7009` → IC=+0.263 (n=315)
...
- **PATRÓN** `libro_liquidez` > `1741.2648` → IC=+0.253 (n=707)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1741.2648 (IC base=+0.234)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.224 (n=950)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0053 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.115` → IC=+0.242 (n=475)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.115 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.226 (n=1131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.212)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.212 (n=1094)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` > `0.9176` → IC=+0.252 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9176 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` > `0.1985` → IC=+0.216 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1985 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.3719` → IC=+0.214 (n=1029)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3719 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.236 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.757 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` < `1.258` → IC=+0.223 (n=1079)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.258 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` > `0.0983` → IC=+0.218 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0983 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` < `1.4948` → IC=+0.220 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4948 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.3672` → IC=+0.222 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3672 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `10989.1304` → IC=+0.222 (n=1079)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10989.1304 (IC base=+0.212)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.155 (n=1017)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0049 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.0755` → IC=+0.159 (n=385)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6717` → IC=+0.173 (n=1154)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6717 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1275` → IC=+0.151 (n=1053)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1275 (IC base=+0.137)
...
- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.144 (n=1154)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2089 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `0.6867` → IC=+0.139 (n=1031)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6867 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.152 (n=1045)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `13515.3928` → IC=+0.151 (n=769)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13515.3928 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `423.0` → IC=+0.146 (n=963)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 423.0 (IC base=+0.137)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.188 (n=1394)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.179 (n=1240)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 15.0 (IC base=+0.177)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.253 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.52` → IC=+0.226 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.52 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1065` → IC=+0.182 (n=1186)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` < 0.1065 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.3768` → IC=+0.187 (n=180)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.3768 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `3.0163` → IC=+0.197 (n=592)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 3.0163 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=1601)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.194 (n=501)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 16.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.222 (n=1200)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.215)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.214 (n=1073)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3796` → IC=+0.232 (n=1056)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.364` → IC=+0.216 (n=1313)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=1758)

- **PATRÓN** `ibs_20min` > `0.9316` → IC=+0.172 (n=291)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.9316 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` > `0.3321` → IC=+0.340 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3321 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` < `0.4846` → IC=+0.326 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4846 (IC base=+0.006)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.323` → IC=+0.136 (n=550)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.323 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` < `0.6501` → IC=+0.374 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6501 (IC base=+0.006)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7922` → IC=+0.340 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7922 (IC base=+0.006)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.345 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 165.0 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` > `0.1655` → IC=+0.192 (n=196)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1655 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `0.8585` → IC=+0.151 (n=388)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8585 (IC base=+0.004)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5051` → IC=+0.185 (n=474)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.5051 (IC base=+0.004)
...
- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.128 (n=1782)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.642` → IC=-0.205 (n=290)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2372)
...
- **FILTRO** `drift_60min` |x|> `0.6599` → IC=-0.194 (n=442)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6599
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1330)

- **FILTRO** `ibs_20min` < `0.8` → IC=-0.141 (n=1329)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=443)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.202 (n=380)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=1392)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.201 (n=670)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=2014)

- **PATRÓN** `dist_vwap_pct` > `0.9754` → IC=+0.318 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9754 (IC base=-0.085)

- **PATRÓN** `dist_vwap_pct` < `0.2465` → IC=+0.303 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2465 (IC base=-0.085)

- **PATRÓN** `volumen_regimen` < `1.0034` → IC=+0.268 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0034 (IC base=-0.085)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.290 (n=222)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4964` → IC=+0.273 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4964 (IC base=-0.085)

- **PATRÓN** `volumen_spike_ratio` > `1.8324` → IC=+0.290 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8324 (IC base=-0.085)

- **PATRÓN** `dist_vwap_pct` > `1.0227` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0227 (IC base=-0.027)

- **PATRÓN** `dist_vwap_pct` < `0.2651` → IC=+0.249 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2651 (IC base=-0.027)

- **PATRÓN** `volumen_regimen` < `0.7337` → IC=+0.244 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7337 (IC base=-0.027)

- **PATRÓN** `volumen_regimen` > `1.0875` → IC=+0.290 (n=251)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2213` → IC=+0.262 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2213 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` > `1.4747` → IC=+0.246 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4747 (IC base=-0.027)

- **PATRÓN** `ballena_activa_n` < `34.0` → IC=+0.247 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 34.0 (IC base=-0.027)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.175 (n=2645)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0092 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.9819` → IC=+0.289 (n=2640)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9819 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `1.0133` → IC=+0.283 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0133 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.525` → IC=+0.144 (n=3743)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 3.525 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` < `1.1747` → IC=+0.225 (n=2696)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1747 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `0.6761` → IC=+0.238 (n=2408)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6761 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` < `0.1128` → IC=+0.226 (n=4095)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1128 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.2468` → IC=+0.258 (n=850)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2468 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `1.4778` → IC=+0.245 (n=1433)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4778 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `2.765` → IC=+0.235 (n=1433)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.765 (IC base=+0.087)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.277 (n=3789)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.087)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.139 (n=2676)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0086 (IC base=+0.068)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.150 (n=7073)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5556 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` > `0.6822` → IC=+0.244 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6822 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` < `0.1661` → IC=+0.231 (n=2072)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1661 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.231 (n=976)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` > `1.2011` → IC=+0.248 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2011 (IC base=+0.068)

- **PATRÓN** `volumen_pendiente_norm` > `0.2515` → IC=+0.319 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2515 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` < `1.4935` → IC=+0.253 (n=962)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4935 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` > `2.37` → IC=+0.255 (n=1308)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.37 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.256 (n=2745)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.068)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2346` → IC=-0.143 (n=544)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2346
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1634)

- **FILTRO** `sigma_ewma_delta_pct` > `4.413` → IC=-0.166 (n=396)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.413
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=1336)

- **PATRÓN** `ibs_20min` > `0.8636` → IC=+0.250 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8636 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.293` → IC=+0.150 (n=736)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 3.293 (IC base=+0.037)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4427` → IC=+0.193 (n=187)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.4427 (IC base=+0.037)
...
- **FILTRO** `ibs_20min` > `0.8242` → IC=-0.148 (n=591)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1775)

- **PATRÓN** `dist_vwap_pct` > `0.2987` → IC=+0.135 (n=258)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.2987 (IC base=+0.012)

- **PATRÓN** `dist_vwap_pct` < `0.1619` → IC=+0.132 (n=596)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.1619 (IC base=+0.012)

- **PATRÓN** `volumen_regimen` < `1.0507` → IC=+0.132 (n=612)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0507 (IC base=+0.012)

- **PATRÓN** `volumen_regimen` > `0.6498` → IC=+0.141 (n=622)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6498 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` > `0.2195` → IC=+0.172 (n=126)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.2195 (IC base=+0.012)

- **PATRÓN** `volumen_spike_ratio` < `1.4208` → IC=+0.180 (n=226)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.4208 (IC base=+0.012)

- **PATRÓN** `ballena_activa_n` < `230.0` → IC=+0.190 (n=224)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 230.0 (IC base=+0.012)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.263 (n=1125)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.0983` → IC=+0.246 (n=420)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0983 (IC base=+0.236)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.241 (n=635)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.236)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.249 (n=472)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.534` → IC=+0.273 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.534 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.1109` → IC=+0.253 (n=1057)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1109 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` < `1.8808` → IC=+0.239 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8808 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` > `3.6325` → IC=+0.253 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6325 (IC base=+0.236)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.253 (n=1432)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.236)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.295 (n=1005)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.774` → IC=+0.296 (n=385)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.774 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.589` → IC=+0.278 (n=1081)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.589 (IC base=+0.278)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6355` → IC=+0.280 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6355 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` > `2.2358` → IC=+0.280 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2358 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.284 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `1878.6984` → IC=+0.304 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1878.6984 (IC base=+0.278)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.273 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 21.0 (IC base=+0.278)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.245` → IC=-0.210 (n=363)

  - _Acción_: SKIP cuando `ibs_20min` < 0.245
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1092)

- **FILTRO** `ibs_20min` > `0.8058` → IC=-0.184 (n=473)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8058
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=1421)

- **PATRÓN** `ibs_20min` > `0.806` → IC=+0.148 (n=495)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.806 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` > `0.4545` → IC=+0.218 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4545 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` < `0.9683` → IC=+0.216 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9683 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` > `0.6179` → IC=+0.200 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6179 (IC base=-0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.2663` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2663 (IC base=-0.011)

- **PATRÓN** `volumen_spike_ratio` < `1.4764` → IC=+0.268 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4764 (IC base=-0.011)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.247 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 164.0 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` > `0.1237` → IC=+0.195 (n=103)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1237 (IC base=-0.017)

- **PATRÓN** `dist_vwap_pct` < `0.2864` → IC=+0.177 (n=258)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2864 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` < `1.1494` → IC=+0.175 (n=247)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.1494 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` > `0.7204` → IC=+0.185 (n=220)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.7204 (IC base=-0.017)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4278` → IC=+0.246 (n=69)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4278 (IC base=-0.017)

- **PATRÓN** `volumen_spike_ratio` > `2.3766` → IC=+0.257 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3766 (IC base=-0.017)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.245 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=-0.017)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6727` → IC=-0.209 (n=855)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6727
  - _Potencial_: sin este filtro IC_bueno=+0.261 (n=856)

- **FILTRO** `ibs_20min` > `0.7108` → IC=-0.234 (n=452)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.677` → IC=-0.176 (n=421)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=1389)

- **PATRÓN** `ibs_20min` > `0.6727` → IC=+0.261 (n=856)
...
- **PATRÓN** `volumen_regimen` < `0.8622` → IC=+0.290 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8622 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.7198` → IC=+0.277 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7198 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` < `0.105` → IC=+0.279 (n=551)
...
- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.321 (n=490)
...
- **PATRÓN** `sigma_h` > `0.0156` → IC=+0.324 (n=709)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0156 (IC base=+0.272)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.278 (n=1114)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.272)

- **PATRÓN** `ibs_20min` > `0.9043` → IC=+0.348 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9043 (IC base=+0.272)

- **PATRÓN** `dist_vwap_pct` > `0.2668` → IC=+0.317 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2668 (IC base=+0.272)
...
- **PATRÓN** `volumen_regimen` > `0.6815` → IC=+0.288 (n=952)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.438` → IC=+0.291 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.438 (IC base=+0.268)

- **PATRÓN** `volumen_regimen` > `1.244` → IC=+0.305 (n=392)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1674` → IC=+0.270 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1674 (IC base=+0.268)

- **PATRÓN** `libro_liquidez` > `2350.7606` → IC=+0.274 (n=1049)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2350.7606 (IC base=+0.268)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.177 (n=2085)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0048 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.200 (n=2081)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0105 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.3377` → IC=+0.173 (n=5494)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3377 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6501)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.5827` → IC=+0.214 (n=6243)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5827 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9426` → IC=+0.219 (n=928)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9426 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.233` → IC=+0.248 (n=1286)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.233 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.163 (n=4150)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2145 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` > `0.6204` → IC=+0.159 (n=4150)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6204 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.1068` → IC=+0.185 (n=2434)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1068 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `1.5658` → IC=+0.174 (n=2612)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.5658 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6656` → IC=+0.167 (n=1979)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.6656 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `3825.7125` → IC=+0.169 (n=2081)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3825.7125 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.182 (n=5151)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 121.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.186 (n=4046)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0064 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0798` → IC=+0.203 (n=2020)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4667` → IC=+0.228 (n=6063)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4667 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2227` → IC=+0.161 (n=4524)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2227 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.227` → IC=+0.197 (n=1046)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.227 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.187` → IC=+0.156 (n=4429)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.187 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6234` → IC=+0.150 (n=4429)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6234 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2924` → IC=+0.230 (n=867)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2924 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `1.5762` → IC=+0.173 (n=2378)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.5762 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.2831` → IC=+0.174 (n=2450)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2831 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.172 (n=5025)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.198 (n=481)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0072 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.3196` → IC=+0.201 (n=1059)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3196 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.208 (n=519)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2291` → IC=+0.238 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2291 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` < `2.5428` → IC=+0.178 (n=964)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.5428 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `1.4266` → IC=+0.179 (n=963)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4266 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.204 (n=996)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.241 (n=673)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.236)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.246 (n=683)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.1819` → IC=+0.293 (n=510)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1819 (IC base=+0.236)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.243 (n=788)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.236)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.239 (n=765)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.236)

- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.256 (n=765)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3333 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.049` → IC=+0.252 (n=827)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.049 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.0955` → IC=+0.232 (n=624)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4302` → IC=+0.251 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4302 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` > `2.6495` → IC=+0.242 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6495 (IC base=+0.236)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `1741.291` → IC=+0.258 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1741.291 (IC base=+0.236)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3663` → IC=+0.169 (n=914)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3663 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=965)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4268` → IC=+0.223 (n=914)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4268 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2074` → IC=+0.208 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2074 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.528` → IC=+0.220 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.528 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2593` → IC=+0.174 (n=914)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.2593 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2311` → IC=+0.183 (n=200)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2311 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.4127` → IC=+0.196 (n=294)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.4127 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `10075.6475` → IC=+0.176 (n=914)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 10075.6475 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.167 (n=1034)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5378` → IC=+0.189 (n=1034)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.5378 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.1347` → IC=+0.165 (n=1053)
...
- **PATRÓN** `volumen_regimen` < `1.215` → IC=+0.160 (n=1034)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4356` → IC=+0.158 (n=924)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4356 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `227.0` → IC=+0.163 (n=280)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 227.0 (IC base=+0.146)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.205 (n=690)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0075 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.1976` → IC=+0.201 (n=690)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1976 (IC base=+0.189)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.222 (n=358)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.286 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.698` → IC=+0.269 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.698 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` < `0.216` → IC=+0.185 (n=994)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.216 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.1354` → IC=+0.188 (n=398)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1354 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.6698` → IC=+0.195 (n=323)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.6698 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `3.6406` → IC=+0.205 (n=323)
...
- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.226 (n=578)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.222)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.221 (n=870)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0056 (IC base=+0.222)

- **PATRÓN** `drift_60min` |x|≤ `0.0935` → IC=+0.246 (n=289)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3456` → IC=+0.251 (n=867)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3456 (IC base=+0.222)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.666` → IC=+0.272 (n=357)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8456` → IC=+0.216 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8456 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `3.5271` → IC=+0.243 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5271 (IC base=+0.222)

- **PATRÓN** `libro_liquidez` > `1889.461` → IC=+0.239 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1889.461 (IC base=+0.222)

- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.217 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 19.0 (IC base=+0.222)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.181 (n=864)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.4227` → IC=+0.167 (n=982)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.4227 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.188 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 17.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.204 (n=982)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3963 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1357` → IC=+0.192 (n=637)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1357 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.071` → IC=+0.247 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.071 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.8577` → IC=+0.161 (n=655)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8577 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.1941` → IC=+0.167 (n=328)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1941 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1718` → IC=+0.157 (n=844)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1718 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `2.5111` → IC=+0.180 (n=320)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.5111 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `7083.9363` → IC=+0.190 (n=655)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 7083.9363 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `119.0` → IC=+0.167 (n=614)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 119.0 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.164 (n=1060)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0072 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.3804` → IC=+0.145 (n=1061)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.3804 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.181 (n=418)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 17.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` < `0.6028` → IC=+0.181 (n=1060)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6028 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` < `0.15` → IC=+0.145 (n=1065)
...
- **PATRÓN** `volumen_regimen` < `0.856` → IC=+0.143 (n=707)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.856 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `0.609` → IC=+0.132 (n=1060)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.609 (IC base=+0.130)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4786` → IC=+0.143 (n=315)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 2.4786 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `10039.916` → IC=+0.158 (n=481)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 10039.916 (IC base=+0.130)

- **PATRÓN** `ballena_activa_n` < `177.0` → IC=+0.128 (n=876)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 177.0 (IC base=+0.130)
...
- **PATRÓN** `ibs_20min` > `0.5` → IC=+0.197 (n=1171)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.47` → IC=+0.258 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.47 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.122 (n=1159)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2208 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4456` → IC=+0.134 (n=372)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.4456 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1196)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.191 (n=526)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.132 (n=856)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 49.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.148 (n=513)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0059 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.171 (n=539)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.55` → IC=+0.208 (n=1163)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.55 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.1871` → IC=+0.134 (n=1075)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1871 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.385` → IC=+0.164 (n=248)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 7.385 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `1.1939` → IC=+0.123 (n=1163)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.1939 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.279` → IC=+0.183 (n=140)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.279 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.462` → IC=+0.140 (n=340)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.462 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.177` → IC=+0.132 (n=462)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 2.177 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `3078.551` → IC=+0.162 (n=388)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3078.551 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0182` → IC=+0.213 (n=731)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0182 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.1686` → IC=+0.211 (n=483)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.206 (n=495)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.7277` → IC=+0.254 (n=979)
...
- **PATRÓN** `volumen_regimen` < `1.2075` → IC=+0.207 (n=1096)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2075 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6101` → IC=+0.209 (n=1096)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.212 (n=536)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.244 (n=1177)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.44 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.1587` → IC=+0.230 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1587 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` < `0.2677` → IC=+0.204 (n=1227)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2677 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.349` → IC=+0.239 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.349 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.217 (n=1173)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.160 (n=504)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.140 (n=1682)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8478.1762` → IC=+0.150 (n=686)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8478.1762 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `157.0` → IC=+0.156 (n=1290)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 157.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.147 (n=539)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0038 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.34` → IC=+0.131 (n=1416)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4872` → IC=+0.156 (n=1416)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4872 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2028` → IC=+0.120 (n=1431)
...
- **PATRÓN** `volumen_regimen` < `1.2224` → IC=+0.121 (n=1427)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2349` → IC=+0.137 (n=1355)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.2349 (IC base=+0.115)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1084` → IC=+0.136 (n=152)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.1084 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.144 (n=313)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 10.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.2893` → IC=+0.131 (n=345)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` > 0.2893 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.5233` → IC=+0.144 (n=71)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.5233 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.31` → IC=+0.144 (n=161)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 3.31 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `0.6949` → IC=+0.156 (n=152)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6949 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `10160.0205` → IC=+0.125 (n=345)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 10160.0205 (IC base=+0.097)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.150 (n=493)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.3402 (IC base=+0.128)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.406` → IC=+0.144 (n=200)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 4.406 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.093` → IC=+0.128 (n=557)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 9.093 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `1.208` → IC=+0.128 (n=493)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.208 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `1.0619` → IC=+0.173 (n=224)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 1.0619 (IC base=+0.128)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4163` → IC=+0.151 (n=483)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4163 (IC base=+0.128)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.162 (n=155)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 158.0 (IC base=+0.128)
...
- **FILTRO** `dist_vwap_pct` > `0.3436` → IC=-0.147 (n=32)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=403)
...
- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.150 (n=327)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.4783 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.235` → IC=+0.140 (n=109)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 5.235 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` < `0.7097` → IC=+0.151 (n=144)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7097 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` < `1.8782` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.8782 (IC base=+0.086)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.194 (n=3595)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4722` → IC=+0.213 (n=7906)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4722 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.8989` → IC=+0.201 (n=1017)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8989 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.588` → IC=+0.222 (n=3873)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.588 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8828` → IC=+0.167 (n=3542)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.8828 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2399` → IC=+0.189 (n=1493)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2399 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6361` → IC=+0.182 (n=2512)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6361 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3810.3548` → IC=+0.169 (n=2635)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3810.3548 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `93.0` → IC=+0.194 (n=5760)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 93.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.195 (n=4841)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0067 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.4808` → IC=+0.183 (n=7261)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.238 (n=7261)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5597 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2323` → IC=+0.162 (n=4623)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2323 (IC base=+0.181)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.693` → IC=+0.182 (n=7016)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.693 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7031` → IC=+0.158 (n=2214)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7031 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2044` → IC=+0.157 (n=1674)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.2044 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.249 (n=946)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.3003` → IC=+0.190 (n=2959)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3003 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.191 (n=2055)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 25.0 (IC base=+0.181)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.228 (n=609)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.264 (n=1042)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0043 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.2026` → IC=+0.283 (n=693)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3404` → IC=+0.285 (n=915)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3404 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.427` → IC=+0.264 (n=1091)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1081)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1742.04` → IC=+0.276 (n=693)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1843` → IC=+0.154 (n=839)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1843 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1313)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.3243` → IC=+0.198 (n=1257)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3243 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.1264` → IC=+0.185 (n=693)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1264 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.774` → IC=+0.161 (n=293)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 9.774 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.358` → IC=+0.153 (n=1121)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.358 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6942` → IC=+0.183 (n=554)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6942 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.154` → IC=+0.181 (n=343)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.154 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.1148` → IC=+0.156 (n=1059)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1148 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7544` → IC=+0.157 (n=802)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7544 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10893.2461` → IC=+0.165 (n=1123)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 10893.2461 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `490.0` → IC=+0.160 (n=1134)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 490.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.169 (n=1122)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0058 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.263` → IC=+0.167 (n=986)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6376` → IC=+0.205 (n=1120)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6376 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.6982` → IC=+0.161 (n=169)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.6982 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.1309` → IC=+0.164 (n=1037)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1309 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.226` → IC=+0.167 (n=556)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.226 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `1.2004` → IC=+0.161 (n=1120)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1272)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.249 (n=1123)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6739 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.6` → IC=+0.297 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.6 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` < `0.2176` → IC=+0.215 (n=1218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2176 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.9918` → IC=+0.232 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9918 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.224 (n=1440)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.236 (n=1201)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.232)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.235 (n=546)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3642` → IC=+0.267 (n=1057)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3642 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.72` → IC=+0.273 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.72 (IC base=+0.232)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.243 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `1892.3107` → IC=+0.237 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1892.3107 (IC base=+0.232)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.258 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 15.0 (IC base=+0.232)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.173 (n=589)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0039 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.433` → IC=+0.140 (n=1339)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.433 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.148 (n=1400)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.7029` → IC=+0.232 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7029 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.3523` → IC=+0.177 (n=493)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3523 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.205` → IC=+0.162 (n=566)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.205 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8789` → IC=+0.160 (n=893)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.121 (n=902)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4673` → IC=+0.182 (n=1353)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.4673 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `1.0059` → IC=+0.195 (n=234)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 1.0059 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.408` → IC=+0.223 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.408 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=940)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2913.9614` → IC=+0.244 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2913.9614 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.126 (n=1009)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 53.0 (IC base=+0.099)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.173 (n=438)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0055 (IC base=+0.113)
...
- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.207 (n=1314)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.4678` → IC=+0.130 (n=1295)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4678 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.446` → IC=+0.126 (n=1263)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.446 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.7164` → IC=+0.153 (n=578)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7164 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2215` → IC=+0.167 (n=205)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5681` → IC=+0.123 (n=385)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 2.5681 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2902.3615` → IC=+0.161 (n=438)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2902.3615 (IC base=+0.113)
...
- **PATRÓN** `ibs_20min` > `0.5124` → IC=+0.245 (n=1365)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5124 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.1867` → IC=+0.234 (n=771)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1867 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.357` → IC=+0.248 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.357 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` < `1.2484` → IC=+0.210 (n=1366)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2484 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `0.6268` → IC=+0.209 (n=1366)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5793` → IC=+0.238 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5793 (IC base=+0.206)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1383)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `2574.5944` → IC=+0.212 (n=910)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2574.5944 (IC base=+0.206)

- **PATRÓN** `sigma_h` < `0.008` → IC=+0.237 (n=504)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.008 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0255` → IC=+0.225 (n=503)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.51` → IC=+0.254 (n=1509)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.51 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.2695` → IC=+0.204 (n=1406)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2695 (IC base=+0.200)
...
- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.237 (n=503)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2324` → IC=+0.193 (n=1169)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2324 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4468` → IC=+0.197 (n=1329)
...
- **PATRÓN** `libro_liquidez` > `2549.3704` → IC=+0.200 (n=1006)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.137 (n=2587)
...
- **PATRÓN** `drift_60min` |x|≤ `0.488` → IC=+0.155 (n=1952)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.160 (n=654)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.309` → IC=+0.143 (n=1935)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.309 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.1151` → IC=+0.144 (n=1631)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1151 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5707` → IC=+0.139 (n=1933)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.5707 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.824` → IC=+0.146 (n=1288)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.824 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.137 (n=2587)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.01 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7675.5901` → IC=+0.151 (n=1744)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7675.5901 (IC base=+0.135)
...
- **FILTRO** `hora_utc` > `12.0` → IC=-0.235 (n=96)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 12.0
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=290)
...
- **PATRÓN** `ibs_20min` > `0.6471` → IC=+0.221 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6471 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1296` → IC=+0.173 (n=301)
...
- **PATRÓN** `volumen_regimen` < `1.0919` → IC=+0.130 (n=582)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0919 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `0.975` → IC=+0.124 (n=264)
...
- **PATRÓN** `volumen_spike_ratio` < `2.116` → IC=+0.171 (n=417)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.116 (IC base=+0.106)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.139 (n=471)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.02 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.159 (n=253)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.0688` → IC=+0.292 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0688 (IC base=-0.023)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.981` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 3.981 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.0857` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0857 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `2.6098` → IC=+0.150 (n=155)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.6098 (IC base=-0.023)

- **PATRÓN** `libro_liquidez` > `2977.6678` → IC=+0.150 (n=58)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2977.6678 (IC base=-0.023)

### GBM_LATE_60M#BTC#60min
- **FILTRO** `ibs_20min` < `0.5881` → IC=-0.176 (n=66)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5881
  - _Potencial_: sin este filtro IC_bueno=+0.213 (n=200)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.178 (n=231)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.006 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.201 (n=85)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` > `0.5881` → IC=+0.213 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5881 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `0.4172` → IC=+0.218 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4172 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.524` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 13.524 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `1.0504` → IC=+0.140 (n=176)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.201 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.108)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=205)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `2866.2796` → IC=+0.128 (n=186)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 2866.2796 (IC base=+0.108)
...
- **PATRÓN** `ibs_20min` > `0.649` → IC=+0.250 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.649 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` > `0.4992` → IC=+0.204 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4992 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.057` → IC=+0.314 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.057 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` < `1.0679` → IC=+0.157 (n=202)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.0679 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` > `0.6219` → IC=+0.150 (n=181)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6219 (IC base=+0.125)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7387` → IC=+0.192 (n=102)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.7387 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` > `1.3826` → IC=+0.156 (n=152)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.3826 (IC base=+0.125)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.153 (n=211)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.02 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `1103.6894` → IC=+0.193 (n=177)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 1103.6894 (IC base=+0.125)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.174 (n=93)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0059 (IC base=+0.082)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.141 (n=140)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 14.0 (IC base=+0.082)

- **PATRÓN** `ibs_20min` > `0.6757` → IC=+0.200 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6757 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` > `0.1718` → IC=+0.148 (n=103)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.1718 (IC base=+0.082)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.626` → IC=+0.197 (n=97)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 3.626 (IC base=+0.082)

- **PATRÓN** `volumen_regimen` > `1.0632` → IC=+0.145 (n=60)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.0632 (IC base=+0.082)

- **PATRÓN** `volumen_pendiente_norm` > `0.0894` → IC=+0.167 (n=76)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0894 (IC base=+0.082)

- **PATRÓN** `volumen_spike_ratio` < `2.5485` → IC=+0.156 (n=161)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.5485 (IC base=+0.082)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.156 (n=184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 16.0 (IC base=+0.113)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.127 (n=488)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` > 0.5 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2833.8623` → IC=+0.163 (n=170)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2833.8623 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=531)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2313.761` → IC=+0.125 (n=561)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 2313.761 (IC base=+0.100)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1348)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=586)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=1067)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5531)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=6480)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1394)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.179 (n=2724)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=8273)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=2814)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8655)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.217 (n=447)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1414)

- **FILTRO** `ibs_20min` < `0.7475` → IC=-0.179 (n=465)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7475
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1396)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.167 (n=472)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=1574)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.120 (n=1104)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.204 (n=465)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1443)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.217 (n=483)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1539)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.165 (n=500)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1522)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.201 (n=450)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1383)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2441)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2483)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7880)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=17902)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=6064)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=19718)

- **FILTRO** `ibs_7min` < `0.7024` → IC=-0.242 (n=6444)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7024
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=19338)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=8764)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=17018)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=8043)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=24262)

- **FILTRO** `ibs_7min` > `0.2958` → IC=-0.176 (n=8072)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2958
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=24233)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=983)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3174)
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.196 (n=970)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3187)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.150 (n=3760)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=1854)

- **FILTRO** `drift_7min_pct` |x|> `0.137` → IC=-0.132 (n=1403)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.137
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=4211)

- **FILTRO** `ibs_7min` > `0.7979` → IC=-0.207 (n=1403)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7979
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4211)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.136 (n=1040)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.257 (n=1057)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3444)

- **FILTRO** `ibs_7min` < `0.7555` → IC=-0.187 (n=1124)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7555
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3377)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1124)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3377)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.256 (n=1076)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3483)

- **FILTRO** `ibs_7min` > `0.2534` → IC=-0.169 (n=1139)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2534
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3420)

- **FILTRO** `ballena_activa_n` > `152.0` → IC=-0.179 (n=1138)

  - _Acción_: SKIP cuando `ballena_activa_n` > 152.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3421)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.180 (n=954)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=2937)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.319 (n=939)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2952)

- **FILTRO** `drift_7min_pct` |x|> `0.181` → IC=-0.131 (n=1321)
...
- **FILTRO** `ibs_7min` < `0.2` → IC=-0.276 (n=961)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2930)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.220 (n=913)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=2978)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.234 (n=1390)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4526)

- **FILTRO** `ibs_7min` > `0.2611` → IC=-0.154 (n=2009)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2611
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=3907)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1344)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1039)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3207)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.190 (n=1060)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3186)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.184 (n=1048)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3198)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1071)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3267)

- **FILTRO** `ibs_7min` > `0.2739` → IC=-0.174 (n=1084)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2739
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3254)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.181 (n=1070)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3268)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.255 (n=1112)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3524)

- **FILTRO** `ibs_7min` < `0.7176` → IC=-0.220 (n=1159)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7176
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3477)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.170 (n=1476)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4642)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.283 (n=1065)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3286)

- **FILTRO** `ibs_7min` < `0.725` → IC=-0.233 (n=1087)

  - _Acción_: SKIP cuando `ibs_7min` < 0.725
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=3264)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.210 (n=1065)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3286)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.207 (n=1360)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=4400)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3986` → IC=+0.137 (n=642)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.68€ cuando `delta_ratio` |x|> 0.3986 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.130 (n=577)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 6.0 (IC base=+0.120)

- **PATRÓN** `total_vol_5m` < `471.727` → IC=+0.150 (n=215)

  - _Acción_: Kelly boost +0.75€ cuando `total_vol_5m` < 471.727 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `3728.089` → IC=+0.122 (n=292)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 3728.089 (IC base=+0.120)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.130 (n=274)
...
- **PATRÓN** `delta_ratio` |x|> `0.4382` → IC=+0.147 (n=49)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.74€ cuando `delta_ratio` |x|> 0.4382 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.129)

- **PATRÓN** `total_vol_5m` < `445.688` → IC=+0.134 (n=129)

  - _Acción_: Kelly boost +0.67€ cuando `total_vol_5m` < 445.688 (IC base=+0.129)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=568)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=949)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2381)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1225)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1233)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.184 (n=371)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.004 (IC base=+0.174)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.204 (n=505)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0075 (IC base=+0.174)

- **PATRÓN** `drift_60min` |x|≤ `0.1648` → IC=+0.178 (n=978)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.1648 (IC base=+0.174)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0589` → IC=+0.175 (n=1111)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio_macro` |x|> 0.0589 (IC base=+0.174)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1333` → IC=+0.226 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1333 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.180 (n=789)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 11.0 (IC base=+0.174)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.188 (n=537)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 6.0 (IC base=+0.174)

- **PATRÓN** `ibs_15` > `0.6216` → IC=+0.246 (n=1111)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6216 (IC base=+0.174)

- **PATRÓN** `dist_vwap_pct` < `0.1047` → IC=+0.178 (n=737)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.1047 (IC base=+0.174)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.764` → IC=+0.238 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.764 (IC base=+0.174)

- **PATRÓN** `libro_liquidez` > `2630.1666` → IC=+0.179 (n=993)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.198 (n=94)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.005 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.0591` → IC=+0.271 (n=94)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0591 (IC base=+0.193)

- **PATRÓN** `drift_15min` |x|≤ `0.3766` → IC=+0.208 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3766 (IC base=+0.193)

- **PATRÓN** `delta_ratio_macro` |x|> `0.252` → IC=+0.198 (n=94)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.99€ cuando `delta_ratio_macro` |x|> 0.252 (IC base=+0.193)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1506` → IC=+0.253 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1506 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.210 (n=291)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.193)

- **PATRÓN** `ibs_15` > `0.7112` → IC=+0.248 (n=280)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7112 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.243 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.1019` → IC=+0.197 (n=196)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.1019 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.624` → IC=+0.250 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.624 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `14100.1799` → IC=+0.221 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14100.1799 (IC base=+0.193)

### UPDOWN_GBM#BTC#60min
- **PATRÓN** `sigma_ewma_delta_pct` > `20.351` → IC=+0.134 (n=69)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 20.351 (IC base=-0.001)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.174 (n=90)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0033 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0038` → IC=+0.142 (n=241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0038 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1407` → IC=+0.165 (n=180)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.82€ cuando `delta_ratio_macro` |x|> 0.1407 (IC base=+0.140)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2725` → IC=+0.169 (n=176)

  - _Acción_: Kelly boost +0.84€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2725 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.150 (n=201)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 11.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.156 (n=120)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 6.0 (IC base=+0.140)

- **PATRÓN** `ibs_15` > `0.6485` → IC=+0.228 (n=270)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6485 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.4093` → IC=+0.154 (n=284)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.4093 (IC base=+0.140)
...
- **PATRÓN** `libro_liquidez` > `11704.6865` → IC=+0.141 (n=90)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 11704.6865 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.258 (n=209)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0648` → IC=+0.195 (n=280)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.98€ cuando `delta_ratio_macro` |x|> 0.0648 (IC base=+0.185)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0933` → IC=+0.287 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0933 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.240 (n=156)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.185)

- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.278 (n=313)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` > `0.167` → IC=+0.205 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.167 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.3078` → IC=+0.184 (n=299)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.3078 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.55` → IC=+0.240 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.55 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.185 (n=341)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.03 (IC base=+0.185)

- **PATRÓN** `libro_liquidez` > `2813.5755` → IC=+0.257 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2813.5755 (IC base=+0.185)

- **PATRÓN** `ibs_15` < `0.1111` → IC=+0.175 (n=355)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0125` → IC=-0.204 (n=542)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0125
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1628)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.176 (n=687)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1483)

- **FILTRO** `libro_liquidez` < `3781.8456` → IC=-0.122 (n=1432)

  - _Acción_: SKIP cuando `libro_liquidez` < 3781.8456
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=738)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2098` → IC=+0.240 (n=391)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2098 (IC base=-0.044)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1825` → IC=+0.240 (n=749)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1825 (IC base=-0.044)

- **PATRÓN** `ibs_15` < `0.356` → IC=+0.281 (n=1173)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.356 (IC base=-0.044)

- **PATRÓN** `dist_vwap_pct` > `0.6573` → IC=+0.268 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6573 (IC base=-0.044)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.208 (n=327)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.194 (n=984)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.228 (n=432)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.182 (n=879)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.207 (n=837)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.181 (n=474)

- **FILTRO** `sigma_ewma_delta_pct` > `19.873` → IC=-0.240 (n=233)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.873
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1078)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1422` → IC=+0.311 (n=51)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1422 (IC base=+0.070)
...
- **PATRÓN** `dist_vwap_pct` > `0.1073` → IC=+0.253 (n=83)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1073 (IC base=+0.070)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.248 (n=495)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.226)

- **PATRÓN** `drift_60min` |x|≤ `0.4368` → IC=+0.228 (n=495)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.238 (n=330)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.226)

- **PATRÓN** `ibs_15` < `0.361` → IC=+0.269 (n=495)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.361 (IC base=+0.226)

- **PATRÓN** `dist_vwap_pct` > `0.3779` → IC=+0.250 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3779 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.263` → IC=+0.233 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.263 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.189` → IC=+0.230 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.189 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `3578.3819` → IC=+0.226 (n=495)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3578.3819 (IC base=+0.226)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.226 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 159.0 (IC base=+0.226)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `drift_15min` |x|> `0.8627` → IC=-0.235 (n=130)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.212 (n=196)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.115 (n=328)

- **PATRÓN** `ibs_15` > `0.8889` → IC=+0.342 (n=17)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8889 (IC base=-0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1511` → IC=+0.122 (n=43)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.1511 (IC base=-0.152)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.261 (n=174)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.152 (n=475)
...
- **PATRÓN** `ibs_15` < `0.3391` → IC=+0.308 (n=342)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.285 (n=538)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.221` → IC=+0.320 (n=287)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.221 (IC base=+0.284)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.302 (n=559)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.284)

- **PATRÓN** `ibs_15` > `0.8357` → IC=+0.322 (n=538)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8357 (IC base=+0.284)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.287 (n=659)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.284)

- **PATRÓN** `libro_liquidez` > `12706.4331` → IC=+0.297 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12706.4331 (IC base=+0.284)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6216 sube el IC de +0.174 a +0.246 en UPDOWN_GBM#15min (n=1111). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7112 sube el IC de +0.193 a +0.248 en UPDOWN_GBM#BTC#15min (n=280). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6485 sube el IC de +0.140 a +0.228 en UPDOWN_GBM#ETH#15min (n=270). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.185 a +0.278 en UPDOWN_GBM#XRP#15min (n=313). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1111 sube el IC de +0.048 a +0.175 en UPDOWN_GBM#XRP#15min (n=355). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6098 sube el IC de -0.059 a +0.251 en UPDOWN_GBM_15M_TARDIO (n=544). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.356 sube el IC de -0.044 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1173). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8098 sube el IC de +0.070 a +0.332 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=111). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.361 sube el IC de +0.226 a +0.269 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=495). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_YES, IBS > 0.8889 sube el IC de -0.152 a +0.342 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=17). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3391 sube el IC de -0.045 a +0.308 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=342). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8357 sube el IC de +0.284 a +0.322 en UPDOWN_GBM_IBS_ALTO (n=538). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 20975 | -0.099 | -3057.60€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1260 | -0.048 | -186.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19715 | -0.103 | -2870.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3227 | -0.110 | -558.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3227 | -0.110 | -558.12€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1260 | -0.048 | -186.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1260 | -0.048 | -186.97€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6012 | -0.043 | -591.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6012 | -0.043 | -591.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5578 | -0.106 | -475.32€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5578 | -0.106 | -475.32€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4524 | -0.170 | -1084.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4524 | -0.170 | -1084.72€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 12816 | -0.040 | +4231.29€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3436 | -0.006 | +1840.10€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 9380 | -0.053 | +2391.18€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 12816 | -0.040 | +4231.29€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3436 | -0.006 | +1840.10€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 9380 | -0.053 | +2391.18€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1090 | -0.108 | -164.71€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 78 | -0.087 | -15.58€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1012 | -0.110 | -149.13€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 622 | -0.088 | -77.40€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 54 | -0.089 | -10.35€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 568 | -0.088 | -67.05€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 303 | -0.152 | -68.41€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 279 | -0.158 | -63.19€ | 2 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 76186 | +0.113 | -3906.13€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 11854 | +0.183 | -358.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 294 | -0.115 | -42.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 58812 | +0.100 | -3383.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5226 | +0.115 | -122.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 9799 | +0.097 | -904.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 39 | -0.159 | -2.72€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 9745 | +0.099 | -889.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 15397 | +0.131 | -318.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3636 | +0.202 | -111.75€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 9743 | +0.109 | -193.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1976 | +0.115 | +8.71€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 9838 | +0.089 | -957.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 46 | -0.062 | -2.24€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 9777 | +0.090 | -944.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 16298 | +0.125 | -292.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4574 | +0.173 | -70.64€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 9832 | +0.108 | -166.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1880 | +0.099 | -46.74€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 15040 | +0.115 | -856.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3519 | +0.186 | -181.52€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 197 | -0.073 | +11.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 9954 | +0.091 | -601.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1370 | +0.136 | -84.26€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 9814 | +0.103 | -576.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 40 | +0.000 | +10.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 9761 | +0.103 | -586.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 12042 | +0.190 | -821.34€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 12042 | +0.190 | -821.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2952 | +0.168 | -319.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2952 | +0.168 | -319.43€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 686 | +0.186 | +6.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 686 | +0.186 | +6.58€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2891 | +0.178 | -265.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2891 | +0.178 | -265.15€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2599 | +0.237 | -79.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2599 | +0.237 | -79.68€ | 0 | 4 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2835 | +0.192 | -177.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2835 | +0.192 | -177.42€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 554 | +0.432 | -12.70€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 554 | +0.432 | -12.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 212 | +0.435 | -2.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 212 | +0.435 | -2.97€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH | 211 | +0.439 | -0.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH#15min | 211 | +0.439 | -0.31€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 123 | +0.404 | -8.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 123 | +0.404 | -8.39€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 41164 | +0.195 | -3409.93€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 41164 | +0.195 | -3409.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 7165 | +0.171 | -896.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 7165 | +0.171 | -896.26€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 6535 | +0.224 | -236.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 6535 | +0.224 | -236.06€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 7133 | +0.169 | -905.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 7133 | +0.169 | -905.01€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 6630 | +0.217 | -276.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 6630 | +0.217 | -276.19€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 6789 | +0.203 | -458.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 6789 | +0.203 | -458.77€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 6912 | +0.191 | -637.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 6912 | +0.191 | -637.64€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 15411 | +0.124 | +292.24€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 15411 | +0.124 | +292.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 7644 | +0.129 | +201.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 7644 | +0.129 | +201.72€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 7767 | +0.120 | +90.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 7767 | +0.120 | +90.52€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1261 | +0.288 | -22.90€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1261 | +0.288 | -22.90€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 603 | +0.292 | -2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 603 | +0.292 | -2.62€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 879 | +0.069 | -45.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 315 | +0.055 | -27.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 564 | +0.076 | -18.06€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 684 | +0.077 | -21.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 120 | +0.082 | -3.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 564 | +0.076 | -18.06€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 27373 | +0.098 | -826.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2301 | +0.094 | +31.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 25072 | +0.099 | -858.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 15582 | +0.103 | -229.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2301 | +0.094 | +31.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 13281 | +0.104 | -260.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 4810 | +0.115 | +35.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 4810 | +0.115 | +35.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 6981 | +0.077 | -632.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 6981 | +0.077 | -632.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 730 | +0.246 | -92.38€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 730 | +0.246 | -92.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 730 | +0.246 | -92.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 730 | +0.246 | -92.38€ | 0 | 4 |
| ✅ GBM_LATE_15M | 20177 | +0.075 | +9042.15€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 20177 | +0.075 | +9042.15€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 3314 | +0.194 | +2408.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 3314 | +0.194 | +2408.76€ | 0 | 20 |
| ✅ GBM_LATE_15M#BTC | 2976 | +0.173 | +1977.75€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2976 | +0.173 | +1977.75€ | 0 | 25 |
| ✅ GBM_LATE_15M#DOGE | 3456 | +0.194 | +2517.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 3456 | +0.194 | +2517.76€ | 0 | 22 |
| ✅ GBM_LATE_15M#ETH | 3009 | +0.005 | +464.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3009 | +0.005 | +464.77€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 2966 | -0.037 | +633.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2966 | -0.037 | +633.63€ | 4 | 12 |
| ✅ GBM_LATE_15M#XRP | 4456 | -0.050 | +1039.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 4456 | -0.050 | +1039.50€ | 4 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 21264 | +0.077 | +10539.10€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 21264 | +0.077 | +10539.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 3910 | +0.011 | +1949.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 3910 | +0.011 | +1949.68€ | 2 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 4486 | +0.006 | +844.65€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 4486 | +0.006 | +844.65€ | 1 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3015 | +0.255 | +2948.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3015 | +0.255 | +2948.42€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 3349 | -0.015 | +433.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 3349 | -0.015 | +433.21€ | 2 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 3521 | +0.014 | +1241.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 3521 | +0.014 | +1241.47€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 2983 | +0.270 | +3121.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 2983 | +0.270 | +3121.68€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 16402 | +0.169 | +12016.87€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 16402 | +0.169 | +12016.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2430 | +0.207 | +1926.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2430 | +0.207 | +1926.55€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 2596 | +0.154 | +1867.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 2596 | +0.154 | +1867.74€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2534 | +0.204 | +1973.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2534 | +0.204 | +1973.08€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 2722 | +0.141 | +1856.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 2722 | +0.141 | +1856.02€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3095 | +0.113 | +2008.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3095 | +0.113 | +2008.77€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3025 | +0.203 | +2384.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3025 | +0.203 | +2384.72€ | 0 | 28 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4161 | +0.125 | +1670.88€ | 0 | 24 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4161 | +0.125 | +1670.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 153 | +0.119 | +63.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 153 | +0.119 | +63.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1116 | +0.115 | +438.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1116 | +0.115 | +438.06€ | 0 | 19 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 871 | +0.085 | +240.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 871 | +0.085 | +240.56€ | 1 | 10 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 503 | +0.136 | +218.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 503 | +0.136 | +218.58€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO | 20219 | +0.173 | +14609.16€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 20219 | +0.173 | +14609.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3164 | +0.220 | +2653.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3164 | +0.220 | +2653.56€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3169 | +0.151 | +2067.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3169 | +0.151 | +2067.20€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 3277 | +0.221 | +2761.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 3277 | +0.221 | +2761.13€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 3226 | +0.138 | +2097.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 3226 | +0.138 | +2097.88€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 3552 | +0.106 | +2046.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 3552 | +0.106 | +2046.31€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 3831 | +0.203 | +2983.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 3831 | +0.203 | +2983.07€ | 0 | 23 |
| ✅ GBM_LATE_5M | 5979 | +0.141 | +3247.31€ | 1 | 25 |
| ✅ GBM_LATE_5M#5min | 5979 | +0.141 | +3247.31€ | 0 | 0 |
...
| ✅ GBM_LATE_60M | 1283 | +0.067 | +534.45€ | 2 | 16 |
| ✅ GBM_LATE_60M#60min | 1283 | +0.067 | +534.45€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 453 | +0.091 | +176.27€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 453 | +0.091 | +176.27€ | 1 | 18 |
| ✅ GBM_LATE_60M#ETH | 430 | +0.072 | +214.78€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 430 | +0.072 | +214.78€ | 2 | 15 |
| ✅ GBM_LATE_60M#SOL | 400 | +0.035 | +143.40€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 400 | +0.035 | +143.40€ | 1 | 11 |
| 🚫 GBM_LATE_60M_FADE | 304 | -0.268 | -24.37€ | 4 | 0 |
| 🚫 GBM_LATE_60M_FADE#60min | 304 | -0.268 | -24.37€ | 0 | 0 |
...
| 🚫 GBM_LATE_60M_FADE#SOL | 88 | -0.278 | -2.72€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#SOL#60min | 88 | -0.278 | -2.72€ | 3 | 0 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 241 | +0.047 | +38.92€ | 3 | 4 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1426 | +0.106 | +420.05€ | 0 | 5 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1426 | +0.106 | +420.05€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1426 | +0.106 | +420.05€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1426 | +0.106 | +420.05€ | 0 | 5 |
...
| ✅ LIQUIDACIONES_5M | 1546 | -0.003 | -3.84€ | 6 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 1546 | -0.003 | -3.84€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_5M#ETH | 633 | +0.023 | +16.29€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 633 | +0.023 | +16.29€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 13319 | -0.011 | -186.91€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 13319 | -0.011 | -186.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2465 | -0.023 | -50.10€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2465 | -0.023 | -50.10€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 2562 | +0.007 | -17.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 2562 | +0.007 | -17.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 2760 | -0.016 | -22.83€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 2760 | -0.016 | -22.83€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 3274 | -0.017 | -62.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 3274 | -0.017 | -62.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 1680 | -0.005 | -32.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 1680 | -0.005 | -32.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 22466 | -0.011 | +971.07€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 22466 | -0.011 | +971.07€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 3907 | +0.010 | +498.00€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 3907 | +0.010 | +498.00€ | 3 | 1 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 3623 | -0.026 | -26.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 3623 | -0.026 | -26.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 3930 | +0.004 | +307.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 3930 | +0.004 | +307.42€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3396 | -0.047 | -100.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3396 | -0.047 | -100.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 3757 | -0.015 | +155.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 3757 | -0.015 | +155.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 3853 | -0.001 | +136.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 3853 | -0.001 | +136.80€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5025 | -0.041 | -119.64€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5025 | -0.041 | -119.64€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1201 | +0.000 | -16.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1201 | +0.000 | -16.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 1093 | -0.049 | -21.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 1093 | -0.049 | -21.56€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE | 43 | -0.122 | -5.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE#15min | 43 | -0.122 | -5.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 470 | -0.121 | -20.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 470 | -0.121 | -20.69€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1372 | -0.058 | -29.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1372 | -0.058 | -29.80€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 58087 | -0.073 | +1171.04€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 58087 | -0.073 | +1171.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 9771 | -0.082 | +553.07€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 9771 | -0.082 | +553.07€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 9060 | -0.089 | -340.18€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 9060 | -0.089 | -340.18€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 9807 | -0.071 | +483.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 9807 | -0.071 | +483.49€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 8584 | -0.093 | -231.33€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 8584 | -0.093 | -231.33€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 10754 | -0.048 | +331.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 10754 | -0.048 | +331.21€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 10111 | -0.064 | +374.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 10111 | -0.064 | +374.77€ | 4 | 0 |
...
| ✅ ORDER_FLOW_5M | 992 | +0.112 | +341.96€ | 0 | 5 |
| ✅ ORDER_FLOW_5M#5min | 856 | +0.120 | +329.36€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 195 | +0.129 | +90.21€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 195 | +0.129 | +90.21€ | 0 | 3 |
...
| ✅ STREAK_FADE_5M | 2452 | -0.026 | -110.74€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2452 | -0.026 | -110.74€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 932 | -0.030 | -45.99€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 932 | -0.030 | -45.99€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 6575 | +0.022 | +92.05€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 6575 | +0.022 | +92.05€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2108 | +0.020 | +19.50€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2108 | +0.020 | +19.50€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1371 | +0.031 | +36.61€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1371 | +0.031 | +36.61€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 1910 | +0.013 | +2.89€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 1910 | +0.013 | +2.89€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1186 | +0.030 | +33.04€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1186 | +0.030 | +33.04€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 6054 | +0.012 | -33.69€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 6054 | +0.012 | -33.69€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2400 | +0.019 | +0.52€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2400 | +0.019 | +0.52€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2397 | +0.014 | -8.56€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2397 | +0.014 | -8.56€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1257 | -0.005 | -25.65€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1257 | -0.005 | -25.65€ | 2 | 0 |
| ✅ UPDOWN_GBM | 26269 | +0.030 | +1454.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 7046 | +0.058 | +1117.89€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 983 | +0.005 | +8.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 16542 | +0.023 | +330.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 1592 | -0.003 | -5.88€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 2312 | +0.071 | +219.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 289 | +0.119 | +85.72€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 19 | -0.023 | -0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2004 | +0.065 | +134.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 4741 | +0.032 | +311.91€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 863 | +0.082 | +194.26€ | 0 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 279 | +0.023 | +7.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 2855 | +0.029 | +104.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 704 | -0.001 | +4.55€ | 0 | 1 |
| ✅ UPDOWN_GBM#BTC#daily | 40 | -0.119 | +1.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 3092 | +0.032 | +103.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 243 | +0.116 | +65.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 16 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 2833 | +0.025 | +39.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 5411 | +0.016 | +212.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1932 | +0.045 | +213.04€ | 0 | 10 |
| ✅ UPDOWN_GBM#ETH#240min | 266 | +0.007 | +8.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 2611 | +0.001 | -5.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 567 | -0.006 | -7.29€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 35 | -0.149 | +3.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 6760 | +0.017 | +159.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1885 | +0.024 | +109.22€ | 1 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 260 | -0.008 | -2.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 4265 | +0.018 | +56.52€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 321 | +0.002 | -3.15€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 29 | -0.145 | -0.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 3951 | +0.042 | +448.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 1834 | +0.079 | +450.61€ | 0 | 12 |
| ✅ UPDOWN_GBM#XRP#240min | 143 | -0.010 | -3.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 1974 | +0.011 | +1.59€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 9226 | -0.048 | +1952.78€ | 3 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 9226 | -0.048 | +1952.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 424 | -0.054 | +341.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 424 | -0.054 | +341.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1765 | -0.129 | +30.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1765 | -0.129 | +30.81€ | 4 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 150 | +0.125 | +64.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 150 | +0.125 | +64.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1012 | +0.194 | +570.43€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1012 | +0.194 | +570.43€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 2948 | -0.062 | +457.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 2948 | -0.062 | +457.45€ | 2 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 2927 | -0.076 | +488.04€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 2927 | -0.076 | +488.04€ | 2 | 3 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 717 | +0.284 | +572.26€ | 0 | 10 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 717 | +0.284 | +572.26€ | 0 | 0 |
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=1882 IC=+0.024 PNL=+109.76€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.097 n=189/60 | contraria IC=+0.137 n=169 | gap=-0.041 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=567/40 IC=-0.006 PNL=-7.29€ | BTC#60min: n=704/40 IC=-0.001 PNL=+4.55€ | SOL#60min: n=321/40 IC=+0.002 PNL=-3.15€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.053 n=266488 | tras_1loss IC=+0.072 n=208297 | tras_2loss IC=+0.040 n=89084/40 | gap=+0.013 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1158 IC=-0.002 PNL=-11.42€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1158 IC=-0.002 PNL=-11.42€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=434 IC=-0.005 PNL=+5.54€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=434 IC=-0.005 PNL=+5.54€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.174 > 0.1 con n=1479 PNL=+840.25€
  - _Datos_: n=1479 IC=+0.174 PNL=+840.25€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=863 IC=+0.082 PNL=+194.26€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=863 IC=+0.082 PNL=+194.26€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=8561 IC=+0.049 PNL=+962.76€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=8561 IC=+0.049 PNL=+962.76€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1414 IC=+0.048 PNL=+163.23€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1414 IC=+0.048 PNL=+163.23€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=13884 IC=-0.144 PNL=+593.67€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=13884 IC=-0.144 PNL=+593.67€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1537 IC=+0.137 PNL=+800.93€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1537 IC=+0.137 PNL=+800.93€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.245 < -0.1 con n=1398 PNL=-209.05€
  - _Datos_: n=1398 IC=-0.245 PNL=-209.05€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.100 n=747) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=747 IC=+0.100 PNL=+198.11€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=7162 IC=+0.171 PNL=-897.39€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=7162 IC=+0.171 PNL=-897.39€
