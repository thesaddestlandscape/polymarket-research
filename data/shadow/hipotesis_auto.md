# Hipótesis automáticas — 2026-07-02 19:06 UTC
_Generado por shadow_postmortem.py sobre 2796 resoluciones (PNL=-52.42€)_
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M#XRP#15min` — IC=+0.175 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#XRP` — IC=+0.175 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 174 | +0.119 | +43.78€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 174 | +0.119 | +43.78€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 48 | +0.100 | +11.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 48 | +0.100 | +11.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 47 | +0.051 | +4.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 47 | +0.051 | +4.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 41 | +0.151 | +13.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 41 | +0.151 | +13.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 38 | +0.175 | +14.12€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 38 | +0.175 | +14.12€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1512 | +0.013 | +11.70€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1376 | +0.009 | -0.89€ | 0 | 0 |
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 152 ops con delta_ratio | SOL: 190 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.009 n=1337 | tras_1loss IC=-0.031 n=1368 | tras_2loss IC=-0.045 n=706/40 | gap=+0.054 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.038 n=117/40 PNL=+0.58€ | H=15h UTC: IC=+0.017 n=116/40 PNL=+5.20€ | H=17h UTC: IC=+0.200 n=58/40 PNL=+21.47€ | H=19h UTC: IC=+0.000 n=56/40 PNL=-4.71€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=370 IC=+0.059 PNL=+37.74€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=370 IC=+0.059 PNL=+37.74€
