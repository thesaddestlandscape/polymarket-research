# Hipótesis automáticas — 2026-09-24 04:27 UTC
_Generado por shadow_postmortem.py sobre 583820 resoluciones (PNL=+65378.00€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.95` → IC=-0.235 (n=6978)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.95
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=20940)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `138.64` → IC=-0.246 (n=918)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 138.64
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2754)
...
- **FILTRO** `restante_s_al_confirmar` < `127.21` → IC=-0.304 (n=862)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.21
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2589)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `164.74` → IC=-0.227 (n=1666)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.74
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4998)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.17` → IC=-0.357 (n=1379)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.17
  - _Potencial_: sin este filtro IC_bueno=-0.124 (n=4137)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.203 (n=13671)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=3435)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5621.0485` → IC=+0.175 (n=2189)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.137 (n=13637)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.128)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=10716)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5589)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `7788.6778` → IC=+0.175 (n=2106)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7788.6778 (IC base=+0.128)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=1657)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1511)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=2124)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `15820.2665` → IC=+0.217 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15820.2665 (IC base=+0.202)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.149 (n=348)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 7.0 (IC base=+0.108)

- **PATRÓN** `py_entrada` < `0.44` → IC=+0.145 (n=812)

  - _Acción_: Kelly boost +0.72€ cuando `py_entrada` < 0.44 (IC base=+0.108)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.145 (n=2359)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.238 (n=1462)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.138 (n=649)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1301.6177` → IC=+0.147 (n=646)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 1301.6177 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.162 (n=578)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.199 (n=10781)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.225 (n=3756)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.173 (n=2598)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.182 (n=1909)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.185 (n=2570)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 17.0 (IC base=+0.179)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.188 (n=1147)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.73 (IC base=+0.179)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.195 (n=2513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 17.0 (IC base=+0.193)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.196 (n=1928)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.235 (n=15046)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.180 (n=4642)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 12.0 (IC base=+0.175)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=6244)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=5983)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.222)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.273 (n=2138)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=6103)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=2082)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.446 (n=425)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.440)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4813` → IC=+0.120 (n=7894)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.4813 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.9831` → IC=+0.243 (n=2633)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9831 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.8477` → IC=+0.251 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8477 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` < `0.6359` → IC=+0.248 (n=2215)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6359 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.96` → IC=+0.177 (n=3032)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.96 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.246 (n=2124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` > `1.0481` → IC=+0.257 (n=963)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0481 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.3047` → IC=+0.217 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3047 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` > `1.9076` → IC=+0.204 (n=3595)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9076 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.134 (n=9533)
...
- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.174 (n=3017)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` < `0.6987` → IC=+0.181 (n=1465)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3485` → IC=+0.166 (n=1786)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3485 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=866)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 15.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.169 (n=1197)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.137` → IC=+0.269 (n=765)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.251 (n=1199)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.0905` → IC=+0.284 (n=447)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.235 (n=1219)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.236)

- **PATRÓN** `ibs_20min` < `0.0538` → IC=+0.294 (n=590)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0538 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.421` → IC=+0.236 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.421 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.424` → IC=+0.249 (n=1394)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.424 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.092` → IC=+0.232 (n=1147)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6417` → IC=+0.243 (n=407)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6417 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `1799.71` → IC=+0.238 (n=894)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1799.71 (IC base=+0.236)
...
- **PATRÓN** `ibs_20min` > `0.9894` → IC=+0.267 (n=453)
...
- **PATRÓN** `dist_vwap_pct` < `0.5869` → IC=+0.218 (n=1420)
...
- **PATRÓN** `volumen_regimen` < `1.2518` → IC=+0.218 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2518 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `1.0807` → IC=+0.225 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0807 (IC base=+0.215)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7485` → IC=+0.218 (n=887)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7485 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.3728` → IC=+0.224 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3728 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `16606.2987` → IC=+0.221 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16606.2987 (IC base=+0.215)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.189 (n=1562)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.221 (n=703)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` < `0.0606` → IC=+0.248 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0606 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.635` → IC=+0.247 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.635 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.3581` → IC=+0.268 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3581 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `1.78` → IC=+0.212 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.78 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.2184` → IC=+0.220 (n=913)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2184 (IC base=+0.215)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.224 (n=1023)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `1880.6384` → IC=+0.232 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1880.6384 (IC base=+0.215)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.214 (n=1154)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.160 (n=98)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=2185)

- **PATRÓN** `ibs_20min` > `0.9422` → IC=+0.211 (n=354)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.692` → IC=+0.156 (n=699)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 4.692 (IC base=+0.022)
...
- **FILTRO** `ibs_20min` > `0.2568` → IC=-0.125 (n=2152)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2568
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=1061)

- **FILTRO** `sigma_ewma_delta_pct` > `8.651` → IC=-0.207 (n=346)
...
- **FILTRO** `drift_60min` |x|> `0.6598` → IC=-0.178 (n=554)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6598
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1666)

- **FILTRO** `ibs_20min` < `0.71` → IC=-0.157 (n=1463)

  - _Acción_: SKIP cuando `ibs_20min` < 0.71
  - _Potencial_: sin este filtro IC_bueno=+0.107 (n=757)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.199 (n=406)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1814)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.199 (n=816)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=2454)
...
- **PATRÓN** `dist_vwap_pct` > `0.8778` → IC=+0.265 (n=151)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8778 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` < `0.7387` → IC=+0.252 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7387 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` > `1.0875` → IC=+0.279 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0875 (IC base=-0.024)

- **PATRÓN** `volumen_pendiente_norm` > `0.1023` → IC=+0.277 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1023 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` < `2.1667` → IC=+0.254 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1667 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` > `1.4322` → IC=+0.245 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4322 (IC base=-0.024)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.196 (n=3302)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0097 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.4741` → IC=+0.187 (n=8834)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4741 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.7694` → IC=+0.290 (n=1039)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7694 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.591` → IC=+0.156 (n=4673)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.591 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6889` → IC=+0.246 (n=3132)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6889 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2956` → IC=+0.263 (n=835)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2956 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `1.4681` → IC=+0.240 (n=1898)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4681 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6771` → IC=+0.236 (n=1898)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6771 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.267 (n=5203)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.153 (n=3302)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5468` → IC=+0.153 (n=8698)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5468 (IC base=+0.073)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.525` → IC=-0.161 (n=520)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.525
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1748)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2236` → IC=+0.269 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2236 (IC base=+0.045)

- **PATRÓN** `volumen_spike_ratio` < `1.4393` → IC=+0.172 (n=285)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.4393 (IC base=+0.045)

- **PATRÓN** `volumen_spike_ratio` > `2.1547` → IC=+0.192 (n=388)
...
- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.157 (n=660)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4496` → IC=+0.224 (n=168)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4496 (IC base=+0.005)
...
- **PATRÓN** `ballena_activa_n` < `476.0` → IC=+0.214 (n=501)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 476.0 (IC base=+0.005)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=1642)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.244)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.247 (n=1389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.736` → IC=+0.280 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.736 (IC base=+0.244)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.253 (n=1108)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1953.345` → IC=+0.251 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1953.345 (IC base=+0.244)
...
- **FILTRO** `ibs_20min` < `0.2831` → IC=-0.186 (n=482)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2831
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1448)

- **FILTRO** `ibs_20min` > `0.7745` → IC=-0.182 (n=586)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7745
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=1759)

- **PATRÓN** `ibs_20min` > `0.9105` → IC=+0.178 (n=483)
...
- **PATRÓN** `volumen_regimen` < `0.9869` → IC=+0.234 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9869 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` > `0.5846` → IC=+0.208 (n=546)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5078` → IC=+0.264 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5078 (IC base=+0.010)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.240 (n=521)
...
- **FILTRO** `ibs_20min` < `0.7191` → IC=-0.199 (n=1047)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7191
  - _Potencial_: sin este filtro IC_bueno=+0.280 (n=1047)
...
- **PATRÓN** `ibs_20min` > `0.7191` → IC=+0.280 (n=1047)
...
- **PATRÓN** `volumen_regimen` < `0.8684` → IC=+0.302 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8684 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `0.7298` → IC=+0.293 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7298 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` < `0.1024` → IC=+0.292 (n=715)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4413` → IC=+0.321 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4413 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.311 (n=648)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.547` → IC=+0.301 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.547 (IC base=+0.277)

- **PATRÓN** `volumen_regimen` > `0.8621` → IC=+0.302 (n=857)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1554` → IC=+0.291 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1554 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1375)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2623.8724` → IC=+0.294 (n=857)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2623.8724 (IC base=+0.277)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2571)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.4779` → IC=+0.227 (n=7393)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4779 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2319` → IC=+0.159 (n=5376)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2319 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.321` → IC=+0.195 (n=1254)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.321 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.174` → IC=+0.153 (n=5364)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.174 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2914` → IC=+0.221 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2914 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5615` → IC=+0.168 (n=2954)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5615 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2562` → IC=+0.171 (n=3044)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2562 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.174 (n=6359)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.240 (n=845)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1881` → IC=+0.294 (n=639)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1881 (IC base=+0.240)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.244 (n=862)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.240)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.252 (n=474)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.240)

- **PATRÓN** `ibs_20min` < `0.3427` → IC=+0.266 (n=958)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3427 (IC base=+0.240)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.224` → IC=+0.253 (n=1034)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.224 (IC base=+0.240)

- **PATRÓN** `volumen_pendiente_norm` < `0.096` → IC=+0.236 (n=796)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.261 (n=140)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2827 (IC base=+0.240)
...
- **PATRÓN** `libro_liquidez` > `1802.6` → IC=+0.249 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1802.6 (IC base=+0.240)
...
- **PATRÓN** `ibs_20min` > `0.4068` → IC=+0.225 (n=1146)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4068 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.213 (n=681)
...
- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.162 (n=1147)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2628 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `0.8772` → IC=+0.165 (n=764)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.8772 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.2316` → IC=+0.200 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2316 (IC base=+0.160)
...
- **PATRÓN** `libro_liquidez` > `15909.7981` → IC=+0.161 (n=520)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 15909.7981 (IC base=+0.160)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.160 (n=1258)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0057 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.291` → IC=+0.161 (n=1258)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` < `0.1339` → IC=+0.164 (n=1244)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1339 (IC base=+0.138)
...
- **PATRÓN** `volumen_regimen` < `1.2116` → IC=+0.158 (n=1258)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4267` → IC=+0.148 (n=1146)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.4267 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `215.0` → IC=+0.176 (n=356)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 215.0 (IC base=+0.138)
...
- **PATRÓN** `ibs_20min` < `0.2417` → IC=+0.258 (n=946)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7818` → IC=+0.218 (n=438)
...
- **PATRÓN** `libro_liquidez` > `1883.1265` → IC=+0.224 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1883.1265 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.221 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 12.0 (IC base=+0.220)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.172 (n=1084)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0067 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.159 (n=1231)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3782` → IC=+0.196 (n=1231)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3782 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1621` → IC=+0.180 (n=819)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1621 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.946` → IC=+0.229 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.946 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.0413` → IC=+0.145 (n=1084)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0413 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6274` → IC=+0.147 (n=1231)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6274 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.2448` → IC=+0.195 (n=260)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2448 (IC base=+0.143)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5292` → IC=+0.166 (n=402)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.5292 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6680.8292` → IC=+0.184 (n=821)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6680.8292 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.145 (n=1167)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 164.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.155 (n=1307)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.144 (n=1307)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6381` → IC=+0.172 (n=1307)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6381 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3635` → IC=+0.137 (n=1412)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.3635 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.926` → IC=+0.171 (n=457)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.926 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.849` → IC=+0.148 (n=872)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4865` → IC=+0.133 (n=396)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.4865 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.161 (n=593)
...
- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.203 (n=1391)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5169 (IC base=+0.118)

- **PATRÓN** `dist_vwap_pct` > `0.8398` → IC=+0.215 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8398 (IC base=+0.118)
...
- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.130 (n=1391)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2184 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.6417` → IC=+0.121 (n=1391)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` > 0.6417 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` < `0.1638` → IC=+0.129 (n=1398)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1638 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.0711` → IC=+0.122 (n=585)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.0711 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.5459` → IC=+0.142 (n=591)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.5459 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1457)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `2895.2022` → IC=+0.197 (n=631)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2895.2022 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.136 (n=1068)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 50.0 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.151 (n=626)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0061 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.1032` → IC=+0.153 (n=473)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.210 (n=1418)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.0011` → IC=+0.144 (n=186)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 1.0011 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.1993` → IC=+0.139 (n=1307)
...
- **PATRÓN** `volumen_regimen` < `1.1736` → IC=+0.122 (n=1418)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.1736 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.171 (n=171)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2757 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4547` → IC=+0.132 (n=424)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4547 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.4234` → IC=+0.131 (n=423)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.4234 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3085.1851` → IC=+0.161 (n=473)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3085.1851 (IC base=+0.114)
...
- **PATRÓN** `sigma_h` > `0.0172` → IC=+0.206 (n=920)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.213 (n=632)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` < `0.4384` → IC=+0.245 (n=1381)
...
- **PATRÓN** `volumen_regimen` > `0.6292` → IC=+0.216 (n=1380)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2183` → IC=+0.194 (n=1090)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2183 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4374` → IC=+0.199 (n=1239)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4374 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2587.1246` → IC=+0.206 (n=920)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2587.1246 (IC base=+0.204)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.161 (n=608)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.55` → IC=+0.188 (n=1628)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.55 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.8774` → IC=+0.193 (n=285)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.8774 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.719` → IC=+0.175 (n=838)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.719 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8739` → IC=+0.164 (n=1065)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8739 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.206` → IC=+0.150 (n=533)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.206 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1652` → IC=+0.178 (n=507)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1652 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4378` → IC=+0.168 (n=585)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4378 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5431` → IC=+0.158 (n=585)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5431 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2066)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12350.4009` → IC=+0.154 (n=608)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12350.4009 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.166 (n=1601)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 162.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.139 (n=1281)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0057 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.121 (n=1934)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 5.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` < `0.5212` → IC=+0.146 (n=1691)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5212 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` < `0.2116` → IC=+0.120 (n=1707)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` < 0.2116 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` < `2.2271` → IC=+0.124 (n=1627)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.2271 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `3875.2837` → IC=+0.127 (n=1281)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 3875.2837 (IC base=+0.107)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.124 (n=596)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1104` → IC=+0.140 (n=201)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1104 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.149 (n=431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 8.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2517` → IC=+0.143 (n=457)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.2517 (IC base=+0.104)
...
- **PATRÓN** `volumen_regimen` < `0.6136` → IC=+0.152 (n=153)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6136 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `12726.9019` → IC=+0.130 (n=409)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 12726.9019 (IC base=+0.104)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.257 (n=249)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.0977` → IC=+0.207 (n=189)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7017` → IC=+0.243 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7017 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` > `0.9497` → IC=+0.223 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9497 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.93` → IC=+0.220 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.93 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` < `0.8389` → IC=+0.197 (n=377)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.8389 (IC base=+0.191)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3961` → IC=+0.239 (n=186)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3961 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.4036` → IC=+0.223 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4036 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `12366.3016` → IC=+0.210 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12366.3016 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.121 (n=470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.60€ cuando `sigma_h` < 0.0061 (IC base=+0.090)

- **PATRÓN** `ibs_20min` < `0.0816` → IC=+0.156 (n=178)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.0816 (IC base=+0.090)

- **PATRÓN** `volumen_pendiente_norm` > `0.1667` → IC=+0.122 (n=125)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.1667 (IC base=+0.090)

- **PATRÓN** `libro_liquidez` > `3821.4035` → IC=+0.120 (n=475)

  - _Acción_: Kelly boost +0.60€ cuando `libro_liquidez` > 3821.4035 (IC base=+0.090)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `ibs_20min` > `0.5192` → IC=-0.159 (n=127)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5192
  - _Potencial_: sin este filtro IC_bueno=+0.144 (n=383)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.179 (n=182)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0089 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.5281` → IC=+0.130 (n=401)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.5281 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.129)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.203 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7333 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` > `0.6339` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6339 (IC base=+0.129)
...
- **PATRÓN** `volumen_regimen` < `1.0699` → IC=+0.147 (n=352)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0699 (IC base=+0.129)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2214` → IC=+0.174 (n=173)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2214 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.132 (n=436)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.02 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `3065.6596` → IC=+0.189 (n=133)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 3065.6596 (IC base=+0.129)

- **PATRÓN** `ibs_20min` < `0.5192` → IC=+0.144 (n=383)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.5192 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` < `1.8504` → IC=+0.143 (n=239)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.8504 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.128 (n=224)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.205 (n=3284)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=9857)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.9764` → IC=+0.206 (n=1380)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9764 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.845` → IC=+0.233 (n=3636)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.845 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.8812` → IC=+0.165 (n=4390)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8812 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2394` → IC=+0.199 (n=1844)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2394 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6009` → IC=+0.186 (n=3154)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6009 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2342.9304` → IC=+0.171 (n=6567)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.9304 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.194 (n=7474)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.181 (n=4171)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 7.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.238 (n=8956)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.725` → IC=+0.182 (n=8670)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2878` → IC=+0.241 (n=1175)
...
- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.193 (n=5251)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.196 (n=1131)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_spike_ratio` < `1.5504` → IC=+0.181 (n=695)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=1005)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.194 (n=530)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.3102` → IC=+0.203 (n=1575)
...
- **PATRÓN** `volumen_regimen` < `0.63` → IC=+0.180 (n=526)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1149` → IC=+0.163 (n=1338)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1149 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7583` → IC=+0.153 (n=1014)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7583 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `15716.8827` → IC=+0.156 (n=714)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 15716.8827 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `477.0` → IC=+0.159 (n=1451)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1618)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.240 (n=705)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_spike_ratio` < `1.7536` → IC=+0.234 (n=599)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.246 (n=1014)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.232 (n=1280)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4371` → IC=+0.144 (n=1678)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.8762` → IC=+0.260 (n=761)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8762 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.5836` → IC=+0.168 (n=471)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.5836 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.19` → IC=+0.159 (n=698)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.19 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8748` → IC=+0.155 (n=1119)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8748 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2367` → IC=+0.214 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2367 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.5214` → IC=+0.150 (n=715)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5214 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.7647` → IC=+0.145 (n=1082)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.7647 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8097.713` → IC=+0.230 (n=761)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.131 (n=1276)
...
- **PATRÓN** `dist_vwap_pct` < `0.2195` → IC=+0.129 (n=1333)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2195 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.454` → IC=+0.123 (n=1577)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.454 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.151 (n=718)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7176 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2238` → IC=+0.171 (n=253)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2238 (IC base=+0.112)
...
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.218 (n=1114)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.209 (n=1490)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.248 (n=1671)
...
- **FILTRO** `sigma_h` > `0.0067` → IC=-0.211 (n=119)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=359)

- **FILTRO** `dist_vwap_pct` > `0.1862` → IC=-0.179 (n=26)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.1862
  - _Potencial_: sin este filtro IC_bueno=+0.122 (n=310)
...
- **PATRÓN** `dist_vwap_pct` < `0.1862` → IC=+0.122 (n=310)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5298` → IC=+0.133 (n=224)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 2.5298 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` > `1.437` → IC=+0.134 (n=200)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.437 (IC base=+0.004)
...
- **PATRÓN** `ibs_20min` < `0.1419` → IC=+0.286 (n=40)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1419 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` < `0.1269` → IC=+0.138 (n=92)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1269 (IC base=-0.010)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.842` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.842 (IC base=-0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.1363` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1363 (IC base=-0.010)

- **PATRÓN** `volumen_spike_ratio` > `2.6298` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6298 (IC base=-0.010)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.146 (n=80)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.02 (IC base=-0.010)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.152 (n=113)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0058 (IC base=+0.090)
...
- **PATRÓN** `ibs_20min` > `0.6522` → IC=+0.161 (n=249)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.6522 (IC base=+0.090)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3996` → IC=+0.141 (n=51)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.3996 (IC base=+0.090)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.210 (n=122)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=287)

- **FILTRO** `restante_min` < `3.3` → IC=-0.147 (n=100)

  - _Acción_: SKIP cuando `restante_min` < 3.3
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=309)

- **FILTRO** `hora_utc` < `7.0` → IC=-0.211 (n=88)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
...
- **PATRÓN** `py_entrada` < `0.48` → IC=+0.173 (n=111)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.48 (IC base=+0.039)

- **PATRÓN** `profundidad_ratio` > `103.8` → IC=+0.185 (n=106)

  - _Acción_: Kelly boost +0.93€ cuando `profundidad_ratio` > 103.8 (IC base=+0.039)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=7456)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.167 (n=3458)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=10386)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.168 (n=3562)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=10793)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.153 (n=632)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=1939)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.190 (n=611)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1833)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=630)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1938)

- **FILTRO** `ibs_20min` > `0.2819` → IC=-0.163 (n=641)
...
- **FILTRO** `py_entrada` < `0.485` → IC=-0.171 (n=591)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1795)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.177 (n=629)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1939)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2743)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9815)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=21964)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7764)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=24015)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.235 (n=7941)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=23838)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=10803)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=20976)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9776)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=30035)

- **FILTRO** `ibs_7min` > `0.293` → IC=-0.178 (n=9952)

  - _Acción_: SKIP cuando `ibs_7min` > 0.293
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=29859)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1251)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3996)

- **FILTRO** `ibs_7min` < `0.7103` → IC=-0.250 (n=1731)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7103
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3516)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.185 (n=1208)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=4039)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1690)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5151)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.123 (n=2322)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4519)

- **FILTRO** `ibs_7min` > `0.7889` → IC=-0.204 (n=1710)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7889
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=5131)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1289)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.249 (n=1324)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4167)

- **FILTRO** `ibs_7min` < `0.7479` → IC=-0.191 (n=1372)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7479
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4119)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.172 (n=1366)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4125)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.252 (n=1387)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=4180)

- **FILTRO** `ibs_7min` > `0.2599` → IC=-0.175 (n=1391)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2599
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=4176)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.182 (n=1389)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4178)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1413)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1219)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3756)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.258 (n=1239)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3736)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1160)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3815)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.236 (n=1675)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5642)

- **FILTRO** `ibs_7min` > `0.7467` → IC=-0.176 (n=1829)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7467
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5488)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.231 (n=1550)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3692)

- **FILTRO** `ibs_7min` < `0.741` → IC=-0.181 (n=1310)

  - _Acción_: SKIP cuando `ibs_7min` < 0.741
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3932)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.169 (n=1292)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3950)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1334)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4009)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.176 (n=1335)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4008)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.185 (n=1324)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4019)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=1347)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4206)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1385)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4168)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1807)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5763)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1698)
...
- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1305)
  ...
  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3966)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1282)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3989)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1721)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5452)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.416` → IC=+0.140 (n=489)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.70€ cuando `delta_ratio` |x|> 0.416 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.127 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 14.0 (IC base=+0.110)

- **PATRÓN** `total_vol_5m` < `464.449` → IC=+0.142 (n=244)
...
- **PATRÓN** `delta_ratio` |x|> `0.4133` → IC=+0.173 (n=99)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio` |x|> 0.4133 (IC base=+0.085)

- **PATRÓN** `total_vol_5m` < `394.71` → IC=+0.191 (n=66)

  - _Acción_: Kelly boost +0.96€ cuando `total_vol_5m` < 394.71 (IC base=+0.085)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=770)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0512` → IC=+0.202 (n=522)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` < `0.6126` → IC=+0.178 (n=1506)
...
- **PATRÓN** `libro_liquidez` > `2978.3521` → IC=+0.194 (n=1042)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2978.3521 (IC base=+0.186)
...
- **FILTRO** `sigma_ewma_delta_pct` > `24.532` → IC=-0.155 (n=27)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=362)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.150 (n=161)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0041 (IC base=+0.136)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0678` → IC=+0.150 (n=161)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.0678 (IC base=+0.136)

- **PATRÓN** `delta_ratio_macro` |x|> `0.232` → IC=+0.177 (n=122)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.89€ cuando `delta_ratio_macro` |x|> 0.232 (IC base=+0.136)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2579` → IC=+0.155 (n=259)

  - _Acción_: Kelly boost +0.78€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2579 (IC base=+0.136)
...
- **PATRÓN** `dist_vwap_pct` < `0.1604` → IC=+0.150 (n=287)
...
- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.161 (n=166)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.136)
...
- **FILTRO** `dist_vwap_pct` > `0.5723` → IC=-0.140 (n=123)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=888)
...
- **PATRÓN** `ibs_15` < `0.1171` → IC=+0.158 (n=463)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1194` → IC=+0.245 (n=1132)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1194 (IC base=-0.034)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1772` → IC=+0.237 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1772 (IC base=-0.034)

- **PATRÓN** `ibs_15` < `0.3482` → IC=+0.278 (n=1699)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3482 (IC base=-0.034)

- **PATRÓN** `dist_vwap_pct` > `0.9662` → IC=+0.292 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9662 (IC base=-0.034)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4386` → IC=+0.226 (n=669)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4386 (IC base=+0.226)

- **PATRÓN** `drift_15min` |x|≤ `0.7869` → IC=+0.233 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7869 (IC base=+0.226)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2029` → IC=+0.257 (n=303)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2029 (IC base=+0.226)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.231 (n=262)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.226)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.244 (n=299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.226)

- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.266 (n=669)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3469 (IC base=+0.226)

- **PATRÓN** `dist_vwap_pct` > `0.7785` → IC=+0.300 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7785 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.806` → IC=+0.244 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.806 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.221` → IC=+0.230 (n=714)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.221 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `3551.8492` → IC=+0.226 (n=669)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.662 sube el IC de +0.136 a +0.248 en UPDOWN_GBM#ETH#15min (n=327). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1171 sube el IC de +0.047 a +0.158 en UPDOWN_GBM#XRP#15min (n=463). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3482 sube el IC de -0.034 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=1699). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3469 sube el IC de +0.226 a +0.266 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=669). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3443 sube el IC de -0.045 a +0.308 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=457). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 24841 | -0.092 | -3178.16€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1436 | -0.048 | -223.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 23405 | -0.095 | -2954.78€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3672 | -0.091 | -597.44€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3672 | -0.091 | -597.44€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7179 | -0.024 | -662.96€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7179 | -0.024 | -662.96€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6664 | -0.098 | -451.74€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6664 | -0.098 | -451.74€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5516 | -0.182 | -1081.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5516 | -0.182 | -1081.59€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17690 | -0.028 | +4075.69€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4625 | +0.000 | +1832.86€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 13065 | -0.038 | +2242.83€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 17690 | -0.028 | +4075.69€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4625 | +0.000 | +1832.86€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 13065 | -0.038 | +2242.83€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 91280 | +0.112 | -4680.03€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13822 | +0.185 | -432.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 367 | -0.088 | -51.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 71133 | +0.100 | -3980.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5958 | +0.108 | -216.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11833 | +0.098 | -1006.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 45 | -0.160 | -0.32€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11773 | +0.100 | -994.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18463 | +0.132 | -374.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4346 | +0.203 | -136.75€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11792 | +0.111 | -187.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2283 | +0.105 | -27.80€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11873 | +0.088 | -1123.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 52 | -0.093 | -6.98€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11806 | +0.089 | -1105.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19429 | +0.123 | -420.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5344 | +0.175 | -85.01€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11917 | +0.104 | -271.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2156 | +0.098 | -55.35€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17835 | +0.114 | -1051.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3989 | +0.189 | -212.92€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 270 | -0.048 | +2.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12057 | +0.091 | -708.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1519 | +0.127 | -132.98€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11847 | +0.101 | -703.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 46 | -0.021 | +9.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11788 | +0.101 | -712.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14481 | +0.191 | -960.26€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14481 | +0.191 | -960.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3457 | +0.167 | -365.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3457 | +0.167 | -365.35€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1174 | +0.193 | -13.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1174 | +0.193 | -13.20€ | 4 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3402 | +0.179 | -296.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3402 | +0.179 | -296.93€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3031 | +0.239 | -97.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3031 | +0.239 | -97.01€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3338 | +0.193 | -201.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3338 | +0.193 | -201.53€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 49830 | +0.196 | -3987.64€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 49830 | +0.196 | -3987.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8627 | +0.175 | -1016.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8627 | +0.175 | -1016.76€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7953 | +0.222 | -307.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7953 | +0.222 | -307.58€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8606 | +0.171 | -1053.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8606 | +0.171 | -1053.75€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 8055 | +0.218 | -326.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 8055 | +0.218 | -326.44€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8231 | +0.203 | -551.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8231 | +0.203 | -551.81€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8358 | +0.193 | -731.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8358 | +0.193 | -731.30€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 18786 | +0.119 | +188.17€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 18786 | +0.119 | +188.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9328 | +0.123 | +160.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9328 | +0.123 | +160.80€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9458 | +0.114 | +27.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9458 | +0.114 | +27.37€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1091 | +0.075 | -43.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 379 | +0.062 | -29.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 712 | +0.081 | -14.11€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 860 | +0.081 | -17.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 148 | +0.080 | -3.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 712 | +0.081 | -14.11€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 34713 | +0.097 | -1095.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2872 | +0.090 | +25.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 31841 | +0.097 | -1121.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 19517 | +0.101 | -325.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2872 | +0.090 | +25.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 16645 | +0.103 | -351.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6492 | +0.107 | -42.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6492 | +0.107 | -42.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8704 | +0.079 | -728.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8704 | +0.079 | -728.09€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 24966 | +0.082 | +11794.86€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 24966 | +0.082 | +11794.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4167 | +0.193 | +3019.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4167 | +0.193 | +3019.61€ | 0 | 20 |
| ✅ GBM_LATE_15M#BTC | 3698 | +0.176 | +2557.58€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3698 | +0.176 | +2557.58€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 4327 | +0.199 | +3235.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4327 | +0.199 | +3235.53€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3694 | +0.018 | +766.32€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3694 | +0.018 | +766.32€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3590 | -0.033 | +822.22€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3590 | -0.033 | +822.22€ | 4 | 14 |
| ✅ GBM_LATE_15M#XRP | 5490 | -0.041 | +1393.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5490 | -0.041 | +1393.61€ | 4 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 26362 | +0.085 | +13725.66€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 26362 | +0.085 | +13725.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4991 | +0.017 | +2649.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4991 | +0.017 | +2649.77€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5492 | +0.014 | +1126.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5492 | +0.014 | +1126.59€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3745 | +0.261 | +3757.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3745 | +0.261 | +3757.86€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4275 | +0.001 | +793.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4275 | +0.001 | +793.94€ | 2 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4292 | +0.027 | +1613.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4292 | +0.027 | +1613.36€ | 3 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3567 | +0.274 | +3784.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3567 | +0.274 | +3784.15€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 20134 | +0.168 | +14994.67€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 20134 | +0.168 | +14994.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 3031 | +0.206 | +2396.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 3031 | +0.206 | +2396.51€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3204 | +0.149 | +2344.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3204 | +0.149 | +2344.88€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3157 | +0.207 | +2505.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3157 | +0.207 | +2505.54€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3383 | +0.133 | +2347.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3383 | +0.133 | +2347.31€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3744 | +0.116 | +2557.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3744 | +0.116 | +2557.31€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3615 | +0.203 | +2843.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3615 | +0.203 | +2843.11€ | 0 | 26 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4990 | +0.126 | +2062.39€ | 0 | 22 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4990 | +0.126 | +2062.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 185 | +0.120 | +80.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 185 | +0.120 | +80.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1426 | +0.122 | +633.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1426 | +0.122 | +633.50€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 373 | +0.143 | +176.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 373 | +0.143 | +176.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1460 | +0.142 | +638.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1460 | +0.142 | +638.57€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1042 | +0.100 | +316.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1042 | +0.100 | +316.12€ | 2 | 14 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 504 | +0.134 | +216.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 504 | +0.134 | +216.54€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 25068 | +0.174 | +18570.93€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 25068 | +0.174 | +18570.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3972 | +0.220 | +3337.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3972 | +0.220 | +3337.97€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3922 | +0.150 | +2586.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3922 | +0.150 | +2586.36€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4107 | +0.226 | +3537.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4107 | +0.226 | +3537.39€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 4069 | +0.136 | +2752.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 4069 | +0.136 | +2752.40€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4391 | +0.112 | +2755.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4391 | +0.112 | +2755.42€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4607 | +0.204 | +3601.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4607 | +0.204 | +3601.40€ | 0 | 24 |
...
| ✅ GBM_LATE_60M | 1672 | +0.070 | +733.59€ | 2 | 14 |
| ✅ GBM_LATE_60M#60min | 1672 | +0.070 | +733.59€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 602 | +0.091 | +260.93€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 602 | +0.091 | +260.93€ | 0 | 15 |
| ✅ GBM_LATE_60M#ETH | 556 | +0.073 | +286.29€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 556 | +0.073 | +286.29€ | 3 | 16 |
...
| 🚫 GBM_LATE_60M_FADE#BTC#60min | 140 | -0.232 | -13.37€ | 6 | 0 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 686 | +0.068 | +140.78€ | 2 | 8 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 686 | +0.068 | +140.78€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1884 | +0.097 | +502.22€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1884 | +0.097 | +502.22€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1884 | +0.097 | +502.22€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1884 | +0.097 | +502.22€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 830 | -0.030 | +0.51€ | 3 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 383 | -0.025 | +4.83€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 447 | -0.035 | -4.31€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC | 210 | +0.066 | +47.48€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#15min | 94 | +0.042 | +14.43€ | 0 | 5 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#5min | 116 | +0.085 | +33.06€ | 0 | 7 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE | 134 | -0.081 | -15.58€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 14320 | -0.011 | -202.36€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14320 | -0.011 | -202.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 3037 | -0.019 | -55.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 3037 | -0.019 | -55.54€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 28199 | -0.007 | +1253.84€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 28199 | -0.007 | +1253.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4971 | +0.016 | +602.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4971 | +0.016 | +602.69€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4381 | -0.028 | -46.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4381 | -0.028 | -46.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 5012 | +0.014 | +455.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 5012 | +0.014 | +455.91€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4164 | -0.052 | -146.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4164 | -0.052 | -146.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4717 | -0.011 | +173.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4717 | -0.011 | +173.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4954 | +0.007 | +214.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4954 | +0.007 | +214.75€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5764 | -0.057 | -128.03€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5764 | -0.057 | -128.03€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 614 | -0.114 | -18.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 614 | -0.114 | -18.43€ | 3 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 71590 | -0.072 | +1790.67€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 71590 | -0.072 | +1790.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 12088 | -0.079 | +723.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 12088 | -0.079 | +723.12€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 11058 | -0.092 | -457.51€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 11058 | -0.092 | -457.51€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 12292 | -0.067 | +707.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 12292 | -0.067 | +707.38€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10585 | -0.092 | -147.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10585 | -0.092 | -147.21€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 13123 | -0.048 | +383.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 13123 | -0.048 | +383.96€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 12444 | -0.062 | +580.94€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 12444 | -0.062 | +580.94€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7526 | -0.023 | -114.48€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7526 | -0.023 | -114.48€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 996 | -0.017 | -19.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 996 | -0.017 | -19.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1656 | -0.025 | +0.98€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1656 | -0.025 | +0.98€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 1003 | -0.020 | -31.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 1003 | -0.020 | -31.30€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 2099 | -0.019 | -23.63€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 2099 | -0.019 | -23.63€ | 1 | 0 |
...
| ✅ ORDER_FLOW_5M | 1111 | +0.104 | +357.38€ | 0 | 3 |
| ✅ ORDER_FLOW_5M#5min | 975 | +0.110 | +344.79€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#ETH | 198 | +0.085 | +58.62€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#ETH#5min | 198 | +0.085 | +58.62€ | 0 | 2 |
...
| ✅ ORDER_FLOW_5M_REACTIVO | 457 | -0.062 | -57.00€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#5min | 457 | -0.062 | -57.00€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO#ETH | 132 | -0.082 | -26.68€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#ETH#5min | 132 | -0.082 | -26.68€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 2741 | -0.022 | -112.06€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2741 | -0.022 | -112.06€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1214 | -0.021 | -46.90€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1214 | -0.021 | -46.90€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 7656 | +0.023 | +113.35€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7656 | +0.023 | +113.35€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2132 | +0.021 | +20.35€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2132 | +0.021 | +20.35€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1711 | +0.035 | +52.11€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1711 | +0.035 | +52.11€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2322 | +0.012 | +2.61€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2322 | +0.012 | +2.61€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1491 | +0.030 | +38.29€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1491 | +0.030 | +38.29€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7189 | +0.012 | -43.84€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7189 | +0.012 | -43.84€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 36241 | +0.030 | +2119.97€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 9772 | +0.067 | +1747.19€ | 0 | 10 |
| ✅ UPDOWN_GBM#240min | 1341 | +0.004 | +6.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 22789 | +0.019 | +347.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2200 | +0.006 | +18.89€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3670 | +0.065 | +386.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 632 | +0.148 | +245.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 29 | -0.016 | -0.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 3009 | +0.049 | +141.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6699 | +0.036 | +455.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1237 | +0.084 | +275.64€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 364 | +0.019 | +7.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 4057 | +0.032 | +154.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 988 | +0.004 | +17.13€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 53 | -0.100 | +0.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 4213 | +0.039 | +248.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 588 | +0.141 | +210.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 27 | -0.017 | -2.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3598 | +0.022 | +40.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 7723 | +0.017 | +272.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2519 | +0.045 | +266.78€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 352 | +0.006 | +6.93€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 4057 | +0.005 | -0.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 750 | +0.001 | -4.92€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 45 | -0.138 | +3.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8688 | +0.015 | +218.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2393 | +0.026 | +168.83€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 346 | -0.006 | -2.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5448 | +0.012 | +47.03€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 462 | +0.017 | +6.68€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 39 | -0.159 | -2.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5246 | +0.035 | +541.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2403 | +0.080 | +580.06€ | 0 | 13 |
| ✅ UPDOWN_GBM#XRP#240min | 223 | -0.002 | -3.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2620 | -0.004 | -35.94€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11667 | -0.040 | +2465.40€ | 2 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11667 | -0.040 | +2465.40€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 731 | -0.036 | +350.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 731 | -0.036 | +350.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2167 | -0.122 | +27.92€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2167 | -0.122 | +27.92€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 363 | +0.182 | +245.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 363 | +0.182 | +245.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1288 | +0.203 | +744.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1288 | +0.203 | +744.52€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3551 | -0.064 | +550.63€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3551 | -0.064 | +550.63€ | 2 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3567 | -0.077 | +545.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3567 | -0.077 | +545.81€ | 3 | 4 |
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=2392 IC=+0.026 PNL=+168.28€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.107 n=298/60 | contraria IC=+0.153 n=286 | gap=-0.046 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar

**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  - _Umbral_: n_overlaps≥20 y IC_overlap > IC_base + 0.05
  - _Acción_: Cambiar _aplicar_kelly_compuesto: match por activo, no market_id
  - _Estado_: n_overlaps=280, boost estimado=+0.002. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=750/40 IC=+0.001 PNL=-4.92€ | BTC#60min: n=988/40 IC=+0.004 PNL=+17.13€ | SOL#60min: n=462/40 IC=+0.017 PNL=+6.68€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.050 n=327898 | tras_1loss IC=+0.077 n=255487 | tras_2loss IC=+0.046 n=107963/40 | gap=+0.004 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1559 IC=+0.013 PNL=+10.26€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1559 IC=+0.013 PNL=+10.26€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=641 IC=-0.012 PNL=+8.63€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=641 IC=-0.012 PNL=+8.63€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.186 > 0.1 con n=2084 PNL=+1298.24€
  - _Datos_: n=2084 IC=+0.186 PNL=+1298.24€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1237 IC=+0.084 PNL=+275.64€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1237 IC=+0.084 PNL=+275.64€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.120 > 0.02 con n=635 PNL=+238.87€
  - _Datos_: n=635 IC=+0.120 PNL=+238.87€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=12579 IC=+0.053 PNL=+1516.03€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=12579 IC=+0.053 PNL=+1516.03€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1849 IC=+0.047 PNL=+190.32€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1849 IC=+0.047 PNL=+190.32€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=17463 IC=-0.137 PNL=+1162.36€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=17463 IC=-0.137 PNL=+1162.36€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=3770 IC=+0.021 PNL=+131.22€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3770 IC=+0.021 PNL=+131.22€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.087 > 0.08 con n=2008 PNL=+1054.45€
  - _Datos_: n=2008 IC=+0.087 PNL=+1054.45€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.089 n=965) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=965 IC=+0.089 PNL=+217.88€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8626 IC=+0.175 PNL=-1017.15€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8626 IC=+0.175 PNL=-1017.15€
