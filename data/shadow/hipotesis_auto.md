# Hipótesis automáticas — 2026-08-05 16:56 UTC
_Generado por shadow_postmortem.py sobre 75058 resoluciones (PNL=+12902.08€)_
...
- **PATRÓN** `sigma_h` < `0.0185` → IC=+0.177 (n=847)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0185 (IC base=+0.172)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.182 (n=847)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0065 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.191 (n=583)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.5513` → IC=+0.264 (n=87)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5513 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.169` → IC=+0.171 (n=912)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` < 9.169 (IC base=+0.172)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=719)
...
- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.182 (n=83)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0056 (IC base=+0.116)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.139 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 15.0 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `0.1395` → IC=+0.127 (n=65)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.1395 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.3492` → IC=+0.134 (n=203)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.3492 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.38` → IC=+0.132 (n=172)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 7.38 (IC base=+0.116)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.567` → IC=+0.202 (n=65)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.567 (IC base=+0.020)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.129 (n=165)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0037 (IC base=+0.105)
...
- **PATRÓN** `sigma_h` < `0.007` → IC=+0.221 (n=583)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_15min` |x|≤ `0.5515` → IC=+0.179 (n=26)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `drift_15min` |x|≤ 0.5515 (IC base=-0.046)

- **PATRÓN** `ibs_15` < `0.5537` → IC=+0.139 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.5537 (IC base=-0.046)

- **PATRÓN** `libro_liquidez` > `9476.9221` → IC=+0.122 (n=35)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 9476.9221 (IC base=-0.046)
...
- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.301 (n=194)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0083 (IC base=+0.277)
...
- **PATRÓN** `sigma_h` < `0.0148` → IC=+0.213 (n=430)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0148 (IC base=+0.210)

- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.210 (n=384)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1643 | +0.056 | -35.69€ | 0 | 5 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1643 | +0.056 | -35.69€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 710 | +0.034 | -26.32€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 710 | +0.034 | -26.32€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 607 | +0.071 | -27.71€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 607 | +0.071 | -27.71€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 307 | +0.073 | +18.69€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 307 | +0.073 | +18.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS | 904 | +0.010 | -50.90€ | 0 | 2 |
| ✅ BALLENAS_TARDIAS#15min | 294 | +0.277 | -10.31€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 610 | -0.119 | -40.58€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB | 162 | -0.293 | -27.06€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB#5min | 162 | -0.293 | -27.06€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 107 | -0.124 | +21.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 107 | -0.124 | +21.18€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 18909 | +0.124 | -426.68€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5411 | +0.196 | -99.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min |
 | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 584 | +0.092 | +99.49€ | 1 | 9 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3211 | +0.168 | +1676.55€ | 0 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3211 | +0.168 | +1676.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 331 | +0.224 | +250.57€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 331 | +0.224 | +250.57€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 330 | +0.093 | +70.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 330 | +0.093 | +70.20€ | 1 | 12 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 330 | +0.205 | +228.44€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 330 | +0.205 | +228.44€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 583 | +0.189 | +253.13€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 583 | +0.189 | +253.13€ | 1 | 14 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 674 | +0.101 | +208.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 674 | +0.101 | +208.91€ | 2 | 13 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 963 | +0.194 | +665.29€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 963 | +0.194 | +665.29€ | 0 | 22 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.151: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.111 n=2359 | neutral: IC=+0.050 n=1838 | overbought(IBS>0.7): IC=+0.201 n=2301
  - _Datos_: n=6926 IC=+0.130 PNL=+2333.83€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.167 n=127 PNL=+60.15€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=12h: IC=+0.136 n=163 PNL=+46.56€ → BOOST | H=14h: IC=+0.140 n=170 PNL=+60.25€ → BOOST | H=16h: IC=+0.114 n=156 PNL=+40.85€ → BOOST | H=22h: IC=+0.176 n=174 PNL=+58.29€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.129 n=45964 | tras_1loss IC=+0.092 n=28774 | tras_2loss IC=+0.068 n=11699/40 | gap=+0.061 (umbral 0.05)
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=368 IC=+0.024 PNL=+14.20€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=368 IC=+0.024 PNL=+14.20€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3590 IC=+0.063 PNL=+531.16€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3590 IC=+0.063 PNL=+531.16€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1419 IC=+0.064 PNL=+208.64€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1419 IC=+0.064 PNL=+208.64€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=584 IC=+0.092 PNL=+99.49€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=584 IC=+0.092 PNL=+99.49€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.098 > 0.08 con n=1844 PNL=+356.93€
  - _Datos_: n=1844 IC=+0.098 PNL=+356.93€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1971 IC=+0.071 PNL=+297.20€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1971 IC=+0.071 PNL=+297.20€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=254 IC=+0.035 PNL=+62.81€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=254 IC=+0.035 PNL=+62.81€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1569 IC=+0.043 PNL=+178.09€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1569 IC=+0.043 PNL=+178.09€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.168 > 0.1 con n=1495 PNL=+522.37€
  - _Datos_: n=1495 IC=+0.168 PNL=+522.37€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=272 IC=+0.062 PNL=+4.82€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=272 IC=+0.062 PNL=+4.82€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1479 IC=-0.077 PNL=+365.17€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1479 IC=-0.077 PNL=+365.17€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.114 > 0.08 con n=1015 PNL=+254.89€
  - _Datos_: n=1015 IC=+0.114 PNL=+254.89€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.165 > 0.08 con n=365 PNL=+117.04€
  - _Datos_: n=365 IC=+0.165 PNL=+117.04€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.092 > 0.08 con n=794 PNL=+168.10€
  - _Datos_: n=794 IC=+0.092 PNL=+168.10€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.124 > 0.08 con n=1178 PNL=+534.68€
  - _Datos_: n=1178 IC=+0.124 PNL=+534.68€
