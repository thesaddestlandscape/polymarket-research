# Hipótesis automáticas — 2026-09-16 15:56 UTC
_Generado por shadow_postmortem.py sobre 468511 resoluciones (PNL=+50178.89€)_
...
- **FILTRO** `restante_s_al_confirmar` < `157.73` → IC=-0.253 (n=1380)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.73
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=4141)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `122.72` → IC=-0.359 (n=1113)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 122.72
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=3339)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.196 (n=11750)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=2933)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `5280.0735` → IC=+0.169 (n=1867)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.246 (n=8019)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.172 (n=5769)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7220.7864` → IC=+0.177 (n=1825)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 7220.7864 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1384)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=1371)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1709)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `14967.7624` → IC=+0.205 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14967.7624 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.208 (n=1383)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` < `0.37` → IC=+0.273 (n=1207)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1772)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `13171.6675` → IC=+0.215 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13171.6675 (IC base=+0.202)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2354)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.138 (n=2014)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.246 (n=1058)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.245 (n=1229)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `3743.7277` → IC=+0.243 (n=524)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.133 (n=549)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.135 (n=639)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.144 (n=689)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2204)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.178 (n=2283)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.318 (n=185)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.443 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.431)

- **PATRÓN** `libro_liquidez` > `2062.8229` → IC=+0.440 (n=413)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.452 (n=145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.436 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.438)

- **PATRÓN** `libro_liquidez` > `3238.6179` → IC=+0.435 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3238.6179 (IC base=+0.438)
...
- **PATRÓN** `lag_apertura_s` < `3.3` → IC=+0.153 (n=3807)
...
- **PATRÓN** `restante_min` < `4.01` → IC=+0.135 (n=1889)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 4.01 (IC base=+0.130)

- **PATRÓN** `restante_min` > `4.93` → IC=+0.148 (n=2032)
...
- **PATRÓN** `lag_apertura_s` < `2.5` → IC=+0.148 (n=1915)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 2.5 (IC base=+0.119)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.301 (n=993)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1613.1588` → IC=+0.297 (n=935)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.437 (n=173)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.430)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9778` → IC=+0.230 (n=2073)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9778 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.2143` → IC=+0.243 (n=1317)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2143 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.854` → IC=+0.166 (n=2399)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.854 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `0.6097` → IC=+0.254 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6097 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.241 (n=716)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0678 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1746` → IC=+0.191 (n=4258)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1746 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.201 (n=586)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.9241` → IC=+0.197 (n=2731)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.9241 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5671` → IC=+0.131 (n=7644)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5671 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5781` → IC=+0.185 (n=452)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5781 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3466` → IC=+0.168 (n=2655)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3466 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `0.6997` → IC=+0.167 (n=1098)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6997 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8717` → IC=+0.177 (n=1663)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.8717 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.2443` → IC=+0.224 (n=841)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2443 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4687` → IC=+0.197 (n=4153)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4687 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.209 (n=3926)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1127` → IC=+0.238 (n=468)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1127 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.226 (n=1114)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `10977.0001` → IC=+0.221 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10977.0001 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.156 (n=1002)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6705` → IC=+0.174 (n=1138)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6705 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1278` → IC=+0.151 (n=1037)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1278 (IC base=+0.138)
...
- **PATRÓN** `volumen_regimen` < `1.2085` → IC=+0.145 (n=1138)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2085 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `0.8477` → IC=+0.142 (n=758)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.8477 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1573` → IC=+0.181 (n=308)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1573 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.154 (n=1029)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4292 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `13454.0855` → IC=+0.151 (n=758)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13454.0855 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `216.0` → IC=+0.158 (n=320)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 216.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.177 (n=1208)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0089 (IC base=+0.176)

- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.187 (n=1371)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0058 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.176 (n=1370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3793` → IC=+0.232 (n=1041)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.364` → IC=+0.216 (n=1294)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1728)
...
- **PATRÓN** `dist_vwap_pct` > `0.1648` → IC=+0.194 (n=194)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1648 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` < `0.697` → IC=+0.145 (n=249)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.697 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` > `1.1677` → IC=+0.149 (n=189)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.1677 (IC base=+0.003)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5104` → IC=+0.182 (n=460)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.5104 (IC base=+0.003)
...
- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.126 (n=1759)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.618` → IC=-0.202 (n=287)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2341)
...
- **FILTRO** `drift_60min` |x|> `0.6568` → IC=-0.194 (n=436)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1310)

- **FILTRO** `ibs_20min` < `0.7881` → IC=-0.141 (n=1309)
...
- **FILTRO** `ibs_20min` > `0.775` → IC=-0.203 (n=661)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=1986)

- **PATRÓN** `dist_vwap_pct` > `0.9726` → IC=+0.324 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9726 (IC base=-0.085)

- **PATRÓN** `dist_vwap_pct` < `0.2555` → IC=+0.303 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2555 (IC base=-0.085)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.294 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6141 (IC base=-0.085)

- **PATRÓN** `volumen_pendiente_norm` < `0.1029` → IC=+0.273 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1029 (IC base=-0.085)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8242` → IC=+0.284 (n=132)
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.172 (n=2602)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0091 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.9818` → IC=+0.288 (n=2597)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.523` → IC=+0.142 (n=3679)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.523 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` < `1.1747` → IC=+0.224 (n=2642)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1747 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6767` → IC=+0.235 (n=2360)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6767 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` < `0.1133` → IC=+0.225 (n=4008)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1133 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` > `0.2482` → IC=+0.257 (n=828)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2482 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` < `1.4779` → IC=+0.241 (n=1401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4779 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` > `2.7761` → IC=+0.235 (n=1401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7761 (IC base=+0.086)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.276 (n=3691)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 103.0 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.141 (n=2641)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0085 (IC base=+0.068)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.151 (n=6978)
...
- **PATRÓN** `dist_vwap_pct` < `0.2319` → IC=+0.231 (n=2110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2319 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` < `0.7148` → IC=+0.230 (n=957)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7148 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` > `1.2024` → IC=+0.252 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2024 (IC base=+0.068)

- **PATRÓN** `volumen_pendiente_norm` > `0.2515` → IC=+0.320 (n=576)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2515 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` < `1.4923` → IC=+0.256 (n=944)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4923 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` > `2.37` → IC=+0.254 (n=1283)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.37 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.256 (n=2691)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.068)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2293` → IC=-0.141 (n=535)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2293
  - _Potencial_: sin este filtro IC_bueno=+0.094 (n=1605)
...
- **PATRÓN** `ibs_20min` > `0.8622` → IC=+0.249 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8622 (IC base=+0.035)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.29` → IC=+0.146 (n=721)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 3.29 (IC base=+0.035)
...
- **FILTRO** `ibs_20min` > `0.8266` → IC=-0.150 (n=583)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1753)

- **PATRÓN** `dist_vwap_pct` > `0.2999` → IC=+0.140 (n=251)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.2999 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` < `1.0528` → IC=+0.130 (n=600)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0528 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` > `0.6498` → IC=+0.136 (n=610)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.173 (n=221)
...
- **PATRÓN** `dist_vwap_pct` < `0.1592` → IC=+0.208 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1592 (IC base=+0.000)

- **PATRÓN** `volumen_regimen` > `0.68` → IC=+0.207 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.68 (IC base=+0.000)

- **PATRÓN** `volumen_pendiente_norm` < `0.0717` → IC=+0.205 (n=330)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8012` → IC=+0.220 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8012 (IC base=+0.000)

- **PATRÓN** `volumen_spike_ratio` > `2.1657` → IC=+0.224 (n=161)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.290 (n=636)
...
- **PATRÓN** `ibs_20min` < `0.3299` → IC=+0.285 (n=989)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3299 (IC base=+0.278)
...
- **FILTRO** `ibs_20min` < `0.2448` → IC=-0.211 (n=355)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1070)

- **FILTRO** `ibs_20min` > `0.8089` → IC=-0.182 (n=466)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8089
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=1400)

- **PATRÓN** `ibs_20min` > `0.806` → IC=+0.143 (n=485)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.806 (IC base=-0.014)

- **PATRÓN** `dist_vwap_pct` > `0.2917` → IC=+0.212 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2917 (IC base=-0.014)

- **PATRÓN** `volumen_regimen` < `0.9592` → IC=+0.215 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9592 (IC base=-0.014)

- **PATRÓN** `volumen_regimen` > `0.5518` → IC=+0.191 (n=328)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 0.5518 (IC base=-0.014)

- **PATRÓN** `volumen_pendiente_norm` < `0.1084` → IC=+0.220 (n=305)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4842` → IC=+0.257 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4842 (IC base=-0.014)

- **PATRÓN** `volumen_spike_ratio` > `1.7393` → IC=+0.222 (n=203)
...
- **PATRÓN** `dist_vwap_pct` > `0.1247` → IC=+0.192 (n=102)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1247 (IC base=-0.019)

- **PATRÓN** `dist_vwap_pct` < `0.2862` → IC=+0.171 (n=247)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.2862 (IC base=-0.019)

- **PATRÓN** `volumen_regimen` > `0.7226` → IC=+0.179 (n=213)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 0.7226 (IC base=-0.019)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4278` → IC=+0.265 (n=66)
...
- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.243 (n=200)
...
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.210 (n=835)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.255 (n=852)

- **FILTRO** `ibs_20min` > `0.7108` → IC=-0.233 (n=447)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.677` → IC=-0.172 (n=416)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=1374)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.255 (n=852)
...
- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.295 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.7203` → IC=+0.276 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7203 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.1058` → IC=+0.281 (n=537)
...
- **PATRÓN** `ibs_20min` < `0.4608` → IC=+0.228 (n=5980)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4608 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2227` → IC=+0.161 (n=4463)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2227 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.239` → IC=+0.196 (n=1031)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.239 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.155 (n=4369)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1913 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6257` → IC=+0.151 (n=4369)
...
- **PATRÓN** `volumen_spike_ratio` < `1.575` → IC=+0.174 (n=2342)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.575 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.651` → IC=+0.176 (n=1774)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.651 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.172 (n=4945)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.204 (n=346)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.314` → IC=+0.201 (n=1036)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.314 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.211 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.047` → IC=+0.307 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.047 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.2282` → IC=+0.238 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2282 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` < `2.5472` → IC=+0.179 (n=943)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.5472 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `1.427` → IC=+0.180 (n=943)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.427 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.207 (n=966)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0752` → IC=+0.184 (n=299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0752 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=948)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4289` → IC=+0.221 (n=897)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4289 (IC base=+0.161)
...
- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.173 (n=897)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.2629 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2316` → IC=+0.187 (n=196)
...
- **PATRÓN** `libro_liquidez` > `10017.2772` → IC=+0.176 (n=897)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 10017.2772 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.175 (n=896)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0049 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.0585` → IC=+0.193 (n=340)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.0585 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=938)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 7.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.5312` → IC=+0.191 (n=1018)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.5312 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.1346` → IC=+0.167 (n=1036)
...
- **PATRÓN** `volumen_regimen` < `1.215` → IC=+0.161 (n=1018)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.215 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1594` → IC=+0.176 (n=316)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1594 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.160 (n=907)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.197 (n=1014)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0058 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.1945` → IC=+0.199 (n=676)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1945 (IC base=+0.188)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.285 (n=537)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.216` → IC=+0.184 (n=972)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.216 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` > `0.1358` → IC=+0.186 (n=390)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.202 (n=1147)
...
- **PATRÓN** `ibs_20min` < `0.6008` → IC=+0.179 (n=1048)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6008 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` < `0.1494` → IC=+0.143 (n=1052)
...
- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.139 (n=699)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8615 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.133 (n=1047)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7982` → IC=+0.139 (n=621)
...
- **PATRÓN** `libro_liquidez` > `10039.916` → IC=+0.156 (n=475)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 10039.916 (IC base=+0.130)

- **PATRÓN** `ballena_activa_n` < `178.0` → IC=+0.125 (n=863)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 178.0 (IC base=+0.130)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.147 (n=761)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0077 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1168)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5` → IC=+0.195 (n=1150)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.447` → IC=+0.249 (n=257)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.447 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.121 (n=1140)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.2208 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4424` → IC=+0.130 (n=366)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4424 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1172)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2895.2022` → IC=+0.194 (n=517)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2895.2022 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.137 (n=828)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 48.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.151 (n=505)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0059 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.170 (n=522)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.5484` → IC=+0.208 (n=1147)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5484 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.692` → IC=+0.145 (n=201)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.692 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.1881` → IC=+0.134 (n=1066)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1881 (IC base=+0.113)
...
- **PATRÓN** `volumen_regimen` < `1.1973` → IC=+0.123 (n=1147)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4638` → IC=+0.138 (n=335)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4638 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.1759` → IC=+0.130 (n=455)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.1759 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `3082.2041` → IC=+0.162 (n=382)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3082.2041 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` < `0.0271` → IC=+0.202 (n=1082)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1671` → IC=+0.213 (n=476)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.8772` → IC=+0.282 (n=722)
...
- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.207 (n=1082)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6101` → IC=+0.210 (n=1082)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.203 (n=1106)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2566.7167` → IC=+0.203 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2566.7167 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.233 (n=387)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0222` → IC=+0.213 (n=525)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.217 (n=567)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.438` → IC=+0.243 (n=1159)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.178 (n=734)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.388` → IC=+0.166 (n=1482)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.388 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.8295` → IC=+0.165 (n=201)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.8295 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.699` → IC=+0.166 (n=678)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.699 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.866` → IC=+0.155 (n=852)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.866 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.1642` → IC=+0.167 (n=406)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1642 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `1.4332` → IC=+0.144 (n=473)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.139 (n=1644)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.02 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `8454.7872` → IC=+0.150 (n=672)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.135 (n=1052)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0057 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.34` → IC=+0.128 (n=1387)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.34 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=1593)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.4839` → IC=+0.157 (n=1387)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.4839 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2059` → IC=+0.122 (n=1404)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2059 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.978` → IC=+0.136 (n=462)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 5.978 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.2242` → IC=+0.120 (n=1396)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.2242 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.1668` → IC=+0.142 (n=403)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.1668 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `2.2321` → IC=+0.136 (n=1326)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.2321 (IC base=+0.115)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1043` → IC=+0.151 (n=147)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1043 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.145 (n=302)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 10.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.8703` → IC=+0.193 (n=151)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.8703 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.6865` → IC=+0.150 (n=58)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.6865 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.256` → IC=+0.154 (n=157)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.256 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `0.6949` → IC=+0.164 (n=147)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.6949 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.0903` → IC=+0.126 (n=121)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.0903 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `9834.2432` → IC=+0.127 (n=333)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 9834.2432 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.157 (n=103)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 151.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.205 (n=164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.3449` → IC=+0.148 (n=484)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3449 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.144 (n=434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 7.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` < `0.3422` → IC=+0.205 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3422 (IC base=+0.125)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.114` → IC=+0.126 (n=431)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.114 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` < `1.2044` → IC=+0.126 (n=484)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.2044 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` > `1.0619` → IC=+0.174 (n=219)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0619 (IC base=+0.125)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4192` → IC=+0.147 (n=474)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.4192 (IC base=+0.125)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.147 (n=154)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 159.0 (IC base=+0.125)
...
- **PATRÓN** `ibs_20min` < `0.4737` → IC=+0.157 (n=310)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.4737 (IC base=+0.085)

- **PATRÓN** `volumen_regimen` < `0.7183` → IC=+0.138 (n=136)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.7183 (IC base=+0.085)

- **PATRÓN** `volumen_spike_ratio` < `2.5615` → IC=+0.132 (n=286)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.579` → IC=+0.222 (n=3806)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.579 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8839` → IC=+0.167 (n=3486)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.8839 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2395` → IC=+0.186 (n=1468)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2395 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6366` → IC=+0.183 (n=2469)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.6366 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3790.2792` → IC=+0.169 (n=2590)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3790.2792 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.194 (n=5652)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 94.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.196 (n=4790)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0067 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.4793` → IC=+0.183 (n=7163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.4793 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2714)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5581` → IC=+0.239 (n=7164)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5581 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2337` → IC=+0.162 (n=4555)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2337 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.842` → IC=+0.198 (n=1029)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.842 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.694` → IC=+0.182 (n=6920)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.694 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.6286` → IC=+0.159 (n=1651)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6286 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2046` → IC=+0.160 (n=1651)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.2046 (IC base=+0.181)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2995` → IC=+0.189 (n=2915)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.2995 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.178 (n=6044)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.227 (n=595)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.198 (n=626)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.318 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.865` → IC=+0.313 (n=592)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1832` → IC=+0.154 (n=824)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1832 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.3255` → IC=+0.197 (n=1236)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3255 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.3404` → IC=+0.199 (n=473)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.3404 (IC base=+0.148)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.384` → IC=+0.152 (n=1099)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.384 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6941` → IC=+0.185 (n=544)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6941 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1542` → IC=+0.176 (n=338)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1542 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.157 (n=1041)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7544` → IC=+0.156 (n=788)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7544 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10832.985` → IC=+0.166 (n=1104)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 10832.985 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `492.0` → IC=+0.158 (n=1113)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 492.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.169 (n=1105)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0057 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.3258` → IC=+0.164 (n=1105)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3258 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` < `0.6372` → IC=+0.205 (n=1105)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6372 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.7019` → IC=+0.159 (n=168)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.7019 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.1302` → IC=+0.163 (n=1020)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1302 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.232` → IC=+0.169 (n=547)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.232 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `1.2003` → IC=+0.162 (n=1105)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2003 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1512` → IC=+0.205 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1512 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.4046` → IC=+0.168 (n=1007)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.4046 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `12312.8113` → IC=+0.154 (n=736)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12312.8113 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `370.0` → IC=+0.166 (n=606)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 370.0 (IC base=+0.154)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.224 (n=1234)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1297)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.215 (n=1257)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.248 (n=1103)
...
- **PATRÓN** `ibs_20min` < `0.3636` → IC=+0.268 (n=1043)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3636 (IC base=+0.231)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.718` → IC=+0.274 (n=423)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7987` → IC=+0.225 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7987 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` > `2.2499` → IC=+0.231 (n=707)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2499 (IC base=+0.231)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.243 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.231)

- **PATRÓN** `libro_liquidez` > `1887.4151` → IC=+0.235 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.4151 (IC base=+0.231)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.253 (n=334)
...
- **PATRÓN** `volumen_regimen` < `0.8808` → IC=+0.160 (n=877)
...
- **PATRÓN** `ibs_20min` < `0.3286` → IC=+0.235 (n=710)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3286 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.2048` → IC=+0.144 (n=1000)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.2048 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.012` → IC=+0.200 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.012 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.194` → IC=+0.139 (n=993)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 4.194 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.6958` → IC=+0.143 (n=468)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.6958 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1921` → IC=+0.153 (n=355)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.1921 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5583` → IC=+0.147 (n=437)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5583 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `2.4671` → IC=+0.170 (n=331)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.4671 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `10953.5869` → IC=+0.195 (n=355)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 10953.5869 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `192.0` → IC=+0.144 (n=985)
...
- **PATRÓN** `ibs_20min` > `0.4673` → IC=+0.181 (n=1332)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.148 (n=604)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.6304` → IC=+0.209 (n=1296)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6304 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.4691` → IC=+0.129 (n=1282)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4691 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.449` → IC=+0.127 (n=1248)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.449 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.7211` → IC=+0.154 (n=570)
...
- **PATRÓN** `volumen_spike_ratio` < `1.461` → IC=+0.152 (n=380)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.461 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.222` → IC=+0.122 (n=517)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 2.222 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2904.3214` → IC=+0.164 (n=432)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2904.3214 (IC base=+0.114)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0183` → IC=+0.212 (n=897)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0183 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1404)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5135` → IC=+0.243 (n=1346)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.069` → IC=+0.261 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.069 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `1.2457` → IC=+0.208 (n=1346)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2457 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.627` → IC=+0.209 (n=1346)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.627 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.0803` → IC=+0.227 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0803 (IC base=+0.205)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1358)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2573.072` → IC=+0.210 (n=897)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2573.072 (IC base=+0.205)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.213 (n=715)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` < `0.5098` → IC=+0.255 (n=1489)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5098 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` < `0.271` → IC=+0.205 (n=1385)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.271 (IC base=+0.199)
...
- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.241 (n=496)
...
- **PATRÓN** `volumen_spike_ratio` < `2.231` → IC=+0.194 (n=1152)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.231 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4428` → IC=+0.195 (n=1308)
...
- **PATRÓN** `libro_liquidez` > `2549.3704` → IC=+0.201 (n=992)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2549.3704 (IC base=+0.199)
...
- **FILTRO** `ibs_20min` > `0.3279` → IC=-0.167 (n=76)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.115 (n=232)
...
- **PATRÓN** `libro_liquidez` > `3934.0004` → IC=+0.145 (n=105)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 3934.0004 (IC base=+0.045)
...
- **PATRÓN** `ibs_20min` < `0.1435` → IC=+0.177 (n=94)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.1435 (IC base=+0.101)

- **PATRÓN** `volumen_pendiente_norm` < `0.1746` → IC=+0.136 (n=75)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` < 0.1746 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `3628.1976` → IC=+0.148 (n=106)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3628.1976 (IC base=+0.101)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.183 (n=39)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.147)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.124 (n=482)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.5 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2833.8623` → IC=+0.159 (n=168)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2833.8623 (IC base=+0.111)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=576)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.124 (n=1047)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5494)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=6354)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1351)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.179 (n=2678)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=8121)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=2762)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=8517)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.221 (n=438)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1384)

- **FILTRO** `ibs_20min` < `0.748` → IC=-0.180 (n=454)

  - _Acción_: SKIP cuando `ibs_20min` < 0.748
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1368)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.163 (n=467)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1544)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.201 (n=459)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1411)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.216 (n=473)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1511)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.196 (n=492)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1493)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2409)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2449)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2455)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7781)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=17625)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.284 (n=5942)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=19464)

- **FILTRO** `ibs_7min` < `0.7033` → IC=-0.242 (n=6350)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7033
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=19056)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=8638)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=16768)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.225 (n=7914)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=23884)

- **FILTRO** `ibs_7min` > `0.2963` → IC=-0.177 (n=7946)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2963
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=23852)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.314 (n=964)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3116)

- **FILTRO** `ibs_7min` < `0.7089` → IC=-0.259 (n=1346)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7089
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2734)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.196 (n=964)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3116)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.150 (n=3702)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1826)

- **FILTRO** `drift_7min_pct` |x|> `0.1361` → IC=-0.131 (n=1381)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1361
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=4147)

- **FILTRO** `ibs_7min` > `0.7992` → IC=-0.206 (n=1381)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7992
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4147)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1024)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3418)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.257 (n=1036)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3406)

- **FILTRO** `ibs_7min` < `0.7558` → IC=-0.187 (n=1108)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7558
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3334)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.173 (n=1106)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3336)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=1056)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3432)

- **FILTRO** `ibs_7min` > `0.2539` → IC=-0.169 (n=1121)
...
- **FILTRO** `ballena_activa_n` > `152.0` → IC=-0.178 (n=1118)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3370)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.182 (n=937)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2891)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.323 (n=922)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2906)

- **FILTRO** `drift_7min_pct` |x|> `0.181` → IC=-0.132 (n=1300)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.181
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=2528)

- **FILTRO** `ibs_7min` < `0.2021` → IC=-0.274 (n=957)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2021
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2871)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.221 (n=905)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2923)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1369)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4451)

- **FILTRO** `ibs_7min` > `0.2632` → IC=-0.158 (n=1972)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=3848)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1324)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=2857)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1018)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3163)

- **FILTRO** `ibs_7min` < `0.7429` → IC=-0.192 (n=1045)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7429
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3136)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.182 (n=1033)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3148)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.262 (n=1050)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3221)

- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.175 (n=1064)
...
- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.180 (n=1060)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3211)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.255 (n=1087)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3498)

- **FILTRO** `ibs_7min` < `0.72` → IC=-0.220 (n=1144)

  - _Acción_: SKIP cuando `ibs_7min` < 0.72
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3441)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.172 (n=1450)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4574)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.281 (n=1044)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3246)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.232 (n=1071)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=3219)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.209 (n=1051)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3239)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.207 (n=1345)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=4322)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=937)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2351)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=1205)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1213)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.188 (n=363)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.004 (IC base=+0.173)

- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.204 (n=363)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0094 (IC base=+0.173)

- **PATRÓN** `drift_60min` |x|≤ `0.0524` → IC=+0.179 (n=363)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.0524 (IC base=+0.173)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0582` → IC=+0.174 (n=1088)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio_macro` |x|> 0.0582 (IC base=+0.173)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1332` → IC=+0.221 (n=338)
...
- **PATRÓN** `ibs_15` > `0.619` → IC=+0.244 (n=1089)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.619 (IC base=+0.173)

- **PATRÓN** `dist_vwap_pct` < `0.1053` → IC=+0.176 (n=724)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1053 (IC base=+0.173)

- **PATRÓN** `sigma_ewma_delta_pct` > `21.297` → IC=+0.261 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 21.297 (IC base=+0.173)

- **PATRÓN** `libro_liquidez` > `2630.1666` → IC=+0.178 (n=972)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2630.1666 (IC base=+0.173)

### UPDOWN_GBM#60min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=366)

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.215 (n=184)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.0591` → IC=+0.266 (n=92)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0591 (IC base=+0.193)

- **PATRÓN** `drift_15min` |x|≤ `0.3762` → IC=+0.213 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3762 (IC base=+0.193)

- **PATRÓN** `delta_ratio_macro` |x|> `0.252` → IC=+0.202 (n=92)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.252 (IC base=+0.193)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1506` → IC=+0.247 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1506 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.207 (n=285)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.193)

- **PATRÓN** `ibs_15` > `0.7732` → IC=+0.266 (n=246)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7732 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.3854` → IC=+0.236 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3854 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.1019` → IC=+0.196 (n=192)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.1019 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.472` → IC=+0.255 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.472 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `11623.6154` → IC=+0.213 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11623.6154 (IC base=+0.193)

### UPDOWN_GBM#BTC#60min
- **PATRÓN** `sigma_ewma_delta_pct` > `20.331` → IC=+0.138 (n=67)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 20.331 (IC base=-0.005)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.163 (n=176)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.81€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=+0.137)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2712` → IC=+0.165 (n=171)

  - _Acción_: Kelly boost +0.82€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2712 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.143 (n=194)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6485` → IC=+0.226 (n=264)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6485 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1433` → IC=+0.164 (n=209)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1433 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.256 (n=207)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0152 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.0857` → IC=+0.198 (n=137)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.0857 (IC base=+0.184)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0648` → IC=+0.195 (n=277)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.5417` → IC=+0.276 (n=310)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5417 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` > `0.1729` → IC=+0.205 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1729 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` < `0.3078` → IC=+0.183 (n=295)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.3078 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.55` → IC=+0.236 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.55 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.184 (n=337)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.03 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `2722.5042` → IC=+0.241 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2722.5042 (IC base=+0.184)

- **PATRÓN** `ibs_15` < `0.1091` → IC=+0.176 (n=347)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` < 0.1091 (IC base=+0.049)
...
- **FILTRO** `sigma_h` > `0.0126` → IC=-0.201 (n=537)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0126
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1612)

- **FILTRO** `ibs_15` < `0.6077` → IC=-0.174 (n=179)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6077
  - _Potencial_: sin este filtro IC_bueno=+0.252 (n=539)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.174 (n=680)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1469)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2875` → IC=+0.224 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2875 (IC base=-0.058)

- **PATRÓN** `ibs_15` > `0.6077` → IC=+0.252 (n=539)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6077 (IC base=-0.058)

- **PATRÓN** `dist_vwap_pct` < `0.2663` → IC=+0.177 (n=425)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2663 (IC base=-0.058)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2104` → IC=+0.241 (n=381)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2104 (IC base=-0.045)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1819` → IC=+0.237 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1819 (IC base=-0.045)

- **PATRÓN** `ibs_15` < `0.3571` → IC=+0.279 (n=1143)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3571 (IC base=-0.045)
...
- **FILTRO** `sigma_h` < `0.0037` → IC=-0.229 (n=426)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.181 (n=867)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=823)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.873` → IC=-0.244 (n=232)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1061)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.167 (n=112)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0026 (IC base=+0.070)
...
- **PATRÓN** `ibs_15` > `0.8098` → IC=+0.338 (n=109)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8098 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.3434` → IC=+0.268 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3434 (IC base=+0.070)

### UPDOWN_GBM_15M_TARDIO#ETH#15min
- **FILTRO** `ibs_15` < `0.6526` → IC=-0.230 (n=87)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6526
  - _Potencial_: sin este filtro IC_bueno=+0.254 (n=262)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.147 (n=332)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.133 (n=262)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0065 (IC base=+0.133)

- **PATRÓN** `sigma_h` > `0.004` → IC=+0.161 (n=234)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.004 (IC base=+0.133)
...
- **PATRÓN** `drift_15min` |x|≤ `0.4223` → IC=+0.156 (n=88)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `drift_15min` |x|≤ 0.4223 (IC base=+0.133)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2968` → IC=+0.231 (n=173)
...
- **PATRÓN** `ibs_15` > `0.6526` → IC=+0.254 (n=262)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6526 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.1025` → IC=+0.181 (n=189)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1025 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.863` → IC=+0.138 (n=205)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 6.863 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=332)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `10544.7398` → IC=+0.194 (n=119)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 10544.7398 (IC base=+0.133)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.249 (n=484)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.225)

- **PATRÓN** `drift_60min` |x|≤ `0.3574` → IC=+0.229 (n=426)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3574 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7675` → IC=+0.227 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7675 (IC base=+0.225)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2029` → IC=+0.256 (n=219)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2029 (IC base=+0.225)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.237 (n=325)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.225)

- **PATRÓN** `ibs_15` < `0.366` → IC=+0.270 (n=484)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.366 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.3779` → IC=+0.250 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3779 (IC base=+0.225)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.182` → IC=+0.230 (n=516)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.279 (n=134)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3796` → IC=+0.290 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3796 (IC base=+0.275)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.339 (n=122)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.275)

- **PATRÓN** `ibs_15` > `0.8213` → IC=+0.295 (n=295)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8213 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `0.2619` → IC=+0.336 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2619 (IC base=+0.275)
...
- **PATRÓN** `libro_liquidez` > `12100.6098` → IC=+0.294 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12100.6098 (IC base=+0.275)

### UPDOWN_GBM_IBS_ALTO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.309 (n=234)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.295)

- **PATRÓN** `sigma_h` > `0.0035` → IC=+0.305 (n=234)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.1` → IC=+0.295 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1 (IC base=+0.295)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.305 (n=265)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.619 sube el IC de +0.173 a +0.244 en UPDOWN_GBM#15min (n=1089). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7732 sube el IC de +0.193 a +0.266 en UPDOWN_GBM#BTC#15min (n=246). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6485 sube el IC de +0.137 a +0.226 en UPDOWN_GBM#ETH#15min (n=264). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5417 sube el IC de +0.184 a +0.276 en UPDOWN_GBM#XRP#15min (n=310). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1091 sube el IC de +0.049 a +0.176 en UPDOWN_GBM#XRP#15min (n=347). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.