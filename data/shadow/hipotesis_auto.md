# Hipótesis automáticas — 2026-08-26 20:14 UTC
_Generado por shadow_postmortem.py sobre 165792 resoluciones (PNL=+11816.01€)_
...
- **FILTRO** `py_entrada` < `0.705` → IC=-0.167 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.273 (n=227)

- **PATRÓN** `py_entrada` > `0.725` → IC=+0.287 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.150)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.164 (n=218)

  - _Acción_: Kelly boost +0.82€ cuando `n_ballena_banda` > 20.0 (IC base=+0.150)

- **PATRÓN** `n_total_lado` > `73.0` → IC=+0.264 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 73.0 (IC base=+0.150)

- **PATRÓN** `banda_hit_calibrado` > `0.8212` → IC=+0.275 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8212 (IC base=+0.150)

- **PATRÓN** `banda_z` > `10.6` → IC=+0.241 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.6 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.185 (n=163)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 11.0 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=248)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3094.168` → IC=+0.236 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3094.168 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `288.0` → IC=+0.305 (n=80)
...
- **PATRÓN** `py_entrada` > `0.725` → IC=+0.291 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.190)

- **PATRÓN** `n_ballena_banda` > `24.0` → IC=+0.208 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `n_ballena_banda` > 24.0 (IC base=+0.190)

- **PATRÓN** `n_total_lado` > `52.0` → IC=+0.245 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 52.0 (IC base=+0.190)

- **PATRÓN** `banda_hit_calibrado` > `0.8208` → IC=+0.289 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8208 (IC base=+0.190)

- **PATRÓN** `banda_z` > `11.788` → IC=+0.292 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.788 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.219 (n=137)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `3827.6428` → IC=+0.261 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3827.6428 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `295.0` → IC=+0.319 (n=70)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.46` → IC=-0.282 (n=2292)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.46
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=6878)
...
- **FILTRO** `restante_s_al_confirmar` < `91.5` → IC=-0.436 (n=281)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 91.5
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=846)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `158.25` → IC=-0.194 (n=625)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.25
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1877)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `151.65` → IC=-0.269 (n=540)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 151.65
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1623)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `152.63` → IC=-0.357 (n=523)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 152.63
  - _Potencial_: sin este filtro IC_bueno=-0.119 (n=1064)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.186 (n=5230)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=1553)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2383.976` → IC=+0.175 (n=1499)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2383.976 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=3493)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.260 (n=3214)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=2878)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1844.982` → IC=+0.183 (n=2408)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 1844.982 (IC base=+0.141)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=622)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.214 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `12715.6779` → IC=+0.228 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12715.6779 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.200 (n=558)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.325` → IC=+0.292 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.188 (n=794)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.01 (IC base=+0.189)

- **PATRÓN** `libro_liquidez` > `12107.4018` → IC=+0.220 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12107.4018 (IC base=+0.189)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=530)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1187)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.290 (n=413)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.281 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `2859.287` → IC=+0.289 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2859.287 (IC base=+0.281)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.194 (n=936)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2027.0591` → IC=+0.259 (n=197)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=4407)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.201 (n=2116)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.166 (n=762)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.165 (n=969)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1126)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.241 (n=1004)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.456 (n=203)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `3355.2252` → IC=+0.466 (n=144)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.438 (n=46)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.443)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.457 (n=45)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.443)

- **PATRÓN** `py_entrada` < `0.92` → IC=+0.431 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.92 (IC base=+0.443)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.193 (n=10644)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.219 (n=8310)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.189)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.127 (n=2168)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.210 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.160)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.237 (n=1693)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.208 (n=1422)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.183)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.201 (n=1602)
...
- **PATRÓN** `restante_min` > `4.93` → IC=+0.164 (n=1433)
...
- **PATRÓN** `lag_apertura_s` < `4.46` → IC=+0.162 (n=1419)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 4.46 (IC base=+0.135)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.206 (n=802)
...
- **PATRÓN** `restante_min` > `4.91` → IC=+0.178 (n=718)

  - _Acción_: Kelly boost +0.89€ cuando `restante_min` > 4.91 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.153 (n=1862)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 15.0 (IC base=+0.143)

- **PATRÓN** `lag_apertura_s` < `5.62` → IC=+0.178 (n=707)

  - _Acción_: Kelly boost +0.89€ cuando `lag_apertura_s` < 5.62 (IC base=+0.143)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.196 (n=800)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.38 (IC base=+0.126)

- **PATRÓN** `restante_min` < `3.98` → IC=+0.131 (n=719)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` < 3.98 (IC base=+0.126)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.159 (n=773)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.94 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.129 (n=2144)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.47` → IC=+0.163 (n=716)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 3.47 (IC base=+0.126)
...
- **PATRÓN** `dist_vwap_pct` > `0.211` → IC=+0.234 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.211 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.741` → IC=+0.215 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.741 (IC base=+0.063)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.229` → IC=+0.170 (n=888)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.229 (IC base=+0.063)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3074` → IC=+0.139 (n=164)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` > 0.3074 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` < `2.4442` → IC=+0.140 (n=1022)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.4442 (IC base=+0.063)

- **PATRÓN** `ibs_20min` < `0.2133` → IC=+0.131 (n=1480)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.2133 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.3017` → IC=+0.147 (n=748)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3017 (IC base=+0.031)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1726` → IC=+0.255 (n=231)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1726 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` < `1.6134` → IC=+0.207 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6134 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` > `2.9145` → IC=+0.232 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9145 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.231 (n=321)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.302 (n=170)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.278 (n=241)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4388` → IC=+0.319 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4388 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.312 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.939 (IC base=+0.274)

- **PATRÓN** `volumen_pendiente_norm` < `0.0577` → IC=+0.295 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0577 (IC base=+0.274)

- **PATRÓN** `volumen_pendiente_norm` > `0.2302` → IC=+0.316 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2302 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` < `1.7714` → IC=+0.286 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7714 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` > `1.5366` → IC=+0.294 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5366 (IC base=+0.274)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3368` → IC=+0.218 (n=317)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3368 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.237 (n=363)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.224 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.2322` → IC=+0.233 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2322 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `0.992` → IC=+0.211 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.992 (IC base=+0.211)
...
- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.213 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2629 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.252 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0851 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.2657` → IC=+0.271 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2657 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4455` → IC=+0.260 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4455 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11253.359` → IC=+0.221 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11253.359 (IC base=+0.211)
...
- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.143 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0054 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.1678` → IC=+0.163 (n=277)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1678 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.148 (n=370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5876` → IC=+0.167 (n=415)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.5876 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.1429` → IC=+0.171 (n=348)
...
- **PATRÓN** `volumen_regimen` > `1.0208` → IC=+0.142 (n=188)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.0208 (IC base=+0.143)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7452` → IC=+0.186 (n=208)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.7452 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.4117` → IC=+0.161 (n=311)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4117 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.142 (n=535)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `14075.3664` → IC=+0.179 (n=138)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 14075.3664 (IC base=+0.143)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3852` → IC=+0.273 (n=311)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3852 (IC base=+0.264)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.284 (n=211)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.264)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.266 (n=327)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.264)

- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.299 (n=311)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7662` → IC=+0.234 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7662 (IC base=+0.264)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.281 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.264)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.227 (n=97)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.919` → IC=-0.154 (n=270)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=997)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.155 (n=111)
...
- **FILTRO** `ibs_20min` > `0.775` → IC=-0.166 (n=285)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=856)

- **FILTRO** `sigma_ewma_delta_pct` > `6.581` → IC=-0.167 (n=190)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.133 (n=1246)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0075 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.245 (n=915)
...
- **PATRÓN** `ibs_20min` < `0.0947` → IC=+0.182 (n=1169)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.0947 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` > `0.6823` → IC=+0.215 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6823 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` < `0.1474` → IC=+0.205 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1474 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `1.229` → IC=+0.232 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.229 (IC base=+0.040)

- **PATRÓN** `volumen_pendiente_norm` > `0.2516` → IC=+0.367 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2516 (IC base=+0.040)

- **PATRÓN** `volumen_spike_ratio` > `1.6267` → IC=+0.260 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6267 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.265 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.040)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2448` → IC=-0.154 (n=180)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2448
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=367)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.142` → IC=+0.182 (n=105)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 5.142 (IC base=-0.014)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.357 (n=222)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.352)

- **PATRÓN** `drift_60min` |x|≤ `0.3471` → IC=+0.358 (n=195)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3471 (IC base=+0.352)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.400 (n=148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.352)

- **PATRÓN** `ibs_20min` < `0.3056` → IC=+0.362 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3056 (IC base=+0.352)

- **PATRÓN** `ibs_20min` > `0.1308` → IC=+0.353 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1308 (IC base=+0.352)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.402` → IC=+0.353 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.402 (IC base=+0.352)

- **PATRÓN** `volumen_pendiente_norm` > `0.3735` → IC=+0.417 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3735 (IC base=+0.352)

- **PATRÓN** `volumen_spike_ratio` < `1.8056` → IC=+0.391 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8056 (IC base=+0.352)

- **PATRÓN** `volumen_spike_ratio` > `1.997` → IC=+0.347 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.997 (IC base=+0.352)

- **PATRÓN** `libro_liquidez` > `1908.841` → IC=+0.368 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1908.841 (IC base=+0.352)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.333 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 22.0 (IC base=+0.352)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=66)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=892)
...
- **FILTRO** `ibs_20min` > `0.748` → IC=-0.170 (n=219)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.583` → IC=-0.121 (n=212)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2819` → IC=+0.275 (n=375)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2819 (IC base=+0.268)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.280 (n=524)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.268)

- **PATRÓN** `ibs_20min` < `0.2766` → IC=+0.325 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2766 (IC base=+0.268)

- **PATRÓN** `dist_vwap_pct` < `0.8804` → IC=+0.274 (n=640)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8804 (IC base=+0.268)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.698` → IC=+0.318 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.698 (IC base=+0.268)

- **PATRÓN** `volumen_regimen` > `1.2535` → IC=+0.304 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2535 (IC base=+0.268)

- **PATRÓN** `volumen_pendiente_norm` > `0.2431` → IC=+0.366 (n=80)
...
- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.254 (n=307)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3259` → IC=+0.154 (n=2085)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3259 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=836)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.7869` → IC=+0.251 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7869 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.328` → IC=+0.249 (n=1006)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.328 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `0.6824` → IC=+0.170 (n=1470)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.6824 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.1017` → IC=+0.177 (n=841)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1017 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.2796` → IC=+0.151 (n=1867)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.2796 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.8513` → IC=+0.145 (n=1414)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8513 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=1940)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `3926.1694` → IC=+0.189 (n=790)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 3926.1694 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.171 (n=1128)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 125.0 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.202 (n=1861)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.4068` → IC=+0.199 (n=2114)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.4068 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.215 (n=798)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` < `0.4098` → IC=+0.238 (n=2114)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4098 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.3577` → IC=+0.177 (n=1859)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3577 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.785` → IC=+0.225 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.785 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` < `1.1795` → IC=+0.166 (n=1714)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1795 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` > `0.8617` → IC=+0.172 (n=1142)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8617 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.2874` → IC=+0.253 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2874 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` < `1.8747` → IC=+0.179 (n=1004)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.8747 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.6113` → IC=+0.206 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6113 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `202.0` → IC=+0.182 (n=1073)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2461` → IC=+0.148 (n=382)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.2461 (IC base=+0.142)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.141` → IC=+0.152 (n=90)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.141 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.4227` → IC=+0.128 (n=304)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.4227 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.164 (n=224)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.04 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.277 (n=164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.266)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.275 (n=185)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.266)

- **PATRÓN** `drift_60min` |x|≤ `0.3308` → IC=+0.313 (n=185)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3308 (IC base=+0.266)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.287 (n=172)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.266)

- **PATRÓN** `ibs_20min` < `0.4088` → IC=+0.297 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4088 (IC base=+0.266)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.838` → IC=+0.284 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.838 (IC base=+0.266)

- **PATRÓN** `volumen_pendiente_norm` < `0.0799` → IC=+0.271 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0799 (IC base=+0.266)

- **PATRÓN** `volumen_spike_ratio` < `1.7907` → IC=+0.309 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7907 (IC base=+0.266)

- **PATRÓN** `volumen_spike_ratio` > `2.7667` → IC=+0.291 (n=41)
...
- **PATRÓN** `libro_liquidez` > `1982.2745` → IC=+0.344 (n=62)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1982.2745 (IC base=+0.266)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.296 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=+0.266)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.211 (n=334)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `1.2907` → IC=+0.184 (n=334)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 1.2907 (IC base=+0.179)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3851` → IC=+0.231 (n=102)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3851 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `12066.18` → IC=+0.205 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12066.18 (IC base=+0.179)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.212 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.293` → IC=+0.176 (n=430)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.293 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 7.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.4065` → IC=+0.190 (n=430)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.4065 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1603` → IC=+0.178 (n=421)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.1603 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.466` → IC=+0.237 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.466 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.7185` → IC=+0.223 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7185 (IC base=+0.152)
...
- **PATRÓN** `libro_liquidez` > `14231.3167` → IC=+0.162 (n=143)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 14231.3167 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.316 (n=96)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.286)

- **PATRÓN** `drift_60min` |x|≤ `0.199` → IC=+0.316 (n=145)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.199 (IC base=+0.286)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.332 (n=147)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.286)

- **PATRÓN** `ibs_20min` < `0.0082` → IC=+0.380 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0082 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.425` → IC=+0.330 (n=51)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3761` → IC=+0.426 (n=25)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3761 (IC base=+0.286)

- **PATRÓN** `volumen_spike_ratio` > `2.0029` → IC=+0.291 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0029 (IC base=+0.286)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.260 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.286)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.209 (n=139)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.4127` → IC=+0.232 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4127 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.2166` → IC=+0.140 (n=365)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2166 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.672` → IC=+0.188 (n=75)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 6.672 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `1.2058` → IC=+0.136 (n=394)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.2058 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` > `0.8568` → IC=+0.167 (n=262)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.8568 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.2196` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2196 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `2.0466` → IC=+0.197 (n=120)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.0466 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.128 (n=334)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `2061.8019` → IC=+0.171 (n=262)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2061.8019 (IC base=+0.126)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6623` → IC=+0.235 (n=484)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6623 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.222 (n=232)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1379` → IC=+0.295 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1379 (IC base=+0.220)

- **PATRÓN** `dist_vwap_pct` < `0.8298` → IC=+0.228 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8298 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.175` → IC=+0.281 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.175 (IC base=+0.220)

- **PATRÓN** `volumen_regimen` > `0.7169` → IC=+0.242 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7169 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` > `0.2814` → IC=+0.333 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2814 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` > `1.5893` → IC=+0.219 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5893 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `31.0` → IC=+0.185 (n=265)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 31.0 (IC base=+0.220)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.193 (n=161)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 17.0 (IC base=+0.082)

- **PATRÓN** `ibs_20min` > `0.6242` → IC=+0.145 (n=361)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.6242 (IC base=+0.082)
...
- **PATRÓN** `libro_liquidez` > `2920.0962` → IC=+0.124 (n=269)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2920.0962 (IC base=+0.082)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.169 (n=164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.004 (IC base=+0.077)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.152 (n=136)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 16.0 (IC base=+0.077)

- **PATRÓN** `ibs_20min` < `0.6219` → IC=+0.124 (n=368)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.6219 (IC base=+0.077)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.192` → IC=+0.224 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.192 (IC base=+0.077)

- **PATRÓN** `volumen_regimen` < `0.7418` → IC=+0.136 (n=152)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.7418 (IC base=+0.077)

- **PATRÓN** `volumen_spike_ratio` < `1.8646` → IC=+0.140 (n=209)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.8646 (IC base=+0.077)

- **PATRÓN** `libro_liquidez` > `3963.5811` → IC=+0.132 (n=245)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 3963.5811 (IC base=+0.077)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.250 (n=66)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.197 (n=150)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.3402 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.196 (n=54)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 16.0 (IC base=+0.167)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.179 (n=135)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 14.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.6664` → IC=+0.191 (n=150)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6664 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.4984` → IC=+0.167 (n=34)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.4984 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.1864` → IC=+0.184 (n=134)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1864 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.323` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.323 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.197 (n=150)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.1856 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.0873` → IC=+0.330 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0873 (IC base=+0.167)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2716` → IC=+0.194 (n=47)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.2716 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `13517.2957` → IC=+0.167 (n=100)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 13517.2957 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `137.0` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 137.0 (IC base=+0.167)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.154 (n=2490)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 8.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.9416` → IC=+0.289 (n=1244)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.355` → IC=+0.246 (n=1162)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.355 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.7015` → IC=+0.151 (n=855)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7015 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.08` → IC=+0.153 (n=880)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.08 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1644` → IC=+0.181 (n=691)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1644 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.8738` → IC=+0.157 (n=1618)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8738 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2242)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `3848.1598` → IC=+0.195 (n=915)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 3848.1598 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.189 (n=1203)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 160.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.229 (n=1646)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.194)

- **PATRÓN** `drift_60min` |x|≤ `0.4581` → IC=+0.202 (n=2467)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4581 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.201 (n=909)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5551` → IC=+0.250 (n=2467)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5551 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` < `0.7191` → IC=+0.182 (n=2022)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.7191 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.417` → IC=+0.225 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.417 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.646` → IC=+0.198 (n=2318)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` < 2.646 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` < `0.6247` → IC=+0.185 (n=623)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6247 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` > `1.1936` → IC=+0.188 (n=623)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.1936 (IC base=+0.194)

- **PATRÓN** `volumen_pendiente_norm` > `0.2808` → IC=+0.271 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2808 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.2479` → IC=+0.206 (n=802)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2479 (IC base=+0.194)

- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.171 (n=1341)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 181.0 (IC base=+0.194)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.218 (n=200)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.167 (n=298)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 11.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.8232` → IC=+0.247 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8232 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.503` → IC=+0.354 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.503 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2113` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.2113 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.8937` → IC=+0.134 (n=241)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.8937 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.172 (n=227)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.04 (IC base=+0.134)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.321 (n=177)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.277)

- **PATRÓN** `drift_60min` |x|≤ `0.1589` → IC=+0.316 (n=177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1589 (IC base=+0.277)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.279 (n=251)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5876` → IC=+0.332 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5876 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.039` → IC=+0.302 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.039 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` < `0.0647` → IC=+0.282 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0647 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.295 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.277)

- **PATRÓN** `volumen_spike_ratio` > `1.4731` → IC=+0.290 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4731 (IC base=+0.277)
...
- **PATRÓN** `libro_liquidez` > `1995.6702` → IC=+0.344 (n=88)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1995.6702 (IC base=+0.277)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 72.0 (IC base=+0.277)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.182 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0028 (IC base=+0.157)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.214 (n=145)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.188 (n=389)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 8.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.3271` → IC=+0.206 (n=434)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3271 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.2647` → IC=+0.247 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2647 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.699` → IC=+0.208 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.699 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` < `0.6489` → IC=+0.167 (n=145)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6489 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `1.0941` → IC=+0.188 (n=197)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.0941 (IC base=+0.157)
...
- **PATRÓN** `volumen_spike_ratio` < `2.109` → IC=+0.183 (n=339)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.109 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.694` → IC=+0.199 (n=257)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.694 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `11753.1829` → IC=+0.194 (n=289)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 11753.1829 (IC base=+0.157)
...
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.174 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0057 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.1687` → IC=+0.189 (n=278)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1687 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.176 (n=393)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3756` → IC=+0.217 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3756 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.7539` → IC=+0.178 (n=461)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1498` → IC=+0.296 (n=96)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1498 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `1.7452` → IC=+0.204 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7452 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `1.5092` → IC=+0.191 (n=286)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 1.5092 (IC base=+0.169)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=537)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `11946.3416` → IC=+0.175 (n=189)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 11946.3416 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `313.0` → IC=+0.197 (n=74)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 313.0 (IC base=+0.169)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.183 (n=121)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.241 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.176)

- **PATRÓN** `ibs_20min` > `0.7131` → IC=+0.257 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7131 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.106` → IC=+0.342 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.106 (IC base=+0.176)

- **PATRÓN** `volumen_pendiente_norm` < `0.1461` → IC=+0.180 (n=267)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` < 0.1461 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` < `2.0929` → IC=+0.177 (n=128)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.0929 (IC base=+0.176)
...
- **PATRÓN** `libro_liquidez` > `1919.67` → IC=+0.193 (n=164)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 1919.67 (IC base=+0.176)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.235 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.333 (n=148)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0059 (IC base=+0.267)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.289 (n=226)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.332 (n=337)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.154 (n=438)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0089 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=399)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.3491` → IC=+0.198 (n=438)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3491 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.8828` → IC=+0.206 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8828 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.521` → IC=+0.195 (n=211)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 4.521 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.6307` → IC=+0.189 (n=146)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.6307 (IC base=+0.143)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4097` → IC=+0.237 (n=135)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4097 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `5254.2901` → IC=+0.235 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5254.2901 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.192 (n=209)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 167.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.215 (n=121)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.5115` → IC=+0.161 (n=361)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.5115 (IC base=+0.151)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.178 (n=253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 11.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.0817` → IC=+0.245 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0817 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.1614` → IC=+0.161 (n=184)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1614 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.6649` → IC=+0.173 (n=386)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.6649 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.457` → IC=+0.262 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.457 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.597` → IC=+0.175 (n=121)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.597 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `1.1278` → IC=+0.189 (n=120)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.1278 (IC base=+0.151)
...
- **PATRÓN** `volumen_spike_ratio` > `1.557` → IC=+0.174 (n=271)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.557 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `9323.6962` → IC=+0.205 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9323.6962 (IC base=+0.151)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.130 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `drift_60min` |x|≤ `0.2606` → IC=+0.138 (n=305)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.2606 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.176 (n=211)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 15.0 (IC base=+0.120)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.126 (n=161)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 5.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.200 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5833 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` < `0.4633` → IC=+0.140 (n=417)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4633 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.03` → IC=+0.136 (n=446)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.072` → IC=+0.175 (n=124)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.072 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.7463` → IC=+0.168 (n=206)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.7463 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=475)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `2571.994` → IC=+0.170 (n=207)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2571.994 (IC base=+0.120)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.291 (n=280)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.4659` → IC=+0.228 (n=560)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4659 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.225 (n=591)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.214)

- **PATRÓN** `ibs_20min` < `0.4887` → IC=+0.277 (n=636)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4887 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `1.2142` → IC=+0.222 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.2142 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.527` → IC=+0.278 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.527 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.03` → IC=+0.218 (n=636)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2826` → IC=+0.311 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2826 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `1.4369` → IC=+0.200 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4369 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `33.0` → IC=+0.165 (n=314)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 33.0 (IC base=+0.214)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.152 (n=918)

- **PATRÓN** `sigma_h` < `0.0099` → IC=+0.131 (n=377)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` < 0.0099 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.152 (n=159)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 17.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` > `0.8318` → IC=+0.135 (n=195)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` > 0.8318 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `1.4484` → IC=+0.196 (n=110)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 1.4484 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `0.702` → IC=+0.145 (n=164)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.702 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` > `0.1531` → IC=+0.159 (n=121)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.1531 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` < `2.1089` → IC=+0.124 (n=370)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.1089 (IC base=+0.107)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=408)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `8162.0536` → IC=+0.149 (n=286)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8162.0536 (IC base=+0.107)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.206 (n=236)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.3523` → IC=+0.167 (n=616)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3523 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.161 (n=252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6304` → IC=+0.155 (n=616)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.6304 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.6304` → IC=+0.171 (n=156)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6304 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.8049` → IC=+0.144 (n=796)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.8049 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.117` → IC=+0.158 (n=314)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.117 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.046` → IC=+0.147 (n=703)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.046 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.2231` → IC=+0.159 (n=688)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2231 (IC base=+0.146)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4847` → IC=+0.165 (n=693)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.4847 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.513` → IC=+0.151 (n=619)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.513 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=918)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `8480.9204` → IC=+0.152 (n=700)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8480.9204 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.162 (n=392)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0063 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.3507` → IC=+0.153 (n=393)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3507 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.187 (n=148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 17.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.198 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` < `0.1629` → IC=+0.169 (n=173)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.1629 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.6215` → IC=+0.190 (n=56)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.6215 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.363` → IC=+0.153 (n=396)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 6.363 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.1826` → IC=+0.150 (n=392)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1826 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6265` → IC=+0.150 (n=392)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6265 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.185 (n=182)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `2.5555` → IC=+0.159 (n=391)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.5555 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.794` → IC=+0.145 (n=260)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.794 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `11894.422` → IC=+0.148 (n=350)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 11894.422 (IC base=+0.143)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=394)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.171 (n=763)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2373)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.212 (n=741)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=2404)

- **FILTRO** `ibs_20min` > `0.2721` → IC=-0.176 (n=786)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2721
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=2359)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.187 (n=180)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=350)

- **FILTRO** `ibs_20min` > `0.7596` → IC=-0.194 (n=132)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7596
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=398)
...
- **FILTRO** `py_entrada` > `0.52` → IC=-0.200 (n=128)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.218 (n=115)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=380)

- **FILTRO** `drift_20min_pct` |x|> `0.2833` → IC=-0.135 (n=168)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.2833
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=327)
...
- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.153 (n=122)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=373)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.213 (n=127)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=1901)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=5849)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.287 (n=1858)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=5892)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.235 (n=1933)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=5817)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.175 (n=2569)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=5181)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.222 (n=2377)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=7135)

- **FILTRO** `ibs_7min` > `0.7176` → IC=-0.168 (n=2377)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7176
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=7135)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=810)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.331 (n=252)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=795)

- **FILTRO** `ibs_7min` < `0.9818` → IC=-0.201 (n=690)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.223 (n=395)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1225)

- **FILTRO** `drift_7min_pct` |x|> `0.1404` → IC=-0.152 (n=550)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1404
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1070)

- **FILTRO** `ibs_7min` > `0.837` → IC=-0.190 (n=404)

  - _Acción_: SKIP cuando `ibs_7min` > 0.837
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1216)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.239 (n=377)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1159)

- **FILTRO** `ibs_7min` < `0.8044` → IC=-0.166 (n=384)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8044
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1152)
...
- **FILTRO** `py_entrada` > `0.6` → IC=-0.227 (n=379)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1194)

- **FILTRO** `ballena_activa_n` > `130.0` → IC=-0.166 (n=393)

  - _Acción_: SKIP cuando `ballena_activa_n` > 130.0
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1180)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.193 (n=262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=836)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.318 (n=356)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=742)

- **FILTRO** `ibs_7min` < `0.2125` → IC=-0.290 (n=274)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2125
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=824)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.275 (n=274)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=824)
...
- **FILTRO** `ibs_7min` > `0.8179` → IC=-0.185 (n=414)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.150 (n=389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=929)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.255 (n=328)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=990)

- **FILTRO** `ibs_7min` < `0.7655` → IC=-0.186 (n=329)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7655
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=989)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.216 (n=325)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=993)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.125 (n=435)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=876)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.285 (n=315)
...
- **FILTRO** `ibs_7min` > `0.2707` → IC=-0.169 (n=327)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=984)

- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.208 (n=323)

  - _Acción_: SKIP cuando `ballena_activa_n` > 38.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=988)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.241 (n=345)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=1122)

- **FILTRO** `ibs_7min` < `0.7719` → IC=-0.209 (n=366)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7719
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1101)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.209 (n=355)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1112)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.176 (n=433)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1318)
...
- **FILTRO** `ibs_7min` < `0.7534` → IC=-0.215 (n=321)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7534
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=963)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.239 (n=308)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=976)
...
- **FILTRO** `ibs_7min` > `0.8272` → IC=-0.153 (n=399)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8272
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1199)
...
- **PATRÓN** `streak_estiramiento` < `0.5054` → IC=+0.123 (n=59)

  - _Acción_: Kelly boost +0.61€ cuando `streak_estiramiento` < 0.5054 (IC base=+0.011)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.088 (n=202)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=664)
...
- **PATRÓN** `ibs_15` < `0.1135` → IC=+0.138 (n=421)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.1135 (IC base=+0.026)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.135 (n=168)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0053 (IC base=+0.015)
...
- **FILTRO** `ibs_15` > `0.4991` → IC=-0.120 (n=135)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.4991
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.219` → IC=-0.180 (n=332)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.219
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2389)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3433` → IC=+0.139 (n=131)

  - _Acción_: Kelly boost +0.70€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3433 (IC base=-0.055)

- **PATRÓN** `ibs_15` > `0.4526` → IC=+0.162 (n=294)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` > 0.4526 (IC base=-0.055)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.068` → IC=+0.397 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.068 (IC base=-0.078)

- **PATRÓN** `ibs_15` < `0.3315` → IC=+0.352 (n=126)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3315 (IC base=-0.078)

- **PATRÓN** `dist_vwap_pct` < `0.1628` → IC=+0.270 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1628 (IC base=-0.078)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=-0.078)
...
- **FILTRO** `sigma_h` < `0.0027` → IC=-0.210 (n=150)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.204 (n=451)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.248 (n=145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.895` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.193 (n=489)
...
- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.300 (n=53)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1016` → IC=+0.257 (n=72)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1016 (IC base=+0.241)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0853` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0853 (IC base=+0.241)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.324 (n=32)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.241)

- **PATRÓN** `ibs_15` < `0.3357` → IC=+0.342 (n=80)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3357 (IC base=+0.241)

- **PATRÓN** `dist_vwap_pct` > `0.1311` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1311 (IC base=+0.241)

- **PATRÓN** `dist_vwap_pct` < `0.1097` → IC=+0.241 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1097 (IC base=+0.241)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.609` → IC=+0.274 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.609 (IC base=+0.241)

- **PATRÓN** `libro_liquidez` > `13129.6634` → IC=+0.328 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13129.6634 (IC base=+0.241)

- **PATRÓN** `ballena_activa_n` < `210.0` → IC=+0.269 (n=50)
...
- **FILTRO** `sigma_ewma_delta_pct` > `12.718` → IC=-0.140 (n=145)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=792)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4526 sube el IC de -0.055 a +0.162 en UPDOWN_GBM_15M_TARDIO (n=294). Ya aplicado como kelly_boost=+0.81€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3315 sube el IC de -0.078 a +0.352 en UPDOWN_GBM_15M_TARDIO (n=126). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3357 sube el IC de +0.241 a +0.342 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=80). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 595 | +0.086 | +45.55€ | 1 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 595 | +0.086 | +45.55€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 351 | +0.112 | +34.55€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 351 | +0.112 | +34.55€ | 0 | 10 |
...
| ✅ BALLENAS_TARDIAS | 6625 | -0.102 | -957.68€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 672 | -0.090 | -121.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5953 | -0.103 | -836.17€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1119 | +0.007 | -148.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1119 | +0.007 | -148.16€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2163 | -0.074 | -110.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2163 | -0.074 | -110.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1587 | -0.198 | -384.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1587 | -0.198 | -384.37€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30905 | +0.114 | -1997.04€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5748 | +0.187 | -179.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21898 | +0.094 | -1729.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3152 | +0.121 | -37.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3675 | +0.061 | -638.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3650 | +0.062 | -635.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6402 | +0.134 | -123.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1620 | +0.200 | -73.06€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3644 | +0.109 | -82.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1096 | +0.129 | +54.56€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3683 | +0.079 | -471.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 20 | +0.045 | +2.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3662 | +0.079 | -472.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6877 | +0.127 | -94.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2094 | +0.168 | -11.76€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3647 | +0.113 | -53.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1124 | +0.103 | -20.63€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6595 | +0.133 | -408.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1977 | +0.202 | -99.10€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3640 | +0.097 | -228.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 932 | +0.133 | -71.26€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3673 | +0.104 | -259.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3655 | +0.105 | -257.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5713 | +0.171 | -461.39€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5713 | +0.171 | -461.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1437 | +0.165 | -156.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1437 | +0.165 | -156.65€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1426 | +0.157 | -175.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1426 | +0.157 | -175.91€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1281 | +0.230 | -35.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1281 | +0.230 | -35.84€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 288 | +0.445 | +2.70€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 288 | +0.445 | +2.70€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 68 | +0.443 | +1.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 68 | +0.443 | +1.69€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15665 | +0.189 | -1420.74€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15665 | +0.189 | -1420.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2876 | +0.123 | -540.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2876 | +0.123 | -540.92€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2435 | +0.235 | -55.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2435 | +0.235 | -55.01€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2696 | +0.160 | -356.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2696 | +0.160 | -356.12€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2482 | +0.231 | -70.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2482 | +0.231 | -70.18€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2537 | +0.214 | -130.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2537 | +0.214 | -130.20€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2639 | +0.183 | -268.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2639 | +0.183 | -268.30€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 5673 | +0.135 | +209.26€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 5673 | +0.135 | +209.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2819 | +0.143 | +144.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2819 | +0.143 | +144.60€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2854 | +0.126 | +64.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2854 | +0.126 | +64.66€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 5835 | +0.095 | -220.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 598 | +0.062 | -25.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 5237 | +0.098 | -195.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 4029 | +0.096 | -94.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 598 | +0.062 | -25.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 3431 | +0.102 | -69.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1806 | +0.092 | -126.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1806 | +0.092 | -126.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 415 | +0.284 | -27.21€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 415 | +0.284 | -27.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 415 | +0.284 | -27.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 415 | +0.284 | -27.21€ | 0 | 4 |
| ✅ GBM_LATE_15M | 7382 | +0.044 | +2343.11€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 7382 | +0.044 | +2343.11€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 985 | +0.170 | +605.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 985 | +0.170 | +605.36€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 1031 | +0.175 | +604.57€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1031 | +0.175 | +604.57€ | 0 | 29 |
| ✅ GBM_LATE_15M#DOGE | 988 | +0.185 | +661.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 988 | +0.185 | +661.64€ | 0 | 17 |
| ✅ GBM_LATE_15M#ETH | 1204 | -0.046 | +30.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1204 | -0.046 | +30.14€ | 2 | 9 |
| ✅ GBM_LATE_15M#SOL | 1384 | -0.042 | +145.78€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1384 | -0.042 | +145.78€ | 5 | 3 |
| ✅ GBM_LATE_15M#XRP | 1790 | -0.052 | +295.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1790 | -0.052 | +295.63€ | 4 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 8335 | +0.045 | +3235.95€ | 0 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 8335 | +0.045 | +3235.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1272 | -0.022 | +629.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1272 | -0.022 | +629.02€ | 2 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1825 | -0.036 | +163.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1825 | -0.036 | +163.95€ | 0 | 1 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 857 | +0.238 | +777.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 857 | +0.238 | +777.36€ | 0 | 22 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1406 | -0.043 | +7.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1406 | -0.043 | +7.88€ | 8 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1497 | -0.020 | +287.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1497 | -0.020 | +287.87€ | 6 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1478 | +0.241 | +1369.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1478 | +0.241 | +1369.88€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 5976 | +0.168 | +4060.32€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 5976 | +0.168 | +4060.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 755 | +0.183 | +525.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 755 | +0.183 | +525.08€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 1016 | +0.164 | +682.85€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 1016 | +0.164 | +682.85€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 743 | +0.202 | +577.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 743 | +0.202 | +577.13€ | 0 | 17 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 992 | +0.161 | +634.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 992 | +0.161 | +634.53€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 1150 | +0.120 | +658.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 1150 | +0.120 | +658.79€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 1320 | +0.190 | +981.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 1320 | +0.190 | +981.94€ | 0 | 23 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 1028 | +0.080 | +205.19€ | 0 | 13 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 1028 | +0.080 | +205.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 56 | +0.086 | +14.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 56 | +0.086 | +14.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 304 | +0.118 | +108.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 304 | +0.118 | +108.25€ | 3 | 19 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 21 | +0.065 | +4.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 21 | +0.065 | +4.29€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 6947 | +0.169 | +4587.00€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#15min | 6947 | +0.169 | +4587.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 940 | +0.188 | +667.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 940 | +0.188 | +667.05€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1132 | +0.163 | +710.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1132 | +0.163 | +710.58€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 930 | +0.220 | +778.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 930 | +0.220 | +778.90€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1063 | +0.147 | +609.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1063 | +0.147 | +609.91€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1257 | +0.107 | +620.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1257 | +0.107 | +620.91€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1625 | +0.193 | +1199.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1625 | +0.193 | +1199.64€ | 0 | 24 |
| ✅ GBM_LATE_5M | 1504 | +0.132 | +704.29€ | 1 | 24 |
| ✅ GBM_LATE_5M#5min | 1504 | +0.132 | +704.29€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB | 79 | +0.191 | +48.83€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB#5min | 79 | +0.191 | +48.83€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 597 | +0.134 | +325.69€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 597 | +0.134 | +325.69€ | 3 | 20 |
| ✅ GBM_LATE_5M#DOGE | 13 | -0.108 | -4.42€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 13 | -0.108 | -4.42€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH | 556 | +0.143 | +251.63€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 556 | +0.143 | +251.63€ | 0 | 27 |
...
| ✅ LIQUIDACIONES_5M | 588 | -0.056 | -39.38€ | 4 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 4295 | -0.004 | -79.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 4295 | -0.004 | -79.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 487 | -0.011 | -0.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 487 | -0.011 | -0.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 731 | -0.007 | -25.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 731 | -0.007 | -25.40€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 853 | +0.011 | +15.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 853 | +0.011 | +15.70€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 762 | -0.011 | -30.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 762 | -0.011 | -30.34€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 864 | -0.014 | -29.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 864 | -0.014 | -29.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 6281 | -0.036 | +191.88€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 6281 | -0.036 | +191.88€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 995 | -0.023 | +141.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 995 | -0.023 | +141.99€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 1126 | -0.035 | -32.52€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 1126 | -0.035 | -32.52€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 1000 | -0.044 | +94.73€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 1000 | -0.044 | +94.73€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 1127 | -0.037 | -36.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 1127 | -0.037 | -36.50€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 1016 | -0.042 | +33.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 1016 | -0.042 | +33.80€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 1017 | -0.032 | -9.63€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 1017 | -0.032 | -9.63€ | 4 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 17262 | -0.073 | +273.65€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 17262 | -0.073 | +273.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 2667 | -0.091 | +301.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 2667 | -0.091 | +301.55€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 3109 | -0.059 | -6.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 3109 | -0.059 | -6.22€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 2757 | -0.086 | +7.41€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 2757 | -0.086 | +7.41€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 2629 | -0.096 | -183.18€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 2629 | -0.096 | -183.18€ | 8 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 3218 | -0.047 | +15.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 3218 | -0.047 | +15.43€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 2882 | -0.069 | +138.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 2882 | -0.069 | +138.65€ | 5 | 0 |
...
| ✅ STREAK_FADE_5M | 1046 | -0.021 | -49.50€ | 1 | 0 |
| ✅ STREAK_FADE_5M#5min | 1046 | -0.021 | -49.50€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE | 369 | -0.020 | -13.50€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE#5min | 369 | -0.020 | -13.50€ | 0 | 0 |
...
| ✅ STREAK_MOM_5M | 2056 | +0.031 | +45.67€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 2056 | +0.031 | +45.67€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 683 | +0.031 | +12.14€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 683 | +0.031 | +12.14€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 371 | +0.017 | +3.54€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 371 | +0.017 | +3.54€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 611 | +0.037 | +13.84€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 611 | +0.037 | +13.84€ | 1 | 2 |
| ✅ STREAK_MOM_5M#XRP | 391 | +0.032 | +16.14€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 391 | +0.032 | +16.14€ | 2 | 1 |
| ✅ STRUCT_NO_15M | 3027 | +0.009 | -26.23€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 3027 | +0.009 | -26.23€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1165 | +0.008 | -11.97€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1165 | +0.008 | -11.97€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1174 | +0.015 | -2.57€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1174 | +0.015 | -2.57€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 688 | -0.001 | -11.69€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 688 | -0.001 | -11.69€ | 2 | 0 |
| ✅ UPDOWN_GBM | 5824 | +0.007 | +150.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2190 | +0.046 | +219.91€ | 0 | 8 |
| ✅ UPDOWN_GBM#240min | 248 | +0.016 | +2.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 2973 | -0.017 | -61.53€ | 2 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 1268 | +0.018 | +59.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 220 | +0.072 | +28.43€ | 3 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 72 | +0.081 | +7.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 839 | +0.010 | +27.70€ | 3 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 119 | -0.037 | -6.64€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 18 | -0.135 | +1.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 741 | -0.007 | -1.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 122 | +0.105 | +29.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 8 | +0.000 | -0.09€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 611 | -0.030 | -30.81€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 1341 | +0.006 | +9.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 617 | +0.027 | +22.68€ | 1 | 6 |
| ✅ UPDOWN_GBM#ETH#240min | 71 | +0.075 | +4.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 480 | -0.027 | -19.27€ | 5 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 158 | +0.013 | +1.68€ | 0 | 2 |
| 🚫 UPDOWN_GBM#ETH#daily | 15 | -0.154 | -0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 1419 | -0.007 | -16.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 503 | +0.003 | -1.87€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 58 | -0.033 | -4.41€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 757 | -0.003 | -5.84€ | 4 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3690 | -0.072 | +841.39€ | 2 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3690 | -0.072 | +841.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 301 | -0.051 | +340.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 301 | -0.051 | +340.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 758 | -0.161 | -79.28€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 758 | -0.161 | -79.28€ | 4 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 77 | +0.070 | +14.56€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 77 | +0.070 | +14.56€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 275 | +0.121 | +118.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 275 | +0.121 | +118.67€ | 2 | 15 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1169 | -0.065 | +231.49€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1169 | -0.065 | +231.49€ | 3 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1110 | -0.083 | +215.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1110 | -0.083 | +215.14€ | 4 | 0 |
...
| ✅ UPDOWN_OU_5M | 430 | -0.079 | -39.89€ | 4 | 0 |
| ✅ UPDOWN_OU_5M#5min | 430 | -0.079 | -39.89€ | 0 | 0 |
...
| 🚫 UPDOWN_OU_5M#DOGE | 29 | -0.210 | -6.70€ | 0 | 0 |
| 🚫 UPDOWN_OU_5M#DOGE#5min | 29 | -0.210 | -6.70€ | 1 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.088) — sin ventaja clara. oversold(IBS<0.3): IC=+0.009 n=2045 | neutral: IC=+0.002 n=2205 | overbought(IBS>0.7): IC=+0.090 n=2277
  - _Datos_: n=6833 IC=+0.035 PNL=+580.32€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 17 celda(s) pasan gate riguroso completo de 711 evaluadas (n>=40) y 2027 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.003 < 0.08 — monitorear
  - _Datos_: n=503 IC=+0.003 PNL=-1.87€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.076 n=92993 | tras_1loss IC=+0.044 n=72493 | tras_2loss IC=+0.008 n=32972/40 | gap=+0.068 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 5762 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=5583 IC=+0.003 PNL=+100.17€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=5583 IC=+0.003 PNL=+100.17€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1266 IC=+0.033 PNL=+83.92€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1266 IC=+0.033 PNL=+83.92€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=2064 IC=-0.015 PNL=-41.24€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2064 IC=-0.015 PNL=-41.24€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1564 IC=+0.027 PNL=+103.50€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1564 IC=+0.027 PNL=+103.50€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=431 IC=+0.031 PNL=-3.29€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=431 IC=+0.031 PNL=-3.29€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=8062 IC=+0.096 PNL=+2189.91€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8062 IC=+0.096 PNL=+2189.91€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=781 IC=+0.024 PNL=+42.36€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=781 IC=+0.024 PNL=+42.36€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.166 > 0.1 con n=759 PNL=+274.32€
  - _Datos_: n=759 IC=+0.166 PNL=+274.32€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=4100 IC=-0.139 PNL=+228.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=4100 IC=-0.139 PNL=+228.35€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=552 IC=+0.143 PNL=+226.36€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=552 IC=+0.143 PNL=+226.36€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.238 < -0.1 con n=449 PNL=-56.97€
  - _Datos_: n=449 IC=-0.238 PNL=-56.97€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1091 IC=+0.133 PNL=+538.68€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1091 IC=+0.133 PNL=+538.68€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=623 IC=-0.026 PNL=+37.82€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=623 IC=-0.026 PNL=+37.82€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=241 PNL=-27.45€
  - _Datos_: n=241 IC=+0.121 PNL=-27.45€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.239 > 0.08 con n=1349 PNL=-119.99€
  - _Datos_: n=1349 IC=+0.239 PNL=-119.99€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2876 IC=+0.123 PNL=-540.92€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2876 IC=+0.123 PNL=-540.92€
