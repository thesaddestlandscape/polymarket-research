# Hipótesis automáticas — 2026-08-14 15:46 UTC
_Generado por shadow_postmortem.py sobre 27382 resoluciones (PNL=+4845.33€)_
...
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.188 (n=78)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.37 (IC base=+0.139)

- **PATRÓN** `py_entrada` > `0.43` → IC=+0.164 (n=129)

  - _Acción_: Kelly boost +0.82€ cuando `py_entrada` > 0.43 (IC base=+0.139)

- **PATRÓN** `restante_min` > `4.86` → IC=+0.191 (n=108)

  - _Acción_: Kelly boost +0.95€ cuando `restante_min` > 4.86 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.158 (n=232)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 11.0 (IC base=+0.139)

- **PATRÓN** `lag_apertura_s` < `56.85` → IC=+0.163 (n=197)

  - _Acción_: Kelly boost +0.82€ cuando `lag_apertura_s` < 56.85 (IC base=+0.139)
...
- **PATRÓN** `py_entrada` < `0.41` → IC=+0.188 (n=75)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.41 (IC base=+0.167)

- **PATRÓN** `py_entrada` > `0.37` → IC=+0.178 (n=113)

  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` > 0.37 (IC base=+0.167)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.287 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.95 (IC base=+0.167)
...
- **PATRÓN** `lag_apertura_s` < `3.12` → IC=+0.346 (n=37)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 3.12 (IC base=+0.167)
...
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.128 (n=154)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.0028 (IC base=+0.099)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2` → IC=+0.198 (n=51)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.99€ cuando `pct_spot_vs_ref` |x|≤ 0.2 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.217 (n=44)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.191)

- **PATRÓN** `sigma_h` > `0.0018` → IC=+0.192 (n=50)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0018 (IC base=+0.191)
...
| ✅ BALLENAS_TARDIAS | 783 | -0.045 | -152.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 271 | +0.156 | -4.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 512 | -0.152 | -147.69€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#DOGE | 82 | -0.107 | -30.14€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 82 | -0.107 | -30.14€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#ETH | 117 | -0.298 | -5.89€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#ETH#5min | 117 | -0.298 | -5.89€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 140 | -0.183 | -70.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 140 | -0.183 | -70.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 84 | -0.128 | -23.84€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 84 | -0.128 | -23.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 5685 | +0.139 | -183.92€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2166 | +0.181 | -102.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 60 | -0.081 | -23.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 1127 | +0.079 | -95.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2332 | +0.134 | +37.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 198 | +0.050 | -26.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 8 | -0.040 | -1.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 187 | +0.066 | -21.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 1677 | +0.144 | -7.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 597 | +0.178 | -54.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 24 | -0.038 | -8.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 188 | +0.063 | -16.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 868 | +0.144 | +72.24€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 193 | +0.038 | -37.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 190 | +0.047 | -32.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 1794 | +0.135 | -14.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 810 | +0.171 | +0.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 11 | -0.106 | -7.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 188 | +0.058 | -15.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 785 | +0.121 | +8.07€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#SOL | 1628 | +0.159 | -96.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 740 | +0.200 | -42.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min |
 | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 434 | +0.083 | +66.38€ | 0 | 1 |
...
| ✅ UPDOWN_GBM#BTC | 212 | -0.028 | -15.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 91 | +0.016 | -9.07€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 818 | -0.024 | +67.08€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 818 | -0.024 | +67.08€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 36 | +0.053 | +9.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 36 | +0.053 | +9.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 220 | -0.090 | +1.30€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 220 | -0.090 | +1.30€ | 1 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 223 | -0.024 | +5.53€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 223 | -0.024 | +5.53€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 232 | -0.004 | +26.17€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 232 | -0.004 | +26.17€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO | 99 | +0.213 | +28.10€ | 0 | 2 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 99 | +0.213 | +28.10€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 66 | +0.191 | +9.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 66 | +0.191 | +9.62€ | 0 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.120) — sin ventaja clara. oversold(IBS<0.3): IC=+0.017 n=298 | neutral: IC=+0.004 n=274 | overbought(IBS>0.7): IC=+0.124 n=450
  - _Datos_: n=1071 IC=+0.056 PNL=+86.06€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.126 n=16494 | tras_1loss IC=+0.086 n=10563 | tras_2loss IC=+0.050 n=4342/40 | gap=+0.075 (umbral 0.05)
...
**⏳ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: 29/40 ops en el filtro definido (IC actual=+0.210 PNL=+17.10€)
  - _Datos_: n=29 IC=+0.210 PNL=+17.10€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=744 IC=+0.025 PNL=+58.16€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=744 IC=+0.025 PNL=+58.16€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=225 IC=+0.099 PNL=+28.83€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=225 IC=+0.099 PNL=+28.83€
...
**🔶 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA en BTC (IC=+0.016 n=91) pero sin cruzar ≥2 pares más — BNB: n=13 IC=+0.152; DOGE: n=11 IC=-0.021; ETH: n=137 IC=+0.104; SOL: n=56 IC=-0.017 ✓; XRP: n=126 IC=+0.141
  - _Datos_: n=91 IC=+0.016 PNL=-9.07€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.082 > 0.08 con n=273 PNL=+38.01€
  - _Datos_: n=273 IC=+0.082 PNL=+38.01€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.103 > 0.08 con n=56 PNL=+16.41€
  - _Datos_: n=56 IC=+0.103 PNL=+16.41€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=460 IC=+0.033 PNL=+18.46€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=460 IC=+0.033 PNL=+18.46€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.147 > 0.1 con n=298 PNL=+81.72€
  - _Datos_: n=298 IC=+0.147 PNL=+81.72€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=442 IC=-0.108 PNL=+85.96€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=442 IC=-0.108 PNL=+85.96€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.099 > 0.08 con n=225 PNL=+28.83€
  - _Datos_: n=225 IC=+0.099 PNL=+28.83€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 70/80 ops en el filtro definido (IC actual=+0.069 PNL=-4.64€)
  - _Datos_: n=70 IC=+0.069 PNL=-4.64€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=440 IC=+0.183 PNL=+256.39€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=440 IC=+0.183 PNL=+256.39€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.175 > 0.08 con n=164 PNL=+81.08€
  - _Datos_: n=164 IC=+0.175 PNL=+81.08€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=147 IC=+0.097 PNL=-33.38€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=147 IC=+0.097 PNL=-33.38€
