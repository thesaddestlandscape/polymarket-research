# Hipótesis automáticas — 2026-08-26 14:19 UTC
_Generado por shadow_postmortem.py sobre 162670 resoluciones (PNL=+11693.62€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.73` → IC=-0.278 (n=2254)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.73
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=6763)
...
- **FILTRO** `restante_s_al_confirmar` < `90.87` → IC=-0.436 (n=279)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=839)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `157.37` → IC=-0.196 (n=614)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.37
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1845)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `150.33` → IC=-0.274 (n=534)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 150.33
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1602)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.96` → IC=-0.344 (n=512)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.96
  - _Potencial_: sin este filtro IC_bueno=-0.117 (n=1041)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.187 (n=5175)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1540)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2376.0723` → IC=+0.174 (n=1488)
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.260 (n=3172)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.189 (n=2854)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `1839.4583` → IC=+0.181 (n=2386)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 1839.4583 (IC base=+0.140)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=611)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `12480.3954` → IC=+0.215 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12480.3954 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.196 (n=548)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.325` → IC=+0.290 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.186 (n=785)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `11939.3802` → IC=+0.207 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11939.3802 (IC base=+0.186)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=525)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.118)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.136 (n=454)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 15.0 (IC base=+0.118)

- **PATRÓN** `py_entrada` > `0.555` → IC=+0.140 (n=528)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.130 (n=1000)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.291 (n=405)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.282)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.286 (n=455)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2840.5007` → IC=+0.293 (n=288)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.195 (n=923)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 5.0 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.195 (n=782)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `977.1681` → IC=+0.238 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 977.1681 (IC base=+0.221)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1107)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.167 (n=947)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.194 (n=1060)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.188 (n=918)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.247 (n=1110)
...
- **PATRÓN** `lag_apertura_s` < `4.48` → IC=+0.160 (n=1391)

  - _Acción_: Kelly boost +0.80€ cuando `lag_apertura_s` < 4.48 (IC base=+0.133)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.204 (n=786)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.141)

- **PATRÓN** `restante_min` < `3.91` → IC=+0.144 (n=700)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` < 3.91 (IC base=+0.141)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.171 (n=693)

  - _Acción_: Kelly boost +0.85€ cuando `restante_min` > 4.91 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.151 (n=1842)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 15.0 (IC base=+0.141)

- **PATRÓN** `lag_apertura_s` < `5.7` → IC=+0.171 (n=693)

  - _Acción_: Kelly boost +0.85€ cuando `lag_apertura_s` < 5.7 (IC base=+0.141)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.193 (n=790)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.38 (IC base=+0.125)

- **PATRÓN** `restante_min` < `3.98` → IC=+0.135 (n=704)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` < 3.98 (IC base=+0.125)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.160 (n=759)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.94 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=2193)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.46` → IC=+0.166 (n=701)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 3.46 (IC base=+0.125)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.299 (n=277)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.308 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `1518.0458` → IC=+0.325 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1518.0458 (IC base=+0.283)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9495` → IC=+0.212 (n=709)
...
- **PATRÓN** `dist_vwap_pct` < `0.5051` → IC=+0.216 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5051 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.229` → IC=+0.169 (n=869)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.229 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` < `0.6304` → IC=+0.232 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6304 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `1.0648` → IC=+0.254 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0648 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.1727` → IC=+0.135 (n=327)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` > 0.1727 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `1.5715` → IC=+0.143 (n=497)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5715 (IC base=+0.065)

- **PATRÓN** `ibs_20min` < `0.2136` → IC=+0.130 (n=1458)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.2136 (IC base=+0.030)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1758` → IC=+0.256 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1758 (IC base=+0.030)

- **PATRÓN** `volumen_spike_ratio` < `1.6134` → IC=+0.206 (n=321)
...
- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.241 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 42.0 (IC base=+0.030)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.202 (n=159)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.733` → IC=+0.330 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.733 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.146 (n=258)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.04 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.298 (n=166)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.280)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.324 (n=83)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.280)

- **PATRÓN** `drift_60min` |x|≤ `0.1478` → IC=+0.344 (n=165)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1478 (IC base=+0.280)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.285 (n=231)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.280)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.283 (n=229)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.280)

- **PATRÓN** `ibs_20min` < `0.4667` → IC=+0.323 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4667 (IC base=+0.280)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.993` → IC=+0.319 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.993 (IC base=+0.280)

- **PATRÓN** `volumen_pendiente_norm` < `0.0585` → IC=+0.316 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0585 (IC base=+0.280)

- **PATRÓN** `volumen_pendiente_norm` > `0.23` → IC=+0.316 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.23 (IC base=+0.280)

- **PATRÓN** `volumen_spike_ratio` < `1.7507` → IC=+0.306 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7507 (IC base=+0.280)

- **PATRÓN** `volumen_spike_ratio` > `1.5291` → IC=+0.300 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5291 (IC base=+0.280)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.331 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.280)

- **PATRÓN** `libro_liquidez` > `1989.8695` → IC=+0.312 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1989.8695 (IC base=+0.280)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.325 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 42.0 (IC base=+0.280)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.245 (n=155)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.211)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.231 (n=117)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.3368` → IC=+0.217 (n=309)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3368 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.237 (n=352)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.211)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.213 (n=319)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.4287` → IC=+0.222 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4287 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.2395` → IC=+0.234 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2395 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `0.5536` → IC=+0.211 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5536 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.359` → IC=+0.233 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.359 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.279` → IC=+0.212 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.279 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.247 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.2656` → IC=+0.261 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2656 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4455` → IC=+0.267 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4455 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11188.0133` → IC=+0.222 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11188.0133 (IC base=+0.211)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.932` → IC=+0.265 (n=113)
...
- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.140 (n=48)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 16.0 (IC base=+0.128)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.281 (n=304)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.261)

- **PATRÓN** `drift_60min` |x|≤ `0.3735` → IC=+0.275 (n=304)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3735 (IC base=+0.261)
...
- **PATRÓN** `ibs_20min` < `0.5322` → IC=+0.294 (n=304)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.4178` → IC=+0.431 (n=27)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.4178 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` < `1.8237` → IC=+0.230 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8237 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` > `2.7662` → IC=+0.232 (n=121)
...
- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.226 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 44.0 (IC base=+0.261)
...
- **FILTRO** `ibs_20min` > `0.76` → IC=-0.160 (n=313)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.921` → IC=-0.153 (n=266)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=988)
...
- **FILTRO** `drift_60min` |x|> `0.4991` → IC=-0.139 (n=217)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.141 (n=104)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=535)

- **FILTRO** `ibs_20min` > `0.7778` → IC=-0.167 (n=280)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7778
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=848)
...
- **PATRÓN** `dist_vwap_pct` < `0.2396` → IC=+0.175 (n=38)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2396 (IC base=-0.084)

- **PATRÓN** `volumen_regimen` > `0.6932` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.6932 (IC base=-0.084)
...
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.150 (n=900)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0087 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9459` → IC=+0.246 (n=898)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1149` → IC=+0.168 (n=1187)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` < 0.1149 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.2458` → IC=+0.200 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2458 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `1.4786` → IC=+0.190 (n=408)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.4786 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` > `2.8554` → IC=+0.166 (n=408)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.8554 (IC base=+0.052)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.270 (n=671)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.0966` → IC=+0.178 (n=1157)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.0966 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` > `1.0735` → IC=+0.214 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0735 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` < `0.1466` → IC=+0.202 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1466 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.211 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6271 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` > `0.2539` → IC=+0.363 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2539 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` > `2.3777` → IC=+0.282 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3777 (IC base=+0.039)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.255 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.039)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2469` → IC=-0.146 (n=173)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2469
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=353)

- **FILTRO** `sigma_ewma_delta_pct` > `5.153` → IC=-0.207 (n=121)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 5.153
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=600)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.107` → IC=+0.192 (n=102)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 5.107 (IC base=-0.013)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0944` → IC=+0.206 (n=182)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0944 (IC base=+0.177)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.94` → IC=+0.284 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.94 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1458` → IC=+0.187 (n=308)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1458 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.4252` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.4252 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` < `2.0329` → IC=+0.182 (n=146)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.0329 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `3.7364` → IC=+0.178 (n=150)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 3.7364 (IC base=+0.177)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.192 (n=105)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 54.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0081` → IC=+0.366 (n=214)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0081 (IC base=+0.347)

- **PATRÓN** `drift_60min` |x|≤ `0.3456` → IC=+0.353 (n=189)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3456 (IC base=+0.347)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.387 (n=148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.347)

- **PATRÓN** `ibs_20min` < `0.3056` → IC=+0.356 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3056 (IC base=+0.347)

- **PATRÓN** `ibs_20min` > `0.1351` → IC=+0.348 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1351 (IC base=+0.347)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.494` → IC=+0.349 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.494 (IC base=+0.347)

- **PATRÓN** `volumen_pendiente_norm` > `0.1402` → IC=+0.381 (n=57)
...
- **PATRÓN** `volumen_spike_ratio` > `1.997` → IC=+0.338 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.997 (IC base=+0.347)

- **PATRÓN** `libro_liquidez` > `1900.976` → IC=+0.351 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1900.976 (IC base=+0.347)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.311 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 37.0 (IC base=+0.347)
...
- **FILTRO** `ibs_20min` < `0.5333` → IC=-0.150 (n=304)
...
- **PATRÓN** `volumen_regimen` < `0.8622` → IC=+0.175 (n=115)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.8622 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `1.1437` → IC=+0.195 (n=57)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.1437 (IC base=-0.010)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4987` → IC=+0.179 (n=54)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4987 (IC base=-0.010)

- **PATRÓN** `volumen_spike_ratio` > `2.0538` → IC=+0.167 (n=73)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.0538 (IC base=-0.010)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.203 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 77.0 (IC base=-0.010)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0236` → IC=+0.324 (n=180)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.8986` → IC=+0.327 (n=154)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8986 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.172` → IC=+0.276 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.172 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `0.8368` → IC=+0.251 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8368 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.0807` → IC=+0.223 (n=457)
...
- **PATRÓN** `libro_liquidez` > `2659.8294` → IC=+0.235 (n=360)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2659.8294 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.282 (n=246)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.267)

- **PATRÓN** `drift_60min` |x|≤ `0.2788` → IC=+0.272 (n=370)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2788 (IC base=+0.267)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.278 (n=515)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.267)

- **PATRÓN** `ibs_20min` < `0.2766` → IC=+0.325 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2766 (IC base=+0.267)

- **PATRÓN** `dist_vwap_pct` < `0.8584` → IC=+0.272 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8584 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.698` → IC=+0.314 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.698 (IC base=+0.267)

- **PATRÓN** `volumen_regimen` > `1.2513` → IC=+0.302 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2513 (IC base=+0.267)

- **PATRÓN** `volumen_pendiente_norm` > `0.2435` → IC=+0.362 (n=78)
...
- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.250 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=+0.267)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.185 (n=1545)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0067 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=2420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` > `0.8925` → IC=+0.258 (n=1545)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8925 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.7901` → IC=+0.251 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7901 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.334` → IC=+0.252 (n=990)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.334 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` < `1.2203` → IC=+0.160 (n=1610)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2203 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `0.6873` → IC=+0.173 (n=1438)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6873 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.1022` → IC=+0.179 (n=824)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1022 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.2822` → IC=+0.157 (n=1821)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.2822 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.8555` → IC=+0.146 (n=1380)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8555 (IC base=+0.156)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=1902)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `3841.9492` → IC=+0.193 (n=773)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 3841.9492 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.180 (n=1080)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 125.0 (IC base=+0.156)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.203 (n=1831)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.399` → IC=+0.201 (n=2080)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.399 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.217 (n=1046)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` < `0.4082` → IC=+0.238 (n=2080)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4082 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.3544` → IC=+0.178 (n=1827)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3544 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.806` → IC=+0.220 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.806 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` < `1.1778` → IC=+0.166 (n=1693)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1778 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `0.8615` → IC=+0.174 (n=1128)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8615 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.250 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` < `1.8725` → IC=+0.180 (n=981)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.8725 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.6218` → IC=+0.211 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6218 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `203.0` → IC=+0.183 (n=1040)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 203.0 (IC base=+0.186)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.233 (n=170)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.150)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.177 (n=345)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.973` → IC=+0.357 (n=138)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.973 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1398` → IC=+0.171 (n=86)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1398 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.4192` → IC=+0.142 (n=294)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.4192 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.281 (n=158)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.276)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.291 (n=180)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.276)

- **PATRÓN** `drift_60min` |x|≤ `0.3243` → IC=+0.319 (n=180)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3243 (IC base=+0.276)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.274 (n=91)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 13.0 (IC base=+0.276)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.285 (n=184)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 16.0 (IC base=+0.276)

- **PATRÓN** `ibs_20min` < `0.3503` → IC=+0.312 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3503 (IC base=+0.276)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.89` → IC=+0.300 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.89 (IC base=+0.276)

- **PATRÓN** `volumen_pendiente_norm` < `0.081` → IC=+0.296 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.081 (IC base=+0.276)

- **PATRÓN** `volumen_spike_ratio` < `1.7714` → IC=+0.325 (n=78)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.328 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `1986.7396` → IC=+0.355 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1986.7396 (IC base=+0.276)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.320 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 50.0 (IC base=+0.276)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.227 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0073 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.217 (n=341)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.182)

- **PATRÓN** `ibs_20min` > `0.5086` → IC=+0.221 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5086 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.250 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.777` → IC=+0.250 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.777 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.6325` → IC=+0.203 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6325 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `0.8987` → IC=+0.202 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8987 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2159` → IC=+0.254 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2159 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` < `1.3897` → IC=+0.243 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3897 (IC base=+0.182)

- **PATRÓN** `libro_liquidez` > `11982.1154` → IC=+0.206 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11982.1154 (IC base=+0.182)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.215 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.2908` → IC=+0.178 (n=424)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2908 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.177 (n=388)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 7.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` < `0.4047` → IC=+0.190 (n=424)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.4047 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.1569` → IC=+0.182 (n=413)
...
- **PATRÓN** `volumen_regimen` < `0.7185` → IC=+0.220 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7185 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.230 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `1.7385` → IC=+0.176 (n=211)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.7385 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `14172.2577` → IC=+0.171 (n=141)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 14172.2577 (IC base=+0.154)
...
- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.305 (n=183)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.285)

- **PATRÓN** `drift_60min` |x|≤ `0.1893` → IC=+0.323 (n=139)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1893 (IC base=+0.285)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.339 (n=141)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.285)

- **PATRÓN** `ibs_20min` < `0.0082` → IC=+0.389 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0082 (IC base=+0.285)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0228` → IC=+0.295 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0228 (IC base=+0.285)

- **PATRÓN** `ballena_activa_n` < `52.0` → IC=+0.239 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 52.0 (IC base=+0.285)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.220 (n=326)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0094 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.4977` → IC=+0.204 (n=326)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4977 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.207 (n=329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` > `0.4502` → IC=+0.244 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4502 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `1.0396` → IC=+0.238 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0396 (IC base=+0.186)
...
- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.201 (n=326)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.189 (n=368)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `8630.7084` → IC=+0.208 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8630.7084 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `157.0` → IC=+0.189 (n=175)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 157.0 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0024` → IC=+0.248 (n=137)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0024 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.3745` → IC=+0.164 (n=406)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3745 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.179 (n=207)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 14.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` < `0.3456` → IC=+0.213 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3456 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.5306` → IC=+0.159 (n=476)
...
- **PATRÓN** `volumen_regimen` < `0.856` → IC=+0.152 (n=271)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.856 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6199` → IC=+0.156 (n=405)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6199 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.1001` → IC=+0.167 (n=118)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1001 (IC base=+0.144)
...
- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.124 (n=192)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 196.0 (IC base=+0.144)
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.189 (n=130)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0048 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.195 (n=185)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 14.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.4107` → IC=+0.231 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4107 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.217` → IC=+0.142 (n=358)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.217 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.672` → IC=+0.184 (n=74)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 6.672 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` > `0.8568` → IC=+0.169 (n=258)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.8568 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.2176` → IC=+0.204 (n=52)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.128 (n=331)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `2060.221` → IC=+0.169 (n=258)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2060.221 (IC base=+0.126)
...
- **PATRÓN** `ibs_20min` < `0.3738` → IC=+0.256 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3738 (IC base=+0.219)

- **PATRÓN** `dist_vwap_pct` < `0.7862` → IC=+0.227 (n=566)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7862 (IC base=+0.219)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.162` → IC=+0.271 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.162 (IC base=+0.219)

- **PATRÓN** `volumen_regimen` > `0.7158` → IC=+0.239 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7158 (IC base=+0.219)

- **PATRÓN** `volumen_pendiente_norm` > `0.2431` → IC=+0.335 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2431 (IC base=+0.219)

- **PATRÓN** `volumen_spike_ratio` > `2.6983` → IC=+0.265 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6983 (IC base=+0.219)

- **PATRÓN** `ballena_activa_n` < `31.0` → IC=+0.183 (n=263)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 31.0 (IC base=+0.219)
...
- **PATRÓN** `ibs_20min` > `0.6275` → IC=+0.151 (n=350)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.6275 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` > `0.7807` → IC=+0.240 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7807 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.086` → IC=+0.212 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.086 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` > `0.1714` → IC=+0.183 (n=99)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1714 (IC base=+0.083)

- **PATRÓN** `libro_liquidez` > `2945.8225` → IC=+0.124 (n=261)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2945.8225 (IC base=+0.083)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.365` → IC=+0.246 (n=1142)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.365 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.7038` → IC=+0.153 (n=839)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7038 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.156 (n=864)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.0851 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1657` → IC=+0.182 (n=683)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1657 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.3279` → IC=+0.146 (n=2093)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.3279 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.8844` → IC=+0.157 (n=1585)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.8844 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2204)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `3813.8034` → IC=+0.196 (n=898)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 3813.8034 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.195 (n=1160)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 163.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.227 (n=1616)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.194)

- **PATRÓN** `drift_60min` |x|≤ `0.4483` → IC=+0.202 (n=2425)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4483 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.196 (n=2210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.551` → IC=+0.249 (n=2424)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.551 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` < `0.7107` → IC=+0.182 (n=1987)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.7107 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.418` → IC=+0.224 (n=353)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.418 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.649` → IC=+0.198 (n=2281)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` < 2.649 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` < `0.6242` → IC=+0.187 (n=615)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6242 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` > `1.1936` → IC=+0.192 (n=614)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.1936 (IC base=+0.194)

- **PATRÓN** `volumen_pendiente_norm` > `0.281` → IC=+0.270 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.281 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.256` → IC=+0.212 (n=783)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.256 (IC base=+0.194)

- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.168 (n=1296)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 181.0 (IC base=+0.194)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.224 (n=197)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.167 (n=298)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 11.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.949` → IC=+0.284 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.949 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.501` → IC=+0.357 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.501 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.316 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.281)

- **PATRÓN** `drift_60min` |x|≤ `0.1543` → IC=+0.327 (n=171)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.289 (n=240)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.281)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.341 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5833 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.039` → IC=+0.310 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.039 (IC base=+0.281)

- **PATRÓN** `volumen_pendiente_norm` < `0.069` → IC=+0.303 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.069 (IC base=+0.281)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.311 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `1997.707` → IC=+0.341 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1997.707 (IC base=+0.281)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.277 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.281)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 6.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.3282` → IC=+0.210 (n=425)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.203 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.157)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.188 (n=331)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.4677` → IC=+0.186 (n=336)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.4677 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `11706.7568` → IC=+0.191 (n=283)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11706.7568 (IC base=+0.157)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.186 (n=119)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.241 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.176)

- **PATRÓN** `ibs_20min` > `0.7131` → IC=+0.256 (n=317)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1464` → IC=+0.182 (n=259)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` < 0.1464 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` < `2.1217` → IC=+0.185 (n=125)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.1217 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `3.8523` → IC=+0.169 (n=128)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 3.8523 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.193 (n=242)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.03 (IC base=+0.176)

- **PATRÓN** `libro_liquidez` > `1855.8284` → IC=+0.195 (n=237)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 1855.8284 (IC base=+0.176)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.214 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.176)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.270 (n=329)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.265)

- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.330 (n=328)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3655` → IC=+0.300 (n=33)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3655 (IC base=+0.265)

- **PATRÓN** `volumen_spike_ratio` < `1.7663` → IC=+0.303 (n=69)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.153 (n=428)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.170 (n=386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 8.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.3491` → IC=+0.198 (n=428)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3491 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.8989` → IC=+0.214 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8989 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.544` → IC=+0.196 (n=205)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 4.544 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.6318` → IC=+0.197 (n=143)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.6318 (IC base=+0.143)
...
- **PATRÓN** `libro_liquidez` > `4999.3593` → IC=+0.235 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4999.3593 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.195 (n=201)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 168.0 (IC base=+0.143)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4941` → IC=+0.164 (n=352)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.4941 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.178 (n=253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 11.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.0802` → IC=+0.245 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0802 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1609` → IC=+0.156 (n=181)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1609 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.6682` → IC=+0.175 (n=377)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.6682 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` < `0.5903` → IC=+0.175 (n=118)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.5903 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.1142` → IC=+0.183 (n=118)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.1142 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1935` → IC=+0.184 (n=261)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.1935 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.4569` → IC=+0.178 (n=296)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4569 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `9345.63` → IC=+0.198 (n=160)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 9345.63 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.173 (n=218)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0107 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.133 (n=325)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.300 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.7691` → IC=+0.252 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7691 (IC base=+0.096)
...
- **PATRÓN** `libro_liquidez` > `2895.1692` → IC=+0.273 (n=161)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2895.1692 (IC base=+0.096)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.185 (n=198)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0059 (IC base=+0.119)

- **PATRÓN** `drift_60min` |x|≤ `0.5096` → IC=+0.128 (n=450)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.5096 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.161 (n=234)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 14.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` < `0.5758` → IC=+0.199 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5758 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` < `0.4633` → IC=+0.139 (n=408)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4633 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.994` → IC=+0.137 (n=441)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 2.994 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` < `0.703` → IC=+0.150 (n=198)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.703 (IC base=+0.119)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7463` → IC=+0.170 (n=201)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.7463 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=471)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2575.6322` → IC=+0.165 (n=204)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2575.6322 (IC base=+0.119)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0257` → IC=+0.220 (n=191)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0257 (IC base=+0.173)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.180 (n=573)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` > `1.0463` → IC=+0.195 (n=260)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.0463 (IC base=+0.173)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5675` → IC=+0.170 (n=231)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5675 (IC base=+0.173)

- **PATRÓN** `volumen_spike_ratio` > `1.8321` → IC=+0.184 (n=349)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4637` → IC=+0.225 (n=554)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4637 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.223 (n=582)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` < `0.4887` → IC=+0.277 (n=629)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4887 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `1.1534` → IC=+0.221 (n=733)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.1534 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.533` → IC=+0.275 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.533 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.021` → IC=+0.216 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.021 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `1.2292` → IC=+0.255 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2292 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` > `0.2833` → IC=+0.308 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2833 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.5474` → IC=+0.234 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5474 (IC base=+0.212)

- **PATRÓN** `ballena_activa_n` < `33.0` → IC=+0.160 (n=310)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 33.0 (IC base=+0.212)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.151 (n=893)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.132 (n=359)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0105 (IC base=+0.105)
...
- **PATRÓN** `volumen_regimen` < `0.7179` → IC=+0.142 (n=160)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.7179 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1297` → IC=+0.127 (n=352)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.1297 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.127 (n=397)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `8162.0536` → IC=+0.150 (n=272)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8162.0536 (IC base=+0.105)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.201 (n=229)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.3507` → IC=+0.168 (n=600)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3507 (IC base=+0.145)
...
- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.153 (n=600)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.6296 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.1827` → IC=+0.145 (n=609)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.1827 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.6272` → IC=+0.171 (n=156)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6272 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.8053` → IC=+0.143 (n=775)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.8053 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.141` → IC=+0.161 (n=305)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.141 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.061` → IC=+0.146 (n=685)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.061 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `1.2252` → IC=+0.160 (n=671)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2252 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` < `0.0946` → IC=+0.147 (n=608)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.0946 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.162 (n=329)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `2.489` → IC=+0.164 (n=674)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.489 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.5136` → IC=+0.151 (n=602)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.5136 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=893)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `8426.6807` → IC=+0.151 (n=681)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8426.6807 (IC base=+0.145)
...
- **FILTRO** `libro_liquidez` < `12272.8392` → IC=-0.167 (n=22)

  - _Acción_: SKIP cuando `libro_liquidez` < 12272.8392
  - _Potencial_: sin este filtro IC_bueno=+0.181 (n=45)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.123 (n=51)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 9.0 (IC base=+0.065)

- **PATRÓN** `ibs_20min` < `0.9366` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.9366 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.6176` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.6176 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.972` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` < 3.972 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` < `0.5285` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.5285 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` < `0.0831` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.0831 (IC base=+0.065)

- **PATRÓN** `libro_liquidez` > `12272.8392` → IC=+0.181 (n=45)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 12272.8392 (IC base=+0.065)

- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.185 (n=252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0044 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.3416` → IC=+0.152 (n=377)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.3416 (IC base=+0.139)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.198 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 5.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.144` → IC=+0.167 (n=166)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.144 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6118` → IC=+0.172 (n=59)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.6118 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.369` → IC=+0.151 (n=382)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.369 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1906` → IC=+0.146 (n=377)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.1906 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.144 (n=377)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6229 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.180 (n=179)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.5707` → IC=+0.156 (n=376)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.5707 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `2.1689` → IC=+0.140 (n=170)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.1689 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `11854.8179` → IC=+0.143 (n=337)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 11854.8179 (IC base=+0.139)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.168 (n=752)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=2308)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.214 (n=723)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2326)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.178 (n=761)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=2288)
...
- **FILTRO** `ibs_20min` < `0.7265` → IC=-0.193 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=336)

- **FILTRO** `ibs_20min` > `0.2721` → IC=-0.131 (n=177)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2721
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=345)

### MOMENTUM_IBS_15M_BALLENA#BTC#15min
- **FILTRO** `py_entrada` > `0.57` → IC=-0.232 (n=121)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=393)

- **FILTRO** `ballena_activa_n` > `76.0` → IC=-0.162 (n=128)

  - _Acción_: SKIP cuando `ballena_activa_n` > 76.0
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=386)
...
- **FILTRO** `ibs_20min` > `0.7608` → IC=-0.200 (n=128)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.180 (n=145)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=397)

- **FILTRO** `ballena_activa_n` > `4.0` → IC=-0.134 (n=184)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.224 (n=114)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=367)

- **FILTRO** `ibs_20min` > `0.2778` → IC=-0.175 (n=118)
...
- **FILTRO** `py_entrada` > `0.61` → IC=-0.268 (n=153)
...
- **FILTRO** `ibs_20min` > `0.2861` → IC=-0.244 (n=119)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=358)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=2175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5344)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.287 (n=1816)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=5703)

- **FILTRO** `ibs_7min` < `0.7358` → IC=-0.235 (n=1879)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7358
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=5640)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.174 (n=2502)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=5017)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.229 (n=2130)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=7116)

- **FILTRO** `ibs_7min` > `0.7213` → IC=-0.169 (n=2311)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7213
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=6935)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=786)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.331 (n=246)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=777)

- **FILTRO** `ibs_7min` < `0.9818` → IC=-0.201 (n=674)
...
- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.263 (n=255)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=768)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.231 (n=377)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1193)

- **FILTRO** `drift_7min_pct` |x|> `0.1399` → IC=-0.158 (n=533)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1399
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1037)

- **FILTRO** `ibs_7min` > `0.8364` → IC=-0.195 (n=392)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1178)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.156 (n=318)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1184)

- **FILTRO** `py_entrada` < `0.38` → IC=-0.242 (n=366)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1136)

- **FILTRO** `ibs_7min` < `0.8057` → IC=-0.166 (n=375)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8057
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1127)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.170 (n=374)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1128)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.230 (n=364)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1172)

- **FILTRO** `ballena_activa_n` > `124.0` → IC=-0.168 (n=383)

  - _Acción_: SKIP cuando `ballena_activa_n` > 124.0
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1153)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.193 (n=262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.101 (n=795)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.340 (n=248)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=809)

- **FILTRO** `ibs_7min` < `0.2125` → IC=-0.282 (n=264)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2125
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=793)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.284 (n=262)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=795)
...
- **FILTRO** `ibs_7min` > `0.8179` → IC=-0.182 (n=404)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.150 (n=389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=894)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.268 (n=300)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=983)

- **FILTRO** `ibs_7min` < `0.7649` → IC=-0.189 (n=320)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7649
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=963)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.213 (n=319)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=964)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.126 (n=410)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=864)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.288 (n=309)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=965)

- **FILTRO** `ibs_7min` > `0.1818` → IC=-0.160 (n=430)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1818
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=844)

- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.208 (n=317)

  - _Acción_: SKIP cuando `ballena_activa_n` > 38.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=957)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.234 (n=336)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1077)

- **FILTRO** `ibs_7min` < `0.7714` → IC=-0.201 (n=352)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7714
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1061)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.204 (n=346)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1067)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.173 (n=423)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1275)
...
- **FILTRO** `ibs_7min` > `0.83` → IC=-0.158 (n=387)

  - _Acción_: SKIP cuando `ibs_7min` > 0.83
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1163)
...
- **PATRÓN** `streak_len` < `3.0` → IC=+0.136 (n=138)

  - _Acción_: Kelly boost +0.68€ cuando `streak_len` < 3.0 (IC base=+0.061)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.128 (n=146)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 14.0 (IC base=+0.072)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=1135)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.148 (n=126)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0029 (IC base=+0.112)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0676` → IC=+0.125 (n=379)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.62€ cuando `delta_ratio_macro` |x|> 0.0676 (IC base=+0.112)

- **PATRÓN** `ibs_15` > `0.5217` → IC=+0.200 (n=378)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5217 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.629` → IC=+0.243 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.629 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2964.2504` → IC=+0.142 (n=252)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 2964.2504 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `86.0` → IC=+0.174 (n=41)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 86.0 (IC base=+0.112)

- **PATRÓN** `ibs_15` < `0.1124` → IC=+0.139 (n=414)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.70€ cuando `ibs_15` < 0.1124 (IC base=+0.027)
...
- **PATRÓN** `ibs_15` < `0.1171` → IC=+0.205 (n=103)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1171 (IC base=+0.047)
...
- **FILTRO** `ibs_15` < `0.4486` → IC=-0.276 (n=96)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.158 (n=290)

- **FILTRO** `sigma_ewma_delta_pct` > `17.232` → IC=-0.180 (n=326)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.232
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2343)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3346` → IC=+0.136 (n=127)

  - _Acción_: Kelly boost +0.68€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3346 (IC base=-0.054)

- **PATRÓN** `ibs_15` > `0.4486` → IC=+0.158 (n=290)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.79€ cuando `ibs_15` > 0.4486 (IC base=-0.054)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1216` → IC=+0.348 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1216 (IC base=-0.081)

- **PATRÓN** `ibs_15` < `0.3315` → IC=+0.346 (n=115)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3315 (IC base=-0.081)

- **PATRÓN** `dist_vwap_pct` < `0.0929` → IC=+0.269 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0929 (IC base=-0.081)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.302 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 163.0 (IC base=-0.081)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0064` → IC=-0.233 (n=200)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.250 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.195 (n=447)

- **FILTRO** `sigma_ewma_delta_pct` > `19.574` → IC=-0.261 (n=111)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1934` → IC=+0.237 (n=74)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1934 (IC base=+0.240)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.324 (n=49)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1117` → IC=+0.250 (n=66)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1117 (IC base=+0.240)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2552` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2552 (IC base=+0.240)
...
- **PATRÓN** `ibs_15` < `0.3357` → IC=+0.342 (n=74)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3357 (IC base=+0.240)

- **PATRÓN** `dist_vwap_pct` < `0.1085` → IC=+0.247 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1085 (IC base=+0.240)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.936` → IC=+0.269 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.936 (IC base=+0.240)

- **PATRÓN** `libro_liquidez` > `13114.1262` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13114.1262 (IC base=+0.240)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.923` → IC=-0.137 (n=210)
...
- **FILTRO** `sigma_ewma_delta_pct` > `9.247` → IC=-0.132 (n=191)
...
### UPDOWN_OU_5M
- **FILTRO** `pct_spot_vs_ref` |x|> `0.1333` → IC=-0.222 (n=16)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.1333
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=33)

- **FILTRO** `drift_15min` |x|> `0.8392` → IC=-0.167 (n=16)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5217 sube el IC de +0.112 a +0.200 en UPDOWN_GBM#15min (n=378). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1171 sube el IC de +0.047 a +0.205 en UPDOWN_GBM#XRP#15min (n=103). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4486 sube el IC de -0.054 a +0.158 en UPDOWN_GBM_15M_TARDIO (n=290). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3315 sube el IC de -0.081 a +0.346 en UPDOWN_GBM_15M_TARDIO (n=115). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3357 sube el IC de +0.240 a +0.342 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=74). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 6524 | -0.099 | -892.96€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 670 | -0.089 | -119.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5854 | -0.100 | -773.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1081 | +0.016 | -127.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1081 | +0.016 | -127.65€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2136 | -0.072 | -98.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2136 | -0.072 | -98.63€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1553 | -0.193 | -353.84€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1553 | -0.193 | -353.84€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30390 | +0.114 | -1985.35€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5676 | +0.187 | -189.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21471 | +0.095 | -1707.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3136 | +0.121 | -38.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3604 | +0.063 | -616.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3579 | +0.064 | -612.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6305 | +0.134 | -134.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1599 | +0.198 | -83.90€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3573 | +0.110 | -83.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1091 | +0.130 | +55.32€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3612 | +0.078 | -473.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 20 | +0.045 | +2.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3591 | +0.078 | -474.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6769 | +0.128 | -84.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2065 | +0.169 | -9.45€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3575 | +0.114 | -45.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1117 | +0.103 | -20.28€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6497 | +0.132 | -423.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1955 | +0.202 | -100.87€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3568 | +0.095 | -240.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 928 | +0.132 | -73.09€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3603 | +0.105 | -253.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3585 | +0.106 | -250.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5639 | +0.173 | -440.65€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5639 | +0.173 | -440.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1418 | +0.167 | -151.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1418 | +0.167 | -151.01€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1407 | +0.159 | -168.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1407 | +0.159 | -168.82€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1263 | +0.231 | -33.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1263 | +0.231 | -33.84€ | 0 | 2 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1361 | +0.185 | -103.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1361 | +0.185 | -103.31€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15357 | +0.191 | -1353.85€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15357 | +0.191 | -1353.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2821 | +0.124 | -523.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2821 | +0.124 | -523.35€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2384 | +0.238 | -45.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2384 | +0.238 | -45.97€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2648 | +0.162 | -344.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2648 | +0.162 | -344.82€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2435 | +0.231 | -66.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2435 | +0.231 | -66.96€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2483 | +0.217 | -116.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2483 | +0.217 | -116.95€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2586 | +0.185 | -255.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2586 | +0.185 | -255.80€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 5557 | +0.133 | +186.76€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 5557 | +0.133 | +186.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2760 | +0.141 | +131.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2760 | +0.141 | +131.50€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2797 | +0.125 | +55.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2797 | +0.125 | +55.26€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 211 | +0.096 | -1.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 64 | +0.106 | +0.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 147 | +0.091 | -2.21€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 173 | +0.100 | +0.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 26 | +0.143 | +2.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 147 | +0.091 | -2.21€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 5629 | +0.096 | -207.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 580 | +0.058 | -28.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 5049 | +0.100 | -178.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 3891 | +0.095 | -99.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 580 | +0.058 | -28.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 3311 | +0.102 | -70.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1738 | +0.097 | -107.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1738 | +0.097 | -107.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 412 | +0.283 | -28.09€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 412 | +0.283 | -28.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 412 | +0.283 | -28.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 412 | +0.283 | -28.09€ | 0 | 4 |
| ✅ GBM_LATE_15M | 7251 | +0.044 | +2308.91€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 7251 | +0.044 | +2308.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 961 | +0.174 | +607.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 961 | +0.174 | +607.09€ | 0 | 19 |
| ✅ GBM_LATE_15M#BTC | 1013 | +0.174 | +591.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1013 | +0.174 | +591.26€ | 0 | 30 |
| ✅ GBM_LATE_15M#DOGE | 964 | +0.184 | +642.15€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 964 | +0.184 | +642.15€ | 0 | 18 |
| ✅ GBM_LATE_15M#ETH | 1181 | -0.046 | +32.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1181 | -0.046 | +32.24€ | 2 | 11 |
| ✅ GBM_LATE_15M#SOL | 1365 | -0.042 | +142.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1365 | -0.042 | +142.69€ | 4 | 3 |
| ✅ GBM_LATE_15M#XRP | 1767 | -0.052 | +293.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1767 | -0.052 | +293.48€ | 4 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 8216 | +0.045 | +3188.47€ | 0 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 8216 | +0.045 | +3188.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1247 | -0.023 | +624.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1247 | -0.023 | +624.94€ | 2 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1801 | -0.036 | +163.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1801 | -0.036 | +163.97€ | 0 | 1 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 834 | +0.236 | +748.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 834 | +0.236 | +748.51€ | 0 | 22 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1394 | -0.043 | +7.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1394 | -0.043 | +7.52€ | 8 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1482 | -0.018 | +289.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1482 | -0.018 | +289.36€ | 4 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1458 | +0.242 | +1354.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1458 | +0.242 | +1354.18€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 5861 | +0.170 | +4038.76€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 5861 | +0.170 | +4038.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 734 | +0.192 | +535.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 734 | +0.192 | +535.87€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 996 | +0.166 | +682.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 996 | +0.166 | +682.19€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 725 | +0.200 | +557.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 725 | +0.200 | +557.84€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 974 | +0.163 | +631.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 974 | +0.163 | +631.04€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 1132 | +0.122 | +657.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 1132 | +0.122 | +657.53€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 1300 | +0.191 | +974.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 1300 | +0.191 | +974.29€ | 0 | 24 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 992 | +0.077 | +187.30€ | 0 | 13 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 992 | +0.077 | +187.30€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 6823 | +0.169 | +4517.07€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#15min | 6823 | +0.169 | +4517.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 920 | +0.190 | +659.85€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 920 | +0.190 | +659.85€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1114 | +0.162 | +700.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1114 | +0.162 | +700.01€ | 0 | 28 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 909 | +0.219 | +757.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 909 | +0.219 | +757.74€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1039 | +0.147 | +599.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1039 | +0.147 | +599.06€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1240 | +0.107 | +616.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1240 | +0.107 | +616.27€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1601 | +0.194 | +1184.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1601 | +0.194 | +1184.14€ | 0 | 24 |
| ✅ GBM_LATE_5M | 1451 | +0.130 | +673.00€ | 1 | 26 |
| ✅ GBM_LATE_5M#5min | 1451 | +0.130 | +673.00€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB | 62 | +0.203 | +39.47€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB#5min | 62 | +0.203 | +39.47€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 569 | +0.131 | +303.36€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 569 | +0.131 | +303.36€ | 3 | 20 |
...
| ✅ MOMENTUM_IBS_15M | 4194 | -0.002 | -66.64€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 4194 | -0.002 | -66.64€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 467 | -0.001 | +4.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 467 | -0.001 | +4.54€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 712 | +0.000 | -19.63€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 712 | +0.000 | -19.63€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 829 | +0.011 | +15.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 829 | +0.011 | +15.97€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 748 | -0.011 | -30.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 748 | -0.011 | -30.36€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 840 | -0.013 | -28.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 840 | -0.013 | -28.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 6109 | -0.035 | +194.21€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 6109 | -0.035 | +194.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 970 | -0.024 | +137.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 970 | -0.024 | +137.25€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 1096 | -0.034 | -26.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 1096 | -0.034 | -26.99€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 975 | -0.044 | +92.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 975 | -0.044 | +92.57€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 1095 | -0.034 | -31.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 1095 | -0.034 | -31.34€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 987 | -0.043 | +31.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 987 | -0.043 | +31.12€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 986 | -0.033 | -8.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 986 | -0.033 | -8.40€ | 4 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 16765 | -0.073 | +257.59€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 16765 | -0.073 | +257.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 2593 | -0.092 | +270.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 2593 | -0.092 | +270.04€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 3038 | -0.059 | -0.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 3038 | -0.059 | -0.45€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 2675 | -0.085 | +23.27€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 2675 | -0.085 | +23.27€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 2557 | -0.095 | -173.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 2557 | -0.095 | -173.91€ | 8 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 3111 | -0.048 | +20.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 3111 | -0.048 | +20.60€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 2791 | -0.069 | +118.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 2791 | -0.069 | +118.04€ | 5 | 0 |
...
| ✅ STREAK_FADE_5M | 1026 | -0.016 | -43.29€ | 1 | 0 |
| ✅ STREAK_FADE_5M#5min | 1026 | -0.016 | -43.29€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE | 357 | -0.013 | -10.38€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE#5min | 357 | -0.013 | -10.38€ | 0 | 0 |
...
| ✅ STREAK_MOM_5M | 1995 | +0.027 | +35.97€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 1995 | +0.027 | +35.97€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 664 | +0.027 | +8.85€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 664 | +0.027 | +8.85€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 358 | +0.011 | +1.22€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 358 | +0.011 | +1.22€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 590 | +0.030 | +8.62€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 590 | +0.030 | +8.62€ | 1 | 1 |
| ✅ STREAK_MOM_5M#XRP | 383 | +0.035 | +17.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 383 | +0.035 | +17.27€ | 2 | 1 |
| ✅ STRUCT_NO_15M | 2999 | +0.007 | -30.63€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 2999 | +0.007 | -30.63€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1154 | +0.007 | -13.20€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1154 | +0.007 | -13.20€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1161 | +0.013 | -4.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1161 | +0.013 | -4.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 684 | -0.003 | -12.62€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 684 | -0.003 | -12.62€ | 2 | 0 |
| ✅ UPDOWN_GBM | 5708 | +0.006 | +148.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2157 | +0.047 | +217.61€ | 0 | 8 |
| ✅ UPDOWN_GBM#240min | 241 | +0.031 | +7.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 2902 | -0.020 | -67.56€ | 2 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 1244 | +0.016 | +57.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 217 | +0.071 | +27.83€ | 3 | 11 |
| ✅ UPDOWN_GBM#BTC#240min | 71 | +0.089 | +9.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 820 | +0.007 | +25.34€ | 4 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 1313 | +0.008 | +13.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 604 | +0.028 | +23.47€ | 1 | 5 |
| ✅ UPDOWN_GBM#ETH#240min | 70 | +0.083 | +6.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 469 | -0.024 | -17.66€ | 4 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 155 | +0.016 | +2.24€ | 0 | 2 |
| 🚫 UPDOWN_GBM#ETH#daily | 15 | -0.154 | -0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 1382 | -0.008 | -18.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 494 | +0.006 | -0.90€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 56 | -0.017 | -3.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 732 | -0.009 | -10.17€ | 3 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 88 | -0.033 | -3.84€ | 2 | 1 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 851 | +0.006 | +61.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 544 | +0.059 | +97.17€ | 0 | 6 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3618 | -0.074 | +817.65€ | 2 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3618 | -0.074 | +817.65€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 298 | -0.047 | +344.02€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 298 | -0.047 | +344.02€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 743 | -0.163 | -83.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 743 | -0.163 | -83.11€ | 4 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 76 | +0.064 | +13.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 76 | +0.064 | +13.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 263 | +0.115 | +113.04€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 263 | +0.115 | +113.04€ | 2 | 15 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1148 | -0.066 | +222.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1148 | -0.066 | +222.67€ | 3 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1090 | -0.084 | +207.76€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1090 | -0.084 | +207.76€ | 4 | 0 |
...
| ✅ UPDOWN_OU_5M | 419 | -0.077 | -39.18€ | 4 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.088) — sin ventaja clara. oversold(IBS<0.3): IC=+0.007 n=2003 | neutral: IC=+0.001 n=2144 | overbought(IBS>0.7): IC=+0.089 n=2234
  - _Datos_: n=6686 IC=+0.034 PNL=+558.97€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: (cache 122s) 17 celda(s) GATE OK de 2015 trackeadas
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.076 n=91288 | tras_1loss IC=+0.045 n=71078 | tras_2loss IC=+0.009 n=32291/40 | gap=+0.067 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 5646 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.010 n=596 | contrario_BTC IC=-0.004 n=444/40 | gap=+0.005 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=5467 IC=+0.003 PNL=+97.29€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=5467 IC=+0.003 PNL=+97.29€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.112 > 0.1 con n=503 PNL=+108.28€
  - _Datos_: n=503 IC=+0.112 PNL=+108.28€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=217 IC=+0.071 PNL=+27.83€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=217 IC=+0.071 PNL=+27.83€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1247 IC=+0.033 PNL=+81.37€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1247 IC=+0.033 PNL=+81.37€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=2049 IC=-0.014 PNL=-40.53€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2049 IC=-0.014 PNL=-40.53€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1535 IC=+0.028 PNL=+103.72€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1535 IC=+0.028 PNL=+103.72€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=426 IC=+0.030 PNL=-2.37€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=426 IC=+0.030 PNL=-2.37€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=6899 IC=+0.097 PNL=+1918.98€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=6899 IC=+0.097 PNL=+1918.98€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=775 IC=+0.024 PNL=+42.36€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=775 IC=+0.024 PNL=+42.36€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1410 IC=+0.022 PNL=+70.88€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1410 IC=+0.022 PNL=+70.88€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.165 > 0.1 con n=752 PNL=+269.50€
  - _Datos_: n=752 IC=+0.165 PNL=+269.50€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=411 IC=+0.047 PNL=+57.85€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=411 IC=+0.047 PNL=+57.85€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=3990 IC=-0.135 PNL=+267.69€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3990 IC=-0.135 PNL=+267.69€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.112 > 0.08 con n=503 PNL=+108.28€
  - _Datos_: n=503 IC=+0.112 PNL=+108.28€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.238 < -0.1 con n=433 PNL=-51.14€
  - _Datos_: n=433 IC=-0.238 PNL=-51.14€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1037 IC=+0.142 PNL=+541.87€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1037 IC=+0.142 PNL=+541.87€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=610 IC=-0.026 PNL=+37.54€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=610 IC=-0.026 PNL=+37.54€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.183 > 0.08 con n=519 PNL=+313.90€
  - _Datos_: n=519 IC=+0.183 PNL=+313.90€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=935 IC=-0.042 PNL=+168.42€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=935 IC=-0.042 PNL=+168.42€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.240 > 0.08 con n=1338 PNL=-118.62€
  - _Datos_: n=1338 IC=+0.240 PNL=-118.62€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2821 IC=+0.124 PNL=-523.35€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2821 IC=+0.124 PNL=-523.35€
