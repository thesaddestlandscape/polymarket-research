# Hipótesis automáticas — 2026-07-02 18:45 UTC
_Generado por shadow_postmortem.py sobre 2789 resoluciones (PNL=-49.60€)_
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M#XRP#15min` — IC=+0.192 n=37. Faltan ~3 resoluciones para umbral n≥40. ETA: ~2h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#XRP` — IC=+0.192 n=37. Faltan ~3 resoluciones para umbral n≥40. ETA: ~2h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#SOL#15min` — IC=+0.159 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#SOL` — IC=+0.159 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 168 | +0.123 | +45.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 168 | +0.123 | +45.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 47 | +0.092 | +11.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 47 | +0.092 | +11.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 45 | +0.053 | +4.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 45 | +0.053 | +4.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 39 | +0.159 | +13.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 39 | +0.159 | +13.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 37 | +0.192 | +16.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 37 | +0.192 | +16.16€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.010 n=1334 | tras_1loss IC=-0.031 n=1364 | tras_2loss IC=-0.045 n=705/40 | gap=+0.054 (umbral 0.05)
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=363 IC=+0.062 PNL=+40.57€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=363 IC=+0.062 PNL=+40.57€
