# Hipótesis automáticas — 2026-07-16 12:02 UTC
_Generado por shadow_postmortem.py sobre 16910 resoluciones (PNL=+3442.99€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.178 (n=1130)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `7351.4655` → IC=+0.183 (n=329)
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.135 (n=1247)
...
- **PATRÓN** `dist_vwap_pct` > `0.7422` → IC=+0.152 (n=44)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.7422 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.518` → IC=+0.189 (n=43)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 7.518 (IC base=+0.065)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.162 (n=769)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.177 (n=765)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0048 (IC base=+0.161)
...
- **PATRÓN** `dist_vwap_pct` < `0.4154` → IC=+0.193 (n=549)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.4154 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.074` → IC=+0.235 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.074 (IC base=+0.161)
...
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.168 (n=194)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0028 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=76)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.4763` → IC=+0.129 (n=157)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.4763 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.827` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.827 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.146 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0068 (IC base=+0.131)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.146 (n=196)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.3828` → IC=+0.167 (n=115)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.3828 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.012` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.012 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.305` → IC=+0.154 (n=128)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 12.305 (IC base=+0.131)
...
- **PATRÓN** `dist_vwap_pct` > `0.2346` → IC=+0.181 (n=67)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.2346 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.9959` → IC=+0.146 (n=156)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.9959 (IC base=+0.135)
...
- **PATRÓN** `dist_vwap_pct` < `0.3632` → IC=+0.122 (n=519)
...
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#ETH#15min` — IC=+0.175 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#ETH` — IC=+0.175 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2545 | +0.173 | -68.98€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1638 | +0.209 | +6.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 108 | +0.018 | -18.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 366 | +0.090 | -61.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 433 | +0.146 | +4.46€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 908 | +0.172 | -10.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 543 | +0.212 | +11.27€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 892 | +0.171 | -35.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 539 | +0.215 | +17.34€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 4877 | +0.102 | +1517.17€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4877 | +0.102 | +1517.17€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1169 | +0.063 | +163.28€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1169 | +0.063 | +163.28€ | 0 | 3 |
| ✅ GBM_LATE_15M#ETH | 1167 | +0.074 | +194.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1167 | +0.074 | +194.62€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1306 | +0.109 | +527.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1306 | +0.109 | +527.03€ | 1 | 7 |
| ✅ GBM_LATE_15M#XRP | 1235 | +0.157 | +632.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1235 | +0.157 | +632.24€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2098 | +0.148 | +1210.91€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2098 | +0.148 | +1210.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 537 | +0.108 | +261.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 537 | +0.108 | +261.23€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 556 | +0.124 | +250.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 556 | +0.124 | +250.81€ | 0 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 566 | +0.109 | +243.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 566 | +0.109 | +243.20€ | 1 | 10 |
...
| ✅ GBM_LATE_15M_TARDIO | 2076 | +0.091 | +625.19€ | 0 | 7 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2076 | +0.091 | +625.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 513 | +0.055 | +86.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 513 | +0.055 | +86.12€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 481 | +0.018 | +7.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 481 | +0.018 | +7.63€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 489 | +0.064 | +100.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 489 | +0.064 | +100.17€ | 2 | 6 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 593 | +0.203 | +431.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 593 | +0.203 | +431.26€ | 0 | 10 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 124 | +0.175 | +33.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 124 | +0.175 | +33.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 7 | -0.019 | +2.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 7 | -0.019 | +2.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 17 | +0.112 | +5.48€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 17 | +0.112 | +5.48€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 38 | +0.175 | +2.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 38 | +0.175 | +2.97€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.155: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.004 n=496 | neutral: IC=-0.020 n=373 | overbought(IBS>0.7): IC=+0.135 n=403
  - _Datos_: n=1346 IC=+0.043 PNL=+134.80€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.102 n=9840 | tras_1loss IC=+0.069 n=6861 | tras_2loss IC=+0.037 n=2928/40 | gap=+0.065 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=14452 IC=+0.105 PNL=+3518.87€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=14452 IC=+0.105 PNL=+3518.87€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=625 IC=+0.055 PNL=+70.38€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=625 IC=+0.055 PNL=+70.38€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.130 > 0.08 con n=163 PNL=+47.22€
  - _Datos_: n=163 IC=+0.130 PNL=+47.22€
...
**🔶 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.170 n=204) pero sin cruzar ≥2 pares más — BTC: n=147 IC=-0.010; ETH: n=112 IC=+0.000; SOL: n=216 IC=+0.064 ✓
