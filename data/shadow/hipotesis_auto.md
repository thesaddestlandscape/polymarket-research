# Hipótesis automáticas — 2026-07-02 15:31 UTC
_Generado por shadow_postmortem.py sobre 2705 resoluciones (PNL=-56.83€)_
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M#BTC#15min` — IC=+0.100 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#BTC` — IC=+0.100 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 123 | +0.140 | +33.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 123 | +0.140 | +33.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 33 | +0.100 | +5.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 33 | +0.100 | +5.97€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 818 | -0.037 | -40.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 593 | -0.014 | -14.31€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 238 | -0.042 | -32.09€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 168 | -0.018 | -21.89€ | 2 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.073) — sin ventaja clara. oversold(IBS<0.3): IC=+0.007 n=144 | neutral: IC=-0.066 n=127 | overbought(IBS>0.7): IC=-0.045 n=143
  - _Datos_: n=428 IC=-0.033 PNL=-15.42€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.010 n=1293 | tras_1loss IC=-0.032 n=1322 | tras_2loss IC=-0.044 n=682/40 | gap=+0.054 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.038 n=117/40 PNL=+0.58€ | H=15h UTC: IC=+0.009 n=108/40 PNL=+2.98€ | H=17h UTC: IC=+0.221 n=41/40 PNL=+14.13€ | H=19h UTC: IC=+0.028 n=51/40 PNL=+1.21€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=695 IC=-0.031 PNL=-27.10€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=695 IC=-0.031 PNL=-27.10€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.018 < 0.02 con n=168 PNL=-21.89€
  - _Datos_: n=168 IC=-0.018 PNL=-21.89€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=250 IC=-0.008 PNL=-25.87€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=250 IC=-0.008 PNL=-25.87€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=288 IC=+0.066 PNL=+36.09€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=288 IC=+0.066 PNL=+36.09€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 30/40 ops en el filtro definido (IC actual=+0.000 PNL=-5.13€)
  - _Datos_: n=30 IC=+0.000 PNL=-5.13€
