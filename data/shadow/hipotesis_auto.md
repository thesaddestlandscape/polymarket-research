# Hipótesis automáticas — 2026-07-10 04:14 UTC
_Generado por shadow_postmortem.py sobre 7128 resoluciones (PNL=+974.83€)_
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.159 (n=39)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 4.0 (IC base=+0.044)
...
- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.126 (n=209)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` < 0.0104 (IC base=+0.036)

- **PATRÓN** `ibs_15` < `0.052` → IC=+0.152 (n=116)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` < 0.052 (IC base=+0.036)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.132 (n=66)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 7.0 (IC base=+0.049)

- **PATRÓN** `ibs_15` < `0.0525` → IC=+0.136 (n=64)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.68€ cuando `ibs_15` < 0.0525 (IC base=+0.049)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.052 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.152 n=116). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 2738 | +0.114 | +906.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2738 | +0.114 | +906.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 694 | +0.055 | +70.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 694 | +0.055 | +70.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 697 | +0.075 | +118.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 697 | +0.075 | +118.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 705 | +0.162 | +401.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 705 | +0.162 | +401.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 642 | +0.168 | +316.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 642 | +0.168 | +316.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 227 | +0.151 | +69.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 227 | +0.151 | +69.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 53 | +0.118 | +12.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 53 | +0.118 | +12.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 60 | +0.177 | +26.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 60 | +0.177 | +26.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 61 | +0.103 | +9.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 61 | +0.103 | +9.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 53 | +0.191 | +20.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 53 | +0.191 | +20.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 286 | +0.042 | +27.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 286 | +0.042 | +27.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 71 | +0.021 | +2.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 71 | +0.021 | +2.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 72 | +0.013 | +4.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 72 | +0.013 | +4.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 68 | -0.043 | -0.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 68 | -0.043 | -0.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 75 | +0.162 | +20.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 75 | +0.162 | +20.42€ | 0 | 0 |
| ✅ GBM_LATE_60M | 208 | -0.124 | +8.10€ | 0 | 0 |
| ✅ GBM_LATE_60M#60min | 208 | -0.124 | +8.10€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 67 | -0.094 | +0.90€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 67 | -0.094 | +0.90€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH | 66 | -0.147 | -5.38€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 66 | -0.147 | -5.38€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL | 75 | -0.123 | +12.57€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 75 | -0.123 | +12.57€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 14 | +0.000 | -0.16€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 14 | +0.000 | -0.16€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 14 | +0.000 | -0.16€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 14 | +0.000 | -0.16€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1567 | +0.013 | +17.22€ | 1 | 1 |
| ✅ ORDER_FLOW_5M#5min | 1431 | +0.009 | +4.63€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 286 | -0.021 | -4.82€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 286 | -0.021 | -4.82€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 316 | +0.041 | +12.50€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 316 | +0.041 | +12.50€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1204 | -0.015 | -0.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 952 | +0.014 | +34.83€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 572 | +0.007 | +22.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 480 | +0.027 | +32.59€ | 1 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.098) — sin ventaja clara. oversold(IBS<0.3): IC=-0.015 n=299 | neutral: IC=-0.057 n=228 | overbought(IBS>0.7): IC=+0.042 n=249
  - _Datos_: n=814 IC=-0.003 PNL=+24.64€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.177 n=29 PNL=-7.49€ → FILTRAR | H=07h: IC=+0.113 n=29 PNL=+7.41€ → BOOST | H=08h: IC=-0.107 n=26 PNL=-3.42€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.132 n=36 PNL=+7.33€ → BOOST | H=17h: IC=+0.132 n=36 PNL=+12.29€ → BOOST | H=22h: IC=+0.128 n=41 PNL=+7.59€ → BOOST

**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  - _Umbral_: n≥200 por par con delta_ratio feature en shadow
  - _Acción_: Añadir DELTA_MIN/MAX por par dict en shadow_predict.py
  - _Estado_: BTC: 182 ops con delta_ratio | SOL: 215 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.063 n=3812 | tras_1loss IC=+0.019 n=3197 | tras_2loss IC=-0.013 n=1514/40 | gap=+0.075 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=87 IC=+0.062 PNL=+10.93€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=87 IC=+0.062 PNL=+10.93€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=1081 IC=-0.009 PNL=+12.95€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1081 IC=-0.009 PNL=+12.95€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=392 IC=+0.018 PNL=+21.35€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=392 IC=+0.018 PNL=+21.35€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=4670 IC=+0.075 PNL=+1050.71€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4670 IC=+0.075 PNL=+1050.71€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.174 > 0.1 con n=188 PNL=+67.94€
  - _Datos_: n=188 IC=+0.174 PNL=+67.94€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=420 IC=+0.035 PNL=+29.55€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=420 IC=+0.035 PNL=+29.55€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.141 > 0.08 con n=218 PNL=+78.92€
  - _Datos_: n=218 IC=+0.141 PNL=+78.92€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.183 < -0.1 con n=298 PNL=-55.16€
  - _Datos_: n=298 IC=-0.183 PNL=-55.16€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 69/100 ops en el filtro definido (IC actual=+0.331 PNL=+43.82€)
  - _Datos_: n=69 IC=+0.331 PNL=+43.82€
