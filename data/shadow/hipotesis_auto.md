# Hipótesis automáticas — 2026-09-12 22:49 UTC
_Generado por shadow_postmortem.py sobre 410939 resoluciones (PNL=+43139.77€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.54` → IC=-0.265 (n=5265)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.54
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=15806)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.120 (n=1801)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1129)

- **FILTRO** `restante_s_al_confirmar` < `141.98` → IC=-0.277 (n=732)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.98
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2198)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `132.9` → IC=-0.295 (n=672)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.9
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2016)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `145.31` → IC=-0.170 (n=1364)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.31
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4092)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.18` → IC=-0.254 (n=1209)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.18
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=3628)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.21` → IC=-0.345 (n=1329)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.21
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=2699)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.5` → IC=-0.238 (n=82)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=89)

- **FILTRO** `py_entrada` < `0.5` → IC=-0.176 (n=66)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.199 (n=9841)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2659)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `11059.7035` → IC=+0.193 (n=850)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11059.7035 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.143 (n=8063)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.245 (n=7137)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.173 (n=5251)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `4706.9806` → IC=+0.173 (n=2268)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 4706.9806 (IC base=+0.136)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.209 (n=1186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.354 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1524)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `14514.2262` → IC=+0.215 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14514.2262 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.192 (n=264)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 7.0 (IC base=+0.136)

- **PATRÓN** `py_entrada` < `0.425` → IC=+0.164 (n=537)

  - _Acción_: Kelly boost +0.82€ cuando `py_entrada` < 0.425 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=529)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `3892.5771` → IC=+0.164 (n=409)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 3892.5771 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.145 (n=2154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.331 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.7 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.253 (n=492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.237)

- **PATRÓN** `py_entrada` < `0.305` → IC=+0.326 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.305 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.237 (n=1081)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `4425.7357` → IC=+0.241 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4425.7357 (IC base=+0.237)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=520)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.137 (n=590)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `1512.3969` → IC=+0.149 (n=443)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.211 (n=483)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.85` → IC=+0.425 (n=490)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.189 (n=464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.285 (n=674)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.187 (n=1048)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=8274)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.181 (n=2088)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.327 (n=588)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.197 (n=2001)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.267 (n=1550)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=4060)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.249 (n=2047)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.199)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.189 (n=4106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `6.5` → IC=+0.147 (n=2198)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 6.5 (IC base=+0.130)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.194 (n=1825)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.38 (IC base=+0.118)

- **PATRÓN** `restante_min` < `4.47` → IC=+0.125 (n=2242)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.47 (IC base=+0.118)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.149 (n=1841)

  - _Acción_: Kelly boost +0.74€ cuando `restante_min` > 4.95 (IC base=+0.118)

- **PATRÓN** `lag_apertura_s` < `3.07` → IC=+0.147 (n=1696)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 3.07 (IC base=+0.118)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.317 (n=616)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.328 (n=289)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1503.2235` → IC=+0.310 (n=371)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.285 (n=453)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.284 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.261)

- **PATRÓN** `libro_liquidez` > `2195.627` → IC=+0.300 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2195.627 (IC base=+0.261)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.974` → IC=+0.229 (n=1825)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.974 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.2151` → IC=+0.242 (n=1119)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2151 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.835` → IC=+0.165 (n=2108)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.835 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `1.2306` → IC=+0.241 (n=1354)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2306 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0679` → IC=+0.239 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0679 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1755` → IC=+0.189 (n=3666)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1755 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.11` → IC=+0.194 (n=1364)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.11 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.8416` → IC=+0.189 (n=3531)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.8416 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.4704` → IC=+0.192 (n=3531)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4704 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5772` → IC=+0.124 (n=6742)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.5772 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` < `0.1323` → IC=+0.164 (n=1982)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1323 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `0.6202` → IC=+0.163 (n=2079)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6202 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.169` → IC=+0.225 (n=1012)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.169 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `1.4622` → IC=+0.193 (n=3459)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4622 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.203 (n=3224)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 167.0 (IC base=+0.056)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.187 (n=410)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3264` → IC=+0.169 (n=1229)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3264 (IC base=+0.166)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.191 (n=604)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 8.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.270 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.966` → IC=+0.282 (n=535)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2786` → IC=+0.200 (n=158)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2786 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `2.6282` → IC=+0.155 (n=1123)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.6282 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.161 (n=1122)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.181 (n=1304)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.06 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.187 (n=884)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 64.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.258 (n=817)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.1942` → IC=+0.279 (n=608)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1942 (IC base=+0.238)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.253 (n=629)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.238)

- **PATRÓN** `ibs_20min` < `0.0621` → IC=+0.285 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0621 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.363` → IC=+0.249 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.363 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0688` → IC=+0.235 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0688 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` > `0.287` → IC=+0.288 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.287 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `2.6706` → IC=+0.269 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6706 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.242 (n=962)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1571.94` → IC=+0.249 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1571.94 (IC base=+0.238)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.232 (n=749)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.238)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.235 (n=413)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1134` → IC=+0.236 (n=411)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1134 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.228 (n=931)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.9278` → IC=+0.250 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9278 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.2068` → IC=+0.215 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2068 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.095` → IC=+0.228 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.095 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.222 (n=931)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2629 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.8783` → IC=+0.212 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8783 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` < `0.1654` → IC=+0.212 (n=948)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1654 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.2334` → IC=+0.209 (n=177)
...
- **PATRÓN** `volumen_spike_ratio` > `2.397` → IC=+0.210 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.397 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `10923.8518` → IC=+0.224 (n=930)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10923.8518 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.163 (n=881)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0049 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.322` → IC=+0.149 (n=997)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.322 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.158 (n=337)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.54` → IC=+0.177 (n=878)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.54 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.678` → IC=+0.176 (n=331)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 6.678 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.150 (n=997)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1954 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.615` → IC=+0.141 (n=997)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.615 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1552` → IC=+0.202 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1552 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.4011` → IC=+0.155 (n=889)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4011 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4117` → IC=+0.152 (n=888)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4117 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12873.5877` → IC=+0.151 (n=665)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12873.5877 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.190 (n=1196)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0058 (IC base=+0.177)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=1203)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.255 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.367` → IC=+0.236 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.367 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1071` → IC=+0.183 (n=1001)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` < 0.1071 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.3768` → IC=+0.175 (n=155)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.3768 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `1.6638` → IC=+0.184 (n=1106)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.6638 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.192 (n=1338)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.195 (n=293)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 16.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.217 (n=1034)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.210)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.211 (n=468)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0092 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.1138` → IC=+0.211 (n=344)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1138 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.238 (n=346)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3921` → IC=+0.230 (n=908)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3921 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.68` → IC=+0.233 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.68 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.394` → IC=+0.210 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.394 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.3645` → IC=+0.269 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3645 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` < `1.8451` → IC=+0.198 (n=399)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.8451 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.2947` → IC=+0.215 (n=605)
...
- **PATRÓN** `libro_liquidez` > `1887.358` → IC=+0.223 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.358 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.202 (n=558)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=87)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1514)

- **PATRÓN** `ibs_20min` > `0.9296` → IC=+0.154 (n=258)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.9296 (IC base=+0.005)

- **PATRÓN** `dist_vwap_pct` < `0.1829` → IC=+0.338 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1829 (IC base=+0.005)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.553` → IC=+0.135 (n=433)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 5.553 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` < `0.6055` → IC=+0.406 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6055 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.344 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1808 (IC base=+0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.2202` → IC=+0.348 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2202 (IC base=+0.005)

- **PATRÓN** `volumen_spike_ratio` < `1.3812` → IC=+0.355 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3812 (IC base=+0.005)

- **PATRÓN** `volumen_spike_ratio` > `2.1031` → IC=+0.343 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1031 (IC base=+0.005)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.333 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 168.0 (IC base=+0.005)

- **PATRÓN** `dist_vwap_pct` > `0.1574` → IC=+0.185 (n=147)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1574 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` < `1.1531` → IC=+0.144 (n=450)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1531 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.137 (n=450)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6129 (IC base=-0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.0654` → IC=+0.191 (n=147)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.0654 (IC base=-0.010)

- **PATRÓN** `volumen_spike_ratio` > `1.5033` → IC=+0.172 (n=358)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.5033 (IC base=-0.010)
...
- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.125 (n=1574)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.112 (n=781)

- **FILTRO** `sigma_ewma_delta_pct` > `8.613` → IC=-0.195 (n=260)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.613
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2095)
...
- **PATRÓN** `volumen_regimen` < `1.1257` → IC=+0.175 (n=164)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.1257 (IC base=-0.046)
...
- **PATRÓN** `volumen_spike_ratio` < `2.43` → IC=+0.215 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.43 (IC base=-0.046)

- **PATRÓN** `ballena_activa_n` < `46.0` → IC=+0.257 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 46.0 (IC base=-0.046)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6412` → IC=-0.186 (n=384)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6412
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=1155)

- **FILTRO** `ibs_20min` < `0.6396` → IC=-0.156 (n=1015)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6396
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=524)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.183 (n=304)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=1235)

- **FILTRO** `ibs_20min` > `0.78` → IC=-0.192 (n=583)
...
- **PATRÓN** `dist_vwap_pct` < `0.2379` → IC=+0.286 (n=152)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2379 (IC base=-0.087)
...
- **PATRÓN** `dist_vwap_pct` > `0.4467` → IC=+0.258 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4467 (IC base=-0.030)

- **PATRÓN** `dist_vwap_pct` < `0.2503` → IC=+0.229 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2503 (IC base=-0.030)

- **PATRÓN** `volumen_regimen` > `1.0828` → IC=+0.290 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0828 (IC base=-0.030)

- **PATRÓN** `volumen_pendiente_norm` < `0.1711` → IC=+0.219 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1711 (IC base=-0.030)

- **PATRÓN** `volumen_pendiente_norm` > `0.1065` → IC=+0.247 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1065 (IC base=-0.030)

- **PATRÓN** `volumen_spike_ratio` < `2.5025` → IC=+0.238 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5025 (IC base=-0.030)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.158 (n=3096)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0077 (IC base=+0.083)

- **PATRÓN** `ibs_20min` > `0.4552` → IC=+0.169 (n=6091)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4552 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` > `0.7012` → IC=+0.270 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7012 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.482` → IC=+0.136 (n=3227)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 3.482 (IC base=+0.083)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.225 (n=2048)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6736 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` > `0.2486` → IC=+0.252 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2486 (IC base=+0.083)

- **PATRÓN** `volumen_spike_ratio` < `1.479` → IC=+0.232 (n=1205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.479 (IC base=+0.083)

- **PATRÓN** `volumen_spike_ratio` > `2.7927` → IC=+0.234 (n=1205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7927 (IC base=+0.083)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.275 (n=3088)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 104.0 (IC base=+0.083)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.138 (n=2343)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0084 (IC base=+0.065)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.146 (n=6191)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5625 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.6608` → IC=+0.243 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6608 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `1.1942` → IC=+0.262 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1942 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.2497` → IC=+0.321 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2497 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `1.6166` → IC=+0.251 (n=1034)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6166 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` > `2.3723` → IC=+0.257 (n=1064)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3723 (IC base=+0.065)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.256 (n=2200)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.065)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2286` → IC=-0.144 (n=462)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2286
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=1388)

- **FILTRO** `sigma_ewma_delta_pct` > `4.296` → IC=-0.158 (n=352)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.296
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1166)

- **PATRÓN** `ibs_20min` > `0.8488` → IC=+0.251 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8488 (IC base=+0.035)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.984` → IC=+0.157 (n=482)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.984 (IC base=+0.035)

- **PATRÓN** `volumen_pendiente_norm` > `0.2213` → IC=+0.296 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2213 (IC base=+0.035)

- **PATRÓN** `volumen_spike_ratio` < `1.8686` → IC=+0.193 (n=298)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.8686 (IC base=+0.035)

- **PATRÓN** `volumen_spike_ratio` > `2.6489` → IC=+0.195 (n=149)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.6489 (IC base=+0.035)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.215 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 62.0 (IC base=+0.035)
...
- **FILTRO** `ibs_20min` > `0.8364` → IC=-0.153 (n=523)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1573)

- **PATRÓN** `volumen_pendiente_norm` > `0.2712` → IC=+0.167 (n=73)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2712 (IC base=+0.005)

- **PATRÓN** `volumen_spike_ratio` < `1.4165` → IC=+0.154 (n=189)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4165 (IC base=+0.005)

- **PATRÓN** `ballena_activa_n` < `267.0` → IC=+0.163 (n=247)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 267.0 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `1.1336` → IC=+0.241 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1336 (IC base=-0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.275` → IC=+0.354 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.275 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` < `1.7599` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7599 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` > `2.127` → IC=+0.225 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.127 (IC base=-0.005)

- **PATRÓN** `ballena_activa_n` < `517.0` → IC=+0.214 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 517.0 (IC base=-0.005)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.281 (n=723)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0073 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.0959` → IC=+0.247 (n=362)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0959 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.239 (n=546)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.237)
...
- **PATRÓN** `libro_liquidez` > `1876.5391` → IC=+0.299 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1876.5391 (IC base=+0.278)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.277 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 22.0 (IC base=+0.278)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.22` → IC=-0.211 (n=296)

  - _Acción_: SKIP cuando `ibs_20min` < 0.22
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=891)

- **FILTRO** `ibs_20min` > `0.8331` → IC=-0.181 (n=405)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8331
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=1219)

- **PATRÓN** `ibs_20min` > `0.7998` → IC=+0.128 (n=404)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` > 0.7998 (IC base=-0.027)

- **PATRÓN** `dist_vwap_pct` > `0.3052` → IC=+0.220 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3052 (IC base=-0.027)

- **PATRÓN** `volumen_regimen` < `0.9213` → IC=+0.197 (n=206)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.9213 (IC base=-0.027)

- **PATRÓN** `volumen_regimen` > `0.6044` → IC=+0.171 (n=211)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6044 (IC base=-0.027)
...
- **PATRÓN** `volumen_spike_ratio` < `1.506` → IC=+0.240 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.506 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` > `1.4` → IC=+0.212 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4 (IC base=-0.027)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.226 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 158.0 (IC base=-0.027)

- **PATRÓN** `dist_vwap_pct` > `0.1079` → IC=+0.162 (n=66)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1079 (IC base=-0.031)

- **PATRÓN** `volumen_regimen` < `0.9092` → IC=+0.159 (n=136)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.9092 (IC base=-0.031)

- **PATRÓN** `volumen_regimen` > `0.6808` → IC=+0.141 (n=154)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6808 (IC base=-0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.0603` → IC=+0.315 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0603 (IC base=-0.031)

- **PATRÓN** `volumen_spike_ratio` < `1.705` → IC=+0.218 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.705 (IC base=-0.031)

- **PATRÓN** `volumen_spike_ratio` > `1.3904` → IC=+0.233 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3904 (IC base=-0.031)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.230 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 158.0 (IC base=-0.031)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6571` → IC=-0.196 (n=744)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6571
  - _Potencial_: sin este filtro IC_bueno=+0.244 (n=745)

- **FILTRO** `ibs_20min` > `0.7241` → IC=-0.234 (n=396)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7241
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1196)

- **FILTRO** `sigma_ewma_delta_pct` > `4.748` → IC=-0.158 (n=384)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.748
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1208)

- **PATRÓN** `ibs_20min` > `0.6571` → IC=+0.244 (n=745)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6571 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1802` → IC=+0.306 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1802 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.279 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8616 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.6333` → IC=+0.262 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6333 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.1058` → IC=+0.267 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1058 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.2751` → IC=+0.308 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2751 (IC base=+0.025)

- **PATRÓN** `volumen_spike_ratio` < `1.4432` → IC=+0.313 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4432 (IC base=+0.025)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.311 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 55.0 (IC base=+0.025)

- **PATRÓN** `ibs_20min` < `0.2083` → IC=+0.165 (n=526)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.2083 (IC base=-0.001)

- **PATRÓN** `dist_vwap_pct` > `0.6661` → IC=+0.181 (n=45)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.6661 (IC base=-0.001)

- **PATRÓN** `dist_vwap_pct` < `0.156` → IC=+0.190 (n=259)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.156 (IC base=-0.001)

- **PATRÓN** `volumen_regimen` < `0.7154` → IC=+0.231 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7154 (IC base=-0.001)

- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.191 (n=250)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1003 (IC base=-0.001)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5701` → IC=+0.207 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5701 (IC base=-0.001)

- **PATRÓN** `volumen_spike_ratio` > `1.5131` → IC=+0.184 (n=261)
...
- **PATRÓN** `sigma_h` > `0.0145` → IC=+0.319 (n=644)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0145 (IC base=+0.261)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.275 (n=456)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` > `0.8982` → IC=+0.328 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8982 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` > `0.1792` → IC=+0.308 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1792 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.341` → IC=+0.286 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.341 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.737` → IC=+0.260 (n=1058)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.737 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` > `0.85` → IC=+0.286 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.85 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` < `0.1112` → IC=+0.264 (n=841)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1112 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` > `0.2389` → IC=+0.296 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2389 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` < `1.5522` → IC=+0.272 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5522 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` > `2.2141` → IC=+0.264 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2141 (IC base=+0.261)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.266 (n=1015)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.261)

- **PATRÓN** `libro_liquidez` > `2428.3902` → IC=+0.265 (n=863)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2428.3902 (IC base=+0.261)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.278 (n=349)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0069 (IC base=+0.271)

- **PATRÓN** `sigma_h` > `0.0137` → IC=+0.297 (n=697)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0137 (IC base=+0.271)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.284 (n=522)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.271)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.270 (n=1113)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.385` → IC=+0.301 (n=1046)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.385 (IC base=+0.271)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.685` → IC=+0.271 (n=983)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.685 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` < `0.635` → IC=+0.272 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.635 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `1.2434` → IC=+0.312 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2434 (IC base=+0.271)

- **PATRÓN** `volumen_pendiente_norm` > `0.2415` → IC=+0.347 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2415 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` < `2.5476` → IC=+0.268 (n=889)
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.173 (n=1833)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.202 (n=1831)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3355` → IC=+0.174 (n=4821)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3355 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=5746)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.6949` → IC=+0.228 (n=4894)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6949 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1629` → IC=+0.195 (n=2402)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1629 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.219` → IC=+0.248 (n=1127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.219 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2177` → IC=+0.162 (n=3669)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2177 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6224` → IC=+0.159 (n=3668)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6224 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.1069` → IC=+0.187 (n=2137)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1069 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.3086` → IC=+0.167 (n=4562)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.3086 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6758` → IC=+0.164 (n=1728)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.6758 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3840.5914` → IC=+0.174 (n=1826)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3840.5914 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.184 (n=4391)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 127.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.185 (n=3513)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0064 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.0786` → IC=+0.203 (n=1754)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0786 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.202 (n=2575)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` < `0.4565` → IC=+0.224 (n=5260)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4565 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.742` → IC=+0.189 (n=2182)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 3.742 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `1.1823` → IC=+0.155 (n=3856)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1823 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.625` → IC=+0.152 (n=3856)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.625 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2909` → IC=+0.227 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2909 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.8725` → IC=+0.169 (n=3077)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.8725 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.6264` → IC=+0.174 (n=1539)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6264 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `132.0` → IC=+0.170 (n=4223)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3196` → IC=+0.208 (n=919)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3196 (IC base=+0.188)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.220 (n=458)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.188)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.044` → IC=+0.309 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.044 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` > `0.2298` → IC=+0.232 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2298 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` < `2.2575` → IC=+0.178 (n=728)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.2575 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `1.4401` → IC=+0.180 (n=827)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4401 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.212 (n=819)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.188)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.203 (n=566)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.188)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3642` → IC=+0.175 (n=792)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3642 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.191 (n=719)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 8.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.5868` → IC=+0.229 (n=707)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5868 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.217 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.757` → IC=+0.239 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.757 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `1.2719` → IC=+0.175 (n=792)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 1.2719 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.2392` → IC=+0.195 (n=172)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2392 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` < `1.4112` → IC=+0.203 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4112 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `11274.9584` → IC=+0.190 (n=707)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11274.9584 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.179 (n=796)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0049 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.287` → IC=+0.169 (n=905)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.287 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=833)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.5107` → IC=+0.192 (n=905)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.5107 (IC base=+0.151)
...
- **PATRÓN** `volumen_regimen` < `1.2025` → IC=+0.167 (n=905)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2025 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1584` → IC=+0.198 (n=273)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1584 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4143` → IC=+0.163 (n=796)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4143 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4122` → IC=+0.154 (n=796)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4122 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `238.0` → IC=+0.165 (n=240)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 238.0 (IC base=+0.151)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.208 (n=597)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0074 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.1968` → IC=+0.197 (n=596)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1968 (IC base=+0.188)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.286 (n=475)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.573` → IC=+0.270 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.573 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` < `0.1074` → IC=+0.184 (n=728)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1074 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` > `0.1346` → IC=+0.186 (n=345)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1346 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` < `1.6698` → IC=+0.183 (n=276)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.6698 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `3.6503` → IC=+0.201 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6503 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.204 (n=987)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.230 (n=751)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.220 (n=673)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.218)

- **PATRÓN** `drift_60min` |x|≤ `0.0891` → IC=+0.243 (n=251)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0891 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.265 (n=274)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.3571` → IC=+0.250 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3571 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.671` → IC=+0.269 (n=305)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8317` → IC=+0.209 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8317 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2457` → IC=+0.223 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2457 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1884.0848` → IC=+0.227 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1884.0848 (IC base=+0.218)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.186 (n=753)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0066 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.4277` → IC=+0.169 (n=856)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.4277 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.170 (n=865)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.4164` → IC=+0.205 (n=855)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.367` → IC=+0.248 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.367 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` < `0.8639` → IC=+0.163 (n=571)
...
- **PATRÓN** `libro_liquidez` > `7640.2791` → IC=+0.198 (n=570)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 7640.2791 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.161 (n=697)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 159.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.159 (n=808)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.006 (IC base=+0.126)

- **PATRÓN** `drift_60min` |x|≤ `0.3741` → IC=+0.147 (n=919)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3741 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.187 (n=311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 18.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.5954` → IC=+0.176 (n=919)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.5954 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.1489` → IC=+0.139 (n=917)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1489 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.174` → IC=+0.192 (n=180)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 12.174 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.137 (n=613)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.8615 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.133 (n=918)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.613 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.0738` → IC=+0.167 (n=361)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0738 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` < `1.7863` → IC=+0.131 (n=537)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.7863 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `11643.1172` → IC=+0.153 (n=306)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 11643.1172 (IC base=+0.126)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.147 (n=692)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0077 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1071)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5098` → IC=+0.195 (n=1037)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.376` → IC=+0.255 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.376 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.123 (n=1037)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2233 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `2.1542` → IC=+0.123 (n=876)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.1542 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1054)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3136.4952` → IC=+0.213 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3136.4952 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.138 (n=739)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 49.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.151 (n=336)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0053 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.144 (n=332)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.180 (n=464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.5283` → IC=+0.206 (n=994)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5283 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2469` → IC=+0.132 (n=962)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.2469 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` < `1.0388` → IC=+0.127 (n=874)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0388 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.2729` → IC=+0.170 (n=116)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2729 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.1374` → IC=+0.138 (n=387)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.1374 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3111.9822` → IC=+0.155 (n=331)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3111.9822 (IC base=+0.115)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0174` → IC=+0.210 (n=657)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0174 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.1643` → IC=+0.216 (n=434)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1643 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=1027)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.250 (n=882)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.72 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` > `1.2177` → IC=+0.238 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2177 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.294` → IC=+0.238 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.294 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `1.1991` → IC=+0.199 (n=985)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1991 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `0.8449` → IC=+0.216 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8449 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.169` → IC=+0.253 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.169 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `2.2016` → IC=+0.213 (n=830)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2016 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.8159` → IC=+0.204 (n=629)
...
- **PATRÓN** `libro_liquidez` > `2554.1675` → IC=+0.197 (n=657)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2554.1675 (IC base=+0.197)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.245 (n=347)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0247` → IC=+0.209 (n=348)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0247 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.089` → IC=+0.217 (n=348)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `2.24` → IC=+0.193 (n=798)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.24 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4601` → IC=+0.188 (n=907)
...
- **PATRÓN** `libro_liquidez` > `2525.7119` → IC=+0.211 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2525.7119 (IC base=+0.201)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.139 (n=425)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0038 (IC base=+0.138)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.155 (n=575)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0072 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0948` → IC=+0.145 (n=423)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.0948 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.163 (n=1190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 8.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.4054` → IC=+0.166 (n=1268)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.4054 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.7872` → IC=+0.190 (n=169)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.7872 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.713` → IC=+0.175 (n=571)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.713 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8626` → IC=+0.158 (n=721)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8626 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1672` → IC=+0.166 (n=348)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1672 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.147 (n=403)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.4339 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.823` → IC=+0.152 (n=805)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.823 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.144 (n=1397)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `8101.5764` → IC=+0.172 (n=575)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.142 (n=437)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0037 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.122 (n=893)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 11.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.305` → IC=+0.159 (n=873)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.305 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.834` → IC=+0.133 (n=519)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.834 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.1657` → IC=+0.147 (n=332)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.1657 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` < `2.2216` → IC=+0.127 (n=1093)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.2216 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.140 (n=390)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 20.0 (IC base=+0.104)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.138 (n=186)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0037 (IC base=+0.111)

- **PATRÓN** `drift_60min` |x|≤ `0.1073` → IC=+0.156 (n=123)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1073 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.154 (n=287)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 8.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.9042` → IC=+0.182 (n=127)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.9042 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.3078` → IC=+0.185 (n=87)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.3078 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.31` → IC=+0.189 (n=130)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 3.31 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.5894` → IC=+0.195 (n=93)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.5894 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `9647.1518` → IC=+0.151 (n=279)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 9647.1518 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.155 (n=85)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 147.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.003` → IC=+0.194 (n=194)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.003 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.2718` → IC=+0.136 (n=383)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.2718 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.124 (n=389)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 7.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.3773` → IC=+0.186 (n=291)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.3773 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.021` → IC=+0.141 (n=90)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 9.021 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` > `0.7093` → IC=+0.132 (n=389)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.7093 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.1546` → IC=+0.203 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1546 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `2.4085` → IC=+0.136 (n=426)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.4085 (IC base=+0.112)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.253 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0948` → IC=+0.220 (n=130)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0948 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.234 (n=352)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.206)

- **PATRÓN** `ibs_20min` > `0.2679` → IC=+0.247 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2679 (IC base=+0.206)
...
- **PATRÓN** `volumen_regimen` < `0.8331` → IC=+0.221 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8331 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `1.1605` → IC=+0.242 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1605 (IC base=+0.206)

- **PATRÓN** `volumen_pendiente_norm` > `0.2428` → IC=+0.323 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2428 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` < `1.368` → IC=+0.223 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.368 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `2.0232` → IC=+0.267 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0232 (IC base=+0.206)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.207 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `12510.0486` → IC=+0.235 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12510.0486 (IC base=+0.206)

- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.138 (n=219)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0047 (IC base=+0.085)

- **PATRÓN** `drift_60min` |x|≤ `0.0973` → IC=+0.158 (n=109)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0973 (IC base=+0.085)

- **PATRÓN** `ibs_20min` < `0.3235` → IC=+0.139 (n=217)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.3235 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.016` → IC=+0.136 (n=116)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.016 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.2153` → IC=+0.130 (n=52)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` > 0.2153 (IC base=+0.085)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.3434` → IC=-0.192 (n=24)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3434
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=287)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.175 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 15.0 (IC base=+0.063)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.210 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.063)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.297` → IC=+0.139 (n=120)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 5.297 (IC base=+0.063)

- **PATRÓN** `libro_liquidez` > `2775.0073` → IC=+0.167 (n=124)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2775.0073 (IC base=+0.063)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.139 (n=117)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 14.0 (IC base=+0.075)

- **PATRÓN** `ibs_20min` < `0.4524` → IC=+0.154 (n=235)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.4524 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.751` → IC=+0.159 (n=42)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 8.751 (IC base=+0.075)

- **PATRÓN** `volumen_regimen` < `0.7227` → IC=+0.157 (n=103)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7227 (IC base=+0.075)

- **PATRÓN** `volumen_spike_ratio` < `2.4885` → IC=+0.129 (n=211)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 2.4885 (IC base=+0.075)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.139 (n=178)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 47.0 (IC base=+0.075)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.191 (n=3113)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0086 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7208)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.475` → IC=+0.211 (n=6866)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.475 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.895` → IC=+0.198 (n=912)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.895 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.578` → IC=+0.221 (n=3364)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.578 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8826` → IC=+0.162 (n=3106)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8826 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1698` → IC=+0.185 (n=1883)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1698 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6439` → IC=+0.179 (n=2170)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.6439 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=8147)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3810.063` → IC=+0.170 (n=2289)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3810.063 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.192 (n=4841)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 99.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.197 (n=4199)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0067 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4754` → IC=+0.185 (n=6280)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.4754 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.200 (n=2423)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.237 (n=6280)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2283` → IC=+0.167 (n=3970)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.2283 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.78` → IC=+0.202 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.78 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `1.0552` → IC=+0.157 (n=3816)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.0552 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.197` → IC=+0.161 (n=1446)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.197 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2359` → IC=+0.245 (n=1089)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2359 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.2861` → IC=+0.190 (n=2519)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2861 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.178 (n=5158)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 131.0 (IC base=+0.182)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.219 (n=382)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0049 (IC base=+0.195)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.231 (n=519)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.195)

- **PATRÓN** `drift_60min` |x|≤ `0.3223` → IC=+0.195 (n=1144)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.3223 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.198 (n=555)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.327 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.775` → IC=+0.326 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.775 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.0953` → IC=+0.223 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0953 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` < `1.5585` → IC=+0.199 (n=466)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.5585 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` > `2.561` → IC=+0.190 (n=353)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.561 (IC base=+0.195)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.224 (n=1066)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.195)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.230 (n=808)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 80.0 (IC base=+0.195)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.265 (n=601)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.272 (n=901)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0044 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.2063` → IC=+0.283 (n=601)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2063 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.270 (n=821)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.0673` → IC=+0.304 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0673 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.636` → IC=+0.268 (n=900)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.636 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2284` → IC=+0.315 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2284 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `1.9089` → IC=+0.279 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9089 (IC base=+0.258)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.259 (n=905)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1576.58` → IC=+0.268 (n=805)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1576.58 (IC base=+0.258)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.257 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.258)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.193 (n=363)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0027 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.1843` → IC=+0.152 (n=725)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1843 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1141)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.6943` → IC=+0.240 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6943 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.339` → IC=+0.200 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.339 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.925` → IC=+0.169 (n=255)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.925 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.374` → IC=+0.153 (n=966)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.374 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.2804` → IC=+0.160 (n=1087)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2804 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1572` → IC=+0.184 (n=302)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1572 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4309` → IC=+0.160 (n=1035)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4309 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7617` → IC=+0.158 (n=690)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7617 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `10679.1014` → IC=+0.174 (n=971)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 10679.1014 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `502.0` → IC=+0.164 (n=965)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 502.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.172 (n=856)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.3258` → IC=+0.173 (n=971)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3258 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.170 (n=328)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6389` → IC=+0.206 (n=971)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6389 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.618` → IC=+0.193 (n=177)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 11.618 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.169 (n=971)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.1847 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.1494` → IC=+0.225 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1494 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `2.3876` → IC=+0.172 (n=874)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.3876 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` > `2.0862` → IC=+0.168 (n=398)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.0862 (IC base=+0.158)

- **PATRÓN** `ballena_activa_n` < `322.0` → IC=+0.172 (n=343)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 322.0 (IC base=+0.158)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.226 (n=1068)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.214 (n=1072)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3871` → IC=+0.265 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3871 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.68` → IC=+0.274 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.68 (IC base=+0.226)

- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.289 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3592 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` < `2.9594` → IC=+0.216 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9594 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` > `2.2499` → IC=+0.224 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2499 (IC base=+0.226)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.236 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `1891.307` → IC=+0.229 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1891.307 (IC base=+0.226)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.229 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 24.0 (IC base=+0.226)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.164 (n=513)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0039 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0944` → IC=+0.139 (n=386)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.0944 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.147 (n=1158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 6.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.7124` → IC=+0.234 (n=772)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7124 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.5489` → IC=+0.182 (n=325)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5489 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.369` → IC=+0.171 (n=505)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 4.369 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8816` → IC=+0.159 (n=772)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8816 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2725` → IC=+0.229 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2725 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.7416` → IC=+0.160 (n=740)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7416 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `9092.5017` → IC=+0.234 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9092.5017 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `170.0` → IC=+0.144 (n=910)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 170.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.166 (n=615)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0051 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.4263` → IC=+0.150 (n=922)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4263 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.168 (n=359)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 17.0 (IC base=+0.132)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.149 (n=459)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 8.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` < `0.6933` → IC=+0.183 (n=922)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6933 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.2025` → IC=+0.138 (n=851)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2025 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.238` → IC=+0.183 (n=137)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 11.238 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.352` → IC=+0.132 (n=861)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 4.352 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.8509` → IC=+0.137 (n=615)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8509 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `1.1615` → IC=+0.144 (n=307)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1615 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.2739` → IC=+0.250 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2739 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.557` → IC=+0.139 (n=377)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.557 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `2.1233` → IC=+0.159 (n=388)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.1233 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `11127.6873` → IC=+0.173 (n=307)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 11127.6873 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `178.0` → IC=+0.133 (n=748)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 178.0 (IC base=+0.132)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.162 (n=459)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 17.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.4615` → IC=+0.174 (n=1203)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.4615 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `1.0054` → IC=+0.176 (n=211)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 1.0054 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.395` → IC=+0.211 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.395 (IC base=+0.093)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=828)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2940.9508` → IC=+0.247 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2940.9508 (IC base=+0.093)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.180 (n=373)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0055 (IC base=+0.120)

- **PATRÓN** `drift_60min` |x|≤ `0.1219` → IC=+0.156 (n=373)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1219 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.157 (n=531)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` < `0.6154` → IC=+0.212 (n=1118)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6154 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` < `0.2627` → IC=+0.140 (n=961)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2627 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.344` → IC=+0.128 (n=1077)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.344 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` < `0.7144` → IC=+0.154 (n=492)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7144 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.2161` → IC=+0.176 (n=171)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2161 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` < `1.4645` → IC=+0.156 (n=321)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4645 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `2.1912` → IC=+0.137 (n=436)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.1912 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.127 (n=1226)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.03 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `2960.2272` → IC=+0.160 (n=372)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2960.2272 (IC base=+0.120)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.212 (n=807)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0175 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1270)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1779` → IC=+0.235 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1779 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.535` → IC=+0.239 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.535 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2371` → IC=+0.205 (n=1211)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2371 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6199` → IC=+0.206 (n=1211)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6199 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.2373` → IC=+0.237 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2373 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `2.6094` → IC=+0.229 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6094 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=1240)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2562.8289` → IC=+0.206 (n=807)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2562.8289 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.248 (n=443)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0251` → IC=+0.226 (n=443)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0251 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.209 (n=648)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.201)
...
- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.251 (n=1329)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.4839` → IC=+0.204 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4839 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.2635` → IC=+0.205 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2635 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.945` → IC=+0.262 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.945 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `1.2318` → IC=+0.239 (n=443)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2231` → IC=+0.192 (n=1014)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2231 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.198 (n=1152)
...
- **PATRÓN** `libro_liquidez` > `2537.96` → IC=+0.203 (n=886)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2537.96 (IC base=+0.201)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.184 (n=1062)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=2330)

- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.144 (n=1859)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0096 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.5354` → IC=+0.137 (n=2112)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.5354 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.154 (n=744)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 18.0 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.132 (n=825)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 5.0 (IC base=+0.129)

- **PATRÓN** `ibs_20min` > `0.9291` → IC=+0.200 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9291 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` > `0.1863` → IC=+0.127 (n=720)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.1863 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.192` → IC=+0.150 (n=338)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 10.192 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` > `0.8968` → IC=+0.127 (n=914)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` > 0.8968 (IC base=+0.129)

- **PATRÓN** `volumen_pendiente_norm` > `0.1732` → IC=+0.152 (n=584)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.1732 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` < `1.4513` → IC=+0.151 (n=697)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4513 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` > `1.8822` → IC=+0.141 (n=1393)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8822 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=1411)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `8850.2598` → IC=+0.152 (n=958)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8850.2598 (IC base=+0.129)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.193 (n=588)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0037 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4774` → IC=+0.162 (n=1759)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1852` → IC=+0.156 (n=774)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.1852 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6965` → IC=+0.152 (n=288)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6965 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.265` → IC=+0.147 (n=1738)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.265 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.9009` → IC=+0.155 (n=1113)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.9009 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.153 (n=825)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.5675` → IC=+0.145 (n=1741)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.5675 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8147` → IC=+0.149 (n=1161)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8147 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=2330)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.201 (n=362)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.3673` → IC=+0.145 (n=820)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.3673 (IC base=+0.133)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.318` → IC=+0.156 (n=801)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 6.318 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `0.88` → IC=+0.176 (n=547)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.88 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.0691` → IC=+0.155 (n=384)
...
- **PATRÓN** `volumen_spike_ratio` > `1.804` → IC=+0.145 (n=544)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.804 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `12051.5949` → IC=+0.147 (n=732)
...
- **PATRÓN** `dist_vwap_pct` > `0.6424` → IC=+0.200 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6424 (IC base=+0.018)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.176 (n=384)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0051 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.162 (n=205)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 18.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.6429` → IC=+0.200 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6429 (IC base=+0.093)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.248` → IC=+0.206 (n=158)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.248 (IC base=+0.093)

- **PATRÓN** `volumen_pendiente_norm` > `0.2862` → IC=+0.221 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2862 (IC base=+0.093)

- **PATRÓN** `volumen_spike_ratio` < `2.5073` → IC=+0.141 (n=377)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.5073 (IC base=+0.093)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.136 (n=388)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.167 (n=208)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.093)
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.209 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0048 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.210 (n=74)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.592` → IC=+0.195 (n=165)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.592 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.1288` → IC=+0.163 (n=81)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1288 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.734` → IC=+0.133 (n=107)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.734 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.0552` → IC=+0.135 (n=146)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.0552 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` < `0.0763` → IC=+0.152 (n=113)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` < 0.0763 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0198` → IC=+0.187 (n=113)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.0198 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.3712` → IC=+0.139 (n=128)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.3712 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=168)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2846.2218` → IC=+0.143 (n=152)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 2846.2218 (IC base=+0.105)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.138 (n=78)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.006 (IC base=+0.064)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.121 (n=122)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 14.0 (IC base=+0.064)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.182 (n=146)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.6744 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.8682` → IC=+0.154 (n=24)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.8682 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.624` → IC=+0.171 (n=80)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 3.624 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `2.5513` → IC=+0.159 (n=127)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.5513 (IC base=+0.064)

- **PATRÓN** `libro_liquidez` > `376.737` → IC=+0.153 (n=125)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 376.737 (IC base=+0.064)
...
- **FILTRO** `dist_vwap_pct` > `0.4126` → IC=-0.400 (n=18)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.275 (n=118)
...
- **PATRÓN** `ibs_20min` > `0.6429` → IC=+0.147 (n=188)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.6429 (IC base=+0.052)
...
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.154 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0046 (IC base=+0.059)

- **PATRÓN** `drift_60min` |x|≤ `0.1059` → IC=+0.167 (n=34)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.1059 (IC base=+0.059)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.200 (n=18)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.059)

- **PATRÓN** `ibs_20min` > `0.6331` → IC=+0.173 (n=50)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.6331 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.0901` → IC=+0.159 (n=42)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.0901 (IC base=+0.059)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.059)

- **PATRÓN** `libro_liquidez` > `2339.7005` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2339.7005 (IC base=+0.059)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.190 (n=27)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0047 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.3593` → IC=+0.130 (n=79)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.3593 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.134 (n=80)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 6.0 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.1848` → IC=+0.138 (n=67)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1848 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.688` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 3.688 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.7917` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7917 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.132 (n=55)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.04 (IC base=+0.117)

### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=391)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 6.0 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2816.9896` → IC=+0.176 (n=137)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2816.9896 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2297.9744` → IC=+0.123 (n=452)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2297.9744 (IC base=+0.089)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=5588)

### MOMENTUM_IBS_15M#BTC#15min
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=961)

### MOMENTUM_IBS_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1087)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.465` → IC=-0.175 (n=2314)

  - _Acción_: SKIP cuando `py_entrada` < 0.465
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=6998)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=2210)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=7453)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.209 (n=372)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1169)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.200 (n=394)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=1219)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.217 (n=404)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=1284)

- **FILTRO** `ibs_20min` > `0.2883` → IC=-0.178 (n=421)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2883
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=1267)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.192 (n=375)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1135)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.187 (n=423)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=1277)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1966)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1835)
...
- **FILTRO** `ibs_20min` > `0.151` → IC=-0.132 (n=93)

  - _Acción_: SKIP cuando `ibs_20min` > 0.151
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=182)

### MOMENTUM_IBS_15M_FADE#ETH#15min
- **FILTRO** `ibs_20min` < `0.2319` → IC=-0.211 (n=95)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2319
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=529)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=5448)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=16743)

- **FILTRO** `ibs_7min` < `0.7125` → IC=-0.231 (n=5544)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7125
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=16647)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.162 (n=7532)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=14659)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.219 (n=6850)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=20817)

- **FILTRO** `ibs_7min` > `0.2982` → IC=-0.174 (n=6913)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2982
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=20754)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.313 (n=812)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2650)

- **FILTRO** `ibs_7min` < `0.7105` → IC=-0.257 (n=1142)
...
- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.203 (n=849)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=2613)

- **FILTRO** `py_entrada` > `0.51` → IC=-0.150 (n=3161)

  - _Acción_: SKIP cuando `py_entrada` > 0.51
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=1651)

- **FILTRO** `drift_7min_pct` |x|> `0.1104` → IC=-0.126 (n=1635)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1104
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3177)

- **FILTRO** `ibs_7min` > `0.8012` → IC=-0.202 (n=1202)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8012
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3610)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.146 (n=889)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=3038)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.252 (n=972)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2955)

- **FILTRO** `ibs_7min` < `0.7628` → IC=-0.181 (n=981)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7628
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=2946)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.172 (n=976)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2951)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=906)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3029)

- **FILTRO** `ibs_7min` > `0.2503` → IC=-0.168 (n=981)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2503
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2954)

- **FILTRO** `ballena_activa_n` > `152.0` → IC=-0.171 (n=983)

  - _Acción_: SKIP cuando `ballena_activa_n` > 152.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2952)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.177 (n=785)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2496)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.321 (n=769)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2512)

- **FILTRO** `ibs_7min` < `0.2105` → IC=-0.266 (n=820)
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.214 (n=771)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=2510)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.230 (n=1164)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3886)

- **FILTRO** `ibs_7min` > `0.2667` → IC=-0.152 (n=1713)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=1129)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=2530)

- **FILTRO** `ibs_7min` < `0.7511` → IC=-0.185 (n=913)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7511
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=2746)

- **FILTRO** `ballena_activa_n` > `35.0` → IC=-0.182 (n=891)

  - _Acción_: SKIP cuando `ballena_activa_n` > 35.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=2768)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=907)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2812)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.172 (n=929)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2790)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.175 (n=927)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2792)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.232 (n=1022)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=3100)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.201 (n=1024)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3098)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.168 (n=1252)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=3982)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.281 (n=885)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2855)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.225 (n=935)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2805)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.209 (n=878)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2862)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.195 (n=1184)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=3733)
...
- **PATRÓN** `streak_estiramiento` < `0.4159` → IC=+0.214 (n=54)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=423)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.155 (n=27)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=403)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=458)

- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=512)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2122)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.186 (n=320)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0039 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.180 (n=320)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0086 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.0584` → IC=+0.170 (n=322)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.0584 (IC base=+0.166)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0589` → IC=+0.171 (n=959)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.86€ cuando `delta_ratio_macro` |x|> 0.0589 (IC base=+0.166)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.228 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.133 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.167 (n=1007)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.617` → IC=+0.239 (n=959)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.617 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` < `0.1053` → IC=+0.169 (n=629)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1053 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.695` → IC=+0.238 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.695 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=856)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2980.6496` → IC=+0.179 (n=639)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2980.6496 (IC base=+0.166)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=261)

### UPDOWN_GBM#BTC#15min
- **FILTRO** `ibs_15` > `0.5884` → IC=-0.132 (n=123)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.5884
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=241)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.220 (n=162)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.195)

- **PATRÓN** `sigma_h` > `0.0023` → IC=+0.198 (n=243)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0023 (IC base=+0.195)

- **PATRÓN** `drift_60min` |x|≤ `0.0624` → IC=+0.247 (n=81)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0624 (IC base=+0.195)

- **PATRÓN** `drift_15min` |x|≤ `0.3744` → IC=+0.223 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3744 (IC base=+0.195)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2384` → IC=+0.199 (n=81)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.99€ cuando `delta_ratio_macro` |x|> 0.2384 (IC base=+0.195)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3848` → IC=+0.231 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3848 (IC base=+0.195)
...
- **PATRÓN** `ibs_15` > `0.8791` → IC=+0.299 (n=162)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8791 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` > `0.3789` → IC=+0.238 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3789 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` < `0.1019` → IC=+0.211 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1019 (IC base=+0.195)
...
- **PATRÓN** `libro_liquidez` > `13620.7369` → IC=+0.250 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13620.7369 (IC base=+0.195)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.160 (n=45)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0047 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.182 (n=61)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0076 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.1368` → IC=+0.169 (n=119)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.1368 (IC base=+0.135)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0662` → IC=+0.164 (n=120)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.82€ cuando `delta_ratio_macro` |x|> 0.0662 (IC base=+0.135)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3249` → IC=+0.214 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3249 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=103)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.135)

- **PATRÓN** `ibs_15` > `0.5641` → IC=+0.237 (n=135)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5641 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.2095` → IC=+0.150 (n=135)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.2095 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.367` → IC=+0.389 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.367 (IC base=+0.135)
...
- **PATRÓN** `libro_liquidez` > `2978.7992` → IC=+0.246 (n=61)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2978.7992 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.208 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` > `0.0133` → IC=+0.227 (n=181)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0133 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.0876` → IC=+0.183 (n=121)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.0876 (IC base=+0.159)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0478` → IC=+0.186 (n=272)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.93€ cuando `delta_ratio_macro` |x|> 0.0478 (IC base=+0.159)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.093` → IC=+0.287 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.093 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.221 (n=134)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.159)

- **PATRÓN** `ibs_15` > `0.5075` → IC=+0.248 (n=272)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5075 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` > `0.1654` → IC=+0.178 (n=150)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1654 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.2989` → IC=+0.160 (n=251)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2989 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.232` → IC=+0.202 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.232 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.247` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 7.247 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `2708.8088` → IC=+0.198 (n=124)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2708.8088 (IC base=+0.159)

- **PATRÓN** `ibs_15` < `0.1053` → IC=+0.163 (n=289)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `drift_60min` |x|≤ `0.1567` → IC=+0.340 (n=248)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1567 (IC base=+0.333)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0665` → IC=+0.335 (n=283)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0665 (IC base=+0.333)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2192` → IC=+0.367 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2192 (IC base=+0.333)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.349 (n=302)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.333)

- **PATRÓN** `ibs_15` > `0.8365` → IC=+0.394 (n=252)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8365 (IC base=+0.333)

- **PATRÓN** `dist_vwap_pct` > `0.4169` → IC=+0.362 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4169 (IC base=+0.333)

- **PATRÓN** `sigma_ewma_delta_pct` > `18.976` → IC=+0.349 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.976 (IC base=+0.333)

- **PATRÓN** `sigma_ewma_delta_pct` < `23.866` → IC=+0.331 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 23.866 (IC base=+0.333)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.340 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.333)

- **PATRÓN** `libro_liquidez` > `3940.6708` → IC=+0.346 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3940.6708 (IC base=+0.333)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1072` → IC=+0.339 (n=54)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1072 (IC base=+0.333)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.332 (n=141)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1544` → IC=+0.339 (n=141)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1544 (IC base=+0.333)

- **PATRÓN** `drift_15min` |x|≤ `0.376` → IC=+0.339 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.376 (IC base=+0.333)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1017` → IC=+0.341 (n=143)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1017 (IC base=+0.333)
...
- **PATRÓN** `ibs_15` > `0.8066` → IC=+0.370 (n=160)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.296` → IC=+0.349 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.296 (IC base=+0.333)
...
- **FILTRO** `sigma_h` > `0.0121` → IC=-0.200 (n=492)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `ibs_15` < `0.5833` → IC=-0.187 (n=164)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.246 (n=494)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.164 (n=605)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1366)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2964` → IC=+0.217 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2964 (IC base=-0.056)

- **PATRÓN** `ibs_15` > `0.5833` → IC=+0.246 (n=494)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5833 (IC base=-0.056)

- **PATRÓN** `dist_vwap_pct` < `0.2631` → IC=+0.171 (n=387)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.2631 (IC base=-0.056)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1187` → IC=+0.224 (n=631)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1187 (IC base=-0.050)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1814` → IC=+0.231 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1814 (IC base=-0.050)

- **PATRÓN** `ibs_15` < `0.3561` → IC=+0.270 (n=946)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3561 (IC base=-0.050)

- **PATRÓN** `dist_vwap_pct` > `0.3864` → IC=+0.255 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3864 (IC base=-0.050)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0071` → IC=-0.211 (n=292)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0071
  - _Potencial_: sin este filtro IC_bueno=-0.196 (n=878)

- **FILTRO** `sigma_h` < `0.0032` → IC=-0.228 (n=292)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=878)
...
- **FILTRO** `sigma_ewma_delta_pct` > `20.172` → IC=-0.245 (n=214)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=956)

- **PATRÓN** `sigma_h` < `0.003` → IC=+0.172 (n=132)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.003 (IC base=+0.069)

- **PATRÓN** `delta_ratio_macro` |x|> `0.191` → IC=+0.250 (n=46)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.191 (IC base=+0.069)
...
- **PATRÓN** `ibs_15` > `0.7695` → IC=+0.349 (n=91)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7695 (IC base=+0.069)

- **PATRÓN** `dist_vwap_pct` < `0.1422` → IC=+0.260 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1422 (IC base=+0.069)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.226 (n=345)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.3497` → IC=+0.226 (n=345)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3497 (IC base=+0.212)

- **PATRÓN** `drift_15min` |x|≤ `0.4147` → IC=+0.222 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4147 (IC base=+0.212)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1958` → IC=+0.228 (n=178)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1958 (IC base=+0.212)
...
- **PATRÓN** `ibs_15` < `0.3657` → IC=+0.259 (n=392)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3657 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` > `0.727` → IC=+0.250 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.727 (IC base=+0.212)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `11.691` → IC=+0.218 (n=420)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.691 (IC base=+0.212)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `drift_15min` |x|> `0.8384` → IC=-0.240 (n=121)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.8384
  - _Potencial_: sin este filtro IC_bueno=-0.110 (n=365)
...
- **FILTRO** `sigma_h` > `0.0186` → IC=-0.240 (n=290)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0186
  - _Potencial_: sin este filtro IC_bueno=-0.104 (n=291)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.243 (n=146)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.148 (n=435)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.103` → IC=+0.372 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.103 (IC base=-0.050)

- **PATRÓN** `ibs_15` < `0.3333` → IC=+0.285 (n=268)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3333 (IC base=-0.050)

- **PATRÓN** `dist_vwap_pct` > `0.4333` → IC=+0.393 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4333 (IC base=-0.050)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.295 (n=320)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0043 (IC base=+0.288)

- **PATRÓN** `sigma_h` > `0.0027` → IC=+0.290 (n=480)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1882` → IC=+0.314 (n=218)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.292 (n=118)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_15min` |x|≤ `0.3845` → IC=+0.283 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3845 (IC base=+0.280)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2384` → IC=+0.315 (n=90)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2384 (IC base=+0.280)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.330 (n=127)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.280)

- **PATRÓN** `ibs_15` > `0.8595` → IC=+0.314 (n=240)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8595 (IC base=+0.280)

- **PATRÓN** `dist_vwap_pct` > `0.2555` → IC=+0.335 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2555 (IC base=+0.280)
...
- **PATRÓN** `dist_vwap_pct` < `0.1621` → IC=+0.301 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1621 (IC base=+0.296)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.617 sube el IC de +0.166 a +0.239 en UPDOWN_GBM#15min (n=959). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.8791 sube el IC de +0.195 a +0.299 en UPDOWN_GBM#BTC#15min (n=162). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#SOL#15min**: dentro de BUY_YES, IBS > 0.5641 sube el IC de +0.135 a +0.237 en UPDOWN_GBM#SOL#15min (n=135). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5075 sube el IC de +0.159 a +0.248 en UPDOWN_GBM#XRP#15min (n=272). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1053 sube el IC de +0.045 a +0.163 en UPDOWN_GBM#XRP#15min (n=289). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5833 sube el IC de -0.056 a +0.246 en UPDOWN_GBM_15M_TARDIO (n=494). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3561 sube el IC de -0.050 a +0.270 en UPDOWN_GBM_15M_TARDIO (n=946). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7695 sube el IC de +0.069 a +0.349 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=91). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3657 sube el IC de +0.212 a +0.259 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=392). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3333 sube el IC de -0.050 a +0.285 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=268). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8357 sube el IC de +0.288 a +0.332 en UPDOWN_GBM_IBS_ALTO (n=480). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8595 sube el IC de +0.280 a +0.314 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=240). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.8365 sube el IC de +0.333 a +0.394 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=252). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8066 sube el IC de +0.333 a +0.370 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=160). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 21071 | -0.105 | -3148.28€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1132 | -0.027 | -190.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19939 | -0.110 | -2957.98€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2930 | -0.112 | -526.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2930 | -0.112 | -526.68€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1132 | -0.027 | -190.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1132 | -0.027 | -190.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2688 | -0.090 | -608.94€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2688 | -0.090 | -608.94€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 5456 | -0.064 | -512.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5456 | -0.064 | -512.71€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 4837 | -0.110 | -374.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 4837 | -0.110 | -374.69€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4028 | -0.180 | -934.96€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4028 | -0.180 | -934.96€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 9877 | -0.051 | +4110.92€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 2712 | -0.010 | +1748.48€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 7165 | -0.066 | +2362.44€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 9877 | -0.051 | +4110.92€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 2712 | -0.010 | +1748.48€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 7165 | -0.066 | +2362.44€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 314 | -0.092 | -49.66€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 5 | +0.018 | +0.75€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 309 | -0.095 | -50.41€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 12 | +0.000 | +2.95€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 12 | +0.000 | +2.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 66811 | +0.112 | -3716.45€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 10676 | +0.182 | -319.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 256 | -0.112 | -46.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 51438 | +0.099 | -3260.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 4441 | +0.116 | -89.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 8582 | +0.093 | -880.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 35 | -0.176 | -2.14€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 8532 | +0.095 | -866.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 13227 | +0.131 | -267.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3219 | +0.202 | -93.61€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 8525 | +0.108 | -185.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1441 | +0.117 | +33.57€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 8620 | +0.087 | -903.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 40 | -0.048 | -3.03€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 8565 | +0.088 | -889.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 14398 | +0.125 | -281.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4090 | +0.170 | -71.05€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 8580 | +0.109 | -160.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1716 | +0.100 | -41.21€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 13385 | +0.116 | -815.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3258 | +0.187 | -153.88€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 159 | -0.059 | +7.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 8684 | +0.090 | -587.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1284 | +0.135 | -81.95€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 8599 | +0.101 | -567.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 34 | -0.028 | +4.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 8552 | +0.102 | -571.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 10371 | +0.183 | -764.08€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 10371 | +0.183 | -764.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2648 | +0.168 | -284.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2648 | +0.168 | -284.22€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2609 | +0.176 | -246.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2609 | +0.176 | -246.98€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 