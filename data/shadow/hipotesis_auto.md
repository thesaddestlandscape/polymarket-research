# Hipótesis automáticas — 2026-07-26 03:47 UTC
_Generado por shadow_postmortem.py sobre 35953 resoluciones (PNL=+7619.67€)_
...
- **PATRÓN** `py_entrada` > `0.715` → IC=+0.348 (n=235)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.157 (n=322)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 6.0 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.3699` → IC=+0.184 (n=112)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.3699 (IC base=+0.140)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.191 (n=1064)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.199 (n=134)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0079 (IC base=+0.121)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.253` → IC=+0.204 (n=106)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.253 (IC base=+0.121)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.249 (n=492)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.6522` → IC=+0.344 (n=30)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6522 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.761` → IC=+0.214 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.761 (IC base=+0.216)
...
- **PATRÓN** `dist_vwap_pct` > `0.4741` → IC=+0.159 (n=294)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.4741 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.462` → IC=+0.271 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.462 (IC base=+0.109)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `13.007` → IC=+0.204 (n=52)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.007 (IC base=+0.064)
...
- **PATRÓN** `sigma_h` < `0.0209` → IC=+0.186 (n=418)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.180 (n=426)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 15.0 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` > `0.2608` → IC=+0.227 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2608 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.005` → IC=+0.302 (n=89)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.761` → IC=+0.227 (n=430)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.761 (IC base=+0.057)

- **PATRÓN** `dist_vwap_pct` > `0.1676` → IC=+0.180 (n=198)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1676 (IC base=+0.057)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.108` → IC=+0.161 (n=181)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 7.108 (IC base=+0.057)
...
- **PATRÓN** `ibs_15` > `0.6794` → IC=+0.190 (n=188)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.95€ cuando `ibs_15` > 0.6794 (IC base=+0.047)

- **PATRÓN** `dist_vwap_pct` > `0.133` → IC=+0.144 (n=99)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.133 (IC base=+0.047)

- **PATRÓN** `dist_vwap_pct` < `0.658` → IC=+0.120 (n=177)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` < 0.658 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` > `22.327` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 22.327 (IC base=+0.047)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.761 sube el IC de +0.057 a +0.227 en UPDOWN_GBM#15min (n=430). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6794 sube el IC de +0.047 a +0.190 en UPDOWN_GBM#ETH#15min (n=188). Ya aplicado como kelly_boost=+0.95€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1203 | +0.122 | +55.24€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1203 | +0.122 | +55.24€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 269 | +0.083 | +20.24€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 269 | +0.083 | +20.24€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 6416 | +0.181 | +1.62€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4228 | +0.206 | +3.34€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 2257 | +0.170 | -33.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1393 | +0.201 | -1.91€ | 0 | 5 |
...
| ✅ GBM_LATE_15M | 7895 | +0.095 | +2420.41€ | 0 | 3 |
| ✅ GBM_LATE_15M#15min | 7895 | +0.095 | +2420.41€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 2109 | +0.142 | +1035.79€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2109 | +0.142 | +1035.79€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5113 | +0.119 | +2458.35€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5113 | +0.119 | +2458.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1336 | +0.086 | +482.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1336 | +0.086 | +482.68€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1334 | +0.086 | +465.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1334 | +0.086 | +465.56€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1285 | +0.090 | +513.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1285 | +0.090 | +513.75€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1158 | +0.225 | +996.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1158 | +0.225 | +996.36€ | 0 | 9 |
...
| ✅ GBM_LATE_15M_TARDIO | 5113 | +0.072 | +1424.44€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5113 | +0.072 | +1424.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1227 | +0.040 | +165.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1227 | +0.040 | +165.96€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1240 | +0.026 | +97.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1240 | +0.026 | +97.69€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1200 | +0.034 | +237.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1200 | +0.034 | +237.27€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1446 | +0.171 | +923.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1446 | +0.171 | +923.52€ | 0 | 10 |
| ✅ GBM_LATE_5M | 695 | -0.028 | +6.07€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 695 | -0.028 | +6.07€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#SOL | 192 | -0.067 | +15.75€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 192 | -0.067 | +15.75€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2634 | +0.036 | +252.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2371 | +0.055 | +290.66€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 1041 | +0.040 | +76.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 947 | +0.054 | +87.64€ | 0 | 6 |
...
| ✅ UPDOWN_GBM#XRP | 284 | +0.042 | +33.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 273 | +0.053 | +37.14€ | 3 | 0 |
| 🚫 UPDOWN_GBM#XRP#5min | 11 | -0.106 | -3.29€ | 0 | 0 |
| 🚫 UPDOWN_GBM#daily | 45 | -0.202 | +1.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 167 | +0.299 | +31.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 167 | +0.299 | +31.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 78 | +0.300 | +14.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 78 | +0.300 | +14.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 89 | +0.291 | +16.99€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 89 | +0.291 | +16.99€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 1814 | +0.154 | +814.07€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1814 | +0.154 | +814.07€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 355 | +0.172 | +147.83€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 355 | +0.172 | +147.83€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 437 | +0.092 | +116.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 437 | +0.092 | +116.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 498 | +0.174 | +301.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 498 | +0.174 | +301.75€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.177: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.075 n=1410 | neutral: IC=+0.014 n=1131 | overbought(IBS>0.7): IC=+0.191 n=1435
  - _Datos_: n=4240 IC=+0.104 PNL=+1124.65€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.113 n=21476 | tras_1loss IC=+0.081 n=14270 | tras_2loss IC=+0.053 n=5935/40 | gap=+0.059 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.048 n=166/60 | contraria IC=+0.110 n=57 | gap=-0.063 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2498 IC=+0.041 PNL=+267.86€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2498 IC=+0.041 PNL=+267.86€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1034 IC=+0.057 PNL=+150.68€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1034 IC=+0.057 PNL=+150.68€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.090 > 0.08 con n=1261 PNL=+222.87€
  - _Datos_: n=1261 IC=+0.090 PNL=+222.87€
...
**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.095 > 0.08 con n=324 PNL=+59.15€
  - _Datos_: n=324 IC=+0.095 PNL=+59.15€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.243 > 0.08 con n=177 PNL=+32.70€
  - _Datos_: n=177 IC=+0.243 PNL=+32.70€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=369 IC=+0.015 PNL=+13.80€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=369 IC=+0.015 PNL=+13.80€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1184 IC=+0.030 PNL=+120.13€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1184 IC=+0.030 PNL=+120.13€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.166 > 0.1 con n=879 PNL=+321.89€
  - _Datos_: n=879 IC=+0.166 PNL=+321.89€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.133 > 0.08 con n=630 PNL=+196.93€
  - _Datos_: n=630 IC=+0.133 PNL=+196.93€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.132 > 0.08 con n=663 PNL=+339.99€
  - _Datos_: n=663 IC=+0.132 PNL=+339.99€
