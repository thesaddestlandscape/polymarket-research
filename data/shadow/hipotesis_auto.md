# Hipótesis automáticas — 2026-07-10 21:44 UTC
_Generado por shadow_postmortem.py sobre 8174 resoluciones (PNL=+1241.51€)_
...
- **PATRÓN** `ibs_15` > `0.7138` → IC=+0.123 (n=189)
  ...
  - _Acción_: Kelly boost +0.62€ cuando `ibs_15` > 0.7138 (IC base=+0.001)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0646` → IC=+0.125 (n=46)
  ...
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.0646 (IC base=+0.033)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.145 (n=108)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 11.0 (IC base=+0.033)

- **PATRÓN** `ibs_15` < `0.9136` → IC=+0.130 (n=98)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.65€ cuando `ibs_15` < 0.9136 (IC base=+0.033)

- **PATRÓN** `ibs_15` > `0.7945` → IC=+0.157 (n=65)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.78€ cuando `ibs_15` > 0.7945 (IC base=+0.033)
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#BTC#15min` — IC=+0.232 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 188 | +0.184 | -2.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 121 | +0.207 | -2.14€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 61 | +0.167 | -1.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 39 | +0.232 | +0.21€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 10 | +0.125 | +1.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 63 | +0.208 | +3.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 41 | +0.244 | +3.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 10 | +0.042 | -0.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 10 | +0.125 | +1.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 64 | +0.167 | -4.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 41 | +0.128 | -5.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 10 | +0.042 | -0.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 10 | +0.125 | +1.28€ | 0 | 0 |
| ✅ GBM_LATE_15M | 3005 | +0.114 | +968.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 3005 | +0.114 | +968.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 755 | +0.061 | +76.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 755 | +0.061 | +76.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 765 | +0.074 | +121.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 765 | +0.074 | +121.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 775 | +0.149 | +402.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 775 | +0.149 | +402.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 710 | +0.174 | +368.80€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 710 | +0.174 | +368.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 442 | +0.171 | +197.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 442 | +0.171 | +197.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 109 | +0.212 | +60.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 109 | +0.212 | +60.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 121 | +0.159 | +50.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 121 | +0.159 | +50.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 126 | +0.070 | +13.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 126 | +0.070 | +13.59€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 550 | +0.067 | +95.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 550 | +0.067 | +95.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 131 | +0.094 | +14.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 131 | +0.094 | +14.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 139 | +0.004 | +1.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 139 | +0.004 | +1.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 138 | -0.043 | -2.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 138 | -0.043 | -2.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 142 | +0.208 | +80.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 142 | +0.208 | +80.61€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1237 | -0.016 | -5.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 982 | +0.013 | +31.46€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 331 | -0.004 | -8.62€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 253 | +0.033 | +4.25€ | 2 | 7 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.103) — sin ventaja clara. oversold(IBS<0.3): IC=-0.022 n=314 | neutral: IC=-0.056 n=239 | overbought(IBS>0.7): IC=+0.046 n=256
  - _Datos_: n=847 IC=-0.004 PNL=+19.74€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.075 n=4465 | tras_1loss IC=+0.028 n=3574 | tras_2loss IC=-0.010 n=1659/40 | gap=+0.085 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1114 IC=-0.010 PNL=+8.06€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1114 IC=-0.010 PNL=+8.06€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=553 IC=+0.001 PNL=-1.70€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=553 IC=+0.001 PNL=-1.70€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=253 IC=+0.033 PNL=+4.25€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=253 IC=+0.033 PNL=+4.25€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=488 IC=+0.033 PNL=+13.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=488 IC=+0.033 PNL=+13.35€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5716 IC=+0.086 PNL=+1317.39€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5716 IC=+0.086 PNL=+1317.39€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=700 IC=-0.031 PNL=-32.17€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=700 IC=-0.031 PNL=-32.17€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.164 > 0.1 con n=209 PNL=+68.55€
  - _Datos_: n=209 IC=+0.164 PNL=+68.55€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=138 IC=+0.050 PNL=+3.99€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=138 IC=+0.050 PNL=+3.99€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.08 con n=149 PNL=+44.55€
  - _Datos_: n=149 IC=+0.169 PNL=+44.55€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 63/80 ops en el filtro definido (IC actual=+0.223 PNL=+20.56€)
  - _Datos_: n=63 IC=+0.223 PNL=+20.56€
