# Hipótesis automáticas — 2026-07-29 05:18 UTC
_Generado por shadow_postmortem.py sobre 41315 resoluciones (PNL=+8763.72€)_
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.193 (n=1320)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.303` → IC=+0.239 (n=653)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.303 (IC base=+0.145)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.123 (n=1315)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0083 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.4734` → IC=+0.137 (n=362)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.4734 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.89` → IC=+0.237 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.89 (IC base=+0.097)
...
- **PATRÓN** `dist_vwap_pct` > `0.6726` → IC=+0.235 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6726 (IC base=+0.173)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=436)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2192` → IC=+0.139 (n=319)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.2192 (IC base=+0.101)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0631` → IC=+0.129 (n=319)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.65€ cuando `delta_ratio_macro` |x|> 0.0631 (IC base=+0.101)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.167 (n=187)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 14.0 (IC base=+0.101)
...
- **PATRÓN** `libro_liquidez` > `11693.755` → IC=+0.164 (n=111)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 11693.755 (IC base=+0.101)
...
- **PATRÓN** `ibs_15` > `0.6674` → IC=+0.190 (n=211)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.95€ cuando `ibs_15` > 0.6674 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.038` → IC=+0.142 (n=65)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 7.038 (IC base=+0.045)

- **PATRÓN** `libro_liquidez` > `10375.7754` → IC=+0.129 (n=60)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 10375.7754 (IC base=+0.045)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6 sube el IC de +0.056 a +0.174 en UPDOWN_GBM#15min (n=660). Ya aplicado como kelly_boost=+0.87€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6674 sube el IC de +0.045 a +0.190 en UPDOWN_GBM#ETH#15min (n=211). Ya aplicado como kelly_boost=+0.95€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 55 | +0.342 | +2.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 55 | +0.342 | +2.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 55 | +0.342 | +2.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 55 | +0.342 | +2.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 6962 | +0.177 | -51.74€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4579 | +0.200 | -46.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 320 | +0.056 | -24.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 821 | +0.128 | -56.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1242 | +0.152 | +75.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 2071 | +0.183 | +0.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1534 | +0.198 | -42.57€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 2438 | +0.167 | -47.59€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 416 | +0.136 | +11.83€ | 0 | 10 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 27 | +0.362 | +1.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 27 | +0.362 | +1.72€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 8907 | +0.094 | +2684.05€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8907 | +0.094 | +2684.05€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 108 | +0.200 | +66.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 108 | +0.200 | +66.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2100 | +0.069 | +342.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2100 | +0.069 | +342.48€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 108 | +0.091 | +20.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 108 | +0.091 | +20.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1887 | +0.070 | +304.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1887 | +0.070 | +304.20€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2339 | +0.084 | +797.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2339 | +0.084 | +797.97€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2365 | +0.141 | +1153.05€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2365 | +0.141 | +1153.05€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 6110 | +0.119 | +2925.13€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 6110 | +0.119 | +2925.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 81 | +0.319 | +95.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 81 | +0.319 | +95.64€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1489 | +0.088 | +598.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1489 | +0.088 | +598.58€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_TARDIO | 6111 | +0.066 | +1659.12€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 6111 | +0.066 | +1659.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 94 | +0.260 | +78.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 94 | +0.260 | +78.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1410 | +0.021 | +153.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1410 | +0.021 | +153.31€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 101 | +0.160 | +42.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 101 | +0.160 | +42.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1441 | +0.018 | +111.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1441 | +0.018 | +111.70€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1403 | +0.025 | +259.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1403 | +0.025 | +259.66€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1662 | +0.164 | +1013.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1662 | +0.164 | +1013.79€ | 0 | 13 |
| ✅ GBM_LATE_5M | 929 | -0.034 | -4.91€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 929 | -0.034 | -4.91€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 200 | -0.035 | -9.84€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 200 | -0.035 | -9.84€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 3059 | +0.036 | +279.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2795 | +0.052 | +318.61€ | 0 | 6 |
...
| ✅ UPDOWN_GBM#BTC | 603 | +0.055 | +77.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 519 | +0.087 | +92.32€ | 1 | 9 |
...
| ✅ UPDOWN_GBM#ETH | 1142 | +0.040 | +83.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1048 | +0.053 | +94.65€ | 0 | 5 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 203 | +0.305 | +43.42€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 203 | +0.305 | +43.42€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 98 | +0.310 | +22.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 98 | +0.310 | +22.97€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2349 | +0.149 | +1023.48€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2349 | +0.149 | +1023.48€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.160: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.077 n=1800 | neutral: IC=+0.024 n=1411 | overbought(IBS>0.7): IC=+0.184 n=1708
  - _Datos_: n=5251 IC=+0.103 PNL=+1372.71€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=24573 | tras_1loss IC=+0.077 n=16501 | tras_2loss IC=+0.052 n=6943/40 | gap=+0.060 (umbral 0.05)
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.006 n=170 | contrario_BTC IC=-0.033 n=73/40 | gap=-0.028 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**🟡 H-24H-GBM-BUYYES-MADRUGADA** — GBM BUY_YES en madrugada europea (05-07h UTC) — señal alcista
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.101 > 0.08 con n=146 PNL=+51.45€
  - _Datos_: n=146 IC=+0.101 PNL=+51.45€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2922 IC=+0.040 PNL=+293.38€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2922 IC=+0.040 PNL=+293.38€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1159 IC=+0.056 PNL=+158.61€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1159 IC=+0.056 PNL=+158.61€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=519 IC=+0.087 PNL=+92.32€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=519 IC=+0.087 PNL=+92.32€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.086 > 0.08 con n=1467 PNL=+244.94€
  - _Datos_: n=1467 IC=+0.086 PNL=+244.94€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.233 > 0.08 con n=208 PNL=+44.57€
  - _Datos_: n=208 IC=+0.233 PNL=+44.57€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=5009 IC=+0.080 PNL=+1098.06€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5009 IC=+0.080 PNL=+1098.06€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=453 IC=+0.023 PNL=+17.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=453 IC=+0.023 PNL=+17.97€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1309 IC=+0.032 PNL=+128.06€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1309 IC=+0.032 PNL=+128.06€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=1076 PNL=+358.28€
  - _Datos_: n=1076 IC=+0.160 PNL=+358.28€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.118 > 0.08 con n=755 PNL=+204.85€
  - _Datos_: n=755 IC=+0.118 PNL=+204.85€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.096 > 0.08 con n=741 PNL=+220.21€
  - _Datos_: n=741 IC=+0.096 PNL=+220.21€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.171 > 0.08 con n=305 PNL=+112.36€
  - _Datos_: n=305 IC=+0.171 PNL=+112.36€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.206 > 0.2 con n=808 PNL=+484.17€
  - _Datos_: n=808 IC=+0.206 PNL=+484.17€
