# Hipótesis automáticas — 2026-07-19 07:07 UTC
_Generado por shadow_postmortem.py sobre 22099 resoluciones (PNL=+5354.16€)_
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.218 (n=651)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.175)

- **PATRÓN** `py_entrada` < `0.265` → IC=+0.341 (n=495)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.175)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.181 (n=1639)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.175)

- **PATRÓN** `libro_liquidez` > `4300.8754` → IC=+0.176 (n=966)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 4300.8754 (IC base=+0.175)
...
- **PATRÓN** `py_entrada` < `0.275` → IC=+0.365 (n=146)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.135 (n=1569)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 12.0 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.1537` → IC=+0.131 (n=367)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.1537 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.8964` → IC=+0.124 (n=1098)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.8964 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.147` → IC=+0.147 (n=230)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 6.147 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.031` → IC=+0.120 (n=975)
...
- **PATRÓN** `dist_vwap_pct` < `0.6204` → IC=+0.188 (n=915)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.6204 (IC base=+0.170)
...
- **PATRÓN** `dist_vwap_pct` > `0.6179` → IC=+0.198 (n=61)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.6179 (IC base=+0.125)
...
- **PATRÓN** `dist_vwap_pct` < `0.7697` → IC=+0.128 (n=950)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.7697 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.527` → IC=+0.131 (n=247)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 3.527 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.031` → IC=+0.120 (n=849)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.821` → IC=+0.196 (n=54)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 7.821 (IC base=+0.046)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.593` → IC=-0.143 (n=26)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.116 (n=290)
...
- **PATRÓN** `ibs_15` < `0.0263` → IC=+0.120 (n=177)
  ...
  - _Acción_: Kelly boost +0.60€ cuando `ibs_15` < 0.0263 (IC base=+0.057)

- **PATRÓN** `dist_vwap_pct` > `0.8904` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.8904 (IC base=+0.057)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.454` → IC=+0.131 (n=258)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 10.454 (IC base=+0.057)
...
| ✅ FAVORITO_CONFIRMADO | 3715 | +0.186 | +60.74€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 2412 | +0.220 | +104.43€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1318 | +0.180 | +21.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 798 | +0.224 | +52.71€ | 0 | 9 |
...
| ✅ GBM_LATE_15M | 5750 | +0.106 | +1930.53€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 5750 | +0.106 | +1930.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1368 | +0.077 | +249.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1368 | +0.077 | +249.89€ | 0 | 7 |
| ✅ GBM_LATE_15M#ETH | 1322 | +0.079 | +246.79€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1322 | +0.079 | +246.79€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2979 | +0.152 | +1766.55€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2979 | +0.152 | +1766.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 759 | +0.116 | +355.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 759 | +0.116 | +355.69€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 785 | +0.116 | +361.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 785 | +0.116 | +361.09€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 2926 | +0.100 | +1018.28€ | 0 | 11 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2926 | +0.100 | +1018.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 701 | +0.072 | +147.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 701 | +0.072 | +147.25€ | 0 | 7 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 705 | +0.039 | +66.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 705 | +0.039 | +66.69€ | 0 | 4 |
...
| ✅ UPDOWN_GBM | 1816 | +0.020 | +128.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1556 | +0.045 | +166.07€ | 1 | 7 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 593 | +0.184 | +270.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 593 | +0.184 | +270.47€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 145 | +0.194 | +54.63€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 145 | +0.194 | +54.63€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.179: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.053 n=723 | neutral: IC=-0.004 n=540 | overbought(IBS>0.7): IC=+0.175 n=682
  - _Datos_: n=2082 IC=+0.086 PNL=+434.54€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.117 n=13286 | tras_1loss IC=+0.088 n=8616 | tras_2loss IC=+0.054 n=3515/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1685 IC=+0.026 PNL=+143.63€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1685 IC=+0.026 PNL=+143.63€
...
**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.161 > 0.08 con n=54 PNL=+21.00€
  - _Datos_: n=54 IC=+0.161 PNL=+21.00€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=19641 IC=+0.121 PNL=+5430.04€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=19641 IC=+0.121 PNL=+5430.04€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=518 PNL=+178.97€
  - _Datos_: n=518 IC=+0.160 PNL=+178.97€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.136 > 0.08 con n=273 PNL=+99.77€
  - _Datos_: n=273 IC=+0.136 PNL=+99.77€
