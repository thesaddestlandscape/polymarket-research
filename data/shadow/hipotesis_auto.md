# Hipótesis automáticas — 2026-07-21 03:57 UTC
_Generado por shadow_postmortem.py sobre 25884 resoluciones (PNL=+6332.88€)_
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.222 (n=674)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.177 (n=1960)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.173)

- **PATRÓN** `libro_liquidez` > `4207.6295` → IC=+0.175 (n=1181)
...
| ✅ FAVORITO_CONFIRMADO | 4476 | +0.186 | +69.92€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1568 | +0.183 | -2.22€ | 0 | 0 |
...
| ✅ LATE_WINDOW_5MIN | 101 | +0.112 | +20.79€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 101 | +0.112 | +20.79€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 101 | +0.112 | +20.79€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 101 | +0.112 | +20.79€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.118 n=15611 | tras_1loss IC=+0.090 n=10071 | tras_2loss IC=+0.056 n=4088/40 | gap=+0.062 (umbral 0.05)
...
**🔶 H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.112 n=101) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=101 IC=+0.112 PNL=+20.79€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=23420 IC=+0.119 PNL=+6407.72€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=23420 IC=+0.119 PNL=+6407.72€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.200 > 0.08 con n=255 PNL=+9.60€
  - _Datos_: n=255 IC=+0.200 PNL=+9.60€
