# Hipótesis automáticas — 2026-07-21 17:24 UTC
_Generado por shadow_postmortem.py sobre 27203 resoluciones (PNL=+6234.35€)_
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.106` → IC=+0.143 (n=429)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.169 (n=914)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0073 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.182 (n=485)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.9625` → IC=+0.164 (n=120)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.9625 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.7417` → IC=+0.148 (n=1307)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.7417 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.143` → IC=+0.158 (n=261)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 6.143 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.322 (n=116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.253)

- **PATRÓN** `dist_vwap_pct` > `0.1967` → IC=+0.348 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1967 (IC base=+0.253)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.52` → IC=+0.252 (n=361)
...
- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.209 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `dist_vwap_pct` > `0.3325` → IC=+0.256 (n=84)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3325 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.122` → IC=+0.195 (n=414)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 621 | +0.121 | +11.20€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 621 | +0.121 | +11.20€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 228 | +0.122 | -3.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 228 | +0.122 | -3.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 243 | +0.137 | +2.75€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 243 | +0.137 | +2.75€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 4691 | +0.185 | +75.94€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3059 | +0.217 | +114.45€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1366 | +0.197 | +55.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1019 | +0.212 | +9.29€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1644 | +0.186 | +21.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1013 | +0.227 | +71.35€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 6576 | +0.098 | +2107.43€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 6576 | +0.098 | +2107.43€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1572 | +0.070 | +280.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1572 | +0.070 | +280.64€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1493 | +0.071 | +259.12€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1493 | +0.071 | +259.12€ | 0 | 6 |
| ✅ GBM_LATE_15M#SOL | 1779 | +0.089 | +632.01€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1779 | +0.089 | +632.01€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 1732 | +0.157 | +935.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1732 | +0.157 | +935.66€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3773 | +0.134 | +2032.43€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3773 | +0.134 | +2032.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 960 | +0.097 | +395.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 960 | +0.097 | +395.23€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 982 | +0.093 | +380.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 982 | +0.093 | +380.99€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 958 | +0.104 | +409.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 958 | +0.104 | +409.23€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 873 | +0.252 | +846.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 873 | +0.252 | +846.98€ | 0 | 11 |
...
| ✅ GBM_LATE_15M_TARDIO | 3744 | +0.086 | +1206.08€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3744 | +0.086 | +1206.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 897 | +0.053 | +157.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 897 | +0.053 | +157.96€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 903 | +0.027 | +78.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 903 | +0.027 | +78.47€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 854 | +0.046 | +175.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 854 | +0.046 | +175.64€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1090 | +0.195 | +794.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1090 | +0.195 | +794.01€ | 0 | 13 |
...
| ✅ LATE_WINDOW_5MIN | 225 | -0.020 | -0.21€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 225 | -0.020 | -0.21€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 225 | -0.020 | -0.21€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 225 | -0.020 | -0.21€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1014 | +0.165 | +454.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1014 | +0.165 | +454.82€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 249 | +0.090 | +68.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 249 | +0.090 | +68.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 249 | +0.225 | +190.59€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 249 | +0.225 | +190.59€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.191: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.053 n=945 | neutral: IC=+0.003 n=732 | overbought(IBS>0.7): IC=+0.194 n=946
  - _Datos_: n=2807 IC=+0.096 PNL=+669.24€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.115 n=16263 | tras_1loss IC=+0.082 n=10730 | tras_2loss IC=+0.049 n=4447/40 | gap=+0.066 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.088 n=1196/40 PNL=+255.63€ | H=15h UTC: IC=+0.148 n=1181/40 PNL=+443.93€ | H=17h UTC: IC=+0.100 n=1098/40 PNL=+234.04€ | H=19h UTC: IC=+0.122 n=993/40 PNL=+261.58€
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=225 IC=-0.020 PNL=-0.21€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=225 IC=-0.020 PNL=-0.21€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=24736 IC=+0.113 PNL=+6311.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=24736 IC=+0.113 PNL=+6311.17€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=860 IC=+0.053 PNL=+107.81€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=860 IC=+0.053 PNL=+107.81€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.148 > 0.08 con n=467 PNL=+275.20€
  - _Datos_: n=467 IC=+0.148 PNL=+275.20€
