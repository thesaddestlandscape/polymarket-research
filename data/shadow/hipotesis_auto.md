# Hipótesis automáticas — 2026-07-10 20:00 UTC
_Generado por shadow_postmortem.py sobre 8054 resoluciones (PNL=+1209.55€)_
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.148 (n=106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 11.0 (IC base=+0.033)

- **PATRÓN** `ibs_15` < `0.9183` → IC=+0.136 (n=97)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.68€ cuando `ibs_15` < 0.9183 (IC base=+0.033)

- **PATRÓN** `ibs_15` > `0.8088` → IC=+0.151 (n=64)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` > 0.8088 (IC base=+0.033)
...
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.8088 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.151 n=64). Confirma señal de reversión media → alinear con BUY_NO.
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#ETH#15min` — IC=+0.250 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#SOL#15min` — IC=+0.139 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 151 | +0.193 | -1.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 100 | +0.226 | +0.26€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 51 | +0.217 | +2.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 34 | +0.250 | +2.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 8 | +0.040 | -0.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 8 | +0.080 | +0.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 52 | +0.148 | -4.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 34 | +0.139 | -3.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 8 | +0.000 | -1.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 8 | +0.080 | +0.61€ | 0 | 0 |
| ✅ GBM_LATE_15M | 2978 | +0.114 | +962.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2978 | +0.114 | +962.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 749 | +0.061 | +76.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 749 | +0.061 | +76.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 758 | +0.075 | +121.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 758 | +0.075 | +121.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 768 | +0.149 | +400.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 768 | +0.149 | +400.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 703 | +0.174 | +363.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 703 | +0.174 | +363.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 423 | +0.171 | +183.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 423 | +0.171 | +183.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 104 | +0.198 | +50.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 104 | +0.198 | +50.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 114 | +0.164 | +48.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 114 | +0.164 | +48.20€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 524 | +0.067 | +85.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 524 | +0.067 | +85.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 125 | +0.083 | +10.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 125 | +0.083 | +10.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 132 | +0.007 | +2.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 132 | +0.007 | +2.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 131 | -0.034 | -0.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 131 | -0.034 | -0.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 136 | +0.203 | +73.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 136 | +0.203 | +73.10€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1232 | -0.016 | -6.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 977 | +0.013 | +30.78€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 329 | -0.004 | -8.45€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 251 | +0.034 | +4.43€ | 2 | 7 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.107) — sin ventaja clara. oversold(IBS<0.3): IC=-0.021 n=311 | neutral: IC=-0.061 n=237 | overbought(IBS>0.7): IC=+0.046 n=256
  - _Datos_: n=842 IC=-0.005 PNL=+19.06€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.074 n=4361 | tras_1loss IC=+0.027 n=3520 | tras_2loss IC=-0.011 n=1642/40 | gap=+0.085 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1109 IC=-0.010 PNL=+7.37€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1109 IC=-0.010 PNL=+7.37€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=549 IC=-0.001 PNL=-3.58€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=549 IC=-0.001 PNL=-3.58€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=251 IC=+0.034 PNL=+4.43€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=251 IC=+0.034 PNL=+4.43€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=485 IC=+0.034 PNL=+14.72€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=485 IC=+0.034 PNL=+14.72€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5596 IC=+0.085 PNL=+1285.43€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5596 IC=+0.085 PNL=+1285.43€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=696 IC=-0.033 PNL=-34.05€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=696 IC=-0.033 PNL=-34.05€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.1 con n=205 PNL=+66.67€
  - _Datos_: n=205 IC=+0.162 PNL=+66.67€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=136 IC=+0.051 PNL=+4.17€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=136 IC=+0.051 PNL=+4.17€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.167 > 0.08 con n=145 PNL=+42.67€
  - _Datos_: n=145 IC=+0.167 PNL=+42.67€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 61/80 ops en el filtro definido (IC actual=+0.230 PNL=+20.73€)
  - _Datos_: n=61 IC=+0.230 PNL=+20.73€
