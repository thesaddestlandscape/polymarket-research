# Hipótesis automáticas — 2026-09-21 00:06 UTC
_Generado por shadow_postmortem.py sobre 533511 resoluciones (PNL=+59199.22€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.117 (n=445)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.109 (n=318)
...
- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.141 (n=115)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 96.0 (IC base=+0.040)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.97` → IC=-0.236 (n=6459)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.97
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19383)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.57` → IC=-0.242 (n=881)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.57
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2644)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `493.55` → IC=-0.151 (n=345)
...
- **FILTRO** `restante_s_al_confirmar` < `160.57` → IC=-0.232 (n=1524)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.57
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4572)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.61` → IC=-0.366 (n=1278)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.61
  - _Potencial_: sin este filtro IC_bueno=-0.117 (n=3837)
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.348 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1936)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15643.085` → IC=+0.234 (n=499)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15643.085 (IC base=+0.203)
...
- **PATRÓN** `py_entrada` < `0.44` → IC=+0.149 (n=784)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.335 (n=857)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.243 (n=1381)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.236)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.148 (n=424)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.665` → IC=+0.226 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=696)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.430 (n=583)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3594)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=2559)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.259 (n=640)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.256)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.329 (n=471)
...
- **PATRÓN** `py_entrada` < `0.73` → IC=+0.181 (n=2451)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` < 0.73 (IC base=+0.181)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=2091)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.324 (n=781)
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.192 (n=1762)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.430 (n=501)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2060.1801` → IC=+0.437 (n=473)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.436 (n=185)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.434 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.437)

- **PATRÓN** `libro_liquidez` > `3299.2146` → IC=+0.442 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3299.2146 (IC base=+0.437)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.240 (n=11581)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5745)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.273 (n=1991)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.224)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.187 (n=1984)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 18.0 (IC base=+0.173)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=5680)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=1956)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.253 (n=2579)
...
- **PATRÓN** `lag_apertura_s` < `3.54` → IC=+0.145 (n=2139)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 3.54 (IC base=+0.124)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=2343)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.38 (IC base=+0.116)

- **PATRÓN** `restante_min` < `4.16` → IC=+0.126 (n=2173)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.16 (IC base=+0.116)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.143 (n=2303)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` > 4.96 (IC base=+0.116)

- **PATRÓN** `lag_apertura_s` < `2.35` → IC=+0.145 (n=2178)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 2.35 (IC base=+0.116)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.318 (n=729)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1573.916` → IC=+0.296 (n=1026)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1573.916 (IC base=+0.290)
...
- **PATRÓN** `libro_liquidez` > `4195.4603` → IC=+0.291 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4195.4603 (IC base=+0.274)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.334 (n=347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1467.8527` → IC=+0.312 (n=440)
...
- **PATRÓN** `py_entrada` < `0.935` → IC=+0.441 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.935 (IC base=+0.437)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.444 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.437)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.439 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.437)

- **PATRÓN** `libro_liquidez` > `1834.428` → IC=+0.438 (n=402)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3539` → IC=+0.126 (n=6336)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3539 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9804` → IC=+0.240 (n=2402)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9804 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.7929` → IC=+0.241 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7929 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.6001` → IC=+0.245 (n=2008)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6001 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.919` → IC=+0.174 (n=2779)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 5.919 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.245 (n=1906)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2089 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.0481` → IC=+0.246 (n=864)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0481 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.211 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.9163` → IC=+0.204 (n=3245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9163 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5703` → IC=+0.132 (n=8699)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5703 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5723` → IC=+0.200 (n=604)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5723 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1426` → IC=+0.172 (n=2694)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1426 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7022` → IC=+0.176 (n=1304)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7022 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8705` → IC=+0.175 (n=1976)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8705 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.225 (n=1437)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5845` → IC=+0.202 (n=4406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5845 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.211 (n=4710)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.170 (n=544)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0081 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3404` → IC=+0.169 (n=1633)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3404 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=802)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.272 (n=638)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.063` → IC=+0.275 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.063 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2807` → IC=+0.208 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2807 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.166 (n=1518)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.247 (n=1070)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.290 (n=399)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0604` → IC=+0.297 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0604 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.39` → IC=+0.248 (n=1253)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6427` → IC=+0.256 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6427 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1773.4468` → IC=+0.245 (n=797)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1773.4468 (IC base=+0.234)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.236 (n=544)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.1134` → IC=+0.248 (n=545)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1134 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.225 (n=1238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.211)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.212 (n=1254)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.7274` → IC=+0.245 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7274 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.1883` → IC=+0.212 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1883 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `0.5643` → IC=+0.216 (n=1297)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5643 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.866` → IC=+0.244 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.866 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.2501` → IC=+0.218 (n=1236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2501 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.213 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.0746` → IC=+0.221 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0746 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4033` → IC=+0.224 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4033 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.3839` → IC=+0.214 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3839 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `16439.5247` → IC=+0.225 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16439.5247 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.178 (n=433)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0025 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.161 (n=432)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.168 (n=438)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 18.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.166 (n=1296)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6828 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.6794` → IC=+0.137 (n=221)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.6794 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.1259` → IC=+0.151 (n=1160)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1259 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.289` → IC=+0.160 (n=210)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.289 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.146 (n=1296)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2046 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.6181` → IC=+0.136 (n=1296)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.6181 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1569` → IC=+0.173 (n=347)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1569 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `2.4451` → IC=+0.146 (n=1186)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4451 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.7707` → IC=+0.146 (n=791)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7707 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.144 (n=1102)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 411.0 (IC base=+0.135)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.201 (n=1062)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.3914` → IC=+0.184 (n=1396)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.3914 (IC base=+0.184)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.265 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.577` → IC=+0.238 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.577 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` < `0.2142` → IC=+0.188 (n=1573)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2142 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.3675` → IC=+0.192 (n=206)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.3675 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` > `2.9269` → IC=+0.205 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9269 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1055)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.223 (n=1355)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.221 (n=1209)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0065 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.256 (n=452)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.3822` → IC=+0.232 (n=1190)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3822 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.543` → IC=+0.238 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.543 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.393` → IC=+0.219 (n=1479)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.393 (IC base=+0.218)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8378` → IC=+0.208 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8378 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2814` → IC=+0.227 (n=816)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2814 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1861.22` → IC=+0.229 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1861.22 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.227 (n=795)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2000)

- **PATRÓN** `ibs_20min` > `0.94` → IC=+0.200 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.94 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.3482` → IC=+0.349 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3482 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` < `0.682` → IC=+0.328 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.682 (IC base=+0.020)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.632` → IC=+0.150 (n=633)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 4.632 (IC base=+0.020)

- **PATRÓN** `volumen_regimen` < `0.8497` → IC=+0.337 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8497 (IC base=+0.020)

- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.323 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1808 (IC base=+0.020)

- **PATRÓN** `volumen_pendiente_norm` < `0.167` → IC=+0.325 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.167 (IC base=+0.020)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.348 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.020)

- **PATRÓN** `volumen_spike_ratio` < `1.3975` → IC=+0.349 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3975 (IC base=+0.020)

- **PATRÓN** `volumen_spike_ratio` > `2.1835` → IC=+0.332 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1835 (IC base=+0.020)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.341 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 165.0 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.3142` → IC=+0.170 (n=228)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3142 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` < `0.856` → IC=+0.153 (n=479)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.177 (n=593)
...
- **FILTRO** `hora_utc` < `17.0` → IC=-0.155 (n=56)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.094 (n=291)

- **FILTRO** `ibs_20min` < `0.2647` → IC=-0.193 (n=86)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2647
  - _Potencial_: sin este filtro IC_bueno=+0.135 (n=261)

- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=1982)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=983)

- **FILTRO** `sigma_ewma_delta_pct` > `8.635` → IC=-0.201 (n=322)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.635
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2643)

- **PATRÓN** `drift_60min` |x|≤ `0.1646` → IC=+0.163 (n=87)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.1646 (IC base=+0.053)

- **PATRÓN** `ibs_20min` > `0.7647` → IC=+0.233 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7647 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `1.6268` → IC=+0.342 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6268 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` < `0.5528` → IC=+0.272 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5528 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` < `0.6466` → IC=+0.266 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6466 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` > `1.1487` → IC=+0.333 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1487 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` < `0.0729` → IC=+0.316 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0729 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` < `2.2644` → IC=+0.304 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2644 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `1.5596` → IC=+0.263 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5596 (IC base=+0.053)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.304 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 48.0 (IC base=+0.053)

- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.124 (n=983)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.197 (n=394)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1623)

- **FILTRO** `ibs_20min` > `0.7734` → IC=-0.200 (n=749)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7734
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2249)
...
- **PATRÓN** `dist_vwap_pct` > `0.9919` → IC=+0.316 (n=85)
...
- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.299 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.1054` → IC=+0.283 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1054 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `2.2099` → IC=+0.258 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2099 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.248 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.191 (n=2990)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.468` → IC=+0.185 (n=8012)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.468 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `1.0151` → IC=+0.292 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0151 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.55` → IC=+0.152 (n=4262)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.55 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1724` → IC=+0.231 (n=3138)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1724 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.682` → IC=+0.241 (n=2803)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.682 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2993` → IC=+0.259 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2993 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4758` → IC=+0.243 (n=1698)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4758 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.7144` → IC=+0.241 (n=1698)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7144 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.270 (n=4607)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.147 (n=3031)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0088 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.5512` → IC=+0.150 (n=7992)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5512 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` > `0.6795` → IC=+0.241 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6795 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.1712` → IC=+0.235 (n=2349)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1712 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` < `0.7171` → IC=+0.237 (n=1143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7171 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.2011` → IC=+0.245 (n=865)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4913` → IC=+0.253 (n=1128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4913 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.3584` → IC=+0.261 (n=1535)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3584 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.264 (n=3255)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 81.0 (IC base=+0.071)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `2.676` → IC=-0.147 (n=647)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.676
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=1457)

- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.268 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8935 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.29` → IC=+0.162 (n=852)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 3.29 (IC base=+0.047)

- **PATRÓN** `volumen_pendiente_norm` > `0.2229` → IC=+0.274 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2229 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `1.4428` → IC=+0.188 (n=254)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.4428 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` > `2.1741` → IC=+0.195 (n=345)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.1741 (IC base=+0.047)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.186 (n=323)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 15.0 (IC base=+0.047)
...
- **FILTRO** `ibs_20min` > `0.8168` → IC=-0.147 (n=655)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8168
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1969)

- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.153 (n=604)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.86 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.2955` → IC=+0.156 (n=321)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2955 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `1.195` → IC=+0.141 (n=815)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.195 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` > `0.6602` → IC=+0.148 (n=728)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6602 (IC base=+0.019)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.193 (n=265)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.187 (n=346)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 249.0 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.6013` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6013 (IC base=+0.000)

- **PATRÓN** `dist_vwap_pct` < `0.1524` → IC=+0.210 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1524 (IC base=+0.000)

- **PATRÓN** `volumen_regimen` > `0.6047` → IC=+0.205 (n=487)
...
- **FILTRO** `ibs_20min` < `0.2701` → IC=-0.198 (n=431)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2701
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=1294)

- **FILTRO** `ibs_20min` > `0.7865` → IC=-0.177 (n=536)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7865
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1610)

- **PATRÓN** `ibs_20min` > `0.8048` → IC=+0.155 (n=587)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.8048 (IC base=+0.005)

- **PATRÓN** `dist_vwap_pct` > `0.4461` → IC=+0.229 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4461 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` < `0.9704` → IC=+0.233 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9704 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `0.6433` → IC=+0.208 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6433 (IC base=+0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.2662` → IC=+0.300 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2662 (IC base=+0.005)

- **PATRÓN** `volumen_spike_ratio` < `2.0961` → IC=+0.247 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0961 (IC base=+0.005)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.268 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.005)

- **PATRÓN** `dist_vwap_pct` > `0.1468` → IC=+0.206 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1468 (IC base=-0.009)

- **PATRÓN** `dist_vwap_pct` < `0.4933` → IC=+0.181 (n=365)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.4933 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` < `1.1531` → IC=+0.190 (n=340)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 1.1531 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` > `0.6712` → IC=+0.187 (n=340)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.6712 (IC base=-0.009)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8269` → IC=+0.226 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8269 (IC base=-0.009)

- **PATRÓN** `volumen_spike_ratio` > `2.1439` → IC=+0.266 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1439 (IC base=-0.009)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.236 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.009)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7049` → IC=-0.205 (n=955)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7049
  - _Potencial_: sin este filtro IC_bueno=+0.270 (n=956)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.231 (n=500)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1508)

- **FILTRO** `sigma_ewma_delta_pct` > `4.678` → IC=-0.175 (n=447)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.678
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=1561)

- **PATRÓN** `ibs_20min` > `0.7049` → IC=+0.270 (n=956)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7049 (IC base=+0.033)

- **PATRÓN** `dist_vwap_pct` > `0.8223` → IC=+0.344 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8223 (IC base=+0.033)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.564` → IC=+0.154 (n=299)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 9.564 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.297 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` > `0.6364` → IC=+0.288 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6364 (IC base=+0.033)

- **PATRÓN** `volumen_pendiente_norm` < `0.1049` → IC=+0.289 (n=638)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7985` → IC=+0.305 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7985 (IC base=+0.033)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.316 (n=579)
...
- **PATRÓN** `dist_vwap_pct` < `0.201` → IC=+0.221 (n=413)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.201 (IC base=+0.011)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.07` → IC=+0.199 (n=184)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.07 (IC base=+0.011)

- **PATRÓN** `volumen_spike_ratio` < `2.5185` → IC=+0.221 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5185 (IC base=+0.011)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.232 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.011)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.016` → IC=+0.319 (n=781)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.346 (n=784)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.274)

- **PATRÓN** `dist_vwap_pct` > `0.1916` → IC=+0.314 (n=677)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1916 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.483` → IC=+0.300 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.483 (IC base=+0.274)

- **PATRÓN** `volumen_regimen` > `1.0343` → IC=+0.305 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0343 (IC base=+0.274)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.311 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` < `1.4407` → IC=+0.279 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4407 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` > `2.5353` → IC=+0.292 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5353 (IC base=+0.274)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.278 (n=1233)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.274)

- **PATRÓN** `libro_liquidez` > `2598.9768` → IC=+0.288 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2598.9768 (IC base=+0.274)

- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.298 (n=864)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3962` → IC=+0.305 (n=1293)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3962 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.5401` → IC=+0.286 (n=367)
...
- **PATRÓN** `volumen_regimen` < `0.6405` → IC=+0.271 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6405 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `1.2432` → IC=+0.311 (n=431)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5387` → IC=+0.266 (n=1128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5387 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1751` → IC=+0.272 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1751 (IC base=+0.271)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.273 (n=847)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.271)

- **PATRÓN** `libro_liquidez` > `2582.5802` → IC=+0.278 (n=862)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2582.5802 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.171 (n=2362)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.201 (n=2355)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0884` → IC=+0.186 (n=2356)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.581` → IC=+0.217 (n=7065)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.581 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1692` → IC=+0.194 (n=3078)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1692 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.217` → IC=+0.256 (n=1451)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.217 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.212` → IC=+0.160 (n=4671)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.212 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6255` → IC=+0.157 (n=4671)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6255 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.192 (n=1416)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5656` → IC=+0.171 (n=2970)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5656 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6489` → IC=+0.174 (n=2249)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6489 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2373.5848` → IC=+0.167 (n=4709)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2373.5848 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=5977)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.183 (n=4503)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.203 (n=2248)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0794 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.208 (n=2297)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.4754` → IC=+0.226 (n=6742)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4754 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2251` → IC=+0.159 (n=4931)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2251 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.200 (n=1141)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1777` → IC=+0.151 (n=4916)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1777 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6254` → IC=+0.145 (n=4917)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6254 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.226 (n=969)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5745` → IC=+0.167 (n=2673)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5745 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6497` → IC=+0.175 (n=2025)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6497 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `119.0` → IC=+0.172 (n=5702)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 119.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.221 (n=406)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.183)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.188 (n=405)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0083 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.3361` → IC=+0.206 (n=1216)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3361 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.200 (n=595)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.304 (n=599)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.067` → IC=+0.306 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.067 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2291` → IC=+0.239 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2291 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `1.4343` → IC=+0.182 (n=1116)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1824` → IC=+0.293 (n=569)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.265 (n=853)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3443 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.044` → IC=+0.253 (n=929)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.044 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0955` → IC=+0.233 (n=702)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6455` → IC=+0.244 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6455 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1781.58` → IC=+0.251 (n=569)
...
- **PATRÓN** `drift_60min` |x|≤ `0.098` → IC=+0.199 (n=459)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.098 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.184 (n=1044)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 6.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4147` → IC=+0.226 (n=1043)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4147 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.1998` → IC=+0.211 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1998 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.501` → IC=+0.229 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.501 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `0.6846` → IC=+0.179 (n=459)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6846 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2334` → IC=+0.193 (n=229)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2334 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `1.4144` → IC=+0.202 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4144 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `15748.8418` → IC=+0.172 (n=473)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 15748.8418 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.194 (n=384)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0025 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.2871` → IC=+0.154 (n=1147)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.2871 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=395)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` < `0.5527` → IC=+0.183 (n=1147)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5527 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1307` → IC=+0.160 (n=1152)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1307 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.831` → IC=+0.212 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.831 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.155 (n=1147)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.2089 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.1575` → IC=+0.156 (n=353)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1575 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.4465` → IC=+0.147 (n=1037)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4465 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.150 (n=321)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 221.0 (IC base=+0.137)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.216 (n=786)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.2067` → IC=+0.216 (n=786)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `drift_60min` |x|≤ `0.4315` → IC=+0.163 (n=1122)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4315 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.163 (n=1126)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3938` → IC=+0.202 (n=1122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3938 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1514` → IC=+0.183 (n=752)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1514 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.953` → IC=+0.244 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.953 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.0478` → IC=+0.155 (n=987)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.0478 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `0.6345` → IC=+0.150 (n=1122)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6345 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2911` → IC=+0.220 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2911 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `1.4216` → IC=+0.160 (n=366)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.4216 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.5308` → IC=+0.174 (n=366)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.5308 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `6834.4767` → IC=+0.185 (n=748)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6834.4767 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.150 (n=1058)
...
- **PATRÓN** `sigma_h` > `0.01` → IC=+0.162 (n=583)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.203 (n=1284)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5156 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `1.0691` → IC=+0.217 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0691 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.563` → IC=+0.250 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.563 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.127 (n=1286)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2233 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` < `0.1666` → IC=+0.130 (n=1281)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1666 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `1.8138` → IC=+0.135 (n=825)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.8138 (IC base=+0.116)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1338)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2877.6891` → IC=+0.196 (n=583)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2877.6891 (IC base=+0.116)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.134 (n=957)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1027` → IC=+0.141 (n=435)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1027 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1328)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.206 (n=1304)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5625 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.9641` → IC=+0.143 (n=169)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9641 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.1948` → IC=+0.134 (n=1192)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1948 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.408` → IC=+0.157 (n=272)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.408 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.041` → IC=+0.120 (n=1146)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.041 (IC base=+0.111)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4585` → IC=+0.139 (n=386)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4585 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.1743` → IC=+0.126 (n=525)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.1743 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.206 (n=815)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.1691` → IC=+0.200 (n=538)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7321` → IC=+0.255 (n=1093)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7321 (IC base=+0.196)

- **PATRÓN** `dist_vwap_pct` > `1.2278` → IC=+0.222 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2278 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.415` → IC=+0.241 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.415 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` < `1.2075` → IC=+0.199 (n=1223)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.2075 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `0.8586` → IC=+0.215 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8586 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` > `0.2353` → IC=+0.272 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2353 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `2.1694` → IC=+0.206 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1694 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `1.8094` → IC=+0.203 (n=785)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8094 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.197 (n=1279)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `2587.1246` → IC=+0.197 (n=815)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2587.1246 (IC base=+0.196)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.217 (n=429)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4412` → IC=+0.245 (n=1286)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4412 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.1172` → IC=+0.232 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1172 (IC base=+0.204)
...
- **PATRÓN** `volumen_regimen` > `0.6295` → IC=+0.217 (n=1286)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2444` → IC=+0.195 (n=1009)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1344` → IC=+0.154 (n=730)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4` → IC=+0.180 (n=1659)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.4 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.8238` → IC=+0.189 (n=249)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.8238 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.719` → IC=+0.176 (n=772)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.719 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.8709` → IC=+0.164 (n=958)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8709 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `1.2036` → IC=+0.151 (n=480)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2036 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.1642` → IC=+0.175 (n=459)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1642 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.157 (n=531)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `2.5596` → IC=+0.175 (n=531)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.5596 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=1863)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `2477.0811` → IC=+0.149 (n=1483)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2477.0811 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.165 (n=1439)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 165.0 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.127 (n=1164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6549` → IC=+0.134 (n=1746)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.6549 (IC base=+0.101)

- **PATRÓN** `volumen_pendiente_norm` > `0.1665` → IC=+0.126 (n=442)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.1665 (IC base=+0.101)

- **PATRÓN** `volumen_spike_ratio` < `2.2445` → IC=+0.120 (n=1476)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 2.2445 (IC base=+0.101)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3431` → IC=+0.130 (n=409)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.3431 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.144 (n=372)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 9.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` > `0.6726` → IC=+0.184 (n=273)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.6726 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.2846` → IC=+0.160 (n=142)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.2846 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.333` → IC=+0.134 (n=184)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.333 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `0.6134` → IC=+0.147 (n=137)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6134 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `14590.6209` → IC=+0.144 (n=273)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 14590.6209 (IC base=+0.107)
...
- **PATRÓN** `ibs_20min` > `0.4251` → IC=+0.244 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4251 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.367` → IC=+0.252 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.367 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.043` → IC=+0.241 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.043 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `0.8399` → IC=+0.214 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8399 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `1.1573` → IC=+0.212 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1573 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2535` → IC=+0.319 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2535 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `1.3759` → IC=+0.233 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3759 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `2.391` → IC=+0.270 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.391 (IC base=+0.203)

- **PATRÓN** `ibs_20min` < `0.0699` → IC=+0.169 (n=149)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.0699 (IC base=+0.075)

- **PATRÓN** `volumen_pendiente_norm` > `0.1657` → IC=+0.120 (n=106)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_pendiente_norm` > 0.1657 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.140 (n=245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0069 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.147 (n=344)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 8.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.242 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.8398` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8398 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.328` → IC=+0.193 (n=174)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 5.328 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.0652` → IC=+0.131 (n=323)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0652 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` > `0.7177` → IC=+0.127 (n=328)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.7177 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.2903` → IC=+0.204 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2903 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.2151` → IC=+0.150 (n=158)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 2.2151 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3064.7088` → IC=+0.204 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3064.7088 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.158 (n=115)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 21.0 (IC base=+0.111)
...
- **PATRÓN** `ibs_20min` > `0.759` → IC=+0.208 (n=118)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.198 (n=2997)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0109 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=9417)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=8995)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9062` → IC=+0.197 (n=1231)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.9062 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.602` → IC=+0.225 (n=4385)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.602 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8808` → IC=+0.165 (n=4010)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8808 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2405` → IC=+0.195 (n=1675)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2405 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6244` → IC=+0.187 (n=2870)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6244 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2324.2036` → IC=+0.168 (n=5992)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2324.2036 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6707)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.191 (n=5449)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0069 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.144` → IC=+0.186 (n=3592)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.144 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5647` → IC=+0.238 (n=8164)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5647 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2375` → IC=+0.161 (n=5091)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2375 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.895` → IC=+0.202 (n=1154)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.895 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.699` → IC=+0.182 (n=7916)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.699 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7051` → IC=+0.159 (n=2487)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7051 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2031` → IC=+0.153 (n=1884)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2031 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.289` → IC=+0.248 (n=1069)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.289 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.2929` → IC=+0.190 (n=3366)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2929 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.196 (n=2470)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.211 (n=1021)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.3419` → IC=+0.193 (n=1531)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.3419 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.196 (n=748)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3451` → IC=+0.289 (n=1027)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3451 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.424` → IC=+0.265 (n=1234)
...
- **PATRÓN** `ibs_20min` > `0.3107` → IC=+0.200 (n=1434)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3107 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.1243` → IC=+0.181 (n=810)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1243 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.755` → IC=+0.166 (n=330)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 9.755 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.279` → IC=+0.150 (n=1287)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.279 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.6267` → IC=+0.180 (n=479)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6267 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` > `0.6721` → IC=+0.255 (n=1292)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6721 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.736` → IC=+0.290 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.736 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.2161` → IC=+0.222 (n=1415)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2161 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.9133` → IC=+0.246 (n=621)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9133 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.227 (n=957)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1932.8384` → IC=+0.223 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1932.8384 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.241 (n=1345)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.242 (n=899)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1569` → IC=+0.239 (n=592)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1569 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.266 (n=516)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.3651` → IC=+0.269 (n=1184)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3651 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.756` → IC=+0.280 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.756 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` > `0.3534` → IC=+0.299 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3534 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.7926` → IC=+0.233 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7926 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.2358` → IC=+0.236 (n=813)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2358 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.251 (n=842)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1862.8007` → IC=+0.250 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1862.8007 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.243 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 32.0 (IC base=+0.237)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.182 (n=513)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0034 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4327` → IC=+0.143 (n=1534)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4327 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8799` → IC=+0.261 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8799 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3604` → IC=+0.171 (n=608)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3604 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.205` → IC=+0.160 (n=639)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.205 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.877` → IC=+0.161 (n=1023)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.877 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2791` → IC=+0.235 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2791 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5223` → IC=+0.153 (n=652)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.5223 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.1374` → IC=+0.150 (n=672)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 2.1374 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8151.5866` → IC=+0.231 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8151.5866 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.154 (n=472)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 81.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.156 (n=1246)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0075 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4369` → IC=+0.150 (n=1246)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6915` → IC=+0.188 (n=1246)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.6915 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.3621` → IC=+0.141 (n=1245)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3621 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.031` → IC=+0.197 (n=186)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 11.031 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.6969` → IC=+0.144 (n=548)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6969 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1836` → IC=+0.145 (n=415)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.1836 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4415` → IC=+0.152 (n=1175)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4415 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `11008.1959` → IC=+0.207 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11008.1959 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `183.0` → IC=+0.142 (n=1167)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 183.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.133 (n=1016)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4695` → IC=+0.186 (n=1524)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4695 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `1.0486` → IC=+0.199 (n=290)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 1.0486 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.228 (n=579)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.403 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.121 (n=1527)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.02 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2900.261` → IC=+0.243 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2900.261 (IC base=+0.105)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.128 (n=1162)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 54.0 (IC base=+0.105)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.176 (n=501)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1553)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1496)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2146` → IC=+0.128 (n=1209)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2146 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.125 (n=1445)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.437 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.154 (n=659)
...
- **PATRÓN** `volumen_spike_ratio` < `1.457` → IC=+0.141 (n=446)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.457 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.2089` → IC=+0.122 (n=606)
...
- **PATRÓN** `sigma_h` > `0.0187` → IC=+0.212 (n=1015)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5111` → IC=+0.243 (n=1523)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5111 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.189` → IC=+0.225 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.189 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.486` → IC=+0.247 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.486 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.0709` → IC=+0.204 (n=1340)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0709 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6344` → IC=+0.209 (n=1523)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6344 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.236` → IC=+0.237 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.236 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `2.5313` → IC=+0.233 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5313 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=1572)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2591.5202` → IC=+0.209 (n=1015)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2591.5202 (IC base=+0.203)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.233 (n=555)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5207` → IC=+0.257 (n=1663)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5207 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `1.1317` → IC=+0.202 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1317 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.844` → IC=+0.204 (n=1855)
...
- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.239 (n=554)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2213` → IC=+0.197 (n=1303)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2213 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.201 (n=1480)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4437 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.211 (n=1038)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2568.3954` → IC=+0.202 (n=1108)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2568.3954 (IC base=+0.201)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.134 (n=2792)

- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.157 (n=2703)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0112 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5212` → IC=+0.160 (n=2703)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.5212 (IC base=+0.150)
...
- **PATRÓN** `ibs_20min` > `0.9387` → IC=+0.210 (n=901)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9387 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1887` → IC=+0.162 (n=950)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1887 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.152` → IC=+0.179 (n=443)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 10.152 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.9039` → IC=+0.162 (n=1130)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.9039 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1731` → IC=+0.183 (n=739)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1731 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.4592` → IC=+0.155 (n=891)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4592 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8934` → IC=+0.162 (n=1782)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8934 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=1787)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3624.8897` → IC=+0.155 (n=1802)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3624.8897 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.192 (n=705)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0037 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.477` → IC=+0.153 (n=2106)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.477 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` < `0.1762` → IC=+0.161 (n=927)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1762 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.6915` → IC=+0.142 (n=397)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6915 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.2426` → IC=+0.126 (n=1881)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.2426 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.241` → IC=+0.140 (n=2092)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.241 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.9017` → IC=+0.148 (n=1338)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.9017 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.146 (n=991)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.5338` → IC=+0.137 (n=918)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.5338 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.8163` → IC=+0.141 (n=1390)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8163 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2792)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7421.473` → IC=+0.145 (n=1881)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 7421.473 (IC base=+0.132)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.139 (n=618)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0047 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4924` → IC=+0.165 (n=691)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.4924 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` > `0.0983` → IC=+0.152 (n=690)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.0983 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6442` → IC=+0.165 (n=162)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.6442 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.3871` → IC=+0.141 (n=692)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3871 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.906` → IC=+0.154 (n=154)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 8.906 (IC base=+0.139)
...
- **PATRÓN** `volumen_regimen` < `1.0958` → IC=+0.149 (n=608)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.0958 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.7253` → IC=+0.145 (n=617)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.7253 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.177 (n=298)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.183` → IC=+0.150 (n=596)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.183 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.7724` → IC=+0.159 (n=452)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7724 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` > `0.9919` → IC=+0.167 (n=52)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.9919 (IC base=+0.046)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.42` → IC=+0.143 (n=82)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 2.42 (IC base=+0.046)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.046)

- **PATRÓN** `ibs_20min` < `0.0556` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.0556 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` > `0.6223` → IC=+0.162 (n=69)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.6223 (IC base=+0.048)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.215 (n=346)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0039 (IC base=+0.103)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=815)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 6.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.5845` → IC=+0.198 (n=693)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5845 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.1931` → IC=+0.163 (n=345)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1931 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.488` → IC=+0.213 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.488 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.2853` → IC=+0.203 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2853 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` < `2.1127` → IC=+0.156 (n=513)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1127 (IC base=+0.103)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=564)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `2435.8886` → IC=+0.152 (n=303)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.176 (n=270)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0059 (IC base=+0.108)

- **PATRÓN** `ibs_20min` > `0.5781` → IC=+0.200 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5781 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `0.1288` → IC=+0.172 (n=123)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1288 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `1.0529` → IC=+0.132 (n=210)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0529 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.148 (n=177)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.0677 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` > `0.2602` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.2602 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.195 (n=175)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.108)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.122 (n=244)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `3454.4813` → IC=+0.125 (n=150)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 3454.4813 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.181 (n=180)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.005 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.150 (n=241)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 8.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.5578` → IC=+0.226 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5578 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.5424` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5424 (IC base=+0.120)
...
- **PATRÓN** `volumen_regimen` < `0.8141` → IC=+0.148 (n=160)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8141 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` > `0.6338` → IC=+0.148 (n=214)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6338 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.3066` → IC=+0.281 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3066 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` < `1.7617` → IC=+0.172 (n=126)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.7617 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.4015` → IC=+0.154 (n=189)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4015 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.143 (n=253)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `1103.6894` → IC=+0.174 (n=210)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.122 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.006 (IC base=+0.076)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.141 (n=165)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 14.0 (IC base=+0.076)

- **PATRÓN** `ibs_20min` > `0.6316` → IC=+0.165 (n=216)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.6316 (IC base=+0.076)

- **PATRÓN** `dist_vwap_pct` > `0.1948` → IC=+0.143 (n=124)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.1948 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.231` → IC=+0.222 (n=88)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0856` → IC=+0.192 (n=89)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.0856 (IC base=+0.076)
...
- **FILTRO** `hora_utc` > `10.0` → IC=-0.129 (n=33)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 10.0
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7219)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3039)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9510)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=3167)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9837)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.219 (n=518)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1641)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.170 (n=544)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1777)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.122 (n=1301)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.203 (n=546)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1648)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.200 (n=575)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1737)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.164 (n=566)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1746)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.475` → IC=-0.190 (n=530)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1604)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.189 (n=554)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1760)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2607)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2744)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2750)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=713)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=20152)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.277 (n=6996)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=22048)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.235 (n=7258)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21786)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9813)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19231)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9052)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=27293)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=9081)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27264)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=1133)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3620)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.255 (n=1568)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3185)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.179 (n=1143)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3610)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.152 (n=4215)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=2059)

- **FILTRO** `drift_7min_pct` |x|> `0.1116` → IC=-0.127 (n=2132)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1116
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4142)

- **FILTRO** `ibs_7min` > `0.7937` → IC=-0.206 (n=1568)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7937
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4706)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=1219)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3822)

- **FILTRO** `ibs_7min` < `0.7519` → IC=-0.189 (n=1260)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7519
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3781)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1258)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3783)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.256 (n=1254)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3847)

- **FILTRO** `ibs_7min` > `0.2588` → IC=-0.171 (n=1273)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2588
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3828)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1270)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.173 (n=1097)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3398)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.309 (n=1090)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3405)

- **FILTRO** `ibs_7min` < `0.1971` → IC=-0.257 (n=1123)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1971
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3372)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1090)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3405)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1551)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5109)

- **FILTRO** `ibs_7min` > `0.759` → IC=-0.177 (n=1663)

  - _Acción_: SKIP cuando `ibs_7min` > 0.759
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=4997)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.246 (n=1170)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3602)

- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.181 (n=1193)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3579)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.179 (n=1161)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3611)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1220)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3676)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.173 (n=1223)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3673)

- **FILTRO** `ballena_activa_n` > `29.0` → IC=-0.188 (n=1221)

  - _Acción_: SKIP cuando `ballena_activa_n` > 29.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3675)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.264 (n=1199)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=3927)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.229 (n=1280)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3846)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1666)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5224)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=1127)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3730)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.231 (n=1213)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3644)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1170)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3687)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1615)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4909)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2653)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1363)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=1371)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0042` → IC=+0.188 (n=460)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0042 (IC base=+0.186)

- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.219 (n=625)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0081 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.162` → IC=+0.194 (n=1212)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.162 (IC base=+0.186)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2178` → IC=+0.188 (n=459)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.2178 (IC base=+0.186)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1315` → IC=+0.234 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1315 (IC base=+0.186)
...
- **PATRÓN** `ibs_15` > `0.6129` → IC=+0.261 (n=1378)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6129 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.4463` → IC=+0.186 (n=326)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4463 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.5648` → IC=+0.175 (n=1356)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.5648 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.106` → IC=+0.272 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.106 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `2964.3096` → IC=+0.194 (n=918)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2964.3096 (IC base=+0.186)

### UPDOWN_GBM#60min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=468)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.164 (n=108)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0034 (IC base=+0.140)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0692` → IC=+0.167 (n=142)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0692 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.159 (n=215)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.79€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=+0.140)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.145 (n=122)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 5.0 (IC base=+0.140)

- **PATRÓN** `ibs_15` > `0.6213` → IC=+0.222 (n=322)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6213 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1542` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1542 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.619` → IC=+0.218 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.619 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9475.4181` → IC=+0.149 (n=146)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 9475.4181 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0235` → IC=+0.248 (n=125)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0235 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.085` → IC=+0.195 (n=165)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.085 (IC base=+0.180)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0626` → IC=+0.188 (n=335)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.0626 (IC base=+0.180)
...
- **PATRÓN** `ibs_15` > `0.5429` → IC=+0.274 (n=374)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5429 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` > `0.1228` → IC=+0.197 (n=226)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1228 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.6263` → IC=+0.184 (n=435)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.6263 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.006` → IC=+0.229 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.006 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.489` → IC=+0.179 (n=335)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 7.489 (IC base=+0.180)

- **PATRÓN** `libro_liquidez` > `2842.2496` → IC=+0.264 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2842.2496 (IC base=+0.180)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.165 (n=416)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.1176 (IC base=+0.046)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.382 (n=167)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.342)

- **PATRÓN** `drift_60min` |x|≤ `0.1089` → IC=+0.355 (n=246)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1089 (IC base=+0.342)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1476` → IC=+0.363 (n=246)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1476 (IC base=+0.342)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1332` → IC=+0.398 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1332 (IC base=+0.342)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.363 (n=370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.342)

- **PATRÓN** `ibs_15` > `0.7853` → IC=+0.384 (n=369)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7853 (IC base=+0.342)

- **PATRÓN** `dist_vwap_pct` > `0.4264` → IC=+0.383 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4264 (IC base=+0.342)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.117` → IC=+0.351 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.117 (IC base=+0.342)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.348 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.342)

- **PATRÓN** `libro_liquidez` > `3480.6224` → IC=+0.357 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3480.6224 (IC base=+0.342)

- **PATRÓN** `ballena_activa_n` < `475.0` → IC=+0.366 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 475.0 (IC base=+0.342)
...
- **FILTRO** `sigma_h` > `0.0129` → IC=-0.212 (n=596)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0129
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1790)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.188 (n=771)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1615)

- **FILTRO** `libro_liquidez` < `3905.3214` → IC=-0.133 (n=1574)

  - _Acción_: SKIP cuando `libro_liquidez` < 3905.3214
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=812)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1175` → IC=+0.238 (n=965)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1175 (IC base=-0.039)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1786` → IC=+0.239 (n=927)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1786 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.280 (n=1444)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3557 (IC base=-0.039)

- **PATRÓN** `dist_vwap_pct` > `0.8709` → IC=+0.274 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8709 (IC base=-0.039)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.217 (n=359)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1081)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.225 (n=475)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.184 (n=965)
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.708` → IC=-0.243 (n=255)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1185)
...
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.238 (n=587)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7722` → IC=+0.232 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7722 (IC base=+0.225)
...
- **PATRÓN** `ibs_15` < `0.273` → IC=+0.278 (n=517)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.262` → IC=+0.229 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.262 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3499.1712` → IC=+0.227 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3499.1712 (IC base=+0.225)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.012` → IC=-0.130 (n=298)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2399)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0746` → IC=+0.215 (n=240)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0746 (IC base=-0.045)

- **PATRÓN** `ibs_15` < `0.3636` → IC=+0.257 (n=269)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3636 (IC base=-0.045)

- **PATRÓN** `dist_vwap_pct` > `0.6912` → IC=+0.200 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6912 (IC base=-0.045)
...
- **FILTRO** `sigma_h` > `0.0196` → IC=-0.264 (n=358)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.262 (n=179)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.169 (n=539)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6129 sube el IC de +0.186 a +0.261 en UPDOWN_GBM#15min (n=1378). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6213 sube el IC de +0.140 a +0.222 en UPDOWN_GBM#ETH#15min (n=322). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5429 sube el IC de +0.180 a +0.274 en UPDOWN_GBM#XRP#15min (n=374). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.046 a +0.165 en UPDOWN_GBM#XRP#15min (n=416). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0.039 a +0.280 en UPDOWN_GBM_15M_TARDIO (n=1444). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7413 sube el IC de +0.086 a +0.330 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=151). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.273 sube el IC de +0.225 a +0.278 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=517). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3636 sube el IC de -0.045 a +0.257 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=269). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7853 sube el IC de +0.342 a +0.384 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=369). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1230 | +0.090 | +154.22€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1230 | +0.090 | +154.22€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 902 | +0.100 | +130.87€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 902 | +0.100 | +130.87€ | 2 | 8 |
...
| ✅ BALLENAS_TARDIAS | 23109 | -0.092 | -3082.12€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 