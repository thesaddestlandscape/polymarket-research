# Hipótesis automáticas — 2026-09-21 08:43 UTC
_Generado por shadow_postmortem.py sobre 539186 resoluciones (PNL=+60170.52€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.249 (n=480)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.249 (n=480)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=547)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `2893.2785` → IC=+0.139 (n=341)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2893.2785 (IC base=+0.130)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.256 (n=379)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.256 (n=379)
...
- **PATRÓN** `banda_hit_calibrado` > `0.802` → IC=+0.267 (n=273)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.802 (IC base=+0.139)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=462)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.21` → IC=-0.235 (n=6512)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.21
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19538)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.43` → IC=-0.239 (n=886)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.43
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2661)
...
- **FILTRO** `restante_s_al_confirmar` < `134.15` → IC=-0.277 (n=782)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.15
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2349)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `160.9` → IC=-0.232 (n=1535)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.9
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4608)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.81` → IC=-0.364 (n=1290)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.81
  - _Potencial_: sin este filtro IC_bueno=-0.119 (n=3873)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.199 (n=13086)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3275)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5499.62` → IC=+0.173 (n=2083)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5499.62 (IC base=+0.100)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=2609)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.144 (n=2236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.243 (n=1390)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.140 (n=614)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1297.6972` → IC=+0.145 (n=610)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=10482)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=10069)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3616)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2457)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.73` → IC=+0.178 (n=2418)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.261 (n=664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=2526)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.181)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.186 (n=2418)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.249 (n=2246)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=5741)
...
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=4791)
...
- **PATRÓN** `restante_min` > `4.95` → IC=+0.143 (n=4586)
...
- **PATRÓN** `lag_apertura_s` < `3.52` → IC=+0.145 (n=2159)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 3.52 (IC base=+0.124)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.198 (n=2374)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.38 (IC base=+0.116)

- **PATRÓN** `restante_min` < `4.16` → IC=+0.127 (n=2194)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.16 (IC base=+0.116)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.141 (n=2331)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` > 4.96 (IC base=+0.116)

- **PATRÓN** `lag_apertura_s` < `2.34` → IC=+0.144 (n=2195)
...
- **PATRÓN** `libro_liquidez` > `1570.4643` → IC=+0.296 (n=1035)
...
- **PATRÓN** `libro_liquidez` > `4195.4603` → IC=+0.293 (n=307)
...
- **PATRÓN** `libro_liquidez` > `1466.3152` → IC=+0.314 (n=444)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3553` → IC=+0.125 (n=6414)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3553 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.9808` → IC=+0.241 (n=2431)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9808 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.7872` → IC=+0.243 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7872 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` < `0.5957` → IC=+0.246 (n=2042)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5957 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.931` → IC=+0.177 (n=2810)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.931 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.244 (n=1940)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2145 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` > `1.0517` → IC=+0.249 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0517 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.3077` → IC=+0.212 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3077 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` > `1.9158` → IC=+0.205 (n=3297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9158 (IC base=+0.103)

- **PATRÓN** `ibs_20min` < `0.5714` → IC=+0.132 (n=8806)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5714 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.5657` → IC=+0.201 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5657 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.1426` → IC=+0.173 (n=2743)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1426 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.7012` → IC=+0.177 (n=1322)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.7012 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `0.8704` → IC=+0.174 (n=2003)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8704 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.1678` → IC=+0.225 (n=1456)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1678 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` > `1.5827` → IC=+0.202 (n=4469)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5827 (IC base=+0.063)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.212 (n=4782)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 142.0 (IC base=+0.063)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.177 (n=552)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.005 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.174 (n=556)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0081 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.3416` → IC=+0.166 (n=1654)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.173 (n=1112)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `ibs_20min` < `0.0603` → IC=+0.300 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0603 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.415` → IC=+0.250 (n=1266)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.415 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` < `0.092` → IC=+0.231 (n=1027)
...
- **PATRÓN** `libro_liquidez` > `1773.87` → IC=+0.246 (n=806)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1773.87 (IC base=+0.235)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.235 (n=553)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.1134` → IC=+0.251 (n=552)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1134 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.213)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1279)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.9928` → IC=+0.262 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9928 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.1856` → IC=+0.214 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1856 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.5614` → IC=+0.218 (n=1316)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5614 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.867` → IC=+0.248 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.867 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2558` → IC=+0.218 (n=1255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2558 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.216 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0851 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.0745` → IC=+0.226 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0745 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.4033` → IC=+0.223 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4033 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.3925` → IC=+0.218 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3925 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `16459.1414` → IC=+0.226 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16459.1414 (IC base=+0.213)
...
- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.149 (n=1199)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.7707` → IC=+0.147 (n=799)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7707 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.145 (n=1116)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 411.0 (IC base=+0.136)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.202 (n=1072)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.187 (n=1689)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.189 (n=1441)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.095` → IC=+0.247 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.095 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.2145` → IC=+0.188 (n=1594)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2145 (IC base=+0.185)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.55` → IC=+0.240 (n=456)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6428` → IC=+0.211 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6428 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2747` → IC=+0.226 (n=825)
...
- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.226 (n=807)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2027)

- **PATRÓN** `ibs_20min` > `0.94` → IC=+0.201 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.94 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` > `0.3448` → IC=+0.344 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3448 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` < `0.682` → IC=+0.324 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.682 (IC base=+0.022)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.666` → IC=+0.153 (n=644)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 4.666 (IC base=+0.022)

- **PATRÓN** `volumen_regimen` < `0.6634` → IC=+0.330 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6634 (IC base=+0.022)

- **PATRÓN** `volumen_regimen` > `1.1953` → IC=+0.337 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1953 (IC base=+0.022)

- **PATRÓN** `volumen_pendiente_norm` < `0.1741` → IC=+0.326 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1741 (IC base=+0.022)

- **PATRÓN** `volumen_pendiente_norm` > `0.3004` → IC=+0.342 (n=80)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1967` → IC=+0.322 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1967 (IC base=+0.022)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.335 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 164.0 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` > `0.1855` → IC=+0.165 (n=299)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1855 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` < `0.8544` → IC=+0.153 (n=488)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5154` → IC=+0.176 (n=606)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.127 (n=2003)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=995)

- **FILTRO** `sigma_ewma_delta_pct` > `8.654` → IC=-0.207 (n=326)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.654
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2672)
...
- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.127 (n=995)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2632 (IC base=-0.043)

- **PATRÓN** `dist_vwap_pct` > `0.6425` → IC=+0.315 (n=52)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.102` → IC=+0.236 (n=218)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=396)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1640)

- **FILTRO** `ibs_20min` > `0.775` → IC=-0.201 (n=756)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=2273)
...
- **PATRÓN** `dist_vwap_pct` > `0.9919` → IC=+0.318 (n=86)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9919 (IC base=-0.024)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1054` → IC=+0.284 (n=230)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1054 (IC base=-0.024)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.192 (n=3029)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0094 (IC base=+0.095)

- **PATRÓN** `ibs_20min` > `0.4692` → IC=+0.186 (n=8107)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4692 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `1.0061` → IC=+0.289 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0061 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.562` → IC=+0.154 (n=4307)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.562 (IC base=+0.095)

- **PATRÓN** `volumen_regimen` > `0.6829` → IC=+0.242 (n=2846)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6829 (IC base=+0.095)

- **PATRÓN** `volumen_pendiente_norm` > `0.2991` → IC=+0.261 (n=755)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2991 (IC base=+0.095)

- **PATRÓN** `volumen_spike_ratio` < `1.4745` → IC=+0.239 (n=1729)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4745 (IC base=+0.095)

- **PATRÓN** `volumen_spike_ratio` > `2.7097` → IC=+0.241 (n=1729)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7097 (IC base=+0.095)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.267 (n=4690)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.095)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.148 (n=3063)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0088 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.5517` → IC=+0.149 (n=8084)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5517 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` > `0.6757` → IC=+0.244 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6757 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.1703` → IC=+0.237 (n=2388)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1703 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` < `0.7171` → IC=+0.239 (n=1160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7171 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.2028` → IC=+0.243 (n=879)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6193` → IC=+0.255 (n=1510)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6193 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.3513` → IC=+0.260 (n=1556)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3513 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.264 (n=3309)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.071)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `2.68` → IC=-0.151 (n=657)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.68
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=1482)

- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.264 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8935 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.293` → IC=+0.165 (n=860)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 3.293 (IC base=+0.047)

- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.272 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `1.4409` → IC=+0.186 (n=262)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.4409 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` > `2.1547` → IC=+0.193 (n=356)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.1547 (IC base=+0.047)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.177 (n=339)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 15.0 (IC base=+0.047)
...
- **FILTRO** `ibs_20min` > `0.817` → IC=-0.148 (n=662)

  - _Acción_: SKIP cuando `ibs_20min` > 0.817
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1990)

- **PATRÓN** `ibs_20min` > `0.862` → IC=+0.155 (n=610)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.862 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.289` → IC=+0.160 (n=324)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.289 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` < `1.0445` → IC=+0.146 (n=730)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0445 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` > `0.6674` → IC=+0.153 (n=741)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6674 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` > `0.2769` → IC=+0.204 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2769 (IC base=+0.021)

- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.195 (n=270)
...
- **PATRÓN** `dist_vwap_pct` > `0.5938` → IC=+0.219 (n=55)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5938 (IC base=-0.000)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.285 (n=960)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0077 (IC base=+0.244)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.244 (n=1442)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.297 (n=761)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.244)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.584` → IC=+0.279 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.584 (IC base=+0.244)

- **PATRÓN** `volumen_pendiente_norm` < `0.1388` → IC=+0.258 (n=1273)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1388 (IC base=+0.244)

- **PATRÓN** `volumen_spike_ratio` > `2.9543` → IC=+0.263 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9543 (IC base=+0.244)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.255 (n=956)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1927.2984` → IC=+0.255 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1927.2984 (IC base=+0.244)
...
- **PATRÓN** `ibs_20min` < `0.2233` → IC=+0.292 (n=1002)
...
- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.292 (n=455)
...
- **FILTRO** `ibs_20min` > `0.7848` → IC=-0.176 (n=542)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7848
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1629)

- **PATRÓN** `ibs_20min` > `0.902` → IC=+0.175 (n=438)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.902 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` > `0.4424` → IC=+0.224 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4424 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` < `0.9838` → IC=+0.230 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9838 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` > `0.6434` → IC=+0.213 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6434 (IC base=+0.006)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5025` → IC=+0.254 (n=197)
...
- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.191 (n=351)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 1.1615 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` > `0.7237` → IC=+0.182 (n=313)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.7237 (IC base=-0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.1645` → IC=+0.274 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1645 (IC base=-0.009)

- **PATRÓN** `volumen_spike_ratio` < `1.8288` → IC=+0.236 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8288 (IC base=-0.009)

- **PATRÓN** `volumen_spike_ratio` > `2.1518` → IC=+0.254 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1518 (IC base=-0.009)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.236 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.009)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7083` → IC=-0.204 (n=964)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7083
  - _Potencial_: sin este filtro IC_bueno=+0.269 (n=967)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.232 (n=502)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.094 (n=1524)

- **FILTRO** `sigma_ewma_delta_pct` > `4.705` → IC=-0.176 (n=452)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.705
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=1574)

- **PATRÓN** `ibs_20min` > `0.7083` → IC=+0.269 (n=967)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7083 (IC base=+0.033)

- **PATRÓN** `dist_vwap_pct` > `0.8145` → IC=+0.346 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8145 (IC base=+0.033)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.568` → IC=+0.156 (n=303)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.568 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` < `0.8657` → IC=+0.298 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8657 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` > `0.6364` → IC=+0.285 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6364 (IC base=+0.033)

- **PATRÓN** `volumen_pendiente_norm` < `0.1045` → IC=+0.288 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1045 (IC base=+0.033)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7966` → IC=+0.302 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7966 (IC base=+0.033)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.313 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.033)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.212 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` < `0.2075` → IC=+0.225 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2075 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `0.7092` → IC=+0.273 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7092 (IC base=+0.013)

- **PATRÓN** `volumen_pendiente_norm` < `0.1001` → IC=+0.212 (n=442)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5185` → IC=+0.224 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5185 (IC base=+0.013)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.237 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.013)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.318 (n=789)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0161 (IC base=+0.275)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.291 (n=559)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.275)

- **PATRÓN** `ibs_20min` > `0.9117` → IC=+0.344 (n=789)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9117 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `0.1917` → IC=+0.316 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1917 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.485` → IC=+0.298 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.485 (IC base=+0.275)

- **PATRÓN** `volumen_regimen` > `0.8621` → IC=+0.298 (n=789)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8621 (IC base=+0.275)

- **PATRÓN** `volumen_pendiente_norm` > `0.2816` → IC=+0.312 (n=179)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1814` → IC=+0.287 (n=506)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1814 (IC base=+0.275)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.279 (n=1247)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2603.9534` → IC=+0.286 (n=789)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2603.9534 (IC base=+0.275)

- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.300 (n=870)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.271 (n=1373)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.3962` → IC=+0.305 (n=1303)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3962 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.5376` → IC=+0.287 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5376 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` < `0.891` → IC=+0.271 (n=1478)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.891 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.484` → IC=+0.291 (n=471)
...
- **PATRÓN** `volumen_regimen` > `1.2432` → IC=+0.312 (n=435)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5342` → IC=+0.268 (n=1138)
...
- **PATRÓN** `libro_liquidez` > `2585.5176` → IC=+0.277 (n=869)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2585.5176 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2391)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.200 (n=2387)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0109 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.185 (n=2387)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0889 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=7450)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5814` → IC=+0.217 (n=7156)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5814 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1685` → IC=+0.195 (n=3111)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1685 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.234` → IC=+0.259 (n=1473)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.234 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2168` → IC=+0.160 (n=4733)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2168 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6255` → IC=+0.159 (n=4733)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6255 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2972` → IC=+0.194 (n=1061)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2972 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5652` → IC=+0.169 (n=3010)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5652 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6447` → IC=+0.176 (n=2280)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6447 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2379.8174` → IC=+0.168 (n=4771)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2379.8174 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=6074)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.183 (n=4550)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.4787` → IC=+0.227 (n=6820)
...
- **PATRÓN** `volumen_regimen` < `1.1802` → IC=+0.152 (n=4972)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.168 (n=2707)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2814` → IC=+0.174 (n=2790)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2814 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.173 (n=5787)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 120.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.221 (n=410)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.183)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.190 (n=411)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0083 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.3363` → IC=+0.206 (n=1228)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3363 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.195 (n=822)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `ibs_20min` < `0.3455` → IC=+0.266 (n=866)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3455 (IC base=+0.240)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.208 (n=354)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.187 (n=1112)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.4147` → IC=+0.227 (n=1059)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4147 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.1954` → IC=+0.213 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1954 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.523` → IC=+0.238 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.523 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.268` → IC=+0.168 (n=1060)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.268 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `1.0702` → IC=+0.163 (n=481)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0702 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.202 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2352 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `1.4144` → IC=+0.201 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4144 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `15765.4015` → IC=+0.171 (n=481)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 15765.4015 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.196 (n=389)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0025 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2886` → IC=+0.155 (n=1163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.2886 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.153 (n=1063)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 7.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.184 (n=1163)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5556 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1293` → IC=+0.160 (n=1168)
...
- **PATRÓN** `volumen_regimen` < `1.2116` → IC=+0.154 (n=1163)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4465` → IC=+0.144 (n=1053)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.4465 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.763` → IC=+0.134 (n=703)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.224 (n=542)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.2108` → IC=+0.215 (n=798)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2108 (IC base=+0.197)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.797` → IC=+0.279 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.797 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` < `0.2131` → IC=+0.196 (n=1154)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` < 0.2131 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.9268` → IC=+0.209 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9268 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=800)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `1931.1232` → IC=+0.206 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1931.1232 (IC base=+0.197)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.174 (n=1004)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0066 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.4315` → IC=+0.162 (n=1138)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4315 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1193)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.3925` → IC=+0.201 (n=1138)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3925 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.1538` → IC=+0.185 (n=756)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1538 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.979` → IC=+0.240 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.979 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `1.0496` → IC=+0.153 (n=1002)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.0496 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.6318` → IC=+0.153 (n=1138)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4219` → IC=+0.154 (n=371)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4219 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `2.5308` → IC=+0.178 (n=371)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.5308 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `6941.7258` → IC=+0.183 (n=759)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6941.7258 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.150 (n=1074)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 167.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.160 (n=1199)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.381` → IC=+0.142 (n=1199)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6186` → IC=+0.170 (n=1199)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7982` → IC=+0.127 (n=721)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.7982 (IC base=+0.123)
...
- **PATRÓN** `ballena_activa_n` < `170.0` → IC=+0.122 (n=1014)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 170.0 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.01` → IC=+0.158 (n=589)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.01 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.5172` → IC=+0.200 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5172 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.0637` → IC=+0.220 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0637 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.59` → IC=+0.253 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.59 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.2243` → IC=+0.126 (n=1299)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.2243 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` < `0.1661` → IC=+0.129 (n=1296)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1661 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `2.4941` → IC=+0.124 (n=1250)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.4941 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1354)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2891.3724` → IC=+0.194 (n=589)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1336)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.209 (n=1318)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.9557` → IC=+0.138 (n=172)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.9557 (IC base=+0.112)
...
- **PATRÓN** `volumen_regimen` < `1.1914` → IC=+0.122 (n=1318)
...
- **PATRÓN** `libro_liquidez` > `3068.9982` → IC=+0.162 (n=439)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3068.9982 (IC base=+0.112)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.209 (n=826)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.198)

- **PATRÓN** `drift_60min` |x|≤ `0.1296` → IC=+0.199 (n=413)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1296 (IC base=+0.198)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=1284)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)
...
- **PATRÓN** `ibs_20min` > `0.7351` → IC=+0.257 (n=1107)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7351 (IC base=+0.198)

- **PATRÓN** `dist_vwap_pct` > `1.2191` → IC=+0.225 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2191 (IC base=+0.198)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.444` → IC=+0.243 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.444 (IC base=+0.198)

- **PATRÓN** `volumen_regimen` < `1.2094` → IC=+0.201 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2094 (IC base=+0.198)

- **PATRÓN** `volumen_regimen` > `0.8594` → IC=+0.217 (n=826)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8594 (IC base=+0.198)

- **PATRÓN** `volumen_pendiente_norm` > `0.2365` → IC=+0.275 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2365 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` < `2.1694` → IC=+0.209 (n=1051)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1694 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `1.8108` → IC=+0.204 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8108 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.200 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `2591.5202` → IC=+0.199 (n=826)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2591.5202 (IC base=+0.198)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.173 (n=560)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.3958` → IC=+0.182 (n=1671)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.3958 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.3662` → IC=+0.183 (n=494)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.3662 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.719` → IC=+0.176 (n=778)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.719 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8709` → IC=+0.164 (n=965)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8709 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6971` → IC=+0.149 (n=1293)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6971 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1639` → IC=+0.176 (n=461)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1639 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.159 (n=535)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.146)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=1877)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `3244.3571` → IC=+0.151 (n=1114)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3244.3571 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.166 (n=1448)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 166.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.127 (n=1175)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6558` → IC=+0.132 (n=1759)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0953` → IC=+0.221 (n=163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.433` → IC=+0.252 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.433 (IC base=+0.206)
...
- **PATRÓN** `volumen_regimen` < `0.8407` → IC=+0.216 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8407 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `0.6043` → IC=+0.209 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6043 (IC base=+0.206)

- **PATRÓN** `volumen_pendiente_norm` > `0.2528` → IC=+0.322 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2528 (IC base=+0.206)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=542)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.201 (n=3033)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0109 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=9478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=9104)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.8962` → IC=+0.198 (n=1245)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8962 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.609` → IC=+0.226 (n=4431)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.609 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `0.8819` → IC=+0.165 (n=4055)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8819 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2405` → IC=+0.196 (n=1701)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2405 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6232` → IC=+0.188 (n=2905)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6232 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2327.9342` → IC=+0.169 (n=6063)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2327.9342 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6808)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 89.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.192 (n=5505)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0069 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1441` → IC=+0.187 (n=3632)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.1441 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5663` → IC=+0.238 (n=8251)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5663 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.237` → IC=+0.161 (n=5157)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.237 (IC base=+0.181)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.71` → IC=+0.183 (n=7998)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.71 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7054` → IC=+0.159 (n=2514)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7054 (IC base=+0.181)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2892` → IC=+0.190 (n=3405)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2892 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.189 (n=4795)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.207 (n=1036)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3429` → IC=+0.189 (n=1552)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.263 (n=1055)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=1065)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.259 (n=1079)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3451` → IC=+0.291 (n=1039)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3451 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.448` → IC=+0.267 (n=1245)
...
- **PATRÓN** `libro_liquidez` > `1773.87` → IC=+0.272 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1773.87 (IC base=+0.258)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0832` → IC=+0.165 (n=485)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0832 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1513)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.3107` → IC=+0.202 (n=1453)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3107 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.184 (n=820)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.124 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.755` → IC=+0.168 (n=335)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 9.755 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.265` → IC=+0.152 (n=1301)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.265 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6277` → IC=+0.182 (n=485)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6277 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.2706` → IC=+0.193 (n=210)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2706 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.1192` → IC=+0.159 (n=1231)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1192 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.5028` → IC=+0.153 (n=1249)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5028 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `13667.9668` → IC=+0.153 (n=969)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13667.9668 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `481.0` → IC=+0.155 (n=1332)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 481.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.163 (n=1262)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0056 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.3172` → IC=+0.158 (n=1262)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3172 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` < `0.6443` → IC=+0.192 (n=1262)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6443 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.6766` → IC=+0.165 (n=204)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6766 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.1279` → IC=+0.164 (n=1148)
...
- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.160 (n=1262)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.160 (n=1164)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.161 (n=776)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `428.0` → IC=+0.154 (n=938)
...
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.242 (n=665)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0098 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.221 (n=1530)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.216)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1489)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.256 (n=1307)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6739 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.749` → IC=+0.291 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.749 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.2167` → IC=+0.222 (n=1436)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2167 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.9054` → IC=+0.245 (n=629)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9054 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=979)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1930.62` → IC=+0.222 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1930.62 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.243 (n=1359)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0108 (IC base=+0.238)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.244 (n=905)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.2` → IC=+0.283 (n=910)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.281 (n=486)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7875` → IC=+0.238 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7875 (IC base=+0.238)
...
- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.256 (n=395)
...
- **PATRÓN** `drift_60min` |x|≤ `0.436` → IC=+0.143 (n=1552)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.436 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=1622)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.6902` → IC=+0.230 (n=1034)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6902 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.5611` → IC=+0.174 (n=443)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.5611 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.214` → IC=+0.162 (n=645)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.214 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8773` → IC=+0.160 (n=1035)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8773 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2798` → IC=+0.233 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2798 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5228` → IC=+0.151 (n=660)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.5228 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4694` → IC=+0.153 (n=500)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.4694 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8150.9955` → IC=+0.230 (n=704)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.156 (n=1265)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6933` → IC=+0.184 (n=1265)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6933 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.362` → IC=+0.140 (n=1265)
...
- **PATRÓN** `volumen_regimen` < `0.8628` → IC=+0.141 (n=843)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8628 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1852` → IC=+0.141 (n=421)
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.185 (n=1540)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4706 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `1.0401` → IC=+0.200 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0401 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.414` → IC=+0.231 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.414 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=1070)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2909.4755` → IC=+0.242 (n=513)
...
- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.134 (n=1513)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0109 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.1286` → IC=+0.153 (n=505)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1286 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1563)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.6371` → IC=+0.206 (n=1513)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.126 (n=1462)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.437 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.156 (n=666)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.72 (IC base=+0.112)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4566` → IC=+0.139 (n=452)
...
- **PATRÓN** `libro_liquidez` > `2839.872` → IC=+0.161 (n=505)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2839.872 (IC base=+0.112)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.215 (n=1026)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1603)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.205 (n=1379)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.246 (n=1539)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `0.188` → IC=+0.227 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.188 (IC base=+0.204)
...
- **PATRÓN** `volumen_regimen` > `0.6351` → IC=+0.211 (n=1539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6351 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.236` → IC=+0.241 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.236 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `2.5313` → IC=+0.234 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5313 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.212 (n=1592)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2597.7754` → IC=+0.213 (n=1026)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2597.7754 (IC base=+0.204)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.233 (n=559)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0085 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.221 (n=560)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.240 (n=559)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2201` → IC=+0.195 (n=1314)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2201 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.201 (n=1493)
...
- **PATRÓN** `libro_liquidez` > `2569.9354` → IC=+0.201 (n=1117)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.135 (n=2811)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4792` → IC=+0.153 (n=2120)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` < `0.243` → IC=+0.126 (n=1898)
  ...
  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.243 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.238` → IC=+0.140 (n=2105)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.238 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `0.9014` → IC=+0.148 (n=1346)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5345` → IC=+0.138 (n=924)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5345 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `1.8156` → IC=+0.140 (n=1399)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8156 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.135 (n=2811)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `7341.4793` → IC=+0.147 (n=1894)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 7341.4793 (IC base=+0.133)
...
- **PATRÓN** `ibs_20min` > `0.0998` → IC=+0.150 (n=693)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.266` → IC=+0.139 (n=626)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 4.266 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.0948` → IC=+0.149 (n=610)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0948 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `0.7253` → IC=+0.143 (n=620)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.7253 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.178 (n=299)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.1885` → IC=+0.152 (n=599)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.1885 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.7743` → IC=+0.158 (n=454)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7743 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `7633.9254` → IC=+0.162 (n=693)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 7633.9254 (IC base=+0.138)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.138 (n=222)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 16.0 (IC base=+0.109)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.125 (n=608)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.5 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2852.6244` → IC=+0.179 (n=207)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2852.6244 (IC base=+0.109)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=1542)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=693)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7251)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.177 (n=3070)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9627)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3219)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9945)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.218 (n=522)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1665)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.171 (n=551)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1800)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.202 (n=552)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=1673)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=585)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1757)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.167 (n=574)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1768)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.185 (n=538)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1626)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.194 (n=563)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1779)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2618)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2763)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2769)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=9157)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=20187)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.276 (n=7075)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=22269)

- **FILTRO** `ibs_7min` < `0.293` → IC=-0.235 (n=7336)

  - _Acción_: SKIP cuando `ibs_7min` < 0.293
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=22008)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.158 (n=9909)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19435)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9151)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=27578)

- **FILTRO** `ibs_7min` > `0.2943` → IC=-0.179 (n=9181)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2943
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27548)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=1148)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3656)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.253 (n=1583)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3221)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.180 (n=1145)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3659)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.151 (n=4257)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=2081)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.125 (n=2151)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4187)

- **FILTRO** `ibs_7min` > `0.7925` → IC=-0.204 (n=1584)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7925
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4754)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1204)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3894)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1225)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3873)

- **FILTRO** `ibs_7min` < `0.7519` → IC=-0.189 (n=1274)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7519
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3824)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.173 (n=1271)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3827)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.259 (n=1270)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3876)

- **FILTRO** `ibs_7min` > `0.2589` → IC=-0.173 (n=1285)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2589
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3861)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1283)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3863)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.171 (n=1130)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3412)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.309 (n=1107)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3435)

- **FILTRO** `ibs_7min` < `0.196` → IC=-0.258 (n=1135)

  - _Acción_: SKIP cuando `ibs_7min` < 0.196
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=3407)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.214 (n=1091)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3451)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1573)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=5163)

- **FILTRO** `ibs_7min` > `0.7596` → IC=-0.178 (n=1683)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7596
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=5053)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1566)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3259)
...
- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.182 (n=1206)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3619)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.177 (n=1204)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3621)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.262 (n=1233)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3713)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.173 (n=1236)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3710)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.191 (n=1205)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3741)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=1212)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3962)

- **FILTRO** `ibs_7min` < `0.7027` → IC=-0.228 (n=1293)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7027
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3881)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1681)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5282)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=1140)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3761)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.232 (n=1225)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3676)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1174)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3727)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1630)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4970)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1034)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.124 (n=637)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `sigma_h` > `0.0095` → IC=-0.294 (n=71)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0095
  - _Potencial_: sin este filtro IC_bueno=-0.283 (n=215)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.180 (n=23)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=261)

- **PATRÓN** `streak_estiramiento` < `0.4576` → IC=+0.154 (n=50)

  - _Acción_: Kelly boost +0.77€ cuando `streak_estiramiento` < 0.4576 (IC base=+0.030)

- **PATRÓN** `streak_estiramiento` < `0.5654` → IC=+0.164 (n=111)

  - _Acción_: Kelly boost +0.82€ cuando `streak_estiramiento` < 0.5654 (IC base=+0.038)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1079)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2678)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1375)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1383)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.584` → IC=+0.125 (n=38)
  ...
  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 20.584 (IC base=+0.016)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.221 (n=364)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=1095)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.227 (n=481)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=978)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=916)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.184 (n=543)

- **FILTRO** `sigma_ewma_delta_pct` > `19.79` → IC=-0.250 (n=258)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.79
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1201)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.012` → IC=-0.135 (n=302)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.012
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2429)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.356 sube el IC de -0.039 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1462). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1241 | +0.090 | +151.95€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1241 | +0.090 | +151.95€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 913 | +0.099 | +128.60€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 913 | +0.099 | +128.60€ | 2 | 7 |
...
| ✅ BALLENAS_TARDIAS | 23293 | -0.092 | -3079.13€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1395 | -0.047 | -211.47€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21898 | -0.095 | -2867.66€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3547 | -0.087 | -578.07€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3547 | -0.087 | -578.07€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 6671 | -0.032 | -604.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6671 | -0.032 | -604.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6143 | -0.095 | -427.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6143 | -0.095 | -427.28€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5163 | -0.180 | -1097.19€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5163 | -0.180 | -1097.19€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15703 | -0.032 | +4131.38€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4130 | -0.002 | +1826.72€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11573 | -0.043 | +2304.65€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15703 | -0.032 | +4131.38€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4130 | -0.002 | +1826.72€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11573 | -0.043 | +2304.65€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1393 | -0.101 | -180.04€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 155 | -0.048 | -17.42€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1238 | -0.108 | -162.62€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 430 | -0.127 | -70.23€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 406 | -0.130 | -65.00€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 85210 | +0.113 | -4377.17€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13065 | +0.184 | -432.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 337 | -0.102 | -48.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 66145 | +0.100 | -3706.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5663 | +0.110 | -190.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11009 | +0.097 | -980.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 43 | -0.167 | -2.82€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 10951 | +0.099 | -965.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 17240 | +0.132 | -350.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4076 | +0.201 | -141.75€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 10962 | +0.112 | -166.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2160 | +0.108 | -20.46€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11049 | +0.087 | -1081.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 50 | -0.077 | -4.56€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 10984 | +0.089 | -1065.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 18179 | +0.124 | -360.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5048 | +0.175 | -78.59€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11073 | +0.106 | -219.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2046 | +0.098 | -53.69€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 16707 | +0.115 | -951.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3805 | +0.186 | -212.42€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 240 | -0.062 | +5.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11205 | +0.093 | -628.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1457 | +0.130 | -115.97€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11026 | +0.102 | -652.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 43 | -0.033 | +7.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 10970 | +0.102 | -660.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 13510 | +0.191 | -895.29€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 13510 | +0.191 | -895.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3263 | +0.168 | -348.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3263 | +0.168 | -348.17€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 982 | +0.196 | +0.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 982 | +0.196 | +0.52€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3194 | +0.180 | -275.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3194 | +0.180 | -275.54€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2857 | +0.240 | -84.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2857 | +0.240 | -84.21€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3135 | +0.191 | -201.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3135 | +0.191 | -201.66€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 46335 | +0.197 | -3681.39€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 46335 | +0.197 | -3681.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8040 | +0.175 | -953.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8040 | +0.175 | -953.95€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7386 | +0.224 | -269.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7386 | +0.224 | -269.15€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8008 | +0.173 | -969.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8008 | +0.173 | -969.75€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 7474 | +0.219 | -291.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 7474 | +0.219 | -291.14€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 7650 | +0.204 | -501.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 7650 | +0.204 | -501.42€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 7777 | +0.193 | -695.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 7777 | +0.193 | -695.98€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 17409 | +0.120 | +186.51€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 17409 | +0.120 | +186.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 8635 | +0.124 | +149.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 8635 | +0.124 | +149.02€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 8774 | +0.116 | +37.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 8774 | +0.116 | +37.50€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1379 | +0.290 | -15.27€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1379 | +0.290 | -15.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 614 | +0.274 | -21.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 614 | +0.274 | -21.23€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 662 | +0.295 | +4.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 662 | +0.295 | +4.92€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 606 | +0.438 | -0.58€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 606 | +0.438 | -0.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC | 285 | +0.437 | -0.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min | 285 | +0.437 | -0.77€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1007 | +0.075 | -41.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 351 | +0.061 | -28.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 656 | +0.082 | -12.77€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 791 | +0.083 | -15.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 135 | +0.084 | -2.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 656 | +0.082 | -12.77€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 31682 | +0.098 | -954.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2630 | +0.091 | +23.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 29052 | +0.099 | -978.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 17882 | +0.103 | -271.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2630 | +0.091 | +23.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 15252 | +0.105 | -294.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 5796 | +0.109 | -15.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 5796 | +0.109 | -15.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8004 | +0.081 | -668.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8004 | +0.081 | -668.44€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 23042 | +0.080 | +10771.38€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 23042 | +0.080 | +10771.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 3817 | +0.192 | +2760.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 3817 | +0.192 | +2760.94€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 3416 | +0.174 | +2315.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3416 | +0.174 | +2315.38€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 3964 | +0.200 | +2985.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 3964 | +0.200 | +2985.33€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3434 | +0.015 | +649.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3434 | +0.015 | +649.34€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3346 | -0.033 | +788.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3346 | -0.033 | +788.37€ | 4 | 16 |
| ✅ GBM_LATE_15M#XRP | 5065 | -0.044 | +1272.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5065 | -0.044 | +1272.02€ | 4 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 24343 | +0.083 | +12751.93€ | 0 | 19 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 24343 | +0.083 | +12751.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4624 | +0.016 | +2590.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4624 | +0.016 | +2590.24€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5092 | +0.010 | +1013.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5092 | +0.010 | +1013.48€ | 1 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3438 | +0.263 | +3469.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3438 | +0.263 | +3469.39€ | 0 | 19 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 3918 | -0.003 | +702.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 3918 | -0.003 | +702.17€ | 2 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 3957 | +0.023 | +1477.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 3957 | +0.023 | +1477.96€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3314 | +0.273 | +3498.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3314 | +0.273 | +3498.69€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 18633 | +0.168 | +13760.72€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 18633 | +0.168 | +13760.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2791 | +0.206 | +2215.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2791 | +0.206 | +2215.97€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 2962 | +0.149 | +2122.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 2962 | +0.149 | +2122.32€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2903 | +0.209 | +2322.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2903 | +0.209 | +2322.20€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3115 | +0.135 | +2127.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3115 | +0.135 | +2127.63€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3486 | +0.113 | +2329.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3486 | +0.113 | +2329.47€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3376 | +0.202 | +2643.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3376 | +0.202 | +2643.13€ | 0 | 27 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4572 | +0.122 | +1844.85€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4572 | +0.122 | +1844.85€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1253 | +0.142 | +556.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1253 | +0.142 | +556.67€ | 0 | 14 |
...
| ✅ GBM_LATE_15M_TARDIO | 23126 | +0.173 | +16980.11€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#15min | 23126 | +0.173 | +16980.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3641 | +0.219 | +3048.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3641 | +0.219 | +3048.54€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3619 | +0.148 | +2350.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3619 | +0.148 | +2350.59€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 3760 | +0.227 | +3258.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 3760 | +0.227 | +3258.31€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 3752 | +0.136 | +2513.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 3752 | +0.136 | +2513.11€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4069 | +0.108 | +2480.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4069 | +0.108 | +2480.30€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4285 | +0.203 | +3329.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4285 | +0.203 | +3329.25€ | 0 | 25 |
| ✅ GBM_LATE_5M | 6443 | +0.142 | +3555.99€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 6443 | +0.142 | +3555.99€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 2036 | +0.146 | +1106.85€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 2036 | +0.146 | +1106.85€ | 0 | 32 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1712 | +0.100 | +469.89€ | 0 | 3 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1712 | +0.100 | +469.89€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1712 | +0.100 | +469.89€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1712 | +0.100 | +469.89€ | 0 | 3 |
...
| ✅ LIQUIDACIONES_5M | 1740 | +0.005 | +9.84€ | 4 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 1740 | +0.005 | +9.84€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_5M#ETH | 740 | +0.035 | +27.63€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 740 | +0.035 | +27.63€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 14115 | -0.012 | -213.97€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14115 | -0.012 | -213.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2832 | -0.025 | -67.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2832 | -0.025 | -67.16€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 25861 | -0.009 | +1150.71€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 25861 | -0.009 | +1150.71€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4538 | +0.014 | +574.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4538 | +0.014 | +574.21€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4074 | -0.027 | -44.07€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4074 | -0.027 | -44.07€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4567 | +0.011 | +395.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4567 | +0.011 | +395.79€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3852 | -0.051 | -134.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3852 | -0.051 | -134.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4324 | -0.011 | +172.28€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4324 | -0.011 | +172.28€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4506 | +0.004 | +186.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4506 | +0.004 | +186.66€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5482 | -0.052 | -128.54€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5482 | -0.052 | -128.54€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1562 | -0.071 | -30.05€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1562 | -0.071 | -30.05€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 66073 | -0.073 | +1509.41€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 66073 | -0.073 | +1509.41€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 11142 | -0.080 | +655.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 11142 | -0.080 | +655.58€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 10244 | -0.093 | -453.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 10244 | -0.093 | -453.01€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 11278 | -0.069 | +610.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 11278 | -0.069 | +610.97€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 9771 | -0.094 | -184.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 9771 | -0.094 | -184.85€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 12137 | -0.049 | +359.10€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 12137 | -0.049 | +359.10€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 11501 | -0.063 | +521.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 11501 | -0.063 | +521.62€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 6901 | -0.023 | -101.90€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 6901 | -0.023 | -101.90€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 996 | -0.017 | -19.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 996 | -0.017 | -19.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1609 | -0.025 | -3.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1609 | -0.025 | -3.11€ | 3 | 0 |
...
| ✅ ORDER_FLOW_5M | 1079 | +0.109 | +363.17€ | 0 | 3 |
| ✅ ORDER_FLOW_5M#5min | 943 | +0.116 | +350.58€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 448 | +0.036 | +19.51€ | 2 | 2 |
| ✅ STREAK_FADE_15M#15min | 448 | +0.036 | +19.51€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M#XRP | 164 | +0.036 | +11.59€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP#15min | 164 | +0.036 | +11.59€ | 1 | 3 |
...
| ✅ STREAK_MOM_5M | 7250 | +0.024 | +115.92€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7250 | +0.024 | +115.92€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2121 | +0.021 | +20.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2121 | +0.021 | +20.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1571 | +0.035 | +47.21€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1571 | +0.035 | +47.21€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2199 | +0.015 | +9.11€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2199 | +0.015 | +9.11€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1359 | +0.032 | +38.70€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1359 | +0.032 | +38.70€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 6762 | +0.010 | -50.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 6762 | +0.010 | -50.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2697 | +0.015 | -8.92€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2697 | +0.015 | -8.92€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2658 | +0.011 | -18.95€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2658 | +0.011 | -18.95€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1407 | -0.001 | -22.94€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1407 | -0.001 | -22.94€ | 2 | 0 |
| ✅ UPDOWN_GBM | 32294 | +0.031 | +1903.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 8652 | +0.062 | +1491.04€ | 0 | 10 |
| ✅ UPDOWN_GBM#240min | 1191 | +0.005 | +8.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 20386 | +0.022 | +388.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 1942 | +0.006 | +15.28€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3050 | +0.071 | +332.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 462 | +0.153 | +187.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 23 | -0.020 | -0.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2565 | +0.057 | +145.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6026 | +0.033 | +392.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1086 | +0.078 | +240.09€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 330 | +0.021 | +7.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 3693 | +0.029 | +130.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 870 | +0.002 | +13.79€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 47 | -0.112 | +0.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 3790 | +0.040 | +215.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 434 | +0.144 | +164.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 18 | +0.000 | -0.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3338 | +0.027 | +50.75€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 6813 | +0.019 | +275.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2282 | +0.044 | +248.44€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 318 | +0.006 | +7.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3505 | +0.009 | +18.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 668 | +0.004 | -1.88€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 40 | -0.143 | +3.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 7882 | +0.017 | +200.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2196 | +0.022 | +131.82€ | 0 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 312 | -0.006 | -2.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 4936 | +0.017 | +70.45€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 404 | +0.015 | +3.37€ | 0 | 2 |
| ✅ UPDOWN_GBM#SOL#daily | 34 | -0.167 | -2.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 4731 | +0.035 | +488.72€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2192 | +0.077 | +518.33€ | 0 | 12 |
| ✅ UPDOWN_GBM#XRP#240min | 190 | -0.005 | -3.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2349 | -0.001 | -26.39€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 10674 | -0.044 | +2253.43€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 10674 | -0.044 | +2253.43€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 626 | -0.045 | +333.01€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 626 | -0.045 | +333.01€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2000 | -0.123 | +48.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2000 | -0.123 | +48.47€ | 4 | 6 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3302 | -0.064 | +523.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3302 | -0.064 | +523.11€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3310 | -0.078 | +527.68€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3310 | -0.078 | +527.68€ | 3 | 4 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 499 celda(s) pasan gate riguroso completo de 2133 evaluadas (n>=40) y 3144 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.022 < 0.08 — monitorear
  - _Datos_: n=2194 IC=+0.022 PNL=+132.89€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.100 n=243/60 | contraria IC=+0.150 n=232 | gap=-0.050 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=666/40 IC=+0.004 PNL=-1.87€ | BTC#60min: n=868/40 IC=+0.002 PNL=+13.79€ | SOL#60min: n=403/40 IC=+0.016 PNL=+3.88€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.052 n=302670 | tras_1loss IC=+0.075 n=235740 | tras_2loss IC=+0.044 n=100016/40 | gap=+0.007 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1404 IC=+0.013 PNL=+6.57€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1404 IC=+0.013 PNL=+6.57€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=533 IC=-0.012 PNL=+9.24€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=533 IC=-0.012 PNL=+9.24€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.184 > 0.1 con n=1863 PNL=+1141.06€
  - _Datos_: n=1863 IC=+0.184 PNL=+1141.06€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1083 IC=+0.078 PNL=+239.11€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1083 IC=+0.078 PNL=+239.11€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=11096 IC=+0.055 PNL=+1357.14€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=11096 IC=+0.055 PNL=+1357.14€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1684 IC=+0.046 PNL=+179.50€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1684 IC=+0.046 PNL=+179.50€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=15904 IC=-0.138 PNL=+1087.52€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=15904 IC=-0.138 PNL=+1087.52€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1743 IC=+0.137 PNL=+931.90€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1743 IC=+0.137 PNL=+931.90€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.092 n=885) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=885 IC=+0.092 PNL=+209.17€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8031 IC=+0.175 PNL=-956.04€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8031 IC=+0.175 PNL=-956.04€
