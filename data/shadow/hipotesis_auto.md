# Hipótesis automáticas — 2026-07-21 04:24 UTC
_Generado por shadow_postmortem.py sobre 25941 resoluciones (PNL=+6322.42€)_
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.124` → IC=+0.129 (n=289)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 6.124 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` > `0.0253` → IC=+0.194 (n=214)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0253 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.182 (n=221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 18.0 (IC base=+0.169)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.214 (n=215)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.4447` → IC=+0.210 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4447 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.238` → IC=+0.161 (n=381)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 9.238 (IC base=+0.169)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.192 (n=830)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0072 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.181 (n=628)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.172 (n=434)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 5.0 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` < `0.6262` → IC=+0.178 (n=1114)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6262 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.119` → IC=+0.201 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.119 (IC base=+0.161)
...
- **PATRÓN** `sigma_h` > `0.0026` → IC=+0.138 (n=321)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0026 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.157 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.5173` → IC=+0.127 (n=285)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.5173 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.745` → IC=+0.217 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.745 (IC base=+0.124)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.314 (n=310)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.4347` → IC=+0.357 (n=40)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4347 (IC base=+0.287)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.503` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.503 (IC base=+0.287)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.827` → IC=+0.294 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.827 (IC base=+0.287)
...
- **PATRÓN** `dist_vwap_pct` < `0.8063` → IC=+0.121 (n=1173)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.8063 (IC base=+0.105)
...
- **PATRÓN** `sigma_h` > `0.0205` → IC=+0.218 (n=133)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0205 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.226 (n=199)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.219 (n=137)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.209)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `10.154` → IC=+0.219 (n=368)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.227 (n=42)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.071)

- **PATRÓN** `volumen_racha` < `497480.0` → IC=+0.156 (n=59)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_racha` < 497480.0 (IC base=+0.071)
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.145 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 9.0 (IC base=+0.054)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 540 | +0.127 | +17.15€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 540 | +0.127 | +17.15€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 201 | +0.140 | +4.77€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 201 | +0.140 | +4.77€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 4488 | +0.186 | +62.78€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2919 | +0.218 | +99.81€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1303 | +0.199 | +55.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 972 | +0.212 | +6.92€ | 0 | 5 |
...
| ✅ GBM_LATE_15M | 6375 | +0.103 | +2140.12€ | 0 | 7 |
| ✅ GBM_LATE_15M#15min | 6375 | +0.103 | +2140.12€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1522 | +0.076 | +293.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1522 | +0.076 | +293.50€ | 0 | 5 |
| ✅ GBM_LATE_15M#ETH | 1444 | +0.076 | +267.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1444 | +0.076 | +267.65€ | 0 | 6 |
| ✅ GBM_LATE_15M#SOL | 1729 | +0.092 | +635.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1729 | +0.092 | +635.74€ | 0 | 4 |
| ✅ GBM_LATE_15M#XRP | 1680 | +0.162 | +943.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1680 | +0.162 | +943.23€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3571 | +0.145 | +2085.81€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3571 | +0.145 | +2085.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 910 | +0.109 | +422.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 910 | +0.109 | +422.03€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 933 | +0.102 | +395.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 933 | +0.102 | +395.34€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 907 | +0.112 | +413.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 907 | +0.112 | +413.88€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 821 | +0.269 | +854.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 821 | +0.269 | +854.55€ | 0 | 11 |
...
| ✅ GBM_LATE_15M_TARDIO | 3553 | +0.095 | +1231.67€ | 0 | 6 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3553 | +0.095 | +1231.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 849 | +0.064 | +168.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 849 | +0.064 | +168.44€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 856 | +0.034 | +88.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 856 | +0.034 | +88.95€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 810 | +0.048 | +172.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 810 | +0.048 | +172.74€ | 1 | 2 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1038 | +0.206 | +801.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1038 | +0.206 | +801.54€ | 0 | 13 |
...
| ✅ LATE_WINDOW_5MIN | 105 | +0.107 | +20.41€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 105 | +0.107 | +20.41€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 105 | +0.107 | +20.41€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 105 | +0.107 | +20.41€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 246 | +0.093 | +35.71€ | 1 | 9 |
| ✅ STREAK_FADE_15M#15min | 246 | +0.093 | +35.71€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M#XRP | 110 | +0.054 | +5.09€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP#15min | 110 | +0.054 | +5.09€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 2026 | +0.025 | +155.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1764 | +0.049 | +194.10€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#DOGE | 117 | +0.029 | +11.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 114 | +0.035 | +12.09€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 914 | +0.174 | +426.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 914 | +0.174 | +426.31€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 72 | +0.243 | +50.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 72 | +0.243 | +50.12€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.194: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.060 n=907 | neutral: IC=-0.002 n=684 | overbought(IBS>0.7): IC=+0.192 n=885
  - _Datos_: n=2651 IC=+0.096 PNL=+623.25€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.118 n=15634 | tras_1loss IC=+0.089 n=10105 | tras_2loss IC=+0.055 n=4111/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1894 IC=+0.031 PNL=+169.76€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1894 IC=+0.031 PNL=+169.76€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=842 IC=+0.045 PNL=+89.50€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=842 IC=+0.045 PNL=+89.50€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=942 IC=+0.079 PNL=+134.77€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=942 IC=+0.079 PNL=+134.77€
...
**🔶 H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.107 n=105) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=105 IC=+0.107 PNL=+20.41€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=879 IC=+0.039 PNL=+74.76€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=879 IC=+0.039 PNL=+74.76€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=23477 IC=+0.119 PNL=+6397.27€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=23477 IC=+0.119 PNL=+6397.27€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=228 IC=+0.000 PNL=+2.25€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=228 IC=+0.000 PNL=+2.25€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=992 IC=+0.015 PNL=+58.94€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=992 IC=+0.015 PNL=+58.94€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.1 con n=611 PNL=+222.59€
  - _Datos_: n=611 IC=+0.169 PNL=+222.59€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=810 IC=+0.064 PNL=+120.67€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=810 IC=+0.064 PNL=+120.67€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.143 > 0.08 con n=438 PNL=+135.74€
  - _Datos_: n=438 IC=+0.143 PNL=+135.74€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=137 IC=+0.025 PNL=+15.73€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=137 IC=+0.025 PNL=+15.73€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=518 PNL=+187.80€
  - _Datos_: n=518 IC=+0.121 PNL=+187.80€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=346 PNL=+113.61€
  - _Datos_: n=346 IC=+0.121 PNL=+113.61€
