# Hipótesis automáticas — 2026-07-15 21:20 UTC
_Generado por shadow_postmortem.py sobre 15944 resoluciones (PNL=+3220.89€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.197 (n=766)
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.297 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.196 (n=958)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `4419.7043` → IC=+0.193 (n=545)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 4419.7043 (IC base=+0.192)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.174 (n=461)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3709` → IC=+0.213 (n=169)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.167 (n=133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3709` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.3709 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `1.1671` → IC=+0.141 (n=126)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 1.1671 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.752` → IC=+0.400 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.752 (IC base=+0.147)
...
- **PATRÓN** `dist_vwap_pct` > `0.7123` → IC=+0.190 (n=111)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.7123 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.717` → IC=+0.323 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.717 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.149 (n=55)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0039 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` > `0.7076` → IC=+0.138 (n=45)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.7076 (IC base=+0.055)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.366` → IC=+0.364 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.366 (IC base=+0.055)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2298 | +0.177 | -27.78€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1480 | +0.211 | +20.54€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 816 | +0.178 | +12.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 489 | +0.221 | +27.08€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1941 | +0.151 | +1126.33€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1941 | +0.151 | +1126.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 498 | +0.112 | +238.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 498 | +0.112 | +238.68€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 513 | +0.129 | +235.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 513 | +0.129 | +235.84€ | 0 | 14 |
...
| ✅ GBM_LATE_15M_TARDIO | 1896 | +0.088 | +561.06€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1896 | +0.088 | +561.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 472 | +0.059 | +85.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 472 | +0.059 | +85.28€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 430 | +0.018 | +14.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 430 | +0.018 | +14.50€ | 0 | 3 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 55 | +0.237 | +18.64€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 55 | +0.237 | +18.64€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 11 | +0.148 | +5.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 11 | +0.148 | +5.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 14 | +0.219 | +4.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 14 | +0.219 | +4.16€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.137) — sin ventaja clara. oversold(IBS<0.3): IC=+0.002 n=452 | neutral: IC=-0.017 n=348 | overbought(IBS>0.7): IC=+0.120 n=369
  - _Datos_: n=1236 IC=+0.038 PNL=+115.43€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.101 n=9246 | tras_1loss IC=+0.066 n=6487 | tras_2loss IC=+0.032 n=2785/40 | gap=+0.069 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13486 IC=+0.105 PNL=+3296.77€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13486 IC=+0.105 PNL=+3296.77€
