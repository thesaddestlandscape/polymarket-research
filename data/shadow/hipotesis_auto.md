# Hipótesis automáticas — 2026-09-14 14:33 UTC
_Generado por shadow_postmortem.py sobre 436609 resoluciones (PNL=+46553.08€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.18` → IC=-0.260 (n=5487)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.18
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=16464)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.134 (n=1935)
...
- **FILTRO** `restante_s_al_confirmar` < `138.64` → IC=-0.290 (n=774)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2322)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `134.98` → IC=-0.289 (n=690)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.98
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2073)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `143.71` → IC=-0.151 (n=1415)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 143.71
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4245)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.55` → IC=-0.256 (n=1279)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.55
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3839)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.97` → IC=-0.344 (n=1368)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.97
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2778)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.33` → IC=-0.287 (n=73)

  - _Acción_: SKIP cuando `py_entrada` < 0.33
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=265)
...
- **FILTRO** `py_entrada` < `0.44` → IC=-0.309 (n=40)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=146)
...
- **FILTRO** `py_entrada` > `0.3` → IC=-0.237 (n=55)

  - _Acción_: SKIP cuando `py_entrada` > 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.167 (n=28)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.196 (n=11281)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2779)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `10989.8106` → IC=+0.196 (n=888)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 10989.8106 (IC base=+0.097)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.245 (n=7524)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.170 (n=5508)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7081.6006` → IC=+0.174 (n=1743)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7081.6006 (IC base=+0.136)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1305)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.353 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1610)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `13114.3601` → IC=+0.212 (n=567)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13114.3601 (IC base=+0.203)
...
- **PATRÓN** `libro_liquidez` > `3843.42` → IC=+0.158 (n=419)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.126 (n=362)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 11.0 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.132 (n=523)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 17.0 (IC base=+0.124)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.220 (n=184)
...
- **PATRÓN** `libro_liquidez` > `1954.0278` → IC=+0.159 (n=347)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1954.0278 (IC base=+0.124)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.143 (n=662)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.178 (n=2084)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=2173)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.338 (n=158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.320)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.339 (n=135)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.320)

- **PATRÓN** `py_entrada` > `0.725` → IC=+0.362 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.320)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=2158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.181 (n=1827)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.183 (n=4715)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.267 (n=1638)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.205 (n=4244)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.203 (n=4213)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.255 (n=2164)
...
- **PATRÓN** `lag_apertura_s` < `4.3` → IC=+0.148 (n=1759)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 4.3 (IC base=+0.130)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.194 (n=1934)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.38 (IC base=+0.118)

- **PATRÓN** `restante_min` < `4.48` → IC=+0.127 (n=2385)

  - _Acción_: Kelly boost +0.64€ cuando `restante_min` < 4.48 (IC base=+0.118)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.148 (n=1964)
...
- **PATRÓN** `libro_liquidez` > `1367.6878` → IC=+0.290 (n=351)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9773` → IC=+0.231 (n=1933)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9773 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` < `0.2151` → IC=+0.248 (n=1186)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2151 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.703` → IC=+0.154 (n=3176)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 2.703 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` < `1.2306` → IC=+0.245 (n=1451)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2306 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `1.0731` → IC=+0.252 (n=658)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0731 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` < `0.1752` → IC=+0.193 (n=3911)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` < 0.1752 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.1099` → IC=+0.195 (n=1465)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1099 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `2.8549` → IC=+0.192 (n=3774)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.8549 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `1.4703` → IC=+0.195 (n=3774)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4703 (IC base=+0.098)

- **PATRÓN** `ibs_20min` < `0.574` → IC=+0.126 (n=7121)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.574 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` < `0.3316` → IC=+0.164 (n=2385)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.3316 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.162 (n=991)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6986 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `0.8713` → IC=+0.169 (n=1501)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.8713 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.2456` → IC=+0.222 (n=772)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2456 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `1.4667` → IC=+0.195 (n=3752)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4667 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `161.0` → IC=+0.204 (n=3518)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.183 (n=591)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.267 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.034` → IC=+0.279 (n=567)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.034 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2302` → IC=+0.194 (n=233)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2302 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `2.6298` → IC=+0.155 (n=1192)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.6298 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.163 (n=1192)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=1171)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.185 (n=946)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.240 (n=986)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `1910.32` → IC=+0.252 (n=324)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1097` → IC=+0.238 (n=433)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1097 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.231 (n=1029)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` > `0.9278` → IC=+0.252 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9278 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` > `0.2036` → IC=+0.221 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2036 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` < `0.1344` → IC=+0.215 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1344 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.875` → IC=+0.235 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.875 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.226 (n=984)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `0.8755` → IC=+0.217 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8755 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.0739` → IC=+0.219 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0739 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `1.4875` → IC=+0.231 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4875 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.4058` → IC=+0.216 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4058 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `11847.0948` → IC=+0.231 (n=879)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11847.0948 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.159 (n=925)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6762` → IC=+0.177 (n=1050)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6762 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1275` → IC=+0.157 (n=947)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1275 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.48` → IC=+0.178 (n=181)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 11.48 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.146 (n=1050)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2046 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.140 (n=1050)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6121 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1536` → IC=+0.198 (n=283)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1536 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.151 (n=941)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4138` → IC=+0.149 (n=941)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4138 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `12748.5243` → IC=+0.151 (n=700)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12748.5243 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `312.0` → IC=+0.153 (n=571)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 312.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.190 (n=1272)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3887` → IC=+0.232 (n=963)
...
- **PATRÓN** `libro_liquidez` > `1890.8984` → IC=+0.233 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1890.8984 (IC base=+0.212)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.200 (n=906)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1603)

- **PATRÓN** `ibs_20min` > `0.9316` → IC=+0.174 (n=271)
...
- **PATRÓN** `dist_vwap_pct` < `0.1808` → IC=+0.344 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1808 (IC base=+0.011)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.258` → IC=+0.136 (n=504)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4779` → IC=+0.352 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4779 (IC base=+0.011)
...
- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.350 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 165.0 (IC base=+0.011)

- **PATRÓN** `dist_vwap_pct` > `0.1577` → IC=+0.193 (n=174)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1577 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `0.8602` → IC=+0.141 (n=335)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8602 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` > `0.6106` → IC=+0.140 (n=501)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6106 (IC base=-0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.2153` → IC=+0.202 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2153 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` > `1.5033` → IC=+0.172 (n=404)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.5033 (IC base=-0.005)
...
- **FILTRO** `ibs_20min` > `0.28` → IC=-0.127 (n=1656)

  - _Acción_: SKIP cuando `ibs_20min` > 0.28
  - _Potencial_: sin este filtro IC_bueno=+0.114 (n=816)

- **FILTRO** `sigma_ewma_delta_pct` > `8.595` → IC=-0.201 (n=269)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.595
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2203)
...
- **PATRÓN** `volumen_regimen` > `0.9262` → IC=+0.181 (n=142)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 0.9262 (IC base=-0.047)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0864` → IC=+0.223 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0864 (IC base=-0.047)

- **PATRÓN** `volumen_spike_ratio` < `2.5473` → IC=+0.220 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5473 (IC base=-0.047)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.627` → IC=-0.192 (n=407)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.627
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=1224)

- **FILTRO** `ibs_20min` < `0.65` → IC=-0.160 (n=1074)

  - _Acción_: SKIP cuando `ibs_20min` < 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=557)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.197 (n=345)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1286)

- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.198 (n=617)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7761
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1853)

- **PATRÓN** `dist_vwap_pct` > `0.941` → IC=+0.348 (n=31)
...
- **PATRÓN** `volumen_regimen` > `0.616` → IC=+0.295 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.616 (IC base=-0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.0737` → IC=+0.295 (n=76)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7999` → IC=+0.281 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7999 (IC base=-0.085)

- **PATRÓN** `dist_vwap_pct` > `0.944` → IC=+0.269 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.944 (IC base=-0.032)

- **PATRÓN** `dist_vwap_pct` < `0.2456` → IC=+0.238 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2456 (IC base=-0.032)

- **PATRÓN** `volumen_regimen` < `0.728` → IC=+0.233 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.728 (IC base=-0.032)

- **PATRÓN** `volumen_regimen` > `1.0971` → IC=+0.303 (n=221)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2422` → IC=+0.257 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2422 (IC base=-0.032)

- **PATRÓN** `volumen_spike_ratio` > `1.5908` → IC=+0.232 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5908 (IC base=-0.032)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.174 (n=2415)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.009 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.4587` → IC=+0.175 (n=6463)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.4587 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `0.6902` → IC=+0.278 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6902 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.485` → IC=+0.142 (n=3429)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.485 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6746` → IC=+0.232 (n=2187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6746 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` > `0.2481` → IC=+0.253 (n=771)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2481 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` < `1.4784` → IC=+0.233 (n=1299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4784 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` > `2.7883` → IC=+0.235 (n=1297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7883 (IC base=+0.086)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.276 (n=3375)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 103.0 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.135 (n=2485)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0083 (IC base=+0.065)

- **PATRÓN** `ibs_20min` < `0.5603` → IC=+0.147 (n=6547)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.5603 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.8959` → IC=+0.233 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8959 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.1596` → IC=+0.229 (n=1811)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1596 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `1.2033` → IC=+0.255 (n=655)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2033 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.2523` → IC=+0.323 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2523 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `1.6295` → IC=+0.249 (n=1122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6295 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` > `2.3871` → IC=+0.254 (n=1156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3871 (IC base=+0.065)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.251 (n=2405)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.065)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2365` → IC=-0.147 (n=488)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2365
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1467)

- **FILTRO** `sigma_ewma_delta_pct` > `4.409` → IC=-0.157 (n=380)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.409
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1262)

- **PATRÓN** `ibs_20min` > `0.8641` → IC=+0.252 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8641 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.963` → IC=+0.165 (n=514)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8558` → IC=+0.189 (n=336)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.8558 (IC base=+0.038)

- **PATRÓN** `volumen_spike_ratio` > `1.4486` → IC=+0.181 (n=503)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4486 (IC base=+0.038)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.205 (n=408)
...
- **FILTRO** `ibs_20min` > `0.8333` → IC=-0.151 (n=549)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1650)

- **PATRÓN** `dist_vwap_pct` > `0.2987` → IC=+0.129 (n=238)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.2987 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.6498` → IC=+0.131 (n=561)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.6498 (IC base=+0.009)
...
- **PATRÓN** `dist_vwap_pct` < `0.1506` → IC=+0.213 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1506 (IC base=-0.003)

- **PATRÓN** `volumen_regimen` > `1.1434` → IC=+0.225 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1434 (IC base=-0.003)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7946` → IC=+0.227 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7946 (IC base=-0.003)

- **PATRÓN** `volumen_spike_ratio` > `2.1554` → IC=+0.227 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1554 (IC base=-0.003)

- **PATRÓN** `ballena_activa_n` < `513.0` → IC=+0.210 (n=308)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 513.0 (IC base=-0.003)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.267 (n=1032)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.502` → IC=+0.265 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.502 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.1109` → IC=+0.257 (n=960)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1109 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` < `2.3547` → IC=+0.240 (n=713)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.3547 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `1.6762` → IC=+0.241 (n=1069)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6762 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.255 (n=1297)
...
- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.286 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3388 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.884` → IC=+0.298 (n=354)
...
- **PATRÓN** `libro_liquidez` > `1881.2284` → IC=+0.299 (n=306)
...
- **FILTRO** `ibs_20min` < `0.2335` → IC=-0.215 (n=324)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=975)

- **FILTRO** `ibs_20min` > `0.8223` → IC=-0.177 (n=431)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8223
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1296)

- **PATRÓN** `ibs_20min` > `0.8027` → IC=+0.142 (n=442)
...
- **PATRÓN** `volumen_regimen` < `0.9407` → IC=+0.221 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9407 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.192 (n=248)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.6129 (IC base=-0.017)

- **PATRÓN** `volumen_pendiente_norm` > `0.266` → IC=+0.344 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.266 (IC base=-0.017)

- **PATRÓN** `volumen_spike_ratio` < `1.4909` → IC=+0.281 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4909 (IC base=-0.017)

- **PATRÓN** `ballena_activa_n` < `171.0` → IC=+0.238 (n=254)
...
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.201 (n=783)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6667
  - _Potencial_: sin este filtro IC_bueno=+0.248 (n=792)

- **FILTRO** `ibs_20min` > `0.72` → IC=-0.236 (n=419)

  - _Acción_: SKIP cuando `ibs_20min` > 0.72
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1260)

- **FILTRO** `sigma_ewma_delta_pct` > `4.704` → IC=-0.167 (n=397)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.704
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=1282)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.248 (n=792)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6667 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1802` → IC=+0.309 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1802 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.282 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.636` → IC=+0.271 (n=540)
...
- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.318 (n=437)
...
- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.322 (n=668)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9043` → IC=+0.340 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9043 (IC base=+0.266)

- **PATRÓN** `dist_vwap_pct` > `0.2561` → IC=+0.316 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2561 (IC base=+0.266)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.371` → IC=+0.294 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.371 (IC base=+0.266)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.79` → IC=+0.266 (n=1100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.79 (IC base=+0.266)

- **PATRÓN** `volumen_regimen` > `0.6806` → IC=+0.284 (n=896)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6806 (IC base=+0.266)

- **PATRÓN** `volumen_pendiente_norm` < `0.1097` → IC=+0.270 (n=877)
...
- **PATRÓN** `ibs_20min` < `0.3875` → IC=+0.303 (n=1087)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3875 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` > `0.5192` → IC=+0.280 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5192 (IC base=+0.265)
...
- **PATRÓN** `libro_liquidez` > `2553.3356` → IC=+0.276 (n=725)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3315` → IC=+0.174 (n=5076)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3315 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6018)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.6961` → IC=+0.230 (n=5153)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6961 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.1628` → IC=+0.197 (n=2537)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1628 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.217` → IC=+0.247 (n=1191)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.217 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.2156` → IC=+0.165 (n=3855)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2156 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6216` → IC=+0.161 (n=3855)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6216 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.1068` → IC=+0.186 (n=2250)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1068 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `2.313` → IC=+0.170 (n=4814)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.313 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `3820.3005` → IC=+0.176 (n=1923)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3820.3005 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.185 (n=4679)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 124.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.185 (n=3708)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0063 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.0783` → IC=+0.204 (n=1849)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.206 (n=437)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.3147` → IC=+0.205 (n=964)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.302 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.034` → IC=+0.307 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.034 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` > `0.2294` → IC=+0.235 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2294 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` < `2.5605` → IC=+0.183 (n=873)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.5605 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.181 (n=873)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.211 (n=876)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.242 (n=614)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_spike_ratio` < `1.8747` → IC=+0.252 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8747 (IC base=+0.238)
...
- **PATRÓN** `ballena_activa_n` < `45.0` → IC=+0.240 (n=394)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3568` → IC=+0.181 (n=835)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.3568 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.202 (n=572)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.45` → IC=+0.225 (n=835)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.45 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.218 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.681` → IC=+0.228 (n=226)
...
- **PATRÓN** `libro_liquidez` > `11189.3992` → IC=+0.193 (n=746)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11189.3992 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `408.0` → IC=+0.165 (n=666)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 408.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.179 (n=829)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0049 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.286` → IC=+0.167 (n=943)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.286 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=868)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 7.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.5163` → IC=+0.193 (n=943)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.5163 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.089` → IC=+0.211 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.089 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.162 (n=943)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2089 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.193 (n=288)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.4411` → IC=+0.159 (n=833)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4411 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.4146` → IC=+0.153 (n=833)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4146 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `233.0` → IC=+0.158 (n=252)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 233.0 (IC base=+0.148)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.197 (n=951)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0058 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.1928` → IC=+0.195 (n=634)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.1928 (IC base=+0.189)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.282 (n=507)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1074` → IC=+0.188 (n=780)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1074 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.6848` → IC=+0.183 (n=295)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.203 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.236 (n=796)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3486` → IC=+0.250 (n=795)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3486 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.666` → IC=+0.269 (n=327)
...
- **PATRÓN** `libro_liquidez` > `1889.7284` → IC=+0.245 (n=265)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.156 (n=850)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.006 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3707` → IC=+0.141 (n=965)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.596` → IC=+0.177 (n=965)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.596 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.1469` → IC=+0.140 (n=958)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.1469 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.181` → IC=+0.189 (n=191)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 12.181 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.133 (n=644)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8615 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.128 (n=965)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.6129 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2894` → IC=+0.194 (n=142)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2894 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.7931` → IC=+0.126 (n=568)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.7931 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4695` → IC=+0.147 (n=284)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 2.4695 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9883.3938` → IC=+0.150 (n=438)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 9883.3938 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.147 (n=723)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0077 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=1111)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.194 (n=1082)
...
- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.122 (n=1083)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=1110)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2898.521` → IC=+0.194 (n=491)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.140 (n=711)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0072 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.172 (n=486)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 15.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.5417` → IC=+0.207 (n=1063)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5417 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.1882` → IC=+0.134 (n=977)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1882 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.335` → IC=+0.155 (n=227)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.335 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.0447` → IC=+0.125 (n=935)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0447 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2754` → IC=+0.185 (n=128)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2754 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.574` → IC=+0.127 (n=405)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.574 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.177` → IC=+0.141 (n=418)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.177 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3082.5359` → IC=+0.157 (n=354)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3082.5359 (IC base=+0.112)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` < `0.0271` → IC=+0.201 (n=1032)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0271 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0177` → IC=+0.209 (n=688)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0177 (IC base=+0.200)

- **PATRÓN** `drift_60min` |x|≤ `0.1642` → IC=+0.219 (n=454)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1642 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1069)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.250 (n=927)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.339` → IC=+0.240 (n=495)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.339 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.205 (n=1033)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.8543` → IC=+0.219 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8543 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2414` → IC=+0.263 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2414 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.199` → IC=+0.215 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.199 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.8207` → IC=+0.205 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8207 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.203 (n=1057)
...
- **PATRÓN** `ibs_20min` < `0.4309` → IC=+0.238 (n=1087)
...
- **PATRÓN** `dist_vwap_pct` < `0.2572` → IC=+0.204 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2572 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.721` → IC=+0.229 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.721 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6302` → IC=+0.215 (n=1086)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6302 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2822` → IC=+0.282 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2822 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `2.2526` → IC=+0.195 (n=837)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2526 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4624` → IC=+0.188 (n=951)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.4624 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2514.0359` → IC=+0.209 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2514.0359 (IC base=+0.201)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.155 (n=622)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0072 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.0946` → IC=+0.154 (n=458)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0946 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.188 (n=678)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.4019` → IC=+0.170 (n=1372)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4019 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.784` → IC=+0.188 (n=190)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.784 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.734` → IC=+0.169 (n=620)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.734 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.8639` → IC=+0.160 (n=785)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8639 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.1656` → IC=+0.167 (n=376)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1656 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `1.4361` → IC=+0.158 (n=437)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4361 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.8234` → IC=+0.152 (n=874)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8234 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.148 (n=1519)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `8146.3351` → IC=+0.170 (n=622)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 8146.3351 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.168 (n=399)
...
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.122 (n=1033)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 10.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.6298` → IC=+0.138 (n=1418)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.6298 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.836` → IC=+0.127 (n=556)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2392` → IC=+0.124 (n=1190)
...
- **PATRÓN** `sigma_h` < `0.0232` → IC=+0.169 (n=164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0232 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.3271` → IC=+0.164 (n=144)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3271 (IC base=+0.150)
...
- **PATRÓN** `ibs_20min` > `0.75` → IC=+0.194 (n=109)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.75 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.2393` → IC=+0.167 (n=79)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.2393 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.9721` → IC=+0.151 (n=196)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.9721 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.767` → IC=+0.192 (n=131)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.767 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.9954` → IC=+0.151 (n=144)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.9954 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.8813` → IC=+0.167 (n=109)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.8813 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` < `0.1263` → IC=+0.174 (n=130)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` < 0.1263 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.2604` → IC=+0.188 (n=123)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.2604 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.176 (n=174)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.02 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `2722.5042` → IC=+0.162 (n=75)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2722.5042 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.209 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 21.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.022` → IC=+0.155 (n=82)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.022 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.132 (n=131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 9.0 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `1.0807` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 1.0807 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.381` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.381 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0747` → IC=+0.131 (n=82)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 1.0747 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.2451` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2451 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `2.8612` → IC=+0.138 (n=56)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.8612 (IC base=+0.106)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.193 (n=3292)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0085 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7583)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4762` → IC=+0.213 (n=7259)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4762 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.8807` → IC=+0.200 (n=960)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8807 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.220 (n=3565)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.165 (n=3271)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8827 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2399` → IC=+0.184 (n=1382)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2399 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6455` → IC=+0.180 (n=2298)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.6455 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=8650)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.04 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3774.9265` → IC=+0.174 (n=2418)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3774.9265 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.194 (n=5186)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 96.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.194 (n=4444)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0066 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.4713` → IC=+0.182 (n=6659)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5593` → IC=+0.237 (n=6659)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5593 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2292` → IC=+0.164 (n=4189)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2292 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.826` → IC=+0.198 (n=968)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.826 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.703` → IC=+0.154 (n=2024)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.703 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2024` → IC=+0.163 (n=1533)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.2024 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.251 (n=866)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.3057` → IC=+0.190 (n=2690)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3057 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.175 (n=5531)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.230 (n=553)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.814` → IC=+0.315 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.814 (IC base=+0.194)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5578` → IC=+0.196 (n=495)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.5578 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.589` → IC=+0.190 (n=375)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.589 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.223 (n=1079)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.194)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.220 (n=881)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.263 (n=843)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.268 (n=866)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.257)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.257 (n=886)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.257)

- **PATRÓN** `ibs_20min` < `0.3509` → IC=+0.289 (n=843)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3509 (IC base=+0.257)
...
- **PATRÓN** `volumen_spike_ratio` > `2.705` → IC=+0.291 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.705 (IC base=+0.257)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.258 (n=977)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `1910.32` → IC=+0.273 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1910.32 (IC base=+0.257)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.254 (n=799)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1796` → IC=+0.159 (n=766)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.1796 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1202)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.6972` → IC=+0.246 (n=766)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6972 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.3381` → IC=+0.201 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3381 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.858` → IC=+0.162 (n=270)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 9.858 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.396` → IC=+0.155 (n=1017)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.396 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.2802` → IC=+0.163 (n=1149)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2802 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.154` → IC=+0.182 (n=316)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.154 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.4495` → IC=+0.162 (n=1096)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4495 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.7614` → IC=+0.159 (n=730)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7614 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `10634.3743` → IC=+0.172 (n=1026)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 10634.3743 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `497.0` → IC=+0.166 (n=1027)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3181` → IC=+0.168 (n=1022)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6377` → IC=+0.206 (n=1022)
...
- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.163 (n=1022)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1917 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1496` → IC=+0.217 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1496 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.4156` → IC=+0.169 (n=925)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.4156 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `317.0` → IC=+0.164 (n=364)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 317.0 (IC base=+0.155)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.226 (n=1140)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.217 (n=1198)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.250 (n=1019)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6739 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.443` → IC=+0.288 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.443 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` < `0.1407` → IC=+0.221 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1407 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `1.6784` → IC=+0.220 (n=1063)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6784 (IC base=+0.212)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.228 (n=1286)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.212)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.234 (n=854)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 60.0 (IC base=+0.212)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.232 (n=1103)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1476` → IC=+0.230 (n=486)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3768` → IC=+0.268 (n=971)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3768 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.713` → IC=+0.273 (n=394)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7946` → IC=+0.216 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7946 (IC base=+0.228)
...
- **PATRÓN** `libro_liquidez` > `1893.9584` → IC=+0.232 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1893.9584 (IC base=+0.228)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.224 (n=600)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.31` → IC=+0.170 (n=528)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 4.31 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8808` → IC=+0.163 (n=819)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8808 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2725` → IC=+0.230 (n=176)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4628` → IC=+0.163 (n=393)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.4628 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8917.6013` → IC=+0.234 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8917.6013 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.165 (n=658)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.005 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.4237` → IC=+0.151 (n=985)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6885` → IC=+0.185 (n=985)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6885 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.3472` → IC=+0.136 (n=1003)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.3472 (IC base=+0.132)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.283` → IC=+0.132 (n=918)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 4.283 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.8594` → IC=+0.136 (n=657)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8594 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.151 (n=328)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.1808 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.2771` → IC=+0.263 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2771 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.5583` → IC=+0.138 (n=404)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5583 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `2.4663` → IC=+0.166 (n=306)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.4663 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `11073.7628` → IC=+0.182 (n=328)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 11073.7628 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.137 (n=908)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 196.0 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` > `0.4634` → IC=+0.174 (n=1260)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.4634 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.9931` → IC=+0.174 (n=219)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.9931 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.395` → IC=+0.213 (n=469)
...
- **PATRÓN** `libro_liquidez` > `2917.745` → IC=+0.244 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2917.745 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.124 (n=919)
...
- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.210 (n=1198)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.1923` → IC=+0.135 (n=971)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1923 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.497` → IC=+0.126 (n=1099)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.218` → IC=+0.176 (n=183)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.218 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.4682` → IC=+0.149 (n=348)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4682 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.2318` → IC=+0.124 (n=472)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.2318 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2933.7762` → IC=+0.166 (n=399)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2933.7762 (IC base=+0.115)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.216 (n=575)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1325)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.205 (n=1134)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.310 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.1818` → IC=+0.237 (n=731)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1818 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.539` → IC=+0.241 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.539 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `1.2439` → IC=+0.206 (n=1269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2439 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6237` → IC=+0.209 (n=1269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6237 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2377` → IC=+0.235 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2377 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `2.6028` → IC=+0.235 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6028 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1285)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2555.5796` → IC=+0.211 (n=846)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2555.5796 (IC base=+0.205)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.203 (n=1309)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.197)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.199 (n=1481)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` < `0.505` → IC=+0.251 (n=1397)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.505 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` < `0.2641` → IC=+0.204 (n=1294)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2641 (IC base=+0.197)
...
- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.241 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.233 (IC base=+0.197)
...
- **PATRÓN** `volumen_spike_ratio` < `2.24` → IC=+0.190 (n=1073)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.24 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.4468` → IC=+0.195 (n=1219)
...
- **PATRÓN** `libro_liquidez` > `2531.064` → IC=+0.199 (n=931)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2531.064 (IC base=+0.197)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=2463)

- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.151 (n=2073)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0097 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.5293` → IC=+0.151 (n=2352)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.5293 (IC base=+0.141)
...
- **PATRÓN** `ibs_20min` > `0.9351` → IC=+0.207 (n=784)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9351 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.1894` → IC=+0.152 (n=802)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1894 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.729` → IC=+0.158 (n=750)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 5.729 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.7125` → IC=+0.128 (n=651)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.7125 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.9041` → IC=+0.144 (n=985)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.9041 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.1732` → IC=+0.171 (n=646)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1732 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `1.4578` → IC=+0.155 (n=776)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4578 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.9026` → IC=+0.157 (n=1551)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.9026 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `8476.5104` → IC=+0.150 (n=1066)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8476.5104 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.195 (n=621)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0037 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.479` → IC=+0.160 (n=1859)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.479 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` < `0.1827` → IC=+0.163 (n=819)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.1827 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6994` → IC=+0.142 (n=325)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6994 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.27` → IC=+0.147 (n=1838)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3657` → IC=+0.151 (n=854)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.6015` → IC=+0.164 (n=114)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.6015 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.225` → IC=+0.163 (n=834)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.225 (IC base=+0.138)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5773` → IC=+0.146 (n=851)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.5773 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.824` → IC=+0.152 (n=567)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.824 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `12056.8052` → IC=+0.150 (n=763)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12056.8052 (IC base=+0.138)
...
- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.195 (n=254)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0102 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.4173` → IC=+0.175 (n=493)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.4173 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.217 (n=210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.9934` → IC=+0.241 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9934 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.311` → IC=+0.222 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.311 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2085` → IC=+0.203 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2085 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `3.4649` → IC=+0.167 (n=559)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 3.4649 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.3086` → IC=+0.177 (n=373)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.3086 (IC base=+0.166)
...
- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.148 (n=699)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0088 (IC base=+0.139)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.142 (n=699)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0045 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4959` → IC=+0.148 (n=699)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.4959 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` > `0.7986` → IC=+0.165 (n=317)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.7986 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.9801` → IC=+0.184 (n=153)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.9801 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.4234` → IC=+0.145 (n=654)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.4234 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.807` → IC=+0.148 (n=697)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.807 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1119` → IC=+0.147 (n=615)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.1119 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.6454` → IC=+0.139 (n=699)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4364` → IC=+0.162 (n=229)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4364 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=647)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `8850.2598` → IC=+0.155 (n=624)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 8850.2598 (IC base=+0.139)
...
### GBM_LATE_60M
- **FILTRO** `ibs_20min` < `0.6355` → IC=-0.161 (n=172)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6355
  - _Potencial_: sin este filtro IC_bueno=+0.206 (n=518)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.187 (n=407)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.6355` → IC=+0.206 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6355 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.1296` → IC=+0.157 (n=272)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1296 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.269` → IC=+0.215 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.269 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `0.6265` → IC=+0.130 (n=228)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 0.6265 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2901` → IC=+0.229 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2901 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `2.5485` → IC=+0.146 (n=413)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.5485 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.135 (n=417)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2444.1883` → IC=+0.164 (n=224)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2444.1883 (IC base=+0.097)
...
- **FILTRO** `ibs_20min` < `0.6407` → IC=-0.177 (n=60)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6407
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.164 (n=141)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0048 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.125 (n=198)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 7.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.6407` → IC=+0.236 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6407 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.1209` → IC=+0.173 (n=96)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.1209 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.109` → IC=+0.312 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.109 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.789` → IC=+0.159 (n=121)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.789 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` > `0.9231` → IC=+0.143 (n=82)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.9231 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.3066` → IC=+0.241 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3066 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `1.3845` → IC=+0.149 (n=132)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.3845 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=189)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `1064.9876` → IC=+0.179 (n=157)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 1064.9876 (IC base=+0.111)
...
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.185 (n=52)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.182 (n=64)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.005 (IC base=+0.070)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.131 (n=128)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 14.0 (IC base=+0.070)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.183 (n=162)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.6667 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.8462` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.8462 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.626` → IC=+0.185 (n=87)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 3.626 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `0.9509` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.9509 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `2.5513` → IC=+0.160 (n=142)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.5513 (IC base=+0.070)

- **PATRÓN** `libro_liquidez` > `393.6556` → IC=+0.145 (n=139)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 393.6556 (IC base=+0.070)
...
- **PATRÓN** `ibs_20min` > `0.6466` → IC=+0.144 (n=203)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.6466 (IC base=+0.059)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.133 (n=96)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 15.0 (IC base=+0.045)

- **PATRÓN** `ibs_20min` < `0.234` → IC=+0.132 (n=183)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.234 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.007` → IC=+0.148 (n=89)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 6.007 (IC base=+0.045)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.230 (n=35)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.095)

- **PATRÓN** `ibs_20min` < `0.1361` → IC=+0.179 (n=79)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.1361 (IC base=+0.095)
...
- **PATRÓN** `ibs_20min` < `0.2075` → IC=+0.125 (n=62)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.2075 (IC base=+0.026)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.26` → IC=+0.300 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.26 (IC base=+0.026)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=455)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.106)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.122 (n=424)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1278)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=5931)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1226)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.176 (n=2478)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=7526)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.170 (n=2573)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=7788)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.216 (n=403)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.089 (n=1265)

- **FILTRO** `ibs_20min` < `0.748` → IC=-0.177 (n=416)

  - _Acción_: SKIP cuando `ibs_20min` < 0.748
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1252)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.194 (n=432)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1299)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.218 (n=431)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1384)

- **FILTRO** `ibs_20min` > `0.2874` → IC=-0.175 (n=453)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2874
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1362)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.198 (n=399)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1246)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.189 (n=452)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=1375)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2219)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2186)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2192)
...
- **FILTRO** `ibs_20min` > `0.9752` → IC=-0.214 (n=47)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.123 (n=144)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=7236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=16408)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.274 (n=5875)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=17769)

- **FILTRO** `ibs_7min` < `0.7089` → IC=-0.236 (n=5908)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7089
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=17736)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.160 (n=7908)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=15736)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.223 (n=7357)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=22142)

- **FILTRO** `ibs_7min` > `0.2987` → IC=-0.177 (n=7374)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2987
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=22125)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.316 (n=883)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2857)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.260 (n=1232)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2508)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=3466)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1676)

- **FILTRO** `drift_7min_pct` |x|> `0.1341` → IC=-0.130 (n=1284)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1341
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3858)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.203 (n=1285)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3857)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.141 (n=956)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=3201)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.250 (n=1038)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3119)

- **FILTRO** `ibs_7min` < `0.7612` → IC=-0.184 (n=1039)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7612
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=3118)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.170 (n=1037)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3120)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=973)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3204)

- **FILTRO** `ibs_7min` > `0.2516` → IC=-0.173 (n=1044)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2516
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3133)

- **FILTRO** `ballena_activa_n` > `113.0` → IC=-0.160 (n=1417)

  - _Acción_: SKIP cuando `ballena_activa_n` > 113.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2760)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.182 (n=859)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=2672)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.323 (n=832)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2699)

- **FILTRO** `drift_7min_pct` |x|> `0.1836` → IC=-0.132 (n=1199)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1836
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=2332)

- **FILTRO** `ibs_7min` < `0.2045` → IC=-0.274 (n=881)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2045
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2650)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.215 (n=876)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=2655)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.232 (n=1264)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4124)

- **FILTRO** `ibs_7min` > `0.2666` → IC=-0.157 (n=1831)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2666
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3557)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1232)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2661)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.249 (n=933)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2960)

- **FILTRO** `ibs_7min` < `0.7475` → IC=-0.190 (n=972)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7475
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=2921)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.185 (n=962)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=2931)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=971)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=2990)

- **FILTRO** `ibs_7min` > `0.2769` → IC=-0.171 (n=990)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2769
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2971)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.179 (n=977)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2984)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.237 (n=1042)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3281)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.205 (n=1070)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3253)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.176 (n=1352)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4228)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=945)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3055)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.224 (n=999)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3001)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.200 (n=987)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3013)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.200 (n=1264)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=3987)
...
- **PATRÓN** `total_vol_5m` < `7209.018` → IC=+0.167 (n=109)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `total_vol_5m` < 7209.018 (IC base=+0.164)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=2241)
...
- **PATRÓN** `ibs_15` > `0.6176` → IC=+0.243 (n=1017)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6176 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.1056` → IC=+0.176 (n=664)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1056 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.825` → IC=+0.253 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.825 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `5030.3765` → IC=+0.185 (n=462)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 5030.3765 (IC base=+0.172)

### UPDOWN_GBM#60min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=302)

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.213 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.198)

- **PATRÓN** `drift_60min` |x|≤ `0.0625` → IC=+0.250 (n=86)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0625 (IC base=+0.198)

- **PATRÓN** `drift_15min` |x|≤ `0.3748` → IC=+0.204 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3748 (IC base=+0.198)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2457` → IC=+0.216 (n=86)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2457 (IC base=+0.198)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.382` → IC=+0.230 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.382 (IC base=+0.198)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.213 (n=266)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.199 (n=267)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `ibs_15` > `0.7746` → IC=+0.267 (n=230)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7746 (IC base=+0.198)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.239 (n=67)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.472` → IC=+0.259 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.472 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `13625.3561` → IC=+0.256 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13625.3561 (IC base=+0.198)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0736` → IC=+0.157 (n=106)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0736 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1911` → IC=+0.185 (n=109)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.92€ cuando `delta_ratio_macro` |x|> 0.1911 (IC base=+0.140)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2712` → IC=+0.171 (n=150)

  - _Acción_: Kelly boost +0.86€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2712 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.154 (n=241)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 16.0 (IC base=+0.140)

- **PATRÓN** `ibs_15` > `0.6966` → IC=+0.260 (n=215)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6966 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.4093` → IC=+0.159 (n=250)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.4093 (IC base=+0.140)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=284)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `10110.2635` → IC=+0.149 (n=109)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 10110.2635 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0224` → IC=+0.258 (n=97)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0224 (IC base=+0.174)

- **PATRÓN** `drift_60min` |x|≤ `0.0857` → IC=+0.195 (n=129)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.0857 (IC base=+0.174)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0459` → IC=+0.186 (n=291)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.93€ cuando `delta_ratio_macro` |x|> 0.0459 (IC base=+0.174)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.093` → IC=+0.279 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.093 (IC base=+0.174)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.229 (n=142)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.174)

- **PATRÓN** `ibs_15` > `0.5354` → IC=+0.271 (n=291)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5354 (IC base=+0.174)

- **PATRÓN** `dist_vwap_pct` > `0.1729` → IC=+0.200 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1729 (IC base=+0.174)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.796` → IC=+0.214 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.796 (IC base=+0.174)

- **PATRÓN** `libro_liquidez` > `2711.8232` → IC=+0.224 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2711.8232 (IC base=+0.174)
...
- **FILTRO** `sigma_h` > `0.0124` → IC=-0.193 (n=513)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `ibs_15` < `0.5909` → IC=-0.188 (n=171)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.252 (n=515)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.166 (n=644)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1410)
...
- **PATRÓN** `ibs_15` > `0.5909` → IC=+0.252 (n=515)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5909 (IC base=-0.055)

- **PATRÓN** `dist_vwap_pct` < `0.266` → IC=+0.174 (n=400)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.266 (IC base=-0.055)

- **PATRÓN** `delta_ratio_macro` |x|> `0.119` → IC=+0.233 (n=680)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.119 (IC base=-0.051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.182` → IC=+0.232 (n=647)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.182 (IC base=-0.051)

- **PATRÓN** `ibs_15` < `0.3561` → IC=+0.274 (n=1021)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3561 (IC base=-0.051)

- **PATRÓN** `dist_vwap_pct` > `0.8488` → IC=+0.257 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8488 (IC base=-0.051)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.216 (n=304)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.202 (n=913)

- **FILTRO** `sigma_h` < `0.0032` → IC=-0.239 (n=304)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.194 (n=913)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.220 (n=772)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=445)

- **FILTRO** `sigma_ewma_delta_pct` > `19.895` → IC=-0.244 (n=221)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.895
  - _Potencial_: sin este filtro IC_bueno=-0.196 (n=996)

- **PATRÓN** `sigma_h` < `0.003` → IC=+0.164 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.003 (IC base=+0.076)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1967` → IC=+0.269 (n=50)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1967 (IC base=+0.076)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1422` → IC=+0.287 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1422 (IC base=+0.076)

- **PATRÓN** `ibs_15` > `0.7946` → IC=+0.351 (n=99)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7946 (IC base=+0.076)

- **PATRÓN** `dist_vwap_pct` < `0.34` → IC=+0.270 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.34 (IC base=+0.076)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.237 (n=283)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.3466` → IC=+0.225 (n=373)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3466 (IC base=+0.217)

- **PATRÓN** `drift_15min` |x|≤ `0.7479` → IC=+0.217 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7479 (IC base=+0.217)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2029` → IC=+0.242 (n=192)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2029 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.228 (n=288)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.217)

- **PATRÓN** `ibs_15` < `0.3657` → IC=+0.265 (n=424)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3657 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` > `0.7113` → IC=+0.245 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7113 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.638` → IC=+0.239 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.638 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.013` → IC=+0.218 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.013 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `3621.1646` → IC=+0.220 (n=423)
...
- **PATRÓN** `ibs_15` < `0.3273` → IC=+0.292 (n=296)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3273 (IC base=-0.052)

- **PATRÓN** `dist_vwap_pct` > `1.0282` → IC=+0.397 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0282 (IC base=-0.052)
...
- **PATRÓN** `sigma_h` > `0.0052` → IC=+0.291 (n=228)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0052 (IC base=+0.288)

- **PATRÓN** `drift_60min` |x|≤ `0.058` → IC=+0.318 (n=168)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.058 (IC base=+0.288)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1901` → IC=+0.314 (n=229)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1901 (IC base=+0.288)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1083` → IC=+0.320 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1083 (IC base=+0.288)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.303 (n=520)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.288)

- **PATRÓN** `ibs_15` > `0.8357` → IC=+0.329 (n=501)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8357 (IC base=+0.288)

- **PATRÓN** `dist_vwap_pct` > `0.2698` → IC=+0.322 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2698 (IC base=+0.288)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.837` → IC=+0.312 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.837 (IC base=+0.288)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.292 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.288)

- **PATRÓN** `libro_liquidez` > `12383.1611` → IC=+0.317 (n=228)
...
- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.292 (n=94)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2454` → IC=+0.323 (n=94)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2454 (IC base=+0.281)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3622` → IC=+0.294 (n=212)
...
- **PATRÓN** `ibs_15` > `0.8593` → IC=+0.309 (n=250)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8593 (IC base=+0.281)

- **PATRÓN** `dist_vwap_pct` > `0.263` → IC=+0.336 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.263 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` > `24.027` → IC=+0.331 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 24.027 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `11986.1796` → IC=+0.315 (n=187)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6176 sube el IC de +0.172 a +0.243 en UPDOWN_GBM#15min (n=1017). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7746 sube el IC de +0.198 a +0.267 en UPDOWN_GBM#BTC#15min (n=230). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6966 sube el IC de +0.140 a +0.260 en UPDOWN_GBM#ETH#15min (n=215). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5354 sube el IC de +0.174 a +0.271 en UPDOWN_GBM#XRP#15min (n=291). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5909 sube el IC de -0.055 a +0.252 en UPDOWN_GBM_15M_TARDIO (n=515). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3561 sube el IC de -0.051 a +0.274 en UPDOWN_GBM_15M_TARDIO (n=1021). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7946 sube el IC de +0.076 a +0.351 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=99). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3657 sube el IC de +0.217 a +0.265 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=424). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3273 sube el IC de -0.052 a +0.292 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=296). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8357 sube el IC de +0.288 a +0.329 en UPDOWN_GBM_IBS_ALTO (n=501). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8593 sube el IC de +0.281 a +0.309 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=250). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 19562 | -0.107 | -2820.73€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1168 | -0.029 | -188.64€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 18394 | -0.112 | -2632.09€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3096 | -0.123 | -558.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3096 | -0.123 | -558.13€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1168 | -0.029 | -188.64€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1168 | -0.029 | -188.64€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 5660 | -0.054 | -530.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5660 | -0.054 | -530.71€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5118 | -0.114 | -412.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5118 | -0.114 | -412.28€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4146 | -0.177 | -969.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4146 | -0.177 | -969.93€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 11023 | -0.045 | +4286.17€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 2989 | -0.008 | +1848.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 8034 | -0.059 | +2437.62€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 11023 | -0.045 | +4286.17€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 2989 | -0.008 | +1848.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 8034 | -0.059 | +2437.62€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 637 | -0.114 | -119.52€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 29 | -0.081 | -5.81€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 608 | -0.115 | -113.72€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 18 | -0.090 | +0.90€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 18 | -0.090 | +0.90€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 370 | -0.078 | -57.20€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 19 | -0.113 | -5.35€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 351 | -0.075 | -51.84€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 171 | -0.194 | -52.88€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 10 | +0.000 | -0.45€ | 0 | 0 |
| 🚫 CANDIDATA9_BOT_CONSENSO#ETH#5min | 161 | -0.205 | -52.43€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 46 | -0.062 | -6.87€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 46 | -0.062 | -6.87€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 32 | -0.147 | -3.48€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 32 | -0.147 | -3.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 70762 | +0.113 | -3748.91€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 11174 | +0.182 | -376.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 271 | -0.115 | -48.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 54350 | +0.100 | -3228.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 4967 | +0.116 | -95.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 9061 | +0.096 | -874.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 36 | -0.158 | -1.29€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 9010 | +0.097 | -861.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 14314 | +0.132 | -280.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3396 | +0.201 | -113.19€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 9006 | +0.110 | -167.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1870 | +0.117 | +22.98€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 9101 | +0.088 | -917.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 43 | -0.056 | -3.06€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 9043 | +0.090 | -903.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 15165 | +0.125 | -290.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4297 | +0.170 | -88.16€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 9073 | +0.109 | -147.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1783 | +0.099 | -46.44€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 14045 | +0.117 | -809.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3366 | +0.186 | -175.35€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 174 | -0.068 | +5.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 9191 | +0.092 | -567.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1314 | +0.138 | -72.05€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 9076 | +0.101 | -576.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 36 | -0.026 | +4.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 9027 | +0.102 | -580.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 11201 | +0.189 | -766.57€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 11201 | +0.189 | -766.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2768 | +0.168 | -300.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2768 | +0.168 | -300.41€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 516 | +0.189 | +19.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 516 | +0.189 | +19.77€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2723 | +0.176 | -255.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2723 | +0.176 | -255.62€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2449 | +0.238 | -67.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2449 | +0.238 | -67.20€ | 0 | 4 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2666 | +0.191 | -176.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2666 | +0.191 | -176.87€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 38202 | +0.194 | -3260.72€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 38202 | +0.194 | -3260.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 6668 | +0.166 | -883.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 6668 | +0.166 | -883.77€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 6033 | +0.224 | -218.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 6033 | +0.224 | -218.35€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 6622 | +0.168 | -852.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 6622 | +0.168 | -852.70€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 6139 | +0.218 | -258.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 6139 | +0.218 | -258.64€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 6309 | +0.201 | -440.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 6309 | +0.201 | -440.66€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 6431 | +0.190 | -606.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 6431 | +0.190 | -606.60€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 14180 | +0.124 | +277.29€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 14180 | +0.124 | +277.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 7028 | +0.130 | +204.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 7028 | +0.130 | +204.29€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 7152 | +0.118 | +73.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 7152 | +0.118 | +73.00€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1206 | +0.286 | -26.96€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1206 | +0.286 | -26.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 534 | +0.272 | -20.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 534 | +0.272 | -20.46€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 574 | +0.290 | -5.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 574 | +0.290 | -5.27€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 534 | +0.429 | -9.31€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 534 | +0.429 | -9.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC | 249 | +0.428 | -4.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min | 249 | +0.428 | -4.96€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 800 | +0.067 | -44.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 281 | +0.065 | -20.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 519 | +0.068 | -23.73€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 624 | +0.075 | -21.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 105 | +0.107 | +2.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 519 | +0.068 | -23.73€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 24734 | +0.098 | -772.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2092 | +0.092 | +20.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 22642 | +0.099 | -793.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 14164 | +0.102 | -220.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2092 | +0.092 | +20.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 12072 | +0.104 | -241.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 4199 | +0.114 | +27.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 4199 | +0.114 | +27.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 6371 | +0.078 | -578.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 6371 | +0.078 | -578.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 702 | +0.257 | -90.79€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 702 | +0.257 | -90.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 702 | +0.257 | -90.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 702 | +0.257 | -90.79€ | 0 | 4 |
| ✅ GBM_LATE_15M | 18513 | +0.073 | +8301.85€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 18513 | +0.073 | +8301.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 3025 | +0.196 | +2226.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 3025 | +0.196 | +2226.21€ | 0 | 20 |
| ✅ GBM_LATE_15M#BTC | 2710 | +0.175 | +1822.25€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2710 | +0.175 | +1822.25€ | 0 | 26 |
| ✅ GBM_LATE_15M#DOGE | 3154 | +0.194 | +2284.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 3154 | +0.194 | +2284.45€ | 0 | 19 |
| ✅ GBM_LATE_15M#ETH | 2777 | +0.001 | +415.01€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 2777 | +0.001 | +415.01€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 2746 | -0.039 | +608.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2746 | -0.039 | +608.26€ | 4 | 14 |
| ✅ GBM_LATE_15M#XRP | 4101 | -0.053 | +945.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 4101 | -0.053 | +945.68€ | 4 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 19563 | +0.075 | +9730.26€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 19563 | +0.075 | +9730.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 3597 | +0.012 | +1933.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 3597 | +0.012 | +1933.16€ | 2 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 4140 | +0.003 | +763.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 4140 | +0.003 | +763.44€ | 1 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 2761 | +0.255 | +2701.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 2761 | +0.255 | +2701.20€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 3026 | -0.021 | +331.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 3026 | -0.021 | +331.20€ | 2 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 3254 | +0.013 | +1145.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 3254 | +0.013 | +1145.87€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 2785 | +0.266 | +2855.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 2785 | +0.266 | +2855.40€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 15085 | +0.169 | +10971.44€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 15085 | +0.169 | +10971.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2215 | +0.209 | +1780.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2215 | +0.209 | +1780.49€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 2369 | +0.157 | +1677.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 2369 | +0.157 | +1677.92€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2325 | +0.203 | +1803.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2325 | +0.203 | +1803.27€ | 0 | 18 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 2495 | +0.141 | +1669.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 2495 | +0.141 | +1669.40€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 2858 | +0.112 | +1832.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 2858 | +0.112 | +1832.75€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 2823 | +0.201 | +2207.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 2823 | +0.201 | +2207.61€ | 0 | 29 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 3719 | +0.122 | +1469.55€ | 0 | 20 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 3719 | +0.122 | +1469.55€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1035 | +0.152 | +483.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1035 | +0.152 | +483.83€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 724 | +0.074 | +174.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 724 | +0.074 | +174.16€ | 1 | 9 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 457 | +0.128 | +180.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 457 | +0.128 | +180.68€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO | 18549 | +0.172 | +13305.09€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 18549 | +0.172 | +13305.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 2892 | +0.222 | +2448.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 2892 | +0.222 | +2448.46€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 2893 | +0.152 | +1894.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 2893 | +0.152 | +1894.16€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 2988 | +0.220 | +2503.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 2988 | +0.220 | +2503.05€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 2949 | +0.135 | +1893.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 2949 | +0.135 | +1893.29€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 3274 | +0.105 | +1830.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 3274 | +0.105 | +1830.02€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 3553 | +0.201 | +2736.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 3553 | +0.201 | +2736.11€ | 0 | 25 |
| ✅ GBM_LATE_5M | 5613 | +0.140 | +3027.08€ | 1 | 26 |
| ✅ GBM_LATE_5M#5min | 5613 | +0.140 | +3027.08€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB | 482 | +0.178 | +321.19€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB#5min | 482 | +0.178 | +321.19€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 1546 | +0.141 | +951.01€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 1546 | +0.141 | +951.01€ | 0 | 26 |
| ✅ GBM_LATE_5M#DOGE | 805 | +0.173 | +517.52€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 805 | +0.173 | +517.52€ | 0 | 18 |
| ✅ GBM_LATE_5M#ETH | 1678 | +0.144 | +900.22€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 1678 | +0.144 | +900.22€ | 0 | 29 |
...
| ✅ GBM_LATE_60M | 1164 | +0.058 | +400.79€ | 4 | 17 |
| ✅ GBM_LATE_60M#60min | 1164 | +0.058 | +400.79€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 407 | +0.084 | +137.76€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 407 | +0.084 | +137.76€ | 1 | 17 |
| ✅ GBM_LATE_60M#ETH | 388 | +0.064 | +164.12€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 388 | +0.064 | +164.12€ | 3 | 18 |
| ✅ GBM_LATE_60M#SOL | 369 | +0.023 | +98.91€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 369 | +0.023 | +98.91€ | 3 | 10 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 547 | +0.052 | +86.65€ | 1 | 4 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 547 | +0.052 | +86.65€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC | 205 | +0.041 | +22.29€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 205 | +0.041 | +22.29€ | 3 | 2 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH | 168 | +0.041 | -0.28€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH#60min | 168 | +0.041 | -0.28€ | 3 | 8 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL | 174 | +0.074 | +64.65€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL#60min | 174 | +0.074 | +64.65€ | 1 | 10 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1266 | +0.095 | +328.48€ | 0 | 3 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1266 | +0.095 | +328.48€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1266 | +0.095 | +328.48€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1266 | +0.095 | +328.48€ | 0 | 3 |
...
| ✅ LIQUIDACIONES_5M | 1476 | -0.002 | -5.74€ | 6 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 1476 | -0.002 | -5.74€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_5M#ETH | 581 | +0.032 | +20.57€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 581 | +0.032 | +20.57€ | 5 | 0 |
...
| ✅ LIQUIDACIONES_60M | 857 | -0.050 | -28.65€ | 4 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 857 | -0.050 | -28.65€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC | 252 | -0.059 | -16.09€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC#60min | 252 | -0.059 | -16.09€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 12395 | -0.011 | -177.27€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 12395 | -0.011 | -177.27€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2182 | -0.024 | -49.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2182 | -0.024 | -49.91€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 2559 | +0.008 | -17.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 2559 | +0.008 | -17.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 2438 | -0.017 | -19.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 2438 | -0.017 | -19.38€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 2959 | -0.017 | -56.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 2959 | -0.017 | -56.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 1679 | -0.006 | -33.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 1679 | -0.006 | -33.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 20365 | -0.013 | +927.65€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 20365 | -0.013 | +927.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 3518 | +0.009 | +482.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 3518 | +0.009 | +482.55€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 3298 | -0.025 | -19.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 3298 | -0.025 | -19.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 3546 | +0.001 | +294.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 3546 | +0.001 | +294.04€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3116 | -0.044 | -70.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3116 | -0.044 | -70.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 3415 | -0.018 | +138.02€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 3415 | -0.018 | +138.02€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 3472 | -0.007 | +103.13€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 3472 | -0.007 | +103.13€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 4506 | -0.033 | -99.53€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 4506 | -0.033 | -99.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1083 | +0.001 | -14.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1083 | +0.001 | -14.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 875 | -0.043 | -29.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 875 | -0.043 | -29.81€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE | 41 | -0.128 | -5.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE#15min | 41 | -0.128 | -5.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 405 | -0.112 | -10.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 405 | -0.112 | -10.82€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1256 | -0.039 | -12.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1256 | -0.039 | -12.96€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 53143 | -0.073 | +1057.82€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 53143 | -0.073 | +1057.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 8882 | -0.082 | +487.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 8882 | -0.082 | +487.56€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 8334 | -0.086 | -271.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 8334 | -0.086 | -271.84€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 8919 | -0.073 | +427.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 8919 | -0.073 | +427.34€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 7854 | -0.094 | -230.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 7854 | -0.094 | -230.77€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 9903 | -0.047 | +275.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 9903 | -0.047 | +275.50€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 9251 | -0.063 | +370.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 9251 | -0.063 | +370.04€ | 4 | 0 |
...
| 🚫 PRICE_TARGET_GBM_FADE | 496 | -0.219 | -37.63€ | 2 | 0 |
| 🚫 PRICE_TARGET_GBM_FADE#BTC | 210 | -0.203 | -32.45€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM_FADE#BTC#atexpiry | 178 | -0.194 | -30.17€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 6033 | +0.024 | +99.12€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 6033 | +0.024 | +99.12€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 1939 | +0.024 | +24.68€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 1939 | +0.024 | +24.68€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M | 5722 | +0.012 | -34.65€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 5722 | +0.012 | -34.65€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2260 | +0.018 | -1.67€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2260 | +0.018 | -1.67€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2278 | +0.015 | -7.93€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2278 | +0.015 | -7.93€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1184 | -0.006 | -25.05€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1184 | -0.006 | -25.05€ | 2 | 0 |
| ✅ UPDOWN_GBM | 23023 | +0.028 | +1260.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 6263 | +0.054 | +982.81€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 869 | +0.004 | +8.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 14430 | +0.022 | +275.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 1369 | -0.003 | -9.00€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 1974 | +0.076 | +206.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 269 | +0.127 | +86.41€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 19 | -0.023 | -0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 1686 | +0.069 | +120.56€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 4118 | +0.029 | +268.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 738 | +0.077 | +173.08€ | 0 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 249 | +0.026 | +6.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 2496 | +0.025 | +84.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 600 | +0.000 | +1.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 35 | -0.122 | +1.55€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 2745 | +0.032 | +87.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 229 | +0.106 | +55.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 16 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 2500 | +0.025 | +32.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 4580 | +0.015 | +191.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1708 | +0.040 | +185.32€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 236 | +0.008 | +8.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 2111 | +0.003 | +0.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 495 | -0.009 | -7.04€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 30 | -0.156 | +3.91€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 6097 | +0.014 | +126.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1687 | +0.020 | +93.07€ | 0 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 230 | -0.009 | -2.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 3881 | +0.015 | +40.40€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 274 | +0.000 | -3.41€ | 2 | 2 |
| ✅ UPDOWN_GBM#SOL#daily | 25 | -0.167 | -1.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 3507 | +0.038 | +382.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 1632 | +0.074 | +389.92€ | 0 | 10 |
| ✅ UPDOWN_GBM#XRP#240min | 119 | -0.021 | -4.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 1756 | +0.009 | -3.66€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 8519 | -0.052 | +1755.12€ | 3 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 8519 | -0.052 | +1755.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 401 | -0.051 | +347.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 401 | -0.051 | +347.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1635 | -0.134 | -27.64€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1635 | -0.134 | -27.64€ | 4 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 139 | +0.117 | +54.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 139 | +0.117 | +54.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 897 | +0.185 | +496.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 897 | +0.185 | +496.19€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 2749 | -0.063 | +439.03€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 2749 | -0.063 | +439.03€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 2698 | -0.079 | +445.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 2698 | -0.079 | +445.62€ | 2 | 3 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 668 | +0.288 | +544.75€ | 0 | 11 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 668 | +0.288 | +544.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 373 | +0.281 | +289.59€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 373 | +0.281 | +289.59€ | 0 | 11 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.058) — sin ventaja clara. oversold(IBS<0.3): IC=+0.043 n=7979 | neutral: IC=+0.027 n=8786 | overbought(IBS>0.7): IC=+0.086 n=8460
  - _Datos_: n=26158 IC=+0.052 PNL=+3064.04€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 426 celda(s) pasan gate riguroso completo de 2000 evaluadas (n>=40) y 2971 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.020 < 0.08 — monitorear
  - _Datos_: n=1687 IC=+0.020 PNL=+93.07€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 22961 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=495/40 IC=-0.009 PNL=-7.04€ | BTC#60min: n=600/40 IC=+0.000 PNL=+1.46€ | SOL#60min: n=274/40 IC=+0.000 PNL=-3.41€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.054 n=244704 | tras_1loss IC=+0.069 n=191635 | tras_2loss IC=+0.036 n=82538/40 | gap=+0.018 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=+0.010 n=2294 | contrario_BTC IC=+0.008 n=2081/40 | gap=-0.001 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=21863 IC=+0.027 PNL=+1162.47€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=21863 IC=+0.027 PNL=+1162.47€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1013 IC=-0.003 PNL=-13.45€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1013 IC=-0.003 PNL=-13.45€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=356 IC=-0.006 PNL=+4.45€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=356 IC=-0.006 PNL=+4.45€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.172 > 0.1 con n=1356 PNL=+763.57€
  - _Datos_: n=1356 IC=+0.172 PNL=+763.57€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=738 IC=+0.077 PNL=+173.08€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=738 IC=+0.077 PNL=+173.08€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=3604 IC=+0.055 PNL=+651.64€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3604 IC=+0.055 PNL=+651.64€

**〰️ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: n≥30 y IC>+0.10
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: n=95 IC=-0.201 PNL=+0.26€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=95 IC=-0.201 PNL=+0.26€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=3083 IC=-0.009 PNL=-25.45€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3083 IC=-0.009 PNL=-25.45€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=4405 IC=+0.024 PNL=+213.51€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=4405 IC=+0.024 PNL=+213.51€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=1507 IC=+0.045 PNL=+144.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1507 IC=+0.045 PNL=+144.35€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.143 > 0.08 con n=376 PNL=+77.84€
  - _Datos_: n=376 IC=+0.143 PNL=+77.84€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=3261 IC=+0.032 PNL=+201.57€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3261 IC=+0.032 PNL=+201.57€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=7386 IC=+0.052 PNL=+879.74€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=7386 IC=+0.052 PNL=+879.74€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.190 > 0.1 con n=2132 PNL=+1090.81€
  - _Datos_: n=2132 IC=+0.190 PNL=+1090.81€
...
**🔴 H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.148 < -0.1 con n=140 PNL=+13.90€
  - _Datos_: n=140 IC=-0.148 PNL=+13.90€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1244 IC=+0.043 PNL=+139.62€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1244 IC=+0.043 PNL=+139.62€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=12700 IC=-0.141 PNL=+675.98€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=12700 IC=-0.141 PNL=+675.98€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1399 IC=+0.138 PNL=+728.73€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1399 IC=+0.138 PNL=+728.73€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.174 > 0.08 con n=1317 PNL=+750.94€
  - _Datos_: n=1317 IC=+0.174 PNL=+750.94€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.197 > 0.08 con n=341 PNL=+166.07€
  - _Datos_: n=341 IC=+0.197 PNL=+166.07€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=3573 IC=+0.144 PNL=+2119.78€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=3573 IC=+0.144 PNL=+2119.78€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=1450 IC=+0.045 PNL=+316.33€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1450 IC=+0.045 PNL=+316.33€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.189 > 0.08 con n=1305 PNL=+904.63€
  - _Datos_: n=1305 IC=+0.189 PNL=+904.63€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=2155 IC=-0.043 PNL=+499.82€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2155 IC=-0.043 PNL=+499.82€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.230 > 0.08 con n=2639 PNL=-261.11€
  - _Datos_: n=2639 IC=+0.230 PNL=-261.11€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=6668 IC=+0.166 PNL=-883.77€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=6668 IC=+0.166 PNL=-883.77€
