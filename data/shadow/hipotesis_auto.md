# Hipótesis automáticas — 2026-09-17 17:15 UTC
_Generado por shadow_postmortem.py sobre 484438 resoluciones (PNL=+52268.12€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.1` → IC=-0.249 (n=5964)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.1
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=17894)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `141.1` → IC=-0.265 (n=823)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.1
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2470)
...
- **FILTRO** `restante_s_al_confirmar` < `132.07` → IC=-0.291 (n=721)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2166)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.58` → IC=-0.243 (n=1417)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.58
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4253)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `117.26` → IC=-0.367 (n=1155)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 117.26
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=3471)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.250 (n=282)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=309)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.167 (n=136)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.267 (n=88)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=47)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.161 (n=54)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.197 (n=12041)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=3002)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `11420.5455` → IC=+0.192 (n=957)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11420.5455 (IC base=+0.098)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.246 (n=8255)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.171 (n=5914)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7280.6728` → IC=+0.179 (n=1868)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 7280.6728 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.203 (n=1410)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=1759)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `15201.8289` → IC=+0.219 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15201.8289 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1296)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.210 (n=1428)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.273 (n=1247)
...
- **PATRÓN** `libro_liquidez` > `13345.9593` → IC=+0.225 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13345.9593 (IC base=+0.204)
...
- **PATRÓN** `py_entrada` < `0.435` → IC=+0.153 (n=679)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2412)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.135 (n=335)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.119)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=2263)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.166)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.176 (n=2348)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.309 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.245 (n=2075)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.199 (n=2249)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.196 (n=1621)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.266 (n=1775)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.208 (n=4658)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.254 (n=2368)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.204)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.193 (n=4716)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `2.47` → IC=+0.150 (n=1983)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.4986` → IC=+0.155 (n=5767)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.848` → IC=+0.168 (n=2499)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.848 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `1.2217` → IC=+0.243 (n=1657)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2217 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0676` → IC=+0.241 (n=751)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0676 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1746` → IC=+0.191 (n=4438)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1746 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.3068` → IC=+0.203 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3068 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.9163` → IC=+0.199 (n=2854)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.9163 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.132 (n=7904)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.57 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` > `0.5591` → IC=+0.185 (n=478)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5591 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` < `0.337` → IC=+0.171 (n=2771)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.337 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` < `0.7016` → IC=+0.174 (n=1148)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.7016 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` > `0.8721` → IC=+0.178 (n=1739)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.8721 (IC base=+0.061)

- **PATRÓN** `volumen_pendiente_norm` > `0.2439` → IC=+0.226 (n=879)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2439 (IC base=+0.061)

- **PATRÓN** `volumen_spike_ratio` > `1.5873` → IC=+0.201 (n=3875)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5873 (IC base=+0.061)

- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.211 (n=4110)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.034` → IC=+0.275 (n=637)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.236 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1746.14` → IC=+0.255 (n=719)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1746.14 (IC base=+0.234)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.222 (n=972)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0053 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.1157` → IC=+0.240 (n=486)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1157 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=1157)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1871` → IC=+0.213 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1871 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `0.1291` → IC=+0.213 (n=852)
...
- **PATRÓN** `volumen_regimen` < `1.2573` → IC=+0.220 (n=1103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2573 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.8751` → IC=+0.211 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8751 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.2254` → IC=+0.213 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2254 (IC base=+0.211)
...
- **PATRÓN** `ibs_20min` < `0.6747` → IC=+0.175 (n=1180)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6747 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1259` → IC=+0.151 (n=1077)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1259 (IC base=+0.139)
...
- **PATRÓN** `volumen_regimen` < `1.2134` → IC=+0.146 (n=1180)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2134 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.6201` → IC=+0.141 (n=1179)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6201 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1575` → IC=+0.183 (n=317)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1575 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.153 (n=1070)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.4266` → IC=+0.144 (n=1070)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4266 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `13567.7255` → IC=+0.152 (n=786)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13567.7255 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `214.0` → IC=+0.162 (n=329)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.180 (n=699)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.254 (n=554)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1062` → IC=+0.183 (n=1211)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3753` → IC=+0.184 (n=185)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.3753 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `3.0002` → IC=+0.199 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0002 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=1642)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.226 (n=1222)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.217 (n=1092)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1804)
...
- **PATRÓN** `dist_vwap_pct` > `0.1695` → IC=+0.188 (n=216)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1695 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` < `0.6123` → IC=+0.162 (n=202)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6123 (IC base=+0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.2684` → IC=+0.234 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2684 (IC base=+0.007)

- **PATRÓN** `volumen_spike_ratio` > `1.5087` → IC=+0.190 (n=495)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 1.5087 (IC base=+0.007)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.637` → IC=-0.209 (n=297)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2406)

- **PATRÓN** `ibs_20min` > `0.7576` → IC=+0.210 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7576 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.6239` → IC=+0.289 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6239 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.6528` → IC=+0.275 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6528 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `0.7776` → IC=+0.331 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7776 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` < `0.0729` → IC=+0.326 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0729 (IC base=+0.041)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5081` → IC=+0.269 (n=76)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5081 (IC base=+0.041)
...
- **FILTRO** `drift_60min` |x|> `0.6568` → IC=-0.194 (n=452)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6568
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1360)

- **FILTRO** `ibs_20min` < `0.6679` → IC=-0.162 (n=1195)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6679
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=617)
...
- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.199 (n=683)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.032 (n=2052)
...
- **PATRÓN** `dist_vwap_pct` < `0.26` → IC=+0.249 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.26 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` < `0.7359` → IC=+0.248 (n=252)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.322` → IC=-0.168 (n=413)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.322
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1376)

- **PATRÓN** `ibs_20min` > `0.8691` → IC=+0.255 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8691 (IC base=+0.039)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.684` → IC=+0.188 (n=299)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 8.684 (IC base=+0.039)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5947` → IC=+0.194 (n=194)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.5947 (IC base=+0.039)
...
- **FILTRO** `ibs_20min` > `0.8216` → IC=-0.145 (n=601)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8216
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1805)

- **PATRÓN** `dist_vwap_pct` > `0.2885` → IC=+0.139 (n=261)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.2885 (IC base=+0.011)

- **PATRÓN** `dist_vwap_pct` < `0.1571` → IC=+0.135 (n=611)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1571 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` > `0.6556` → IC=+0.141 (n=636)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6556 (IC base=+0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.2712` → IC=+0.177 (n=91)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.2712 (IC base=+0.011)

- **PATRÓN** `volumen_spike_ratio` < `1.4262` → IC=+0.178 (n=231)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4262 (IC base=+0.011)

- **PATRÓN** `ballena_activa_n` < `229.0` → IC=+0.190 (n=227)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 229.0 (IC base=+0.011)
...
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.280 (n=858)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.241 (n=640)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.255 (n=1462)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.238)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.299 (n=1021)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.808` → IC=+0.298 (n=389)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3474` → IC=+0.306 (n=158)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6378` → IC=+0.285 (n=309)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6378 (IC base=+0.280)

- **PATRÓN** `volumen_spike_ratio` > `2.228` → IC=+0.282 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.228 (IC base=+0.280)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.289 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.280)

- **PATRÓN** `libro_liquidez` > `1882.9554` → IC=+0.304 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1882.9554 (IC base=+0.280)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.277 (n=402)
...
- **FILTRO** `ibs_20min` < `0.2479` → IC=-0.211 (n=372)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=1121)

- **FILTRO** `ibs_20min` > `0.8018` → IC=-0.184 (n=483)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8018
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=1450)

- **PATRÓN** `ibs_20min` > `0.8055` → IC=+0.151 (n=508)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.8055 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` > `0.4461` → IC=+0.215 (n=142)
...
- **PATRÓN** `volumen_regimen` < `0.9592` → IC=+0.214 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9592 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `0.6214` → IC=+0.194 (n=318)
...
- **PATRÓN** `volumen_regimen` < `1.1339` → IC=+0.183 (n=263)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 1.1339 (IC base=-0.014)

- **PATRÓN** `volumen_regimen` > `0.7255` → IC=+0.188 (n=235)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.7255 (IC base=-0.014)

- **PATRÓN** `volumen_pendiente_norm` > `0.1466` → IC=+0.306 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1466 (IC base=-0.014)

- **PATRÓN** `volumen_spike_ratio` < `1.7898` → IC=+0.253 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7898 (IC base=-0.014)
...
- **FILTRO** `ibs_20min` < `0.6757` → IC=-0.212 (n=870)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6757
  - _Potencial_: sin este filtro IC_bueno=+0.263 (n=872)

- **FILTRO** `ibs_20min` > `0.7083` → IC=-0.233 (n=458)
...
- **PATRÓN** `ibs_20min` > `0.6757` → IC=+0.263 (n=872)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6757 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.1802` → IC=+0.316 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1802 (IC base=+0.026)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.474` → IC=+0.143 (n=270)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 9.474 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` < `0.8648` → IC=+0.294 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8648 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.7203` → IC=+0.278 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7203 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` < `0.1055` → IC=+0.280 (n=561)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4432` → IC=+0.318 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4432 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.323 (n=501)
...
- **PATRÓN** `sigma_h` > `0.0145` → IC=+0.297 (n=795)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0145 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.284 (n=591)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.269)

- **PATRÓN** `ibs_20min` < `0.3953` → IC=+0.305 (n=1193)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3953 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` > `0.5351` → IC=+0.288 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5351 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.453` → IC=+0.289 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.453 (IC base=+0.269)

- **PATRÓN** `volumen_regimen` > `1.2435` → IC=+0.304 (n=397)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5387` → IC=+0.263 (n=1028)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5387 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` > `2.1688` → IC=+0.274 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1688 (IC base=+0.269)

- **PATRÓN** `libro_liquidez` > `2354.6422` → IC=+0.276 (n=1064)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2354.6422 (IC base=+0.269)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.176 (n=2121)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0048 (IC base=+0.165)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.198 (n=2120)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0106 (IC base=+0.165)

- **PATRÓN** `drift_60min` |x|≤ `0.3382` → IC=+0.173 (n=5598)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3382 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=6634)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.581` → IC=+0.213 (n=6357)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.581 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.9311` → IC=+0.218 (n=944)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9311 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.247 (n=1312)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `1.2135` → IC=+0.161 (n=4222)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2135 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` > `0.623` → IC=+0.157 (n=4222)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.623 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.1065` → IC=+0.183 (n=2492)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1065 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` < `1.4521` → IC=+0.173 (n=2016)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.4521 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6607` → IC=+0.169 (n=2016)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.6607 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3832.0952` → IC=+0.167 (n=2119)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3832.0952 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.180 (n=5274)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0792` → IC=+0.204 (n=2057)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4692` → IC=+0.229 (n=6166)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4692 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` < `0.2207` → IC=+0.161 (n=4595)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2207 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.187` → IC=+0.195 (n=1062)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.187 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `1.1819` → IC=+0.155 (n=4506)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1819 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.6254` → IC=+0.149 (n=4506)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6254 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2922` → IC=+0.231 (n=881)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2922 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.5762` → IC=+0.173 (n=2425)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5762 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.2831` → IC=+0.175 (n=2498)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2831 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.172 (n=5128)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.192 (n=361)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0081 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.3224` → IC=+0.201 (n=1079)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.044` → IC=+0.306 (n=492)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5274` → IC=+0.174 (n=983)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.5274 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `1.4242` → IC=+0.177 (n=984)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4242 (IC base=+0.183)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=1023)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0764` → IC=+0.187 (n=311)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0764 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=985)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4182` → IC=+0.224 (n=932)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4182 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.1998` → IC=+0.207 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1998 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.506` → IC=+0.216 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.506 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.2554` → IC=+0.170 (n=932)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.2554 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` < `0.0779` → IC=+0.159 (n=774)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.0779 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.232` → IC=+0.184 (n=204)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.232 (IC base=+0.161)
...
- **PATRÓN** `libro_liquidez` > `10111.2304` → IC=+0.174 (n=932)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 10111.2304 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.166 (n=1055)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_regimen` < `1.2116` → IC=+0.160 (n=1055)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.156 (n=945)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.197 (n=1059)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.287 (n=556)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2145` → IC=+0.184 (n=1015)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6638` → IC=+0.188 (n=331)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.6638 (IC base=+0.188)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.200 (n=1205)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.239 (n=883)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0891` → IC=+0.244 (n=295)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3478` → IC=+0.254 (n=883)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3478 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.677` → IC=+0.275 (n=362)
...
- **PATRÓN** `volumen_spike_ratio` < `1.854` → IC=+0.217 (n=355)
...
- **PATRÓN** `libro_liquidez` > `1894.0152` → IC=+0.241 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1894.0152 (IC base=+0.224)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.179 (n=883)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0066 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.429` → IC=+0.164 (n=1003)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3938` → IC=+0.202 (n=1002)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3938 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1362` → IC=+0.184 (n=657)
...
- **PATRÓN** `volumen_regimen` < `0.858` → IC=+0.159 (n=669)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.858 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.1924` → IC=+0.167 (n=334)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1924 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2885` → IC=+0.215 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2885 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `1.5336` → IC=+0.163 (n=431)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.5336 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.5103` → IC=+0.178 (n=327)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.5103 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `7103.48` → IC=+0.185 (n=668)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 7103.48 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `173.0` → IC=+0.150 (n=938)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 173.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.167 (n=1075)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0072 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.3806` → IC=+0.146 (n=1075)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6046` → IC=+0.183 (n=1075)
...
- **PATRÓN** `volumen_regimen` < `0.8548` → IC=+0.144 (n=717)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8548 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `0.6094` → IC=+0.132 (n=1074)
...
- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.204 (n=1187)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.392` → IC=+0.154 (n=255)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.392 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.0388` → IC=+0.121 (n=1045)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1784` → IC=+0.127 (n=473)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 2.1784 (IC base=+0.111)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0896` → IC=+0.217 (n=398)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0896 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.218 (n=584)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.244 (n=1192)
...
- **PATRÓN** `dist_vwap_pct` < `0.2629` → IC=+0.203 (n=1249)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2821` → IC=+0.281 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2821 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` < `2.2444` → IC=+0.195 (n=927)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2444 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4611` → IC=+0.195 (n=1053)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4611 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2546.4974` → IC=+0.214 (n=794)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2546.4974 (IC base=+0.204)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.154 (n=516)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0038 (IC base=+0.136)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.164 (n=516)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0089 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0981` → IC=+0.149 (n=516)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0981 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.177 (n=772)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.388` → IC=+0.168 (n=1548)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.388 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.8094` → IC=+0.173 (n=215)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.8094 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.678` → IC=+0.169 (n=714)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.678 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8692` → IC=+0.155 (n=891)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8692 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1631` → IC=+0.167 (n=424)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1631 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.4332` → IC=+0.151 (n=494)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4332 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `2.5517` → IC=+0.163 (n=494)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.5517 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=1728)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `11932.15` → IC=+0.151 (n=516)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 11932.15 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.157 (n=1326)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.133 (n=1449)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.3402 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1663)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `1.2216` → IC=+0.124 (n=1460)
...
- **PATRÓN** `libro_liquidez` > `2625.3161` → IC=+0.122 (n=1470)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1096` → IC=+0.142 (n=160)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.1096 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.141 (n=324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 10.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.2805` → IC=+0.135 (n=362)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` > 0.2805 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.5024` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.5024 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.264` → IC=+0.143 (n=169)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 3.264 (IC base=+0.099)

- **PATRÓN** `volumen_regimen` < `0.6134` → IC=+0.142 (n=121)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.6134 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `10160.5257` → IC=+0.126 (n=362)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 10160.5257 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.149 (n=112)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 152.0 (IC base=+0.099)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.211 (n=171)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.34` → IC=+0.156 (n=510)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.34 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=458)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.3419` → IC=+0.208 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3419 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.437` → IC=+0.149 (n=203)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.437 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.159` → IC=+0.138 (n=580)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 9.159 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.218` → IC=+0.139 (n=510)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.218 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.063` → IC=+0.178 (n=231)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.063 (IC base=+0.136)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1106` → IC=+0.161 (n=440)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1106 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4209` → IC=+0.143 (n=500)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4209 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `155.0` → IC=+0.175 (n=161)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 155.0 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.132 (n=313)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 8.0 (IC base=+0.092)

- **PATRÓN** `ibs_20min` > `0.8947` → IC=+0.210 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8947 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.7807` → IC=+0.160 (n=48)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.7807 (IC base=+0.092)
...
- **PATRÓN** `volumen_regimen` < `1.0549` → IC=+0.121 (n=299)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.0549 (IC base=+0.092)
...
- **PATRÓN** `libro_liquidez` > `3074.7539` → IC=+0.222 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3074.7539 (IC base=+0.092)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.193 (n=3663)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0087 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.173 (n=8429)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.212 (n=8072)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.8869` → IC=+0.196 (n=1041)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.8869 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.76` → IC=+0.231 (n=3021)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.76 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.166 (n=3615)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6338` → IC=+0.181 (n=2565)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6338 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3813.5418` → IC=+0.167 (n=2689)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3813.5418 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `92.0` → IC=+0.193 (n=5896)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 92.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.195 (n=4943)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0068 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4819` → IC=+0.184 (n=7401)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.215 (n=619)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.196 (n=656)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.366` → IC=+0.291 (n=834)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.366 (IC base=+0.190)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5466` → IC=+0.181 (n=559)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.5466 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.2361` → IC=+0.194 (n=576)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.2361 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.214 (n=1268)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.190)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.257 (n=1059)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1107)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3568` → IC=+0.151 (n=1285)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.3568 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1341)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3156` → IC=+0.198 (n=1284)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3156 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.3247` → IC=+0.194 (n=488)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.3247 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.921` → IC=+0.152 (n=435)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 6.921 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.296` → IC=+0.153 (n=1141)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.296 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.181 (n=565)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6973 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.265` → IC=+0.179 (n=185)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.265 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.1148` → IC=+0.156 (n=1082)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1148 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7574` → IC=+0.157 (n=820)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7574 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `10925.7104` → IC=+0.164 (n=1147)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 10925.7104 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `488.0` → IC=+0.159 (n=1163)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 488.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.170 (n=1144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0058 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.263` → IC=+0.169 (n=1006)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6376` → IC=+0.207 (n=1143)
...
- **PATRÓN** `dist_vwap_pct` < `0.1271` → IC=+0.165 (n=1058)
...
- **PATRÓN** `volumen_regimen` < `1.2029` → IC=+0.162 (n=1143)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4156` → IC=+0.168 (n=1045)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.4156 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.7562` → IC=+0.160 (n=697)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7562 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `12550.5978` → IC=+0.156 (n=762)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12550.5978 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `368.0` → IC=+0.169 (n=635)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 368.0 (IC base=+0.154)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.226 (n=1287)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=1351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1311)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.6711` → IC=+0.248 (n=1150)
...
- **PATRÓN** `ibs_20min` < `0.3642` → IC=+0.268 (n=1077)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7987` → IC=+0.226 (n=484)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7987 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.2488` → IC=+0.234 (n=732)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2488 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.246 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1897.5376` → IC=+0.241 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1897.5376 (IC base=+0.234)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4371` → IC=+0.139 (n=1370)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.4371 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.145 (n=1434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.6988` → IC=+0.229 (n=914)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6988 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.5571` → IC=+0.172 (n=367)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.5571 (IC base=+0.135)
...
- **PATRÓN** `volumen_regimen` < `0.8779` → IC=+0.159 (n=914)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8779 (IC base=+0.135)
...
- **PATRÓN** `ibs_20min` < `0.6874` → IC=+0.196 (n=1110)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.6874 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.2048` → IC=+0.145 (n=1036)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.2048 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.009` → IC=+0.191 (n=166)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 11.009 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.21` → IC=+0.142 (n=1038)
...
- **PATRÓN** `volumen_regimen` > `1.1774` → IC=+0.153 (n=370)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1774 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2782` → IC=+0.273 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2782 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.472` → IC=+0.173 (n=347)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.472 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `11048.3545` → IC=+0.204 (n=370)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2215` → IC=+0.168 (n=206)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.2215 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4637` → IC=+0.151 (n=393)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4637 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.2313` → IC=+0.121 (n=534)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 2.2313 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2900.0851` → IC=+0.162 (n=445)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2900.0851 (IC base=+0.112)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1451)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `0.5116` → IC=+0.245 (n=1389)
...
- **PATRÓN** `volumen_regimen` < `1.2478` → IC=+0.210 (n=1390)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2478 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6304` → IC=+0.210 (n=1389)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1413)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2585.5589` → IC=+0.210 (n=926)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2585.5589 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.008` → IC=+0.234 (n=512)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.008 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.225 (n=511)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0256 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.214 (n=740)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.2662` → IC=+0.205 (n=1431)
...
- **PATRÓN** `ibs_20min` > `0.6383` → IC=+0.215 (n=599)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6383 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1307` → IC=+0.170 (n=313)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1307 (IC base=+0.106)
...
- **PATRÓN** `volumen_regimen` < `1.0919` → IC=+0.129 (n=599)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0919 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `0.9761` → IC=+0.128 (n=272)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4899` → IC=+0.161 (n=491)
...
- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.154 (n=261)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.106)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.170 (n=95)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0059 (IC base=+0.085)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.121 (n=217)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 7.0 (IC base=+0.085)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.197 (n=186)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.6744 (IC base=+0.085)

- **PATRÓN** `dist_vwap_pct` > `0.8626` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.8626 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.244` → IC=+0.214 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.244 (IC base=+0.085)

- **PATRÓN** `volumen_regimen` > `1.0632` → IC=+0.141 (n=62)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.0632 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.0894` → IC=+0.179 (n=79)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.0894 (IC base=+0.085)

- **PATRÓN** `volumen_spike_ratio` < `2.1825` → IC=+0.169 (n=146)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.1825 (IC base=+0.085)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.158 (n=185)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 16.0 (IC base=+0.114)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.129 (n=502)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2842.677` → IC=+0.176 (n=174)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2842.677 (IC base=+0.114)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1368)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=6644)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.180 (n=2773)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=8465)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=2864)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=8855)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.215 (n=475)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.094 (n=1432)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.168 (n=486)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=1607)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.205 (n=473)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1479)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.221 (n=489)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1579)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.168 (n=504)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1564)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.200 (n=455)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1425)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2462)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=2530)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2536)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=8036)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=18173)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=6195)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=20014)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.244 (n=6489)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=19720)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.160 (n=8905)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=17304)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=8236)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=24752)

- **FILTRO** `ibs_7min` > `0.2955` → IC=-0.177 (n=8245)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2955
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=24743)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.133 (n=1302)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=2935)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=1004)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3233)

- **FILTRO** `ibs_7min` < `0.7071` → IC=-0.260 (n=1398)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7071
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2839)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.197 (n=976)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3261)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.150 (n=3836)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1893)

- **FILTRO** `drift_7min_pct` |x|> `0.1108` → IC=-0.123 (n=1945)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1108
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3784)

- **FILTRO** `ibs_7min` > `0.7976` → IC=-0.206 (n=1431)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7976
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4298)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1056)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3514)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.258 (n=1081)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3489)

- **FILTRO** `ibs_7min` < `0.7548` → IC=-0.189 (n=1142)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7548
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3428)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.178 (n=1138)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3432)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1108)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3552)

- **FILTRO** `ibs_7min` > `0.2546` → IC=-0.170 (n=1164)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2546
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3496)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.184 (n=1160)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3500)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=970)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=2988)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.317 (n=953)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=3005)

- **FILTRO** `drift_7min_pct` |x|> `0.1798` → IC=-0.133 (n=1345)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1798
  - _Potencial_: sin este filtro IC_bueno=-0.105 (n=2613)

- **FILTRO** `ibs_7min` < `0.2` → IC=-0.272 (n=978)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2980)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.221 (n=919)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3039)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1417)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4626)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.155 (n=2052)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=3991)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1374)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2948)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1060)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3262)

- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.190 (n=1080)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3242)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.186 (n=1067)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3255)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1094)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3340)

- **FILTRO** `ibs_7min` > `0.2743` → IC=-0.176 (n=1108)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2743
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3326)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1087)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3347)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.257 (n=1131)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3564)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.232 (n=1145)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3550)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.170 (n=1523)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4723)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=1346)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=3081)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.281 (n=1096)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3331)

- **FILTRO** `ibs_7min` < `0.72` → IC=-0.235 (n=1102)

  - _Acción_: SKIP cuando `ibs_7min` < 0.72
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3325)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1080)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3347)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.206 (n=1392)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=4484)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=600)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=977)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2427)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1252)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1260)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.219 (n=521)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0582` → IC=+0.180 (n=1148)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.186 (n=806)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.62` → IC=+0.252 (n=1148)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.817` → IC=+0.243 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.817 (IC base=+0.177)

- **PATRÓN** `libro_liquidez` > `4928.6279` → IC=+0.181 (n=521)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 4928.6279 (IC base=+0.177)
...
- **FILTRO** `sigma_h` > `0.0127` → IC=-0.205 (n=550)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0127
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1651)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.179 (n=703)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1498)

- **FILTRO** `libro_liquidez` < `3781.8456` → IC=-0.122 (n=1452)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1171` → IC=+0.234 (n=814)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1171 (IC base=-0.042)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1825` → IC=+0.242 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1825 (IC base=-0.042)

- **PATRÓN** `ibs_15` < `0.3605` → IC=+0.282 (n=1222)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3605 (IC base=-0.042)

- **PATRÓN** `dist_vwap_pct` > `0.6509` → IC=+0.261 (n=186)
...
- **FILTRO** `sigma_h` > `0.007` → IC=-0.210 (n=332)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1000)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.226 (n=439)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=893)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.205 (n=847)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.873` → IC=-0.241 (n=237)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.185 (n=1095)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.251 (n=511)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.229)

- **PATRÓN** `drift_60min` |x|≤ `0.4382` → IC=+0.231 (n=511)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4382 (IC base=+0.229)

- **PATRÓN** `drift_15min` |x|≤ `0.7762` → IC=+0.239 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7762 (IC base=+0.229)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1983` → IC=+0.256 (n=232)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.2758` → IC=+0.288 (n=450)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2758 (IC base=+0.229)

- **PATRÓN** `dist_vwap_pct` > `0.7515` → IC=+0.259 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7515 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.908` → IC=+0.232 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.908 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.033` → IC=+0.237 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.033 (IC base=+0.229)

- **PATRÓN** `libro_liquidez` > `3600.0181` → IC=+0.233 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3600.0181 (IC base=+0.229)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.231 (n=481)
...
- **FILTRO** `sigma_h` > `0.0194` → IC=-0.264 (n=329)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0194
  - _Potencial_: sin este filtro IC_bueno=-0.101 (n=331)

- **FILTRO** `drift_15min` |x|> `1.1952` → IC=-0.241 (n=164)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.1952
  - _Potencial_: sin este filtro IC_bueno=-0.163 (n=496)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.261 (n=174)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.154 (n=486)
...
- **PATRÓN** `dist_vwap_pct` < `0.4406` → IC=+0.299 (n=247)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.62 sube el IC de +0.177 a +0.252 en UPDOWN_GBM#15min (n=1148). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3605 sube el IC de -0.042 a +0.282 en UPDOWN_GBM_15M_TARDIO (n=1222). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2758 sube el IC de +0.229 a +0.288 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=450). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 21345 | -0.097 | -3125.22€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1272 | -0.050 | -194.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 20073 | -0.100 | -2930.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3293 | -0.103 | -562.14€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3293 | -0.103 | -562.14€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 6110 | -0.040 | -598.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6110 | -0.040 | -598.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5670 | -0.101 | -480.79€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5670 | -0.101 | -480.79€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4626 | -0.172 | -1128.19€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4626 | -0.172 | -1128.19€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 13233 | -0.039 | +4202.83€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3534 | -0.005 | +1837.08€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 9699 | -0.051 | +2365.75€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 13233 | -0.039 | +4202.83€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3534 | -0.005 | +1837.08€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 9699 | -0.051 | +2365.75€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1153 | -0.105 | -170.96€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 94 | -0.052 | -11.21€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1059 | -0.110 | -159.74€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 318 | -0.156 | -76.43€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 294 | -0.162 | -71.21€ | 3 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 77461 | +0.113 | -3928.15€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 12021 | +0.183 | -357.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 298 | -0.120 | -46.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 59852 | +0.101 | -3378.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5290 | +0.113 | -145.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 9969 | +0.097 | -912.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 39 | -0.159 | -2.72€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 9915 | +0.099 | -898.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 15662 | +0.132 | -305.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3700 | +0.203 | -108.46€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 9916 | +0.110 | -178.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2004 | +0.114 | +3.36€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 10009 | +0.089 | -972.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 47 | -0.051 | -1.60€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 9947 | +0.090 | -959.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 16570 | +0.125 | -294.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4643 | +0.173 | -70.50€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 10011 | +0.108 | -163.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1904 | +0.098 | -51.88€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 15265 | +0.115 | -877.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3552 | +0.186 | -185.47€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 201 | -0.081 | +7.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 10130 | +0.092 | -602.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1382 | +0.134 | -96.98€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 9986 | +0.104 | -565.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 40 | +0.000 | +10.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 9933 | +0.104 | -576.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 12237 | +0.189 | -851.42€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 12237 | +0.189 | -851.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2996 | +0.166 | -330.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2996 | +0.166 | -330.57€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 724 | +0.183 | +1.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 724 | +0.183 | +1.13€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2931 | +0.178 | -268.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2931 | +0.178 | -268.58€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2631 | +0.236 | -85.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2631 | +0.236 | -85.13€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2876 | +0.191 | -182.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2876 | +0.191 | -182.02€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 41877 | +0.195 | -3467.50€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 41877 | +0.195 | -3467.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 7286 | +0.171 | -912.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 7286 | +0.171 | -912.93€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 6652 | +0.224 | -239.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 6652 | +0.224 | -239.30€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 7254 | +0.170 | -915.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 7254 | +0.170 | -915.20€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 6749 | +0.217 | -285.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 6749 | +0.217 | -285.36€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 6908 | +0.203 | -465.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 6908 | +0.203 | -465.97€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 7028 | +0.191 | -648.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 7028 | +0.191 | -648.73€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 15691 | +0.124 | +302.01€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 15691 | +0.124 | +302.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 7784 | +0.129 | +202.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 7784 | +0.129 | +202.11€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 7907 | +0.120 | +99.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 7907 | +0.120 | +99.90€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 894 | +0.072 | -39.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 316 | +0.057 | -27.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 578 | +0.081 | -12.71€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 698 | +0.081 | -15.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 120 | +0.082 | -3.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 578 | +0.081 | -12.71€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 27981 | +0.099 | -813.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2352 | +0.095 | +37.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 25629 | +0.099 | -851.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 15908 | +0.103 | -219.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2352 | +0.095 | +37.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 13556 | +0.104 | -256.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 4952 | +0.115 | +40.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 4952 | +0.115 | +40.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 7121 | +0.078 | -634.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 7121 | +0.078 | -634.74€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 20577 | +0.076 | +9254.50€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 20577 | +0.076 | +9254.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 3376 | +0.193 | +2442.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 3376 | +0.193 | +2442.24€ | 0 | 20 |
| ✅ GBM_LATE_15M#BTC | 3042 | +0.174 | +2041.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3042 | +0.174 | +2041.65€ | 0 | 26 |
| ✅ GBM_LATE_15M#DOGE | 3527 | +0.195 | +2580.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 3527 | +0.195 | +2580.73€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3075 | +0.007 | +483.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3075 | +0.007 | +483.95€ | 1 | 14 |
| ✅ GBM_LATE_15M#SOL | 3010 | -0.037 | +641.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3010 | -0.037 | +641.62€ | 4 | 14 |
| ✅ GBM_LATE_15M#XRP | 4547 | -0.049 | +1064.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 4547 | -0.049 | +1064.31€ | 4 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 21659 | +0.079 | +10767.67€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 21659 | +0.079 | +10767.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 3997 | +0.013 | +1970.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 3997 | +0.013 | +1970.58€ | 2 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 4570 | +0.007 | +875.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 4570 | +0.007 | +875.42€ | 1 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3067 | +0.257 | +3022.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3067 | +0.257 | +3022.19€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 3426 | -0.012 | +459.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 3426 | -0.012 | +459.10€ | 2 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 3575 | +0.014 | +1262.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 3575 | +0.014 | +1262.58€ | 3 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3024 | +0.271 | +3177.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3024 | +0.271 | +3177.80€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 16697 | +0.168 | +12204.07€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 16697 | +0.168 | +12204.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2475 | +0.205 | +1946.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2475 | +0.205 | +1946.91€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 2648 | +0.153 | +1900.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 2648 | +0.153 | +1900.33€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2586 | +0.204 | +2015.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2586 | +0.204 | +2015.12€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 2768 | +0.140 | +1892.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 2768 | +0.140 | +1892.76€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3149 | +0.111 | +2034.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3149 | +0.111 | +2034.22€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3071 | +0.202 | +2414.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3071 | +0.202 | +2414.72€ | 0 | 27 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4256 | +0.126 | +1749.79€ | 0 | 25 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4256 | +0.126 | +1749.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 163 | +0.112 | +63.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 163 | +0.112 | +63.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1161 | +0.121 | +483.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1161 | +0.121 | +483.38€ | 0 | 20 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 901 | +0.089 | +261.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 901 | +0.089 | +261.10€ | 1 | 12 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 503 | +0.136 | +218.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 503 | +0.136 | +218.58€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO | 20623 | +0.173 | +14930.51€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 20623 | +0.173 | +14930.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3224 | +0.218 | +2687.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3224 | +0.218 | +2687.13€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3234 | +0.151 | +2128.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3234 | +0.151 | +2128.80€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 3346 | +0.221 | +2828.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 3346 | +0.221 | +2828.18€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 3305 | +0.138 | +2166.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 3305 | +0.138 | +2166.74€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 3618 | +0.105 | +2085.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 3618 | +0.105 | +2085.50€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 3896 | +0.203 | +3034.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 3896 | +0.203 | +3034.16€ | 0 | 22 |
...
| ✅ GBM_LATE_60M | 1314 | +0.067 | +594.39€ | 2 | 14 |
| ✅ GBM_LATE_60M#60min | 1314 | +0.067 | +594.39€ | 0 | 0 |
...
| ✅ GBM_LATE_60M#SOL | 408 | +0.037 | +163.48€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 408 | +0.037 | +163.48€ | 1 | 11 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1462 | +0.107 | +432.43€ | 0 | 4 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1462 | +0.107 | +432.43€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1462 | +0.107 | +432.43€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1462 | +0.107 | +432.43€ | 0 | 4 |
...
| ✅ LIQUIDACIONES_5M | 1566 | -0.001 | -1.86€ | 6 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 1566 | -0.001 | -1.86€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_5M#ETH | 653 | +0.025 | +18.28€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 653 | +0.025 | +18.28€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 13508 | -0.011 | -177.75€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 13508 | -0.011 | -177.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2522 | -0.021 | -47.05€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2522 | -0.021 | -47.05€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 2562 | +0.007 | -17.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 2562 | +0.007 | -17.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 2835 | -0.014 | -18.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 2835 | -0.014 | -18.93€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 3331 | -0.016 | -60.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 3331 | -0.016 | -60.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 1680 | -0.005 | -32.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 1680 | -0.005 | -32.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 22957 | -0.011 | +1002.93€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 22957 | -0.011 | +1002.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4000 | +0.011 | +511.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4000 | +0.011 | +511.93€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 3687 | -0.025 | -20.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 3687 | -0.025 | -20.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4020 | +0.004 | +305.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4020 | +0.004 | +305.49€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3461 | -0.047 | -94.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3461 | -0.047 | -94.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 3843 | -0.014 | +158.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 3843 | -0.014 | +158.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 3946 | -0.000 | +142.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 3946 | -0.000 | +142.50€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5093 | -0.044 | -129.26€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5093 | -0.044 | -129.26€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1201 | +0.000 | -16.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1201 | +0.000 | -16.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 1124 | -0.053 | -24.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 1124 | -0.053 | -24.66€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1396 | -0.060 | -31.95€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1396 | -0.060 | -31.95€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 59197 | -0.073 | +1182.56€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 59197 | -0.073 | +1182.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 9966 | -0.081 | +583.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 9966 | -0.081 | +583.36€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 9230 | -0.090 | -367.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 9230 | -0.090 | -367.77€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 10001 | -0.071 | +507.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 10001 | -0.071 | +507.50€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 8756 | -0.093 | -253.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 8756 | -0.093 | -253.66€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 10941 | -0.048 | +339.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 10941 | -0.048 | +339.58€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 10303 | -0.064 | +373.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 10303 | -0.064 | +373.54€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 6759 | -0.021 | -97.27€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 6759 | -0.021 | -97.27€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 2491 | -0.027 | -115.73€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2491 | -0.027 | -115.73€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 971 | -0.033 | -50.98€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 971 | -0.033 | -50.98€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 6697 | +0.024 | +102.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 6697 | +0.024 | +102.90€ | 0 | 0 |
...
| ✅ STREAK_MOM_5M#SOL | 1960 | +0.015 | +8.58€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 1960 | +0.015 | +8.58€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1216 | +0.034 | +37.67€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1216 | +0.034 | +37.67€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 6171 | +0.014 | -24.22€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 6171 | +0.014 | -24.22€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2446 | +0.020 | +3.75€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2446 | +0.020 | +3.75€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2441 | +0.016 | -5.39€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2441 | +0.016 | -5.39€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1284 | -0.002 | -22.58€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1284 | -0.002 | -22.58€ | 2 | 0 |
| ✅ UPDOWN_GBM | 26994 | +0.030 | +1524.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 7265 | +0.060 | +1174.41€ | 0 | 12 |
| ✅ UPDOWN_GBM#240min | 1014 | +0.005 | +8.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 16962 | +0.023 | +338.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 1643 | +0.002 | +1.65€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 2393 | +0.071 | +238.41€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 315 | +0.131 | +105.65€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 19 | -0.023 | -0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2059 | +0.062 | +133.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 4899 | +0.033 | +322.93€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 885 | +0.083 | +200.05€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 287 | +0.022 | +7.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 2958 | +0.029 | +108.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 727 | -0.001 | +6.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 42 | -0.114 | +0.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 3180 | +0.033 | +118.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 266 | +0.123 | +80.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 16 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 2898 | +0.025 | +38.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 5611 | +0.017 | +217.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1981 | +0.047 | +214.14€ | 0 | 10 |
| ✅ UPDOWN_GBM#ETH#240min | 274 | +0.007 | +7.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 2737 | +0.002 | -3.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 583 | -0.001 | -4.24€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 36 | -0.158 | +3.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 6870 | +0.017 | +167.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1930 | +0.023 | +111.52€ | 1 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 268 | -0.007 | -2.62€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 4309 | +0.018 | +59.48€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 333 | +0.010 | -0.13€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 30 | -0.156 | -1.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 4039 | +0.042 | +461.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 1888 | +0.078 | +462.87€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 150 | -0.007 | -2.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2001 | +0.011 | +1.89€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 9436 | -0.046 | +2009.22€ | 3 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 9436 | -0.046 | +2009.22€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 459 | -0.049 | +344.13€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 459 | -0.049 | +344.13€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1793 | -0.127 | +37.30€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1793 | -0.127 | +37.30€ | 4 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 164 | +0.127 | +71.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 164 | +0.127 | +71.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1037 | +0.198 | +594.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1037 | +0.198 | +594.73€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 2999 | -0.062 | +458.85€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 2999 | -0.062 | +458.85€ | 2 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 2984 | -0.075 | +502.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 2984 | -0.075 | +502.87€ | 3 | 3 |
