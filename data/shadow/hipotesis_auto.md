# Hipótesis automáticas — 2026-07-28 18:25 UTC
_Generado por shadow_postmortem.py sobre 40574 resoluciones (PNL=+8431.55€)_
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.193 (n=1280)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0076 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=1716)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.2762` → IC=+0.182 (n=526)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.2762 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.406` → IC=+0.236 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.406 (IC base=+0.144)

- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.155 (n=1452)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0068 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.134 (n=1491)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.392` → IC=+0.126 (n=348)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.392 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.169` → IC=+0.151 (n=322)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 8.169 (IC base=+0.121)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.138 (n=434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 7.0 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.4476` → IC=+0.188 (n=62)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.4476 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.79` → IC=+0.167 (n=85)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.79 (IC base=+0.107)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.399` → IC=+0.186 (n=103)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 9.399 (IC base=+0.086)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.148 (n=475)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0078 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.149 (n=425)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 8.0 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.3073` → IC=+0.172 (n=135)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.3073 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.566` → IC=+0.274 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.566 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.120 (n=430)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.01 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `3211.0609` → IC=+0.209 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3211.0609 (IC base=+0.117)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.0172` → IC=+0.241 (n=442)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0172 (IC base=+0.226)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.243 (n=407)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.4543` → IC=+0.277 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4543 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.563` → IC=+0.349 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.563 (IC base=+0.226)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.220 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.226)

- **PATRÓN** `sigma_h` < `0.0172` → IC=+0.209 (n=555)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.243 (n=376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.119` → IC=+0.197 (n=609)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.125 (n=1262)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0083 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.468` → IC=+0.138 (n=346)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.468 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.997` → IC=+0.233 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.997 (IC base=+0.097)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `12.471` → IC=+0.181 (n=70)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 12.471 (IC base=+0.073)

- **PATRÓN** `libro_liquidez` > `10368.8183` → IC=+0.122 (n=207)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 10368.8183 (IC base=+0.073)
...
- **PATRÓN** `libro_liquidez` > `6662.3921` → IC=+0.122 (n=228)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 6662.3921 (IC base=+0.054)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `8.996` → IC=+0.271 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.996 (IC base=+0.051)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.0189` → IC=+0.175 (n=488)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0189 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.169 (n=496)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0103 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.173 (n=563)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.169 (n=497)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 15.0 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.4573` → IC=+0.223 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4573 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.932` → IC=+0.290 (n=103)
...
- **PATRÓN** `ibs_15` > `0.6045` → IC=+0.173 (n=647)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `ibs_15` > 0.6045 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.163 (n=238)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.054)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.106` → IC=+0.150 (n=235)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 5.106 (IC base=+0.054)

- **PATRÓN** `libro_liquidez` > `10314.0826` → IC=+0.138 (n=183)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 10314.0826 (IC base=+0.054)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2197` → IC=+0.138 (n=316)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.2197 (IC base=+0.100)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0631` → IC=+0.126 (n=316)
...
- **PATRÓN** `dist_vwap_pct` > `0.257` → IC=+0.234 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.257 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `24.506` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 24.506 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `11693.755` → IC=+0.167 (n=109)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 11693.755 (IC base=+0.100)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6045 sube el IC de +0.054 a +0.173 en UPDOWN_GBM#15min (n=647). Ya aplicado como kelly_boost=+0.87€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.6374 sube el IC de +0.100 a +0.216 en UPDOWN_GBM#BTC#15min (n=276). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1427 | +0.098 | +35.13€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1427 | +0.098 | +35.13€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 572 | +0.092 | +5.49€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 572 | +0.092 | +5.49€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 6927 | +0.176 | -64.06€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4556 | +0.200 | -52.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 317 | +0.058 | -21.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 821 | +0.128 | -56.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1233 | +0.150 | +66.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 2052 | +0.182 | -9.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1523 | +0.197 | -48.82€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 105 | +0.042 | -14.32€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 414 | +0.171 | +57.14€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 8 | +0.120 | +5.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 7 | +0.097 | +4.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 2427 | +0.166 | -52.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1493 | +0.198 | -6.61€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 2401 | +0.181 | -9.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1500 | +0.205 | -0.50€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 22 | +0.417 | +2.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 22 | +0.417 | +2.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 8 | +0.120 | +0.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 8 | +0.120 | +0.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 9 | +0.184 | +1.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 9 | +0.184 | +1.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 5 | +0.089 | +0.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 5 | +0.089 | +0.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 15 | +0.243 | +0.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 15 | +0.243 | +0.43€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 6 | +0.113 | +0.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 6 | +0.113 | +0.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 446 | +0.304 | +8.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 446 | +0.304 | +8.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 446 | +0.304 | +8.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 446 | +0.304 | +8.52€ | 0 | 0 |
| ✅ GBM_LATE_15M | 8740 | +0.093 | +2598.40€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8740 | +0.093 | +2598.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 76 | +0.179 | +35.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 76 | +0.179 | +35.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2075 | +0.070 | +344.58€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2075 | +0.070 | +344.58€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 76 | +0.090 | +11.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 76 | +0.090 | +11.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1867 | +0.070 | +304.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1867 | +0.070 | +304.24€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2314 | +0.084 | +791.11€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2314 | +0.084 | +791.11€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2332 | +0.138 | +1110.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2332 | +0.138 | +1110.81€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5964 | +0.118 | +2823.32€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5964 | +0.118 | +2823.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 58 | +0.333 | +70.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 58 | +0.333 | +70.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1522 | +0.082 | +503.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1522 | +0.082 | +503.33€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 72 | +0.189 | +45.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 72 | +0.189 | +45.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1516 | +0.086 | +532.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1516 | +0.086 | +532.92€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1466 | +0.087 | +587.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1466 | +0.087 | +587.21€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1330 | +0.214 | +1083.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1330 | +0.214 | +1083.01€ | 0 | 13 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 293 | +0.063 | +100.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 293 | +0.063 | +100.17€ | 0 | 0 |
| 🚫 GBM_LATE_15M_PYCONFIRMADO#BTC | 9 | -0.102 | -1.94€ | 0 | 0 |
| 🚫 GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 9 | -0.102 | -1.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 129 | -0.065 | +1.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 129 | -0.065 | +1.80€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 5958 | +0.065 | +1575.54€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5958 | +0.065 | +1575.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 65 | +0.276 | +53.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 65 | +0.276 | +53.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1390 | +0.024 | +151.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1390 | +0.024 | +151.77€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 70 | +0.181 | +30.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 70 | +0.181 | +30.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1420 | +0.019 | +111.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1420 | +0.019 | +111.92€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1380 | +0.025 | +255.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1380 | +0.025 | +255.28€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1633 | +0.160 | +972.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1633 | +0.160 | +972.46€ | 0 | 14 |
| ✅ GBM_LATE_5M | 890 | -0.039 | -10.08€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 890 | -0.039 | -10.08€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#SOL | 301 | -0.058 | +8.84€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 301 | -0.058 | +8.84€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP | 326 | +0.024 | +10.21€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 326 | +0.024 | +10.21€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 3001 | +0.034 | +264.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2737 | +0.050 | +303.40€ | 0 | 5 |
...
| ✅ UPDOWN_GBM#BTC | 599 | +0.054 | +75.41€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 515 | +0.086 | +89.89€ | 1 | 9 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2290 | +0.148 | +987.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2290 | +0.148 | +987.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 224 | +0.217 | +153.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 224 | +0.217 | +153.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 240 | +0.103 | +37.93€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 240 | +0.103 | +37.93€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 644 | +0.167 | +375.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 644 | +0.167 | +375.69€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.163: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.070 n=1751 | neutral: IC=+0.023 n=1379 | overbought(IBS>0.7): IC=+0.185 n=1677
  - _Datos_: n=5127 IC=+0.101 PNL=+1320.45€
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 13 celda(s) pasan gate riguroso completo de 38 evaluadas (n>=40) y 156 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.110 n=24083 | tras_1loss IC=+0.077 n=16236 | tras_2loss IC=+0.052 n=6816/40 | gap=+0.058 (umbral 0.05)
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=311 IC=+0.002 PNL=-3.22€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=311 IC=+0.002 PNL=-3.22€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2864 IC=+0.038 PNL=+278.17€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2864 IC=+0.038 PNL=+278.17€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1140 IC=+0.054 PNL=+153.59€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1140 IC=+0.054 PNL=+153.59€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=515 IC=+0.086 PNL=+89.89€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=515 IC=+0.086 PNL=+89.89€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.086 > 0.08 con n=1441 PNL=+239.02€
  - _Datos_: n=1441 IC=+0.086 PNL=+239.02€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.240 > 0.08 con n=202 PNL=+43.30€
  - _Datos_: n=202 IC=+0.240 PNL=+43.30€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=4276 IC=+0.068 PNL=+765.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4276 IC=+0.068 PNL=+765.17€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1290 IC=+0.030 PNL=+123.04€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1290 IC=+0.030 PNL=+123.04€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.158 > 0.1 con n=1047 PNL=+346.24€
  - _Datos_: n=1047 IC=+0.158 PNL=+346.24€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=239 IC=+0.056 PNL=+2.07€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=239 IC=+0.056 PNL=+2.07€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1047 IC=-0.073 PNL=+265.21€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1047 IC=-0.073 PNL=+265.21€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1138 IC=+0.053 PNL=+117.41€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1138 IC=+0.053 PNL=+117.41€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.118 > 0.08 con n=736 PNL=+199.84€
  - _Datos_: n=736 IC=+0.118 PNL=+199.84€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.170 > 0.08 con n=301 PNL=+109.92€
  - _Datos_: n=301 IC=+0.170 PNL=+109.92€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.211 > 0.2 con n=765 PNL=+463.74€
  - _Datos_: n=765 IC=+0.211 PNL=+463.74€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.097 > 0.08 con n=576 PNL=+140.86€
  - _Datos_: n=576 IC=+0.097 PNL=+140.86€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.104 > 0.08 con n=622 PNL=+183.05€
  - _Datos_: n=622 IC=+0.104 PNL=+183.05€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.08 con n=782 PNL=+376.02€
  - _Datos_: n=782 IC=+0.125 PNL=+376.02€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.271 > 0.08 con n=513 PNL=-1.67€
  - _Datos_: n=513 IC=+0.271 PNL=-1.67€
