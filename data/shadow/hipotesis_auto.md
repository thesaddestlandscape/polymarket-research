# Hipótesis automáticas — 2026-08-24 09:10 UTC
_Generado por shadow_postmortem.py sobre 136424 resoluciones (PNL=+9421.73€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `156.96` → IC=-0.257 (n=1905)
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.263 (n=2569)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.161 (n=1118)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 11.0 (IC base=+0.159)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=1310)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.227 (n=1029)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `restante_min` > `4.92` → IC=+0.155 (n=1222)
...
- **PATRÓN** `lag_apertura_s` < `4.58` → IC=+0.153 (n=1152)

  - _Acción_: Kelly boost +0.77€ cuando `lag_apertura_s` < 4.58 (IC base=+0.132)
...
- **PATRÓN** `dist_vwap_pct` > `1.7757` → IC=+0.192 (n=92)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 1.7757 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.3546` → IC=+0.153 (n=70)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.3546 (IC base=+0.052)
...
- **PATRÓN** `dist_vwap_pct` > `1.1861` → IC=+0.218 (n=37)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1861 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.22` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.22 (IC base=+0.052)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.237 (n=557)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1755)

- **FILTRO** `ibs_20min` > `0.2759` → IC=-0.206 (n=576)
...
- **FILTRO** `drift_20min_pct` |x|> `0.3408` → IC=-0.185 (n=90)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3408
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=271)
...
- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.203 (n=89)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.148 (n=1259)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4499)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.280 (n=1381)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=4377)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.232 (n=1433)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4325)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.183 (n=1927)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=3831)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.218 (n=1728)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=5357)
...
- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.241 (n=191)
...
- **FILTRO** `py_entrada` < `0.32` → IC=-0.343 (n=189)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=602)

- **FILTRO** `ibs_7min` < `0.2097` → IC=-0.284 (n=197)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.263 (n=264)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=959)

- **FILTRO** `ibs_7min` > `0.2772` → IC=-0.162 (n=415)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.185 (n=211)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=762)
...
- **FILTRO** `ibs_7min` < `0.7794` → IC=-0.202 (n=243)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=730)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.220 (n=237)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=736)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.217 (n=263)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=795)

- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.199 (n=264)
...
| ✅ BALLENAS_TARDIAS | 5821 | -0.100 | -693.97€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 619 | -0.083 | -108.36€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5202 | -0.102 | -585.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 849 | -0.018 | -99.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 849 | -0.018 | -99.59€ | 1 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 12784 | +0.193 | -1119.89€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 12784 | +0.193 | -1119.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2371 | +0.124 | -447.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2371 | +0.124 | -447.13€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1974 | +0.236 | -48.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1974 | +0.236 | -48.48€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2222 | +0.159 | -299.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2222 | +0.159 | -299.24€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2018 | +0.238 | -42.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2018 | +0.238 | -42.11€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2044 | +0.224 | -85.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2044 | +0.224 | -85.00€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 4595 | +0.132 | +125.55€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 4595 | +0.132 | +125.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2280 | +0.142 | +105.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2280 | +0.142 | +105.59€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 3951 | +0.099 | -146.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 407 | +0.053 | -24.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 3544 | +0.104 | -121.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 2728 | +0.097 | -73.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 407 | +0.053 | -24.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 2321 | +0.105 | -49.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1223 | +0.102 | -72.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1223 | +0.102 | -72.52€ | 0 | 0 |
...
| ✅ GBM_LATE_5M | 819 | +0.114 | +341.57€ | 1 | 19 |
| ✅ GBM_LATE_5M#5min | 819 | +0.114 | +341.57€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 261 | +0.135 | +100.15€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 261 | +0.135 | +100.15€ | 0 | 16 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 4672 | -0.033 | +148.37€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 4672 | -0.033 | +148.37€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 762 | -0.048 | +4.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 762 | -0.048 | +4.60€ | 4 | 0 |
...
| ✅ MOMENTUM_IBS_5M | 2397 | +0.007 | +6.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 2397 | +0.007 | +6.62€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#ETH | 681 | +0.018 | +15.52€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#ETH#5min | 681 | +0.018 | +15.52€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL | 1091 | +0.009 | +2.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 1091 | +0.009 | +2.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 12843 | -0.070 | +273.40€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 12843 | -0.070 | +273.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 1947 | -0.093 | +231.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 1947 | -0.093 | +231.32€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 2440 | -0.054 | +18.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 2440 | -0.054 | +18.69€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 2014 | -0.082 | +38.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 2014 | -0.082 | +38.65€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 1963 | -0.101 | -174.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 1963 | -0.101 | -174.36€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 2342 | -0.044 | +37.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 2342 | -0.044 | +37.40€ | 4 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.093) — sin ventaja clara. oversold(IBS<0.3): IC=-0.005 n=1629 | neutral: IC=+0.008 n=1737 | overbought(IBS>0.7): IC=+0.089 n=1916
  - _Datos_: n=5550 IC=+0.033 PNL=+383.26€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.078 n=76736 | tras_1loss IC=+0.045 n=59388 | tras_2loss IC=+0.009 n=26958/40 | gap=+0.070 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 4682 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.015 n=478 | contrario_BTC IC=+0.006 n=352/40 | gap=+0.020 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=4503 IC=+0.006 PNL=+87.71€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=4503 IC=+0.006 PNL=+87.71€
...
**〰️ H-CUSTOM-GBM-09H** — GBM a las 09h UTC — bloqueada 2026-06-29
  ...
  - _Estado_: n=63 IC=+0.023 PNL=+6.15€ — sin señal clara aún (umbral IC: min=None max=-0.1)
  - _Datos_: n=63 IC=+0.023 PNL=+6.15€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=1622 IC=-0.012 PNL=-37.12€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1622 IC=-0.012 PNL=-37.12€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=642 IC=+0.023 PNL=+34.71€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=642 IC=+0.023 PNL=+34.71€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=3281 IC=-0.127 PNL=+311.75€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3281 IC=-0.127 PNL=+311.75€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2371 IC=+0.124 PNL=-447.13€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2371 IC=+0.124 PNL=-447.13€
