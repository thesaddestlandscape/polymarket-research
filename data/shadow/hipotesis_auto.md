# Hipótesis automáticas — 2026-07-28 21:50 UTC
_Generado por shadow_postmortem.py sobre 40800 resoluciones (PNL=+8525.12€)_
...
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.154 (n=1454)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0068 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.134 (n=1499)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.3924` → IC=+0.122 (n=353)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` > 0.3924 (IC base=+0.121)
...
- **PATRÓN** `dist_vwap_pct` > `0.4727` → IC=+0.137 (n=356)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.4727 (IC base=+0.098)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.702` → IC=+0.246 (n=132)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.702 (IC base=+0.051)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6018` → IC=+0.173 (n=652)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.86€ cuando `ibs_15` > 0.6018 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` > `0.1672` → IC=+0.163 (n=241)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1672 (IC base=+0.055)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.021` → IC=+0.149 (n=240)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 5.021 (IC base=+0.055)

- **PATRÓN** `libro_liquidez` > `10314.0826` → IC=+0.136 (n=185)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 10314.0826 (IC base=+0.055)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6018 sube el IC de +0.055 a +0.173 en UPDOWN_GBM#15min (n=652). Ya aplicado como kelly_boost=+0.86€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ GBM_LATE_15M | 8798 | +0.093 | +2627.52€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8798 | +0.093 | +2627.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 88 | +0.200 | +51.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 88 | +0.200 | +51.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2085 | +0.069 | +340.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2085 | +0.069 | +340.21€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 86 | +0.091 | +14.13€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 86 | +0.091 | +14.13€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1873 | +0.070 | +303.99€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1873 | +0.070 | +303.99€ | 0 | 7 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 6015 | +0.118 | +2846.26€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 6015 | +0.118 | +2846.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 65 | +0.351 | +84.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 65 | +0.351 | +84.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1531 | +0.081 | +498.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1531 | +0.081 | +498.34€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 81 | +0.187 | +51.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 81 | +0.187 | +51.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1523 | +0.086 | +529.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1523 | +0.086 | +529.89€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1475 | +0.087 | +587.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1475 | +0.087 | +587.46€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1340 | +0.215 | +1094.56€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 76 | +0.282 | +67.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1397 | +0.022 | +148.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1397 | +0.022 | +148.71€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 80 | +0.171 | +33.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 80 | +0.171 | +33.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1426 | +0.018 | +111.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1426 | +0.018 | +111.47€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1386 | +0.025 | +257.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1386 | +0.025 | +257.34€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 3009 | +0.034 | +268.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2745 | +0.050 | +307.53€ | 0 | 5 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 131 | -0.064 | -11.72€ | 6 | 0 |
| ✅ UPDOWN_GBM#BNB | 324 | +0.052 | +60.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 324 | +0.052 | +60.61€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2303 | +0.148 | +994.44€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2303 | +0.148 | +994.44€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 438 | +0.159 | +156.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 438 | +0.159 | +156.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 540 | +0.085 | +130.92€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 540 | +0.085 | +130.92€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.160: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.071 n=1755 | neutral: IC=+0.025 n=1391 | overbought(IBS>0.7): IC=+0.184 n=1684
  - _Datos_: n=5151 IC=+0.102 PNL=+1330.06€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.111 n=24229 | tras_1loss IC=+0.077 n=16325 | tras_2loss IC=+0.051 n=6863/40 | gap=+0.059 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2872 IC=+0.039 PNL=+282.30€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2872 IC=+0.039 PNL=+282.30€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1147 IC=+0.055 PNL=+155.94€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1147 IC=+0.055 PNL=+155.94€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.087 > 0.08 con n=1446 PNL=+241.59€
  - _Datos_: n=1446 IC=+0.087 PNL=+241.59€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=4500 IC=+0.071 PNL=+859.48€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4500 IC=+0.071 PNL=+859.48€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=447 IC=+0.019 PNL=+15.19€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=447 IC=+0.019 PNL=+15.19€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1297 IC=+0.031 PNL=+125.39€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1297 IC=+0.031 PNL=+125.39€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=1055 PNL=+350.37€
  - _Datos_: n=1055 IC=+0.159 PNL=+350.37€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1146 IC=+0.051 PNL=+114.33€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1146 IC=+0.051 PNL=+114.33€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.119 > 0.08 con n=743 PNL=+202.18€
  - _Datos_: n=743 IC=+0.119 PNL=+202.18€
