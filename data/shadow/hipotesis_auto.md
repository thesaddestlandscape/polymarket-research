# Hipótesis automáticas — 2026-09-26 15:51 UTC
_Generado por shadow_postmortem.py sobre 622209 resoluciones (PNL=+71057.43€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=508)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.126 (n=508)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` < 0.495 (IC base=+0.055)

- **PATRÓN** `ballena_activa_n` < `93.0` → IC=+0.147 (n=182)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 93.0 (IC base=+0.055)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.119 (n=373)
...
- **PATRÓN** `libro_liquidez` > `11781.953` → IC=+0.126 (n=145)
  ...
  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 11781.953 (IC base=+0.057)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.167 (n=142)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 94.0 (IC base=+0.057)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.26` → IC=-0.223 (n=7287)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.26
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=21864)
...
- **FILTRO** `restante_s_al_confirmar` < `166.11` → IC=-0.207 (n=1776)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 166.11
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=5330)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `127.5` → IC=-0.339 (n=1434)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.5
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=4305)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.206 (n=14290)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3596)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5676.6756` → IC=+0.178 (n=2290)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=11291)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=5807)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7848.8603` → IC=+0.176 (n=2197)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=2906)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 5.0 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.146 (n=2481)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.153 (n=477)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 11.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.139 (n=687)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.140 (n=779)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `1313.0714` → IC=+0.150 (n=681)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 1313.0714 (IC base=+0.136)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.431 (n=655)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.164 (n=560)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.245 (n=935)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.238)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.242 (n=935)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=35527)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.236 (n=15832)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=7214)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.230 (n=3188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.33` → IC=+0.143 (n=2485)

  - _Acción_: Kelly boost +0.71€ cuando `lag_apertura_s` < 3.33 (IC base=+0.121)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.187 (n=2693)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.38 (IC base=+0.113)

- **PATRÓN** `restante_min` < `4.2` → IC=+0.126 (n=2533)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.2 (IC base=+0.113)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.132 (n=2777)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` > 4.96 (IC base=+0.113)

- **PATRÓN** `lag_apertura_s` < `2.26` → IC=+0.138 (n=2517)

  - _Acción_: Kelly boost +0.69€ cuando `lag_apertura_s` < 2.26 (IC base=+0.113)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.318 (n=809)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.297 (n=353)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.276)

- **PATRÓN** `py_entrada` > `0.805` → IC=+0.325 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.805 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `4267.8515` → IC=+0.298 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4267.8515 (IC base=+0.276)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.330 (n=385)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.275 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1367.7996` → IC=+0.284 (n=383)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4858` → IC=+0.123 (n=8419)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4858 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9838` → IC=+0.243 (n=2807)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9838 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.834` → IC=+0.247 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.834 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.6253` → IC=+0.250 (n=2398)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6253 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.973` → IC=+0.179 (n=3220)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.973 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2024` → IC=+0.247 (n=2297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2024 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0422` → IC=+0.261 (n=1042)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4616` → IC=+0.204 (n=5801)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4616 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.5708` → IC=+0.134 (n=10155)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3482` → IC=+0.167 (n=1891)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3482 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.172 (n=908)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.177 (n=1930)
...
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.233 (n=642)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.1127` → IC=+0.236 (n=641)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1127 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.232 (n=1529)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.217 (n=1484)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` > `0.9861` → IC=+0.271 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9861 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` > `0.1954` → IC=+0.219 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1954 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.5633` → IC=+0.221 (n=1527)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5633 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.762` → IC=+0.261 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.762 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` < `1.2505` → IC=+0.219 (n=1457)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2505 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `1.0769` → IC=+0.226 (n=661)
...
- **PATRÓN** `libro_liquidez` > `11154.7281` → IC=+0.225 (n=1457)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11154.7281 (IC base=+0.217)
...
- **PATRÓN** `ibs_20min` < `0.7007` → IC=+0.170 (n=1514)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.7007 (IC base=+0.140)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=1975)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.190 (n=1692)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.173` → IC=+0.256 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.173 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.1009` → IC=+0.188 (n=1631)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1009 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.3568` → IC=+0.193 (n=252)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.3568 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `1.7786` → IC=+0.192 (n=1600)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.7786 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1314)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.221 (n=1427)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.6119` → IC=+0.211 (n=1619)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `libro_liquidez` > `1909.461` → IC=+0.216 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1909.461 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.214 (n=946)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.74` → IC=+0.162 (n=740)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.125 (n=2273)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1130)

- **FILTRO** `sigma_ewma_delta_pct` > `8.719` → IC=-0.210 (n=363)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.719
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=3040)
...
- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.124 (n=1130)
...
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.183 (n=592)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1787)

- **FILTRO** `ibs_20min` < `0.72` → IC=-0.153 (n=1570)

  - _Acción_: SKIP cuando `ibs_20min` < 0.72
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=809)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.198 (n=455)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1924)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.203 (n=866)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=2625)
...
- **PATRÓN** `ibs_20min` < `0.5499` → IC=+0.154 (n=9262)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.5499 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.7151` → IC=+0.241 (n=663)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7151 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` < `0.2501` → IC=+0.241 (n=2971)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2501 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` < `0.7084` → IC=+0.242 (n=1376)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6004` → IC=+0.260 (n=1827)
...
- **FILTRO** `ibs_20min` < `0.2571` → IC=-0.148 (n=732)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2571
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=2198)

- **FILTRO** `sigma_ewma_delta_pct` > `4.548` → IC=-0.160 (n=559)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.548
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1870)

- **PATRÓN** `ibs_20min` > `0.8969` → IC=+0.265 (n=734)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4344` → IC=+0.176 (n=313)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4344 (IC base=+0.043)
...
- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.188 (n=405)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 13.0 (IC base=+0.043)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4765` → IC=+0.451 (n=79)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4765 (IC base=-0.019)
...
- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.466 (n=56)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=-0.019)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `ibs_20min` > `0.8652` → IC=+0.163 (n=712)
...
- **PATRÓN** `volumen_regimen` > `0.6746` → IC=+0.169 (n=880)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6746 (IC base=+0.026)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3925` → IC=+0.161 (n=322)
...
- **PATRÓN** `dist_vwap_pct` < `0.1527` → IC=+0.217 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1527 (IC base=+0.005)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4386` → IC=+0.210 (n=188)
...
- **PATRÓN** `ballena_activa_n` < `459.0` → IC=+0.214 (n=561)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 459.0 (IC base=+0.005)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.251 (n=1669)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.247)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.248 (n=1684)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.681` → IC=+0.283 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.681 (IC base=+0.247)

- **PATRÓN** `volumen_pendiente_norm` < `0.1031` → IC=+0.260 (n=1415)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1031 (IC base=+0.247)
...
- **PATRÓN** `libro_liquidez` > `1911.2354` → IC=+0.253 (n=756)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1911.2354 (IC base=+0.247)
...
- **FILTRO** `ibs_20min` < `0.2966` → IC=-0.174 (n=525)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2966
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1578)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.187 (n=625)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1878)

- **PATRÓN** `ibs_20min` > `0.9118` → IC=+0.180 (n=526)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.9118 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` > `0.4359` → IC=+0.220 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4359 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` < `0.6749` → IC=+0.217 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6749 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` < `0.9865` → IC=+0.243 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9865 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` > `0.5875` → IC=+0.216 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5875 (IC base=+0.015)

- **PATRÓN** `volumen_pendiente_norm` > `0.0768` → IC=+0.260 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0768 (IC base=+0.015)

- **PATRÓN** `volumen_spike_ratio` < `1.5025` → IC=+0.263 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5025 (IC base=+0.015)

- **PATRÓN** `volumen_spike_ratio` > `1.7472` → IC=+0.232 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7472 (IC base=+0.015)
...
- **FILTRO** `ibs_20min` < `0.7328` → IC=-0.194 (n=1125)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7328
  - _Potencial_: sin este filtro IC_bueno=+0.279 (n=1126)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.723` → IC=-0.187 (n=506)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.723
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=1805)

- **PATRÓN** `ibs_20min` > `0.7328` → IC=+0.279 (n=1126)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7328 (IC base=+0.043)

- **PATRÓN** `dist_vwap_pct` > `0.8593` → IC=+0.327 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8593 (IC base=+0.043)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.65` → IC=+0.169 (n=354)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 9.65 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.304 (n=559)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` > `0.7279` → IC=+0.293 (n=747)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4182` → IC=+0.327 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4182 (IC base=+0.043)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.316 (n=714)
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.346 (n=916)
...
- **PATRÓN** `volumen_regimen` > `0.8606` → IC=+0.303 (n=914)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4333` → IC=+0.287 (n=1302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4333 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1455)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2476.2478` → IC=+0.291 (n=1224)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2476.2478 (IC base=+0.277)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.173 (n=2738)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.200 (n=2737)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.184 (n=2736)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=8554)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5745` → IC=+0.218 (n=8202)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5745 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1757` → IC=+0.193 (n=3557)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1757 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.35` → IC=+0.254 (n=1675)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.35 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2075` → IC=+0.160 (n=5434)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2075 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6301` → IC=+0.161 (n=5435)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6301 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2425` → IC=+0.194 (n=1654)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2425 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5572` → IC=+0.167 (n=3465)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5572 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6103` → IC=+0.176 (n=2625)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6103 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2410.2644` → IC=+0.169 (n=5468)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2410.2644 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `112.0` → IC=+0.181 (n=7116)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.336` → IC=+0.194 (n=1326)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.336 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1727` → IC=+0.152 (n=5660)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5595` → IC=+0.166 (n=3147)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5595 (IC base=+0.168)
...
- **PATRÓN** `ballena_activa_n` < `113.0` → IC=+0.174 (n=6796)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 113.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.211 (n=465)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3418` → IC=+0.206 (n=1391)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3418 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=1463)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.182 (n=1289)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.183)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=1421)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.240 (n=406)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.0732` → IC=+0.194 (n=406)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.0732 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.186 (n=1216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 6.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4056` → IC=+0.227 (n=1216)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4056 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2087` → IC=+0.213 (n=712)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2087 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.482` → IC=+0.239 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.482 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `0.6875` → IC=+0.167 (n=535)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6875 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.170 (n=552)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0678 (IC base=+0.162)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2047` → IC=+0.201 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2047 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `1.8041` → IC=+0.198 (n=578)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.8041 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `2.816` → IC=+0.215 (n=595)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.816 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.210 (n=1629)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.174 (n=1156)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0066 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.4277` → IC=+0.159 (n=1312)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.4277 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1377)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.3749` → IC=+0.197 (n=1312)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3749 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.1493` → IC=+0.177 (n=864)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.1493 (IC base=+0.144)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1527)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.5741` → IC=+0.212 (n=1507)
...
- **PATRÓN** `dist_vwap_pct` < `0.2075` → IC=+0.140 (n=1380)
...
- **PATRÓN** `volumen_regimen` < `0.6381` → IC=+0.147 (n=503)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1475)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7386` → IC=+0.258 (n=1268)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.240 (n=671)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.205 (n=1421)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.8564` → IC=+0.221 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8564 (IC base=+0.201)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1481` → IC=+0.211 (n=1208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1481 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4077` → IC=+0.209 (n=1372)
...
- **PATRÓN** `libro_liquidez` > `2828.7134` → IC=+0.206 (n=644)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2828.7134 (IC base=+0.201)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.174 (n=673)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0038 (IC base=+0.151)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.174 (n=670)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0088 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3531` → IC=+0.155 (n=1767)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.3531 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.169 (n=1844)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 8.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.5377` → IC=+0.190 (n=1793)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.5377 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.8569` → IC=+0.176 (n=331)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.8569 (IC base=+0.151)
...
- **PATRÓN** `volumen_regimen` < `0.8709` → IC=+0.170 (n=1182)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8709 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `1.2097` → IC=+0.159 (n=591)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.2097 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1642` → IC=+0.179 (n=553)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1642 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `1.4417` → IC=+0.164 (n=646)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4417 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.8245` → IC=+0.158 (n=1292)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8245 (IC base=+0.151)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.156 (n=2273)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.02 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `12369.1399` → IC=+0.159 (n=669)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12369.1399 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.171 (n=1785)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 151.0 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.138 (n=1375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0056 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=2077)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6667` → IC=+0.137 (n=2064)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.6667 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2104` → IC=+0.121 (n=1844)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2104 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.6989` → IC=+0.130 (n=819)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 0.6989 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4512` → IC=+0.144 (n=663)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4512 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3921.3253` → IC=+0.127 (n=1374)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 3921.3253 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.126 (n=851)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.130 (n=328)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` < 0.0039 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.3382` → IC=+0.130 (n=492)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.3382 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=460)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.2558` → IC=+0.156 (n=492)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.2558 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.3004` → IC=+0.148 (n=174)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.3004 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.6136` → IC=+0.157 (n=164)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6136 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `10937.2581` → IC=+0.136 (n=492)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 10937.2581 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.139 (n=156)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 147.0 (IC base=+0.112)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.263 (n=277)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=656)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1466` → IC=+0.205 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1466 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` < `0.2183` → IC=+0.200 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2183 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.064` → IC=+0.230 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.064 (IC base=+0.199)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2643` → IC=+0.263 (n=91)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2643 (IC base=+0.199)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7512` → IC=+0.226 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7512 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=697)
...
- **FILTRO** `dist_vwap_pct` > `0.6016` → IC=-0.147 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.090 (n=545)
...
- **PATRÓN** `volumen_regimen` < `0.7082` → IC=+0.144 (n=186)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.7082 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `1.5789` → IC=+0.176 (n=174)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.5789 (IC base=+0.084)

- **PATRÓN** `libro_liquidez` > `2590.446` → IC=+0.131 (n=280)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2590.446 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.132 (n=368)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 42.0 (IC base=+0.084)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.206 (n=3513)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=10993)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.9634` → IC=+0.203 (n=1498)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9634 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.345` → IC=+0.244 (n=2647)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.345 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `0.8799` → IC=+0.166 (n=4695)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8799 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2882` → IC=+0.202 (n=1452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2882 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.587` → IC=+0.188 (n=3379)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.587 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `1794.8354` → IC=+0.172 (n=10531)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1794.8354 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `85.0` → IC=+0.196 (n=8087)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 85.0 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=6354)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.196 (n=5625)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 47.0 (IC base=+0.182)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.210 (n=595)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3528` → IC=+0.191 (n=1775)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.3528 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.205 (n=847)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.211 (n=1796)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.199 (n=563)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.0846` → IC=+0.160 (n=562)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0846 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1763)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 5.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.3081` → IC=+0.203 (n=1686)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3081 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.3405` → IC=+0.191 (n=672)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.3405 (IC base=+0.151)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.2` → IC=+0.153 (n=1524)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.2 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6272` → IC=+0.179 (n=562)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6272 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.2657` → IC=+0.205 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2657 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.1136` → IC=+0.160 (n=1435)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1136 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7544` → IC=+0.158 (n=1087)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7544 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `11318.7174` → IC=+0.161 (n=1506)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 11318.7174 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `470.0` → IC=+0.159 (n=1562)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1797)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1745)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.217)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.811` → IC=+0.294 (n=499)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.811 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.1346` → IC=+0.219 (n=1560)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1346 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `1.7707` → IC=+0.228 (n=1464)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7707 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.227 (n=1197)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1914.56` → IC=+0.219 (n=778)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1914.56 (IC base=+0.217)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.188 (n=598)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0035 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4335` → IC=+0.147 (n=1791)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.4335 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=1871)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8762` → IC=+0.262 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8762 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3627` → IC=+0.163 (n=707)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.3627 (IC base=+0.137)
...
- **PATRÓN** `volumen_regimen` < `0.8725` → IC=+0.156 (n=1194)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8725 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5155` → IC=+0.153 (n=764)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.5155 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4575` → IC=+0.154 (n=579)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.4575 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8024.5486` → IC=+0.232 (n=812)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.141 (n=1191)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0081 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1838)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.191 (n=1787)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.4706 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.0933` → IC=+0.197 (n=378)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 1.0933 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.51` → IC=+0.238 (n=667)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.51 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.8929` → IC=+0.135 (n=1191)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8929 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1800)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2904.4304` → IC=+0.254 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2904.4304 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.131 (n=1395)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 54.0 (IC base=+0.114)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.176 (n=575)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_spike_ratio` < `1.44` → IC=+0.141 (n=521)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.44 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2811.5163` → IC=+0.174 (n=575)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2811.5163 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.124 (n=1351)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 51.0 (IC base=+0.114)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.226 (n=1590)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0132 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1858)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.211 (n=1599)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.6` → IC=+0.258 (n=1597)
...
- **PATRÓN** `volumen_regimen` < `1.243` → IC=+0.212 (n=1780)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.243 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.64` → IC=+0.218 (n=1780)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.64 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2323` → IC=+0.252 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2323 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.5001` → IC=+0.233 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5001 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.218 (n=1854)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `2626.1883` → IC=+0.218 (n=1187)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2626.1883 (IC base=+0.209)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.148 (n=3198)

- **PATRÓN** `sigma_h` < `0.009` → IC=+0.171 (n=2708)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.009 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.5152` → IC=+0.170 (n=3078)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.5152 (IC base=+0.160)
...
- **PATRÓN** `ibs_20min` > `0.9415` → IC=+0.217 (n=1026)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9415 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.18` → IC=+0.172 (n=1147)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.18 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` < `0.4695` → IC=+0.160 (n=1937)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.4695 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.2` → IC=+0.195 (n=506)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.2 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.163 (n=2067)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6307 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.1707` → IC=+0.198 (n=852)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1707 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `1.4563` → IC=+0.168 (n=1014)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4563 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.8741` → IC=+0.169 (n=2027)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.8741 (IC base=+0.160)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.161 (n=3431)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.02 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `3963.7863` → IC=+0.170 (n=2052)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3963.7863 (IC base=+0.160)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.203 (n=808)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.4847` → IC=+0.165 (n=2410)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0723` → IC=+0.148 (n=1112)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.0723 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.5347` → IC=+0.159 (n=1048)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.5347 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.8163` → IC=+0.149 (n=1587)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8163 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=3198)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `7069.1221` → IC=+0.158 (n=2153)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 7069.1221 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.178 (n=913)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0072 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.3801` → IC=+0.176 (n=911)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3801 (IC base=+0.171)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.183 (n=393)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 17.0 (IC base=+0.171)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.177 (n=354)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 4.0 (IC base=+0.171)

- **PATRÓN** `ibs_20min` < `0.5342` → IC=+0.186 (n=690)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.5342 (IC base=+0.171)

- **PATRÓN** `ibs_20min` > `0.8847` → IC=+0.180 (n=345)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.8847 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.4016` → IC=+0.181 (n=971)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.4016 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.251` → IC=+0.171 (n=171)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 11.251 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.178` → IC=+0.181 (n=926)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 4.178 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.0828` → IC=+0.172 (n=911)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.0828 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6409` → IC=+0.174 (n=1035)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6409 (IC base=+0.171)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4598` → IC=+0.175 (n=1016)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.4598 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `1.7745` → IC=+0.173 (n=677)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.7745 (IC base=+0.171)
...
- **PATRÓN** `sigma_h` < `0.0129` → IC=+0.134 (n=263)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0129 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.150 (n=181)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 6.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.252 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.1983` → IC=+0.163 (n=188)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1983 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.177` → IC=+0.191 (n=53)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 9.177 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.9028` → IC=+0.140 (n=176)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.9028 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.1658` → IC=+0.199 (n=81)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1658 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.139 (n=253)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.4355 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `3433.7126` → IC=+0.158 (n=235)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3433.7126 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.133 (n=216)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 58.0 (IC base=+0.117)
...
- **FILTRO** `dist_vwap_pct` > `0.178` → IC=-0.155 (n=27)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=350)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.183 (n=430)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.004 (IC base=+0.088)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.193 (n=790)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.6667 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` > `0.1491` → IC=+0.151 (n=474)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1491 (IC base=+0.088)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2799` → IC=+0.183 (n=118)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2799 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` < `2.0999` → IC=+0.124 (n=677)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.0999 (IC base=+0.088)

- **PATRÓN** `libro_liquidez` > `2438.1282` → IC=+0.133 (n=390)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2438.1282 (IC base=+0.088)

- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.124 (n=261)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0045 (IC base=+0.016)

- **PATRÓN** `ibs_20min` < `0.0667` → IC=+0.279 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0667 (IC base=+0.016)

- **PATRÓN** `dist_vwap_pct` < `0.178` → IC=+0.125 (n=350)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.178 (IC base=+0.016)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.187` → IC=+0.132 (n=123)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 3.187 (IC base=+0.016)

- **PATRÓN** `volumen_pendiente_norm` > `0.138` → IC=+0.216 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.138 (IC base=+0.016)

- **PATRÓN** `volumen_spike_ratio` < `2.5298` → IC=+0.137 (n=254)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.5298 (IC base=+0.016)

- **PATRÓN** `volumen_spike_ratio` > `1.4395` → IC=+0.133 (n=227)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.4395 (IC base=+0.016)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.152 (n=222)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.005 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.131 (n=310)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 7.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.6632` → IC=+0.222 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6632 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.3353` → IC=+0.181 (n=117)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.3353 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.792` → IC=+0.277 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.792 (IC base=+0.100)

- **PATRÓN** `volumen_regimen` < `0.807` → IC=+0.129 (n=200)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.807 (IC base=+0.100)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7354` → IC=+0.159 (n=165)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.7354 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `1133.2011` → IC=+0.158 (n=264)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1133.2011 (IC base=+0.100)
...
- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.156 (n=251)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.6667 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.2066` → IC=+0.129 (n=157)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.2066 (IC base=+0.062)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.497` → IC=+0.143 (n=113)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 5.497 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `1.062` → IC=+0.167 (n=94)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.062 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.2436` → IC=+0.161 (n=54)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.2436 (IC base=+0.062)
...
- **FILTRO** `volumen_regimen` > `0.6561` → IC=-0.339 (n=29)
...
- **FILTRO** `dist_vwap_pct` > `0.6344` → IC=-0.179 (n=26)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=344)

- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.153 (n=122)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0058 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.641` → IC=+0.151 (n=267)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.641 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.4941` → IC=+0.197 (n=64)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.4941 (IC base=+0.084)

- **PATRÓN** `ibs_20min` < `0.1761` → IC=+0.160 (n=245)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1761 (IC base=+0.062)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.007` → IC=+0.149 (n=112)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 6.007 (IC base=+0.062)

- **PATRÓN** `libro_liquidez` > `3761.0521` → IC=+0.164 (n=126)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 3761.0521 (IC base=+0.062)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.122 (n=744)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2920.5936` → IC=+0.174 (n=253)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2920.5936 (IC base=+0.106)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=1886)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=823)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.125 (n=62)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=777)
...
- **PATRÓN** `py_entrada` < `0.47` → IC=+0.170 (n=222)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` < 0.47 (IC base=+0.021)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.190 (n=27)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.5 (IC base=+0.019)

- **PATRÓN** `restante_min` > `13.13` → IC=+0.125 (n=38)

  - _Acción_: Kelly boost +0.62€ cuando `restante_min` > 13.13 (IC base=+0.019)
...
- **PATRÓN** `py_entrada` < `0.45` → IC=+0.220 (n=23)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.45 (IC base=+0.038)

- **PATRÓN** `profundidad_ratio` > `46.5` → IC=+0.160 (n=45)

  - _Acción_: Kelly boost +0.80€ cuando `profundidad_ratio` > 46.5 (IC base=+0.038)
...
- **PATRÓN** `py_entrada` < `0.6` → IC=+0.143 (n=54)

  - _Acción_: Kelly boost +0.71€ cuando `py_entrada` < 0.6 (IC base=+0.024)

- **PATRÓN** `restante_min` > `13.48` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 13.48 (IC base=+0.024)

- **PATRÓN** `lag_apertura_s` < `90.99` → IC=+0.190 (n=27)

  - _Acción_: Kelly boost +0.95€ cuando `lag_apertura_s` < 90.99 (IC base=+0.024)

- **PATRÓN** `profundidad_ratio` > `4.8` → IC=+0.143 (n=40)

  - _Acción_: Kelly boost +0.71€ cuando `profundidad_ratio` > 4.8 (IC base=+0.024)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7658)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.167 (n=3659)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=11203)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.165 (n=3810)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=11577)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.208 (n=629)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1956)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.186 (n=654)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1983)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.206 (n=668)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=2093)

- **FILTRO** `ibs_20min` > `0.281` → IC=-0.165 (n=690)

  - _Acción_: SKIP cuando `ibs_20min` > 0.281
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=2071)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.49` → IC=-0.170 (n=640)

  - _Acción_: SKIP cuando `py_entrada` < 0.49
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1938)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.131 (n=10450)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=23420)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=8326)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=25544)

- **FILTRO** `ibs_7min` < `0.2805` → IC=-0.235 (n=8467)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2805
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=25403)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11462)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=22408)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.231 (n=10464)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=32200)

- **FILTRO** `ibs_7min` > `0.2924` → IC=-0.178 (n=10664)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2924
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=32000)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3926)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=1334)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4294)

- **FILTRO** `ibs_7min` < `0.7117` → IC=-0.250 (n=1857)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7117
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3771)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.188 (n=1249)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=4379)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1812)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5524)

- **FILTRO** `drift_7min_pct` |x|> `0.1107` → IC=-0.123 (n=2494)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1107
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4842)

- **FILTRO** `ibs_7min` > `0.788` → IC=-0.207 (n=1833)

  - _Acción_: SKIP cuando `ibs_7min` > 0.788
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=5503)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1372)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4468)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1419)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4421)

- **FILTRO** `ibs_7min` < `0.7473` → IC=-0.194 (n=1460)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7473
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4380)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.177 (n=1454)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=4386)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.264 (n=1368)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4566)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.180 (n=1481)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4453)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.183 (n=1476)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4458)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.166 (n=1313)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4043)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.304 (n=1325)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4031)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.260 (n=1339)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4017)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.222 (n=1200)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4156)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.239 (n=1809)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=6040)

- **FILTRO** `ibs_7min` > `0.75` → IC=-0.172 (n=1959)

  - _Acción_: SKIP cuando `ibs_7min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5890)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3784)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1652)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3934)

- **FILTRO** `ibs_7min` < `0.7403` → IC=-0.181 (n=1396)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7403
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4190)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.173 (n=1393)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4193)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.257 (n=1428)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=4288)

- **FILTRO** `ibs_7min` > `0.2747` → IC=-0.177 (n=1428)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2747
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4288)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1394)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4322)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.256 (n=1459)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4416)

- **FILTRO** `ibs_7min` < `0.298` → IC=-0.235 (n=1468)

  - _Acción_: SKIP cuando `ibs_7min` < 0.298
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=4407)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1927)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=6199)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.255 (n=1823)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3762)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.226 (n=1396)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4189)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1353)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4232)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.208 (n=1819)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=5884)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1111)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.125 (n=54)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=566)

### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3978` → IC=+0.126 (n=775)
...
- **PATRÓN** `hora_utc` < `13.0` → IC=+0.129 (n=138)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 13.0 (IC base=+0.092)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.092)

- **PATRÓN** `libro_liquidez` > `3589.6144` → IC=+0.153 (n=70)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3589.6144 (IC base=+0.092)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.415 (n=57)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0082 (IC base=+0.375)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.423 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.413)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=3006)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=1532)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.187 (n=570)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0044 (IC base=+0.186)

- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.219 (n=775)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0087 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0511` → IC=+0.203 (n=570)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0511 (IC base=+0.186)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2154` → IC=+0.186 (n=569)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.93€ cuando `delta_ratio_macro` |x|> 0.2154 (IC base=+0.186)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1274` → IC=+0.233 (n=608)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1274 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=1587)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6077` → IC=+0.267 (n=1708)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6077 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.3041` → IC=+0.187 (n=563)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.3041 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.6136` → IC=+0.180 (n=1623)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6136 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.77` → IC=+0.273 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.77 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `2959.5754` → IC=+0.195 (n=1139)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2959.5754 (IC base=+0.186)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.202 (n=943)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1797)
...
- **PATRÓN** `dist_vwap_pct` < `0.1081` → IC=+0.196 (n=412)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.1081 (IC base=-0.065)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0762` → IC=+0.246 (n=1696)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0762 (IC base=-0.029)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1784` → IC=+0.240 (n=1228)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1784 (IC base=-0.029)

- **PATRÓN** `ibs_15` < `0.3488` → IC=+0.276 (n=1899)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0102` → IC=-0.255 (n=161)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.143 (n=486)

- **FILTRO** `drift_15min` |x|> `0.89` → IC=-0.267 (n=161)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.89
  - _Potencial_: sin este filtro IC_bueno=-0.139 (n=486)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.219 (n=254)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.141 (n=393)

- **PATRÓN** `ibs_15` > `0.5625` → IC=+0.186 (n=49)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.93€ cuando `ibs_15` > 0.5625 (IC base=-0.172)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0765` → IC=+0.232 (n=289)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0765 (IC base=-0.041)

- **PATRÓN** `ibs_15` < `0.35` → IC=+0.264 (n=324)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.1951` → IC=+0.224 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1951 (IC base=-0.041)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `sigma_h` > `0.0198` → IC=-0.258 (n=399)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0198
  - _Potencial_: sin este filtro IC_bueno=-0.143 (n=401)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.264 (n=201)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6077 sube el IC de +0.186 a +0.267 en UPDOWN_GBM#15min (n=1708). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.052 a +0.156 en UPDOWN_GBM#XRP#15min (n=507). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6409 sube el IC de -0.065 a +0.273 en UPDOWN_GBM_15M_TARDIO (n=654). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3488 sube el IC de -0.029 a +0.276 en UPDOWN_GBM_15M_TARDIO (n=1899). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.041 a +0.264 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=324). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1348 | +0.101 | +205.18€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1348 | +0.101 | +205.18€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 1007 | +0.111 | +177.48€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 1007 | +0.111 | +177.48€ | 2 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 255 | +0.056 | +9.04€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 255 | +0.056 | +9.04€ | 6 | 6 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 29151 | -0.086 | -3884.93€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1538 | -0.037 | -227.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27613 | -0.088 | -3657.56€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3800 | -0.099 | -625.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3800 | -0.099 | -625.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1538 | -0.037 | -227.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1538 | -0.037 | -227.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3484 | -0.096 | -788.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3484 | -0.096 | -788.92€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7484 | -0.020 | -706.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7484 | -0.020 | -706.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 7106 | -0.089 | -447.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 7106 | -0.089 | -447.38€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5739 | -0.165 | -1089.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5739 | -0.165 | -1089.46€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 19369 | -0.026 | +3966.81€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 5035 | +0.001 | +1819.06€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 14334 | -0.036 | +2147.75€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 19369 | -0.026 | +3966.81€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 5035 | +0.001 | +1819.06€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 14334 | -0.036 | +2147.75€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 96547 | +0.113 | -4741.51€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14446 | +0.185 | -433.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 389 | -0.075 | -50.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 75494 | +0.100 | -4035.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6218 | +0.107 | -222.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12552 | +0.099 | -1020.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 46 | -0.167 | -1.52€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12491 | +0.101 | -1007.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 19514 | +0.132 | -370.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4562 | +0.203 | -136.11€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12516 | +0.112 | -186.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2394 | +0.102 | -25.42€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12591 | +0.090 | -1131.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 53 | -0.100 | -7.49€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12523 | +0.092 | -1112.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 20512 | +0.124 | -379.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5596 | +0.175 | -79.99€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12653 | +0.106 | -233.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2251 | +0.099 | -56.99€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18814 | +0.114 | -1087.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4142 | +0.189 | -216.35€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 292 | -0.034 | +3.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12807 | +0.091 | -734.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1573 | +0.126 | -140.17€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12564 | +0.100 | -752.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12504 | +0.101 | -760.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 15323 | +0.191 | -1015.17€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 15323 | +0.191 | -1015.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3635 | +0.167 | -384.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3635 | +0.167 | -384.11€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1345 | +0.195 | -18.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1345 | +0.195 | -18.90€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3587 | +0.180 | -307.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3587 | +0.180 | -307.27€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3164 | +0.239 | -103.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3164 | +0.239 | -103.39€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3513 | +0.192 | -215.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3513 | +0.192 | -215.25€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 52879 | +0.198 | -4120.53€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 52879 | +0.198 | -4120.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 9132 | +0.177 | -1051.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 9132 | +0.177 | -1051.65€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 8455 | +0.223 | -306.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 8455 | +0.223 | -306.53€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 9135 | +0.173 | -1086.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 9135 | +0.173 | -1086.12€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 8551 | +0.218 | -345.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 8551 | +0.218 | -345.08€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8737 | +0.204 | -567.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8737 | +0.204 | -567.23€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8869 | +0.194 | -763.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8869 | +0.194 | -763.93€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 19961 | +0.117 | +148.71€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 19961 | +0.117 | +148.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9909 | +0.121 | +133.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9909 | +0.121 | +133.48€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 10052 | +0.113 | +15.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 10052 | +0.113 | +15.24€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1517 | +0.289 | -21.12€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1517 | +0.289 | -21.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 677 | +0.276 | -20.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 677 | +0.276 | -20.66€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 729 | +0.291 | -2.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 729 | +0.291 | -2.59€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 670 | +0.436 | -3.19€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 670 | +0.436 | -3.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC | 318 | +0.434 | -3.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min | 318 | +0.434 | -3.00€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1150 | +0.071 | -51.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 399 | +0.054 | -36.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 751 | +0.080 | -15.45€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 910 | +0.078 | -23.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 159 | +0.065 | -8.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 751 | +0.080 | -15.45€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 37261 | +0.098 | -1106.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 3071 | +0.090 | +26.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 34190 | +0.098 | -1132.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 20878 | +0.102 | -326.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 3071 | +0.090 | +26.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 17807 | +0.104 | -352.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 7072 | +0.107 | -38.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 7072 | +0.107 | -38.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 9311 | +0.081 | -741.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 9311 | +0.081 | -741.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 834 | +0.216 | -102.47€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 834 | +0.216 | -102.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 834 | +0.216 | -102.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 834 | +0.216 | -102.47€ | 2 | 4 |
| ✅ GBM_LATE_15M | 26610 | +0.083 | +12716.64€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 26610 | +0.083 | +12716.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4444 | +0.194 | +3254.32€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4444 | +0.194 | +3254.32€ | 0 | 19 |
| ✅ GBM_LATE_15M#BTC | 3960 | +0.178 | +2790.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3960 | +0.178 | +2790.94€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 4663 | +0.197 | +3449.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4663 | +0.197 | +3449.98€ | 0 | 22 |
| ✅ GBM_LATE_15M#ETH | 3871 | +0.022 | +855.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3871 | +0.022 | +855.98€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3802 | -0.033 | +865.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3802 | -0.033 | +865.33€ | 4 | 13 |
| ✅ GBM_LATE_15M#XRP | 5870 | -0.040 | +1500.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5870 | -0.040 | +1500.09€ | 4 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 28209 | +0.086 | +14742.48€ | 0 | 19 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 28209 | +0.086 | +14742.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 5359 | +0.015 | +2805.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 5359 | +0.015 | +2805.05€ | 2 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5892 | +0.016 | +1238.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5892 | +0.016 | +1238.70€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 4008 | +0.263 | +4041.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 4008 | +0.263 | +4041.06€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4606 | +0.004 | +886.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4606 | +0.004 | +886.80€ | 2 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4562 | +0.028 | +1726.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4562 | +0.028 | +1726.71€ | 3 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3782 | +0.276 | +4044.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3782 | +0.276 | +4044.15€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 21385 | +0.168 | +16001.74€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 21385 | +0.168 | +16001.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 3223 | +0.207 | +2566.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 3223 | +0.207 | +2566.13€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3375 | +0.149 | +2477.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3375 | +0.149 | +2477.33€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3371 | +0.207 | +2674.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3371 | +0.207 | +2674.47€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3580 | +0.133 | +2494.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3580 | +0.133 | +2494.19€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3991 | +0.116 | +2761.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3991 | +0.116 | +2761.08€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3845 | +0.203 | +3028.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3845 | +0.203 | +3028.55€ | 0 | 26 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 5424 | +0.131 | +2360.85€ | 0 | 23 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 5424 | +0.131 | +2360.85€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 211 | +0.110 | +81.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 211 | +0.110 | +81.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1516 | +0.125 | +706.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1516 | +0.125 | +706.36€ | 0 | 21 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 373 | +0.143 | +176.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 373 | +0.143 | +176.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1625 | +0.148 | +759.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1625 | +0.148 | +759.58€ | 0 | 19 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1193 | +0.110 | +421.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1193 | +0.110 | +421.47€ | 1 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 506 | +0.134 | +215.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 506 | +0.134 | +215.28€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 26746 | +0.176 | +20016.93€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#15min | 26746 | +0.176 | +20016.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 4235 | +0.221 | +3581.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 4235 | +0.221 | +3581.23€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 4192 | +0.151 | +2798.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 4192 | +0.151 | +2798.21€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4415 | +0.224 | +3780.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4415 | +0.224 | +3780.84€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 4328 | +0.136 | +2964.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 4328 | +0.136 | +2964.05€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4679 | +0.114 | +3016.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4679 | +0.114 | +3016.15€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4897 | +0.206 | +3876.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4897 | +0.206 | +3876.46€ | 0 | 24 |
| ✅ GBM_LATE_5M | 7316 | +0.154 | +4366.98€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 7316 | +0.154 | +4366.98€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 2511 | +0.164 | +1551.45€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 2511 | +0.164 | +1551.45€ | 0 | 29 |
| ✅ GBM_LATE_5M#SOL | 672 | +0.126 | +296.77€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 672 | +0.126 | +296.77€ | 0 | 22 |
| ✅ GBM_LATE_5M#XRP | 837 | +0.116 | +326.92€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 837 | +0.116 | +326.92€ | 0 | 0 |
| ✅ GBM_LATE_60M | 1819 | +0.068 | +736.60€ | 2 | 14 |
| ✅ GBM_LATE_60M#60min | 1819 | +0.068 | +736.60€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 662 | +0.089 | +260.71€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 662 | +0.089 | +260.71€ | 0 | 12 |
| ✅ GBM_LATE_60M#ETH | 602 | +0.071 | +295.88€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 602 | +0.071 | +295.88€ | 2 | 15 |
| ✅ GBM_LATE_60M#SOL | 555 | +0.039 | +180.02€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 555 | +0.039 | +180.02€ | 2 | 10 |
| 🚫 GBM_LATE_60M_FADE | 387 | -0.251 | -16.87€ | 8 | 0 |
| 🚫 GBM_LATE_60M_FADE#60min | 387 | -0.251 | -16.87€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#BTC | 148 | -0.220 | -6.61€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#BTC#60min | 148 | -0.220 | -6.61€ | 6 | 0 |
| 🚫 GBM_LATE_60M_FADE#ETH | 126 | -0.250 | -4.94€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#ETH#60min | 126 | -0.250 | -4.94€ | 3 | 1 |
| 🚫 GBM_LATE_60M_FADE#SOL | 113 | -0.283 | -5.32€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#SOL#60min | 113 | -0.283 | -5.32€ | 3 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO | 726 | +0.073 | +157.34€ | 2 | 6 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 726 | +0.073 | +157.34€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 2064 | +0.104 | +570.60€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 2064 | +0.104 | +570.60€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 2064 | +0.104 | +570.60€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 2064 | +0.104 | +570.60€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_5M | 2085 | +0.009 | +20.81€ | 6 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 2085 | +0.009 | +20.81€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_5M#ETH | 870 | +0.025 | +23.27€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 870 | +0.025 | +23.27€ | 6 | 0 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 1688 | -0.018 | +37.78€ | 1 | 1 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 806 | -0.020 | +6.02€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 882 | -0.016 | +31.75€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC | 411 | +0.037 | +55.94€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#15min | 193 | +0.023 | +14.72€ | 0 | 3 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#5min | 218 | +0.050 | +41.23€ | 0 | 1 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH | 313 | -0.056 | -22.78€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#15min | 140 | -0.056 | -9.62€ | 3 | 1 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#5min | 173 | -0.054 | -13.17€ | 5 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL | 293 | -0.005 | +14.66€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#15min | 148 | +0.007 | +10.24€ | 3 | 7 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#5min | 145 | -0.017 | +4.42€ | 2 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP | 400 | -0.040 | -9.01€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#15min | 189 | -0.034 | -3.35€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#5min | 211 | -0.045 | -5.66€ | 1 | 3 |
| ✅ MOMENTUM_IBS_15M | 14522 | -0.012 | -209.42€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14522 | -0.012 | -209.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 3239 | -0.020 | -62.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 3239 | -0.020 | -62.60€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 30249 | -0.006 | +1359.62€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 30249 | -0.006 | +1359.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 5339 | +0.018 | +650.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 5339 | +0.018 | +650.66€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4656 | -0.027 | -40.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4656 | -0.027 | -40.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 5398 | +0.014 | +472.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 5398 | +0.014 | +472.93€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4436 | -0.052 | -138.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4436 | -0.052 | -138.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 5075 | -0.010 | +198.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 5075 | -0.010 | +198.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 5345 | +0.008 | +217.07€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 5345 | +0.008 | +217.07€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5947 | -0.059 | -140.01€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5947 | -0.059 | -140.01€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 76534 | -0.073 | +1713.95€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 76534 | -0.073 | +1713.95€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 12964 | -0.078 | +754.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 12964 | -0.078 | +754.82€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 11774 | -0.094 | -558.17€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 11774 | -0.094 | -558.17€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 13205 | -0.067 | +717.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 13205 | -0.067 | +717.42€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 11302 | -0.093 | -204.29€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 11302 | -0.093 | -204.29€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 14001 | -0.048 | +396.26€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 14001 | -0.048 | +396.26€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 13288 | -0.063 | +607.90€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 13288 | -0.063 | +607.90€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7678 | -0.025 | -122.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7678 | -0.025 | -122.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 996 | -0.017 | -19.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 996 | -0.017 | -19.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1718 | -0.031 | -8.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1718 | -0.031 | -8.80€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 1003 | -0.020 | -31.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 1003 | -0.020 | -31.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 2169 | -0.019 | -21.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 2169 | -0.019 | -21.38€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 1048 | -0.043 | -17.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 1048 | -0.043 | -17.74€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 744 | -0.020 | -23.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 744 | -0.020 | -23.42€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1167 | +0.104 | +377.95€ | 0 | 2 |
| ✅ ORDER_FLOW_5M#5min | 1031 | +0.110 | +365.35€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#XRP | 204 | +0.092 | +53.83€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#XRP#5min | 204 | +0.092 | +53.83€ | 0 | 3 |
| ✅ ORDER_FLOW_5M_REACTIVO | 547 | -0.054 | -57.75€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#5min | 547 | -0.054 | -57.75€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO#XRP | 89 | -0.082 | -13.17€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#XRP#5min | 89 | -0.082 | -13.17€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 2815 | -0.022 | -116.00€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2815 | -0.022 | -116.00€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1276 | -0.022 | -50.93€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1276 | -0.022 | -50.93€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 8050 | +0.025 | +133.23€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 8050 | +0.025 | +133.23€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2174 | +0.023 | +26.24€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2174 | +0.023 | +26.24€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1829 | +0.035 | +55.04€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1829 | +0.035 | +55.04€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2464 | +0.016 | +14.59€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2464 | +0.016 | +14.59€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1583 | +0.028 | +37.37€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1583 | +0.028 | +37.37€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7538 | +0.013 | -32.22€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7538 | +0.013 | -32.22€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 3025 | +0.017 | -4.12€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 3025 | +0.017 | -4.12€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2949 | +0.013 | -14.20€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2949 | +0.013 | -14.20€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1564 | +0.006 | -13.90€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1564 | +0.006 | -13.90€ | 2 | 0 |
| ✅ UPDOWN_GBM | 39979 | +0.032 | +2457.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 10705 | +0.070 | +1978.57€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 1449 | +0.004 | +5.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 25255 | +0.022 | +456.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2422 | +0.002 | +17.53€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 4160 | +0.070 | +476.82€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 754 | +0.155 | +310.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 33 | -0.014 | -0.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 3373 | +0.052 | +167.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 7428 | +0.038 | +526.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1348 | +0.085 | +304.87€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 388 | +0.018 | +7.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 4545 | +0.036 | +190.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 1090 | +0.002 | +22.81€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 57 | -0.093 | +1.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 4729 | +0.042 | +304.58€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 706 | +0.140 | +250.55€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 28 | +0.000 | -1.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3995 | +0.025 | +55.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 8523 | +0.019 | +316.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2713 | +0.048 | +291.81€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 380 | +0.005 | +6.81€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 4566 | +0.009 | +22.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 816 | -0.002 | -8.49€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 48 | -0.140 | +3.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 9301 | +0.015 | +231.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2573 | +0.027 | +178.57€ | 0 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 372 | -0.005 | -2.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5799 | +0.013 | +55.89€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 516 | +0.008 | +3.21€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 41 | -0.174 | -3.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5836 | +0.036 | +603.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2611 | +0.084 | +642.52€ | 0 | 12 |
| ✅ UPDOWN_GBM#XRP#240min | 248 | -0.004 | -3.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2977 | -0.003 | -35.31€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 12533 | -0.037 | +2699.73€ | 2 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 12533 | -0.037 | +2699.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 852 | -0.046 | +359.70€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 852 | -0.046 | +359.70€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2282 | -0.121 | +21.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2282 | -0.121 | +21.14€ | 4 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 447 | +0.181 | +301.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 447 | +0.181 | +301.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1389 | +0.209 | +830.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1389 | +0.209 | +830.81€ | 1 | 22 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3765 | -0.064 | +576.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3765 | -0.064 | +576.11€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3798 | -0.074 | +610.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3798 | -0.074 | +610.12€ | 2 | 4 |
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=2571 IC=+0.027 PNL=+176.99€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.117 n=356/60 | contraria IC=+0.158 n=331 | gap=-0.040 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=815/40 IC=-0.003 PNL=-8.98€ | BTC#60min: n=1088/40 IC=+0.002 PNL=+22.87€ | SOL#60min: n=516/40 IC=+0.008 PNL=+3.21€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.050 n=349802 | tras_1loss IC=+0.080 n=271524 | tras_2loss IC=+0.050 n=114020/40 | gap=+0.000 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1696 IC=+0.007 PNL=+2.47€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1696 IC=+0.007 PNL=+2.47€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=723 IC=-0.012 PNL=+14.63€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=723 IC=-0.012 PNL=+14.63€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.186 > 0.1 con n=2274 PNL=+1418.15€
  - _Datos_: n=2274 IC=+0.186 PNL=+1418.15€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=14146 IC=+0.053 PNL=+1681.15€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=14146 IC=+0.053 PNL=+1681.15€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=2012 IC=+0.053 PNL=+219.02€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2012 IC=+0.053 PNL=+219.02€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=18818 IC=-0.139 PNL=+1158.10€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=18818 IC=-0.139 PNL=+1158.10€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.239 < -0.1 con n=1837 PNL=-217.71€
  - _Datos_: n=1837 IC=-0.239 PNL=-217.71€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=9124 IC=+0.176 PNL=-1051.59€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=9124 IC=+0.176 PNL=-1051.59€
