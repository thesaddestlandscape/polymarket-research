# Hipótesis automáticas — 2026-07-27 02:23 UTC
_Generado por shadow_postmortem.py sobre 37584 resoluciones (PNL=+7780.84€)_
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.625` → IC=+0.140 (n=145)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 6.625 (IC base=+0.067)
...
- **PATRÓN** `dist_vwap_pct` > `0.9417` → IC=+0.131 (n=139)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.9417 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.263` → IC=+0.140 (n=295)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 8.263 (IC base=+0.121)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7574` → IC=+0.222 (n=454)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7574 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.1672` → IC=+0.170 (n=219)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1672 (IC base=+0.054)
...
- **PATRÓN** `ibs_15` > `0.676` → IC=+0.194 (n=197)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.97€ cuando `ibs_15` > 0.676 (IC base=+0.042)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.7574 sube el IC de +0.054 a +0.222 en UPDOWN_GBM#15min (n=454). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.676 sube el IC de +0.042 a +0.194 en UPDOWN_GBM#ETH#15min (n=197). Ya aplicado como kelly_boost=+0.97€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ GBM_LATE_15M | 8149 | +0.094 | +2457.03€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8149 | +0.094 | +2457.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1972 | +0.072 | +346.15€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1972 | +0.072 | +346.15€ | 0 | 5 |
| ✅ GBM_LATE_15M#ETH | 1798 | +0.074 | +305.57€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1798 | +0.074 | +305.57€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5380 | +0.117 | +2525.37€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5380 | +0.117 | +2525.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1409 | +0.084 | +490.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1409 | +0.084 | +490.77€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1409 | +0.089 | +489.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1409 | +0.089 | +489.59€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_TARDIO | 5367 | +0.068 | +1441.92€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5367 | +0.068 | +1441.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1281 | +0.037 | +168.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1281 | +0.037 | +168.38€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1310 | +0.025 | +103.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1310 | +0.025 | +103.68€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 2744 | +0.034 | +241.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2481 | +0.051 | +280.29€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 1068 | +0.039 | +72.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 974 | +0.053 | +84.48€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1974 | +0.156 | +903.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1974 | +0.156 | +903.23€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 382 | +0.164 | +148.54€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 382 | +0.164 | +148.54€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.171: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.076 n=1500 | neutral: IC=+0.018 n=1213 | overbought(IBS>0.7): IC=+0.188 n=1531
  - _Datos_: n=4524 IC=+0.104 PNL=+1204.90€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=22383 | tras_1loss IC=+0.079 n=14992 | tras_2loss IC=+0.051 n=6286/40 | gap=+0.061 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2607 IC=+0.038 PNL=+255.57€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2607 IC=+0.038 PNL=+255.57€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1083 IC=+0.054 PNL=+138.45€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1083 IC=+0.054 PNL=+138.45€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.086 > 0.08 con n=1328 PNL=+219.36€
  - _Datos_: n=1328 IC=+0.086 PNL=+219.36€
...
**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: n=356 IC=+0.064 PNL=+41.53€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=356 IC=+0.064 PNL=+41.53€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=1323 IC=+0.053 PNL=+141.07€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1323 IC=+0.053 PNL=+141.07€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1233 IC=+0.029 PNL=+107.90€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1233 IC=+0.029 PNL=+107.90€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.161 > 0.1 con n=948 PNL=+321.04€
  - _Datos_: n=948 IC=+0.161 PNL=+321.04€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.123 > 0.08 con n=679 PNL=+184.70€
  - _Datos_: n=679 IC=+0.123 PNL=+184.70€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.106 > 0.08 con n=531 PNL=+139.73€
  - _Datos_: n=531 IC=+0.106 PNL=+139.73€
