# Hipótesis automáticas — 2026-09-23 22:06 UTC
_Generado por shadow_postmortem.py sobre 579552 resoluciones (PNL=+64675.75€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.02` → IC=-0.234 (n=6936)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.02
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=20823)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `139.07` → IC=-0.241 (n=908)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 139.07
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2724)
...
- **FILTRO** `restante_s_al_confirmar` < `128.9` → IC=-0.301 (n=859)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 128.9
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2578)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `164.54` → IC=-0.227 (n=1652)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.54
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4958)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.232 (n=10663)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5565)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7753.9545` → IC=+0.173 (n=2096)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7753.9545 (IC base=+0.127)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.209 (n=1609)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.352 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2078)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15906.4754` → IC=+0.240 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15906.4754 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.375` → IC=+0.263 (n=1502)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=2108)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `14078.6167` → IC=+0.212 (n=741)
...
- **PATRÓN** `py_entrada` < `0.44` → IC=+0.146 (n=808)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=2760)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=1067)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=11226)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.225 (n=3741)
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.183 (n=1897)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.257 (n=385)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.185 (n=2542)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.200 (n=2600)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.198 (n=1917)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=6208)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.71 (IC base=+0.175)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.225 (n=5980)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.275 (n=2127)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=6080)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=3008)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4081.2097` → IC=+0.315 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4081.2097 (IC base=+0.292)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.305 (n=336)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4246.1312` → IC=+0.302 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4246.1312 (IC base=+0.280)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.335 (n=367)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1462.5909` → IC=+0.311 (n=464)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.448 (n=498)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.935` → IC=+0.444 (n=494)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.442 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.440)

- **PATRÓN** `libro_liquidez` > `2547.1781` → IC=+0.440 (n=314)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.450 (n=158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.442)

- **PATRÓN** `py_entrada` < `0.93` → IC=+0.454 (n=194)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.443 (n=261)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4813` → IC=+0.121 (n=7836)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.4813 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.982` → IC=+0.244 (n=2613)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.982 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.8477` → IC=+0.251 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8477 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.6368` → IC=+0.251 (n=2191)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6368 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.95` → IC=+0.176 (n=3011)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.95 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.248 (n=2104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0481` → IC=+0.259 (n=954)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0481 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.3055` → IC=+0.219 (n=780)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3055 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.9075` → IC=+0.206 (n=3564)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9075 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.132 (n=9463)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.57 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.6152` → IC=+0.193 (n=698)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.6152 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.172 (n=2977)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` < `0.6983` → IC=+0.180 (n=1451)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6983 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.0526` → IC=+0.173 (n=1494)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0526 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.221 (n=1576)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `1.5716` → IC=+0.200 (n=4937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5716 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.210 (n=5312)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 136.0 (IC base=+0.064)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.183 (n=591)
...
- **PATRÓN** `drift_60min` |x|≤ `0.348` → IC=+0.166 (n=1772)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.348 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.166 (n=860)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.269 (n=686)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.117` → IC=+0.271 (n=761)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.163 (n=1656)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.249 (n=1189)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.233)

- **PATRÓN** `drift_60min` |x|≤ `0.09` → IC=+0.285 (n=444)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.09 (IC base=+0.233)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.246 (n=914)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.233)

- **PATRÓN** `ibs_20min` < `0.0571` → IC=+0.290 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0571 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.412` → IC=+0.234 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.412 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.422` → IC=+0.247 (n=1381)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.422 (IC base=+0.233)

- **PATRÓN** `volumen_pendiente_norm` < `0.092` → IC=+0.229 (n=1136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.092 (IC base=+0.233)

- **PATRÓN** `volumen_pendiente_norm` > `0.2774` → IC=+0.261 (n=178)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6417` → IC=+0.241 (n=403)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6417 (IC base=+0.233)

- **PATRÓN** `libro_liquidez` > `1799.51` → IC=+0.234 (n=886)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1799.51 (IC base=+0.233)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.231 (n=901)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.232 (n=1347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` > `0.9902` → IC=+0.267 (n=449)
...
- **PATRÓN** `dist_vwap_pct` < `0.5883` → IC=+0.221 (n=1408)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5883 (IC base=+0.217)
...
- **PATRÓN** `volumen_regimen` < `1.2525` → IC=+0.221 (n=1348)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2525 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `0.8736` → IC=+0.226 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8736 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` > `0.2801` → IC=+0.236 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2801 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `1.7478` → IC=+0.220 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7478 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.3728` → IC=+0.224 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3728 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `12373.9855` → IC=+0.220 (n=1204)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12373.9855 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.151 (n=1405)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.252` → IC=+0.140 (n=1279)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 4.252 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.150 (n=1405)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4143` → IC=+0.151 (n=1295)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4143 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4221` → IC=+0.144 (n=1295)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4221 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.147 (n=1212)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.189 (n=1733)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.263 (n=687)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2115` → IC=+0.188 (n=1728)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8516` → IC=+0.207 (n=746)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8516 (IC base=+0.187)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=1235)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.187)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.223 (n=1487)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0115 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.5884` → IC=+0.216 (n=1487)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5884 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.250 (n=566)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0636` → IC=+0.245 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0636 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.615` → IC=+0.247 (n=507)
...
- **FILTRO** `ibs_20min` > `0.2571` → IC=-0.125 (n=2135)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2571
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1057)

- **FILTRO** `sigma_ewma_delta_pct` > `8.651` → IC=-0.204 (n=343)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.651
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2849)
...
- **PATRÓN** `ibs_20min` < `0.2571` → IC=+0.124 (n=1057)
...
- **FILTRO** `drift_60min` |x|> `0.6599` → IC=-0.179 (n=549)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6599
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1651)

- **FILTRO** `ibs_20min` < `0.71` → IC=-0.157 (n=1452)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1684` → IC=+0.251 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1684 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.4374` → IC=+0.247 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4374 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.243 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.198 (n=3274)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4737` → IC=+0.188 (n=8765)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4737 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7728` → IC=+0.289 (n=1038)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7728 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.586` → IC=+0.156 (n=4637)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.586 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6881` → IC=+0.248 (n=3105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6881 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.297` → IC=+0.265 (n=825)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.297 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4711` → IC=+0.242 (n=1880)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4711 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6813` → IC=+0.237 (n=1880)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6813 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.268 (n=5158)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.152 (n=3276)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0091 (IC base=+0.072)

- **PATRÓN** `ibs_20min` < `0.5472` → IC=+0.151 (n=8636)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5472 (IC base=+0.072)

- **PATRÓN** `dist_vwap_pct` < `0.2488` → IC=+0.237 (n=2721)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2488 (IC base=+0.072)

- **PATRÓN** `volumen_regimen` < `0.7088` → IC=+0.237 (n=1268)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7088 (IC base=+0.072)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.244 (n=960)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2035 (IC base=+0.072)

- **PATRÓN** `volumen_pendiente_norm` > `0.2452` → IC=+0.300 (n=722)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2452 (IC base=+0.072)

- **PATRÓN** `volumen_spike_ratio` < `1.6084` → IC=+0.254 (n=1665)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6084 (IC base=+0.072)

- **PATRÓN** `volumen_spike_ratio` > `2.3262` → IC=+0.255 (n=1715)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3262 (IC base=+0.072)

- **PATRÓN** `ballena_activa_n` < `83.0` → IC=+0.261 (n=3659)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 83.0 (IC base=+0.072)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.503` → IC=-0.164 (n=513)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.503
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1730)

- **PATRÓN** `ibs_20min` > `0.8889` → IC=+0.262 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8889 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.772` → IC=+0.205 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.772 (IC base=+0.045)

- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.275 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.045)

- **PATRÓN** `volumen_spike_ratio` < `1.4401` → IC=+0.180 (n=282)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.4401 (IC base=+0.045)

- **PATRÓN** `volumen_spike_ratio` > `2.1594` → IC=+0.191 (n=383)
...
- **PATRÓN** `ibs_20min` > `0.862` → IC=+0.158 (n=655)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.862 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.1282` → IC=+0.173 (n=502)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1282 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6717` → IC=+0.165 (n=802)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4226` → IC=+0.202 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4226 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `247.0` → IC=+0.195 (n=382)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 247.0 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` < `0.1623` → IC=+0.217 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1623 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` > `0.6093` → IC=+0.212 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6093 (IC base=+0.003)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4443` → IC=+0.231 (n=165)
...
- **PATRÓN** `ballena_activa_n` < `477.0` → IC=+0.213 (n=493)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=1557)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=825)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1373` → IC=+0.258 (n=1378)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1373 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `3.4416` → IC=+0.261 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4416 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=1092)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1948.9053` → IC=+0.255 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1948.9053 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.315 (n=561)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.281)

- **PATRÓN** `drift_60min` |x|≤ `0.6004` → IC=+0.283 (n=1237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6004 (IC base=+0.281)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.327 (n=421)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.281)

- **PATRÓN** `ibs_20min` < `0.2248` → IC=+0.287 (n=1089)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2248 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.819` → IC=+0.300 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.819 (IC base=+0.281)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6001` → IC=+0.286 (n=381)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6001 (IC base=+0.281)

- **PATRÓN** `volumen_spike_ratio` > `2.7705` → IC=+0.284 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7705 (IC base=+0.281)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.289 (n=832)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `1933.0584` → IC=+0.302 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1933.0584 (IC base=+0.281)
...
- **FILTRO** `ibs_20min` < `0.2831` → IC=-0.187 (n=477)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2831
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1433)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.181 (n=581)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1747)

- **PATRÓN** `ibs_20min` > `0.9105` → IC=+0.177 (n=478)
...
- **PATRÓN** `volumen_regimen` < `0.9898` → IC=+0.233 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9898 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.5808` → IC=+0.210 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5808 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.0791` → IC=+0.249 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0791 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` < `2.0971` → IC=+0.244 (n=447)
...
- **PATRÓN** `dist_vwap_pct` < `0.6847` → IC=+0.194 (n=468)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.6847 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` < `1.1643` → IC=+0.205 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1643 (IC base=-0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.1645` → IC=+0.268 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1645 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` < `1.8285` → IC=+0.255 (n=243)
...
- **FILTRO** `ibs_20min` < `0.7188` → IC=-0.200 (n=1038)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7188
  - _Potencial_: sin este filtro IC_bueno=+0.281 (n=1039)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.677` → IC=-0.176 (n=476)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.677
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=1707)

- **PATRÓN** `ibs_20min` > `0.7188` → IC=+0.281 (n=1039)
...
- **PATRÓN** `volumen_regimen` > `0.6434` → IC=+0.291 (n=763)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6434 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` < `0.1024` → IC=+0.295 (n=710)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.313 (n=639)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.321 (n=851)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.7411` → IC=+0.324 (n=1140)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7411 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.2054` → IC=+0.319 (n=759)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2054 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.523` → IC=+0.305 (n=674)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.523 (IC base=+0.279)

- **PATRÓN** `volumen_regimen` > `0.8627` → IC=+0.304 (n=851)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8627 (IC base=+0.279)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.320 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.279)

- **PATRÓN** `volumen_spike_ratio` > `2.5142` → IC=+0.295 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5142 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.285 (n=1362)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `2622.2574` → IC=+0.297 (n=851)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2622.2574 (IC base=+0.279)

- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.295 (n=924)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0152 (IC base=+0.271)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.279 (n=483)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3953` → IC=+0.304 (n=1387)
...
- **PATRÓN** `dist_vwap_pct` < `0.9685` → IC=+0.272 (n=1562)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1612` → IC=+0.275 (n=553)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.172 (n=2554)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.202 (n=2553)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0899` → IC=+0.186 (n=2555)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0899 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=7986)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5789` → IC=+0.217 (n=7654)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5789 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1771` → IC=+0.197 (n=3353)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1771 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.311` → IC=+0.258 (n=1571)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.311 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.160 (n=5065)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2145 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.628` → IC=+0.160 (n=5064)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.628 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2965` → IC=+0.195 (n=1143)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2965 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5622` → IC=+0.171 (n=3227)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5622 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6268` → IC=+0.175 (n=2445)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6268 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2400.6554` → IC=+0.169 (n=5102)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2400.6554 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.180 (n=6562)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 116.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=4890)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0806` → IC=+0.208 (n=2447)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0806 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.203 (n=2839)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.226 (n=7335)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4783 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.232` → IC=+0.158 (n=5328)
...
- **PATRÓN** `volumen_regimen` < `1.1737` → IC=+0.152 (n=5323)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5642` → IC=+0.168 (n=2929)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5642 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.2598` → IC=+0.169 (n=3017)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2598 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.173 (n=6298)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3418` → IC=+0.206 (n=1307)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2294` → IC=+0.234 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2294 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.179 (n=1207)
...
- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.165 (n=1140)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2653 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `0.879` → IC=+0.165 (n=760)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.879 (IC base=+0.161)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4114` → IC=+0.193 (n=369)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.4114 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `15877.6197` → IC=+0.163 (n=517)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 15877.6197 (IC base=+0.161)
...
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.221 (n=428)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.219 (n=446)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.291 (n=683)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6421` → IC=+0.199 (n=406)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6421 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.8669` → IC=+0.208 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8669 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=907)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `1952.9484` → IC=+0.198 (n=428)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 1952.9484 (IC base=+0.197)

- **PATRÓN** `sigma_h` < `0.0113` → IC=+0.232 (n=1064)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0113 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.0968` → IC=+0.254 (n=356)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0968 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.277 (n=374)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.220)

- **PATRÓN** `ibs_20min` < `0.2407` → IC=+0.256 (n=936)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2407 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.735` → IC=+0.271 (n=452)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7913` → IC=+0.217 (n=433)
...
- **PATRÓN** `libro_liquidez` > `1880.9161` → IC=+0.226 (n=483)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.158 (n=1223)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3782` → IC=+0.196 (n=1223)
...
- **PATRÓN** `volumen_regimen` < `1.0413` → IC=+0.144 (n=1076)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0413 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6274` → IC=+0.148 (n=1223)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6274 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.292` → IC=+0.198 (n=190)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.292 (IC base=+0.143)
...
- **PATRÓN** `libro_liquidez` > `6793.8152` → IC=+0.184 (n=815)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6793.8152 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.145 (n=1160)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.164 (n=640)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1993` → IC=+0.138 (n=1295)
...
- **PATRÓN** `volumen_regimen` < `1.174` → IC=+0.122 (n=1408)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4572` → IC=+0.128 (n=420)
...
- **PATRÓN** `libro_liquidez` > `3086.6372` → IC=+0.160 (n=469)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 3086.6372 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.215 (n=881)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1375)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7386` → IC=+0.262 (n=1181)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1563` → IC=+0.216 (n=1123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1563 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.412` → IC=+0.207 (n=1276)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.412 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1403)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2613.0554` → IC=+0.207 (n=881)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2613.0554 (IC base=+0.202)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.220 (n=677)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.245 (n=1379)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.44 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `1.2245` → IC=+0.223 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2245 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.392` → IC=+0.242 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.392 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.215 (n=1373)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2198` → IC=+0.193 (n=1084)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2198 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4406` → IC=+0.198 (n=1231)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4406 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2586.8546` → IC=+0.206 (n=915)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2586.8546 (IC base=+0.203)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.165 (n=601)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0038 (IC base=+0.147)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0997` → IC=+0.154 (n=602)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0997 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.186 (n=916)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.5505` → IC=+0.188 (n=1611)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.728` → IC=+0.176 (n=829)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.728 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.8739` → IC=+0.165 (n=1052)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8739 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `1.2084` → IC=+0.156 (n=527)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.2084 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.165` → IC=+0.175 (n=500)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.165 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.4385` → IC=+0.166 (n=579)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4385 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `2.5472` → IC=+0.159 (n=579)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5472 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.151 (n=2042)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.02 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `12348.3168` → IC=+0.157 (n=601)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12348.3168 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.168 (n=1580)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 163.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.134 (n=1267)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0057 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=1814)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5224` → IC=+0.142 (n=1670)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.5224 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` < `2.2268` → IC=+0.122 (n=1606)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.2268 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `3863.6748` → IC=+0.123 (n=1265)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.206 (n=202)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.149 (n=605)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.142 (n=624)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 5.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.3445` → IC=+0.197 (n=404)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.3445 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.3076` → IC=+0.150 (n=641)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.3076 (IC base=+0.131)
...
- **PATRÓN** `volumen_spike_ratio` < `2.42` → IC=+0.148 (n=595)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.42 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.415` → IC=+0.141 (n=595)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.415 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `331.0` → IC=+0.146 (n=504)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 331.0 (IC base=+0.131)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.217 (n=185)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.232 (n=255)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` > `0.7033` → IC=+0.242 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7033 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` > `0.9497` → IC=+0.223 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9497 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.93` → IC=+0.224 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.93 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` < `0.8363` → IC=+0.199 (n=370)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2601` → IC=+0.298 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2601 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` < `1.3924` → IC=+0.235 (n=183)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=617)
...
- **PATRÓN** `ibs_20min` < `0.0837` → IC=+0.146 (n=176)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.0837 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` < `0.6823` → IC=+0.121 (n=230)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 0.6823 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` > `0.2242` → IC=+0.131 (n=82)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` > 0.2242 (IC base=+0.086)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.194 (n=181)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0089 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.166 (n=369)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.204 (n=353)
...
- **PATRÓN** `volumen_regimen` < `1.0699` → IC=+0.147 (n=346)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0699 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `0.7359` → IC=+0.155 (n=352)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7359 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.2893` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2893 (IC base=+0.131)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2252` → IC=+0.169 (n=170)
  ...
  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.2252 (IC base=+0.131)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.834` → IC=+0.235 (n=3610)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.834 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8814` → IC=+0.165 (n=4359)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8814 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2399` → IC=+0.200 (n=1830)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2399 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6039` → IC=+0.188 (n=3131)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6039 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2342.629` → IC=+0.172 (n=6519)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.629 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.195 (n=7401)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 87.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.190 (n=5927)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.007 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1472` → IC=+0.188 (n=3913)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.1472 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=3382)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.236 (n=8892)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2483` → IC=+0.161 (n=5511)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2483 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.007` → IC=+0.203 (n=1249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.007 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.72` → IC=+0.181 (n=8607)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 3.72 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7039` → IC=+0.160 (n=2693)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6325` → IC=+0.191 (n=2713)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.6325 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.191 (n=5201)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 48.0 (IC base=+0.180)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.211 (n=555)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.199 (n=801)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.322 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.034` → IC=+0.314 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.034 (IC base=+0.190)
...
- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.289 (n=1140)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.466` → IC=+0.262 (n=1353)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8682` → IC=+0.272 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8682 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `1798.6031` → IC=+0.262 (n=863)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1798.6031 (IC base=+0.257)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.195 (n=526)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0028 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.0842` → IC=+0.162 (n=522)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0842 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1637)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3134` → IC=+0.203 (n=1565)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3134 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.3452` → IC=+0.196 (n=637)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.3452 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.755` → IC=+0.174 (n=357)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 9.755 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.233` → IC=+0.154 (n=1407)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.233 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.629` → IC=+0.179 (n=522)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.629 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2676` → IC=+0.203 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2676 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.1137` → IC=+0.163 (n=1329)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1137 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.7583` → IC=+0.156 (n=1007)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7583 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `15670.3793` → IC=+0.153 (n=710)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 15670.3793 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `477.0` → IC=+0.160 (n=1441)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3225` → IC=+0.161 (n=1357)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.3225 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.177 (n=456)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1371` → IC=+0.165 (n=1223)
...
- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.162 (n=1357)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1888 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1513` → IC=+0.198 (n=366)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1513 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.3978` → IC=+0.160 (n=1258)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.3978 (IC base=+0.150)
...
- **PATRÓN** `ballena_activa_n` < `425.0` → IC=+0.158 (n=1023)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 425.0 (IC base=+0.150)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.246 (n=529)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=1661)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.6697` → IC=+0.256 (n=1414)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2125` → IC=+0.221 (n=1559)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2125 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.844` → IC=+0.243 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.844 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.229 (n=1126)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1957.2184` → IC=+0.223 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1957.2184 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.232 (n=1309)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 53.0 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.240 (n=1476)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0115 (IC base=+0.233)

- **PATRÓN** `drift_60min` |x|≤ `0.1659` → IC=+0.239 (n=649)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1659 (IC base=+0.233)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.262 (n=561)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1944` → IC=+0.282 (n=986)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1944 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.751` → IC=+0.280 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.751 (IC base=+0.233)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7536` → IC=+0.233 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7536 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` > `2.1905` → IC=+0.236 (n=900)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1905 (IC base=+0.233)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.243 (n=999)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.233)

- **PATRÓN** `libro_liquidez` > `1878.6984` → IC=+0.250 (n=669)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1878.6984 (IC base=+0.233)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.231 (n=1268)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.233)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.185 (n=556)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0035 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4373` → IC=+0.143 (n=1667)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4373 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1746)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.8769` → IC=+0.260 (n=756)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4461` → IC=+0.153 (n=1363)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4461 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=511)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.7012` → IC=+0.181 (n=1363)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.7012 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.6022` → IC=+0.141 (n=1507)
...
- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.145 (n=909)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8615 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1921` → IC=+0.139 (n=455)
...
- **PATRÓN** `volumen_spike_ratio` > `1.444` → IC=+0.150 (n=1291)
...
- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.144 (n=1286)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1699)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.190 (n=1654)
...
- **PATRÓN** `volumen_regimen` < `0.8911` → IC=+0.133 (n=1101)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8911 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1665)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.130 (n=1265)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 54.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.174 (n=541)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_spike_ratio` < `1.4488` → IC=+0.136 (n=487)
...
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.221 (n=1103)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1731)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.251 (n=1655)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5146 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.2019` → IC=+0.235 (n=978)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2019 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.245` → IC=+0.272 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.245 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.0709` → IC=+0.211 (n=1456)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0709 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.6363` → IC=+0.218 (n=1655)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6363 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.2346` → IC=+0.250 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2346 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.5104` → IC=+0.236 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5104 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.220 (n=1735)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `2618.726` → IC=+0.224 (n=1103)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.207 (n=1260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` < `0.5188` → IC=+0.255 (n=1779)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5188 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` > `1.2377` → IC=+0.200 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2377 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` < `0.918` → IC=+0.203 (n=1979)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.918 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.813` → IC=+0.261 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.813 (IC base=+0.199)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2045` → IC=+0.195 (n=1404)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2045 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4324` → IC=+0.195 (n=1595)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4324 (IC base=+0.199)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.196 (n=393)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.004 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.128 (n=829)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 8.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.6781` → IC=+0.205 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6781 (IC base=+0.097)
...
- **PATRÓN** `volumen_regimen` > `0.9793` → IC=+0.136 (n=361)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0809` → IC=+0.139 (n=602)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.0809 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=641)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2424.4386` → IC=+0.148 (n=350)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.166 (n=303)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.006 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.125 (n=318)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.5273` → IC=+0.190 (n=272)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.5273 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.1366` → IC=+0.183 (n=143)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1366 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.573` → IC=+0.134 (n=162)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.573 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `1.0632` → IC=+0.127 (n=239)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0632 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.141 (n=207)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.0677 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2771` → IC=+0.149 (n=35)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.2771 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.176 (n=205)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=281)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `4085.8043` → IC=+0.139 (n=117)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 4085.8043 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.181 (n=133)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0039 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.141 (n=271)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 8.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.6839` → IC=+0.231 (n=243)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.815` → IC=+0.300 (n=83)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.815 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `0.9516` → IC=+0.143 (n=124)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.9516 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7335` → IC=+0.167 (n=148)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.7335 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.128 (n=181)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.131 (n=201)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.185 (n=106)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=260)

- **FILTRO** `restante_min` < `3.32` → IC=-0.156 (n=91)

  - _Acción_: SKIP cuando `restante_min` < 3.32
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=275)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.189 (n=101)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.47 (IC base=+0.026)

- **PATRÓN** `profundidad_ratio` > `103.8` → IC=+0.173 (n=102)

  - _Acción_: Kelly boost +0.87€ cuando `profundidad_ratio` > 103.8 (IC base=+0.026)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7435)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.172 (n=3246)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=10498)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.169 (n=3553)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=10682)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.212 (n=591)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1789)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.199 (n=589)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1836)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=622)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1924)

- **FILTRO** `ibs_20min` > `0.2814` → IC=-0.161 (n=636)
...
- **FILTRO** `py_entrada` < `0.485` → IC=-0.169 (n=587)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1777)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.181 (n=622)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1924)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2906)
...
- **FILTRO** `ibs_20min` > `0.1705` → IC=-0.148 (n=123)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=370)

- **FILTRO** `libro_liquidez` < `17176.9722` → IC=-0.128 (n=162)

  - _Acción_: SKIP cuando `libro_liquidez` < 17176.9722
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=331)

- **FILTRO** `libro_liquidez` < `16943.7323` → IC=-0.138 (n=222)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9688)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=21886)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7703)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=23871)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.235 (n=7876)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=23698)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.158 (n=10451)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21123)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9721)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=29783)

- **FILTRO** `ibs_7min` > `0.2937` → IC=-0.179 (n=9875)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2937
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=29629)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.306 (n=1244)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3970)

- **FILTRO** `ibs_7min` < `0.7099` → IC=-0.249 (n=1720)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7099
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3494)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.185 (n=1203)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=4011)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1680)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=5109)

- **FILTRO** `drift_7min_pct` |x|> `0.1118` → IC=-0.124 (n=2308)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1118
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4481)

- **FILTRO** `ibs_7min` > `0.7911` → IC=-0.205 (n=1697)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7911
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=5092)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1265)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4192)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1309)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4148)

- **FILTRO** `ibs_7min` < `0.7484` → IC=-0.193 (n=1364)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7484
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4093)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.171 (n=1357)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4100)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.255 (n=1374)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4151)

- **FILTRO** `ibs_7min` > `0.2605` → IC=-0.177 (n=1381)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2605
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4144)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.184 (n=1377)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4148)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.167 (n=1211)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3728)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.307 (n=1210)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3729)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.258 (n=1229)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3710)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1158)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3781)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1664)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5592)

- **FILTRO** `ibs_7min` > `0.75` → IC=-0.176 (n=1809)

  - _Acción_: SKIP cuando `ibs_7min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=5447)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.232 (n=1537)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3673)

- **FILTRO** `ibs_7min` < `0.742` → IC=-0.181 (n=1302)

  - _Acción_: SKIP cuando `ibs_7min` < 0.742
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3908)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.169 (n=1289)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3921)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.266 (n=1175)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4124)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.176 (n=1324)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3975)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.186 (n=1321)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3978)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=1334)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4181)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1371)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4144)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1799)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5715)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.253 (n=1687)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=3552)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1296)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3943)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.213 (n=1274)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3965)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1711)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=5410)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=2856)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.220 (n=699)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0085 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.0748` → IC=+0.202 (n=678)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0748 (IC base=+0.185)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2129` → IC=+0.191 (n=513)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.2129 (IC base=+0.185)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.194 (n=1444)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 6.0 (IC base=+0.185)

- **PATRÓN** `ibs_15` > `0.6071` → IC=+0.263 (n=1540)
...
- **PATRÓN** `dist_vwap_pct` > `0.1185` → IC=+0.187 (n=812)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1185 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.6126` → IC=+0.177 (n=1486)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.6126 (IC base=+0.185)
...
- **PATRÓN** `libro_liquidez` > `2980.0928` → IC=+0.193 (n=1027)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.211 (n=355)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.0587` → IC=+0.293 (n=119)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0587 (IC base=+0.201)

- **PATRÓN** `drift_15min` |x|≤ `0.3838` → IC=+0.211 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3838 (IC base=+0.201)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2526` → IC=+0.242 (n=118)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2526 (IC base=+0.201)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1443` → IC=+0.268 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1443 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.222 (n=375)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.201)

- **PATRÓN** `ibs_15` > `0.7061` → IC=+0.268 (n=355)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7061 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.4073` → IC=+0.248 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4073 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.55` → IC=+0.268 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.55 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `16018.1469` → IC=+0.235 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16018.1469 (IC base=+0.201)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.146 (n=159)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0041 (IC base=+0.137)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.161 (n=240)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0051 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.069` → IC=+0.148 (n=160)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.069 (IC base=+0.137)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2337` → IC=+0.172 (n=120)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.86€ cuando `delta_ratio_macro` |x|> 0.2337 (IC base=+0.137)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2558` → IC=+0.158 (n=255)

  - _Acción_: Kelly boost +0.79€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2558 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=361)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6642` → IC=+0.244 (n=322)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6642 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.5943` → IC=+0.146 (n=77)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.5943 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1661` → IC=+0.153 (n=283)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1661 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.386` → IC=+0.196 (n=156)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 8.386 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.163 (n=164)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.137)
...
- **FILTRO** `dist_vwap_pct` > `0.5742` → IC=-0.140 (n=123)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=857)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0862` → IC=+0.209 (n=180)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0862 (IC base=+0.187)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0597` → IC=+0.193 (n=366)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.5488` → IC=+0.283 (n=409)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.7658` → IC=+0.187 (n=471)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.7658 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.92` → IC=+0.223 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.92 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.785` → IC=+0.190 (n=407)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` < 10.785 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `2910.1242` → IC=+0.277 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2910.1242 (IC base=+0.187)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.154 (n=463)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.77€ cuando `ibs_15` < 0.1176 (IC base=+0.045)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.219 (n=645)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1937)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.189 (n=870)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1712)

- **FILTRO** `libro_liquidez` < `3914.9244` → IC=-0.137 (n=1704)

  - _Acción_: SKIP cuando `libro_liquidez` < 3914.9244
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=878)
...
- **PATRÓN** `ibs_15` > `0.6349` → IC=+0.270 (n=620)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6349 (IC base=-0.062)

- **PATRÓN** `dist_vwap_pct` < `0.2815` → IC=+0.180 (n=489)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2815 (IC base=-0.062)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1192` → IC=+0.243 (n=1117)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1192 (IC base=-0.036)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1772` → IC=+0.236 (n=1080)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1772 (IC base=-0.036)

- **PATRÓN** `ibs_15` < `0.35` → IC=+0.276 (n=1677)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.35 (IC base=-0.036)

- **PATRÓN** `dist_vwap_pct` > `0.6912` → IC=+0.290 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6912 (IC base=-0.036)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.216 (n=392)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=1177)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.230 (n=391)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1178)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=996)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.563` → IC=-0.247 (n=279)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1290)
...
- **PATRÓN** `ibs_15` > `0.7413` → IC=+0.318 (n=168)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.5746` → IC=+0.271 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5746 (IC base=+0.077)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.262 (n=221)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.223)

- **PATRÓN** `drift_60min` |x|≤ `0.4388` → IC=+0.223 (n=663)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4388 (IC base=+0.223)

- **PATRÓN** `drift_15min` |x|≤ `0.7869` → IC=+0.230 (n=583)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7869 (IC base=+0.223)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.228 (n=259)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.223)
...
- **PATRÓN** `ibs_15` < `0.2696` → IC=+0.276 (n=583)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2696 (IC base=+0.223)

- **PATRÓN** `dist_vwap_pct` > `0.778` → IC=+0.302 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.778 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.806` → IC=+0.241 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.806 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.189` → IC=+0.228 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.189 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `3551.8492` → IC=+0.223 (n=663)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3551.8492 (IC base=+0.223)
...
- **PATRÓN** `dist_vwap_pct` > `0.4961` → IC=+0.211 (n=88)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4961 (IC base=-0.043)
...
- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.307 (n=450)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3457 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` > `0.9146` → IC=+0.343 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9146 (IC base=-0.046)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.294 (n=431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0045 (IC base=+0.290)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.290 (n=293)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2389` → IC=+0.302 (n=215)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.319 (n=590)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.290)

- **PATRÓN** `ibs_15` > `0.838` → IC=+0.326 (n=647)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.294 (n=793)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.290)

- **PATRÓN** `libro_liquidez` > `13081.1746` → IC=+0.303 (n=293)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0574` → IC=+0.344 (n=120)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0574 (IC base=+0.283)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2571` → IC=+0.303 (n=120)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2571 (IC base=+0.283)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3729` → IC=+0.304 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3729 (IC base=+0.283)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.303 (n=378)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.283)

- **PATRÓN** `ibs_15` > `0.83` → IC=+0.312 (n=359)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.83 (IC base=+0.283)

- **PATRÓN** `dist_vwap_pct` > `0.4454` → IC=+0.353 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4454 (IC base=+0.283)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.589` → IC=+0.355 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.589 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `16049.8465` → IC=+0.328 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16049.8465 (IC base=+0.283)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6071 sube el IC de +0.185 a +0.263 en UPDOWN_GBM#15min (n=1540). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7061 sube el IC de +0.201 a +0.268 en UPDOWN_GBM#BTC#15min (n=355). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6642 sube el IC de +0.137 a +0.244 en UPDOWN_GBM#ETH#15min (n=322). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5488 sube el IC de +0.187 a +0.283 en UPDOWN_GBM#XRP#15min (n=409). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.045 a +0.154 en UPDOWN_GBM#XRP#15min (n=463). Ya aplicado como kelly_boost=+0.77€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6349 sube el IC de -0.062 a +0.270 en UPDOWN_GBM_15M_TARDIO (n=620). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.036 a +0.276 en UPDOWN_GBM_15M_TARDIO (n=1677). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7413 sube el IC de +0.077 a +0.318 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=168). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2696 sube el IC de +0.223 a +0.276 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=583). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3529 sube el IC de -0.043 a +0.263 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=302). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.046 a +0.307 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=450). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.838 sube el IC de +0.290 a +0.326 en UPDOWN_GBM_IBS_ALTO (n=647). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.83 sube el IC de +0.283 a +0.312 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=359). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 24696 | -0.091 | -3136.48€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1433 | -0.048 | -223.67€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 23263 | -0.094 | -2912.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3632 | -0.088 | -572.11€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3632 | -0.088 | -572.11€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7140 | -0.023 | -648.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7140 | -0.023 | -648.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6610 | -0.097 | -450.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6610 | -0.097 | -450.72€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5507 | -0.183 | -1080.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5507 | -0.183 | -1080.29€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17502 | -0.029 | +4079.32€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4577 | +0.000 | +1827.64€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12925 | -0.039 | +2251.68€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 17502 | -0.029 | +4079.32€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4577 | +0.000 | +1827.64€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12925 | -0.039 | +2251.68€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 90731 | +0.112 | -4634.54€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13754 | +0.185 | -445.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 363 | -0.089 | -50.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 70684 | +0.100 | -3927.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5930 | +0.108 | -211.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11757 | +0.098 | -1010.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 44 | -0.174 | -3.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11698 | +0.099 | -995.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18351 | +0.132 | -374.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4320 | +0.202 | -146.28€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11717 | +0.112 | -178.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2272 | +0.105 | -27.37€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11797 | +0.089 | -1106.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 51 | -0.085 | -5.77€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11731 | +0.090 | -1089.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19316 | +0.123 | -401.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5318 | +0.175 | -80.85€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11841 | +0.105 | -258.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2145 | +0.098 | -54.45€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17737 | +0.114 | -1040.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3976 | +0.188 | -216.66€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 266 | -0.049 | +3.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11982 | +0.091 | -697.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1513 | +0.127 | -129.61€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11773 | +0.101 | -700.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 45 | -0.032 | +7.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11715 | +0.101 | -708.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14391 | +0.192 | -935.19€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14391 | +0.192 | -935.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3437 | +0.168 | -362.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3437 | +0.168 | -362.27€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1157 | +0.197 | -5.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1157 | +0.197 | -5.27€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3381 | +0.181 | -287.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3381 | +0.181 | -287.79€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3018 | +0.238 | -97.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3018 | +0.238 | -97.78€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3319 | +0.194 | -195.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3319 | +0.194 | -195.83€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 49533 | +0.197 | -3941.20€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 49533 | +0.197 | -3941.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8580 | +0.175 | -1012.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8580 | +0.175 | -1012.03€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7906 | +0.223 | -297.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7906 | +0.223 | -297.93€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8551 | +0.172 | -1041.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8551 | +0.172 | -1041.74€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 8005 | +0.218 | -320.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 8005 | +0.218 | -320.37€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8180 | +0.203 | -547.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8180 | +0.203 | -547.35€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8311 | +0.194 | -721.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8311 | +0.194 | -721.79€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 18656 | +0.118 | +166.19€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 18656 | +0.118 | +166.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9263 | +0.123 | +153.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9263 | +0.123 | +153.46€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9393 | +0.113 | +12.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9393 | +0.113 | +12.73€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1439 | +0.292 | -3.98€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1439 | +0.292 | -3.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 642 | +0.280 | -13.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 642 | +0.280 | -13.32€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 692 | +0.295 | +7.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 692 | +0.295 | +7.31€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 628 | +0.440 | +2.29€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 628 | +0.440 | +2.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC | 296 | +0.440 | +0.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min | 296 | +0.440 | +0.77€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#ETH | 291 | +0.442 | +1.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#ETH#60min | 291 | +0.442 | +1.51€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#SOL | 41 | +0.384 | +0.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#SOL#60min | 41 | +0.384 | +0.01€ | 0 | 1 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1083 | +0.076 | -40.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 375 | +0.062 | -28.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 708 | +0.083 | -11.74€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 854 | +0.083 | -15.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 146 | +0.081 | -3.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 708 | +0.083 | -11.74€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 34427 | +0.097 | -1095.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2849 | +0.089 | +17.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 31578 | +0.097 | -1112.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 19364 | +0.101 | -330.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2849 | +0.089 | +17.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 16515 | +0.103 | -347.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6426 | +0.106 | -47.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6426 | +0.106 | -47.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8637 | +0.080 | -717.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8637 | +0.080 | -717.30€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 24782 | +0.082 | +11672.35€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 24782 | +0.082 | +11672.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4134 | +0.192 | +2987.80€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4134 | +0.192 | +2987.80€ | 0 | 19 |
| ✅ GBM_LATE_15M#BTC | 3669 | +0.177 | +2540.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3669 | +0.177 | +2540.36€ | 0 | 25 |
| ✅ GBM_LATE_15M#DOGE | 4291 | +0.199 | +3217.01€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4291 | +0.199 | +3217.01€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3672 | +0.017 | +749.60€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3672 | +0.017 | +749.60€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3567 | -0.033 | +808.06€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3567 | -0.033 | +808.06€ | 4 | 15 |
| ✅ GBM_LATE_15M#XRP | 5449 | -0.042 | +1369.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5449 | -0.042 | +1369.52€ | 4 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 26163 | +0.085 | +13628.19€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 26163 | +0.085 | +13628.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4951 | +0.016 | +2628.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4951 | +0.016 | +2628.86€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5451 | +0.014 | +1121.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5451 | +0.014 | +1121.30€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3715 | +0.262 | +3735.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3715 | +0.262 | +3735.49€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4238 | +0.001 | +774.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4238 | +0.001 | +774.72€ | 2 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4260 | +0.027 | +1592.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4260 | +0.027 | +1592.80€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3548 | +0.275 | +3775.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3548 | +0.275 | +3775.02€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 19983 | +0.167 | +14844.87€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 19983 | +0.167 | +14844.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 3008 | +0.205 | +2372.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 3008 | +0.205 | +2372.31€ | 0 | 18 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3182 | +0.148 | +2316.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3182 | +0.148 | +2316.56€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3128 | +0.208 | +2484.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3128 | +0.208 | +2484.74€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3356 | +0.133 | +2322.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3356 | +0.133 | +2322.11€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3717 | +0.116 | +2523.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3717 | +0.116 | +2523.00€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3592 | +0.203 | +2826.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3592 | +0.203 | +2826.14€ | 0 | 26 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4933 | +0.126 | +2031.10€ | 0 | 20 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4933 | +0.126 | +2031.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1410 | +0.121 | +626.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1410 | +0.121 | +626.95€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1435 | +0.141 | +620.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1435 | +0.141 | +620.73€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1028 | +0.099 | +311.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1028 | +0.099 | +311.80€ | 2 | 14 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 504 | +0.134 | +216.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 504 | +0.134 | +216.54€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 24887 | +0.174 | +18404.32€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#15min | 24887 | +0.174 | +18404.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3940 | +0.219 | +3304.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3940 | +0.219 | +3304.12€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3894 | +0.150 | +2566.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3894 | +0.150 | +2566.02€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4075 | +0.226 | +3511.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4075 | +0.226 | +3511.11€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 4038 | +0.136 | +2719.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 4038 | +0.136 | +2719.18€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4363 | +0.111 | +2709.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4363 | +0.111 | +2709.19€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4577 | +0.205 | +3594.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4577 | +0.205 | +3594.71€ | 0 | 24 |
...
| ✅ GBM_LATE_60M | 1654 | +0.070 | +732.89€ | 2 | 15 |
| ✅ GBM_LATE_60M#60min | 1654 | +0.070 | +732.89€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 595 | +0.091 | +259.09€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 595 | +0.091 | +259.09€ | 0 | 16 |
| ✅ GBM_LATE_60M#ETH | 550 | +0.072 | +285.29€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 550 | +0.072 | +285.29€ | 2 | 16 |
| ✅ GBM_LATE_60M#SOL | 509 | +0.042 | +188.51€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 509 | +0.042 | +188.51€ | 1 | 12 |
...
| 🚫 GBM_LATE_60M_FADE#BTC#60min | 137 | -0.227 | -11.84€ | 5 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1868 | +0.096 | +493.17€ | 0 | 1 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1868 | +0.096 | +493.17€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1868 | +0.096 | +493.17€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1868 | +0.096 | +493.17€ | 0 | 1 |
...
| ✅ LIQUIDACIONES_5M | 1913 | +0.004 | +11.94€ | 4 | 0 |
...
| ✅ LIQUIDACIONES_60M | 1057 | -0.048 | -30.97€ | 6 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 1057 | -0.048 | -30.97€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_60M#SOL | 404 | -0.062 | -13.45€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 404 | -0.062 | -13.45€ | 3 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 769 | -0.025 | +4.85€ | 2 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 345 | -0.019 | +6.32€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 424 | -0.030 | -1.48€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL | 119 | -0.021 | -0.39€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#15min | 60 | -0.016 | +2.63€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#5min | 59 | -0.025 | -3.01€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP | 183 | -0.062 | -15.70€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#15min | 76 | -0.051 | -4.92€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#5min | 107 | -0.069 | -10.78€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M | 14299 | -0.012 | -206.80€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14299 | -0.012 | -206.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 3016 | -0.021 | -59.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 3016 | -0.021 | -59.99€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 27979 | -0.008 | +1220.16€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 27979 | -0.008 | +1220.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4931 | +0.015 | +592.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4931 | +0.015 | +592.54€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4354 | -0.029 | -55.10€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4354 | -0.029 | -55.10€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4971 | +0.014 | +451.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4971 | +0.014 | +451.45€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4135 | -0.053 | -149.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4135 | -0.053 | -149.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4678 | -0.012 | +174.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4678 | -0.012 | +174.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4910 | +0.007 | +206.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4910 | +0.007 | +206.57€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5740 | -0.056 | -132.02€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5740 | -0.056 | -132.02€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1203 | +0.000 | -15.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1203 | +0.000 | -15.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 1381 | -0.080 | -38.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 1381 | -0.080 | -38.12€ | 3 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1657 | -0.075 | -27.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1657 | -0.075 | -27.62€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 71078 | -0.072 | +1721.24€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 71078 | -0.072 | +1721.24€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 12003 | -0.079 | +710.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 12003 | -0.079 | +710.06€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 10982 | -0.092 | -472.00€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 10982 | -0.092 | -472.00€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 12195 | -0.067 | +680.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 12195 | -0.067 | +680.58€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10509 | -0.092 | -145.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10509 | -0.092 | -145.58€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 13029 | -0.048 | +372.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 13029 | -0.048 | +372.77€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 12360 | -0.063 | +575.41€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 12360 | -0.063 | +575.41€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7438 | -0.023 | -108.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7438 | -0.023 | -108.97€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 2020 | -0.017 | -17.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 2020 | -0.017 | -17.19€ | 1 | 0 |
...
| ✅ STREAK_FADE_5M | 2724 | -0.023 | -113.39€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2724 | -0.023 | -113.39€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1199 | -0.022 | -48.19€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1199 | -0.022 | -48.19€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 7625 | +0.023 | +111.08€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7625 | +0.023 | +111.08€ | 0 | 0 |
...
| ✅ STREAK_MOM_5M#SOL | 2314 | +0.011 | +1.60€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2314 | +0.011 | +1.60€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1479 | +0.030 | +38.40€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1479 | +0.030 | +38.40€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7154 | +0.011 | -50.66€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7154 | +0.011 | -50.66€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2875 | +0.014 | -12.00€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2875 | +0.014 | -12.00€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2799 | +0.011 | -20.08€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2799 | +0.011 | -20.08€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1480 | +0.003 | -18.58€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1480 | +0.003 | -18.58€ | 2 | 0 |
| ✅ UPDOWN_GBM | 35723 | +0.030 | +2073.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 9653 | +0.065 | +1697.07€ | 0 | 10 |
| ✅ UPDOWN_GBM#240min | 1325 | +0.004 | +5.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 22434 | +0.019 | +351.09€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2172 | +0.006 | +19.39€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3595 | +0.065 | +371.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 616 | +0.142 | +229.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 29 | -0.016 | -0.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2950 | +0.050 | +142.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6611 | +0.035 | +439.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1224 | +0.082 | +267.10€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 360 | +0.019 | +7.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 3999 | +0.031 | +147.72€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 975 | +0.004 | +16.38€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 53 | -0.100 | +0.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 4160 | +0.040 | +246.53€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 569 | +0.139 | +202.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 27 | -0.017 | -2.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3564 | +0.024 | +46.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 7606 | +0.017 | +275.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2493 | +0.045 | +267.61€ | 0 | 12 |
| ✅ UPDOWN_GBM#ETH#240min | 348 | +0.006 | +6.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3980 | +0.005 | +1.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 740 | +0.003 | -4.33€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 45 | -0.138 | +3.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8578 | +0.015 | +213.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2374 | +0.026 | +164.70€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 342 | -0.006 | -3.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5366 | +0.012 | +46.95€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 457 | +0.018 | +7.34€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 39 | -0.159 | -2.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5171 | +0.034 | +529.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2377 | +0.078 | +566.14€ | 0 | 12 |
| ✅ UPDOWN_GBM#XRP#240min | 219 | -0.002 | -3.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2575 | -0.003 | -34.11€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11565 | -0.042 | +2367.97€ | 3 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11565 | -0.042 | +2367.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 715 | -0.041 | +336.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 715 | -0.041 | +336.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2156 | -0.123 | +14.92€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2156 | -0.123 | +14.92€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 352 | +0.178 | +232.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 352 | +0.178 | +232.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1277 | +0.201 | +730.04€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1277 | +0.201 | +730.04€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3526 | -0.064 | +532.89€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3526 | -0.064 | +532.89€ | 2 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3539 | -0.078 | +521.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3539 | -0.078 | +521.38€ | 3 | 4 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 861 | +0.290 | +694.84€ | 0 | 11 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 861 | +0.290 | +694.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 478 | +0.283 | +360.00€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 478 | +0.283 | +360.00€ | 0 | 10 |
