# Hipótesis automáticas — 2026-07-02 00:32 UTC
_Generado por shadow_postmortem.py sobre 2491 resoluciones (PNL=-73.52€)_
...
- **PATRÓN** `drift_60min` |x|≤ `0.438` → IC=+0.138 (n=45)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.438 (IC base=+0.106)

- **PATRÓN** `drift_15min` |x|≤ `0.4139` → IC=+0.139 (n=34)

  - _Acción_: Kelly boost +0.69€ cuando `drift_15min` |x|≤ 0.4139 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.206 (n=32)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.106)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.133 (n=28)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 11.0 (IC base=+0.106)

- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.258 (n=31)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0634 (IC base=+0.106)
...
| ✅ UPDOWN_GBM | 741 | -0.030 | -22.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 523 | -0.003 | +3.56€ | 1 | 6 |
...
| ✅ UPDOWN_GBM#XRP | 58 | +0.017 | +6.97€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 47 | +0.071 | +10.26€ | 1 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.098) — sin ventaja clara. oversold(IBS<0.3): IC=+0.032 n=109 | neutral: IC=-0.066 n=104 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=351 IC=-0.018 PNL=+2.84€
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.001 n=1173 | tras_1loss IC=-0.033 n=1236 | tras_2loss IC=-0.047 n=643/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=618 IC=-0.023 PNL=-8.84€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=618 IC=-0.023 PNL=-8.84€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=140 IC=+0.077 PNL=+31.42€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=140 IC=+0.077 PNL=+31.42€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 74/200 ops en el filtro definido (IC actual=+0.105 PNL=+19.40€)
  - _Datos_: n=74 IC=+0.105 PNL=+19.40€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 74/100 ops en el filtro definido (IC actual=+0.105 PNL=+19.40€)
  - _Datos_: n=74 IC=+0.105 PNL=+19.40€
