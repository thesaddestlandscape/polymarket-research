# Hipótesis automáticas — 2026-07-28 04:06 UTC
_Generado por shadow_postmortem.py sobre 39513 resoluciones (PNL=+8016.15€)_
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.187 (n=1229)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.185 (n=1191)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=2898)
...
- **PATRÓN** `dist_vwap_pct` > `0.4604` → IC=+0.127 (n=328)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.4604 (IC base=+0.113)
...
- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.144 (n=506)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.185 (n=1204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.441` → IC=+0.230 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.441 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.153 (n=1409)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.3973` → IC=+0.129 (n=340)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.3973 (IC base=+0.119)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.136 (n=457)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1796` → IC=+0.151 (n=164)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1796 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.62` → IC=+0.260 (n=194)
...
- **PATRÓN** `sigma_h` < `0.0173` → IC=+0.206 (n=545)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0173 (IC base=+0.203)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.231 (n=545)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1912` → IC=+0.317 (n=102)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1912 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.497` → IC=+0.219 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.497 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.43` → IC=+0.195 (n=545)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 5.43 (IC base=+0.203)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.126 (n=803)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.127 (n=156)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 12.0 (IC base=+0.081)

- **PATRÓN** `ibs_15` < `0.0357` → IC=+0.153 (n=70)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` < 0.0357 (IC base=+0.081)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.0357 sube el IC de +0.081 a +0.153 en UPDOWN_GBM#XRP#15min (n=70). Ya aplicado como kelly_boost=+0.76€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ FAVORITO_CONFIRMADO | 6871 | +0.177 | -49.09€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4529 | +0.201 | -42.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 309 | +0.056 | -21.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 819 | +0.129 | -55.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1214 | +0.152 | +70.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 2030 | +0.182 | -12.05€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 407 | +0.172 | +57.21€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 8 | +0.120 | +5.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 7 | +0.097 | +4.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 2410 | +0.168 | -44.04€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 406 | +0.137 | +11.88€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 2384 | +0.183 | -0.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1491 | +0.207 | +8.61€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 8488 | +0.093 | +2525.65€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8488 | +0.093 | +2525.65€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 2271 | +0.082 | +768.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2271 | +0.082 | +768.66€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2278 | +0.139 | +1089.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2278 | +0.139 | +1089.26€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5726 | +0.114 | +2610.93€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5726 | +0.114 | +2610.93€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1424 | +0.081 | +532.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1424 | +0.081 | +532.98€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1284 | +0.214 | +1046.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1284 | +0.214 | +1046.30€ | 0 | 10 |
...
| ✅ GBM_LATE_15M_TARDIO | 5714 | +0.064 | +1467.31€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5714 | +0.064 | +1467.31€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 1336 | +0.024 | +242.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1336 | +0.024 | +242.04€ | 1 | 1 |
...
| ✅ STREAK_FADE_15M | 300 | +0.066 | +23.34€ | 1 | 1 |
| ✅ STREAK_FADE_15M#15min | 300 | +0.066 | +23.34€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M#XRP | 149 | +0.043 | +5.45€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP#15min | 149 | +0.043 | +5.45€ | 0 | 3 |
...
| ✅ UPDOWN_GBM | 2936 | +0.036 | +269.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2672 | +0.052 | +308.70€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#XRP | 337 | +0.052 | +47.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 326 | +0.061 | +50.52€ | 4 | 2 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2206 | +0.149 | +958.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2206 | +0.149 | +958.23€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 618 | +0.166 | +360.93€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 618 | +0.166 | +360.93€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Datos_: n=4969 IC=+0.103 PNL=+1293.35€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.109 n=23454 | tras_1loss IC=+0.077 n=15844 | tras_2loss IC=+0.052 n=6662/40 | gap=+0.057 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.052 n=172/60 | contraria IC=+0.106 n=64 | gap=-0.054 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2799 IC=+0.040 PNL=+283.47€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2799 IC=+0.040 PNL=+283.47€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1479 IC=+0.040 PNL=+119.84€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1479 IC=+0.040 PNL=+119.84€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3231 IC=+0.054 PNL=+360.72€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3231 IC=+0.054 PNL=+360.72€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.1 con n=1019 PNL=+347.16€
  - _Datos_: n=1019 IC=+0.162 PNL=+347.16€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=289 IC=+0.081 PNL=+53.85€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=289 IC=+0.081 PNL=+53.85€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1016 IC=-0.075 PNL=+248.65€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1016 IC=-0.075 PNL=+248.65€
...
**🟡 H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.085 > 0.08 con n=222 PNL=+42.83€
  - _Datos_: n=222 IC=+0.085 PNL=+42.83€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.101 > 0.08 con n=687 PNL=+213.62€
  - _Datos_: n=687 IC=+0.101 PNL=+213.62€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=680 IC=+0.199 PNL=+384.66€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=680 IC=+0.199 PNL=+384.66€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.204 > 0.08 con n=434 PNL=+23.96€
  - _Datos_: n=434 IC=+0.204 PNL=+23.96€
