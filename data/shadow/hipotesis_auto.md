# Hipótesis automáticas — 2026-08-22 03:21 UTC
_Generado por shadow_postmortem.py sobre 108818 resoluciones (PNL=+8817.79€)_
...
- **PATRÓN** `py_entrada` > `0.705` → IC=+0.261 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.705 (IC base=+0.117)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.128 (n=181)

  - _Acción_: Kelly boost +0.64€ cuando `n_ballena_banda` > 20.0 (IC base=+0.117)

- **PATRÓN** `n_total_lado` > `69.0` → IC=+0.217 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 69.0 (IC base=+0.117)

- **PATRÓN** `banda_hit_calibrado` > `0.8011` → IC=+0.261 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8011 (IC base=+0.117)

- **PATRÓN** `banda_z` > `9.862` → IC=+0.216 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 9.862 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=203)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `3120.8362` → IC=+0.157 (n=65)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3120.8362 (IC base=+0.117)
...
- **PATRÓN** `py_entrada` > `0.725` → IC=+0.303 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.146)

- **PATRÓN** `n_ballena_banda` > `26.0` → IC=+0.163 (n=99)

  - _Acción_: Kelly boost +0.82€ cuando `n_ballena_banda` > 26.0 (IC base=+0.146)

- **PATRÓN** `n_total_lado` > `71.0` → IC=+0.240 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 71.0 (IC base=+0.146)

- **PATRÓN** `banda_z` > `9.998` → IC=+0.173 (n=50)

  - _Acción_: Kelly boost +0.87€ cuando `banda_z` > 9.998 (IC base=+0.146)

- **PATRÓN** `ballenas_wallet_edge_medio` > `3.222` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `ballenas_wallet_edge_medio` > 3.222 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.198 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 17.0 (IC base=+0.146)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.159 (n=39)
...
- **PATRÓN** `libro_liquidez` > `4546.1989` → IC=+0.218 (n=37)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4546.1989 (IC base=+0.146)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `157.1` → IC=-0.261 (n=1534)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.1
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4609)
...
- **FILTRO** `restante_s_al_confirmar` < `145.86` → IC=-0.244 (n=369)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.86
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=1110)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `169.07` → IC=-0.330 (n=397)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 169.07
  - _Potencial_: sin este filtro IC_bueno=-0.122 (n=807)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=3653)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=1315)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2373.5135` → IC=+0.171 (n=1267)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.141 (n=2824)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 7.0 (IC base=+0.130)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.258 (n=2144)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.207 (n=579)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.134 (n=781)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 15.0 (IC base=+0.125)

- **PATRÓN** `py_entrada` > `0.7` → IC=+0.305 (n=300)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.203 (n=482)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.196 (n=1500)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 7.0 (IC base=+0.189)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.198 (n=1792)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=853)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.188 (n=864)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.175 (n=380)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.228 (n=671)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.226)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.311 (n=294)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.201 (n=362)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.436 (n=155)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.450 (n=38)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.429)

- **PATRÓN** `py_entrada` < `0.932` → IC=+0.421 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.932 (IC base=+0.429)

- **PATRÓN** `py_entrada` > `0.92` → IC=+0.427 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.92 (IC base=+0.429)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.423 (n=37)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.198 (n=5373)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 12.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.229 (n=5501)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.136 (n=1001)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 12.0 (IC base=+0.121)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.164 (n=1002)

  - _Acción_: Kelly boost +0.82€ cuando `py_entrada` > 0.71 (IC base=+0.121)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.285 (n=589)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.167 (n=514)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 6.0 (IC base=+0.160)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.189 (n=921)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.306 (n=452)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.238 (n=1062)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.235)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.253 (n=1093)
...
- **PATRÓN** `restante_min` > `4.89` → IC=+0.158 (n=477)

  - _Acción_: Kelly boost +0.79€ cuando `restante_min` > 4.89 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.161 (n=944)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 12.0 (IC base=+0.141)

- **PATRÓN** `lag_apertura_s` < `6.62` → IC=+0.165 (n=446)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 6.62 (IC base=+0.141)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.176 (n=501)

  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` < 0.37 (IC base=+0.114)

- **PATRÓN** `restante_min` < `3.95` → IC=+0.137 (n=452)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 3.95 (IC base=+0.114)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.161 (n=452)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.95 (IC base=+0.114)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.122 (n=1425)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 18.0 (IC base=+0.114)

- **PATRÓN** `lag_apertura_s` < `3.3` → IC=+0.161 (n=452)

  - _Acción_: Kelly boost +0.80€ cuando `lag_apertura_s` < 3.3 (IC base=+0.114)
...
- **PATRÓN** `py_entrada` > `0.865` → IC=+0.419 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.865 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.290 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `1406.0028` → IC=+0.331 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1406.0028 (IC base=+0.276)
...
- **PATRÓN** `dist_vwap_pct` > `0.1564` → IC=+0.232 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1564 (IC base=+0.089)

- **PATRÓN** `dist_vwap_pct` < `1.0969` → IC=+0.237 (n=287)
...
- **PATRÓN** `volumen_regimen` > `1.1032` → IC=+0.262 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1032 (IC base=+0.089)

- **PATRÓN** `volumen_pendiente_norm` < `0.0803` → IC=+0.124 (n=798)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4952` → IC=+0.131 (n=882)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4952 (IC base=+0.089)

- **PATRÓN** `ibs_20min` < `0.4017` → IC=+0.128 (n=1786)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4017 (IC base=+0.043)

- **PATRÓN** `dist_vwap_pct` < `0.1289` → IC=+0.142 (n=587)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1289 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` < `0.6283` → IC=+0.137 (n=202)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.6283 (IC base=+0.043)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2582` → IC=+0.260 (n=119)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2582 (IC base=+0.043)

- **PATRÓN** `volumen_spike_ratio` < `1.664` → IC=+0.206 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.664 (IC base=+0.043)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.317 (n=69)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.229)

- **PATRÓN** `drift_60min` |x|≤ `0.0798` → IC=+0.246 (n=69)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4873` → IC=+0.251 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4873 (IC base=+0.229)

- **PATRÓN** `dist_vwap_pct` > `0.1784` → IC=+0.239 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1784 (IC base=+0.229)

- **PATRÓN** `dist_vwap_pct` < `1.1931` → IC=+0.248 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.1931 (IC base=+0.229)
...
- **PATRÓN** `volumen_regimen` > `1.1438` → IC=+0.271 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1438 (IC base=+0.229)

- **PATRÓN** `volumen_pendiente_norm` < `0.083` → IC=+0.246 (n=171)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2854` → IC=+0.300 (n=28)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2854 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` < `1.3555` → IC=+0.246 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3555 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` > `1.6776` → IC=+0.242 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6776 (IC base=+0.229)

- **PATRÓN** `libro_liquidez` > `11822.0119` → IC=+0.257 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11822.0119 (IC base=+0.229)

- **PATRÓN** `ballena_activa_n` < `431.0` → IC=+0.237 (n=131)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.933` → IC=-0.133 (n=300)
...
- **FILTRO** `ibs_20min` > `0.7549` → IC=-0.151 (n=227)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7549
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=685)

- **FILTRO** `sigma_ewma_delta_pct` > `8.08` → IC=-0.167 (n=109)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.315` → IC=+0.134 (n=1207)
...
- **FILTRO** `ibs_20min` < `0.668` → IC=-0.121 (n=209)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.220 (n=580)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9107` → IC=+0.260 (n=1157)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9107 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` > `0.9323` → IC=+0.262 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9323 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.055` → IC=+0.270 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.055 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` > `0.6379` → IC=+0.176 (n=1088)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4298` → IC=+0.148 (n=1315)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.4298 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.4774` → IC=+0.147 (n=1494)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4774 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=1812)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `3294.5947` → IC=+0.207 (n=579)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3294.5947 (IC base=+0.159)
...
- **PATRÓN** `sigma_h` > `0.0038` → IC=+0.216 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5283` → IC=+0.251 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5283 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.258 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.75` → IC=+0.321 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.75 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.9291` → IC=+0.257 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9291 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2865` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2865 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `1.4256` → IC=+0.258 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4256 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.7304` → IC=+0.211 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7304 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `11170.0615` → IC=+0.250 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11170.0615 (IC base=+0.201)
...
- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.242 (n=196)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.4752` → IC=+0.284 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4752 (IC base=+0.222)

- **PATRÓN** `dist_vwap_pct` > `0.1293` → IC=+0.241 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1293 (IC base=+0.222)

- **PATRÓN** `dist_vwap_pct` < `0.387` → IC=+0.245 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.387 (IC base=+0.222)
...
- **PATRÓN** `volumen_regimen` > `0.6466` → IC=+0.253 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6466 (IC base=+0.222)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4661` → IC=+0.238 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4661 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `2.5456` → IC=+0.281 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5456 (IC base=+0.222)

- **PATRÓN** `ballena_activa_n` < `243.0` → IC=+0.211 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 243.0 (IC base=+0.222)
...
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.227 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0092 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.152 (n=110)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 18.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.8736` → IC=+0.238 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8736 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.7814` → IC=+0.294 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7814 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.4` → IC=+0.247 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.4 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `0.6244` → IC=+0.123 (n=324)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6244 (IC base=+0.106)
...
- **PATRÓN** `libro_liquidez` > `2714.252` → IC=+0.191 (n=147)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2714.252 (IC base=+0.106)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.234 (n=126)
...
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.245 (n=241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.200 (n=128)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.165 (n=162)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 7.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.250 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.326` → IC=+0.229 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.326 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.888` → IC=+0.240 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.888 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.2526` → IC=+0.161 (n=361)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2526 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `0.8564` → IC=+0.183 (n=241)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.8564 (IC base=+0.161)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6685` → IC=+0.179 (n=325)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.6685 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.9238` → IC=+0.162 (n=217)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.9238 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.162 (n=388)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `2460.3759` → IC=+0.167 (n=361)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.241 (n=662)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.151 (n=746)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 6.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.96` → IC=+0.289 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.96 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.7963` → IC=+0.242 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7963 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.049` → IC=+0.267 (n=890)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.049 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.8969` → IC=+0.143 (n=842)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8969 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.0941` → IC=+0.155 (n=572)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.0941 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.1689` → IC=+0.169 (n=484)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.1689 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.8745` → IC=+0.139 (n=1675)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.8745 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.9557` → IC=+0.149 (n=1116)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.9557 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.152 (n=2034)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.04 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `3232.413` → IC=+0.191 (n=662)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 3232.413 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.221 (n=535)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3507` → IC=+0.200 (n=1802)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3507 (IC base=+0.189)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.552` → IC=+0.192 (n=1692)
...
- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.130 (n=306)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 35.0 (IC base=+0.189)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.172 (n=117)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0027 (IC base=+0.158)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.199 (n=121)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.3308` → IC=+0.229 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3308 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` > `0.2114` → IC=+0.240 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2114 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.421` → IC=+0.274 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.421 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `0.6834` → IC=+0.159 (n=89)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.6834 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` > `0.9205` → IC=+0.191 (n=176)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.9205 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` < `0.1037` → IC=+0.191 (n=205)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1464` → IC=+0.203 (n=62)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1464 (IC base=+0.158)
...
- **PATRÓN** `volumen_spike_ratio` > `1.3478` → IC=+0.211 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3478 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `10405.5061` → IC=+0.219 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10405.5061 (IC base=+0.158)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.144 (n=88)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0022 (IC base=+0.142)

- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.178 (n=88)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0077 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.0741` → IC=+0.167 (n=88)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0741 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=97)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 17.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` > `0.3665` → IC=+0.213 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3665 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.1624` → IC=+0.188 (n=158)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1624 (IC base=+0.142)
...
- **PATRÓN** `volumen_regimen` < `0.7415` → IC=+0.195 (n=116)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.7415 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `1.1223` → IC=+0.169 (n=119)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.1223 (IC base=+0.142)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4212` → IC=+0.230 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4212 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `3954.2434` → IC=+0.217 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3954.2434 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `238.0` → IC=+0.252 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 238.0 (IC base=+0.142)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.232 (n=106)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0081 (IC base=+0.074)

- **PATRÓN** `ibs_20min` > `0.9412` → IC=+0.262 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9412 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.6975` → IC=+0.247 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6975 (IC base=+0.074)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.9` → IC=+0.261 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.9 (IC base=+0.074)

- **PATRÓN** `libro_liquidez` > `2638.9696` → IC=+0.222 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2638.9696 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.274 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 64.0 (IC base=+0.074)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.291 (n=309)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.209)

- **PATRÓN** `drift_60min` |x|≤ `0.4043` → IC=+0.228 (n=461)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4043 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.264 (n=214)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` < `0.4667` → IC=+0.282 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4667 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` < `0.7234` → IC=+0.223 (n=518)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.8` → IC=+0.217 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.8 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.883` → IC=+0.238 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.883 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2418` → IC=+0.297 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2418 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.7637` → IC=+0.225 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7637 (IC base=+0.209)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.158 (n=328)

- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.125 (n=86)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0078 (IC base=+0.067)

- **PATRÓN** `dist_vwap_pct` > `1.102` → IC=+0.179 (n=79)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 1.102 (IC base=+0.067)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=104)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.067)

- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.207 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.1757` → IC=+0.184 (n=172)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.1757 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.177 (n=91)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.247 (n=93)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.6846` → IC=+0.173 (n=258)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6846 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.2638` → IC=+0.154 (n=241)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.2638 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.281` → IC=+0.152 (n=245)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 5.281 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.1717` → IC=+0.172 (n=227)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.1717 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.7403` → IC=+0.142 (n=230)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.7403 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` < `0.0956` → IC=+0.139 (n=217)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.0956 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.0712` → IC=+0.162 (n=137)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0712 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.6509` → IC=+0.173 (n=255)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.6509 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4126` → IC=+0.150 (n=255)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4126 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=328)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `5937.9785` → IC=+0.181 (n=258)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 5937.9785 (IC base=+0.141)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.243` → IC=+0.200 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.243 (IC base=+0.058)
...
- **PATRÓN** `py_entrada` < `0.485` → IC=+0.167 (n=25)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` < 0.485 (IC base=+0.150)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.5 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `2598.9726` → IC=+0.221 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2598.9726 (IC base=+0.150)
...
- **PATRÓN** `drift_20min_pct` |x|≤ `0.1191` → IC=+0.136 (n=75)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `drift_20min_pct` |x|≤ 0.1191 (IC base=+0.056)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.45` → IC=-0.167 (n=376)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1174)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.255 (n=370)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1178)

- **FILTRO** `ibs_20min` > `0.278` → IC=-0.237 (n=386)
...
- **FILTRO** `py_entrada` > `0.68` → IC=-0.162 (n=63)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=195)

- **FILTRO** `ibs_20min` > `0.1845` → IC=-0.177 (n=128)

  - _Acción_: SKIP cuando `ibs_20min` > 0.1845
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=130)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.130 (n=90)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` > 0.505 (IC base=+0.004)

- **PATRÓN** `libro_liquidez` > `1614.5443` → IC=+0.133 (n=77)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 1614.5443 (IC base=+0.004)
...
- **FILTRO** `py_entrada` > `0.68` → IC=-0.258 (n=64)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=197)

- **FILTRO** `drift_20min_pct` |x|> `0.3092` → IC=-0.122 (n=88)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3092
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=173)

- **FILTRO** `ibs_20min` > `0.7667` → IC=-0.246 (n=65)
...
- **FILTRO** `drift_20min_pct` |x|> `0.3061` → IC=-0.254 (n=59)
...
- **FILTRO** `ballena_activa_n` > `2.0` → IC=-0.216 (n=100)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.221 (n=66)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.128 (n=202)
...
- **FILTRO** `py_entrada` > `0.65` → IC=-0.342 (n=55)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=184)

- **FILTRO** `drift_20min_pct` |x|> `0.3942` → IC=-0.199 (n=81)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3942
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=158)

- **FILTRO** `ibs_20min` > `0.2917` → IC=-0.402 (n=59)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2917
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=180)

- **PATRÓN** `py_entrada` > `0.47` → IC=+0.128 (n=202)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.47 (IC base=+0.041)

- **PATRÓN** `libro_liquidez` > `2471.6906` → IC=+0.128 (n=92)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 2471.6906 (IC base=+0.041)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.277 (n=916)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=2907)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.222 (n=955)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2868)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.167 (n=1279)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2544)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.227 (n=1088)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3423)

- **FILTRO** `ibs_7min` > `0.7213` → IC=-0.164 (n=1127)
...
- **FILTRO** `ibs_7min` < `0.9422` → IC=-0.190 (n=359)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9422
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=186)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.225 (n=136)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=409)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.234 (n=201)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=504)

- **FILTRO** `drift_7min_pct` |x|> `0.1346` → IC=-0.197 (n=239)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1346
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=466)

- **FILTRO** `ibs_7min` > `0.8364` → IC=-0.202 (n=176)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=529)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.142 (n=171)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=534)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.251 (n=191)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=582)

- **FILTRO** `ballena_activa_n` > `143.0` → IC=-0.149 (n=192)

  - _Acción_: SKIP cuando `ballena_activa_n` > 143.0
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=581)

- **FILTRO** `py_entrada` > `0.53` → IC=-0.204 (n=194)

  - _Acción_: SKIP cuando `py_entrada` > 0.53
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=584)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.210 (n=150)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.39` → IC=-0.230 (n=202)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=473)

- **FILTRO** `ibs_7min` < `0.7844` → IC=-0.176 (n=168)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.193 (n=174)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=537)

- **FILTRO** `ibs_7min` < `0.7778` → IC=-0.157 (n=176)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7778
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=535)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.203 (n=170)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=541)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.167 (n=199)
...
- **FILTRO** `py_entrada` < `0.37` → IC=-0.266 (n=143)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=453)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.226 (n=144)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=452)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.222 (n=142)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.297 (n=185)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=559)

- **FILTRO** `ibs_7min` > `0.8696` → IC=-0.195 (n=185)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8696
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=559)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.142 (n=241)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `py_entrada` > 0.505 (IC base=+0.070)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=532)
...
- **FILTRO** `ibs_15` < `0.142` → IC=-0.241 (n=79)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.142
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.526` → IC=-0.192 (n=37)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=280)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.203` → IC=+0.277 (n=92)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.203 (IC base=+0.279)

- **PATRÓN** `sigma_h` < `0.0024` → IC=+0.292 (n=46)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0024 (IC base=+0.279)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.303 (n=69)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0029 (IC base=+0.279)

- **PATRÓN** `drift_60min` |x|≤ `0.1957` → IC=+0.283 (n=104)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1957 (IC base=+0.279)

- **PATRÓN** `drift_15min` |x|≤ `0.4366` → IC=+0.292 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4366 (IC base=+0.279)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0706` → IC=+0.283 (n=104)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0706 (IC base=+0.279)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.294 (n=105)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.279)

- **PATRÓN** `ibs_15` > `0.7199` → IC=+0.340 (n=104)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7199 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.3763` → IC=+0.400 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3763 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `18.963` → IC=+0.321 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.963 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `3371.1445` → IC=+0.300 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3371.1445 (IC base=+0.279)
...
- **FILTRO** `ibs_15` < `0.3664` → IC=-0.331 (n=75)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.145 (n=226)

- **FILTRO** `sigma_h` > `0.0077` → IC=-0.172 (n=616)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0077
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=1196)

- **FILTRO** `drift_15min` |x|> `0.82` → IC=-0.132 (n=452)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
...
- **FILTRO** `sigma_ewma_delta_pct` > `13.46` → IC=-0.200 (n=328)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 13.46
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=1484)

- **PATRÓN** `ibs_15` > `0.3664` → IC=+0.145 (n=226)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` > 0.3664 (IC base=-0.039)
...
- **FILTRO** `sigma_h` > `0.0066` → IC=-0.260 (n=102)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0066
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=309)

- **FILTRO** `drift_15min` |x|> `0.7946` → IC=-0.211 (n=102)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.7946
  - _Potencial_: sin este filtro IC_bueno=-0.207 (n=309)
...
- **FILTRO** `sigma_ewma_delta_pct` > `20.305` → IC=-0.250 (n=86)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 20.305
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=325)
...
- **PATRÓN** `ibs_15` > `0.6285` → IC=+0.241 (n=56)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6285 (IC base=-0.040)
...
- **FILTRO** `sigma_h` > `0.0079` → IC=-0.159 (n=215)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0079
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=420)

- **FILTRO** `sigma_ewma_delta_pct` > `12.125` → IC=-0.205 (n=103)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.368 (n=51)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.286)
...
- **PATRÓN** `drift_15min` |x|≤ `0.4515` → IC=+0.286 (n=68)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4515 (IC base=+0.286)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1863` → IC=+0.347 (n=70)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1863 (IC base=+0.286)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3217` → IC=+0.363 (n=49)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.290 (n=160)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.5461` → IC=+0.367 (n=43)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5461 (IC base=+0.286)

- **PATRÓN** `dist_vwap_pct` < `0.0966` → IC=+0.309 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0966 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.556` → IC=+0.285 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.556 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` < `19.88` → IC=+0.299 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 19.88 (IC base=+0.286)

- **PATRÓN** `libro_liquidez` > `9584.2249` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9584.2249 (IC base=+0.286)

- **PATRÓN** `ballena_activa_n` < `276.0` → IC=+0.344 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 276.0 (IC base=+0.286)
...
- **PATRÓN** `sigma_h` > `0.0039` → IC=+0.344 (n=43)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0039 (IC base=+0.316)

- **PATRÓN** `drift_60min` |x|≤ `0.157` → IC=+0.314 (n=57)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.157 (IC base=+0.316)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1796` → IC=+0.435 (n=29)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1796 (IC base=+0.316)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.321 (n=65)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.316)

- **PATRÓN** `ibs_15` > `0.9619` → IC=+0.371 (n=29)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9619 (IC base=+0.316)

- **PATRÓN** `dist_vwap_pct` > `0.5578` → IC=+0.447 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5578 (IC base=+0.316)

- **PATRÓN** `dist_vwap_pct` < `0.0769` → IC=+0.329 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0769 (IC base=+0.316)

- **PATRÓN** `sigma_ewma_delta_pct` < `19.469` → IC=+0.341 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 19.469 (IC base=+0.316)

- **PATRÓN** `libro_liquidez` > `10425.7161` → IC=+0.375 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10425.7161 (IC base=+0.316)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6285 sube el IC de -0.040 a +0.241 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=56). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.9678 sube el IC de +0.286 a +0.377 en UPDOWN_GBM_IBS_ALTO (n=71). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.9619 sube el IC de +0.316 a +0.371 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=29). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7199 sube el IC de +0.279 a +0.340 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=104). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 537 | +0.066 | +40.53€ | 3 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 537 | +0.066 | +40.53€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 293 | +0.080 | +29.53€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 293 | +0.080 | +29.53€ | 1 | 9 |
...
| ✅ BALLENAS_TARDIAS | 4945 | -0.103 | -531.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 570 | -0.082 | -104.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 4375 | -0.105 | -426.68€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1479 | -0.008 | +47.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1479 | -0.008 | +47.40€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1204 | -0.191 | -200.02€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1204 | -0.191 | -200.02€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 21291 | +0.112 | -1511.13€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4362 | +0.184 | -173.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 13987 | +0.088 | -1279.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2836 | +0.127 | -9.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2355 | +0.053 | -453.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 17 | -0.067 | -0.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2333 | +0.056 | -446.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 4575 | +0.134 | -102.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1208 | +0.190 | -83.39€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2326 | +0.107 | -65.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 999 | +0.138 | +68.27€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2359 | +0.065 | -373.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 16 | +0.044 | -1.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2342 | +0.066 | -370.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 4933 | +0.127 | -77.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1603 | +0.169 | -7.87€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2326 | +0.108 | -48.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 992 | +0.108 | -12.34€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 4715 | +0.125 | -384.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1504 | +0.201 | -79.85€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2321 | +0.075 | -231.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 845 | +0.134 | -65.19€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2354 | +0.118 | -120.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 14 | +0.000 | -0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2339 | +0.118 | -118.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 4466 | +0.173 | -348.36€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 4466 | +0.173 | -348.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1121 | +0.167 | -123.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1121 | +0.167 | -123.45€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 92 | -0.096 | +2.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 92 | -0.096 | +2.52€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1114 | +0.162 | -132.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1114 | +0.162 | -132.17€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 997 | +0.226 | -35.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 997 | +0.226 | -35.52€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1063 | +0.192 | -73.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1063 | +0.192 | -73.49€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 227 | +0.430 | -4.98€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 227 | +0.430 | -4.98€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 54 | +0.429 | -0.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 54 | +0.429 | -0.02€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 