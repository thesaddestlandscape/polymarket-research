# Hipótesis automáticas — 2026-08-24 05:40 UTC
_Generado por shadow_postmortem.py sobre 134652 resoluciones (PNL=+9345.28€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `158.1` → IC=-0.252 (n=1876)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.1
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=5630)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `150.45` → IC=-0.207 (n=210)
...
- **FILTRO** `restante_s_al_confirmar` < `110.24` → IC=-0.388 (n=212)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 110.24
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=638)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `169.89` → IC=-0.143 (n=496)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 169.89
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1488)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `148.13` → IC=-0.271 (n=465)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.13
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1396)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `173.08` → IC=-0.295 (n=446)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 173.08
  - _Potencial_: sin este filtro IC_bueno=-0.108 (n=907)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.185 (n=4516)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.7 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1420)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `7182.9538` → IC=+0.203 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7182.9538 (IC base=+0.098)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.144 (n=2892)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 17.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.154 (n=3463)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 7.0 (IC base=+0.137)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.264 (n=2532)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.185 (n=2628)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `1771.3041` → IC=+0.175 (n=2169)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1771.3041 (IC base=+0.137)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=525)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.212 (n=658)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.190 (n=369)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 11.0 (IC base=+0.181)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.286 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.181)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=690)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.143 (n=418)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 15.0 (IC base=+0.124)

- **PATRÓN** `py_entrada` > `0.6` → IC=+0.174 (n=213)

  - _Acción_: Kelly boost +0.87€ cuando `py_entrada` > 0.6 (IC base=+0.124)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1034)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.129 (n=713)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=818)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.305` → IC=+0.306 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.305 (IC base=+0.215)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.224 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `802.9165` → IC=+0.234 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 802.9165 (IC base=+0.215)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.181 (n=954)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 17.0 (IC base=+0.172)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.191 (n=992)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.442 (n=170)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2048.1399` → IC=+0.448 (n=170)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.436 (n=61)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `10692.8582` → IC=+0.471 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10692.8582 (IC base=+0.436)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=1294)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.293 (n=558)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.269 (n=513)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.192 (n=1156)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.315 (n=247)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.303 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.305)

- **PATRÓN** `libro_liquidez` > `2357.4153` → IC=+0.321 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2357.4153 (IC base=+0.305)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.422 (n=228)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.410)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.423 (n=220)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.419 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.410)

- **PATRÓN** `libro_liquidez` > `1854.0504` → IC=+0.422 (n=216)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.430 (n=98)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.413 (n=102)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9498` → IC=+0.225 (n=605)
...
- **PATRÓN** `dist_vwap_pct` < `0.7063` → IC=+0.227 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7063 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.008` → IC=+0.193 (n=771)
...
- **PATRÓN** `volumen_regimen` > `1.0858` → IC=+0.248 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0858 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` < `0.1063` → IC=+0.129 (n=907)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1063 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.31` → IC=+0.162 (n=131)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.31 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `2.554` → IC=+0.132 (n=841)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 2.554 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `1.4734` → IC=+0.131 (n=955)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4734 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.2105` → IC=+0.127 (n=1299)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.2105 (IC base=+0.031)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4155` → IC=+0.218 (n=271)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4155 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.243 (n=278)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.7257` → IC=+0.226 (n=250)
...
- **PATRÓN** `volumen_regimen` > `1.1116` → IC=+0.244 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1116 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` < `0.0779` → IC=+0.223 (n=233)
...
- **PATRÓN** `libro_liquidez` > `11871.8913` → IC=+0.232 (n=181)
...
- **FILTRO** `ibs_20min` < `0.4437` → IC=-0.140 (n=273)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4437
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=273)

- **FILTRO** `sigma_h` > `0.0119` → IC=-0.150 (n=255)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0119
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=766)

- **FILTRO** `ibs_20min` > `0.7692` → IC=-0.164 (n=251)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.515` → IC=-0.171 (n=168)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=853)

- **PATRÓN** `dist_vwap_pct` < `0.1852` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1852 (IC base=-0.066)

- **PATRÓN** `volumen_regimen` > `0.9484` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9484 (IC base=-0.066)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.146 (n=775)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.324` → IC=+0.124 (n=1327)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 2.324 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.1718` → IC=+0.195 (n=260)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.1718 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` < `0.1155` → IC=+0.158 (n=992)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.1155 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.2483` → IC=+0.214 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2483 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `1.5017` → IC=+0.166 (n=342)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5017 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` > `2.9207` → IC=+0.172 (n=342)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.9207 (IC base=+0.052)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.277 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.166 (n=1059)
...
- **PATRÓN** `dist_vwap_pct` < `0.1309` → IC=+0.194 (n=596)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.1309 (IC base=+0.035)

- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.202 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6271 (IC base=+0.035)

- **PATRÓN** `volumen_pendiente_norm` > `0.2486` → IC=+0.340 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2486 (IC base=+0.035)

- **PATRÓN** `volumen_spike_ratio` > `2.9495` → IC=+0.287 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9495 (IC base=+0.035)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.253 (n=294)
...
- **FILTRO** `ibs_20min` < `0.5111` → IC=-0.146 (n=255)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5111
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=255)
...
- **PATRÓN** `volumen_regimen` > `1.1463` → IC=+0.153 (n=47)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1463 (IC base=-0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.2585` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2585 (IC base=-0.010)

- **PATRÓN** `volumen_spike_ratio` < `1.4704` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4704 (IC base=-0.010)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.184 (n=93)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 80.0 (IC base=-0.010)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.118` → IC=+0.268 (n=283)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0805` → IC=+0.208 (n=396)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2494` → IC=+0.221 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2494 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.223 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2507.3695` → IC=+0.218 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2507.3695 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.277 (n=316)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.007 (IC base=+0.263)

- **PATRÓN** `sigma_h` > `0.0146` → IC=+0.263 (n=158)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0146 (IC base=+0.263)

- **PATRÓN** `drift_60min` |x|≤ `0.3852` → IC=+0.273 (n=416)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.265 (n=168)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.263)

- **PATRÓN** `ibs_20min` < `0.2766` → IC=+0.325 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2766 (IC base=+0.263)

- **PATRÓN** `dist_vwap_pct` < `0.2281` → IC=+0.275 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2281 (IC base=+0.263)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.487` → IC=+0.291 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.487 (IC base=+0.263)

- **PATRÓN** `volumen_regimen` > `0.7147` → IC=+0.281 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7147 (IC base=+0.263)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.348 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.263)

- **PATRÓN** `volumen_spike_ratio` > `2.1844` → IC=+0.277 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1844 (IC base=+0.263)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.241 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 39.0 (IC base=+0.263)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.203 (n=664)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0089 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=2067)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.901` → IC=+0.257 (n=1327)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.901 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.7461` → IC=+0.242 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7461 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.107` → IC=+0.257 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.107 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `0.6987` → IC=+0.172 (n=1200)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6987 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1042` → IC=+0.181 (n=700)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1042 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.3331` → IC=+0.150 (n=1537)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.3331 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.8902` → IC=+0.143 (n=1164)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8902 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.166 (n=1580)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `2446.4744` → IC=+0.177 (n=1327)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2446.4744 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.187 (n=791)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 131.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.205 (n=1532)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.3441` → IC=+0.195 (n=1738)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.3441 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.213 (n=803)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` < `0.3974` → IC=+0.245 (n=1738)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3974 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.3292` → IC=+0.179 (n=1515)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3292 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.752` → IC=+0.200 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.752 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` < `1.1795` → IC=+0.164 (n=1438)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1795 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `0.8554` → IC=+0.179 (n=959)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 0.8554 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.2479` → IC=+0.226 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2479 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` < `1.8969` → IC=+0.183 (n=755)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.8969 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.7301` → IC=+0.205 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7301 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.198 (n=465)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 60.0 (IC base=+0.186)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.195 (n=316)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.004 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.2097` → IC=+0.184 (n=315)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.2097 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=323)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 7.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.377` → IC=+0.192 (n=358)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.377 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.1503` → IC=+0.179 (n=359)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.1503 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.678` → IC=+0.230 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.678 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6392` → IC=+0.238 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6392 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1012` → IC=+0.206 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1012 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.6113` → IC=+0.164 (n=251)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.6113 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4262` → IC=+0.144 (n=251)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4262 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `248.0` → IC=+0.149 (n=55)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 248.0 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.226 (n=261)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0096 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.1344` → IC=+0.218 (n=115)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4362` → IC=+0.257 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4362 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.1644` → IC=+0.224 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1644 (IC base=+0.193)
...
- **PATRÓN** `volumen_regimen` > `0.6366` → IC=+0.219 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6366 (IC base=+0.193)

- **PATRÓN** `volumen_pendiente_norm` > `0.101` → IC=+0.261 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.101 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` < `1.4661` → IC=+0.221 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4661 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` > `2.4523` → IC=+0.233 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4523 (IC base=+0.193)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.193 (n=291)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.01 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `9553.6554` → IC=+0.208 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9553.6554 (IC base=+0.193)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.174 (n=173)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 196.0 (IC base=+0.193)
...
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.183 (n=178)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0092 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=404)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.8621` → IC=+0.220 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8621 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.6618` → IC=+0.262 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6618 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.885` → IC=+0.269 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.885 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` > `0.6804` → IC=+0.134 (n=350)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6804 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.1` → IC=+0.137 (n=133)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` > 0.1 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2751.5045` → IC=+0.200 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2751.5045 (IC base=+0.110)

- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.209 (n=115)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0047 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.202 (n=166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.4362` → IC=+0.225 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4362 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.6212` → IC=+0.136 (n=86)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.6212 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.217` → IC=+0.125 (n=307)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.217 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.498` → IC=+0.148 (n=52)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 7.498 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` > `0.853` → IC=+0.154 (n=229)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.853 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2675` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2675 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.1018` → IC=+0.177 (n=97)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.1018 (IC base=+0.112)
...
- **PATRÓN** `libro_liquidez` > `2644.2167` → IC=+0.183 (n=156)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 2644.2167 (IC base=+0.112)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0268` → IC=+0.219 (n=144)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0268 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.1498` → IC=+0.182 (n=190)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.1498 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.190 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 17.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.172 (n=196)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 7.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.8014` → IC=+0.225 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8014 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `1.6023` → IC=+0.240 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6023 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.956` → IC=+0.243 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.956 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2275` → IC=+0.171 (n=430)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.2275 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.8384` → IC=+0.182 (n=287)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.8384 (IC base=+0.168)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2016` → IC=+0.181 (n=346)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.2016 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8289` → IC=+0.178 (n=262)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.8289 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=478)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2512.7673` → IC=+0.171 (n=384)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2512.7673 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.273 (n=174)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.230)

- **PATRÓN** `drift_60min` |x|≤ `0.4823` → IC=+0.234 (n=396)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4823 (IC base=+0.230)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.241 (n=191)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.230)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.257 (n=191)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.230)

- **PATRÓN** `ibs_20min` < `0.1272` → IC=+0.323 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1272 (IC base=+0.230)

- **PATRÓN** `dist_vwap_pct` < `0.9685` → IC=+0.240 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9685 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.735` → IC=+0.266 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.735 (IC base=+0.230)

- **PATRÓN** `volumen_regimen` > `0.8714` → IC=+0.274 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8714 (IC base=+0.230)

- **PATRÓN** `volumen_pendiente_norm` > `0.2921` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2921 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` > `2.7905` → IC=+0.261 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7905 (IC base=+0.230)

- **PATRÓN** `libro_liquidez` > `2539.7275` → IC=+0.229 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2539.7275 (IC base=+0.230)

- **PATRÓN** `ballena_activa_n` < `31.0` → IC=+0.192 (n=183)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 31.0 (IC base=+0.230)
...
- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.133 (n=194)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2632 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.567` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.567 (IC base=+0.045)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.362 (n=27)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.085)

- **PATRÓN** `drift_60min` |x|≤ `0.2474` → IC=+0.173 (n=53)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.2474 (IC base=+0.085)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.244 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.085)

- **PATRÓN** `ibs_20min` < `0.5743` → IC=+0.151 (n=61)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5743 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.025` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.025 (IC base=+0.085)

- **PATRÓN** `volumen_regimen` < `0.6982` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6982 (IC base=+0.085)

- **PATRÓN** `libro_liquidez` > `9493.103` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9493.103 (IC base=+0.085)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.209 (n=762)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.161 (n=1169)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 15.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.9483` → IC=+0.285 (n=1036)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9483 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `1.024` → IC=+0.242 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.024 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.406` → IC=+0.231 (n=1401)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.406 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.7083` → IC=+0.148 (n=688)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7083 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.2452` → IC=+0.148 (n=521)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.2452 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.177 (n=398)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.9203` → IC=+0.151 (n=1315)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.9203 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=1809)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `3459.4766` → IC=+0.183 (n=762)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 3459.4766 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.191 (n=803)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3947` → IC=+0.201 (n=2055)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3947 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.194 (n=769)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 17.0 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.188 (n=996)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 7.0 (IC base=+0.187)

- **PATRÓN** `ibs_20min` < `0.5413` → IC=+0.242 (n=2055)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5413 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.675` → IC=+0.177 (n=1660)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.675 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.371` → IC=+0.202 (n=374)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.371 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.601` → IC=+0.193 (n=1928)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.601 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` < `0.6181` → IC=+0.175 (n=525)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6181 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` > `1.1856` → IC=+0.179 (n=525)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 1.1856 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` > `0.1667` → IC=+0.234 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1667 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` > `2.2679` → IC=+0.195 (n=618)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.2679 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `34.0` → IC=+0.145 (n=418)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 34.0 (IC base=+0.187)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.171 (n=150)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0029 (IC base=+0.155)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.184 (n=153)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0054 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=352)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.3307` → IC=+0.218 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3307 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.2301` → IC=+0.241 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2301 (IC base=+0.155)
...
- **PATRÓN** `volumen_regimen` < `0.6608` → IC=+0.170 (n=113)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.6608 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `1.1267` → IC=+0.177 (n=153)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.1267 (IC base=+0.155)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5664` → IC=+0.192 (n=290)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.5664 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.3679` → IC=+0.195 (n=290)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.3679 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `11088.6716` → IC=+0.196 (n=225)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 11088.6716 (IC base=+0.155)
...
- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.143 (n=337)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0086 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.1293` → IC=+0.136 (n=149)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.1293 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.157 (n=307)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` > `0.3557` → IC=+0.199 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3557 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.9611` → IC=+0.196 (n=77)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.9611 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.539` → IC=+0.191 (n=166)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 4.539 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.9132` → IC=+0.161 (n=225)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.9132 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `1.2091` → IC=+0.161 (n=113)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.2091 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.2719` → IC=+0.300 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2719 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.4212` → IC=+0.209 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4212 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `4224.1911` → IC=+0.196 (n=225)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 4224.1911 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `233.0` → IC=+0.181 (n=211)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4348` → IC=+0.147 (n=276)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.4348 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.165 (n=195)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 11.0 (IC base=+0.129)

- **PATRÓN** `ibs_20min` < `0.0606` → IC=+0.226 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0606 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.7345` → IC=+0.147 (n=290)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.7345 (IC base=+0.129)
...
- **PATRÓN** `volumen_regimen` < `0.5823` → IC=+0.160 (n=92)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.5823 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` > `0.6243` → IC=+0.129 (n=246)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.6243 (IC base=+0.129)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1688` → IC=+0.179 (n=194)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.1688 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `4254.0588` → IC=+0.140 (n=184)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 4254.0588 (IC base=+0.129)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.211 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 135.0 (IC base=+0.129)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.165 (n=180)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0086 (IC base=+0.079)
...
- **PATRÓN** `dist_vwap_pct` > `0.6975` → IC=+0.236 (n=108)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6975 (IC base=+0.079)
...
- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.172 (n=172)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 69.0 (IC base=+0.079)

- **PATRÓN** `sigma_h` < `0.005` → IC=+0.194 (n=132)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.005 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=183)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 15.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` < `0.5758` → IC=+0.188 (n=389)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5758 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` < `0.448` → IC=+0.134 (n=350)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.448 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.086` → IC=+0.128 (n=372)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.086 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` > `1.0525` → IC=+0.131 (n=177)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 1.0525 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` > `0.0706` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.0706 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` > `1.4249` → IC=+0.161 (n=243)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4249 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `1444.9583` → IC=+0.151 (n=259)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1444.9583 (IC base=+0.108)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0131` → IC=+0.226 (n=224)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0131 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.0996` → IC=+0.177 (n=165)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.0996 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=514)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.9733` → IC=+0.301 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9733 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.1743` → IC=+0.241 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1743 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.369` → IC=+0.246 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.369 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.6191` → IC=+0.189 (n=165)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6191 (IC base=+0.169)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8925` → IC=+0.167 (n=295)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.8925 (IC base=+0.169)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.181 (n=544)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2639.8541` → IC=+0.179 (n=328)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2639.8541 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.226 (n=224)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3884` → IC=+0.234 (n=475)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3884 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.223 (n=497)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` < `0.4875` → IC=+0.282 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4875 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` < `0.6843` → IC=+0.225 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6843 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.017` → IC=+0.254 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.017 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.947` → IC=+0.218 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.947 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.8842` → IC=+0.235 (n=360)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6664` → IC=+0.218 (n=122)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6664 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.155 (n=256)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 37.0 (IC base=+0.210)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.157 (n=497)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.151 (n=84)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 16.0 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` > `0.257` → IC=+0.165 (n=153)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.257 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` > `1.1342` → IC=+0.156 (n=91)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.1342 (IC base=+0.061)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.204 (n=258)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.2985` → IC=+0.162 (n=338)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.2985 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` < `0.6004` → IC=+0.173 (n=338)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6004 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.7` → IC=+0.167 (n=100)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.7 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.3354` → IC=+0.152 (n=366)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3354 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.408` → IC=+0.170 (n=186)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 3.408 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.3482` → IC=+0.164 (n=385)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.3482 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6531` → IC=+0.150 (n=384)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6531 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` < `0.0976` → IC=+0.150 (n=332)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0976 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.0772` → IC=+0.160 (n=198)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0772 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.6668` → IC=+0.181 (n=381)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.6668 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.4358` → IC=+0.147 (n=381)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4358 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.157 (n=497)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `7022.3118` → IC=+0.174 (n=384)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7022.3118 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.193 (n=213)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0046 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.0673` → IC=+0.199 (n=71)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.0673 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` < `0.0969` → IC=+0.229 (n=94)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0969 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.4808` → IC=+0.154 (n=53)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.4808 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.2814` → IC=+0.155 (n=221)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.2814 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.584` → IC=+0.153 (n=99)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.046` → IC=+0.157 (n=208)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.046 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.3181` → IC=+0.170 (n=213)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.3181 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.906` → IC=+0.160 (n=142)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.906 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.0824` → IC=+0.179 (n=104)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.0824 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.7111` → IC=+0.170 (n=213)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.7111 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `9960.3992` → IC=+0.156 (n=213)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 9960.3992 (IC base=+0.146)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `hora_utc` > `19.0` → IC=+0.278 (n=25)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.069)

- **PATRÓN** `dist_vwap_pct` > `1.5243` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.5243 (IC base=+0.069)

- **PATRÓN** `libro_liquidez` > `7271.563` → IC=+0.136 (n=75)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 7271.563 (IC base=+0.069)

- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.287 (n=45)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.2358` → IC=+0.243 (n=68)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2358 (IC base=+0.191)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.210 (n=91)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 13.0 (IC base=+0.191)

- **PATRÓN** `ibs_20min` < `0.6855` → IC=+0.199 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6855 (IC base=+0.191)

- **PATRÓN** `ibs_20min` > `0.1608` → IC=+0.250 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1608 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` < `0.148` → IC=+0.206 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.148 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.306` → IC=+0.263 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.306 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` < `1.2459` → IC=+0.238 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2459 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` < `0.122` → IC=+0.228 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.122 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` < `2.2541` → IC=+0.264 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2541 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `9521.2349` → IC=+0.250 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9521.2349 (IC base=+0.191)
...
- **PATRÓN** `libro_liquidez` > `2553.7488` → IC=+0.180 (n=73)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2553.7488 (IC base=+0.100)
...
- **PATRÓN** `libro_liquidez` > `2221.671` → IC=+0.135 (n=50)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 2221.671 (IC base=+0.005)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.157 (n=561)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=1747)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.237 (n=553)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1713)

- **FILTRO** `ibs_20min` > `0.2774` → IC=-0.206 (n=566)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2774
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=1700)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.164 (n=147)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=191)

- **FILTRO** `ibs_20min` < `0.7265` → IC=-0.186 (n=84)
...
- **FILTRO** `py_entrada` > `0.56` → IC=-0.258 (n=89)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.175 (n=112)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.201 (n=125)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=258)

- **FILTRO** `ibs_20min` > `0.2846` → IC=-0.197 (n=130)
...
- **FILTRO** `drift_20min_pct` |x|> `0.1566` → IC=-0.124 (n=232)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.151 (n=1242)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4388)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.280 (n=1349)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=4281)

- **FILTRO** `ibs_7min` < `0.7413` → IC=-0.229 (n=1407)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7413
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4223)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.180 (n=1873)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3757)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.218 (n=1697)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=5229)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=192)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=589)

- **FILTRO** `ibs_7min` < `0.9776` → IC=-0.185 (n=515)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9776
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=266)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.226 (n=195)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=586)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.239 (n=270)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=848)

- **FILTRO** `drift_7min_pct` |x|> `0.1396` → IC=-0.165 (n=380)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1396
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=738)

- **FILTRO** `ibs_7min` > `0.2951` → IC=-0.186 (n=380)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2951
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=738)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.252 (n=272)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=903)

- **FILTRO** `ballena_activa_n` > `130.0` → IC=-0.171 (n=293)

  - _Acción_: SKIP cuando `ballena_activa_n` > 130.0
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=882)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.181 (n=302)

  - _Acción_: SKIP cuando `py_entrada` > 0.52
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=912)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.210 (n=222)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=550)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.340 (n=186)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=586)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.280 (n=193)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=579)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.284 (n=188)
...
- **FILTRO** `ibs_7min` > `0.2785` → IC=-0.159 (n=405)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2785
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=789)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.194 (n=207)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=747)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.273 (n=223)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=731)

- **FILTRO** `ibs_7min` < `0.7803` → IC=-0.200 (n=238)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7803
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=716)

- **FILTRO** `ballena_activa_n` > `42.0` → IC=-0.211 (n=237)

  - _Acción_: SKIP cuando `ballena_activa_n` > 42.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=717)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.298 (n=241)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=727)

- **FILTRO** `ibs_7min` > `0.1751` → IC=-0.159 (n=329)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1751
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=639)

- **FILTRO** `ballena_activa_n` > `36.0` → IC=-0.205 (n=239)

  - _Acción_: SKIP cuando `ballena_activa_n` > 36.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=729)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.214 (n=253)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=780)

- **FILTRO** `ibs_7min` < `0.7759` → IC=-0.192 (n=258)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7759
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=775)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.213 (n=256)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=777)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.170 (n=307)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=951)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.271 (n=225)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=690)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.226 (n=217)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=698)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.220 (n=223)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=692)
...
- **FILTRO** `ibs_7min` > `0.8039` → IC=-0.131 (n=293)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8039
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=881)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.126 (n=394)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=780)
...
- **FILTRO** `drift_15min` |x|> `0.5689` → IC=-0.162 (n=69)
...
- **FILTRO** `sigma_h` > `0.0089` → IC=-0.147 (n=745)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.699` → IC=-0.199 (n=294)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=1898)

- **PATRÓN** `ibs_15` > `0.4359` → IC=+0.147 (n=264)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.73€ cuando `ibs_15` > 0.4359 (IC base=-0.053)
...
- **FILTRO** `sigma_h` > `0.0031` → IC=-0.123 (n=67)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.238 (n=120)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.200 (n=368)

- **FILTRO** `sigma_ewma_delta_pct` > `25.189` → IC=-0.253 (n=79)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 25.189
  - _Potencial_: sin este filtro IC_bueno=-0.201 (n=409)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2968` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2968 (IC base=+0.003)

- **PATRÓN** `ibs_15` > `0.3768` → IC=+0.136 (n=108)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.68€ cuando `ibs_15` > 0.3768 (IC base=+0.003)

- **PATRÓN** `dist_vwap_pct` > `0.728` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.728 (IC base=+0.003)

- **PATRÓN** `libro_liquidez` > `10408.2229` → IC=+0.237 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10408.2229 (IC base=+0.003)
...
- **FILTRO** `sigma_h` > `0.0073` → IC=-0.225 (n=67)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0073
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=131)

- **FILTRO** `sigma_ewma_delta_pct` > `12.226` → IC=-0.180 (n=123)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 12.226
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=645)

- **PATRÓN** `ibs_15` > `0.8125` → IC=+0.206 (n=15)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8125 (IC base=-0.070)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `sigma_h` < `0.0051` → IC=-0.160 (n=51)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0051
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=154)
...
- **FILTRO** `sigma_ewma_delta_pct` > `15.17` → IC=-0.222 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=628)

### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0024` → IC=+0.266 (n=62)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0024 (IC base=+0.262)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.266 (n=62)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0055 (IC base=+0.262)

- **PATRÓN** `drift_60min` |x|≤ `0.1898` → IC=+0.275 (n=185)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1898 (IC base=+0.262)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0599` → IC=+0.281 (n=185)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0599 (IC base=+0.262)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3963` → IC=+0.307 (n=81)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.264 (n=189)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.262)

- **PATRÓN** `ibs_15` > `0.8311` → IC=+0.302 (n=185)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8311 (IC base=+0.262)

- **PATRÓN** `dist_vwap_pct` > `0.2755` → IC=+0.337 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2755 (IC base=+0.262)

- **PATRÓN** `dist_vwap_pct` < `0.0994` → IC=+0.263 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0994 (IC base=+0.262)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.042` → IC=+0.270 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.042 (IC base=+0.262)

- **PATRÓN** `sigma_ewma_delta_pct` < `19.469` → IC=+0.267 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 19.469 (IC base=+0.262)

- **PATRÓN** `libro_liquidez` > `9958.5281` → IC=+0.291 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9958.5281 (IC base=+0.262)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.288 (n=83)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0072 (IC base=+0.277)

- **PATRÓN** `drift_60min` |x|≤ `0.157` → IC=+0.273 (n=73)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.157 (IC base=+0.277)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1898` → IC=+0.350 (n=38)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1898 (IC base=+0.277)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3048` → IC=+0.354 (n=39)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.277 (n=83)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.277)

- **PATRÓN** `ibs_15` > `0.8687` → IC=+0.329 (n=74)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8687 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.6362` → IC=+0.405 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6362 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.888` → IC=+0.291 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.888 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.463` → IC=+0.273 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.463 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.283 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `9979.9504` → IC=+0.400 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9979.9504 (IC base=+0.277)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.342 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 123.0 (IC base=+0.277)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_YES, IBS > 0.8125 sube el IC de -0.070 a +0.206 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=15). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8311 sube el IC de +0.262 a +0.302 en UPDOWN_GBM_IBS_ALTO (n=185). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8687 sube el IC de +0.277 a +0.329 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=74). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 5756 | -0.098 | -674.75€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 618 | -0.082 | -107.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5138 | -0.100 | -567.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 840 | -0.021 | -100.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 840 | -0.021 | -100.06€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1861 | -0.063 | -56.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1861 | -0.063 | -56.51€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1353 | -0.170 | -217.43€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1353 | -0.170 | -217.43€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 25694 | +0.113 | -1753.95€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5016 | +0.185 | -178.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 17594 | +0.092 | -1514.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2978 | +0.125 | -12.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2958 | +0.059 | -535.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 18 | -0.045 | +2.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2935 | +0.061 | -531.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5411 | +0.135 | -117.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1401 | +0.194 | -88.36€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2927 | +0.110 | -68.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1041 | +0.134 | +60.92€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2962 | +0.073 | -424.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 18 | +0.045 | -1.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2943 | +0.074 | -420.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 5819 | +0.129 | -55.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1829 | +0.169 | -4.52€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2927 | +0.114 | -35.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1051 | +0.109 | -7.16€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5585 | +0.128 | -413.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1734 | +0.202 | -86.40€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2920 | +0.084 | -253.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 886 | +0.133 | -65.78€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2959 | +0.107 | -206.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 16 | +0.000 | +0.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2942 | +0.108 | -205.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5030 | +0.176 | -371.46€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5030 | +0.176 | -371.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1262 | +0.172 | -126.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1262 | +0.172 | -126.58€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1260 | +0.162 | -147.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1260 | +0.162 | -147.53€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1125 | +0.231 | -31.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1125 | +0.231 | -31.86€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1202 | +0.192 | -81.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1202 | +0.192 | -81.34€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 253 | +0.437 | -1.45€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 253 | +0.437 | -1.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 92 | +0.436 | +0.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 92 | +0.436 | +0.34€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 12634 | +0.192 | -1116.41€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 12634 | +0.192 | -1116.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2339 | +0.124 | -440.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2339 | +0.124 | -440.85€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1951 | +0.234 | -51.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1951 | +0.234 | -51.97€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2200 | +0.159 | -298.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2200 | +0.159 | -298.01€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 1996 | +0.237 | -44.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 1996 | +0.237 | -44.67€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2016 | +0.224 | -83.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2016 | +0.224 | -83.94€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2132 | +0.191 | -196.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2132 | +0.191 | -196.96€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 4524 | +0.131 | +109.87€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 4524 | +0.131 | +109.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2245 | +0.141 | +96.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2245 | +0.141 | +96.87€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2279 | +0.120 | +13.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2279 | +0.120 | +13.00€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 688 | +0.303 | +10.61€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 688 | +0.303 | +10.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 294 | +0.277 | -9.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 294 | +0.277 | -9.07€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 321 | +0.305 | +10.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 321 | +0.305 | +10.66€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 288 | +0.410 | -13.87€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 288 | +0.410 | -13.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC | 128 | +0.408 | -6.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min | 128 | +0.408 | -6.69€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 140 | +0.099 | -0.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 44 | +0.087 | -1.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 96 | +0.102 | +0.23€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 113 | +0.109 | +1.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 17 | +0.112 | +1.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 96 | +0.102 | +0.23€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 3837 | +0.099 | -146.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 395 | +0.049 | -26.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 3442 | +0.104 | -119.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 2645 | +0.098 | -72.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 395 | +0.049 | -26.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 2250 | +0.106 | -45.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1192 | +0.101 | -73.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1192 | +0.101 | -73.97€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 6348 | +0.046 | +1934.20€ | 0 | 18 |
| ✅ GBM_LATE_15M#15min | 6348 | +0.046 | +1934.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 843 | +0.176 | +534.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 843 | +0.176 | +534.73€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 858 | +0.166 | +458.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 858 | +0.166 | +458.40€ | 0 | 28 |
| ✅ GBM_LATE_15M#DOGE | 853 | +0.191 | +587.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 853 | +0.191 | +587.35€ | 0 | 18 |
| ✅ GBM_LATE_15M#ETH | 1001 | -0.057 | -12.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1001 | -0.057 | -12.47€ | 4 | 3 |
| ✅ GBM_LATE_15M#SOL | 1226 | -0.036 | +150.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1226 | -0.036 | +150.16€ | 3 | 3 |
| ✅ GBM_LATE_15M#XRP | 1567 | -0.039 | +216.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1567 | -0.039 | +216.02€ | 4 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 7302 | +0.042 | +2739.61€ | 0 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 7302 | +0.042 | +2739.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1126 | -0.028 | +510.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1126 | -0.028 | +510.46€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1587 | -0.037 | +148.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1587 | -0.037 | +148.99€ | 0 | 2 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1337 | -0.012 | +277.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1337 | -0.012 | +277.14€ | 3 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1256 | +0.234 | +1130.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1256 | +0.234 | +1130.33€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 4971 | +0.170 | +3375.33€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 4971 | +0.170 | +3375.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 634 | +0.193 | +466.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 634 | +0.193 | +466.11€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 826 | +0.159 | +519.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 826 | +0.159 | +519.14€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 630 | +0.201 | +486.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 630 | +0.201 | +486.64€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 803 | +0.168 | +521.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 803 | +0.168 | +521.92€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 978 | +0.111 | +524.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 978 | +0.111 | +524.92€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 1100 | +0.198 | +856.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 1100 | +0.198 | +856.60€ | 0 | 26 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 810 | +0.067 | +121.93€ | 0 | 10 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 810 | +0.067 | +121.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 205 | +0.094 | +54.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 205 | +0.094 | +54.11€ | 3 | 16 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 180 | +0.170 | +57.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 180 | +0.170 | +57.48€ | 0 | 19 |
...
| ✅ GBM_LATE_15M_TARDIO | 5786 | +0.162 | +3656.68€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5786 | +0.162 | +3656.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 807 | +0.182 | +553.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 807 | +0.182 | +553.90€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 944 | +0.158 | +561.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 944 | +0.158 | +561.42€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 798 | +0.216 | +655.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 798 | +0.216 | +655.60€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 816 | +0.131 | +403.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 816 | +0.131 | +403.42€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1046 | +0.093 | +481.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1046 | +0.093 | +481.24€ | 0 | 16 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1375 | +0.191 | +1001.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1375 | +0.191 | +1001.10€ | 0 | 25 |
| ✅ GBM_LATE_5M | 790 | +0.116 | +336.56€ | 1 | 19 |
| ✅ GBM_LATE_5M#5min | 790 | +0.116 | +336.56€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 327 | +0.135 | +191.77€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 327 | +0.135 | +191.77€ | 2 | 20 |
| ✅ GBM_LATE_5M#DOGE | 13 | -0.108 | -4.42€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 13 | -0.108 | -4.42€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH | 234 | +0.140 | +91.82€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 234 | +0.140 | +91.82€ | 0 | 14 |
...
| ✅ LEADLAG_BTC_XRP_15M | 222 | +0.098 | +45.41€ | 0 | 3 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 222 | +0.098 | +45.41€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 222 | +0.098 | +45.41€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 222 | +0.098 | +45.41€ | 0 | 3 |
...
| ✅ MOMENTUM_IBS_15M | 3157 | +0.002 | -41.28€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 3157 | +0.002 | -41.28€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 286 | +0.010 | +9.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 286 | +0.010 | +9.84€ | 1 | 1 |
| ✅ MOMENTUM_IBS_15M#BTC | 590 | +0.005 | -8.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 590 | +0.005 | -8.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 498 | +0.002 | -16.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 498 | +0.002 | -16.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 606 | +0.011 | +15.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 606 | +0.011 | +15.89€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 563 | -0.010 | -25.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 563 | -0.010 | -25.74€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 614 | -0.002 | -16.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 614 | -0.002 | -16.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 4574 | -0.033 | +149.30€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 4574 | -0.033 | +149.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 716 | -0.039 | +72.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 716 | -0.039 | +72.43€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 822 | -0.028 | -18.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 822 | -0.028 | -18.01€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 726 | -0.032 | +114.24€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 726 | -0.032 | +114.24€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 823 | -0.022 | -16.92€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 823 | -0.022 | -16.92€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 746 | -0.050 | +4.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 746 | -0.050 | +4.67€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 741 | -0.029 | -7.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 741 | -0.029 | -7.11€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_5M | 2328 | +0.006 | +4.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 2328 | +0.006 | +4.75€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#ETH | 653 | +0.018 | +14.73€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#ETH#5min | 653 | +0.018 | +14.73€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL | 1050 | +0.008 | +0.94€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 1050 | +0.008 | +0.94€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 12556 | -0.070 | +293.05€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 12556 | -0.070 | +293.05€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 1899 | -0.092 | +241.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 1899 | -0.092 | +241.79€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 2389 | -0.053 | +20.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 2389 | -0.053 | +20.32€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 1966 | -0.082 | +43.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 1966 | -0.082 | +43.56€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 1922 | -0.099 | -176.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 1922 | -0.099 | -176.58€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 2291 | -0.046 | +41.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 2291 | -0.046 | +41.89€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 2089 | -0.056 | +122.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 2089 | -0.056 | +122.08€ | 6 | 0 |
...
| ✅ STREAK_FADE_5M | 778 | -0.004 | -24.77€ | 1 | 0 |
| ✅ STREAK_FADE_5M#5min | 778 | -0.004 | -24.77€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE | 260 | +0.011 | -1.73€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE#5min | 260 | +0.011 | -1.73€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 161 | -0.052 | -14.28€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 161 | -0.052 | -14.28€ | 4 | 0 |
...
| ✅ STREAK_MOM_5M | 1498 | +0.017 | +13.12€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 1498 | +0.017 | +13.12€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 490 | +0.016 | +0.50€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 490 | +0.016 | +0.50€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 260 | +0.000 | -2.21€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 260 | +0.000 | -2.21€ | 2 | 0 |
| ✅ STREAK_MOM_5M#SOL | 454 | +0.011 | -2.16€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 454 | +0.011 | -2.16€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP | 294 | +0.044 | +16.98€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 294 | +0.044 | +16.98€ | 2 | 4 |
| ✅ STRUCT_NO_15M | 2723 | +0.002 | -42.68€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 2723 | +0.002 | -42.68€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1044 | +0.004 | -15.09€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1044 | +0.004 | -15.09€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1047 | +0.007 | -10.80€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1047 | +0.007 | -10.80€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 632 | -0.011 | -16.80€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 632 | -0.011 | -16.80€ | 2 | 0 |
| ✅ UPDOWN_GBM | 4674 | +0.011 | +137.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1840 | +0.048 | +173.95€ | 0 | 6 |
| ✅ UPDOWN_GBM#240min | 203 | +0.027 | +3.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 2254 | -0.013 | -34.97€ | 3 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 1051 | +0.016 | +21.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 487 | +0.042 | +28.87€ | 1 | 5 |
| ✅ UPDOWN_GBM#ETH#240min | 60 | +0.081 | +4.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 351 | -0.024 | -13.89€ | 4 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 138 | +0.021 | +3.10€ | 0 | 1 |
| 🚫 UPDOWN_GBM#ETH#daily | 15 | -0.154 | -0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 1085 | -0.005 | -12.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 409 | +0.006 | -3.34€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 46 | -0.042 | -4.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 534 | -0.002 | -2.99€ | 3 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3027 | -0.085 | +376.51€ | 4 | 3 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3027 | -0.085 | +376.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 251 | -0.081 | +115.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 251 | -0.081 | +115.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 623 | -0.167 | -79.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 623 | -0.167 | -79.20€ | 4 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 68 | +0.043 | +8.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 68 | +0.043 | +8.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 198 | +0.050 | +50.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 198 | +0.050 | +50.20€ | 2 | 15 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 966 | -0.065 | +179.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 966 | -0.065 | +179.52€ | 2 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 921 | -0.088 | +101.58€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 921 | -0.088 | +101.58€ | 6 | 0 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 246 | +0.262 | +156.81€ | 0 | 13 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 246 | +0.262 | +156.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 136 | +0.246 | +72.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 136 | +0.246 | +72.47€ | 0 | 11 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 110 | +0.277 | +84.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 110 | +0.277 | +84.34€ | 0 | 13 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.095) — sin ventaja clara. oversold(IBS<0.3): IC=-0.005 n=1600 | neutral: IC=+0.008 n=1713 | overbought(IBS>0.7): IC=+0.090 n=1889
  - _Datos_: n=5469 IC=+0.033 PNL=+372.90€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=409 IC=+0.006 PNL=-3.34€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.079 n=75802 | tras_1loss IC=+0.045 n=58551 | tras_2loss IC=+0.009 n=26555/40 | gap=+0.070 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 4612 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=41, boost estimado=-0.000. Necesita 0 más y boost>0.05
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.014 n=465 | contrario_BTC IC=+0.012 n=344/40 | gap=+0.025 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=4433 IC=+0.007 PNL=+86.43€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=4433 IC=+0.007 PNL=+86.43€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1091 IC=+0.036 PNL=+64.33€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1091 IC=+0.036 PNL=+64.33€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=1565 IC=-0.011 PNL=-35.26€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1565 IC=-0.011 PNL=-35.26€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1245 IC=+0.029 PNL=+82.62€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1245 IC=+0.029 PNL=+82.62€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=3230 IC=-0.127 PNL=+311.95€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3230 IC=-0.127 PNL=+311.95€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=491 IC=+0.003 PNL=+1.30€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=491 IC=+0.003 PNL=+1.30€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=529 PNL=+305.04€
  - _Datos_: n=529 IC=+0.091 PNL=+305.04€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.237 < -0.1 con n=325 PNL=-37.29€
  - _Datos_: n=325 IC=-0.237 PNL=-37.29€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=517 IC=-0.034 PNL=+12.99€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=517 IC=-0.034 PNL=+12.99€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=830 IC=-0.034 PNL=+118.13€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=830 IC=-0.034 PNL=+118.13€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.241 > 0.08 con n=1143 PNL=-108.93€
  - _Datos_: n=1143 IC=+0.241 PNL=-108.93€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2339 IC=+0.124 PNL=-440.85€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2339 IC=+0.124 PNL=-440.85€
