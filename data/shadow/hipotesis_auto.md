# Hipótesis automáticas — 2026-07-28 13:05 UTC
_Generado por shadow_postmortem.py sobre 40091 resoluciones (PNL=+8228.44€)_
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.191 (n=1244)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0075 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.163 (n=1740)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 7.0 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.6748` → IC=+0.198 (n=230)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.6748 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.392` → IC=+0.232 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.392 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `2416.2073` → IC=+0.137 (n=1512)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2416.2073 (IC base=+0.142)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.157 (n=1434)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0067 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.133 (n=1459)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.3917` → IC=+0.129 (n=340)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.3917 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.126` → IC=+0.149 (n=317)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 8.126 (IC base=+0.121)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.404` → IC=+0.145 (n=198)
...
- **PATRÓN** `sigma_h` < `0.0173` → IC=+0.248 (n=430)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0173 (IC base=+0.229)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.248 (n=391)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.125 (n=835)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0103 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `0.4559` → IC=+0.155 (n=334)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.4559 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.021` → IC=+0.231 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.021 (IC base=+0.095)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.062` → IC=+0.285 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.062 (IC base=+0.049)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.168 (n=486)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.2416` → IC=+0.230 (n=150)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2416 (IC base=+0.168)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6045` → IC=+0.174 (n=645)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.87€ cuando `ibs_15` > 0.6045 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.164 (n=236)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.055)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.225` → IC=+0.159 (n=212)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6045 sube el IC de +0.055 a +0.174 en UPDOWN_GBM#15min (n=645). Ya aplicado como kelly_boost=+0.87€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M_ESPACIO_ATR#BNB#15min` — IC=+0.305 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M_ESPACIO_ATR#BNB` — IC=+0.305 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
...
| ✅ GBM_LATE_15M | 8631 | +0.093 | +2562.18€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8631 | +0.093 | +2562.18€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 54 | +0.161 | +18.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 54 | +0.161 | +18.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2061 | +0.071 | +345.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2061 | +0.071 | +345.38€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 54 | +0.071 | +6.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 54 | +0.071 | +6.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1854 | +0.073 | +313.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1854 | +0.073 | +313.33€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2298 | +0.083 | +778.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2298 | +0.083 | +778.59€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2310 | +0.138 | +1100.29€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2310 | +0.138 | +1100.29€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5860 | +0.117 | +2736.43€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5860 | +0.117 | +2736.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 39 | +0.305 | +41.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 39 | +0.305 | +41.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1510 | +0.083 | +506.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1510 | +0.083 | +506.66€ | 0 | 4 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1447 | +0.083 | +553.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1447 | +0.083 | +553.84€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1310 | +0.216 | +1075.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1310 | +0.216 | +1075.82€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 5852 | +0.064 | +1509.73€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5852 | +0.064 | +1509.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 47 | +0.255 | +30.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 47 | +0.255 | +30.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1376 | +0.025 | +144.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1376 | +0.025 | +144.77€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 50 | +0.154 | +13.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 50 | +0.154 | +13.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1401 | +0.022 | +111.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1401 | +0.022 | +111.95€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1363 | +0.023 | +244.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1363 | +0.023 | +244.35€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1615 | +0.161 | +965.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1615 | +0.161 | +965.44€ | 0 | 12 |
...
| ✅ UPDOWN_GBM | 2971 | +0.035 | +266.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2707 | +0.051 | +305.29€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#ETH | 1121 | +0.037 | +74.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1027 | +0.050 | +85.58€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 198 | +0.305 | +41.01€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 198 | +0.305 | +41.01€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2255 | +0.149 | +977.64€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2255 | +0.149 | +977.64€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 429 | +0.159 | +151.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 429 | +0.159 | +151.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 531 | +0.085 | +130.43€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 531 | +0.085 | +130.43€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 636 | +0.169 | +376.02€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 636 | +0.169 | +376.02€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.166: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.070 n=1718 | neutral: IC=+0.021 n=1364 | overbought(IBS>0.7): IC=+0.187 n=1664
  - _Datos_: n=5059 IC=+0.102 PNL=+1309.82€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.110 n=23799 | tras_1loss IC=+0.078 n=16058 | tras_2loss IC=+0.053 n=6746/40 | gap=+0.056 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2834 IC=+0.039 PNL=+280.07€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2834 IC=+0.039 PNL=+280.07€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1135 IC=+0.055 PNL=+154.32€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1135 IC=+0.055 PNL=+154.32€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.089 > 0.08 con n=1426 PNL=+242.01€
  - _Datos_: n=1426 IC=+0.089 PNL=+242.01€
...
**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: n=433 IC=+0.056 PNL=+51.87€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=433 IC=+0.056 PNL=+51.87€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.241 > 0.08 con n=199 PNL=+40.60€
  - _Datos_: n=199 IC=+0.241 PNL=+40.60€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3809 IC=+0.064 PNL=+573.00€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3809 IC=+0.064 PNL=+573.00€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1285 IC=+0.031 PNL=+123.77€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1285 IC=+0.031 PNL=+123.77€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=1037 PNL=+347.38€
  - _Datos_: n=1037 IC=+0.159 PNL=+347.38€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1130 IC=+0.055 PNL=+120.88€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1130 IC=+0.055 PNL=+120.88€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.119 > 0.08 con n=731 PNL=+200.57€
  - _Datos_: n=731 IC=+0.119 PNL=+200.57€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.203 > 0.2 con n=726 PNL=+419.43€
  - _Datos_: n=726 IC=+0.203 PNL=+419.43€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.104 > 0.08 con n=615 PNL=+181.12€
  - _Datos_: n=615 IC=+0.104 PNL=+181.12€
