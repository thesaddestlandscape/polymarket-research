# Hipótesis automáticas — 2026-07-12 12:50 UTC
_Generado por shadow_postmortem.py sobre 10926 resoluciones (PNL=+1944.07€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.222 (n=293)
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.319 (n=147)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.219)

- **PATRÓN** `libro_liquidez` > `2363.0481` → IC=+0.233 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2363.0481 (IC base=+0.219)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 887 | +0.186 | +16.05€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 314 | +0.174 | +6.29€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 310 | +0.189 | +5.37€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6160 | tras_1loss IC=+0.044 n=4629 | tras_2loss IC=+0.011 n=2080/40 | gap=+0.080 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8468 IC=+0.096 PNL=+2019.95€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8468 IC=+0.096 PNL=+2019.95€
