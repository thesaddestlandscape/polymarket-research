# Hipótesis automáticas — 2026-07-10 19:12 UTC
_Generado por shadow_postmortem.py sobre 8011 resoluciones (PNL=+1185.99€)_
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=285)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0646` → IC=+0.138 (n=45)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.0646 (IC base=+0.034)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.151 (n=104)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 11.0 (IC base=+0.034)

- **PATRÓN** `ibs_15` < `0.9183` → IC=+0.139 (n=95)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.70€ cuando `ibs_15` < 0.9183 (IC base=+0.034)

- **PATRÓN** `ibs_15` > `0.8088` → IC=+0.146 (n=63)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.73€ cuando `ibs_15` > 0.8088 (IC base=+0.034)
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#BTC#15min` — IC=+0.250 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#ETH#15min` — IC=+0.258 n=31. Faltan ~9 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#SOL#15min` — IC=+0.118 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 144 | +0.185 | -3.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 93 | +0.216 | -1.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 23 | -0.020 | -4.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 24 | +0.231 | +2.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 46 | +0.188 | +0.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 30 | +0.250 | +1.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 7 | -0.058 | -2.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 8 | +0.080 | +0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 48 | +0.220 | +1.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 31 | +0.258 | +1.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 8 | +0.040 | -0.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 8 | +0.080 | +0.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 50 | +0.135 | -4.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 32 | +0.118 | -4.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 8 | +0.000 | -1.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 8 | +0.080 | +0.61€ | 0 | 0 |
| ✅ GBM_LATE_15M | 2967 | +0.114 | +955.39€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2967 | +0.114 | +955.39€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 747 | +0.061 | +75.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 747 | +0.061 | +75.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 755 | +0.075 | +120.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 755 | +0.075 | +120.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 765 | +0.148 | +396.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 765 | +0.148 | +396.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 700 | +0.174 | +362.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 700 | +0.174 | +362.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 413 | +0.163 | +170.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 413 | +0.163 | +170.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 102 | +0.192 | +47.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 102 | +0.192 | +47.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 112 | +0.158 | +46.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 112 | +0.158 | +46.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 117 | +0.063 | +11.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 117 | +0.063 | +11.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 82 | +0.262 | +65.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 82 | +0.262 | +65.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 513 | +0.065 | +83.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 513 | +0.065 | +83.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 123 | +0.084 | +11.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 123 | +0.084 | +11.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 129 | +0.011 | +3.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 129 | +0.011 | +3.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 128 | -0.046 | -2.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 128 | -0.046 | -2.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 133 | +0.204 | +71.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 133 | +0.204 | +71.35€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1228 | -0.016 | -6.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 973 | +0.013 | +30.92€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 327 | -0.005 | -8.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 249 | +0.034 | +4.61€ | 2 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 589 | +0.006 | +20.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 496 | +0.026 | +31.70€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.106) — sin ventaja clara. oversold(IBS<0.3): IC=-0.019 n=310 | neutral: IC=-0.061 n=235 | overbought(IBS>0.7): IC=+0.045 n=255
  - _Datos_: n=838 IC=-0.005 PNL=+19.20€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.073 n=4335 | tras_1loss IC=+0.026 n=3503 | tras_2loss IC=-0.013 n=1632/40 | gap=+0.086 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.049 n=368/40 PNL=+44.48€ | H=15h UTC: IC=+0.077 n=372/40 PNL=+80.14€ | H=17h UTC: IC=+0.128 n=307/40 PNL=+108.31€ | H=19h UTC: IC=+0.024 n=269/40 PNL=+24.64€
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.018 n=112 | contrario_BTC IC=-0.069 n=56/40 | gap=-0.051 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=195 IC=-0.008 PNL=+5.08€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=195 IC=-0.008 PNL=+5.08€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1105 IC=-0.010 PNL=+7.52€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1105 IC=-0.010 PNL=+7.52€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=546 IC=-0.002 PNL=-3.94€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=546 IC=-0.002 PNL=-3.94€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=249 IC=+0.034 PNL=+4.61€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=249 IC=+0.034 PNL=+4.61€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=481 IC=+0.034 PNL=+14.86€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=481 IC=+0.034 PNL=+14.86€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5553 IC=+0.083 PNL=+1261.87€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5553 IC=+0.083 PNL=+1261.87€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=693 IC=-0.034 PNL=-34.41€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=693 IC=-0.034 PNL=-34.41€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.1 con n=202 PNL=+66.31€
  - _Datos_: n=202 IC=+0.162 PNL=+66.31€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=134 IC=+0.051 PNL=+4.36€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=134 IC=+0.051 PNL=+4.36€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.167 > 0.08 con n=142 PNL=+42.31€
  - _Datos_: n=142 IC=+0.167 PNL=+42.31€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 59/80 ops en el filtro definido (IC actual=+0.238 PNL=+20.92€)
  - _Datos_: n=59 IC=+0.238 PNL=+20.92€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 57/100 ops en el filtro definido (IC actual=+0.314 PNL=+36.39€)
  - _Datos_: n=57 IC=+0.314 PNL=+36.39€
