# Hipótesis automáticas — 2026-07-15 14:05 UTC
_Generado por shadow_postmortem.py sobre 15405 resoluciones (PNL=+3032.53€)_
...
- **PATRÓN** `py_entrada` < `0.65` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.65 (IC base=+0.179)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2169 | +0.174 | -44.25€ | 0 | 10 |
...
| ✅ FAVORITO_CONFIRMADO#60min | 368 | +0.154 | +12.71€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 762 | +0.170 | -30.27€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 122 | +0.121 | -13.58€ | 0 | 4 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.099 n=8869 | tras_1loss IC=+0.061 n=6317 | tras_2loss IC=+0.029 n=2740/40 | gap=+0.070 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12947 IC=+0.102 PNL=+3108.42€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12947 IC=+0.102 PNL=+3108.42€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.263 > 0.08 con n=167 PNL=-2.23€
  - _Datos_: n=167 IC=+0.263 PNL=-2.23€
