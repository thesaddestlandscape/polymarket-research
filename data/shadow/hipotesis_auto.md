# Hipótesis automáticas — 2026-07-16 09:35 UTC
_Generado por shadow_postmortem.py sobre 16772 resoluciones (PNL=+3446.31€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=1058)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.01 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `4371.9525` → IC=+0.186 (n=604)
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.103 n=9763 | tras_1loss IC=+0.069 n=6800 | tras_2loss IC=+0.037 n=2904/40 | gap=+0.066 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=14314 IC=+0.106 PNL=+3522.20€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=14314 IC=+0.106 PNL=+3522.20€
