# Hipótesis automáticas — 2026-07-16 22:15 UTC
_Generado por shadow_postmortem.py sobre 17641 resoluciones (PNL=+3634.29€)_
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.292 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.179)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.183 (n=1141)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.01 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `4364.0743` → IC=+0.183 (n=651)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 4364.0743 (IC base=+0.179)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.190 (n=411)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.178 (n=1221)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `7415.7641` → IC=+0.186 (n=355)
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.247 (n=192)
...
- **PATRÓN** `libro_liquidez` > `7221.0845` → IC=+0.207 (n=206)
...
- **PATRÓN** `py_entrada` < `0.565` → IC=+0.190 (n=27)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.565 (IC base=+0.153)

- **PATRÓN** `py_entrada` > `0.605` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `py_entrada` > 0.605 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `6647.908` → IC=+0.167 (n=55)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 6647.908 (IC base=+0.153)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.209 (n=228)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `3761.3506` → IC=+0.209 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3761.3506 (IC base=+0.199)
...
- **PATRÓN** `py_entrada` < `0.595` → IC=+0.262 (n=40)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.595 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `5786.6763` → IC=+0.179 (n=26)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 5786.6763 (IC base=+0.179)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.178` → IC=+0.202 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.178 (IC base=+0.107)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `14.745` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 14.745 (IC base=+0.075)
...
- **PATRÓN** `dist_vwap_pct` > `0.6854` → IC=+0.154 (n=24)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.6854 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.476` → IC=+0.222 (n=52)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.148 (n=174)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` < `0.0307` → IC=+0.150 (n=466)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0307 (IC base=+0.147)

- **PATRÓN** `sigma_h` > `0.0244` → IC=+0.173 (n=212)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0244 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.152 (n=418)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.6854` → IC=+0.227 (n=31)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6854 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.1397` → IC=+0.122 (n=146)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.1397 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.281` → IC=+0.258 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.281 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.224 (n=356)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.170 (n=532)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3772` → IC=+0.212 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3772 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.98` → IC=+0.292 (n=104)
...
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.132 (n=188)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0028 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.167 (n=127)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 13.0 (IC base=+0.111)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.905` → IC=+0.186 (n=33)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 10.905 (IC base=+0.111)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.153 (n=148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3457` → IC=+0.187 (n=65)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.3457 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `1.1151` → IC=+0.130 (n=152)
...
- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.145 (n=74)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0093 (IC base=+0.137)

- **PATRÓN** `sigma_h` > `0.0125` → IC=+0.216 (n=100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0125 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.163 (n=81)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2465` → IC=+0.187 (n=65)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.2465 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.9751` → IC=+0.146 (n=176)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.9751 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.995` → IC=+0.274 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.995 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` < `0.0214` → IC=+0.276 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0214 (IC base=+0.253)

- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.253 (n=172)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `1.0058` → IC=+0.364 (n=20)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0058 (IC base=+0.253)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.801` → IC=+0.354 (n=39)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.192 (n=245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0152 (IC base=+0.114)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.133 (n=341)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 8.0 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.6722` → IC=+0.172 (n=120)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.6722 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.1434` → IC=+0.145 (n=316)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1434 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.981` → IC=+0.305 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.981 (IC base=+0.114)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.127 (n=73)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` < 0.0037 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` > `0.4306` → IC=+0.125 (n=22)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.4306 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` < `0.1146` → IC=+0.132 (n=74)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.1146 (IC base=+0.088)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.702` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 12.702 (IC base=+0.088)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.128 (n=84)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0047 (IC base=+0.053)
...
- **PATRÓN** `sigma_h` < `0.0333` → IC=+0.210 (n=222)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0333 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0115` → IC=+0.214 (n=222)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0115 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.230 (n=161)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 13.0 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `0.3553` → IC=+0.276 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3553 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.863` → IC=+0.262 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.863 (IC base=+0.204)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2720 | +0.174 | -63.52€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 1752 | +0.205 | -5.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 115 | +0.021 | -17.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 388 | +0.100 | -59.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 465 | +0.155 | +18.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 787 | +0.177 | -17.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 584 | +0.198 | -22.50€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 38 | +0.025 | -5.82€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 155 | +0.162 | +14.90€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#ETH | 969 | +0.173 | -7.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 581 | +0.207 | +7.48€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 38 | -0.050 | -10.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 195 | +0.114 | -22.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 155 | +0.175 | +18.39€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL | 955 | +0.172 | -36.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 578 | +0.210 | +11.89€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 39 | +0.085 | -0.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 183 | +0.105 | -33.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 155 | +0.124 | -14.92€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 9 | +0.021 | -2.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 9 | +0.021 | -2.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 55 | +0.289 | -0.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 55 | +0.289 | -0.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 55 | +0.289 | -0.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 55 | +0.289 | -0.73€ | 0 | 0 |
| ✅ GBM_LATE_15M | 5020 | +0.102 | +1557.40€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 5020 | +0.102 | +1557.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1206 | +0.065 | +176.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1206 | +0.065 | +176.21€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1193 | +0.072 | +193.22€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1193 | +0.072 | +193.22€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1345 | +0.110 | +547.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1345 | +0.110 | +547.61€ | 1 | 7 |
| ✅ GBM_LATE_15M#XRP | 1276 | +0.154 | +640.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1276 | +0.154 | +640.36€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2229 | +0.148 | +1277.06€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2229 | +0.148 | +1277.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 572 | +0.108 | +275.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 572 | +0.108 | +275.04€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 588 | +0.119 | +251.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 588 | +0.119 | +251.01€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 598 | +0.115 | +261.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 598 | +0.115 | +261.46€ | 1 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 471 | +0.274 | +489.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 471 | +0.274 | +489.55€ | 0 | 11 |
...
| ✅ GBM_LATE_15M_TARDIO | 2209 | +0.092 | +673.87€ | 0 | 7 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2209 | +0.092 | +673.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 550 | +0.060 | +99.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 550 | +0.060 | +99.35€ | 0 | 6 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 516 | +0.017 | +6.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 516 | +0.017 | +6.96€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 509 | +0.068 | +107.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 509 | +0.068 | +107.94€ | 2 | 6 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 634 | +0.201 | +459.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 634 | +0.201 | +459.63€ | 0 | 10 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 172 | +0.155 | +46.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 172 | +0.155 | +46.12€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 55 | +0.184 | +26.58€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 55 | +0.184 | +26.58€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 25 | +0.204 | +7.13€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 25 | +0.204 | +7.13€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.148) — sin ventaja clara. oversold(IBS<0.3): IC=+0.000 n=524 | neutral: IC=-0.017 n=393 | overbought(IBS>0.7): IC=+0.132 n=430
  - _Datos_: n=1423 IC=+0.043 PNL=+138.79€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.104 n=10291 | tras_1loss IC=+0.070 n=7139 | tras_2loss IC=+0.041 n=3037/40 | gap=+0.063 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=15183 IC=+0.107 PNL=+3710.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=15183 IC=+0.107 PNL=+3710.17€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.236 > 0.2 con n=381 PNL=+256.01€
  - _Datos_: n=381 IC=+0.236 PNL=+256.01€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.109 > 0.08 con n=182 PNL=+42.71€
  - _Datos_: n=182 IC=+0.109 PNL=+42.71€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.126 > 0.08 con n=177 PNL=+68.81€
  - _Datos_: n=177 IC=+0.126 PNL=+68.81€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.153 > 0.08 con n=226 PNL=+132.05€
  - _Datos_: n=226 IC=+0.153 PNL=+132.05€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.246 > 0.08 con n=207 PNL=-12.34€
  - _Datos_: n=207 IC=+0.246 PNL=-12.34€
