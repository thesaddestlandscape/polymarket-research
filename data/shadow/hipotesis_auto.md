# Hipótesis automáticas — 2026-07-03 03:08 UTC
_Generado por shadow_postmortem.py sobre 2919 resoluciones (PNL=-51.14€)_
...
- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.173 (n=53)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `ibs_15` < 0.0613 (IC base=+0.044)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1297` → IC=+0.149 (n=55)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.75€ cuando `pct_spot_vs_ref` |x|≤ 0.1297 (IC base=+0.122)

- **PATRÓN** `sigma_h` < `0.0144` → IC=+0.149 (n=55)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0144 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `1.124` → IC=+0.141 (n=51)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 1.124 (IC base=+0.122)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.227 (n=20)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.122)

- **PATRÓN** `ibs_15` < `0.0792` → IC=+0.300 (n=28)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0792 (IC base=+0.122)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0792 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.300 n=28). Confirma señal de reversión media → alinear con BUY_YES.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 280 | +0.071 | +39.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 280 | +0.071 | +39.37€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 68 | +0.100 | +11.72€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 68 | +0.100 | +11.72€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 65 | +0.157 | +21.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 65 | +0.157 | +21.90€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 846 | -0.039 | -45.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 617 | -0.017 | -18.31€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 330 | -0.009 | +9.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 246 | +0.008 | +15.63€ | 3 | 5 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.064) — sin ventaja clara. oversold(IBS<0.3): IC=-0.003 n=153 | neutral: IC=-0.067 n=139 | overbought(IBS>0.7): IC=-0.043 n=149
  - _Datos_: n=456 IC=-0.037 PNL=-20.41€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.007 n=1395 | tras_1loss IC=-0.027 n=1433 | tras_2loss IC=-0.044 n=737/40 | gap=+0.051 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=723 IC=-0.034 PNL=-32.09€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=723 IC=-0.034 PNL=-32.09€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=208 IC=+0.019 PNL=+16.48€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=208 IC=+0.019 PNL=+16.48€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=493 IC=+0.045 PNL=+39.03€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=493 IC=+0.045 PNL=+39.03€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=40 IC=+0.000 PNL=-5.74€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=40 IC=+0.000 PNL=-5.74€
