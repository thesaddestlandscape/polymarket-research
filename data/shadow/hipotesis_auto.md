# Hipótesis automáticas — 2026-08-09 02:47 UTC
_Generado por shadow_postmortem.py sobre 95979 resoluciones (PNL=+14067.98€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.256 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.141)

- **PATRÓN** `restante_min` < `4.57` → IC=+0.165 (n=392)

  - _Acción_: Kelly boost +0.82€ cuando `restante_min` < 4.57 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.157 (n=598)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 7.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.145 (n=582)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 18.0 (IC base=+0.141)

- **PATRÓN** `profundidad_ratio_no` > `17.8` → IC=+0.182 (n=193)

  - _Acción_: Kelly boost +0.91€ cuando `profundidad_ratio_no` > 17.8 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.129 (n=292)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 18.0 (IC base=+0.119)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.198 (n=253)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.43 (IC base=+0.162)

- **PATRÓN** `restante_min` < `4.93` → IC=+0.179 (n=288)

  - _Acción_: Kelly boost +0.90€ cuando `restante_min` < 4.93 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.185 (n=296)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 7.0 (IC base=+0.162)

- **PATRÓN** `profundidad_ratio_no` > `26.5` → IC=+0.214 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio_no` > 26.5 (IC base=+0.162)
...
| ✅ BALLENAS_TARDIAS | 2373 | -0.071 | -515.99€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 423 | +0.213 | -42.58€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 1950 | -0.133 | -473.42€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 11525 | +0.197 | -874.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 11525 | +0.197 | -874.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2071 | +0.157 | -286.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2071 | +0.157 | -286.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1821 | +0.220 | -56.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1821 | +0.220 | -56.67€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 1907 | +0.194 | -162.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 1907 | +0.194 | -162.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 772 | +0.141 | +27.46€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 772 | +0.141 | +27.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 389 | +0.119 | -3.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 389 | +0.119 | -3.51€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 383 | +0.162 | +30.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 383 | +0.162 | +30.97€ | 0 | 4 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.130 n=58681 | tras_1loss IC=+0.086 n=37047 | tras_2loss IC=+0.051 n=15289/40 | gap=+0.079 (umbral 0.05)
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2071 IC=+0.157 PNL=-286.61€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2071 IC=+0.157 PNL=-286.61€
