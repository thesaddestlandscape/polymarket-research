...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.054) — sin ventaja clara. oversold(IBS<0.3): IC=+0.048 n=9495 | neutral: IC=+0.030 n=10205 | overbought(IBS>0.7): IC=+0.084 n=9702
  - _Datos_: n=30486 IC=+0.054 PNL=+3600.90€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 469 celda(s) pasan gate riguroso completo de 2068 evaluadas (n>=40) y 3040 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.023 < 0.08 — monitorear
  - _Datos_: n=1926 IC=+0.023 PNL=+111.57€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 26878 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.

**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  - _Umbral_: n≥60 alineadas y gap IC≥0.08 vs contrarias — y descartar que sea proxy de drift_15min/60min
  - _Acción_: Si confirma e independiente de drift → capturar prev_window_outcome como feature en shadow_predict y boost ×1.1-1.2 en señales alineadas
  - _Estado_: alineada_con_outcome_prev IC=+0.100 n=198/60 | contraria IC=+0.148 n=180 | gap=-0.048 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=582/40 IC=-0.002 PNL=-4.74€ | BTC#60min: n=725/40 IC=-0.001 PNL=+6.07€ | SOL#60min: n=332/40 IC=+0.009 PNL=-0.65€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.053 n=271557 | tras_1loss IC=+0.072 n=211959 | tras_2loss IC=+0.041 n=90568/40 | gap=+0.013 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=+0.013 n=2908 | contrario_BTC IC=+0.018 n=2576/40 | gap=+0.005 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.195 > 0.08 con n=277 PNL=+175.44€
  - _Datos_: n=277 IC=+0.195 PNL=+175.44€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=25766 IC=+0.029 PNL=+1427.04€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=25766 IC=+0.029 PNL=+1427.04€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1195 IC=+0.004 PNL=-5.68€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1195 IC=+0.004 PNL=-5.68€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=444 IC=-0.007 PNL=+6.36€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=444 IC=-0.007 PNL=+6.36€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.177 > 0.1 con n=1529 PNL=+886.19€
  - _Datos_: n=1529 IC=+0.177 PNL=+886.19€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=884 IC=+0.082 PNL=+199.38€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=884 IC=+0.082 PNL=+199.38€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=4156 IC=+0.065 PNL=+802.36€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=4156 IC=+0.065 PNL=+802.36€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=3348 IC=-0.002 PNL=-1.75€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3348 IC=-0.002 PNL=-1.75€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=5182 IC=+0.030 PNL=+274.64€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=5182 IC=+0.030 PNL=+274.64€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=1714 IC=+0.049 PNL=+188.73€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1714 IC=+0.049 PNL=+188.73€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=3816 IC=+0.038 PNL=+267.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3816 IC=+0.038 PNL=+267.35€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=8893 IC=+0.051 PNL=+1021.40€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=8893 IC=+0.051 PNL=+1021.40€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.196 > 0.1 con n=2412 PNL=+1259.87€
  - _Datos_: n=2412 IC=+0.196 PNL=+1259.87€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1456 IC=+0.046 PNL=+162.42€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1456 IC=+0.046 PNL=+162.42€
...
**🟡 H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.142 > 0.1 con n=280 PNL=+89.97€
  - _Datos_: n=280 IC=+0.142 PNL=+89.97€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=14132 IC=-0.144 PNL=+596.06€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=14132 IC=-0.144 PNL=+596.06€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1570 IC=+0.139 PNL=+840.64€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1570 IC=+0.139 PNL=+840.64€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.180 > 0.08 con n=1490 PNL=+873.56€
  - _Datos_: n=1490 IC=+0.180 PNL=+873.56€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.244 < -0.1 con n=1421 PNL=-208.01€
  - _Datos_: n=1421 IC=-0.244 PNL=-208.01€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=4107 IC=+0.147 PNL=+2475.51€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=4107 IC=+0.147 PNL=+2475.51€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=1614 IC=+0.048 PNL=+353.80€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1614 IC=+0.048 PNL=+353.80€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.178 > 0.08 con n=1465 PNL=+978.48€
  - _Datos_: n=1465 IC=+0.178 PNL=+978.48€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=2400 IC=-0.038 PNL=+561.51€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2400 IC=-0.038 PNL=+561.51€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.230 > 0.08 con n=2819 PNL=-275.43€
  - _Datos_: n=2819 IC=+0.230 PNL=-275.43€
...
**🟡 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.345 > 0.08 con n=198 PNL=+81.43€
  - _Datos_: n=198 IC=+0.345 PNL=+81.43€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=7277 IC=+0.171 PNL=-911.63€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=7277 IC=+0.171 PNL=-911.63€
