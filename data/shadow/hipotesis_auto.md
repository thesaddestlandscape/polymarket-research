# Hipótesis automáticas — 2026-07-16 09:59 UTC
_Generado por shadow_postmortem.py sobre 16787 resoluciones (PNL=+3439.70€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=1063)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.180)

- **PATRÓN** `libro_liquidez` > `4371.9525` → IC=+0.186 (n=607)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 4371.9525 (IC base=+0.180)
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.135 (n=1237)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0091 (IC base=+0.107)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.127 (n=1245)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 11.0 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.188` → IC=+0.121 (n=143)

  - _Acción_: Kelly boost +0.60€ cuando `sigma_ewma_delta_pct` > 6.188 (IC base=+0.107)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.176` → IC=+0.183 (n=58)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.180 (n=755)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.4151` → IC=+0.198 (n=534)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.4151 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.192` → IC=+0.259 (n=52)
...
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.168 (n=191)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0028 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.163 (n=90)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 15.0 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.4825` → IC=+0.128 (n=154)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.4825 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.827` → IC=+0.326 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.827 (IC base=+0.137)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2513 | +0.174 | -58.85€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 1616 | +0.211 | +17.94€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 728 | +0.182 | -9.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 541 | +0.207 | -8.65€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 895 | +0.172 | -8.37€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 882 | +0.170 | -37.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 532 | +0.213 | +15.55€ | 0 | 6 |
...
| ✅ GBM_LATE_15M | 4849 | +0.103 | +1515.70€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 4849 | +0.103 | +1515.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1163 | +0.063 | +161.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1163 | +0.063 | +161.53€ | 0 | 3 |
| ✅ GBM_LATE_15M#ETH | 1161 | +0.076 | +201.42€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1161 | +0.076 | +201.42€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1298 | +0.109 | +524.19€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1298 | +0.109 | +524.19€ | 1 | 6 |
| ✅ GBM_LATE_15M#XRP | 1227 | +0.157 | +628.56€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1227 | +0.157 | +628.56€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2075 | +0.150 | +1214.52€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2075 | +0.150 | +1214.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 531 | +0.110 | +258.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 531 | +0.110 | +258.73€ | 0 | 8 |
...
| ✅ GBM_LATE_15M_TARDIO | 2047 | +0.090 | +611.99€ | 0 | 6 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2047 | +0.090 | +611.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 507 | +0.056 | +84.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 507 | +0.056 | +84.41€ | 0 | 3 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.102 n=9771 | tras_1loss IC=+0.069 n=6807 | tras_2loss IC=+0.037 n=2908/40 | gap=+0.065 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=14329 IC=+0.106 PNL=+3515.59€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=14329 IC=+0.106 PNL=+3515.59€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=621 IC=+0.055 PNL=+70.19€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=621 IC=+0.055 PNL=+70.19€
