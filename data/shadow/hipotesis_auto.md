# Hipótesis automáticas — 2026-08-25 13:21 UTC
_Generado por shadow_postmortem.py sobre 150880 resoluciones (PNL=+10040.38€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.99` → IC=-0.276 (n=2113)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.99
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=6340)
...
- **FILTRO** `restante_s_al_confirmar` < `82.9` → IC=-0.448 (n=250)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=752)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `158.17` → IC=-0.197 (n=568)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.17
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=1707)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `150.33` → IC=-0.279 (n=518)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 150.33
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1555)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `158.17` → IC=-0.336 (n=487)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.17
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=989)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.189 (n=4908)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=1487)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2375.6867` → IC=+0.177 (n=1437)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.217 (n=715)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `10469.9485` → IC=+0.216 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10469.9485 (IC base=+0.212)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.137 (n=1111)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.195 (n=4138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 5.0 (IC base=+0.190)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.195 (n=3577)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.166 (n=1058)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.168 (n=908)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.243 (n=942)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.232)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.232 (n=812)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.193 (n=877)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.196 (n=699)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.196 (n=10058)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.222 (n=7568)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.192)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=2064)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.161 (n=1429)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` > 0.71 (IC base=+0.124)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.247 (n=1744)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.242 (n=1696)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.249 (n=1036)
...
- **PATRÓN** `lag_apertura_s` < `5.92` → IC=+0.171 (n=640)

  - _Acción_: Kelly boost +0.86€ cuando `lag_apertura_s` < 5.92 (IC base=+0.138)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.191 (n=648)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.37 (IC base=+0.122)

- **PATRÓN** `restante_min` < `4.39` → IC=+0.135 (n=859)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 4.39 (IC base=+0.122)
...
- **PATRÓN** `lag_apertura_s` < `3.49` → IC=+0.156 (n=649)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9463` → IC=+0.221 (n=653)
...
- **PATRÓN** `dist_vwap_pct` < `0.7337` → IC=+0.226 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7337 (IC base=+0.069)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.065` → IC=+0.186 (n=813)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 5.065 (IC base=+0.069)

- **PATRÓN** `volumen_regimen` < `0.7077` → IC=+0.225 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7077 (IC base=+0.069)

- **PATRÓN** `volumen_regimen` > `1.0807` → IC=+0.265 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0807 (IC base=+0.069)

- **PATRÓN** `volumen_pendiente_norm` < `0.1061` → IC=+0.135 (n=970)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1061 (IC base=+0.069)

- **PATRÓN** `volumen_pendiente_norm` > `0.3074` → IC=+0.152 (n=139)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.3074 (IC base=+0.069)

- **PATRÓN** `volumen_spike_ratio` < `1.5818` → IC=+0.147 (n=448)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5818 (IC base=+0.069)

- **PATRÓN** `volumen_spike_ratio` > `1.954` → IC=+0.134 (n=678)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.954 (IC base=+0.069)

- **PATRÓN** `ibs_20min` < `0.2131` → IC=+0.122 (n=1365)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.2131 (IC base=+0.027)

- **PATRÓN** `dist_vwap_pct` < `0.1781` → IC=+0.149 (n=662)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1781 (IC base=+0.027)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1742` → IC=+0.253 (n=200)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1742 (IC base=+0.027)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.182 (n=146)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0075 (IC base=+0.121)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.181 (n=161)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 6.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.305 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.341` → IC=+0.344 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.341 (IC base=+0.121)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.152 (n=334)
...
- **PATRÓN** `ibs_20min` < `0.3352` → IC=+0.318 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3352 (IC base=+0.287)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4382` → IC=+0.219 (n=315)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4382 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.245 (n=327)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.4327` → IC=+0.229 (n=315)
...
- **PATRÓN** `dist_vwap_pct` < `0.992` → IC=+0.222 (n=322)
...
- **PATRÓN** `volumen_regimen` < `1.294` → IC=+0.222 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.294 (IC base=+0.220)

- **PATRÓN** `volumen_regimen` > `1.1032` → IC=+0.252 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1032 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` < `0.0769` → IC=+0.229 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0769 (IC base=+0.220)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4526` → IC=+0.262 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4526 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `11102.6859` → IC=+0.235 (n=281)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.888` → IC=-0.149 (n=257)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.132 (n=1137)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0072 (IC base=+0.054)

- **PATRÓN** `ibs_20min` > `0.9467` → IC=+0.253 (n=833)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9467 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.4504` → IC=+0.262 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4504 (IC base=+0.054)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.339` → IC=+0.122 (n=1415)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` > 2.339 (IC base=+0.054)

- **PATRÓN** `volumen_regimen` > `1.1691` → IC=+0.196 (n=291)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 1.1691 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` < `0.1151` → IC=+0.163 (n=1093)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.1151 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` > `0.2417` → IC=+0.216 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2417 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` < `1.4824` → IC=+0.184 (n=375)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.4824 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` > `2.8755` → IC=+0.176 (n=375)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.8755 (IC base=+0.054)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.271 (n=570)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.808` → IC=+0.191 (n=95)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 4.808 (IC base=-0.015)
...
- **PATRÓN** `volumen_spike_ratio` > `3.8997` → IC=+0.213 (n=134)
...
- **FILTRO** `ibs_20min` < `0.5294` → IC=-0.144 (n=279)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.137 (n=282)
...
- **PATRÓN** `volumen_regimen` < `0.8775` → IC=+0.170 (n=107)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8775 (IC base=-0.003)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2621` → IC=+0.326 (n=21)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2621 (IC base=-0.003)

- **PATRÓN** `volumen_spike_ratio` < `1.4987` → IC=+0.173 (n=50)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.4987 (IC base=-0.003)

- **PATRÓN** `volumen_spike_ratio` > `1.5794` → IC=+0.164 (n=132)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.5794 (IC base=-0.003)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.213 (n=113)
...
- **PATRÓN** `ibs_20min` > `0.9064` → IC=+0.289 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9064 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` > `1.2538` → IC=+0.335 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2538 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.118` → IC=+0.271 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.118 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `0.8361` → IC=+0.246 (n=340)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.226 (n=567)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `3083.7036` → IC=+0.244 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3083.7036 (IC base=+0.208)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3022` → IC=+0.160 (n=1676)
...
- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.188 (n=934)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.211 (n=154)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.330 (n=157)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1398` → IC=+0.159 (n=80)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.1398 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.4177` → IC=+0.133 (n=262)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4177 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.186 (n=272)
...
- **PATRÓN** `ibs_20min` > `0.5141` → IC=+0.142 (n=350)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.989` → IC=+0.236 (n=108)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.989 (IC base=+0.088)

- **PATRÓN** `volumen_pendiente_norm` > `0.1826` → IC=+0.222 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1826 (IC base=+0.088)

- **PATRÓN** `libro_liquidez` > `2971.9929` → IC=+0.130 (n=233)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2971.9929 (IC base=+0.088)

- **PATRÓN** `ballena_activa_n` < `278.0` → IC=+0.177 (n=128)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 278.0 (IC base=+0.088)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.202 (n=1132)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0076 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=2226)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.9448` → IC=+0.289 (n=1130)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9448 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `1.0369` → IC=+0.257 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0369 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.484` → IC=+0.231 (n=1503)
...
- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.152 (n=797)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8994` → IC=+0.154 (n=1451)
...
- **PATRÓN** `ibs_20min` < `0.5455` → IC=+0.244 (n=2221)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5455 (IC base=+0.188)

- **PATRÓN** `dist_vwap_pct` < `0.705` → IC=+0.176 (n=1828)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.705 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.261` → IC=+0.201 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.261 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.603` → IC=+0.195 (n=2080)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 2.603 (IC base=+0.188)

- **PATRÓN** `volumen_regimen` < `0.6224` → IC=+0.176 (n=575)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6224 (IC base=+0.188)

- **PATRÓN** `volumen_regimen` > `1.1921` → IC=+0.185 (n=576)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.1921 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` > `0.2333` → IC=+0.250 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2333 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `2.2519` → IC=+0.198 (n=693)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.2519 (IC base=+0.188)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.209 (n=187)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9489` → IC=+0.286 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9489 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.136` → IC=+0.358 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.136 (IC base=+0.130)
...
- **PATRÓN** `libro_spread` < `0.06` → IC=+0.160 (n=304)
...
- **PATRÓN** `ibs_20min` > `0.717` → IC=+0.247 (n=291)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1406` → IC=+0.155 (n=111)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.1406 (IC base=+0.174)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.211 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.174)

- **PATRÓN** `libro_liquidez` > `1854.121` → IC=+0.185 (n=217)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1854.121 (IC base=+0.174)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1507` → IC=+0.151 (n=187)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1507 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.175 (n=198)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 15.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.189 (n=425)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5833 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.042` → IC=+0.128 (n=412)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.042 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `0.7026` → IC=+0.135 (n=187)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.7026 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` > `1.0506` → IC=+0.126 (n=193)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` > 1.0506 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` > `0.0719` → IC=+0.158 (n=115)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0719 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` > `1.54` → IC=+0.157 (n=249)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.54 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `1085.2925` → IC=+0.139 (n=380)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 1085.2925 (IC base=+0.109)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0255` → IC=+0.216 (n=181)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9655` → IC=+0.294 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9655 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` > `1.2697` → IC=+0.283 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2697 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.048` → IC=+0.255 (n=296)
...
- **PATRÓN** `volumen_regimen` > `1.0463` → IC=+0.190 (n=246)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 1.0463 (IC base=+0.171)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8445` → IC=+0.179 (n=328)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.8445 (IC base=+0.171)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.184 (n=603)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.01 (IC base=+0.171)

- **PATRÓN** `libro_liquidez` > `3106.4209` → IC=+0.194 (n=181)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 3106.4209 (IC base=+0.171)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.157 (n=703)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3361` → IC=+0.179 (n=474)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.3361 (IC base=+0.149)
...
- **PATRÓN** `ibs_20min` < `0.6264` → IC=+0.162 (n=474)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.6264 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.7247` → IC=+0.154 (n=134)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.7247 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.3663` → IC=+0.152 (n=501)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3663 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` < `1.2459` → IC=+0.169 (n=539)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.2459 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` < `0.096` → IC=+0.151 (n=480)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` < 0.096 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.0749` → IC=+0.168 (n=263)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.0749 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.5395` → IC=+0.177 (n=533)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.5395 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.157 (n=703)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `8217.4862` → IC=+0.162 (n=539)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.194 (n=194)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0038 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.3017` → IC=+0.170 (n=289)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3017 (IC base=+0.149)
...
- **PATRÓN** `ibs_20min` < `0.1373` → IC=+0.223 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1373 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.7389` → IC=+0.157 (n=97)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.7389 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.648` → IC=+0.179 (n=51)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.648 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.3426` → IC=+0.154 (n=284)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.3426 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.168` → IC=+0.148 (n=143)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 3.168 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.369` → IC=+0.160 (n=292)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.369 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.1988` → IC=+0.163 (n=289)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1988 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `0.6966` → IC=+0.158 (n=258)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6966 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.0777` → IC=+0.196 (n=136)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.0777 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.625` → IC=+0.177 (n=289)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.625 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `11510.29` → IC=+0.169 (n=258)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 11510.29 (IC base=+0.149)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.164 (n=671)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=2111)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.223 (n=665)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2055)

- **FILTRO** `ibs_20min` > `0.2774` → IC=-0.198 (n=679)
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.156 (n=120)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=363)
...
- **FILTRO** `py_entrada` > `0.61` → IC=-0.271 (n=138)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=285)

- **FILTRO** `drift_20min_pct` |x|> `0.2744` → IC=-0.124 (n=211)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.142 (n=2031)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4755)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.287 (n=1640)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=5146)

- **FILTRO** `ibs_7min` < `0.736` → IC=-0.234 (n=1696)

  - _Acción_: SKIP cuando `ibs_7min` < 0.736
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=5090)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.176 (n=2292)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=4494)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.226 (n=1961)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=6344)

- **FILTRO** `ibs_7min` > `0.7213` → IC=-0.167 (n=2076)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7213
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=6229)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=290)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1087)

- **FILTRO** `py_entrada` < `0.39` → IC=-0.249 (n=344)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1033)
...
- **FILTRO** `ballena_activa_n` > `146.0` → IC=-0.172 (n=343)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1034)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.215 (n=352)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.213 (n=273)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=678)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.332 (n=224)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=727)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.273 (n=236)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=715)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.275 (n=233)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=718)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.264 (n=316)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1135)

- **FILTRO** `ibs_7min` > `0.8192` → IC=-0.187 (n=362)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.157 (n=359)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=800)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.272 (n=287)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=872)

- **FILTRO** `ibs_7min` < `0.7674` → IC=-0.191 (n=289)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7674
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=870)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.215 (n=289)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=870)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.284 (n=271)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=874)

- **FILTRO** `ibs_7min` > `0.1808` → IC=-0.155 (n=389)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1808
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=756)

- **FILTRO** `ballena_activa_n` > `39.0` → IC=-0.215 (n=282)

  - _Acción_: SKIP cuando `ballena_activa_n` > 39.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=863)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.223 (n=308)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=956)

- **FILTRO** `ibs_7min` < `0.7719` → IC=-0.195 (n=316)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7719
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=948)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.195 (n=303)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=961)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.181 (n=359)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1146)
...
- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.248 (n=268)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=840)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.272 (n=287)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1114)

- **FILTRO** `ibs_7min` > `0.8272` → IC=-0.142 (n=350)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8272
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1051)
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.868` → IC=-0.188 (n=312)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=2124)
...
- **FILTRO** `sigma_h` < `0.0044` → IC=-0.227 (n=273)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0044
  - _Potencial_: sin este filtro IC_bueno=-0.202 (n=273)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.241 (n=133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.206 (n=413)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.923` → IC=-0.140 (n=195)
...
- **FILTRO** `sigma_ewma_delta_pct` > `15.281` → IC=-0.187 (n=97)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=685)
...
| ✅ BALLENAS_TARDIAS | 6260 | -0.099 | -813.76€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 653 | -0.083 | -108.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5607 | -0.100 | -705.51€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2073 | -0.074 | -103.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2073 | -0.074 | -103.54€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1476 | -0.183 | -299.24€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1476 | -0.183 | -299.24€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 28492 | +0.114 | -1865.25€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5410 | +0.187 | -177.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 19905 | +0.094 | -1610.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3070 | +0.123 | -27.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3341 | +0.062 | -581.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 19 | -0.068 | +0.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3317 | +0.063 | -575.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5947 | +0.135 | -113.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1518 | +0.197 | -81.32€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3316 | +0.111 | -69.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1071 | +0.132 | +59.20€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3349 | +0.076 | -462.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 19 | +0.023 | -2.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3329 | +0.076 | -458.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6381 | +0.131 | -49.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1968 | +0.171 | -0.03€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3313 | +0.116 | -26.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1088 | +0.105 | -14.19€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6132 | +0.131 | -409.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1869 | +0.202 | -93.80€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3306 | +0.092 | -233.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 911 | +0.132 | -72.06€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3342 | +0.103 | -248.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3324 | +0.104 | -246.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5389 | +0.176 | -398.12€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5389 | +0.176 | -398.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1355 | +0.171 | -136.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1355 | +0.171 | -136.23€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1347 | +0.161 | -158.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1347 | +0.161 | -158.23€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1206 | +0.233 | -30.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1206 | +0.233 | -30.36€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1295 | +0.191 | -88.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1295 | +0.191 | -88.64€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 14262 | +0.192 | -1242.13€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 14262 | +0.192 | -1242.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2629 | +0.124 | -489.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2629 | +0.124 | -489.67€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2212 | +0.236 | -51.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2212 | +0.236 | -51.06€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2472 | +0.163 | -319.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2472 | +0.163 | -319.39€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2253 | +0.235 | -50.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2253 | +0.235 | -50.56€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2295 | +0.219 | -105.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2295 | +0.219 | -105.91€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2401 | +0.188 | -225.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2401 | +0.188 | -225.55€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 5143 | +0.130 | +137.25€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 5143 | +0.130 | +137.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2553 | +0.138 | +103.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2553 | +0.138 | +103.85€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2590 | +0.122 | +33.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2590 | +0.122 | +33.40€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 4903 | +0.096 | -186.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 504 | +0.045 | -37.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 4399 | +0.102 | -149.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 3387 | +0.095 | -94.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 504 | +0.045 | -37.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 2883 | +0.104 | -56.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1516 | +0.098 | -92.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1516 | +0.098 | -92.44€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 6743 | +0.043 | +2048.71€ | 0 | 18 |
| ✅ GBM_LATE_15M#15min | 6743 | +0.043 | +2048.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 861 | +0.176 | +546.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 861 | +0.176 | +546.24€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 946 | +0.174 | +540.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 946 | +0.174 | +540.83€ | 0 | 29 |
| ✅ GBM_LATE_15M#DOGE | 870 | +0.190 | +596.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 870 | +0.190 | +596.76€ | 0 | 19 |
| ✅ GBM_LATE_15M#ETH | 1094 | -0.050 | +18.12€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1094 | -0.050 | +18.12€ | 2 | 6 |
| ✅ GBM_LATE_15M#SOL | 1301 | -0.038 | +154.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1301 | -0.038 | +154.69€ | 4 | 4 |
| ✅ GBM_LATE_15M#XRP | 1671 | -0.051 | +192.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1671 | -0.051 | +192.08€ | 5 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 7701 | +0.043 | +2893.93€ | 0 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 7701 | +0.043 | +2893.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1143 | -0.028 | +505.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1143 | -0.028 | +505.34€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1704 | -0.033 | +170.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1704 | -0.033 | +170.20€ | 0 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 735 | +0.242 | +677.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 735 | +0.242 | +677.70€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1333 | -0.042 | +15.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1333 | -0.042 | +15.24€ | 8 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1417 | -0.013 | +298.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1417 | -0.013 | +298.05€ | 5 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1369 | +0.234 | +1227.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1369 | +0.234 | +1227.41€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 5383 | +0.170 | +3668.28€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 5383 | +0.170 | +3668.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 648 | +0.194 | +477.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 648 | +0.194 | +477.84€ | 0 | 18 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO | 890 | +0.072 | +151.86€ | 0 | 11 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 890 | +0.072 | +151.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 6 | +0.000 | -1.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 6 | +0.000 | -1.19€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 6281 | +0.165 | +4050.61€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#15min | 6281 | +0.165 | +4050.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 825 | +0.184 | +573.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 825 | +0.184 | +573.39€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1041 | +0.165 | +663.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1041 | +0.165 | +663.90€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 815 | +0.218 | +676.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 815 | +0.218 | +676.89€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 941 | +0.139 | +497.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 941 | +0.139 | +497.96€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1158 | +0.097 | +542.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1158 | +0.097 | +542.81€ | 0 | 16 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1501 | +0.191 | +1095.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1501 | +0.191 | +1095.66€ | 0 | 24 |
| ✅ GBM_LATE_5M | 1145 | +0.122 | +494.93€ | 1 | 17 |
| ✅ GBM_LATE_5M#5min | 1145 | +0.122 | +494.93€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 451 | +0.136 | +253.67€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 451 | +0.136 | +253.67€ | 2 | 22 |
...
| ✅ MOMENTUM_IBS_15M | 3748 | +0.002 | -47.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 3748 | +0.002 | -47.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 379 | +0.004 | +7.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 379 | +0.004 | +7.49€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 616 | +0.000 | -18.90€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 616 | +0.000 | -18.90€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 732 | +0.014 | +17.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 732 | +0.014 | +17.49€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 683 | -0.002 | -23.13€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 683 | -0.002 | -23.13€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 740 | -0.007 | -21.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 740 | -0.007 | -21.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 5502 | -0.035 | +177.46€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 5502 | -0.035 | +177.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 871 | -0.028 | +124.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 871 | -0.028 | +124.76€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 985 | -0.030 | -16.17€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 985 | -0.030 | -16.17€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 879 | -0.040 | +96.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 879 | -0.040 | +96.82€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 984 | -0.035 | -30.13€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 984 | -0.035 | -30.13€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 893 | -0.046 | +6.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 893 | -0.046 | +6.67€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 890 | -0.029 | -4.48€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 890 | -0.029 | -4.48€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_5M | 2978 | +0.006 | +0.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 2978 | +0.006 | +0.40€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#ETH | 968 | +0.013 | +13.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#ETH#5min | 968 | +0.013 | +13.34€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 15091 | -0.073 | +282.74€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 15091 | -0.073 | +282.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 2319 | -0.094 | +254.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 2319 | -0.094 | +254.72€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 2788 | -0.057 | +2.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 2788 | -0.057 | +2.58€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 2402 | -0.085 | +16.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 2402 | -0.085 | +16.67€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 2304 | -0.098 | -174.95€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 2304 | -0.098 | -174.95€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 2769 | -0.048 | +37.71€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 2769 | -0.048 | +37.71€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 2509 | -0.066 | +146.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 2509 | -0.066 | +146.01€ | 5 | 0 |
...
| ✅ STREAK_MOM_5M | 1788 | +0.025 | +26.83€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 1788 | +0.025 | +26.83€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 596 | +0.025 | +6.48€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 596 | +0.025 | +6.48€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 312 | +0.013 | +1.63€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 312 | +0.013 | +1.63€ | 2 | 0 |
...
| ✅ UPDOWN_GBM | 5241 | +0.008 | +147.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2023 | +0.046 | +194.29€ | 0 | 7 |
| ✅ UPDOWN_GBM#240min | 227 | +0.028 | +5.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 2600 | -0.016 | -48.89€ | 2 | 0 |
...
| ✅ UPDOWN_GBM#SOL | 1240 | -0.006 | -12.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 456 | +0.002 | -3.42€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 51 | -0.028 | -3.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 635 | -0.002 | -3.92€ | 3 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3332 | -0.085 | +378.63€ | 2 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3332 | -0.085 | +378.63€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 275 | -0.063 | +130.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 275 | -0.063 | +130.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 688 | -0.171 | -88.04€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 688 | -0.171 | -88.04€ | 4 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1063 | -0.072 | +160.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1063 | -0.072 | +160.73€ | 2 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1007 | -0.093 | +89.41€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1007 | -0.093 | +89.41€ | 5 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.085) — sin ventaja clara. oversold(IBS<0.3): IC=+0.003 n=1806 | neutral: IC=+0.005 n=1964 | overbought(IBS>0.7): IC=+0.088 n=2079
  - _Datos_: n=6130 IC=+0.033 PNL=+465.27€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 4 celda(s) pasan gate riguroso completo de 197 evaluadas (n>=40) y 550 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.002 < 0.08 — monitorear
  - _Datos_: n=456 IC=+0.002 PNL=-3.42€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.076 n=84702 | tras_1loss IC=+0.044 n=65866 | tras_2loss IC=+0.008 n=29943/40 | gap=+0.068 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 5179 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.004 n=524 | contrario_BTC IC=-0.009 n=397/40 | gap=-0.005 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=5000 IC=+0.004 PNL=+97.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=5000 IC=+0.004 PNL=+97.02€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1186 IC=+0.037 PNL=+81.27€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1186 IC=+0.037 PNL=+81.27€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=1923 IC=-0.013 PNL=-40.44€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1923 IC=-0.013 PNL=-40.44€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1414 IC=+0.025 PNL=+86.04€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1414 IC=+0.025 PNL=+86.04€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=2305 IC=+0.100 PNL=+372.56€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=2305 IC=+0.100 PNL=+372.56€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=730 IC=+0.025 PNL=+42.34€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=730 IC=+0.025 PNL=+42.34€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=3647 IC=-0.131 PNL=+293.07€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3647 IC=-0.131 PNL=+293.07€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=883 IC=+0.153 PNL=+488.02€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=883 IC=+0.153 PNL=+488.02€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=569 IC=-0.027 PNL=+30.94€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=569 IC=-0.027 PNL=+30.94€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.242 > 0.08 con n=1251 PNL=-110.88€
  - _Datos_: n=1251 IC=+0.242 PNL=-110.88€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2629 IC=+0.124 PNL=-489.67€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2629 IC=+0.124 PNL=-489.67€
