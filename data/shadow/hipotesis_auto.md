# Hipótesis automáticas — 2026-07-02 07:46 UTC
_Generado por shadow_postmortem.py sobre 2570 resoluciones (PNL=-77.23€)_
...
- **FILTRO** `ibs_15` > `0.3704` → IC=-0.139 (n=34)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.3704
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=106)

- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.218 (n=69)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.060)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.150 (n=38)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 14.0 (IC base=+0.060)

- **PATRÓN** `ibs_15` < `0.0714` → IC=+0.235 (n=47)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0714 (IC base=+0.060)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0714 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.235 n=47). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 796 | -0.034 | -33.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 572 | -0.011 | -7.64€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#DOGE | 24 | -0.077 | -3.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 21 | -0.065 | -2.27€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.098) — sin ventaja clara. oversold(IBS<0.3): IC=+0.029 n=134 | neutral: IC=-0.069 n=121 | overbought(IBS>0.7): IC=-0.047 n=137
  - _Datos_: n=406 IC=-0.027 PNL=-8.24€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1206 | tras_1loss IC=-0.035 n=1266 | tras_2loss IC=-0.050 n=660/40 | gap=+0.052 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=673 IC=-0.027 PNL=-19.92€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=673 IC=-0.027 PNL=-19.92€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=189 IC=+0.034 PNL=+20.22€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=189 IC=+0.034 PNL=+20.22€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 153/200 ops en el filtro definido (IC actual=+0.068 PNL=+15.69€)
  - _Datos_: n=153 IC=+0.068 PNL=+15.69€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=153 IC=+0.068 PNL=+15.69€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=153 IC=+0.068 PNL=+15.69€
