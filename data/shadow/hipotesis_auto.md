# Hipótesis automáticas — 2026-08-26 14:30 UTC
_Generado por shadow_postmortem.py sobre 162798 resoluciones (PNL=+11688.22€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.73` → IC=-0.278 (n=2256)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.73
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=6768)
...
- **FILTRO** `restante_s_al_confirmar` < `157.54` → IC=-0.195 (n=615)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.54
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1845)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `150.08` → IC=-0.274 (n=534)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 150.08
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1603)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.96` → IC=-0.345 (n=513)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.96
  - _Potencial_: sin este filtro IC_bueno=-0.117 (n=1042)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.187 (n=5176)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1541)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2382.8902` → IC=+0.174 (n=1488)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.213 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `12480.3954` → IC=+0.215 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12480.3954 (IC base=+0.210)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.135 (n=1167)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.130 (n=1001)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=4337)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 5.0 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=3741)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1108)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.167 (n=948)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.242 (n=987)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.193 (n=1061)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.211 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.162)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.238 (n=1647)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.248 (n=1112)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.211 (n=1388)
...
- **PATRÓN** `restante_min` < `3.94` → IC=+0.142 (n=1404)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` < 3.94 (IC base=+0.133)

- **PATRÓN** `restante_min` > `4.93` → IC=+0.161 (n=1400)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.93 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=4379)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `4.47` → IC=+0.159 (n=1392)

  - _Acción_: Kelly boost +0.80€ cuando `lag_apertura_s` < 4.47 (IC base=+0.133)
...
- **PATRÓN** `restante_min` < `4.27` → IC=+0.144 (n=927)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` < 4.27 (IC base=+0.141)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.171 (n=696)

  - _Acción_: Kelly boost +0.85€ cuando `restante_min` > 4.91 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.151 (n=1845)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 15.0 (IC base=+0.141)

- **PATRÓN** `lag_apertura_s` < `5.65` → IC=+0.171 (n=691)

  - _Acción_: Kelly boost +0.85€ cuando `lag_apertura_s` < 5.65 (IC base=+0.141)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.159 (n=761)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.94 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=2195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.44` → IC=+0.168 (n=700)

  - _Acción_: Kelly boost +0.84€ cuando `lag_apertura_s` < 3.44 (IC base=+0.125)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9494` → IC=+0.211 (n=710)
...
- **PATRÓN** `dist_vwap_pct` < `0.5036` → IC=+0.217 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5036 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.229` → IC=+0.170 (n=870)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5715` → IC=+0.144 (n=498)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5715 (IC base=+0.065)

- **PATRÓN** `ibs_20min` < `0.2143` → IC=+0.130 (n=1461)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.198 (n=160)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0075 (IC base=+0.117)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.717` → IC=+0.331 (n=170)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.717 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.144 (n=259)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.233 (n=118)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.3368` → IC=+0.218 (n=310)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.214 (n=320)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.4287` → IC=+0.223 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4287 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.3109` → IC=+0.235 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3109 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `1.0239` → IC=+0.212 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.0239 (IC base=+0.211)
...
- **PATRÓN** `volumen_regimen` < `1.2788` → IC=+0.212 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2788 (IC base=+0.211)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.264` → IC=+0.261 (n=44)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.264 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.447` → IC=+0.262 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.447 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11188.0133` → IC=+0.222 (n=315)
...
- **PATRÓN** `libro_liquidez` > `1918.3532` → IC=+0.142 (n=191)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 1918.3532 (IC base=+0.129)
...
- **FILTRO** `ibs_20min` > `0.7612` → IC=-0.160 (n=313)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7612
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=942)

- **FILTRO** `sigma_ewma_delta_pct` > `4.919` → IC=-0.154 (n=267)
...
- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.169 (n=282)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=847)
...
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.149 (n=899)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0087 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9449` → IC=+0.246 (n=899)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1147` → IC=+0.167 (n=1189)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.1147 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.2437` → IC=+0.201 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2437 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `1.4786` → IC=+0.191 (n=409)
...
- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.269 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.0967` → IC=+0.178 (n=1158)
...
- **FILTRO** `ibs_20min` < `0.2469` → IC=-0.146 (n=173)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=354)

- **FILTRO** `sigma_ewma_delta_pct` > `5.178` → IC=-0.205 (n=120)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 5.178
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=602)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.08` → IC=+0.192 (n=102)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 5.08 (IC base=-0.014)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1444` → IC=+0.188 (n=309)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1444 (IC base=+0.177)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0228` → IC=+0.182 (n=146)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.0228 (IC base=+0.177)
...
- **PATRÓN** `libro_liquidez` > `1915.9532` → IC=+0.214 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1915.9532 (IC base=+0.177)
...
- **PATRÓN** `volumen_regimen` < `1.2203` → IC=+0.160 (n=1612)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2203 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `0.6873` → IC=+0.173 (n=1440)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6873 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.103` → IC=+0.180 (n=823)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.103 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.2822` → IC=+0.157 (n=1825)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.2822 (IC base=+0.156)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=1904)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `3848.1598` → IC=+0.193 (n=774)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 3848.1598 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.179 (n=1082)
...
- **PATRÓN** `drift_60min` |x|≤ `0.399` → IC=+0.200 (n=2081)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.399 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.216 (n=1047)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.3544` → IC=+0.178 (n=1828)
...
- **PATRÓN** `volumen_regimen` < `1.1777` → IC=+0.165 (n=1693)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1777 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `0.8608` → IC=+0.175 (n=1129)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8608 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.250 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` < `1.8722` → IC=+0.178 (n=981)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.8722 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.6202` → IC=+0.210 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6202 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `203.0` → IC=+0.183 (n=1041)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.175 (n=346)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_spike_ratio` > `1.4214` → IC=+0.139 (n=294)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4214 (IC base=+0.149)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.230 (n=109)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0073 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.218 (n=342)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` > `0.5086` → IC=+0.222 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5086 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.250 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.183)
...
- **PATRÓN** `volumen_regimen` < `1.2971` → IC=+0.191 (n=325)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 1.2971 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `0.8987` → IC=+0.203 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8987 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2178` → IC=+0.254 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2178 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` < `1.3897` → IC=+0.243 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3897 (IC base=+0.183)

- **PATRÓN** `libro_liquidez` > `11982.1154` → IC=+0.208 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11982.1154 (IC base=+0.183)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1433` → IC=+0.161 (n=225)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2295` → IC=+0.143 (n=275)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.2295 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.0094` → IC=+0.210 (n=122)
...
- **PATRÓN** `libro_liquidez` > `1961.8084` → IC=+0.178 (n=113)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 1961.8084 (IC base=+0.147)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.408` → IC=+0.333 (n=64)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.408 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.202 (n=327)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.190 (n=369)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `8630.7084` → IC=+0.209 (n=218)
...
- **FILTRO** `ibs_20min` > `0.4107` → IC=-0.195 (n=129)

  - _Acción_: SKIP cuando `ibs_20min` > 0.4107
  - _Potencial_: sin este filtro IC_bueno=+0.231 (n=388)
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.189 (n=130)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0048 (IC base=+0.124)
...
- **PATRÓN** `dist_vwap_pct` < `0.2166` → IC=+0.139 (n=358)
...
- **PATRÓN** `volumen_regimen` > `0.8565` → IC=+0.171 (n=259)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.8565 (IC base=+0.124)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0432` → IC=+0.200 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0432 (IC base=+0.124)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.128 (n=331)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `2060.221` → IC=+0.167 (n=259)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2060.221 (IC base=+0.124)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0222` → IC=+0.194 (n=227)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0222 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.1617` → IC=+0.185 (n=220)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.1617 (IC base=+0.163)
...
- **PATRÓN** `ibs_20min` > `0.928` → IC=+0.258 (n=333)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.928 (IC base=+0.163)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.073` → IC=+0.244 (n=271)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.073 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.1991` → IC=+0.165 (n=499)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1991 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.8284` → IC=+0.193 (n=333)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.8284 (IC base=+0.163)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1643` → IC=+0.179 (n=406)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.1643 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.8078` → IC=+0.165 (n=308)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.8078 (IC base=+0.163)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3253` → IC=+0.146 (n=2096)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.3253 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.8809` → IC=+0.157 (n=1588)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.8809 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2206)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `3813.8034` → IC=+0.196 (n=900)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 3813.8034 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.194 (n=1163)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 163.0 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.220 (n=198)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.8271` → IC=+0.247 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8271 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.431` → IC=+0.357 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.431 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2129` → IC=+0.176 (n=66)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2129 (IC base=+0.134)
...
- **PATRÓN** `ibs_20min` > `0.7131` → IC=+0.256 (n=318)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1461` → IC=+0.183 (n=260)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1461 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` < `2.11` → IC=+0.185 (n=125)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.11 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `3.8461` → IC=+0.172 (n=129)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 3.8461 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.193 (n=242)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.03 (IC base=+0.176)

- **PATRÓN** `libro_liquidez` > `1917.9762` → IC=+0.201 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1917.9762 (IC base=+0.176)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.190 (n=288)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 15.0 (IC base=+0.172)
...
- **PATRÓN** `dist_vwap_pct` > `1.4114` → IC=+0.294 (n=134)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.4114 (IC base=+0.172)
...
- **PATRÓN** `volumen_regimen` < `0.6141` → IC=+0.186 (n=192)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6141 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `1.0463` → IC=+0.195 (n=260)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.0463 (IC base=+0.172)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5675` → IC=+0.170 (n=231)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5675 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `1.8321` → IC=+0.184 (n=349)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.8321 (IC base=+0.172)
...
- **PATRÓN** `libro_liquidez` > `3109.2978` → IC=+0.179 (n=191)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 3109.2978 (IC base=+0.172)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.151 (n=894)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.133 (n=360)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0105 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 17.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.8291` → IC=+0.142 (n=185)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.8291 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `1.5265` → IC=+0.206 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.5265 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `0.7179` → IC=+0.142 (n=160)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.7179 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.1533` → IC=+0.161 (n=116)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.1533 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` < `2.1228` → IC=+0.127 (n=352)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.1228 (IC base=+0.106)
...
- **PATRÓN** `libro_liquidez` > `8162.0536` → IC=+0.150 (n=272)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8162.0536 (IC base=+0.106)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.201 (n=229)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.3507` → IC=+0.167 (n=601)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` < `0.8053` → IC=+0.143 (n=776)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.8053 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.141` → IC=+0.159 (n=306)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.141 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.061` → IC=+0.146 (n=685)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.061 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `1.2252` → IC=+0.159 (n=672)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.2252 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` < `2.489` → IC=+0.163 (n=675)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.489 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.5134` → IC=+0.150 (n=603)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.5134 (IC base=+0.144)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=894)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8426.6807` → IC=+0.151 (n=682)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8426.6807 (IC base=+0.144)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.185 (n=252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0044 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.3471` → IC=+0.150 (n=378)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.3471 (IC base=+0.138)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.198 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 5.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.144` → IC=+0.167 (n=166)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.144 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.6099` → IC=+0.172 (n=59)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.6099 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.369` → IC=+0.151 (n=382)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.369 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.1906` → IC=+0.145 (n=378)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1906 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.142 (n=378)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6229 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.180 (n=179)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.5688` → IC=+0.153 (n=376)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.5688 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `2.1651` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.1651 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `11854.8179` → IC=+0.141 (n=338)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 11854.8179 (IC base=+0.138)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.169 (n=753)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=2311)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.214 (n=725)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2330)

- **FILTRO** `ibs_20min` > `0.2733` → IC=-0.177 (n=763)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2733
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=2292)
...
- **FILTRO** `py_entrada` > `0.67` → IC=-0.218 (n=122)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=392)

- **FILTRO** `ibs_20min` > `0.7647` → IC=-0.200 (n=128)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.182 (n=146)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=397)

- **FILTRO** `ballena_activa_n` > `5.0` → IC=-0.147 (n=171)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.224 (n=114)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=368)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=2175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=5356)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.287 (n=1818)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=5713)

- **FILTRO** `ibs_7min` < `0.7365` → IC=-0.235 (n=1882)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7365
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=5649)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.174 (n=2504)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=5027)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.229 (n=2130)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=7123)

- **FILTRO** `ibs_7min` > `0.7209` → IC=-0.169 (n=2312)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7209
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=6941)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.096 (n=788)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.331 (n=247)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=778)

- **FILTRO** `ibs_7min` < `0.9819` → IC=-0.201 (n=676)
...
- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.263 (n=255)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=770)
...
- **FILTRO** `drift_7min_pct` |x|> `0.1399` → IC=-0.159 (n=534)
...
- **FILTRO** `ibs_7min` > `0.8364` → IC=-0.195 (n=392)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1179)
...
- **FILTRO** `py_entrada` < `0.38` → IC=-0.242 (n=367)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1137)

- **FILTRO** `ibs_7min` < `0.8058` → IC=-0.164 (n=376)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8058
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1128)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.170 (n=374)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1130)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.230 (n=364)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1173)

- **FILTRO** `ballena_activa_n` > `124.0` → IC=-0.168 (n=384)
...
- **FILTRO** `py_entrada` < `0.32` → IC=-0.341 (n=249)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=810)

- **FILTRO** `ibs_7min` < `0.2097` → IC=-0.282 (n=264)
...
- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.284 (n=262)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=797)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.258 (n=349)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1271)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.150 (n=389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=896)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.268 (n=300)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=985)

- **FILTRO** `ibs_7min` < `0.765` → IC=-0.187 (n=321)

  - _Acción_: SKIP cuando `ibs_7min` < 0.765
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=964)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.213 (n=319)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=966)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.126 (n=410)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=865)
...
- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.208 (n=317)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=958)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.234 (n=336)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1080)

- **FILTRO** `ibs_7min` < `0.7719` → IC=-0.202 (n=354)
...
- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.204 (n=346)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1070)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.173 (n=423)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1276)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.296 (n=297)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=945)
...
- **FILTRO** `ibs_7min` > `0.83` → IC=-0.158 (n=387)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1164)
...
- **PATRÓN** `ibs_15` > `0.5275` → IC=+0.200 (n=378)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5275 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.113)
...
- **PATRÓN** `libro_liquidez` > `2964.2504` → IC=+0.142 (n=252)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 2964.2504 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `73.0` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 73.0 (IC base=+0.113)

- **PATRÓN** `ibs_15` < `0.1124` → IC=+0.138 (n=415)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.1124 (IC base=+0.026)
...
- **FILTRO** `sigma_h` > `0.0092` → IC=-0.139 (n=236)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0092
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=714)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.235` → IC=-0.180 (n=326)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.235
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2346)
...
- **FILTRO** `sigma_h` < `0.0027` → IC=-0.211 (n=147)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.208 (n=443)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.250 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.196 (n=448)

- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.261 (n=111)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.716
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=479)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.923` → IC=-0.139 (n=211)
...
- **FILTRO** `sigma_ewma_delta_pct` > `9.208` → IC=-0.132 (n=191)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5275 sube el IC de +0.113 a +0.200 en UPDOWN_GBM#15min (n=378). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 6529 | -0.099 | -895.92€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 670 | -0.089 | -119.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5859 | -0.100 | -776.56€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1083 | +0.015 | -129.79€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1083 | +0.015 | -129.79€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2137 | -0.073 | -99.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2137 | -0.073 | -99.71€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1555 | -0.192 | -353.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1555 | -0.192 | -353.59€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30411 | +0.114 | -1980.98€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5679 | +0.187 | -188.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21489 | +0.095 | -1704.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3136 | +0.121 | -38.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3607 | +0.063 | -613.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3582 | +0.065 | -610.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6309 | +0.134 | -134.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1600 | +0.198 | -83.02€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3576 | +0.109 | -84.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1091 | +0.130 | +55.32€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3615 | +0.078 | -473.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 20 | +0.045 | +2.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3594 | +0.078 | -473.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6773 | +0.128 | -83.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2066 | +0.169 | -8.71€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3578 | +0.114 | -45.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1117 | +0.103 | -20.28€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6502 | +0.132 | -422.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1956 | +0.202 | -100.61€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3572 | +0.095 | -239.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 928 | +0.132 | -73.09€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3605 | +0.105 | -253.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3587 | +0.106 | -251.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5643 | +0.173 | -442.00€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5643 | +0.173 | -442.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1419 | +0.166 | -152.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1419 | +0.166 | -152.08€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1408 | +0.160 | -168.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1408 | +0.160 | -168.41€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1264 | +0.231 | -33.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1264 | +0.231 | -33.45€ | 0 | 2 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1362 | +0.185 | -104.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1362 | +0.185 | -104.38€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15367 | +0.191 | -1353.10€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15367 | +0.191 | -1353.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2823 | +0.124 | -524.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2823 | +0.124 | -524.03€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2386 | +0.238 | -45.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2386 | +0.238 | -45.20€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2649 | +0.162 | -344.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2649 | +0.162 | -344.51€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2436 | +0.231 | -66.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2436 | +0.231 | -66.59€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2486 | +0.217 | -117.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 