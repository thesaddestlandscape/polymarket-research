# Hipótesis automáticas — 2026-07-02 02:48 UTC
_Generado por shadow_postmortem.py sobre 2523 resoluciones (PNL=-85.73€)_
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.250 (n=62)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.074)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.206 (n=32)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.074)

- **PATRÓN** `ibs_15` < `0.4545` → IC=+0.130 (n=90)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.65€ cuando `ibs_15` < 0.4545 (IC base=+0.074)
...
| ✅ UPDOWN_GBM | 771 | -0.033 | -34.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 551 | -0.008 | -8.65€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#SOL | 133 | -0.078 | -8.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 80 | -0.049 | -4.09€ | 5 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.093) — sin ventaja clara. oversold(IBS<0.3): IC=+0.034 n=116 | neutral: IC=-0.059 n=116 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=381 IC=-0.025 PNL=-9.33€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.179 n=26 PNL=-12.72€ → FILTRAR | H=02h: IC=-0.180 n=18 PNL=-5.07€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=80 IC=-0.049 PNL=-4.09€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.003 n=1191 | tras_1loss IC=-0.037 n=1250 | tras_2loss IC=-0.050 n=651/40 | gap=+0.053 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=648 IC=-0.026 PNL=-21.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=648 IC=-0.026 PNL=-21.02€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=168 IC=+0.047 PNL=+19.21€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=168 IC=+0.047 PNL=+19.21€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 106/200 ops en el filtro definido (IC actual=+0.046 PNL=+7.19€)
  - _Datos_: n=106 IC=+0.046 PNL=+7.19€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=106 IC=+0.046 PNL=+7.19€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=106 IC=+0.046 PNL=+7.19€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 15/40 ops en el filtro definido (IC actual=+0.022 PNL=-1.04€)
  - _Datos_: n=15 IC=+0.022 PNL=-1.04€
