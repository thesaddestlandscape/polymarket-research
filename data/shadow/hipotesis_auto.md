# Hipótesis automáticas — 2026-08-30 03:30 UTC
_Generado por shadow_postmortem.py sobre 209514 resoluciones (PNL=+16147.18€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.55` → IC=-0.291 (n=2933)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.55
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=8801)
...
- **FILTRO** `restante_s_al_confirmar` < `158.28` → IC=-0.165 (n=783)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2351)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.158 (n=5079)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.84` → IC=+0.437 (n=361)
...
- **FILTRO** `py_entrada` > `0.835` → IC=-0.364 (n=42)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.199 (n=134)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=4358)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `hora_utc` > `11.0` → IC=-0.380 (n=23)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.224 (n=74)

- **FILTRO** `py_entrada` > `0.795` → IC=-0.403 (n=29)

  - _Acción_: SKIP cuando `py_entrada` > 0.795
  - _Potencial_: sin este filtro IC_bueno=-0.200 (n=68)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.185 (n=1078)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 15.0 (IC base=+0.184)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.198 (n=646)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.219 (n=10882)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.164 (n=1851)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.269 (n=1729)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.285 (n=839)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.153 (n=2667)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 8.0 (IC base=+0.133)

- **PATRÓN** `lag_apertura_s` < `6.41` → IC=+0.153 (n=2375)

  - _Acción_: Kelly boost +0.76€ cuando `lag_apertura_s` < 6.41 (IC base=+0.133)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.211 (n=1002)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.166 (n=1320)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 8.0 (IC base=+0.138)

- **PATRÓN** `lag_apertura_s` < `7.07` → IC=+0.156 (n=1183)
...
- **PATRÓN** `restante_min` < `4.4` → IC=+0.131 (n=1195)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.141 (n=1200)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2113.8339` → IC=+0.324 (n=123)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2113.8339 (IC base=+0.281)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.201 (n=182)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=599)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.137 (n=1561)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0076 (IC base=+0.056)

- **PATRÓN** `ibs_20min` > `0.2752` → IC=+0.122 (n=3435)
...
- **PATRÓN** `volumen_regimen` > `1.0166` → IC=+0.214 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0166 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` < `0.1153` → IC=+0.186 (n=1544)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4956` → IC=+0.209 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4956 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `2.8719` → IC=+0.189 (n=528)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.8719 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.279 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 94.0 (IC base=+0.056)

- **PATRÓN** `ibs_20min` < `0.0909` → IC=+0.193 (n=1346)
...
- **PATRÓN** `dist_vwap_pct` < `0.2222` → IC=+0.216 (n=832)
...
- **PATRÓN** `dist_vwap_pct` > `0.5454` → IC=+0.147 (n=15)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.5454 (IC base=-0.044)

- **PATRÓN** `dist_vwap_pct` < `0.2627` → IC=+0.136 (n=105)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.2627 (IC base=-0.044)

- **PATRÓN** `volumen_regimen` < `0.5591` → IC=+0.235 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5591 (IC base=-0.044)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.147 (n=32)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.0678 (IC base=-0.044)

- **PATRÓN** `volumen_spike_ratio` < `1.9031` → IC=+0.203 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9031 (IC base=-0.044)

- **PATRÓN** `ballena_activa_n` < `265.0` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 265.0 (IC base=-0.044)
...
- **FILTRO** `ibs_20min` < `0.7576` → IC=-0.135 (n=502)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.232 (n=259)
...
- **PATRÓN** `ibs_20min` > `0.8824` → IC=+0.288 (n=191)
...
- **PATRÓN** `volumen_regimen` < `0.8541` → IC=+0.202 (n=149)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1127` → IC=+0.206 (n=212)
...
- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.197 (n=979)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `1.1446` → IC=+0.258 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1446 (IC base=+0.161)
...
- **PATRÓN** `volumen_regimen` > `0.6232` → IC=+0.171 (n=2028)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.6232 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2409` → IC=+0.194 (n=563)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2409 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `2.3191` → IC=+0.162 (n=2356)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.3191 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.8734` → IC=+0.156 (n=1785)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.8734 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=2325)
...
- **PATRÓN** `ballena_activa_n` < `161.0` → IC=+0.178 (n=1843)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1632` → IC=+0.206 (n=267)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.181 (n=726)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.197 (n=1551)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9365` → IC=+0.284 (n=1550)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9365 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `1.0648` → IC=+0.239 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0648 (IC base=+0.155)
...
- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.159 (n=1059)
...
- **PATRÓN** `dist_vwap_pct` < `0.4278` → IC=+0.178 (n=2289)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.4278 (IC base=+0.186)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.522` → IC=+0.192 (n=3072)
...
- **PATRÓN** `volumen_spike_ratio` > `2.34` → IC=+0.200 (n=1103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.34 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.172 (n=890)
...
- **PATRÓN** `ibs_20min` < `0.6` → IC=+0.190 (n=562)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` < `0.5076` → IC=+0.133 (n=526)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.5076 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.138` → IC=+0.132 (n=547)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 3.138 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `0.7113` → IC=+0.139 (n=247)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.7113 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` > `0.2055` → IC=+0.158 (n=74)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.2055 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` < `2.5014` → IC=+0.126 (n=412)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.5014 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2729.7668` → IC=+0.152 (n=254)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2729.7668 (IC base=+0.107)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0274` → IC=+0.222 (n=235)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0274 (IC base=+0.186)
...
- **PATRÓN** `volumen_regimen` > `0.8376` → IC=+0.208 (n=470)
...
- **PATRÓN** `sigma_h` < `0.0132` → IC=+0.128 (n=977)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0132 (IC base=+0.116)

- **PATRÓN** `drift_60min` |x|≤ `0.4477` → IC=+0.134 (n=858)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.2678` → IC=+0.138 (n=975)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.2678 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.552` → IC=+0.126 (n=896)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6893` → IC=+0.147 (n=321)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.6893 (IC base=+0.116)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.177 (n=1030)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=3160)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.215 (n=1020)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=3314)

- **FILTRO** `ibs_20min` > `0.2738` → IC=-0.175 (n=1082)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2738
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=3252)
...
- **FILTRO** `py_entrada` > `0.57` → IC=-0.218 (n=168)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=536)

- **FILTRO** `ballena_activa_n` > `72.0` → IC=-0.147 (n=171)

  - _Acción_: SKIP cuando `ballena_activa_n` > 72.0
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=533)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.191 (n=176)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=529)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.144 (n=3079)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.278 (n=2631)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=7956)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.231 (n=2640)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=7947)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.173 (n=3572)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=7015)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.228 (n=3018)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=10030)

- **FILTRO** `ibs_7min` > `0.7273` → IC=-0.168 (n=3261)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=9787)
...
- **FILTRO** `ibs_7min` > `0.8378` → IC=-0.182 (n=567)
...
- **FILTRO** `py_entrada` > `0.57` → IC=-0.206 (n=669)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1360)

- **FILTRO** `ballena_activa_n` > `98.0` → IC=-0.174 (n=689)

  - _Acción_: SKIP cuando `ballena_activa_n` > 98.0
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1340)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.198 (n=379)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `ibs_7min` < `0.2222` → IC=-0.283 (n=385)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1172)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.240 (n=382)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1175)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.158 (n=410)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=430)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=1358)

- **FILTRO** `ibs_7min` < `0.7615` → IC=-0.183 (n=446)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7615
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=1342)

- **FILTRO** `ballena_activa_n` > `39.0` → IC=-0.192 (n=440)

  - _Acción_: SKIP cuando `ballena_activa_n` > 39.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1348)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.262 (n=440)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1352)

- **FILTRO** `ibs_7min` > `0.1909` → IC=-0.174 (n=609)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1909
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=1183)

- **FILTRO** `ballena_activa_n` > `35.0` → IC=-0.189 (n=438)

  - _Acción_: SKIP cuando `ballena_activa_n` > 35.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1354)
...
- **FILTRO** `hora_utc` < `9.0` → IC=-0.128 (n=562)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
...
- **FILTRO** `py_entrada` < `0.37` → IC=-0.296 (n=420)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1297)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.227 (n=426)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.267 (n=469)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1789)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.163 (n=564)
...
- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.131 (n=740)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1518)
...
- **FILTRO** `streak_estiramiento` > `0.9261` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `streak_estiramiento` > 0.9261
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=1322)
...
- **FILTRO** `sigma_h` > `0.0101` → IC=-0.188 (n=277)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=833)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.126 (n=292)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=818)

- **FILTRO** `sigma_ewma_delta_pct` > `17.671` → IC=-0.176 (n=381)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.671
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=2934)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.346 (n=76)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
| ✅ BALLENAS_TARDIAS | 11734 | -0.102 | -1939.26€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 820 | -0.032 | -130.34€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 10914 | -0.107 | -1808.92€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#DOGE | 1522 | -0.140 | -443.83€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1522 | -0.140 | -443.83€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 3134 | -0.070 | -310.22€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 3134 | -0.070 | -310.22€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2712 | -0.109 | -271.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2712 | -0.109 | -271.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2033 | -0.173 | -487.56€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2033 | -0.173 | -487.56€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 1500 | -0.059 | +740.38€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 421 | -0.001 | +277.18€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 1079 | -0.081 | +463.20€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 1500 | -0.059 | +740.38€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 421 | -0.001 | +277.18€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 1079 | -0.081 | +463.20€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 37902 | +0.115 | -2349.51€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6737 | +0.185 | -253.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 117 | -0.088 | -49.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 27663 | +0.098 | -2004.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3385 | +0.120 | -42.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 4639 | +0.072 | -707.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 22 | -0.083 | +0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 4612 | +0.073 | -702.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 7729 | +0.133 | -166.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1919 | +0.198 | -94.74€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 4603 | +0.110 | -104.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1165 | +0.128 | +55.11€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 4650 | +0.083 | -542.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 24 | +0.077 | +2.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 4625 | +0.084 | -543.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 8296 | +0.127 | -127.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2458 | +0.168 | -20.80€ | 1 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 4606 | +0.113 | -73.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1220 | +0.101 | -24.74€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 7952 | +0.131 | -508.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2297 | +0.199 | -140.66€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#XRP | 4636 | +0.108 | -295.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 4617 | +0.109 | -294.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 6674 | +0.175 | -516.36€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 6674 | +0.175 | -516.36€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 133 | -0.115 | +1.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 133 | -0.115 | +1.70€ | 2 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1621 | +0.184 | -122.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1621 | +0.184 | -122.48€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 19721 | +0.192 | -1722.95€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 19721 | +0.192 | -1722.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 3568 | +0.135 | -613.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 3568 | +0.135 | -613.57€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 3092 | +0.233 | -75.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 3092 | +0.233 | -75.11€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 3136 | +0.227 | -105.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 3136 | +0.227 | -105.86€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 3324 | +0.184 | -336.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 3324 | +0.184 | -336.11€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 7194 | +0.133 | +260.42€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 7194 | +0.133 | +260.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 3584 | +0.138 | +159.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 3584 | +0.138 | +159.21€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 3610 | +0.128 | +101.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 3610 | +0.128 | +101.21€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 9198 | +0.095 | -332.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 874 | +0.066 | -30.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 8324 | +0.098 | -301.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 5883 | +0.097 | -131.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 874 | +0.066 | -30.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 5009 | +0.102 | -101.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 670 | +0.118 | +9.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 670 | +0.118 | +9.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 2645 | +0.086 | -209.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 2645 | +0.086 | -209.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 491 | +0.281 | -36.93€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 491 | +0.281 | -36.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 491 | +0.281 | -36.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 491 | +0.281 | -36.93€ | 0 | 4 |
| ✅ GBM_LATE_15M | 9064 | +0.045 | +3043.15€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 9064 | +0.045 | +3043.15€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL#15min | 1594 | -0.054 | +153.89€ | 6 | 3 |
| ✅ GBM_LATE_15M#XRP | 2103 | -0.073 | +249.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 