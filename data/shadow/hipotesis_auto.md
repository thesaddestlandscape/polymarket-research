# Hipótesis automáticas — 2026-07-01 20:47 UTC
_Generado por shadow_postmortem.py sobre 2467 resoluciones (PNL=-84.17€)_
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.255 (n=47)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0089 (IC base=+0.090)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.136 (n=20)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 15.0 (IC base=+0.090)

- **PATRÓN** `ibs_15` < `0.1215` → IC=+0.200 (n=38)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1215 (IC base=+0.090)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.1215 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.200 n=38). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 719 | -0.035 | -33.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 507 | -0.011 | -8.20€ | 2 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.123) — sin ventaja clara. oversold(IBS<0.3): IC=+0.025 n=97 | neutral: IC=-0.098 n=95 | overbought(IBS>0.7): IC=-0.023 n=128
  - _Datos_: n=329 IC=-0.029 PNL=-7.82€
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=-0.001 n=1158 | tras_1loss IC=-0.034 n=1219 | tras_2loss IC=-0.050 n=633/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=596 IC=-0.028 PNL=-19.50€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=596 IC=-0.028 PNL=-19.50€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=124 IC=+0.056 PNL=+19.66€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=124 IC=+0.056 PNL=+19.66€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 50/200 ops en el filtro definido (IC actual=+0.096 PNL=+8.75€)
  - _Datos_: n=50 IC=+0.096 PNL=+8.75€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 50/100 ops en el filtro definido (IC actual=+0.096 PNL=+8.75€)
  - _Datos_: n=50 IC=+0.096 PNL=+8.75€
