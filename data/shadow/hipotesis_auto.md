# Hipótesis automáticas — 2026-09-20 18:31 UTC
_Generado por shadow_postmortem.py sobre 530098 resoluciones (PNL=+58648.77€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.254 (n=466)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.254 (n=466)
...
- **PATRÓN** `banda_z` > `9.998` → IC=+0.222 (n=167)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 9.998 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.146 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 11.0 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=534)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `2870.3252` → IC=+0.143 (n=334)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 2870.3252 (IC base=+0.131)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.263 (n=365)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.263 (n=365)
...
- **PATRÓN** `banda_z` > `4.497` → IC=+0.171 (n=396)

  - _Acción_: Kelly boost +0.85€ cuando `banda_z` > 4.497 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.160 (n=286)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=449)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.91` → IC=-0.236 (n=6425)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.91
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19276)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.4` → IC=-0.243 (n=877)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.4
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2631)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `494.42` → IC=-0.153 (n=344)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 494.42
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1032)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `133.5` → IC=-0.276 (n=775)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.5
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=2327)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `160.38` → IC=-0.231 (n=1515)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.38
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4548)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.38` → IC=-0.366 (n=1269)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.38
  - _Potencial_: sin este filtro IC_bueno=-0.116 (n=3807)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.247 (n=330)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=378)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.185 (n=163)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.181 (n=67)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.198 (n=12917)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3226)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5470.7315` → IC=+0.174 (n=2053)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5470.7315 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.145 (n=10133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.235 (n=9852)
...
- **PATRÓN** `libro_liquidez` > `1663.3165` → IC=+0.159 (n=5958)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1663.3165 (IC base=+0.131)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1398)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=1921)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=2581)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.335 (n=846)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.144 (n=420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1300.2394` → IC=+0.148 (n=600)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.223 (n=648)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.86` → IC=+0.429 (n=575)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=1025)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=699)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.168)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.159 (n=285)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=10345)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3578)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2540)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.197 (n=2420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2062.8229` → IC=+0.441 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2062.8229 (IC base=+0.433)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.436 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.200 (n=30673)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.239 (n=11528)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=6255)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5709)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.71 (IC base=+0.174)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.226 (n=5484)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=2745)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.252 (n=2026)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.192)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.201 (n=4694)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.121)

- **PATRÓN** `restante_min` < `4.12` → IC=+0.131 (n=4324)

  - _Acción_: Kelly boost +0.65€ cuando `restante_min` < 4.12 (IC base=+0.121)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.146 (n=4488)
...
- **PATRÓN** `libro_liquidez` > `1588.4149` → IC=+0.295 (n=1020)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1588.4149 (IC base=+0.289)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.296 (n=316)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.332 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1485.2195` → IC=+0.313 (n=437)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1485.2195 (IC base=+0.294)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.445 (n=472)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1841.4992` → IC=+0.443 (n=399)
...
- **PATRÓN** `py_entrada` > `0.91` → IC=+0.437 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.91 (IC base=+0.439)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3535` → IC=+0.125 (n=6286)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3535 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9804` → IC=+0.240 (n=2384)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9804 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.2074` → IC=+0.247 (n=1527)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2074 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.914` → IC=+0.173 (n=2757)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 5.914 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.2124` → IC=+0.245 (n=1882)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2124 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.0518` → IC=+0.243 (n=854)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0518 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.3073` → IC=+0.210 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3073 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.9148` → IC=+0.204 (n=3213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9148 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5703` → IC=+0.132 (n=8642)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5703 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5635` → IC=+0.192 (n=582)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.5635 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.142` → IC=+0.172 (n=2692)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.142 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.703` → IC=+0.175 (n=1294)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.703 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8712` → IC=+0.173 (n=1960)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8712 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.1678` → IC=+0.224 (n=1423)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1678 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5829` → IC=+0.200 (n=4370)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5829 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `144.0` → IC=+0.211 (n=4673)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 144.0 (IC base=+0.062)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.180 (n=541)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.005 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.174 (n=541)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0081 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3367` → IC=+0.169 (n=1621)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3367 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=787)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.273 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.032` → IC=+0.274 (n=705)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8591` → IC=+0.245 (n=713)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8591 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1774.82` → IC=+0.244 (n=791)
...
- **PATRÓN** `drift_60min` |x|≤ `0.084` → IC=+0.254 (n=409)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.084 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.226 (n=1288)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` > `0.7303` → IC=+0.246 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7303 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` > `0.1856` → IC=+0.216 (n=640)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1856 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.129` → IC=+0.215 (n=929)
...
- **PATRÓN** `volumen_regimen` < `1.2524` → IC=+0.221 (n=1225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2524 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `0.8746` → IC=+0.214 (n=817)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3807` → IC=+0.216 (n=399)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.173 (n=432)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0026 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.157 (n=432)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.6835` → IC=+0.166 (n=1288)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.323` → IC=+0.160 (n=210)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.323 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.2049` → IC=+0.146 (n=1288)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2049 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `0.6202` → IC=+0.135 (n=1287)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6202 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.1569` → IC=+0.172 (n=345)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1569 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.147 (n=1178)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.7701` → IC=+0.143 (n=785)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.7701 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `413.0` → IC=+0.142 (n=1094)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 413.0 (IC base=+0.134)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.202 (n=1052)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.185 (n=1577)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.264 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.573` → IC=+0.237 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.573 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` < `0.1057` → IC=+0.190 (n=1351)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1057 (IC base=+0.184)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9206` → IC=+0.206 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9206 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1041)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.223 (n=1344)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.221 (n=1200)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0065 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.258 (n=506)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.0637` → IC=+0.242 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0637 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.554` → IC=+0.237 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.554 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.394` → IC=+0.219 (n=1470)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.394 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` > `0.3631` → IC=+0.272 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3631 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2771` → IC=+0.228 (n=810)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2771 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=834)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1863.0764` → IC=+0.228 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1863.0764 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.227 (n=790)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=1986)

- **PATRÓN** `ibs_20min` > `0.9377` → IC=+0.199 (n=323)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.9377 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.3391` → IC=+0.354 (n=121)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.619` → IC=+0.149 (n=627)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.619 (IC base=+0.019)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1749` → IC=+0.331 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1749 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.339 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 168.0 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.3065` → IC=+0.170 (n=219)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3065 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.8577` → IC=+0.150 (n=473)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.8577 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2242` → IC=+0.237 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2242 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` > `1.5133` → IC=+0.179 (n=586)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5133 (IC base=+0.009)

### GBM_LATE_15M#SOL#15min
- **FILTRO** `hora_utc` < `17.0` → IC=-0.155 (n=56)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 17.0
  - _Potencial_: sin este filtro IC_bueno=+0.089 (n=285)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=1973)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=974)

- **FILTRO** `sigma_ewma_delta_pct` > `8.632` → IC=-0.202 (n=320)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.632
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2627)

- **PATRÓN** `ibs_20min` > `0.7619` → IC=+0.231 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7619 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` > `0.9864` → IC=+0.295 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9864 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` < `0.5471` → IC=+0.269 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5471 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` < `0.6466` → IC=+0.261 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6466 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` > `1.1487` → IC=+0.329 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1487 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` < `0.0729` → IC=+0.308 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0729 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` < `2.2252` → IC=+0.298 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2252 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.300 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 48.0 (IC base=+0.048)

- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.126 (n=974)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.197 (n=394)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=1606)

- **FILTRO** `ibs_20min` > `0.7734` → IC=-0.204 (n=744)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7734
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2233)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0764` → IC=+0.296 (n=111)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0764 (IC base=-0.077)
...
- **PATRÓN** `dist_vwap_pct` > `0.9736` → IC=+0.295 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9736 (IC base=-0.023)

- **PATRÓN** `dist_vwap_pct` < `0.2681` → IC=+0.245 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2681 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` < `0.7367` → IC=+0.253 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7367 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` > `1.0812` → IC=+0.294 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0812 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.1054` → IC=+0.280 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1054 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `2.1883` → IC=+0.256 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1883 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.4611` → IC=+0.245 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4611 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.191 (n=2969)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.467` → IC=+0.186 (n=7951)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.467 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.9981` → IC=+0.286 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9981 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.546` → IC=+0.151 (n=4229)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.546 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1739` → IC=+0.231 (n=3107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1739 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.6824` → IC=+0.242 (n=2777)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6824 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.298` → IC=+0.261 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.298 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4754` → IC=+0.242 (n=1680)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4754 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.7084` → IC=+0.241 (n=1681)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7084 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.271 (n=4547)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.147 (n=3009)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0088 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5504` → IC=+0.150 (n=7930)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5504 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6733` → IC=+0.240 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6733 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1701` → IC=+0.236 (n=2345)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1701 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7166` → IC=+0.237 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7166 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.201` → IC=+0.244 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.201 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.2477` → IC=+0.310 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2477 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.6193` → IC=+0.252 (n=1478)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6193 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.3485` → IC=+0.260 (n=1521)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3485 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.263 (n=3226)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 81.0 (IC base=+0.070)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.47` → IC=-0.164 (n=477)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.47
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1605)

- **PATRÓN** `ibs_20min` > `0.8933` → IC=+0.273 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8933 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.671` → IC=+0.198 (n=336)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 8.671 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.2222` → IC=+0.281 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2222 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` < `1.4427` → IC=+0.188 (n=248)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.4427 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `2.5703` → IC=+0.204 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5703 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.183 (n=317)
...
- **FILTRO** `ibs_20min` > `0.8153` → IC=-0.149 (n=651)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8153
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1955)

- **PATRÓN** `ibs_20min` > `0.862` → IC=+0.157 (n=599)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.862 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.2926` → IC=+0.157 (n=313)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.2926 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `1.1952` → IC=+0.142 (n=808)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1952 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` > `0.6591` → IC=+0.149 (n=722)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6591 (IC base=+0.019)

- **PATRÓN** `volumen_pendiente_norm` > `0.2765` → IC=+0.195 (n=103)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2765 (IC base=+0.019)

- **PATRÓN** `volumen_spike_ratio` < `1.4243` → IC=+0.198 (n=263)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4243 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.188 (n=341)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 249.0 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.6013` → IC=+0.209 (n=53)
...
- **PATRÓN** `volumen_regimen` > `0.6047` → IC=+0.204 (n=484)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1933` → IC=+0.216 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1933 (IC base=-0.001)

- **PATRÓN** `ballena_activa_n` < `483.0` → IC=+0.204 (n=437)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1052` → IC=+0.247 (n=472)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1052 (IC base=+0.244)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.245 (n=704)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.244)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.576` → IC=+0.277 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.576 (IC base=+0.244)

- **PATRÓN** `volumen_pendiente_norm` < `0.1388` → IC=+0.259 (n=1245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1388 (IC base=+0.244)

- **PATRÓN** `volumen_spike_ratio` > `2.9575` → IC=+0.263 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9575 (IC base=+0.244)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=923)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1930.2584` → IC=+0.255 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1930.2584 (IC base=+0.244)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.265 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 16.0 (IC base=+0.244)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.306 (n=1003)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.285)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.327 (n=380)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.285)

- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.290 (n=1120)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3333 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.884` → IC=+0.302 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.884 (IC base=+0.285)

- **PATRÓN** `volumen_pendiente_norm` > `0.3447` → IC=+0.312 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3447 (IC base=+0.285)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2082` → IC=+0.288 (n=682)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2082 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.296 (n=691)
...
- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.286 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.285)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2689` → IC=-0.199 (n=427)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2689
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=1282)

- **FILTRO** `ibs_20min` > `0.7866` → IC=-0.178 (n=532)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7866
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1597)

- **PATRÓN** `ibs_20min` > `0.8045` → IC=+0.158 (n=582)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8045 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.4389` → IC=+0.218 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4389 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `1.0974` → IC=+0.224 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0974 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` > `0.6488` → IC=+0.210 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6488 (IC base=+0.004)
...
- **PATRÓN** `volumen_spike_ratio` < `2.091` → IC=+0.248 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.091 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.265 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 104.0 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.1468` → IC=+0.199 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1468 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` < `0.4803` → IC=+0.183 (n=364)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.4803 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` < `1.1494` → IC=+0.187 (n=337)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 1.1494 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `0.6712` → IC=+0.184 (n=337)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.6712 (IC base=-0.010)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8248` → IC=+0.229 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8248 (IC base=-0.010)

- **PATRÓN** `volumen_spike_ratio` > `2.1178` → IC=+0.265 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1178 (IC base=-0.010)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.232 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.010)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7` → IC=-0.211 (n=945)
...
- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.230 (n=498)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1495)

- **FILTRO** `sigma_ewma_delta_pct` > `4.656` → IC=-0.175 (n=444)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.656
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=1549)

- **PATRÓN** `ibs_20min` > `0.7` → IC=+0.273 (n=952)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7 (IC base=+0.032)

- **PATRÓN** `dist_vwap_pct` > `0.8055` → IC=+0.343 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8055 (IC base=+0.032)
...
- **PATRÓN** `volumen_regimen` < `0.8648` → IC=+0.295 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8648 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` > `0.6388` → IC=+0.285 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6388 (IC base=+0.032)

- **PATRÓN** `volumen_pendiente_norm` < `0.1047` → IC=+0.288 (n=631)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7981` → IC=+0.303 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7981 (IC base=+0.032)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.317 (n=576)
...
- **PATRÓN** `dist_vwap_pct` > `0.8315` → IC=+0.196 (n=77)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.8315 (IC base=+0.012)

- **PATRÓN** `dist_vwap_pct` < `0.4349` → IC=+0.212 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4349 (IC base=+0.012)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.271 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` < `0.0994` → IC=+0.209 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0994 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` > `0.2612` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2612 (IC base=+0.012)

- **PATRÓN** `volumen_spike_ratio` < `2.5144` → IC=+0.222 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5144 (IC base=+0.012)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.237 (n=436)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 57.0 (IC base=+0.012)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.318 (n=776)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.347 (n=778)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.274)

- **PATRÓN** `dist_vwap_pct` > `0.9332` → IC=+0.330 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9332 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.442` → IC=+0.300 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.442 (IC base=+0.274)

- **PATRÓN** `volumen_regimen` > `1.0362` → IC=+0.306 (n=528)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4382` → IC=+0.277 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4382 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` > `2.1737` → IC=+0.290 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1737 (IC base=+0.274)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.278 (n=1223)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.274)

- **PATRÓN** `libro_liquidez` > `2602.132` → IC=+0.287 (n=776)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2602.132 (IC base=+0.274)

- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.301 (n=856)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0147 (IC base=+0.271)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.280 (n=647)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3953` → IC=+0.306 (n=1284)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3953 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.5351` → IC=+0.284 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5351 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` < `0.8839` → IC=+0.271 (n=1462)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8839 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.455` → IC=+0.291 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.455 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` < `0.6388` → IC=+0.272 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6388 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `1.2419` → IC=+0.312 (n=428)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5298` → IC=+0.267 (n=1118)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5298 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1674` → IC=+0.272 (n=507)
...
- **PATRÓN** `libro_liquidez` > `2585.5176` → IC=+0.276 (n=856)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2585.5176 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.172 (n=2346)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.201 (n=2341)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0884` → IC=+0.186 (n=2339)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0884 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=7334)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5827` → IC=+0.217 (n=7014)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5827 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1676` → IC=+0.194 (n=3041)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1676 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.219` → IC=+0.255 (n=1441)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.219 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2153` → IC=+0.160 (n=4639)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2153 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6274` → IC=+0.157 (n=4638)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6274 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2462` → IC=+0.192 (n=1403)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2462 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5646` → IC=+0.171 (n=2947)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5646 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6447` → IC=+0.174 (n=2232)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6447 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3828.4706` → IC=+0.168 (n=2338)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3828.4706 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=5926)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.182 (n=4478)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.202 (n=2237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0794 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.207 (n=2247)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.475` → IC=+0.225 (n=6704)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.475 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2236` → IC=+0.159 (n=4929)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2236 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.199 (n=1136)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1778` → IC=+0.151 (n=4889)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1778 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2918` → IC=+0.225 (n=965)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2918 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5731` → IC=+0.166 (n=2656)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5731 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6424` → IC=+0.173 (n=2012)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.6424 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.171 (n=5672)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.193 (n=402)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0082 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.3322` → IC=+0.206 (n=1207)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3322 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.200 (n=595)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.304 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.044` → IC=+0.307 (n=547)
...
- **PATRÓN** `volumen_spike_ratio` > `1.429` → IC=+0.182 (n=1108)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.207 (n=346)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.186 (n=1094)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4176` → IC=+0.229 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4176 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.1985` → IC=+0.216 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1985 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.523` → IC=+0.231 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.523 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.169 (n=1036)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2629 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.196 (n=228)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2352 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.414` → IC=+0.205 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.414 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `15757.8757` → IC=+0.170 (n=470)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 15757.8757 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.194 (n=383)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0025 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2896` → IC=+0.153 (n=1141)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.2896 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=1051)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.5528` → IC=+0.183 (n=1141)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.883` → IC=+0.211 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.883 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.153 (n=1141)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2113 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1578` → IC=+0.155 (n=352)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1578 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.4443` → IC=+0.146 (n=1030)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4443 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.7587` → IC=+0.134 (n=687)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.7587 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.153 (n=318)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 221.0 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.223 (n=532)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0093 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.2073` → IC=+0.214 (n=781)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2073 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.223 (n=395)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.781` → IC=+0.273 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.781 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` < `0.2119` → IC=+0.194 (n=1130)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` < 0.2119 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `1.6529` → IC=+0.193 (n=369)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.6529 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.2791` → IC=+0.205 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2791 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `1935.7117` → IC=+0.204 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1935.7117 (IC base=+0.196)

- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.236 (n=968)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0106 (IC base=+0.223)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.223 (n=864)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.278 (n=341)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.223)

- **PATRÓN** `ibs_20min` < `0.3521` → IC=+0.251 (n=967)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3521 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.689` → IC=+0.277 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.689 (IC base=+0.223)

- **PATRÓN** `volumen_pendiente_norm` > `0.3598` → IC=+0.274 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3598 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` < `1.6425` → IC=+0.222 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6425 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` > `2.2601` → IC=+0.234 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2601 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `1865.08` → IC=+0.223 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1865.08 (IC base=+0.223)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.229 (n=304)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.162 (n=1114)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4324 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.163 (n=1115)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.202 (n=1113)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3963 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1493` → IC=+0.183 (n=743)
...
- **PATRÓN** `volumen_regimen` < `1.05` → IC=+0.156 (n=980)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.05 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.1917` → IC=+0.154 (n=371)
...
- **PATRÓN** `libro_liquidez` > `6834.4767` → IC=+0.187 (n=742)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6834.4767 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.151 (n=1052)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 169.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.159 (n=1176)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3804` → IC=+0.140 (n=1177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3804 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.183 (n=396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 18.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6129` → IC=+0.171 (n=1176)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6129 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3413` → IC=+0.138 (n=1270)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.3413 (IC base=+0.123)
...
- **PATRÓN** `volumen_regimen` < `0.8548` → IC=+0.142 (n=784)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8548 (IC base=+0.123)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4783` → IC=+0.139 (n=353)
...
- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.163 (n=579)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0099 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.202 (n=1276)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5156 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `1.0633` → IC=+0.216 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0633 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.127 (n=1277)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2233 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` < `0.1664` → IC=+0.129 (n=1272)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1664 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.8114` → IC=+0.132 (n=819)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.8114 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1328)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2888.477` → IC=+0.197 (n=579)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2888.477 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.134 (n=951)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.404` → IC=+0.156 (n=271)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.404 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `1.0447` → IC=+0.120 (n=1139)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.0447 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.276` → IC=+0.165 (n=159)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.276 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `1.4572` → IC=+0.139 (n=383)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4572 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `3069.3649` → IC=+0.157 (n=432)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3069.3649 (IC base=+0.110)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.207 (n=811)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.195)

- **PATRÓN** `drift_60min` |x|≤ `0.1691` → IC=+0.200 (n=535)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1691 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=1263)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 5.0 (IC base=+0.195)

- **PATRÓN** `ibs_20min` > `0.7321` → IC=+0.255 (n=1085)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7321 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` > `1.2055` → IC=+0.224 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2055 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.407` → IC=+0.240 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.407 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` < `1.209` → IC=+0.198 (n=1215)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.209 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` > `0.8586` → IC=+0.213 (n=810)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8586 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.2353` → IC=+0.270 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2353 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` < `2.1681` → IC=+0.207 (n=1029)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1681 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` > `1.8081` → IC=+0.201 (n=780)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8081 (IC base=+0.195)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.196 (n=1269)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.02 (IC base=+0.195)

- **PATRÓN** `libro_liquidez` > `2754.3868` → IC=+0.196 (n=551)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2754.3868 (IC base=+0.195)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.235 (n=428)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0083 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0223` → IC=+0.217 (n=581)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.223 (n=630)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4412` → IC=+0.244 (n=1280)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4412 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.1084` → IC=+0.223 (n=146)
...
- **PATRÓN** `volumen_regimen` > `0.6292` → IC=+0.216 (n=1280)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.197 (n=2976)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0109 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=9335)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=8935)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.895` → IC=+0.193 (n=1207)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.895 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.599` → IC=+0.225 (n=4357)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.599 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8816` → IC=+0.164 (n=3984)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8816 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.194 (n=1669)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6235` → IC=+0.186 (n=2849)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6235 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2322.8611` → IC=+0.167 (n=5951)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2322.8611 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6646)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.195 (n=3571)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0053 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1439` → IC=+0.185 (n=3571)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.1439 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3076)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.564` → IC=+0.238 (n=8109)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.564 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2359` → IC=+0.161 (n=5083)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2359 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.882` → IC=+0.201 (n=1147)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.882 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.699` → IC=+0.182 (n=7861)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.699 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7054` → IC=+0.158 (n=2471)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7054 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2031` → IC=+0.153 (n=1872)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2031 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.244 (n=1060)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.286` → IC=+0.190 (n=3341)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.286 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.198 (n=2331)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.211 (n=1015)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.3399` → IC=+0.194 (n=1519)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.3399 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.198 (n=733)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.321 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.46` → IC=+0.349 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.46 (IC base=+0.191)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5623` → IC=+0.209 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5623 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.193 (n=833)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.258 (n=1159)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.257)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.262 (n=1037)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.257)

- **PATRÓN** `drift_60min` |x|≤ `0.1263` → IC=+0.291 (n=510)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1263 (IC base=+0.257)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=1052)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.290 (n=1020)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8751` → IC=+0.278 (n=702)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0832` → IC=+0.166 (n=477)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0832 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=1490)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.3102` → IC=+0.201 (n=1425)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3102 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.182 (n=800)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.282` → IC=+0.150 (n=1278)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.282 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.6267` → IC=+0.178 (n=476)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6267 (IC base=+0.146)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1192` → IC=+0.157 (n=1206)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1192 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.4084` → IC=+0.152 (n=1371)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4084 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `13659.511` → IC=+0.150 (n=950)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 13659.511 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `482.0` → IC=+0.155 (n=1302)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 482.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.160 (n=1243)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0056 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0782` → IC=+0.176 (n=415)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.0782 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.175 (n=416)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 18.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.6433` → IC=+0.191 (n=1243)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6433 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6834` → IC=+0.162 (n=199)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.6834 (IC base=+0.147)
...
- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.159 (n=1243)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1888 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1509` → IC=+0.194 (n=338)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1509 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4305` → IC=+0.159 (n=1146)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4305 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7532` → IC=+0.157 (n=764)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7532 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `363.0` → IC=+0.157 (n=701)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 363.0 (IC base=+0.147)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.241 (n=651)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.221 (n=1505)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.6721` → IC=+0.255 (n=1283)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6721 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.736` → IC=+0.291 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.736 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.2146` → IC=+0.222 (n=1404)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2146 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.9089` → IC=+0.248 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9089 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.227 (n=944)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1934.9386` → IC=+0.223 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1934.9386 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.241 (n=1337)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.240 (n=1194)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.267 (n=504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.3651` → IC=+0.269 (n=1176)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3533` → IC=+0.296 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3533 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.791` → IC=+0.233 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.791 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.2286` → IC=+0.238 (n=807)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2286 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.252 (n=832)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1863.9984` → IC=+0.252 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1863.9984 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.245 (n=763)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4329` → IC=+0.142 (n=1524)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4329 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.148 (n=1598)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.8802` → IC=+0.262 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8802 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.3559` → IC=+0.171 (n=599)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3559 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.201` → IC=+0.159 (n=634)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.201 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8781` → IC=+0.159 (n=1016)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5223` → IC=+0.153 (n=647)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5223 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4148` → IC=+0.147 (n=1470)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4148 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `8151.5866` → IC=+0.229 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8151.5866 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.150 (n=466)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 81.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.157 (n=1235)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0075 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4369` → IC=+0.150 (n=1235)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4369 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.172 (n=464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6897` → IC=+0.190 (n=1235)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6897 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.3578` → IC=+0.140 (n=1243)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3578 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.009` → IC=+0.194 (n=184)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 11.009 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.6987` → IC=+0.145 (n=544)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6987 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.145 (n=412)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1808 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2798` → IC=+0.264 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2798 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4412` → IC=+0.153 (n=1164)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4412 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `11032.6717` → IC=+0.208 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11032.6717 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `184.0` → IC=+0.142 (n=1157)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 184.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.130 (n=1011)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0079 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.165 (n=565)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 17.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.4694` → IC=+0.186 (n=1515)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4694 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `1.0378` → IC=+0.191 (n=283)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 1.0378 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.399` → IC=+0.227 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.399 (IC base=+0.104)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=1052)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `2907.4324` → IC=+0.244 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2907.4324 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.125 (n=1135)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1277` → IC=+0.152 (n=495)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1277 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1539)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.204 (n=1487)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.213` → IC=+0.128 (n=1209)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.213 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.126 (n=1433)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.155 (n=653)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7176 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.2234` → IC=+0.174 (n=231)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.2234 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.142 (n=442)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.212 (n=1008)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.207 (n=1580)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5124` → IC=+0.244 (n=1512)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5124 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.1878` → IC=+0.224 (n=864)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1878 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.484` → IC=+0.247 (n=722)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.484 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.0765` → IC=+0.202 (n=1331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0765 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6344` → IC=+0.209 (n=1512)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6344 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.236` → IC=+0.236 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.236 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `2.5326` → IC=+0.231 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5326 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=1559)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2596.7996` → IC=+0.211 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2596.7996 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.233 (n=552)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0085 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0172` → IC=+0.213 (n=1102)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0172 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.210 (n=808)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.200)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1750)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.52` → IC=+0.257 (n=1654)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.52 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.8337` → IC=+0.204 (n=1851)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8337 (IC base=+0.200)
...
- **PATRÓN** `volumen_regimen` > `1.2323` → IC=+0.238 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2323 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2826` → IC=+0.256 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2826 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2192` → IC=+0.197 (n=1296)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2192 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.443` → IC=+0.200 (n=1471)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.443 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.210 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `2569.2034` → IC=+0.202 (n=1102)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2569.2034 (IC base=+0.200)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.134 (n=2783)

- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.156 (n=2697)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0112 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.52` → IC=+0.159 (n=2695)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.52 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.161 (n=1078)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1876` → IC=+0.161 (n=941)
...
- **PATRÓN** `volumen_regimen` > `0.9029` → IC=+0.162 (n=1125)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.9029 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8927` → IC=+0.162 (n=1778)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8927 (IC base=+0.149)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4768` → IC=+0.153 (n=2099)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4768 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.168 (n=772)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1742` → IC=+0.161 (n=924)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1742 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.6865` → IC=+0.141 (n=391)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6865 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.4314` → IC=+0.125 (n=2083)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.4314 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.261` → IC=+0.140 (n=2085)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.261 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.9017` → IC=+0.147 (n=1332)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.9017 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.145 (n=985)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.4293` → IC=+0.139 (n=693)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4293 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.8156` → IC=+0.139 (n=1385)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.8156 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2783)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7454.6788` → IC=+0.144 (n=1875)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 7454.6788 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.154 (n=50)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 1.0 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.185` → IC=+0.167 (n=58)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.185 (IC base=+0.037)

- **PATRÓN** `volumen_pendiente_norm` > `0.1563` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1563 (IC base=+0.037)

- **PATRÓN** `ibs_20min` < `0.0333` → IC=+0.200 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0333 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` > `0.6027` → IC=+0.162 (n=63)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.6027 (IC base=+0.042)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=806)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.5881` → IC=+0.198 (n=686)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5881 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3424` → IC=+0.178 (n=256)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.3424 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.859` → IC=+0.195 (n=290)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 6.859 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` > `0.975` → IC=+0.133 (n=311)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.975 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.2867` → IC=+0.208 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2867 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` < `2.116` → IC=+0.158 (n=507)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.116 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` > `1.4086` → IC=+0.137 (n=576)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4086 (IC base=+0.104)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.135 (n=559)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `2438.1282` → IC=+0.152 (n=300)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2438.1282 (IC base=+0.104)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.178 (n=268)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0059 (IC base=+0.109)

- **PATRÓN** `ibs_20min` > `0.5781` → IC=+0.199 (n=237)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5781 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.1249` → IC=+0.177 (n=122)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1249 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `1.0529` → IC=+0.133 (n=208)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.0529 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.150 (n=175)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0677 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` > `0.2625` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.2625 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.193 (n=174)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.109)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=242)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2997.8142` → IC=+0.122 (n=199)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2997.8142 (IC base=+0.109)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.133 (n=107)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0059 (IC base=+0.080)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.136 (n=174)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 13.0 (IC base=+0.080)

- **PATRÓN** `ibs_20min` > `0.6324` → IC=+0.170 (n=213)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.6324 (IC base=+0.080)

- **PATRÓN** `dist_vwap_pct` > `0.1941` → IC=+0.159 (n=121)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1941 (IC base=+0.080)
...
- **PATRÓN** `volumen_regimen` > `1.0588` → IC=+0.158 (n=71)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.0588 (IC base=+0.080)

- **PATRÓN** `volumen_pendiente_norm` > `0.0865` → IC=+0.200 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0865 (IC base=+0.080)

- **PATRÓN** `volumen_spike_ratio` < `2.1768` → IC=+0.140 (n=170)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.1768 (IC base=+0.080)

- **PATRÓN** `volumen_spike_ratio` > `1.5298` → IC=+0.129 (n=173)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.5298 (IC base=+0.080)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.151 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 16.0 (IC base=+0.111)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.129 (n=585)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.111)
...
- **FILTRO** `py_entrada` < `0.44` → IC=-0.143 (n=208)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=459)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7201)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3017)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=9434)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3131)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9774)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.220 (n=516)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1626)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.171 (n=539)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1764)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=1288)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.203 (n=543)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=1632)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.204 (n=569)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1724)

- **FILTRO** `ibs_20min` > `0.2846` → IC=-0.159 (n=573)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2846
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1720)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.475` → IC=-0.193 (n=526)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1585)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.178 (n=572)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1724)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2596)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=709)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=19939)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.278 (n=6940)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=21891)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.236 (n=7201)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21630)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9748)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19083)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.228 (n=8997)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=27103)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=9016)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27084)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=1124)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3588)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.256 (n=1554)
...
- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.179 (n=1142)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3570)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.152 (n=4192)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=2043)

- **FILTRO** `drift_7min_pct` |x|> `0.1116` → IC=-0.127 (n=2118)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1116
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4117)

- **FILTRO** `ibs_7min` > `0.7945` → IC=-0.205 (n=1556)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7945
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4679)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3841)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=1209)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3799)

- **FILTRO** `ibs_7min` < `0.752` → IC=-0.188 (n=1252)

  - _Acción_: SKIP cuando `ibs_7min` < 0.752
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3756)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.173 (n=1251)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3757)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1243)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=3825)

- **FILTRO** `ibs_7min` > `0.2584` → IC=-0.171 (n=1266)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2584
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3802)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1259)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3809)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.170 (n=1263)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3189)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.310 (n=1080)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3372)

- **FILTRO** `ibs_7min` < `0.1972` → IC=-0.258 (n=1113)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1972
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3339)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1086)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3366)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1542)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5071)

- **FILTRO** `ibs_7min` > `0.76` → IC=-0.175 (n=1650)

  - _Acción_: SKIP cuando `ibs_7min` > 0.76
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=4963)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3223)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.248 (n=1163)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3578)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.181 (n=1185)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3556)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.179 (n=1154)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3587)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1209)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3652)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.173 (n=1214)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3647)

- **FILTRO** `ballena_activa_n` > `29.0` → IC=-0.186 (n=1215)

  - _Acción_: SKIP cuando `ballena_activa_n` > 29.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3646)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.267 (n=1187)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=3905)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.230 (n=1270)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3822)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1654)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=5194)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.280 (n=1113)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3713)

- **FILTRO** `ibs_7min` < `0.71` → IC=-0.232 (n=1205)

  - _Acción_: SKIP cuando `ibs_7min` < 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3621)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1161)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3665)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1607)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4868)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.032 (n=648)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1627` → IC=+0.192 (n=1204)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2175` → IC=+0.186 (n=457)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `delta_ratio_macro` |x|> 0.2175 (IC base=+0.185)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.196 (n=966)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6136` → IC=+0.260 (n=1367)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6136 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` > `0.4417` → IC=+0.184 (n=318)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.4417 (IC base=+0.185)
...
- **PATRÓN** `libro_liquidez` > `2964.2504` → IC=+0.193 (n=911)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.213 (n=594)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1784)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.188 (n=768)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1610)

- **FILTRO** `libro_liquidez` < `3902.9946` → IC=-0.133 (n=1569)

  - _Acción_: SKIP cuando `libro_liquidez` < 3902.9946
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=809)
...
- **PATRÓN** `dist_vwap_pct` > `0.5593` → IC=+0.176 (n=106)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.5593 (IC base=-0.058)

- **PATRÓN** `dist_vwap_pct` < `0.1102` → IC=+0.185 (n=360)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1102 (IC base=-0.058)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1175` → IC=+0.238 (n=960)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1175 (IC base=-0.039)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1804` → IC=+0.237 (n=923)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1804 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.3542` → IC=+0.279 (n=1438)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.