# Hipótesis automáticas — 2026-07-10 20:12 UTC
_Generado por shadow_postmortem.py sobre 8075 resoluciones (PNL=+1213.08€)_
...
- **PATRÓN** `ibs_15` > `0.7159` → IC=+0.126 (n=188)
  ...
  - _Acción_: Kelly boost +0.63€ cuando `ibs_15` > 0.7159 (IC base=-0.002)
...
- **PATRÓN** `ibs_15` > `0.7529` → IC=+0.180 (n=73)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` > 0.7529 (IC base=+0.014)
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#BTC#15min` — IC=+0.243 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#ETH#15min` — IC=+0.257 n=35. Faltan ~5 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#SOL#15min` — IC=+0.122 n=35. Faltan ~5 resoluciones para umbral n≥40. ETA: ~4h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 162 | +0.195 | -1.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 103 | +0.214 | -2.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 7 | +0.058 | +0.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 25 | +0.018 | -3.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 27 | +0.259 | +3.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 51 | +0.198 | -0.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 33 | +0.243 | +0.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 7 | -0.058 | -2.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 9 | +0.102 | +1.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 55 | +0.219 | +2.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 35 | +0.257 | +3.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 9 | +0.061 | -0.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 9 | +0.102 | +1.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 56 | +0.155 | -4.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 35 | +0.122 | -5.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 9 | +0.021 | -0.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 9 | +0.102 | +0.95€ | 0 | 0 |
| ✅ GBM_LATE_15M | 2981 | +0.115 | +966.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2981 | +0.115 | +966.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 749 | +0.061 | +76.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 749 | +0.061 | +76.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 759 | +0.076 | +122.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 759 | +0.076 | +122.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 769 | +0.150 | +402.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 769 | +0.150 | +402.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 704 | +0.174 | +365.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 704 | +0.174 | +365.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 424 | +0.169 | +181.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 424 | +0.169 | +181.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 104 | +0.198 | +50.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 104 | +0.198 | +50.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 115 | +0.158 | +46.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 115 | +0.158 | +46.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 120 | +0.074 | +13.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 120 | +0.074 | +13.37€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 527 | +0.067 | +87.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 527 | +0.067 | +87.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 125 | +0.083 | +10.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 125 | +0.083 | +10.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 133 | +0.011 | +2.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 133 | +0.011 | +2.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 132 | -0.037 | -1.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 132 | -0.037 | -1.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 137 | +0.205 | +75.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 137 | +0.205 | +75.02€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1233 | -0.017 | -7.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 978 | +0.012 | +29.39€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 591 | +0.006 | +20.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 498 | +0.026 | +31.74€ | 0 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.107) — sin ventaja clara. oversold(IBS<0.3): IC=-0.022 n=312 | neutral: IC=-0.061 n=237 | overbought(IBS>0.7): IC=+0.046 n=256
  - _Datos_: n=843 IC=-0.005 PNL=+17.67€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.074 n=4373 | tras_1loss IC=+0.027 n=3521 | tras_2loss IC=-0.011 n=1642/40 | gap=+0.085 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1110 IC=-0.011 PNL=+5.99€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1110 IC=-0.011 PNL=+5.99€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=550 IC=-0.002 PNL=-4.96€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=550 IC=-0.002 PNL=-4.96€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5617 IC=+0.085 PNL=+1288.96€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5617 IC=+0.085 PNL=+1288.96€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=697 IC=-0.034 PNL=-35.43€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=697 IC=-0.034 PNL=-35.43€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=206 PNL=+65.28€
  - _Datos_: n=206 IC=+0.159 PNL=+65.28€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=387 IC=+0.045 PNL=+28.26€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=387 IC=+0.045 PNL=+28.26€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.08 con n=146 PNL=+41.28€
  - _Datos_: n=146 IC=+0.162 PNL=+41.28€
