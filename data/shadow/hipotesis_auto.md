# Hipótesis automáticas — 2026-07-02 19:48 UTC
_Generado por shadow_postmortem.py sobre 2811 resoluciones (PNL=-55.26€)_
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.220 (n=73)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.038)

- **PATRÓN** `ibs_15` < `0.0669` → IC=+0.179 (n=51)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` < 0.0669 (IC base=+0.038)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0669 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.179 n=51). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 184 | +0.107 | +39.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 184 | +0.107 | +39.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 49 | +0.108 | +11.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 49 | +0.108 | +11.97€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 41 | +0.174 | +14.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 41 | +0.174 | +14.38€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 838 | -0.042 | -51.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 610 | -0.020 | -23.36€ | 1 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.059) — sin ventaja clara. oversold(IBS<0.3): IC=-0.013 n=150 | neutral: IC=-0.072 n=136 | overbought(IBS>0.7): IC=-0.047 n=148
  - _Datos_: n=448 IC=-0.042 PNL=-26.00€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.009 n=1341 | tras_1loss IC=-0.031 n=1379 | tras_2loss IC=-0.045 n=714/40 | gap=+0.054 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.038 n=117/40 PNL=+0.58€ | H=15h UTC: IC=+0.017 n=116/40 PNL=+5.20€ | H=17h UTC: IC=+0.200 n=58/40 PNL=+21.47€ | H=19h UTC: IC=-0.007 n=71/40 PNL=-7.54€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=715 IC=-0.037 PNL=-37.68€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=715 IC=-0.037 PNL=-37.68€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=201 IC=+0.012 PNL=+11.44€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=201 IC=+0.012 PNL=+11.44€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=385 IC=+0.056 PNL=+34.91€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=385 IC=+0.056 PNL=+34.91€
