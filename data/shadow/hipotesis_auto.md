# Hipótesis automáticas — 2026-09-23 05:44 UTC
_Generado por shadow_postmortem.py sobre 568777 resoluciones (PNL=+63675.81€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.3` → IC=-0.231 (n=6826)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.3
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=20478)
...
- **FILTRO** `restante_s_al_confirmar` < `134.15` → IC=-0.282 (n=843)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.15
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2530)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `163.66` → IC=-0.229 (n=1620)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 163.66
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4862)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.16` → IC=-0.358 (n=1364)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.16
  - _Potencial_: sin este filtro IC_bueno=-0.124 (n=4095)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.229 (n=352)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=407)

- **FILTRO** `py_entrada` > `0.54` → IC=-0.181 (n=233)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.183 (n=77)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.202 (n=13495)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=3385)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5598.1652` → IC=+0.175 (n=2158)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.136 (n=13365)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.127)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.232 (n=10509)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5508)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7710.748` → IC=+0.172 (n=2073)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7710.748 (IC base=+0.127)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1657)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1629)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.351 (n=752)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2049)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15828.4498` → IC=+0.231 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15828.4498 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.204 (n=1622)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.263 (n=1475)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=2078)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `13974.4909` → IC=+0.208 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13974.4909 (IC base=+0.199)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `py_entrada` > `0.59` → IC=+0.167 (n=454)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.59 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `4624.034` → IC=+0.146 (n=235)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 4624.034 (IC base=+0.105)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.144 (n=341)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 7.0 (IC base=+0.107)

- **PATRÓN** `py_entrada` < `0.44` → IC=+0.146 (n=798)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.145 (n=2322)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.240 (n=1446)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.144 (n=574)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=521)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `1302.4168` → IC=+0.151 (n=635)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1302.4168 (IC base=+0.138)
...
- **PATRÓN** `py_entrada` < `0.355` → IC=+0.196 (n=370)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=10541)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3710)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2549)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.184 (n=1864)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.254 (n=758)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.188 (n=2516)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.198 (n=2461)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 17.0 (IC base=+0.195)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.199 (n=1883)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.232 (n=17757)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.199)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6639)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.180 (n=5621)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 15.0 (IC base=+0.176)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.191 (n=6092)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.227 (n=5842)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.224)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.275 (n=2102)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.263 (n=2052)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4783` → IC=+0.121 (n=7710)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4783 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9825` → IC=+0.242 (n=2569)
...
- **PATRÓN** `dist_vwap_pct` < `0.6284` → IC=+0.247 (n=2137)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6284 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.932` → IC=+0.177 (n=2968)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3051` → IC=+0.217 (n=769)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3051 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.9077` → IC=+0.206 (n=3505)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9077 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5703` → IC=+0.132 (n=9280)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5703 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.5918` → IC=+0.193 (n=718)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.5918 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.1486` → IC=+0.172 (n=2862)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1486 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.6996` → IC=+0.177 (n=1415)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6996 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `0.869` → IC=+0.175 (n=2144)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.869 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.221 (n=1538)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` > `1.576` → IC=+0.201 (n=4804)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.576 (IC base=+0.063)

- **PATRÓN** `ballena_activa_n` < `137.0` → IC=+0.210 (n=5159)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 137.0 (IC base=+0.063)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.181 (n=587)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.005 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.173 (n=582)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0082 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.347` → IC=+0.166 (n=1744)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.173 (n=1168)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.105` → IC=+0.272 (n=751)
...
- **PATRÓN** `ibs_20min` < `0.0603` → IC=+0.295 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0603 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.394` → IC=+0.248 (n=1349)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.394 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.231 (n=1106)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6252` → IC=+0.249 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6252 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1792.11` → IC=+0.240 (n=863)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1792.11 (IC base=+0.235)

- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.230 (n=1001)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.215 (n=1353)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.1985` → IC=+0.223 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1985 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` < `0.7362` → IC=+0.218 (n=1463)
...
- **PATRÓN** `volumen_regimen` < `1.2554` → IC=+0.218 (n=1330)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2554 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.227 (n=603)
...
- **PATRÓN** `libro_liquidez` > `12297.8729` → IC=+0.218 (n=1188)
...
- **PATRÓN** `ibs_20min` < `0.6911` → IC=+0.170 (n=1378)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6911 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1307` → IC=+0.157 (n=1212)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1307 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.204` → IC=+0.162 (n=223)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 11.204 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.236` → IC=+0.141 (n=1253)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 4.236 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.2035` → IC=+0.149 (n=1378)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2035 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `0.8504` → IC=+0.138 (n=919)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.8504 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1573` → IC=+0.175 (n=370)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1573 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4238` → IC=+0.150 (n=1268)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.4238 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.7701` → IC=+0.147 (n=845)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7701 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `13949.082` → IC=+0.145 (n=919)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 13949.082 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.147 (n=1189)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 411.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.210 (n=773)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0099 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.189 (n=1788)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 5.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=1523)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_spike_ratio` > `2.221` → IC=+0.223 (n=881)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.221 (IC base=+0.215)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.223 (n=962)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `1869.8832` → IC=+0.229 (n=658)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1869.8832 (IC base=+0.215)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.215 (n=1104)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=96)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2131)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1787` → IC=+0.319 (n=247)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1787 (IC base=+0.021)
...
- **PATRÓN** `volumen_regimen` < `0.8509` → IC=+0.157 (n=525)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8509 (IC base=+0.014)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5154` → IC=+0.176 (n=656)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.5154 (IC base=+0.014)
...
- **FILTRO** `ibs_20min` > `0.2576` → IC=-0.125 (n=2107)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2576
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1038)

- **FILTRO** `sigma_ewma_delta_pct` > `8.653` → IC=-0.204 (n=339)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.653
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2806)
...
- **PATRÓN** `ibs_20min` < `0.2576` → IC=+0.124 (n=1038)
...
- **PATRÓN** `volumen_regimen` < `1.0999` → IC=+0.224 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0999 (IC base=-0.043)

- **PATRÓN** `volumen_regimen` > `0.9027` → IC=+0.215 (n=226)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4773` → IC=+0.261 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4773 (IC base=-0.043)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6469` → IC=-0.185 (n=538)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6469
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1616)

- **FILTRO** `ibs_20min` < `0.705` → IC=-0.159 (n=1421)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.200 (n=401)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1753)

- **FILTRO** `ibs_20min` > `0.7727` → IC=-0.203 (n=797)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=2393)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4721` → IC=+0.240 (n=1849)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4721 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.686` → IC=+0.237 (n=1849)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.686 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.268 (n=5066)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.148 (n=3212)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.009 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.5494` → IC=+0.151 (n=8473)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5494 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.2434` → IC=+0.239 (n=2622)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2434 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.236 (n=1238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.249 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2035 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.303 (n=702)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` < `1.6124` → IC=+0.254 (n=1618)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6124 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.3305` → IC=+0.258 (n=1668)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3305 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.261 (n=3550)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.071)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.493` → IC=-0.169 (n=508)
...
- **PATRÓN** `dist_vwap_pct` < `0.16` → IC=+0.219 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.16 (IC base=+0.001)

- **PATRÓN** `volumen_regimen` > `0.6093` → IC=+0.213 (n=525)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1626` → IC=+0.232 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1626 (IC base=+0.001)

- **PATRÓN** `ballena_activa_n` < `477.0` → IC=+0.217 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 477.0 (IC base=+0.001)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.289 (n=509)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.248 (n=1536)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1382` → IC=+0.257 (n=1353)
...
- **PATRÓN** `volumen_spike_ratio` > `3.4481` → IC=+0.259 (n=480)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4481 (IC base=+0.245)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.245)

- **PATRÓN** `libro_liquidez` > `1943.8205` → IC=+0.255 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1943.8205 (IC base=+0.245)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.307 (n=806)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.5945` → IC=+0.284 (n=1206)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0909` → IC=+0.289 (n=807)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0909 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.808` → IC=+0.299 (n=471)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3433` → IC=+0.307 (n=185)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3433 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` < `1.6063` → IC=+0.282 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6063 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.7856` → IC=+0.286 (n=503)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7856 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.291 (n=793)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1862.8007` → IC=+0.296 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1862.8007 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.286 (n=712)
...
- **FILTRO** `ibs_20min` > `0.7766` → IC=-0.185 (n=570)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7766
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1711)
...
- **PATRÓN** `dist_vwap_pct` > `0.1485` → IC=+0.207 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1485 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` < `0.636` → IC=+0.193 (n=441)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.636 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` < `1.1607` → IC=+0.205 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1607 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` > `0.7182` → IC=+0.192 (n=349)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8289` → IC=+0.253 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8289 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` > `2.1518` → IC=+0.250 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1518 (IC base=-0.007)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.246 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=-0.007)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7176` → IC=-0.200 (n=1022)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7176
  - _Potencial_: sin este filtro IC_bueno=+0.278 (n=1023)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.230 (n=535)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=1607)

- **FILTRO** `sigma_ewma_delta_pct` > `4.685` → IC=-0.178 (n=467)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.685
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=1675)

- **PATRÓN** `ibs_20min` > `0.7176` → IC=+0.278 (n=1023)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.526` → IC=+0.157 (n=327)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.526 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` < `0.8648` → IC=+0.299 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8648 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` > `0.6398` → IC=+0.289 (n=751)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6398 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` < `0.1034` → IC=+0.293 (n=698)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5113` → IC=+0.221 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5113 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.236 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=+0.014)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0167` → IC=+0.319 (n=838)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0167 (IC base=+0.279)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.299 (n=590)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.279)

- **PATRÓN** `ibs_20min` > `0.63` → IC=+0.313 (n=1258)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.63 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.2012` → IC=+0.319 (n=759)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2012 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.503` → IC=+0.306 (n=664)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.503 (IC base=+0.279)

- **PATRÓN** `volumen_regimen` > `0.8624` → IC=+0.305 (n=838)
...
- **PATRÓN** `ibs_20min` < `0.4773` → IC=+0.226 (n=7157)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4773 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2286` → IC=+0.159 (n=5157)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2286 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.242` → IC=+0.193 (n=1216)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 10.242 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1752` → IC=+0.151 (n=5202)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1752 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2911` → IC=+0.222 (n=1029)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2911 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5675` → IC=+0.163 (n=2852)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.5675 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.2623` → IC=+0.171 (n=2939)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.2623 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.172 (n=6117)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3424` → IC=+0.204 (n=1294)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3424 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.195 (n=864)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.107` → IC=+0.312 (n=584)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.181 (n=1194)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.182)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.238 (n=812)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.238)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.253 (n=827)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.1839` → IC=+0.294 (n=615)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1839 (IC base=+0.238)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.244 (n=942)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.238)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.246 (n=458)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.238)

- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.263 (n=922)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.215` → IC=+0.250 (n=917)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.215 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0955` → IC=+0.235 (n=765)
...
- **PATRÓN** `volumen_spike_ratio` < `1.507` → IC=+0.257 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.507 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1958.455` → IC=+0.258 (n=308)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1958.455 (IC base=+0.238)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.235 (n=379)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.0745` → IC=+0.201 (n=376)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4088` → IC=+0.225 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4088 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.2079` → IC=+0.212 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2079 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.501` → IC=+0.237 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.501 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.2679` → IC=+0.163 (n=1126)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2679 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `1.0767` → IC=+0.170 (n=510)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0767 (IC base=+0.161)
...
- **PATRÓN** `libro_liquidez` > `15860.9645` → IC=+0.164 (n=510)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 15860.9645 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.195 (n=411)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0026 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.2896` → IC=+0.158 (n=1223)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5636` → IC=+0.183 (n=1223)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5636 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.160 (n=1199)
...
- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.154 (n=1223)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1334` → IC=+0.201 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1334 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `2.8719` → IC=+0.209 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8719 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `1948.68` → IC=+0.200 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1948.68 (IC base=+0.199)
...
- **PATRÓN** `ibs_20min` < `0.2417` → IC=+0.256 (n=910)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2417 (IC base=+0.221)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.729` → IC=+0.270 (n=437)
...
- **PATRÓN** `volumen_spike_ratio` > `2.221` → IC=+0.229 (n=636)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.221 (IC base=+0.221)

- **PATRÓN** `libro_liquidez` > `1872.8576` → IC=+0.228 (n=469)
...
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.209 (n=403)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0036 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.4314` → IC=+0.160 (n=1208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3812` → IC=+0.196 (n=1208)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5308` → IC=+0.172 (n=394)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5308 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `6943.592` → IC=+0.185 (n=805)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6943.592 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.145 (n=1149)
...
- **PATRÓN** `drift_60min` |x|≤ `0.383` → IC=+0.142 (n=1263)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6258` → IC=+0.170 (n=1263)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6258 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.5667` → IC=+0.133 (n=1449)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.5667 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.879` → IC=+0.173 (n=444)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.879 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8503` → IC=+0.143 (n=842)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7906` → IC=+0.129 (n=763)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.7906 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4847` → IC=+0.135 (n=382)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.4847 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9950.2818` → IC=+0.161 (n=573)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 9950.2818 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.159 (n=620)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0101 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=1397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 5.0 (IC base=+0.118)

- **PATRÓN** `ibs_20min` > `0.5167` → IC=+0.203 (n=1367)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5167 (IC base=+0.118)

- **PATRÓN** `dist_vwap_pct` > `0.8335` → IC=+0.217 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8335 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.694` → IC=+0.254 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.694 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.130 (n=1367)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2233 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.638` → IC=+0.122 (n=1367)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.638 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` < `0.1651` → IC=+0.131 (n=1374)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1651 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.4429` → IC=+0.145 (n=440)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4429 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1432)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.195 (n=620)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2898.7698 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.137 (n=1046)
...
- **PATRÓN** `drift_60min` |x|≤ `0.103` → IC=+0.151 (n=459)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.103 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.208 (n=1375)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.7314` → IC=+0.136 (n=278)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.7314 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.1957` → IC=+0.137 (n=1251)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1957 (IC base=+0.111)
...
- **PATRÓN** `volumen_regimen` < `1.1848` → IC=+0.120 (n=1375)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.1848 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.277` → IC=+0.173 (n=166)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.277 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.4306` → IC=+0.130 (n=409)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.4306 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3081.0348` → IC=+0.157 (n=459)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3081.0348 (IC base=+0.111)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0189` → IC=+0.215 (n=873)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.207 (n=596)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.203)

- **PATRÓN** `ibs_20min` > `0.7386` → IC=+0.261 (n=1170)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7386 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.5008` → IC=+0.219 (n=636)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5008 (IC base=+0.203)
...
- **PATRÓN** `volumen_regimen` < `1.2102` → IC=+0.206 (n=1310)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2102 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.8596` → IC=+0.223 (n=873)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8596 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.234` → IC=+0.270 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.234 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `2.1554` → IC=+0.217 (n=1113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1554 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4098` → IC=+0.208 (n=1264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4098 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.206 (n=1388)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2801.4478` → IC=+0.206 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2801.4478 (IC base=+0.203)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.236 (n=448)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0085 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0224` → IC=+0.214 (n=609)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0224 (IC base=+0.204)

- **PATRÓN** `drift_60min` |x|≤ `0.089` → IC=+0.221 (n=449)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.213 (n=621)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.247 (n=1344)
...
- **PATRÓN** `dist_vwap_pct` < `0.8659` → IC=+0.204 (n=1556)
...
- **PATRÓN** `volumen_regimen` > `0.6303` → IC=+0.216 (n=1342)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2298` → IC=+0.192 (n=1057)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2298 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.199 (n=1201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4437 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2575.0556` → IC=+0.209 (n=895)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2575.0556 (IC base=+0.204)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.163 (n=594)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0039 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.179 (n=590)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0089 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.0996` → IC=+0.154 (n=590)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.5556` → IC=+0.188 (n=1580)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5556 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.387` → IC=+0.182 (n=554)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.387 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.696` → IC=+0.176 (n=817)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.696 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8753` → IC=+0.163 (n=1029)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8753 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.2111` → IC=+0.154 (n=515)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2111 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1641` → IC=+0.175 (n=491)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5517` → IC=+0.161 (n=567)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5517 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=1998)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12224.8689` → IC=+0.149 (n=590)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 12224.8689 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.164 (n=1552)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 165.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.130 (n=1235)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5217` → IC=+0.141 (n=1625)
...
- **PATRÓN** `ibs_20min` > `0.7098` → IC=+0.249 (n=357)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7098 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` > `0.3816` → IC=+0.210 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3816 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.882` → IC=+0.223 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.882 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` < `0.8407` → IC=+0.205 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8407 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` > `1.1573` → IC=+0.207 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1573 (IC base=+0.194)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3892` → IC=+0.236 (n=176)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3892 (IC base=+0.194)
...
- **PATRÓN** `libro_liquidez` > `12296.651` → IC=+0.202 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12296.651 (IC base=+0.194)

- **PATRÓN** `ibs_20min` < `0.1558` → IC=+0.142 (n=219)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.1558 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` > `0.2225` → IC=+0.125 (n=78)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_pendiente_norm` > 0.2225 (IC base=+0.079)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `ibs_20min` > `0.4167` → IC=-0.125 (n=166)

  - _Acción_: SKIP cuando `ibs_20min` > 0.4167
  - _Potencial_: sin este filtro IC_bueno=+0.156 (n=324)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1111` → IC=+0.129 (n=130)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.1111 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.163 (n=363)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 8.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.238 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.6259` → IC=+0.222 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6259 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.127` → IC=+0.206 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.127 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `1.0712` → IC=+0.144 (n=341)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0712 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` > `0.289` → IC=+0.202 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.289 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `2.2214` → IC=+0.163 (n=167)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.2214 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.130 (n=422)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.02 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `3062.644` → IC=+0.202 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3062.644 (IC base=+0.127)

- **PATRÓN** `ibs_20min` < `0.4167` → IC=+0.156 (n=324)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4167 (IC base=+0.061)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.207 (n=3211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)
...
- **PATRÓN** `ibs_20min` > `0.4721` → IC=+0.216 (n=9633)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4721 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.9505` → IC=+0.206 (n=1407)
...
- **PATRÓN** `volumen_regimen` < `0.8818` → IC=+0.165 (n=4295)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8818 (IC base=+0.168)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6084` → IC=+0.189 (n=3082)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6084 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2342.6107` → IC=+0.171 (n=6421)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.6107 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `88.0` → IC=+0.195 (n=7291)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 88.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.187 (n=7670)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0092 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1463` → IC=+0.189 (n=3835)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.1463 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.237 (n=8714)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2434` → IC=+0.160 (n=5343)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2434 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.949` → IC=+0.199 (n=1226)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.949 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.72` → IC=+0.181 (n=8440)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.72 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7051` → IC=+0.158 (n=2643)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7051 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.204` → IC=+0.152 (n=2003)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.204 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.288` → IC=+0.242 (n=1140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.288 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.6332` → IC=+0.193 (n=2654)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6332 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.191 (n=5067)
...
- **PATRÓN** `ibs_20min` < `0.3505` → IC=+0.290 (n=1112)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3505 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.537` → IC=+0.266 (n=1273)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.537 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2243` → IC=+0.288 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2243 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `1.8641` → IC=+0.273 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8641 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1961.3686` → IC=+0.275 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1961.3686 (IC base=+0.258)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0842` → IC=+0.163 (n=515)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3137` → IC=+0.201 (n=1542)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.23` → IC=+0.151 (n=1387)
...
- **PATRÓN** `ibs_20min` < `0.2685` → IC=+0.233 (n=887)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2685 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.6855` → IC=+0.152 (n=231)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6855 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.1329` → IC=+0.166 (n=1185)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1329 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.407` → IC=+0.158 (n=226)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.407 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.186` → IC=+0.161 (n=1330)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.186 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1532` → IC=+0.197 (n=361)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1532 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.4046` → IC=+0.158 (n=1232)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4046 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.161 (n=821)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `423.0` → IC=+0.156 (n=999)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 423.0 (IC base=+0.150)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.245 (n=519)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1580)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2117` → IC=+0.220 (n=1528)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8468` → IC=+0.245 (n=670)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8468 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.229 (n=1092)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0113` → IC=+0.240 (n=1439)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0113 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.1645` → IC=+0.241 (n=634)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1645 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.265 (n=547)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.234)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.236 (n=688)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.234)

- **PATRÓN** `ibs_20min` < `0.3617` → IC=+0.268 (n=1266)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3617 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.722` → IC=+0.280 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.722 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.3454` → IC=+0.294 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3454 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` < `1.7653` → IC=+0.233 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7653 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.1969` → IC=+0.238 (n=876)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1969 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.245 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1871.1464` → IC=+0.251 (n=653)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1871.1464 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.247 (n=421)
...
- **PATRÓN** `drift_60min` |x|≤ `0.436` → IC=+0.143 (n=1642)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.156` → IC=+0.159 (n=682)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.156 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.877` → IC=+0.156 (n=1095)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.877 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2833` → IC=+0.217 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2833 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4694` → IC=+0.148 (n=529)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.4694 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.154 (n=1336)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0076 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4451` → IC=+0.153 (n=1336)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.141 (n=614)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 7.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.6955` → IC=+0.185 (n=1336)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6955 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.788` → IC=+0.141 (n=1544)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.788 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.14` → IC=+0.173 (n=197)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 11.14 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.6969` → IC=+0.146 (n=588)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6969 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1836` → IC=+0.145 (n=446)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.151 (n=1266)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `10957.774` → IC=+0.205 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10957.774 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `180.0` → IC=+0.142 (n=1261)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 180.0 (IC base=+0.136)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.135 (n=1087)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4725` → IC=+0.190 (n=1627)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4725 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `1.0688` → IC=+0.204 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0688 (IC base=+0.110)
...
- **PATRÓN** `volumen_regimen` < `0.8906` → IC=+0.135 (n=1085)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8906 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1642)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2912.6118` → IC=+0.249 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2912.6118 (IC base=+0.110)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.129 (n=1247)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1315` → IC=+0.160 (n=533)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1315 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=1645)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.203 (n=1598)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2176` → IC=+0.128 (n=1285)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2176 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.454` → IC=+0.124 (n=1545)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.454 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.150 (n=703)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5239` → IC=+0.130 (n=479)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.5239 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2849.8754` → IC=+0.160 (n=533)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.212 (n=1455)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.250 (n=1632)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5146 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.197` → IC=+0.233 (n=978)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.197 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.506` → IC=+0.254 (n=773)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.506 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.637` → IC=+0.217 (n=1631)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5119` → IC=+0.238 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5119 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.218 (n=1706)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `2616.0932` → IC=+0.224 (n=1087)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2616.0932 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0087` → IC=+0.224 (n=582)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.254 (n=1745)
...
- **PATRÓN** `dist_vwap_pct` < `0.8801` → IC=+0.203 (n=1922)
...
- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.238 (n=582)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2111` → IC=+0.193 (n=1375)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2111 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4346` → IC=+0.197 (n=1562)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4346 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1059)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=2919)

- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.159 (n=2467)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0093 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.150 (n=2502)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5235` → IC=+0.159 (n=2801)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.166 (n=1258)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 6.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.9422` → IC=+0.211 (n=934)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9422 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1897` → IC=+0.156 (n=1029)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1897 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4929` → IC=+0.143 (n=1665)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.4929 (IC base=+0.150)
...
- **PATRÓN** `volumen_regimen` > `0.9026` → IC=+0.162 (n=1193)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4565` → IC=+0.155 (n=923)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4565 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8861` → IC=+0.161 (n=1846)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8861 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `8154.7046` → IC=+0.151 (n=1270)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8154.7046 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.195 (n=735)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0038 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.487` → IC=+0.156 (n=2201)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.487 (IC base=+0.137)
...
- **PATRÓN** `ibs_20min` < `0.1827` → IC=+0.166 (n=969)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1827 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.6838` → IC=+0.152 (n=432)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6838 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.2438` → IC=+0.131 (n=1950)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2438 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.224` → IC=+0.146 (n=2193)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.224 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2465` → IC=+0.143 (n=2099)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2465 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0726` → IC=+0.145 (n=1019)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0726 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5356` → IC=+0.144 (n=957)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5356 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.8153` → IC=+0.144 (n=1449)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8153 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=2919)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `6935.3546` → IC=+0.151 (n=1966)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 6935.3546 (IC base=+0.137)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.166 (n=330)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.156 (n=373)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.3825` → IC=+0.153 (n=361)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3825 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` > `0.849` → IC=+0.188 (n=248)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.849 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.3101` → IC=+0.286 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3101 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `1.4501` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4501 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.6734` → IC=+0.206 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6734 (IC base=+0.149)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1108` → IC=+0.173 (n=405)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.1108 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.179 (n=350)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.171 (n=348)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` < `0.1382` → IC=+0.176 (n=405)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.1382 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.6084` → IC=+0.142 (n=417)
...
- **PATRÓN** `dist_vwap_pct` < `0.2194` → IC=+0.138 (n=941)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2194 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.107` → IC=+0.153 (n=1007)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 9.107 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8817` → IC=+0.185 (n=614)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.8817 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2207` → IC=+0.172 (n=199)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.2207 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.422` → IC=+0.143 (n=306)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.422 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.8256` → IC=+0.148 (n=611)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.8256 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `11385.2836` → IC=+0.150 (n=920)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 11385.2836 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `707.0` → IC=+0.145 (n=874)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 707.0 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.153 (n=756)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0075 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.162 (n=858)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0044 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.1253` → IC=+0.156 (n=286)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1253 (IC base=+0.152)
...
- **PATRÓN** `ibs_20min` < `0.5612` → IC=+0.155 (n=572)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.5612 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.8888` → IC=+0.170 (n=286)
...
- **PATRÓN** `dist_vwap_pct` < `0.4255` → IC=+0.164 (n=787)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4255 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.678` → IC=+0.161 (n=860)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.678 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.9005` → IC=+0.152 (n=573)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.9005 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.7206` → IC=+0.155 (n=766)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7206 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` < `0.1119` → IC=+0.155 (n=789)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.1119 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1724` → IC=+0.159 (n=253)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.1724 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.2097` → IC=+0.158 (n=740)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.2097 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.5194` → IC=+0.153 (n=751)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5194 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=835)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.132 (n=804)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 8.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.6781` → IC=+0.206 (n=692)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6781 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.1487` → IC=+0.162 (n=439)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1487 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.428` → IC=+0.220 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.428 (IC base=+0.100)

- **PATRÓN** `volumen_pendiente_norm` > `0.2825` → IC=+0.206 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2825 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` < `2.0932` → IC=+0.143 (n=583)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.0932 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=625)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.149 (n=340)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2432.8034 (IC base=+0.100)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.192 (n=131)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.004 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.137 (n=279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 7.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` > `0.6839` → IC=+0.232 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6839 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.1272` → IC=+0.162 (n=152)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1272 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.792` → IC=+0.300 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.792 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `0.8141` → IC=+0.131 (n=177)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8141 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` > `0.9558` → IC=+0.142 (n=121)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.9558 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` > `0.2835` → IC=+0.250 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2835 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` < `1.7354` → IC=+0.162 (n=143)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.7354 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` > `1.4015` → IC=+0.125 (n=214)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 1.4015 (IC base=+0.109)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.133 (n=175)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `1771.0926` → IC=+0.197 (n=87)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 1771.0926 (IC base=+0.109)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.126 (n=121)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` < 0.0061 (IC base=+0.079)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.123 (n=250)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 9.0 (IC base=+0.079)

- **PATRÓN** `ibs_20min` > `0.6757` → IC=+0.179 (n=219)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.6757 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` > `0.198` → IC=+0.158 (n=144)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.198 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.345` → IC=+0.200 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.345 (IC base=+0.079)

- **PATRÓN** `volumen_regimen` > `1.0643` → IC=+0.171 (n=83)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0643 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` > `0.0847` → IC=+0.167 (n=100)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0847 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` < `2.1501` → IC=+0.128 (n=197)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.1501 (IC base=+0.079)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.124 (n=660)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.5 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2897.9051` → IC=+0.171 (n=223)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2897.9051 (IC base=+0.106)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=1688)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=748)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7378)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.173 (n=3206)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=10289)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.171 (n=3462)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=10454)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.203 (n=583)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=1796)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.206 (n=610)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1875)

- **FILTRO** `ibs_20min` > `0.282` → IC=-0.163 (n=621)

  - _Acción_: SKIP cuando `ibs_20min` > 0.282
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1864)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.175 (n=555)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1760)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.185 (n=614)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2704)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2864)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2870)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=9603)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=21395)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7537)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=23461)

- **FILTRO** `ibs_7min` < `0.2892` → IC=-0.235 (n=7749)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2892
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=23249)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10502)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=20496)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9579)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=29158)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.180 (n=9661)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=29076)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.305 (n=1218)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3894)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.249 (n=1685)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3427)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.182 (n=1183)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3929)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.261 (n=1652)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=5014)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.125 (n=2263)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4403)

- **FILTRO** `ibs_7min` > `0.7937` → IC=-0.208 (n=1666)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7937
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=5000)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1287)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4072)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.192 (n=1338)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4021)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.171 (n=1335)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4024)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1348)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=4077)

- **FILTRO** `ibs_7min` > `0.2607` → IC=-0.178 (n=1355)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2607
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4070)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1349)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=4076)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1383)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=3457)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1183)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3657)

- **FILTRO** `ibs_7min` < `0.1959` → IC=-0.257 (n=1210)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1959
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3630)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.215 (n=1134)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3706)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.239 (n=1643)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=5466)

- **FILTRO** `ibs_7min` > `0.7535` → IC=-0.178 (n=1777)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7535
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=5332)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1512)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3602)

- **FILTRO** `ibs_7min` < `0.7425` → IC=-0.181 (n=1278)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7425
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3836)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.168 (n=1255)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3859)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.266 (n=1154)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4045)

- **FILTRO** `ibs_7min` > `0.2755` → IC=-0.174 (n=1298)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2755
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3901)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.190 (n=1280)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3919)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.262 (n=1297)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=4127)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1339)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4085)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1768)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=5593)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.271 (n=1219)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=3930)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.227 (n=1286)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=3863)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1237)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3912)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1698)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=5279)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1053)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=840)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=2816)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1448)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.225 (n=686)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0514` → IC=+0.204 (n=504)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1267` → IC=+0.232 (n=525)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.187 (n=1523)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 16.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6077` → IC=+0.263 (n=1512)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6077 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.2989` → IC=+0.191 (n=544)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.2989 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.881` → IC=+0.274 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.881 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `2980.0928` → IC=+0.193 (n=1008)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2980.0928 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.206 (n=826)
...
- **FILTRO** `dist_vwap_pct` > `0.6927` → IC=-0.150 (n=101)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=845)

### UPDOWN_GBM#SOL#60min
- **PATRÓN** `sigma_ewma_delta_pct` > `15.662` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.662 (IC base=+0.005)
...
- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.159 (n=450)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1175` → IC=+0.239 (n=1075)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1175 (IC base=-0.038)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1772` → IC=+0.235 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1772 (IC base=-0.038)

- **PATRÓN** `ibs_15` < `0.3482` → IC=+0.276 (n=1611)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3482 (IC base=-0.038)

- **PATRÓN** `dist_vwap_pct` > `0.6634` → IC=+0.285 (n=282)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.216 (n=386)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1161)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.227 (n=386)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1161)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=977)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=570)

- **FILTRO** `sigma_ewma_delta_pct` > `19.574` → IC=-0.249 (n=277)
...
- **PATRÓN** `drift_15min` |x|≤ `0.7826` → IC=+0.230 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7826 (IC base=+0.227)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2028` → IC=+0.254 (n=291)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.245 (n=288)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.227)

- **PATRÓN** `ibs_15` < `0.2692` → IC=+0.280 (n=565)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2692 (IC base=+0.227)

- **PATRÓN** `dist_vwap_pct` > `0.7403` → IC=+0.308 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7403 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.558` → IC=+0.256 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 20.558 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.221` → IC=+0.231 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.221 (IC base=+0.227)

- **PATRÓN** `libro_liquidez` > `3546.5572` → IC=+0.228 (n=642)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.103` → IC=+0.354 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.103 (IC base=-0.048)

- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.306 (n=437)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3457 (IC base=-0.048)

- **PATRÓN** `dist_vwap_pct` > `0.8709` → IC=+0.348 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8709 (IC base=-0.048)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6077 sube el IC de +0.186 a +0.263 en UPDOWN_GBM#15min (n=1512). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.046 a +0.159 en UPDOWN_GBM#XRP#15min (n=450). Ya aplicado como kelly_boost=+0.80€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3482 sube el IC de -0.038 a +0.276 en UPDOWN_GBM_15M_TARDIO (n=1611). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2692 sube el IC de +0.227 a +0.280 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=565). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.048 a +0.306 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=437). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1281 | +0.096 | +179.22€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1281 | +0.096 | +179.22€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 951 | +0.105 | +153.43€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 951 | +0.105 | +153.43€ | 2 | 7 |
...
| ✅ BALLENAS_TARDIAS | 24305 | -0.090 | -3066.51€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1431 | -0.047 | -221.52€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22874 | -0.093 | -2844.99€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 6990 | -0.022 | -611.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6990 | -0.022 | -611.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6482 | -0.096 | -428.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6482 | -0.096 | -428.92€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5459 | -0.182 | -1066.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5459 | -0.182 | -1066.92€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17027 | -0.029 | +4089.47€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4460 | -0.000 | +1828.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12567 | -0.040 | +2261.01€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 17027 | -0.029 | +4089.47€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4460 | -0.000 | +1828.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12567 | -0.040 | +2261.01€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1467 | -0.102 | -189.03€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 168 | -0.053 | -21.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1299 | -0.109 | -167.67€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 489 | -0.127 | -77.52€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 465 | -0.130 | -72.29€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 89257 | +0.113 | -4549.48€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13597 | +0.184 | -433.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 357 | -0.093 | -51.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 69443 | +0.100 | -3848.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5860 | +0.108 | -216.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11554 | +0.098 | -994.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 44 | -0.174 | -3.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11495 | +0.100 | -979.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18055 | +0.132 | -366.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4259 | +0.202 | -141.73€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11511 | +0.112 | -174.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2243 | +0.106 | -27.32€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11594 | +0.089 | -1083.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 51 | -0.085 | -5.77€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11528 | +0.090 | -1066.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19018 | +0.123 | -397.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5257 | +0.175 | -80.89€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11630 | +0.105 | -254.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2119 | +0.097 | -53.53€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17465 | +0.114 | -1023.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3941 | +0.188 | -209.47€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 260 | -0.053 | +2.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11766 | +0.092 | -681.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1498 | +0.125 | -135.45€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11571 | +0.101 | -683.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 45 | -0.032 | +7.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11513 | +0.102 | -691.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14162 | +0.193 | -913.32€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14162 | +0.193 | -913.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3389 | +0.169 | -356.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3389 | +0.169 | -356.52€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1114 | +0.196 | -5.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1114 | +0.196 | -5.14€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3331 | +0.182 | -279.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3331 | +0.182 | -279.84€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2979 | +0.238 | -97.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2979 | +0.238 | -97.89€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3270 | +0.195 | -187.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3270 | +0.195 | -187.68€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 48665 | +0.198 | -3784.32€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 48665 | +0.198 | -3784.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8431 | +0.176 | -980.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8431 | +0.176 | -980.46€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7767 | +0.224 | -277.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7767 | +0.224 | -277.59€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8401 | +0.174 | -994.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8401 | +0.174 | -994.27€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 7859 | +0.220 | -297.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 7859 | +0.220 | -297.69€ | 1 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8035 | +0.204 | -527.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8035 | +0.204 | -527.92€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8172 | +0.194 | -706.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8172 | +0.194 | -706.38€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 