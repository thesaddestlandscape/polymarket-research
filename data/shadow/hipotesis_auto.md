# Hipótesis automáticas — 2026-07-28 20:21 UTC
_Generado por shadow_postmortem.py sobre 40722 resoluciones (PNL=+8520.52€)_
...
- **PATRÓN** `sigma_h` < `0.0172` → IC=+0.244 (n=448)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0172 (IC base=+0.229)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.247 (n=413)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.4537` → IC=+0.282 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4537 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.55` → IC=+0.352 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.55 (IC base=+0.229)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.126 (n=1275)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` > 0.0083 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.4709` → IC=+0.141 (n=352)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.4709 (IC base=+0.099)
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.193 (n=187)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0091 (IC base=+0.170)

- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.171 (n=499)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.2438` → IC=+0.223 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2438 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.87` → IC=+0.294 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.87 (IC base=+0.170)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=426)
...
| ✅ FAVORITO_CONFIRMADO | 6941 | +0.176 | -56.86€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO#60min | 1236 | +0.151 | +70.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 2059 | +0.182 | -4.56€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 416 | +0.172 | +60.02€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 18 | +0.315 | +1.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 18 | +0.315 | +1.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 8 | +0.080 | -0.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 8 | +0.080 | -0.47€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 8777 | +0.094 | +2624.54€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8777 | +0.094 | +2624.54€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#DOGE | 83 | +0.100 | +15.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 83 | +0.100 | +15.71€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 2339 | +0.140 | +1123.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2339 | +0.140 | +1123.66€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 6000 | +0.119 | +2855.76€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 6000 | +0.119 | +2855.76€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 79 | +0.191 | +51.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 79 | +0.191 | +51.68€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1337 | +0.215 | +1096.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1337 | +0.215 | +1096.51€ | 0 | 13 |
...
| ✅ GBM_LATE_15M_TARDIO | 5992 | +0.066 | +1606.42€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5992 | +0.066 | +1606.42€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#DOGE | 77 | +0.183 | +34.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 77 | +0.183 | +34.86€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#XRP | 1640 | +0.161 | +985.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1640 | +0.161 | +985.96€ | 0 | 13 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.111 n=24187 | tras_1loss IC=+0.077 n=16290 | tras_2loss IC=+0.051 n=6847/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=4422 IC=+0.072 PNL=+854.88€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4422 IC=+0.072 PNL=+854.88€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.211 > 0.2 con n=779 PNL=+473.04€
  - _Datos_: n=779 IC=+0.211 PNL=+473.04€
