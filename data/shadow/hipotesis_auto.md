# Hipótesis automáticas — 2026-09-05 15:49 UTC
_Generado por shadow_postmortem.py sobre 297370 resoluciones (PNL=+29026.69€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.46` → IC=-0.301 (n=3980)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.46
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=11943)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `131.33` → IC=-0.331 (n=537)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 131.33
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1613)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` > `627.84` → IC=-0.157 (n=336)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` > 627.84
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=654)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `116.78` → IC=-0.403 (n=525)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 116.78
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=1578)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `145.74` → IC=-0.313 (n=887)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.74
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2661)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `159.9` → IC=-0.376 (n=958)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 159.9
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1947)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.191 (n=8344)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.162 (n=2138)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2365.062` → IC=+0.164 (n=2050)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1171)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=880)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.192)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=977)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1490.3665` → IC=+0.150 (n=401)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 1490.3665 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.198 (n=749)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 7.0 (IC base=+0.195)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.197 (n=846)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `940.0494` → IC=+0.197 (n=825)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 940.0494 (IC base=+0.195)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.127 (n=553)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.199 (n=1603)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.188)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.191 (n=1375)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.188)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.193 (n=829)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.7 (IC base=+0.188)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.179 (n=3264)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.261 (n=2374)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.226)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=3177)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=3269)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.71 (IC base=+0.166)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.232 (n=1626)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.274 (n=1172)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.241 (n=1597)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.202)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.187 (n=3094)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.29` → IC=+0.169 (n=1262)

  - _Acción_: Kelly boost +0.85€ cuando `lag_apertura_s` < 3.29 (IC base=+0.123)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.317 (n=534)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1736.667` → IC=+0.294 (n=747)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1736.667 (IC base=+0.290)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.338 (n=245)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.4845` → IC=+0.141 (n=3552)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.4845 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.225 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` < `0.4548` → IC=+0.224 (n=850)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4548 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.705` → IC=+0.156 (n=1525)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 5.705 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` < `0.6988` → IC=+0.230 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6988 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `1.0825` → IC=+0.243 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0825 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.189 (n=703)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.8651` → IC=+0.182 (n=2423)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.8651 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `1.4731` → IC=+0.179 (n=2423)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4731 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.4025` → IC=+0.125 (n=3794)
...
- **PATRÓN** `volumen_spike_ratio` > `1.6067` → IC=+0.190 (n=1897)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 1.6067 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.218 (n=845)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2933` → IC=+0.166 (n=894)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2933 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.201 (n=430)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.269 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.663` → IC=+0.281 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.663 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2302` → IC=+0.237 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2302 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `2.6507` → IC=+0.149 (n=796)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.6507 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.4431` → IC=+0.153 (n=796)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4431 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.197 (n=750)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.04 (IC base=+0.161)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.192 (n=478)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.260 (n=547)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.245)

- **PATRÓN** `drift_60min` |x|≤ `0.1789` → IC=+0.290 (n=407)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1789 (IC base=+0.245)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.250 (n=554)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.245)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.251 (n=621)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.245)

- **PATRÓN** `ibs_20min` < `0.4122` → IC=+0.277 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4122 (IC base=+0.245)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.37` → IC=+0.263 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.37 (IC base=+0.245)

- **PATRÓN** `volumen_pendiente_norm` < `0.0697` → IC=+0.243 (n=449)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5816` → IC=+0.270 (n=445)
...
- **PATRÓN** `libro_liquidez` > `1724.5869` → IC=+0.263 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1724.5869 (IC base=+0.245)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.244 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.245)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.244 (n=307)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2052` → IC=+0.231 (n=462)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2052 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.232 (n=695)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` > `0.3717` → IC=+0.224 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3717 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.216 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.4583` → IC=+0.215 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4583 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.225` → IC=+0.224 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.225 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` < `1.2524` → IC=+0.219 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2524 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.225 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0851 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` < `0.0971` → IC=+0.215 (n=655)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0971 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` < `1.4783` → IC=+0.241 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4783 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `11847.0948` → IC=+0.242 (n=619)
...
- **PATRÓN** `sigma_h` > `0.0096` → IC=+0.204 (n=282)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1042` → IC=+0.166 (n=696)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.1042 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `3.7914` → IC=+0.163 (n=761)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 3.7914 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `1.889` → IC=+0.182 (n=680)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.889 (IC base=+0.170)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.193 (n=894)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.04 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.198 (n=531)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 47.0 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.229 (n=696)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0102 (IC base=+0.222)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.224 (n=622)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.222)

- **PATRÓN** `drift_60min` |x|≤ `0.4907` → IC=+0.224 (n=696)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4907 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.240 (n=329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0311` → IC=+0.274 (n=232)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6975` → IC=+0.210 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6975 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `1.9303` → IC=+0.206 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9303 (IC base=+0.222)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.235 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.222)

- **PATRÓN** `ballena_activa_n` < `33.0` → IC=+0.211 (n=334)
...
- **FILTRO** `drift_60min` |x|> `0.5078` → IC=-0.162 (n=377)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5078
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=732)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.191 (n=147)
...
- **FILTRO** `ibs_20min` > `0.79` → IC=-0.198 (n=442)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1328)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0997` → IC=+0.208 (n=63)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0997 (IC base=-0.050)

- **PATRÓN** `volumen_spike_ratio` < `2.3173` → IC=+0.192 (n=131)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.3173 (IC base=-0.050)

- **PATRÓN** `volumen_spike_ratio` > `1.5056` → IC=+0.160 (n=148)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.5056 (IC base=-0.050)
...
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.176 (n=1642)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0093 (IC base=+0.078)

- **PATRÓN** `ibs_20min` > `0.3061` → IC=+0.148 (n=4925)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.3061 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` > `1.1933` → IC=+0.295 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1933 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.485` → IC=+0.123 (n=2609)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` > 2.485 (IC base=+0.078)

- **PATRÓN** `volumen_regimen` > `0.6824` → IC=+0.223 (n=1435)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6824 (IC base=+0.078)

- **PATRÓN** `volumen_pendiente_norm` > `0.251` → IC=+0.248 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.251 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` < `1.4865` → IC=+0.234 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4865 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` > `2.8011` → IC=+0.222 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8011 (IC base=+0.078)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.294 (n=1934)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.078)

- **PATRÓN** `ibs_20min` < `0.5853` → IC=+0.128 (n=4725)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.5853 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.7533` → IC=+0.250 (n=226)
...
- **PATRÓN** `volumen_regimen` < `0.7102` → IC=+0.220 (n=541)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2584` → IC=+0.335 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2584 (IC base=+0.051)

- **PATRÓN** `volumen_spike_ratio` > `2.4177` → IC=+0.256 (n=659)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4177 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.255 (n=1302)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.051)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3169` → IC=-0.144 (n=414)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3169
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=841)

- **FILTRO** `sigma_ewma_delta_pct` > `2.456` → IC=-0.162 (n=368)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.456
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=800)

- **PATRÓN** `ibs_20min` > `0.841` → IC=+0.244 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.841 (IC base=+0.035)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.685` → IC=+0.172 (n=233)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.685 (IC base=+0.035)

- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.323 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.035)

- **PATRÓN** `volumen_spike_ratio` < `1.8775` → IC=+0.244 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8775 (IC base=+0.035)

- **PATRÓN** `volumen_spike_ratio` > `1.4769` → IC=+0.231 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4769 (IC base=+0.035)
...
- **FILTRO** `ibs_20min` > `0.8603` → IC=-0.157 (n=406)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8603
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1222)

- **PATRÓN** `volumen_spike_ratio` < `1.6899` → IC=+0.136 (n=245)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.6899 (IC base=-0.011)

- **PATRÓN** `ballena_activa_n` < `291.0` → IC=+0.143 (n=155)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0852` → IC=+0.235 (n=266)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.712` → IC=+0.260 (n=711)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2202` → IC=+0.235 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2202 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` < `2.4118` → IC=+0.232 (n=475)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4118 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` > `1.7204` → IC=+0.235 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7204 (IC base=+0.229)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.258 (n=835)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.229)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.324 (n=384)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0075 (IC base=+0.290)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.319 (n=279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.290)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.304 (n=574)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3512` → IC=+0.338 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3512 (IC base=+0.290)

- **PATRÓN** `volumen_spike_ratio` < `3.4644` → IC=+0.281 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.4644 (IC base=+0.290)

- **PATRÓN** `volumen_spike_ratio` > `2.3535` → IC=+0.296 (n=321)
...
- **FILTRO** `hora_utc` < `9.0` → IC=-0.143 (n=250)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=554)

- **FILTRO** `ibs_20min` < `0.7902` → IC=-0.130 (n=530)
...
- **PATRÓN** `volumen_regimen` < `0.8836` → IC=+0.170 (n=95)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8836 (IC base=-0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.1671` → IC=+0.326 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1671 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` < `2.2497` → IC=+0.225 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2497 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` > `1.3689` → IC=+0.225 (n=89)
...
- **FILTRO** `ibs_20min` < `0.8333` → IC=-0.133 (n=704)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8333
  - _Potencial_: sin este filtro IC_bueno=+0.293 (n=366)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1143` → IC=+0.263 (n=319)
...
- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.314 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `1.2342` → IC=+0.130 (n=133)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2342 (IC base=-0.028)
...
- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.176 (n=100)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 65.0 (IC base=-0.028)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0135` → IC=+0.338 (n=517)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0135 (IC base=+0.257)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.266 (n=683)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.257)

- **PATRÓN** `ibs_20min` > `0.9` → IC=+0.329 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9 (IC base=+0.257)

- **PATRÓN** `dist_vwap_pct` > `0.1688` → IC=+0.317 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1688 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.191` → IC=+0.292 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.191 (IC base=+0.257)

- **PATRÓN** `volumen_regimen` > `0.8467` → IC=+0.296 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8467 (IC base=+0.257)

- **PATRÓN** `volumen_pendiente_norm` > `0.2413` → IC=+0.300 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2413 (IC base=+0.257)

- **PATRÓN** `volumen_spike_ratio` < `2.5706` → IC=+0.264 (n=715)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5706 (IC base=+0.257)

- **PATRÓN** `volumen_spike_ratio` > `1.8318` → IC=+0.264 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8318 (IC base=+0.257)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.259 (n=883)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `2463.6549` → IC=+0.260 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2463.6549 (IC base=+0.257)
...
- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.208 (n=1381)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0105 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3391` → IC=+0.171 (n=3646)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3391 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=4154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.7006` → IC=+0.224 (n=3702)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7006 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.7781` → IC=+0.234 (n=869)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7781 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.122` → IC=+0.252 (n=866)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.122 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.156 (n=2791)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.2208 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.6321` → IC=+0.162 (n=2790)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6321 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.1053` → IC=+0.188 (n=1569)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1053 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `2.318` → IC=+0.165 (n=3409)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.318 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `3889.6241` → IC=+0.172 (n=1381)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3889.6241 (IC base=+0.163)

- **PATRÓN** `ballena_activa_n` < `140.0` → IC=+0.182 (n=3052)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 140.0 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.179 (n=3389)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0083 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.0779` → IC=+0.203 (n=1284)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0779 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.194 (n=1812)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 15.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` < `0.4423` → IC=+0.221 (n=3850)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.07` → IC=+0.204 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.07 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `1.174` → IC=+0.160 (n=2894)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.174 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.6238` → IC=+0.154 (n=2892)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6238 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2944` → IC=+0.242 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2944 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.6579` → IC=+0.191 (n=1073)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6579 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.165 (n=2809)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3034` → IC=+0.206 (n=698)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3034 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.222 (n=469)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.616` → IC=+0.298 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.616 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2273` → IC=+0.262 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2273 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` < `2.6391` → IC=+0.173 (n=615)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.6391 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `1.4564` → IC=+0.174 (n=615)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.4564 (IC base=+0.180)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.215 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.199 (n=423)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 69.0 (IC base=+0.180)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.259 (n=392)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.232)

- **PATRÓN** `drift_60min` |x|≤ `0.1666` → IC=+0.303 (n=293)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1666 (IC base=+0.232)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.249 (n=444)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.232)

- **PATRÓN** `ibs_20min` < `0.2712` → IC=+0.258 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2712 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.702` → IC=+0.246 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.702 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` < `0.0683` → IC=+0.226 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0683 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` > `0.2958` → IC=+0.297 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2958 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` < `1.9106` → IC=+0.223 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9106 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.7651` → IC=+0.252 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7651 (IC base=+0.232)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.260 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `1705.2902` → IC=+0.265 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1705.2902 (IC base=+0.232)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.228 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 64.0 (IC base=+0.232)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.221 (n=206)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.4029` → IC=+0.165 (n=609)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.4029 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.211 (n=420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4738` → IC=+0.207 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4738 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2654` → IC=+0.224 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2654 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.787` → IC=+0.243 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.787 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2757` → IC=+0.168 (n=609)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2757 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0768` → IC=+0.169 (n=276)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0768 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2304` → IC=+0.198 (n=127)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2304 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.394` → IC=+0.199 (n=194)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.394 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `11274.9584` → IC=+0.187 (n=544)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1788` → IC=+0.200 (n=438)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1788 (IC base=+0.178)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1325` → IC=+0.192 (n=248)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1325 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` < `3.1304` → IC=+0.171 (n=521)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 3.1304 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` > `1.9121` → IC=+0.170 (n=529)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.9121 (IC base=+0.178)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.178)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.196 (n=133)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 18.0 (IC base=+0.178)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.231 (n=519)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.2109` → IC=+0.227 (n=346)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2109 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.244 (n=349)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` < `0.374` → IC=+0.252 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.374 (IC base=+0.217)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3671` → IC=+0.279 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3671 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `1.9066` → IC=+0.201 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9066 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `3.0915` → IC=+0.219 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0915 (IC base=+0.217)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.184 (n=549)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0071 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.1197` → IC=+0.174 (n=274)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.1197 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.172 (n=633)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.4254` → IC=+0.200 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4254 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.1416` → IC=+0.182 (n=429)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1416 (IC base=+0.153)
...
- **PATRÓN** `volumen_regimen` < `0.8895` → IC=+0.160 (n=415)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8895 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `1.2156` → IC=+0.186 (n=208)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.2156 (IC base=+0.153)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6221` → IC=+0.181 (n=202)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6221 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=693)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `8688.9164` → IC=+0.193 (n=415)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 8688.9164 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.144 (n=372)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 135.0 (IC base=+0.153)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.181 (n=355)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0103 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=820)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.5263` → IC=+0.190 (n=784)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.5263 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.1232` → IC=+0.250 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1232 (IC base=+0.112)
...
- **PATRÓN** `volumen_regimen` > `0.6322` → IC=+0.122 (n=783)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6322 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4407` → IC=+0.135 (n=250)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.4407 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3182.8788` → IC=+0.203 (n=261)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.144 (n=237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.168 (n=362)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 14.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.4737` → IC=+0.214 (n=712)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4737 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `1.0287` → IC=+0.128 (n=84)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 1.0287 (IC base=+0.123)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.287` → IC=+0.152 (n=285)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.287 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `1.1937` → IC=+0.138 (n=711)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5471` → IC=+0.129 (n=254)
  ...
  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.5471 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.3851` → IC=+0.186 (n=192)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.3851 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `3171.9552` → IC=+0.157 (n=237)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3171.9552 (IC base=+0.123)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1668` → IC=+0.221 (n=342)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1668 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=815)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7354` → IC=+0.247 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7354 (IC base=+0.196)

- **PATRÓN** `dist_vwap_pct` > `0.2613` → IC=+0.232 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2613 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.172` → IC=+0.242 (n=385)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.172 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `0.8447` → IC=+0.225 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8447 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` > `0.0832` → IC=+0.253 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0832 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `2.5276` → IC=+0.213 (n=737)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5276 (IC base=+0.196)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.171 (n=405)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0078 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0941` → IC=+0.140 (n=298)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.0941 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.200 (n=454)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.44` → IC=+0.167 (n=895)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.44 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.9582` → IC=+0.223 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9582 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.64` → IC=+0.172 (n=413)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 3.64 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8707` → IC=+0.158 (n=481)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8707 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1751` → IC=+0.145 (n=240)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1751 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1694` → IC=+0.180 (n=248)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1694 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.2592` → IC=+0.146 (n=738)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.2592 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8216` → IC=+0.145 (n=559)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8216 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=933)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.183 (n=298)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.129 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.0034 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.169 (n=155)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 10.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.9306` → IC=+0.194 (n=70)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.9306 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.8848` → IC=+0.218 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8848 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.537` → IC=+0.162 (n=75)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 3.537 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `0.5764` → IC=+0.167 (n=52)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.5764 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `2.3825` → IC=+0.140 (n=145)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.3825 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `11201.4083` → IC=+0.136 (n=138)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 11201.4083 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.159 (n=42)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 147.0 (IC base=+0.094)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.272 (n=160)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.259)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0935` → IC=+0.268 (n=80)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0935 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.294 (n=250)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1421` → IC=+0.279 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1421 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.12` → IC=+0.298 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.12 (IC base=+0.259)

- **PATRÓN** `volumen_regimen` < `0.8258` → IC=+0.272 (n=160)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.258 (n=250)
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.235 (n=4588)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.4325` → IC=+0.166 (n=3246)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.703` → IC=+0.184 (n=4274)
...
- **PATRÓN** `volumen_spike_ratio` > `2.304` → IC=+0.195 (n=1757)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.304 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `140.0` → IC=+0.174 (n=3460)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.194 (n=279)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0052 (IC base=+0.191)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.238 (n=376)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.881` → IC=+0.310 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.881 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` > `0.2271` → IC=+0.273 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2271 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` < `1.5836` → IC=+0.200 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5836 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `1.8844` → IC=+0.177 (n=497)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.8844 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.191)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.243 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 81.0 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.271 (n=543)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.260)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.266 (n=617)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.260)

- **PATRÓN** `drift_60min` |x|≤ `0.1914` → IC=+0.298 (n=413)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1914 (IC base=+0.260)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=559)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.260)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.266 (n=631)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.260)

- **PATRÓN** `ibs_20min` < `0.4158` → IC=+0.298 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4158 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.483` → IC=+0.275 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.483 (IC base=+0.260)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5076` → IC=+0.275 (n=514)
...
- **PATRÓN** `libro_liquidez` > `1730.7134` → IC=+0.272 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1730.7134 (IC base=+0.260)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.172 (n=858)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.4595` → IC=+0.209 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4595 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.219` → IC=+0.207 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.219 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.774` → IC=+0.187 (n=196)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 9.774 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.34` → IC=+0.163 (n=713)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 4.34 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `1.2667` → IC=+0.165 (n=817)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2667 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` < `0.0705` → IC=+0.165 (n=693)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3913` → IC=+0.170 (n=767)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.3913 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.7227` → IC=+0.178 (n=511)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.7227 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `10640.5814` → IC=+0.181 (n=729)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10640.5814 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `465.0` → IC=+0.171 (n=609)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.224 (n=734)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6818` → IC=+0.258 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6818 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.358` → IC=+0.320 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.358 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` < `0.2199` → IC=+0.215 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2199 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` < `3.2024` → IC=+0.208 (n=581)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.2024 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.4494` → IC=+0.206 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4494 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=766)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `1474.3814` → IC=+0.213 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1474.3814 (IC base=+0.210)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.241 (n=330)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0089 (IC base=+0.232)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.236 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3979` → IC=+0.275 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3979 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.51` → IC=+0.269 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.51 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` > `0.3579` → IC=+0.286 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3579 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` < `3.0572` → IC=+0.229 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0572 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.3386` → IC=+0.218 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3386 (IC base=+0.232)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.239 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.232)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.207 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.232)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.156 (n=736)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0069 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.2291` → IC=+0.142 (n=556)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.2291 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=745)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.7314` → IC=+0.237 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7314 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.3602` → IC=+0.188 (n=322)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.3602 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.313` → IC=+0.168 (n=374)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 4.313 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8989` → IC=+0.170 (n=555)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8989 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.2022` → IC=+0.142 (n=277)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.2022 (IC base=+0.140)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1479` → IC=+0.185 (n=360)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.1479 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=905)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9524.3039` → IC=+0.239 (n=377)
...
- **PATRÓN** `sigma_h` > `0.0053` → IC=+0.120 (n=877)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.60€ cuando `sigma_h` > 0.0053 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.144 (n=434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 15.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.179 (n=879)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4706 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `1.0947` → IC=+0.189 (n=165)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 1.0947 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.355` → IC=+0.212 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.355 (IC base=+0.093)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.122 (n=607)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2947.9426` → IC=+0.256 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2947.9426 (IC base=+0.093)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.134 (n=651)
...
- **PATRÓN** `libro_liquidez` > `2648.8968` → IC=+0.154 (n=374)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2648.8968 (IC base=+0.116)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0279` → IC=+0.238 (n=311)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0279 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=978)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.204 (n=830)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.1711` → IC=+0.252 (n=563)
...
- **PATRÓN** `volumen_regimen` > `0.8624` → IC=+0.219 (n=621)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8624 (IC base=+0.203)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8291` → IC=+0.210 (n=587)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.130 (n=1807)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.134 (n=1424)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0101 (IC base=+0.120)

- **PATRÓN** `drift_60min` |x|≤ `0.5507` → IC=+0.132 (n=1618)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.9277` → IC=+0.191 (n=539)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.9277 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.47` → IC=+0.142 (n=255)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 10.47 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.04` → IC=+0.121 (n=1646)

  - _Acción_: Kelly boost +0.60€ cuando `sigma_ewma_delta_pct` < 6.04 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.1753` → IC=+0.152 (n=443)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.1753 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` < `1.4612` → IC=+0.138 (n=534)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4612 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.8982` → IC=+0.143 (n=1067)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8982 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `8774.5433` → IC=+0.133 (n=734)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8774.5433 (IC base=+0.120)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.170 (n=461)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0039 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.5012` → IC=+0.147 (n=1367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1994` → IC=+0.149 (n=602)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.329` → IC=+0.137 (n=1363)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1489` → IC=+0.129 (n=1368)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5034` → IC=+0.136 (n=1352)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.5034 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `1.8071` → IC=+0.138 (n=901)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.8071 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=1807)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.204 (n=130)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.4204` → IC=+0.154 (n=342)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4204 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.189 (n=348)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.299` → IC=+0.211 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.299 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.0966` → IC=+0.159 (n=162)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0966 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `3.5461` → IC=+0.151 (n=388)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 3.5461 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.8351` → IC=+0.152 (n=346)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8351 (IC base=+0.144)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.196 (n=261)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0056 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.185 (n=141)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 18.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.6481` → IC=+0.217 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6481 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.8407` → IC=+0.262 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8407 (IC base=+0.097)
...
- **PATRÓN** `volumen_regimen` < `0.8241` → IC=+0.157 (n=199)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8241 (IC base=+0.097)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9919` → IC=+0.172 (n=175)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.9919 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.4893` → IC=+0.176 (n=177)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.4893 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.160 (n=242)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.02 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `1101.9191` → IC=+0.164 (n=245)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 1101.9191 (IC base=+0.097)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.204 (n=52)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.055)

- **PATRÓN** `ibs_20min` > `0.6842` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.6842 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` > `0.888` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.888 (IC base=+0.055)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.203` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.203 (IC base=+0.055)

- **PATRÓN** `volumen_regimen` > `0.9891` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.9891 (IC base=+0.055)

- **PATRÓN** `volumen_pendiente_norm` > `0.0856` → IC=+0.224 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0856 (IC base=+0.055)

- **PATRÓN** `volumen_spike_ratio` < `2.1825` → IC=+0.162 (n=63)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1825 (IC base=+0.055)

- **PATRÓN** `libro_liquidez` > `376.737` → IC=+0.157 (n=65)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 376.737 (IC base=+0.055)
...
- **PATRÓN** `libro_liquidez` > `2759.8944` → IC=+0.186 (n=103)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2759.8944 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `2252.7754` → IC=+0.132 (n=270)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2252.7754 (IC base=+0.093)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=1599)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.032 (n=4855)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.185 (n=1597)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5054)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.217 (n=281)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=857)

- **FILTRO** `ibs_20min` > `0.7103` → IC=-0.199 (n=284)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.172 (n=254)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=819)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.139 (n=289)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=795)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.280 (n=3798)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=11775)

- **FILTRO** `ibs_7min` < `0.715` → IC=-0.237 (n=3893)

  - _Acción_: SKIP cuando `ibs_7min` < 0.715
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=11680)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.169 (n=5238)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=10335)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.222 (n=4805)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=14876)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=4907)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=14774)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=555)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1748)

- **FILTRO** `ibs_7min` < `0.7063` → IC=-0.252 (n=759)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7063
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1544)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.221 (n=549)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1754)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.240 (n=847)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=2569)

- **FILTRO** `drift_7min_pct` |x|> `0.1137` → IC=-0.133 (n=1161)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1137
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=2255)

- **FILTRO** `ibs_7min` > `0.837` → IC=-0.197 (n=852)

  - _Acción_: SKIP cuando `ibs_7min` > 0.837
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2564)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=635)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=2238)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=697)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2176)

- **FILTRO** `ibs_7min` < `0.7741` → IC=-0.190 (n=718)
...
- **FILTRO** `ballena_activa_n` > `166.0` → IC=-0.174 (n=717)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2156)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.242 (n=697)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2197)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.170 (n=983)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1911)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.183 (n=740)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=1554)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.304 (n=728)
...
- **FILTRO** `ibs_7min` < `0.2184` → IC=-0.289 (n=572)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1722)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.239 (n=546)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=1748)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.225 (n=844)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2720)

- **FILTRO** `ibs_7min` > `0.2797` → IC=-0.155 (n=1211)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2797
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=2353)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=808)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=1819)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.263 (n=631)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=1996)

- **FILTRO** `ibs_7min` < `0.7561` → IC=-0.190 (n=656)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7561
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=1971)

- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.182 (n=653)

  - _Acción_: SKIP cuando `ballena_activa_n` > 37.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=1974)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.253 (n=663)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=1992)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.181 (n=663)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=1992)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.186 (n=657)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=1998)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.245 (n=708)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2206)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.207 (n=724)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2190)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.178 (n=874)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2815)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.126 (n=615)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1947)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.295 (n=622)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1940)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.230 (n=639)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1923)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.225 (n=620)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1942)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.206 (n=842)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2621)

- **FILTRO** `ibs_7min` > `0.7612` → IC=-0.156 (n=865)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.157 (n=97)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.167 (n=76)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 55.0 (IC base=+0.133)
...
- **FILTRO** `hora_utc` < `3.0` → IC=-0.144 (n=43)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=167)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=1665)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.163 (n=200)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0036 (IC base=+0.142)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.187 (n=199)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0075 (IC base=+0.142)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0599` → IC=+0.144 (n=597)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio_macro` |x|> 0.0599 (IC base=+0.142)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3285` → IC=+0.189 (n=284)

  - _Acción_: Kelly boost +0.94€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3285 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.144 (n=644)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.5909` → IC=+0.223 (n=598)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5909 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.4287` → IC=+0.155 (n=140)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.4287 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.5539` → IC=+0.140 (n=637)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.029` → IC=+0.167 (n=28)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 20.029 (IC base=+0.007)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.250 (n=26)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0076 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.1596` → IC=+0.133 (n=77)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.1596 (IC base=+0.125)

- **PATRÓN** `delta_ratio_macro` |x|> `0.209` → IC=+0.176 (n=35)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.88€ cuando `delta_ratio_macro` |x|> 0.209 (IC base=+0.125)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2052` → IC=+0.250 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2052 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.200 (n=28)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.125)

- **PATRÓN** `ibs_15` > `0.5217` → IC=+0.247 (n=77)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5217 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` < `0.2349` → IC=+0.141 (n=76)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.2349 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.935` → IC=+0.389 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.935 (IC base=+0.125)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.127 (n=65)
...
- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.125)

### UPDOWN_GBM#SOL#5min
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0249` → IC=-0.191 (n=40)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.0249
...
- **FILTRO** `sigma_h` > `0.0112` → IC=-0.195 (n=365)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.144 (n=383)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1079)

- **FILTRO** `sigma_ewma_delta_pct` > `18.728` → IC=-0.153 (n=529)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.728
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4027)
...
- **PATRÓN** `ibs_15` > `0.5833` → IC=+0.229 (n=334)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5833 (IC base=-0.067)

- **PATRÓN** `dist_vwap_pct` < `0.1742` → IC=+0.129 (n=227)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.1742 (IC base=-0.067)
...
- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.267 (n=526)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.216 (n=488)
...
- **FILTRO** `sigma_h` < `0.0038` → IC=-0.233 (n=312)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0038
  - _Potencial_: sin este filtro IC_bueno=-0.181 (n=635)
...
- **FILTRO** `drift_60min` |x|> `0.1609` → IC=-0.191 (n=124)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.1609
  - _Potencial_: sin este filtro IC_bueno=-0.102 (n=242)

- **FILTRO** `drift_15min` |x|> `0.8398` → IC=-0.263 (n=91)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.8398
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=275)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.174 (n=127)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.110 (n=239)

- **FILTRO** `sigma_ewma_delta_pct` > `16.341` → IC=-0.148 (n=180)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 16.341
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1418)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5909 sube el IC de +0.142 a +0.223 en UPDOWN_GBM#15min (n=598). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#SOL#15min**: dentro de BUY_YES, IBS > 0.5217 sube el IC de +0.125 a +0.247 en UPDOWN_GBM#SOL#15min (n=77). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5833 sube el IC de -0.067 a +0.229 en UPDOWN_GBM_15M_TARDIO (n=334). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3696 sube el IC de -0.064 a +0.267 en UPDOWN_GBM_15M_TARDIO (n=526). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3448 sube el IC de -0.061 a +0.276 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=141). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 15923 | -0.118 | -2604.21€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 990 | -0.016 | -147.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 14933 | -0.125 | -2457.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2150 | -0.108 | -478.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2150 | -0.108 | -478.50€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 990 | -0.016 | -147.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 990 | -0.016 | -147.13€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2103 | -0.175 | -585.03€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2103 | -0.175 | -585.03€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 4227 | -0.058 | -391.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 4227 | -0.058 | -391.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3548 | -0.130 | -237.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3548 | -0.130 | -237.63€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2905 | -0.191 | -764.52€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2905 | -0.191 | -764.52€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 5001 | -0.080 | +1964.29€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 1431 | -0.012 | +1068.15€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 3570 | -0.106 | +896.15€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 5001 | -0.080 | +1964.29€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 1431 | -0.012 | +1068.15€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 3570 | -0.106 | +896.15€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 51130 | +0.114 | -3080.31€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 8501 | +0.182 | -304.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 180 | -0.110 | -57.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 38573 | +0.100 | -2635.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3876 | +0.115 | -83.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 6470 | +0.086 | -801.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 28 | -0.100 | +6.23€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 6427 | +0.088 | -795.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 10215 | +0.132 | -224.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2505 | +0.197 | -119.05€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 6375 | +0.110 | -127.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1293 | +0.123 | +44.01€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 6491 | +0.086 | -753.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 31 | +0.015 | +3.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#240min | 14 | -0.219 | -10.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 6446 | +0.088 | -746.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 11048 | +0.126 | -194.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 3177 | +0.169 | -37.43€ | 1 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 6419 | +0.111 | -107.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1440 | +0.096 | -40.66€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 10436 | +0.122 | -677.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2737 | +0.188 | -159.08€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 88 | -0.022 | -5.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 6468 | +0.095 | -426.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1143 | +0.130 | -86.39€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 6470 | +0.105 | -429.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 23 | -0.020 | +1.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 9 | +0.021 | +0.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 6438 | +0.106 | -431.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 8388 | +0.180 | -629.15€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 8388 | +0.180 | -629.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2141 | +0.168 | -232.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2141 | +0.168 | -232.03€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2096 | +0.172 | -213.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2096 | +0.172 | -213.77€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1877 | +0.235 | -47.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1877 | +0.235 | -47.71€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2046 | +0.188 | -148.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2046 | +0.188 | -148.57€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 27372 | +0.191 | -2480.63€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 27372 | +0.191 | -2480.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 4867 | +0.154 | -733.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 4867 | +0.154 | -733.11€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 4275 | +0.226 | -149.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 4275 | +0.226 | -149.01€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 4735 | +0.166 | -625.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 4735 | +0.166 | -625.56€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 4362 | +0.220 | -175.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 4362 | +0.220 | -175.11€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 4523 | +0.201 | -324.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 4523 | +0.201 | -324.05€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 4610 | +0.185 | -473.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 4610 | +0.185 | -473.79€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 9953 | +0.130 | +308.64€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 9953 | +0.130 | +308.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 4928 | +0.136 | +206.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 4928 | +0.136 | +206.03€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 5025 | +0.123 | +102.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 5025 | +0.123 | +102.60€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 995 | +0.290 | -13.74€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 995 | +0.290 | -13.74€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 469 | +0.294 | +1.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 469 | +0.294 | +1.88€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 520 | +0.094 | -4.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 180 | +0.082 | -7.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 340 | +0.099 | +2.93€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 407 | +0.104 | +6.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 67 | +0.123 | +3.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 340 | +0.099 | +2.93€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 15474 | +0.096 | -549.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 1376 | +0.079 | -17.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 14098 | +0.098 | -532.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 9220 | +0.099 | -190.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 1376 | +0.079 | -17.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 7844 | +0.102 | -172.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 2078 | +0.115 | +22.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 2078 | +0.115 | +22.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 4176 | +0.081 | -382.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 4176 | +0.081 | -382.18€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 12887 | +0.059 | +5518.99€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 12887 | +0.059 | +5518.99€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 2004 | +0.195 | +1461.10€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 2004 | +0.195 | +1461.10€ | 0 | 23 |
| ✅ GBM_LATE_15M#BTC | 1924 | +0.178 | +1322.22€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1924 | +0.178 | +1322.22€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 2054 | +0.194 | +1481.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 2054 | +0.194 | +1481.95€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 1987 | -0.035 | +128.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1987 | -0.035 | +128.30€ | 2 | 10 |
| ✅ GBM_LATE_15M#SOL | 2039 | -0.052 | +480.75€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2039 | -0.052 | +480.75€ | 5 | 8 |
| ✅ GBM_LATE_15M#XRP | 2879 | -0.068 | +644.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2879 | -0.068 | +644.66€ | 4 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 13724 | +0.064 | +7091.69€ | 0 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 13724 | +0.064 | +7091.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 2423 | +0.001 | +1743.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 2423 | +0.001 | +1743.87€ | 2 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 2971 | -0.016 | +462.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 2971 | -0.016 | +462.82€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 1826 | +0.255 | +1786.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 1826 | +0.255 | +1786.28€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 2074 | -0.046 | +75.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 2074 | -0.046 | +75.34€ | 6 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 2281 | -0.009 | +833.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 2281 | -0.009 | +833.75€ | 3 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 2149 | +0.264 | +2189.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 2149 | +0.264 | +2189.64€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 10655 | +0.167 | +7523.10€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 10655 | +0.167 | +7523.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 1514 | +0.201 | +1165.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 1514 | +0.201 | +1165.84€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 1743 | +0.159 | +1264.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 1743 | +0.159 | +1264.93€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 1565 | +0.196 | +1172.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 1565 | +0.196 | +1172.96€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 1743 | +0.138 | +1061.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 1743 | +0.138 | +1061.33€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 1991 | +0.117 | +1235.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 1991 | +0.117 | +1235.37€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 2099 | +0.198 | +1622.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 2099 | +0.198 | +1622.66€ | 0 | 22 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 2400 | +0.107 | +804.61€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 2400 | +0.107 | +804.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 91 | +0.113 | +37.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 91 | +0.113 | +37.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 608 | +0.087 | +180.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 608 | +0.087 | +180.10€ | 0 | 14 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 344 | +0.144 | +166.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 344 | +0.144 | +166.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 562 | +0.165 | +242.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 562 | +0.165 | +242.09€ | 0 | 14 |
...
| ✅ GBM_LATE_15M_TARDIO | 12802 | +0.173 | +9215.25€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#15min | 12802 | +0.173 | +9215.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 1926 | +0.220 | +1622.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 1926 | +0.220 | +1622.89€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 2068 | +0.161 | +1477.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 2068 | +0.161 | +1477.12€ | 0 | 28 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 1948 | +0.221 | +1643.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 1948 | +0.221 | +1643.99€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1979 | +0.133 | +1178.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1979 | +0.133 | +1178.77€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 2267 | +0.104 | +1258.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 2267 | +0.104 | +1258.69€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 2614 | +0.203 | +2033.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 2614 | +0.203 | +2033.78€ | 0 | 23 |
| ✅ GBM_LATE_5M | 3978 | +0.123 | +1846.87€ | 1 | 24 |
| ✅ GBM_LATE_5M#5min | 3978 | +0.123 | +1846.87€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB | 250 | +0.171 | +159.76€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB#5min | 250 | +0.171 | +159.76€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 1038 | +0.110 | +504.88€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 1038 | +0.110 | +504.88€ | 1 | 16 |
| ✅ GBM_LATE_5M#DOGE | 577 | +0.156 | +330.95€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 577 | +0.156 | +330.95€ | 0 | 21 |
...
| ✅ GBM_LATE_5M#XRP | 617 | +0.095 | +187.90€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 617 | +0.095 | +187.90€ | 0 | 0 |
| ✅ GBM_LATE_60M | 788 | +0.025 | +200.65€ | 3 | 12 |
| ✅ GBM_LATE_60M#60min | 788 | +0.025 | +200.65€ | 0 | 0 |
...
| ✅ GBM_LATE_60M#SOL | 237 | -0.040 | +44.16€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 237 | -0.040 | +44.16€ | 1 | 8 |
...
| ✅ LEADLAG_BTC_XRP_15M | 661 | +0.097 | +157.91€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 661 | +0.097 | +157.91€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 661 | +0.097 | +157.91€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 661 | +0.097 | +157.91€ | 0 | 2 |
...
| ✅ MOMENTUM_IBS_15M | 7985 | -0.004 | -104.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 7985 | -0.004 | -104.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 556 | -0.007 | +1.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 556 | -0.007 | +1.36€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 867 | -0.020 | -21.23€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 867 | -0.020 | -21.23€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 1866 | +0.009 | -14.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 1866 | +0.009 | -14.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 1585 | +0.001 | +1.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 1585 | +0.001 | +1.75€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 1633 | -0.010 | -41.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 1633 | -0.010 | -41.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 1478 | -0.005 | -30.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 1478 | -0.005 | -30.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 13105 | -0.030 | +630.92€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 13105 | -0.030 | +630.92€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 2183 | -0.017 | +321.94€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 2183 | -0.017 | +321.94€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 2237 | -0.032 | -11.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 2237 | -0.032 | -11.58€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 2215 | -0.027 | +194.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 2215 | -0.027 | +194.30€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 2124 | -0.046 | -44.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 2124 | -0.046 | -44.84€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 2205 | -0.032 | +94.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 2205 | -0.032 | +94.75€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 2141 | -0.026 | +76.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 2141 | -0.026 | +76.36€ | 3 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 35254 | -0.077 | +611.58€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 35254 | -0.077 | +611.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 5719 | -0.087 | +440.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 5719 | -0.087 | +440.11€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 5767 | -0.081 | -138.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 5767 | -0.081 | -138.25€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 5858 | -0.083 | +199.71€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 5858 | -0.083 | +199.71€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 5282 | -0.100 | -298.35€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 5282 | -0.100 | -298.35€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 6603 | -0.053 | +121.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 6603 | -0.053 | +121.53€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 6025 | -0.065 | +286.83€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 6025 | -0.065 | +286.83€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 6293 | -0.015 | -115.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 6293 | -0.015 | -115.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 995 | -0.018 | -20.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 995 | -0.018 | -20.76€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1336 | -0.011 | -15.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1336 | -0.011 | -15.55€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 857 | -0.021 | -13.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 857 | -0.021 | -13.77€ | 1 | 0 |
...
| ✅ STREAK_FADE_5M | 1936 | -0.024 | -86.63€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 1936 | -0.024 | -86.63€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 441 | -0.028 | -22.11€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 441 | -0.028 | -22.11€ | 4 | 0 |
...
| ✅ STREAK_MOM_5M | 4118 | +0.018 | +44.42€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 4118 | +0.018 | +44.42€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 1338 | +0.019 | +9.98€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 1338 | +0.019 | +9.98€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 840 | +0.033 | +28.91€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 840 | +0.033 | +28.91€ | 1 | 1 |
| ✅ STREAK_MOM_5M#SOL | 1213 | +0.006 | -7.74€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 1213 | +0.006 | -7.74€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 727 | +0.016 | +13.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 727 | +0.016 | +13.27€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 4381 | +0.013 | -21.87€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 4381 | +0.013 | -21.87€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1684 | +0.014 | -8.57€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1684 | +0.014 | -8.57€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1743 | +0.021 | +5.35€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1743 | +0.021 | +5.35€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 954 | -0.004 | -18.64€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 954 | -0.004 | -18.64€ | 2 | 0 |
| ✅ UPDOWN_GBM | 11167 | +0.011 | +374.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 3805 | +0.040 | +418.07€ | 0 | 12 |
| ✅ UPDOWN_GBM#240min | 466 | +0.006 | +5.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 6141 | -0.003 | -40.51€ | 1 | 0 |
| ✅ UPDOWN_GBM#60min | 703 | -0.008 | -8.13€ | 2 | 0 |
| ✅ UPDOWN_GBM#BNB | 545 | +0.067 | +56.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 187 | +0.114 | +44.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 11 | -0.021 | -0.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 347 | +0.044 | +12.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 2048 | +0.014 | +111.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 437 | +0.072 | +90.30€ | 1 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 141 | +0.045 | +8.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 1174 | -0.006 | +15.26€ | 3 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 276 | +0.000 | -3.61€ | 2 | 1 |
| ✅ UPDOWN_GBM#BTC#daily | 20 | -0.136 | +1.50€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 1314 | +0.007 | +9.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 130 | +0.091 | +29.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 10 | +0.042 | +0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 1174 | -0.003 | -21.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 2263 | +0.000 | +19.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1087 | +0.028 | +47.64€ | 1 | 7 |
| ✅ UPDOWN_GBM#ETH#240min | 131 | +0.019 | +6.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 745 | -0.033 | -29.85€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 283 | -0.016 | -4.60€ | 3 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 17 | -0.157 | +0.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 3182 | +0.004 | +21.91€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1003 | +0.006 | +24.14€ | 1 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 125 | -0.004 | -2.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 1897 | +0.005 | +1.00€ | 3 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 144 | -0.007 | +0.08€ | 1 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 13 | -0.152 | -0.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 1813 | +0.021 | +157.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 961 | +0.053 | +182.02€ | 0 | 8 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 6018 | -0.065 | +1316.06€ | 4 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 6018 | -0.065 | +1316.06€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 310 | -0.051 | +340.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 310 | -0.051 | +340.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1227 | -0.148 | -54.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1227 | -0.148 | -54.84€ | 3 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1964 | -0.065 | +375.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1964 | -0.065 | +375.47€ | 4 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1871 | -0.085 | +367.98€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1871 | -0.085 | +367.98€ | 2 | 4 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.082) — sin ventaja clara. oversold(IBS<0.3): IC=+0.027 n=3935 | neutral: IC=+0.005 n=4340 | overbought(IBS>0.7): IC=+0.087 n=4344
  - _Datos_: n=13108 IC=+0.041 PNL=+1375.49€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=1003 IC=+0.006 PNL=+24.14€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 11105 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.

**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  - _Umbral_: n≥60 alineadas y gap IC≥0.08 vs contrarias — y descartar que sea proxy de drift_15min/60min
  - _Acción_: Si confirma e independiente de drift → capturar prev_window_outcome como feature en shadow_predict y boost ×1.1-1.2 en señales alineadas
  - _Estado_: alineada_con_outcome_prev IC=+0.020 n=73/60 | contraria IC=+0.120 n=48 | gap=-0.100 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=283/40 IC=-0.016 PNL=-4.60€ | BTC#60min: n=276/40 IC=+0.000 PNL=-3.61€ | SOL#60min: n=144/40 IC=-0.007 PNL=+0.08€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.064 n=166073 | tras_1loss IC=+0.053 n=131027 | tras_2loss IC=+0.018 n=58476/40 | gap=+0.045 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.005 n=981 | contrario_BTC IC=-0.006 n=883/40 | gap=-0.002 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.157 > 0.08 con n=141 PNL=+55.52€
  - _Datos_: n=141 IC=+0.157 PNL=+55.52€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=10822 IC=+0.009 PNL=+327.38€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=10822 IC=+0.009 PNL=+327.38€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=546 IC=+0.004 PNL=-1.99€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=546 IC=+0.004 PNL=-1.99€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=157 IC=-0.047 PNL=-6.14€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=157 IC=-0.047 PNL=-6.14€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.142 > 0.1 con n=796 PNL=+298.51€
  - _Datos_: n=796 IC=+0.142 PNL=+298.51€
...
**〰️ H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: n=235 IC=+0.044 PNL=+35.01€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=235 IC=+0.044 PNL=+35.01€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=2215 IC=+0.037 PNL=+256.27€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2215 IC=+0.037 PNL=+256.27€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2771 IC=+0.015 PNL=+118.09€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2771 IC=+0.015 PNL=+118.09€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=828 IC=+0.031 PNL=+30.42€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=828 IC=+0.031 PNL=+30.42€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=1531 IC=+0.035 PNL=+89.19€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1531 IC=+0.035 PNL=+89.19€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=2890 IC=+0.037 PNL=+276.76€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2890 IC=+0.037 PNL=+276.76€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.1 con n=1203 PNL=+496.12€
  - _Datos_: n=1203 IC=+0.169 PNL=+496.12€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=8495 IC=-0.139 PNL=+489.76€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=8495 IC=-0.139 PNL=+489.76€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.143 > 0.08 con n=758 PNL=+284.14€
  - _Datos_: n=758 IC=+0.143 PNL=+284.14€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=2391 IC=+0.141 PNL=+1417.97€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=2391 IC=+0.141 PNL=+1417.97€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=1004 IC=+0.003 PNL=+124.15€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1004 IC=+0.003 PNL=+124.15€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.186 > 0.08 con n=923 PNL=+638.14€
  - _Datos_: n=923 IC=+0.186 PNL=+638.14€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=1513 IC=-0.058 PNL=+329.54€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1513 IC=-0.058 PNL=+329.54€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.228 > 0.08 con n=2126 PNL=-217.96€
  - _Datos_: n=2126 IC=+0.228 PNL=-217.96€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.093 n=359) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=359 IC=+0.093 PNL=+85.54€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=4867 IC=+0.154 PNL=-733.11€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=4867 IC=+0.154 PNL=-733.11€
