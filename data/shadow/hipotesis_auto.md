# Hipótesis automáticas — 2026-07-19 03:06 UTC
_Generado por shadow_postmortem.py sobre 21769 resoluciones (PNL=+5226.29€)_
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.206 (n=1351)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.197 (n=1525)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.223 (n=528)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=1606)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.271 (n=116)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
| ✅ FAVORITO_CONFIRMADO | 3645 | +0.184 | +45.94€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 2366 | +0.217 | +87.94€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1058 | +0.193 | +31.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 789 | +0.209 | +0.62€ | 0 | 5 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=13055 | tras_1loss IC=+0.087 n=8510 | tras_2loss IC=+0.054 n=3481/40 | gap=+0.062 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=19311 IC=+0.120 PNL=+5302.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=19311 IC=+0.120 PNL=+5302.17€
