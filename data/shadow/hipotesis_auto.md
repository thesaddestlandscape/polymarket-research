# Hipótesis automáticas — 2026-09-05 20:17 UTC
_Generado por shadow_postmortem.py sobre 300106 resoluciones (PNL=+29441.11€)_
...
- **FILTRO** `py_entrada` > `0.5` → IC=-0.392 (n=81)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.130 (n=325)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.130 (n=325)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` < 0.5 (IC base=+0.025)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.125 (n=102)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 124.0 (IC base=+0.025)
...
- **PATRÓN** `py_entrada` < `0.485` → IC=+0.122 (n=141)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.485 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `93.0` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 93.0 (IC base=+0.014)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.7` → IC=-0.300 (n=4011)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.7
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=12033)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `132.48` → IC=-0.326 (n=543)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.48
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1631)
...
- **FILTRO** `restante_s_al_confirmar` < `118.65` → IC=-0.400 (n=529)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 118.65
  - _Potencial_: sin este filtro IC_bueno=-0.096 (n=1589)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `157.54` → IC=-0.156 (n=1063)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.54
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3190)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `145.71` → IC=-0.312 (n=895)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.71
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2686)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `160.57` → IC=-0.375 (n=964)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.57
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=1960)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.192 (n=8384)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.163 (n=2150)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2367.2094` → IC=+0.164 (n=2063)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2367.2094 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.148 (n=5962)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.253 (n=5314)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.179 (n=4134)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.02 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `4545.1557` → IC=+0.179 (n=1797)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 4545.1557 (IC base=+0.139)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.216 (n=923)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.785` → IC=+0.375 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.785 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1178)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `13030.2014` → IC=+0.219 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13030.2014 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.203 (n=888)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.325` → IC=+0.290 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.193 (n=1252)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `12436.8097` → IC=+0.204 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12436.8097 (IC base=+0.192)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=691)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4063.9233` → IC=+0.158 (n=331)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 4063.9233 (IC base=+0.130)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.144 (n=1749)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.308 (n=586)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.258 (n=679)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.251)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.253 (n=742)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.251)

- **PATRÓN** `py_entrada` < `0.205` → IC=+0.392 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.205 (IC base=+0.251)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.256 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.251)

- **PATRÓN** `libro_liquidez` > `1926.7157` → IC=+0.266 (n=742)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1926.7157 (IC base=+0.251)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.139 (n=375)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.145 (n=483)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.02 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `1484.0616` → IC=+0.148 (n=402)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1484.0616 (IC base=+0.134)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.215 (n=412)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.199 (n=755)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.235` → IC=+0.340 (n=291)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.235 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.204 (n=727)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `939.5107` → IC=+0.197 (n=830)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.126 (n=557)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=6603)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.421 (n=36)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.300)

- **PATRÓN** `py_entrada` > `0.775` → IC=+0.344 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.775 (IC base=+0.300)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=1585)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.314 (n=536)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=1615)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.194 (n=834)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.7 (IC base=+0.187)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.187 (n=694)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.73 (IC base=+0.187)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.451 (n=303)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.442 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.443)

- **PATRÓN** `libro_liquidez` > `3434.6605` → IC=+0.453 (n=210)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.194 (n=18690)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 8.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.211 (n=18964)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.191)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=3881)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.156 (n=2631)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 12.0 (IC base=+0.155)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.180 (n=3300)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` > 0.71 (IC base=+0.155)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.230 (n=1621)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.260 (n=2396)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.226)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.169 (n=3216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=3297)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.71 (IC base=+0.166)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.232 (n=1667)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.29` → IC=+0.168 (n=1269)

  - _Acción_: Kelly boost +0.84€ cuando `lag_apertura_s` < 3.29 (IC base=+0.123)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.318 (n=536)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1733.724` → IC=+0.295 (n=748)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.339 (n=247)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1713.4258` → IC=+0.321 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1713.4258 (IC base=+0.295)
...
- **PATRÓN** `libro_liquidez` > `1978.5089` → IC=+0.435 (n=290)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.435 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.426)

- **PATRÓN** `py_entrada` < `0.935` → IC=+0.438 (n=160)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9516` → IC=+0.212 (n=1342)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9516 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.2589` → IC=+0.226 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2589 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` < `0.1712` → IC=+0.225 (n=664)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1712 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.724` → IC=+0.153 (n=1538)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 5.724 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` < `0.7029` → IC=+0.231 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7029 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `1.0844` → IC=+0.242 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0844 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.2513` → IC=+0.193 (n=496)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2513 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.8626` → IC=+0.182 (n=2452)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.8626 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `1.4722` → IC=+0.179 (n=2452)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4722 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.402` → IC=+0.127 (n=3821)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.402 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` < `0.3334` → IC=+0.142 (n=1427)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3334 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` < `0.6881` → IC=+0.148 (n=606)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6881 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `1.0494` → IC=+0.147 (n=625)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.0494 (IC base=+0.040)

- **PATRÓN** `volumen_pendiente_norm` > `0.3031` → IC=+0.231 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3031 (IC base=+0.040)

- **PATRÓN** `volumen_spike_ratio` > `1.6079` → IC=+0.190 (n=1921)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 1.6079 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.218 (n=853)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2945` → IC=+0.166 (n=903)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2945 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.201 (n=430)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.272 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.649` → IC=+0.280 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.649 (IC base=+0.161)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6489` → IC=+0.149 (n=805)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.6489 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.5557` → IC=+0.155 (n=719)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5557 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=760)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.161)

- **PATRÓN** `ballena_activa_n` < `43.0` → IC=+0.195 (n=368)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 43.0 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.251 (n=415)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.241)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.253 (n=553)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.241)

- **PATRÓN** `drift_60min` |x|≤ `0.1819` → IC=+0.290 (n=413)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1819 (IC base=+0.241)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.244 (n=565)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4122` → IC=+0.277 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4122 (IC base=+0.241)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.392` → IC=+0.258 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.392 (IC base=+0.241)

- **PATRÓN** `volumen_pendiente_norm` < `0.0686` → IC=+0.236 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0686 (IC base=+0.241)

- **PATRÓN** `volumen_pendiente_norm` > `0.2889` → IC=+0.336 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2889 (IC base=+0.241)

- **PATRÓN** `volumen_spike_ratio` > `2.8103` → IC=+0.295 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8103 (IC base=+0.241)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.263 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.241)

- **PATRÓN** `libro_liquidez` > `1729.3648` → IC=+0.256 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1729.3648 (IC base=+0.241)

- **PATRÓN** `ballena_activa_n` < `67.0` → IC=+0.242 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 67.0 (IC base=+0.241)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.245 (n=308)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.213)

- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.219 (n=233)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0066 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.2041` → IC=+0.231 (n=467)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2041 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.232 (n=704)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.3717` → IC=+0.225 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3717 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.217 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.4553` → IC=+0.215 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4553 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.309` → IC=+0.227 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.309 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2524` → IC=+0.219 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2524 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.224 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` < `0.0983` → IC=+0.215 (n=661)
...
- **PATRÓN** `libro_liquidez` > `10989.1304` → IC=+0.236 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10989.1304 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.154 (n=755)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0061 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.147 (n=673)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.148 (n=675)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6604` → IC=+0.171 (n=754)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.52` → IC=+0.229 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.52 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.615` → IC=+0.173 (n=252)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.615 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.1499` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1499 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `1.7274` → IC=+0.165 (n=431)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.7274 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4035` → IC=+0.163 (n=645)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4035 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `12569.7182` → IC=+0.153 (n=502)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.199 (n=287)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.201 (n=413)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.248 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.376` → IC=+0.273 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.376 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` < `0.2176` → IC=+0.163 (n=803)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.2176 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `3.1353` → IC=+0.161 (n=677)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 3.1353 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8855` → IC=+0.181 (n=687)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.8855 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=905)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.196 (n=540)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 48.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.230 (n=706)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.223)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.224 (n=632)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.223)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.242 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.027` → IC=+0.281 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.027 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.68` → IC=+0.233 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.68 (IC base=+0.223)

- **PATRÓN** `volumen_pendiente_norm` > `0.3746` → IC=+0.302 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3746 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` < `1.6985` → IC=+0.216 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6985 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` > `2.4205` → IC=+0.210 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4205 (IC base=+0.223)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.237 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.223)

- **PATRÓN** `ballena_activa_n` < `34.0` → IC=+0.211 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 34.0 (IC base=+0.223)

### GBM_LATE_15M#ETH#15min
- **FILTRO** `ibs_20min` > `0.8166` → IC=-0.186 (n=307)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=72)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1158)

- **PATRÓN** `dist_vwap_pct` < `0.3757` → IC=+0.293 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3757 (IC base=-0.027)

- **PATRÓN** `volumen_regimen` < `0.5993` → IC=+0.379 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5993 (IC base=-0.027)

- **PATRÓN** `volumen_regimen` > `1.1929` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1929 (IC base=-0.027)

- **PATRÓN** `volumen_pendiente_norm` < `0.1153` → IC=+0.279 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1153 (IC base=-0.027)

- **PATRÓN** `volumen_pendiente_norm` > `0.0988` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0988 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` < `1.4376` → IC=+0.344 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4376 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` > `1.9125` → IC=+0.287 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9125 (IC base=-0.027)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 154.0 (IC base=-0.027)

- **PATRÓN** `dist_vwap_pct` > `0.1427` → IC=+0.159 (n=83)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1427 (IC base=-0.039)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5772` → IC=+0.128 (n=205)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.5772 (IC base=-0.039)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.412` → IC=-0.184 (n=213)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1644)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5398` → IC=+0.167 (n=25)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5398 (IC base=-0.061)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.5049` → IC=-0.157 (n=380)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5049
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=738)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.186 (n=154)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=964)

- **FILTRO** `ibs_20min` > `0.79` → IC=-0.197 (n=444)

  - _Acción_: SKIP cuando `ibs_20min` > 0.79
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1338)

- **FILTRO** `sigma_ewma_delta_pct` > `8.957` → IC=-0.132 (n=202)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.957
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1580)
...
- **PATRÓN** `dist_vwap_pct` < `0.2317` → IC=+0.206 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2317 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` > `1.0971` → IC=+0.281 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0971 (IC base=-0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.2594` → IC=+0.235 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2594 (IC base=-0.048)

- **PATRÓN** `volumen_spike_ratio` < `2.5738` → IC=+0.190 (n=153)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.5738 (IC base=-0.048)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.189 (n=101)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 22.0 (IC base=-0.048)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.174 (n=1661)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0093 (IC base=+0.078)

- **PATRÓN** `ibs_20min` > `0.3103` → IC=+0.148 (n=4975)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.3103 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` > `1.1843` → IC=+0.292 (n=354)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1843 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.486` → IC=+0.122 (n=2634)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` > 2.486 (IC base=+0.078)

- **PATRÓN** `volumen_regimen` > `0.6831` → IC=+0.223 (n=1454)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6831 (IC base=+0.078)

- **PATRÓN** `volumen_pendiente_norm` > `0.2515` → IC=+0.249 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2515 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` < `1.4852` → IC=+0.233 (n=837)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4852 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` > `2.8009` → IC=+0.223 (n=836)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8009 (IC base=+0.078)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.293 (n=1968)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.078)

- **PATRÓN** `ibs_20min` < `0.5851` → IC=+0.128 (n=4763)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.5851 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.7601` → IC=+0.248 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7601 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` < `0.2212` → IC=+0.218 (n=1169)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2212 (IC base=+0.051)

- **PATRÓN** `volumen_regimen` > `1.2262` → IC=+0.245 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2262 (IC base=+0.051)

- **PATRÓN** `volumen_pendiente_norm` > `0.2584` → IC=+0.334 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2584 (IC base=+0.051)

- **PATRÓN** `volumen_spike_ratio` > `2.4151` → IC=+0.258 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4151 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.254 (n=1320)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.051)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3226` → IC=-0.140 (n=417)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3226
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=849)

- **FILTRO** `sigma_ewma_delta_pct` > `2.485` → IC=-0.160 (n=372)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.485
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=814)

- **PATRÓN** `ibs_20min` > `0.8435` → IC=+0.252 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8435 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.685` → IC=+0.172 (n=236)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.685 (IC base=+0.037)

- **PATRÓN** `volumen_pendiente_norm` > `0.2202` → IC=+0.325 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2202 (IC base=+0.037)

- **PATRÓN** `volumen_spike_ratio` < `1.8686` → IC=+0.246 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8686 (IC base=+0.037)

- **PATRÓN** `volumen_spike_ratio` > `1.4729` → IC=+0.232 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4729 (IC base=+0.037)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.306 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=+0.037)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8603` → IC=-0.156 (n=408)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8603
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1226)

- **PATRÓN** `volumen_spike_ratio` < `1.6989` → IC=+0.140 (n=248)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.6989 (IC base=-0.010)

- **PATRÓN** `ballena_activa_n` < `260.0` → IC=+0.136 (n=119)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 260.0 (IC base=-0.010)
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.258 (n=720)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.0848` → IC=+0.233 (n=268)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0848 (IC base=+0.228)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.254 (n=384)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.228)

- **PATRÓN** `ibs_20min` > `0.712` → IC=+0.259 (n=717)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.712 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.394` → IC=+0.292 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.394 (IC base=+0.228)

- **PATRÓN** `volumen_pendiente_norm` < `0.221` → IC=+0.234 (n=746)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.221 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` < `2.3922` → IC=+0.230 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.3922 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` > `1.7141` → IC=+0.234 (n=717)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7141 (IC base=+0.228)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=843)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.228)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.313 (n=522)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.291)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.320 (n=292)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.291)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.306 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.291)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.713` → IC=+0.317 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.713 (IC base=+0.291)

- **PATRÓN** `volumen_pendiente_norm` > `0.3512` → IC=+0.340 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3512 (IC base=+0.291)

- **PATRÓN** `volumen_spike_ratio` < `1.6567` → IC=+0.283 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6567 (IC base=+0.291)

- **PATRÓN** `volumen_spike_ratio` > `2.3464` → IC=+0.297 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3464 (IC base=+0.291)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.302 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `1850.0471` → IC=+0.292 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1850.0471 (IC base=+0.291)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.271 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.291)
...
- **FILTRO** `ibs_20min` < `0.5834` → IC=-0.161 (n=408)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5834
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=409)

- **FILTRO** `ibs_20min` > `0.8665` → IC=-0.159 (n=318)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8665
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=957)
...
- **PATRÓN** `dist_vwap_pct` > `1.3501` → IC=+0.333 (n=28)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3501 (IC base=-0.050)

- **PATRÓN** `volumen_regimen` < `0.8912` → IC=+0.167 (n=100)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8912 (IC base=-0.050)

- **PATRÓN** `volumen_pendiente_norm` > `0.1671` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1671 (IC base=-0.050)

- **PATRÓN** `volumen_spike_ratio` < `2.2544` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2544 (IC base=-0.050)

- **PATRÓN** `volumen_spike_ratio` > `1.3713` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3713 (IC base=-0.050)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.254 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 158.0 (IC base=-0.050)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.8392` → IC=-0.130 (n=714)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8392
  - _Potencial_: sin este filtro IC_bueno=+0.290 (n=369)

- **FILTRO** `ibs_20min` > `0.75` → IC=-0.234 (n=303)

  - _Acción_: SKIP cuando `ibs_20min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=918)

- **FILTRO** `sigma_ewma_delta_pct` > `4.678` → IC=-0.143 (n=306)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.678
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=915)

- **PATRÓN** `ibs_20min` > `0.8392` → IC=+0.290 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8392 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` > `1.1776` → IC=+0.342 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1776 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `0.8696` → IC=+0.260 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8696 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` > `0.639` → IC=+0.255 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.639 (IC base=+0.013)

- **PATRÓN** `volumen_pendiente_norm` < `0.1127` → IC=+0.258 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1127 (IC base=+0.013)

- **PATRÓN** `volumen_pendiente_norm` > `0.2247` → IC=+0.285 (n=63)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4432` → IC=+0.305 (n=111)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4432 (IC base=+0.013)

- **PATRÓN** `volumen_spike_ratio` > `2.0579` → IC=+0.250 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0579 (IC base=+0.013)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.307 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `1.2342` → IC=+0.129 (n=138)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2342 (IC base=-0.027)

- **PATRÓN** `volumen_pendiente_norm` > `0.2452` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2452 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` > `2.4055` → IC=+0.135 (n=50)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.4055 (IC base=-0.027)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.176 (n=106)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 65.0 (IC base=-0.027)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0136` → IC=+0.336 (n=521)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0136 (IC base=+0.256)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.258 (n=790)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` > `0.8983` → IC=+0.326 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8983 (IC base=+0.256)

- **PATRÓN** `dist_vwap_pct` > `0.1699` → IC=+0.315 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1699 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.182` → IC=+0.291 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.182 (IC base=+0.256)

- **PATRÓN** `volumen_regimen` > `0.8448` → IC=+0.295 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8448 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.2409` → IC=+0.295 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2409 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` < `2.5673` → IC=+0.264 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5673 (IC base=+0.256)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.260 (n=884)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `2452.9003` → IC=+0.259 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2452.9003 (IC base=+0.256)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.281 (n=281)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0063 (IC base=+0.271)

- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.295 (n=281)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.271)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.279 (n=799)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.384` → IC=+0.309 (n=842)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.384 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.5366` → IC=+0.284 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5366 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` < `0.2763` → IC=+0.272 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2763 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.408` → IC=+0.291 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.408 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `1.2602` → IC=+0.306 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2602 (IC base=+0.271)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.374 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` < `2.5859` → IC=+0.260 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5859 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1862` → IC=+0.283 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1862 (IC base=+0.271)

- **PATRÓN** `ballena_activa_n` < `41.0` → IC=+0.266 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 41.0 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.204 (n=1397)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0105 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3403` → IC=+0.170 (n=3687)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3403 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.170 (n=4216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.7006` → IC=+0.223 (n=3744)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7006 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `1.106` → IC=+0.232 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.106 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.132` → IC=+0.252 (n=873)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.132 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.155 (n=2822)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.2233 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.6317` → IC=+0.161 (n=2821)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6317 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.1052` → IC=+0.188 (n=1583)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1052 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `2.313` → IC=+0.164 (n=3449)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.313 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.163 (n=4242)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.03 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `3892.8648` → IC=+0.173 (n=1397)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3892.8648 (IC base=+0.163)

- **PATRÓN** `ballena_activa_n` < `140.0` → IC=+0.181 (n=3099)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 140.0 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.179 (n=3415)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0083 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0781` → IC=+0.203 (n=1293)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0781 (IC base=+0.171)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.194 (n=1852)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 15.0 (IC base=+0.171)

- **PATRÓN** `ibs_20min` < `0.4423` → IC=+0.221 (n=3880)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4423 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2202` → IC=+0.165 (n=2907)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2202 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.075` → IC=+0.207 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.075 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1729` → IC=+0.161 (n=2909)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1729 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6221` → IC=+0.155 (n=2910)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6221 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2939` → IC=+0.243 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2939 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.6536` → IC=+0.193 (n=1083)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.6536 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.165 (n=2842)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 154.0 (IC base=+0.171)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.186 (n=313)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3049` → IC=+0.205 (n=707)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.616` → IC=+0.297 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.616 (IC base=+0.181)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6388` → IC=+0.172 (n=624)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.6388 (IC base=+0.181)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.216 (n=604)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `45.0` → IC=+0.199 (n=290)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 45.0 (IC base=+0.181)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.250 (n=398)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.1673` → IC=+0.306 (n=297)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1673 (IC base=+0.228)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.245 (n=446)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.228)

- **PATRÓN** `ibs_20min` < `0.2712` → IC=+0.256 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2712 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.766` → IC=+0.241 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.766 (IC base=+0.228)

- **PATRÓN** `volumen_pendiente_norm` < `0.0675` → IC=+0.220 (n=326)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2944` → IC=+0.297 (n=57)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2944 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` < `1.4302` → IC=+0.219 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4302 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` > `2.7079` → IC=+0.242 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7079 (IC base=+0.228)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.257 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.228)

- **PATRÓN** `libro_liquidez` > `1705.2902` → IC=+0.259 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1705.2902 (IC base=+0.228)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.225 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 64.0 (IC base=+0.228)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.225 (n=205)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.397` → IC=+0.167 (n=614)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.397 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.213 (n=427)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.4744` → IC=+0.208 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4744 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.263` → IC=+0.227 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.263 (IC base=+0.163)
...
- **PATRÓN** `volumen_regimen` < `1.2757` → IC=+0.169 (n=614)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2757 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.8987` → IC=+0.172 (n=409)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8987 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.1623` → IC=+0.200 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1623 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `1.394` → IC=+0.201 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.394 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `11274.9584` → IC=+0.190 (n=549)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11274.9584 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.179 (n=705)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0061 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.0596` → IC=+0.213 (n=235)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0596 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.177 (n=646)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 7.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` < `0.4911` → IC=+0.192 (n=703)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.4911 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.3191` → IC=+0.170 (n=753)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3191 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.219` → IC=+0.243 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.219 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` < `0.6944` → IC=+0.221 (n=310)
...
- **PATRÓN** `volumen_spike_ratio` < `2.386` → IC=+0.167 (n=595)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.386 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.3961` → IC=+0.165 (n=595)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.3961 (IC base=+0.156)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.156 (n=908)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `15630.8052` → IC=+0.158 (n=235)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 15630.8052 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `241.0` → IC=+0.163 (n=170)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 241.0 (IC base=+0.156)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.208 (n=221)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.177)

- **PATRÓN** `drift_60min` |x|≤ `0.179` → IC=+0.198 (n=442)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.179 (IC base=+0.177)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.189 (n=223)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.298 (n=339)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1321` → IC=+0.191 (n=250)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1321 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `1.8983` → IC=+0.174 (n=535)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.8983 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.199 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.231 (n=526)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.218)

- **PATRÓN** `drift_60min` |x|≤ `0.217` → IC=+0.225 (n=351)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.217 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.244 (n=358)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.3684` → IC=+0.252 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3684 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.704` → IC=+0.262 (n=208)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3115` → IC=+0.268 (n=110)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3115 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` < `1.9009` → IC=+0.215 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9009 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `3.6802` → IC=+0.217 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6802 (IC base=+0.218)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.188 (n=558)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0071 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.1197` → IC=+0.175 (n=278)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.1197 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=646)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.4313` → IC=+0.197 (n=632)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.4313 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.1444` → IC=+0.181 (n=440)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1444 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.408` → IC=+0.269 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.408 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `0.8882` → IC=+0.156 (n=422)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8882 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `1.2156` → IC=+0.190 (n=211)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 1.2156 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.2963` → IC=+0.222 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2963 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `2.6221` → IC=+0.186 (n=205)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6221 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `8728.1176` → IC=+0.190 (n=421)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 8728.1176 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.147 (n=383)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 136.0 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.149 (n=690)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0076 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.3757` → IC=+0.142 (n=689)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3757 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.169 (n=273)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.137 (n=315)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 7.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` < `0.5426` → IC=+0.176 (n=689)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.5426 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` < `0.6019` → IC=+0.138 (n=805)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.6019 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.371` → IC=+0.210 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.371 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` < `1.161` → IC=+0.132 (n=689)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.161 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.131 (n=689)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.613 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` > `0.1023` → IC=+0.172 (n=236)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1023 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` < `1.5424` → IC=+0.142 (n=255)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.5424 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` > `2.5127` → IC=+0.151 (n=193)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.5127 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `5230.1415` → IC=+0.136 (n=459)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 5230.1415 (IC base=+0.125)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.188 (n=264)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0118 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.129 (n=831)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5263` → IC=+0.188 (n=792)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5263 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `1.1251` → IC=+0.243 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1251 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.352` → IC=+0.264 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.352 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3182.3782` → IC=+0.203 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3182.3782 (IC base=+0.111)

- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.160 (n=239)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0105 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.097` → IC=+0.147 (n=239)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.097 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=327)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` < `0.4737` → IC=+0.214 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4737 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` > `1.0375` → IC=+0.144 (n=88)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 1.0375 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.1783` → IC=+0.136 (n=641)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1783 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.287` → IC=+0.156 (n=289)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.287 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` < `1.1937` → IC=+0.138 (n=717)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.1937 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` > `0.8565` → IC=+0.131 (n=478)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.8565 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.2716` → IC=+0.211 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2716 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` < `1.4461` → IC=+0.133 (n=194)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4461 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` > `2.3673` → IC=+0.189 (n=194)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.3673 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `3168.0146` → IC=+0.160 (n=239)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 3168.0146 (IC base=+0.124)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.218 (n=523)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0175 (IC base=+0.194)

- **PATRÓN** `drift_60min` |x|≤ `0.1669` → IC=+0.218 (n=346)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1669 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=825)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7351` → IC=+0.245 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7351 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` > `0.2672` → IC=+0.225 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2672 (IC base=+0.194)
...
- **PATRÓN** `volumen_regimen` > `0.8431` → IC=+0.222 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8431 (IC base=+0.194)

- **PATRÓN** `volumen_pendiente_norm` > `0.0834` → IC=+0.249 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0834 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` < `2.5276` → IC=+0.211 (n=745)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5276 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.196 (n=870)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0904` → IC=+0.218 (n=268)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0904 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.200 (n=398)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.425` → IC=+0.244 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.425 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.2521` → IC=+0.206 (n=821)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2521 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.959` → IC=+0.241 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.959 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.6912` → IC=+0.227 (n=716)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6631` → IC=+0.202 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6631 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `2506.521` → IC=+0.207 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2506.521 (IC base=+0.200)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.166 (n=411)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0077 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=858)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.44` → IC=+0.169 (n=904)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.44 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.9443` → IC=+0.219 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9443 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.645` → IC=+0.175 (n=417)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.645 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8708` → IC=+0.159 (n=488)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8708 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.1814` → IC=+0.153 (n=243)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1814 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1702` → IC=+0.182 (n=250)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1702 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.2631` → IC=+0.146 (n=746)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.2631 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.823` → IC=+0.147 (n=565)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.823 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=945)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9553.6554` → IC=+0.186 (n=301)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 9553.6554 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.3132` → IC=+0.121 (n=608)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.3132 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.081` → IC=+0.130 (n=187)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 8.081 (IC base=+0.076)

- **PATRÓN** `volumen_pendiente_norm` > `0.1737` → IC=+0.155 (n=227)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1737 (IC base=+0.076)
...
- **PATRÓN** `sigma_h` > `0.0032` → IC=+0.132 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0032 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.169 (n=161)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 10.0 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.9281` → IC=+0.189 (n=72)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.9281 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.8823` → IC=+0.225 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8823 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.537` → IC=+0.171 (n=77)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 3.537 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `0.6919` → IC=+0.167 (n=70)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6919 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.3852` → IC=+0.142 (n=149)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.3852 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `8646.4701` → IC=+0.158 (n=159)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 8646.4701 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `150.0` → IC=+0.174 (n=44)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 150.0 (IC base=+0.096)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.170 (n=104)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0029 (IC base=+0.083)

- **PATRÓN** `ibs_20min` < `0.6326` → IC=+0.156 (n=268)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.6326 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.093` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 9.093 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.220 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.083)

- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.170 (n=92)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 146.0 (IC base=+0.083)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.276 (n=163)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.261)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.331 (n=81)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.261)

- **PATRÓN** `drift_60min` |x|≤ `0.0935` → IC=+0.262 (n=82)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0935 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.292 (n=243)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` > `0.388` → IC=+0.284 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.388 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` > `0.149` → IC=+0.288 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.149 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.12` → IC=+0.300 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.12 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` < `0.8258` → IC=+0.270 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8258 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` > `1.1605` → IC=+0.319 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1605 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` > `0.2472` → IC=+0.381 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2472 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` > `2.0629` → IC=+0.338 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0629 (IC base=+0.261)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.262 (n=254)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.199 (n=2300)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.172 (n=5088)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4839` → IC=+0.210 (n=5065)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4839 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `1.0483` → IC=+0.220 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0483 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.463` → IC=+0.226 (n=2536)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.463 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8873` → IC=+0.160 (n=2327)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8873 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.198 (n=1389)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.8757` → IC=+0.172 (n=3155)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8757 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.166 (n=4742)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.02 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3817.4959` → IC=+0.182 (n=1688)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3817.4959 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.211 (n=2481)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 63.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.199 (n=3081)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0069 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.478` → IC=+0.189 (n=4619)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.478 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=2230)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.235 (n=4623)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.4351` → IC=+0.166 (n=3252)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.4351 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.717` → IC=+0.212 (n=662)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.717 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.712` → IC=+0.184 (n=4299)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 2.712 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `0.6227` → IC=+0.167 (n=1086)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6227 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `1.1954` → IC=+0.162 (n=1086)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.1954 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.237` → IC=+0.244 (n=759)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.237 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.3025` → IC=+0.195 (n=1772)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.3025 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.174 (n=3492)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 139.0 (IC base=+0.183)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.196 (n=281)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.324 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.897` → IC=+0.310 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.897 (IC base=+0.192)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4713` → IC=+0.201 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4713 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `2.2942` → IC=+0.180 (n=342)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.2942 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=689)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.192)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.245 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.192)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.268 (n=550)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.256)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.261 (n=625)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.1914` → IC=+0.293 (n=418)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1914 (IC base=+0.256)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.261 (n=570)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4158` → IC=+0.297 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4158 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.577` → IC=+0.270 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.577 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.2963` → IC=+0.315 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2963 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `1.5076` → IC=+0.271 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5076 (IC base=+0.256)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.274 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1730.86` → IC=+0.266 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1730.86 (IC base=+0.256)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.265 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 72.0 (IC base=+0.256)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.177 (n=277)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0029 (IC base=+0.155)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.161 (n=275)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0067 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.178 (n=737)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 8.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.4595` → IC=+0.210 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4595 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.2194` → IC=+0.207 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2194 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.756` → IC=+0.190 (n=198)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 9.756 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.322` → IC=+0.163 (n=720)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 4.322 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.165 (n=824)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2673 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` < `0.0705` → IC=+0.165 (n=697)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.0705 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1464` → IC=+0.199 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1464 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.3936` → IC=+0.170 (n=774)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.3936 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.7246` → IC=+0.179 (n=516)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.7246 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `10634.2635` → IC=+0.182 (n=736)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10634.2635 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `465.0` → IC=+0.172 (n=616)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 465.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.178 (n=738)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0062 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.171 (n=660)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0029 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.3387` → IC=+0.180 (n=738)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.3387 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=696)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6191` → IC=+0.208 (n=738)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.846` → IC=+0.224 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.846 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.618` → IC=+0.226 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.618 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.0856` → IC=+0.228 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0856 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.4027` → IC=+0.199 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4027 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.0527` → IC=+0.193 (n=291)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.0527 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=952)
...
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.232 (n=494)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6818` → IC=+0.259 (n=662)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6818 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.274` → IC=+0.321 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.274 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` < `0.2198` → IC=+0.214 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2198 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` < `3.1961` → IC=+0.206 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.1961 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.4328` → IC=+0.206 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4328 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `1474.5515` → IC=+0.213 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1474.5515 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.253 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 65.0 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.263 (n=247)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0059 (IC base=+0.233)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.243 (n=336)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.009 (IC base=+0.233)
...
- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.277 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3966 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.571` → IC=+0.273 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.571 (IC base=+0.233)

- **PATRÓN** `volumen_pendiente_norm` > `0.3568` → IC=+0.290 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3568 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` < `3.0458` → IC=+0.233 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0458 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` > `2.3266` → IC=+0.216 (n=410)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3266 (IC base=+0.233)
...
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.155 (n=742)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0069 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=757)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.7317` → IC=+0.237 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7317 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.3633` → IC=+0.188 (n=331)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.3633 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.071` → IC=+0.178 (n=144)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 12.071 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8962` → IC=+0.168 (n=561)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.8962 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.2022` → IC=+0.145 (n=280)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.2022 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.2748` → IC=+0.235 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2748 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `2.509` → IC=+0.191 (n=267)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.509 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=915)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9524.3039` → IC=+0.239 (n=381)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9524.3039 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.167 (n=220)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0032 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.4369` → IC=+0.143 (n=656)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4369 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=249)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6768` → IC=+0.173 (n=656)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6768 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` > `0.1542` → IC=+0.130 (n=298)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.1542 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.2051` → IC=+0.126 (n=602)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.2051 (IC base=+0.124)
...
- **PATRÓN** `volumen_regimen` < `0.5999` → IC=+0.124 (n=219)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 0.5999 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` > `1.1414` → IC=+0.147 (n=219)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.1414 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.257 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` > `1.4531` → IC=+0.141 (n=594)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.4531 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `9491.207` → IC=+0.177 (n=298)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 9491.207 (IC base=+0.124)

- **PATRÓN** `ballena_activa_n` < `191.0` → IC=+0.136 (n=509)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 191.0 (IC base=+0.124)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.139 (n=591)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0079 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.136 (n=591)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 12.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.178 (n=887)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4706 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.8687` → IC=+0.178 (n=225)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.8687 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.395` → IC=+0.216 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.395 (IC base=+0.094)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=617)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2949.3334` → IC=+0.254 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2949.3334 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.134 (n=660)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 63.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.179 (n=278)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0057 (IC base=+0.116)

- **PATRÓN** `drift_60min` |x|≤ `0.1263` → IC=+0.181 (n=277)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.1263 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.149 (n=397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 15.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` < `0.587` → IC=+0.194 (n=829)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.587 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.4879` → IC=+0.137 (n=799)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.4879 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.222` → IC=+0.129 (n=807)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 3.222 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `1.0622` → IC=+0.131 (n=730)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0622 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` > `0.0737` → IC=+0.172 (n=285)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.0737 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.142 (n=227)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4564 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` > `2.1792` → IC=+0.129 (n=308)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.1792 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2644.2874` → IC=+0.151 (n=376)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2644.2874 (IC base=+0.116)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=989)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.172` → IC=+0.248 (n=573)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.172 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.248 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.169 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6933` → IC=+0.213 (n=840)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6933 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.253 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.828` → IC=+0.209 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.828 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=1039)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.273 (n=346)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0069 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0254` → IC=+0.226 (n=345)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0254 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.208 (n=978)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.256 (n=1048)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` < `0.1792` → IC=+0.209 (n=900)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1792 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.694` → IC=+0.267 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.694 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.241 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.233 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2851` → IC=+0.286 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2851 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4546` → IC=+0.195 (n=860)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4546 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.209 (n=944)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2525.8943` → IC=+0.207 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2525.8943 (IC base=+0.204)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.184 (n=754)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 35.0 (IC base=+0.204)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.129 (n=1813)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.134 (n=1447)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0103 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.555` → IC=+0.131 (n=1644)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.555 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.170 (n=552)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 18.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `0.9277` → IC=+0.191 (n=548)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.9277 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.427` → IC=+0.145 (n=260)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 10.427 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.79` → IC=+0.122 (n=1425)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 2.79 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.1737` → IC=+0.155 (n=453)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1737 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.4612` → IC=+0.137 (n=543)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.4612 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.894` → IC=+0.143 (n=1085)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.894 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `8677.2486` → IC=+0.131 (n=745)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 8677.2486 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.174 (n=458)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0039 (IC base=+0.126)

- **PATRÓN** `drift_60min` |x|≤ `0.5006` → IC=+0.147 (n=1372)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.476` → IC=+0.130 (n=366)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.476 (IC base=+0.126)
...
- **PATRÓN** `volumen_regimen` < `1.0988` → IC=+0.138 (n=1149)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.0988 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` < `0.1489` → IC=+0.128 (n=1373)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1489 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.0693` → IC=+0.149 (n=647)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.0693 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` < `2.5016` → IC=+0.136 (n=1357)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.5016 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.8093` → IC=+0.136 (n=904)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.8093 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=1813)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `7723.2634` → IC=+0.134 (n=1225)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.471` → IC=-0.250 (n=26)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.147 (n=185)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=55)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.471` → IC=+0.147 (n=185)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 2.471 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `0.9456` → IC=+0.135 (n=72)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.9456 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `1.4115` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.4115 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `12609.7541` → IC=+0.146 (n=142)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 12609.7541 (IC base=+0.096)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.174 (n=277)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0035 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.0863` → IC=+0.140 (n=209)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.0863 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.154 (n=238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 17.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.1654` → IC=+0.157 (n=275)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.1654 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.369` → IC=+0.138 (n=622)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 6.369 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.8677` → IC=+0.144 (n=417)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8677 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.0635` → IC=+0.152 (n=294)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.0635 (IC base=+0.112)
...
- **PATRÓN** `libro_liquidez` > `11116.1452` → IC=+0.124 (n=625)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 11116.1452 (IC base=+0.112)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.201 (n=135)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.176 (n=183)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0106 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.2821` → IC=+0.161 (n=269)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.2821 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.188 (n=367)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 9.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.9849` → IC=+0.223 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9849 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.295` → IC=+0.220 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.295 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.2159` → IC=+0.161 (n=107)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.2159 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `3.5224` → IC=+0.156 (n=402)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 3.5224 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.8314` → IC=+0.151 (n=359)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8314 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `2278.6566` → IC=+0.164 (n=135)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2278.6566 (IC base=+0.146)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4713` → IC=+0.145 (n=570)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4713 (IC base=+0.133)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.191 (n=263)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0055 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.167 (n=145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 18.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.6383` → IC=+0.214 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6383 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.8416` → IC=+0.211 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8416 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.847` → IC=+0.241 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.847 (IC base=+0.093)

- **PATRÓN** `volumen_regimen` < `0.8208` → IC=+0.147 (n=202)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8208 (IC base=+0.093)

- **PATRÓN** `volumen_regimen` > `0.5803` → IC=+0.125 (n=302)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.5803 (IC base=+0.093)

- **PATRÓN** `volumen_pendiente_norm` > `0.2652` → IC=+0.300 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2652 (IC base=+0.093)

- **PATRÓN** `volumen_spike_ratio` < `1.9975` → IC=+0.172 (n=178)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.9975 (IC base=+0.093)

- **PATRÓN** `volumen_spike_ratio` > `1.4893` → IC=+0.161 (n=181)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4893 (IC base=+0.093)

- **PATRÓN** `libro_spread` < `0.023` → IC=+0.156 (n=245)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.023 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `1096.0492` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1096.0492 (IC base=+0.093)
...
- **FILTRO** `ibs_20min` < `0.7829` → IC=-0.186 (n=33)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7829
  - _Potencial_: sin este filtro IC_bueno=+0.226 (n=100)

- **PATRÓN** `sigma_h` < `0.0054` → IC=+0.227 (n=115)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0054 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.141 (n=62)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 16.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` > `0.7829` → IC=+0.226 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7829 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `0.3158` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3158 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.35` → IC=+0.233 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.35 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `0.8725` → IC=+0.167 (n=67)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8725 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` < `0.0635` → IC=+0.184 (n=55)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.0635 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` > `0.1451` → IC=+0.208 (n=22)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2071` → IC=+0.212 (n=64)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2071 (IC base=+0.108)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.157 (n=97)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.176 (n=103)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.005 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.154 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 15.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` > `0.6741` → IC=+0.268 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6741 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.49` → IC=+0.224 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.49 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` < `0.1483` → IC=+0.154 (n=108)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1483 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.977` → IC=+0.294 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.977 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `0.789` → IC=+0.167 (n=82)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.789 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` < `0.0797` → IC=+0.135 (n=61)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.0797 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` > `0.2254` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2254 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` < `1.7961` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.7961 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` > `1.4589` → IC=+0.175 (n=75)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.4589 (IC base=+0.107)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.162 (n=128)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.02 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `1276.6106` → IC=+0.204 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1276.6106 (IC base=+0.107)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.191 (n=53)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 18.0 (IC base=+0.054)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.183 (n=80)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.6744 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.888` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.888 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` < `0.5928` → IC=+0.123 (n=75)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.5928 (IC base=+0.054)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.203` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.203 (IC base=+0.054)

- **PATRÓN** `volumen_regimen` > `1.0843` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.0843 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` > `0.0856` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0856 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` < `2.1762` → IC=+0.151 (n=64)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.1762 (IC base=+0.054)

- **PATRÓN** `libro_liquidez` > `377.7393` → IC=+0.147 (n=66)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 377.7393 (IC base=+0.054)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `libro_liquidez` > `2756.2176` → IC=+0.192 (n=105)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2756.2176 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `2252.7754` → IC=+0.130 (n=271)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2252.7754 (IC base=+0.092)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=1608)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.032 (n=4913)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.185 (n=1620)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5108)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.224 (n=255)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.074 (n=779)

- **FILTRO** `ibs_20min` < `0.7376` → IC=-0.192 (n=258)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7376
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=776)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.167 (n=289)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=891)

- **FILTRO** `ibs_20min` > `0.7246` → IC=-0.155 (n=294)
...
- **FILTRO** `py_entrada` > `0.56` → IC=-0.186 (n=259)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=791)

- **FILTRO** `ballena_activa_n` > `58.0` → IC=-0.155 (n=262)
...
- **FILTRO** `ibs_20min` > `0.7083` → IC=-0.197 (n=288)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7083
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=865)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.173 (n=255)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=831)

- **FILTRO** `py_entrada` > `0.56` → IC=-0.174 (n=262)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=798)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.140 (n=290)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=806)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.190 (n=246)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=765)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.195 (n=267)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=885)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=541)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=547)
...
- **PATRÓN** `libro_liquidez` > `4506.3723` → IC=+0.182 (n=20)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 4506.3723 (IC base=-0.042)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.280 (n=3825)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=11898)

- **FILTRO** `ibs_7min` < `0.7155` → IC=-0.235 (n=3930)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7155
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=11793)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.168 (n=5296)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=10427)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.223 (n=4851)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=15043)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=4957)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=14937)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=560)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1768)

- **FILTRO** `ibs_7min` < `0.7089` → IC=-0.249 (n=768)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7089
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1560)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.218 (n=555)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1773)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.242 (n=855)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2597)

- **FILTRO** `drift_7min_pct` |x|> `0.1142` → IC=-0.135 (n=1173)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1142
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=2279)

- **FILTRO** `ibs_7min` > `0.8364` → IC=-0.199 (n=862)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2590)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=635)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2267)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=703)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2199)

- **FILTRO** `ibs_7min` < `0.7733` → IC=-0.191 (n=725)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7733
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=2177)

- **FILTRO** `ballena_activa_n` > `166.0` → IC=-0.176 (n=724)

  - _Acción_: SKIP cuando `ballena_activa_n` > 166.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2178)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.244 (n=705)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2213)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.170 (n=990)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=1928)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.183 (n=740)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1569)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.305 (n=732)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1577)

- **FILTRO** `ibs_7min` < `0.2222` → IC=-0.289 (n=577)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2222
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1732)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.240 (n=548)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=1761)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=856)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=2749)

- **FILTRO** `ibs_7min` > `0.799` → IC=-0.170 (n=901)

  - _Acción_: SKIP cuando `ibs_7min` > 0.799
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2704)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=808)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=1843)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.263 (n=635)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2016)

- **FILTRO** `ibs_7min` < `0.7575` → IC=-0.188 (n=662)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7575
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=1989)

- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.182 (n=658)

  - _Acción_: SKIP cuando `ballena_activa_n` > 37.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=1993)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.235 (n=877)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1808)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.178 (n=671)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2014)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.186 (n=661)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=2024)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.241 (n=713)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2229)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.204 (n=730)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2212)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.178 (n=884)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2845)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.126 (n=615)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1976)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.295 (n=626)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1965)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.230 (n=647)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1944)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.225 (n=628)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1963)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.208 (n=847)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.125 (n=38)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=482)
...
- **PATRÓN** `delta_ratio` |x|> `0.3988` → IC=+0.146 (n=543)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.73€ cuando `delta_ratio` |x|> 0.3988 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.142 (n=434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 6.0 (IC base=+0.132)

- **PATRÓN** `total_vol_5m` < `471.727` → IC=+0.165 (n=174)

  - _Acción_: Kelly boost +0.82€ cuando `total_vol_5m` < 471.727 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `3304.2559` → IC=+0.156 (n=213)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3304.2559 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.130 (n=382)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 63.0 (IC base=+0.132)

### ORDER_FLOW_5M#BNB#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.272 (n=55)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.124)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.132 (n=104)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 59.0 (IC base=+0.124)
...
- **FILTRO** `pct_vs_K` |x|> `2.3742` → IC=-0.439 (n=31)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=383)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1678)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=930)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=938)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.163 (n=203)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0036 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.181 (n=202)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0075 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.1668` → IC=+0.140 (n=534)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1668 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1322` → IC=+0.143 (n=404)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.71€ cuando `delta_ratio_macro` |x|> 0.1322 (IC base=+0.140)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3329` → IC=+0.185 (n=293)

  - _Acción_: Kelly boost +0.92€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3329 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=608)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.5909` → IC=+0.219 (n=607)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5909 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.2747` → IC=+0.143 (n=228)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.2747 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.5518` → IC=+0.140 (n=646)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5518 (IC base=+0.140)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=603)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9601.804` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 9601.804 (IC base=+0.140)

### UPDOWN_GBM#5min
- **FILTRO** `sigma_ewma_delta_pct` > `7.858` → IC=-0.204 (n=42)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 7.858
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1222)
...
- **PATRÓN** `ibs_15` > `0.8221` → IC=+0.121 (n=93)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` > 0.8221 (IC base=+0.007)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.331` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 20.331 (IC base=+0.007)

### UPDOWN_GBM#ETH#15min
- **FILTRO** `ibs_15` < `0.6414` → IC=-0.200 (n=48)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6414
  - _Potencial_: sin este filtro IC_bueno=+0.194 (n=145)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2614` → IC=+0.167 (n=49)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.2614 (IC base=+0.095)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2299` → IC=+0.129 (n=68)

  - _Acción_: Kelly boost +0.64€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2299 (IC base=+0.095)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.122 (n=149)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 17.0 (IC base=+0.095)

- **PATRÓN** `ibs_15` > `0.6414` → IC=+0.194 (n=145)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.97€ cuando `ibs_15` > 0.6414 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` < `0.1534` → IC=+0.141 (n=115)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1534 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.619` → IC=+0.147 (n=66)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 8.619 (IC base=+0.095)
...
- **FILTRO** `drift_15min` |x|> `0.4883` → IC=-0.148 (n=157)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0241` → IC=-0.204 (n=42)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0501` → IC=+0.167 (n=166)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.0501 (IC base=+0.132)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.192 (n=76)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 6.0 (IC base=+0.132)

- **PATRÓN** `ibs_15` > `0.5676` → IC=+0.229 (n=149)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5676 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.1207` → IC=+0.196 (n=100)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1207 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.916` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.916 (IC base=+0.132)
...
- **PATRÓN** `libro_liquidez` > `2682.2064` → IC=+0.218 (n=76)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2682.2064 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.207 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 39.0 (IC base=+0.132)

- **PATRÓN** `ibs_15` < `0.1154` → IC=+0.179 (n=188)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.89€ cuando `ibs_15` < 0.1154 (IC base=+0.029)
...
- **FILTRO** `sigma_h` > `0.0112` → IC=-0.191 (n=367)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0112
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1104)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.142 (n=384)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1087)

- **FILTRO** `sigma_ewma_delta_pct` > `18.745` → IC=-0.153 (n=534)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.745
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4053)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3537` → IC=+0.181 (n=214)

  - _Acción_: Kelly boost +0.90€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3537 (IC base=-0.064)

- **PATRÓN** `ibs_15` > `0.5` → IC=+0.194 (n=380)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.97€ cuando `ibs_15` > 0.5 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` < `0.1752` → IC=+0.132 (n=229)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.1752 (IC base=-0.064)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1261` → IC=+0.220 (n=352)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1261 (IC base=-0.064)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1113` → IC=+0.232 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1113 (IC base=-0.064)

- **PATRÓN** `ibs_15` < `0.3676` → IC=+0.267 (n=529)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3676 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` > `0.7574` → IC=+0.209 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7574 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` < `0.1514` → IC=+0.211 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1514 (IC base=-0.064)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.215 (n=492)
...
- **FILTRO** `sigma_h` > `0.0074` → IC=-0.225 (n=238)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=715)

- **FILTRO** `sigma_h` < `0.0038` → IC=-0.229 (n=312)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0038
  - _Potencial_: sin este filtro IC_bueno=-0.184 (n=641)

- **FILTRO** `sigma_ewma_delta_pct` > `19.521` → IC=-0.253 (n=172)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.521
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=781)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1163` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1163 (IC base=+0.028)

- **PATRÓN** `ibs_15` > `0.6077` → IC=+0.307 (n=55)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6077 (IC base=+0.028)

- **PATRÓN** `dist_vwap_pct` < `0.1661` → IC=+0.219 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1661 (IC base=+0.028)

- **PATRÓN** `ballena_activa_n` < `320.0` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 320.0 (IC base=+0.028)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1232` → IC=+0.167 (n=79)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.1232 (IC base=-0.048)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2037` → IC=+0.188 (n=75)

  - _Acción_: Kelly boost +0.94€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2037 (IC base=-0.048)

- **PATRÓN** `ibs_15` < `0.3814` → IC=+0.217 (n=118)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3814 (IC base=-0.048)

- **PATRÓN** `dist_vwap_pct` < `0.1451` → IC=+0.189 (n=104)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.1451 (IC base=-0.048)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `sigma_h` > `0.0178` → IC=-0.230 (n=205)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.5057` → IC=+0.339 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5057 (IC base=-0.062)
...
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0525` → IC=-0.167 (n=28)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.0525
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5909 sube el IC de +0.140 a +0.219 en UPDOWN_GBM#15min (n=607). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6414 sube el IC de +0.095 a +0.194 en UPDOWN_GBM#ETH#15min (n=145). Ya aplicado como kelly_boost=+0.97€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5676 sube el IC de +0.132 a +0.229 en UPDOWN_GBM#XRP#15min (n=149). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1154 sube el IC de +0.029 a +0.179 en UPDOWN_GBM#XRP#15min (n=188). Ya aplicado como kelly_boost=+0.89€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5 sube el IC de -0.064 a +0.194 en UPDOWN_GBM_15M_TARDIO (n=380). Ya aplicado como kelly_boost=+0.97€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3676 sube el IC de -0.064 a +0.267 en UPDOWN_GBM_15M_TARDIO (n=529). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.6077 sube el IC de +0.028 a +0.307 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=55). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3814 sube el IC de -0.048 a +0.217 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=118). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3448 sube el IC de -0.062 a +0.271 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=142). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 874 | +0.088 | +61.86€ | 2 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 874 | +0.088 | +61.86€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 25 | +0.056 | -0.25€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 25 | +0.056 | -0.25€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 585 | +0.103 | +47.85€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 585 | +0.103 | +47.85€ | 2 | 9 |
...
| ✅ BALLENAS_TARDIAS | 16044 | -0.117 | -2559.06€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 994 | -0.016 | -145.57€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 15050 | -0.124 | -2413.49€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2174 | -0.106 | -474.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2174 | -0.106 | -474.48€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 994 | -0.016 | -145.57€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 994 | -0.016 | -145.57€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2118 | -0.172 | -583.80€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2118 | -0.172 | -583.80€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 4253 | -0.059 | -381.10€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 4253 | -0.059 | -381.10€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3581 | -0.129 | -215.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3581 | -0.129 | -215.99€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2924 | -0.190 | -758.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2924 | -0.190 | -758.13€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 5111 | -0.080 | +1948.36€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 1461 | -0.013 | +1064.07€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 3650 | -0.107 | +884.29€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 5111 | -0.080 | +1948.36€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 1461 | -0.013 | +1064.07€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 3650 | -0.107 | +884.29€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 108 | -0.036 | -10.27€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 108 | -0.036 | -10.27€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 108 | -0.036 | -10.27€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 108 | -0.036 | -10.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 51529 | +0.114 | -3072.57€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 8550 | +0.182 | -296.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 184 | -0.118 | -59.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 38906 | +0.100 | -2636.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3889 | +0.116 | -79.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 6524 | +0.086 | -803.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 28 | -0.100 | +6.23€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 6481 | +0.088 | -798.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 10290 | +0.132 | -215.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2521 | +0.198 | -113.83€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 6431 | +0.110 | -123.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1296 | +0.123 | +44.28€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 6545 | +0.087 | -755.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 31 | +0.015 | +3.38€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 6499 | +0.088 | -747.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 11132 | +0.126 | -185.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 3199 | +0.170 | -37.06€ | 1 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 6476 | +0.112 | -102.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1445 | +0.097 | -37.35€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 10512 | +0.122 | -679.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2748 | +0.188 | -156.94€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 90 | -0.033 | -6.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 6526 | +0.095 | -430.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1148 | +0.130 | -86.41€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 6526 | +0.105 | -432.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 23 | -0.020 | +1.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 10 | +0.000 | +0.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 6493 | +0.106 | -434.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 8439 | +0.180 | -632.32€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 8439 | +0.180 | -632.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2156 | +0.169 | -231.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2156 | +0.169 | -231.02€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2106 | +0.172 | -215.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2106 | +0.172 | -215.86€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1891 | +0.236 | -47.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1891 | +0.236 | -47.22€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2058 | +0.187 | -151.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2058 | +0.187 | -151.14€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 419 | +0.443 | +0.85€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 419 | +0.443 | +0.85€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 27619 | +0.191 | -2487.26€ | 1 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 27619 | +0.191 | -2487.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 4909 | +0.155 | -732.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 4909 | +0.155 | -732.61€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 4314 | +0.226 | -150.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 4314 | +0.226 | -150.01€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 4774 | +0.166 | -628.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 4774 | +0.166 | -628.24€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 4404 | +0.220 | -175.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 4404 | +0.220 | -175.63€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 4565 | +0.201 | -321.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 4565 | +0.201 | -321.17€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 4653 | +0.185 | -479.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 4653 | +0.185 | -479.61€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 10037 | +0.130 | +310.05€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 10037 | +0.130 | +310.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 4968 | +0.136 | +207.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 4968 | +0.136 | +207.85€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 5069 | +0.123 | +102.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 5069 | +0.123 | +102.20€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 997 | +0.291 | -12.43€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 997 | +0.291 | -12.43€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 471 | +0.295 | +3.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 471 | +0.295 | +3.19€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 432 | +0.422 | -13.03€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 432 | +0.422 | -13.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC | 194 | +0.418 | -7.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min | 194 | +0.418 | -7.18€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#ETH | 201 | +0.426 | -5.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#ETH#60min | 201 | +0.426 | -5.39€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#SOL | 37 | +0.372 | -0.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#SOL#60min | 37 | +0.372 | -0.46€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 529 | +0.097 | -1.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 186 | +0.090 | -4.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 343 | +0.100 | +3.28€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 412 | +0.106 | +8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 69 | +0.134 | +4.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 343 | +0.100 | +3.28€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 15668 | +0.096 | -553.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 1391 | +0.078 | -20.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 14277 | +0.098 | -532.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 9325 | +0.099 | -197.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 1391 | +0.078 | -20.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 7934 | +0.102 | -176.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 2117 | +0.114 | +21.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 2117 | +0.114 | +21.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 4226 | +0.082 | -377.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 4226 | +0.082 | -377.96€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 12996 | +0.060 | +5595.09€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 12996 | +0.060 | +5595.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 2027 | +0.194 | +1470.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 2027 | +0.194 | +1470.64€ | 0 | 23 |
| ✅ GBM_LATE_15M#BTC | 1936 | +0.178 | +1332.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1936 | +0.178 | +1332.50€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 2079 | +0.193 | +1498.80€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 2079 | +0.193 | +1498.80€ | 0 | 20 |
| ✅ GBM_LATE_15M#ETH | 2000 | -0.035 | +136.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 2000 | -0.035 | +136.36€ | 2 | 11 |
| ✅ GBM_LATE_15M#SOL | 2054 | -0.051 | +498.55€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2054 | -0.051 | +498.55€ | 5 | 7 |
| ✅ GBM_LATE_15M#XRP | 2900 | -0.066 | +658.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2900 | -0.066 | +658.24€ | 4 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 13849 | +0.064 | +7163.83€ | 0 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 13849 | +0.064 | +7163.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 2452 | +0.001 | +1751.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 2452 | +0.001 | +1751.93€ | 2 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 2990 | -0.016 | +470.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 2990 | -0.016 | +470.02€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 1847 | +0.255 | +1807.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 1847 | +0.255 | +1807.28€ | 0 | 19 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 2092 | -0.045 | +84.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 2092 | -0.045 | +84.81€ | 6 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 2304 | -0.008 | +846.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 2304 | -0.008 | +846.73€ | 3 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 2164 | +0.264 | +2203.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 2164 | +0.264 | +2203.05€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 10757 | +0.167 | +7615.36€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 10757 | +0.167 | +7615.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 1535 | +0.199 | +1175.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 1535 | +0.199 | +1175.47€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 1755 | +0.160 | +1281.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 1755 | +0.160 | +1281.22€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 1583 | +0.195 | +1184.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 1583 | +0.195 | +1184.21€ | 0 | 17 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 1760 | +0.139 | +1086.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 1760 | +0.139 | +1086.58€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 2010 | +0.117 | +1259.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 2010 | +0.117 | +1259.63€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 2114 | +0.197 | +1628.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 2114 | +0.197 | +1628.27€ | 0 | 23 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 2418 | +0.108 | +813.62€ | 0 | 16 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 2418 | +0.108 | +813.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 91 | +0.113 | +37.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 91 | +0.113 | +37.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 617 | +0.088 | +186.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 617 | +0.088 | +186.19€ | 0 | 14 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 345 | +0.145 | +168.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 345 | +0.145 | +168.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 570 | +0.164 | +243.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 570 | +0.164 | +243.16€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 12910 | +0.174 | +9299.17€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#15min | 12910 | +0.174 | +9299.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 1948 | +0.220 | +1634.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 1948 | +0.220 | +1634.47€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 2081 | +0.162 | +1483.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 2081 | +0.162 | +1483.17€ | 0 | 28 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 1970 | +0.222 | +1666.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 1970 | +0.222 | +1666.96€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1994 | +0.133 | +1203.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1994 | +0.133 | +1203.29€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 2285 | +0.105 | +1266.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 2285 | +0.105 | +1266.20€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 2632 | +0.203 | +2045.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 2632 | +0.203 | +2045.07€ | 0 | 23 |
| ✅ GBM_LATE_5M | 4019 | +0.123 | +1866.03€ | 1 | 24 |
| ✅ GBM_LATE_5M#5min | 4019 | +0.123 | +1866.03€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB | 253 | +0.167 | +157.64€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB#5min | 253 | +0.167 | +157.64€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 1044 | +0.109 | +504.86€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 1044 | +0.109 | +504.86€ | 1 | 14 |
| ✅ GBM_LATE_5M#DOGE | 596 | +0.157 | +344.04€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 596 | +0.157 | +344.04€ | 0 | 21 |
| ✅ GBM_LATE_5M#ETH | 1326 | +0.141 | +655.26€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 1326 | +0.141 | +655.26€ | 0 | 29 |
| ✅ GBM_LATE_5M#SOL | 173 | -0.014 | +5.96€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 173 | -0.014 | +5.96€ | 2 | 1 |
| ✅ GBM_LATE_5M#XRP | 627 | +0.098 | +198.27€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 627 | +0.098 | +198.27€ | 0 | 0 |
| ✅ GBM_LATE_60M | 793 | +0.023 | +200.73€ | 3 | 13 |
| ✅ GBM_LATE_60M#60min | 793 | +0.023 | +200.73€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 263 | +0.062 | +59.29€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 263 | +0.062 | +59.29€ | 1 | 12 |
| ✅ GBM_LATE_60M#ETH | 291 | +0.039 | +91.08€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 291 | +0.039 | +91.08€ | 2 | 14 |
| ✅ GBM_LATE_60M#SOL | 239 | -0.039 | +50.36€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 239 | -0.039 | +50.36€ | 1 | 9 |
...
| ✅ LEADLAG_BTC_XRP_15M | 669 | +0.098 | +159.39€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 669 | +0.098 | +159.39€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 669 | +0.098 | +159.39€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 669 | +0.098 | +159.39€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_60M | 668 | -0.025 | -7.60€ | 3 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 668 | -0.025 | -7.60€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_60M#SOL | 268 | -0.030 | +0.24€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 268 | -0.030 | +0.24€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M | 8061 | -0.003 | -101.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 8061 | -0.003 | -101.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 556 | -0.007 | +1.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 556 | -0.007 | +1.36€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 877 | -0.019 | -19.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 877 | -0.019 | -19.85€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 1896 | +0.009 | -12.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 1896 | +0.009 | -12.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 1585 | +0.001 | +1.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 1585 | +0.001 | +1.75€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 1669 | -0.010 | -41.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 1669 | -0.010 | -41.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 1478 | -0.005 | -30.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 1478 | -0.005 | -30.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 13249 | -0.029 | +635.93€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 13249 | -0.029 | +635.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 2214 | -0.016 | +321.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 2214 | -0.016 | +321.55€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 2257 | -0.032 | -18.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 2257 | -0.032 | -18.20€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 2240 | -0.025 | +200.05€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 2240 | -0.025 | +200.05€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 2146 | -0.047 | -51.52€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 2146 | -0.047 | -51.52€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 2229 | -0.033 | +102.98€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 2229 | -0.033 | +102.98€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 2163 | -0.025 | +81.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 2163 | -0.025 | +81.08€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 814 | -0.087 | -45.60€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 814 | -0.087 | -45.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 121 | -0.020 | -3.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 121 | -0.020 | -3.70€ | 2 | 1 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 122 | -0.161 | -16.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 122 | -0.161 | -16.04€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE | 36 | -0.105 | -4.31€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE#15min | 36 | -0.105 | -4.31€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 168 | -0.159 | -12.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 168 | -0.159 | -12.97€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 235 | -0.057 | -0.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 235 | -0.057 | -0.65€ | 1 | 1 |
| ✅ MOMENTUM_IBS_15M_FADE#XRP | 132 | -0.030 | -7.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#XRP#15min | 132 | -0.030 | -7.93€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 35617 | -0.078 | +574.00€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 35617 | -0.078 | +574.00€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 5780 | -0.088 | +429.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 5780 | -0.088 | +429.81€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 5820 | -0.082 | -157.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 5820 | -0.082 | -157.50€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 5914 | -0.084 | +201.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 5914 | -0.084 | +201.03€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 5336 | -0.101 | -314.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 5336 | -0.101 | -314.16€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 6671 | -0.053 | +136.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 6671 | -0.053 | +136.08€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 6096 | -0.065 | +278.73€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 6096 | -0.065 | +278.73€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 6308 | -0.015 | -115.35€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 6308 | -0.015 | -115.35€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 995 | -0.018 | -20.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 995 | -0.018 | -20.76€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1344 | -0.011 | -14.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1344 | -0.011 | -14.89€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 1002 | -0.020 | -30.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 1002 | -0.020 | -30.79€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 1371 | -0.006 | -11.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 1371 | -0.006 | -11.38€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 860 | -0.022 | -13.87€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 860 | -0.022 | -13.87€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 736 | -0.020 | -23.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 736 | -0.020 | -23.66€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 761 | +0.116 | +263.82€ | 1 | 5 |
| ✅ ORDER_FLOW_5M#5min | 625 | +0.128 | +251.22€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 147 | +0.124 | +64.05€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 147 | +0.124 | +64.05€ | 0 | 2 |
...
| ✅ STREAK_FADE_5M | 1942 | -0.024 | -86.72€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 1942 | -0.024 | -86.72€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 447 | -0.028 | -22.20€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 447 | -0.028 | -22.20€ | 4 | 0 |
...
| ✅ STREAK_MOM_5M | 4145 | +0.017 | +40.75€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 4145 | +0.017 | +40.75€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 1349 | +0.018 | +8.45€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 1349 | +0.018 | +8.45€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 846 | +0.032 | +27.87€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 846 | +0.032 | +27.87€ | 1 | 1 |
| ✅ STREAK_MOM_5M#SOL | 1219 | +0.005 | -8.80€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 1219 | +0.005 | -8.80€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 731 | +0.016 | +13.23€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 731 | +0.016 | +13.23€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 4419 | +0.012 | -24.47€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 4419 | +0.012 | -24.47€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1697 | +0.013 | -9.28€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1697 | +0.013 | -9.28€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1760 | +0.020 | +3.57€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1760 | +0.020 | +3.57€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 962 | -0.004 | -18.76€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 962 | -0.004 | -18.76€ | 2 | 0 |
| ✅ UPDOWN_GBM | 11288 | +0.011 | +383.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 3832 | +0.040 | +418.74€ | 0 | 13 |
| ✅ UPDOWN_GBM#240min | 478 | +0.006 | +6.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 6207 | -0.002 | -32.20€ | 1 | 0 |
| ✅ UPDOWN_GBM#60min | 715 | -0.008 | -8.01€ | 2 | 0 |
| ✅ UPDOWN_GBM#BNB | 552 | +0.069 | +56.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 188 | +0.111 | +41.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 11 | -0.021 | -0.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 353 | +0.049 | +15.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 2069 | +0.014 | +114.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 440 | +0.072 | +91.12€ | 1 | 9 |
| ✅ UPDOWN_GBM#BTC#240min | 145 | +0.044 | +8.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 1180 | -0.005 | +17.60€ | 3 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 283 | -0.002 | -4.02€ | 2 | 2 |
| ✅ UPDOWN_GBM#BTC#daily | 21 | -0.152 | +0.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 1335 | +0.010 | +13.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 130 | +0.091 | +29.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 10 | +0.042 | +0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 1195 | +0.000 | -16.95€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 2289 | -0.001 | +15.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1094 | +0.027 | +44.47€ | 1 | 6 |
| ✅ UPDOWN_GBM#ETH#240min | 135 | +0.018 | +7.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 755 | -0.035 | -31.97€ | 4 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 286 | -0.014 | -4.07€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 19 | -0.158 | +0.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 3208 | +0.004 | +26.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1011 | +0.007 | +29.40€ | 1 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 129 | -0.004 | -2.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 1908 | +0.005 | +0.85€ | 2 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 146 | -0.007 | +0.07€ | 1 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 14 | -0.175 | -1.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 1833 | +0.021 | +157.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 969 | +0.053 | +181.83€ | 0 | 9 |
| ✅ UPDOWN_GBM#XRP#240min | 48 | -0.120 | -6.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 816 | -0.007 | -17.21€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 6058 | -0.064 | +1348.05€ | 4 | 9 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 6058 | -0.064 | +1348.05€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 311 | -0.050 | +343.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 311 | -0.050 | +343.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1237 | -0.147 | -55.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1237 | -0.147 | -55.81€ | 3 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1978 | -0.064 | +391.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1978 | -0.064 | +391.95€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1883 | -0.084 | +377.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1883 | -0.084 | +377.51€ | 2 | 4 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.081) — sin ventaja clara. oversold(IBS<0.3): IC=+0.025 n=3957 | neutral: IC=+0.007 n=4395 | overbought(IBS>0.7): IC=+0.088 n=4398
  - _Datos_: n=13243 IC=+0.041 PNL=+1389.59€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 233 celda(s) pasan gate riguroso completo de 1490 evaluadas (n>=40) y 2544 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.007 < 0.08 — monitorear
  - _Datos_: n=1011 IC=+0.007 PNL=+29.40€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 11226 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.

**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  - _Umbral_: n≥60 alineadas y gap IC≥0.08 vs contrarias — y descartar que sea proxy de drift_15min/60min
  - _Acción_: Si confirma e independiente de drift → capturar prev_window_outcome como feature en shadow_predict y boost ×1.1-1.2 en señales alineadas
  - _Estado_: alineada_con_outcome_prev IC=+0.006 n=75/60 | contraria IC=+0.135 n=50 | gap=-0.128 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=286/40 IC=-0.014 PNL=-4.07€ | BTC#60min: n=283/40 IC=-0.002 PNL=-4.02€ | SOL#60min: n=146/40 IC=-0.007 PNL=+0.07€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.063 n=167602 | tras_1loss IC=+0.053 n=132242 | tras_2loss IC=+0.018 n=58980/40 | gap=+0.045 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.004 n=990 | contrario_BTC IC=-0.005 n=891/40 | gap=-0.001 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=10927 IC=+0.010 PNL=+332.43€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=10927 IC=+0.010 PNL=+332.43€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=555 IC=+0.004 PNL=-1.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=555 IC=+0.004 PNL=-1.38€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=160 IC=-0.049 PNL=-6.63€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=160 IC=-0.049 PNL=-6.63€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.140 > 0.1 con n=808 PNL=+295.48€
  - _Datos_: n=808 IC=+0.140 PNL=+295.48€
...
**〰️ H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: n=241 IC=+0.043 PNL=+36.30€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=241 IC=+0.043 PNL=+36.30€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=2234 IC=+0.037 PNL=+257.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2234 IC=+0.037 PNL=+257.38€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2784 IC=+0.015 PNL=+121.82€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2784 IC=+0.015 PNL=+121.82€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=846 IC=+0.034 PNL=+37.85€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=846 IC=+0.034 PNL=+37.85€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.139 > 0.08 con n=181 PNL=+70.18€
  - _Datos_: n=181 IC=+0.139 PNL=+70.18€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.130 > 0.02 con n=428 PNL=+163.94€
  - _Datos_: n=428 IC=+0.130 PNL=+163.94€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=2951 IC=+0.039 PNL=+282.79€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2951 IC=+0.039 PNL=+282.79€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.168 > 0.1 con n=1221 PNL=+499.14€
  - _Datos_: n=1221 IC=+0.168 PNL=+499.14€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=748 IC=+0.029 PNL=+78.79€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=748 IC=+0.029 PNL=+78.79€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=8571 IC=-0.139 PNL=+498.87€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=8571 IC=-0.139 PNL=+498.87€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1004 IC=+0.145 PNL=+554.83€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1004 IC=+0.145 PNL=+554.83€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.141 > 0.08 con n=770 PNL=+281.11€
  - _Datos_: n=770 IC=+0.141 PNL=+281.11€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.235 < -0.1 con n=931 PNL=-104.84€
  - _Datos_: n=931 IC=-0.235 PNL=-104.84€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=2410 IC=+0.143 PNL=+1438.35€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=2410 IC=+0.143 PNL=+1438.35€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=1015 IC=+0.003 PNL=+132.44€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1015 IC=+0.003 PNL=+132.44€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.187 > 0.08 con n=929 PNL=+645.54€
  - _Datos_: n=929 IC=+0.187 PNL=+645.54€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=1524 IC=-0.056 PNL=+334.41€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1524 IC=-0.056 PNL=+334.41€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.227 > 0.08 con n=2139 PNL=-220.04€
  - _Datos_: n=2139 IC=+0.227 PNL=-220.04€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.092 n=361) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=361 IC=+0.092 PNL=+84.82€
...
**🟡 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.315 > 0.08 con n=117 PNL=+58.42€
  - _Datos_: n=117 IC=+0.315 PNL=+58.42€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=4909 IC=+0.155 PNL=-732.61€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=4909 IC=+0.155 PNL=-732.61€
