# Hipótesis automáticas — 2026-07-12 11:25 UTC
_Generado por shadow_postmortem.py sobre 10832 resoluciones (PNL=+1880.56€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.214 (n=292)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.213)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.219 (n=322)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.213)

- **PATRÓN** `py_entrada` > `0.695` → IC=+0.323 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `2340.244` → IC=+0.223 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2340.244 (IC base=+0.213)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.235 (n=47)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.605` → IC=+0.226 (n=71)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 861 | +0.185 | +11.35€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 554 | +0.212 | +7.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 34 | +0.028 | -2.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 129 | +0.080 | -11.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 144 | +0.205 | +17.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 254 | +0.191 | +0.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 185 | +0.211 | -4.90€ | 0 | 7 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.089 n=6101 | tras_1loss IC=+0.043 n=4594 | tras_2loss IC=+0.009 n=2066/40 | gap=+0.081 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8374 IC=+0.095 PNL=+1956.45€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8374 IC=+0.095 PNL=+1956.45€
