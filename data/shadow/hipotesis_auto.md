# Hipótesis automáticas — 2026-09-25 13:14 UTC
_Generado por shadow_postmortem.py sobre 604951 resoluciones (PNL=+68472.06€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.18` → IC=-0.229 (n=7150)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.18
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=21452)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `137.45` → IC=-0.249 (n=938)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 137.45
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2817)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `499.92` → IC=-0.147 (n=369)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 499.92
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1110)
...
- **FILTRO** `restante_s_al_confirmar` < `165.41` → IC=-0.215 (n=1730)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.41
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=5192)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `127.34` → IC=-0.351 (n=1408)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.34
  - _Potencial_: sin este filtro IC_bueno=-0.114 (n=4227)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.205 (n=13995)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=3529)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5649.2316` → IC=+0.178 (n=2247)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=11013)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5714)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `7845.6927` → IC=+0.175 (n=2159)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7845.6927 (IC base=+0.126)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1742)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.206)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=1709)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.44` → IC=+0.143 (n=827)
...
- **PATRÓN** `py_entrada` < `0.26` → IC=+0.358 (n=625)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.26 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.237 (n=1496)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.234)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.159 (n=464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 11.0 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.140 (n=673)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=551)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `1311.0387` → IC=+0.152 (n=667)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.163 (n=553)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=732)
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.208 (n=303)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=872)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.243)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.246 (n=873)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.446 (n=182)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.432 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.433)

- **PATRÓN** `libro_liquidez` > `3369.9988` → IC=+0.448 (n=133)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=34579)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.236 (n=15420)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.177 (n=5975)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `2.77` → IC=+0.140 (n=4861)

  - _Acción_: Kelly boost +0.70€ cuando `lag_apertura_s` < 2.77 (IC base=+0.117)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.197 (n=2650)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.38 (IC base=+0.121)

- **PATRÓN** `restante_min` < `4.12` → IC=+0.128 (n=2434)

  - _Acción_: Kelly boost +0.64€ cuando `restante_min` < 4.12 (IC base=+0.121)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.140 (n=2637)
...
- **PATRÓN** `lag_apertura_s` < `3.36` → IC=+0.142 (n=2413)

  - _Acción_: Kelly boost +0.71€ cuando `lag_apertura_s` < 3.36 (IC base=+0.121)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.189 (n=2611)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.38 (IC base=+0.113)

- **PATRÓN** `restante_min` < `4.19` → IC=+0.125 (n=2454)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.19 (IC base=+0.113)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.134 (n=2681)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 4.96 (IC base=+0.113)

- **PATRÓN** `lag_apertura_s` < `2.27` → IC=+0.139 (n=2448)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.136` → IC=+0.268 (n=791)
...
- **PATRÓN** `dist_vwap_pct` < `0.5724` → IC=+0.221 (n=1484)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5724 (IC base=+0.217)
...
- **PATRÓN** `volumen_regimen` < `1.2554` → IC=+0.219 (n=1416)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2554 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `1.0803` → IC=+0.227 (n=642)
...
- **PATRÓN** `ibs_20min` < `0.3275` → IC=+0.199 (n=983)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.3275 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.157 (n=1311)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.284` → IC=+0.144 (n=1344)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 4.284 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.2035` → IC=+0.152 (n=1474)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2035 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.1564` → IC=+0.179 (n=391)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1564 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.4238` → IC=+0.154 (n=1364)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4238 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4164` → IC=+0.150 (n=1364)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4164 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `14094.8894` → IC=+0.145 (n=983)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 14094.8894 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `410.0` → IC=+0.150 (n=1284)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 410.0 (IC base=+0.141)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.211 (n=608)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0117 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=1914)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2101` → IC=+0.188 (n=1825)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2101 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.3587` → IC=+0.201 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3587 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.8278` → IC=+0.204 (n=786)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8278 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=1294)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.222 (n=1380)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.6083` → IC=+0.212 (n=1567)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0645` → IC=+0.243 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0645 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.627` → IC=+0.237 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.627 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.57` → IC=+0.210 (n=1701)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.57 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.3531` → IC=+0.272 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3531 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` < `1.7653` → IC=+0.202 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7653 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.1985` → IC=+0.219 (n=958)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1985 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.215 (n=1058)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `1900.6539` → IC=+0.219 (n=710)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1900.6539 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.216 (n=937)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.150 (n=101)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2246)

- **PATRÓN** `ibs_20min` > `0.9456` → IC=+0.210 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9456 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1604` → IC=+0.321 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1604 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` < `0.7929` → IC=+0.334 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7929 (IC base=+0.025)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.752` → IC=+0.159 (n=726)
...
- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.331 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 160.0 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.6848` → IC=+0.205 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6848 (IC base=+0.018)

- **PATRÓN** `volumen_regimen` < `0.8497` → IC=+0.164 (n=567)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8497 (IC base=+0.018)

- **PATRÓN** `volumen_regimen` > `1.1597` → IC=+0.154 (n=284)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1597 (IC base=+0.018)

- **PATRÓN** `volumen_pendiente_norm` > `0.2812` → IC=+0.221 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2812 (IC base=+0.018)

- **PATRÓN** `volumen_spike_ratio` > `1.5204` → IC=+0.178 (n=712)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5204 (IC base=+0.018)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.125 (n=2220)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=1095)

- **FILTRO** `sigma_ewma_delta_pct` > `8.696` → IC=-0.208 (n=354)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.696
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2961)
...
- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.125 (n=1095)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4253` → IC=+0.265 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4253 (IC base=-0.042)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.184 (n=577)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=1733)

- **FILTRO** `ibs_20min` < `0.7191` → IC=-0.153 (n=1524)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7191
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=786)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.200 (n=418)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1892)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.203 (n=847)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2543)
...
- **PATRÓN** `dist_vwap_pct` > `0.5572` → IC=+0.268 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5572 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` < `0.7364` → IC=+0.253 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7364 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` > `1.092` → IC=+0.280 (n=353)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.092 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.1035` → IC=+0.274 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1035 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `2.141` → IC=+0.256 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.141 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.5237` → IC=+0.247 (n=595)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5237 (IC base=-0.023)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.243 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.198 (n=3438)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0098 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4762` → IC=+0.189 (n=9209)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4762 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7682` → IC=+0.288 (n=1096)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7682 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.609` → IC=+0.157 (n=4839)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.609 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6911` → IC=+0.250 (n=3283)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4655` → IC=+0.239 (n=1989)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4655 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6612` → IC=+0.243 (n=1989)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6612 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.268 (n=5473)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 96.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.157 (n=3422)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0091 (IC base=+0.074)

- **PATRÓN** `ibs_20min` < `0.5494` → IC=+0.155 (n=9011)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.5494 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.7307` → IC=+0.243 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7307 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` < `0.2525` → IC=+0.240 (n=2855)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2525 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` < `0.7101` → IC=+0.242 (n=1331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7101 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` > `1.2058` → IC=+0.247 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2058 (IC base=+0.074)

- **PATRÓN** `volumen_pendiente_norm` > `0.2437` → IC=+0.303 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2437 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` < `1.6007` → IC=+0.261 (n=1760)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6007 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` > `2.3059` → IC=+0.258 (n=1813)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3059 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.265 (n=3876)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.074)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.536` → IC=-0.158 (n=541)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.536
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1822)

- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.267 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8935 (IC base=+0.044)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.828` → IC=+0.211 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.828 (IC base=+0.044)
...
- **PATRÓN** `ibs_20min` > `0.8641` → IC=+0.160 (n=689)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8641 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3135` → IC=+0.175 (n=380)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3135 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.170 (n=849)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4243` → IC=+0.196 (n=310)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.4243 (IC base=+0.026)

- **PATRÓN** `volumen_spike_ratio` > `2.3804` → IC=+0.154 (n=310)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.3804 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `243.0` → IC=+0.195 (n=405)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 243.0 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.222 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1614 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `0.611` → IC=+0.216 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.611 (IC base=+0.005)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4386` → IC=+0.218 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4386 (IC base=+0.005)

- **PATRÓN** `volumen_spike_ratio` > `2.1523` → IC=+0.235 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1523 (IC base=+0.005)

- **PATRÓN** `ballena_activa_n` < `464.0` → IC=+0.218 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 464.0 (IC base=+0.005)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.288 (n=541)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.246)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.249 (n=1623)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.246)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.249 (n=1451)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.246)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=860)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.104` → IC=+0.258 (n=1379)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.104 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `3.4162` → IC=+0.263 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4162 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.255 (n=1143)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1802.242` → IC=+0.249 (n=1081)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1802.242 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.317 (n=589)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0099 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.613` → IC=+0.284 (n=1298)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0909` → IC=+0.288 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0909 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.812` → IC=+0.296 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.812 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.3414` → IC=+0.308 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3414 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` < `1.5923` → IC=+0.284 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5923 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.7268` → IC=+0.288 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7268 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.285 (n=869)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1887.358` → IC=+0.295 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.358 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `28.0` → IC=+0.286 (n=774)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 28.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.294` → IC=-0.184 (n=504)

  - _Acción_: SKIP cuando `ibs_20min` < 0.294
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1515)

- **FILTRO** `ibs_20min` > `0.7753` → IC=-0.190 (n=607)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7753
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1822)

- **PATRÓN** `ibs_20min` > `0.8224` → IC=+0.161 (n=688)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8224 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` > `0.4514` → IC=+0.226 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4514 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` < `0.7002` → IC=+0.216 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7002 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` < `0.9978` → IC=+0.236 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9978 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` > `0.5902` → IC=+0.216 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5902 (IC base=+0.015)

- **PATRÓN** `volumen_pendiente_norm` > `0.1662` → IC=+0.269 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1662 (IC base=+0.015)

- **PATRÓN** `volumen_spike_ratio` < `1.5078` → IC=+0.263 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5078 (IC base=+0.015)

- **PATRÓN** `ballena_activa_n` < `149.0` → IC=+0.247 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 149.0 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` > `0.1559` → IC=+0.213 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1559 (IC base=-0.006)

- **PATRÓN** `dist_vwap_pct` < `0.6853` → IC=+0.201 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6853 (IC base=-0.006)

- **PATRÓN** `volumen_regimen` < `1.1677` → IC=+0.213 (n=434)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1677 (IC base=-0.006)

- **PATRÓN** `volumen_pendiente_norm` > `0.2852` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2852 (IC base=-0.006)

- **PATRÓN** `volumen_spike_ratio` < `1.8285` → IC=+0.261 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8285 (IC base=-0.006)

- **PATRÓN** `volumen_spike_ratio` > `2.1499` → IC=+0.237 (n=177)
...
- **FILTRO** `ibs_20min` < `0.7273` → IC=-0.194 (n=1091)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=+0.278 (n=1094)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.235 (n=561)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1698)

- **FILTRO** `sigma_ewma_delta_pct` > `4.71` → IC=-0.184 (n=492)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.71
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=1767)

- **PATRÓN** `ibs_20min` > `0.7273` → IC=+0.278 (n=1094)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7273 (IC base=+0.043)

- **PATRÓN** `dist_vwap_pct` > `0.8547` → IC=+0.332 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8547 (IC base=+0.043)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.621` → IC=+0.171 (n=344)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.621 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` < `0.8684` → IC=+0.304 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8684 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` > `0.7313` → IC=+0.297 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7313 (IC base=+0.043)

- **PATRÓN** `volumen_pendiente_norm` < `0.1016` → IC=+0.293 (n=751)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0972` → IC=+0.213 (n=532)
...
- **PATRÓN** `volumen_spike_ratio` < `2.481` → IC=+0.224 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.481 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.239 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=+0.014)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.318 (n=892)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0168 (IC base=+0.277)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.283 (n=1341)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.277)

- **PATRÓN** `ibs_20min` > `0.6319` → IC=+0.311 (n=1338)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6319 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.2113` → IC=+0.317 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2113 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.604` → IC=+0.303 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.604 (IC base=+0.277)

- **PATRÓN** `volumen_regimen` > `0.8619` → IC=+0.303 (n=892)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1481` → IC=+0.296 (n=576)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1481 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1432)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2636.1235` → IC=+0.294 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2636.1235 (IC base=+0.277)

- **PATRÓN** `sigma_h` > `0.0153` → IC=+0.300 (n=955)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0153 (IC base=+0.273)
...
- **PATRÓN** `ibs_20min` < `0.3939` → IC=+0.306 (n=1433)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3939 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` > `0.3084` → IC=+0.280 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3084 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` < `0.2265` → IC=+0.274 (n=1293)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2265 (IC base=+0.273)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.477` → IC=+0.291 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.477 (IC base=+0.273)

- **PATRÓN** `volumen_regimen` < `0.6405` → IC=+0.277 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6405 (IC base=+0.273)

- **PATRÓN** `volumen_regimen` > `1.244` → IC=+0.306 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.244 (IC base=+0.273)

- **PATRÓN** `volumen_pendiente_norm` > `0.2375` → IC=+0.335 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2375 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` < `1.4259` → IC=+0.277 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4259 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` > `2.1452` → IC=+0.273 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1452 (IC base=+0.273)

- **PATRÓN** `libro_liquidez` > `2627.1278` → IC=+0.277 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2627.1278 (IC base=+0.273)
...
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.202 (n=2670)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0906` → IC=+0.188 (n=2669)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0906 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=8336)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.575` → IC=+0.219 (n=8013)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.575 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1782` → IC=+0.195 (n=3500)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1782 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.347` → IC=+0.255 (n=1635)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.347 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2128` → IC=+0.160 (n=5302)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2128 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6316` → IC=+0.161 (n=5301)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6316 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2955` → IC=+0.198 (n=1196)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2955 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5587` → IC=+0.167 (n=3380)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5587 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6169` → IC=+0.178 (n=2560)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6169 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2407.5074` → IC=+0.169 (n=5338)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2407.5074 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `114.0` → IC=+0.181 (n=6916)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 114.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=5092)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0811` → IC=+0.208 (n=2544)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0811 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2934)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.48` → IC=+0.226 (n=7632)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.48 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9212` → IC=+0.145 (n=744)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9212 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2352` → IC=+0.158 (n=5532)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2352 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.353` → IC=+0.193 (n=1295)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.353 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1737` → IC=+0.151 (n=5524)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1737 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2909` → IC=+0.217 (n=1100)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2909 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5586` → IC=+0.165 (n=3055)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5586 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.2522` → IC=+0.170 (n=3148)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2522 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `115.0` → IC=+0.173 (n=6590)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3425` → IC=+0.206 (n=1361)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3425 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=1431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.8961` → IC=+0.279 (n=907)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8961 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.137` → IC=+0.309 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.137 (IC base=+0.182)
...
- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.264 (n=995)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.331` → IC=+0.250 (n=1075)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.331 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.1603` → IC=+0.234 (n=939)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1603 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` > `0.287` → IC=+0.250 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.287 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` < `1.4206` → IC=+0.266 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4206 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.238 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1994.8172` → IC=+0.245 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1994.8172 (IC base=+0.238)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.482` → IC=+0.234 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.482 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2593` → IC=+0.164 (n=1190)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2593 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0736` → IC=+0.170 (n=540)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0736 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.281` → IC=+0.209 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.281 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.5024` → IC=+0.181 (n=509)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5024 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `2.4541` → IC=+0.162 (n=385)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.4541 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `11874.9267` → IC=+0.170 (n=1063)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0594` → IC=+0.205 (n=432)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0594 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.184 (n=504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 17.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.565` → IC=+0.188 (n=1294)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.565 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1346` → IC=+0.160 (n=1282)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1346 (IC base=+0.138)
...
- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.159 (n=1294)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.2089 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1561` → IC=+0.156 (n=396)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1561 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.146 (n=1183)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4211` → IC=+0.138 (n=1182)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.222 (n=610)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0101 (IC base=+0.200)

- **PATRÓN** `drift_60min` |x|≤ `0.234` → IC=+0.216 (n=897)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.234 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=1393)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.877` → IC=+0.272 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.877 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2071` → IC=+0.203 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2071 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `1.8217` → IC=+0.199 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8217 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `2.8416` → IC=+0.215 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8416 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.200)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.231 (n=1113)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.248 (n=371)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3478` → IC=+0.248 (n=1113)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3478 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.746` → IC=+0.263 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.746 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` > `0.3553` → IC=+0.268 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3553 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `1.7668` → IC=+0.211 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7668 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `3.3893` → IC=+0.237 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.3893 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `11.0` → IC=+0.207 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 11.0 (IC base=+0.217)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.174 (n=1127)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0066 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.4335` → IC=+0.158 (n=1279)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4335 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1340)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.375` → IC=+0.198 (n=1278)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.375 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.1614` → IC=+0.180 (n=851)
...
- **PATRÓN** `volumen_regimen` < `1.0405` → IC=+0.146 (n=1125)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0405 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6279` → IC=+0.148 (n=1278)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6279 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.2917` → IC=+0.202 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2917 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.4257` → IC=+0.152 (n=417)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4257 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `2.5102` → IC=+0.171 (n=417)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.5102 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `6496.8974` → IC=+0.185 (n=852)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6496.8974 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.149 (n=1214)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 162.0 (IC base=+0.144)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.153 (n=1343)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3842` → IC=+0.142 (n=1343)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3842 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.179 (n=521)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.4638` → IC=+0.190 (n=1182)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.4638 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.368` → IC=+0.136 (n=1450)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.368 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.963` → IC=+0.166 (n=474)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 6.963 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8476` → IC=+0.148 (n=896)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8476 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.190 (n=195)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.789` → IC=+0.137 (n=814)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.789 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.160 (n=609)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 10007.3401 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.156 (n=655)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0101 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=1476)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 5.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.206 (n=1445)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5156 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` > `0.8477` → IC=+0.212 (n=436)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8477 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.733` → IC=+0.256 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.733 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.131 (n=1446)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.2184 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` > `0.6466` → IC=+0.124 (n=1445)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.6466 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.0978` → IC=+0.126 (n=548)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.0978 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `2.4678` → IC=+0.128 (n=1396)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.4678 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1510)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2898.8632` → IC=+0.196 (n=655)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2898.8632 (IC base=+0.119)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.137 (n=1100)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1034` → IC=+0.159 (n=488)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1034 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1480)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.209 (n=1463)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `1.012` → IC=+0.142 (n=199)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 1.012 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.2019` → IC=+0.137 (n=1349)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2019 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.321` → IC=+0.130 (n=446)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 5.321 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.6379` → IC=+0.141 (n=488)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.6379 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2754` → IC=+0.159 (n=180)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.2754 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.4547` → IC=+0.132 (n=438)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4547 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2767.152` → IC=+0.156 (n=663)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 2767.152 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0189` → IC=+0.213 (n=926)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1442)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0223` → IC=+0.206 (n=647)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0223 (IC base=+0.202)

- **PATRÓN** `drift_60min` |x|≤ `0.0897` → IC=+0.219 (n=475)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4384` → IC=+0.244 (n=1424)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4384 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `1.2573` → IC=+0.229 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2573 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.437` → IC=+0.239 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.437 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6325` → IC=+0.213 (n=1424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6325 (IC base=+0.202)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2006` → IC=+0.193 (n=1127)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2006 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.4348` → IC=+0.198 (n=1281)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4348 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2602.132` → IC=+0.207 (n=949)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2602.132 (IC base=+0.202)
...
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.175 (n=645)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0088 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.3556` → IC=+0.150 (n=1703)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.3556 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=961)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.5391` → IC=+0.188 (n=1728)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5391 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.8726` → IC=+0.180 (n=311)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.8726 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.709` → IC=+0.175 (n=874)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.709 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.8753` → IC=+0.164 (n=1134)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8753 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `0.7015` → IC=+0.151 (n=1520)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.7015 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.165` → IC=+0.175 (n=534)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.165 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.4411` → IC=+0.162 (n=622)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4411 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.8249` → IC=+0.151 (n=1244)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8249 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.151 (n=2195)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.02 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `12429.5841` → IC=+0.160 (n=645)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12429.5841 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.168 (n=1713)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 156.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.139 (n=1340)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0056 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=2026)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6665` → IC=+0.139 (n=2008)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.6665 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2152` → IC=+0.122 (n=1778)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2152 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.6987` → IC=+0.126 (n=794)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 0.6987 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.1653` → IC=+0.126 (n=500)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.1653 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4526` → IC=+0.143 (n=645)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4526 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2751.2995` → IC=+0.123 (n=1793)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2751.2995 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.121 (n=818)

  - _Acción_: Kelly boost +0.60€ cuando `ballena_activa_n` < 29.0 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.257 (n=265)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.194)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.200 (n=201)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.194)

- **PATRÓN** `drift_60min` |x|≤ `0.0979` → IC=+0.209 (n=201)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0979 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=627)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.194)

- **PATRÓN** `ibs_20min` > `0.405` → IC=+0.228 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.405 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` > `0.1582` → IC=+0.211 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1582 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` < `0.6549` → IC=+0.194 (n=664)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.6549 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.884` → IC=+0.223 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.884 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` < `0.8363` → IC=+0.198 (n=402)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.8363 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` > `1.1605` → IC=+0.219 (n=201)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7539` → IC=+0.219 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7539 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=671)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.194)

- **PATRÓN** `libro_liquidez` > `12451.6308` → IC=+0.219 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12451.6308 (IC base=+0.194)

- **PATRÓN** `ibs_20min` < `0.1558` → IC=+0.153 (n=249)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.1558 (IC base=+0.093)

- **PATRÓN** `volumen_regimen` < `0.6858` → IC=+0.130 (n=249)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 0.6858 (IC base=+0.093)

- **PATRÓN** `volumen_pendiente_norm` > `0.1663` → IC=+0.127 (n=132)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.1663 (IC base=+0.093)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.164 (n=293)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0072 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.1179` → IC=+0.144 (n=147)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.1179 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` > `0.8947` → IC=+0.240 (n=294)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8947 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.947` → IC=+0.235 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.947 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.365` → IC=+0.194 (n=243)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 3.365 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `1.0741` → IC=+0.148 (n=387)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0741 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.1866` → IC=+0.172 (n=126)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1866 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `2.2097` → IC=+0.177 (n=190)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.2097 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.132 (n=479)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.02 (IC base=+0.132)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.206 (n=3415)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=10686)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.4696` → IC=+0.216 (n=10245)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4696 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.9797` → IC=+0.203 (n=1457)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9797 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.633` → IC=+0.227 (n=4932)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.633 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8814` → IC=+0.166 (n=4569)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8814 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2891` → IC=+0.202 (n=1409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2891 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.595` → IC=+0.187 (n=3287)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.595 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2350.8` → IC=+0.172 (n=6830)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2350.8 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `86.0` → IC=+0.195 (n=7819)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 86.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=6193)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1488` → IC=+0.189 (n=4081)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1488 (IC base=+0.181)
...
- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.237 (n=9276)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2512` → IC=+0.162 (n=5740)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2512 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.044` → IC=+0.200 (n=1303)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.044 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.734` → IC=+0.182 (n=8975)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.734 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7051` → IC=+0.162 (n=2802)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.7051 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2043` → IC=+0.154 (n=2122)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2043 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2879` → IC=+0.240 (n=1226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2879 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.6218` → IC=+0.193 (n=2841)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6218 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.194 (n=5508)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.222 (n=580)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.356` → IC=+0.190 (n=1732)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.562` → IC=+0.345 (n=392)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2444` → IC=+0.196 (n=742)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.2444 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1034)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.189)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.262 (n=1364)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0045 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.1282` → IC=+0.281 (n=600)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1282 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.268 (n=1233)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3517` → IC=+0.289 (n=1201)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3517 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.475` → IC=+0.262 (n=1427)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.475 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2803` → IC=+0.285 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2803 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` < `1.5484` → IC=+0.256 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5484 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `2.635` → IC=+0.276 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.635 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1807.5248` → IC=+0.264 (n=909)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1807.5248 (IC base=+0.258)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.191 (n=548)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0028 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.0852` → IC=+0.160 (n=548)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0852 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1716)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3085` → IC=+0.204 (n=1642)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3085 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.3455` → IC=+0.192 (n=666)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.3455 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.73` → IC=+0.170 (n=374)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.73 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.235` → IC=+0.154 (n=1482)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.235 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.6288` → IC=+0.180 (n=548)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6288 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2666` → IC=+0.200 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2666 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.1137` → IC=+0.161 (n=1397)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1137 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.7557` → IC=+0.156 (n=1058)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7557 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `15747.2217` → IC=+0.160 (n=745)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 15747.2217 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `472.0` → IC=+0.158 (n=1519)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 472.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.167 (n=1423)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.0802` → IC=+0.185 (n=475)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0802 (IC base=+0.153)
...
- **PATRÓN** `ibs_20min` < `0.2707` → IC=+0.239 (n=948)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2707 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.6883` → IC=+0.155 (n=233)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6883 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.1343` → IC=+0.167 (n=1279)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1343 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.493` → IC=+0.160 (n=239)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.493 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.283` → IC=+0.154 (n=1289)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.283 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.165 (n=1421)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1888 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.1512` → IC=+0.196 (n=380)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1512 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.4003` → IC=+0.161 (n=1323)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4003 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `2.0862` → IC=+0.168 (n=601)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.0862 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `420.0` → IC=+0.158 (n=1079)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 420.0 (IC base=+0.153)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.012` → IC=+0.247 (n=555)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.012 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.226 (n=1740)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1689)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.797` → IC=+0.294 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.797 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` < `0.2107` → IC=+0.222 (n=1648)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2107 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.8283` → IC=+0.241 (n=719)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8283 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.229 (n=1178)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1802.242` → IC=+0.218 (n=1108)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1802.242 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0117` → IC=+0.237 (n=1552)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0117 (IC base=+0.231)

- **PATRÓN** `drift_60min` |x|≤ `0.1678` → IC=+0.238 (n=681)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1678 (IC base=+0.231)
...
- **PATRÓN** `ibs_20min` < `0.3611` → IC=+0.266 (n=1362)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3611 (IC base=+0.231)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.751` → IC=+0.273 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.751 (IC base=+0.231)

- **PATRÓN** `volumen_pendiente_norm` > `0.3445` → IC=+0.305 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3445 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` < `1.7532` → IC=+0.229 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7532 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` > `2.1869` → IC=+0.235 (n=948)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1869 (IC base=+0.231)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.238 (n=1046)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.231)

- **PATRÓN** `libro_liquidez` > `1955.4832` → IC=+0.241 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1955.4832 (IC base=+0.231)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.229 (n=1352)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.231)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.178 (n=768)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0041 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4384` → IC=+0.146 (n=1743)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4384 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.153 (n=1820)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.877` → IC=+0.261 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.877 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3755` → IC=+0.163 (n=693)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.3755 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.45` → IC=+0.166 (n=282)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.45 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8743` → IC=+0.156 (n=1162)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8743 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.281` → IC=+0.220 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.281 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5221` → IC=+0.150 (n=743)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5221 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.7664` → IC=+0.150 (n=1125)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.7664 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8051.1298` → IC=+0.232 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8051.1298 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `91.0` → IC=+0.151 (n=720)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 91.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.154 (n=1421)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0076 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4484` → IC=+0.153 (n=1420)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7027` → IC=+0.182 (n=1420)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.7027 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.5983` → IC=+0.141 (n=1571)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5983 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.146` → IC=+0.176 (n=211)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 11.146 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.6958` → IC=+0.151 (n=625)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6958 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `1.1938` → IC=+0.145 (n=474)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.151 (n=1347)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `7268.5561` → IC=+0.200 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7268.5561 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `178.0` → IC=+0.144 (n=1348)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 178.0 (IC base=+0.137)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.141 (n=1156)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0082 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1781)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.192 (n=1736)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.4706 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.0902` → IC=+0.200 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0902 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.513` → IC=+0.237 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.513 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.8958` → IC=+0.136 (n=1156)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8958 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1742)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.248 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2898.7698 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.133 (n=1345)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1331` → IC=+0.162 (n=560)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.1331 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=1734)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1680)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2207` → IC=+0.132 (n=1371)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.2207 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.486` → IC=+0.127 (n=1624)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.486 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.717` → IC=+0.153 (n=739)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.717 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2227` → IC=+0.164 (n=263)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.2227 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4467` → IC=+0.144 (n=506)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4467 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2831.1065` → IC=+0.169 (n=560)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2831.1065 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.121 (n=1312)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 51.0 (IC base=+0.114)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.218 (n=1158)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1809)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.208)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.210 (n=1557)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.248 (n=1736)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` > `0.207` → IC=+0.234 (n=1028)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.207 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.245` → IC=+0.273 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.245 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` < `1.2484` → IC=+0.212 (n=1736)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2484 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `0.64` → IC=+0.216 (n=1736)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5002` → IC=+0.236 (n=559)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5002 (IC base=+0.208)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1827)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `2631.9838` → IC=+0.220 (n=1157)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2631.9838 (IC base=+0.208)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.225 (n=617)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.222 (n=616)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0256 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.209 (n=1294)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.4224` → IC=+0.266 (n=1625)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4224 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `1.2792` → IC=+0.204 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2792 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.9279` → IC=+0.203 (n=2051)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9279 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.822` → IC=+0.255 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.822 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `1.236` → IC=+0.236 (n=616)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1829` → IC=+0.198 (n=1463)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.1829 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4288` → IC=+0.197 (n=1662)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4288 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1094)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.142 (n=3109)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.167 (n=2622)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0091 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.5178` → IC=+0.167 (n=2980)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.5178 (IC base=+0.157)
...
- **PATRÓN** `ibs_20min` > `0.9414` → IC=+0.216 (n=993)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9414 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.1894` → IC=+0.170 (n=1105)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1894 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` < `0.4855` → IC=+0.153 (n=1846)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.4855 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.195` → IC=+0.191 (n=487)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 10.195 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `0.8968` → IC=+0.167 (n=1313)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.8968 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.171` → IC=+0.192 (n=818)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.171 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `1.4563` → IC=+0.165 (n=983)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4563 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.8762` → IC=+0.166 (n=1962)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.8762 (IC base=+0.157)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.159 (n=2094)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `3871.4994` → IC=+0.166 (n=1986)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3871.4994 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.198 (n=782)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0038 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.4871` → IC=+0.159 (n=2344)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1819` → IC=+0.172 (n=1031)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.1819 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.6841` → IC=+0.162 (n=450)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.6841 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.303` → IC=+0.151 (n=2329)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.303 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.9003` → IC=+0.159 (n=1495)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.9003 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.0969` → IC=+0.144 (n=2123)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.0969 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.144 (n=1081)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.4249` → IC=+0.154 (n=772)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4249 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.8143` → IC=+0.143 (n=1542)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8143 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.142 (n=3109)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `7238.8989` → IC=+0.153 (n=2094)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 7238.8989 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.170 (n=853)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0073 (IC base=+0.165)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.172 (n=969)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0043 (IC base=+0.165)

- **PATRÓN** `drift_60min` |x|≤ `0.3855` → IC=+0.171 (n=853)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3855 (IC base=+0.165)
...
- **PATRÓN** `ibs_20min` < `0.5481` → IC=+0.173 (n=647)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.5481 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.8883` → IC=+0.180 (n=323)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.8883 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.1638` → IC=+0.166 (n=566)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1638 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` < `0.4255` → IC=+0.173 (n=900)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.4255 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.134` → IC=+0.176 (n=871)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 4.134 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `1.0856` → IC=+0.167 (n=853)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.0856 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` > `0.6431` → IC=+0.168 (n=969)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6431 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` < `0.1056` → IC=+0.167 (n=893)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` < 0.1056 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.0781` → IC=+0.174 (n=422)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0781 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` < `1.4349` → IC=+0.177 (n=317)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4349 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.5194` → IC=+0.168 (n=849)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.5194 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=963)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.186 (n=269)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0041 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.497` → IC=+0.174 (n=805)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.497 (IC base=+0.146)
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.161 (n=546)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 10.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` < `0.748` → IC=+0.149 (n=805)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.748 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.0983` → IC=+0.154 (n=805)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.0983 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.6253` → IC=+0.182 (n=177)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.6253 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.399` → IC=+0.155 (n=729)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.399 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.6473` → IC=+0.183 (n=269)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6473 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.7274` → IC=+0.150 (n=719)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.7274 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.0742` → IC=+0.165 (n=338)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0742 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.2051` → IC=+0.158 (n=694)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.2051 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7829` → IC=+0.150 (n=526)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.7829 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `7572.3913` → IC=+0.172 (n=805)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7572.3913 (IC base=+0.146)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.240 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.191` → IC=+0.140 (n=162)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.191 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.247` → IC=+0.194 (n=47)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 9.247 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.212 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.4231` → IC=+0.130 (n=225)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4231 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `3421.4081` → IC=+0.143 (n=208)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 3421.4081 (IC base=+0.096)
...
- **FILTRO** `dist_vwap_pct` > `0.1829` → IC=-0.179 (n=26)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.116 (n=331)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.185 (n=417)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0041 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.127 (n=867)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 8.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.67` → IC=+0.203 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.67 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.1562` → IC=+0.159 (n=461)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2792` → IC=+0.202 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2792 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `2.0892` → IC=+0.130 (n=649)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 2.0892 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.139 (n=375)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 2432.8034 (IC base=+0.094)

- **PATRÓN** `ibs_20min` < `0.0667` → IC=+0.269 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0667 (IC base=+0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.07` → IC=+0.189 (n=101)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.07 (IC base=+0.005)

- **PATRÓN** `volumen_spike_ratio` < `2.5298` → IC=+0.127 (n=239)
...
- **PATRÓN** `ibs_20min` < `0.0889` → IC=+0.283 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0889 (IC base=+0.055)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.732` → IC=+0.149 (n=112)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.732 (IC base=+0.055)

- **PATRÓN** `volumen_regimen` < `0.6103` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6103 (IC base=+0.055)

- **PATRÓN** `volumen_pendiente_norm` > `0.0712` → IC=+0.214 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0712 (IC base=+0.055)

- **PATRÓN** `volumen_spike_ratio` < `2.3987` → IC=+0.167 (n=109)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.3987 (IC base=+0.055)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.138 (n=299)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3507` → IC=+0.178 (n=116)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.3507 (IC base=+0.107)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7281` → IC=+0.175 (n=158)
...
- **PATRÓN** `libro_liquidez` > `1133.2011` → IC=+0.160 (n=254)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1133.2011 (IC base=+0.107)
...
- **PATRÓN** `dist_vwap_pct` > `0.2066` → IC=+0.143 (n=152)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.2066 (IC base=+0.069)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.497` → IC=+0.167 (n=109)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.497 (IC base=+0.069)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.153 (n=119)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0058 (IC base=+0.089)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.132 (n=123)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 15.0 (IC base=+0.089)

- **PATRÓN** `ibs_20min` > `0.6417` → IC=+0.162 (n=261)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.6417 (IC base=+0.089)

- **PATRÓN** `dist_vwap_pct` > `0.4967` → IC=+0.192 (n=63)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.4967 (IC base=+0.089)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1891` → IC=+0.170 (n=92)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` < 0.1891 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `2.8132` → IC=+0.156 (n=91)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.8132 (IC base=+0.118)
...
- **FILTRO** `ibs_20min` < `0.5842` → IC=-0.292 (n=22)
...
- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.288 (n=31)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0023 (IC base=+0.048)

- **PATRÓN** `drift_60min` |x|≤ `0.1365` → IC=+0.125 (n=46)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.1365 (IC base=+0.048)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.192 (n=24)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 17.0 (IC base=+0.048)

- **PATRÓN** `ibs_20min` > `0.5842` → IC=+0.162 (n=69)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.5842 (IC base=+0.048)

- **PATRÓN** `libro_liquidez` > `1532.5809` → IC=+0.135 (n=61)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 1532.5809 (IC base=+0.048)
...
- **PATRÓN** `elapsed_s` > `194.4` → IC=+0.231 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `elapsed_s` > 194.4 (IC base=+0.220)

- **PATRÓN** `drift_15min` |x|≤ `2.5595` → IC=+0.265 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 2.5595 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.6716` → IC=+0.315 (n=25)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6716 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `1768.0` → IC=+0.294 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 1768.0 (IC base=+0.220)
...
- **PATRÓN** `libro_liquidez` > `2925.1106` → IC=+0.169 (n=240)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1832)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.123 (n=67)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 14.0 (IC base=+0.045)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.157 (n=33)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 25.0 (IC base=+0.045)

### LIQUIDACIONES_5M#BTC#5min
- **FILTRO** `liq_usd_total` < `35151.71` → IC=-0.136 (n=64)
...
- **PATRÓN** `liq_n` > `18.0` → IC=+0.211 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `liq_n` > 18.0 (IC base=+0.020)

- **PATRÓN** `liq_usd_total` > `69212.62` → IC=+0.160 (n=98)

  - _Acción_: Kelly boost +0.80€ cuando `liq_usd_total` > 69212.62 (IC base=+0.020)
...
- **PATRÓN** `libro_liquidez` > `3757.4005` → IC=+0.138 (n=67)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 3757.4005 (IC base=+0.007)

### LIQUIDACIONES_60M
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=632)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=365)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.128 (n=406)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=236)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.172 (n=187)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.47 (IC base=+0.012)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.155 (n=27)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=34)

- **FILTRO** `profundidad_ratio` < `255.7` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `profundidad_ratio` < 255.7
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=46)

- **PATRÓN** `py_entrada` < `0.53` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` < 0.53 (IC base=+0.035)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.56` → IC=+0.184 (n=55)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` < 0.56 (IC base=+0.077)

- **PATRÓN** `restante_min` > `3.99` → IC=+0.139 (n=34)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` > 3.99 (IC base=+0.077)

- **PATRÓN** `profundidad_ratio` > `79.6` → IC=+0.132 (n=74)

  - _Acción_: Kelly boost +0.66€ cuando `profundidad_ratio` > 79.6 (IC base=+0.077)
...
- **FILTRO** `py_entrada` > `0.47` → IC=-0.129 (n=33)
...
- **FILTRO** `profundidad_ratio` < `61.1` → IC=-0.208 (n=22)

  - _Acción_: SKIP cuando `profundidad_ratio` < 61.1
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=25)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.143 (n=40)

  - _Acción_: SKIP cuando `py_entrada` > 0.52
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=21)

- **FILTRO** `restante_min` < `13.0` → IC=-0.156 (n=30)

  - _Acción_: SKIP cuando `restante_min` < 13.0
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=31)

- **FILTRO** `lag_apertura_s` > `120.14` → IC=-0.156 (n=30)

  - _Acción_: SKIP cuando `lag_apertura_s` > 120.14
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=31)

### LIQUIDACIONES_DEPTH_FASE0#ETH#5min
- **FILTRO** `restante_min` < `3.82` → IC=-0.329 (n=33)
...
- **FILTRO** `lag_apertura_s` > `70.81` → IC=-0.329 (n=33)

  - _Acción_: SKIP cuando `lag_apertura_s` > 70.81
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=34)

- **FILTRO** `profundidad_ratio` < `66.2` → IC=-0.214 (n=33)

  - _Acción_: SKIP cuando `profundidad_ratio` < 66.2
  - _Potencial_: sin este filtro IC_bueno=-0.111 (n=34)

- **FILTRO** `profundidad_ratio` < `49.7` → IC=-0.149 (n=35)

  - _Acción_: SKIP cuando `profundidad_ratio` < 49.7
  - _Potencial_: sin este filtro IC_bueno=+0.158 (n=36)

- **PATRÓN** `py_entrada` < `0.45` → IC=+0.262 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.45 (IC base=+0.007)

- **PATRÓN** `profundidad_ratio` > `49.7` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `profundidad_ratio` > 49.7 (IC base=+0.007)

### LIQUIDACIONES_DEPTH_FASE0#SOL#15min
- **PATRÓN** `py_entrada` < `0.6` → IC=+0.136 (n=42)

  - _Acción_: Kelly boost +0.68€ cuando `py_entrada` < 0.6 (IC base=+0.024)

- **PATRÓN** `restante_min` > `13.49` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 13.49 (IC base=+0.024)

- **PATRÓN** `lag_apertura_s` < `90.79` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `lag_apertura_s` < 90.79 (IC base=+0.024)

### LIQUIDACIONES_DEPTH_FASE0#SOL#5min
- **FILTRO** `restante_min` < `3.75` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `restante_min` < 3.75
  - _Potencial_: sin este filtro IC_bueno=+0.115 (n=24)

- **FILTRO** `py_entrada` > `0.5` → IC=-0.125 (n=38)

  - _Acción_: SKIP cuando `py_entrada` > 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=23)

### LIQUIDACIONES_DEPTH_FASE0#XRP#15min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.262 (n=19)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=61)

- **FILTRO** `restante_min` > `10.52` → IC=-0.173 (n=53)

  - _Acción_: SKIP cuando `restante_min` > 10.52
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=27)

### LIQUIDACIONES_DEPTH_FASE0#XRP#5min
- **FILTRO** `py_entrada` < `0.41` → IC=-0.223 (n=45)
...
- **FILTRO** `lag_apertura_s` > `133.74` → IC=-0.192 (n=24)

  - _Acción_: SKIP cuando `lag_apertura_s` > 133.74
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=74)

- **FILTRO** `py_entrada` > `0.56` → IC=-0.132 (n=36)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=+0.150 (n=38)

- **PATRÓN** `restante_min` > `3.85` → IC=+0.141 (n=37)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` > 3.85 (IC base=+0.013)

- **PATRÓN** `lag_apertura_s` < `69.66` → IC=+0.125 (n=38)

  - _Acción_: Kelly boost +0.62€ cuando `lag_apertura_s` < 69.66 (IC base=+0.013)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7566)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.165 (n=3583)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10825)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.168 (n=3706)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=11202)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.208 (n=614)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1889)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.192 (n=627)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=647)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=2022)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.174 (n=609)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1884)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.176 (n=652)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=2021)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2790)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.212 (n=709)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2274)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2962)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=784)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=10193)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=22738)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=8071)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=24860)

- **FILTRO** `ibs_7min` < `0.2826` → IC=-0.234 (n=8232)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2826
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=24699)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11178)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21753)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.231 (n=10136)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=31230)

- **FILTRO** `ibs_7min` > `0.2929` → IC=-0.178 (n=10338)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2929
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=31028)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.136 (n=1664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3790)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=1297)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4157)

- **FILTRO** `ibs_7min` < `0.7115` → IC=-0.250 (n=1799)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7115
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3655)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.186 (n=1231)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4223)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.261 (n=1747)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5366)

- **FILTRO** `drift_7min_pct` |x|> `0.112` → IC=-0.126 (n=2418)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.112
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4695)

- **FILTRO** `ibs_7min` > `0.7882` → IC=-0.207 (n=1778)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7882
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=5335)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1334)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4348)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1375)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4307)

- **FILTRO** `ibs_7min` < `0.7468` → IC=-0.192 (n=1418)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7468
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4264)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.176 (n=1416)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4266)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.255 (n=1441)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=4331)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.179 (n=1440)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=4332)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.183 (n=1438)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4334)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1470)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3709)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.304 (n=1282)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3897)

- **FILTRO** `ibs_7min` < `0.7068` → IC=-0.242 (n=1709)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7068
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3470)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.221 (n=1185)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3994)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1740)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=5868)

- **FILTRO** `ibs_7min` > `0.7468` → IC=-0.173 (n=1901)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1755)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3683)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.241 (n=1338)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4100)

- **FILTRO** `ibs_7min` < `0.741` → IC=-0.179 (n=1359)

  - _Acción_: SKIP cuando `ibs_7min` < 0.741
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=4079)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.172 (n=1327)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4111)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1385)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4159)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.179 (n=1384)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4160)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.184 (n=1363)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4181)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.253 (n=1409)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4328)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.233 (n=1424)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4313)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1868)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5999)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.253 (n=1769)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3672)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.226 (n=1357)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4084)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.215 (n=1317)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4124)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.206 (n=1778)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5684)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3978` → IC=+0.126 (n=750)
...
- **PATRÓN** `delta_ratio` |x|> `0.4377` → IC=+0.150 (n=58)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.75€ cuando `delta_ratio` |x|> 0.4377 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=180)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `2534.4132` → IC=+0.167 (n=58)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2534.4132 (IC base=+0.133)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.158 (n=74)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 15.0 (IC base=+0.133)
...
- **PATRÓN** `delta_ratio` |x|> `0.4133` → IC=+0.173 (n=102)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio` |x|> 0.4133 (IC base=+0.092)

- **PATRÓN** `total_vol_5m` < `394.3776` → IC=+0.200 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 394.3776 (IC base=+0.092)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.167 (n=67)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 78.0 (IC base=+0.092)
...
- **PATRÓN** `hora_utc` < `13.0` → IC=+0.132 (n=131)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 13.0 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.213 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `3571.4392` → IC=+0.162 (n=66)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3571.4392 (IC base=+0.100)
...
- **FILTRO** `pct_vs_K` |x|> `3.6696` → IC=-0.393 (n=26)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.180 (n=23)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=297)

- **PATRÓN** `streak_estiramiento` < `0.4117` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `streak_estiramiento` < 0.4117 (IC base=+0.038)

- **PATRÓN** `streak_estiramiento` < `0.5654` → IC=+0.157 (n=129)

  - _Acción_: Kelly boost +0.78€ cuando `streak_estiramiento` < 0.5654 (IC base=+0.034)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1113)

### STREAK_MOM_5M#XRP#5min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=772)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=2952)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1506)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1514)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.221 (n=746)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0087 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.0514` → IC=+0.208 (n=549)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0514 (IC base=+0.187)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1262` → IC=+0.235 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1262 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.197 (n=1526)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 6.0 (IC base=+0.187)

- **PATRÓN** `ibs_15` > `0.6071` → IC=+0.269 (n=1646)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6071 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` > `0.1187` → IC=+0.186 (n=844)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1187 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.6244` → IC=+0.180 (n=1565)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6244 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.77` → IC=+0.283 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.77 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `2966.2693` → IC=+0.195 (n=1097)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2966.2693 (IC base=+0.187)
...
- **FILTRO** `sigma_ewma_delta_pct` > `29.297` → IC=-0.152 (n=21)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=394)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.139 (n=383)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0065 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.154 (n=255)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0051 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.0678` → IC=+0.155 (n=169)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0678 (IC base=+0.135)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2337` → IC=+0.169 (n=128)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.85€ cuando `delta_ratio_macro` |x|> 0.2337 (IC base=+0.135)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2579` → IC=+0.159 (n=274)

  - _Acción_: Kelly boost +0.80€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2579 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.155 (n=282)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 11.0 (IC base=+0.135)

- **PATRÓN** `ibs_15` > `0.6602` → IC=+0.256 (n=342)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6602 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.1651` → IC=+0.156 (n=300)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1651 (IC base=+0.135)
...
- **PATRÓN** `libro_liquidez` > `3422.7688` → IC=+0.145 (n=342)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 3422.7688 (IC base=+0.135)
...
- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.159 (n=487)
...
- **FILTRO** `sigma_h` > `0.0129` → IC=-0.221 (n=668)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0129
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=2006)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.195 (n=908)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1766)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1366` → IC=+0.250 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1366 (IC base=-0.064)

- **PATRÓN** `ibs_15` > `0.6371` → IC=+0.277 (n=638)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6371 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` < `0.1175` → IC=+0.193 (n=398)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.1175 (IC base=-0.064)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1198` → IC=+0.251 (n=1205)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1198 (IC base=-0.032)

- **PATRÓN** `ibs_15` < `0.3453` → IC=+0.279 (n=1808)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3453 (IC base=-0.032)

- **PATRÓN** `dist_vwap_pct` > `0.7029` → IC=+0.302 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7029 (IC base=-0.032)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.221 (n=407)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=1224)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.234 (n=407)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1224)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.211 (n=1029)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=602)

- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.249 (n=293)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.716
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1338)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.164 (n=385)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.153 (n=266)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.006 (IC base=+0.151)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0757` → IC=+0.218 (n=133)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0757 (IC base=+0.151)

- **PATRÓN** `drift_15min` |x|≤ `0.4193` → IC=+0.170 (n=101)

  - _Acción_: Kelly boost +0.85€ cuando `drift_15min` |x|≤ 0.4193 (IC base=+0.151)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0589` → IC=+0.155 (n=302)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.77€ cuando `delta_ratio_macro` |x|> 0.0589 (IC base=+0.151)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2902` → IC=+0.237 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2902 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.206 (n=141)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.151)

- **PATRÓN** `ibs_15` > `0.6675` → IC=+0.266 (n=302)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6675 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.4805` → IC=+0.159 (n=86)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.4805 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1187` → IC=+0.188 (n=216)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.1187 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.857` → IC=+0.163 (n=241)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.857 (IC base=+0.151)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.164 (n=385)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `11031.3332` → IC=+0.191 (n=137)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11031.3332 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.273 (n=236)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.232)

- **PATRÓN** `drift_60min` |x|≤ `0.4443` → IC=+0.233 (n=706)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4443 (IC base=+0.232)

- **PATRÓN** `drift_15min` |x|≤ `0.48` → IC=+0.238 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.48 (IC base=+0.232)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2036` → IC=+0.264 (n=320)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3441` → IC=+0.271 (n=706)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3441 (IC base=+0.232)

- **PATRÓN** `dist_vwap_pct` > `0.7744` → IC=+0.320 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7744 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.729` → IC=+0.258 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.729 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.182` → IC=+0.239 (n=749)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.182 (IC base=+0.232)
...
- **PATRÓN** `ibs_15` < `0.35` → IC=+0.266 (n=314)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.2005` → IC=+0.223 (n=280)
...
- **PATRÓN** `ibs_15` < `0.34` → IC=+0.303 (n=476)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.34 (IC base=-0.043)

- **PATRÓN** `dist_vwap_pct` > `0.943` → IC=+0.344 (n=94)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.221` → IC=+0.331 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.221 (IC base=+0.294)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.314 (n=698)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.294)

- **PATRÓN** `ibs_15` > `0.8404` → IC=+0.329 (n=669)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `23.453` → IC=+0.336 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.453 (IC base=+0.294)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.296 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.294)

- **PATRÓN** `libro_liquidez` > `13084.0601` → IC=+0.303 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13084.0601 (IC base=+0.294)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1127` → IC=+0.303 (n=201)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1127 (IC base=+0.301)

- **PATRÓN** `delta_ratio_macro` |x|> `0.226` → IC=+0.314 (n=100)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.226 (IC base=+0.301)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.288` → IC=+0.338 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.288 (IC base=+0.301)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.333 (n=268)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.301)

- **PATRÓN** `ibs_15` > `0.8527` → IC=+0.341 (n=300)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8527 (IC base=+0.301)

- **PATRÓN** `dist_vwap_pct` > `0.2918` → IC=+0.301 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2918 (IC base=+0.301)

- **PATRÓN** `dist_vwap_pct` < `0.1676` → IC=+0.306 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1676 (IC base=+0.301)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.564` → IC=+0.323 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.564 (IC base=+0.301)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.309 (n=338)
...
- **FILTRO** `ballena_activa_n` > `47.0` → IC=-0.137 (n=188)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6071 sube el IC de +0.187 a +0.269 en UPDOWN_GBM#15min (n=1646). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6602 sube el IC de +0.135 a +0.256 en UPDOWN_GBM#ETH#15min (n=342). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.050 a +0.159 en UPDOWN_GBM#XRP#15min (n=487). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6371 sube el IC de -0.064 a +0.277 en UPDOWN_GBM_15M_TARDIO (n=638). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3453 sube el IC de -0.032 a +0.279 en UPDOWN_GBM_15M_TARDIO (n=1808). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6675 sube el IC de +0.151 a +0.266 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=302). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3441 sube el IC de +0.232 a +0.271 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=706). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.042 a +0.266 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=314). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.34 sube el IC de -0.043 a +0.303 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=476). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8404 sube el IC de +0.294 a +0.329 en UPDOWN_GBM_IBS_ALTO (n=669). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8527 sube el IC de +0.301 a +0.341 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=300). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 28602 | -0.089 | -3821.32€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1479 | -0.048 | -222.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27123 | -0.091 | -3598.41€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3755 | -0.097 | -607.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3755 | -0.097 | -607.30€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1479 | -0.048 | -222.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1479 | -0.048 | -222.91€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3482 | -0.096 | -787.96€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3482 | -0.096 | -787.96€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7329 | -0.021 | -677.75€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7329 | -0.021 | -677.75€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6922 | -0.091 | -436.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6922 | -0.091 | -436.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5635 | -0.174 | -1088.79€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5635 | -0.174 | -1088.79€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 18602 | -0.028 | +4002.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4849 | -0.000 | +1815.47€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 13753 | -0.037 | +2187.07€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 18602 | -0.028 | +4002.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4849 | -0.000 | +1815.47€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 13753 | -0.037 | +2187.07€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 94211 | +0.112 | -4747.84€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14172 | +0.185 | -424.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 379 | -0.080 | -49.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 73551 | +0.100 | -4057.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6109 | +0.107 | -216.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12232 | +0.097 | -1039.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 45 | -0.160 | -0.32€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12172 | +0.099 | -1027.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 19056 | +0.131 | -370.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4475 | +0.204 | -131.54€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12194 | +0.111 | -200.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2345 | +0.103 | -16.29€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12270 | +0.090 | -1121.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 52 | -0.093 | -6.98€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12203 | +0.091 | -1103.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 20032 | +0.123 | -391.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5483 | +0.175 | -74.83€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12325 | +0.105 | -251.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2212 | +0.098 | -56.92€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18375 | +0.113 | -1093.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4070 | +0.188 | -218.86€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 282 | -0.039 | +4.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12471 | +0.091 | -736.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1552 | +0.125 | -143.02€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12246 | +0.100 | -731.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12186 | +0.101 | -739.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14948 | +0.191 | -986.61€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14948 | +0.191 | -986.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3554 | +0.167 | -377.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3554 | +0.167 | -377.03€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1264 | +0.196 | -12.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1264 | +0.196 | -12.57€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3505 | +0.180 | -300.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3505 | +0.180 | -300.98€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3106 | +0.239 | -99.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3106 | +0.239 | -99.26€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3440 | +0.192 | -210.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3440 | +0.192 | -210.52€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 705 | +0.429 | -20.20€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 705 | +0.429 | -20.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 272 | +0.438 | -2.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 272 | +0.438 | -2.44€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH | 266 | +0.433 | -4.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH#15min | 266 | +0.433 | -4.89€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 157 | +0.406 | -10.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 157 | +0.406 | -10.36€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 51529 | +0.197 | -4018.83€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 51529 | +0.197 | -4018.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8914 | +0.176 | -1031.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8914 | +0.176 | -1031.82€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 8230 | +0.223 | -305.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 8230 | +0.223 | -305.69€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8900 | +0.172 | -1063.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8900 | +0.172 | -1063.14€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 8324 | +0.219 | -317.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 8324 | +0.219 | -317.13€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8516 | +0.204 | -553.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8516 | +0.204 | -553.16€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8645 | +0.193 | -747.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8645 | +0.193 | -747.89€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 19431 | +0.117 | +153.64€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 19431 | +0.117 | +153.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9646 | +0.121 | +137.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9646 | +0.121 | +137.88€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9785 | +0.113 | +15.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9785 | +0.113 | +15.76€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1130 | +0.076 | -41.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 392 | +0.058 | -32.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 738 | +0.085 | -9.09€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 892 | +0.084 | -13.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 154 | +0.077 | -4.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 738 | +0.085 | -9.09€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 36141 | +0.097 | -1116.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2986 | +0.090 | +24.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 33155 | +0.098 | -1140.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 20283 | +0.101 | -333.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2986 | +0.090 | +24.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 17297 | +0.103 | -357.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6811 | +0.106 | -54.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6811 | +0.106 | -54.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 9047 | +0.081 | -729.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 9047 | +0.081 | -729.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 810 | +0.215 | -98.04€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 810 | +0.215 | -98.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 810 | +0.215 | -98.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 810 | +0.215 | -98.04€ | 2 | 4 |
| ✅ GBM_LATE_15M | 25901 | +0.083 | +12291.48€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 25901 | +0.083 | +12291.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4329 | +0.193 | +3140.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4329 | +0.193 | +3140.93€ | 0 | 20 |
| ✅ GBM_LATE_15M#BTC | 3852 | +0.178 | +2694.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3852 | +0.178 | +2694.64€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 4516 | +0.197 | +3354.43€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4516 | +0.197 | +3354.43€ | 0 | 22 |
| ✅ GBM_LATE_15M#ETH | 3801 | +0.021 | +819.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3801 | +0.021 | +819.69€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3703 | -0.033 | +833.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3703 | -0.033 | +833.24€ | 4 | 14 |
| ✅ GBM_LATE_15M#XRP | 5700 | -0.040 | +1448.55€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5700 | -0.040 | +1448.55€ | 4 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 27391 | +0.086 | +14317.08€ | 0 | 19 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 27391 | +0.086 | +14317.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 5200 | +0.017 | +2752.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 5200 | +0.017 | +2752.61€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5714 | +0.015 | +1182.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5714 | +0.015 | +1182.75€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3892 | +0.262 | +3918.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3892 | +0.262 | +3918.44€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4448 | +0.004 | +850.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4448 | +0.004 | +850.31€ | 2 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4444 | +0.028 | +1682.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4444 | +0.028 | +1682.03€ | 3 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3693 | +0.275 | +3930.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3693 | +0.275 | +3930.93€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 20847 | +0.168 | +15515.64€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 20847 | +0.168 | +15515.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 3140 | +0.206 | +2487.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 3140 | +0.206 | +2487.24€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3311 | +0.149 | +2425.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3311 | +0.149 | +2425.36€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3276 | +0.208 | +2603.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3276 | +0.208 | +2603.83€ | 0 | 18 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3494 | +0.133 | +2431.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3494 | +0.133 | +2431.40€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3876 | +0.116 | +2635.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3876 | +0.116 | +2635.01€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3750 | +0.202 | +2932.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3750 | +0.202 | +2932.80€ | 0 | 27 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 5255 | +0.129 | +2232.12€ | 0 | 24 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 5255 | +0.129 | +2232.12€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1555 | +0.145 | +706.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1555 | +0.145 | +706.79€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1118 | +0.106 | +378.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1118 | +0.106 | +378.19€ | 1 | 16 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 506 | +0.134 | +215.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 506 | +0.134 | +215.28€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 26025 | +0.175 | +19360.71€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#15min | 26025 | +0.175 | +19360.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 4125 | +0.220 | +3465.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 4125 | +0.220 | +3465.73€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 4083 | +0.151 | +2704.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 4083 | +0.151 | +2704.34€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4278 | +0.225 | +3669.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4278 | +0.225 | +3669.01€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 4216 | +0.137 | +2886.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 4216 | +0.137 | +2886.19€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4547 | +0.114 | +2891.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4547 | +0.114 | +2891.08€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4776 | +0.204 | +3744.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4776 | +0.204 | +3744.37€ | 0 | 24 |
| ✅ GBM_LATE_5M | 7096 | +0.150 | +4114.68€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 7096 | +0.150 | +4114.68€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 2365 | +0.157 | +1396.89€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 2365 | +0.157 | +1396.89€ | 0 | 31 |
| ✅ GBM_LATE_5M#SOL | 604 | +0.104 | +213.40€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 604 | +0.104 | +213.40€ | 0 | 17 |
| ✅ GBM_LATE_5M#XRP | 837 | +0.116 | +326.92€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 837 | +0.116 | +326.92€ | 0 | 0 |
| ✅ GBM_LATE_60M | 1755 | +0.069 | +748.38€ | 2 | 11 |
| ✅ GBM_LATE_60M#60min | 1755 | +0.069 | +748.38€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 636 | +0.088 | +271.37€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 636 | +0.088 | +271.37€ | 0 | 12 |
| ✅ GBM_LATE_60M#ETH | 580 | +0.072 | +288.18€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 580 | +0.072 | +288.18€ | 2 | 15 |
| ✅ GBM_LATE_60M#SOL | 539 | +0.042 | +188.83€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 539 | +0.042 | +188.83€ | 2 | 11 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 706 | +0.071 | +154.73€ | 2 | 7 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 706 | +0.071 | +154.73€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC | 276 | +0.058 | +47.41€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 276 | +0.058 | +47.41€ | 1 | 12 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH | 206 | +0.034 | +12.89€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH#60min | 206 | +0.034 | +12.89€ | 2 | 6 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL | 224 | +0.119 | +94.43€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL#60min | 224 | +0.119 | +94.43€ | 2 | 11 |
| ✅ LATE_WINDOW_5MIN | 99 | +0.262 | +83.65€ | 0 | 9 |
| ✅ LATE_WINDOW_5MIN#5min | 99 | +0.262 | +83.65€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 99 | +0.262 | +83.65€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 99 | +0.262 | +83.65€ | 0 | 9 |
| ✅ LEADLAG_BTC_XRP_15M | 1977 | +0.103 | +547.10€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1977 | +0.103 | +547.10€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1977 | +0.103 | +547.10€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1977 | +0.103 | +547.10€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_5M | 2031 | +0.007 | +17.73€ | 5 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 2031 | +0.007 | +17.73€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB | 105 | +0.023 | -0.05€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB#5min | 105 | +0.023 | -0.05€ | 0 | 2 |
| ✅ LIQUIDACIONES_5M#BTC | 231 | -0.011 | +8.56€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BTC#5min | 231 | -0.011 | +8.56€ | 5 | 2 |
| ✅ LIQUIDACIONES_5M#DOGE | 164 | -0.036 | -7.46€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#DOGE#5min | 164 | -0.036 | -7.46€ | 1 | 0 |
| ✅ LIQUIDACIONES_5M#ETH | 850 | +0.026 | +23.44€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 850 | +0.026 | +23.44€ | 6 | 0 |
| ✅ LIQUIDACIONES_5M#SOL | 471 | -0.001 | -5.44€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#SOL#5min | 471 | -0.001 | -5.44€ | 4 | 0 |
| ✅ LIQUIDACIONES_5M#XRP | 210 | -0.005 | -1.33€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#XRP#5min | 210 | -0.005 | -1.33€ | 1 | 2 |
| ✅ LIQUIDACIONES_60M | 1092 | -0.043 | -26.02€ | 6 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 1092 | -0.043 | -26.02€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC | 311 | -0.040 | -12.25€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC#60min | 311 | -0.040 | -12.25€ | 4 | 0 |
| ✅ LIQUIDACIONES_60M#ETH | 365 | -0.026 | -0.79€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#ETH#60min | 365 | -0.026 | -0.79€ | 3 | 0 |
| ✅ LIQUIDACIONES_60M#SOL | 416 | -0.060 | -12.98€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 416 | -0.060 | -12.98€ | 3 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 1347 | -0.031 | -9.89€ | 1 | 1 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 631 | -0.035 | -17.61€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 716 | -0.026 | +7.72€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB | 36 | +0.026 | +6.59€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB#15min | 21 | +0.065 | +5.03€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB#5min | 15 | -0.022 | +1.56€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC | 341 | +0.034 | +42.20€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#15min | 158 | +0.006 | +5.90€ | 2 | 1 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#5min | 183 | +0.057 | +36.30€ | 0 | 3 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE | 189 | -0.076 | -19.52€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE#15min | 90 | -0.087 | -13.29€ | 4 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE#5min | 99 | -0.064 | -6.23€ | 2 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH | 246 | -0.085 | -33.72€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#15min | 108 | -0.091 | -15.07€ | 5 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#5min | 138 | -0.079 | -18.65€ | 5 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL | 221 | -0.016 | +9.04€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#15min | 112 | +0.000 | +8.60€ | 0 | 3 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#5min | 109 | -0.032 | +0.44€ | 2 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP | 314 | -0.048 | -14.48€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#15min | 142 | -0.049 | -8.78€ | 2 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#5min | 172 | -0.046 | -5.70€ | 4 | 2 |
| ✅ MOMENTUM_IBS_15M | 14430 | -0.012 | -207.96€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14430 | -0.012 | -207.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 3147 | -0.020 | -61.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 3147 | -0.020 | -61.14€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 29316 | -0.006 | +1343.66€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 29316 | -0.006 | +1343.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 5175 | +0.018 | +639.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 5175 | +0.018 | +639.25€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4535 | -0.028 | -48.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4535 | -0.028 | -48.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 5222 | +0.015 | +472.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 5222 | +0.015 | +472.21€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4313 | -0.051 | -127.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4313 | -0.051 | -127.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4905 | -0.010 | +192.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4905 | -0.010 | +192.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 5166 | +0.008 | +215.94€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 5166 | +0.008 | +215.94€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5853 | -0.058 | -135.61€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5853 | -0.058 | -135.61€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1208 | +0.001 | -14.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1208 | +0.001 | -14.22€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 634 | -0.112 | -18.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 634 | -0.112 | -18.09€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1702 | -0.078 | -34.33€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1702 | -0.078 | -34.33€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 74297 | -0.072 | +1725.84€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 74297 | -0.072 | +1725.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 12567 | -0.079 | +707.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 12567 | -0.079 | +707.14€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 11454 | -0.092 | -490.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 11454 | -0.092 | -490.70€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 12787 | -0.067 | +703.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 12787 | -0.067 | +703.09€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10982 | -0.093 | -195.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10982 | -0.093 | -195.54€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 13604 | -0.048 | +402.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 13604 | -0.048 | +402.96€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 12903 | -0.063 | +598.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 12903 | -0.063 | +598.89€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7626 | -0.025 | -122.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7626 | -0.025 | -122.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 996 | -0.017 | -19.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 996 | -0.017 | -19.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1693 | -0.030 | -7.88€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1693 | -0.030 | -7.88€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 1003 | -0.020 | -31.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 1003 | -0.020 | -31.30€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 2154 | -0.019 | -25.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 2154 | -0.019 | -25.74€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 1042 | -0.040 | -14.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 1042 | -0.040 | -14.68€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 738 | -0.020 | -23.52€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 738 | -0.020 | -23.52€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1136 | +0.105 | +368.40€ | 0 | 2 |
| ✅ ORDER_FLOW_5M#5min | 1000 | +0.111 | +355.81€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 232 | +0.133 | +110.94€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 232 | +0.133 | +110.94€ | 0 | 4 |
| ✅ ORDER_FLOW_5M#DOGE | 194 | +0.092 | +43.99€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#DOGE#5min | 194 | +0.092 | +43.99€ | 0 | 1 |
| ✅ ORDER_FLOW_5M#ETH | 204 | +0.092 | +65.05€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#ETH#5min | 204 | +0.092 | +65.05€ | 0 | 3 |
| ✅ ORDER_FLOW_5M#SOL | 177 | +0.131 | +80.23€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 177 | +0.131 | +80.23€ | 0 | 3 |
| ✅ ORDER_FLOW_5M#XRP | 193 | +0.100 | +55.61€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#XRP#5min | 193 | +0.100 | +55.61€ | 0 | 3 |
| ✅ ORDER_FLOW_5M_REACTIVO | 499 | -0.065 | -64.02€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#5min | 499 | -0.065 | -64.02€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO#ETH | 147 | -0.084 | -29.38€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#ETH#5min | 147 | -0.084 | -29.38€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#SOL | 106 | -0.009 | -0.29€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#SOL#5min | 106 | -0.009 | -0.29€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#XRP | 79 | -0.105 | -15.14€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#XRP#5min | 79 | -0.105 | -15.14€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 517 | +0.036 | +18.73€ | 2 | 2 |
| ✅ STREAK_FADE_15M#15min | 517 | +0.036 | +18.73€ | 0 | 0 |
| ✅ STREAK_FADE_15M#DOGE | 246 | +0.032 | +4.63€ | 0 | 0 |
| ✅ STREAK_FADE_15M#DOGE#15min | 246 | +0.032 | +4.63€ | 0 | 0 |
...
| ✅ STREAK_MOM_5M | 7855 | +0.023 | +117.98€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7855 | +0.023 | +117.98€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2143 | +0.022 | +22.91€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2143 | +0.022 | +22.91€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1784 | +0.035 | +53.94€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1784 | +0.035 | +53.94€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2381 | +0.012 | +3.50€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2381 | +0.012 | +3.50€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1547 | +0.029 | +37.63€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1547 | +0.029 | +37.63€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7398 | +0.013 | -32.54€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7398 | +0.013 | -32.54€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2971 | +0.018 | -2.00€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2971 | +0.018 | -2.00€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2889 | +0.013 | -14.06€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2889 | +0.013 | -14.06€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1538 | +0.004 | -16.48€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1538 | +0.004 | -16.48€ | 2 | 0 |
| ✅ UPDOWN_GBM | 37999 | +0.031 | +2296.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 10302 | +0.069 | +1880.20€ | 0 | 10 |
| ✅ UPDOWN_GBM#240min | 1403 | +0.005 | +7.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 23826 | +0.020 | +383.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2325 | +0.005 | +27.11€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3946 | +0.068 | +445.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 706 | +0.158 | +295.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 32 | +0.000 | -0.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 3208 | +0.049 | +150.91€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 7052 | +0.037 | +496.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1302 | +0.083 | +291.37€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 377 | +0.020 | +8.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 4275 | +0.034 | +172.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 1043 | +0.003 | +24.67€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 55 | -0.097 | +0.55€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 4499 | +0.041 | +280.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 661 | +0.140 | +234.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 28 | +0.000 | -1.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3810 | +0.024 | +47.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 8034 | +0.018 | +285.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2632 | +0.047 | +270.92€ | 0 | 10 |
| ✅ UPDOWN_GBM#ETH#240min | 368 | +0.005 | +6.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 4200 | +0.006 | +9.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 788 | +0.001 | -5.28€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 46 | -0.146 | +3.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8918 | +0.014 | +220.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2487 | +0.027 | +175.23€ | 0 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 360 | -0.005 | -2.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5537 | +0.011 | +42.73€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 494 | +0.016 | +7.72€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 40 | -0.167 | -2.82€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5548 | +0.035 | +570.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2514 | +0.082 | +613.16€ | 0 | 12 |
| ✅ UPDOWN_GBM#XRP#240min | 238 | -0.004 | -3.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2796 | -0.004 | -39.18€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 12155 | -0.039 | +2555.50€ | 2 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 12155 | -0.039 | +2555.50€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 802 | -0.040 | +360.32€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 802 | -0.040 | +360.32€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2239 | -0.123 | +9.85€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2239 | -0.123 | +9.85€ | 4 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 412 | +0.179 | +273.06€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 412 | +0.179 | +273.06€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1343 | +0.208 | +795.83€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1343 | +0.208 | +795.83€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3669 | -0.064 | +548.09€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3669 | -0.064 | +548.09€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3690 | -0.076 | +568.36€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3690 | -0.076 | +568.36€ | 3 | 4 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 891 | +0.294 | +720.85€ | 0 | 10 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 891 | +0.294 | +720.85€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 491 | +0.287 | +374.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 491 | +0.287 | +374.39€ | 0 | 10 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 400 | +0.301 | +346.46€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 400 | +0.301 | +346.46€ | 0 | 10 |
| ✅ UPDOWN_OU_5M | 726 | -0.111 | -84.11€ | 4 | 0 |
| ✅ UPDOWN_OU_5M#5min | 726 | -0.111 | -84.11€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB | 311 | -0.078 | -35.51€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB#5min | 311 | -0.078 | -35.51€ | 2 | 0 |
| ✅ UPDOWN_OU_5M#BTC | 210 | -0.080 | -15.29€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BTC#5min | 210 | -0.080 | -15.29€ | 3 | 0 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 531 celda(s) pasan gate riguroso completo de 2253 evaluadas (n>=40) y 3229 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.028 < 0.08 — monitorear
  - _Datos_: n=2484 IC=+0.028 PNL=+176.81€
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=293, boost estimado=+0.002. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=786/40 IC=+0.001 PNL=-5.27€ | BTC#60min: n=1041/40 IC=+0.003 PNL=+24.54€ | SOL#60min: n=493/40 IC=+0.017 PNL=+8.23€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.050 n=339890 | tras_1loss IC=+0.078 n=264212 | tras_2loss IC=+0.048 n=111315/40 | gap=+0.003 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1633 IC=+0.014 PNL=+13.88€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1633 IC=+0.014 PNL=+13.88€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=687 IC=-0.014 PNL=+13.61€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=687 IC=-0.014 PNL=+13.61€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.187 > 0.1 con n=2192 PNL=+1365.88€
  - _Datos_: n=2192 IC=+0.187 PNL=+1365.88€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1300 IC=+0.084 PNL=+292.39€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1300 IC=+0.084 PNL=+292.39€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.117 > 0.02 con n=641 PNL=+234.86€
  - _Datos_: n=641 IC=+0.117 PNL=+234.86€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=13334 IC=+0.054 PNL=+1619.36€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=13334 IC=+0.054 PNL=+1619.36€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1934 IC=+0.050 PNL=+207.98€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1934 IC=+0.050 PNL=+207.98€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=18181 IC=-0.137 PNL=+1238.54€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=18181 IC=-0.137 PNL=+1238.54€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1962 IC=+0.142 PNL=+1087.79€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1962 IC=+0.142 PNL=+1087.79€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.239 < -0.1 con n=1772 PNL=-204.75€
  - _Datos_: n=1772 IC=-0.239 PNL=-204.75€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.098 n=1017) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=1017 IC=+0.098 PNL=+240.85€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8906 IC=+0.176 PNL=-1031.98€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8906 IC=+0.176 PNL=-1031.98€
