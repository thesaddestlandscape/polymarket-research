# Hipótesis automáticas — 2026-07-23 17:06 UTC
_Generado por shadow_postmortem.py sobre 31308 resoluciones (PNL=+6857.59€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=2038)
...
- **PATRÓN** `sigma_h` > `0.0133` → IC=+0.129 (n=920)
...
- **PATRÓN** `dist_vwap_pct` > `0.2669` → IC=+0.129 (n=397)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.2669 (IC base=+0.097)
...
- **FILTRO** `sigma_ewma_delta_pct` > `9.228` → IC=-0.309 (n=19)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=426)
...
- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.161 (n=252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.757` → IC=+0.141 (n=418)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.172 (n=1295)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.148 (n=1588)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0043 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.145 (n=1089)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.9651` → IC=+0.167 (n=118)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.9651 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.7281` → IC=+0.132 (n=1590)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.7281 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.147` → IC=+0.156 (n=312)
...
- **PATRÓN** `dist_vwap_pct` > `0.6746` → IC=+0.205 (n=59)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6746 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.773` → IC=+0.231 (n=91)
...
- **PATRÓN** `sigma_h` < `0.0081` → IC=+0.149 (n=166)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0081 (IC base=+0.094)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.141 (n=143)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 6.0 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.125` → IC=+0.128 (n=304)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.125 (IC base=+0.094)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.254 (n=400)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.933` → IC=+0.246 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.933 (IC base=+0.240)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.123 (n=1281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.130 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` < 0.0046 (IC base=+0.067)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.945` → IC=-0.152 (n=21)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=347)
...
- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.122 (n=331)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` < `0.0194` → IC=+0.183 (n=449)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0194 (IC base=+0.175)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `10.154` → IC=+0.177 (n=499)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 10.154 (IC base=+0.175)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 870 | +0.127 | +41.87€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 870 | +0.127 | +41.87€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 198 | +0.085 | +14.43€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 198 | +0.085 | +14.43€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 5475 | +0.189 | +111.26€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3591 | +0.216 | +101.47€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1934 | +0.179 | +18.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1183 | +0.214 | +41.88€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1907 | +0.192 | +41.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1185 | +0.225 | +66.47€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 7178 | +0.095 | +2217.35€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 7178 | +0.095 | +2217.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1735 | +0.065 | +279.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1735 | +0.065 | +279.47€ | 0 | 2 |
| ✅ GBM_LATE_15M#ETH | 1611 | +0.074 | +282.58€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1611 | +0.074 | +282.58€ | 0 | 6 |
| ✅ GBM_LATE_15M#SOL | 1934 | +0.087 | +683.99€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1934 | +0.087 | +683.99€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 1898 | +0.149 | +971.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1898 | +0.149 | +971.31€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 4373 | +0.124 | +2174.13€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 4373 | +0.124 | +2174.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1126 | +0.082 | +389.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1126 | +0.082 | +389.84€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1142 | +0.092 | +419.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1142 | +0.092 | +419.05€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1106 | +0.098 | +453.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1106 | +0.098 | +453.69€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 999 | +0.238 | +911.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 999 | +0.238 | +911.55€ | 0 | 9 |
...
| ✅ GBM_LATE_15M_TARDIO | 4391 | +0.077 | +1271.59€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 4391 | +0.077 | +1271.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1057 | +0.035 | +133.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1057 | +0.035 | +133.62€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1057 | +0.027 | +80.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1057 | +0.027 | +80.04€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1013 | +0.042 | +205.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1013 | +0.042 | +205.82€ | 1 | 3 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1264 | +0.181 | +852.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1264 | +0.181 | +852.11€ | 0 | 12 |
| ✅ GBM_LATE_5M | 453 | -0.025 | -1.67€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 453 | -0.025 | -1.67€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#XRP | 225 | +0.055 | +16.03€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 225 | +0.055 | +16.03€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2362 | +0.031 | +205.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2099 | +0.051 | +243.66€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#SOL | 210 | -0.071 | -12.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 141 | -0.045 | -6.51€ | 5 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1401 | +0.164 | +651.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1401 | +0.164 | +651.27€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 352 | +0.203 | +248.18€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 352 | +0.203 | +248.18€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.194: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.063 n=1205 | neutral: IC=+0.008 n=920 | overbought(IBS>0.7): IC=+0.202 n=1179
  - _Datos_: n=3518 IC=+0.102 PNL=+906.47€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.128 n=84 PNL=+35.91€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.167 n=94 PNL=+41.63€ → BOOST | H=16h: IC=+0.118 n=87 PNL=+16.58€ → BOOST | H=21h: IC=+0.111 n=88 PNL=+13.19€ → BOOST | H=22h: IC=+0.111 n=106 PNL=+19.54€ → BOOST
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=141 IC=-0.045 PNL=-6.51€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.114 n=18712 | tras_1loss IC=+0.081 n=12400 | tras_2loss IC=+0.048 n=5160/40 | gap=+0.066 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.082 n=1411/40 PNL=+254.80€ | H=15h UTC: IC=+0.154 n=1352/40 PNL=+522.48€ | H=17h UTC: IC=+0.105 n=1228/40 PNL=+261.08€ | H=19h UTC: IC=+0.126 n=1176/40 PNL=+309.76€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2230 IC=+0.036 PNL=+219.89€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2230 IC=+0.036 PNL=+219.89€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.092 > 0.08 con n=1118 PNL=+197.13€
  - _Datos_: n=1118 IC=+0.092 PNL=+197.13€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1119 IC=+0.036 PNL=+80.44€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1119 IC=+0.036 PNL=+80.44€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=313 IC=+0.021 PNL=+19.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=313 IC=+0.021 PNL=+19.97€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=947 IC=+0.052 PNL=+110.95€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=947 IC=+0.052 PNL=+110.95€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.213 > 0.08 con n=340 PNL=+23.94€
  - _Datos_: n=340 IC=+0.213 PNL=+23.94€
