# Hipótesis automáticas — 2026-09-26 10:28 UTC
_Generado por shadow_postmortem.py sobre 618849 resoluciones (PNL=+70402.01€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.26` → IC=-0.224 (n=7262)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.26
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=21792)
...
- **FILTRO** `restante_s_al_confirmar` < `166.11` → IC=-0.209 (n=1769)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 166.11
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=5308)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `127.7` → IC=-0.343 (n=1428)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.7
  - _Potencial_: sin este filtro IC_bueno=-0.108 (n=4287)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.206 (n=14229)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3588)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5678.304` → IC=+0.178 (n=2283)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2191)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.137 (n=538)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.236 (n=1524)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.139 (n=682)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 17.0 (IC base=+0.137)

- **PATRÓN** `py_entrada` > `0.67` → IC=+0.257 (n=228)
...
- **PATRÓN** `libro_liquidez` > `1313.0714` → IC=+0.150 (n=678)
...
- **PATRÓN** `lag_apertura_s` < `2.71` → IC=+0.139 (n=4972)

  - _Acción_: Kelly boost +0.69€ cuando `lag_apertura_s` < 2.71 (IC base=+0.117)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.196 (n=2711)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.38 (IC base=+0.121)

- **PATRÓN** `restante_min` < `4.12` → IC=+0.127 (n=2480)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.12 (IC base=+0.121)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.140 (n=2717)
...
- **PATRÓN** `libro_liquidez` > `1546.3244` → IC=+0.294 (n=1134)
...
- **PATRÓN** `libro_liquidez` > `4267.8515` → IC=+0.297 (n=338)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.446 (n=166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.438)

- **PATRÓN** `py_entrada` < `0.925` → IC=+0.451 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.925 (IC base=+0.438)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.439 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.438)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.438 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.438)

- **PATRÓN** `libro_liquidez` > `1981.0007` → IC=+0.463 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1981.0007 (IC base=+0.438)
...
- **PATRÓN** `drift_60min` |x|≤ `0.349` → IC=+0.167 (n=1883)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.349 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.172 (n=907)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 15.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.167 (n=1269)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 11.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.270 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.137` → IC=+0.267 (n=808)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.137 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.211 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.165 (n=1764)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.177 (n=1920)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.04 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.255 (n=651)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.479` → IC=+0.245 (n=1491)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=1586)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.235)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.231 (n=642)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.232 (n=1517)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.216)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.216 (n=1472)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.2003` → IC=+0.220 (n=761)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2003 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `0.5643` → IC=+0.220 (n=1518)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5643 (IC base=+0.216)
...
- **PATRÓN** `volumen_regimen` < `1.2501` → IC=+0.219 (n=1448)
...
- **PATRÓN** `libro_liquidez` > `11163.5207` → IC=+0.225 (n=1448)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11163.5207 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.176 (n=504)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0026 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0761` → IC=+0.166 (n=504)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0761 (IC base=+0.140)
...
- **PATRÓN** `ibs_20min` < `0.7006` → IC=+0.171 (n=1510)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.7006 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1316` → IC=+0.155 (n=1355)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1316 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.254` → IC=+0.156 (n=242)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 11.254 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.301` → IC=+0.145 (n=1378)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 4.301 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.150 (n=1510)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1913 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1558` → IC=+0.178 (n=402)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1558 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.153 (n=1400)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.42` → IC=+0.148 (n=1400)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.42 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `14094.8894` → IC=+0.146 (n=1007)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 14094.8894 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `234.0` → IC=+0.169 (n=587)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 234.0 (IC base=+0.140)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.207 (n=622)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1958)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.189 (n=1675)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.265 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.187` → IC=+0.256 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.187 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.2077` → IC=+0.187 (n=1871)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2077 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.3576` → IC=+0.192 (n=251)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.3576 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.8014` → IC=+0.203 (n=807)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8014 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1311)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.221 (n=1417)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.209)

- **PATRÓN** `drift_60min` |x|≤ `0.6119` → IC=+0.210 (n=1610)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6119 (IC base=+0.209)
...
- **PATRÓN** `ibs_20min` < `0.0645` → IC=+0.242 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0645 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.626` → IC=+0.234 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.626 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.569` → IC=+0.210 (n=1748)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3508` → IC=+0.273 (n=231)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3508 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` < `1.7646` → IC=+0.203 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7646 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.1845` → IC=+0.217 (n=987)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1845 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.216 (n=1073)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `1907.66` → IC=+0.217 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1907.66 (IC base=+0.209)

- **PATRÓN** `ballena_activa_n` < `23.0` → IC=+0.215 (n=959)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.144 (n=102)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=2282)
...
- **PATRÓN** `volumen_regimen` > `1.1597` → IC=+0.152 (n=291)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5232` → IC=+0.176 (n=733)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.124 (n=2260)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1125)

- **FILTRO** `sigma_ewma_delta_pct` > `8.708` → IC=-0.212 (n=363)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.708
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3022)
...
- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.124 (n=1125)
...
- **PATRÓN** `ibs_20min` < `0.5491` → IC=+0.155 (n=9216)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.5491 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.7205` → IC=+0.241 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7205 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` < `0.2514` → IC=+0.241 (n=2958)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2514 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` < `0.708` → IC=+0.242 (n=1370)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.243` → IC=+0.304 (n=780)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.243 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` < `1.6001` → IC=+0.260 (n=1818)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6001 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` > `2.2978` → IC=+0.260 (n=1874)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2978 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.267 (n=4015)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.074)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2571` → IC=-0.147 (n=728)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2571
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=2187)

- **FILTRO** `sigma_ewma_delta_pct` > `4.552` → IC=-0.161 (n=555)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.552
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1860)

- **PATRÓN** `ibs_20min` > `0.8938` → IC=+0.263 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8938 (IC base=+0.042)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.861` → IC=+0.206 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.861 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.2222` → IC=+0.276 (n=181)
...
- **PATRÓN** `volumen_spike_ratio` < `1.433` → IC=+0.173 (n=310)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.433 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` > `2.1367` → IC=+0.200 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1367 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.184 (n=397)
...
- **PATRÓN** `ibs_20min` > `0.8641` → IC=+0.159 (n=707)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8641 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.3086` → IC=+0.175 (n=383)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3086 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.168 (n=874)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6736 (IC base=+0.025)
...
- **PATRÓN** `ballena_activa_n` < `242.0` → IC=+0.187 (n=420)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 242.0 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` < `0.1592` → IC=+0.220 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1592 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` > `0.8539` → IC=+0.228 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8539 (IC base=+0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.2701` → IC=+0.311 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2701 (IC base=+0.007)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1623` → IC=+0.233 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1623 (IC base=+0.007)

- **PATRÓN** `ballena_activa_n` < `460.0` → IC=+0.219 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 460.0 (IC base=+0.007)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1031` → IC=+0.260 (n=1404)
...
- **PATRÓN** `libro_liquidez` > `1909.8884` → IC=+0.250 (n=751)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1909.8884 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.01` → IC=+0.312 (n=605)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.01 (IC base=+0.281)

- **PATRÓN** `drift_60min` |x|≤ `0.1738` → IC=+0.288 (n=587)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1738 (IC base=+0.281)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.323 (n=450)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.281)

- **PATRÓN** `ibs_20min` < `0.0909` → IC=+0.287 (n=891)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0909 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.812` → IC=+0.294 (n=528)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7379` → IC=+0.286 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7379 (IC base=+0.281)

- **PATRÓN** `volumen_spike_ratio` > `2.7002` → IC=+0.290 (n=561)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7002 (IC base=+0.281)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.285 (n=883)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `1899.5579` → IC=+0.294 (n=605)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1899.5579 (IC base=+0.281)

- **PATRÓN** `ballena_activa_n` < `28.0` → IC=+0.284 (n=819)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 28.0 (IC base=+0.281)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2958` → IC=-0.179 (n=521)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2958
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1564)

- **FILTRO** `ibs_20min` > `0.7732` → IC=-0.184 (n=621)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7732
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1867)

- **PATRÓN** `ibs_20min` > `0.9107` → IC=+0.177 (n=522)
...
- **PATRÓN** `dist_vwap_pct` > `0.1485` → IC=+0.214 (n=215)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1485 (IC base=-0.004)

- **PATRÓN** `dist_vwap_pct` < `0.346` → IC=+0.198 (n=455)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.346 (IC base=-0.004)

- **PATRÓN** `volumen_regimen` < `0.6439` → IC=+0.232 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6439 (IC base=-0.004)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8269` → IC=+0.256 (n=273)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8269 (IC base=-0.004)

- **PATRÓN** `volumen_spike_ratio` > `2.1439` → IC=+0.234 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1439 (IC base=-0.004)
...
- **FILTRO** `ibs_20min` < `0.7308` → IC=-0.195 (n=1118)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7308
  - _Potencial_: sin este filtro IC_bueno=+0.277 (n=1120)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.237 (n=569)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1731)

- **FILTRO** `sigma_ewma_delta_pct` > `4.714` → IC=-0.189 (n=502)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.714
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1798)

- **PATRÓN** `ibs_20min` > `0.7308` → IC=+0.277 (n=1120)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.652` → IC=+0.170 (n=353)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.652 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` < `0.8679` → IC=+0.302 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8679 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` > `0.7298` → IC=+0.295 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7298 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` < `0.1013` → IC=+0.294 (n=774)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1013 (IC base=+0.042)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.315 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.042)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.120 (n=1523)
...
- **PATRÓN** `dist_vwap_pct` < `0.2221` → IC=+0.223 (n=515)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0972` → IC=+0.216 (n=551)
...
- **PATRÓN** `volumen_spike_ratio` < `2.46` → IC=+0.225 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.46 (IC base=+0.014)

- **PATRÓN** `volumen_spike_ratio` > `1.5706` → IC=+0.207 (n=496)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.318 (n=908)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.7398` → IC=+0.323 (n=1217)
...
- **PATRÓN** `volumen_regimen` > `0.8606` → IC=+0.303 (n=909)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8606 (IC base=+0.278)

- **PATRÓN** `volumen_pendiente_norm` < `0.0782` → IC=+0.282 (n=1161)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1495` → IC=+0.300 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1495 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1450)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `2634.3588` → IC=+0.291 (n=908)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2634.3588 (IC base=+0.278)

- **PATRÓN** `sigma_h` > `0.0215` → IC=+0.311 (n=664)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.3139` → IC=+0.281 (n=551)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3139 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` < `0.2283` → IC=+0.276 (n=1331)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2283 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.471` → IC=+0.290 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.471 (IC base=+0.275)

- **PATRÓN** `volumen_regimen` < `0.6391` → IC=+0.278 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6391 (IC base=+0.275)

- **PATRÓN** `volumen_regimen` > `1.2434` → IC=+0.310 (n=488)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1452` → IC=+0.275 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1452 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2625.9176` → IC=+0.278 (n=976)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.9176 (IC base=+0.275)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.172 (n=2728)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.200 (n=2721)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.185 (n=2722)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=8493)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5738` → IC=+0.218 (n=8158)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5738 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1767` → IC=+0.194 (n=3543)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1767 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.354` → IC=+0.256 (n=1666)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.354 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.209` → IC=+0.159 (n=5404)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.209 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6316` → IC=+0.160 (n=5403)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6316 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2427` → IC=+0.195 (n=1645)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2427 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5578` → IC=+0.167 (n=3445)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5578 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6119` → IC=+0.176 (n=2610)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6119 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2409.2447` → IC=+0.168 (n=5438)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2409.2447 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `113.0` → IC=+0.180 (n=7071)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 113.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.183 (n=5210)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.4806` → IC=+0.226 (n=7808)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4806 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2355` → IC=+0.159 (n=5665)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2355 (IC base=+0.168)
...
- **PATRÓN** `volumen_regimen` < `1.1725` → IC=+0.152 (n=5641)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5594` → IC=+0.165 (n=3134)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.5594 (IC base=+0.168)
...
- **PATRÓN** `ballena_activa_n` < `114.0` → IC=+0.175 (n=6772)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.308 (n=622)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.182 (n=1281)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.183)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.197 (n=1412)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.234 (n=407)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=1279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4047` → IC=+0.226 (n=1212)
...
- **PATRÓN** `volumen_spike_ratio` < `1.503` → IC=+0.177 (n=518)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.503 (IC base=+0.161)
...
- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.188 (n=1314)
...
- **PATRÓN** `volumen_regimen` < `1.1967` → IC=+0.159 (n=1314)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4443` → IC=+0.146 (n=1202)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4443 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.4225` → IC=+0.137 (n=1202)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4225 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `213.0` → IC=+0.165 (n=374)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2361` → IC=+0.216 (n=915)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2361 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=1419)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=723)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2057` → IC=+0.201 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2057 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` < `1.6236` → IC=+0.199 (n=436)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6236 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `2.8194` → IC=+0.214 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8194 (IC base=+0.199)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.174 (n=1148)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0066 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.4314` → IC=+0.158 (n=1305)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4314 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1367)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.3713` → IC=+0.196 (n=1306)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3713 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1549` → IC=+0.178 (n=861)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1549 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.995` → IC=+0.227 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.995 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.0361` → IC=+0.146 (n=1148)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0361 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6251` → IC=+0.147 (n=1305)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4269` → IC=+0.152 (n=426)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4269 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `2.5049` → IC=+0.168 (n=426)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.5049 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6113.3127` → IC=+0.182 (n=870)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 6113.3127 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.148 (n=1247)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.143 (n=1369)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.3831 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.178 (n=533)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.122)

- **PATRÓN** `ibs_20min` < `0.646` → IC=+0.171 (n=1369)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.646 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.3635` → IC=+0.135 (n=1480)
...
- **PATRÓN** `volumen_regimen` < `0.8476` → IC=+0.148 (n=913)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8007` → IC=+0.138 (n=832)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.138 (n=1512)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.204 (n=1478)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.5228` → IC=+0.197 (n=638)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5228 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.8` → IC=+0.259 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.8 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `1.2151` → IC=+0.129 (n=1478)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2151 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0708` → IC=+0.123 (n=621)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.0708 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.5371` → IC=+0.137 (n=628)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.5371 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1544)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2898.8632` → IC=+0.194 (n=670)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2898.8632 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.133 (n=1128)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=941)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.2928` → IC=+0.202 (n=941)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2928 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1463)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7391` → IC=+0.257 (n=1260)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.172 (n=665)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1374` → IC=+0.155 (n=877)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1374 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.186 (n=992)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3818` → IC=+0.180 (n=1992)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.3818 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.8649` → IC=+0.177 (n=329)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.8649 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.713` → IC=+0.177 (n=897)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.713 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.8725` → IC=+0.166 (n=1172)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8725 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `0.6257` → IC=+0.153 (n=1757)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6257 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4411` → IC=+0.163 (n=641)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4411 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.5174` → IC=+0.161 (n=641)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5174 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.154 (n=2258)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.02 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `12391.64` → IC=+0.161 (n=664)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12391.64 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.168 (n=1770)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 152.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.137 (n=1371)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0056 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=2068)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.0589` → IC=+0.190 (n=685)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.0589 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2117` → IC=+0.121 (n=1837)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2117 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.6996` → IC=+0.132 (n=815)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.6996 (IC base=+0.110)
...
- **PATRÓN** `libro_liquidez` > `2761.3271` → IC=+0.122 (n=1836)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.125 (n=326)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0039 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.3431` → IC=+0.127 (n=489)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3431 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.153 (n=456)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 8.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.2556` → IC=+0.152 (n=489)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.2556 (IC base=+0.110)
...
- **PATRÓN** `volumen_regimen` < `0.6213` → IC=+0.154 (n=163)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6213 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `10937.2581` → IC=+0.133 (n=489)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 10937.2581 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.167 (n=214)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.009 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.5437` → IC=+0.131 (n=469)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.5437 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.166 (n=432)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `1.0699` → IC=+0.145 (n=412)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0699 (IC base=+0.129)

- **PATRÓN** `volumen_pendiente_norm` > `0.181` → IC=+0.172 (n=132)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.181 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` > `2.2007` → IC=+0.183 (n=203)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.2007 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.132 (n=506)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.206 (n=3496)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=10917)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.308 (n=3524)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` > `0.967` → IC=+0.202 (n=1490)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.967 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.354` → IC=+0.245 (n=2638)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.354 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `0.88` → IC=+0.165 (n=4671)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.88 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2883` → IC=+0.203 (n=1445)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2883 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.5897` → IC=+0.188 (n=3361)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.5897 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `1794.2984` → IC=+0.171 (n=10474)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1794.2984 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `85.0` → IC=+0.195 (n=8024)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1489` → IC=+0.190 (n=4177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5686` → IC=+0.236 (n=9490)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5686 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2507` → IC=+0.162 (n=5894)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2507 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.033` → IC=+0.200 (n=1327)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.033 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.732` → IC=+0.183 (n=9176)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.732 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7039` → IC=+0.163 (n=2862)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.7039 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2017` → IC=+0.155 (n=2168)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2017 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2874` → IC=+0.240 (n=1248)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2874 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.6133` → IC=+0.193 (n=2912)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.6133 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.195 (n=5599)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 47.0 (IC base=+0.181)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.208 (n=590)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.266 (n=1262)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3509` → IC=+0.285 (n=1229)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3509 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.489` → IC=+0.261 (n=1464)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4333` → IC=+0.256 (n=429)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.259 (n=1544)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1812.929` → IC=+0.261 (n=931)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1812.929 (IC base=+0.258)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.194 (n=563)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1752)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3085` → IC=+0.202 (n=1677)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3085 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.3434` → IC=+0.193 (n=668)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.3434 (IC base=+0.150)
...
- **PATRÓN** `volumen_regimen` < `0.6273` → IC=+0.178 (n=561)
...
- **PATRÓN** `ibs_20min` < `0.6612` → IC=+0.193 (n=1456)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.6612 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.6845` → IC=+0.154 (n=235)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.6845 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1329` → IC=+0.165 (n=1321)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1329 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.471` → IC=+0.161 (n=243)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 11.471 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.303` → IC=+0.154 (n=1320)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.303 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.164 (n=1457)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1847 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1508` → IC=+0.197 (n=391)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1508 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.161 (n=1357)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.7561` → IC=+0.163 (n=905)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7561 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `352.0` → IC=+0.160 (n=842)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1780)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1728)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=662)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2104` → IC=+0.221 (n=1693)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2104 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `1.6263` → IC=+0.224 (n=1626)
...
- **PATRÓN** `libro_liquidez` > `1912.7172` → IC=+0.219 (n=773)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1912.7172 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0118` → IC=+0.237 (n=1590)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.0152` → IC=+0.308 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0152 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.746` → IC=+0.272 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.746 (IC base=+0.230)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7518` → IC=+0.229 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7518 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` > `2.1786` → IC=+0.234 (n=976)
...
- **PATRÓN** `libro_liquidez` > `1904.2584` → IC=+0.236 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1904.2584 (IC base=+0.230)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.243 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 13.0 (IC base=+0.230)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.187 (n=598)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0035 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4353` → IC=+0.146 (n=1783)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4353 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=1861)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.8757` → IC=+0.261 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8757 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.3639` → IC=+0.164 (n=704)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.3639 (IC base=+0.136)
...
- **PATRÓN** `volumen_regimen` < `0.8727` → IC=+0.155 (n=1189)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8727 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2331` → IC=+0.215 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2331 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.5181` → IC=+0.151 (n=760)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5181 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `2.1367` → IC=+0.151 (n=784)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.1367 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7950.223` → IC=+0.232 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7950.223 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.161 (n=555)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 77.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.154 (n=1449)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0076 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4451` → IC=+0.152 (n=1448)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7081` → IC=+0.181 (n=1448)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.7081 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.140 (n=1253)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.1614 (IC base=+0.136)
...
- **PATRÓN** `volumen_regimen` < `0.6926` → IC=+0.149 (n=637)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6926 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1877` → IC=+0.141 (n=483)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.1877 (IC base=+0.136)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.149 (n=1375)
...
- **PATRÓN** `ballena_activa_n` < `176.0` → IC=+0.142 (n=1370)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 176.0 (IC base=+0.136)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.141 (n=1185)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0082 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1826)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.190 (n=1778)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4706 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `1.1001` → IC=+0.197 (n=377)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 1.1001 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.513` → IC=+0.239 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.513 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `1.0803` → IC=+0.127 (n=1564)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0803 (IC base=+0.113)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1792)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2897.5388` → IC=+0.250 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2897.5388 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.129 (n=1389)
...
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.226 (n=1580)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0132 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1843)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.210)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.211 (n=1584)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.6` → IC=+0.258 (n=1587)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.21` → IC=+0.233 (n=1032)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.21 (IC base=+0.210)
...
- **PATRÓN** `volumen_regimen` < `1.2439` → IC=+0.211 (n=1769)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2439 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.6398` → IC=+0.218 (n=1769)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6398 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.2335` → IC=+0.252 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2335 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.5002` → IC=+0.236 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5002 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1848)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `2839.3754` → IC=+0.220 (n=802)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2839.3754 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.224 (n=629)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.4224` → IC=+0.266 (n=1659)
...
- **PATRÓN** `dist_vwap_pct` < `0.9192` → IC=+0.205 (n=2094)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1803` → IC=+0.199 (n=1496)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.1803 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4297` → IC=+0.199 (n=1700)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.147 (n=3187)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.170 (n=2695)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0091 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.5164` → IC=+0.168 (n=3062)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.9412` → IC=+0.216 (n=1022)
...
- **PATRÓN** `dist_vwap_pct` < `0.4754` → IC=+0.157 (n=1921)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.4754 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.206` → IC=+0.196 (n=504)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.206 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` > `0.6332` → IC=+0.162 (n=2051)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6332 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.1706` → IC=+0.195 (n=845)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1706 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `1.4563` → IC=+0.167 (n=1010)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4563 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.8774` → IC=+0.168 (n=2017)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.8774 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.160 (n=2185)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.01 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `8263.9499` → IC=+0.166 (n=1388)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 8263.9499 (IC base=+0.159)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.200 (n=802)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.4848` → IC=+0.164 (n=2402)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.4848 (IC base=+0.145)
...
- **PATRÓN** `dist_vwap_pct` > `0.6744` → IC=+0.170 (n=465)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6744 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.225` → IC=+0.158 (n=2395)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.225 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `1.2441` → IC=+0.152 (n=2300)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2441 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` < `0.0965` → IC=+0.149 (n=2179)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0965 (IC base=+0.145)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5338` → IC=+0.158 (n=1044)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.5338 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.8153` → IC=+0.148 (n=1581)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.8153 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=3187)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `7138.5133` → IC=+0.158 (n=2146)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 7138.5133 (IC base=+0.145)
...
- **PATRÓN** `volumen_regimen` < `1.2271` → IC=+0.181 (n=406)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 1.2271 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `0.8476` → IC=+0.202 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8476 (IC base=+0.172)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.176 (n=905)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0073 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.0041` → IC=+0.170 (n=1033)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0041 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.382` → IC=+0.175 (n=905)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.382 (IC base=+0.169)
...
- **PATRÓN** `ibs_20min` < `0.5389` → IC=+0.185 (n=686)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5389 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.8854` → IC=+0.178 (n=343)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.8854 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.4059` → IC=+0.179 (n=962)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.4059 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.19` → IC=+0.180 (n=920)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 4.19 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.0789` → IC=+0.170 (n=905)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.0789 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6413` → IC=+0.173 (n=1028)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6413 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.1645` → IC=+0.184 (n=308)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1645 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `2.4717` → IC=+0.174 (n=1009)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.4717 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `1.5228` → IC=+0.172 (n=903)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.5228 (IC base=+0.169)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=1028)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.195 (n=283)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0041 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.49` → IC=+0.180 (n=844)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.165 (n=565)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 10.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` < `0.7393` → IC=+0.158 (n=844)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.7393 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.0954` → IC=+0.163 (n=844)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.0954 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.1618` → IC=+0.171 (n=387)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1618 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.387` → IC=+0.164 (n=766)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 4.387 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `0.6452` → IC=+0.194 (n=282)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.6452 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `0.7215` → IC=+0.155 (n=754)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7215 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` < `0.1512` → IC=+0.156 (n=873)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` < 0.1512 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.0733` → IC=+0.171 (n=357)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.0733 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.1958` → IC=+0.170 (n=728)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.1958 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `7548.6064` → IC=+0.174 (n=844)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7548.6064 (IC base=+0.154)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.135 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 11.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.5405` → IC=+0.154 (n=255)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.5405 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.2115` → IC=+0.150 (n=181)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.2115 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.464` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 7.464 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` < `0.9193` → IC=+0.122 (n=170)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 0.9193 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.1626` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1626 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` > `1.4296` → IC=+0.129 (n=246)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4296 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `3437.001` → IC=+0.151 (n=227)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3437.001 (IC base=+0.103)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.179 (n=428)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `dist_vwap_pct` > `0.1545` → IC=+0.150 (n=470)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1545 (IC base=+0.088)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.443` → IC=+0.188 (n=206)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 11.443 (IC base=+0.088)

- **PATRÓN** `volumen_pendiente_norm` > `0.2799` → IC=+0.175 (n=115)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2799 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` < `2.0999` → IC=+0.124 (n=671)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.153 (n=332)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0059 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=342)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.101)

- **PATRÓN** `ibs_20min` > `0.4823` → IC=+0.183 (n=301)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.4823 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.1343` → IC=+0.175 (n=155)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.1343 (IC base=+0.101)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.164 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0039 (IC base=+0.098)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.130 (n=306)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 7.0 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.6741` → IC=+0.223 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6741 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.3368` → IC=+0.181 (n=117)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.3368 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.499` → IC=+0.300 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.499 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2766` → IC=+0.200 (n=38)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7354` → IC=+0.161 (n=163)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.7354 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `1133.2011` → IC=+0.154 (n=261)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 1133.2011 (IC base=+0.098)
...
- **PATRÓN** `volumen_regimen` < `1.1369` → IC=+0.133 (n=126)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.1369 (IC base=+0.121)
...
- **PATRÓN** `volumen_spike_ratio` < `2.698` → IC=+0.167 (n=94)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.698 (IC base=+0.121)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=735)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2924.7184` → IC=+0.173 (n=249)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2924.7184 (IC base=+0.109)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=818)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.125 (n=62)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=772)
...
- **PATRÓN** `py_entrada` < `0.47` → IC=+0.170 (n=216)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` < 0.47 (IC base=+0.019)
...
- **PATRÓN** `py_entrada` < `0.54` → IC=+0.161 (n=60)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` < 0.54 (IC base=+0.025)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.56` → IC=+0.141 (n=62)

  - _Acción_: Kelly boost +0.70€ cuando `py_entrada` < 0.56 (IC base=+0.060)
...
- **FILTRO** `profundidad_ratio` < `48.0` → IC=-0.136 (n=42)
...
- **PATRÓN** `py_entrada` < `0.45` → IC=+0.208 (n=22)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.45 (IC base=+0.017)

- **PATRÓN** `profundidad_ratio` > `48.0` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `profundidad_ratio` > 48.0 (IC base=+0.017)
...
- **PATRÓN** `py_entrada` < `0.42` → IC=+0.182 (n=20)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` < 0.42 (IC base=+0.018)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.180 (n=23)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 16.0 (IC base=+0.018)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7641)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.168 (n=3649)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=11119)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.166 (n=3789)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=11510)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.209 (n=628)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1940)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.186 (n=652)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1969)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.208 (n=663)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=2082)

- **FILTRO** `ibs_20min` > `0.281` → IC=-0.165 (n=685)

  - _Acción_: SKIP cuando `ibs_20min` > 0.281
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=2060)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.49` → IC=-0.170 (n=640)

  - _Acción_: SKIP cuando `py_entrada` < 0.49
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1921)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.174 (n=661)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=2089)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.205 (n=751)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2277)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3007)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=795)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.131 (n=10450)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=23217)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=8295)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=25372)

- **FILTRO** `ibs_7min` < `0.2791` → IC=-0.236 (n=8414)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2791
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=25253)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11413)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=22254)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.231 (n=10394)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=32016)

- **FILTRO** `ibs_7min` > `0.2922` → IC=-0.178 (n=10602)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2922
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=31808)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3889)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=1331)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4260)

- **FILTRO** `ibs_7min` < `0.7105` → IC=-0.252 (n=1844)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7105
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3747)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.188 (n=1246)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4345)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1798)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5493)

- **FILTRO** `drift_7min_pct` |x|> `0.111` → IC=-0.125 (n=2477)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.111
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4814)

- **FILTRO** `ibs_7min` > `0.7869` → IC=-0.208 (n=1821)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7869
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=5470)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1372)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4436)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1412)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4396)

- **FILTRO** `ibs_7min` < `0.7472` → IC=-0.193 (n=1452)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7472
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4356)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.176 (n=1449)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=4359)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.263 (n=1362)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=4539)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.180 (n=1473)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4428)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1508)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=3808)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.304 (n=1318)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3998)

- **FILTRO** `ibs_7min` < `0.7059` → IC=-0.245 (n=1745)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7059
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3571)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1794)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=6009)

- **FILTRO** `ibs_7min` > `0.75` → IC=-0.172 (n=1945)

  - _Acción_: SKIP cuando `ibs_7min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=5858)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3754)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1646)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3910)

- **FILTRO** `ibs_7min` < `0.7406` → IC=-0.181 (n=1389)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7406
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4167)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.174 (n=1348)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4208)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.259 (n=1419)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4262)

- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.178 (n=1420)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2744
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4261)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.184 (n=1387)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4294)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.257 (n=1449)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4393)

- **FILTRO** `ibs_7min` < `0.2963` → IC=-0.235 (n=1460)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2963
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=4382)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1914)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=6162)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.255 (n=1819)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3735)

- **FILTRO** `ibs_7min` < `0.298` → IC=-0.226 (n=1388)

  - _Acción_: SKIP cuando `ibs_7min` < 0.298
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4166)
...
- **FILTRO** `py_entrada` > `0.67` → IC=-0.208 (n=1805)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5853)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=414)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=751)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=2997)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=1523)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.225 (n=566)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0507` → IC=+0.206 (n=566)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=1573)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6071` → IC=+0.267 (n=1698)
...
- **PATRÓN** `dist_vwap_pct` < `0.6136` → IC=+0.180 (n=1614)
...
- **PATRÓN** `libro_liquidez` > `2960.2418` → IC=+0.194 (n=1132)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2960.2418 (IC base=+0.186)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0758` → IC=+0.245 (n=1687)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0758 (IC base=-0.029)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1785` → IC=+0.239 (n=1222)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1785 (IC base=-0.029)

- **PATRÓN** `ibs_15` < `0.3488` → IC=+0.276 (n=1888)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `drift_60min` |x|> `0.1682` → IC=-0.224 (n=219)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
...
- **FILTRO** `sigma_h` > `0.0198` → IC=-0.259 (n=397)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `drift_15min` |x|> `1.2607` → IC=-0.270 (n=198)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.177 (n=598)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6071 sube el IC de +0.186 a +0.267 en UPDOWN_GBM#15min (n=1698). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6423 sube el IC de -0.066 a +0.274 en UPDOWN_GBM_15M_TARDIO (n=652). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3488 sube el IC de -0.029 a +0.276 en UPDOWN_GBM_15M_TARDIO (n=1888). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 29054 | -0.086 | -3888.39€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1522 | -0.040 | -226.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27532 | -0.089 | -3661.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3800 | -0.099 | -625.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3800 | -0.099 | -625.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1522 | -0.040 | -226.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1522 | -0.040 | -226.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3484 | -0.096 | -788.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3484 | -0.096 | -788.92€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7456 | -0.020 | -701.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7456 | -0.020 | -701.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 7077 | -0.090 | -456.15€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 7077 | -0.090 | -456.15€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5715 | -0.167 | -1089.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5715 | -0.167 | -1089.40€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 19217 | -0.027 | +3962.98€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 5001 | +0.000 | +1817.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 14216 | -0.036 | +2145.44€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 19217 | -0.027 | +3962.98€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 5001 | +0.000 | +1817.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 14216 | -0.036 | +2145.44€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 96077 | +0.113 | -4742.04€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14394 | +0.185 | -436.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 387 | -0.076 | -50.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 75100 | +0.100 | -4035.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6196 | +0.107 | -218.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12487 | +0.099 | -1026.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 46 | -0.167 | -1.52€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12426 | +0.100 | -1013.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 19429 | +0.132 | -376.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4552 | +0.203 | -147.45€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12451 | +0.112 | -184.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2384 | +0.102 | -22.63€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12527 | +0.090 | -1128.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 53 | -0.100 | -7.49€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12459 | +0.092 | -1109.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 20414 | +0.124 | -378.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5573 | +0.175 | -78.19€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12586 | +0.106 | -234.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2243 | +0.099 | -56.78€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18721 | +0.114 | -1085.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4123 | +0.189 | -210.40€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 290 | -0.034 | +3.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12739 | +0.091 | -739.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1569 | +0.126 | -139.50€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12499 | +0.100 | -746.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12439 | +0.101 | -754.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 15236 | +0.191 | -1007.28€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 15236 | +0.191 | -1007.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3616 | +0.167 | -381.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3616 | +0.167 | -381.19€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1327 | +0.194 | -20.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1327 | +0.194 | -20.04€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3569 | +0.180 | -305.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3569 | +0.180 | -305.75€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3150 | +0.239 | -103.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3150 | +0.239 | -103.44€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 