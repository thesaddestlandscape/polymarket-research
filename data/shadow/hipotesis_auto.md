# Hipótesis automáticas — 2026-09-23 14:36 UTC
_Generado por shadow_postmortem.py sobre 574519 resoluciones (PNL=+64188.64€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.120 (n=464)

- **PATRÓN** `py_entrada` > `0.51` → IC=+0.258 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.51 (IC base=+0.138)

- **PATRÓN** `n_total_lado` > `75.0` → IC=+0.207 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 75.0 (IC base=+0.138)

- **PATRÓN** `banda_hit_calibrado` > `0.8035` → IC=+0.254 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8035 (IC base=+0.138)

- **PATRÓN** `banda_z` > `4.204` → IC=+0.167 (n=538)

  - _Acción_: Kelly boost +0.83€ cuando `banda_z` > 4.204 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.149 (n=496)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 7.0 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=575)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `4878.272` → IC=+0.159 (n=180)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 4878.272 (IC base=+0.138)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.120 (n=464)

  - _Acción_: Kelly boost +0.60€ cuando `py_entrada` < 0.495 (IC base=+0.045)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.133 (n=164)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 96.0 (IC base=+0.045)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.259 (n=409)

- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)

  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.114 (n=337)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.259 (n=409)
...
- **PATRÓN** `banda_hit_calibrado` > `0.7991` → IC=+0.267 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.7991 (IC base=+0.147)

- **PATRÓN** `banda_z` > `10.816` → IC=+0.231 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.816 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.167 (n=304)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 11.0 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=486)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.151 (n=124)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 96.0 (IC base=+0.047)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.04` → IC=-0.234 (n=6884)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.04
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=20655)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.2` → IC=-0.239 (n=897)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.2
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2693)
...
- **FILTRO** `restante_s_al_confirmar` < `128.9` → IC=-0.303 (n=854)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 128.9
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2564)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `164.03` → IC=-0.228 (n=1636)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.03
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4909)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.14` → IC=-0.357 (n=1371)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.14
  - _Potencial_: sin este filtro IC_bueno=-0.125 (n=4116)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.202 (n=13561)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3403)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5610.4838` → IC=+0.175 (n=2169)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5610.4838 (IC base=+0.101)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.232 (n=10599)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5540)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7726.643` → IC=+0.173 (n=2086)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7726.643 (IC base=+0.127)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1673)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.352 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2064)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15851.4079` → IC=+0.233 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15851.4079 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.200)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1639)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1491)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=2095)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `14025.2522` → IC=+0.211 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14025.2522 (IC base=+0.200)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `py_entrada` > `0.59` → IC=+0.165 (n=455)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.59 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `4624.034` → IC=+0.146 (n=235)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 4624.034 (IC base=+0.103)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.141 (n=507)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.108)

- **PATRÓN** `py_entrada` < `0.44` → IC=+0.148 (n=804)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.239 (n=1451)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.141 (n=578)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=523)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `1301.6177` → IC=+0.148 (n=638)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1301.6177 (IC base=+0.136)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.432 (n=618)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=1062)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.204 (n=289)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=11117)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=10661)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3725)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=2573)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.183 (n=1882)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.251 (n=780)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=32997)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.235 (n=14903)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.176 (n=5706)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `2.95` → IC=+0.141 (n=4628)

  - _Acción_: Kelly boost +0.70€ cuando `lag_apertura_s` < 2.95 (IC base=+0.118)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=2550)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.122)

- **PATRÓN** `restante_min` < `4.1` → IC=+0.132 (n=2305)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` < 4.1 (IC base=+0.122)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.141 (n=2468)
...
- **PATRÓN** `lag_apertura_s` < `3.44` → IC=+0.144 (n=2302)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 3.44 (IC base=+0.122)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.190 (n=2514)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.38 (IC base=+0.113)

- **PATRÓN** `restante_min` < `4.19` → IC=+0.126 (n=2342)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.19 (IC base=+0.113)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.135 (n=2522)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 4.96 (IC base=+0.113)

- **PATRÓN** `lag_apertura_s` < `2.31` → IC=+0.138 (n=2337)

  - _Acción_: Kelly boost +0.69€ cuando `lag_apertura_s` < 2.31 (IC base=+0.113)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.322 (n=760)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.291)

- **PATRÓN** `py_entrada` > `0.815` → IC=+0.387 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `4080.5501` → IC=+0.311 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4080.5501 (IC base=+0.291)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.303 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4222.4628` → IC=+0.301 (n=320)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.294 (n=517)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1466.3152` → IC=+0.310 (n=461)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4793` → IC=+0.121 (n=7778)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4793 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.982` → IC=+0.243 (n=2592)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.982 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8353` → IC=+0.248 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8353 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.633` → IC=+0.248 (n=2166)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.633 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.936` → IC=+0.176 (n=2993)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.936 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.2119` → IC=+0.246 (n=2089)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2119 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.05` → IC=+0.258 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.05 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3055` → IC=+0.217 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3055 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.9099` → IC=+0.206 (n=3539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9099 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.133 (n=9386)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.57 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.5983` → IC=+0.192 (n=709)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.5983 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` < `0.1508` → IC=+0.173 (n=2930)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1508 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` < `0.7009` → IC=+0.181 (n=1437)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.7009 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.0532` → IC=+0.175 (n=1480)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0532 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.1683` → IC=+0.225 (n=1556)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1683 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `1.5744` → IC=+0.202 (n=4880)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5744 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `137.0` → IC=+0.212 (n=5250)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.173 (n=588)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0082 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.3476` → IC=+0.165 (n=1761)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3476 (IC base=+0.161)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0835` → IC=+0.251 (n=447)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0835 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.229 (n=1404)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.216)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.215 (n=1365)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.9886` → IC=+0.266 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9886 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` > `0.2003` → IC=+0.222 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2003 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `0.5794` → IC=+0.219 (n=1393)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5794 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.856` → IC=+0.256 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.856 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` < `1.2554` → IC=+0.219 (n=1339)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2554 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `0.8753` → IC=+0.225 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8753 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` > `0.2802` → IC=+0.232 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2802 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` < `1.4014` → IC=+0.220 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4014 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.3798` → IC=+0.222 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3798 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `12314.1902` → IC=+0.218 (n=1196)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12314.1902 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.174 (n=468)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0026 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.158 (n=466)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6918` → IC=+0.170 (n=1396)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6918 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1328` → IC=+0.157 (n=1238)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1328 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.202` → IC=+0.165 (n=225)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.202 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.243` → IC=+0.140 (n=1271)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 4.243 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.149 (n=1396)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.204 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0967` → IC=+0.173 (n=506)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0967 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4156` → IC=+0.152 (n=1286)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4156 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.7671` → IC=+0.146 (n=857)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7671 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `14001.0043` → IC=+0.144 (n=931)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 14001.0043 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.147 (n=1204)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 411.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.217 (n=575)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.189 (n=1811)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 5.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=1546)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.187` → IC=+0.250 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.187 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` < `0.2114` → IC=+0.188 (n=1714)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8719` → IC=+0.205 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8719 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=1219)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.224 (n=1470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.215)

- **PATRÓN** `drift_60min` |x|≤ `0.5845` → IC=+0.217 (n=1470)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5845 (IC base=+0.215)
...
- **PATRÓN** `ibs_20min` < `0.0625` → IC=+0.243 (n=648)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0625 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.609` → IC=+0.244 (n=502)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7936` → IC=+0.209 (n=590)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7936 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.2222` → IC=+0.221 (n=893)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2222 (IC base=+0.215)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.224 (n=984)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `1874.1584` → IC=+0.231 (n=667)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1874.1584 (IC base=+0.215)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.214 (n=1126)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=96)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=2156)

- **PATRÓN** `ibs_20min` > `0.9414` → IC=+0.212 (n=349)
...
- **PATRÓN** `dist_vwap_pct` < `0.7769` → IC=+0.330 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7769 (IC base=+0.022)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.666` → IC=+0.154 (n=689)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 4.666 (IC base=+0.022)

- **PATRÓN** `volumen_regimen` < `0.6044` → IC=+0.332 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6044 (IC base=+0.022)

- **PATRÓN** `volumen_regimen` > `1.2004` → IC=+0.340 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2004 (IC base=+0.022)

- **PATRÓN** `volumen_pendiente_norm` < `0.1818` → IC=+0.318 (n=250)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4012` → IC=+0.335 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4012 (IC base=+0.022)

- **PATRÓN** `volumen_spike_ratio` > `2.2012` → IC=+0.327 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2012 (IC base=+0.022)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.332 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 164.0 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` > `0.6671` → IC=+0.195 (n=139)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.6671 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` < `0.8509` → IC=+0.162 (n=534)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8509 (IC base=+0.015)

- **PATRÓN** `volumen_pendiente_norm` > `0.2258` → IC=+0.213 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2258 (IC base=+0.015)

- **PATRÓN** `volumen_spike_ratio` > `1.5204` → IC=+0.177 (n=667)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5204 (IC base=+0.015)
...
- **FILTRO** `ibs_20min` > `0.2571` → IC=-0.125 (n=2124)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2571
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=1048)

- **FILTRO** `sigma_ewma_delta_pct` > `8.654` → IC=-0.206 (n=342)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.654
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2830)
...
- **PATRÓN** `ibs_20min` < `0.2571` → IC=+0.126 (n=1048)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2571 (IC base=-0.042)

- **PATRÓN** `dist_vwap_pct` > `0.6858` → IC=+0.258 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6858 (IC base=-0.042)

- **PATRÓN** `volumen_regimen` < `1.096` → IC=+0.225 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.096 (IC base=-0.042)

- **PATRÓN** `volumen_regimen` > `0.9038` → IC=+0.211 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9038 (IC base=-0.042)

- **PATRÓN** `volumen_pendiente_norm` < `0.1045` → IC=+0.229 (n=256)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4396` → IC=+0.261 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4396 (IC base=-0.042)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.186 (n=545)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1636)

- **FILTRO** `ibs_20min` < `0.7098` → IC=-0.157 (n=1439)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7098
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=742)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.199 (n=403)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1778)

- **FILTRO** `ibs_20min` > `0.7717` → IC=-0.204 (n=805)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7717
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=2416)

- **PATRÓN** `dist_vwap_pct` > `0.783` → IC=+0.324 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.783 (IC base=-0.068)

- **PATRÓN** `dist_vwap_pct` < `0.2675` → IC=+0.319 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2675 (IC base=-0.068)

- **PATRÓN** `volumen_regimen` < `0.9948` → IC=+0.294 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9948 (IC base=-0.068)

- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.310 (n=329)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4256` → IC=+0.301 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4256 (IC base=-0.068)

- **PATRÓN** `volumen_spike_ratio` > `1.7955` → IC=+0.299 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7955 (IC base=-0.068)

- **PATRÓN** `dist_vwap_pct` > `0.8408` → IC=+0.274 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8408 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.7387` → IC=+0.251 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7387 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` > `1.2467` → IC=+0.291 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2467 (IC base=-0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.1708` → IC=+0.280 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1708 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `2.1684` → IC=+0.252 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1684 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.4431` → IC=+0.249 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4431 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.245 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.197 (n=3249)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.4733` → IC=+0.188 (n=8693)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4733 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.7535` → IC=+0.286 (n=1052)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7535 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.575` → IC=+0.155 (n=4604)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.575 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.247 (n=3083)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6895 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2976` → IC=+0.265 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2976 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `1.4726` → IC=+0.240 (n=1867)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4726 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6833` → IC=+0.237 (n=1866)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6833 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.268 (n=5119)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.152 (n=3250)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5478` → IC=+0.152 (n=8565)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5478 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` < `0.2455` → IC=+0.238 (n=2684)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2455 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` < `0.7126` → IC=+0.238 (n=1256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7126 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.246 (n=952)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2035 (IC base=+0.073)

- **PATRÓN** `volumen_pendiente_norm` > `0.2461` → IC=+0.302 (n=712)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2461 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `1.6124` → IC=+0.256 (n=1646)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6124 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `2.3302` → IC=+0.256 (n=1696)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3302 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `83.0` → IC=+0.262 (n=3615)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 83.0 (IC base=+0.073)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.255` → IC=-0.149 (n=670)

  - _Acción_: SKIP cuando `ibs_20min` < 0.255
  - _Potencial_: sin este filtro IC_bueno=+0.108 (n=2013)

- **FILTRO** `sigma_ewma_delta_pct` > `4.503` → IC=-0.164 (n=510)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.503
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1720)

- **PATRÓN** `ibs_20min` > `0.8889` → IC=+0.263 (n=672)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8889 (IC base=+0.044)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.764` → IC=+0.201 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.764 (IC base=+0.044)
...
- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.177 (n=373)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 15.0 (IC base=+0.044)

- **PATRÓN** `volumen_pendiente_norm` < `0.1791` → IC=+0.459 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1791 (IC base=-0.018)

- **PATRÓN** `volumen_spike_ratio` > `1.3867` → IC=+0.446 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3867 (IC base=-0.018)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.462 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 26.0 (IC base=-0.018)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `ibs_20min` > `0.8632` → IC=+0.156 (n=650)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.8632 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1264` → IC=+0.173 (n=503)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.1264 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.164 (n=796)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6736 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.2752` → IC=+0.214 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2752 (IC base=+0.025)

- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.199 (n=290)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.025)

- **PATRÓN** `ballena_activa_n` < `247.0` → IC=+0.192 (n=378)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 247.0 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.217 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1614 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` > `0.611` → IC=+0.210 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.611 (IC base=+0.003)

- **PATRÓN** `volumen_pendiente_norm` > `0.273` → IC=+0.300 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.273 (IC base=+0.003)

- **PATRÓN** `volumen_spike_ratio` < `1.4551` → IC=+0.229 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4551 (IC base=+0.003)

- **PATRÓN** `volumen_spike_ratio` > `2.1626` → IC=+0.229 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1626 (IC base=+0.003)

- **PATRÓN** `ballena_activa_n` < `477.0` → IC=+0.213 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 477.0 (IC base=+0.003)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.291 (n=515)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0111 (IC base=+0.246)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=1543)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.246)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.249 (n=1555)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.736` → IC=+0.279 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.736 (IC base=+0.246)

- **PATRÓN** `volumen_pendiente_norm` < `0.1379` → IC=+0.258 (n=1366)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1379 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `3.4416` → IC=+0.260 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4416 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=1078)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1946.7648` → IC=+0.255 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1946.7648 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.315 (n=554)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.597` → IC=+0.283 (n=1222)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.597 (IC base=+0.282)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.329 (n=412)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.282)

- **PATRÓN** `ibs_20min` < `0.2252` → IC=+0.288 (n=1076)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2252 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.819` → IC=+0.298 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.819 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.3432` → IC=+0.309 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3432 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` < `1.6093` → IC=+0.286 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6093 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.7856` → IC=+0.285 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7856 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.291 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1927.08` → IC=+0.302 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1927.08 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.285 (n=723)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2821` → IC=-0.190 (n=472)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2821
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1419)

- **FILTRO** `ibs_20min` > `0.7753` → IC=-0.182 (n=577)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7753
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1732)

- **PATRÓN** `ibs_20min` > `0.8157` → IC=+0.159 (n=643)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8157 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` > `0.4516` → IC=+0.222 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4516 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.9984` → IC=+0.233 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9984 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.6488` → IC=+0.210 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6488 (IC base=+0.009)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1059` → IC=+0.244 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1059 (IC base=+0.009)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.256 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` > `0.1547` → IC=+0.205 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1547 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` < `0.6719` → IC=+0.192 (n=456)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.6719 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.205 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1615 (IC base=-0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.1651` → IC=+0.263 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1651 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` < `1.8288` → IC=+0.255 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8288 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` > `2.1743` → IC=+0.239 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1743 (IC base=-0.007)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.246 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=-0.007)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7196` → IC=-0.199 (n=1031)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7196
  - _Potencial_: sin este filtro IC_bueno=+0.279 (n=1031)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.231 (n=540)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1628)

- **FILTRO** `sigma_ewma_delta_pct` > `4.685` → IC=-0.178 (n=473)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.685
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=1695)

- **PATRÓN** `ibs_20min` > `0.7196` → IC=+0.279 (n=1031)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7196 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` > `0.8467` → IC=+0.335 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8467 (IC base=+0.040)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.527` → IC=+0.159 (n=329)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 9.527 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.302 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `0.7279` → IC=+0.291 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7279 (IC base=+0.040)

- **PATRÓN** `volumen_pendiente_norm` < `0.1034` → IC=+0.294 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1034 (IC base=+0.040)
...
- **PATRÓN** `ibs_20min` > `0.6316` → IC=+0.313 (n=1267)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6316 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.2027` → IC=+0.319 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2027 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.504` → IC=+0.305 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.504 (IC base=+0.279)

- **PATRÓN** `volumen_regimen` > `0.8631` → IC=+0.304 (n=845)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8631 (IC base=+0.279)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.324 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.279)

- **PATRÓN** `volumen_spike_ratio` > `2.1582` → IC=+0.293 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1582 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.286 (n=1351)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `2621.5822` → IC=+0.296 (n=845)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2621.5822 (IC base=+0.279)

- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.297 (n=916)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0151 (IC base=+0.271)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.278 (n=687)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3962` → IC=+0.305 (n=1374)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3962 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.2958` → IC=+0.279 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2958 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` < `0.9535` → IC=+0.272 (n=1542)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9535 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.999` → IC=+0.299 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.999 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` < `0.6417` → IC=+0.272 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6417 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `1.2432` → IC=+0.311 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2432 (IC base=+0.271)

- **PATRÓN** `volumen_pendiente_norm` > `0.2393` → IC=+0.341 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2393 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` < `2.5076` → IC=+0.268 (n=1207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5076 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1642` → IC=+0.276 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1642 (IC base=+0.271)

- **PATRÓN** `libro_liquidez` > `2612.1165` → IC=+0.279 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2612.1165 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2540)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.203 (n=2538)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0898` → IC=+0.186 (n=2539)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0898 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=7931)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5789` → IC=+0.217 (n=7612)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5789 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1755` → IC=+0.196 (n=3362)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1755 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.277` → IC=+0.258 (n=1563)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.277 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2155` → IC=+0.160 (n=5035)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2155 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.629` → IC=+0.160 (n=5034)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.629 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2455` → IC=+0.195 (n=1535)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2455 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.563` → IC=+0.171 (n=3209)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.563 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6278` → IC=+0.176 (n=2431)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6278 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2398.6848` → IC=+0.168 (n=5075)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2398.6848 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.181 (n=6522)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 116.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=4845)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0805` → IC=+0.209 (n=2422)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4762` → IC=+0.227 (n=7262)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4762 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.1699` → IC=+0.161 (n=5071)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1699 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.296` → IC=+0.197 (n=1241)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.296 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1752` → IC=+0.153 (n=5273)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1752 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2914` → IC=+0.225 (n=1045)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2914 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5675` → IC=+0.166 (n=2897)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5675 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2624` → IC=+0.172 (n=2985)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.2624 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.174 (n=6228)
...
- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.187 (n=867)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0065 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.3418` → IC=+0.205 (n=1301)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.302 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.107` → IC=+0.312 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.107 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2786` → IC=+0.236 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2786 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.181 (n=1201)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.182)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.239 (n=827)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.240)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.254 (n=839)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.240)

- **PATRÓN** `drift_60min` |x|≤ `0.1878` → IC=+0.295 (n=626)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1878 (IC base=+0.240)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.245 (n=964)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.240)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.244 (n=826)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.240)

- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.264 (n=939)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.240)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.202` → IC=+0.253 (n=1014)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.202 (IC base=+0.240)

- **PATRÓN** `volumen_pendiente_norm` < `0.0955` → IC=+0.235 (n=776)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0955 (IC base=+0.240)

- **PATRÓN** `volumen_pendiente_norm` > `0.2821` → IC=+0.270 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2821 (IC base=+0.240)

- **PATRÓN** `volumen_spike_ratio` < `1.4205` → IC=+0.260 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4205 (IC base=+0.240)

- **PATRÓN** `volumen_spike_ratio` > `2.6424` → IC=+0.234 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6424 (IC base=+0.240)

- **PATRÓN** `libro_liquidez` > `1799.54` → IC=+0.253 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1799.54 (IC base=+0.240)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.239 (n=378)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.0739` → IC=+0.200 (n=378)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0739 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=1191)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4088` → IC=+0.224 (n=1132)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4088 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.2099` → IC=+0.213 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2099 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.482` → IC=+0.236 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.482 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.2679` → IC=+0.163 (n=1132)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2679 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `1.0768` → IC=+0.167 (n=514)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.0768 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.232` → IC=+0.198 (n=250)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.232 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `1.4115` → IC=+0.193 (n=366)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.4115 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `15862.1611` → IC=+0.163 (n=514)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 15862.1611 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.197 (n=414)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0026 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0593` → IC=+0.203 (n=415)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0593 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.175 (n=416)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 18.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.5646` → IC=+0.184 (n=1240)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5646 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1339` → IC=+0.161 (n=1222)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1339 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.777` → IC=+0.204 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.777 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.155 (n=1240)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2113 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1575` → IC=+0.155 (n=378)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1575 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.4267` → IC=+0.145 (n=1129)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.4267 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `216.0` → IC=+0.170 (n=353)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 216.0 (IC base=+0.136)
...
- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.235 (n=1052)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0112 (IC base=+0.221)

- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.255 (n=353)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2407` → IC=+0.257 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2407 (IC base=+0.221)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.735` → IC=+0.271 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.735 (IC base=+0.221)

- **PATRÓN** `volumen_pendiente_norm` > `0.3581` → IC=+0.271 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3581 (IC base=+0.221)

- **PATRÓN** `volumen_spike_ratio` < `1.6049` → IC=+0.215 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6049 (IC base=+0.221)

- **PATRÓN** `volumen_spike_ratio` > `2.2332` → IC=+0.227 (n=647)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2332 (IC base=+0.221)

- **PATRÓN** `libro_liquidez` > `1877.2368` → IC=+0.229 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1877.2368 (IC base=+0.221)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4315` → IC=+0.158 (n=1213)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4315 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1272)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.3795` → IC=+0.194 (n=1212)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.3795 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1608` → IC=+0.180 (n=818)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1608 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.868` → IC=+0.225 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.868 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.0427` → IC=+0.144 (n=1067)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0427 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6318` → IC=+0.147 (n=1212)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6318 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.197 (n=255)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.5369` → IC=+0.149 (n=523)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5369 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `2.5292` → IC=+0.171 (n=396)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.5292 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6938.502` → IC=+0.184 (n=808)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6938.502 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.144 (n=1148)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 165.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.156 (n=1284)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0072 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.3828` → IC=+0.144 (n=1283)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.3828 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.178 (n=498)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` < `0.6304` → IC=+0.171 (n=1283)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6304 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.5767` → IC=+0.134 (n=1483)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.5767 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.896` → IC=+0.172 (n=452)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.896 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` < `0.8521` → IC=+0.147 (n=856)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8521 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.202 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` < `1.7982` → IC=+0.134 (n=776)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.7982 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` > `2.489` → IC=+0.139 (n=388)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.489 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `9966.3147` → IC=+0.163 (n=582)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 9966.3147 (IC base=+0.124)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.123 (n=1098)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 165.0 (IC base=+0.124)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.157 (n=624)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0101 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.140 (n=1408)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 5.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.204 (n=1375)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5169 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` > `0.8344` → IC=+0.217 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8344 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.694` → IC=+0.256 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.694 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.131 (n=1377)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2233 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` > `0.6398` → IC=+0.122 (n=1375)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6398 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` < `0.1649` → IC=+0.132 (n=1383)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` < 0.1649 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.0712` → IC=+0.123 (n=577)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_pendiente_norm` > 0.0712 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `1.4421` → IC=+0.146 (n=444)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.4421 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1440)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.195 (n=624)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.119)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.137 (n=1053)
...
- **PATRÓN** `drift_60min` |x|≤ `0.103` → IC=+0.153 (n=465)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.103 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1410)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.208 (n=1394)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5625 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.9777` → IC=+0.139 (n=189)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.9777 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.1963` → IC=+0.139 (n=1276)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1963 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.49` → IC=+0.143 (n=289)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 7.49 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `1.18` → IC=+0.122 (n=1393)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.18 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2773` → IC=+0.174 (n=170)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.2773 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.4294` → IC=+0.131 (n=415)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.4294 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `3082.5359` → IC=+0.162 (n=465)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3082.5359 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.216 (n=877)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.7386` → IC=+0.261 (n=1175)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7386 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.5011` → IC=+0.221 (n=636)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5011 (IC base=+0.203)
...
- **PATRÓN** `volumen_regimen` < `1.209` → IC=+0.205 (n=1315)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2335` → IC=+0.272 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2335 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.216 (n=1117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1508 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4098` → IC=+0.208 (n=1269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4098 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.206 (n=1395)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2612.836` → IC=+0.206 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2612.836 (IC base=+0.203)

- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.232 (n=453)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0086 (IC base=+0.205)

- **PATRÓN** `sigma_h` > `0.0224` → IC=+0.210 (n=616)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0224 (IC base=+0.205)

- **PATRÓN** `drift_60min` |x|≤ `0.0896` → IC=+0.223 (n=453)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4385` → IC=+0.247 (n=1358)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4385 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `1.1573` → IC=+0.233 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1573 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` < `0.8806` → IC=+0.205 (n=1579)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8806 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.374` → IC=+0.246 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.374 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6302` → IC=+0.216 (n=1358)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6302 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.290 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2827 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `2.2213` → IC=+0.195 (n=1071)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2213 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4428` → IC=+0.200 (n=1217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4428 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2581.0665` → IC=+0.209 (n=905)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2581.0665 (IC base=+0.205)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.164 (n=597)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0038 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.178 (n=598)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0089 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.0995` → IC=+0.154 (n=596)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.5494` → IC=+0.186 (n=1596)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.5494 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.3904` → IC=+0.182 (n=549)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.3904 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.719` → IC=+0.175 (n=822)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.719 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8759` → IC=+0.164 (n=1041)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8759 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.2116` → IC=+0.154 (n=521)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2116 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1641` → IC=+0.175 (n=497)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1641 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4378` → IC=+0.167 (n=574)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4378 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5495` → IC=+0.159 (n=573)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5495 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2022)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12293.6617` → IC=+0.150 (n=596)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12293.6617 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.165 (n=1566)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 164.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.134 (n=1253)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0057 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=1788)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.5219` → IC=+0.142 (n=1653)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.5219 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` < `2.2271` → IC=+0.122 (n=1590)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.2271 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `3821.4035` → IC=+0.122 (n=1252)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 3821.4035 (IC base=+0.104)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3375` → IC=+0.124 (n=448)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3375 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.145 (n=401)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 9.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2513` → IC=+0.142 (n=448)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.2513 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3078` → IC=+0.161 (n=160)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.3078 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.264` → IC=+0.126 (n=201)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 3.264 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6219` → IC=+0.151 (n=150)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6219 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `12687.2059` → IC=+0.132 (n=400)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 12687.2059 (IC base=+0.104)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.208 (n=200)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.3387` → IC=+0.149 (n=599)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3387 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.142 (n=616)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 5.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.6039` → IC=+0.177 (n=527)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6039 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.3016` → IC=+0.151 (n=631)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.3016 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.384` → IC=+0.155 (n=233)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 4.384 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `0.718` → IC=+0.148 (n=535)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.718 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.1607` → IC=+0.203 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1607 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `2.1022` → IC=+0.153 (n=519)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.1022 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.42` → IC=+0.141 (n=589)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.42 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `390.0` → IC=+0.141 (n=567)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 390.0 (IC base=+0.131)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.261 (n=241)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.193)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.206 (n=182)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.0977` → IC=+0.213 (n=183)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0977 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.207 (n=572)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.193)

- **PATRÓN** `ibs_20min` > `0.7028` → IC=+0.246 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7028 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.154` → IC=+0.208 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.154 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.948` → IC=+0.218 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.948 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` < `0.8422` → IC=+0.203 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8422 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` > `1.1614` → IC=+0.217 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1614 (IC base=+0.193)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3913` → IC=+0.242 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3913 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` > `2.405` → IC=+0.231 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.405 (IC base=+0.193)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `12330.8778` → IC=+0.201 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12330.8778 (IC base=+0.193)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.121 (n=452)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0061 (IC base=+0.085)

- **PATRÓN** `ibs_20min` < `0.0811` → IC=+0.153 (n=171)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.0811 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.2226` → IC=+0.127 (n=81)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.2226 (IC base=+0.085)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `ibs_20min` > `0.525` → IC=-0.159 (n=124)

  - _Acción_: SKIP cuando `ibs_20min` > 0.525
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=375)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.189 (n=178)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0089 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.162 (n=365)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 8.0 (IC base=+0.128)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.201 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7333 (IC base=+0.128)
...
- **PATRÓN** `volumen_regimen` < `1.0712` → IC=+0.144 (n=344)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0712 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `0.7359` → IC=+0.152 (n=349)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.7359 (IC base=+0.128)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4828` → IC=+0.143 (n=124)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4828 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `2.2214` → IC=+0.167 (n=169)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.2214 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.131 (n=426)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.02 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `3062.644` → IC=+0.197 (n=130)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 3062.644 (IC base=+0.128)

- **PATRÓN** `ibs_20min` < `0.525` → IC=+0.139 (n=375)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.525 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `1.8752` → IC=+0.140 (n=234)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.8752 (IC base=+0.065)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.207 (n=3239)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=10133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.4715` → IC=+0.216 (n=9710)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4715 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.9538` → IC=+0.207 (n=1404)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9538 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.606` → IC=+0.227 (n=4705)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.606 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8828` → IC=+0.165 (n=4327)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8828 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2399` → IC=+0.200 (n=1817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2399 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6061` → IC=+0.188 (n=3108)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6061 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2342.4972` → IC=+0.172 (n=6473)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.4972 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.195 (n=7341)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 87.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.187 (n=7756)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0092 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1468` → IC=+0.189 (n=3878)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.1468 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.237 (n=8815)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2455` → IC=+0.161 (n=5443)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2455 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.975` → IC=+0.202 (n=1238)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.975 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.72` → IC=+0.181 (n=8537)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.72 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7053` → IC=+0.161 (n=2673)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.7053 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.151 (n=2026)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2035 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.288` → IC=+0.245 (n=1157)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.288 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.6334` → IC=+0.193 (n=2689)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.6334 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.192 (n=5142)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.219 (n=554)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3514` → IC=+0.190 (n=1651)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.322 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.987` → IC=+0.312 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.987 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2734` → IC=+0.248 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2734 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.2444` → IC=+0.202 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2444 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=978)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.259 (n=1284)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.259)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.264 (n=1147)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.1282` → IC=+0.290 (n=564)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1282 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.271 (n=1155)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.3485` → IC=+0.291 (n=1128)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3485 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.577` → IC=+0.265 (n=1287)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.577 (IC base=+0.259)

- **PATRÓN** `volumen_pendiente_norm` > `0.2253` → IC=+0.292 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2253 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `1.8649` → IC=+0.275 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8649 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1966.1335` → IC=+0.274 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1966.1335 (IC base=+0.259)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0839` → IC=+0.160 (n=518)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0839 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1621)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3134` → IC=+0.201 (n=1553)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3134 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.3423` → IC=+0.196 (n=642)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.3423 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.173 (n=356)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.227` → IC=+0.151 (n=1395)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.227 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.63` → IC=+0.179 (n=518)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.63 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2681` → IC=+0.203 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2681 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.162 (n=1319)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7583` → IC=+0.154 (n=999)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7583 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `15642.4447` → IC=+0.152 (n=704)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 15642.4447 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `479.0` → IC=+0.157 (n=1430)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 479.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.163 (n=1347)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0057 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.32` → IC=+0.160 (n=1347)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.32 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.175 (n=451)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 18.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.2689` → IC=+0.234 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2689 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.6916` → IC=+0.154 (n=229)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.6916 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.1343` → IC=+0.166 (n=1209)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1343 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.186` → IC=+0.158 (n=644)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.186 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.1862` → IC=+0.161 (n=1347)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1862 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1532` → IC=+0.197 (n=364)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1532 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.4003` → IC=+0.160 (n=1249)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4003 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `2.0862` → IC=+0.164 (n=567)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.0862 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `424.0` → IC=+0.157 (n=1013)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 424.0 (IC base=+0.150)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.247 (n=524)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=1645)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=1601)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` > `0.6712` → IC=+0.257 (n=1403)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6712 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.811` → IC=+0.292 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.811 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` < `0.2118` → IC=+0.221 (n=1545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2118 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.8468` → IC=+0.244 (n=677)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8468 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=1110)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1955.02` → IC=+0.219 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1955.02 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.231 (n=1297)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 53.0 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.240 (n=1459)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.1647` → IC=+0.242 (n=642)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1647 (IC base=+0.234)
...
- **PATRÓN** `ibs_20min` < `0.36` → IC=+0.270 (n=1284)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.36 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.756` → IC=+0.279 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.756 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.3452` → IC=+0.298 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3452 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` < `1.7653` → IC=+0.235 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7653 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.1985` → IC=+0.237 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1985 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.246 (n=977)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1931.7443` → IC=+0.252 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1931.7443 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.231 (n=1259)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4371` → IC=+0.143 (n=1653)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4371 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1728)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.876` → IC=+0.259 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.876 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.5719` → IC=+0.170 (n=477)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.5719 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.153` → IC=+0.158 (n=686)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.153 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8772` → IC=+0.156 (n=1102)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8772 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2358` → IC=+0.213 (n=308)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2358 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.5208` → IC=+0.150 (n=703)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5208 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.7664` → IC=+0.146 (n=1065)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7664 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8147.128` → IC=+0.229 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8147.128 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.152 (n=516)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 80.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.155 (n=1355)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0076 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4451` → IC=+0.154 (n=1354)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6988` → IC=+0.182 (n=1354)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6988 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.8066` → IC=+0.141 (n=1568)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.8066 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.146` → IC=+0.177 (n=199)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 11.146 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.6969` → IC=+0.149 (n=596)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6969 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `1.1921` → IC=+0.140 (n=451)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.1921 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2861` → IC=+0.245 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2861 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.443` → IC=+0.151 (n=1281)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.443 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `10928.5899` → IC=+0.206 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10928.5899 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.144 (n=1276)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 179.0 (IC base=+0.137)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.137 (n=1095)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0081 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1685)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.190 (n=1645)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4706 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `1.0689` → IC=+0.204 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0689 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.442` → IC=+0.234 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.442 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.8919` → IC=+0.135 (n=1094)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8919 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1655)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2912.6118` → IC=+0.251 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2912.6118 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.130 (n=1258)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1314` → IC=+0.161 (n=538)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.1314 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=1665)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.202 (n=1616)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.218` → IC=+0.128 (n=1307)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.218 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.449` → IC=+0.123 (n=1562)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.449 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.7204` → IC=+0.152 (n=710)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7204 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.172 (n=251)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4547` → IC=+0.136 (n=484)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.4547 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.5228` → IC=+0.130 (n=484)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.5228 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2844.2019` → IC=+0.163 (n=538)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2844.2019 (IC base=+0.111)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.220 (n=1096)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1717)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.210)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.212 (n=1473)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.251 (n=1645)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5146 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.1997` → IC=+0.234 (n=980)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1997 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.164` → IC=+0.269 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.164 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` < `1.0716` → IC=+0.210 (n=1447)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0716 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.637` → IC=+0.217 (n=1644)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.637 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.2346` → IC=+0.252 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2346 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.5103` → IC=+0.238 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5103 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.219 (n=1722)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `2617.704` → IC=+0.223 (n=1096)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2617.704 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.224 (n=588)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0088 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.219 (n=588)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0256 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.208 (n=1240)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5188` → IC=+0.255 (n=1764)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5188 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.2041` → IC=+0.203 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2041 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.8921` → IC=+0.204 (n=1954)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8921 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.764` → IC=+0.267 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.764 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.236 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2332 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.265 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2827 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2045` → IC=+0.195 (n=1390)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2045 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4351` → IC=+0.198 (n=1580)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4351 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=1065)
...
- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.213 (n=936)
...
- **PATRÓN** `dist_vwap_pct` < `0.4942` → IC=+0.144 (n=1676)
...
- **PATRÓN** `volumen_regimen` > `0.9029` → IC=+0.163 (n=1198)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8861` → IC=+0.162 (n=1849)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8861 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3701.6132` → IC=+0.152 (n=1872)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3701.6132 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.195 (n=738)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0038 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4865` → IC=+0.156 (n=2212)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.4865 (IC base=+0.137)
...
- **PATRÓN** `ibs_20min` < `0.184` → IC=+0.167 (n=974)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.184 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.6849` → IC=+0.151 (n=431)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6849 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.4298` → IC=+0.130 (n=2180)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4298 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.22` → IC=+0.146 (n=2203)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.22 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2464` → IC=+0.142 (n=2110)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2464 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.145 (n=1027)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5356` → IC=+0.145 (n=961)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5356 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.8143` → IC=+0.143 (n=1456)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8143 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=2934)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `6989.8968` → IC=+0.151 (n=1976)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 6989.8968 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.156 (n=725)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0084 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.3914` → IC=+0.173 (n=637)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3914 (IC base=+0.141)
...
- **PATRÓN** `ibs_20min` < `0.7429` → IC=+0.143 (n=724)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.7429 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.103` → IC=+0.154 (n=723)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.103 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.6151` → IC=+0.169 (n=167)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.6151 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.3867` → IC=+0.143 (n=727)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.3867 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.738` → IC=+0.158 (n=118)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 10.738 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.281` → IC=+0.143 (n=656)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.281 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.101` → IC=+0.154 (n=637)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.101 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.7274` → IC=+0.145 (n=646)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.7274 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.0735` → IC=+0.169 (n=306)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.0735 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.1949` → IC=+0.152 (n=624)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.1949 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.7807` → IC=+0.154 (n=472)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7807 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `7600.4466` → IC=+0.165 (n=723)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 7600.4466 (IC base=+0.141)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `ibs_20min` > `0.9615` → IC=+0.222 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9615 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.191` → IC=+0.128 (n=146)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.191 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.177` → IC=+0.202 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.177 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` > `0.1583` → IC=+0.221 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1583 (IC base=+0.091)

- **PATRÓN** `libro_liquidez` > `3421.4081` → IC=+0.145 (n=187)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 3421.4081 (IC base=+0.091)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.141 (n=204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0069 (IC base=+0.108)

- **PATRÓN** `drift_60min` |x|≤ `0.3939` → IC=+0.159 (n=136)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.3939 (IC base=+0.108)
...
- **PATRÓN** `dist_vwap_pct` > `0.5986` → IC=+0.173 (n=99)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.5986 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.747` → IC=+0.133 (n=115)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 2.747 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` < `0.092` → IC=+0.165 (n=156)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.092 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `3255.1743` → IC=+0.141 (n=204)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 3255.1743 (IC base=+0.108)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.153 (n=197)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 62.0 (IC base=+0.108)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.128 (n=814)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` > `0.283` → IC=+0.196 (n=100)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.283 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.0918` → IC=+0.138 (n=592)
...
- **FILTRO** `ibs_20min` > `0.2308` → IC=-0.288 (n=31)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2308
  - _Potencial_: sin este filtro IC_bueno=+0.182 (n=61)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.124 (n=123)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0061 (IC base=+0.076)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.136 (n=196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 13.0 (IC base=+0.076)

- **PATRÓN** `ibs_20min` > `0.6757` → IC=+0.179 (n=222)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.6757 (IC base=+0.076)

- **PATRÓN** `dist_vwap_pct` > `0.198` → IC=+0.158 (n=144)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.198 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.345` → IC=+0.193 (n=99)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 5.345 (IC base=+0.076)

- **PATRÓN** `volumen_regimen` > `1.0643` → IC=+0.171 (n=83)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0643 (IC base=+0.076)

- **PATRÓN** `volumen_pendiente_norm` > `0.25` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.25 (IC base=+0.076)
...
- **PATRÓN** `ibs_20min` < `0.2` → IC=+0.121 (n=230)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.2 (IC base=+0.040)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.007` → IC=+0.133 (n=107)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 6.007 (IC base=+0.040)

- **PATRÓN** `libro_liquidez` > `3787.1326` → IC=+0.150 (n=118)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3787.1326 (IC base=+0.040)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.26` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.26 (IC base=+0.004)
...
- **PATRÓN** `elapsed_s` > `193.3` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `elapsed_s` > 193.3 (IC base=+0.196)

- **PATRÓN** `drift_15min` |x|≤ `2.0335` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 2.0335 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.6484` → IC=+0.300 (n=23)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6484 (IC base=+0.196)

- **PATRÓN** `ballena_activa_n` < `1573.0` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 1573.0 (IC base=+0.196)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.121 (n=671)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2905.3151` → IC=+0.171 (n=226)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2905.3151 (IC base=+0.105)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.122 (n=80)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=619)
...
- **FILTRO** `py_entrada` < `0.44` → IC=-0.143 (n=208)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=491)

- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=338)
...
- **FILTRO** `py_entrada` > `0.55` → IC=-0.148 (n=86)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=267)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.207 (n=73)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=196)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.127 (n=81)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=251)

- **PATRÓN** `py_entrada` < `0.56` → IC=+0.123 (n=173)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.56 (IC base=+0.027)

- **PATRÓN** `profundidad_ratio` > `100.0` → IC=+0.159 (n=83)

  - _Acción_: Kelly boost +0.79€ cuando `profundidad_ratio` > 100.0 (IC base=+0.027)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` < `0.55` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `py_entrada` < 0.55 (IC base=+0.087)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.250 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.59 (IC base=+0.154)

- **PATRÓN** `restante_min` > `3.99` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` > 3.99 (IC base=+0.154)
...
- **PATRÓN** `lag_apertura_s` < `60.77` → IC=+0.222 (n=16)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 60.77 (IC base=+0.154)

- **PATRÓN** `profundidad_ratio` > `107.3` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `profundidad_ratio` > 107.3 (IC base=+0.154)
...
- **FILTRO** `profundidad_ratio` < `60.7` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `profundidad_ratio` < 60.7
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=8)

### LIQUIDACIONES_DEPTH_FASE0#ETH#15min
- **FILTRO** `profundidad_ratio` < `49.3` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `profundidad_ratio` < 49.3
  - _Potencial_: sin este filtro IC_bueno=+0.136 (n=9)

### LIQUIDACIONES_DEPTH_FASE0#ETH#5min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.184 (n=17)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=9)

- **FILTRO** `restante_min` < `3.98` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `restante_min` < 3.98
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=10)

- **FILTRO** `lag_apertura_s` > `60.91` → IC=-0.237 (n=17)

  - _Acción_: SKIP cuando `lag_apertura_s` > 60.91
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=9)

### LIQUIDACIONES_DEPTH_FASE0#XRP#15min
- **FILTRO** `restante_min` > `10.52` → IC=-0.250 (n=18)
...
- **FILTRO** `lag_apertura_s` > `127.87` → IC=-0.206 (n=15)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=7409)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.172 (n=3220)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=10396)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.169 (n=3498)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=10601)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.212 (n=588)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1768)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.156 (n=626)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=1900)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.201 (n=584)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=1819)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=618)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1900)

- **FILTRO** `ibs_20min` > `0.282` → IC=-0.162 (n=629)

  - _Acción_: SKIP cuando `ibs_20min` > 0.282
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1889)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.173 (n=557)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1782)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.181 (n=619)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1899)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2719)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2887)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2893)
...
- **FILTRO** `libro_liquidez` < `17056.193` → IC=-0.134 (n=159)

  - _Acción_: SKIP cuando `libro_liquidez` < 17056.193
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=323)

- **FILTRO** `libro_liquidez` < `16939.3779` → IC=-0.138 (n=219)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9688)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=21599)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7627)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=23660)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.235 (n=7797)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=23490)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10622)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=20665)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9659)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=29505)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.180 (n=9740)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=29424)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.306 (n=1232)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3926)

- **FILTRO** `ibs_7min` < `0.7098` → IC=-0.251 (n=1702)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7098
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3456)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.184 (n=1192)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3966)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1667)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=5072)

- **FILTRO** `drift_7min_pct` |x|> `0.1118` → IC=-0.123 (n=2290)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1118
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4449)

- **FILTRO** `ibs_7min` > `0.7917` → IC=-0.205 (n=1684)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7917
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=5055)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1265)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4143)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1300)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4108)

- **FILTRO** `ibs_7min` < `0.7491` → IC=-0.191 (n=1352)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7491
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4056)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.171 (n=1350)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4058)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.254 (n=1361)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=4121)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.178 (n=1367)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4115)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1366)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4116)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1394)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=3498)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1200)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3692)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.258 (n=1220)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3672)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.218 (n=1149)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3743)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1656)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=5532)

- **FILTRO** `ibs_7min` > `0.7518` → IC=-0.177 (n=1796)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7518
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=5392)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1528)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3637)

- **FILTRO** `ibs_7min` < `0.742` → IC=-0.180 (n=1290)

  - _Acción_: SKIP cuando `ibs_7min` < 0.742
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3875)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.170 (n=1267)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3898)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.266 (n=1164)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4087)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.173 (n=1312)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3939)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.189 (n=1298)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3953)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=1314)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4155)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1358)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4111)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1785)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5664)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.272 (n=1235)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=3960)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1282)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3913)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.213 (n=1255)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3940)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1705)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=5350)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1057)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=945)
...
- **FILTRO** `sigma_h` < `0.0044` → IC=-0.310 (n=77)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0044
  - _Potencial_: sin este filtro IC_bueno=-0.300 (n=233)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=727)

- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=699)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=2837)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1443)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1451)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.222 (n=692)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.0744` → IC=+0.200 (n=672)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0744 (IC base=+0.185)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2128` → IC=+0.193 (n=509)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.2128 (IC base=+0.185)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1263` → IC=+0.227 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1263 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.194 (n=1426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 6.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.185 (n=1543)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 16.0 (IC base=+0.185)

- **PATRÓN** `ibs_15` > `0.6047` → IC=+0.263 (n=1527)
...
- **PATRÓN** `libro_liquidez` > `2979.0729` → IC=+0.191 (n=1018)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2979.0729 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.204 (n=839)
...
- **FILTRO** `dist_vwap_pct` > `0.6998` → IC=-0.150 (n=98)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=861)

### UPDOWN_GBM#SOL#60min
- **PATRÓN** `sigma_ewma_delta_pct` > `15.662` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.662 (IC base=+0.022)

### UPDOWN_GBM#XRP#15min
- **PATRÓN** `sigma_h` > `0.0178` → IC=+0.236 (n=271)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0178 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.0862` → IC=+0.207 (n=179)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0862 (IC base=+0.188)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0597` → IC=+0.194 (n=364)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.97€ cuando `delta_ratio_macro` |x|> 0.0597 (IC base=+0.188)
...
- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.285 (n=407)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.396` → IC=+0.189 (n=364)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 7.396 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `2910.1242` → IC=+0.275 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2910.1242 (IC base=+0.188)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.159 (n=456)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.217 (n=638)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1915)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.190 (n=857)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1696)

- **FILTRO** `libro_liquidez` < `3914.4454` → IC=-0.136 (n=1684)

  - _Acción_: SKIP cuando `libro_liquidez` < 3914.4454
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=869)
...
- **PATRÓN** `dist_vwap_pct` > `0.581` → IC=+0.178 (n=116)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.581 (IC base=-0.062)

- **PATRÓN** `dist_vwap_pct` < `0.2759` → IC=+0.178 (n=482)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.2759 (IC base=-0.062)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0756` → IC=+0.237 (n=1470)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0756 (IC base=-0.036)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1771` → IC=+0.235 (n=1060)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1771 (IC base=-0.036)

- **PATRÓN** `ibs_15` < `0.3462` → IC=+0.277 (n=1645)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3462 (IC base=-0.036)

- **PATRÓN** `dist_vwap_pct` > `0.6758` → IC=+0.284 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6758 (IC base=-0.036)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.218 (n=388)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=1168)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.228 (n=388)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1168)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.207 (n=983)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=573)

- **FILTRO** `sigma_ewma_delta_pct` > `19.521` → IC=-0.247 (n=279)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.521
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1277)

- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.167 (n=145)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_15` > `0.7413` → IC=+0.316 (n=166)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7413 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` > `0.102` → IC=+0.281 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.102 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` < `0.5415` → IC=+0.272 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5415 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.264 (n=218)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7799` → IC=+0.231 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7799 (IC base=+0.225)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2005` → IC=+0.253 (n=297)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3453` → IC=+0.264 (n=654)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3453 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.7586` → IC=+0.306 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7586 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.297` → IC=+0.250 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 20.297 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.153` → IC=+0.230 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.153 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3539.2271` → IC=+0.227 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3539.2271 (IC base=+0.225)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `sigma_h` > `0.0102` → IC=-0.229 (n=149)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0102
  - _Potencial_: sin este filtro IC_bueno=-0.142 (n=450)

- **FILTRO** `drift_60min` |x|> `0.1671` → IC=-0.217 (n=203)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.1671
  - _Potencial_: sin este filtro IC_bueno=-0.136 (n=396)

- **FILTRO** `drift_15min` |x|> `0.8849` → IC=-0.262 (n=149)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.8849
  - _Potencial_: sin este filtro IC_bueno=-0.131 (n=450)

- **PATRÓN** `ibs_15` > `0.8889` → IC=+0.342 (n=17)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8889 (IC base=-0.164)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0758` → IC=+0.220 (n=266)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0758 (IC base=-0.043)

- **PATRÓN** `ibs_15` < `0.35` → IC=+0.260 (n=298)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.35 (IC base=-0.043)

- **PATRÓN** `dist_vwap_pct` > `0.4766` → IC=+0.206 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4766 (IC base=-0.043)

- **PATRÓN** `dist_vwap_pct` < `0.1951` → IC=+0.217 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1951 (IC base=-0.043)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `sigma_h` > `0.0198` → IC=-0.261 (n=378)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0198
  - _Potencial_: sin este filtro IC_bueno=-0.133 (n=379)

- **FILTRO** `drift_15min` |x|> `1.2406` → IC=-0.258 (n=188)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.2406
  - _Potencial_: sin este filtro IC_bueno=-0.176 (n=569)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.265 (n=185)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.174 (n=572)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1541` → IC=+0.280 (n=148)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1541 (IC base=-0.046)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.103` → IC=+0.351 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.103 (IC base=-0.046)

- **PATRÓN** `ibs_15` < `0.3448` → IC=+0.309 (n=444)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3448 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` > `1.1587` → IC=+0.351 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1587 (IC base=-0.046)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.317 (n=583)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6047 sube el IC de +0.185 a +0.263 en UPDOWN_GBM#15min (n=1527). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.188 a +0.285 en UPDOWN_GBM#XRP#15min (n=407). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.046 a +0.159 en UPDOWN_GBM#XRP#15min (n=456). Ya aplicado como kelly_boost=+0.80€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6349 sube el IC de -0.062 a +0.268 en UPDOWN_GBM_15M_TARDIO (n=615). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3462 sube el IC de -0.036 a +0.277 en UPDOWN_GBM_15M_TARDIO (n=1645). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7413 sube el IC de +0.075 a +0.316 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=166). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3453 sube el IC de +0.225 a +0.264 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=654). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_YES, IBS > 0.8889 sube el IC de -0.164 a +0.342 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=17). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.043 a +0.260 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=298). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3448 sube el IC de -0.046 a +0.309 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=444). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1293 | +0.097 | +184.30€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1293 | +0.097 | +184.30€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 960 | +0.107 | +159.25€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 960 | +0.107 | +159.25€ | 2 | 7 |
...
| ✅ BALLENAS_TARDIAS | 24495 | -0.091 | -3134.33€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1432 | -0.047 | -222.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 23063 | -0.094 | -2911.73€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3590 | -0.086 | -589.26€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3590 | -0.086 | -589.26€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7067 | -0.023 | -644.10€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7067 | -0.023 | -644.10€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6545 | -0.097 | -445.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6545 | -0.097 | -445.27€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5487 | -0.183 | -1072.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5487 | -0.183 | -1072.05€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17293 | -0.029 | +4074.27€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4527 | -0.001 | +1821.06€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12766 | -0.040 | +2253.21€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 17293 | -0.029 | +4074.27€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4527 | -0.001 | +1821.06€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12766 | -0.040 | +2253.21€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 90043 | +0.112 | -4651.77€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13683 | +0.184 | -441.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 360 | -0.091 | -50.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 70104 | +0.099 | -3948.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5896 | +0.108 | -211.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11663 | +0.097 | -1012.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 44 | -0.174 | -3.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11604 | +0.099 | -997.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18211 | +0.131 | -384.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4292 | +0.202 | -147.71€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11619 | +0.111 | -187.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2258 | +0.106 | -27.09€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11702 | +0.089 | -1102.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 51 | -0.085 | -5.77€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11636 | +0.090 | -1085.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19173 | +0.123 | -409.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5287 | +0.175 | -80.85€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11742 | +0.104 | -267.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2132 | +0.098 | -52.80€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17616 | +0.114 | -1042.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3964 | +0.188 | -211.80€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 263 | -0.051 | +3.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11883 | +0.091 | -703.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1506 | +0.127 | -131.17€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11678 | +0.101 | -699.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 45 | -0.032 | +7.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11620 | +0.101 | -706.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14282 | +0.192 | -930.32€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14282 | +0.192 | -930.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3413 | +0.168 | -360.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3413 | +0.168 | -360.09€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1136 | +0.195 | -7.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1136 | +0.195 | -7.79€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3358 | +0.181 | -283.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3358 | +0.181 | -283.65€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3000 | +0.238 | -99.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3000 | +0.238 | -99.17€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3296 | +0.194 | -193.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3296 | +0.194 | -193.37€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 674 | +0.430 | -17.96€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 674 | +0.430 | -17.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 258 | +0.435 | -4.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 258 | +0.435 | -4.18€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 49134 | +0.197 | -3877.99€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 49134 | +0.197 | -3877.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8514 | +0.175 | -1000.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8514 | +0.175 | -1000.96€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7841 | +0.223 | -287.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7841 | +0.223 | -287.61€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8480 | +0.173 | -1019.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8480 | +0.173 | -1019.44€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 7938 | +0.218 | -314.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 7938 | +0.218 | -314.00€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8112 | +0.203 | -539.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8112 | +0.203 | -539.59€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8249 | +0.194 | -716.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8249 | +0.194 | -716.39€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 18505 | +0.118 | +145.70€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 18505 | +0.118 | +145.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9185 | +0.122 | +141.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9185 | +0.122 | +141.43€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9320 | +0.113 | +4.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9320 | +0.113 | +4.27€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1431 | +0.291 | -8.52€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1431 | +0.291 | -8.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 639 | +0.279 | -15.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 639 | +0.279 | -15.22€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 688 | +0.294 | +4.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 688 | +0.294 | +4.90€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1074 | +0.076 | -40.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 373 | +0.065 | -26.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 701 | +0.082 | -13.62€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 846 | +0.083 | -15.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 145 | +0.085 | -2.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 701 | +0.082 | -13.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#SOL | 167 | +0.027 | -27.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#SOL#240min | 167 | +0.027 | -27.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 34080 | +0.097 | -1068.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2823 | +0.090 | +20.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 31257 | +0.098 | -1088.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 19179 | +0.101 | -317.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2823 | +0.090 | +20.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 16356 | +0.103 | -338.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6346 | +0.107 | -42.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6346 | +0.107 | -42.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8555 | +0.080 | -707.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8555 | +0.080 | -707.41€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 24584 | +0.082 | +11573.72€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 24584 | +0.082 | +11573.72€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4098 | +0.193 | +2973.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4098 | +0.193 | +2973.59€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 3645 | +0.176 | +2509.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3645 | +0.176 | +2509.61€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 4252 | +0.200 | +3192.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4252 | +0.200 | +3192.52€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3645 | +0.017 | +735.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3645 | +0.017 | +735.08€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3542 | -0.032 | +815.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3542 | -0.032 | +815.30€ | 4 | 15 |
| ✅ GBM_LATE_15M#XRP | 5402 | -0.042 | +1347.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5402 | -0.042 | +1347.63€ | 4 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 25951 | +0.085 | +13531.36€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 25951 | +0.085 | +13531.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4913 | +0.016 | +2616.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4913 | +0.016 | +2616.25€ | 2 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5407 | +0.014 | +1099.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5407 | +0.014 | +1099.95€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3681 | +0.262 | +3704.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3681 | +0.262 | +3704.73€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4200 | +0.000 | +769.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4200 | +0.000 | +769.71€ | 2 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4230 | +0.027 | +1588.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4230 | +0.027 | +1588.59€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3520 | +0.275 | +3752.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3520 | +0.275 | +3752.14€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 19831 | +0.168 | +14767.59€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 19831 | +0.168 | +14767.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2985 | +0.206 | +2367.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2985 | +0.206 | +2367.39€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3162 | +0.148 | +2281.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3162 | +0.148 | +2281.68€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3105 | +0.208 | +2475.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3105 | +0.208 | +2475.41€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3326 | +0.133 | +2299.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3326 | +0.133 | +2299.47€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3690 | +0.116 | +2522.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3690 | +0.116 | +2522.41€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3563 | +0.204 | +2821.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3563 | +0.204 | +2821.22€ | 0 | 27 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4885 | +0.125 | +1996.14€ | 0 | 20 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4885 | +0.125 | +1996.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1395 | +0.120 | +612.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1395 | +0.120 | +612.24€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1411 | +0.141 | +609.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1411 | +0.141 | +609.15€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1019 | +0.098 | +303.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1019 | +0.098 | +303.13€ | 2 | 14 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 504 | +0.134 | +216.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 504 | +0.134 | +216.54€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 24697 | +0.174 | +18263.97€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 24697 | +0.174 | +18263.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3909 | +0.220 | +3283.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3909 | +0.220 | +3283.71€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3865 | +0.149 | +2529.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3865 | +0.149 | +2529.87€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4037 | +0.226 | +3484.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4037 | +0.226 | +3484.58€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 4007 | +0.136 | +2692.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 4007 | +0.136 | +2692.60€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4336 | +0.111 | +2701.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4336 | +0.111 | +2701.15€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4543 | +0.205 | +3572.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4543 | +0.205 | +3572.07€ | 0 | 24 |
| ✅ GBM_LATE_5M | 6693 | +0.144 | +3733.98€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 6693 | +0.144 | +3733.98€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB | 594 | +0.186 | +416.56€ | 0 | 0 |
| ✅ GBM_LATE_5M#BNB#5min | 594 | +0.186 | +416.56€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 1730 | +0.140 | +1096.01€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 1730 | +0.140 | +1096.01€ | 0 | 28 |
| ✅ GBM_LATE_5M#DOGE | 889 | +0.171 | +564.50€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 889 | +0.171 | +564.50€ | 0 | 22 |
| ✅ GBM_LATE_5M#ETH | 2111 | +0.147 | +1158.40€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 2111 | +0.147 | +1158.40€ | 0 | 32 |
| ✅ GBM_LATE_5M#SOL | 550 | +0.100 | +182.18€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 550 | +0.100 | +182.18€ | 0 | 14 |
| ✅ GBM_LATE_5M#XRP | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_60M | 1639 | +0.069 | +708.42€ | 2 | 14 |
| ✅ GBM_LATE_60M#60min | 1639 | +0.069 | +708.42€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 590 | +0.089 | +250.06€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 590 | +0.089 | +250.06€ | 0 | 14 |
| ✅ GBM_LATE_60M#ETH | 545 | +0.070 | +267.32€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 545 | +0.070 | +267.32€ | 2 | 16 |
| ✅ GBM_LATE_60M#SOL | 504 | +0.043 | +191.05€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 504 | +0.043 | +191.05€ | 1 | 13 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 673 | +0.063 | +125.98€ | 1 | 7 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 673 | +0.063 | +125.98€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC | 267 | +0.054 | +44.84€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 267 | +0.054 | +44.84€ | 2 | 7 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH | 191 | +0.029 | -4.29€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH#60min | 191 | +0.029 | -4.29€ | 2 | 7 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL | 215 | +0.104 | +85.44€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL#60min | 215 | +0.104 | +85.44€ | 2 | 12 |
| ✅ LATE_WINDOW_5MIN | 93 | +0.247 | +71.62€ | 0 | 9 |
| ✅ LATE_WINDOW_5MIN#5min | 93 | +0.247 | +71.62€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 93 | +0.247 | +71.62€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 93 | +0.247 | +71.62€ | 0 | 9 |
| ✅ LEADLAG_BTC_XRP_15M | 1850 | +0.096 | +489.62€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1850 | +0.096 | +489.62€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1850 | +0.096 | +489.62€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1850 | +0.096 | +489.62€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_60M | 1052 | -0.048 | -31.72€ | 6 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 1052 | -0.048 | -31.72€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC | 301 | -0.045 | -13.58€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC#60min | 301 | -0.045 | -13.58€ | 5 | 0 |
| ✅ LIQUIDACIONES_60M#ETH | 350 | -0.037 | -5.09€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#ETH#60min | 350 | -0.037 | -5.09€ | 3 | 0 |
| ✅ LIQUIDACIONES_60M#SOL | 401 | -0.061 | -13.05€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 401 | -0.061 | -13.05€ | 3 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 601 | -0.021 | +3.47€ | 2 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 277 | -0.030 | -3.90€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 324 | -0.012 | +7.38€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB | 18 | -0.045 | -1.03€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB#15min | 10 | +0.042 | +2.34€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB#5min | 8 | -0.080 | -3.36€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC | 150 | +0.092 | +39.67€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#15min | 68 | +0.071 | +14.38€ | 0 | 1 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#5min | 82 | +0.107 | +25.29€ | 0 | 6 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE | 100 | -0.059 | -7.85€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE#15min | 47 | -0.071 | -5.74€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE#5min | 53 | -0.045 | -2.11€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH | 96 | -0.092 | -14.45€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#15min | 45 | -0.096 | -7.28€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#5min | 51 | -0.085 | -7.17€ | 3 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL | 95 | +0.015 | +5.66€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#15min | 50 | -0.019 | +1.01€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#5min | 45 | +0.053 | +4.65€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP | 142 | -0.083 | -18.53€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#15min | 57 | -0.093 | -8.61€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#5min | 85 | -0.075 | -9.92€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M | 14273 | -0.011 | -204.65€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14273 | -0.011 | -204.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2990 | -0.020 | -57.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2990 | -0.020 | -57.84€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 27715 | -0.007 | +1225.57€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 27715 | -0.007 | +1225.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4882 | +0.016 | +593.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4882 | +0.016 | +593.44€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4318 | -0.028 | -52.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4318 | -0.028 | -52.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4921 | +0.014 | +438.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4921 | +0.014 | +438.16€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4098 | -0.052 | -140.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4098 | -0.052 | -140.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4639 | -0.011 | +181.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4639 | -0.011 | +181.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4857 | +0.007 | +206.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4857 | +0.007 | +206.03€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5707 | -0.055 | -124.67€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5707 | -0.055 | -124.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1203 | +0.000 | -15.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1203 | +0.000 | -15.55€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 1360 | -0.076 | -30.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 1360 | -0.076 | -30.70€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE | 43 | -0.122 | -5.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE#15min | 43 | -0.122 | -5.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 604 | -0.116 | -19.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 604 | -0.116 | -19.45€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1650 | -0.075 | -27.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1650 | -0.075 | -27.84€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 70451 | -0.073 | +1730.16€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 70451 | -0.073 | +1730.16€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 11897 | -0.079 | +699.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 11897 | -0.079 | +699.22€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 10890 | -0.093 | -471.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 10890 | -0.093 | -471.77€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 12080 | -0.067 | +677.29€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 12080 | -0.067 | +677.29€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10416 | -0.092 | -140.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10416 | -0.092 | -140.59€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 12918 | -0.048 | +375.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 12918 | -0.048 | +375.45€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 12250 | -0.062 | +590.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 12250 | -0.062 | +590.57€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7336 | -0.023 | -109.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7336 | -0.023 | -109.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 996 | -0.017 | -19.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 996 | -0.017 | -19.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1644 | -0.025 | -0.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1644 | -0.025 | -0.69€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 1003 | -0.020 | -31.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 1003 | -0.020 | -31.30€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 1926 | -0.018 | -16.92€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 1926 | -0.018 | -16.92€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 1029 | -0.040 | -17.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 1029 | -0.040 | -17.53€ | 3 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO | 434 | -0.060 | -50.33€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#5min | 434 | -0.060 | -50.33€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO#ETH | 124 | -0.087 | -26.25€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#ETH#5min | 124 | -0.087 | -26.25€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#SOL | 87 | +0.017 | +4.73€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#SOL#5min | 87 | +0.017 | +4.73€ | 0 | 0 |
...
| ✅ PRICE_TARGET_GBM#SOL#atexpiry | 83 | -0.029 | +11.72€ | 1 | 0 |
...
| ✅ PRICE_TARGET_GBM_FADE#SOL#atexpiry | 146 | -0.196 | +12.84€ | 4 | 0 |
...
| ✅ RESOLUTION_SNIPER#SOL#sniper | 177 | +0.483 | +161.66€ | 0 | 10 |
| ✅ RESOLUTION_SNIPER#sniper | 279 | +0.415 | +215.62€ | 0 | 0 |
| 🚫 SMART_FLOW_1H | 29 | -0.274 | -13.82€ | 0 | 0 |
| ✅ SMART_FLOW_1H#BTC | 12 | -0.086 | -3.30€ | 0 | 0 |
| ✅ STREAK_FADE_15M | 487 | +0.034 | +14.29€ | 2 | 2 |
| ✅ STREAK_FADE_15M#15min | 487 | +0.034 | +14.29€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 2708 | -0.022 | -112.16€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2708 | -0.022 | -112.16€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1183 | -0.021 | -46.96€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1183 | -0.021 | -46.96€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 7586 | +0.022 | +106.92€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7586 | +0.022 | +106.92€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2127 | +0.020 | +19.86€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2127 | +0.020 | +19.86€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1687 | +0.035 | +50.34€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1687 | +0.035 | +50.34€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2304 | +0.010 | -0.29€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2304 | +0.010 | -0.29€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1468 | +0.029 | +37.01€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1468 | +0.029 | +37.01€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7113 | +0.011 | -50.43€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7113 | +0.011 | -50.43€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2856 | +0.014 | -13.12€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2856 | +0.014 | -13.12€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2782 | +0.011 | -18.31€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2782 | +0.011 | -18.31€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1475 | +0.002 | -19.00€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1475 | +0.002 | -19.00€ | 2 | 0 |
| ✅ UPDOWN_GBM | 35290 | +0.030 | +2083.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 9526 | +0.066 | +1689.35€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 1307 | +0.004 | +5.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 22182 | +0.020 | +366.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2142 | +0.008 | +22.33€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3530 | +0.068 | +380.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 594 | +0.151 | +234.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 29 | -0.016 | -0.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2907 | +0.051 | +145.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6543 | +0.035 | +435.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1208 | +0.083 | +262.07€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 356 | +0.020 | +7.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 3966 | +0.031 | +148.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 962 | +0.004 | +16.55€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 51 | -0.104 | +0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 4108 | +0.039 | +239.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 552 | +0.139 | +196.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 25 | -0.018 | -1.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3531 | +0.024 | +44.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 7511 | +0.017 | +276.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2468 | +0.045 | +266.11€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 344 | +0.006 | +7.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3925 | +0.005 | +2.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 731 | +0.005 | -2.66€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 43 | -0.144 | +3.56€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8485 | +0.016 | +222.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2352 | +0.025 | +161.36€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 338 | -0.006 | -3.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5309 | +0.014 | +58.39€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 449 | +0.021 | +8.44€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 37 | -0.167 | -2.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5111 | +0.035 | +531.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2352 | +0.079 | +568.19€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 215 | -0.002 | -2.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2544 | -0.003 | -33.42€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11445 | -0.042 | +2343.20€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11445 | -0.042 | +2343.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 702 | -0.041 | +330.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 702 | -0.041 | +330.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2135 | -0.123 | +19.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2135 | -0.123 | +19.97€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 338 | +0.176 | +220.54€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 338 | +0.176 | +220.54€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1261 | +0.202 | +723.64€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1261 | +0.202 | +723.64€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3496 | -0.064 | +536.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3496 | -0.064 | +536.73€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3513 | -0.079 | +511.50€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3513 | -0.079 | +511.50€ | 3 | 4 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.059) — sin ventaja clara. oversold(IBS<0.3): IC=+0.046 n=12471 | neutral: IC=+0.028 n=13336 | overbought(IBS>0.7): IC=+0.087 n=12583
  - _Datos_: n=39759 IC=+0.054 PNL=+4739.11€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 521 celda(s) pasan gate riguroso completo de 2198 evaluadas (n>=40) y 3192 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.025 < 0.08 — monitorear
  - _Datos_: n=2352 IC=+0.025 PNL=+161.36€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 35228 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 0/50 ops con delta_ratio feature | SOL: 168 ops con delta_ratio

**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40 en cualquier subtipo 60min
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=731/40 IC=+0.005 PNL=-2.66€ | BTC#60min: n=962/40 IC=+0.004 PNL=+16.55€ | SOL#60min: n=449/40 IC=+0.021 PNL=+8.44€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.051 n=322807 | tras_1loss IC=+0.077 n=251416 | tras_2loss IC=+0.046 n=106302/40 | gap=+0.005 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=+0.018 n=4067 | contrario_BTC IC=+0.021 n=3601/40 | gap=+0.003 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=33939 IC=+0.030 PNL=+1983.20€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=33939 IC=+0.030 PNL=+1983.20€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1526 IC=+0.014 PNL=+11.62€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1526 IC=+0.014 PNL=+11.62€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=616 IC=-0.008 PNL=+10.71€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=616 IC=-0.008 PNL=+10.71€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.185 > 0.1 con n=2035 PNL=+1263.36€
  - _Datos_: n=2035 IC=+0.185 PNL=+1263.36€
...
**〰️ H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: n=972 IC=+0.045 PNL=+71.62€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=972 IC=+0.045 PNL=+71.62€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1208 IC=+0.083 PNL=+262.07€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1208 IC=+0.083 PNL=+262.07€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=5455 IC=+0.075 PNL=+1217.11€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=5455 IC=+0.075 PNL=+1217.11€
...
**〰️ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  ...
  - _Estado_: n=247 IC=-0.022 PNL=+8.18€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=247 IC=-0.022 PNL=+8.18€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=5625 IC=-0.004 PNL=-14.20€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=5625 IC=-0.004 PNL=-14.20€
...
**🔶 H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.247 n=93) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=93 IC=+0.247 PNL=+71.62€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=6811 IC=+0.033 PNL=+388.45€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=6811 IC=+0.033 PNL=+388.45€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=2124 IC=+0.051 PNL=+244.70€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2124 IC=+0.051 PNL=+244.70€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.134 > 0.08 con n=571 PNL=+127.40€
  - _Datos_: n=571 IC=+0.134 PNL=+127.40€

**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  - _Hipótesis_: Lado negativo de H-CUSTOM-CROSS-WINDOW-SPREAD-POS (mercado propio más barato que el relacionado). Mismo feature cross_window_spread, mismo origen (artículo sobre bots de Polymarket), umbral simétrico.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma con n≥40 → considerar boost/filtro por cross_window_spread
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.123 > 0.08 con n=438 PNL=+209.00€
  - _Datos_: n=438 IC=+0.123 PNL=+209.00€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=5219 IC=+0.036 PNL=+369.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=5219 IC=+0.036 PNL=+369.38€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=12230 IC=+0.055 PNL=+1503.47€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=12230 IC=+0.055 PNL=+1503.47€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.200 > 0.1 con n=3263 PNL=+1766.76€
  - _Datos_: n=3263 IC=+0.200 PNL=+1766.76€
...
**🔴 H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.156 < -0.1 con n=222 PNL=+19.81€
  - _Datos_: n=222 IC=-0.156 PNL=+19.81€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1810 IC=+0.046 PNL=+188.36€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1810 IC=+0.046 PNL=+188.36€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=17154 IC=-0.137 PNL=+1183.47€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=17154 IC=-0.137 PNL=+1183.47€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1861 IC=+0.138 PNL=+1003.28€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1861 IC=+0.138 PNL=+1003.28€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.187 > 0.08 con n=1996 PNL=+1250.73€
  - _Datos_: n=1996 IC=+0.187 PNL=+1250.73€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.198 > 0.08 con n=468 PNL=+223.17€
  - _Datos_: n=468 IC=+0.198 PNL=+223.17€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.239 < -0.1 con n=1680 PNL=-191.90€
  - _Datos_: n=1680 IC=-0.239 PNL=-191.90€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=5089 IC=+0.162 PNL=+3274.99€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=5089 IC=+0.162 PNL=+3274.99€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=1923 IC=+0.059 PNL=+505.73€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1923 IC=+0.059 PNL=+505.73€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.179 > 0.08 con n=1742 PNL=+1194.18€
  - _Datos_: n=1742 IC=+0.179 PNL=+1194.18€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=2836 IC=-0.032 PNL=+732.60€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2836 IC=-0.032 PNL=+732.60€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.086 > 0.08 con n=539 PNL=-49.88€
  - _Datos_: n=539 IC=+0.086 PNL=-49.88€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.233 > 0.08 con n=3206 PNL=-304.35€
  - _Datos_: n=3206 IC=+0.233 PNL=-304.35€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.087 n=949) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=949 IC=+0.087 PNL=+210.60€
...
**🟡 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.342 > 0.08 con n=244 PNL=+92.12€
  - _Datos_: n=244 IC=+0.342 PNL=+92.12€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8514 IC=+0.175 PNL=-1000.96€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8514 IC=+0.175 PNL=-1000.96€
