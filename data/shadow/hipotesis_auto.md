# Hipótesis automáticas — 2026-08-26 11:18 UTC
_Generado por shadow_postmortem.py sobre 161136 resoluciones (PNL=+11535.86€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.79` → IC=-0.277 (n=2234)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.79
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=6705)
...
- **FILTRO** `restante_s_al_confirmar` < `157.54` → IC=-0.201 (n=609)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1828)
...
- **FILTRO** `restante_s_al_confirmar` < `156.39` → IC=-0.343 (n=508)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.115 (n=1034)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.167 (n=1317)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.241 (n=1622)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.233)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.235 (n=1207)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=4314)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.203 (n=776)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=2162)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.2153` → IC=+0.128 (n=1448)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.494` → IC=+0.350 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.494 (IC base=+0.347)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=2175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=5243)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.285 (n=1795)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=5623)

- **FILTRO** `ibs_7min` < `0.7355` → IC=-0.232 (n=1854)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7355
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=5564)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.173 (n=2460)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=4958)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.230 (n=2110)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=6998)

- **FILTRO** `ibs_7min` > `0.7244` → IC=-0.171 (n=2276)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7244
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=6832)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.227 (n=379)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1139)

- **FILTRO** `ballena_activa_n` > `123.0` → IC=-0.173 (n=377)

  - _Acción_: SKIP cuando `ballena_activa_n` > 123.0
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1141)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.266 (n=344)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1251)

- **FILTRO** `ibs_7min` > `0.8192` → IC=-0.188 (n=398)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8192
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1197)
...
- **FILTRO** `hora_utc` > `15.0` → IC=-0.126 (n=410)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=841)
...
- **FILTRO** `ibs_7min` > `0.1818` → IC=-0.157 (n=424)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=827)

- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.209 (n=307)

  - _Acción_: SKIP cuando `ballena_activa_n` > 38.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=944)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.188 (n=395)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1276)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.277 (n=307)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1221)

- **FILTRO** `ibs_7min` > `0.8387` → IC=-0.161 (n=381)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8387
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1147)
...
| ✅ BALLENAS_TARDIAS | 6482 | -0.097 | -864.70€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 669 | -0.089 | -118.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5813 | -0.098 | -746.41€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1059 | +0.024 | -110.73€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1059 | +0.024 | -110.73€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2128 | -0.072 | -100.15€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2128 | -0.072 | -100.15€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1542 | -0.190 | -342.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1542 | -0.190 | -342.06€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30126 | +0.114 | -1959.15€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5633 | +0.187 | -185.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21261 | +0.095 | -1689.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3125 | +0.121 | -34.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3569 | +0.064 | -606.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3544 | +0.065 | -602.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6256 | +0.134 | -127.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1588 | +0.198 | -84.76€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3538 | +0.110 | -77.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1088 | +0.130 | +57.73€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3577 | +0.077 | -474.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 20 | +0.045 | +2.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3556 | +0.078 | -475.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6712 | +0.130 | -66.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2048 | +0.170 | -6.23€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min |