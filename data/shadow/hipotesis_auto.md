# Hipótesis automáticas — 2026-08-08 11:07 UTC
_Generado por shadow_postmortem.py sobre 92000 resoluciones (PNL=+13869.54€)_
...
- **PATRÓN** `py_entrada` < `0.39` → IC=+0.199 (n=164)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.39 (IC base=+0.128)

- **PATRÓN** `restante_min` < `4.55` → IC=+0.172 (n=239)

  - _Acción_: Kelly boost +0.86€ cuando `restante_min` < 4.55 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.145 (n=367)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 6.0 (IC base=+0.128)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.143 (n=320)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 15.0 (IC base=+0.128)

- **PATRÓN** `profundidad_ratio_no` > `11.2` → IC=+0.152 (n=162)

  - _Acción_: Kelly boost +0.76€ cuando `profundidad_ratio_no` > 11.2 (IC base=+0.128)
...
- **PATRÓN** `restante_min` < `4.78` → IC=+0.152 (n=159)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` < 4.78 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.125 (n=166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 8.0 (IC base=+0.113)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.130 (n=163)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
| ✅ FAVORITO_CONFIRMADO | 24617 | +0.119 | -583.19€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6081 | +0.195 | -93.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 441 | +0.051 | -39.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 16238 | +0.089 | -503.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1857 | +0.139 | +53.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2588 | +0.087 | -123.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 11 | +0.021 | -0.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2572 | +0.087 | -125.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5332 | +0.129 | -86.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1909 | +0.183 | -90.42€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 141 | +0.052 | -15.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2579 | +0.088 | -45.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 703 | +0.148 | +65.50€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2587 | +0.076 | -152.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 15 | +0.243 | +10.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2571 | +0.074 | -164.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 5767 | +0.135 | -26.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2035 | +0.197 | +5.86€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 146 | -0.013 | -31.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2983 | +0.101 | -16.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 603 | +0.131 | +15.14€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5727 | +0.136 | -160.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2072 | +0.205 | -17.80€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 146 | +0.108 | +4.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2958 | +0.089 | -120.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 551 | +0.135 | -27.01€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2616 | +0.095 | -33.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 39 | +0.134 | -2.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2575 | +0.095 | -30.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 2242 | +0.201 | -157.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 2242 | +0.201 | -157.67€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 333 | +0.160 | -40.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 333 | +0.160 | -40.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 114 | +0.422 | -2.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 114 | +0.422 | -2.61€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 10763 | +0.195 | -825.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 10763 | +0.195 | -825.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1926 | +0.157 | -264.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1926 | +0.157 | -264.25€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1863 | +0.180 | -201.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1863 | +0.180 | -201.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 1730 | +0.215 | -68.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 1730 | +0.215 | -68.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 1752 | +0.215 | -80.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 1752 | +0.215 | -80.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 1791 | +0.191 | -161.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 1791 | +0.191 | -161.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 476 | +0.128 | +10.41€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 476 | +0.128 | +10.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 238 | +0.113 | -3.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 238 | +0.113 | -3.68€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 299 | +0.271 | -19.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 299 | +0.271 | -19.18€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 136 | +0.268 | -8.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 136 | +0.268 | -8.56€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 113 | +0.361 | -14.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 113 | +0.361 | -14.64€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 613 | +0.303 | +0.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 613 | +0.303 | +0.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 613 | +0.303 | +0.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 613 | +0.303 | +0.38€ | 0 | 0 |
| ✅ GBM_LATE_15M | 12728 | +0.102 | +4261.57€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 12728 | +0.102 | +4261.57€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 2836 | +0.072 | +845.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2836 | +0.072 | +845.44€ | 1 | 2 |
| ✅ GBM_LATE_15M#XRP | 3235 | +0.134 | +1587.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 3235 | +0.134 | +1587.67€ | 0 | 10 |
...
| ✅ LIQUIDACIONES_60M | 81 | +0.018 | -0.74€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 81 | +0.018 | -0.74€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_60M#SOL | 28 | +0.067 | +1.54€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 28 | +0.067 | +1.54€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M | 403 | +0.018 | -0.75€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 403 | +0.018 | -0.75€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M#SOL | 127 | -0.050 | -8.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 127 | -0.050 | -8.81€ | 2 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.128 n=56144 | tras_1loss IC=+0.086 n=35602 | tras_2loss IC=+0.053 n=14695/40 | gap=+0.075 (umbral 0.05)
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.08 con n=1282 PNL=+637.57€
  - _Datos_: n=1282 IC=+0.125 PNL=+637.57€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.264 > 0.08 con n=795 PNL=-31.43€
  - _Datos_: n=795 IC=+0.264 PNL=-31.43€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1926 IC=+0.157 PNL=-264.25€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1926 IC=+0.157 PNL=-264.25€
