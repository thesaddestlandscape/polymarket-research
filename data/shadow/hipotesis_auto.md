# Hipótesis automáticas — 2026-08-28 19:43 UTC
_Generado por shadow_postmortem.py sobre 192107 resoluciones (PNL=+14325.61€)_
...
- **FILTRO** `py_entrada` < `0.7` → IC=-0.174 (n=84)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.272 (n=265)
...
- **PATRÓN** `n_ballena_banda` > `17.0` → IC=+0.175 (n=263)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `n_ballena_banda` > 17.0 (IC base=+0.164)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8175` → IC=+0.292 (n=176)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8175 (IC base=+0.164)

- **PATRÓN** `banda_z` > `11.411` → IC=+0.289 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.411 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.188 (n=235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 7.0 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.188 (n=274)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.01 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3111.6433` → IC=+0.244 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3111.6433 (IC base=+0.164)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.45` → IC=-0.287 (n=2686)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.45
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=8058)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `132.48` → IC=-0.274 (n=338)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.48
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1015)
...
- **FILTRO** `restante_s_al_confirmar` < `113.22` → IC=-0.391 (n=345)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 113.22
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1038)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `161.45` → IC=-0.158 (n=722)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 161.45
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2166)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `140.79` → IC=-0.310 (n=623)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.79
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=1872)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `155.51` → IC=-0.352 (n=615)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 155.51
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1249)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.189 (n=5829)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1675)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2376.0723` → IC=+0.172 (n=1614)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2376.0723 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.147 (n=4013)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1309)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.278 (n=506)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.275 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `2874.5416` → IC=+0.284 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2874.5416 (IC base=+0.276)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.196 (n=979)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.261 (n=232)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.232 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `1936.8295` → IC=+0.254 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1936.8295 (IC base=+0.225)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.194 (n=4850)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.200 (n=2298)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.187)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.169 (n=843)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.72` → IC=+0.176 (n=1053)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.172 (n=1173)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.194 (n=1187)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.195 (n=12256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `4.23` → IC=+0.161 (n=1651)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 4.23 (IC base=+0.134)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.208 (n=902)
...
- **PATRÓN** `restante_min` > `4.88` → IC=+0.156 (n=1136)
...
- **PATRÓN** `lag_apertura_s` < `7.08` → IC=+0.160 (n=1085)

  - _Acción_: Kelly boost +0.80€ cuando `lag_apertura_s` < 7.08 (IC base=+0.140)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.198 (n=881)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.38 (IC base=+0.128)

- **PATRÓN** `restante_min` < `4.43` → IC=+0.128 (n=1100)

  - _Acción_: Kelly boost +0.64€ cuando `restante_min` < 4.43 (IC base=+0.128)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.168 (n=923)

  - _Acción_: Kelly boost +0.84€ cuando `restante_min` > 4.94 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=2608)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9499` → IC=+0.210 (n=833)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.262` → IC=+0.155 (n=997)
...
- **PATRÓN** `ibs_20min` < `0.1163` → IC=+0.149 (n=1275)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.1163 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.1358` → IC=+0.147 (n=794)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.1358 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.6207` → IC=+0.155 (n=276)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6207 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `1.0603` → IC=+0.137 (n=375)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 1.0603 (IC base=+0.031)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9153` → IC=+0.246 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9153 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `46.0` → IC=+0.237 (n=325)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.262 (n=309)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.288 (n=337)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0775` → IC=+0.169 (n=161)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0775 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=455)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4406` → IC=+0.177 (n=425)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.4406 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.1415` → IC=+0.169 (n=415)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1415 (IC base=+0.143)
...
- **PATRÓN** `volumen_regimen` < `0.6237` → IC=+0.181 (n=161)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6237 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.1594` → IC=+0.209 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1594 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.7604` → IC=+0.167 (n=253)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.7604 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.4117` → IC=+0.168 (n=378)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.4117 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.144 (n=624)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `13835.1304` → IC=+0.192 (n=219)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 13835.1304 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `222.0` → IC=+0.167 (n=97)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 222.0 (IC base=+0.143)
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.275 (n=380)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.4646` → IC=+0.270 (n=380)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4646 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.270 (n=259)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.301 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5208 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.01` → IC=+0.321 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.01 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.613` → IC=+0.262 (n=410)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5785` → IC=+0.259 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5785 (IC base=+0.258)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.281 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.258)

- **PATRÓN** `ballena_activa_n` < `52.0` → IC=+0.242 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 52.0 (IC base=+0.258)
...
- **PATRÓN** `volumen_regimen` < `0.5962` → IC=+0.324 (n=15)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5962 (IC base=-0.044)
...
- **FILTRO** `sigma_ewma_delta_pct` > `5.027` → IC=-0.154 (n=293)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1094)
...
- **FILTRO** `ibs_20min` > `0.7881` → IC=-0.171 (n=311)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=937)

- **FILTRO** `sigma_ewma_delta_pct` > `6.719` → IC=-0.149 (n=203)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.719
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1045)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.137 (n=1419)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1151` → IC=+0.180 (n=1411)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4787` → IC=+0.205 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4787 (IC base=+0.054)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.277 (n=895)
...
- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.267 (n=581)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 60.0 (IC base=+0.041)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2441` → IC=-0.167 (n=217)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.349` → IC=+0.169 (n=125)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.349 (IC base=-0.003)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.339 (n=252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.330)

- **PATRÓN** `drift_60min` |x|≤ `0.257` → IC=+0.339 (n=191)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.257 (IC base=+0.330)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.366 (n=192)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.330)

- **PATRÓN** `ibs_20min` < `0.3296` → IC=+0.347 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3296 (IC base=+0.330)

- **PATRÓN** `ibs_20min` > `0.1304` → IC=+0.335 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1304 (IC base=+0.330)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.492` → IC=+0.339 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.492 (IC base=+0.330)

- **PATRÓN** `volumen_pendiente_norm` > `0.3635` → IC=+0.412 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3635 (IC base=+0.330)

- **PATRÓN** `volumen_spike_ratio` < `1.7067` → IC=+0.336 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7067 (IC base=+0.330)

- **PATRÓN** `volumen_spike_ratio` > `2.5018` → IC=+0.340 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5018 (IC base=+0.330)

- **PATRÓN** `libro_liquidez` > `1873.0784` → IC=+0.378 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1873.0784 (IC base=+0.330)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.315 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.330)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.241 (n=226)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `1.3817` → IC=+0.346 (n=134)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3817 (IC base=+0.227)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0807` → IC=+0.232 (n=510)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8002` → IC=+0.245 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8002 (IC base=+0.227)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.237 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.227)

- **PATRÓN** `libro_liquidez` > `2452.7664` → IC=+0.236 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2452.7664 (IC base=+0.227)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.203 (n=1644)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.0825` → IC=+0.215 (n=819)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0825 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.212 (n=1127)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.187)

- **PATRÓN** `ibs_20min` < `0.4105` → IC=+0.242 (n=2455)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4105 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.2218` → IC=+0.183 (n=2000)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.2218 (IC base=+0.187)
...
- **PATRÓN** `volumen_regimen` < `1.1737` → IC=+0.172 (n=1942)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.1737 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` > `0.6207` → IC=+0.170 (n=1943)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.6207 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` > `0.2924` → IC=+0.259 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2924 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` < `1.5799` → IC=+0.179 (n=810)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.5799 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` > `2.6614` → IC=+0.213 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6614 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.197 (n=1245)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 122.0 (IC base=+0.187)
...
- **PATRÓN** `ibs_20min` < `0.3945` → IC=+0.286 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3945 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.436` → IC=+0.274 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.436 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.178` → IC=+0.293 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.178 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` < `1.9491` → IC=+0.278 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9491 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `2.8655` → IC=+0.297 (n=57)
...
- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.244 (n=127)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.173 (n=487)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.006 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.2337` → IC=+0.174 (n=428)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.2337 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=447)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.4271` → IC=+0.195 (n=487)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.4271 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1622` → IC=+0.176 (n=483)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1622 (IC base=+0.151)
...
- **PATRÓN** `volumen_regimen` < `0.637` → IC=+0.215 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.637 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1673` → IC=+0.226 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1673 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.5679` → IC=+0.161 (n=379)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.5679 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4105` → IC=+0.150 (n=378)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4105 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `14744.132` → IC=+0.189 (n=162)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 14744.132 (IC base=+0.151)
...
- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.293 (n=278)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0102 (IC base=+0.266)

- **PATRÓN** `drift_60min` |x|≤ `0.1065` → IC=+0.342 (n=93)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1065 (IC base=+0.266)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.307 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.266)

- **PATRÓN** `ibs_20min` < `0.3077` → IC=+0.323 (n=247)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3709` → IC=+0.443 (n=33)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3709 (IC base=+0.266)

- **PATRÓN** `volumen_spike_ratio` > `3.1717` → IC=+0.289 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1717 (IC base=+0.266)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.159 (n=467)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3831 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.174 (n=237)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3583` → IC=+0.209 (n=411)
...
- **PATRÓN** `volumen_regimen` < `1.1693` → IC=+0.155 (n=467)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1693 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.6086` → IC=+0.152 (n=467)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6086 (IC base=+0.141)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9025` → IC=+0.174 (n=240)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5362` → IC=+0.147 (n=120)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.5362 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `10903.0281` → IC=+0.158 (n=156)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 10903.0281 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.143 (n=124)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 123.0 (IC base=+0.141)
...
- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.200 (n=148)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.222 (n=156)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.4085` → IC=+0.238 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4085 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.7528` → IC=+0.146 (n=94)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.7528 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.23` → IC=+0.156 (n=425)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.23 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.22` → IC=+0.204 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.22 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1603` → IC=+0.151 (n=445)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1603 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.8469` → IC=+0.171 (n=296)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8469 (IC base=+0.140)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4538` → IC=+0.154 (n=105)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4538 (IC base=+0.140)
...
- **PATRÓN** `libro_liquidez` > `2124.31` → IC=+0.198 (n=296)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2124.31 (IC base=+0.140)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6757` → IC=+0.234 (n=547)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6757 (IC base=+0.223)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.234 (n=265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3824` → IC=+0.263 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3824 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.223` → IC=+0.288 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.223 (IC base=+0.223)

- **PATRÓN** `volumen_regimen` > `0.6925` → IC=+0.245 (n=488)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7123` → IC=+0.259 (n=139)
...
- **PATRÓN** `ibs_20min` < `0.3128` → IC=+0.147 (n=327)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.3128 (IC base=+0.058)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.777` → IC=+0.155 (n=111)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.777 (IC base=+0.058)
...
- **PATRÓN** `ibs_20min` < `0.0488` → IC=+0.260 (n=23)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.217 (n=1924)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.4857` → IC=+0.201 (n=2880)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4857 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.196 (n=1060)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5624` → IC=+0.247 (n=2880)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5624 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` < `0.4299` → IC=+0.182 (n=2128)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.4299 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.426` → IC=+0.208 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.426 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.657` → IC=+0.195 (n=2703)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 2.657 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` < `0.6199` → IC=+0.186 (n=711)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6199 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` > `1.204` → IC=+0.176 (n=711)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.204 (IC base=+0.191)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3099` → IC=+0.208 (n=989)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3099 (IC base=+0.191)

- **PATRÓN** `ballena_activa_n` < `174.0` → IC=+0.172 (n=1752)
...
- **PATRÓN** `ibs_20min` < `0.562` → IC=+0.312 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.562 (IC base=+0.270)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.116` → IC=+0.290 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.116 (IC base=+0.270)

- **PATRÓN** `volumen_pendiente_norm` > `0.3039` → IC=+0.321 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3039 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` > `2.7667` → IC=+0.323 (n=77)
...
- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.257 (n=150)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.175 (n=478)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0061 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.2812` → IC=+0.178 (n=421)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2812 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=448)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3927` → IC=+0.214 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3927 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.1514` → IC=+0.181 (n=425)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1514 (IC base=+0.167)
...
- **PATRÓN** `volumen_regimen` > `0.8371` → IC=+0.167 (n=319)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.8371 (IC base=+0.167)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7532` → IC=+0.193 (n=255)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.7532 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.5117` → IC=+0.183 (n=342)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.5117 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.167 (n=619)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `12924.6533` → IC=+0.180 (n=217)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 12924.6533 (IC base=+0.167)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1285` → IC=+0.253 (n=184)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1285 (IC base=+0.245)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.248 (n=284)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5541` → IC=+0.311 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5541 (IC base=+0.245)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.065` → IC=+0.276 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.065 (IC base=+0.245)

- **PATRÓN** `volumen_pendiente_norm` > `0.3655` → IC=+0.330 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3655 (IC base=+0.245)

- **PATRÓN** `volumen_spike_ratio` < `1.7665` → IC=+0.250 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7665 (IC base=+0.245)

- **PATRÓN** `volumen_spike_ratio` > `2.408` → IC=+0.217 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.408 (IC base=+0.245)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.272 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.245)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.198 (n=187)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 60.0 (IC base=+0.245)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5115` → IC=+0.163 (n=431)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.5115 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` < `0.295` → IC=+0.217 (n=288)
...
- **PATRÓN** `dist_vwap_pct` < `0.3924` → IC=+0.148 (n=430)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.3924 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.931` → IC=+0.211 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.931 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.583` → IC=+0.164 (n=144)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.583 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6454` → IC=+0.156 (n=385)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6454 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.2395` → IC=+0.292 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2395 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.4663` → IC=+0.185 (n=125)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.4663 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `11683.5869` → IC=+0.212 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11683.5869 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.207 (n=155)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.180 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0056 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1241` → IC=+0.157 (n=173)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.1241 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.169 (n=243)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` < `0.5938` → IC=+0.204 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5938 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.5034` → IC=+0.141 (n=488)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5034 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.097` → IC=+0.141 (n=505)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 3.097 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.7113` → IC=+0.152 (n=228)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7113 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.167 (n=148)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `2.108` → IC=+0.145 (n=325)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.108 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `1.4441` → IC=+0.141 (n=369)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.4441 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=542)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2676.601` → IC=+0.171 (n=235)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2676.601 (IC base=+0.117)
...
- **PATRÓN** `dist_vwap_pct` < `0.1702` → IC=+0.234 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1702 (IC base=+0.218)
...
- **PATRÓN** `volumen_regimen` > `1.2416` → IC=+0.235 (n=236)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2416 (IC base=+0.218)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2111` → IC=+0.230 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2111 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.187 (n=426)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.145 (n=1231)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.143 (n=320)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 17.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.2455` → IC=+0.123 (n=821)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` > 0.2455 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.2444` → IC=+0.175 (n=152)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2444 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` > `2.6057` → IC=+0.135 (n=269)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.6057 (IC base=+0.103)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.195 (n=313)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0038 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3873` → IC=+0.166 (n=823)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3873 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.155 (n=346)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.193` → IC=+0.164 (n=412)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.193 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.089` → IC=+0.142 (n=935)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.089 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.1928` → IC=+0.152 (n=354)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1928 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.162` → IC=+0.151 (n=936)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.162 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2181` → IC=+0.151 (n=911)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.2181 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.1463` → IC=+0.147 (n=937)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.1463 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.5395` → IC=+0.158 (n=927)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.5395 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4235` → IC=+0.149 (n=927)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4235 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=1231)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `10638.1798` → IC=+0.150 (n=623)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.167 (n=40)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 18.0 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `0.9282` → IC=+0.160 (n=48)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.9282 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` < `1.5267` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5267 (IC base=+0.056)

- **PATRÓN** `libro_liquidez` > `12609.7541` → IC=+0.145 (n=105)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 12609.7541 (IC base=+0.056)

- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.199 (n=227)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0036 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.4014` → IC=+0.152 (n=513)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4014 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=192)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.3794` → IC=+0.142 (n=342)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.3794 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.6725` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.6725 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.225` → IC=+0.162 (n=512)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.225 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.1877` → IC=+0.158 (n=513)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1877 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6133` → IC=+0.143 (n=513)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6133 (IC base=+0.142)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5479` → IC=+0.157 (n=511)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.5479 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.8093` → IC=+0.152 (n=340)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8093 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `11979.2467` → IC=+0.152 (n=458)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 11979.2467 (IC base=+0.142)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.179 (n=104)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0106 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.214 (n=61)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `0.92` → IC=+0.278 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.92 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.325` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.325 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.215` → IC=+0.196 (n=44)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.215 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `2.4202` → IC=+0.151 (n=104)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 2.4202 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `1874.6858` → IC=+0.152 (n=156)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1874.6858 (IC base=+0.119)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=930)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2831)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.209 (n=954)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=2901)

- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.175 (n=961)
...
- **FILTRO** `ibs_20min` < `0.7353` → IC=-0.167 (n=136)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=409)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.180 (n=251)
...
- **FILTRO** `ibs_20min` < `0.7271` → IC=-0.197 (n=143)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=431)
...
- **FILTRO** `ibs_20min` > `0.7289` → IC=-0.224 (n=161)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.143 (n=2723)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=6793)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.282 (n=2331)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=7185)

- **FILTRO** `ibs_7min` < `0.7297` → IC=-0.236 (n=2379)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7297
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=7137)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.174 (n=3218)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=6298)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=2883)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=8731)

- **FILTRO** `ibs_7min` > `0.7159` → IC=-0.173 (n=2903)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7159
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=8711)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.317 (n=315)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=978)

- **FILTRO** `ibs_7min` < `1.0` → IC=-0.189 (n=905)
...
- **FILTRO** `py_entrada` > `0.71` → IC=-0.229 (n=477)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1522)

- **FILTRO** `drift_7min_pct` |x|> `0.1337` → IC=-0.139 (n=679)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1337
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1320)

- **FILTRO** `ibs_7min` > `0.704` → IC=-0.170 (n=679)

  - _Acción_: SKIP cuando `ibs_7min` > 0.704
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1320)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.142 (n=392)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1452)
...
- **FILTRO** `ibs_7min` < `0.792` → IC=-0.187 (n=461)

  - _Acción_: SKIP cuando `ibs_7min` < 0.792
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1383)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.188 (n=460)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1384)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.213 (n=444)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1393)

- **FILTRO** `ballena_activa_n` > `98.0` → IC=-0.162 (n=619)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.202 (n=333)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=1041)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.312 (n=444)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=930)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.284 (n=341)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1033)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.271 (n=343)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=1031)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.252 (n=438)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1603)

- **FILTRO** `ibs_7min` > `0.812` → IC=-0.190 (n=510)

  - _Acción_: SKIP cuando `ibs_7min` > 0.812
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1531)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.151 (n=480)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=1119)

- **FILTRO** `py_entrada` < `0.44` → IC=-0.216 (n=770)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=829)
...
- **FILTRO** `hora_utc` > `15.0` → IC=-0.120 (n=522)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
...
- **FILTRO** `py_entrada` > `0.66` → IC=-0.266 (n=383)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1217)

- **FILTRO** `ibs_7min` > `0.1866` → IC=-0.166 (n=543)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1866
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=1057)

- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.172 (n=543)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=1057)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.231 (n=448)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1387)

- **FILTRO** `ibs_7min` < `0.7692` → IC=-0.205 (n=449)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7692
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1386)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.185 (n=433)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1402)
...
- **FILTRO** `py_entrada` < `0.37` → IC=-0.298 (n=379)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1192)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.231 (n=384)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1187)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.233 (n=387)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1184)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.270 (n=398)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1588)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.169 (n=491)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1495)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.123 (n=648)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1338)
...
### UPDOWN_GBM#5min
- **FILTRO** `delta_ratio_macro` |x|≤ `0.0992` → IC=-0.129 (n=176)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.0992
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=360)

- **FILTRO** `ibs_15` < `0.2571` → IC=-0.184 (n=134)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.2571
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.578` → IC=-0.209 (n=53)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=483)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.671` → IC=-0.174 (n=363)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0639` → IC=+0.255 (n=198)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0639 (IC base=-0.075)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3008` → IC=+0.287 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3008 (IC base=-0.075)

- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.326 (n=199)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3696 (IC base=-0.075)

- **PATRÓN** `dist_vwap_pct` < `0.1514` → IC=+0.264 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1514 (IC base=-0.075)

- **PATRÓN** `ballena_activa_n` < `67.0` → IC=+0.273 (n=108)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1041` → IC=+0.256 (n=76)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1041 (IC base=+0.239)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.259 (n=114)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.256 (n=76)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.239)

- **PATRÓN** `drift_60min` |x|≤ `0.2306` → IC=+0.244 (n=76)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2306 (IC base=+0.239)

- **PATRÓN** `drift_15min` |x|≤ `0.4277` → IC=+0.275 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4277 (IC base=+0.239)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1` → IC=+0.260 (n=102)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1 (IC base=+0.239)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.247 (n=85)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` < `0.3764` → IC=+0.328 (n=114)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3764 (IC base=+0.239)

- **PATRÓN** `dist_vwap_pct` < `0.1242` → IC=+0.257 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1242 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.486` → IC=+0.268 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 10.486 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `13769.0298` → IC=+0.275 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13769.0298 (IC base=+0.239)

- **PATRÓN** `ballena_activa_n` < `206.0` → IC=+0.244 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 206.0 (IC base=+0.239)
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.013` → IC=-0.145 (n=119)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=956)

- **PATRÓN** `ibs_15` > `0.8125` → IC=+0.206 (n=15)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8125 (IC base=-0.118)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1278` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1278 (IC base=-0.056)

- **PATRÓN** `ibs_15` < `0.3` → IC=+0.250 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3 (IC base=-0.056)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0537` → IC=+0.328 (n=85)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0537 (IC base=+0.276)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0568` → IC=+0.292 (n=253)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0568 (IC base=+0.276)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1222` → IC=+0.346 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1222 (IC base=+0.276)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.305 (n=265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3131` → IC=+0.344 (n=113)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3131 (IC base=+0.276)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.292` → IC=+0.282 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.292 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.276 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `4881.1986` → IC=+0.289 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4881.1986 (IC base=+0.276)

### UPDOWN_GBM_IBS_ALTO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0024` → IC=+0.260 (n=48)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0024 (IC base=+0.260)

- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.300 (n=48)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0057 (IC base=+0.260)

- **PATRÓN** `drift_60min` |x|≤ `0.162` → IC=+0.289 (n=126)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.162 (IC base=+0.260)

- **PATRÓN** `drift_15min` |x|≤ `0.6649` → IC=+0.266 (n=126)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1224` → IC=+0.321 (n=26)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1224 (IC base=+0.260)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.321 (n=65)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.260)

- **PATRÓN** `ibs_15` > `0.968` → IC=+0.306 (n=65)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.968 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` > `0.3523` → IC=+0.350 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3523 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.453` → IC=+0.265 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.453 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.866` → IC=+0.273 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.866 (IC base=+0.260)

- **PATRÓN** `libro_liquidez` > `13151.6029` → IC=+0.291 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13151.6029 (IC base=+0.260)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1764` → IC=+0.136 (n=31)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.68€ cuando `delta_ratio_macro` |x|> 0.1764 (IC base=+0.031)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3696 sube el IC de -0.075 a +0.326 en UPDOWN_GBM_15M_TARDIO (n=199). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3764 sube el IC de +0.239 a +0.328 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=114). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3 sube el IC de -0.056 a +0.250 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=34). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.9673 sube el IC de +0.276 a +0.346 en UPDOWN_GBM_IBS_ALTO (n=115). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.968 sube el IC de +0.260 a +0.306 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=65). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 637 | +0.091 | +46.94€ | 1 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 637 | +0.091 | +46.94€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS | 10744 | -0.096 | -1775.03€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 761 | -0.058 | -134.21€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 9983 | -0.099 | -1640.82€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1353 | -0.034 | -268.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 