# Hipótesis automáticas — 2026-07-01 21:02 UTC
_Generado por shadow_postmortem.py sobre 2470 resoluciones (PNL=-86.55€)_
...
| ✅ UPDOWN_GBM | 722 | -0.037 | -35.43€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.108) — sin ventaja clara. oversold(IBS<0.3): IC=+0.010 n=100 | neutral: IC=-0.098 n=95 | overbought(IBS>0.7): IC=-0.023 n=128
  - _Datos_: n=332 IC=-0.033 PNL=-10.19€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.112 n=17 PNL=-5.44€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.136 n=20 PNL=-4.88€ → FILTRAR
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=-0.001 n=1162 | tras_1loss IC=-0.035 n=1226 | tras_2loss IC=-0.050 n=638/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=599 IC=-0.031 PNL=-21.88€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=599 IC=-0.031 PNL=-21.88€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 53/200 ops en el filtro definido (IC actual=+0.064 PNL=+6.38€)
  - _Datos_: n=53 IC=+0.064 PNL=+6.38€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 53/100 ops en el filtro definido (IC actual=+0.064 PNL=+6.38€)
  - _Datos_: n=53 IC=+0.064 PNL=+6.38€
