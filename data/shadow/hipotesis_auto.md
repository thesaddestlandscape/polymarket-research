# Hipótesis automáticas — 2026-07-01 00:19 UTC
_Generado por shadow_postmortem.py sobre 1487 resoluciones (PNL=-60.10€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0978` → IC=+0.140 (n=23)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `pct_spot_vs_ref` |x|≤ 0.0978 (IC base=+0.043)

- **PATRÓN** `drift_60min` |x|≤ `0.0607` → IC=+0.136 (n=20)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.0607 (IC base=+0.043)
...
- **PATRÓN** `sigma_h` > `0.0129` → IC=+0.135 (n=50)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0129 (IC base=+0.031)

- **PATRÓN** `ibs_15` < `0.1558` → IC=+0.152 (n=21)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` < 0.1558 (IC base=+0.031)
...
| ✅ UPDOWN_GBM | 492 | -0.020 | -12.95€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 303 | +0.021 | +4.28€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 105 | -0.042 | -6.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 155 | -0.010 | -9.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 90 | +0.043 | -2.53€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 212 | +0.014 | +5.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 145 | +0.031 | +6.07€ | 1 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.078) — sin ventaja clara. oversold(IBS<0.3): IC=-0.035 n=56 | neutral: IC=-0.091 n=64 | overbought(IBS>0.7): IC=-0.013 n=78
  - _Datos_: n=203 IC=-0.046 PNL=-14.08€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=393 IC=-0.014 PNL=-7.31€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=393 IC=-0.014 PNL=-7.31€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=236 IC=-0.008 PNL=-15.97€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=236 IC=-0.008 PNL=-15.97€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=90 IC=+0.043 PNL=-2.53€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=90 IC=+0.043 PNL=-2.53€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=133 IC=+0.048 PNL=-2.27€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=133 IC=+0.048 PNL=-2.27€
