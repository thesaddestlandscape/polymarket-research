# Hipótesis automáticas — 2026-08-10 09:43 UTC
_Generado por shadow_postmortem.py sobre 104013 resoluciones (PNL=+14756.03€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.224 (n=349)
...
- **PATRÓN** `restante_min` > `4.91` → IC=+0.141 (n=341)
...
- **PATRÓN** `lag_apertura_s` < `5.68` → IC=+0.143 (n=340)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 5.68 (IC base=+0.129)

- **PATRÓN** `profundidad_ratio_no` > `16.7` → IC=+0.157 (n=342)

  - _Acción_: Kelly boost +0.78€ cuando `profundidad_ratio_no` > 16.7 (IC base=+0.129)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.239 (n=186)
...
- **PATRÓN** `py_entrada` < `0.41` → IC=+0.192 (n=361)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` < 0.41 (IC base=+0.142)

- **PATRÓN** `restante_min` < `4.95` → IC=+0.149 (n=534)

  - _Acción_: Kelly boost +0.75€ cuando `restante_min` < 4.95 (IC base=+0.142)

- **PATRÓN** `restante_min` > `4.22` → IC=+0.149 (n=457)

  - _Acción_: Kelly boost +0.75€ cuando `restante_min` > 4.22 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=484)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 7.0 (IC base=+0.142)

- **PATRÓN** `lag_apertura_s` < `42.86` → IC=+0.147 (n=451)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 42.86 (IC base=+0.142)

- **PATRÓN** `profundidad_ratio_no` > `24.2` → IC=+0.205 (n=171)
...
| ✅ BALLENAS_TARDIAS | 2933 | -0.060 | -614.41€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 468 | +0.219 | -42.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2465 | -0.114 | -571.73€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#DOGE | 407 | -0.153 | -50.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 407 | -0.153 | -50.99€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 28725 | +0.119 | -708.14€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6649 | +0.195 | -127.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 455 | +0.049 | -40.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 19596 | +0.093 | -583.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2025 | +0.136 | +42.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3149 | +0.081 | -193.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 13 | -0.022 | -3.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3131 | +0.081 | -192.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6130 | +0.131 | -98.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2075 | +0.184 | -105.96€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 148 | +0.053 | -15.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3139 | +0.096 | -45.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 768 | +0.145 | +67.74€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3148 | +0.083 | -166.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 16 | +0.222 | +8.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3131 | +0.082 | -177.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6598 | +0.136 | -21.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2241 | +0.196 | +7.44€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 149 | -0.017 | -32.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3543 | +0.105 | -9.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 665 | +0.130 | +12.55€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6523 | +0.134 | -215.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2263 | +0.207 | -30.55€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 150 | +0.105 | +4.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3518 | +0.088 | -151.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 592 | +0.131 | -37.83€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3177 | +0.105 | -12.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 41 | +0.128 | -3.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3134 | +0.104 | -7.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 2812 | +0.202 | -175.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 2812 | +0.202 | -175.84€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 491 | +0.161 | -59.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 491 | +0.161 | -59.26€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 13109 | +0.201 | -942.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 13109 | +0.201 | -942.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2347 | +0.160 | -320.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2347 | +0.160 | -320.71€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2271 | +0.185 | -237.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2271 | +0.185 | -237.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2123 | +0.221 | -71.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2123 | +0.221 | -71.07€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2160 | +0.198 | -173.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2160 | +0.198 | -173.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 1358 | +0.129 | +17.97€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 1358 | +0.129 | +17.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 676 | +0.117 | -6.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 676 | +0.117 | -6.75€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 682 | +0.142 | +24.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 682 | +0.142 | +24.72€ | 0 | 6 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.132 n=63789 | tras_1loss IC=+0.087 n=39975 | tras_2loss IC=+0.050 n=16474/40 | gap=+0.082 (umbral 0.05)
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1740 IC=-0.084 PNL=+390.46€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1740 IC=-0.084 PNL=+390.46€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2347 IC=+0.160 PNL=-320.71€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2347 IC=+0.160 PNL=-320.71€
