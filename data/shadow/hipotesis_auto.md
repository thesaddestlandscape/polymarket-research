# Hipótesis automáticas — 2026-07-05 23:50 UTC
_Generado por shadow_postmortem.py sobre 4069 resoluciones (PNL=+194.99€)_
...
- **PATRÓN** `sigma_h` < `0.0087` → IC=+0.146 (n=97)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0087 (IC base=+0.031)

- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.162 (n=75)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` < 0.0634 (IC base=+0.031)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.188 (n=30)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0059 (IC base=+0.075)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.132 (n=55)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 13.0 (IC base=+0.075)

- **PATRÓN** `ibs_15` < `0.044` → IC=+0.222 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.044 (IC base=+0.075)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0634 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.162 n=75). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.044 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.222 n=34). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1201 | +0.092 | +295.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1201 | +0.092 | +295.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 313 | +0.033 | +31.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 313 | +0.033 | +31.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 314 | +0.057 | +34.80€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 314 | +0.057 | +34.80€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 970 | -0.036 | -52.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 731 | -0.013 | -22.73€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 413 | -0.004 | +5.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 326 | +0.015 | +13.36€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.065) — sin ventaja clara. oversold(IBS<0.3): IC=-0.007 n=207 | neutral: IC=-0.072 n=164 | overbought(IBS>0.7): IC=-0.040 n=187
  - _Datos_: n=580 IC=-0.033 PNL=-27.46€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.029 n=2043 | tras_1loss IC=-0.003 n=1913 | tras_2loss IC=-0.023 n=945/40 | gap=+0.051 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=847 IC=-0.031 PNL=-39.14€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=847 IC=-0.031 PNL=-39.14€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=330 IC=-0.009 PNL=-30.12€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=330 IC=-0.009 PNL=-30.12€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=269 IC=+0.002 PNL=+2.58€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=269 IC=+0.002 PNL=+2.58€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1619 IC=+0.060 PNL=+270.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1619 IC=+0.060 PNL=+270.17€
