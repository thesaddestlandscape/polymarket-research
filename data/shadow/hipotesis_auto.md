# Hipótesis automáticas — 2026-09-16 06:03 UTC
_Generado por shadow_postmortem.py sobre 462422 resoluciones (PNL=+49529.84€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.44` → IC=-0.253 (n=5740)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.44
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=17224)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `139.07` → IC=-0.286 (n=789)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 139.07
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2369)
...
- **FILTRO** `restante_s_al_confirmar` < `141.07` → IC=-0.150 (n=1474)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.07
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=4432)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.46` → IC=-0.254 (n=1360)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.46
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=4087)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `155.05` → IC=-0.331 (n=1442)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 155.05
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=2928)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.245 (n=237)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=254)

- **FILTRO** `py_entrada` > `0.56` → IC=-0.129 (n=114)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=358)
...
- **FILTRO** `py_entrada` > `0.54` → IC=-0.129 (n=60)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.142 (n=10800)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 7.0 (IC base=+0.135)

- **PATRÓN** `py_entrada` < `0.345` → IC=+0.246 (n=7921)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.172 (n=5725)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7185.4978` → IC=+0.177 (n=1810)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 7185.4978 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1362)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1687)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `11046.4721` → IC=+0.201 (n=872)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.208 (n=1364)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.273 (n=1194)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1753)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `13089.1641` → IC=+0.210 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13089.1641 (IC base=+0.202)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.189 (n=287)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 7.0 (IC base=+0.134)

- **PATRÓN** `py_entrada` < `0.425` → IC=+0.167 (n=566)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2328)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.138 (n=1988)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.133 (n=545)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=635)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `1937.9599` → IC=+0.159 (n=362)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1937.9599 (IC base=+0.126)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.179 (n=2174)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2260)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.294 (n=173)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.285)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.345 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.285)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=2236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.177)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.181 (n=2141)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.247 (n=2001)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.237)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.321 (n=658)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=4791)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.223)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.272 (n=1725)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.183 (n=4968)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=1717)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.256 (n=2261)
...
- **PATRÓN** `libro_liquidez` > `1604.9934` → IC=+0.297 (n=932)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9779` → IC=+0.230 (n=2045)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9779 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.2223` → IC=+0.244 (n=1288)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2223 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.856` → IC=+0.166 (n=2364)
...
- **PATRÓN** `volumen_regimen` > `1.0656` → IC=+0.242 (n=703)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0656 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1751` → IC=+0.192 (n=4185)
...
- **PATRÓN** `volumen_spike_ratio` > `1.472` → IC=+0.195 (n=4027)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.472 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5676` → IC=+0.130 (n=7543)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.5676 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5845` → IC=+0.181 (n=447)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5845 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3502` → IC=+0.168 (n=2598)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3502 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.168 (n=2449)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.204 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8704` → IC=+0.176 (n=1632)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8704 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.2451` → IC=+0.222 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2451 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4672` → IC=+0.197 (n=4077)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4672 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.207 (n=3845)
...
- **PATRÓN** `ibs_20min` < `0.0538` → IC=+0.285 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0538 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.25` → IC=+0.243 (n=1152)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.25 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0922` → IC=+0.232 (n=864)
...
- **PATRÓN** `ibs_20min` < `0.6723` → IC=+0.176 (n=1122)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6723 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1307` → IC=+0.154 (n=1018)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1307 (IC base=+0.140)
...
- **PATRÓN** `volumen_regimen` < `1.2035` → IC=+0.149 (n=1122)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.2035 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.6855` → IC=+0.141 (n=1002)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6855 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1571` → IC=+0.181 (n=302)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1571 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.155 (n=1013)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `13317.864` → IC=+0.155 (n=748)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 13317.864 (IC base=+0.140)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1062` → IC=+0.181 (n=1146)
...
- **PATRÓN** `ibs_20min` < `0.0606` → IC=+0.246 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0606 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.556` → IC=+0.233 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.556 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.373` → IC=+0.215 (n=1278)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.373 (IC base=+0.214)

- **PATRÓN** `volumen_pendiente_norm` > `0.365` → IC=+0.266 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.365 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` < `1.8451` → IC=+0.204 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8451 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `2.2989` → IC=+0.223 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2989 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.225 (n=608)
...
- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.226 (n=326)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=1701)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.129 (n=1734)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=+0.117 (n=865)

- **FILTRO** `sigma_ewma_delta_pct` > `8.613` → IC=-0.197 (n=282)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.613
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2317)
...
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.192 (n=430)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1293)

- **FILTRO** `ibs_20min` < `0.7838` → IC=-0.140 (n=1292)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.200 (n=378)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1345)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.200 (n=652)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=1959)
...
- **PATRÓN** `dist_vwap_pct` < `0.2677` → IC=+0.240 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2677 (IC base=-0.028)

- **PATRÓN** `volumen_regimen` < `0.7344` → IC=+0.239 (n=236)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1065` → IC=+0.268 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1065 (IC base=-0.028)

- **PATRÓN** `volumen_spike_ratio` < `2.2351` → IC=+0.255 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2351 (IC base=-0.028)

- **PATRÓN** `volumen_spike_ratio` > `1.4747` → IC=+0.238 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4747 (IC base=-0.028)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.242 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.028)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.173 (n=2563)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0091 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.9833` → IC=+0.289 (n=2562)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9833 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `0.7157` → IC=+0.282 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7157 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.51` → IC=+0.142 (n=3624)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.51 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6754` → IC=+0.235 (n=2331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6754 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` < `0.1135` → IC=+0.225 (n=3950)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7765` → IC=+0.235 (n=1382)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7765 (IC base=+0.086)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.277 (n=3630)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.141 (n=2608)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0084 (IC base=+0.068)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.150 (n=6885)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5556 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` > `0.6921` → IC=+0.243 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6921 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` < `0.2339` → IC=+0.231 (n=2058)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2339 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` < `0.7126` → IC=+0.231 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7126 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` > `1.1988` → IC=+0.253 (n=710)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1988 (IC base=+0.068)

- **PATRÓN** `volumen_pendiente_norm` > `0.2528` → IC=+0.320 (n=564)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2528 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` < `1.6267` → IC=+0.255 (n=1221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6267 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` > `2.3737` → IC=+0.255 (n=1257)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3737 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.255 (n=2629)
...
- **PATRÓN** `ibs_20min` > `0.8632` → IC=+0.250 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8632 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.293` → IC=+0.147 (n=707)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 3.293 (IC base=+0.038)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.167 (n=217)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4239 (IC base=+0.011)

- **PATRÓN** `ballena_activa_n` < `231.0` → IC=+0.184 (n=213)
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.267 (n=1090)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.0966` → IC=+0.248 (n=407)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.254 (n=461)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.526` → IC=+0.270 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.526 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.1109` → IC=+0.253 (n=1020)
...
- **PATRÓN** `ibs_20min` < `0.3321` → IC=+0.285 (n=977)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3474` → IC=+0.299 (n=152)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2358` → IC=+0.281 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2358 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=506)
...
- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.275 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 22.0 (IC base=+0.278)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2437` → IC=-0.210 (n=350)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2437
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1052)

- **FILTRO** `ibs_20min` > `0.8097` → IC=-0.185 (n=458)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8097
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=1378)

- **PATRÓN** `ibs_20min` > `0.8048` → IC=+0.145 (n=477)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.8048 (IC base=-0.014)

- **PATRÓN** `dist_vwap_pct` > `0.2958` → IC=+0.216 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2958 (IC base=-0.014)
...
- **PATRÓN** `volumen_regimen` > `0.553` → IC=+0.190 (n=321)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 0.553 (IC base=-0.014)
...
- **PATRÓN** `ballena_activa_n` < `113.0` → IC=+0.259 (n=197)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 113.0 (IC base=-0.014)

- **PATRÓN** `dist_vwap_pct` > `0.1237` → IC=+0.180 (n=98)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1237 (IC base=-0.020)

- **PATRÓN** `dist_vwap_pct` < `0.283` → IC=+0.165 (n=237)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.283 (IC base=-0.020)

- **PATRÓN** `volumen_regimen` < `0.979` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.979 (IC base=-0.020)

- **PATRÓN** `volumen_regimen` > `0.7203` → IC=+0.172 (n=205)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.7203 (IC base=-0.020)

- **PATRÓN** `volumen_pendiente_norm` > `0.0687` → IC=+0.295 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0687 (IC base=-0.020)

- **PATRÓN** `volumen_spike_ratio` < `1.4278` → IC=+0.269 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4278 (IC base=-0.020)

- **PATRÓN** `volumen_spike_ratio` > `2.4157` → IC=+0.254 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4157 (IC base=-0.020)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.236 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=-0.020)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.208 (n=827)
...
- **FILTRO** `ibs_20min` > `0.7143` → IC=-0.237 (n=439)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1326)

- **FILTRO** `sigma_ewma_delta_pct` > `4.689` → IC=-0.172 (n=412)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.689
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1353)
...
- **PATRÓN** `dist_vwap_pct` < `0.3961` → IC=+0.185 (n=379)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.3961 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` < `0.7144` → IC=+0.255 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7144 (IC base=+0.003)

- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.185 (n=325)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1003 (IC base=+0.003)
...
- **PATRÓN** `volumen_spike_ratio` < `2.629` → IC=+0.202 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.629 (IC base=+0.003)

- **PATRÓN** `volumen_spike_ratio` > `1.5045` → IC=+0.184 (n=333)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.5045 (IC base=+0.003)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.219 (n=336)
...
- **PATRÓN** `ibs_20min` < `0.3925` → IC=+0.304 (n=1144)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.429` → IC=+0.291 (n=414)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.266 (n=982)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5474 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` > `2.17` → IC=+0.267 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.17 (IC base=+0.269)

- **PATRÓN** `libro_liquidez` > `2336.4744` → IC=+0.275 (n=1022)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2336.4744 (IC base=+0.269)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.177 (n=2026)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0047 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.200 (n=2021)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0104 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3341` → IC=+0.173 (n=5334)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3341 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6299)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.6936` → IC=+0.229 (n=5416)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6936 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9554` → IC=+0.224 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9554 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.219` → IC=+0.248 (n=1251)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.219 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2143` → IC=+0.162 (n=4041)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2143 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6211` → IC=+0.159 (n=4041)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6211 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.1068` → IC=+0.186 (n=2371)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1068 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5656` → IC=+0.172 (n=2536)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5656 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6658` → IC=+0.167 (n=1920)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.6658 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3823.5619` → IC=+0.170 (n=2021)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3823.5619 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.183 (n=4981)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 123.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.188 (n=3930)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0063 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.204 (n=1963)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4588` → IC=+0.226 (n=5887)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4588 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2251` → IC=+0.161 (n=4380)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2251 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.251` → IC=+0.194 (n=1019)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.251 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1889` → IC=+0.156 (n=4300)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1889 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.625` → IC=+0.150 (n=4299)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.625 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2926` → IC=+0.228 (n=840)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2926 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `1.576` → IC=+0.172 (n=2303)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.576 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.2842` → IC=+0.176 (n=2372)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.2842 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.170 (n=4853)
...
- **PATRÓN** `drift_60min` |x|≤ `0.314` → IC=+0.204 (n=1023)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.314 (IC base=+0.188)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.217 (n=451)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.249 (n=664)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.1821` → IC=+0.293 (n=496)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1821 (IC base=+0.236)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.243 (n=676)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.236)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.241 (n=783)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.236)

- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.255 (n=745)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0946` → IC=+0.234 (n=608)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0946 (IC base=+0.236)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.236 (n=768)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `1739.24` → IC=+0.253 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1739.24 (IC base=+0.236)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=931)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4292` → IC=+0.223 (n=885)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.681` → IC=+0.225 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.681 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.174 (n=884)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.2629 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2316` → IC=+0.189 (n=194)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2316 (IC base=+0.162)
...
- **PATRÓN** `volumen_regimen` < `1.2096` → IC=+0.164 (n=1002)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2096 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1598` → IC=+0.182 (n=309)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1598 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.4411` → IC=+0.162 (n=892)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4411 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `230.0` → IC=+0.154 (n=270)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 230.0 (IC base=+0.149)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.196 (n=1002)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0058 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.1945` → IC=+0.198 (n=666)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1945 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.216 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.190 (n=466)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1072` → IC=+0.183 (n=821)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` < 0.1072 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` > `0.1358` → IC=+0.185 (n=385)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1358 (IC base=+0.187)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=1127)
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.250 (n=845)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3598` → IC=+0.270 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3598 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `3.5271` → IC=+0.248 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5271 (IC base=+0.222)

- **PATRÓN** `libro_liquidez` > `1886.9572` → IC=+0.236 (n=282)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1886.9572 (IC base=+0.222)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.209 (n=325)
...
- **PATRÓN** `ibs_20min` < `0.5455` → IC=+0.206 (n=1131)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5455 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.7088` → IC=+0.144 (n=200)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.7088 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.1923` → IC=+0.135 (n=1050)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1923 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.383` → IC=+0.157 (n=240)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 7.383 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `1.0407` → IC=+0.128 (n=994)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0407 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2773` → IC=+0.176 (n=137)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2773 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.4645` → IC=+0.131 (n=329)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4645 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.177` → IC=+0.135 (n=447)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.177 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `3071.3046` → IC=+0.160 (n=377)
...
- **PATRÓN** `volumen_regimen` > `0.6289` → IC=+0.218 (n=1140)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2458` → IC=+0.196 (n=883)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2458 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4611` → IC=+0.194 (n=1003)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4611 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2531.5374` → IC=+0.213 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2531.5374 (IC base=+0.204)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0958` → IC=+0.148 (n=487)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0958 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.178 (n=732)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.3872` → IC=+0.168 (n=1461)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.3872 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.8433` → IC=+0.167 (n=199)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.8433 (IC base=+0.135)
...
- **PATRÓN** `volumen_regimen` < `0.8649` → IC=+0.155 (n=839)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8649 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4313` → IC=+0.147 (n=466)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4313 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.5669` → IC=+0.158 (n=466)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5669 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=1617)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8234.6705` → IC=+0.152 (n=662)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8234.6705 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.157 (n=1242)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 156.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.134 (n=1031)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0057 (IC base=+0.113)

- **PATRÓN** `drift_60min` |x|≤ `0.3399` → IC=+0.126 (n=1355)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3399 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.128 (n=1465)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 6.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.155 (n=1355)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4783 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.2125` → IC=+0.121 (n=1364)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` < 0.2125 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.978` → IC=+0.134 (n=457)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 5.978 (IC base=+0.113)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.133 (n=1295)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 2.2373 (IC base=+0.113)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1037` → IC=+0.153 (n=145)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1037 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.152 (n=294)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 10.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.2836` → IC=+0.141 (n=327)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.2836 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.6944` → IC=+0.144 (n=57)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.6944 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.256` → IC=+0.160 (n=154)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 3.256 (IC base=+0.100)

- **PATRÓN** `volumen_regimen` < `0.6919` → IC=+0.164 (n=144)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.6919 (IC base=+0.100)

- **PATRÓN** `volumen_pendiente_norm` > `0.0903` → IC=+0.128 (n=119)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.0903 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `9742.4663` → IC=+0.135 (n=327)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 9742.4663 (IC base=+0.100)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.160 (n=101)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 151.0 (IC base=+0.100)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0949` → IC=+0.215 (n=149)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0949 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.240 (n=221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` > `0.2587` → IC=+0.228 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2587 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` > `0.1411` → IC=+0.221 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1411 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.948` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.948 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` < `0.8331` → IC=+0.198 (n=299)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.8331 (IC base=+0.190)
...
- **PATRÓN** `volumen_spike_ratio` < `1.374` → IC=+0.218 (n=147)
...
- **PATRÓN** `libro_liquidez` > `12351.8233` → IC=+0.209 (n=149)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12351.8233 (IC base=+0.190)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.133 (n=393)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0066 (IC base=+0.108)

- **PATRÓN** `drift_60min` |x|≤ `0.0962` → IC=+0.154 (n=131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0962 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.138 (n=266)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 11.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` < `0.2923` → IC=+0.159 (n=262)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.2923 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.51` → IC=+0.170 (n=107)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 6.51 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `1.2294` → IC=+0.123 (n=393)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2294 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` > `0.1664` → IC=+0.163 (n=93)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1664 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` > `1.5407` → IC=+0.124 (n=333)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 1.5407 (IC base=+0.108)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.3844` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3844
  - _Potencial_: sin este filtro IC_bueno=+0.091 (n=375)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.176 (n=146)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 15.0 (IC base=+0.080)

- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.208 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.080)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.297` → IC=+0.152 (n=136)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 5.297 (IC base=+0.080)

- **PATRÓN** `libro_liquidez` > `3001.6768` → IC=+0.167 (n=103)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3001.6768 (IC base=+0.080)

- **PATRÓN** `ibs_20min` < `0.4615` → IC=+0.155 (n=297)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4615 (IC base=+0.078)

- **PATRÓN** `volumen_regimen` < `0.7177` → IC=+0.136 (n=130)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.7177 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` < `2.2675` → IC=+0.128 (n=237)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.2675 (IC base=+0.078)
...
- **PATRÓN** `ibs_20min` < `0.5563` → IC=+0.239 (n=7059)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5563 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2352` → IC=+0.164 (n=4468)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2352 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.853` → IC=+0.201 (n=1013)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.853 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.688` → IC=+0.182 (n=6824)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.688 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.703` → IC=+0.159 (n=2146)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.703 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.202` → IC=+0.162 (n=1626)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.202 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.248 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.3005` → IC=+0.189 (n=2868)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3005 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.189 (n=2050)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.231 (n=585)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.205 (n=870)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.865` → IC=+0.315 (n=582)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.277` → IC=+0.241 (n=168)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.277 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` < `1.4574` → IC=+0.187 (n=401)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.4574 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.2718` → IC=+0.197 (n=545)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.2718 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.222 (n=1173)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.263 (n=680)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0056 (IC base=+0.255)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.266 (n=907)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.255)

- **PATRÓN** `drift_60min` |x|≤ `0.2026` → IC=+0.280 (n=676)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3404` → IC=+0.284 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3404 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.61` → IC=+0.263 (n=1019)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1827` → IC=+0.154 (n=812)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1827 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1269)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.6894` → IC=+0.243 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6894 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.3452` → IC=+0.202 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3452 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.774` → IC=+0.162 (n=285)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 9.774 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.384` → IC=+0.153 (n=1082)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.384 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6929` → IC=+0.184 (n=536)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6929 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1544` → IC=+0.181 (n=333)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1544 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.4203` → IC=+0.156 (n=1165)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4203 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7559` → IC=+0.158 (n=776)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7559 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10774.9458` → IC=+0.168 (n=1088)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 10774.9458 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `492.0` → IC=+0.159 (n=1093)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 492.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.170 (n=1091)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0057 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.2605` → IC=+0.170 (n=959)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.2605 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` < `0.6376` → IC=+0.207 (n=1090)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6376 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.5411` → IC=+0.161 (n=216)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.5411 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.1318` → IC=+0.166 (n=1004)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1318 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.258` → IC=+0.174 (n=535)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.258 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.167 (n=1090)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1888 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.1509` → IC=+0.207 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1509 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.409` → IC=+0.171 (n=992)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.409 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `12235.5092` → IC=+0.159 (n=726)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12235.5092 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `372.0` → IC=+0.164 (n=596)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 372.0 (IC base=+0.156)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.209 (n=1215)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.209)

- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.224 (n=1214)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1270)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.214 (n=1230)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.6721` → IC=+0.247 (n=1086)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6721 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.541` → IC=+0.294 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.541 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` < `0.2176` → IC=+0.215 (n=1172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2176 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `3.0042` → IC=+0.234 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0042 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.223 (n=1383)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.237 (n=1172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.231)

- **PATRÓN** `drift_60min` |x|≤ `0.1543` → IC=+0.231 (n=515)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3642` → IC=+0.267 (n=1030)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3642 (IC base=+0.231)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.713` → IC=+0.273 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.713 (IC base=+0.231)

- **PATRÓN** `volumen_pendiente_norm` > `0.3595` → IC=+0.294 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3595 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` < `1.7962` → IC=+0.224 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7962 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` > `2.2483` → IC=+0.228 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2483 (IC base=+0.231)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.241 (n=619)
...
- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.254 (n=323)
...
- **PATRÓN** `volumen_regimen` < `0.8789` → IC=+0.159 (n=867)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.151 (n=477)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 7.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.6884` → IC=+0.193 (n=1045)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6884 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.2048` → IC=+0.144 (n=978)
...
- **PATRÓN** `ballena_activa_n` < `194.0` → IC=+0.144 (n=969)
...
- **PATRÓN** `ibs_20min` > `0.4673` → IC=+0.181 (n=1319)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=921)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2909.4755` → IC=+0.242 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2909.4755 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.129 (n=979)
...
- **PATRÓN** `ibs_20min` < `0.6279` → IC=+0.209 (n=1275)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6279 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.4738` → IC=+0.128 (n=1262)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.4738 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.124 (n=1228)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.155 (n=561)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4615` → IC=+0.143 (n=373)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4615 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.225` → IC=+0.123 (n=507)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 2.225 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2909.7638` → IC=+0.165 (n=425)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2909.7638 (IC base=+0.114)
...
- **PATRÓN** `ibs_20min` < `0.5073` → IC=+0.254 (n=1468)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5073 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.1913` → IC=+0.206 (n=1296)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1913 (IC base=+0.200)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2257` → IC=+0.195 (n=1134)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2257 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.196 (n=1288)
...
- **PATRÓN** `libro_liquidez` > `2544.3255` → IC=+0.201 (n=979)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2544.3255 (IC base=+0.200)
...
- **FILTRO** `ibs_20min` < `0.6429` → IC=-0.172 (n=184)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.214 (n=555)

- **FILTRO** `sigma_h` > `0.0079` → IC=-0.260 (n=94)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0079
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=285)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.179 (n=431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.6429` → IC=+0.214 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6429 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.136` → IC=+0.168 (n=287)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.136 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.105` → IC=+0.212 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.105 (IC base=+0.101)

- **PATRÓN** `volumen_regimen` < `1.0919` → IC=+0.121 (n=555)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.0919 (IC base=+0.101)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.222 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.101)

- **PATRÓN** `volumen_spike_ratio` < `2.4945` → IC=+0.156 (n=448)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4945 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.136 (n=449)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.158 (n=241)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.101)

- **PATRÓN** `ibs_20min` < `0.0674` → IC=+0.287 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0674 (IC base=-0.020)

- **PATRÓN** `dist_vwap_pct` < `0.1608` → IC=+0.131 (n=220)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.1608 (IC base=-0.020)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.902` → IC=+0.158 (n=71)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.902 (IC base=-0.020)
...
- **PATRÓN** `volumen_spike_ratio` < `2.637` → IC=+0.158 (n=150)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.637 (IC base=-0.020)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.138 (n=158)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.02 (IC base=-0.020)

- **PATRÓN** `libro_liquidez` > `2976.1916` → IC=+0.138 (n=56)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2976.1916 (IC base=-0.020)

### GBM_LATE_60M#BTC#60min
- **FILTRO** `ibs_20min` < `0.5857` → IC=-0.177 (n=63)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5857
  - _Potencial_: sin este filtro IC_bueno=+0.210 (n=191)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.174 (n=222)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.006 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.211 (n=81)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.5857` → IC=+0.210 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5857 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1301` → IC=+0.199 (n=91)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1301 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.734` → IC=+0.134 (n=121)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.734 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.0504` → IC=+0.129 (n=168)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0504 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` < `0.0759` → IC=+0.154 (n=134)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.191 (n=134)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2846.2218` → IC=+0.131 (n=177)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2846.2218 (IC base=+0.106)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=150)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.144 (n=200)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 8.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.649` → IC=+0.244 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.649 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.5424` → IC=+0.206 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5424 (IC base=+0.120)
...
- **PATRÓN** `volumen_regimen` < `0.789` → IC=+0.164 (n=129)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.789 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` > `0.932` → IC=+0.156 (n=88)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.932 (IC base=+0.120)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7387` → IC=+0.173 (n=96)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.7387 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.3826` → IC=+0.151 (n=144)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.3826 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=201)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `1077.2861` → IC=+0.190 (n=169)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 1077.2861 (IC base=+0.120)

- **PATRÓN** `drift_60min` |x|≤ `0.1073` → IC=+0.176 (n=35)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.1073 (IC base=-0.051)

- **PATRÓN** `ibs_20min` < `0.1926` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1926 (IC base=-0.051)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.257` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.257 (IC base=-0.051)

- **PATRÓN** `volumen_pendiente_norm` > `0.0706` → IC=+0.200 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0706 (IC base=-0.051)

- **PATRÓN** `volumen_spike_ratio` > `2.7298` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7298 (IC base=-0.051)

- **PATRÓN** `libro_liquidez` > `1019.3386` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 1019.3386 (IC base=-0.051)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.127 (n=465)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2825.877` → IC=+0.169 (n=164)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2825.877 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=511)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2307.6342` → IC=+0.129 (n=540)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2307.6342 (IC base=+0.098)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1327)
...
### MOMENTUM_IBS_15M
- **FILTRO** `py_entrada` < `0.5` → IC=-0.124 (n=1025)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=5448)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=6245)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.179 (n=2641)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=7996)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=2721)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8386)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.219 (n=436)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=1356)

- **FILTRO** `ibs_20min` < `0.7471` → IC=-0.182 (n=448)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7471
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1344)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.165 (n=455)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1525)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.201 (n=453)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.216 (n=466)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1487)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.165 (n=488)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1465)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.199 (n=437)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.195 (n=486)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1468)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2393)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2412)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2418)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7716)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=17326)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.284 (n=5828)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=19214)

- **FILTRO** `ibs_7min` < `0.7046` → IC=-0.241 (n=6259)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7046
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=18783)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.161 (n=8287)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=16755)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.225 (n=7783)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=23572)

- **FILTRO** `ibs_7min` > `0.2963` → IC=-0.178 (n=7835)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2963
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=23520)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.313 (n=945)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3066)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.260 (n=1322)
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.195 (n=957)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3054)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.149 (n=3651)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1806)

- **FILTRO** `drift_7min_pct` |x|> `0.1358` → IC=-0.129 (n=1363)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1358
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=4094)

- **FILTRO** `ibs_7min` > `0.7979` → IC=-0.208 (n=1364)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7979
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4093)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.256 (n=1015)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3363)

- **FILTRO** `ibs_7min` < `0.7586` → IC=-0.186 (n=1094)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7586
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3284)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.172 (n=1093)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3285)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1037)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3397)

- **FILTRO** `ibs_7min` > `0.2509` → IC=-0.169 (n=1108)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2509
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=3326)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=932)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2832)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.322 (n=904)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2860)

- **FILTRO** `drift_7min_pct` |x|> `0.1813` → IC=-0.131 (n=1279)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1813
  - _Potencial_: sin este filtro IC_bueno=-0.109 (n=2485)

- **FILTRO** `ibs_7min` < `0.2031` → IC=-0.275 (n=941)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2031
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2823)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.221 (n=900)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=2864)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1346)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=4388)

- **FILTRO** `ibs_7min` > `0.2632` → IC=-0.158 (n=1948)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=3786)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1312)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2804)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.256 (n=997)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3119)

- **FILTRO** `ibs_7min` < `0.744` → IC=-0.195 (n=1029)

  - _Acción_: SKIP cuando `ibs_7min` < 0.744
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3087)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.183 (n=1019)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3097)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1033)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3184)

- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.174 (n=1054)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2744
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3163)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.180 (n=1046)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3171)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.254 (n=1063)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3473)

- **FILTRO** `ibs_7min` < `0.7222` → IC=-0.217 (n=1126)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7222
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3410)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.175 (n=1422)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4513)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.280 (n=1026)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3211)

- **FILTRO** `ibs_7min` < `0.73` → IC=-0.230 (n=1058)

  - _Acción_: SKIP cuando `ibs_7min` < 0.73
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3179)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.208 (n=1041)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3196)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.206 (n=1323)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=4255)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=927)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2327)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.199 (n=487)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.174)

- **PATRÓN** `drift_60min` |x|≤ `0.0532` → IC=+0.181 (n=359)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.0532 (IC base=+0.174)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0585` → IC=+0.177 (n=1074)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.89€ cuando `delta_ratio_macro` |x|> 0.0585 (IC base=+0.174)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3418` → IC=+0.210 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3418 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.178 (n=755)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 11.0 (IC base=+0.174)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.190 (n=523)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 6.0 (IC base=+0.174)

- **PATRÓN** `ibs_15` > `0.6176` → IC=+0.244 (n=1074)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6176 (IC base=+0.174)

- **PATRÓN** `dist_vwap_pct` < `0.1053` → IC=+0.178 (n=713)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.1053 (IC base=+0.174)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.889` → IC=+0.247 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.889 (IC base=+0.174)

- **PATRÓN** `libro_liquidez` > `2624.3797` → IC=+0.179 (n=959)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2624.3797 (IC base=+0.174)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.216 (n=181)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0602` → IC=+0.274 (n=91)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0602 (IC base=+0.199)

- **PATRÓN** `drift_15min` |x|≤ `0.3775` → IC=+0.220 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3775 (IC base=+0.199)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2526` → IC=+0.206 (n=90)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3906` → IC=+0.232 (n=196)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3906 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.215 (n=279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.199)

- **PATRÓN** `ibs_15` > `0.7112` → IC=+0.250 (n=270)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7112 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` > `0.3946` → IC=+0.232 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3946 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` < `0.1019` → IC=+0.207 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1019 (IC base=+0.199)
...
- **PATRÓN** `libro_liquidez` > `13917.3658` → IC=+0.236 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13917.3658 (IC base=+0.199)

### UPDOWN_GBM#BTC#60min
- **PATRÓN** `sigma_ewma_delta_pct` > `20.399` → IC=+0.136 (n=64)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 20.399 (IC base=-0.006)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.174 (n=87)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0033 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0733` → IC=+0.152 (n=116)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.0733 (IC base=+0.138)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1411` → IC=+0.163 (n=173)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.81€ cuando `delta_ratio_macro` |x|> 0.1411 (IC base=+0.138)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2698` → IC=+0.169 (n=167)

  - _Acción_: Kelly boost +0.84€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2698 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.142 (n=191)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 11.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.158 (n=118)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 6.0 (IC base=+0.138)

- **PATRÓN** `ibs_15` > `0.6485` → IC=+0.225 (n=260)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6485 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.4172` → IC=+0.152 (n=274)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4172 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.912` → IC=+0.213 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.912 (IC base=+0.138)
...
- **FILTRO** `dist_vwap_pct` > `0.5826` → IC=-0.147 (n=114)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=596)
...
- **PATRÓN** `ibs_15` < `0.1087` → IC=+0.174 (n=339)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `drift_60min` |x|≤ `0.1544` → IC=+0.344 (n=273)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2968` → IC=+0.371 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2968 (IC base=+0.336)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.360 (n=299)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.336)

- **PATRÓN** `ibs_15` > `0.7904` → IC=+0.378 (n=310)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7904 (IC base=+0.336)

- **PATRÓN** `dist_vwap_pct` > `0.4169` → IC=+0.374 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4169 (IC base=+0.336)

- **PATRÓN** `sigma_ewma_delta_pct` > `18.963` → IC=+0.342 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.963 (IC base=+0.336)

- **PATRÓN** `sigma_ewma_delta_pct` < `13.729` → IC=+0.336 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 13.729 (IC base=+0.336)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.344 (n=377)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.336)

- **PATRÓN** `libro_liquidez` > `3425.1488` → IC=+0.349 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3425.1488 (IC base=+0.336)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1225` → IC=+0.348 (n=77)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1225 (IC base=+0.337)

- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.356 (n=116)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0033 (IC base=+0.337)

- **PATRÓN** `drift_60min` |x|≤ `0.1519` → IC=+0.345 (n=153)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1519 (IC base=+0.337)

- **PATRÓN** `drift_15min` |x|≤ `0.4111` → IC=+0.335 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4111 (IC base=+0.337)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1017` → IC=+0.341 (n=155)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1017 (IC base=+0.337)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.409 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.133 (IC base=+0.337)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.363 (n=166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.337)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.337 (n=182)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.337)

- **PATRÓN** `ibs_15` > `0.8112` → IC=+0.369 (n=174)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8112 (IC base=+0.337)

- **PATRÓN** `dist_vwap_pct` > `0.2515` → IC=+0.387 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2515 (IC base=+0.337)
...
- **PATRÓN** `libro_liquidez` > `9172.6877` → IC=+0.356 (n=116)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9172.6877 (IC base=+0.337)

- **PATRÓN** `ballena_activa_n` < `550.0` → IC=+0.393 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 550.0 (IC base=+0.337)
...
- **FILTRO** `sigma_h` > `0.0126` → IC=-0.199 (n=533)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0126
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1600)

- **FILTRO** `ibs_15` < `0.6076` → IC=-0.178 (n=178)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6076
  - _Potencial_: sin este filtro IC_bueno=+0.254 (n=535)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.207 (n=247)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1886)
...
- **PATRÓN** `ibs_15` > `0.6076` → IC=+0.254 (n=535)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6076 (IC base=-0.057)

- **PATRÓN** `dist_vwap_pct` < `0.1102` → IC=+0.184 (n=330)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1102 (IC base=-0.057)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2104` → IC=+0.240 (n=375)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2104 (IC base=-0.046)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1821` → IC=+0.238 (n=715)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1821 (IC base=-0.046)

- **PATRÓN** `ibs_15` < `0.3542` → IC=+0.278 (n=1123)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3542 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` > `0.6583` → IC=+0.266 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6583 (IC base=-0.046)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.204 (n=319)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=959)

- **FILTRO** `sigma_h` < `0.0032` → IC=-0.232 (n=319)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=959)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.210 (n=812)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=466)

- **FILTRO** `sigma_ewma_delta_pct` > `19.944` → IC=-0.245 (n=229)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.944
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1049)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3586` → IC=+0.230 (n=416)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3586 (IC base=+0.224)

- **PATRÓN** `drift_15min` |x|≤ `0.7642` → IC=+0.227 (n=416)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.236 (n=316)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.224)

- **PATRÓN** `ibs_15` < `0.3584` → IC=+0.270 (n=472)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3584 (IC base=+0.224)

- **PATRÓN** `dist_vwap_pct` > `0.1631` → IC=+0.244 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1631 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.178` → IC=+0.232 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.178 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.1` → IC=+0.230 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.1 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `3600.0181` → IC=+0.224 (n=472)
...
- **PATRÓN** `ibs_15` < `0.3333` → IC=+0.302 (n=331)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.290 (n=231)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.286)

- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.285 (n=524)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0028 (IC base=+0.286)

- **PATRÓN** `drift_60min` |x|≤ `0.0567` → IC=+0.314 (n=175)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0567 (IC base=+0.286)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1415` → IC=+0.292 (n=349)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.303 (n=541)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.286)

- **PATRÓN** `ibs_15` > `0.8357` → IC=+0.325 (n=524)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8357 (IC base=+0.286)

- **PATRÓN** `dist_vwap_pct` > `0.2727` → IC=+0.327 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2727 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.701` → IC=+0.314 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.701 (IC base=+0.286)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.289 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.286)

- **PATRÓN** `libro_liquidez` > `12448.5931` → IC=+0.304 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12448.5931 (IC base=+0.286)
...
- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.293 (n=133)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.278)

- **PATRÓN** `drift_60min` |x|≤ `0.0596` → IC=+0.310 (n=98)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0596 (IC base=+0.278)

- **PATRÓN** `drift_15min` |x|≤ `0.4172` → IC=+0.280 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4172 (IC base=+0.278)

- **PATRÓN** `delta_ratio_macro` |x|> `0.246` → IC=+0.290 (n=98)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.246 (IC base=+0.278)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3796` → IC=+0.296 (n=224)
...
- **PATRÓN** `ibs_15` > `0.8239` → IC=+0.299 (n=292)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8239 (IC base=+0.278)

- **PATRÓN** `dist_vwap_pct` > `0.2631` → IC=+0.333 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2631 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.837` → IC=+0.336 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.837 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `12007.0154` → IC=+0.302 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12007.0154 (IC base=+0.278)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6176 sube el IC de +0.174 a +0.244 en UPDOWN_GBM#15min (n=1074). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7112 sube el IC de +0.199 a +0.250 en UPDOWN_GBM#BTC#15min (n=270). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6485 sube el IC de +0.138 a +0.225 en UPDOWN_GBM#ETH#15min (n=260). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1087 sube el IC de +0.049 a +0.174 en UPDOWN_GBM#XRP#15min (n=339). Ya aplicado como kelly_boost=+0.87€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6076 sube el IC de -0.057 a +0.254 en UPDOWN_GBM_15M_TARDIO (n=535). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3542 sube el IC de -0.046 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=1123). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3584 sube el IC de +0.224 a +0.270 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=472). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3333 sube el IC de -0.046 a +0.302 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=331). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8357 sube el IC de +0.286 a +0.325 en UPDOWN_GBM_IBS_ALTO (n=524). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8239 sube el IC de +0.278 a +0.299 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=292). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7904 sube el IC de +0.336 a +0.378 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=310). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8112 sube el IC de +0.337 a +0.369 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=174). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 20497 | -0.102 | -2944.67€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1242 | -0.045 | -182.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19255 | -0.106 | -2762.21€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3158 | -0.119 | -557.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3158 | -0.119 | -557.00€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 5906 | -0.048 | -583.89€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 