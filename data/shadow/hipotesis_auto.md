# Hipótesis automáticas — 2026-09-21 04:24 UTC
_Generado por shadow_postmortem.py sobre 536397 resoluciones (PNL=+59631.44€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.249 (n=477)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.249 (n=477)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=545)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `2884.2428` → IC=+0.140 (n=340)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 2884.2428 (IC base=+0.130)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.257 (n=376)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.257 (n=376)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.14` → IC=-0.236 (n=6487)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.14
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19461)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.51` → IC=-0.242 (n=883)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.51
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2649)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `494.42` → IC=-0.153 (n=347)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 494.42
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1042)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `133.45` → IC=-0.277 (n=778)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.45
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=2337)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `160.65` → IC=-0.232 (n=1530)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.65
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4592)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.8` → IC=-0.365 (n=1285)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.8
  - _Potencial_: sin este filtro IC_bueno=-0.118 (n=3858)
...
- **FILTRO** `py_entrada` > `0.54` → IC=-0.176 (n=217)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.176 (n=66)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.150 (n=324)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 7.0 (IC base=+0.116)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.144 (n=2224)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 15.0 (IC base=+0.143)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.333 (n=866)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.243 (n=1385)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.142 (n=610)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=700)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `1296.9414` → IC=+0.149 (n=607)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1296.9414 (IC base=+0.138)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.177 (n=700)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=10002)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3606)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2443)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=2574)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.321 (n=786)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.193 (n=2350)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 17.0 (IC base=+0.190)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.193 (n=1769)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.435 (n=168)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `3286.0948` → IC=+0.443 (n=120)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3286.0948 (IC base=+0.438)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.240 (n=11619)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.179 (n=5333)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 15.0 (IC base=+0.174)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5773)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.226 (n=5523)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.224)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.273 (n=2000)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=5709)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.222 (n=2116)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.221)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=1965)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3553` → IC=+0.125 (n=6375)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3553 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.9808` → IC=+0.241 (n=2415)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9808 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` < `0.5964` → IC=+0.244 (n=2024)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5964 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.928` → IC=+0.175 (n=2793)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.928 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.244 (n=1921)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` > `1.0495` → IC=+0.247 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0495 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.211 (n=714)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` > `1.9173` → IC=+0.205 (n=3268)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9173 (IC base=+0.103)

- **PATRÓN** `ibs_20min` < `0.571` → IC=+0.131 (n=8749)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.571 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5676` → IC=+0.200 (n=608)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5676 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.172 (n=2728)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7009` → IC=+0.177 (n=1316)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7009 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8696` → IC=+0.172 (n=1994)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8696 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.1683` → IC=+0.225 (n=1446)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1683 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.202 (n=4444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.211 (n=4757)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 143.0 (IC base=+0.062)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.178 (n=548)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3416` → IC=+0.168 (n=1643)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2806` → IC=+0.206 (n=216)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2806 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.4398` → IC=+0.166 (n=1528)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4398 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.249 (n=1076)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.292 (n=401)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.212 (n=1267)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.9071` → IC=+0.253 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9071 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.1866` → IC=+0.212 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1866 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `0.5623` → IC=+0.216 (n=1307)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5623 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.874` → IC=+0.245 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.874 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.2525` → IC=+0.217 (n=1246)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2525 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `1.0844` → IC=+0.214 (n=565)
...
- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.167 (n=1303)
...
- **PATRÓN** `dist_vwap_pct` < `0.1259` → IC=+0.153 (n=1170)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3689` → IC=+0.192 (n=206)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.3689 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.9235` → IC=+0.207 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9235 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=1066)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.224 (n=1362)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0108 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.219 (n=1219)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.1935` → IC=+0.237 (n=908)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1935 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.554` → IC=+0.239 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.554 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.402` → IC=+0.217 (n=1487)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.402 (IC base=+0.217)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6442` → IC=+0.207 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6442 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.2754` → IC=+0.226 (n=822)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2754 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.229 (n=854)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1860.9977` → IC=+0.231 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1860.9977 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.224 (n=803)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2015)

- **PATRÓN** `ibs_20min` > `0.9377` → IC=+0.196 (n=327)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.9377 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.3544` → IC=+0.344 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3544 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` < `0.682` → IC=+0.324 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.682 (IC base=+0.021)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.658` → IC=+0.152 (n=638)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 4.658 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` < `0.6629` → IC=+0.335 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6629 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` > `1.0371` → IC=+0.324 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0371 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` < `0.1687` → IC=+0.328 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1687 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` > `0.2985` → IC=+0.340 (n=79)
...
- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.336 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 164.0 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.314` → IC=+0.168 (n=230)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.314 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` < `0.8548` → IC=+0.153 (n=485)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5154` → IC=+0.175 (n=601)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.5154 (IC base=+0.010)
...
- **FILTRO** `ibs_20min` > `0.2625` → IC=-0.127 (n=1997)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2625
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=984)

- **FILTRO** `sigma_ewma_delta_pct` > `8.642` → IC=-0.205 (n=324)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.642
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2657)
...
- **PATRÓN** `ibs_20min` < `0.2625` → IC=+0.125 (n=984)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.2625 (IC base=-0.044)

- **PATRÓN** `dist_vwap_pct` > `0.6436` → IC=+0.315 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6436 (IC base=-0.044)

- **PATRÓN** `volumen_regimen` < `1.096` → IC=+0.237 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.096 (IC base=-0.044)

- **PATRÓN** `volumen_pendiente_norm` < `0.102` → IC=+0.233 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.102 (IC base=-0.044)
...
- **PATRÓN** `volumen_spike_ratio` < `2.456` → IC=+0.268 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.456 (IC base=-0.044)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.638` → IC=-0.191 (n=506)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.638
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1520)

- **FILTRO** `ibs_20min` < `0.6957` → IC=-0.158 (n=1337)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6957
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=689)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=396)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=1630)

- **FILTRO** `ibs_20min` > `0.7734` → IC=-0.202 (n=753)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7734
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2260)

- **PATRÓN** `dist_vwap_pct` > `0.9664` → IC=+0.296 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9664 (IC base=-0.076)

- **PATRÓN** `dist_vwap_pct` < `0.258` → IC=+0.317 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.258 (IC base=-0.076)

- **PATRÓN** `volumen_regimen` > `0.6119` → IC=+0.298 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6119 (IC base=-0.076)

- **PATRÓN** `volumen_pendiente_norm` > `0.0764` → IC=+0.302 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0764 (IC base=-0.076)

- **PATRÓN** `volumen_spike_ratio` < `1.4208` → IC=+0.296 (n=91)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8655` → IC=+0.298 (n=181)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8655 (IC base=-0.076)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2166` → IC=+0.257 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2166 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.250 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.191 (n=3012)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4687` → IC=+0.186 (n=8058)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4687 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `1.0116` → IC=+0.289 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0116 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.556` → IC=+0.152 (n=4282)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.556 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1742` → IC=+0.231 (n=3160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1742 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.6817` → IC=+0.241 (n=2823)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6817 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2993` → IC=+0.260 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2993 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4763` → IC=+0.242 (n=1713)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4763 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.7144` → IC=+0.241 (n=1713)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7144 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.268 (n=4640)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.146 (n=3050)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0088 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.5519` → IC=+0.149 (n=8037)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5519 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` > `0.6784` → IC=+0.242 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6784 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.1709` → IC=+0.236 (n=2371)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1709 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` < `0.7156` → IC=+0.240 (n=1151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7156 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.2024` → IC=+0.241 (n=872)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2024 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` > `0.248` → IC=+0.307 (n=667)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.248 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` < `1.4913` → IC=+0.253 (n=1137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4913 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.3584` → IC=+0.260 (n=1546)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3584 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.264 (n=3274)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 81.0 (IC base=+0.071)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.497` → IC=-0.164 (n=486)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.497
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1636)

- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.266 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8935 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.29` → IC=+0.163 (n=856)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 3.29 (IC base=+0.047)

- **PATRÓN** `volumen_pendiente_norm` > `0.2236` → IC=+0.269 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2236 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `1.4427` → IC=+0.185 (n=258)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.4427 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` > `2.1741` → IC=+0.193 (n=350)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.1741 (IC base=+0.047)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.183 (n=332)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 15.0 (IC base=+0.047)
...
- **FILTRO** `ibs_20min` > `0.817` → IC=-0.147 (n=659)

  - _Acción_: SKIP cuando `ibs_20min` > 0.817
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1979)

- **PATRÓN** `ibs_20min` > `0.859` → IC=+0.152 (n=607)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.859 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.2926` → IC=+0.156 (n=321)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2926 (IC base=+0.020)

- **PATRÓN** `volumen_regimen` < `1.1965` → IC=+0.143 (n=822)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1965 (IC base=+0.020)

- **PATRÓN** `volumen_regimen` > `0.6606` → IC=+0.149 (n=734)
...
- **PATRÓN** `ballena_activa_n` < `248.0` → IC=+0.191 (n=347)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 248.0 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.6013` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6013 (IC base=+0.000)

- **PATRÓN** `dist_vwap_pct` < `0.1524` → IC=+0.212 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1524 (IC base=+0.000)

- **PATRÓN** `volumen_regimen` > `0.6047` → IC=+0.207 (n=490)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=944)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1927.9404` → IC=+0.254 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1927.9404 (IC base=+0.244)
...
- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.291 (n=1135)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3388 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.841` → IC=+0.303 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.841 (IC base=+0.285)

- **PATRÓN** `volumen_pendiente_norm` > `0.3445` → IC=+0.315 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3445 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` < `1.6226` → IC=+0.293 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6226 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` > `2.2073` → IC=+0.288 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2073 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.298 (n=705)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `1912.2459` → IC=+0.316 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1912.2459 (IC base=+0.285)

- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.290 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 19.0 (IC base=+0.285)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2709` → IC=-0.197 (n=433)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2709
  - _Potencial_: sin este filtro IC_bueno=+0.073 (n=1302)

- **FILTRO** `ibs_20min` > `0.7832` → IC=-0.176 (n=539)
...
- **PATRÓN** `volumen_regimen` < `0.9756` → IC=+0.231 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9756 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `0.6419` → IC=+0.211 (n=417)
...
- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.264 (n=295)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8288` → IC=+0.233 (n=204)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.568` → IC=+0.155 (n=302)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 9.568 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.298 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` > `0.6359` → IC=+0.284 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6359 (IC base=+0.033)

- **PATRÓN** `volumen_pendiente_norm` < `0.1049` → IC=+0.289 (n=644)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7981` → IC=+0.305 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7981 (IC base=+0.033)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.314 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.033)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.210 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1 (IC base=+0.012)

- **PATRÓN** `dist_vwap_pct` < `0.2083` → IC=+0.221 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2083 (IC base=+0.012)

- **PATRÓN** `volumen_regimen` < `0.7067` → IC=+0.271 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7067 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` < `0.1001` → IC=+0.209 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1001 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` > `0.2645` → IC=+0.204 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2645 (IC base=+0.012)

- **PATRÓN** `volumen_spike_ratio` < `2.5268` → IC=+0.222 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5268 (IC base=+0.012)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.234 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.012)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.318 (n=785)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0161 (IC base=+0.274)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.290 (n=551)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.274)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.346 (n=788)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.485` → IC=+0.297 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.485 (IC base=+0.274)

- **PATRÓN** `volumen_regimen` > `0.8596` → IC=+0.295 (n=785)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8596 (IC base=+0.274)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4428` → IC=+0.280 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4428 (IC base=+0.274)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.271 (n=648)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.305 (n=1298)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5387` → IC=+0.267 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5387 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1719` → IC=+0.271 (n=514)
...
- **PATRÓN** `libro_liquidez` > `2583.781` → IC=+0.277 (n=865)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2583.781 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.170 (n=2380)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.201 (n=2373)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0109 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.185 (n=2376)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.581` → IC=+0.216 (n=7113)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.581 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1688` → IC=+0.194 (n=3094)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1688 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.232` → IC=+0.258 (n=1463)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.232 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.159 (n=4703)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2145 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.624` → IC=+0.157 (n=4703)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.624 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2974` → IC=+0.194 (n=1052)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2974 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5656` → IC=+0.170 (n=2990)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5656 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6486` → IC=+0.175 (n=2266)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6486 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2376.7652` → IC=+0.167 (n=4741)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2376.7652 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=6026)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.183 (n=4530)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0796` → IC=+0.202 (n=2264)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4773` → IC=+0.226 (n=6786)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4773 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.225` → IC=+0.158 (n=4966)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.225 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.24` → IC=+0.196 (n=1152)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.24 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1795` → IC=+0.152 (n=4947)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1795 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2918` → IC=+0.224 (n=976)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2918 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.166 (n=2691)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.283` → IC=+0.173 (n=2774)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.283 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.171 (n=5750)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.245 (n=418)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.238)

- **PATRÓN** `ibs_20min` < `0.3455` → IC=+0.265 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3455 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.044` → IC=+0.254 (n=935)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.044 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0946` → IC=+0.236 (n=707)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0946 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` > `0.2782` → IC=+0.267 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2782 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` < `1.4206` → IC=+0.254 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4206 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `2.6424` → IC=+0.240 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6424 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1781.7648` → IC=+0.251 (n=573)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1781.7648 (IC base=+0.238)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.245 (n=351)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.0745` → IC=+0.205 (n=351)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4147` → IC=+0.225 (n=1052)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4147 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.1958` → IC=+0.212 (n=629)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1958 (IC base=+0.160)
...
- **PATRÓN** `volumen_regimen` < `0.6831` → IC=+0.177 (n=463)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6831 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.2332` → IC=+0.195 (n=231)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2332 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `1.4144` → IC=+0.199 (n=340)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4144 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `15762.0138` → IC=+0.168 (n=477)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 15762.0138 (IC base=+0.160)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.196 (n=389)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0025 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2883` → IC=+0.155 (n=1156)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5546` → IC=+0.183 (n=1156)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5546 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1307` → IC=+0.160 (n=1162)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1307 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.856` → IC=+0.207 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.856 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.155 (n=1156)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2113 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1573` → IC=+0.159 (n=356)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.1573 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.449` → IC=+0.144 (n=1046)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.449 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.763` → IC=+0.136 (n=698)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.763 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.150 (n=324)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 221.0 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.228 (n=538)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0094 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.2094` → IC=+0.214 (n=792)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.786` → IC=+0.277 (n=370)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9343` → IC=+0.210 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9343 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=789)
...
- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.236 (n=979)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3529` → IC=+0.253 (n=979)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3529 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.735` → IC=+0.273 (n=404)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6422` → IC=+0.225 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6422 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` > `2.2644` → IC=+0.234 (n=599)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.003` → IC=+0.243 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.003 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `1.0478` → IC=+0.153 (n=994)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.0478 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.152 (n=1130)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6307 (IC base=+0.148)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4237` → IC=+0.158 (n=369)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4237 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `2.5331` → IC=+0.178 (n=368)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.5331 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `6954.443` → IC=+0.182 (n=753)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 6954.443 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.149 (n=1069)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 168.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.158 (n=1192)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0072 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.3811` → IC=+0.141 (n=1192)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3811 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.187 (n=404)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 18.0 (IC base=+0.122)

- **PATRÓN** `ibs_20min` < `0.6177` → IC=+0.170 (n=1192)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6177 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.3453` → IC=+0.136 (n=1283)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.3453 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.91` → IC=+0.177 (n=422)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 6.91 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `0.8536` → IC=+0.142 (n=795)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8536 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.205 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` > `2.4874` → IC=+0.142 (n=358)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.4874 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `9966.3147` → IC=+0.159 (n=540)
...
- **FILTRO** `ibs_20min` > `0.5652` → IC=-0.182 (n=435)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.208 (n=1312)
...
- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.201 (n=1292)
...
- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.126 (n=1292)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.2233 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` < `0.1664` → IC=+0.129 (n=1289)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1664 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.8125` → IC=+0.132 (n=830)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.8125 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1347)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2888.477` → IC=+0.194 (n=586)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2888.477 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.133 (n=962)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1029` → IC=+0.140 (n=437)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1029 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.208 (n=1312)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.9592` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.9592 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.1948` → IC=+0.135 (n=1199)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1948 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.473` → IC=+0.154 (n=273)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.473 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.0447` → IC=+0.123 (n=1154)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.0447 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.276` → IC=+0.167 (n=160)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.276 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4573` → IC=+0.134 (n=389)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.4573 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.173` → IC=+0.125 (n=529)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.173 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3066.2091` → IC=+0.158 (n=437)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3066.2091 (IC base=+0.111)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.209 (n=820)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.197 (n=562)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 7.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `0.7351` → IC=+0.257 (n=1099)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7351 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` > `1.2244` → IC=+0.223 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2244 (IC base=+0.197)
...
- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.200 (n=1231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2089 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `0.8586` → IC=+0.214 (n=820)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8586 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.2365` → IC=+0.273 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2365 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `2.1696` → IC=+0.207 (n=1044)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1696 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.8114` → IC=+0.203 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8114 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.198 (n=1287)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `2587.3393` → IC=+0.197 (n=820)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2587.3393 (IC base=+0.197)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.237 (n=431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0083 (IC base=+0.205)

- **PATRÓN** `sigma_h` > `0.0223` → IC=+0.219 (n=585)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0223 (IC base=+0.205)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.218 (n=430)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.213 (n=591)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` < `0.4426` → IC=+0.246 (n=1290)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.365` → IC=+0.246 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.365 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6295` → IC=+0.217 (n=1290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6295 (IC base=+0.205)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2444` → IC=+0.196 (n=1012)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2444 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4601` → IC=+0.198 (n=1150)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4601 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2561.1058` → IC=+0.210 (n=860)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2561.1058 (IC base=+0.205)
...
- **PATRÓN** `ibs_20min` > `0.3984` → IC=+0.181 (n=1665)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.176 (n=776)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8709` → IC=+0.164 (n=961)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5597` → IC=+0.173 (n=533)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5597 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=1869)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `2477.985` → IC=+0.149 (n=1487)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2477.985 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.166 (n=1442)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 165.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.127 (n=1171)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6561` → IC=+0.132 (n=1755)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.6561 (IC base=+0.099)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3431` → IC=+0.127 (n=411)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3431 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.144 (n=372)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 9.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.2439` → IC=+0.146 (n=411)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.2439 (IC base=+0.105)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.328` → IC=+0.133 (n=186)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 3.328 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `0.7067` → IC=+0.139 (n=181)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.7067 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `14590.6209` → IC=+0.141 (n=274)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 14590.6209 (IC base=+0.105)
...
- **PATRÓN** `ibs_20min` < `0.3451` → IC=+0.197 (n=367)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.3451 (IC base=+0.124)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0953` → IC=+0.220 (n=162)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4315` → IC=+0.248 (n=434)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4315 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `0.3651` → IC=+0.253 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3651 (IC base=+0.204)
...
- **PATRÓN** `volumen_regimen` < `0.8399` → IC=+0.215 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8399 (IC base=+0.204)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=538)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.200 (n=3019)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.208 (n=1027)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.3429` → IC=+0.191 (n=1540)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.202 (n=1036)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.318 (n=554)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.257 (n=1069)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.257)

- **PATRÓN** `ibs_20min` < `0.3485` → IC=+0.290 (n=1033)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3485 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.427` → IC=+0.266 (n=1240)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.427 (IC base=+0.257)

- **PATRÓN** `volumen_pendiente_norm` > `0.2233` → IC=+0.299 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2233 (IC base=+0.257)

- **PATRÓN** `volumen_spike_ratio` > `1.8722` → IC=+0.277 (n=712)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8722 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `1773.87` → IC=+0.270 (n=782)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0829` → IC=+0.167 (n=481)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3102` → IC=+0.201 (n=1443)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.271` → IC=+0.151 (n=1293)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1213` → IC=+0.159 (n=1222)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1213 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4084` → IC=+0.152 (n=1388)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4084 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `13656.0542` → IC=+0.151 (n=962)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13656.0542 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `481.0` → IC=+0.154 (n=1320)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 481.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.162 (n=1258)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0057 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.3178` → IC=+0.158 (n=1258)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3178 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.6459` → IC=+0.191 (n=1258)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6459 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.6769` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6769 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.1286` → IC=+0.164 (n=1145)
...
- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.160 (n=1258)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1476)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.6723` → IC=+0.258 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6723 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.749` → IC=+0.291 (n=434)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.749 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.2162` → IC=+0.223 (n=1425)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2162 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.9054` → IC=+0.245 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9054 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.229 (n=967)
...
- **PATRÓN** `ibs_20min` < `0.3651` → IC=+0.270 (n=1190)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3651 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.751` → IC=+0.279 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.751 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` > `0.3533` → IC=+0.295 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3533 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.7875` → IC=+0.236 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7875 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.2288` → IC=+0.237 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2288 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.251 (n=850)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1862.1984` → IC=+0.252 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1862.1984 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.253 (n=391)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4353` → IC=+0.143 (n=1542)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4353 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8799` → IC=+0.260 (n=699)
...
- **PATRÓN** `volumen_regimen` < `0.877` → IC=+0.159 (n=1028)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.137 (n=573)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.693` → IC=+0.184 (n=1256)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.693 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.3631` → IC=+0.139 (n=1256)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3631 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.113` → IC=+0.186 (n=189)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 11.113 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.6958` → IC=+0.143 (n=553)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6958 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `1.1836` → IC=+0.139 (n=419)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 1.1836 (IC base=+0.134)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.149 (n=1185)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4416 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `10998.3764` → IC=+0.205 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10998.3764 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `183.0` → IC=+0.139 (n=1180)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 183.0 (IC base=+0.134)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.134 (n=1022)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4695` → IC=+0.185 (n=1533)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4695 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `1.047` → IC=+0.199 (n=290)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 1.047 (IC base=+0.105)
...
- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1505)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2141` → IC=+0.128 (n=1220)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2141 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.124 (n=1454)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.155 (n=662)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7176 (IC base=+0.110)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2108` → IC=+0.121 (n=611)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 2.2108 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2831.1065` → IC=+0.157 (n=502)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 2831.1065 (IC base=+0.110)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.215 (n=1022)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.204 (n=1369)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.203)

- **PATRÓN** `ibs_20min` > `0.5116` → IC=+0.244 (n=1532)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.143` → IC=+0.263 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.143 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.0718` → IC=+0.204 (n=1348)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0718 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6343` → IC=+0.210 (n=1532)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.211 (n=1582)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2595.6306` → IC=+0.211 (n=1021)
...
- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.221 (n=557)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1759)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.257 (n=1668)
...
- **PATRÓN** `dist_vwap_pct` < `0.8436` → IC=+0.204 (n=1862)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2848` → IC=+0.255 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2848 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `2.2198` → IC=+0.197 (n=1307)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2198 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4438` → IC=+0.202 (n=1485)
...
- **PATRÓN** `libro_liquidez` > `2568.8412` → IC=+0.202 (n=1112)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.135 (n=2809)

- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.158 (n=2387)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0093 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5227` → IC=+0.160 (n=2713)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.9401` → IC=+0.211 (n=904)
...
- **PATRÓN** `volumen_regimen` > `0.9028` → IC=+0.163 (n=1136)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4583` → IC=+0.155 (n=894)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=1799)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `2755.3734` → IC=+0.154 (n=2423)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4793` → IC=+0.153 (n=2119)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4793 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.169 (n=781)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.159 (n=723)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 4.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` < `0.1781` → IC=+0.162 (n=932)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.1781 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` > `0.6851` → IC=+0.143 (n=399)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.6851 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.2426` → IC=+0.126 (n=1895)
...
- **PATRÓN** `volumen_regimen` < `0.9014` → IC=+0.149 (n=1345)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.9014 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.148 (n=995)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.133)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.135 (n=2809)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.173 (n=313)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0056 (IC base=+0.160)

- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.174 (n=317)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0033 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.0919` → IC=+0.194 (n=119)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.0919 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.170 (n=362)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 5.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` < `0.5204` → IC=+0.199 (n=237)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.5204 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.2159` → IC=+0.185 (n=163)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.2159 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` < `0.4014` → IC=+0.164 (n=349)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4014 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.308` → IC=+0.173 (n=383)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` < 2.308 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `0.8476` → IC=+0.198 (n=236)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 0.8476 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.3101` → IC=+0.295 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3101 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `1.454` → IC=+0.194 (n=119)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.454 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `2.7022` → IC=+0.208 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7022 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `12563.2849` → IC=+0.199 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12563.2849 (IC base=+0.160)
...
- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.149 (n=72)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0119 (IC base=+0.059)

- **PATRÓN** `drift_60min` |x|≤ `0.3887` → IC=+0.130 (n=106)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.3887 (IC base=+0.059)

- **PATRÓN** `ibs_20min` < `0.2353` → IC=+0.167 (n=70)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.2353 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.8077` → IC=+0.167 (n=52)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.8077 (IC base=+0.059)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.126 (n=600)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` > 0.5 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2847.4573` → IC=+0.180 (n=204)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2847.4573 (IC base=+0.109)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1531)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=687)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7235)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3049)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9577)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=3199)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9887)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.218 (n=519)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1655)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.204 (n=548)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=1662)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=581)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1746)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.166 (n=570)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1757)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.186 (n=537)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1612)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.192 (n=559)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1771)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2612)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2758)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2764)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=715)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=9017)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=20154)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.277 (n=7025)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=22146)

- **FILTRO** `ibs_7min` < `0.2931` → IC=-0.236 (n=7291)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2931
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21880)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9852)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19319)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9117)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=27435)

- **FILTRO** `ibs_7min` > `0.2945` → IC=-0.179 (n=9135)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2945
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27417)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=1138)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3636)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.254 (n=1573)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3201)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.180 (n=1145)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3629)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.151 (n=4242)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=2067)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.126 (n=2142)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4167)

- **FILTRO** `ibs_7min` > `0.7928` → IC=-0.205 (n=1577)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7928
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4732)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1192)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1220)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=3846)

- **FILTRO** `ibs_7min` < `0.7518` → IC=-0.189 (n=1266)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7518
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3800)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1261)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3805)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=1265)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3861)

- **FILTRO** `ibs_7min` > `0.2588` → IC=-0.172 (n=1281)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2588
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3845)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.185 (n=1279)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3847)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.173 (n=1115)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3399)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.311 (n=1096)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3418)

- **FILTRO** `ibs_7min` < `0.1963` → IC=-0.258 (n=1128)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1963
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3386)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1090)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3424)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1564)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5135)

- **FILTRO** `ibs_7min` > `0.759` → IC=-0.177 (n=1674)

  - _Acción_: SKIP cuando `ibs_7min` > 0.759
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=5025)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1540)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3254)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.245 (n=1173)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3621)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.181 (n=1197)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3597)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.177 (n=1197)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3597)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1229)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3696)

- **FILTRO** `ibs_7min` > `0.2753` → IC=-0.172 (n=1231)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2753
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3694)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.190 (n=1201)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3724)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.265 (n=1202)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3941)

- **FILTRO** `ibs_7min` < `0.7027` → IC=-0.230 (n=1285)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7027
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3858)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1678)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5253)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=1135)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3745)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.232 (n=1219)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3661)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1171)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3709)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.205 (n=1623)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4939)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=657)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1369)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1377)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.186 (n=463)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0043 (IC base=+0.185)

- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.216 (n=629)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0081 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.1627` → IC=+0.193 (n=1220)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.1627 (IC base=+0.185)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2175` → IC=+0.190 (n=463)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.95€ cuando `delta_ratio_macro` |x|> 0.2175 (IC base=+0.185)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1315` → IC=+0.230 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1315 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.198 (n=980)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 11.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.186 (n=1395)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 16.0 (IC base=+0.185)

- **PATRÓN** `ibs_15` > `0.6129` → IC=+0.260 (n=1387)
...
- **PATRÓN** `dist_vwap_pct` < `0.5591` → IC=+0.174 (n=1366)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5591 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.103` → IC=+0.271 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.103 (IC base=+0.185)

- **PATRÓN** `libro_liquidez` > `2968.8` → IC=+0.192 (n=924)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2968.8 (IC base=+0.185)

### UPDOWN_GBM#60min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=474)

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.225 (n=220)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0037 (IC base=+0.204)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1492` → IC=+0.281 (n=112)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1492 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.234 (n=302)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.204)

- **PATRÓN** `ibs_15` > `0.7061` → IC=+0.267 (n=329)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7061 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.281 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.503` → IC=+0.257 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.503 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15869.2533` → IC=+0.241 (n=110)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.167 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0034 (IC base=+0.141)

- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.160 (n=148)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0057 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.0692` → IC=+0.169 (n=143)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0692 (IC base=+0.141)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2375` → IC=+0.167 (n=109)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.2375 (IC base=+0.141)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.258` → IC=+0.173 (n=224)

  - _Acción_: Kelly boost +0.86€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.258 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.164 (n=242)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 11.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.141 (n=327)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 16.0 (IC base=+0.141)

- **PATRÓN** `ibs_15` > `0.6213` → IC=+0.222 (n=325)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6213 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1549` → IC=+0.160 (n=251)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1549 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.56` → IC=+0.213 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.56 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.147 (n=148)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.141)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1498` → IC=+0.201 (n=152)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1498 (IC base=+0.158)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0662` → IC=+0.192 (n=154)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.0662 (IC base=+0.158)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3414` → IC=+0.229 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3414 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.192 (n=115)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 11.0 (IC base=+0.158)

- **PATRÓN** `ibs_15` > `0.6` → IC=+0.243 (n=173)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` > `0.116` → IC=+0.163 (n=99)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.116 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` < `0.6172` → IC=+0.163 (n=197)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.6172 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.389` → IC=+0.395 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.389 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.167 (n=136)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `3004.732` → IC=+0.275 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3004.732 (IC base=+0.158)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.213 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.158)

### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.5687` → IC=-0.142 (n=118)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.5687
...
- **PATRÓN** `sigma_h` > `0.0167` → IC=+0.223 (n=251)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0401` → IC=+0.189 (n=377)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.0401 (IC base=+0.179)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0926` → IC=+0.240 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0926 (IC base=+0.179)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.236 (n=127)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.179)

- **PATRÓN** `ibs_15` > `0.5429` → IC=+0.273 (n=377)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5429 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` > `0.1228` → IC=+0.194 (n=227)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1228 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` < `0.6263` → IC=+0.182 (n=439)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.489` → IC=+0.179 (n=338)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 7.489 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `2846.2656` → IC=+0.258 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2846.2656 (IC base=+0.179)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.165 (n=419)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1089` → IC=+0.352 (n=248)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1089 (IC base=+0.341)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1476` → IC=+0.363 (n=247)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1332` → IC=+0.392 (n=127)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1332 (IC base=+0.341)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.361 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.341)

- **PATRÓN** `ibs_15` > `0.7856` → IC=+0.382 (n=371)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7856 (IC base=+0.341)

- **PATRÓN** `dist_vwap_pct` > `0.4248` → IC=+0.384 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4248 (IC base=+0.341)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.238` → IC=+0.352 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.238 (IC base=+0.341)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.346 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.341)

- **PATRÓN** `libro_liquidez` > `3505.1277` → IC=+0.358 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3505.1277 (IC base=+0.341)

- **PATRÓN** `ballena_activa_n` < `474.0` → IC=+0.363 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 474.0 (IC base=+0.341)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.213 (n=598)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1798)
...
- **FILTRO** `libro_liquidez` < `3905.4186` → IC=-0.134 (n=1581)

  - _Acción_: SKIP cuando `libro_liquidez` < 3905.4186
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=815)
...
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.220 (n=362)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1087)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.227 (n=478)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.183 (n=971)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.207 (n=914)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.182 (n=535)

- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.244 (n=256)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.716
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1193)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.186 (n=135)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0027 (IC base=+0.084)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1073` → IC=+0.360 (n=48)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1073 (IC base=+0.084)
...
- **PATRÓN** `dist_vwap_pct` < `0.5257` → IC=+0.283 (n=164)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5257 (IC base=+0.084)
...
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.238 (n=590)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7722` → IC=+0.231 (n=519)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.236 (n=403)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.225)

- **PATRÓN** `ibs_15` < `0.3561` → IC=+0.264 (n=590)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.262` → IC=+0.229 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.262 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3504.653` → IC=+0.228 (n=590)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.293 (n=607)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.292)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.299 (n=276)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1438` → IC=+0.298 (n=405)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1438 (IC base=+0.292)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2199` → IC=+0.329 (n=332)
...
- **PATRÓN** `ibs_15` > `0.8404` → IC=+0.329 (n=607)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.294 (n=745)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.310 (n=308)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6129 sube el IC de +0.185 a +0.260 en UPDOWN_GBM#15min (n=1387). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7061 sube el IC de +0.204 a +0.267 en UPDOWN_GBM#BTC#15min (n=329). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6213 sube el IC de +0.141 a +0.222 en UPDOWN_GBM#ETH#15min (n=325). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#SOL#15min**: dentro de BUY_YES, IBS > 0.6 sube el IC de +0.158 a +0.243 en UPDOWN_GBM#SOL#15min (n=173). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5429 sube el IC de +0.179 a +0.273 en UPDOWN_GBM#XRP#15min (n=377). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.045 a +0.165 en UPDOWN_GBM#XRP#15min (n=419). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.356 sube el IC de -0.039 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1456). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7413 sube el IC de +0.084 a +0.331 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=152). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3561 sube el IC de +0.225 a +0.264 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=590). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3636 sube el IC de -0.045 a +0.259 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=272). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8404 sube el IC de +0.292 a +0.329 en UPDOWN_GBM_IBS_ALTO (n=607). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8489 sube el IC de +0.300 a +0.341 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=269). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7856 sube el IC de +0.341 a +0.382 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=371). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1238 | +0.089 | +151.61€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1238 | +0.089 | +151.61€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 910 | +0.099 | +128.26€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 910 | +0.099 | +128.26€ | 2 | 7 |
...
| ✅ BALLENAS_TARDIAS | 23207 | -0.093 | -3091.07€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1389 | -0.046 | -212.04€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21818 | -0.096 | -2879.03€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3532 | -0.088 | -575.89€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3532 | -0.088 | -575.89€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1389 | -0.046 | -212.04€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1389 | -0.046 | -212.04€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6647 | -0.032 | -601.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6647 | -0.032 | -601.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6122 | -0.095 | -443.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6122 | -0.095 | -443.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5143 | -0.180 | -1096.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5143 | -0.180 | -1096.72€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15579 | -0.033 | +4119.65€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4103 | -0.002 | +1822.78€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11476 | -0.044 | +2296.87€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15579 | -0.033 | +4119.65€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4103 | -0.002 | +1822.78€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11476 | -0.044 | +2296.87€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1383 | -0.101 | -182.47€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 153 | -0.042 | -15.28€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1230 | -0.109 | -167.19€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 763 | -0.089 | -93.79€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 129 | -0.034 | -10.06€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 634 | -0.101 | -83.73€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 422 | -0.130 | -74.80€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 398 | -0.133 | -69.57€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 84828 | +0.113 | -4300.22€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13017 | +0.184 | -430.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 335 | -0.102 | -47.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 65832 | +0.101 | -3637.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5644 | +0.110 | -184.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 10957 | +0.097 | -970.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 43 | -0.167 | -2.82€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 10899 | +0.099 | -956.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 17161 | +0.132 | -340.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4057 | +0.201 | -139.10€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 10910 | +0.112 | -159.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2152 | +0.109 | -19.20€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 