# Hipótesis automáticas — 2026-07-19 07:37 UTC
_Generado por shadow_postmortem.py sobre 22133 resoluciones (PNL=+5378.69€)_
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.219 (n=653)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=1641)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.176)

- **PATRÓN** `libro_liquidez` > `4295.7303` → IC=+0.176 (n=967)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 4295.7303 (IC base=+0.176)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.257 (n=138)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `6900.2197` → IC=+0.221 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6900.2197 (IC base=+0.221)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.245 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.309` → IC=+0.216 (n=86)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.309 (IC base=+0.106)
...
- **PATRÓN** `dist_vwap_pct` > `0.1635` → IC=+0.205 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1635 (IC base=+0.165)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.172 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 12.0 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.153 (n=289)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 18.0 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.1309` → IC=+0.179 (n=110)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1309 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.8639` → IC=+0.141 (n=221)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.8639 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.778` → IC=+0.281 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.778 (IC base=+0.145)
...
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.186 (n=135)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0118 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.159 (n=209)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 12.0 (IC base=+0.132)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.133 (n=276)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 16.0 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.1497` → IC=+0.178 (n=119)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1497 (IC base=+0.132)
...
- **PATRÓN** `sigma_h` > `0.0135` → IC=+0.192 (n=329)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0135 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.134 (n=887)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 8.0 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.135 (n=919)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 16.0 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` > `0.5262` → IC=+0.173 (n=194)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.5262 (IC base=+0.130)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.399` → IC=+0.285 (n=77)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.399 (IC base=+0.079)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 283 | +0.146 | +17.70€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 283 | +0.146 | +17.70€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 118 | +0.175 | +11.03€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 118 | +0.175 | +11.03€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 105 | +0.136 | +2.86€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 105 | +0.136 | +2.86€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.097 | +3.81€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.097 | +3.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 3721 | +0.186 | +61.46€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 2418 | +0.220 | +105.16€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1080 | +0.194 | +36.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 806 | +0.212 | +6.16€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1320 | +0.181 | +22.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 800 | +0.224 | +53.59€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1305 | +0.184 | +0.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 800 | +0.224 | +47.96€ | 0 | 6 |
...
| ✅ GBM_LATE_15M | 5757 | +0.107 | +1938.17€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 5757 | +0.107 | +1938.17€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 1558 | +0.101 | +609.78€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1558 | +0.101 | +609.78€ | 1 | 7 |
| ✅ GBM_LATE_15M#XRP | 1506 | +0.164 | +830.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1506 | +0.164 | +830.61€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2987 | +0.153 | +1773.19€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2987 | +0.153 | +1773.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 761 | +0.117 | +359.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 761 | +0.117 | +359.27€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 787 | +0.116 | +361.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 787 | +0.116 | +361.09€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 766 | +0.115 | +341.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 766 | +0.115 | +341.69€ | 1 | 9 |
...
| ✅ GBM_LATE_15M_TARDIO | 2932 | +0.101 | +1020.44€ | 0 | 10 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2932 | +0.101 | +1020.44€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 659 | +0.049 | +131.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 659 | +0.049 | +131.43€ | 1 | 3 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 595 | +0.185 | +274.36€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 595 | +0.185 | +274.36€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 149 | +0.149 | +63.35€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 149 | +0.149 | +63.35€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.180: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.055 n=726 | neutral: IC=-0.004 n=540 | overbought(IBS>0.7): IC=+0.176 n=683
  - _Datos_: n=2086 IC=+0.087 PNL=+440.15€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.118 n=13310 | tras_1loss IC=+0.088 n=8625 | tras_2loss IC=+0.054 n=3519/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=19675 IC=+0.121 PNL=+5454.57€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=19675 IC=+0.121 PNL=+5454.57€
