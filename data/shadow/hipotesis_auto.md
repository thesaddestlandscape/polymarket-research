# Hipótesis automáticas — 2026-06-30 03:47 UTC
_Generado por shadow_postmortem.py sobre 1361 resoluciones (PNL=-49.90€)_
...
- **PATRÓN** `sigma_h` > `0.0128` → IC=+0.147 (n=15)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0128 (IC base=+0.062)
...
- **LIVE-CANDIDATA**: `UPDOWN_GBM#BTC#60min` — IC=+0.094 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.023) — sin ventaja clara. oversold(IBS<0.3): IC=-0.031 n=30 | neutral: IC=-0.048 n=29 | overbought(IBS>0.7): IC=-0.025 n=38
  - _Datos_: n=100 IC=-0.039 PNL=-10.06€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 100 ops, 17 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Estado_: ETH#60min: n=30/40 IC=+0.062 PNL=+2.12€ | BTC#60min: n=30/40 IC=+0.094 PNL=+1.93€ | SOL#60min: n=17/40 IC=-0.067 PNL=-0.21€
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 389/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=290 IC=+0.000 PNL=-3.30€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=290 IC=+0.000 PNL=-3.30€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=61 IC=+0.040 PNL=+3.39€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=61 IC=+0.040 PNL=+3.39€
