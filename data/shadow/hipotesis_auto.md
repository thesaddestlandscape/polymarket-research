# Hipótesis automáticas — 2026-07-12 18:34 UTC
_Generado por shadow_postmortem.py sobre 11276 resoluciones (PNL=+2140.81€)_
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 17.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.219 (n=190)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 10.0 (IC base=+0.152)

- **PATRÓN** `py_entrada` < `0.275` → IC=+0.307 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.159 (n=438)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `6004.8923` → IC=+0.172 (n=175)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 6004.8923 (IC base=+0.152)
...
- **PATRÓN** `libro_liquidez` > `7704.0798` → IC=+0.245 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7704.0798 (IC base=+0.220)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.244 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.245` → IC=+0.300 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `1598.2993` → IC=+0.238 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1598.2993 (IC base=+0.212)
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.150 (n=939)
...
- **PATRÓN** `dist_vwap_pct` > `0.5632` → IC=+0.167 (n=40)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.5632 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.4251` → IC=+0.171 (n=141)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.4251 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.06` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 3.06 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` < `0.01` → IC=+0.177 (n=156)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.01 (IC base=+0.155)

- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.167 (n=118)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0149 (IC base=+0.155)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.219 (n=261)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` < `0.1508` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1508 (IC base=+0.155)
...
- **PATRÓN** `sigma_h` < `0.0171` → IC=+0.186 (n=234)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0171 (IC base=+0.178)

- **PATRÓN** `sigma_h` > `0.0298` → IC=+0.206 (n=117)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0298 (IC base=+0.178)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.258 (n=130)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` < `0.2854` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.2854 (IC base=+0.178)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.194 (n=334)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0049 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.180 (n=251)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1341` → IC=+0.202 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1341 (IC base=+0.174)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.404` → IC=+0.318 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.404 (IC base=+0.174)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.181 (n=384)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0043 (IC base=+0.156)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.187 (n=148)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 6.0 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.2537` → IC=+0.254 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2537 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.57` → IC=+0.288 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.57 (IC base=+0.156)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.232 (n=54)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.107)
...
- **PATRÓN** `dist_vwap_pct` < `0.152` → IC=+0.294 (n=32)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.152 (IC base=+0.107)
...
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.312 (n=67)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0088 (IC base=+0.282)
...
- **PATRÓN** `sigma_h` > `0.0123` → IC=+0.147 (n=148)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.1776` → IC=+0.163 (n=90)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1776 (IC base=+0.082)
...
- **PATRÓN** `sigma_h` < `0.0082` → IC=+0.232 (n=39)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0082 (IC base=+0.038)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.143 (n=40)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 6.0 (IC base=+0.038)

- **PATRÓN** `dist_vwap_pct` < `0.194` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.194 (IC base=+0.038)
...
- **PATRÓN** `sigma_h` > `0.0306` → IC=+0.262 (n=40)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0306 (IC base=+0.206)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.250 (n=62)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 10.0 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` < `0.1854` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1854 (IC base=+0.206)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 991 | +0.183 | +12.18€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 637 | +0.210 | +9.47€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 290 | +0.185 | -4.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 212 | +0.206 | -7.57€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 346 | +0.198 | +16.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 211 | +0.223 | +16.10€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 3659 | +0.114 | +1229.13€ | 0 | 10 |
| ✅ GBM_LATE_15M#15min | 3659 | +0.114 | +1229.13€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 954 | +0.139 | +480.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 954 | +0.139 | +480.85€ | 0 | 8 |
| ✅ GBM_LATE_15M#XRP | 881 | +0.172 | +467.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 881 | +0.172 | +467.98€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1010 | +0.165 | +585.81€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1010 | +0.165 | +585.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 265 | +0.159 | +167.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 265 | +0.159 | +167.86€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 270 | +0.132 | +121.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 270 | +0.132 | +121.08€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 283 | +0.121 | +102.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 283 | +0.121 | +102.05€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 192 | +0.278 | +194.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 192 | +0.278 | +194.83€ | 0 | 6 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1165 | +0.082 | +291.80€ | 1 | 7 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1165 | +0.082 | +291.80€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 303 | +0.038 | +38.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 303 | +0.038 | +38.63€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 300 | +0.199 | +198.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 300 | +0.199 | +198.93€ | 0 | 7 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.092 n=6390 | tras_1loss IC=+0.048 n=4748 | tras_2loss IC=+0.013 n=2120/40 | gap=+0.079 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8818 IC=+0.098 PNL=+2216.70€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8818 IC=+0.098 PNL=+2216.70€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.176 > 0.08 con n=69 PNL=+1.25€
  - _Datos_: n=69 IC=+0.176 PNL=+1.25€
