# Hipótesis automáticas — 2026-07-02 01:22 UTC
_Generado por shadow_postmortem.py sobre 2510 resoluciones (PNL=-78.24€)_
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.267 (n=58)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.091)

- **PATRÓN** `drift_60min` |x|≤ `0.7494` → IC=+0.121 (n=101)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.7494 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.091)

- **PATRÓN** `ibs_15` < `0.0669` → IC=+0.237 (n=36)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0669 (IC base=+0.091)
...
- **FILTRO** `drift_15min` |x|> `0.5685` → IC=-0.150 (n=18)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0669 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.237 n=36). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 758 | -0.030 | -27.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 539 | -0.005 | -1.67€ | 1 | 4 |
...
| ✅ UPDOWN_GBM#SOL | 131 | -0.071 | -7.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 79 | -0.043 | -2.86€ | 5 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 23 | -0.060 | -3.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 23 | -0.140 | -2.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 62 | +0.016 | +6.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 51 | +0.066 | +10.13€ | 1 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.079) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.049 n=111 | overbought(IBS>0.7): IC=-0.037 n=132
  - _Datos_: n=368 IC=-0.019 PNL=-1.84€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=79 IC=-0.043 PNL=-2.86€
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1188 | tras_1loss IC=-0.035 n=1240 | tras_2loss IC=-0.047 n=643/40 | gap=+0.050 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.022 n=90 | contrario_BTC IC=-0.037 n=39/40 | gap=-0.015 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=635 IC=-0.023 PNL=-13.53€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=635 IC=-0.023 PNL=-13.53€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=227 IC=+0.015 PNL=-7.60€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=227 IC=+0.015 PNL=-7.60€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=156 IC=+0.063 PNL=+26.19€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=156 IC=+0.063 PNL=+26.19€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 93/200 ops en el filtro definido (IC actual=+0.079 PNL=+14.68€)
  - _Datos_: n=93 IC=+0.079 PNL=+14.68€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 93/100 ops en el filtro definido (IC actual=+0.079 PNL=+14.68€)
  - _Datos_: n=93 IC=+0.079 PNL=+14.68€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 11/40 ops en el filtro definido (IC actual=+0.021 PNL=-1.29€)
  - _Datos_: n=11 IC=+0.021 PNL=-1.29€
