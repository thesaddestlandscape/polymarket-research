# Hipótesis automáticas — 2026-07-21 19:25 UTC
_Generado por shadow_postmortem.py sobre 27362 resoluciones (PNL=+6248.23€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.203 (n=1528)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1919)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.229 (n=271)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.126 (n=1150)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.176 (n=508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 17.0 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.9819` → IC=+0.164 (n=117)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.9819 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.7608` → IC=+0.147 (n=1332)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.7608 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.158` → IC=+0.158 (n=264)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 6.158 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.134 (n=159)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0051 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.151 (n=173)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 15.0 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.527` → IC=+0.167 (n=124)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 4.527 (IC base=+0.101)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7529` → IC=+0.214 (n=344)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.7529 sube el IC de +0.049 a +0.214 en UPDOWN_GBM#15min (n=344). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ FAVORITO_CONFIRMADO | 4722 | +0.184 | +56.15€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3079 | +0.215 | +97.35€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1374 | +0.196 | +50.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1025 | +0.211 | +5.02€ | 0 | 5 |
...
| ✅ GBM_LATE_15M | 6603 | +0.099 | +2113.82€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 6603 | +0.099 | +2113.82€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1577 | +0.070 | +281.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1577 | +0.070 | +281.38€ | 0 | 4 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3800 | +0.134 | +2044.72€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3800 | +0.134 | +2044.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 965 | +0.097 | +397.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 965 | +0.097 | +397.52€ | 0 | 8 |
...
| ✅ GBM_LATE_15M_TARDIO | 3771 | +0.086 | +1214.09€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3771 | +0.086 | +1214.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 901 | +0.053 | +158.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 901 | +0.053 | +158.18€ | 0 | 5 |
...
| ✅ UPDOWN_GBM | 2078 | +0.025 | +165.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1816 | +0.048 | +204.40€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1025 | +0.167 | +462.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1025 | +0.167 | +462.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 100 | +0.186 | +52.00€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 100 | +0.186 | +52.00€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 121 | +0.134 | +23.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 121 | +0.134 | +23.67€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.189: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.055 n=950 | neutral: IC=+0.004 n=742 | overbought(IBS>0.7): IC=+0.193 n=949
  - _Datos_: n=2825 IC=+0.096 PNL=+673.96€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.114 n=16357 | tras_1loss IC=+0.083 n=10802 | tras_2loss IC=+0.049 n=4471/40 | gap=+0.065 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.088 n=1196/40 PNL=+255.63€ | H=15h UTC: IC=+0.148 n=1181/40 PNL=+443.93€ | H=17h UTC: IC=+0.092 n=1140/40 PNL=+216.18€ | H=19h UTC: IC=+0.123 n=1034/40 PNL=+268.65€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=249 IC=+0.002 PNL=-1.12€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=249 IC=+0.002 PNL=-1.12€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1946 IC=+0.031 PNL=+180.06€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1946 IC=+0.031 PNL=+180.06€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=860 IC=+0.049 PNL=+102.62€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=860 IC=+0.049 PNL=+102.62€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.083 > 0.08 con n=973 PNL=+149.51€
  - _Datos_: n=973 IC=+0.083 PNL=+149.51€
...
**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.132 > 0.08 con n=153 PNL=+41.13€
  - _Datos_: n=153 IC=+0.132 PNL=+41.13€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=24894 IC=+0.113 PNL=+6326.12€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=24894 IC=+0.113 PNL=+6326.12€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1010 IC=+0.019 PNL=+72.07€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1010 IC=+0.019 PNL=+72.07€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.172 > 0.1 con n=632 PNL=+237.97€
  - _Datos_: n=632 IC=+0.172 PNL=+237.97€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=865 IC=+0.054 PNL=+108.55€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=865 IC=+0.054 PNL=+108.55€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.146 > 0.08 con n=456 PNL=+148.87€
  - _Datos_: n=456 IC=+0.146 PNL=+148.87€
