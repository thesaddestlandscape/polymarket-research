# Hipótesis automáticas — 2026-08-10 08:19 UTC
_Generado por shadow_postmortem.py sobre 103668 resoluciones (PNL=+14700.80€)_
...
- **PATRÓN** `restante_min` < `4.62` → IC=+0.134 (n=676)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` < 4.62 (IC base=+0.131)

- **PATRÓN** `restante_min` > `4.85` → IC=+0.143 (n=463)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` > 4.85 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=943)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.131)

- **PATRÓN** `lag_apertura_s` < `8.55` → IC=+0.142 (n=439)

  - _Acción_: Kelly boost +0.71€ cuando `lag_apertura_s` < 8.55 (IC base=+0.131)
...
- **PATRÓN** `restante_min` > `4.86` → IC=+0.132 (n=180)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` > 4.86 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.137 (n=444)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `restante_min` < `4.95` → IC=+0.150 (n=526)

  - _Acción_: Kelly boost +0.75€ cuando `restante_min` < 4.95 (IC base=+0.142)

- **PATRÓN** `restante_min` > `4.19` → IC=+0.148 (n=450)

  - _Acción_: Kelly boost +0.74€ cuando `restante_min` > 4.19 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=470)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 7.0 (IC base=+0.142)

- **PATRÓN** `lag_apertura_s` < `44.78` → IC=+0.150 (n=441)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 44.78 (IC base=+0.142)
...
| ✅ BALLENAS_TARDIAS | 2914 | -0.061 | -628.04€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 467 | +0.219 | -43.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2447 | -0.115 | -584.99€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 563 | -0.052 | -73.49€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 563 | -0.052 | -73.49€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 577 | -0.194 | -324.67€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 577 | -0.194 | -324.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 28604 | +0.119 | -700.18€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6628 | +0.196 | -123.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 455 | +0.049 | -40.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 19501 | +0.093 | -578.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2020 | +0.137 | +42.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3133 | +0.081 | -189.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 13 | -0.022 | -3.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3115 | +0.082 | -189.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6107 | +0.131 | -96.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2069 | +0.184 | -104.68€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 148 | +0.053 | -15.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3124 | +0.096 | -44.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 766 | +0.146 | +68.55€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3131 | +0.083 | -168.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 16 | +0.222 | +8.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3114 | +0.081 | -178.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6573 | +0.136 | -20.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2234 | +0.195 | +6.81€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 149 | -0.017 | -32.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3527 | +0.105 | -6.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 663 | +0.130 | +12.52€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6498 | +0.134 | -213.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2255 | +0.208 | -27.27€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 150 | +0.105 | +4.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3502 | +0.088 | -152.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 591 | +0.131 | -38.93€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3162 | +0.105 | -11.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 41 | +0.128 | -3.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3119 | +0.104 | -6.78€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 13046 | +0.200 | -944.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 13046 | +0.200 | -944.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2336 | +0.160 | -321.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2336 | +0.160 | -321.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2070 | +0.226 | -49.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2070 | +0.226 | -49.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2259 | +0.184 | -239.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2259 | +0.184 | -239.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2113 | +0.221 | -71.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2113 | +0.221 | -71.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2118 | +0.218 | -91.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2118 | +0.218 | -91.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2150 | +0.199 | -171.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2150 | +0.199 | -171.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 1330 | +0.131 | +19.97€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 1330 | +0.131 | +19.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 662 | +0.119 | -3.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 662 | +0.119 | -3.96€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 668 | +0.142 | +23.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 668 | +0.142 | +23.93€ | 0 | 6 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.132 n=63568 | tras_1loss IC=+0.087 n=39851 | tras_2loss IC=+0.050 n=16425/40 | gap=+0.082 (umbral 0.05)
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2336 IC=+0.160 PNL=-321.50€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2336 IC=+0.160 PNL=-321.50€
