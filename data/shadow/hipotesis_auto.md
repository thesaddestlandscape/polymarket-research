# Hipótesis automáticas — 2026-09-20 13:03 UTC
_Generado por shadow_postmortem.py sobre 526566 resoluciones (PNL=+58037.30€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.87` → IC=-0.236 (n=6390)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.87
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19172)
...
- **FILTRO** `restante_s_al_confirmar` < `493.31` → IC=-0.151 (n=342)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 493.31
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1029)
...
- **FILTRO** `restante_s_al_confirmar` < `160.09` → IC=-0.231 (n=1508)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.09
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4526)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.85` → IC=-0.364 (n=1258)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.85
  - _Potencial_: sin este filtro IC_bueno=-0.116 (n=3778)
...
- **FILTRO** `py_entrada` > `0.54` → IC=-0.170 (n=210)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.203 (n=72)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.198 (n=12829)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=3208)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `5465.4064` → IC=+0.173 (n=2040)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 5465.4064 (IC base=+0.099)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.236 (n=9798)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=5270)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `7509.4511` → IC=+0.173 (n=1977)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7509.4511 (IC base=+0.131)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1521)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.351 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1909)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.204 (n=1533)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=1959)
...
- **PATRÓN** `py_entrada` > `0.62` → IC=+0.177 (n=298)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.142 (n=414)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 11.0 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.140 (n=600)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=498)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `1300.2394` → IC=+0.147 (n=596)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1300.2394 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.174 (n=1019)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=10258)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=9853)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.223 (n=3561)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2411)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2524)
...
- **PATRÓN** `libro_liquidez` > `2062.8229` → IC=+0.440 (n=464)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5609)
...
- **PATRÓN** `lag_apertura_s` < `3.57` → IC=+0.147 (n=2112)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 3.57 (IC base=+0.125)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=2305)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.117)

- **PATRÓN** `restante_min` < `4.49` → IC=+0.126 (n=2847)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.49 (IC base=+0.117)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.145 (n=2264)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` > 4.96 (IC base=+0.117)

- **PATRÓN** `lag_apertura_s` < `2.36` → IC=+0.148 (n=2148)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 2.36 (IC base=+0.117)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.316 (n=714)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1588.4149` → IC=+0.294 (n=1014)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1588.4149 (IC base=+0.288)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.293 (n=312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4193.5606` → IC=+0.289 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4193.5606 (IC base=+0.273)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3518` → IC=+0.124 (n=6236)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3518 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9797` → IC=+0.237 (n=2363)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9797 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.2068` → IC=+0.246 (n=1514)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2068 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.904` → IC=+0.172 (n=2734)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 5.904 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.245 (n=1861)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.0513` → IC=+0.243 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0513 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` < `0.1753` → IC=+0.195 (n=4958)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` < 0.1753 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.3078` → IC=+0.209 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3078 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.9158` → IC=+0.203 (n=3185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9158 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5698` → IC=+0.132 (n=8590)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5698 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5602` → IC=+0.186 (n=575)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5602 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.141` → IC=+0.171 (n=2678)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.141 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7025` → IC=+0.175 (n=1285)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7025 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.172 (n=1948)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8706 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.223 (n=1416)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5838` → IC=+0.200 (n=4340)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5838 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `144.0` → IC=+0.210 (n=4635)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 144.0 (IC base=+0.062)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.177 (n=540)
...
- **PATRÓN** `drift_60min` |x|≤ `0.334` → IC=+0.167 (n=1608)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.334 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.166 (n=776)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.175 (n=1084)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 11.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.271 (n=623)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4349` → IC=+0.165 (n=1494)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4349 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.247 (n=1055)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.247 (n=803)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.377` → IC=+0.249 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.377 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0922` → IC=+0.230 (n=1000)
...
- **PATRÓN** `libro_liquidez` > `1773.87` → IC=+0.244 (n=787)
...
- **PATRÓN** `dist_vwap_pct` < `0.129` → IC=+0.214 (n=924)
...
- **PATRÓN** `volumen_regimen` < `1.2518` → IC=+0.220 (n=1213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2518 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `0.8723` → IC=+0.212 (n=808)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8723 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` > `0.0746` → IC=+0.216 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0746 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` < `1.4038` → IC=+0.223 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4038 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.3852` → IC=+0.213 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3852 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `12240.9476` → IC=+0.219 (n=1083)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12240.9476 (IC base=+0.212)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.174 (n=430)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0026 (IC base=+0.133)
...
- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.166 (n=1282)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6828 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.1247` → IC=+0.151 (n=1157)
...
- **PATRÓN** `volumen_regimen` < `1.2085` → IC=+0.145 (n=1282)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2085 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` > `0.8523` → IC=+0.134 (n=854)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.8523 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.1566` → IC=+0.172 (n=345)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1566 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.146 (n=1172)
...
- **PATRÓN** `ballena_activa_n` < `413.0` → IC=+0.142 (n=1088)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.186 (n=1647)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.187 (n=1405)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 15.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.261 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.56` → IC=+0.233 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.56 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` < `0.2141` → IC=+0.188 (n=1550)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2141 (IC base=+0.184)
...
- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.197 (n=1266)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 42.0 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.224 (n=1336)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.221 (n=1193)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.145 (n=91)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1974)

- **PATRÓN** `ibs_20min` > `0.9396` → IC=+0.202 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9396 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.3391` → IC=+0.351 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3391 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` < `0.669` → IC=+0.328 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.669 (IC base=+0.019)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.599` → IC=+0.146 (n=623)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2916` → IC=+0.342 (n=74)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1718` → IC=+0.336 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1718 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.341 (n=262)
...
- **PATRÓN** `volumen_regimen` < `0.6989` → IC=+0.154 (n=310)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6989 (IC base=+0.008)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5087` → IC=+0.177 (n=581)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5087 (IC base=+0.008)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.129 (n=1962)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=968)

- **FILTRO** `sigma_ewma_delta_pct` > `8.632` → IC=-0.204 (n=319)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.632
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2611)
...
- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.126 (n=968)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2632 (IC base=-0.045)

- **PATRÓN** `dist_vwap_pct` > `0.6425` → IC=+0.304 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6425 (IC base=-0.045)

- **PATRÓN** `volumen_regimen` < `1.0999` → IC=+0.229 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0999 (IC base=-0.045)

- **PATRÓN** `volumen_pendiente_norm` < `0.1012` → IC=+0.226 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1012 (IC base=-0.045)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4253` → IC=+0.264 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4253 (IC base=-0.045)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6434` → IC=-0.190 (n=495)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6434
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1491)

- **FILTRO** `ibs_20min` < `0.69` → IC=-0.158 (n=1310)

  - _Acción_: SKIP cuando `ibs_20min` < 0.69
  - _Potencial_: sin este filtro IC_bueno=+0.078 (n=676)
...
- **FILTRO** `ibs_20min` > `0.7708` → IC=-0.204 (n=739)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7708
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=2219)

- **PATRÓN** `dist_vwap_pct` > `0.9226` → IC=+0.308 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9226 (IC base=-0.077)

- **PATRÓN** `dist_vwap_pct` < `0.2585` → IC=+0.316 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2585 (IC base=-0.077)

- **PATRÓN** `volumen_regimen` > `0.6119` → IC=+0.300 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6119 (IC base=-0.077)

- **PATRÓN** `volumen_pendiente_norm` < `0.1723` → IC=+0.279 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1723 (IC base=-0.077)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8487` → IC=+0.294 (n=173)
...
- **PATRÓN** `ibs_20min` > `0.4666` → IC=+0.186 (n=7886)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4666 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `1.0016` → IC=+0.290 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0016 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.536` → IC=+0.151 (n=4201)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.536 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.172` → IC=+0.231 (n=3076)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.172 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.6809` → IC=+0.243 (n=2747)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4763` → IC=+0.244 (n=1662)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4763 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.7163` → IC=+0.242 (n=1661)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7163 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.273 (n=4491)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.147 (n=2985)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0088 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5497` → IC=+0.151 (n=7878)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5497 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6733` → IC=+0.240 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6733 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1692` → IC=+0.235 (n=2328)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1692 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7154` → IC=+0.237 (n=1124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7154 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.2001` → IC=+0.245 (n=852)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2001 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.2486` → IC=+0.310 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2486 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.4914` → IC=+0.252 (n=1110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4914 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.356` → IC=+0.260 (n=1509)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.356 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.262 (n=3191)
...
- **FILTRO** `ibs_20min` < `0.2571` → IC=-0.145 (n=603)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.111 (n=1809)

- **FILTRO** `sigma_ewma_delta_pct` > `4.45` → IC=-0.162 (n=469)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.45
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1591)

- **PATRÓN** `ibs_20min` > `0.8916` → IC=+0.272 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8916 (IC base=+0.047)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5761` → IC=+0.206 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5761 (IC base=+0.047)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.182 (n=322)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 16.0 (IC base=+0.047)
...
- **FILTRO** `ibs_20min` > `0.8163` → IC=-0.149 (n=647)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8163
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1945)

- **PATRÓN** `ibs_20min` > `0.8635` → IC=+0.158 (n=594)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8635 (IC base=+0.018)

- **PATRÓN** `dist_vwap_pct` > `0.2926` → IC=+0.160 (n=307)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.2926 (IC base=+0.018)

- **PATRÓN** `volumen_regimen` < `1.195` → IC=+0.141 (n=800)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.195 (IC base=+0.018)

- **PATRÓN** `volumen_regimen` > `0.6556` → IC=+0.148 (n=715)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.195 (n=260)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.018)

- **PATRÓN** `ballena_activa_n` < `251.0` → IC=+0.191 (n=341)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1014` → IC=+0.249 (n=468)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=735)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1387` → IC=+0.260 (n=1235)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1929.6932` → IC=+0.253 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1929.6932 (IC base=+0.244)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.264 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 16.0 (IC base=+0.244)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.306 (n=996)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.0909` → IC=+0.285 (n=746)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1986` → IC=+0.277 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1986 (IC base=+0.285)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6267` → IC=+0.295 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6267 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` > `2.2108` → IC=+0.290 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2108 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.297 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `1912.76` → IC=+0.318 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1912.76 (IC base=+0.285)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.287 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.285)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2648` → IC=-0.201 (n=422)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2648
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=1268)

- **FILTRO** `ibs_20min` > `0.7894` → IC=-0.180 (n=529)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7894
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1590)

- **PATRÓN** `ibs_20min` > `0.8036` → IC=+0.159 (n=575)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8036 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.8507` → IC=+0.227 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8507 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `0.9592` → IC=+0.232 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9592 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` > `0.6434` → IC=+0.211 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6434 (IC base=+0.004)

- **PATRÓN** `volumen_pendiente_norm` > `0.1635` → IC=+0.283 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1635 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` < `2.0829` → IC=+0.247 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0829 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.261 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 104.0 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.1418` → IC=+0.204 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1418 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` < `0.4707` → IC=+0.180 (n=360)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.4707 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` < `1.1422` → IC=+0.186 (n=332)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 1.1422 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` > `0.6712` → IC=+0.183 (n=332)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.6712 (IC base=-0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.1639` → IC=+0.297 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1639 (IC base=-0.011)

- **PATRÓN** `volumen_spike_ratio` < `1.8106` → IC=+0.225 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8106 (IC base=-0.011)

- **PATRÓN** `volumen_spike_ratio` > `2.1143` → IC=+0.261 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1143 (IC base=-0.011)

- **PATRÓN** `ballena_activa_n` < `140.0` → IC=+0.230 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 140.0 (IC base=-0.011)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7` → IC=-0.210 (n=941)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.274 (n=942)

- **FILTRO** `ibs_20min` > `0.6944` → IC=-0.233 (n=493)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6944
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1484)

- **FILTRO** `sigma_ewma_delta_pct` > `4.656` → IC=-0.177 (n=441)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.656
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=1536)

- **PATRÓN** `ibs_20min` > `0.7` → IC=+0.274 (n=942)
...
- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.295 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` > `0.6364` → IC=+0.289 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6364 (IC base=+0.032)

- **PATRÓN** `volumen_pendiente_norm` < `0.1046` → IC=+0.289 (n=624)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7981` → IC=+0.305 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7981 (IC base=+0.032)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.317 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.032)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.208 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1 (IC base=+0.011)

- **PATRÓN** `dist_vwap_pct` > `0.8315` → IC=+0.192 (n=76)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.8315 (IC base=+0.011)

- **PATRÓN** `dist_vwap_pct` < `0.197` → IC=+0.218 (n=406)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0994` → IC=+0.205 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0994 (IC base=+0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.07` → IC=+0.198 (n=180)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.07 (IC base=+0.011)

- **PATRÓN** `volumen_spike_ratio` < `2.5144` → IC=+0.219 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5144 (IC base=+0.011)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.235 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 57.0 (IC base=+0.011)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.319 (n=770)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0161 (IC base=+0.276)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.282 (n=1162)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.276)

- **PATRÓN** `ibs_20min` > `0.9088` → IC=+0.351 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9088 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` > `0.9332` → IC=+0.334 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9332 (IC base=+0.276)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.464` → IC=+0.302 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.464 (IC base=+0.276)

- **PATRÓN** `volumen_regimen` > `1.0341` → IC=+0.312 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0341 (IC base=+0.276)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1845` → IC=+0.288 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1845 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.279 (n=1213)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `2449.769` → IC=+0.286 (n=1032)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2449.769 (IC base=+0.276)
...
- **PATRÓN** `ibs_20min` < `0.3953` → IC=+0.305 (n=1278)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.453` → IC=+0.290 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.453 (IC base=+0.270)

- **PATRÓN** `volumen_regimen` < `0.6387` → IC=+0.271 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6387 (IC base=+0.270)

- **PATRÓN** `volumen_regimen` > `1.2419` → IC=+0.311 (n=426)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5387` → IC=+0.265 (n=1114)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5387 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` > `2.17` → IC=+0.273 (n=505)
...
- **PATRÓN** `libro_liquidez` > `2586.8546` → IC=+0.276 (n=852)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2586.8546 (IC base=+0.270)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.171 (n=2327)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.203 (n=2317)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3425` → IC=+0.175 (n=6117)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3425 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=7250)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5828` → IC=+0.217 (n=6952)
...
- **PATRÓN** `ibs_20min` < `0.4745` → IC=+0.225 (n=6676)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4745 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2232` → IC=+0.159 (n=4909)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2232 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.213` → IC=+0.199 (n=1129)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.213 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1777` → IC=+0.151 (n=4868)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1777 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6257` → IC=+0.144 (n=4868)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6257 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.225 (n=961)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.574` → IC=+0.166 (n=2644)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.574 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6424` → IC=+0.173 (n=2003)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6424 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.170 (n=5643)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3311` → IC=+0.205 (n=1194)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3311 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.200 (n=595)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.302 (n=585)
...
- **PATRÓN** `volumen_spike_ratio` > `1.429` → IC=+0.181 (n=1095)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.429 (IC base=+0.184)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.245 (n=343)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.206 (n=342)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=1078)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4182` → IC=+0.228 (n=1023)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4182 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.1985` → IC=+0.215 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1985 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.506` → IC=+0.227 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.506 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.2593` → IC=+0.169 (n=1024)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2593 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` < `0.0783` → IC=+0.159 (n=854)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.0783 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2332` → IC=+0.186 (n=224)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2332 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `1.4154` → IC=+0.205 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4154 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `15769.1051` → IC=+0.170 (n=464)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 15769.1051 (IC base=+0.161)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2028` → IC=+0.213 (n=774)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2028 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.226 (n=392)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.290 (n=617)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2129` → IC=+0.195 (n=1120)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9594` → IC=+0.209 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9594 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=758)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `1935.1784` → IC=+0.204 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1935.1784 (IC base=+0.196)

- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.235 (n=962)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0106 (IC base=+0.222)

- **PATRÓN** `drift_60min` |x|≤ `0.0922` → IC=+0.246 (n=321)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2436` → IC=+0.255 (n=846)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2436 (IC base=+0.222)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.735` → IC=+0.274 (n=397)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6434` → IC=+0.221 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6434 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `2.28` → IC=+0.234 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.28 (IC base=+0.222)

- **PATRÓN** `libro_liquidez` > `1917.325` → IC=+0.225 (n=321)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.213 (n=368)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.4314` → IC=+0.162 (n=1102)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4314 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1159)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.202 (n=1102)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3963 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.1491` → IC=+0.183 (n=736)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1491 (IC base=+0.148)
...
- **PATRÓN** `volumen_regimen` < `1.0471` → IC=+0.154 (n=970)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.0471 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `1.1857` → IC=+0.154 (n=368)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1857 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.2902` → IC=+0.218 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2902 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `1.5375` → IC=+0.160 (n=474)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.5375 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `2.5113` → IC=+0.176 (n=359)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.5113 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `6915.1659` → IC=+0.185 (n=735)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6915.1659 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.151 (n=1039)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 169.0 (IC base=+0.148)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1301)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.202 (n=1268)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5156 (IC base=+0.116)
...
- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.128 (n=1268)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2208 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` > `0.7156` → IC=+0.122 (n=1133)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.7156 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` < `0.1669` → IC=+0.131 (n=1263)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1669 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `1.8138` → IC=+0.136 (n=814)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.8138 (IC base=+0.116)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1317)
...
- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.135 (n=946)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 49.0 (IC base=+0.116)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.146 (n=566)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.006 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.1` → IC=+0.140 (n=429)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1306)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.204 (n=1286)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.9557` → IC=+0.146 (n=162)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.9557 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.1929` → IC=+0.133 (n=1180)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.1929 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.392` → IC=+0.157 (n=269)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.392 (IC base=+0.110)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4572` → IC=+0.137 (n=381)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4572 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `3069.3744` → IC=+0.159 (n=429)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.217 (n=425)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4412` → IC=+0.243 (n=1275)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4412 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `1.1088` → IC=+0.221 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1088 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.355` → IC=+0.245 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.355 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6292` → IC=+0.216 (n=1275)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6292 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2836` → IC=+0.282 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2836 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `2.2444` → IC=+0.195 (n=1000)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2444 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4604` → IC=+0.196 (n=1136)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4604 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2559.8293` → IC=+0.209 (n=850)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2559.8293 (IC base=+0.203)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.159 (n=552)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.3958` → IC=+0.179 (n=1646)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.3958 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.8205` → IC=+0.182 (n=243)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.8205 (IC base=+0.145)
...
- **PATRÓN** `volumen_regimen` < `0.8707` → IC=+0.163 (n=949)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8707 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `0.6953` → IC=+0.148 (n=1271)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6953 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.1641` → IC=+0.172 (n=452)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5495` → IC=+0.173 (n=527)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5495 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=1847)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `12060.9586` → IC=+0.157 (n=549)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12060.9586 (IC base=+0.145)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.261 (n=211)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.4056` → IC=+0.243 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4056 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `0.3645` → IC=+0.244 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3645 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.043` → IC=+0.242 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.043 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` < `0.8363` → IC=+0.209 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8363 (IC base=+0.200)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3827` → IC=+0.261 (n=157)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.199 (n=2951)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0109 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=9236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=8859)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.895` → IC=+0.197 (n=1190)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.895 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.591` → IC=+0.224 (n=4331)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.591 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8801` → IC=+0.164 (n=3951)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6214` → IC=+0.188 (n=2825)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6214 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2323.447` → IC=+0.168 (n=5902)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2323.447 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6581)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.195 (n=3554)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0053 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1434` → IC=+0.183 (n=3548)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `drift_60min` |x|≤ `0.3383` → IC=+0.193 (n=1507)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.319 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.44` → IC=+0.347 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.44 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` > `0.2263` → IC=+0.246 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2263 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.2452` → IC=+0.204 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2452 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=817)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.258 (n=1153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.257)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.263 (n=1031)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.257)

- **PATRÓN** `drift_60min` |x|≤ `0.1263` → IC=+0.290 (n=508)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1263 (IC base=+0.257)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=1044)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.257)

- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.289 (n=1016)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.424` → IC=+0.266 (n=1219)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8725` → IC=+0.279 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8725 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `1773.87` → IC=+0.269 (n=769)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1773.87 (IC base=+0.257)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.193 (n=473)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0028 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.1819` → IC=+0.159 (n=941)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.1819 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1471)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.3107` → IC=+0.200 (n=1411)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3107 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.183 (n=788)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.124 (IC base=+0.146)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.271` → IC=+0.151 (n=1261)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.271 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.626` → IC=+0.179 (n=471)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.626 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` < `0.0752` → IC=+0.152 (n=1228)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1195` → IC=+0.157 (n=1194)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1195 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7597` → IC=+0.153 (n=904)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7597 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `13672.1173` → IC=+0.152 (n=941)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13672.1173 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `482.0` → IC=+0.155 (n=1287)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 482.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.160 (n=1237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0056 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.3178` → IC=+0.156 (n=1237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `2.4305` → IC=+0.159 (n=1140)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4305 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.158 (n=760)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `363.0` → IC=+0.157 (n=695)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 363.0 (IC base=+0.146)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.244 (n=646)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.221 (n=1490)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.215)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.221 (n=1449)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` > `0.6717` → IC=+0.254 (n=1271)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6717 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.725` → IC=+0.290 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.725 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` < `0.2144` → IC=+0.222 (n=1392)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9089` → IC=+0.245 (n=611)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9089 (IC base=+0.215)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=931)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `1934.3468` → IC=+0.223 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1934.3468 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.242 (n=1330)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3642` → IC=+0.269 (n=1169)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3642 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.751` → IC=+0.278 (n=471)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3556` → IC=+0.295 (n=193)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3556 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.7946` → IC=+0.232 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7946 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.2358` → IC=+0.236 (n=802)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2358 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.253 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1863.9984` → IC=+0.252 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1863.9984 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.246 (n=753)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.141 (n=1510)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1580)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8801` → IC=+0.263 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8801 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.5545` → IC=+0.178 (n=423)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.5545 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.171` → IC=+0.159 (n=631)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.171 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8769` → IC=+0.159 (n=1007)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8769 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.278` → IC=+0.232 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.278 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5208` → IC=+0.153 (n=641)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5208 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4575` → IC=+0.154 (n=486)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.4575 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8222.2638` → IC=+0.229 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8222.2638 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.152 (n=469)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 82.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.158 (n=1227)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0075 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4356` → IC=+0.149 (n=1227)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6889` → IC=+0.190 (n=1227)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6889 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.3551` → IC=+0.140 (n=1238)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4398` → IC=+0.153 (n=1156)
...
- **PATRÓN** `ballena_activa_n` < `184.0` → IC=+0.142 (n=1149)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.131 (n=1003)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0079 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=562)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.4694` → IC=+0.186 (n=1503)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4694 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `1.0378` → IC=+0.198 (n=279)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 1.0378 (IC base=+0.105)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.120 (n=1502)
...
- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.127 (n=1128)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 53.0 (IC base=+0.105)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.177 (n=493)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0057 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.1276` → IC=+0.150 (n=492)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1276 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=1524)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1474)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2127` → IC=+0.129 (n=1197)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2127 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.125 (n=1424)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.437 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.7156` → IC=+0.155 (n=648)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7156 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2238` → IC=+0.175 (n=229)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2238 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.142 (n=439)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4564 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2861.2843` → IC=+0.163 (n=491)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2861.2843 (IC base=+0.110)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.208 (n=1566)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.203 (n=1348)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.203)

- **PATRÓN** `ibs_20min` > `0.5116` → IC=+0.245 (n=1502)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5116 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.1877` → IC=+0.226 (n=858)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1877 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.464` → IC=+0.247 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.464 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.0718` → IC=+0.202 (n=1322)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0718 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.633` → IC=+0.209 (n=1502)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=1547)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2598.6802` → IC=+0.211 (n=1001)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2598.6802 (IC base=+0.203)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.230 (n=550)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1739)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5185` → IC=+0.255 (n=1645)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5185 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.8297` → IC=+0.204 (n=1845)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8297 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.778` → IC=+0.263 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.778 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.2318` → IC=+0.237 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2318 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2831` → IC=+0.255 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2831 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2201` → IC=+0.196 (n=1288)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2201 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.443` → IC=+0.200 (n=1463)
...
- **PATRÓN** `libro_liquidez` > `2569.1156` → IC=+0.202 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2569.1156 (IC base=+0.200)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.124 (n=795)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.5857` → IC=+0.202 (n=678)
...
- **PATRÓN** `volumen_regimen` > `0.977` → IC=+0.132 (n=308)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.977 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` < `2.116` → IC=+0.159 (n=500)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.116 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=552)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2438.1282` → IC=+0.152 (n=297)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2438.1282 (IC base=+0.105)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.178 (n=265)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0059 (IC base=+0.108)

- **PATRÓN** `ibs_20min` > `0.5781` → IC=+0.199 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5781 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `0.1296` → IC=+0.178 (n=119)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1296 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `1.0552` → IC=+0.135 (n=206)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.0552 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` < `0.0678` → IC=+0.151 (n=173)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` < 0.0678 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.195 (n=172)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `3473.0547` → IC=+0.131 (n=147)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 3473.0547 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.170 (n=177)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.005 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=249)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `0.5578` → IC=+0.229 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5578 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` > `0.5243` → IC=+0.197 (n=64)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5243 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.297` → IC=+0.333 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.297 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` < `0.8141` → IC=+0.152 (n=156)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8141 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` > `0.6338` → IC=+0.144 (n=209)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6338 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.3101` → IC=+0.306 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3101 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `1.7588` → IC=+0.180 (n=123)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.7588 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `1.3977` → IC=+0.154 (n=183)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.3977 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=246)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `1108.9201` → IC=+0.172 (n=205)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1108.9201 (IC base=+0.119)
...
- **PATRÓN** `sigma_h` < `0.0054` → IC=+0.151 (n=81)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0054 (IC base=+0.084)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.123 (n=242)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 7.0 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.6316` → IC=+0.174 (n=210)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.6316 (IC base=+0.084)
...
- **PATRÓN** `volumen_regimen` > `1.0588` → IC=+0.153 (n=70)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.0588 (IC base=+0.084)

- **PATRÓN** `volumen_pendiente_norm` > `0.0896` → IC=+0.193 (n=86)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.0896 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `2.1768` → IC=+0.145 (n=167)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.1768 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` > `1.5302` → IC=+0.128 (n=170)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.5302 (IC base=+0.084)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7185)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.177 (n=3006)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9348)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3106)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9720)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.218 (n=513)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1610)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.170 (n=535)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1752)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.122 (n=1277)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.022)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.201 (n=527)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.098 (n=1629)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=566)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1711)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.196 (n=491)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1602)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.180 (n=566)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=1715)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2582)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=703)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=19722)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=6893)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=21721)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.238 (n=7153)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21461)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9682)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=18932)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.228 (n=8939)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=26929)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=8952)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=26916)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=1120)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3551)

- **FILTRO** `ibs_7min` < `0.7077` → IC=-0.258 (n=1541)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7077
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3130)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.179 (n=1139)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3532)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.151 (n=4170)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.103 (n=2026)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.128 (n=2098)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4098)

- **FILTRO** `ibs_7min` > `0.7955` → IC=-0.206 (n=1548)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7955
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4648)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3812)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.254 (n=1199)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3780)

- **FILTRO** `ibs_7min` < `0.7517` → IC=-0.189 (n=1244)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7517
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3735)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.174 (n=1239)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3740)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1228)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3804)

- **FILTRO** `ibs_7min` > `0.2575` → IC=-0.173 (n=1257)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2575
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3775)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.184 (n=1256)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3776)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.170 (n=1263)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3146)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.313 (n=1072)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3337)

- **FILTRO** `ibs_7min` < `0.1961` → IC=-0.259 (n=1101)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1961
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3308)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1083)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3326)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1531)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=5040)

- **FILTRO** `ibs_7min` > `0.76` → IC=-0.176 (n=1639)

  - _Acción_: SKIP cuando `ibs_7min` > 0.76
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=4932)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=3182)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.248 (n=1155)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3545)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.183 (n=1175)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3525)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.180 (n=1145)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=3555)
...
- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.174 (n=1207)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2744
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3629)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.188 (n=1177)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3659)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.270 (n=1178)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3884)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.232 (n=1262)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3800)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1646)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=5154)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.281 (n=1107)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3686)

- **FILTRO** `ibs_7min` < `0.71` → IC=-0.233 (n=1196)

  - _Acción_: SKIP cuando `ibs_7min` < 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3597)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1154)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3639)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1596)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4837)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2621)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0042` → IC=+0.184 (n=450)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0042 (IC base=+0.183)

- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.218 (n=612)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0082 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.1627` → IC=+0.191 (n=1188)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1627 (IC base=+0.183)

- **PATRÓN** `delta_ratio_macro` |x|> `0.217` → IC=+0.184 (n=450)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.92€ cuando `delta_ratio_macro` |x|> 0.217 (IC base=+0.183)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.232 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.133 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.193 (n=942)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.617` → IC=+0.258 (n=1349)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.617 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` > `0.4445` → IC=+0.182 (n=313)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.4445 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.557` → IC=+0.172 (n=1332)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.557 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.103` → IC=+0.272 (n=353)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.103 (IC base=+0.183)

- **PATRÓN** `libro_liquidez` > `2963.5906` → IC=+0.192 (n=899)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2963.5906 (IC base=+0.183)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.218 (n=214)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.252` → IC=+0.216 (n=107)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.229 (n=293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.203)

- **PATRÓN** `ibs_15` > `0.7103` → IC=+0.264 (n=320)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `13.646` → IC=+0.262 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.646 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `14926.7198` → IC=+0.241 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14926.7198 (IC base=+0.203)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.170 (n=104)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0034 (IC base=+0.138)

- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.153 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0057 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0714` → IC=+0.155 (n=137)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0714 (IC base=+0.138)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1407` → IC=+0.157 (n=208)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.79€ cuando `delta_ratio_macro` |x|> 0.1407 (IC base=+0.138)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2579` → IC=+0.165 (n=213)

  - _Acción_: Kelly boost +0.83€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2579 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.161 (n=228)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.138 (n=316)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 16.0 (IC base=+0.138)

- **PATRÓN** `ibs_15` > `0.6341` → IC=+0.233 (n=312)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6341 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1047` → IC=+0.164 (n=215)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1047 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.717` → IC=+0.218 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.717 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.146 (n=142)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.138)
...
- **FILTRO** `dist_vwap_pct` > `0.5758` → IC=-0.147 (n=117)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=714)
...
- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.164 (n=412)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.82€ cuando `ibs_15` < 0.1176 (IC base=+0.046)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.378 (n=162)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.339)

- **PATRÓN** `drift_60min` |x|≤ `0.151` → IC=+0.345 (n=315)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.151 (IC base=+0.339)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1476` → IC=+0.358 (n=238)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1476 (IC base=+0.339)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.394 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.133 (IC base=+0.339)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.358 (n=328)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.339)

- **PATRÓN** `ibs_15` > `0.7873` → IC=+0.380 (n=357)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7873 (IC base=+0.339)

- **PATRÓN** `dist_vwap_pct` > `0.4264` → IC=+0.377 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4264 (IC base=+0.339)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.08` → IC=+0.344 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.08 (IC base=+0.339)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.345 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.339)

- **PATRÓN** `libro_liquidez` > `3525.4286` → IC=+0.355 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3525.4286 (IC base=+0.339)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.344 (n=178)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_15min` |x|≤ `0.4175` → IC=+0.346 (n=89)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4175 (IC base=+0.345)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1505` → IC=+0.361 (n=135)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.367 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.345)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.345 (n=211)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.345)

- **PATRÓN** `ibs_15` > `0.8154` → IC=+0.378 (n=202)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8154 (IC base=+0.345)

- **PATRÓN** `dist_vwap_pct` > `0.242` → IC=+0.408 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.242 (IC base=+0.345)
...
- **PATRÓN** `libro_liquidez` > `15484.5662` → IC=+0.371 (n=68)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15484.5662 (IC base=+0.345)

- **PATRÓN** `ballena_activa_n` < `591.0` → IC=+0.404 (n=154)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1062` → IC=+0.340 (n=104)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1062 (IC base=+0.328)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0642` → IC=+0.335 (n=156)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2247` → IC=+0.364 (n=86)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2247 (IC base=+0.328)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.377 (n=71)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.328)

- **PATRÓN** `ibs_15` > `0.743` → IC=+0.386 (n=156)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.743 (IC base=+0.328)

- **PATRÓN** `dist_vwap_pct` > `0.4406` → IC=+0.337 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4406 (IC base=+0.328)

- **PATRÓN** `dist_vwap_pct` < `0.11` → IC=+0.348 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.11 (IC base=+0.328)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.275` → IC=+0.364 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.275 (IC base=+0.328)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.341 (n=174)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.214 (n=590)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1773)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.188 (n=765)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1598)

- **FILTRO** `libro_liquidez` < `3871.0971` → IC=-0.132 (n=1559)

  - _Acción_: SKIP cuando `libro_liquidez` < 3871.0971
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=804)
...
- **PATRÓN** `ibs_15` > `0.6314` → IC=+0.264 (n=579)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6314 (IC base=-0.060)

- **PATRÓN** `dist_vwap_pct` > `0.5648` → IC=+0.179 (n=104)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.5648 (IC base=-0.060)

- **PATRÓN** `dist_vwap_pct` < `0.1109` → IC=+0.182 (n=356)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1109 (IC base=-0.060)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1175` → IC=+0.237 (n=953)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1175 (IC base=-0.039)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1809` → IC=+0.238 (n=915)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1809 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.3529` → IC=+0.278 (n=1426)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3529 (IC base=-0.039)

- **PATRÓN** `dist_vwap_pct` > `0.8608` → IC=+0.267 (n=165)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.184 (n=131)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0027 (IC base=+0.081)
...
- **PATRÓN** `dist_vwap_pct` < `0.5257` → IC=+0.274 (n=157)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5257 (IC base=+0.081)
...
- **PATRÓN** `ibs_15` < `0.2722` → IC=+0.276 (n=511)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.047` → IC=-0.133 (n=295)
...
- **FILTRO** `sigma_h` > `0.0196` → IC=-0.265 (n=355)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.262 (n=179)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.169 (n=533)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1052` → IC=+0.361 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1052 (IC base=-0.044)

- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.314 (n=395)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.295 (n=198)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1438` → IC=+0.296 (n=396)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1438 (IC base=+0.291)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2168` → IC=+0.328 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2168 (IC base=+0.291)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.309 (n=621)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.291)

- **PATRÓN** `ibs_15` > `0.838` → IC=+0.329 (n=595)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `23.164` → IC=+0.330 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.164 (IC base=+0.291)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.292 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `14318.3661` → IC=+0.305 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14318.3661 (IC base=+0.291)

### UPDOWN_GBM_IBS_ALTO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.305 (n=111)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.26` → IC=+0.288 (n=111)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.8267` → IC=+0.309 (n=333)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8267 (IC base=+0.282)

- **PATRÓN** `dist_vwap_pct` > `0.2565` → IC=+0.356 (n=144)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1506` → IC=+0.318 (n=174)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2866` → IC=+0.343 (n=195)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2866 (IC base=+0.300)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.346 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.6102` → IC=+0.317 (n=58)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6102 (IC base=+0.300)

- **PATRÓN** `dist_vwap_pct` < `0.1651` → IC=+0.299 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1651 (IC base=+0.300)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.169` → IC=+0.332 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.169 (IC base=+0.300)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.308 (n=300)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.617 sube el IC de +0.183 a +0.258 en UPDOWN_GBM#15min (n=1349). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7103 sube el IC de +0.203 a +0.264 en UPDOWN_GBM#BTC#15min (n=320). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6341 sube el IC de +0.138 a +0.233 en UPDOWN_GBM#ETH#15min (n=312). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.046 a +0.164 en UPDOWN_GBM#XRP#15min (n=412). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6314 sube el IC de -0.060 a +0.264 en UPDOWN_GBM_15M_TARDIO (n=579). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3529 sube el IC de -0.039 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=1426). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7496 sube el IC de +0.081 a +0.330 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=145). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2722 sube el IC de +0.223 a +0.276 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=511). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.044 a +0.314 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=395). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.838 sube el IC de +0.291 a +0.329 en UPDOWN_GBM_IBS_ALTO (n=595). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8267 sube el IC de +0.282 a +0.309 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=333). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8516 sube el IC de +0.300 a +0.344 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=261). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7873 sube el IC de +0.339 a +0.380 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=357). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8154 sube el IC de +0.345 a +0.378 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=202). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.743 sube el IC de +0.328 a +0.386 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=156). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 22837 | -0.093 | -3089.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1371 | -0.041 | -200.95€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21466 | -0.096 | -2888.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3489 | -0.086 | -572.41€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3489 | -0.086 | -572.41€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1371 | -0.041 | -200.95€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1371 | -0.041 | -200.95€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6533 | -0.036 | -612.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6533 | -0.036 | -612.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6034 | -0.095 | -452.22€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6034 | -0.095 | -452.22€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5036 | -0.178 | -1090.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5036 | -0.178 | -1090.85€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15138 | -0.034 | +4139.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3998 | -0.003 | +1820.63€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11140 | -0.045 | +2318.83€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15138 | -0.034 | +4139.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3998 | -0.003 | +1820.63€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11140 | -0.045 | +2318.83€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1356 | -0.099 | -173.02€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 146 | -0.041 | -13.92€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1210 | -0.106 | -159.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 751 | -0.088 | -92.08€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 122 | -0.032 | -8.70€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 629 | -0.099 | -83.38€ | 2 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 83442 | +0.113 | -4261.56€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 12831 | +0.184 | -395.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 328 | -0.106 | -45.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 64708 | +0.100 | -3638.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5575 | +0.111 | -181.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 10772 | +0.097 | -960.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 42 | -0.159 | -1.60€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 10715 | +0.099 | -947.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 16882 | +0.132 | -329.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3992 | +0.201 | -131.20€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 10724 | +0.112 | -159.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2124 | +0.109 | -16.54€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 10813 | +0.087 | -1061.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 49 | -0.069 | -3.34€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 10749 | +0.089 | -1046.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 17814 | +0.124 | -346.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4964 | +0.175 | -71.04€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 10828 | +0.106 | -216.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2010 | +0.098 | -50.33€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 16372 | +0.115 | -936.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3742 | +0.187 | -197.77€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 231 | -0.067 | +8.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 10958 | +0.093 | -632.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1441 | +0.130 | -114.41€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 10789 | +0.102 | -626.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 42 | -0.023 | +9.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 10734 | +0.103 | -635.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 13206 | +0.191 | -876.36€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 13206 | +0.191 | -876.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3197 | +0.169 | -338.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3197 | +0.169 | -338.10€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 922 | +0.194 | +0.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 922 | +0.194 | +0.34€ | 4 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3132 | +0.181 | -269.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3132 | +0.181 | -269.60€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2802 | +0.240 | -81.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2802 | +0.240 | -81.71€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3074 | +0.190 | -201.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3074 | +0.190 | -201.04€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 618 | +0.432 | -13.68€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 618 | +0.432 | -13.68€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 45275 | +0.197 | -3630.10€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 45275 | +0.197 | -3630.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 7866 | +0.174 | -947.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 7866 | +0.174 | -947.18€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7213 | +0.224 | -262.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7213 | +0.224 | -262.53€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 7821 | +0.173 | -949.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 7821 | +0.173 | -949.85€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 7301 | +0.218 | -293.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 7301 | +0.218 | -293.92€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 7474 | +0.204 | -494.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 7474 | +0.204 | -494.07€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 7600 | +0.193 | -682.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 7600 | +0.193 | -682.55€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 17014 | +0.121 | +223.28€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 17014 | +0.121 | +223.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 8441 | +0.125 | +166.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 8441 | +0.125 | +166.73€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 8573 | +0.117 | +56.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 8573 | +0.117 | +56.55€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1352 | +0.288 | -22.77€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1352 | +0.288 | -22.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 601 | +0.273 | -23.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 601 | +0.273 | -23.04€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 983 | +0.070 | -48.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 344 | +0.055 | -31.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 639 | +0.077 | -17.73€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 771 | +0.078 | -20.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 132 | +0.082 | -2.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 639 | +0.077 | -17.73€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 30835 | +0.099 | -926.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2573 | +0.091 | +20.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 28262 | +0.099 | -946.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 17435 | +0.103 | -266.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2573 | +0.091 | +20.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 14862 | +0.105 | -287.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 5603 | +0.112 | +6.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 5603 | +0.112 | +6.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 7797 | +0.080 | -665.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 7797 | +0.080 | -665.91€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 22461 | +0.079 | +10373.99€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 22461 | +0.079 | +10373.99€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 3716 | +0.193 | +2690.84€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 3716 | +0.193 | +2690.84€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 3324 | +0.172 | +2216.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3324 | +0.172 | +2216.09€ | 0 | 25 |
| ✅ GBM_LATE_15M#DOGE | 3865 | +0.200 | +2899.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 3865 | +0.200 | +2899.20€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3345 | +0.012 | +582.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3345 | +0.012 | +582.59€ | 1 | 14 |
| ✅ GBM_LATE_15M#SOL | 3267 | -0.035 | +741.99€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3267 | -0.035 | +741.99€ | 4 | 15 |
| ✅ GBM_LATE_15M#XRP | 4944 | -0.045 | +1243.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 4944 | -0.045 | +1243.26€ | 4 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 23704 | +0.082 | +12389.58€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 23704 | +0.082 | +12389.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4472 | +0.016 | +2574.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4472 | +0.016 | +2574.46€ | 2 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 4968 | +0.008 | +954.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 4968 | +0.008 | +954.50€ | 1 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3353 | +0.262 | +3374.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3353 | +0.262 | +3374.70€ | 0 | 23 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 3809 | -0.004 | +645.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 3809 | -0.004 | +645.66€ | 2 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 3860 | +0.021 | +1416.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 3860 | +0.021 | +1416.49€ | 3 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3242 | +0.273 | +3423.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3242 | +0.273 | +3423.77€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 18168 | +0.167 | +13256.99€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 18168 | +0.167 | +13256.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2720 | +0.207 | +2164.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2720 | +0.207 | +2164.24€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 2880 | +0.148 | +2015.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 2880 | +0.148 | +2015.41€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2827 | +0.208 | +2244.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2827 | +0.208 | +2244.88€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3030 | +0.136 | +2028.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3030 | +0.136 | +2028.46€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3404 | +0.113 | +2242.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3404 | +0.113 | +2242.61€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3307 | +0.200 | +2561.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3307 | +0.200 | +2561.39€ | 0 | 25 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4508 | +0.123 | +1822.24€ | 0 | 21 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4508 | +0.123 | +1822.24€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1220 | +0.142 | +542.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1220 | +0.142 | +542.46€ | 0 | 15 |
...
| ✅ GBM_LATE_15M_TARDIO | 22551 | +0.173 | +16415.64€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 22551 | +0.173 | +16415.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3544 | +0.220 | +2978.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3544 | +0.220 | +2978.28€ | 0 | 19 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3530 | +0.146 | +2255.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3530 | +0.146 | +2255.83€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 3667 | +0.226 | +3167.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 3667 | +0.226 | +3167.94€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 3648 | +0.136 | +2394.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 3648 | +0.136 | +2394.40€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 3967 | +0.107 | +2376.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 3967 | +0.107 | +2376.29€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4195 | +0.202 | +3242.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4195 | +0.202 | +3242.90€ | 0 | 25 |
| ✅ GBM_LATE_5M | 6370 | +0.141 | +3471.43€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 6370 | +0.141 | +3471.43€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#SOL | 372 | +0.032 | +43.64€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 372 | +0.032 | +43.64€ | 1 | 4 |
| ✅ GBM_LATE_5M#XRP | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_60M | 1458 | +0.070 | +653.55€ | 2 | 13 |
| ✅ GBM_LATE_60M#60min | 1458 | +0.070 | +653.55€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 525 | +0.088 | +227.26€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 525 | +0.088 | +227.26€ | 0 | 12 |
| ✅ GBM_LATE_60M#ETH | 485 | +0.075 | +252.48€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 485 | +0.075 | +252.48€ | 2 | 17 |
| ✅ GBM_LATE_60M#SOL | 448 | +0.044 | +173.81€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 448 | +0.044 | +173.81€ | 1 | 15 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1655 | +0.102 | +461.27€ | 0 | 3 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1655 | +0.102 | +461.27€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1655 | +0.102 | +461.27€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1655 | +0.102 | +461.27€ | 0 | 3 |
...
| ✅ MOMENTUM_IBS_15M | 14049 | -0.012 | -208.59€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14049 | -0.012 | -208.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2766 | -0.024 | -61.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2766 | -0.024 | -61.78€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 25180 | -0.009 | +1137.99€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 25180 | -0.009 | +1137.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4410 | +0.014 | +564.29€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4410 | +0.014 | +564.29€ | 2 | 1 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 3983 | -0.025 | -23.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 3983 | -0.025 | -23.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4433 | +0.010 | +385.71€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4433 | +0.010 | +385.71€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3764 | -0.049 | -116.18€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3764 | -0.049 | -116.18€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4216 | -0.012 | +156.17€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4216 | -0.012 | +156.17€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4374 | +0.004 | +171.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4374 | +0.004 | +171.81€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5411 | -0.052 | -140.61€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5411 | -0.052 | -140.61€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1522 | -0.070 | -32.24€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1522 | -0.070 | -32.24€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 64482 | -0.074 | +1274.08€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 64482 | -0.074 | +1274.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 10867 | -0.081 | +607.35€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 10867 | -0.081 | +607.35€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 10011 | -0.092 | -438.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 10011 | -0.092 | -438.01€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 10980 | -0.069 | +564.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 10980 | -0.069 | +564.44€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 9536 | -0.094 | -279.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 9536 | -0.094 | -279.60€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 11862 | -0.049 | +335.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 11862 | -0.049 | +335.97€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 11226 | -0.064 | +483.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 11226 | -0.064 | +483.93€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 6877 | -0.023 | -100.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 6877 | -0.023 | -100.25€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 1530 | -0.018 | -6.41€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 1530 | -0.018 | -6.41€ | 1 | 0 |
...
| ✅ STREAK_MOM_5M | 7124 | +0.025 | +119.99€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7124 | +0.025 | +119.99€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2121 | +0.021 | +20.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2121 | +0.021 | +20.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1526 | +0.036 | +48.03€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1526 | +0.036 | +48.03€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2146 | +0.015 | +9.06€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2146 | +0.015 | +9.06€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1331 | +0.035 | +42.00€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1331 | +0.035 | +42.00€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 6620 | +0.011 | -45.55€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 6620 | +0.011 | -45.55€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2640 | +0.017 | -4.52€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2640 | +0.017 | -4.52€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2604 | +0.011 | -17.07€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2604 | +0.011 | -17.07€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1376 | -0.002 | -23.96€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1376 | -0.002 | -23.96€ | 2 | 0 |
| ✅ UPDOWN_GBM | 31030 | +0.031 | +1842.75€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 8390 | +0.061 | +1434.50€ | 0 | 12 |
| ✅ UPDOWN_GBM#240min | 1148 | +0.004 | +7.65€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 19510 | +0.023 | +384.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 1863 | +0.005 | +14.36€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 2910 | +0.073 | +328.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 456 | +0.151 | +181.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 21 | -0.022 | -0.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2433 | +0.060 | +147.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 5716 | +0.033 | +386.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1034 | +0.077 | +234.69€ | 0 | 11 |
| ✅ UPDOWN_GBM#BTC#240min | 320 | +0.022 | +7.58€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 3484 | +0.030 | +128.86€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 832 | +0.002 | +14.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 46 | -0.104 | +0.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 3681 | +0.039 | +202.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 426 | +0.140 | +156.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 16 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3239 | +0.026 | +47.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 6536 | +0.019 | +267.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2204 | +0.043 | +240.50€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 308 | +0.006 | +7.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3340 | +0.010 | +19.12€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 646 | +0.002 | -3.67€ | 3 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 38 | -0.150 | +4.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 7634 | +0.016 | +181.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2144 | +0.020 | +119.15€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 302 | -0.007 | -2.86€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 4770 | +0.017 | +63.03€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 385 | +0.014 | +3.65€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 33 | -0.157 | -1.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 4551 | +0.036 | +477.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2126 | +0.077 | +502.53€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 181 | -0.008 | -3.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2244 | +0.001 | -21.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#daily | 117 | -0.139 | +3.37€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 476 | +0.339 | +141.87€ | 0 | 10 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 476 | +0.339 | +141.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 269 | +0.345 | +79.21€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 269 | +0.345 | +79.21€ | 0 | 14 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 207 | +0.328 | +62.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 207 | +0.328 | +62.67€ | 0 | 11 |
| ✅ UPDOWN_GBM_15M_TARDIO | 10428 | -0.044 | +2188.23€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 10428 | -0.044 | +2188.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 619 | -0.046 | +333.18€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 619 | -0.046 | +333.18€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1943 | -0.123 | +48.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1943 | -0.123 | +48.11€ | 4 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 261 | +0.162 | +153.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 261 | +0.162 | +153.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1144 | +0.196 | +639.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1144 | +0.196 | +639.62€ | 2 | 22 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3228 | -0.065 | +496.94€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3228 | -0.065 | +496.94€ | 3 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3233 | -0.077 | +517.04€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3233 | -0.077 | +517.04€ | 2 | 3 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 791 | +0.291 | +651.81€ | 0 | 11 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 791 | +0.291 | +651.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 443 | +0.282 | +336.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 443 | +0.282 | +336.73€ | 0 | 10 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 348 | +0.300 | +315.08€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 348 | +0.300 | +315.08€ | 0 | 10 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 493 celda(s) pasan gate riguroso completo de 2116 evaluadas (n>=40) y 3130 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.020 < 0.08 — monitorear
  - _Datos_: n=2142 IC=+0.020 PNL=+117.25€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.097 n=231/60 | contraria IC=+0.144 n=220 | gap=-0.048 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=646/40 IC=+0.002 PNL=-3.67€ | BTC#60min: n=832/40 IC=+0.002 PNL=+14.37€ | SOL#60min: n=385/40 IC=+0.014 PNL=+3.65€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.052 n=295721 | tras_1loss IC=+0.075 n=230392 | tras_2loss IC=+0.043 n=97929/40 | gap=+0.009 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1356 IC=+0.009 PNL=+1.00€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1356 IC=+0.009 PNL=+1.00€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.183 > 0.1 con n=1796 PNL=+1100.68€
  - _Datos_: n=1796 IC=+0.183 PNL=+1100.68€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1034 IC=+0.077 PNL=+234.69€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1034 IC=+0.077 PNL=+234.69€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=10533 IC=+0.053 PNL=+1285.22€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=10533 IC=+0.053 PNL=+1285.22€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1634 IC=+0.046 PNL=+175.10€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1634 IC=+0.046 PNL=+175.10€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=15525 IC=-0.140 PNL=+955.66€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=15525 IC=-0.140 PNL=+955.66€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1708 IC=+0.133 PNL=+883.26€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1708 IC=+0.133 PNL=+883.26€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.241 < -0.1 con n=1540 PNL=-194.19€
  - _Datos_: n=1540 IC=-0.241 PNL=-194.19€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.095 n=862) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=862 IC=+0.095 PNL=+210.66€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=7863 IC=+0.174 PNL=-948.42€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=7863 IC=+0.174 PNL=-948.42€
