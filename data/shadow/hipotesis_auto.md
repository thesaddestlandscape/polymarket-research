# Hipótesis automáticas — 2026-08-24 10:34 UTC
_Generado por shadow_postmortem.py sobre 137089 resoluciones (PNL=+9420.29€)_
...
- **PATRÓN** `py_entrada` > `0.705` → IC=+0.262 (n=200)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8139` → IC=+0.262 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8139 (IC base=+0.130)

- **PATRÓN** `banda_z` > `9.925` → IC=+0.216 (n=72)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.132 (n=153)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 11.0 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=223)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `2887.1789` → IC=+0.200 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2887.1789 (IC base=+0.130)

- **PATRÓN** `ballena_activa_n` < `288.0` → IC=+0.287 (n=59)
...
- **PATRÓN** `py_entrada` > `0.725` → IC=+0.294 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.163)

- **PATRÓN** `n_ballena_banda` > `22.0` → IC=+0.174 (n=130)

  - _Acción_: Kelly boost +0.87€ cuando `n_ballena_banda` > 22.0 (IC base=+0.163)

- **PATRÓN** `n_total_lado` > `50.0` → IC=+0.220 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 50.0 (IC base=+0.163)

- **PATRÓN** `banda_hit_calibrado` > `0.8198` → IC=+0.303 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8198 (IC base=+0.163)

- **PATRÓN** `banda_z` > `10.841` → IC=+0.202 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.841 (IC base=+0.163)

- **PATRÓN** `ballenas_wallet_edge_medio` > `3.098` → IC=+0.183 (n=58)

  - _Acción_: Kelly boost +0.92€ cuando `ballenas_wallet_edge_medio` > 3.098 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.188 (n=91)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 11.0 (IC base=+0.163)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.163 (n=90)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 11.0 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=153)
...
- **PATRÓN** `ballena_activa_n` < `295.0` → IC=+0.304 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 295.0 (IC base=+0.163)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `156.5` → IC=-0.259 (n=1916)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.5
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=5749)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `148.73` → IC=-0.188 (n=213)
...
- **FILTRO** `restante_s_al_confirmar` < `361.72` → IC=-0.296 (n=155)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 361.72
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=465)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `104.2` → IC=-0.396 (n=218)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 104.2
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=657)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `167.98` → IC=-0.152 (n=507)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 167.98
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1522)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `149.25` → IC=-0.271 (n=474)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 149.25
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1425)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `167.04` → IC=-0.315 (n=457)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 167.04
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=930)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.186 (n=4578)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.7 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=1429)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `7250.2217` → IC=+0.203 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7250.2217 (IC base=+0.098)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1047)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.135 (n=674)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.290 (n=403)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.286)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.294 (n=401)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.286)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.326 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.286)

- **PATRÓN** `libro_liquidez` > `3574.4821` → IC=+0.312 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3574.4821 (IC base=+0.286)
...
- **PATRÓN** `py_entrada` < `0.305` → IC=+0.299 (n=352)
...
- **PATRÓN** `libro_liquidez` > `803.6762` → IC=+0.231 (n=522)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.182 (n=968)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 17.0 (IC base=+0.174)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.193 (n=1006)
...
- **FILTRO** `libro_liquidez` < `11465.6584` → IC=-0.325 (n=55)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.227 (n=1042)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.195 (n=1099)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 11.0 (IC base=+0.192)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.235 (n=620)
...
- **PATRÓN** `restante_min` < `3.93` → IC=+0.145 (n=1174)

  - _Acción_: Kelly boost +0.73€ cuando `restante_min` < 3.93 (IC base=+0.131)

- **PATRÓN** `restante_min` > `4.92` → IC=+0.152 (n=1232)
...
- **PATRÓN** `lag_apertura_s` < `4.57` → IC=+0.150 (n=1157)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 4.57 (IC base=+0.131)
...
- **PATRÓN** `restante_min` < `3.87` → IC=+0.157 (n=575)

  - _Acción_: Kelly boost +0.78€ cuando `restante_min` < 3.87 (IC base=+0.141)

- **PATRÓN** `restante_min` > `4.9` → IC=+0.163 (n=574)

  - _Acción_: Kelly boost +0.82€ cuando `restante_min` > 4.9 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.154 (n=1535)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 15.0 (IC base=+0.141)

- **PATRÓN** `lag_apertura_s` < `6.31` → IC=+0.164 (n=575)

  - _Acción_: Kelly boost +0.82€ cuando `lag_apertura_s` < 6.31 (IC base=+0.141)
...
- **PATRÓN** `restante_min` < `3.98` → IC=+0.141 (n=585)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` < 3.98 (IC base=+0.121)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.151 (n=637)
...
- **PATRÓN** `lag_apertura_s` < `3.42` → IC=+0.158 (n=583)

  - _Acción_: Kelly boost +0.79€ cuando `lag_apertura_s` < 3.42 (IC base=+0.121)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.316 (n=552)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.302)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.306 (n=523)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.290 (n=236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.277)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.280 (n=207)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.276 (n=275)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.314 (n=251)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.422 (n=230)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.411)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.424 (n=222)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1852.2015` → IC=+0.423 (n=218)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.299 (n=262)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9497` → IC=+0.222 (n=612)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9497 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.2566` → IC=+0.233 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2566 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.9628` → IC=+0.227 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9628 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.018` → IC=+0.189 (n=776)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 5.018 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.225 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2629 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.247 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` < `0.107` → IC=+0.131 (n=911)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.107 (IC base=+0.070)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5529` → IC=+0.135 (n=847)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.5529 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `1.4731` → IC=+0.132 (n=962)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4731 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.2109` → IC=+0.126 (n=1307)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2109 (IC base=+0.030)

- **PATRÓN** `dist_vwap_pct` < `0.3005` → IC=+0.144 (n=680)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.3005 (IC base=+0.030)

- **PATRÓN** `volumen_regimen` < `0.6271` → IC=+0.158 (n=217)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6271 (IC base=+0.030)

- **PATRÓN** `volumen_regimen` > `1.0471` → IC=+0.136 (n=295)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 1.0471 (IC base=+0.030)

- **PATRÓN** `volumen_pendiente_norm` > `0.0792` → IC=+0.244 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0792 (IC base=+0.030)

- **PATRÓN** `volumen_spike_ratio` < `1.6284` → IC=+0.205 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6284 (IC base=+0.030)

- **PATRÓN** `volumen_spike_ratio` > `2.9764` → IC=+0.225 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9764 (IC base=+0.030)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.266 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 49.0 (IC base=+0.030)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.239 (n=278)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.4191` → IC=+0.220 (n=277)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4191 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.246 (n=286)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` > `0.6025` → IC=+0.232 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6025 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` > `0.1985` → IC=+0.236 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1985 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.709` → IC=+0.229 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.709 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.515` → IC=+0.270 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.515 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` < `1.2957` → IC=+0.224 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2957 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `1.1094` → IC=+0.242 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1094 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.1037` → IC=+0.227 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1037 (IC base=+0.217)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4558` → IC=+0.254 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4558 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.0438` → IC=+0.218 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0438 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `13499.45` → IC=+0.250 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13499.45 (IC base=+0.217)
...
- **FILTRO** `sigma_h` > `0.0061` → IC=-0.139 (n=167)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0061
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=502)

- **FILTRO** `ibs_20min` > `0.8814` → IC=-0.180 (n=167)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8814
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=502)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.84` → IC=-0.148 (n=248)
...
- **FILTRO** `ibs_20min` < `0.4414` → IC=-0.143 (n=278)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4414
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=278)

- **FILTRO** `sigma_h` > `0.0127` → IC=-0.152 (n=257)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0127
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=773)

- **FILTRO** `ibs_20min` > `0.7692` → IC=-0.164 (n=254)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7692
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=776)

- **FILTRO** `sigma_ewma_delta_pct` > `6.517` → IC=-0.172 (n=169)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.129 (n=1066)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.007 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.250 (n=783)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.4287` → IC=+0.259 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4287 (IC base=+0.052)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.339` → IC=+0.122 (n=1339)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` > 2.339 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.1704` → IC=+0.189 (n=265)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 1.1704 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` < `0.1162` → IC=+0.158 (n=1003)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.1162 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.2486` → IC=+0.210 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2486 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `1.4996` → IC=+0.165 (n=347)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4996 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` > `2.9129` → IC=+0.172 (n=346)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.9129 (IC base=+0.052)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.272 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.167 (n=1066)
...
- **PATRÓN** `dist_vwap_pct` < `0.1319` → IC=+0.194 (n=605)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.1319 (IC base=+0.034)

- **PATRÓN** `volumen_regimen` > `0.6311` → IC=+0.203 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6311 (IC base=+0.034)

- **PATRÓN** `volumen_pendiente_norm` > `0.248` → IC=+0.333 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.248 (IC base=+0.034)

- **PATRÓN** `volumen_spike_ratio` > `2.9244` → IC=+0.285 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9244 (IC base=+0.034)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.253 (n=301)
...
- **FILTRO** `libro_liquidez` < `8791.013` → IC=-0.167 (n=97)

  - _Acción_: SKIP cuando `libro_liquidez` < 8791.013
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=291)
...
- **PATRÓN** `ibs_20min` > `0.8333` → IC=+0.222 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8333 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` > `0.3035` → IC=+0.232 (n=80)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2609` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2609 (IC base=-0.011)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.177 (n=97)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 80.0 (IC base=-0.011)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.322 (n=217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0109 (IC base=+0.205)
...
- **PATRÓN** `ibs_20min` > `0.9064` → IC=+0.284 (n=318)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.097` → IC=+0.269 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.097 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.8332` → IC=+0.234 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8332 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` < `0.0807` → IC=+0.208 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0807 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.272 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `2.2293` → IC=+0.220 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2293 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.222 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `3051.204` → IC=+0.233 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3051.204 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.276 (n=320)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0071 (IC base=+0.261)

- **PATRÓN** `drift_60min` |x|≤ `0.3874` → IC=+0.271 (n=422)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3874 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.294 (n=217)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` < `0.2788` → IC=+0.326 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2788 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` < `0.2288` → IC=+0.272 (n=441)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2288 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.5` → IC=+0.283 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.5 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` > `0.7156` → IC=+0.279 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7156 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.351 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` > `2.1844` → IC=+0.280 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1844 (IC base=+0.261)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.237 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 39.0 (IC base=+0.261)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.205 (n=676)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.009 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=2103)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.901` → IC=+0.259 (n=1345)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.901 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.7372` → IC=+0.237 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7372 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.116` → IC=+0.257 (n=884)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.116 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `0.6987` → IC=+0.174 (n=1224)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6987 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.104` → IC=+0.182 (n=712)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.104 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `2.3275` → IC=+0.154 (n=1560)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.3275 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.4525` → IC=+0.146 (n=1773)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4525 (IC base=+0.157)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=1613)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `2460.3759` → IC=+0.179 (n=1345)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2460.3759 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `132.0` → IC=+0.190 (n=815)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 132.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.199 (n=1753)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.3479` → IC=+0.196 (n=1753)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.3479 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.213 (n=803)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` < `0.3985` → IC=+0.245 (n=1753)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3985 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.3302` → IC=+0.178 (n=1534)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3302 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.74` → IC=+0.197 (n=338)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.74 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.471` → IC=+0.186 (n=1772)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` < 5.471 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` < `1.1764` → IC=+0.163 (n=1453)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1764 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` > `0.8565` → IC=+0.179 (n=969)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.8565 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.2935` → IC=+0.233 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2935 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` < `1.5799` → IC=+0.186 (n=505)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.5799 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.7123` → IC=+0.204 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7123 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.192 (n=478)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.261 (n=90)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.217 (n=281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` > `0.4962` → IC=+0.222 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4962 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.249 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.0` → IC=+0.277 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.0 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `1.3047` → IC=+0.181 (n=268)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 1.3047 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `0.8983` → IC=+0.207 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8983 (IC base=+0.180)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4115` → IC=+0.232 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4115 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.1749` → IC=+0.185 (n=109)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.1749 (IC base=+0.180)

- **PATRÓN** `libro_liquidez` > `12999.7032` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12999.7032 (IC base=+0.180)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.196 (n=320)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.004 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.212` → IC=+0.185 (n=319)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.212 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=328)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 7.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` < `0.3777` → IC=+0.195 (n=362)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.3777 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.1939` → IC=+0.181 (n=368)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1939 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.664` → IC=+0.230 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.664 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6392` → IC=+0.232 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6392 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1012` → IC=+0.205 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1012 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.6102` → IC=+0.165 (n=255)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.6102 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.4202` → IC=+0.146 (n=255)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4202 (IC base=+0.149)
...
- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.231 (n=269)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0096 (IC base=+0.194)

- **PATRÓN** `drift_60min` |x|≤ `0.1344` → IC=+0.211 (n=119)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1344 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.216 (n=273)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.194)

- **PATRÓN** `ibs_20min` > `0.435` → IC=+0.260 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.435 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` > `0.1669` → IC=+0.225 (n=198)
...
- **PATRÓN** `volumen_regimen` > `0.6402` → IC=+0.223 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6402 (IC base=+0.194)

- **PATRÓN** `volumen_pendiente_norm` > `0.0999` → IC=+0.269 (n=119)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4571` → IC=+0.239 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4571 (IC base=+0.194)

- **PATRÓN** `libro_liquidez` > `9553.6554` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9553.6554 (IC base=+0.194)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.176 (n=180)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 196.0 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.203 (n=304)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.3487` → IC=+0.168 (n=344)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4456` → IC=+0.205 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4456 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.5211` → IC=+0.169 (n=400)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.5211 (IC base=+0.150)
...
- **PATRÓN** `volumen_regimen` < `0.8521` → IC=+0.155 (n=230)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8521 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.168 (n=344)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6121 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1018` → IC=+0.173 (n=96)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1018 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.8946` → IC=+0.208 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8946 (IC base=+0.150)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.189 (n=181)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0093 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=412)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.8667` → IC=+0.230 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8667 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.9936` → IC=+0.270 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9936 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.939` → IC=+0.283 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.939 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` > `0.6824` → IC=+0.136 (n=355)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.6824 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.0999` → IC=+0.138 (n=136)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` > 0.0999 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2760.8656` → IC=+0.203 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2760.8656 (IC base=+0.114)
...
- **PATRÓN** `ibs_20min` < `0.4362` → IC=+0.224 (n=346)
...
- **PATRÓN** `dist_vwap_pct` < `0.22` → IC=+0.124 (n=312)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.22 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.49` → IC=+0.148 (n=52)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 7.49 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` > `0.8507` → IC=+0.157 (n=231)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.8507 (IC base=+0.111)
...
- **PATRÓN** `libro_liquidez` > `2645.6946` → IC=+0.179 (n=157)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2645.6946 (IC base=+0.111)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0268` → IC=+0.216 (n=146)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0268 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.1499` → IC=+0.187 (n=193)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.1499 (IC base=+0.168)
...
- **PATRÓN** `ibs_20min` > `0.7317` → IC=+0.211 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7317 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.4182` → IC=+0.223 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4182 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.964` → IC=+0.246 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.964 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2275` → IC=+0.174 (n=437)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.2275 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.8384` → IC=+0.179 (n=291)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 0.8384 (IC base=+0.168)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2016` → IC=+0.184 (n=352)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.2016 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8263` → IC=+0.173 (n=267)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8263 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=487)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2635.1118` → IC=+0.176 (n=291)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2635.1118 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.272 (n=178)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.225)

- **PATRÓN** `drift_60min` |x|≤ `0.4944` → IC=+0.231 (n=403)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1272` → IC=+0.316 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1272 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` < `0.9736` → IC=+0.234 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9736 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.787` → IC=+0.260 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.787 (IC base=+0.225)

- **PATRÓN** `volumen_regimen` > `0.7026` → IC=+0.251 (n=360)
...
- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.186 (n=186)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 30.0 (IC base=+0.225)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.156 (n=149)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0059 (IC base=+0.085)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.210 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.085)

- **PATRÓN** `ibs_20min` > `0.5141` → IC=+0.141 (n=324)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.5141 (IC base=+0.085)

- **PATRÓN** `dist_vwap_pct` > `0.5255` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5255 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.962` → IC=+0.233 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.962 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.1873` → IC=+0.223 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1873 (IC base=+0.085)

- **PATRÓN** `ballena_activa_n` < `256.0` → IC=+0.192 (n=102)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 256.0 (IC base=+0.085)

- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.253 (n=99)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.043)

- **PATRÓN** `ibs_20min` < `0.2685` → IC=+0.130 (n=198)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.2685 (IC base=+0.043)
...
- **FILTRO** `libro_liquidez` < `8533.3968` → IC=-0.167 (n=37)
...
- **PATRÓN** `ibs_20min` > `0.233` → IC=+0.121 (n=56)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` > 0.233 (IC base=+0.000)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.257 (n=35)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.3109` → IC=+0.198 (n=104)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.3109 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.148 (n=106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5587` → IC=+0.170 (n=104)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.5587 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.0249` → IC=+0.153 (n=93)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.0249 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.2247` → IC=+0.179 (n=104)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2247 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.019` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.019 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.2361` → IC=+0.198 (n=104)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.2361 (IC base=+0.150)
...
- **PATRÓN** `volumen_spike_ratio` < `1.602` → IC=+0.250 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.602 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 123.0 (IC base=+0.150)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.203 (n=773)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.148 (n=2341)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 6.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.9473` → IC=+0.287 (n=1051)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9473 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `1.0067` → IC=+0.243 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0067 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.406` → IC=+0.229 (n=1420)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.406 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8833` → IC=+0.146 (n=1063)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8833 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.2439` → IC=+0.144 (n=532)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.2439 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.2393` → IC=+0.178 (n=405)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.2393 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.9158` → IC=+0.149 (n=1336)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.9158 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=1845)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `2998.6135` → IC=+0.177 (n=1051)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2998.6135 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.188 (n=829)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 166.0 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.206 (n=2076)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0085 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.3997` → IC=+0.200 (n=2075)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3997 (IC base=+0.185)
...
- **PATRÓN** `ibs_20min` < `0.5421` → IC=+0.242 (n=2075)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5421 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.6724` → IC=+0.175 (n=1683)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.6724 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.373` → IC=+0.199 (n=377)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.373 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.622` → IC=+0.193 (n=1949)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.622 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` < `0.619` → IC=+0.172 (n=532)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.619 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` > `1.1867` → IC=+0.180 (n=532)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 1.1867 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.2331` → IC=+0.238 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2331 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.2624` → IC=+0.196 (n=627)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.2624 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.139 (n=632)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 56.0 (IC base=+0.185)
...
- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.170 (n=116)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0025 (IC base=+0.155)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.183 (n=159)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0054 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=364)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.3307` → IC=+0.216 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3307 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.2258` → IC=+0.238 (n=208)
...
- **PATRÓN** `volumen_regimen` < `0.6619` → IC=+0.178 (n=116)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6619 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `1.1052` → IC=+0.175 (n=158)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.1052 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` < `0.074` → IC=+0.178 (n=265)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` < 0.074 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1445` → IC=+0.208 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1445 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.5982` → IC=+0.191 (n=299)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.5982 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.3834` → IC=+0.194 (n=299)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.3834 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `11116.6074` → IC=+0.195 (n=231)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 11116.6074 (IC base=+0.155)
...
- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.149 (n=346)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0086 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.159 (n=312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 8.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` > `0.3491` → IC=+0.195 (n=346)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3491 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.9243` → IC=+0.204 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9243 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.499` → IC=+0.180 (n=170)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 4.499 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `0.9175` → IC=+0.161 (n=231)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.9175 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `1.2094` → IC=+0.161 (n=116)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.2094 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.2719` → IC=+0.307 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2719 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.4212` → IC=+0.205 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4212 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `4151.2759` → IC=+0.200 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4151.2759 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `232.0` → IC=+0.170 (n=219)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 232.0 (IC base=+0.131)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.250 (n=94)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.4348` → IC=+0.150 (n=281)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4348 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.167 (n=202)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 11.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` < `0.0656` → IC=+0.222 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0656 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` < `0.7176` → IC=+0.152 (n=294)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.7176 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.624` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.624 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` < `0.5827` → IC=+0.156 (n=94)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.5827 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `0.954` → IC=+0.139 (n=128)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.954 (IC base=+0.130)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1429` → IC=+0.177 (n=199)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.1429 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `4274.4143` → IC=+0.145 (n=187)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 4274.4143 (IC base=+0.130)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.170 (n=183)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0089 (IC base=+0.082)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.132 (n=188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 16.0 (IC base=+0.082)

- **PATRÓN** `ibs_20min` > `0.9231` → IC=+0.269 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9231 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` > `0.9261` → IC=+0.244 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9261 (IC base=+0.082)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.244` → IC=+0.262 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.244 (IC base=+0.082)

- **PATRÓN** `libro_liquidez` > `2751.2995` → IC=+0.274 (n=135)
...
- **PATRÓN** `ibs_20min` < `0.5789` → IC=+0.188 (n=395)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5789 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.7543` → IC=+0.123 (n=404)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.7543 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.087` → IC=+0.126 (n=378)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.087 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0506` → IC=+0.130 (n=179)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 1.0506 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.0719` → IC=+0.173 (n=105)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.0719 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.7285` → IC=+0.183 (n=165)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.7285 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `1508.4936` → IC=+0.145 (n=263)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 1508.4936 (IC base=+0.105)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0145` → IC=+0.219 (n=226)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0145 (IC base=+0.168)
...
- **PATRÓN** `ibs_20min` > `0.9733` → IC=+0.298 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9733 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `1.22` → IC=+0.270 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.22 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.966` → IC=+0.255 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.966 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.6199` → IC=+0.186 (n=167)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6199 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `1.2439` → IC=+0.179 (n=166)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.2439 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.1718` → IC=+0.246 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1718 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `2.3027` → IC=+0.170 (n=395)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.3027 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8693` → IC=+0.165 (n=299)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.8693 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.180 (n=552)

  - _Acción_: Kelly boost +0.90€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `3077.3336` → IC=+0.184 (n=166)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 3077.3336 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.222 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.276 (n=368)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.206)

- **PATRÓN** `drift_60min` |x|≤ `0.3965` → IC=+0.234 (n=482)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3965 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.221 (n=504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.206)

- **PATRÓN** `ibs_20min` < `0.4884` → IC=+0.280 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4884 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` < `0.6958` → IC=+0.221 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6958 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.01` → IC=+0.262 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.01 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.947` → IC=+0.215 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.947 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.246 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2332 (IC base=+0.206)

- **PATRÓN** `volumen_pendiente_norm` > `0.2868` → IC=+0.300 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2868 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `2.6567` → IC=+0.216 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6567 (IC base=+0.206)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.144 (n=262)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 36.0 (IC base=+0.206)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.158 (n=512)

- **PATRÓN** `dist_vwap_pct` > `1.7478` → IC=+0.195 (n=93)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 1.7478 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.134 (n=99)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 1.1808 (IC base=+0.053)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.199 (n=264)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0041 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.2017` → IC=+0.169 (n=264)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.2017 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` < `0.6103` → IC=+0.171 (n=348)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6103 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.6845` → IC=+0.173 (n=102)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.6845 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.3243` → IC=+0.152 (n=375)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3243 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.448` → IC=+0.181 (n=189)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 3.448 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.3221` → IC=+0.166 (n=396)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.3221 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6531` → IC=+0.151 (n=396)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6531 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` < `0.0986` → IC=+0.149 (n=343)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0986 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.0777` → IC=+0.165 (n=201)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0777 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.6551` → IC=+0.180 (n=392)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.6551 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.4336` → IC=+0.150 (n=392)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4336 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=512)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `7268.8224` → IC=+0.173 (n=396)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7268.8224 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `185.0` → IC=+0.173 (n=215)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 185.0 (IC base=+0.146)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.235 (n=32)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `1.7332` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.7332 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.2977` → IC=+0.159 (n=42)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.2977 (IC base=+0.052)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.275 (n=38)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.3626` → IC=+0.220 (n=98)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3626 (IC base=+0.193)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.230 (n=98)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.193)

- **PATRÓN** `ibs_20min` < `0.6855` → IC=+0.193 (n=112)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6855 (IC base=+0.193)

- **PATRÓN** `ibs_20min` > `0.1532` → IC=+0.255 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1532 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.497` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.497 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.6082` → IC=+0.194 (n=119)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.6082 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.54` → IC=+0.286 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.54 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` < `1.1102` → IC=+0.260 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1102 (IC base=+0.193)

- **PATRÓN** `volumen_pendiente_norm` < `0.1267` → IC=+0.223 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1267 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` < `2.4942` → IC=+0.248 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4942 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` > `1.4487` → IC=+0.194 (n=109)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4487 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `9525.8523` → IC=+0.244 (n=37)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.140 (n=84)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 6.0 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2555.3558` → IC=+0.197 (n=74)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2555.3558 (IC base=+0.107)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.122 (n=72)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 8.0 (IC base=+0.037)
...
- **PATRÓN** `libro_liquidez` > `2219.072` → IC=+0.148 (n=52)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2219.072 (IC base=+0.014)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.155 (n=578)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=1808)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.237 (n=565)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1761)

- **FILTRO** `ibs_20min` > `0.2762` → IC=-0.204 (n=580)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2762
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=1746)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.156 (n=155)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.108 (n=197)

- **FILTRO** `ibs_20min` < `0.7265` → IC=-0.189 (n=88)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7265
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=264)

- **FILTRO** `ibs_20min` > `0.7659` → IC=-0.184 (n=96)
...
- **FILTRO** `ibs_20min` < `0.7244` → IC=-0.189 (n=88)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.203 (n=126)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=267)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.142 (n=107)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=321)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.222 (n=106)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=313)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.173 (n=102)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=317)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` > `0.62` → IC=-0.275 (n=87)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=277)

- **FILTRO** `drift_20min_pct` |x|> `0.3427` → IC=-0.185 (n=90)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3427
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=274)

- **FILTRO** `ibs_20min` > `0.27` → IC=-0.217 (n=90)

  - _Acción_: SKIP cuando `ibs_20min` > 0.27
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=274)

- **FILTRO** `ballena_activa_n` > `1.0` → IC=-0.161 (n=222)
...
- **FILTRO** `py_entrada` > `0.6` → IC=-0.281 (n=121)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=237)

- **FILTRO** `drift_20min_pct` |x|> `0.5638` → IC=-0.150 (n=121)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.5638
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=237)

- **FILTRO** `ibs_20min` > `0.2949` → IC=-0.311 (n=88)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.148 (n=1259)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4565)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.279 (n=1391)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=4433)

- **FILTRO** `ibs_7min` < `0.7407` → IC=-0.228 (n=1455)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7407
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4369)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.180 (n=1949)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3875)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.219 (n=1740)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=5394)

- **FILTRO** `ibs_7min` > `0.3` → IC=-0.164 (n=1782)

  - _Acción_: SKIP cuando `ibs_7min` > 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=5352)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.313 (n=196)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=613)

- **FILTRO** `ibs_7min` < `0.9818` → IC=-0.188 (n=533)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9818
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=276)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.234 (n=201)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=608)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.245 (n=277)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=882)

- **FILTRO** `drift_7min_pct` |x|> `0.1413` → IC=-0.163 (n=393)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1413
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=766)

- **FILTRO** `ibs_7min` > `0.2981` → IC=-0.189 (n=394)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2981
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=765)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.160 (n=248)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=960)

- **FILTRO** `py_entrada` < `0.39` → IC=-0.245 (n=280)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=928)

- **FILTRO** `ballena_activa_n` > `135.0` → IC=-0.169 (n=297)

  - _Acción_: SKIP cuando `ballena_activa_n` > 135.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=911)

- **FILTRO** `py_entrada` > `0.53` → IC=-0.187 (n=308)

  - _Acción_: SKIP cuando `py_entrada` > 0.53
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=941)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.213 (n=235)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=567)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.334 (n=191)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=611)

- **FILTRO** `ibs_7min` < `0.2125` → IC=-0.282 (n=200)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2125
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=602)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.281 (n=194)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=608)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.265 (n=266)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=968)

- **FILTRO** `ibs_7min` > `0.2791` → IC=-0.165 (n=419)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.270 (n=233)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=754)

- **FILTRO** `ibs_7min` < `0.7784` → IC=-0.202 (n=246)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7784
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=741)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.220 (n=241)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=746)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.300 (n=228)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=765)

- **FILTRO** `ibs_7min` > `0.177` → IC=-0.164 (n=337)

  - _Acción_: SKIP cuando `ibs_7min` > 0.177
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=656)

- **FILTRO** `ballena_activa_n` > `36.0` → IC=-0.206 (n=246)

  - _Acción_: SKIP cuando `ballena_activa_n` > 36.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=747)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.215 (n=265)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=807)

- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.195 (n=267)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=805)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.212 (n=265)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=807)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.172 (n=312)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=977)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.269 (n=232)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=714)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.221 (n=227)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=719)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.223 (n=229)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=717)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.277 (n=240)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=970)
...
- **PATRÓN** `delta_ratio` |x|> `0.401` → IC=+0.134 (n=233)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.67€ cuando `delta_ratio` |x|> 0.401 (IC base=+0.112)
...
- **PATRÓN** `delta_ratio` |x|> `0.4116` → IC=+0.144 (n=43)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio` |x|> 0.4116 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.300 (n=23)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.121)

- **PATRÓN** `total_vol_5m` < `584.855` → IC=+0.147 (n=49)

  - _Acción_: Kelly boost +0.74€ cuando `total_vol_5m` < 584.855 (IC base=+0.121)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=163)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.182 (n=42)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 19.0 (IC base=-0.020)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.137 (n=122)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 14.0 (IC base=+0.078)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.145 (n=60)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 25.0 (IC base=+0.078)
...
- **PATRÓN** `ibs_15` < `0.1282` → IC=+0.177 (n=91)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.89€ cuando `ibs_15` < 0.1282 (IC base=+0.040)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1971` → IC=+0.302 (n=124)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1971 (IC base=+0.290)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1559` → IC=+0.300 (n=83)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1559 (IC base=+0.290)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.310 (n=114)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.290)

- **PATRÓN** `ibs_15` > `0.7914` → IC=+0.358 (n=111)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7914 (IC base=+0.290)

- **PATRÓN** `dist_vwap_pct` > `0.522` → IC=+0.362 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.522 (IC base=+0.290)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.631` → IC=+0.314 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.631 (IC base=+0.290)

- **PATRÓN** `libro_liquidez` > `7152.8647` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7152.8647 (IC base=+0.290)

- **PATRÓN** `ballena_activa_n` < `546.0` → IC=+0.370 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 546.0 (IC base=+0.290)
...
- **FILTRO** `sigma_h` > `0.009` → IC=-0.144 (n=753)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.009
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1466)

- **FILTRO** `sigma_ewma_delta_pct` > `16.683` → IC=-0.198 (n=296)
...
- **PATRÓN** `ibs_15` < `0.5238` → IC=+0.283 (n=58)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.5238 (IC base=-0.097)

- **PATRÓN** `dist_vwap_pct` < `0.1474` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1474 (IC base=-0.097)
...
- **FILTRO** `sigma_h` > `0.0067` → IC=-0.236 (n=123)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.238 (n=120)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.200 (n=374)

- **FILTRO** `sigma_ewma_delta_pct` > `25.101` → IC=-0.256 (n=80)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 25.101
  - _Potencial_: sin este filtro IC_bueno=-0.200 (n=414)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.152` → IC=+0.218 (n=37)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.152 (IC base=+0.172)

- **PATRÓN** `sigma_h` > `0.004` → IC=+0.225 (n=38)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.004 (IC base=+0.172)

- **PATRÓN** `drift_15min` |x|≤ `0.4277` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4277 (IC base=+0.172)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1155` → IC=+0.175 (n=38)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.88€ cuando `delta_ratio_macro` |x|> 0.1155 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.265 (n=15)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.172)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.175 (n=38)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 14.0 (IC base=+0.172)

- **PATRÓN** `ibs_15` < `0.3357` → IC=+0.321 (n=37)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3357 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.294` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.294 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.945` → IC=+0.175 (n=38)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 11.945 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `4836.9669` → IC=+0.227 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4836.9669 (IC base=+0.172)
...
- **FILTRO** `drift_60min` |x|> `0.7874` → IC=-0.139 (n=181)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.7874
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=545)

- **FILTRO** `drift_15min` |x|> `1.4351` → IC=-0.150 (n=181)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.4351
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=545)

- **FILTRO** `sigma_ewma_delta_pct` > `15.088` → IC=-0.206 (n=90)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 15.088
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=636)

### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.264 (n=125)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.265)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.285 (n=63)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0056 (IC base=+0.265)

- **PATRÓN** `drift_60min` |x|≤ `0.1898` → IC=+0.278 (n=187)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1898 (IC base=+0.265)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0599` → IC=+0.283 (n=187)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0599 (IC base=+0.265)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3963` → IC=+0.312 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3963 (IC base=+0.265)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.299 (n=187)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.265)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.268 (n=192)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.265)

- **PATRÓN** `ibs_15` > `0.83` → IC=+0.300 (n=188)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.83 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` > `0.2755` → IC=+0.340 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2755 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` < `0.0994` → IC=+0.265 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0994 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.106` → IC=+0.270 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.106 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.08` → IC=+0.270 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.08 (IC base=+0.265)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.263 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.265)

- **PATRÓN** `libro_liquidez` > `9958.5281` → IC=+0.293 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9958.5281 (IC base=+0.265)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1282 sube el IC de +0.040 a +0.177 en UPDOWN_GBM#XRP#15min (n=91). Ya aplicado como kelly_boost=+0.89€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.5238 sube el IC de -0.097 a +0.283 en UPDOWN_GBM_15M_TARDIO (n=58). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3357 sube el IC de +0.172 a +0.321 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=37). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.83 sube el IC de +0.265 a +0.300 en UPDOWN_GBM_IBS_ALTO (n=188). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7914 sube el IC de +0.290 a +0.358 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=111). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 565 | +0.075 | +39.47€ | 2 | 11 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 565 | +0.075 | +39.47€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 321 | +0.094 | +28.46€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 321 | +0.094 | +28.46€ | 0 | 12 |
...
| ✅ BALLENAS_TARDIAS | 5845 | -0.100 | -695.29€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 620 | -0.082 | -107.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5225 | -0.102 | -588.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 855 | -0.015 | -98.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 855 | -0.015 | -98.48€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 620 | -0.082 | -107.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 620 | -0.082 | -107.29€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1899 | -0.066 | -59.41€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1899 | -0.066 | -59.41€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1387 | -0.176 | -236.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1387 | -0.176 | -236.65€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 26120 | +0.112 | -1823.17€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5080 | +0.186 | -180.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 17941 | +0.091 | -1575.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2993 | +0.124 | -18.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3016 | +0.058 | -553.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 18 | -0.045 | +2.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2993 | +0.060 | -548.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5492 | +0.134 | -125.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1420 | +0.194 | -87.75€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2984 | +0.109 | -75.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1046 | +0.134 | +60.75€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3020 | +0.073 | -432.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 18 | +0.045 | -1.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3001 | +0.073 | -428.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 5906 | +0.129 | -63.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1851 | +0.170 | -2.00€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2986 | +0.112 | -42.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1057 | +0.107 | -10.63€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5670 | +0.127 | -429.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1757 | +0.202 | -92.05€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2978 | +0.083 | -261.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 890 | +0.132 | -68.35€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3016 | +0.105 | -219.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 16 | +0.000 | +0.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2999 | +0.106 | -218.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5080 | +0.177 | -370.08€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5080 | +0.177 | -370.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1276 | +0.174 | -125.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1276 | +0.174 | -125.26€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 103 | -0.119 | +1.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 103 | -0.119 | +1.58€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1271 | +0.162 | -149.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1271 | +0.162 | -149.03€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1136 | +0.231 | -31.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1136 | +0.231 | -31.91€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1215 | +0.194 | -79.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1215 | +0.194 | -79.21€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 12859 | +0.194 | -1112.63€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 12859 | +0.194 | -1112.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2384 | +0.125 | -444.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2384 | +0.125 | -444.80€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1988 | +0.237 | -45.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1988 | +0.237 | -45.46€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2235 | +0.160 | -299.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2235 | +0.160 | -299.30€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2030 | +0.238 | -41.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2030 | +0.238 | -41.95€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2057 | +0.224 | -84.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2057 | +0.224 | -84.19€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2165 | +0.192 | -196.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2165 | +0.192 | -196.93€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 4624 | +0.131 | +120.15€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 4624 | +0.131 | +120.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2296 | +0.141 | +101.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2296 | +0.141 | +101.30€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2328 | +0.121 | +18.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2328 | +0.121 | +18.85€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 696 | +0.302 | +10.13€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 696 | +0.302 | +10.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 298 | +0.277 | -9.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 298 | +0.277 | -9.12€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 325 | +0.304 | +10.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 325 | +0.304 | +10.23€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 290 | +0.411 | -13.71€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 290 | +0.411 | -13.71€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 147 | +0.111 | +3.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 46 | +0.104 | +0.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 101 | +0.112 | +2.51€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 119 | +0.120 | +4.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 18 | +0.135 | +2.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 101 | +0.112 | +2.51€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 4003 | +0.098 | -155.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 412 | +0.046 | -29.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 3591 | +0.103 | -126.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 2764 | +0.095 | -84.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 412 | +0.046 | -29.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 2352 | +0.104 | -54.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1239 | +0.102 | -71.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1239 | +0.102 | -71.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 375 | +0.280 | -28.08€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 375 | +0.280 | -28.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 375 | +0.280 | -28.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 375 | +0.280 | -28.08€ | 0 | 4 |
| ✅ GBM_LATE_15M | 6404 | +0.045 | +1947.69€ | 0 | 18 |
| ✅ GBM_LATE_15M#15min | 6404 | +0.045 | +1947.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 843 | +0.176 | +534.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 843 | +0.176 | +534.73€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 869 | +0.169 | +474.46€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 869 | +0.169 | +474.46€ | 0 | 29 |
| ✅ GBM_LATE_15M#DOGE | 853 | +0.191 | +587.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 853 | +0.191 | +587.35€ | 0 | 18 |
| ✅ GBM_LATE_15M#ETH | 1012 | -0.059 | -19.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1012 | -0.059 | -19.26€ | 4 | 3 |
| ✅ GBM_LATE_15M#SOL | 1241 | -0.038 | +143.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1241 | -0.038 | +143.14€ | 3 | 3 |
| ✅ GBM_LATE_15M#XRP | 1586 | -0.040 | +227.27€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1586 | -0.040 | +227.27€ | 4 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 7364 | +0.041 | +2746.14€ | 0 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 7364 | +0.041 | +2746.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1126 | -0.028 | +510.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1126 | -0.028 | +510.46€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1605 | -0.037 | +153.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1605 | -0.037 | +153.47€ | 0 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 717 | +0.241 | +658.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 717 | +0.241 | +658.57€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1291 | -0.044 | +6.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1291 | -0.044 | +6.75€ | 9 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1351 | -0.014 | +275.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1351 | -0.014 | +275.43€ | 5 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1274 | +0.234 | +1141.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1274 | +0.234 | +1141.46€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 5027 | +0.170 | +3443.88€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 5027 | +0.170 | +3443.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 634 | +0.193 | +466.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 634 | +0.193 | +466.11€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 839 | +0.162 | +544.65€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 839 | +0.162 | +544.65€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 630 | +0.201 | +486.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 630 | +0.201 | +486.64€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 816 | +0.170 | +537.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 816 | +0.170 | +537.67€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 990 | +0.113 | +549.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 990 | +0.113 | +549.08€ | 0 | 18 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 1118 | +0.196 | +859.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 1118 | +0.196 | +859.73€ | 0 | 25 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 826 | +0.065 | +129.25€ | 0 | 10 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 826 | +0.065 | +129.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 212 | +0.098 | +59.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 212 | +0.098 | +59.63€ | 4 | 14 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 184 | +0.161 | +53.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 184 | +0.161 | +53.70€ | 1 | 19 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 281 | -0.019 | +2.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 281 | -0.019 | +2.34€ | 2 | 4 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 148 | +0.060 | +14.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 148 | +0.060 | +14.84€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO | 5855 | +0.161 | +3690.88€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5855 | +0.161 | +3690.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 807 | +0.182 | +553.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 807 | +0.182 | +553.90€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 958 | +0.158 | +579.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 958 | +0.158 | +579.23€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 798 | +0.216 | +655.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 798 | +0.216 | +655.60€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 835 | +0.131 | +408.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 835 | +0.131 | +408.19€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1063 | +0.093 | +491.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1063 | +0.093 | +491.70€ | 0 | 15 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1394 | +0.188 | +1002.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1394 | +0.188 | +1002.26€ | 0 | 25 |
| ✅ GBM_LATE_5M | 829 | +0.113 | +338.79€ | 1 | 19 |
| ✅ GBM_LATE_5M#5min | 829 | +0.113 | +338.79€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 271 | +0.130 | +97.38€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 271 | +0.130 | +97.38€ | 0 | 16 |
...
| ✅ LEADLAG_BTC_XRP_15M | 227 | +0.107 | +54.05€ | 0 | 4 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 227 | +0.107 | +54.05€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 227 | +0.107 | +54.05€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 227 | +0.107 | +54.05€ | 0 | 4 |
...
| ✅ LIQUIDACIONES_5M | 466 | -0.070 | -39.54€ | 3 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 466 | -0.070 | -39.54€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_5M#ETH | 135 | -0.033 | -4.89€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 135 | -0.033 | -4.89€ | 3 | 1 |
| ✅ LIQUIDACIONES_5M#SOL | 125 | -0.051 | -9.62€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#SOL#5min | 125 | -0.051 | -9.62€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 3254 | +0.003 | -37.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 3254 | +0.003 | -37.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 300 | +0.013 | +11.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 300 | +0.013 | +11.50€ | 1 | 1 |
| ✅ MOMENTUM_IBS_15M#BTC | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 598 | +0.005 | -8.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 517 | +0.003 | -16.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 517 | +0.003 | -16.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 624 | +0.016 | +18.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 624 | +0.016 | +18.93€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 582 | -0.009 | -25.37€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 582 | -0.009 | -25.37€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 633 | -0.004 | -17.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 633 | -0.004 | -17.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 4712 | -0.032 | +151.97€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 4712 | -0.032 | +151.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 740 | -0.035 | +82.10€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 740 | -0.035 | +82.10€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 847 | -0.025 | -16.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 847 | -0.025 | -16.50€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 747 | -0.034 | +109.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 747 | -0.034 | +109.67€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 847 | -0.025 | -20.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 847 | -0.025 | -20.89€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 770 | -0.048 | +2.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 770 | -0.048 | +2.80€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 761 | -0.027 | -5.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 761 | -0.027 | -5.20€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_5M | 2429 | +0.006 | +4.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 2429 | +0.006 | +4.30€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#ETH | 696 | +0.016 | +13.87€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#ETH#5min | 696 | +0.016 | +13.87€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL | 1108 | +0.008 | +1.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 1108 | +0.008 | +1.34€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 12958 | -0.070 | +285.30€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 12958 | -0.070 | +285.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 1968 | -0.092 | +230.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 1968 | -0.092 | +230.21€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 2457 | -0.053 | +23.17€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 2457 | -0.053 | +23.17€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 2036 | -0.083 | +37.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 2036 | -0.083 | +37.74€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 1980 | -0.100 | -172.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 1980 | -0.100 | -172.93€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 2361 | -0.044 | +39.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 2361 | -0.044 | +39.57€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 2156 | -0.057 | +127.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 2156 | -0.057 | +127.54€ | 4 | 0 |
...
| ✅ ORDER_FLOW_5M | 348 | +0.080 | +62.14€ | 1 | 2 |
| ✅ ORDER_FLOW_5M#5min | 212 | +0.093 | +49.55€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 64 | +0.121 | +27.11€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 64 | +0.121 | +27.11€ | 0 | 3 |
...
| ✅ STREAK_FADE_15M | 125 | -0.043 | -16.04€ | 5 | 1 |
| ✅ STREAK_FADE_15M#15min | 125 | -0.043 | -16.04€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 800 | -0.004 | -25.07€ | 1 | 0 |
| ✅ STREAK_FADE_5M#5min | 800 | -0.004 | -25.07€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE | 269 | +0.009 | -2.35€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE#5min | 269 | +0.009 | -2.35€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH | 264 | +0.011 | -3.47€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH#5min | 264 | +0.011 | -3.47€ | 1 | 0 |
...
| ✅ STREAK_MOM_5M | 1539 | +0.018 | +13.08€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 1539 | +0.018 | +13.08€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 505 | +0.017 | +0.86€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 505 | +0.017 | +0.86€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 265 | +0.002 | -1.72€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 265 | +0.002 | -1.72€ | 2 | 0 |
| ✅ STREAK_MOM_5M#SOL | 468 | +0.015 | -0.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 468 | +0.015 | -0.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP | 301 | +0.038 | +14.22€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 301 | +0.038 | +14.22€ | 2 | 3 |
| ✅ STRUCT_NO_15M | 2757 | +0.002 | -41.26€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 2757 | +0.002 | -41.26€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1058 | +0.003 | -16.32€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1058 | +0.003 | -16.32€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1060 | +0.009 | -8.53€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1060 | +0.009 | -8.53€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 639 | -0.010 | -16.41€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 639 | -0.010 | -16.41€ | 2 | 0 |
| ✅ UPDOWN_GBM | 4748 | +0.010 | +136.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1856 | +0.047 | +176.55€ | 0 | 6 |
| ✅ UPDOWN_GBM#240min | 208 | +0.014 | +0.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 2307 | -0.013 | -35.78€ | 3 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 1009 | +0.023 | +56.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 190 | +0.073 | +21.26€ | 4 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 61 | +0.087 | +7.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 632 | +0.019 | +32.37€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 108 | -0.045 | -6.52€ | 2 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 18 | -0.135 | +1.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 589 | +0.003 | +4.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 104 | +0.094 | +24.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 479 | -0.018 | -19.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 1068 | +0.017 | +23.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 493 | +0.043 | +29.81€ | 1 | 5 |
| ✅ UPDOWN_GBM#ETH#240min | 61 | +0.071 | +3.55€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 361 | -0.021 | -12.95€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 138 | +0.021 | +3.10€ | 0 | 1 |
| 🚫 UPDOWN_GBM#ETH#daily | 15 | -0.154 | -0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 1107 | -0.007 | -14.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 414 | +0.002 | -4.88€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 47 | -0.051 | -4.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 550 | -0.002 | -3.09€ | 3 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 84 | -0.023 | -1.38€ | 1 | 2 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 797 | -0.001 | +42.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 492 | +0.053 | +77.45€ | 0 | 6 |
| ✅ UPDOWN_GBM#XRP#240min | 29 | -0.145 | -5.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 276 | -0.079 | -30.11€ | 0 | 0 |
| 🚫 UPDOWN_GBM#daily | 45 | -0.202 | +1.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 165 | +0.290 | +18.23€ | 0 | 10 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 165 | +0.290 | +18.23€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3066 | -0.084 | +382.77€ | 3 | 3 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3066 | -0.084 | +382.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 251 | -0.081 | +115.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 251 | -0.081 | +115.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 630 | -0.166 | -76.92€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 630 | -0.166 | -76.92€ | 4 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 68 | +0.043 | +8.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 68 | +0.043 | +8.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 203 | +0.051 | +50.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 203 | +0.051 | +50.69€ | 2 | 14 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 979 | -0.067 | +176.07€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 979 | -0.067 | +176.07€ | 2 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 935 | -0.087 | +108.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 935 | -0.087 | +108.51€ | 6 | 0 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 249 | +0.265 | +162.51€ | 0 | 14 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 249 | +0.265 | +162.51€ | 0 | 0 |
...
| ✅ UPDOWN_OU_5M#SOL#5min | 28 | -0.200 | -4.70€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.093) — sin ventaja clara. oversold(IBS<0.3): IC=-0.005 n=1630 | neutral: IC=+0.007 n=1740 | overbought(IBS>0.7): IC=+0.089 n=1916
  - _Datos_: n=5554 IC=+0.032 PNL=+381.22€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=414 IC=+0.002 PNL=-4.88€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.078 n=77100 | tras_1loss IC=+0.045 n=59689 | tras_2loss IC=+0.009 n=27093/40 | gap=+0.069 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 4686 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.016 n=479 | contrario_BTC IC=+0.006 n=352/40 | gap=+0.021 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=4507 IC=+0.006 PNL=+85.67€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=4507 IC=+0.006 PNL=+85.67€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1101 IC=+0.037 PNL=+68.99€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1101 IC=+0.037 PNL=+68.99€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=1625 IC=-0.013 PNL=-38.65€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1625 IC=-0.013 PNL=-38.65€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1260 IC=+0.028 PNL=+80.99€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1260 IC=+0.028 PNL=+80.99€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=644 IC=+0.022 PNL=+33.69€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=644 IC=+0.022 PNL=+33.69€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.119 > 0.02 con n=179 PNL=+45.09€
  - _Datos_: n=179 IC=+0.119 PNL=+45.09€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=361 IC=+0.040 PNL=+41.92€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=361 IC=+0.040 PNL=+41.92€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=3293 IC=-0.126 PNL=+319.27€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3293 IC=-0.126 PNL=+319.27€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.235 < -0.1 con n=338 PNL=-34.11€
  - _Datos_: n=338 IC=-0.235 PNL=-34.11€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=523 IC=-0.035 PNL=+9.53€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=523 IC=-0.035 PNL=+9.53€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.173 > 0.08 con n=463 PNL=+245.89€
  - _Datos_: n=463 IC=+0.173 PNL=+245.89€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=838 IC=-0.033 PNL=+127.41€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=838 IC=-0.033 PNL=+127.41€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.241 > 0.08 con n=1156 PNL=-110.08€
  - _Datos_: n=1156 IC=+0.241 PNL=-110.08€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2384 IC=+0.125 PNL=-444.80€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2384 IC=+0.125 PNL=-444.80€
