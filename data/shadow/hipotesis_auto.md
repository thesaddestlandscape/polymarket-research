# Hipótesis automáticas — 2026-07-04 05:11 UTC
_Generado por shadow_postmortem.py sobre 3361 resoluciones (PNL=+10.57€)_
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.147 (n=15)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 5.0 (IC base=+0.044)
...
- **FILTRO** `drift_60min` |x|> `0.4057` → IC=-0.122 (n=43)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.4057
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=130)

- **FILTRO** `delta_ratio_macro` |x|≤ `0.0671` → IC=-0.144 (n=43)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.0671
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 626 | +0.076 | +115.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 626 | +0.076 | +115.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 164 | +0.030 | +11.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 164 | +0.030 | +11.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 164 | +0.018 | +5.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 164 | +0.018 | +5.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 157 | +0.110 | +43.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 157 | +0.110 | +43.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 141 | +0.157 | +54.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 141 | +0.157 | +54.73€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M | 1532 | +0.012 | +10.65€ | 0 | 1 |
| ✅ ORDER_FLOW_5M#5min | 1396 | +0.008 | -1.94€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 266 | -0.026 | -9.19€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 266 | -0.026 | -9.19€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 901 | -0.044 | -61.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 668 | -0.024 | -33.45€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 367 | -0.015 | +0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 282 | +0.000 | +7.32€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.044) — sin ventaja clara. oversold(IBS<0.3): IC=-0.024 n=183 | neutral: IC=-0.069 n=151 | overbought(IBS>0.7): IC=-0.053 n=159
  - _Datos_: n=511 IC=-0.046 PNL=-36.53€
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 162 ops con delta_ratio | SOL: 200 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.015 n=1630 | tras_1loss IC=-0.021 n=1626 | tras_2loss IC=-0.040 n=829/40 | gap=+0.056 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=56 IC=+0.052 PNL=+3.20€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=56 IC=+0.052 PNL=+3.20€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=778 IC=-0.040 PNL=-48.21€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=778 IC=-0.040 PNL=-48.21€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=401 IC=-0.053 PNL=-47.26€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=401 IC=-0.053 PNL=-47.26€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=289 IC=-0.026 PNL=-38.31€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=289 IC=-0.026 PNL=-38.31€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=928 IC=+0.045 PNL=+96.13€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=928 IC=+0.045 PNL=+96.13€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.076 < -0.05 con n=543 PNL=-75.18€
  - _Datos_: n=543 IC=-0.076 PNL=-75.18€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 72/120 ops en el filtro definido (IC actual=+0.122 PNL=+10.88€)
  - _Datos_: n=72 IC=+0.122 PNL=+10.88€
