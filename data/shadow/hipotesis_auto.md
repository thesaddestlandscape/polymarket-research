# Hipótesis automáticas — 2026-07-06 21:47 UTC
_Generado por shadow_postmortem.py sobre 4493 resoluciones (PNL=+340.98€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.135 (n=102)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0084 (IC base=+0.024)

- **PATRÓN** `ibs_15` < `0.0394` → IC=+0.167 (n=61)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.0394 (IC base=+0.024)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.167 (n=34)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0059 (IC base=+0.048)

- **PATRÓN** `ibs_15` < `0.044` → IC=+0.175 (n=38)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` < 0.044 (IC base=+0.048)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0394 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.167 n=61). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.044 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.175 n=38). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1507 | +0.109 | +445.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1507 | +0.109 | +445.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 393 | +0.047 | +43.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 393 | +0.047 | +43.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 391 | +0.083 | +70.57€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 391 | +0.083 | +70.57€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 392 | +0.157 | +194.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 392 | +0.157 | +194.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 331 | +0.155 | +136.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 331 | +0.155 | +136.85€ | 0 | 0 |
| 🚫 GBM_LATE_60M | 29 | -0.274 | -9.39€ | 0 | 0 |
| 🚫 GBM_LATE_60M#60min | 29 | -0.274 | -9.39€ | 0 | 0 |
| 🚫 GBM_LATE_60M#BTC | 8 | -0.120 | -3.28€ | 0 | 0 |
| 🚫 GBM_LATE_60M#BTC#60min | 8 | -0.120 | -3.28€ | 0 | 0 |
...
| ✅ LATE_WINDOW_5MIN | 18 | +0.180 | +3.91€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 18 | +0.180 | +3.91€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 18 | +0.180 | +3.91€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 18 | +0.180 | +3.91€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1014 | -0.034 | -52.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 772 | -0.010 | -22.06€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 449 | -0.008 | +0.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 361 | +0.010 | +8.60€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.056) — sin ventaja clara. oversold(IBS<0.3): IC=-0.011 n=227 | neutral: IC=-0.067 n=178 | overbought(IBS>0.7): IC=-0.025 n=196
  - _Datos_: n=624 IC=-0.029 PNL=-27.15€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.044 n=2290 | tras_1loss IC=+0.000 n=2066 | tras_2loss IC=-0.024 n=1013/40 | gap=+0.068 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=891 IC=-0.029 PNL=-38.83€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=891 IC=-0.029 PNL=-38.83€
...
**⏳ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: 18/30 ops en el filtro definido (IC actual=+0.180 PNL=+3.91€)
  - _Datos_: n=18 IC=+0.180 PNL=+3.91€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=286 IC=-0.004 PNL=+0.29€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=286 IC=-0.004 PNL=+0.29€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=2035 IC=+0.073 PNL=+416.86€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=2035 IC=+0.073 PNL=+416.86€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=77 IC=-0.044 PNL=-11.93€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=77 IC=-0.044 PNL=-11.93€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=119 IC=-0.021 PNL=+34.56€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=119 IC=-0.021 PNL=+34.56€
