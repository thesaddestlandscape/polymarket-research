# Hipótesis automáticas — 2026-07-02 03:32 UTC
_Generado por shadow_postmortem.py sobre 2529 resoluciones (PNL=-88.04€)_
...
- **PATRÓN** `ibs_15` < `0.0714` → IC=+0.244 (n=41)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0714 (IC base=+0.071)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0714 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.244 n=41). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 776 | -0.035 | -37.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 554 | -0.009 | -10.41€ | 2 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.080) — sin ventaja clara. oversold(IBS<0.3): IC=+0.020 n=121 | neutral: IC=-0.059 n=116 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=386 IC=-0.028 PNL=-12.12€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1193 | tras_1loss IC=-0.037 n=1254 | tras_2loss IC=-0.051 n=655/40 | gap=+0.054 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=653 IC=-0.028 PNL=-23.80€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=653 IC=-0.028 PNL=-23.80€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=171 IC=+0.043 PNL=+17.45€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=171 IC=+0.043 PNL=+17.45€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 112/200 ops en el filtro definido (IC actual=+0.035 PNL=+4.89€)
  - _Datos_: n=112 IC=+0.035 PNL=+4.89€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=112 IC=+0.035 PNL=+4.89€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=112 IC=+0.035 PNL=+4.89€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 17/40 ops en el filtro definido (IC actual=+0.022 PNL=-0.49€)
  - _Datos_: n=17 IC=+0.022 PNL=-0.49€
