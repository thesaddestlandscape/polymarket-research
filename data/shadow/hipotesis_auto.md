# Hipótesis automáticas — 2026-07-06 16:24 UTC
_Generado por shadow_postmortem.py sobre 4376 resoluciones (PNL=+288.37€)_
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.128 (n=100)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0084 (IC base=+0.025)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.138 (n=78)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.0613 (IC base=+0.025)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.157 (n=33)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0059 (IC base=+0.054)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.141 (n=37)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 7.0 (IC base=+0.054)

- **PATRÓN** `ibs_15` < `0.044` → IC=+0.167 (n=37)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.044 (IC base=+0.054)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1422 | +0.102 | +395.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1422 | +0.102 | +395.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 372 | +0.037 | +37.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 372 | +0.037 | +37.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 370 | +0.073 | +57.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 370 | +0.073 | +57.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 371 | +0.151 | +175.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 371 | +0.151 | +175.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 309 | +0.153 | +124.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 309 | +0.153 | +124.96€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 15 | -0.110 | -2.80€ | 0 | 0 |
| ✅ STREAK_FADE_15M#15min | 15 | -0.110 | -2.80€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL | 5 | -0.018 | -0.61€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL#15min | 5 | -0.018 | -0.61€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP | 7 | -0.097 | -2.61€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP#15min | 7 | -0.097 | -2.61€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1000 | -0.037 | -56.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 758 | -0.015 | -26.66€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 439 | -0.010 | -1.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 351 | +0.007 | +7.48€ | 1 | 3 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.040 n=2211 | tras_1loss IC=-0.002 n=2025 | tras_2loss IC=-0.025 n=997/40 | gap=+0.065 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=877 IC=-0.032 PNL=-43.43€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=877 IC=-0.032 PNL=-43.43€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=347 IC=-0.004 PNL=-27.00€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=347 IC=-0.004 PNL=-27.00€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=280 IC=-0.004 PNL=-1.03€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=280 IC=-0.004 PNL=-1.03€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1918 IC=+0.066 PNL=+364.26€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1918 IC=+0.066 PNL=+364.26€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=75 IC=-0.033 PNL=-10.82€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=75 IC=-0.033 PNL=-10.82€
...
**🔴 H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.003 < 0.03 con n=191 PNL=+9.44€
  - _Datos_: n=191 IC=-0.003 PNL=+9.44€
