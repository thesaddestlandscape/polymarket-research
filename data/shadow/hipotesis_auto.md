# Hipótesis automáticas — 2026-06-30 22:29 UTC
_Generado por shadow_postmortem.py sobre 1481 resoluciones (PNL=-60.72€)_

## Patrones causales activos

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0921` → IC=+0.125 (n=22)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.62€ cuando `pct_spot_vs_ref` |x|≤ 0.0921 (IC base=+0.034)

- **PATRÓN** `drift_60min` |x|≤ `0.1354` → IC=+0.130 (n=25)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.1354 (IC base=+0.034)
...
- **FILTRO** `hora_utc` > `18.0` → IC=-0.150 (n=18)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 18.0
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=61)

- **PATRÓN** `sigma_h` > `0.0131` → IC=+0.128 (n=49)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.0131 (IC base=+0.027)

- **PATRÓN** `ibs_15` < `0.1521` → IC=+0.182 (n=20)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` < 0.1521 (IC base=+0.027)

### UPDOWN_GBM#ETH#60min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0853` → IC=+0.147 (n=15)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.74€ cuando `pct_spot_vs_ref` |x|≤ 0.0853 (IC base=+0.022)

- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.125 (n=22)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0097 (IC base=+0.022)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.1521 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.182 n=20). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 486 | -0.022 | -13.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 298 | +0.017 | +3.15€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 104 | -0.038 | -5.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 151 | -0.016 | -10.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 86 | +0.034 | -3.14€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 210 | +0.014 | +5.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 144 | +0.027 | +5.55€ | 1 | 2 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 12 | -0.086 | -3.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 44 | +0.022 | +0.40€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.065) — sin ventaja clara. oversold(IBS<0.3): IC=-0.036 n=54 | neutral: IC=-0.091 n=64 | overbought(IBS>0.7): IC=-0.026 n=74
  - _Datos_: n=197 IC=-0.053 PNL=-14.70€
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=44/40 IC=+0.022 PNL=+0.40€ | BTC#60min: n=39/40 IC=-0.037 PNL=-3.81€ | SOL#60min: n=21/40 IC=-0.152 PNL=-2.25€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=387 IC=-0.017 PNL=-7.93€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=387 IC=-0.017 PNL=-7.93€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=87 IC=-0.051 PNL=-5.60€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=87 IC=-0.051 PNL=-5.60€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=231 IC=-0.015 PNL=-17.10€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=231 IC=-0.015 PNL=-17.10€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=86 IC=+0.034 PNL=-3.14€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=86 IC=+0.034 PNL=-3.14€

**⏳ H-CUSTOM-DRIFT15-ZONA-MUERTA** — GBM#15min drift_15min ∈ [-0.3,+0.3] — zona muerta de señal
  - _Hipótesis_: Análisis n=127 GBM#15min: cuando drift_15min está entre -0.3 y +0.3 (mercado sin dirección clara) el IC es negativo (-0.043). Cuando drift>0.3 IC=+0.100 (n=28). Cuando drift<-1 IC=+0.048 (reversión). La señal requiere mercado con dirección clara.
  - _Umbral_: 50
  - _Acción_: Filtrar señales GBM#15min cuando drift_15min ∈ [-0.3, +0.3] — validar con n≥50 antes de implementar
  - _Estado_: 47/50 ops en el filtro definido (IC actual=-0.071 PNL=-3.49€)
  - _Datos_: n=47 IC=-0.071 PNL=-3.49€

**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  - _Hipótesis_: Cuando drift_15min > 0.3%/h el GBM captura bien la dirección: IC=+0.100 n=28 en todos GBM#15min; IC=+0.152 n=13 solo BTC. El mercado tiene dirección clara y el GBM la sigue. Hipótesis: este rango es donde la señal es real.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma IC>0.10 con n≥40 → boost ×1.2 en GBM#15min cuando drift_15min>0.3
  - _Estado_: n=129 IC=+0.042 PNL=-2.88€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=129 IC=+0.042 PNL=-2.88€
