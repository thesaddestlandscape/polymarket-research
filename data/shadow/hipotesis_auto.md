# Hipótesis automáticas — 2026-07-12 06:32 UTC
_Generado por shadow_postmortem.py sobre 10498 resoluciones (PNL=+1774.64€)_
...
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.147 (n=900)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0092 (IC base=+0.110)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.141 (n=904)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 11.0 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.4443` → IC=+0.198 (n=84)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.4443 (IC base=+0.110)
...
| ✅ GBM_LATE_15M | 3490 | +0.113 | +1120.89€ | 0 | 7 |
| ✅ GBM_LATE_15M#15min | 3490 | +0.113 | +1120.89€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 834 | +0.175 | +448.29€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 834 | +0.175 | +448.29€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 857 | +0.157 | +407.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 857 | +0.157 | +407.71€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 158 | +0.263 | +148.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 158 | +0.263 | +148.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1032 | +0.080 | +235.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1032 | +0.080 | +235.11€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#XRP | 266 | +0.209 | +184.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 266 | +0.209 | +184.72€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 124 | -0.016 | -5.12€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 124 | -0.016 | -5.12€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.088 n=5891 | tras_1loss IC=+0.041 n=4470 | tras_2loss IC=+0.008 n=2022/40 | gap=+0.080 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8040 IC=+0.094 PNL=+1850.52€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8040 IC=+0.094 PNL=+1850.52€
