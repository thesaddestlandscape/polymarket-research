# Hipótesis automáticas — 2026-09-15 21:24 UTC
_Generado por shadow_postmortem.py sobre 457007 resoluciones (PNL=+49287.55€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.249 (n=429)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.249 (n=429)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.136 (n=330)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.256 (n=330)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.256 (n=330)
...
- **PATRÓN** `banda_hit_calibrado` > `0.7991` → IC=+0.274 (n=246)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.7991 (IC base=+0.128)

- **PATRÓN** `banda_z` > `11.438` → IC=+0.252 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.438 (IC base=+0.128)

- **PATRÓN** `ballenas_wallet_edge_medio` > `3.005` → IC=+0.133 (n=118)

  - _Acción_: Kelly boost +0.67€ cuando `ballenas_wallet_edge_medio` > 3.005 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.148 (n=265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2596.553` → IC=+0.130 (n=330)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.04` → IC=-0.254 (n=5690)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.04
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=17073)
...
- **FILTRO** `restante_s_al_confirmar` < `485.84` → IC=-0.160 (n=307)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 485.84
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=923)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `135.81` → IC=-0.280 (n=708)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 135.81
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2126)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `141.37` → IC=-0.155 (n=1464)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.37
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=4397)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.58` → IC=-0.254 (n=1345)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.58
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=4035)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `157.06` → IC=-0.328 (n=1424)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.306 (n=60)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=190)
...
- **PATRÓN** `libro_liquidez` > `10994.9669` → IC=+0.201 (n=862)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10994.9669 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.208 (n=1236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.273 (n=1185)
...
- **PATRÓN** `libro_liquidez` > `13020.8583` → IC=+0.209 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13020.8583 (IC base=+0.202)
...
- **PATRÓN** `py_entrada` < `0.425` → IC=+0.167 (n=563)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2318)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.245 (n=1042)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.238)

- **PATRÓN** `py_entrada` < `0.355` → IC=+0.301 (n=1013)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.355 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.243 (n=1206)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `4343.582` → IC=+0.242 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4343.582 (IC base=+0.238)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.215 (n=592)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.144 (n=680)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=9035)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.219 (n=3210)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2241)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.325 (n=175)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.347 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.289)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.182 (n=2106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.247 (n=1993)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.200 (n=2156)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.193 (n=1546)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.186 (n=4908)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.71 (IC base=+0.169)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.225 (n=4765)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `4.39` → IC=+0.145 (n=2467)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9339` → IC=+0.199 (n=2644)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.9339 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5684` → IC=+0.131 (n=7454)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.5684 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5845` → IC=+0.180 (n=445)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.5845 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3514` → IC=+0.169 (n=2553)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3514 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `0.6977` → IC=+0.171 (n=1060)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.6977 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8699` → IC=+0.173 (n=1606)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8699 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.2462` → IC=+0.222 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2462 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4644` → IC=+0.198 (n=4012)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4644 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.208 (n=3785)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.226 (n=1032)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.222 (n=1029)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3852` → IC=+0.217 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3852 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `10909.0739` → IC=+0.221 (n=1029)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10909.0739 (IC base=+0.212)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.162 (n=974)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0048 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.0761` → IC=+0.169 (n=369)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0761 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.171 (n=375)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 18.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` < `0.6723` → IC=+0.177 (n=1107)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6723 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.157 (n=1001)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1332 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.553` → IC=+0.177 (n=190)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 11.553 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.152 (n=1107)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2046 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.142 (n=1107)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.613 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.1561` → IC=+0.190 (n=298)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1561 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `2.4323` → IC=+0.155 (n=998)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4323 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `13209.8237` → IC=+0.157 (n=738)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 13209.8237 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `216.0` → IC=+0.167 (n=307)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 216.0 (IC base=+0.142)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.188 (n=1330)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0057 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.176 (n=1334)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1063` → IC=+0.182 (n=1128)
...
- **PATRÓN** `volumen_spike_ratio` > `3.0416` → IC=+0.198 (n=564)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 3.0416 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=1518)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.222 (n=1153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.1516` → IC=+0.214 (n=508)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1516 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.247 (n=386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` < `0.3808` → IC=+0.231 (n=1015)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.389` → IC=+0.215 (n=1261)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3652` → IC=+0.269 (n=167)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3652 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.8406` → IC=+0.205 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8406 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.2947` → IC=+0.222 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2947 (IC base=+0.213)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=592)
...
- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.218 (n=430)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1682)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.272` → IC=+0.135 (n=530)
...
- **PATRÓN** `volumen_regimen` < `0.8572` → IC=+0.153 (n=358)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5033` → IC=+0.179 (n=434)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5033 (IC base=+0.001)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.127 (n=1717)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=+0.118 (n=855)
...
- **PATRÓN** `dist_vwap_pct` > `0.7708` → IC=+0.308 (n=24)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7708 (IC base=-0.045)

- **PATRÓN** `volumen_regimen` < `1.1047` → IC=+0.206 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1047 (IC base=-0.045)

- **PATRÓN** `volumen_pendiente_norm` < `0.203` → IC=+0.206 (n=199)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4885` → IC=+0.238 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4885 (IC base=-0.045)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.246 (n=175)
...
- **FILTRO** `ibs_20min` > `0.7708` → IC=-0.203 (n=644)
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.173 (n=2530)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0091 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.9833` → IC=+0.289 (n=2532)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9833 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `0.7171` → IC=+0.281 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7171 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.506` → IC=+0.142 (n=3587)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.506 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6762` → IC=+0.234 (n=2297)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4784` → IC=+0.237 (n=1365)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4784 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` > `2.7839` → IC=+0.237 (n=1365)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7839 (IC base=+0.086)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.277 (n=3579)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.139 (n=2587)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0084 (IC base=+0.068)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.150 (n=6815)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5556 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` > `0.6896` → IC=+0.243 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6896 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` < `0.2344` → IC=+0.231 (n=2023)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2344 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.231 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` > `1.2011` → IC=+0.252 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2011 (IC base=+0.068)

- **PATRÓN** `volumen_pendiente_norm` > `0.2525` → IC=+0.323 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2525 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` < `1.6249` → IC=+0.255 (n=1201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6249 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` > `2.37` → IC=+0.256 (n=1238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.37 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.255 (n=2592)
...
- **PATRÓN** `ibs_20min` > `0.8649` → IC=+0.253 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8649 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.29` → IC=+0.149 (n=698)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 3.29 (IC base=+0.038)
...
- **FILTRO** `ibs_20min` > `0.8269` → IC=-0.149 (n=571)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1715)
...
- **PATRÓN** `dist_vwap_pct` < `0.1622` → IC=+0.216 (n=403)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.238 (n=606)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.52` → IC=+0.272 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.52 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.1101` → IC=+0.254 (n=1007)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.627` → IC=+0.278 (n=1036)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.627 (IC base=+0.278)
...
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.207 (n=822)
...
- **FILTRO** `ibs_20min` > `0.7143` → IC=-0.235 (n=436)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1311)

- **FILTRO** `sigma_ewma_delta_pct` > `4.704` → IC=-0.169 (n=409)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.704
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1338)
...
- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.128 (n=878)
...
- **PATRÓN** `dist_vwap_pct` < `0.3939` → IC=+0.184 (n=371)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.3939 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` < `0.7171` → IC=+0.245 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7171 (IC base=+0.003)

- **PATRÓN** `volumen_pendiente_norm` < `0.1007` → IC=+0.183 (n=320)
...
- **PATRÓN** `dist_vwap_pct` > `0.1867` → IC=+0.314 (n=588)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1867 (IC base=+0.268)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.372` → IC=+0.296 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.372 (IC base=+0.268)

- **PATRÓN** `volumen_regimen` > `0.8543` → IC=+0.294 (n=692)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8543 (IC base=+0.268)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5657` → IC=+0.271 (n=973)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.272 (n=1073)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.268)

- **PATRÓN** `libro_liquidez` > `2584.5792` → IC=+0.275 (n=692)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5387` → IC=+0.266 (n=971)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.268 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.268)

- **PATRÓN** `libro_liquidez` > `2565.5748` → IC=+0.277 (n=755)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.234` → IC=+0.249 (n=1237)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.234 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2177` → IC=+0.163 (n=3995)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2177 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6223` → IC=+0.159 (n=3995)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6223 (IC base=+0.167)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4533` → IC=+0.172 (n=1897)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.4533 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6741` → IC=+0.169 (n=1896)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.6741 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3825.7125` → IC=+0.173 (n=1996)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3825.7125 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.184 (n=4899)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 123.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.189 (n=3889)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0063 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.206 (n=1943)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0794 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.204 (n=2807)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` < `0.459` → IC=+0.227 (n=5821)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.459 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.2258` → IC=+0.163 (n=4327)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2258 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.27` → IC=+0.195 (n=1012)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.27 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.157 (n=4252)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1913 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `0.6252` → IC=+0.152 (n=4253)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6252 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` > `0.2927` → IC=+0.230 (n=832)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2927 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `1.575` → IC=+0.174 (n=2274)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.575 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `2.6511` → IC=+0.179 (n=1722)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.6511 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.172 (n=4786)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.181 (n=874)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0049 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.0584` → IC=+0.200 (n=331)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0584 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.166 (n=914)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 7.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.5289` → IC=+0.193 (n=991)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.5289 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.1381` → IC=+0.169 (n=1003)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1381 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.118` → IC=+0.211 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.118 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.2129` → IC=+0.166 (n=991)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2129 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1594` → IC=+0.185 (n=306)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1594 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.4411` → IC=+0.163 (n=881)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4411 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `230.0` → IC=+0.160 (n=266)
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.223 (n=749)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` > `3.5248` → IC=+0.249 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5248 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `1887.9956` → IC=+0.233 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.9956 (IC base=+0.223)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.214 (n=316)
...
- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.141 (n=681)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8615 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `0.6106` → IC=+0.129 (n=1020)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.6106 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` > `0.2894` → IC=+0.195 (n=149)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2894 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` < `1.7906` → IC=+0.134 (n=604)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.7906 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `2.4834` → IC=+0.141 (n=302)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.4834 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.152 (n=463)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 10007.3401 (IC base=+0.128)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.148 (n=745)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0077 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.135 (n=812)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.176 (n=514)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 15.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` < `0.5435` → IC=+0.208 (n=1113)
...
- **PATRÓN** `dist_vwap_pct` < `0.1929` → IC=+0.139 (n=1033)
...
- **PATRÓN** `volumen_regimen` < `1.041` → IC=+0.131 (n=979)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.041 (IC base=+0.116)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1742` → IC=+0.140 (n=440)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.1742 (IC base=+0.116)
...
- **PATRÓN** `sigma_h` < `0.0271` → IC=+0.201 (n=1064)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7241` → IC=+0.255 (n=951)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7241 (IC base=+0.201)
...
- **PATRÓN** `volumen_regimen` < `1.2084` → IC=+0.205 (n=1064)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1845` → IC=+0.215 (n=899)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1845 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.202 (n=1084)
...
- **PATRÓN** `sigma_h` > `0.0163` → IC=+0.213 (n=753)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.219 (n=561)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `1.1503` → IC=+0.222 (n=124)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1503 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` < `0.2686` → IC=+0.205 (n=1175)
...
- **PATRÓN** `volumen_regimen` > `0.6291` → IC=+0.219 (n=1130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6291 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2822` → IC=+0.292 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2822 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `2.2447` → IC=+0.199 (n=874)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.2447 (IC base=+0.205)
...
- **PATRÓN** `libro_liquidez` > `2530.3534` → IC=+0.214 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2530.3534 (IC base=+0.205)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.150 (n=653)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0073 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.0966` → IC=+0.149 (n=480)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.0966 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.180 (n=724)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.3929` → IC=+0.167 (n=1440)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.3929 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.8433` → IC=+0.167 (n=199)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.8433 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.699` → IC=+0.168 (n=654)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.699 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8646` → IC=+0.155 (n=825)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4335` → IC=+0.154 (n=460)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4335 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.5716` → IC=+0.157 (n=459)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5716 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=1588)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8101.5764` → IC=+0.160 (n=653)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 8101.5764 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.159 (n=1219)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 156.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.151 (n=505)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0037 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.129 (n=1332)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3402 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=1534)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.48` → IC=+0.156 (n=1332)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.48 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2164` → IC=+0.124 (n=1335)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.2164 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.985` → IC=+0.134 (n=446)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 5.985 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.2259` → IC=+0.123 (n=1334)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2259 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.167` → IC=+0.142 (n=392)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.167 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `2.2358` → IC=+0.133 (n=1272)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.2358 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.128 (n=608)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.144 (n=321)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 8.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2855` → IC=+0.141 (n=321)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.2855 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3078` → IC=+0.140 (n=98)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.3078 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.256` → IC=+0.169 (n=152)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.256 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6895` → IC=+0.164 (n=141)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.6895 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.0903` → IC=+0.128 (n=119)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.0903 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `9647.1518` → IC=+0.141 (n=321)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 9647.1518 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.173 (n=99)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 151.0 (IC base=+0.104)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.057` → IC=+0.125 (n=417)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.057 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.129 (n=469)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.1856 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` > `1.0598` → IC=+0.161 (n=213)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.0598 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.206 (n=134)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.233 (n=298)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.194)

- **PATRÓN** `ibs_20min` > `0.2663` → IC=+0.232 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2663 (IC base=+0.194)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.116` → IC=+0.227 (n=141)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.116 (IC base=+0.194)

- **PATRÓN** `volumen_regimen` < `0.8331` → IC=+0.204 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8331 (IC base=+0.194)
...
- **FILTRO** `dist_vwap_pct` > `0.3939` → IC=-0.206 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=358)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.171 (n=141)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 15.0 (IC base=+0.074)

- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.202 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.074)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.329` → IC=+0.154 (n=134)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 5.329 (IC base=+0.074)

- **PATRÓN** `libro_liquidez` > `2982.5482` → IC=+0.160 (n=101)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2982.5482 (IC base=+0.074)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.129 (n=138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 14.0 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.4524` → IC=+0.167 (n=280)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.4524 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.921` → IC=+0.154 (n=50)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 8.921 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` < `0.7177` → IC=+0.151 (n=124)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7177 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` < `0.1007` → IC=+0.122 (n=257)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` < 0.1007 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.4929` → IC=+0.129 (n=257)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 2.4929 (IC base=+0.087)

- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.134 (n=225)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 44.0 (IC base=+0.087)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6421` → IC=+0.183 (n=2404)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.6421 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3784.1723` → IC=+0.171 (n=2524)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3784.1723 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.194 (n=5452)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 94.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.197 (n=4654)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0067 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.4793` → IC=+0.184 (n=6979)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4793 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.205 (n=2680)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.239 (n=6980)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5556 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.2357` → IC=+0.166 (n=4408)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.2357 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.856` → IC=+0.200 (n=1002)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.856 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.706` → IC=+0.183 (n=6747)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.706 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `0.7028` → IC=+0.161 (n=2122)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.7028 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.162 (n=1608)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.2035 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.251 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.3011` → IC=+0.190 (n=2831)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3011 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.179 (n=5861)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.231 (n=578)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.200 (n=615)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.366` → IC=+0.293 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.366 (IC base=+0.194)

- **PATRÓN** `volumen_pendiente_norm` > `0.2778` → IC=+0.242 (n=165)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.384` → IC=+0.153 (n=1064)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.384 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6937` → IC=+0.187 (n=528)
...
- **PATRÓN** `volumen_spike_ratio` < `2.132` → IC=+0.159 (n=1009)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.132 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7608` → IC=+0.158 (n=764)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7608 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10724.0239` → IC=+0.170 (n=1072)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 10724.0239 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `495.0` → IC=+0.163 (n=1081)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 495.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.170 (n=1076)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0057 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.326` → IC=+0.168 (n=1076)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.326 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.181 (n=365)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 18.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` < `0.6372` → IC=+0.207 (n=1076)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6372 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.5411` → IC=+0.161 (n=216)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.5411 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.168 (n=987)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1332 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.281` → IC=+0.175 (n=530)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.281 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.167 (n=1076)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1917 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.1498` → IC=+0.211 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1498 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `2.4236` → IC=+0.173 (n=979)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.4236 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.5164` → IC=+0.163 (n=874)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.5164 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `283.0` → IC=+0.174 (n=296)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 283.0 (IC base=+0.157)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.223 (n=1197)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.541` → IC=+0.297 (n=353)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.541 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` < `0.2179` → IC=+0.216 (n=1153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2179 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `1.6811` → IC=+0.217 (n=1120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6811 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.224 (n=1360)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1543` → IC=+0.231 (n=510)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1543 (IC base=+0.230)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.255 (n=439)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.230)

- **PATRÓN** `ibs_20min` < `0.3653` → IC=+0.267 (n=1019)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3653 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.708` → IC=+0.275 (n=412)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4329` → IC=+0.138 (n=1284)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.4329 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.163 (n=633)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 15.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.7089` → IC=+0.234 (n=856)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7089 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.3546` → IC=+0.183 (n=481)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.3546 (IC base=+0.136)
...
- **PATRÓN** `volumen_regimen` < `0.8804` → IC=+0.160 (n=856)
...
- **PATRÓN** `ibs_20min` < `0.6883` → IC=+0.192 (n=1034)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6883 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.2051` → IC=+0.145 (n=965)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.2051 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.104` → IC=+0.205 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.104 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8599` → IC=+0.143 (n=690)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8599 (IC base=+0.138)
...
- **PATRÓN** `volumen_spike_ratio` < `1.557` → IC=+0.153 (n=425)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.557 (IC base=+0.138)
...
- **PATRÓN** `ballena_activa_n` < `195.0` → IC=+0.145 (n=959)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 195.0 (IC base=+0.138)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.165 (n=493)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.451` → IC=+0.220 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.451 (IC base=+0.098)
...
- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.211 (n=1260)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.4757` → IC=+0.131 (n=1242)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.4757 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.127 (n=1214)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.437 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `0.7164` → IC=+0.158 (n=554)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7164 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` > `0.2178` → IC=+0.175 (n=192)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2178 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `1.4615` → IC=+0.141 (n=368)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4615 (IC base=+0.116)
...
- **PATRÓN** `sigma_h` > `0.0181` → IC=+0.212 (n=878)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0181 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1379)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.067` → IC=+0.262 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.067 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` < `1.2457` → IC=+0.206 (n=1318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2457 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.627` → IC=+0.208 (n=1317)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.627 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.0799` → IC=+0.227 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0799 (IC base=+0.204)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.212 (n=1324)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2567.2944` → IC=+0.209 (n=878)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.213 (n=706)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` < `2.2257` → IC=+0.197 (n=1120)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2257 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.197 (n=1272)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4427 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.209 (n=985)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2542.8974` → IC=+0.202 (n=968)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=6178)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=1030)

- **FILTRO** `libro_liquidez` < `15900.0203` → IC=-0.154 (n=261)

  - _Acción_: SKIP cuando `libro_liquidez` < 15900.0203
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=784)

### MOMENTUM_IBS_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1308)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.179 (n=2599)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=7903)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=2685)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8275)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.217 (n=426)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1340)

- **FILTRO** `ibs_20min` < `0.748` → IC=-0.177 (n=441)
...
- **FILTRO** `py_entrada` > `0.65` → IC=-0.160 (n=448)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1502)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.199 (n=446)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1370)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.215 (n=458)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1468)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.165 (n=481)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1445)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.196 (n=481)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1449)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2379)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2378)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7497)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=17215)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=5725)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=18987)

- **FILTRO** `ibs_7min` < `0.7059` → IC=-0.241 (n=6160)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7059
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=18552)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.161 (n=8204)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=16508)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=7697)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=23286)

- **FILTRO** `ibs_7min` > `0.2964` → IC=-0.177 (n=7745)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2964
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=23238)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=929)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3027)

- **FILTRO** `ibs_7min` < `0.7099` → IC=-0.259 (n=1305)
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.194 (n=952)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3004)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=3617)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1778)

- **FILTRO** `ibs_7min` > `0.7979` → IC=-0.206 (n=1348)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7979
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4047)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=988)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3335)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.256 (n=1003)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3320)

- **FILTRO** `ibs_7min` < `0.7594` → IC=-0.189 (n=1080)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7594
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=3243)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.173 (n=1073)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3250)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.254 (n=1026)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3359)

- **FILTRO** `ibs_7min` > `0.2509` → IC=-0.166 (n=1096)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2509
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3289)

- **FILTRO** `ballena_activa_n` > `114.0` → IC=-0.164 (n=1482)

  - _Acción_: SKIP cuando `ballena_activa_n` > 114.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2903)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=898)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2813)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.321 (n=887)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2824)

- **FILTRO** `drift_7min_pct` |x|> `0.1817` → IC=-0.130 (n=1261)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1817
  - _Potencial_: sin este filtro IC_bueno=-0.108 (n=2450)

- **FILTRO** `ibs_7min` < `0.2031` → IC=-0.274 (n=927)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2031
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2784)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.219 (n=894)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2817)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.234 (n=1329)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=4334)

- **FILTRO** `ibs_7min` > `0.264` → IC=-0.157 (n=1924)

  - _Acción_: SKIP cuando `ibs_7min` > 0.264
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=3739)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1277)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2782)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=980)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3079)

- **FILTRO** `ibs_7min` < `0.7455` → IC=-0.193 (n=1014)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7455
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3045)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.183 (n=1014)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3045)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1018)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3152)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.174 (n=1042)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3128)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.179 (n=1037)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3133)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.243 (n=1113)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3371)

- **FILTRO** `ibs_7min` < `0.7234` → IC=-0.214 (n=1120)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7234
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3364)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.176 (n=1410)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=4449)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.124 (n=1246)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2933)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.280 (n=1006)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3173)

- **FILTRO** `ibs_7min` < `0.7313` → IC=-0.231 (n=1044)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7313
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3135)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.206 (n=1033)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3146)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.206 (n=1309)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=4202)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=950)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=921)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2307)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.186 (n=352)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0039 (IC base=+0.171)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.194 (n=479)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0072 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0548` → IC=+0.175 (n=352)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3415` → IC=+0.209 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3415 (IC base=+0.171)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.177 (n=753)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 11.0 (IC base=+0.171)
...
- **PATRÓN** `dist_vwap_pct` < `0.1095` → IC=+0.171 (n=704)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1095 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.889` → IC=+0.242 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.889 (IC base=+0.171)
...
- **PATRÓN** `sigma_h` > `0.0146` → IC=+0.249 (n=201)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0146 (IC base=+0.178)

- **PATRÓN** `drift_60min` |x|≤ `0.0851` → IC=+0.204 (n=133)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0851 (IC base=+0.178)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0668` → IC=+0.191 (n=270)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.0668 (IC base=+0.178)
...
- **PATRÓN** `ibs_15` > `0.5385` → IC=+0.273 (n=302)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5385 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` > `0.173` → IC=+0.199 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.173 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` < `0.3078` → IC=+0.178 (n=287)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3078 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.55` → IC=+0.229 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.55 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.409` → IC=+0.179 (n=269)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` < 7.409 (IC base=+0.178)

- **PATRÓN** `libro_liquidez` > `2716.8736` → IC=+0.234 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2716.8736 (IC base=+0.178)
...
- **FILTRO** `sigma_h` > `0.0125` → IC=-0.202 (n=528)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1585)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.207 (n=247)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1866)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1411` → IC=+0.236 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1411 (IC base=-0.057)

- **PATRÓN** `ibs_15` > `0.6053` → IC=+0.252 (n=530)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6053 (IC base=-0.057)

- **PATRÓN** `dist_vwap_pct` < `0.1129` → IC=+0.177 (n=326)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1129 (IC base=-0.057)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1198` → IC=+0.240 (n=734)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1198 (IC base=-0.046)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1818` → IC=+0.237 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1818 (IC base=-0.046)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.279 (n=1102)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3557 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` > `0.6604` → IC=+0.265 (n=168)
...
- **FILTRO** `sigma_h` > `0.007` → IC=-0.200 (n=315)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.198 (n=946)

- **FILTRO** `sigma_h` < `0.0032` → IC=-0.232 (n=315)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=946)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.212 (n=807)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.895` → IC=-0.247 (n=227)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1034)

- **PATRÓN** `sigma_h` < `0.003` → IC=+0.151 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.003 (IC base=+0.073)
...
- **PATRÓN** `ibs_15` > `0.8109` → IC=+0.340 (n=104)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8109 (IC base=+0.073)
...
- **PATRÓN** `dist_vwap_pct` < `0.3672` → IC=+0.267 (n=118)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3672 (IC base=+0.073)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.248 (n=463)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.225)

- **PATRÓN** `drift_60min` |x|≤ `0.3595` → IC=+0.231 (n=407)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3595 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7675` → IC=+0.229 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7675 (IC base=+0.225)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2071` → IC=+0.259 (n=210)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2071 (IC base=+0.225)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.252 (n=155)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` < `0.3657` → IC=+0.272 (n=463)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3657 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.381` → IC=+0.245 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.381 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.223` → IC=+0.237 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.223 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.182` → IC=+0.227 (n=492)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5385 sube el IC de +0.178 a +0.273 en UPDOWN_GBM#XRP#15min (n=302). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6053 sube el IC de -0.057 a +0.252 en UPDOWN_GBM_15M_TARDIO (n=530). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0.046 a +0.279 en UPDOWN_GBM_15M_TARDIO (n=1102). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8109 sube el IC de +0.073 a +0.340 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=104). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3657 sube el IC de +0.225 a +0.272 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=463). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1152 | +0.083 | +136.71€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1152 | +0.083 | +136.71€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 833 | +0.089 | +111.68€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 833 | +0.089 | +111.68€ | 3 | 9 |
...
| ✅ BALLENAS_TARDIAS | 20303 | -0.104 | -2891.65€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1230 | -0.044 | -185.11€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19073 | -0.108 | -2706.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3140 | -0.122 | -556.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3140 | -0.122 | -556.81€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1230 | -0.044 | -185.11€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1230 | -0.044 | -185.11€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 5861 | -0.051 | -584.43€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5861 | -0.051 | -584.43€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5380 | -0.115 | -433.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5380 | -0.115 | -433.06€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4318 | -0.163 | -971.20€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4318 | -0.163 | -971.20€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 11941 | -0.043 | +4252.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3214 | -0.008 | +1847.24€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 8727 | -0.056 | +2405.30€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 11941 | -0.043 | +4252.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3214 | -0.008 | +1847.24€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 8727 | -0.056 | +2405.30€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO |