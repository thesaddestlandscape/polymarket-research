# Hipótesis automáticas — 2026-07-12 13:43 UTC
_Generado por shadow_postmortem.py sobre 10972 resoluciones (PNL=+1968.50€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.223 (n=298)
...
- **PATRÓN** `py_entrada` > `0.585` → IC=+0.253 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.585 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `2363.0481` → IC=+0.233 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2363.0481 (IC base=+0.220)
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.216 (n=167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 9.0 (IC base=+0.146)

- **PATRÓN** `py_entrada` < `0.275` → IC=+0.302 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=399)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `5910.4373` → IC=+0.165 (n=159)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 5910.4373 (IC base=+0.146)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.210 (n=67)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.605` → IC=+0.237 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.605 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.231 (n=65)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.235` → IC=+0.333 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.235 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `9436.7928` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9436.7928 (IC base=+0.214)

### FAVORITO_CONFIRMADO#ETH#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.297 (n=72)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.260)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.263 (n=74)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.260)

- **PATRÓN** `py_entrada` < `0.635` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.635 (IC base=+0.260)

- **PATRÓN** `py_entrada` > `0.765` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.765 (IC base=+0.260)

- **PATRÓN** `libro_liquidez` > `3061.4104` → IC=+0.294 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3061.4104 (IC base=+0.260)
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.158 (n=36)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 9.0 (IC base=+0.160)

- **PATRÓN** `py_entrada` < `0.245` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `3498.8855` → IC=+0.162 (n=66)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3498.8855 (IC base=+0.160)
...
- **PATRÓN** `py_entrada` > `0.705` → IC=+0.386 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.705 (IC base=+0.222)

- **PATRÓN** `libro_liquidez` > `1873.3412` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1873.3412 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=25)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.190)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.243 (n=33)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.190)

- **PATRÓN** `py_entrada` < `0.245` → IC=+0.286 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.190)

- **PATRÓN** `libro_liquidez` > `1648.9469` → IC=+0.221 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1648.9469 (IC base=+0.190)

### GBM_LATE_15M
- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.140 (n=439)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0151 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=1338)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.122 (n=1334)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 17.0 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.4454` → IC=+0.141 (n=37)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.4454 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.1403` → IC=+0.204 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1403 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.267` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.267 (IC base=+0.117)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.149 (n=919)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0092 (IC base=+0.110)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.140 (n=938)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.505` → IC=+0.169 (n=125)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.505 (IC base=+0.110)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.086)

### GBM_LATE_15M#ETH#15min
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.164 (n=111)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0045 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.4125` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.4125 (IC base=+0.092)

### GBM_LATE_15M#SOL#15min
- **PATRÓN** `sigma_h` < `0.0162` → IC=+0.140 (n=359)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0162 (IC base=+0.123)
...
- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.123)

- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.167 (n=115)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0094 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.184 (n=115)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0149 (IC base=+0.153)
...
- **PATRÓN** `dist_vwap_pct` < `0.1589` → IC=+0.250 (n=22)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1589 (IC base=+0.153)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` < `0.0319` → IC=+0.183 (n=304)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0319 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0141` → IC=+0.179 (n=272)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0141 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.169 (n=309)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1365` → IC=+0.289 (n=17)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1365 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0173` → IC=+0.188 (n=229)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0173 (IC base=+0.180)

- **PATRÓN** `sigma_h` > `0.0116` → IC=+0.190 (n=343)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0116 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.258 (n=130)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.088` → IC=+0.241 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.088 (IC base=+0.180)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.191 (n=318)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0049 (IC base=+0.170)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.207 (n=162)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` > `0.4503` → IC=+0.197 (n=31)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.4503 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` < `0.1221` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.1221 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.442` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.442 (IC base=+0.170)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.173 (n=359)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0045 (IC base=+0.150)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.184 (n=169)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 7.0 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.2052` → IC=+0.255 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2052 (IC base=+0.150)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` > `0.0024` → IC=+0.196 (n=100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0024 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.180 (n=95)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 7.0 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.164 (n=102)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.0796` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.0796 (IC base=+0.159)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.167 (n=88)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0055 (IC base=+0.164)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.241 (n=79)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.182 (n=61)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 11.0 (IC base=+0.164)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.149 (n=35)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0034 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.181 (n=70)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0049 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.167 (n=73)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 12.0 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.164 (n=105)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 17.0 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.4153` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4153 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.139 (n=59)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0049 (IC base=+0.088)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.176 (n=35)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 6.0 (IC base=+0.088)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.200 (n=58)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.167 (n=76)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 15.0 (IC base=+0.133)

- **PATRÓN** `sigma_h` < `0.008` → IC=+0.250 (n=38)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.008 (IC base=+0.101)

- **PATRÓN** `sigma_h` > `0.0116` → IC=+0.125 (n=38)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0116 (IC base=+0.101)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=41)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` < `0.121` → IC=+0.274 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.121 (IC base=+0.101)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.0187` → IC=+0.324 (n=66)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0187 (IC base=+0.264)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.290 (n=60)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.264)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.315 (n=63)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0088 (IC base=+0.279)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.281 (n=71)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M_TARDIO
- **FILTRO** `sigma_ewma_delta_pct` < `5.79` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` < 5.79
  - _Potencial_: sin este filtro IC_bueno=+0.292 (n=22)

- **PATRÓN** `sigma_h` > `0.0135` → IC=+0.125 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0135 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` < `0.1111` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1111 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.79` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.79 (IC base=+0.078)

- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.150 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0127 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` < `0.2033` → IC=+0.153 (n=93)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.2033 (IC base=+0.081)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.072)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.128 (n=49)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0039 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.4123` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.4123 (IC base=+0.020)
...
- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.184 (n=36)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0083 (IC base=+0.035)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.122 (n=72)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 11.0 (IC base=+0.035)

- **PATRÓN** `dist_vwap_pct` < `0.1605` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1605 (IC base=+0.035)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.033` → IC=+0.204 (n=106)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.033 (IC base=+0.185)

- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.194 (n=106)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0113 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.250 (n=74)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.1277` → IC=+0.200 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1277 (IC base=+0.185)

- **PATRÓN** `sigma_h` > `0.0316` → IC=+0.244 (n=37)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0316 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.225 (n=38)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1752` → IC=+0.241 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1752 (IC base=+0.213)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.123 (n=51)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0055 (IC base=-0.006)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.156 (n=30)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0053 (IC base=+0.057)
...
- **FILTRO** `sigma_h` > `0.0026` → IC=-0.381 (n=65)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0026
  - _Potencial_: sin este filtro IC_bueno=+0.292 (n=22)

- **FILTRO** `T_h` < `144.7669` → IC=-0.454 (n=41)

  - _Acción_: SKIP cuando `T_h` < 144.7669
  - _Potencial_: sin este filtro IC_bueno=-0.278 (n=16)

- **FILTRO** `pct_vs_K` |x|> `2.975` → IC=-0.477 (n=42)

  - _Acción_: SKIP cuando `pct_vs_K` |x|> 2.975
  - _Potencial_: sin este filtro IC_bueno=-0.206 (n=15)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.292 (n=22)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=-0.208)

### PRICE_TARGET_GBM#ETH#atexpiry
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.420 (n=23)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0069
  - _Potencial_: sin este filtro IC_bueno=+0.300 (n=8)

- **FILTRO** `T_h` > `87.9936` → IC=-0.441 (n=15)
...
### STREAK_FADE_15M
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.250 (n=38)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.128)

- **PATRÓN** `py_entrada` < `0.505` → IC=+0.210 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.505 (IC base=+0.128)

- **PATRÓN** `streak_len` < `4.0` → IC=+0.188 (n=46)

  - _Acción_: Kelly boost +0.94€ cuando `streak_len` < 4.0 (IC base=+0.128)

- **PATRÓN** `volumen_racha` < `29764.512` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_racha` < 29764.512 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `2513.3765` → IC=+0.227 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2513.3765 (IC base=+0.128)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.125 (n=22)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.075)

- **PATRÓN** `py_entrada` < `0.505` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` < 0.505 (IC base=+0.075)

- **PATRÓN** `streak_len` < `4.0` → IC=+0.125 (n=22)

  - _Acción_: Kelly boost +0.62€ cuando `streak_len` < 4.0 (IC base=+0.075)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.122 (n=236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 13.0 (IC base=+0.018)

- **PATRÓN** `ibs_15` > `0.717` → IC=+0.156 (n=216)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.78€ cuando `ibs_15` > 0.717 (IC base=+0.018)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.199 (n=71)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.018)

- **PATRÓN** `dist_vwap_pct` < `0.3809` → IC=+0.183 (n=102)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.3809 (IC base=+0.018)

- **PATRÓN** `ibs_15` < `0.0334` → IC=+0.144 (n=99)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` < 0.0334 (IC base=+0.028)
...
- **PATRÓN** `drift_60min` |x|≤ `0.237` → IC=+0.125 (n=134)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.237 (IC base=+0.060)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.172 (n=126)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 11.0 (IC base=+0.060)

- **PATRÓN** `ibs_15` < `0.9183` → IC=+0.155 (n=114)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.78€ cuando `ibs_15` < 0.9183 (IC base=+0.060)

- **PATRÓN** `ibs_15` > `0.6428` → IC=+0.172 (n=114)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.86€ cuando `ibs_15` > 0.6428 (IC base=+0.060)

- **PATRÓN** `dist_vwap_pct` > `0.2086` → IC=+0.340 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2086 (IC base=+0.060)
...
- **PATRÓN** `ibs_15` > `0.7617` → IC=+0.201 (n=85)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7617 (IC base=+0.029)

- **PATRÓN** `dist_vwap_pct` < `0.5087` → IC=+0.162 (n=63)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.5087 (IC base=+0.029)
...
### WEEKLY_PRICE
- **FILTRO** `T_h` > `81.6124` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `T_h` > 81.6124
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=11)

- **FILTRO** `T_h` < `144.8515` → IC=-0.283 (n=21)

  - _Acción_: SKIP cuando `T_h` < 144.8515
  - _Potencial_: sin este filtro IC_bueno=-0.115 (n=11)

- **PATRÓN** `T_h` > `145.7215` → IC=+0.284 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `T_h` > 145.7215 (IC base=+0.245)

### WEEKLY_PRICE#SOL
- **PATRÓN** `T_h` > `111.9959` → IC=+0.300 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `T_h` > 111.9959 (IC base=+0.260)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.717 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.156 n=216). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS < 0.9183 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.155 n=114). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6428 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.172 n=114). Confirma señal de reversión media → alinear con BUY_NO.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS > 0.7617 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.201 n=85). Confirma señal de reversión media → alinear con BUY_NO.
...
- **LIVE-CANDIDATA**: `STREAK_FADE_15M#ETH#15min` — IC=+0.139 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `STREAK_FADE_15M#ETH` — IC=+0.139 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 904 | +0.182 | +7.24€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 580 | +0.210 | +7.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 37 | +0.064 | +1.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 137 | +0.083 | -14.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 150 | +0.191 | +13.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 265 | +0.189 | -0.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 193 | +0.208 | -6.27€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 12 | +0.086 | +1.65€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 50 | +0.211 | +7.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 320 | +0.171 | +5.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 192 | +0.211 | +6.85€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.043 | -1.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 66 | +0.088 | -7.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 50 | +0.173 | +6.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 317 | +0.186 | +2.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 193 | +0.208 | +6.39€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 13 | +0.065 | +0.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 61 | +0.135 | -3.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 50 | +0.173 | -1.14€ | 0 | 0 |
| ✅ GBM_LATE_15M | 3591 | +0.113 | +1178.37€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 3591 | +0.113 | +1178.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 884 | +0.069 | +112.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 884 | +0.069 | +112.87€ | 0 | 1 |
| ✅ GBM_LATE_15M#ETH | 910 | +0.072 | +143.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 910 | +0.072 | +143.73€ | 0 | 2 |
| ✅ GBM_LATE_15M#SOL | 935 | +0.138 | +458.92€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 935 | +0.138 | +458.92€ | 0 | 8 |
| ✅ GBM_LATE_15M#XRP | 862 | +0.174 | +462.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 862 | +0.174 | +462.85€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 952 | +0.160 | +503.62€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 952 | +0.160 | +503.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 250 | +0.163 | +158.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 250 | +0.163 | +158.23€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 256 | +0.120 | +85.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 256 | +0.120 | +85.51€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 266 | +0.116 | +80.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 266 | +0.116 | +80.43€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 180 | +0.275 | +179.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 180 | +0.275 | +179.46€ | 0 | 5 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1118 | +0.080 | +265.03€ | 1 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1118 | +0.080 | +265.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 260 | +0.072 | +32.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 260 | +0.072 | +32.05€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 278 | +0.004 | +4.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 278 | +0.004 | +4.78€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 291 | +0.036 | +34.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 291 | +0.036 | +34.79€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 289 | +0.201 | +193.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 289 | +0.201 | +193.41€ | 0 | 8 |
| ✅ GBM_LATE_60M | 310 | -0.115 | +4.97€ | 2 | 1 |
| ✅ GBM_LATE_60M#60min | 310 | -0.115 | +4.97€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 105 | -0.033 | +3.93€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 105 | -0.033 | +3.93€ | 3 | 1 |
...
| ✅ LEADLAG_BTC_XRP_15M | 66 | +0.118 | +18.50€ | 0 | 3 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 66 | +0.118 | +18.50€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 66 | +0.118 | +18.50€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 66 | +0.118 | +18.50€ | 0 | 3 |
...
| ✅ PRICE_TARGET_GBM | 136 | -0.152 | -0.14€ | 4 | 1 |
...
| ✅ PRICE_TARGET_GBM#ETH#atexpiry | 45 | -0.160 | +0.04€ | 4 | 0 |
...
| ✅ STREAK_FADE_15M | 151 | +0.114 | +18.94€ | 0 | 7 |
| ✅ STREAK_FADE_15M#15min | 151 | +0.114 | +18.94€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH | 34 | +0.139 | +5.63€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH#15min | 34 | +0.139 | +5.63€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL | 54 | +0.143 | +11.31€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL#15min | 54 | +0.143 | +11.31€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP | 63 | +0.069 | +2.00€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP#15min | 63 | +0.069 | +2.00€ | 0 | 3 |
| ✅ STREAK_FADE_5M | 159 | -0.047 | -11.64€ | 4 | 0 |
| ✅ STREAK_FADE_5M#5min | 159 | -0.047 | -11.64€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 56 | +0.017 | -0.74€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 56 | +0.017 | -0.74€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1322 | -0.007 | +26.62€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1066 | +0.022 | +64.09€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#BTC | 355 | +0.013 | +10.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 276 | +0.054 | +23.95€ | 1 | 8 |
...
| ✅ UPDOWN_GBM#ETH | 653 | +0.013 | +34.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 560 | +0.032 | +45.53€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.123) — sin ventaja clara. oversold(IBS<0.3): IC=-0.023 n=342 | neutral: IC=-0.048 n=259 | overbought(IBS>0.7): IC=+0.075 n=290
  - _Datos_: n=932 IC=+0.007 PNL=+51.86€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.156 n=30 PNL=-6.41€ → FILTRAR | H=07h: IC=+0.110 n=39 PNL=+13.58€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.105 n=36 PNL=+9.04€ → BOOST | H=17h: IC=+0.130 n=44 PNL=+14.88€ → BOOST | H=22h: IC=+0.108 n=49 PNL=+7.56€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6192 | tras_1loss IC=+0.044 n=4643 | tras_2loss IC=+0.011 n=2082/40 | gap=+0.080 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.122 n=72/60 | contraria IC=+0.065 n=21 | gap=+0.056 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar

**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  - _Umbral_: n_overlaps≥20 y IC_overlap > IC_base + 0.05
  - _Acción_: Cambiar _aplicar_kelly_compuesto: match por activo, no market_id
  - _Estado_: n_overlaps=31, boost estimado=-0.025. Necesita 0 más y boost>0.05
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.081 n=485/40 PNL=+110.14€ | H=15h UTC: IC=+0.087 n=444/40 PNL=+95.17€ | H=17h UTC: IC=+0.122 n=382/40 PNL=+123.97€ | H=19h UTC: IC=+0.063 n=385/40 PNL=+49.78€
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.004 n=121 | contrario_BTC IC=-0.059 n=57/40 | gap=-0.055 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1195 IC=-0.000 PNL=+40.62€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1195 IC=-0.000 PNL=+40.62€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=606 IC=+0.018 PNL=+29.04€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=606 IC=+0.018 PNL=+29.04€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=276 IC=+0.054 PNL=+23.95€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=276 IC=+0.054 PNL=+23.95€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=549 IC=+0.052 PNL=+46.93€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=549 IC=+0.052 PNL=+46.93€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=430 IC=+0.012 PNL=+15.73€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=430 IC=+0.012 PNL=+15.73€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.242 > 0.08 con n=60 PNL=+15.28€
  - _Datos_: n=60 IC=+0.242 PNL=+15.28€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=51 IC=+0.066 PNL=+33.49€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=51 IC=+0.066 PNL=+33.49€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8514 IC=+0.096 PNL=+2044.39€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8514 IC=+0.096 PNL=+2044.39€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=119 IC=+0.004 PNL=+0.54€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=119 IC=+0.004 PNL=+0.54€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=753 IC=-0.015 PNL=-1.43€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=753 IC=-0.015 PNL=-1.43€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.174 > 0.1 con n=268 PNL=+102.24€
  - _Datos_: n=268 IC=+0.174 PNL=+102.24€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=368 IC=-0.062 PNL=+68.91€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=368 IC=-0.062 PNL=+68.91€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=454 IC=+0.053 PNL=+34.55€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=454 IC=+0.053 PNL=+34.55€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.176 > 0.08 con n=202 PNL=+75.29€
  - _Datos_: n=202 IC=+0.176 PNL=+75.29€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.244 n=84) pero sin cruzar ≥2 pares más — ETH: n=106 IC=+0.139 ✓; SOL: n=7 IC=-0.019; XRP: n=5 IC=+0.018
  - _Datos_: n=84 IC=+0.244 PNL=+40.32€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.156 < -0.1 con n=312 PNL=-34.61€
  - _Datos_: n=312 IC=-0.156 PNL=-34.61€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.301 > 0.2 con n=139 PNL=+93.27€
  - _Datos_: n=139 IC=+0.301 PNL=+93.27€
...
**⏳ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 10/40 ops en el filtro definido (IC actual=+0.083 PNL=+9.65€)
  - _Datos_: n=10 IC=+0.083 PNL=+9.65€

**⏳ H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: 40
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: 9/40 ops en el filtro definido (IC actual=+0.021 PNL=+6.80€)
  - _Datos_: n=9 IC=+0.021 PNL=+6.80€
...
**⏳ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: 14/40 ops en el filtro definido (IC actual=+0.131 PNL=+11.24€)
  - _Datos_: n=14 IC=+0.131 PNL=+11.24€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.150 > 0.08 con n=58 PNL=-4.40€
  - _Datos_: n=58 IC=+0.150 PNL=-4.40€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.324 > 0.08 con n=66 PNL=+8.52€
  - _Datos_: n=66 IC=+0.324 PNL=+8.52€
...
**⏳ H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: 34/40 ops en el filtro definido (IC actual=+0.194 PNL=+18.12€)
  - _Datos_: n=34 IC=+0.194 PNL=+18.12€
