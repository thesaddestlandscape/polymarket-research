# Hipótesis automáticas — 2026-07-03 15:02 UTC
_Generado por shadow_postmortem.py sobre 3099 resoluciones (PNL=-38.62€)_

## Patrones causales activos

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.207 (n=80)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0097 (IC base=+0.037)

- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.167 (n=58)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.0634 (IC base=+0.037)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 437 | +0.051 | +56.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 437 | +0.051 | +56.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 112 | +0.009 | +2.92€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 112 | +0.009 | +2.92€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 862 | -0.041 | -49.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 632 | -0.019 | -22.14€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 249 | -0.042 | -34.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 178 | -0.017 | -23.98€ | 3 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.063) — sin ventaja clara. oversold(IBS<0.3): IC=-0.006 n=164 | neutral: IC=-0.069 n=142 | overbought(IBS>0.7): IC=-0.046 n=150
  - _Datos_: n=472 IC=-0.040 PNL=-24.75€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.008 n=1487 | tras_1loss IC=-0.027 n=1520 | tras_2loss IC=-0.043 n=783/40 | gap=+0.051 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.052 n=132/40 PNL=-4.05€ | H=15h UTC: IC=+0.017 n=118/40 PNL=+5.44€ | H=17h UTC: IC=+0.200 n=58/40 PNL=+21.47€ | H=19h UTC: IC=-0.013 n=72/40 PNL=-9.58€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=739 IC=-0.036 PNL=-36.43€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=739 IC=-0.036 PNL=-36.43€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.017 < 0.02 con n=178 PNL=-23.98€
  - _Datos_: n=178 IC=-0.017 PNL=-23.98€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=271 IC=-0.017 PNL=-32.43€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=271 IC=-0.017 PNL=-32.43€

**⏳ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: 30
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: 17/30 ops en el filtro definido (IC actual=-0.112 PNL=-2.43€)
  - _Datos_: n=17 IC=-0.112 PNL=-2.43€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=222 IC=+0.013 PNL=+13.17€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=222 IC=+0.013 PNL=+13.17€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 5/40 ops en el filtro definido (IC actual=+0.018 PNL=+0.54€)
  - _Datos_: n=5 IC=+0.018 PNL=+0.54€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=673 IC=+0.033 PNL=+51.54€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=673 IC=+0.033 PNL=+51.54€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 70/120 ops en el filtro definido (IC actual=+0.125 PNL=+10.53€)
  - _Datos_: n=70 IC=+0.125 PNL=+10.53€
...
**⏳ H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: 22/40 ops en el filtro definido (IC actual=-0.125 PNL=-6.86€)
  - _Datos_: n=22 IC=-0.125 PNL=-6.86€
