# Hipótesis automáticas — 2026-07-21 09:43 UTC
_Generado por shadow_postmortem.py sobre 26461 resoluciones (PNL=+6269.60€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.207 (n=1462)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.209 (n=1685)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` > `0.695` → IC=+0.316 (n=766)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=1861)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=2000)
...
- **PATRÓN** `py_entrada` > `0.605` → IC=+0.269 (n=361)
...
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.122 (n=1631)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.295` → IC=+0.139 (n=117)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 4.295 (IC base=+0.064)
...
- **PATRÓN** `dist_vwap_pct` > `1.052` → IC=+0.156 (n=30)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 1.052 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.179` → IC=+0.177 (n=94)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 7.179 (IC base=+0.070)
...
- **PATRÓN** `dist_vwap_pct` < `0.4067` → IC=+0.161 (n=1132)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.4067 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.122` → IC=+0.176 (n=239)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 6.122 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.004` → IC=+0.150 (n=893)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 3.004 (IC base=+0.149)
...
- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.141 (n=151)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0051 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.157 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.444` → IC=+0.196 (n=54)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 12.444 (IC base=+0.110)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.149 (n=169)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 15.0 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.6179` → IC=+0.150 (n=78)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.6179 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.504` → IC=+0.185 (n=122)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 4.504 (IC base=+0.103)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.463` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 7.463 (IC base=+0.044)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 563 | +0.128 | +17.40€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 563 | +0.128 | +17.40€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 208 | +0.133 | +1.11€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 208 | +0.133 | +1.11€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 4571 | +0.186 | +74.93€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2974 | +0.217 | +101.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 196 | +0.071 | -4.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 615 | +0.108 | -78.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 786 | +0.160 | +55.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 1328 | +0.199 | +56.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 991 | +0.212 | +6.21€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1617 | +0.178 | +5.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 979 | +0.217 | +38.98€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 6459 | +0.101 | +2116.47€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 6459 | +0.101 | +2116.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1543 | +0.073 | +286.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1543 | +0.073 | +286.07€ | 0 | 5 |
| ✅ GBM_LATE_15M#ETH | 1465 | +0.073 | +260.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1465 | +0.073 | +260.85€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3655 | +0.139 | +2050.83€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3655 | +0.139 | +2050.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 931 | +0.102 | +406.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 931 | +0.102 | +406.94€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 954 | +0.097 | +385.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 954 | +0.097 | +385.78€ | 0 | 7 |
...
| ✅ GBM_LATE_15M_TARDIO | 3632 | +0.091 | +1216.17€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3632 | +0.091 | +1216.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 870 | +0.059 | +162.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 870 | +0.059 | +162.36€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 877 | +0.030 | +81.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 877 | +0.030 | +81.66€ | 0 | 3 |
...
| ✅ GBM_LATE_5M | 238 | +0.025 | +19.72€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 238 | +0.025 | +19.72€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 30 | +0.000 | -3.29€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 30 | +0.000 | -3.29€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH | 25 | -0.018 | +1.08€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 25 | -0.018 | +1.08€ | 0 | 0 |
...
| ✅ LATE_WINDOW_5MIN | 163 | +0.033 | +11.93€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 163 | +0.033 | +11.93€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 163 | +0.033 | +11.93€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 163 | +0.033 | +11.93€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=15893 | tras_1loss IC=+0.087 n=10364 | tras_2loss IC=+0.053 n=4246/40 | gap=+0.063 (umbral 0.05)
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=163 IC=+0.033 PNL=+11.93€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=163 IC=+0.033 PNL=+11.93€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=23997 IC=+0.116 PNL=+6344.44€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=23997 IC=+0.116 PNL=+6344.44€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=831 IC=+0.058 PNL=+113.24€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=831 IC=+0.058 PNL=+113.24€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.114 > 0.08 con n=358 PNL=+109.95€
  - _Datos_: n=358 IC=+0.114 PNL=+109.95€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.130 > 0.08 con n=374 PNL=+155.68€
  - _Datos_: n=374 IC=+0.130 PNL=+155.68€
