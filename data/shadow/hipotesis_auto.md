# Hipótesis automáticas — 2026-07-02 06:30 UTC
_Generado por shadow_postmortem.py sobre 2545 resoluciones (PNL=-84.23€)_
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.235 (n=66)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.065)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=34)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.065)

- **PATRÓN** `ibs_15` < `0.0769` → IC=+0.217 (n=44)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0769 (IC base=+0.065)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0769 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.217 n=44). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 786 | -0.034 | -35.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 563 | -0.010 | -9.45€ | 2 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Datos_: n=396 IC=-0.028 PNL=-10.62€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1202 | tras_1loss IC=-0.036 n=1260 | tras_2loss IC=-0.050 n=658/40 | gap=+0.052 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=663 IC=-0.028 PNL=-22.30€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=663 IC=-0.028 PNL=-22.30€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=180 IC=+0.038 PNL=+18.41€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=180 IC=+0.038 PNL=+18.41€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 128/200 ops en el filtro definido (IC actual=+0.046 PNL=+8.69€)
  - _Datos_: n=128 IC=+0.046 PNL=+8.69€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=128 IC=+0.046 PNL=+8.69€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=128 IC=+0.046 PNL=+8.69€
