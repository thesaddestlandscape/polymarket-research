# Hipótesis automáticas — 2026-07-02 01:15 UTC
_Generado por shadow_postmortem.py sobre 2506 resoluciones (PNL=-70.63€)_
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.280 (n=57)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.105)

- **PATRÓN** `drift_60min` |x|≤ `0.7563` → IC=+0.140 (n=98)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.7563 (IC base=+0.105)

- **PATRÓN** `drift_15min` |x|≤ `0.7516` → IC=+0.132 (n=74)

  - _Acción_: Kelly boost +0.66€ cuando `drift_15min` |x|≤ 0.7516 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.105)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.222 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0613 (IC base=+0.105)
...
| ✅ UPDOWN_GBM | 754 | -0.028 | -19.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 535 | -0.001 | +5.94€ | 1 | 5 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.071) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.041 n=109 | overbought(IBS>0.7): IC=-0.030 n=130
  - _Datos_: n=364 IC=-0.014 PNL=+5.77€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1187 | tras_1loss IC=-0.034 n=1237 | tras_2loss IC=-0.047 n=643/40 | gap=+0.050 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=22, boost estimado=+0.005. Necesita 0 más y boost>0.05
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=631 IC=-0.020 PNL=-5.92€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=631 IC=-0.020 PNL=-5.92€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=223 IC=+0.024 PNL=+0.01€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=223 IC=+0.024 PNL=+0.01€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=152 IC=+0.078 PNL=+33.80€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=152 IC=+0.078 PNL=+33.80€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 89/200 ops en el filtro definido (IC actual=+0.104 PNL=+22.29€)
  - _Datos_: n=89 IC=+0.104 PNL=+22.29€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 89/100 ops en el filtro definido (IC actual=+0.104 PNL=+22.29€)
  - _Datos_: n=89 IC=+0.104 PNL=+22.29€
