# Hipótesis automáticas — 2026-09-18 04:05 UTC
_Generado por shadow_postmortem.py sobre 491243 resoluciones (PNL=+53034.76€)_
...
- **FILTRO** `restante_s_al_confirmar` < `132.71` → IC=-0.295 (n=735)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=2208)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.92` → IC=-0.239 (n=1430)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.92
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4293)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `118.04` → IC=-0.366 (n=1172)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 118.04
  - _Potencial_: sin este filtro IC_bueno=-0.109 (n=3516)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.198 (n=12157)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3041)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `5349.0852` → IC=+0.173 (n=1938)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1424)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1789)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15379.9983` → IC=+0.233 (n=462)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.208 (n=1440)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.272 (n=1259)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1850)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `13461.0349` → IC=+0.219 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13461.0349 (IC base=+0.201)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.168 (n=302)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 7.0 (IC base=+0.126)

- **PATRÓN** `py_entrada` < `0.435` → IC=+0.153 (n=682)

  - _Acción_: Kelly boost +0.77€ cuando `py_entrada` < 0.435 (IC base=+0.126)
...
- **PATRÓN** `libro_liquidez` > `3855.8996` → IC=+0.149 (n=425)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3855.8996 (IC base=+0.126)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.139 (n=2074)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 15.0 (IC base=+0.138)

- **PATRÓN** `py_entrada` > `0.7` → IC=+0.329 (n=821)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.248 (n=1285)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.241)

- **PATRÓN** `libro_liquidez` > `3756.3222` → IC=+0.246 (n=546)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.148 (n=200)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 5.0 (IC base=+0.131)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.228 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=474)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.427 (n=533)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.199 (n=9207)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.223 (n=3368)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=2278)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.177 (n=2381)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.183 (n=2237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 17.0 (IC base=+0.180)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.187 (n=1992)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.71 (IC base=+0.180)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.237 (n=1779)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.237)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.324 (n=703)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.193 (n=1951)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.196 (n=1640)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.238 (n=10788)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.177 (n=4914)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 15.0 (IC base=+0.171)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5296)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.225 (n=5070)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.224)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.274 (n=1820)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.187 (n=5261)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.221 (n=1945)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.218)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.265 (n=1795)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.255 (n=2392)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3485` → IC=+0.120 (n=5770)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.3485 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.9773` → IC=+0.233 (n=2186)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9773 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` < `0.1435` → IC=+0.247 (n=1303)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1435 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.835` → IC=+0.170 (n=2540)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.835 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` < `1.2224` → IC=+0.244 (n=1685)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2224 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.243 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0678 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.209 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `1.9163` → IC=+0.201 (n=2906)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9163 (IC base=+0.098)

- **PATRÓN** `ibs_20min` < `0.5708` → IC=+0.132 (n=8001)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5708 (IC base=+0.060)

- **PATRÓN** `dist_vwap_pct` > `0.5507` → IC=+0.186 (n=485)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5507 (IC base=+0.060)

- **PATRÓN** `dist_vwap_pct` < `0.1358` → IC=+0.170 (n=2488)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1358 (IC base=+0.060)

- **PATRÓN** `volumen_regimen` < `0.7009` → IC=+0.173 (n=1167)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.7009 (IC base=+0.060)

- **PATRÓN** `volumen_regimen` > `0.8715` → IC=+0.176 (n=1768)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8715 (IC base=+0.060)

- **PATRÓN** `volumen_pendiente_norm` > `0.1671` → IC=+0.220 (n=1288)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1671 (IC base=+0.060)

- **PATRÓN** `volumen_spike_ratio` > `1.5867` → IC=+0.200 (n=3935)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5867 (IC base=+0.060)

- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.210 (n=4181)
...
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.175 (n=494)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.008 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3287` → IC=+0.164 (n=1482)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3287 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.166 (n=729)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.183 (n=560)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.966` → IC=+0.273 (n=649)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.353` → IC=+0.247 (n=1138)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.353 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.092` → IC=+0.232 (n=918)
...
- **PATRÓN** `ibs_20min` > `0.9153` → IC=+0.259 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9153 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` > `0.1843` → IC=+0.215 (n=571)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1843 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `0.1269` → IC=+0.215 (n=862)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1269 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.822` → IC=+0.234 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.822 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` < `1.2573` → IC=+0.224 (n=1120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2573 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` > `0.8755` → IC=+0.214 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8755 (IC base=+0.214)

- **PATRÓN** `volumen_pendiente_norm` > `0.0998` → IC=+0.214 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0998 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` < `1.4012` → IC=+0.225 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4012 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `2.3766` → IC=+0.224 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3766 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `11027.9657` → IC=+0.224 (n=1120)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11027.9657 (IC base=+0.214)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.153 (n=1054)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6762` → IC=+0.174 (n=1196)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6762 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1213` → IC=+0.150 (n=1094)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1213 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.446` → IC=+0.162 (n=202)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 11.446 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2134` → IC=+0.145 (n=1196)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2134 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `0.6181` → IC=+0.139 (n=1196)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6181 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4323` → IC=+0.150 (n=1087)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.4323 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.4262` → IC=+0.141 (n=1086)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.4262 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `13589.8332` → IC=+0.147 (n=797)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 13589.8332 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `241.0` → IC=+0.157 (n=441)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 241.0 (IC base=+0.137)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.193 (n=1449)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.185 (n=723)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 8.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.260 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.471` → IC=+0.233 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.471 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` < `0.1059` → IC=+0.186 (n=1232)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1059 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.3741` → IC=+0.186 (n=189)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.3741 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.987` → IC=+0.200 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.987 (IC base=+0.180)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.193 (n=1673)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.180)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.226 (n=1237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3824` → IC=+0.232 (n=1089)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3824 (IC base=+0.216)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.323` → IC=+0.217 (n=1357)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1833)

- **PATRÓN** `ibs_20min` > `0.9343` → IC=+0.179 (n=300)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.401` → IC=+0.135 (n=568)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.401 (IC base=+0.007)
...
- **PATRÓN** `dist_vwap_pct` > `0.279` → IC=+0.190 (n=169)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.279 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` < `0.695` → IC=+0.162 (n=273)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.695 (IC base=+0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.2681` → IC=+0.223 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2681 (IC base=+0.007)

- **PATRÓN** `volumen_spike_ratio` > `1.5036` → IC=+0.188 (n=508)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.5036 (IC base=+0.007)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.132 (n=1827)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.632` → IC=-0.210 (n=301)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2434)
...
- **FILTRO** `ibs_20min` < `0.6689` → IC=-0.160 (n=1212)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6689
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=625)
...
- **FILTRO** `ibs_20min` > `0.775` → IC=-0.200 (n=692)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=2078)
...
- **PATRÓN** `dist_vwap_pct` < `0.2575` → IC=+0.248 (n=598)
...
- **PATRÓN** `volumen_spike_ratio` < `2.224` → IC=+0.261 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.224 (IC base=-0.026)

- **PATRÓN** `volumen_spike_ratio` > `1.5907` → IC=+0.248 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5907 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.248 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.026)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.183 (n=2733)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0093 (IC base=+0.089)

- **PATRÓN** `ibs_20min` > `0.4595` → IC=+0.180 (n=7306)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.4595 (IC base=+0.089)

- **PATRÓN** `dist_vwap_pct` > `0.6935` → IC=+0.280 (n=758)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6935 (IC base=+0.089)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.503` → IC=+0.148 (n=3872)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 3.503 (IC base=+0.089)

- **PATRÓN** `volumen_regimen` > `0.6786` → IC=+0.241 (n=2496)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6786 (IC base=+0.089)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.262 (n=886)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.089)

- **PATRÓN** `volumen_spike_ratio` < `1.4778` → IC=+0.246 (n=1493)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4778 (IC base=+0.089)

- **PATRÓN** `volumen_spike_ratio` > `2.7523` → IC=+0.240 (n=1493)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7523 (IC base=+0.089)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.278 (n=3972)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.089)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.140 (n=2768)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0086 (IC base=+0.069)

- **PATRÓN** `ibs_20min` < `0.5543` → IC=+0.151 (n=7294)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5543 (IC base=+0.069)

- **PATRÓN** `dist_vwap_pct` > `0.6674` → IC=+0.243 (n=419)
...
- **PATRÓN** `volumen_regimen` < `0.7154` → IC=+0.236 (n=1016)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7154 (IC base=+0.069)

- **PATRÓN** `volumen_regimen` > `1.201` → IC=+0.251 (n=769)
...
- **PATRÓN** `dist_vwap_pct` > `0.1104` → IC=+0.142 (n=381)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.1104 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` < `0.1582` → IC=+0.138 (n=619)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1582 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` < `1.0507` → IC=+0.135 (n=636)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.0507 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` > `0.6591` → IC=+0.144 (n=644)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.186 (n=234)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.014)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.258 (n=493)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.241)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=674)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.11` → IC=+0.257 (n=1096)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.258 (n=1491)
...
- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.297 (n=1034)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `ibs_20min` > `0.7987` → IC=-0.183 (n=490)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7987
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1471)

- **PATRÓN** `ibs_20min` > `0.8055` → IC=+0.152 (n=518)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.8055 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` > `0.4367` → IC=+0.209 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4367 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` < `0.1805` → IC=+0.196 (n=284)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.1805 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` < `0.9565` → IC=+0.220 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9565 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` > `0.625` → IC=+0.200 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.625 (IC base=-0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.2647` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2647 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` < `2.0696` → IC=+0.243 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0696 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` > `1.3739` → IC=+0.221 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3739 (IC base=-0.007)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.251 (n=303)
...
- **FILTRO** `ibs_20min` < `0.68` → IC=-0.214 (n=880)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.264 (n=881)

- **FILTRO** `ibs_20min` > `0.7083` → IC=-0.232 (n=460)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7083
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1386)

- **FILTRO** `sigma_ewma_delta_pct` > `4.635` → IC=-0.174 (n=427)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.635
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=1419)

- **PATRÓN** `ibs_20min` > `0.68` → IC=+0.264 (n=881)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.68 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.185` → IC=+0.312 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.185 (IC base=+0.025)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.383` → IC=+0.149 (n=274)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 9.383 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` < `0.8648` → IC=+0.292 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8648 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.636` → IC=+0.280 (n=616)
...
- **PATRÓN** `dist_vwap_pct` > `0.5877` → IC=+0.181 (n=89)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5877 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` < `0.3961` → IC=+0.194 (n=407)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.3961 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `0.7154` → IC=+0.243 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7154 (IC base=+0.004)

- **PATRÓN** `volumen_pendiente_norm` < `0.1017` → IC=+0.186 (n=361)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1017 (IC base=+0.004)

- **PATRÓN** `volumen_pendiente_norm` > `0.2666` → IC=+0.202 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2666 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` < `2.5876` → IC=+0.203 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5876 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` > `1.4993` → IC=+0.182 (n=369)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4993 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.217 (n=373)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.280 (n=1139)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.273)

- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.347 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` > `0.2673` → IC=+0.319 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2673 (IC base=+0.273)
...
- **PATRÓN** `volumen_regimen` > `1.0341` → IC=+0.306 (n=493)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0341 (IC base=+0.273)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5484` → IC=+0.281 (n=450)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.277 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.273)

- **PATRÓN** `libro_liquidez` > `2433.8665` → IC=+0.283 (n=972)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2433.8665 (IC base=+0.273)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.264 (n=1038)
...
- **PATRÓN** `libro_liquidez` > `2357.2754` → IC=+0.276 (n=1074)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2357.2754 (IC base=+0.270)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.176 (n=2156)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.199 (n=2154)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0106 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3404` → IC=+0.174 (n=5683)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3404 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=6704)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5827` → IC=+0.215 (n=6458)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5827 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.161` → IC=+0.193 (n=2793)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.161 (IC base=+0.167)
...
- **PATRÓN** `volumen_regimen` < `1.2168` → IC=+0.162 (n=4282)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2168 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6243` → IC=+0.158 (n=4281)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6243 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2982` → IC=+0.192 (n=952)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2982 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5658` → IC=+0.174 (n=2706)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.5658 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6652` → IC=+0.171 (n=2049)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.6652 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3825.7125` → IC=+0.169 (n=2153)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3825.7125 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.181 (n=5380)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0791` → IC=+0.204 (n=2084)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4728` → IC=+0.229 (n=6241)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4728 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` < `0.2201` → IC=+0.161 (n=4644)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2201 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.162` → IC=+0.195 (n=1073)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.162 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `1.1842` → IC=+0.154 (n=4567)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1842 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.625` → IC=+0.148 (n=4567)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.625 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2918` → IC=+0.228 (n=897)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2918 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.5751` → IC=+0.170 (n=2456)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5751 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.6483` → IC=+0.175 (n=1861)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6483 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.172 (n=5201)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.195 (n=368)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0081 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.3275` → IC=+0.203 (n=1104)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3275 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.204 (n=545)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.249 (n=700)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1815` → IC=+0.288 (n=522)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.4284` → IC=+0.253 (n=237)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=819)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1750.54` → IC=+0.256 (n=522)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0757` → IC=+0.192 (n=316)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.0757 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=992)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.227 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.1948` → IC=+0.210 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1948 (IC base=+0.164)
...
- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.173 (n=947)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.2629 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` < `0.0783` → IC=+0.162 (n=787)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` < 0.0783 (IC base=+0.164)
...
- **PATRÓN** `libro_liquidez` > `10179.3316` → IC=+0.179 (n=947)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 10179.3316 (IC base=+0.164)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.211 (n=717)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0076 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.1996` → IC=+0.206 (n=717)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1996 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.230 (n=368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.291 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.625` → IC=+0.275 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.625 (IC base=+0.192)

- **PATRÓN** `volumen_pendiente_norm` < `0.2141` → IC=+0.189 (n=1034)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.2141 (IC base=+0.192)

- **PATRÓN** `volumen_pendiente_norm` > `0.1338` → IC=+0.189 (n=416)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1338 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` < `1.6638` → IC=+0.192 (n=336)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.6638 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `3.5942` → IC=+0.207 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5942 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.205 (n=1227)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.178 (n=897)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0066 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.4235` → IC=+0.163 (n=1020)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.4235 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1065)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3943` → IC=+0.202 (n=1020)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3943 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1355` → IC=+0.186 (n=670)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1355 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` < `1.0519` → IC=+0.155 (n=897)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.0519 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.1941` → IC=+0.164 (n=340)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.1941 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5341` → IC=+0.166 (n=438)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5341 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.5113` → IC=+0.174 (n=332)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.5113 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `7052.6142` → IC=+0.188 (n=680)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 7052.6142 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.158 (n=644)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 118.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.166 (n=1090)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0071 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.381` → IC=+0.146 (n=1090)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.381 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.190 (n=366)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 18.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.6052` → IC=+0.182 (n=1090)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6052 (IC base=+0.131)
...
- **PATRÓN** `volumen_regimen` < `0.8554` → IC=+0.145 (n=727)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7982` → IC=+0.134 (n=649)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.7982 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.4781` → IC=+0.148 (n=325)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.4781 (IC base=+0.131)
...
- **FILTRO** `ibs_20min` > `0.5652` → IC=-0.177 (n=401)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5652
  - _Potencial_: sin este filtro IC_bueno=+0.204 (n=1206)

- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.157 (n=540)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0099 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.129 (n=1221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.5111` → IC=+0.199 (n=1191)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5111 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.0188` → IC=+0.218 (n=257)
...
- **PATRÓN** `volumen_regimen` < `1.2249` → IC=+0.123 (n=1191)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2249 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.8166` → IC=+0.129 (n=763)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.8166 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1232)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2903.4322` → IC=+0.188 (n=540)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 2903.4322 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.131 (n=884)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 49.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.154 (n=403)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0053 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.169 (n=557)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.204 (n=1206)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.6927` → IC=+0.128 (n=229)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.6927 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` < `0.1866` → IC=+0.134 (n=1092)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1866 (IC base=+0.109)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4645` → IC=+0.135 (n=354)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.4645 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` > `2.1784` → IC=+0.123 (n=481)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.1784 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `3082.5359` → IC=+0.161 (n=402)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 3082.5359 (IC base=+0.109)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0183` → IC=+0.213 (n=750)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0183 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.1691` → IC=+0.213 (n=496)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.201 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.7277` → IC=+0.255 (n=1005)
...
- **PATRÓN** `volumen_regimen` < `1.2084` → IC=+0.207 (n=1126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2084 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6145` → IC=+0.209 (n=1126)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.158 (n=530)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0039 (IC base=+0.139)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.165 (n=526)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0089 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` > `0.3938` → IC=+0.170 (n=1578)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.3938 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.8094` → IC=+0.168 (n=224)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.8094 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.949` → IC=+0.171 (n=551)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.949 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8707` → IC=+0.155 (n=907)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8707 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.6945` → IC=+0.140 (n=1216)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6945 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1644` → IC=+0.170 (n=434)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1644 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `1.4352` → IC=+0.154 (n=504)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4352 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `2.5703` → IC=+0.172 (n=504)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5703 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.144 (n=1764)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `11933.0804` → IC=+0.155 (n=526)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 11933.0804 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.160 (n=1355)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 160.0 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.135 (n=1115)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0057 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.3392` → IC=+0.128 (n=1466)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4886` → IC=+0.155 (n=1466)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.4886 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.998` → IC=+0.129 (n=483)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 5.998 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.2216` → IC=+0.121 (n=1477)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.133 (n=1405)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3479` → IC=+0.126 (n=372)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3479 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.142 (n=342)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 9.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.2658` → IC=+0.136 (n=372)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` > 0.2658 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.2779` → IC=+0.131 (n=120)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.2779 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.328` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.328 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `0.9155` → IC=+0.132 (n=248)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.9155 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `10448.5867` → IC=+0.134 (n=372)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 10448.5867 (IC base=+0.106)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.158 (n=115)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 152.0 (IC base=+0.106)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.210 (n=174)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.336` → IC=+0.147 (n=520)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.336 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=467)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` < `0.3445` → IC=+0.202 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3445 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.437` → IC=+0.141 (n=207)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 4.437 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.093` → IC=+0.133 (n=590)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 9.093 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `1.208` → IC=+0.136 (n=520)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.208 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `1.0619` → IC=+0.168 (n=236)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0619 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.1583` → IC=+0.211 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1583 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `2.4413` → IC=+0.153 (n=511)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4413 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.4187` → IC=+0.141 (n=510)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.4187 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.169 (n=167)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 153.0 (IC base=+0.132)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.129 (n=324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 8.0 (IC base=+0.092)

- **PATRÓN** `ibs_20min` > `0.8889` → IC=+0.202 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8889 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.6084` → IC=+0.154 (n=76)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.6084 (IC base=+0.092)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.1` → IC=+0.171 (n=159)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.1 (IC base=+0.092)

- **PATRÓN** `volumen_pendiente_norm` > `0.2903` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2903 (IC base=+0.092)

- **PATRÓN** `volumen_spike_ratio` > `2.2136` → IC=+0.132 (n=150)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 2.2136 (IC base=+0.092)

- **PATRÓN** `libro_liquidez` > `3089.4567` → IC=+0.212 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3089.4567 (IC base=+0.092)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.155 (n=114)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 21.0 (IC base=+0.092)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.194 (n=3719)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.214 (n=8207)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.8828` → IC=+0.195 (n=1064)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.8828 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.737` → IC=+0.233 (n=3067)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.737 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8833` → IC=+0.165 (n=3667)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8833 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2393` → IC=+0.194 (n=1546)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2393 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6356` → IC=+0.184 (n=2607)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.6356 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3796.8122` → IC=+0.169 (n=2732)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3796.8122 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `92.0` → IC=+0.193 (n=6021)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 92.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.195 (n=5006)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0068 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.4812` → IC=+0.183 (n=7499)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4812 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2871)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5633` → IC=+0.239 (n=7500)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5633 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2302` → IC=+0.162 (n=4754)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.684` → IC=+0.182 (n=7255)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.684 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.705` → IC=+0.158 (n=2287)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.705 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2052` → IC=+0.156 (n=1732)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.2052 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2886` → IC=+0.245 (n=981)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2886 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.2951` → IC=+0.190 (n=3066)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2951 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.191 (n=2160)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.208 (n=930)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.3293` → IC=+0.190 (n=1388)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.201 (n=931)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.818` → IC=+0.314 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.818 (IC base=+0.190)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2431` → IC=+0.197 (n=589)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.2431 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.214 (n=1303)
...
- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.264 (n=1070)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0044 (IC base=+0.255)

- **PATRÓN** `drift_60min` |x|≤ `0.2039` → IC=+0.283 (n=712)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3505` → IC=+0.288 (n=940)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3505 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.416` → IC=+0.263 (n=1124)
...
- **PATRÓN** `volumen_spike_ratio` > `1.88` → IC=+0.278 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.88 (IC base=+0.255)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.255 (n=1118)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.255)

- **PATRÓN** `libro_liquidez` > `1749.389` → IC=+0.273 (n=712)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1749.389 (IC base=+0.255)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.203 (n=435)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3567` → IC=+0.154 (n=1304)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3567 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1353)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.3156` → IC=+0.201 (n=1304)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3156 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.3225` → IC=+0.196 (n=494)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.3225 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.805` → IC=+0.157 (n=304)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.805 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.298` → IC=+0.155 (n=1159)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.298 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.182 (n=574)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6973 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.2652` → IC=+0.182 (n=187)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.2652 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.1213` → IC=+0.159 (n=1100)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1213 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7596` → IC=+0.160 (n=833)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7596 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `10981.291` → IC=+0.168 (n=1165)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 10981.291 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `486.0` → IC=+0.163 (n=1181)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 486.0 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.168 (n=1160)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0057 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.2608` → IC=+0.167 (n=1020)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.2608 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.175 (n=527)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 16.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.6379` → IC=+0.203 (n=1159)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6379 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.6845` → IC=+0.167 (n=172)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6845 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1262` → IC=+0.163 (n=1073)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1262 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.162 (n=1159)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.204 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1506` → IC=+0.202 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1506 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.4156` → IC=+0.165 (n=1061)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4156 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.7547` → IC=+0.157 (n=707)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7547 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `12617.1565` → IC=+0.152 (n=772)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 12617.1565 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `366.0` → IC=+0.164 (n=644)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 366.0 (IC base=+0.152)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.230 (n=1311)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3642` → IC=+0.267 (n=1089)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.359` → IC=+0.295 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.359 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` < `1.7946` → IC=+0.226 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7946 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` > `2.2483` → IC=+0.232 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2483 (IC base=+0.233)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.244 (n=706)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4353` → IC=+0.137 (n=1393)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.6988` → IC=+0.230 (n=929)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6988 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.5533` → IC=+0.175 (n=373)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.5533 (IC base=+0.134)
...
- **PATRÓN** `volumen_regimen` < `0.8779` → IC=+0.156 (n=929)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8779 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2772` → IC=+0.230 (n=194)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4575` → IC=+0.155 (n=447)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.4575 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `8624.0494` → IC=+0.227 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8624.0494 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `85.0` → IC=+0.165 (n=425)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 85.0 (IC base=+0.134)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.162 (n=1128)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0075 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.4448` → IC=+0.160 (n=1128)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.4448 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.175 (n=429)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 17.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.150 (n=509)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 7.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.6874` → IC=+0.196 (n=1128)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.6874 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.2043` → IC=+0.145 (n=1048)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.2043 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.007` → IC=+0.190 (n=169)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 11.007 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.695` → IC=+0.149 (n=496)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.695 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.1774` → IC=+0.153 (n=376)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1774 (IC base=+0.141)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.158 (n=1058)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `11048.3545` → IC=+0.204 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11048.3545 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `189.0` → IC=+0.151 (n=1050)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.373` → IC=+0.225 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.373 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=964)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1278` → IC=+0.155 (n=453)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1278 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.148 (n=640)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.6458` → IC=+0.203 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6458 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.4698` → IC=+0.126 (n=1323)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.4698 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.451` → IC=+0.124 (n=1305)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.451 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.7205` → IC=+0.148 (n=597)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7205 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2238` → IC=+0.170 (n=210)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2238 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `1.4682` → IC=+0.147 (n=400)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.4682 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2886.578` → IC=+0.159 (n=453)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2886.578 (IC base=+0.110)
...
- **PATRÓN** `ibs_20min` > `0.5124` → IC=+0.246 (n=1406)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5124 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.1843` → IC=+0.232 (n=792)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1843 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.386` → IC=+0.249 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.386 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` < `1.2484` → IC=+0.209 (n=1406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2484 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.209 (n=1406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6307 (IC base=+0.206)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5687` → IC=+0.241 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5687 (IC base=+0.206)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1431)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `2587.3393` → IC=+0.209 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2587.3393 (IC base=+0.206)
...
- **PATRÓN** `volumen_regimen` > `1.232` → IC=+0.235 (n=518)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2259` → IC=+0.193 (n=1208)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2259 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4438` → IC=+0.198 (n=1372)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4438 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.207 (n=1011)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `2565.3121` → IC=+0.199 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2565.3121 (IC base=+0.199)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.135 (n=2607)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4871` → IC=+0.152 (n=1967)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.157 (n=666)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_regimen` < `1.1137` → IC=+0.142 (n=1644)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1137 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.148 (n=925)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `2.5724` → IC=+0.138 (n=1948)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.135 (n=2607)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `7633.9254` → IC=+0.149 (n=1757)
...
- **PATRÓN** `drift_60min` |x|≤ `0.511` → IC=+0.180 (n=624)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.156 (n=417)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 10.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.7429` → IC=+0.149 (n=624)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.7429 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.0998` → IC=+0.160 (n=624)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.0998 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.1528` → IC=+0.170 (n=283)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1528 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.3875` → IC=+0.148 (n=643)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.3875 (IC base=+0.148)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.261` → IC=+0.149 (n=565)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.261 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.647` → IC=+0.176 (n=208)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.647 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.7274` → IC=+0.155 (n=557)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7274 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.179 (n=266)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.1996` → IC=+0.167 (n=539)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.1996 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.4499` → IC=+0.161 (n=612)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4499 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `8082.96` → IC=+0.171 (n=624)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 8082.96 (IC base=+0.148)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.132 (n=517)

  - _Acción_: Kelly boost +0.66€ cuando `py_entrada` > 0.5 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2844.5756` → IC=+0.183 (n=178)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 2844.5756 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2324.7856` → IC=+0.122 (n=591)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=6773)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.180 (n=2814)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=8625)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.174 (n=2902)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=8983)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.215 (n=482)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1463)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.171 (n=493)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1626)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.120 (n=1159)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.205 (n=479)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.090 (n=1510)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.222 (n=495)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1605)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.170 (n=513)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1587)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.200 (n=464)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1456)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.193 (n=510)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1589)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=2480)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=2573)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2579)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=8194)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=18421)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.281 (n=6326)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=20289)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.242 (n=6612)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=20003)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.160 (n=9037)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=17578)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.230 (n=7855)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=25599)

- **FILTRO** `ibs_7min` > `0.2963` → IC=-0.177 (n=8350)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2963
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=25104)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=1024)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=3283)

- **FILTRO** `ibs_7min` < `0.708` → IC=-0.258 (n=1421)

  - _Acción_: SKIP cuando `ibs_7min` < 0.708
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2886)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.150 (n=3904)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=1907)

- **FILTRO** `drift_7min_pct` |x|> `0.1111` → IC=-0.124 (n=1972)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1111
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3839)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.205 (n=1451)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4360)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1083)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3560)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=1103)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3540)

- **FILTRO** `ibs_7min` < `0.7545` → IC=-0.187 (n=1159)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7545
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3484)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.178 (n=1154)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3489)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=1132)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3586)

- **FILTRO** `ibs_7min` > `0.2551` → IC=-0.171 (n=1179)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2551
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3539)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.184 (n=1174)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=3544)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.170 (n=1148)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=2880)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.314 (n=972)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3056)

- **FILTRO** `ibs_7min` < `0.2` → IC=-0.266 (n=1000)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=3028)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.220 (n=926)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3102)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.236 (n=1436)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4690)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.156 (n=2079)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=4047)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=1402)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=1081)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3311)

- **FILTRO** `ibs_7min` < `0.7425` → IC=-0.189 (n=1097)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7425
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3295)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.185 (n=1083)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=3309)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1112)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3381)

- **FILTRO** `ibs_7min` > `0.274` → IC=-0.175 (n=1123)

  - _Acción_: SKIP cuando `ibs_7min` > 0.274
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3370)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.181 (n=1097)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3396)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.259 (n=1159)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3594)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.232 (n=1171)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3582)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.172 (n=1555)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4781)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.278 (n=1116)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3376)

- **FILTRO** `ibs_7min` < `0.7196` → IC=-0.232 (n=1123)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7196
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3369)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.213 (n=1088)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3404)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.205 (n=1414)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=4556)
...
- **PATRÓN** `edge` > `0.1023` → IC=+0.443 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `edge` > 0.1023 (IC base=+0.400)

- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.437 (n=77)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0077 (IC base=+0.400)

- **PATRÓN** `T_h` > `1.1323` → IC=+0.415 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `T_h` > 1.1323 (IC base=+0.400)

- **PATRÓN** `dist_50` > `0.4084` → IC=+0.475 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_50` > 0.4084 (IC base=+0.400)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.427 (n=80)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.400)
...
- **PATRÓN** `edge` > `0.2335` → IC=+0.450 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `edge` > 0.2335 (IC base=+0.467)

- **PATRÓN** `sigma_h` < `0.0144` → IC=+0.466 (n=57)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0144 (IC base=+0.467)

- **PATRÓN** `T_h` > `0.958` → IC=+0.462 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `T_h` > 0.958 (IC base=+0.467)

- **PATRÓN** `dist_50` > `0.4658` → IC=+0.481 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `dist_50` > 0.4658 (IC base=+0.467)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.456 (n=43)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.467)

- **PATRÓN** `hora_utc` < `2.0` → IC=+0.452 (n=19)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 2.0 (IC base=+0.467)
...
- **PATRÓN** `streak_estiramiento` < `0.5606` → IC=+0.154 (n=102)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `streak_estiramiento` < 0.5606 (IC base=+0.030)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=2462)
...
- **PATRÓN** `ibs_15` < `0.1143` → IC=+0.166 (n=375)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.1143 (IC base=+0.043)
...
- **FILTRO** `libro_liquidez` < `3802.1817` → IC=-0.122 (n=1471)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.182` → IC=+0.239 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.182 (IC base=-0.043)

- **PATRÓN** `ibs_15` < `0.361` → IC=+0.280 (n=1255)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.007` → IC=-0.208 (n=337)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.193 (n=1012)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.229 (n=445)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.181 (n=904)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.205 (n=857)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.182 (n=492)

- **FILTRO** `sigma_ewma_delta_pct` > `19.975` → IC=-0.241 (n=241)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.975
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1108)
...
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.249 (n=524)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.229)

- **PATRÓN** `drift_60min` |x|≤ `0.3586` → IC=+0.232 (n=461)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3586 (IC base=+0.229)

- **PATRÓN** `drift_15min` |x|≤ `0.774` → IC=+0.239 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.774 (IC base=+0.229)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1994` → IC=+0.258 (n=238)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1994 (IC base=+0.229)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.241 (n=350)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.229)

- **PATRÓN** `ibs_15` < `0.2757` → IC=+0.288 (n=461)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2757 (IC base=+0.229)

- **PATRÓN** `dist_vwap_pct` > `0.3704` → IC=+0.258 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3704 (IC base=+0.229)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.155` → IC=-0.134 (n=277)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.155
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2224)
...
- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.310 (n=362)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1143 sube el IC de +0.043 a +0.166 en UPDOWN_GBM#XRP#15min (n=375). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.361 sube el IC de -0.043 a +0.280 en UPDOWN_GBM_15M_TARDIO (n=1255). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2757 sube el IC de +0.229 a +0.288 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=461). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.045 a +0.310 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=362). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 21582 | -0.096 | -3136.30€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1279 | -0.050 | -190.98€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 20303 | -0.099 | -2945.32€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3329 | -0.100 | -569.96€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3329 | -0.100 | -569.96€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1279 | -0.050 | -190.98€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1279 | -0.050 | -190.98€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6189 | -0.042 | -610.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6189 | -0.042 | -610.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5723 | -0.097 | -477.07€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5723 | -0.097 | -477.07€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4688 | -0.174 | -1126.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4688 | -0.174 | -1126.63€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 13559 | -0.038 | +4179.33€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3610 | -0.005 | +1833.80€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 9949 | -0.050 | +2345.53€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 13559 | -0.038 | +4179.33€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3610 | -0.005 | +1833.80€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 9949 | -0.050 | +2345.53€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1200 | -0.097 | -156.48€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 104 | -0.038 | -9.03€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1096 | -0.102 | -147.44€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 683 | -0.083 | -79.01€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 80 | -0.024 | -3.81€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 603 | -0.090 | -75.20€ | 2 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 78450 | +0.113 | -4000.71€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 12163 | +0.184 | -362.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 302 | -0.122 | -48.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 60648 | +0.100 | -3430.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5337 | +0.112 | -159.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 10102 | +0.097 | -922.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 41 | -0.151 | -1.09€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 10046 | +0.099 | -909.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 15868 | +0.132 | -308.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3754 | +0.203 | -111.49€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 10047 | +0.111 | -173.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2025 | +0.112 | -0.79€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 10140 | +0.088 | -986.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 47 | -0.051 | -1.60€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 10078 | +0.090 | -973.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 16779 | +0.124 | -309.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4699 | +0.173 | -68.91€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 10147 | +0.107 | -177.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1921 | +0.098 | -53.98€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 15443 | +0.115 | -894.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3581 | +0.186 | -189.58€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 205 | -0.085 | +5.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 10266 | +0.092 | -605.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1391 | +0.132 | -104.74€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 10118 | +0.103 | -580.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 41 | -0.012 | +10.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 10064 | +0.104 | -590.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 12399 | +0.190 | -839.16€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 12399 | +0.190 | -839.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 