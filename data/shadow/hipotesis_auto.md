# Hipótesis automáticas — 2026-07-28 13:30 UTC
_Generado por shadow_postmortem.py sobre 40144 resoluciones (PNL=+8266.66€)_
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.163 (n=1747)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2416.2073` → IC=+0.137 (n=1517)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2416.2073 (IC base=+0.143)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.157 (n=1435)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0067 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.134 (n=1461)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.3908` → IC=+0.129 (n=340)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.3908 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.137` → IC=+0.150 (n=318)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 8.137 (IC base=+0.121)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.43` → IC=+0.147 (n=199)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 4.43 (IC base=+0.093)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.142 (n=336)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 11.0 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` > `0.659` → IC=+0.171 (n=83)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.659 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.253` → IC=+0.188 (n=126)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 7.253 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `8292.9308` → IC=+0.130 (n=244)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 8292.9308 (IC base=+0.119)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.120 (n=1231)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.60€ cuando `sigma_h` > 0.0083 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.4541` → IC=+0.153 (n=335)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.4541 (IC base=+0.096)
...
- **PATRÓN** `libro_liquidez` > `10368.9672` → IC=+0.132 (n=112)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 10368.9672 (IC base=+0.055)
...
- **PATRÓN** `sigma_h` < `0.0191` → IC=+0.174 (n=480)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0191 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.169 (n=487)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.169 (n=490)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=412)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6069` → IC=+0.175 (n=645)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.225` → IC=+0.156 (n=213)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.225 (IC base=+0.055)

- **PATRÓN** `libro_liquidez` > `10166.4857` → IC=+0.141 (n=182)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.123 (n=157)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 12.0 (IC base=+0.075)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6069 sube el IC de +0.055 a +0.175 en UPDOWN_GBM#15min (n=645). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1421 | +0.097 | +29.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1421 | +0.097 | +29.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 566 | +0.091 | +0.32€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 566 | +0.091 | +0.32€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 6904 | +0.177 | -59.93€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4544 | +0.201 | -46.31€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 2043 | +0.182 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1518 | +0.197 | -51.73€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 8642 | +0.094 | +2575.71€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8642 | +0.094 | +2575.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 56 | +0.172 | +22.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 56 | +0.172 | +22.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2063 | +0.071 | +347.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2063 | +0.071 | +347.61€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 56 | +0.069 | +6.41€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 56 | +0.069 | +6.41€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1855 | +0.073 | +313.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1855 | +0.073 | +313.38€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2300 | +0.083 | +781.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2300 | +0.083 | +781.24€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2312 | +0.139 | +1104.22€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2312 | +0.139 | +1104.22€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5869 | +0.117 | +2749.42€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5869 | +0.117 | +2749.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 40 | +0.309 | +43.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 40 | +0.309 | +43.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1512 | +0.084 | +510.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1512 | +0.084 | +510.02€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 53 | +0.191 | +32.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 53 | +0.191 | +32.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1504 | +0.088 | +527.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1504 | +0.088 | +527.95€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1449 | +0.084 | +557.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1449 | +0.084 | +557.35€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_TARDIO | 5864 | +0.065 | +1521.04€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5864 | +0.065 | +1521.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 49 | +0.265 | +34.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 49 | +0.265 | +34.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1378 | +0.025 | +145.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1378 | +0.025 | +145.81€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 52 | +0.148 | +13.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 52 | +0.148 | +13.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1403 | +0.022 | +111.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1403 | +0.022 | +111.77€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1365 | +0.024 | +246.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1365 | +0.024 | +246.33€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1617 | +0.161 | +969.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1617 | +0.161 | +969.37€ | 0 | 13 |
...
| ✅ UPDOWN_GBM | 2975 | +0.035 | +265.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2711 | +0.051 | +304.42€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#SOL | 325 | -0.023 | +5.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 255 | +0.006 | +12.56€ | 4 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 23 | -0.060 | -3.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 33 | -0.100 | -1.97€ | 0 | 0 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 347 | +0.047 | +44.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 336 | +0.056 | +48.25€ | 4 | 1 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2259 | +0.149 | +979.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2259 | +0.149 | +979.27€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 532 | +0.086 | +131.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 532 | +0.086 | +131.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 637 | +0.168 | +374.15€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 637 | +0.168 | +374.15€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.166: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.070 n=1721 | neutral: IC=+0.022 n=1365 | overbought(IBS>0.7): IC=+0.187 n=1670
  - _Datos_: n=5069 IC=+0.102 PNL=+1311.37€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=255 IC=+0.006 PNL=+12.56€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.110 n=23834 | tras_1loss IC=+0.078 n=16070 | tras_2loss IC=+0.053 n=6749/40 | gap=+0.056 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2838 IC=+0.039 PNL=+279.19€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2838 IC=+0.039 PNL=+279.19€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1137 IC=+0.055 PNL=+154.33€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1137 IC=+0.055 PNL=+154.33€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.089 > 0.08 con n=1430 PNL=+241.14€
  - _Datos_: n=1430 IC=+0.089 PNL=+241.14€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1505 IC=+0.039 PNL=+114.86€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1505 IC=+0.039 PNL=+114.86€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3862 IC=+0.067 PNL=+611.23€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3862 IC=+0.067 PNL=+611.23€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=443 IC=+0.019 PNL=+14.29€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=443 IC=+0.019 PNL=+14.29€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1287 IC=+0.031 PNL=+123.78€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1287 IC=+0.031 PNL=+123.78€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.158 > 0.1 con n=1040 PNL=+345.97€
  - _Datos_: n=1040 IC=+0.158 PNL=+345.97€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=299 IC=+0.075 PNL=+51.57€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=299 IC=+0.075 PNL=+51.57€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1131 IC=+0.055 PNL=+121.50€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1131 IC=+0.055 PNL=+121.50€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.119 > 0.08 con n=733 PNL=+200.58€
  - _Datos_: n=733 IC=+0.119 PNL=+200.58€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.106 > 0.08 con n=617 PNL=+183.36€
  - _Datos_: n=617 IC=+0.106 PNL=+183.36€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.08 con n=769 PNL=+370.07€
  - _Datos_: n=769 IC=+0.125 PNL=+370.07€
