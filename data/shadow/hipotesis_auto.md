# Hipótesis automáticas — 2026-08-11 06:47 UTC
_Generado por shadow_postmortem.py sobre 109409 resoluciones (PNL=+15225.70€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.235 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.131)

- **PATRÓN** `restante_min` < `4.68` → IC=+0.142 (n=902)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` < 4.68 (IC base=+0.131)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.134 (n=465)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 4.91 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.149 (n=622)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 16.0 (IC base=+0.131)

- **PATRÓN** `lag_apertura_s` < `5.37` → IC=+0.141 (n=446)

  - _Acción_: Kelly boost +0.70€ cuando `lag_apertura_s` < 5.37 (IC base=+0.131)

- **PATRÓN** `profundidad_ratio_no` > `18.7` → IC=+0.163 (n=446)

  - _Acción_: Kelly boost +0.81€ cuando `profundidad_ratio_no` > 18.7 (IC base=+0.131)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.245 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.125)

- **PATRÓN** `restante_min` < `3.75` → IC=+0.159 (n=221)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.125 (n=457)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 12.0 (IC base=+0.125)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.219 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.137)

- **PATRÓN** `restante_min` < `4.32` → IC=+0.148 (n=299)

  - _Acción_: Kelly boost +0.74€ cuando `restante_min` < 4.32 (IC base=+0.137)

- **PATRÓN** `restante_min` > `3.9` → IC=+0.138 (n=680)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` > 3.9 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.144 (n=708)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.137 (n=711)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 18.0 (IC base=+0.137)

- **PATRÓN** `lag_apertura_s` < `16.08` → IC=+0.142 (n=451)

  - _Acción_: Kelly boost +0.71€ cuando `lag_apertura_s` < 16.08 (IC base=+0.137)

- **PATRÓN** `profundidad_ratio_no` > `24.9` → IC=+0.193 (n=226)

  - _Acción_: Kelly boost +0.96€ cuando `profundidad_ratio_no` > 24.9 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.157 (n=214)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0031 (IC base=+0.106)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.370 (n=75)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.351)
...
- **FILTRO** `hora_utc` > `6.0` → IC=-0.245 (n=222)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.203 (n=72)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.1689` → IC=+0.139 (n=70)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.1689 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.38` → IC=+0.121 (n=201)

  - _Acción_: Kelly boost +0.60€ cuando `sigma_ewma_delta_pct` < 7.38 (IC base=+0.103)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.139 (n=34)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 14.0 (IC base=+0.081)

- **PATRÓN** `libro_liquidez` > `5912.3955` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 5912.3955 (IC base=+0.081)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.565` → IC=+0.216 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.565 (IC base=+0.033)
...
### LIQUIDACIONES_15M
- **FILTRO** `py_entrada` < `0.505` → IC=-0.382 (n=15)
...
- **FILTRO** `libro_liquidez` < `2136.6655` → IC=-0.308 (n=24)

  - _Acción_: SKIP cuando `libro_liquidez` < 2136.6655
  - _Potencial_: sin este filtro IC_bueno=-0.108 (n=49)

- **FILTRO** `liq_usd_total` < `715.76` → IC=-0.184 (n=17)

  - _Acción_: SKIP cuando `liq_usd_total` < 715.76
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.151 (n=233)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0055 (IC base=+0.081)
...
- **PATRÓN** `sigma_h` < `0.0079` → IC=+0.153 (n=1060)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0079 (IC base=+0.147)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.155 (n=1072)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0054 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0663` → IC=+0.175 (n=340)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.0663 (IC base=+0.147)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1937` → IC=+0.138 (n=352)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.69€ cuando `delta_ratio_macro` |x|> 0.1937 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.138 (n=776)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.138 (n=525)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 12.0 (IC base=+0.147)

- **PATRÓN** `ibs_15` > `0.5385` → IC=+0.220 (n=772)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5385 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.2413` → IC=+0.139 (n=267)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.2413 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.258` → IC=+0.189 (n=448)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 5.258 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `2545.0995` → IC=+0.133 (n=772)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 2545.0995 (IC base=+0.147)

- **PATRÓN** `sigma_h` > `0.006` → IC=+0.176 (n=1504)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.006 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.2167` → IC=+0.169 (n=599)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.2167 (IC base=+0.168)

- **PATRÓN** `drift_15min` |x|≤ `0.4196` → IC=+0.198 (n=299)

  - _Acción_: Kelly boost +0.99€ cuando `drift_15min` |x|≤ 0.4196 (IC base=+0.168)
...
- **PATRÓN** `ibs_15` < `0.4444` → IC=+0.238 (n=906)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.4444 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.2003` → IC=+0.191 (n=208)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.2003 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.539` → IC=+0.194 (n=119)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 19.539 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.443` → IC=+0.188 (n=885)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 7.443 (IC base=+0.168)
...
- **PATRÓN** `libro_liquidez` > `3994.029` → IC=+0.174 (n=299)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3994.029 (IC base=+0.168)
...
- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.159 (n=174)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0029 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.1123` → IC=+0.152 (n=90)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1123 (IC base=+0.137)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0951` → IC=+0.180 (n=120)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.90€ cuando `delta_ratio_macro` |x|> 0.0951 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.208 (n=63)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.137)

- **PATRÓN** `ibs_15` > `0.7488` → IC=+0.271 (n=120)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7488 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.2256` → IC=+0.203 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2256 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.379` → IC=+0.182 (n=83)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 9.379 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `11198.676` → IC=+0.141 (n=90)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 11198.676 (IC base=+0.137)

- **PATRÓN** `drift_15min` |x|≤ `0.5515` → IC=+0.179 (n=26)

  - _Acción_: Kelly boost +0.89€ cuando `drift_15min` |x|≤ 0.5515 (IC base=-0.098)

- **PATRÓN** `ibs_15` < `0.5537` → IC=+0.139 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.5537 (IC base=-0.098)

- **PATRÓN** `libro_liquidez` > `9476.9221` → IC=+0.122 (n=35)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 9476.9221 (IC base=-0.098)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.313 (n=153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.277)

- **PATRÓN** `drift_60min` |x|≤ `0.1029` → IC=+0.370 (n=44)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1029 (IC base=+0.277)

- **PATRÓN** `drift_15min` |x|≤ `0.4473` → IC=+0.304 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4473 (IC base=+0.277)
...
- **PATRÓN** `ibs_15` < `0.0419` → IC=+0.413 (n=44)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0419 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.2534` → IC=+0.386 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2534 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.363` → IC=+0.292 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.363 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.671` → IC=+0.288 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.671 (IC base=+0.277)
...
- **PATRÓN** `ibs_15` < `0.4444` → IC=+0.257 (n=294)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.4444 (IC base=+0.211)
...
### UPDOWN_OU_5M
- **FILTRO** `pct_spot_vs_ref` |x|> `0.2466` → IC=-0.471 (n=33)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.2466
  - _Potencial_: sin este filtro IC_bueno=-0.206 (n=66)

- **FILTRO** `sigma_h` > `0.0063` → IC=-0.382 (n=66)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `delta_ratio_macro` |x|≤ `0.1986` → IC=-0.303 (n=64)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5385 sube el IC de +0.147 a +0.220 en UPDOWN_GBM_15M_TARDIO (n=772). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.4444 sube el IC de +0.168 a +0.238 en UPDOWN_GBM_15M_TARDIO (n=906). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7488 sube el IC de +0.137 a +0.271 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=120). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.0419 sube el IC de +0.277 a +0.413 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=44). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.4444 sube el IC de +0.211 a +0.257 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=294). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min` — IC=+0.447 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL` — IC=+0.447 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1907 | +0.051 | -1.27€ | 0 | 4 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1907 | +0.051 | -1.27€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 901 | +0.027 | -19.47€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 901 | +0.027 | -19.47€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 675 | +0.072 | -1.42€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 675 | +0.072 | -1.42€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 312 | +0.073 | +19.97€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 312 | +0.073 | +19.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS | 3407 | -0.047 | -648.62€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 499 | +0.221 | -44.88€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2908 | -0.093 | -603.74€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB | 405 | -0.264 | -112.48€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB#5min | 405 | -0.264 | -112.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 499 | +0.221 | -44.88€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 499 | +0.221 | -44.88€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#DOGE | 502 | -0.171 | -34.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 502 | -0.171 | -34.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 654 | +0.062 | -38.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 654 | +0.062 | -38.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 711 | -0.008 | -79.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 711 | -0.008 | -79.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 636 | -0.179 | -339.35€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 636 | -0.179 | -339.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30577 | +0.117 | -832.96€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6903 | +0.195 | -124.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 461 | +0.049 | -41.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21127 | +0.091 | -716.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2086 | +0.138 | +50.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3409 | +0.080 | -221.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 14 | -0.044 | -4.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3390 | +0.081 | -219.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6476 | +0.131 | -93.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2146 | +0.187 | -93.06€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 150 | +0.053 | -16.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3393 | +0.096 | -55.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 787 | +0.146 | +71.59€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3403 | +0.080 | -207.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 16 | +0.222 | +8.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3386 | +0.079 | -217.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6973 | +0.132 | -51.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2334 | +0.194 | +5.06€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 150 | -0.020 | -33.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3798 | +0.101 | -32.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 691 | +0.128 | +9.91€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6884 | +0.134 | -220.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2351 | +0.206 | -37.74€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 152 | +0.110 | +6.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3773 | +0.089 | -158.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 608 | +0.138 | -31.07€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3432 | +0.102 | -39.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 42 | +0.136 | -3.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3387 | +0.102 | -33.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 3057 | +0.200 | -194.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 3057 | +0.200 | -194.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 547 | +0.165 | -60.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 547 | +0.165 | -60.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 535 | +0.224 | -15.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 535 | +0.224 | -15.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 553 | +0.158 | -69.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 553 | +0.158 | -69.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 756 | +0.269 | -6.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 756 | +0.269 | -6.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 157 | +0.116 | +7.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 157 | +0.116 | +7.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 509 | +0.175 | -49.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 509 | +0.175 | -49.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 145 | +0.432 | -1.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 145 | +0.432 | -1.08€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 36 | +0.447 | +1.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 36 | +0.447 | +1.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 14136 | +0.199 | -1044.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 14136 | +0.199 | -1044.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2532 | +0.159 | -351.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2532 | +0.159 | -351.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2247 | +0.223 | -61.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2247 | +0.223 | -61.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2446 | +0.185 | -254.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2446 | +0.185 | -254.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2288 | +0.218 | -84.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2288 | +0.218 | -84.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2290 | +0.219 | -98.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2290 | +0.219 | -98.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2333 | +0.196 | -194.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2333 | +0.196 | -194.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 1778 | +0.131 | +29.53€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 1778 | +0.131 | +29.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 877 | +0.125 | +6.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 877 | +0.125 | +6.58€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 901 | +0.137 | +22.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 901 | +0.137 | +22.95€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 660 | +0.295 | -16.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 660 | +0.295 | -16.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 660 | +0.295 | -16.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 660 | +0.295 | -16.23€ | 0 | 0 |
| ✅ GBM_LATE_15M | 13603 | +0.103 | +4660.23€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 13603 | +0.103 | +4660.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 951 | +0.187 | +628.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 951 | +0.187 | +628.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2648 | +0.086 | +541.60€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2648 | +0.086 | +541.60€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 973 | +0.189 | +621.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 973 | +0.189 | +621.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 2486 | +0.059 | +340.54€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 2486 | +0.059 | +340.54€ | 0 | 5 |
| ✅ GBM_LATE_15M#SOL | 3073 | +0.068 | +863.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3073 | +0.068 | +863.03€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 3472 | +0.130 | +1664.49€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 3472 | +0.130 | +1664.49€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 11274 | +0.119 | +5578.26€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 11274 | +0.119 | +5578.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 994 | +0.147 | +743.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 994 | +0.147 | +743.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 2488 | +0.075 | +813.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 2488 | +0.075 | +813.80€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 842 | +0.228 | +722.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 842 | +0.228 | +722.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 2317 | +0.072 | +643.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 2317 | +0.072 | +643.15€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 2439 | +0.069 | +815.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 2439 | +0.069 | +815.38€ | 1 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 2194 | +0.220 | +1840.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 2194 | +0.220 | +1840.22€ | 0 | 12 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 1013 | +0.250 | +940.81€ | 0 | 12 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 1013 | +0.250 | +940.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 155 | +0.353 | +199.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 155 | +0.353 | +199.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 173 | +0.186 | +81.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 173 | +0.186 | +81.64€ | 0 | 6 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 153 | +0.326 | +179.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 153 | +0.326 | +179.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 139 | +0.209 | +114.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 139 | +0.209 | +114.37€ | 0 | 4 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 189 | +0.118 | +129.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 189 | +0.118 | +129.32€ | 0 | 2 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 204 | +0.306 | +236.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 204 | +0.306 | +236.14€ | 0 | 7 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 233 | -0.032 | -1.79€ | 3 | 9 |
...
| ✅ GBM_LATE_15M_TARDIO | 10391 | +0.095 | +3944.74€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 10391 | +0.095 | +3944.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 871 | +0.215 | +691.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 871 | +0.215 | +691.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1969 | +0.038 | +300.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1969 | +0.038 | +300.19€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 915 | +0.213 | +705.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 915 | +0.213 | +705.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1960 | +0.017 | +152.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1960 | +0.017 | +152.33€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 2130 | +0.022 | +425.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 2130 | +0.022 | +425.38€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 2546 | +0.174 | +1669.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 2546 | +0.174 | +1669.86€ | 0 | 10 |
| ✅ GBM_LATE_5M | 1644 | -0.007 | +46.17€ | 3 | 0 |
| ✅ GBM_LATE_5M#5min | 1644 | -0.007 | +46.17€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 353 | +0.021 | +23.63€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 353 | +0.021 | +23.63€ | 1 | 3 |
| ✅ GBM_LATE_5M#ETH | 123 | -0.124 | -17.29€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 123 | -0.124 | -17.29€ | 2 | 2 |
| ✅ GBM_LATE_5M#SOL | 679 | -0.020 | +31.54€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 679 | -0.020 | +31.54€ | 3 | 1 |
| ✅ GBM_LATE_5M#XRP | 489 | +0.019 | +8.29€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 489 | +0.019 | +8.29€ | 0 | 0 |
| ✅ GBM_LATE_60M | 418 | -0.076 | +13.94€ | 3 | 1 |
| ✅ GBM_LATE_60M#60min | 418 | -0.076 | +13.94€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 150 | -0.020 | +0.60€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 150 | -0.020 | +0.60€ | 3 | 1 |
| ✅ GBM_LATE_60M#ETH | 145 | -0.071 | +4.55€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 145 | -0.071 | +4.55€ | 3 | 1 |
| ✅ GBM_LATE_60M#SOL | 123 | -0.148 | +8.79€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 123 | -0.148 | +8.79€ | 3 | 1 |
| 🚫 GBM_LATE_60M_FADE | 137 | -0.313 | -28.99€ | 5 | 0 |
| 🚫 GBM_LATE_60M_FADE#60min | 137 | -0.313 | -28.99€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#BTC | 48 | -0.240 | -4.81€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#BTC#60min | 48 | -0.240 | -4.81€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#ETH | 48 | -0.380 | -17.17€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#ETH#60min | 48 | -0.380 | -17.17€ | 1 | 0 |
| 🚫 GBM_LATE_60M_FADE#SOL | 41 | -0.291 | -7.01€ | 0 | 0 |
| 🚫 GBM_LATE_60M_FADE#SOL#60min | 41 | -0.291 | -7.01€ | 1 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO | 180 | +0.038 | +1.93€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 180 | +0.038 | +1.93€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC | 58 | +0.000 | -1.01€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 58 | +0.000 | -1.01€ | 0 | 1 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH | 44 | +0.152 | +8.99€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH#60min | 44 | +0.152 | +8.99€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL | 78 | +0.000 | -6.05€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL#60min | 78 | +0.000 | -6.05€ | 1 | 0 |
...
| ✅ LIQUIDACIONES_15M | 142 | -0.111 | -20.04€ | 5 | 0 |
| ✅ LIQUIDACIONES_15M#15min | 142 | -0.111 | -20.04€ | 0 | 0 |
| ✅ LIQUIDACIONES_15M#BTC | 34 | -0.083 | -3.98€ | 0 | 0 |
| ✅ LIQUIDACIONES_15M#BTC#15min | 34 | -0.083 | -3.98€ | 0 | 0 |
| 🚫 LIQUIDACIONES_15M#DOGE | 14 | -0.175 | -4.30€ | 0 | 0 |
| 🚫 LIQUIDACIONES_15M#DOGE#15min | 14 | -0.175 | -4.30€ | 0 | 0 |
| ✅ LIQUIDACIONES_15M#ETH | 29 | +0.048 | +0.38€ | 0 | 0 |
| ✅ LIQUIDACIONES_15M#ETH#15min | 29 | +0.048 | +0.38€ | 0 | 0 |
| ✅ LIQUIDACIONES_15M#SOL | 26 | -0.036 | -1.79€ | 0 | 0 |
| ✅ LIQUIDACIONES_15M#SOL#15min | 26 | -0.036 | -1.79€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_60M | 155 | +0.010 | -2.87€ | 1 | 1 |
| ✅ LIQUIDACIONES_60M#60min | 155 | +0.010 | -2.87€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC | 54 | +0.000 | -4.93€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC#60min | 54 | +0.000 | -4.93€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#ETH | 49 | +0.010 | +0.80€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#ETH#60min | 49 | +0.010 | +0.80€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL | 52 | +0.018 | +1.27€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 52 | +0.018 | +1.27€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1728 | +0.015 | +16.96€ | 1 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1592 | +0.011 | +4.37€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 227 | +0.046 | +7.47€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 227 | +0.046 | +7.47€ | 0 | 1 |
...
| ✅ ORDER_FLOW_5M#ETH | 278 | -0.018 | -8.65€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#ETH#5min | 278 | -0.018 | -8.65€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M | 830 | +0.031 | +12.83€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 830 | +0.031 | +12.83€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 309 | +0.063 | +15.69€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 309 | +0.063 | +15.69€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH | 314 | +0.041 | +7.14€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 314 | +0.041 | +7.14€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 207 | -0.031 | -10.00€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 207 | -0.031 | -10.00€ | 2 | 0 |
| ✅ UPDOWN_GBM | 4067 | +0.059 | +561.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 3791 | +0.073 | +602.25€ | 0 | 5 |
...
| ✅ UPDOWN_GBM#BTC | 734 | +0.054 | +73.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 647 | +0.081 | +87.98€ | 1 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 1429 | +0.059 | +161.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1330 | +0.071 | +173.93€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 326 | +0.305 | +64.41€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 326 | +0.305 | +64.41€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 166 | +0.298 | +27.79€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 166 | +0.298 | +27.79€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 160 | +0.309 | +36.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 160 | +0.309 | +36.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 3595 | +0.159 | +1816.11€ | 0 | 21 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3595 | +0.159 | +1816.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 479 | +0.028 | +43.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 479 | +0.028 | +43.81€ | 1 | 11 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 366 | +0.196 | +242.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 366 | +0.196 | +242.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 650 | +0.199 | +305.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 650 | +0.199 | +305.95€ | 1 | 15 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 159 | +0.264 | +83.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 159 | +0.264 | +83.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 89 | +0.225 | +27.61€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 89 | +0.225 | +27.61€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 70 | +0.306 | +56.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 70 | +0.306 | +56.23€ | 0 | 0 |
| ✅ UPDOWN_OU_5M | 347 | -0.179 | -61.22€ | 8 | 0 |
| ✅ UPDOWN_OU_5M#5min | 347 | -0.179 | -61.22€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB | 55 | -0.184 | -11.55€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB#5min | 55 | -0.184 | -11.55€ | 3 | 0 |
| 🚫 UPDOWN_OU_5M#BTC | 36 | -0.210 | -6.62€ | 0 | 0 |
| 🚫 UPDOWN_OU_5M#BTC#5min | 36 | -0.210 | -6.62€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#DOGE | 60 | -0.161 | -10.58€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#DOGE#5min | 60 | -0.161 | -10.58€ | 2 | 0 |
| ✅ UPDOWN_OU_5M#ETH | 38 | -0.200 | -6.40€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#ETH#5min | 38 | -0.200 | -6.40€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.164: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.115 n=2556 | neutral: IC=+0.041 n=1992 | overbought(IBS>0.7): IC=+0.204 n=2580
  - _Datos_: n=7599 IC=+0.131 PNL=+2571.11€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.154 n=134 PNL=+59.49€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=12h: IC=+0.150 n=178 PNL=+58.14€ → BOOST | H=14h: IC=+0.136 n=182 PNL=+60.79€ → BOOST | H=16h: IC=+0.113 n=166 PNL=+44.36€ → BOOST | H=21h: IC=+0.115 n=159 PNL=+34.61€ → BOOST | H=22h: IC=+0.168 n=191 PNL=+62.26€ → BOOST
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 38 celda(s) pasan gate riguroso completo de 173 evaluadas (n>=40) y 362 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.132 n=67123 | tras_1loss IC=+0.087 n=42030 | tras_2loss IC=+0.050 n=17320/40 | gap=+0.083 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=49, boost estimado=-0.054. Necesita 0 más y boost>0.05
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=+0.007 n=203 | contrario_BTC IC=-0.037 n=93/40 | gap=-0.044 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**🟡 H-24H-GBM-BUYYES-MADRUGADA** — GBM BUY_YES en madrugada europea (05-07h UTC) — señal alcista
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.093 > 0.08 con n=192 PNL=+61.67€
  - _Datos_: n=192 IC=+0.093 PNL=+61.67€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=386 IC=+0.031 PNL=+23.58€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=386 IC=+0.031 PNL=+23.58€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3879 IC=+0.063 PNL=+567.96€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3879 IC=+0.063 PNL=+567.96€
...
**🔴 H-CUSTOM-GBM-18H** — GBM a las 18h UTC — ¿blacklist necesario?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.116 < -0.08 con n=227 PNL=-46.44€
  - _Datos_: n=227 IC=-0.116 PNL=-46.44€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1536 IC=+0.063 PNL=+216.73€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1536 IC=+0.063 PNL=+216.73€
...
**〰️ H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: n=45 IC=+0.096 PNL=+12.67€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=45 IC=+0.096 PNL=+12.67€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=647 IC=+0.081 PNL=+87.98€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=647 IC=+0.081 PNL=+87.98€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=2017 PNL=+358.26€
  - _Datos_: n=2017 IC=+0.091 PNL=+358.26€

**⏳ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: 30
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: 29/30 ops en el filtro definido (IC actual=-0.177 PNL=-2.61€)
  - _Datos_: n=29 IC=-0.177 PNL=-2.61€

**〰️ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  - _Hipótesis_: ETH y BTC tienen patrones opuestos: BTC funciona con momentum (drift>0.3). ETH funciona con reversión (drift<-1): 9/14 (64%) IC=+0.087. La hipótesis es que ETH tiene más mean-reversion que BTC en 15min.
  - _Umbral_: n≥20 y IC>+0.08
  - _Acción_: Si ETH drift<-1 confirma IC>0.08 con n≥20 → boost ×1.1 en ETH#15min cuando drift_15min<-1
  - _Estado_: n=139 IC=+0.032 PNL=+9.98€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=139 IC=+0.032 PNL=+9.98€

**〰️ H-CUSTOM-GBM-09H** — GBM a las 09h UTC — bloqueada 2026-06-29
  - _Hipótesis_: IC=-0.158 n=19 PNL=-11.62€. Bloqueada manualmente el 2026-06-29 añadiendo hora 9 a meta.gbm_blacklist_hours_auto. Esta hipótesis monitorea que el IC siga siendo negativo para justificar el bloqueo.
  - _Umbral_: n≥25 para confirmar el bloqueo es necesario
  - _Acción_: Si IC sube a >-0.05 con n≥30 → evaluar desbloquear. Si se mantiene <-0.10 → confirmar bloqueo permanente.
  - _Estado_: n=56 IC=-0.069 PNL=-7.05€ — sin señal clara aún (umbral IC: min=None max=-0.1)
  - _Datos_: n=56 IC=-0.069 PNL=-7.05€
...
**🟡 H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.107 > 0.08 con n=181 PNL=+48.19€
  - _Datos_: n=181 IC=+0.107 PNL=+48.19€
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=394 IC=-0.063 PNL=-7.19€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=394 IC=-0.063 PNL=-7.19€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2123 IC=+0.073 PNL=+329.88€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2123 IC=+0.073 PNL=+329.88€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=712 IC=+0.074 PNL=+88.56€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=712 IC=+0.074 PNL=+88.56€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.234 > 0.08 con n=317 PNL=+68.13€
  - _Datos_: n=317 IC=+0.234 PNL=+68.13€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=286 IC=+0.038 PNL=+69.09€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=286 IC=+0.038 PNL=+69.09€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=587 IC=+0.050 PNL=+58.45€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=587 IC=+0.050 PNL=+58.45€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.037 > 0.02 con n=458 PNL=+23.19€
  - _Datos_: n=458 IC=+0.037 PNL=+23.19€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1694 IC=+0.043 PNL=+185.09€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1694 IC=+0.043 PNL=+185.09€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.164 > 0.1 con n=1671 PNL=+567.10€
  - _Datos_: n=1671 IC=+0.164 PNL=+567.10€
...
**〰️ H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: n=86 IC=-0.034 PNL=+17.81€ — sin señal clara aún (umbral IC: min=None max=-0.1)
  - _Datos_: n=86 IC=-0.034 PNL=+17.81€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=286 IC=+0.066 PNL=+10.43€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=286 IC=+0.066 PNL=+10.43€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1819 IC=-0.091 PNL=+373.32€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1819 IC=-0.091 PNL=+373.32€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1536 IC=+0.070 PNL=+183.70€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1536 IC=+0.070 PNL=+183.70€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.108 > 0.08 con n=1132 PNL=+262.97€
  - _Datos_: n=1132 IC=+0.108 PNL=+262.97€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=317 IC=+0.080 PNL=+52.04€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=317 IC=+0.080 PNL=+52.04€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.112 > 0.08 con n=1126 PNL=+419.11€
  - _Datos_: n=1126 IC=+0.112 PNL=+419.11€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.147 > 0.08 con n=414 PNL=+108.69€
  - _Datos_: n=414 IC=+0.147 PNL=+108.69€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1783 IC=+0.195 PNL=+1064.53€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1783 IC=+0.195 PNL=+1064.53€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=943 IC=+0.076 PNL=+169.04€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=943 IC=+0.076 PNL=+169.04€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=990 PNL=+323.90€
  - _Datos_: n=990 IC=+0.121 PNL=+323.90€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.123 > 0.08 con n=1413 PNL=+683.77€
  - _Datos_: n=1413 IC=+0.123 PNL=+683.77€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.197 > 0.08 con n=496 PNL=+19.09€
  - _Datos_: n=496 IC=+0.197 PNL=+19.09€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.268 > 0.08 con n=947 PNL=-38.81€
  - _Datos_: n=947 IC=+0.268 PNL=-38.81€
...
**🟡 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.320 > 0.08 con n=170 PNL=+96.08€
  - _Datos_: n=170 IC=+0.320 PNL=+96.08€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2532 IC=+0.159 PNL=-351.64€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2532 IC=+0.159 PNL=-351.64€
...
**🟡 H-CUSTOM-GBMLATE15M-SOL-RESCATE-PRECIO** — GBM_LATE_15M#SOL#15min#BUY_YES (pausada 05-Ago) -- posible rescate con filtro py en [0.45,0.55)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.152 > 0.1 con n=771 PNL=+320.10€
  - _Datos_: n=771 IC=+0.152 PNL=+320.10€
