# Hipótesis automáticas — 2026-07-02 15:58 UTC
_Generado por shadow_postmortem.py sobre 2713 resoluciones (PNL=-54.61€)_
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 128 | +0.139 | +36.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 128 | +0.139 | +36.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 35 | +0.122 | +8.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 35 | +0.122 | +8.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 34 | +0.056 | +3.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 34 | +0.056 | +3.16€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 820 | -0.036 | -41.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 595 | -0.014 | -15.50€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 240 | -0.041 | -33.28€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 314 | -0.003 | +10.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 231 | +0.015 | +16.37€ | 2 | 6 |
...
| ✅ UPDOWN_GBM#SOL | 141 | -0.080 | -9.89€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.073) — sin ventaja clara. oversold(IBS<0.3): IC=+0.007 n=144 | neutral: IC=-0.066 n=127 | overbought(IBS>0.7): IC=-0.044 n=145
  - _Datos_: n=430 IC=-0.032 PNL=-16.61€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.010 n=1299 | tras_1loss IC=-0.031 n=1324 | tras_2loss IC=-0.042 n=684/40 | gap=+0.053 (umbral 0.05)
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.016 n=91 | contrario_BTC IC=-0.058 n=41/40 | gap=-0.042 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=145 IC=-0.037 PNL=-10.89€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=145 IC=-0.037 PNL=-10.89€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=697 IC=-0.031 PNL=-28.30€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=697 IC=-0.031 PNL=-28.30€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=380 IC=-0.047 PNL=-42.09€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=380 IC=-0.047 PNL=-42.09€
...
**〰️ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  ...
  - _Estado_: n=36 IC=+0.079 PNL=+9.11€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=36 IC=+0.079 PNL=+9.11€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=296 IC=+0.067 PNL=+38.31€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=296 IC=+0.067 PNL=+38.31€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 32/40 ops en el filtro definido (IC actual=+0.000 PNL=-6.32€)
  - _Datos_: n=32 IC=+0.000 PNL=-6.32€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.072 < -0.05 con n=522 PNL=-70.01€
  - _Datos_: n=522 IC=-0.072 PNL=-70.01€
