# Hipótesis automáticas — 2026-07-05 22:03 UTC
_Generado por shadow_postmortem.py sobre 4028 resoluciones (PNL=+190.98€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0087` → IC=+0.153 (n=96)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0087 (IC base=+0.029)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.158 (n=74)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.79€ cuando `ibs_15` < 0.0613 (IC base=+0.029)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.188 (n=30)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0059 (IC base=+0.068)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.186 (n=33)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 7.0 (IC base=+0.068)

- **PATRÓN** `ibs_15` < `0.0431` → IC=+0.214 (n=33)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0431 (IC base=+0.068)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0613 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.158 n=74). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0431 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.214 n=33). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1176 | +0.092 | +289.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1176 | +0.092 | +289.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 307 | +0.037 | +32.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 307 | +0.037 | +32.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 307 | +0.057 | +33.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 307 | +0.057 | +33.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 308 | +0.129 | +121.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 308 | +0.129 | +121.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 254 | +0.156 | +102.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 254 | +0.156 | +102.65€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M | 7 | -0.097 | -2.58€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7 | -0.097 | -2.58€ | 0 | 0 |
| ✅ UPDOWN_GBM | 967 | -0.037 | -52.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 728 | -0.014 | -22.67€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 270 | -0.037 | -32.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 197 | -0.013 | -21.71€ | 3 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 411 | -0.006 | +4.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 324 | +0.012 | +12.13€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.058) — sin ventaja clara. oversold(IBS<0.3): IC=-0.012 n=205 | neutral: IC=-0.070 n=163 | overbought(IBS>0.7): IC=-0.040 n=187
  - _Datos_: n=577 IC=-0.034 PNL=-27.39€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.030 n=2024 | tras_1loss IC=-0.005 n=1903 | tras_2loss IC=-0.023 n=945/40 | gap=+0.052 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=27, boost estimado=+0.015. Necesita 0 más y boost>0.05
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.000 n=160/40 PNL=+12.57€ | H=15h UTC: IC=-0.018 n=164/40 PNL=-11.68€ | H=17h UTC: IC=+0.150 n=101/40 PNL=+32.21€ | H=19h UTC: IC=+0.034 n=116/40 PNL=+7.21€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=844 IC=-0.032 PNL=-39.08€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=844 IC=-0.032 PNL=-39.08€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=439 IC=-0.042 PNL=-44.90€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=439 IC=-0.042 PNL=-44.90€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.013 < 0.02 con n=197 PNL=-21.71€
  - _Datos_: n=197 IC=-0.013 PNL=-21.71€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=327 IC=-0.011 PNL=-30.05€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=327 IC=-0.011 PNL=-30.05€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=266 IC=+0.000 PNL=+2.64€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=266 IC=+0.000 PNL=+2.64€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 11/40 ops en el filtro definido (IC actual=+0.021 PNL=+0.47€)
  - _Datos_: n=11 IC=+0.021 PNL=+0.47€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1578 IC=+0.061 PNL=+266.16€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1578 IC=+0.061 PNL=+266.16€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.068 < -0.05 con n=583 PNL=-73.85€
  - _Datos_: n=583 IC=-0.068 PNL=-73.85€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 86/120 ops en el filtro definido (IC actual=+0.159 PNL=+21.83€)
  - _Datos_: n=86 IC=+0.159 PNL=+21.83€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=104 IC=+0.009 PNL=-7.34€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=104 IC=+0.009 PNL=-7.34€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=99 IC=-0.054 PNL=+17.12€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=99 IC=-0.054 PNL=+17.12€
