# Hipótesis automáticas — 2026-07-26 01:15 UTC
_Generado por shadow_postmortem.py sobre 35764 resoluciones (PNL=+7580.20€)_
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.195 (n=847)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=2748)
...
- **PATRÓN** `libro_liquidez` > `1576.3156` → IC=+0.214 (n=540)
...
- **PATRÓN** `dist_vwap_pct` > `0.9761` → IC=+0.133 (n=137)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.9761 (IC base=+0.094)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.148 (n=379)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.157 (n=316)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.175 (n=605)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0079 (IC base=+0.163)
...
- **PATRÓN** `dist_vwap_pct` > `1.0308` → IC=+0.235 (n=32)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0308 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.657` → IC=+0.163 (n=613)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 9.657 (IC base=+0.163)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1184 | +0.124 | +55.22€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1184 | +0.124 | +55.22€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 441 | +0.143 | +18.83€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 441 | +0.143 | +18.83€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 6384 | +0.181 | +12.66€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4202 | +0.206 | +12.02€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 2220 | +0.187 | +22.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1383 | +0.216 | +43.90€ | 0 | 9 |
...
| ✅ GBM_LATE_15M | 7869 | +0.095 | +2408.42€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 7869 | +0.095 | +2408.42€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 2117 | +0.087 | +742.01€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2117 | +0.087 | +742.01€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2102 | +0.143 | +1034.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2102 | +0.143 | +1034.14€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5083 | +0.119 | +2450.61€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5083 | +0.119 | +2450.61€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 5084 | +0.072 | +1409.44€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5084 | +0.072 | +1409.44€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#XRP | 1439 | +0.170 | +917.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1439 | +0.170 | +917.99€ | 0 | 10 |
| ✅ GBM_LATE_5M | 686 | -0.032 | -0.19€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 686 | -0.032 | -0.19€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#SOL | 183 | -0.084 | +9.50€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 183 | -0.084 | +9.50€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2621 | +0.036 | +248.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2358 | +0.055 | +287.38€ | 0 | 3 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.176: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.075 n=1404 | neutral: IC=+0.017 n=1115 | overbought(IBS>0.7): IC=+0.192 n=1421
  - _Datos_: n=4202 IC=+0.106 PNL=+1118.87€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.113 n=21357 | tras_1loss IC=+0.081 n=14200 | tras_2loss IC=+0.053 n=5911/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2485 IC=+0.042 PNL=+264.59€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2485 IC=+0.042 PNL=+264.59€
...
**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.098 > 0.08 con n=321 PNL=+61.58€
  - _Datos_: n=321 IC=+0.098 PNL=+61.58€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.212 > 0.08 con n=398 PNL=+31.33€
  - _Datos_: n=398 IC=+0.212 PNL=+31.33€
