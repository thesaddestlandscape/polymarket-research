# Hipótesis automáticas — 2026-06-29 15:04 UTC
_Generado por shadow_postmortem.py sobre 1265 resoluciones (PNL=-34.55€)_
...
| ✅ WEEKLY_PRICE | 51 | +0.047 | -9.51€ | 0 | 0 |
| ✅ WEEKLY_PRICE#BTC | 16 | -0.044 | -6.36€ | 0 | 0 |
| ✅ WEEKLY_PRICE#ETH | 19 | +0.068 | -3.33€ | 0 | 0 |
...
**🟡 H-WEEKLY** — Predicciones semanales de precio por par
  ...
  - _Estado_: ETH: n=19/15 IC=+0.068 PNL=-3.33€ | BTC: n=16/15 IC=-0.044 PNL=-6.36€ | SOL: n=16/15 IC=+0.089 PNL=+0.17€
...
**⏳ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: 16/40 ops con ibs_15. oversold(IBS<0.3): IC=-0.058 n=7 | neutral: IC=+0.025 n=2 | overbought(IBS>0.7): IC=+0.054 n=5
  - _Datos_: n=16 IC=+0.044 PNL=-0.91€

**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: 20
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: Solo 16 ops GBM con hora_utc en features. Esperar n≥20 para patrones.
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.051 n=87/40 PNL=+0.29€ | H=15h UTC: IC=+0.006 n=81/40 PNL=-2.70€ | H=17h UTC: IC=+0.204 n=25/40 PNL=+7.08€ | H=19h UTC: IC=-0.029 n=32/40 PNL=-0.97€

**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40 en cualquier subtipo 60min
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=23/40 IC=+0.100 PNL=+2.69€ | BTC#60min: n=20/40 IC=+0.136 PNL=+3.10€ | SOL#60min: n=12/40 IC=+0.000 PNL=+1.27€
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 305/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=206 IC=+0.024 PNL=+5.86€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=206 IC=+0.024 PNL=+5.86€
