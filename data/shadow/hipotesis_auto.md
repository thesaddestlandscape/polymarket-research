# Hipótesis automáticas — 2026-07-10 03:02 UTC
_Generado por shadow_postmortem.py sobre 7076 resoluciones (PNL=+948.17€)_
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.184 (n=36)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 4.0 (IC base=+0.044)
...
- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.124 (n=208)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0104 (IC base=+0.035)

- **PATRÓN** `ibs_15` < `0.0512` → IC=+0.158 (n=115)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.79€ cuando `ibs_15` < 0.0512 (IC base=+0.035)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.127 (n=65)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 7.0 (IC base=+0.047)

- **PATRÓN** `ibs_15` < `0.0525` → IC=+0.136 (n=64)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.68€ cuando `ibs_15` < 0.0525 (IC base=+0.047)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0512 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.158 n=115). Confirma señal de reversión media → alinear con BUY_YES.
...
- **LIVE-CANDIDATA**: `LATE_WINDOW_5MIN` — IC=+0.194 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `LATE_WINDOW_5MIN#BTC#5min` — IC=+0.194 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `LATE_WINDOW_5MIN#BTC` — IC=+0.194 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `LATE_WINDOW_5MIN#5min` — IC=+0.194 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 2722 | +0.113 | +899.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2722 | +0.113 | +899.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 690 | +0.053 | +68.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 690 | +0.053 | +68.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 693 | +0.073 | +115.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 693 | +0.073 | +115.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 701 | +0.163 | +401.49€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 701 | +0.163 | +401.49€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 638 | +0.167 | +312.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 638 | +0.167 | +312.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 216 | +0.142 | +60.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 216 | +0.142 | +60.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 50 | +0.115 | +11.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 50 | +0.115 | +11.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 56 | +0.155 | +20.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 56 | +0.155 | +20.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 58 | +0.100 | +8.85€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 58 | +0.100 | +8.85€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 52 | +0.185 | +19.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 52 | +0.185 | +19.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 270 | +0.026 | +20.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 270 | +0.026 | +20.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 67 | +0.007 | +1.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 67 | +0.007 | +1.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 68 | -0.014 | +2.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 68 | -0.014 | +2.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 64 | -0.061 | -1.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 64 | -0.061 | -1.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 71 | +0.158 | +17.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 71 | +0.158 | +17.42€ | 0 | 0 |
| ✅ GBM_LATE_60M | 204 | -0.126 | +5.24€ | 0 | 0 |
| ✅ GBM_LATE_60M#60min | 204 | -0.126 | +5.24€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 66 | -0.088 | +1.41€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 66 | -0.088 | +1.41€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH | 65 | -0.157 | -6.91€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 65 | -0.157 | -6.91€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL | 73 | -0.127 | +10.74€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 73 | -0.127 | +10.74€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN | 34 | +0.194 | +9.39€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 34 | +0.194 | +9.39€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 34 | +0.194 | +9.39€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 34 | +0.194 | +9.39€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M | 13 | -0.022 | -0.64€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 13 | -0.022 | -0.64€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 13 | -0.022 | -0.64€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 13 | -0.022 | -0.64€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1564 | +0.013 | +18.43€ | 1 | 1 |
| ✅ ORDER_FLOW_5M#5min | 1428 | +0.009 | +5.83€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 284 | -0.021 | -5.18€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 284 | -0.021 | -5.18€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 315 | +0.043 | +14.07€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 315 | +0.043 | +14.07€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 111 | +0.084 | +10.35€ | 0 | 0 |
| ✅ STREAK_FADE_15M#15min | 111 | +0.084 | +10.35€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH | 23 | +0.220 | +9.63€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH#15min | 23 | +0.220 | +9.63€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL | 38 | +0.050 | +0.89€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL#15min | 38 | +0.050 | +0.89€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP | 50 | +0.038 | -0.17€ | 0 | 0 |
| ✅ STREAK_FADE_15M#XRP#15min | 50 | +0.038 | -0.17€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1203 | -0.015 | -1.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 951 | +0.013 | +33.74€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 571 | +0.006 | +20.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 479 | +0.026 | +31.51€ | 1 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.098) — sin ventaja clara. oversold(IBS<0.3): IC=-0.017 n=298 | neutral: IC=-0.057 n=228 | overbought(IBS>0.7): IC=+0.042 n=249
  - _Datos_: n=813 IC=-0.003 PNL=+23.55€
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 180 ops con delta_ratio | SOL: 214 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.060 n=3769 | tras_1loss IC=+0.018 n=3188 | tras_2loss IC=-0.013 n=1513/40 | gap=+0.073 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.181 n=45/60 | contraria IC=+0.089 n=16 | gap=+0.092 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=84 IC=+0.070 PNL=+12.13€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=84 IC=+0.070 PNL=+12.13€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=1080 IC=-0.009 PNL=+11.87€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1080 IC=-0.009 PNL=+11.87€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=466 IC=+0.036 PNL=+17.87€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=466 IC=+0.036 PNL=+17.87€
...
**🔶 H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.194 n=34) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=34 IC=+0.194 PNL=+9.39€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=391 IC=+0.017 PNL=+20.26€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=391 IC=+0.017 PNL=+20.26€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=4618 IC=+0.073 PNL=+1024.06€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4618 IC=+0.073 PNL=+1024.06€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=104 IC=-0.019 PNL=-5.67€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=104 IC=-0.019 PNL=-5.67€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.172 > 0.1 con n=187 PNL=+66.85€
  - _Datos_: n=187 IC=+0.172 PNL=+66.85€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=247 IC=-0.046 PNL=+53.70€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=247 IC=-0.046 PNL=+53.70€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=413 IC=+0.033 PNL=+27.79€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=413 IC=+0.033 PNL=+27.79€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.181 < -0.1 con n=296 PNL=-51.95€
  - _Datos_: n=296 IC=-0.181 PNL=-51.95€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 63/100 ops en el filtro definido (IC actual=+0.346 PNL=+43.11€)
  - _Datos_: n=63 IC=+0.346 PNL=+43.11€
