# Hipótesis automáticas — 2026-09-06 01:56 UTC
_Generado por shadow_postmortem.py sobre 303591 resoluciones (PNL=+29614.77€)_

## Patrones causales activos

### BALLENAS_CONFIRMADAS_15M
- **FILTRO** `py_entrada` < `0.705` → IC=-0.140 (n=145)
...
- **FILTRO** `py_entrada` > `0.5` → IC=-0.392 (n=81)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.128 (n=331)

- **PATRÓN** `py_entrada` > `0.705` → IC=+0.268 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.705 (IC base=+0.142)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.141 (n=316)

  - _Acción_: Kelly boost +0.71€ cuando `n_ballena_banda` > 20.0 (IC base=+0.142)

- **PATRÓN** `n_total_lado` > `72.0` → IC=+0.247 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 72.0 (IC base=+0.142)

- **PATRÓN** `banda_hit_calibrado` > `0.6169` → IC=+0.238 (n=353)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.6169 (IC base=+0.142)

- **PATRÓN** `banda_z` > `11.552` → IC=+0.275 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.552 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.172 (n=242)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 11.0 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.164 (n=367)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `3120.8362` → IC=+0.179 (n=160)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 3120.8362 (IC base=+0.142)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.128 (n=331)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` < 0.5 (IC base=+0.024)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=226)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.267 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.505 (IC base=+0.167)

- **PATRÓN** `n_total_lado` > `68.0` → IC=+0.241 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 68.0 (IC base=+0.167)

- **PATRÓN** `banda_hit_calibrado` > `0.6181` → IC=+0.263 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.6181 (IC base=+0.167)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=287)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2957.7064` → IC=+0.174 (n=170)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2957.7064 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.465` → IC=+0.162 (n=75)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` < 0.465 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `92.0` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 92.0 (IC base=+0.014)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.7` → IC=-0.299 (n=4044)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.7
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=12138)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `133.51` → IC=-0.324 (n=549)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.51
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1649)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` > `629.56` → IC=-0.160 (n=339)
...
- **FILTRO** `restante_s_al_confirmar` < `157.1` → IC=-0.159 (n=1070)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.1
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3219)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `145.71` → IC=-0.312 (n=904)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.71
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=2715)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `160.75` → IC=-0.371 (n=971)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.75
  - _Potencial_: sin este filtro IC_bueno=-0.096 (n=1974)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.192 (n=8430)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.162 (n=2169)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2364.1007` → IC=+0.162 (n=2082)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2364.1007 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.143 (n=5270)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 18.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.148 (n=7154)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 7.0 (IC base=+0.138)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.253 (n=5352)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.179 (n=4163)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `1938.54` → IC=+0.171 (n=3566)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1938.54 (IC base=+0.138)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.204 (n=949)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1189)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=985)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.192)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.288 (n=672)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.193 (n=1261)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `12428.1933` → IC=+0.206 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12428.1933 (IC base=+0.192)
...
- **PATRÓN** `py_entrada` > `0.62` → IC=+0.174 (n=222)

  - _Acción_: Kelly boost +0.87€ cuando `py_entrada` > 0.62 (IC base=+0.112)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.139 (n=1481)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 15.0 (IC base=+0.134)

- **PATRÓN** `py_entrada` > `0.69` → IC=+0.310 (n=593)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.251 (n=784)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.255 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.251)

- **PATRÓN** `libro_liquidez` > `1921.9908` → IC=+0.267 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1921.9908 (IC base=+0.251)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.144 (n=363)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.144 (n=487)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `1765.9885` → IC=+0.151 (n=362)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1765.9885 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.197 (n=852)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `939.0669` → IC=+0.197 (n=834)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.188 (n=174)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.02 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `3435.4625` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3435.4625 (IC base=+0.170)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.198 (n=5616)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 15.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.204 (n=3201)
...
- **PATRÓN** `libro_liquidez` > `6193.784` → IC=+0.331 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6193.784 (IC base=+0.191)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.182 (n=1446)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 15.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.181 (n=1706)
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.335 (n=113)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.304)

- **PATRÓN** `libro_liquidez` > `5382.4283` → IC=+0.325 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5382.4283 (IC base=+0.304)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.238 (n=1275)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.236)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.314 (n=542)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.191 (n=7956)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 6.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.210 (n=19209)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.157 (n=2651)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 12.0 (IC base=+0.154)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.178 (n=3347)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.228 (n=1228)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.225)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.276 (n=1491)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.169 (n=1389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 6.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.185 (n=3338)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.228 (n=1249)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.222)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.273 (n=1205)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.241 (n=1625)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.131 (n=1892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 8.0 (IC base=+0.123)

- **PATRÓN** `lag_apertura_s` < `3.28` → IC=+0.164 (n=1283)
...
- **PATRÓN** `libro_liquidez` > `5464.0706` → IC=+0.293 (n=109)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5464.0706 (IC base=+0.277)
...
- **PATRÓN** `libro_liquidez` > `1710.7648` → IC=+0.321 (n=317)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1710.7648 (IC base=+0.296)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.429 (n=294)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.434 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.422)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.424 (n=381)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.422)

- **PATRÓN** `libro_liquidez` > `1965.9066` → IC=+0.436 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1965.9066 (IC base=+0.422)
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.429 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.427)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.429 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.427)

- **PATRÓN** `libro_liquidez` > `1953.1484` → IC=+0.452 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1953.1484 (IC base=+0.427)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9516` → IC=+0.212 (n=1358)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9516 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.226 (n=527)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.715` → IC=+0.156 (n=1558)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 5.715 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` < `0.6988` → IC=+0.233 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6988 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.241 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.2521` → IC=+0.193 (n=500)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2521 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.8733` → IC=+0.181 (n=2491)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.8733 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `1.4721` → IC=+0.179 (n=2490)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4721 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.4017` → IC=+0.126 (n=3863)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.4017 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.1316` → IC=+0.143 (n=1270)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1316 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.854` → IC=+0.144 (n=930)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.854 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `1.0471` → IC=+0.144 (n=633)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.0471 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.302` → IC=+0.232 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.302 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` > `1.6066` → IC=+0.188 (n=1961)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.6066 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.215 (n=869)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2975` → IC=+0.166 (n=914)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2975 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.201 (n=436)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.669` → IC=+0.283 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.669 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2302` → IC=+0.242 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2302 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `2.6736` → IC=+0.150 (n=817)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.6736 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.442` → IC=+0.153 (n=816)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.442 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.197 (n=774)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.189 (n=496)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 57.0 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.247 (n=421)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.253 (n=564)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.239)

- **PATRÓN** `drift_60min` |x|≤ `0.1822` → IC=+0.287 (n=421)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1822 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.244 (n=577)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.239)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.252 (n=664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.239)

- **PATRÓN** `ibs_20min` < `0.4091` → IC=+0.272 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4091 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.345` → IC=+0.258 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.345 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` < `0.0691` → IC=+0.236 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0691 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` > `0.2883` → IC=+0.340 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2883 (IC base=+0.239)

- **PATRÓN** `volumen_spike_ratio` > `2.8305` → IC=+0.294 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8305 (IC base=+0.239)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.263 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `1718.9242` → IC=+0.257 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1718.9242 (IC base=+0.239)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.238 (n=463)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.146 (n=540)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 12.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` < `0.6614` → IC=+0.170 (n=761)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6614 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.1349` → IC=+0.169 (n=647)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1349 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.52` → IC=+0.225 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.52 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.6787` → IC=+0.162 (n=335)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6787 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.1499` → IC=+0.218 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1499 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.7274` → IC=+0.164 (n=436)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.7274 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.4046` → IC=+0.160 (n=653)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.4046 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `12567.3384` → IC=+0.150 (n=507)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12567.3384 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `213.0` → IC=+0.177 (n=190)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 213.0 (IC base=+0.144)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.194 (n=289)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0097 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.203 (n=419)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.251 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.364` → IC=+0.275 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.364 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` < `0.104` → IC=+0.163 (n=717)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3828` → IC=+0.161 (n=110)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.3828 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8863` → IC=+0.180 (n=699)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.8863 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.190 (n=923)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.192 (n=553)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 48.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.229 (n=721)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.220)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.221 (n=644)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.229 (n=330)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.220)

- **PATRÓN** `ibs_20min` < `0.0263` → IC=+0.278 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0263 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.992` → IC=+0.237 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.992 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` > `0.3726` → IC=+0.304 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3726 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` < `1.6975` → IC=+0.203 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6975 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` > `2.3963` → IC=+0.212 (n=398)
...
- **FILTRO** `ibs_20min` > `0.816` → IC=-0.182 (n=309)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=931)
...
- **PATRÓN** `dist_vwap_pct` < `0.5765` → IC=+0.320 (n=98)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5765 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` < `0.5993` → IC=+0.386 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5993 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` > `1.1956` → IC=+0.294 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1956 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` < `0.114` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.114 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.2291` → IC=+0.300 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2291 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `1.4292` → IC=+0.379 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4292 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.9064` → IC=+0.297 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9064 (IC base=-0.023)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.303 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 154.0 (IC base=-0.023)

- **PATRÓN** `dist_vwap_pct` > `0.1431` → IC=+0.144 (n=88)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.1431 (IC base=-0.040)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8133` → IC=+0.139 (n=156)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8133 (IC base=-0.040)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.399` → IC=-0.185 (n=214)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1660)

- **FILTRO** `volumen_spike_ratio` > `1.5251` → IC=-0.167 (n=25)

  - _Acción_: SKIP cuando `volumen_spike_ratio` > 1.5251
...
- **PATRÓN** `volumen_spike_ratio` < `1.4175` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4175 (IC base=-0.060)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.5039` → IC=-0.161 (n=384)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5039
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=748)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.181 (n=164)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=968)

- **FILTRO** `ibs_20min` > `0.79` → IC=-0.193 (n=448)

  - _Acción_: SKIP cuando `ibs_20min` > 0.79
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1346)

- **FILTRO** `sigma_ewma_delta_pct` > `8.947` → IC=-0.136 (n=204)
...
- **PATRÓN** `dist_vwap_pct` > `0.1575` → IC=+0.198 (n=94)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1575 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` < `0.2317` → IC=+0.207 (n=264)
...
- **PATRÓN** `volumen_spike_ratio` < `2.313` → IC=+0.203 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.313 (IC base=-0.046)

- **PATRÓN** `volumen_spike_ratio` > `1.5056` → IC=+0.175 (n=155)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.5056 (IC base=-0.046)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.164 (n=2283)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0078 (IC base=+0.079)

- **PATRÓN** `ibs_20min` > `0.3124` → IC=+0.150 (n=5035)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.3124 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` > `1.1758` → IC=+0.294 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1758 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.481` → IC=+0.123 (n=2667)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 2.481 (IC base=+0.079)

- **PATRÓN** `volumen_regimen` > `0.6802` → IC=+0.224 (n=1476)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6802 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` > `0.2515` → IC=+0.249 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2515 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` < `1.4881` → IC=+0.233 (n=852)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4881 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` > `2.8083` → IC=+0.227 (n=851)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8083 (IC base=+0.079)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.292 (n=2015)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.079)

- **PATRÓN** `ibs_20min` < `0.5848` → IC=+0.128 (n=4813)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.5848 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.7631` → IC=+0.247 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7631 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` < `0.2222` → IC=+0.219 (n=1173)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2222 (IC base=+0.051)

- **PATRÓN** `volumen_regimen` < `0.7061` → IC=+0.220 (n=551)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2584` → IC=+0.333 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2584 (IC base=+0.051)

- **PATRÓN** `volumen_spike_ratio` > `2.4118` → IC=+0.258 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4118 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.253 (n=1342)
...
- **FILTRO** `ibs_20min` < `0.3333` → IC=-0.140 (n=423)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=860)

- **FILTRO** `sigma_ewma_delta_pct` > `2.487` → IC=-0.164 (n=379)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.487
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=830)

- **PATRÓN** `ibs_20min` > `0.8457` → IC=+0.249 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8457 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.773` → IC=+0.162 (n=341)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.773 (IC base=+0.038)

- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.315 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.038)

- **PATRÓN** `volumen_spike_ratio` < `1.883` → IC=+0.242 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.883 (IC base=+0.038)

- **PATRÓN** `volumen_spike_ratio` > `1.4728` → IC=+0.223 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4728 (IC base=+0.038)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.277 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 87.0 (IC base=+0.038)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8608` → IC=-0.156 (n=411)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8608
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1236)

- **PATRÓN** `volumen_spike_ratio` < `1.7065` → IC=+0.134 (n=255)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.7065 (IC base=-0.008)

- **PATRÓN** `ballena_activa_n` < `290.0` → IC=+0.144 (n=161)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 290.0 (IC base=-0.008)

- **PATRÓN** `dist_vwap_pct` < `0.1406` → IC=+0.184 (n=204)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1406 (IC base=-0.021)

- **PATRÓN** `volumen_regimen` < `0.5824` → IC=+0.190 (n=69)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.5824 (IC base=-0.021)

- **PATRÓN** `volumen_regimen` > `1.1181` → IC=+0.204 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1181 (IC base=-0.021)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4228` → IC=+0.183 (n=162)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4228 (IC base=-0.021)
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.259 (n=729)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.230)

- **PATRÓN** `drift_60min` |x|≤ `0.0848` → IC=+0.236 (n=271)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0848 (IC base=+0.230)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.257 (n=389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.230)

- **PATRÓN** `ibs_20min` > `0.7131` → IC=+0.259 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7131 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.371` → IC=+0.295 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.371 (IC base=+0.230)

- **PATRÓN** `volumen_pendiente_norm` < `0.1087` → IC=+0.239 (n=662)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1087 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` < `2.3922` → IC=+0.233 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.3922 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` > `1.7204` → IC=+0.235 (n=727)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7204 (IC base=+0.230)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.258 (n=856)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.230)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.310 (n=534)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.286)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.316 (n=399)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.286)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.301 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.516` → IC=+0.317 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.516 (IC base=+0.286)

- **PATRÓN** `volumen_pendiente_norm` > `0.3496` → IC=+0.331 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3496 (IC base=+0.286)

- **PATRÓN** `volumen_spike_ratio` > `2.3387` → IC=+0.293 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3387 (IC base=+0.286)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.299 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.286)

- **PATRÓN** `libro_liquidez` > `1847.3847` → IC=+0.291 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1847.3847 (IC base=+0.286)
...
- **FILTRO** `ibs_20min` > `0.8648` → IC=-0.158 (n=320)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.140 (n=84)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1197)
...
- **FILTRO** `ibs_20min` < `0.8421` → IC=-0.131 (n=722)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8421
  - _Potencial_: sin este filtro IC_bueno=+0.295 (n=373)

- **FILTRO** `ibs_20min` > `0.75` → IC=-0.233 (n=305)

  - _Acción_: SKIP cuando `ibs_20min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=926)

- **FILTRO** `sigma_ewma_delta_pct` > `4.656` → IC=-0.144 (n=307)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.656
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=924)

- **PATRÓN** `ibs_20min` > `0.8421` → IC=+0.295 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8421 (IC base=+0.014)
...
- **PATRÓN** `volumen_regimen` > `1.1627` → IC=+0.281 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1627 (IC base=+0.014)

- **PATRÓN** `volumen_pendiente_norm` < `0.116` → IC=+0.259 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.116 (IC base=+0.014)

- **PATRÓN** `volumen_pendiente_norm` > `0.2747` → IC=+0.292 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2747 (IC base=+0.014)

- **PATRÓN** `volumen_spike_ratio` < `1.4485` → IC=+0.291 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4485 (IC base=+0.014)

- **PATRÓN** `volumen_spike_ratio` > `2.4195` → IC=+0.272 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4195 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.312 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` < `1.2143` → IC=+0.132 (n=142)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.2143 (IC base=-0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.295` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.295 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `1.6907` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.6907 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.179 (n=107)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 61.0 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0137` → IC=+0.335 (n=526)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0137 (IC base=+0.256)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.263 (n=373)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` > `0.8915` → IC=+0.328 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8915 (IC base=+0.256)

- **PATRÓN** `dist_vwap_pct` > `0.1699` → IC=+0.314 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1699 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.192` → IC=+0.288 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.192 (IC base=+0.256)

- **PATRÓN** `volumen_regimen` > `0.839` → IC=+0.295 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.839 (IC base=+0.256)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5673` → IC=+0.263 (n=728)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5673 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `1.8308` → IC=+0.260 (n=485)
...
- **PATRÓN** `libro_liquidez` > `2449.1286` → IC=+0.260 (n=705)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2449.1286 (IC base=+0.256)
...
- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.204 (n=1410)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0105 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3383` → IC=+0.171 (n=3723)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7` → IC=+0.223 (n=3781)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `1.0956` → IC=+0.232 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0956 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.14` → IC=+0.251 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.14 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.2254` → IC=+0.156 (n=2852)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.2254 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.6317` → IC=+0.161 (n=2852)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6317 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.1053` → IC=+0.188 (n=1603)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1053 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `2.3154` → IC=+0.163 (n=3485)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.3154 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.163 (n=3108)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `3889.6241` → IC=+0.173 (n=1410)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3889.6241 (IC base=+0.163)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.181 (n=3140)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 139.0 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.179 (n=3451)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0083 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0785` → IC=+0.201 (n=1307)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4416` → IC=+0.221 (n=3921)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4416 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2204` → IC=+0.164 (n=2914)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2204 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.086` → IC=+0.207 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.086 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1727` → IC=+0.161 (n=2931)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1727 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.623` → IC=+0.155 (n=2931)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.623 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2929` → IC=+0.244 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2929 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.6536` → IC=+0.192 (n=1097)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6536 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.166 (n=2883)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 151.0 (IC base=+0.171)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.189 (n=313)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3049` → IC=+0.205 (n=711)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3049 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.220 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.616` → IC=+0.299 (n=326)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6391` → IC=+0.175 (n=628)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.6391 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `1.4557` → IC=+0.174 (n=627)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.4557 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.216 (n=608)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `45.0` → IC=+0.198 (n=293)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 45.0 (IC base=+0.182)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.254 (n=408)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.226)

- **PATRÓN** `drift_60min` |x|≤ `0.1695` → IC=+0.308 (n=305)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1695 (IC base=+0.226)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.246 (n=475)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.226)

- **PATRÓN** `ibs_20min` < `0.2702` → IC=+0.257 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2702 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.771` → IC=+0.241 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.771 (IC base=+0.226)

- **PATRÓN** `volumen_pendiente_norm` < `0.0675` → IC=+0.218 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0675 (IC base=+0.226)

- **PATRÓN** `volumen_pendiente_norm` > `0.2921` → IC=+0.303 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2921 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` < `1.4302` → IC=+0.227 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4302 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` > `2.7379` → IC=+0.248 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7379 (IC base=+0.226)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.257 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `1701.724` → IC=+0.255 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1701.724 (IC base=+0.226)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.218 (n=307)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.179 (n=708)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0061 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.0596` → IC=+0.210 (n=236)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ballena_activa_n` < `244.0` → IC=+0.155 (n=172)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 244.0 (IC base=+0.156)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.207 (n=223)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.177)

- **PATRÓN** `drift_60min` |x|≤ `0.179` → IC=+0.199 (n=446)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.191 (n=305)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 7.0 (IC base=+0.177)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.437` → IC=+0.295 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.437 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.1322` → IC=+0.191 (n=254)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1322 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `1.896` → IC=+0.178 (n=541)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.896 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.200 (n=698)
...
- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=567)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.1189` → IC=+0.177 (n=283)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.1189 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.170 (n=656)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.4313` → IC=+0.199 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4313 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.1491` → IC=+0.181 (n=452)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1491 (IC base=+0.154)
...
- **PATRÓN** `volumen_regimen` < `0.8895` → IC=+0.157 (n=429)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8895 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `1.2168` → IC=+0.191 (n=215)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.2168 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.2935` → IC=+0.225 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2935 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `1.4389` → IC=+0.149 (n=209)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4389 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `2.6202` → IC=+0.187 (n=209)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6202 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.156 (n=718)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `8687.9043` → IC=+0.196 (n=429)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 8687.9043 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.149 (n=388)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 135.0 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.149 (n=694)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0075 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.3745` → IC=+0.141 (n=694)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3745 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.174 (n=234)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 18.0 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.135 (n=316)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` < `0.5426` → IC=+0.175 (n=694)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.5426 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` < `0.6087` → IC=+0.137 (n=807)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.6087 (IC base=+0.125)
...
- **PATRÓN** `volumen_regimen` > `0.6135` → IC=+0.129 (n=694)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5407` → IC=+0.146 (n=258)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5407 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` > `2.512` → IC=+0.145 (n=195)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 2.512 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `5154.5272` → IC=+0.134 (n=463)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 5154.5272 (IC base=+0.125)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.187 (n=266)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0117 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=834)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5283` → IC=+0.189 (n=798)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5283 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `1.1246` → IC=+0.240 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1246 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.303` → IC=+0.261 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.303 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3178.99` → IC=+0.202 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3178.99 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.137 (n=538)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 51.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.160 (n=245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0104 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.097` → IC=+0.147 (n=242)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.097 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.183 (n=336)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.122)

- **PATRÓN** `ibs_20min` < `0.4737` → IC=+0.212 (n=727)
...
- **PATRÓN** `dist_vwap_pct` < `0.1783` → IC=+0.135 (n=644)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1783 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.292` → IC=+0.157 (n=295)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.292 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `1.1889` → IC=+0.136 (n=726)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.1889 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` > `0.8586` → IC=+0.128 (n=484)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.8586 (IC base=+0.122)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4448` → IC=+0.128 (n=197)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.4448 (IC base=+0.122)
...
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.216 (n=529)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0175 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.1669` → IC=+0.218 (n=349)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1669 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=830)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.192)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.195 (n=707)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 15.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` > `0.7255` → IC=+0.247 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7255 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` > `0.2627` → IC=+0.226 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2627 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.172` → IC=+0.238 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.172 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` < `1.2034` → IC=+0.192 (n=793)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 1.2034 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` > `0.8431` → IC=+0.219 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8431 (IC base=+0.192)

- **PATRÓN** `volumen_pendiente_norm` > `0.0826` → IC=+0.249 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0826 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` < `2.5276` → IC=+0.210 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5276 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.196 (n=872)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.02 (IC base=+0.192)
...
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.169 (n=306)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4315` → IC=+0.170 (n=918)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4315 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.9443` → IC=+0.214 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9443 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.66` → IC=+0.173 (n=423)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 3.66 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8708` → IC=+0.158 (n=495)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8708 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1814` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.1814 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.178 (n=256)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.2724` → IC=+0.146 (n=760)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.2724 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.824` → IC=+0.145 (n=575)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.824 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.151 (n=963)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9602.9508` → IC=+0.179 (n=306)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 9602.9508 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.3158` → IC=+0.121 (n=618)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.3158 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.142` → IC=+0.130 (n=190)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 8.142 (IC base=+0.075)

- **PATRÓN** `volumen_pendiente_norm` > `0.1737` → IC=+0.151 (n=230)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.1737 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` > `0.004` → IC=+0.136 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.004 (IC base=+0.092)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.165 (n=165)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 10.0 (IC base=+0.092)

- **PATRÓN** `ibs_20min` > `0.566` → IC=+0.140 (n=145)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.566 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.8281` → IC=+0.232 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8281 (IC base=+0.092)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.537` → IC=+0.167 (n=79)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.537 (IC base=+0.092)

- **PATRÓN** `volumen_regimen` < `0.6949` → IC=+0.162 (n=72)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6949 (IC base=+0.092)

- **PATRÓN** `libro_liquidez` > `8646.4701` → IC=+0.152 (n=162)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8646.4701 (IC base=+0.092)

- **PATRÓN** `ibs_20min` < `0.6346` → IC=+0.156 (n=274)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.6346 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.172` → IC=+0.150 (n=58)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 9.172 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.202 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.083)

- **PATRÓN** `ballena_activa_n` < `148.0` → IC=+0.167 (n=94)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 148.0 (IC base=+0.083)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.314 (n=84)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.7468` → IC=+0.300 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7468 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` > `0.154` → IC=+0.280 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.154 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` < `0.9169` → IC=+0.267 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9169 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.086` → IC=+0.296 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.086 (IC base=+0.260)

- **PATRÓN** `volumen_regimen` < `0.8266` → IC=+0.272 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8266 (IC base=+0.260)

- **PATRÓN** `volumen_regimen` > `1.1605` → IC=+0.326 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1605 (IC base=+0.260)

- **PATRÓN** `volumen_pendiente_norm` > `0.0999` → IC=+0.350 (n=105)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.199 (n=2327)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0086 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.172 (n=5145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4836` → IC=+0.210 (n=5133)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4836 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `1.0396` → IC=+0.220 (n=719)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0396 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.463` → IC=+0.225 (n=2568)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.463 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.887` → IC=+0.159 (n=2356)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.887 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.197 (n=1406)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.8741` → IC=+0.172 (n=3199)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8741 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.165 (n=4795)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.02 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3801.753` → IC=+0.181 (n=1711)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3801.753 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.207 (n=2505)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 62.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.191 (n=4673)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0109 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.4769` → IC=+0.189 (n=4673)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.191 (n=2102)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 7.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.235 (n=4677)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.4381` → IC=+0.166 (n=3269)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.4381 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.210 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.718` → IC=+0.184 (n=4341)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 2.718 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `0.6225` → IC=+0.168 (n=1096)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6225 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `1.193` → IC=+0.163 (n=1096)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.193 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2368` → IC=+0.242 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2368 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.3011` → IC=+0.193 (n=1796)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.3011 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.175 (n=3547)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 138.0 (IC base=+0.183)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.238 (n=384)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.192)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.219 (n=411)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.909` → IC=+0.312 (n=482)
...
- **PATRÓN** `volumen_spike_ratio` < `1.469` → IC=+0.200 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.469 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `2.3008` → IC=+0.182 (n=347)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.3008 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=702)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.192)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.243 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.192)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.267 (n=560)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.255)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.260 (n=636)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.255)

- **PATRÓN** `drift_60min` |x|≤ `0.1914` → IC=+0.292 (n=425)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1914 (IC base=+0.255)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.263 (n=580)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.255)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.260 (n=640)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.255)

- **PATRÓN** `ibs_20min` < `0.4158` → IC=+0.295 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4158 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.577` → IC=+0.272 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.577 (IC base=+0.255)

- **PATRÓN** `volumen_pendiente_norm` > `0.2963` → IC=+0.309 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2963 (IC base=+0.255)

- **PATRÓN** `volumen_spike_ratio` > `2.415` → IC=+0.307 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.415 (IC base=+0.255)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.273 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.255)

- **PATRÓN** `libro_liquidez` > `1520.2648` → IC=+0.264 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1520.2648 (IC base=+0.255)

- **PATRÓN** `ballena_activa_n` < `73.0` → IC=+0.265 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 73.0 (IC base=+0.255)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.189 (n=281)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0029 (IC base=+0.155)
...
- **PATRÓN** `ibs_20min` > `0.4508` → IC=+0.209 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4508 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.2144` → IC=+0.202 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2144 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.181 (n=202)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.298` → IC=+0.163 (n=727)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 4.298 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `1.2667` → IC=+0.164 (n=833)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2667 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.158 (n=378)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.099 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` < `0.0705` → IC=+0.165 (n=706)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.0705 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1475` → IC=+0.194 (n=227)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1475 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.3955` → IC=+0.169 (n=783)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.3955 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.7292` → IC=+0.176 (n=522)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.7292 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `10518.005` → IC=+0.181 (n=744)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 10518.005 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `465.0` → IC=+0.172 (n=625)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 465.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.177 (n=745)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0061 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.169 (n=668)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0029 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.2645` → IC=+0.182 (n=655)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.2645 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=700)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.167)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.170 (n=774)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 18.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.6223` → IC=+0.208 (n=745)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6223 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.1378` → IC=+0.186 (n=647)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1378 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.868` → IC=+0.221 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.868 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `0.6156` → IC=+0.221 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6156 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.1447` → IC=+0.230 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1447 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.4033` → IC=+0.197 (n=216)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4033 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.0427` → IC=+0.193 (n=294)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.0427 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `289.0` → IC=+0.192 (n=183)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 289.0 (IC base=+0.167)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.229 (n=503)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0074 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.247 (n=358)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.6818` → IC=+0.259 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6818 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.214` → IC=+0.320 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.214 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` < `0.2192` → IC=+0.211 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2192 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` < `3.1682` → IC=+0.205 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.1682 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `1.7121` → IC=+0.206 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7121 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.235 (n=792)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `1467.9084` → IC=+0.214 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1467.9084 (IC base=+0.209)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.249 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 65.0 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.263 (n=251)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0059 (IC base=+0.232)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.240 (n=340)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` < `3.0442` → IC=+0.229 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0442 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `1.8897` → IC=+0.216 (n=561)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8897 (IC base=+0.232)
...
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.157 (n=753)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0069 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=768)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.7314` → IC=+0.239 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7314 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.364` → IC=+0.185 (n=341)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.364 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.314` → IC=+0.168 (n=380)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 4.314 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.8979` → IC=+0.169 (n=569)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8979 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.2062` → IC=+0.145 (n=285)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.2062 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.2746` → IC=+0.231 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2746 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `2.5172` → IC=+0.189 (n=271)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.5172 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.144 (n=930)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `9500.4052` → IC=+0.238 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9500.4052 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.168 (n=224)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0032 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.4356` → IC=+0.140 (n=664)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.160 (n=292)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 7.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6809` → IC=+0.170 (n=664)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6809 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.6853` → IC=+0.136 (n=736)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.6853 (IC base=+0.123)
...
- **PATRÓN** `volumen_regimen` < `1.0179` → IC=+0.125 (n=584)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.0179 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `1.1432` → IC=+0.137 (n=221)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 1.1432 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2776` → IC=+0.257 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2776 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.5135` → IC=+0.150 (n=201)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 2.5135 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9462.6339` → IC=+0.173 (n=301)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 9462.6339 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `191.0` → IC=+0.134 (n=517)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 191.0 (IC base=+0.123)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.137 (n=598)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0078 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.135 (n=600)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.178 (n=899)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4706 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `1.0947` → IC=+0.182 (n=171)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 1.0947 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.395` → IC=+0.214 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.395 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2942.126` → IC=+0.258 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2942.126 (IC base=+0.093)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.133 (n=676)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 63.0 (IC base=+0.093)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.180 (n=282)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0057 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1269` → IC=+0.184 (n=280)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.1269 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.148 (n=407)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` < `0.5862` → IC=+0.196 (n=839)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.5862 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.5034` → IC=+0.137 (n=804)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.5034 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.459` → IC=+0.128 (n=777)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 2.459 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `1.0602` → IC=+0.132 (n=738)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0602 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0745` → IC=+0.175 (n=290)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0745 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.5612` → IC=+0.146 (n=303)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5612 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `2.1793` → IC=+0.131 (n=312)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.1793 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2625.2681` → IC=+0.149 (n=380)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2625.2681 (IC base=+0.117)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0279` → IC=+0.237 (n=318)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.202 (n=838)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.1714` → IC=+0.247 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1714 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.172` → IC=+0.245 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.172 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.862` → IC=+0.215 (n=634)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.862 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.1711` → IC=+0.243 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1711 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.8207` → IC=+0.211 (n=600)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6467` → IC=+0.205 (n=1042)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6467 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=986)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.210 (n=1095)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` < `0.1793` → IC=+0.210 (n=901)
...
- **PATRÓN** `volumen_regimen` > `1.2323` → IC=+0.240 (n=348)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2225` → IC=+0.188 (n=763)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.2225 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4546` → IC=+0.196 (n=867)
...
- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.185 (n=761)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.130 (n=1820)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.134 (n=1475)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0103 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.5544` → IC=+0.130 (n=1675)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.5544 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.169 (n=578)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 18.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `0.9286` → IC=+0.192 (n=559)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.9286 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.398` → IC=+0.145 (n=263)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 10.398 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.1729` → IC=+0.152 (n=464)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.1729 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.4626` → IC=+0.140 (n=553)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4626 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.894` → IC=+0.143 (n=1105)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.894 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `8629.6288` → IC=+0.129 (n=759)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 8629.6288 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.175 (n=459)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0039 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.4997` → IC=+0.147 (n=1377)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4997 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.158 (n=513)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 17.0 (IC base=+0.127)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.154 (n=466)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_regimen` < `1.0973` → IC=+0.139 (n=1154)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.0973 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` < `0.1492` → IC=+0.128 (n=1377)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1492 (IC base=+0.127)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.182 (n=278)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0035 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.0863` → IC=+0.141 (n=210)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.0863 (IC base=+0.112)
...
- **PATRÓN** `ibs_20min` < `0.1654` → IC=+0.156 (n=277)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.1654 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.6417` → IC=+0.156 (n=88)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6417 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.377` → IC=+0.138 (n=625)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 6.377 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.1896` → IC=+0.128 (n=630)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.1896 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.0641` → IC=+0.155 (n=297)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.0641 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4049` → IC=+0.141 (n=210)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4049 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `11129.4732` → IC=+0.123 (n=630)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 11129.4732 (IC base=+0.112)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.213 (n=141)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.179 (n=191)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0106 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.2953` → IC=+0.164 (n=281)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.2953 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.191 (n=380)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 9.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.988` → IC=+0.232 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.988 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.26` → IC=+0.225 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.26 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.2135` → IC=+0.172 (n=114)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.2135 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `3.5044` → IC=+0.165 (n=419)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 3.5044 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.8333` → IC=+0.157 (n=374)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.8333 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `2299.0582` → IC=+0.183 (n=140)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 2299.0582 (IC base=+0.153)
...
- **FILTRO** `dist_vwap_pct` > `0.1414` → IC=-0.289 (n=17)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.1414
...
- **PATRÓN** `ibs_20min` < `0.0952` → IC=+0.211 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0952 (IC base=-0.115)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0817` → IC=+0.180 (n=23)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.0817 (IC base=-0.033)

- **PATRÓN** `ibs_20min` < `0.3814` → IC=+0.188 (n=30)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.3814 (IC base=-0.033)
...
- **PATRÓN** `libro_liquidez` > `2736.2335` → IC=+0.182 (n=108)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 2736.2335 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2240.2754` → IC=+0.128 (n=275)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 2240.2754 (IC base=+0.098)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=1630)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.032 (n=4980)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.184 (n=1632)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5190)
...
- **FILTRO** `ibs_20min` < `0.7376` → IC=-0.189 (n=262)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7376
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=789)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.161 (n=293)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=908)
...
- **FILTRO** `ballena_activa_n` > `58.0` → IC=-0.155 (n=265)

  - _Acción_: SKIP cuando `ballena_activa_n` > 58.0
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=798)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.183 (n=358)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=745)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.216 (n=287)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=884)

- **FILTRO** `ibs_20min` > `0.7059` → IC=-0.193 (n=291)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7059
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=880)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.173 (n=313)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.142 (n=294)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=818)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.185 (n=252)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.200 (n=291)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=877)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=559)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=3865)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=12049)

- **FILTRO** `ibs_7min` < `0.7163` → IC=-0.235 (n=3978)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7163
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=11936)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.169 (n=5355)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=10559)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.222 (n=4899)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=15263)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=5016)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=15146)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=564)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1792)

- **FILTRO** `ibs_7min` < `0.7105` → IC=-0.251 (n=777)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7105
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1579)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.218 (n=561)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1795)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.242 (n=863)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2638)

- **FILTRO** `drift_7min_pct` |x|> `0.1143` → IC=-0.133 (n=1187)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1143
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2314)

- **FILTRO** `ibs_7min` > `0.8349` → IC=-0.198 (n=875)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8349
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2626)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=646)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2287)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=710)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2223)

- **FILTRO** `ibs_7min` < `0.7719` → IC=-0.191 (n=733)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7719
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2200)

- **FILTRO** `ballena_activa_n` > `164.0` → IC=-0.178 (n=733)

  - _Acción_: SKIP cuando `ballena_activa_n` > 164.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2200)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.243 (n=718)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2238)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.170 (n=1001)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1955)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.181 (n=750)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1587)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.303 (n=741)
...
- **FILTRO** `ibs_7min` < `0.2222` → IC=-0.289 (n=581)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1756)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.240 (n=553)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1784)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.225 (n=863)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=2794)

- **FILTRO** `ibs_7min` > `0.797` → IC=-0.171 (n=914)

  - _Acción_: SKIP cuando `ibs_7min` > 0.797
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2743)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.261 (n=643)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2044)

- **FILTRO** `ibs_7min` < `0.7575` → IC=-0.188 (n=671)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7575
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=2016)

- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.172 (n=900)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1787)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.255 (n=679)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=2038)

- **FILTRO** `ibs_7min` > `0.2762` → IC=-0.178 (n=679)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2762
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=2038)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.187 (n=672)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2045)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.237 (n=724)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2253)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.203 (n=739)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2238)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.170 (n=942)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2838)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.296 (n=634)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1990)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.231 (n=653)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1971)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.226 (n=633)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1991)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.205 (n=856)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2695)

- **FILTRO** `ibs_7min` > `0.76` → IC=-0.154 (n=883)

  - _Acción_: SKIP cuando `ibs_7min` > 0.76
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2668)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=854)
...
- **PATRÓN** `streak_estiramiento` < `0.4095` → IC=+0.167 (n=34)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `streak_estiramiento` < 0.4095 (IC base=+0.030)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1691)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.176 (n=208)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0035 (IC base=+0.142)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.184 (n=207)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0075 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.1668` → IC=+0.143 (n=547)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.1668 (IC base=+0.142)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1911` → IC=+0.144 (n=282)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio_macro` |x|> 0.1911 (IC base=+0.142)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3318` → IC=+0.189 (n=307)

  - _Acción_: Kelly boost +0.95€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3318 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.143 (n=662)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 4.0 (IC base=+0.142)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.179 (n=288)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 6.0 (IC base=+0.142)

- **PATRÓN** `ibs_15` > `0.5919` → IC=+0.221 (n=621)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5919 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.2698` → IC=+0.150 (n=238)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.2698 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.5472` → IC=+0.143 (n=662)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.5472 (IC base=+0.142)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=617)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `9645.5725` → IC=+0.175 (n=207)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 9645.5725 (IC base=+0.142)

### UPDOWN_GBM#5min
- **FILTRO** `sigma_ewma_delta_pct` > `7.845` → IC=-0.204 (n=42)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 7.845
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1285)
...
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.212 (n=116)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.178)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.179 (n=79)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0044 (IC base=+0.178)

- **PATRÓN** `drift_60min` |x|≤ `0.1888` → IC=+0.199 (n=174)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1888 (IC base=+0.178)

- **PATRÓN** `drift_15min` |x|≤ `0.391` → IC=+0.183 (n=77)

  - _Acción_: Kelly boost +0.92€ cuando `drift_15min` |x|≤ 0.391 (IC base=+0.178)
...
- **PATRÓN** `ibs_15` > `0.8714` → IC=+0.297 (n=116)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8714 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` > `0.156` → IC=+0.185 (n=106)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.156 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` < `0.1185` → IC=+0.199 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1185 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.773` → IC=+0.226 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.773 (IC base=+0.178)

- **PATRÓN** `libro_liquidez` > `14752.2757` → IC=+0.267 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14752.2757 (IC base=+0.178)
...
- **FILTRO** `ibs_15` < `0.6756` → IC=-0.173 (n=47)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6756
...
- **PATRÓN** `ibs_15` > `0.8231` → IC=+0.122 (n=96)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` > 0.8231 (IC base=+0.010)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.351` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 20.351 (IC base=+0.010)

### UPDOWN_GBM#ETH#15min
- **FILTRO** `ibs_15` < `0.6467` → IC=-0.206 (n=49)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6467
  - _Potencial_: sin este filtro IC_bueno=+0.200 (n=148)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.147 (n=66)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0034 (IC base=+0.098)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2632` → IC=+0.192 (n=50)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.2632 (IC base=+0.098)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2299` → IC=+0.130 (n=71)

  - _Acción_: Kelly boost +0.65€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2299 (IC base=+0.098)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.128 (n=151)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 17.0 (IC base=+0.098)

- **PATRÓN** `ibs_15` > `0.6467` → IC=+0.200 (n=148)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6467 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` < `0.1542` → IC=+0.147 (n=117)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.1542 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.878` → IC=+0.162 (n=66)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 8.878 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `12383.1611` → IC=+0.154 (n=50)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12383.1611 (IC base=+0.098)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.167 (n=25)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0059 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` < `0.3805` → IC=+0.160 (n=51)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.3805 (IC base=+0.015)

### UPDOWN_GBM#XRP#15min
- **PATRÓN** `delta_ratio_macro` |x|> `0.0459` → IC=+0.157 (n=170)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.78€ cuando `delta_ratio_macro` |x|> 0.0459 (IC base=+0.136)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1718` → IC=+0.211 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1718 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.195 (n=80)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 6.0 (IC base=+0.136)

- **PATRÓN** `ibs_15` > `0.5676` → IC=+0.234 (n=152)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5676 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.1142` → IC=+0.202 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1142 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.916` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.916 (IC base=+0.136)
...
- **PATRÓN** `libro_liquidez` > `2680.8058` → IC=+0.209 (n=77)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2680.8058 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.205 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 39.0 (IC base=+0.136)

- **PATRÓN** `ibs_15` < `0.1159` → IC=+0.182 (n=190)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` < 0.1159 (IC base=+0.032)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1426` → IC=+0.332 (n=141)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.8357` → IC=+0.390 (n=189)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.330 (n=256)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.112` → IC=+0.364 (n=42)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.112 (IC base=+0.314)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.320 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.314)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.341 (n=42)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.314)

- **PATRÓN** `drift_60min` |x|≤ `0.1567` → IC=+0.329 (n=109)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1567 (IC base=+0.314)

- **PATRÓN** `drift_15min` |x|≤ `0.376` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.376 (IC base=+0.314)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0919` → IC=+0.323 (n=111)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0919 (IC base=+0.314)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1332` → IC=+0.412 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1332 (IC base=+0.314)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.358 (n=111)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.314)

- **PATRÓN** `ibs_15` > `0.8048` → IC=+0.357 (n=124)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8048 (IC base=+0.314)

- **PATRÓN** `dist_vwap_pct` > `0.2698` → IC=+0.370 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2698 (IC base=+0.314)

- **PATRÓN** `sigma_ewma_delta_pct` < `8.509` → IC=+0.333 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 8.509 (IC base=+0.314)

- **PATRÓN** `libro_liquidez` > `8157.6321` → IC=+0.359 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8157.6321 (IC base=+0.314)

- **PATRÓN** `ballena_activa_n` < `626.0` → IC=+0.411 (n=77)
...
- **FILTRO** `sigma_h` > `0.0112` → IC=-0.192 (n=374)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0112
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=1123)

- **FILTRO** `ibs_15` < `0.5879` → IC=-0.188 (n=168)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.5879
  - _Potencial_: sin este filtro IC_bueno=+0.241 (n=342)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=394)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1103)

- **FILTRO** `sigma_ewma_delta_pct` > `18.767` → IC=-0.156 (n=539)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.767
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4086)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3537` → IC=+0.189 (n=220)

  - _Acción_: Kelly boost +0.95€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3537 (IC base=-0.064)

- **PATRÓN** `ibs_15` > `0.5879` → IC=+0.241 (n=342)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5879 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` < `0.1742` → IC=+0.137 (n=232)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1742 (IC base=-0.064)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1248` → IC=+0.223 (n=355)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `dist_vwap_pct` < `0.1514` → IC=+0.212 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1514 (IC base=-0.064)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.215 (n=496)
...
- **FILTRO** `sigma_h` > `0.0074` → IC=-0.226 (n=239)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=721)

- **FILTRO** `sigma_h` < `0.0038` → IC=-0.233 (n=316)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0038
  - _Potencial_: sin este filtro IC_bueno=-0.183 (n=644)

- **FILTRO** `sigma_ewma_delta_pct` > `19.563` → IC=-0.256 (n=174)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.563
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=786)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.145 (n=74)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0026 (IC base=+0.036)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1186` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1186 (IC base=+0.036)

- **PATRÓN** `ibs_15` > `0.6819` → IC=+0.317 (n=58)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6819 (IC base=+0.036)

- **PATRÓN** `dist_vwap_pct` < `0.1653` → IC=+0.235 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1653 (IC base=+0.036)

- **PATRÓN** `ballena_activa_n` < `320.0` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 320.0 (IC base=+0.036)

### UPDOWN_GBM_15M_TARDIO#ETH#15min
- **FILTRO** `ibs_15` < `0.6448` → IC=-0.237 (n=78)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6448
  - _Potencial_: sin este filtro IC_bueno=+0.261 (n=161)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.116 (n=222)

- **PATRÓN** `drift_60min` |x|≤ `0.0806` → IC=+0.216 (n=79)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0806 (IC base=+0.098)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2769` → IC=+0.221 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2769 (IC base=+0.098)

- **PATRÓN** `ibs_15` > `0.6448` → IC=+0.261 (n=161)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6448 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` < `0.3442` → IC=+0.123 (n=165)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.3442 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `10966.626` → IC=+0.202 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10966.626 (IC base=+0.098)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.124` → IC=+0.183 (n=80)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.91€ cuando `delta_ratio_macro` |x|> 0.124 (IC base=-0.050)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2087` → IC=+0.192 (n=76)

  - _Acción_: Kelly boost +0.96€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2087 (IC base=-0.050)

- **PATRÓN** `ibs_15` < `0.3926` → IC=+0.215 (n=121)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3926 (IC base=-0.050)

- **PATRÓN** `dist_vwap_pct` < `0.1451` → IC=+0.192 (n=105)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.1451 (IC base=-0.050)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.1341` → IC=-0.181 (n=142)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.1341
  - _Potencial_: sin este filtro IC_bueno=-0.158 (n=276)

- **FILTRO** `drift_15min` |x|> `1.1964` → IC=-0.255 (n=104)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.1964
  - _Potencial_: sin este filtro IC_bueno=-0.136 (n=314)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.230 (n=72)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.287 (n=364)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.284)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.290 (n=165)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0055 (IC base=+0.284)

- **PATRÓN** `drift_60min` |x|≤ `0.057` → IC=+0.339 (n=122)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.057 (IC base=+0.284)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1322` → IC=+0.304 (n=243)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.8311` → IC=+0.317 (n=364)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8311 (IC base=+0.284)

- **PATRÓN** `dist_vwap_pct` > `0.2994` → IC=+0.321 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2994 (IC base=+0.284)

- **PATRÓN** `sigma_ewma_delta_pct` > `18.899` → IC=+0.288 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.899 (IC base=+0.284)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.414` → IC=+0.285 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.414 (IC base=+0.284)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.293 (n=447)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.294 (n=139)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0037 (IC base=+0.281)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.283 (n=95)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.281)

- **PATRÓN** `drift_60min` |x|≤ `0.1134` → IC=+0.294 (n=139)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1134 (IC base=+0.281)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1252` → IC=+0.323 (n=139)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1252 (IC base=+0.281)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.309 (n=218)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.281)

- **PATRÓN** `ibs_15` > `0.8545` → IC=+0.314 (n=186)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8545 (IC base=+0.281)

- **PATRÓN** `dist_vwap_pct` > `0.3029` → IC=+0.330 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3029 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` > `22.592` → IC=+0.337 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 22.592 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.246` → IC=+0.288 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.246 (IC base=+0.281)
...
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.286 (n=157)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0071 (IC base=+0.286)

- **PATRÓN** `drift_60min` |x|≤ `0.0714` → IC=+0.331 (n=69)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0714 (IC base=+0.286)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1901` → IC=+0.322 (n=71)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1901 (IC base=+0.286)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1463` → IC=+0.333 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1463 (IC base=+0.286)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.317 (n=151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.286)

- **PATRÓN** `ibs_15` > `0.8444` → IC=+0.323 (n=156)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8444 (IC base=+0.286)

- **PATRÓN** `dist_vwap_pct` > `0.2913` → IC=+0.303 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2913 (IC base=+0.286)

- **PATRÓN** `dist_vwap_pct` < `0.4822` → IC=+0.290 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4822 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.579` → IC=+0.310 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.579 (IC base=+0.286)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.309 (n=181)
...
- **PATRÓN** `ballena_activa_n` < `112.0` → IC=+0.289 (n=55)
...
- **H-SIGMA-SOL-60MIN**: `UPDOWN_GBM#SOL#60min` gana cuando sigma_h < 0.0059 (IC=+0.167 n=25). Implementar como filtro pre-predicción en shadow_predict.py.
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5919 sube el IC de +0.142 a +0.221 en UPDOWN_GBM#15min (n=621). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.8714 sube el IC de +0.178 a +0.297 en UPDOWN_GBM#BTC#15min (n=116). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6467 sube el IC de +0.098 a +0.200 en UPDOWN_GBM#ETH#15min (n=148). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5676 sube el IC de +0.136 a +0.234 en UPDOWN_GBM#XRP#15min (n=152). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1159 sube el IC de +0.032 a +0.182 en UPDOWN_GBM#XRP#15min (n=190). Ya aplicado como kelly_boost=+0.91€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5879 sube el IC de -0.064 a +0.241 en UPDOWN_GBM_15M_TARDIO (n=342). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.6819 sube el IC de +0.036 a +0.317 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=58). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6448 sube el IC de +0.098 a +0.261 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=161). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3926 sube el IC de -0.050 a +0.215 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=121). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8311 sube el IC de +0.284 a +0.317 en UPDOWN_GBM_IBS_ALTO (n=364). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8545 sube el IC de +0.281 a +0.314 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=186). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8444 sube el IC de +0.286 a +0.323 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=156). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.8357 sube el IC de +0.323 a +0.390 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=189). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8048 sube el IC de +0.314 a +0.357 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n
38€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 1228 | +0.006 | -8.38€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 737 | +0.013 | +11.17€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 737 | +0.013 | +11.17€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 4454 | +0.011 | -27.55€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 4454 | +0.011 | -27.55€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1710 | +0.012 | -10.98€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1710 | +0.012 | -10.98€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1777 | +0.019 | +1.77€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1777 | +0.019 | +1.77€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 967 | -0.004 | -18.34€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 967 | -0.004 | -18.34€ | 2 | 0 |
| ✅ UPDOWN_GBM | 11530 | +0.012 | +408.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 3886 | +0.041 | +436.37€ | 0 | 13 |
| ✅ UPDOWN_GBM#240min | 485 | +0.007 | +7.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 6375 | -0.001 | -27.87€ | 1 | 0 |
| ✅ UPDOWN_GBM#60min | 728 | -0.005 | -6.13€ | 3 | 0 |
| ✅ UPDOWN_GBM#BNB | 580 | +0.062 | +54.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 188 | +0.111 | +41.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 11 | -0.021 | -0.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 381 | +0.041 | +12.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 2094 | +0.015 | +122.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 447 | +0.077 | +98.90€ | 1 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 147 | +0.044 | +8.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 1186 | -0.005 | +18.57€ | 3 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 293 | -0.002 | -4.13€ | 3 | 2 |
| ✅ UPDOWN_GBM#BTC#daily | 21 | -0.152 | +0.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 1375 | +0.011 | +15.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 130 | +0.091 | +29.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 10 | +0.042 | +0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 1235 | +0.002 | -15.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 2340 | +0.001 | +22.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1109 | +0.028 | +47.27€ | 1 | 8 |
| ✅ UPDOWN_GBM#ETH#240min | 137 | +0.018 | +7.29€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 787 | -0.030 | -29.35€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 288 | -0.010 | -3.01€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 19 | -0.158 | +0.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 3271 | +0.003 | +25.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1028 | +0.006 | +27.87€ | 1 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 131 | -0.004 | -2.55€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 1951 | +0.005 | +0.17€ | 2 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 147 | -0.003 | +1.01€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#daily | 14 | -0.175 | -1.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 1868 | +0.025 | +169.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 984 | +0.056 | +190.40€ | 0 | 10 |
| ✅ UPDOWN_GBM#XRP#240min | 49 | -0.108 | -6.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 835 | -0.004 | -14.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#daily | 54 | -0.196 | +0.06€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 281 | +0.323 | +66.61€ | 0 | 13 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 281 | +0.323 | +66.61€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 165 | +0.314 | +31.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 165 | +0.314 | +31.55€ | 0 | 13 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 6122 | -0.064 | +1343.91€ | 4 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 6122 | -0.064 | +1343.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 311 | -0.050 | +343.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 311 | -0.050 | +343.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1253 | -0.145 | -53.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1253 | -0.145 | -53.51€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 81 | +0.042 | +8.29€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 81 | +0.042 | +8.29€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 571 | +0.165 | +288.50€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 571 | +0.165 | +288.50€ | 2 | 16 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 2001 | -0.066 | +380.36€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 2001 | -0.066 | +380.36€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1905 | -0.085 | +377.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1905 | -0.085 | +377.14€ | 3 | 4 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 485 | +0.284 | +384.55€ | 0 | 12 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 485 | +0.284 | +384.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 277 | +0.281 | +217.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 277 | +0.281 | +217.62€ | 0 | 10 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 208 | +0.286 | +166.93€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 208 | +0.286 | +166.93€ | 0 | 12 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.081) — sin ventaja clara. oversold(IBS<0.3): IC=+0.024 n=4022 | neutral: IC=+0.009 n=4487 | overbought(IBS>0.7): IC=+0.089 n=4505
  - _Datos_: n=13511 IC=+0.042 PNL=+1443.55€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=1028 IC=+0.006 PNL=+27.87€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 11468 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.

**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  - _Umbral_: n≥60 alineadas y gap IC≥0.08 vs contrarias — y descartar que sea proxy de drift_15min/60min
  - _Acción_: Si confirma e independiente de drift → capturar prev_window_outcome como feature en shadow_predict y boost ×1.1-1.2 en señales alineadas
  - _Estado_: alineada_con_outcome_prev IC=+0.006 n=79/60 | contraria IC=+0.118 n=53 | gap=-0.112 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n