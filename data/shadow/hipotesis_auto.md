# Hipótesis automáticas — 2026-08-21 17:36 UTC
_Generado por shadow_postmortem.py sobre 103839 resoluciones (PNL=+8570.94€)_
...
- **FILTRO** `restante_s_al_confirmar` < `156.16` → IC=-0.262 (n=1464)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4395)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=3530)
...
- **PATRÓN** `libro_liquidez` > `2375.6867` → IC=+0.170 (n=1252)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2375.6867 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.150 (n=2189)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=7192)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.158 (n=601)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.246 (n=400)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.228 (n=420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.163 (n=336)
...
- **FILTRO** `ibs_20min` < `0.719` → IC=-0.192 (n=50)
...
- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.153 (n=70)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.9429 (IC base=-0.022)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.267 (n=856)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2592)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.213 (n=860)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2588)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.169 (n=1155)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=2293)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.219 (n=1005)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=3140)

- **FILTRO** `ibs_7min` > `0.7049` → IC=-0.154 (n=1036)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7049
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3109)
...
- **FILTRO** `drift_7min_pct` |x|> `0.1311` → IC=-0.182 (n=215)
...
- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.142 (n=160)
...
- **FILTRO** `py_entrada` < `0.37` → IC=-0.238 (n=147)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=463)

- **FILTRO** `ibs_7min` < `0.7905` → IC=-0.182 (n=152)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.122 (n=96)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 16.0 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `23.0` → IC=+0.151 (n=41)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 23.0 (IC base=+0.071)
...
| ✅ BALLENAS_TARDIAS | 4760 | -0.104 | -561.83€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 554 | -0.074 | -91.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 4206 | -0.108 | -470.11€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 581 | -0.126 | -83.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 581 | -0.126 | -83.38€ | 2 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#DOGE | 2244 | +0.063 | -367.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 15 | +0.022 | -2.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2228 | +0.064 | -362.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 4757 | +0.127 | -80.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1555 | +0.169 | -5.93€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2211 | +0.106 | -55.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 979 | +0.110 | -10.63€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 4542 | +0.126 | -360.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1454 | +0.199 | -79.12€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2207 | +0.078 | -207.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 836 | +0.134 | -66.36€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2239 | +0.115 | -121.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 14 | +0.000 | -0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2224 | +0.116 | -119.20€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 9499 | +0.195 | -831.72€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 9499 | +0.195 | -831.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1773 | +0.116 | -358.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1773 | +0.116 | -358.97€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1660 | +0.156 | -236.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1660 | +0.156 | -236.47€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 1498 | +0.237 | -39.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 1498 | +0.237 | -39.06€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 1595 | +0.198 | -136.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 1595 | +0.198 | -136.28€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 1825 | +0.106 | -59.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 185 | +0.029 | -19.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 1640 | +0.115 | -40.39€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 572 | +0.129 | -10.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 572 | +0.129 | -10.91€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 2788 | -0.029 | +92.72€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 2788 | -0.029 | +92.72€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 443 | -0.030 | +51.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 443 | -0.030 | +51.53€ | 4 | 1 |
...
| ✅ MOMENTUM_IBS_5M | 1079 | -0.001 | -1.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 1079 | -0.001 | -1.96€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#SOL | 306 | +0.000 | +0.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 306 | +0.000 | +0.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 166 | -0.006 | -5.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 166 | -0.006 | -5.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 7593 | -0.066 | +239.90€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 7593 | -0.066 | +239.90€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 1131 | -0.100 | +102.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 1131 | -0.100 | +102.11€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 1438 | -0.053 | +59.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 1438 | -0.053 | +59.57€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 1181 | -0.065 | +55.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 1181 | -0.065 | +55.68€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 1231 | -0.084 | -60.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 1231 | -0.084 | -60.12€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 1404 | -0.042 | +29.27€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 1404 | -0.042 | +29.27€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 1208 | -0.059 | +53.39€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 1208 | -0.059 | +53.39€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 5477 | -0.009 | -103.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 5477 | -0.009 | -103.60€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 1119 | -0.007 | -17.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 1119 | -0.007 | -17.93€ | 1 | 0 |
...
| ✅ STREAK_MOM_5M | 1019 | +0.015 | +1.10€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 1019 | +0.015 | +1.10€ | 0 | 0 |
...
| ✅ STREAK_MOM_5M#XRP | 188 | +0.037 | +4.95€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 188 | +0.037 | +4.95€ | 2 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.101) — sin ventaja clara. oversold(IBS<0.3): IC=-0.007 n=1235 | neutral: IC=+0.009 n=1272 | overbought(IBS>0.7): IC=+0.094 n=1522
  - _Datos_: n=4273 IC=+0.036 PNL=+344.16€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.088 n=59060 | tras_1loss IC=+0.047 n=44456 | tras_2loss IC=+0.010 n=20073/40 | gap=+0.078 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3385 IC=+0.006 PNL=+85.45€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3385 IC=+0.006 PNL=+85.45€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=767 IC=-0.049 PNL=-56.64€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=767 IC=-0.049 PNL=-56.64€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=2359 IC=-0.117 PNL=+325.00€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2359 IC=-0.117 PNL=+325.00€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1773 IC=+0.116 PNL=-358.97€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1773 IC=+0.116 PNL=-358.97€
