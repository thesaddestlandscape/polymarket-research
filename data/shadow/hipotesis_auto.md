# Hipótesis automáticas — 2026-07-21 16:17 UTC
_Generado por shadow_postmortem.py sobre 27099 resoluciones (PNL=+6230.71€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=2050)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `4229.257` → IC=+0.170 (n=1233)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 4229.257 (IC base=+0.169)
...
| ✅ FAVORITO_CONFIRMADO | 4674 | +0.185 | +73.70€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#60min | 807 | +0.155 | +49.54€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1638 | +0.186 | +17.34€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 269 | +0.135 | -11.47€ | 0 | 5 |
...
| ✅ LATE_WINDOW_5MIN | 218 | -0.004 | +5.56€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 218 | -0.004 | +5.56€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 218 | -0.004 | +5.56€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 218 | -0.004 | +5.56€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.115 n=16210 | tras_1loss IC=+0.082 n=10680 | tras_2loss IC=+0.049 n=4424/40 | gap=+0.066 (umbral 0.05)
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=218 IC=-0.004 PNL=+5.56€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=218 IC=-0.004 PNL=+5.56€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=24633 IC=+0.113 PNL=+6306.46€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=24633 IC=+0.113 PNL=+6306.46€
