# Hipótesis automáticas — 2026-07-12 21:08 UTC
_Generado por shadow_postmortem.py sobre 11436 resoluciones (PNL=+2195.05€)_
...
- **PATRÓN** `libro_liquidez` > `5937.8835` → IC=+0.163 (n=182)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 5937.8835 (IC base=+0.155)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 1038 | +0.189 | +33.87€ | 0 | 9 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.094 n=6497 | tras_1loss IC=+0.049 n=4801 | tras_2loss IC=+0.015 n=2136/40 | gap=+0.078 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8978 IC=+0.100 PNL=+2270.93€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8978 IC=+0.100 PNL=+2270.93€
