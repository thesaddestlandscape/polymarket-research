# Hipótesis automáticas — 2026-07-21 04:35 UTC
_Generado por shadow_postmortem.py sobre 25955 resoluciones (PNL=+6325.80€)_
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.193 (n=832)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.173 (n=436)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` < `0.6262` → IC=+0.179 (n=1116)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6262 (IC base=+0.162)
...
- **PATRÓN** `dist_vwap_pct` < `0.8028` → IC=+0.122 (n=1175)
...
| ✅ GBM_LATE_15M | 6377 | +0.103 | +2142.74€ | 0 | 7 |
| ✅ GBM_LATE_15M#15min | 6377 | +0.103 | +2142.74€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3573 | +0.145 | +2089.14€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3573 | +0.145 | +2089.14€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 3555 | +0.095 | +1233.54€ | 0 | 6 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3555 | +0.095 | +1233.54€ | 0 | 0 |
...
| ✅ LATE_WINDOW_5MIN | 107 | +0.105 | +20.46€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 107 | +0.105 | +20.46€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 107 | +0.105 | +20.46€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 107 | +0.105 | +20.46€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 247 | +0.090 | +33.67€ | 1 | 8 |
| ✅ STREAK_FADE_15M#15min | 247 | +0.090 | +33.67€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2027 | +0.025 | +154.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1765 | +0.048 | +193.59€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 916 | +0.172 | +423.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 916 | +0.172 | +423.31€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.194: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.059 n=909 | neutral: IC=-0.002 n=685 | overbought(IBS>0.7): IC=+0.192 n=885
  - _Datos_: n=2654 IC=+0.095 PNL=+619.74€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.118 n=15642 | tras_1loss IC=+0.089 n=10111 | tras_2loss IC=+0.055 n=4115/40 | gap=+0.063 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1895 IC=+0.031 PNL=+169.25€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1895 IC=+0.031 PNL=+169.25€
...
**🔶 H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.105 n=107) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=107 IC=+0.105 PNL=+20.46€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=23491 IC=+0.119 PNL=+6400.64€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=23491 IC=+0.119 PNL=+6400.64€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=811 IC=+0.065 PNL=+121.71€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=811 IC=+0.065 PNL=+121.71€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=138 IC=+0.021 PNL=+15.22€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=138 IC=+0.021 PNL=+15.22€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.123 > 0.08 con n=520 PNL=+190.42€
  - _Datos_: n=520 IC=+0.123 PNL=+190.42€
