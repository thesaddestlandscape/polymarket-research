# Hipótesis automáticas — 2026-07-04 10:11 UTC
_Generado por shadow_postmortem.py sobre 3438 resoluciones (PNL=+45.52€)_
...
- **FILTRO** `delta_ratio_macro` |x|≤ `0.0712` → IC=-0.138 (n=45)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.0712
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 693 | +0.087 | +146.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 693 | +0.087 | +146.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 179 | +0.041 | +16.54€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 179 | +0.041 | +16.54€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 182 | +0.022 | +7.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 182 | +0.022 | +7.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 177 | +0.137 | +63.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 177 | +0.137 | +63.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 155 | +0.156 | +58.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 155 | +0.156 | +58.62€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 910 | -0.042 | -56.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 677 | -0.021 | -28.61€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 374 | -0.013 | +1.93€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 289 | +0.002 | +8.91€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.047) — sin ventaja clara. oversold(IBS<0.3): IC=-0.024 n=185 | neutral: IC=-0.071 n=152 | overbought(IBS>0.7): IC=-0.045 n=163
  - _Datos_: n=520 IC=-0.042 PNL=-31.68€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.020 n=1681 | tras_1loss IC=-0.018 n=1652 | tras_2loss IC=-0.037 n=838/40 | gap=+0.057 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=787 IC=-0.037 PNL=-43.37€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=787 IC=-0.037 PNL=-43.37€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=407 IC=-0.053 PNL=-47.09€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=407 IC=-0.053 PNL=-47.09€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=297 IC=-0.018 PNL=-32.91€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=297 IC=-0.018 PNL=-32.91€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1005 IC=+0.055 PNL=+131.08€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1005 IC=+0.055 PNL=+131.08€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.075 < -0.05 con n=549 PNL=-75.01€
  - _Datos_: n=549 IC=-0.075 PNL=-75.01€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 74/120 ops en el filtro definido (IC actual=+0.132 PNL=+13.64€)
  - _Datos_: n=74 IC=+0.132 PNL=+13.64€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=72 IC=-0.041 PNL=+11.47€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=72 IC=-0.041 PNL=+11.47€
