# Hipótesis automáticas — 2026-09-24 14:05 UTC
_Generado por shadow_postmortem.py sobre 589969 resoluciones (PNL=+66078.77€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.120 (n=477)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.120 (n=477)

  - _Acción_: Kelly boost +0.60€ cuando `py_entrada` < 0.495 (IC base=+0.046)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.133 (n=167)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 95.0 (IC base=+0.046)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.111 (n=348)
...
- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.142 (n=132)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 96.0 (IC base=+0.047)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.96` → IC=-0.234 (n=7021)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.96
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=21074)
...
- **FILTRO** `restante_s_al_confirmar` < `164.89` → IC=-0.226 (n=1681)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.89
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5048)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.203 (n=13771)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=3466)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5621.0485` → IC=+0.177 (n=2207)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2107)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `15975.8246` → IC=+0.241 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15975.8246 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1676)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.263 (n=1524)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.236 (n=1475)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `3729.7102` → IC=+0.232 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3729.7102 (IC base=+0.232)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.157 (n=455)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 11.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.140 (n=657)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=536)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `1302.9991` → IC=+0.150 (n=652)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=303)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.161)

- **PATRÓN** `py_entrada` > `0.735` → IC=+0.346 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.735 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.163 (n=188)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.02 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `1261.7454` → IC=+0.152 (n=225)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1261.7454 (IC base=+0.161)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.251 (n=822)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.246)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.246 (n=829)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.194 (n=5660)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `4093.3151` → IC=+0.314 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4093.3151 (IC base=+0.292)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.306 (n=338)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4254.7258` → IC=+0.304 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4254.7258 (IC base=+0.279)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.336 (n=369)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.07` → IC=+0.349 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.07 (IC base=+0.343)

- **PATRÓN** `libro_liquidez` > `720.8183` → IC=+0.378 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 720.8183 (IC base=+0.343)

### FAVORITO_CONFIRMADO_60MIN_EXTREMO
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.445 (n=341)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.439)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.444 (n=428)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.439)

- **PATRÓN** `py_entrada` < `0.935` → IC=+0.443 (n=503)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.935 (IC base=+0.439)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.447 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.439)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.441 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.439)

### FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.444 (n=232)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.935` → IC=+0.442 (n=241)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.451 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.444 (n=264)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4837` → IC=+0.122 (n=7984)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4837 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9835` → IC=+0.244 (n=2661)
...
- **PATRÓN** `dist_vwap_pct` < `0.634` → IC=+0.248 (n=2251)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.634 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.966` → IC=+0.177 (n=3061)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.966 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.246 (n=2152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0481` → IC=+0.258 (n=976)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0481 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3047` → IC=+0.218 (n=799)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3047 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.9076` → IC=+0.205 (n=3641)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9076 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.569` → IC=+0.134 (n=9629)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.569 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.6154` → IC=+0.193 (n=699)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.6154 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.174 (n=3063)
...
- **PATRÓN** `volumen_regimen` > `1.0548` → IC=+0.176 (n=1527)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5707` → IC=+0.201 (n=5056)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5707 (IC base=+0.065)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.211 (n=5445)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.268 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.270 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.122 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.2807` → IC=+0.206 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2807 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.4344` → IC=+0.163 (n=1689)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4344 (IC base=+0.160)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.248 (n=1214)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.241 (n=1227)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.234)

- **PATRÓN** `ibs_20min` < `0.0531` → IC=+0.293 (n=598)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.428` → IC=+0.246 (n=1409)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.428 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0922` → IC=+0.230 (n=1164)
...
- **PATRÓN** `volumen_spike_ratio` > `1.847` → IC=+0.236 (n=825)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.847 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1801.6295` → IC=+0.234 (n=905)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1801.6295 (IC base=+0.234)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.232 (n=1439)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.9894` → IC=+0.270 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9894 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` > `0.2016` → IC=+0.220 (n=727)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2016 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `0.5843` → IC=+0.219 (n=1441)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5843 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.83` → IC=+0.255 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.83 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` < `1.2525` → IC=+0.219 (n=1374)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2525 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `1.0825` → IC=+0.226 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0825 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` > `0.2785` → IC=+0.241 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2785 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` < `1.7475` → IC=+0.218 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7475 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.3728` → IC=+0.227 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3728 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `16028.2025` → IC=+0.225 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16028.2025 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.178 (n=482)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0026 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0766` → IC=+0.165 (n=478)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.0766 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` < `0.3234` → IC=+0.196 (n=955)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.3234 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1328` → IC=+0.157 (n=1283)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1328 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.254` → IC=+0.162 (n=229)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 11.254 (IC base=+0.139)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2115` → IC=+0.188 (n=1766)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2115 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.3609` → IC=+0.198 (n=233)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.3609 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.8411` → IC=+0.204 (n=762)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8411 (IC base=+0.186)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.153 (n=99)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=2204)

- **PATRÓN** `ibs_20min` > `0.9436` → IC=+0.219 (n=357)
...
- **PATRÓN** `dist_vwap_pct` < `0.7929` → IC=+0.330 (n=356)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7929 (IC base=+0.024)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.725` → IC=+0.158 (n=708)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.725 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` < `0.8561` → IC=+0.322 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8561 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` > `1.2014` → IC=+0.336 (n=108)
...
- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.329 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 163.0 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` > `0.1959` → IC=+0.181 (n=337)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1959 (IC base=+0.017)

- **PATRÓN** `volumen_regimen` < `0.8497` → IC=+0.163 (n=552)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8497 (IC base=+0.017)
...
- **PATRÓN** `volumen_spike_ratio` > `1.518` → IC=+0.176 (n=692)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.518 (IC base=+0.017)
...
- **FILTRO** `ibs_20min` > `0.2558` → IC=-0.125 (n=2169)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2558
  - _Potencial_: sin este filtro IC_bueno=+0.128 (n=1069)

- **FILTRO** `sigma_ewma_delta_pct` > `8.666` → IC=-0.211 (n=348)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.666
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2890)
...
- **PATRÓN** `ibs_20min` < `0.2558` → IC=+0.128 (n=1069)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.2558 (IC base=-0.041)
...
- **FILTRO** `drift_60min` |x|> `0.6598` → IC=-0.180 (n=561)
...
- **FILTRO** `ibs_20min` < `0.7101` → IC=-0.155 (n=1481)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=764)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.201 (n=409)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1836)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.202 (n=822)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=2481)

- **PATRÓN** `dist_vwap_pct` > `0.7895` → IC=+0.322 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7895 (IC base=-0.067)

- **PATRÓN** `dist_vwap_pct` < `0.2675` → IC=+0.314 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2675 (IC base=-0.067)

- **PATRÓN** `volumen_regimen` < `0.9855` → IC=+0.289 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9855 (IC base=-0.067)

- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.303 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6229 (IC base=-0.067)

- **PATRÓN** `volumen_pendiente_norm` < `0.1006` → IC=+0.296 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1006 (IC base=-0.067)

- **PATRÓN** `volumen_spike_ratio` < `1.4006` → IC=+0.302 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4006 (IC base=-0.067)

- **PATRÓN** `volumen_spike_ratio` > `1.8015` → IC=+0.294 (n=216)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.196 (n=3344)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0097 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4754` → IC=+0.189 (n=8940)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4754 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7669` → IC=+0.289 (n=1043)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7669 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.598` → IC=+0.156 (n=4724)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.598 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6894` → IC=+0.246 (n=3174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6894 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.296` → IC=+0.264 (n=847)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.296 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4663` → IC=+0.239 (n=1926)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4663 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6706` → IC=+0.238 (n=1925)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6706 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.266 (n=5288)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.153 (n=3331)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5472` → IC=+0.153 (n=8787)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.525` → IC=-0.157 (n=528)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.525
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1772)

- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.266 (n=689)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2229` → IC=+0.269 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2229 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `1.433` → IC=+0.176 (n=291)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.433 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` > `2.1457` → IC=+0.195 (n=395)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.1457 (IC base=+0.047)

- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.173 (n=377)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 14.0 (IC base=+0.047)
...
- **PATRÓN** `ibs_20min` > `0.859` → IC=+0.158 (n=668)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.859 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.1264` → IC=+0.171 (n=506)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1264 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6717` → IC=+0.163 (n=821)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4243` → IC=+0.199 (n=300)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4243 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `245.0` → IC=+0.192 (n=391)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1042` → IC=+0.258 (n=1339)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1042 (IC base=+0.245)

- **PATRÓN** `volumen_spike_ratio` > `3.4277` → IC=+0.261 (n=499)
...
- **PATRÓN** `libro_liquidez` > `1957.9172` → IC=+0.253 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1957.9172 (IC base=+0.245)
...
- **FILTRO** `ibs_20min` < `0.2847` → IC=-0.186 (n=488)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2847
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1467)

- **FILTRO** `ibs_20min` > `0.7745` → IC=-0.185 (n=592)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7745
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1778)

- **PATRÓN** `ibs_20min` > `0.9105` → IC=+0.180 (n=489)
...
- **PATRÓN** `dist_vwap_pct` < `0.2202` → IC=+0.207 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2202 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` < `0.9869` → IC=+0.234 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9869 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` > `0.5867` → IC=+0.211 (n=558)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5078` → IC=+0.261 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5078 (IC base=+0.011)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.242 (n=533)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.606` → IC=+0.162 (n=338)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 9.606 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` < `0.8726` → IC=+0.301 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8726 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `0.7299` → IC=+0.293 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7299 (IC base=+0.040)

- **PATRÓN** `volumen_pendiente_norm` < `0.1024` → IC=+0.291 (n=725)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2244` → IC=+0.297 (n=146)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2244 (IC base=+0.040)

- **PATRÓN** `volumen_spike_ratio` < `1.4267` → IC=+0.324 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4267 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.312 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.040)

- **PATRÓN** `ibs_20min` < `0.5789` → IC=+0.120 (n=1458)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.318 (n=866)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6319` → IC=+0.311 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6319 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.2044` → IC=+0.318 (n=766)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2044 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.574` → IC=+0.299 (n=686)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.574 (IC base=+0.277)

- **PATRÓN** `volumen_regimen` > `0.8621` → IC=+0.303 (n=865)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8621 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.321 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.277)

- **PATRÓN** `volumen_spike_ratio` > `2.1562` → IC=+0.293 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1562 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1390)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2627.455` → IC=+0.293 (n=865)
...
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.201 (n=2600)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0901` → IC=+0.186 (n=2601)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0901 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=8120)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5785` → IC=+0.217 (n=7800)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5785 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1757` → IC=+0.195 (n=3389)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1757 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.353` → IC=+0.254 (n=1599)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.353 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2119` → IC=+0.160 (n=5161)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2119 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6287` → IC=+0.161 (n=5161)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6287 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2959` → IC=+0.194 (n=1171)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2959 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5597` → IC=+0.169 (n=3292)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5597 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6244` → IC=+0.176 (n=2494)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6244 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2400.9842` → IC=+0.169 (n=5200)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2400.9842 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.180 (n=6723)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0812` → IC=+0.207 (n=2494)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.227 (n=7475)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4783 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9197` → IC=+0.145 (n=710)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9197 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.233` → IC=+0.158 (n=5449)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.233 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.348` → IC=+0.196 (n=1270)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.348 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1755` → IC=+0.151 (n=5418)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.188 (n=606)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0075 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.3439` → IC=+0.206 (n=1331)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3439 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=1400)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.8969` → IC=+0.275 (n=888)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8969 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.312 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.122 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.23` → IC=+0.231 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.23 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.179 (n=1230)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=1224)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4061` → IC=+0.227 (n=1161)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4061 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2116` → IC=+0.214 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2116 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.506` → IC=+0.237 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.506 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.164 (n=1161)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2629 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0753` → IC=+0.169 (n=526)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4994` → IC=+0.185 (n=496)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.4994 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `15946.6772` → IC=+0.165 (n=526)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 15946.6772 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.156 (n=1270)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5649` → IC=+0.186 (n=1270)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.5649 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1339` → IC=+0.160 (n=1261)
...
- **PATRÓN** `volumen_regimen` < `1.2129` → IC=+0.155 (n=1270)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2129 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1567` → IC=+0.154 (n=388)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1567 (IC base=+0.136)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4202` → IC=+0.135 (n=1158)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4202 (IC base=+0.136)
...
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.217 (n=437)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.2291` → IC=+0.215 (n=874)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2291 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1354)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.291 (n=698)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1321` → IC=+0.197 (n=510)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1321 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `1.6331` → IC=+0.199 (n=416)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6331 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.847` → IC=+0.210 (n=564)
...
- **PATRÓN** `libro_liquidez` > `1958.5384` → IC=+0.202 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1958.5384 (IC base=+0.197)
...
- **PATRÓN** `volumen_regimen` < `1.0413` → IC=+0.144 (n=1098)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0413 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6251` → IC=+0.148 (n=1248)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6251 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.2462` → IC=+0.194 (n=263)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2462 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.5375` → IC=+0.148 (n=538)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5375 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `2.529` → IC=+0.168 (n=408)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.529 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6488.9388` → IC=+0.183 (n=832)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6488.9388 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.146 (n=1186)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.137 (n=1438)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 5.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.5172` → IC=+0.203 (n=1407)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.76` → IC=+0.251 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.76 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.129 (n=1408)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2208 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` > `0.6434` → IC=+0.122 (n=1407)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6434 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0711` → IC=+0.123 (n=592)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.0711 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.5459` → IC=+0.140 (n=598)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.5459 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1474)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2891.4485` → IC=+0.198 (n=638)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2891.4485 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.135 (n=1084)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.214 (n=897)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.74` → IC=+0.262 (n=1203)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.74 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.506` → IC=+0.223 (n=638)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.506 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.241 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.204 (n=1347)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6232` → IC=+0.213 (n=1346)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6232 (IC base=+0.202)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1554` → IC=+0.213 (n=1144)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1554 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.5219` → IC=+0.208 (n=1162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5219 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1434)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2813.9876` → IC=+0.214 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2813.9876 (IC base=+0.202)
...
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.179 (n=619)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0088 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.0996` → IC=+0.153 (n=618)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3913` → IC=+0.179 (n=1853)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.3913 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.8726` → IC=+0.191 (n=286)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.8726 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.176 (n=850)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8743` → IC=+0.162 (n=1085)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8743 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.2081` → IC=+0.153 (n=542)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2081 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1652` → IC=+0.176 (n=513)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1652 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4385` → IC=+0.167 (n=596)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4385 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5431` → IC=+0.157 (n=595)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.5431 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2104)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12390.1326` → IC=+0.158 (n=618)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12390.1326 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.166 (n=1634)
...
- **PATRÓN** `libro_liquidez` > `12905.7647` → IC=+0.128 (n=415)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.254 (n=254)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.191)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.192 (n=193)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=601)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.191)

- **PATRÓN** `ibs_20min` > `0.7003` → IC=+0.243 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7003 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` > `0.9351` → IC=+0.226 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9351 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.884` → IC=+0.223 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.884 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` < `0.8389` → IC=+0.198 (n=385)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.8389 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` > `1.1584` → IC=+0.211 (n=192)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3991` → IC=+0.229 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3991 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.405` → IC=+0.224 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.405 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=640)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `12413.6269` → IC=+0.216 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12413.6269 (IC base=+0.191)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.181 (n=186)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0089 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.5281` → IC=+0.134 (n=410)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.5281 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.187 (n=298)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 11.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.204 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7333 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` > `0.6368` → IC=+0.216 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6368 (IC base=+0.130)
...
- **PATRÓN** `volumen_regimen` < `1.0697` → IC=+0.147 (n=361)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0697 (IC base=+0.130)

- **PATRÓN** `volumen_pendiente_norm` > `0.2872` → IC=+0.183 (n=58)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2872 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` > `2.2136` → IC=+0.172 (n=178)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.2136 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.133 (n=447)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.02 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `3071.8702` → IC=+0.191 (n=137)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 3071.8702 (IC base=+0.130)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.207 (n=3326)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=10390)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.216 (n=9975)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.9699` → IC=+0.207 (n=1386)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9699 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.634` → IC=+0.226 (n=4825)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.634 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8812` → IC=+0.164 (n=4441)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8812 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2401` → IC=+0.200 (n=1862)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2401 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.602` → IC=+0.187 (n=3193)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.602 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2342.8724` → IC=+0.172 (n=6644)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.8724 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.194 (n=7585)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 87.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.191 (n=6034)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1482` → IC=+0.189 (n=3982)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.238 (n=9049)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2485` → IC=+0.162 (n=5632)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2485 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.029` → IC=+0.202 (n=1267)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.029 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.732` → IC=+0.181 (n=8752)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.732 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.705` → IC=+0.161 (n=2738)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.705 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2043` → IC=+0.152 (n=2073)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6321` → IC=+0.192 (n=2766)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6321 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.192 (n=5333)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.221 (n=568)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.356` → IC=+0.191 (n=1693)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.323 (n=608)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2738` → IC=+0.256 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2738 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.5476` → IC=+0.184 (n=703)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.5476 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.5691` → IC=+0.199 (n=533)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=1193)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.258 (n=1213)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3478` → IC=+0.290 (n=1164)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3478 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.537` → IC=+0.263 (n=1325)
...
- **PATRÓN** `volumen_spike_ratio` > `2.635` → IC=+0.279 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.635 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1800.61` → IC=+0.262 (n=882)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0845` → IC=+0.161 (n=532)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0845 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1667)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3107` → IC=+0.204 (n=1596)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3107 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.3439` → IC=+0.196 (n=640)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.3439 (IC base=+0.150)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.242` → IC=+0.153 (n=1432)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2676` → IC=+0.206 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2676 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.1149` → IC=+0.162 (n=1356)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1149 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.7577` → IC=+0.156 (n=1027)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7577 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `15747.0266` → IC=+0.157 (n=724)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 15747.0266 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `476.0` → IC=+0.159 (n=1473)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 476.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1383)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.2566` → IC=+0.165 (n=1216)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2566 (IC base=+0.151)
...
- **PATRÓN** `ibs_20min` < `0.6522` → IC=+0.194 (n=1381)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.6522 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1343` → IC=+0.166 (n=1252)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1343 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.493` → IC=+0.160 (n=233)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.493 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.162 (n=1381)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1913 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1512` → IC=+0.196 (n=373)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1512 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.160 (n=1283)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `2.0974` → IC=+0.163 (n=582)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.0974 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `422.0` → IC=+0.158 (n=1044)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 422.0 (IC base=+0.151)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.245 (n=539)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=1688)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1643)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` > `0.67` → IC=+0.257 (n=1441)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.67 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.811` → IC=+0.294 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.811 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.2118` → IC=+0.221 (n=1593)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2118 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.8378` → IC=+0.240 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8378 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=1165)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1665` → IC=+0.237 (n=663)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1665 (IC base=+0.232)
...
- **PATRÓN** `ibs_20min` < `0.3594` → IC=+0.269 (n=1326)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3594 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.76` → IC=+0.276 (n=557)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4373` → IC=+0.146 (n=1697)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4373 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.151 (n=1773)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.877` → IC=+0.262 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.877 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.5842` → IC=+0.167 (n=470)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.5842 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.201` → IC=+0.161 (n=708)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.201 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8748` → IC=+0.154 (n=1132)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8748 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2374` → IC=+0.215 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2374 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5223` → IC=+0.149 (n=724)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5223 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.767` → IC=+0.150 (n=1095)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.767 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8024.5486` → IC=+0.233 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8024.5486 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.147 (n=528)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 79.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.156 (n=1391)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0076 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.4484` → IC=+0.154 (n=1389)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7027` → IC=+0.184 (n=1389)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.7027 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.6029` → IC=+0.144 (n=1542)
...
- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.146 (n=1317)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 179.0 (IC base=+0.138)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.135 (n=1123)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0081 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1729)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.189 (n=1687)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4706 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `1.0764` → IC=+0.202 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0764 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.485` → IC=+0.232 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.485 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.8929` → IC=+0.132 (n=1124)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8929 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1696)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.248 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.110)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.129 (n=1297)
...
- **PATRÓN** `drift_60min` |x|≤ `0.132` → IC=+0.161 (n=549)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.132 (IC base=+0.112)
...
- **PATRÓN** `dist_vwap_pct` < `0.2197` → IC=+0.130 (n=1350)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2197 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.474` → IC=+0.124 (n=1591)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.474 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.717` → IC=+0.153 (n=725)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.717 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2234` → IC=+0.165 (n=255)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2234 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4462` → IC=+0.142 (n=495)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4462 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.5044` → IC=+0.128 (n=495)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 2.5044 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2831.1065` → IC=+0.166 (n=549)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2831.1065 (IC base=+0.112)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.219 (n=1123)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1754)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.210 (n=1511)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.250 (n=1687)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` > `0.2019` → IC=+0.235 (n=989)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2019 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.275` → IC=+0.268 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.275 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` < `1.0672` → IC=+0.211 (n=1483)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0672 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.6382` → IC=+0.216 (n=1685)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6382 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.235` → IC=+0.247 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.235 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.5107` → IC=+0.239 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5107 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1774)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `2624.5942` → IC=+0.222 (n=1123)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2624.5942 (IC base=+0.209)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=3013)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.157 (n=2526)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0092 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.150 (n=2567)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5223` → IC=+0.159 (n=2871)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.942` → IC=+0.209 (n=957)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.942 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1868` → IC=+0.157 (n=1044)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1868 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4917` → IC=+0.143 (n=1756)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.4917 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.187` → IC=+0.176 (n=470)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 10.187 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.9005` → IC=+0.159 (n=1240)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.9005 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1717` → IC=+0.182 (n=785)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1717 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.4575` → IC=+0.158 (n=946)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4575 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8851` → IC=+0.161 (n=1890)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8851 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3758.564` → IC=+0.151 (n=1914)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3758.564 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.196 (n=760)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0038 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4905` → IC=+0.154 (n=2272)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.184` → IC=+0.169 (n=1000)
...
- **PATRÓN** `dist_vwap_pct` < `0.4314` → IC=+0.130 (n=2257)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4314 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.273` → IC=+0.147 (n=2262)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.273 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2467` → IC=+0.142 (n=2170)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2467 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` < `0.0972` → IC=+0.138 (n=2055)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` < 0.0972 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0732` → IC=+0.143 (n=1052)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.0732 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.4255` → IC=+0.151 (n=748)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4255 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.813` → IC=+0.141 (n=1495)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.813 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=3013)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `7124.482` → IC=+0.151 (n=2029)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7124.482 (IC base=+0.137)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.163 (n=253)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0043 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.172 (n=126)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0065 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.0895` → IC=+0.192 (n=128)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.0895 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=380)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.5452` → IC=+0.186 (n=253)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.5452 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.2158` → IC=+0.156 (n=178)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2158 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.3825` → IC=+0.158 (n=369)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.3825 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.403` → IC=+0.163 (n=402)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 2.403 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.2719` → IC=+0.153 (n=379)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2719 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.8487` → IC=+0.185 (n=252)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.8487 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4501` → IC=+0.182 (n=127)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.4501 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `2.6755` → IC=+0.203 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6755 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `12465.6116` → IC=+0.194 (n=338)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 12465.6116 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.153 (n=796)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0073 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.161 (n=904)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0043 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.3878` → IC=+0.155 (n=795)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5636` → IC=+0.156 (n=603)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.5636 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.7889` → IC=+0.163 (n=410)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.7889 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.9756` → IC=+0.163 (n=200)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.9756 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.4258` → IC=+0.163 (n=849)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.4258 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.676` → IC=+0.160 (n=905)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.676 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.8944` → IC=+0.155 (n=604)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8944 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.7181` → IC=+0.155 (n=807)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7181 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` < `0.1099` → IC=+0.153 (n=835)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.1099 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.0788` → IC=+0.159 (n=388)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0788 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `1.4358` → IC=+0.167 (n=295)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4358 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.157 (n=892)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.156 (n=678)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0071 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.3946` → IC=+0.169 (n=677)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7363` → IC=+0.143 (n=769)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.7363 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.0998` → IC=+0.147 (n=769)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.0998 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6442` → IC=+0.169 (n=164)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.6442 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.3871` → IC=+0.140 (n=789)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3871 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.639` → IC=+0.145 (n=792)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.639 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.647` → IC=+0.172 (n=257)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.647 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.7259` → IC=+0.140 (n=687)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.7259 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0742` → IC=+0.167 (n=325)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0742 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.1956` → IC=+0.155 (n=664)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.1956 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.7807` → IC=+0.145 (n=503)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7807 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `7577.2758` → IC=+0.165 (n=769)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 7577.2758 (IC base=+0.139)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `ibs_20min` > `0.5469` → IC=+0.142 (n=224)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.5469 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.1868` → IC=+0.126 (n=153)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.1868 (IC base=+0.087)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1583` → IC=+0.218 (n=69)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1583 (IC base=+0.087)

- **PATRÓN** `libro_liquidez` > `3427.7149` → IC=+0.144 (n=200)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 3427.7149 (IC base=+0.087)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.192 (n=401)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0041 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.129 (n=845)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 8.0 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.6741` → IC=+0.207 (n=731)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6741 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.1542` → IC=+0.161 (n=440)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1542 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.443` → IC=+0.205 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.443 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.201 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.0912` → IC=+0.137 (n=621)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.0912 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.121 (n=658)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2424.4386` → IC=+0.144 (n=360)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.164 (n=310)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.006 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.126 (n=324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 6.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` > `0.52` → IC=+0.187 (n=279)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.52 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.1366` → IC=+0.187 (n=145)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1366 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.517` → IC=+0.123 (n=168)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 3.517 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `1.0669` → IC=+0.125 (n=246)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.0669 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` < `0.0678` → IC=+0.139 (n=214)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` < 0.0678 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` > `0.2771` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.2771 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.178 (n=212)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.107)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=291)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `4122.3752` → IC=+0.126 (n=121)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 4122.3752 (IC base=+0.107)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.181 (n=136)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.004 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.135 (n=291)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3477` → IC=+0.170 (n=110)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3477 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.742` → IC=+0.303 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.742 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `0.9419` → IC=+0.141 (n=126)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.9419 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.2818` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2818 (IC base=+0.105)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.131 (n=204)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 13.0 (IC base=+0.074)

- **PATRÓN** `ibs_20min` > `0.6719` → IC=+0.182 (n=234)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.6719 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.1982` → IC=+0.158 (n=147)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1982 (IC base=+0.074)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.497` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.497 (IC base=+0.074)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2825` → IC=+0.186 (n=33)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2825 (IC base=+0.074)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `libro_liquidez` > `2918.2518` → IC=+0.168 (n=233)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2918.2518 (IC base=+0.104)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1742)
...
- **PATRÓN** `liq_usd_total` > `74841.37` → IC=+0.156 (n=91)

  - _Acción_: Kelly boost +0.78€ cuando `liq_usd_total` > 74841.37 (IC base=+0.033)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.156 (n=88)

  - _Acción_: Kelly boost +0.78€ cuando `py_entrada` < 0.495 (IC base=+0.033)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.144 (n=99)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=391)

- **PATRÓN** `py_entrada` < `0.48` → IC=+0.153 (n=122)

  - _Acción_: Kelly boost +0.77€ cuando `py_entrada` < 0.48 (IC base=+0.010)

- **PATRÓN** `profundidad_ratio` > `100.0` → IC=+0.150 (n=121)

  - _Acción_: Kelly boost +0.75€ cuando `profundidad_ratio` > 100.0 (IC base=+0.010)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` < `0.52` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` < 0.52 (IC base=+0.061)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.154 (n=24)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 15.0 (IC base=+0.061)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.222 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.59 (IC base=+0.125)

- **PATRÓN** `restante_min` > `2.92` → IC=+0.139 (n=59)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` > 2.92 (IC base=+0.125)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.196 (n=21)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 8.0 (IC base=+0.125)

- **PATRÓN** `lag_apertura_s` < `60.77` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 60.77 (IC base=+0.125)

- **PATRÓN** `profundidad_ratio` > `46.0` → IC=+0.205 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio` > 46.0 (IC base=+0.125)

### LIQUIDACIONES_DEPTH_FASE0#DOGE#15min
- **FILTRO** `profundidad_ratio` < `26.6` → IC=-0.167 (n=25)
...
- **FILTRO** `restante_min` < `12.89` → IC=-0.227 (n=20)

  - _Acción_: SKIP cuando `restante_min` < 12.89
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=21)

- **FILTRO** `hora_utc` < `15.0` → IC=-0.192 (n=24)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=17)

- **FILTRO** `lag_apertura_s` > `126.34` → IC=-0.227 (n=20)
...
- **FILTRO** `lag_apertura_s` > `93.56` → IC=-0.333 (n=16)

  - _Acción_: SKIP cuando `lag_apertura_s` > 93.56
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=32)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=16)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.011)

- **PATRÓN** `profundidad_ratio` > `44.1` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `profundidad_ratio` > 44.1 (IC base=+0.011)
...
- **FILTRO** `py_entrada` > `0.49` → IC=-0.143 (n=26)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7489)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.165 (n=3493)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10512)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.166 (n=3622)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=10893)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.152 (n=641)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1957)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.189 (n=612)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=1862)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=634)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=1962)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.172 (n=598)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1818)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.175 (n=635)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1963)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2749)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9940)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=22169)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7840)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=24269)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.235 (n=8025)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=24084)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10908)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21201)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9884)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=30378)

- **FILTRO** `ibs_7min` > `0.2925` → IC=-0.178 (n=10065)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2925
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=30197)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.135 (n=1628)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3681)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1265)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4044)

- **FILTRO** `ibs_7min` < `0.7109` → IC=-0.249 (n=1751)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7109
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3558)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.184 (n=1220)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4089)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.260 (n=1709)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5204)

- **FILTRO** `drift_7min_pct` |x|> `0.1122` → IC=-0.125 (n=2348)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1122
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4565)

- **FILTRO** `ibs_7min` > `0.789` → IC=-0.205 (n=1728)

  - _Acción_: SKIP cuando `ibs_7min` > 0.789
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=5185)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4246)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1337)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4208)

- **FILTRO** `ibs_7min` < `0.7478` → IC=-0.192 (n=1386)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7478
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4159)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1380)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4165)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1404)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=4224)

- **FILTRO** `ibs_7min` > `0.2602` → IC=-0.176 (n=1406)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2602
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4222)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.181 (n=1406)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4222)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1430)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3609)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1236)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3803)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.259 (n=1256)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3783)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1169)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3870)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1691)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5709)

- **FILTRO** `ibs_7min` > `0.7442` → IC=-0.175 (n=1849)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7442
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=5551)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1705)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3589)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.231 (n=1566)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3728)

- **FILTRO** `ibs_7min` < `0.7409` → IC=-0.181 (n=1323)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7409
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3971)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.169 (n=1304)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3990)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.265 (n=1196)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=4211)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.175 (n=1351)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4056)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.184 (n=1342)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4065)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.257 (n=1361)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4240)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.239 (n=1396)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4205)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1825)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=5832)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1715)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3606)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.228 (n=1317)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=4004)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1294)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4027)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.205 (n=1738)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5519)
...
- **FILTRO** `pct_vs_K` |x|> `1.6258` → IC=-0.382 (n=66)
...
- **PATRÓN** `streak_estiramiento` < `0.5606` → IC=+0.164 (n=126)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `streak_estiramiento` < 0.5606 (IC base=+0.036)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=394)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2888)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.219 (n=720)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0085 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0507` → IC=+0.205 (n=530)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0507 (IC base=+0.186)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2136` → IC=+0.196 (n=530)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.98€ cuando `delta_ratio_macro` |x|> 0.2136 (IC base=+0.186)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1262` → IC=+0.233 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1262 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.196 (n=1482)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6061` → IC=+0.265 (n=1588)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6061 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.1585` → IC=+0.189 (n=725)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.1585 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.6134` → IC=+0.177 (n=1530)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6134 (IC base=+0.186)
...
- **PATRÓN** `libro_liquidez` > `2975.1342` → IC=+0.195 (n=1059)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2975.1342 (IC base=+0.186)

### UPDOWN_GBM#60min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=604)

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.217 (n=362)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.237 (n=336)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.207)

- **PATRÓN** `ibs_15` > `0.7061` → IC=+0.272 (n=362)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0675` → IC=+0.202 (n=169)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0675 (IC base=+0.172)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2704` → IC=+0.224 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2704 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.207 (n=131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.172)

- **PATRÓN** `ibs_15` > `0.6111` → IC=+0.259 (n=189)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6111 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` > `0.1219` → IC=+0.200 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1219 (IC base=+0.172)
...
- **PATRÓN** `libro_liquidez` > `3071.8702` → IC=+0.273 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3071.8702 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `34.0` → IC=+0.226 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 34.0 (IC base=+0.172)
...
- **PATRÓN** `ibs_15` < `0.1163` → IC=+0.160 (n=469)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `ibs_15` < 0.1163 (IC base=+0.047)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.218 (n=653)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1960)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.190 (n=883)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1730)

- **FILTRO** `libro_liquidez` < `3914.9244` → IC=-0.136 (n=1724)

  - _Acción_: SKIP cuando `libro_liquidez` < 3914.9244
  - _Potencial_: sin este filtro IC_bueno=+0.088 (n=889)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1771` → IC=+0.235 (n=1114)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1771 (IC base=-0.034)

- **PATRÓN** `ibs_15` < `0.3453` → IC=+0.278 (n=1726)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3453 (IC base=-0.034)

- **PATRÓN** `dist_vwap_pct` > `0.6896` → IC=+0.287 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6896 (IC base=-0.034)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.219 (n=397)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1194)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.229 (n=397)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1194)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=1006)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.178 (n=585)

- **FILTRO** `sigma_ewma_delta_pct` > `19.796` → IC=-0.247 (n=287)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19