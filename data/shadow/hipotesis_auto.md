# Hipótesis automáticas — 2026-09-13 13:17 UTC
_Generado por shadow_postmortem.py sobre 420109 resoluciones (PNL=+44478.15€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.2` → IC=-0.263 (n=5347)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.2
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=16043)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.128 (n=1858)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.104 (n=1146)

- **FILTRO** `restante_s_al_confirmar` < `140.51` → IC=-0.283 (n=751)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.51
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2253)
...
- **FILTRO** `restante_s_al_confirmar` < `144.38` → IC=-0.159 (n=1380)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.38
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=4142)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.44` → IC=-0.255 (n=1232)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.44
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=3699)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.21` → IC=-0.346 (n=1345)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.21
  - _Potencial_: sin este filtro IC_bueno=-0.102 (n=2731)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.143 (n=82)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=94)

### CANDIDATA9_BOT_CONSENSO#BTC#5min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.293 (n=27)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=86)

- **PATRÓN** `py_entrada` > `0.52` → IC=+0.130 (n=44)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` > 0.52 (IC base=+0.032)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.199 (n=10018)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=2707)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `11005.4433` → IC=+0.193 (n=865)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 11005.4433 (IC base=+0.096)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.246 (n=7286)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.173 (n=5343)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `4705.0519` → IC=+0.174 (n=2305)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 4705.0519 (IC base=+0.137)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.354 (n=566)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=1557)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `13134.0888` → IC=+0.208 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13134.0888 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1263)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.270 (n=1103)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1616)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `12629.1143` → IC=+0.207 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12629.1143 (IC base=+0.204)
...
- **PATRÓN** `py_entrada` < `0.425` → IC=+0.165 (n=541)
...
- **PATRÓN** `py_entrada` < `0.305` → IC=+0.329 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.305 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.239 (n=1104)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=528)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.123)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.133 (n=456)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 15.0 (IC base=+0.123)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.225 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.123)
...
- **PATRÓN** `libro_liquidez` > `2022.4564` → IC=+0.160 (n=336)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2022.4564 (IC base=+0.123)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2025)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2117)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.182 (n=4539)
...
- **PATRÓN** `lag_apertura_s` < `2.89` → IC=+0.149 (n=1731)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 2.89 (IC base=+0.119)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9742` → IC=+0.228 (n=1860)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9742 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.2069` → IC=+0.243 (n=1149)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2069 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.83` → IC=+0.165 (n=2153)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.83 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `0.612` → IC=+0.254 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.612 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.240 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0678 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.0811` → IC=+0.190 (n=3254)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.0811 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.11` → IC=+0.191 (n=1399)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.11 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.8557` → IC=+0.190 (n=3608)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.8557 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.4711` → IC=+0.193 (n=3609)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4711 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5743` → IC=+0.125 (n=6870)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.5743 (IC base=+0.057)

- **PATRÓN** `dist_vwap_pct` < `0.1309` → IC=+0.164 (n=2059)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1309 (IC base=+0.057)

- **PATRÓN** `volumen_regimen` < `1.2033` → IC=+0.161 (n=2140)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2033 (IC base=+0.057)

- **PATRÓN** `volumen_regimen` > `0.8688` → IC=+0.164 (n=1427)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.8688 (IC base=+0.057)

- **PATRÓN** `volumen_pendiente_norm` > `0.1694` → IC=+0.225 (n=1049)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1694 (IC base=+0.057)

- **PATRÓN** `volumen_spike_ratio` > `1.4644` → IC=+0.195 (n=3561)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4644 (IC base=+0.057)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.205 (n=3324)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 164.0 (IC base=+0.057)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.269 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.032` → IC=+0.283 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.032 (IC base=+0.166)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6357` → IC=+0.155 (n=1146)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.6357 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.161 (n=1146)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.181 (n=1334)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.06 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.187 (n=901)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 63.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.237 (n=821)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1923` → IC=+0.279 (n=622)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1923 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.251 (n=633)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.0621` → IC=+0.284 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0621 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.377` → IC=+0.249 (n=971)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.377 (IC base=+0.237)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2878` → IC=+0.290 (n=117)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2878 (IC base=+0.237)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.240 (n=938)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1576.58` → IC=+0.248 (n=833)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1576.58 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.230 (n=769)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 65.0 (IC base=+0.237)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.233 (n=417)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.003 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.1109` → IC=+0.237 (n=417)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1109 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.229 (n=991)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1985` → IC=+0.217 (n=475)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1985 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.919` → IC=+0.233 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.919 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.223 (n=946)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2628 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.8755` → IC=+0.212 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8755 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.1002` → IC=+0.211 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1002 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4924` → IC=+0.227 (n=405)
...
- **PATRÓN** `ibs_20min` < `0.5415` → IC=+0.179 (n=892)
...
- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.149 (n=1014)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1954 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1564` → IC=+0.200 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1564 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.4168` → IC=+0.154 (n=905)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4168 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.4138` → IC=+0.149 (n=905)
...
- **PATRÓN** `ballena_activa_n` < `219.0` → IC=+0.167 (n=274)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 219.0 (IC base=+0.139)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=1225)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.374` → IC=+0.228 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.374 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1071` → IC=+0.185 (n=1024)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1071 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.3774` → IC=+0.173 (n=160)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.3774 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `1.6638` → IC=+0.183 (n=1136)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.6638 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=1377)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.195 (n=326)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 16.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.221 (n=1053)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.1135` → IC=+0.217 (n=351)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1135 (IC base=+0.213)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3042` → IC=+0.219 (n=617)
...
- **PATRÓN** `libro_liquidez` > `1892.3232` → IC=+0.228 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1892.3232 (IC base=+0.213)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.215 (n=387)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=87)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1550)
...
- **PATRÓN** `volumen_regimen` < `1.0344` → IC=+0.147 (n=414)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0344 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.136 (n=470)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4999` → IC=+0.167 (n=376)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4999 (IC base=-0.007)
...
- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.126 (n=1593)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.111 (n=799)

- **FILTRO** `sigma_ewma_delta_pct` > `8.602` → IC=-0.198 (n=263)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.602
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2129)
...
- **PATRÓN** `dist_vwap_pct` > `0.7032` → IC=+0.254 (n=63)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7032 (IC base=-0.030)

- **PATRÓN** `dist_vwap_pct` < `0.2364` → IC=+0.233 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2364 (IC base=-0.030)
...
- **PATRÓN** `volumen_spike_ratio` < `2.24` → IC=+0.248 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.24 (IC base=-0.030)

- **PATRÓN** `volumen_spike_ratio` > `1.5824` → IC=+0.226 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5824 (IC base=-0.030)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.228 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 36.0 (IC base=-0.030)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.169 (n=2318)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0091 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.4545` → IC=+0.171 (n=6213)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4545 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.6974` → IC=+0.270 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6974 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.487` → IC=+0.137 (n=3294)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 3.487 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` > `0.6734` → IC=+0.227 (n=2086)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6734 (IC base=+0.084)

- **PATRÓN** `volumen_pendiente_norm` > `0.2498` → IC=+0.251 (n=732)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2498 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `1.4805` → IC=+0.235 (n=1232)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4805 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` > `2.8023` → IC=+0.229 (n=1232)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8023 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.275 (n=3177)
...
- **PATRÓN** `ibs_20min` < `0.5603` → IC=+0.147 (n=6310)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.5603 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` > `0.6602` → IC=+0.243 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6602 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `1.1975` → IC=+0.252 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1975 (IC base=+0.066)

- **PATRÓN** `volumen_pendiente_norm` > `0.2507` → IC=+0.321 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2507 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` < `1.6198` → IC=+0.251 (n=1064)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6198 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` > `2.3762` → IC=+0.256 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3762 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.255 (n=2268)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.066)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3469` → IC=-0.123 (n=621)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3469
  - _Potencial_: sin este filtro IC_bueno=+0.116 (n=1262)

- **FILTRO** `sigma_ewma_delta_pct` > `4.316` → IC=-0.159 (n=364)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.316
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1199)

- **PATRÓN** `ibs_20min` > `0.8545` → IC=+0.251 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8545 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.0` → IC=+0.161 (n=494)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8686` → IC=+0.196 (n=310)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.8686 (IC base=+0.037)
...
- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.215 (n=377)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7706` → IC=+0.225 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7706 (IC base=-0.003)

- **PATRÓN** `volumen_spike_ratio` > `1.4319` → IC=+0.212 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4319 (IC base=-0.003)

- **PATRÓN** `ballena_activa_n` < `514.0` → IC=+0.213 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 514.0 (IC base=-0.003)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.267 (n=993)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.0948` → IC=+0.245 (n=371)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.601` → IC=+0.277 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.601 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.1116` → IC=+0.257 (n=917)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1116 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `1.681` → IC=+0.242 (n=1025)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.681 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.257 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1910.8884` → IC=+0.242 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1910.8884 (IC base=+0.238)
...
- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.287 (n=881)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.611` → IC=+0.280 (n=948)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.611 (IC base=+0.280)
...
- **PATRÓN** `volumen_spike_ratio` < `3.38` → IC=+0.274 (n=786)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.38 (IC base=+0.280)

- **PATRÓN** `volumen_spike_ratio` > `2.228` → IC=+0.285 (n=524)
...
- **PATRÓN** `libro_liquidez` > `1882.4784` → IC=+0.297 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1882.4784 (IC base=+0.280)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.281 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 26.0 (IC base=+0.280)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2234` → IC=-0.210 (n=305)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2234
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=918)

- **FILTRO** `ibs_20min` > `0.8269` → IC=-0.176 (n=415)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8269
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1250)

- **PATRÓN** `ibs_20min` > `0.7984` → IC=+0.132 (n=416)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` > 0.7984 (IC base=-0.026)

- **PATRÓN** `dist_vwap_pct` > `0.4602` → IC=+0.224 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4602 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` < `0.9231` → IC=+0.192 (n=219)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.9231 (IC base=-0.026)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5053` → IC=+0.262 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5053 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `175.0` → IC=+0.220 (n=223)
...
- **PATRÓN** `volumen_regimen` < `1.0874` → IC=+0.149 (n=172)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.0874 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` > `0.6828` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6828 (IC base=-0.026)
...
- **PATRÓN** `ibs_20min` > `0.6634` → IC=+0.244 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6634 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` > `0.1797` → IC=+0.307 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1797 (IC base=+0.024)
...
- **PATRÓN** `ibs_20min` < `0.2051` → IC=+0.169 (n=535)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.2051 (IC base=-0.000)

- **PATRÓN** `dist_vwap_pct` > `0.5359` → IC=+0.183 (n=58)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.5359 (IC base=-0.000)

- **PATRÓN** `volumen_regimen` < `0.7144` → IC=+0.241 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7144 (IC base=-0.000)

- **PATRÓN** `volumen_pendiente_norm` < `0.1007` → IC=+0.188 (n=261)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1007 (IC base=-0.000)

- **PATRÓN** `volumen_pendiente_norm` > `0.2193` → IC=+0.208 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2193 (IC base=-0.000)

- **PATRÓN** `volumen_spike_ratio` < `2.629` → IC=+0.203 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.629 (IC base=-0.000)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.215 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=-0.000)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0145` → IC=+0.319 (n=650)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.8983` → IC=+0.330 (n=650)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.339` → IC=+0.289 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.339 (IC base=+0.262)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.737` → IC=+0.262 (n=1068)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.737 (IC base=+0.262)

- **PATRÓN** `volumen_regimen` > `0.8495` → IC=+0.287 (n=650)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8495 (IC base=+0.262)

- **PATRÓN** `volumen_pendiente_norm` < `0.1112` → IC=+0.265 (n=849)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5522` → IC=+0.274 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5522 (IC base=+0.262)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.267 (n=1019)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.262)

- **PATRÓN** `libro_liquidez` > `2572.5002` → IC=+0.267 (n=650)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2572.5002 (IC base=+0.262)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.176 (n=1860)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0047 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.201 (n=1857)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.332` → IC=+0.174 (n=4888)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.332 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=5808)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.6944` → IC=+0.229 (n=4963)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6944 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1603` → IC=+0.196 (n=2415)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1603 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.217` → IC=+0.250 (n=1145)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.217 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2181` → IC=+0.161 (n=3715)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2181 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6214` → IC=+0.158 (n=3714)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6214 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.1067` → IC=+0.186 (n=2167)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1067 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.311` → IC=+0.168 (n=4628)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.311 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3822.4537` → IC=+0.172 (n=1852)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3822.4537 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.183 (n=4466)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 126.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.188 (n=3595)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0063 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0786` → IC=+0.206 (n=1792)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4532` → IC=+0.226 (n=5376)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4532 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.732` → IC=+0.190 (n=2237)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 3.732 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1885` → IC=+0.157 (n=3937)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1885 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6248` → IC=+0.153 (n=3936)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8819` → IC=+0.169 (n=3154)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.8819 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.641` → IC=+0.178 (n=1577)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.641 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `130.0` → IC=+0.171 (n=4337)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.206 (n=423)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3176` → IC=+0.207 (n=930)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.302 (n=453)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2555` → IC=+0.178 (n=738)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.2555 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `1.5436` → IC=+0.182 (n=749)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.5436 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.213 (n=834)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.203 (n=581)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.245 (n=591)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.247 (n=669)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.242 (n=610)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.237)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.242 (n=673)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.1082` → IC=+0.266 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1082 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.964` → IC=+0.249 (n=724)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8747` → IC=+0.251 (n=399)
...
- **PATRÓN** `libro_liquidez` > `1583.66` → IC=+0.250 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1583.66 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.234 (n=563)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3591` → IC=+0.175 (n=801)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3591 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.190 (n=724)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 8.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.45` → IC=+0.221 (n=801)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.45 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.2093` → IC=+0.215 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2093 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.757` → IC=+0.235 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.757 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `1.2757` → IC=+0.176 (n=801)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 1.2757 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.2377` → IC=+0.191 (n=173)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2377 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` < `1.4112` → IC=+0.203 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4112 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `11247.6748` → IC=+0.189 (n=715)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 11247.6748 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `412.0` → IC=+0.161 (n=636)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 412.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.180 (n=808)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0049 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.287` → IC=+0.171 (n=918)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.287 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.168 (n=847)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.5111` → IC=+0.194 (n=918)
...
- **PATRÓN** `volumen_regimen` < `1.2025` → IC=+0.169 (n=918)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4386` → IC=+0.162 (n=809)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4386 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4146` → IC=+0.155 (n=809)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4146 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `235.0` → IC=+0.153 (n=243)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 235.0 (IC base=+0.151)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1929` → IC=+0.197 (n=608)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.553` → IC=+0.269 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.553 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` < `0.1074` → IC=+0.187 (n=742)
...
- **PATRÓN** `ibs_20min` < `0.3506` → IC=+0.252 (n=771)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3506 (IC base=+0.221)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.695` → IC=+0.269 (n=314)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8317` → IC=+0.210 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8317 (IC base=+0.221)

- **PATRÓN** `volumen_spike_ratio` > `2.2531` → IC=+0.231 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2531 (IC base=+0.221)

- **PATRÓN** `libro_liquidez` > `1890.8984` → IC=+0.241 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1890.8984 (IC base=+0.221)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.207 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 24.0 (IC base=+0.221)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.182 (n=768)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.4224` → IC=+0.168 (n=871)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.4224 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.167 (n=875)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 6.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.4158` → IC=+0.205 (n=870)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4158 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.1317` → IC=+0.189 (n=574)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.1317 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.299` → IC=+0.247 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.299 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `0.8664` → IC=+0.164 (n=581)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.236 (n=138)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.155)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5308` → IC=+0.181 (n=283)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.5308 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `7552.1408` → IC=+0.192 (n=580)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 7552.1408 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.163 (n=711)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 158.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.161 (n=826)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.006 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.3736` → IC=+0.149 (n=938)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3736 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=372)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 17.0 (IC base=+0.129)

- **PATRÓN** `ibs_20min` < `0.5944` → IC=+0.179 (n=938)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.5944 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.1469` → IC=+0.143 (n=941)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1469 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.174` → IC=+0.202 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.174 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` < `0.8624` → IC=+0.142 (n=626)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8624 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` > `0.6135` → IC=+0.134 (n=938)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6135 (IC base=+0.129)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7863` → IC=+0.134 (n=550)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.7863 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` > `2.4566` → IC=+0.146 (n=275)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 2.4566 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `9896.1185` → IC=+0.151 (n=425)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 9896.1185 (IC base=+0.129)

- **PATRÓN** `ballena_activa_n` < `187.0` → IC=+0.123 (n=756)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 187.0 (IC base=+0.129)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=1079)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.5111` → IC=+0.195 (n=1047)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1575` → IC=+0.120 (n=885)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 2.1575 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=1065)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `3131.3446` → IC=+0.212 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3131.3446 (IC base=+0.110)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.135 (n=751)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 49.0 (IC base=+0.110)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.155 (n=450)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0058 (IC base=+0.116)

- **PATRÓN** `drift_60min` |x|≤ `0.097` → IC=+0.141 (n=341)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5273` → IC=+0.205 (n=1022)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5273 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.307` → IC=+0.153 (n=217)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 7.307 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `1.0503` → IC=+0.128 (n=899)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0503 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` > `0.2724` → IC=+0.188 (n=123)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2724 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `1.5679` → IC=+0.123 (n=388)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 1.5679 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` > `2.1514` → IC=+0.142 (n=400)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.1514 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `3086.3351` → IC=+0.156 (n=341)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3086.3351 (IC base=+0.116)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.208 (n=665)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0175 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.1642` → IC=+0.217 (n=439)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1642 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=1037)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.249 (n=892)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.289` → IC=+0.234 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.289 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `1.1991` → IC=+0.201 (n=997)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1991 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `0.686` → IC=+0.208 (n=891)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.686 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.2409` → IC=+0.258 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2409 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `2.2072` → IC=+0.213 (n=841)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2072 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.4285` → IC=+0.203 (n=956)
...
- **PATRÓN** `ibs_20min` < `0.4309` → IC=+0.236 (n=1060)
...
- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.215 (n=1060)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2566` → IC=+0.194 (n=816)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2566 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4604` → IC=+0.188 (n=927)
...
- **PATRÓN** `libro_liquidez` > `2509.5314` → IC=+0.211 (n=707)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2509.5314 (IC base=+0.200)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.145 (n=435)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0038 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.156 (n=434)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0085 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0941` → IC=+0.153 (n=433)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4091` → IC=+0.168 (n=1298)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.4091 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.7872` → IC=+0.190 (n=169)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.7872 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.699` → IC=+0.175 (n=586)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.699 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.161 (n=741)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8615 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1672` → IC=+0.164 (n=355)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1672 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.148 (n=413)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.8231` → IC=+0.154 (n=825)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.8231 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.147 (n=1434)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.02 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `8121.9037` → IC=+0.173 (n=589)
...
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.147 (n=449)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0036 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.4893` → IC=+0.142 (n=1185)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.4893 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.824` → IC=+0.127 (n=534)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1661` → IC=+0.147 (n=346)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.1661 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` < `2.2321` → IC=+0.126 (n=1127)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.2321 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.137 (n=406)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.251 (n=175)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=415)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.207)

- **PATRÓN** `ibs_20min` > `0.277` → IC=+0.245 (n=398)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.949` → IC=+0.248 (n=169)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=430)
...
- **PATRÓN** `ibs_20min` < `0.3259` → IC=+0.133 (n=224)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.3259 (IC base=+0.085)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.142 (n=79)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.085)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.3477` → IC=-0.220 (n=23)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3477
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=317)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.328` → IC=+0.143 (n=127)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 5.328 (IC base=+0.067)

- **PATRÓN** `libro_liquidez` > `2928.3958` → IC=+0.191 (n=95)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2928.3958 (IC base=+0.067)
...
- **PATRÓN** `volumen_regimen` < `0.7183` → IC=+0.152 (n=113)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7183 (IC base=+0.076)

- **PATRÓN** `volumen_spike_ratio` < `2.513` → IC=+0.126 (n=233)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.513 (IC base=+0.076)

- **PATRÓN** `ballena_activa_n` < `45.0` → IC=+0.131 (n=201)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 45.0 (IC base=+0.076)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.579` → IC=+0.220 (n=3432)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.579 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8824` → IC=+0.163 (n=3153)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8824 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.17` → IC=+0.183 (n=1917)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.17 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6484` → IC=+0.178 (n=2209)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6484 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=8302)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3774.9265` → IC=+0.171 (n=2329)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3774.9265 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.192 (n=4938)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 97.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.197 (n=4286)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0067 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4735` → IC=+0.185 (n=6415)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.237 (n=6417)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.78` → IC=+0.202 (n=939)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.78 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.688` → IC=+0.182 (n=6188)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.688 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `1.0564` → IC=+0.156 (n=3900)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.0564 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.1986` → IC=+0.159 (n=1478)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.1986 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.289` → IC=+0.252 (n=829)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.289 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.2953` → IC=+0.190 (n=2579)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2953 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `130.0` → IC=+0.178 (n=5292)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 130.0 (IC base=+0.182)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.219 (n=389)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.322` → IC=+0.195 (n=1168)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.269 (n=833)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.259)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.259 (n=847)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.0667` → IC=+0.308 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0667 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.636` → IC=+0.269 (n=919)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.636 (IC base=+0.259)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9092` → IC=+0.282 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9092 (IC base=+0.259)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.260 (n=930)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1578.46` → IC=+0.268 (n=822)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1578.46 (IC base=+0.259)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.258 (n=676)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3225` → IC=+0.172 (n=987)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.157 (n=659)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 11.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` < `0.6443` → IC=+0.207 (n=987)
...
- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.167 (n=987)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4046` → IC=+0.171 (n=889)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.4046 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `289.0` → IC=+0.170 (n=265)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 289.0 (IC base=+0.157)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.227 (n=1093)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.218 (n=1150)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `drift_60min` |x|≤ `0.1455` → IC=+0.230 (n=468)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.381` → IC=+0.268 (n=938)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.381 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.693` → IC=+0.277 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.693 (IC base=+0.229)
...
- **PATRÓN** `volumen_spike_ratio` < `2.9608` → IC=+0.218 (n=827)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9608 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` > `2.2531` → IC=+0.228 (n=626)
...
- **PATRÓN** `libro_liquidez` > `1894.4532` → IC=+0.231 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1894.4532 (IC base=+0.229)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.222 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.229)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.169 (n=520)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0038 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4249` → IC=+0.137 (n=1180)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.4249 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=1236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.7101` → IC=+0.233 (n=788)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7101 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.5494` → IC=+0.184 (n=324)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.5494 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.337` → IC=+0.171 (n=511)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 4.337 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8816` → IC=+0.159 (n=787)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8816 (IC base=+0.135)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.135 (n=1281)
...
- **PATRÓN** `ibs_20min` < `0.6898` → IC=+0.184 (n=949)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6898 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.1974` → IC=+0.138 (n=883)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1974 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.238` → IC=+0.192 (n=141)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 11.238 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `0.8533` → IC=+0.141 (n=633)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8533 (IC base=+0.133)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5573` → IC=+0.144 (n=388)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5573 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `2.1299` → IC=+0.162 (n=400)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.1299 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `11093.2268` → IC=+0.176 (n=316)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 11093.2268 (IC base=+0.133)

- **PATRÓN** `ballena_activa_n` < `198.0` → IC=+0.138 (n=870)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 198.0 (IC base=+0.133)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.176 (n=504)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0061 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1197` → IC=+0.148 (n=382)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.619` → IC=+0.209 (n=1144)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.619 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.344` → IC=+0.127 (n=1099)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.344 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.7143` → IC=+0.154 (n=504)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7143 (IC base=+0.117)
...
- **PATRÓN** `volumen_spike_ratio` < `1.581` → IC=+0.145 (n=435)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.581 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `2.2064` → IC=+0.134 (n=449)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.2064 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2943.5324` → IC=+0.159 (n=382)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2943.5324 (IC base=+0.117)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0237` → IC=+0.212 (n=558)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0237 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1286)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.202 (n=1099)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.308 (n=441)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.1743` → IC=+0.236 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1743 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.53` → IC=+0.237 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.53 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` < `1.2398` → IC=+0.204 (n=1230)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2398 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.619` → IC=+0.204 (n=1230)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.619 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2388` → IC=+0.231 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2388 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `2.6099` → IC=+0.228 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6099 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=1247)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2555.3736` → IC=+0.208 (n=820)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2555.3736 (IC base=+0.201)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.248 (n=454)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.200)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.203 (n=1436)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.252 (n=1354)
...
- **PATRÓN** `dist_vwap_pct` < `0.1806` → IC=+0.203 (n=1209)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2872` → IC=+0.259 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2872 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2259` → IC=+0.191 (n=1035)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2259 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4453` → IC=+0.198 (n=1176)
...
- **PATRÓN** `libro_liquidez` > `2528.706` → IC=+0.205 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2528.706 (IC base=+0.200)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.182 (n=1081)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.146 (n=721)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0051 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.2737` → IC=+0.143 (n=1441)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.2737 (IC base=+0.131)
...
- **PATRÓN** `ibs_20min` > `0.9286` → IC=+0.198 (n=722)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.9286 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.1852` → IC=+0.126 (n=723)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.1852 (IC base=+0.131)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1732` → IC=+0.156 (n=597)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1732 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `1.4534` → IC=+0.151 (n=714)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4534 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.8876` → IC=+0.145 (n=1425)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8876 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `8776.3155` → IC=+0.145 (n=979)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 8776.3155 (IC base=+0.131)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.181 (n=211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0103 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.2804` → IC=+0.164 (n=310)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.2804 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.224 (n=183)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` < `0.4823` → IC=+0.155 (n=204)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4823 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.988` → IC=+0.220 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.988 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.299` → IC=+0.209 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.299 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.2085` → IC=+0.179 (n=129)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.2085 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `3.4649` → IC=+0.165 (n=463)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 3.4649 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.8314` → IC=+0.160 (n=413)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8314 (IC base=+0.155)
...
- **FILTRO** `ibs_20min` > `0.2413` → IC=-0.130 (n=90)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.150 (n=175)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.149 (n=92)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.054)

- **PATRÓN** `ibs_20min` < `0.2413` → IC=+0.150 (n=175)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.2413 (IC base=+0.054)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.892` → IC=+0.163 (n=84)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 5.892 (IC base=+0.054)

- **PATRÓN** `libro_liquidez` > `3703.4476` → IC=+0.156 (n=91)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3703.4476 (IC base=+0.054)
...
- **PATRÓN** `ibs_20min` < `0.3559` → IC=+0.123 (n=67)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.3559 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.26` → IC=+0.300 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.26 (IC base=+0.038)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.123 (n=298)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 10.0 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `2809.1559` → IC=+0.164 (n=144)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2809.1559 (IC base=+0.102)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=5744)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=986)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.176 (n=2384)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=7159)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.166 (n=2460)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=7485)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.212 (n=384)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=1198)

- **FILTRO** `ibs_20min` < `0.7482` → IC=-0.175 (n=395)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.199 (n=400)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1253)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.220 (n=412)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1323)

- **FILTRO** `ibs_20min` > `0.2874` → IC=-0.178 (n=433)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2874
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1302)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.185 (n=430)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2041)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1960)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1966)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=6976)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=15791)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.275 (n=5605)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=17162)

- **FILTRO** `ibs_7min` < `0.7113` → IC=-0.235 (n=5691)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7113
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=17076)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.162 (n=7675)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=15092)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.219 (n=7002)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=21318)

- **FILTRO** `ibs_7min` > `0.2967` → IC=-0.173 (n=7075)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2967
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=21245)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.316 (n=836)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2736)

- **FILTRO** `ibs_7min` < `0.7111` → IC=-0.258 (n=1177)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7111
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2395)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.203 (n=853)

  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=2719)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.145 (n=3319)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1617)

- **FILTRO** `drift_7min_pct` |x|> `0.1084` → IC=-0.122 (n=1678)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1084
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3258)

- **FILTRO** `ibs_7min` > `0.7987` → IC=-0.201 (n=1233)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7987
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3703)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.147 (n=917)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3091)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.254 (n=995)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3013)

- **FILTRO** `ibs_7min` < `0.7628` → IC=-0.184 (n=1002)
...
- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.171 (n=996)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3012)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.259 (n=927)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3099)

- **FILTRO** `ibs_7min` > `0.2497` → IC=-0.171 (n=1006)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2497
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3020)

- **FILTRO** `ballena_activa_n` > `113.0` → IC=-0.162 (n=1360)

  - _Acción_: SKIP cuando `ballena_activa_n` > 113.0
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2666)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.180 (n=823)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2559)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.322 (n=792)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2590)

- **FILTRO** `ibs_7min` < `0.2083` → IC=-0.272 (n=845)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2083
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2537)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.215 (n=776)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=2606)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.231 (n=1197)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=3971)

- **FILTRO** `ibs_7min` > `0.2658` → IC=-0.150 (n=1757)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2658
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=3411)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.170 (n=2480)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=1279)

- **FILTRO** `ibs_7min` < `0.7486` → IC=-0.191 (n=939)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7486
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=2820)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.185 (n=932)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=2827)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.258 (n=927)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2868)

- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.172 (n=946)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2744
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2849)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.175 (n=944)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2851)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.234 (n=1049)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=3150)

- **FILTRO** `ibs_7min` < `0.7353` → IC=-0.202 (n=1049)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7353
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3150)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.167 (n=1282)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=4071)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.282 (n=907)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2940)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.225 (n=960)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2887)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.209 (n=886)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2961)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.195 (n=1200)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=3842)
...
- **PATRÓN** `delta_ratio` |x|> `0.4` → IC=+0.160 (n=104)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.80€ cuando `delta_ratio` |x|> 0.4 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.132 (n=104)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 13.0 (IC base=+0.112)

- **PATRÓN** `total_vol_5m` < `353208.2` → IC=+0.138 (n=103)

  - _Acción_: Kelly boost +0.69€ cuando `total_vol_5m` < 353208.2 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.246 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.176 (n=72)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 36.0 (IC base=+0.112)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=2155)
...
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.182 (n=325)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0087 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0582` → IC=+0.170 (n=325)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.0582 (IC base=+0.167)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0587` → IC=+0.171 (n=974)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.86€ cuando `delta_ratio_macro` |x|> 0.0587 (IC base=+0.167)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0986` → IC=+0.227 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0986 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.167 (n=1017)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6176` → IC=+0.239 (n=974)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6176 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.1038` → IC=+0.172 (n=644)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1038 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.71` → IC=+0.242 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.71 (IC base=+0.167)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.331` → IC=+0.136 (n=53)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 20.331 (IC base=+0.000)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.6122` → IC=-0.143 (n=113)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.6122
...
- **PATRÓN** `sigma_h` > `0.0135` → IC=+0.222 (n=185)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0135 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.0876` → IC=+0.182 (n=124)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.0876 (IC base=+0.161)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0459` → IC=+0.176 (n=279)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.88€ cuando `delta_ratio_macro` |x|> 0.0459 (IC base=+0.161)
...
- **PATRÓN** `ibs_15` > `0.5075` → IC=+0.250 (n=278)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5075 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.1654` → IC=+0.178 (n=150)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1654 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` < `0.3009` → IC=+0.164 (n=260)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.3009 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.796` → IC=+0.208 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.796 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.247` → IC=+0.161 (n=252)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 7.247 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `2703.9992` → IC=+0.203 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2703.9992 (IC base=+0.161)
...
- **FILTRO** `sigma_h` > `0.0122` → IC=-0.195 (n=497)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1494)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.165 (n=615)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1193` → IC=+0.231 (n=644)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1193 (IC base=-0.050)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.183` → IC=+0.234 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.183 (IC base=-0.050)

- **PATRÓN** `ibs_15` < `0.3529` → IC=+0.272 (n=966)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3529 (IC base=-0.050)

- **PATRÓN** `dist_vwap_pct` > `0.3819` → IC=+0.251 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3819 (IC base=-0.050)
...
- **FILTRO** `sigma_h` < `0.0032` → IC=-0.236 (n=294)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=883)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.215 (n=752)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.174 (n=425)

- **FILTRO** `sigma_ewma_delta_pct` > `20.011` → IC=-0.246 (n=215)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 20.011
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=962)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.226 (n=352)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.3466` → IC=+0.226 (n=352)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3466 (IC base=+0.214)

- **PATRÓN** `drift_15min` |x|≤ `0.7445` → IC=+0.217 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7445 (IC base=+0.214)

- **PATRÓN** `delta_ratio_macro` |x|> `0.095` → IC=+0.222 (n=358)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3584` → IC=+0.259 (n=400)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `11.945` → IC=+0.218 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.945 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `3672.3796` → IC=+0.216 (n=400)
...
- **FILTRO** `drift_15min` |x|> `0.8298` → IC=-0.242 (n=122)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.111 (n=368)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.209 (n=180)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1035` → IC=+0.376 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1035 (IC base=-0.050)

- **PATRÓN** `ibs_15` < `0.3256` → IC=+0.288 (n=276)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6176 sube el IC de +0.167 a +0.239 en UPDOWN_GBM#15min (n=974). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5075 sube el IC de +0.161 a +0.250 en UPDOWN_GBM#XRP#15min (n=278). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1034 sube el IC de +0.046 a +0.174 en UPDOWN_GBM#XRP#15min (n=296). Ya aplicado como kelly_boost=+0.87€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3529 sube el IC de -0.050 a +0.272 en UPDOWN_GBM_15M_TARDIO (n=966). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3584 sube el IC de +0.214 a +0.259 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=400). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3256 sube el IC de -0.050 a +0.288 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=276). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1105 | +0.079 | +109.52€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1105 | +0.079 | +109.52€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS | 19049 | -0.108 | -2789.48€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1142 | -0.027 | -192.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 17907 | -0.114 | -2596.76€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3004 | -0.119 | -566.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3004 | -0.119 | -566.63€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 5522 | -0.061 | -519.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5522 | -0.061 | -519.16€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 4931 | -0.110 | -384.35€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 4931 | -0.110 | -384.35€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4076 | -0.183 | -965.57€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4076 | -0.183 | -965.57€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 10288 | -0.048 | +4326.17€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 2816 | -0.009 | +1857.11€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 7472 | -0.063 | +2469.06€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 10288 | -0.048 | +4326.17€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 2816 | -0.009 | +1857.11€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 7472 | -0.063 | +2469.06€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 370 | -0.094 | -58.45€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 9 | +0.021 | +0.62€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 361 | -0.098 | -59.08€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 16 | -0.089 | -0.58€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 16 | -0.089 | -0.58€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 223 | -0.033 | -16.00€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 220 | -0.036 | -16.94€ | 1 | 1 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 17 | +0.022 | +5.70€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 17 | +0.022 | +5.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 68495 | +0.113 | -3706.01€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 10855 | +0.182 | -329.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 263 | -0.111 | -45.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 52515 | +0.100 | -3235.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 4862 | +0.117 | -94.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 8761 | +0.094 | -876.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 36 | -0.158 | -1.29€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 8710 | +0.096 | -863.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 13853 | +0.131 | -279.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3281 | +0.202 | -96.89€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 8703 | +0.109 | -181.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1827 | +0.118 | +21.30€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 8796 | +0.089 | -889.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 41 | -0.035 | -1.28€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 8740 | +0.090 | -877.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 14680 | +0.125 | -299.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4164 | +0.170 | -76.86€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 8764 | +0.109 | -171.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1740 | +0.101 | -42.53€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 13629 | +0.117 | -804.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3297 | +0.187 | -157.90€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 166 | -0.059 | +7.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 8871 | +0.091 | -581.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1295 | +0.137 | -73.58€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 8776 | +0.102 | -556.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 36 | -0.026 | +4.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 8727 | +0.102 | -560.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 10828 | +0.187 | -764.85€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 10828 | +0.187 | -764.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2690 | +0.168 | -291.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2690 | +0.168 | -291.73€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 443 | +0.172 | +14.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 443 | +0.172 | +14.08€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2649 | +0.176 | -249.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2649 | +0.176 | -249.50€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2378 | +0.236 | -70.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2378 | +0.236 | -70.33€ | 0 | 4 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2589 | +0.189 | -181.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2589 | +0.189 | -181.12€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 36924 | +0.192 | -3241.00€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 36924 | +0.192 | -3241.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 6458 | +0.164 | -871.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 6458 | +0.164 | -871.14€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 5823 | +0.223 | -222.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 5823 | +0.223 | -222.27€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 6402 | +0.167 | -837.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 6402 | +0.167 | -837.59€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 5925 | +0.216 | -261.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 5925 | +0.216 | -261.34€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 6105 | +0.199 | -448.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 6105 | +0.199 | -448.82€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 6211 | +0.189 | -599.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 6211 | +0.189 | -599.84€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 13713 | +0.125 | +278.40€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 13713 | +0.125 | +278.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 6790 | +0.131 | +206.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 6790 | +0.131 | +206.34€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 6923 | +0.119 | +72.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 6923 | +0.119 | +72.07€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 767 | +0.063 | -48.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 268 | +0.056 | -23.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 499 | +0.067 | -24.36€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 599 | +0.072 | -23.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 100 | +0.098 | +0.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 499 | +0.067 | -24.36€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 23678 | +0.098 | -754.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2010 | +0.095 | +32.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 21668 | +0.098 | -787.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 13601 | +0.102 | -216.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2010 | +0.095 | +32.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 11591 | +0.103 | -249.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 3962 | +0.116 | +37.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 3962 | +0.116 | +37.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 6115 | +0.076 | -575.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 6115 | +0.076 | -575.86€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 17849 | +0.073 | +7998.72€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 17849 | +0.073 | +7998.72€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 2911 | +0.197 | +2146.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 2911 | +0.197 | +2146.62€ | 0 | 24 |
| ✅ GBM_LATE_15M#BTC | 2612 | +0.174 | +1757.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2612 | +0.174 | +1757.51€ | 0 | 23 |
| ✅ GBM_LATE_15M#DOGE | 3032 | +0.194 | +2198.06€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 3032 | +0.194 | +2198.06€ | 0 | 23 |
| ✅ GBM_LATE_15M#ETH | 2682 | -0.002 | +389.49€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 2682 | -0.002 | +389.49€ | 1 | 14 |
| ✅ GBM_LATE_15M#SOL | 2658 | -0.038 | +597.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2658 | -0.038 | +597.71€ | 4 | 10 |
| ✅ GBM_LATE_15M#XRP | 3954 | -0.054 | +909.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 3954 | -0.054 | +909.34€ | 4 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 18828 | +0.075 | +9415.19€ | 0 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 18828 | +0.075 | +9415.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 3446 | +0.012 | +1922.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 3446 | +0.012 | +1922.26€ | 2 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 3999 | +0.001 | +733.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 3999 | +0.001 | +733.42€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 2653 | +0.257 | +2614.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 2653 | +0.257 | +2614.28€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 2888 | -0.026 | +260.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 2888 | -0.026 | +260.88€ | 2 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 3133 | +0.012 | +1109.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 3133 | +0.012 | +1109.80€ | 3 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 2709 | +0.265 | +2774.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 2709 | +0.265 | +2774.55€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 14573 | +0.169 | +10522.06€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 14573 | +0.169 | +10522.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2131 | +0.209 | +1711.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2131 | +0.209 | +1711.59€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 2290 | +0.158 | +1612.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 2290 | +0.158 | +1612.44€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2242 | +0.204 | +1745.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2242 | +0.204 | +1745.16€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 2410 | +0.141 | +1574.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 2410 | +0.141 | +1574.11€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 2758 | +0.113 | +1758.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 2758 | +0.113 | +1758.16€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 2742 | +0.199 | +2120.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 2742 | +0.199 | +2120.60€ | 0 | 27 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 3525 | +0.122 | +1348.42€ | 0 | 20 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 3525 | +0.122 | +1348.42€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 976 | +0.151 | +431.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 976 | +0.151 | +431.15€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 717 | +0.072 | +167.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 717 | +0.072 | +167.95€ | 1 | 8 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 387 | +0.130 | +151.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 387 | +0.130 | +151.73€ | 0 | 28 |
| ✅ GBM_LATE_15M_TARDIO | 17867 | +0.172 | +12800.28€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#15min | 17867 | +0.172 | +12800.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 2781 | +0.223 | +2370.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 2781 | +0.223 | +2370.75€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 2785 | +0.152 | +1834.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 2785 | +0.152 | +1834.59€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 2873 | +0.220 | +2410.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 2873 | +0.220 | +2410.38€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 2837 | +0.134 | +1792.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 2837 | +0.134 | +1792.36€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 3148 | +0.105 | +1743.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 3148 | +0.105 | +1743.70€ | 0 | 16 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 3443 | +0.201 | +2648.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 3443 | +0.201 | +2648.50€ | 0 | 27 |
| ✅ GBM_LATE_5M | 5244 | +0.135 | +2702.79€ | 1 | 25 |
| ✅ GBM_LATE_5M#5min | 5244 | +0.135 | +2702.79€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#DOGE | 677 | +0.164 | +410.68€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 677 | +0.164 | +410.68€ | 0 | 19 |
...
| ✅ GBM_LATE_60M | 1124 | +0.054 | +356.35€ | 4 | 18 |
| ✅ GBM_LATE_60M#60min | 1124 | +0.054 | +356.35€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 394 | +0.081 | +129.53€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 394 | +0.081 | +129.53€ | 0 | 17 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 523 | +0.054 | +87.68€ | 1 | 5 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 523 | +0.054 | +87.68€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC | 193 | +0.049 | +24.68€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 193 | +0.049 | +24.68€ | 3 | 8 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH | 159 | +0.047 | +3.28€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH#60min | 159 | +0.047 | +3.28€ | 3 | 8 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1196 | +0.097 | +313.19€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1196 | +0.097 | +313.19€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1196 | +0.097 | +313.19€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1196 | +0.097 | +313.19€ | 0 | 2 |
...
| ✅ MOMENTUM_IBS_15M | 12036 | -0.011 | -171.82€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 12036 | -0.011 | -171.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2078 | -0.021 | -41.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2078 | -0.021 | -41.44€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE | 2559 | +0.008 | -17.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 2559 | +0.008 | -17.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 2241 | -0.018 | -17.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 2241 | -0.018 | -17.93€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 2901 | -0.016 | -60.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 2901 | -0.016 | -60.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 1679 | -0.006 | -33.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 1679 | -0.006 | -33.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 19488 | -0.014 | +923.22€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 19488 | -0.014 | +923.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 3351 | +0.008 | +477.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 3351 | +0.008 | +477.22€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 3166 | -0.026 | -16.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 3166 | -0.026 | -16.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 3388 | -0.001 | +281.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 3388 | -0.001 | +281.81€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3005 | -0.045 | -65.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3005 | -0.045 | -65.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 3272 | -0.017 | +151.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 3272 | -0.017 | +151.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 3306 | -0.009 | +94.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 3306 | -0.009 | +94.67€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 4102 | -0.031 | -94.33€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 4102 | -0.031 | -94.33€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 904 | +0.000 | -14.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 904 | +0.000 | -14.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 756 | -0.034 | -18.13€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 756 | -0.034 | -18.13€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1181 | -0.033 | -17.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1181 | -0.033 | -17.67€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 51087 | -0.073 | +1077.30€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 51087 | -0.073 | +1077.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 8508 | -0.082 | +493.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 8508 | -0.082 | +493.67€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 8034 | -0.087 | -285.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 8034 | -0.087 | -285.15€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 8550 | -0.072 | +428.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 8550 | -0.072 | +428.67€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 7554 | -0.096 | -241.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 7554 | -0.096 | -241.99€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 9552 | -0.046 | +312.37€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 9552 | -0.046 | +312.37€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 8889 | -0.063 | +369.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 8889 | -0.063 | +369.72€ | 4 | 0 |
...
| ✅ ORDER_FLOW_5M | 912 | +0.111 | +305.88€ | 1 | 5 |
| ✅ ORDER_FLOW_5M#5min | 776 | +0.119 | +293.29€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#XRP | 155 | +0.112 | +49.97€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#XRP#5min | 155 | +0.112 | +49.97€ | 0 | 5 |
...
| ✅ STREAK_FADE_5M | 2302 | -0.022 | -96.86€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2302 | -0.022 | -96.86€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 788 | -0.021 | -33.08€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 788 | -0.021 | -33.08€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 5795 | +0.022 | +84.34€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 5795 | +0.022 | +84.34€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 1879 | +0.024 | +23.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 1879 | +0.024 | +23.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1191 | +0.034 | +36.17€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1191 | +0.034 | +36.17€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 1687 | +0.010 | -2.65€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 1687 | +0.010 | -2.65€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1038 | +0.028 | +27.54€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1038 | +0.028 | +27.54€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 5538 | +0.014 | -21.46€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 5538 | +0.014 | -21.46€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2174 | +0.022 | +7.75€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2174 | +0.022 | +7.75€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2204 | +0.017 | -2.54€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2204 | +0.017 | -2.54€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1160 | -0.008 | -26.67€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1160 | -0.008 | -26.67€ | 2 | 0 |
| ✅ UPDOWN_GBM | 21687 | +0.027 | +1146.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 5972 | +0.055 | +912.56€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 824 | +0.004 | +8.81€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 13525 | +0.021 | +241.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 1278 | -0.009 | -19.90€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 1814 | +0.077 | +190.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 267 | +0.128 | +86.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 19 | -0.023 | -0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 1528 | +0.069 | +104.86€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 3844 | +0.027 | +238.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 693 | +0.080 | +160.34€ | 1 | 13 |
| ✅ UPDOWN_GBM#BTC#240min | 237 | +0.027 | +7.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 2321 | +0.021 | +72.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 560 | -0.004 | -3.05€ | 0 | 1 |
| ✅ UPDOWN_GBM#BTC#daily | 33 | -0.129 | +1.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 2582 | +0.031 | +83.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 228 | +0.109 | +55.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 16 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 2338 | +0.024 | +28.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 4381 | +0.015 | +161.97€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1630 | +0.040 | +159.70€ | 1 | 12 |
| ✅ UPDOWN_GBM#ETH#240min | 224 | +0.009 | +8.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 2032 | +0.004 | -1.62€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 466 | -0.015 | -9.22€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 29 | -0.145 | +4.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 5757 | +0.014 | +125.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1608 | +0.021 | +94.03€ | 0 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 219 | -0.007 | -1.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 3654 | +0.016 | +41.79€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 252 | -0.012 | -7.63€ | 1 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 24 | -0.154 | -0.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 3307 | +0.038 | +347.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 1546 | +0.074 | +356.08€ | 0 | 12 |
| ✅ UPDOWN_GBM#XRP#240min | 109 | -0.032 | -4.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 1652 | +0.009 | -4.08€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 8220 | -0.052 | +1725.44€ | 3 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 8220 | -0.052 | +1725.44€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 397 | -0.049 | +350.53€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 397 | -0.049 | +350.53€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1579 | -0.133 | -13.30€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1579 | -0.133 | -13.30€ | 4 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 139 | +0.117 | +54.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 139 | +0.117 | +54.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 854 | +0.182 | +469.29€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 854 | +0.182 | +469.29€ | 2 | 23 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 2657 | -0.063 | +422.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 2657 | -0.063 | +422.86€ | 2 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 2594 | -0.077 | +441.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 2594 | -0.077 | +441.51€ | 2 | 3 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 417 celda(s) pasan gate riguroso completo de 1972 evaluadas (n>=40) y 2933 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.021 < 0.08 — monitorear
  - _Datos_: n=1607 IC=+0.021 PNL=+94.54€
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=466/40 IC=-0.015 PNL=-9.22€ | BTC#60min: n=558/40 IC=-0.004 PNL=-3.68€ | SOL#60min: n=252/40 IC=-0.012 PNL=-7.63€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.055 n=235269 | tras_1loss IC=+0.068 n=184482 | tras_2loss IC=+0.035 n=79707/40 | gap=+0.019 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=945 IC=-0.008 PNL=-18.48€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=945 IC=-0.008 PNL=-18.48€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=331 IC=-0.013 PNL=-2.04€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=331 IC=-0.013 PNL=-2.04€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.167 > 0.1 con n=1298 PNL=+691.20€
  - _Datos_: n=1298 IC=+0.167 PNL=+691.20€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=693 IC=+0.080 PNL=+160.34€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=693 IC=+0.080 PNL=+160.34€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=6814 IC=+0.049 PNL=+773.62€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=6814 IC=+0.049 PNL=+773.62€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1176 IC=+0.046 PNL=+137.07€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1176 IC=+0.046 PNL=+137.07€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=12221 IC=-0.142 PNL=+575.42€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=12221 IC=-0.142 PNL=+575.42€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1351 IC=+0.139 PNL=+728.47€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1351 IC=+0.139 PNL=+728.47€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.239 < -0.1 con n=1242 PNL=-172.38€
  - _Datos_: n=1242 IC=-0.239 PNL=-172.38€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=6456 IC=+0.164 PNL=-870.38€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=6456 IC=+0.164 PNL=-870.38€
