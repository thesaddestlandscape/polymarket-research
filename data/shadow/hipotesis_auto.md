# Hipótesis automáticas — 2026-07-10 07:52 UTC
_Generado por shadow_postmortem.py sobre 7309 resoluciones (PNL=+1032.38€)_
...
- **PATRÓN** `ibs_15` > `0.8261` → IC=+0.127 (n=124)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.63€ cuando `ibs_15` > 0.8261 (IC base=-0.004)
...
- **PATRÓN** `ibs_15` > `0.8337` → IC=+0.191 (n=53)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.95€ cuando `ibs_15` > 0.8337 (IC base=+0.009)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS > 0.8337 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.191 n=53). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 2795 | +0.114 | +916.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2795 | +0.114 | +916.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 706 | +0.055 | +70.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 706 | +0.055 | +70.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 712 | +0.077 | +121.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 712 | +0.077 | +121.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 720 | +0.157 | +396.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 720 | +0.157 | +396.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 657 | +0.169 | +327.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 657 | +0.169 | +327.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 274 | +0.163 | +101.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 274 | +0.163 | +101.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 65 | +0.142 | +19.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 65 | +0.142 | +19.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 75 | +0.175 | +35.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 75 | +0.175 | +35.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 74 | +0.118 | +15.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 74 | +0.118 | +15.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 60 | +0.210 | +30.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 60 | +0.210 | +30.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 342 | +0.055 | +42.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 342 | +0.055 | +42.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 82 | +0.048 | +4.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 82 | +0.048 | +4.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 87 | +0.039 | +7.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 87 | +0.039 | +7.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 83 | -0.053 | -1.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 83 | -0.053 | -1.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 90 | +0.174 | +31.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 90 | +0.174 | +31.72€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1209 | -0.015 | -0.95€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 957 | +0.013 | +34.48€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 577 | +0.006 | +21.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 485 | +0.026 | +32.24€ | 1 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.100) — sin ventaja clara. oversold(IBS<0.3): IC=-0.018 n=303 | neutral: IC=-0.057 n=228 | overbought(IBS>0.7): IC=+0.044 n=250
  - _Datos_: n=819 IC=-0.003 PNL=+24.29€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.177 n=29 PNL=-7.49€ → FILTRAR | H=07h: IC=+0.106 n=31 PNL=+8.42€ → BOOST | H=08h: IC=-0.107 n=26 PNL=-3.42€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.132 n=36 PNL=+7.33€ → BOOST | H=17h: IC=+0.132 n=36 PNL=+12.29€ → BOOST | H=22h: IC=+0.128 n=41 PNL=+7.59€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.063 n=3923 | tras_1loss IC=+0.023 n=3267 | tras_2loss IC=-0.011 n=1532/40 | gap=+0.074 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.167 n=46/60 | contraria IC=+0.089 n=16 | gap=+0.078 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1086 IC=-0.009 PNL=+12.60€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1086 IC=-0.009 PNL=+12.60€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=538 IC=-0.004 PNL=-3.98€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=538 IC=-0.004 PNL=-3.98€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=468 IC=+0.036 PNL=+18.88€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=468 IC=+0.036 PNL=+18.88€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=4851 IC=+0.077 PNL=+1108.26€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4851 IC=+0.077 PNL=+1108.26€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=685 IC=-0.036 PNL=-34.45€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=685 IC=-0.036 PNL=-34.45€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.174 > 0.1 con n=191 PNL=+70.16€
  - _Datos_: n=191 IC=+0.174 PNL=+70.16€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=255 IC=-0.056 PNL=+48.34€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=255 IC=-0.056 PNL=+48.34€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=359 IC=+0.037 PNL=+25.36€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=359 IC=+0.037 PNL=+25.36€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.08 con n=134 PNL=+42.27€
  - _Datos_: n=134 IC=+0.169 PNL=+42.27€
...
**⏳ H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: 256/289 ops en el filtro definido (IC actual=-0.155 PNL=-38.49€)
  - _Datos_: n=256 IC=-0.155 PNL=-38.49€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 37/100 ops en el filtro definido (IC actual=+0.244 PNL=+18.67€)
  - _Datos_: n=37 IC=+0.244 PNL=+18.67€
