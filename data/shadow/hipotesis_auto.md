# Hipótesis automáticas — 2026-07-28 17:29 UTC
_Generado por shadow_postmortem.py sobre 40461 resoluciones (PNL=+8416.87€)_
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.197 (n=1271)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0076 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=1794)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 7.0 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.6814` → IC=+0.200 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6814 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.398` → IC=+0.240 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.398 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.155 (n=1446)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0068 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.132 (n=1480)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 12.0 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.3908` → IC=+0.123 (n=343)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.3908 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.169` → IC=+0.153 (n=321)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 8.169 (IC base=+0.120)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.142 (n=431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.4456` → IC=+0.221 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4456 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.79` → IC=+0.174 (n=84)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 11.79 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.214 (n=159)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0075 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.150 (n=315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 12.0 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.6615` → IC=+0.178 (n=85)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.6615 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.083` → IC=+0.200 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.083 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `8305.53` → IC=+0.133 (n=246)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8305.53 (IC base=+0.121)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.128 (n=1257)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.0083 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.4603` → IC=+0.152 (n=340)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.4603 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.986` → IC=+0.239 (n=308)
...
- **PATRÓN** `dist_vwap_pct` > `0.4428` → IC=+0.183 (n=58)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.4428 (IC base=+0.077)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.632` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 12.632 (IC base=+0.077)

- **PATRÓN** `libro_liquidez` > `10368.8183` → IC=+0.128 (n=205)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 10368.8183 (IC base=+0.077)
...
- **PATRÓN** `libro_liquidez` > `6662.3921` → IC=+0.124 (n=227)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 6662.3921 (IC base=+0.057)
...
| ✅ GBM_LATE_15M | 8714 | +0.093 | +2594.59€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8714 | +0.093 | +2594.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 71 | +0.158 | +28.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 71 | +0.158 | +28.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2072 | +0.071 | +349.82€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2072 | +0.071 | +349.82€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 71 | +0.089 | +12.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 71 | +0.089 | +12.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1864 | +0.071 | +307.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1864 | +0.071 | +307.86€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2309 | +0.083 | +786.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2309 | +0.083 | +786.86€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2327 | +0.139 | +1109.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2327 | +0.139 | +1109.83€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5937 | +0.118 | +2818.73€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5937 | +0.118 | +2818.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 53 | +0.318 | +61.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 53 | +0.318 | +61.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1519 | +0.083 | +509.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1519 | +0.083 | +509.45€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 67 | +0.196 | +44.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 67 | +0.196 | +44.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1512 | +0.088 | +540.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1512 | +0.088 | +540.63€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1461 | +0.086 | +581.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1461 | +0.086 | +581.69€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1325 | +0.214 | +1081.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1325 | +0.214 | +1081.35€ | 0 | 13 |
...
| ✅ GBM_LATE_15M_TARDIO | 5936 | +0.066 | +1574.91€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5936 | +0.066 | +1574.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 62 | +0.266 | +47.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 62 | +0.266 | +47.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1386 | +0.026 | +157.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1386 | +0.026 | +157.15€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 66 | +0.176 | +27.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 66 | +0.176 | +27.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1416 | +0.021 | +116.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1416 | +0.021 | +116.95€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1377 | +0.025 | +257.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1377 | +0.025 | +257.69€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1629 | +0.160 | +968.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1629 | +0.160 | +968.76€ | 0 | 14 |
...
| ✅ UPDOWN_GBM | 2990 | +0.033 | +261.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2726 | +0.050 | +300.72€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#XRP | 349 | +0.044 | +43.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 338 | +0.053 | +46.32€ | 4 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2282 | +0.148 | +983.26€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2282 | +0.148 | +983.26€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 222 | +0.214 | +150.07€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 222 | +0.214 | +150.07€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 236 | +0.109 | +40.68€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 236 | +0.109 | +40.68€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 643 | +0.167 | +373.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 643 | +0.167 | +373.87€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.163: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.068 n=1738 | neutral: IC=+0.023 n=1377 | overbought(IBS>0.7): IC=+0.186 n=1676
  - _Datos_: n=5108 IC=+0.101 PNL=+1313.17€
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 11 celda(s) pasan gate riguroso completo de 35 evaluadas (n>=40) y 155 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.110 n=24025 | tras_1loss IC=+0.078 n=16184 | tras_2loss IC=+0.053 n=6784/40 | gap=+0.056 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2853 IC=+0.038 PNL=+275.49€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2853 IC=+0.038 PNL=+275.49€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1139 IC=+0.055 PNL=+155.32€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1139 IC=+0.055 PNL=+155.32€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=514 IC=+0.087 PNL=+91.62€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=514 IC=+0.087 PNL=+91.62€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.086 > 0.08 con n=1437 PNL=+238.78€
  - _Datos_: n=1437 IC=+0.086 PNL=+238.78€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1518 IC=+0.036 PNL=+110.17€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1518 IC=+0.036 PNL=+110.17€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=4163 IC=+0.069 PNL=+750.49€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4163 IC=+0.069 PNL=+750.49€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1289 IC=+0.031 PNL=+124.77€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1289 IC=+0.031 PNL=+124.77€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.158 > 0.1 con n=1045 PNL=+347.43€
  - _Datos_: n=1045 IC=+0.158 PNL=+347.43€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=301 IC=+0.071 PNL=+49.64€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=301 IC=+0.071 PNL=+49.64€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1041 IC=-0.070 PNL=+274.67€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1041 IC=-0.070 PNL=+274.67€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.119 > 0.08 con n=735 PNL=+201.57€
  - _Datos_: n=735 IC=+0.119 PNL=+201.57€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.172 > 0.08 con n=300 PNL=+111.66€
  - _Datos_: n=300 IC=+0.172 PNL=+111.66€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.08 con n=780 PNL=+376.22€
  - _Datos_: n=780 IC=+0.125 PNL=+376.22€
