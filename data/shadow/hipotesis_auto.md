# Hipótesis automáticas — 2026-07-02 01:31 UTC
_Generado por shadow_postmortem.py sobre 2511 resoluciones (PNL=-79.46€)_
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.267 (n=58)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.088)

- **PATRÓN** `drift_60min` |x|≤ `0.7483` → IC=+0.121 (n=101)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.7483 (IC base=+0.088)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.088)

- **PATRÓN** `ibs_15` < `0.0669` → IC=+0.237 (n=36)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0669 (IC base=+0.088)
...
| ✅ UPDOWN_GBM | 759 | -0.031 | -28.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 540 | -0.005 | -2.89€ | 1 | 4 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.079) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.049 n=111 | overbought(IBS>0.7): IC=-0.041 n=133
  - _Datos_: n=369 IC=-0.020 PNL=-3.07€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.135 n=18 PNL=-6.66€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1188 | tras_1loss IC=-0.035 n=1241 | tras_2loss IC=-0.048 n=644/40 | gap=+0.051 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=636 IC=-0.024 PNL=-14.75€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=636 IC=-0.024 PNL=-14.75€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=228 IC=+0.013 PNL=-8.83€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=228 IC=+0.013 PNL=-8.83€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=157 IC=+0.060 PNL=+24.97€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=157 IC=+0.060 PNL=+24.97€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 94/200 ops en el filtro definido (IC actual=+0.073 PNL=+13.46€)
  - _Datos_: n=94 IC=+0.073 PNL=+13.46€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 94/100 ops en el filtro definido (IC actual=+0.073 PNL=+13.46€)
  - _Datos_: n=94 IC=+0.073 PNL=+13.46€
