# Hipótesis automáticas — 2026-07-05 16:00 UTC
_Generado por shadow_postmortem.py sobre 3932 resoluciones (PNL=+166.38€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.167 (n=94)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0089 (IC base=+0.035)

- **PATRÓN** `ibs_15` < `0.0389` → IC=+0.167 (n=55)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.0389 (IC base=+0.035)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.233 (n=28)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.084)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.186 (n=33)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 7.0 (IC base=+0.084)

- **PATRÓN** `ibs_15` < `0.0949` → IC=+0.173 (n=47)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.87€ cuando `ibs_15` < 0.0949 (IC base=+0.084)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0389 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.167 n=55). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0949 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.173 n=47). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1098 | +0.092 | +260.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1098 | +0.092 | +260.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 285 | +0.040 | +29.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 285 | +0.040 | +29.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 286 | +0.059 | +31.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 286 | +0.059 | +31.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 287 | +0.126 | +108.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 287 | +0.126 | +108.51€ | 0 | 0 |
...
| ✅ PRICE_TARGET_GBM | 101 | -0.121 | +1.93€ | 0 | 0 |
...
| ✅ PRICE_TARGET_GBM#SOL | 16 | +0.000 | +8.47€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#SOL#atexpiry | 16 | +0.000 | +8.47€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#atexpiry | 96 | -0.133 | +2.51€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 958 | -0.036 | -48.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 719 | -0.013 | -18.26€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 268 | -0.041 | -32.88€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 404 | -0.003 | +9.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 317 | +0.017 | +17.40€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.066) — sin ventaja clara. oversold(IBS<0.3): IC=-0.007 n=199 | neutral: IC=-0.073 n=162 | overbought(IBS>0.7): IC=-0.040 n=185
  - _Datos_: n=568 IC=-0.033 PNL=-22.98€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.029 n=1977 | tras_1loss IC=-0.008 n=1861 | tras_2loss IC=-0.029 n=926/40 | gap=+0.058 (umbral 0.05)
...
**⏳ H-WEEKLY** — Predicciones semanales de precio por par
  ...
  - _Estado_: ETH: n=36/15 IC=+0.000 PNL=-8.64€ | BTC: n=35/15 IC=-0.013 PNL=-8.65€ | SOL: n=28/15 IC=-0.133 PNL=-6.54€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.035 n=97 | contrario_BTC IC=-0.051 n=47/40 | gap=-0.016 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-WEEKLY-BUYNO** — WEEKLY_PRICE BUY_NO — dirección dominante con IC muy alto
  ...
  - _Estado_: n=65 IC=+0.082 PNL=-8.41€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=65 IC=+0.082 PNL=-8.41€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=835 IC=-0.032 PNL=-34.67€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=835 IC=-0.032 PNL=-34.67€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=261 IC=+0.006 PNL=+7.87€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=261 IC=+0.006 PNL=+7.87€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=464 IC=+0.045 PNL=+35.48€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=464 IC=+0.045 PNL=+35.48€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1483 IC=+0.062 PNL=+244.38€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1483 IC=+0.062 PNL=+244.38€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=70 IC=-0.028 PNL=-10.03€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=70 IC=-0.028 PNL=-10.03€
...
**〰️ H-CUSTOM-PRICETARGET-BUYYES-MALO** — PRICE_TARGET_GBM BUY_YES estructuralmente roto (BUY_NO no)
  ...
  - _Estado_: n=43 IC=-0.100 PNL=+12.71€ — sin señal clara aún (umbral IC: min=None max=-0.15)
  - _Datos_: n=43 IC=-0.100 PNL=+12.71€

**⏳ H-CUSTOM-WEEKLY-INRANGE-BUYYES** — WEEKLY_PRICE BUY_YES con in_range=1 — ¿estructuralmente sobrevalorado?
  - _Hipótesis_: Analizado 2026-07-01, n=10 (evidencia mínima): BUY_YES cuando in_range=1 fue 0/3 (todo pérdida). Mecanismo propuesto: acertar un rango de precio estrecho al vencimiento es intrínsecamente poco probable, el mercado puede estar sobrevalorando el 'sí'. Ver H-CUSTOM-WEEKLY-PCTDIST-BUYNO para el lado complementario (BUY_NO con pct_dist alto).
  - _Umbral_: 25
  - _Acción_: Si se confirma con n≥25 → filtro causal in_range==1 + BUY_YES → skip en WEEKLY_PRICE
  - _Estado_: 14/25 ops en el filtro definido (IC actual=-0.175 PNL=-4.68€)
  - _Datos_: n=14 IC=-0.175 PNL=-4.68€

**⏳ H-CUSTOM-WEEKLY-PCTDIST-BUYNO** — WEEKLY_PRICE BUY_NO con pct_dist alto — cuanto más lejos del rango, más seguro
  - _Hipótesis_: Analizado 2026-07-01, n=10 (evidencia mínima): BUY_NO con pct_dist>=2.09% fue 4/4 victorias (rango 2.09%-23.4%); BUY_NO con pct_dist<8% (pero fuera del corte anterior) tuvo derrotas. Patrón: cuanto más lejos está el spot del rango objetivo al momento de la predicción, más fiable el BUY_NO. Complementa H-CUSTOM-WEEKLY-INRANGE-BUYYES.
  - _Umbral_: 25
  - _Acción_: Si se confirma con n≥25 → boost ×1.2 en WEEKLY_PRICE BUY_NO cuando pct_dist≥2
  - _Estado_: 12/25 ops en el filtro definido (IC actual=-0.043 PNL=-2.83€)
  - _Datos_: n=12 IC=-0.043 PNL=-2.83€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.070 < -0.05 con n=579 PNL=-74.67€
  - _Datos_: n=579 IC=-0.070 PNL=-74.67€
...
**⏳ H-CUSTOM-DAILY-BUYNO** — UPDOWN_GBM#daily BUY_NO — el sesgo anti-YES amplificado en ventanas diarias
  ...
  - _Estado_: 16/20 ops en el filtro definido (IC actual=+0.000 PNL=+8.97€)
  - _Datos_: n=16 IC=+0.000 PNL=+8.97€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=94 IC=-0.073 PNL=+10.61€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=94 IC=-0.073 PNL=+10.61€
