# Hipótesis automáticas — 2026-07-16 03:49 UTC
_Generado por shadow_postmortem.py sobre 16405 resoluciones (PNL=+3339.50€)_
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.214 (n=424)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.183)

- **PATRÓN** `py_entrada` > `0.695` → IC=+0.290 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.183)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.186 (n=1025)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.183)

- **PATRÓN** `libro_liquidez` > `4402.2111` → IC=+0.185 (n=582)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 4402.2111 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 17.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.191 (n=344)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 6.0 (IC base=+0.161)

- **PATRÓN** `py_entrada` < `0.265` → IC=+0.324 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=1069)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `7401.6146` → IC=+0.188 (n=312)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 7401.6146 (IC base=+0.161)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.223 (n=63)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.615` → IC=+0.251 (n=175)
...
- **PATRÓN** `py_entrada` < `0.225` → IC=+0.400 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.225 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `7240.499` → IC=+0.216 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7240.499 (IC base=+0.206)
...
- **PATRÓN** `py_entrada` < `0.605` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `py_entrada` < 0.605 (IC base=+0.136)

- **PATRÓN** `py_entrada` > `0.635` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.635 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7040.5617` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 7040.5617 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.214 (n=19)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `9.0` → IC=+0.293 (n=27)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.395` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.395 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `7674.945` → IC=+0.210 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7674.945 (IC base=+0.162)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.231 (n=195)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.223)

- **PATRÓN** `py_entrada` > `0.715` → IC=+0.349 (n=91)
...
- **PATRÓN** `py_entrada` < `0.275` → IC=+0.363 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `3766.7239` → IC=+0.215 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3766.7239 (IC base=+0.203)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.245 (n=45)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `5972.9638` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 5972.9638 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.150 (n=18)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 17.0 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.227 (n=20)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.129)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `4743.0687` → IC=+0.179 (n=51)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 4743.0687 (IC base=+0.129)
...
- **PATRÓN** `py_entrada` > `0.625` → IC=+0.282 (n=168)
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.254 (n=173)
...
- **PATRÓN** `hora_utc` > `19.0` → IC=+0.200 (n=18)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.156)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.222 (n=16)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.156)

- **PATRÓN** `py_entrada` < `0.585` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.585 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `2386.174` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2386.174 (IC base=+0.156)
...
### GBM_LATE_15M
- **PATRÓN** `dist_vwap_pct` > `0.9363` → IC=+0.129 (n=95)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.9363 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.21` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.21 (IC base=+0.109)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.134 (n=1217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0091 (IC base=+0.105)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.129 (n=1319)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 12.0 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.206` → IC=+0.124 (n=131)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 6.206 (IC base=+0.105)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `dist_vwap_pct` > `0.2776` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2776 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.331` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.331 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.176` → IC=+0.191 (n=53)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 3.176 (IC base=+0.061)
...
- **PATRÓN** `dist_vwap_pct` > `0.719` → IC=+0.138 (n=45)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.719 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.0` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.0 (IC base=+0.065)
...
- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.148 (n=208)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0108 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.141 (n=218)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 16.0 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.515` → IC=+0.235 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.515 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0135` → IC=+0.140 (n=404)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0135 (IC base=+0.130)

- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.136 (n=459)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0093 (IC base=+0.130)
...
- **PATRÓN** `sigma_h` > `0.0238` → IC=+0.173 (n=200)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0238 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.150 (n=441)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 6.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.152 (n=297)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.178` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.178 (IC base=+0.147)

- **PATRÓN** `sigma_h` > `0.0272` → IC=+0.207 (n=155)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0272 (IC base=+0.163)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.240 (n=171)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.3214` → IC=+0.130 (n=52)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.3214 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` < `0.5244` → IC=+0.138 (n=172)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.5244 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.696` → IC=+0.131 (n=155)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 7.696 (IC base=+0.163)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.220 (n=327)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.167 (n=739)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 18.0 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.3498` → IC=+0.207 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3498 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.022` → IC=+0.309 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.022 (IC base=+0.160)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.177 (n=732)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.191 (n=250)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 5.0 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` < `0.4317` → IC=+0.194 (n=505)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.4317 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.074` → IC=+0.271 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.074 (IC base=+0.161)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` > `0.0032` → IC=+0.152 (n=156)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0032 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.161 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 12.0 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.5034` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5034 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.074` → IC=+0.224 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.074 (IC base=+0.115)

- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.176 (n=183)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0028 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.157 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.297` → IC=+0.136 (n=138)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.297 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.17` → IC=+0.312 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.17 (IC base=+0.138)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.244 (n=88)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.159 (n=136)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 12.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.165 (n=201)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 18.0 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.3418` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.3418 (IC base=+0.143)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.141 (n=165)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0068 (IC base=+0.134)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.151 (n=187)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.187 (n=65)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 5.0 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.7422` → IC=+0.189 (n=43)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.7422 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.3828` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.3828 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.0` → IC=+0.235 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.0 (IC base=+0.134)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `3.243` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 3.243
  - _Potencial_: sin este filtro IC_bueno=+0.152 (n=110)

- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.214 (n=89)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0127 (IC base=+0.140)
...
- **PATRÓN** `dist_vwap_pct` > `0.3907` → IC=+0.192 (n=50)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.3907 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `1.0527` → IC=+0.146 (n=145)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 1.0527 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.082` → IC=+0.281 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.082 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0082` → IC=+0.196 (n=67)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0082 (IC base=+0.099)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.144 (n=71)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 5.0 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` < `0.2663` → IC=+0.167 (n=118)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.2663 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.243` → IC=+0.152 (n=110)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 3.243 (IC base=+0.099)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.021` → IC=+0.277 (n=155)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.021 (IC base=+0.250)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.252 (n=143)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.250)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.293 (n=138)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.250)

- **PATRÓN** `dist_vwap_pct` > `0.7553` → IC=+0.326 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7553 (IC base=+0.250)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.511` → IC=+0.361 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.511 (IC base=+0.250)

- **PATRÓN** `sigma_h` < `0.0161` → IC=+0.294 (n=163)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0161 (IC base=+0.289)

- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.323 (n=162)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0085 (IC base=+0.289)
...
- **PATRÓN** `dist_vwap_pct` < `0.5285` → IC=+0.309 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5285 (IC base=+0.289)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.933` → IC=+0.307 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.933 (IC base=+0.289)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.015` → IC=+0.188 (n=222)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.015 (IC base=+0.114)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.124 (n=690)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 18.0 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.3518` → IC=+0.169 (n=170)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.3518 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.1422` → IC=+0.154 (n=229)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1422 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.296` → IC=+0.338 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.296 (IC base=+0.114)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.122 (n=284)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 6.0 (IC base=+0.086)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` > `0.5186` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.5186 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` < `0.1111` → IC=+0.138 (n=56)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1111 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.972` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.972 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.123 (n=67)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 17.0 (IC base=+0.063)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.161 (n=57)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0039 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.2823` → IC=+0.160 (n=45)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2823 (IC base=+0.059)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.38` → IC=+0.382 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.38 (IC base=+0.059)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.626` → IC=+0.132 (n=17)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 7.626 (IC base=+0.012)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.135 (n=72)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 6.0 (IC base=+0.038)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.214 (n=194)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=205)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3403` → IC=+0.268 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3403 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.951` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.951 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.161` → IC=+0.225 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.161 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0254` → IC=+0.247 (n=77)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0254 (IC base=+0.194)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.256 (n=80)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` > `0.312` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.312 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` < `0.4971` → IC=+0.180 (n=170)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.4971 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.652` → IC=+0.189 (n=133)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 2.652 (IC base=+0.194)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.196 (n=44)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 15.0 (IC base=+0.136)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.5 (IC base=+0.136)

- **PATRÓN** `btc_momentum` |x|≤ `0.03` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `btc_momentum` |x|≤ 0.03 (IC base=+0.136)
...
### UPDOWN_GBM#15min
- **FILTRO** `sigma_ewma_delta_pct` > `17.133` → IC=-0.143 (n=26)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.133
  - _Potencial_: sin este filtro IC_bueno=+0.135 (n=143)

- **PATRÓN** `ibs_15` > `0.7179` → IC=+0.172 (n=263)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.86€ cuando `ibs_15` > 0.7179 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.7448` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.7448 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` < `0.5084` → IC=+0.141 (n=165)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5084 (IC base=+0.026)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.541` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 3.541 (IC base=+0.026)

- **PATRÓN** `ibs_15` < `0.0268` → IC=+0.122 (n=141)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` < 0.0268 (IC base=+0.047)

- **PATRÓN** `dist_vwap_pct` > `0.921` → IC=+0.125 (n=22)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.921 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` < `17.133` → IC=+0.135 (n=143)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 17.133 (IC base=+0.047)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2412` → IC=+0.126 (n=188)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.2412 (IC base=+0.074)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.158 (n=159)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 11.0 (IC base=+0.074)

- **PATRÓN** `ibs_15` < `0.9306` → IC=+0.136 (n=149)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.68€ cuando `ibs_15` < 0.9306 (IC base=+0.074)

- **PATRÓN** `ibs_15` > `0.6323` → IC=+0.189 (n=149)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.94€ cuando `ibs_15` > 0.6323 (IC base=+0.074)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.986` → IC=+0.149 (n=35)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 5.986 (IC base=+0.074)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `15.261` → IC=+0.121 (n=64)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 15.261 (IC base=+0.045)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7179 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.172 n=263). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6323 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.189 n=149). Confirma señal de reversión media → alinear con BUY_NO.
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M_PYCONFIRMADO#XRP#15min` — IC=+0.306 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M_PYCONFIRMADO#XRP` — IC=+0.306 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION` — IC=+0.281 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min` — IC=+0.281 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL` — IC=+0.281 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min` — IC=+0.281 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#SOL#15min` — IC=+0.167 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#SOL` — IC=+0.167 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2412 | +0.172 | -69.16€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1554 | +0.208 | +2.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 100 | +0.020 | -15.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 350 | +0.088 | -57.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 408 | +0.144 | +1.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 699 | +0.180 | -14.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 520 | +0.203 | -16.29€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 33 | +0.071 | -2.63€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 136 | +0.152 | +7.88€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#ETH | 858 | +0.171 | -8.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 515 | +0.214 | +15.30€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 33 | -0.100 | -11.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 174 | +0.102 | -23.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 136 | +0.159 | +10.81€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL | 847 | +0.167 | -42.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 511 | +0.208 | +6.40€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 34 | +0.083 | -0.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 166 | +0.095 | -30.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 136 | +0.116 | -17.39€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 8 | +0.000 | -3.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 8 | +0.000 | -3.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 30 | +0.281 | +0.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 30 | +0.281 | +0.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 30 | +0.281 | +0.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 30 | +0.281 | +0.32€ | 0 | 0 |
| ✅ GBM_LATE_15M | 4774 | +0.103 | +1496.16€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 4774 | +0.103 | +1496.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1144 | +0.065 | +162.75€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1144 | +0.065 | +162.75€ | 0 | 3 |
| ✅ GBM_LATE_15M#ETH | 1150 | +0.077 | +204.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1150 | +0.077 | +204.52€ | 1 | 6 |
| ✅ GBM_LATE_15M#SOL | 1275 | +0.111 | +523.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1275 | +0.111 | +523.34€ | 1 | 6 |
| ✅ GBM_LATE_15M#XRP | 1205 | +0.155 | +605.55€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1205 | +0.155 | +605.55€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2012 | +0.150 | +1177.71€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2012 | +0.150 | +1177.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 513 | +0.110 | +245.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 513 | +0.110 | +245.76€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 534 | +0.131 | +258.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 534 | +0.131 | +258.04€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 543 | +0.111 | +239.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 543 | +0.111 | +239.32€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 422 | +0.271 | +434.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 422 | +0.271 | +434.58€ | 0 | 11 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 62 | +0.094 | +20.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 62 | +0.094 | +20.51€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 34 | +0.306 | +23.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 34 | +0.306 | +23.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1977 | +0.091 | +598.08€ | 0 | 6 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1977 | +0.091 | +598.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 488 | +0.057 | +87.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 488 | +0.057 | +87.47€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 454 | +0.024 | +16.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 454 | +0.024 | +16.88€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 472 | +0.061 | +97.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 472 | +0.061 | +97.25€ | 1 | 6 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 563 | +0.197 | +396.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 563 | +0.197 | +396.48€ | 0 | 11 |
...
| ✅ LEADLAG_BTC_XRP_15M | 134 | +0.096 | +30.14€ | 0 | 5 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 134 | +0.096 | +30.14€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 134 | +0.096 | +30.14€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 134 | +0.096 | +30.14€ | 0 | 5 |
| ✅ ORDER_FLOW_5M | 1611 | +0.011 | +11.84€ | 1 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1475 | +0.007 | -0.76€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 197 | +0.043 | +5.96€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 197 | +0.043 | +5.96€ | 0 | 1 |
| ✅ ORDER_FLOW_5M#BTC | 291 | -0.019 | -5.24€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 291 | -0.019 | -5.24€ | 2 | 1 |
| ✅ ORDER_FLOW_5M#DOGE | 215 | -0.002 | -2.61€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#DOGE#5min | 215 | -0.002 | -2.61€ | 2 | 0 |
| ✅ ORDER_FLOW_5M#ETH | 257 | -0.017 | -7.96€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#ETH#5min | 257 | -0.017 | -7.96€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL | 322 | +0.040 | +13.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 322 | +0.040 | +13.28€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1585 | +0.009 | +71.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1327 | +0.036 | +108.19€ | 1 | 7 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 127 | -0.058 | -10.76€ | 7 | 0 |
| ✅ UPDOWN_GBM#BNB | 83 | +0.065 | +17.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 83 | +0.065 | +17.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 409 | +0.025 | +25.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 328 | +0.064 | +38.66€ | 1 | 10 |
...
| ✅ UPDOWN_GBM#ETH | 760 | +0.017 | +35.86€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 667 | +0.034 | +46.91€ | 2 | 4 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 14 | +0.131 | -0.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 14 | +0.131 | -0.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 5 | +0.018 | -0.50€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 5 | +0.018 | -0.50€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 9 | +0.102 | -0.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 9 | +0.102 | -0.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 101 | +0.199 | +29.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 101 | +0.199 | +29.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 5 | -0.018 | +2.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 5 | -0.018 | +2.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 14 | +0.087 | +2.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 14 | +0.087 | +2.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 28 | +0.233 | +6.21€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 28 | +0.233 | +6.21€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 34 | +0.167 | +11.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 34 | +0.167 | +11.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 16 | +0.178 | +3.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 16 | +0.178 | +3.97€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.146) — sin ventaja clara. oversold(IBS<0.3): IC=+0.009 n=477 | neutral: IC=-0.021 n=372 | overbought(IBS>0.7): IC=+0.124 n=392
  - _Datos_: n=1310 IC=+0.041 PNL=+124.95€
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 187 ops con delta_ratio | SOL: 220 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.102 n=9530 | tras_1loss IC=+0.067 n=6661 | tras_2loss IC=+0.034 n=2852/40 | gap=+0.067 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=97 IC=+0.066 PNL=+11.79€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=97 IC=+0.066 PNL=+11.79€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=1458 IC=+0.016 PNL=+85.15€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1458 IC=+0.016 PNL=+85.15€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=700 IC=+0.026 PNL=+42.79€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=700 IC=+0.026 PNL=+42.79€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=328 IC=+0.064 PNL=+38.66€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=328 IC=+0.064 PNL=+38.66€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=702 IC=+0.074 PNL=+90.73€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=702 IC=+0.074 PNL=+90.73€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=592 IC=+0.032 PNL=+41.55€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=592 IC=+0.032 PNL=+41.55€
...
**〰️ H-CUSTOM-OF-VOLUMEN-ALTO** — ORDER_FLOW_5M con total_vol_5m alto — ¿volumen extremo mejora el IC?
  ...
  - _Estado_: n=360 IC=-0.008 PNL=-8.37€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=360 IC=-0.008 PNL=-8.37€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=76 IC=+0.026 PNL=+30.64€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=76 IC=+0.026 PNL=+30.64€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13947 IC=+0.105 PNL=+3415.39€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13947 IC=+0.105 PNL=+3415.39€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=153 IC=+0.003 PNL=+1.63€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=153 IC=+0.003 PNL=+1.63€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=848 IC=-0.005 PNL=+13.26€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=848 IC=-0.005 PNL=+13.26€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=404 PNL=+135.30€
  - _Datos_: n=404 IC=+0.160 PNL=+135.30€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=481 IC=-0.080 PNL=+81.32€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=481 IC=-0.080 PNL=+81.32€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=609 IC=+0.055 PNL=+70.05€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=609 IC=+0.055 PNL=+70.05€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.144 > 0.08 con n=296 PNL=+89.03€
  - _Datos_: n=296 IC=+0.144 PNL=+89.03€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.207 n=131) pero sin cruzar ≥2 pares más — BNB: n=18 IC=+0.000; DOGE: n=4 IC=+0.067; ETH: n=129 IC=+0.103 ✓; SOL: n=7 IC=-0.019; XRP: n=7 IC=+0.019
  - _Datos_: n=131 IC=+0.207 PNL=+56.85€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.181 < -0.1 con n=396 PNL=-79.86€
  - _Datos_: n=396 IC=-0.181 PNL=-79.86€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.246 > 0.2 con n=341 PNL=+230.72€
  - _Datos_: n=341 IC=+0.246 PNL=+230.72€
...
**⏳ H-CUSTOM-OF5M-SMARTMONEY-CONTRARIO** — ORDER_FLOW_5M SOL BUY_NO — smart money EN CONTRA del flujo CEX, no a favor, predice mejor
  ...
  - _Estado_: 21/40 ops en el filtro definido (IC actual=+0.152 PNL=+6.46€)
  - _Datos_: n=21 IC=+0.152 PNL=+6.46€

**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: sigma_ewma_delta_pct = (sigma_h_ewma10-sigma_h)/sigma_h. Verificado ad-hoc n=47: cuando la vol reciente (EWMA half-life 10min) supera la ventana plana, hit sube de 59.5% (agregado ETH) a 66.0%, ic_bayes=+0.153. Efecto NO uniforme entre activos (ver hermanas BTC/XRP) -- desagregar por activo es obligatorio, el agregado GBM_LATE_15M diluye esto a ruido.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en ETH#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.156 > 0.08 con n=152 PNL=+57.41€
  - _Datos_: n=152 IC=+0.156 PNL=+57.41€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.114 > 0.08 con n=138 PNL=+54.55€
  - _Datos_: n=138 IC=+0.114 PNL=+54.55€
...
**🔶 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.154 n=189) pero sin cruzar ≥2 pares más — BTC: n=139 IC=-0.004; ETH: n=106 IC=+0.000; SOL: n=201 IC=+0.057 ✓
  - _Datos_: n=189 IC=+0.154 PNL=+111.47€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.198 > 0.08 con n=127 PNL=+1.13€
  - _Datos_: n=127 IC=+0.198 PNL=+1.13€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.246 > 0.08 con n=191 PNL=-10.46€
  - _Datos_: n=191 IC=+0.246 PNL=-10.46€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.136 n=64) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=64 IC=+0.136 PNL=+25.05€
...
**🔶 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA en ETH (IC=+0.254 n=59) pero sin cruzar ≥2 pares más — BNB: n=11 IC=+0.064; BTC: n=12 IC=+0.043; DOGE: n=9 IC=+0.102; SOL: n=8 IC=+0.000; XRP: n=9 IC=+0.061
  - _Datos_: n=59 IC=+0.254 PNL=+32.47€
