# Hipótesis automáticas — 2026-07-06 00:15 UTC
_Generado por shadow_postmortem.py sobre 4075 resoluciones (PNL=+199.16€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.146 (n=97)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0086 (IC base=+0.032)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.162 (n=75)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` < 0.0613 (IC base=+0.032)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0613 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.162 n=75). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1206 | +0.093 | +298.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1206 | +0.093 | +298.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 315 | +0.033 | +30.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 315 | +0.033 | +30.81€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 971 | -0.035 | -51.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 732 | -0.012 | -21.25€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.068) — sin ventaja clara. oversold(IBS<0.3): IC=-0.005 n=208 | neutral: IC=-0.072 n=164 | overbought(IBS>0.7): IC=-0.040 n=187
  - _Datos_: n=581 IC=-0.032 PNL=-25.98€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.029 n=2045 | tras_1loss IC=-0.002 n=1917 | tras_2loss IC=-0.022 n=946/40 | gap=+0.051 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=848 IC=-0.031 PNL=-37.66€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=848 IC=-0.031 PNL=-37.66€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=331 IC=-0.007 PNL=-28.63€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=331 IC=-0.007 PNL=-28.63€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=270 IC=+0.004 PNL=+4.06€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=270 IC=+0.004 PNL=+4.06€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1625 IC=+0.061 PNL=+274.34€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1625 IC=+0.061 PNL=+274.34€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 88/120 ops en el filtro definido (IC actual=+0.167 PNL=+23.89€)
  - _Datos_: n=88 IC=+0.167 PNL=+23.89€
