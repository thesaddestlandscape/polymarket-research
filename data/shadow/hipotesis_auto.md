# Hipótesis automáticas — 2026-07-12 13:40 UTC
_Generado por shadow_postmortem.py sobre 10971 resoluciones (PNL=+1970.54€)_
...
- **PATRÓN** `py_entrada` > `0.585` → IC=+0.253 (n=342)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.585 (IC base=+0.222)

- **PATRÓN** `libro_liquidez` > `2363.0481` → IC=+0.236 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2363.0481 (IC base=+0.222)
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6191 | tras_1loss IC=+0.044 n=4643 | tras_2loss IC=+0.011 n=2082/40 | gap=+0.080 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.082 n=484/40 PNL=+112.18€ | H=15h UTC: IC=+0.087 n=444/40 PNL=+95.17€ | H=17h UTC: IC=+0.122 n=382/40 PNL=+123.97€ | H=19h UTC: IC=+0.063 n=385/40 PNL=+49.78€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8513 IC=+0.096 PNL=+2046.43€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8513 IC=+0.096 PNL=+2046.43€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.161 > 0.08 con n=57 PNL=-2.36€
  - _Datos_: n=57 IC=+0.161 PNL=-2.36€
