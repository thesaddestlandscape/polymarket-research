# Hipótesis automáticas — 2026-08-24 16:04 UTC
_Generado por shadow_postmortem.py sobre 139985 resoluciones (PNL=+9673.82€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `154.94` → IC=-0.255 (n=1957)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.94
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=5873)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `149.38` → IC=-0.176 (n=220)
...
- **FILTRO** `n_ballenas` < `5.0` → IC=-0.190 (n=140)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=488)

- **FILTRO** `restante_s_al_confirmar` < `364.84` → IC=-0.286 (n=157)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 364.84
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=471)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `98.45` → IC=-0.411 (n=222)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 98.45
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=669)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `165.51` → IC=-0.148 (n=521)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.51
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=1564)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `148.68` → IC=-0.274 (n=484)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.68
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1455)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `166.37` → IC=-0.309 (n=463)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 166.37
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=943)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.188 (n=4664)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=1441)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2373.5135` → IC=+0.174 (n=1391)
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.261 (n=2612)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.184 (n=2677)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `1789.0312` → IC=+0.173 (n=2216)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1789.0312 (IC base=+0.134)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.226 (n=545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.214 (n=677)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.187 (n=496)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.180 (n=710)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.135 (n=1062)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 5.0 (IC base=+0.128)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.133 (n=915)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.289 (n=367)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.283)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.291 (n=410)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.283)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.324 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `3614.8589` → IC=+0.299 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3614.8589 (IC base=+0.283)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=844)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.196)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.204 (n=720)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.305` → IC=+0.301 (n=360)
...
- **PATRÓN** `libro_liquidez` > `817.0971` → IC=+0.231 (n=530)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=3950)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 5.0 (IC base=+0.193)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.199 (n=3427)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.179 (n=674)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 11.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.185 (n=983)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 17.0 (IC base=+0.176)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.195 (n=1021)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.74 (IC base=+0.176)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.241 (n=901)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.233)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.236 (n=777)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=957)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.196)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.197 (n=840)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 15.0 (IC base=+0.196)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.202 (n=662)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=9927)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.225 (n=6991)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.194)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1921)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.165 (n=1313)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.288 (n=738)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.209 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.160)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.248 (n=1396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.262 (n=733)
...
- **PATRÓN** `lag_apertura_s` < `6.78` → IC=+0.147 (n=1565)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 6.78 (IC base=+0.129)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.214 (n=590)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.138)

- **PATRÓN** `restante_min` < `3.87` → IC=+0.151 (n=591)

  - _Acción_: Kelly boost +0.75€ cuando `restante_min` < 3.87 (IC base=+0.138)

- **PATRÓN** `restante_min` > `4.86` → IC=+0.161 (n=813)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` > 4.86 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.150 (n=1590)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 15.0 (IC base=+0.138)

- **PATRÓN** `lag_apertura_s` < `6.31` → IC=+0.166 (n=588)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 6.31 (IC base=+0.138)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.188 (n=616)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.37 (IC base=+0.120)

- **PATRÓN** `restante_min` < `3.97` → IC=+0.136 (n=597)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 3.97 (IC base=+0.120)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.151 (n=645)
...
- **PATRÓN** `lag_apertura_s` < `3.46` → IC=+0.154 (n=596)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.303 (n=267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.309 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `1685.2184` → IC=+0.345 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1685.2184 (IC base=+0.283)
...
- **PATRÓN** `dist_vwap_pct` > `0.2623` → IC=+0.242 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2623 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.7164` → IC=+0.231 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7164 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.035` → IC=+0.187 (n=785)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 5.035 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.231 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.0991` → IC=+0.247 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0991 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` < `0.1062` → IC=+0.134 (n=921)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1062 (IC base=+0.070)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5067` → IC=+0.138 (n=854)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.5067 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `1.4673` → IC=+0.133 (n=970)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4673 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.2114` → IC=+0.124 (n=1319)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.2114 (IC base=+0.029)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.273 (n=95)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.260 (n=285)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.222)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.222 (n=286)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 16.0 (IC base=+0.222)

- **PATRÓN** `ibs_20min` > `0.4365` → IC=+0.232 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4365 (IC base=+0.222)

- **PATRÓN** `dist_vwap_pct` > `0.2069` → IC=+0.243 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2069 (IC base=+0.222)

- **PATRÓN** `dist_vwap_pct` < `0.7305` → IC=+0.227 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7305 (IC base=+0.222)
...
- **PATRÓN** `volumen_regimen` < `1.3035` → IC=+0.228 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.3035 (IC base=+0.222)

- **PATRÓN** `volumen_regimen` > `1.1132` → IC=+0.248 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1132 (IC base=+0.222)

- **PATRÓN** `volumen_pendiente_norm` < `0.0775` → IC=+0.233 (n=245)
...
- **PATRÓN** `libro_liquidez` > `13599.3486` → IC=+0.263 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13599.3486 (IC base=+0.222)
...
- **FILTRO** `ibs_20min` > `0.7526` → IC=-0.142 (n=291)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7526
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=876)

- **FILTRO** `sigma_ewma_delta_pct` > `4.862` → IC=-0.151 (n=250)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.862
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=917)
...
- **FILTRO** `sigma_h` > `0.0239` → IC=-0.139 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `ibs_20min` > `0.7692` → IC=-0.169 (n=258)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7692
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=781)

- **FILTRO** `sigma_ewma_delta_pct` > `6.558` → IC=-0.178 (n=172)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.134 (n=1080)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0071 (IC base=+0.054)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.254 (n=794)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.4379` → IC=+0.267 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4379 (IC base=+0.054)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.345` → IC=+0.124 (n=1358)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 2.345 (IC base=+0.054)

- **PATRÓN** `volumen_regimen` > `1.1726` → IC=+0.200 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1726 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` < `0.1155` → IC=+0.164 (n=1024)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.1155 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` > `0.2482` → IC=+0.216 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2482 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` < `1.4966` → IC=+0.179 (n=353)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4966 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` > `2.907` → IC=+0.176 (n=353)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.907 (IC base=+0.054)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.277 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.054)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.168 (n=1075)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.1 (IC base=+0.034)

- **PATRÓN** `dist_vwap_pct` > `0.6092` → IC=+0.228 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6092 (IC base=+0.034)

- **PATRÓN** `dist_vwap_pct` < `0.1326` → IC=+0.193 (n=607)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.1326 (IC base=+0.034)

- **PATRÓN** `volumen_regimen` > `0.632` → IC=+0.203 (n=659)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.254 (n=307)
...
- **FILTRO** `ibs_20min` > `0.8857` → IC=-0.133 (n=246)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8857
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=742)

- **PATRÓN** `dist_vwap_pct` > `0.8543` → IC=+0.155 (n=56)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.8543 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` > `1.2518` → IC=+0.196 (n=44)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 1.2518 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` < `1.3488` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.3488 (IC base=-0.024)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.160 (n=98)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=299)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.150 (n=58)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=850)

- **PATRÓN** `dist_vwap_pct` > `0.6615` → IC=+0.300 (n=23)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7258` → IC=+0.167 (n=22)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.7258 (IC base=-0.064)
...
- **FILTRO** `ibs_20min` > `0.7333` → IC=-0.146 (n=207)
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.288 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` > `1.2538` → IC=+0.339 (n=128)
...
- **PATRÓN** `volumen_regimen` > `1.0233` → IC=+0.252 (n=220)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0233 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` < `0.081` → IC=+0.211 (n=410)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2393` → IC=+0.278 (n=79)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2393 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` < `2.2494` → IC=+0.225 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2494 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.227 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `2635.1118` → IC=+0.233 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2635.1118 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.273 (n=324)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0072 (IC base=+0.261)

- **PATRÓN** `drift_60min` |x|≤ `0.3988` → IC=+0.274 (n=427)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3988 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.293 (n=254)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` < `0.2788` → IC=+0.325 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2788 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` < `0.2297` → IC=+0.271 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2297 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.5` → IC=+0.282 (n=122)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.337 (n=47)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` > `2.1844` → IC=+0.278 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1844 (IC base=+0.261)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.241 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 39.0 (IC base=+0.261)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.201 (n=929)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.166 (n=2052)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.7694` → IC=+0.251 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7694 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.145` → IC=+0.260 (n=896)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.145 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` > `0.7012` → IC=+0.177 (n=1251)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.7012 (IC base=+0.159)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3263` → IC=+0.157 (n=1586)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.3263 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1649)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `3635.1946` → IC=+0.199 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3635.1946 (IC base=+0.159)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.193 (n=844)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 135.0 (IC base=+0.159)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.198 (n=1771)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0078 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.3502` → IC=+0.196 (n=1771)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.3502 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.214 (n=805)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.243 (n=1771)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2038` → IC=+0.179 (n=1450)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2038 (IC base=+0.182)
...
- **PATRÓN** `volumen_regimen` < `1.1821` → IC=+0.161 (n=1471)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1821 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `0.8575` → IC=+0.173 (n=980)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8575 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.294` → IC=+0.227 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.294 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` < `1.5829` → IC=+0.182 (n=513)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5829 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.707` → IC=+0.203 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.707 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `216.0` → IC=+0.164 (n=730)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 216.0 (IC base=+0.182)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2735` → IC=+0.286 (n=40)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2735 (IC base=+0.186)
...
- **PATRÓN** `drift_60min` |x|≤ `0.261` → IC=+0.210 (n=184)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.261 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.228 (n=248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `0.4339` → IC=+0.263 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4339 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` > `0.1732` → IC=+0.227 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1732 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.711` → IC=+0.342 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.711 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `0.6414` → IC=+0.223 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6414 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.0999` → IC=+0.272 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0999 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `1.4523` → IC=+0.214 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4523 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.4757` → IC=+0.244 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4757 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `9590.9584` → IC=+0.216 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9590.9584 (IC base=+0.197)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.184 (n=93)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 125.0 (IC base=+0.197)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.199 (n=307)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0053 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.3509` → IC=+0.167 (n=349)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3509 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` < `0.4496` → IC=+0.204 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4496 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.5253` → IC=+0.166 (n=402)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.5253 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.526` → IC=+0.250 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.526 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.0395` → IC=+0.150 (n=307)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.0395 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6146` → IC=+0.163 (n=348)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6146 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1018` → IC=+0.160 (n=98)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.1018 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.8946` → IC=+0.207 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8946 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.208 (n=135)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0109 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` > `0.8621` → IC=+0.228 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8621 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `0.6671` → IC=+0.270 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6671 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.939` → IC=+0.287 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.939 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` > `0.6181` → IC=+0.132 (n=403)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.6181 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` > `0.1015` → IC=+0.136 (n=138)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` > 0.1015 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` > `1.5734` → IC=+0.126 (n=332)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.5734 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2764.0859` → IC=+0.208 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2764.0859 (IC base=+0.116)
...
- **PATRÓN** `sigma_h` > `0.021` → IC=+0.211 (n=202)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.021 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.1583` → IC=+0.183 (n=197)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.1583 (IC base=+0.170)
...
- **PATRÓN** `ibs_20min` > `0.8` → IC=+0.229 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` > `1.6195` → IC=+0.250 (n=130)
...
- **PATRÓN** `volumen_regimen` < `1.2315` → IC=+0.179 (n=446)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 1.2315 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.8419` → IC=+0.186 (n=297)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.8419 (IC base=+0.170)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2016` → IC=+0.185 (n=360)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.2016 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `1.8289` → IC=+0.176 (n=273)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.8289 (IC base=+0.170)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=498)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `2637.4126` → IC=+0.179 (n=297)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2637.4126 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.269 (n=180)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.222)

- **PATRÓN** `drift_60min` |x|≤ `0.4944` → IC=+0.229 (n=407)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4944 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.242 (n=192)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1273` → IC=+0.314 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1273 (IC base=+0.222)

- **PATRÓN** `dist_vwap_pct` < `0.9791` → IC=+0.232 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9791 (IC base=+0.222)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.892` → IC=+0.265 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.892 (IC base=+0.222)

- **PATRÓN** `volumen_regimen` > `0.6252` → IC=+0.241 (n=407)
...
- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.182 (n=190)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 30.0 (IC base=+0.222)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.210 (n=788)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.152 (n=2391)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 6.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.9465` → IC=+0.290 (n=1068)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9465 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `1.0378` → IC=+0.254 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0378 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.408` → IC=+0.230 (n=1438)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.408 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.8902` → IC=+0.150 (n=1088)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.8902 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `1.0892` → IC=+0.150 (n=740)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.0892 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.181 (n=412)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.9171` → IC=+0.153 (n=1361)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.9171 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=1886)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `3018.1508` → IC=+0.189 (n=1068)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 3018.1508 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `171.0` → IC=+0.191 (n=861)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 171.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.206 (n=2101)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0086 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.4063` → IC=+0.200 (n=2101)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4063 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.190 (n=1912)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5455` → IC=+0.242 (n=2101)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5455 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.6843` → IC=+0.175 (n=1701)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.6843 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.379` → IC=+0.201 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.379 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.61` → IC=+0.193 (n=1972)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.61 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` < `0.6224` → IC=+0.172 (n=540)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.6224 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `1.1974` → IC=+0.181 (n=540)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 1.1974 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.2332` → IC=+0.240 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2332 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.2519` → IC=+0.198 (n=638)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.2519 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.141 (n=656)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 57.0 (IC base=+0.186)
...
- **PATRÓN** `volumen_regimen` < `0.6631` → IC=+0.186 (n=119)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6631 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `1.1267` → IC=+0.183 (n=162)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.1267 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` < `0.0707` → IC=+0.187 (n=273)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.0707 (IC base=+0.163)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5592` → IC=+0.201 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5592 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.3851` → IC=+0.201 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3851 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `11201.4083` → IC=+0.204 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11201.4083 (IC base=+0.163)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.166 (n=324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.3627` → IC=+0.203 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3627 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.4196` → IC=+0.193 (n=161)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.4196 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.499` → IC=+0.184 (n=175)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 4.499 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.9242` → IC=+0.170 (n=237)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.9242 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.224` → IC=+0.161 (n=119)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.224 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2765` → IC=+0.317 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2765 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4275` → IC=+0.207 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4275 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `3050.8475` → IC=+0.186 (n=317)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 3050.8475 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `235.0` → IC=+0.172 (n=227)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 235.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.247 (n=97)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.4769` → IC=+0.146 (n=289)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4769 (IC base=+0.132)
...
- **PATRÓN** `dist_vwap_pct` < `0.7697` → IC=+0.147 (n=301)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.7697 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.454` → IC=+0.250 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.454 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.586` → IC=+0.157 (n=97)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.586 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `0.6375` → IC=+0.139 (n=258)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6375 (IC base=+0.132)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0895` → IC=+0.175 (n=204)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.0895 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.162 (n=232)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `4334.9367` → IC=+0.139 (n=192)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 4334.9367 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.211 (n=95)
...
- **PATRÓN** `ibs_20min` > `0.9231` → IC=+0.274 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9231 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.98` → IC=+0.250 (n=90)
...
- **PATRÓN** `libro_liquidez` > `2751.5045` → IC=+0.279 (n=138)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1459` → IC=+0.148 (n=177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.1459 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.185 (n=404)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5833 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.4479` → IC=+0.126 (n=359)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.4479 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.091` → IC=+0.126 (n=386)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.091 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `0.7014` → IC=+0.120 (n=177)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 0.7014 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.183` → IC=+0.125 (n=134)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 1.183 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` < `0.1471` → IC=+0.132 (n=270)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` < 0.1471 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.158 (n=109)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `2.4231` → IC=+0.204 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4231 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2407.6604` → IC=+0.149 (n=183)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2407.6604 (IC base=+0.106)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0166` → IC=+0.221 (n=231)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0166 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.193 (n=255)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `1.2344` → IC=+0.279 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2344 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.369` → IC=+0.253 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.369 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` < `0.6191` → IC=+0.192 (n=170)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.6191 (IC base=+0.172)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3039` → IC=+0.175 (n=404)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.3039 (IC base=+0.172)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.186 (n=565)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `3085.6316` → IC=+0.192 (n=170)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 3085.6316 (IC base=+0.172)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.277 (n=370)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.208)

- **PATRÓN** `drift_60min` |x|≤ `0.4043` → IC=+0.233 (n=488)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4043 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.224 (n=512)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` < `0.49` → IC=+0.277 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.49 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` < `0.7191` → IC=+0.219 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7191 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.073` → IC=+0.269 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.073 (IC base=+0.208)
...
- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.149 (n=266)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 36.0 (IC base=+0.208)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.146 (n=538)

- **PATRÓN** `dist_vwap_pct` > `1.6509` → IC=+0.206 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6509 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` > `1.3488` → IC=+0.142 (n=79)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.3488 (IC base=+0.067)

- **PATRÓN** `libro_liquidez` > `9863.1301` → IC=+0.155 (n=82)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 9863.1301 (IC base=+0.067)

- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.199 (n=277)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0044 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.3195` → IC=+0.162 (n=365)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.3195 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.145 (n=167)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6103` → IC=+0.159 (n=365)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.6103 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.2241` → IC=+0.149 (n=357)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.2241 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.522` → IC=+0.172 (n=196)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 3.522 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.335` → IC=+0.162 (n=415)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.335 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `0.7744` → IC=+0.138 (n=371)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.7744 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.0772` → IC=+0.156 (n=210)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.0772 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.625` → IC=+0.166 (n=411)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.625 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.423` → IC=+0.139 (n=411)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.423 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=538)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7478.3992` → IC=+0.157 (n=415)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 7478.3992 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` > `9.0` → IC=+0.167 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 9.0 (IC base=+0.077)

- **PATRÓN** `dist_vwap_pct` > `1.5837` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.5837 (IC base=+0.077)

- **PATRÓN** `libro_liquidez` > `7464.2403` → IC=+0.128 (n=111)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 7464.2403 (IC base=+0.077)

- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.278 (n=43)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.2862` → IC=+0.227 (n=86)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2862 (IC base=+0.169)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.230 (n=87)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.1632` → IC=+0.224 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1632 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.6108` → IC=+0.189 (n=120)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.6108 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.54` → IC=+0.273 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.54 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.2693` → IC=+0.223 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2693 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` < `0.1267` → IC=+0.190 (n=127)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1267 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `2.4591` → IC=+0.224 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4591 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `1.4889` → IC=+0.175 (n=112)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.4889 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `7633.9254` → IC=+0.185 (n=128)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 7633.9254 (IC base=+0.169)
...
- **PATRÓN** `liq_usd_total` > `76612.5` → IC=+0.182 (n=20)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `liq_usd_total` > 76612.5 (IC base=-0.025)
...
- **FILTRO** `ibs_20min` > `0.9593` → IC=-0.208 (n=63)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.150 (n=595)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1894)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.238 (n=585)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1808)

- **FILTRO** `ibs_20min` > `0.2791` → IC=-0.213 (n=598)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2791
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1795)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.178 (n=116)
...
- **FILTRO** `ibs_20min` < `0.7244` → IC=-0.192 (n=92)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=279)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.212 (n=130)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=276)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.227 (n=137)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.214 (n=110)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=320)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.167 (n=106)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=324)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` > `0.62` → IC=-0.272 (n=90)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=284)

- **FILTRO** `drift_20min_pct` |x|> `0.3439` → IC=-0.195 (n=93)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3439
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=281)

- **FILTRO** `ibs_20min` > `0.2759` → IC=-0.226 (n=93)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2759
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=281)

- **FILTRO** `ballena_activa_n` > `1.0` → IC=-0.158 (n=232)
...
- **FILTRO** `py_entrada` < `0.48` → IC=-0.170 (n=104)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=318)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=539)

### MOMENTUM_IBS_5M_BALLENA
- **FILTRO** `hora_utc` < `6.0` → IC=-0.148 (n=1259)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4764)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.279 (n=1424)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=4599)

- **FILTRO** `ibs_7min` < `0.7425` → IC=-0.226 (n=1504)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7425
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=4519)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.174 (n=2024)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3999)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.220 (n=1836)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=5555)

- **FILTRO** `ibs_7min` > `0.7126` → IC=-0.168 (n=1847)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7126
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=5544)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.316 (n=199)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=636)

- **FILTRO** `ibs_7min` < `1.0` → IC=-0.175 (n=565)

  - _Acción_: SKIP cuando `ibs_7min` < 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=270)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.237 (n=207)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=628)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.243 (n=301)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=912)

- **FILTRO** `drift_7min_pct` |x|> `0.1441` → IC=-0.159 (n=412)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1441
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=801)

- **FILTRO** `ibs_7min` > `0.8475` → IC=-0.211 (n=303)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8475
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=910)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.139 (n=308)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=936)

- **FILTRO** `py_entrada` < `0.39` → IC=-0.242 (n=293)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=951)

- **FILTRO** `ballena_activa_n` > `142.0` → IC=-0.165 (n=308)

  - _Acción_: SKIP cuando `ballena_activa_n` > 142.0
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=936)

- **FILTRO** `py_entrada` > `0.55` → IC=-0.199 (n=307)

  - _Acción_: SKIP cuando `py_entrada` > 0.55
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=977)
...
- **FILTRO** `ibs_7min` < `0.2174` → IC=-0.279 (n=206)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=624)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.284 (n=206)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=624)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.264 (n=282)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1003)

- **FILTRO** `ibs_7min` > `0.2857` → IC=-0.168 (n=432)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.185 (n=211)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=806)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.265 (n=241)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=776)

- **FILTRO** `ibs_7min` < `0.7815` → IC=-0.191 (n=254)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7815
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=763)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.214 (n=250)
...
- **FILTRO** `ibs_7min` > `0.1774` → IC=-0.159 (n=350)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1774
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=680)

- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.210 (n=257)

  - _Acción_: SKIP cuando `ballena_activa_n` > 37.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=773)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.215 (n=272)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=840)

- **FILTRO** `ibs_7min` < `0.7759` → IC=-0.189 (n=278)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7759
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=834)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.195 (n=277)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=835)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.170 (n=328)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1004)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.272 (n=235)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=750)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.218 (n=236)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=749)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.277 (n=253)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=994)

- **FILTRO** `ibs_7min` > `0.8049` → IC=-0.139 (n=311)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8049
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=936)
...
- **PATRÓN** `streak_len` < `3.0` → IC=+0.132 (n=104)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `streak_len` < 3.0 (IC base=+0.062)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.130 (n=136)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 16.0 (IC base=+0.079)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.151 (n=61)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 25.0 (IC base=+0.079)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1056)
...
- **PATRÓN** `ibs_15` < `0.1282` → IC=+0.184 (n=93)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` < 0.1282 (IC base=+0.038)
...
- **FILTRO** `sigma_h` > `0.0092` → IC=-0.146 (n=767)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0092
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1491)
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.659` → IC=-0.200 (n=298)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 16.659
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=1960)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1079` → IC=+0.154 (n=53)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.77€ cuando `delta_ratio_macro` |x|> 0.1079 (IC base=-0.100)
...
- **PATRÓN** `dist_vwap_pct` < `0.1474` → IC=+0.172 (n=56)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1474 (IC base=-0.100)
...
- **FILTRO** `sigma_h` > `0.007` → IC=-0.242 (n=126)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.204 (n=380)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.238 (n=120)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.206 (n=386)

- **FILTRO** `sigma_ewma_delta_pct` > `24.589` → IC=-0.247 (n=81)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 24.589
  - _Potencial_: sin este filtro IC_bueno=-0.207 (n=425)
...
- **FILTRO** `drift_60min` |x|> `0.7937` → IC=-0.145 (n=184)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.7937
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=554)

- **FILTRO** `drift_15min` |x|> `1.4939` → IC=-0.150 (n=184)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.4939
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=554)

- **FILTRO** `sigma_ewma_delta_pct` > `14.969` → IC=-0.206 (n=90)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1282 sube el IC de +0.038 a +0.184 en UPDOWN_GBM#XRP#15min (n=93). Ya aplicado como kelly_boost=+0.92€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.53 sube el IC de -0.100 a +0.287 en UPDOWN_GBM_15M_TARDIO (n=59). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 5938 | -0.098 | -691.66€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 628 | -0.081 | -105.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5310 | -0.099 | -586.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 881 | -0.005 | -97.02€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 881 | -0.005 | -97.02€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 628 | -0.081 | -105.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 628 | -0.081 | -105.37€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1939 | -0.067 | -59.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1939 | -0.067 | -59.63€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1406 | -0.174 | -236.17€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1406 | -0.174 | -236.17€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 26608 | +0.113 | -1845.59€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5149 | +0.187 | -180.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 18345 | +0.091 | -1596.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3008 | +0.124 | -20.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3083 | +0.059 | -557.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 18 | -0.045 | +2.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3060 | +0.061 | -553.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5588 | +0.134 | -128.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1441 | +0.194 | -91.06€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3054 | +0.109 | -77.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1051 | +0.134 | +62.64€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3087 | +0.074 | -437.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 18 | +0.045 | -1.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3068 | +0.074 | -434.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6003 | +0.129 | -70.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1875 | +0.171 | +0.47€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3054 | +0.111 | -49.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1062 | +0.106 | -12.26€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5766 | +0.128 | -428.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1781 | +0.203 | -90.57€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3045 | +0.085 | -259.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 895 | +0.132 | -70.64€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3081 | +0.105 | -223.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 16 | +0.000 | +0.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3064 | +0.106 | -222.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5140 | +0.179 | -357.99€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5140 | +0.179 | -357.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1291 | +0.176 | -121.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1291 | +0.176 | -121.99€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1285 | +0.164 | -147.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1285 | +0.164 | -147.84€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1151 | +0.233 | -28.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1151 | +0.233 | -28.91€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1230 | +0.196 | -76.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1230 | +0.196 | -76.11€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 13177 | +0.194 | -1128.49€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 13177 | +0.194 | -1128.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2441 | +0.127 | -448.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2441 | +0.127 | -448.51€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2041 | +0.237 | -45.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2041 | +0.237 | -45.59€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2288 | +0.160 | -304.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2288 | +0.160 | -304.04€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2078 | +0.239 | -37.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2078 | +0.239 | -37.67€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2111 | +0.223 | -89.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2111 | +0.223 | -89.69€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2218 | +0.191 | -203.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2218 | +0.191 | -203.00€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 4732 | +0.129 | +107.94€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 4732 | +0.129 | +107.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2351 | +0.138 | +93.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2351 | +0.138 | +93.06€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2381 | +0.120 | +14.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2381 | +0.120 | +14.88€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 4195 | +0.097 | -164.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 432 | +0.039 | -36.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 3763 | +0.103 | -128.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 2897 | +0.094 | -92.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 432 | +0.039 | -36.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 2465 | +0.104 | -56.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1298 | +0.102 | -72.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1298 | +0.102 | -72.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 380 | +0.283 | -24.77€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 380 | +0.283 | -24.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 380 | +0.283 | -24.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 380 | +0.283 | -24.77€ | 0 | 4 |
| ✅ GBM_LATE_15M | 6476 | +0.045 | +1973.25€ | 0 | 18 |
| ✅ GBM_LATE_15M#15min | 6476 | +0.045 | +1973.25€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 843 | +0.176 | +534.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 843 | +0.176 | +534.73€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 886 | +0.171 | +495.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 886 | +0.171 | +495.38€ | 0 | 29 |
| ✅ GBM_LATE_15M#DOGE | 853 | +0.191 | +587.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 853 | +0.191 | +587.35€ | 0 | 18 |
| ✅ GBM_LATE_15M#ETH | 1031 | -0.056 | -6.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1031 | -0.056 | -6.98€ | 3 | 3 |
| ✅ GBM_LATE_15M#SOL | 1255 | -0.039 | +142.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1255 | -0.039 | +142.37€ | 4 | 3 |
| ✅ GBM_LATE_15M#XRP | 1608 | -0.042 | +220.39€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1608 | -0.042 | +220.39€ | 4 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 7441 | +0.043 | +2804.29€ | 0 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 7441 | +0.043 | +2804.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1126 | -0.028 | +510.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1126 | -0.028 | +510.46€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1629 | -0.035 | +172.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1629 | -0.035 | +172.15€ | 1 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 717 | +0.241 | +658.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 717 | +0.241 | +658.57€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1305 | -0.042 | +15.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1305 | -0.042 | +15.34€ | 8 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1371 | -0.013 | +281.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1371 | -0.013 | +281.46€ | 5 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1293 | +0.235 | +1166.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1293 | +0.235 | +1166.32€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 5090 | +0.170 | +3484.17€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 5090 | +0.170 | +3484.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 634 | +0.193 | +466.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 634 | +0.193 | +466.11€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 854 | +0.164 | +562.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 854 | +0.164 | +562.93€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 630 | +0.201 | +486.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 630 | +0.201 | +486.64€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 831 | +0.169 | +544.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 831 | +0.169 | +544.59€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 1005 | +0.112 | +553.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 1005 | +0.112 | +553.03€ | 1 | 17 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 1136 | +0.195 | +870.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 1136 | +0.195 | +870.86€ | 0 | 25 |
...
| ✅ GBM_LATE_15M_TARDIO | 5939 | +0.163 | +3801.26€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5939 | +0.163 | +3801.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 807 | +0.182 | +553.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 807 | +0.182 | +553.90€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 976 | +0.163 | +615.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 976 | +0.163 | +615.30€ | 0 | 28 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 798 | +0.216 | +655.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 798 | +0.216 | +655.60€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 857 | +0.135 | +437.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 857 | +0.135 | +437.98€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1085 | +0.095 | +505.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1085 | +0.095 | +505.44€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1416 | +0.191 | +1033.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1416 | +0.191 | +1033.04€ | 0 | 23 |
| ✅ GBM_LATE_5M | 881 | +0.110 | +341.32€ | 1 | 17 |
| ✅ GBM_LATE_5M#5min | 881 | +0.110 | +341.32€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 317 | +0.127 | +107.03€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 317 | +0.127 | +107.03€ | 0 | 14 |
...
| ✅ LEADLAG_BTC_XRP_15M | 236 | +0.101 | +51.83€ | 0 | 4 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 236 | +0.101 | +51.83€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 236 | +0.101 | +51.83€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 236 | +0.101 | +51.83€ | 0 | 4 |
...
| ✅ LIQUIDACIONES_5M | 499 | -0.049 | -25.10€ | 4 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 499 | -0.049 | -25.10€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB | 25 | +0.018 | +0.20€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB#5min | 25 | +0.018 | +0.20€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BTC | 89 | -0.082 | -7.66€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BTC#5min | 89 | -0.082 | -7.66€ | 3 | 1 |
...
| ✅ MOMENTUM_IBS_15M | 3350 | +0.002 | -44.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 3350 | +0.002 | -44.53€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M#DOGE | 536 | +0.000 | -18.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 536 | +0.000 | -18.08€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 646 | +0.017 | +19.65€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 646 | +0.017 | +19.65€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 604 | -0.007 | -24.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 604 | -0.007 | -24.67€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 655 | -0.008 | -21.00€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 655 | -0.008 | -21.00€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 4882 | -0.032 | +155.86€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 4882 | -0.032 | +155.86€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 769 | -0.034 | +85.41€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 769 | -0.034 | +85.41€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 878 | -0.024 | -13.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 878 | -0.024 | -13.79€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 777 | -0.035 | +104.26€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 777 | -0.035 | +104.26€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 875 | -0.026 | -19.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 875 | -0.026 | -19.89€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 795 | -0.046 | +6.33€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 795 | -0.046 | +6.33€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 788 | -0.027 | -6.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 788 | -0.027 | -6.46€ | 5 | 0 |
...
| ✅ MOMENTUM_IBS_5M | 2542 | +0.002 | -6.26€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 2542 | +0.002 | -6.26€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#ETH | 744 | +0.009 | +9.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#ETH#5min | 744 | +0.009 | +9.43€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL | 1173 | +0.003 | -4.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 1173 | +0.003 | -4.77€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 13414 | -0.069 | +358.72€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 13414 | -0.069 | +358.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 2048 | -0.090 | +229.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 2048 | -0.090 | +229.79€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 2528 | -0.051 | +40.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 2528 | -0.051 | +40.09€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 2115 | -0.082 | +42.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 2115 | -0.082 | +42.57€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 2047 | -0.097 | -162.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 2047 | -0.097 | -162.59€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 2444 | -0.045 | +47.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 2444 | -0.045 | +47.20€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 2232 | -0.057 | +161.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 2232 | -0.057 | +161.66€ | 4 | 0 |
...
| ✅ STREAK_FADE_5M | 827 | -0.008 | -28.96€ | 1 | 0 |
| ✅ STREAK_FADE_5M#5min | 827 | -0.008 | -28.96€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE | 279 | +0.005 | -3.49€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE#5min | 279 | +0.005 | -3.49€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH | 272 | +0.011 | -3.59€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH#5min | 272 | +0.011 | -3.59€ | 1 | 0 |
...
| ✅ STREAK_MOM_5M | 1608 | +0.024 | +24.89€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 1608 | +0.024 | +24.89€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 527 | +0.022 | +3.62€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 527 | +0.022 | +3.62€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 283 | +0.012 | +1.24€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 283 | +0.012 | +1.24€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 487 | +0.021 | +3.30€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 487 | +0.021 | +3.30€ | 0 | 1 |
| ✅ STREAK_MOM_5M#XRP | 311 | +0.040 | +16.72€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 311 | +0.040 | +16.72€ | 2 | 2 |
| ✅ STRUCT_NO_15M | 2799 | +0.002 | -42.90€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 2799 | +0.002 | -42.90€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 1075 | +0.002 | -17.09€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 1075 | +0.002 | -17.09€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 1077 | +0.009 | -9.28€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1077 | +0.009 | -9.28€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 647 | -0.010 | -16.53€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 647 | -0.010 | -16.53€ | 2 | 0 |
| ✅ UPDOWN_GBM | 4830 | +0.009 | +139.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1891 | +0.045 | +176.01€ | 0 | 7 |
| ✅ UPDOWN_GBM#240min | 211 | +0.021 | +3.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 2345 | -0.013 | -37.92€ | 3 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 1029 | +0.020 | +54.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 197 | +0.068 | +21.27€ | 4 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 62 | +0.094 | +8.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 643 | +0.015 | +29.90€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 109 | -0.050 | -7.03€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 18 | -0.135 | +1.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 598 | +0.002 | +3.95€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 105 | +0.089 | +23.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 487 | -0.017 | -19.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 1090 | +0.017 | +24.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 504 | +0.040 | +28.08€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#XRP | 805 | -0.001 | +45.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 500 | +0.052 | +80.50€ | 0 | 6 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3109 | -0.087 | +352.37€ | 4 | 4 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3109 | -0.087 | +352.37€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 251 | -0.081 | +115.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 251 | -0.081 | +115.95€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 642 | -0.171 | -87.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 642 | -0.171 | -87.39€ | 4 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 995 | -0.069 | +167.58€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 995 | -0.069 | +167.58€ | 2 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 948 | -0.090 | +97.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 948 | -0.090 | +97.82€ | 6 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.093) — sin ventaja clara. oversold(IBS<0.3): IC=-0.005 n=1647 | neutral: IC=+0.007 n=1777 | overbought(IBS>0.7): IC=+0.087 n=1952
  - _Datos_: n=5644 IC=+0.032 PNL=+391.05€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 4 celda(s) pasan gate riguroso completo de 186 evaluadas (n>=40) y 528 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.078 n=78742 | tras_1loss IC=+0.045 n=60942 | tras_2loss IC=+0.009 n=27678/40 | gap=+0.069 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 4768 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=4589 IC=+0.005 PNL=+88.88€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=4589 IC=+0.005 PNL=+88.88€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1121 IC=+0.034 PNL=+68.62€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1121 IC=+0.034 PNL=+68.62€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=1687 IC=-0.016 PNL=-43.51€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1687 IC=-0.016 PNL=-43.51€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1293 IC=+0.024 PNL=+77.43€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1293 IC=+0.024 PNL=+77.43€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=655 IC=+0.019 PNL=+34.01€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=655 IC=+0.019 PNL=+34.01€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1292 IC=+0.025 PNL=+67.15€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1292 IC=+0.025 PNL=+67.15€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=368 IC=+0.038 PNL=+43.10€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=368 IC=+0.038 PNL=+43.10€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=3363 IC=-0.122 PNL=+384.75€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3363 IC=-0.122 PNL=+384.75€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.230 < -0.1 con n=354 PNL=-28.42€
  - _Datos_: n=354 IC=-0.230 PNL=-28.42€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=532 IC=-0.034 PNL=+10.49€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=532 IC=-0.034 PNL=+10.49€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.176 > 0.08 con n=473 PNL=+260.87€
  - _Datos_: n=473 IC=+0.176 PNL=+260.87€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.240 > 0.08 con n=1177 PNL=-110.78€
  - _Datos_: n=1177 IC=+0.240 PNL=-110.78€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2441 IC=+0.127 PNL=-448.51€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2441 IC=+0.127 PNL=-448.51€
