# Hipótesis automáticas — 2026-07-03 19:06 UTC
_Generado por shadow_postmortem.py sobre 3184 resoluciones (PNL=-35.36€)_
...
### UPDOWN_GBM#15min
- **FILTRO** `ibs_15` > `0.3451` → IC=-0.130 (n=44)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.3451
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=136)

- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.202 (n=82)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0097 (IC base=+0.038)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.153 (n=47)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 15.0 (IC base=+0.038)

- **PATRÓN** `ibs_15` < `0.0642` → IC=+0.161 (n=60)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` < 0.0642 (IC base=+0.038)
...
- **FILTRO** `drift_60min` |x|> `0.3401` → IC=-0.125 (n=22)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.3401
...
- **FILTRO** `delta_ratio_macro` |x|≤ `0.0642` → IC=-0.136 (n=42)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.0642
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1297` → IC=+0.132 (n=66)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.66€ cuando `pct_spot_vs_ref` |x|≤ 0.1297 (IC base=+0.107)

- **PATRÓN** `sigma_h` < `0.009` → IC=+0.196 (n=44)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.009 (IC base=+0.107)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.192 (n=24)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 7.0 (IC base=+0.107)

- **PATRÓN** `ibs_15` < `0.0949` → IC=+0.230 (n=35)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0949 (IC base=+0.107)
...
- **PATRÓN** `sigma_h` < `0.0136` → IC=+0.152 (n=21)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0136 (IC base=+0.105)

- **PATRÓN** `drift_15min` |x|≤ `0.7351` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `drift_15min` |x|≤ 0.7351 (IC base=+0.105)

## Estrategias nuevas sugeridas
_Derivadas de los patrones aprendidos:_

- **H-HORA-OF**: ORDER_FLOW_5M tiene IC=-0.147 cuando hora_utc > 15.0. Añadir hora 15 a ORDER_FLOW_BLACKLIST_HOURS si n≥20.
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0642 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.161 n=60). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0949 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.230 n=35). Confirma señal de reversión media → alinear con BUY_YES.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 486 | +0.051 | +58.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 486 | +0.051 | +58.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 128 | +0.023 | +5.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 128 | +0.023 | +5.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 126 | -0.016 | -0.27€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 126 | -0.016 | -0.27€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 121 | +0.093 | +26.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 121 | +0.093 | +26.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 111 | +0.111 | +26.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 111 | +0.111 | +26.98€ | 0 | 0 |
| ✅ GBM_LATE_60M | 7 | -0.097 | -2.67€ | 0 | 0 |
| ✅ GBM_LATE_60M#60min | 7 | -0.097 | -2.67€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN | 5 | -0.018 | -0.59€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 5 | -0.018 | -0.59€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 5 | -0.018 | -0.59€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 5 | -0.018 | -0.59€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1529 | +0.012 | +10.18€ | 1 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1393 | +0.007 | -2.41€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 265 | -0.028 | -9.69€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 265 | -0.028 | -9.69€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 299 | +0.042 | +10.34€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 299 | +0.042 | +10.34€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#XRP | 184 | +0.000 | -1.63€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#XRP#5min | 184 | +0.000 | -1.63€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM | 83 | -0.112 | -4.61€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#BTC | 41 | -0.198 | -11.57€ | 0 | 0 |
| 🚫 PRICE_TARGET_GBM#BTC#atexpiry | 37 | -0.218 | -10.83€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#ETH | 29 | -0.048 | +0.08€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#ETH#atexpiry | 28 | -0.067 | -0.07€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#SOL | 13 | +0.022 | +6.88€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#SOL#atexpiry | 13 | +0.022 | +6.88€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#atexpiry | 78 | -0.125 | -4.03€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 872 | -0.041 | -48.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 641 | -0.019 | -20.36€ | 1 | 3 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 124 | -0.056 | -10.29€ | 7 | 0 |
| ✅ UPDOWN_GBM#BNB | 24 | -0.154 | -7.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 24 | -0.154 | -7.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 251 | -0.045 | -35.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 180 | -0.022 | -25.05€ | 3 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 348 | -0.011 | +8.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 263 | +0.006 | +15.85€ | 3 | 4 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 19 | -0.204 | -7.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 53 | -0.009 | -2.05€ | 3 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 8 | +0.000 | +3.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 145 | -0.085 | -11.86€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 86 | -0.068 | -7.22€ | 7 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 23 | -0.060 | -3.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 29 | -0.113 | -2.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#daily | 5 | -0.018 | +2.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 75 | -0.006 | +3.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 64 | +0.030 | +7.09€ | 3 | 2 |
| 🚫 UPDOWN_GBM#XRP#5min | 11 | -0.106 | -3.29€ | 0 | 0 |
| ✅ UPDOWN_GBM#daily | 19 | +0.023 | +10.57€ | 0 | 0 |
...
| ✅ WEEKLY_PRICE | 83 | -0.018 | -18.06€ | 0 | 0 |
| ✅ WEEKLY_PRICE#BTC | 29 | +0.016 | -6.73€ | 0 | 0 |
| ✅ WEEKLY_PRICE#ETH | 29 | +0.016 | -6.32€ | 0 | 0 |
| ✅ WEEKLY_PRICE#SOL | 25 | -0.093 | -5.01€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.066) — sin ventaja clara. oversold(IBS<0.3): IC=-0.006 n=168 | neutral: IC=-0.071 n=145 | overbought(IBS>0.7): IC=-0.052 n=152
  - _Datos_: n=482 IC=-0.041 PNL=-23.48€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.200 n=28 PNL=-13.74€ → FILTRAR | H=02h: IC=-0.180 n=23 PNL=-6.09€ → FILTRAR | H=03h: IC=-0.110 n=15 PNL=-5.87€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.167 n=25 PNL=+7.36€ → BOOST | H=20h: IC=-0.143 n=26 PNL=-5.82€ → FILTRAR | H=23h: IC=+0.158 n=19 PNL=+11.81€ → BOOST

**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  - _Umbral_: n≥200 por par con delta_ratio feature en shadow
  - _Acción_: Añadir DELTA_MIN/MAX por par dict en shadow_predict.py
  - _Estado_: BTC: 161 ops con delta_ratio | SOL: 198 ops con delta_ratio

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=-0.068 < 0.08 — monitorear
  - _Datos_: n=86 IC=-0.068 PNL=-7.22€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.010 n=1526 | tras_1loss IC=-0.028 n=1558 | tras_2loss IC=-0.044 n=803/40 | gap=+0.054 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.045 n=18/60 | contraria IC=+0.040 n=8 | gap=+0.005 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar

**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  - _Umbral_: n_overlaps≥20 y IC_overlap > IC_base + 0.05
  - _Acción_: Cambiar _aplicar_kelly_compuesto: match por activo, no market_id
  - _Estado_: n_overlaps=26, boost estimado=+0.017. Necesita 0 más y boost>0.05
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.052 n=132/40 PNL=-4.05€ | H=15h UTC: IC=-0.004 n=135/40 PNL=-0.84€ | H=17h UTC: IC=+0.153 n=73/40 PNL=+21.60€ | H=19h UTC: IC=-0.044 n=77/40 PNL=-12.87€

**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40 en cualquier subtipo 60min
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=53/40 IC=-0.009 PNL=-2.05€ | BTC#60min: n=42/40 IC=-0.068 PNL=-6.16€ | SOL#60min: n=29/40 IC=-0.113 PNL=-2.07€

**⏳ H-WEEKLY** — Predicciones semanales de precio por par
  - _Umbral_: n≥15 por par con IC≥+0.05
  - _Acción_: Si confirma IC≥+0.10 n≥15 en SOL → considerar live semanal
  - _Estado_: ETH: n=29/15 IC=+0.016 PNL=-6.32€ | BTC: n=29/15 IC=+0.016 PNL=-6.73€ | SOL: n=25/15 IC=-0.093 PNL=-5.01€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.026 n=95 | contrario_BTC IC=-0.056 n=43/40 | gap=-0.030 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=158 IC=-0.056 PNL=-16.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=158 IC=-0.056 PNL=-16.38€
...
**〰️ H-WEEKLY-BUYNO** — WEEKLY_PRICE BUY_NO — dirección dominante con IC muy alto
  ...
  - _Estado_: n=55 IC=+0.097 PNL=-5.70€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=55 IC=+0.097 PNL=-5.70€
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=53 IC=+0.045 PNL=+2.74€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=53 IC=+0.045 PNL=+2.74€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=749 IC=-0.037 PNL=-35.16€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=749 IC=-0.037 PNL=-35.16€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  ...
  - _Estado_: n=35 IC=-0.041 PNL=-2.69€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=35 IC=-0.041 PNL=-2.69€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=394 IC=-0.056 PNL=-48.09€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=394 IC=-0.056 PNL=-48.09€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.022 < 0.02 con n=180 PNL=-25.05€
  - _Datos_: n=180 IC=-0.022 PNL=-25.05€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=276 IC=-0.022 PNL=-34.03€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=276 IC=-0.022 PNL=-34.03€

**⏳ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: 30
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: 18/30 ops en el filtro definido (IC actual=-0.135 PNL=-2.94€)
  - _Datos_: n=18 IC=-0.135 PNL=-2.94€

**🟡 H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  - _Hipótesis_: ETH y BTC tienen patrones opuestos: BTC funciona con momentum (drift>0.3). ETH funciona con reversión (drift<-1): 9/14 (64%) IC=+0.087. La hipótesis es que ETH tiene más mean-reversion que BTC en 15min.
  - _Umbral_: n≥20 y IC>+0.08
  - _Acción_: Si ETH drift<-1 confirma IC>0.08 con n≥20 → boost ×1.1 en ETH#15min cuando drift_15min<-1
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.083 > 0.08 con n=46 PNL=+13.96€
  - _Datos_: n=46 IC=+0.083 PNL=+13.96€

**⏳ H-CUSTOM-GBM-09H** — GBM a las 09h UTC — bloqueada 2026-06-29
  - _Hipótesis_: IC=-0.158 n=19 PNL=-11.62€. Bloqueada manualmente el 2026-06-29 añadiendo hora 9 a meta.gbm_blacklist_hours_auto. Esta hipótesis monitorea que el IC siga siendo negativo para justificar el bloqueo.
  - _Umbral_: 25
  - _Acción_: Si IC sube a >-0.05 con n≥30 → evaluar desbloquear. Si se mantiene <-0.10 → confirmar bloqueo permanente.
  - _Estado_: 18/25 ops en el filtro definido (IC actual=-0.180 PNL=-11.50€)
  - _Datos_: n=18 IC=-0.180 PNL=-11.50€
...
**⏳ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: 5/30 ops en el filtro definido (IC actual=-0.018 PNL=-0.59€)
  - _Datos_: n=5 IC=-0.018 PNL=-0.59€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=229 IC=+0.015 PNL=+16.07€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=229 IC=+0.015 PNL=+16.07€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 6/40 ops en el filtro definido (IC actual=+0.000 PNL=+0.03€)
  - _Datos_: n=6 IC=+0.000 PNL=+0.03€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=450 IC=+0.053 PNL=+39.66€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=450 IC=+0.053 PNL=+39.66€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=751 IC=+0.027 PNL=+50.20€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=751 IC=+0.027 PNL=+50.20€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=48 IC=-0.020 PNL=-7.53€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=48 IC=-0.020 PNL=-7.53€
...
**🔴 H-CUSTOM-PRICETARGET-BUYYES-MALO** — PRICE_TARGET_GBM BUY_YES estructuralmente roto (BUY_NO no)
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.176 < -0.15 con n=35 PNL=+0.60€
  - _Datos_: n=35 IC=-0.176 PNL=+0.60€

**⏳ H-CUSTOM-WEEKLY-INRANGE-BUYYES** — WEEKLY_PRICE BUY_YES con in_range=1 — ¿estructuralmente sobrevalorado?
  - _Hipótesis_: Analizado 2026-07-01, n=10 (evidencia mínima): BUY_YES cuando in_range=1 fue 0/3 (todo pérdida). Mecanismo propuesto: acertar un rango de precio estrecho al vencimiento es intrínsecamente poco probable, el mercado puede estar sobrevalorando el 'sí'. Ver H-CUSTOM-WEEKLY-PCTDIST-BUYNO para el lado complementario (BUY_NO con pct_dist alto).
  - _Umbral_: 25
  - _Acción_: Si se confirma con n≥25 → filtro causal in_range==1 + BUY_YES → skip en WEEKLY_PRICE
  - _Estado_: 8/25 ops en el filtro definido (IC actual=-0.040 PNL=-1.62€)
  - _Datos_: n=8 IC=-0.040 PNL=-1.62€

**⏳ H-CUSTOM-WEEKLY-PCTDIST-BUYNO** — WEEKLY_PRICE BUY_NO con pct_dist alto — cuanto más lejos del rango, más seguro
  - _Hipótesis_: Analizado 2026-07-01, n=10 (evidencia mínima): BUY_NO con pct_dist>=2.09% fue 4/4 victorias (rango 2.09%-23.4%); BUY_NO con pct_dist<8% (pero fuera del corte anterior) tuvo derrotas. Patrón: cuanto más lejos está el spot del rango objetivo al momento de la predicción, más fiable el BUY_NO. Complementa H-CUSTOM-WEEKLY-INRANGE-BUYYES.
  - _Umbral_: 25
  - _Acción_: Si se confirma con n≥25 → boost ×1.2 en WEEKLY_PRICE BUY_NO cuando pct_dist≥2
  - _Estado_: 8/25 ops en el filtro definido (IC actual=+0.000 PNL=-1.00€)
  - _Datos_: n=8 IC=+0.000 PNL=-1.00€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.078 < -0.05 con n=536 PNL=-76.01€
  - _Datos_: n=536 IC=-0.078 PNL=-76.01€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 71/120 ops en el filtro definido (IC actual=+0.116 PNL=+10.02€)
  - _Datos_: n=71 IC=+0.116 PNL=+10.02€
...
**⏳ H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: 23/40 ops en el filtro definido (IC actual=-0.140 PNL=-7.37€)
  - _Datos_: n=23 IC=-0.140 PNL=-7.37€
...
**⏳ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: 41/50 ops en el filtro definido (IC actual=+0.105 PNL=+9.18€)
  - _Datos_: n=41 IC=+0.105 PNL=+9.18€
...
**⏳ H-CUSTOM-DAILY-BUYNO** — UPDOWN_GBM#daily BUY_NO — el sesgo anti-YES amplificado en ventanas diarias
  ...
  - _Estado_: 12/20 ops en el filtro definido (IC actual=+0.043 PNL=+9.60€)
  - _Datos_: n=12 IC=+0.043 PNL=+9.60€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=92 IC=+0.000 PNL=-7.13€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=92 IC=+0.000 PNL=-7.13€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=58 IC=-0.100 PNL=-1.34€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=58 IC=-0.100 PNL=-1.34€
