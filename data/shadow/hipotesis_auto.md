# Hipótesis automáticas — 2026-07-02 16:39 UTC
_Generado por shadow_postmortem.py sobre 2751 resoluciones (PNL=-53.50€)_
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M#SOL#15min` — IC=+0.176 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#SOL` — IC=+0.176 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 139 | +0.138 | +38.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 139 | +0.138 | +38.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 38 | +0.125 | +8.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 38 | +0.125 | +8.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 37 | +0.038 | +1.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 37 | +0.038 | +1.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 32 | +0.176 | +12.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 32 | +0.176 | +12.86€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 827 | -0.040 | -47.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 599 | -0.018 | -20.04€ | 2 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 318 | -0.009 | +6.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 234 | +0.009 | +13.15€ | 2 | 4 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.079) — sin ventaja clara. oversold(IBS<0.3): IC=+0.000 n=146 | neutral: IC=-0.079 n=131 | overbought(IBS>0.7): IC=-0.047 n=146
  - _Datos_: n=437 IC=-0.040 PNL=-22.68€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.200 n=28 PNL=-13.74€ → FILTRAR | H=02h: IC=-0.227 n=20 PNL=-7.89€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=15h: IC=-0.109 n=21 PNL=-6.63€ → FILTRAR | H=16h: IC=+0.182 n=20 PNL=+5.72€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.180 n=18 PNL=+12.32€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.011 n=1312 | tras_1loss IC=-0.033 n=1348 | tras_2loss IC=-0.045 n=699/40 | gap=+0.056 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=24, boost estimado=+0.008. Necesita 0 más y boost>0.05
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=148 IC=-0.047 PNL=-13.39€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=148 IC=-0.047 PNL=-13.39€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=704 IC=-0.035 PNL=-34.37€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=704 IC=-0.035 PNL=-34.37€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=383 IC=-0.051 PNL=-44.59€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=383 IC=-0.051 PNL=-44.59€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=255 IC=-0.014 PNL=-30.98€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=255 IC=-0.014 PNL=-30.98€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=325 IC=+0.069 PNL=+36.66€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=325 IC=+0.069 PNL=+36.66€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 34/40 ops en el filtro definido (IC actual=-0.028 PNL=-7.39€)
  - _Datos_: n=34 IC=-0.028 PNL=-7.39€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.075 < -0.05 con n=525 PNL=-72.51€
  - _Datos_: n=525 IC=-0.075 PNL=-72.51€
