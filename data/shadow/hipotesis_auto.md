# Hipótesis automáticas — 2026-07-02 01:17 UTC
_Generado por shadow_postmortem.py sobre 2508 resoluciones (PNL=-74.35€)_
...
- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.263 (n=57)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0097 (IC base=+0.098)

- **PATRÓN** `drift_60min` |x|≤ `0.7563` → IC=+0.128 (n=100)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.7563 (IC base=+0.098)

- **PATRÓN** `drift_15min` |x|≤ `0.7351` → IC=+0.123 (n=75)

  - _Acción_: Kelly boost +0.62€ cuando `drift_15min` |x|≤ 0.7351 (IC base=+0.098)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.098)

- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.230 (n=35)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0634 (IC base=+0.098)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0634 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.230 n=35). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 756 | -0.029 | -23.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 537 | -0.003 | +2.22€ | 1 | 5 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 116 | -0.051 | -9.39€ | 4 | 0 |
| ✅ UPDOWN_GBM#BNB | 19 | -0.068 | -2.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 19 | -0.068 | -2.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 225 | -0.037 | -26.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 156 | -0.013 | -16.35€ | 2 | 1 |
| 🚫 UPDOWN_GBM#BTC#5min | 19 | -0.158 | -7.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 41 | -0.058 | -5.65€ | 2 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 5 | +0.054 | +5.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 18 | -0.090 | -4.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 15 | -0.066 | -3.24€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.075) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.045 n=110 | overbought(IBS>0.7): IC=-0.034 n=131
  - _Datos_: n=366 IC=-0.016 PNL=+2.04€
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=22, boost estimado=+0.006. Necesita 0 más y boost>0.05
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1188 | tras_1loss IC=-0.034 n=1238 | tras_2loss IC=-0.047 n=643/40 | gap=+0.050 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=633 IC=-0.021 PNL=-9.64€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=633 IC=-0.021 PNL=-9.64€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.013 < 0.02 con n=156 PNL=-16.35€
  - _Datos_: n=156 IC=-0.013 PNL=-16.35€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=225 IC=+0.020 PNL=-3.72€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=225 IC=+0.020 PNL=-3.72€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=154 IC=+0.070 PNL=+30.08€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=154 IC=+0.070 PNL=+30.08€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 91/200 ops en el filtro definido (IC actual=+0.091 PNL=+18.57€)
  - _Datos_: n=91 IC=+0.091 PNL=+18.57€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 91/100 ops en el filtro definido (IC actual=+0.091 PNL=+18.57€)
  - _Datos_: n=91 IC=+0.091 PNL=+18.57€
