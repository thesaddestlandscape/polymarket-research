# Hipótesis automáticas — 2026-09-05 21:22 UTC
_Generado por shadow_postmortem.py sobre 300766 resoluciones (PNL=+29377.85€)_
...
- **FILTRO** `py_entrada` > `0.5` → IC=-0.392 (n=81)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.131 (n=326)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.131 (n=326)

  - _Acción_: Kelly boost +0.66€ cuando `py_entrada` < 0.5 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.129 (n=103)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 124.0 (IC base=+0.026)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)

  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.121 (n=196)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.121 (n=196)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.55` → IC=-0.300 (n=4016)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.55
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=12050)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `132.61` → IC=-0.326 (n=544)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.61
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1632)
...
- **FILTRO** `restante_s_al_confirmar` < `118.98` → IC=-0.399 (n=530)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 118.98
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=1591)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `157.5` → IC=-0.157 (n=1064)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.5
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3193)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `145.55` → IC=-0.311 (n=897)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.55
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2693)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `160.75` → IC=-0.375 (n=966)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.75
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=1962)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.191 (n=8392)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.162 (n=2156)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2367.2094` → IC=+0.163 (n=2067)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2367.2094 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.147 (n=5991)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.253 (n=5318)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.179 (n=4136)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `4545.1557` → IC=+0.179 (n=1798)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 4545.1557 (IC base=+0.138)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.214 (n=927)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `13027.6931` → IC=+0.220 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13027.6931 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=889)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.193 (n=1253)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=692)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.144 (n=1753)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.258 (n=680)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1926.7157` → IC=+0.266 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1926.7157 (IC base=+0.251)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.138 (n=376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.144 (n=484)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `1483.2932` → IC=+0.147 (n=403)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 1483.2932 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.215 (n=415)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.182)

- **PATRÓN** `py_entrada` > `0.84` → IC=+0.424 (n=431)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.197 (n=6618)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.205 (n=3171)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.181 (n=1694)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=1588)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=1619)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.188 (n=696)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.179 (n=3312)

  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` > 0.71 (IC base=+0.154)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.229 (n=1634)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.259 (n=2403)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.225)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.169 (n=3228)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.185 (n=3307)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.71 (IC base=+0.166)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.233 (n=1677)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.86` → IC=+0.158 (n=2516)

  - _Acción_: Kelly boost +0.79€ cuando `lag_apertura_s` < 3.86 (IC base=+0.129)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.211 (n=1350)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.136)

- **PATRÓN** `restante_min` < `3.95` → IC=+0.145 (n=1248)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` < 3.95 (IC base=+0.136)

- **PATRÓN** `restante_min` > `4.88` → IC=+0.150 (n=1733)
...
- **PATRÓN** `lag_apertura_s` < `3.29` → IC=+0.167 (n=1271)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9518` → IC=+0.211 (n=1341)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.73` → IC=+0.155 (n=1539)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 5.73 (IC base=+0.087)
...
- **PATRÓN** `volumen_spike_ratio` < `2.8626` → IC=+0.182 (n=2455)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.8626 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `1.4721` → IC=+0.179 (n=2455)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4721 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.4017` → IC=+0.126 (n=3831)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.4017 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.3335` → IC=+0.143 (n=1428)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3335 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.6891` → IC=+0.146 (n=608)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6891 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `1.0498` → IC=+0.145 (n=626)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.0498 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.1721` → IC=+0.226 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1721 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` > `1.9356` → IC=+0.196 (n=1440)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.9356 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.217 (n=854)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2948` → IC=+0.167 (n=904)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2948 (IC base=+0.161)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.663` → IC=+0.281 (n=395)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6507` → IC=+0.150 (n=807)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.6507 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.5555` → IC=+0.154 (n=721)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5555 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=762)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.161)

- **PATRÓN** `ballena_activa_n` < `43.0` → IC=+0.193 (n=369)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 43.0 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.249 (n=417)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.241)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.254 (n=555)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.241)

- **PATRÓN** `drift_60min` |x|≤ `0.1822` → IC=+0.289 (n=415)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1822 (IC base=+0.241)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.244 (n=569)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1729.3648` → IC=+0.257 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1729.3648 (IC base=+0.241)

- **PATRÓN** `ballena_activa_n` < `67.0` → IC=+0.241 (n=454)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.154 (n=756)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0061 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.148 (n=674)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.149 (n=676)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6603` → IC=+0.172 (n=754)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6603 (IC base=+0.145)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0647` → IC=+0.210 (n=270)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4035` → IC=+0.164 (n=646)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4035 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `12567.3384` → IC=+0.151 (n=503)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.186 (n=571)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0073 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.201 (n=413)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.248 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.394` → IC=+0.277 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.394 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` < `0.2176` → IC=+0.163 (n=805)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` < 0.2176 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `3.1296` → IC=+0.160 (n=678)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 3.1296 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8829` → IC=+0.182 (n=689)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.8829 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=907)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.194 (n=541)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 48.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.230 (n=709)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.239 (n=347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0268` → IC=+0.282 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0268 (IC base=+0.222)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.034` → IC=+0.234 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.034 (IC base=+0.222)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6985` → IC=+0.212 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6985 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `2.4058` → IC=+0.212 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4058 (IC base=+0.222)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.237 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.222)

- **PATRÓN** `ballena_activa_n` < `34.0` → IC=+0.209 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 34.0 (IC base=+0.222)
...
- **PATRÓN** `dist_vwap_pct` < `0.5618` → IC=+0.312 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5618 (IC base=-0.027)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.412` → IC=-0.184 (n=213)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1648)
...
- **FILTRO** `drift_60min` |x|> `0.5049` → IC=-0.157 (n=380)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=739)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.181 (n=155)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=964)

- **FILTRO** `ibs_20min` > `0.79` → IC=-0.194 (n=446)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.947` → IC=-0.134 (n=203)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1583)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5738` → IC=+0.190 (n=153)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.5738 (IC base=-0.047)
...
- **PATRÓN** `volumen_regimen` < `0.8421` → IC=+0.176 (n=137)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.8421 (IC base=-0.020)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7377` → IC=+0.225 (n=107)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7377 (IC base=-0.020)

- **PATRÓN** `volumen_spike_ratio` > `1.4228` → IC=+0.185 (n=160)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.4228 (IC base=-0.020)

- **PATRÓN** `ballena_activa_n` < `262.0` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 262.0 (IC base=-0.020)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.258 (n=721)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.7122` → IC=+0.259 (n=717)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7122 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.441` → IC=+0.293 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.441 (IC base=+0.229)

- **PATRÓN** `volumen_pendiente_norm` < `0.2202` → IC=+0.234 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2202 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` < `2.3907` → IC=+0.232 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.3907 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` > `1.7141` → IC=+0.235 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7141 (IC base=+0.229)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.257 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.229)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.312 (n=524)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.289)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.317 (n=391)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.289)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.303 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.289)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.709` → IC=+0.317 (n=200)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6567` → IC=+0.278 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6567 (IC base=+0.289)

- **PATRÓN** `volumen_spike_ratio` > `2.3431` → IC=+0.298 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3431 (IC base=+0.289)
...
- **FILTRO** `ibs_20min` < `0.5835` → IC=-0.162 (n=409)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5835
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=410)
...
- **PATRÓN** `volumen_regimen` < `0.8912` → IC=+0.167 (n=100)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8912 (IC base=-0.049)

- **PATRÓN** `volumen_pendiente_norm` > `0.1671` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1671 (IC base=-0.049)

- **PATRÓN** `volumen_spike_ratio` < `2.2544` → IC=+0.222 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2544 (IC base=-0.049)

- **PATRÓN** `volumen_spike_ratio` > `1.3713` → IC=+0.222 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3713 (IC base=-0.049)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.258 (n=60)
...
- **PATRÓN** `volumen_regimen` < `1.2342` → IC=+0.124 (n=139)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.2342 (IC base=-0.027)
...
- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 61.0 (IC base=-0.027)
...
- **PATRÓN** `ibs_20min` > `0.8982` → IC=+0.326 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8982 (IC base=+0.256)

- **PATRÓN** `dist_vwap_pct` > `0.1699` → IC=+0.316 (n=464)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5515` → IC=+0.269 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5515 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `1.8308` → IC=+0.260 (n=481)
...
- **PATRÓN** `drift_60min` |x|≤ `0.31` → IC=+0.272 (n=563)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.31 (IC base=+0.272)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.280 (n=802)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.272)

- **PATRÓN** `ibs_20min` < `0.384` → IC=+0.310 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.384 (IC base=+0.272)

- **PATRÓN** `dist_vwap_pct` > `0.5366` → IC=+0.286 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5366 (IC base=+0.272)

- **PATRÓN** `dist_vwap_pct` < `0.2765` → IC=+0.272 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2765 (IC base=+0.272)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.402` → IC=+0.292 (n=152)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2431` → IC=+0.370 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2431 (IC base=+0.272)

- **PATRÓN** `volumen_spike_ratio` < `2.577` → IC=+0.261 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.577 (IC base=+0.272)

- **PATRÓN** `volumen_spike_ratio` > `2.1847` → IC=+0.283 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1847 (IC base=+0.272)

- **PATRÓN** `libro_liquidez` > `2544.784` → IC=+0.272 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2544.784 (IC base=+0.272)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.266 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=+0.272)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.204 (n=1399)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0105 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3399` → IC=+0.170 (n=3693)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3399 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.169 (n=4224)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.7` → IC=+0.222 (n=3758)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `1.1059` → IC=+0.231 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1059 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.14` → IC=+0.250 (n=874)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.14 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.224` → IC=+0.155 (n=2827)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.224 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.6321` → IC=+0.161 (n=2826)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6321 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.105` → IC=+0.187 (n=1585)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.105 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `2.3099` → IC=+0.163 (n=3454)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.3099 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.163 (n=4249)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.03 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `3892.8648` → IC=+0.172 (n=1399)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3892.8648 (IC base=+0.163)

- **PATRÓN** `ballena_activa_n` < `140.0` → IC=+0.181 (n=3104)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 140.0 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.179 (n=3426)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0083 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0785` → IC=+0.202 (n=1299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0785 (IC base=+0.171)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.193 (n=1870)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 15.0 (IC base=+0.171)

- **PATRÓN** `ibs_20min` < `0.4416` → IC=+0.221 (n=3892)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4416 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2203` → IC=+0.165 (n=2909)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2203 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.085` → IC=+0.208 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.085 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1729` → IC=+0.161 (n=2917)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1729 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.623` → IC=+0.155 (n=2916)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.623 (IC base=+0.171)
...
- **PATRÓN** `volumen_spike_ratio` > `2.651` → IC=+0.194 (n=1088)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.651 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.165 (n=2852)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 153.0 (IC base=+0.171)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.251 (n=400)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.1683` → IC=+0.307 (n=299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `libro_liquidez` > `1705.2902` → IC=+0.261 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1705.2902 (IC base=+0.228)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.225 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 65.0 (IC base=+0.228)
...
- **PATRÓN** `drift_60min` |x|≤ `0.397` → IC=+0.166 (n=615)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.397 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.212 (n=428)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.4738` → IC=+0.208 (n=615)
...
- **PATRÓN** `volumen_regimen` < `1.2757` → IC=+0.168 (n=615)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2757 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `1.0769` → IC=+0.173 (n=279)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 1.0769 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2306` → IC=+0.204 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2306 (IC base=+0.163)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.208 (n=221)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.176)

- **PATRÓN** `drift_60min` |x|≤ `0.179` → IC=+0.197 (n=443)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.179 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.186 (n=224)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.44` → IC=+0.298 (n=211)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.44 (IC base=+0.176)

- **PATRÓN** `volumen_pendiente_norm` > `0.1321` → IC=+0.191 (n=250)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1321 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `1.896` → IC=+0.175 (n=536)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.896 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=691)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.233 (n=529)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.2176` → IC=+0.227 (n=353)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2176 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.242 (n=362)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` < `0.3684` → IC=+0.249 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3684 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.703` → IC=+0.258 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.703 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` > `0.3085` → IC=+0.270 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3085 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `1.8929` → IC=+0.211 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8929 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `3.6446` → IC=+0.219 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6446 (IC base=+0.217)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.186 (n=559)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0071 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.1196` → IC=+0.174 (n=280)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.1196 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.170 (n=650)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.4254` → IC=+0.197 (n=635)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.4254 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1446` → IC=+0.179 (n=443)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1446 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.408` → IC=+0.262 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.408 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.8895` → IC=+0.155 (n=424)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8895 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.2168` → IC=+0.187 (n=212)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.2168 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6202` → IC=+0.188 (n=206)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6202 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=707)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `8688.9164` → IC=+0.192 (n=423)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 8688.9164 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.146 (n=385)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 136.0 (IC base=+0.152)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=832)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `drift_60min` |x|≤ `0.0978` → IC=+0.149 (n=240)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0978 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=330)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.4737` → IC=+0.212 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4737 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `1.0296` → IC=+0.137 (n=89)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 1.0296 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.1784` → IC=+0.136 (n=641)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1784 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.287` → IC=+0.158 (n=290)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.287 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `1.1889` → IC=+0.137 (n=719)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.1889 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `0.8568` → IC=+0.128 (n=479)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.8568 (IC base=+0.123)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5471` → IC=+0.129 (n=257)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.5471 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.3625` → IC=+0.190 (n=195)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3625 (IC base=+0.123)
...
- **PATRÓN** `ibs_20min` > `0.7321` → IC=+0.246 (n=702)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7321 (IC base=+0.194)

- **PATRÓN** `dist_vwap_pct` > `0.2672` → IC=+0.226 (n=505)
...
- **PATRÓN** `volumen_regimen` > `0.8431` → IC=+0.222 (n=524)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5262` → IC=+0.212 (n=745)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5262 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `1.5169` → IC=+0.199 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5169 (IC base=+0.194)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.202 (n=401)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.425` → IC=+0.245 (n=805)
...
- **PATRÓN** `volumen_regimen` > `0.6915` → IC=+0.228 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6915 (IC base=+0.201)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3252` → IC=+0.140 (n=797)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3252 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=862)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.4375` → IC=+0.169 (n=906)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.4375 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.9443` → IC=+0.213 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9443 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.66` → IC=+0.175 (n=417)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.66 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8709` → IC=+0.158 (n=489)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8709 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1814` → IC=+0.154 (n=244)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1814 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1708` → IC=+0.179 (n=250)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1708 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.2604` → IC=+0.146 (n=749)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.2604 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8216` → IC=+0.147 (n=567)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8216 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.161 (n=702)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.188 (n=302)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.3143` → IC=+0.121 (n=610)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.3143 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.081` → IC=+0.130 (n=187)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 8.081 (IC base=+0.075)

- **PATRÓN** `volumen_pendiente_norm` > `0.1735` → IC=+0.157 (n=228)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1735 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.170 (n=104)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0029 (IC base=+0.084)

- **PATRÓN** `ibs_20min` < `0.6326` → IC=+0.157 (n=269)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.6326 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.093` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 9.093 (IC base=+0.084)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.220 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.170 (n=92)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 146.0 (IC base=+0.084)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.274 (n=166)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.290 (n=246)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.260)

- **PATRÓN** `ibs_20min` > `0.3797` → IC=+0.278 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3797 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` > `0.149` → IC=+0.285 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.149 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` < `0.226` → IC=+0.260 (n=227)
...
- **PATRÓN** `volumen_regimen` < `0.8266` → IC=+0.271 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8266 (IC base=+0.260)

- **PATRÓN** `volumen_regimen` > `1.1605` → IC=+0.321 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1605 (IC base=+0.260)

- **PATRÓN** `volumen_pendiente_norm` > `0.0976` → IC=+0.356 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0976 (IC base=+0.260)

- **PATRÓN** `volumen_spike_ratio` > `2.0629` → IC=+0.339 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0629 (IC base=+0.260)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.264 (n=256)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.200 (n=2304)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.172 (n=5101)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4839` → IC=+0.210 (n=5074)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4839 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `1.047` → IC=+0.220 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.047 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.472` → IC=+0.226 (n=2538)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.472 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8873` → IC=+0.159 (n=2331)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8873 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.1679` → IC=+0.197 (n=1391)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1679 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.8738` → IC=+0.172 (n=3162)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8738 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.165 (n=4750)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.02 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3813.8034` → IC=+0.181 (n=1692)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3813.8034 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.210 (n=2487)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 63.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.199 (n=3093)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0069 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.4782` → IC=+0.189 (n=4634)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.4782 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=2248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.235 (n=4638)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.4373` → IC=+0.166 (n=3255)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.4373 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.718` → IC=+0.212 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.718 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.713` → IC=+0.184 (n=4314)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 2.713 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `0.6228` → IC=+0.166 (n=1089)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6228 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `1.1947` → IC=+0.163 (n=1089)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.1947 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2368` → IC=+0.244 (n=759)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2368 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.3011` → IC=+0.193 (n=1779)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.3011 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.174 (n=3508)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.905` → IC=+0.310 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.905 (IC base=+0.192)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4696` → IC=+0.201 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4696 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `2.2942` → IC=+0.178 (n=343)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.2942 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.192)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.244 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.192)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.264 (n=554)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.256)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.262 (n=628)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.1918` → IC=+0.293 (n=419)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1918 (IC base=+0.256)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.260 (n=574)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4158` → IC=+0.296 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4158 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.61` → IC=+0.271 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.61 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.2958` → IC=+0.317 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2958 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `1.5076` → IC=+0.270 (n=525)
...
- **PATRÓN** `libro_liquidez` > `1730.86` → IC=+0.267 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1730.86 (IC base=+0.256)

- **PATRÓN** `ballena_activa_n` < `73.0` → IC=+0.263 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 73.0 (IC base=+0.256)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.177 (n=738)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 8.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.4544` → IC=+0.209 (n=737)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4544 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.219` → IC=+0.205 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.219 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.185 (n=198)
...
- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.164 (n=825)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2673 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` < `0.0706` → IC=+0.165 (n=697)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.0706 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1469` → IC=+0.196 (n=225)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1469 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.3936` → IC=+0.169 (n=775)
...
- **PATRÓN** `libro_liquidez` > `10617.4307` → IC=+0.182 (n=737)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10617.4307 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `465.0` → IC=+0.172 (n=616)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 465.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.179 (n=739)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3387` → IC=+0.180 (n=739)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.3387 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.174 (n=697)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6191` → IC=+0.208 (n=739)
...
- **PATRÓN** `volumen_regimen` < `0.6181` → IC=+0.227 (n=247)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=953)
...
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.230 (n=495)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6825` → IC=+0.259 (n=663)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6825 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.344` → IC=+0.321 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.344 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` < `0.2198` → IC=+0.213 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2198 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` < `3.196` → IC=+0.205 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.196 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `1.713` → IC=+0.206 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.713 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=777)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `1474.5515` → IC=+0.214 (n=742)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1474.5515 (IC base=+0.209)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.251 (n=456)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.238 (n=360)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.275 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3966 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.554` → IC=+0.273 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.554 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` > `0.3565` → IC=+0.290 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3565 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` < `3.0442` → IC=+0.231 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0442 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `1.8897` → IC=+0.215 (n=552)
...
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.155 (n=742)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0069 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.155 (n=761)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.7314` → IC=+0.236 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7314 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.364` → IC=+0.184 (n=334)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.364 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.071` → IC=+0.173 (n=145)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 12.071 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.077` → IC=+0.139 (n=841)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 7.077 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8969` → IC=+0.167 (n=563)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.8969 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.2062` → IC=+0.143 (n=281)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.2062 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5084` → IC=+0.193 (n=268)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.5084 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.142 (n=917)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9491.6866` → IC=+0.238 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9491.6866 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.168 (n=221)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0032 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.4364` → IC=+0.141 (n=658)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.4364 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.146 (n=252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6768` → IC=+0.171 (n=658)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6768 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3958` → IC=+0.126 (n=663)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.3958 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.298` → IC=+0.209 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.298 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.6018` → IC=+0.126 (n=220)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 0.6018 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `1.142` → IC=+0.140 (n=220)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.142 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2795` → IC=+0.257 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2795 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `1.4547` → IC=+0.139 (n=596)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4547 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9489.0705` → IC=+0.174 (n=299)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 9489.0705 (IC base=+0.123)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.138 (n=592)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0079 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.134 (n=593)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.177 (n=888)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4706 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.8687` → IC=+0.178 (n=225)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.8687 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.214 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.403 (IC base=+0.093)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.122 (n=619)
...
- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.133 (n=662)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.147 (n=400)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.587` → IC=+0.193 (n=832)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.587 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.4927` → IC=+0.137 (n=800)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.4927 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.231` → IC=+0.128 (n=809)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.231 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.0622` → IC=+0.131 (n=732)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0622 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.0745` → IC=+0.174 (n=286)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0745 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.5628` → IC=+0.139 (n=300)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.5628 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.1793` → IC=+0.130 (n=309)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.1793 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2637.4052` → IC=+0.149 (n=377)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2637.4052 (IC base=+0.115)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.213 (n=991)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` > `1.828` → IC=+0.209 (n=593)
...
- **PATRÓN** `sigma_h` > `0.0253` → IC=+0.228 (n=347)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0253 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=981)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.257 (n=1050)
...
- **PATRÓN** `libro_liquidez` > `2525.55` → IC=+0.205 (n=692)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2525.55 (IC base=+0.205)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.185 (n=757)
...
- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.133 (n=1453)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0103 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.5538` → IC=+0.131 (n=1650)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.5538 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.169 (n=560)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 18.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `0.9275` → IC=+0.192 (n=550)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.9275 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.464` → IC=+0.144 (n=259)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 10.464 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.788` → IC=+0.121 (n=1430)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 2.788 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.1729` → IC=+0.155 (n=453)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1729 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.4612` → IC=+0.138 (n=545)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4612 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.8939` → IC=+0.142 (n=1089)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8939 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `8675.6611` → IC=+0.129 (n=748)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 8675.6611 (IC base=+0.121)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.471` → IC=-0.250 (n=26)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.142 (n=188)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.150 (n=58)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 19.0 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.471` → IC=+0.142 (n=188)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 2.471 (IC base=+0.093)

- **PATRÓN** `volumen_regimen` > `0.9417` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.9417 (IC base=+0.093)

- **PATRÓN** `volumen_spike_ratio` < `1.4115` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4115 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `12574.1361` → IC=+0.144 (n=144)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.203 (n=136)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.177 (n=184)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0106 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.2821` → IC=+0.163 (n=271)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.2821 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.189 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 9.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.9849` → IC=+0.225 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9849 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.335` → IC=+0.216 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.335 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.215` → IC=+0.164 (n=108)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.215 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `3.5224` → IC=+0.159 (n=405)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 3.5224 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.8279` → IC=+0.151 (n=362)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8279 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `2285.379` → IC=+0.167 (n=136)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2285.379 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.188 (n=264)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0055 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.158 (n=147)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 18.0 (IC base=+0.091)

- **PATRÓN** `ibs_20min` > `0.6383` → IC=+0.211 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6383 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.8439` → IC=+0.189 (n=43)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.8439 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.817` → IC=+0.243 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.817 (IC base=+0.091)

- **PATRÓN** `volumen_regimen` < `0.8208` → IC=+0.144 (n=203)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8208 (IC base=+0.091)

- **PATRÓN** `volumen_regimen` > `0.9949` → IC=+0.121 (n=138)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.9949 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` > `0.2695` → IC=+0.295 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2695 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` < `1.9919` → IC=+0.163 (n=179)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.9919 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` > `1.4935` → IC=+0.152 (n=182)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4935 (IC base=+0.091)

- **PATRÓN** `libro_spread` < `0.023` → IC=+0.153 (n=246)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.023 (IC base=+0.091)

- **PATRÓN** `libro_liquidez` > `1064.9876` → IC=+0.155 (n=250)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 1064.9876 (IC base=+0.091)
...
- **PATRÓN** `libro_liquidez` > `2754.2307` → IC=+0.185 (n=106)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2754.2307 (IC base=+0.104)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=1609)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=4927)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.184 (n=1621)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5126)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.224 (n=255)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.073 (n=780)

- **FILTRO** `ibs_20min` < `0.7376` → IC=-0.192 (n=258)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7376
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=777)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.164 (n=290)
...
- **FILTRO** `ballena_activa_n` > `57.0` → IC=-0.157 (n=263)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.182 (n=357)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=733)
...
- **FILTRO** `ibs_20min` > `0.214` → IC=-0.152 (n=265)

  - _Acción_: SKIP cuando `ibs_20min` > 0.214
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=796)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.140 (n=292)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=807)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=288)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.306 (n=34)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=545)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=551)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.280 (n=3828)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=11923)

- **FILTRO** `ibs_7min` < `0.7155` → IC=-0.235 (n=3937)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7155
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=11814)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.168 (n=5307)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=10444)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.223 (n=4862)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=15093)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=4969)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=14986)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=560)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1771)

- **FILTRO** `ibs_7min` < `0.7089` → IC=-0.249 (n=768)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7089
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1563)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.218 (n=555)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1776)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.242 (n=856)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2607)

- **FILTRO** `drift_7min_pct` |x|> `0.1143` → IC=-0.134 (n=1174)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1143
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2289)

- **FILTRO** `ibs_7min` > `0.8362` → IC=-0.199 (n=865)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8362
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2598)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=635)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2271)
...
- **FILTRO** `ibs_7min` < `0.7734` → IC=-0.190 (n=726)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7734
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=2180)

- **FILTRO** `ballena_activa_n` > `166.0` → IC=-0.175 (n=725)

  - _Acción_: SKIP cuando `ballena_activa_n` > 166.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2181)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.243 (n=709)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=2220)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.169 (n=993)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=1936)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.183 (n=740)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1576)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.305 (n=735)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1581)

- **FILTRO** `ibs_7min` < `0.2222` → IC=-0.290 (n=579)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2222
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1737)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.241 (n=551)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1765)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=858)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=2757)

- **FILTRO** `ibs_7min` > `0.2791` → IC=-0.157 (n=1229)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2791
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=2386)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=808)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=1848)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.263 (n=635)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2021)

- **FILTRO** `ibs_7min` < `0.7575` → IC=-0.188 (n=664)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7575
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=1992)

- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.181 (n=660)

  - _Acción_: SKIP cuando `ballena_activa_n` > 37.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=1996)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.235 (n=880)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1813)

- **FILTRO** `ibs_7min` > `0.2755` → IC=-0.178 (n=673)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2755
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2020)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.186 (n=664)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=2029)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.241 (n=715)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2232)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.203 (n=731)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2216)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.179 (n=885)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2853)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.126 (n=615)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1980)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.295 (n=626)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1969)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.230 (n=647)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1948)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.225 (n=628)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1967)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.207 (n=848)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2669)

- **FILTRO** `ibs_7min` > `0.76` → IC=-0.156 (n=876)

  - _Acción_: SKIP cuando `ibs_7min` > 0.76
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=2641)
...
- **PATRÓN** `delta_ratio` |x|> `0.399` → IC=+0.145 (n=544)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio` |x|> 0.399 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.142 (n=436)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 6.0 (IC base=+0.131)

- **PATRÓN** `total_vol_5m` < `459.6089` → IC=+0.165 (n=174)

  - _Acción_: Kelly boost +0.82€ cuando `total_vol_5m` < 459.6089 (IC base=+0.131)
...
- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.131 (n=383)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 63.0 (IC base=+0.131)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.183 (n=203)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0075 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.1916` → IC=+0.139 (n=608)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1916 (IC base=+0.139)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1318` → IC=+0.141 (n=405)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.71€ cuando `delta_ratio_macro` |x|> 0.1318 (IC base=+0.139)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3329` → IC=+0.183 (n=295)

  - _Acción_: Kelly boost +0.92€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3329 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=610)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.177 (n=274)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 6.0 (IC base=+0.139)

- **PATRÓN** `ibs_15` > `0.5909` → IC=+0.218 (n=609)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5909 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.4311` → IC=+0.144 (n=144)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.4311 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.5539` → IC=+0.139 (n=647)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5539 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.547` → IC=+0.228 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.547 (IC base=+0.139)
...
- **PATRÓN** `libro_liquidez` > `9584.2249` → IC=+0.168 (n=203)
  ...
  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 9584.2249 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `38.0` → IC=+0.171 (n=144)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 38.0 (IC base=+0.139)

### UPDOWN_GBM#5min
- **FILTRO** `sigma_ewma_delta_pct` > `7.859` → IC=-0.198 (n=41)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 7.859
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1227)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.331` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 20.331 (IC base=+0.005)
...
- **FILTRO** `drift_15min` |x|> `0.4882` → IC=-0.144 (n=158)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.4882
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=478)
...
- **PATRÓN** `ibs_15` < `0.1159` → IC=+0.181 (n=189)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0112` → IC=-0.189 (n=368)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0112
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1107)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.142 (n=386)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1089)

- **FILTRO** `sigma_ewma_delta_pct` > `18.728` → IC=-0.151 (n=536)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.728
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4058)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1115` → IC=+0.235 (n=213)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1115 (IC base=-0.063)
...
- **PATRÓN** `dist_vwap_pct` < `0.1516` → IC=+0.211 (n=490)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1516 (IC base=-0.063)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.214 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 124.0 (IC base=-0.063)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0074` → IC=-0.225 (n=238)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0074
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=716)
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.521` → IC=-0.253 (n=172)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=782)
...
- **FILTRO** `drift_60min` |x|> `0.1594` → IC=-0.193 (n=125)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=244)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.174 (n=127)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=242)

- **FILTRO** `sigma_ewma_delta_pct` > `16.343` → IC=-0.140 (n=184)
...
- **FILTRO** `sigma_h` > `0.0178` → IC=-0.226 (n=206)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `drift_15min` |x|> `1.1952` → IC=-0.243 (n=103)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.135 (n=310)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.283 (n=358)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.282)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.293 (n=162)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.307 (n=377)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.282)

- **PATRÓN** `ibs_15` > `0.834` → IC=+0.316 (n=357)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0