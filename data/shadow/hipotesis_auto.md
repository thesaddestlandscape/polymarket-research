# Hipótesis automáticas — 2026-07-01 20:51 UTC
_Generado por shadow_postmortem.py sobre 2468 resoluciones (PNL=-84.68€)_
...
- **FILTRO** `ibs_15` > `0.2806` → IC=-0.130 (n=25)
...
- **PATRÓN** `sigma_h` < `0.009` → IC=+0.260 (n=48)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.009 (IC base=+0.086)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=19)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.086)

- **PATRÓN** `ibs_15` < `0.0512` → IC=+0.250 (n=26)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0512 (IC base=+0.086)
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.118) — sin ventaja clara. oversold(IBS<0.3): IC=+0.020 n=98 | neutral: IC=-0.098 n=95 | overbought(IBS>0.7): IC=-0.023 n=128
  - _Datos_: n=330 IC=-0.030 PNL=-8.33€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.112 n=17 PNL=-5.44€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.113 n=19 PNL=-3.52€ → FILTRAR
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=48/40 IC=-0.020 PNL=-2.51€ | BTC#60min: n=39/40 IC=-0.037 PNL=-4.63€ | SOL#60min: n=22/40 IC=-0.125 PNL=-1.68€
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=-0.001 n=1158 | tras_1loss IC=-0.034 n=1220 | tras_2loss IC=-0.050 n=634/40 | gap=+0.049 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.028 n=89 | contrario_BTC IC=-0.013 n=37/40 | gap=+0.015 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=597 IC=-0.029 PNL=-20.01€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=597 IC=-0.029 PNL=-20.01€
...
**⏳ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  ...
  - _Estado_: 20/30 ops en el filtro definido (IC actual=+0.000 PNL=-1.22€)
  - _Datos_: n=20 IC=+0.000 PNL=-1.22€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=125 IC=+0.051 PNL=+19.15€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=125 IC=+0.051 PNL=+19.15€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 51/200 ops en el filtro definido (IC actual=+0.085 PNL=+8.24€)
  - _Datos_: n=51 IC=+0.085 PNL=+8.24€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 51/100 ops en el filtro definido (IC actual=+0.085 PNL=+8.24€)
  - _Datos_: n=51 IC=+0.085 PNL=+8.24€
