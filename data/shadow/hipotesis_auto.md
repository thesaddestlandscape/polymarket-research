# Hipótesis automáticas — 2026-06-30 11:01 UTC
_Generado por shadow_postmortem.py sobre 1402 resoluciones (PNL=-57.43€)_
...
| ✅ UPDOWN_GBM | 429 | -0.022 | -15.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 257 | +0.017 | +1.28€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 177 | +0.014 | +0.53€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 120 | +0.025 | +1.30€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.015) — sin ventaja clara. oversold(IBS<0.3): IC=-0.048 n=40 | neutral: IC=-0.062 n=46 | overbought(IBS>0.7): IC=-0.058 n=50
  - _Datos_: n=140 IC=-0.063 PNL=-17.09€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 140 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=330 IC=-0.015 PNL=-10.32€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=330 IC=-0.015 PNL=-10.32€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=199 IC=-0.017 PNL=-17.08€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=199 IC=-0.017 PNL=-17.08€
...
**⏳ H-CUSTOM-DRIFT15-ZONA-MUERTA** — GBM#15min drift_15min ∈ [-0.3,+0.3] — zona muerta de señal
  ...
  - _Estado_: 41/50 ops en el filtro definido (IC actual=-0.081 PNL=-4.21€)
  - _Datos_: n=41 IC=-0.081 PNL=-4.21€

**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  - _Hipótesis_: Cuando drift_15min > 0.3%/h el GBM captura bien la dirección: IC=+0.100 n=28 en todos GBM#15min; IC=+0.152 n=13 solo BTC. El mercado tiene dirección clara y el GBM la sigue. Hipótesis: este rango es donde la señal es real.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma IC>0.10 con n≥40 → boost ×1.2 en GBM#15min cuando drift_15min>0.3
  - _Estado_: n=105 IC=+0.061 PNL=+0.59€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=105 IC=+0.061 PNL=+0.59€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=45 IC=+0.053 PNL=+7.24€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=45 IC=+0.053 PNL=+7.24€
