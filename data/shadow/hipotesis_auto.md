# Hipótesis automáticas — 2026-07-12 13:33 UTC
_Generado por shadow_postmortem.py sobre 10960 resoluciones (PNL=+1970.07€)_
...
- **PATRÓN** `py_entrada` < `0.275` → IC=+0.308 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=396)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `5910.4373` → IC=+0.169 (n=158)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 5910.4373 (IC base=+0.146)
...
- **PATRÓN** `libro_liquidez` > `6496.7981` → IC=+0.243 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6496.7981 (IC base=+0.222)
...
- **PATRÓN** `libro_liquidez` > `3498.8855` → IC=+0.157 (n=65)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3498.8855 (IC base=+0.157)
...
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.148 (n=918)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.4878` → IC=+0.172 (n=123)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.4878 (IC base=+0.110)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.184 (n=169)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 7.0 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.2052` → IC=+0.262 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2052 (IC base=+0.151)
...
- **PATRÓN** `sigma_h` > `0.0025` → IC=+0.230 (n=87)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0025 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=90)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.170)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.182 (n=61)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 11.0 (IC base=+0.170)
...
- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.150 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0127 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` < `0.503` → IC=+0.133 (n=118)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.503 (IC base=+0.082)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 900 | +0.183 | +9.34€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 577 | +0.210 | +7.07€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 264 | +0.192 | +1.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 192 | +0.211 | -4.23€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 319 | +0.170 | +4.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 191 | +0.210 | +5.74€ | 0 | 9 |
...
| ✅ GBM_LATE_15M | 3588 | +0.113 | +1176.07€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 3588 | +0.113 | +1176.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 883 | +0.070 | +114.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 883 | +0.070 | +114.34€ | 0 | 1 |
...
| ✅ GBM_LATE_15M#XRP | 861 | +0.173 | +460.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 861 | +0.173 | +460.93€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 950 | +0.161 | +503.74€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 950 | +0.161 | +503.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 249 | +0.165 | +160.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 249 | +0.165 | +160.27€ | 0 | 7 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 179 | +0.274 | +177.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 179 | +0.274 | +177.54€ | 0 | 5 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1117 | +0.080 | +266.49€ | 1 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1117 | +0.080 | +266.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 259 | +0.075 | +33.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 259 | +0.075 | +33.51€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 1321 | -0.006 | +28.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1065 | +0.023 | +65.62€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#ETH | 652 | +0.014 | +36.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 559 | +0.033 | +47.06€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.121) — sin ventaja clara. oversold(IBS<0.3): IC=-0.023 n=342 | neutral: IC=-0.046 n=258 | overbought(IBS>0.7): IC=+0.075 n=290
  - _Datos_: n=931 IC=+0.008 PNL=+53.39€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6187 | tras_1loss IC=+0.045 n=4636 | tras_2loss IC=+0.011 n=2081/40 | gap=+0.079 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.083 n=473/40 PNL=+111.71€ | H=15h UTC: IC=+0.087 n=444/40 PNL=+95.17€ | H=17h UTC: IC=+0.122 n=382/40 PNL=+123.97€ | H=19h UTC: IC=+0.063 n=385/40 PNL=+49.78€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1194 IC=+0.000 PNL=+42.15€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1194 IC=+0.000 PNL=+42.15€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=548 IC=+0.053 PNL=+48.46€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=548 IC=+0.053 PNL=+48.46€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8502 IC=+0.096 PNL=+2045.95€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8502 IC=+0.096 PNL=+2045.95€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=453 IC=+0.054 PNL=+36.02€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=453 IC=+0.054 PNL=+36.02€
...
**⏳ H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 8/40 ops en el filtro definido (IC actual=+0.040 PNL=+8.27€)
  - _Datos_: n=8 IC=+0.040 PNL=+8.27€
...
**⏳ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: 13/40 ops en el filtro definido (IC actual=+0.108 PNL=+9.32€)
  - _Datos_: n=13 IC=+0.108 PNL=+9.32€
