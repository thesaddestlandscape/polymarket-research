# Hipótesis automáticas — 2026-07-02 20:28 UTC
_Generado por shadow_postmortem.py sobre 2819 resoluciones (PNL=-53.38€)_
...
- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.179 (n=51)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` < 0.0634 (IC base=+0.041)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1297` → IC=+0.154 (n=50)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.77€ cuando `pct_spot_vs_ref` |x|≤ 0.1297 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0158` → IC=+0.154 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0158 (IC base=+0.118)

- **PATRÓN** `drift_60min` |x|≤ `1.1498` → IC=+0.146 (n=46)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 1.1498 (IC base=+0.118)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.237 (n=17)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.118)

- **PATRÓN** `ibs_15` < `0.0792` → IC=+0.315 (n=25)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0792 (IC base=+0.118)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 190 | +0.109 | +40.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 190 | +0.109 | +40.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 51 | +0.104 | +10.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 51 | +0.104 | +10.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 51 | +0.028 | +3.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 51 | +0.028 | +3.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 45 | +0.117 | +10.17€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 45 | +0.117 | +10.17€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 839 | -0.041 | -49.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 611 | -0.019 | -21.86€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 324 | -0.012 | +5.62€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 240 | +0.004 | +12.08€ | 3 | 5 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.063) — sin ventaja clara. oversold(IBS<0.3): IC=-0.010 n=151 | neutral: IC=-0.072 n=136 | overbought(IBS>0.7): IC=-0.047 n=148
  - _Datos_: n=449 IC=-0.041 PNL=-24.50€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.009 n=1345 | tras_1loss IC=-0.029 n=1383 | tras_2loss IC=-0.044 n=715/40 | gap=+0.052 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=716 IC=-0.036 PNL=-36.18€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=716 IC=-0.036 PNL=-36.18€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=202 IC=+0.015 PNL=+12.94€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=202 IC=+0.015 PNL=+12.94€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=393 IC=+0.057 PNL=+36.78€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=393 IC=+0.057 PNL=+36.78€
