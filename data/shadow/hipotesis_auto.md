# Hipótesis automáticas — 2026-07-21 07:23 UTC
_Generado por shadow_postmortem.py sobre 26234 resoluciones (PNL=+6272.14€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1684)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.208 (n=1664)
...
- **PATRÓN** `dist_vwap_pct` < `0.3902` → IC=+0.169 (n=1099)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3902 (IC base=+0.154)
...
| ✅ FAVORITO_CONFIRMADO | 4529 | +0.185 | +59.62€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2948 | +0.217 | +96.78€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 6422 | +0.101 | +2119.40€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 6422 | +0.101 | +2119.40€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3618 | +0.141 | +2055.80€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3618 | +0.141 | +2055.80€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 943 | +0.172 | +438.63€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 943 | +0.172 | +438.63€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.193: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.059 n=919 | neutral: IC=+0.001 n=692 | overbought(IBS>0.7): IC=+0.195 n=908
  - _Datos_: n=2696 IC=+0.098 PNL=+645.85€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.117 n=15778 | tras_1loss IC=+0.087 n=10254 | tras_2loss IC=+0.054 n=4193/40 | gap=+0.063 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=23770 IC=+0.117 PNL=+6346.99€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=23770 IC=+0.117 PNL=+6346.99€
