# Hipótesis automáticas — 2026-07-21 12:36 UTC
_Generado por shadow_postmortem.py sobre 26726 resoluciones (PNL=+6253.45€)_
...
- **PATRÓN** `py_entrada` < `0.235` → IC=+0.374 (n=133)
...
- **PATRÓN** `dist_vwap_pct` > `1.0914` → IC=+0.156 (n=30)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 1.0914 (IC base=+0.068)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.447` → IC=+0.177 (n=97)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 7.447 (IC base=+0.068)
...
- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.161 (n=1324)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0044 (IC base=+0.145)
...
- **PATRÓN** `dist_vwap_pct` > `0.1697` → IC=+0.154 (n=365)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.1697 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.4182` → IC=+0.156 (n=1170)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.4182 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.174` → IC=+0.164 (n=251)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 6.174 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.021` → IC=+0.145 (n=914)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 3.021 (IC base=+0.145)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.149 (n=169)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 15.0 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.6262` → IC=+0.141 (n=76)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6262 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.533` → IC=+0.185 (n=125)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 4.533 (IC base=+0.100)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.32` → IC=+0.136 (n=75)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 7.32 (IC base=+0.042)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 579 | +0.125 | +14.38€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 579 | +0.125 | +14.38€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 216 | +0.128 | +0.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 216 | +0.128 | +0.50€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 4613 | +0.186 | +77.89€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3004 | +0.217 | +109.42€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1632 | +0.176 | -0.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 990 | +0.216 | +38.02€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 6504 | +0.100 | +2117.17€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 6504 | +0.100 | +2117.17€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1554 | +0.071 | +281.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1554 | +0.071 | +281.45€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1477 | +0.072 | +260.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1477 | +0.072 | +260.21€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3700 | +0.137 | +2044.29€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3700 | +0.137 | +2044.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 942 | +0.099 | +397.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 942 | +0.099 | +397.72€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 966 | +0.095 | +381.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 966 | +0.095 | +381.81€ | 0 | 7 |
...
| ✅ GBM_LATE_15M_TARDIO | 3677 | +0.089 | +1217.62€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3677 | +0.089 | +1217.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 881 | +0.055 | +159.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 881 | +0.055 | +159.69€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 889 | +0.029 | +79.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 889 | +0.029 | +79.62€ | 0 | 3 |
...
| ✅ LATE_WINDOW_5MIN | 196 | +0.005 | +7.20€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 196 | +0.005 | +7.20€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 196 | +0.005 | +7.20€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 196 | +0.005 | +7.20€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 968 | +0.168 | +440.76€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 968 | +0.168 | +440.76€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 208 | +0.162 | +63.61€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 208 | +0.162 | +63.61€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.196: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.057 n=928 | neutral: IC=+0.000 n=710 | overbought(IBS>0.7): IC=+0.196 n=922
  - _Datos_: n=2738 IC=+0.096 PNL=+652.87€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=16025 | tras_1loss IC=+0.083 n=10495 | tras_2loss IC=+0.048 n=4322/40 | gap=+0.068 (umbral 0.05)
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=196 IC=+0.005 PNL=+7.20€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=196 IC=+0.005 PNL=+7.20€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=24262 IC=+0.115 PNL=+6328.29€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=24262 IC=+0.115 PNL=+6328.29€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.112 > 0.08 con n=364 PNL=+110.00€
  - _Datos_: n=364 IC=+0.112 PNL=+110.00€
