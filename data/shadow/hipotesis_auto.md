# Hipótesis automáticas — 2026-08-26 13:49 UTC
_Generado por shadow_postmortem.py sobre 162414 resoluciones (PNL=+11637.08€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.79` → IC=-0.279 (n=2251)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.79
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=6755)
...
- **FILTRO** `restante_s_al_confirmar` < `157.8` → IC=-0.199 (n=613)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.8
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1841)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.187 (n=5170)
...
- **PATRÓN** `libro_liquidez` > `1839.4583` → IC=+0.181 (n=2384)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 1839.4583 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.129 (n=998)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.196 (n=10309)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.221 (n=8116)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.191)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=2218)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.157 (n=1551)

  - _Acción_: Kelly boost +0.79€ cuando `py_entrada` > 0.71 (IC base=+0.124)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.245 (n=1787)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.237)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.273 (n=1326)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.237 (n=1641)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `1.0239` → IC=+0.217 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.0239 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.229` → IC=+0.168 (n=866)
...
- **PATRÓN** `volumen_regimen` > `1.0648` → IC=+0.257 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0648 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.3067` → IC=+0.134 (n=159)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.3067 (IC base=+0.065)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3375` → IC=+0.219 (n=308)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3375 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.239 (n=350)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.211)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.215 (n=317)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.224 (n=350)
...
- **PATRÓN** `dist_vwap_pct` < `0.5536` → IC=+0.213 (n=301)
...
- **PATRÓN** `volumen_regimen` < `0.7062` → IC=+0.218 (n=154)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7062 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.252 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.0752` → IC=+0.210 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0752 (IC base=+0.211)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3527` → IC=+0.275 (n=109)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3527 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11170.0615` → IC=+0.224 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11170.0615 (IC base=+0.211)
...
- **PATRÓN** `volumen_regimen` < `1.1445` → IC=+0.324 (n=32)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1445 (IC base=-0.032)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1127` → IC=+0.309 (n=19)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1127 (IC base=-0.032)

- **PATRÓN** `volumen_spike_ratio` > `1.8068` → IC=+0.333 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8068 (IC base=-0.032)
...
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.148 (n=897)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.08` → IC=+0.189 (n=101)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 5.08 (IC base=-0.014)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5866` → IC=+0.220 (n=23)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5866 (IC base=-0.014)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.155 (n=2416)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `0.7037` → IC=+0.153 (n=837)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7037 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.155 (n=862)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.0826 (IC base=+0.146)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3285` → IC=+0.145 (n=2087)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=424)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.186 (n=192)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.099 (IC base=+0.157)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.190 (n=330)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.4677` → IC=+0.185 (n=335)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.4677 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `11701.6956` → IC=+0.194 (n=282)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 11701.6956 (IC base=+0.157)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.217 (n=718)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2320)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.181 (n=756)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=2282)
...
- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.155 (n=117)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=362)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=2175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=5324)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.287 (n=1813)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=5686)

- **FILTRO** `ibs_7min` < `0.7353` → IC=-0.235 (n=1874)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7353
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=5625)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.176 (n=2493)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=5006)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=784)
...
- **FILTRO** `ibs_7min` < `0.9818` → IC=-0.203 (n=672)
...
- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.266 (n=254)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=767)
...
- **FILTRO** `ibs_7min` < `0.8057` → IC=-0.165 (n=374)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8057
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1124)
...
- **PATRÓN** `ibs_15` < `0.1111` → IC=+0.141 (n=413)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.70€ cuando `ibs_15` < 0.1111 (IC base=+0.028)
...
- **PATRÓN** `ibs_15` < `0.1171` → IC=+0.205 (n=103)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1171 (IC base=+0.049)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.262` → IC=-0.178 (n=324)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.262
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2338)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.908` → IC=-0.138 (n=208)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1171 sube el IC de +0.049 a +0.205 en UPDOWN_GBM#XRP#15min (n=103). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ FAVORITO_CONFIRMADO | 30347 | +0.114 | -1978.22€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5669 | +0.187 | -192.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21438 | +0.095 | -1696.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3133 | +0.121 | -38.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3599 | +0.063 | -615.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3574 | +0.064 | -611.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6296 | +0.134 | -132.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1597 | +0.197 | -85.93€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3567 | +0.110 | -78.58€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 6760 | +0.129 | -80.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2063 | +0.169 | -10.40€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3569 | +0.114 | -42.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1116 | +0.104 | -19.21€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6488 | +0.132 | -424.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1952 | +0.202 | -100.95€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15330 | +0.191 | -1356.68€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15330 | +0.191 | -1356.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2817 | +0.124 | -523.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2817 | +0.124 | -523.43€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2379 | +0.237 | -46.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2379 | +0.237 | -46.34€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2430 | +0.231 | -68.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2430 | +0.231 | -68.72€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 5614 | +0.096 | -209.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 579 | +0.058 | -29.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 5035 | +0.100 | -179.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 3880 | +0.096 | -98.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 579 | +0.058 | -29.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 3301 | +0.102 | -69.15€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 7239 | +0.044 | +2299.47€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 7239 | +0.044 | +2299.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 959 | +0.173 | +603.17€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 959 | +0.173 | +603.17€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 1011 | +0.174 | +591.92€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1011 | +0.174 | +591.92€ | 0 | 31 |
| ✅ GBM_LATE_15M#DOGE | 962 | +0.184 | +638.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 962 | +0.184 | +638.23€ | 0 | 17 |
| ✅ GBM_LATE_15M#ETH | 1179 | -0.047 | +30.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1179 | -0.047 | +30.97€ | 2 | 11 |
| ✅ GBM_LATE_15M#SOL | 1363 | -0.042 | +142.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1363 | -0.042 | +142.07€ | 4 | 3 |
| ✅ GBM_LATE_15M#XRP | 1765 | -0.052 | +293.12€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1765 | -0.052 | +293.12€ | 4 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 8205 | +0.045 | +3180.15€ | 0 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 8205 | +0.045 | +3180.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1244 | -0.023 | +623.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1244 | -0.023 | +623.08€ | 2 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1799 | -0.036 | +166.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1799 | -0.036 | +166.54€ | 0 | 1 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 832 | +0.235 | +744.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 832 | +0.235 | +744.59€ | 0 | 21 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1456 | +0.241 | +1350.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1456 | +0.241 | +1350.34€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 5853 | +0.170 | +4028.71€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 5853 | +0.170 | +4028.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 732 | +0.191 | +531.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 732 | +0.191 | +531.95€ | 0 | 18 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 994 | +0.167 | +683.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 994 | +0.167 | +683.98€ | 0 | 22 |
...
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 1299 | +0.191 | +972.33€ | 0 | 23 |
...
| ✅ GBM_LATE_15M_TARDIO | 6811 | +0.168 | +4499.58€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#15min | 6811 | +0.168 | +4499.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 918 | +0.189 | +655.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 918 | +0.189 | +655.93€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 