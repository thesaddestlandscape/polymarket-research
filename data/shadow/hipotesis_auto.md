# Hipótesis automáticas — 2026-09-22 08:51 UTC
_Generado por shadow_postmortem.py sobre 554906 resoluciones (PNL=+61861.07€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.249 (n=496)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.249 (n=496)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.146 (n=362)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 11.0 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=560)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `2935.919` → IC=+0.138 (n=349)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2935.919 (IC base=+0.133)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.255 (n=394)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.255 (n=394)
...
- **PATRÓN** `banda_z` > `10.99` → IC=+0.223 (n=139)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.99 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.158 (n=296)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 11.0 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=474)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.02` → IC=-0.232 (n=6684)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.02
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=20062)
...
- **FILTRO** `restante_s_al_confirmar` < `135.23` → IC=-0.277 (n=818)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 135.23
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2455)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `162.79` → IC=-0.228 (n=1582)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 162.79
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4748)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `123.8` → IC=-0.363 (n=1329)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 123.8
  - _Potencial_: sin este filtro IC_bueno=-0.124 (n=3988)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.201 (n=13297)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3331)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `9526.5258` → IC=+0.189 (n=1443)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 9526.5258 (IC base=+0.101)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.234 (n=10275)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=5429)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `7654.5864` → IC=+0.172 (n=2040)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7654.5864 (IC base=+0.129)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1622)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1596)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.351 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2007)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15752.6972` → IC=+0.230 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15752.6972 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.203 (n=1435)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1593)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1453)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=2038)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `13885.0763` → IC=+0.207 (n=716)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13885.0763 (IC base=+0.199)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=2671)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.143 (n=2287)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.140 (n=564)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1301.6177` → IC=+0.149 (n=624)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1301.6177 (IC base=+0.135)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.431 (n=608)
...
- **PATRÓN** `py_entrada` < `0.355` → IC=+0.203 (n=365)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.355 (IC base=+0.117)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=10770)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=10328)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2507)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.184 (n=1829)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.254 (n=714)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=5855)
...
- **PATRÓN** `lag_apertura_s` < `3.48` → IC=+0.146 (n=2223)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 3.48 (IC base=+0.122)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.195 (n=2436)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.38 (IC base=+0.115)

- **PATRÓN** `restante_min` < `4.18` → IC=+0.126 (n=2268)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.18 (IC base=+0.115)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.138 (n=2418)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` > 4.96 (IC base=+0.115)

- **PATRÓN** `lag_apertura_s` < `2.32` → IC=+0.142 (n=2257)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.207 (n=39)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4724` → IC=+0.120 (n=7508)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.4724 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9815` → IC=+0.241 (n=2503)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9815 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8286` → IC=+0.247 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8286 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.6234` → IC=+0.245 (n=2083)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6234 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.928` → IC=+0.178 (n=2895)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.928 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.2128` → IC=+0.242 (n=2008)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2128 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0517` → IC=+0.253 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0517 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3055` → IC=+0.213 (n=748)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3055 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.9108` → IC=+0.207 (n=3404)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9108 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5703` → IC=+0.132 (n=9060)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5703 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.592` → IC=+0.191 (n=680)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.592 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.1472` → IC=+0.173 (n=2824)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1472 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.175 (n=1377)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6986 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `0.8688` → IC=+0.174 (n=2083)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8688 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.1678` → IC=+0.222 (n=1493)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1678 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` > `1.5781` → IC=+0.201 (n=4656)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5781 (IC base=+0.063)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.210 (n=4990)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=+0.063)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.178 (n=572)
...
- **PATRÓN** `drift_60min` |x|≤ `0.346` → IC=+0.165 (n=1703)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.166 (n=1588)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.233 (n=1072)
...
- **PATRÓN** `libro_liquidez` > `1781.7648` → IC=+0.243 (n=837)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1781.7648 (IC base=+0.235)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.236 (n=573)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.229 (n=1361)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` > `2.368` → IC=+0.222 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.368 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `16507.001` → IC=+0.224 (n=433)
...
- **PATRÓN** `ibs_20min` < `0.6846` → IC=+0.168 (n=1347)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.6846 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1271` → IC=+0.158 (n=1202)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4323` → IC=+0.149 (n=1237)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=1741)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 5.0 (IC base=+0.188)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=1483)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.101` → IC=+0.254 (n=356)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.101 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` < `0.2115` → IC=+0.191 (n=1645)
...
- **PATRÓN** `volumen_spike_ratio` > `1.832` → IC=+0.194 (n=1401)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.832 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.197 (n=1141)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.02 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.223 (n=1412)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.0637` → IC=+0.242 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0637 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.685` → IC=+0.238 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.685 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` > `0.3589` → IC=+0.270 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3589 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` < `1.6264` → IC=+0.207 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6264 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.881` → IC=+0.228 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.881 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1861.0222` → IC=+0.231 (n=640)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1861.0222 (IC base=+0.216)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.218 (n=1079)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.153 (n=93)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2085)

- **PATRÓN** `ibs_20min` > `0.94` → IC=+0.204 (n=339)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.666` → IC=+0.151 (n=666)
...
- **PATRÓN** `dist_vwap_pct` > `0.6715` → IC=+0.191 (n=137)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.6715 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `0.8511` → IC=+0.159 (n=508)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8511 (IC base=+0.013)

- **PATRÓN** `volumen_pendiente_norm` > `0.2244` → IC=+0.226 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2244 (IC base=+0.013)

- **PATRÓN** `volumen_spike_ratio` > `1.5133` → IC=+0.177 (n=633)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5133 (IC base=+0.013)
...
- **FILTRO** `ibs_20min` > `0.2581` → IC=-0.125 (n=2064)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2581
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1019)

- **FILTRO** `sigma_ewma_delta_pct` > `8.655` → IC=-0.209 (n=331)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.655
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2752)
...
- **PATRÓN** `ibs_20min` < `0.2581` → IC=+0.124 (n=1019)
...
- **PATRÓN** `dist_vwap_pct` < `0.4425` → IC=+0.206 (n=352)
...
- **FILTRO** `drift_60min` |x|> `0.6416` → IC=-0.182 (n=523)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6416
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1572)

- **FILTRO** `ibs_20min` < `0.6988` → IC=-0.156 (n=1382)
...
- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.203 (n=778)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=2337)
...
- **PATRÓN** `dist_vwap_pct` > `1.0544` → IC=+0.281 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0544 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.7389` → IC=+0.247 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7389 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` > `1.0811` → IC=+0.290 (n=313)
...
- **PATRÓN** `ibs_20min` > `0.8932` → IC=+0.265 (n=646)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8932 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.294` → IC=+0.164 (n=890)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 3.294 (IC base=+0.045)
...
- **FILTRO** `ibs_20min` > `0.8136` → IC=-0.150 (n=680)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8136
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=2041)

- **PATRÓN** `ibs_20min` > `0.8588` → IC=+0.157 (n=631)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8588 (IC base=+0.023)

- **PATRÓN** `dist_vwap_pct` > `0.3003` → IC=+0.169 (n=351)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.3003 (IC base=+0.023)

- **PATRÓN** `volumen_regimen` < `1.0443` → IC=+0.145 (n=758)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0443 (IC base=+0.023)

- **PATRÓN** `volumen_regimen` > `0.6606` → IC=+0.158 (n=770)
...
- **PATRÓN** `dist_vwap_pct` < `0.1592` → IC=+0.220 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1592 (IC base=+0.001)

- **PATRÓN** `volumen_regimen` > `0.6059` → IC=+0.212 (n=515)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.246 (n=1486)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1382` → IC=+0.257 (n=1314)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=1013)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.245)

- **PATRÓN** `libro_liquidez` > `1928.9792` → IC=+0.248 (n=495)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1928.9792 (IC base=+0.245)

- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.321 (n=533)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.2233` → IC=+0.291 (n=1035)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6093` → IC=+0.290 (n=360)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.293 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.284)

- **PATRÓN** `libro_liquidez` > `1913.8215` → IC=+0.310 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1913.8215 (IC base=+0.284)

- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.292 (n=473)
...
- **FILTRO** `ibs_20min` < `0.2776` → IC=-0.194 (n=455)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1365)
...
- **PATRÓN** `ibs_20min` > `0.9033` → IC=+0.176 (n=455)
...
- **PATRÓN** `volumen_regimen` < `0.9865` → IC=+0.232 (n=445)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9865 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` > `0.6488` → IC=+0.205 (n=452)
...
- **PATRÓN** `dist_vwap_pct` < `0.6717` → IC=+0.187 (n=420)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.6717 (IC base=-0.008)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2772` → IC=+0.274 (n=51)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2772 (IC base=-0.008)

- **PATRÓN** `volumen_spike_ratio` < `1.8248` → IC=+0.249 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8248 (IC base=-0.008)
...
- **FILTRO** `ibs_20min` < `0.7143` → IC=-0.204 (n=995)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=+0.276 (n=996)

- **FILTRO** `ibs_20min` > `0.6897` → IC=-0.230 (n=523)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6897
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1570)

- **FILTRO** `sigma_ewma_delta_pct` > `4.656` → IC=-0.182 (n=460)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.656
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=1633)

- **PATRÓN** `ibs_20min` > `0.7143` → IC=+0.276 (n=996)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.526` → IC=+0.161 (n=314)
...
- **PATRÓN** `volumen_regimen` > `0.6388` → IC=+0.288 (n=726)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4432` → IC=+0.319 (n=235)
...
- **PATRÓN** `dist_vwap_pct` < `0.218` → IC=+0.228 (n=447)
...
- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.245 (n=429)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.294 (n=576)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.278)

- **PATRÓN** `ibs_20min` > `0.63` → IC=+0.311 (n=1221)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.63 (IC base=+0.278)

- **PATRÓN** `dist_vwap_pct` > `0.195` → IC=+0.319 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.195 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.487` → IC=+0.303 (n=647)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.487 (IC base=+0.278)

- **PATRÓN** `volumen_regimen` > `0.8624` → IC=+0.303 (n=814)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8624 (IC base=+0.278)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.318 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` > `2.5204` → IC=+0.288 (n=385)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5204 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1292)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `2609.87` → IC=+0.289 (n=814)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2609.87 (IC base=+0.278)

- **PATRÓN** `sigma_h` > `0.015` → IC=+0.296 (n=891)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.015 (IC base=+0.270)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.273 (n=1277)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.270)

- **PATRÓN** `ibs_20min` < `0.3953` → IC=+0.303 (n=1336)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3953 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` > `0.287` → IC=+0.280 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.287 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` < `0.9266` → IC=+0.270 (n=1502)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9266 (IC base=+0.270)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5449` → IC=+0.268 (n=515)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5449 (IC base=+0.270)
...
- **PATRÓN** `libro_liquidez` > `2598.7344` → IC=+0.276 (n=890)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2598.7344 (IC base=+0.270)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.170 (n=2471)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.205 (n=2463)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0111 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.3539` → IC=+0.175 (n=6500)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3539 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=7704)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5789` → IC=+0.217 (n=7386)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5789 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1732` → IC=+0.196 (n=3241)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1732 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.243` → IC=+0.259 (n=1514)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.243 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2173` → IC=+0.161 (n=4891)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2173 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6273` → IC=+0.160 (n=4891)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6273 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2458` → IC=+0.195 (n=1487)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2458 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5622` → IC=+0.171 (n=3109)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5622 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6294` → IC=+0.176 (n=2356)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6294 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2392.8562` → IC=+0.168 (n=4923)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2392.8562 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.182 (n=6292)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 117.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=4681)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0799` → IC=+0.205 (n=2343)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4762` → IC=+0.226 (n=7016)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4762 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2291` → IC=+0.160 (n=5096)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2291 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.234` → IC=+0.194 (n=1190)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.234 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1755` → IC=+0.152 (n=5107)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5705` → IC=+0.165 (n=2791)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.5705 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2649` → IC=+0.171 (n=2876)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2649 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.172 (n=5974)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 118.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.219 (n=422)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1866` → IC=+0.296 (n=600)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1866 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.247 (n=805)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3427` → IC=+0.266 (n=900)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3427 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.083` → IC=+0.253 (n=978)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.083 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` < `0.0953` → IC=+0.238 (n=746)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2544` → IC=+0.245 (n=725)
...
- **PATRÓN** `libro_liquidez` > `1787.4775` → IC=+0.251 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1787.4775 (IC base=+0.239)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.243 (n=368)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.199 (n=367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=1158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4084` → IC=+0.226 (n=1100)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.523` → IC=+0.237 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.523 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.164 (n=1100)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2653 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `1.0753` → IC=+0.167 (n=499)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.0753 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2325` → IC=+0.200 (n=241)
...
- **PATRÓN** `libro_liquidez` > `15819.1278` → IC=+0.169 (n=499)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 15819.1278 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.156 (n=1196)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0058 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2905` → IC=+0.158 (n=1195)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.2905 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=583)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.5573` → IC=+0.184 (n=1195)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4356` → IC=+0.145 (n=1084)
...
- **PATRÓN** `sigma_h` < `0.011` → IC=+0.236 (n=1009)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.4327` → IC=+0.160 (n=1180)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.4327 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1239)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.3888` → IC=+0.197 (n=1179)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3888 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.1604` → IC=+0.181 (n=792)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1604 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.946` → IC=+0.236 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.946 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `1.0458` → IC=+0.149 (n=1038)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.0458 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `0.6318` → IC=+0.149 (n=1179)
...
- **PATRÓN** `libro_liquidez` > `6960.2205` → IC=+0.185 (n=786)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6960.2205 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.147 (n=1117)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 166.0 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.155 (n=1238)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0073 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3834` → IC=+0.142 (n=1237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3834 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.181 (n=415)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 18.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6186` → IC=+0.169 (n=1237)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6186 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.1596` → IC=+0.143 (n=1195)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1596 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.896` → IC=+0.173 (n=436)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 6.896 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.849` → IC=+0.146 (n=825)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7906` → IC=+0.130 (n=746)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.7906 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4847` → IC=+0.137 (n=373)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.4847 (IC base=+0.123)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.157 (n=607)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0101 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.137 (n=1370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` > `0.5172` → IC=+0.202 (n=1338)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5172 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `0.8398` → IC=+0.215 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8398 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.59` → IC=+0.256 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.59 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `1.2249` → IC=+0.129 (n=1338)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2249 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `2.4822` → IC=+0.127 (n=1290)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.4822 (IC base=+0.116)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1394)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2892.276` → IC=+0.196 (n=607)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2892.276 (IC base=+0.116)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.135 (n=1018)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 50.0 (IC base=+0.116)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.148 (n=595)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0061 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.1032` → IC=+0.145 (n=451)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.208 (n=1353)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.9824` → IC=+0.139 (n=189)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.9824 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.1963` → IC=+0.137 (n=1233)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1963 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.434` → IC=+0.147 (n=281)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 7.434 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.1889` → IC=+0.121 (n=1353)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4294` → IC=+0.126 (n=402)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.4294 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3081.0348` → IC=+0.158 (n=451)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3081.0348 (IC base=+0.112)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0187` → IC=+0.215 (n=850)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0187 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=1326)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7368` → IC=+0.260 (n=1139)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.158 (n=577)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0039 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.175 (n=573)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0089 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.1349` → IC=+0.151 (n=757)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1349 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=871)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.5522` → IC=+0.187 (n=1536)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5522 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.868` → IC=+0.196 (n=284)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.868 (IC base=+0.145)
...
- **PATRÓN** `volumen_regimen` < `0.8749` → IC=+0.162 (n=997)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8749 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `0.701` → IC=+0.148 (n=1336)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.701 (IC base=+0.145)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4364` → IC=+0.164 (n=551)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4364 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `2.5508` → IC=+0.164 (n=551)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.5508 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=1937)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `2503.2481` → IC=+0.146 (n=1535)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2503.2481 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.163 (n=1498)
...
- **PATRÓN** `ibs_20min` < `0.6561` → IC=+0.131 (n=1802)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.6561 (IC base=+0.101)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3377` → IC=+0.121 (n=433)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.3377 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.144 (n=408)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 8.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.2517` → IC=+0.139 (n=433)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.2517 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.5024` → IC=+0.157 (n=106)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.5024 (IC base=+0.099)

- **PATRÓN** `volumen_regimen` < `0.6135` → IC=+0.140 (n=145)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.6135 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `12350.4009` → IC=+0.127 (n=387)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 12350.4009 (IC base=+0.099)
...
- **PATRÓN** `ibs_20min` < `0.0725` → IC=+0.163 (n=158)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.0725 (IC base=+0.073)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.205 (n=3132)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0111 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=9797)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.4711` → IC=+0.215 (n=9394)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4711 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9517` → IC=+0.208 (n=1358)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9517 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.61` → IC=+0.228 (n=4571)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.61 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `0.8826` → IC=+0.165 (n=4191)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8826 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.29` → IC=+0.201 (n=1300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.29 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6131` → IC=+0.189 (n=3003)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6131 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2337.0092` → IC=+0.170 (n=6263)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2337.0092 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.194 (n=7082)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 89.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.187 (n=7490)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0092 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.4894` → IC=+0.183 (n=8504)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4894 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.205 (n=3239)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5644` → IC=+0.237 (n=8504)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5644 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2434` → IC=+0.162 (n=5267)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2434 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.923` → IC=+0.198 (n=1194)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.923 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.71` → IC=+0.182 (n=8244)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.71 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7044` → IC=+0.160 (n=2586)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.7044 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2037` → IC=+0.153 (n=1959)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3513` → IC=+0.189 (n=1600)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.199 (n=1084)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.978` → IC=+0.311 (n=717)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5787` → IC=+0.210 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5787 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.258 (n=1227)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.269 (n=1102)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.289 (n=1080)
...
- **PATRÓN** `libro_liquidez` > `1781.58` → IC=+0.268 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1781.58 (IC base=+0.258)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.193 (n=506)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0028 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0842` → IC=+0.161 (n=503)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0842 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1575)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3134` → IC=+0.200 (n=1509)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3134 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.128` → IC=+0.183 (n=860)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.128 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.170 (n=346)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.757 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.234` → IC=+0.150 (n=1353)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.234 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6267` → IC=+0.173 (n=503)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.159 (n=1280)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7583` → IC=+0.153 (n=969)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.7583 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `13760.2251` → IC=+0.147 (n=1006)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 13760.2251 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `478.0` → IC=+0.154 (n=1384)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 478.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.164 (n=1300)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0057 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.3224` → IC=+0.161 (n=1300)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.267` → IC=+0.234 (n=867)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.267 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.1318` → IC=+0.168 (n=1177)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1318 (IC base=+0.150)
...
- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.161 (n=1300)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1913 (IC base=+0.150)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4232` → IC=+0.160 (n=1201)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4232 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `2.1036` → IC=+0.164 (n=545)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.1036 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `426.0` → IC=+0.157 (n=971)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 426.0 (IC base=+0.150)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.238 (n=685)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0101 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=1581)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1536)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.779` → IC=+0.294 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.779 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` < `0.212` → IC=+0.223 (n=1481)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.230 (n=1039)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1931.278` → IC=+0.219 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1931.278 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.233 (n=1235)
...
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.239 (n=936)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.008 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.1606` → IC=+0.243 (n=617)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1971` → IC=+0.282 (n=935)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1971 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.746` → IC=+0.280 (n=502)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7685` → IC=+0.238 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7685 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` > `2.2037` → IC=+0.237 (n=851)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2037 (IC base=+0.236)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.248 (n=910)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `1862.6032` → IC=+0.251 (n=636)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1862.6032 (IC base=+0.236)

- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.254 (n=405)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1367` → IC=+0.153 (n=702)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.1367 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `8150.9116` → IC=+0.229 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8150.9116 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.151 (n=505)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 81.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.162 (n=1146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0066 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4461` → IC=+0.155 (n=1302)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.693` → IC=+0.186 (n=1302)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.693 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.8109` → IC=+0.141 (n=1501)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.8109 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.146` → IC=+0.177 (n=193)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 11.146 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8594` → IC=+0.145 (n=868)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8594 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `1.1778` → IC=+0.147 (n=434)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.151 (n=1231)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `10998.3764` → IC=+0.211 (n=434)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10998.3764 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.142 (n=1224)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 181.0 (IC base=+0.137)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.133 (n=1062)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.187 (n=1594)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4706 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `1.0764` → IC=+0.199 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0764 (IC base=+0.107)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1609)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1563)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.2195` → IC=+0.131 (n=1259)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2195 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.449` → IC=+0.127 (n=1509)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.449 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.155 (n=687)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.72 (IC base=+0.112)
...
- **PATRÓN** `ibs_20min` < `0.5207` → IC=+0.254 (n=1715)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5207 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` < `0.8681` → IC=+0.202 (n=1900)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8681 (IC base=+0.199)
...
- **PATRÓN** `volumen_regimen` > `1.2318` → IC=+0.239 (n=572)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2122` → IC=+0.192 (n=1348)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2122 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4369` → IC=+0.198 (n=1533)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.137 (n=2860)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4847` → IC=+0.153 (n=2157)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4847 (IC base=+0.135)
...
- **PATRÓN** `ibs_20min` < `0.1833` → IC=+0.164 (n=949)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.1833 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.9229` → IC=+0.149 (n=337)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.9229 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.2479` → IC=+0.128 (n=1922)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2479 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.214` → IC=+0.143 (n=2146)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 6.214 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.9014` → IC=+0.150 (n=1370)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.9014 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8136` → IC=+0.141 (n=1421)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8136 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.137 (n=2860)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.01 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7032.9879` → IC=+0.150 (n=1927)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7032.9879 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.154 (n=704)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0084 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3914` → IC=+0.171 (n=618)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3914 (IC base=+0.140)
...
- **PATRÓN** `ibs_20min` < `0.735` → IC=+0.140 (n=704)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.735 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.1015` → IC=+0.152 (n=702)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.1015 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.6251` → IC=+0.171 (n=165)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6251 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.3871` → IC=+0.142 (n=705)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3871 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.966` → IC=+0.152 (n=156)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 8.966 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.281` → IC=+0.142 (n=637)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.281 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.0934` → IC=+0.152 (n=618)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.0934 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.721` → IC=+0.143 (n=628)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.721 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.0731` → IC=+0.173 (n=301)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0731 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.183` → IC=+0.153 (n=606)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.183 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.7713` → IC=+0.155 (n=459)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7713 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `7600.4466` → IC=+0.165 (n=702)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.213 (n=367)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.127 (n=773)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 8.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.5536` → IC=+0.182 (n=743)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.5536 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.1483` → IC=+0.155 (n=412)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.1483 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.443` → IC=+0.213 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.443 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2818` → IC=+0.213 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2818 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `2.0983` → IC=+0.142 (n=556)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.0983 (IC base=+0.094)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=601)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2435.8886` → IC=+0.146 (n=326)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2435.8886 (IC base=+0.094)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.273 (n=126)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.5656` → IC=+0.193 (n=255)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.5656 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1301` → IC=+0.184 (n=134)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1301 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.0632` → IC=+0.126 (n=225)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0632 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` < `0.0651` → IC=+0.132 (n=191)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` < 0.0651 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.2692` → IC=+0.167 (n=34)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2692 (IC base=+0.106)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.122 (n=260)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.135 (n=269)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 7.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.5333` → IC=+0.200 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5333 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.3424` → IC=+0.164 (n=105)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.3424 (IC base=+0.105)
...
- **PATRÓN** `volumen_regimen` < `0.8141` → IC=+0.128 (n=170)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.8141 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `0.6345` → IC=+0.126 (n=228)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` > 0.6345 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7387` → IC=+0.159 (n=136)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.7387 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.4015` → IC=+0.126 (n=204)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.4015 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=267)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `1606.9963` → IC=+0.181 (n=114)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 1606.9963 (IC base=+0.105)
...
- **PATRÓN** `ibs_20min` > `0.6842` → IC=+0.174 (n=210)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.6842 (IC base=+0.069)

- **PATRÓN** `dist_vwap_pct` > `0.198` → IC=+0.142 (n=135)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.198 (IC base=+0.069)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.244` → IC=+0.204 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.244 (IC base=+0.069)

- **PATRÓN** `volumen_pendiente_norm` > `0.0831` → IC=+0.170 (n=98)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.0831 (IC base=+0.069)
...
- **FILTRO** `dist_vwap_pct` > `0.2402` → IC=-0.324 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.219 (n=176)
...
- **FILTRO** `volumen_regimen` > `1.108` → IC=-0.265 (n=15)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.121 (n=639)

  - _Acción_: Kelly boost +0.60€ cuando `py_entrada` > 0.5 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2870.7742` → IC=+0.161 (n=216)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2870.7742 (IC base=+0.106)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1622)
...
- **PATRÓN** `liq_n` > `18.0` → IC=+0.217 (n=44)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `liq_n` > 18.0 (IC base=+0.033)

- **PATRÓN** `liq_usd_total` > `76612.5` → IC=+0.179 (n=82)

  - _Acción_: Kelly boost +0.89€ cuando `liq_usd_total` > 76612.5 (IC base=+0.033)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=323)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7312)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.176 (n=3141)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9972)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.174 (n=3291)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=10296)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.215 (n=560)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1702)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.174 (n=559)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1869)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.202 (n=576)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.107 (n=1729)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.206 (n=597)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1824)

- **FILTRO** `ibs_20min` > `0.2846` → IC=-0.163 (n=604)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2846
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1817)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2814)
...
- **FILTRO** `py_entrada` > `0.625` → IC=-0.273 (n=64)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=213)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=9434)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=20814)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.275 (n=7323)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=22925)

- **FILTRO** `ibs_7min` < `0.291` → IC=-0.236 (n=7562)

  - _Acción_: SKIP cuando `ibs_7min` < 0.291
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=22686)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=10253)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19995)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=9387)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=28415)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.180 (n=9413)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=28389)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.135 (n=1544)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3422)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.306 (n=1186)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3780)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.251 (n=1635)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3331)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.183 (n=1160)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3806)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.260 (n=1620)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=4890)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.124 (n=2213)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4297)

- **FILTRO** `ibs_7min` > `0.7922` → IC=-0.205 (n=1627)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7922
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4883)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4009)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1259)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3987)

- **FILTRO** `ibs_7min` < `0.7506` → IC=-0.194 (n=1311)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7506
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3935)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.172 (n=1310)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3936)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=1306)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=3979)

- **FILTRO** `ibs_7min` > `0.2588` → IC=-0.176 (n=1321)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2588
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3964)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.188 (n=1313)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=3972)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.169 (n=1352)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3354)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.309 (n=1147)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3559)

- **FILTRO** `ibs_7min` < `0.1963` → IC=-0.259 (n=1176)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1963
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3530)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.214 (n=1115)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3591)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1611)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=5328)

- **FILTRO** `ibs_7min` > `0.7547` → IC=-0.178 (n=1734)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7547
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=5205)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.242 (n=1221)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3758)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.181 (n=1243)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3736)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.172 (n=1222)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3757)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.265 (n=1128)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3953)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.173 (n=1270)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3811)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.191 (n=1244)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3837)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.263 (n=1255)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4055)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1299)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4011)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1722)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=5457)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.276 (n=1188)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3853)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.232 (n=1257)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3784)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1209)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3832)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1664)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5144)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1043)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=594)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=698)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=704)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=684)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=2753)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0691` → IC=+0.158 (n=153)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0691 (IC base=+0.141)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2344` → IC=+0.178 (n=116)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.89€ cuando `delta_ratio_macro` |x|> 0.2344 (IC base=+0.141)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2558` → IC=+0.169 (n=243)

  - _Acción_: Kelly boost +0.85€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2558 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.165 (n=255)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 11.0 (IC base=+0.141)

- **PATRÓN** `ibs_15` > `0.6675` → IC=+0.239 (n=309)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.1631` → IC=+0.162 (n=270)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1631 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.56` → IC=+0.206 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.56 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `3462.5082` → IC=+0.153 (n=309)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3462.5082 (IC base=+0.141)
...
- **FILTRO** `dist_vwap_pct` > `0.7126` → IC=-0.146 (n=97)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=794)
...
- **FILTRO** `sigma_h` > `0.0131` → IC=-0.214 (n=618)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1856)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.189 (n=814)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1660)

- **FILTRO** `libro_liquidez` < `3915.9217` → IC=-0.134 (n=1632)

  - _Acción_: SKIP cuando `libro_liquidez` < 3915.9217
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=842)
...
- **PATRÓN** `ibs_15` > `0.6326` → IC=+0.266 (n=604)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.2726` → IC=+0.176 (n=473)
...
- **FILTRO** `sigma_h` < `0.0038` → IC=-0.226 (n=497)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0038
  - _Potencial_: sin este filtro IC_bueno=-0.183 (n=1012)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=953)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=556)

- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.248 (n=268)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.716
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1241)
...
- **PATRÓN** `dist_vwap_pct` > `1.111` → IC=+0.373 (n=61)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.111 (IC base=-0.046)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6071 sube el IC de +0.186 a +0.262 en UPDOWN_GBM#15min (n=1455). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6675 sube el IC de +0.141 a +0.239 en UPDOWN_GBM#ETH#15min (n=309). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6326 sube el IC de -0.061 a +0.266 en UPDOWN_GBM_15M_TARDIO (n=604). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.046 a +0.310 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=424). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1263 | +0.092 | +161.17€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1263 | +0.092 | +161.17€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 934 | +0.102 | +135.97€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 934 | +0.102 | +135.97€ | 2 | 7 |
...
| ✅ BALLENAS_TARDIAS | 23847 | -0.091 | -3088.77€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1415 | -0.046 | -217.33€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22432 | -0.094 | -2871.44€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 6846 | -0.026 | -606.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6846 | -0.026 | -606.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6330 | -0.094 | -417.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6330 | -0.094 | -417.08€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5317 | -0.184 | -1112.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5317 | -0.184 | -1112.51€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 16401 | -0.030 | +4124.26€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4306 | +0.000 | +1838.88€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12095 | -0.041 | +2285.38€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 16401 | -0.030 | +4124.26€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4306 | +0.000 | +1838.88€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12095 | -0.041 | +2285.38€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 87385 | +0.113 | -4432.50€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13357 | +0.184 | -434.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 347 | -0.096 | -49.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 67914 | +0.100 | -3756.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5767 | +0.110 | -192.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11301 | +0.098 | -977.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 44 | -0.174 | -3.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11242 | +0.100 | -962.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 17674 | +0.132 | -369.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4172 | +0.202 | -146.60€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11257 | +0.112 | -178.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2203 | +0.107 | -22.86€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11342 | +0.089 | -1074.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 51 | -0.085 | -5.77€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11276 | +0.090 | -1057.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 18630 | +0.124 | -379.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5164 | +0.174 | -84.20€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11370 | +0.105 | -234.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2084 | +0.098 | -52.75€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17120 | +0.115 | -968.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3882 | +0.188 | -203.53€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 250 | -0.056 | +4.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11508 | +0.092 | -652.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1480 | +0.130 | -116.55€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11318 | +0.102 | -663.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 44 | -0.022 | +8.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11261 | +0.102 | -671.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 13861 | +0.192 | -899.18€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 13861 | +0.192 | -899.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3330 | +0.169 | -350.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3330 | +0.169 | -350.56€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1052 | +0.196 | -2.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1052 | +0.196 | -2.28€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3266 | +0.182 | -273.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3266 | +0.182 | -273.44€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2927 | +0.238 | -96.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2927 | +0.238 | -96.33€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3207 | +0.194 | -190.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3207 | +0.194 | -190.33€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 655 | +0.428 | -20.03€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 655 | +0.428 | -20.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 249 | +0.432 | -5.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 249 | +0.432 | -5.10€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 47557 | +0.198 | -3712.62€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 47557 | +0.198 | -3712.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8237 | +0.176 | -955.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8237 | +0.176 | -955.69€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7590 | +0.225 | -267.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7590 | +0.225 | -267.63€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8211 | +0.174 | -969.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8211 | +0.174 | -969.96€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 7683 | +0.219 | -296.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 7683 | +0.219 | -296.36€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 7855 | +0.204 | -515.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 7855 | +0.204 | -515.72€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 7981 | +0.193 | -707.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 7981 | +0.193 | -707.27€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 17907 | +0.118 | +160.65€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 17907 | +0.118 | +160.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 8884 | +0.122 | +129.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 8884 | +0.122 | +129.78€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9023 | +0.115 | +30.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9023 | +0.115 | +30.86€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1039 | +0.073 | -44.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 362 | +0.060 | -29.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 677 | +0.080 | -15.46€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 817 | +0.081 | -17.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 140 | +0.085 | -2.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 677 | +0.080 | -15.46€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 32761 | +0.098 | -1019.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2715 | +0.090 | +22.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 30046 | +0.098 | -1041.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 18464 | +0.102 | -296.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2715 | +0.090 | +22.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 15749 | +0.104 | -319.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6047 | +0.107 | -40.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6047 | +0.107 | -40.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8250 | +0.081 | -682.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8250 | +0.081 | -682.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 773 | +0.220 | -94.40€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 773 | +0.220 | -94.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 773 | +0.220 | -94.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 773 | +0.220 | -94.40€ | 2 | 4 |
| ✅ GBM_LATE_15M | 23737 | +0.081 | +11129.10€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 23737 | +0.081 | +11129.10€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 3944 | +0.193 | +2856.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 3944 | +0.193 | +2856.70€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 3524 | +0.175 | +2407.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3524 | +0.175 | +2407.90€ | 0 | 26 |
| ✅ GBM_LATE_15M#DOGE | 4088 | +0.201 | +3087.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4088 | +0.201 | +3087.91€ | 0 | 20 |
| ✅ GBM_LATE_15M#ETH | 3531 | +0.016 | +688.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3531 | +0.016 | +688.40€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3440 | -0.033 | +786.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3440 | -0.033 | +786.81€ | 4 | 13 |
| ✅ GBM_LATE_15M#XRP | 5210 | -0.044 | +1301.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5210 | -0.044 | +1301.38€ | 4 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 25101 | +0.083 | +13084.04€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 25101 | +0.083 | +13084.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4770 | +0.014 | +2588.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4770 | +0.014 | +2588.26€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5242 | +0.012 | +1046.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5242 | +0.012 | +1046.25€ | 1 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3546 | +0.262 | +3572.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3546 | +0.262 | +3572.64€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4052 | -0.001 | +740.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4052 | -0.001 | +740.92€ | 2 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4084 | +0.025 | +1524.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4084 | +0.025 | +1524.53€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3407 | +0.274 | +3611.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3407 | +0.274 | +3611.44€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 19198 | +0.168 | +14188.35€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 19198 | +0.168 | +14188.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2880 | +0.206 | +2285.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2880 | +0.206 | +2285.83€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3059 | +0.148 | +2182.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3059 | +0.148 | +2182.20€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 2988 | +0.211 | +2409.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 2988 | +0.211 | +2409.95€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3221 | +0.134 | +2175.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3221 | +0.134 | +2175.41€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3586 | +0.114 | +2404.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3586 | +0.114 | +2404.25€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3464 | +0.203 | +2730.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3464 | +0.203 | +2730.71€ | 0 | 25 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4693 | +0.122 | +1882.81€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4693 | +0.122 | +1882.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1341 | +0.117 | +561.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1341 | +0.117 | +561.58€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 369 | +0.147 | +180.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 369 | +0.147 | +180.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1309 | +0.140 | +565.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1309 | +0.140 | +565.95€ | 0 | 14 |
...
| ✅ GBM_LATE_15M_TARDIO | 23861 | +0.174 | +17534.79€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 23861 | +0.174 | +17534.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3767 | +0.218 | +3146.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3767 | +0.218 | +3146.34€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3743 | +0.148 | +2421.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3743 | +0.148 | +2421.47€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 3881 | +0.227 | +3363.65€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 3881 | +0.227 | +3363.65€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 3870 | +0.136 | +2583.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 3870 | +0.136 | +2583.70€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4199 | +0.110 | +2584.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4199 | +0.110 | +2584.43€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4401 | +0.203 | +3435.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4401 | +0.203 | +3435.20€ | 0 | 22 |
| ✅ GBM_LATE_5M | 6542 | +0.143 | +3623.77€ | 1 | 27 |
| ✅ GBM_LATE_5M#5min | 6542 | +0.143 | +3623.77€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 2053 | +0.147 | +1120.49€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 2053 | +0.147 | +1120.49€ | 0 | 31 |
...
| ✅ GBM_LATE_60M | 1562 | +0.066 | +666.50€ | 2 | 12 |
| ✅ GBM_LATE_60M#60min | 1562 | +0.066 | +666.50€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 563 | +0.088 | +235.75€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 563 | +0.088 | +235.75€ | 0 | 13 |
| ✅ GBM_LATE_60M#ETH | 519 | +0.070 | +258.92€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 519 | +0.070 | +258.92€ | 2 | 18 |
| ✅ GBM_LATE_60M#SOL | 480 | +0.035 | +171.83€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 480 | +0.035 | +171.83€ | 1 | 10 |
| 🚫 GBM_LATE_60M_FADE | 349 | -0.261 | -25.86€ | 7 | 0 |
| 🚫 GBM_LATE_60M_FADE#60min | 349 | -0.261 | -25.86€ | 0 | 0 |
...
| ✅ LATE_WINDOW_5MIN | 89 | +0.258 | +70.84€ | 0 | 4 |
| ✅ LATE_WINDOW_5MIN#5min | 89 | +0.258 | +70.84€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 89 | +0.258 | +70.84€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 89 | +0.258 | +70.84€ | 0 | 4 |
| ✅ LEADLAG_BTC_XRP_15M | 1777 | +0.097 | +475.67€ | 0 | 3 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1777 | +0.097 | +475.67€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1777 | +0.097 | +475.67€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1777 | +0.097 | +475.67€ | 0 | 3 |
...
| ✅ LIQUIDACIONES_5M | 1820 | +0.004 | +12.34€ | 5 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 1820 | +0.004 | +12.34€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB | 96 | +0.000 | -2.95€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB#5min | 96 | +0.000 | -2.95€ | 1 | 0 |
| ✅ LIQUIDACIONES_5M#BTC | 197 | -0.003 | +12.30€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BTC#5min | 197 | -0.003 | +12.30€ | 3 | 2 |
...
| ✅ LIQUIDACIONES_60M | 1024 | -0.045 | -26.46€ | 3 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 1024 | -0.045 | -26.46€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 14176 | -0.012 | -207.71€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14176 | -0.012 | -207.71€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2893 | -0.022 | -60.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2893 | -0.022 | -60.89€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 26700 | -0.009 | +1128.52€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 26700 | -0.009 | +1128.52€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4690 | +0.014 | +570.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4690 | +0.014 | +570.76€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4185 | -0.028 | -54.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4185 | -0.028 | -54.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4726 | +0.013 | +406.08€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4726 | +0.013 | +406.08€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 3966 | -0.053 | -145.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 3966 | -0.053 | -145.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4471 | -0.013 | +164.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4471 | -0.013 | +164.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4662 | +0.005 | +187.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4662 | +0.005 | +187.89€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5580 | -0.055 | -135.62€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5580 | -0.055 | -135.62€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 574 | -0.123 | -23.74€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 574 | -0.123 | -23.74€ | 3 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 68050 | -0.073 | +1539.96€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 68050 | -0.073 | +1539.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 11476 | -0.079 | +661.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 11476 | -0.079 | +661.30€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 10531 | -0.093 | -482.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 10531 | -0.093 | -482.78€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 11645 | -0.069 | +610.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 11645 | -0.069 | +610.25€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10060 | -0.093 | -145.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10060 | -0.093 | -145.06€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 12489 | -0.049 | +348.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 12489 | -0.049 | +348.69€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 11849 | -0.063 | +547.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 11849 | -0.063 | +547.55€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 6948 | -0.024 | -102.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 6948 | -0.024 | -102.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 996 | -0.017 | -19.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 996 | -0.017 | -19.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1624 | -0.025 | -2.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1624 | -0.025 | -2.34€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 1003 | -0.020 | -31.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 1003 | -0.020 | -31.30€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 1563 | -0.019 | -9.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 1563 | -0.019 | -9.38€ | 1 | 0 |
...
| ✅ STREAK_FADE_5M | 2655 | -0.023 | -111.87€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2655 | -0.023 | -111.87€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1131 | -0.023 | -47.19€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1131 | -0.023 | -47.19€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 7413 | +0.022 | +104.13€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7413 | +0.022 | +104.13€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2121 | +0.021 | +20.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2121 | +0.021 | +20.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1628 | +0.035 | +49.42€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1628 | +0.035 | +49.42€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2260 | +0.011 | +0.09€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2260 | +0.011 | +0.09€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1404 | +0.028 | +33.71€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1404 | +0.028 | +33.71€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 6925 | +0.010 | -53.12€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 6925 | +0.010 | -53.12€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2772 | +0.014 | -13.64€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2772 | +0.014 | -13.64€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2712 | +0.011 | -18.02€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2712 | +0.011 | -18.02€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1441 | +0.000 | -21.47€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1441 | +0.000 | -21.47€ | 2 | 0 |
| ✅ UPDOWN_GBM | 33607 | +0.030 | +1986.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 9037 | +0.063 | +1581.31€ | 0 | 10 |
| ✅ UPDOWN_GBM#240min | 1246 | +0.005 | +7.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 21163 | +0.021 | +376.75€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2034 | +0.007 | +21.67€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3253 | +0.067 | +338.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 502 | +0.149 | +197.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 27 | -0.017 | -0.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2724 | +0.053 | +142.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6246 | +0.034 | +405.56€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1141 | +0.081 | +245.32€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 342 | +0.020 | +7.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 3800 | +0.030 | +137.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 914 | +0.003 | +14.78€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 49 | -0.108 | +0.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 3918 | +0.041 | +230.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 468 | +0.147 | +179.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 22 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3428 | +0.026 | +50.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 7145 | +0.019 | +288.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2380 | +0.045 | +266.78€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 330 | +0.006 | +7.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3699 | +0.007 | +11.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 695 | +0.005 | -0.78€ | 1 | 1 |
| ✅ UPDOWN_GBM#ETH#daily | 41 | -0.151 | +3.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8135 | +0.016 | +205.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2273 | +0.024 | +143.20€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 324 | -0.006 | -3.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5078 | +0.015 | +60.56€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 425 | +0.020 | +7.67€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 35 | -0.176 | -2.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 4908 | +0.035 | +519.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2273 | +0.078 | +549.33€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 201 | -0.003 | -2.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2434 | -0.001 | -26.53€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11015 | -0.043 | +2278.49€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11015 | -0.043 | +2278.49€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 643 | -0.046 | +330.03€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 643 | -0.046 | +330.03€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2068 | -0.124 | +28.09€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2068 | -0.124 | +28.09€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 290 | +0.171 | +182.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 290 | +0.171 | +182.14€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1216 | +0.202 | +702.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1216 | +0.202 | +702.78€ | 2 | 21 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3391 | -0.064 | +519.54€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3391 | -0.064 | +519.54€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3407 | -0.079 | +515.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3407 | -0.079 | +515.91€ | 3 | 4 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 511 celda(s) pasan gate riguroso completo de 2153 evaluadas (n>=40) y 3168 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.024 < 0.08 — monitorear
  - _Datos_: n=2271 IC=+0.024 PNL=+143.22€
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=695/40 IC=+0.005 PNL=-0.78€ | BTC#60min: n=914/40 IC=+0.003 PNL=+14.78€ | SOL#60min: n=425/40 IC=+0.020 PNL=+7.67€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.051 n=311711 | tras_1loss IC=+0.076 n=242665 | tras_2loss IC=+0.045 n=102766/40 | gap=+0.006 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1463 IC=+0.014 PNL=+9.52€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1463 IC=+0.014 PNL=+9.52€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=571 IC=-0.010 PNL=+12.15€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=571 IC=-0.010 PNL=+12.15€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.186 > 0.1 con n=1939 PNL=+1207.67€
  - _Datos_: n=1939 IC=+0.186 PNL=+1207.67€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1140 IC=+0.081 PNL=+244.80€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1140 IC=+0.081 PNL=+244.80€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=11602 IC=+0.056 PNL=+1439.60€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=11602 IC=+0.056 PNL=+1439.60€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1744 IC=+0.044 PNL=+180.41€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1744 IC=+0.044 PNL=+180.41€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=16482 IC=-0.137 PNL=+1119.89€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=16482 IC=-0.137 PNL=+1119.89€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1795 IC=+0.138 PNL=+968.52€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1795 IC=+0.138 PNL=+968.52€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.238 < -0.1 con n=1626 PNL=-174.69€
  - _Datos_: n=1626 IC=-0.238 PNL=-174.69€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.087 n=912) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=912 IC=+0.087 PNL=+207.12€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8233 IC=+0.176 PNL=-954.33€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8233 IC=+0.176 PNL=-954.33€
