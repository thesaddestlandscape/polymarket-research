# Hipótesis automáticas — 2026-07-21 16:48 UTC
_Generado por shadow_postmortem.py sobre 27148 resoluciones (PNL=+6234.57€)_
...
- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.126 (n=1141)
...
- **PATRÓN** `sigma_h` > `0.0265` → IC=+0.171 (n=226)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0265 (IC base=+0.158)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.106` → IC=+0.142 (n=426)
...
- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.156 (n=1363)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0045 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.176 (n=644)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.7321` → IC=+0.149 (n=1297)
...
- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.140 (n=281)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0108 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` < `0.775` → IC=+0.137 (n=282)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.775 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.311` → IC=+0.150 (n=238)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 2.311 (IC base=+0.107)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.262 (n=347)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.254)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.296 (n=135)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.52` → IC=+0.253 (n=358)
...
- **PATRÓN** `dist_vwap_pct` > `0.3241` → IC=+0.256 (n=84)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3241 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.122` → IC=+0.195 (n=411)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 10.122 (IC base=+0.189)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 616 | +0.120 | +9.89€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 616 | +0.120 | +9.89€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 228 | +0.122 | -3.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 228 | +0.122 | -3.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 240 | +0.136 | +2.90€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 240 | +0.136 | +2.90€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 145 | +0.078 | +8.46€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 145 | +0.078 | +8.46€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 4680 | +0.185 | +75.00€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3051 | +0.217 | +111.73€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1640 | +0.186 | +20.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1010 | +0.226 | +69.77€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 6568 | +0.099 | +2106.30€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 6568 | +0.099 | +2106.30€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 1729 | +0.157 | +933.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1729 | +0.157 | +933.89€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3764 | +0.134 | +2034.60€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3764 | +0.134 | +2034.60€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 955 | +0.105 | +411.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 955 | +0.105 | +411.27€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 870 | +0.252 | +845.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 870 | +0.252 | +845.21€ | 0 | 11 |
...
| ✅ GBM_LATE_15M_TARDIO | 3735 | +0.087 | +1205.76€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3735 | +0.087 | +1205.76€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 851 | +0.046 | +176.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 851 | +0.046 | +176.40€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1087 | +0.195 | +792.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1087 | +0.195 | +792.25€ | 0 | 13 |
...
| ✅ LATE_WINDOW_5MIN | 222 | -0.013 | +2.13€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 222 | -0.013 | +2.13€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 222 | -0.013 | +2.13€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 222 | -0.013 | +2.13€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1008 | +0.165 | +453.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1008 | +0.165 | +453.20€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 246 | +0.230 | +192.71€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 246 | +0.230 | +192.71€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.192: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.054 n=944 | neutral: IC=+0.001 n=728 | overbought(IBS>0.7): IC=+0.194 n=945
  - _Datos_: n=2801 IC=+0.096 PNL=+667.62€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.115 n=16231 | tras_1loss IC=+0.082 n=10708 | tras_2loss IC=+0.049 n=4439/40 | gap=+0.066 (umbral 0.05)
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=222 IC=-0.013 PNL=+2.13€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=222 IC=-0.013 PNL=+2.13€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=24682 IC=+0.113 PNL=+6310.32€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=24682 IC=+0.113 PNL=+6310.32€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.147 > 0.08 con n=465 PNL=+271.40€
  - _Datos_: n=465 IC=+0.147 PNL=+271.40€
