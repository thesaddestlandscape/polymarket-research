# Hipótesis automáticas — 2026-08-10 06:07 UTC
_Generado por shadow_postmortem.py sobre 103076 resoluciones (PNL=+14683.03€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.229 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.136)

- **PATRÓN** `restante_min` < `4.62` → IC=+0.139 (n=654)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` < 4.62 (IC base=+0.136)

- **PATRÓN** `restante_min` > `4.85` → IC=+0.152 (n=443)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` > 4.85 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.148 (n=881)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 8.0 (IC base=+0.136)

- **PATRÓN** `lag_apertura_s` < `8.63` → IC=+0.151 (n=425)

  - _Acción_: Kelly boost +0.76€ cuando `lag_apertura_s` < 8.63 (IC base=+0.136)

- **PATRÓN** `profundidad_ratio_no` > `16.7` → IC=+0.160 (n=324)

  - _Acción_: Kelly boost +0.80€ cuando `profundidad_ratio_no` > 16.7 (IC base=+0.136)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.240 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.124)

- **PATRÓN** `restante_min` < `4.56` → IC=+0.138 (n=324)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` < 4.56 (IC base=+0.124)

- **PATRÓN** `restante_min` > `4.86` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` > 4.86 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.138 (n=443)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 8.0 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.126 (n=324)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 12.0 (IC base=+0.124)

- **PATRÓN** `lag_apertura_s` < `8.23` → IC=+0.138 (n=161)

  - _Acción_: Kelly boost +0.69€ cuando `lag_apertura_s` < 8.23 (IC base=+0.124)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.44` → IC=+0.168 (n=525)

  - _Acción_: Kelly boost +0.84€ cuando `py_entrada` < 0.44 (IC base=+0.147)

- **PATRÓN** `restante_min` < `4.95` → IC=+0.154 (n=507)

  - _Acción_: Kelly boost +0.77€ cuando `restante_min` < 4.95 (IC base=+0.147)

- **PATRÓN** `restante_min` > `4.19` → IC=+0.153 (n=433)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` > 4.19 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.157 (n=505)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `lag_apertura_s` < `46.75` → IC=+0.154 (n=426)

  - _Acción_: Kelly boost +0.77€ cuando `lag_apertura_s` < 46.75 (IC base=+0.147)

- **PATRÓN** `profundidad_ratio_no` > `24.5` → IC=+0.199 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio_no` > 24.5 (IC base=+0.147)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.463` → IC=+0.174 (n=84)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 6.463 (IC base=+0.019)
...
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.129 (n=33)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 10.0 (IC base=+0.037)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.44` → IC=+0.167 (n=19)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 4.44 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.157 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0049 (IC base=+0.079)
...
- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.174 (n=993)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1850 | +0.049 | -12.59€ | 0 | 4 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1850 | +0.049 | -12.59€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 865 | +0.027 | -17.15€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 865 | +0.027 | -17.15€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 654 | +0.066 | -15.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 654 | +0.066 | -15.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 312 | +0.073 | +19.97€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 312 | +0.073 | +19.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS | 2874 | -0.066 | -637.13€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 463 | +0.216 | -44.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2411 | -0.120 | -592.82€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB | 387 | -0.266 | -101.92€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB#5min | 387 | -0.266 | -101.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 463 | +0.216 | -44.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min |
 | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL#60min | 65 | +0.007 | -1.05€ | 2 | 1 |
...
| ✅ LIQUIDACIONES_5M | 75 | -0.162 | -13.50€ | 5 | 0 |
...
| ✅ LIQUIDACIONES_60M | 127 | +0.035 | +1.74€ | 1 | 1 |
| ✅ LIQUIDACIONES_60M#60min | 127 | +0.035 | +1.74€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M | 697 | +0.029 | +11.10€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 697 | +0.029 | +11.10€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 255 | +0.064 | +15.10€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 255 | +0.064 | +15.10€ | 0 | 1 |
| ✅ STRUCT_NO_15M#ETH | 261 | +0.048 | +7.60€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 261 | +0.048 | +7.60€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 181 | -0.046 | -11.60€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 181 | -0.046 | -11.60€ | 2 | 0 |
| ✅ UPDOWN_GBM | 4028 | +0.059 | +556.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 3760 | +0.073 | +596.13€ | 0 | 5 |
...
| ✅ UPDOWN_GBM#BTC | 723 | +0.054 | +72.53€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 638 | +0.081 | +87.52€ | 1 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 1402 | +0.058 | +156.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1308 | +0.070 | +168.26€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3552 | +0.162 | +1813.83€ | 0 | 21 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3552 | +0.162 | +1813.83€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 447 | +0.048 | +60.07€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 447 | +0.048 | +60.07€ | 1 | 11 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.160: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.115 n=2540 | neutral: IC=+0.042 n=1977 | overbought(IBS>0.7): IC=+0.202 n=2542
  - _Datos_: n=7524 IC=+0.130 PNL=+2535.93€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.152 n=133 PNL=+58.80€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=12h: IC=+0.153 n=174 PNL=+59.38€ → BOOST | H=14h: IC=+0.133 n=178 PNL=+57.11€ → BOOST | H=16h: IC=+0.111 n=165 PNL=+42.79€ → BOOST | H=21h: IC=+0.115 n=159 PNL=+34.61€ → BOOST | H=22h: IC=+0.168 n=188 PNL=+61.92€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.132 n=63210 | tras_1loss IC=+0.086 n=39617 | tras_2loss IC=+0.049 n=16322/40 | gap=+0.083 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3846 IC=+0.062 PNL=+559.54€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3846 IC=+0.062 PNL=+559.54€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=638 IC=+0.081 PNL=+87.52€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=638 IC=+0.081 PNL=+87.52€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=1999 PNL=+355.65€
  - _Datos_: n=1999 IC=+0.091 PNL=+355.65€
...
**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: n=702 IC=+0.072 PNL=+85.48€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=702 IC=+0.072 PNL=+85.48€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1738 IC=-0.084 PNL=+392.20€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1738 IC=-0.084 PNL=+392.20€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1508 IC=+0.070 PNL=+182.84€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1508 IC=+0.070 PNL=+182.84€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1759 IC=+0.193 PNL=+1040.58€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1759 IC=+0.193 PNL=+1040.58€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=922 IC=+0.079 PNL=+168.88€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=922 IC=+0.079 PNL=+168.88€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.120 > 0.08 con n=969 PNL=+318.82€
  - _Datos_: n=969 IC=+0.120 PNL=+318.82€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=1376 PNL=+658.30€
  - _Datos_: n=1376 IC=+0.121 PNL=+658.30€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.269 > 0.08 con n=894 PNL=-36.60€
  - _Datos_: n=894 IC=+0.269 PNL=-36.60€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2316 IC=+0.159 PNL=-321.14€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2316 IC=+0.159 PNL=-321.14€
