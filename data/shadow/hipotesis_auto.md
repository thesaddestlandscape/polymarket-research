# Hipótesis automáticas — 2026-08-19 12:12 UTC
_Generado por shadow_postmortem.py sobre 75124 resoluciones (PNL=+8031.32€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `153.65` → IC=-0.249 (n=996)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 153.65
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=2991)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `119.48` → IC=-0.398 (n=106)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 119.48
  - _Potencial_: sin este filtro IC_bueno=-0.124 (n=320)
...
- **FILTRO** `restante_s_al_confirmar` < `51.75` → IC=-0.478 (n=137)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 51.75
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=279)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `concentracion_yes` < `1.0` → IC=-0.139 (n=70)

  - _Acción_: SKIP cuando `concentracion_yes` < 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.113 (n=906)

- **FILTRO** `n_ballenas` < `4.0` → IC=-0.139 (n=236)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.108 (n=740)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `152.84` → IC=-0.314 (n=197)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 152.84
  - _Potencial_: sin este filtro IC_bueno=-0.203 (n=594)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.183 (n=2595)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.7 (IC base=+0.089)
...
- **PATRÓN** `libro_liquidez` > `2353.1976` → IC=+0.169 (n=1155)
  ...
  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2353.1976 (IC base=+0.089)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.156 (n=4661)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.234 (n=340)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.302 (n=241)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.187 (n=512)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.31` → IC=+0.334 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.31 (IC base=+0.224)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.239 (n=381)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `896.2706` → IC=+0.245 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 896.2706 (IC base=+0.224)
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.177 (n=1032)

  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` < 0.7 (IC base=+0.177)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.195 (n=976)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.75 (IC base=+0.177)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.152 (n=464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 11.0 (IC base=+0.151)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.156 (n=638)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 15.0 (IC base=+0.151)

- **PATRÓN** `py_entrada` < `0.75` → IC=+0.170 (n=719)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` < 0.75 (IC base=+0.151)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.154 (n=712)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.183 (n=238)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` < 0.7 (IC base=+0.153)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.220 (n=627)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.72` → IC=+0.188 (n=526)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.217 (n=3605)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.308 (n=264)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.210 (n=340)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.293 (n=302)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.269 (n=401)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.229 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.175)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.222 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.149)

- **PATRÓN** `restante_min` < `3.8` → IC=+0.162 (n=604)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` < 3.8 (IC base=+0.149)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.211 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.91 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=1857)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.157 (n=1832)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 17.0 (IC base=+0.149)

- **PATRÓN** `lag_apertura_s` < `5.62` → IC=+0.211 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 5.62 (IC base=+0.149)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.239 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.155)

- **PATRÓN** `restante_min` < `4.06` → IC=+0.165 (n=392)

  - _Acción_: Kelly boost +0.82€ cuando `restante_min` < 4.06 (IC base=+0.155)

- **PATRÓN** `restante_min` > `4.88` → IC=+0.199 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.88 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=920)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.164 (n=802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 15.0 (IC base=+0.155)

- **PATRÓN** `lag_apertura_s` < `7.33` → IC=+0.206 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 7.33 (IC base=+0.155)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.173 (n=814)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.43 (IC base=+0.144)

- **PATRÓN** `restante_min` < `3.88` → IC=+0.153 (n=306)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` < 3.88 (IC base=+0.144)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.208 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.94 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=937)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.154 (n=928)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 17.0 (IC base=+0.144)

- **PATRÓN** `lag_apertura_s` < `3.37` → IC=+0.222 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 3.37 (IC base=+0.144)

- **PATRÓN** `profundidad_ratio_no` > `10.7` → IC=+0.144 (n=304)

  - _Acción_: Kelly boost +0.72€ cuando `profundidad_ratio_no` > 10.7 (IC base=+0.144)
...
- **PATRÓN** `ibs_20min` > `0.9834` → IC=+0.274 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9834 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.1499` → IC=+0.279 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1499 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.673` → IC=+0.234 (n=634)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.673 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` < `0.7156` → IC=+0.237 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7156 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.8467` → IC=+0.256 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8467 (IC base=+0.098)

- **PATRÓN** `ibs_20min` < `0.6667` → IC=+0.121 (n=2297)
...
- **PATRÓN** `sigma_h` < `0.0019` → IC=+0.333 (n=52)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0756` → IC=+0.274 (n=51)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0756 (IC base=+0.263)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.308 (n=118)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.263)

- **PATRÓN** `ibs_20min` > `0.9146` → IC=+0.310 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9146 (IC base=+0.263)

- **PATRÓN** `dist_vwap_pct` > `0.1558` → IC=+0.320 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1558 (IC base=+0.263)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.566` → IC=+0.341 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.566 (IC base=+0.263)

- **PATRÓN** `volumen_regimen` < `1.3474` → IC=+0.280 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.3474 (IC base=+0.263)

- **PATRÓN** `volumen_regimen` > `0.7455` → IC=+0.264 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7455 (IC base=+0.263)

- **PATRÓN** `volumen_pendiente_norm` < `0.1838` → IC=+0.302 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1838 (IC base=+0.263)

- **PATRÓN** `volumen_spike_ratio` < `2.7036` → IC=+0.308 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.7036 (IC base=+0.263)

- **PATRÓN** `libro_liquidez` > `12395.6781` → IC=+0.318 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12395.6781 (IC base=+0.263)

- **PATRÓN** `ballena_activa_n` < `303.0` → IC=+0.328 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 303.0 (IC base=+0.263)
...
- **PATRÓN** `dist_vwap_pct` < `0.1756` → IC=+0.228 (n=145)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1756 (IC base=+0.028)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6973 (IC base=+0.028)

- **PATRÓN** `volumen_regimen` > `1.1383` → IC=+0.224 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1383 (IC base=+0.028)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.240 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9429 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` > `0.1207` → IC=+0.178 (n=178)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1207 (IC base=+0.049)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.215` → IC=+0.130 (n=1059)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 2.215 (IC base=+0.049)

- **PATRÓN** `volumen_pendiente_norm` > `0.3445` → IC=+0.199 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3445 (IC base=+0.049)

- **PATRÓN** `volumen_spike_ratio` > `2.2067` → IC=+0.155 (n=468)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.2067 (IC base=+0.049)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.241 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 68.0 (IC base=+0.049)

- **PATRÓN** `ibs_20min` < `0.1014` → IC=+0.167 (n=892)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1014 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` > `0.478` → IC=+0.289 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.478 (IC base=+0.049)
...
- **PATRÓN** `volumen_regimen` > `1.0609` → IC=+0.212 (n=217)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0609 (IC base=+0.049)

- **PATRÓN** `volumen_pendiente_norm` > `0.2103` → IC=+0.316 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2103 (IC base=+0.049)

- **PATRÓN** `volumen_spike_ratio` > `3.7057` → IC=+0.318 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.7057 (IC base=+0.049)
...
- **FILTRO** `sigma_ewma_delta_pct` > `3.236` → IC=-0.193 (n=151)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 3.236
...
- **FILTRO** `ibs_20min` < `0.0377` → IC=-0.177 (n=91)
...
- **FILTRO** `ibs_20min` < `0.6153` → IC=-0.133 (n=167)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6153
...
- **FILTRO** `libro_liquidez` < `8611.2001` → IC=-0.208 (n=63)
...
- **FILTRO** `ibs_20min` < `0.45` → IC=-0.158 (n=153)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.135 (n=154)
...
- **PATRÓN** `ibs_20min` > `0.45` → IC=+0.135 (n=154)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` > 0.45 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` > `0.1776` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1776 (IC base=-0.011)
...
- **PATRÓN** `ibs_20min` > `0.9185` → IC=+0.259 (n=905)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9185 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.1207` → IC=+0.155 (n=404)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1207 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.94` → IC=+0.270 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.94 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.1858` → IC=+0.143 (n=709)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1858 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.6287` → IC=+0.140 (n=709)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6287 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.11` → IC=+0.162 (n=465)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.11 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.148 (n=1369)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.05 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `2734.3004` → IC=+0.177 (n=453)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2734.3004 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.220 (n=1324)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.209)

- **PATRÓN** `drift_60min` |x|≤ `0.2896` → IC=+0.213 (n=1324)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3785` → IC=+0.272 (n=1324)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.507` → IC=+0.209 (n=1140)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.507 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` < `1.2415` → IC=+0.186 (n=1024)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 1.2415 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.8687` → IC=+0.192 (n=683)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.8687 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2675` → IC=+0.261 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2675 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` < `1.6779` → IC=+0.222 (n=318)
...
- **PATRÓN** `ballena_activa_n` < `128.0` → IC=+0.219 (n=283)
...
- **PATRÓN** `sigma_h` < `0.0017` → IC=+0.256 (n=39)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0017 (IC base=+0.211)

- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.256 (n=39)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0033 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.265 (n=117)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.6555` → IC=+0.280 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6555 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.2678` → IC=+0.315 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2678 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.48` → IC=+0.314 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.48 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.3694` → IC=+0.220 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.3694 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.0992` → IC=+0.245 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0992 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4783` → IC=+0.274 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4783 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11869.8733` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11869.8733 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `366.0` → IC=+0.243 (n=33)
...
- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.316 (n=36)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0021 (IC base=+0.243)

- **PATRÓN** `drift_60min` |x|≤ `0.1667` → IC=+0.297 (n=72)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1667 (IC base=+0.243)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.252 (n=111)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.243)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.257 (n=101)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.243)

- **PATRÓN** `ibs_20min` > `0.614` → IC=+0.298 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.614 (IC base=+0.243)

- **PATRÓN** `dist_vwap_pct` < `0.3511` → IC=+0.271 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3511 (IC base=+0.243)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.328` → IC=+0.423 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.328 (IC base=+0.243)

- **PATRÓN** `volumen_regimen` > `0.6466` → IC=+0.271 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6466 (IC base=+0.243)

- **PATRÓN** `volumen_pendiente_norm` > `0.1967` → IC=+0.291 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1967 (IC base=+0.243)

- **PATRÓN** `volumen_spike_ratio` < `1.688` → IC=+0.239 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.688 (IC base=+0.243)

- **PATRÓN** `volumen_spike_ratio` > `2.0789` → IC=+0.265 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0789 (IC base=+0.243)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.252 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.243)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.269 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 166.0 (IC base=+0.243)
...
- **FILTRO** `ibs_20min` > `0.375` → IC=-0.198 (n=114)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.249 (n=229)

- **PATRÓN** `ibs_20min` > `0.8667` → IC=+0.185 (n=157)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.8667 (IC base=+0.043)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.386` → IC=+0.203 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.386 (IC base=+0.043)

- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.227 (n=86)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0045 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.138 (n=269)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 4.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` < `0.375` → IC=+0.249 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.375 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.5478` → IC=+0.130 (n=44)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.5478 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.906` → IC=+0.210 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.906 (IC base=+0.100)

- **PATRÓN** `volumen_regimen` > `0.8684` → IC=+0.144 (n=172)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.8684 (IC base=+0.100)

- **PATRÓN** `volumen_pendiente_norm` > `0.1182` → IC=+0.167 (n=58)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1182 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` > `2.5969` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.5969 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2100.222` → IC=+0.164 (n=117)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2100.222 (IC base=+0.100)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 32.0 (IC base=+0.100)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.252 (n=115)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.219` → IC=+0.146 (n=224)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.219 (IC base=+0.127)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.178 (n=116)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 7.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.233 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.3168` → IC=+0.200 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3168 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.069` → IC=+0.136 (n=171)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.069 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.341` → IC=+0.232 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.341 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `1.1287` → IC=+0.144 (n=254)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1287 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` > `0.1989` → IC=+0.200 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1989 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` < `3.0538` → IC=+0.134 (n=219)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 3.0538 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.132 (n=259)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `2472.2755` → IC=+0.142 (n=227)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 2472.2755 (IC base=+0.127)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 22.0 (IC base=+0.127)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.263 (n=285)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.248)
...
- **PATRÓN** `ibs_20min` < `0.1125` → IC=+0.349 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1125 (IC base=+0.248)

- **PATRÓN** `dist_vwap_pct` > `0.3767` → IC=+0.326 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3767 (IC base=+0.248)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.869` → IC=+0.283 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.869 (IC base=+0.248)

- **PATRÓN** `volumen_regimen` > `0.8787` → IC=+0.292 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8787 (IC base=+0.248)

- **PATRÓN** `volumen_pendiente_norm` > `0.2721` → IC=+0.337 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2721 (IC base=+0.248)

- **PATRÓN** `volumen_spike_ratio` > `3.4473` → IC=+0.300 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4473 (IC base=+0.248)

- **PATRÓN** `libro_liquidez` > `2699.3874` → IC=+0.248 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2699.3874 (IC base=+0.248)

- **PATRÓN** `ballena_activa_n` < `28.0` → IC=+0.188 (n=46)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 28.0 (IC base=+0.248)
...
- **PATRÓN** `ibs_20min` > `0.6` → IC=+0.123 (n=221)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` > 0.6 (IC base=+0.050)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.863` → IC=+0.262 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.863 (IC base=+0.050)

- **PATRÓN** `volumen_pendiente_norm` > `0.184` → IC=+0.154 (n=53)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.184 (IC base=+0.050)
...
- **PATRÓN** `sigma_h` > `0.006` → IC=+0.207 (n=39)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.006 (IC base=+0.075)

- **PATRÓN** `ibs_20min` > `0.7778` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` > 0.7778 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.99` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.99 (IC base=+0.075)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.195 (n=543)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0068 (IC base=+0.121)
...
- **PATRÓN** `ibs_20min` > `0.9626` → IC=+0.283 (n=732)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9626 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.175 (n=300)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.259` → IC=+0.233 (n=1081)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.259 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.1816` → IC=+0.139 (n=383)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` > 0.1816 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.6893` → IC=+0.125 (n=1165)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 1.6893 (IC base=+0.121)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.127 (n=1815)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.06 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `2786.7534` → IC=+0.159 (n=538)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2786.7534 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.229 (n=1309)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0063 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0038` → IC=+0.220 (n=1488)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0038 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.250 (n=753)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` < `0.5111` → IC=+0.279 (n=1486)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5111 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.1176` → IC=+0.194 (n=935)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.1176 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.981` → IC=+0.244 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.981 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.473` → IC=+0.225 (n=1393)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.473 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` < `0.6176` → IC=+0.205 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6176 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `1.0582` → IC=+0.214 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0582 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.1126` → IC=+0.236 (n=717)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1126 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` > `0.2489` → IC=+0.251 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2489 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `2.0219` → IC=+0.253 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0219 (IC base=+0.217)
...
- **FILTRO** `ibs_20min` < `0.3749` → IC=-0.195 (n=57)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.217 (n=171)

- **PATRÓN** `sigma_h` < `0.0019` → IC=+0.172 (n=59)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0019 (IC base=+0.113)

- **PATRÓN** `drift_60min` |x|≤ `0.2804` → IC=+0.126 (n=172)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.2804 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.172 (n=62)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 17.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` > `0.3749` → IC=+0.217 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3749 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.3233` → IC=+0.167 (n=40)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.3233 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.0883` → IC=+0.134 (n=140)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.0883 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.354` → IC=+0.203 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.354 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.7759` → IC=+0.167 (n=76)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.7759 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` > `1.1149` → IC=+0.150 (n=78)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.1149 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.29` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.29 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `1.981` → IC=+0.247 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.981 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `7829.088` → IC=+0.287 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7829.088 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.312 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 147.0 (IC base=+0.113)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.212 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0049 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.176` → IC=+0.155 (n=166)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.176 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.198 (n=117)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 15.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` < `0.2308` → IC=+0.309 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2308 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.1429` → IC=+0.151 (n=173)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1429 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.399` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 7.399 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.824` → IC=+0.141 (n=229)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 2.824 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `0.7028` → IC=+0.194 (n=109)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.7028 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` > `1.0788` → IC=+0.152 (n=113)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.0788 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` < `0.1693` → IC=+0.255 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1693 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` < `1.9831` → IC=+0.275 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9831 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `1.7035` → IC=+0.234 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7035 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `1425.2754` → IC=+0.204 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1425.2754 (IC base=+0.127)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.201 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.0741` → IC=+0.201 (n=105)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0741 (IC base=+0.132)
...
- **PATRÓN** `dist_vwap_pct` > `0.1869` → IC=+0.227 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1869 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.293` → IC=+0.216 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.293 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `0.6734` → IC=+0.141 (n=279)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6734 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.1933` → IC=+0.191 (n=66)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1933 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.7606` → IC=+0.135 (n=236)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.7606 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=318)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `2479.6478` → IC=+0.144 (n=279)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2479.6478 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `43.0` → IC=+0.203 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 43.0 (IC base=+0.132)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.171 (n=253)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.215 (n=177)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.2422` → IC=+0.181 (n=202)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.2422 (IC base=+0.148)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.244 (n=76)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.6103` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6103 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.1139` → IC=+0.164 (n=212)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1139 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.997` → IC=+0.160 (n=189)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 5.997 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `1.3884` → IC=+0.176 (n=202)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 1.3884 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.6649` → IC=+0.155 (n=201)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6649 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` < `0.0989` → IC=+0.169 (n=164)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` < 0.0989 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `1.941` → IC=+0.213 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.941 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=253)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `7478.3992` → IC=+0.195 (n=201)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 7478.3992 (IC base=+0.148)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.183 (n=121)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0032 (IC base=+0.165)

- **PATRÓN** `sigma_h` > `0.002` → IC=+0.172 (n=120)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.002 (IC base=+0.165)

- **PATRÓN** `drift_60min` |x|≤ `0.0847` → IC=+0.264 (n=53)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0847 (IC base=+0.165)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.286 (n=40)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` < `0.2133` → IC=+0.195 (n=80)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.2133 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.189` → IC=+0.190 (n=127)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` < 10.189 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `1.2899` → IC=+0.180 (n=120)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 1.2899 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` > `0.7424` → IC=+0.188 (n=107)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.7424 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.1596` → IC=+0.239 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1596 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` < `2.3936` → IC=+0.192 (n=105)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.3936 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.4793` → IC=+0.180 (n=120)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4793 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `9767.1927` → IC=+0.180 (n=120)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 9767.1927 (IC base=+0.165)
...
- **PATRÓN** `py_entrada` < `0.505` → IC=+0.233 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.505 (IC base=+0.188)
...
- **PATRÓN** `hora_utc` > `3.0` → IC=+0.161 (n=57)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 3.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.155 (n=27)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 4.0 (IC base=+0.141)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.1308` → IC=+0.183 (n=58)

  - _Acción_: Kelly boost +0.92€ cuando `drift_20min_pct` |x|≤ 0.1308 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.1778` → IC=+0.160 (n=51)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1778 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.1` → IC=+0.175 (n=38)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.1 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `2054.213` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2054.213 (IC base=+0.141)

### MOMENTUM_IBS_15M#BTC#15min
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.250 (n=38)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.098)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.0481` → IC=+0.139 (n=34)

  - _Acción_: Kelly boost +0.69€ cuando `drift_20min_pct` |x|≤ 0.0481 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.0526` → IC=+0.167 (n=34)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.0526 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `20074.839` → IC=+0.241 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 20074.839 (IC base=+0.098)
...
- **PATRÓN** `hora_utc` < `2.0` → IC=+0.188 (n=30)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 2.0 (IC base=+0.077)
...
- **FILTRO** `py_entrada` < `0.39` → IC=-0.295 (n=125)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=421)

- **FILTRO** `ibs_20min` < `0.7187` → IC=-0.230 (n=135)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7187
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=411)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.196 (n=136)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=410)

- **FILTRO** `libro_liquidez` < `1772.2376` → IC=-0.133 (n=360)

  - _Acción_: SKIP cuando `libro_liquidez` < 1772.2376
...
- **FILTRO** `ballena_activa_n` > `5.0` → IC=-0.125 (n=30)

  - _Acción_: SKIP cuando `ballena_activa_n` > 5.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=59)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.167 (n=25)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.177 (n=29)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.048)

- **PATRÓN** `py_entrada` < `0.68` → IC=+0.120 (n=77)

  - _Acción_: Kelly boost +0.60€ cuando `py_entrada` < 0.68 (IC base=+0.048)
...
- **PATRÓN** `hora_utc` < `3.0` → IC=+0.157 (n=33)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 3.0 (IC base=+0.024)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.147 (n=49)

  - _Acción_: Kelly boost +0.74€ cuando `py_entrada` < 0.5 (IC base=+0.024)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.283 (n=21)
...
- **FILTRO** `ballena_activa_n` > `4.0` → IC=-0.174 (n=44)
...
- **FILTRO** `py_entrada` > `0.515` → IC=-0.235 (n=32)

  - _Acción_: SKIP cuando `py_entrada` > 0.515
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=67)

- **PATRÓN** `py_entrada` < `0.515` → IC=+0.123 (n=67)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` < 0.515 (IC base=+0.005)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.185 (n=363)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=1119)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.286 (n=363)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1119)

- **FILTRO** `ibs_7min` < `0.711` → IC=-0.242 (n=370)

  - _Acción_: SKIP cuando `ibs_7min` < 0.711
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=1112)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.210 (n=498)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=984)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.164 (n=456)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1377)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.3` → IC=-0.238 (n=59)

  - _Acción_: SKIP cuando `py_entrada` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=182)

- **FILTRO** `ibs_7min` < `0.9167` → IC=-0.188 (n=158)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9167
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=83)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.182 (n=61)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=185)

- **FILTRO** `drift_7min_pct` |x|> `0.0988` → IC=-0.135 (n=83)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.353 (n=73)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=232)

- **FILTRO** `ibs_7min` < `0.7638` → IC=-0.231 (n=76)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7638
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=229)

- **FILTRO** `ballena_activa_n` > `88.0` → IC=-0.199 (n=101)

  - _Acción_: SKIP cuando `ballena_activa_n` > 88.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=204)

- **FILTRO** `libro_liquidez` < `10375.8854` → IC=-0.145 (n=201)

  - _Acción_: SKIP cuando `libro_liquidez` < 10375.8854
...
- **FILTRO** `hora_utc` < `13.0` → IC=-0.186 (n=103)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `ibs_7min` < `0.1429` → IC=-0.259 (n=52)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1429
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=158)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.176 (n=146)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.212 (n=57)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=200)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.194 (n=145)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=112)

- **FILTRO** `ibs_7min` < `0.8105` → IC=-0.167 (n=64)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8105
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=193)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.203 (n=62)
...
- **FILTRO** `py_entrada` < `0.39` → IC=-0.254 (n=67)
...
- **PATRÓN** `delta_ratio` |x|> `0.3994` → IC=+0.165 (n=174)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.82€ cuando `delta_ratio` |x|> 0.3994 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.192 (n=50)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 5.0 (IC base=+0.129)

- **PATRÓN** `total_vol_5m` < `504.262` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 504.262 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=92)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.129)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.125 (n=38)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 4.0 (IC base=-0.009)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=720)
...
- **FILTRO** `ibs_15` < `0.5882` → IC=-0.139 (n=142)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.229 (n=289)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.148 (n=143)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0034 (IC base=+0.107)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0679` → IC=+0.126 (n=324)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.63€ cuando `delta_ratio_macro` |x|> 0.0679 (IC base=+0.107)

- **PATRÓN** `ibs_15` > `0.5882` → IC=+0.229 (n=289)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5882 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.4246` → IC=+0.191 (n=66)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.4246 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.09` → IC=+0.239 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.09 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `5195.5881` → IC=+0.164 (n=108)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 5195.5881 (IC base=+0.107)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1018` → IC=+0.125 (n=470)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.62€ cuando `delta_ratio_macro` |x|> 0.1018 (IC base=+0.075)

- **PATRÓN** `ibs_15` < `0.1215` → IC=+0.145 (n=232)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.73€ cuando `ibs_15` < 0.1215 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` > `0.5423` → IC=+0.172 (n=62)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.5423 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` > `0.0021` → IC=+0.153 (n=70)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0021 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.193` → IC=+0.154 (n=79)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.193 (IC base=+0.141)

- **PATRÓN** `drift_15min` |x|≤ `0.4532` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `drift_15min` |x|≤ 0.4532 (IC base=+0.141)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0763` → IC=+0.150 (n=78)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.75€ cuando `delta_ratio_macro` |x|> 0.0763 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.199 (n=71)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3682` → IC=+0.286 (n=26)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3682 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1019` → IC=+0.223 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1019 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.367` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 7.367 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` < `18.716` → IC=+0.141 (n=76)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 18.716 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `8878.5012` → IC=+0.237 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8878.5012 (IC base=+0.141)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0087` → IC=+0.173 (n=50)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.87€ cuando `pct_spot_vs_ref` |x|≤ 0.0087 (IC base=+0.103)

- **PATRÓN** `sigma_h` < `0.0018` → IC=+0.211 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0018 (IC base=+0.103)

- **PATRÓN** `drift_60min` |x|≤ `0.1646` → IC=+0.139 (n=131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1646 (IC base=+0.103)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.123 (n=136)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 12.0 (IC base=+0.103)

- **PATRÓN** `ibs_15` > `0.0593` → IC=+0.127 (n=148)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.63€ cuando `ibs_15` > 0.0593 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.3242` → IC=+0.136 (n=42)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.3242 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.883` → IC=+0.198 (n=41)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 8.883 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `10442.7271` → IC=+0.164 (n=132)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 10442.7271 (IC base=+0.103)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.159 (n=124)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 22.0 (IC base=+0.103)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1329` → IC=+0.220 (n=48)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1329 (IC base=+0.108)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.140 (n=48)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.108)

- **PATRÓN** `ibs_15` > `0.531` → IC=+0.273 (n=64)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.531 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` < `0.0929` → IC=+0.207 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0929 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.57` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.57 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `8758.263` → IC=+0.154 (n=24)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 8758.263 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.176 (n=35)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0021 (IC base=+0.053)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.3157` → IC=+0.157 (n=33)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.79€ cuando `delta_ratio_macro` |x|> 0.3157 (IC base=+0.052)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.128 (n=49)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 4.0 (IC base=+0.052)

- **PATRÓN** `ibs_15` < `0.0769` → IC=+0.167 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.0769 (IC base=+0.052)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1058` → IC=+0.172 (n=56)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.1058 (IC base=+0.081)

- **PATRÓN** `delta_ratio_macro` |x|> `0.079` → IC=+0.129 (n=165)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.64€ cuando `delta_ratio_macro` |x|> 0.079 (IC base=+0.081)

- **PATRÓN** `ibs_15` < `0.1304` → IC=+0.167 (n=73)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.1304 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` > `0.4097` → IC=+0.250 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4097 (IC base=+0.081)
...
- **FILTRO** `ibs_15` < `0.4` → IC=-0.331 (n=81)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.172 (n=169)

- **FILTRO** `sigma_ewma_delta_pct` > `12.629` → IC=-0.160 (n=254)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 12.629
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1006)

- **PATRÓN** `ibs_15` > `0.4` → IC=+0.172 (n=169)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.86€ cuando `ibs_15` > 0.4 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.531` → IC=+0.280 (n=48)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.531 (IC base=-0.055)

- **PATRÓN** `dist_vwap_pct` < `0.0928` → IC=+0.181 (n=45)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.0928 (IC base=-0.055)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.244 (n=88)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.174 (n=182)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.224 (n=56)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=214)

- **FILTRO** `libro_liquidez` < `13596.8271` → IC=-0.216 (n=202)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.121 (n=56)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.60€ cuando `sigma_h` < 0.0029 (IC base=+0.070)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=57)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.070)
...
- **FILTRO** `sigma_ewma_delta_pct` > `13.675` → IC=-0.181 (n=67)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.509` → IC=+0.192 (n=24)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 9.509 (IC base=-0.021)
...
- **FILTRO** `sigma_ewma_delta_pct` > `7.667` → IC=-0.146 (n=97)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 7.667
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=316)

### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` > `0.0021` → IC=+0.272 (n=121)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0021 (IC base=+0.261)

- **PATRÓN** `drift_60min` |x|≤ `0.1819` → IC=+0.272 (n=121)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1819 (IC base=+0.261)

- **PATRÓN** `drift_15min` |x|≤ `0.5899` → IC=+0.271 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.5899 (IC base=+0.261)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0679` → IC=+0.281 (n=121)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0679 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `3.0` → IC=+0.292 (n=128)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 3.0 (IC base=+0.261)

- **PATRÓN** `ibs_15` > `0.9378` → IC=+0.355 (n=81)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9378 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` > `0.3682` → IC=+0.333 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3682 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` < `0.0758` → IC=+0.331 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0758 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.127` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.127 (IC base=+0.261)

- **PATRÓN** `libro_liquidez` > `8665.5751` → IC=+0.272 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8665.5751 (IC base=+0.261)

### UPDOWN_GBM_IBS_ALTO#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1974` → IC=+0.266 (n=75)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1974 (IC base=+0.243)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.253 (n=75)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.243)

- **PATRÓN** `sigma_h` > `0.0022` → IC=+0.254 (n=67)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0022 (IC base=+0.243)

- **PATRÓN** `drift_60min` |x|≤ `0.1837` → IC=+0.279 (n=75)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1837 (IC base=+0.243)

- **PATRÓN** `drift_15min` |x|≤ `0.6581` → IC=+0.266 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.6581 (IC base=+0.243)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0911` → IC=+0.254 (n=67)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0911 (IC base=+0.243)

- **PATRÓN** `hora_utc` > `3.0` → IC=+0.278 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 3.0 (IC base=+0.243)

- **PATRÓN** `ibs_15` > `0.9375` → IC=+0.327 (n=50)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9375 (IC base=+0.243)

- **PATRÓN** `dist_vwap_pct` > `0.3582` → IC=+0.385 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3582 (IC base=+0.243)

- **PATRÓN** `dist_vwap_pct` < `0.0834` → IC=+0.300 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0834 (IC base=+0.243)

- **PATRÓN** `sigma_ewma_delta_pct` > `27.672` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 27.672 (IC base=+0.243)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.699` → IC=+0.245 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.699 (IC base=+0.243)

- **PATRÓN** `libro_liquidez` > `5837.085` → IC=+0.250 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5837.085 (IC base=+0.243)

### UPDOWN_GBM_IBS_ALTO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0042` → IC=+0.276 (n=47)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0042 (IC base=+0.281)

- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.318 (n=42)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0028 (IC base=+0.281)

- **PATRÓN** `drift_15min` |x|≤ `0.4139` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4139 (IC base=+0.281)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0547` → IC=+0.337 (n=47)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0547 (IC base=+0.281)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.318 (n=31)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.281)

- **PATRÓN** `ibs_15` > `0.9815` → IC=+0.417 (n=22)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9815 (IC base=+0.281)

- **PATRÓN** `dist_vwap_pct` > `0.2663` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2663 (IC base=+0.281)

- **PATRÓN** `dist_vwap_pct` < `0.0728` → IC=+0.362 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0728 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` < `16.651` → IC=+0.295 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 16.651 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `10076.1613` → IC=+0.333 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10076.1613 (IC base=+0.281)
...
- **H-IBS-UPDOWN_GBM#SOL#5min**: dentro de BUY_NO, IBS < 0.0769 sube el IC de +0.052 a +0.167 en UPDOWN_GBM#SOL#5min (n=34). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5882 sube el IC de +0.107 a +0.229 en UPDOWN_GBM#15min (n=289). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.9507 sube el IC de +0.141 a +0.263 en UPDOWN_GBM#BTC#15min (n=36). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.531 sube el IC de +0.108 a +0.273 en UPDOWN_GBM#ETH#15min (n=64). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1304 sube el IC de +0.081 a +0.167 en UPDOWN_GBM#XRP#15min (n=73). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4 sube el IC de -0.039 a +0.172 en UPDOWN_GBM_15M_TARDIO (n=169). Ya aplicado como kelly_boost=+0.86€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.531 sube el IC de -0.055 a +0.280 en UPDOWN_GBM_15M_TARDIO (n=48). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.9378 sube el IC de +0.261 a +0.355 en UPDOWN_GBM_IBS_ALTO (n=81). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.9375 sube el IC de +0.243 a +0.327 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=50). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.9815 sube el IC de +0.281 a +0.417 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=22). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 3644 | -0.116 | -595.60€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 471 | -0.026 | -22.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 3173 | -0.129 | -573.14€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 426 | -0.194 | -94.64€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 426 | -0.194 | -94.64€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 907 | +0.005 | -121.79€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 907 | +0.005 | -121.79€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP | 791 | -0.231 | -171.20€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 791 | -0.231 | -171.20€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 15791 | +0.113 | -995.55€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 3573 | +0.183 | -111.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 103 | -0.090 | -46.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 9466 | +0.084 | -857.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2649 | +0.132 | +20.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 1600 | +0.028 | -361.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 14 | -0.044 | +0.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 1582 | +0.030 | -355.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 3532 | +0.139 | -16.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 978 | +0.199 | -30.30€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 1571 | +0.109 | -25.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 941 | +0.137 | +61.35€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 1598 | +0.057 | -278.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 10 | +0.000 | -3.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 1587 | +0.058 | -272.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 3821 | +0.128 | -39.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1318 | +0.164 | -15.30€ | 0 | 6 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 1572 | +0.107 | -18.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 919 | +0.117 | +3.47€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL | 3645 | +0.134 | -229.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1241 | +0.194 | -64.64€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 43 | +0.033 | -6.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 1572 | +0.085 | -114.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 789 | +0.141 | -44.22€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#XRP | 1595 | +0.117 | -70.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 12 | +0.043 | +1.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 1582 | +0.118 | -71.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 3656 | +0.159 | -363.65€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 3656 | +0.159 | -363.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 920 | +0.151 | -126.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 920 | +0.151 | -126.85€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 909 | +0.153 | -122.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 909 | +0.153 | -122.40€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 807 | +0.219 | -38.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 807 | +0.219 | -38.40€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 861 | +0.173 | -85.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 861 | +0.173 | -85.44€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 6747 | +0.183 | -700.04€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 6747 | +0.183 | -700.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1262 | +0.092 | -294.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1262 | +0.092 | -294.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1029 | +0.238 | -24.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1029 | +0.238 | -24.44€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1190 | +0.151 | -178.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1190 | +0.151 | -178.16€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 1083 | +0.223 | -45.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 1083 | +0.223 | -45.95€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 1046 | +0.238 | -24.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 1046 | +0.238 | -24.29€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 1137 | +0.175 | -132.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 1137 | +0.175 | -132.54€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 2399 | +0.149 | +134.72€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 2399 | +0.149 | +134.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 1185 | +0.155 | +76.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 1185 | +0.155 | +76.79€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 1214 | +0.144 | +57.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 1214 | +0.144 | +57.92€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 44 | +0.130 | -2.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 40 | +0.143 | -2.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 27 | +0.121 | -0.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 23 | +0.140 | -0.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 17 | +0.112 | -1.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 17 | +0.112 | -1.65€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 4834 | +0.084 | +1824.58€ | 0 | 14 |
| ✅ GBM_LATE_15M#15min | 4834 | +0.084 | +1824.58€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 843 | +0.176 | +534.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 843 | +0.176 | +534.73€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 492 | +0.184 | +266.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 492 | +0.184 | +266.31€ | 0 | 27 |
...
| ✅ GBM_LATE_15M#SOL | 897 | -0.001 | +176.79€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 897 | -0.001 | +176.79€ | 3 | 5 |
| ✅ GBM_LATE_15M#XRP | 1111 | +0.007 | +222.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1111 | +0.007 | +222.07€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5859 | +0.049 | +2163.45€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5859 | +0.049 | +2163.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1124 | -0.027 | +512.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1124 | -0.027 | +512.60€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1118 | -0.015 | +92.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1118 | -0.015 | +92.06€ | 1 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 717 | +0.241 | +658.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 717 | +0.241 | +658.57€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1020 | -0.021 | +53.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1020 | -0.021 | +53.25€ | 6 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1027 | +0.002 | +162.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1027 | +0.002 | +162.46€ | 2 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 853 | +0.211 | +684.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 853 | +0.211 | +684.52€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 3574 | +0.174 | +2414.70€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 3574 | +0.174 | +2414.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 634 | +0.193 | +466.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 634 | +0.193 | +466.11€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 482 | +0.196 | +323.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 482 | +0.196 | +323.90€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 630 | +0.201 | +486.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 630 | +0.201 | +486.64€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 457 | +0.204 | +338.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 457 | +0.204 | +338.82€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 654 | +0.073 | +259.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 654 | +0.073 | +259.28€ | 1 | 12 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 717 | +0.191 | +539.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 717 | +0.191 | +539.95€ | 0 | 24 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 623 | +0.057 | +75.20€ | 0 | 9 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 623 | +0.057 | +75.20€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 143 | +0.059 | +12.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 143 | +0.059 | +12.46€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO | 4132 | +0.167 | +2675.03€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 4132 | +0.167 | +2675.03€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#ETH | 403 | +0.137 | +189.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 403 | +0.137 | +189.89€ | 1 | 24 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 653 | +0.076 | +293.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 653 | +0.076 | +293.59€ | 0 | 15 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 922 | +0.192 | +672.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 922 | +0.192 | +672.17€ | 0 | 24 |
| ✅ GBM_LATE_5M | 345 | +0.105 | +131.16€ | 3 | 12 |
| ✅ GBM_LATE_5M#5min | 345 | +0.105 | +131.16€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 174 | +0.131 | +79.53€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 174 | +0.131 | +79.53€ | 0 | 12 |
...
| ✅ LEADLAG_BTC_XRP_15M | 76 | +0.154 | +26.96€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 76 | +0.154 | +26.96€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 76 | +0.154 | +26.96€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 76 | +0.154 | +26.96€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_5M | 106 | -0.120 | -14.66€ | 3 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 106 | -0.120 | -14.66€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BTC | 41 | -0.105 | -5.24€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BTC#5min | 41 | -0.105 | -5.24€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_15M | 910 | +0.030 | +30.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 910 | +0.030 | +30.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 127 | +0.089 | +30.33€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 127 | +0.089 | +30.33€ | 1 | 7 |
| ✅ MOMENTUM_IBS_15M#BTC | 164 | +0.084 | +24.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 164 | +0.084 | +24.01€ | 0 | 4 |
| ✅ MOMENTUM_IBS_15M#DOGE | 140 | +0.000 | -13.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 140 | +0.000 | -13.57€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 169 | +0.038 | +19.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 169 | +0.038 | +19.93€ | 0 | 1 |
| ✅ MOMENTUM_IBS_15M#SOL | 153 | -0.029 | -19.41€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 153 | -0.029 | -19.41€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 157 | -0.003 | -10.61€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 157 | -0.003 | -10.61€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 1188 | -0.040 | +33.10€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 1188 | -0.040 | +33.10€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 185 | -0.035 | +29.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 185 | -0.035 | +29.19€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 208 | -0.062 | -23.98€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 208 | -0.062 | -23.98€ | 8 | 1 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 191 | -0.013 | +32.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 191 | -0.013 | +32.44€ | 3 | 2 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 211 | -0.030 | -2.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 211 | -0.030 | -2.57€ | 5 | 2 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 193 | -0.054 | +8.40€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 193 | -0.054 | +8.40€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 200 | -0.040 | -10.37€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 200 | -0.040 | -10.37€ | 5 | 1 |
| ✅ MOMENTUM_IBS_15M_FADE | 409 | -0.052 | -22.75€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 409 | -0.052 | -22.75€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 79 | -0.080 | -7.35€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 79 | -0.080 | -7.35€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 3315 | -0.061 | +119.83€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 3315 | -0.061 | +119.83€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 487 | -0.089 | +48.93€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 487 | -0.089 | +48.93€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 639 | -0.046 | +71.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 639 | -0.046 | +71.57€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 505 | -0.074 | -5.68€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 505 | -0.074 | -5.68€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 575 | -0.065 | -27.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 575 | -0.065 | -27.53€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 598 | -0.042 | -10.72€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 598 | -0.042 | -10.72€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 511 | -0.056 | +43.27€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 511 | -0.056 | +43.27€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 2897 | +0.016 | +22.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 2897 | +0.016 | +22.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 500 | +0.026 | +13.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 500 | +0.026 | +13.47€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 382 | +0.034 | +9.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 382 | +0.034 | +9.22€ | 1 | 1 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 513 | +0.009 | -1.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 513 | +0.009 | -1.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 490 | +0.006 | +0.73€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 490 | +0.006 | +0.73€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 514 | +0.010 | +0.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 514 | +0.010 | +0.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 498 | +0.014 | -0.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 498 | +0.014 | -0.25€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 268 | +0.085 | +52.27€ | 1 | 4 |
| ✅ ORDER_FLOW_5M#5min | 132 | +0.112 | +39.67€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 30 | +0.062 | +2.01€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 30 | +0.062 | +2.01€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 417 | -0.015 | -17.88€ | 2 | 1 |
| ✅ STREAK_FADE_5M#5min | 417 | -0.015 | -17.88€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE | 121 | +0.029 | +2.88€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE#5min | 121 | +0.029 | +2.88€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 94 | -0.042 | -6.46€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 94 | -0.042 | -6.46€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 704 | +0.020 | +1.49€ | 1 | 0 |
| ✅ STREAK_MOM_5M#5min | 704 | +0.020 | +1.49€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 225 | +0.011 | -2.22€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 225 | +0.011 | -2.22€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 130 | -0.015 | -4.39€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 130 | -0.015 | -4.39€ | 3 | 2 |
| ✅ STREAK_MOM_5M#SOL | 191 | +0.029 | +1.69€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 191 | +0.029 | +1.69€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP | 158 | +0.050 | +6.41€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 158 | +0.050 | +6.41€ | 2 | 3 |
| ✅ STRUCT_NO_15M | 1948 | +0.017 | -0.68€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 1948 | +0.017 | -0.68€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 739 | +0.009 | -7.27€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 739 | +0.009 | -7.27€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 761 | +0.023 | +3.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 761 | +0.023 | +3.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 448 | +0.022 | +2.79€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 448 | +0.022 | +2.79€ | 2 | 0 |
| ✅ UPDOWN_GBM | 2650 | +0.030 | +213.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1133 | +0.088 | +211.49€ | 1 | 9 |
| ✅ UPDOWN_GBM#240min | 128 | +0.008 | -2.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 1084 | -0.005 | +12.66€ | 3 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 508 | +0.041 | +55.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 135 | +0.069 | +5.58€ | 1 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 39 | +0.061 | +2.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 229 | +0.071 | +53.08€ | 2 | 9 |
...
| ✅ UPDOWN_GBM#ETH | 620 | +0.053 | +59.75€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 260 | +0.118 | +60.58€ | 1 | 15 |
| ✅ UPDOWN_GBM#ETH#240min | 40 | +0.048 | +0.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 200 | +0.010 | -1.51€ | 4 | 1 |
| ✅ UPDOWN_GBM#ETH#60min | 105 | +0.014 | +0.14€ | 0 | 2 |
| 🚫 UPDOWN_GBM#ETH#daily | 15 | -0.154 | -0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 503 | +0.001 | +5.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 218 | +0.023 | +6.54€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 31 | -0.045 | -3.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 176 | +0.011 | +2.70€ | 2 | 4 |
| ✅ UPDOWN_GBM#SOL#60min | 66 | -0.029 | -0.87€ | 0 | 0 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 595 | +0.018 | +58.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 348 | +0.083 | +84.83€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 17 | -0.112 | -2.90€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 230 | -0.069 | -23.26€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1842 | -0.050 | +483.60€ | 2 | 3 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1842 | -0.050 | +483.60€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 132 | -0.060 | +106.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 132 | -0.060 | +106.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 354 | -0.135 | -12.48€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 354 | -0.135 | -12.48€ | 3 | 2 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 597 | -0.019 | +241.89€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 597 | -0.019 | +241.89€ | 1 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 573 | -0.046 | +119.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 573 | -0.046 | +119.31€ | 3 | 0 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 161 | +0.261 | +89.10€ | 0 | 10 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 161 | +0.261 | +89.10€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 99 | +0.243 | +44.21€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 99 | +0.243 | +44.21€ | 0 | 13 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 62 | +0.281 | +44.89€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 62 | +0.281 | +44.89€ | 0 | 10 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.132) — sin ventaja clara. oversold(IBS<0.3): IC=-0.009 n=926 | neutral: IC=+0.020 n=881 | overbought(IBS>0.7): IC=+0.124 n=1159
  - _Datos_: n=3187 IC=+0.050 PNL=+336.72€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=218 IC=+0.023 PNL=+6.54€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.098 n=43517 | tras_1loss IC=+0.058 n=31314 | tras_2loss IC=+0.018 n=13791/40 | gap=+0.080 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=27, boost estimado=+0.002. Necesita 0 más y boost>0.05

**⏳ H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  - _Umbral_: n≥200 por par con delta_ratio feature en shadow
  - _Acción_: Añadir DELTA_MIN/MAX por par dict en shadow_predict.py
  - _Estado_: BTC: 0/50 ops con delta_ratio feature | SOL: 30/50 ops con delta_ratio feature
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=+0.047 n=212 | contrario_BTC IC=+0.021 n=138/40 | gap=-0.025 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2416 IC=+0.024 PNL=+158.80€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2416 IC=+0.024 PNL=+158.80€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.107 > 0.1 con n=431 PNL=+72.26€
  - _Datos_: n=431 IC=+0.107 PNL=+72.26€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=135 IC=+0.069 PNL=+5.58€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=135 IC=+0.069 PNL=+5.58€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.090 > 0.08 con n=705 PNL=+120.60€
  - _Datos_: n=705 IC=+0.090 PNL=+120.60€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=593 IC=+0.087 PNL=+132.86€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=593 IC=+0.087 PNL=+132.86€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=380 IC=+0.034 PNL=+21.09€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=380 IC=+0.034 PNL=+21.09€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1010 IC=+0.026 PNL=+39.55€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1010 IC=+0.026 PNL=+39.55€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=585 PNL=+196.51€
  - _Datos_: n=585 IC=+0.159 PNL=+196.51€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=220 IC=+0.081 PNL=+50.81€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=220 IC=+0.081 PNL=+50.81€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1585 IC=-0.149 PNL=+56.47€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1585 IC=-0.149 PNL=+56.47€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.107 > 0.08 con n=431 PNL=+72.26€
  - _Datos_: n=431 IC=+0.107 PNL=+72.26€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.141 > 0.08 con n=104 PNL=+13.03€
  - _Datos_: n=104 IC=+0.141 PNL=+13.03€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.202 > 0.08 con n=300 PNL=+172.56€
  - _Datos_: n=300 IC=+0.202 PNL=+172.56€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=590 IC=+0.015 PNL=+144.28€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=590 IC=+0.015 PNL=+144.28€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.241 > 0.08 con n=697 PNL=-78.34€
  - _Datos_: n=697 IC=+0.241 PNL=-78.34€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.188 n=46) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=46 IC=+0.188 PNL=+24.30€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1262 IC=+0.092 PNL=-294.66€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1262 IC=+0.092 PNL=-294.66€
