# Hipótesis automáticas — 2026-07-29 12:20 UTC
_Generado por shadow_postmortem.py sobre 41736 resoluciones (PNL=+8980.76€)_
...
- **PATRÓN** `dist_vwap_pct` > `0.1896` → IC=+0.160 (n=189)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1896 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.373` → IC=+0.281 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.373 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `3211.0609` → IC=+0.207 (n=186)
...
- **PATRÓN** `ibs_15` < `0.04` → IC=+0.154 (n=79)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.77€ cuando `ibs_15` < 0.04 (IC base=+0.072)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.04 sube el IC de +0.072 a +0.154 en UPDOWN_GBM#XRP#15min (n=79). Ya aplicado como kelly_boost=+0.77€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ GBM_LATE_15M | 9015 | +0.095 | +2725.11€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 9015 | +0.095 | +2725.11€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#DOGE | 130 | +0.099 | +29.57€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 130 | +0.099 | +29.57€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 2388 | +0.141 | +1166.11€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2388 | +0.141 | +1166.11€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 6216 | +0.120 | +3016.28€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 6216 | +0.120 | +3016.28€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1509 | +0.090 | +612.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1509 | +0.090 | +612.82€ | 0 | 6 |
...
| ✅ UPDOWN_GBM | 3068 | +0.036 | +281.82€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2804 | +0.052 | +320.84€ | 0 | 5 |
...
| ✅ UPDOWN_GBM#XRP | 364 | +0.046 | +45.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 353 | +0.055 | +48.62€ | 4 | 1 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.160: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.077 n=1812 | neutral: IC=+0.024 n=1423 | overbought(IBS>0.7): IC=+0.184 n=1713
  - _Datos_: n=5282 IC=+0.103 PNL=+1386.78€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=24841 | tras_1loss IC=+0.078 n=16657 | tras_2loss IC=+0.052 n=6995/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2931 IC=+0.040 PNL=+295.62€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2931 IC=+0.040 PNL=+295.62€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1573 IC=+0.041 PNL=+128.52€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1573 IC=+0.041 PNL=+128.52€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=452 IC=+0.059 PNL=+58.08€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=452 IC=+0.059 PNL=+58.08€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=5422 IC=+0.085 PNL=+1315.44€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5422 IC=+0.085 PNL=+1315.44€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=454 IC=+0.024 PNL=+19.46€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=454 IC=+0.024 PNL=+19.46€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=316 IC=+0.072 PNL=+51.94€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=316 IC=+0.072 PNL=+51.94€
