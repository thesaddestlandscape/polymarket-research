# Hipótesis automáticas — 2026-08-26 12:42 UTC
_Generado por shadow_postmortem.py sobre 161849 resoluciones (PNL=+11639.14€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.79` → IC=-0.278 (n=2243)
...
- **FILTRO** `restante_s_al_confirmar` < `157.71` → IC=-0.202 (n=611)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1835)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `150.08` → IC=-0.273 (n=532)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 150.08
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1599)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.92` → IC=-0.344 (n=510)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.92
  - _Potencial_: sin este filtro IC_bueno=-0.116 (n=1038)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.187 (n=5157)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1537)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2376.0723` → IC=+0.174 (n=1485)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.212 (n=751)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `12477.3281` → IC=+0.214 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12477.3281 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.195 (n=545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=782)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.135 (n=1161)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.130 (n=995)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.290 (n=402)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.281)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.284 (n=452)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.280 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `2826.4245` → IC=+0.292 (n=286)
...
- **PATRÓN** `py_entrada` < `0.245` → IC=+0.335 (n=264)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.219)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.219)

- **PATRÓN** `libro_liquidez` > `975.3905` → IC=+0.237 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 975.3905 (IC base=+0.219)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1103)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.168 (n=943)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.197 (n=10249)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.222 (n=8087)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.191)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.129 (n=2206)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.212 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.162)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.238 (n=1631)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.287 (n=640)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.246 (n=1106)
...
- **PATRÓN** `lag_apertura_s` < `4.5` → IC=+0.160 (n=1384)
...
- **PATRÓN** `restante_min` < `3.9` → IC=+0.142 (n=686)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` < 3.9 (IC base=+0.140)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.172 (n=686)
...
- **PATRÓN** `lag_apertura_s` < `5.7` → IC=+0.172 (n=686)

  - _Acción_: Kelly boost +0.86€ cuando `lag_apertura_s` < 5.7 (IC base=+0.140)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.193 (n=786)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.159 (n=751)

  - _Acción_: Kelly boost +0.79€ cuando `restante_min` > 4.94 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=2174)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.47` → IC=+0.162 (n=697)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.298 (n=275)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1516.0855` → IC=+0.324 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1516.0855 (IC base=+0.282)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9508` → IC=+0.214 (n=704)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.215` → IC=+0.174 (n=863)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5715` → IC=+0.144 (n=495)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5715 (IC base=+0.066)

- **PATRÓN** `ibs_20min` < `0.2136` → IC=+0.128 (n=1454)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6146` → IC=+0.203 (n=321)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.194 (n=158)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0075 (IC base=+0.118)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.714` → IC=+0.335 (n=168)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.714 (IC base=+0.118)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1478` → IC=+0.343 (n=164)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1478 (IC base=+0.277)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.283 (n=228)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.277)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.281 (n=226)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.277)

- **PATRÓN** `ibs_20min` < `0.4667` → IC=+0.321 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4667 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.972` → IC=+0.320 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.972 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` < `0.0601` → IC=+0.316 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0601 (IC base=+0.277)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7714` → IC=+0.294 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7714 (IC base=+0.277)
...
- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.310 (n=77)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.923` → IC=+0.259 (n=114)
...
- **PATRÓN** `libro_liquidez` > `1917.9762` → IC=+0.141 (n=190)
...
- **PATRÓN** `volumen_regimen` > `0.6189` → IC=+0.122 (n=96)
  ...
  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6189 (IC base=-0.057)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3816` → IC=+0.300 (n=18)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3816 (IC base=-0.057)

- **PATRÓN** `ballena_activa_n` < `114.0` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 114.0 (IC base=-0.057)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.916` → IC=-0.153 (n=266)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=985)
...
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.150 (n=894)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0086 (IC base=+0.053)

- **PATRÓN** `ibs_20min` > `0.9465` → IC=+0.246 (n=893)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9465 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `1.2464` → IC=+0.287 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2464 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` > `1.0132` → IC=+0.194 (n=419)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.0132 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` < `0.1151` → IC=+0.168 (n=1181)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4823` → IC=+0.189 (n=406)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.4823 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `2.8541` → IC=+0.171 (n=405)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.8541 (IC base=+0.053)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.268 (n=663)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.053)

- **PATRÓN** `ibs_20min` < `0.0968` → IC=+0.177 (n=1154)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.0968 (IC base=+0.039)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0923` → IC=+0.205 (n=181)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0923 (IC base=+0.177)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1458` → IC=+0.185 (n=306)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1458 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.4252` → IC=+0.194 (n=47)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.4252 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` < `2.035` → IC=+0.180 (n=145)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.035 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `3.7364` → IC=+0.182 (n=149)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 3.7364 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.222 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.177)

- **PATRÓN** `libro_liquidez` > `1915.5084` → IC=+0.213 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1915.5084 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.192 (n=92)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 42.0 (IC base=+0.177)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=64)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=884)
...
- **FILTRO** `ibs_20min` < `0.5333` → IC=-0.148 (n=302)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5333
  - _Potencial_: sin este filtro IC_bueno=+0.132 (n=302)
...
- **PATRÓN** `volumen_regimen` < `0.8598` → IC=+0.181 (n=114)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.8598 (IC base=-0.008)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0538` → IC=+0.162 (n=72)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.0538 (IC base=-0.008)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.201 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 77.0 (IC base=-0.008)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0235` → IC=+0.319 (n=180)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0235 (IC base=+0.216)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.277 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.169 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `0.8361` → IC=+0.254 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8361 (IC base=+0.216)
...
- **PATRÓN** `libro_liquidez` > `2661.3588` → IC=+0.234 (n=359)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2661.3588 (IC base=+0.216)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.202 (n=773)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.4354` → IC=+0.157 (n=2308)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.4354 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=2408)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.893` → IC=+0.259 (n=1539)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.33` → IC=+0.254 (n=985)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.33 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` < `1.2156` → IC=+0.160 (n=1603)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2156 (IC base=+0.157)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2796` → IC=+0.156 (n=1814)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.2796 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.8535` → IC=+0.148 (n=1374)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.8535 (IC base=+0.157)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=1894)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `3831.2799` → IC=+0.194 (n=770)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 3831.2799 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.180 (n=1070)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 124.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.198 (n=2066)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0084 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.3944` → IC=+0.201 (n=2066)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3944 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.217 (n=941)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` < `0.4063` → IC=+0.237 (n=2066)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4063 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` < `0.3513` → IC=+0.176 (n=1814)
...
- **PATRÓN** `volumen_regimen` < `1.176` → IC=+0.164 (n=1684)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.176 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` > `0.8596` → IC=+0.173 (n=1122)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8596 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.249 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `1.8709` → IC=+0.177 (n=972)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.8709 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` > `2.6198` → IC=+0.209 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6198 (IC base=+0.184)

- **PATRÓN** `ballena_activa_n` < `203.0` → IC=+0.179 (n=1025)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 203.0 (IC base=+0.184)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.288 (n=177)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.273)

- **PATRÓN** `drift_60min` |x|≤ `0.3243` → IC=+0.317 (n=178)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3243 (IC base=+0.273)

- **PATRÓN** `hora_utc` < `9.0` → IC=+0.318 (n=119)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 9.0 (IC base=+0.273)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.310 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.273)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.667` → IC=+0.294 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.667 (IC base=+0.273)

- **PATRÓN** `volumen_pendiente_norm` < `0.0812` → IC=+0.292 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0812 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` < `1.7889` → IC=+0.323 (n=77)
...
- **PATRÓN** `ballena_activa_n` < `46.0` → IC=+0.312 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 46.0 (IC base=+0.273)
...
- **PATRÓN** `drift_60min` |x|≤ `0.29` → IC=+0.178 (n=421)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.29 (IC base=+0.154)
...
- **PATRÓN** `dist_vwap_pct` < `0.1569` → IC=+0.182 (n=410)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1569 (IC base=+0.154)
...
- **PATRÓN** `volumen_spike_ratio` < `1.732` → IC=+0.178 (n=209)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.732 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `14092.9821` → IC=+0.178 (n=141)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 14092.9821 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `239.0` → IC=+0.183 (n=77)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 239.0 (IC base=+0.154)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.144` → IC=+0.159 (n=224)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.144 (IC base=+0.147)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2295` → IC=+0.140 (n=273)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.2295 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.0094` → IC=+0.207 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0094 (IC base=+0.147)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.336 (n=138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` > `2.0228` → IC=+0.292 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0228 (IC base=+0.283)

- **PATRÓN** `ballena_activa_n` < `52.0` → IC=+0.233 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 52.0 (IC base=+0.283)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4992` → IC=+0.206 (n=325)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4992 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.208 (n=327)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.203 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6356 (IC base=+0.187)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4212` → IC=+0.229 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4212 (IC base=+0.187)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.190 (n=366)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `8630.7084` → IC=+0.206 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8630.7084 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.188 (n=174)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 156.0 (IC base=+0.187)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.176 (n=403)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0072 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.372` → IC=+0.167 (n=403)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3496` → IC=+0.209 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3496 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.5306` → IC=+0.157 (n=473)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.5306 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.302` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.302 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `0.8556` → IC=+0.149 (n=269)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.8556 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6177` → IC=+0.152 (n=403)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6177 (IC base=+0.142)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8878` → IC=+0.185 (n=198)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.8878 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `9896.1185` → IC=+0.142 (n=135)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 9896.1185 (IC base=+0.142)
...
- **PATRÓN** `drift_60min` |x|≤ `0.399` → IC=+0.236 (n=419)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.399 (IC base=+0.218)
...
- **PATRÓN** `ibs_20min` < `0.3738` → IC=+0.255 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3738 (IC base=+0.218)

- **PATRÓN** `dist_vwap_pct` < `0.7822` → IC=+0.227 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7822 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.162` → IC=+0.268 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.162 (IC base=+0.218)
...
- **PATRÓN** `ibs_20min` > `0.6252` → IC=+0.151 (n=348)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.086` → IC=+0.218 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.086 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.1717` → IC=+0.190 (n=98)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1717 (IC base=+0.085)

- **PATRÓN** `libro_liquidez` > `2945.8225` → IC=+0.124 (n=259)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2945.8225 (IC base=+0.085)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.214 (n=1217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.157 (n=2405)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.9445` → IC=+0.289 (n=1215)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9445 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `1.0671` → IC=+0.252 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0671 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.357` → IC=+0.249 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.357 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6312` → IC=+0.155 (n=632)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6312 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `1.0803` → IC=+0.157 (n=860)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.0803 (IC base=+0.147)
...
- **PATRÓN** `volumen_spike_ratio` < `2.324` → IC=+0.145 (n=2080)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.324 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.8815` → IC=+0.158 (n=1576)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8815 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2193)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `3801.753` → IC=+0.199 (n=894)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 3801.753 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.194 (n=1146)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 162.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.227 (n=1609)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.4454` → IC=+0.201 (n=2413)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4454 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=881)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.551` → IC=+0.248 (n=2413)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.551 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` < `0.7107` → IC=+0.180 (n=1978)
...
- **PATRÓN** `volumen_spike_ratio` > `2.257` → IC=+0.211 (n=779)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.257 (IC base=+0.192)

- **PATRÓN** `ballena_activa_n` < `182.0` → IC=+0.165 (n=1285)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1556` → IC=+0.326 (n=170)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1556 (IC base=+0.279)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.282 (n=237)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.340 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5833 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.979` → IC=+0.308 (n=280)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6987` → IC=+0.333 (n=52)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6987 (IC base=+0.279)
...
- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.281 (n=80)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 68.0 (IC base=+0.279)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.182 (n=422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 6.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` > `0.3307` → IC=+0.210 (n=422)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.209 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` < `0.6538` → IC=+0.178 (n=141)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6538 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `1.0896` → IC=+0.196 (n=192)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 1.0896 (IC base=+0.160)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.192 (n=329)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.7089` → IC=+0.193 (n=249)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.7089 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `11701.6956` → IC=+0.196 (n=281)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 11701.6956 (IC base=+0.160)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0757` → IC=+0.183 (n=118)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0757 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.241 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.176)

- **PATRÓN** `ibs_20min` > `0.717` → IC=+0.254 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.717 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.113` → IC=+0.338 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.113 (IC base=+0.176)

- **PATRÓN** `volumen_pendiente_norm` < `0.2322` → IC=+0.179 (n=285)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` < 0.2322 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` < `2.1217` → IC=+0.182 (n=124)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.1217 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `3.8461` → IC=+0.174 (n=127)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 3.8461 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.193 (n=242)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.03 (IC base=+0.176)

- **PATRÓN** `libro_liquidez` > `1917.9762` → IC=+0.198 (n=160)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 1917.9762 (IC base=+0.176)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.227 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 61.0 (IC base=+0.176)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.544` → IC=+0.198 (n=203)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 4.544 (IC base=+0.143)
...
- **PATRÓN** `ibs_20min` < `0.0817` → IC=+0.244 (n=154)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0817 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1609` → IC=+0.156 (n=181)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1609 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.6853` → IC=+0.173 (n=374)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.6853 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.454` → IC=+0.246 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.454 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.5888` → IC=+0.181 (n=117)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.5888 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `1.1115` → IC=+0.181 (n=117)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 1.1115 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2303` → IC=+0.357 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2303 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.1819` → IC=+0.186 (n=259)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.1819 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.4569` → IC=+0.176 (n=294)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.4569 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `9323.6962` → IC=+0.196 (n=159)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 9323.6962 (IC base=+0.150)
...
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.171 (n=217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0107 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.133 (n=322)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `drift_60min` |x|≤ `0.4561` → IC=+0.224 (n=552)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4561 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.221 (n=579)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` < `0.4887` → IC=+0.276 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4887 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `1.1476` → IC=+0.220 (n=730)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.021` → IC=+0.215 (n=630)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.150 (n=887)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.202 (n=226)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.3507` → IC=+0.166 (n=597)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3507 (IC base=+0.144)
...
- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.152 (n=596)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.6296 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.6223` → IC=+0.171 (n=156)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6223 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.8049` → IC=+0.142 (n=768)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.8049 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.141` → IC=+0.162 (n=303)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.141 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.061` → IC=+0.144 (n=681)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.061 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `1.2231` → IC=+0.159 (n=667)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2231 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.162 (n=326)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `2.489` → IC=+0.164 (n=670)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.489 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.5137` → IC=+0.150 (n=598)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.5137 (IC base=+0.144)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=887)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8306.7713` → IC=+0.149 (n=677)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8306.7713 (IC base=+0.144)
...
- **PATRÓN** `drift_60min` |x|≤ `0.338` → IC=+0.148 (n=373)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.338 (IC base=+0.137)
...
- **PATRÓN** `ibs_20min` < `0.144` → IC=+0.169 (n=164)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.144 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.6094` → IC=+0.177 (n=60)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.6094 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.369` → IC=+0.147 (n=378)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.369 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.1826` → IC=+0.145 (n=373)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.1826 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `0.6217` → IC=+0.139 (n=372)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6217 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.180 (n=176)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.5688` → IC=+0.154 (n=371)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.5688 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `11854.8179` → IC=+0.139 (n=333)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 11854.8179 (IC base=+0.137)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.142 (n=121)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 18.0 (IC base=+0.121)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `py_entrada` < 0.495 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `2495.3515` → IC=+0.155 (n=114)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 2495.3515 (IC base=+0.121)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.168 (n=750)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.032 (n=2292)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.217 (n=718)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2304)

- **FILTRO** `ibs_20min` > `0.2733` → IC=-0.180 (n=754)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2733
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=2268)
...
- **FILTRO** `ballena_activa_n` > `78.0` → IC=-0.167 (n=127)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=383)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.183 (n=197)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=262)
...
- **FILTRO** `drift_20min_pct` |x|> `0.2855` → IC=-0.146 (n=162)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=492)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=2175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=5284)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.286 (n=1803)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=5656)

- **FILTRO** `ibs_7min` < `0.7353` → IC=-0.234 (n=1864)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7353
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=5595)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.174 (n=2475)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=4984)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.231 (n=2117)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=7055)

- **FILTRO** `ibs_7min` > `0.7213` → IC=-0.171 (n=2292)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7213
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=6880)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.096 (n=778)
...
- **FILTRO** `ibs_7min` < `0.9818` → IC=-0.203 (n=668)
...
- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.267 (n=251)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=764)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.236 (n=373)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1184)

- **FILTRO** `drift_7min_pct` |x|> `0.1395` → IC=-0.161 (n=529)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1395
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=1028)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.198 (n=389)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1168)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.156 (n=318)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1175)
...
- **FILTRO** `ibs_7min` < `0.8058` → IC=-0.161 (n=373)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8058
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1120)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.166 (n=372)
...
- **FILTRO** `ballena_activa_n` > `124.0` → IC=-0.169 (n=379)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.193 (n=262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.101 (n=787)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.338 (n=245)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=804)

- **FILTRO** `ibs_7min` < `0.2127` → IC=-0.280 (n=262)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2127
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=787)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.284 (n=257)
...
- **FILTRO** `ibs_7min` > `0.8179` → IC=-0.185 (n=401)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.150 (n=389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=887)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.267 (n=299)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=977)

- **FILTRO** `ibs_7min` < `0.765` → IC=-0.185 (n=319)
...
- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.211 (n=316)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=960)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.126 (n=410)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=852)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.288 (n=304)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=958)

- **FILTRO** `ibs_7min` > `0.1818` → IC=-0.157 (n=427)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1818
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=835)

- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.206 (n=311)

  - _Acción_: SKIP cuando `ballena_activa_n` > 38.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=951)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.233 (n=331)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1069)

- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.199 (n=350)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1050)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.203 (n=341)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1059)
...
- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.243 (n=305)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=921)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.277 (n=307)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1231)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.162 (n=383)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=1155)
...
- **PATRÓN** `streak_len` < `3.0` → IC=+0.133 (n=137)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `streak_len` < 3.0 (IC base=+0.062)
...
- **PATRÓN** `ibs_15` < `0.1129` → IC=+0.135 (n=412)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.68€ cuando `ibs_15` < 0.1129 (IC base=+0.027)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.128 (n=162)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0052 (IC base=+0.015)
...
- **FILTRO** `ibs_15` > `0.596` → IC=-0.139 (n=95)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.596
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.235` → IC=-0.179 (n=325)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2330)
...
- **PATRÓN** `ibs_15` < `0.3315` → IC=+0.344 (n=113)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3315 (IC base=-0.082)

- **PATRÓN** `dist_vwap_pct` < `0.0929` → IC=+0.264 (n=104)
...
- **FILTRO** `sigma_h` > `0.0064` → IC=-0.231 (n=199)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.195 (n=388)

- **FILTRO** `sigma_h` < `0.0027` → IC=-0.209 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.250 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.194 (n=445)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4486 sube el IC de -0.052 a +0.156 en UPDOWN_GBM_15M_TARDIO (n=289). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3315 sube el IC de -0.082 a +0.344 en UPDOWN_GBM_15M_TARDIO (n=113). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 6499 | -0.098 | -879.41€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 669 | -0.089 | -118.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5830 | -0.099 | -761.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1067 | +0.020 | -119.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1067 | +0.020 | -119.30€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2131 | -0.072 | -99.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2131 | -0.072 | -99.87€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1548 | -0.192 | -348.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1548 | -0.192 | -348.48€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30245 | +0.114 | -1978.77€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5655 | +0.186 | -198.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21354 | +0.095 | -1693.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3129 | +0.121 | -35.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3585 | +0.063 | -611.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3560 | +0.065 | -608.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6279 | +0.134 | -129.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1594 | +0.197 | -87.94€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3554 | +0.111 | -76.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1089 | +0.130 | +56.66€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3593 | +0.078 | -471.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 20 | +0.045 | +2.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3572 | +0.078 | -472.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6738 | +0.129 | -79.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2057 | +0.169 | -12.11€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3555 | +0.114 | -40.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1114 | +0.104 | -17.98€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6468 | +0.131 | -429.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1947 | +0.201 | -103.11€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3549 | +0.095 | -241.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 926 | +0.132 | -74.53€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3582 | +0.104 | -256.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3564 | +0.105 | -254.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5625 | +0.173 | -437.14€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5625 | +0.173 | -437.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1415 | +0.167 | -150.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1415 | +0.167 | -150.68€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1403 | +0.160 | -167.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1403 | +0.160 | -167.34€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1260 | +0.231 | -33.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1260 | +0.231 | -33.54€ | 0 | 2 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1357 | +0.186 | -101.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1357 | +0.186 | -101.91€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15270 | +0.191 | -1337.11€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15270 | +0.191 | -1337.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2805 | +0.125 | -517.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2805 | +0.125 | -517.49€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2370 | +0.238 | -43.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2370 | +0.238 | -43.98€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2635 | +0.162 | -340.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2635 | +0.162 | -340.88€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2420 | +0.231 | -66.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2420 | +0.231 | -66.91€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2468 | +0.218 | -115.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2468 | +0.218 | -115.43€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2572 | +0.185 | -252.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2572 | +0.185 | -252.42€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 5521 | +0.133 | +182.11€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 5521 | +0.133 | +182.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2743 | +0.140 | +129.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2743 | +0.140 | +129.32€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2778 | +0.125 | +52.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2778 | +0.125 | +52.79€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 5575 | +0.096 | -206.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 575 | +0.056 | -30.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 5000 | +0.100 | -176.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 3852 | +0.096 | -98.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 575 | +0.056 | -30.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 