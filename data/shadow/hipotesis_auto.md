# Hipótesis automáticas — 2026-09-23 18:54 UTC
_Generado por shadow_postmortem.py sobre 577421 resoluciones (PNL=+64381.40€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.06` → IC=-0.234 (n=6914)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.06
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=20744)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `139.02` → IC=-0.239 (n=903)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 139.02
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2711)
...
- **FILTRO** `restante_s_al_confirmar` < `128.9` → IC=-0.302 (n=856)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 128.9
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2568)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `164.56` → IC=-0.227 (n=1645)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.56
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4935)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.63` → IC=-0.357 (n=1374)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.63
  - _Potencial_: sin este filtro IC_bueno=-0.124 (n=4123)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.232 (n=10636)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5558)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `7741.5348` → IC=+0.173 (n=2093)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7741.5348 (IC base=+0.128)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.208 (n=1602)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2071)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15863.5473` → IC=+0.233 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15863.5473 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1487)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.375` → IC=+0.263 (n=1498)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=2104)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `14040.9217` → IC=+0.213 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14040.9217 (IC base=+0.200)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.154 (n=2749)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.334 (n=933)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.248 (n=652)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.238 (n=1455)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.233)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.153 (n=448)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1302.4168` → IC=+0.149 (n=640)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.143 (n=303)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 17.0 (IC base=+0.113)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=11176)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3730)
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.183 (n=1893)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.253 (n=375)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.185 (n=2531)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.186 (n=2202)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.71 (IC base=+0.181)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.247 (n=2374)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=2589)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.198 (n=1908)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=6184)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.71 (IC base=+0.175)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.225 (n=5955)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.230 (n=2976)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `2.94` → IC=+0.142 (n=4650)

  - _Acción_: Kelly boost +0.71€ cuando `lag_apertura_s` < 2.94 (IC base=+0.118)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.200 (n=2557)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.123)

- **PATRÓN** `restante_min` < `4.1` → IC=+0.134 (n=2316)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` < 4.1 (IC base=+0.123)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.142 (n=2482)
...
- **PATRÓN** `lag_apertura_s` < `3.44` → IC=+0.145 (n=2314)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 3.44 (IC base=+0.123)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.191 (n=2520)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` < 0.38 (IC base=+0.113)

- **PATRÓN** `restante_min` < `4.19` → IC=+0.126 (n=2350)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.19 (IC base=+0.113)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.136 (n=2536)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` > 4.96 (IC base=+0.113)

- **PATRÓN** `lag_apertura_s` < `2.3` → IC=+0.139 (n=2342)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.449 (n=233)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3696` → IC=+0.123 (n=6873)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3696 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9804` → IC=+0.242 (n=2606)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9804 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.839` → IC=+0.249 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.839 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.6336` → IC=+0.249 (n=2176)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6336 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.326` → IC=+0.184 (n=2071)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 8.326 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.05` → IC=+0.258 (n=950)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.05 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.306` → IC=+0.219 (n=777)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.306 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.909` → IC=+0.206 (n=3552)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.909 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5698` → IC=+0.133 (n=9431)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5698 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.6098` → IC=+0.192 (n=700)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.6098 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` < `0.152` → IC=+0.173 (n=2965)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.152 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.181 (n=1448)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6986 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.0527` → IC=+0.173 (n=1491)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0527 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.222 (n=1571)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `1.573` → IC=+0.200 (n=4918)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.573 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `137.0` → IC=+0.211 (n=5295)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3485` → IC=+0.166 (n=1768)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3485 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=854)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.116` → IC=+0.270 (n=759)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4398` → IC=+0.163 (n=1652)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4398 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.250 (n=1184)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.09` → IC=+0.286 (n=441)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.09 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.247 (n=904)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.234)

- **PATRÓN** `ibs_20min` < `0.0556` → IC=+0.291 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0556 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.427` → IC=+0.247 (n=1375)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.427 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.230 (n=1128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0914 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.265 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2757 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.6401` → IC=+0.242 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6401 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1798.11` → IC=+0.237 (n=881)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1798.11 (IC base=+0.234)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.230 (n=1409)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9042` → IC=+0.260 (n=610)
...
- **PATRÓN** `sigma_h` > `0.0115` → IC=+0.215 (n=577)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0115 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.189 (n=1819)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2115` → IC=+0.188 (n=1721)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7913` → IC=+0.210 (n=595)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7913 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `2.221` → IC=+0.220 (n=900)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.221 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.223 (n=998)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `1875.8832` → IC=+0.231 (n=671)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1875.8832 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.214 (n=1134)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.666` → IC=+0.153 (n=692)
...
- **FILTRO** `hora_utc` < `17.0` → IC=-0.172 (n=59)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=315)

- **FILTRO** `ibs_20min` < `0.2703` → IC=-0.205 (n=93)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2703
  - _Potencial_: sin este filtro IC_bueno=+0.129 (n=281)

- **FILTRO** `ibs_20min` > `0.2568` → IC=-0.125 (n=2131)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.654` → IC=-0.206 (n=342)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2840)

- **PATRÓN** `ibs_20min` > `0.7846` → IC=+0.215 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7846 (IC base=+0.045)

- **PATRÓN** `dist_vwap_pct` > `1.6434` → IC=+0.318 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6434 (IC base=+0.045)

- **PATRÓN** `dist_vwap_pct` < `0.7682` → IC=+0.267 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7682 (IC base=+0.045)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8428` → IC=+0.303 (n=74)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8428 (IC base=+0.045)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.293 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 49.0 (IC base=+0.045)

- **PATRÓN** `ibs_20min` < `0.2568` → IC=+0.126 (n=1051)
...
- **FILTRO** `drift_60min` |x|> `0.6576` → IC=-0.180 (n=548)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6576
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1645)

- **FILTRO** `ibs_20min` < `0.7091` → IC=-0.157 (n=1447)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.198 (n=405)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1788)
...
- **PATRÓN** `dist_vwap_pct` > `0.8768` → IC=+0.266 (n=152)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8768 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.7369` → IC=+0.254 (n=323)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1027` → IC=+0.275 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1027 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `2.1721` → IC=+0.253 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1721 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.247 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4427 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.246 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.198 (n=3267)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.4718` → IC=+0.188 (n=8729)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4718 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.7584` → IC=+0.289 (n=1044)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7584 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.584` → IC=+0.155 (n=4620)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.584 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6888` → IC=+0.248 (n=3091)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6888 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2976` → IC=+0.264 (n=820)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2976 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `1.4721` → IC=+0.241 (n=1872)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4721 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6833` → IC=+0.238 (n=1872)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6833 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.268 (n=5134)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.152 (n=3260)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5457` → IC=+0.152 (n=8607)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5457 (IC base=+0.073)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2455` → IC=+0.300 (n=719)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2455 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `1.6087` → IC=+0.254 (n=1660)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6087 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `2.3271` → IC=+0.256 (n=1710)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3271 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `83.0` → IC=+0.261 (n=3648)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.772` → IC=+0.203 (n=362)
...
- **PATRÓN** `volumen_regimen` > `0.8575` → IC=+0.172 (n=596)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8575 (IC base=+0.026)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.197 (n=292)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `247.0` → IC=+0.193 (n=379)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=1549)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1379` → IC=+0.258 (n=1372)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.255 (n=1084)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1714` → IC=+0.283 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1714 (IC base=+0.281)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.289 (n=826)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `1931.0684` → IC=+0.299 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1931.0684 (IC base=+0.281)
...
- **FILTRO** `ibs_20min` < `0.2821` → IC=-0.189 (n=474)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2821
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1424)
...
- **PATRÓN** `ibs_20min` > `0.8153` → IC=+0.159 (n=646)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8153 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` > `0.4536` → IC=+0.225 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4536 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` < `0.7044` → IC=+0.206 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7044 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.9978` → IC=+0.232 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9978 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.5819` → IC=+0.209 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5819 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.0801` → IC=+0.245 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0801 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` < `2.0972` → IC=+0.244 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0972 (IC base=+0.009)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.254 (n=344)
...
- **PATRÓN** `dist_vwap_pct` < `0.6734` → IC=+0.193 (n=463)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.6734 (IC base=-0.006)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1651` → IC=+0.266 (n=92)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1651 (IC base=-0.006)
...
- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.231 (n=540)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=1636)

- **FILTRO** `sigma_ewma_delta_pct` > `4.685` → IC=-0.177 (n=475)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.685
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=1701)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.564` → IC=+0.157 (n=330)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.564 (IC base=+0.040)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.320 (n=848)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.63` → IC=+0.314 (n=1274)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.512` → IC=+0.304 (n=671)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.286 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.280)

- **PATRÓN** `libro_liquidez` > `2622.2916` → IC=+0.298 (n=848)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2622.2916 (IC base=+0.280)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.306` → IC=+0.257 (n=1566)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.306 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2155` → IC=+0.159 (n=5051)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2155 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6283` → IC=+0.160 (n=5049)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6283 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2458` → IC=+0.194 (n=1540)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2458 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.563` → IC=+0.170 (n=3218)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.563 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6282` → IC=+0.175 (n=2439)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6282 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2399.7982` → IC=+0.168 (n=5088)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2399.7982 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.180 (n=6540)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 116.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=4874)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0806` → IC=+0.208 (n=2437)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0806 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2807)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.4773` → IC=+0.226 (n=7311)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4773 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2316` → IC=+0.159 (n=5306)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2316 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.32` → IC=+0.196 (n=1243)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.32 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.174` → IC=+0.152 (n=5307)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.174 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2917` → IC=+0.223 (n=1048)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2917 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5653` → IC=+0.168 (n=2920)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5653 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2623` → IC=+0.170 (n=3007)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2623 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.173 (n=6270)
...
- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.185 (n=871)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0065 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.3421` → IC=+0.205 (n=1305)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.301 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.107` → IC=+0.310 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.107 (IC base=+0.181)
...
- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.264 (n=945)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.234` → IC=+0.251 (n=1019)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.234 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0959` → IC=+0.235 (n=782)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0959 (IC base=+0.238)
...
- **PATRÓN** `libro_liquidez` > `1800.66` → IC=+0.248 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1800.66 (IC base=+0.238)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=1196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` > `0.4081` → IC=+0.224 (n=1136)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.523` → IC=+0.237 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.523 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` < `1.2679` → IC=+0.163 (n=1136)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4117` → IC=+0.192 (n=368)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.4117 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `2.4674` → IC=+0.161 (n=367)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.4674 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `15865.6176` → IC=+0.162 (n=515)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 15865.6176 (IC base=+0.160)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.218 (n=441)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1334` → IC=+0.200 (n=501)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1334 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `1.6438` → IC=+0.195 (n=405)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.6438 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.8719` → IC=+0.206 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8719 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `1952.3598` → IC=+0.197 (n=427)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 1952.3598 (IC base=+0.197)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.157 (n=1219)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=1281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` > `0.375` → IC=+0.195 (n=1219)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.884` → IC=+0.220 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.884 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.0427` → IC=+0.142 (n=1073)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.0427 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6283` → IC=+0.148 (n=1219)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6283 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2461` → IC=+0.199 (n=257)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2461 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `1.5375` → IC=+0.148 (n=526)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5375 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.5292` → IC=+0.170 (n=398)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.5292 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `6793.8152` → IC=+0.183 (n=813)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6793.8152 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.143 (n=1155)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.138 (n=1413)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.118)

- **PATRÓN** `ibs_20min` > `0.5167` → IC=+0.203 (n=1379)
...
- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.130 (n=1381)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2233 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.639` → IC=+0.121 (n=1379)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.639 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` < `0.165` → IC=+0.131 (n=1388)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.165 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `2.4822` → IC=+0.127 (n=1331)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.4822 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1445)
...
- **PATRÓN** `dist_vwap_pct` > `0.9924` → IC=+0.140 (n=187)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.9924 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.1974` → IC=+0.138 (n=1289)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1974 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.973` → IC=+0.145 (n=226)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 8.973 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `1.1765` → IC=+0.122 (n=1403)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.1765 (IC base=+0.113)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4585` → IC=+0.132 (n=419)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4585 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.4294` → IC=+0.131 (n=418)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.209 (n=476)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.203)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.547` → IC=+0.244 (n=622)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.547 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.209` → IC=+0.205 (n=1317)
...
- **PATRÓN** `ibs_20min` < `0.4385` → IC=+0.246 (n=1367)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4385 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.184` → IC=+0.228 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.184 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` < `0.8984` → IC=+0.204 (n=1591)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8984 (IC base=+0.204)
...
- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.216 (n=1367)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2198` → IC=+0.195 (n=1079)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2198 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4425` → IC=+0.199 (n=1226)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4425 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2585.5965` → IC=+0.208 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2585.5965 (IC base=+0.204)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.183 (n=908)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.5505` → IC=+0.187 (n=1605)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.5505 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.868` → IC=+0.192 (n=287)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.868 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.175 (n=826)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8753` → IC=+0.162 (n=1048)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8753 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.21` → IC=+0.156 (n=524)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4385` → IC=+0.165 (n=577)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2036)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12328.2495` → IC=+0.152 (n=599)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 12328.2495 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.165 (n=1577)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 164.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.133 (n=1262)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0057 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=1805)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` < `2.2268` → IC=+0.122 (n=1601)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.2268 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `3859.8614` → IC=+0.123 (n=1261)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 3859.8614 (IC base=+0.104)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3375` → IC=+0.125 (n=451)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3375 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.146 (n=405)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 9.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.2513` → IC=+0.145 (n=451)
...
- **PATRÓN** `libro_liquidez` > `12708.3374` → IC=+0.135 (n=403)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 12708.3374 (IC base=+0.105)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.204 (n=201)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.3387` → IC=+0.150 (n=603)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.3387 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.142 (n=621)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 5.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.6012` → IC=+0.177 (n=530)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6012 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.3066` → IC=+0.151 (n=637)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3066 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.384` → IC=+0.152 (n=234)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 4.384 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `0.7174` → IC=+0.147 (n=539)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.7174 (IC base=+0.131)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1013` → IC=+0.153 (n=522)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.1013 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.42` → IC=+0.142 (n=593)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.42 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `389.0` → IC=+0.141 (n=571)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.227 (n=251)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.191)

- **PATRÓN** `ibs_20min` > `0.7033` → IC=+0.240 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7033 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` > `0.1544` → IC=+0.210 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1544 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.93` → IC=+0.220 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.93 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` < `0.8392` → IC=+0.195 (n=368)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.8392 (IC base=+0.191)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3924` → IC=+0.234 (n=182)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3924 (IC base=+0.191)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.198 (n=614)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `12357.9012` → IC=+0.204 (n=184)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.197 (n=796)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.524` → IC=+0.344 (n=375)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.524 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2738` → IC=+0.252 (n=220)
...
- **PATRÓN** `ibs_20min` < `0.3485` → IC=+0.290 (n=1134)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3485 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.466` → IC=+0.262 (n=1347)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.466 (IC base=+0.257)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.286 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.257)

- **PATRÓN** `volumen_spike_ratio` > `1.8649` → IC=+0.273 (n=786)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8649 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `1796.78` → IC=+0.263 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1796.78 (IC base=+0.257)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=1653)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.6709` → IC=+0.256 (n=1408)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6709 (IC base=+0.217)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2125` → IC=+0.220 (n=1553)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2125 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.8459` → IC=+0.243 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8459 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=1118)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1956.263` → IC=+0.220 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1956.263 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.230 (n=1303)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 53.0 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.240 (n=1470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0115 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.1659` → IC=+0.240 (n=647)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1659 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.264 (n=553)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.756` → IC=+0.280 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.756 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.3451` → IC=+0.299 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3451 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` < `1.7564` → IC=+0.236 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7564 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.195` → IC=+0.237 (n=896)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.195 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.244 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1877.4384` → IC=+0.248 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1877.4384 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.230 (n=1270)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4373` → IC=+0.143 (n=1660)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4373 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.148 (n=1738)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.8762` → IC=+0.259 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8762 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.577` → IC=+0.169 (n=472)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.577 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.171` → IC=+0.157 (n=689)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.171 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.8767` → IC=+0.153 (n=1107)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8767 (IC base=+0.134)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5221` → IC=+0.146 (n=707)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5221 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `2.4694` → IC=+0.146 (n=535)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 2.4694 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `8136.1215` → IC=+0.227 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8136.1215 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.151 (n=520)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1692)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.190 (n=1650)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4706 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `1.0763` → IC=+0.202 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0763 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.453` → IC=+0.233 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.453 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.8919` → IC=+0.133 (n=1098)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8919 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1660)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2909.4755` → IC=+0.249 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2909.4755 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.129 (n=1262)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1305` → IC=+0.161 (n=540)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1305 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=1672)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` < `1.4542` → IC=+0.139 (n=486)
...
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.221 (n=1100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1724)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.251 (n=1650)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.188` → IC=+0.270 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.188 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.0716` → IC=+0.210 (n=1452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0716 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.6367` → IC=+0.218 (n=1650)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6367 (IC base=+0.211)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.220 (n=1729)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `2619.817` → IC=+0.223 (n=1100)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2619.817 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.225 (n=591)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0088 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.219 (n=593)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0256 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.208 (n=1252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5185` → IC=+0.255 (n=1773)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5185 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.2224` → IC=+0.204 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2224 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.913` → IC=+0.204 (n=1970)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.913 (IC base=+0.200)
...
- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.234 (n=591)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2043` → IC=+0.196 (n=1398)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2043 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4345` → IC=+0.196 (n=1589)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=2945)

- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.158 (n=2475)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0093 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.151 (n=2516)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5229` → IC=+0.159 (n=2812)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.5229 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.155 (n=938)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.212 (n=938)
...
- **PATRÓN** `dist_vwap_pct` < `0.4967` → IC=+0.143 (n=1683)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.4967 (IC base=+0.150)
...
- **PATRÓN** `volumen_regimen` > `0.902` → IC=+0.163 (n=1201)
...
- **PATRÓN** `ibs_20min` < `0.1833` → IC=+0.166 (n=977)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1833 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.6915` → IC=+0.149 (n=428)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.6915 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.4317` → IC=+0.130 (n=2194)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4317 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.224` → IC=+0.145 (n=2211)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.224 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2456` → IC=+0.142 (n=2119)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8143` → IC=+0.142 (n=1461)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8143 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=2945)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `6937.818` → IC=+0.150 (n=1984)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.152 (n=762)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0075 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.161 (n=863)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0044 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.1256` → IC=+0.155 (n=288)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1256 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.162 (n=338)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5623` → IC=+0.157 (n=576)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.5623 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.8892` → IC=+0.169 (n=288)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.8892 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.9801` → IC=+0.167 (n=199)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.9801 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.4266` → IC=+0.164 (n=796)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4266 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.678` → IC=+0.160 (n=866)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.678 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.7185` → IC=+0.156 (n=771)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7185 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` < `0.111` → IC=+0.155 (n=795)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.111 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4338` → IC=+0.162 (n=282)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4338 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=842)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.156 (n=727)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0084 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3917` → IC=+0.171 (n=640)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3917 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.1015` → IC=+0.152 (n=727)
...
- **PATRÓN** `dist_vwap_pct` < `0.387` → IC=+0.142 (n=733)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.387 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.738` → IC=+0.153 (n=119)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 10.738 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.266` → IC=+0.141 (n=659)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.266 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.6452` → IC=+0.167 (n=244)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6452 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.7262` → IC=+0.143 (n=650)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.7262 (IC base=+0.140)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1956` → IC=+0.152 (n=627)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7807` → IC=+0.152 (n=475)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.7807 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `7600.4466` → IC=+0.163 (n=727)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 7600.4466 (IC base=+0.140)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `ibs_20min` > `0.5469` → IC=+0.139 (n=211)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.5469 (IC base=+0.090)

- **PATRÓN** `dist_vwap_pct` > `0.2712` → IC=+0.130 (n=133)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.2712 (IC base=+0.090)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.177` → IC=+0.202 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.177 (IC base=+0.090)

- **PATRÓN** `volumen_pendiente_norm` > `0.1583` → IC=+0.221 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1583 (IC base=+0.090)

- **PATRÓN** `libro_liquidez` > `3421.4081` → IC=+0.144 (n=189)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 3421.4081 (IC base=+0.090)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.195 (n=388)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.004 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.128 (n=818)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 8.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.6778` → IC=+0.205 (n=703)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.166 (n=300)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.006 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=314)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` > `0.52` → IC=+0.186 (n=269)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.52 (IC base=+0.108)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.581` → IC=+0.132 (n=161)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 3.581 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.139 (n=203)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2771` → IC=+0.149 (n=35)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.2771 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.176 (n=202)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.108)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=277)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `4069.8567` → IC=+0.144 (n=116)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 4069.8567 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.179 (n=132)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0039 (IC base=+0.103)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.132 (n=283)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 7.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.6839` → IC=+0.227 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6839 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.3424` → IC=+0.170 (n=110)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3424 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.792` → IC=+0.300 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.792 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` > `1.0654` → IC=+0.141 (n=90)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.0654 (IC base=+0.103)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7369` → IC=+0.162 (n=146)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.7369 (IC base=+0.103)
...
- **PATRÓN** `libro_liquidez` > `1767.0561` → IC=+0.189 (n=88)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 1767.0561 (IC base=+0.103)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.135 (n=198)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 13.0 (IC base=+0.076)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.177 (n=224)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.6744 (IC base=+0.076)

- **PATRÓN** `dist_vwap_pct` > `0.1982` → IC=+0.158 (n=144)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1982 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.351` → IC=+0.186 (n=100)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 5.351 (IC base=+0.076)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2448` → IC=+0.173 (n=47)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.2448 (IC base=+0.076)
...
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.140 (n=112)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0057 (IC base=+0.088)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.136 (n=116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 15.0 (IC base=+0.088)

- **PATRÓN** `ibs_20min` > `0.6522` → IC=+0.159 (n=247)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.6522 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` > `0.4941` → IC=+0.189 (n=59)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.4941 (IC base=+0.088)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.120 (n=675)

  - _Acción_: Kelly boost +0.60€ cuando `py_entrada` > 0.5 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2909.492` → IC=+0.168 (n=227)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2909.492 (IC base=+0.105)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.161 (n=175)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=175)

- **FILTRO** `restante_min` < `3.3` → IC=-0.155 (n=85)

  - _Acción_: SKIP cuando `restante_min` < 3.3
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=265)

- **FILTRO** `profundidad_ratio` < `40.8` → IC=-0.133 (n=175)

  - _Acción_: SKIP cuando `profundidad_ratio` < 40.8
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=175)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.184 (n=96)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` < 0.47 (IC base=+0.030)

- **PATRÓN** `profundidad_ratio` > `100.0` → IC=+0.163 (n=96)

  - _Acción_: Kelly boost +0.82€ cuando `profundidad_ratio` > 100.0 (IC base=+0.030)
...
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.189 (n=43)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.59 (IC base=+0.115)

- **PATRÓN** `restante_min` > `3.99` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` > 3.99 (IC base=+0.115)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.222 (n=16)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.115)

- **PATRÓN** `lag_apertura_s` < `60.77` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 60.77 (IC base=+0.115)

- **PATRÓN** `profundidad_ratio` > `67.7` → IC=+0.189 (n=43)

  - _Acción_: Kelly boost +0.94€ cuando `profundidad_ratio` > 67.7 (IC base=+0.115)
...
- **FILTRO** `profundidad_ratio` < `46.5` → IC=-0.184 (n=17)
...
- **FILTRO** `restante_min` < `2.87` → IC=-0.250 (n=18)
...
- **FILTRO** `lag_apertura_s` > `83.98` → IC=-0.200 (n=28)

  - _Acción_: SKIP cuando `lag_apertura_s` > 83.98
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=7426)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.172 (n=3229)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=10452)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.168 (n=3537)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=10646)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.212 (n=589)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1781)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.202 (n=585)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=1828)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=619)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1916)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.168 (n=586)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1767)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2904)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9688)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=21762)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=7666)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=23784)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.236 (n=7843)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=23607)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=10690)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=20760)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9684)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=29670)

- **FILTRO** `ibs_7min` > `0.2936` → IC=-0.179 (n=9837)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2936
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=29517)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1235)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3954)

- **FILTRO** `ibs_7min` < `0.7103` → IC=-0.250 (n=1712)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7103
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3477)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.185 (n=1196)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3993)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.260 (n=1673)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5092)

- **FILTRO** `drift_7min_pct` |x|> `0.1119` → IC=-0.124 (n=2300)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1119
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4465)

- **FILTRO** `ibs_7min` > `0.7903` → IC=-0.205 (n=1691)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7903
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=5074)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1265)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4172)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1305)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4132)

- **FILTRO** `ibs_7min` < `0.7484` → IC=-0.192 (n=1359)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7484
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4078)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.171 (n=1358)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4079)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.254 (n=1366)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4139)

- **FILTRO** `ibs_7min` > `0.2607` → IC=-0.177 (n=1375)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2607
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4130)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.184 (n=1374)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1394)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3521)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.307 (n=1206)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3709)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.259 (n=1225)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=3690)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1154)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3761)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1661)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5567)

- **FILTRO** `ibs_7min` > `0.75` → IC=-0.177 (n=1802)

  - _Acción_: SKIP cuando `ibs_7min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=5426)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1533)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3657)

- **FILTRO** `ibs_7min` < `0.742` → IC=-0.181 (n=1297)

  - _Acción_: SKIP cuando `ibs_7min` < 0.742
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3893)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.171 (n=1280)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3910)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.267 (n=1168)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=4110)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.175 (n=1319)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3959)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.187 (n=1313)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3965)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.263 (n=1325)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4174)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.242 (n=1368)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4131)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1789)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5697)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1678)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3542)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.228 (n=1291)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3929)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.215 (n=1264)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3956)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1707)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=5385)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.4164` → IC=+0.143 (n=483)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio` |x|> 0.4164 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.131 (n=331)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 14.0 (IC base=+0.113)

- **PATRÓN** `total_vol_5m` < `464.449` → IC=+0.147 (n=242)

  - _Acción_: Kelly boost +0.74€ cuando `total_vol_5m` < 464.449 (IC base=+0.113)
...
- **PATRÓN** `delta_ratio` |x|> `0.3989` → IC=+0.174 (n=127)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio` |x|> 0.3989 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.192 (n=89)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 11.0 (IC base=+0.137)

- **PATRÓN** `total_vol_5m` < `8095.34` → IC=+0.159 (n=127)

  - _Acción_: Kelly boost +0.79€ cuando `total_vol_5m` < 8095.34 (IC base=+0.137)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=2847)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.221 (n=694)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `libro_liquidez` > `2979.0729` → IC=+0.192 (n=1020)
...
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.139 (n=120)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0036 (IC base=+0.137)
...
- **PATRÓN** `drift_60min` |x|≤ `0.069` → IC=+0.152 (n=159)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.069 (IC base=+0.137)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2542` → IC=+0.159 (n=253)

  - _Acción_: Kelly boost +0.79€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2542 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=358)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_15` > `0.6642` → IC=+0.242 (n=320)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6642 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.5648` → IC=+0.142 (n=79)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.5648 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1658` → IC=+0.155 (n=279)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1658 (IC base=+0.137)
...
- **PATRÓN** `libro_liquidez` > `3456.6166` → IC=+0.149 (n=320)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3456.6166 (IC base=+0.137)
...
- **FILTRO** `dist_vwap_pct` > `0.7151` → IC=-0.143 (n=96)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=874)
...
- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.157 (n=459)
...
- **FILTRO** `sigma_h` > `0.0131` → IC=-0.220 (n=641)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0131
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1927)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.190 (n=866)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1702)
...
- **PATRÓN** `ibs_15` > `0.6349` → IC=+0.269 (n=616)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.2759` → IC=+0.178 (n=483)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.2759 (IC base=-0.063)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0755` → IC=+0.237 (n=1488)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3488` → IC=+0.275 (n=1665)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `hora_utc` > `7.0` → IC=-0.207 (n=991)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.169 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0028 (IC base=+0.075)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.162 (n=374)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.149 (n=294)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0068 (IC base=+0.149)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.192 (n=196)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0051 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.0768` → IC=+0.220 (n=130)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0768 (IC base=+0.149)

- **PATRÓN** `drift_15min` |x|≤ `0.4643` → IC=+0.159 (n=130)

  - _Acción_: Kelly boost +0.80€ cuando `drift_15min` |x|≤ 0.4643 (IC base=+0.149)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1323` → IC=+0.157 (n=196)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.78€ cuando `delta_ratio_macro` |x|> 0.1323 (IC base=+0.149)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.288` → IC=+0.238 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.288 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.205 (n=137)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1651` → IC=+0.177 (n=224)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1651 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.024` → IC=+0.159 (n=250)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 9.024 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.162 (n=374)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `11008.7835` → IC=+0.196 (n=133)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 11008.7835 (IC base=+0.149)
...
- **FILTRO** `drift_60min` |x|> `0.1671` → IC=-0.220 (n=205)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.138 (n=399)

- **FILTRO** `drift_15min` |x|> `0.8935` → IC=-0.263 (n=150)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1069` → IC=+0.344 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1069 (IC base=+0.289)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.309 (n=673)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.292 (n=787)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6047 sube el IC de +0.185 a +0.263 en UPDOWN_GBM#15min (n=1531). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6642 sube el IC de +0.137 a +0.242 en UPDOWN_GBM#ETH#15min (n=320). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.046 a +0.157 en UPDOWN_GBM#XRP#15min (n=459). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6349 sube el IC de -0.063 a +0.269 en UPDOWN_GBM_15M_TARDIO (n=616). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3488 sube el IC de -0.035 a +0.275 en UPDOWN_GBM_15M_TARDIO (n=1665). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6647 sube el IC de +0.149 a +0.264 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=294). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1300 | +0.098 | +189.37€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1300 | +0.098 | +189.37€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 967 | +0.108 | +164.31€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 967 | +0.108 | +164.31€ | 2 | 8 |
...
| ✅ BALLENAS_TARDIAS | 24608 | -0.091 | -3161.91€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1433 | -0.048 | -223.67€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 23175 | -0.094 | -2938.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3614 | -0.088 | -592.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3614 | -0.088 | -592.50€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7110 | -0.023 | -653.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7110 | -0.023 | -653.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6580 | -0.098 | -458.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6580 | -0.098 | -458.00€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5497 | -0.183 | -1072.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5497 | -0.183 | -1072.71€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17415 | -0.029 | +4080.19€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4557 | +0.000 | +1827.97€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12858 | -0.039 | +2252.22€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 17415 | -0.029 | +4080.19€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4557 | +0.000 | +1827.97€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12858 | -0.039 | +2252.22€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 90434 | +0.112 | -4635.59€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13726 | +0.184 | -446.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 361 | -0.089 | -50.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 70431 | +0.100 | -3925.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5916 | +0.108 | -213.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11716 | +0.097 | -1014.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 44 | -0.174 | -3.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11657 | +0.099 | -999.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18290 | +0.132 | -383.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4308 | +0.202 | -150.39€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11674 | +0.111 | -182.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2266 | +0.105 | -28.05€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11755 | +0.089 | -1103.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 51 | -0.085 | -5.77€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11689 | +0.090 | -1086.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19254 | +0.123 | -402.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5305 | +0.175 | -79.81€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11798 | +0.105 | -261.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2139 | +0.098 | -53.01€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17688 | +0.114 | -1035.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3973 | +0.188 | -214.93€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 264 | -0.049 | +3.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11940 | +0.091 | -692.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1511 | +0.127 | -132.13€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11731 | +0.101 | -696.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 45 | -0.032 | +7.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11673 | +0.101 | -704.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14341 | +0.192 | -933.41€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14341 | +0.192 | -933.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3427 | +0.168 | -360.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3427 | +0.168 | -360.25€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1147 | +0.195 | -7.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1147 | +0.195 | -7.81€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3370 | +0.181 | -286.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3370 | +0.181 | -286.31€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3010 | +0.238 | -98.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3010 | +0.238 | -98.44€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3308 | +0.194 | -194.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3308 | +0.194 | -194.35€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 49350 | +0.197 | -3928.77€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 49350 | +0.197 | -3928.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8550 | +0.175 | -1007.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8550 | +0.175 | -1007.65€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7881 | +0.222 | -299.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7881 | +0.222 | -299.65€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8517 | +0.172 | -1032.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8517 | +0.172 | -1032.87€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 7973 | +0.218 | -322.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 7973 | +0.218 | -322.37€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8148 | +0.203 | -544.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8148 | +0.203 | -544.43€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8281 | +0.194 | -721.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8281 | +0.194 | -721.80€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 18592 | +0.118 | +167.56€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 18592 | +0.118 | +167.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9230 | +0.123 | +152.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9230 | +0.123 | +152.42€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9362 | +0.113 | +15.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9362 | +0.113 | +15.13€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1080 | +0.075 | -42.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 375 | +0.062 | -28.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 705 | +0.081 | -14.09€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 851 | +0.082 | -17.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 146 | +0.081 | -3.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 705 | +0.081 | -14.09€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 34278 | +0.097 | -1075.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2838 | +0.090 | +21.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 31440 | +0.098 | -1096.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 19286 | +0.101 | -322.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2838 | +0.090 | +21.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 16448 | +0.103 | -344.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6392 | +0.107 | -36.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6392 | +0.107 | -36.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8600 | +0.080 | -715.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8600 | +0.080 | -715.84€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 24700 | +0.081 | +11622.06€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 24700 | +0.081 | +11622.06€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4118 | +0.192 | +2976.60€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4118 | +0.192 | +2976.60€ | 0 | 18 |
| ✅ GBM_LATE_15M#BTC | 3660 | +0.176 | +2525.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3660 | +0.176 | +2525.30€ | 0 | 26 |
| ✅ GBM_LATE_15M#DOGE | 4274 | +0.199 | +3203.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4274 | +0.199 | +3203.77€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3662 | +0.017 | +747.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3662 | +0.017 | +747.65€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3556 | -0.033 | +809.13€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3556 | -0.033 | +809.13€ | 4 | 15 |
| ✅ GBM_LATE_15M#XRP | 5430 | -0.042 | +1359.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5430 | -0.042 | +1359.61€ | 4 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 26068 | +0.085 | +13594.00€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 26068 | +0.085 | +13594.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4935 | +0.017 | +2628.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4935 | +0.017 | +2628.47€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5432 | +0.014 | +1114.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5432 | +0.014 | +1114.07€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3701 | +0.262 | +3716.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3701 | +0.262 | +3716.13€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4216 | +0.001 | +776.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4216 | +0.001 | +776.72€ | 2 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4246 | +0.027 | +1591.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4246 | +0.027 | +1591.22€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3538 | +0.275 | +3767.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3538 | +0.275 | +3767.38€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 19923 | +0.167 | +14807.77€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 19923 | +0.167 | +14807.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2998 | +0.205 | +2364.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2998 | +0.205 | +2364.83€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3174 | +0.147 | +2301.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3174 | +0.147 | +2301.78€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3119 | +0.208 | +2479.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3119 | +0.208 | +2479.10€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3347 | +0.132 | +2316.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3347 | +0.132 | +2316.09€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3708 | +0.115 | +2517.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3708 | +0.115 | +2517.27€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3577 | +0.204 | +2828.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3577 | +0.204 | +2828.70€ | 0 | 27 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4916 | +0.125 | +2012.39€ | 0 | 20 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4916 | +0.125 | +2012.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1404 | +0.120 | +619.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1404 | +0.120 | +619.35€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1426 | +0.140 | +611.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1426 | +0.140 | +611.20€ | 0 | 17 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1026 | +0.098 | +310.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1026 | +0.098 | +310.22€ | 2 | 13 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 504 | +0.134 | +216.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 504 | +0.134 | +216.54€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 24807 | +0.174 | +18335.55€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#15min | 24807 | +0.174 | +18335.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3926 | +0.219 | +3288.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3926 | +0.219 | +3288.84€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3884 | +0.149 | +2546.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3884 | +0.149 | +2546.20€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4059 | +0.225 | +3495.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4059 | +0.225 | +3495.82€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 4026 | +0.135 | +2708.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 4026 | +0.135 | +2708.89€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4350 | +0.111 | +2706.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4350 | +0.111 | +2706.53€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4562 | +0.205 | +3589.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4562 | +0.205 | +3589.27€ | 0 | 24 |
| ✅ GBM_LATE_5M | 6709 | +0.144 | +3738.66€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 6709 | +0.144 | +3738.66€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 2119 | +0.146 | +1154.04€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 2119 | +0.146 | +1154.04€ | 0 | 31 |
| ✅ GBM_LATE_5M#SOL | 557 | +0.099 | +185.09€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 557 | +0.099 | +185.09€ | 0 | 15 |
| ✅ GBM_LATE_5M#XRP | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_60M | 1643 | +0.070 | +712.04€ | 2 | 14 |
| ✅ GBM_LATE_60M#60min | 1643 | +0.070 | +712.04€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 591 | +0.090 | +251.73€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 591 | +0.090 | +251.73€ | 0 | 14 |
| ✅ GBM_LATE_60M#ETH | 546 | +0.071 | +268.88€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 546 | +0.071 | +268.88€ | 2 | 16 |
| ✅ GBM_LATE_60M#SOL | 506 | +0.043 | +191.43€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 506 | +0.043 | +191.43€ | 1 | 13 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 675 | +0.064 | +126.77€ | 1 | 7 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 675 | +0.064 | +126.77€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1860 | +0.096 | +493.99€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1860 | +0.096 | +493.99€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1860 | +0.096 | +493.99€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1860 | +0.096 | +493.99€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 733 | -0.029 | -0.53€ | 3 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 331 | -0.019 | +6.27€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 402 | -0.037 | -6.80€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC | 184 | +0.059 | +38.75€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#15min | 82 | +0.059 | +15.74€ | 0 | 3 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#5min | 102 | +0.058 | +23.01€ | 0 | 5 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH | 120 | -0.082 | -13.32€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#15min | 53 | -0.082 | -6.50€ | 4 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#5min | 67 | -0.080 | -6.82€ | 3 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL | 113 | -0.013 | +1.46€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#15min | 57 | -0.009 | +3.82€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#5min | 56 | -0.017 | -2.36€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP | 172 | -0.069 | -16.89€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#15min | 71 | -0.062 | -5.72€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#5min | 101 | -0.073 | -11.17€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M | 14290 | -0.011 | -204.23€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14290 | -0.011 | -204.23€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 3007 | -0.020 | -57.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 3007 | -0.020 | -57.42€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 27864 | -0.007 | +1223.92€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 27864 | -0.007 | +1223.92€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4912 | +0.016 | +594.24€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4912 | +0.016 | +594.24€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4336 | -0.028 | -53.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4336 | -0.028 | -53.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4948 | +0.014 | +442.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4948 | +0.014 | +442.56€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4118 | -0.052 | -144.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4118 | -0.052 | -144.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4662 | -0.011 | +180.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4662 | -0.011 | +180.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4888 | +0.007 | +205.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4888 | +0.007 | +205.69€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5729 | -0.056 | -127.62€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5729 | -0.056 | -127.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1203 | +0.000 | -15.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1203 | +0.000 | -15.55€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 1373 | -0.077 | -33.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 1373 | -0.077 | -33.99€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1655 | -0.074 | -26.60€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1655 | -0.074 | -26.60€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 70804 | -0.073 | +1696.62€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 70804 | -0.073 | +1696.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 11954 | -0.079 | +691.61€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 11954 | -0.079 | +691.61€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 10942 | -0.092 | -465.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 10942 | -0.092 | -465.47€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 12143 | -0.067 | +675.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 12143 | -0.067 | +675.56€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10468 | -0.093 | -145.02€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10468 | -0.093 | -145.02€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 12985 | -0.048 | +364.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 12985 | -0.048 | +364.14€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 12312 | -0.063 | +575.80€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 12312 | -0.063 | +575.80€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7393 | -0.023 | -110.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7393 | -0.023 | -110.78€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 1979 | -0.019 | -21.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 1979 | -0.019 | -21.03€ | 1 | 0 |
...
| ✅ ORDER_FLOW_5M | 1102 | +0.106 | +364.26€ | 0 | 3 |
| ✅ ORDER_FLOW_5M#5min | 966 | +0.113 | +351.66€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 169 | +0.137 | +80.67€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 169 | +0.137 | +80.67€ | 0 | 3 |
| ✅ ORDER_FLOW_5M#XRP | 188 | +0.105 | +57.82€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#XRP#5min | 188 | +0.105 | +57.82€ | 0 | 5 |
| ✅ ORDER_FLOW_5M_REACTIVO | 440 | -0.059 | -50.96€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#5min | 440 | -0.059 | -50.96€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO#SOL | 90 | +0.011 | +3.16€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#SOL#5min | 90 | +0.011 | +3.16€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 2720 | -0.023 | -114.32€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2720 | -0.023 | -114.32€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1195 | -0.023 | -49.12€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1195 | -0.023 | -49.12€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 7604 | +0.023 | +110.84€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7604 | +0.023 | +110.84€ | 0 | 0 |
...
| ✅ STREAK_MOM_5M#SOL | 2308 | +0.011 | +1.69€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2308 | +0.011 | +1.69€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1473 | +0.029 | +37.49€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1473 | +0.029 | +37.49€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7133 | +0.011 | -48.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7133 | +0.011 | -48.81€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2866 | +0.015 | -11.35€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2866 | +0.015 | -11.35€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2790 | +0.011 | -19.42€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2790 | +0.011 | -19.42€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1477 | +0.003 | -18.04€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1477 | +0.003 | -18.04€ | 2 | 0 |
| ✅ UPDOWN_GBM | 35527 | +0.030 | +2072.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 9595 | +0.065 | +1689.78€ | 0 | 10 |
| ✅ UPDOWN_GBM#240min | 1317 | +0.004 | +5.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 22316 | +0.020 | +358.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2160 | +0.006 | +19.53€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3563 | +0.066 | +372.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 606 | +0.145 | +229.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 29 | -0.016 | -0.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2928 | +0.050 | +143.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6578 | +0.035 | +435.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1215 | +0.082 | +261.41€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 358 | +0.019 | +7.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 3983 | +0.031 | +149.65€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 969 | +0.004 | +16.43€ | 1 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 7563 | +0.017 | +276.82€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2483 | +0.045 | +267.60€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 346 | +0.006 | +6.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3953 | +0.005 | +2.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 736 | +0.003 | -4.29€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 45 | -0.138 | +3.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8539 | +0.015 | +214.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2366 | +0.026 | +162.31€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 340 | -0.006 | -3.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5339 | +0.013 | +50.64€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 455 | +0.019 | +7.39€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 39 | -0.159 | -2.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5146 | +0.035 | +532.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2366 | +0.079 | +568.56€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 217 | -0.002 | -3.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2563 | -0.003 | -33.03€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11511 | -0.042 | +2351.26€ | 2 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11511 | -0.042 | +2351.26€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 710 | -0.041 | +335.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 710 | -0.041 | +335.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2145 | -0.124 | +15.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2145 | -0.124 | +15.19€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 345 | +0.177 | +226.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 345 | +0.177 | +226.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1271 | +0.201 | +727.60€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1271 | +0.201 | +727.60€ | 1 | 24 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3513 | -0.064 | +533.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3513 | -0.064 | +533.97€ | 3 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3527 | -0.079 | +512.79€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3527 | -0.079 | +512.79€ | 3 | 4 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 855 | +0.289 | +686.01€ | 0 | 11 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 855 | +0.289 | +686.01€ | 0 | 0 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 518 celda(s) pasan gate riguroso completo de 2202 evaluadas (n>=40) y 3195 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.026 < 0.08 — monitorear
  - _Datos_: n=2366 IC=+0.026 PNL=+162.31€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.092 n=285/60 | contraria IC=+0.150 n=278 | gap=-0.058 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=736/40 IC=+0.003 PNL=-4.29€ | BTC#60min: n=969/40 IC=+0.004 PNL=+16.43€ | SOL#60min: n=455/40 IC=+0.019 PNL=+7.39€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.051 n=324208 | tras_1loss IC=+0.077 n=252646 | tras_2loss IC=+0.046 n=106839/40 | gap=+0.005 (umbral 0.05)
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.220 > 0.08 con n=370 PNL=+270.50€
  - _Datos_: n=370 IC=+0.220 PNL=+270.50€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1536 IC=+0.014 PNL=+10.84€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1536 IC=+0.014 PNL=+10.84€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.185 > 0.1 con n=2039 PNL=+1266.66€
  - _Datos_: n=2039 IC=+0.185 PNL=+1266.66€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1215 IC=+0.082 PNL=+261.41€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1215 IC=+0.082 PNL=+261.41€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=12286 IC=+0.054 PNL=+1495.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=12286 IC=+0.054 PNL=+1495.02€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1823 IC=+0.046 PNL=+186.85€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1823 IC=+0.046 PNL=+186.85€
...
**🟡 H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.126 > 0.1 con n=386 PNL=+105.45€
  - _Datos_: n=386 IC=+0.126 PNL=+105.45€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=17279 IC=-0.137 PNL=+1170.76€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=17279 IC=-0.137 PNL=+1170.76€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1869 IC=+0.138 PNL=+1000.62€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1869 IC=+0.138 PNL=+1000.62€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.239 < -0.1 con n=1693 PNL=-187.70€
  - _Datos_: n=1693 IC=-0.239 PNL=-187.70€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.088 n=954) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=954 IC=+0.088 PNL=+213.17€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8546 IC=+0.175 PNL=-1009.23€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8546 IC=+0.175 PNL=-1009.23€
