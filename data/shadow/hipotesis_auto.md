# Hipótesis automáticas — 2026-07-20 01:10 UTC
_Generado por shadow_postmortem.py sobre 23535 resoluciones (PNL=+6020.59€)_
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.214 (n=581)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `4191.5309` → IC=+0.175 (n=1057)
...
| ✅ FAVORITO_CONFIRMADO | 4024 | +0.186 | +60.81€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#60min | 690 | +0.160 | +48.41€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1430 | +0.181 | +18.30€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 230 | +0.155 | +16.27€ | 0 | 8 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.119 n=14216 | tras_1loss IC=+0.092 n=9126 | tras_2loss IC=+0.059 n=3686/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=21077 IC=+0.123 PNL=+6096.47€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=21077 IC=+0.123 PNL=+6096.47€
