# Hipótesis automáticas — 2026-07-29 01:21 UTC
_Generado por shadow_postmortem.py sobre 41047 resoluciones (PNL=+8671.56€)_
...
- **PATRÓN** `dist_vwap_pct` > `0.2776` → IC=+0.182 (n=545)
...
- **PATRÓN** `libro_liquidez` > `2368.47` → IC=+0.141 (n=1608)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.189 (n=159)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.253` → IC=+0.189 (n=130)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 7.253 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `8269.8968` → IC=+0.131 (n=250)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 8269.8968 (IC base=+0.118)
...
- **PATRÓN** `sigma_h` < `0.0171` → IC=+0.246 (n=454)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.231 (n=399)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.537` → IC=+0.354 (n=128)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.537 (IC base=+0.231)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=495)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.126 (n=1295)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.266` → IC=+0.162 (n=66)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 12.266 (IC base=+0.053)

- **PATRÓN** `libro_liquidez` > `6662.3921` → IC=+0.125 (n=230)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 6662.3921 (IC base=+0.053)
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.196 (n=189)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0091 (IC base=+0.173)

- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.175 (n=505)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0102 (IC base=+0.173)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=576)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 6.0 (IC base=+0.173)

- **PATRÓN** `dist_vwap_pct` > `0.461` → IC=+0.237 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.461 (IC base=+0.173)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.87` → IC=+0.296 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.87 (IC base=+0.173)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=432)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.173)
...
| ✅ GBM_LATE_15M | 8851 | +0.094 | +2659.79€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8851 | +0.094 | +2659.79€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#DOGE | 97 | +0.086 | +15.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 97 | +0.086 | +15.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1880 | +0.070 | +303.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1880 | +0.070 | +303.03€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2330 | +0.083 | +788.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2330 | +0.083 | +788.67€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2354 | +0.141 | +1145.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2354 | +0.141 | +1145.03€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 6066 | +0.118 | +2890.52€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 6066 | +0.118 | +2890.52€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1530 | +0.086 | +535.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1530 | +0.086 | +535.33€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1481 | +0.086 | +584.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1481 | +0.086 | +584.52€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1350 | +0.217 | +1114.85€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1350 | +0.217 | +1114.85€ | 0 | 13 |
...
| ✅ GBM_LATE_15M_TARDIO | 6056 | +0.066 | +1642.30€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 6056 | +0.066 | +1642.30€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#DOGE | 90 | +0.163 | +36.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 90 | +0.163 | +36.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1432 | +0.018 | +112.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1432 | +0.018 | +112.97€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1394 | +0.024 | +255.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1394 | +0.024 | +255.81€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1652 | +0.163 | +1006.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1652 | +0.163 | +1006.51€ | 0 | 13 |
| ✅ GBM_LATE_5M | 906 | -0.037 | -8.36€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 906 | -0.037 | -8.36€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 187 | -0.045 | -12.34€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 187 | -0.045 | -12.34€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=24406 | tras_1loss IC=+0.077 n=16403 | tras_2loss IC=+0.051 n=6900/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=4743 IC=+0.077 PNL=+1006.60€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4743 IC=+0.077 PNL=+1006.60€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.208 > 0.2 con n=799 PNL=+483.85€
  - _Datos_: n=799 IC=+0.208 PNL=+483.85€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.129 > 0.08 con n=793 PNL=+392.28€
  - _Datos_: n=793 IC=+0.129 PNL=+392.28€
