# Hipótesis automáticas — 2026-07-04 07:50 UTC
_Generado por shadow_postmortem.py sobre 3406 resoluciones (PNL=+33.59€)_
...
- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.174 (n=90)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0093 (IC base=+0.026)

- **PATRÓN** `ibs_15` < `0.0563` → IC=+0.138 (n=67)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.0563 (IC base=+0.026)
...
- **FILTRO** `delta_ratio_macro` |x|≤ `0.068` → IC=-0.152 (n=44)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.068
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.141 (n=51)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0089 (IC base=+0.073)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.145 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 7.0 (IC base=+0.073)

- **PATRÓN** `ibs_15` < `0.0878` → IC=+0.182 (n=42)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` < 0.0878 (IC base=+0.073)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0878 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.182 n=42). Confirma señal de reversión media → alinear con BUY_YES.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 663 | +0.086 | +135.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 663 | +0.086 | +135.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 172 | +0.040 | +15.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 172 | +0.040 | +15.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 174 | +0.023 | +6.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 174 | +0.023 | +6.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 168 | +0.129 | +54.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 168 | +0.129 | +54.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 149 | +0.162 | +58.58€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 149 | +0.162 | +58.58€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M | 1533 | +0.012 | +10.14€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1397 | +0.007 | -2.45€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 267 | -0.028 | -9.70€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 267 | -0.028 | -9.70€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 301 | +0.041 | +10.30€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 301 | +0.041 | +10.30€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 908 | -0.043 | -58.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 675 | -0.023 | -29.94€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 372 | -0.016 | +0.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 287 | -0.002 | +7.58€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.047) — sin ventaja clara. oversold(IBS<0.3): IC=-0.024 n=185 | neutral: IC=-0.071 n=152 | overbought(IBS>0.7): IC=-0.052 n=161
  - _Datos_: n=518 IC=-0.044 PNL=-33.01€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.227 n=31 PNL=-17.74€ → FILTRAR | H=02h: IC=-0.154 n=24 PNL=-5.23€ → FILTRAR | H=03h: IC=-0.113 n=19 PNL=-5.87€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.167 n=25 PNL=+7.36€ → BOOST | H=20h: IC=-0.167 n=28 PNL=-9.59€ → FILTRAR

**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  - _Umbral_: n≥200 por par con delta_ratio feature en shadow
  - _Acción_: Añadir DELTA_MIN/MAX por par dict en shadow_predict.py
  - _Estado_: BTC: 163 ops con delta_ratio | SOL: 200 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.018 n=1661 | tras_1loss IC=-0.018 n=1640 | tras_2loss IC=-0.038 n=833/40 | gap=+0.056 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=785 IC=-0.039 PNL=-44.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=785 IC=-0.039 PNL=-44.69€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=405 IC=-0.055 PNL=-48.42€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=405 IC=-0.055 PNL=-48.42€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=295 IC=-0.022 PNL=-34.23€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=295 IC=-0.022 PNL=-34.23€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=249 IC=-0.002 PNL=+2.14€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=249 IC=-0.002 PNL=+2.14€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 5/40 ops en el filtro definido (IC actual=-0.018 PNL=-2.18€)
  - _Datos_: n=5 IC=-0.018 PNL=-2.18€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=973 IC=+0.053 PNL=+119.15€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=973 IC=+0.053 PNL=+119.15€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=55 IC=-0.026 PNL=-9.90€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=55 IC=-0.026 PNL=-9.90€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.077 < -0.05 con n=547 PNL=-76.34€
  - _Datos_: n=547 IC=-0.077 PNL=-76.34€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 73/120 ops en el filtro definido (IC actual=+0.127 PNL=+12.84€)
  - _Datos_: n=73 IC=+0.127 PNL=+12.84€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=70 IC=-0.042 PNL=+10.93€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=70 IC=-0.042 PNL=+10.93€
