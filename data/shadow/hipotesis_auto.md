# Hipótesis automáticas — 2026-07-28 03:55 UTC
_Generado por shadow_postmortem.py sobre 39501 resoluciones (PNL=+8015.46€)_
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.187 (n=1228)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.190 (n=2782)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.205 (n=577)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.185 (n=1203)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0075 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.159 (n=1687)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 7.0 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.2777` → IC=+0.191 (n=496)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.2777 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.463` → IC=+0.230 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.463 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.138 (n=456)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0077 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.146 (n=309)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 12.0 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.1858` → IC=+0.154 (n=163)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.1858 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.625` → IC=+0.259 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.625 (IC base=+0.109)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.0177` → IC=+0.246 (n=419)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `dist_vwap_pct` > `0.4614` → IC=+0.285 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4614 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.585` → IC=+0.347 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.585 (IC base=+0.228)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.127 (n=802)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6075` → IC=+0.176 (n=637)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.106` → IC=+0.154 (n=229)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 5.106 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` > `0.9997` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.9997 (IC base=+0.049)
...
- **PATRÓN** `ibs_15` > `0.67` → IC=+0.196 (n=205)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.98€ cuando `ibs_15` > 0.67 (IC base=+0.046)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.232` → IC=+0.145 (n=60)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 6.232 (IC base=+0.046)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.143 (n=138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 13.0 (IC base=+0.079)

- **PATRÓN** `ibs_15` < `0.037` → IC=+0.144 (n=71)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` < 0.037 (IC base=+0.079)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6075 sube el IC de +0.056 a +0.176 en UPDOWN_GBM#15min (n=637). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.67 sube el IC de +0.046 a +0.196 en UPDOWN_GBM#ETH#15min (n=205). Ya aplicado como kelly_boost=+0.98€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1412 | +0.097 | +29.71€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1412 | +0.097 | +29.71€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 527 | +0.118 | +11.43€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 527 | +0.118 | +11.43€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 6868 | +0.177 | -49.67€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4528 | +0.201 | -43.88€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 2029 | +0.182 | -13.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1511 | +0.197 | -50.89€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 8486 | +0.093 | +2527.94€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8486 | +0.093 | +2527.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 24 | +0.154 | +2.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 24 | +0.154 | +2.81€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5724 | +0.114 | +2610.82€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5724 | +0.114 | +2610.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 19 | +0.204 | +12.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 19 | +0.204 | +12.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1490 | +0.083 | +500.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1490 | +0.083 | +500.98€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1423 | +0.081 | +534.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1423 | +0.081 | +534.79€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1283 | +0.214 | +1044.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1283 | +0.214 | +1044.37€ | 0 | 10 |
...
| ✅ GBM_LATE_15M_TARDIO | 5713 | +0.064 | +1468.46€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5713 | +0.064 | +1468.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 23 | +0.220 | +9.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 23 | +0.220 | +9.23€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2935 | +0.036 | +268.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2671 | +0.052 | +307.25€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#ETH | 1110 | +0.040 | +77.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1016 | +0.053 | +89.33€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#XRP | 336 | +0.050 | +45.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 325 | +0.060 | +49.07€ | 4 | 2 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2204 | +0.150 | +957.96€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2204 | +0.150 | +957.96€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 421 | +0.164 | +153.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 421 | +0.164 | +153.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 520 | +0.086 | +129.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 520 | +0.086 | +129.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 617 | +0.166 | +359.18€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 617 | +0.166 | +359.18€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.163: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.073 n=1681 | neutral: IC=+0.023 n=1335 | overbought(IBS>0.7): IC=+0.186 n=1644
  - _Datos_: n=4966 IC=+0.103 PNL=+1291.62€
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 187 ops con delta_ratio | SOL: 231 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.109 n=23448 | tras_1loss IC=+0.077 n=15838 | tras_2loss IC=+0.052 n=6657/40 | gap=+0.058 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=108 IC=+0.082 PNL=+13.90€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=108 IC=+0.082 PNL=+13.90€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=2798 IC=+0.040 PNL=+282.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2798 IC=+0.040 PNL=+282.02€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1125 IC=+0.056 PNL=+154.86€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1125 IC=+0.056 PNL=+154.86€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=1412 PNL=+245.11€
  - _Datos_: n=1412 IC=+0.091 PNL=+245.11€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1478 IC=+0.040 PNL=+118.39€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1478 IC=+0.040 PNL=+118.39€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3219 IC=+0.054 PNL=+360.02€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3219 IC=+0.054 PNL=+360.02€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1275 IC=+0.032 PNL=+124.31€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1275 IC=+0.032 PNL=+124.31€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.1 con n=1018 PNL=+345.71€
  - _Datos_: n=1018 IC=+0.162 PNL=+345.71€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=288 IC=+0.079 PNL=+52.40€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=288 IC=+0.079 PNL=+52.40€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.122 > 0.08 con n=721 PNL=+201.11€
  - _Datos_: n=721 IC=+0.122 PNL=+201.11€
