# Hipótesis automáticas — 2026-08-27 04:29 UTC
_Generado por shadow_postmortem.py sobre 170236 resoluciones (PNL=+12310.52€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.28` → IC=-0.286 (n=2363)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.28
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=7090)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `146.13` → IC=-0.205 (n=293)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.13
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=882)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `concentracion_yes` < `1.0` → IC=-0.122 (n=125)

  - _Acción_: SKIP cuando `concentracion_yes` < 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=560)

- **FILTRO** `n_ballenas` < `6.0` → IC=-0.175 (n=167)

  - _Acción_: SKIP cuando `n_ballenas` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=518)

- **FILTRO** `restante_s_al_confirmar` < `390.04` → IC=-0.280 (n=171)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 390.04
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=514)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `97.38` → IC=-0.429 (n=292)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 97.38
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=876)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `158.96` → IC=-0.186 (n=641)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.96
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1925)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `154.41` → IC=-0.261 (n=554)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.41
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1664)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `117.53` → IC=-0.384 (n=410)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 117.53
  - _Potencial_: sin este filtro IC_bueno=-0.143 (n=1231)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.188 (n=5331)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=1571)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2382.8902` → IC=+0.173 (n=1516)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.158 (n=4217)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 7.0 (IC base=+0.141)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.259 (n=3278)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=2918)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1859.5289` → IC=+0.182 (n=2439)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 1859.5289 (IC base=+0.141)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.209 (n=776)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.192 (n=433)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 11.0 (IC base=+0.185)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.292 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=810)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.01 (IC base=+0.185)

- **PATRÓN** `libro_liquidez` > `12171.7502` → IC=+0.216 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12171.7502 (IC base=+0.185)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.136 (n=459)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 15.0 (IC base=+0.118)

- **PATRÓN** `py_entrada` > `0.555` → IC=+0.139 (n=535)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.127 (n=1021)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.285 (n=467)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.283)

- **PATRÓN** `py_entrada` < `0.195` → IC=+0.419 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.195 (IC base=+0.283)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.283 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `2882.5134` → IC=+0.293 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2882.5134 (IC base=+0.283)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.194 (n=628)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 12.0 (IC base=+0.190)

- **PATRÓN** `py_entrada` > `0.84` → IC=+0.445 (n=306)
...
- **PATRÓN** `py_entrada` < `0.245` → IC=+0.336 (n=273)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.223)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.232 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `2052.8376` → IC=+0.249 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2052.8376 (IC base=+0.223)
...
- **PATRÓN** `py_entrada` < `0.355` → IC=+0.205 (n=208)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.190 (n=3802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.185)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.199 (n=2146)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.178 (n=975)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 15.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.72` → IC=+0.174 (n=972)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.165 (n=962)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.229 (n=866)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.182 (n=936)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.273 (n=1387)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.164 (n=1470)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 12.0 (IC base=+0.163)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.213 (n=713)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.288 (n=674)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.247 (n=1167)
...
- **PATRÓN** `restante_min` < `4.42` → IC=+0.127 (n=980)

  - _Acción_: Kelly boost +0.64€ cuando `restante_min` < 4.42 (IC base=+0.126)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.161 (n=785)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.137 (n=971)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 7.0 (IC base=+0.126)

- **PATRÓN** `lag_apertura_s` < `3.5` → IC=+0.160 (n=737)

  - _Acción_: Kelly boost +0.80€ cuando `lag_apertura_s` < 3.5 (IC base=+0.126)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9487` → IC=+0.206 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9487 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.1937` → IC=+0.231 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1937 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.212` → IC=+0.169 (n=907)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.212 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` < `0.6324` → IC=+0.221 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6324 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.0608` → IC=+0.242 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0608 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.31` → IC=+0.155 (n=172)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.31 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `2.4442` → IC=+0.141 (n=1055)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.4442 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.2133` → IC=+0.132 (n=1514)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2133 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.2933` → IC=+0.146 (n=769)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.2933 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.6337` → IC=+0.157 (n=246)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6337 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `1.0596` → IC=+0.146 (n=334)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.0596 (IC base=+0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.3026` → IC=+0.264 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3026 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` < `1.6234` → IC=+0.194 (n=351)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.6234 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` > `2.929` → IC=+0.230 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.929 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `228.0` → IC=+0.216 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 228.0 (IC base=+0.031)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.161 (n=240)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1496` → IC=+0.133 (n=118)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.1496 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.294 (n=178)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1518` → IC=+0.321 (n=177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1518 (IC base=+0.274)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.276 (n=248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.274)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.287 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.274)

- **PATRÓN** `ibs_20min` < `0.4375` → IC=+0.313 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4375 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.311 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.939 (IC base=+0.274)

- **PATRÓN** `volumen_pendiente_norm` < `0.0561` → IC=+0.300 (n=138)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8119` → IC=+0.298 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8119 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` > `2.6427` → IC=+0.304 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6427 (IC base=+0.274)
...
- **PATRÓN** `libro_liquidez` > `1985.6048` → IC=+0.300 (n=88)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1985.6048 (IC base=+0.274)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.288 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.274)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.241 (n=164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3344` → IC=+0.214 (n=327)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3344 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.233 (n=373)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.206)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.205 (n=327)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.206)

- **PATRÓN** `ibs_20min` > `0.4187` → IC=+0.221 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4187 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.2143` → IC=+0.231 (n=240)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3527` → IC=+0.254 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3527 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `11295.2956` → IC=+0.215 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11295.2956 (IC base=+0.206)

- **PATRÓN** `ballena_activa_n` < `369.0` → IC=+0.202 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 369.0 (IC base=+0.206)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.188 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0022 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.151 (n=448)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 18.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.5892` → IC=+0.168 (n=426)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.5892 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1382` → IC=+0.169 (n=361)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1382 (IC base=+0.141)
...
- **PATRÓN** `volumen_regimen` < `0.6283` → IC=+0.181 (n=142)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6283 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.025` → IC=+0.146 (n=193)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.025 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.094` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.094 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `1.7479` → IC=+0.177 (n=215)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.7479 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4188` → IC=+0.161 (n=322)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.4188 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.142 (n=549)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `14231.3167` → IC=+0.188 (n=142)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 14231.3167 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `228.0` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 228.0 (IC base=+0.141)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.0944` → IC=+0.135 (n=195)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.0944 (IC base=+0.132)
...
- **PATRÓN** `libro_liquidez` > `1917.6878` → IC=+0.145 (n=201)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 1917.6878 (IC base=+0.132)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.293 (n=143)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.264)

- **PATRÓN** `drift_60min` |x|≤ `0.1271` → IC=+0.285 (n=142)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1271 (IC base=+0.264)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.277 (n=218)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.264)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.269 (n=336)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.264)

- **PATRÓN** `ibs_20min` < `0.5146` → IC=+0.300 (n=323)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.696` → IC=+0.264 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.696 (IC base=+0.264)
...
- **PATRÓN** `volumen_spike_ratio` < `3.6549` → IC=+0.232 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.6549 (IC base=+0.264)

- **PATRÓN** `volumen_spike_ratio` > `2.0113` → IC=+0.235 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0113 (IC base=+0.264)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.280 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.264)

- **PATRÓN** `ballena_activa_n` < `46.0` → IC=+0.226 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 46.0 (IC base=+0.264)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=63)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=728)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5459` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5459 (IC base=-0.051)

- **PATRÓN** `volumen_spike_ratio` > `2.1413` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1413 (IC base=-0.051)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 142.0 (IC base=-0.051)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.935` → IC=-0.156 (n=274)
...
- **FILTRO** `drift_60min` |x|> `0.5186` → IC=-0.152 (n=225)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5186
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=439)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.158 (n=118)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=546)

- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.173 (n=289)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.649` → IC=-0.151 (n=193)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=967)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.133 (n=1276)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0075 (IC base=+0.053)

- **PATRÓN** `ibs_20min` > `0.9449` → IC=+0.246 (n=937)
...
- **PATRÓN** `volumen_regimen` > `1.0166` → IC=+0.192 (n=439)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.0166 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` < `0.115` → IC=+0.168 (n=1255)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` < 0.115 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` > `0.2482` → IC=+0.205 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2482 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` < `1.4785` → IC=+0.197 (n=430)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.4785 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `2.8381` → IC=+0.171 (n=430)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.8381 (IC base=+0.053)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.266 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.053)

- **PATRÓN** `ibs_20min` < `0.0939` → IC=+0.185 (n=1190)
...
- **PATRÓN** `dist_vwap_pct` < `0.2092` → IC=+0.206 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2092 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `1.2342` → IC=+0.234 (n=250)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3757` → IC=+0.294 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3757 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.265 (n=466)
...
- **FILTRO** `sigma_ewma_delta_pct` > `3.507` → IC=-0.191 (n=173)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 3.507
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=580)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.193` → IC=+0.188 (n=107)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 5.193 (IC base=-0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.0542` → IC=+0.278 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0542 (IC base=-0.011)

- **PATRÓN** `volumen_spike_ratio` > `2.317` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.317 (IC base=-0.011)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8811` → IC=-0.141 (n=271)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.253 (n=156)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1441` → IC=+0.188 (n=334)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.4216` → IC=+0.179 (n=51)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.4216 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` < `2.0039` → IC=+0.192 (n=157)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.0039 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `3.5621` → IC=+0.177 (n=162)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 3.5621 (IC base=+0.180)
...
- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.354 (n=203)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.351)

- **PATRÓN** `drift_60min` |x|≤ `0.22` → IC=+0.359 (n=154)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.22 (IC base=+0.351)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.391 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.351)

- **PATRÓN** `ibs_20min` < `0.0204` → IC=+0.365 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0204 (IC base=+0.351)

- **PATRÓN** `ibs_20min` > `0.1308` → IC=+0.359 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1308 (IC base=+0.351)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.378` → IC=+0.356 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.378 (IC base=+0.351)

- **PATRÓN** `volumen_pendiente_norm` > `0.097` → IC=+0.382 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.097 (IC base=+0.351)

- **PATRÓN** `volumen_spike_ratio` < `3.3374` → IC=+0.355 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.3374 (IC base=+0.351)

- **PATRÓN** `volumen_spike_ratio` > `2.5538` → IC=+0.351 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5538 (IC base=+0.351)

- **PATRÓN** `libro_liquidez` > `1903.1828` → IC=+0.361 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1903.1828 (IC base=+0.351)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.156 (n=152)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `ibs_20min` < `0.7368` → IC=-0.125 (n=417)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4818` → IC=+0.273 (n=501)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4818 (IC base=+0.269)
...
- **PATRÓN** `dist_vwap_pct` < `0.8804` → IC=+0.275 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8804 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.746` → IC=+0.322 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.746 (IC base=+0.269)

- **PATRÓN** `volumen_regimen` > `1.2535` → IC=+0.307 (n=190)
...
- **PATRÓN** `ibs_20min` < `0.4088` → IC=+0.238 (n=2163)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4088 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.3561` → IC=+0.178 (n=1894)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3561 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.222 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.757 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` < `1.174` → IC=+0.167 (n=1745)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.174 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `0.8593` → IC=+0.173 (n=1163)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8593 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.248 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` < `1.8765` → IC=+0.179 (n=1036)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.8765 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.6258` → IC=+0.213 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6258 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `200.0` → IC=+0.183 (n=1122)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 200.0 (IC base=+0.186)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1485` → IC=+0.177 (n=94)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1485 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.5512` → IC=+0.125 (n=281)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.5512 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=237)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.272 (n=169)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.264)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.278 (n=192)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.264)

- **PATRÓN** `drift_60min` |x|≤ `0.3308` → IC=+0.305 (n=193)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3308 (IC base=+0.264)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.284 (n=179)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.264)

- **PATRÓN** `ibs_20min` < `0.0692` → IC=+0.339 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0692 (IC base=+0.264)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.436` → IC=+0.291 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.436 (IC base=+0.264)

- **PATRÓN** `volumen_spike_ratio` < `1.854` → IC=+0.309 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.854 (IC base=+0.264)

- **PATRÓN** `volumen_spike_ratio` > `2.8455` → IC=+0.322 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8455 (IC base=+0.264)
...
- **PATRÓN** `libro_liquidez` > `1981.9929` → IC=+0.348 (n=64)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1981.9929 (IC base=+0.264)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.280 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=+0.264)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.239 (n=117)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.4292` → IC=+0.181 (n=343)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.4292 (IC base=+0.180)
...
- **PATRÓN** `ibs_20min` > `0.9974` → IC=+0.279 (n=156)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9974 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` > `0.2074` → IC=+0.246 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2074 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.757` → IC=+0.236 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.757 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `1.2894` → IC=+0.187 (n=343)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 1.2894 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `0.886` → IC=+0.193 (n=229)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.886 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2178` → IC=+0.268 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2178 (IC base=+0.180)
...
- **PATRÓN** `libro_liquidez` > `12164.5258` → IC=+0.201 (n=229)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12164.5258 (IC base=+0.180)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.169 (n=436)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0055 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.29` → IC=+0.173 (n=436)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.29 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=399)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 7.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.4047` → IC=+0.187 (n=436)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.4047 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.1586` → IC=+0.176 (n=430)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1586 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.365` → IC=+0.245 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.365 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.7208` → IC=+0.222 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7208 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1012` → IC=+0.213 (n=148)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7388` → IC=+0.174 (n=219)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.7388 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `14245.6725` → IC=+0.162 (n=146)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 14245.6725 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `244.0` → IC=+0.155 (n=82)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 244.0 (IC base=+0.150)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.217 (n=118)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2288` → IC=+0.145 (n=288)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.2288 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `1.9887` → IC=+0.200 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9887 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `3.6406` → IC=+0.142 (n=132)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 3.6406 (IC base=+0.152)
...
- **PATRÓN** `libro_liquidez` > `1960.841` → IC=+0.181 (n=117)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 1960.841 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0081` → IC=+0.296 (n=199)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0081 (IC base=+0.279)

- **PATRÓN** `drift_60min` |x|≤ `0.2` → IC=+0.324 (n=151)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3046` → IC=+0.316 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3046 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.244` → IC=+0.307 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.244 (IC base=+0.279)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9918` → IC=+0.283 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9918 (IC base=+0.279)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.245 (n=108)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.243 (n=185)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.3788` → IC=+0.168 (n=417)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3788 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.185 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 17.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.343` → IC=+0.215 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.343 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.5324` → IC=+0.161 (n=488)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.5324 (IC base=+0.148)
...
- **PATRÓN** `volumen_regimen` < `1.1598` → IC=+0.161 (n=417)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1598 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.6177` → IC=+0.156 (n=417)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6177 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.0996` → IC=+0.169 (n=122)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.0996 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `1.8877` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.8877 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10039.916` → IC=+0.152 (n=139)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 10039.916 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.132 (n=202)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 196.0 (IC base=+0.148)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **FILTRO** `ibs_20min` > `0.4107` → IC=-0.194 (n=132)

  - _Acción_: SKIP cuando `ibs_20min` > 0.4107
  - _Potencial_: sin este filtro IC_bueno=+0.231 (n=400)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.200 (n=218)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.202` → IC=+0.286 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.202 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.6818` → IC=+0.140 (n=429)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6818 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.2805` → IC=+0.122 (n=72)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.2805 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` > `1.5631` → IC=+0.130 (n=401)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.5631 (IC base=+0.118)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.189 (n=133)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0097 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.208 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.4107` → IC=+0.231 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4107 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.2166` → IC=+0.142 (n=372)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.2166 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.686` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 6.686 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` > `0.8536` → IC=+0.164 (n=266)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.8536 (IC base=+0.126)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2466` → IC=+0.206 (n=90)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2466 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `2071.8704` → IC=+0.172 (n=266)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2071.8704 (IC base=+0.126)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6625` → IC=+0.236 (n=494)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `1.5891` → IC=+0.223 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5891 (IC base=+0.221)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.187 (n=276)
...
- **PATRÓN** `ibs_20min` > `0.6275` → IC=+0.154 (n=382)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.6275 (IC base=+0.085)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.273` → IC=+0.194 (n=122)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 8.273 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.1741` → IC=+0.175 (n=112)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1741 (IC base=+0.085)

- **PATRÓN** `libro_liquidez` > `2895.1692` → IC=+0.127 (n=285)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 2895.1692 (IC base=+0.085)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.169 (n=170)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0041 (IC base=+0.081)

- **PATRÓN** `drift_60min` |x|≤ `0.1997` → IC=+0.122 (n=257)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.1997 (IC base=+0.081)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.132 (n=188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 14.0 (IC base=+0.081)

- **PATRÓN** `ibs_20min` < `0.619` → IC=+0.128 (n=385)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.619 (IC base=+0.081)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.192` → IC=+0.201 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.192 (IC base=+0.081)

- **PATRÓN** `volumen_regimen` < `0.6508` → IC=+0.158 (n=118)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6508 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` < `1.852` → IC=+0.144 (n=220)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.852 (IC base=+0.081)

- **PATRÓN** `libro_liquidez` > `11319.4379` → IC=+0.157 (n=129)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 11319.4379 (IC base=+0.081)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.207 (n=1283)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9416` → IC=+0.293 (n=1282)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9416 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `1.0677` → IC=+0.255 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0677 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.349` → IC=+0.246 (n=1188)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.349 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.8796` → IC=+0.148 (n=1334)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8796 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `1.0795` → IC=+0.153 (n=908)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.0795 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1651` → IC=+0.183 (n=721)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1651 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.8684` → IC=+0.161 (n=1673)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8684 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2306)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `3920.5916` → IC=+0.191 (n=943)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 3920.5916 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `157.0` → IC=+0.189 (n=1276)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 157.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.227 (n=1682)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.4606` → IC=+0.206 (n=2521)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4606 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.202 (n=939)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.197)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.209 (n=935)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` < `0.5566` → IC=+0.253 (n=2521)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5566 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` < `0.7107` → IC=+0.185 (n=2060)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.7107 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.366` → IC=+0.225 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.366 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.646` → IC=+0.201 (n=2372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.646 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `0.6242` → IC=+0.189 (n=634)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6242 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `1.193` → IC=+0.192 (n=634)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.193 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.2812` → IC=+0.274 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2812 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.257` → IC=+0.215 (n=827)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.257 (IC base=+0.197)

- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.180 (n=1393)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 179.0 (IC base=+0.197)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.216 (n=206)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` > `2.7667` → IC=+0.350 (n=58)
...
- **PATRÓN** `libro_liquidez` > `1989.8695` → IC=+0.330 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1989.8695 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.282 (n=99)
...
- **PATRÓN** `ibs_20min` > `0.3266` → IC=+0.209 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3266 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.256` → IC=+0.246 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.256 (IC base=+0.154)
...
- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.160 (n=448)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2673 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.173 (n=203)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.181 (n=352)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.7065` → IC=+0.194 (n=266)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.7065 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `11768.8428` → IC=+0.181 (n=299)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 11768.8428 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.208 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2654` → IC=+0.183 (n=373)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.182 (n=439)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 18.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` < `0.3776` → IC=+0.220 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3776 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` < `0.7428` → IC=+0.179 (n=471)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.7428 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.638` → IC=+0.231 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.638 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `0.6259` → IC=+0.236 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6259 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `1.1856` → IC=+0.171 (n=141)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 1.1856 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.1496` → IC=+0.292 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1496 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.7452` → IC=+0.201 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7452 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `1.5054` → IC=+0.192 (n=293)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.5054 (IC base=+0.170)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=547)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `12099.1189` → IC=+0.175 (n=192)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 12099.1189 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `313.0` → IC=+0.179 (n=76)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 313.0 (IC base=+0.170)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.240 (n=171)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` > `0.7044` → IC=+0.262 (n=334)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2289` → IC=+0.185 (n=306)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2289 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` < `2.035` → IC=+0.211 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.035 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `3.686` → IC=+0.176 (n=137)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 3.686 (IC base=+0.180)
...
- **PATRÓN** `libro_liquidez` > `1917.67` → IC=+0.203 (n=170)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1917.67 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.231 (n=76)
...
- **PATRÓN** `ibs_20min` < `0.5683` → IC=+0.331 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5683 (IC base=+0.268)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3655` → IC=+0.306 (n=34)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3655 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` < `3.4029` → IC=+0.266 (n=199)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.154 (n=452)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.34` → IC=+0.200 (n=452)
...
- **PATRÓN** `volumen_regimen` < `0.6268` → IC=+0.180 (n=151)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6268 (IC base=+0.142)
...
- **PATRÓN** `libro_liquidez` > `5280.4621` → IC=+0.226 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5280.4621 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.180 (n=217)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5036` → IC=+0.167 (n=370)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.5036 (IC base=+0.157)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.184 (n=261)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 11.0 (IC base=+0.157)
...
- **PATRÓN** `dist_vwap_pct` > `0.1614` → IC=+0.165 (n=189)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1614 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` < `0.6649` → IC=+0.178 (n=395)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6649 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.36` → IC=+0.254 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.36 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` < `0.596` → IC=+0.175 (n=124)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.596 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `1.1275` → IC=+0.191 (n=124)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 1.1275 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.2305` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2305 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `2.1819` → IC=+0.193 (n=275)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.1819 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.4584` → IC=+0.181 (n=312)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4584 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `9489.0705` → IC=+0.218 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9489.0705 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.235 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=+0.157)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.171 (n=229)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0107 (IC base=+0.098)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.140 (n=345)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 12.0 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.309 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `1.0536` → IC=+0.279 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0536 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.478` → IC=+0.226 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.478 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2942.126` → IC=+0.282 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2942.126 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.171 (n=281)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 68.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.178 (n=203)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0059 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.2624` → IC=+0.142 (n=308)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.2624 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.181 (n=214)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.122)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.129 (n=165)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 5.0 (IC base=+0.122)

- **PATRÓN** `ibs_20min` < `0.5789` → IC=+0.203 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5789 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.4552` → IC=+0.141 (n=421)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4552 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.03` → IC=+0.141 (n=452)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 3.03 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `0.7055` → IC=+0.154 (n=203)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7055 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.072` → IC=+0.172 (n=126)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.072 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` > `1.7467` → IC=+0.168 (n=209)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.7467 (IC base=+0.122)
...
- **PATRÓN** `libro_liquidez` > `2599.7014` → IC=+0.170 (n=210)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2599.7014 (IC base=+0.122)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0266` → IC=+0.216 (n=199)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `1.4549` → IC=+0.288 (n=130)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.4549 (IC base=+0.172)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8201` → IC=+0.187 (n=365)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.8201 (IC base=+0.172)
...
- **PATRÓN** `libro_liquidez` > `3104.3643` → IC=+0.187 (n=199)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 3104.3643 (IC base=+0.172)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4762` → IC=+0.230 (n=569)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.217 (n=688)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` < `0.4884` → IC=+0.281 (n=646)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4884 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `1.2129` → IC=+0.225 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.2129 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.527` → IC=+0.281 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.527 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.032` → IC=+0.218 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.032 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `1.2292` → IC=+0.257 (n=216)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5474` → IC=+0.242 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5474 (IC base=+0.216)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.180 (n=360)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.153 (n=957)

- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.137 (n=417)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0097 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.160 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.8318` → IC=+0.154 (n=215)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.8318 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `1.4176` → IC=+0.194 (n=119)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 1.4176 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.261` → IC=+0.197 (n=74)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.261 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.6128` → IC=+0.152 (n=133)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6128 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.134 (n=181)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 1.0851 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.1537` → IC=+0.174 (n=136)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1537 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `2.1407` → IC=+0.134 (n=408)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.1407 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.131 (n=437)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `7860.8553` → IC=+0.150 (n=315)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7860.8553 (IC base=+0.117)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.199 (n=244)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.3549` → IC=+0.166 (n=642)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3549 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.169 (n=267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.194 (n=292)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 4.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.155 (n=642)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.6296 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.0833` → IC=+0.158 (n=729)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.0833 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.1756` → IC=+0.159 (n=309)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1756 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.3663` → IC=+0.145 (n=720)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3663 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.056` → IC=+0.157 (n=327)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 4.056 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.046` → IC=+0.150 (n=733)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.046 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.2157` → IC=+0.160 (n=715)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2157 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` < `0.0935` → IC=+0.150 (n=655)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0935 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.0712` → IC=+0.160 (n=348)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0712 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4847` → IC=+0.164 (n=722)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.4847 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.513` → IC=+0.151 (n=645)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.513 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=957)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `8486.696` → IC=+0.152 (n=729)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8486.696 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.168 (n=411)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0063 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.3507` → IC=+0.155 (n=410)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.227 (n=137)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` < `0.1706` → IC=+0.167 (n=181)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1706 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.6094` → IC=+0.177 (n=60)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.6094 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.318` → IC=+0.160 (n=415)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.318 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.1834` → IC=+0.155 (n=410)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1834 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6217` → IC=+0.150 (n=410)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6217 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.186 (n=189)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.5555` → IC=+0.162 (n=409)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.5555 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7842` → IC=+0.150 (n=272)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.7842 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `11900.5247` → IC=+0.149 (n=366)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 11900.5247 (IC base=+0.146)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_ewma_delta_pct` > `1.765` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 1.765 (IC base=+0.090)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.176 (n=223)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0097 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.4418` → IC=+0.162 (n=196)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4418 (IC base=+0.144)
...
- **PATRÓN** `ibs_20min` < `0.175` → IC=+0.162 (n=75)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.175 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.7909` → IC=+0.180 (n=101)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.7909 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `1.1418` → IC=+0.212 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1418 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.4111` → IC=+0.163 (n=188)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4111 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.126` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 11.126 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.087` → IC=+0.145 (n=187)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 3.087 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.6496` → IC=+0.188 (n=75)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6496 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.1754` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1754 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.4096` → IC=+0.207 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4096 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8856.6618` → IC=+0.187 (n=199)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 8856.6618 (IC base=+0.144)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.773` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 4.773 (IC base=+0.000)

- **PATRÓN** `volumen_pendiente_norm` > `0.0892` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0892 (IC base=+0.000)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=410)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.172 (n=796)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=2461)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.213 (n=764)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=2509)

- **FILTRO** `ibs_20min` > `0.2706` → IC=-0.172 (n=818)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2706
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=2455)
...
- **FILTRO** `ibs_20min` > `0.7424` → IC=-0.141 (n=140)
...
- **FILTRO** `py_entrada` > `0.57` → IC=-0.227 (n=130)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=417)

- **FILTRO** `ballena_activa_n` > `79.0` → IC=-0.167 (n=136)

  - _Acción_: SKIP cuando `ballena_activa_n` > 79.0
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=411)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.124 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.186 (n=208)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=280)

- **FILTRO** `ibs_20min` < `0.7289` → IC=-0.210 (n=122)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.192 (n=186)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=363)

- **FILTRO** `ibs_20min` > `0.7585` → IC=-0.198 (n=137)
...
- **FILTRO** `py_entrada` > `0.515` → IC=-0.183 (n=143)
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.150 (n=141)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=439)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` > `0.62` → IC=-0.219 (n=119)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=395)

- **FILTRO** `drift_20min_pct` |x|> `0.3785` → IC=-0.146 (n=128)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3785
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=386)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.162 (n=128)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=386)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.156 (n=126)
...
- **FILTRO** `ibs_20min` > `0.2761` → IC=-0.220 (n=130)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.143 (n=2316)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5764)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.283 (n=1931)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=6149)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.233 (n=2014)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=6066)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.174 (n=2739)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=5341)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.229 (n=2273)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=7592)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.174 (n=2466)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=7399)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.163 (n=259)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=834)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.329 (n=267)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=826)

- **FILTRO** `ibs_7min` < `0.9819` → IC=-0.201 (n=721)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9819
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=372)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.257 (n=270)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=823)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.223 (n=416)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1268)

- **FILTRO** `drift_7min_pct` |x|> `0.1386` → IC=-0.159 (n=572)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1386
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1112)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.192 (n=420)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1264)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.158 (n=343)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1245)

- **FILTRO** `py_entrada` < `0.38` → IC=-0.229 (n=396)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1192)

- **FILTRO** `ibs_7min` < `0.803` → IC=-0.164 (n=397)

  - _Acción_: SKIP cuando `ibs_7min` < 0.803
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1191)

- **FILTRO** `ballena_activa_n` > `155.0` → IC=-0.172 (n=394)

  - _Acción_: SKIP cuando `ballena_activa_n` > 155.0
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1194)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.218 (n=395)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=1225)

- **FILTRO** `ballena_activa_n` > `131.0` → IC=-0.169 (n=403)

  - _Acción_: SKIP cuando `ballena_activa_n` > 131.0
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1217)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.197 (n=282)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=865)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.315 (n=370)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=777)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.281 (n=286)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=861)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.276 (n=284)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=863)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.262 (n=364)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1355)

- **FILTRO** `ibs_7min` > `0.8179` → IC=-0.189 (n=429)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8179
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1290)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.151 (n=414)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=955)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.262 (n=317)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=1052)

- **FILTRO** `ibs_7min` < `0.7615` → IC=-0.182 (n=341)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7615
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=1028)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.217 (n=334)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=1035)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.133 (n=456)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=903)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.279 (n=333)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1026)

- **FILTRO** `ibs_7min` > `0.1818` → IC=-0.166 (n=462)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1818
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=897)

- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.204 (n=339)

  - _Acción_: SKIP cuando `ballena_activa_n` > 37.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=1020)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.41` → IC=-0.234 (n=378)

  - _Acción_: SKIP cuando `py_entrada` < 0.41
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=1163)

- **FILTRO** `ibs_7min` < `0.7763` → IC=-0.198 (n=385)
...
- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.192 (n=374)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1167)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.184 (n=448)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1376)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.123 (n=433)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=909)

- **FILTRO** `py_entrada` < `0.39` → IC=-0.273 (n=328)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1014)

- **FILTRO** `ibs_7min` < `0.7544` → IC=-0.209 (n=335)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7544
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1007)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.236 (n=320)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1022)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.273 (n=337)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=1322)

- **FILTRO** `ibs_7min` > `0.83` → IC=-0.161 (n=414)

  - _Acción_: SKIP cuando `ibs_7min` > 0.83
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1245)
...
- **PATRÓN** `delta_ratio` |x|> `0.4498` → IC=+0.184 (n=93)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `delta_ratio` |x|> 0.4498 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.157 (n=97)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.126)

- **PATRÓN** `total_vol_5m` < `411.7048` → IC=+0.227 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 411.7048 (IC base=+0.126)
...
- **PATRÓN** `libro_liquidez` > `3589.6144` → IC=+0.176 (n=69)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3589.6144 (IC base=+0.126)
...
- **PATRÓN** `delta_ratio` |x|> `0.4028` → IC=+0.134 (n=39)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.67€ cuando `delta_ratio` |x|> 0.4028 (IC base=+0.067)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.134 (n=39)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 15.0 (IC base=+0.067)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.067)

- **PATRÓN** `libro_liquidez` > `3436.4906` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3436.4906 (IC base=+0.067)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.134 (n=151)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 14.0 (IC base=+0.071)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=1166)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=666)
...
- **PATRÓN** `ibs_15` < `0.1143` → IC=+0.138 (n=432)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.1143 (IC base=+0.028)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.127 (n=175)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0053 (IC base=+0.016)
...
- **FILTRO** `drift_15min` |x|> `0.5513` → IC=-0.170 (n=104)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.5513
...
- **FILTRO** `sigma_h` > `0.0094` → IC=-0.149 (n=246)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0094
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=739)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.262` → IC=-0.174 (n=342)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2455)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3433` → IC=+0.142 (n=132)

  - _Acción_: Kelly boost +0.71€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3433 (IC base=-0.058)

- **PATRÓN** `ibs_15` > `0.4545` → IC=+0.162 (n=294)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` > 0.4545 (IC base=-0.058)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1369` → IC=+0.271 (n=94)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1369 (IC base=-0.077)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0898` → IC=+0.364 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0898 (IC base=-0.077)

- **PATRÓN** `ibs_15` < `0.3247` → IC=+0.347 (n=142)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3247 (IC base=-0.077)

- **PATRÓN** `dist_vwap_pct` < `0.1185` → IC=+0.276 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1185 (IC base=-0.077)

- **PATRÓN** `ballena_activa_n` < `141.0` → IC=+0.298 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 141.0 (IC base=-0.077)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1045` → IC=+0.278 (n=61)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1045 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.303 (n=59)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.2338` → IC=+0.258 (n=60)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2338 (IC base=+0.258)

- **PATRÓN** `drift_15min` |x|≤ `0.4361` → IC=+0.281 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4361 (IC base=+0.258)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0962` → IC=+0.281 (n=80)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0962 (IC base=+0.258)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1036` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1036 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.294 (n=32)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.258)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.281 (n=30)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.258)

- **PATRÓN** `ibs_15` < `0.3345` → IC=+0.346 (n=89)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3345 (IC base=+0.258)

- **PATRÓN** `dist_vwap_pct` > `0.1514` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1514 (IC base=+0.258)

- **PATRÓN** `dist_vwap_pct` < `0.3293` → IC=+0.262 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3293 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.326` → IC=+0.287 (n=92)
...
- **PATRÓN** `ballena_activa_n` < `207.0` → IC=+0.287 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 207.0 (IC base=+0.258)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `drift_60min` |x|> `0.1589` → IC=-0.159 (n=80)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4545 sube el IC de -0.058 a +0.162 en UPDOWN_GBM_15M_TARDIO (n=294). Ya aplicado como kelly_boost=+0.81€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3247 sube el IC de -0.077 a +0.347 en UPDOWN_GBM_15M_TARDIO (n=142). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.