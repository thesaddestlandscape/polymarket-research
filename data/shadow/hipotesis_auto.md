# Hipótesis automáticas — 2026-07-02 04:14 UTC
_Generado por shadow_postmortem.py sobre 2531 resoluciones (PNL=-90.20€)_
...
- **PATRÓN** `ibs_15` < `0.0714` → IC=+0.244 (n=41)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0714 (IC base=+0.065)
...
| ✅ UPDOWN_GBM | 778 | -0.036 | -39.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 556 | -0.011 | -12.57€ | 2 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.079) — sin ventaja clara. oversold(IBS<0.3): IC=+0.016 n=122 | neutral: IC=-0.063 n=117 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=388 IC=-0.031 PNL=-14.28€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1194 | tras_1loss IC=-0.038 n=1255 | tras_2loss IC=-0.052 n=656/40 | gap=+0.054 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=655 IC=-0.030 PNL=-25.96€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=655 IC=-0.030 PNL=-25.96€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=173 IC=+0.037 PNL=+15.29€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=173 IC=+0.037 PNL=+15.29€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 114/200 ops en el filtro definido (IC actual=+0.026 PNL=+2.72€)
  - _Datos_: n=114 IC=+0.026 PNL=+2.72€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=114 IC=+0.026 PNL=+2.72€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=114 IC=+0.026 PNL=+2.72€
