# Hipótesis automáticas — 2026-08-07 15:01 UTC
_Generado por shadow_postmortem.py sobre 86825 resoluciones (PNL=+13643.91€)_
...
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.189 (n=2272)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0066 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.1064` → IC=+0.258 (n=31)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1064 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.156 (n=3184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 7.0 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.2919` → IC=+0.172 (n=814)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.2919 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.013` → IC=+0.244 (n=1288)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.013 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `2045.0175` → IC=+0.152 (n=3049)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2045.0175 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.166 (n=2747)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0047 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0966` → IC=+0.217 (n=58)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0966 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.152 (n=2071)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.6141` → IC=+0.150 (n=321)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.6141 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.814` → IC=+0.168 (n=727)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.814 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.846` → IC=+0.148 (n=2535)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 2.846 (IC base=+0.147)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.36` → IC=+0.168 (n=287)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 4.36 (IC base=+0.106)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.489` → IC=+0.167 (n=166)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 9.489 (IC base=+0.076)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.225 (n=757)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.213 (n=762)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.0` → IC=+0.336 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.0 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.195 (n=702)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.01 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `3148.2286` → IC=+0.195 (n=231)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 3148.2286 (IC base=+0.197)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.240 (n=768)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.1576` → IC=+0.333 (n=22)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1576 (IC base=+0.228)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.255 (n=528)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.228)

- **PATRÓN** `dist_vwap_pct` > `0.8135` → IC=+0.353 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8135 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.194` → IC=+0.242 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.194 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.632` → IC=+0.223 (n=702)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.632 (IC base=+0.228)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.245 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.228)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.360 (n=55)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.273)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.269 (n=37)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.273)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.308 (n=50)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.273)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.814` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.814 (IC base=+0.273)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.265` → IC=+0.342 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.265 (IC base=+0.273)

- **PATRÓN** `libro_liquidez` > `1203.7602` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1203.7602 (IC base=+0.273)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.241 (n=110)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.0966` → IC=+0.220 (n=80)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0966 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.277 (n=83)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.695` → IC=+0.233 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.695 (IC base=+0.185)

- **PATRÓN** `libro_liquidez` > `1363.5326` → IC=+0.208 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1363.5326 (IC base=+0.185)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.133 (n=47)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0031 (IC base=+0.094)

- **PATRÓN** `drift_60min` |x|≤ `0.0563` → IC=+0.167 (n=16)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0563 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.167 (n=31)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 11.0 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.058` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 6.058 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `3504.9965` → IC=+0.125 (n=46)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 3504.9965 (IC base=+0.094)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.230 (n=35)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0037 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.224 (n=27)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 10.0 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.069` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.069 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.759` → IC=+0.154 (n=24)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 3.759 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.241 (n=25)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 13.0 (IC base=+0.077)

- **PATRÓN** `libro_liquidez` > `1521.1726` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1521.1726 (IC base=+0.077)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.327 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.294)

- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.308 (n=50)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0066 (IC base=+0.294)

- **PATRÓN** `drift_60min` |x|≤ `0.1353` → IC=+0.289 (n=17)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1353 (IC base=+0.294)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.350 (n=18)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.294)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.987` → IC=+0.304 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.987 (IC base=+0.294)

- **PATRÓN** `libro_liquidez` > `1592.3808` → IC=+0.280 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1592.3808 (IC base=+0.294)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.327 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.281)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.327 (n=131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.281)

- **PATRÓN** `dist_vwap_pct` > `0.3725` → IC=+0.300 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3725 (IC base=+0.281)

- **PATRÓN** `dist_vwap_pct` < `0.0981` → IC=+0.285 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0981 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.768` → IC=+0.386 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.768 (IC base=+0.281)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.300 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `3169.1987` → IC=+0.304 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3169.1987 (IC base=+0.281)
...
- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.227 (n=20)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.234 (n=62)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.759` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.759 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.653` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` < 3.653 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.217 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `1963.7442` → IC=+0.194 (n=60)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 1963.7442 (IC base=+0.167)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.126 (n=2278)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` > 0.007 (IC base=+0.098)

- **PATRÓN** `drift_60min` |x|≤ `0.1213` → IC=+0.194 (n=34)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.1213 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.985` → IC=+0.214 (n=1226)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.985 (IC base=+0.098)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `10.966` → IC=+0.174 (n=133)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 10.966 (IC base=+0.068)
...
- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.187 (n=916)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0065 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.196 (n=629)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 12.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.180 (n=329)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 6.0 (IC base=+0.176)

- **PATRÓN** `dist_vwap_pct` > `0.7531` → IC=+0.274 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7531 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.189 (n=805)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.184 (n=17)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 14.0 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.1329` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1329 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.546` → IC=+0.154 (n=24)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 3.546 (IC base=+0.134)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.463` → IC=+0.162 (n=75)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 6.463 (IC base=+0.011)
...
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.145 (n=74)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0046 (IC base=+0.013)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.379` → IC=+0.229 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.379 (IC base=+0.013)
...
- **FILTRO** `sigma_ewma_delta_pct` < `4.185` → IC=-0.265 (n=15)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` < 4.185
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.185` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.185 (IC base=+0.029)
...
- **FILTRO** `liq_usd_total` < `6139.08` → IC=-0.214 (n=19)

  - _Acción_: SKIP cuando `liq_usd_total` < 6139.08
...
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.121 (n=175)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0036 (IC base=+0.102)
...
- **PATRÓN** `ibs_15` > `0.6644` → IC=+0.192 (n=219)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.96€ cuando `ibs_15` > 0.6644 (IC base=+0.058)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.056` → IC=+0.158 (n=74)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 7.056 (IC base=+0.058)

- **PATRÓN** `sigma_h` < `0.005` → IC=+0.165 (n=168)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.005 (IC base=+0.080)
...
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.134 (n=159)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0074 (IC base=+0.117)
...
- **PATRÓN** `ibs_15` < `0.0448` → IC=+0.143 (n=82)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.71€ cuando `ibs_15` < 0.0448 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `3035.0793` → IC=+0.158 (n=71)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3035.0793 (IC base=+0.117)

### UPDOWN_GBM_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.158 (n=1057)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0056 (IC base=+0.148)
...
- **PATRÓN** `sigma_h` < `0.0079` → IC=+0.186 (n=955)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0079 (IC base=+0.177)

- **PATRÓN** `drift_60min` |x|≤ `0.2167` → IC=+0.169 (n=599)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.2167 (IC base=+0.177)

- **PATRÓN** `drift_15min` |x|≤ `0.4196` → IC=+0.198 (n=299)

  - _Acción_: Kelly boost +0.99€ cuando `drift_15min` |x|≤ 0.4196 (IC base=+0.177)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.173 (n=325)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 17.0 (IC base=+0.177)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.169 (n=618)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 12.0 (IC base=+0.177)

- **PATRÓN** `ibs_15` < `0.4444` → IC=+0.238 (n=906)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.4444 (IC base=+0.177)

- **PATRÓN** `dist_vwap_pct` > `0.2003` → IC=+0.191 (n=208)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.2003 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.539` → IC=+0.194 (n=119)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 19.539 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.443` → IC=+0.188 (n=885)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 7.443 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=921)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.177)

- **PATRÓN** `libro_liquidez` > `3994.029` → IC=+0.174 (n=299)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3994.029 (IC base=+0.177)
...
- **FILTRO** `sigma_h` < `0.0044` → IC=-0.158 (n=77)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0044
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=78)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.169 (n=122)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0037 (IC base=+0.149)

- **PATRÓN** `sigma_h` > `0.003` → IC=+0.148 (n=163)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.003 (IC base=+0.149)
...
- **PATRÓN** `dist_vwap_pct` > `0.2256` → IC=+0.203 (n=62)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2256 (IC base=+0.149)
...
- **PATRÓN** `drift_15min` |x|≤ `0.5515` → IC=+0.179 (n=26)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `drift_15min` |x|≤ 0.5515 (IC base=-0.086)

- **PATRÓN** `ibs_15` < `0.5537` → IC=+0.139 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.5537 (IC base=-0.086)

- **PATRÓN** `libro_liquidez` > `9476.9221` → IC=+0.122 (n=35)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 9476.9221 (IC base=-0.086)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.178 (n=85)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0064 (IC base=+0.123)
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.333 (n=94)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.229 (n=153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0069 (IC base=+0.212)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.213 (n=305)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0088 (IC base=+0.212)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1689` → IC=+0.185 (n=195)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.93€ cuando `delta_ratio_macro` |x|> 0.1689 (IC base=+0.212)
...
- **PATRÓN** `ibs_15` < `0.3571` → IC=+0.267 (n=256)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3571 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` > `0.7875` → IC=+0.271 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7875 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.21` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 20.21 (IC base=+0.212)
...
- **PATRÓN** `libro_liquidez` > `2792.8241` → IC=+0.191 (n=260)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2792.8241 (IC base=+0.212)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6644 sube el IC de +0.058 a +0.192 en UPDOWN_GBM#ETH#15min (n=219). Ya aplicado como kelly_boost=+0.96€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.4444 sube el IC de +0.177 a +0.238 en UPDOWN_GBM_15M_TARDIO (n=906). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3571 sube el IC de +0.212 a +0.267 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=256). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#XRP#15min` — IC=+0.150 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min` — IC=+0.382 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC` — IC=+0.382 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH#15min` — IC=+0.412 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH` — IC=+0.412 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1729 | +0.046 | -41.06€ | 0 | 4 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1729 | +0.046 | -41.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 778 | +0.014 | -51.33€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 778 | +0.014 | -51.33€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS | 1742 | -0.077 | -272.06€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 366 | +0.190 | -48.84€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 1376 | -0.148 | -223.22€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB | 313 | -0.319 | -78.42€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB#5min | 313 | -0.319 | -78.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC |
 | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 519 | +0.103 | +155.30€ | 3 | 4 |
| 🚫 UPDOWN_GBM#XRP#5min | 11 | -0.106 | -3.29€ | 0 | 0 |
| 🚫 UPDOWN_GBM#daily | 45 | -0.202 | +1.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 299 | +0.307 | +60.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 299 | +0.307 | +60.86€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 147 | +0.305 | +29.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 147 | +0.305 | +29.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 152 | +0.305 | +31.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 152 | +0.305 | +31.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 3478 | +0.164 | +1804.41€ | 0 | 20 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3478 | +0.164 | +1804.41€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 398 | +0.058 | +57.53€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 398 | +0.058 | +57.53€ | 2 | 12 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 366 | +0.196 | +242.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 366 | +0.196 | +242.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 618 | +0.192 | +274.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 618 | +0.192 | +274.62€ | 1 | 14 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 693 | +0.106 | +231.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 693 | +0.106 | +231.12€ | 2 | 13 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1023 | +0.197 | +716.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1023 | +0.197 | +716.27€ | 0 | 20 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 126 | +0.266 | +72.54€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 126 | +0.266 | +72.54€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 67 | +0.239 | +27.92€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 67 | +0.239 | +27.92€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 59 | +0.287 | +44.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 59 | +0.287 | +44.62€ | 0 | 0 |
| ✅ UPDOWN_OU_5M | 294 | -0.172 | -52.51€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#5min | 294 | -0.172 | -52.51€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB | 54 | -0.179 | -11.04€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB#5min | 54 | -0.179 | -11.04€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BTC | 23 | -0.180 | -3.88€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BTC#5min | 23 | -0.180 | -3.88€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#DOGE | 51 | -0.141 | -8.00€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#DOGE#5min | 51 | -0.141 | -8.00€ | 0 | 0 |
| 🚫 UPDOWN_OU_5M#ETH | 33 | -0.214 | -6.08€ | 0 | 0 |
| 🚫 UPDOWN_OU_5M#ETH#5min | 33 | -0.214 | -6.08€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#SOL | 57 | -0.178 | -10.41€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#SOL#5min | 57 | -0.178 | -10.41€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#XRP | 76 | -0.141 | -13.11€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#XRP#5min | 76 | -0.141 | -13.11€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.158: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.115 n=2513 | neutral: IC=+0.044 n=1958 | overbought(IBS>0.7): IC=+0.202 n=2482
  - _Datos_: n=7413 IC=+0.130 PNL=+2531.70€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.162 n=131 PNL=+61.09€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=12h: IC=+0.151 n=173 PNL=+57.67€ → BOOST | H=14h: IC=+0.135 n=176 PNL=+58.38€ → BOOST | H=16h: IC=+0.111 n=165 PNL=+42.79€ → BOOST | H=21h: IC=+0.109 n=154 PNL=+31.81€ → BOOST | H=22h: IC=+0.168 n=188 PNL=+61.92€ → BOOST
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 34 celda(s) pasan gate riguroso completo de 152 evaluadas (n>=40) y 302 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.047 < 0.08 — monitorear
  - _Datos_: n=420 IC=+0.047 PNL=+55.82€

**🟡 H-WEEKLY** — Predicciones semanales de precio por par
  - _Umbral_: n≥15 por par con IC≥+0.05
  - _Acción_: Si confirma IC≥+0.10 n≥15 en SOL → considerar live semanal
  - _Estado_: ETH: n=181/15 IC=+0.205 PNL=+11.70€ | BTC: n=189/15 IC=+0.160 PNL=-11.79€ | SOL: n=264/15 IC=+0.365 PNL=+240.65€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.127 n=52925 | tras_1loss IC=+0.087 n=33620 | tras_2loss IC=+0.057 n=13853/40 | gap=+0.070 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=49, boost estimado=-0.051. Necesita 0 más y boost>0.05
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=+0.005 n=200 | contrario_BTC IC=-0.043 n=90/40 | gap=-0.049 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=378 IC=+0.024 PNL=+15.68€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=378 IC=+0.024 PNL=+15.68€
...
**🟡 H-WEEKLY-BUYNO** — WEEKLY_PRICE BUY_NO — dirección dominante con IC muy alto
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.329 > 0.1 con n=529 PNL=+248.23€
  - _Datos_: n=529 IC=+0.329 PNL=+248.23€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3810 IC=+0.063 PNL=+565.19€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3810 IC=+0.063 PNL=+565.19€
...
**🔴 H-CUSTOM-GBM-18H** — GBM a las 18h UTC — ¿blacklist necesario?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.115 < -0.08 con n=224 PNL=-46.41€
  - _Datos_: n=224 IC=-0.115 PNL=-46.41€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1498 IC=+0.063 PNL=+220.48€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1498 IC=+0.063 PNL=+220.48€
...
**⏳ H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: 29/30 ops en el filtro definido (IC actual=+0.177 PNL=+16.45€)
  - _Datos_: n=29 IC=+0.177 PNL=+16.45€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=620 IC=+0.087 PNL=+98.61€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=620 IC=+0.087 PNL=+98.61€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.092 > 0.08 con n=1967 PNL=+361.15€
  - _Datos_: n=1967 IC=+0.092 PNL=+361.15€
...
**🟡 H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.113 > 0.08 con n=179 PNL=+49.47€
  - _Datos_: n=179 IC=+0.113 PNL=+49.47€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2097 IC=+0.072 PNL=+322.68€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2097 IC=+0.072 PNL=+322.68€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=687 IC=+0.070 PNL=+82.14€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=687 IC=+0.070 PNL=+82.14€
...
**〰️ H-CUSTOM-OF-VOLUMEN-ALTO** — ORDER_FLOW_5M con total_vol_5m alto — ¿volumen extremo mejora el IC?
  ...
  - _Estado_: n=393 IC=-0.009 PNL=-9.26€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=393 IC=-0.009 PNL=-9.26€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.233 > 0.08 con n=298 PNL=+62.67€
  - _Datos_: n=298 IC=+0.233 PNL=+62.67€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=272 IC=+0.033 PNL=+64.15€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=272 IC=+0.033 PNL=+64.15€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=577 IC=+0.053 PNL=+65.75€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=577 IC=+0.053 PNL=+65.75€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.036 > 0.02 con n=455 PNL=+22.69€
  - _Datos_: n=455 IC=+0.036 PNL=+22.69€
...
**🟡 H-CUSTOM-WEEKLY-PCTDIST-BUYNO** — WEEKLY_PRICE BUY_NO con pct_dist alto — cuanto más lejos del rango, más seguro
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.425 > 0.1 con n=356 PNL=+279.12€
  - _Datos_: n=356 IC=+0.425 PNL=+279.12€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1648 IC=+0.044 PNL=+189.93€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1648 IC=+0.044 PNL=+189.93€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.166 > 0.1 con n=1620 PNL=+567.38€
  - _Datos_: n=1620 IC=+0.166 PNL=+567.38€
...
**〰️ H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: n=84 IC=-0.023 PNL=+19.63€ — sin señal clara aún (umbral IC: min=None max=-0.1)
  - _Datos_: n=84 IC=-0.023 PNL=+19.63€
...
**🟡 H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.117 > 0.1 con n=481 PNL=+157.33€
  - _Datos_: n=481 IC=+0.117 PNL=+157.33€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=280 IC=+0.064 PNL=+9.45€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=280 IC=+0.064 PNL=+9.45€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1662 IC=-0.082 PNL=+380.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1662 IC=-0.082 PNL=+380.38€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1461 IC=+0.065 PNL=+158.64€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1461 IC=+0.065 PNL=+158.64€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.110 > 0.08 con n=1094 PNL=+266.73€
  - _Datos_: n=1094 IC=+0.110 PNL=+266.73€
...
**🟡 H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.089 > 0.08 con n=312 PNL=+58.99€
  - _Datos_: n=312 IC=+0.089 PNL=+58.99€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.103 > 0.08 con n=1023 PNL=+331.95€
  - _Datos_: n=1023 IC=+0.103 PNL=+331.95€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.156 > 0.08 con n=393 PNL=+117.32€
  - _Datos_: n=393 IC=+0.156 PNL=+117.32€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1704 IC=+0.188 PNL=+969.40€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1704 IC=+0.188 PNL=+969.40€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.083 > 0.08 con n=855 PNL=+162.77€
  - _Datos_: n=855 IC=+0.083 PNL=+162.77€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.113 > 0.08 con n=930 PNL=+290.52€
  - _Datos_: n=930 IC=+0.113 PNL=+290.52€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.127 > 0.08 con n=1251 PNL=+629.82€
  - _Datos_: n=1251 IC=+0.127 PNL=+629.82€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.204 > 0.08 con n=475 PNL=+28.12€
  - _Datos_: n=475 IC=+0.204 PNL=+28.12€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.262 > 0.08 con n=749 PNL=-30.08€
  - _Datos_: n=749 IC=+0.262 PNL=-30.08€
...
**🟡 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.321 > 0.08 con n=160 PNL=+91.21€
  - _Datos_: n=160 IC=+0.321 PNL=+91.21€
...
**⏳ H-CUSTOM-WEEKLY-SOL-BUYNO-PRECIO-ALTO** — WEEKLY_PRICE SOL BUY_NO -- edge fuerte concentrado en precio alto (py>=0.45), posible pero sin fill-ability medida
  ...
  - _Estado_: 161/200 ops en el filtro definido (IC actual=+0.463 PNL=+219.95€)
  - _Datos_: n=161 IC=+0.463 PNL=+219.95€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1741 IC=+0.151 PNL=-248.70€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1741 IC=+0.151 PNL=-248.70€
...
**🟡 H-CUSTOM-GBMLATE15M-SOL-RESCATE-PRECIO** — GBM_LATE_15M#SOL#15min#BUY_YES (pausada 05-Ago) -- posible rescate con filtro py en [0.45,0.55)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.152 > 0.1 con n=768 PNL=+318.56€
  - _Datos_: n=768 IC=+0.152 PNL=+318.56€
