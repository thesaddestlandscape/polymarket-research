# Hipótesis automáticas — 2026-07-02 01:42 UTC
_Generado por shadow_postmortem.py sobre 2513 resoluciones (PNL=-82.73€)_
...
- **FILTRO** `ibs_15` > `0.44` → IC=-0.155 (n=27)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=83)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.271 (n=59)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.081)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.081)

- **PATRÓN** `ibs_15` < `0.0714` → IC=+0.244 (n=37)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0714 (IC base=+0.081)
...
- **PATRÓN** `sigma_h` < `0.0123` → IC=+0.222 (n=16)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0714 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.244 n=37). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 761 | -0.032 | -31.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 542 | -0.007 | -6.15€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#DOGE | 19 | -0.113 | -5.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 16 | -0.089 | -4.46€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#XRP | 63 | +0.008 | +4.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 52 | +0.056 | +8.09€ | 1 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.079) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.049 n=111 | overbought(IBS>0.7): IC=-0.047 n=135
  - _Datos_: n=371 IC=-0.023 PNL=-6.33€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.182 n=20 PNL=-9.93€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1188 | tras_1loss IC=-0.036 n=1243 | tras_2loss IC=-0.049 n=646/40 | gap=+0.052 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=638 IC=-0.025 PNL=-18.01€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=638 IC=-0.025 PNL=-18.01€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=230 IC=+0.009 PNL=-12.09€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=230 IC=+0.009 PNL=-12.09€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=159 IC=+0.053 PNL=+21.71€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=159 IC=+0.053 PNL=+21.71€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 96/200 ops en el filtro definido (IC actual=+0.061 PNL=+10.19€)
  - _Datos_: n=96 IC=+0.061 PNL=+10.19€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 96/100 ops en el filtro definido (IC actual=+0.061 PNL=+10.19€)
  - _Datos_: n=96 IC=+0.061 PNL=+10.19€
