# Hipótesis automáticas — 2026-07-02 00:33 UTC
_Generado por shadow_postmortem.py sobre 2492 resoluciones (PNL=-71.81€)_
...
- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.264 (n=53)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0092 (IC base=+0.109)

- **PATRÓN** `drift_60min` |x|≤ `0.8017` → IC=+0.124 (n=91)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.8017 (IC base=+0.109)

- **PATRÓN** `drift_15min` |x|≤ `0.7516` → IC=+0.129 (n=68)

  - _Acción_: Kelly boost +0.64€ cuando `drift_15min` |x|≤ 0.7516 (IC base=+0.109)
...
- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.258 (n=31)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0634 (IC base=+0.109)
...
- **FILTRO** `ibs_15` > `0.0787` → IC=-0.132 (n=17)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.400 (n=18)

- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0841` → IC=+0.149 (n=35)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.74€ cuando `pct_spot_vs_ref` |x|≤ 0.0841 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.190 (n=27)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0089 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `1.067` → IC=+0.176 (n=32)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 1.067 (IC base=+0.136)

- **PATRÓN** `drift_15min` |x|≤ `0.8797` → IC=+0.130 (n=25)

  - _Acción_: Kelly boost +0.65€ cuando `drift_15min` |x|≤ 0.8797 (IC base=+0.136)

- **PATRÓN** `ibs_15` < `0.0787` → IC=+0.400 (n=18)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0787 (IC base=+0.136)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0634 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.258 n=31). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0787 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.400 n=18). Confirma señal de reversión media → alinear con BUY_YES.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ ORDER_FLOW_5M | 1500 | +0.013 | +10.77€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1364 | +0.008 | -1.82€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 284 | +0.038 | +8.81€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 284 | +0.038 | +8.81€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 742 | -0.030 | -20.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 524 | -0.002 | +5.28€ | 1 | 6 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 115 | -0.056 | -9.93€ | 5 | 0 |
| ✅ UPDOWN_GBM#BNB | 16 | -0.044 | -0.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 16 | -0.044 | -0.31€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#DOGE | 15 | -0.066 | -2.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 12 | -0.043 | -1.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 299 | -0.008 | +5.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 218 | +0.009 | +11.47€ | 5 | 5 |
...
| ✅ UPDOWN_GBM#SOL | 127 | -0.074 | -6.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 75 | -0.045 | -1.85€ | 4 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.092) — sin ventaja clara. oversold(IBS<0.3): IC=+0.032 n=109 | neutral: IC=-0.061 n=105 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=352 IC=-0.017 PNL=+4.56€
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 147 ops con delta_ratio | SOL: 183 ops con delta_ratio

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=-0.045 < 0.08 — monitorear
  - _Datos_: n=75 IC=-0.045 PNL=-1.85€
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=20, boost estimado=+0.002. Necesita 0 más y boost>0.05
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.002 n=1174 | tras_1loss IC=-0.033 n=1236 | tras_2loss IC=-0.047 n=643/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=42 IC=+0.023 PNL=+0.90€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=42 IC=+0.023 PNL=+0.90€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=619 IC=-0.022 PNL=-7.12€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=619 IC=-0.022 PNL=-7.12€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=141 IC=+0.080 PNL=+33.14€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=141 IC=+0.080 PNL=+33.14€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 75/200 ops en el filtro definido (IC actual=+0.110 PNL=+21.12€)
  - _Datos_: n=75 IC=+0.110 PNL=+21.12€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 75/100 ops en el filtro definido (IC actual=+0.110 PNL=+21.12€)
  - _Datos_: n=75 IC=+0.110 PNL=+21.12€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 7/40 ops en el filtro definido (IC actual=+0.058 PNL=+3.31€)
  - _Datos_: n=7 IC=+0.058 PNL=+3.31€
