# Hipótesis automáticas — 2026-09-01 16:13 UTC
_Generado por shadow_postmortem.py sobre 240995 resoluciones (PNL=+20621.72€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.68` → IC=-0.296 (n=3340)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.68
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=10025)
...
- **FILTRO** `restante_s_al_confirmar` < `109.52` → IC=-0.414 (n=429)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 109.52
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1288)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `156.47` → IC=-0.159 (n=911)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.47
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2734)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `136.94` → IC=-0.324 (n=749)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 136.94
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2247)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `153.55` → IC=-0.374 (n=786)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 153.55
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=1597)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.191 (n=7128)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` > 0.7 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=1871)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `7197.4104` → IC=+0.200 (n=811)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7197.4104 (IC base=+0.095)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.211 (n=804)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.209)

- **PATRÓN** `py_entrada` > `0.785` → IC=+0.377 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.785 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.212 (n=1001)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `12924.6533` → IC=+0.220 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12924.6533 (IC base=+0.209)
...
- **PATRÓN** `libro_liquidez` > `5664.9983` → IC=+0.174 (n=213)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5664.9983 (IC base=+0.130)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.140 (n=1511)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.213 (n=186)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.196 (n=5657)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.203 (n=2721)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.174 (n=1370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.174 (n=1469)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.244 (n=1290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.199 (n=1389)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.209 (n=2250)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.132)

- **PATRÓN** `restante_min` < `3.98` → IC=+0.142 (n=2079)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=3259)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3514` → IC=+0.122 (n=3150)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` > 0.3514 (IC base=+0.073)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0803` → IC=+0.167 (n=746)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.0803 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `2.4318` → IC=+0.168 (n=1606)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.4318 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `1.4778` → IC=+0.163 (n=1825)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4778 (IC base=+0.073)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.335` → IC=+0.294 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.335 (IC base=+0.146)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3086` → IC=+0.122 (n=532)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.3086 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.4431` → IC=+0.138 (n=605)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4431 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=535)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.174 (n=351)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.227` → IC=+0.207 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.227 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` < `1.2608` → IC=+0.209 (n=548)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.195 (n=437)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.205` → IC=-0.176 (n=183)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1427)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.873` → IC=-0.160 (n=233)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.873
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1223)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.142 (n=1795)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0077 (IC base=+0.058)

- **PATRÓN** `ibs_20min` > `0.2718` → IC=+0.125 (n=3960)
...
- **FILTRO** `ibs_20min` < `0.2583` → IC=-0.147 (n=324)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=660)
...
- **PATRÓN** `ibs_20min` > `0.7818` → IC=+0.177 (n=246)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.7818 (IC base=+0.000)

- **PATRÓN** `volumen_pendiente_norm` > `0.2729` → IC=+0.395 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2729 (IC base=+0.000)

- **PATRÓN** `volumen_spike_ratio` > `2.7645` → IC=+0.263 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7645 (IC base=+0.000)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.384 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=+0.000)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8755` → IC=-0.155 (n=343)
...
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.283 (n=289)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1431` → IC=+0.229 (n=529)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.244 (n=632)
...
- **FILTRO** `ibs_20min` > `0.7459` → IC=-0.152 (n=389)
...
- **FILTRO** `ibs_20min` < `0.775` → IC=-0.150 (n=567)
...
- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.297 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=-0.012)
...
- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.273 (n=187)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 61.0 (IC base=-0.012)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1047` → IC=+0.185 (n=1228)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1047 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` < `2.3254` → IC=+0.166 (n=2705)
...
- **PATRÓN** `ballena_activa_n` < `91.0` → IC=+0.183 (n=1976)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0789` → IC=+0.213 (n=1040)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0789 (IC base=+0.178)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.196 (n=1463)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4188` → IC=+0.231 (n=3112)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4188 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` < `0.2254` → IC=+0.171 (n=2384)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.2254 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.957` → IC=+0.220 (n=566)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.957 (IC base=+0.178)

- **PATRÓN** `volumen_regimen` < `1.1686` → IC=+0.169 (n=2379)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.136 (n=673)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1655` → IC=+0.136 (n=636)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` < 0.1655 (IC base=+0.118)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.263 (n=293)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.0901` → IC=+0.245 (n=222)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0901 (IC base=+0.212)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.257 (n=306)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` < `0.0205` → IC=+0.324 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0205 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.2569` → IC=+0.218 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2569 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.446` → IC=+0.261 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.446 (IC base=+0.212)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7123` → IC=+0.244 (n=178)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7123 (IC base=+0.212)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.166 (n=309)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.008 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.3282` → IC=+0.135 (n=598)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.3282 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=253)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` > `0.6111` → IC=+0.180 (n=608)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.6111 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` > `0.8042` → IC=+0.226 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8042 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.306` → IC=+0.190 (n=182)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 8.306 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` < `0.8882` → IC=+0.146 (n=362)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8882 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `1.1694` → IC=+0.150 (n=181)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.1694 (IC base=+0.130)

- **PATRÓN** `volumen_pendiente_norm` > `0.1838` → IC=+0.188 (n=184)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1838 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` < `2.3206` → IC=+0.144 (n=551)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.3206 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=501)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `3112.9004` → IC=+0.149 (n=309)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3112.9004 (IC base=+0.130)

- **PATRÓN** `ibs_20min` < `0.3103` → IC=+0.133 (n=458)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.3103 (IC base=+0.060)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.167 (n=241)
...
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.144 (n=102)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 10.0 (IC base=+0.062)

- **PATRÓN** `ibs_20min` > `0.5418` → IC=+0.125 (n=102)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` > 0.5418 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.2233` → IC=+0.148 (n=52)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.2233 (IC base=+0.062)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.972` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 3.972 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7021` → IC=+0.138 (n=45)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.7021 (IC base=+0.062)

- **PATRÓN** `libro_liquidez` > `16771.2388` → IC=+0.222 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16771.2388 (IC base=+0.062)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.177 (n=648)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` < `1.5836` → IC=+0.168 (n=248)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5836 (IC base=+0.176)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.233 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.176)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.232 (n=270)
...
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.170 (n=213)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0068 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.0918` → IC=+0.170 (n=213)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.0918 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.175 (n=638)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 6.0 (IC base=+0.159)

- **PATRÓN** `ibs_20min` > `0.3282` → IC=+0.210 (n=637)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.439` → IC=+0.166 (n=551)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` < 4.439 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` < `1.2667` → IC=+0.167 (n=637)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2667 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` > `1.1006` → IC=+0.167 (n=289)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1006 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` < `0.0733` → IC=+0.179 (n=528)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1133` → IC=+0.181 (n=518)
...
- **PATRÓN** `libro_liquidez` > `10792.8871` → IC=+0.185 (n=569)
...
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.262 (n=183)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6991` → IC=+0.266 (n=490)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.207)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.263 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.207)
...
- **PATRÓN** `ibs_20min` < `0.4206` → IC=+0.302 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4206 (IC base=+0.239)
...
- **PATRÓN** `sigma_h` > `0.004` → IC=+0.147 (n=571)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.163 (n=577)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 8.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.3293` → IC=+0.194 (n=639)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.3293 (IC base=+0.146)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=704)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `9611.138` → IC=+0.233 (n=290)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=824)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` > `0.6849` → IC=+0.209 (n=700)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8301` → IC=+0.203 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8301 (IC base=+0.195)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.202 (n=939)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.134 (n=1531)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.133 (n=1033)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0101 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.4383` → IC=+0.137 (n=1035)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.2701` → IC=+0.145 (n=1174)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.2701 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.491` → IC=+0.169 (n=176)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 10.491 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.723` → IC=+0.126 (n=1084)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.723 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` > `0.8859` → IC=+0.124 (n=562)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.8859 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.1738` → IC=+0.155 (n=323)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1738 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` < `1.4485` → IC=+0.166 (n=387)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4485 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` > `2.6581` → IC=+0.148 (n=387)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.6581 (IC base=+0.122)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.182 (n=388)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0037 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.4847` → IC=+0.146 (n=1160)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4847 (IC base=+0.131)
...
- **PATRÓN** `ibs_20min` < `0.2006` → IC=+0.153 (n=511)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.2006 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.187` → IC=+0.138 (n=478)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.187 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.273` → IC=+0.145 (n=1163)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.273 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `1.2232` → IC=+0.138 (n=1130)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.2232 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` < `0.1463` → IC=+0.134 (n=1156)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1463 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.0681` → IC=+0.141 (n=555)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` > 0.0681 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `2.4927` → IC=+0.144 (n=1149)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.4927 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.5152` → IC=+0.136 (n=1026)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.5152 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=1531)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `6470.4651` → IC=+0.140 (n=1160)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 6470.4651 (IC base=+0.131)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.155 (n=192)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0052 (IC base=+0.128)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.131 (n=434)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0047 (IC base=+0.128)

- **PATRÓN** `drift_60min` |x|≤ `0.2729` → IC=+0.140 (n=290)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.2729 (IC base=+0.128)
...
- **PATRÓN** `ibs_20min` > `0.1816` → IC=+0.140 (n=434)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.1816 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` > `0.8995` → IC=+0.155 (n=114)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.8995 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.2349` → IC=+0.132 (n=351)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.2349 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.435` → IC=+0.158 (n=71)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.435 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.078` → IC=+0.131 (n=437)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 7.078 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.6576` → IC=+0.146 (n=145)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6576 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` > `0.0815` → IC=+0.153 (n=197)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.0815 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` < `1.4147` → IC=+0.174 (n=142)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.4147 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `2.5523` → IC=+0.146 (n=142)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 2.5523 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `8866.0493` → IC=+0.139 (n=388)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 8866.0493 (IC base=+0.128)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=278)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.180 (n=1239)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=3732)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.198 (n=1206)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=3995)

- **FILTRO** `ibs_20min` > `0.2701` → IC=-0.155 (n=1300)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2701
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=3901)
...
- **FILTRO** `ibs_20min` < `0.719` → IC=-0.185 (n=195)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=586)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.227 (n=203)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=658)

- **FILTRO** `ibs_20min` > `0.7354` → IC=-0.191 (n=215)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.139 (n=228)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=615)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=792)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.144 (n=3603)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=8741)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.284 (n=3029)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=9315)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.245 (n=3081)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=9263)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.170 (n=4196)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=8148)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.224 (n=3618)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=11891)

- **FILTRO** `ibs_7min` > `0.7313` → IC=-0.171 (n=3877)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7313
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=11632)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.145 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=1825)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=544)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1794)
...
- **FILTRO** `ballena_activa_n` > `163.0` → IC=-0.189 (n=583)
...
- **FILTRO** `ballena_activa_n` > `104.0` → IC=-0.177 (n=805)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1565)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.233 (n=638)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2099)

- **FILTRO** `ibs_7min` > `0.8113` → IC=-0.175 (n=684)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8113
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2053)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.145 (n=640)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=1466)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.260 (n=511)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=1595)

- **FILTRO** `ibs_7min` < `0.7541` → IC=-0.191 (n=526)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7541
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=1580)

- **FILTRO** `ballena_activa_n` > `27.0` → IC=-0.182 (n=699)

  - _Acción_: SKIP cuando `ballena_activa_n` > 27.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1407)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.189 (n=693)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=2190)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.125 (n=656)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1347)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.297 (n=495)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1508)
...
- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.226 (n=487)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1516)

- **FILTRO** `libro_liquidez` < `2666.4808` → IC=-0.139 (n=1321)

  - _Acción_: SKIP cuando `libro_liquidez` < 2666.4808
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=682)
...
- **FILTRO** `ibs_7min` > `0.7972` → IC=-0.162 (n=673)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2021)
...
- **FILTRO** `T_h` > `135.89` → IC=-0.139 (n=59)

  - _Acción_: SKIP cuando `T_h` > 135.89
...
- **PATRÓN** `T_h` < `87.9853` → IC=+0.208 (n=22)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `T_h` < 87.9853 (IC base=-0.016)

- **PATRÓN** `pct_vs_K` |x|≤ `0.8662` → IC=+0.350 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `pct_vs_K` |x|≤ 0.8662 (IC base=-0.016)
...
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.167 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.003 (IC base=+0.125)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.153 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0063 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.1645` → IC=+0.133 (n=374)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.1645 (IC base=+0.125)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0656` → IC=+0.132 (n=425)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.66€ cuando `delta_ratio_macro` |x|> 0.0656 (IC base=+0.125)
...
- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.217 (n=425)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` > `0.3926` → IC=+0.175 (n=112)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3926 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.287` → IC=+0.241 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.287 (IC base=+0.125)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.133 (n=448)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `8676.3608` → IC=+0.188 (n=142)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 8676.3608 (IC base=+0.125)

- **PATRÓN** `ballena_activa_n` < `52.0` → IC=+0.194 (n=47)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 52.0 (IC base=+0.125)
...
- **FILTRO** `ibs_15` < `0.6381` → IC=-0.221 (n=41)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.216 (n=86)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1911` → IC=+0.152 (n=44)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.76€ cuando `delta_ratio_macro` |x|> 0.1911 (IC base=+0.074)

- **PATRÓN** `ibs_15` > `0.6381` → IC=+0.216 (n=86)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6381 (IC base=+0.074)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.912` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 8.912 (IC base=+0.074)
...
- **PATRÓN** `ibs_15` < `0.1404` → IC=+0.181 (n=133)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` < 0.1404 (IC base=+0.028)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.932` → IC=-0.158 (n=439)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3354)
...
- **FILTRO** `sigma_h` > `0.0074` → IC=-0.239 (n=201)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.235 (n=198)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.196 (n=607)

- **FILTRO** `sigma_ewma_delta_pct` > `19.708` → IC=-0.253 (n=152)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.708
  - _Potencial_: sin este filtro IC_bueno=-0.195 (n=653)

- **FILTRO** `libro_liquidez` < `15853.6345` → IC=-0.217 (n=531)

  - _Acción_: SKIP cuando `libro_liquidez` < 15853.6345
...
- **PATRÓN** `T_h` < `63.9936` → IC=+0.239 (n=44)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `T_h` < 63.9936 (IC base=+0.103)

- **PATRÓN** `ratio` < `0.9922` → IC=+0.361 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `ratio` < 0.9922 (IC base=+0.103)
...
- **PATRÓN** `T_h` < `63.9965` → IC=+0.182 (n=20)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `T_h` < 63.9965 (IC base=+0.093)

- **PATRÓN** `ratio` < `0.973` → IC=+0.395 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `ratio` < 0.973 (IC base=+0.093)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.125 a +0.217 en UPDOWN_GBM#15min (n=425). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6381 sube el IC de +0.074 a +0.216 en UPDOWN_GBM#ETH#15min (n=86). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1404 sube el IC de +0.028 a +0.181 en UPDOWN_GBM#XRP#15min (n=133). Ya aplicado como kelly_boost=+0.91€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 13365 | -0.106 | -2279.81€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 902 | -0.003 | -127.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 12463 | -0.114 | -2152.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1722 | -0.070 | -345.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1722 | -0.070 | -345.39€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 902 | -0.003 | -127.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 902 | -0.003 | -127.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1717 | -0.156 | -522.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1717 | -0.156 | -522.93€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 3645 | -0.063 | -363.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 3645 | -0.063 | -363.91€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2996 | -0.119 | -299.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2996 | -0.119 | -299.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2383 | -0.185 | -620.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2383 | -0.185 | -620.25€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 2928 | -0.057 | +1372.37€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 825 | -0.005 | +438.91€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 2103 | -0.078 | +933.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 2928 | -0.057 | +1372.37€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 825 | -0.005 | +438.91€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 2103 | -0.078 | +933.46€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 68 | -0.129 | -20.37€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 68 | -0.129 | -20.37€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 68 | -0.129 | -20.37€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 68 | -0.129 | -20.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 42727 | +0.113 | -2710.11€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 7351 | +0.187 | -228.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 132 | -0.097 | -54.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 31692 | +0.096 | -2377.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3552 | +0.119 | -49.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 5316 | +0.077 | -761.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 22 | -0.083 | +0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 9 | -0.143 | -7.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 5285 | +0.078 | -754.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 8640 | +0.132 | -190.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2130 | +0.201 | -77.96€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min |
|
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.088) — sin ventaja clara. oversold(IBS<0.3): IC=+0.020 n=2886 | neutral: IC=+0.000 n=3104 | overbought(IBS>0.7): IC=+0.088 n=3167
  - _Datos_: n=9526 IC=+0.037 PNL=+917.55€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: (cache 706s) 90 celda(s) GATE OK de 2358 trackeadas

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.000 < 0.08 — monitorear
  - _Datos_: n=726 IC=+0.000 PNL=-1.04€

**🟡 H-WEEKLY** — Predicciones semanales de precio por par
  - _Umbral_: n≥15 por par con IC≥+0.05
  - _Acción_: Si confirma IC≥+0.10 n≥15 en SOL → considerar live semanal
  - _Estado_: ETH: n=424/15 IC=+0.272 PNL=+119.01€ | BTC: n=410/15 IC=+0.221 PNL=+20.03€ | SOL: n=467/15 IC=+0.372 PNL=+428.39€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.071 n=134686 | tras_1loss IC=+0.046 n=106005 | tras_2loss IC=+0.008 n=48123/40 | gap=+0.062 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 7959 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=212/40 IC=+0.009 PNL=-0.20€ | BTC#60min: n=155/40 IC=-0.029 PNL=-6.79€ | SOL#60min: n=110/40 IC=+0.000 PNL=+1.45€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.007 n=804 | contrario_BTC IC=-0.022 n=647/40 | gap=-0.015 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.144 > 0.08 con n=99 PNL=+29.71€
  - _Datos_: n=99 IC=+0.144 PNL=+29.71€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=7744 IC=+0.001 PNL=+114.39€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=7744 IC=+0.001 PNL=+114.39€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=396 IC=+0.010 PNL=+1.55€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=396 IC=+0.010 PNL=+1.55€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.1 con n=566 PNL=+157.97€
  - _Datos_: n=566 IC=+0.125 PNL=+157.97€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=297 IC=+0.089 PNL=+64.30€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=297 IC=+0.089 PNL=+64.30€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1649 IC=+0.027 PNL=+117.75€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1649 IC=+0.027 PNL=+117.75€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2110 IC=+0.014 PNL=+88.52€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2110 IC=+0.014 PNL=+88.52€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=26984 IC=+0.102 PNL=+8486.95€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=26984 IC=+0.102 PNL=+8486.95€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1811 IC=+0.024 PNL=+114.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1811 IC=+0.024 PNL=+114.02€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.167 > 0.1 con n=858 PNL=+330.54€
  - _Datos_: n=858 IC=+0.167 PNL=+330.54€
...
**🔴 H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.214 < -0.1 con n=40 PNL=-2.41€
  - _Datos_: n=40 IC=-0.214 PNL=-2.41€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=528 IC=+0.028 PNL=+52.08€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=528 IC=+0.028 PNL=+52.08€
...
**🟡 H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.120 > 0.1 con n=90 PNL=+15.86€
  - _Datos_: n=90 IC=+0.120 PNL=+15.86€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=6598 IC=-0.146 PNL=+205.85€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=6598 IC=-0.146 PNL=+205.85€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1825 IC=+0.122 PNL=+939.61€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1825 IC=+0.122 PNL=+939.61€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=1246 IC=-0.068 PNL=+249.54€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1246 IC=-0.068 PNL=+249.54€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=4040 IC=+0.141 PNL=-672.01€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=4040 IC=+0.141 PNL=-672.01€
