# Hipótesis automáticas — 2026-07-02 00:03 UTC
_Generado por shadow_postmortem.py sobre 2486 resoluciones (PNL=-77.50€)_
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.255 (n=51)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.096)

- **PATRÓN** `drift_60min` |x|≤ `0.438` → IC=+0.130 (n=44)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.438 (IC base=+0.096)

- **PATRÓN** `drift_15min` |x|≤ `0.5412` → IC=+0.122 (n=43)

  - _Acción_: Kelly boost +0.61€ cuando `drift_15min` |x|≤ 0.5412 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.188 (n=30)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 16.0 (IC base=+0.096)

- **PATRÓN** `ibs_15` < `0.1215` → IC=+0.217 (n=44)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1215 (IC base=+0.096)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.1215 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.217 n=44). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ ORDER_FLOW_5M | 1499 | +0.012 | +10.27€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1363 | +0.008 | -2.32€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 250 | -0.024 | -8.08€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 250 | -0.024 | -8.08€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 737 | -0.033 | -25.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 519 | -0.007 | +0.08€ | 1 | 5 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 115 | -0.056 | -9.93€ | 5 | 0 |
| ✅ UPDOWN_GBM#BNB | 14 | -0.087 | -2.09€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 14 | -0.087 | -2.09€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#DOGE | 14 | -0.087 | -3.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 11 | -0.064 | -2.18€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#SOL | 126 | -0.078 | -7.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 74 | -0.053 | -3.07€ | 4 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.120) — sin ventaja clara. oversold(IBS<0.3): IC=+0.032 n=109 | neutral: IC=-0.088 n=100 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=347 IC=-0.024 PNL=-0.64€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.112 n=17 PNL=-5.44€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR

**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  - _Umbral_: n≥200 por par con delta_ratio feature en shadow
  - _Acción_: Añadir DELTA_MIN/MAX por par dict en shadow_predict.py
  - _Estado_: BTC: 146 ops con delta_ratio | SOL: 183 ops con delta_ratio

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=-0.053 < 0.08 — monitorear
  - _Datos_: n=74 IC=-0.053 PNL=-3.07€
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=20, boost estimado=+0.004. Necesita 0 más y boost>0.05
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.000 n=1170 | tras_1loss IC=-0.034 n=1234 | tras_2loss IC=-0.049 n=641/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=41 IC=+0.012 PNL=+0.40€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=41 IC=+0.012 PNL=+0.40€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=614 IC=-0.026 PNL=-12.32€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=614 IC=-0.026 PNL=-12.32€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=221 IC=+0.025 PNL=+0.30€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=221 IC=+0.025 PNL=+0.30€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=136 IC=+0.065 PNL=+27.94€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=136 IC=+0.065 PNL=+27.94€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 69/200 ops en el filtro definido (IC actual=+0.077 PNL=+15.42€)
  - _Datos_: n=69 IC=+0.077 PNL=+15.42€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 69/100 ops en el filtro definido (IC actual=+0.077 PNL=+15.42€)
  - _Datos_: n=69 IC=+0.077 PNL=+15.42€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 6/40 ops en el filtro definido (IC actual=+0.037 PNL=+2.10€)
  - _Datos_: n=6 IC=+0.037 PNL=+2.10€
