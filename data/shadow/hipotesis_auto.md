# Hipótesis automáticas — 2026-06-29 20:12 UTC
_Generado por shadow_postmortem.py sobre 1311 resoluciones (PNL=-32.38€)_

## Patrones causales activos

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1022` → IC=+0.136 (n=20)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.68€ cuando `pct_spot_vs_ref` |x|≤ 0.1022 (IC base=+0.050)

- **PATRÓN** `sigma_h` < `0.0121` → IC=+0.125 (n=30)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0121 (IC base=+0.050)
...
| ✅ UPDOWN_GBM | 342 | +0.017 | +9.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 199 | +0.062 | +13.01€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 62 | +0.109 | +11.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 106 | +0.018 | -0.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 58 | +0.050 | -0.04€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.111) — sin ventaja clara. oversold(IBS<0.3): IC=+0.044 n=14 | neutral: IC=+0.154 n=15 | overbought(IBS>0.7): IC=+0.083 n=22
  - _Datos_: n=53 IC=+0.118 PNL=+7.93€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 53 ops, 9 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 342/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=243 IC=+0.043 PNL=+14.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=243 IC=+0.043 PNL=+14.69€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=148 IC=+0.040 PNL=-0.16€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=148 IC=+0.040 PNL=-0.16€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=58 IC=+0.050 PNL=-0.04€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=58 IC=+0.050 PNL=-0.04€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.140 > 0.08 con n=73 PNL=+10.29€
  - _Datos_: n=73 IC=+0.140 PNL=+10.29€
