# Hipótesis automáticas — 2026-08-19 14:09 UTC
_Generado por shadow_postmortem.py sobre 76258 resoluciones (PNL=+8055.46€)_
...
- **FILTRO** `restante_s_al_confirmar` < `71.17` → IC=-0.472 (n=142)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 71.17
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=290)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `concentracion_yes` < `1.0` → IC=-0.135 (n=72)

  - _Acción_: SKIP cuando `concentracion_yes` < 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=927)

- **FILTRO** `n_ballenas` < `4.0` → IC=-0.139 (n=239)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=760)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `151.11` → IC=-0.313 (n=201)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 151.11
  - _Potencial_: sin este filtro IC_bueno=-0.201 (n=603)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.182 (n=2640)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.7 (IC base=+0.089)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.164 (n=1193)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.089)

- **PATRÓN** `libro_liquidez` > `2359.6175` → IC=+0.168 (n=1156)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2359.6175 (IC base=+0.089)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=478)
...
- **PATRÓN** `libro_liquidez` > `5287.6073` → IC=+0.174 (n=213)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5287.6073 (IC base=+0.140)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.121 (n=201)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 15.0 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `5700.7138` → IC=+0.190 (n=69)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 5700.7138 (IC base=+0.096)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.124 (n=357)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.159 (n=259)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.02 (IC base=+0.110)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.219 (n=3677)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.230 (n=827)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.224)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.225 (n=850)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=1895)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.154 (n=1870)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `restante_min` < `4.06` → IC=+0.168 (n=398)

  - _Acción_: Kelly boost +0.84€ cuando `restante_min` < 4.06 (IC base=+0.153)

- **PATRÓN** `restante_min` > `4.88` → IC=+0.201 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.88 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=939)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.153)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.162 (n=821)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.170 (n=822)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` < 0.43 (IC base=+0.141)

- **PATRÓN** `restante_min` < `3.9` → IC=+0.155 (n=311)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.143 (n=956)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 5.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.149 (n=947)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.310 (n=304)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.301)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.311 (n=421)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.283 (n=178)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.273)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.277 (n=182)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `3909.8054` → IC=+0.282 (n=177)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.132 (n=493)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 6.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.9831` → IC=+0.271 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9831 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.1499` → IC=+0.267 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1499 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.68` → IC=+0.232 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.68 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `1.2802` → IC=+0.242 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2802 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.8536` → IC=+0.246 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8536 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.3253` → IC=+0.143 (n=110)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.3253 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.6667` → IC=+0.120 (n=2300)
...
- **PATRÓN** `sigma_h` < `0.0019` → IC=+0.336 (n=53)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0019 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.0035` → IC=+0.262 (n=40)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0035 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.0774` → IC=+0.282 (n=53)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0774 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.300 (n=123)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` > `0.5545` → IC=+0.279 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5545 (IC base=+0.258)

- **PATRÓN** `dist_vwap_pct` > `0.308` → IC=+0.308 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.308 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.157` → IC=+0.331 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.157 (IC base=+0.258)

- **PATRÓN** `volumen_regimen` < `1.3826` → IC=+0.279 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.3826 (IC base=+0.258)

- **PATRÓN** `volumen_regimen` > `0.7493` → IC=+0.262 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7493 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` < `0.1897` → IC=+0.296 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1897 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` < `1.4783` → IC=+0.353 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4783 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `12448.5931` → IC=+0.307 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12448.5931 (IC base=+0.258)

- **PATRÓN** `ballena_activa_n` < `366.0` → IC=+0.329 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 366.0 (IC base=+0.258)
...
- **PATRÓN** `ibs_20min` > `0.9425` → IC=+0.240 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9425 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` > `0.1212` → IC=+0.176 (n=183)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.1212 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.219` → IC=+0.130 (n=1064)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 2.219 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.35` → IC=+0.204 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.35 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `2.8942` → IC=+0.166 (n=321)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.8942 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.242 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.048)

- **PATRÓN** `ibs_20min` < `0.1001` → IC=+0.166 (n=894)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1001 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` > `0.4844` → IC=+0.256 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4844 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.195 (n=211)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.7176 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` > `1.2602` → IC=+0.210 (n=160)
...
- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.277 (n=128)
...
- **PATRÓN** `ibs_20min` > `0.45` → IC=+0.133 (n=156)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` > 0.45 (IC base=-0.014)

- **PATRÓN** `dist_vwap_pct` > `0.1779` → IC=+0.156 (n=30)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1779 (IC base=-0.014)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.275 (n=336)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.273)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.281 (n=300)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0051 (IC base=+0.273)

- **PATRÓN** `drift_60min` |x|≤ `0.3215` → IC=+0.272 (n=336)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3215 (IC base=+0.273)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.327 (n=166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.273)

- **PATRÓN** `ibs_20min` < `0.2639` → IC=+0.346 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2639 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` > `0.5366` → IC=+0.333 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5366 (IC base=+0.273)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.872` → IC=+0.278 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.872 (IC base=+0.273)

- **PATRÓN** `volumen_regimen` > `1.0818` → IC=+0.312 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0818 (IC base=+0.273)

- **PATRÓN** `volumen_pendiente_norm` > `0.3369` → IC=+0.375 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3369 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` > `3.3548` → IC=+0.341 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.3548 (IC base=+0.273)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.159 (n=459)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0046 (IC base=+0.142)

- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.194 (n=623)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0066 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.145 (n=604)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.150 (n=458)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 17.0 (IC base=+0.142)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.151 (n=931)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 11.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` > `0.9185` → IC=+0.260 (n=915)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9185 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.1231` → IC=+0.164 (n=421)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1231 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.015` → IC=+0.292 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.015 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.2075` → IC=+0.142 (n=724)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2075 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6346` → IC=+0.143 (n=724)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6346 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.1106` → IC=+0.167 (n=475)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1106 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `2.6482` → IC=+0.121 (n=1000)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 2.6482 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.5437` → IC=+0.121 (n=1136)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 1.5437 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.150 (n=1389)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.05 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `2763.8927` → IC=+0.180 (n=458)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2763.8927 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.220 (n=1328)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.209)

- **PATRÓN** `drift_60min` |x|≤ `0.2896` → IC=+0.213 (n=1327)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3785` → IC=+0.272 (n=1327)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.507` → IC=+0.209 (n=1143)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.507 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` < `1.2448` → IC=+0.185 (n=1027)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 1.2448 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.8699` → IC=+0.192 (n=684)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.8699 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2675` → IC=+0.257 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2675 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` < `1.6779` → IC=+0.223 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6779 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `3.0855` → IC=+0.238 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0855 (IC base=+0.209)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.220 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 131.0 (IC base=+0.209)
...
- **PATRÓN** `sigma_h` < `0.0018` → IC=+0.267 (n=41)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0018 (IC base=+0.205)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.267 (n=41)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0034 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.254 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `0.655` → IC=+0.281 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.655 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.2785` → IC=+0.293 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2785 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.832` → IC=+0.317 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.832 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `1.4038` → IC=+0.215 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.4038 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.7639` → IC=+0.209 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7639 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.3409` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3409 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `1.4872` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4872 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `8500.2314` → IC=+0.271 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8500.2314 (IC base=+0.205)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1372` → IC=+0.196 (n=159)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.1372 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.228 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` < `0.332` → IC=+0.251 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.332 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.358` → IC=+0.265 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.358 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` < `1.2379` → IC=+0.212 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2379 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.0843` → IC=+0.213 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0843 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` < `1.9183` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9183 (IC base=+0.185)
...
- **PATRÓN** `ibs_20min` > `0.875` → IC=+0.200 (n=158)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.875 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.655` → IC=+0.210 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.655 (IC base=+0.047)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.202 (n=541)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.122)
...
- **PATRÓN** `ibs_20min` > `0.9631` → IC=+0.285 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9631 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` > `0.2157` → IC=+0.179 (n=310)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.2157 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.259` → IC=+0.234 (n=1087)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.259 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.1816` → IC=+0.144 (n=388)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.1816 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` > `1.6907` → IC=+0.126 (n=1173)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.6907 (IC base=+0.122)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.127 (n=1623)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.05 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `2800.762` → IC=+0.163 (n=541)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2800.762 (IC base=+0.122)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.192 (n=245)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 147.0 (IC base=+0.122)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.230 (n=1318)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0063 (IC base=+0.216)

- **PATRÓN** `sigma_h` > `0.0038` → IC=+0.219 (n=1495)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0038 (IC base=+0.216)

- **PATRÓN** `drift_60min` |x|≤ `0.1535` → IC=+0.216 (n=997)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1535 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.250 (n=753)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` < `0.5146` → IC=+0.279 (n=1496)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5146 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `0.1544` → IC=+0.194 (n=968)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.1544 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.969` → IC=+0.245 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.969 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.48` → IC=+0.224 (n=1402)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.48 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` < `0.6176` → IC=+0.203 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6176 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `1.0639` → IC=+0.210 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0639 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.113` → IC=+0.233 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.113 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` > `0.2494` → IC=+0.247 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2494 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` < `2.0204` → IC=+0.248 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0204 (IC base=+0.216)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1808` → IC=+0.186 (n=218)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.1808 (IC base=+0.178)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.192 (n=238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 7.0 (IC base=+0.178)

- **PATRÓN** `ibs_20min` < `0.4082` → IC=+0.224 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4082 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` < `0.1435` → IC=+0.192 (n=271)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.1435 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.3` → IC=+0.245 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.3 (IC base=+0.178)

- **PATRÓN** `volumen_regimen` < `0.6183` → IC=+0.218 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6183 (IC base=+0.178)

- **PATRÓN** `volumen_regimen` > `0.856` → IC=+0.195 (n=165)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 0.856 (IC base=+0.178)

- **PATRÓN** `volumen_pendiente_norm` > `0.1746` → IC=+0.307 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1746 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` < `1.5729` → IC=+0.329 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5729 (IC base=+0.178)

- **PATRÓN** `libro_liquidez` > `5226.4416` → IC=+0.192 (n=222)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 5226.4416 (IC base=+0.178)

- **PATRÓN** `ballena_activa_n` < `265.0` → IC=+0.200 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 265.0 (IC base=+0.178)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.204 (n=52)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` < `0.149` → IC=+0.283 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.149 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` > `0.1083` → IC=+0.292 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1083 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.713` → IC=+0.259 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.713 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` < `0.953` → IC=+0.183 (n=118)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.953 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `0.6178` → IC=+0.172 (n=120)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6178 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` < `0.1547` → IC=+0.307 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1547 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `1.8043` → IC=+0.318 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8043 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `5105.3697` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 5105.3697 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.241 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 124.0 (IC base=+0.172)

### GBM_LATE_15M_TARDIO#SOL#15min
- **FILTRO** `ibs_20min` < `0.5` → IC=-0.192 (n=76)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.088 (n=248)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.226 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.021)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.743` → IC=+0.185 (n=128)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 3.743 (IC base=+0.021)
...
- **PATRÓN** `drift_60min` |x|≤ `0.318` → IC=+0.238 (n=383)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.318 (IC base=+0.238)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.308 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.238)

- **PATRÓN** `ibs_20min` < `0.425` → IC=+0.297 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.425 (IC base=+0.238)

- **PATRÓN** `dist_vwap_pct` > `0.3684` → IC=+0.331 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3684 (IC base=+0.238)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.777` → IC=+0.244 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.777 (IC base=+0.238)

- **PATRÓN** `volumen_regimen` > `0.8842` → IC=+0.270 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8842 (IC base=+0.238)
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.145 (n=60)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 4.0 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.155 (n=27)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 4.0 (IC base=+0.134)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.1176` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `drift_20min_pct` |x|≤ 0.1176 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.1` → IC=+0.191 (n=40)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.1 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `2049.7257` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2049.7257 (IC base=+0.134)
...
- **FILTRO** `ibs_20min` < `0.719` → IC=-0.205 (n=144)
...
- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.190 (n=143)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=436)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.169 (n=161)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=504)
...
- **FILTRO** `libro_liquidez` < `14386.2811` → IC=-0.197 (n=64)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.140 (n=48)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 7.0 (IC base=+0.015)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `py_entrada` < 0.5 (IC base=+0.015)
...
- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.179 (n=26)
...
- **FILTRO** `py_entrada` < `0.34` → IC=-0.270 (n=381)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1186)
...
- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.197 (n=522)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1045)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.169 (n=451)
...
- **FILTRO** `ibs_7min` < `0.1618` → IC=-0.250 (n=54)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=164)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.282 (n=53)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=165)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.192 (n=144)
...
- **FILTRO** `ibs_7min` > `0.0423` → IC=-0.128 (n=41)
...
- **PATRÓN** `delta_ratio` |x|> `0.401` → IC=+0.171 (n=174)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.85€ cuando `delta_ratio` |x|> 0.401 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.192 (n=50)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 5.0 (IC base=+0.133)

- **PATRÓN** `total_vol_5m` < `504.262` → IC=+0.210 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 504.262 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.132 (n=93)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.02 (IC base=+0.133)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=727)
...
- **PATRÓN** `ibs_15` < `0.1213` → IC=+0.148 (n=237)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.74€ cuando `ibs_15` < 0.1213 (IC base=+0.072)

- **PATRÓN** `dist_vwap_pct` > `0.5395` → IC=+0.172 (n=65)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.5395 (IC base=+0.072)
...
- **PATRÓN** `ibs_15` > `0.9253` → IC=+0.167 (n=22)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` > 0.9253 (IC base=+0.000)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.144 (n=43)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0029 (IC base=+0.123)

- **PATRÓN** `sigma_h` > `0.004` → IC=+0.163 (n=84)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.004 (IC base=+0.123)

- **PATRÓN** `delta_ratio_macro` |x|> `0.103` → IC=+0.143 (n=113)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio_macro` |x|> 0.103 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.159 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 12.0 (IC base=+0.123)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.129 (n=122)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 14.0 (IC base=+0.123)

- **PATRÓN** `ibs_15` < `0.2754` → IC=+0.155 (n=111)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.77€ cuando `ibs_15` < 0.2754 (IC base=+0.123)

- **PATRÓN** `ibs_15` > `0.0403` → IC=+0.151 (n=127)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` > 0.0403 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `0.4148` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4148 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` < `22.914` → IC=+0.161 (n=125)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 22.914 (IC base=+0.123)
...
- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.160 (n=48)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0025 (IC base=+0.055)

### UPDOWN_GBM#ETH#60min
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.149 (n=35)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.03 (IC base=+0.022)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.3156` → IC=+0.167 (n=34)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.3156 (IC base=+0.047)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.128 (n=49)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 4.0 (IC base=+0.047)

- **PATRÓN** `ibs_15` < `0.0714` → IC=+0.167 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.0714 (IC base=+0.047)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=60)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.047)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0971` → IC=+0.141 (n=151)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.70€ cuando `delta_ratio_macro` |x|> 0.0971 (IC base=+0.073)

- **PATRÓN** `ibs_15` < `0.1333` → IC=+0.175 (n=75)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` < 0.1333 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` > `0.4942` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4942 (IC base=+0.073)
...
- **PATRÓN** `ibs_15` > `0.4043` → IC=+0.184 (n=169)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` > 0.4043 (IC base=-0.040)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.127 (n=57)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0029 (IC base=+0.068)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=59)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 5.0 (IC base=+0.068)
...
- **FILTRO** `sigma_h` > `0.0065` → IC=-0.203 (n=35)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_15` > `0.8607` → IC=+0.340 (n=48)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8607 (IC base=+0.285)
...
- **H-IBS-UPDOWN_GBM#SOL#5min**: dentro de BUY_NO, IBS < 0.0714 sube el IC de +0.047 a +0.167 en UPDOWN_GBM#SOL#5min (n=34). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_NO, IBS < 0.2754 sube el IC de +0.123 a +0.155 en UPDOWN_GBM#ETH#15min (n=111). Ya aplicado como kelly_boost=+0.77€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_NO, IBS > 0.0403 sube el IC de +0.123 a +0.151 en UPDOWN_GBM#ETH#15min (n=127). Ya aplicado como kelly_boost=+0.76€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1333 sube el IC de +0.073 a +0.175 en UPDOWN_GBM#XRP#15min (n=75). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#60min**: dentro de BUY_YES, IBS > 0.9253 sube el IC de +0.000 a +0.167 en UPDOWN_GBM#BTC#60min (n=22). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4043 sube el IC de -0.040 a +0.184 en UPDOWN_GBM_15M_TARDIO (n=169). Ya aplicado como kelly_boost=+0.92€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8607 sube el IC de +0.285 a +0.340 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=48). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min` — IC=+0.200 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL` — IC=+0.200 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.
...
| ✅ BALLENAS_TARDIAS | 3685 | -0.113 | -577.69€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 471 | -0.026 | -22.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 3214 | -0.126 | -555.23€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 435 | -0.191 | -88.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 435 | -0.191 | -88.38€ | 1 | 0 |
...
| 🚫 BALLENAS_TARDIAS#XRP | 804 | -0.230 | -168.58€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 804 | -0.230 | -168.58€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 15966 | +0.112 | -1047.22€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 3596 | +0.182 | -118.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 103 | -0.090 | -46.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 9613 | +0.083 | -899.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2654 | +0.131 | +17.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 1625 | +0.027 | -368.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 14 | -0.044 | +0.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 1607 | +0.029 | -362.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 3564 | +0.137 | -31.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 984 | +0.197 | -37.20€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 1596 | +0.106 | -34.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 942 | +0.138 | +62.09€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 1623 | +0.058 | -278.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 10 | +0.000 | -3.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 1612 | +0.059 | -273.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 3858 | +0.127 | -46.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1328 | +0.164 | -15.59€ | 0 | 5 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 1597 | +0.105 | -25.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 921 | +0.117 | +3.10€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL | 3678 | +0.132 | -243.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1248 | +0.195 | -63.73€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 43 | +0.033 | -6.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 1596 | +0.081 | -125.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 791 | +0.139 | -48.20€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#XRP | 1618 | +0.115 | -77.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 12 | +0.043 | +1.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 1605 | +0.116 | -77.58€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 6863 | +0.184 | -700.18€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 6863 | +0.184 | -700.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1285 | +0.092 | -299.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1285 | +0.092 | -299.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1047 | +0.241 | -21.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1047 | +0.241 | -21.41€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1211 | +0.150 | -182.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1211 | +0.150 | -182.18€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 1102 | +0.224 | -44.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 1102 | +0.224 | -44.93€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 2437 | +0.147 | +127.19€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 2437 | +0.147 | +127.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 1204 | +0.153 | +75.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 1204 | +0.153 | +75.23€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 1233 | +0.141 | +51.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 1233 | +0.141 | +51.96€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 560 | +0.301 | +5.94€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 560 | +0.301 | +5.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 236 | +0.273 | -9.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 236 | +0.273 | -9.23€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 114 | +0.121 | -3.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 12 | +0.000 | -1.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 102 | +0.135 | -1.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 76 | +0.077 | -5.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 12 | +0.000 | -1.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 64 | +0.091 | -4.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 38 | +0.200 | +2.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 38 | +0.200 | +2.87€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 4855 | +0.083 | +1818.53€ | 0 | 15 |
| ✅ GBM_LATE_15M#15min | 4855 | +0.083 | +1818.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 843 | +0.176 | +534.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 843 | +0.176 | +534.73€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 497 | +0.183 | +269.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 497 | +0.183 | +269.07€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 853 | +0.191 | +587.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 853 | +0.191 | +587.35€ | 0 | 18 |
| ✅ GBM_LATE_15M#ETH | 643 | -0.009 | +36.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 643 | -0.009 | +36.91€ | 0 | 1 |
| ✅ GBM_LATE_15M#SOL | 901 | -0.003 | +172.51€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 901 | -0.003 | +172.51€ | 3 | 5 |
| ✅ GBM_LATE_15M#XRP | 1118 | +0.004 | +217.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1118 | +0.004 | +217.96€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5884 | +0.048 | +2165.00€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5884 | +0.048 | +2165.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1126 | -0.028 | +510.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1126 | -0.028 | +510.46€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1126 | -0.015 | +97.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1126 | -0.015 | +97.78€ | 1 | 2 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1031 | +0.001 | +160.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1031 | +0.001 | +160.29€ | 2 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 859 | +0.211 | +688.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 859 | +0.211 | +688.13€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 3597 | +0.175 | +2447.63€ | 0 | 27 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 3597 | +0.175 | +2447.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 634 | +0.193 | +466.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 634 | +0.193 | +466.11€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 489 | +0.195 | +334.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 489 | +0.195 | +334.01€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 630 | +0.201 | +486.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 630 | +0.201 | +486.64€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 462 | +0.207 | +349.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 462 | +0.207 | +349.22€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 660 | +0.075 | +265.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 660 | +0.075 | +265.52€ | 1 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 4154 | +0.167 | +2695.99€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#15min | 4154 | +0.167 | +2695.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 807 | +0.182 | +553.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 807 | +0.182 | +553.90€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 553 | +0.161 | +318.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 553 | +0.161 | +318.48€ | 1 | 23 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 798 | +0.216 | +655.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 798 | +0.216 | +655.60€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 409 | +0.142 | +202.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 409 | +0.142 | +202.15€ | 1 | 23 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 657 | +0.072 | +285.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 657 | +0.072 | +285.94€ | 1 | 15 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 930 | +0.192 | +679.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 930 | +0.192 | +679.91€ | 0 | 25 |
...
| ✅ LIQUIDACIONES_60M | 309 | -0.005 | -6.79€ | 2 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 309 | -0.005 | -6.79€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC | 104 | -0.009 | -7.60€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC#60min | 104 | -0.009 | -7.60€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#ETH | 101 | -0.024 | -2.63€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#ETH#60min | 101 | -0.024 | -2.63€ | 2 | 0 |
| ✅ LIQUIDACIONES_60M#SOL | 104 | +0.019 | +3.44€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 104 | +0.019 | +3.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M | 947 | +0.028 | +28.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 947 | +0.028 | +28.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 131 | +0.086 | +30.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 131 | +0.086 | +30.25€ | 1 | 6 |
| ✅ MOMENTUM_IBS_15M#BTC | 172 | +0.075 | +22.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 172 | +0.075 | +22.11€ | 0 | 4 |
| ✅ MOMENTUM_IBS_15M#DOGE | 145 | +0.010 | -12.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 145 | +0.010 | -12.12€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 177 | +0.036 | +19.01€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 177 | +0.036 | +19.01€ | 0 | 1 |
| ✅ MOMENTUM_IBS_15M#SOL | 158 | -0.025 | -18.95€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 158 | -0.025 | -18.95€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 164 | -0.012 | -12.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 164 | -0.012 | -12.20€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 1244 | -0.041 | +30.24€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 1244 | -0.041 | +30.24€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 194 | -0.041 | +25.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 194 | -0.041 | +25.34€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 219 | -0.061 | -24.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 219 | -0.061 | -24.76€ | 8 | 1 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 199 | -0.007 | +39.21€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 199 | -0.007 | +39.21€ | 3 | 2 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 221 | -0.034 | -2.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 221 | -0.034 | -2.56€ | 4 | 2 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 203 | -0.051 | +7.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 203 | -0.051 | +7.76€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 208 | -0.048 | -14.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 208 | -0.048 | -14.76€ | 6 | 1 |
| ✅ MOMENTUM_IBS_15M_FADE | 416 | -0.055 | -24.29€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 416 | -0.055 | -24.29€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 84 | -0.081 | -7.87€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 84 | -0.081 | -7.87€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 3493 | -0.059 | +164.51€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 3493 | -0.059 | +164.51€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 515 | -0.084 | +63.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 515 | -0.084 | +63.70€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 673 | -0.050 | +75.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 673 | -0.050 | +75.09€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 529 | -0.069 | +1.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 529 | -0.069 | +1.12€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 606 | -0.067 | -19.66€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 606 | -0.067 | -19.66€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 630 | -0.040 | -13.51€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 630 | -0.040 | -13.51€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 540 | -0.050 | +57.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 540 | -0.050 | +57.77€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 3029 | +0.013 | +13.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 3029 | +0.013 | +13.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 522 | +0.023 | +12.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 522 | +0.023 | +12.06€ | 2 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 400 | +0.035 | +7.26€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 400 | +0.035 | +7.26€ | 1 | 1 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 537 | +0.010 | -0.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 537 | +0.010 | -0.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 513 | -0.003 | -3.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 513 | -0.003 | -3.99€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 537 | +0.008 | -0.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 537 | +0.008 | -0.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 520 | +0.011 | -1.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 520 | +0.011 | -1.43€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 270 | +0.088 | +55.62€ | 1 | 4 |
| ✅ ORDER_FLOW_5M#5min | 134 | +0.118 | +43.03€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M | 1968 | +0.016 | -3.00€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 1968 | +0.016 | -3.00€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 746 | +0.008 | -7.91€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 746 | +0.008 | -7.91€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 769 | +0.023 | +3.69€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 769 | +0.023 | +3.69€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 453 | +0.019 | +1.23€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 453 | +0.019 | +1.23€ | 2 | 0 |
| ✅ UPDOWN_GBM | 2686 | +0.029 | +208.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1150 | +0.086 | +209.36€ | 1 | 9 |
| ✅ UPDOWN_GBM#240min | 128 | +0.008 | -2.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 1099 | -0.007 | +8.36€ | 3 | 0 |
| ✅ UPDOWN_GBM#60min | 262 | -0.015 | -6.84€ | 3 | 0 |
| ✅ UPDOWN_GBM#BNB | 115 | +0.133 | +35.50€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 108 | +0.154 | +37.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 6 | -0.075 | -2.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 517 | +0.043 | +58.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 139 | +0.074 | +8.67€ | 2 | 12 |
| ✅ UPDOWN_GBM#BTC#240min | 39 | +0.061 | +2.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 232 | +0.068 | +51.26€ | 2 | 8 |
| ✅ UPDOWN_GBM#BTC#60min | 89 | -0.038 | -5.89€ | 1 | 1 |
...
| ✅ UPDOWN_GBM#ETH | 630 | +0.054 | +62.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 264 | +0.120 | +63.26€ | 1 | 17 |
| ✅ UPDOWN_GBM#ETH#240min | 40 | +0.048 | +0.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 205 | +0.012 | -0.25€ | 5 | 1 |
| ✅ UPDOWN_GBM#ETH#60min | 106 | +0.009 | -1.22€ | 0 | 1 |
| 🚫 UPDOWN_GBM#ETH#daily | 15 | -0.154 | -0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 511 | -0.001 | +2.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 222 | +0.018 | +4.02€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 31 | -0.045 | -3.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 179 | +0.008 | +1.11€ | 2 | 4 |
| ✅ UPDOWN_GBM#SOL#60min | 67 | -0.022 | +0.27€ | 0 | 0 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 602 | +0.013 | +52.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 353 | +0.077 | +79.45€ | 0 | 10 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1865 | -0.053 | +472.13€ | 2 | 3 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1865 | -0.053 | +472.13€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 134 | -0.059 | +107.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 134 | -0.059 | +107.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 360 | -0.135 | -12.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 360 | -0.135 | -12.39€ | 3 | 2 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 605 | -0.024 | +234.70€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 605 | -0.024 | +234.70€ | 2 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.130) — sin ventaja clara. oversold(IBS<0.3): IC=-0.009 n=936 | neutral: IC=+0.021 n=889 | overbought(IBS>0.7): IC=+0.122 n=1180
  - _Datos_: n=3228 IC=+0.050 PNL=+338.92€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.098 n=44113 | tras_1loss IC=+0.057 n=31853 | tras_2loss IC=+0.017 n=14059/40 | gap=+0.081 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=28, boost estimado=-0.007. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=106/40 IC=+0.009 PNL=-1.22€ | BTC#60min: n=89/40 IC=-0.038 PNL=-5.89€ | SOL#60min: n=67/40 IC=-0.022 PNL=+0.27€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=+0.046 n=216 | contrario_BTC IC=+0.014 n=144/40 | gap=-0.032 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2450 IC=+0.022 PNL=+154.27€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2450 IC=+0.022 PNL=+154.27€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=203 IC=+0.012 PNL=+0.63€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=203 IC=+0.012 PNL=+0.63€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=139 IC=+0.074 PNL=+8.67€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=139 IC=+0.074 PNL=+8.67€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.086 > 0.08 con n=718 PNL=+115.31€
  - _Datos_: n=718 IC=+0.086 PNL=+115.31€
...
**⏳ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  ...
  - _Estado_: 16/20 ops en el filtro definido (IC actual=+0.178 PNL=+11.30€)
  - _Datos_: n=16 IC=+0.178 PNL=+11.30€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=173 IC=+0.060 PNL=+25.84€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=173 IC=+0.060 PNL=+25.84€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=607 IC=+0.083 PNL=+128.76€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=607 IC=+0.083 PNL=+128.76€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.02 con n=137 PNL=+55.94€
  - _Datos_: n=137 IC=+0.169 PNL=+55.94€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1018 IC=+0.026 PNL=+43.90€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1018 IC=+0.026 PNL=+43.90€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=225 IC=+0.073 PNL=+45.43€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=225 IC=+0.073 PNL=+45.43€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1625 IC=-0.143 PNL=+84.17€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1625 IC=-0.143 PNL=+84.17€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=357 IC=-0.010 PNL=+16.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=357 IC=-0.010 PNL=+16.97€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.199 > 0.08 con n=304 PNL=+173.15€
  - _Datos_: n=304 IC=+0.199 PNL=+173.15€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=594 IC=+0.013 PNL=+143.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=594 IC=+0.013 PNL=+143.38€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.133 > 0.08 con n=167 PNL=-14.13€
  - _Datos_: n=167 IC=+0.133 PNL=-14.13€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1285 IC=+0.092 PNL=-299.16€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1285 IC=+0.092 PNL=-299.16€
