# Hipótesis automáticas — 2026-06-29 16:02 UTC
_Generado por shadow_postmortem.py sobre 1280 resoluciones (PNL=-38.78€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.06` → IC=+0.150 (n=18)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `pct_spot_vs_ref` |x|≤ 0.06 (IC base=+0.027)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `drift_60min` |x|≤ `0.4329` → IC=+0.129 (n=33)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.4329 (IC base=+0.058)
...
| ✅ WEEKLY_PRICE | 53 | +0.027 | -11.35€ | 0 | 0 |
...
**🟡 H-WEEKLY** — Predicciones semanales de precio por par
  ...
  - _Estado_: ETH: n=20/15 IC=+0.045 PNL=-4.24€ | BTC: n=16/15 IC=-0.044 PNL=-6.36€ | SOL: n=17/15 IC=+0.067 PNL=-0.75€
...
**⏳ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: 26/40 ops con ibs_15. oversold(IBS<0.3): IC=-0.021 n=9 | neutral: IC=+0.018 n=5 | overbought(IBS>0.7): IC=+0.042 n=10
  - _Datos_: n=26 IC=+0.036 PNL=-0.56€

**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: 26 ops, 5 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 315/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=216 IC=+0.023 PNL=+6.21€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=216 IC=+0.023 PNL=+6.21€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=131 IC=+0.019 PNL=-3.80€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=131 IC=+0.019 PNL=-3.80€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=53 IC=+0.027 PNL=-0.96€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=53 IC=+0.027 PNL=-0.96€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.113 > 0.08 con n=60 PNL=+6.61€
  - _Datos_: n=60 IC=+0.113 PNL=+6.61€
