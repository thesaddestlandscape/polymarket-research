# Hipótesis automáticas — 2026-07-04 01:10 UTC
_Generado por shadow_postmortem.py sobre 3293 resoluciones (PNL=-17.42€)_
...
### UPDOWN_GBM#15min
- **FILTRO** `ibs_15` > `0.3448` → IC=-0.128 (n=49)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.3448
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=149)

- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.178 (n=88)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0097 (IC base=+0.024)

- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.147 (n=66)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.74€ cuando `ibs_15` < 0.0634 (IC base=+0.024)
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.173 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0091 (IC base=+0.080)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.140 (n=23)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 6.0 (IC base=+0.080)

- **PATRÓN** `ibs_15` < `0.0878` → IC=+0.198 (n=41)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.99€ cuando `ibs_15` < 0.0878 (IC base=+0.080)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0878 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.198 n=41). Confirma señal de reversión media → alinear con BUY_YES.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 572 | +0.063 | +85.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 572 | +0.063 | +85.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 149 | +0.017 | +4.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 149 | +0.017 | +4.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 150 | +0.007 | +3.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 150 | +0.007 | +3.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 143 | +0.100 | +34.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 143 | +0.100 | +34.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 130 | +0.136 | +43.15€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 130 | +0.136 | +43.15€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 891 | -0.043 | -58.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 659 | -0.023 | -30.80€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 359 | -0.015 | +2.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 274 | +0.000 | +9.46€ | 3 | 3 |
...
| ✅ UPDOWN_GBM#SOL | 151 | -0.082 | -11.97€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 91 | -0.070 | -7.88€ | 7 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.058) — sin ventaja clara. oversold(IBS<0.3): IC=-0.019 n=181 | neutral: IC=-0.077 n=147 | overbought(IBS>0.7): IC=-0.048 n=155
  - _Datos_: n=501 IC=-0.045 PNL=-33.36€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=91 IC=-0.070 PNL=-7.88€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.012 n=1587 | tras_1loss IC=-0.025 n=1602 | tras_2loss IC=-0.043 n=822/40 | gap=+0.055 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=768 IC=-0.039 PNL=-45.04€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=768 IC=-0.039 PNL=-45.04€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=284 IC=-0.025 PNL=-38.14€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=284 IC=-0.025 PNL=-38.14€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=247 IC=+0.002 PNL=+5.63€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=247 IC=+0.002 PNL=+5.63€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=860 IC=+0.035 PNL=+68.15€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=860 IC=+0.035 PNL=+68.15€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=53 IC=-0.045 PNL=-13.16€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=53 IC=-0.045 PNL=-13.16€
