# Hipótesis automáticas — 2026-07-10 23:45 UTC
_Generado por shadow_postmortem.py sobre 8311 resoluciones (PNL=+1281.65€)_
...
- **PATRÓN** `ibs_15` > `0.7103` → IC=+0.126 (n=193)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.63€ cuando `ibs_15` > 0.7103 (IC base=+0.002)

- **PATRÓN** `ibs_15` < `0.0487` → IC=+0.131 (n=120)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.0487 (IC base=+0.028)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0664` → IC=+0.133 (n=47)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.0664 (IC base=+0.037)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.149 (n=112)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 11.0 (IC base=+0.037)

- **PATRÓN** `ibs_15` < `0.908` → IC=+0.131 (n=101)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.908 (IC base=+0.037)

- **PATRÓN** `ibs_15` > `0.6323` → IC=+0.131 (n=101)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` > 0.6323 (IC base=+0.037)
...
- **PATRÓN** `ibs_15` > `0.8278` → IC=+0.184 (n=55)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` > 0.8278 (IC base=+0.016)
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#60min` — IC=+0.316 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 225 | +0.192 | +1.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 144 | +0.212 | +1.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 7 | +0.058 | +0.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 38 | -0.025 | -6.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 36 | +0.316 | +6.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 70 | +0.181 | -0.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 46 | +0.229 | +0.46€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 12 | +0.171 | +2.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 77 | +0.196 | +2.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 49 | +0.226 | +2.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 14 | +0.044 | -1.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 12 | +0.171 | +2.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 78 | +0.188 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 49 | +0.167 | -2.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 14 | +0.044 | -1.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 12 | +0.171 | +1.88€ | 0 | 0 |
| ✅ GBM_LATE_15M | 3036 | +0.114 | +976.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 3036 | +0.114 | +976.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 762 | +0.064 | +79.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 762 | +0.064 | +79.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 773 | +0.073 | +120.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 773 | +0.073 | +120.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 783 | +0.148 | +404.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 783 | +0.148 | +404.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 718 | +0.174 | +371.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 718 | +0.174 | +371.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 467 | +0.174 | +218.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 467 | +0.174 | +218.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 116 | +0.229 | +80.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 116 | +0.229 | +80.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 128 | +0.154 | +50.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 128 | +0.154 | +50.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 134 | +0.081 | +16.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 134 | +0.081 | +16.48€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 580 | +0.069 | +100.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 580 | +0.069 | +100.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 138 | +0.100 | +16.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 138 | +0.100 | +16.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 146 | +0.000 | +1.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 146 | +0.000 | +1.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 146 | -0.034 | -1.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 146 | -0.034 | -1.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 150 | +0.204 | +83.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 150 | +0.204 | +83.87€ | 0 | 0 |
| ✅ GBM_LATE_60M | 245 | -0.115 | +7.87€ | 0 | 0 |
| ✅ GBM_LATE_60M#60min | 245 | -0.115 | +7.87€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 81 | -0.066 | +2.37€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 81 | -0.066 | +2.37€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH | 77 | -0.146 | -5.92€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 77 | -0.146 | -5.92€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL | 87 | -0.129 | +11.43€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 87 | -0.129 | +11.43€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 121 | +0.118 | +18.64€ | 0 | 0 |
| ✅ STREAK_FADE_15M#15min | 121 | +0.118 | +18.64€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH | 25 | +0.241 | +11.91€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH#15min | 25 | +0.241 | +11.91€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL | 43 | +0.100 | +5.03€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL#15min | 43 | +0.100 | +5.03€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1245 | -0.016 | -4.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 990 | +0.013 | +32.17€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 335 | -0.002 | -6.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 257 | +0.037 | +6.23€ | 2 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 597 | +0.006 | +20.78€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 504 | +0.026 | +31.83€ | 0 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.101) — sin ventaja clara. oversold(IBS<0.3): IC=-0.022 n=314 | neutral: IC=-0.055 n=243 | overbought(IBS>0.7): IC=+0.046 n=260
  - _Datos_: n=855 IC=-0.004 PNL=+20.45€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.177 n=29 PNL=-7.49€ → FILTRAR | H=07h: IC=+0.106 n=31 PNL=+8.42€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=101 IC=-0.063 PNL=-7.89€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.078 n=4555 | tras_1loss IC=+0.029 n=3621 | tras_2loss IC=-0.009 n=1676/40 | gap=+0.086 (umbral 0.05)
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.021 n=115 | contrario_BTC IC=-0.069 n=56/40 | gap=-0.048 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1122 IC=-0.010 PNL=+8.77€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1122 IC=-0.010 PNL=+8.77€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=560 IC=+0.002 PNL=-0.48€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=560 IC=+0.002 PNL=-0.48€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=257 IC=+0.037 PNL=+6.23€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=257 IC=+0.037 PNL=+6.23€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=496 IC=+0.032 PNL=+14.05€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=496 IC=+0.032 PNL=+14.05€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=406 IC=+0.010 PNL=+14.19€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=406 IC=+0.010 PNL=+14.19€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.220 > 0.08 con n=48 PNL=+10.53€
  - _Datos_: n=48 IC=+0.220 PNL=+10.53€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5853 IC=+0.087 PNL=+1357.53€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5853 IC=+0.087 PNL=+1357.53€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=707 IC=-0.030 PNL=-30.95€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=707 IC=-0.030 PNL=-30.95€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.161 > 0.1 con n=216 PNL=+69.77€
  - _Datos_: n=216 IC=+0.161 PNL=+69.77€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=142 IC=+0.056 PNL=+5.98€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=142 IC=+0.056 PNL=+5.98€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=394 IC=+0.048 PNL=+29.33€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=394 IC=+0.048 PNL=+29.33€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.165 > 0.08 con n=156 PNL=+45.77€
  - _Datos_: n=156 IC=+0.165 PNL=+45.77€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 67/80 ops en el filtro definido (IC actual=+0.225 PNL=+22.54€)
  - _Datos_: n=67 IC=+0.225 PNL=+22.54€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 73/100 ops en el filtro definido (IC actual=+0.340 PNL=+51.37€)
  - _Datos_: n=73 IC=+0.340 PNL=+51.37€
