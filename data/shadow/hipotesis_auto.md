# Hipótesis automáticas — 2026-07-12 13:17 UTC
_Generado por shadow_postmortem.py sobre 10950 resoluciones (PNL=+1963.04€)_
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.216 (n=167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 9.0 (IC base=+0.149)

- **PATRÓN** `py_entrada` < `0.275` → IC=+0.315 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=395)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `5850.3139` → IC=+0.175 (n=158)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 5850.3139 (IC base=+0.149)
...
- **PATRÓN** `py_entrada` < `0.235` → IC=+0.362 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.235 (IC base=+0.229)

- **PATRÓN** `libro_liquidez` > `6496.7981` → IC=+0.253 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6496.7981 (IC base=+0.229)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.214 (n=33)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1648.9469` → IC=+0.216 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1648.9469 (IC base=+0.187)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=1336)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.116)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.121 (n=1332)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 17.0 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `0.4454` → IC=+0.132 (n=36)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.4454 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.1403` → IC=+0.204 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1403 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.656` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.656 (IC base=+0.116)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.148 (n=917)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0092 (IC base=+0.110)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.140 (n=938)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.505` → IC=+0.177 (n=122)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.505 (IC base=+0.110)
...
- **PATRÓN** `dist_vwap_pct` > `0.4125` → IC=+0.167 (n=19)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.4125 (IC base=+0.091)
...
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.167 (n=115)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0094 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.184 (n=115)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0149 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.213 (n=235)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.0879` → IC=+0.262 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0879 (IC base=+0.152)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` < `0.032` → IC=+0.180 (n=304)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.032 (IC base=+0.165)

- **PATRÓN** `sigma_h` > `0.0141` → IC=+0.178 (n=271)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0141 (IC base=+0.165)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.182 (n=209)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 11.0 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` < `0.1365` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1365 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0173` → IC=+0.188 (n=229)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0173 (IC base=+0.179)

- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.189 (n=342)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0117 (IC base=+0.179)
...
- **PATRÓN** `dist_vwap_pct` < `0.088` → IC=+0.241 (n=25)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.088 (IC base=+0.179)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.186 (n=317)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.4215` → IC=+0.188 (n=30)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.4215 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.1193` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.1193 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.685` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.685 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.171 (n=357)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.2165` → IC=+0.270 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2165 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.174 (n=87)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0055 (IC base=+0.175)

- **PATRÓN** `sigma_h` > `0.0024` → IC=+0.230 (n=87)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0024 (IC base=+0.175)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 5.0 (IC base=+0.175)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.181 (n=89)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 16.0 (IC base=+0.175)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.149 (n=35)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0034 (IC base=+0.143)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.176 (n=69)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0049 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.162 (n=72)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 12.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.192 (n=50)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 8.0 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.4153` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4153 (IC base=+0.143)
...
- **PATRÓN** `sigma_h` < `0.0187` → IC=+0.321 (n=65)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0187 (IC base=+0.261)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.304 (n=44)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.261)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.312 (n=62)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0088 (IC base=+0.277)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.278 (n=70)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.150 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0127 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` < `0.503` → IC=+0.139 (n=117)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.503 (IC base=+0.083)
...
- **PATRÓN** `py_entrada` < `0.485` → IC=+0.182 (n=42)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` < 0.485 (IC base=+0.092)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=344)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.124 (n=235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 13.0 (IC base=+0.019)

- **PATRÓN** `ibs_15` > `0.5859` → IC=+0.122 (n=289)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` > 0.5859 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.1647` → IC=+0.212 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1647 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` < `0.3774` → IC=+0.189 (n=101)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.3774 (IC base=+0.019)

- **PATRÓN** `ibs_15` < `0.0334` → IC=+0.144 (n=99)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` < 0.0334 (IC base=+0.029)
...
- **PATRÓN** `ibs_15` > `0.7622` → IC=+0.209 (n=84)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7622 (IC base=+0.030)

- **PATRÓN** `dist_vwap_pct` < `0.5087` → IC=+0.172 (n=62)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.5087 (IC base=+0.030)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS > 0.7622 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.209 n=84). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 898 | +0.184 | +13.42€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 575 | +0.212 | +11.15€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 263 | +0.194 | +3.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 191 | +0.215 | -2.19€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 318 | +0.172 | +6.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 190 | +0.213 | +7.78€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 315 | +0.188 | +3.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 192 | +0.206 | +5.51€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 3585 | +0.113 | +1169.36€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 3585 | +0.113 | +1169.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 882 | +0.070 | +115.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 882 | +0.070 | +115.81€ | 0 | 1 |
| ✅ GBM_LATE_15M#ETH | 909 | +0.072 | +137.55€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 909 | +0.072 | +137.55€ | 0 | 2 |
| ✅ GBM_LATE_15M#SOL | 934 | +0.138 | +457.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 934 | +0.138 | +457.07€ | 0 | 8 |
| ✅ GBM_LATE_15M#XRP | 860 | +0.173 | +458.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 860 | +0.173 | +458.93€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 947 | +0.161 | +497.31€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 947 | +0.161 | +497.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 248 | +0.168 | +162.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 248 | +0.168 | +162.31€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 255 | +0.119 | +79.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 255 | +0.119 | +79.03€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 266 | +0.116 | +80.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 266 | +0.116 | +80.43€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 178 | +0.272 | +175.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 178 | +0.272 | +175.54€ | 0 | 5 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1116 | +0.081 | +268.01€ | 1 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1116 | +0.081 | +268.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 258 | +0.077 | +35.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 258 | +0.077 | +35.03€ | 0 | 1 |
...
| ✅ STREAK_FADE_15M | 150 | +0.112 | +17.60€ | 0 | 7 |
| ✅ STREAK_FADE_15M#15min | 150 | +0.112 | +17.60€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1320 | -0.006 | +28.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1064 | +0.024 | +66.13€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#ETH | 651 | +0.015 | +36.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 558 | +0.034 | +47.57€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.121) — sin ventaja clara. oversold(IBS<0.3): IC=-0.022 n=341 | neutral: IC=-0.046 n=258 | overbought(IBS>0.7): IC=+0.075 n=290
  - _Datos_: n=930 IC=+0.009 PNL=+53.90€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6178 | tras_1loss IC=+0.045 n=4635 | tras_2loss IC=+0.011 n=2081/40 | gap=+0.080 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.130 n=71/60 | contraria IC=+0.065 n=21 | gap=+0.065 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.087 n=463/40 PNL=+104.68€ | H=15h UTC: IC=+0.087 n=444/40 PNL=+95.17€ | H=17h UTC: IC=+0.122 n=382/40 PNL=+123.97€ | H=19h UTC: IC=+0.063 n=385/40 PNL=+49.78€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1193 IC=+0.000 PNL=+42.66€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1193 IC=+0.000 PNL=+42.66€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=605 IC=+0.019 PNL=+30.57€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=605 IC=+0.019 PNL=+30.57€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=547 IC=+0.054 PNL=+48.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=547 IC=+0.054 PNL=+48.97€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8492 IC=+0.096 PNL=+2038.92€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8492 IC=+0.096 PNL=+2038.92€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=752 IC=-0.015 PNL=+0.10€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=752 IC=-0.015 PNL=+0.10€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.177 > 0.1 con n=267 PNL=+103.77€
  - _Datos_: n=267 IC=+0.177 PNL=+103.77€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=452 IC=+0.055 PNL=+37.48€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=452 IC=+0.055 PNL=+37.48€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.180 > 0.08 con n=201 PNL=+76.82€
  - _Datos_: n=201 IC=+0.180 PNL=+76.82€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.244 n=84) pero sin cruzar ≥2 pares más — ETH: n=105 IC=+0.145 ✓; SOL: n=7 IC=-0.019; XRP: n=5 IC=+0.018
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.158 < -0.1 con n=311 PNL=-40.78€
  - _Datos_: n=311 IC=-0.158 PNL=-40.78€
...
**⏳ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 9/40 ops en el filtro definido (IC actual=+0.061 PNL=+3.47€)
  - _Datos_: n=9 IC=+0.061 PNL=+3.47€

**⏳ H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: 40
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: 7/40 ops en el filtro definido (IC actual=+0.058 PNL=+9.74€)
  - _Datos_: n=7 IC=+0.058 PNL=+9.74€
...
**⏳ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: 12/40 ops en el filtro definido (IC actual=+0.086 PNL=+7.32€)
  - _Datos_: n=12 IC=+0.086 PNL=+7.32€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.155 > 0.08 con n=56 PNL=-3.24€
  - _Datos_: n=56 IC=+0.155 PNL=-3.24€
