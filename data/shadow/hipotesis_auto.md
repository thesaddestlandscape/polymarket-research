# Hipótesis automáticas — 2026-08-17 23:51 UTC
_Generado por shadow_postmortem.py sobre 55556 resoluciones (PNL=+5920.31€)_
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.156 (n=1400)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `5.42` → IC=+0.194 (n=443)

  - _Acción_: Kelly boost +0.97€ cuando `lag_apertura_s` < 5.42 (IC base=+0.147)
...
- **PATRÓN** `restante_min` > `4.88` → IC=+0.185 (n=230)

  - _Acción_: Kelly boost +0.93€ cuando `restante_min` > 4.88 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=699)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.157 (n=619)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 16.0 (IC base=+0.152)

- **PATRÓN** `lag_apertura_s` < `7.41` → IC=+0.186 (n=221)

  - _Acción_: Kelly boost +0.93€ cuando `lag_apertura_s` < 7.41 (IC base=+0.152)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.175 (n=592)

  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` < 0.43 (IC base=+0.143)

- **PATRÓN** `restante_min` < `3.84` → IC=+0.153 (n=223)

  - _Acción_: Kelly boost +0.77€ cuando `restante_min` < 3.84 (IC base=+0.143)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.204 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.95 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=701)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `profundidad_ratio_no` > `15.4` → IC=+0.188 (n=222)
...
- **FILTRO** `ibs_20min` < `0.44` → IC=-0.200 (n=18)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.161 (n=54)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 15.0 (IC base=+0.070)
...
- **FILTRO** `hora_utc` > `21.0` → IC=-0.152 (n=21)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `ibs_20min` < `0.9853` → IC=-0.148 (n=52)

  - _Acción_: SKIP cuando `ibs_20min` < 0.9853
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=28)

### MOMENTUM_IBS_5M
- **PATRÓN** `drift_7min_pct` |x|≤ `0.0394` → IC=+0.176 (n=66)

  - _Acción_: Kelly boost +0.88€ cuando `drift_7min_pct` |x|≤ 0.0394 (IC base=+0.030)
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.136 (n=31)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.167 (n=16)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 16.0 (IC base=-0.031)
...
- **PATRÓN** `drift_7min_pct` |x|≤ `0.0379` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `drift_7min_pct` |x|≤ 0.0379 (IC base=+0.026)

### MOMENTUM_IBS_5M_BALLENA
- **FILTRO** `ibs_7min` < `0.8889` → IC=-0.167 (n=100)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8889
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=210)

- **FILTRO** `hora_utc` > `22.0` → IC=-0.413 (n=21)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 22.0
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=144)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.342 (n=36)
...
- **FILTRO** `ballena_activa_n` > `3.0` → IC=-0.324 (n=15)

  - _Acción_: SKIP cuando `ballena_activa_n` > 3.0
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=17)

- **FILTRO** `libro_liquidez` < `9238.6663` → IC=-0.389 (n=16)

  - _Acción_: SKIP cuando `libro_liquidez` < 9238.6663
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=16)

### MOMENTUM_IBS_5M_FADE#BNB#5min
- **PATRÓN** `ibs_7min` > `0.9327` → IC=+0.141 (n=37)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_7min` > 0.9327 (IC base=+0.066)
...
- **PATRÓN** `hora_utc` > `20.0` → IC=+0.167 (n=16)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 20.0 (IC base=+0.089)
...
- **PATRÓN** `delta_ratio` |x|> `0.4012` → IC=+0.158 (n=118)
...
- **PATRÓN** `total_vol_5m` < `447.889` → IC=+0.294 (n=32)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 447.889 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.133 (n=145)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0054 (IC base=+0.095)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.138 (n=125)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0063 (IC base=+0.089)
...
- **FILTRO** `sigma_h` > `0.0057` → IC=-0.149 (n=72)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0023` → IC=+0.141 (n=51)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0023 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.157 (n=97)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.005 (IC base=+0.081)

- **PATRÓN** `sigma_h` > `0.006` → IC=+0.250 (n=42)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.006 (IC base=+0.117)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2` → IC=+0.247 (n=73)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.2 (IC base=+0.231)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.268 (n=54)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.231)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2` → IC=+0.240 (n=48)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.2 (IC base=+0.196)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.250 (n=46)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.196)

### UPDOWN_GBM_15M_TARDIO
- **FILTRO** `sigma_h` < `0.0041` → IC=-0.161 (n=237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0041
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=805)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0022` → IC=-0.193 (n=148)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0022
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.250 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0023 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0023` → IC=+0.244 (n=88)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0023 (IC base=+0.237)

### UPDOWN_GBM_IBS_ALTO#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.19` → IC=+0.229 (n=57)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.19 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.227 (n=64)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0021` → IC=+0.229 (n=57)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#SOL#15min` — IC=+0.105 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#SOL` — IC=+0.105 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 480 | +0.042 | +35.15€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min |
15€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 749 | +0.092 | +128.84€ | 0 | 2 |
| ✅ UPDOWN_GBM#240min | 108 | +0.027 | +0.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 488 | -0.061 | -46.17€ | 2 | 0 |
| ✅ UPDOWN_GBM#60min | 244 | -0.020 | -9.62€ | 3 | 0 |
| ✅ UPDOWN_GBM#BNB | 66 | +0.059 | +5.75€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 60 | +0.081 | +6.81€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 5 | -0.054 | -1.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 291 | -0.005 | -11.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 114 | +0.060 | -3.37€ | 0 | 1 |
| ✅ UPDOWN_GBM#BTC#240min | 31 | +0.076 | +2.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 44 | -0.065 | -3.21€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 84 | -0.058 | -9.22€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#SOL | 297 | -0.015 | -1.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 113 | +0.022 | +2.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#240min | 28 | +0.000 | -0.41€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 80 | -0.037 | -3.90€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 64 | -0.015 | +0.81€ | 1 | 0 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 385 | +0.032 | +50.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 240 | +0.099 | +68.76€ | 0 | 2 |
| ✅ UPDOWN_GBM#XRP#240min | 16 | -0.089 | -2.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 129 | -0.072 | -15.41€ | 0 | 0 |
| 🚫 UPDOWN_GBM#daily | 45 | -0.202 | +1.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 102 | +0.231 | -6.04€ | 0 | 2 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 102 | +0.231 | -6.04€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 67 | +0.196 | -11.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 67 | +0.196 | -11.69€ | 0 | 2 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 35 | +0.284 | +5.65€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 35 | +0.284 | +5.65€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 1495 | -0.040 | +158.23€ | 1 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1495 | -0.040 | +158.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 92 | -0.064 | +0.60€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 92 | -0.064 | +0.60€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 300 | -0.133 | +0.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 300 | -0.133 | +0.51€ | 1 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 123 | -0.004 | +19.25€ | 1 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 477 | +0.007 | +91.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 477 | +0.007 | +91.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 468 | -0.034 | +48.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 468 | -0.034 | +48.23€ | 1 | 0 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 131 | +0.237 | +55.22€ | 0 | 2 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 131 | +0.237 | +55.22€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 83 | +0.218 | +25.60€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 83 | +0.218 | +25.60€ | 0 | 3 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 48 | +0.260 | +29.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 48 | +0.260 | +29.62€ | 0 | 1 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.168: overbought→boost, oversold→filtro | oversold(IBS<0.3): IC=-0.036 n=567 | neutral: IC=-0.009 n=570 | overbought(IBS>0.7): IC=+0.132 n=802
  - _Datos_: n=2069 IC=+0.039 PNL=+134.50€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=-0.109 n=62 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.120 n=90 PNL=+25.02€ → BOOST | H=23h: IC=-0.140 n=98 PNL=-24.15€ → FILTRAR

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.022 < 0.08 — monitorear
  - _Datos_: n=113 IC=+0.022 PNL=+2.28€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=32844 | tras_1loss IC=+0.068 n=22425 | tras_2loss IC=+0.026 n=9644/40 | gap=+0.086 (umbral 0.05)
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=+0.046 n=106 | contrario_BTC IC=-0.027 n=53/40 | gap=-0.074 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1509 IC=+0.018 PNL=+78.84€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1509 IC=+0.018 PNL=+78.84€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=408 IC=+0.095 PNL=+51.15€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=408 IC=+0.095 PNL=+51.15€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.096 > 0.08 con n=478 PNL=+72.53€
  - _Datos_: n=478 IC=+0.096 PNL=+72.53€
...
**🟡 H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.103 > 0.1 con n=288 PNL=+77.52€
  - _Datos_: n=288 IC=+0.103 PNL=+77.52€
...
**⏳ H-CUSTOM-OF-VOLUMEN-ALTO** — ORDER_FLOW_5M con total_vol_5m alto — ¿volumen extremo mejora el IC?
  ...
  - _Estado_: 15/40 ops en el filtro definido (IC actual=+0.022 PNL=-0.25€)
  - _Datos_: n=15 IC=+0.022 PNL=-0.25€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=237 IC=+0.027 PNL=+11.87€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=237 IC=+0.027 PNL=+11.87€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=936 IC=+0.018 PNL=+16.49€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=936 IC=+0.018 PNL=+16.49€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.141 > 0.1 con n=525 PNL=+141.03€
  - _Datos_: n=525 IC=+0.141 PNL=+141.03€
...
**🟡 H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.117 > 0.1 con n=113 PNL=+36.82€
  - _Datos_: n=113 IC=+0.117 PNL=+36.82€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1027 IC=-0.124 PNL=+138.10€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1027 IC=-0.124 PNL=+138.10€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.095 > 0.08 con n=408 PNL=+51.15€
  - _Datos_: n=408 IC=+0.095 PNL=+51.15€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=690 IC=+0.168 PNL=+358.75€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=690 IC=+0.168 PNL=+358.75€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.247 > 0.08 con n=590 PNL=-66.57€
  - _Datos_: n=590 IC=+0.247 PNL=-66.57€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=947 IC=+0.098 PNL=-210.05€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=947 IC=+0.098 PNL=-210.05€
