# Hipótesis automáticas — 2026-09-01 16:26 UTC
_Generado por shadow_postmortem.py sobre 241111 resoluciones (PNL=+20685.08€)_
...
- **FILTRO** `restante_s_al_confirmar` < `156.47` → IC=-0.159 (n=911)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2736)
...
- **FILTRO** `restante_s_al_confirmar` < `153.55` → IC=-0.374 (n=786)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=1598)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.191 (n=7131)
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.258 (n=4404)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=3519)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1918.2624` → IC=+0.184 (n=2988)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1918.2624 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.201 (n=744)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.194)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=824)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.194 (n=1057)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.284 (n=401)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.273)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.273 (n=614)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.273)

- **PATRÓN** `py_entrada` < `0.195` → IC=+0.416 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.195 (IC base=+0.273)

- **PATRÓN** `libro_liquidez` > `2193.6078` → IC=+0.280 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2193.6078 (IC base=+0.273)
...
- **PATRÓN** `restante_min` < `3.97` → IC=+0.142 (n=2066)
...
- **PATRÓN** `restante_min` < `3.94` → IC=+0.149 (n=1033)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=3260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3503` → IC=+0.122 (n=3152)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.426` → IC=+0.147 (n=1210)
...
- **PATRÓN** `ibs_20min` < `0.4149` → IC=+0.120 (n=3108)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.4149 (IC base=+0.034)

- **PATRÓN** `dist_vwap_pct` > `0.5788` → IC=+0.133 (n=224)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.5788 (IC base=+0.034)

- **PATRÓN** `dist_vwap_pct` < `0.1336` → IC=+0.137 (n=977)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1336 (IC base=+0.034)

- **PATRÓN** `volumen_regimen` < `0.6773` → IC=+0.159 (n=464)
...
- **PATRÓN** `drift_60min` |x|≤ `0.078` → IC=+0.159 (n=203)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.078 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.145 (n=545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.637` → IC=+0.167 (n=608)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.637 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.1374` → IC=+0.164 (n=518)
...
- **PATRÓN** `volumen_regimen` < `0.618` → IC=+0.193 (n=203)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.618 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.0665` → IC=+0.193 (n=213)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.0665 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `2.4183` → IC=+0.166 (n=501)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4183 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.3872` → IC=+0.158 (n=501)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.3872 (IC base=+0.144)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.144 (n=787)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `12550.5978` → IC=+0.171 (n=405)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 12550.5978 (IC base=+0.144)
...
- **PATRÓN** `drift_60min` |x|≤ `0.461` → IC=+0.248 (n=514)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.461 (IC base=+0.241)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.249 (n=357)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5027` → IC=+0.275 (n=514)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9918` → IC=+0.220 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9918 (IC base=+0.241)

- **PATRÓN** `volumen_spike_ratio` > `2.5247` → IC=+0.226 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5247 (IC base=+0.241)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.241 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.241)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.227 (n=317)
...
- **FILTRO** `ibs_20min` > `0.8432` → IC=-0.182 (n=262)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=788)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.153 (n=70)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=980)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.205` → IC=-0.176 (n=183)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1428)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.141 (n=1796)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0077 (IC base=+0.058)

- **PATRÓN** `ibs_20min` > `0.2718` → IC=+0.125 (n=3961)
...
- **PATRÓN** `ibs_20min` < `0.59` → IC=+0.124 (n=3891)
...
- **PATRÓN** `volumen_regimen` < `0.8589` → IC=+0.230 (n=639)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2584` → IC=+0.348 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2584 (IC base=+0.046)

- **PATRÓN** `volumen_spike_ratio` > `2.4177` → IC=+0.287 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4177 (IC base=+0.046)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.275 (n=863)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.446` → IC=+0.318 (n=475)
...
- **PATRÓN** `volumen_spike_ratio` < `3.5266` → IC=+0.302 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.5266 (IC base=+0.314)

- **PATRÓN** `volumen_spike_ratio` > `2.3777` → IC=+0.341 (n=218)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.158 (n=74)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1074)
...
- **FILTRO** `ibs_20min` < `0.775` → IC=-0.151 (n=568)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2988` → IC=+0.280 (n=476)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2988 (IC base=+0.279)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.285 (n=674)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3651` → IC=+0.318 (n=714)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3651 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.5158` → IC=+0.281 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5158 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` < `0.2753` → IC=+0.283 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2753 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.221` → IC=+0.314 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.221 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` < `8.908` → IC=+0.278 (n=855)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 8.908 (IC base=+0.279)

- **PATRÓN** `volumen_regimen` < `0.6367` → IC=+0.292 (n=238)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1719` → IC=+0.296 (n=253)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1719 (IC base=+0.279)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5756` → IC=+0.171 (n=1097)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5756 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` > `2.6614` → IC=+0.196 (n=831)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.6614 (IC base=+0.179)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.176 (n=2074)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.175 (n=586)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.006 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.2333` → IC=+0.178 (n=516)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2333 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=543)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.4506` → IC=+0.192 (n=586)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.417` → IC=+0.236 (n=127)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.417 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6864` → IC=+0.219 (n=258)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4667` → IC=+0.167 (n=478)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4667 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.3935` → IC=+0.150 (n=478)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.3935 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `15479.8554` → IC=+0.167 (n=196)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 15479.8554 (IC base=+0.151)
...
- **PATRÓN** `volumen_spike_ratio` > `3.1577` → IC=+0.235 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1577 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1855.026` → IC=+0.237 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1855.026 (IC base=+0.234)
...
- **PATRÓN** `ibs_20min` < `0.31` → IC=+0.133 (n=458)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.206 (n=2453)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.4706` → IC=+0.194 (n=3677)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.240 (n=3678)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.4377` → IC=+0.173 (n=2602)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.4377 (IC base=+0.187)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.559` → IC=+0.189 (n=3606)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 3.559 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` < `0.6203` → IC=+0.181 (n=883)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6203 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` > `0.2382` → IC=+0.255 (n=581)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2382 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` > `2.3201` → IC=+0.201 (n=1347)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3201 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.179 (n=1703)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.169 (n=602)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0061 (IC base=+0.165)

- **PATRÓN** `drift_60min` |x|≤ `0.0805` → IC=+0.195 (n=201)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.0805 (IC base=+0.165)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.173 (n=601)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 17.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` < `0.5918` → IC=+0.198 (n=601)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.5918 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` < `0.1464` → IC=+0.177 (n=522)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.1464 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.74` → IC=+0.206 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.74 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.618` → IC=+0.249 (n=201)
...
- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.186 (n=505)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `11545.7195` → IC=+0.167 (n=400)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 11545.7195 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `287.0` → IC=+0.188 (n=136)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 287.0 (IC base=+0.165)
...
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.239 (n=255)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.240 (n=386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4206` → IC=+0.302 (n=493)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4206 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.351` → IC=+0.287 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.351 (IC base=+0.239)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9303` → IC=+0.222 (n=390)
...
- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.210 (n=353)
...
- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.179 (n=182)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0032 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.4454` → IC=+0.152 (n=544)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6715` → IC=+0.172 (n=544)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6715 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.1612` → IC=+0.136 (n=262)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.1612 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.3847` → IC=+0.134 (n=531)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.3847 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.36` → IC=+0.236 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.36 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.447` → IC=+0.134 (n=512)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 4.447 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.009` → IC=+0.140 (n=478)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.009 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `1.1365` → IC=+0.156 (n=181)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.1365 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2806` → IC=+0.268 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2806 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `1.8319` → IC=+0.146 (n=323)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.8319 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `2.5255` → IC=+0.165 (n=162)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.5255 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `11746.7684` → IC=+0.210 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11746.7684 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `186.0` → IC=+0.149 (n=411)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 186.0 (IC base=+0.134)
...
- **FILTRO** `ibs_20min` > `0.5` → IC=-0.122 (n=284)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.219 (n=586)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.182 (n=218)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0057 (IC base=+0.108)

- **PATRÓN** `drift_60min` |x|≤ `0.1269` → IC=+0.164 (n=218)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1269 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.136 (n=311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 15.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.219 (n=586)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` < `0.5176` → IC=+0.125 (n=617)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.5176 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.187` → IC=+0.125 (n=640)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.187 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `0.7116` → IC=+0.139 (n=289)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.7116 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.152 (n=202)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5492` → IC=+0.130 (n=222)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.5492 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` > `1.7854` → IC=+0.130 (n=336)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.7854 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `2673.0949` → IC=+0.171 (n=296)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2673.0949 (IC base=+0.108)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4625` → IC=+0.210 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4625 (IC base=+0.216)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.195 (n=571)
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.132 (n=1035)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0101 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.4383` → IC=+0.136 (n=1037)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.2696` → IC=+0.144 (n=1176)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.727` → IC=+0.125 (n=1087)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1727` → IC=+0.155 (n=323)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1727 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.449` → IC=+0.167 (n=388)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.449 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `2.6554` → IC=+0.146 (n=388)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2581` → IC=+0.169 (n=170)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.2581 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.191 (n=231)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 7.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.9524` → IC=+0.259 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9524 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.889` → IC=+0.241 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.889 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.149` → IC=+0.170 (n=231)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` < 3.149 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` < `0.0966` → IC=+0.160 (n=233)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.0966 (IC base=+0.157)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6341` → IC=+0.201 (n=85)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6341 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `2.9485` → IC=+0.175 (n=115)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.9485 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `1793.9526` → IC=+0.175 (n=229)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 1793.9526 (IC base=+0.157)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.151 (n=193)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0052 (IC base=+0.127)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.129 (n=435)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0047 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.4` → IC=+0.134 (n=383)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.4 (IC base=+0.127)
...
- **PATRÓN** `ibs_20min` > `0.1792` → IC=+0.138 (n=435)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.1792 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.8995` → IC=+0.155 (n=114)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.8995 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.2349` → IC=+0.130 (n=352)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.07` → IC=+0.130 (n=438)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 7.07 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `0.657` → IC=+0.146 (n=145)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.657 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` > `0.9115` → IC=+0.127 (n=290)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` > 0.9115 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` > `0.1742` → IC=+0.157 (n=135)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1742 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` < `1.4166` → IC=+0.169 (n=143)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4166 (IC base=+0.127)
...
- **PATRÓN** `libro_liquidez` > `8873.6006` → IC=+0.136 (n=388)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 8873.6006 (IC base=+0.127)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.180 (n=1240)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=3735)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.198 (n=1207)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=3996)

- **FILTRO** `ibs_20min` > `0.2703` → IC=-0.155 (n=1300)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2703
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=3903)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.200 (n=248)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=534)

- **FILTRO** `ibs_20min` < `0.7187` → IC=-0.190 (n=195)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.144 (n=3603)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=8742)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.284 (n=3029)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=9316)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.245 (n=3082)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=9263)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.170 (n=4197)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=8148)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.224 (n=3620)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=11900)

- **FILTRO** `ibs_7min` > `0.7308` → IC=-0.171 (n=3879)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7308
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=11641)
...
- **FILTRO** `py_entrada` > `0.71` → IC=-0.227 (n=668)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=2044)

- **FILTRO** `drift_7min_pct` |x|> `0.1158` → IC=-0.134 (n=922)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1158
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1790)

- **FILTRO** `ibs_7min` > `0.2946` → IC=-0.170 (n=922)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2946
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1790)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.145 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=1826)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=544)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1795)

- **FILTRO** `ibs_7min` < `0.7751` → IC=-0.184 (n=584)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7751
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1755)

- **FILTRO** `ballena_activa_n` > `163.0` → IC=-0.189 (n=584)

  - _Acción_: SKIP cuando `ballena_activa_n` > 163.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1755)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.224 (n=578)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1794)

- **FILTRO** `ballena_activa_n` > `104.0` → IC=-0.176 (n=806)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.233 (n=638)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2100)

- **FILTRO** `ibs_7min` > `0.8113` → IC=-0.175 (n=684)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8113
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=2054)
...
- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.190 (n=520)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=1598)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.254 (n=551)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=2145)

- **FILTRO** `ibs_7min` > `0.7975` → IC=-0.161 (n=673)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7975
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2023)
...
- **PATRÓN** `streak_estiramiento` < `0.3377` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `streak_estiramiento` < 0.3377 (IC base=+0.033)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=312)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=817)
...
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.169 (n=143)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.003 (IC base=+0.123)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.148 (n=143)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0063 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.1648` → IC=+0.132 (n=376)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.1648 (IC base=+0.123)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0656` → IC=+0.132 (n=427)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.66€ cuando `delta_ratio_macro` |x|> 0.0656 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.127 (n=285)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 12.0 (IC base=+0.123)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.162 (n=190)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 6.0 (IC base=+0.123)

- **PATRÓN** `ibs_15` > `0.55` → IC=+0.213 (n=427)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.55 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `0.3897` → IC=+0.175 (n=112)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3897 (IC base=+0.123)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.133 (n=450)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `8676.3608` → IC=+0.183 (n=143)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 8676.3608 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.200 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 50.0 (IC base=+0.123)
...
- **FILTRO** `ibs_15` < `0.6414` → IC=-0.204 (n=42)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.204 (n=86)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1911` → IC=+0.152 (n=44)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.76€ cuando `delta_ratio_macro` |x|> 0.1911 (IC base=+0.069)

- **PATRÓN** `ibs_15` > `0.6414` → IC=+0.204 (n=86)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6414 (IC base=+0.069)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.937` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 8.937 (IC base=+0.069)
...
- **PATRÓN** `ibs_15` < `0.1385` → IC=+0.181 (n=133)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` < 0.1385 (IC base=+0.029)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.134 (n=315)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=905)

- **FILTRO** `sigma_ewma_delta_pct` > `17.932` → IC=-0.158 (n=439)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.932
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3355)
...
- **PATRÓN** `dist_vwap_pct` < `0.1698` → IC=+0.230 (n=317)
...
- **PATRÓN** `sigma_h` < `0.0079` → IC=+0.266 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0079 (IC base=+0.224)

- **PATRÓN** `sigma_h` > `0.0052` → IC=+0.226 (n=155)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0052 (IC base=+0.224)

- **PATRÓN** `drift_60min` |x|≤ `0.4573` → IC=+0.231 (n=173)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4573 (IC base=+0.224)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0763` → IC=+0.226 (n=173)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0763 (IC base=+0.224)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.095` → IC=+0.246 (n=61)
...
- **PATRÓN** `ibs_15` < `0.3435` → IC=+0.306 (n=173)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3435 (IC base=+0.224)

- **PATRÓN** `dist_vwap_pct` > `0.7695` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7695 (IC base=+0.224)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.231 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.416` → IC=+0.261 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 10.416 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `11624.4939` → IC=+0.235 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11624.4939 (IC base=+0.224)

- **PATRÓN** `ballena_activa_n` < `188.0` → IC=+0.233 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 188.0 (IC base=+0.224)
...
- **FILTRO** `sigma_h` > `0.022` → IC=-0.272 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.118 (n=218)

- **FILTRO** `drift_15min` |x|> `1.1512` → IC=-0.250 (n=82)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.1512
  - _Potencial_: sin este filtro IC_bueno=-0.144 (n=248)

- **FILTRO** `sigma_ewma_delta_pct` > `15.666` → IC=-0.214 (n=40)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 15.666
  - _Potencial_: sin este filtro IC_bueno=-0.164 (n=290)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.55 sube el IC de +0.123 a +0.213 en UPDOWN_GBM#15min (n=427). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6414 sube el IC de +0.069 a +0.204 en UPDOWN_GBM#ETH#15min (n=86). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1385 sube el IC de +0.029 a +0.181 en UPDOWN_GBM#XRP#15min (n=133). Ya aplicado como kelly_boost=+0.91€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3453 sube el IC de -0.071 a +0.293 en UPDOWN_GBM_15M_TARDIO (n=336). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3435 sube el IC de +0.224 a +0.306 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=173). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 13369 | -0.106 | -2284.09€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 902 | -0.003 | -127.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 12467 | -0.114 | -2156.66€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1723 | -0.070 | -346.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1723 | -0.070 | -346.46€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 3647 | -0.063 | -366.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 3647 | -0.063 | -366.06€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2996 | -0.119 | -299.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2996 | -0.119 | -299.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2384 | -0.186 | -621.32€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2384 | -0.186 | -621.32€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 2934 | -0.058 | +1369.39€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 827 | -0.005 | +438.65€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 2107 | -0.078 | +930.74€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 2934 | -0.058 | +1369.39€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 827 | -0.005 | +438.65€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 2107 | -0.078 | +930.74€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 42742 | +0.113 | -2717.43€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 7353 | +0.187 | -227.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 133 | -0.100 | -55.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 31703 | +0.096 | -2383.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3553 | +0.119 | -51.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 5319 | +0.077 | -763.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 22 | -0.083 | +0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 9 | -0.143 | -7.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 5288 | +0.078 | -756.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 8644 | +0.132 | -188.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2131 | +0.201 | -76.63€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 5261 | +0.106 | -148.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1210 | +0.130 | +57.97€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 5333 | +0.081 | -673.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 26 | +0.036 | +0.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#240min | 6 | -0.075 | -4.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 5301 | +0.082 | -669.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 9292 | +0.127 | -116.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2699 | +0.173 | +0.85€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 5290 | +0.112 | -79.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1291 | +0.097 | -29.77€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 8842 | +0.128 | -596.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2457 | +0.195 | -153.11€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 61 | +0.008 | -11.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 5272 | +0.096 | -353.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 
 | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 4331 | -0.013 | -76.02€ | 2 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 1676 | +0.015 | +84.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 298 | +0.090 | +64.78€ | 2 | 11 |
...
| ✅ UPDOWN_GBM#ETH | 1825 | -0.006 | -17.09€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 848 | +0.011 | +8.96€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#SOL | 2256 | -0.002 | -11.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 728 | +0.000 | -2.53€ | 1 | 3 |
| ✅ UPDOWN_GBM#SOL#240min | 82 | -0.012 | -3.53€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 1324 | +0.000 | -7.18€ | 4 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 110 | +0.000 | +1.45€ | 1 | 3 |
| ✅ UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 1198 | +0.010 | +79.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 677 | +0.048 | +109.46€ | 0 | 8 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 5014 | -0.071 | +989.24€ | 4 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 5014 | -0.071 | +989.24€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 432 | +0.150 | +211.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 432 | +0.150 | +211.87€ | 2 | 17 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1640 | -0.064 | +305.59€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1640 | -0.064 | +305.59€ | 3 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1541 | -0.092 | +211.03€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1541 | -0.092 | +211.03€ | 4 | 4 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.088) — sin ventaja clara. oversold(IBS<0.3): IC=+0.020 n=2889 | neutral: IC=+0.000 n=3108 | overbought(IBS>0.7): IC=+0.088 n=3169
  - _Datos_: n=9535 IC=+0.037 PNL=+920.97€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: (cache 323s) 90 celda(s) GATE OK de 2358 trackeadas

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.000 < 0.08 — monitorear
  - _Datos_: n=728 IC=+0.000 PNL=-2.53€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.071 n=134748 | tras_1loss IC=+0.046 n=106059 | tras_2loss IC=+0.008 n=48141/40 | gap=+0.062 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 7967 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.009 n=806 | contrario_BTC IC=-0.021 n=648/40 | gap=-0.013 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.135 > 0.08 con n=102 PNL=+27.83€
  - _Datos_: n=102 IC=+0.135 PNL=+27.83€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=7752 IC=+0.001 PNL=+115.88€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=7752 IC=+0.001 PNL=+115.88€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.123 > 0.1 con n=569 PNL=+156.08€
  - _Datos_: n=569 IC=+0.123 PNL=+156.08€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=298 IC=+0.090 PNL=+64.78€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=298 IC=+0.090 PNL=+64.78€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1654 IC=+0.027 PNL=+116.83€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1654 IC=+0.027 PNL=+116.83€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2113 IC=+0.015 PNL=+90.91€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2113 IC=+0.015 PNL=+90.91€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1814 IC=+0.024 PNL=+112.13€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1814 IC=+0.024 PNL=+112.13€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=529 IC=+0.029 PNL=+53.50€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=529 IC=+0.029 PNL=+53.50€
...
**🟡 H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.124 > 0.1 con n=91 PNL=+16.34€
  - _Datos_: n=91 IC=+0.124 PNL=+16.34€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=6601 IC=-0.147 PNL=+202.63€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=6601 IC=-0.147 PNL=+202.63€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=810 IC=+0.144 PNL=+408.06€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=810 IC=+0.144 PNL=+408.06€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.249 < -0.1 con n=730 PNL=-124.28€
  - _Datos_: n=730 IC=-0.249 PNL=-124.28€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=839 IC=-0.024 PNL=+56.70€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=839 IC=-0.024 PNL=+56.70€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.179 > 0.08 con n=745 PNL=+454.48€
  - _Datos_: n=745 IC=+0.179 PNL=+454.48€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.233 > 0.08 con n=1838 PNL=-180.16€
  - _Datos_: n=1838 IC=+0.233 PNL=-180.16€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=4041 IC=+0.141 PNL=-673.08€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=4041 IC=+0.141 PNL=-673.08€
