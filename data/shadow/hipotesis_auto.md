# Hipótesis automáticas — 2026-07-12 12:34 UTC
_Generado por shadow_postmortem.py sobre 10911 resoluciones (PNL=+1940.09€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.221 (n=292)
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.319 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `2363.0481` → IC=+0.233 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2363.0481 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=121)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.154)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.190 (n=253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 12.0 (IC base=+0.154)

- **PATRÓN** `py_entrada` < `0.275` → IC=+0.324 (n=117)
...
- **PATRÓN** `libro_liquidez` > `5897.7268` → IC=+0.179 (n=154)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 5897.7268 (IC base=+0.154)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.246 (n=65)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `6537.3705` → IC=+0.246 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6537.3705 (IC base=+0.223)

### FAVORITO_CONFIRMADO#ETH#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.306 (n=65)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.260 (n=73)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.258)

- **PATRÓN** `py_entrada` > `0.765` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.765 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `3061.4104` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3061.4104 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.224 (n=27)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.245` → IC=+0.278 (n=25)
...
- **PATRÓN** `py_entrada` > `0.715` → IC=+0.382 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.715 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1870.3552` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1870.3552 (IC base=+0.216)
...
- **PATRÓN** `py_entrada` > `0.405` → IC=+0.147 (n=15)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `py_entrada` > 0.405 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `2458.5408` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2458.5408 (IC base=+0.125)

### GBM_LATE_15M
- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.138 (n=437)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0151 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=1329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.115)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.120 (n=1325)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` < 17.0 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.1365` → IC=+0.210 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1365 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.034` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.034 (IC base=+0.115)

- **PATRÓN** `sigma_h` > `0.0121` → IC=+0.160 (n=624)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0121 (IC base=+0.110)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.140 (n=938)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.505` → IC=+0.175 (n=121)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.505 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.152 (n=110)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0045 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.4454` → IC=+0.132 (n=17)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.4454 (IC base=+0.091)

### GBM_LATE_15M#SOL#15min
- **PATRÓN** `sigma_h` < `0.0162` → IC=+0.137 (n=356)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0162 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.163 (n=161)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 16.0 (IC base=+0.121)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.133 (n=167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 8.0 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` < `0.1403` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1403 (IC base=+0.121)
...
- **PATRÓN** `sigma_h` < `0.032` → IC=+0.179 (n=303)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.032 (IC base=+0.164)

- **PATRÓN** `sigma_h` > `0.0141` → IC=+0.178 (n=271)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0141 (IC base=+0.164)
...
- **PATRÓN** `dist_vwap_pct` < `0.1365` → IC=+0.289 (n=17)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1365 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0173` → IC=+0.187 (n=228)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0173 (IC base=+0.178)

- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.189 (n=342)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0117 (IC base=+0.178)
...
- **PATRÓN** `dist_vwap_pct` < `0.088` → IC=+0.241 (n=25)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.088 (IC base=+0.178)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.186 (n=313)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.3858` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.3858 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.1193` → IC=+0.211 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1193 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.442` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.442 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.172 (n=355)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0045 (IC base=+0.153)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.184 (n=169)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 7.0 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.2052` → IC=+0.270 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2052 (IC base=+0.153)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.214 (n=89)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0028 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.188 (n=94)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 7.0 (IC base=+0.164)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.170 (n=101)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 18.0 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.164)
...
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.180 (n=48)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.164 (n=108)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.4503` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4503 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.150 (n=58)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0049 (IC base=+0.093)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.176 (n=35)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 6.0 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` < `0.505` → IC=+0.132 (n=17)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.505 (IC base=+0.093)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.195 (n=57)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0113 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `9.0` → IC=+0.151 (n=41)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 9.0 (IC base=+0.126)
...
- **PATRÓN** `sigma_h` < `0.0187` → IC=+0.318 (n=64)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0187 (IC base=+0.259)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.300 (n=43)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.259)

- **PATRÓN** `sigma_h` > `0.008` → IC=+0.303 (n=69)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.008 (IC base=+0.274)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.275 (n=69)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0136` → IC=+0.122 (n=141)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` > 0.0136 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` < `0.1095` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1095 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.483` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.483 (IC base=+0.075)

- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.147 (n=137)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0127 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` < `0.2033` → IC=+0.167 (n=91)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.2033 (IC base=+0.083)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.141 (n=37)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0035 (IC base=+0.013)
...
- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.184 (n=36)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0083 (IC base=+0.038)
...
- **PATRÓN** `dist_vwap_pct` < `0.1605` → IC=+0.208 (n=22)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1605 (IC base=+0.038)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.0333` → IC=+0.204 (n=106)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0333 (IC base=+0.183)

- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.201 (n=105)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.183)
...
- **PATRÓN** `dist_vwap_pct` < `0.1011` → IC=+0.184 (n=17)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1011 (IC base=+0.183)

- **PATRÓN** `sigma_h` > `0.0237` → IC=+0.250 (n=50)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0237 (IC base=+0.211)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=342)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.124 (n=235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 13.0 (IC base=+0.019)

- **PATRÓN** `ibs_15` > `0.7177` → IC=+0.154 (n=215)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.77€ cuando `ibs_15` > 0.7177 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.1647` → IC=+0.218 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1647 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` < `0.3774` → IC=+0.196 (n=100)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.3774 (IC base=+0.019)
...
- **PATRÓN** `ibs_15` > `0.7622` → IC=+0.209 (n=84)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7622 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.5087` → IC=+0.177 (n=60)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.5087 (IC base=+0.031)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7177 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.154 n=215). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 883 | +0.186 | +15.66€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 567 | +0.212 | +9.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 37 | +0.064 | +1.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 132 | +0.082 | -12.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 147 | +0.205 | +18.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 260 | +0.195 | +3.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 189 | +0.212 | -3.92€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 12 | +0.086 | +1.65€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 49 | +0.226 | +9.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 312 | +0.175 | +7.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 187 | +0.214 | +7.90€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.043 | -1.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 64 | +0.091 | -6.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 49 | +0.186 | +7.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 309 | +0.188 | +4.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 189 | +0.207 | +5.00€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 13 | +0.065 | +0.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 58 | +0.133 | -2.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 49 | +0.186 | +0.89€ | 0 | 2 |
| ✅ GBM_LATE_15M | 3577 | +0.113 | +1157.29€ | 0 | 8 |
| ✅ GBM_LATE_15M#15min | 3577 | +0.113 | +1157.29€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 882 | +0.070 | +115.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 882 | +0.070 | +115.81€ | 0 | 1 |
| ✅ GBM_LATE_15M#ETH | 906 | +0.072 | +135.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 906 | +0.072 | +135.86€ | 0 | 2 |
| ✅ GBM_LATE_15M#SOL | 931 | +0.137 | +450.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 931 | +0.137 | +450.61€ | 0 | 8 |
| ✅ GBM_LATE_15M#XRP | 858 | +0.172 | +455.01€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 858 | +0.172 | +455.01€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 939 | +0.161 | +492.89€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 939 | +0.161 | +492.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 247 | +0.171 | +164.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 247 | +0.171 | +164.35€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 252 | +0.122 | +81.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 252 | +0.122 | +81.20€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 264 | +0.113 | +75.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 264 | +0.113 | +75.72€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 176 | +0.270 | +171.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 176 | +0.270 | +171.62€ | 0 | 5 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1110 | +0.079 | +259.05€ | 1 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1110 | +0.079 | +259.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 258 | +0.077 | +35.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 258 | +0.077 | +35.03€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 276 | +0.000 | +1.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 276 | +0.000 | +1.81€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 289 | +0.036 | +32.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 289 | +0.036 | +32.72€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 287 | +0.199 | +189.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 287 | +0.199 | +189.49€ | 0 | 8 |
...
| ✅ UPDOWN_GBM | 1318 | -0.006 | +28.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1062 | +0.024 | +66.38€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#ETH | 649 | +0.015 | +36.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 556 | +0.034 | +47.83€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.124) — sin ventaja clara. oversold(IBS<0.3): IC=-0.021 n=340 | neutral: IC=-0.048 n=257 | overbought(IBS>0.7): IC=+0.075 n=290
  - _Datos_: n=928 IC=+0.009 PNL=+54.15€
...
**🟡 H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.130 n=71/60 | contraria IC=+0.045 n=20 | gap=+0.085 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6152 | tras_1loss IC=+0.044 n=4622 | tras_2loss IC=+0.010 n=2079/40 | gap=+0.080 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1191 IC=+0.000 PNL=+42.92€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1191 IC=+0.000 PNL=+42.92€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=603 IC=+0.019 PNL=+30.83€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=603 IC=+0.019 PNL=+30.83€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=546 IC=+0.053 PNL=+47.70€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=546 IC=+0.053 PNL=+47.70€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=50 IC=+0.077 PNL=+35.02€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=50 IC=+0.077 PNL=+35.02€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8453 IC=+0.096 PNL=+2015.98€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8453 IC=+0.096 PNL=+2015.98€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=750 IC=-0.015 PNL=+0.36€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=750 IC=-0.015 PNL=+0.36€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.178 > 0.1 con n=265 PNL=+104.02€
  - _Datos_: n=265 IC=+0.178 PNL=+104.02€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=364 IC=-0.066 PNL=+61.64€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=364 IC=-0.066 PNL=+61.64€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.182 > 0.08 con n=199 PNL=+77.07€
  - _Datos_: n=199 IC=+0.182 PNL=+77.07€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.244 n=84) pero sin cruzar ≥2 pares más — ETH: n=103 IC=+0.148 ✓; SOL: n=7 IC=-0.019; XRP: n=5 IC=+0.018
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.157 < -0.1 con n=310 PNL=-39.03€
  - _Datos_: n=310 IC=-0.157 PNL=-39.03€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.299 > 0.2 con n=137 PNL=+89.83€
  - _Datos_: n=137 IC=+0.299 PNL=+89.83€
...
**⏳ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 7/40 ops en el filtro definido (IC actual=+0.019 PNL=+0.03€)
  - _Datos_: n=7 IC=+0.019 PNL=+0.03€
...
**⏳ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: 11/40 ops en el filtro definido (IC actual=+0.064 PNL=+5.40€)
  - _Datos_: n=11 IC=+0.064 PNL=+5.40€
