# Hipótesis automáticas — 2026-07-29 15:27 UTC
_Generado por shadow_postmortem.py sobre 41919 resoluciones (PNL=+9055.56€)_
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.193 (n=1358)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0077 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.164 (n=1918)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.189` → IC=+0.243 (n=674)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.137 (n=439)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 7.0 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.4476` → IC=+0.172 (n=65)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.4476 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.697` → IC=+0.159 (n=86)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.697 (IC base=+0.107)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.195 (n=162)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0079 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.137 (n=348)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 11.0 (IC base=+0.118)

- **PATRÓN** `dist_vwap_pct` > `0.6615` → IC=+0.152 (n=90)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6615 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.301` → IC=+0.189 (n=133)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 7.301 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `8292.9308` → IC=+0.134 (n=255)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8292.9308 (IC base=+0.118)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.151 (n=499)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0077 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.149 (n=445)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 8.0 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` > `0.1896` → IC=+0.162 (n=190)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1896 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.441` → IC=+0.282 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.441 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `1874.2607` → IC=+0.160 (n=369)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1874.2607 (IC base=+0.119)
...
- **PATRÓN** `sigma_h` < `0.0169` → IC=+0.236 (n=468)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0169 (IC base=+0.225)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.236 (n=480)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.2694` → IC=+0.267 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2694 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.493` → IC=+0.357 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.493 (IC base=+0.225)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.219 (n=514)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.121 (n=1355)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.764` → IC=+0.239 (n=335)
...
- **PATRÓN** `dist_vwap_pct` > `0.4756` → IC=+0.136 (n=64)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.4756 (IC base=+0.073)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.355` → IC=+0.193 (n=73)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 12.355 (IC base=+0.073)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `12.266` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 12.266 (IC base=+0.051)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.134` → IC=+0.229 (n=164)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.134 (IC base=+0.047)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.175 (n=195)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0089 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.01` → IC=+0.171 (n=521)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.01 (IC base=+0.169)
...
- **PATRÓN** `dist_vwap_pct` > `0.4878` → IC=+0.230 (n=124)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4878 (IC base=+0.169)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.167 (n=448)
...
- **PATRÓN** `ibs_15` > `0.6011` → IC=+0.173 (n=664)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `ibs_15` > 0.6011 (IC base=+0.056)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.946` → IC=+0.151 (n=247)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 4.946 (IC base=+0.056)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6011 sube el IC de +0.056 a +0.173 en UPDOWN_GBM#15min (n=664). Ya aplicado como kelly_boost=+0.86€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 70 | +0.319 | +7.57€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 64 | +0.333 | +2.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 6 | +0.037 | +5.02€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 64 | +0.333 | +2.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 64 | +0.333 | +2.54€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 9050 | +0.095 | +2739.79€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 9050 | +0.095 | +2739.79€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 139 | +0.209 | +95.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 139 | +0.209 | +95.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2120 | +0.067 | +343.03€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2120 | +0.067 | +343.03€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 138 | +0.107 | +35.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 138 | +0.107 | +35.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1902 | +0.070 | +302.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1902 | +0.070 | +302.52€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2355 | +0.085 | +802.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2355 | +0.085 | +802.45€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2396 | +0.141 | +1161.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2396 | +0.141 | +1161.37€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 6249 | +0.121 | +3037.15€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 6249 | +0.121 | +3037.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 103 | +0.319 | +123.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 103 | +0.319 | +123.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1563 | +0.079 | +514.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1563 | +0.079 | +514.74€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 126 | +0.180 | +80.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 126 | +0.180 | +80.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1557 | +0.088 | +561.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1557 | +0.088 | +561.24€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1514 | +0.091 | +616.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1514 | +0.091 | +616.03€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1386 | +0.216 | +1140.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1386 | +0.216 | +1140.84€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 6242 | +0.068 | +1733.30€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 6242 | +0.068 | +1733.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 118 | +0.250 | +98.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 118 | +0.250 | +98.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1430 | +0.022 | +166.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1430 | +0.022 | +166.91€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 126 | +0.164 | +58.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 126 | +0.164 | +58.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1463 | +0.019 | +119.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1463 | +0.019 | +119.55€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1417 | +0.026 | +261.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1417 | +0.026 | +261.79€ | 1 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1688 | +0.163 | +1028.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1688 | +0.163 | +1028.54€ | 0 | 13 |
| ✅ GBM_LATE_5M | 965 | -0.033 | -3.53€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 965 | -0.033 | -3.53€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 217 | -0.025 | -6.71€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 217 | -0.025 | -6.71€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#XRP | 357 | +0.026 | +11.25€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 357 | +0.026 | +11.25€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 3094 | +0.038 | +293.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2830 | +0.054 | +332.91€ | 0 | 6 |
...
| ✅ UPDOWN_GBM#ETH | 1150 | +0.041 | +83.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1056 | +0.054 | +94.80€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2381 | +0.151 | +1047.18€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2381 | +0.151 | +1047.18€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 453 | +0.164 | +167.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 453 | +0.164 | +167.34€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.158: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.079 n=1832 | neutral: IC=+0.027 n=1433 | overbought(IBS>0.7): IC=+0.185 n=1724
  - _Datos_: n=5323 IC=+0.105 PNL=+1412.24€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=24962 | tras_1loss IC=+0.078 n=16714 | tras_2loss IC=+0.052 n=7009/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=313 IC=+0.002 PNL=-4.09€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=313 IC=+0.002 PNL=-4.09€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2957 IC=+0.042 PNL=+307.68€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2957 IC=+0.042 PNL=+307.68€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1166 IC=+0.056 PNL=+158.70€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1166 IC=+0.056 PNL=+158.70€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.088 > 0.08 con n=1483 PNL=+251.40€
  - _Datos_: n=1483 IC=+0.088 PNL=+251.40€
...
**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: n=460 IC=+0.065 PNL=+63.86€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=460 IC=+0.065 PNL=+63.86€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=5598 IC=+0.087 PNL=+1384.84€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5598 IC=+0.087 PNL=+1384.84€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1316 IC=+0.032 PNL=+128.15€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1316 IC=+0.032 PNL=+128.15€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=1091 PNL=+362.09€
  - _Datos_: n=1091 IC=+0.160 PNL=+362.09€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.118 > 0.08 con n=762 PNL=+204.95€
  - _Datos_: n=762 IC=+0.118 PNL=+204.95€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.209 > 0.2 con n=844 PNL=+513.62€
  - _Datos_: n=844 IC=+0.209 PNL=+513.62€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.094 > 0.08 con n=597 PNL=+138.00€
  - _Datos_: n=597 IC=+0.094 PNL=+138.00€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.124 > 0.08 con n=813 PNL=+386.88€
  - _Datos_: n=813 IC=+0.124 PNL=+386.88€
