# Hipótesis automáticas — 2026-07-15 22:03 UTC
_Generado por shadow_postmortem.py sobre 15992 resoluciones (PNL=+3246.92€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.193 (n=771)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.193 (n=963)
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.258 (n=163)
...
- **PATRÓN** `hora_utc` > `19.0` → IC=+0.206 (n=15)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.289 (n=17)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.161)

- **PATRÓN** `py_entrada` < `0.65` → IC=+0.200 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.65 (IC base=+0.161)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2309 | +0.175 | -37.15€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 1487 | +0.210 | +19.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 97 | +0.015 | -15.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 333 | +0.091 | -49.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 392 | +0.152 | +9.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 670 | +0.181 | -10.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 497 | +0.201 | -17.06€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 810 | +0.171 | -28.93€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 130 | +0.121 | -15.16€ | 0 | 6 |
...
| ✅ UPDOWN_GBM | 1566 | +0.010 | +74.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1308 | +0.037 | +111.24€ | 0 | 5 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 127 | -0.058 | -10.76€ | 7 | 0 |
| ✅ UPDOWN_GBM#BNB | 77 | +0.082 | +19.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 77 | +0.082 | +19.35€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 60 | +0.242 | +21.60€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 60 | +0.242 | +21.60€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.133) — sin ventaja clara. oversold(IBS<0.3): IC=+0.007 n=456 | neutral: IC=-0.014 n=350 | overbought(IBS>0.7): IC=+0.118 n=370
  - _Datos_: n=1243 IC=+0.040 PNL=+121.44€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.102 n=9273 | tras_1loss IC=+0.066 n=6506 | tras_2loss IC=+0.032 n=2795/40 | gap=+0.070 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1439 IC=+0.017 PNL=+88.20€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1439 IC=+0.017 PNL=+88.20€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=690 IC=+0.074 PNL=+88.52€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=690 IC=+0.074 PNL=+88.52€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13534 IC=+0.105 PNL=+3322.81€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13534 IC=+0.105 PNL=+3322.81€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.1 con n=394 PNL=+141.57€
  - _Datos_: n=394 IC=+0.169 PNL=+141.57€
