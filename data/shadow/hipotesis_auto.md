# Hipótesis automáticas — 2026-07-10 04:19 UTC
_Generado por shadow_postmortem.py sobre 7136 resoluciones (PNL=+982.66€)_
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 2741 | +0.115 | +909.42€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2741 | +0.115 | +909.42€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 289 | +0.046 | +29.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 289 | +0.046 | +29.28€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.063 n=3818 | tras_1loss IC=+0.019 n=3199 | tras_2loss IC=-0.013 n=1514/40 | gap=+0.076 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=4678 IC=+0.076 PNL=+1058.54€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4678 IC=+0.076 PNL=+1058.54€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.153 > 0.08 con n=226 PNL=+86.75€
  - _Datos_: n=226 IC=+0.153 PNL=+86.75€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.181 < -0.1 con n=299 PNL=-53.55€
  - _Datos_: n=299 IC=-0.181 PNL=-53.55€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 70/100 ops en el filtro definido (IC actual=+0.333 PNL=+44.13€)
  - _Datos_: n=70 IC=+0.333 PNL=+44.13€
