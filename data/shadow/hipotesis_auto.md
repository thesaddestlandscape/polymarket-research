# Hipótesis automáticas — 2026-07-11 11:37 UTC
_Generado por shadow_postmortem.py sobre 9099 resoluciones (PNL=+1445.08€)_
...
- **PATRÓN** `ibs_15` > `0.7067` → IC=+0.126 (n=196)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.63€ cuando `ibs_15` > 0.7067 (IC base=+0.002)
...
- **PATRÓN** `ibs_15` > `0.8268` → IC=+0.190 (n=56)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.95€ cuando `ibs_15` > 0.8268 (IC base=+0.014)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 440 | +0.165 | -24.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 282 | +0.172 | -26.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 16 | +0.044 | -0.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 70 | +0.069 | -6.16€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 152 | +0.162 | -3.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 95 | +0.180 | -4.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 5 | -0.018 | -0.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 28 | +0.100 | -1.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 24 | +0.192 | +2.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 157 | +0.167 | -11.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 95 | +0.149 | -12.16€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 3214 | +0.113 | +1043.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 3214 | +0.113 | +1043.89€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 831 | +0.145 | +424.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 831 | +0.145 | +424.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 761 | +0.178 | +408.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 761 | +0.178 | +408.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 613 | +0.147 | +268.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 613 | +0.147 | +268.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 159 | +0.177 | +98.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 159 | +0.177 | +98.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 168 | +0.129 | +57.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 168 | +0.129 | +57.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 176 | +0.067 | +24.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 176 | +0.067 | +24.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 110 | +0.250 | +87.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 110 | +0.250 | +87.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 757 | +0.077 | +161.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 757 | +0.077 | +161.91€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 194 | +0.020 | +14.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 194 | +0.020 | +14.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 193 | +0.218 | +127.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 193 | +0.218 | +127.76€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1256 | -0.015 | -1.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1001 | +0.013 | +35.01€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 607 | +0.006 | +22.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 514 | +0.025 | +33.48€ | 0 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.098) — sin ventaja clara. oversold(IBS<0.3): IC=-0.022 n=320 | neutral: IC=-0.052 n=246 | overbought(IBS>0.7): IC=+0.045 n=262
  - _Datos_: n=866 IC=-0.004 PNL=+23.29€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.079 n=5024 | tras_1loss IC=+0.035 n=3930 | tras_2loss IC=-0.001 n=1800/40 | gap=+0.080 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1133 IC=-0.009 PNL=+11.61€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1133 IC=-0.009 PNL=+11.61€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=566 IC=+0.002 PNL=+1.12€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=566 IC=+0.002 PNL=+1.12€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=502 IC=+0.032 PNL=+14.50€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=502 IC=+0.032 PNL=+14.50€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 38/40 ops en el filtro definido (IC actual=+0.075 PNL=+25.38€)
  - _Datos_: n=38 IC=+0.075 PNL=+25.38€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=6641 IC=+0.089 PNL=+1520.96€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=6641 IC=+0.089 PNL=+1520.96€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=713 IC=-0.030 PNL=-29.35€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=713 IC=-0.030 PNL=-29.35€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=224 PNL=+73.29€
  - _Datos_: n=224 IC=+0.159 PNL=+73.29€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.08 con n=162 PNL=+47.36€
  - _Datos_: n=162 IC=+0.159 PNL=+47.36€
