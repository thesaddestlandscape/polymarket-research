# Hipótesis automáticas — 2026-07-15 14:49 UTC
_Generado por shadow_postmortem.py sobre 15459 resoluciones (PNL=+3067.99€)_
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.310 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.198 (n=911)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `4405.4574` → IC=+0.193 (n=516)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 4405.4574 (IC base=+0.192)
...
- **PATRÓN** `py_entrada` < `0.265` → IC=+0.322 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=986)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `7377.4888` → IC=+0.183 (n=288)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 7377.4888 (IC base=+0.159)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.220 (n=123)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.256 (n=154)
...
- **PATRÓN** `py_entrada` < `0.225` → IC=+0.406 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.225 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `7250.1498` → IC=+0.207 (n=165)
...
- **PATRÓN** `py_entrada` < `0.605` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `py_entrada` < 0.605 (IC base=+0.161)

- **PATRÓN** `py_entrada` > `0.585` → IC=+0.167 (n=31)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.585 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `7023.9191` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 7023.9191 (IC base=+0.161)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.244 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.725` → IC=+0.346 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.233)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.240 (n=71)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` < `0.245` → IC=+0.370 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `3728.3706` → IC=+0.205 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3728.3706 (IC base=+0.204)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.281 (n=39)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.221)

- **PATRÓN** `py_entrada` < `0.575` → IC=+0.309 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.575 (IC base=+0.221)

- **PATRÓN** `py_entrada` > `0.655` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.655 (IC base=+0.221)

- **PATRÓN** `libro_liquidez` > `5381.0084` → IC=+0.219 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5381.0084 (IC base=+0.221)
...
- **PATRÓN** `py_entrada` < `0.375` → IC=+0.243 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.195)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.195 (n=221)
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.182 (n=20)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 9.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.66` → IC=+0.210 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.66 (IC base=+0.167)
...
### GBM_LATE_15M
- **PATRÓN** `dist_vwap_pct` > `0.6733` → IC=+0.121 (n=114)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` > 0.6733 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.135 (n=1177)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.941` → IC=+0.200 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.941 (IC base=+0.059)
...
- **PATRÓN** `dist_vwap_pct` > `0.7151` → IC=+0.176 (n=35)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.7151 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.0` → IC=+0.128 (n=49)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 5.0 (IC base=+0.064)

### GBM_LATE_15M#SOL#15min
- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.145 (n=201)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0108 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.141 (n=157)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 18.0 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.034` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.034 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.138 (n=296)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0115 (IC base=+0.129)

- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.137 (n=444)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0093 (IC base=+0.129)
...
- **PATRÓN** `sigma_h` < `0.0297` → IC=+0.143 (n=421)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0297 (IC base=+0.143)

- **PATRÓN** `sigma_h` > `0.023` → IC=+0.184 (n=191)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.023 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.151 (n=445)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.7064` → IC=+0.224 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7064 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.389` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 9.389 (IC base=+0.143)

- **PATRÓN** `sigma_h` > `0.0262` → IC=+0.202 (n=149)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.9646` → IC=+0.129 (n=157)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.9646 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.767` → IC=+0.124 (n=131)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 7.767 (IC base=+0.162)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0123` → IC=+0.232 (n=222)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0123 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.179 (n=469)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 12.0 (IC base=+0.163)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.170 (n=588)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 15.0 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.3729` → IC=+0.220 (n=155)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.183 (n=685)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.4443` → IC=+0.195 (n=460)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.4443 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.956` → IC=+0.224 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.956 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.119` → IC=+0.175 (n=343)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 3.119 (IC base=+0.162)
...
- **PATRÓN** `sigma_h` > `0.0027` → IC=+0.186 (n=173)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0027 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.179 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.3101` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.3101 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.1961` → IC=+0.139 (n=117)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1961 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.106` → IC=+0.300 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.106 (IC base=+0.142)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.232 (n=80)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.167 (n=121)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 12.0 (IC base=+0.146)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.163 (n=188)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.6633` → IC=+0.235 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6633 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.885` → IC=+0.400 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.885 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.139 (n=153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0067 (IC base=+0.131)

- **PATRÓN** `sigma_h` > `0.0042` → IC=+0.156 (n=155)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0042 (IC base=+0.131)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.172 (n=59)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 5.0 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.7422` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.7422 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `1.5721` → IC=+0.164 (n=129)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 1.5721 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.0` → IC=+0.191 (n=40)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 5.0 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.175` → IC=+0.163 (n=99)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 10.175 (IC base=+0.131)
...
- **PATRÓN** `sigma_h` > `0.013` → IC=+0.214 (n=82)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.013 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.149 (n=172)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 8.0 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.144 (n=158)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 15.0 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.4625` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4625 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `1.0918` → IC=+0.149 (n=129)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 1.0918 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.359` → IC=+0.259 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.359 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0082` → IC=+0.177 (n=63)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0082 (IC base=+0.103)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.157 (n=68)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 5.0 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` < `0.2503` → IC=+0.179 (n=104)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2503 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.243` → IC=+0.170 (n=95)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` < 3.243 (IC base=+0.103)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0148` → IC=+0.172 (n=202)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0148 (IC base=+0.105)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.127 (n=547)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 15.0 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.7076` → IC=+0.180 (n=98)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.7076 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.366` → IC=+0.329 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.366 (IC base=+0.105)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.136 (n=127)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 7.0 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` > `0.3646` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.3646 (IC base=+0.088)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.632` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 12.632 (IC base=+0.088)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.138 (n=67)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0043 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.6019` → IC=+0.141 (n=37)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6019 (IC base=+0.051)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.023` → IC=+0.342 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.023 (IC base=+0.051)
...
- **PATRÓN** `sigma_h` < `0.0324` → IC=+0.195 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0324 (IC base=+0.193)

- **PATRÓN** `sigma_h` > `0.0178` → IC=+0.227 (n=115)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0178 (IC base=+0.193)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.223 (n=157)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.189` → IC=+0.237 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.189 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `1.4499` → IC=+0.184 (n=96)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 1.4499 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.253` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.253 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.126` → IC=+0.180 (n=73)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 11.126 (IC base=+0.193)

- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.193 (n=73)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0094 (IC base=+0.189)

- **PATRÓN** `sigma_h` > `0.0176` → IC=+0.207 (n=97)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.3325` → IC=+0.174 (n=41)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.3325 (IC base=+0.189)

- **PATRÓN** `dist_vwap_pct` < `0.51` → IC=+0.171 (n=153)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.51 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.652` → IC=+0.183 (n=118)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 2.652 (IC base=+0.189)
...
- **PATRÓN** `ibs_15` < `0.029` → IC=+0.125 (n=134)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.62€ cuando `ibs_15` < 0.029 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` > `0.4192` → IC=+0.125 (n=30)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.4192 (IC base=+0.049)

- **PATRÓN** `sigma_ewma_delta_pct` < `16.557` → IC=+0.145 (n=119)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 16.557 (IC base=+0.049)
...
- **PATRÓN** `dist_vwap_pct` > `0.6366` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6366 (IC base=+0.049)

- **PATRÓN** `sigma_ewma_delta_pct` < `15.138` → IC=+0.123 (n=51)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 15.138 (IC base=+0.049)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2182 | +0.175 | -38.77€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1407 | +0.209 | +10.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 91 | +0.016 | -14.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 315 | +0.093 | -45.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 369 | +0.152 | +10.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 634 | +0.181 | -13.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 471 | +0.200 | -20.44€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 30 | +0.094 | -0.56€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 123 | +0.164 | +11.46€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH | 774 | +0.176 | +6.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 464 | +0.219 | +21.50€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 30 | -0.125 | -12.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 157 | +0.110 | -16.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 123 | +0.172 | +14.84€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL | 768 | +0.170 | -28.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 466 | +0.211 | +13.79€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 31 | +0.076 | -1.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 148 | +0.100 | -25.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 123 | +0.116 | -15.41€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 6 | -0.037 | -4.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 6 | -0.037 | -4.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 8 | +0.120 | -0.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 8 | +0.120 | -0.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 8 | +0.120 | -0.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 8 | +0.120 | -0.09€ | 0 | 0 |
| ✅ GBM_LATE_15M | 4603 | +0.102 | +1411.07€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4603 | +0.102 | +1411.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1105 | +0.066 | +158.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1105 | +0.066 | +158.67€ | 0 | 3 |
| ✅ GBM_LATE_15M#ETH | 1120 | +0.076 | +192.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1120 | +0.076 | +192.62€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1224 | +0.111 | +494.42€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1224 | +0.111 | +494.42€ | 0 | 6 |
| ✅ GBM_LATE_15M#XRP | 1154 | +0.153 | +565.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1154 | +0.153 | +565.36€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1858 | +0.154 | +1100.86€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1858 | +0.154 | +1100.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 475 | +0.125 | +248.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 475 | +0.125 | +248.17€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 489 | +0.129 | +227.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 489 | +0.129 | +227.30€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 501 | +0.110 | +215.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 501 | +0.110 | +215.69€ | 1 | 10 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO | 31 | -0.076 | -0.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 31 | -0.076 | -0.63€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 7 | +0.097 | +2.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 7 | +0.097 | +2.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1810 | +0.086 | +505.96€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1810 | +0.086 | +505.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 450 | +0.062 | +75.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 450 | +0.062 | +75.47€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 406 | +0.017 | +11.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 406 | +0.017 | +11.59€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 441 | +0.049 | +72.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 441 | +0.049 | +72.49€ | 2 | 5 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 513 | +0.191 | +346.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 513 | +0.191 | +346.41€ | 0 | 13 |
...
| ✅ LEADLAG_BTC_XRP_15M | 122 | +0.089 | +29.24€ | 0 | 4 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 122 | +0.089 | +29.24€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 122 | +0.089 | +29.24€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 122 | +0.089 | +29.24€ | 0 | 4 |
...
| ✅ UPDOWN_GBM | 1548 | +0.010 | +76.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1291 | +0.037 | +113.22€ | 0 | 7 |
...
| ✅ UPDOWN_GBM#BTC | 401 | +0.031 | +33.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 321 | +0.070 | +45.75€ | 1 | 10 |
...
| ✅ UPDOWN_GBM#ETH | 743 | +0.018 | +36.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 650 | +0.035 | +47.40€ | 1 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 21 | +0.326 | +10.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 21 | +0.326 | +10.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 8 | +0.120 | +5.65€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 8 | +0.120 | +5.65€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 6 | +0.075 | +1.30€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 6 | +0.075 | +1.30€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 6 | +0.075 | +3.00€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 6 | +0.075 | +3.00€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.124) — sin ventaja clara. oversold(IBS<0.3): IC=-0.001 n=433 | neutral: IC=-0.013 n=335 | overbought(IBS>0.7): IC=+0.111 n=350
  - _Datos_: n=1181 IC=+0.034 PNL=+112.81€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.105 n=41 PNL=-7.10€ → FILTRAR | H=07h: IC=+0.135 n=50 PNL=+24.03€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.140 n=48 PNL=+19.77€ → BOOST | H=16h: IC=+0.111 n=52 PNL=+10.12€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.100 n=8905 | tras_1loss IC=+0.062 n=6327 | tras_2loss IC=+0.029 n=2741/40 | gap=+0.071 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.075 n=692/40 PNL=+165.38€ | H=15h UTC: IC=+0.123 n=621/40 PNL=+193.46€ | H=17h UTC: IC=+0.127 n=575/40 PNL=+170.31€ | H=19h UTC: IC=+0.082 n=556/40 PNL=+84.58€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1421 IC=+0.017 PNL=+90.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1421 IC=+0.017 PNL=+90.69€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=321 IC=+0.070 PNL=+45.75€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=321 IC=+0.070 PNL=+45.75€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=680 IC=+0.075 PNL=+91.03€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=680 IC=+0.075 PNL=+91.03€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=564 IC=+0.034 PNL=+41.20€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=564 IC=+0.034 PNL=+41.20€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13001 IC=+0.103 PNL=+3143.87€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13001 IC=+0.103 PNL=+3143.87€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=148 IC=+0.013 PNL=+5.91€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=148 IC=+0.013 PNL=+5.91€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=465 IC=-0.085 PNL=+63.85€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=465 IC=-0.085 PNL=+63.85€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=588 IC=+0.056 PNL=+66.98€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=588 IC=+0.056 PNL=+66.98€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.188 < -0.1 con n=386 PNL=-89.92€
  - _Datos_: n=386 IC=-0.188 PNL=-89.92€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.253 > 0.2 con n=306 PNL=+206.12€
  - _Datos_: n=306 IC=+0.253 PNL=+206.12€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.137 > 0.08 con n=133 PNL=+44.52€
  - _Datos_: n=133 IC=+0.137 PNL=+44.52€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.117 > 0.08 con n=118 PNL=+48.77€
  - _Datos_: n=118 IC=+0.117 PNL=+48.77€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.134 > 0.08 con n=162 PNL=+82.92€
  - _Datos_: n=162 IC=+0.134 PNL=+82.92€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.259 > 0.08 con n=168 PNL=-4.05€
  - _Datos_: n=168 IC=+0.259 PNL=-4.05€
