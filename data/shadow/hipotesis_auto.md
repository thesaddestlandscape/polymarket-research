# Hipótesis automáticas — 2026-07-15 14:13 UTC
_Generado por shadow_postmortem.py sobre 15408 resoluciones (PNL=+3032.80€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.196 (n=905)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.01 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `4402.2111` → IC=+0.193 (n=512)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 4402.2111 (IC base=+0.191)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2172 | +0.174 | -43.98€ | 0 | 10 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 771 | +0.177 | +6.97€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 764 | +0.170 | -31.39€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.099 n=8871 | tras_1loss IC=+0.061 n=6318 | tras_2loss IC=+0.029 n=2740/40 | gap=+0.070 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12950 IC=+0.102 PNL=+3108.68€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12950 IC=+0.102 PNL=+3108.68€
