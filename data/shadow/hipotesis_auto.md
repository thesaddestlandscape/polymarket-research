# Hipótesis automáticas — 2026-09-15 13:52 UTC
_Generado por shadow_postmortem.py sobre 452235 resoluciones (PNL=+48513.09€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.252 (n=422)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.252 (n=422)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.137 (n=323)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 11.0 (IC base=+0.121)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.137 (n=497)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.121)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.160 (n=139)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 98.0 (IC base=+0.121)
...
- **FILTRO** `py_entrada` < `0.465` → IC=-0.130 (n=160)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.255 (n=325)
...
- **PATRÓN** `py_entrada` > `0.465` → IC=+0.255 (n=325)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8014` → IC=+0.271 (n=243)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8014 (IC base=+0.128)

- **PATRÓN** `banda_z` > `11.446` → IC=+0.258 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.446 (IC base=+0.128)

- **PATRÓN** `ballenas_wallet_edge_medio` > `2.996` → IC=+0.130 (n=117)

  - _Acción_: Kelly boost +0.65€ cuando `ballenas_wallet_edge_medio` > 2.996 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.150 (n=258)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 11.0 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=412)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `2583.232` → IC=+0.130 (n=325)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2583.232 (IC base=+0.128)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.96` → IC=-0.256 (n=5638)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.96
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=16920)
...
- **FILTRO** `restante_s_al_confirmar` < `484.43` → IC=-0.166 (n=303)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 484.43
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=910)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `135.23` → IC=-0.287 (n=701)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 135.23
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2106)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `141.07` → IC=-0.158 (n=1452)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.07
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=4365)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.3` → IC=-0.254 (n=1329)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.3
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3989)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `157.46` → IC=-0.333 (n=1406)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.46
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2857)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.38` → IC=-0.266 (n=143)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=298)
...
- **FILTRO** `py_entrada` < `0.44` → IC=-0.263 (n=57)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=180)

- **FILTRO** `py_entrada` < `0.5` → IC=-0.122 (n=43)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.195 (n=11513)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=2855)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `5227.749` → IC=+0.167 (n=1822)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 5227.749 (IC base=+0.097)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.245 (n=7771)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.171 (n=5650)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7146.8269` → IC=+0.177 (n=1786)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7146.8269 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1344)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.349 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=1656)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `10983.2748` → IC=+0.203 (n=856)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10983.2748 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.210 (n=1221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.208 (n=1346)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` < `0.37` → IC=+0.274 (n=1175)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1723)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `12932.3181` → IC=+0.212 (n=605)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12932.3181 (IC base=+0.202)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.175 (n=420)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 11.0 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=2299)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.138 (n=1963)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.135 (n=630)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `1940.1614` → IC=+0.159 (n=356)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1940.1614 (IC base=+0.125)
...
- **PATRÓN** `py_entrada` > `0.85` → IC=+0.423 (n=530)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.182 (n=958)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.181 (n=1105)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2146)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=2225)
...
- **PATRÓN** `py_entrada` > `0.725` → IC=+0.355 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.291)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=2209)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.180 (n=2114)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 17.0 (IC base=+0.176)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.182 (n=1889)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.71 (IC base=+0.176)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.246 (n=1974)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.236)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.236 (n=1687)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `lag_apertura_s` < `2.62` → IC=+0.148 (n=1847)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 2.62 (IC base=+0.119)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9773` → IC=+0.230 (n=1998)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9773 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.6044` → IC=+0.243 (n=1596)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6044 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.718` → IC=+0.154 (n=3280)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 2.718 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `0.6145` → IC=+0.252 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6145 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.0696` → IC=+0.248 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0696 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.1751` → IC=+0.192 (n=4055)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1751 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.3089` → IC=+0.202 (n=559)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3089 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.472` → IC=+0.195 (n=3912)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.472 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.130 (n=7379)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.57 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5678` → IC=+0.181 (n=453)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5678 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3436` → IC=+0.168 (n=2502)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3436 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `0.6996` → IC=+0.167 (n=1046)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6996 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.175 (n=1584)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8706 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.3011` → IC=+0.222 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3011 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4634` → IC=+0.198 (n=3953)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4634 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.206 (n=3723)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.187 (n=448)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=1028)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1578.8947` → IC=+0.248 (n=899)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1578.8947 (IC base=+0.235)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.230 (n=339)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.213)

- **PATRÓN** `sigma_h` > `0.0039` → IC=+0.213 (n=677)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0039 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.1109` → IC=+0.239 (n=447)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1109 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.229 (n=1066)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.9238` → IC=+0.254 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9238 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.219 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.853` → IC=+0.234 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.853 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2608` → IC=+0.223 (n=1015)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2608 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.8751` → IC=+0.216 (n=677)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8751 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.0998` → IC=+0.218 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0998 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.4925` → IC=+0.225 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4925 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.3925` → IC=+0.220 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3925 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `11900.8434` → IC=+0.226 (n=907)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11900.8434 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.161 (n=963)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6717` → IC=+0.178 (n=1094)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6717 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.1323` → IC=+0.157 (n=984)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1323 (IC base=+0.142)
...
- **PATRÓN** `volumen_regimen` < `1.2044` → IC=+0.151 (n=1094)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2044 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6862` → IC=+0.144 (n=977)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6862 (IC base=+0.142)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3763` → IC=+0.184 (n=172)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.3763 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `3.0251` → IC=+0.192 (n=557)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 3.0251 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.190 (n=1498)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.217 (n=762)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1665)

- **PATRÓN** `ibs_20min` > `0.9299` → IC=+0.168 (n=281)
...
- **PATRÓN** `dist_vwap_pct` < `0.6316` → IC=+0.333 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6316 (IC base=+0.007)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.272` → IC=+0.136 (n=522)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4916` → IC=+0.349 (n=91)
...
- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.348 (n=202)
...
- **PATRÓN** `dist_vwap_pct` < `0.4593` → IC=+0.146 (n=602)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.4593 (IC base=+0.000)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2689` → IC=+0.225 (n=67)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2689 (IC base=+0.000)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.128 (n=1705)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=+0.118 (n=844)

- **FILTRO** `sigma_ewma_delta_pct` > `8.613` → IC=-0.196 (n=278)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.613
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2271)
...
- **FILTRO** `drift_60min` |x|> `0.6458` → IC=-0.188 (n=421)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6458
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=1264)

- **FILTRO** `ibs_20min` < `0.6502` → IC=-0.159 (n=1112)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6502
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=573)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.198 (n=376)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1309)

- **FILTRO** `ibs_20min` > `0.775` → IC=-0.201 (n=636)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=1914)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2185` → IC=+0.270 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2185 (IC base=-0.086)
...
- **PATRÓN** `dist_vwap_pct` > `1.0024` → IC=+0.267 (n=58)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0024 (IC base=-0.029)

- **PATRÓN** `dist_vwap_pct` < `0.26` → IC=+0.241 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.26 (IC base=-0.029)

- **PATRÓN** `volumen_regimen` < `0.7351` → IC=+0.240 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7351 (IC base=-0.029)

- **PATRÓN** `volumen_regimen` > `1.0875` → IC=+0.293 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0875 (IC base=-0.029)

- **PATRÓN** `volumen_pendiente_norm` > `0.1065` → IC=+0.256 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1065 (IC base=-0.029)

- **PATRÓN** `volumen_spike_ratio` < `2.24` → IC=+0.256 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.24 (IC base=-0.029)

- **PATRÓN** `volumen_spike_ratio` > `1.4747` → IC=+0.236 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4747 (IC base=-0.029)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.240 (n=410)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.029)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.176 (n=2503)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.009 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.8823` → IC=+0.264 (n=3399)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8823 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `1.0117` → IC=+0.283 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0117 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.504` → IC=+0.142 (n=3544)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.504 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6792` → IC=+0.234 (n=2270)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6792 (IC base=+0.086)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8491` → IC=+0.197 (n=348)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.8491 (IC base=+0.038)

- **PATRÓN** `volumen_spike_ratio` > `2.6525` → IC=+0.193 (n=174)
...
- **FILTRO** `ibs_20min` > `0.8292` → IC=-0.145 (n=565)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8292
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1698)

- **PATRÓN** `dist_vwap_pct` > `0.3038` → IC=+0.140 (n=248)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.3038 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` > `0.6545` → IC=+0.132 (n=579)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4206` → IC=+0.160 (n=210)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.4206 (IC base=+0.008)
...
- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.268 (n=1066)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.0959` → IC=+0.247 (n=398)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.285 (n=953)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3333 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.885` → IC=+0.296 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.885 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` > `0.3457` → IC=+0.309 (n=145)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2184` → IC=+0.282 (n=571)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2184 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.284 (n=475)
...
- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.274 (n=361)
...
- **FILTRO** `ibs_20min` < `0.2435` → IC=-0.213 (n=339)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1019)

- **FILTRO** `ibs_20min` > `0.8156` → IC=-0.182 (n=448)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8156
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=1345)

- **PATRÓN** `ibs_20min` > `0.8024` → IC=+0.144 (n=462)
...
- **PATRÓN** `volumen_regimen` < `0.9592` → IC=+0.204 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9592 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` > `0.6183` → IC=+0.190 (n=272)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 0.6183 (IC base=-0.017)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4842` → IC=+0.254 (n=124)
...
- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.251 (n=187)
...
- **PATRÓN** `dist_vwap_pct` < `0.4535` → IC=+0.156 (n=242)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.4535 (IC base=-0.019)

- **PATRÓN** `volumen_regimen` < `0.9712` → IC=+0.165 (n=192)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.9712 (IC base=-0.019)

- **PATRÓN** `volumen_regimen` > `0.7126` → IC=+0.170 (n=195)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.7126 (IC base=-0.019)

- **PATRÓN** `volumen_pendiente_norm` > `0.1565` → IC=+0.311 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1565 (IC base=-0.019)
...
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.206 (n=811)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6667
  - _Potencial_: sin este filtro IC_bueno=+0.252 (n=824)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.689` → IC=-0.168 (n=405)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=1328)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.252 (n=824)
...
- **PATRÓN** `volumen_regimen` < `0.8622` → IC=+0.285 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8622 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.724` → IC=+0.274 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.724 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.1092` → IC=+0.277 (n=517)
...
- **PATRÓN** `sigma_h` > `0.015` → IC=+0.321 (n=686)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.343 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.268)

- **PATRÓN** `dist_vwap_pct` > `0.2654` → IC=+0.316 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2654 (IC base=+0.268)
...
- **PATRÓN** `volumen_regimen` > `0.6887` → IC=+0.286 (n=919)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5611` → IC=+0.271 (n=963)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5611 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` > `2.2072` → IC=+0.272 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2072 (IC base=+0.268)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.271 (n=1061)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.268)

- **PATRÓN** `libro_liquidez` > `2580.3091` → IC=+0.275 (n=686)
...
- **PATRÓN** `sigma_h` > `0.0202` → IC=+0.299 (n=510)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.4585` → IC=+0.227 (n=5753)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4585 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2235` → IC=+0.162 (n=4259)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2235 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.28` → IC=+0.198 (n=997)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.28 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1867` → IC=+0.156 (n=4204)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1867 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6268` → IC=+0.152 (n=4203)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6268 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2924` → IC=+0.229 (n=814)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2924 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.172 (n=2243)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.6495` → IC=+0.180 (n=1699)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.6495 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.171 (n=4713)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.206 (n=457)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3124` → IC=+0.203 (n=999)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3124 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.215 (n=499)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.077` → IC=+0.308 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.077 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2298` → IC=+0.238 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2298 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `2.5605` → IC=+0.183 (n=907)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.5605 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.183 (n=906)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.212 (n=917)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.239 (n=638)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2644` → IC=+0.175 (n=758)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.2644 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.199 (n=590)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.4328` → IC=+0.223 (n=861)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4328 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.2178` → IC=+0.214 (n=515)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2178 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.686` → IC=+0.227 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.686 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.268` → IC=+0.176 (n=861)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 1.268 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2364` → IC=+0.190 (n=188)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2364 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `1.4117` → IC=+0.198 (n=276)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4117 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `9812.7811` → IC=+0.181 (n=861)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 9812.7811 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.181 (n=863)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0048 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.0581` → IC=+0.200 (n=328)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0581 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=901)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.5226` → IC=+0.195 (n=981)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.5226 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1372` → IC=+0.169 (n=990)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1372 (IC base=+0.151)
...
- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.165 (n=981)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2089 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1586` → IC=+0.186 (n=301)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1586 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.162 (n=871)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `230.0` → IC=+0.159 (n=262)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 230.0 (IC base=+0.151)
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.225 (n=728)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.221)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.223 (n=738)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.250 (n=826)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3443 (IC base=+0.221)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.671` → IC=+0.269 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.671 (IC base=+0.221)

- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.279 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3592 (IC base=+0.221)

- **PATRÓN** `volumen_spike_ratio` > `3.5271` → IC=+0.245 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5271 (IC base=+0.221)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5308` → IC=+0.184 (n=305)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.5308 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `7289.8412` → IC=+0.192 (n=624)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 7289.8412 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.162 (n=770)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 154.0 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.163 (n=888)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.006 (IC base=+0.128)

- **PATRÓN** `drift_60min` |x|≤ `0.3751` → IC=+0.144 (n=1009)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6027` → IC=+0.179 (n=1009)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6027 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.3367` → IC=+0.140 (n=1102)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3367 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.135` → IC=+0.192 (n=199)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 12.135 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.140 (n=673)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8615 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.130 (n=1008)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.6129 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` > `0.2909` → IC=+0.198 (n=147)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2909 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` < `1.7994` → IC=+0.134 (n=596)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.7994 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `2.4836` → IC=+0.143 (n=298)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 2.4836 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `9950.2818` → IC=+0.154 (n=457)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 9950.2818 (IC base=+0.128)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1137)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.196 (n=1108)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.5169 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `1.009` → IC=+0.234 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.009 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.465` → IC=+0.254 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.465 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.2203` → IC=+0.122 (n=1108)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2203 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.8007` → IC=+0.127 (n=711)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.8007 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=1139)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.152 (n=484)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0057 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.174 (n=501)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 15.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.5417` → IC=+0.207 (n=1099)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5417 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.6893` → IC=+0.145 (n=201)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.6893 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.1913` → IC=+0.137 (n=1013)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1913 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.336` → IC=+0.158 (n=235)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 7.336 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.0388` → IC=+0.129 (n=967)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0388 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2741` → IC=+0.184 (n=131)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2741 (IC base=+0.114)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1727` → IC=+0.138 (n=434)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.1727 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3069.462` → IC=+0.159 (n=367)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3069.462 (IC base=+0.114)
...
- **PATRÓN** `volumen_regimen` > `0.6935` → IC=+0.212 (n=946)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6935 (IC base=+0.200)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.236 (n=373)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0076 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.022` → IC=+0.213 (n=506)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.022 (IC base=+0.204)

- **PATRÓN** `drift_60min` |x|≤ `0.0901` → IC=+0.220 (n=373)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0244` → IC=+0.304 (n=493)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2447` → IC=+0.198 (n=863)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.2447 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4614` → IC=+0.192 (n=981)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4614 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=745)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2525.7119` → IC=+0.213 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2525.7119 (IC base=+0.204)
...
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.155 (n=474)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0087 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.0954` → IC=+0.151 (n=474)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.0954 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=703)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.3958` → IC=+0.169 (n=1421)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.3958 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.8094` → IC=+0.170 (n=207)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.8094 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.703` → IC=+0.167 (n=646)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.703 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.866` → IC=+0.156 (n=814)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4335` → IC=+0.158 (n=454)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4335 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.5912` → IC=+0.159 (n=453)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5912 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.143 (n=1567)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8146.3351` → IC=+0.159 (n=644)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 8146.3351 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.160 (n=1200)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 156.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.157 (n=497)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0037 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.336` → IC=+0.126 (n=1313)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.336 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.4833` → IC=+0.157 (n=1312)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4833 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2132` → IC=+0.123 (n=1303)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2132 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.824` → IC=+0.133 (n=589)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 3.824 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.2259` → IC=+0.122 (n=1312)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2259 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.167` → IC=+0.142 (n=384)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.167 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.134 (n=1253)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.2373 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.128 (n=594)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 27.0 (IC base=+0.114)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1013` → IC=+0.148 (n=140)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.1013 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.155 (n=288)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 10.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2979` → IC=+0.146 (n=317)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.2979 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.6738` → IC=+0.139 (n=59)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.6738 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.31` → IC=+0.167 (n=151)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.31 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6919` → IC=+0.169 (n=140)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.6919 (IC base=+0.104)
...
- **PATRÓN** `libro_liquidez` > `9633.8027` → IC=+0.143 (n=317)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 9633.8027 (IC base=+0.104)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3374` → IC=+0.145 (n=466)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.3374 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.143 (n=418)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` < `0.3483` → IC=+0.206 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3483 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.1841` → IC=+0.144 (n=467)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1841 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.384` → IC=+0.134 (n=189)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 4.384 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.074` → IC=+0.124 (n=416)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.074 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.128 (n=466)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.1856 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` > `0.7044` → IC=+0.142 (n=417)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.7044 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.1571` → IC=+0.202 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1571 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` < `2.1106` → IC=+0.156 (n=402)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1106 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` > `1.42` → IC=+0.131 (n=456)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.42 (IC base=+0.124)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.160 (n=148)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 159.0 (IC base=+0.124)
...
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.214 (n=145)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.0954` → IC=+0.216 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0954 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.252 (n=216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `0.2679` → IC=+0.235 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2679 (IC base=+0.196)

- **PATRÓN** `dist_vwap_pct` > `0.149` → IC=+0.220 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.149 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.116` → IC=+0.232 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.116 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` < `0.8389` → IC=+0.206 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8389 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `1.168` → IC=+0.228 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.168 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` > `0.2528` → IC=+0.312 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2528 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `1.374` → IC=+0.231 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.374 (IC base=+0.196)
...
- **PATRÓN** `libro_liquidez` > `12390.1326` → IC=+0.221 (n=145)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12390.1326 (IC base=+0.196)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.136 (n=256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 11.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.298` → IC=+0.163 (n=253)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.298 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.51` → IC=+0.160 (n=104)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 6.51 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.2331` → IC=+0.122 (n=379)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2331 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5407` → IC=+0.127 (n=320)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.5407 (IC base=+0.105)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.3689` → IC=-0.200 (n=18)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3689
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=339)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.961` → IC=+0.133 (n=47)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 8.961 (IC base=+0.085)

- **PATRÓN** `volumen_regimen` < `0.7211` → IC=+0.150 (n=118)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7211 (IC base=+0.085)

- **PATRÓN** `volumen_spike_ratio` < `2.4929` → IC=+0.133 (n=246)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.4929 (IC base=+0.085)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.192 (n=3402)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0085 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7833)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4737` → IC=+0.212 (n=7494)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4737 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.8917` → IC=+0.200 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8917 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.579` → IC=+0.221 (n=3683)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.579 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8839` → IC=+0.163 (n=3370)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8839 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.188 (n=1431)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6402` → IC=+0.182 (n=2377)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6402 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=8958)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3771.8767` → IC=+0.170 (n=2498)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3771.8767 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.194 (n=5383)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 94.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.197 (n=4602)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0066 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.473` → IC=+0.184 (n=6904)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5567` → IC=+0.239 (n=6904)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5567 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2341` → IC=+0.164 (n=4333)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2341 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.857` → IC=+0.202 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.857 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.7033` → IC=+0.159 (n=2099)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7033 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2018` → IC=+0.163 (n=1590)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.2018 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.253 (n=888)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.3005` → IC=+0.191 (n=2798)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3005 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.178 (n=5782)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.231 (n=571)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.319 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.366` → IC=+0.291 (n=774)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5578` → IC=+0.189 (n=515)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.5578 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.5831` → IC=+0.196 (n=390)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.5831 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.223 (n=1132)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.262 (n=662)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0056 (IC base=+0.256)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.266 (n=886)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.1993` → IC=+0.280 (n=661)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1993 (IC base=+0.256)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=896)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` < `0.3409` → IC=+0.286 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3409 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.61` → IC=+0.264 (n=994)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.61 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.2858` → IC=+0.303 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2858 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `1.9032` → IC=+0.282 (n=590)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9032 (IC base=+0.256)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1015)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1579.5248` → IC=+0.268 (n=884)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1579.5248 (IC base=+0.256)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.807` → IC=+0.161 (n=278)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 9.807 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.374` → IC=+0.151 (n=1048)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.374 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6941` → IC=+0.181 (n=522)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6941 (IC base=+0.147)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4264` → IC=+0.156 (n=1132)
...
- **PATRÓN** `libro_liquidez` > `10706.4059` → IC=+0.168 (n=1058)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 10706.4059 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `495.0` → IC=+0.162 (n=1063)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 495.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=940)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.3196` → IC=+0.168 (n=1063)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3196 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.182 (n=356)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 18.0 (IC base=+0.158)

- **PATRÓN** `ibs_20min` < `0.6376` → IC=+0.208 (n=1063)
...
- **PATRÓN** `dist_vwap_pct` < `0.132` → IC=+0.169 (n=970)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.132 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.618` → IC=+0.193 (n=190)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 11.618 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.168 (n=1063)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.1888 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.1498` → IC=+0.210 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1498 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `2.409` → IC=+0.172 (n=966)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.409 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.164 (n=864)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.5138 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `12094.187` → IC=+0.158 (n=709)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12094.187 (IC base=+0.158)

- **PATRÓN** `ballena_activa_n` < `376.0` → IC=+0.165 (n=580)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 376.0 (IC base=+0.158)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.223 (n=1182)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=1241)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.675` → IC=+0.251 (n=1056)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.675 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.502` → IC=+0.297 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.502 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.2175` → IC=+0.216 (n=1134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2175 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `1.6746` → IC=+0.217 (n=1106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6746 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.225 (n=1341)
...
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.231 (n=519)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3701` → IC=+0.267 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3701 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.713` → IC=+0.278 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.713 (IC base=+0.230)

- **PATRÓN** `volumen_pendiente_norm` > `0.3595` → IC=+0.299 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3595 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` < `1.7875` → IC=+0.225 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7875 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` > `2.2419` → IC=+0.226 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2419 (IC base=+0.230)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.241 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.230)

- **PATRÓN** `libro_liquidez` > `1894.0152` → IC=+0.232 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1894.0152 (IC base=+0.230)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.240 (n=414)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4307` → IC=+0.137 (n=1271)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.4307 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=1333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.7089` → IC=+0.235 (n=847)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7089 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.3523` → IC=+0.181 (n=484)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.3523 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.3` → IC=+0.165 (n=545)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 4.3 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.8808` → IC=+0.158 (n=848)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5044` → IC=+0.150 (n=538)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.159 (n=902)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0065 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4315` → IC=+0.154 (n=1024)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4315 (IC base=+0.137)
...
- **PATRÓN** `ibs_20min` < `0.3291` → IC=+0.227 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3291 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.2043` → IC=+0.143 (n=951)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.2043 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.113` → IC=+0.203 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.113 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.245` → IC=+0.137 (n=957)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 4.245 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8594` → IC=+0.142 (n=683)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8594 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `1.1778` → IC=+0.154 (n=342)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1778 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5573` → IC=+0.149 (n=420)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5573 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4741` → IC=+0.172 (n=318)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.4741 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `10973.4331` → IC=+0.186 (n=342)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 10973.4331 (IC base=+0.137)
...
- **PATRÓN** `ibs_20min` > `0.4667` → IC=+0.178 (n=1296)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4667 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `1.0` → IC=+0.185 (n=230)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 1.0 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.432` → IC=+0.219 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.432 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=902)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2907.4324` → IC=+0.242 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2907.4324 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.127 (n=954)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 53.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.180 (n=548)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0061 (IC base=+0.115)
...
- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.209 (n=1247)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.4697` → IC=+0.131 (n=1219)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.4697 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.125 (n=1200)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.115)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2143` → IC=+0.127 (n=494)
...
- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.217 (n=592)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1363)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.205 (n=1167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.312 (n=476)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5936` → IC=+0.237 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5936 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.212 (n=1309)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2564.206` → IC=+0.211 (n=870)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2564.206 (IC base=+0.204)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.239 (n=480)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0253` → IC=+0.220 (n=480)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.140 (n=2552)

- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.155 (n=2216)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0094 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.5272` → IC=+0.155 (n=2518)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.5272 (IC base=+0.144)
...
- **PATRÓN** `dist_vwap_pct` > `0.1887` → IC=+0.154 (n=820)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.1887 (IC base=+0.144)
...
- **PATRÓN** `volumen_regimen` > `0.9065` → IC=+0.151 (n=1019)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4616` → IC=+0.162 (n=831)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4616 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.9066` → IC=+0.158 (n=1662)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.9066 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8162.0536` → IC=+0.153 (n=1142)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8162.0536 (IC base=+0.144)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.189 (n=644)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0037 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.4837` → IC=+0.157 (n=1926)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1778` → IC=+0.160 (n=848)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.265` → IC=+0.147 (n=1908)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.265 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.1137` → IC=+0.148 (n=1608)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5724` → IC=+0.143 (n=1906)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.5724 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.8251` → IC=+0.149 (n=1271)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.8251 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=2552)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `7756.2728` → IC=+0.150 (n=1720)
...
- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.151 (n=743)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0088 (IC base=+0.143)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.148 (n=743)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0045 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.5033` → IC=+0.152 (n=743)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.1834` → IC=+0.153 (n=744)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.1834 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.9619` → IC=+0.173 (n=166)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.9619 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.4248` → IC=+0.151 (n=706)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4248 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.735` → IC=+0.151 (n=744)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.735 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.9096` → IC=+0.147 (n=496)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.9096 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `1.2651` → IC=+0.152 (n=248)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2651 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.1782` → IC=+0.167 (n=220)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1782 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.4406` → IC=+0.171 (n=244)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.4406 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=704)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `8268.5946` → IC=+0.151 (n=743)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8268.5946 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.165 (n=535)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0071 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.5101` → IC=+0.185 (n=607)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.0956` → IC=+0.167 (n=607)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.0956 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.1562` → IC=+0.174 (n=274)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.1562 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.3949` → IC=+0.152 (n=621)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3949 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.802` → IC=+0.173 (n=99)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 10.802 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6505` → IC=+0.188 (n=203)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6505 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `0.7288` → IC=+0.155 (n=543)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7288 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` < `0.1527` → IC=+0.156 (n=623)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0741` → IC=+0.178 (n=262)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.0741 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.1996` → IC=+0.168 (n=525)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.1996 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4508` → IC=+0.166 (n=596)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4508 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `8205.2722` → IC=+0.170 (n=607)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 8205.2722 (IC base=+0.151)
...
- **FILTRO** `ibs_20min` > `0.2374` → IC=-0.130 (n=98)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2374
  - _Potencial_: sin este filtro IC_bueno=+0.136 (n=193)

- **PATRÓN** `ibs_20min` > `0.7391` → IC=+0.140 (n=187)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.7391 (IC base=+0.062)

- **PATRÓN** `ibs_20min` < `0.2374` → IC=+0.136 (n=193)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.2374 (IC base=+0.046)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.12` → IC=+0.143 (n=96)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 6.12 (IC base=+0.046)

- **PATRÓN** `libro_liquidez` > `3771.3449` → IC=+0.153 (n=99)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3771.3449 (IC base=+0.046)
...
- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.144 (n=43)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0023 (IC base=+0.100)

- **PATRÓN** `drift_60min` |x|≤ `0.2185` → IC=+0.143 (n=82)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.2185 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.230 (n=35)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` < `0.1622` → IC=+0.167 (n=85)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1622 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.682` → IC=+0.125 (n=94)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 10.682 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `3566.36` → IC=+0.143 (n=96)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 3566.36 (IC base=+0.100)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.128 (n=441)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2814.617` → IC=+0.173 (n=157)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2814.617 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.123 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 11.0 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2300.2562` → IC=+0.124 (n=527)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2300.2562 (IC base=+0.095)
...
- **FILTRO** `py_entrada` < `0.445` → IC=-0.135 (n=50)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.445
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=156)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=6121)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1303)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.177 (n=2558)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=7824)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=2665)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8157)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.216 (n=420)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.091 (n=1322)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.218 (n=455)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=1444)

- **FILTRO** `ibs_20min` > `0.2873` → IC=-0.170 (n=474)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2873
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1425)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.200 (n=415)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2361)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2351)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2357)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7497)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=16947)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.281 (n=5644)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=18800)

- **FILTRO** `ibs_7min` < `0.7065` → IC=-0.237 (n=6110)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7065
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=18334)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.160 (n=8120)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=16324)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.223 (n=7627)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=22996)

- **FILTRO** `ibs_7min` > `0.2973` → IC=-0.177 (n=7651)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2973
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=22972)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=919)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2978)

- **FILTRO** `ibs_7min` < `0.7099` → IC=-0.256 (n=1285)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7099
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2612)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.192 (n=947)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=2950)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=3587)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.098 (n=1748)

- **FILTRO** `ibs_7min` > `0.7976` → IC=-0.205 (n=1333)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7976
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4002)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=988)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3293)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=990)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3291)

- **FILTRO** `ibs_7min` < `0.76` → IC=-0.186 (n=1070)

  - _Acción_: SKIP cuando `ibs_7min` < 0.76
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3211)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.170 (n=1066)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3215)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.254 (n=1012)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3325)

- **FILTRO** `ibs_7min` > `0.2506` → IC=-0.167 (n=1084)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2506
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3253)

- **FILTRO** `ballena_activa_n` > `114.0` → IC=-0.164 (n=1461)

  - _Acción_: SKIP cuando `ballena_activa_n` > 114.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2876)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=898)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=2769)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.320 (n=874)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2793)

- **FILTRO** `drift_7min_pct` |x|> `0.181` → IC=-0.130 (n=1245)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.181
  - _Potencial_: sin este filtro IC_bueno=-0.108 (n=2422)

- **FILTRO** `ibs_7min` < `0.2034` → IC=-0.272 (n=916)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2034
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2751)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.217 (n=890)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2777)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1313)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=4285)

- **FILTRO** `ibs_7min` > `0.2649` → IC=-0.157 (n=1903)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2649
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=3695)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1277)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2743)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=967)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3053)

- **FILTRO** `ibs_7min` < `0.7454` → IC=-0.190 (n=1005)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7454
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3015)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.184 (n=983)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3037)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1009)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3110)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.175 (n=1029)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3090)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.181 (n=1023)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3096)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.238 (n=1095)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3347)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.208 (n=1110)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3332)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.176 (n=1399)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=4391)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=988)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3149)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.228 (n=1031)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3106)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.203 (n=1016)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3121)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.204 (n=1304)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=4140)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.417` → IC=+0.145 (n=412)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio` |x|> 0.417 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.134 (n=558)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### PRICE_TARGET_GBM
- **FILTRO** `sigma_h` > `0.0057` → IC=-0.348 (n=136)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `sigma_h` < `0.007` → IC=-0.287 (n=59)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2289)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1180)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1188)
...
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.192 (n=349)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0587` → IC=+0.172 (n=1046)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.86€ cuando `delta_ratio_macro` |x|> 0.0587 (IC base=+0.168)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3415` → IC=+0.205 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3415 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.171 (n=740)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6154` → IC=+0.238 (n=1046)
...
- **PATRÓN** `dist_vwap_pct` < `0.5472` → IC=+0.166 (n=1100)
...
- **PATRÓN** `libro_liquidez` > `5104.4221` → IC=+0.179 (n=474)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 5104.4221 (IC base=+0.168)
...
- **PATRÓN** `sigma_h` > `0.0023` → IC=+0.194 (n=263)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `drift_15min` |x|≤ `0.3761` → IC=+0.211 (n=88)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3761 (IC base=+0.193)

- **PATRÓN** `delta_ratio_macro` |x|> `0.252` → IC=+0.211 (n=88)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.252 (IC base=+0.193)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3853` → IC=+0.228 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3853 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.209 (n=273)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.193)

- **PATRÓN** `ibs_15` > `0.7064` → IC=+0.243 (n=263)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7064 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.3946` → IC=+0.232 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3946 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.1089` → IC=+0.201 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1089 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.491` → IC=+0.246 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.491 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `13829.6156` → IC=+0.227 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13829.6156 (IC base=+0.193)

### UPDOWN_GBM#BTC#60min
- **PATRÓN** `sigma_ewma_delta_pct` > `19.811` → IC=+0.145 (n=60)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 19.811 (IC base=-0.004)
...
- **PATRÓN** `ibs_15` < `0.1053` → IC=+0.178 (n=330)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0125` → IC=-0.202 (n=525)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0125
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1576)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.207 (n=247)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1854)
...
- **PATRÓN** `ibs_15` > `0.6046` → IC=+0.248 (n=525)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6046 (IC base=-0.059)

- **PATRÓN** `dist_vwap_pct` < `0.2672` → IC=+0.167 (n=409)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.2672 (IC base=-0.059)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1198` → IC=+0.239 (n=723)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1198 (IC base=-0.047)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1822` → IC=+0.237 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1822 (IC base=-0.047)

- **PATRÓN** `ibs_15` < `0.3521` → IC=+0.278 (n=1084)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3521 (IC base=-0.047)

- **PATRÓN** `dist_vwap_pct` > `0.4078` → IC=+0.258 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4078 (IC base=-0.047)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.206 (n=311)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.196 (n=935)

- **FILTRO** `sigma_h` < `0.0032` → IC=-0.232 (n=311)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=935)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.212 (n=792)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.843` → IC=-0.246 (n=226)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1020)

- **PATRÓN** `sigma_h` < `0.003` → IC=+0.153 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.003 (IC base=+0.072)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2023` → IC=+0.245 (n=53)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2023 (IC base=+0.072)
...
- **PATRÓN** `dist_vwap_pct` < `0.4975` → IC=+0.273 (n=126)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4975 (IC base=+0.072)
...
- **PATRÓN** `ibs_15` < `0.3605` → IC=+0.271 (n=453)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3605 (IC base=+0.224)

- **PATRÓN** `dist_vwap_pct` > `0.3742` → IC=+0.250 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3742 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.118` → IC=+0.241 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.118 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.013` → IC=+0.225 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.013 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `3628.461` → IC=+0.225 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3628.461 (IC base=+0.224)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.261 (n=174)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.148 (n=458)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.107` → IC=+0.357 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.107 (IC base=-0.047)

- **PATRÓN** `ibs_15` < `0.3273` → IC=+0.298 (n=320)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6154 sube el IC de +0.168 a +0.238 en UPDOWN_GBM#15min (n=1046). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7064 sube el IC de +0.193 a +0.243 en UPDOWN_GBM#BTC#15min (n=263). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1053 sube el IC de +0.050 a +0.178 en UPDOWN_GBM#XRP#15min (n=330). Ya aplicado como kelly_boost=+0.89€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6046 sube el IC de -0.059 a +0.248 en UPDOWN_GBM_15M_TARDIO (n=525). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3521 sube el IC de -0.047 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=1084). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8098 sube el IC de +0.072 a +0.338 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=103). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3605 sube el IC de +0.224 a +0.271 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=453). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3667 sube el IC de -0.043 a +0.242 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=227). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3273 sube el IC de -0.047 a +0.298 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=320). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1145 | +0.083 | +135.74€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1145 | +0.083 | +135.74€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 826 | +0.089 | +110.71€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 826 | +0.089 | +110.71€ | 3 | 9 |
...
| ✅ BALLENAS_TARDIAS | 20125 | -0.105 | -2914.97€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1213 | -0.042 | -214.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 18912 | -0.109 | -2700.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3140 | -0.122 | -556.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3140 | -0.122 | -556.81€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1213 | -0.042 | -214.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1213 | -0.042 | -214.28€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 5817 | -0.053 | -589.78€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5817 | -0.053 | -589.78€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5318 | -0.115 | -414.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5318 | -0.115 | -414.16€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4263 | -0.166 | -978.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4263 | -0.166 | -978.90€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 11718 | -0.043 | +4264.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3161 | -0.008 | +1843.23€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 8557 | -0.056 | +2421.23€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 11718 | -0.043 | +4264.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3161 | -0.008 | +1843.23€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 8557 | -0.056 | +2421.23€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 851 | -0.101 | -122.72€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 48 | -0.080 | -8.86€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 803 | -0.102 | -113.87€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 489 | -0.074 | -61.82€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 33 | -0.100 | -7.05€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 456 | -0.072 | -54.76€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 234 | -0.161 | -52.30€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 15 | -0.022 | -1.80€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 219 | -0.170 | -50.50€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 67 | -0.051 | -8.46€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 67 | -0.051 | -8.46€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 39 | -0.159 | -4.70€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 39 | -0.159 | -4.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 72907 | +0.113 | -3850.97€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 11462 | +0.182 | -362.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 280 | -0.117 | -46.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 56091 | +0.100 | -3333.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5074 | +0.115 | -109.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 9347 | +0.095 | -896.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 37 | -0.141 | -0.23€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 9295 | +0.097 | -884.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 14740 | +0.130 | -325.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3491 | +0.201 | -113.84€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 9294 | +0.108 | -205.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1913 | +0.116 | +16.40€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 9389 | +0.088 | -935.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 44 | -0.065 | -4.30€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 9330 | +0.090 | -919.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 15622 | +0.124 | -306.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4414 | +0.171 | -78.47€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 9372 | +0.108 | -167.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1824 | +0.099 | -51.08€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 