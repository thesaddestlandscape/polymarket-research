# Hipótesis automáticas — 2026-07-28 12:19 UTC
_Generado por shadow_postmortem.py sobre 40056 resoluciones (PNL=+8213.16€)_
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.190 (n=1241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0075 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.162 (n=1736)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.406` → IC=+0.232 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.406 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `2416.2073` → IC=+0.137 (n=1509)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2416.2073 (IC base=+0.142)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=427)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.798` → IC=+0.171 (n=83)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 11.798 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` < `0.0173` → IC=+0.247 (n=429)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0173 (IC base=+0.228)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.247 (n=389)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.124 (n=831)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.033` → IC=+0.232 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.033 (IC base=+0.094)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` > `0.4413` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.4413 (IC base=+0.073)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.655` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 12.655 (IC base=+0.073)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.068` → IC=+0.283 (n=90)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.068 (IC base=+0.047)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.0191` → IC=+0.172 (n=477)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0191 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.167 (n=485)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0103 (IC base=+0.167)
...
- **PATRÓN** `dist_vwap_pct` > `0.2414` → IC=+0.230 (n=150)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2414 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.951` → IC=+0.284 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.951 (IC base=+0.167)
...
- **PATRÓN** `ibs_15` > `0.6069` → IC=+0.175 (n=642)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` > 0.6069 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` > `0.1672` → IC=+0.167 (n=235)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1672 (IC base=+0.055)
...
- **PATRÓN** `libro_liquidez` > `10314.0826` → IC=+0.137 (n=180)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 10314.0826 (IC base=+0.055)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6069 sube el IC de +0.055 a +0.175 en UPDOWN_GBM#15min (n=642). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ GBM_LATE_15M | 8622 | +0.093 | +2556.17€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8622 | +0.093 | +2556.17€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 52 | +0.167 | +17.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 52 | +0.167 | +17.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2059 | +0.072 | +347.54€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2059 | +0.072 | +347.54€ | 0 | 6 |
...
| ✅ GBM_LATE_15M#XRP | 2308 | +0.138 | +1096.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2308 | +0.138 | +1096.44€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5854 | +0.117 | +2735.52€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5854 | +0.117 | +2735.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 38 | +0.300 | +39.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 38 | +0.300 | +39.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1508 | +0.084 | +509.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1508 | +0.084 | +509.96€ | 0 | 4 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1308 | +0.215 | +1071.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1308 | +0.215 | +1071.96€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 5842 | +0.064 | +1499.39€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5842 | +0.064 | +1499.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 45 | +0.245 | +26.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 45 | +0.245 | +26.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1374 | +0.025 | +145.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1374 | +0.025 | +145.79€ | 0 | 2 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 1361 | +0.022 | +242.49€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1361 | +0.022 | +242.49€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1613 | +0.160 | +961.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1613 | +0.160 | +961.59€ | 0 | 12 |
...
| ✅ UPDOWN_GBM | 2968 | +0.035 | +267.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2704 | +0.051 | +306.85€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#BTC#15min | 509 | +0.089 | +91.09€ | 1 | 9 |
...
| ✅ UPDOWN_GBM#XRP | 345 | +0.050 | +47.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 334 | +0.059 | +50.45€ | 4 | 1 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2250 | +0.150 | +979.90€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2250 | +0.150 | +979.90€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 634 | +0.170 | +376.63€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 634 | +0.170 | +376.63€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.166: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.071 n=1715 | neutral: IC=+0.021 n=1358 | overbought(IBS>0.7): IC=+0.186 n=1663
  - _Datos_: n=5049 IC=+0.102 PNL=+1311.79€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.109 n=23777 | tras_1loss IC=+0.078 n=16046 | tras_2loss IC=+0.053 n=6737/40 | gap=+0.056 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2831 IC=+0.039 PNL=+281.62€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2831 IC=+0.039 PNL=+281.62€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1133 IC=+0.055 PNL=+155.10€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1133 IC=+0.055 PNL=+155.10€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.089 > 0.08 con n=1424 PNL=+242.79€
  - _Datos_: n=1424 IC=+0.089 PNL=+242.79€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1502 IC=+0.039 PNL=+116.52€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1502 IC=+0.039 PNL=+116.52€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=190 IC=+0.057 PNL=+62.93€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=190 IC=+0.057 PNL=+62.93€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3774 IC=+0.063 PNL=+557.72€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3774 IC=+0.063 PNL=+557.72€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1283 IC=+0.031 PNL=+124.55€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1283 IC=+0.031 PNL=+124.55€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=1035 PNL=+348.16€
  - _Datos_: n=1035 IC=+0.160 PNL=+348.16€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=297 IC=+0.079 PNL=+53.77€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=297 IC=+0.079 PNL=+53.77€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1025 IC=-0.074 PNL=+250.78€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1025 IC=-0.074 PNL=+250.78€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.120 > 0.08 con n=729 PNL=+201.35€
  - _Datos_: n=729 IC=+0.120 PNL=+201.35€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.106 > 0.08 con n=613 PNL=+183.28€
  - _Datos_: n=613 IC=+0.106 PNL=+183.28€
