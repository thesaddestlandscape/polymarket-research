# Hipótesis automáticas — 2026-07-20 03:54 UTC
_Generado por shadow_postmortem.py sobre 23773 resoluciones (PNL=+6088.81€)_
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.215 (n=594)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `4191.5309` → IC=+0.175 (n=1063)
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.120 n=14378 | tras_1loss IC=+0.093 n=9202 | tras_2loss IC=+0.060 n=3712/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=21315 IC=+0.123 PNL=+6164.69€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=21315 IC=+0.123 PNL=+6164.69€
