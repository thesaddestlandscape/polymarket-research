# Hipótesis automáticas — 2026-07-06 00:23 UTC
_Generado por shadow_postmortem.py sobre 4079 resoluciones (PNL=+200.12€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.140 (n=98)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0086 (IC base=+0.030)

- **PATRÓN** `ibs_15` < `0.0394` → IC=+0.178 (n=57)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.89€ cuando `ibs_15` < 0.0394 (IC base=+0.030)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.188 (n=30)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0059 (IC base=+0.070)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.132 (n=55)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 13.0 (IC base=+0.070)

- **PATRÓN** `ibs_15` < `0.0431` → IC=+0.194 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.97€ cuando `ibs_15` < 0.0431 (IC base=+0.070)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1209 | +0.093 | +301.11€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1209 | +0.093 | +301.11€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 315 | +0.033 | +30.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 315 | +0.033 | +30.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 316 | +0.060 | +37.92€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 316 | +0.060 | +37.92€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 317 | +0.130 | +125.10€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 317 | +0.130 | +125.10€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 261 | +0.158 | +107.29€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 261 | +0.158 | +107.29€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 972 | -0.036 | -53.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 733 | -0.013 | -23.04€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 414 | -0.005 | +3.58€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 327 | +0.014 | +11.58€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.065) — sin ventaja clara. oversold(IBS<0.3): IC=-0.007 n=209 | neutral: IC=-0.072 n=164 | overbought(IBS>0.7): IC=-0.040 n=187
  - _Datos_: n=582 IC=-0.033 PNL=-27.76€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.029 n=2049 | tras_1loss IC=-0.002 n=1917 | tras_2loss IC=-0.022 n=946/40 | gap=+0.051 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=849 IC=-0.031 PNL=-39.44€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=849 IC=-0.031 PNL=-39.44€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=271 IC=+0.002 PNL=+2.27€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=271 IC=+0.002 PNL=+2.27€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1629 IC=+0.061 PNL=+275.30€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1629 IC=+0.061 PNL=+275.30€
