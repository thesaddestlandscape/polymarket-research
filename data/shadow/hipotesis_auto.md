# Hipótesis automáticas — 2026-08-28 00:47 UTC
_Generado por shadow_postmortem.py sobre 181129 resoluciones (PNL=+13130.80€)_
...
- **FILTRO** `restante_s_al_confirmar` < `104.39` → IC=-0.407 (n=322)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 104.39
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=969)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `161.14` → IC=-0.172 (n=683)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 161.14
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2052)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `147.51` → IC=-0.287 (n=590)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.51
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1770)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `120.59` → IC=-0.373 (n=439)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 120.59
  - _Potencial_: sin este filtro IC_bueno=-0.111 (n=1317)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=5614)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1616)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2376.0723` → IC=+0.173 (n=1560)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.157 (n=4389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.188 (n=3020)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.02 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `1890.0155` → IC=+0.179 (n=2529)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 1890.0155 (IC base=+0.142)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=813)
...
- **PATRÓN** `libro_liquidez` > `4191.7874` → IC=+0.148 (n=288)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 4191.7874 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.127 (n=1058)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 15.0 (IC base=+0.124)

- **PATRÓN** `py_entrada` > `0.69` → IC=+0.312 (n=414)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.191 (n=3947)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.187)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.200 (n=2229)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.179 (n=1013)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.169 (n=996)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 15.0 (IC base=+0.164)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.169 (n=427)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.229 (n=898)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.229)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.320 (n=370)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.184 (n=974)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 15.0 (IC base=+0.183)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.202 (n=575)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.191 (n=9032)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 12.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.220 (n=9222)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.130 (n=1663)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 12.0 (IC base=+0.127)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.157 (n=1567)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.285 (n=1150)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.167 (n=1543)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 12.0 (IC base=+0.165)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.205 (n=1046)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.230 (n=977)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.228)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.291 (n=715)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.244 (n=1252)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.191 (n=1522)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 12.0 (IC base=+0.185)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.211 (n=1592)
...
- **PATRÓN** `restante_min` < `3.96` → IC=+0.136 (n=1556)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 3.96 (IC base=+0.133)

- **PATRÓN** `restante_min` > `4.93` → IC=+0.162 (n=1611)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` > 4.93 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.150 (n=2256)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 8.0 (IC base=+0.133)

- **PATRÓN** `lag_apertura_s` < `4.33` → IC=+0.161 (n=1554)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 4.33 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.138 (n=1140)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 8.0 (IC base=+0.127)

- **PATRÓN** `lag_apertura_s` < `3.43` → IC=+0.174 (n=781)
...
- **PATRÓN** `py_entrada` > `0.87` → IC=+0.447 (n=111)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.87 (IC base=+0.290)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.310 (n=356)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.290)

- **PATRÓN** `libro_liquidez` > `1692.7461` → IC=+0.337 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1692.7461 (IC base=+0.290)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9497` → IC=+0.208 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9497 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` > `0.1871` → IC=+0.230 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1871 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` < `0.4917` → IC=+0.211 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4917 (IC base=+0.066)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.223` → IC=+0.159 (n=955)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 5.223 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` < `0.6304` → IC=+0.212 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6304 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `1.067` → IC=+0.243 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.067 (IC base=+0.066)

- **PATRÓN** `volumen_pendiente_norm` > `0.3074` → IC=+0.161 (n=184)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.3074 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` < `2.443` → IC=+0.149 (n=1134)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.443 (IC base=+0.066)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.170 (n=177)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0075 (IC base=+0.123)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.164 (n=251)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 8.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.282 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.843` → IC=+0.320 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.843 (IC base=+0.123)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.150 (n=332)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3341` → IC=+0.218 (n=349)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.208 (n=375)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 16.0 (IC base=+0.207)

- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.224 (n=396)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.343` → IC=+0.221 (n=206)
...
- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.236 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0851 (IC base=+0.207)

- **PATRÓN** `volumen_pendiente_norm` < `0.0762` → IC=+0.208 (n=354)
...
- **PATRÓN** `libro_liquidez` > `11354.7125` → IC=+0.222 (n=354)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11354.7125 (IC base=+0.207)

- **PATRÓN** `ballena_activa_n` < `309.0` → IC=+0.205 (n=215)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.923` → IC=+0.260 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.923 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` < `0.1415` → IC=+0.130 (n=368)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1415 (IC base=+0.142)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7287` → IC=+0.130 (n=393)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.7287 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=423)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `1910.5673` → IC=+0.145 (n=215)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 1910.5673 (IC base=+0.142)
...
- **FILTRO** `ibs_20min` > `0.5` → IC=-0.139 (n=644)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.972` → IC=-0.155 (n=282)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1054)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.696` → IC=-0.155 (n=195)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.696
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1009)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.138 (n=1349)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0077 (IC base=+0.056)

- **PATRÓN** `ibs_20min` > `0.9467` → IC=+0.248 (n=989)
...
- **PATRÓN** `volumen_regimen` > `1.172` → IC=+0.201 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.172 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` < `0.1146` → IC=+0.176 (n=1336)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` < 0.1146 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.2486` → IC=+0.206 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2486 (IC base=+0.056)
...
- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.276 (n=825)
...
- **PATRÓN** `volumen_regimen` > `1.2342` → IC=+0.233 (n=260)
...
- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.264 (n=518)
...
- **FILTRO** `ibs_20min` > `0.8857` → IC=-0.149 (n=280)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=844)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1014` → IC=+0.216 (n=206)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.256 (n=162)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.03` → IC=+0.298 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.03 (IC base=+0.190)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.219 (n=421)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4831` → IC=+0.273 (n=522)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` < `0.264` → IC=+0.280 (n=562)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.197 (n=859)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0101 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.3373` → IC=+0.158 (n=2268)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.160 (n=947)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 6.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.282 (n=1266)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.8123` → IC=+0.252 (n=612)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8123 (IC base=+0.157)
...
- **PATRÓN** `volumen_regimen` > `0.6881` → IC=+0.175 (n=1596)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2798` → IC=+0.155 (n=2047)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.2798 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.8485` → IC=+0.152 (n=1550)
...
- **PATRÓN** `ibs_20min` < `0.4099` → IC=+0.237 (n=2290)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4099 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.214` → IC=+0.177 (n=1841)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.214 (IC base=+0.183)
...
- **PATRÓN** `volumen_regimen` < `1.1669` → IC=+0.164 (n=1832)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1669 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `0.8521` → IC=+0.172 (n=1221)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8521 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2897` → IC=+0.255 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2897 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` < `1.8834` → IC=+0.172 (n=1120)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.8834 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.653` → IC=+0.208 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.653 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `129.0` → IC=+0.189 (n=1099)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2679` → IC=+0.152 (n=421)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.2679 (IC base=+0.146)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.210 (n=153)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.083` → IC=+0.332 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.083 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1485` → IC=+0.186 (n=100)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1485 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.131 (n=342)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.196 (n=123)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0072 (IC base=+0.176)

- **PATRÓN** `drift_60min` |x|≤ `0.4292` → IC=+0.177 (n=367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.4292 (IC base=+0.176)
...
- **PATRÓN** `dist_vwap_pct` > `0.211` → IC=+0.233 (n=275)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.211 (IC base=+0.176)
...
- **PATRÓN** `volumen_regimen` < `1.2894` → IC=+0.180 (n=367)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 1.2894 (IC base=+0.176)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.198 (n=167)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 1.0855 (IC base=+0.176)
...
- **PATRÓN** `libro_liquidez` > `12288.7036` → IC=+0.192 (n=245)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 12288.7036 (IC base=+0.176)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1487` → IC=+0.171 (n=247)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.1487 (IC base=+0.160)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2295` → IC=+0.154 (n=307)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.2295 (IC base=+0.160)
...
- **PATRÓN** `volumen_spike_ratio` > `3.6311` → IC=+0.150 (n=141)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 3.6311 (IC base=+0.160)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.187 (n=321)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `1955.5029` → IC=+0.188 (n=123)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 1955.5029 (IC base=+0.160)
...
- **PATRÓN** `dist_vwap_pct` < `0.1494` → IC=+0.161 (n=446)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1494 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.272` → IC=+0.198 (n=137)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.272 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `1.1531` → IC=+0.158 (n=439)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1531 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.158 (n=439)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6129 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.0994` → IC=+0.172 (n=132)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.0994 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.8946` → IC=+0.179 (n=222)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.8946 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `10334.4562` → IC=+0.158 (n=147)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 10334.4562 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.137 (n=111)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 126.0 (IC base=+0.144)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.208 (n=231)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0107 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.147 (n=468)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 8.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` > `0.8519` → IC=+0.234 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8519 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` > `0.8776` → IC=+0.270 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8776 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.259` → IC=+0.295 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.259 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` > `0.6201` → IC=+0.141 (n=510)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6201 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` < `0.0941` → IC=+0.127 (n=456)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` < 0.0941 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` < `1.4397` → IC=+0.130 (n=160)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4397 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` > `1.5512` → IC=+0.134 (n=427)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.5512 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `3227.897` → IC=+0.233 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3227.897 (IC base=+0.124)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6622` → IC=+0.233 (n=518)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.381` → IC=+0.258 (n=518)
...
- **PATRÓN** `volumen_regimen` > `0.6252` → IC=+0.238 (n=518)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.126 (n=209)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6267` → IC=+0.168 (n=411)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.6267 (IC base=+0.097)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.195 (n=1361)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0081 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.174 (n=1009)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 18.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.94` → IC=+0.290 (n=1361)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.94 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.7706` → IC=+0.232 (n=646)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7706 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.515` → IC=+0.227 (n=1758)
...
- **PATRÓN** `volumen_regimen` > `1.0767` → IC=+0.155 (n=963)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.0767 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1649` → IC=+0.182 (n=769)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1649 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.3027` → IC=+0.149 (n=2360)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.3027 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.8592` → IC=+0.159 (n=1788)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8592 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2432)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `2501.4019` → IC=+0.176 (n=2000)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2501.4019 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `149.0` → IC=+0.192 (n=1428)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 149.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.219 (n=1798)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.4731` → IC=+0.202 (n=2696)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4731 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=1020)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 17.0 (IC base=+0.190)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.207 (n=962)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` < `0.5617` → IC=+0.246 (n=2696)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5617 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` < `0.7284` → IC=+0.181 (n=2147)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.7284 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.366` → IC=+0.206 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.366 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.629` → IC=+0.192 (n=2524)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.629 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` < `0.6218` → IC=+0.184 (n=669)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6218 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` > `1.1969` → IC=+0.180 (n=669)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 1.1969 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.2828` → IC=+0.264 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2828 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.2922` → IC=+0.208 (n=906)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2922 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `177.0` → IC=+0.167 (n=1568)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 177.0 (IC base=+0.190)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.210 (n=219)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.147)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.308` → IC=+0.301 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.308 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.2139` → IC=+0.218 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2139 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.9109` → IC=+0.146 (n=269)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.9109 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.195 (n=283)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.04 (IC base=+0.147)
...
- **PATRÓN** `ibs_20min` > `0.3266` → IC=+0.207 (n=480)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.582` → IC=+0.190 (n=127)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 9.582 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `1.2659` → IC=+0.161 (n=481)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2659 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `1.0896` → IC=+0.177 (n=218)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.0896 (IC base=+0.153)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0884` → IC=+0.178 (n=380)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.0884 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.3655` → IC=+0.180 (n=432)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.3655 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `11985.6464` → IC=+0.174 (n=320)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 11985.6464 (IC base=+0.153)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.154 (n=484)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.345` → IC=+0.193 (n=484)
...
- **PATRÓN** `volumen_regimen` < `0.6983` → IC=+0.170 (n=213)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.6983 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.1936` → IC=+0.165 (n=162)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.1936 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.2673` → IC=+0.269 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2673 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `2.4116` → IC=+0.237 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4116 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `5099.5365` → IC=+0.220 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5099.5365 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.180 (n=239)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 165.0 (IC base=+0.140)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2741` → IC=+0.138 (n=324)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.2741 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=231)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.5909` → IC=+0.198 (n=485)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.5909 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.4738` → IC=+0.139 (n=433)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4738 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.042` → IC=+0.133 (n=475)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 3.042 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.7039` → IC=+0.148 (n=214)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7039 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.0719` → IC=+0.162 (n=137)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0719 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `2.0691` → IC=+0.136 (n=297)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.0691 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `1.4382` → IC=+0.134 (n=337)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.4382 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2610.631` → IC=+0.158 (n=220)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2610.631 (IC base=+0.111)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4789` → IC=+0.227 (n=596)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4789 (IC base=+0.214)
...
- **PATRÓN** `ibs_20min` < `0.4912` → IC=+0.275 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4912 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `1.245` → IC=+0.222 (n=786)
...
- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.246 (n=226)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2332 (IC base=+0.214)
...
- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.178 (n=393)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.148 (n=1051)

- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.140 (n=551)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.9286` → IC=+0.174 (n=210)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.9286 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.856` → IC=+0.147 (n=100)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 9.856 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.509` → IC=+0.126 (n=570)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.509 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` < `0.6826` → IC=+0.130 (n=214)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 0.6826 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` > `1.0529` → IC=+0.144 (n=220)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.0529 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.2806` → IC=+0.211 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2806 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.505` → IC=+0.132 (n=270)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.505 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `2.1975` → IC=+0.137 (n=279)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.1975 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `9436.689` → IC=+0.136 (n=284)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 9436.689 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.191 (n=267)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0036 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.3642` → IC=+0.170 (n=704)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.0855` → IC=+0.151 (n=800)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.0855 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.6384` → IC=+0.156 (n=193)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6384 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.3912` → IC=+0.134 (n=761)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.3912 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.056` → IC=+0.143 (n=357)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 4.056 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.072` → IC=+0.151 (n=803)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.072 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.2036` → IC=+0.155 (n=777)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2036 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` < `0.0944` → IC=+0.146 (n=719)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.0944 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.155 (n=381)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `2.4927` → IC=+0.160 (n=792)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4927 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.4169` → IC=+0.150 (n=792)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4169 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=1051)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.169 (n=448)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0065 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.3655` → IC=+0.158 (n=448)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3655 (IC base=+0.142)
...
- **PATRÓN** `ibs_20min` > `0.3932` → IC=+0.147 (n=298)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.3932 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.6118` → IC=+0.179 (n=79)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.6118 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.34` → IC=+0.157 (n=453)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.34 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.156 (n=448)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1847 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.184 (n=207)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `2.5268` → IC=+0.153 (n=445)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7814` → IC=+0.145 (n=297)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7814 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `11906.7023` → IC=+0.144 (n=400)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 11906.7023 (IC base=+0.142)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.205 (n=59)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0091 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.262 (n=61)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 13.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.4667` → IC=+0.210 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4667 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.9583` → IC=+0.371 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9583 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.697` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.697 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.072` → IC=+0.155 (n=82)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.072 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1831` → IC=+0.293 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1831 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `3.2505` → IC=+0.159 (n=86)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 3.2505 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `2.2445` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.2445 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `1720.343` → IC=+0.174 (n=87)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1720.343 (IC base=+0.150)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.182 (n=250)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0094 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.4394` → IC=+0.167 (n=220)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.4394 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.203 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.147 (n=114)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 5.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.8027` → IC=+0.196 (n=113)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.8027 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.9756` → IC=+0.200 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9756 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.4035` → IC=+0.152 (n=219)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4035 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.126` → IC=+0.175 (n=38)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 11.126 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.985` → IC=+0.143 (n=214)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 2.985 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.6437` → IC=+0.186 (n=84)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6437 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.171` → IC=+0.167 (n=76)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.171 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.412` → IC=+0.199 (n=81)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.412 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.8041` → IC=+0.146 (n=162)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8041 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8958.3045` → IC=+0.171 (n=223)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 8958.3045 (IC base=+0.144)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.155 (n=56)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.026)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.170 (n=870)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=2684)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.216 (n=841)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2700)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.179 (n=884)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=2657)
...
- **FILTRO** `ibs_20min` > `0.1844` → IC=-0.122 (n=305)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.136 (n=116)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=425)

- **FILTRO** `py_entrada` < `0.5` → IC=-0.181 (n=236)
...
- **FILTRO** `ibs_20min` < `0.7271` → IC=-0.186 (n=135)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=406)
...
- **FILTRO** `py_entrada` > `0.52` → IC=-0.179 (n=154)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.137 (n=2152)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=6713)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.282 (n=2145)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=6720)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.232 (n=2210)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=6655)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.173 (n=3007)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=5858)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.231 (n=2488)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=8258)

- **FILTRO** `ibs_7min` > `0.7241` → IC=-0.174 (n=2686)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7241
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=8060)
...
- **FILTRO** `py_entrada` > `0.71` → IC=-0.232 (n=439)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1411)

- **FILTRO** `drift_7min_pct` |x|> `0.1354` → IC=-0.152 (n=628)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1354
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1222)

- **FILTRO** `ibs_7min` > `0.8429` → IC=-0.190 (n=462)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8429
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1388)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.253 (n=406)
...
- **FILTRO** `ibs_7min` < `0.797` → IC=-0.181 (n=430)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1295)

- **FILTRO** `ballena_activa_n` > `158.0` → IC=-0.191 (n=428)

  - _Acción_: SKIP cuando `ballena_activa_n` > 158.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1297)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.226 (n=410)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1319)

- **FILTRO** `ballena_activa_n` > `94.0` → IC=-0.160 (n=586)

  - _Acción_: SKIP cuando `ballena_activa_n` > 94.0
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1143)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.201 (n=299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=978)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.317 (n=408)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=869)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.285 (n=319)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=958)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.283 (n=307)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=970)
...
- **FILTRO** `ibs_7min` > `0.8184` → IC=-0.194 (n=469)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8184
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1408)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.156 (n=324)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=1165)

- **FILTRO** `py_entrada` < `0.44` → IC=-0.214 (n=714)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=775)

- **FILTRO** `ibs_7min` < `0.7575` → IC=-0.187 (n=372)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7575
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=1117)

- **FILTRO** `ballena_activa_n` > `42.0` → IC=-0.205 (n=371)
...
- **FILTRO** `hora_utc` > `18.0` → IC=-0.141 (n=318)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=1164)
...
- **FILTRO** `ibs_7min` > `0.1889` → IC=-0.161 (n=503)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1889
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=979)

- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.181 (n=493)

  - _Acción_: SKIP cuando `ballena_activa_n` > 26.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=989)
...
- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.195 (n=424)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1278)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.188 (n=414)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1288)
...
- **FILTRO** `py_entrada` < `0.38` → IC=-0.289 (n=363)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1113)

- **FILTRO** `ibs_7min` < `0.7532` → IC=-0.209 (n=369)
...
- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.223 (n=363)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1113)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.266 (n=378)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1447)
...
- **PATRÓN** `delta_ratio` |x|> `0.4489` → IC=+0.179 (n=104)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `delta_ratio` |x|> 0.4489 (IC base=+0.121)
...
- **PATRÓN** `total_vol_5m` < `451.687` → IC=+0.197 (n=97)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `total_vol_5m` < 451.687 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `3571.4392` → IC=+0.159 (n=80)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3571.4392 (IC base=+0.121)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.123 (n=136)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 47.0 (IC base=+0.121)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.131 (n=158)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 14.0 (IC base=+0.076)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.126 (n=89)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 24.0 (IC base=+0.076)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1210)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1957` → IC=+0.328 (n=155)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_15` > `0.8116` → IC=+0.371 (n=138)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8116 (IC base=+0.316)

- **PATRÓN** `dist_vwap_pct` > `0.156` → IC=+0.344 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.156 (IC base=+0.316)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.354` → IC=+0.343 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.354 (IC base=+0.316)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.318 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.316)

- **PATRÓN** `libro_liquidez` > `8147.128` → IC=+0.370 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8147.128 (IC base=+0.316)

- **PATRÓN** `ballena_activa_n` < `540.0` → IC=+0.381 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 540.0 (IC base=+0.316)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1971` → IC=+0.310 (n=77)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1971 (IC base=+0.297)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.403 (n=29)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.297)

- **PATRÓN** `drift_60min` |x|≤ `0.16` → IC=+0.323 (n=77)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.16 (IC base=+0.297)

- **PATRÓN** `drift_15min` |x|≤ `0.4136` → IC=+0.329 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4136 (IC base=+0.297)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.444 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.133 (IC base=+0.297)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.323 (n=94)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.297)

- **PATRÓN** `ibs_15` > `0.838` → IC=+0.338 (n=78)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.838 (IC base=+0.297)

- **PATRÓN** `dist_vwap_pct` > `0.4311` → IC=+0.393 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4311 (IC base=+0.297)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.871` → IC=+0.311 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.871 (IC base=+0.297)

- **PATRÓN** `sigma_ewma_delta_pct` < `13.538` → IC=+0.295 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 13.538 (IC base=+0.297)

- **PATRÓN** `libro_liquidez` > `8657.61` → IC=+0.381 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8657.61 (IC base=+0.297)

- **PATRÓN** `ballena_activa_n` < `478.0` → IC=+0.447 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 478.0 (IC base=+0.297)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.455` → IC=-0.169 (n=348)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2590)
...
- **PATRÓN** `ibs_15` > `0.6897` → IC=+0.269 (n=201)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6897 (IC base=-0.060)
...
- **FILTRO** `sigma_ewma_delta_pct` > `15.954` → IC=-0.147 (n=114)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.285 (n=161)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_15min` |x|≤ `0.8433` → IC=+0.282 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.8433 (IC base=+0.280)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3048` → IC=+0.328 (n=120)
...
- **PATRÓN** `ibs_15` > `0.9652` → IC=+0.357 (n=110)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9652 (IC base=+0.280)

- **PATRÓN** `dist_vwap_pct` > `0.3` → IC=+0.346 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3 (IC base=+0.280)
...
- **PATRÓN** `libro_liquidez` > `12445.3624` → IC=+0.343 (n=81)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.274 (n=60)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.265)

- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.292 (n=46)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0057 (IC base=+0.265)

- **PATRÓN** `drift_60min` |x|≤ `0.1871` → IC=+0.290 (n=136)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1871 (IC base=+0.265)

- **PATRÓN** `drift_15min` |x|≤ `0.6671` → IC=+0.271 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.6671 (IC base=+0.265)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1438` → IC=+0.296 (n=91)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1438 (IC base=+0.265)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1224` → IC=+0.346 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1224 (IC base=+0.265)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.315 (n=63)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.265)

- **PATRÓN** `ibs_15` > `0.9678` → IC=+0.328 (n=62)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9678 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` > `0.3131` → IC=+0.344 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3131 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.789` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.789 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.866` → IC=+0.272 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.866 (IC base=+0.265)

- **PATRÓN** `libro_liquidez` > `13620.7369` → IC=+0.333 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13620.7369 (IC base=+0.265)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6897 sube el IC de -0.060 a +0.269 en UPDOWN_GBM_15M_TARDIO (n=201). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.9652 sube el IC de +0.280 a +0.357 en UPDOWN_GBM_IBS_ALTO (n=110). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.9678 sube el IC de +0.265 a +0.328 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=62). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.8116 sube el IC de +0.316 a +0.371 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=138). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.838 sube el IC de +0.297 a +0.338 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15
 | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1265 | -0.074 | +203.72€ | 3 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1192 | -0.088 | +201.94€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1192 | -0.088 | +201.94€ | 3 | 0 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 321 | +0.280 | +242.23€ | 0 | 12 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 321 | +0.280 | +242.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 181 | +0.265 | +127.03€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 181 | +0.265 | +127.03€ | 0 | 12 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.090) — sin ventaja clara. oversold(IBS<0.3): IC=+0.013 n=2217 | neutral: IC=-0.001 n=2384 | overbought(IBS>0.7): IC=+0.089 n=2467
  - _Datos_: n=7385 IC=+0.035 PNL=+657.10€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: (cache 109s) 24 celda(s) GATE OK de 2107 trackeadas

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=-0.003 < 0.08 — monitorear
  - _Datos_: n=537 IC=-0.003 PNL=-3.59€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.075 n=101682 | tras_1loss IC=+0.045 n=79142 | tras_2loss IC=+0.009 n=35911/40 | gap=+0.067 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 6202 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.

**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  - _Umbral_: n≥60 alineadas y gap IC≥0.08 vs contrarias — y descartar que sea proxy de drift_15min/60min
  - _Acción_: Si confirma e independiente de drift → capturar prev_window_outcome como feature en shadow_predict y boost ×1.1-1.2 en señales alineadas
  - _Estado_: alineada_con_outcome_prev IC=+0.087 n=44/60 | contraria IC=+0.000 n=24 | gap=+0.087 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=173/40 IC=+0.009 PNL=+0.27€ | BTC#60min: n=126/40 IC=-0.039 PNL=-7.13€ | SOL#60min: n=91/40 IC=-0.027 PNL=-2.45€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.013 n=666 | contrario_BTC IC=-0.014 n=504/40 | gap=-0.000 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=6017 IC=+0.001 PNL=+100.27€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=6017 IC=+0.001 PNL=+100.27€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=322 IC=+0.003 PNL=-1.42€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=322 IC=+0.003 PNL=-1.42€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1343 IC=+0.027 PNL=+83.33€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1343 IC=+0.027 PNL=+83.33€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1667 IC=+0.023 PNL=+99.73€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1667 IC=+0.023 PNL=+99.73€
...
**🟡 H-CUSTOM-OF-VOLUMEN-ALTO** — ORDER_FLOW_5M con total_vol_5m alto — ¿volumen extremo mejora el IC?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.093 > 0.08 con n=111 PNL=+22.36€
  - _Datos_: n=111 IC=+0.093 PNL=+22.36€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=13504 IC=+0.100 PNL=+3881.97€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13504 IC=+0.100 PNL=+3881.97€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=836 IC=+0.031 PNL=+51.46€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=836 IC=+0.031 PNL=+51.46€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.122 > 0.02 con n=239 PNL=+68.68€
  - _Datos_: n=239 IC=+0.122 PNL=+68.68€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1537 IC=+0.023 PNL=+83.81€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1537 IC=+0.023 PNL=+83.81€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=4670 IC=-0.143 PNL=+189.99€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=4670 IC=-0.143 PNL=+189.99€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1215 IC=+0.140 PNL=+628.85€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1215 IC=+0.140 PNL=+628.85€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.177 > 0.08 con n=581 PNL=+339.29€
  - _Datos_: n=581 IC=+0.177 PNL=+339.29€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=1006 IC=-0.052 PNL=+162.95€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1006 IC=-0.052 PNL=+162.95€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.243 > 0.08 con n=1455 PNL=-125.78€
  - _Datos_: n=1455 IC=+0.243 PNL=-125.78€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=3133 IC=+0.127 PNL=-574.68€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=3133 IC=+0.127 PNL=-574.68€
