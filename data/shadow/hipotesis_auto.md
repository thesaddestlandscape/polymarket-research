# Hipótesis automáticas — 2026-09-21 07:41 UTC
_Generado por shadow_postmortem.py sobre 538498 resoluciones (PNL=+60047.75€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.2` → IC=-0.235 (n=6504)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.2
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19515)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.51` → IC=-0.241 (n=885)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.51
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2657)
...
- **FILTRO** `restante_s_al_confirmar` < `133.7` → IC=-0.277 (n=781)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.7
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2345)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `160.9` → IC=-0.232 (n=1534)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.9
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4603)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.85` → IC=-0.364 (n=1289)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.85
  - _Potencial_: sin este filtro IC_bueno=-0.119 (n=3867)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.199 (n=13076)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=3272)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5499.62` → IC=+0.173 (n=2080)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 5499.62 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.142 (n=10359)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 17.0 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.139 (n=12692)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 7.0 (IC base=+0.130)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.235 (n=10009)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=5334)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `1663.561` → IC=+0.158 (n=6007)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1663.561 (IC base=+0.130)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1580)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=1554)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.348 (n=716)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1958)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15704.4993` → IC=+0.232 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15704.4993 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.203 (n=1555)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.262 (n=1415)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=1990)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.147 (n=327)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 7.0 (IC base=+0.115)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.141 (n=613)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1297.6972` → IC=+0.146 (n=609)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=10466)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=10053)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3615)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=2454)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.178 (n=2585)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.260 (n=661)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.257)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.358 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.257)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=2522)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.181)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.186 (n=2414)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=2243)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.240)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.321 (n=790)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=5733)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=1971)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.355` → IC=+0.125 (n=6403)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.355 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9804` → IC=+0.239 (n=2428)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9804 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.7872` → IC=+0.241 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7872 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.5948` → IC=+0.245 (n=2035)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5948 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.93` → IC=+0.176 (n=2803)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.93 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.244 (n=1933)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.0495` → IC=+0.248 (n=876)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0495 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.211 (n=719)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.9171` → IC=+0.205 (n=3286)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9171 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5714` → IC=+0.132 (n=8798)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5714 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.5658` → IC=+0.201 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5658 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.173 (n=2744)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.7009` → IC=+0.177 (n=1321)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.7009 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `0.8696` → IC=+0.174 (n=2003)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.077` → IC=+0.279 (n=714)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.077 (IC base=+0.161)
...
- **PATRÓN** `ibs_20min` < `0.0604` → IC=+0.300 (n=532)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.231 (n=1027)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0914 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` > `0.276` → IC=+0.264 (n=159)
...
- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.167 (n=1307)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6828 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1254` → IC=+0.153 (n=1174)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1254 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.294` → IC=+0.159 (n=212)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.294 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.189` → IC=+0.137 (n=1183)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 4.189 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2085` → IC=+0.147 (n=1307)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2085 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `0.8523` → IC=+0.139 (n=871)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.8523 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.1573` → IC=+0.176 (n=350)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1573 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.4443` → IC=+0.148 (n=1198)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.4443 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.7707` → IC=+0.146 (n=798)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7707 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.145 (n=1114)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 411.0 (IC base=+0.137)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.202 (n=1074)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.186 (n=1685)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.189 (n=1437)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 15.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.264 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.095` → IC=+0.249 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.095 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.2145` → IC=+0.188 (n=1591)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3675` → IC=+0.191 (n=208)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.3675 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.9235` → IC=+0.206 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9235 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.193 (n=1076)
...
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.220 (n=1221)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` < `1.8319` → IC=+0.209 (n=545)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=860)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2024)

- **PATRÓN** `ibs_20min` > `0.9396` → IC=+0.197 (n=328)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.9396 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.3448` → IC=+0.344 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3448 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` < `0.6795` → IC=+0.322 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6795 (IC base=+0.021)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.666` → IC=+0.152 (n=641)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 4.666 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` < `0.6629` → IC=+0.328 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6629 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` > `1.0384` → IC=+0.326 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0384 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` < `0.1688` → IC=+0.325 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1688 (IC base=+0.021)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.127 (n=2000)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=994)

- **FILTRO** `sigma_ewma_delta_pct` > `8.643` → IC=-0.206 (n=325)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.643
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2669)
...
- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.127 (n=994)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=396)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=1636)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.199 (n=756)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=2269)

- **PATRÓN** `dist_vwap_pct` > `0.9637` → IC=+0.296 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9637 (IC base=-0.076)

- **PATRÓN** `dist_vwap_pct` < `0.2555` → IC=+0.314 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2555 (IC base=-0.076)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.299 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6141 (IC base=-0.076)

- **PATRÓN** `volumen_pendiente_norm` > `0.0753` → IC=+0.297 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0753 (IC base=-0.076)

- **PATRÓN** `volumen_spike_ratio` < `1.4208` → IC=+0.287 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4208 (IC base=-0.076)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.192 (n=3022)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.469` → IC=+0.185 (n=8093)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.469 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `1.0075` → IC=+0.289 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0075 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.559` → IC=+0.154 (n=4302)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.559 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1749` → IC=+0.231 (n=3178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1749 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.6821` → IC=+0.242 (n=2839)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6821 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2993` → IC=+0.261 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2993 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4757` → IC=+0.238 (n=1724)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4757 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.7129` → IC=+0.240 (n=1724)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7129 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.267 (n=4675)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.149 (n=3058)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0088 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.5516` → IC=+0.149 (n=8072)
...
- **PATRÓN** `dist_vwap_pct` < `0.1709` → IC=+0.237 (n=2388)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1709 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` < `0.7166` → IC=+0.240 (n=1158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7166 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.2028` → IC=+0.243 (n=878)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6193` → IC=+0.255 (n=1509)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6193 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.3535` → IC=+0.260 (n=1555)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3535 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.263 (n=3307)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.071)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `2.676` → IC=-0.151 (n=655)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.676
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=1480)

- **PATRÓN** `ibs_20min` > `0.8933` → IC=+0.264 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8933 (IC base=+0.046)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.29` → IC=+0.165 (n=860)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4412` → IC=+0.181 (n=261)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.4412 (IC base=+0.046)

- **PATRÓN** `volumen_spike_ratio` > `2.1623` → IC=+0.191 (n=354)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.1623 (IC base=+0.046)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.175 (n=337)
...
- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.153 (n=609)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.86 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.2893` → IC=+0.157 (n=322)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.2893 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` < `1.0443` → IC=+0.145 (n=728)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0443 (IC base=+0.021)

- **PATRÓN** `volumen_regimen` > `0.6622` → IC=+0.152 (n=739)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6622 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` > `0.2774` → IC=+0.204 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2774 (IC base=+0.021)
...
- **PATRÓN** `dist_vwap_pct` < `0.1515` → IC=+0.213 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1515 (IC base=-0.000)

- **PATRÓN** `volumen_regimen` > `0.6059` → IC=+0.210 (n=494)
...
- **PATRÓN** `ballena_activa_n` < `483.0` → IC=+0.211 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 483.0 (IC base=-0.000)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.285 (n=961)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.584` → IC=+0.280 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.584 (IC base=+0.244)

- **PATRÓN** `volumen_pendiente_norm` < `0.1395` → IC=+0.259 (n=1270)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1395 (IC base=+0.244)

- **PATRÓN** `volumen_spike_ratio` > `2.9543` → IC=+0.263 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9543 (IC base=+0.244)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.255 (n=953)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1927.5618` → IC=+0.255 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1927.5618 (IC base=+0.244)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.330 (n=516)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.2248` → IC=+0.291 (n=1002)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2248 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.816` → IC=+0.304 (n=436)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6234` → IC=+0.294 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6234 (IC base=+0.286)

- **PATRÓN** `volumen_spike_ratio` > `2.2024` → IC=+0.289 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2024 (IC base=+0.286)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.299 (n=711)
...
- **FILTRO** `ibs_20min` > `0.7832` → IC=-0.176 (n=541)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7832
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1627)

- **PATRÓN** `ibs_20min` > `0.902` → IC=+0.174 (n=437)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.902 (IC base=+0.005)

- **PATRÓN** `dist_vwap_pct` > `0.4431` → IC=+0.224 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4431 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` < `0.9813` → IC=+0.229 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9813 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `0.6433` → IC=+0.209 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6433 (IC base=+0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.2675` → IC=+0.289 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2675 (IC base=+0.005)

- **PATRÓN** `volumen_spike_ratio` < `1.5025` → IC=+0.253 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5025 (IC base=+0.005)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.258 (n=300)
...
- **FILTRO** `ibs_20min` < `0.7083` → IC=-0.204 (n=964)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.268 (n=965)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.232 (n=501)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.094 (n=1523)

- **FILTRO** `sigma_ewma_delta_pct` > `4.704` → IC=-0.177 (n=450)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.704
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=1574)

- **PATRÓN** `ibs_20min` > `0.7083` → IC=+0.268 (n=965)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7083 (IC base=+0.032)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.568` → IC=+0.156 (n=303)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.568 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` < `0.8648` → IC=+0.297 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8648 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` > `0.6364` → IC=+0.285 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6364 (IC base=+0.032)

- **PATRÓN** `volumen_pendiente_norm` < `0.1047` → IC=+0.287 (n=647)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7975` → IC=+0.301 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7975 (IC base=+0.032)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.312 (n=589)
...
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.318 (n=787)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0161 (IC base=+0.274)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.290 (n=556)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.274)

- **PATRÓN** `ibs_20min` > `0.9111` → IC=+0.344 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9111 (IC base=+0.274)

- **PATRÓN** `dist_vwap_pct` > `0.1916` → IC=+0.315 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1916 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.487` → IC=+0.298 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.487 (IC base=+0.274)

- **PATRÓN** `volumen_regimen` > `0.8611` → IC=+0.297 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8611 (IC base=+0.274)
...
- **PATRÓN** `volumen_regimen` > `1.2432` → IC=+0.312 (n=434)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5342` → IC=+0.267 (n=1137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5342 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.17` → IC=+0.272 (n=516)
...
- **PATRÓN** `libro_liquidez` > `2585.5176` → IC=+0.277 (n=868)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2585.5176 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2388)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.201 (n=2386)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0109 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.185 (n=2385)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0889 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=7436)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5808` → IC=+0.216 (n=7146)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5808 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1685` → IC=+0.195 (n=3105)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1685 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.241` → IC=+0.258 (n=1470)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.241 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2155` → IC=+0.160 (n=4726)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2155 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6251` → IC=+0.158 (n=4727)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6251 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2976` → IC=+0.194 (n=1059)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2976 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5656` → IC=+0.169 (n=3004)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5656 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6475` → IC=+0.176 (n=2276)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6475 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2378.896` → IC=+0.168 (n=4764)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2378.896 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.179 (n=6063)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.183 (n=4546)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.4787` → IC=+0.226 (n=6814)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4787 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2248` → IC=+0.159 (n=4992)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2248 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.24` → IC=+0.196 (n=1157)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.24 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1802` → IC=+0.152 (n=4968)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.168 (n=2705)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2814` → IC=+0.174 (n=2787)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2814 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.172 (n=5781)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 120.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.216 (n=414)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.182)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.191 (n=409)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0083 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.3367` → IC=+0.206 (n=1228)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3367 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.195 (n=821)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.097` → IC=+0.310 (n=557)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.181 (n=1128)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2774` → IC=+0.256 (n=129)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.207 (n=353)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.186 (n=1109)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4138` → IC=+0.226 (n=1057)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4138 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.1954` → IC=+0.212 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1954 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.506` → IC=+0.237 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.506 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.168 (n=1057)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2629 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.201 (n=232)
...
- **PATRÓN** `libro_liquidez` > `15765.4015` → IC=+0.170 (n=480)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4465` → IC=+0.144 (n=1051)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.4465 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.763` → IC=+0.134 (n=701)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.225 (n=543)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0094 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.2095` → IC=+0.214 (n=796)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2095 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.223 (n=406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.291 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.797` → IC=+0.281 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.797 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` < `0.2133` → IC=+0.196 (n=1152)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` < 0.2133 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.9287` → IC=+0.208 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9287 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=797)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `1931.278` → IC=+0.205 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1931.278 (IC base=+0.197)
...
- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.167 (n=1138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0077 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.161 (n=1137)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1191)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3921` → IC=+0.200 (n=1137)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3921 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.1538` → IC=+0.185 (n=756)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1538 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.003` → IC=+0.240 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.003 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.0496` → IC=+0.153 (n=1000)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.0496 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.152 (n=1137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4237` → IC=+0.154 (n=371)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4237 (IC base=+0.147)
...
- **PATRÓN** `libro_liquidez` > `6941.7258` → IC=+0.183 (n=758)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 6941.7258 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.149 (n=1072)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 167.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.159 (n=1198)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3806` → IC=+0.142 (n=1198)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6186` → IC=+0.170 (n=1198)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6186 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3435` → IC=+0.137 (n=1291)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.3435 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.926` → IC=+0.177 (n=425)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 6.926 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8526` → IC=+0.143 (n=799)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4865` → IC=+0.141 (n=360)
...
- **PATRÓN** `libro_liquidez` > `2892.276` → IC=+0.193 (n=588)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2892.276 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.133 (n=984)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1334)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.209 (n=1316)
...
- **PATRÓN** `dist_vwap_pct` < `0.1939` → IC=+0.137 (n=1204)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1939 (IC base=+0.112)
...
- **PATRÓN** `volumen_regimen` < `1.1914` → IC=+0.122 (n=1316)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=1281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.199 (n=570)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.198)

- **PATRÓN** `ibs_20min` > `0.7351` → IC=+0.257 (n=1105)
...
- **PATRÓN** `volumen_regimen` < `1.2094` → IC=+0.201 (n=1237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2094 (IC base=+0.198)

- **PATRÓN** `volumen_regimen` > `0.8592` → IC=+0.215 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8592 (IC base=+0.198)

- **PATRÓN** `volumen_pendiente_norm` > `0.2376` → IC=+0.278 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2376 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` < `2.1696` → IC=+0.208 (n=1050)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1696 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `1.8141` → IC=+0.205 (n=794)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8141 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.199 (n=1295)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `2590.751` → IC=+0.199 (n=824)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2590.751 (IC base=+0.198)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.214 (n=596)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` < `0.4426` → IC=+0.247 (n=1294)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.356` → IC=+0.243 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.356 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6303` → IC=+0.217 (n=1293)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4601` → IC=+0.198 (n=1154)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4601 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2562.9213` → IC=+0.211 (n=862)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1349` → IC=+0.153 (n=736)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3958` → IC=+0.182 (n=1669)
...
- **PATRÓN** `volumen_regimen` < `0.8708` → IC=+0.165 (n=964)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8708 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6967` → IC=+0.149 (n=1293)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6967 (IC base=+0.146)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4378` → IC=+0.158 (n=536)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=1875)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `3232.0177` → IC=+0.150 (n=1113)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.200 (n=3031)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0109 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=9460)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=9088)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.8967` → IC=+0.197 (n=1243)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8967 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.607` → IC=+0.226 (n=4426)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.607 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8814` → IC=+0.164 (n=4050)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8814 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2408` → IC=+0.196 (n=1697)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2408 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.624` → IC=+0.188 (n=2900)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.624 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2327.3906` → IC=+0.169 (n=6054)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2327.3906 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6795)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.192 (n=5502)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0069 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1441` → IC=+0.187 (n=3628)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5665` → IC=+0.238 (n=8245)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5665 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2369` → IC=+0.161 (n=5153)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2369 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.917` → IC=+0.198 (n=1165)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.917 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.709` → IC=+0.183 (n=7997)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.709 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7054` → IC=+0.159 (n=2513)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7054 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2891` → IC=+0.245 (n=1078)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2891 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.2892` → IC=+0.190 (n=3402)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2892 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.190 (n=4790)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.207 (n=1034)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3426` → IC=+0.190 (n=1549)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.3426 (IC base=+0.189)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.195 (n=749)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.200 (n=1047)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.498` → IC=+0.349 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.498 (IC base=+0.189)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8683` → IC=+0.276 (n=716)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.193 (n=484)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1510)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3102` → IC=+0.201 (n=1451)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3102 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.183 (n=818)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.124 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.755` → IC=+0.167 (n=334)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 9.755 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.271` → IC=+0.152 (n=1300)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.271 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6273` → IC=+0.181 (n=484)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6273 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.2695` → IC=+0.192 (n=209)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2695 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.1192` → IC=+0.158 (n=1229)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1192 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4084` → IC=+0.152 (n=1396)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4084 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `13667.9668` → IC=+0.152 (n=967)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13667.9668 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `481.0` → IC=+0.154 (n=1329)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 481.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.163 (n=1261)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0056 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.3167` → IC=+0.159 (n=1261)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3167 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` < `0.6443` → IC=+0.192 (n=1261)
...
- **PATRÓN** `dist_vwap_pct` < `0.1283` → IC=+0.164 (n=1148)
...
- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.160 (n=1261)
...
- **PATRÓN** `ibs_20min` < `0.3648` → IC=+0.271 (n=1194)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3648 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.280 (n=485)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4353` → IC=+0.143 (n=1549)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4353 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1619)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8799` → IC=+0.259 (n=703)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.214` → IC=+0.161 (n=644)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.214 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.877` → IC=+0.159 (n=1033)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.877 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5228` → IC=+0.150 (n=659)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5228 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4706` → IC=+0.153 (n=499)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.4706 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8150.9955` → IC=+0.229 (n=703)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.156 (n=1264)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0076 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.4396` → IC=+0.151 (n=1263)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4396 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.139 (n=582)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 7.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.6933` → IC=+0.184 (n=1264)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6933 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.3612` → IC=+0.140 (n=1264)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3612 (IC base=+0.134)
...
- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.142 (n=842)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8616 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `1.1852` → IC=+0.141 (n=421)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.1852 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2828` → IC=+0.253 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2828 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.149 (n=1192)
...
- **PATRÓN** `ballena_activa_n` < `182.0` → IC=+0.142 (n=1184)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 182.0 (IC base=+0.134)
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.185 (n=1538)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4706 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `1.0401` → IC=+0.200 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0401 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.408` → IC=+0.231 (n=582)
...
- **PATRÓN** `libro_liquidez` > `2907.4324` → IC=+0.240 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2907.4324 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.127 (n=1171)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 54.0 (IC base=+0.104)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.133 (n=1512)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0109 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.1279` → IC=+0.154 (n=504)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1279 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1561)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.6371` → IC=+0.206 (n=1512)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6371 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.2879` → IC=+0.128 (n=1295)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2879 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.126 (n=1461)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.112)
...
- **PATRÓN** `volumen_spike_ratio` < `1.457` → IC=+0.139 (n=452)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.457 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.5357` → IC=+0.125 (n=451)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.5357 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2839.872` → IC=+0.160 (n=504)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1600)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.205 (n=1376)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` > `0.5135` → IC=+0.245 (n=1537)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5135 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `0.188` → IC=+0.226 (n=886)
...
- **PATRÓN** `volumen_regimen` < `0.8799` → IC=+0.204 (n=1025)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8799 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.635` → IC=+0.211 (n=1537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.635 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2361` → IC=+0.241 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2361 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `2.5326` → IC=+0.233 (n=493)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5326 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.211 (n=1589)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2597.572` → IC=+0.213 (n=1025)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2597.572 (IC base=+0.204)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1767)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.5222` → IC=+0.257 (n=1674)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5222 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.5032` → IC=+0.202 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5032 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.8372` → IC=+0.203 (n=1868)
...
- **PATRÓN** `volumen_regimen` > `1.2323` → IC=+0.239 (n=558)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2201` → IC=+0.196 (n=1313)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2201 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.201 (n=1491)
...
- **PATRÓN** `libro_liquidez` > `2569.9074` → IC=+0.201 (n=1116)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2569.9074 (IC base=+0.201)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2867` → IC=+0.214 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2867 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` < `2.1124` → IC=+0.151 (n=522)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.1124 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.130 (n=571)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.02 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2435.8886` → IC=+0.148 (n=308)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2435.8886 (IC base=+0.100)

- **PATRÓN** `ibs_20min` < `0.0482` → IC=+0.261 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0482 (IC base=-0.016)

- **PATRÓN** `volumen_pendiente_norm` > `0.1363` → IC=+0.212 (n=57)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.173 (n=273)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0059 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.5656` → IC=+0.197 (n=242)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.5656 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.1288` → IC=+0.169 (n=125)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1288 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.0552` → IC=+0.128 (n=213)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0552 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.143 (n=180)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.0677 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.2625` → IC=+0.156 (n=30)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.2625 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.191 (n=179)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.4946` → IC=+0.191 (n=95)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.4946 (IC base=+0.037)

- **PATRÓN** `volumen_regimen` < `0.5714` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.5714 (IC base=+0.037)

- **PATRÓN** `volumen_pendiente_norm` > `0.0668` → IC=+0.232 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0668 (IC base=+0.037)

- **PATRÓN** `volumen_spike_ratio` < `2.4111` → IC=+0.155 (n=85)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4111 (IC base=+0.037)
...
- **FILTRO** `volumen_regimen` < `0.7363` → IC=-0.355 (n=60)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.169 (n=122)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=606)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.5 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `2851.519` → IC=+0.178 (n=206)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2851.519 (IC base=+0.108)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7248)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.177 (n=3067)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9609)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=3213)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9935)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.217 (n=521)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.098 (n=1661)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.202 (n=552)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=1669)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=583)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1755)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.166 (n=572)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1766)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.185 (n=538)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1622)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.193 (n=562)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2761)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2767)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=720)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9132)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=20154)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.276 (n=7063)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=22223)

- **FILTRO** `ibs_7min` < `0.2925` → IC=-0.236 (n=7319)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2925
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21967)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9891)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19395)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9144)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=27553)

- **FILTRO** `ibs_7min` > `0.2943` → IC=-0.179 (n=9173)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2943
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27524)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=1146)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3647)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.253 (n=1579)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3214)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.180 (n=1145)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3648)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.151 (n=4254)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=2080)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.125 (n=2149)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4185)

- **FILTRO** `ibs_7min` > `0.7922` → IC=-0.204 (n=1583)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1204)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3885)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1224)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=3865)

- **FILTRO** `ibs_7min` < `0.7518` → IC=-0.188 (n=1272)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7518
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3817)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.174 (n=1270)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3819)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.259 (n=1269)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3873)

- **FILTRO** `ibs_7min` > `0.2589` → IC=-0.173 (n=1284)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2589
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3858)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.185 (n=1281)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3861)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.169 (n=1299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3233)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.308 (n=1105)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3427)

- **FILTRO** `ibs_7min` < `0.1961` → IC=-0.259 (n=1133)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1961
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3399)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.214 (n=1091)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3441)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1572)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5156)

- **FILTRO** `ibs_7min` > `0.7596` → IC=-0.177 (n=1681)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7596
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5047)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1562)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3254)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.246 (n=1181)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3635)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.182 (n=1204)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3612)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.178 (n=1202)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3614)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.262 (n=1233)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3709)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.173 (n=1235)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3707)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.191 (n=1203)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3739)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.263 (n=1208)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3955)

- **FILTRO** `ibs_7min` < `0.7024` → IC=-0.229 (n=1290)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7024
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3873)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1680)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5278)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=1139)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3754)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.232 (n=1222)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3671)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.211 (n=1173)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3720)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1629)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4964)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2675)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1374)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1382)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.215 (n=634)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0082 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.1627` → IC=+0.191 (n=1230)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1627 (IC base=+0.184)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2175` → IC=+0.189 (n=467)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.2175 (IC base=+0.184)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1305` → IC=+0.225 (n=475)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.185 (n=1410)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 16.0 (IC base=+0.184)

- **PATRÓN** `ibs_15` > `0.6122` → IC=+0.260 (n=1398)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6122 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` > `0.4448` → IC=+0.187 (n=330)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4448 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.093` → IC=+0.270 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.093 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `2972.1985` → IC=+0.191 (n=932)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2972.1985 (IC base=+0.184)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.222 (n=221)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0037 (IC base=+0.202)

- **PATRÓN** `drift_60min` |x|≤ `0.0596` → IC=+0.279 (n=111)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0596 (IC base=+0.202)

- **PATRÓN** `drift_15min` |x|≤ `0.3806` → IC=+0.208 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3806 (IC base=+0.202)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2526` → IC=+0.226 (n=111)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2526 (IC base=+0.202)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1484` → IC=+0.274 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1484 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.225 (n=347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.202)

- **PATRÓN** `ibs_15` > `0.7031` → IC=+0.266 (n=331)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7031 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.3824` → IC=+0.281 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3824 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.633` → IC=+0.270 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.633 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `15869.2533` → IC=+0.234 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15869.2533 (IC base=+0.202)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.155 (n=111)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0034 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.153 (n=220)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.005 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0692` → IC=+0.162 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0692 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1411` → IC=+0.162 (n=220)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.81€ cuando `delta_ratio_macro` |x|> 0.1411 (IC base=+0.140)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.263` → IC=+0.167 (n=229)

  - _Acción_: Kelly boost +0.83€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.263 (IC base=+0.140)
...
- **PATRÓN** `ibs_15` > `0.6192` → IC=+0.220 (n=330)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **FILTRO** `dist_vwap_pct` > `0.7126` → IC=-0.146 (n=97)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=774)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.226 (n=253)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0402` → IC=+0.189 (n=380)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0926` → IC=+0.232 (n=95)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0926 (IC base=+0.179)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.231 (n=128)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.179)

- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.275 (n=380)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` > `0.1219` → IC=+0.194 (n=230)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1219 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` < `0.6263` → IC=+0.182 (n=442)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.6263 (IC base=+0.179)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.409` → IC=+0.179 (n=341)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 7.409 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `2857.925` → IC=+0.260 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2857.925 (IC base=+0.179)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.164 (n=424)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.82€ cuando `ibs_15` < 0.1176 (IC base=+0.045)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.378 (n=170)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.338)

- **PATRÓN** `drift_60min` |x|≤ `0.1105` → IC=+0.346 (n=252)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1105 (IC base=+0.338)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1476` → IC=+0.361 (n=249)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1476 (IC base=+0.338)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.385 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.133 (IC base=+0.338)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.359 (n=345)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.338)

- **PATRÓN** `ibs_15` > `0.785` → IC=+0.383 (n=374)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.785 (IC base=+0.338)

- **PATRÓN** `dist_vwap_pct` > `0.424` → IC=+0.386 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.424 (IC base=+0.338)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.888` → IC=+0.349 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.888 (IC base=+0.338)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.344 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.338)

- **PATRÓN** `libro_liquidez` > `3505.1277` → IC=+0.354 (n=374)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3505.1277 (IC base=+0.338)

- **PATRÓN** `ballena_activa_n` < `475.0` → IC=+0.361 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 475.0 (IC base=+0.338)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.340 (n=186)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1519` → IC=+0.346 (n=186)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1519 (IC base=+0.341)

- **PATRÓN** `drift_15min` |x|≤ `0.4202` → IC=+0.342 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4202 (IC base=+0.341)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2087` → IC=+0.369 (n=97)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2087 (IC base=+0.341)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1224` → IC=+0.401 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1224 (IC base=+0.341)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.368 (n=195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.341)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.339 (n=222)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.341)

- **PATRÓN** `ibs_15` > `0.8048` → IC=+0.378 (n=211)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8048 (IC base=+0.341)

- **PATRÓN** `dist_vwap_pct` > `0.3894` → IC=+0.419 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3894 (IC base=+0.341)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.997` → IC=+0.351 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 20.997 (IC base=+0.341)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.303` → IC=+0.343 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.303 (IC base=+0.341)

- **PATRÓN** `ballena_activa_n` < `585.0` → IC=+0.397 (n=163)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.213 (n=600)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1801)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.189 (n=776)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1625)

- **FILTRO** `libro_liquidez` < `3911.5181` → IC=-0.134 (n=1584)

  - _Acción_: SKIP cuando `libro_liquidez` < 3911.5181
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=817)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.138` → IC=+0.262 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.138 (IC base=-0.060)

- **PATRÓN** `ibs_15` > `0.6324` → IC=+0.267 (n=591)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6324 (IC base=-0.060)

- **PATRÓN** `dist_vwap_pct` < `0.1109` → IC=+0.183 (n=364)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1109 (IC base=-0.060)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1786` → IC=+0.240 (n=938)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1786 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.281 (n=1460)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.221 (n=363)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1093)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.226 (n=480)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.185 (n=976)

- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.245 (n=257)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.716
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1199)

- **FILTRO** `libro_liquidez` < `16115.0866` → IC=-0.204 (n=960)

  - _Acción_: SKIP cuando `libro_liquidez` < 16115.0866
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=496)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.186 (n=135)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0027 (IC base=+0.082)
...
- **PATRÓN** `ibs_15` > `0.8109` → IC=+0.349 (n=137)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8109 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` > `0.1316` → IC=+0.298 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1316 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` < `0.5257` → IC=+0.278 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5257 (IC base=+0.082)

### UPDOWN_GBM_15M_TARDIO#ETH#15min
- **FILTRO** `ibs_15` < `0.6642` → IC=-0.208 (n=94)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6642
  - _Potencial_: sin este filtro IC_bueno=+0.258 (n=283)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.155 (n=360)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.175 (n=189)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0051 (IC base=+0.141)
...
- **PATRÓN** `drift_15min` |x|≤ `0.4223` → IC=+0.160 (n=95)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `drift_15min` |x|≤ 0.4223 (IC base=+0.141)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1329` → IC=+0.154 (n=189)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.77€ cuando `delta_ratio_macro` |x|> 0.1329 (IC base=+0.141)
...
- **PATRÓN** `ibs_15` > `0.6642` → IC=+0.258 (n=283)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6642 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1175` → IC=+0.181 (n=202)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1175 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.579` → IC=+0.156 (n=225)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 6.579 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=360)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `10966.626` → IC=+0.179 (n=129)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 10966.626 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.240 (n=594)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.778` → IC=+0.233 (n=523)
...
- **PATRÓN** `ibs_15` < `0.3561` → IC=+0.265 (n=594)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.254` → IC=+0.229 (n=636)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.254 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3531.6592` → IC=+0.228 (n=594)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.012` → IC=-0.134 (n=301)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.012
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2426)
...
- **PATRÓN** `dist_vwap_pct` < `0.1863` → IC=+0.216 (n=241)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1863 (IC base=-0.043)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2322` → IC=+0.147 (n=49)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.2322 (IC base=+0.076)

- **PATRÓN** `drift_15min` |x|≤ `0.5868` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `drift_15min` |x|≤ 0.5868 (IC base=+0.076)

- **PATRÓN** `dist_vwap_pct` > `0.1526` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1526 (IC base=+0.076)

- **PATRÓN** `libro_liquidez` > `13351.9222` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 13351.9222 (IC base=+0.076)
...
- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.296 (n=277)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0054 (IC base=+0.291)

- **PATRÓN** `drift_60min` |x|≤ `0.058` → IC=+0.320 (n=204)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.058 (IC base=+0.291)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1449` → IC=+0.299 (n=406)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1449 (IC base=+0.291)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.218` → IC=+0.327 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.218 (IC base=+0.291)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.311 (n=637)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.291)

- **PATRÓN** `ibs_15` > `0.8411` → IC=+0.328 (n=609)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2925` → IC=+0.343 (n=202)
...
- **PATRÓN** `ibs_15` > `0.8516` → IC=+0.343 (n=271)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.167` → IC=+0.300 (n=193)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6122 sube el IC de +0.184 a +0.260 en UPDOWN_GBM#15min (n=1398). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7031 sube el IC de +0.202 a +0.266 en UPDOWN_GBM#BTC#15min (n=331). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6192 sube el IC de +0.140 a +0.220 en UPDOWN_GBM#ETH#15min (n=330). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.179 a +0.275 en UPDOWN_GBM#XRP#15min (n=380). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.045 a +0.164 en UPDOWN_GBM#XRP#15min (n=424). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6324 sube el IC de -0.060 a +0.267 en UPDOWN_GBM_15M_TARDIO (n=591). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0.039 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1460). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8109 sube el IC de +0.082 a +0.349 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=137). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6642 sube el IC de +0.141 a +0.258 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=283). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3561 sube el IC de +0.225 a +0.265 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=594). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3636 sube el IC de -0.043 a +0.260 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=273). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8411 sube el IC de +0.291 a +0.328 en UPDOWN_GBM_IBS_ALTO (n=609). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8516 sube el IC de +0.299 a +0.343 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=271). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.785 sube el IC de +0.338 a +0.383 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=374). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8048 sube el IC de +0.341 a +0.378 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=211). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 23267 | -0.092 | -3098.34€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1394 | -0.047 | -210.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21873 | -0.096 | -2887.94€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3542 | -0.088 | -578.95€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3542 | -0.088 | -578.95€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1394 | -0.047 | -210.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1394 | -0.047 | -210.40€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6664 | -0.032 | -605.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6664 | -0.032 | -605.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6137 | -0.095 | -438.78€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6137 | -0.095 | -438.78€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5156 | -0.180 | -1103.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5156 | -0.180 | -1103.40€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15672 | -0.032 | +4139.09€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4123 | -0.001 | +1830.47€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11549 | -0.043 | +2308.62€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15672 | -0.032 | +4139.09€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 