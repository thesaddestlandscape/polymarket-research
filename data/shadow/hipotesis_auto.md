# Hipótesis automáticas — 2026-09-04 01:13 UTC
_Generado por shadow_postmortem.py sobre 273922 resoluciones (PNL=+26618.43€)_

## Patrones causales activos

### BALLENAS_CONFIRMADAS_15M
- **FILTRO** `py_entrada` < `0.705` → IC=-0.159 (n=121)
...
- **PATRÓN** `py_entrada` > `0.705` → IC=+0.269 (n=322)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.705 (IC base=+0.152)

- **PATRÓN** `n_ballena_banda` > `19.0` → IC=+0.165 (n=305)

  - _Acción_: Kelly boost +0.82€ cuando `n_ballena_banda` > 19.0 (IC base=+0.152)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.157 (n=240)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 12.0 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.177 (n=345)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `3094.8617` → IC=+0.199 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3094.8617 (IC base=+0.152)
...
- **PATRÓN** `n_ballena_banda` > `18.0` → IC=+0.194 (n=243)

  - _Acción_: Kelly boost +0.97€ cuando `n_ballena_banda` > 18.0 (IC base=+0.182)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8026` → IC=+0.269 (n=240)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8026 (IC base=+0.182)

- **PATRÓN** `banda_z` > `12.634` → IC=+0.281 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 12.634 (IC base=+0.182)

- **PATRÓN** `ballenas_wallet_edge_medio` > `3.102` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `ballenas_wallet_edge_medio` > 3.102 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.192 (n=222)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 7.0 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.188 (n=168)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 12.0 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.182)

- **PATRÓN** `libro_liquidez` > `2928.5072` → IC=+0.198 (n=160)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2928.5072 (IC base=+0.182)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.62` → IC=-0.298 (n=3692)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.62
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=11079)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.63` → IC=-0.290 (n=479)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.63
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=1438)
...
- **FILTRO** `restante_s_al_confirmar` < `113.85` → IC=-0.405 (n=490)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 113.85
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1477)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `142.53` → IC=-0.315 (n=820)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 142.53
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=2460)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.92` → IC=-0.378 (n=891)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.92
  - _Potencial_: sin este filtro IC_bueno=-0.103 (n=1810)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.188 (n=8009)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.094)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=2021)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2371.8003` → IC=+0.171 (n=1938)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2371.8003 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.146 (n=4825)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 18.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.153 (n=6407)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 7.0 (IC base=+0.141)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.253 (n=4889)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.184 (n=3841)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1462.2112` → IC=+0.174 (n=3677)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1462.2112 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.199 (n=909)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.190 (n=1168)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `12454.422` → IC=+0.202 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12454.422 (IC base=+0.188)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.139 (n=1372)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.264 (n=696)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1939.4936` → IC=+0.267 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1939.4936 (IC base=+0.259)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.195 (n=5186)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 15.0 (IC base=+0.189)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.202 (n=2939)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=1583)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.176 (n=1310)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.179 (n=1062)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.237 (n=1181)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.186 (n=1282)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.206 (n=17420)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.147 (n=2411)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 12.0 (IC base=+0.146)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.175 (n=2562)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.227 (n=1108)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.225)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.258 (n=2213)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.179 (n=3004)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.227 (n=1128)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.237 (n=1503)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.185 (n=2261)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `restante_min` < `3.95` → IC=+0.151 (n=1149)

  - _Acción_: Kelly boost +0.75€ cuando `restante_min` < 3.95 (IC base=+0.138)

- **PATRÓN** `restante_min` > `4.88` → IC=+0.151 (n=1584)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` > 4.88 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.162 (n=1664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 8.0 (IC base=+0.138)

- **PATRÓN** `lag_apertura_s` < `7.0` → IC=+0.151 (n=1513)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 7.0 (IC base=+0.138)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.160 (n=1299)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.138 (n=1702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 8.0 (IC base=+0.128)

- **PATRÓN** `lag_apertura_s` < `3.33` → IC=+0.168 (n=1162)

  - _Acción_: Kelly boost +0.84€ cuando `lag_apertura_s` < 3.33 (IC base=+0.128)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.279 (n=428)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1042.1643` → IC=+0.279 (n=374)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3577` → IC=+0.128 (n=3666)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` > 0.3577 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` > `0.2741` → IC=+0.224 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2741 (IC base=+0.081)
...
- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.243 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.081)

- **PATRÓN** `volumen_pendiente_norm` > `0.1732` → IC=+0.175 (n=626)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1732 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` < `2.88` → IC=+0.174 (n=2192)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.88 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` > `1.4763` → IC=+0.170 (n=2192)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.4763 (IC base=+0.081)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.197 (n=1095)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 54.0 (IC base=+0.081)

- **PATRÓN** `ibs_20min` < `0.4038` → IC=+0.128 (n=3528)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4038 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` < `0.3417` → IC=+0.146 (n=1277)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3417 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` < `0.6876` → IC=+0.150 (n=547)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6876 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` > `1.047` → IC=+0.140 (n=564)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.047 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.3041` → IC=+0.254 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3041 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` > `2.8566` → IC=+0.213 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8566 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.213 (n=1416)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2794` → IC=+0.157 (n=817)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.2794 (IC base=+0.153)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6742` → IC=+0.137 (n=719)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.6742 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.4443` → IC=+0.145 (n=719)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4443 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=651)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.186 (n=466)
...
- **PATRÓN** `ibs_20min` < `0.7619` → IC=+0.212 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.7619 (IC base=+0.212)

- **PATRÓN** `ibs_20min` > `0.929` → IC=+0.237 (n=291)
...
- **PATRÓN** `dist_vwap_pct` < `0.487` → IC=+0.217 (n=577)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.487 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.225` → IC=+0.224 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.225 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.05` → IC=+0.215 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.05 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` < `1.2608` → IC=+0.216 (n=642)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0999` → IC=+0.217 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0999 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` < `2.109` → IC=+0.227 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.109 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `11847.0948` → IC=+0.243 (n=573)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.141 (n=734)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 18.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.6604` → IC=+0.162 (n=703)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.6604 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.3411` → IC=+0.159 (n=676)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.3411 (IC base=+0.140)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0663` → IC=+0.206 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0663 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.3943` → IC=+0.152 (n=595)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.3943 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4046` → IC=+0.155 (n=595)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4046 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12550.5978` → IC=+0.153 (n=468)
...
- **PATRÓN** `sigma_h` > `0.0096` → IC=+0.208 (n=258)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0096 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.200 (n=285)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1322` → IC=+0.160 (n=659)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.1322 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.3904` → IC=+0.153 (n=96)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.3904 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `3.8997` → IC=+0.154 (n=685)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 3.8997 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.8939` → IC=+0.175 (n=613)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.8939 (IC base=+0.160)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.184 (n=792)
...
- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.252 (n=624)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0102 (IC base=+0.241)

- **PATRÓN** `drift_60min` |x|≤ `0.3782` → IC=+0.246 (n=549)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3782 (IC base=+0.241)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.245 (n=312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.241)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.265 (n=283)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.241)

- **PATRÓN** `ibs_20min` < `0.0351` → IC=+0.309 (n=208)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4461` → IC=+0.223 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4461 (IC base=+0.241)
...
- **FILTRO** `ibs_20min` > `0.8252` → IC=-0.186 (n=288)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=865)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=72)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1081)
...
- **PATRÓN** `dist_vwap_pct` > `0.2938` → IC=+0.189 (n=59)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.2938 (IC base=-0.039)

- **PATRÓN** `volumen_pendiente_norm` > `0.2799` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2799 (IC base=-0.039)

- **PATRÓN** `volumen_spike_ratio` > `1.5827` → IC=+0.141 (n=179)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.5827 (IC base=-0.039)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.312` → IC=-0.193 (n=203)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1561)
...
- **FILTRO** `drift_60min` |x|> `0.5305` → IC=-0.156 (n=347)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=113)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=910)

- **FILTRO** `ibs_20min` > `0.7921` → IC=-0.187 (n=410)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.908` → IC=-0.137 (n=191)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1453)

- **PATRÓN** `dist_vwap_pct` > `0.5839` → IC=+0.342 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5839 (IC base=-0.102)

- **PATRÓN** `dist_vwap_pct` < `0.2288` → IC=+0.200 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2288 (IC base=-0.102)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.233 (n=73)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4824` → IC=+0.233 (n=28)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4824 (IC base=-0.102)

- **PATRÓN** `volumen_spike_ratio` > `2.3039` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.3039 (IC base=-0.102)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.172 (n=1511)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0094 (IC base=+0.071)

- **PATRÓN** `ibs_20min` > `0.2903` → IC=+0.139 (n=4531)
...
- **PATRÓN** `volumen_regimen` > `0.6814` → IC=+0.217 (n=1314)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6814 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` < `0.0869` → IC=+0.213 (n=2050)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0869 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` > `0.2534` → IC=+0.232 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2534 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` < `1.4917` → IC=+0.231 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4917 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.8344` → IC=+0.225 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8344 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.295 (n=1659)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 95.0 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.131 (n=4396)
...
- **FILTRO** `ibs_20min` < `0.2957` → IC=-0.148 (n=376)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=765)

- **FILTRO** `sigma_ewma_delta_pct` > `2.431` → IC=-0.161 (n=325)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9482` → IC=+0.224 (n=132)
...
- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.319 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 77.0 (IC base=+0.021)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8618` → IC=-0.163 (n=381)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8618
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=1147)
...
- **PATRÓN** `dist_vwap_pct` < `0.1132` → IC=+0.167 (n=163)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1132 (IC base=-0.028)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0647` → IC=+0.146 (n=128)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.0647 (IC base=-0.028)

- **PATRÓN** `volumen_pendiente_norm` > `0.0817` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0817 (IC base=-0.028)

- **PATRÓN** `volumen_spike_ratio` < `1.763` → IC=+0.230 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.763 (IC base=-0.028)
...
- **PATRÓN** `ballena_activa_n` < `262.0` → IC=+0.189 (n=43)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 262.0 (IC base=-0.028)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.281 (n=331)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.219)

- **PATRÓN** `drift_60min` |x|≤ `0.1246` → IC=+0.221 (n=321)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1246 (IC base=+0.219)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.319` → IC=+0.290 (n=179)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.319 (IC base=+0.219)

- **PATRÓN** `volumen_pendiente_norm` < `0.1403` → IC=+0.234 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1403 (IC base=+0.219)

- **PATRÓN** `volumen_spike_ratio` > `1.7205` → IC=+0.225 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7205 (IC base=+0.219)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.247 (n=746)
...
- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.208 (n=1278)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0106 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3424` → IC=+0.168 (n=3369)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.7958` → IC=+0.236 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7958 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.704` → IC=+0.233 (n=1554)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.704 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `0.6285` → IC=+0.165 (n=2589)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6285 (IC base=+0.162)
...
- **PATRÓN** `volumen_spike_ratio` < `2.324` → IC=+0.162 (n=3134)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.324 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.165 (n=3910)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.03 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `3937.758` → IC=+0.177 (n=1276)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3937.758 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.178 (n=2744)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0792` → IC=+0.215 (n=1186)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0792 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.197 (n=1748)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.185 (n=1615)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 7.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.4375` → IC=+0.231 (n=3556)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4375 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2295` → IC=+0.175 (n=2684)
...
- **PATRÓN** `volumen_regimen` < `1.1753` → IC=+0.169 (n=2690)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.1753 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `0.6237` → IC=+0.162 (n=2690)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6237 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2951` → IC=+0.257 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2951 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` < `1.5762` → IC=+0.174 (n=1289)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.5762 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.6561` → IC=+0.201 (n=977)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6561 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.181 (n=2516)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.265 (n=359)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.240)

- **PATRÓN** `drift_60min` |x|≤ `0.158` → IC=+0.307 (n=267)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.158 (IC base=+0.240)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.265 (n=420)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.240)

- **PATRÓN** `ibs_20min` < `0.2708` → IC=+0.268 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2708 (IC base=+0.240)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2422` → IC=+0.300 (n=73)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9297` → IC=+0.237 (n=222)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9297 (IC base=+0.240)
...
- **PATRÓN** `libro_liquidez` > `1698.2448` → IC=+0.281 (n=267)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.183 (n=655)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0061 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.2979` → IC=+0.174 (n=655)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4833` → IC=+0.193 (n=655)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.4833 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` < `0.1993` → IC=+0.174 (n=655)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1584` → IC=+0.222 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1584 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.167 (n=547)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.3983` → IC=+0.161 (n=547)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.3983 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `15532.7795` → IC=+0.161 (n=219)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 15532.7795 (IC base=+0.155)
...
- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.259 (n=466)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.2232` → IC=+0.260 (n=311)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2232 (IC base=+0.238)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.257 (n=323)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.238)

- **PATRÓN** `ibs_20min` < `0.3684` → IC=+0.274 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3684 (IC base=+0.238)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3666` → IC=+0.292 (n=75)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3666 (IC base=+0.238)
...
- **PATRÓN** `volumen_spike_ratio` > `3.101` → IC=+0.228 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.101 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1855.026` → IC=+0.240 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1855.026 (IC base=+0.238)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0935` → IC=+0.179 (n=191)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.0935 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.174 (n=584)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 6.0 (IC base=+0.159)

- **PATRÓN** `ibs_20min` > `0.4481` → IC=+0.203 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4481 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` > `0.1538` → IC=+0.192 (n=400)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1538 (IC base=+0.159)
...
- **PATRÓN** `libro_liquidez` > `12637.7534` → IC=+0.208 (n=190)
...
- **PATRÓN** `drift_60min` |x|≤ `0.381` → IC=+0.154 (n=640)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_regimen` < `1.1618` → IC=+0.139 (n=640)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.1618 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` > `0.6135` → IC=+0.140 (n=640)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6135 (IC base=+0.133)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8596` → IC=+0.150 (n=355)
...
- **PATRÓN** `ibs_20min` > `0.5405` → IC=+0.194 (n=717)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.5405 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.1627` → IC=+0.252 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1627 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.352` → IC=+0.269 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.352 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` > `0.7086` → IC=+0.130 (n=641)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.7086 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` < `0.1682` → IC=+0.133 (n=715)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.120 (n=722)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.02 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3187.8673` → IC=+0.218 (n=239)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.154 (n=299)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0094 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.5231` → IC=+0.139 (n=654)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.5231 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=308)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.4642` → IC=+0.229 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4642 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.2524` → IC=+0.150 (n=615)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.2524 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.218` → IC=+0.174 (n=256)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.218 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.1985` → IC=+0.151 (n=654)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1985 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.8584` → IC=+0.153 (n=436)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.8584 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2712` → IC=+0.226 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2712 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.1018` → IC=+0.202 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1018 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `3176.6468` → IC=+0.177 (n=218)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 3176.6468 (IC base=+0.135)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1796` → IC=+0.174 (n=222)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1796 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.2754` → IC=+0.149 (n=657)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.2754 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.8612` → IC=+0.145 (n=497)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8612 (IC base=+0.138)
...
- **PATRÓN** `ibs_20min` < `0.3103` → IC=+0.134 (n=545)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.3103 (IC base=+0.069)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.200 (n=2077)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.185 (n=255)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0053 (IC base=+0.185)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.236 (n=343)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.217 (n=281)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.071` → IC=+0.297 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.071 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.2233` → IC=+0.261 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2233 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` < `1.4729` → IC=+0.181 (n=224)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.4729 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `1.8922` → IC=+0.175 (n=447)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.8922 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.233 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `76.0` → IC=+0.233 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 76.0 (IC base=+0.185)
...
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.173 (n=252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.003 (IC base=+0.161)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0968` → IC=+0.168 (n=251)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0968 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.184 (n=672)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 8.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.3282` → IC=+0.206 (n=750)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.756` → IC=+0.181 (n=183)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 9.756 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.439` → IC=+0.174 (n=654)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` < 4.439 (IC base=+0.161)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0723` → IC=+0.175 (n=629)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1469` → IC=+0.188 (n=206)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1469 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `2.413` → IC=+0.178 (n=701)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.413 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.7246` → IC=+0.182 (n=467)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.7246 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `10640.5814` → IC=+0.188 (n=670)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 10640.5814 (IC base=+0.161)

- **PATRÓN** `ballena_activa_n` < `510.0` → IC=+0.172 (n=626)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 510.0 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.172 (n=689)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0062 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3506` → IC=+0.175 (n=688)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3506 (IC base=+0.163)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.168 (n=712)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 18.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` < `0.6154` → IC=+0.200 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6154 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` < `0.1464` → IC=+0.180 (n=589)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.141` → IC=+0.232 (n=181)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0753` → IC=+0.179 (n=269)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.0753 (IC base=+0.163)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.240 (n=310)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` > `0.6825` → IC=+0.254 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6825 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.62` → IC=+0.335 (n=156)
...
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.253 (n=301)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0088 (IC base=+0.244)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.271 (n=304)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.244)

- **PATRÓN** `ibs_20min` < `0.4031` → IC=+0.297 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4031 (IC base=+0.244)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.441` → IC=+0.298 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.441 (IC base=+0.244)
...
- **PATRÓN** `ibs_20min` > `0.7425` → IC=+0.239 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7425 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.3814` → IC=+0.190 (n=308)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.3814 (IC base=+0.145)
...
- **PATRÓN** `libro_liquidez` > `9491.6866` → IC=+0.242 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9491.6866 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.159 (n=531)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0072 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4492` → IC=+0.158 (n=604)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4492 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.177 (n=301)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 8.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.6744` → IC=+0.181 (n=604)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6744 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.4098` → IC=+0.140 (n=601)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4098 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.341` → IC=+0.226 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.341 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.296` → IC=+0.138 (n=570)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 4.296 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8251` → IC=+0.137 (n=403)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.8251 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1408` → IC=+0.170 (n=201)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.1408 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5341` → IC=+0.161 (n=181)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.5341 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `11624.4939` → IC=+0.209 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11624.4939 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `192.0` → IC=+0.154 (n=463)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 192.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.147 (n=528)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.48` → IC=+0.180 (n=792)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=549)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.143 (n=500)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 54.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.173 (n=255)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0059 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1316` → IC=+0.173 (n=255)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.1316 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.143 (n=376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 15.0 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.140 (n=287)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 6.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` < `0.6` → IC=+0.200 (n=769)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.5192` → IC=+0.136 (n=732)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.5192 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.195` → IC=+0.137 (n=756)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 3.195 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `1.0655` → IC=+0.130 (n=673)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0655 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.160 (n=254)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.4553` → IC=+0.142 (n=205)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4553 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `2.1867` → IC=+0.144 (n=279)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 2.1867 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2648.2907` → IC=+0.168 (n=347)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2648.2907 (IC base=+0.117)
...
- **PATRÓN** `dist_vwap_pct` > `0.167` → IC=+0.251 (n=531)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.167 (IC base=+0.198)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.244 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.169 (IC base=+0.198)

- **PATRÓN** `volumen_regimen` > `1.2346` → IC=+0.228 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2346 (IC base=+0.198)

- **PATRÓN** `volumen_pendiente_norm` > `0.1014` → IC=+0.234 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1014 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `1.4407` → IC=+0.202 (n=823)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4407 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=1002)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.129 (n=1721)

- **PATRÓN** `sigma_h` < `0.01` → IC=+0.134 (n=1315)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.01 (IC base=+0.119)

- **PATRÓN** `drift_60min` |x|≤ `0.5508` → IC=+0.130 (n=1495)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.9213` → IC=+0.190 (n=498)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.9213 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.766` → IC=+0.123 (n=1360)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 3.766 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.1742` → IC=+0.150 (n=407)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.1742 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `1.4626` → IC=+0.148 (n=493)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4626 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `1.8992` → IC=+0.139 (n=986)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.8992 (IC base=+0.119)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3998` → IC=+0.152 (n=1146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.144 (n=501)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 5.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` < `0.2` → IC=+0.152 (n=573)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.2 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` > `0.4817` → IC=+0.132 (n=359)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.4817 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.347` → IC=+0.137 (n=1301)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 6.347 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` < `1.2326` → IC=+0.135 (n=1271)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.2326 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` > `0.0691` → IC=+0.145 (n=621)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0691 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` < `2.4775` → IC=+0.134 (n=1289)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.4775 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` > `1.794` → IC=+0.131 (n=859)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.794 (IC base=+0.125)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=1721)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `8431.5409` → IC=+0.135 (n=1164)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8431.5409 (IC base=+0.125)
...
- **PATRÓN** `ibs_20min` < `0.1703` → IC=+0.161 (n=272)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1703 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.363` → IC=+0.139 (n=615)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 6.363 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.8701` → IC=+0.147 (n=412)
...
- **PATRÓN** `libro_liquidez` > `11116.1452` → IC=+0.124 (n=618)
...
- **PATRÓN** `sigma_h` < `0.009` → IC=+0.150 (n=550)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.009 (IC base=+0.134)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.136 (n=550)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0046 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.4809` → IC=+0.147 (n=550)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4809 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.194 (n=194)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 18.0 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.140 (n=245)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 6.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.186` → IC=+0.147 (n=551)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.186 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `1.0768` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 1.0768 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.4417` → IC=+0.144 (n=520)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.4417 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.914` → IC=+0.148 (n=552)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.914 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.2728` → IC=+0.145 (n=550)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2728 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` < `0.1172` → IC=+0.137 (n=507)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4475` → IC=+0.172 (n=181)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.4475 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.825` → IC=+0.139 (n=361)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.825 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `8958.19` → IC=+0.144 (n=492)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 8958.19 (IC base=+0.134)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.171 (n=363)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0078 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.4222` → IC=+0.209 (n=362)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4222 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.148 (n=211)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.157 (n=275)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` < `0.42` → IC=+0.156 (n=417)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.42 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.921` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 10.921 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.2231` → IC=+0.168 (n=411)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2231 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `0.7334` → IC=+0.148 (n=367)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.7334 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` < `0.1502` → IC=+0.153 (n=419)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.1502 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.161 (n=181)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.147)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4499` → IC=+0.166 (n=402)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4499 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `8176.6816` → IC=+0.163 (n=411)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 8176.6816 (IC base=+0.147)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=1048)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.178 (n=1447)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=4354)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.183 (n=1482)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=4558)
...
- **FILTRO** `ballena_activa_n` > `60.0` → IC=-0.149 (n=240)

  - _Acción_: SKIP cuando `ballena_activa_n` > 60.0
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=722)
...
- **FILTRO** `ibs_20min` > `0.7162` → IC=-0.195 (n=254)
...
- **FILTRO** `py_entrada` > `0.56` → IC=-0.168 (n=233)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=743)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=464)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=470)
...
- **FILTRO** `ibs_20min` > `0.9056` → IC=-0.141 (n=51)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=3018)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=11157)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.282 (n=3488)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=10687)

- **FILTRO** `ibs_7min` < `0.7117` → IC=-0.247 (n=3543)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7117
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=10632)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.171 (n=4739)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=9436)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.220 (n=4394)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=13472)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.172 (n=4449)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=13417)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.153 (n=607)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.31` → IC=-0.316 (n=510)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1555)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.260 (n=680)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1385)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.226 (n=513)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=1552)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.140 (n=2070)

  - _Acción_: SKIP cuando `py_entrada` > 0.52
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1038)

- **FILTRO** `drift_7min_pct` |x|> `0.1142` → IC=-0.127 (n=1056)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1142
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2052)

- **FILTRO** `ibs_7min` > `0.8358` → IC=-0.189 (n=776)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8358
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2332)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=577)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=643)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2004)

- **FILTRO** `ibs_7min` < `0.7711` → IC=-0.195 (n=661)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7711
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=1986)

- **FILTRO** `ballena_activa_n` > `168.0` → IC=-0.180 (n=657)

  - _Acción_: SKIP cuando `ballena_activa_n` > 168.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1990)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.246 (n=617)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2042)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.174 (n=896)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1763)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.185 (n=661)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=1436)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.310 (n=668)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1429)

- **FILTRO** `ibs_7min` < `0.2125` → IC=-0.291 (n=524)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2125
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=1573)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.252 (n=493)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=1604)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=744)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2460)

- **FILTRO** `ibs_7min` > `0.7964` → IC=-0.171 (n=800)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7964
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2404)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.139 (n=723)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=587)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=1818)

- **FILTRO** `ibs_7min` < `0.7519` → IC=-0.195 (n=601)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7519
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=1804)

- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.177 (n=806)

  - _Acción_: SKIP cuando `ballena_activa_n` > 26.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1599)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.238 (n=785)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1631)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.179 (n=603)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=1813)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.182 (n=592)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=1824)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.250 (n=641)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2003)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.214 (n=660)
...
- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.193 (n=627)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2017)
...
- **FILTRO** `hora_utc` < `9.0` → IC=-0.126 (n=743)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=1574)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.297 (n=566)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1751)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.249 (n=576)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1741)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.233 (n=560)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.252 (n=616)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2506)

- **FILTRO** `ibs_7min` > `0.7767` → IC=-0.162 (n=780)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7767
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2342)
...
- **PATRÓN** `delta_ratio` |x|> `0.398` → IC=+0.144 (n=509)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.72€ cuando `delta_ratio` |x|> 0.398 (IC base=+0.131)
...
- **PATRÓN** `total_vol_5m` < `451.687` → IC=+0.177 (n=162)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `total_vol_5m` < 451.687 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=227)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `3282.1951` → IC=+0.155 (n=198)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.121 (n=64)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2005.686` → IC=+0.125 (n=78)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2005.686 (IC base=+0.093)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=538)
...
- **PATRÓN** `sigma_h` > `0.0053` → IC=+0.145 (n=350)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0053 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.168` → IC=+0.125 (n=462)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.168 (IC base=+0.123)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0597` → IC=+0.128 (n=525)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.64€ cuando `delta_ratio_macro` |x|> 0.0597 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.128 (n=563)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 4.0 (IC base=+0.123)

- **PATRÓN** `hora_utc` < `19.0` → IC=+0.136 (n=564)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 19.0 (IC base=+0.123)

- **PATRÓN** `ibs_15` > `0.5787` → IC=+0.213 (n=525)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5787 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `0.4311` → IC=+0.154 (n=134)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.4311 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.5518` → IC=+0.120 (n=543)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` < 0.5518 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.661` → IC=+0.208 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.661 (IC base=+0.123)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=541)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `3051.8123` → IC=+0.148 (n=350)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3051.8123 (IC base=+0.123)

### UPDOWN_GBM#5min
- **FILTRO** `sigma_ewma_delta_pct` > `6.43` → IC=-0.205 (n=59)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.43
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=808)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0636` → IC=+0.139 (n=59)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.70€ cuando `delta_ratio_macro` |x|> 0.0636 (IC base=+0.100)

- **PATRÓN** `ibs_15` > `0.5217` → IC=+0.264 (n=53)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5217 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.225` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.225 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `3008.8466` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3008.8466 (IC base=+0.100)
...
- **PATRÓN** `ibs_15` < `0.125` → IC=+0.173 (n=163)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1242` → IC=+0.238 (n=296)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1242 (IC base=-0.064)
...
- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.270 (n=445)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3696 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` < `0.4772` → IC=+0.219 (n=467)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.273 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.210)

- **PATRÓN** `ibs_15` < `0.2941` → IC=+0.294 (n=197)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2941 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.1907` → IC=+0.223 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1907 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` < `0.4132` → IC=+0.210 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4132 (IC base=+0.210)
...
- **PATRÓN** `ballena_activa_n` < `182.0` → IC=+0.209 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 182.0 (IC base=+0.210)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5787 sube el IC de +0.123 a +0.213 en UPDOWN_GBM#15min (n=525). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#SOL#15min**: dentro de BUY_YES, IBS > 0.5217 sube el IC de +0.100 a +0.264 en UPDOWN_GBM#SOL#15min (n=53). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.125 sube el IC de +0.034 a +0.173 en UPDOWN_GBM#XRP#15min (n=163). Ya aplicado como kelly_boost=+0.86€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3696 sube el IC de -0.064 a +0.270 en UPDOWN_GBM_15M_TARDIO (n=445). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2941 sube el IC de +0.210 a +0.294 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=197). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 806 | +0.087 | +44.26€ | 2 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 806 | +0.087 | +44.26€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 23 | +0.060 | +0.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 23 | +0.060 | +0.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 528 | +0.106 | +36.72€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 528 | +0.106 | +36.72€ | 2 | 11 |
...
| ✅ BALLENAS_TARDIAS | 14771 | -0.112 | -2508.77€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 956 | -0.010 | -142.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 13815 | -0.119 | -2366.15€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1917 | -0.090 | -421.83€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1917 | -0.090 | -421.83€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 956 | -0.010 | -142.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 956 | -0.010 | -142.62€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1967 | -0.168 | -537.24€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1967 | -0.168 | -537.24€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 3950 | -0.049 | -365.76€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 3950 | -0.049 | -365.76€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3280 | -0.128 | -289.45€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3280 | -0.128 | -289.45€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2701 | -0.194 | -751.88€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 