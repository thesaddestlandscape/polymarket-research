# Hipótesis automáticas — 2026-07-12 08:17 UTC
...
- **PATRÓN** `py_entrada` < `0.275` → IC=+0.317 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=352)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `5897.7268` → IC=+0.160 (n=142)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 5897.7268 (IC base=+0.145)
...
- **PATRÓN** `libro_liquidez` > `6497.9556` → IC=+0.242 (n=64)
...
- **PATRÓN** `py_entrada` < `0.245` → IC=+0.269 (n=24)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.144)
...
- **PATRÓN** `py_entrada` < `0.315` → IC=+0.261 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.315 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `1618.5911` → IC=+0.221 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1618.5911 (IC base=+0.197)

### GBM_LATE_15M
- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.137 (n=428)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0152 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.124 (n=1297)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.123 (n=1293)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.148 (n=906)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0092 (IC base=+0.109)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.140 (n=914)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` < `0.4251` → IC=+0.177 (n=94)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.4251 (IC base=+0.109)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `dist_vwap_pct` < `0.0796` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.0796 (IC base=+0.086)

### GBM_LATE_15M#ETH#15min
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.154 (n=108)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0045 (IC base=+0.095)
...
- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.187 (n=113)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0149 (IC base=+0.153)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.214 (n=229)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` < `0.0174` → IC=+0.177 (n=224)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0174 (IC base=+0.177)

- **PATRÓN** `sigma_h` > `0.0121` → IC=+0.186 (n=336)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0121 (IC base=+0.177)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.237 (n=112)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.177)

- **PATRÓN** `dist_vwap_pct` < `0.1756` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1756 (IC base=+0.177)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.205 (n=110)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0117 (IC base=+0.169)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.212 (n=158)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.4922` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.4922 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.1221` → IC=+0.214 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1221 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.169 (n=336)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0046 (IC base=+0.148)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.187 (n=148)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 6.0 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.2537` → IC=+0.265 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2537 (IC base=+0.148)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.221 (n=84)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0029 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.197 (n=87)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 7.0 (IC base=+0.169)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.177 (n=94)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 18.0 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.1253` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1253 (IC base=+0.169)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.186 (n=33)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0034 (IC base=+0.157)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.196 (n=44)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0067 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.162 (n=69)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 12.0 (IC base=+0.157)
...
- **PATRÓN** `sigma_h` < `0.0082` → IC=+0.289 (n=36)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0082 (IC base=+0.094)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=41)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.094)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.127 (n=183)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.0119 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.156 (n=59)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.081)

- **PATRÓN** `sigma_h` > `0.0128` → IC=+0.139 (n=131)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0128 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` < `0.2446` → IC=+0.175 (n=78)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2446 (IC base=+0.082)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` < `0.1146` → IC=+0.132 (n=17)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.1146 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.184 (n=36)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0035 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.6294` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.6294 (IC base=+0.025)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.194 (n=34)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0083 (IC base=+0.040)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.140 (n=48)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 8.0 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` < `0.0879` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0879 (IC base=+0.040)
...
- **PATRÓN** `sigma_h` > `0.0259` → IC=+0.240 (n=48)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0259 (IC base=+0.206)
...
- **PATRÓN** `dist_vwap_pct` < `0.186` → IC=+0.208 (n=22)
...
- **PATRÓN** `ibs_15` > `0.717` → IC=+0.149 (n=212)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `ibs_15` > 0.717 (IC base=+0.017)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.017)

- **PATRÓN** `dist_vwap_pct` < `0.3854` → IC=+0.184 (n=96)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.3854 (IC base=+0.017)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1652` → IC=+0.128 (n=100)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.1652 (IC base=+0.056)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.173 (n=111)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 12.0 (IC base=+0.056)

- **PATRÓN** `ibs_15` < `0.9136` → IC=+0.155 (n=111)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.77€ cuando `ibs_15` < 0.9136 (IC base=+0.056)

- **PATRÓN** `ibs_15` > `0.6428` → IC=+0.164 (n=111)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.82€ cuando `ibs_15` > 0.6428 (IC base=+0.056)
...
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS < 0.9136 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.155 n=111). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 808 | +0.181 | +4.20€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 518 | +0.211 | +3.76€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 239 | +0.189 | -2.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 173 | +0.214 | -4.06€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 285 | +0.166 | +1.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 171 | +0.205 | +1.30€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 282 | +0.190 | +5.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 172 | +0.213 | +6.48€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 3519 | +0.113 | +1141.01€ | 0 | 7 |
| ✅ GBM_LATE_15M#15min | 3519 | +0.113 | +1141.01€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 870 | +0.069 | +105.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 870 | +0.069 | +105.70€ | 0 | 1 |
| ✅ GBM_LATE_15M#ETH | 894 | +0.074 | +140.25€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 894 | +0.074 | +140.25€ | 0 | 1 |
| ✅ GBM_LATE_15M#SOL | 914 | +0.139 | +449.18€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 914 | +0.139 | +449.18€ | 0 | 7 |
| ✅ GBM_LATE_15M#XRP | 841 | +0.173 | +445.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 841 | +0.173 | +445.89€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 886 | +0.159 | +439.64€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 886 | +0.159 | +439.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 234 | +0.170 | +152.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 234 | +0.170 | +152.07€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 240 | +0.128 | +80.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 240 | +0.128 | +80.34€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 248 | +0.104 | +50.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 248 | +0.104 | +50.98€ | 0 | 4 |
...
| ✅ GBM_LATE_15M_TARDIO | 1061 | +0.081 | +242.43€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1061 | +0.081 | +242.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 246 | +0.077 | +28.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 246 | +0.077 | +28.47€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 266 | +0.007 | +7.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 266 | +0.007 | +7.21€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 276 | +0.036 | +24.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 276 | +0.036 | +24.42€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 273 | +0.202 | +182.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 273 | +0.202 | +182.32€ | 0 | 8 |
...
| ✅ STREAK_FADE_5M | 146 | -0.061 | -12.68€ | 4 | 0 |
| ✅ STREAK_FADE_5M#5min | 146 | -0.061 | -12.68€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 46 | +0.000 | -1.35€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 46 | +0.000 | -1.35€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1312 | -0.007 | +23.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1056 | +0.023 | +60.68€ | 1 | 4 |
...
| ✅ UPDOWN_GBM#BTC | 350 | +0.011 | +5.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 271 | +0.053 | +19.08€ | 1 | 8 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.116) — sin ventaja clara. oversold(IBS<0.3): IC=-0.021 n=340 | neutral: IC=-0.046 n=256 | overbought(IBS>0.7): IC=+0.069 n=286
  - _Datos_: n=922 IC=+0.008 PNL=+48.44€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.089 n=5981 | tras_1loss IC=+0.042 n=4533 | tras_2loss IC=+0.008 n=2048/40 | gap=+0.081 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.123 n=67/60 | contraria IC=+0.045 n=20 | gap=+0.078 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1186 IC=-0.001 PNL=+35.68€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1186 IC=-0.001 PNL=+35.68€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=598 IC=+0.017 PNL=+23.59€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=598 IC=+0.017 PNL=+23.59€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=271 IC=+0.053 PNL=+19.08€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=271 IC=+0.053 PNL=+19.08€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=540 IC=+0.052 PNL=+41.99€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=540 IC=+0.052 PNL=+41.99€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8193 IC=+0.095 PNL=+1915.43€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8193 IC=+0.095 PNL=+1915.43€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=745 IC=-0.017 PNL=-6.88€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=745 IC=-0.017 PNL=-6.88€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.176 > 0.1 con n=260 PNL=+96.79€
  - _Datos_: n=260 IC=+0.176 PNL=+96.79€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=357 IC=-0.057 PNL=+72.26€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=357 IC=-0.057 PNL=+72.26€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.179 > 0.08 con n=194 PNL=+69.83€
  - _Datos_: n=194 IC=+0.179 PNL=+69.83€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.244 n=80) pero sin cruzar ≥2 pares más — ETH: n=102 IC=+0.144 ✓; SOL: n=7 IC=-0.019; XRP: n=5 IC=+0.018
  - _Datos_: n=80 IC=+0.244 PNL=+33.91€
...
**⏳ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 2/40 ops en el filtro definido (IC actual=+0.025 PNL=+3.42€)
  - _Datos_: n=2 IC=+0.025 PNL=+3.42€

**⏳ H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: 40
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: 1/40 ops en el filtro definido (IC actual=+0.008 PNL=+2.07€)
  - _Datos_: n=1 IC=+0.008 PNL=+2.07€
