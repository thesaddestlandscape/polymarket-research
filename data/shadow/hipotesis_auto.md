# Hipótesis automáticas — 2026-07-02 16:58 UTC
_Generado por shadow_postmortem.py sobre 2756 resoluciones (PNL=-53.83€)_
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M#XRP#15min` — IC=+0.214 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#XRP` — IC=+0.214 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#BTC#15min` — IC=+0.110 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#BTC` — IC=+0.110 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#SOL#15min` — IC=+0.186 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#SOL` — IC=+0.186 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 143 | +0.135 | +39.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 143 | +0.135 | +39.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 39 | +0.110 | +8.42€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 39 | +0.110 | +8.42€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 38 | +0.025 | +1.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 38 | +0.025 | +1.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 33 | +0.186 | +13.82€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 33 | +0.186 | +13.82€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 33 | +0.214 | +16.22€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 33 | +0.214 | +16.22€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 828 | -0.041 | -49.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 600 | -0.018 | -22.08€ | 2 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 319 | -0.011 | +4.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 235 | +0.006 | +11.11€ | 1 | 4 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.075) — sin ventaja clara. oversold(IBS<0.3): IC=-0.003 n=147 | neutral: IC=-0.079 n=131 | overbought(IBS>0.7): IC=-0.047 n=146
  - _Datos_: n=438 IC=-0.041 PNL=-24.72€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.200 n=28 PNL=-13.74€ → FILTRAR | H=02h: IC=-0.227 n=20 PNL=-7.89€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=15h: IC=-0.109 n=21 PNL=-6.63€ → FILTRAR | H=16h: IC=+0.152 n=21 PNL=+3.68€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.180 n=18 PNL=+12.32€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.011 n=1316 | tras_1loss IC=-0.033 n=1349 | tras_2loss IC=-0.046 n=700/40 | gap=+0.057 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=705 IC=-0.036 PNL=-36.41€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=705 IC=-0.036 PNL=-36.41€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=330 IC=+0.066 PNL=+36.33€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=330 IC=+0.066 PNL=+36.33€
