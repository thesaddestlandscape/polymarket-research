# Hipótesis automáticas — 2026-08-18 18:42 UTC
_Generado por shadow_postmortem.py sobre 66359 resoluciones (PNL=+6688.19€)_
...
- **FILTRO** `py_entrada` > `0.5` → IC=-0.377 (n=63)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.138 (n=208)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.138 (n=208)

  - _Acción_: Kelly boost +0.69€ cuando `py_entrada` < 0.5 (IC base=+0.017)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `150.33` → IC=-0.255 (n=878)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 150.33
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2636)
...
- **FILTRO** `restante_s_al_confirmar` > `641.0` → IC=-0.276 (n=114)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` > 641.0
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=346)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `13.61` → IC=-0.491 (n=116)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 13.61
...
- **FILTRO** `concentracion_yes` < `1.0` → IC=-0.135 (n=61)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.128 (n=774)

- **FILTRO** `restante_s_al_confirmar` < `247.64` → IC=-0.156 (n=626)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 247.64
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=209)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `159.59` → IC=-0.279 (n=170)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 159.59
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=513)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.194 (n=2274)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` > 0.7 (IC base=+0.094)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.164 (n=1162)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2373.5135` → IC=+0.166 (n=1124)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2373.5135 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.154 (n=3861)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 7.0 (IC base=+0.149)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.152 (n=2869)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 11.0 (IC base=+0.149)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.283 (n=1471)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.188 (n=2003)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.02 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `4043.0621` → IC=+0.179 (n=811)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 4043.0621 (IC base=+0.149)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.208 (n=364)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.775` → IC=+0.356 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.775 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.230 (n=305)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.297 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=433)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.197)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.142 (n=392)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 5.0 (IC base=+0.132)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.162 (n=341)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 15.0 (IC base=+0.132)

- **PATRÓN** `py_entrada` > `0.555` → IC=+0.143 (n=421)
...
- **PATRÓN** `py_entrada` < `0.395` → IC=+0.223 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.395 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `5296.1268` → IC=+0.175 (n=207)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5296.1268 (IC base=+0.141)
...
- **PATRÓN** `libro_liquidez` > `2188.8928` → IC=+0.165 (n=270)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=577)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.272 (n=112)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.233)

- **PATRÓN** `py_entrada` < `0.37` → IC=+0.309 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.233)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.251 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.233)

- **PATRÓN** `libro_liquidez` > `913.222` → IC=+0.243 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 913.222 (IC base=+0.233)
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.220 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.162 (n=258)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.02 (IC base=+0.110)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.181 (n=911)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.202 (n=907)
...
- **PATRÓN** `py_entrada` < `0.741` → IC=+0.171 (n=652)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.741 (IC base=+0.156)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.155 (n=619)

  - _Acción_: Kelly boost +0.78€ cuando `py_entrada` > 0.71 (IC base=+0.156)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=677)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.189 (n=291)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 7.0 (IC base=+0.160)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.188 (n=229)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.7 (IC base=+0.160)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.160 (n=369)

  - _Acción_: Kelly boost +0.80€ cuando `py_entrada` > 0.73 (IC base=+0.160)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.218 (n=600)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.72` → IC=+0.189 (n=500)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=1504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.252 (n=1532)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.142 (n=411)

  - _Acción_: Kelly boost +0.71€ cuando `py_entrada` > 0.73 (IC base=+0.098)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.296 (n=268)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.321 (n=232)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.292 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.248)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.248 (n=248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.257 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.191)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.227 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.149)

- **PATRÓN** `restante_min` < `3.79` → IC=+0.163 (n=535)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` < 3.79 (IC base=+0.149)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.202 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.91 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.155 (n=1478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 7.0 (IC base=+0.149)
...
- **PATRÓN** `lag_apertura_s` < `5.53` → IC=+0.208 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 5.53 (IC base=+0.149)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.242 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.155)

- **PATRÓN** `restante_min` < `3.73` → IC=+0.169 (n=267)

  - _Acción_: Kelly boost +0.85€ cuando `restante_min` < 3.73 (IC base=+0.155)

- **PATRÓN** `restante_min` > `4.88` → IC=+0.190 (n=279)

  - _Acción_: Kelly boost +0.95€ cuando `restante_min` > 4.88 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=823)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `7.35` → IC=+0.194 (n=263)

  - _Acción_: Kelly boost +0.97€ cuando `lag_apertura_s` < 7.35 (IC base=+0.155)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.210 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.142)

- **PATRÓN** `restante_min` < `3.88` → IC=+0.143 (n=270)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` < 3.88 (IC base=+0.142)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.223 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.95 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.147 (n=748)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.25` → IC=+0.222 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 3.25 (IC base=+0.142)

- **PATRÓN** `profundidad_ratio_no` > `12.4` → IC=+0.162 (n=270)

  - _Acción_: Kelly boost +0.81€ cuando `profundidad_ratio_no` > 12.4 (IC base=+0.142)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.310 (n=425)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.313 (n=196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.302)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.310 (n=188)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1882.9092` → IC=+0.321 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1882.9092 (IC base=+0.302)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.411 (n=77)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.413)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.427 (n=67)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1842.491` → IC=+0.436 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1842.491 (IC base=+0.413)

### FAVORITO_CONFIRMADO_SOL_ALTACONVICCION
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.279 (n=138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9882` → IC=+0.266 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9882 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.5859` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5859 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.749` → IC=+0.239 (n=599)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.749 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `1.3035` → IC=+0.240 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.3035 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` > `0.6419` → IC=+0.240 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6419 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.6604` → IC=+0.123 (n=2152)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.6604 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` < `0.116` → IC=+0.143 (n=538)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.116 (IC base=+0.078)

- **PATRÓN** `volumen_regimen` < `1.3118` → IC=+0.141 (n=486)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.3118 (IC base=+0.078)

- **PATRÓN** `volumen_regimen` > `0.6936` → IC=+0.144 (n=434)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6936 (IC base=+0.078)

- **PATRÓN** `volumen_pendiente_norm` > `0.1255` → IC=+0.268 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1255 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` < `1.7037` → IC=+0.248 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7037 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` > `2.817` → IC=+0.217 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.817 (IC base=+0.078)

- **PATRÓN** `ballena_activa_n` < `245.0` → IC=+0.284 (n=109)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.168 (n=185)
  ...
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.007 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.191 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 6.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.297 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.556` → IC=+0.345 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.556 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.163 (n=292)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.06 (IC base=+0.126)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.317 (n=129)
...
- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.337 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5833 (IC base=+0.287)

- **PATRÓN** `volumen_pendiente_norm` < `0.0668` → IC=+0.324 (n=72)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7987` → IC=+0.339 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7987 (IC base=+0.287)

- **PATRÓN** `volumen_spike_ratio` > `2.2101` → IC=+0.314 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2101 (IC base=+0.287)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.333 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.287)

- **PATRÓN** `libro_liquidez` > `1915.4982` → IC=+0.322 (n=88)
...
- **PATRÓN** `sigma_h` > `0.0035` → IC=+0.329 (n=33)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0035 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.313 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 9.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` < `0.655` → IC=+0.278 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.655 (IC base=+0.261)

- **PATRÓN** `ibs_20min` > `0.917` → IC=+0.294 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.917 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` > `0.55` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.55 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.764` → IC=+0.339 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.764 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` < `1.4038` → IC=+0.275 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.4038 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` < `0.1173` → IC=+0.322 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1173 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` < `2.7168` → IC=+0.308 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.7168 (IC base=+0.261)

- **PATRÓN** `libro_liquidez` > `12045.4998` → IC=+0.308 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12045.4998 (IC base=+0.261)

- **PATRÓN** `sigma_h` < `0.0018` → IC=+0.171 (n=80)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0018 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.151 (n=107)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0029 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.1903` → IC=+0.171 (n=208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.1903 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.188 (n=171)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 12.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` < `0.4787` → IC=+0.206 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4787 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.365` → IC=+0.258 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.365 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.2895` → IC=+0.164 (n=236)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2895 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6827` → IC=+0.167 (n=211)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.6827 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.13` → IC=+0.250 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.13 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.5138` → IC=+0.266 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5138 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12093.0773` → IC=+0.191 (n=79)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 12093.0773 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `244.0` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 244.0 (IC base=+0.146)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.177 (n=165)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.271 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.059` → IC=+0.302 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.059 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.4203` → IC=+0.159 (n=42)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.4203 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.152 (n=400)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.06 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `1918.9386` → IC=+0.141 (n=165)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 1918.9386 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 13.0 (IC base=+0.131)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.288 (n=163)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5082` → IC=+0.313 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5082 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.108` → IC=+0.316 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.108 (IC base=+0.285)
...
- **PATRÓN** `volumen_spike_ratio` < `4.8135` → IC=+0.270 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 4.8135 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` > `2.9764` → IC=+0.263 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9764 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.290 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.06 (IC base=+0.285)

### GBM_LATE_15M#ETH#15min
- **PATRÓN** `ibs_20min` > `0.772` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.772 (IC base=+0.059)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.253` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.253 (IC base=+0.059)
...
- **PATRÓN** `sigma_h` < `0.0054` → IC=+0.167 (n=25)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0054 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.5652` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5652 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.928` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 2.928 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.190 (n=27)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.120)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `8.411` → IC=+0.144 (n=57)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 8.411 (IC base=-0.019)

- **PATRÓN** `volumen_regimen` < `0.7863` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.7863 (IC base=-0.019)
...
- **PATRÓN** `ibs_20min` > `0.9432` → IC=+0.232 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9432 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.1186` → IC=+0.179 (n=160)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1186 (IC base=+0.052)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.204` → IC=+0.129 (n=997)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 2.204 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` < `0.1183` → IC=+0.123 (n=619)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_pendiente_norm` < 0.1183 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.3352` → IC=+0.195 (n=103)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.3352 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` > `2.8513` → IC=+0.170 (n=295)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.8513 (IC base=+0.052)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.297 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.166 (n=854)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` > `0.5114` → IC=+0.265 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5114 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` > `1.2602` → IC=+0.216 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2602 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.2058` → IC=+0.337 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2058 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `3.7273` → IC=+0.307 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.7273 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.295 (n=76)
...
- **FILTRO** `sigma_ewma_delta_pct` > `5.016` → IC=-0.210 (n=105)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=528)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.361` → IC=+0.177 (n=122)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.361 (IC base=-0.013)
...
- **FILTRO** `ibs_20min` < `0.0377` → IC=-0.151 (n=84)
...
- **PATRÓN** `volumen_regimen` < `1.0528` → IC=+0.139 (n=34)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.0528 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` < `0.5591` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.5591 (IC base=-0.008)

- **PATRÓN** `volumen_regimen` > `1.1078` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.1078 (IC base=-0.008)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0626` → IC=+0.203 (n=116)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.027` → IC=+0.317 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.027 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` < `0.1372` → IC=+0.187 (n=247)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1372 (IC base=+0.180)
...
- **PATRÓN** `volumen_spike_ratio` < `4.7523` → IC=+0.167 (n=265)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 4.7523 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `3.7567` → IC=+0.197 (n=120)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 3.7567 (IC base=+0.180)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.197 (n=374)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.06 (IC base=+0.180)

- **PATRÓN** `libro_liquidez` > `1914.9184` → IC=+0.204 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1914.9184 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `31.0` → IC=+0.271 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 31.0 (IC base=+0.180)

- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.407 (n=106)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.368)

- **PATRÓN** `drift_60min` |x|≤ `0.1839` → IC=+0.370 (n=106)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1839 (IC base=+0.368)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.394 (n=149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.368)

- **PATRÓN** `ibs_20min` < `0.2417` → IC=+0.387 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2417 (IC base=+0.368)

- **PATRÓN** `ibs_20min` > `0.0506` → IC=+0.368 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.0506 (IC base=+0.368)

- **PATRÓN** `volumen_pendiente_norm` < `0.3414` → IC=+0.389 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.3414 (IC base=+0.368)

- **PATRÓN** `volumen_pendiente_norm` > `0.1288` → IC=+0.395 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1288 (IC base=+0.368)

- **PATRÓN** `volumen_spike_ratio` < `2.9702` → IC=+0.436 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9702 (IC base=+0.368)

- **PATRÓN** `libro_liquidez` > `1868.3264` → IC=+0.427 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1868.3264 (IC base=+0.368)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.6396` → IC=-0.127 (n=156)
...
- **FILTRO** `volumen_regimen` > `0.9044` → IC=-0.273 (n=20)

  - _Acción_: SKIP cuando `volumen_regimen` > 0.9044
  - _Potencial_: sin este filtro IC_bueno=-0.125 (n=22)

- **FILTRO** `libro_liquidez` < `8603.4597` → IC=-0.205 (n=59)

  - _Acción_: SKIP cuando `libro_liquidez` < 8603.4597
...
- **FILTRO** `ibs_20min` < `0.45` → IC=-0.155 (n=143)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=143)
...
- **PATRÓN** `ibs_20min` > `0.45` → IC=+0.141 (n=143)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.45 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` > `0.1775` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1775 (IC base=-0.007)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.304 (n=100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0066 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.1343` → IC=+0.145 (n=201)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.1343 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.143 (n=110)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.223 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.322` → IC=+0.221 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.322 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.12` → IC=+0.225 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.12 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `0.5938` → IC=+0.149 (n=300)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.5938 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.3138` → IC=+0.225 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3138 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=304)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `2467.2556` → IC=+0.137 (n=268)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2467.2556 (IC base=+0.134)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.290 (n=269)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.282)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.321 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.282)

- **PATRÓN** `ibs_20min` < `0.3141` → IC=+0.338 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3141 (IC base=+0.282)

- **PATRÓN** `dist_vwap_pct` > `0.5529` → IC=+0.375 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5529 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.238` → IC=+0.289 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.238 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.001` → IC=+0.283 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.001 (IC base=+0.282)

- **PATRÓN** `volumen_regimen` > `0.8997` → IC=+0.318 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8997 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.2872` → IC=+0.371 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2872 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `3.4615` → IC=+0.308 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4615 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `2832.6472` → IC=+0.286 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2832.6472 (IC base=+0.282)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.149 (n=420)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0047 (IC base=+0.139)

- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.192 (n=572)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0066 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.142 (n=604)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9206` → IC=+0.253 (n=840)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9206 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.2233` → IC=+0.144 (n=282)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.2233 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.964` → IC=+0.265 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.964 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1809` → IC=+0.139 (n=655)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.1809 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.6237` → IC=+0.137 (n=654)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6237 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1127` → IC=+0.159 (n=417)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.1127 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.146 (n=1416)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.06 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `2680.8058` → IC=+0.173 (n=420)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2680.8058 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.222 (n=1208)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.215)

- **PATRÓN** `drift_60min` |x|≤ `0.2964` → IC=+0.222 (n=1208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2964 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.272 (n=615)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` < `0.3729` → IC=+0.282 (n=1208)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3729 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.616` → IC=+0.242 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.616 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.277` → IC=+0.215 (n=1192)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.277 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` < `1.2547` → IC=+0.192 (n=938)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 1.2547 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `0.8744` → IC=+0.202 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8744 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.2712` → IC=+0.279 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2712 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `2.049` → IC=+0.235 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.049 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `3.1312` → IC=+0.235 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1312 (IC base=+0.215)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.272 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.215)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.173 (n=105)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0058 (IC base=+0.155)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.217 (n=104)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0075 (IC base=+0.155)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.224 (n=121)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.8835` → IC=+0.290 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8835 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.478` → IC=+0.349 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.478 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.0917` → IC=+0.142 (n=93)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.0917 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.08` → IC=+0.173 (n=338)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.08 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.295 (n=86)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2186` → IC=+0.325 (n=112)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2186 (IC base=+0.289)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.287 (n=134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0513` → IC=+0.411 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0513 (IC base=+0.289)

- **PATRÓN** `volumen_pendiente_norm` < `0.1174` → IC=+0.330 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1174 (IC base=+0.289)

- **PATRÓN** `volumen_spike_ratio` < `1.8801` → IC=+0.370 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8801 (IC base=+0.289)

- **PATRÓN** `volumen_spike_ratio` > `2.3631` → IC=+0.281 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3631 (IC base=+0.289)

- **PATRÓN** `libro_spread` < `0.08` → IC=+0.316 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.08 (IC base=+0.289)

- **PATRÓN** `libro_liquidez` > `1903.8` → IC=+0.350 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1903.8 (IC base=+0.289)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0018` → IC=+0.250 (n=34)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0018 (IC base=+0.213)
...
- **PATRÓN** `ibs_20min` > `0.871` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.871 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.5629` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5629 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.534` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.534 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `0.6419` → IC=+0.222 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6419 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.9006` → IC=+0.225 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9006 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.2042` → IC=+0.278 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2042 (IC base=+0.213)
...
- **PATRÓN** `libro_liquidez` > `11338.6336` → IC=+0.306 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11338.6336 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0018` → IC=+0.214 (n=75)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0018 (IC base=+0.184)

- **PATRÓN** `sigma_h` > `0.002` → IC=+0.186 (n=202)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.002 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.1928` → IC=+0.205 (n=198)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1928 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.220 (n=212)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` < `0.2977` → IC=+0.240 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2977 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.664` → IC=+0.281 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.664 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` < `0.637` → IC=+0.227 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.637 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` > `0.6986` → IC=+0.185 (n=201)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.6986 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` < `0.1932` → IC=+0.212 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1932 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.1352` → IC=+0.246 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1352 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.255 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5474 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `11311.9325` → IC=+0.214 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11311.9325 (IC base=+0.184)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.153 (n=99)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0056 (IC base=+0.148)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.170 (n=195)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0065 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.1472` → IC=+0.157 (n=196)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1472 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.170 (n=110)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.816` → IC=+0.317 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.816 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` < `0.2311` → IC=+0.128 (n=232)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.2311 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.0146` → IC=+0.205 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0146 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.179 (n=222)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.04 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `1962.7584` → IC=+0.170 (n=98)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 1962.7584 (IC base=+0.148)
...
- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.353 (n=32)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0021 (IC base=+0.254)

- **PATRÓN** `sigma_h` > `0.003` → IC=+0.267 (n=58)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.003 (IC base=+0.254)

- **PATRÓN** `drift_60min` |x|≤ `0.181` → IC=+0.303 (n=59)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.181 (IC base=+0.254)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.259 (n=81)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7638` → IC=+0.309 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7638 (IC base=+0.254)

- **PATRÓN** `dist_vwap_pct` < `0.3604` → IC=+0.283 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3604 (IC base=+0.254)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.946` → IC=+0.400 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.946 (IC base=+0.254)

- **PATRÓN** `volumen_regimen` > `0.6636` → IC=+0.275 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6636 (IC base=+0.254)

- **PATRÓN** `volumen_pendiente_norm` > `0.1167` → IC=+0.304 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1167 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` < `1.7703` → IC=+0.263 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7703 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` > `3.154` → IC=+0.293 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.154 (IC base=+0.254)

- **PATRÓN** `libro_liquidez` > `2528.5027` → IC=+0.253 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2528.5027 (IC base=+0.254)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.265 (n=147)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.1429` → IC=+0.196 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.1429 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` < `0.314` → IC=+0.264 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.314 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` > `0.2215` → IC=+0.210 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2215 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.869` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.869 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` < `1.2412` → IC=+0.223 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2412 (IC base=+0.192)

- **PATRÓN** `volumen_pendiente_norm` < `0.0858` → IC=+0.226 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0858 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` < `1.9228` → IC=+0.285 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9228 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.193 (n=252)
...
- **FILTRO** `ibs_20min` > `0.5625` → IC=-0.250 (n=78)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.225 (n=242)

- **PATRÓN** `ibs_20min` > `0.875` → IC=+0.184 (n=150)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.875 (IC base=+0.042)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.386` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 7.386 (IC base=+0.042)

- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.226 (n=82)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.235 (n=81)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.225 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5625 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.5497` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.5497 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.974` → IC=+0.250 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.974 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` > `0.8622` → IC=+0.148 (n=160)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.8622 (IC base=+0.109)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5471` → IC=+0.149 (n=112)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.5471 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2386.131` → IC=+0.232 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2386.131 (IC base=+0.109)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.241 (n=110)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.0799` → IC=+0.151 (n=81)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.0799 (IC base=+0.121)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.173 (n=111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 7.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.232 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.2945` → IC=+0.185 (n=71)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.2945 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` < `0.0666` → IC=+0.141 (n=168)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.0666 (IC base=+0.121)
...
- **PATRÓN** `volumen_regimen` < `1.1129` → IC=+0.137 (n=243)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.1129 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.327` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.327 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `2.9818` → IC=+0.129 (n=208)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.9818 (IC base=+0.121)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=249)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `2468.9826` → IC=+0.130 (n=217)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2468.9826 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.281 (n=226)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0063 (IC base=+0.267)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.275 (n=229)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.267)

- **PATRÓN** `drift_60min` |x|≤ `0.0817` → IC=+0.295 (n=86)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0817 (IC base=+0.267)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.283 (n=118)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3125` → IC=+0.306 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3125 (IC base=+0.267)

- **PATRÓN** `dist_vwap_pct` > `0.1297` → IC=+0.337 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1297 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.787` → IC=+0.300 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.787 (IC base=+0.267)

- **PATRÓN** `volumen_regimen` > `0.8965` → IC=+0.309 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8965 (IC base=+0.267)

- **PATRÓN** `volumen_pendiente_norm` > `0.2728` → IC=+0.365 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2728 (IC base=+0.267)

- **PATRÓN** `volumen_spike_ratio` > `1.7767` → IC=+0.261 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7767 (IC base=+0.267)

- **PATRÓN** `libro_liquidez` > `2824.7858` → IC=+0.273 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2824.7858 (IC base=+0.267)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.293 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.267)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.204 (n=106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.041)

- **PATRÓN** `ibs_20min` > `0.9601` → IC=+0.164 (n=105)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.9601 (IC base=+0.041)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.863` → IC=+0.244 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.863 (IC base=+0.041)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.303 (n=59)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.051)

- **PATRÓN** `ibs_20min` < `0.36` → IC=+0.122 (n=154)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.36 (IC base=+0.051)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.874` → IC=+0.239 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.874 (IC base=+0.051)

- **PATRÓN** `volumen_spike_ratio` < `2.7336` → IC=+0.126 (n=105)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.7336 (IC base=+0.051)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.269 (n=37)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.2693` → IC=+0.192 (n=37)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.2693 (IC base=+0.167)
...
- **PATRÓN** `hora_utc` < `13.0` → IC=+0.227 (n=31)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 13.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.1986` → IC=+0.269 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1986 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.27` → IC=+0.370 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.27 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 1.1856 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.7151` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.7151 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.091` → IC=+0.395 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.091 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.8271` → IC=+0.333 (n=22)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.198 (n=512)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0068 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.154 (n=556)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 17.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.9601` → IC=+0.282 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9601 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.3432` → IC=+0.189 (n=165)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.3432 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.259` → IC=+0.231 (n=1030)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.259 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.1809` → IC=+0.139 (n=358)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` > 0.1809 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.6929` → IC=+0.123 (n=1095)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 1.6929 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.125 (n=1712)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.06 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `2726.373` → IC=+0.155 (n=511)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2726.373 (IC base=+0.120)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.213 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 147.0 (IC base=+0.120)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.235 (n=1185)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.227)

- **PATRÓN** `sigma_h` > `0.0038` → IC=+0.233 (n=1346)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0038 (IC base=+0.227)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.253 (n=614)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.227)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.288 (n=1352)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.227)

- **PATRÓN** `dist_vwap_pct` > `0.2398` → IC=+0.198 (n=236)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.2398 (IC base=+0.227)

- **PATRÓN** `dist_vwap_pct` < `0.1508` → IC=+0.198 (n=899)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.1508 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.033` → IC=+0.262 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.033 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.48` → IC=+0.227 (n=1260)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.48 (IC base=+0.227)

- **PATRÓN** `volumen_regimen` < `0.6183` → IC=+0.215 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6183 (IC base=+0.227)

- **PATRÓN** `volumen_regimen` > `1.0639` → IC=+0.217 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0639 (IC base=+0.227)

- **PATRÓN** `volumen_pendiente_norm` < `0.1146` → IC=+0.254 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1146 (IC base=+0.227)

- **PATRÓN** `volumen_pendiente_norm` > `0.1843` → IC=+0.270 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1843 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` < `2.0113` → IC=+0.280 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0113 (IC base=+0.227)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.138 (n=387)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 6.0 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.159 (n=265)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 11.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.290 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.288` → IC=+0.350 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.288 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2113` → IC=+0.155 (n=56)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.2113 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.170 (n=274)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.06 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.333 (n=64)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2132` → IC=+0.344 (n=165)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2132 (IC base=+0.301)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.310 (n=177)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.356 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.301)

- **PATRÓN** `volumen_pendiente_norm` < `0.0695` → IC=+0.351 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0695 (IC base=+0.301)

- **PATRÓN** `volumen_spike_ratio` < `1.88` → IC=+0.336 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.88 (IC base=+0.301)

- **PATRÓN** `volumen_spike_ratio` > `2.7667` → IC=+0.344 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7667 (IC base=+0.301)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.331 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.301)

- **PATRÓN** `libro_liquidez` > `1978.9302` → IC=+0.361 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1978.9302 (IC base=+0.301)

### GBM_LATE_15M_TARDIO#BTC#15min
- **FILTRO** `ibs_20min` < `0.4138` → IC=-0.187 (n=65)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4138
  - _Potencial_: sin este filtro IC_bueno=+0.284 (n=132)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.153 (n=99)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0027 (IC base=+0.128)

- **PATRÓN** `sigma_h` > `0.0031` → IC=+0.181 (n=67)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0031 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.232 (n=69)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.128)

- **PATRÓN** `ibs_20min` > `0.4138` → IC=+0.284 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4138 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` > `0.3609` → IC=+0.324 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3609 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.779` → IC=+0.255 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.779 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.6608` → IC=+0.173 (n=50)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.6608 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `1.1082` → IC=+0.167 (n=67)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1082 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` < `0.1561` → IC=+0.185 (n=106)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1561 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` < `2.8769` → IC=+0.233 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.8769 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `8861.5314` → IC=+0.239 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8861.5314 (IC base=+0.128)

- **PATRÓN** `sigma_h` < `0.0018` → IC=+0.216 (n=79)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0018 (IC base=+0.177)

- **PATRÓN** `sigma_h` > `0.0024` → IC=+0.177 (n=156)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0024 (IC base=+0.177)

- **PATRÓN** `drift_60min` |x|≤ `0.1928` → IC=+0.189 (n=204)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1928 (IC base=+0.177)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 6.0 (IC base=+0.177)

- **PATRÓN** `ibs_20min` < `0.4222` → IC=+0.231 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4222 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.22` → IC=+0.264 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.22 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` < `1.3065` → IC=+0.188 (n=232)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 1.3065 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` > `1.1277` → IC=+0.201 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1277 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.0979` → IC=+0.303 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0979 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` < `1.8705` → IC=+0.308 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8705 (IC base=+0.177)

- **PATRÓN** `libro_liquidez` > `5000.8359` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 5000.8359 (IC base=+0.177)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.245 (n=104)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.319 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.924` → IC=+0.348 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.924 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` < `0.1458` → IC=+0.171 (n=220)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` < 0.1458 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `1.9083` → IC=+0.159 (n=80)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.9083 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `4.0128` → IC=+0.167 (n=109)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 4.0128 (IC base=+0.172)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.190 (n=337)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.06 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `1854.4986` → IC=+0.191 (n=208)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 1854.4986 (IC base=+0.172)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.362 (n=85)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0053 (IC base=+0.277)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.282 (n=172)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5455` → IC=+0.334 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5455 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` < `0.2348` → IC=+0.230 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2348 (IC base=+0.277)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7145` → IC=+0.304 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7145 (IC base=+0.277)
...
- **FILTRO** `ibs_20min` < `0.345` → IC=-0.217 (n=51)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.203 (n=153)

- **PATRÓN** `sigma_h` < `0.0019` → IC=+0.185 (n=52)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0019 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=55)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.345` → IC=+0.203 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.345 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.4244` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.4244 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.566` → IC=+0.212 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.566 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `0.7759` → IC=+0.171 (n=68)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.7759 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.29` → IC=+0.326 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.29 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.4389` → IC=+0.220 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4389 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `7083.9363` → IC=+0.250 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7083.9363 (IC base=+0.097)

- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.225 (n=107)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.2641` → IC=+0.151 (n=107)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.2641 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.191 (n=40)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 16.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` < `0.3` → IC=+0.250 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.1908` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1908 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.7` → IC=+0.269 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.7 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8857` → IC=+0.208 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8857 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` < `0.141` → IC=+0.328 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.141 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.2709` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2709 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7529` → IC=+0.289 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7529 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `6213.1923` → IC=+0.237 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6213.1923 (IC base=+0.146)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.923` → IC=+0.167 (n=139)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 2.923 (IC base=+0.019)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.170 (n=231)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0069 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.1759` → IC=+0.173 (n=154)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.1759 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.225 (n=107)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` < `0.5938` → IC=+0.242 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5938 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.1779` → IC=+0.159 (n=180)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1779 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.427` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.427 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.92` → IC=+0.148 (n=217)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 2.92 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.703` → IC=+0.211 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.703 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `1.2477` → IC=+0.158 (n=77)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.2477 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` < `0.1742` → IC=+0.320 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1742 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.5886` → IC=+0.316 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5886 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `1366.7866` → IC=+0.257 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1366.7866 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 95.0 (IC base=+0.144)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.200 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.0729` → IC=+0.189 (n=101)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.0729 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.172 (n=114)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 17.0 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.181 (n=111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 6.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.248 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` > `0.3261` → IC=+0.258 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3261 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.29` → IC=+0.218 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.29 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` < `1.1858` → IC=+0.130 (n=303)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.1858 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `0.6695` → IC=+0.141 (n=271)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6695 (IC base=+0.130)

- **PATRÓN** `volumen_pendiente_norm` > `0.327` → IC=+0.188 (n=30)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.327 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` > `1.7654` → IC=+0.124 (n=227)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 1.7654 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=309)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `2596.7996` → IC=+0.137 (n=202)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2596.7996 (IC base=+0.130)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.297 (n=299)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.260)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.309 (n=171)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.260)

- **PATRÓN** `ibs_20min` < `0.1852` → IC=+0.369 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1852 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` > `0.3858` → IC=+0.360 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3858 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.221` → IC=+0.321 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.221 (IC base=+0.260)

- **PATRÓN** `volumen_regimen` > `0.883` → IC=+0.298 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.883 (IC base=+0.260)

- **PATRÓN** `volumen_pendiente_norm` > `0.322` → IC=+0.367 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.322 (IC base=+0.260)

- **PATRÓN** `volumen_spike_ratio` < `1.5017` → IC=+0.276 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5017 (IC base=+0.260)

- **PATRÓN** `volumen_spike_ratio` > `2.6501` → IC=+0.256 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6501 (IC base=+0.260)

- **PATRÓN** `libro_liquidez` > `2828.8084` → IC=+0.265 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2828.8084 (IC base=+0.260)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.204 (n=52)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.164 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0039 (IC base=+0.106)

- **PATRÓN** `drift_60min` |x|≤ `0.1502` → IC=+0.173 (n=96)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.1502 (IC base=+0.106)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.204 (n=52)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.3964` → IC=+0.136 (n=127)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.3964 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.53` → IC=+0.139 (n=34)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 11.53 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.4143` → IC=+0.137 (n=144)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.4143 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` < `2.8806` → IC=+0.146 (n=142)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.8806 (IC base=+0.106)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.135 (n=176)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.106)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.133 (n=88)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0033 (IC base=+0.097)

- **PATRÓN** `drift_60min` |x|≤ `0.0928` → IC=+0.207 (n=39)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0928 (IC base=+0.097)

- **PATRÓN** `hora_utc` < `9.0` → IC=+0.129 (n=68)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 9.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.1112` → IC=+0.156 (n=59)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.1112 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.1563` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1563 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `2.7111` → IC=+0.133 (n=88)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.7111 (IC base=+0.097)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.265 (n=32)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0036 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.2186` → IC=+0.315 (n=25)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2186 (IC base=+0.220)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.353 (n=32)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.220)

- **PATRÓN** `ibs_20min` > `0.3342` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3342 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.567` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.567 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.056` → IC=+0.233 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.056 (IC base=+0.220)

- **PATRÓN** `volumen_regimen` < `1.4038` → IC=+0.294 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.4038 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` < `0.0872` → IC=+0.274 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0872 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` < `1.8733` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8733 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `7268.8224` → IC=+0.243 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7268.8224 (IC base=+0.220)
...
- **FILTRO** `ibs_20min` < `0.6354` → IC=-0.460 (n=23)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.180 (n=48)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.023)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.944` → IC=+0.122 (n=43)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` > 5.944 (IC base=+0.023)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.186 (n=33)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 8.0 (IC base=+0.128)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.1176` → IC=+0.157 (n=33)

  - _Acción_: Kelly boost +0.79€ cuando `drift_20min_pct` |x|≤ 0.1176 (IC base=+0.128)

- **PATRÓN** `ibs_20min` > `0.0947` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.0947 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `2061.3329` → IC=+0.129 (n=33)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 2061.3329 (IC base=+0.128)

### MOMENTUM_IBS_15M#BTC#15min
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.152 (n=21)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 7.0 (IC base=+0.044)

### MOMENTUM_IBS_15M#ETH#15min
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=22)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.121)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.208 (n=22)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.121)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.0569` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `drift_20min_pct` |x|≤ 0.0569 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `0.1574` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.1574 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `15301.6756` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 15301.6756 (IC base=+0.121)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.5` → IC=-0.202 (n=159)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=200)

- **FILTRO** `ibs_20min` < `0.7442` → IC=-0.181 (n=89)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7442
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=270)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.182 (n=86)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=273)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.164 (n=102)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=311)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.121 (n=172)

  - _Acción_: Kelly boost +0.60€ cuando `py_entrada` < 0.5 (IC base=+0.011)
...
- **FILTRO** `ibs_20min` < `0.7593` → IC=-0.262 (n=19)
...
- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.214 (n=19)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=41)

- **FILTRO** `libro_liquidez` < `15830.4808` → IC=-0.134 (n=39)

  - _Acción_: SKIP cuando `libro_liquidez` < 15830.4808
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=21)

- **FILTRO** `py_entrada` > `0.53` → IC=-0.289 (n=17)

  - _Acción_: SKIP cuando `py_entrada` > 0.53
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=57)

- **FILTRO** `ibs_20min` > `0.2282` → IC=-0.289 (n=17)
...
- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=19)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.208 (n=22)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.070)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.5 (IC base=+0.070)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.1191` → IC=+0.123 (n=51)

  - _Acción_: Kelly boost +0.61€ cuando `drift_20min_pct` |x|≤ 0.1191 (IC base=+0.070)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.220 (n=23)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=36)

- **FILTRO** `ibs_20min` > `0.8571` → IC=-0.177 (n=29)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8571
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=30)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.333 (n=16)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=49)

- **FILTRO** `ibs_20min` < `0.743` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `ibs_20min` < 0.743
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=49)

- **FILTRO** `ballena_activa_n` > `3.0` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `ballena_activa_n` > 3.0
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=46)

- **FILTRO** `py_entrada` > `0.53` → IC=-0.265 (n=15)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.179 (n=26)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` < 0.5 (IC base=+0.015)

- **PATRÓN** `libro_liquidez` > `2687.4654` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 2687.4654 (IC base=+0.015)
...
- **FILTRO** `ibs_20min` > `0.2836` → IC=-0.184 (n=17)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2836
...
- **PATRÓN** `ibs_20min` > `0.7143` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.7143 (IC base=+0.000)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.174 (n=225)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=780)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.309 (n=250)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=755)

- **FILTRO** `ibs_7min` < `0.7391` → IC=-0.234 (n=250)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7391
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=755)

- **FILTRO** `ballena_activa_n` > `24.0` → IC=-0.208 (n=245)

  - _Acción_: SKIP cuando `ballena_activa_n` > 24.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=760)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.208 (n=262)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=800)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.236 (n=51)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=106)

- **FILTRO** `drift_7min_pct` |x|> `0.0765` → IC=-0.138 (n=78)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.0765
  - _Potencial_: sin este filtro IC_bueno=-0.117 (n=79)

- **FILTRO** `ballena_activa_n` > `4.0` → IC=-0.210 (n=74)

  - _Acción_: SKIP cuando `ballena_activa_n` > 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=83)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.214 (n=33)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=118)

- **FILTRO** `drift_7min_pct` |x|> `0.116` → IC=-0.192 (n=37)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.116
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=114)

- **FILTRO** `ibs_7min` > `0.2707` → IC=-0.141 (n=37)
...
- **PATRÓN** `libro_liquidez` > `10993.3675` → IC=+0.130 (n=71)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 10993.3675 (IC base=+0.052)
...
- **PATRÓN** `delta_ratio` |x|> `0.4012` → IC=+0.155 (n=137)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.77€ cuando `delta_ratio` |x|> 0.4012 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.148 (n=69)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 18.0 (IC base=+0.130)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.208 (n=22)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.093)

- **PATRÓN** `streak_len` < `3.0` → IC=+0.148 (n=69)

  - _Acción_: Kelly boost +0.74€ cuando `streak_len` < 3.0 (IC base=+0.093)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=387)
...
- **PATRÓN** `ibs_15` < `0.5882` → IC=+0.120 (n=406)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.60€ cuando `ibs_15` < 0.5882 (IC base=+0.077)

- **PATRÓN** `dist_vwap_pct` > `0.566` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.566 (IC base=+0.077)
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.130 (n=79)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.03 (IC base=+0.003)
...
- **PATRÓN** `sigma_h` < `0.002` → IC=+0.242 (n=29)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.002 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.805` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.805 (IC base=+0.070)

- **PATRÓN** `libro_liquidez` > `11518.9437` → IC=+0.121 (n=56)

  - _Acción_: Kelly boost +0.60€ cuando `libro_liquidez` > 11518.9437 (IC base=+0.070)
...
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.189 (n=43)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0033 (IC base=+0.144)

- **PATRÓN** `sigma_h` > `0.0041` → IC=+0.202 (n=65)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0041 (IC base=+0.144)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1155` → IC=+0.156 (n=88)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.78€ cuando `delta_ratio_macro` |x|> 0.1155 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.156 (n=88)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 7.0 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.153 (n=93)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 14.0 (IC base=+0.144)

- **PATRÓN** `ibs_15` < `0.3247` → IC=+0.170 (n=98)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.85€ cuando `ibs_15` < 0.3247 (IC base=+0.144)

- **PATRÓN** `ibs_15` > `0.0292` → IC=+0.190 (n=98)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.95€ cuando `ibs_15` > 0.0292 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.1562` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1562 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `23.05` → IC=+0.197 (n=97)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 23.05 (IC base=+0.144)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0064` → IC=+0.136 (n=20)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.68€ cuando `pct_spot_vs_ref` |x|≤ 0.0064 (IC base=+0.093)

- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.273 (n=20)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0021 (IC base=+0.093)

- **PATRÓN** `drift_15min` |x|≤ `0.1256` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.1256 (IC base=+0.093)

- **PATRÓN** `hora_utc` < `2.0` → IC=+0.152 (n=21)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 2.0 (IC base=+0.093)

- **PATRÓN** `ibs_15` > `0.0472` → IC=+0.145 (n=60)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.73€ cuando `ibs_15` > 0.0472 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.992` → IC=+0.132 (n=55)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 6.992 (IC base=+0.093)

- **PATRÓN** `ballena_activa_n` < `3.0` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 3.0 (IC base=+0.093)
...
- **FILTRO** `ibs_15` > `0.2` → IC=-0.134 (n=39)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.2
  - _Potencial_: sin este filtro IC_bueno=+0.214 (n=40)

- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.182 (n=20)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0046 (IC base=+0.043)

- **PATRÓN** `delta_ratio_macro` |x|> `0.3123` → IC=+0.155 (n=27)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.78€ cuando `delta_ratio_macro` |x|> 0.3123 (IC base=+0.043)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.130 (n=44)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 8.0 (IC base=+0.043)

- **PATRÓN** `ibs_15` < `0.2` → IC=+0.214 (n=40)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2 (IC base=+0.043)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1198` → IC=+0.182 (n=42)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.1198 (IC base=+0.104)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0971` → IC=+0.158 (n=112)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.79€ cuando `delta_ratio_macro` |x|> 0.0971 (IC base=+0.104)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.146 (n=111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 15.0 (IC base=+0.104)

- **PATRÓN** `ibs_15` < `0.234` → IC=+0.198 (n=84)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.99€ cuando `ibs_15` < 0.234 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.1194` → IC=+0.244 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1194 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.148` → IC=+0.154 (n=105)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 5.148 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `2560.2434` → IC=+0.141 (n=126)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 2560.2434 (IC base=+0.104)
...
- **FILTRO** `ibs_15` < `0.6216` → IC=-0.257 (n=113)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6216
  - _Potencial_: sin este filtro IC_bueno=+0.233 (n=114)

- **FILTRO** `sigma_ewma_delta_pct` > `13.09` → IC=-0.161 (n=225)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 13.09
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=912)

- **PATRÓN** `ibs_15` > `0.6216` → IC=+0.233 (n=114)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6216 (IC base=-0.039)
...
- **FILTRO** `sigma_ewma_delta_pct` > `14.141` → IC=-0.194 (n=60)
...
- **FILTRO** `libro_liquidez` < `2472.6826` → IC=-0.184 (n=36)

  - _Acción_: SKIP cuando `libro_liquidez` < 2472.6826
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=109)

- **FILTRO** `sigma_ewma_delta_pct` > `7.938` → IC=-0.148 (n=86)
...
- **H-IBS-UPDOWN_GBM#SOL#5min**: dentro de BUY_NO, IBS < 0.2 sube el IC de +0.043 a +0.214 en UPDOWN_GBM#SOL#5min (n=40). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_NO, IBS < 0.3247 sube el IC de +0.144 a +0.170 en UPDOWN_GBM#ETH#15min (n=98). Ya aplicado como kelly_boost=+0.85€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_NO, IBS > 0.0292 sube el IC de +0.144 a +0.190 en UPDOWN_GBM#ETH#15min (n=98). Ya aplicado como kelly_boost=+0.95€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.234 sube el IC de +0.104 a +0.198 en UPDOWN_GBM#XRP#15min (n=84). Ya aplicado como kelly_boost=+0.99€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6216 sube el IC de -0.039 a +0.233 en UPDOWN_GBM_15M_TARDIO (n=114). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 488 | +0.045 | +37.75€ | 3 | 4 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 488 | +0.045 | +37.75€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS | 3359 | -0.112 | -519.80€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 460 | -0.024 | -17.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2899 | -0.126 | -501.95€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 366 | -0.182 | -98.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 366 | -0.182 | -98.69€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 460 | -0.024 | -17.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 460 | -0.024 | -17.86€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 310 | -0.164 | -151.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 310 | -0.164 | -151.46€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 725 | -0.137 | -38.80€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 725 | -0.137 | -38.80€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 815 | +0.003 | -94.83€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 815 | +0.003 | -94.83€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP | 683 | -0.218 | -118.18€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 683 | -0.218 | -118.18€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 14443 | +0.115 | -838.85€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 3392 | +0.181 | -107.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 99 | -0.104 | -47.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 8355 | +0.086 | -707.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2597 | +0.132 | +24.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 1410 | +0.033 | -304.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 13 | -0.065 | -2.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 1393 | +0.036 | -296.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 3284 | +0.140 | -3.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 926 | +0.197 | -29.03€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 41 | -0.105 | -20.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 1393 | +0.109 | -18.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 924 | +0.139 | +64.24€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 1406 | +0.055 | -245.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 9 | -0.021 | -3.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 1396 | +0.056 | -239.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 3550 | +0.126 | -47.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1252 | +0.160 | -23.03€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 1389 | +0.105 | -18.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 897 | +0.116 | +2.65€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 3387 | +0.135 | -207.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1180 | +0.196 | -51.77€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 40 | +0.000 | -9.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 1391 | +0.083 | -103.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 776 | +0.140 | -42.31€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 1406 | +0.127 | -29.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 12 | +0.043 | +1.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 1393 | +0.128 | -29.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 3468 | +0.161 | -330.37€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 3468 | +0.161 | -330.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 869 | +0.156 | -112.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 869 | +0.156 | -112.13€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 859 | +0.160 | -106.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 859 | +0.160 | -106.52€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 770 | +0.218 | -42.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 770 | +0.218 | -42.32€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 813 | +0.175 | -77.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 813 | +0.175 | -77.44€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 5957 | +0.190 | -547.62€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 5957 | +0.190 | -547.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1116 | +0.098 | -251.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1116 | +0.098 | -251.76€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 920 | +0.249 | -6.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 920 | +0.249 | -6.32€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1049 | +0.153 | -152.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1049 | +0.153 | -152.49€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 958 | +0.224 | -36.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 958 | +0.224 | -36.39€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 926 | +0.248 | -9.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 926 | +0.248 | -9.05€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 988 | +0.191 | -91.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 988 | +0.191 | -91.62€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 2124 | +0.149 | +116.07€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 2124 | +0.149 | +116.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 1048 | +0.155 | +69.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 1048 | +0.155 | +69.58€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 1076 | +0.142 | +46.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 1076 | +0.142 | +46.49€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 536 | +0.299 | +3.87€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 536 | +0.299 | +3.87€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 250 | +0.302 | +7.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 250 | +0.302 | +7.27€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO | 226 | +0.408 | -11.41€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#60min | 226 | +0.408 | -11.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC | 101 | +0.403 | -5.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#BTC#60min | 101 | +0.403 | -5.98€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#ETH | 101 | +0.413 | -5.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#ETH#60min | 101 | +0.413 | -5.58€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#SOL | 24 | +0.346 | +0.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_EXTREMO#SOL#60min | 24 | +0.346 | +0.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 250 | +0.258 | -29.89€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 250 | +0.258 | -29.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 250 | +0.258 | -29.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 250 | +0.258 | -29.89€ | 0 | 4 |
| ✅ GBM_LATE_15M | 4535 | +0.088 | +1614.64€ | 0 | 14 |
| ✅ GBM_LATE_15M#15min | 4535 | +0.088 | +1614.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 789 | +0.179 | +504.78€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 789 | +0.179 | +504.78€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 446 | +0.181 | +227.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 446 | +0.181 | +227.65€ | 0 | 23 |
| ✅ GBM_LATE_15M#DOGE | 793 | +0.192 | +544.42€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 793 | +0.192 | +544.42€ | 0 | 18 |
| ✅ GBM_LATE_15M#ETH | 607 | -0.003 | +32.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 607 | -0.003 | +32.89€ | 0 | 2 |
| ✅ GBM_LATE_15M#SOL | 851 | +0.004 | +76.19€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 851 | +0.004 | +76.19€ | 3 | 4 |
| ✅ GBM_LATE_15M#XRP | 1049 | +0.019 | +228.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1049 | +0.019 | +228.71€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5549 | +0.050 | +1647.71€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5549 | +0.050 | +1647.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1064 | -0.028 | +188.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1064 | -0.028 | +188.55€ | 1 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1051 | -0.008 | +105.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1051 | -0.008 | +105.89€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 671 | +0.240 | +612.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 671 | +0.240 | +612.25€ | 0 | 21 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 973 | -0.019 | +12.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 973 | -0.019 | +12.33€ | 6 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 989 | +0.003 | +94.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 989 | +0.003 | +94.18€ | 3 | 2 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 801 | +0.209 | +634.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 801 | +0.209 | +634.50€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 3288 | +0.177 | +2240.65€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 3288 | +0.177 | +2240.65€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 585 | +0.195 | +431.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 585 | +0.195 | +431.43€ | 0 | 18 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 433 | +0.194 | +285.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 433 | +0.194 | +285.81€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 581 | +0.202 | +450.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 581 | +0.202 | +450.04€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 406 | +0.211 | +300.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 406 | +0.211 | +300.94€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 619 | +0.076 | +257.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 619 | +0.076 | +257.00€ | 1 | 11 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 664 | +0.197 | +515.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 664 | +0.197 | +515.43€ | 0 | 25 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 539 | +0.045 | +43.80€ | 0 | 7 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 539 | +0.045 | +43.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 97 | +0.045 | -4.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 97 | +0.045 | -4.31€ | 2 | 10 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 103 | +0.033 | -0.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 103 | +0.033 | -0.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 3835 | +0.170 | +2497.58€ | 0 | 23 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3835 | +0.170 | +2497.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 759 | +0.190 | +541.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 759 | +0.190 | +541.11€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 505 | +0.159 | +275.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 505 | +0.159 | +275.91€ | 1 | 22 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 749 | +0.219 | +622.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 749 | +0.219 | +622.60€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 346 | +0.118 | +135.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 346 | +0.118 | +135.90€ | 1 | 20 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 621 | +0.081 | +271.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 621 | +0.081 | +271.53€ | 0 | 15 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 855 | +0.199 | +650.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 855 | +0.199 | +650.55€ | 0 | 24 |
| ✅ GBM_LATE_5M | 252 | +0.079 | +60.44€ | 3 | 9 |
| ✅ GBM_LATE_5M#5min | 252 | +0.079 | +60.44€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 130 | +0.061 | +19.88€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 130 | +0.061 | +19.88€ | 0 | 6 |
| ✅ GBM_LATE_5M#ETH | 68 | +0.186 | +35.22€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 68 | +0.186 | +35.22€ | 0 | 10 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 305 | +0.044 | +8.36€ | 0 | 3 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 305 | +0.044 | +8.36€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC | 120 | +0.016 | +5.07€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#BTC#60min | 120 | +0.016 | +5.07€ | 2 | 5 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH | 69 | +0.106 | +6.60€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#ETH#60min | 69 | +0.106 | +6.60€ | 0 | 2 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL | 116 | +0.034 | -3.31€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#SOL#60min | 116 | +0.034 | -3.31€ | 1 | 5 |
| ✅ LEADLAG_BTC_XRP_15M | 54 | +0.143 | +14.10€ | 0 | 1 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 54 | +0.143 | +14.10€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 54 | +0.143 | +14.10€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 54 | +0.143 | +14.10€ | 0 | 1 |
...
| ✅ MOMENTUM_IBS_15M | 543 | +0.041 | +7.11€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 543 | +0.041 | +7.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 88 | +0.078 | +10.87€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 88 | +0.078 | +10.87€ | 0 | 4 |
| ✅ MOMENTUM_IBS_15M#BTC | 93 | +0.058 | +7.88€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 93 | +0.058 | +7.88€ | 0 | 1 |
| ✅ MOMENTUM_IBS_15M#DOGE | 86 | +0.011 | -9.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#DOGE#15min | 86 | +0.011 | -9.96€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH | 95 | +0.088 | +19.51€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 95 | +0.088 | +19.51€ | 0 | 5 |
| ✅ MOMENTUM_IBS_15M#SOL | 90 | -0.043 | -18.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 90 | -0.043 | -18.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 91 | +0.048 | -2.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 91 | +0.048 | -2.19€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 772 | -0.035 | -8.25€ | 4 | 1 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 772 | -0.035 | -8.25€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 123 | -0.052 | +12.73€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 123 | -0.052 | +12.73€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 134 | -0.059 | -13.20€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 134 | -0.059 | -13.20€ | 6 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 125 | -0.028 | +4.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 125 | -0.028 | +4.30€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 134 | +0.015 | +0.35€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 134 | +0.015 | +0.35€ | 2 | 3 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 125 | -0.059 | -5.00€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 125 | -0.059 | -5.00€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 131 | -0.026 | -7.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 131 | -0.026 | -7.42€ | 4 | 2 |
| ✅ MOMENTUM_IBS_15M_FADE | 275 | -0.092 | -28.54€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 275 | -0.092 | -28.54€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 40 | -0.071 | -3.79€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 40 | -0.071 | -3.79€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 60 | -0.048 | -3.52€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 60 | -0.048 | -3.52€ | 0 | 1 |
| ✅ MOMENTUM_IBS_15M_FADE#XRP | 53 | -0.045 | -2.84€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#XRP#15min | 53 | -0.045 | -2.84€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M | 968 | +0.000 | -0.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 968 | +0.000 | -0.56€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#XRP | 164 | -0.012 | -6.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 164 | -0.012 | -6.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 2067 | -0.068 | +32.63€ | 5 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 2067 | -0.068 | +32.63€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 308 | -0.090 | +5.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 308 | -0.090 | +5.62€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 392 | -0.058 | +82.82€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 392 | -0.058 | +82.82€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 319 | -0.076 | -22.43€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 319 | -0.076 | -22.43€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 341 | -0.092 | -36.02€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 341 | -0.092 | -36.02€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 378 | -0.032 | +6.70€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 378 | -0.032 | +6.70€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 329 | -0.068 | -4.05€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 329 | -0.068 | -4.05€ | 5 | 1 |
| ✅ MOMENTUM_IBS_5M_FADE | 1914 | +0.018 | +16.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 1914 | +0.018 | +16.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 326 | +0.006 | +3.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 326 | +0.006 | +3.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 282 | +0.046 | +8.58€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 282 | +0.046 | +8.58€ | 1 | 1 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 328 | +0.012 | +0.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 328 | +0.012 | +0.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 328 | +0.021 | +4.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 328 | +0.021 | +4.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 333 | +0.025 | +5.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 333 | +0.025 | +5.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 317 | -0.002 | -6.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 317 | -0.002 | -6.32€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 220 | +0.077 | +35.91€ | 1 | 4 |
| ✅ ORDER_FLOW_5M#5min | 84 | +0.105 | +23.32€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 353 | -0.021 | -19.16€ | 2 | 1 |
| ✅ STREAK_FADE_5M#5min | 353 | -0.021 | -19.16€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE | 90 | +0.033 | +2.64€ | 0 | 0 |
| ✅ STREAK_FADE_5M#DOGE#5min | 90 | +0.033 | +2.64€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH | 122 | -0.008 | -6.62€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH#5min | 122 | -0.008 | -6.62€ | 1 | 0 |
...
| ✅ STREAK_MOM_5M | 592 | +0.025 | +5.90€ | 1 | 0 |
| ✅ STREAK_MOM_5M#5min | 592 | +0.025 | +5.90€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 185 | +0.008 | -2.81€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 185 | +0.008 | -2.81€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 115 | -0.004 | -1.76€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 115 | -0.004 | -1.76€ | 2 | 2 |
| ✅ STREAK_MOM_5M#SOL | 154 | +0.038 | +3.43€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 154 | +0.038 | +3.43€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP | 138 | +0.057 | +7.04€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 138 | +0.057 | +7.04€ | 2 | 3 |
| ✅ STRUCT_NO_15M | 1857 | +0.016 | -3.54€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 1857 | +0.016 | -3.54€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 708 | +0.007 | -8.09€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 708 | +0.007 | -8.09€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 730 | +0.021 | +1.82€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 730 | +0.021 | +1.82€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 419 | +0.023 | +2.72€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 419 | +0.023 | +2.72€ | 2 | 0 |
| ✅ UPDOWN_GBM | 2200 | +0.024 | +137.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 958 | +0.086 | +168.54€ | 1 | 6 |
| ✅ UPDOWN_GBM#240min | 119 | +0.021 | +0.93€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 825 | -0.021 | -21.88€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 251 | -0.022 | -9.81€ | 3 | 1 |
| ✅ UPDOWN_GBM#BNB | 97 | +0.106 | +21.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 90 | +0.130 | +22.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 6 | -0.075 | -2.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 406 | +0.007 | +1.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 124 | +0.040 | -6.62€ | 2 | 6 |
| ✅ UPDOWN_GBM#BTC#240min | 36 | +0.079 | +3.29€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 143 | +0.024 | +12.28€ | 2 | 3 |
| ✅ UPDOWN_GBM#BTC#60min | 85 | -0.063 | -9.73€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 18 | -0.135 | +1.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 302 | +0.000 | -2.17€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 60 | +0.113 | +13.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 242 | -0.029 | -15.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 509 | +0.058 | +56.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 222 | +0.125 | +52.89€ | 1 | 13 |
| ✅ UPDOWN_GBM#ETH#240min | 36 | +0.053 | +0.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 134 | +0.015 | +3.63€ | 4 | 7 |
| ✅ UPDOWN_GBM#ETH#60min | 102 | +0.010 | -0.89€ | 0 | 2 |
| 🚫 UPDOWN_GBM#ETH#daily | 15 | -0.154 | -0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 395 | -0.009 | +0.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 167 | +0.015 | +1.60€ | 1 | 2 |
| ✅ UPDOWN_GBM#SOL#240min | 29 | -0.016 | -0.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 123 | -0.012 | -0.98€ | 3 | 4 |
| ✅ UPDOWN_GBM#SOL#60min | 64 | -0.015 | +0.81€ | 2 | 0 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 489 | +0.028 | +62.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 295 | +0.096 | +84.39€ | 0 | 14 |
| ✅ UPDOWN_GBM#XRP#240min | 17 | -0.112 | -2.90€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 177 | -0.070 | -18.96€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1664 | -0.047 | +176.15€ | 2 | 3 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1664 | -0.047 | +176.15€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 113 | -0.074 | -3.80€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 113 | -0.074 | -3.80€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 327 | -0.141 | -16.88€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 327 | -0.141 | -16.88€ | 3 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 534 | -0.011 | +106.40€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 534 | -0.011 | +106.40€ | 1 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 516 | -0.033 | +70.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 516 | -0.033 | +70.67€ | 3 | 0 |
...
| ✅ UPDOWN_OU_5M | 350 | -0.060 | -26.38€ | 3 | 0 |
| ✅ UPDOWN_OU_5M#5min | 350 | -0.060 | -26.38€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB | 225 | -0.002 | -10.08€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB#5min | 225 | -0.002 | -10.08€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.140) — sin ventaja clara. oversold(IBS<0.3): IC=-0.020 n=765 | neutral: IC=+0.009 n=744 | overbought(IBS>0.7): IC=+0.120 n=993
  - _Datos_: n=2684 IC=+0.043 PNL=+220.99€
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 1 celda(s) pasan gate riguroso completo de 45 evaluadas (n>=40) y 276 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.015 < 0.08 — monitorear
  - _Datos_: n=167 IC=+0.015 PNL=+1.60€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.105 n=38757 | tras_1loss IC=+0.061 n=27301 | tras_2loss IC=+0.021 n=11934/40 | gap=+0.084 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.129 n=12/60 | contraria IC=-0.043 n=12 | gap=+0.172 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar

**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  - _Umbral_: n_overlaps≥20 y IC_overlap > IC_base + 0.05
  - _Acción_: Cambiar _aplicar_kelly_compuesto: match por activo, no market_id
  - _Estado_: n_overlaps=14, boost estimado=+0.016. Necesita 6 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=102/40 IC=+0.010 PNL=-0.89€ | BTC#60min: n=85/40 IC=-0.063 PNL=-9.73€ | SOL#60min: n=64/40 IC=-0.015 PNL=+0.81€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=+0.085 n=169 | contrario_BTC IC=-0.036 n=95/40 | gap=-0.121 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2025 IC=+0.018 PNL=+102.25€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2025 IC=+0.018 PNL=+102.25€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=193 IC=+0.003 PNL=-2.85€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=193 IC=+0.003 PNL=-2.85€
...
**〰️ H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: n=117 IC=+0.063 PNL=+20.16€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=117 IC=+0.063 PNL=+20.16€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=599 IC=+0.079 PNL=+74.74€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=599 IC=+0.079 PNL=+74.74€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=87 IC=+0.017 PNL=+8.28€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=87 IC=+0.017 PNL=+8.28€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=457 IC=+0.093 PNL=+110.08€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=457 IC=+0.093 PNL=+110.08€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=295 IC=+0.035 PNL=-5.82€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=295 IC=+0.035 PNL=-5.82€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=322 IC=+0.022 PNL=+3.05€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=322 IC=+0.022 PNL=+3.05€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=969 IC=+0.021 PNL=+24.66€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=969 IC=+0.021 PNL=+24.66€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.153 > 0.1 con n=554 PNL=+171.60€
  - _Datos_: n=554 IC=+0.153 PNL=+171.60€
...
**🟡 H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.104 > 0.1 con n=167 PNL=+50.37€
  - _Datos_: n=167 IC=+0.104 PNL=+50.37€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1330 IC=-0.148 PNL=+60.00€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1330 IC=-0.148 PNL=+60.00€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=314 IC=+0.146 PNL=+107.13€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=314 IC=+0.146 PNL=+107.13€
...
**⏳ H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: 53/289 ops en el filtro definido (IC actual=-0.318 PNL=-19.25€)
  - _Datos_: n=53 IC=-0.318 PNL=-19.25€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=804 IC=+0.158 PNL=+430.20€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=804 IC=+0.158 PNL=+430.20€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=337 IC=-0.002 PNL=+22.86€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=337 IC=-0.002 PNL=+22.86€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.206 > 0.08 con n=277 PNL=+158.05€
  - _Datos_: n=277 IC=+0.206 PNL=+158.05€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=556 IC=+0.029 PNL=+150.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=556 IC=+0.029 PNL=+150.97€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.246 > 0.08 con n=652 PNL=-69.89€
  - _Datos_: n=652 IC=+0.246 PNL=-69.89€
...
**🟡 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.386 > 0.08 con n=42 PNL=+38.33€
  - _Datos_: n=42 IC=+0.386 PNL=+38.33€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1116 IC=+0.098 PNL=-251.76€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1116 IC=+0.098 PNL=-251.76€
