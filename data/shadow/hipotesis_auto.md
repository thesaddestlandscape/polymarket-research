# Hipótesis automáticas — 2026-09-24 05:32 UTC
_Generado por shadow_postmortem.py sobre 584485 resoluciones (PNL=+65442.31€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.120 (n=472)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.120 (n=472)

  - _Acción_: Kelly boost +0.60€ cuando `py_entrada` < 0.495 (IC base=+0.046)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.134 (n=170)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.113 (n=344)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.94` → IC=-0.235 (n=6983)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.94
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=20956)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `138.46` → IC=-0.247 (n=918)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 138.46
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2756)
...
- **FILTRO** `restante_s_al_confirmar` < `127.21` → IC=-0.305 (n=863)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.21
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2592)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `164.59` → IC=-0.227 (n=1667)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.59
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=5002)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.63` → IC=-0.357 (n=1380)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.63
  - _Potencial_: sin este filtro IC_bueno=-0.123 (n=4140)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.203 (n=13683)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=3437)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5621.0485` → IC=+0.176 (n=2191)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.137 (n=13663)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.128)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=10718)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5595)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `7788.6778` → IC=+0.175 (n=2109)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7788.6778 (IC base=+0.128)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1691)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1661)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2090)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.154 (n=2767)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 5.0 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.145 (n=2362)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.237 (n=1464)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.138 (n=650)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=531)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `1301.6177` → IC=+0.147 (n=647)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.244 (n=806)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=2691)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.179)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.185 (n=2574)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=2386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=5993)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.222)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.273 (n=2141)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=6104)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.220 (n=2299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.220)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=2084)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4815` → IC=+0.121 (n=7907)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.4815 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9836` → IC=+0.243 (n=2636)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9836 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.846` → IC=+0.249 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.846 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.6345` → IC=+0.248 (n=2220)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6345 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.958` → IC=+0.177 (n=3039)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.958 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.2107` → IC=+0.247 (n=2128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2107 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0478` → IC=+0.257 (n=965)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9075` → IC=+0.205 (n=3601)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9075 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.133 (n=9537)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.57 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.613` → IC=+0.192 (n=699)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.613 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.173 (n=3018)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.180 (n=1465)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6986 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `1.0532` → IC=+0.175 (n=1509)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0532 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.1675` → IC=+0.222 (n=1589)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1675 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` > `1.571` → IC=+0.201 (n=4990)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.571 (IC base=+0.065)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.211 (n=5375)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.174 (n=599)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0082 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.349` → IC=+0.166 (n=1789)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.349 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=866)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 15.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.170 (n=1201)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 11.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.269 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.136` → IC=+0.270 (n=767)
...
- **PATRÓN** `ibs_20min` < `0.0542` → IC=+0.294 (n=591)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.424` → IC=+0.248 (n=1395)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.424 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` < `0.0922` → IC=+0.231 (n=1148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0922 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.264 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2757 (IC base=+0.235)

- **PATRÓN** `volumen_spike_ratio` > `2.6417` → IC=+0.243 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6417 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1799.7248` → IC=+0.238 (n=894)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1799.7248 (IC base=+0.235)
...
- **PATRÓN** `dist_vwap_pct` < `0.5863` → IC=+0.219 (n=1423)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5863 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.856` → IC=+0.256 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.856 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` < `1.2518` → IC=+0.219 (n=1360)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2518 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `0.8719` → IC=+0.223 (n=906)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8719 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.2783` → IC=+0.237 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2783 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `1.7478` → IC=+0.218 (n=888)
...
- **PATRÓN** `libro_liquidez` > `16606.6187` → IC=+0.221 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16606.6187 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.153 (n=1417)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0056 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0755` → IC=+0.161 (n=473)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.141 (n=638)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 7.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.6911` → IC=+0.172 (n=1417)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6911 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1328` → IC=+0.158 (n=1265)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1328 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.202` → IC=+0.168 (n=227)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 11.202 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.243` → IC=+0.141 (n=1291)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.243 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.151 (n=1417)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.204 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.096` → IC=+0.173 (n=509)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.096 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.4183` → IC=+0.152 (n=1307)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4183 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.77` → IC=+0.148 (n=871)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.77 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `14056.6641` → IC=+0.144 (n=945)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 14056.6641 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `238.0` → IC=+0.161 (n=546)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=1834)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.189 (n=1566)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.199` → IC=+0.252 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.199 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.2115` → IC=+0.188 (n=1746)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2115 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.3614` → IC=+0.197 (n=232)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.3614 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.8473` → IC=+0.202 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8473 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1257)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.222 (n=1501)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0115 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.5908` → IC=+0.215 (n=1501)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.218 (n=705)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.637` → IC=+0.247 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.637 (IC base=+0.214)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7794` → IC=+0.210 (n=604)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7794 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `2.2159` → IC=+0.221 (n=914)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2159 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.223 (n=1025)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `1880.6384` → IC=+0.231 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1880.6384 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.213 (n=1156)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.160 (n=98)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=2186)
...
- **PATRÓN** `volumen_regimen` < `0.8497` → IC=+0.162 (n=546)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8497 (IC base=+0.016)

- **PATRÓN** `volumen_pendiente_norm` > `0.2266` → IC=+0.220 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2266 (IC base=+0.016)

- **PATRÓN** `volumen_spike_ratio` > `1.5219` → IC=+0.176 (n=683)
...
- **FILTRO** `ibs_20min` > `0.2568` → IC=-0.125 (n=2153)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2568
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=1061)
...
- **PATRÓN** `ibs_20min` < `0.2568` → IC=+0.127 (n=1061)
...
- **PATRÓN** `dist_vwap_pct` > `0.8772` → IC=+0.266 (n=152)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8772 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` < `0.7369` → IC=+0.248 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7369 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` > `1.0842` → IC=+0.279 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0842 (IC base=-0.024)

- **PATRÓN** `volumen_pendiente_norm` > `0.1023` → IC=+0.274 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1023 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` < `2.1643` → IC=+0.254 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1643 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` > `1.4322` → IC=+0.244 (n=634)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4322 (IC base=-0.024)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.196 (n=3310)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0097 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.475` → IC=+0.187 (n=8851)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.475 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.7692` → IC=+0.289 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7692 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.591` → IC=+0.156 (n=4684)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.591 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.247 (n=3139)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6895 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2958` → IC=+0.264 (n=837)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2958 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `1.4674` → IC=+0.241 (n=1903)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4674 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6741` → IC=+0.236 (n=1902)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6741 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.267 (n=5218)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.153 (n=3303)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5476` → IC=+0.153 (n=8706)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5476 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` < `0.2484` → IC=+0.238 (n=2755)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2484 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` < `0.7094` → IC=+0.238 (n=1279)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7094 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` > `1.2049` → IC=+0.246 (n=969)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6079` → IC=+0.254 (n=1681)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6079 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `2.3222` → IC=+0.256 (n=1731)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3222 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.262 (n=3703)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.073)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.525` → IC=-0.162 (n=521)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.525
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1751)

- **PATRÓN** `ibs_20min` > `0.8933` → IC=+0.266 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8933 (IC base=+0.046)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.782` → IC=+0.206 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.782 (IC base=+0.046)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.177 (n=286)
...
- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.177 (n=367)
...
- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.158 (n=661)
...
- **PATRÓN** `volumen_regimen` > `0.6717` → IC=+0.164 (n=811)
...
- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.220 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1614 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` > `0.611` → IC=+0.213 (n=548)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4496` → IC=+0.224 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4496 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` > `2.1657` → IC=+0.239 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1657 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `476.0` → IC=+0.214 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 476.0 (IC base=+0.004)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=1643)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.244)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.247 (n=1393)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.244)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.298 (n=836)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.244)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.741` → IC=+0.280 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.741 (IC base=+0.244)

- **PATRÓN** `volumen_pendiente_norm` < `0.1373` → IC=+0.256 (n=1392)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1373 (IC base=+0.244)

- **PATRÓN** `volumen_spike_ratio` > `3.4394` → IC=+0.260 (n=493)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4394 (IC base=+0.244)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.253 (n=1112)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1955.02` → IC=+0.250 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1955.02 (IC base=+0.244)

- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.317 (n=566)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.6002` → IC=+0.284 (n=1247)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2222` → IC=+0.290 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2222 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.841` → IC=+0.300 (n=492)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5974` → IC=+0.288 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5974 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.751` → IC=+0.284 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.751 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.292 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1934.061` → IC=+0.304 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1934.061 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.286 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2838` → IC=-0.184 (n=483)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2838
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1451)

- **FILTRO** `ibs_20min` > `0.7753` → IC=-0.184 (n=586)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7753
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=1761)
...
- **PATRÓN** `dist_vwap_pct` < `0.6852` → IC=+0.197 (n=480)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.6852 (IC base=-0.006)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.206 (n=416)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8285` → IC=+0.257 (n=249)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.573` → IC=+0.160 (n=333)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 9.573 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.8696` → IC=+0.301 (n=515)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8696 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `0.7299` → IC=+0.293 (n=689)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7299 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` < `0.1022` → IC=+0.292 (n=715)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0975` → IC=+0.206 (n=509)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4844` → IC=+0.218 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4844 (IC base=+0.015)

- **PATRÓN** `volumen_spike_ratio` > `1.5778` → IC=+0.198 (n=461)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.5778 (IC base=+0.015)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.234 (n=464)
...
- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.295 (n=927)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.273 (n=689)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.395` → IC=+0.305 (n=1390)
...
- **PATRÓN** `dist_vwap_pct` < `0.9682` → IC=+0.272 (n=1568)
...
- **PATRÓN** `volumen_regimen` > `1.2434` → IC=+0.305 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2434 (IC base=+0.271)

- **PATRÓN** `volumen_pendiente_norm` > `0.2384` → IC=+0.338 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2384 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` < `1.434` → IC=+0.268 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.434 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1556` → IC=+0.276 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1556 (IC base=+0.271)

- **PATRÓN** `libro_liquidez` > `2614.9946` → IC=+0.276 (n=927)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2614.9946 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2585)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.200 (n=2576)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.189 (n=439)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.193 (n=881)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.137` → IC=+0.310 (n=592)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.137 (IC base=+0.181)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.251 (n=475)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.239)

- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.265 (n=959)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.224` → IC=+0.252 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.224 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` < `0.096` → IC=+0.235 (n=797)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.096 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.261 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2827 (IC base=+0.239)

- **PATRÓN** `volumen_spike_ratio` < `1.4205` → IC=+0.264 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4205 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `1803.42` → IC=+0.247 (n=639)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=1207)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4061` → IC=+0.225 (n=1148)
...
- **PATRÓN** `volumen_regimen` < `1.2593` → IC=+0.164 (n=1148)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2593 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `0.876` → IC=+0.165 (n=765)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.876 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2817` → IC=+0.202 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2817 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `1.5013` → IC=+0.185 (n=490)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.5013 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `15909.7981` → IC=+0.162 (n=521)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 15909.7981 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.159 (n=1259)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0057 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.2908` → IC=+0.161 (n=1258)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5649` → IC=+0.187 (n=1258)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5649 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1345` → IC=+0.163 (n=1245)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1345 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.777` → IC=+0.201 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.777 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.158 (n=1258)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.2113 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1572` → IC=+0.152 (n=383)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.1572 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4267` → IC=+0.147 (n=1147)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.863` → IC=+0.278 (n=403)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8516` → IC=+0.207 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8516 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `1955.62` → IC=+0.199 (n=433)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 1955.62 (IC base=+0.197)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.231 (n=1076)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.2407` → IC=+0.257 (n=946)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2407 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.270 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.748 (IC base=+0.220)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7801` → IC=+0.218 (n=438)
...
- **PATRÓN** `libro_liquidez` > `1882.9554` → IC=+0.225 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1882.9554 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.218 (n=339)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.159 (n=1234)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4324 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.379` → IC=+0.197 (n=1234)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.379 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1614` → IC=+0.180 (n=820)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1614 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.953` → IC=+0.230 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.953 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.0413` → IC=+0.144 (n=1086)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0413 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6274` → IC=+0.148 (n=1234)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4216` → IC=+0.152 (n=403)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4216 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `2.5292` → IC=+0.167 (n=403)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.5292 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6581.0543` → IC=+0.185 (n=823)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6581.0543 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.145 (n=1171)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 164.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.154 (n=1308)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.143 (n=1308)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6381` → IC=+0.171 (n=1308)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6381 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3632` → IC=+0.137 (n=1413)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.3632 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.91` → IC=+0.171 (n=457)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.91 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8485` → IC=+0.148 (n=872)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8485 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.198 (n=190)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.789` → IC=+0.135 (n=792)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.789 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4874` → IC=+0.133 (n=396)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.4874 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `10015.5876` → IC=+0.159 (n=593)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1433)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.210 (n=1420)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `1.0011` → IC=+0.144 (n=186)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 1.0011 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.1996` → IC=+0.138 (n=1309)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1996 (IC base=+0.113)
...
- **PATRÓN** `volumen_regimen` < `1.1736` → IC=+0.121 (n=1420)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.1736 (IC base=+0.113)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4542` → IC=+0.129 (n=424)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.213 (n=1134)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.204 (n=1419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2613.5209` → IC=+0.206 (n=889)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.212 (n=633)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.203)

- **PATRÓN** `ibs_20min` < `0.438` → IC=+0.245 (n=1381)
...
- **PATRÓN** `volumen_regimen` > `0.6291` → IC=+0.216 (n=1381)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6291 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2833` → IC=+0.289 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2833 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `2.2183` → IC=+0.194 (n=1091)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2183 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4377` → IC=+0.198 (n=1239)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4377 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2587.1246` → IC=+0.205 (n=921)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2587.1246 (IC base=+0.203)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.162 (n=611)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.5505` → IC=+0.188 (n=1633)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5505 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.8753` → IC=+0.191 (n=286)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.8753 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.176 (n=842)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8743` → IC=+0.163 (n=1069)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8743 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.206` → IC=+0.151 (n=534)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.206 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.179 (n=509)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4378` → IC=+0.169 (n=587)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4378 (IC base=+0.146)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2072)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12351.8233` → IC=+0.156 (n=609)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12351.8233 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.166 (n=1607)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 162.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.138 (n=1283)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6012` → IC=+0.181 (n=540)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6012 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.307` → IC=+0.154 (n=652)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.307 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.351` → IC=+0.158 (n=238)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.351 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.137 (n=613)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.2046 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.0598` → IC=+0.164 (n=278)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.0598 (IC base=+0.135)
...
- **PATRÓN** `ibs_20min` < `0.0816` → IC=+0.156 (n=178)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.0816 (IC base=+0.089)

- **PATRÓN** `volumen_pendiente_norm` > `0.1667` → IC=+0.122 (n=125)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.1667 (IC base=+0.089)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `ibs_20min` > `0.5192` → IC=-0.159 (n=127)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5192
  - _Potencial_: sin este filtro IC_bueno=+0.142 (n=384)

- **FILTRO** `dist_vwap_pct` > `0.3429` → IC=-0.167 (n=34)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3429
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=477)
...
- **PATRÓN** `ibs_20min` < `0.5192` → IC=+0.142 (n=384)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.5192 (IC base=+0.067)

- **PATRÓN** `volumen_spike_ratio` < `1.8504` → IC=+0.141 (n=240)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.8504 (IC base=+0.067)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.206 (n=3292)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=10259)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=9877)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.9754` → IC=+0.206 (n=1381)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9754 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.842` → IC=+0.234 (n=3645)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.842 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8811` → IC=+0.165 (n=4397)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8811 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2394` → IC=+0.200 (n=1848)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2394 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.5999` → IC=+0.187 (n=3160)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.5999 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2342.8724` → IC=+0.172 (n=6579)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.8724 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.194 (n=7493)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 87.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=5971)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1471` → IC=+0.189 (n=3939)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `drift_60min` |x|≤ `0.3541` → IC=+0.190 (n=1677)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.3541 (IC base=+0.189)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.200 (n=807)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.197 (n=1135)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.539` → IC=+0.345 (n=379)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5488` → IC=+0.182 (n=696)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5488 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.5711` → IC=+0.201 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5711 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=1008)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.260 (n=1306)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.259)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.264 (n=1169)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.1279` → IC=+0.287 (n=575)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.260 (n=1191)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.3469` → IC=+0.291 (n=1150)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3469 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.563` → IC=+0.265 (n=1311)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8671` → IC=+0.274 (n=798)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8671 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1799.58` → IC=+0.265 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1799.58 (IC base=+0.259)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.193 (n=526)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0028 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.0845` → IC=+0.161 (n=526)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0845 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1643)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3086` → IC=+0.203 (n=1578)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.169 (n=363)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.235` → IC=+0.153 (n=1415)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.235 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.629` → IC=+0.180 (n=526)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.629 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2669` → IC=+0.203 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2669 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.1149` → IC=+0.163 (n=1340)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.1149 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.403` → IC=+0.154 (n=1523)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.403 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `15716.8827` → IC=+0.157 (n=716)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 15716.8827 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `477.0` → IC=+0.159 (n=1454)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 477.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1367)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3224` → IC=+0.163 (n=1367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.152 (n=621)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.6522` → IC=+0.194 (n=1367)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.6522 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1343` → IC=+0.167 (n=1235)
...
- **PATRÓN** `volumen_regimen` < `1.1894` → IC=+0.164 (n=1367)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1894 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1514` → IC=+0.197 (n=368)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1514 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.160 (n=1269)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.162 (n=846)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `423.0` → IC=+0.159 (n=1032)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7544` → IC=+0.234 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7544 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.1892` → IC=+0.237 (n=910)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1892 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.245 (n=1015)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1880.6384` → IC=+0.250 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1880.6384 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.232 (n=1281)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4371` → IC=+0.144 (n=1681)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4371 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1752)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.877` → IC=+0.261 (n=762)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.877 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.3732` → IC=+0.165 (n=663)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.3732 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.195` → IC=+0.160 (n=701)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.195 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8764` → IC=+0.154 (n=1121)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8764 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2368` → IC=+0.214 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2368 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.5214` → IC=+0.149 (n=716)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5214 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.7649` → IC=+0.146 (n=1084)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7649 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8061.7093` → IC=+0.230 (n=762)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8061.7093 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.145 (n=519)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 79.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.157 (n=1375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0076 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4461` → IC=+0.154 (n=1375)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.143 (n=632)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 7.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` < `0.7033` → IC=+0.181 (n=1375)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.7033 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.6016` → IC=+0.143 (n=1521)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.6016 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.14` → IC=+0.180 (n=201)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 11.14 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.6962` → IC=+0.149 (n=605)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6962 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `1.1921` → IC=+0.141 (n=458)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.1921 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2875` → IC=+0.239 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2875 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.444` → IC=+0.150 (n=1302)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.444 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `10927.5954` → IC=+0.209 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10927.5954 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.145 (n=1301)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 179.0 (IC base=+0.137)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.136 (n=1110)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0081 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1703)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.4717` → IC=+0.192 (n=1665)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.4717 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.0792` → IC=+0.202 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0792 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.432` → IC=+0.233 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.432 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.8919` → IC=+0.135 (n=1111)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8919 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.5687` → IC=+0.120 (n=712)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 1.5687 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1677)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2904.4304` → IC=+0.250 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2904.4304 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.132 (n=1280)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 54.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.175 (n=545)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=1683)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.203 (n=1634)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.2197` → IC=+0.129 (n=1333)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2197 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.46` → IC=+0.123 (n=1577)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.46 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.151 (n=720)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.72 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2239` → IC=+0.167 (n=253)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2239 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4488` → IC=+0.137 (n=491)
...
- **PATRÓN** `volumen_regimen` < `1.0718` → IC=+0.210 (n=1472)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0718 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `0.637` → IC=+0.215 (n=1672)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.637 (IC base=+0.208)

- **PATRÓN** `volumen_pendiente_norm` > `0.2344` → IC=+0.248 (n=292)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.216 (n=1758)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `2621.5822` → IC=+0.220 (n=1115)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2621.5822 (IC base=+0.208)

- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.226 (n=596)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0089 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.217 (n=596)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.5183` → IC=+0.255 (n=1787)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5183 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.2377` → IC=+0.200 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2377 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.918` → IC=+0.203 (n=1990)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.918 (IC base=+0.200)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.138 (n=2971)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.158 (n=2496)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0092 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.150 (n=2533)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5211` → IC=+0.158 (n=2836)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.165 (n=1281)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.1866` → IC=+0.156 (n=1033)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1866 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4925` → IC=+0.144 (n=1710)
...
- **PATRÓN** `volumen_regimen` > `0.9007` → IC=+0.159 (n=1216)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.9007 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1721` → IC=+0.184 (n=774)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8835` → IC=+0.162 (n=1867)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8835 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3726.3592` → IC=+0.152 (n=1890)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4865` → IC=+0.155 (n=2240)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4865 (IC base=+0.137)
...
- **PATRÓN** `ibs_20min` < `0.184` → IC=+0.167 (n=986)
...
- **PATRÓN** `dist_vwap_pct` < `0.4314` → IC=+0.129 (n=2216)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4314 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.241` → IC=+0.145 (n=2230)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.241 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2464` → IC=+0.142 (n=2138)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2464 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0726` → IC=+0.145 (n=1036)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0726 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5352` → IC=+0.148 (n=973)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5352 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.8143` → IC=+0.141 (n=1474)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8143 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.138 (n=2971)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `7032.9879` → IC=+0.150 (n=2001)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1563` → IC=+0.182 (n=328)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.1563 (IC base=+0.138)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.247` → IC=+0.181 (n=45)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 9.247 (IC base=+0.085)
...
- **PATRÓN** `libro_liquidez` > `3417.5406` → IC=+0.131 (n=193)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 3417.5406 (IC base=+0.085)

- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.211 (n=95)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0119 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.3981` → IC=+0.155 (n=140)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3981 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.162 (n=143)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 10.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.1429` → IC=+0.208 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1429 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.6189` → IC=+0.183 (n=99)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.6189 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.699` → IC=+0.139 (n=117)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 2.699 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` < `0.0898` → IC=+0.167 (n=160)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.0898 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.6212` → IC=+0.130 (n=90)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.6212 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3279.9138` → IC=+0.146 (n=210)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 3279.9138 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.157 (n=199)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 61.0 (IC base=+0.112)

### GBM_LATE_60M
- **FILTRO** `sigma_h` > `0.0067` → IC=-0.211 (n=119)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0067
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=360)

- **FILTRO** `dist_vwap_pct` > `0.1862` → IC=-0.179 (n=26)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.1862
  - _Potencial_: sin este filtro IC_bueno=+0.120 (n=311)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.196 (n=396)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.6774` → IC=+0.206 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6774 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.1513` → IC=+0.161 (n=437)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1513 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.443` → IC=+0.210 (n=188)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0809` → IC=+0.139 (n=610)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.0809 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=650)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2418.9216` → IC=+0.147 (n=355)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2418.9216 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.0508` → IC=+0.264 (n=125)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1755` → IC=+0.135 (n=198)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.1755 (IC base=+0.003)

- **PATRÓN** `volumen_spike_ratio` > `1.437` → IC=+0.131 (n=201)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.437 (IC base=+0.003)
...
- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.175 (n=229)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.379` → IC=+0.180 (n=101)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 5.379 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` > `1.0639` → IC=+0.159 (n=86)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.0639 (IC base=+0.074)

- **PATRÓN** `volumen_pendiente_norm` > `0.2436` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.2436 (IC base=+0.074)
...
### GBM_LATE_60M_FADE
- **FILTRO** `sigma_h` < `0.0032` → IC=-0.291 (n=65)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=133)
...
- **FILTRO** `dist_vwap_pct` > `0.2352` → IC=-0.333 (n=16)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.212 (n=182)

- **FILTRO** `volumen_regimen` < `0.7506` → IC=-0.351 (n=65)

  - _Acción_: SKIP cuando `volumen_regimen` < 0.7506
  - _Potencial_: sin este filtro IC_bueno=-0.159 (n=133)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=345)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.210 (n=122)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=290)

- **FILTRO** `restante_min` < `3.31` → IC=-0.148 (n=103)

  - _Acción_: SKIP cuando `restante_min` < 3.31
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=309)

- **FILTRO** `hora_utc` < `7.0` → IC=-0.188 (n=91)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `py_entrada` < `0.56` → IC=-0.152 (n=21)
...
- **FILTRO** `profundidad_ratio` < `45.4` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `profundidad_ratio` < 45.4
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=17)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=7460)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.167 (n=3458)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10406)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.167 (n=3590)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=10777)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.153 (n=632)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1941)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.190 (n=611)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1837)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=630)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1939)

- **FILTRO** `ibs_20min` > `0.2814` → IC=-0.162 (n=642)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2814
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1927)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.171 (n=591)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1799)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.177 (n=629)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9846)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=21964)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7766)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=24044)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.235 (n=7942)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=23868)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10813)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=20997)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9791)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=30067)

- **FILTRO** `ibs_7min` > `0.2932` → IC=-0.178 (n=9964)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2932
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=29894)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1251)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4000)

- **FILTRO** `ibs_7min` < `0.7104` → IC=-0.250 (n=1732)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7104
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3519)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.185 (n=1208)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=4043)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1693)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5156)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.124 (n=2325)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4524)

- **FILTRO** `ibs_7min` > `0.789` → IC=-0.205 (n=1712)

  - _Acción_: SKIP cuando `ibs_7min` > 0.789
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=5137)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1295)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4202)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.249 (n=1324)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4173)

- **FILTRO** `ibs_7min` < `0.7482` → IC=-0.191 (n=1373)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7482
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4124)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.172 (n=1374)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4123)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1388)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=4186)

- **FILTRO** `ibs_7min` > `0.2601` → IC=-0.175 (n=1393)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2601
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4181)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.182 (n=1391)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4183)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1418)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3562)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1219)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3761)

- **FILTRO** `ibs_7min` < `0.1944` → IC=-0.257 (n=1245)
...
- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1160)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3820)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.236 (n=1677)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5649)

- **FILTRO** `ibs_7min` > `0.7474` → IC=-0.176 (n=1831)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7474
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=5495)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.231 (n=1550)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3697)

- **FILTRO** `ibs_7min` < `0.7412` → IC=-0.182 (n=1311)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7412
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3936)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.170 (n=1293)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3954)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1336)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4015)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.176 (n=1337)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4014)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.186 (n=1325)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4026)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.259 (n=1348)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4211)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1385)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4174)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1809)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5768)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1699)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=3577)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1305)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3971)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1283)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3993)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1723)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5458)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1125)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=765)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=771)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=714)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2869)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=590)
...
- **FILTRO** `dist_vwap_pct` > `0.5705` → IC=-0.135 (n=124)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=891)
...
- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.155 (n=468)
...
- **FILTRO** `sigma_h` > `0.0131` → IC=-0.220 (n=648)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0131
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1948)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.190 (n=876)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1195` → IC=+0.243 (n=1134)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1195 (IC base=-0.034)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1772` → IC=+0.236 (n=1099)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1772 (IC base=-0.034)

- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.276 (n=1702)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3469 (IC base=-0.034)

- **PATRÓN** `dist_vwap_pct` > `0.9657` → IC=+0.292 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9657 (IC base=-0.034)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.220 (n=394)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1186)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.231 (n=395)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1185)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=999)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.177 (n=581)

- **FILTRO** `sigma_ewma_delta_pct` > `19.708` → IC=-0.241 (n=284)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.708
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1296)
...
- **PATRÓN** `drift_15min` |x|≤ `0.7857` → IC=+0.231 (n=590)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7857 (IC base=+0.224)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2029` → IC=+0.255 (n=304)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.239 (n=301)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.224)

- **PATRÓN** `ibs_15` < `0.3453` → IC=+0.263 (n=670)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.251` → IC=+0.247 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 20.251 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.221` → IC=+0.229 (n=715)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.221 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `3551.8492` → IC=+0.225 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3551.8492 (IC base=+0.224)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `drift_60min` |x|> `0.1657` → IC=-0.219 (n=208)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.046 a +0.155 en UPDOWN_GBM#XRP#15min (n=468). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3469 sube el IC de -0.034 a +0.276 en UPDOWN_GBM_15M_TARDIO (n=1702). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3453 sube el IC de +0.224 a +0.263 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=670). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3437 sube el IC de -0.045 a +0.306 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=457). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1309 | +0.098 | +192.94€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1309 | +0.098 | +192.94€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 975 | +0.108 | +167.02€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 975 | +0.108 | +167.02€ | 2 | 8 |
...
| ✅ BALLENAS_TARDIAS | 24858 | -0.092 | -3183.37€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1436 | -0.048 | -223.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 23422 | -0.095 | -2959.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3674 | -0.092 | -599.58€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3674 | -0.092 | -599.58€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7185 | -0.024 | -667.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7185 | -0.024 | -667.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6669 | -0.098 | -451.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6669 | -0.098 | -451.37€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5520 | -0.182 | -1080.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5520 | -0.182 | -1080.27€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17722 | -0.028 | +4070.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4632 | +0.000 | +1830.67€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 13090 | -0.038 | +2239.87€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 17722 | -0.028 | +4070.54€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4632 | +0.000 | +1830.67€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 13090 | -0.038 | +2239.87€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 91377 | +0.112 | -4684.95€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13835 | +0.185 | -439.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 367 | -0.088 | -51.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 71212 | +0.100 | -3976.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5963 | +0.108 | -217.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11845 | +0.098 | -1004.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 45 | -0.160 | -0.32€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11785 | +0.100 | -992.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18483 | +0.131 | -377.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4351 | +0.203 | -137.87€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11805 | +0.111 | -189.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2285 | +0.105 | -28.03€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11886 | +0.088 | -1121.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 52 | -0.093 | -6.98€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11819 | +0.090 | -1102.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19451 | +0.123 | -421.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5350 | +0.175 | -86.88€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11931 | +0.104 | -271.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2158 | +0.098 | -54.95€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17852 | +0.114 | -1057.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3991 | +0.188 | -217.00€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 270 | -0.048 | +2.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12071 | +0.091 | -708.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1520 | +0.126 | -134.82€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11860 | +0.101 | -702.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 46 | -0.021 | +9.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11801 | +0.101 | -711.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14499 | +0.191 | -956.56€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14499 | +0.191 | -956.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3461 | +0.168 | -363.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3461 | +0.168 | -363.79€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1177 | +0.194 | -11.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1177 | +0.194 | -11.91€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3406 | +0.179 | -296.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3406 | +0.179 | -296.74€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3034 | +0.239 | -96.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3034 | +0.239 | -96.46€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3342 | +0.193 | -201.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3342 | +0.193 | -201.42€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 49892 | +0.196 | -3985.06€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 49892 | +0.196 | -3985.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8638 | +0.175 | -1015.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8638 | +0.175 | -1015.53€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7963 | +0.222 | -309.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7963 | +0.222 | -309.55€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8616 | +0.171 | -1052.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8616 | +0.171 | -1052.46€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 8064 | +0.218 | -324.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 8064 | +0.218 | -324.52€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8243 | +0.203 | -551.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8243 | +0.203 | -551.35€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8368 | +0.193 | -731.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8368 | +0.193 | -731.65€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 18804 | +0.119 | +188.51€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 18804 | +0.119 | +188.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9336 | +0.123 | +161.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9336 | +0.123 | +161.00€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9468 | +0.114 | +27.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9468 | +0.114 | +27.51€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1092 | +0.075 | -42.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 379 | +0.062 | -29.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 713 | +0.082 | -13.27€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 861 | +0.082 | -17.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 148 | +0.080 | -3.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 713 | +0.082 | -13.27€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 34755 | +0.097 | -1091.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2875 | +0.090 | +24.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 31880 | +0.097 | -1115.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 19539 | +0.101 | -323.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2875 | +0.090 | +24.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 16664 | +0.103 | -348.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6500 | +0.107 | -41.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6500 | +0.107 | -41.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8716 | +0.080 | -725.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8716 | +0.080 | -725.31€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 24989 | +0.082 | +11804.27€ | 0 | 17 |
| ✅ GBM_LATE_15M#15min | 24989 | +0.082 | +11804.27€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4172 | +0.193 | +3025.29€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4172 | +0.193 | +3025.29€ | 0 | 19 |
| ✅ GBM_LATE_15M#BTC | 3701 | +0.177 | +2562.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3701 | +0.177 | +2562.00€ | 0 | 27 |
| ✅ GBM_LATE_15M#DOGE | 4333 | +0.199 | +3235.29€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4333 | +0.199 | +3235.29€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3697 | +0.018 | +767.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3697 | +0.018 | +767.69€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3591 | -0.033 | +821.15€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3591 | -0.033 | +821.15€ | 4 | 14 |
| ✅ GBM_LATE_15M#XRP | 5495 | -0.041 | +1392.85€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5495 | -0.041 | +1392.85€ | 4 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 26392 | +0.085 | +13744.51€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 26392 | +0.085 | +13744.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4999 | +0.017 | +2651.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4999 | +0.017 | +2651.43€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5497 | +0.014 | +1130.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5497 | +0.014 | +1130.81€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3749 | +0.261 | +3761.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3749 | +0.261 | +3761.70€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4281 | +0.001 | +795.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4281 | +0.001 | +795.18€ | 2 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4296 | +0.028 | +1619.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4296 | +0.028 | +1619.37€ | 3 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3570 | +0.274 | +3786.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3570 | +0.274 | +3786.03€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 20159 | +0.167 | +15010.17€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 20159 | +0.167 | +15010.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 3034 | +0.205 | +2398.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 3034 | +0.205 | +2398.39€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3207 | +0.149 | +2353.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3207 | +0.149 | +2353.07€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3162 | +0.207 | +2507.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3162 | +0.207 | +2507.34€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3388 | +0.133 | +2349.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3388 | +0.133 | +2349.73€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3749 | +0.116 | +2558.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3749 | +0.116 | +2558.69€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3619 | +0.203 | +2842.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3619 | +0.203 | +2842.95€ | 0 | 26 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4999 | +0.126 | +2072.27€ | 0 | 20 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4999 | +0.126 | +2072.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 185 | +0.120 | +80.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 185 | +0.120 | +80.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1427 | +0.122 | +636.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1427 | +0.122 | +636.30€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 373 | +0.143 | +176.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 373 | +0.143 | +176.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1464 | +0.142 | +638.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1464 | +0.142 | +638.74€ | 0 | 16 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1046 | +0.100 | +323.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1046 | +0.100 | +323.03€ | 2 | 13 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 504 | +0.134 | +216.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 504 | +0.134 | +216.54€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 25093 | +0.175 | +18608.52€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#15min | 25093 | +0.175 | +18608.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3976 | +0.220 | +3345.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3976 | +0.220 | +3345.69€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3925 | +0.150 | +2599.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3925 | +0.150 | +2599.48€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4112 | +0.225 | +3539.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4112 | +0.225 | +3539.19€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 4073 | +0.136 | +2756.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 4073 | +0.136 | +2756.86€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4396 | +0.112 | +2762.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4396 | +0.112 | +2762.06€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4611 | +0.204 | +3605.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4611 | +0.204 | +3605.24€ | 0 | 24 |
| ✅ GBM_LATE_5M | 6766 | +0.144 | +3775.79€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 6766 | +0.144 | +3775.79€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#SOL | 566 | +0.099 | +189.51€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 566 | +0.099 | +189.51€ | 0 | 14 |
| ✅ GBM_LATE_5M#XRP | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 819 | +0.115 | +316.33€ | 0 | 0 |
| ✅ GBM_LATE_60M | 1675 | +0.070 | +734.00€ | 2 | 13 |
| ✅ GBM_LATE_60M#60min | 1675 | +0.070 | +734.00€ | 0 | 0 |
...
| ✅ GBM_LATE_60M#SOL | 515 | +0.042 | +186.75€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 515 | +0.042 | +186.75€ | 1 | 11 |
| 🚫 GBM_LATE_60M_FADE | 367 | -0.259 | -27.07€ | 8 | 0 |
| 🚫 GBM_LATE_60M_FADE#60min | 367 | -0.259 | -27.07€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1888 | +0.097 | +502.38€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1888 | +0.097 | +502.38€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1888 | +0.097 | +502.38€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1888 | +0.097 | +502.38€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_60M | 1064 | -0.046 | -29.10€ | 6 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 1064 | -0.046 | -29.10€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 834 | -0.029 | +2.36€ | 3 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 385 | -0.022 | +7.00€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 449 | -0.034 | -4.65€ | 0 | 0 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC | 213 | +0.072 | +50.40€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#15min | 96 | +0.051 | +16.60€ | 0 | 5 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#5min | 117 | +0.088 | +33.80€ | 0 | 7 |
...
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH | 137 | -0.083 | -15.62€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#15min | 61 | -0.087 | -7.86€ | 4 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#5min | 76 | -0.077 | -7.76€ | 3 | 1 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL | 128 | -0.031 | -2.81€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#15min | 67 | -0.022 | +2.34€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#5min | 61 | -0.040 | -5.15€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP | 197 | -0.063 | -15.41€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#15min | 85 | -0.052 | -4.22€ | 2 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#5min | 112 | -0.070 | -11.19€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M | 14324 | -0.011 | -203.39€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14324 | -0.011 | -203.39€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 3041 | -0.020 | -56.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 3041 | -0.020 | -56.57€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 28231 | -0.007 | +1256.12€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 28231 | -0.007 | +1256.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4977 | +0.016 | +604.48€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4977 | +0.016 | +604.48€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4387 | -0.028 | -48.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4387 | -0.028 | -48.30€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 5017 | +0.014 | +456.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 5017 | +0.014 | +456.36€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4168 | -0.052 | -147.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4168 | -0.052 | -147.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4721 | -0.011 | +175.18€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4721 | -0.011 | +175.18€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4961 | +0.007 | +215.49€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4961 | +0.007 | +215.49€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5765 | -0.056 | -127.37€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5765 | -0.056 | -127.37€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 615 | -0.113 | -17.77€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 615 | -0.113 | -17.77€ | 3 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 71668 | -0.072 | +1781.76€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 71668 | -0.072 | +1781.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 12100 | -0.079 | +716.27€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 12100 | -0.079 | +716.27€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 11071 | -0.092 | -455.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 11071 | -0.092 | -455.22€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 12306 | -0.067 | +701.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 12306 | -0.067 | +701.59€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10598 | -0.092 | -151.35€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10598 | -0.092 | -151.35€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 13136 | -0.048 | +385.56€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 13136 | -0.048 | +385.56€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 12457 | -0.062 | +584.91€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 12457 | -0.062 | +584.91€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7543 | -0.023 | -115.23€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7543 | -0.023 | -115.23€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 2113 | -0.018 | -22.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 2113 | -0.018 | -22.85€ | 1 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO | 459 | -0.062 | -56.38€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#5min | 459 | -0.062 | -56.38€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO#ETH | 134 | -0.081 | -26.06€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#ETH#5min | 134 | -0.081 | -26.06€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 2743 | -0.022 | -111.10€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2743 | -0.022 | -111.10€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1216 | -0.020 | -45.94€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1216 | -0.020 | -45.94€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 7666 | +0.023 | +113.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7666 | +0.023 | +113.27€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2133 | +0.021 | +20.85€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2133 | +0.021 | +20.85€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1712 | +0.036 | +52.61€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1712 | +0.036 | +52.61€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2326 | +0.012 | +2.57€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2326 | +0.012 | +2.57€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1495 | +0.029 | +37.25€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1495 | +0.029 | +37.25€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7190 | +0.011 | -44.35€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7190 | +0.011 | -44.35€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2888 | +0.016 | -8.78€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2888 | +0.016 | -8.78€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2810 | +0.011 | -18.78€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2810 | +0.011 | -18.78€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1492 | +0.004 | -16.78€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1492 | +0.004 | -16.78€ | 2 | 0 |
| ✅ UPDOWN_GBM | 36318 | +0.029 | +2103.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 9790 | +0.066 | +1733.40€ | 0 | 10 |
| ✅ UPDOWN_GBM#240min | 1341 | +0.004 | +6.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 22843 | +0.019 | +345.12€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2205 | +0.006 | +18.34€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3683 | +0.065 | +385.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 636 | +0.146 | +244.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 29 | -0.016 | -0.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 3018 | +0.049 | +142.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6707 | +0.035 | +454.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1238 | +0.084 | +275.13€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 364 | +0.019 | +7.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 4062 | +0.032 | +154.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 990 | +0.004 | +17.07€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 53 | -0.100 | +0.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 4223 | +0.039 | +246.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 590 | +0.139 | +207.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 27 | -0.017 | -2.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3606 | +0.023 | +41.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 7742 | +0.016 | +269.09€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2523 | +0.044 | +263.21€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 352 | +0.006 | +6.93€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 4070 | +0.005 | +0.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 752 | +0.001 | -4.90€ | 2 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 45 | -0.138 | +3.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8706 | +0.014 | +213.81€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2397 | +0.026 | +166.74€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 346 | -0.006 | -2.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5461 | +0.012 | +45.44€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 463 | +0.016 | +6.17€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 39 | -0.159 | -2.31€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5255 | +0.034 | +535.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2406 | +0.079 | +577.00€ | 0 | 12 |
| ✅ UPDOWN_GBM#XRP#240min | 223 | -0.002 | -3.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2626 | -0.005 | -38.01€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11684 | -0.040 | +2452.24€ | 2 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11684 | -0.040 | +2452.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 735 | -0.039 | +346.49€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 735 | -0.039 | +346.49€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2169 | -0.122 | +28.01€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2169 | -0.122 | +28.01€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 364 | +0.180 | +243.71€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 364 | +0.180 | +243.71€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1290 | +0.202 | +740.44€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1290 | +0.202 | +740.44€ | 2 | 22 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3555 | -0.064 | +549.44€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3555 | -0.064 | +549.44€ | 2 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3571 | -0.078 | +544.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3571 | -0.078 | +544.16€ | 3 | 4 |
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=2397 IC=+0.026 PNL=+166.74€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.103 n=300/60 | contraria IC=+0.153 n=286 | gap=-0.050 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar

**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  - _Umbral_: n_overlaps≥20 y IC_overlap > IC_base + 0.05
  - _Acción_: Cambiar _aplicar_kelly_compuesto: match por activo, no market_id
  - _Estado_: n_overlaps=281, boost estimado=+0.002. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=752/40 IC=+0.001 PNL=-4.90€ | BTC#60min: n=990/40 IC=+0.004 PNL=+17.07€ | SOL#60min: n=463/40 IC=+0.016 PNL=+6.17€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.050 n=328303 | tras_1loss IC=+0.077 n=255828 | tras_2loss IC=+0.046 n=108088/40 | gap=+0.004 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1561 IC=+0.014 PNL=+11.29€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1561 IC=+0.014 PNL=+11.29€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=644 IC=-0.014 PNL=+7.05€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=644 IC=-0.014 PNL=+7.05€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1238 IC=+0.084 PNL=+275.13€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1238 IC=+0.084 PNL=+275.13€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=12611 IC=+0.053 PNL=+1513.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=12611 IC=+0.053 PNL=+1513.69€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1852 IC=+0.046 PNL=+189.84€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1852 IC=+0.046 PNL=+189.84€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=17488 IC=-0.137 PNL=+1181.00€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=17488 IC=-0.137 PNL=+1181.00€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1889 IC=+0.139 PNL=+1030.50€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1889 IC=+0.139 PNL=+1030.50€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=3856 IC=+0.019 PNL=+119.54€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3856 IC=+0.019 PNL=+119.54€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.087 > 0.08 con n=2041 PNL=+1062.15€
  - _Datos_: n=2041 IC=+0.087 PNL=+1062.15€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.239 < -0.1 con n=1707 PNL=-189.80€
  - _Datos_: n=1707 IC=-0.239 PNL=-189.80€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.089 n=969) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=969 IC=+0.089 PNL=+217.81€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8637 IC=+0.175 PNL=-1015.72€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8637 IC=+0.175 PNL=-1015.72€
