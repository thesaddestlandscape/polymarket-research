# Hipótesis automáticas — 2026-09-17 13:55 UTC
_Generado por shadow_postmortem.py sobre 482322 resoluciones (PNL=+52027.49€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `143.98` → IC=-0.250 (n=5941)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 143.98
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=17827)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.79` → IC=-0.270 (n=818)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.79
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2457)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `491.23` → IC=-0.158 (n=317)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 491.23
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=953)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `132.07` → IC=-0.291 (n=720)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.07
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2162)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.37` → IC=-0.244 (n=1412)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.37
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4237)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `117.04` → IC=-0.367 (n=1151)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 117.04
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=3456)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.249 (n=281)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=302)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.159 (n=133)
...
- **FILTRO** `py_entrada` > `0.61` → IC=-0.148 (n=52)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=2994)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `11413.5383` → IC=+0.191 (n=955)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11413.5383 (IC base=+0.097)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.247 (n=8221)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.172 (n=5894)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7277.3676` → IC=+0.179 (n=1861)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 7277.3676 (IC base=+0.136)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1421)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=1405)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=1754)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `15184.1001` → IC=+0.221 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15184.1001 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.210 (n=1286)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.211 (n=1418)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.274 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1817)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `14954.558` → IC=+0.230 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14954.558 (IC base=+0.204)
...
- **PATRÓN** `py_entrada` < `0.435` → IC=+0.153 (n=676)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=2402)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=2253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 17.0 (IC base=+0.166)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.176 (n=2341)
...
- **PATRÓN** `py_entrada` > `0.735` → IC=+0.353 (n=304)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.735 (IC base=+0.269)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=2313)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.178)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.181 (n=2212)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 17.0 (IC base=+0.178)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.186 (n=1975)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.71 (IC base=+0.178)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.245 (n=2066)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=5171)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.191 (n=3786)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `lag_apertura_s` < `2.47` → IC=+0.150 (n=1974)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 2.47 (IC base=+0.120)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.318 (n=674)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1613.1588` → IC=+0.298 (n=954)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1613.1588 (IC base=+0.288)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.301 (n=294)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1493.0973` → IC=+0.317 (n=408)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.434 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.432)

- **PATRÓN** `libro_liquidez` > `1860.5823` → IC=+0.439 (n=375)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.435 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.435)

- **PATRÓN** `libro_liquidez` > `2103.8839` → IC=+0.456 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2103.8839 (IC base=+0.435)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.4989` → IC=+0.155 (n=5736)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.4989 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.1444` → IC=+0.245 (n=1281)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1444 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.853` → IC=+0.168 (n=2486)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.853 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.244 (n=1648)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2208 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0676` → IC=+0.240 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0676 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1746` → IC=+0.190 (n=4414)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1746 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.3068` → IC=+0.202 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3068 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.9198` → IC=+0.198 (n=2839)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.9198 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.569` → IC=+0.132 (n=7867)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.569 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` > `0.5602` → IC=+0.185 (n=471)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.5602 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` < `0.3377` → IC=+0.171 (n=2758)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.3377 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` < `0.703` → IC=+0.174 (n=1141)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.703 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` > `0.8732` → IC=+0.178 (n=1728)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.8732 (IC base=+0.061)

- **PATRÓN** `volumen_pendiente_norm` > `0.2442` → IC=+0.226 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2442 (IC base=+0.061)

- **PATRÓN** `volumen_spike_ratio` > `1.5877` → IC=+0.201 (n=3849)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5877 (IC base=+0.061)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.211 (n=4081)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.172 (n=485)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0078 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3264` → IC=+0.164 (n=1450)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.034` → IC=+0.275 (n=634)
...
- **PATRÓN** `ibs_20min` < `0.6737` → IC=+0.174 (n=1174)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6737 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1261` → IC=+0.152 (n=1073)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1261 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.45` → IC=+0.168 (n=197)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 11.45 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.2116` → IC=+0.145 (n=1174)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2116 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.853` → IC=+0.142 (n=783)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.853 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1573` → IC=+0.182 (n=316)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1573 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.4376` → IC=+0.151 (n=1065)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4376 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `13562.4111` → IC=+0.152 (n=783)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13562.4111 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `421.0` → IC=+0.148 (n=983)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 421.0 (IC base=+0.139)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.188 (n=1417)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0058 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=1491)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.505` → IC=+0.228 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.505 (IC base=+0.176)

- **PATRÓN** `volumen_pendiente_norm` < `0.1063` → IC=+0.182 (n=1203)
...
- **PATRÓN** `ibs_20min` < `0.3796` → IC=+0.234 (n=1070)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3796 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.693` → IC=+0.234 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.693 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.323` → IC=+0.219 (n=1332)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.323 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` > `0.365` → IC=+0.271 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.365 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` < `1.846` → IC=+0.209 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.846 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.3058` → IC=+0.225 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3058 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.232 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1893.56` → IC=+0.237 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1893.56 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.225 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 27.0 (IC base=+0.218)

### GBM_LATE_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1793)

- **PATRÓN** `ibs_20min` > `0.9343` → IC=+0.177 (n=295)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.396` → IC=+0.135 (n=557)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4621` → IC=+0.329 (n=226)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4621 (IC base=+0.006)
...
- **PATRÓN** `dist_vwap_pct` > `0.1669` → IC=+0.191 (n=208)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.1669 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.158 (n=264)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6973 (IC base=+0.007)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5104` → IC=+0.189 (n=490)
...
- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.129 (n=1804)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2692
  - _Potencial_: sin este filtro IC_bueno=+0.121 (n=892)

- **FILTRO** `sigma_ewma_delta_pct` > `8.635` → IC=-0.204 (n=295)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.635
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2401)
...
- **PATRÓN** `ibs_20min` < `0.2692` → IC=+0.121 (n=892)
...
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.195 (n=450)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1354)

- **FILTRO** `ibs_20min` < `0.6679` → IC=-0.161 (n=1190)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1377` → IC=+0.275 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1377 (IC base=-0.083)
...
- **PATRÓN** `dist_vwap_pct` > `1.0174` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0174 (IC base=-0.026)

- **PATRÓN** `dist_vwap_pct` < `0.2617` → IC=+0.248 (n=582)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2617 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` < `0.7351` → IC=+0.245 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7351 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` > `1.0842` → IC=+0.295 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0842 (IC base=-0.026)

- **PATRÓN** `volumen_pendiente_norm` > `0.1054` → IC=+0.273 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1054 (IC base=-0.026)

- **PATRÓN** `volumen_spike_ratio` < `2.2199` → IC=+0.260 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2199 (IC base=-0.026)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.244 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.247 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.026)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.179 (n=2680)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0092 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.4565` → IC=+0.177 (n=7172)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.4565 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.6947` → IC=+0.279 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6947 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.51` → IC=+0.145 (n=3798)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 3.51 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `0.6782` → IC=+0.238 (n=2447)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6782 (IC base=+0.087)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7613` → IC=+0.237 (n=1457)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7613 (IC base=+0.087)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.277 (n=3864)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.087)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.142 (n=2716)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0086 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.555` → IC=+0.152 (n=7171)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.555 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6725` → IC=+0.249 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6725 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1626` → IC=+0.233 (n=2109)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1626 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7156` → IC=+0.233 (n=995)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7156 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.1993` → IC=+0.253 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1993 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.2513` → IC=+0.316 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2513 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.4946` → IC=+0.254 (n=983)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4946 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.3737` → IC=+0.256 (n=1334)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3737 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.259 (n=2808)
...
- **FILTRO** `ibs_20min` < `0.2376` → IC=-0.143 (n=550)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1651)

- **FILTRO** `sigma_ewma_delta_pct` > `4.369` → IC=-0.168 (n=407)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.369
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1369)

- **PATRÓN** `ibs_20min` > `0.8687` → IC=+0.256 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8687 (IC base=+0.039)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.684` → IC=+0.187 (n=298)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 8.684 (IC base=+0.039)
...
- **FILTRO** `ibs_20min` > `0.8226` → IC=-0.146 (n=599)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8226
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1800)
...
- **PATRÓN** `dist_vwap_pct` < `0.1009` → IC=+0.211 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1009 (IC base=+0.002)

- **PATRÓN** `volumen_regimen` > `1.047` → IC=+0.218 (n=193)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1395` → IC=+0.252 (n=1117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1395 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.8778` → IC=+0.239 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8778 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `3.6288` → IC=+0.254 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6288 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.254 (n=1454)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.299 (n=1016)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.285 (n=1019)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3333 (IC base=+0.280)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.795` → IC=+0.300 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.795 (IC base=+0.280)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.588` → IC=+0.281 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.588 (IC base=+0.280)

- **PATRÓN** `volumen_pendiente_norm` > `0.3474` → IC=+0.305 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3474 (IC base=+0.280)

- **PATRÓN** `volumen_spike_ratio` < `1.6329` → IC=+0.286 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6329 (IC base=+0.280)

- **PATRÓN** `volumen_spike_ratio` > `2.2257` → IC=+0.281 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2257 (IC base=+0.280)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.289 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.280)

- **PATRÓN** `libro_liquidez` > `1881.2284` → IC=+0.306 (n=339)
...
- **FILTRO** `ibs_20min` > `0.8032` → IC=-0.185 (n=481)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=1445)

- **PATRÓN** `ibs_20min` > `0.8048` → IC=+0.150 (n=506)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.8048 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` > `0.4461` → IC=+0.218 (n=140)
...
- **PATRÓN** `volumen_regimen` < `0.9592` → IC=+0.216 (n=311)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9592 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` > `0.6214` → IC=+0.198 (n=316)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 0.6214 (IC base=-0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.2647` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2647 (IC base=-0.011)

- **PATRÓN** `volumen_spike_ratio` < `2.0696` → IC=+0.242 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0696 (IC base=-0.011)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.244 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 163.0 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` > `0.122` → IC=+0.204 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.122 (IC base=-0.015)

- **PATRÓN** `volumen_regimen` < `1.1339` → IC=+0.179 (n=260)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 1.1339 (IC base=-0.015)

- **PATRÓN** `volumen_regimen` > `0.7266` → IC=+0.184 (n=232)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.7266 (IC base=-0.015)

- **PATRÓN** `volumen_pendiente_norm` > `0.1508` → IC=+0.303 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1508 (IC base=-0.015)

- **PATRÓN** `volumen_spike_ratio` < `1.7947` → IC=+0.250 (n=146)
...
- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.252 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 146.0 (IC base=-0.015)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6757` → IC=-0.212 (n=866)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.635` → IC=-0.175 (n=426)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.635
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=1403)
...
- **PATRÓN** `volumen_regimen` < `0.8648` → IC=+0.293 (n=403)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8648 (IC base=+0.025)
...
- **PATRÓN** `ibs_20min` < `0.1071` → IC=+0.199 (n=459)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.1071 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.5842` → IC=+0.198 (n=84)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.5842 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` < `0.3939` → IC=+0.196 (n=402)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.3939 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `0.7148` → IC=+0.243 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7148 (IC base=+0.004)

- **PATRÓN** `volumen_pendiente_norm` < `0.1008` → IC=+0.193 (n=350)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` < 0.1008 (IC base=+0.004)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5876` → IC=+0.207 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5876 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.225 (n=358)
...
- **PATRÓN** `sigma_h` > `0.0145` → IC=+0.297 (n=790)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.199 (n=2112)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0106 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.3373` → IC=+0.173 (n=5573)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3373 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=6601)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.581` → IC=+0.213 (n=6334)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.581 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9323` → IC=+0.219 (n=941)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9323 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.225` → IC=+0.247 (n=1308)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.225 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `1.2134` → IC=+0.162 (n=4206)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2134 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` > `0.6224` → IC=+0.158 (n=4207)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6224 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.1064` → IC=+0.183 (n=2483)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1064 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `1.5656` → IC=+0.173 (n=2652)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5656 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6619` → IC=+0.169 (n=2008)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.6619 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `3825.7125` → IC=+0.168 (n=2111)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3825.7125 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.180 (n=5247)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 121.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.186 (n=4110)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0064 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.206 (n=2050)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4688` → IC=+0.229 (n=6146)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4688 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2212` → IC=+0.161 (n=4586)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2212 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.199` → IC=+0.193 (n=1058)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.199 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1833` → IC=+0.155 (n=4494)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1833 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6254` → IC=+0.150 (n=4494)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6254 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2924` → IC=+0.230 (n=878)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2924 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `1.5764` → IC=+0.174 (n=2415)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.5764 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.2842` → IC=+0.175 (n=2488)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.2842 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.173 (n=5106)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.190 (n=488)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0073 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.3224` → IC=+0.201 (n=1076)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.044` → IC=+0.307 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.044 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.229` → IC=+0.235 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.229 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` < `2.5417` → IC=+0.174 (n=981)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.5417 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `1.4242` → IC=+0.178 (n=982)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4242 (IC base=+0.183)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=1019)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.252 (n=691)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.248 (n=701)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.239)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.242 (n=777)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.239)

- **PATRÓN** `ibs_20min` < `0.1026` → IC=+0.275 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1026 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.041` → IC=+0.255 (n=837)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8683` → IC=+0.247 (n=468)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8683 (IC base=+0.239)

- **PATRÓN** `volumen_spike_ratio` > `2.6455` → IC=+0.241 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6455 (IC base=+0.239)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.239 (n=808)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `1746.26` → IC=+0.261 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1746.26 (IC base=+0.239)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=979)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `10111.2304` → IC=+0.175 (n=927)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 10111.2304 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1051)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.162 (n=972)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 7.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` < `0.5406` → IC=+0.190 (n=1051)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.5406 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.1334` → IC=+0.165 (n=1072)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1334 (IC base=+0.146)
...
- **PATRÓN** `volumen_regimen` < `1.2116` → IC=+0.160 (n=1051)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2116 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1586` → IC=+0.176 (n=322)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1586 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.4356` → IC=+0.156 (n=941)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.196 (n=1052)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0059 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.198` → IC=+0.203 (n=703)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.198 (IC base=+0.187)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.673` → IC=+0.270 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.673 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` < `0.2152` → IC=+0.185 (n=1010)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.2152 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` > `0.1346` → IC=+0.184 (n=409)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1346 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` < `1.6638` → IC=+0.189 (n=329)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.6638 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` > `3.6197` → IC=+0.204 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6197 (IC base=+0.187)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.200 (n=1198)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.187)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.240 (n=880)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.225)

- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.226 (n=879)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3478` → IC=+0.254 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3478 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.671` → IC=+0.274 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.671 (IC base=+0.225)

- **PATRÓN** `volumen_pendiente_norm` > `0.3624` → IC=+0.270 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3624 (IC base=+0.225)
...
- **PATRÓN** `volumen_spike_ratio` > `3.5269` → IC=+0.247 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5269 (IC base=+0.225)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.179 (n=878)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0066 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.4234` → IC=+0.164 (n=998)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.4234 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.188 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 17.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3938` → IC=+0.202 (n=998)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3938 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1355` → IC=+0.186 (n=651)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1355 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.047` → IC=+0.246 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.047 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.858` → IC=+0.160 (n=666)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.858 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `1.1924` → IC=+0.166 (n=333)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1924 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.213 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.532` → IC=+0.164 (n=429)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.532 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `2.5102` → IC=+0.182 (n=325)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.5102 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `7103.48` → IC=+0.185 (n=665)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 7103.48 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.160 (n=624)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 118.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.167 (n=1073)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0071 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.3806` → IC=+0.147 (n=1072)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3806 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.181 (n=418)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 17.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` < `0.6028` → IC=+0.183 (n=1072)
...
- **PATRÓN** `volumen_regimen` < `0.8548` → IC=+0.144 (n=715)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8548 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `0.6094` → IC=+0.133 (n=1072)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6094 (IC base=+0.132)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7994` → IC=+0.142 (n=638)
...
- **PATRÓN** `libro_liquidez` > `10127.4072` → IC=+0.164 (n=486)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 10127.4072 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `175.0` → IC=+0.130 (n=885)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 175.0 (IC base=+0.132)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.157 (n=531)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0098 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1201)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.5` → IC=+0.196 (n=1183)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.5 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.0121` → IC=+0.232 (n=248)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8139` → IC=+0.128 (n=750)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.8139 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1211)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.192 (n=531)
...
- **PATRÓN** `volumen_regimen` < `1.0407` → IC=+0.122 (n=1043)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.0407 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.181 (n=142)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4623` → IC=+0.142 (n=347)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4623 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.1784` → IC=+0.127 (n=472)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.1784 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3086.3351` → IC=+0.163 (n=395)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3086.3351 (IC base=+0.111)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0182` → IC=+0.210 (n=740)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.725` → IC=+0.254 (n=992)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.371` → IC=+0.240 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.371 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` < `1.2075` → IC=+0.207 (n=1111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2075 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.209 (n=1110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6141 (IC base=+0.200)
...
- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.244 (n=1188)
...
- **PATRÓN** `dist_vwap_pct` < `0.2651` → IC=+0.204 (n=1245)
...
- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.217 (n=1187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6282 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2821` → IC=+0.279 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2821 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` < `2.2447` → IC=+0.197 (n=924)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2447 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4611` → IC=+0.195 (n=1050)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4611 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2545.8374` → IC=+0.215 (n=791)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2545.8374 (IC base=+0.204)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.164 (n=513)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.3929` → IC=+0.167 (n=1538)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.3929 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.8162` → IC=+0.173 (n=212)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.8162 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.996` → IC=+0.171 (n=539)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.996 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8692` → IC=+0.157 (n=884)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8692 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1633` → IC=+0.166 (n=423)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1633 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.4335` → IC=+0.154 (n=492)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4335 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `2.5596` → IC=+0.163 (n=491)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.5596 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=1715)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `2475.6692` → IC=+0.142 (n=1373)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 2475.6692 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.158 (n=1315)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 159.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.151 (n=548)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0038 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.34` → IC=+0.132 (n=1445)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.34 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1657)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` < `0.4872` → IC=+0.158 (n=1446)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.4872 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.145` → IC=+0.122 (n=1396)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.145 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.998` → IC=+0.135 (n=475)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 5.998 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `1.2216` → IC=+0.123 (n=1456)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.2216 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.1675` → IC=+0.141 (n=416)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.1675 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `2.2374` → IC=+0.136 (n=1384)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.2374 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2623.817` → IC=+0.121 (n=1466)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2623.817 (IC base=+0.117)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1096` → IC=+0.141 (n=157)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.1096 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.139 (n=330)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 9.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.2836` → IC=+0.131 (n=356)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` > 0.2836 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.5042` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.5042 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.31` → IC=+0.137 (n=166)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 3.31 (IC base=+0.099)

- **PATRÓN** `volumen_regimen` < `0.9061` → IC=+0.133 (n=238)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.9061 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `10160.5257` → IC=+0.126 (n=356)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 10160.5257 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.152 (n=110)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 156.0 (IC base=+0.099)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.211 (n=171)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.34` → IC=+0.156 (n=507)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.34 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.151 (n=454)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.3415` → IC=+0.206 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3415 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.41` → IC=+0.147 (n=202)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.41 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.159` → IC=+0.137 (n=577)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 9.159 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.7202` → IC=+0.157 (n=453)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.7202 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1609` → IC=+0.215 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1609 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `2.1115` → IC=+0.161 (n=437)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1115 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4209` → IC=+0.141 (n=497)
...
- **FILTRO** `dist_vwap_pct` > `0.3335` → IC=-0.139 (n=34)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.103 (n=414)
...
- **PATRÓN** `ibs_20min` < `0.4872` → IC=+0.150 (n=338)
...
- **PATRÓN** `volumen_spike_ratio` < `1.604` → IC=+0.186 (n=138)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.604 (IC base=+0.084)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.192 (n=3645)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0087 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.173 (n=8375)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.212 (n=8035)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.8883` → IC=+0.198 (n=1034)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8883 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.58` → IC=+0.223 (n=3934)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.58 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8832` → IC=+0.167 (n=3595)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8832 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.2394` → IC=+0.190 (n=1518)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2394 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6356` → IC=+0.182 (n=2552)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6356 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3802.1817` → IC=+0.168 (n=2676)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3802.1817 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `92.0` → IC=+0.192 (n=5858)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 92.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.195 (n=4915)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0068 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4808` → IC=+0.184 (n=7365)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.240 (n=7368)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.231` → IC=+0.163 (n=4682)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.231 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.856` → IC=+0.196 (n=1057)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 9.856 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.684` → IC=+0.184 (n=7120)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 3.684 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.7053` → IC=+0.158 (n=2243)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7053 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.204` → IC=+0.159 (n=1699)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.204 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2893` → IC=+0.247 (n=956)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2893 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.2996` → IC=+0.191 (n=3005)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2996 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.194 (n=2099)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.216 (n=615)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.190)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5466` → IC=+0.182 (n=557)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5466 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.5691` → IC=+0.196 (n=422)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.5691 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.214 (n=1262)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.190)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.260 (n=703)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.257)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.266 (n=1053)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0044 (IC base=+0.257)

- **PATRÓN** `drift_60min` |x|≤ `0.2039` → IC=+0.284 (n=703)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2039 (IC base=+0.257)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.269 (n=952)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.257)

- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.287 (n=926)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3443 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.416` → IC=+0.265 (n=1105)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.416 (IC base=+0.257)

- **PATRÓN** `volumen_pendiente_norm` > `0.2245` → IC=+0.304 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2245 (IC base=+0.257)

- **PATRÓN** `volumen_spike_ratio` > `1.8849` → IC=+0.278 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8849 (IC base=+0.257)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.258 (n=1099)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `1746.26` → IC=+0.278 (n=702)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1746.26 (IC base=+0.257)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1331)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.3171` → IC=+0.198 (n=1276)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3171 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.187 (n=701)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.124 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.803` → IC=+0.151 (n=299)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 9.803 (IC base=+0.148)
...
- **PATRÓN** `ibs_20min` < `0.6377` → IC=+0.205 (n=1138)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6377 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.6916` → IC=+0.165 (n=171)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.6916 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.1283` → IC=+0.165 (n=1054)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1283 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.534` → IC=+0.172 (n=202)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 11.534 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `1.2029` → IC=+0.161 (n=1138)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2029 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1513` → IC=+0.211 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1513 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.4232` → IC=+0.167 (n=1041)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.4232 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.7562` → IC=+0.160 (n=694)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7562 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `12527.0336` → IC=+0.154 (n=759)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12527.0336 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `368.0` → IC=+0.168 (n=631)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 368.0 (IC base=+0.154)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.224 (n=1281)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1342)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.208)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.212 (n=1302)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` > `0.67` → IC=+0.248 (n=1144)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.67 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.548` → IC=+0.301 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.548 (IC base=+0.208)

- **PATRÓN** `volumen_pendiente_norm` < `0.2156` → IC=+0.214 (n=1242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2156 (IC base=+0.208)

- **PATRÓN** `volumen_spike_ratio` > `2.9918` → IC=+0.230 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9918 (IC base=+0.208)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.222 (n=1470)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.208)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.238 (n=1218)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.235)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.241 (n=554)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0092 (IC base=+0.235)

- **PATRÓN** `drift_60min` |x|≤ `0.1545` → IC=+0.235 (n=537)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1545 (IC base=+0.235)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.256 (n=457)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.235)

- **PATRÓN** `ibs_20min` < `0.3636` → IC=+0.270 (n=1071)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3636 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.708` → IC=+0.277 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.708 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.297 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3592 (IC base=+0.235)

- **PATRÓN** `volumen_spike_ratio` < `1.7962` → IC=+0.227 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7962 (IC base=+0.235)

- **PATRÓN** `volumen_spike_ratio` > `2.2488` → IC=+0.234 (n=728)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2488 (IC base=+0.235)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.249 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1894.7532` → IC=+0.243 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1894.7532 (IC base=+0.235)
...
- **PATRÓN** `drift_60min` |x|≤ `0.433` → IC=+0.139 (n=1361)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.433 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=1422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.7004` → IC=+0.229 (n=907)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7004 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.5568` → IC=+0.178 (n=361)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.5568 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.171` → IC=+0.161 (n=576)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.171 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8781` → IC=+0.159 (n=908)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8781 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5113` → IC=+0.144 (n=577)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5113 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.409` → IC=+0.149 (n=1310)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.409 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8761.5886` → IC=+0.227 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8761.5886 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `86.0` → IC=+0.166 (n=417)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 86.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.162 (n=1103)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0075 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.4443` → IC=+0.160 (n=1103)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.4443 (IC base=+0.142)
...
- **PATRÓN** `ibs_20min` < `0.6877` → IC=+0.196 (n=1103)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.6877 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.2043` → IC=+0.146 (n=1034)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.2043 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.031` → IC=+0.195 (n=165)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 11.031 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.21` → IC=+0.142 (n=1032)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.21 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.150 (n=486)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6973 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `1.1778` → IC=+0.151 (n=368)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.1778 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2783` → IC=+0.271 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2783 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.4741` → IC=+0.171 (n=344)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.4741 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `11036.6607` → IC=+0.203 (n=368)
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.182 (n=1372)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.4706 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `1.0` → IC=+0.186 (n=240)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 1.0 (IC base=+0.099)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=953)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2917.9058` → IC=+0.243 (n=458)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.167 (n=590)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0062 (IC base=+0.113)

- **PATRÓN** `drift_60min` |x|≤ `0.1278` → IC=+0.155 (n=444)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1278 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.147 (n=619)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.208 (n=1331)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.4673` → IC=+0.129 (n=1307)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.4673 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.439` → IC=+0.127 (n=1280)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.439 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.7204` → IC=+0.150 (n=586)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4623` → IC=+0.151 (n=391)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4623 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.5681` → IC=+0.123 (n=391)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.5681 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2900.0851` → IC=+0.161 (n=444)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2900.0851 (IC base=+0.113)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.214 (n=924)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1444)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `0.511` → IC=+0.243 (n=1384)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.511 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.1843` → IC=+0.232 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1843 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.371` → IC=+0.248 (n=669)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.371 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `1.2457` → IC=+0.209 (n=1384)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2457 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6304` → IC=+0.208 (n=1384)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6304 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.0797` → IC=+0.231 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0797 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `2.573` → IC=+0.239 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.573 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1407)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2582.8199` → IC=+0.209 (n=923)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2582.8199 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.008` → IC=+0.236 (n=509)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.008 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0255` → IC=+0.227 (n=510)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0255 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.211 (n=1071)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5111` → IC=+0.253 (n=1527)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5111 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.2681` → IC=+0.206 (n=1426)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2681 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.731` → IC=+0.262 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.731 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.232` → IC=+0.236 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.232 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2857` → IC=+0.255 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2857 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2267` → IC=+0.196 (n=1185)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2267 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4453` → IC=+0.198 (n=1346)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4453 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.207 (n=1004)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `2329.247` → IC=+0.200 (n=1363)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2329.247 (IC base=+0.200)
...
- **PATRÓN** `ibs_20min` > `0.6429` → IC=+0.216 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6429 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.1301` → IC=+0.171 (n=308)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1301 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.105` → IC=+0.218 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.105 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `1.0919` → IC=+0.129 (n=594)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0919 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` > `0.977` → IC=+0.127 (n=269)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4899` → IC=+0.162 (n=486)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4899 (IC base=+0.107)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.139 (n=483)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.159 (n=259)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.107)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.183 (n=235)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.006 (IC base=+0.110)
...
- **PATRÓN** `ibs_20min` > `0.5881` → IC=+0.209 (n=204)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5881 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.1301` → IC=+0.197 (n=97)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1301 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.734` → IC=+0.129 (n=130)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 3.734 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `1.0527` → IC=+0.143 (n=180)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.0527 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` < `0.0759` → IC=+0.162 (n=146)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` < 0.0759 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2582` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2582 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.203 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=211)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2972.3262` → IC=+0.136 (n=171)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2972.3262 (IC base=+0.110)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.127 (n=499)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` > 0.5 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2841.5214` → IC=+0.169 (n=173)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2841.5214 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2317.435` → IC=+0.121 (n=576)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2317.435 (IC base=+0.100)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1362)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=600)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=6606)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.180 (n=2766)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=8418)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=2858)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=8807)
...
- **FILTRO** `ibs_20min` < `0.748` → IC=-0.179 (n=474)

  - _Acción_: SKIP cuando `ibs_20min` < 0.748
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1422)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.168 (n=483)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=1601)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.204 (n=471)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1470)
...
- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.167 (n=503)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1556)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.201 (n=453)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1415)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.194 (n=507)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1550)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=2456)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=2523)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=644)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=8036)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=18066)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=6164)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=19938)

- **FILTRO** `ibs_7min` < `0.7005` → IC=-0.243 (n=6525)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7005
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=19577)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.160 (n=8868)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=17234)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=8191)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=24641)

- **FILTRO** `ibs_7min` > `0.2952` → IC=-0.176 (n=8207)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2952
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=24625)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.133 (n=1302)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=2910)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=999)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3213)

- **FILTRO** `ibs_7min` < `0.7063` → IC=-0.263 (n=1388)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7063
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2824)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.197 (n=975)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3237)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.150 (n=3818)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1886)

- **FILTRO** `drift_7min_pct` |x|> `0.1374` → IC=-0.130 (n=1423)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1374
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=4281)

- **FILTRO** `ibs_7min` > `0.7976` → IC=-0.207 (n=1425)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7976
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4279)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1056)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3500)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=1075)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3481)

- **FILTRO** `ibs_7min` < `0.7551` → IC=-0.190 (n=1139)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7551
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3417)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.177 (n=1133)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3423)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.256 (n=1097)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3537)

- **FILTRO** `ibs_7min` > `0.2531` → IC=-0.171 (n=1158)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2531
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3476)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.183 (n=1150)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3484)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=970)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=2971)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.316 (n=951)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2990)

- **FILTRO** `drift_7min_pct` |x|> `0.1798` → IC=-0.133 (n=1339)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1798
  - _Potencial_: sin este filtro IC_bueno=-0.104 (n=2602)

- **FILTRO** `ibs_7min` < `0.2` → IC=-0.273 (n=977)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2964)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.220 (n=917)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3024)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1412)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4602)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.155 (n=2043)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=3971)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1374)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2933)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1055)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3252)

- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.191 (n=1076)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3231)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.187 (n=1064)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3243)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1086)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3324)

- **FILTRO** `ibs_7min` > `0.2739` → IC=-0.174 (n=1102)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2739
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3308)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.182 (n=1081)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3329)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.257 (n=1124)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3555)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.231 (n=1137)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3542)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.168 (n=1509)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4710)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=1346)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=3061)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.280 (n=1086)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3321)

- **FILTRO** `ibs_7min` < `0.72` → IC=-0.234 (n=1094)

  - _Acción_: SKIP cuando `ibs_7min` < 0.72
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3313)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.211 (n=1074)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3333)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.206 (n=1387)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=4464)
...
- **FILTRO** `libro_liquidez` < `10509.6738` → IC=-0.149 (n=132)

  - _Acción_: SKIP cuando `libro_liquidez` < 10509.6738
...
- **FILTRO** `sigma_h` < `0.0142` → IC=-0.329 (n=33)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=592)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.155 (n=27)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=480)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2414)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1247)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1255)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.215 (n=518)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0582` → IC=+0.179 (n=1143)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.89€ cuando `delta_ratio_macro` |x|> 0.0582 (IC base=+0.176)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.187 (n=464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 16.0 (IC base=+0.176)
...
- **PATRÓN** `libro_liquidez` > `2620.7944` → IC=+0.177 (n=1021)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2620.7944 (IC base=+0.176)
...
- **PATRÓN** `ibs_15` < `0.1111` → IC=+0.171 (n=363)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2096` → IC=+0.238 (n=402)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2096 (IC base=-0.042)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.183` → IC=+0.245 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.183 (IC base=-0.042)

- **PATRÓN** `ibs_15` < `0.3529` → IC=+0.283 (n=1205)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3529 (IC base=-0.042)

- **PATRÓN** `dist_vwap_pct` > `0.6504` → IC=+0.264 (n=180)
...
- **FILTRO** `sigma_h` > `0.007` → IC=-0.208 (n=330)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=996)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.227 (n=437)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=889)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.206 (n=841)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.238 (n=235)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1091)
...
- **PATRÓN** `ibs_15` < `0.2758` → IC=+0.286 (n=447)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2758 (IC base=+0.229)

- **PATRÓN** `dist_vwap_pct` > `0.3755` → IC=+0.254 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3755 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.178` → IC=+0.232 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.178 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.033` → IC=+0.236 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.033 (IC base=+0.229)

- **PATRÓN** `libro_liquidez` > `3591.8273` → IC=+0.231 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3591.8273 (IC base=+0.229)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.229 (n=481)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0726` → IC=+0.217 (n=217)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.