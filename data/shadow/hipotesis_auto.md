# Hipótesis automáticas — 2026-07-15 10:30 UTC
_Generado por shadow_postmortem.py sobre 15164 resoluciones (PNL=+2966.06€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.197 (n=870)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `4387.7143` → IC=+0.196 (n=491)
...
- **PATRÓN** `sigma_h` > `0.012` → IC=+0.228 (n=215)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.164 (n=674)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `1.0625` → IC=+0.236 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0625 (IC base=+0.160)
...
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.130 (n=160)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` < 0.0064 (IC base=+0.126)

- **PATRÓN** `sigma_h` > `0.0031` → IC=+0.169 (n=143)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0031 (IC base=+0.126)
...
- **PATRÓN** `dist_vwap_pct` > `0.1391` → IC=+0.152 (n=44)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1391 (IC base=+0.126)
...
- **PATRÓN** `dist_vwap_pct` > `0.4883` → IC=+0.194 (n=47)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.4883 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `1.1149` → IC=+0.135 (n=124)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 1.1149 (IC base=+0.133)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2099 | +0.177 | -33.08€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1358 | +0.207 | -2.00€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 612 | +0.177 | -17.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 454 | +0.193 | -27.88€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 743 | +0.180 | +15.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 448 | +0.220 | +21.70€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 738 | +0.174 | -26.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 450 | +0.210 | +8.35€ | 0 | 6 |
...
| ✅ GBM_LATE_15M | 4542 | +0.102 | +1386.81€ | 0 | 3 |
| ✅ GBM_LATE_15M#15min | 4542 | +0.102 | +1386.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1090 | +0.068 | +161.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1090 | +0.068 | +161.47€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1108 | +0.073 | +182.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1108 | +0.073 | +182.94€ | 1 | 4 |
| ✅ GBM_LATE_15M#SOL | 1208 | +0.112 | +492.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1208 | +0.112 | +492.40€ | 1 | 6 |
| ✅ GBM_LATE_15M#XRP | 1136 | +0.152 | +550.01€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1136 | +0.152 | +550.01€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1805 | +0.152 | +1049.10€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1805 | +0.152 | +1049.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 462 | +0.125 | +232.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 462 | +0.125 | +232.90€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 475 | +0.123 | +212.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 475 | +0.123 | +212.77€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 488 | +0.108 | +207.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 488 | +0.108 | +207.24€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 380 | +0.275 | +396.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 380 | +0.275 | +396.19€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 1758 | +0.084 | +484.84€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1758 | +0.084 | +484.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 436 | +0.064 | +74.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 436 | +0.064 | +74.52€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 391 | +0.009 | +7.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 391 | +0.009 | +7.46€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 436 | +0.048 | +71.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 436 | +0.048 | +71.81€ | 2 | 5 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 495 | +0.190 | +331.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 495 | +0.190 | +331.05€ | 0 | 11 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.099 n=8734 | tras_1loss IC=+0.061 n=6235 | tras_2loss IC=+0.028 n=2709/40 | gap=+0.070 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12706 IC=+0.101 PNL=+3041.94€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12706 IC=+0.101 PNL=+3041.94€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=580 IC=+0.058 PNL=+68.21€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=580 IC=+0.058 PNL=+68.21€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.130 > 0.08 con n=152 PNL=+75.67€
  - _Datos_: n=152 IC=+0.130 PNL=+75.67€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.229 > 0.08 con n=105 PNL=+9.48€
  - _Datos_: n=105 IC=+0.229 PNL=+9.48€
