# Hipótesis automáticas — 2026-06-29 22:44 UTC
_Generado por shadow_postmortem.py sobre 1326 resoluciones (PNL=-39.46€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1022` → IC=+0.152 (n=21)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `pct_spot_vs_ref` |x|≤ 0.1022 (IC base=+0.054)

- **PATRÓN** `drift_60min` |x|≤ `0.2032` → IC=+0.132 (n=17)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.2032 (IC base=+0.054)
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.091) — sin ventaja clara. oversold(IBS<0.3): IC=+0.000 n=18 | neutral: IC=+0.091 n=20 | overbought(IBS>0.7): IC=+0.033 n=28
  - _Datos_: n=68 IC=+0.043 PNL=+0.85€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 68 ops, 12 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 357/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=258 IC=+0.027 PNL=+7.61€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=258 IC=+0.027 PNL=+7.61€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=160 IC=+0.018 PNL=-7.04€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=160 IC=+0.018 PNL=-7.04€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=63 IC=+0.054 PNL=+1.00€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=63 IC=+0.054 PNL=+1.00€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.107 > 0.08 con n=82 PNL=+4.95€
  - _Datos_: n=82 IC=+0.107 PNL=+4.95€
