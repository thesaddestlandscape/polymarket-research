# Hipótesis automáticas — 2026-07-11 17:13 UTC
_Generado por shadow_postmortem.py sobre 9508 resoluciones (PNL=+1493.04€)_
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.089 (n=319)

- **PATRÓN** `ibs_15` > `0.7103` → IC=+0.134 (n=203)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.67€ cuando `ibs_15` > 0.7103 (IC base=+0.007)

- **PATRÓN** `dist_vwap_pct` > `0.1374` → IC=+0.194 (n=60)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1374 (IC base=+0.007)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0748` → IC=+0.147 (n=49)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0748 (IC base=+0.041)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.157 (n=106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 12.0 (IC base=+0.041)

- **PATRÓN** `ibs_15` < `0.908` → IC=+0.139 (n=106)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.908 (IC base=+0.041)

- **PATRÓN** `ibs_15` > `0.6354` → IC=+0.145 (n=105)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` > 0.6354 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` > `0.1361` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1361 (IC base=+0.041)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 542 | +0.149 | -42.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 343 | +0.172 | -33.87€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 159 | +0.158 | -13.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 112 | +0.184 | -12.61€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 192 | +0.139 | -6.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 116 | +0.178 | -5.10€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 190 | +0.146 | -22.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 114 | +0.147 | -16.71€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 3295 | +0.111 | +1048.84€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 3295 | +0.111 | +1048.84€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 819 | +0.063 | +87.56€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 819 | +0.063 | +87.56€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 840 | +0.069 | +129.10€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 840 | +0.069 | +129.10€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 853 | +0.140 | +421.49€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 853 | +0.140 | +421.49€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 783 | +0.174 | +410.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 783 | +0.174 | +410.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 686 | +0.144 | +301.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 686 | +0.144 | +301.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 178 | +0.167 | +107.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 178 | +0.167 | +107.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 187 | +0.114 | +59.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 187 | +0.114 | +59.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 194 | +0.082 | +32.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 194 | +0.082 | +32.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 127 | +0.244 | +100.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 127 | +0.244 | +100.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 838 | +0.076 | +176.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 838 | +0.076 | +176.95€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 195 | +0.074 | +18.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 195 | +0.074 | +18.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 212 | -0.009 | +2.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 212 | -0.009 | +2.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 216 | +0.028 | +17.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 216 | +0.028 | +17.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 215 | +0.210 | +138.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 215 | +0.210 | +138.73€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1273 | -0.013 | +5.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1017 | +0.016 | +42.62€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 342 | +0.000 | -5.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 263 | +0.040 | +7.50€ | 1 | 8 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.103) — sin ventaja clara. oversold(IBS<0.3): IC=-0.025 n=322 | neutral: IC=-0.049 n=251 | overbought(IBS>0.7): IC=+0.053 n=271
  - _Datos_: n=883 IC=-0.001 PNL=+30.39€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.177 n=29 PNL=-7.49€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.105 n=36 PNL=+9.04€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.079 n=5247 | tras_1loss IC=+0.036 n=4093 | tras_2loss IC=+0.001 n=1866/40 | gap=+0.078 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.079 n=442/40 PNL=+85.95€ | H=15h UTC: IC=+0.087 n=444/40 PNL=+95.17€ | H=17h UTC: IC=+0.113 n=329/40 PNL=+107.45€ | H=19h UTC: IC=+0.057 n=312/40 PNL=+48.20€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=200 IC=-0.005 PNL=+5.20€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=200 IC=-0.005 PNL=+5.20€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1148 IC=-0.007 PNL=+18.79€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1148 IC=-0.007 PNL=+18.79€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=580 IC=+0.007 PNL=+8.59€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=580 IC=+0.007 PNL=+8.59€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=263 IC=+0.040 PNL=+7.50€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=263 IC=+0.040 PNL=+7.50€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=517 IC=+0.038 PNL=+22.61€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=517 IC=+0.038 PNL=+22.61€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=7050 IC=+0.087 PNL=+1568.92€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=7050 IC=+0.087 PNL=+1568.92€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=727 IC=-0.025 PNL=-21.88€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=727 IC=-0.025 PNL=-21.88€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.164 > 0.1 con n=239 PNL=+81.40€
  - _Datos_: n=239 IC=+0.164 PNL=+81.40€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=143 IC=+0.059 PNL=+7.18€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=143 IC=+0.059 PNL=+7.18€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=329 IC=-0.047 PNL=+78.63€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=329 IC=-0.047 PNL=+78.63€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.163 > 0.08 con n=176 PNL=+54.84€
  - _Datos_: n=176 IC=+0.163 PNL=+54.84€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 73/80 ops en el filtro definido (IC actual=+0.220 PNL=+23.81€)
  - _Datos_: n=73 IC=+0.220 PNL=+23.81€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.155 < -0.1 con n=291 PNL=-39.80€
  - _Datos_: n=291 IC=-0.155 PNL=-39.80€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 94/100 ops en el filtro definido (IC actual=+0.312 PNL=+60.68€)
  - _Datos_: n=94 IC=+0.312 PNL=+60.68€
