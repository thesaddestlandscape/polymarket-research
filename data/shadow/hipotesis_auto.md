# Hipótesis automáticas — 2026-09-25 02:35 UTC
_Generado por shadow_postmortem.py sobre 598047 resoluciones (PNL=+67445.90€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.122 (n=490)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.122 (n=490)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.495 (IC base=+0.050)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.146 (n=173)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.113 (n=357)
...
- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.154 (n=134)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 95.0 (IC base=+0.050)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.02` → IC=-0.232 (n=7082)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.02
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=21260)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `138.36` → IC=-0.248 (n=928)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 138.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2784)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `500.19` → IC=-0.148 (n=365)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 500.19
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1098)
...
- **FILTRO** `restante_s_al_confirmar` < `165.18` → IC=-0.220 (n=1710)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.18
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=5130)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `126.29` → IC=-0.355 (n=1393)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 126.29
  - _Potencial_: sin este filtro IC_bueno=-0.119 (n=4182)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.204 (n=13875)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=3501)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5643.012` → IC=+0.178 (n=2229)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 5643.012 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.138 (n=11570)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 17.0 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.135 (n=13904)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.126)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=10918)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5671)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `7825.557` → IC=+0.174 (n=2142)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7825.557 (IC base=+0.126)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.210 (n=1649)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1690)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.205)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.352 (n=783)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=2130)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `16024.1962` → IC=+0.241 (n=550)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1689)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.263 (n=1542)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=2166)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `15860.4955` → IC=+0.213 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15860.4955 (IC base=+0.201)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.172 (n=327)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` > 0.615 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `4624.034` → IC=+0.147 (n=236)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 4624.034 (IC base=+0.102)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.142 (n=353)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.236 (n=1488)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.162 (n=584)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 7.0 (IC base=+0.159)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=727)
...
- **PATRÓN** `py_entrada` < `0.355` → IC=+0.195 (n=385)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.436 (n=527)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.430)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.430 (n=469)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.430)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.440 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.430)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.430 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.430)

- **PATRÓN** `libro_liquidez` > `2073.3909` → IC=+0.439 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2073.3909 (IC base=+0.430)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.435 (n=183)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.437)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.437 (n=205)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 16.0 (IC base=+0.437)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.451 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.437)

- **PATRÓN** `libro_liquidez` > `19031.9918` → IC=+0.442 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 19031.9918 (IC base=+0.437)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.236 (n=15287)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.177 (n=5926)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 8.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.181 (n=4739)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 12.0 (IC base=+0.176)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=6394)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=6121)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.223)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.264 (n=3499)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=6226)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.267 (n=2114)
...
- **PATRÓN** `py_entrada` > `0.815` → IC=+0.381 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.290)

- **PATRÓN** `libro_liquidez` > `4103.1582` → IC=+0.309 (n=370)
...
- **PATRÓN** `libro_liquidez` > `4263.4949` → IC=+0.298 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4263.4949 (IC base=+0.277)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.299 (n=556)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.293)

- **PATRÓN** `py_entrada` > `0.815` → IC=+0.393 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.293)

- **PATRÓN** `libro_liquidez` > `1451.8749` → IC=+0.310 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1451.8749 (IC base=+0.293)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4859` → IC=+0.122 (n=8105)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4859 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9836` → IC=+0.244 (n=2701)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9836 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.8494` → IC=+0.252 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8494 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.6368` → IC=+0.249 (n=2285)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6368 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.344` → IC=+0.186 (n=2143)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 8.344 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2084` → IC=+0.248 (n=2194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2084 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0448` → IC=+0.257 (n=995)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0448 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.3043` → IC=+0.219 (n=810)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3043 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.4628` → IC=+0.202 (n=5554)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4628 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.5706` → IC=+0.135 (n=9766)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.5706 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` > `0.6169` → IC=+0.199 (n=725)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.6169 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` < `0.6971` → IC=+0.183 (n=1505)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6971 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `1.0527` → IC=+0.176 (n=1552)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0527 (IC base=+0.066)

- **PATRÓN** `volumen_pendiente_norm` > `0.1673` → IC=+0.225 (n=1630)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1673 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.5695` → IC=+0.202 (n=5146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5695 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.212 (n=5549)
...
- **PATRÓN** `ibs_20min` < `0.3275` → IC=+0.198 (n=970)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.3275 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1327` → IC=+0.157 (n=1291)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1327 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.262` → IC=+0.160 (n=233)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.262 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.282` → IC=+0.143 (n=1324)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 4.282 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.150 (n=1454)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.2046 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1567` → IC=+0.176 (n=384)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1567 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.152 (n=1344)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4292 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4164` → IC=+0.149 (n=1344)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4164 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `14092.9821` → IC=+0.146 (n=969)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 14092.9821 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `410.0` → IC=+0.149 (n=1262)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 410.0 (IC base=+0.140)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.210 (n=599)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0117 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1889)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 5.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.191 (n=1604)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.199` → IC=+0.251 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.199 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` < `0.2102` → IC=+0.187 (n=1799)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2102 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.3582` → IC=+0.200 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3582 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.8308` → IC=+0.204 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8308 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.193 (n=1288)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0116` → IC=+0.220 (n=1545)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0116 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.6021` → IC=+0.214 (n=1545)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.157 (n=100)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=2224)
...
- **PATRÓN** `ballena_activa_n` < `161.0` → IC=+0.327 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 161.0 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` > `0.3372` → IC=+0.194 (n=266)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.3372 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `0.8471` → IC=+0.167 (n=560)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.8471 (IC base=+0.019)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.178 (n=702)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5138 (IC base=+0.019)
...
- **FILTRO** `ibs_20min` > `0.2558` → IC=-0.125 (n=2198)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2558
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=1084)

- **FILTRO** `sigma_ewma_delta_pct` > `8.672` → IC=-0.209 (n=352)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.672
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2930)
...
- **PATRÓN** `ibs_20min` < `0.2558` → IC=+0.126 (n=1084)
...
- **PATRÓN** `dist_vwap_pct` < `0.9446` → IC=+0.216 (n=421)
...
- **PATRÓN** `volumen_regimen` > `0.899` → IC=+0.216 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.899 (IC base=-0.042)

- **PATRÓN** `volumen_pendiente_norm` < `0.102` → IC=+0.234 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.102 (IC base=-0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.1566` → IC=+0.261 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1566 (IC base=-0.042)

- **PATRÓN** `volumen_spike_ratio` < `2.43` → IC=+0.265 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.43 (IC base=-0.042)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6576` → IC=-0.184 (n=570)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6576
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1713)

- **FILTRO** `ibs_20min` < `0.7149` → IC=-0.156 (n=1505)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7149
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=778)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.201 (n=416)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1867)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.203 (n=834)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2515)

- **PATRÓN** `dist_vwap_pct` > `0.8523` → IC=+0.316 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8523 (IC base=-0.066)

- **PATRÓN** `dist_vwap_pct` < `0.2747` → IC=+0.317 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2747 (IC base=-0.066)

- **PATRÓN** `volumen_regimen` < `0.9814` → IC=+0.290 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9814 (IC base=-0.066)

- **PATRÓN** `volumen_regimen` > `0.6251` → IC=+0.301 (n=354)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6251 (IC base=-0.066)

- **PATRÓN** `volumen_pendiente_norm` < `0.1006` → IC=+0.297 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1006 (IC base=-0.066)

- **PATRÓN** `volumen_spike_ratio` < `1.3932` → IC=+0.307 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3932 (IC base=-0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.8015` → IC=+0.292 (n=224)
...
- **PATRÓN** `volumen_regimen` < `0.7351` → IC=+0.253 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7351 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` > `1.0882` → IC=+0.280 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0882 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.1035` → IC=+0.275 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1035 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `2.1457` → IC=+0.259 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1457 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.4298` → IC=+0.247 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4298 (IC base=-0.023)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.245 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.197 (n=3392)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0098 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4766` → IC=+0.189 (n=9080)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4766 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7744` → IC=+0.290 (n=1078)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7744 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.597` → IC=+0.157 (n=4778)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.597 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6889` → IC=+0.247 (n=3234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6889 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2948` → IC=+0.268 (n=860)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2948 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4655` → IC=+0.240 (n=1959)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4655 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6649` → IC=+0.241 (n=1959)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6649 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.268 (n=5393)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.155 (n=3378)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5488` → IC=+0.155 (n=8908)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.5488 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` > `0.7309` → IC=+0.241 (n=634)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7309 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` < `0.2498` → IC=+0.239 (n=2815)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2498 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` < `0.7094` → IC=+0.240 (n=1313)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7094 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` > `1.205` → IC=+0.247 (n=995)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.205 (IC base=+0.073)

- **PATRÓN** `volumen_pendiente_norm` > `0.2443` → IC=+0.303 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2443 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `1.6035` → IC=+0.260 (n=1732)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6035 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `2.3137` → IC=+0.258 (n=1784)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3137 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.264 (n=3820)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.073)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.523` → IC=-0.159 (n=535)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.523
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1798)

- **PATRÓN** `ibs_20min` > `0.8938` → IC=+0.268 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8938 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.799` → IC=+0.210 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.799 (IC base=+0.045)

- **PATRÓN** `volumen_pendiente_norm` > `0.2239` → IC=+0.271 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2239 (IC base=+0.045)

- **PATRÓN** `volumen_spike_ratio` < `1.433` → IC=+0.174 (n=296)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.433 (IC base=+0.045)

- **PATRÓN** `volumen_spike_ratio` > `2.1457` → IC=+0.201 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1457 (IC base=+0.045)

- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.182 (n=394)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 14.0 (IC base=+0.045)

- **PATRÓN** `volumen_pendiente_norm` < `0.1845` → IC=+0.451 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1845 (IC base=-0.017)

- **PATRÓN** `volumen_spike_ratio` < `2.6396` → IC=+0.439 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.6396 (IC base=-0.017)

- **PATRÓN** `volumen_spike_ratio` > `2.2378` → IC=+0.435 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2378 (IC base=-0.017)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.469 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 21.0 (IC base=-0.017)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.160 (n=680)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.86 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3125` → IC=+0.178 (n=380)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.3125 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6718` → IC=+0.165 (n=837)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.6718 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` > `0.2732` → IC=+0.227 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2732 (IC base=+0.026)

- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.198 (n=306)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `244.0` → IC=+0.195 (n=398)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 244.0 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.218 (n=577)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1614 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `1.0371` → IC=+0.230 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0371 (IC base=+0.005)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.691` → IC=+0.281 (n=506)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.691 (IC base=+0.246)

- **PATRÓN** `volumen_pendiente_norm` < `0.104` → IC=+0.259 (n=1359)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.104 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `3.4244` → IC=+0.261 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4244 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.254 (n=1138)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1961.5776` → IC=+0.254 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1961.5776 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.320 (n=581)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0099 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.6105` → IC=+0.284 (n=1281)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2222` → IC=+0.290 (n=1127)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3414` → IC=+0.309 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3414 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` < `1.5923` → IC=+0.283 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5923 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.7291` → IC=+0.288 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7291 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.287 (n=865)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1880.06` → IC=+0.299 (n=581)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1880.06 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.288 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2871` → IC=-0.183 (n=497)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2871
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1492)

- **FILTRO** `ibs_20min` > `0.7758` → IC=-0.191 (n=599)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7758
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=1804)

- **PATRÓN** `ibs_20min` > `0.822` → IC=+0.157 (n=678)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.822 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` > `0.4545` → IC=+0.225 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4545 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` < `0.7062` → IC=+0.211 (n=586)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7062 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `0.9855` → IC=+0.236 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9855 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` > `0.5867` → IC=+0.211 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5867 (IC base=+0.013)

- **PATRÓN** `volumen_pendiente_norm` > `0.0806` → IC=+0.261 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0806 (IC base=+0.013)

- **PATRÓN** `volumen_spike_ratio` < `1.5105` → IC=+0.266 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5105 (IC base=+0.013)

- **PATRÓN** `ballena_activa_n` < `150.0` → IC=+0.244 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 150.0 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` > `0.1547` → IC=+0.211 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1547 (IC base=-0.005)

- **PATRÓN** `dist_vwap_pct` < `0.6852` → IC=+0.203 (n=493)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6852 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.213 (n=427)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8268` → IC=+0.267 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8268 (IC base=-0.005)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.251 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.005)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.725` → IC=-0.198 (n=1076)

  - _Acción_: SKIP cuando `ibs_20min` < 0.725
  - _Potencial_: sin este filtro IC_bueno=+0.282 (n=1079)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.234 (n=555)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1683)

- **FILTRO** `sigma_ewma_delta_pct` > `4.709` → IC=-0.182 (n=488)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.709
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=1750)

- **PATRÓN** `ibs_20min` > `0.725` → IC=+0.282 (n=1079)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.725 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` > `0.8547` → IC=+0.337 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8547 (IC base=+0.042)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.58` → IC=+0.164 (n=340)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 9.58 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.307 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` > `0.7299` → IC=+0.294 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7299 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` < `0.1034` → IC=+0.293 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1034 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.2245` → IC=+0.301 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2245 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` < `1.421` → IC=+0.326 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.421 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.315 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.042)

- **PATRÓN** `ibs_20min` < `0.5806` → IC=+0.120 (n=1478)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.5806 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` > `0.7308` → IC=+0.201 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7308 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` < `0.2141` → IC=+0.218 (n=494)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0971` → IC=+0.210 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0971 (IC base=+0.014)

- **PATRÓN** `volumen_pendiente_norm` > `0.069` → IC=+0.212 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.069 (IC base=+0.014)

- **PATRÓN** `volumen_spike_ratio` < `2.4844` → IC=+0.221 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4844 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.237 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=+0.014)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.316 (n=879)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0168 (IC base=+0.277)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.285 (n=1380)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.277)

- **PATRÓN** `ibs_20min` > `0.9118` → IC=+0.346 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9118 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.2086` → IC=+0.316 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2086 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.566` → IC=+0.300 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.566 (IC base=+0.277)

- **PATRÓN** `volumen_regimen` > `0.8606` → IC=+0.300 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8606 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` < `0.0796` → IC=+0.280 (n=1121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0796 (IC base=+0.277)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.273 (n=703)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.272)

- **PATRÓN** `ibs_20min` < `0.3939` → IC=+0.305 (n=1420)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3939 (IC base=+0.272)

- **PATRÓN** `dist_vwap_pct` > `0.3051` → IC=+0.282 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3051 (IC base=+0.272)
...
- **PATRÓN** `volumen_regimen` < `0.6405` → IC=+0.275 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6405 (IC base=+0.272)

- **PATRÓN** `volumen_regimen` > `1.2435` → IC=+0.307 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2435 (IC base=+0.272)

- **PATRÓN** `volumen_pendiente_norm` > `0.2392` → IC=+0.337 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2392 (IC base=+0.272)

- **PATRÓN** `volumen_spike_ratio` < `1.4272` → IC=+0.276 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4272 (IC base=+0.272)

- **PATRÓN** `volumen_spike_ratio` > `2.1485` → IC=+0.275 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1485 (IC base=+0.272)

- **PATRÓN** `libro_liquidez` > `2623.1942` → IC=+0.276 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2623.1942 (IC base=+0.272)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2648)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.201 (n=2641)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0906` → IC=+0.187 (n=2640)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0906 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=8238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5765` → IC=+0.217 (n=7917)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5765 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1772` → IC=+0.196 (n=3468)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1772 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.343` → IC=+0.255 (n=1622)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.343 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2107` → IC=+0.160 (n=5242)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2107 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.161 (n=5242)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6307 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2956` → IC=+0.196 (n=1186)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2956 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.559` → IC=+0.168 (n=3343)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.559 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6194` → IC=+0.177 (n=2531)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6194 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2403.067` → IC=+0.169 (n=5278)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2403.067 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `115.0` → IC=+0.181 (n=6827)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 115.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=5042)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0812` → IC=+0.208 (n=2520)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0812 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.206 (n=2519)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.4792` → IC=+0.227 (n=7552)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4792 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9249` → IC=+0.149 (n=733)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.9249 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2336` → IC=+0.158 (n=5468)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2336 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.342` → IC=+0.195 (n=1282)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.342 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1737` → IC=+0.151 (n=5471)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1737 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2911` → IC=+0.219 (n=1085)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2911 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5601` → IC=+0.166 (n=3023)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5601 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.2519` → IC=+0.169 (n=3114)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2519 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.172 (n=6519)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 116.0 (IC base=+0.167)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.220 (n=451)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.182)

- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.188 (n=611)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0076 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.3439` → IC=+0.206 (n=1348)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3439 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=1416)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.192 (n=900)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 11.0 (IC base=+0.182)

- **PATRÓN** `ibs_20min` > `0.8969` → IC=+0.278 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8969 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.312 (n=605)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.180 (n=1247)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4355 (IC base=+0.182)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.240 (n=868)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.250 (n=881)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.239)

- **PATRÓN** `drift_60min` |x|≤ `0.1889` → IC=+0.290 (n=656)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1889 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.245 (n=889)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.239)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.247 (n=481)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.239)

- **PATRÓN** `ibs_20min` < `0.3427` → IC=+0.266 (n=983)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3427 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.305` → IC=+0.251 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.305 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` < `0.0977` → IC=+0.235 (n=821)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0977 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` > `0.2864` → IC=+0.250 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2864 (IC base=+0.239)

- **PATRÓN** `volumen_spike_ratio` < `1.4211` → IC=+0.260 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4211 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `1807.5508` → IC=+0.246 (n=655)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1807.5508 (IC base=+0.239)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.238 (n=778)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 47.0 (IC base=+0.239)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.232 (n=393)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.0745` → IC=+0.199 (n=393)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.0745 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=1242)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4061` → IC=+0.228 (n=1178)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.501` → IC=+0.233 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.501 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2593` → IC=+0.164 (n=1178)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2593 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0736` → IC=+0.168 (n=534)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0736 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2815` → IC=+0.208 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2815 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.5013` → IC=+0.181 (n=503)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5013 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `2.4541` → IC=+0.161 (n=381)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.4541 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `15988.2314` → IC=+0.164 (n=534)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 15988.2314 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `389.0` → IC=+0.161 (n=967)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 389.0 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.157 (n=1282)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0057 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2303` → IC=+0.166 (n=1128)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2303 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.179 (n=431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.5665` → IC=+0.186 (n=1282)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.5665 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1336` → IC=+0.159 (n=1266)
...
- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.156 (n=1282)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.2113 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1561` → IC=+0.154 (n=391)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1561 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.4356` → IC=+0.145 (n=1170)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4356 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4185` → IC=+0.136 (n=1170)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4185 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `215.0` → IC=+0.165 (n=365)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 215.0 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.221 (n=603)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0101 (IC base=+0.198)

- **PATRÓN** `drift_60min` |x|≤ `0.2325` → IC=+0.216 (n=886)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=705)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.198)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.876` → IC=+0.274 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.876 (IC base=+0.198)

- **PATRÓN** `volumen_pendiente_norm` > `0.2072` → IC=+0.200 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2072 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` < `1.6272` → IC=+0.200 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6272 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `2.8468` → IC=+0.212 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8468 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=943)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `1962.7584` → IC=+0.199 (n=443)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 1962.7584 (IC base=+0.198)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.231 (n=1101)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.5755` → IC=+0.227 (n=1101)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5755 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.276 (n=387)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` < `0.2417` → IC=+0.255 (n=969)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2417 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.746` → IC=+0.264 (n=472)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7676` → IC=+0.212 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7676 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.215` → IC=+0.227 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.215 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1891.307` → IC=+0.221 (n=499)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1891.307 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `11.0` → IC=+0.207 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 11.0 (IC base=+0.217)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.172 (n=1117)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0066 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.4335` → IC=+0.157 (n=1267)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.4219` → IC=+0.153 (n=413)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4219 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `2.5111` → IC=+0.170 (n=413)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.5111 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6496.8974` → IC=+0.184 (n=844)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6496.8974 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.147 (n=1204)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 163.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.153 (n=1333)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3848` → IC=+0.143 (n=1333)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6398` → IC=+0.172 (n=1333)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6398 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.5895` → IC=+0.132 (n=1547)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.5895 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.963` → IC=+0.169 (n=469)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 6.963 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8475` → IC=+0.148 (n=889)
...
- **PATRÓN** `volumen_spike_ratio` < `1.789` → IC=+0.137 (n=807)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.789 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `10039.916` → IC=+0.160 (n=604)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 10039.916 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.158 (n=649)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0101 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=1461)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 5.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.205 (n=1431)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5169 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` > `0.8486` → IC=+0.218 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8486 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.733` → IC=+0.255 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.733 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.131 (n=1432)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.2184 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` > `0.6461` → IC=+0.123 (n=1431)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.6461 (IC base=+0.119)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4678` → IC=+0.129 (n=1382)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.4678 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1496)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2896.4901` → IC=+0.197 (n=649)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2896.4901 (IC base=+0.119)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.137 (n=1086)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1033` → IC=+0.156 (n=483)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1033 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.162 (n=658)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 15.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.210 (n=1448)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.0156` → IC=+0.145 (n=195)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 1.0156 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.2005` → IC=+0.138 (n=1331)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2005 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.973` → IC=+0.136 (n=234)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 8.973 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.6359` → IC=+0.137 (n=483)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.6359 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.165 (n=177)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.2757 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.4248` → IC=+0.130 (n=433)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.4248 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2170.6408` → IC=+0.146 (n=965)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2170.6408 (IC base=+0.112)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=912)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.1351` → IC=+0.201 (n=456)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1351 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1419)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.205 (n=621)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.65` → IC=+0.244 (n=1370)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.65 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.5119` → IC=+0.221 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5119 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.242 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.204 (n=1368)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6251` → IC=+0.211 (n=1368)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6251 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2334` → IC=+0.264 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2334 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `2.1481` → IC=+0.211 (n=1163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1481 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.409` → IC=+0.207 (n=1321)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.409 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.204 (n=1456)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2825.677` → IC=+0.207 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2825.677 (IC base=+0.201)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.227 (n=620)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.203)

- **PATRÓN** `sigma_h` > `0.0172` → IC=+0.206 (n=939)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0172 (IC base=+0.203)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.223 (n=470)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `2.2088` → IC=+0.195 (n=1115)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2088 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4369` → IC=+0.199 (n=1266)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4369 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2595.0802` → IC=+0.209 (n=939)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2595.0802 (IC base=+0.203)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.161 (n=636)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0039 (IC base=+0.147)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.180 (n=635)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0088 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.1006` → IC=+0.153 (n=633)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1006 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=961)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.388` → IC=+0.181 (n=1899)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.388 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.8774` → IC=+0.185 (n=303)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.8774 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.703` → IC=+0.173 (n=860)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 3.703 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.8708` → IC=+0.165 (n=1115)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8708 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `0.6979` → IC=+0.150 (n=1493)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6979 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.165` → IC=+0.172 (n=525)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.165 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.4413` → IC=+0.163 (n=610)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4413 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.8262` → IC=+0.150 (n=1219)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8262 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2158)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `12439.6953` → IC=+0.160 (n=633)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12439.6953 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.169 (n=1676)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 160.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.142 (n=1318)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.66` → IC=+0.139 (n=1977)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.66 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2132` → IC=+0.122 (n=1752)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2132 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.6252` → IC=+0.128 (n=594)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.6252 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.128 (n=490)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4548` → IC=+0.139 (n=635)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4548 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2753.0147` → IC=+0.124 (n=1766)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2753.0147 (IC base=+0.111)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3432` → IC=+0.123 (n=478)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.3432 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.148 (n=427)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 9.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2517` → IC=+0.144 (n=478)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.2517 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3087` → IC=+0.155 (n=169)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.3087 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6182` → IC=+0.148 (n=160)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6182 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `15011.8449` → IC=+0.145 (n=319)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 15011.8449 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.154 (n=151)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.160 (n=634)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6039` → IC=+0.186 (n=558)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.6039 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.4869` → IC=+0.154 (n=729)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.4869 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.406` → IC=+0.159 (n=247)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.406 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.218` → IC=+0.143 (n=634)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.218 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.0611` → IC=+0.169 (n=288)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0611 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1106` → IC=+0.158 (n=550)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1106 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.4203` → IC=+0.152 (n=624)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4203 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `325.0` → IC=+0.157 (n=531)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 325.0 (IC base=+0.139)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.255 (n=259)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.191)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.197 (n=196)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.007 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.0977` → IC=+0.208 (n=197)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.9753` → IC=+0.268 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9753 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` > `0.1561` → IC=+0.208 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1561 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` < `0.226` → IC=+0.191 (n=512)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.226 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.026` → IC=+0.223 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.026 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` < `0.8331` → IC=+0.196 (n=393)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.8331 (IC base=+0.191)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2622` → IC=+0.267 (n=84)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2622 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` < `1.3991` → IC=+0.225 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3991 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.4105` → IC=+0.225 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4105 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=655)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `12428.4336` → IC=+0.217 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12428.4336 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.124 (n=487)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0061 (IC base=+0.094)

- **PATRÓN** `ibs_20min` < `0.0837` → IC=+0.163 (n=185)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.0837 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.306` → IC=+0.126 (n=145)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 6.306 (IC base=+0.094)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1664` → IC=+0.131 (n=128)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` > 0.1664 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `3825.7125` → IC=+0.122 (n=493)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 3825.7125 (IC base=+0.094)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.3434` → IC=-0.139 (n=34)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3434
  - _Potencial_: sin este filtro IC_bueno=+0.089 (n=492)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.169 (n=285)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0071 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.5315` → IC=+0.135 (n=428)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.5315 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=400)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` > `0.7241` → IC=+0.203 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7241 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` > `0.9426` → IC=+0.234 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9426 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.1` → IC=+0.203 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.1 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `1.0674` → IC=+0.152 (n=377)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.0674 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.1825` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1825 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `1.482` → IC=+0.159 (n=136)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.482 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `2.2097` → IC=+0.174 (n=185)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2097 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.135 (n=466)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `3102.4168` → IC=+0.197 (n=143)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 3102.4168 (IC base=+0.133)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.173 (n=151)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 21.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` < `0.5152` → IC=+0.150 (n=395)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5152 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` < `1.8405` → IC=+0.151 (n=247)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.8405 (IC base=+0.074)

- **PATRÓN** `libro_liquidez` > `2552.1243` → IC=+0.123 (n=263)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2552.1243 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `43.0` → IC=+0.123 (n=338)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 43.0 (IC base=+0.074)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.206 (n=3376)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=10554)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.216 (n=10124)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.9817` → IC=+0.204 (n=1429)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9817 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.623` → IC=+0.226 (n=4877)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.623 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8803` → IC=+0.167 (n=4512)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8803 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.201 (n=1394)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.5993` → IC=+0.186 (n=3244)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.5993 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2347.917` → IC=+0.172 (n=6745)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2347.917 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `86.0` → IC=+0.195 (n=7694)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 86.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=6114)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.1489` → IC=+0.190 (n=4034)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5665` → IC=+0.238 (n=9168)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5665 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2497` → IC=+0.162 (n=5665)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2497 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.036` → IC=+0.200 (n=1289)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.036 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.732` → IC=+0.183 (n=8867)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.732 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.7044` → IC=+0.162 (n=2770)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.7044 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2037` → IC=+0.153 (n=2098)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2037 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2882` → IC=+0.242 (n=1208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2882 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.6294` → IC=+0.193 (n=2806)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6294 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.194 (n=5427)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 48.0 (IC base=+0.182)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.208 (n=573)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.190)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.226 (n=571)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.3586` → IC=+0.191 (n=1714)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.5477` → IC=+0.182 (n=712)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5477 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.2444` → IC=+0.198 (n=734)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.2444 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1031)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.190)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.264 (n=1347)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0045 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.1282` → IC=+0.284 (n=592)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3517` → IC=+0.289 (n=1185)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3517 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.563` → IC=+0.264 (n=1350)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.563 (IC base=+0.259)

- **PATRÓN** `volumen_pendiente_norm` > `0.2267` → IC=+0.277 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2267 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` < `1.5472` → IC=+0.258 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5472 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `2.6339` → IC=+0.278 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6339 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1804.6172` → IC=+0.263 (n=897)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1804.6172 (IC base=+0.259)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.190 (n=543)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0028 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.085` → IC=+0.163 (n=541)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.085 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1694)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3086` → IC=+0.204 (n=1622)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.74` → IC=+0.170 (n=371)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.74 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.249` → IC=+0.153 (n=1461)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.249 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.6287` → IC=+0.180 (n=541)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6287 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2672` → IC=+0.198 (n=233)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2672 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.1148` → IC=+0.162 (n=1379)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1148 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.4047` → IC=+0.155 (n=1567)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.4047 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `15747.2217` → IC=+0.159 (n=736)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 15747.2217 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `473.0` → IC=+0.158 (n=1499)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 473.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1403)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.2605` → IC=+0.166 (n=1233)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2605 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.179 (n=471)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.6597` → IC=+0.197 (n=1402)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.6597 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.6926` → IC=+0.155 (n=230)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6926 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1334` → IC=+0.166 (n=1259)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1334 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.496` → IC=+0.160 (n=236)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.496 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.279` → IC=+0.153 (n=1269)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.279 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.162 (n=1402)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1917 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1514` → IC=+0.198 (n=375)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1514 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.4071` → IC=+0.160 (n=1303)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4071 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.5117` → IC=+0.160 (n=1164)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.5117 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `421.0` → IC=+0.158 (n=1065)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 421.0 (IC base=+0.152)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.012` → IC=+0.248 (n=549)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1659)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.237 (n=720)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.232)

- **PATRÓN** `ibs_20min` < `0.3611` → IC=+0.268 (n=1346)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3611 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.766` → IC=+0.274 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.766 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` > `0.3446` → IC=+0.307 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3446 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` < `1.7536` → IC=+0.231 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7536 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.1892` → IC=+0.237 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1892 (IC base=+0.232)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.239 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `1889.7284` → IC=+0.244 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1889.7284 (IC base=+0.232)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.230 (n=1332)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.232)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.182 (n=574)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0035 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4376` → IC=+0.145 (n=1722)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4376 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.151 (n=1799)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.877` → IC=+0.261 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.877 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.375` → IC=+0.164 (n=683)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.375 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.435` → IC=+0.168 (n=284)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 11.435 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8741` → IC=+0.157 (n=1148)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8741 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2368` → IC=+0.215 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2368 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5221` → IC=+0.150 (n=733)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5221 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.768` → IC=+0.150 (n=1111)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.768 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8031.121` → IC=+0.232 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8031.121 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `91.0` → IC=+0.149 (n=705)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 91.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.157 (n=1403)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0076 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4469` → IC=+0.155 (n=1402)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4469 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.175 (n=528)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 17.0 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.143 (n=640)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 7.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.7021` → IC=+0.186 (n=1402)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.7021 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.6029` → IC=+0.144 (n=1554)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.6029 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.137` → IC=+0.178 (n=209)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 11.137 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.149 (n=935)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8616 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1867` → IC=+0.143 (n=468)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.1867 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.152 (n=1330)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `10833.0728` → IC=+0.213 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10833.0728 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `178.0` → IC=+0.147 (n=1325)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 178.0 (IC base=+0.139)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.139 (n=1143)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0081 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1759)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.192 (n=1714)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.4706 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `1.0902` → IC=+0.203 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0902 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.451` → IC=+0.233 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.451 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.8911` → IC=+0.136 (n=1141)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8911 (IC base=+0.113)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1719)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.247 (n=571)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.133 (n=1324)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1326` → IC=+0.161 (n=556)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.255 (n=1827)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5172 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `1.2864` → IC=+0.204 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2864 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.932` → IC=+0.204 (n=2029)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.932 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.834` → IC=+0.257 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.834 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `1.2357` → IC=+0.233 (n=609)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1966` → IC=+0.198 (n=1446)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.1966 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4315` → IC=+0.197 (n=1643)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4315 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1084)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.140 (n=3063)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.162 (n=2572)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0091 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.52` → IC=+0.163 (n=2922)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.52 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.165 (n=983)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 18.0 (IC base=+0.154)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.168 (n=1019)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 4.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.9422` → IC=+0.213 (n=974)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9422 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.1866` → IC=+0.166 (n=1089)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1866 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.4929` → IC=+0.148 (n=1790)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.4929 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.174` → IC=+0.180 (n=480)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 10.174 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `0.8959` → IC=+0.161 (n=1274)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.8959 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.185 (n=799)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.164 (n=962)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4564 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.8822` → IC=+0.163 (n=1924)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.8822 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2033)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `8282.6457` → IC=+0.159 (n=1325)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 8282.6457 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.197 (n=773)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0038 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.4894` → IC=+0.156 (n=2309)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.4894 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=847)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 17.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.162 (n=778)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 4.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.1824` → IC=+0.170 (n=1016)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.1824 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.6876` → IC=+0.157 (n=441)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6876 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.306` → IC=+0.149 (n=2296)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.306 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.1012` → IC=+0.149 (n=1942)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1012 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` < `0.0969` → IC=+0.141 (n=2090)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.0969 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.142 (n=1069)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.4237` → IC=+0.151 (n=760)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4237 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.8118` → IC=+0.142 (n=1520)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8118 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=3063)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `7202.6889` → IC=+0.152 (n=2063)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 7202.6889 (IC base=+0.138)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.177 (n=345)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0056 (IC base=+0.164)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.173 (n=350)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0034 (IC base=+0.164)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.199 (n=131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.172 (n=394)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` < `0.5549` → IC=+0.189 (n=262)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.5549 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.2158` → IC=+0.177 (n=190)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.2158 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` < `0.3825` → IC=+0.166 (n=378)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.3825 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.786` → IC=+0.167 (n=61)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.786 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.403` → IC=+0.174 (n=415)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` < 2.403 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `1.2355` → IC=+0.170 (n=392)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.2355 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` > `0.8402` → IC=+0.196 (n=261)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 0.8402 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.3044` → IC=+0.295 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3044 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` < `1.4419` → IC=+0.199 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4419 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6554` → IC=+0.207 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6554 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `12565.4829` → IC=+0.213 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12565.4829 (IC base=+0.164)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.171 (n=354)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 5.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.1382` → IC=+0.177 (n=416)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.1382 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.6084` → IC=+0.146 (n=428)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.6084 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.6972` → IC=+0.163 (n=87)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.6972 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.114` → IC=+0.154 (n=1032)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 9.114 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.88` → IC=+0.185 (n=630)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.88 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0691` → IC=+0.164 (n=442)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0691 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.42` → IC=+0.142 (n=314)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.42 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.8156` → IC=+0.149 (n=627)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.8156 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `11419.5725` → IC=+0.152 (n=944)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 11419.5725 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `705.0` → IC=+0.145 (n=899)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.163 (n=822)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0073 (IC base=+0.158)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.166 (n=934)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0043 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.3863` → IC=+0.163 (n=822)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.3863 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.170 (n=656)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 11.0 (IC base=+0.158)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.168 (n=326)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 4.0 (IC base=+0.158)

- **PATRÓN** `ibs_20min` < `0.5618` → IC=+0.162 (n=623)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.5618 (IC base=+0.158)

- **PATRÓN** `ibs_20min` > `0.8892` → IC=+0.169 (n=312)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.8892 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` > `0.9437` → IC=+0.165 (n=210)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.9437 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` < `0.4268` → IC=+0.167 (n=869)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.4268 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.12` → IC=+0.169 (n=839)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` < 4.12 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `1.0845` → IC=+0.159 (n=823)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.0845 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` > `0.7161` → IC=+0.161 (n=835)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.7161 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` < `0.1066` → IC=+0.161 (n=859)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.1066 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.0781` → IC=+0.165 (n=404)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0781 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `1.4364` → IC=+0.175 (n=306)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4364 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.164 (n=924)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.158)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.154 (n=785)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0083 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.3946` → IC=+0.171 (n=690)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.153 (n=526)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 10.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.7466` → IC=+0.145 (n=784)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.7466 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.0983` → IC=+0.148 (n=784)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.0983 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.6351` → IC=+0.174 (n=170)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.6351 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.388` → IC=+0.149 (n=710)
...
- **PATRÓN** `volumen_regimen` > `0.7236` → IC=+0.141 (n=701)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.7236 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.0741` → IC=+0.164 (n=331)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0741 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.1996` → IC=+0.156 (n=676)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1996 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.7807` → IC=+0.146 (n=512)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7807 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `7573.3328` → IC=+0.168 (n=784)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 7573.3328 (IC base=+0.141)
...
### GBM_LATE_60M
- **FILTRO** `sigma_h` > `0.0066` → IC=-0.210 (n=122)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `dist_vwap_pct` > `0.182` → IC=-0.179 (n=26)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.112 (n=323)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.193 (n=408)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0041 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.127 (n=861)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 8.0 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.6724` → IC=+0.207 (n=746)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6724 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.1546` → IC=+0.156 (n=457)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1546 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.429` → IC=+0.206 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.429 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.2807` → IC=+0.200 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2807 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.0918` → IC=+0.137 (n=635)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.0918 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.121 (n=673)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.02 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.143 (n=368)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2432.8034 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.057` → IC=+0.271 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.057 (IC base=+0.001)

- **PATRÓN** `volumen_pendiente_norm` > `0.0685` → IC=+0.203 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0685 (IC base=+0.001)

- **PATRÓN** `volumen_spike_ratio` < `2.5091` → IC=+0.121 (n=233)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.5091 (IC base=+0.001)

### GBM_LATE_60M#BTC#60min
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.161 (n=317)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.006 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=331)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.5161` → IC=+0.188 (n=286)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5161 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1379` → IC=+0.173 (n=151)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.1379 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.0688` → IC=+0.126 (n=252)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0688 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` < `0.1568` → IC=+0.140 (n=262)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.1568 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.173 (n=218)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.082` → IC=+0.276 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.082 (IC base=+0.047)

- **PATRÓN** `volumen_regimen` < `0.6023` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6023 (IC base=+0.047)

- **PATRÓN** `volumen_pendiente_norm` > `0.0709` → IC=+0.229 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0709 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `2.3732` → IC=+0.154 (n=105)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.3732 (IC base=+0.047)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.186 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.004 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.136 (n=295)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 7.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.6789` → IC=+0.236 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6789 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.348` → IC=+0.172 (n=114)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.348 (IC base=+0.106)
...
- **PATRÓN** `volumen_regimen` > `0.9419` → IC=+0.146 (n=128)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.9419 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.2799` → IC=+0.237 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2799 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` < `1.7335` → IC=+0.173 (n=154)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.7335 (IC base=+0.106)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=188)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `1133.2011` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1133.2011 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.1667` → IC=+0.267 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1667 (IC base=-0.023)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.956` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.956 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.1353` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1353 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `2.268` → IC=+0.176 (n=35)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.268 (IC base=-0.023)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.139 (n=81)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.02 (IC base=-0.023)
...
- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.175 (n=241)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.6667 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.1982` → IC=+0.149 (n=152)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1982 (IC base=+0.074)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.438` → IC=+0.176 (n=106)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.438 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` > `1.0643` → IC=+0.181 (n=89)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.0643 (IC base=+0.074)

- **PATRÓN** `volumen_pendiente_norm` > `0.2825` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2825 (IC base=+0.074)
...
- **FILTRO** `hora_utc` > `8.0` → IC=-0.365 (n=50)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.169 (n=152)

- **FILTRO** `dist_vwap_pct` > `0.2351` → IC=-0.333 (n=16)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.2351
  - _Potencial_: sin este filtro IC_bueno=-0.207 (n=186)

- **FILTRO** `volumen_regimen` < `0.7553` → IC=-0.353 (n=66)

  - _Acción_: SKIP cuando `volumen_regimen` < 0.7553
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.152 (n=116)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0058 (IC base=+0.092)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.132 (n=123)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 15.0 (IC base=+0.092)

- **PATRÓN** `ibs_20min` > `0.6438` → IC=+0.163 (n=256)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.6438 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.5013` → IC=+0.177 (n=60)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.5013 (IC base=+0.092)

- **PATRÓN** `volumen_spike_ratio` > `1.4872` → IC=+0.122 (n=141)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 1.4872 (IC base=+0.092)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.121 (n=703)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2919.859` → IC=+0.181 (n=236)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2919.859 (IC base=+0.106)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1792)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=790)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.132 (n=381)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=200)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.173 (n=160)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.47 (IC base=+0.013)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **FILTRO** `profundidad_ratio` < `746.1` → IC=-0.132 (n=36)
...
- **PATRÓN** `py_entrada` < `0.55` → IC=+0.159 (n=42)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `py_entrada` < 0.55 (IC base=+0.036)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.154 (n=24)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 16.0 (IC base=+0.014)

- **PATRÓN** `py_entrada` < `0.59` → IC=+0.182 (n=64)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` < 0.59 (IC base=+0.098)

- **PATRÓN** `restante_min` > `3.82` → IC=+0.135 (n=50)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 3.82 (IC base=+0.098)

- **PATRÓN** `profundidad_ratio` > `79.6` → IC=+0.182 (n=64)

  - _Acción_: Kelly boost +0.91€ cuando `profundidad_ratio` > 79.6 (IC base=+0.098)
...
- **FILTRO** `profundidad_ratio` < `56.2` → IC=-0.250 (n=38)
...
- **FILTRO** `lag_apertura_s` > `135.61` → IC=-0.208 (n=22)

  - _Acción_: SKIP cuando `lag_apertura_s` > 135.61
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=68)

- **FILTRO** `profundidad_ratio` < `26.8` → IC=-0.123 (n=59)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7534)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.167 (n=3542)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10688)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.168 (n=3663)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=11054)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.210 (n=606)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1867)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.152 (n=645)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=1992)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.192 (n=619)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1897)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=641)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1994)

- **FILTRO** `ibs_20min` > `0.2812` → IC=-0.162 (n=658)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2812
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1977)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.174 (n=605)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1851)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.177 (n=642)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1996)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2784)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2947)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=2953)
...
- **FILTRO** `py_entrada` < `0.415` → IC=-0.214 (n=197)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=601)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=10035)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=22544)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7977)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=24602)

- **FILTRO** `ibs_7min` < `0.2834` → IC=-0.235 (n=8142)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2834
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=24437)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11063)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21516)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=10001)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=30836)

- **FILTRO** `ibs_7min` > `0.2922` → IC=-0.177 (n=10207)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2922
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=30630)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.136 (n=1642)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3752)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=1287)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4107)

- **FILTRO** `ibs_7min` < `0.7115` → IC=-0.250 (n=1779)
...
- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.186 (n=1226)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4168)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.262 (n=1730)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5289)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.126 (n=2385)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4634)

- **FILTRO** `ibs_7min` > `0.7881` → IC=-0.206 (n=1754)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7881
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=5265)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.135 (n=1318)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4305)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1360)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4263)

- **FILTRO** `ibs_7min` < `0.7471` → IC=-0.191 (n=1405)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7471
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4218)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.177 (n=1405)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4218)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1423)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4279)

- **FILTRO** `ibs_7min` > `0.2604` → IC=-0.177 (n=1425)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2604
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=4277)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.182 (n=1423)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4279)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.165 (n=1253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3862)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1262)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3853)

- **FILTRO** `ibs_7min` < `0.7077` → IC=-0.243 (n=1687)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7077
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3428)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.221 (n=1181)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3934)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1713)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5794)

- **FILTRO** `ibs_7min` > `0.7442` → IC=-0.173 (n=1875)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7442
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=5632)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.240 (n=1326)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4053)

- **FILTRO** `ibs_7min` < `0.7403` → IC=-0.180 (n=1344)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7403
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=4035)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.170 (n=1317)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4062)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.259 (n=1366)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4108)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.176 (n=1367)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4107)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1350)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4124)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.253 (n=1390)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4288)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.233 (n=1405)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4273)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1844)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5930)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1744)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3646)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.228 (n=1338)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4052)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1310)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4080)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.206 (n=1754)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=5607)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1088)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3978` → IC=+0.125 (n=745)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.63€ cuando `delta_ratio` |x|> 0.3978 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.123 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 14.0 (IC base=+0.110)

- **PATRÓN** `total_vol_5m` < `471.727` → IC=+0.138 (n=249)

  - _Acción_: Kelly boost +0.69€ cuando `total_vol_5m` < 471.727 (IC base=+0.110)
...
- **PATRÓN** `delta_ratio` |x|> `0.4133` → IC=+0.170 (n=101)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.85€ cuando `delta_ratio` |x|> 0.4133 (IC base=+0.088)

- **PATRÓN** `total_vol_5m` < `394.3776` → IC=+0.196 (n=67)

  - _Acción_: Kelly boost +0.98€ cuando `total_vol_5m` < 394.3776 (IC base=+0.088)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.167 (n=52)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 69.0 (IC base=+0.088)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2927)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1494)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.221 (n=735)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.202 (n=713)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.187)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2158` → IC=+0.196 (n=541)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.98€ cuando `delta_ratio_macro` |x|> 0.2158 (IC base=+0.187)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1251` → IC=+0.233 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1251 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.196 (n=1511)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 6.0 (IC base=+0.187)

- **PATRÓN** `ibs_15` > `0.6071` → IC=+0.268 (n=1620)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6071 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` > `0.118` → IC=+0.188 (n=843)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.118 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.6245` → IC=+0.180 (n=1543)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6245 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.756` → IC=+0.282 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.756 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `2972.0706` → IC=+0.197 (n=1080)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2972.0706 (IC base=+0.187)

### UPDOWN_GBM#60min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=617)

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.220 (n=366)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.0587` → IC=+0.298 (n=122)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0587 (IC base=+0.210)

- **PATRÓN** `drift_15min` |x|≤ `0.3843` → IC=+0.210 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3843 (IC base=+0.210)
...
- **PATRÓN** `ibs_15` > `0.7061` → IC=+0.275 (n=366)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7061 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.4073` → IC=+0.257 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4073 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.239` → IC=+0.270 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.239 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `16113.4131` → IC=+0.250 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16113.4131 (IC base=+0.210)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.149 (n=166)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0041 (IC base=+0.137)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.160 (n=251)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0051 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.0674` → IC=+0.155 (n=166)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0674 (IC base=+0.137)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2344` → IC=+0.180 (n=126)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.90€ cuando `delta_ratio_macro` |x|> 0.2344 (IC base=+0.137)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2579` → IC=+0.161 (n=269)

  - _Acción_: Kelly boost +0.80€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2579 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.160 (n=280)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.141 (n=394)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 17.0 (IC base=+0.137)

- **PATRÓN** `ibs_15` > `0.6602` → IC=+0.255 (n=337)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6602 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1651` → IC=+0.153 (n=295)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1651 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.19` → IC=+0.203 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.19 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `9475.4181` → IC=+0.159 (n=171)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 9475.4181 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` > `0.0177` → IC=+0.234 (n=284)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0177 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.0864` → IC=+0.212 (n=189)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0864 (IC base=+0.187)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0393` → IC=+0.192 (n=426)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.0393 (IC base=+0.187)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0883` → IC=+0.250 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0883 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.233 (n=144)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.187)

- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.283 (n=426)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` > `0.1318` → IC=+0.211 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1318 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.8758` → IC=+0.189 (n=490)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.8758 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.796` → IC=+0.221 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.796 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.591` → IC=+0.188 (n=424)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 10.591 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `2915.737` → IC=+0.285 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2915.737 (IC base=+0.187)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.158 (n=480)
...
- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.379 (n=188)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_15` > `0.7872` → IC=+0.385 (n=414)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7872 (IC base=+0.341)

- **PATRÓN** `dist_vwap_pct` > `0.4406` → IC=+0.388 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4406 (IC base=+0.341)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `13.77` → IC=+0.343 (n=379)
...
- **PATRÓN** `libro_liquidez` > `3525.4286` → IC=+0.356 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3525.4286 (IC base=+0.341)

- **PATRÓN** `ballena_activa_n` < `463.0` → IC=+0.363 (n=342)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1054` → IC=+0.348 (n=123)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1054 (IC base=+0.334)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0897` → IC=+0.356 (n=165)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0897 (IC base=+0.334)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2925` → IC=+0.363 (n=137)
...
- **PATRÓN** `ibs_15` > `0.7403` → IC=+0.393 (n=184)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7403 (IC base=+0.334)

- **PATRÓN** `dist_vwap_pct` > `0.4658` → IC=+0.383 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4658 (IC base=+0.334)

- **PATRÓN** `dist_vwap_pct` < `0.1256` → IC=+0.341 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1256 (IC base=+0.334)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.937` → IC=+0.347 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.937 (IC base=+0.334)

- **PATRÓN** `sigma_ewma_delta_pct` < `13.694` → IC=+0.338 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 13.694 (IC base=+0.334)
...
- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.347 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 162.0 (IC base=+0.334)

### UPDOWN_GBM_15M_TARDIO
- **FILTRO** `sigma_h` > `0.0129` → IC=-0.220 (n=662)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0129
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1989)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.193 (n=901)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1750)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1378` → IC=+0.254 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1378 (IC base=-0.062)

- **PATRÓN** `ibs_15` > `0.6364` → IC=+0.277 (n=634)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6364 (IC base=-0.062)

- **PATRÓN** `dist_vwap_pct` < `0.2806` → IC=+0.186 (n=502)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.2806 (IC base=-0.062)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1204` → IC=+0.250 (n=1180)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1204 (IC base=-0.032)

- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.279 (n=1770)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3469 (IC base=-0.032)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.221 (n=403)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=1212)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.231 (n=403)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1212)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=1023)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.178 (n=592)

- **FILTRO** `sigma_ewma_delta_pct` > `19.708` → IC=-0.247 (n=291)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.708
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1324)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.162 (n=152)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0029 (IC base=+0.084)
...
- **PATRÓN** `dist_vwap_pct` < `0.5662` → IC=+0.285 (n=189)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5662 (IC base=+0.084)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.269 (n=232)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.230)

- **PATRÓN** `drift_60min` |x|≤ `0.4443` → IC=+0.231 (n=694)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4443 (IC base=+0.230)

- **PATRÓN** `drift_15min` |x|≤ `0.4794` → IC=+0.239 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4794 (IC base=+0.230)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2011` → IC=+0.260 (n=315)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2011 (IC base=+0.230)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.240 (n=275)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.230)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.240 (n=306)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.230)

- **PATRÓN** `ibs_15` < `0.3453` → IC=+0.269 (n=694)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3453 (IC base=+0.230)

- **PATRÓN** `dist_vwap_pct` > `0.778` → IC=+0.312 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.778 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.663` → IC=+0.258 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.663 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.182` → IC=+0.238 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.182 (IC base=+0.230)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `sigma_h` > `0.0076` → IC=-0.221 (n=313)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0076
  - _Potencial_: sin este filtro IC_bueno=-0.115 (n=315)

- **FILTRO** `drift_15min` |x|> `0.89` → IC=-0.266 (n=156)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.89
  - _Potencial_: sin este filtro IC_bueno=-0.135 (n=472)

- **PATRÓN** `ibs_15` > `0.8889` → IC=+0.350 (n=18)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8889 (IC base=-0.168)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0761` → IC=+0.231 (n=277)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `dist_vwap_pct` > `0.4921` → IC=+0.210 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4921 (IC base=-0.042)

- **PATRÓN** `dist_vwap_pct` < `0.2005` → IC=+0.227 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2005 (IC base=-0.042)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `sigma_h` > `0.0198` → IC=-0.260 (n=386)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0198
  - _Potencial_: sin este filtro IC_bueno=-0.135 (n=387)

- **FILTRO** `drift_15min` |x|> `1.2607` → IC=-0.269 (n=193)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.2607
  - _Potencial_: sin este filtro IC_bueno=-0.173 (n=580)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.263 (n=188)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.176 (n=585)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1334` → IC=+0.286 (n=213)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1334 (IC base=-0.043)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.103` → IC=+0.340 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.103 (IC base=-0.043)

- **PATRÓN** `ibs_15` < `0.3429` → IC=+0.307 (n=469)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `ibs_15` > `0.8393` → IC=+0.329 (n=665)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8393 (IC base=+0.294)

- **PATRÓN** `dist_vwap_pct` > `0.2788` → IC=+0.328 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2788 (IC base=+0.294)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.101` → IC=+0.331 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.101 (IC base=+0.294)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.310 (n=298)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.301)

- **PATRÓN** `drift_60min` |x|≤ `0.0692` → IC=+0.304 (n=131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0692 (IC base=+0.301)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1481` → IC=+0.315 (n=198)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1481 (IC base=+0.301)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.288` → IC=+0.341 (n=224)
...
- **PATRÓN** `ibs_15` > `0.8516` → IC=+0.343 (n=297)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8516 (IC base=+0.301)

- **PATRÓN** `dist_vwap_pct` > `0.6422` → IC=+0.312 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6422 (IC base=+0.301)

- **PATRÓN** `dist_vwap_pct` < `0.1676` → IC=+0.304 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1676 (IC base=+0.301)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.221` → IC=+0.323 (n=139)
...
- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.214 (n=61)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.120 (n=119)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6071 sube el IC de +0.187 a +0.268 en UPDOWN_GBM#15min (n=1620). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7061 sube el IC de +0.210 a +0.275 en UPDOWN_GBM#BTC#15min (n=366). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6602 sube el IC de +0.137 a +0.255 en UPDOWN_GBM#ETH#15min (n=337). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.187 a +0.283 en UPDOWN_GBM#XRP#15min (n=426). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.049 a +0.158 en UPDOWN_GBM#XRP#15min (n=480). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6364 sube el IC de -0.062 a +0.277 en UPDOWN_GBM_15M_TARDIO (n=634). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.