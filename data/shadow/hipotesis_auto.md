# Hipótesis automáticas — 2026-07-01 02:35 UTC
_Generado por shadow_postmortem.py sobre 1510 resoluciones (PNL=-61.92€)_
...
- **PATRÓN** `drift_60min` |x|≤ `0.0607` → IC=+0.152 (n=21)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.0607 (IC base=+0.042)
...
- **PATRÓN** `ibs_15` < `0.1531` → IC=+0.180 (n=23)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` < 0.1531 (IC base=+0.029)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.1531 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.180 n=23). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 509 | -0.021 | -14.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 319 | +0.020 | +3.97€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 106 | -0.046 | -7.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 159 | -0.009 | -9.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 94 | +0.042 | -1.90€ | 0 | 1 |
...
| ✅ UPDOWN_GBM#ETH | 221 | +0.011 | +3.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 153 | +0.029 | +5.25€ | 1 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.080) — sin ventaja clara. oversold(IBS<0.3): IC=-0.008 n=61 | neutral: IC=-0.088 n=66 | overbought(IBS>0.7): IC=-0.033 n=88
  - _Datos_: n=220 IC=-0.045 PNL=-15.61€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=410 IC=-0.015 PNL=-8.84€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=410 IC=-0.015 PNL=-8.84€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=250 IC=-0.008 PNL=-14.61€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=250 IC=-0.008 PNL=-14.61€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=94 IC=+0.042 PNL=-1.90€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=94 IC=+0.042 PNL=-1.90€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=143 IC=+0.031 PNL=-3.81€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=143 IC=+0.031 PNL=-3.81€
