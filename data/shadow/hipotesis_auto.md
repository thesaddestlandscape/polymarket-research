# Hipótesis automáticas — 2026-07-16 12:11 UTC
_Generado por shadow_postmortem.py sobre 16933 resoluciones (PNL=+3454.29€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.178 (n=663)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 11.0 (IC base=+0.178)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.207 (n=463)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.178)

- **PATRÓN** `py_entrada` > `0.695` → IC=+0.296 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.178)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=1077)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.01 (IC base=+0.178)

- **PATRÓN** `libro_liquidez` > `4341.2879` → IC=+0.186 (n=615)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 4341.2879 (IC base=+0.178)
...
- **PATRÓN** `py_entrada` < `0.265` → IC=+0.329 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.177 (n=1135)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `7351.4655` → IC=+0.182 (n=331)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 7351.4655 (IC base=+0.167)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.208 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.257 (n=183)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.222 (n=156)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.205)

- **PATRÓN** `py_entrada` < `0.225` → IC=+0.405 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.225 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `7106.2104` → IC=+0.206 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7106.2104 (IC base=+0.205)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=52)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.565` → IC=+0.179 (n=26)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` < 0.565 (IC base=+0.129)

- **PATRÓN** `py_entrada` > `0.605` → IC=+0.130 (n=25)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` > 0.605 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `6926.0677` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 6926.0677 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=25)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.158)
...
- **PATRÓN** `libro_liquidez` > `7105.7782` → IC=+0.185 (n=52)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 7105.7782 (IC base=+0.158)

### FAVORITO_CONFIRMADO#ETH#15min
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.233 (n=133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.219)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.225 (n=209)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.219)

- **PATRÓN** `py_entrada` > `0.715` → IC=+0.356 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.715 (IC base=+0.219)

- **PATRÓN** `libro_liquidez` > `5188.295` → IC=+0.220 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5188.295 (IC base=+0.219)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.250 (n=82)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.205)

- **PATRÓN** `py_entrada` < `0.265` → IC=+0.363 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `3709.4417` → IC=+0.212 (n=210)
...
- **PATRÓN** `libro_liquidez` > `5697.4897` → IC=+0.218 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5697.4897 (IC base=+0.153)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.225 (n=67)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.217)

- **PATRÓN** `py_entrada` > `0.615` → IC=+0.274 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.615 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1591.9819` → IC=+0.220 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1591.9819 (IC base=+0.217)
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.266 (n=186)
...
- **PATRÓN** `py_entrada` < `0.64` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` < 0.64 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=51)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.145 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 7.0 (IC base=+0.087)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.041` → IC=+0.226 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.041 (IC base=+0.107)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.136 (n=1249)
...
- **PATRÓN** `dist_vwap_pct` > `0.2945` → IC=+0.121 (n=27)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` > 0.2945 (IC base=+0.071)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.181` → IC=+0.200 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.181 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.4662` → IC=+0.121 (n=159)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.4662 (IC base=+0.062)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.206` → IC=+0.177 (n=60)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.206 (IC base=+0.062)

### GBM_LATE_15M#ETH#15min
- **FILTRO** `sigma_ewma_delta_pct` < `7.25` → IC=-0.132 (n=36)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` < 7.25
  - _Potencial_: sin este filtro IC_bueno=+0.255 (n=47)

- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.154 (n=128)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0045 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.6633` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6633 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.25` → IC=+0.255 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.25 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.7422` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.7422 (IC base=+0.066)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.447` → IC=+0.174 (n=44)
...
- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.136 (n=212)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0107 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.139 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 18.0 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.561` → IC=+0.222 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.561 (IC base=+0.109)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.149 (n=314)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0114 (IC base=+0.131)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.134 (n=471)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0092 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.179 (n=213)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 7.0 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.875` → IC=+0.123 (n=128)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 2.875 (IC base=+0.131)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.171 (n=299)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0175 (IC base=+0.149)
...
- **PATRÓN** `dist_vwap_pct` < `0.1365` → IC=+0.122 (n=125)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.1365 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.138` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.138 (IC base=+0.149)

- **PATRÓN** `sigma_h` > `0.0279` → IC=+0.210 (n=160)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0279 (IC base=+0.165)
...
- **PATRÓN** `dist_vwap_pct` > `0.3145` → IC=+0.143 (n=54)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.3145 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` < `0.5085` → IC=+0.146 (n=193)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.5085 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.494` → IC=+0.142 (n=174)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 7.494 (IC base=+0.165)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.221 (n=335)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.162 (n=770)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 18.0 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.1504` → IC=+0.196 (n=284)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1504 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.998` → IC=+0.298 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.998 (IC base=+0.156)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.178 (n=768)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0048 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.164 (n=555)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 11.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.190 (n=259)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 5.0 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` < `0.4154` → IC=+0.195 (n=552)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.4154 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.089` → IC=+0.240 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.089 (IC base=+0.162)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.135 (n=179)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0028 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.161 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 12.0 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.5737` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5737 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.905` → IC=+0.210 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.905 (IC base=+0.111)

- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.170 (n=195)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0028 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=76)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.4662` → IC=+0.131 (n=158)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.4662 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.827` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.827 (IC base=+0.136)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.228 (n=90)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.159 (n=136)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 12.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.157 (n=208)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 18.0 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.3208` → IC=+0.171 (n=68)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.3208 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `1.1271` → IC=+0.129 (n=141)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 1.1271 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.752` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.752 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.146 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0068 (IC base=+0.133)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.148 (n=197)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0037 (IC base=+0.133)
...
- **PATRÓN** `dist_vwap_pct` > `0.759` → IC=+0.182 (n=42)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.759 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.3977` → IC=+0.170 (n=116)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3977 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.012` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.012 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.305` → IC=+0.157 (n=129)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 12.305 (IC base=+0.133)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `3.13` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 3.13
  - _Potencial_: sin este filtro IC_bueno=+0.158 (n=118)

- **PATRÓN** `sigma_h` > `0.0126` → IC=+0.216 (n=93)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.9959` → IC=+0.148 (n=157)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.9959 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.082` → IC=+0.271 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.082 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0124` → IC=+0.128 (n=205)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0124 (IC base=+0.104)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.145 (n=74)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 5.0 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` < `0.2522` → IC=+0.172 (n=126)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.2522 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.13` → IC=+0.158 (n=118)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 3.13 (IC base=+0.104)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.0222` → IC=+0.276 (n=159)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0222 (IC base=+0.251)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.255 (n=145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.251)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.293 (n=143)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.801` → IC=+0.361 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.801 (IC base=+0.251)

- **PATRÓN** `sigma_h` < `0.0172` → IC=+0.293 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0172 (IC base=+0.292)

- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.322 (n=172)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0087 (IC base=+0.292)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.292 (n=128)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.292)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.301 (n=174)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.292)

- **PATRÓN** `dist_vwap_pct` < `0.5139` → IC=+0.312 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5139 (IC base=+0.292)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.048` → IC=+0.317 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.048 (IC base=+0.292)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.200 (n=231)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0151 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.130 (n=609)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 15.0 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.3431` → IC=+0.171 (n=174)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3431 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.1391` → IC=+0.139 (n=261)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1391 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.256` → IC=+0.297 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.256 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.126 (n=303)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 6.0 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` < `0.361` → IC=+0.123 (n=521)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.361 (IC base=+0.091)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` > `0.4395` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.4395 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.755` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 13.755 (IC base=+0.083)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.120 (n=77)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 16.0 (IC base=+0.068)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.138 (n=78)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0046 (IC base=+0.050)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.551` → IC=+0.333 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.551 (IC base=+0.050)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.626` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 7.626 (IC base=+0.021)
...
- **PATRÓN** `sigma_h` > `0.0129` → IC=+0.144 (n=71)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0129 (IC base=+0.086)
...
- **PATRÓN** `dist_vwap_pct` > `0.8694` → IC=+0.167 (n=16)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.8694 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` < `0.3894` → IC=+0.149 (n=72)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.3894 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.311` → IC=+0.333 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.311 (IC base=+0.086)
...
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.222 (n=203)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.231 (n=180)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.2687` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2687 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.43` → IC=+0.222 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.43 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.107` → IC=+0.224 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.107 (IC base=+0.206)

- **PATRÓN** `sigma_h` > `0.0272` → IC=+0.247 (n=81)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.4836` → IC=+0.190 (n=188)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.4836 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.963` → IC=+0.196 (n=169)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 7.963 (IC base=+0.199)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.145 (n=29)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 14.0 (IC base=+0.048)

- **PATRÓN** `py_entrada` < `0.48` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `py_entrada` < 0.48 (IC base=+0.048)

- **PATRÓN** `libro_liquidez` > `2201.6174` → IC=+0.130 (n=25)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2201.6174 (IC base=+0.048)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.138 (n=56)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 17.0 (IC base=+0.108)

- **PATRÓN** `py_entrada` < `0.505` → IC=+0.161 (n=57)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` < 0.505 (IC base=+0.108)
...
- **FILTRO** `libro_liquidez` < `3196.8316` → IC=-0.125 (n=38)

  - _Acción_: SKIP cuando `libro_liquidez` < 3196.8316
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.130 (n=25)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 9.0 (IC base=+0.040)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `py_entrada` > 0.505 (IC base=+0.040)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.040)
...
### UPDOWN_GBM#15min
- **FILTRO** `sigma_ewma_delta_pct` > `19.835` → IC=-0.136 (n=20)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.835
  - _Potencial_: sin este filtro IC_bueno=+0.119 (n=158)

- **PATRÓN** `ibs_15` > `0.7204` → IC=+0.178 (n=265)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.89€ cuando `ibs_15` > 0.7204 (IC base=+0.027)

- **PATRÓN** `dist_vwap_pct` > `0.7415` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.7415 (IC base=+0.027)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.541` → IC=+0.138 (n=45)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 3.541 (IC base=+0.027)

- **PATRÓN** `ibs_15` < `0.0266` → IC=+0.121 (n=143)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.60€ cuando `ibs_15` < 0.0266 (IC base=+0.047)

- **PATRÓN** `dist_vwap_pct` > `0.9263` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.9263 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` < `16.557` → IC=+0.122 (n=149)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 16.557 (IC base=+0.047)
...
- **PATRÓN** `drift_60min` |x|≤ `0.241` → IC=+0.130 (n=190)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.241 (IC base=+0.075)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.154 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 11.0 (IC base=+0.075)

- **PATRÓN** `ibs_15` < `0.9252` → IC=+0.134 (n=151)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.67€ cuando `ibs_15` < 0.9252 (IC base=+0.075)

- **PATRÓN** `ibs_15` > `0.6354` → IC=+0.193 (n=151)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.96€ cuando `ibs_15` > 0.6354 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` > `0.7608` → IC=+0.300 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7608 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.517` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 4.517 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.039` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 7.039 (IC base=+0.075)
...
- **FILTRO** `sigma_ewma_delta_pct` > `21.438` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 21.438
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7204 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.178 n=265). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6354 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.193 n=151). Confirma señal de reversión media → alinear con BUY_NO.
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION` — IC=+0.289 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min` — IC=+0.289 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL` — IC=+0.289 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min` — IC=+0.289 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#ETH#15min` — IC=+0.183 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#ETH` — IC=+0.183 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2551 | +0.172 | -72.67€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1641 | +0.209 | +6.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 109 | +0.013 | -19.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 366 | +0.090 | -61.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 435 | +0.143 | +1.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 740 | +0.176 | -22.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 549 | +0.202 | -18.06€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 36 | +0.026 | -6.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 145 | +0.146 | +6.12€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#ETH | 909 | +0.173 | -8.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 544 | +0.212 | +12.54€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 36 | -0.079 | -12.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 184 | +0.107 | -23.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 145 | +0.167 | +14.39€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 894 | +0.170 | -38.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 540 | +0.214 | +15.30€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 37 | +0.090 | -0.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 172 | +0.092 | -34.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 145 | +0.112 | -18.73€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 8 | +0.000 | -3.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 8 | +0.000 | -3.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 36 | +0.289 | +0.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 36 | +0.289 | +0.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 36 | +0.289 | +0.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 36 | +0.289 | +0.82€ | 0 | 0 |
| ✅ GBM_LATE_15M | 4881 | +0.102 | +1522.38€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4881 | +0.102 | +1522.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1170 | +0.063 | +163.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1170 | +0.063 | +163.77€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1168 | +0.074 | +195.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1168 | +0.074 | +195.44€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1307 | +0.110 | +529.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1307 | +0.110 | +529.02€ | 1 | 7 |
| ✅ GBM_LATE_15M#XRP | 1236 | +0.158 | +634.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1236 | +0.158 | +634.16€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2102 | +0.148 | +1216.99€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2102 | +0.148 | +1216.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 538 | +0.109 | +263.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 538 | +0.109 | +263.00€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 557 | +0.124 | +252.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 557 | +0.124 | +252.08€ | 0 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 567 | +0.110 | +244.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 567 | +0.110 | +244.33€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 440 | +0.274 | +457.59€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 440 | +0.274 | +457.59€ | 0 | 11 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 80 | +0.110 | +30.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 80 | +0.110 | +30.47€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 52 | +0.259 | +33.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 52 | +0.259 | +33.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 2079 | +0.091 | +628.79€ | 0 | 7 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2079 | +0.091 | +628.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 514 | +0.056 | +87.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 514 | +0.056 | +87.11€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 482 | +0.019 | +8.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 482 | +0.019 | +8.33€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 489 | +0.064 | +100.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 489 | +0.064 | +100.17€ | 2 | 6 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 594 | +0.203 | +433.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 594 | +0.203 | +433.18€ | 0 | 10 |
...
| ✅ LEADLAG_BTC_XRP_15M | 143 | +0.079 | +25.47€ | 0 | 5 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 143 | +0.079 | +25.47€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 143 | +0.079 | +25.47€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 143 | +0.079 | +25.47€ | 0 | 5 |
...
| 🚫 STREAK_MOM_5M | 313 | -0.056 | -23.62€ | 7 | 0 |
| ✅ STREAK_MOM_5M#5min | 313 | -0.056 | -23.62€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 105 | -0.051 | -6.31€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 105 | -0.051 | -6.31€ | 2 | 0 |
| ✅ STREAK_MOM_5M#SOL | 110 | -0.009 | -3.97€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 110 | -0.009 | -3.97€ | 2 | 3 |
...
| ✅ UPDOWN_GBM | 1598 | +0.010 | +75.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1340 | +0.036 | +112.23€ | 1 | 6 |
...
| ✅ UPDOWN_GBM#BTC | 412 | +0.027 | +29.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 331 | +0.065 | +42.72€ | 1 | 10 |
...
| ✅ UPDOWN_GBM#ETH | 768 | +0.018 | +36.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 675 | +0.035 | +47.42€ | 2 | 3 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 128 | +0.177 | +34.65€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 128 | +0.177 | +34.65€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 7 | -0.019 | +2.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 7 | -0.019 | +2.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 18 | +0.090 | +4.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 18 | +0.090 | +4.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 39 | +0.183 | +4.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 39 | +0.183 | +4.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 41 | +0.198 | +18.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 41 | +0.198 | +18.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 19 | +0.158 | +2.71€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 19 | +0.158 | +2.71€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.153: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.006 n=498 | neutral: IC=-0.020 n=373 | overbought(IBS>0.7): IC=+0.133 n=407
  - _Datos_: n=1352 IC=+0.044 PNL=+134.89€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.102 n=9850 | tras_1loss IC=+0.069 n=6874 | tras_2loss IC=+0.038 n=2934/40 | gap=+0.064 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.096 n=102/60 | contraria IC=+0.177 n=29 | gap=-0.081 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1471 IC=+0.017 PNL=+89.19€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1471 IC=+0.017 PNL=+89.19€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=704 IC=+0.027 PNL=+48.33€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=704 IC=+0.027 PNL=+48.33€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=331 IC=+0.065 PNL=+42.72€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=331 IC=+0.065 PNL=+42.72€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=710 IC=+0.074 PNL=+95.23€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=710 IC=+0.074 PNL=+95.23€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=601 IC=+0.032 PNL=+40.06€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=601 IC=+0.032 PNL=+40.06€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=78 IC=+0.037 PNL=+34.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=78 IC=+0.037 PNL=+34.97€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=14475 IC=+0.106 PNL=+3530.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=14475 IC=+0.106 PNL=+3530.17€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=156 IC=+0.013 PNL=+8.60€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=156 IC=+0.013 PNL=+8.60€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=852 IC=-0.004 PNL=+18.79€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=852 IC=-0.004 PNL=+18.79€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=411 PNL=+137.90€
  - _Datos_: n=411 IC=+0.159 PNL=+137.90€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=494 IC=-0.081 PNL=+86.32€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=494 IC=-0.081 PNL=+86.32€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=626 IC=+0.056 PNL=+70.86€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=626 IC=+0.056 PNL=+70.86€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.146 > 0.08 con n=300 PNL=+94.57€
  - _Datos_: n=300 IC=+0.146 PNL=+94.57€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.206 > 0.08 con n=134 PNL=+60.91€
  - _Datos_: n=134 IC=+0.206 PNL=+60.91€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.180 < -0.1 con n=404 PNL=-81.77€
  - _Datos_: n=404 IC=-0.180 PNL=-81.77€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.244 > 0.2 con n=354 PNL=+242.53€
  - _Datos_: n=354 IC=+0.244 PNL=+242.53€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.133 > 0.08 con n=164 PNL=+48.04€
  - _Datos_: n=164 IC=+0.133 PNL=+48.04€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.105 > 0.08 con n=155 PNL=+57.10€
  - _Datos_: n=155 IC=+0.105 PNL=+57.10€
...
**🔶 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.172 n=205) pero sin cruzar ≥2 pares más — BTC: n=148 IC=-0.007; ETH: n=112 IC=+0.000; SOL: n=216 IC=+0.064 ✓
  - _Datos_: n=205 IC=+0.172 PNL=+134.67€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.202 > 0.08 con n=132 PNL=+1.99€
  - _Datos_: n=132 IC=+0.202 PNL=+1.99€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.251 > 0.08 con n=195 PNL=-8.64€
  - _Datos_: n=195 IC=+0.251 PNL=-8.64€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Datos_: n=72 IC=+0.108 PNL=+21.02€
