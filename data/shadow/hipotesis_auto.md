# Hipótesis automáticas — 2026-08-08 11:38 UTC
_Generado por shadow_postmortem.py sobre 92107 resoluciones (PNL=+13872.18€)_
...
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.206 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.126)

- **PATRÓN** `restante_min` < `4.55` → IC=+0.167 (n=244)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` < 4.55 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.143 (n=376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 6.0 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.141 (n=329)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 15.0 (IC base=+0.126)

- **PATRÓN** `profundidad_ratio_no` > `11.3` → IC=+0.155 (n=166)

  - _Acción_: Kelly boost +0.77€ cuando `profundidad_ratio_no` > 11.3 (IC base=+0.126)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.294 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.111)

- **PATRÓN** `restante_min` < `4.77` → IC=+0.154 (n=160)

  - _Acción_: Kelly boost +0.77€ cuando `restante_min` < 4.77 (IC base=+0.111)
...
- **PATRÓN** `py_entrada` < `0.42` → IC=+0.191 (n=124)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.42 (IC base=+0.141)

- **PATRÓN** `py_entrada` > `0.38` → IC=+0.145 (n=184)

  - _Acción_: Kelly boost +0.73€ cuando `py_entrada` > 0.38 (IC base=+0.141)

- **PATRÓN** `restante_min` < `4.61` → IC=+0.185 (n=122)

  - _Acción_: Kelly boost +0.93€ cuando `restante_min` < 4.61 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.165 (n=189)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.152 (n=185)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 17.0 (IC base=+0.141)

- **PATRÓN** `profundidad_ratio_no` > `5.9` → IC=+0.173 (n=163)

  - _Acción_: Kelly boost +0.86€ cuando `profundidad_ratio_no` > 5.9 (IC base=+0.141)
...
| ✅ BALLENAS_TARDIAS | 2050 | -0.083 | -411.24€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 395 | +0.205 | -43.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 1655 | -0.152 | -367.27€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 350 | -0.193 | -73.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 350 | -0.193 | -73.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 343 | -0.057 | -139.78€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 343 | -0.057 | -139.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 24655 | +0.119 | -588.21€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6087 | +0.195 | -97.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 441 | +0.051 | -39.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 16269 | +0.089 | -504.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1858 | +0.139 | +54.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2593 | +0.088 | -119.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 11 | +0.021 | -0.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2577 | +0.088 | -122.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5341 | +0.129 | -87.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1911 | +0.183 | -94.34€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 141 | +0.052 | -15.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2585 | +0.089 | -43.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 704 | +0.149 | +65.93€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2592 | +0.077 | -151.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 15 | +0.243 | +10.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2576 | +0.075 | -164.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 5775 | +0.135 | -31.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2038 | +0.197 | +5.56€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 146 | -0.013 | -31.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2988 | +0.100 | -19.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 603 | +0.131 | +15.14€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5733 | +0.136 | -162.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2073 | +0.205 | -17.59€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 146 | +0.108 | +4.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2963 | +0.089 | -122.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 551 | +0.135 | -27.01€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2621 | +0.095 | -35.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 39 | +0.134 | -2.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2580 | +0.094 | -32.82€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 10783 | +0.196 | -822.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 10783 | +0.196 | -822.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1930 | +0.157 | -263.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1930 | +0.157 | -263.02€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 1734 | +0.214 | -69.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 1734 | +0.214 | -69.70€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 485 | +0.126 | +8.93€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 485 | +0.126 | +8.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 242 | +0.111 | -5.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 242 | +0.111 | -5.06€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 243 | +0.141 | +13.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 243 | +0.141 | +13.99€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 10150 | +0.126 | +5063.03€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 10150 | +0.126 | +5063.03€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.128 n=56213 | tras_1loss IC=+0.086 n=35640 | tras_2loss IC=+0.053 n=14714/40 | gap=+0.076 (umbral 0.05)
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1930 IC=+0.157 PNL=-263.02€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1930 IC=+0.157 PNL=-263.02€
