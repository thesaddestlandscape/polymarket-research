# Hipótesis automáticas — 2026-08-28 03:44 UTC
_Generado por shadow_postmortem.py sobre 182854 resoluciones (PNL=+13279.57€)_
...
- **PATRÓN** `banda_hit_calibrado` > `0.8187` → IC=+0.321 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8187 (IC base=+0.201)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.36` → IC=-0.287 (n=2549)
...
- **FILTRO** `restante_s_al_confirmar` < `161.45` → IC=-0.171 (n=690)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2072)
...
- **FILTRO** `restante_s_al_confirmar` < `152.41` → IC=-0.354 (n=588)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=1195)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.189 (n=5641)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1623)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2376.0723` → IC=+0.173 (n=1567)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.158 (n=4492)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=819)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `13072.4309` → IC=+0.219 (n=215)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.128 (n=1066)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.192 (n=657)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=3977)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.187)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.200 (n=2239)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.179 (n=1021)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.219 (n=9311)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.242 (n=1264)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.135 (n=1043)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.231` → IC=+0.160 (n=961)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3076` → IC=+0.160 (n=186)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.3076 (IC base=+0.067)
...
- **PATRÓN** `ibs_20min` < `0.2135` → IC=+0.132 (n=1613)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2135 (IC base=+0.030)

- **PATRÓN** `dist_vwap_pct` < `0.3017` → IC=+0.143 (n=816)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.3017 (IC base=+0.030)

- **PATRÓN** `volumen_regimen` < `0.6279` → IC=+0.157 (n=263)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6279 (IC base=+0.030)

- **PATRÓN** `volumen_regimen` > `1.0603` → IC=+0.141 (n=357)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.0603 (IC base=+0.030)

- **PATRÓN** `volumen_pendiente_norm` > `0.3058` → IC=+0.274 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3058 (IC base=+0.030)

- **PATRÓN** `volumen_spike_ratio` > `2.9116` → IC=+0.233 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9116 (IC base=+0.030)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.222 (n=429)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.178 (n=178)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0075 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.177 (n=193)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 6.0 (IC base=+0.126)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1423` → IC=+0.148 (n=126)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.1423 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.155 (n=337)
...
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.141 (n=154)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0057 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.160 (n=154)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.148 (n=461)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 17.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.4388` → IC=+0.173 (n=405)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.4388 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1371` → IC=+0.164 (n=385)
...
- **PATRÓN** `volumen_regimen` < `0.6283` → IC=+0.186 (n=154)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6283 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.025` → IC=+0.144 (n=209)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.025 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7548` → IC=+0.175 (n=238)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.7548 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.4103` → IC=+0.160 (n=357)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.4103 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=594)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `14470.1116` → IC=+0.179 (n=154)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 14470.1116 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.275 (n=358)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0094 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.1318` → IC=+0.294 (n=158)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.285 (n=142)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.578` → IC=+0.268 (n=390)
...
- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.242 (n=157)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 49.0 (IC base=+0.259)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.966` → IC=-0.156 (n=283)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.719` → IC=-0.157 (n=196)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1016)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.139 (n=1357)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `1.2859` → IC=+0.291 (n=247)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2859 (IC base=+0.057)

- **PATRÓN** `volumen_regimen` > `1.1726` → IC=+0.200 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1726 (IC base=+0.057)

- **PATRÓN** `volumen_pendiente_norm` < `0.115` → IC=+0.176 (n=1349)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` < 0.115 (IC base=+0.057)

- **PATRÓN** `volumen_pendiente_norm` > `0.249` → IC=+0.208 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.249 (IC base=+0.057)

- **PATRÓN** `volumen_spike_ratio` < `1.4786` → IC=+0.205 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4786 (IC base=+0.057)

- **PATRÓN** `volumen_spike_ratio` > `2.8261` → IC=+0.175 (n=462)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.8261 (IC base=+0.057)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.278 (n=837)
...
- **PATRÓN** `volumen_spike_ratio` > `1.6341` → IC=+0.261 (n=618)
...
- **FILTRO** `ibs_20min` < `0.2584` → IC=-0.160 (n=198)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=404)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.238` → IC=+0.178 (n=116)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.238 (IC base=-0.002)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2366` → IC=+0.354 (n=176)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2366 (IC base=+0.341)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.378 (n=187)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.341)

- **PATRÓN** `ibs_20min` < `0.3415` → IC=+0.357 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3415 (IC base=+0.341)

- **PATRÓN** `ibs_20min` > `0.1351` → IC=+0.343 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1351 (IC base=+0.341)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.484` → IC=+0.353 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.484 (IC base=+0.341)
...
- **PATRÓN** `volumen_spike_ratio` < `3.2115` → IC=+0.337 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.2115 (IC base=+0.341)

- **PATRÓN** `volumen_spike_ratio` > `1.9885` → IC=+0.339 (n=153)
...
- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.333 (n=58)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 32.0 (IC base=+0.341)
...
- **PATRÓN** `sigma_h` > `0.0248` → IC=+0.327 (n=194)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.232 (n=218)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.223)

- **PATRÓN** `ibs_20min` > `0.8983` → IC=+0.302 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8983 (IC base=+0.223)

- **PATRÓN** `dist_vwap_pct` > `1.3817` → IC=+0.346 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3817 (IC base=+0.223)
...
- **PATRÓN** `volumen_regimen` > `0.8368` → IC=+0.253 (n=387)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8368 (IC base=+0.223)

- **PATRÓN** `volumen_pendiente_norm` < `0.0804` → IC=+0.229 (n=493)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4123` → IC=+0.261 (n=174)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4123 (IC base=+0.223)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.235 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `2451.9374` → IC=+0.232 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2451.9374 (IC base=+0.223)
...
- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.192 (n=867)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0102 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.3391` → IC=+0.158 (n=2285)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.352` → IC=+0.245 (n=1079)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.352 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.171 (n=1610)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2818` → IC=+0.155 (n=2064)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.2818 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.8493` → IC=+0.150 (n=1563)
...
- **PATRÓN** `libro_liquidez` > `3974.1116` → IC=+0.183 (n=866)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 3974.1116 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.179 (n=1324)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 116.0 (IC base=+0.156)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.196 (n=2035)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0076 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.4229` → IC=+0.194 (n=2313)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.4229 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.213 (n=876)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` < `0.4085` → IC=+0.238 (n=2313)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4085 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.2145` → IC=+0.177 (n=1861)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.2145 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.887` → IC=+0.215 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.887 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `1.1729` → IC=+0.165 (n=1847)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1729 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `0.8545` → IC=+0.175 (n=1231)
...
- **PATRÓN** `drift_60min` |x|≤ `0.269` → IC=+0.155 (n=424)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.269 (IC base=+0.149)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.217 (n=157)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.092` → IC=+0.333 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.092 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1454` → IC=+0.189 (n=101)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1454 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.137 (n=345)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.158 (n=191)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.03 (IC base=+0.149)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2264` → IC=+0.175 (n=407)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.2264 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.168 (n=422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` < `0.4197` → IC=+0.188 (n=463)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.4197 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.7052` → IC=+0.145 (n=74)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.7052 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.171 (n=451)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.466` → IC=+0.226 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.466 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.6405` → IC=+0.226 (n=155)
...
- **PATRÓN** `libro_liquidez` > `14545.069` → IC=+0.160 (n=154)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 14545.069 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.292 (n=253)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.273)

- **PATRÓN** `drift_60min` |x|≤ `0.3735` → IC=+0.309 (n=223)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3735 (IC base=+0.273)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3645` → IC=+0.433 (n=28)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3645 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` > `3.1717` → IC=+0.283 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1717 (IC base=+0.273)

- **PATRÓN** `ballena_activa_n` < `52.0` → IC=+0.238 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 52.0 (IC base=+0.273)
...
- **PATRÓN** `drift_60min` |x|≤ `0.381` → IC=+0.163 (n=443)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.381 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.174 (n=225)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 14.0 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.151 (n=170)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 5.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` < `0.3411` → IC=+0.212 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3411 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.1494` → IC=+0.160 (n=451)
...
- **PATRÓN** `volumen_regimen` < `1.1652` → IC=+0.156 (n=443)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1652 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6135` → IC=+0.158 (n=443)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6135 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8946` → IC=+0.181 (n=224)
...
- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.143 (n=113)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 126.0 (IC base=+0.144)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.199 (n=141)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.683` → IC=+0.147 (n=100)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.683 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.2188` → IC=+0.142 (n=389)
...
- **PATRÓN** `volumen_regimen` < `1.1404` → IC=+0.138 (n=421)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.1404 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `0.8432` → IC=+0.163 (n=280)
...
- **PATRÓN** `libro_liquidez` > `2095.1686` → IC=+0.181 (n=280)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2095.1686 (IC base=+0.128)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1648` → IC=+0.194 (n=240)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.1648 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=194)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.9123` → IC=+0.267 (n=363)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.118` → IC=+0.246 (n=282)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.118 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6832` → IC=+0.185 (n=487)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.6832 (IC base=+0.169)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1453` → IC=+0.185 (n=446)
...
- **PATRÓN** `libro_liquidez` > `2450.0308` → IC=+0.173 (n=545)
...
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.137 (n=155)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.008 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.188 (n=235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 16.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.6252` → IC=+0.169 (n=415)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.6252 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.7947` → IC=+0.283 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7947 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.086` → IC=+0.197 (n=130)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 8.086 (IC base=+0.099)
...
- **PATRÓN** `libro_liquidez` > `2800.762` → IC=+0.131 (n=310)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2800.762 (IC base=+0.099)
...
- **PATRÓN** `sigma_h` > `0.006` → IC=+0.221 (n=41)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.006 (IC base=+0.090)

- **PATRÓN** `ibs_20min` > `0.6522` → IC=+0.149 (n=55)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.6522 (IC base=+0.090)

- **PATRÓN** `dist_vwap_pct` > `0.2226` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.2226 (IC base=+0.090)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.306` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.306 (IC base=+0.090)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.143 (n=54)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.090)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.193 (n=1371)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9402` → IC=+0.289 (n=1371)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.503` → IC=+0.228 (n=1772)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.503 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.8775` → IC=+0.147 (n=1428)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1653` → IC=+0.180 (n=782)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1653 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.307` → IC=+0.149 (n=2380)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.307 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.8616` → IC=+0.159 (n=1803)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3003` → IC=+0.208 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3003 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `177.0` → IC=+0.169 (n=1597)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.172 (n=327)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.327` → IC=+0.303 (n=293)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9026` → IC=+0.146 (n=272)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.9026 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=289)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2725` → IC=+0.187 (n=397)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.2725 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.168 (n=420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.165)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.177 (n=469)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 18.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` < `0.3841` → IC=+0.212 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3841 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` < `0.1415` → IC=+0.181 (n=387)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1415 (IC base=+0.165)
...
- **PATRÓN** `volumen_regimen` < `0.6259` → IC=+0.239 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6259 (IC base=+0.165)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4919` → IC=+0.189 (n=355)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.4919 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.5092` → IC=+0.183 (n=317)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.5092 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=583)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `12401.831` → IC=+0.181 (n=205)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 12401.831 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `308.0` → IC=+0.193 (n=86)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 308.0 (IC base=+0.165)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1262` → IC=+0.253 (n=172)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.291 (n=156)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.249)

- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.314 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.249)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.008` → IC=+0.284 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.008 (IC base=+0.249)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7663` → IC=+0.261 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7663 (IC base=+0.249)

- **PATRÓN** `volumen_spike_ratio` > `2.4041` → IC=+0.218 (n=179)
...
- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.202 (n=186)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5098` → IC=+0.166 (n=402)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.5098 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.182 (n=284)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` < `0.3924` → IC=+0.157 (n=391)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.3924 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` > `1.1599` → IC=+0.176 (n=134)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.1599 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.2348` → IC=+0.330 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2348 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.2105` → IC=+0.172 (n=303)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.2105 (IC base=+0.152)
...
- **PATRÓN** `libro_liquidez` > `9534.8435` → IC=+0.217 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9534.8435 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.229 (n=142)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5416` → IC=+0.125 (n=489)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5909` → IC=+0.201 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5909 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.4735` → IC=+0.142 (n=437)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.4735 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.042` → IC=+0.135 (n=478)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 3.042 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.7055` → IC=+0.145 (n=215)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.7055 (IC base=+0.113)
...
- **PATRÓN** `sigma_h` > `0.0228` → IC=+0.218 (n=285)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0228 (IC base=+0.179)
...
- **PATRÓN** `ibs_20min` > `0.9615` → IC=+0.294 (n=285)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9615 (IC base=+0.179)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.968` → IC=+0.267 (n=247)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.968 (IC base=+0.179)

- **PATRÓN** `volumen_regimen` < `0.6101` → IC=+0.189 (n=210)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6101 (IC base=+0.179)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8188` → IC=+0.188 (n=386)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.8188 (IC base=+0.179)
...
- **PATRÓN** `libro_liquidez` > `3084.4124` → IC=+0.184 (n=210)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 3084.4124 (IC base=+0.179)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.227 (n=360)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.149 (n=1076)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3722` → IC=+0.168 (n=721)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3722 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.163 (n=315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 17.0 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.196 (n=320)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 4.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` < `0.743` → IC=+0.148 (n=819)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.743 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.085` → IC=+0.152 (n=819)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.085 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.6469` → IC=+0.160 (n=189)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.6469 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.4023` → IC=+0.138 (n=790)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.4023 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.061` → IC=+0.153 (n=822)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.061 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `1.2231` → IC=+0.152 (n=796)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2231 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` < `0.0944` → IC=+0.149 (n=738)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.0944 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4174` → IC=+0.154 (n=810)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4174 (IC base=+0.144)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=1076)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.170 (n=883)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=2709)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.217 (n=844)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2742)

- **FILTRO** `ibs_20min` > `0.2723` → IC=-0.181 (n=896)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2723
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2690)
...
- **FILTRO** `ibs_20min` > `0.1844` → IC=-0.123 (n=308)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=122)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `ibs_20min` < `0.7248` → IC=-0.188 (n=136)
...
- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.167 (n=136)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=431)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.279 (n=143)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=433)

- **FILTRO** `ibs_20min` > `0.283` → IC=-0.238 (n=143)

  - _Acción_: SKIP cuando `ibs_20min` > 0.283
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=433)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=2566)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=6393)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.282 (n=2165)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=6794)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.232 (n=2234)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=6725)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.172 (n=3043)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=5916)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.229 (n=2514)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=8372)

- **FILTRO** `ibs_7min` > `0.7222` → IC=-0.174 (n=2720)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7222
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=8166)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.318 (n=289)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=919)

- **FILTRO** `ibs_7min` < `0.9735` → IC=-0.197 (n=797)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9735
...
- **FILTRO** `py_entrada` > `0.61` → IC=-0.221 (n=417)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1329)

- **FILTRO** `ballena_activa_n` > `95.0` → IC=-0.160 (n=589)

  - _Acción_: SKIP cuando `ballena_activa_n` > 95.0
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1157)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.202 (n=313)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=978)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.317 (n=413)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=878)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.287 (n=322)
...
- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.278 (n=322)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=969)
...
- **FILTRO** `ibs_7min` > `0.8179` → IC=-0.194 (n=475)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1427)
...
- **FILTRO** `hora_utc` > `15.0` → IC=-0.124 (n=501)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=1002)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.269 (n=358)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1145)
...
- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.175 (n=500)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1003)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.188 (n=488)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1523)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.265 (n=381)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1468)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1217)
...
| ✅ BALLENAS_TARDIAS | 10203 | -0.095 | -1653.15€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 728 | -0.067 | -127.47€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 9475 | -0.097 | -1525.69€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 2762 | -0.069 | -272.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 2762 | -0.069 | -272.86€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2381 | -0.080 | -177.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2381 | -0.080 | -177.39€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1783 | -0.176 | -441.70€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1783 | -0.176 | -441.70€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 228 | -0.057 | +71.70€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 63 | -0.008 | +37.23€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 165 | -0.075 | +34.48€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 228 | -0.057 | +71.70€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 63 | -0.008 | +37.23€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 165 | -0.075 | +34.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 33710 | +0.115 | -2104.10€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6151 | +0.186 | -220.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 109 | -0.104 | -50.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 24204 | +0.097 | -1793.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3246 | +0.120 | -39.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 4063 | +0.064 | -682.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 21 | -0.065 | +2.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 4037 | +0.066 | -677.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6936 | +0.133 | -153.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1742 | +0.194 | -105.21€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 4028 | +0.110 | -84.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1124 | +0.130 | +58.33€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 4070 | +0.082 | -491.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 22 | +0.083 | +3.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 4047 | +0.082 | -493.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 7441 | +0.127 | -112.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2235 | +0.167 | -17.82€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 4030 | +0.114 | -59.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1164 | +0.100 | -26.89€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 7141 | +0.135 | -412.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 