# Hipótesis automáticas — 2026-09-25 11:05 UTC
_Generado por shadow_postmortem.py sobre 603520 resoluciones (PNL=+68294.61€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.122 (n=498)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.122 (n=498)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.495 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.143 (n=180)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 94.0 (IC base=+0.051)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.115 (n=364)
...
- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.155 (n=140)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 95.0 (IC base=+0.053)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.11` → IC=-0.230 (n=7135)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.11
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=21406)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `137.45` → IC=-0.249 (n=936)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 137.45
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=2809)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `499.92` → IC=-0.149 (n=368)
...
- **FILTRO** `restante_s_al_confirmar` < `165.3` → IC=-0.217 (n=1724)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.3
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=5178)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `126.94` → IC=-0.351 (n=1405)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 126.94
  - _Potencial_: sin este filtro IC_bueno=-0.116 (n=4215)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.205 (n=13973)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=3526)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5652.3116` → IC=+0.178 (n=2243)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=10998)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5707)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `7841.0824` → IC=+0.175 (n=2157)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7841.0824 (IC base=+0.126)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1739)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.206)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=1706)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.207 (n=2146)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `16019.7856` → IC=+0.243 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16019.7856 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1537)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=1707)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1554)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=2184)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `15860.4955` → IC=+0.214 (n=564)
...
- **PATRÓN** `libro_liquidez` > `4614.6151` → IC=+0.144 (n=237)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 4614.6151 (IC base=+0.102)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.136 (n=528)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.26` → IC=+0.358 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.26 (IC base=+0.233)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.236 (n=1493)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.138 (n=670)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 17.0 (IC base=+0.137)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.238 (n=250)
...
- **PATRÓN** `libro_liquidez` > `1302.9991` → IC=+0.149 (n=665)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.434 (n=634)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=867)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.242)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.246 (n=868)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `4103.5959` → IC=+0.307 (n=372)
...
- **PATRÓN** `libro_liquidez` > `1738.7704` → IC=+0.314 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1738.7704 (IC base=+0.292)
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.271 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1367.6878` → IC=+0.290 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1367.6878 (IC base=+0.259)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.248 (n=1252)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.235)

- **PATRÓN** `drift_60min` |x|≤ `0.0915` → IC=+0.271 (n=466)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0556` → IC=+0.294 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0556 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.523` → IC=+0.242 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.523 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.458` → IC=+0.245 (n=1452)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.458 (IC base=+0.235)
...
- **PATRÓN** `volumen_spike_ratio` < `1.429` → IC=+0.231 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.429 (IC base=+0.235)

- **PATRÓN** `volumen_spike_ratio` > `2.6131` → IC=+0.241 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6131 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1808.16` → IC=+0.237 (n=932)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1808.16 (IC base=+0.235)
...
- **PATRÓN** `dist_vwap_pct` > `0.2074` → IC=+0.218 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2074 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.5738` → IC=+0.221 (n=1480)
...
- **PATRÓN** `volumen_regimen` < `1.2554` → IC=+0.219 (n=1413)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2554 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `1.0803` → IC=+0.226 (n=641)
...
- **PATRÓN** `libro_liquidez` > `12518.8764` → IC=+0.220 (n=1262)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12518.8764 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.166 (n=981)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0039 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.0769` → IC=+0.167 (n=490)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0769 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1906)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 5.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.191 (n=1629)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2101` → IC=+0.187 (n=1818)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2101 (IC base=+0.186)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8308` → IC=+0.204 (n=784)
...
- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.222 (n=1375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.6053` → IC=+0.213 (n=1563)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0643` → IC=+0.246 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0643 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.635` → IC=+0.239 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.635 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.3531` → IC=+0.271 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3531 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.7646` → IC=+0.203 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7646 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.1997` → IC=+0.220 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1997 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.215 (n=1058)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `1898.72` → IC=+0.220 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1898.72 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `23.0` → IC=+0.214 (n=908)
...
- **PATRÓN** `ibs_20min` > `0.9463` → IC=+0.212 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9463 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` > `0.1604` → IC=+0.320 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1604 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` < `0.7852` → IC=+0.334 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7852 (IC base=+0.024)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.752` → IC=+0.159 (n=725)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.752 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` < `0.8561` → IC=+0.327 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8561 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` > `1.2014` → IC=+0.342 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2014 (IC base=+0.024)

- **PATRÓN** `volumen_pendiente_norm` > `0.3004` → IC=+0.349 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3004 (IC base=+0.024)
...
- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.330 (n=322)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.125 (n=2215)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=1094)

- **FILTRO** `sigma_ewma_delta_pct` > `8.692` → IC=-0.208 (n=354)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.692
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2955)
...
- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.125 (n=1094)
...
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.183 (n=576)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1731)

- **FILTRO** `ibs_20min` < `0.7191` → IC=-0.153 (n=1522)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7191
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=785)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.202 (n=417)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1890)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.203 (n=843)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2539)
...
- **PATRÓN** `dist_vwap_pct` > `0.9089` → IC=+0.273 (n=161)
...
- **PATRÓN** `volumen_regimen` > `1.2624` → IC=+0.285 (n=259)
...
- **PATRÓN** `volumen_spike_ratio` < `2.141` → IC=+0.256 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.141 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.5239` → IC=+0.248 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5239 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.197 (n=3428)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0098 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4762` → IC=+0.189 (n=9182)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4762 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7593` → IC=+0.289 (n=1086)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7593 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.61` → IC=+0.157 (n=4828)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.61 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6905` → IC=+0.250 (n=3273)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6905 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2947` → IC=+0.270 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2947 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4655` → IC=+0.240 (n=1982)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4655 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.663` → IC=+0.243 (n=1982)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.663 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.268 (n=5465)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.157 (n=3408)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0091 (IC base=+0.074)

- **PATRÓN** `ibs_20min` < `0.549` → IC=+0.155 (n=8992)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.549 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.7264` → IC=+0.239 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7264 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` < `0.2522` → IC=+0.241 (n=2852)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2522 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` < `0.7094` → IC=+0.242 (n=1327)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7094 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` > `1.2049` → IC=+0.248 (n=1006)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2049 (IC base=+0.074)

- **PATRÓN** `volumen_pendiente_norm` > `0.2437` → IC=+0.304 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2437 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` < `1.6007` → IC=+0.261 (n=1755)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6007 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` > `2.3077` → IC=+0.259 (n=1808)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3077 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.265 (n=3871)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.074)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2583` → IC=-0.146 (n=707)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2583
  - _Potencial_: sin este filtro IC_bueno=+0.108 (n=2122)

- **FILTRO** `sigma_ewma_delta_pct` > `4.535` → IC=-0.159 (n=540)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.535
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1816)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.823` → IC=+0.211 (n=375)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.823 (IC base=+0.045)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1673` → IC=+0.455 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1673 (IC base=-0.016)

- **PATRÓN** `volumen_spike_ratio` < `2.5496` → IC=+0.444 (n=70)
...
- **PATRÓN** `ibs_20min` > `0.8635` → IC=+0.159 (n=687)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8635 (IC base=+0.026)
...
- **PATRÓN** `dist_vwap_pct` < `0.1622` → IC=+0.223 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1622 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `0.6101` → IC=+0.217 (n=578)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.249 (n=1617)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.246)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.249 (n=1445)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.706` → IC=+0.282 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.706 (IC base=+0.246)

- **PATRÓN** `volumen_pendiente_norm` < `0.104` → IC=+0.258 (n=1374)
...
- **PATRÓN** `ibs_20min` < `0.2252` → IC=+0.287 (n=1140)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2252 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.808` → IC=+0.297 (n=511)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5904` → IC=+0.284 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5904 (IC base=+0.282)
...
- **PATRÓN** `libro_liquidez` > `1886.9572` → IC=+0.297 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1886.9572 (IC base=+0.282)
...
- **FILTRO** `ibs_20min` < `0.294` → IC=-0.183 (n=503)

  - _Acción_: SKIP cuando `ibs_20min` < 0.294
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1510)

- **FILTRO** `ibs_20min` > `0.7758` → IC=-0.192 (n=605)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7758
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1819)

- **PATRÓN** `ibs_20min` > `0.8224` → IC=+0.159 (n=685)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8224 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` > `0.4473` → IC=+0.225 (n=256)
...
- **PATRÓN** `volumen_regimen` < `0.9978` → IC=+0.237 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9978 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` > `0.5902` → IC=+0.216 (n=580)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5105` → IC=+0.266 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5105 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `149.0` → IC=+0.248 (n=557)
...
- **PATRÓN** `dist_vwap_pct` < `0.6852` → IC=+0.202 (n=498)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6852 (IC base=-0.006)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5364` → IC=+0.236 (n=347)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5364 (IC base=-0.006)
...
- **PATRÓN** `volumen_regimen` > `0.7313` → IC=+0.297 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7313 (IC base=+0.043)

- **PATRÓN** `volumen_pendiente_norm` < `0.1024` → IC=+0.295 (n=748)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.316 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.043)

- **PATRÓN** `ibs_20min` < `0.5806` → IC=+0.120 (n=1489)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0972` → IC=+0.213 (n=531)
...
- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.232 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.014)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.316 (n=890)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6319` → IC=+0.310 (n=1333)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6319 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` > `0.2108` → IC=+0.316 (n=790)
...
- **PATRÓN** `volumen_regimen` > `0.8606` → IC=+0.300 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8606 (IC base=+0.276)

- **PATRÓN** `volumen_pendiente_norm` > `0.2814` → IC=+0.325 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2814 (IC base=+0.276)

- **PATRÓN** `volumen_spike_ratio` > `2.1484` → IC=+0.295 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1484 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1430)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `2634.3588` → IC=+0.291 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2634.3588 (IC base=+0.276)

- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.301 (n=954)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3939` → IC=+0.306 (n=1431)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3939 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` > `0.3069` → IC=+0.281 (n=546)
...
- **PATRÓN** `volumen_regimen` > `1.2435` → IC=+0.308 (n=477)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5347` → IC=+0.276 (n=556)
...
- **PATRÓN** `libro_liquidez` > `2626.0288` → IC=+0.278 (n=954)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2626.0288 (IC base=+0.273)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2672)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.202 (n=2665)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0903` → IC=+0.188 (n=2663)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0903 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=8307)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5755` → IC=+0.219 (n=7985)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5755 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1775` → IC=+0.196 (n=3485)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1775 (IC base=+0.168)
...
- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.161 (n=5289)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2113 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.161 (n=5290)
...
- **PATRÓN** `volumen_spike_ratio` < `1.559` → IC=+0.168 (n=3372)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.559 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6183` → IC=+0.177 (n=2554)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6183 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2407.1003` → IC=+0.170 (n=5323)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2407.1003 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `115.0` → IC=+0.182 (n=6902)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 115.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=5087)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0809` → IC=+0.208 (n=2541)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `2.2522` → IC=+0.171 (n=3143)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2522 (IC base=+0.168)
...
- **PATRÓN** `volumen_regimen` > `1.0742` → IC=+0.169 (n=539)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0742 (IC base=+0.162)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5013` → IC=+0.180 (n=508)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.5013 (IC base=+0.162)
...
- **PATRÓN** `libro_liquidez` > `11871.8913` → IC=+0.170 (n=1062)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 11871.8913 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.158 (n=1292)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0057 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0594` → IC=+0.204 (n=431)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5665` → IC=+0.188 (n=1292)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.883` → IC=+0.204 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.883 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.159 (n=1292)
...
- **PATRÓN** `ibs_20min` < `0.2417` → IC=+0.255 (n=979)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.174 (n=1125)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0066 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.159 (n=1276)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4324 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1337)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.3782` → IC=+0.198 (n=1276)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3782 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.1612` → IC=+0.181 (n=848)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1612 (IC base=+0.144)
...
- **PATRÓN** `volumen_regimen` < `1.0405` → IC=+0.146 (n=1123)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0405 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6279` → IC=+0.148 (n=1276)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6279 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.200 (n=198)
...
- **PATRÓN** `libro_liquidez` > `6488.9388` → IC=+0.185 (n=851)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6488.9388 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.149 (n=1216)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=922)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` < `2.1481` → IC=+0.211 (n=1177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1481 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4081` → IC=+0.209 (n=1337)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4081 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1474)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2828.2154` → IC=+0.209 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2828.2154 (IC base=+0.201)
...
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.175 (n=644)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0088 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.1007` → IC=+0.155 (n=642)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1007 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=1768)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.5391` → IC=+0.189 (n=1720)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5391 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.868` → IC=+0.184 (n=308)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.868 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.707` → IC=+0.175 (n=872)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.707 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.8753` → IC=+0.165 (n=1131)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8753 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.701` → IC=+0.151 (n=1516)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.701 (IC base=+0.148)
...
- **PATRÓN** `volumen_spike_ratio` > `1.825` → IC=+0.152 (n=1238)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.825 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.152 (n=2188)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.02 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `12429.5841` → IC=+0.160 (n=642)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12429.5841 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.169 (n=1705)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 158.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.139 (n=1338)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0056 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=2020)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6607` → IC=+0.139 (n=2003)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.6607 (IC base=+0.111)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1652` → IC=+0.125 (n=497)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.1652 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4526` → IC=+0.143 (n=643)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4526 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2751.2995` → IC=+0.124 (n=1789)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2751.2995 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.121 (n=816)
...
- **PATRÓN** `ibs_20min` < `0.0839` → IC=+0.163 (n=188)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.0839 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `0.6847` → IC=+0.128 (n=248)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.6847 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.1661` → IC=+0.129 (n=130)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.1661 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `9139.2638` → IC=+0.121 (n=375)

  - _Acción_: Kelly boost +0.60€ cuando `libro_liquidez` > 9139.2638 (IC base=+0.094)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.169 (n=291)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0072 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.1165` → IC=+0.142 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.1165 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.170 (n=407)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 8.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.263 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.939` → IC=+0.244 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.939 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.412` → IC=+0.196 (n=241)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 3.412 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.0738` → IC=+0.151 (n=385)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.0738 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.289` → IC=+0.188 (n=62)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.289 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `2.2114` → IC=+0.175 (n=189)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.2114 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=476)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `3112.9004` → IC=+0.196 (n=146)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 3112.9004 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.173 (n=145)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 20.0 (IC base=+0.134)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.206 (n=3408)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=10647)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` > `0.47` → IC=+0.217 (n=10215)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.47 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` > `0.9744` → IC=+0.204 (n=1446)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9744 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.634` → IC=+0.227 (n=4922)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.634 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `0.8811` → IC=+0.166 (n=4557)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8811 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2891` → IC=+0.203 (n=1407)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2891 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.595` → IC=+0.187 (n=3275)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.595 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `2350.8` → IC=+0.173 (n=6810)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2350.8 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `86.0` → IC=+0.195 (n=7792)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 86.0 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=6183)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.1485` → IC=+0.190 (n=4072)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.238 (n=9258)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2512` → IC=+0.162 (n=5735)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.734` → IC=+0.182 (n=8953)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.734 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.705` → IC=+0.162 (n=2796)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.705 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.155 (n=2117)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2035 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2877` → IC=+0.242 (n=1220)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2877 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.622` → IC=+0.193 (n=2835)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.622 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.194 (n=5502)
...
- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.262 (n=1360)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.268 (n=1229)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3517` → IC=+0.289 (n=1198)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3517 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.718` → IC=+0.262 (n=1529)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.718 (IC base=+0.258)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5472` → IC=+0.257 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5472 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `2.6339` → IC=+0.278 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6339 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1807.1648` → IC=+0.262 (n=907)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1807.1648 (IC base=+0.258)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0848` → IC=+0.161 (n=546)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0848 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1709)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 5.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.3085` → IC=+0.205 (n=1638)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3085 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.1328` → IC=+0.186 (n=929)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1328 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.74` → IC=+0.169 (n=373)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.74 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.242` → IC=+0.155 (n=1477)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.242 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.628` → IC=+0.179 (n=546)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.628 (IC base=+0.151)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1137` → IC=+0.161 (n=1392)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1137 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4033` → IC=+0.156 (n=1582)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.4033 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `15748.4784` → IC=+0.160 (n=742)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 15748.4784 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `472.0` → IC=+0.159 (n=1513)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 472.0 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1418)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.2608` → IC=+0.168 (n=1247)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6603` → IC=+0.197 (n=1417)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.279` → IC=+0.154 (n=1284)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.279 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.165 (n=1417)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1888 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.1512` → IC=+0.197 (n=378)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1512 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.161 (n=1318)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `2.0873` → IC=+0.168 (n=598)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.0873 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `420.0` → IC=+0.158 (n=1076)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.226 (n=1732)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1681)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2107` → IC=+0.221 (n=1641)
...
- **PATRÓN** `libro_liquidez` > `1801.6976` → IC=+0.218 (n=1104)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1801.6976 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0117` → IC=+0.238 (n=1544)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0117 (IC base=+0.232)

- **PATRÓN** `drift_60min` |x|≤ `0.1677` → IC=+0.237 (n=680)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0148` → IC=+0.307 (n=515)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7532` → IC=+0.231 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7532 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.187` → IC=+0.235 (n=946)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.187 (IC base=+0.232)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.238 (n=1046)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `1953.0964` → IC=+0.243 (n=515)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1953.0964 (IC base=+0.232)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4373` → IC=+0.147 (n=1739)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4373 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.153 (n=1815)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3748` → IC=+0.164 (n=689)
...
- **PATRÓN** `volumen_regimen` < `0.8748` → IC=+0.157 (n=1160)
...
- **PATRÓN** `ibs_20min` < `0.7033` → IC=+0.182 (n=1417)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.7033 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.5977` → IC=+0.142 (n=1569)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1730)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1677)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.486` → IC=+0.126 (n=1620)
...
- **PATRÓN** `ibs_20min` < `0.4224` → IC=+0.266 (n=1623)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4224 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `1.2706` → IC=+0.204 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2706 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.9265` → IC=+0.203 (n=2049)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9265 (IC base=+0.201)
...
- **PATRÓN** `volumen_regimen` > `1.2355` → IC=+0.236 (n=615)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1835` → IC=+0.198 (n=1462)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.1835 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4297` → IC=+0.197 (n=1661)
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.167 (n=2616)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0091 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.5172` → IC=+0.166 (n=2973)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.942` → IC=+0.215 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.942 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.1889` → IC=+0.170 (n=1097)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1889 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` < `0.4847` → IC=+0.153 (n=1843)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.4847 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.195` → IC=+0.191 (n=486)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 10.195 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `0.8968` → IC=+0.166 (n=1308)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.8968 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.1711` → IC=+0.191 (n=817)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1711 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `1.4562` → IC=+0.165 (n=979)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4562 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.8779` → IC=+0.165 (n=1958)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.8779 (IC base=+0.157)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.159 (n=2087)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `3857.8302` → IC=+0.165 (n=1982)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3857.8302 (IC base=+0.157)
...
- **PATRÓN** `ibs_20min` < `0.5529` → IC=+0.171 (n=642)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.5529 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.8888` → IC=+0.178 (n=321)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.8888 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.1633` → IC=+0.165 (n=559)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1633 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` < `0.424` → IC=+0.173 (n=895)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.424 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.148` → IC=+0.175 (n=863)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 4.148 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.89` → IC=+0.166 (n=642)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.89 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` > `0.6409` → IC=+0.167 (n=963)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6409 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` < `0.1056` → IC=+0.166 (n=885)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4338` → IC=+0.178 (n=315)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4338 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.5168` → IC=+0.166 (n=843)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.5168 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=956)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0918` → IC=+0.132 (n=647)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 2.0918 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.141 (n=374)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.161 (n=322)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.006 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.124 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.5136` → IC=+0.183 (n=291)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.5136 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.1382` → IC=+0.175 (n=152)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.1382 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.0688` → IC=+0.124 (n=256)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.0688 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` < `0.1568` → IC=+0.136 (n=267)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` < 0.1568 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.165 (n=222)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.105)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.183 (n=140)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.004 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.136 (n=297)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 7.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.6789` → IC=+0.236 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6789 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.348` → IC=+0.175 (n=115)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.348 (IC base=+0.105)
...
- **PATRÓN** `volumen_regimen` > `0.9514` → IC=+0.129 (n=130)
  ...
  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.9514 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7335` → IC=+0.167 (n=157)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.7335 (IC base=+0.105)
...
- **PATRÓN** `liq_usd_total` > `69212.62` → IC=+0.163 (n=96)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=799)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.125 (n=62)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=753)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.142 (n=65)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `py_entrada` < 0.495 (IC base=+0.008)

- **PATRÓN** `libro_liquidez` > `3946.3264` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3946.3264 (IC base=+0.008)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.126 (n=410)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=213)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.180 (n=173)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` < 0.47 (IC base=+0.012)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` < `0.54` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `py_entrada` < 0.54 (IC base=+0.038)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.56` → IC=+0.191 (n=53)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.56 (IC base=+0.081)

- **PATRÓN** `profundidad_ratio` > `79.6` → IC=+0.139 (n=70)

  - _Acción_: Kelly boost +0.69€ cuando `profundidad_ratio` > 79.6 (IC base=+0.081)
...
- **FILTRO** `py_entrada` > `0.47` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` > 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.269 (n=11)

- **PATRÓN** `py_entrada` < `0.519` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.519 (IC base=-0.033)
...
- **FILTRO** `profundidad_ratio` < `37.6` → IC=-0.206 (n=15)
...
- **FILTRO** `lag_apertura_s` > `247.46` → IC=-0.214 (n=19)

  - _Acción_: SKIP cuando `lag_apertura_s` > 247.46
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=38)

- **FILTRO** `profundidad_ratio` < `49.3` → IC=-0.141 (n=37)
...
- **FILTRO** `profundidad_ratio` < `49.7` → IC=-0.147 (n=32)
...
- **PATRÓN** `py_entrada` < `0.45` → IC=+0.237 (n=17)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.45 (IC base=+0.015)

- **PATRÓN** `profundidad_ratio` > `49.7` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `profundidad_ratio` > 49.7 (IC base=+0.015)
...
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.141 (n=37)

  - _Acción_: Kelly boost +0.71€ cuando `py_entrada` < 0.59 (IC base=+0.017)

- **PATRÓN** `restante_min` > `13.49` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `restante_min` > 13.49 (IC base=+0.017)

- **PATRÓN** `lag_apertura_s` < `121.18` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 121.18 (IC base=+0.017)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7560)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.166 (n=3579)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10794)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.168 (n=3691)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=11176)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.208 (n=614)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1883)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.152 (n=650)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=2014)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.192 (n=627)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1918)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=644)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=2018)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.174 (n=609)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1876)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.175 (n=648)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=2019)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=10193)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=22672)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=8056)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=24809)

- **FILTRO** `ibs_7min` < `0.2821` → IC=-0.234 (n=8209)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2821
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=24656)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11152)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21713)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.231 (n=10109)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=31147)

- **FILTRO** `ibs_7min` > `0.2927` → IC=-0.178 (n=10313)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2927
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=30943)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.136 (n=1664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3778)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=1295)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4147)

- **FILTRO** `ibs_7min` < `0.7113` → IC=-0.249 (n=1795)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7113
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3647)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.186 (n=1230)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4212)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.262 (n=1742)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5353)

- **FILTRO** `drift_7min_pct` |x|> `0.1119` → IC=-0.126 (n=2412)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1119
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4683)

- **FILTRO** `ibs_7min` > `0.788` → IC=-0.208 (n=1773)

  - _Acción_: SKIP cuando `ibs_7min` > 0.788
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=5322)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1334)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4337)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1372)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4299)

- **FILTRO** `ibs_7min` < `0.7468` → IC=-0.192 (n=1415)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7468
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4256)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.177 (n=1414)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4257)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.255 (n=1438)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4320)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.179 (n=1438)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=4320)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.183 (n=1436)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4322)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1470)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3695)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.304 (n=1280)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3885)

- **FILTRO** `ibs_7min` < `0.7062` → IC=-0.243 (n=1703)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7062
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3462)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.221 (n=1184)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3981)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1735)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5853)

- **FILTRO** `ibs_7min` > `0.7467` → IC=-0.173 (n=1896)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7467
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=5692)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1755)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3673)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.241 (n=1336)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4092)

- **FILTRO** `ibs_7min` < `0.7407` → IC=-0.179 (n=1356)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7407
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=4072)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.171 (n=1325)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4103)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1381)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4147)

- **FILTRO** `ibs_7min` > `0.2747` → IC=-0.178 (n=1381)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2747
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4147)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.184 (n=1359)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4169)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.254 (n=1406)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4322)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.233 (n=1421)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4307)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1861)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5984)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1763)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3668)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.226 (n=1353)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4078)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1314)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4117)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.206 (n=1776)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5666)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.416` → IC=+0.141 (n=500)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.71€ cuando `delta_ratio` |x|> 0.416 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.123 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 14.0 (IC base=+0.110)

- **PATRÓN** `total_vol_5m` < `471.727` → IC=+0.139 (n=250)
...
- **PATRÓN** `delta_ratio` |x|> `0.4377` → IC=+0.150 (n=58)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.75€ cuando `delta_ratio` |x|> 0.4377 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=178)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.129)

- **PATRÓN** `total_vol_5m` < `626.439` → IC=+0.134 (n=173)

  - _Acción_: Kelly boost +0.67€ cuando `total_vol_5m` < 626.439 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `2532.1776` → IC=+0.167 (n=58)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2532.1776 (IC base=+0.129)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.144 (n=57)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 12.0 (IC base=+0.129)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=2949)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1501)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1509)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1338 | +0.099 | +200.66€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1338 | +0.099 | +200.66€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 998 | +0.109 | +173.79€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 998 | +0.109 | +173.79€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 254 | +0.055 | +8.21€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 254 | +0.055 | +8.21€ | 6 | 6 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 28541 | -0.089 | -3813.45€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1475 | -0.048 | -222.89€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27066 | -0.091 | -3590.56€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3745 | -0.096 | -604.09€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3745 | -0.096 | -604.09€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1475 | -0.048 | -222.89€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1475 | -0.048 | -222.89€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3482 | -0.096 | -787.96€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3482 | -0.096 | -787.96€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7317 | -0.021 | -676.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 