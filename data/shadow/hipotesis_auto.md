# Hipótesis automáticas — 2026-06-29 19:26 UTC
_Generado por shadow_postmortem.py sobre 1305 resoluciones (PNL=-33.83€)_
...
- **PATRÓN** `sigma_h` < `0.0119` → IC=+0.167 (n=28)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0119 (IC base=+0.081)

- **PATRÓN** `drift_60min` |x|≤ `1.067` → IC=+0.128 (n=49)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 1.067 (IC base=+0.081)
...
| ✅ UPDOWN_GBM#ETH | 130 | +0.061 | +9.62€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 84 | +0.081 | +6.43€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#XRP | 25 | -0.056 | -1.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 16 | +0.000 | +0.84€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.085) — sin ventaja clara. oversold(IBS<0.3): IC=+0.044 n=14 | neutral: IC=+0.129 n=12 | overbought(IBS>0.7): IC=+0.068 n=19
  - _Datos_: n=47 IC=+0.112 PNL=+6.48€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 47 ops, 9 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.051 n=87/40 PNL=+0.29€ | H=15h UTC: IC=-0.011 n=92/40 PNL=-5.07€ | H=17h UTC: IC=+0.271 n=33/40 PNL=+13.52€ | H=19h UTC: IC=+0.026 n=36/40 PNL=+2.38€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=237 IC=+0.040 PNL=+13.25€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=237 IC=+0.040 PNL=+13.25€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=143 IC=+0.038 PNL=-0.11€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=143 IC=+0.038 PNL=-0.11€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.148 > 0.08 con n=69 PNL=+12.34€
  - _Datos_: n=69 IC=+0.148 PNL=+12.34€
