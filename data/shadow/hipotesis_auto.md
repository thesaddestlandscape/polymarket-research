# Hipótesis automáticas — 2026-09-02 13:45 UTC
_Generado por shadow_postmortem.py sobre 252851 resoluciones (PNL=+22702.15€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.28` → IC=-0.292 (n=3450)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.28
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=10352)
...
- **FILTRO** `restante_s_al_confirmar` < `113.25` → IC=-0.406 (n=446)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 113.25
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=1338)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `137.97` → IC=-0.323 (n=765)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 137.97
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2295)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.97` → IC=-0.371 (n=822)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.97
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=1671)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.189 (n=7505)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.093)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=1923)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2383.976` → IC=+0.170 (n=1844)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=3625)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `1926.6564` → IC=+0.185 (n=3082)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1926.6564 (IC base=+0.143)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.213 (n=804)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=823)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.205)

- **PATRÓN** `py_entrada` > `0.785` → IC=+0.379 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.785 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.207 (n=1029)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `13027.6931` → IC=+0.217 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13027.6931 (IC base=+0.205)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.123 (n=542)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.138 (n=374)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.148 (n=319)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=433)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `1992.203` → IC=+0.162 (n=320)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 1992.203 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.174 (n=1439)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.314 (n=481)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.196 (n=1431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 5.0 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.186 (n=1223)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.206 (n=16084)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.188)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=3308)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.171 (n=2324)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` > 0.72 (IC base=+0.142)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.228 (n=2793)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.259 (n=2074)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.180 (n=2759)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.279 (n=1002)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.241 (n=1378)
...
- **PATRÓN** `lag_apertura_s` < `7.07` → IC=+0.152 (n=1411)
...
- **PATRÓN** `lag_apertura_s` < `3.36` → IC=+0.170 (n=1082)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3493` → IC=+0.125 (n=3336)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` > 0.3493 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` > `0.2678` → IC=+0.222 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2678 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.492` → IC=+0.147 (n=1283)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 5.492 (IC base=+0.075)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.240 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0851 (IC base=+0.075)

- **PATRÓN** `volumen_pendiente_norm` > `0.1704` → IC=+0.176 (n=559)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1704 (IC base=+0.075)

- **PATRÓN** `volumen_spike_ratio` < `1.6021` → IC=+0.172 (n=860)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.6021 (IC base=+0.075)

- **PATRÓN** `volumen_spike_ratio` > `1.4772` → IC=+0.168 (n=1953)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.4772 (IC base=+0.075)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.202 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.075)

- **PATRÓN** `ibs_20min` < `0.405` → IC=+0.124 (n=3270)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.405 (IC base=+0.038)

- **PATRÓN** `volumen_regimen` < `0.6788` → IC=+0.161 (n=497)
...
- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.214 (n=918)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.504` → IC=+0.301 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.504 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2291` → IC=+0.223 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2291 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.3284` → IC=+0.127 (n=564)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.3284 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.4564` → IC=+0.148 (n=641)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4564 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.193 (n=577)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.186 (n=386)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.228 (n=604)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.207)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=588)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.314` → IC=+0.219 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.314 (IC base=+0.207)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.07` → IC=+0.212 (n=581)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.07 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` < `1.2524` → IC=+0.208 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2524 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.228 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.207)

- **PATRÓN** `volumen_pendiente_norm` < `0.0993` → IC=+0.207 (n=554)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1056` → IC=+0.228 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1056 (IC base=+0.207)

- **PATRÓN** `libro_liquidez` > `11045.5521` → IC=+0.227 (n=580)
...
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.209 (n=314)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.008 (IC base=+0.165)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.217` → IC=+0.261 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.217 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` < `0.1318` → IC=+0.168 (n=586)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` < 0.1318 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` < `3.2706` → IC=+0.158 (n=536)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 3.2706 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.6757` → IC=+0.173 (n=609)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.6757 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=694)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.208` → IC=-0.189 (n=191)
...
- **FILTRO** `ibs_20min` > `0.797` → IC=-0.183 (n=380)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1144)

- **FILTRO** `sigma_ewma_delta_pct` > `8.726` → IC=-0.145 (n=184)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.726
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1340)
...
- **PATRÓN** `volumen_regimen` > `1.295` → IC=+0.258 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.295 (IC base=-0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.2664` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2664 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` < `2.224` → IC=+0.157 (n=65)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.224 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` > `1.6954` → IC=+0.147 (n=66)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.6954 (IC base=-0.052)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.241` → IC=-0.166 (n=297)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.241
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=639)

- **PATRÓN** `ibs_20min` > `0.7933` → IC=+0.203 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7933 (IC base=+0.008)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.471` → IC=+0.130 (n=190)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 6.471 (IC base=+0.008)

- **PATRÓN** `volumen_pendiente_norm` > `0.2294` → IC=+0.397 (n=27)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.275 (n=305)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.7091` → IC=+0.253 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7091 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.251` → IC=+0.283 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.251 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.1063` → IC=+0.235 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1063 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `2.4754` → IC=+0.223 (n=391)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.246 (n=671)
...
- **FILTRO** `ibs_20min` < `0.7268` → IC=-0.153 (n=428)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0639` → IC=+0.200 (n=18)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0639 (IC base=-0.079)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2381` → IC=+0.167 (n=16)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.2381 (IC base=-0.079)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.78` → IC=-0.149 (n=594)

  - _Acción_: SKIP cuando `ibs_20min` < 0.78
  - _Potencial_: sin este filtro IC_bueno=+0.270 (n=307)
...
- **PATRÓN** `ibs_20min` > `0.78` → IC=+0.270 (n=307)
...
- **PATRÓN** `sigma_h` > `0.0213` → IC=+0.323 (n=315)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.256 (n=612)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.285 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.169 (IC base=+0.246)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5805` → IC=+0.253 (n=634)
...
- **PATRÓN** `libro_liquidez` > `2469.6086` → IC=+0.251 (n=620)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.56` → IC=+0.236 (n=1419)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.56 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.169 (n=2362)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6282 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1049` → IC=+0.186 (n=1277)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1049 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` < `2.324` → IC=+0.167 (n=2824)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.324 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.167 (n=3597)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.03 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3946.0946` → IC=+0.180 (n=1157)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 3946.0946 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `90.0` → IC=+0.183 (n=2102)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2758` → IC=+0.190 (n=575)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `drift_60min` |x|≤ `0.4064` → IC=+0.180 (n=507)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.4064 (IC base=+0.171)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.195 (n=513)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 6.0 (IC base=+0.171)

- **PATRÓN** `ibs_20min` > `0.4578` → IC=+0.223 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4578 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` > `0.1871` → IC=+0.231 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1871 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.906` → IC=+0.236 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.906 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.516` → IC=+0.172 (n=483)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` < 7.516 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `0.6395` → IC=+0.178 (n=169)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6395 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `1.0613` → IC=+0.185 (n=230)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.0613 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.1606` → IC=+0.199 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1606 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `2.1246` → IC=+0.190 (n=420)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.1246 (IC base=+0.171)

- **PATRÓN** `libro_liquidez` > `11350.6257` → IC=+0.190 (n=453)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11350.6257 (IC base=+0.171)
...
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.229 (n=179)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.009 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.2701` → IC=+0.190 (n=472)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.2701 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.188 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 16.0 (IC base=+0.172)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.358` → IC=+0.298 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.358 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` < `0.1052` → IC=+0.165 (n=425)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.1052 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `1.732` → IC=+0.177 (n=159)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.732 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `3.2754` → IC=+0.164 (n=215)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 3.2754 (IC base=+0.172)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.197 (n=526)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.04 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `1910.8884` → IC=+0.174 (n=179)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1910.8884 (IC base=+0.172)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.204 (n=448)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.4649` → IC=+0.179 (n=509)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.4649 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.184 (n=517)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 6.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.435` → IC=+0.214 (n=509)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.181` → IC=+0.294 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.181 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6402` → IC=+0.183 (n=509)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=574)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `12383.1611` → IC=+0.227 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12383.1611 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `170.0` → IC=+0.159 (n=391)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 170.0 (IC base=+0.169)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.197 (n=713)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1521` → IC=+0.219 (n=475)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1521 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.298` → IC=+0.246 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.298 (IC base=+0.186)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5262` → IC=+0.205 (n=645)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3332` → IC=+0.135 (n=639)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.3332 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.161 (n=692)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `0.8772` → IC=+0.144 (n=386)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8866` → IC=+0.140 (n=448)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8866 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=542)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `5099.5365` → IC=+0.160 (n=242)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 5099.5365 (IC base=+0.133)
...
- **PATRÓN** `drift_60min` |x|≤ `0.102` → IC=+0.263 (n=57)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.102 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.293 (n=177)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` > `0.7832` → IC=+0.333 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7832 (IC base=+0.261)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.66` → IC=+0.306 (n=91)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.66 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` < `0.8565` → IC=+0.265 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8565 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` > `1.2111` → IC=+0.310 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2111 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` > `0.0933` → IC=+0.390 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0933 (IC base=+0.261)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5225` → IC=+0.325 (n=55)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5225 (IC base=+0.261)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.399` → IC=+0.230 (n=2125)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.399 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8814` → IC=+0.157 (n=1923)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8814 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` > `1.0839` → IC=+0.153 (n=1307)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.0839 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1658` → IC=+0.194 (n=1114)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1658 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `1.8809` → IC=+0.173 (n=2547)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8809 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.165 (n=4292)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.03 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3897.6995` → IC=+0.186 (n=1382)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 3897.6995 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.217 (n=1851)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.228 (n=307)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.185 (n=677)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.711` → IC=+0.309 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.711 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.218` → IC=+0.272 (n=121)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.241 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.242 (n=304)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.190 (n=227)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0029 (IC base=+0.159)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0927` → IC=+0.171 (n=226)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.0927 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=708)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.159)

- **PATRÓN** `ibs_20min` > `0.3255` → IC=+0.211 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3255 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` > `0.2388` → IC=+0.213 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2388 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.199 (n=164)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.757 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.384` → IC=+0.168 (n=586)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` < 4.384 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` < `1.2687` → IC=+0.164 (n=676)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2687 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` > `1.1002` → IC=+0.169 (n=306)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.1002 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` < `0.0712` → IC=+0.173 (n=564)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` < 0.0712 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.1464` → IC=+0.190 (n=182)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1464 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `2.1045` → IC=+0.180 (n=552)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.1045 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.7162` → IC=+0.179 (n=418)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.7162 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `10721.5149` → IC=+0.186 (n=603)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 10721.5149 (IC base=+0.159)

- **PATRÓN** `ballena_activa_n` < `502.0` → IC=+0.175 (n=552)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.376` → IC=+0.338 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.376 (IC base=+0.208)

- **PATRÓN** `volumen_pendiente_norm` < `0.1386` → IC=+0.218 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1386 (IC base=+0.208)

- **PATRÓN** `volumen_spike_ratio` < `1.9083` → IC=+0.224 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9083 (IC base=+0.208)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.240 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.208)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.272 (n=300)
...
- **PATRÓN** `sigma_h` < `0.007` → IC=+0.156 (n=597)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.14` → IC=+0.151 (n=299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.14 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.159 (n=610)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 8.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.7439` → IC=+0.240 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7439 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.39` → IC=+0.182 (n=265)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.39 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.692` → IC=+0.208 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.692 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.9006` → IC=+0.168 (n=453)
...
- **PATRÓN** `libro_liquidez` > `9596.597` → IC=+0.239 (n=308)
...
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.149 (n=480)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0084 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.138 (n=481)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 12.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.4868` → IC=+0.188 (n=720)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4868 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.8895` → IC=+0.200 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8895 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.55` → IC=+0.230 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.55 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2971.573` → IC=+0.256 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2971.573 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.145 (n=438)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.207 (n=849)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.116` → IC=+0.243 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.116 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `0.6863` → IC=+0.208 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6863 (IC base=+0.196)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4456` → IC=+0.199 (n=761)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4456 (IC base=+0.196)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.130 (n=1669)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.129 (n=1204)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0101 (IC base=+0.119)

- **PATRÓN** `drift_60min` |x|≤ `0.4365` → IC=+0.132 (n=1204)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.4365 (IC base=+0.119)
...
- **PATRÓN** `ibs_20min` > `0.9206` → IC=+0.195 (n=457)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.9206 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.581` → IC=+0.157 (n=214)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 10.581 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.051` → IC=+0.122 (n=1389)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 6.051 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` > `0.8938` → IC=+0.123 (n=627)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.8938 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.1742` → IC=+0.156 (n=370)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1742 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `1.4626` → IC=+0.152 (n=452)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4626 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `2.39` → IC=+0.146 (n=614)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5081` → IC=+0.146 (n=1264)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.369` → IC=+0.140 (n=1261)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.369 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `1.0973` → IC=+0.139 (n=1084)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.0973 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` < `0.1484` → IC=+0.129 (n=1260)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4757` → IC=+0.136 (n=1252)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.4757 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `1.794` → IC=+0.133 (n=834)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.794 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=1669)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `8304.7792` → IC=+0.137 (n=1129)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 8304.7792 (IC base=+0.127)
...
- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.186 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0102 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.4069` → IC=+0.152 (n=265)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4069 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.260 (n=102)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.260 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.155` → IC=+0.238 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.155 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.334` → IC=+0.148 (n=271)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 3.334 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` < `0.092` → IC=+0.148 (n=279)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.092 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.2136` → IC=+0.149 (n=75)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.2136 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `1.6679` → IC=+0.196 (n=100)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.6679 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `2.4202` → IC=+0.163 (n=200)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.4202 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `1874.6858` → IC=+0.153 (n=269)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 1874.6858 (IC base=+0.145)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.144 (n=495)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0091 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.4826` → IC=+0.144 (n=495)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4826 (IC base=+0.129)
...
- **PATRÓN** `ibs_20min` > `0.1766` → IC=+0.142 (n=495)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.1766 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` > `1.006` → IC=+0.170 (n=101)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 1.006 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.2471` → IC=+0.138 (n=426)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2471 (IC base=+0.129)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.061` → IC=+0.141 (n=496)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 7.061 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` < `0.7271` → IC=+0.150 (n=218)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7271 (IC base=+0.129)

- **PATRÓN** `volumen_pendiente_norm` > `0.1754` → IC=+0.162 (n=149)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.1754 (IC base=+0.129)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8388` → IC=+0.141 (n=324)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8388 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `8943.6658` → IC=+0.144 (n=442)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 8943.6658 (IC base=+0.129)
...
- **PATRÓN** `libro_liquidez` > `3125.6088` → IC=+0.179 (n=54)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 3125.6088 (IC base=+0.087)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=678)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.184 (n=1303)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=3951)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.186 (n=1369)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=4154)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.249 (n=189)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=588)
...
- **FILTRO** `ballena_activa_n` > `62.0` → IC=-0.149 (n=226)
...
- **FILTRO** `py_entrada` > `0.65` → IC=-0.229 (n=223)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=700)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.147 (n=3747)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=9203)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.284 (n=3213)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=9737)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.246 (n=3237)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=9713)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.173 (n=4341)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=8609)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.223 (n=3793)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=12581)

- **FILTRO** `ibs_7min` > `0.72` → IC=-0.171 (n=4089)

  - _Acción_: SKIP cuando `ibs_7min` > 0.72
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=12285)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.170 (n=559)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=1308)

- **FILTRO** `py_entrada` < `0.3` → IC=-0.326 (n=451)

  - _Acción_: SKIP cuando `py_entrada` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=1416)

- **FILTRO** `ibs_7min` < `0.2841` → IC=-0.267 (n=616)
...
- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.239 (n=447)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=1420)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.137 (n=1912)
...
- **FILTRO** `ibs_7min` > `0.8362` → IC=-0.185 (n=713)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2142)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.147 (n=533)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1905)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.266 (n=583)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1855)
...
- **FILTRO** `ballena_activa_n` > `164.0` → IC=-0.193 (n=608)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1830)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.227 (n=617)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=1862)

- **FILTRO** `ballena_activa_n` > `106.0` → IC=-0.177 (n=834)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.199 (n=466)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.102 (n=1440)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.312 (n=616)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1290)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.267 (n=624)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=1282)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.244 (n=466)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=1440)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.229 (n=684)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2224)

- **FILTRO** `ibs_7min` > `0.8061` → IC=-0.172 (n=726)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8061
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2182)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.144 (n=670)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1541)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=545)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=1666)

- **FILTRO** `ibs_7min` < `0.7509` → IC=-0.193 (n=552)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7509
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1659)

- **FILTRO** `ballena_activa_n` > `27.0` → IC=-0.185 (n=732)

  - _Acción_: SKIP cuando `ballena_activa_n` > 27.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1479)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.236 (n=726)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1495)

- **FILTRO** `ibs_7min` > `0.2762` → IC=-0.182 (n=555)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2762
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1666)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.183 (n=554)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=1667)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.244 (n=587)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1827)

- **FILTRO** `ibs_7min` < `0.7317` → IC=-0.212 (n=603)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7317
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1811)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.194 (n=586)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1828)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.178 (n=752)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2303)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.298 (n=523)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1591)

- **FILTRO** `ibs_7min` < `0.7303` → IC=-0.249 (n=528)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7303
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1586)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.247 (n=572)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=2284)

- **FILTRO** `ibs_7min` > `0.7838` → IC=-0.159 (n=713)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7838
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=2143)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=1480)
...
- **PATRÓN** `ibs_15` < `0.1304` → IC=+0.164 (n=147)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.82€ cuando `ibs_15` < 0.1304 (IC base=+0.031)
...
- **FILTRO** `sigma_h` > `0.0106` → IC=-0.207 (n=315)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=948)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0839` → IC=+0.238 (n=338)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3659` → IC=+0.287 (n=379)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0074` → IC=-0.233 (n=208)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=627)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.226 (n=275)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=560)
...
- **FILTRO** `libro_liquidez` < `15993.132` → IC=-0.214 (n=551)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1304 sube el IC de +0.031 a +0.164 en UPDOWN_GBM#XRP#15min (n=147). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3659 sube el IC de -0.066 a +0.287 en UPDOWN_GBM_15M_TARDIO (n=379). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.0729 sube el IC de -0.064 a +0.305 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=39). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS > 0.3273 sube el IC de -0.064 a +0.312 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=30). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 13802 | -0.107 | -2339.58€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 914 | -0.005 | -134.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 12888 | -0.114 | -2204.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1787 | -0.076 | -345.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1787 | -0.076 | -345.87€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 914 | -0.005 | -134.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 914 | -0.005 | -134.65€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1784 | -0.157 | -532.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1784 | -0.157 | -532.54€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 3764 | -0.058 | -355.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 3764 | -0.058 | -355.42€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3060 | -0.122 | -298.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3060 | -0.122 | -298.92€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2493 | -0.187 | -672.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2493 | -0.187 | -672.18€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 3313 | -0.064 | +1554.92€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 940 | -0.005 | +674.94€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 2373 | -0.087 | +879.98€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 3313 | -0.064 | +1554.92€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min |