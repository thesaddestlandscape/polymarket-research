# Hipótesis automáticas — 2026-07-12 10:41 UTC
_Generado por shadow_postmortem.py sobre 10791 resoluciones (PNL=+1881.14€)_
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.189 (n=236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `5910.4373` → IC=+0.173 (n=148)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5910.4373 (IC base=+0.152)
...
- **PATRÓN** `py_entrada` < `0.245` → IC=+0.278 (n=25)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.156)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 844 | +0.186 | +11.51€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 545 | +0.215 | +8.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 34 | +0.028 | -2.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 124 | +0.079 | -9.69€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 298 | +0.170 | +2.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 180 | +0.209 | +2.71€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 11 | -0.064 | -2.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 60 | +0.097 | -3.54€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6077 | tras_1loss IC=+0.043 n=4577 | tras_2loss IC=+0.009 n=2061/40 | gap=+0.081 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8333 IC=+0.096 PNL=+1957.02€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8333 IC=+0.096 PNL=+1957.02€
