# Hipótesis automáticas — 2026-06-30 03:13 UTC
_Generado por shadow_postmortem.py sobre 1356 resoluciones (PNL=-49.51€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0502` → IC=+0.132 (n=17)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `pct_spot_vs_ref` |x|≤ 0.0502 (IC base=+0.036)
...
| ✅ UPDOWN_GBM#ETH | 151 | +0.016 | +0.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 100 | +0.029 | +0.33€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.036) — sin ventaja clara. oversold(IBS<0.3): IC=-0.048 n=29 | neutral: IC=-0.036 n=26 | overbought(IBS>0.7): IC=-0.013 n=37
  - _Datos_: n=95 IC=-0.036 PNL=-9.68€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 95 ops, 16 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 384/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=285 IC=+0.002 PNL=-2.91€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=285 IC=+0.002 PNL=-2.91€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=171 IC=-0.009 PNL=-13.74€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=171 IC=-0.009 PNL=-13.74€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=67 IC=+0.036 PNL=-2.13€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=67 IC=+0.036 PNL=-2.13€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=90 IC=+0.065 PNL=-0.23€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=90 IC=+0.065 PNL=-0.23€
