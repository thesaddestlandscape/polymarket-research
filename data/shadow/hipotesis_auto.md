# Hipótesis automáticas — 2026-08-24 19:47 UTC
_Generado por shadow_postmortem.py sobre 141883 resoluciones (PNL=+9716.10€)_
...
- **FILTRO** `py_entrada` < `0.705` → IC=-0.167 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.263 (n=205)
...
- **PATRÓN** `py_entrada` > `0.705` → IC=+0.263 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.705 (IC base=+0.134)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.154 (n=206)

  - _Acción_: Kelly boost +0.77€ cuando `n_ballena_banda` > 20.0 (IC base=+0.134)

- **PATRÓN** `n_total_lado` > `72.0` → IC=+0.255 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 72.0 (IC base=+0.134)

- **PATRÓN** `banda_hit_calibrado` > `0.8144` → IC=+0.265 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8144 (IC base=+0.134)

- **PATRÓN** `banda_z` > `9.958` → IC=+0.214 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 9.958 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.162 (n=149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 11.0 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=228)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `3473.3708` → IC=+0.224 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3473.3708 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `288.0` → IC=+0.285 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 288.0 (IC base=+0.134)
...
- **PATRÓN** `n_ballena_banda` > `21.0` → IC=+0.191 (n=137)

  - _Acción_: Kelly boost +0.95€ cuando `n_ballena_banda` > 21.0 (IC base=+0.169)

- **PATRÓN** `n_total_lado` > `57.0` → IC=+0.238 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 57.0 (IC base=+0.169)

- **PATRÓN** `banda_hit_calibrado` > `0.8203` → IC=+0.294 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8203 (IC base=+0.169)

- **PATRÓN** `banda_z` > `10.232` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `banda_z` > 10.232 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.204 (n=96)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.169)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=158)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `3827.6428` → IC=+0.246 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3827.6428 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `296.0` → IC=+0.293 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 296.0 (IC base=+0.169)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `154.55` → IC=-0.259 (n=1984)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.55
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=5952)
...
- **FILTRO** `restante_s_al_confirmar` < `163.37` → IC=-0.160 (n=530)
...
- **FILTRO** `restante_s_al_confirmar` < `150.08` → IC=-0.272 (n=490)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1471)
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.262 (n=2650)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=551)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.215 (n=682)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.135 (n=1074)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.197 (n=3994)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.203 (n=1969)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.176 (n=686)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.193 (n=1033)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.242 (n=909)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=970)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.196)
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.201 (n=671)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.199 (n=8982)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 8.0 (IC base=+0.193)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.224 (n=7090)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.193)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.133 (n=1854)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.243 (n=1562)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.173 (n=653)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.208 (n=628)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.233 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.190)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.203 (n=1224)
...
- **PATRÓN** `restante_min` > `4.92` → IC=+0.156 (n=1282)
...
- **PATRÓN** `lag_apertura_s` < `6.72` → IC=+0.151 (n=1585)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 6.72 (IC base=+0.130)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.215 (n=599)
...
- **PATRÓN** `restante_min` > `4.9` → IC=+0.168 (n=604)
...
- **PATRÓN** `lag_apertura_s` < `6.14` → IC=+0.166 (n=597)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 6.14 (IC base=+0.138)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.191 (n=625)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.154 (n=657)
...
- **PATRÓN** `lag_apertura_s` < `3.46` → IC=+0.157 (n=607)

  - _Acción_: Kelly boost +0.78€ cuando `lag_apertura_s` < 3.46 (IC base=+0.122)
...
- **PATRÓN** `volumen_regimen` < `1.2608` → IC=+0.224 (n=378)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0782` → IC=+0.133 (n=889)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4943` → IC=+0.137 (n=860)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.4943 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `1.4673` → IC=+0.131 (n=978)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4673 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.2114` → IC=+0.124 (n=1327)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.278 (n=97)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.256 (n=293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2115` → IC=+0.238 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2115 (IC base=+0.220)

- **PATRÓN** `dist_vwap_pct` < `0.7424` → IC=+0.224 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7424 (IC base=+0.220)
...
- **PATRÓN** `volumen_regimen` < `1.2957` → IC=+0.227 (n=291)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0773` → IC=+0.231 (n=251)
...
- **PATRÓN** `volumen_spike_ratio` > `2.041` → IC=+0.224 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.041 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `12067.4093` → IC=+0.250 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12067.4093 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.219 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 411.0 (IC base=+0.220)
...
- **FILTRO** `sigma_h` > `0.0064` → IC=-0.140 (n=170)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `ibs_20min` > `0.7547` → IC=-0.147 (n=293)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7547
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=883)

- **FILTRO** `sigma_ewma_delta_pct` > `4.862` → IC=-0.150 (n=252)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.197 (n=31)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0055 (IC base=+0.047)

- **PATRÓN** `drift_60min` |x|≤ `0.3576` → IC=+0.125 (n=62)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3576 (IC base=+0.047)

- **PATRÓN** `ibs_20min` > `0.5233` → IC=+0.133 (n=47)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` > 0.5233 (IC base=+0.047)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `sigma_h` > `0.0243` → IC=-0.141 (n=143)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.135 (n=1087)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0071 (IC base=+0.055)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.254 (n=800)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1162` → IC=+0.163 (n=1032)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.1162 (IC base=+0.055)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4917` → IC=+0.181 (n=355)
...
- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.280 (n=511)
...
- **FILTRO** `ibs_20min` < `0.5135` → IC=-0.149 (n=266)
...
- **PATRÓN** `ibs_20min` > `0.84` → IC=+0.228 (n=134)
...
- **PATRÓN** `volumen_regimen` > `1.1469` → IC=+0.186 (n=49)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.1469 (IC base=-0.008)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5739` → IC=+0.142 (n=121)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.5739 (IC base=-0.008)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.220 (n=180)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9097` → IC=+0.290 (n=326)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9097 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `1.2538` → IC=+0.340 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2538 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.12` → IC=+0.276 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.12 (IC base=+0.211)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.081` → IC=+0.213 (n=413)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.081 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.278 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `2.2293` → IC=+0.227 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2293 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.229 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `2636.9304` → IC=+0.235 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2636.9304 (IC base=+0.211)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.202 (n=935)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.166 (n=2070)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9` → IC=+0.261 (n=1374)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.7743` → IC=+0.254 (n=519)
...
- **PATRÓN** `volumen_regimen` < `1.2394` → IC=+0.164 (n=1414)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2394 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `0.6988` → IC=+0.177 (n=1263)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.6988 (IC base=+0.160)
...
- **PATRÓN** `volumen_spike_ratio` < `2.321` → IC=+0.158 (n=1598)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.321 (IC base=+0.160)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=1666)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `2479.6478` → IC=+0.185 (n=1374)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2479.6478 (IC base=+0.160)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.193 (n=854)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3582` → IC=+0.198 (n=1794)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.3582 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.208 (n=836)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3974` → IC=+0.240 (n=1794)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3974 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.3354` → IC=+0.173 (n=1563)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.3354 (IC base=+0.180)
...
- **PATRÓN** `volumen_regimen` < `1.1764` → IC=+0.159 (n=1494)
...
- **PATRÓN** `ballena_activa_n` < `216.0` → IC=+0.161 (n=753)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.230 (n=283)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.188)

- **PATRÓN** `ibs_20min` > `0.4975` → IC=+0.231 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4975 (IC base=+0.188)

- **PATRÓN** `dist_vwap_pct` > `0.1754` → IC=+0.252 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1754 (IC base=+0.188)
...
- **PATRÓN** `volumen_regimen` < `1.3047` → IC=+0.192 (n=280)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1613` → IC=+0.190 (n=114)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.1613 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `11730.8031` → IC=+0.230 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11730.8031 (IC base=+0.188)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7388` → IC=+0.174 (n=176)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.7388 (IC base=+0.145)
...
- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.230 (n=279)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0096 (IC base=+0.194)

- **PATRÓN** `drift_60min` |x|≤ `0.5026` → IC=+0.201 (n=279)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5026 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.224 (n=252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.194)

- **PATRÓN** `ibs_20min` > `0.435` → IC=+0.258 (n=279)
...
- **PATRÓN** `volumen_regimen` > `0.6402` → IC=+0.219 (n=279)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6402 (IC base=+0.194)
...
- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.184 (n=96)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 126.0 (IC base=+0.194)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.140 (n=370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 8.0 (IC base=+0.118)

- **PATRÓN** `ibs_20min` > `0.8661` → IC=+0.233 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8661 (IC base=+0.118)

- **PATRÓN** `dist_vwap_pct` > `1.0035` → IC=+0.281 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0035 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.939` → IC=+0.287 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.939 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.6182` → IC=+0.136 (n=407)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.6182 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.1017` → IC=+0.138 (n=139)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` > 0.1017 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` > `1.5794` → IC=+0.126 (n=335)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.5794 (IC base=+0.118)
...
- **PATRÓN** `ibs_20min` < `0.1273` → IC=+0.309 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1273 (IC base=+0.218)

- **PATRÓN** `dist_vwap_pct` < `1.0003` → IC=+0.228 (n=490)
...
- **PATRÓN** `volumen_regimen` > `0.8787` → IC=+0.252 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8787 (IC base=+0.218)
...
- **PATRÓN** `ballena_activa_n` < `31.0` → IC=+0.175 (n=201)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 31.0 (IC base=+0.218)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.213 (n=792)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0087 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.152 (n=2418)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `0.7095` → IC=+0.156 (n=727)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7095 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `1.0874` → IC=+0.150 (n=749)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.0874 (IC base=+0.143)
...
- **PATRÓN** `volumen_spike_ratio` < `2.368` → IC=+0.140 (n=1815)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.368 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.9136` → IC=+0.152 (n=1375)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.9136 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=1906)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `3031.8812` → IC=+0.192 (n=1077)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 3031.8812 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `73.0` → IC=+0.190 (n=668)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.195 (n=165)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0058 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.195 (n=368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 6.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.3404` → IC=+0.223 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3404 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.241` → IC=+0.246 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.241 (IC base=+0.163)
...
- **PATRÓN** `volumen_regimen` < `0.6603` → IC=+0.177 (n=122)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6603 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `1.1138` → IC=+0.189 (n=165)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.1138 (IC base=+0.163)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5664` → IC=+0.204 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5664 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.3851` → IC=+0.197 (n=315)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.3851 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `11253.359` → IC=+0.205 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11253.359 (IC base=+0.163)
...
- **PATRÓN** `sigma_h` < `0.009` → IC=+0.151 (n=362)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.009 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=331)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.3643` → IC=+0.204 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3643 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.4105` → IC=+0.195 (n=162)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.4105 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.499` → IC=+0.187 (n=177)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 4.499 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.9227` → IC=+0.167 (n=241)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.9227 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4777` → IC=+0.266 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4777 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `3071.3952` → IC=+0.188 (n=322)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 3071.3952 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `236.0` → IC=+0.175 (n=232)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.172 (n=190)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0095 (IC base=+0.084)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.129 (n=195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 16.0 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.9231` → IC=+0.278 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9231 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.9817` → IC=+0.263 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9817 (IC base=+0.084)
...
- **PATRÓN** `libro_liquidez` > `2752.8978` → IC=+0.266 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2752.8978 (IC base=+0.084)
...
- **PATRÓN** `sigma_h` > `0.0172` → IC=+0.227 (n=232)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0172 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.197 (n=259)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 15.0 (IC base=+0.174)

- **PATRÓN** `ibs_20min` > `0.9753` → IC=+0.303 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9753 (IC base=+0.174)

- **PATRÓN** `dist_vwap_pct` > `1.2527` → IC=+0.287 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2527 (IC base=+0.174)
...
- **PATRÓN** `volumen_regimen` < `0.6183` → IC=+0.199 (n=171)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6183 (IC base=+0.174)

- **PATRÓN** `volumen_regimen` > `1.2398` → IC=+0.182 (n=171)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.2398 (IC base=+0.174)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3027` → IC=+0.177 (n=407)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.3027 (IC base=+0.174)

- **PATRÓN** `volumen_spike_ratio` > `1.8748` → IC=+0.171 (n=308)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.8748 (IC base=+0.174)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.188 (n=569)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.01 (IC base=+0.174)

- **PATRÓN** `libro_liquidez` > `3090.4756` → IC=+0.199 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3090.4756 (IC base=+0.174)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.151 (n=571)
...
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.209 (n=194)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.163 (n=387)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.182 (n=149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.209 (n=180)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.6103` → IC=+0.163 (n=387)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.6103 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.3601` → IC=+0.152 (n=400)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3601 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.522` → IC=+0.184 (n=207)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 3.522 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.3022` → IC=+0.167 (n=440)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.3022 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.6452` → IC=+0.142 (n=440)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6452 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` < `0.0976` → IC=+0.143 (n=385)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.0976 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.0766` → IC=+0.158 (n=220)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0766 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.6123` → IC=+0.169 (n=436)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.6123 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4358` → IC=+0.148 (n=435)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4358 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=571)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `7614.1842` → IC=+0.161 (n=440)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 7614.1842 (IC base=+0.141)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.206 (n=199)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0041 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2174` → IC=+0.162 (n=199)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.2174 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.211 (n=88)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1065` → IC=+0.216 (n=100)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1065 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.3008` → IC=+0.155 (n=224)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.3008 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.005` → IC=+0.139 (n=117)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 3.005 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.225` → IC=+0.144 (n=223)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.225 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2988` → IC=+0.162 (n=226)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2988 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `0.6265` → IC=+0.143 (n=225)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6265 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1596` → IC=+0.176 (n=72)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1596 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.6733` → IC=+0.158 (n=226)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.6733 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `10115.8658` → IC=+0.148 (n=225)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 10115.8658 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `753.0` → IC=+0.154 (n=180)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 753.0 (IC base=+0.136)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.221 (n=127)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.179)

- **PATRÓN** `drift_60min` |x|≤ `0.3192` → IC=+0.235 (n=96)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3192 (IC base=+0.179)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.202 (n=55)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.179)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.220 (n=98)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 10.0 (IC base=+0.179)

- **PATRÓN** `ibs_20min` < `0.6855` → IC=+0.178 (n=144)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6855 (IC base=+0.179)

- **PATRÓN** `ibs_20min` > `0.1577` → IC=+0.231 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1577 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` < `0.8894` → IC=+0.200 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8894 (IC base=+0.179)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.468` → IC=+0.296 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.468 (IC base=+0.179)

- **PATRÓN** `volumen_regimen` < `1.2404` → IC=+0.226 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2404 (IC base=+0.179)

- **PATRÓN** `volumen_pendiente_norm` < `0.1261` → IC=+0.199 (n=144)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` < 0.1261 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` < `2.2158` → IC=+0.246 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2158 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` > `1.4925` → IC=+0.188 (n=126)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.4925 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `9140.0556` → IC=+0.214 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9140.0556 (IC base=+0.179)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.150 (n=616)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1929)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.234 (n=606)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1845)

- **FILTRO** `ibs_20min` > `0.28` → IC=-0.213 (n=608)

  - _Acción_: SKIP cuando `ibs_20min` > 0.28
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=1843)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.132 (n=112)
...
- **FILTRO** `ballena_activa_n` > `4.0` → IC=-0.151 (n=147)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=292)
...
- **FILTRO** `drift_20min_pct` |x|> `0.3578` → IC=-0.173 (n=96)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=289)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1750)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=4411)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.279 (n=1475)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=4686)

- **FILTRO** `ibs_7min` < `0.7391` → IC=-0.230 (n=1539)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7391
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4622)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.176 (n=2084)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4077)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.227 (n=1766)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=5782)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.169 (n=1884)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=5664)
...
- **FILTRO** `ibs_7min` < `0.9857` → IC=-0.182 (n=561)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9857
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=290)
...
- **FILTRO** `hora_utc` > `17.0` → IC=-0.134 (n=277)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=969)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.236 (n=309)
...
- **FILTRO** `drift_7min_pct` |x|> `0.1458` → IC=-0.156 (n=422)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=824)
...
- **FILTRO** `py_entrada` < `0.39` → IC=-0.235 (n=304)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=964)

- **FILTRO** `ballena_activa_n` > `143.0` → IC=-0.161 (n=314)

  - _Acción_: SKIP cuando `ballena_activa_n` > 143.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=954)

- **FILTRO** `py_entrada` > `0.55` → IC=-0.197 (n=321)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.200 (n=211)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=645)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.266 (n=250)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=792)

- **FILTRO** `ibs_7min` < `0.7768` → IC=-0.202 (n=260)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7768
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=782)
...
- **FILTRO** `ibs_7min` > `0.1778` → IC=-0.155 (n=357)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1778
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=694)

- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.214 (n=260)
...
- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.197 (n=282)
...
- **FILTRO** `ibs_7min` > `0.8092` → IC=-0.144 (n=318)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=956)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.124 (n=413)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=861)
...
- **PATRÓN** `streak_len` < `3.0` → IC=+0.136 (n=105)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `streak_len` < 3.0 (IC base=+0.062)
...
- **FILTRO** `ibs_15` < `0.4324` → IC=-0.220 (n=23)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.4324
...
- **FILTRO** `sigma_h` > `0.0093` → IC=-0.149 (n=776)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0093
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1508)

- **FILTRO** `drift_15min` |x|> `0.7944` → IC=-0.125 (n=772)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.717` → IC=-0.193 (n=301)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=1983)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.111` → IC=+0.154 (n=53)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.77€ cuando `delta_ratio_macro` |x|> 0.111 (IC base=-0.102)
...
- **FILTRO** `sigma_h` > `0.0232` → IC=-0.126 (n=252)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0232
...
- **FILTRO** `drift_15min` |x|> `1.5149` → IC=-0.152 (n=185)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=559)

- **FILTRO** `sigma_ewma_delta_pct` > `15.062` → IC=-0.210 (n=91)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 15.062
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=653)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.53 sube el IC de -0.102 a +0.290 en UPDOWN_GBM_15M_TARDIO (n=60). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 571 | +0.078 | +40.88€ | 2 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 571 | +0.078 | +40.88€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 327 | +0.099 | +29.88€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 327 | +0.099 | +29.88€ | 0 | 10 |
...
| ✅ BALLENAS_TARDIAS | 5992 | -0.098 | -711.50€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 632 | -0.080 | -104.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5360 | -0.100 | -607.04€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1961 | -0.070 | -71.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1961 | -0.070 | -71.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1418 | -0.172 | -241.21€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1418 | -0.172 | -241.21€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 26942 | +0.113 | -1830.77€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5198 | +0.187 | -178.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 18618 | +0.092 | -1582.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3020 | +0.124 | -20.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3127 | +0.061 | -552.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 18 | -0.045 | +2.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3104 | +0.063 | -548.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5652 | +0.134 | -126.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1455 | +0.195 | -87.07€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3100 | +0.109 | -77.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1055 | +0.133 | +59.99€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3133 | +0.074 | -441.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 18 | +0.045 | -1.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3114 | +0.075 | -438.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6071 | +0.130 | -59.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1892 | +0.171 | +0.85€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3099 | +0.113 | -39.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1068 | +0.106 | -12.10€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5832 | +0.129 | -425.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1799 | +0.203 | -93.85€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3091 | +0.086 | -254.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 897 | +0.133 | -68.63€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3127 | +0.105 | -224.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 16 | +0.000 | +0.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3110 | +0.106 | -223.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5184 | +0.178 | -363.77€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5184 | +0.178 | -363.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1303 | +0.174 | -126.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1303 | +0.174 | -126.00€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1159 | +0.234 | -27.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1159 | +0.234 | -27.14€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1243 | +0.196 | -76.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1243 | +0.196 | -76.72€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 13362 | +0.193 | -1158.08€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 13362 | +0.193 | -1158.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2472 | +0.127 | -454.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2472 | +0.127 | -454.31€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2072 | +0.234 | -54.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2072 | +0.234 | -54.74€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2321 | +0.160 | -309.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2321 | +0.160 | -309.41€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2104 | +0.239 | -38.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2104 | +0.239 | -38.01€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2144 | +0.222 | -91.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2144 | +0.222 | -91.56€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2249 | +0.190 | -210.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2249 | +0.190 | -210.04€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 4802 | +0.130 | +119.81€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 4802 | +0.130 | +119.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 2386 | +0.138 | +95.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 2386 | +0.138 | +95.76€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2416 | +0.122 | +24.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2416 | +0.122 | +24.05€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 4310 | +0.097 | -160.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 444 | +0.040 | -36.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 3866 | +0.104 | -124.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 2975 | +0.095 | -88.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 444 | +0.040 | -36.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 2531 | +0.104 | -52.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 1335 | +0.103 | -71.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 1335 | +0.103 | -71.53€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 6525 | +0.044 | +1994.34€ | 0 | 18 |
| ✅ GBM_LATE_15M#15min | 6525 | +0.044 | +1994.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 843 | +0.176 | +534.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 843 | +0.176 | +534.73€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 896 | +0.172 | +502.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 896 | +0.172 | +502.96€ | 0 | 30 |
| ✅ GBM_LATE_15M#DOGE | 853 | +0.191 | +587.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 853 | +0.191 | +587.35€ | 0 | 18 |
| ✅ GBM_LATE_15M#ETH | 1043 | -0.053 | +3.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1043 | -0.053 | +3.02€ | 3 | 3 |
| ✅ GBM_LATE_15M#SOL | 1269 | -0.039 | +145.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1269 | -0.039 | +145.97€ | 4 | 3 |
| ✅ GBM_LATE_15M#XRP | 1621 | -0.043 | +220.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1621 | -0.043 | +220.31€ | 4 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 7484 | +0.043 | +2814.34€ | 0 | 17 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 7484 | +0.043 | +2814.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 1126 | -0.028 | +510.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 1126 | -0.028 | +510.46€ | 1 | 3 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1641 | -0.034 | +169.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1641 | -0.034 | +169.74€ | 1 | 5 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1379 | -0.013 | +282.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1379 | -0.013 | +282.35€ | 5 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1308 | +0.234 | +1175.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1308 | +0.234 | +1175.64€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 5139 | +0.169 | +3500.86€ | 0 | 26 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 5139 | +0.169 | +3500.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 634 | +0.193 | +466.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 634 | +0.193 | +466.11€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 867 | +0.164 | +570.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 867 | +0.164 | +570.55€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 630 | +0.201 | +486.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 630 | +0.201 | +486.64€ | 0 | 20 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 843 | +0.168 | +546.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 843 | +0.168 | +546.66€ | 0 | 23 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 1016 | +0.112 | +558.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 1016 | +0.112 | +558.68€ | 1 | 17 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 1149 | +0.193 | +872.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 1149 | +0.193 | +872.23€ | 0 | 25 |
...
| ✅ GBM_LATE_15M_TARDIO | 5994 | +0.163 | +3847.88€ | 0 | 26 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5994 | +0.163 | +3847.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 807 | +0.182 | +553.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 807 | +0.182 | +553.90€ | 0 | 17 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 987 | +0.163 | +631.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 987 | +0.163 | +631.02€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 798 | +0.216 | +655.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 798 | +0.216 | +655.60€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 872 | +0.136 | +454.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 872 | +0.136 | +454.26€ | 0 | 24 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1099 | +0.096 | +510.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1099 | +0.096 | +510.73€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1431 | +0.191 | +1042.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1431 | +0.191 | +1042.37€ | 0 | 23 |
| ✅ GBM_LATE_5M | 940 | +0.112 | +370.00€ | 1 | 18 |
| ✅ GBM_LATE_5M#5min | 940 | +0.112 | +370.00€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 353 | +0.120 | +182.05€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 353 | +0.120 | +182.05€ | 2 | 17 |
| ✅ GBM_LATE_5M#DOGE | 13 | -0.108 | -4.42€ | 0 | 0 |
| ✅ GBM_LATE_5M#DOGE#5min | 13 | -0.108 | -4.42€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH | 357 | +0.135 | +136.26€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 357 | +0.135 | +136.26€ | 0 | 17 |
...
| ✅ MOMENTUM_IBS_15M | 3420 | +0.001 | -49.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 3420 | +0.001 | -49.53€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 321 | +0.008 | +9.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 321 | +0.008 | +9.09€ | 1 | 1 |
...
| ✅ MOMENTUM_IBS_15M#ETH | 661 | +0.014 | +17.90€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#ETH#15min | 661 | +0.014 | +17.90€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL | 619 | -0.007 | -25.38€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#SOL#15min | 619 | -0.007 | -25.38€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP | 670 | -0.012 | -23.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#XRP#15min | 670 | -0.012 | -23.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA | 4996 | -0.032 | +172.81€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 4996 | -0.032 | +172.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 788 | -0.035 | +90.99€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 788 | -0.035 | +90.99€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 895 | -0.025 | -14.29€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 895 | -0.025 | -14.29€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 797 | -0.034 | +109.22€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 797 | -0.034 | +109.22€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 894 | -0.027 | -19.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 894 | -0.027 | -19.11€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 813 | -0.045 | +12.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 813 | -0.045 | +12.06€ | 4 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 809 | -0.028 | -6.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 809 | -0.028 | -6.06€ | 4 | 0 |
...
| ✅ MOMENTUM_IBS_5M | 2626 | +0.003 | -4.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#5min | 2626 | +0.003 | -4.04€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M#ETH | 783 | +0.015 | +13.62€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#ETH#5min | 783 | +0.015 | +13.62€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL | 1218 | +0.002 | -6.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 1218 | +0.002 | -6.75€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 178 | -0.006 | -5.46€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 13709 | -0.070 | +326.09€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 13709 | -0.070 | +326.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 2097 | -0.090 | +237.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 2097 | -0.090 | +237.47€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 2572 | -0.051 | +43.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 2572 | -0.051 | +43.12€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 2165 | -0.083 | +32.63€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 2165 | -0.083 | +32.63€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 2093 | -0.098 | -172.78€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 2093 | -0.098 | -172.78€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 2500 | -0.047 | +34.97€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 2500 | -0.047 | +34.97€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 2282 | -0.059 | +150.67€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 2282 | -0.059 | +150.67€ | 6 | 0 |
...
| ✅ STREAK_MOM_5M | 1634 | +0.026 | +29.69€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 1634 | +0.026 | +29.69€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 536 | +0.024 | +5.09€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 536 | +0.024 | +5.09€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 291 | +0.012 | +1.20€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 291 | +0.012 | +1.20€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 493 | +0.023 | +4.26€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 493 | +0.023 | +4.26€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 4890 | +0.008 | +130.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1915 | +0.042 | +170.41€ | 0 | 7 |
| ✅ UPDOWN_GBM#240min | 211 | +0.021 | +3.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 2380 | -0.014 | -40.62€ | 3 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3139 | -0.089 | +341.01€ | 5 | 4 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3139 | -0.089 | +341.01€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 254 | -0.086 | +112.74€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 254 | -0.086 | +112.74€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1006 | -0.069 | +167.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1006 | -0.069 | +167.31€ | 2 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 956 | -0.093 | +91.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 956 | -0.093 | +91.27€ | 7 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.090) — sin ventaja clara. oversold(IBS<0.3): IC=-0.005 n=1674 | neutral: IC=+0.006 n=1797 | overbought(IBS>0.7): IC=+0.085 n=1966
  - _Datos_: n=5706 IC=+0.030 PNL=+385.51€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 4 celda(s) pasan gate riguroso completo de 192 evaluadas (n>=40) y 545 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=-0.002 < 0.08 — monitorear
  - _Datos_: n=426 IC=-0.002 PNL=-6.98€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.078 n=79771 | tras_1loss IC=+0.045 n=61811 | tras_2loss IC=+0.009 n=28081/40 | gap=+0.069 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 4828 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.013 n=485 | contrario_BTC IC=-0.005 n=364/40 | gap=+0.008 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=4649 IC=+0.003 PNL=+79.42€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=4649 IC=+0.003 PNL=+79.42€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1127 IC=+0.032 PNL=+66.34€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1127 IC=+0.032 PNL=+66.34€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=1733 IC=-0.018 PNL=-49.84€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1733 IC=-0.018 PNL=-49.84€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1317 IC=+0.020 PNL=+71.83€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1317 IC=+0.020 PNL=+71.83€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=677 IC=+0.018 PNL=+33.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=677 IC=+0.018 PNL=+33.38€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=711 PNL=+242.98€
  - _Datos_: n=711 IC=+0.159 PNL=+242.98€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=3411 IC=-0.122 PNL=+380.82€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=3411 IC=-0.122 PNL=+380.82€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.228 < -0.1 con n=362 PNL=-23.20€
  - _Datos_: n=362 IC=-0.228 PNL=-23.20€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=854 IC=-0.037 PNL=+121.28€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=854 IC=-0.037 PNL=+121.28€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2472 IC=+0.127 PNL=-454.31€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2472 IC=+0.127 PNL=-454.31€
...
**⏳ H-CUSTOM-GBMLATE15M-SOL-RESCATE-PRECIO** — GBM_LATE_15M#SOL#15min#BUY_YES (pausada 05-Ago) -- posible rescate con filtro py en [0.45,0.55)
  ...
  - _Estado_: 34/40 ops en el filtro definido (IC actual=+0.167 PNL=+18.68€)
  - _Datos_: n=34 IC=+0.167 PNL=+18.68€
