# Hipótesis automáticas — 2026-08-08 19:06 UTC
_Generado por shadow_postmortem.py sobre 94090 resoluciones (PNL=+14040.71€)_
...
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.233 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.129)

- **PATRÓN** `restante_min` < `4.57` → IC=+0.161 (n=314)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` < 4.57 (IC base=+0.129)
...
- **PATRÓN** `profundidad_ratio_no` > `11.4` → IC=+0.173 (n=215)

  - _Acción_: Kelly boost +0.86€ cuando `profundidad_ratio_no` > 11.4 (IC base=+0.129)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.271 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.112)

- **PATRÓN** `restante_min` < `4.46` → IC=+0.135 (n=157)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 4.46 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.128 (n=111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 10.0 (IC base=+0.112)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.42` → IC=+0.186 (n=167)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` < 0.42 (IC base=+0.146)

- **PATRÓN** `restante_min` < `4.66` → IC=+0.188 (n=158)

  - _Acción_: Kelly boost +0.94€ cuando `restante_min` < 4.66 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.157 (n=240)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `profundidad_ratio_no` > `26.5` → IC=+0.216 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio_no` > 26.5 (IC base=+0.146)
...
| ✅ BALLENAS_TARDIAS | 2216 | -0.073 | -446.33€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 409 | +0.206 | -45.47€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 1807 | -0.136 | -400.86€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 404 | +0.003 | -14.78€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 404 | +0.003 | -14.78€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 383 | -0.173 | -65.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 383 | -0.173 | -65.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 379 | -0.098 | -178.34€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 379 | -0.098 | -178.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 25314 | +0.119 | -594.00€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6174 | +0.195 | -108.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 444 | +0.047 | -41.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 16812 | +0.091 | -498.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1884 | +0.139 | +54.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2684 | +0.086 | -129.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 11 | +0.021 | -0.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2668 | +0.086 | -132.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5469 | +0.131 | -82.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1938 | +0.182 | -100.81€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 142 | +0.049 | -16.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2675 | +0.094 | -30.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 714 | +0.148 | +65.38€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2682 | +0.078 | -154.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 15 | +0.243 | +10.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2666 | +0.076 | -166.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 5910 | +0.136 | -18.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2071 | +0.197 | +5.89€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 147 | -0.017 | -32.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3079 | +0.103 | -7.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 613 | +0.131 | +14.67€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5858 | +0.135 | -175.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2100 | +0.205 | -21.84€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 147 | +0.104 | +3.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3054 | +0.088 | -131.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 557 | +0.137 | -25.58€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2711 | +0.096 | -33.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 39 | +0.134 | -2.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2670 | +0.095 | -30.36€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 11172 | +0.196 | -846.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 11172 | +0.196 | -846.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2002 | +0.158 | -274.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2002 | +0.158 | -274.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1764 | +0.221 | -50.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1764 | +0.221 | -50.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1934 | +0.181 | -207.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1934 | +0.181 | -207.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 1797 | +0.218 | -65.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 1797 | +0.218 | -65.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 1822 | +0.215 | -83.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 1822 | +0.215 | -83.71€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 626 | +0.129 | +12.88€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 626 | +0.129 | +12.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 312 | +0.112 | -5.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 312 | +0.112 | -5.83€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 314 | +0.146 | +18.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 314 | +0.146 | +18.71€ | 0 | 5 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.129 n=57497 | tras_1loss IC=+0.086 n=36345 | tras_2loss IC=+0.052 n=14999/40 | gap=+0.077 (umbral 0.05)
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2002 IC=+0.158 PNL=-274.16€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2002 IC=+0.158 PNL=-274.16€
