# Hipótesis automáticas — 2026-08-08 04:11 UTC
_Generado por shadow_postmortem.py sobre 90227 resoluciones (PNL=+13686.94€)_
...
- **PATRÓN** `drift_60min` |x|≤ `0.1142` → IC=+0.278 (n=34)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1142 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.156 (n=3193)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 7.0 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.1188` → IC=+0.166 (n=1218)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1188 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.025` → IC=+0.245 (n=1295)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.025 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `2042.29` → IC=+0.152 (n=3056)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2042.29 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0039` → IC=+0.163 (n=3116)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0039 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0964` → IC=+0.199 (n=71)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.0964 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.157 (n=1065)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 18.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.154 (n=1175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 6.0 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6113` → IC=+0.151 (n=322)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6113 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.169` → IC=+0.172 (n=516)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 8.169 (IC base=+0.147)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.148 (n=191)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0022 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.137 (n=508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 8.0 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.4991` → IC=+0.154 (n=76)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.4991 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.349` → IC=+0.188 (n=110)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 12.349 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `11100.7306` → IC=+0.151 (n=313)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 11100.7306 (IC base=+0.115)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.483` → IC=+0.165 (n=168)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 9.483 (IC base=+0.074)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `drift_60min` |x|> `0.1971` → IC=-0.222 (n=16)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.126 (n=276)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 7.0 (IC base=+0.072)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.224 (n=759)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.198)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.214 (n=765)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.031` → IC=+0.336 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.031 (IC base=+0.198)
...
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.246 (n=699)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.227)

- **PATRÓN** `drift_60min` |x|≤ `0.4577` → IC=+0.306 (n=65)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4577 (IC base=+0.227)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.323` → IC=+0.255 (n=96)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.323 (IC base=+0.227)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.244 (n=704)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.283 (n=67)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.267)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.300 (n=28)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.018` → IC=+0.276 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.018 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.905` → IC=+0.346 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.905 (IC base=+0.267)

- **PATRÓN** `libro_liquidez` > `1263.2483` → IC=+0.276 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1263.2483 (IC base=+0.267)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.213 (n=294)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0034 (IC base=+0.195)

- **PATRÓN** `drift_60min` |x|≤ `0.0964` → IC=+0.237 (n=97)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0964 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.263 (n=196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.75` → IC=+0.223 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.75 (IC base=+0.195)

- **PATRÓN** `libro_liquidez` > `1479.1934` → IC=+0.205 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1479.1934 (IC base=+0.195)
...
- **PATRÓN** `sigma_h` > `0.0022` → IC=+0.148 (n=52)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0022 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0796` → IC=+0.167 (n=25)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0796 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.198 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 12.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.136 (n=20)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 5.0 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.518` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` < 7.518 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `4027.3872` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 4027.3872 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.292 (n=22)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.721` → IC=+0.231 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.721 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.152 (n=21)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0053 (IC base=+0.088)

- **PATRÓN** `drift_60min` |x|≤ `0.2441` → IC=+0.159 (n=42)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.2441 (IC base=+0.088)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.194 (n=47)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 9.0 (IC base=+0.088)

- **PATRÓN** `libro_liquidez` > `1755.237` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1755.237 (IC base=+0.088)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.300 (n=43)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.271)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.289 (n=55)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.271)

- **PATRÓN** `drift_60min` |x|≤ `0.1353` → IC=+0.283 (n=21)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1353 (IC base=+0.271)

- **PATRÓN** `hora_utc` < `19.0` → IC=+0.278 (n=61)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 19.0 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.558` → IC=+0.281 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.558 (IC base=+0.271)

- **PATRÓN** `libro_liquidez` > `1425.8012` → IC=+0.274 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1425.8012 (IC base=+0.271)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.126 (n=2293)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` > 0.0069 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.015` → IC=+0.214 (n=1238)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.015 (IC base=+0.098)

- **PATRÓN** `drift_60min` |x|≤ `0.093` → IC=+0.151 (n=104)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.093 (IC base=+0.109)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `10.972` → IC=+0.167 (n=136)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 10.972 (IC base=+0.064)

- **PATRÓN** `libro_liquidez` > `8573.1499` → IC=+0.124 (n=293)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 8573.1499 (IC base=+0.064)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=905)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.6671` → IC=+0.206 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6671 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.566` → IC=+0.288 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.566 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.160 (n=740)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.01 (IC base=+0.155)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.187 (n=935)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0065 (IC base=+0.175)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.199 (n=648)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 12.0 (IC base=+0.175)

- **PATRÓN** `dist_vwap_pct` > `0.7539` → IC=+0.274 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7539 (IC base=+0.175)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.517` → IC=+0.174 (n=811)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` < 2.517 (IC base=+0.175)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.187 (n=828)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.379` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 5.379 (IC base=+0.011)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.134` → IC=+0.293 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.134 (IC base=+0.033)
...
- **FILTRO** `liq_n` < `4.0` → IC=-0.154 (n=24)
...
- **FILTRO** `hora_utc` > `7.0` → IC=-0.182 (n=20)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.163 (n=170)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0049 (IC base=+0.082)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.185 (n=642)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min` — IC=+0.392 n=35. Faltan ~5 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC` — IC=+0.392 n=35. Faltan ~5 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH#15min` — IC=+0.419 n=35. Faltan ~5 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH` — IC=+0.419 n=35. Faltan ~5 resoluciones para umbral n≥40. ETA: ~4h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 
 | 0 | 0 |
| ✅ UPDOWN_OU_5M#DOGE#5min | 59 | -0.156 | -10.07€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#ETH | 36 | -0.184 | -5.38€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#ETH#5min | 36 | -0.184 | -5.38€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#SOL | 68 | -0.157 | -9.94€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#SOL#5min | 68 | -0.157 | -9.94€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#XRP | 84 | -0.163 | -16.17€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#XRP#5min | 84 | -0.163 | -16.17€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.159: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.115 n=2530 | neutral: IC=+0.043 n=1965 | overbought(IBS>0.7): IC=+0.202 n=2500
  - _Datos_: n=7458 IC=+0.130 PNL=+2536.83€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.162 n=131 PNL=+61.09€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=12h: IC=+0.151 n=173 PNL=+57.67€ → BOOST | H=14h: IC=+0.137 n=177 PNL=+59.15€ → BOOST | H=16h: IC=+0.111 n=165 PNL=+42.79€ → BOOST | H=21h: IC=+0.119 n=158 PNL=+36.34€ → BOOST | H=22h: IC=+0.168 n=188 PNL=+61.92€ → BOOST
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 34 celda(s) pasan gate riguroso completo de 154 evaluadas (n>=40) y 314 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.128 n=55010 | tras_1loss IC=+0.085 n=34963 | tras_2loss IC=+0.052 n=14447/40 | gap=+0.075 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3827 IC=+0.063 PNL=+571.14€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3827 IC=+0.063 PNL=+571.14€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1505 IC=+0.063 PNL=+220.45€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1505 IC=+0.063 PNL=+220.45€
...
**🟡 H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.129 > 0.1 con n=33 PNL=+12.12€
  - _Datos_: n=33 IC=+0.129 PNL=+12.12€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=627 IC=+0.087 PNL=+97.28€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=627 IC=+0.087 PNL=+97.28€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.092 > 0.08 con n=1980 PNL=+365.45€
  - _Datos_: n=1980 IC=+0.092 PNL=+365.45€
...
**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: n=697 IC=+0.072 PNL=+85.33€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=697 IC=+0.072 PNL=+85.33€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=580 IC=+0.055 PNL=+68.46€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=580 IC=+0.055 PNL=+68.46€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1655 IC=+0.044 PNL=+189.90€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1655 IC=+0.044 PNL=+189.90€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.165 > 0.1 con n=1633 PNL=+566.55€
  - _Datos_: n=1633 IC=+0.165 PNL=+566.55€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1681 IC=-0.083 PNL=+382.00€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1681 IC=-0.083 PNL=+382.00€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1471 IC=+0.066 PNL=+161.42€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1471 IC=+0.066 PNL=+161.42€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.109 > 0.08 con n=1101 PNL=+266.69€
  - _Datos_: n=1101 IC=+0.109 PNL=+266.69€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.154 > 0.08 con n=397 PNL=+115.61€
  - _Datos_: n=397 IC=+0.154 PNL=+115.61€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1713 IC=+0.189 PNL=+980.42€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1713 IC=+0.189 PNL=+980.42€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.084 > 0.08 con n=873 PNL=+168.29€
  - _Datos_: n=873 IC=+0.084 PNL=+168.29€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.112 > 0.08 con n=937 PNL=+289.80€
  - _Datos_: n=937 IC=+0.112 PNL=+289.80€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.08 con n=1268 PNL=+626.10€
  - _Datos_: n=1268 IC=+0.125 PNL=+626.10€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.203 > 0.08 con n=477 PNL=+27.50€
  - _Datos_: n=477 IC=+0.203 PNL=+27.50€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.266 > 0.08 con n=763 PNL=-27.33€
  - _Datos_: n=763 IC=+0.266 PNL=-27.33€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1858 IC=+0.156 PNL=-255.22€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1858 IC=+0.156 PNL=-255.22€
