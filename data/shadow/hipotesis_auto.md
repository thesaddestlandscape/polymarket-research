# Hipótesis automáticas — 2026-09-14 21:59 UTC
_Generado por shadow_postmortem.py sobre 441674 resoluciones (PNL=+47219.35€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.96` → IC=-0.261 (n=5539)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.96
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=16627)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.133 (n=1953)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=1162)

- **FILTRO** `restante_s_al_confirmar` < `138.64` → IC=-0.291 (n=778)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 138.64
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2337)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `483.07` → IC=-0.160 (n=295)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 483.07
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=886)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `135.23` → IC=-0.289 (n=694)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 135.23
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2083)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `142.03` → IC=-0.161 (n=1433)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 142.03
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4299)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.06` → IC=-0.255 (n=1294)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.06
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3882)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `157.23` → IC=-0.340 (n=1381)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.23
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2804)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.33` → IC=-0.302 (n=84)

  - _Acción_: SKIP cuando `py_entrada` < 0.33
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=300)

- **FILTRO** `py_entrada` < `0.48` → IC=-0.163 (n=99)
...
- **FILTRO** `py_entrada` < `0.38` → IC=-0.258 (n=64)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.196 (n=11364)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.156 (n=2800)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `11040.8599` → IC=+0.195 (n=894)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 11040.8599 (IC base=+0.098)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.143 (n=8577)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.245 (n=7590)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.170 (n=5545)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7095.7162` → IC=+0.176 (n=1754)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7095.7162 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1319)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1624)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `14514.2262` → IC=+0.216 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14514.2262 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.208 (n=1201)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.325` → IC=+0.299 (n=897)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=1688)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `12764.9378` → IC=+0.211 (n=593)
...
- **PATRÓN** `py_entrada` > `0.62` → IC=+0.184 (n=267)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.62 (IC base=+0.106)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2268)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.243 (n=1009)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.235)

- **PATRÓN** `py_entrada` < `0.305` → IC=+0.329 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.305 (IC base=+0.235)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.238 (n=1164)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `4381.435` → IC=+0.236 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4381.435 (IC base=+0.235)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.133 (n=369)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.665` → IC=+0.226 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.138 (n=622)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.219 (n=504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.181 (n=945)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.181 (n=1085)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=8792)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.220 (n=3140)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.333 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.182 (n=2063)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.182 (n=1857)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.71 (IC base=+0.177)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=1948)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=2107)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.194 (n=1509)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=4753)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.71 (IC base=+0.167)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.226 (n=4621)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `2.69` → IC=+0.146 (n=1807)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 2.69 (IC base=+0.118)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.318 (n=650)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1614.3793` → IC=+0.297 (n=915)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1614.3793 (IC base=+0.289)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.328 (n=306)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9773` → IC=+0.231 (n=1955)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.703` → IC=+0.153 (n=3213)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 2.703 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` < `1.2306` → IC=+0.246 (n=1472)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1759` → IC=+0.193 (n=3961)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1759 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.3104` → IC=+0.200 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3104 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `1.4704` → IC=+0.196 (n=3825)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4704 (IC base=+0.098)

- **PATRÓN** `ibs_20min` < `0.5739` → IC=+0.127 (n=7202)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.5739 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` > `0.5558` → IC=+0.169 (n=442)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.5558 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` < `0.3361` → IC=+0.165 (n=2398)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.3361 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` < `0.7009` → IC=+0.164 (n=1007)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.7009 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `0.8714` → IC=+0.172 (n=1526)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8714 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.1686` → IC=+0.222 (n=1122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1686 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `1.4638` → IC=+0.197 (n=3810)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4638 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.205 (n=3579)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 159.0 (IC base=+0.056)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.189 (n=442)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3237` → IC=+0.166 (n=1314)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3237 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.166 (n=641)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` < `2.6362` → IC=+0.154 (n=1208)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.6362 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.165 (n=1208)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.190 (n=1190)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.184 (n=967)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 62.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.253 (n=879)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.1902` → IC=+0.276 (n=655)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1902 (IC base=+0.236)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.252 (n=670)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.236)

- **PATRÓN** `ibs_20min` < `0.062` → IC=+0.288 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.062 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.34` → IC=+0.248 (n=1024)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.34 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.069` → IC=+0.236 (n=777)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.069 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` > `0.287` → IC=+0.274 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.287 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` > `2.7136` → IC=+0.266 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7136 (IC base=+0.236)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.239 (n=999)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `1734.6286` → IC=+0.247 (n=655)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1107` → IC=+0.239 (n=439)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1107 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.229 (n=999)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` > `0.9251` → IC=+0.254 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9251 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` > `0.211` → IC=+0.219 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.211 (IC base=+0.215)
...
- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.226 (n=998)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `0.8751` → IC=+0.215 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8751 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` < `0.163` → IC=+0.215 (n=1011)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.163 (IC base=+0.215)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4924` → IC=+0.226 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4924 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.397` → IC=+0.218 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.397 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `11855.79` → IC=+0.228 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11855.79 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.160 (n=935)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0048 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0755` → IC=+0.167 (n=355)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0755 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.167 (n=358)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 18.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.6789` → IC=+0.179 (n=1063)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6789 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1307` → IC=+0.157 (n=948)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1307 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.446` → IC=+0.176 (n=183)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 11.446 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.149 (n=1063)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2046 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.6178` → IC=+0.141 (n=1062)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6178 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1561` → IC=+0.199 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1561 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.4376` → IC=+0.152 (n=954)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4376 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4146` → IC=+0.152 (n=954)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4146 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12789.0736` → IC=+0.153 (n=708)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12789.0736 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `311.0` → IC=+0.157 (n=581)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 311.0 (IC base=+0.140)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.191 (n=1287)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1065` → IC=+0.187 (n=1084)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1065 (IC base=+0.178)

- **PATRÓN** `volumen_pendiente_norm` > `0.3789` → IC=+0.176 (n=168)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.3789 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` > `1.6649` → IC=+0.182 (n=1200)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.6649 (IC base=+0.178)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.192 (n=1462)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.178)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.220 (n=1108)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.212)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.213 (n=992)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.247 (n=369)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` < `0.3883` → IC=+0.231 (n=974)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3883 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.677` → IC=+0.234 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.677 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.378` → IC=+0.214 (n=1211)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.378 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` > `0.3647` → IC=+0.265 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3647 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.2989` → IC=+0.222 (n=653)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2989 (IC base=+0.212)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `1889.7284` → IC=+0.233 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1889.7284 (IC base=+0.212)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.203 (n=907)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 50.0 (IC base=+0.212)

### GBM_LATE_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1624)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.258` → IC=+0.139 (n=510)
...
- **PATRÓN** `dist_vwap_pct` > `0.1614` → IC=+0.185 (n=182)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1614 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `0.695` → IC=+0.148 (n=225)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.695 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` > `1.1643` → IC=+0.147 (n=171)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.1643 (IC base=-0.005)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5018` → IC=+0.175 (n=413)
...
- **FILTRO** `ibs_20min` > `0.28` → IC=-0.128 (n=1673)

  - _Acción_: SKIP cuando `ibs_20min` > 0.28
  - _Potencial_: sin este filtro IC_bueno=+0.112 (n=827)

- **FILTRO** `sigma_ewma_delta_pct` > `8.618` → IC=-0.201 (n=272)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.618
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=2228)
...
- **PATRÓN** `dist_vwap_pct` > `0.672` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.672 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` < `0.6535` → IC=+0.184 (n=74)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6535 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` > `0.9262` → IC=+0.182 (n=146)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.9262 (IC base=-0.048)

- **PATRÓN** `volumen_pendiente_norm` < `0.2003` → IC=+0.188 (n=174)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2003 (IC base=-0.048)
...
- **PATRÓN** `dist_vwap_pct` > `0.755` → IC=+0.261 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.755 (IC base=-0.032)

- **PATRÓN** `dist_vwap_pct` < `0.2503` → IC=+0.239 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2503 (IC base=-0.032)

- **PATRÓN** `volumen_regimen` < `0.7344` → IC=+0.238 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7344 (IC base=-0.032)

- **PATRÓN** `volumen_regimen` > `1.0875` → IC=+0.298 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0875 (IC base=-0.032)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2413` → IC=+0.254 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2413 (IC base=-0.032)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.234 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=-0.032)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.175 (n=2443)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.009 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.8824` → IC=+0.264 (n=3332)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8824 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `1.0168` → IC=+0.284 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0168 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.495` → IC=+0.142 (n=3477)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.495 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `0.678` → IC=+0.234 (n=2222)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.678 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` < `0.114` → IC=+0.224 (n=3754)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.114 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.2489` → IC=+0.256 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2489 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `1.4784` → IC=+0.235 (n=1321)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4784 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `2.7883` → IC=+0.238 (n=1318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7883 (IC base=+0.087)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.278 (n=3439)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 103.0 (IC base=+0.087)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.137 (n=2510)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0084 (IC base=+0.065)

- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.147 (n=6614)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5597 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.6702` → IC=+0.243 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6702 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.1622` → IC=+0.230 (n=1815)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1622 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `1.2024` → IC=+0.256 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2024 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.2515` → IC=+0.325 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2515 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `1.6234` → IC=+0.250 (n=1139)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6234 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` > `2.3762` → IC=+0.254 (n=1173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3762 (IC base=+0.065)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.251 (n=2446)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.065)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2365` → IC=-0.144 (n=495)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2365
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1486)
...
- **PATRÓN** `ibs_20min` > `0.8645` → IC=+0.253 (n=496)
...
- **FILTRO** `ibs_20min` > `0.8328` → IC=-0.149 (n=554)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8328
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1665)

- **PATRÓN** `dist_vwap_pct` > `0.3003` → IC=+0.140 (n=248)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.3003 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` > `0.6498` → IC=+0.131 (n=570)
...
- **PATRÓN** `volumen_regimen` > `1.1352` → IC=+0.230 (n=120)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.241 (n=589)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.298 (n=831)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.278)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.320 (n=315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.278)

- **PATRÓN** `ibs_20min` < `0.3357` → IC=+0.286 (n=928)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3357 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.885` → IC=+0.299 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.885 (IC base=+0.278)

- **PATRÓN** `volumen_pendiente_norm` > `0.3448` → IC=+0.307 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3448 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` < `1.6193` → IC=+0.279 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6193 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` > `2.2184` → IC=+0.283 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2184 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.286 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `1881.2284` → IC=+0.297 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1881.2284 (IC base=+0.278)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.272 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 18.0 (IC base=+0.278)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2414` → IC=-0.208 (n=330)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2414
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=992)

- **FILTRO** `ibs_20min` > `0.8186` → IC=-0.180 (n=436)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8186
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=1311)

- **PATRÓN** `ibs_20min` > `0.8031` → IC=+0.144 (n=450)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.8031 (IC base=-0.016)
...
- **PATRÓN** `volumen_regimen` < `0.9592` → IC=+0.215 (n=254)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9592 (IC base=-0.016)

- **PATRÓN** `volumen_regimen` > `0.6162` → IC=+0.192 (n=258)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.6162 (IC base=-0.016)

- **PATRÓN** `volumen_pendiente_norm` > `0.2725` → IC=+0.306 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2725 (IC base=-0.016)

- **PATRÓN** `volumen_spike_ratio` < `1.4915` → IC=+0.273 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4915 (IC base=-0.016)

- **PATRÓN** `ballena_activa_n` < `171.0` → IC=+0.244 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 171.0 (IC base=-0.016)

- **PATRÓN** `dist_vwap_pct` > `0.1219` → IC=+0.170 (n=95)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1219 (IC base=-0.024)

- **PATRÓN** `dist_vwap_pct` < `0.2706` → IC=+0.150 (n=201)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.2706 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` < `0.9651` → IC=+0.152 (n=179)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.9651 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` > `0.7202` → IC=+0.167 (n=181)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.7202 (IC base=-0.024)

- **PATRÓN** `volumen_pendiente_norm` > `0.1508` → IC=+0.324 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1508 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` < `1.787` → IC=+0.239 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.787 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` > `2.4157` → IC=+0.268 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4157 (IC base=-0.024)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.222 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=-0.024)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.202 (n=790)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6667
  - _Potencial_: sin este filtro IC_bueno=+0.253 (n=806)

- **FILTRO** `ibs_20min` > `0.7188` → IC=-0.235 (n=424)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7188
  - _Potencial_: sin este filtro IC_bueno=+0.078 (n=1273)

- **FILTRO** `sigma_ewma_delta_pct` > `4.689` → IC=-0.168 (n=401)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.689
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1296)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.253 (n=806)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6667 (IC base=+0.028)

- **PATRÓN** `dist_vwap_pct` > `0.7795` → IC=+0.338 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7795 (IC base=+0.028)

- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.286 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.028)

- **PATRÓN** `volumen_regimen` > `0.639` → IC=+0.277 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.639 (IC base=+0.028)

- **PATRÓN** `volumen_pendiente_norm` < `0.1077` → IC=+0.278 (n=506)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4456` → IC=+0.311 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4456 (IC base=+0.028)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.322 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 55.0 (IC base=+0.028)

- **PATRÓN** `ibs_20min` < `0.4118` → IC=+0.124 (n=851)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.4118 (IC base=-0.000)

- **PATRÓN** `dist_vwap_pct` > `0.5612` → IC=+0.180 (n=73)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.5612 (IC base=-0.000)

- **PATRÓN** `dist_vwap_pct` < `0.3758` → IC=+0.181 (n=340)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.3758 (IC base=-0.000)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.233 (n=148)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6339` → IC=+0.196 (n=304)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.6339 (IC base=-0.000)

- **PATRÓN** `volumen_spike_ratio` > `1.5236` → IC=+0.170 (n=304)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.5236 (IC base=-0.000)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.202 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=-0.000)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.323 (n=676)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1843` → IC=+0.314 (n=583)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1843 (IC base=+0.267)
...
- **PATRÓN** `volumen_regimen` > `0.8564` → IC=+0.293 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8564 (IC base=+0.267)

- **PATRÓN** `volumen_pendiente_norm` < `0.11` → IC=+0.270 (n=885)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5657` → IC=+0.272 (n=948)
...
- **PATRÓN** `libro_liquidez` > `2576.372` → IC=+0.274 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2576.372 (IC base=+0.267)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.275 (n=366)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.007 (IC base=+0.266)

- **PATRÓN** `sigma_h` > `0.0203` → IC=+0.294 (n=498)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0203 (IC base=+0.266)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.280 (n=548)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.266)

- **PATRÓN** `ibs_20min` < `0.385` → IC=+0.303 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.385 (IC base=+0.266)

- **PATRÓN** `dist_vwap_pct` > `0.5351` → IC=+0.281 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5351 (IC base=+0.266)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.406` → IC=+0.285 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.406 (IC base=+0.266)

- **PATRÓN** `volumen_regimen` > `1.248` → IC=+0.310 (n=366)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5563` → IC=+0.263 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5563 (IC base=+0.266)

- **PATRÓN** `volumen_spike_ratio` > `1.4376` → IC=+0.257 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4376 (IC base=+0.266)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.268 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.266)

- **PATRÓN** `libro_liquidez` > `2553.7488` → IC=+0.275 (n=731)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.202 (n=1948)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.3346` → IC=+0.175 (n=5141)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3346 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6115)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.697` → IC=+0.231 (n=5223)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.697 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.1646` → IC=+0.199 (n=2584)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1646 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.234` → IC=+0.250 (n=1210)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.234 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.2177` → IC=+0.166 (n=3903)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2177 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6235` → IC=+0.162 (n=3902)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6235 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.1071` → IC=+0.186 (n=2287)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1071 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `2.311` → IC=+0.170 (n=4878)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.311 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6798` → IC=+0.168 (n=1848)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.6798 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `3828.4706` → IC=+0.175 (n=1947)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3828.4706 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.186 (n=4753)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 124.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.185 (n=3725)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0063 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.0782` → IC=+0.205 (n=1863)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0782 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.200 (n=2693)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` < `0.4587` → IC=+0.226 (n=5584)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4587 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.2216` → IC=+0.161 (n=4125)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2216 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.27` → IC=+0.191 (n=974)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 10.27 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.1872` → IC=+0.152 (n=4084)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1872 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6257` → IC=+0.149 (n=4084)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6257 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2921` → IC=+0.228 (n=793)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2921 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.168 (n=2171)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6493` → IC=+0.177 (n=1645)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6493 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.170 (n=4547)
...
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.242 (n=618)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.250 (n=629)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.239)

- **PATRÓN** `drift_60min` |x|≤ `0.1815` → IC=+0.296 (n=469)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1815 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.245 (n=641)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1074` → IC=+0.267 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1074 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.024` → IC=+0.253 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.024 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` < `0.0703` → IC=+0.237 (n=546)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8747` → IC=+0.252 (n=421)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.240 (n=716)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `1906.8` → IC=+0.259 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1906.8 (IC base=+0.239)

- **PATRÓN** `ballena_activa_n` < `45.0` → IC=+0.241 (n=400)
...
- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.163 (n=950)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.204 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1594` → IC=+0.192 (n=290)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1594 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4386` → IC=+0.158 (n=841)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4386 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4146` → IC=+0.152 (n=840)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4146 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.236 (n=800)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.221)

- **PATRÓN** `drift_60min` |x|≤ `0.2233` → IC=+0.233 (n=534)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2233 (IC base=+0.221)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.268 (n=287)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.221)

- **PATRÓN** `ibs_20min` < `0.3486` → IC=+0.250 (n=799)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3486 (IC base=+0.221)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.677` → IC=+0.271 (n=330)
...
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.157 (n=973)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0071 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.3714` → IC=+0.141 (n=973)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3714 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=385)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 17.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` < `0.6008` → IC=+0.177 (n=973)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6008 (IC base=+0.124)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.147` → IC=+0.189 (n=191)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 12.147 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.134 (n=649)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8615 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.128 (n=974)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.6121 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.2909` → IC=+0.199 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2909 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` < `1.7982` → IC=+0.127 (n=574)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.7982 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` > `2.4786` → IC=+0.147 (n=287)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.4786 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `9877.5526` → IC=+0.150 (n=441)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 9877.5526 (IC base=+0.124)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.335` → IC=+0.154 (n=229)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.335 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.0417` → IC=+0.124 (n=942)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.127 (n=408)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.1766` → IC=+0.141 (n=421)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.1766 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.207 (n=728)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0161 (IC base=+0.202)

- **PATRÓN** `drift_60min` |x|≤ `0.089` → IC=+0.221 (n=364)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.089 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.214 (n=541)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4309` → IC=+0.239 (n=1092)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4309 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `1.1146` → IC=+0.212 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1146 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` < `0.2576` → IC=+0.204 (n=1126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2576 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.3` → IC=+0.236 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.3 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6303` → IC=+0.216 (n=1092)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2526` → IC=+0.196 (n=842)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2526 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.4626` → IC=+0.190 (n=957)
...
- **PATRÓN** `libro_liquidez` > `2514.0359` → IC=+0.210 (n=728)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2514.0359 (IC base=+0.202)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.149 (n=465)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0038 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.155 (n=465)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0087 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0953` → IC=+0.150 (n=464)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.0953 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.185 (n=699)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.4048` → IC=+0.170 (n=1390)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4048 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.821` → IC=+0.170 (n=201)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.821 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.168 (n=630)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8649` → IC=+0.160 (n=797)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8649 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1659` → IC=+0.162 (n=382)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.1659 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.4352` → IC=+0.163 (n=443)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4352 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `2.5988` → IC=+0.156 (n=443)
...
- **PATRÓN** `libro_liquidez` > `8135.1658` → IC=+0.168 (n=631)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 8135.1658 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.162 (n=1171)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 156.0 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.153 (n=480)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0037 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.129 (n=970)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 11.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.141 (n=1439)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.6296 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.825` → IC=+0.127 (n=566)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 3.825 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.167` → IC=+0.140 (n=370)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` > 0.167 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` < `2.2392` → IC=+0.125 (n=1207)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.139 (n=242)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0047 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.128 (n=248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 11.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` < `0.3132` → IC=+0.147 (n=242)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.3132 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.514` → IC=+0.146 (n=97)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 6.514 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2187` → IC=+0.167 (n=61)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2187 (IC base=+0.094)
...
- **PATRÓN** `sigma_h` < `0.0234` → IC=+0.163 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0234 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.2313` → IC=+0.178 (n=116)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2313 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.182 (n=61)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 16.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.205 (n=76)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.7653` → IC=+0.201 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7653 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.2468` → IC=+0.163 (n=90)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.2468 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `1.0637` → IC=+0.151 (n=196)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 1.0637 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.394` → IC=+0.175 (n=149)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 3.394 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `1.104` → IC=+0.167 (n=58)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.104 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` < `0.0834` → IC=+0.164 (n=132)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.0834 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.2494` → IC=+0.184 (n=131)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.2494 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.174 (n=179)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.02 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `2722.5042` → IC=+0.154 (n=79)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2722.5042 (IC base=+0.147)

- **PATRÓN** `sigma_h` > `0.0222` → IC=+0.171 (n=86)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0222 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.132 (n=131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 10.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.6` → IC=+0.127 (n=191)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.6 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `1.1471` → IC=+0.250 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1471 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.969` → IC=+0.173 (n=50)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 4.969 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` > `0.6616` → IC=+0.128 (n=189)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.6616 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` > `2.8612` → IC=+0.139 (n=59)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.8612 (IC base=+0.110)

- **PATRÓN** `ballena_activa_n` < `17.0` → IC=+0.134 (n=151)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 17.0 (IC base=+0.110)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.194 (n=3328)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0085 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7698)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4768` → IC=+0.213 (n=7340)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4768 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.8961` → IC=+0.202 (n=993)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8961 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.577` → IC=+0.221 (n=3608)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.577 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8833` → IC=+0.166 (n=3308)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8833 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2408` → IC=+0.186 (n=1407)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2408 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6477` → IC=+0.182 (n=2327)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6477 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.172 (n=8763)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.04 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `3789.8405` → IC=+0.172 (n=2447)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3789.8405 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.196 (n=5248)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 95.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.194 (n=4486)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0067 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.473` → IC=+0.183 (n=6730)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.473 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.200 (n=2578)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.238 (n=6731)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2315` → IC=+0.164 (n=4197)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2315 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.832` → IC=+0.198 (n=972)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.832 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7033` → IC=+0.156 (n=2045)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7033 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2027` → IC=+0.163 (n=1549)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.2027 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.253 (n=872)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.3029` → IC=+0.190 (n=2720)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3029 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.175 (n=5606)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 127.0 (IC base=+0.180)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.223 (n=413)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0049 (IC base=+0.194)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.229 (n=556)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.199 (n=595)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.348` → IC=+0.292 (n=756)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.348 (IC base=+0.194)

- **PATRÓN** `volumen_pendiente_norm` > `0.2282` → IC=+0.241 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2282 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` < `1.559` → IC=+0.191 (n=502)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.559 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.5938` → IC=+0.194 (n=380)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.5938 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.223 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.194)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.219 (n=789)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 64.0 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.261 (n=853)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.256)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.269 (n=868)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.1993` → IC=+0.283 (n=647)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1993 (IC base=+0.256)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=879)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3509` → IC=+0.288 (n=852)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3509 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.621` → IC=+0.266 (n=971)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.621 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.226` → IC=+0.302 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.226 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `1.9032` → IC=+0.280 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9032 (IC base=+0.256)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.257 (n=989)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1909.2548` → IC=+0.272 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1909.2548 (IC base=+0.256)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.253 (n=812)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.384` → IC=+0.155 (n=1031)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.384 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.2804` → IC=+0.162 (n=1164)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2804 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1548` → IC=+0.181 (n=324)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1548 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.4495` → IC=+0.160 (n=1111)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4495 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7628` → IC=+0.158 (n=740)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7628 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `10653.1142` → IC=+0.169 (n=1040)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 10653.1142 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `496.0` → IC=+0.166 (n=1042)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 496.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.178 (n=690)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0037 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.3196` → IC=+0.170 (n=1033)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3196 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.177 (n=348)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` < `0.6433` → IC=+0.207 (n=1033)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6433 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.699` → IC=+0.157 (n=164)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.699 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.1297` → IC=+0.169 (n=934)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1297 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.305` → IC=+0.177 (n=509)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.305 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.165 (n=1033)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1917 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.1506` → IC=+0.223 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1506 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.4232` → IC=+0.170 (n=935)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.4232 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.164 (n=836)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.5138 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `315.0` → IC=+0.171 (n=369)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 315.0 (IC base=+0.156)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.228 (n=1154)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.214 (n=1156)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.230 (n=505)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0091 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.149` → IC=+0.228 (n=491)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.149 (IC base=+0.228)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.252 (n=422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.375` → IC=+0.268 (n=983)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.375 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.718` → IC=+0.273 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.718 (IC base=+0.228)

- **PATRÓN** `volumen_pendiente_norm` > `0.3603` → IC=+0.295 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3603 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` < `1.791` → IC=+0.222 (n=436)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.791 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` > `2.2483` → IC=+0.227 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2483 (IC base=+0.228)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.241 (n=573)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.228)

- **PATRÓN** `libro_liquidez` > `1893.56` → IC=+0.233 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1893.56 (IC base=+0.228)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.232 (n=409)
...
- **PATRÓN** `volumen_spike_ratio` < `1.502` → IC=+0.150 (n=527)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.502 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4658` → IC=+0.161 (n=399)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.4658 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8843.5076` → IC=+0.232 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8843.5076 (IC base=+0.137)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4263` → IC=+0.152 (n=994)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4263 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.166 (n=381)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6883` → IC=+0.186 (n=994)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.6883 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.2025` → IC=+0.139 (n=915)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2025 (IC base=+0.133)
...
- **PATRÓN** `volumen_regimen` < `0.8591` → IC=+0.136 (n=663)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8591 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` > `1.1774` → IC=+0.156 (n=332)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.1774 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.2782` → IC=+0.263 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2782 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `1.5573` → IC=+0.141 (n=408)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.5573 (IC base=+0.133)
...
- **PATRÓN** `libro_liquidez` > `11059.7035` → IC=+0.186 (n=332)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 11059.7035 (IC base=+0.133)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.139 (n=921)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 196.0 (IC base=+0.133)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.165 (n=482)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4667` → IC=+0.177 (n=1272)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4667 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `1.0029` → IC=+0.187 (n=225)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 1.0029 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.215 (n=475)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.403 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=883)
...
- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.127 (n=932)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 53.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.168 (n=537)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0061 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.1221` → IC=+0.149 (n=405)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.1221 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.150 (n=573)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 15.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.208 (n=1215)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.1971` → IC=+0.135 (n=975)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1971 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.516` → IC=+0.124 (n=1112)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 2.516 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.7164` → IC=+0.155 (n=534)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4637` → IC=+0.142 (n=353)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4637 (IC base=+0.114)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5135` → IC=+0.241 (n=1282)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5135 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.1854` → IC=+0.236 (n=747)
...
- **PATRÓN** `volumen_regimen` < `1.2457` → IC=+0.206 (n=1282)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2457 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6268` → IC=+0.209 (n=1282)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6001` → IC=+0.235 (n=410)
...
- **PATRÓN** `libro_liquidez` > `2556.6049` → IC=+0.212 (n=855)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2556.6049 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.244 (n=470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.203 (n=1326)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5065` → IC=+0.253 (n=1410)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5065 (IC base=+0.198)

- **PATRÓN** `dist_vwap_pct` < `0.8372` → IC=+0.202 (n=1579)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8372 (IC base=+0.198)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.973` → IC=+0.263 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.973 (IC base=+0.198)

- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.239 (n=470)
...
- **PATRÓN** `volumen_spike_ratio` < `2.24` → IC=+0.190 (n=1084)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.24 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `1.4469` → IC=+0.195 (n=1231)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4469 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.210 (n=977)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `2531.5374` → IC=+0.198 (n=940)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2531.5374 (IC base=+0.198)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=2485)

- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.152 (n=2124)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0096 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.5328` → IC=+0.152 (n=2414)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.5328 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.161 (n=829)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9392` → IC=+0.211 (n=805)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9392 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1905` → IC=+0.155 (n=816)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1905 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.206` → IC=+0.164 (n=391)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 10.206 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.9051` → IC=+0.148 (n=993)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.9051 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.1739` → IC=+0.171 (n=661)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1739 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.4594` → IC=+0.162 (n=797)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4594 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.905` → IC=+0.158 (n=1593)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.905 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `3474.784` → IC=+0.148 (n=1609)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3474.784 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.194 (n=626)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0037 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4847` → IC=+0.159 (n=1876)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.4847 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.170 (n=713)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1823` → IC=+0.163 (n=826)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.1823 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.7064` → IC=+0.143 (n=340)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.7064 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.27` → IC=+0.148 (n=1854)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.27 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.2566` → IC=+0.145 (n=1781)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2566 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.155 (n=890)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.5706` → IC=+0.144 (n=1857)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.5706 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8237` → IC=+0.150 (n=1238)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8237 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=2485)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `7600.4466` → IC=+0.152 (n=1675)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 7600.4466 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.201 (n=259)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.170)

- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.190 (n=266)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0101 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.4259` → IC=+0.179 (n=515)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.4259 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.227 (n=229)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.703` → IC=+0.229 (n=138)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.703 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2102` → IC=+0.203 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2102 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.3086` → IC=+0.179 (n=390)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.3086 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `2525.266` → IC=+0.246 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2525.266 (IC base=+0.170)
...
- **PATRÓN** `ibs_20min` > `0.1886` → IC=+0.152 (n=705)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.1886 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `1.006` → IC=+0.179 (n=157)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 1.006 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.424` → IC=+0.146 (n=657)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.424 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.818` → IC=+0.149 (n=707)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.818 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.113` → IC=+0.145 (n=621)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.113 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.6457` → IC=+0.141 (n=705)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6457 (IC base=+0.140)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4422` → IC=+0.162 (n=232)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4422 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=655)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `8830.4928` → IC=+0.152 (n=630)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8830.4928 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.165 (n=499)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0071 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.511` → IC=+0.186 (n=568)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.511 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.165 (n=219)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.165 (n=386)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 11.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.1015` → IC=+0.163 (n=567)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.1015 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1528` → IC=+0.163 (n=268)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1528 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.3831` → IC=+0.156 (n=573)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.3831 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.089` → IC=+0.167 (n=268)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.089 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.6473` → IC=+0.182 (n=190)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6473 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.7336` → IC=+0.154 (n=507)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7336 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.0735` → IC=+0.181 (n=246)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.0735 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.1885` → IC=+0.169 (n=490)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.1885 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.4487` → IC=+0.167 (n=557)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.4487 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `8151.1111` → IC=+0.168 (n=567)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 8151.1111 (IC base=+0.152)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.120 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 11.0 (IC base=+0.089)
...
- **FILTRO** `liq_imbalance_60min` |x|≤ `1.0` → IC=-0.152 (n=21)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=183)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=5987)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=1011)

- **FILTRO** `libro_liquidez` < `15875.7057` → IC=-0.151 (n=256)

  - _Acción_: SKIP cuando `libro_liquidez` < 15875.7057
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=770)

### MOMENTUM_IBS_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1257)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.176 (n=2500)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=7653)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=2621)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=7887)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.215 (n=408)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.090 (n=1287)

- **FILTRO** `ibs_20min` < `0.7482` → IC=-0.175 (n=423)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7482
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1272)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.193 (n=435)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1321)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.218 (n=442)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1399)

- **FILTRO** `ibs_20min` > `0.2874` → IC=-0.175 (n=460)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2874
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1381)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.198 (n=402)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.193 (n=461)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=1391)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2288)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2250)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2256)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=7236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=16686)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=5944)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=17978)

- **FILTRO** `ibs_7min` < `0.709` → IC=-0.234 (n=5980)

  - _Acción_: SKIP cuando `ibs_7min` < 0.709
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=17942)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.160 (n=7983)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=15939)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=7454)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=22386)

- **FILTRO** `ibs_7min` > `0.2986` → IC=-0.177 (n=7459)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2986
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=22381)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.315 (n=895)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2901)

- **FILTRO** `ibs_7min` < `0.7099` → IC=-0.258 (n=1252)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7099
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2544)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.194 (n=942)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=2854)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=3506)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1693)

- **FILTRO** `drift_7min_pct` |x|> `0.1341` → IC=-0.128 (n=1299)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1341
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3900)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.204 (n=1297)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3902)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.141 (n=956)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=3244)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.252 (n=1049)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3151)

- **FILTRO** `ibs_7min` < `0.7611` → IC=-0.185 (n=1049)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7611
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=3151)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.170 (n=1049)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3151)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=984)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3242)

- **FILTRO** `ibs_7min` > `0.2516` → IC=-0.172 (n=1056)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2516
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3170)

- **FILTRO** `ballena_activa_n` > `113.0` → IC=-0.161 (n=1434)

  - _Acción_: SKIP cuando `ballena_activa_n` > 113.0
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2792)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.182 (n=859)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=2716)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.321 (n=842)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2733)

- **FILTRO** `drift_7min_pct` |x|> `0.1835` → IC=-0.132 (n=1215)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1835
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=2360)

- **FILTRO** `ibs_7min` < `0.2045` → IC=-0.272 (n=891)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2045
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2684)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.216 (n=877)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=2698)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.234 (n=1280)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=4174)

- **FILTRO** `ibs_7min` > `0.2655` → IC=-0.158 (n=1853)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2655
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=3601)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.168 (n=2594)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1343)

- **FILTRO** `ibs_7min` < `0.7475` → IC=-0.188 (n=983)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7475
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=2954)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.184 (n=966)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=2971)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=984)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3026)

- **FILTRO** `ibs_7min` > `0.2762` → IC=-0.172 (n=1002)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2762
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3008)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.180 (n=985)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=3025)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.236 (n=1053)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3309)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.204 (n=1078)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3284)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1372)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4273)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.276 (n=959)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3093)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.222 (n=1012)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3040)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.199 (n=995)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3057)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.202 (n=1279)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=4027)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=2270)
...
- **PATRÓN** `ibs_15` < `0.1053` → IC=+0.174 (n=317)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.87€ cuando `ibs_15` < 0.1053 (IC base=+0.044)
...
- **FILTRO** `sigma_h` > `0.0124` → IC=-0.196 (n=517)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1555)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=650)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0766` → IC=+0.229 (n=927)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0766 (IC base=-0.051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1833` → IC=+0.232 (n=659)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1833 (IC base=-0.051)

- **PATRÓN** `ibs_15` < `0.356` → IC=+0.274 (n=1038)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.356 (IC base=-0.051)

- **PATRÓN** `dist_vwap_pct` > `0.6325` → IC=+0.264 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6325 (IC base=-0.051)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.205 (n=307)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.201 (n=924)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.233 (n=406)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=825)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.214 (n=786)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.843` → IC=-0.242 (n=223)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.193 (n=1008)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.228 (n=380)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.35` → IC=+0.228 (n=380)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.35 (IC base=+0.217)

- **PATRÓN** `drift_15min` |x|≤ `0.7573` → IC=+0.220 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7573 (IC base=+0.217)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1963` → IC=+0.237 (n=196)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1963 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.217 (n=203)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` < `0.3657` → IC=+0.263 (n=432)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3657 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` > `0.727` → IC=+0.265 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.727 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.294` → IC=+0.239 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.294 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.1` → IC=+0.218 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.1 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `3638.7885` → IC=+0.219 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3638.7885 (IC base=+0.217)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0701` → IC=+0.205 (n=198)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0701 (IC base=-0.046)

- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.241 (n=222)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3696 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` < `0.1546` → IC=+0.194 (n=197)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.1546 (IC base=-0.046)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1093` → IC=+0.348 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1093 (IC base=-0.051)

- **PATRÓN** `ibs_15` < `0.3256` → IC=+0.296 (n=302)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3256 (IC base=-0.051)

- **PATRÓN** `dist_vwap_pct` > `1.0601` → IC=+0.409 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0601 (IC base=-0.051)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1053 sube el IC de +0.044 a +0.174 en UPDOWN_GBM#XRP#15min (n=317). Ya aplicado como kelly_boost=+0.87€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.356 sube el IC de -0.051 a +0.274 en UPDOWN_GBM_15M_TARDIO (n=1038). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3657 sube el IC de +0.217 a +0.263 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n