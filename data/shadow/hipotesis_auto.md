# Hipótesis automáticas — 2026-07-10 22:32 UTC
_Generado por shadow_postmortem.py sobre 8232 resoluciones (PNL=+1264.72€)_
...
- **PATRÓN** `ibs_15` > `0.7138` → IC=+0.127 (n=191)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.63€ cuando `ibs_15` > 0.7138 (IC base=+0.004)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0664` → IC=+0.133 (n=47)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.0664 (IC base=+0.038)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.152 (n=110)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 11.0 (IC base=+0.038)

- **PATRÓN** `ibs_15` < `0.9136` → IC=+0.137 (n=100)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.9136 (IC base=+0.038)

- **PATRÓN** `ibs_15` > `0.6323` → IC=+0.134 (n=99)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.67€ cuando `ibs_15` > 0.6323 (IC base=+0.038)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 203 | +0.188 | -2.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 131 | +0.207 | -2.77€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 66 | +0.162 | -3.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 43 | +0.211 | -2.24€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 3018 | +0.114 | +971.79€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 3018 | +0.114 | +971.79€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 759 | +0.062 | +78.16€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 759 | +0.062 | +78.16€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 454 | +0.173 | +212.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 454 | +0.173 | +212.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 113 | +0.222 | +75.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 113 | +0.222 | +75.33€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 563 | +0.070 | +96.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 563 | +0.070 | +96.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 135 | +0.099 | +16.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 135 | +0.099 | +16.06€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1240 | -0.015 | -3.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 985 | +0.015 | +33.81€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 333 | -0.002 | -6.53€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 255 | +0.037 | +6.34€ | 2 | 7 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.104) — sin ventaja clara. oversold(IBS<0.3): IC=-0.022 n=314 | neutral: IC=-0.054 n=240 | overbought(IBS>0.7): IC=+0.050 n=258
  - _Datos_: n=850 IC=-0.002 PNL=+22.08€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.177 n=29 PNL=-7.49€ → FILTRAR | H=07h: IC=+0.106 n=31 PNL=+8.42€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=22h: IC=+0.136 n=42 PNL=+8.83€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.077 n=4506 | tras_1loss IC=+0.029 n=3591 | tras_2loss IC=-0.009 n=1665/40 | gap=+0.086 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1117 IC=-0.009 PNL=+10.40€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1117 IC=-0.009 PNL=+10.40€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=556 IC=+0.004 PNL=+0.65€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=556 IC=+0.004 PNL=+0.65€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=255 IC=+0.037 PNL=+6.34€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=255 IC=+0.037 PNL=+6.34€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=491 IC=+0.035 PNL=+15.69€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=491 IC=+0.035 PNL=+15.69€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5774 IC=+0.087 PNL=+1340.61€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5774 IC=+0.087 PNL=+1340.61€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=703 IC=-0.029 PNL=-29.82€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=703 IC=-0.029 PNL=-29.82€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.168 > 0.1 con n=212 PNL=+70.89€
  - _Datos_: n=212 IC=+0.168 PNL=+70.89€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=140 IC=+0.056 PNL=+6.08€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=140 IC=+0.056 PNL=+6.08€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=392 IC=+0.046 PNL=+28.44€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=392 IC=+0.046 PNL=+28.44€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.175 > 0.08 con n=152 PNL=+46.89€
  - _Datos_: n=152 IC=+0.175 PNL=+46.89€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 65/80 ops en el filtro definido (IC actual=+0.231 PNL=+22.64€)
  - _Datos_: n=65 IC=+0.231 PNL=+22.64€
