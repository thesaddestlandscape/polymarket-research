# Hipótesis automáticas — 2026-09-26 20:07 UTC
_Generado por shadow_postmortem.py sobre 624840 resoluciones (PNL=+71527.57€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=513)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.125 (n=513)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.118 (n=378)
...
- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.164 (n=147)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 94.0 (IC base=+0.058)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.19` → IC=-0.222 (n=7300)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.19
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=21903)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `137.24` → IC=-0.250 (n=951)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 137.24
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2856)
...
- **FILTRO** `restante_s_al_confirmar` < `165.94` → IC=-0.207 (n=1779)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.94
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=5340)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `127.39` → IC=-0.337 (n=1436)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.39
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=4311)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.206 (n=14327)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3601)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5661.7901` → IC=+0.177 (n=2295)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 5661.7901 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.139 (n=11946)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=11328)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=5820)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `7848.8603` → IC=+0.176 (n=2203)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7848.8603 (IC base=+0.128)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1781)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2196)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.206 (n=1572)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2230)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15863.0179` → IC=+0.214 (n=576)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15863.0179 (IC base=+0.203)
...
- **PATRÓN** `py_entrada` < `0.44` → IC=+0.143 (n=842)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=2914)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.344 (n=928)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.249 (n=548)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.235 (n=1533)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.234 (n=727)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.208)

- **PATRÓN** `py_entrada` > `0.81` → IC=+0.404 (n=874)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.162 (n=566)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=742)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=320)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=11991)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.226 (n=3930)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.168 (n=2890)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.73` → IC=+0.175 (n=2737)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=943)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.348 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.240)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.186 (n=2696)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.249 (n=2509)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.239)

- **PATRÓN** `py_entrada` > `0.77` → IC=+0.325 (n=800)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.199 (n=2756)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `11135.4127` → IC=+0.457 (n=182)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.410 (n=109)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=35714)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.236 (n=15908)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=7246)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.191 (n=6674)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.71 (IC base=+0.176)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.225 (n=6419)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.229 (n=3221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.267 (n=2222)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.210 (n=5915)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.257 (n=2378)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.204)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.196 (n=5964)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.275 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1367.6878` → IC=+0.285 (n=385)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4859` → IC=+0.123 (n=8450)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.4859 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9835` → IC=+0.243 (n=2816)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9835 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.6239` → IC=+0.251 (n=2408)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6239 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.968` → IC=+0.179 (n=3230)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 5.968 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2036` → IC=+0.248 (n=2306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2036 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.043` → IC=+0.261 (n=1045)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4616` → IC=+0.204 (n=5814)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4616 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.134 (n=10200)
...
- **PATRÓN** `dist_vwap_pct` < `0.1533` → IC=+0.175 (n=3288)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1533 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` < `0.697` → IC=+0.188 (n=1585)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.697 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` > `0.8669` → IC=+0.176 (n=2401)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8669 (IC base=+0.067)

- **PATRÓN** `volumen_pendiente_norm` > `0.1673` → IC=+0.227 (n=1725)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1673 (IC base=+0.067)

- **PATRÓN** `volumen_spike_ratio` > `1.5701` → IC=+0.201 (n=5444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5701 (IC base=+0.067)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.213 (n=5887)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3482` → IC=+0.167 (n=1894)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3482 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.172 (n=911)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.271 (n=744)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.165 (n=1775)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.177 (n=1933)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.04 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.253 (n=659)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.274 (n=484)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0889 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.248 (n=998)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.0519` → IC=+0.294 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0519 (IC base=+0.237)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.479` → IC=+0.246 (n=1510)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.479 (IC base=+0.237)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4285` → IC=+0.233 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4285 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.6068` → IC=+0.247 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6068 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.240 (n=1604)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1816.2998` → IC=+0.237 (n=968)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1816.2998 (IC base=+0.237)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.234 (n=648)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.0837` → IC=+0.239 (n=488)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0837 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.233 (n=1535)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9865` → IC=+0.269 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9865 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` > `0.1937` → IC=+0.218 (n=767)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1937 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.5615` → IC=+0.221 (n=1531)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5615 (IC base=+0.217)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.166 (n=507)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=593)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.7028` → IC=+0.171 (n=1519)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.7028 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1283` → IC=+0.156 (n=1361)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1283 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.291` → IC=+0.152 (n=242)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 11.291 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.302` → IC=+0.145 (n=1386)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 4.302 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.151 (n=1519)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1954 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.8511` → IC=+0.141 (n=1012)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.8511 (IC base=+0.141)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.154 (n=1408)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4292 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4221` → IC=+0.148 (n=1408)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4221 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `14087.0235` → IC=+0.146 (n=1012)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 14087.0235 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `233.0` → IC=+0.170 (n=583)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 233.0 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1981)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.264 (n=738)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1004` → IC=+0.189 (n=1636)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1004 (IC base=+0.185)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7767` → IC=+0.192 (n=1604)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.7767 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1314)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.222 (n=1438)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.6107` → IC=+0.212 (n=1630)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6107 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.248 (n=618)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0643` → IC=+0.247 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0643 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.626` → IC=+0.237 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.626 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.54` → IC=+0.211 (n=1770)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.54 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.3507` → IC=+0.270 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3507 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.7646` → IC=+0.206 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7646 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.1841` → IC=+0.217 (n=1000)
...
- **PATRÓN** `libro_liquidez` > `1909.8776` → IC=+0.215 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1909.8776 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.217 (n=959)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.144 (n=102)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2295)
...
- **PATRÓN** `dist_vwap_pct` < `0.5438` → IC=+0.330 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5438 (IC base=+0.028)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.74` → IC=+0.163 (n=742)
...
- **PATRÓN** `volumen_regimen` < `0.6874` → IC=+0.168 (n=389)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2271` → IC=+0.222 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2271 (IC base=+0.019)

- **PATRÓN** `volumen_spike_ratio` > `1.5242` → IC=+0.173 (n=741)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.5242 (IC base=+0.019)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.125 (n=2280)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1135)

- **FILTRO** `sigma_ewma_delta_pct` > `8.724` → IC=-0.210 (n=364)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.724
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=3051)
...
- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.124 (n=1135)
...
- **PATRÓN** `volumen_regimen` < `0.7071` → IC=+0.256 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7071 (IC base=-0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.1582` → IC=+0.263 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1582 (IC base=-0.042)

- **PATRÓN** `volumen_spike_ratio` < `2.43` → IC=+0.274 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.43 (IC base=-0.042)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.186 (n=596)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1797)

- **FILTRO** `ibs_20min` < `0.7191` → IC=-0.156 (n=1579)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7191
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=814)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.201 (n=463)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1930)

- **FILTRO** `ibs_20min` > `0.7692` → IC=-0.205 (n=875)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7692
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=2634)

- **PATRÓN** `dist_vwap_pct` > `0.4585` → IC=+0.311 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4585 (IC base=-0.068)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.295 (n=345)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1003 (IC base=-0.068)
...
- **PATRÓN** `dist_vwap_pct` > `0.5629` → IC=+0.275 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5629 (IC base=-0.020)

- **PATRÓN** `volumen_regimen` < `0.7337` → IC=+0.256 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7337 (IC base=-0.020)

- **PATRÓN** `volumen_regimen` > `1.2485` → IC=+0.287 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2485 (IC base=-0.020)

- **PATRÓN** `volumen_pendiente_norm` > `0.2422` → IC=+0.286 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2422 (IC base=-0.020)

- **PATRÓN** `volumen_spike_ratio` < `2.1392` → IC=+0.262 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1392 (IC base=-0.020)

- **PATRÓN** `volumen_spike_ratio` > `1.5237` → IC=+0.251 (n=636)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5237 (IC base=-0.020)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.196 (n=3563)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0097 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.4754` → IC=+0.187 (n=9540)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4754 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `1.0596` → IC=+0.288 (n=883)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0596 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.621` → IC=+0.156 (n=4994)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.621 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6902` → IC=+0.251 (n=3403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6902 (IC base=+0.097)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.176 (n=313)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4339 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` > `2.1457` → IC=+0.205 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1457 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.190 (n=407)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4765` → IC=+0.452 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4765 (IC base=-0.018)

- **PATRÓN** `volumen_spike_ratio` > `2.0444` → IC=+0.449 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0444 (IC base=-0.018)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.474 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 18.0 (IC base=-0.018)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `ibs_20min` > `0.8652` → IC=+0.163 (n=715)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.8652 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3024` → IC=+0.176 (n=387)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3024 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6746` → IC=+0.170 (n=882)
...
- **PATRÓN** `volumen_spike_ratio` > `2.397` → IC=+0.164 (n=322)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.397 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `241.0` → IC=+0.187 (n=423)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 241.0 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` < `0.1515` → IC=+0.216 (n=629)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1515 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` > `0.854` → IC=+0.227 (n=408)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.298 (n=881)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.247)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.706` → IC=+0.284 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.706 (IC base=+0.247)

- **PATRÓN** `volumen_pendiente_norm` < `0.1018` → IC=+0.261 (n=1415)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1018 (IC base=+0.247)

- **PATRÓN** `volumen_spike_ratio` > `3.3557` → IC=+0.264 (n=528)
...
- **PATRÓN** `libro_liquidez` > `1911.425` → IC=+0.254 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1911.425 (IC base=+0.247)

- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.314 (n=615)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0099 (IC base=+0.283)

- **PATRÓN** `drift_60min` |x|≤ `0.6123` → IC=+0.285 (n=1352)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6123 (IC base=+0.283)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.326 (n=457)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.283)

- **PATRÓN** `ibs_20min` < `0.2269` → IC=+0.288 (n=1190)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2269 (IC base=+0.283)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.812` → IC=+0.296 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.812 (IC base=+0.283)

- **PATRÓN** `volumen_pendiente_norm` > `0.3385` → IC=+0.305 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3385 (IC base=+0.283)

- **PATRÓN** `volumen_spike_ratio` < `1.5928` → IC=+0.286 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5928 (IC base=+0.283)

- **PATRÓN** `volumen_spike_ratio` > `2.6992` → IC=+0.290 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6992 (IC base=+0.283)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.287 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `1902.4584` → IC=+0.295 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1902.4584 (IC base=+0.283)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.288 (n=813)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 27.0 (IC base=+0.283)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2978` → IC=-0.174 (n=529)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2978
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1588)

- **FILTRO** `ibs_20min` > `0.7732` → IC=-0.186 (n=628)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7732
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1885)

- **PATRÓN** `ibs_20min` > `0.9101` → IC=+0.182 (n=530)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.9101 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` > `0.4282` → IC=+0.218 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4282 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` < `0.6708` → IC=+0.218 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6708 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` < `0.9869` → IC=+0.243 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9869 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` > `0.5902` → IC=+0.219 (n=613)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5025` → IC=+0.264 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5025 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `71.0` → IC=+0.271 (n=260)
...
- **PATRÓN** `dist_vwap_pct` < `0.3438` → IC=+0.200 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3438 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `0.6435` → IC=+0.234 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6435 (IC base=-0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.2772` → IC=+0.287 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2772 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` < `1.8269` → IC=+0.258 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8269 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` > `2.472` → IC=+0.236 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.472 (IC base=-0.005)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.255 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=-0.005)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7328` → IC=-0.194 (n=1130)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7328
  - _Potencial_: sin este filtro IC_bueno=+0.279 (n=1131)

- **FILTRO** `ibs_20min` > `0.6857` → IC=-0.235 (n=579)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6857
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1740)

- **FILTRO** `sigma_ewma_delta_pct` > `4.714` → IC=-0.188 (n=508)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.714
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1811)

- **PATRÓN** `ibs_20min` > `0.7328` → IC=+0.279 (n=1131)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7328 (IC base=+0.043)

- **PATRÓN** `dist_vwap_pct` > `0.8548` → IC=+0.327 (n=270)
...
- **PATRÓN** `volumen_regimen` < `0.8657` → IC=+0.302 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8657 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` > `0.7265` → IC=+0.294 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7265 (IC base=+0.043)

- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.295 (n=785)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4641` → IC=+0.227 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4641 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.237 (n=572)
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.347 (n=918)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.623` → IC=+0.302 (n=714)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.623 (IC base=+0.278)

- **PATRÓN** `volumen_regimen` > `0.8606` → IC=+0.304 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8606 (IC base=+0.278)

- **PATRÓN** `volumen_pendiente_norm` < `0.0782` → IC=+0.282 (n=1171)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4339` → IC=+0.287 (n=1304)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4339 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1455)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `2476.2054` → IC=+0.291 (n=1226)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2476.2054 (IC base=+0.278)

- **PATRÓN** `sigma_h` > `0.0154` → IC=+0.304 (n=983)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0154 (IC base=+0.276)

- **PATRÓN** `drift_60min` |x|≤ `0.1958` → IC=+0.276 (n=649)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1958 (IC base=+0.276)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.287 (n=506)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.2927` → IC=+0.316 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2927 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` > `1.3497` → IC=+0.283 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3497 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` < `0.2288` → IC=+0.277 (n=1346)
...
- **PATRÓN** `volumen_regimen` < `0.6405` → IC=+0.279 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6405 (IC base=+0.276)

- **PATRÓN** `volumen_regimen` > `1.244` → IC=+0.310 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.244 (IC base=+0.276)

- **PATRÓN** `volumen_pendiente_norm` > `0.2372` → IC=+0.339 (n=246)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1403` → IC=+0.277 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1403 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `2623.1942` → IC=+0.278 (n=983)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2623.1942 (IC base=+0.276)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.173 (n=2746)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.201 (n=2739)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.184 (n=2741)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=8570)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5745` → IC=+0.218 (n=8215)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5745 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1753` → IC=+0.193 (n=3563)
...
- **PATRÓN** `volumen_regimen` < `1.2076` → IC=+0.161 (n=5444)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2076 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6301` → IC=+0.161 (n=5445)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6301 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2423` → IC=+0.195 (n=1656)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2423 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5572` → IC=+0.167 (n=3470)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5572 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.61` → IC=+0.177 (n=2629)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.61 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `1952.62` → IC=+0.169 (n=7338)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 1952.62 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `112.0` → IC=+0.181 (n=7126)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 112.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.185 (n=5255)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0066 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.0811` → IC=+0.210 (n=2627)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0811 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.208 (n=3044)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4814` → IC=+0.227 (n=7881)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4814 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.2341` → IC=+0.160 (n=5714)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2341 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.342` → IC=+0.193 (n=1332)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.342 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.1726` → IC=+0.153 (n=5686)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1726 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.215 (n=1140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `1.5585` → IC=+0.167 (n=3166)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5585 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.248` → IC=+0.172 (n=3261)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.248 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `113.0` → IC=+0.176 (n=6849)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.245 (n=912)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.248 (n=926)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.239)

- **PATRÓN** `drift_60min` |x|≤ `0.1848` → IC=+0.291 (n=691)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1848 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.244 (n=934)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3427` → IC=+0.264 (n=1036)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3427 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.34` → IC=+0.250 (n=1124)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.34 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` < `0.1614` → IC=+0.235 (n=980)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.186 (n=1221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 6.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4049` → IC=+0.227 (n=1220)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4049 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2078` → IC=+0.213 (n=715)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2078 (IC base=+0.162)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.279` → IC=+0.210 (n=198)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.279 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.5031` → IC=+0.177 (n=522)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.5031 (IC base=+0.162)
...
- **PATRÓN** `libro_liquidez` > `10634.3743` → IC=+0.170 (n=1220)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 10634.3743 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.158 (n=1320)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0057 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.2922` → IC=+0.162 (n=1319)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.2922 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.179 (n=440)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.5665` → IC=+0.189 (n=1319)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5665 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.133` → IC=+0.162 (n=1312)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.133 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.883` → IC=+0.198 (n=263)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 11.883 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.195` → IC=+0.159 (n=1319)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.195 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1537` → IC=+0.155 (n=404)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1537 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4411` → IC=+0.148 (n=1207)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.4411 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4235` → IC=+0.138 (n=1207)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4235 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `213.0` → IC=+0.165 (n=377)
...
- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.232 (n=1160)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.275 (n=402)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.3478` → IC=+0.249 (n=1160)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3478 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.729` → IC=+0.260 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.729 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` > `0.3526` → IC=+0.260 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3526 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` < `1.7653` → IC=+0.215 (n=475)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7653 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.1982` → IC=+0.231 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1982 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1907.66` → IC=+0.220 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1907.66 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `11.0` → IC=+0.215 (n=370)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.155 (n=1381)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3825` → IC=+0.144 (n=1381)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.3825 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.182 (n=539)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6462` → IC=+0.173 (n=1381)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6462 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3603` → IC=+0.136 (n=1494)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.3603 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.982` → IC=+0.161 (n=491)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 6.982 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8485` → IC=+0.151 (n=921)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8485 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.291` → IC=+0.188 (n=203)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.291 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.8007` → IC=+0.140 (n=839)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.8007 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9966.3147` → IC=+0.161 (n=626)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 9966.3147 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.122 (n=1198)
...
- **PATRÓN** `libro_liquidez` > `2907.8423` → IC=+0.193 (n=676)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2907.8423 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.134 (n=1142)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 49.0 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.159 (n=666)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0061 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.1048` → IC=+0.165 (n=505)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1048 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.161 (n=552)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.5741` → IC=+0.212 (n=1513)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5741 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.0156` → IC=+0.139 (n=217)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 1.0156 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2022` → IC=+0.140 (n=1385)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2022 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.617` → IC=+0.136 (n=314)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 7.617 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.6365` → IC=+0.145 (n=505)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6365 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2729` → IC=+0.158 (n=188)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.2729 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4523` → IC=+0.130 (n=455)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4523 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2760.1991` → IC=+0.160 (n=686)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2760.1991 (IC base=+0.114)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0126` → IC=+0.225 (n=1270)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0126 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7391` → IC=+0.258 (n=1270)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1499)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2828.2154` → IC=+0.206 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2828.2154 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0117` → IC=+0.222 (n=650)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0117 (IC base=+0.206)

- **PATRÓN** `sigma_h` > `0.0224` → IC=+0.211 (n=669)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0224 (IC base=+0.206)

- **PATRÓN** `drift_60min` |x|≤ `0.0924` → IC=+0.223 (n=492)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.438` → IC=+0.247 (n=1475)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.438 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `1.2288` → IC=+0.221 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2288 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.437` → IC=+0.246 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.437 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `0.633` → IC=+0.216 (n=1475)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.633 (IC base=+0.206)

- **PATRÓN** `volumen_pendiente_norm` > `0.2813` → IC=+0.289 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2813 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` < `2.1921` → IC=+0.197 (n=1172)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.1921 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `1.4272` → IC=+0.202 (n=1332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4272 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `2592.8602` → IC=+0.208 (n=983)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2592.8602 (IC base=+0.206)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.176 (n=673)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0038 (IC base=+0.151)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.175 (n=672)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0088 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3504` → IC=+0.156 (n=1773)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.3504 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.170 (n=1854)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 8.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.5385` → IC=+0.190 (n=1800)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.5385 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.8506` → IC=+0.176 (n=331)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.8506 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.728` → IC=+0.181 (n=907)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 3.728 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.8725` → IC=+0.170 (n=1188)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8725 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `1.2084` → IC=+0.161 (n=594)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.2084 (IC base=+0.151)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4413` → IC=+0.162 (n=649)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4413 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `2.2086` → IC=+0.163 (n=882)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.2086 (IC base=+0.151)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.157 (n=2282)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.02 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `12367.2302` → IC=+0.157 (n=672)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12367.2302 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.172 (n=1793)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 151.0 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.137 (n=1379)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0056 (IC base=+0.111)

- **PATRÓN** `drift_60min` |x|≤ `0.3432` → IC=+0.126 (n=1820)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3432 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=2086)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.0588` → IC=+0.192 (n=690)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.0588 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2086` → IC=+0.121 (n=1851)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2086 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.6987` → IC=+0.128 (n=821)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.6987 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.129 (n=518)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4499` → IC=+0.143 (n=665)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4499 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2761.3271` → IC=+0.122 (n=1848)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2761.3271 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.127 (n=856)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3377` → IC=+0.132 (n=495)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.3377 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.157 (n=464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` > `0.2572` → IC=+0.156 (n=495)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.2572 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.299` → IC=+0.148 (n=174)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.299 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.6182` → IC=+0.159 (n=165)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6182 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.0904` → IC=+0.131 (n=177)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` > 0.0904 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `10925.7104` → IC=+0.134 (n=495)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 10925.7104 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.144 (n=158)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 147.0 (IC base=+0.113)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.202 (n=216)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.155 (n=647)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.144 (n=661)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.6055` → IC=+0.183 (n=569)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6055 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.307` → IC=+0.151 (n=683)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.307 (IC base=+0.135)
...
- **PATRÓN** `volumen_regimen` < `1.218` → IC=+0.141 (n=647)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.218 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.0598` → IC=+0.162 (n=294)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0598 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1569` → IC=+0.193 (n=174)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1569 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `2.1115` → IC=+0.157 (n=561)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1115 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4203` → IC=+0.148 (n=637)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4203 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `325.0` → IC=+0.153 (n=543)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 325.0 (IC base=+0.135)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.266 (n=280)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0037 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.200 (n=211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.200)

- **PATRÓN** `drift_60min` |x|≤ `0.2084` → IC=+0.214 (n=421)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2084 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=659)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` > `0.9667` → IC=+0.265 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9667 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `0.1422` → IC=+0.206 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1422 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.2163` → IC=+0.201 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2163 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.949` → IC=+0.228 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.949 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` < `1.0063` → IC=+0.204 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0063 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.6082` → IC=+0.206 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6082 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2643` → IC=+0.263 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2643 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `1.3995` → IC=+0.224 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3995 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.7452` → IC=+0.227 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7452 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.209 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `12439.6953` → IC=+0.223 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12439.6953 (IC base=+0.200)

- **PATRÓN** `drift_60min` |x|≤ `0.3517` → IC=+0.120 (n=522)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.3517 (IC base=+0.095)

- **PATRÓN** `ibs_20min` < `0.0837` → IC=+0.157 (n=199)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.0837 (IC base=+0.095)

- **PATRÓN** `volumen_regimen` < `0.6868` → IC=+0.139 (n=261)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.6868 (IC base=+0.095)

- **PATRÓN** `volumen_pendiente_norm` > `0.2277` → IC=+0.135 (n=94)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` > 0.2277 (IC base=+0.095)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.5971` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.5971
  - _Potencial_: sin este filtro IC_bueno=+0.091 (n=550)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.167 (n=217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.009 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.5425` → IC=+0.135 (n=478)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.5425 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.170 (n=444)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.412` → IC=+0.199 (n=257)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 3.412 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `1.0712` → IC=+0.149 (n=420)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.0712 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` > `0.7281` → IC=+0.148 (n=427)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.7281 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.2893` → IC=+0.202 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2893 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `1.4827` → IC=+0.139 (n=153)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4827 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `2.2078` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.2078 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.137 (n=513)
...
- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.153 (n=424)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5172 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` < `0.7062` → IC=+0.145 (n=187)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.7062 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `1.5787` → IC=+0.174 (n=176)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.5787 (IC base=+0.084)

- **PATRÓN** `libro_liquidez` > `2590.1864` → IC=+0.132 (n=283)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2590.1864 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.132 (n=373)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.348` → IC=+0.245 (n=2654)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.348 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `0.88` → IC=+0.166 (n=4708)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.88 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.203 (n=1455)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.589` → IC=+0.189 (n=3387)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.589 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `1794.8984` → IC=+0.172 (n=10557)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1794.8984 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `85.0` → IC=+0.196 (n=8110)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 85.0 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.193 (n=6393)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.1486` → IC=+0.191 (n=4214)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1486 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.208 (n=3628)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5683` → IC=+0.237 (n=9574)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5683 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2499` → IC=+0.163 (n=5948)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2499 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.036` → IC=+0.200 (n=1346)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.036 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.731` → IC=+0.184 (n=9254)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 3.731 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.704` → IC=+0.164 (n=2885)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.704 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2022` → IC=+0.155 (n=2186)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2022 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2872` → IC=+0.239 (n=1260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2872 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.6133` → IC=+0.193 (n=2940)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.6133 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.197 (n=5670)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 47.0 (IC base=+0.182)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.209 (n=593)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3528` → IC=+0.191 (n=1778)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.3528 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.205 (n=850)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.324 (n=646)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.079` → IC=+0.313 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.079 (IC base=+0.191)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2395` → IC=+0.195 (n=762)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.2395 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.211 (n=1799)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.196` → IC=+0.153 (n=1526)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.196 (IC base=+0.151)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1137` → IC=+0.160 (n=1439)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1137 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4033` → IC=+0.157 (n=1635)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.4033 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `11295.2956` → IC=+0.161 (n=1510)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 11295.2956 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `471.0` → IC=+0.159 (n=1567)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 471.0 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.164 (n=1464)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0057 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.256` → IC=+0.168 (n=1288)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.256 (IC base=+0.152)
...
- **PATRÓN** `ibs_20min` < `0.2761` → IC=+0.234 (n=976)
...
- **PATRÓN** `dist_vwap_pct` < `0.1316` → IC=+0.166 (n=1330)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.303` → IC=+0.154 (n=1328)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.303 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.164 (n=1464)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1847 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1506` → IC=+0.196 (n=393)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1506 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.161 (n=1366)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.7548` → IC=+0.163 (n=910)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.7548 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `352.0` → IC=+0.160 (n=847)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.226 (n=1803)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.816` → IC=+0.295 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.816 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.1345` → IC=+0.219 (n=1565)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1345 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `1.7707` → IC=+0.227 (n=1468)
...
- **PATRÓN** `libro_liquidez` > `1914.6584` → IC=+0.220 (n=780)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1914.6584 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0118` → IC=+0.240 (n=1608)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0118 (IC base=+0.232)

- **PATRÓN** `drift_60min` |x|≤ `0.1712` → IC=+0.238 (n=707)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1712 (IC base=+0.232)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.261 (n=612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.232)
...
- **PATRÓN** `ibs_20min` < `0.0152` → IC=+0.309 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0152 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.275 (n=599)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.748 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` > `0.3428` → IC=+0.307 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3428 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` < `1.7484` → IC=+0.232 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7484 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.175` → IC=+0.235 (n=988)
...
- **PATRÓN** `volumen_regimen` < `0.873` → IC=+0.157 (n=1198)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.873 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2346` → IC=+0.215 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2346 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5181` → IC=+0.154 (n=766)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5181 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.138` → IC=+0.154 (n=789)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.138 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8015.433` → IC=+0.233 (n=814)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8015.433 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.163 (n=565)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 77.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.159 (n=1286)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0066 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4447` → IC=+0.150 (n=1460)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4447 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.173 (n=542)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5812` → IC=+0.197 (n=1285)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.5812 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.158` → IC=+0.139 (n=1263)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.158 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.233` → IC=+0.167 (n=220)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.233 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.695` → IC=+0.151 (n=643)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.695 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1938` → IC=+0.142 (n=487)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.1938 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.29` → IC=+0.237 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.29 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.147 (n=1388)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7203.9856` → IC=+0.196 (n=662)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 7203.9856 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `176.0` → IC=+0.141 (n=1385)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 176.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.139 (n=1196)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0081 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1846)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.191 (n=1793)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.513` → IC=+0.240 (n=667)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.513 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `0.8929` → IC=+0.135 (n=1195)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8929 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.129 (n=1807)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2900.261` → IC=+0.252 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2900.261 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.131 (n=1401)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 54.0 (IC base=+0.115)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.178 (n=579)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0058 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.1326` → IC=+0.165 (n=577)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1326 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1788)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.6371` → IC=+0.205 (n=1730)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6371 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2216` → IC=+0.133 (n=1406)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.2216 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.474` → IC=+0.126 (n=1667)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.474 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.7148` → IC=+0.156 (n=762)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7148 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2202` → IC=+0.168 (n=272)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.2202 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4382` → IC=+0.140 (n=523)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4382 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2809.3195` → IC=+0.175 (n=577)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2809.3195 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.125 (n=1357)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 51.0 (IC base=+0.114)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.227 (n=1594)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0132 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=1863)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.6` → IC=+0.259 (n=1602)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.218 (n=1855)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `2625.687` → IC=+0.219 (n=1189)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.687 (IC base=+0.210)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.213 (n=1347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` < `0.4214` → IC=+0.268 (n=1676)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4214 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.2405` → IC=+0.207 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2405 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` < `0.9244` → IC=+0.207 (n=2123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9244 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.848` → IC=+0.262 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.848 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `1.2349` → IC=+0.241 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2349 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.282` → IC=+0.274 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.282 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` < `2.1798` → IC=+0.200 (n=1513)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1798 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4282` → IC=+0.201 (n=1719)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4282 (IC base=+0.204)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.149 (n=3208)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.185 (n=1030)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0049 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.5152` → IC=+0.171 (n=3085)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.5152 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.173 (n=1220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9414` → IC=+0.217 (n=1028)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9414 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.1783` → IC=+0.172 (n=1152)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1783 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` < `0.4687` → IC=+0.161 (n=1942)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.4687 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.201` → IC=+0.197 (n=506)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.201 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.163 (n=2073)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6307 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.1707` → IC=+0.197 (n=854)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1707 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `1.4562` → IC=+0.169 (n=1016)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4562 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.8741` → IC=+0.169 (n=2031)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.8741 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.161 (n=3437)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.02 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `3963.7863` → IC=+0.171 (n=2056)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3963.7863 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.205 (n=812)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.4845` → IC=+0.166 (n=2418)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.4845 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.180 (n=880)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1794` → IC=+0.176 (n=1064)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.1794 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6718` → IC=+0.171 (n=469)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6718 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.238` → IC=+0.159 (n=2409)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.238 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.2441` → IC=+0.153 (n=2315)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2441 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` < `0.0966` → IC=+0.151 (n=2192)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0966 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.0721` → IC=+0.149 (n=1116)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.0721 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.5352` → IC=+0.160 (n=1051)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.5352 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.8181` → IC=+0.151 (n=1592)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8181 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=3208)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `7061.4518` → IC=+0.158 (n=2160)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 7061.4518 (IC base=+0.147)
...
- **PATRÓN** `libro_liquidez` > `14916.3486` → IC=+0.160 (n=433)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 14916.3486 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.178 (n=913)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0072 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.3797` → IC=+0.176 (n=913)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3797 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.187 (n=397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 17.0 (IC base=+0.172)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.177 (n=354)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 4.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` < `0.5327` → IC=+0.187 (n=692)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5327 (IC base=+0.172)

- **PATRÓN** `ibs_20min` > `0.8839` → IC=+0.181 (n=346)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.8839 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.2171` → IC=+0.180 (n=857)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2171 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.178` → IC=+0.182 (n=929)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 4.178 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` < `1.0828` → IC=+0.173 (n=913)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.0828 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `0.6413` → IC=+0.175 (n=1038)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.6413 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` > `0.1656` → IC=+0.190 (n=311)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1656 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `2.4706` → IC=+0.176 (n=1019)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.4706 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `1.5228` → IC=+0.174 (n=911)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.5228 (IC base=+0.172)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=1035)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.172)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.200 (n=285)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.4837` → IC=+0.185 (n=855)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4837 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.177 (n=295)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.7429` → IC=+0.163 (n=855)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.7429 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.0937` → IC=+0.166 (n=855)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.0937 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.6041` → IC=+0.172 (n=187)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.6041 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.615` → IC=+0.164 (n=879)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 6.615 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` < `0.6464` → IC=+0.197 (n=285)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.6464 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `0.7218` → IC=+0.158 (n=764)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.7218 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` < `0.1513` → IC=+0.159 (n=883)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.1513 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.0733` → IC=+0.176 (n=362)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.0733 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `2.1958` → IC=+0.173 (n=738)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.1958 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `7515.9677` → IC=+0.172 (n=855)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7515.9677 (IC base=+0.157)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `sigma_h` < `0.0129` → IC=+0.132 (n=267)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0129 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.147 (n=185)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 6.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.9615` → IC=+0.248 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9615 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.1983` → IC=+0.163 (n=191)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1983 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.325` → IC=+0.190 (n=69)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 7.325 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `0.9028` → IC=+0.144 (n=178)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.9028 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.1658` → IC=+0.191 (n=82)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1658 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `2.3559` → IC=+0.128 (n=256)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.3559 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `1.4296` → IC=+0.136 (n=256)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4296 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3427.9609` → IC=+0.163 (n=238)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3427.9609 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.131 (n=220)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 58.0 (IC base=+0.115)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.169 (n=243)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0069 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.6706` → IC=+0.159 (n=244)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.6706 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.169 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 10.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.1429` → IC=+0.241 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1429 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.5982` → IC=+0.220 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5982 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.222` → IC=+0.142 (n=118)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.222 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.9493` → IC=+0.154 (n=163)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.9493 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` < `0.1129` → IC=+0.202 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1129 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.611` → IC=+0.151 (n=104)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.611 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `2.1901` → IC=+0.164 (n=108)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.1901 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `3335.3834` → IC=+0.169 (n=243)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3335.3834 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 47.0 (IC base=+0.138)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.181 (n=431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.004 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.193 (n=792)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.6667 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.1487` → IC=+0.149 (n=477)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2792` → IC=+0.186 (n=119)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2792 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.1016` → IC=+0.123 (n=680)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.1016 (IC base=+0.087)

- **PATRÓN** `libro_liquidez` > `2438.1282` → IC=+0.134 (n=391)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 2438.1282 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.0667` → IC=+0.280 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0667 (IC base=+0.016)

- **PATRÓN** `dist_vwap_pct` < `0.1778` → IC=+0.124 (n=352)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.1778 (IC base=+0.016)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.138` → IC=+0.220 (n=73)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5523` → IC=+0.136 (n=256)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.5523 (IC base=+0.016)

- **PATRÓN** `volumen_spike_ratio` > `1.4422` → IC=+0.130 (n=228)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4422 (IC base=+0.016)

### GBM_LATE_60M#BTC#60min
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.154 (n=336)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0059 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.101)

- **PATRÓN** `ibs_20min` > `0.4737` → IC=+0.184 (n=305)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.4737 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.1296` → IC=+0.169 (n=158)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.1296 (IC base=+0.101)

- **PATRÓN** `volumen_spike_ratio` < `2.0448` → IC=+0.160 (n=233)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.0448 (IC base=+0.101)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0547` → IC=+0.174 (n=44)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.0547 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.3241` → IC=+0.250 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3241 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.585` → IC=+0.153 (n=122)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.585 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.0709` → IC=+0.217 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0709 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `2.0636` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.0636 (IC base=+0.064)
...
- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.153 (n=252)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.6667 (IC base=+0.060)

- **PATRÓN** `dist_vwap_pct` > `0.2066` → IC=+0.121 (n=159)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` > 0.2066 (IC base=+0.060)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.497` → IC=+0.138 (n=114)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 5.497 (IC base=+0.060)

- **PATRÓN** `volumen_regimen` > `1.062` → IC=+0.167 (n=94)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.062 (IC base=+0.060)

- **PATRÓN** `volumen_pendiente_norm` > `0.2443` → IC=+0.161 (n=54)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.2443 (IC base=+0.060)
...
- **FILTRO** `ibs_20min` > `0.1754` → IC=-0.125 (n=126)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.160 (n=248)

- **FILTRO** `dist_vwap_pct` > `0.6296` → IC=-0.179 (n=26)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.6296
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=348)
...
- **PATRÓN** `ibs_20min` < `0.1754` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1754 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.614` → IC=+0.155 (n=82)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 8.614 (IC base=+0.064)

- **PATRÓN** `libro_liquidez` > `3751.1947` → IC=+0.169 (n=128)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3751.1947 (IC base=+0.064)
...
- **PATRÓN** `ibs_20min` < `0.1754` → IC=+0.151 (n=81)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.1754 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.321` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.321 (IC base=+0.048)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.121 (n=748)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2919.859` → IC=+0.176 (n=254)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2919.859 (IC base=+0.107)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.136 (n=385)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=460)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.161 (n=225)

  - _Acción_: Kelly boost +0.80€ cuando `py_entrada` < 0.47 (IC base=+0.018)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` > `0.44` → IC=+0.136 (n=42)

  - _Acción_: Kelly boost +0.68€ cuando `py_entrada` > 0.44 (IC base=+0.019)

- **PATRÓN** `restante_min` > `12.8` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 12.8 (IC base=+0.019)

- **PATRÓN** `profundidad_ratio` > `1112.4` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `profundidad_ratio` > 1112.4 (IC base=+0.019)
...
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.126 (n=89)
  ...
  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` < 0.59 (IC base=+0.077)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.151 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.147 (n=15)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=51)

- **FILTRO** `profundidad_ratio` < `122.2` → IC=-0.167 (n=43)
...
- **PATRÓN** `py_entrada` > `0.51` → IC=+0.182 (n=20)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.51 (IC base=-0.014)

- **PATRÓN** `restante_min` > `13.48` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `restante_min` > 13.48 (IC base=-0.014)

- **PATRÓN** `lag_apertura_s` < `90.91` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 90.91 (IC base=-0.014)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7675)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.169 (n=3678)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=11252)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.165 (n=3818)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=11651)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.209 (n=633)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1964)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.188 (n=659)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1989)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.207 (n=670)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=2107)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.49` → IC=-0.171 (n=643)

  - _Acción_: SKIP cuando `py_entrada` < 0.49
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1951)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.175 (n=665)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=2119)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `py_entrada` < `0.485` → IC=-0.171 (n=697)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2216)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3023)

### MOMENTUM_IBS_15M_FADE#BTC#15min
- **FILTRO** `hora_utc` < `15.0` → IC=-0.175 (n=121)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=405)

- **FILTRO** `ibs_20min` > `0.1725` → IC=-0.144 (n=130)

  - _Acción_: SKIP cuando `ibs_20min` > 0.1725
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=396)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.214 (n=82)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=251)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.131 (n=10450)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=23579)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=8373)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=25656)

- **FILTRO** `ibs_7min` < `0.2791` → IC=-0.235 (n=8506)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2791
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=25523)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=11506)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=22523)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=10493)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=32372)

- **FILTRO** `ibs_7min` > `0.2917` → IC=-0.177 (n=10707)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2917
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=32158)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3954)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=1343)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4313)

- **FILTRO** `ibs_7min` < `0.7115` → IC=-0.253 (n=1866)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7115
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3790)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.188 (n=1249)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4407)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1818)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=5556)

- **FILTRO** `drift_7min_pct` |x|> `0.1376` → IC=-0.130 (n=1843)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1376
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=5531)

- **FILTRO** `ibs_7min` > `0.7867` → IC=-0.208 (n=1842)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7867
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=5532)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1372)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=4496)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1426)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4442)

- **FILTRO** `ibs_7min` < `0.7471` → IC=-0.193 (n=1466)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7471
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=4402)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.177 (n=1457)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4411)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.263 (n=1373)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=4587)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.181 (n=1486)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4474)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.182 (n=1478)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4482)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.166 (n=1313)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4076)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.303 (n=1336)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4053)

- **FILTRO** `ibs_7min` < `0.7061` → IC=-0.243 (n=1778)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7061
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3611)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.221 (n=1203)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=4186)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.239 (n=1813)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=6072)

- **FILTRO** `ibs_7min` > `0.7474` → IC=-0.173 (n=1971)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7474
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=5914)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3810)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.234 (n=1658)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3954)

- **FILTRO** `ibs_7min` < `0.7398` → IC=-0.184 (n=1403)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7398
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4209)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.174 (n=1399)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4213)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.256 (n=1434)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=4307)

- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.176 (n=1435)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2744
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4306)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1398)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4343)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.256 (n=1469)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4428)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.233 (n=1469)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4428)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1931)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=6232)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1832)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3775)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.224 (n=1401)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4206)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1358)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4249)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.208 (n=1822)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=5920)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.120 (n=704)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 6.0 (IC base=+0.111)

- **PATRÓN** `total_vol_5m` < `464.449` → IC=+0.147 (n=259)

  - _Acción_: Kelly boost +0.74€ cuando `total_vol_5m` < 464.449 (IC base=+0.111)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.155 (n=27)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=632)

### STREAK_MOM_5M#SOL#5min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1166)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=3016)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=1536)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.189 (n=573)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0044 (IC base=+0.187)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.227 (n=572)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.0512` → IC=+0.202 (n=572)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0512 (IC base=+0.187)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2154` → IC=+0.189 (n=573)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.2154 (IC base=+0.187)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1268` → IC=+0.234 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1268 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=1596)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 6.0 (IC base=+0.187)

- **PATRÓN** `ibs_15` > `0.6077` → IC=+0.267 (n=1715)
...
- **PATRÓN** `dist_vwap_pct` < `0.6134` → IC=+0.181 (n=1630)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6134 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.791` → IC=+0.274 (n=440)
...
- **PATRÓN** `libro_liquidez` > `2959.1226` → IC=+0.195 (n=1143)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2959.1226 (IC base=+0.187)
...
- **FILTRO** `sigma_ewma_delta_pct` > `24.23` → IC=-0.133 (n=28)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=412)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.6968` → IC=-0.153 (n=99)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.6968
...
- **PATRÓN** `sigma_h` > `0.0234` → IC=+0.271 (n=151)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0234 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.0846` → IC=+0.216 (n=199)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0846 (IC base=+0.192)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0394` → IC=+0.195 (n=451)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.98€ cuando `delta_ratio_macro` |x|> 0.0394 (IC base=+0.192)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0904` → IC=+0.252 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0904 (IC base=+0.192)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.226 (n=155)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.192)

- **PATRÓN** `ibs_15` > `0.5593` → IC=+0.281 (n=451)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5593 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` > `0.352` → IC=+0.208 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.352 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` < `0.8136` → IC=+0.193 (n=523)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.8136 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.853` → IC=+0.214 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.853 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.785` → IC=+0.195 (n=454)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 10.785 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `2914.215` → IC=+0.284 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2914.215 (IC base=+0.192)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.157 (n=508)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.78€ cuando `ibs_15` < 0.1176 (IC base=+0.054)
...
- **FILTRO** `sigma_h` > `0.0128` → IC=-0.223 (n=687)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0128
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2064)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.202 (n=950)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1801)

- **FILTRO** `libro_liquidez` < `3876.6456` → IC=-0.143 (n=1815)

  - _Acción_: SKIP cuando `libro_liquidez` < 3876.6456
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=936)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.224 (n=415)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1248)
...
- **FILTRO** `hora_utc` > `7.0` → IC=-0.210 (n=1050)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.475` → IC=-0.252 (n=296)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1367)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.246 (n=734)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0076 (IC base=+0.233)

- **PATRÓN** `drift_60min` |x|≤ `0.4386` → IC=+0.236 (n=734)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4386 (IC base=+0.233)

- **PATRÓN** `drift_15min` |x|≤ `0.4747` → IC=+0.254 (n=323)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.239 (n=285)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.270 (n=734)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3469 (IC base=+0.233)

- **PATRÓN** `dist_vwap_pct` > `0.7536` → IC=+0.324 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7536 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.87` → IC=+0.252 (n=135)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6077 sube el IC de +0.187 a +0.267 en UPDOWN_GBM#15min (n=1715). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5593 sube el IC de +0.192 a +0.281 en UPDOWN_GBM#XRP#15min (n=451). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.054 a +0.157 en UPDOWN_GBM#XRP#15min (n=508). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.346 sube el IC de -0.029 a +0.276 en UPDOWN_GBM_15M_TARDIO (n=1912). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3469 sube el IC de +0.233 a +0.270 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=734). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.34 sube el IC de -0.040 a +0.305 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=506). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 29203 | -0.085 | -3895.79€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1544 | -0.035 | -224.33€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27659 | -0.088 | -3671.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3807 | -0.099 | -628.52€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3807 | -0.099 | -628.52€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1544 | -0.035 | -224.33€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1544 | -0.035 | -224.33€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3484 | -0.096 | -788.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3484 | -0.096 | -788.92€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7502 | -0.019 | -707.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7502 | -0.019 | -707.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 7119 | -0.089 | -455.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 7119 | -0.089 | -455.08€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5747 | -0.164 | -1091.66€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5747 | -0.164 | -1091.66€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 19493 | -0.026 | +3954.45€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 5068 | +0.001 | +1816.55€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 14425 | -0.036 | +2137.90€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 19493 | -0.026 | +3954.45€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 5068 | +0.001 | +1816.55€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 14425 | -0.036 | +2137.90€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 96911 | +0.113 | -4745.45€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14482 | +0.185 | -424.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 392 | -0.074 | -50.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 75802 | +0.100 | -4056.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6235 | +0.107 | -213.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12603 | +0.099 | -1018.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 46 | -0.167 | -1.52€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12542 | +0.101 | -1005.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 19579 | +0.132 | -356.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4568 | +0.203 | -127.92€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12567 | +0.112 | -183.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2402 | +0.102 | -22.86€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12642 | +0.090 | -1139.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 53 | -0.100 | -7.49€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12574 | +0.091 | -1120.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 20586 | +0.124 | -377.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5612 | +0.175 | -77.47€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12706 | +0.106 | -235.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2256 | +0.099 | -55.24€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18886 | +0.114 | -1083.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4156 | +0.189 | -218.50€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 295 | -0.032 | +3.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12858 | +0.092 | -732.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1577 | +0.127 | -135.76€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12615 | +0.099 | -770.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12555 | +0.100 | -778.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 15364 | +0.191 | -1014.81€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 15364 | +0.191 | -1014.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3646 | +0.167 | -387.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3646 | +0.167 | -387.87€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1353 | +0.197 | -15.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1353 | +0.197 | -15.67€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3594 | +0.179 | -308.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3594 | +0.179 | -308.87€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3173 | +0.239 | -103.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3173 | +0.239 | -103.35€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3519 | +0.192 | -212.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3519 | +0.192 | -212.81€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 725 | +0.427 | -24.15€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 725 | +0.427 | -24.15€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 160 | +0.407 | -9.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 160 | +0.407 | -9.96€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 53066 | +0.197 | -4154.09€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 53066 | +0.197 | -4154.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 9164 | +0.176 | -1059.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 9164 | +0.176 | -1059.67€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 8487 | +0.223 | -309.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 8487 | +0.223 | -309.92€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 9164 | +0.173 | -1090.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 9164 | +0.173 | -1090.86€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 8584 | +0.218 | -349.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 8584 | +0.218 | -349.97€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 