# Hipótesis automáticas — 2026-07-02 00:36 UTC
_Generado por shadow_postmortem.py sobre 2494 resoluciones (PNL=-68.41€)_
...
- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.268 (n=54)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0092 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.7816` → IC=+0.138 (n=92)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.7816 (IC base=+0.114)

- **PATRÓN** `drift_15min` |x|≤ `0.7351` → IC=+0.148 (n=69)

  - _Acción_: Kelly boost +0.74€ cuando `drift_15min` |x|≤ 0.7351 (IC base=+0.114)
...
- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.265 (n=32)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0634 (IC base=+0.114)
...
| ✅ UPDOWN_GBM | 744 | -0.028 | -17.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 526 | +0.000 | +8.67€ | 1 | 5 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.091) — sin ventaja clara. oversold(IBS<0.3): IC=+0.036 n=110 | neutral: IC=-0.056 n=106 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=354 IC=-0.014 PNL=+7.95€
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=20, boost estimado=+0.001. Necesita 0 más y boost>0.05
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1176 | tras_1loss IC=-0.033 n=1236 | tras_2loss IC=-0.047 n=643/40 | gap=+0.050 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=621 IC=-0.020 PNL=-3.73€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=621 IC=-0.020 PNL=-3.73€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=143 IC=+0.086 PNL=+36.53€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=143 IC=+0.086 PNL=+36.53€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 77/200 ops en el filtro definido (IC actual=+0.120 PNL=+24.51€)
  - _Datos_: n=77 IC=+0.120 PNL=+24.51€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 77/100 ops en el filtro definido (IC actual=+0.120 PNL=+24.51€)
  - _Datos_: n=77 IC=+0.120 PNL=+24.51€
