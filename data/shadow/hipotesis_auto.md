# Hipótesis automáticas — 2026-07-10 19:41 UTC
_Generado por shadow_postmortem.py sobre 8038 resoluciones (PNL=+1198.04€)_
...
- **PATRÓN** `ibs_15` > `0.7159` → IC=+0.124 (n=187)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.62€ cuando `ibs_15` > 0.7159 (IC base=-0.002)

- **PATRÓN** `ibs_15` < `0.0487` → IC=+0.136 (n=119)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.68€ cuando `ibs_15` < 0.0487 (IC base=+0.032)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0618` → IC=+0.138 (n=45)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.0618 (IC base=+0.031)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.145 (n=105)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 11.0 (IC base=+0.031)

- **PATRÓN** `ibs_15` < `0.9183` → IC=+0.133 (n=96)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.9183 (IC base=+0.031)

- **PATRÓN** `ibs_15` > `0.7945` → IC=+0.151 (n=64)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` > 0.7945 (IC base=+0.031)
...
- **PATRÓN** `ibs_15` < `0.0481` → IC=+0.123 (n=67)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.62€ cuando `ibs_15` < 0.0481 (IC base=+0.043)
...
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.7945 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.151 n=64). Confirma señal de reversión media → alinear con BUY_NO.
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#BTC#15min` — IC=+0.265 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#ETH#15min` — IC=+0.243 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#SOL#15min` — IC=+0.129 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 149 | +0.189 | -2.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 98 | +0.220 | -1.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 23 | -0.020 | -4.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 24 | +0.231 | +2.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 48 | +0.200 | +0.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 32 | +0.265 | +1.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 7 | -0.058 | -2.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 8 | +0.080 | +0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 50 | +0.211 | +1.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 33 | +0.243 | +1.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 8 | +0.040 | -0.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 8 | +0.080 | +0.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 51 | +0.141 | -4.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 33 | +0.129 | -4.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 8 | +0.000 | -1.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 8 | +0.080 | +0.61€ | 0 | 0 |
| ✅ GBM_LATE_15M | 2974 | +0.114 | +958.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2974 | +0.114 | +958.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 748 | +0.061 | +76.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 748 | +0.061 | +76.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 757 | +0.074 | +120.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 757 | +0.074 | +120.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 767 | +0.149 | +399.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 767 | +0.149 | +399.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 702 | +0.173 | +362.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 702 | +0.173 | +362.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 419 | +0.168 | +178.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 419 | +0.168 | +178.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 103 | +0.195 | +49.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 103 | +0.195 | +49.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 113 | +0.161 | +47.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 113 | +0.161 | +47.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 119 | +0.070 | +12.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 119 | +0.070 | +12.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 84 | +0.267 | +68.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 84 | +0.267 | +68.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 520 | +0.067 | +84.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 520 | +0.067 | +84.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 124 | +0.087 | +11.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 124 | +0.087 | +11.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 131 | +0.011 | +3.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 131 | +0.011 | +3.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 130 | -0.038 | -1.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 130 | -0.038 | -1.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 135 | +0.201 | +71.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 135 | +0.201 | +71.18€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1230 | -0.016 | -6.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 975 | +0.013 | +30.07€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 328 | -0.006 | -9.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 250 | +0.032 | +3.21€ | 2 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 590 | +0.007 | +21.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 497 | +0.027 | +32.25€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.105) — sin ventaja clara. oversold(IBS<0.3): IC=-0.019 n=310 | neutral: IC=-0.061 n=237 | overbought(IBS>0.7): IC=+0.045 n=255
  - _Datos_: n=840 IC=-0.005 PNL=+18.34€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.073 n=4349 | tras_1loss IC=+0.027 n=3516 | tras_2loss IC=-0.011 n=1641/40 | gap=+0.085 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.135 n=50/60 | contraria IC=+0.089 n=16 | gap=+0.046 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.049 n=368/40 PNL=+44.48€ | H=15h UTC: IC=+0.077 n=372/40 PNL=+80.14€ | H=17h UTC: IC=+0.128 n=307/40 PNL=+108.31€ | H=19h UTC: IC=+0.047 n=296/40 PNL=+36.69€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=197 IC=-0.007 PNL=+4.23€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=197 IC=-0.007 PNL=+4.23€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1107 IC=-0.010 PNL=+6.66€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1107 IC=-0.010 PNL=+6.66€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=548 IC=-0.002 PNL=-4.80€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=548 IC=-0.002 PNL=-4.80€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=250 IC=+0.032 PNL=+3.21€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=250 IC=+0.032 PNL=+3.21€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=483 IC=+0.034 PNL=+14.01€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=483 IC=+0.034 PNL=+14.01€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=403 IC=+0.014 PNL=+16.40€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=403 IC=+0.014 PNL=+16.40€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5580 IC=+0.084 PNL=+1273.92€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5580 IC=+0.084 PNL=+1273.92€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=695 IC=-0.034 PNL=-35.27€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=695 IC=-0.034 PNL=-35.27€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=204 PNL=+65.45€
  - _Datos_: n=204 IC=+0.160 PNL=+65.45€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=135 IC=+0.047 PNL=+2.95€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=135 IC=+0.047 PNL=+2.95€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=289 IC=-0.074 PNL=+42.93€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=289 IC=-0.074 PNL=+42.93€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=386 IC=+0.046 PNL=+28.77€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=386 IC=+0.046 PNL=+28.77€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.164 > 0.08 con n=144 PNL=+41.45€
  - _Datos_: n=144 IC=+0.164 PNL=+41.45€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 60/80 ops en el filtro definido (IC actual=+0.226 PNL=+19.51€)
  - _Datos_: n=60 IC=+0.226 PNL=+19.51€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 58/100 ops en el filtro definido (IC actual=+0.317 PNL=+37.64€)
  - _Datos_: n=58 IC=+0.317 PNL=+37.64€
