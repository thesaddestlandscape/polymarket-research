# Hipótesis automáticas — 2026-07-02 11:38 UTC
_Generado por shadow_postmortem.py sobre 2632 resoluciones (PNL=-64.17€)_
...
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.122 (n=43)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 10.0 (IC base=-0.031)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 70 | +0.167 | +22.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 70 | +0.167 | +22.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 19 | +0.068 | +1.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 19 | +0.068 | +1.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 19 | +0.113 | +2.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 19 | +0.113 | +2.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 15 | +0.110 | +6.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 15 | +0.110 | +6.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 17 | +0.246 | +11.25€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 17 | +0.246 | +11.25€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 802 | -0.036 | -36.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 577 | -0.013 | -10.13€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 231 | -0.041 | -29.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 161 | -0.015 | -19.43€ | 2 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.082) — sin ventaja clara. oversold(IBS<0.3): IC=+0.014 n=138 | neutral: IC=-0.068 n=123 | overbought(IBS>0.7): IC=-0.047 n=137
  - _Datos_: n=412 IC=-0.031 PNL=-11.24€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.009 n=1257 | tras_1loss IC=-0.034 n=1288 | tras_2loss IC=-0.049 n=667/40 | gap=+0.058 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=679 IC=-0.030 PNL=-22.93€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=679 IC=-0.030 PNL=-22.93€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=366 IC=-0.049 PNL=-38.96€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=366 IC=-0.049 PNL=-38.96€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.015 < 0.02 con n=161 PNL=-19.43€
  - _Datos_: n=161 IC=-0.015 PNL=-19.43€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=240 IC=-0.004 PNL=-22.94€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=240 IC=-0.004 PNL=-22.94€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=215 IC=+0.067 PNL=+28.75€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=215 IC=+0.067 PNL=+28.75€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 25/40 ops en el filtro definido (IC actual=+0.018 PNL=-3.32€)
  - _Datos_: n=25 IC=+0.018 PNL=-3.32€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.074 < -0.05 con n=508 PNL=-66.88€
  - _Datos_: n=508 IC=-0.074 PNL=-66.88€
