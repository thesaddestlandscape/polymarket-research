# Hipótesis automáticas — 2026-07-21 09:02 UTC
_Generado por shadow_postmortem.py sobre 26395 resoluciones (PNL=+6254.94€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=1993)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `4211.294` → IC=+0.172 (n=1201)
...
| ✅ FAVORITO_CONFIRMADO | 4559 | +0.186 | +65.40€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1613 | +0.177 | +4.32€ | 0 | 0 |
...
| ✅ LATE_WINDOW_5MIN | 155 | +0.035 | +11.89€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 155 | +0.035 | +11.89€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 155 | +0.035 | +11.89€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 155 | +0.035 | +11.89€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=15855 | tras_1loss IC=+0.086 n=10336 | tras_2loss IC=+0.053 n=4236/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=155 IC=+0.035 PNL=+11.89€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=155 IC=+0.035 PNL=+11.89€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=23931 IC=+0.116 PNL=+6329.79€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=23931 IC=+0.116 PNL=+6329.79€
