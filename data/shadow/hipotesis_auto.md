# Hipótesis automáticas — 2026-09-18 00:47 UTC
_Generado por shadow_postmortem.py sobre 489043 resoluciones (PNL=+52847.39€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.121 (n=412)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.121 (n=412)
...
- **PATRÓN** `n_ballena_banda` > `26.0` → IC=+0.184 (n=17)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `n_ballena_banda` > 26.0 (IC base=+0.188)

- **PATRÓN** `n_total_lado` > `39.0` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 39.0 (IC base=+0.188)

- **PATRÓN** `banda_z` > `3.422` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 3.422 (IC base=+0.188)
...
- **PATRÓN** `libro_liquidez` > `2518.5859` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2518.5859 (IC base=+0.188)

### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.14` → IC=-0.249 (n=6020)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.14
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=18062)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `141.04` → IC=-0.262 (n=830)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.04
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2491)
...
- **FILTRO** `restante_s_al_confirmar` < `132.71` → IC=-0.295 (n=733)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2199)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `159.03` → IC=-0.241 (n=1427)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 159.03
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4283)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `117.9` → IC=-0.367 (n=1168)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 117.9
  - _Potencial_: sin este filtro IC_bueno=-0.109 (n=3506)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.246 (n=286)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=323)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.198 (n=12119)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=3025)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `5339.6996` → IC=+0.171 (n=1930)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1777)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `15305.1426` → IC=+0.227 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15305.1426 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.208 (n=1310)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.210 (n=1433)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1843)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `13438.2681` → IC=+0.221 (n=646)
...
- **PATRÓN** `py_entrada` > `0.62` → IC=+0.175 (n=284)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `py_entrada` > 0.62 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `4641.025` → IC=+0.148 (n=231)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 4641.025 (IC base=+0.100)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.255 (n=577)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.249 (n=1279)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.242)

- **PATRÓN** `libro_liquidez` > `3755.7636` → IC=+0.247 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3755.7636 (IC base=+0.242)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.135 (n=708)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 7.0 (IC base=+0.117)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.133 (n=336)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.117)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.198 (n=9144)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 17.0 (IC base=+0.196)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.223 (n=3356)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=2266)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.177 (n=2370)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.271 (n=173)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.196 (n=1632)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.238 (n=10753)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.176 (n=4881)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.219 (n=1915)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.218)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.265 (n=1786)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.254 (n=2384)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.149 (n=1970)

  - _Acción_: Kelly boost +0.75€ cuando `restante_min` > 4.94 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.145 (n=2892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 8.0 (IC base=+0.129)

- **PATRÓN** `lag_apertura_s` < `3.88` → IC=+0.150 (n=1967)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 3.88 (IC base=+0.129)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.203 (n=2155)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.120)

- **PATRÓN** `restante_min` < `4.48` → IC=+0.126 (n=2644)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.48 (IC base=+0.120)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.149 (n=2069)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.130 (n=2961)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 8.0 (IC base=+0.120)

- **PATRÓN** `lag_apertura_s` < `2.44` → IC=+0.149 (n=1998)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9767` → IC=+0.232 (n=2173)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9767 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.1436` → IC=+0.247 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1436 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.838` → IC=+0.168 (n=2526)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.838 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `1.2217` → IC=+0.244 (n=1673)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2217 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.067` → IC=+0.241 (n=759)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.067 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.207 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.4663` → IC=+0.196 (n=4329)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4663 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.133 (n=7970)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.57 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` > `0.5521` → IC=+0.184 (n=483)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.5521 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` < `0.3354` → IC=+0.172 (n=2805)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.3354 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` < `0.6996` → IC=+0.174 (n=1162)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.6996 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` > `0.8715` → IC=+0.178 (n=1760)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.8715 (IC base=+0.061)

- **PATRÓN** `volumen_pendiente_norm` > `0.1673` → IC=+0.223 (n=1281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1673 (IC base=+0.061)

- **PATRÓN** `volumen_spike_ratio` > `1.5869` → IC=+0.202 (n=3919)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5869 (IC base=+0.061)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.212 (n=4158)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.177 (n=491)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0079 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3271` → IC=+0.162 (n=1473)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.3271 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.166 (n=729)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.184 (n=548)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 6.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.268 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.966` → IC=+0.273 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.966 (IC base=+0.162)
...
- **PATRÓN** `ibs_20min` < `0.058` → IC=+0.290 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.058 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.334` → IC=+0.247 (n=1134)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.334 (IC base=+0.234)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6474` → IC=+0.258 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6474 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.236 (n=1134)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1748.06` → IC=+0.252 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1748.06 (IC base=+0.234)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.225 (n=978)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.1151` → IC=+0.245 (n=489)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.1844` → IC=+0.213 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1844 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.1278` → IC=+0.215 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1278 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.786` → IC=+0.230 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.786 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2558` → IC=+0.223 (n=1111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2558 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.8755` → IC=+0.213 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8755 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.2276` → IC=+0.214 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2276 (IC base=+0.213)
...
- **PATRÓN** `ibs_20min` < `0.6747` → IC=+0.176 (n=1191)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6747 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1233` → IC=+0.152 (n=1090)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1233 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.426` → IC=+0.170 (n=201)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 11.426 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.2116` → IC=+0.147 (n=1191)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2116 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.6181` → IC=+0.141 (n=1191)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6181 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1561` → IC=+0.184 (n=321)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1561 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.4323` → IC=+0.154 (n=1081)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4323 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `13581.1471` → IC=+0.151 (n=794)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 13581.1471 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `241.0` → IC=+0.160 (n=439)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 241.0 (IC base=+0.139)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.191 (n=1439)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3742` → IC=+0.188 (n=187)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.3742 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` > `2.9915` → IC=+0.199 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9915 (IC base=+0.178)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.190 (n=1661)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.178)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.226 (n=1233)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.217 (n=1102)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3822` → IC=+0.234 (n=1085)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.323` → IC=+0.219 (n=1353)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3036` → IC=+0.227 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3036 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1899.1152` → IC=+0.241 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1899.1152 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.225 (n=710)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=1824)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.401` → IC=+0.133 (n=565)
...
- **PATRÓN** `dist_vwap_pct` > `0.1648` → IC=+0.194 (n=220)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1648 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.6944` → IC=+0.163 (n=271)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.6944 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2681` → IC=+0.232 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2681 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` > `1.5051` → IC=+0.190 (n=505)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 1.5051 (IC base=+0.009)
...
- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.127 (n=1823)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2692
  - _Potencial_: sin este filtro IC_bueno=+0.120 (n=899)

- **FILTRO** `sigma_ewma_delta_pct` > `8.618` → IC=-0.209 (n=300)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.618
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2422)
...
- **PATRÓN** `ibs_20min` < `0.2692` → IC=+0.120 (n=899)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.2692 (IC base=-0.045)

- **PATRÓN** `dist_vwap_pct` > `0.7032` → IC=+0.321 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7032 (IC base=-0.045)
...
- **PATRÓN** `volumen_regimen` > `0.9038` → IC=+0.194 (n=171)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 0.9038 (IC base=-0.045)

- **PATRÓN** `volumen_pendiente_norm` < `0.1972` → IC=+0.219 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1972 (IC base=-0.045)
...
- **FILTRO** `ibs_20min` > `0.7736` → IC=-0.199 (n=689)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7736
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=2068)
...
- **PATRÓN** `dist_vwap_pct` < `0.26` → IC=+0.251 (n=597)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4747` → IC=+0.248 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4747 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.181 (n=2718)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0093 (IC base=+0.088)

- **PATRÓN** `ibs_20min` > `0.4571` → IC=+0.179 (n=7273)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4571 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` > `0.6947` → IC=+0.279 (n=752)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6947 (IC base=+0.088)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.503` → IC=+0.147 (n=3852)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 3.503 (IC base=+0.088)

- **PATRÓN** `volumen_regimen` > `0.6782` → IC=+0.239 (n=2483)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6782 (IC base=+0.088)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.261 (n=878)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` < `1.4778` → IC=+0.245 (n=1485)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4778 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` > `2.7529` → IC=+0.238 (n=1483)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7529 (IC base=+0.088)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.277 (n=3939)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.088)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.142 (n=2755)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0086 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.554` → IC=+0.152 (n=7271)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.554 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6676` → IC=+0.244 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6676 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1626` → IC=+0.235 (n=2143)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1626 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.715` → IC=+0.237 (n=1013)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.715 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.1996` → IC=+0.253 (n=767)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1996 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.2507` → IC=+0.317 (n=604)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2507 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.4942` → IC=+0.253 (n=998)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4942 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.37` → IC=+0.258 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.37 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.260 (n=2857)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 79.0 (IC base=+0.070)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.241` → IC=-0.147 (n=556)

  - _Acción_: SKIP cuando `ibs_20min` < 0.241
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1671)

- **FILTRO** `sigma_ewma_delta_pct` > `4.274` → IC=-0.167 (n=418)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.274
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=1401)

- **PATRÓN** `ibs_20min` > `0.8739` → IC=+0.259 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8739 (IC base=+0.041)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.279` → IC=+0.152 (n=756)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.279 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.2236` → IC=+0.303 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2236 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` < `1.4419` → IC=+0.206 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4419 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` > `2.5947` → IC=+0.200 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5947 (IC base=+0.041)
...
- **PATRÓN** `dist_vwap_pct` > `0.2872` → IC=+0.141 (n=263)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.2872 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` < `0.1582` → IC=+0.137 (n=617)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1582 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` > `0.8514` → IC=+0.150 (n=478)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.8514 (IC base=+0.013)
...
- **PATRÓN** `volumen_spike_ratio` < `1.425` → IC=+0.185 (n=233)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.425 (IC base=+0.013)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8118` → IC=+0.209 (n=259)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8118 (IC base=+0.003)
...
- **PATRÓN** `ballena_activa_n` < `489.0` → IC=+0.214 (n=386)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 489.0 (IC base=+0.003)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.283 (n=868)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0074 (IC base=+0.239)

- **PATRÓN** `drift_60min` |x|≤ `0.0991` → IC=+0.244 (n=432)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.252 (n=481)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.526` → IC=+0.276 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.526 (IC base=+0.239)

- **PATRÓN** `volumen_pendiente_norm` < `0.11` → IC=+0.255 (n=1089)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.11 (IC base=+0.239)

- **PATRÓN** `volumen_spike_ratio` < `1.8738` → IC=+0.243 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8738 (IC base=+0.239)

- **PATRÓN** `volumen_spike_ratio` > `3.5994` → IC=+0.256 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5994 (IC base=+0.239)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1479)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `1911.2892` → IC=+0.242 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1911.2892 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.300 (n=1031)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.287 (n=1029)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2184` → IC=+0.282 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2184 (IC base=+0.281)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.292 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `1887.358` → IC=+0.309 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.358 (IC base=+0.281)
...
- **FILTRO** `ibs_20min` < `0.25` → IC=-0.213 (n=378)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=1135)

- **FILTRO** `ibs_20min` > `0.8009` → IC=-0.184 (n=488)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8009
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1467)

- **PATRÓN** `ibs_20min` > `0.8036` → IC=+0.152 (n=515)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.8036 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` > `0.4389` → IC=+0.211 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4389 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` < `0.1812` → IC=+0.193 (n=281)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.1812 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` < `0.956` → IC=+0.218 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.956 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `0.6214` → IC=+0.195 (n=326)
...
- **PATRÓN** `volumen_regimen` < `1.1418` → IC=+0.190 (n=269)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 1.1418 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` > `0.7255` → IC=+0.194 (n=240)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 0.7255 (IC base=-0.011)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7961` → IC=+0.253 (n=152)
...
- **PATRÓN** `ballena_activa_n` < `145.0` → IC=+0.263 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 145.0 (IC base=-0.011)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6774` → IC=-0.214 (n=879)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6774
  - _Potencial_: sin este filtro IC_bueno=+0.263 (n=880)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.627` → IC=-0.174 (n=427)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=1415)

- **PATRÓN** `ibs_20min` > `0.6774` → IC=+0.263 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6774 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1845` → IC=+0.312 (n=381)
...
- **PATRÓN** `volumen_regimen` > `0.6359` → IC=+0.278 (n=615)
...
- **PATRÓN** `dist_vwap_pct` < `0.3961` → IC=+0.198 (n=405)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.3961 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` < `0.7154` → IC=+0.247 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7154 (IC base=+0.005)

- **PATRÓN** `volumen_pendiente_norm` < `0.1008` → IC=+0.193 (n=356)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5876` → IC=+0.209 (n=366)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.221 (n=371)
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.175 (n=2145)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0048 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.199 (n=2147)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0106 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.3371` → IC=+0.173 (n=5645)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3371 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=6704)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.5802` → IC=+0.214 (n=6417)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5802 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9311` → IC=+0.216 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9311 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.206` → IC=+0.248 (n=1325)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.206 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `1.2136` → IC=+0.161 (n=4255)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2136 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` > `0.6236` → IC=+0.158 (n=4255)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6236 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2981` → IC=+0.190 (n=942)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2981 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `1.5654` → IC=+0.172 (n=2687)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5654 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6652` → IC=+0.170 (n=2035)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.6652 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `3822.0558` → IC=+0.168 (n=2139)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3822.0558 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.180 (n=5339)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 121.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.187 (n=4150)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0064 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0791` → IC=+0.205 (n=2078)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.47` → IC=+0.229 (n=6224)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.47 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2201` → IC=+0.162 (n=4636)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2201 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.165` → IC=+0.195 (n=1071)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.165 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1823` → IC=+0.155 (n=4553)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1823 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6245` → IC=+0.150 (n=4553)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6245 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2918` → IC=+0.232 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2918 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `1.5756` → IC=+0.171 (n=2448)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5756 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.6493` → IC=+0.177 (n=1855)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6493 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.173 (n=5185)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.195 (n=365)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0081 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.3242` → IC=+0.202 (n=1096)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3242 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.205 (n=534)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.304 (n=533)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2298` → IC=+0.238 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2298 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `2.5472` → IC=+0.173 (n=1001)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.5472 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` > `1.519` → IC=+0.180 (n=893)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.519 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.203 (n=1043)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.250 (n=698)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1816` → IC=+0.290 (n=521)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `drift_60min` |x|≤ `0.3644` → IC=+0.173 (n=939)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3644 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=992)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4182` → IC=+0.226 (n=939)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4182 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.1954` → IC=+0.208 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1954 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.523` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.523 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.172 (n=939)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.2628 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` < `0.0779` → IC=+0.161 (n=779)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.0779 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.232` → IC=+0.188 (n=206)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.232 (IC base=+0.162)
...
- **PATRÓN** `libro_liquidez` > `10150.3915` → IC=+0.177 (n=939)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 10150.3915 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.165 (n=1068)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.059` → IC=+0.196 (n=357)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.059 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.161 (n=992)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 7.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` < `0.3839` → IC=+0.205 (n=940)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3839 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.1321` → IC=+0.164 (n=1091)
...
- **PATRÓN** `volumen_regimen` < `1.2129` → IC=+0.160 (n=1068)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2129 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.1578` → IC=+0.176 (n=328)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1578 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.155 (n=958)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.206 (n=713)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0076 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.1988` → IC=+0.205 (n=711)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2142` → IC=+0.186 (n=1025)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2142 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.1342` → IC=+0.187 (n=413)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1342 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.6649` → IC=+0.191 (n=335)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.6649 (IC base=+0.189)
...
- **PATRÓN** `ibs_20min` < `0.3486` → IC=+0.255 (n=891)
...
- **PATRÓN** `libro_liquidez` > `1898.72` → IC=+0.242 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1898.72 (IC base=+0.224)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.213 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 18.0 (IC base=+0.224)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.177 (n=891)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0066 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.4234` → IC=+0.162 (n=1012)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3938` → IC=+0.200 (n=1012)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3938 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.1351` → IC=+0.184 (n=662)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1351 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.953` → IC=+0.246 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.953 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `1.0512` → IC=+0.154 (n=891)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5337` → IC=+0.164 (n=435)
...
- **PATRÓN** `ibs_20min` < `0.6028` → IC=+0.183 (n=1087)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.871` → IC=+0.193 (n=210)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 11.871 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.8541` → IC=+0.144 (n=725)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8541 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `0.609` → IC=+0.132 (n=1086)
...
- **PATRÓN** `volumen_spike_ratio` < `1.799` → IC=+0.138 (n=647)
...
- **PATRÓN** `ballena_activa_n` < `174.0` → IC=+0.130 (n=901)
...
- **PATRÓN** `ibs_20min` > `0.5098` → IC=+0.198 (n=1186)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8146` → IC=+0.129 (n=760)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.8146 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.120 (n=1226)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.154 (n=403)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0053 (IC base=+0.112)
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.204 (n=1201)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.6893` → IC=+0.137 (n=224)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.6893 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.1866` → IC=+0.135 (n=1090)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1866 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.391` → IC=+0.152 (n=257)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 7.391 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.041` → IC=+0.121 (n=1056)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.041 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2785` → IC=+0.183 (n=143)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.2785 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4638` → IC=+0.136 (n=352)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.4638 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.1782` → IC=+0.127 (n=478)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 2.1782 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3085.144` → IC=+0.164 (n=400)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 3085.144 (IC base=+0.112)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0182` → IC=+0.213 (n=746)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.725` → IC=+0.255 (n=1000)
...
- **PATRÓN** `sigma_h` > `0.0224` → IC=+0.214 (n=544)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0224 (IC base=+0.205)

- **PATRÓN** `drift_60min` |x|≤ `0.089` → IC=+0.220 (n=401)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.212 (n=547)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` < `0.0294` → IC=+0.310 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0294 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `1.1415` → IC=+0.229 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1415 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` < `0.2648` → IC=+0.206 (n=1263)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2648 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.721` → IC=+0.230 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.721 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6261` → IC=+0.217 (n=1200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6261 (IC base=+0.205)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2423` → IC=+0.198 (n=935)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.2423 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4614` → IC=+0.196 (n=1062)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4614 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2550.1344` → IC=+0.216 (n=800)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2550.1344 (IC base=+0.205)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.165 (n=523)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0089 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.3432` → IC=+0.142 (n=1379)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3432 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.179 (n=711)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 16.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.3942` → IC=+0.170 (n=1567)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.3942 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.8205` → IC=+0.162 (n=220)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.8205 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.66` → IC=+0.167 (n=721)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.66 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8678` → IC=+0.154 (n=900)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8678 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.2036` → IC=+0.139 (n=450)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.2036 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1639` → IC=+0.169 (n=430)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.1639 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.4337` → IC=+0.152 (n=501)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4337 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `2.5597` → IC=+0.168 (n=501)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.5597 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=1750)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `8478.1762` → IC=+0.152 (n=711)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8478.1762 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.158 (n=1347)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 158.0 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.137 (n=1111)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0057 (IC base=+0.116)

- **PATRÓN** `drift_60min` |x|≤ `0.3399` → IC=+0.131 (n=1460)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4882` → IC=+0.156 (n=1461)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4882 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.998` → IC=+0.133 (n=480)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 5.998 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `1.2207` → IC=+0.123 (n=1470)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.136 (n=1400)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.2373 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2625.3161` → IC=+0.121 (n=1483)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2625.3161 (IC base=+0.116)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3374` → IC=+0.153 (n=517)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3445` → IC=+0.206 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3445 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.453` → IC=+0.147 (n=205)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.453 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.093` → IC=+0.137 (n=587)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 9.093 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.138 (n=517)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.2046 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.7174` → IC=+0.153 (n=462)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7174 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` > `1.42` → IC=+0.144 (n=507)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.42 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.181 (n=164)
...
- **PATRÓN** `ibs_20min` < `0.4872` → IC=+0.151 (n=339)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.4872 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` < `0.7121` → IC=+0.136 (n=149)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.7121 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` < `1.5981` → IC=+0.186 (n=138)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.5981 (IC base=+0.086)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.193 (n=3702)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.213 (n=8153)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.8845` → IC=+0.194 (n=1057)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.8845 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.737` → IC=+0.231 (n=3048)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.737 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.164 (n=3648)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8827 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.191 (n=1533)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6328` → IC=+0.182 (n=2592)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6328 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3790.4821` → IC=+0.169 (n=2717)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3790.4821 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `92.0` → IC=+0.192 (n=5982)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 92.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.196 (n=4986)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0068 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.4805` → IC=+0.185 (n=7467)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4805 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2871)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` < `0.5623` → IC=+0.240 (n=7467)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5623 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.231` → IC=+0.164 (n=4739)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.231 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.844` → IC=+0.196 (n=1074)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 9.844 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.683` → IC=+0.184 (n=7221)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 3.683 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `0.7044` → IC=+0.160 (n=2276)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.7044 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.161 (n=1724)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.2035 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2889` → IC=+0.248 (n=975)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2889 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.2966` → IC=+0.192 (n=3051)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.2966 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.192 (n=2150)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 25.0 (IC base=+0.183)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.209 (n=921)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.201 (n=681)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.264 (n=1066)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0044 (IC base=+0.255)

- **PATRÓN** `drift_60min` |x|≤ `0.2039` → IC=+0.284 (n=710)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.287 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.403` → IC=+0.263 (n=1119)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1837` → IC=+0.155 (n=863)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3149` → IC=+0.201 (n=1294)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3149 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.3233` → IC=+0.195 (n=490)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.3233 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.155 (n=302)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 9.757 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.29` → IC=+0.154 (n=1151)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.29 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.182 (n=570)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6973 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` < `0.0734` → IC=+0.154 (n=1127)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.0734 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.158 (n=1091)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7574` → IC=+0.159 (n=827)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7574 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `10977.0001` → IC=+0.167 (n=1156)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 10977.0001 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `486.0` → IC=+0.160 (n=1170)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 486.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.171 (n=1154)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0057 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.26` → IC=+0.169 (n=1015)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6376` → IC=+0.206 (n=1153)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6376 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.6855` → IC=+0.167 (n=172)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6855 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` < `0.1265` → IC=+0.166 (n=1070)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1265 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.523` → IC=+0.173 (n=206)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 11.523 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `1.2004` → IC=+0.164 (n=1153)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4232` → IC=+0.169 (n=1056)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.4232 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.7548` → IC=+0.160 (n=704)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7548 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `12583.0078` → IC=+0.158 (n=769)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12583.0078 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `366.0` → IC=+0.168 (n=640)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 366.0 (IC base=+0.155)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.228 (n=1302)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1314)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.6717` → IC=+0.249 (n=1162)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6717 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.556` → IC=+0.299 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.556 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` < `0.2161` → IC=+0.216 (n=1265)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2161 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.9845` → IC=+0.235 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9845 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.224 (n=1498)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.239 (n=1234)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_spike_ratio` > `2.2483` → IC=+0.234 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2483 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.247 (n=702)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1900.7432` → IC=+0.246 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1900.7432 (IC base=+0.234)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.175 (n=466)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0034 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.4335` → IC=+0.137 (n=1385)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.4335 (IC base=+0.133)
...
- **PATRÓN** `dist_vwap_pct` > `0.5539` → IC=+0.175 (n=370)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.5539 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.195` → IC=+0.159 (n=582)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.195 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `0.8772` → IC=+0.155 (n=924)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8772 (IC base=+0.133)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5119` → IC=+0.147 (n=588)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5119 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `2.4575` → IC=+0.155 (n=444)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.4575 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `8700.8274` → IC=+0.229 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8700.8274 (IC base=+0.133)

- **PATRÓN** `ballena_activa_n` < `85.0` → IC=+0.164 (n=423)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 85.0 (IC base=+0.133)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.164 (n=1123)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0075 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.4443` → IC=+0.161 (n=1123)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4443 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.175 (n=429)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 17.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.157 (n=502)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 7.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` < `0.6856` → IC=+0.197 (n=1123)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.6856 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.3462` → IC=+0.146 (n=1152)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3462 (IC base=+0.143)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.186` → IC=+0.144 (n=1046)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 4.186 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.6938` → IC=+0.149 (n=494)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6938 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `1.1774` → IC=+0.157 (n=374)
...
- **PATRÓN** `volumen_spike_ratio` > `1.443` → IC=+0.158 (n=1052)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.443 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `11048.3545` → IC=+0.207 (n=374)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11048.3545 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.147 (n=920)
...
- **PATRÓN** `ibs_20min` > `0.4694` → IC=+0.181 (n=1394)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.373` → IC=+0.224 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.373 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2920.0962` → IC=+0.237 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2920.0962 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.123 (n=1048)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 53.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.178 (n=451)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0056 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.1277` → IC=+0.159 (n=450)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1277 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.148 (n=640)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.64` → IC=+0.207 (n=1348)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.64 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.4697` → IC=+0.129 (n=1317)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4697 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.449` → IC=+0.127 (n=1297)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.449 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.7204` → IC=+0.151 (n=594)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7204 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2234` → IC=+0.176 (n=208)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2234 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4671` → IC=+0.152 (n=397)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4671 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.5681` → IC=+0.124 (n=397)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.5681 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2890.5622` → IC=+0.162 (n=450)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2890.5622 (IC base=+0.114)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0185` → IC=+0.213 (n=933)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0185 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1464)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.206)

- **PATRÓN** `ibs_20min` > `0.5111` → IC=+0.245 (n=1400)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5687` → IC=+0.240 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5687 (IC base=+0.206)
...
- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.223 (n=517)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` < `2.2259` → IC=+0.194 (n=1202)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2259 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4469` → IC=+0.199 (n=1365)
...
- **PATRÓN** `libro_liquidez` > `2562.5653` → IC=+0.201 (n=1031)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.136 (n=2599)

- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.155 (n=2237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0094 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.526` → IC=+0.156 (n=2539)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.1876` → IC=+0.154 (n=831)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.1876 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.736` → IC=+0.167 (n=820)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9054` → IC=+0.157 (n=1676)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.9054 (IC base=+0.145)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4873` → IC=+0.153 (n=1961)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.159 (n=658)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.9176` → IC=+0.139 (n=272)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.9176 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.306` → IC=+0.142 (n=1942)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 6.306 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `1.1137` → IC=+0.142 (n=1639)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8237` → IC=+0.144 (n=1294)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8237 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.136 (n=2599)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `7638.6115` → IC=+0.149 (n=1752)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7638.6115 (IC base=+0.133)
...
- **PATRÓN** `sigma_h` < `0.0087` → IC=+0.151 (n=755)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0087 (IC base=+0.144)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.150 (n=756)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0045 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.5033` → IC=+0.153 (n=755)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.5033 (IC base=+0.144)
...
- **PATRÓN** `ibs_20min` > `0.186` → IC=+0.155 (n=755)
...
- **PATRÓN** `dist_vwap_pct` < `0.4234` → IC=+0.150 (n=719)
...
- **PATRÓN** `volumen_regimen` < `1.1119` → IC=+0.147 (n=664)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1119 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6454` → IC=+0.147 (n=755)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=718)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8162.0536` → IC=+0.150 (n=755)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8162.0536 (IC base=+0.144)
...
- **PATRÓN** `dist_vwap_pct` > `0.6396` → IC=+0.161 (n=54)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.6396 (IC base=+0.027)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.209 (n=307)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.6306` → IC=+0.209 (n=606)
...
- **PATRÓN** `volumen_regimen` < `0.8014` → IC=+0.134 (n=405)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8014 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `0.9761` → IC=+0.124 (n=275)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.9761 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.2835` → IC=+0.207 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2835 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` < `2.4945` → IC=+0.159 (n=499)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4945 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.4023` → IC=+0.136 (n=498)
...
- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.147 (n=264)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.105)
...
- **FILTRO** `ibs_20min` < `0.5802` → IC=-0.176 (n=69)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.200 (n=208)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.172 (n=239)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.006 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.178 (n=88)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.5802` → IC=+0.200 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5802 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.1288` → IC=+0.186 (n=100)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1288 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.739` → IC=+0.126 (n=129)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 3.739 (IC base=+0.100)

- **PATRÓN** `volumen_regimen` < `1.0527` → IC=+0.132 (n=183)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0527 (IC base=+0.100)

- **PATRÓN** `volumen_pendiente_norm` < `0.0759` → IC=+0.149 (n=149)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0759 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.184 (n=150)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.100)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.128 (n=221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 7.0 (IC base=+0.090)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.191 (n=189)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.6667 (IC base=+0.090)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.345` → IC=+0.222 (n=77)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.345 (IC base=+0.090)

- **PATRÓN** `volumen_regimen` > `1.0632` → IC=+0.146 (n=63)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.0632 (IC base=+0.090)

- **PATRÓN** `volumen_pendiente_norm` > `0.0894` → IC=+0.187 (n=81)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.0894 (IC base=+0.090)

- **PATRÓN** `volumen_spike_ratio` < `2.1854` → IC=+0.175 (n=149)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.1854 (IC base=+0.090)

- **PATRÓN** `volumen_spike_ratio` > `1.5314` → IC=+0.134 (n=151)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.5314 (IC base=+0.090)

- **PATRÓN** `libro_spread` < `0.08` → IC=+0.129 (n=173)
...
- **PATRÓN** `ibs_20min` > `0.7368` → IC=+0.152 (n=199)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.7368 (IC base=+0.079)
...
- **PATRÓN** `libro_liquidez` > `577.9686` → IC=+0.163 (n=81)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 577.9686 (IC base=+0.164)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.128 (n=512)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2843.9296` → IC=+0.180 (n=176)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2843.9296 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2322.3754` → IC=+0.123 (n=585)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2322.3754 (IC base=+0.099)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=6731)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.181 (n=2805)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=8563)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=2884)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=8956)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.217 (n=478)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1456)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.171 (n=491)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1619)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.205 (n=479)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=1496)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.221 (n=493)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1600)

- **FILTRO** `ibs_20min` > `0.2846` → IC=-0.160 (n=522)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2846
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1571)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.200 (n=464)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1442)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.193 (n=509)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1580)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=2556)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=2562)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.131 (n=8058)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=18421)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=6277)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=20202)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.244 (n=6577)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=19902)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.161 (n=8992)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=17487)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.225 (n=8330)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=24997)

- **FILTRO** `ibs_7min` > `0.2955` → IC=-0.176 (n=8331)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2955
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=24996)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.134 (n=1304)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=2981)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=1016)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3269)

- **FILTRO** `ibs_7min` < `0.7075` → IC=-0.259 (n=1414)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7075
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2871)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.199 (n=980)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3305)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.149 (n=3888)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=1905)

- **FILTRO** `drift_7min_pct` |x|> `0.111` → IC=-0.122 (n=1966)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.111
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3827)

- **FILTRO** `ibs_7min` > `0.7992` → IC=-0.203 (n=1447)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7992
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4346)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1060)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=1097)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3523)

- **FILTRO** `ibs_7min` < `0.7545` → IC=-0.188 (n=1155)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7545
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3465)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.178 (n=1149)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3471)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1125)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3577)

- **FILTRO** `ibs_7min` > `0.2547` → IC=-0.169 (n=1175)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2547
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3527)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.183 (n=1171)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3531)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=973)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=3031)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.317 (n=965)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3039)

- **FILTRO** `drift_7min_pct` |x|> `0.1791` → IC=-0.133 (n=1361)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1791
  - _Potencial_: sin este filtro IC_bueno=-0.104 (n=2643)

- **FILTRO** `ibs_7min` < `0.2` → IC=-0.269 (n=993)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=3011)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.221 (n=923)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3081)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1429)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4674)

- **FILTRO** `ibs_7min` > `0.2602` → IC=-0.154 (n=2075)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2602
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4028)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=1378)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=2990)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.254 (n=1074)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3294)

- **FILTRO** `ibs_7min` < `0.7422` → IC=-0.189 (n=1092)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7422
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3276)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.186 (n=1078)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=3290)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1105)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3373)

- **FILTRO** `ibs_7min` > `0.2739` → IC=-0.173 (n=1119)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2739
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3359)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.181 (n=1095)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3383)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.259 (n=1149)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3583)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.233 (n=1162)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3570)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.172 (n=1543)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4766)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1349)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=3121)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.282 (n=1107)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3363)

- **FILTRO** `ibs_7min` < `0.72` → IC=-0.236 (n=1116)

  - _Acción_: SKIP cuando `ibs_7min` < 0.72
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3354)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.213 (n=1088)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3382)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.206 (n=1408)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=4534)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=612)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2449)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.221 (n=531)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.179)

- **PATRÓN** `drift_60min` |x|≤ `0.1636` → IC=+0.182 (n=1029)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.1636 (IC base=+0.179)

- **PATRÓN** `delta_ratio_macro` |x|> `0.058` → IC=+0.180 (n=1170)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.90€ cuando `delta_ratio_macro` |x|> 0.058 (IC base=+0.179)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1364` → IC=+0.234 (n=374)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1364 (IC base=+0.179)
...
- **PATRÓN** `ibs_15` > `0.619` → IC=+0.253 (n=1170)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.619 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` > `0.4223` → IC=+0.174 (n=274)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.4223 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` < `0.1038` → IC=+0.180 (n=761)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1038 (IC base=+0.179)
...
- **PATRÓN** `libro_liquidez` > `4692.4102` → IC=+0.183 (n=531)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 4692.4102 (IC base=+0.179)
...
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.154 (n=128)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0057 (IC base=+0.138)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2337` → IC=+0.167 (n=94)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.2337 (IC base=+0.138)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2712` → IC=+0.160 (n=186)

  - _Acción_: Kelly boost +0.80€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2712 (IC base=+0.138)
...
- **PATRÓN** `ibs_15` > `0.6853` → IC=+0.259 (n=251)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6853 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.0983` → IC=+0.163 (n=200)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.0983 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.981` → IC=+0.213 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.981 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `9700.4747` → IC=+0.139 (n=128)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 9700.4747 (IC base=+0.138)
...
- **PATRÓN** `ibs_15` < `0.1143` → IC=+0.169 (n=373)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.85€ cuando `ibs_15` < 0.1143 (IC base=+0.045)
...
- **FILTRO** `sigma_h` > `0.0127` → IC=-0.209 (n=555)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0127
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1668)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.180 (n=713)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1510)

- **FILTRO** `libro_liquidez` < `3796.4295` → IC=-0.124 (n=1467)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2079` → IC=+0.242 (n=416)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2079 (IC base=-0.041)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1821` → IC=+0.244 (n=798)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1821 (IC base=-0.041)

- **PATRÓN** `ibs_15` < `0.3571` → IC=+0.282 (n=1247)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3571 (IC base=-0.041)

- **PATRÓN** `dist_vwap_pct` > `0.8663` → IC=+0.265 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8663 (IC base=-0.041)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1079` → IC=+0.333 (n=40)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1079 (IC base=+0.071)
...
- **PATRÓN** `dist_vwap_pct` > `0.099` → IC=+0.261 (n=86)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.099 (IC base=+0.071)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.248 (n=522)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.229)

- **PATRÓN** `drift_60min` |x|≤ `0.3595` → IC=+0.233 (n=459)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3595 (IC base=+0.229)

- **PATRÓN** `drift_15min` |x|≤ `0.774` → IC=+0.237 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.774 (IC base=+0.229)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1983` → IC=+0.257 (n=237)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1983 (IC base=+0.229)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.243 (n=247)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.229)

- **PATRÓN** `ibs_15` < `0.2757` → IC=+0.287 (n=459)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2757 (IC base=+0.229)

- **PATRÓN** `dist_vwap_pct` > `0.7403` → IC=+0.268 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7403 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.179` → IC=+0.250 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 20.179 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.153` → IC=+0.233 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.153 (IC base=+0.229)

- **PATRÓN** `libro_liquidez` > `3576.5439` → IC=+0.231 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3576.5439 (IC base=+0.229)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.230 (n=495)
...
- **FILTRO** `sigma_h` > `0.0195` → IC=-0.267 (n=333)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0195
  - _Potencial_: sin este filtro IC_bueno=-0.102 (n=335)

- **FILTRO** `drift_15min` |x|> `1.1964` → IC=-0.244 (n=166)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.1964
  - _Potencial_: sin este filtro IC_bueno=-0.165 (n=502)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.261 (n=174)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.157 (n=494)
...
- **PATRÓN** `ibs_15` < `0.3448` → IC=+0.315 (n=360)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.619 sube el IC de +0.179 a +0.253 en UPDOWN_GBM#15min (n=1170). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6853 sube el IC de +0.138 a +0.259 en UPDOWN_GBM#ETH#15min (n=251). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1143 sube el IC de +0.045 a +0.169 en UPDOWN_GBM#XRP#15min (n=373). Ya aplicado como kelly_boost=+0.85€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3571 sube el IC de -0.041 a +0.282 en UPDOWN_GBM_15M_TARDIO (n=1247). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8098 sube el IC de +0.071 a +0.336 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=114). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2757 sube el IC de +0.229 a +0.287 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=459). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3667 sube el IC de -0.041 a +0.254 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=250). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3448 sube el IC de -0.044 a +0.315 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=360). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1167 | +0.084 | +144.90€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1167 | +0.084 | +144.90€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 56 | +0.172 | +24.06€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 56 | +0.172 | +24.06€ | 0 | 6 |
| ✅ BALLENAS_TARDIAS | 21524 | -0.097 | -3150.06€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1275 | -0.051 | -194.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 20249 | -0.100 | -2955.60€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3321 | -0.101 | -568.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3321 | -0.101 | -568.86€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1275 | -0.051 | -194.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1275 | -0.051 | -194.46€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6170 | -0.042 | -612.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6170 | -0.042 | -612.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5710 | -0.098 | -478.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5710 | -0.098 | -478.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4674 | -0.173 | -1134.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4674 | -0.173 | -1134.59€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 13462 | -0.038 | +4178.76€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3589 | -0.005 | +1832.05€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 9873 | -0.051 | +2346.71€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 13462 | -0.038 | +4178.76€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3589 | -0.005 | +1832.05€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 9873 | -0.051 | +2346.71€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1194 | -0.099 | -161.73€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 103 | -0.043 | -10.20€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1091 | -0.104 | -151.53€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 680 | -0.084 | -80.05€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 79 | -0.031 | -4.97€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 601 | -0.090 | -75.08€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 336 | -0.142 | -69.59€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 312 | -0.146 | -64.37€ | 2 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 78140 | +0.113 | -3968.52€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 12113 | +0.183 | -359.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 301 | -0.120 | -46.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 60405 | +0.100 | -3408.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5321 | +0.113 | -153.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 10062 | +0.097 | -916.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 41 | -0.151 | -1.09€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 10006 | +0.099 | -903.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 15802 | +0.132 | -302.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3735 | +0.203 | -110.46€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 10007 | +0.111 | -170.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2018 | +0.113 | +1.35€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 10100 | +0.088 | -987.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 47 | -0.051 | -1.60€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 10038 | +0.089 | -975.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 16712 | +0.124 | -299.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4679 | +0.173 | -70.10€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 10106 | +0.107 | -168.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1915 | +0.098 | -52.33€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 15386 | +0.115 | -886.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3570 | +0.186 | -187.08€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 204 | -0.083 | +7.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 10224 | +0.092 | -604.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1388 | +0.132 | -102.22€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 10078 | +0.103 | -575.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 41 | -0.012 | +10.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 10024 | +0.104 | -586.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 