# Hipótesis automáticas — 2026-09-23 11:11 UTC
_Generado por shadow_postmortem.py sobre 572213 resoluciones (PNL=+63979.19€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.252 (n=513)

- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)

  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.119 (n=463)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.252 (n=513)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8036` → IC=+0.253 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8036 (IC base=+0.137)

- **PATRÓN** `banda_z` > `4.204` → IC=+0.166 (n=537)

  - _Acción_: Kelly boost +0.83€ cuando `banda_z` > 4.204 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.147 (n=494)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 7.0 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=573)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `4869.7265` → IC=+0.158 (n=179)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 4869.7265 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.133 (n=164)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 96.0 (IC base=+0.044)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.258 (n=407)

- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)

  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.112 (n=336)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.258 (n=407)
...
- **PATRÓN** `banda_hit_calibrado` > `0.7998` → IC=+0.267 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.7998 (IC base=+0.146)

- **PATRÓN** `banda_z` > `10.816` → IC=+0.231 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.816 (IC base=+0.146)
...
- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.151 (n=124)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 96.0 (IC base=+0.046)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.09` → IC=-0.232 (n=6863)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.09
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=20589)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.43` → IC=-0.235 (n=893)
...
- **FILTRO** `restante_s_al_confirmar` < `130.64` → IC=-0.295 (n=851)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 130.64
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2553)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `164.01` → IC=-0.228 (n=1631)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.01
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4893)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.16` → IC=-0.357 (n=1371)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.16
  - _Potencial_: sin este filtro IC_bueno=-0.124 (n=4113)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.202 (n=13532)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3398)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5607.146` → IC=+0.175 (n=2166)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5607.146 (IC base=+0.101)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.232 (n=10572)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5527)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7718.399` → IC=+0.173 (n=2080)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7718.399 (IC base=+0.127)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1668)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1640)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.351 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2059)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1471)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.200)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.204 (n=1632)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.263 (n=1485)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=2088)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `13994.7148` → IC=+0.209 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13994.7148 (IC base=+0.200)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.141 (n=505)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 11.0 (IC base=+0.109)

- **PATRÓN** `py_entrada` < `0.44` → IC=+0.148 (n=801)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.239 (n=1449)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.141 (n=577)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1302.4168` → IC=+0.149 (n=637)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.432 (n=616)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=1058)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.355` → IC=+0.194 (n=371)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.355 (IC base=+0.112)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=11079)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=10623)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3721)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2566)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.184 (n=1876)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.252 (n=772)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.429 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.430)

- **PATRÓN** `libro_liquidez` > `2069.2076` → IC=+0.439 (n=503)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.454 (n=170)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.438 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.437)

- **PATRÓN** `libro_liquidez` > `3364.1944` → IC=+0.446 (n=127)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=6030)
...
- **PATRÓN** `libro_liquidez` > `4068.869` → IC=+0.311 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4068.869 (IC base=+0.291)
...
- **PATRÓN** `libro_liquidez` > `4222.4628` → IC=+0.301 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4222.4628 (IC base=+0.278)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4796` → IC=+0.122 (n=7747)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4796 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.982` → IC=+0.243 (n=2583)
...
- **PATRÓN** `dist_vwap_pct` < `0.63` → IC=+0.248 (n=2152)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.63 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.934` → IC=+0.177 (n=2980)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.934 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0481` → IC=+0.259 (n=945)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0481 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.3054` → IC=+0.217 (n=772)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3054 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.909` → IC=+0.207 (n=3526)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.909 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.5701` → IC=+0.132 (n=9342)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5701 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.5935` → IC=+0.194 (n=716)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.5935 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.1495` → IC=+0.172 (n=2898)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1495 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.6995` → IC=+0.179 (n=1427)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6995 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `1.0522` → IC=+0.175 (n=1470)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0522 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.1681` → IC=+0.223 (n=1545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1681 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` > `1.5744` → IC=+0.201 (n=4850)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5744 (IC base=+0.063)

- **PATRÓN** `ballena_activa_n` < `137.0` → IC=+0.210 (n=5211)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 137.0 (IC base=+0.063)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.181 (n=585)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.005 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.172 (n=587)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0082 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.3476` → IC=+0.166 (n=1755)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.164 (n=1640)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.250 (n=1168)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.089` → IC=+0.285 (n=436)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.089 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.248 (n=883)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.234)

- **PATRÓN** `ibs_20min` < `0.0583` → IC=+0.295 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0583 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.415` → IC=+0.248 (n=1359)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.415 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.230 (n=1116)
...
- **PATRÓN** `ibs_20min` < `0.6918` → IC=+0.170 (n=1388)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6918 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.132` → IC=+0.157 (n=1227)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.132 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.204` → IC=+0.164 (n=224)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 11.204 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.243` → IC=+0.140 (n=1263)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 4.243 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.2025` → IC=+0.148 (n=1388)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2025 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0967` → IC=+0.173 (n=503)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0967 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4168` → IC=+0.150 (n=1278)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.4168 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.7651` → IC=+0.146 (n=852)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7651 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.147 (n=1199)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 411.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.219 (n=571)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=1802)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 5.0 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.193 (n=1537)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.187)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.263 (n=682)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.184` → IC=+0.253 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.184 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` < `0.2115` → IC=+0.188 (n=1708)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2115 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` > `0.3635` → IC=+0.200 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3635 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` > `2.8557` → IC=+0.208 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8557 (IC base=+0.187)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.195 (n=1210)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.187)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.222 (n=1463)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.5845` → IC=+0.216 (n=1462)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5845 (IC base=+0.214)
...
- **PATRÓN** `ibs_20min` < `0.0625` → IC=+0.241 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0625 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.615` → IC=+0.243 (n=497)
...
- **PATRÓN** `volumen_spike_ratio` < `1.799` → IC=+0.205 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.799 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `2.2222` → IC=+0.219 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2222 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.222 (n=974)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `1872.8576` → IC=+0.229 (n=663)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1872.8576 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.213 (n=1118)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=96)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2146)
...
- **PATRÓN** `volumen_regimen` < `0.8504` → IC=+0.160 (n=530)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8504 (IC base=+0.014)

- **PATRÓN** `volumen_pendiente_norm` > `0.2258` → IC=+0.216 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2258 (IC base=+0.014)

- **PATRÓN** `volumen_spike_ratio` > `1.5219` → IC=+0.176 (n=662)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.5219 (IC base=+0.014)
...
- **FILTRO** `ibs_20min` > `0.2576` → IC=-0.126 (n=2118)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2576
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=1044)

- **FILTRO** `sigma_ewma_delta_pct` > `8.653` → IC=-0.203 (n=341)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.653
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2821)
...
- **PATRÓN** `ibs_20min` < `0.2576` → IC=+0.125 (n=1044)
...
- **PATRÓN** `volumen_regimen` < `1.096` → IC=+0.222 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.096 (IC base=-0.043)

- **PATRÓN** `volumen_regimen` > `0.9031` → IC=+0.212 (n=227)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4773` → IC=+0.259 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4773 (IC base=-0.043)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6492` → IC=-0.186 (n=542)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6492
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1628)

- **FILTRO** `ibs_20min` < `0.7098` → IC=-0.157 (n=1432)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7098
  - _Potencial_: sin este filtro IC_bueno=+0.107 (n=738)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.201 (n=402)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1768)

- **FILTRO** `ibs_20min` > `0.7717` → IC=-0.205 (n=802)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7717
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=2408)

- **PATRÓN** `dist_vwap_pct` > `0.7626` → IC=+0.315 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7626 (IC base=-0.067)

- **PATRÓN** `dist_vwap_pct` < `0.2662` → IC=+0.321 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2662 (IC base=-0.067)

- **PATRÓN** `volumen_regimen` < `0.9872` → IC=+0.293 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9872 (IC base=-0.067)

- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.308 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6229 (IC base=-0.067)

- **PATRÓN** `volumen_pendiente_norm` < `0.0963` → IC=+0.295 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0963 (IC base=-0.067)

- **PATRÓN** `volumen_pendiente_norm` > `0.0744` → IC=+0.309 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0744 (IC base=-0.067)

- **PATRÓN** `volumen_spike_ratio` < `2.4256` → IC=+0.301 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4256 (IC base=-0.067)

- **PATRÓN** `volumen_spike_ratio` > `1.7951` → IC=+0.298 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7951 (IC base=-0.067)

- **PATRÓN** `dist_vwap_pct` > `0.8161` → IC=+0.272 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8161 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.7389` → IC=+0.250 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7389 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` > `1.0828` → IC=+0.284 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0828 (IC base=-0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.1689` → IC=+0.278 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1689 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `2.1732` → IC=+0.251 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1732 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.248 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4427 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.245 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.198 (n=3233)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4733` → IC=+0.188 (n=8661)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4733 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7483` → IC=+0.286 (n=1060)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7483 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.573` → IC=+0.157 (n=4583)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.573 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6888` → IC=+0.247 (n=3070)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6888 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2975` → IC=+0.265 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2975 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4721` → IC=+0.241 (n=1860)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4721 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6849` → IC=+0.238 (n=1860)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6849 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.269 (n=5085)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.149 (n=3236)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.009 (IC base=+0.072)

- **PATRÓN** `ibs_20min` < `0.5488` → IC=+0.151 (n=8533)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5488 (IC base=+0.072)

- **PATRÓN** `dist_vwap_pct` < `0.244` → IC=+0.237 (n=2659)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.244 (IC base=+0.072)

- **PATRÓN** `volumen_regimen` < `0.7126` → IC=+0.237 (n=1249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7126 (IC base=+0.072)

- **PATRÓN** `volumen_regimen` > `1.2033` → IC=+0.245 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2033 (IC base=+0.072)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.302 (n=707)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.072)

- **PATRÓN** `volumen_spike_ratio` < `1.6115` → IC=+0.254 (n=1634)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6115 (IC base=+0.072)

- **PATRÓN** `volumen_spike_ratio` > `2.3312` → IC=+0.256 (n=1683)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3312 (IC base=+0.072)

- **PATRÓN** `ballena_activa_n` < `83.0` → IC=+0.261 (n=3593)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 83.0 (IC base=+0.072)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.503` → IC=-0.165 (n=509)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.503
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1717)

- **PATRÓN** `ibs_20min` > `0.8889` → IC=+0.262 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8889 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.756` → IC=+0.203 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.756 (IC base=+0.045)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1791` → IC=+0.457 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1791 (IC base=-0.018)

- **PATRÓN** `volumen_spike_ratio` > `1.3948` → IC=+0.443 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3948 (IC base=-0.018)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.460 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=-0.018)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `ibs_20min` > `0.8632` → IC=+0.158 (n=647)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8632 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.1247` → IC=+0.173 (n=503)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.1247 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6718` → IC=+0.163 (n=792)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6718 (IC base=+0.026)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4243` → IC=+0.201 (n=289)
...
- **PATRÓN** `dist_vwap_pct` < `0.1603` → IC=+0.215 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1603 (IC base=+0.002)

- **PATRÓN** `volumen_regimen` > `0.6093` → IC=+0.209 (n=530)
...
- **PATRÓN** `ibs_20min` < `0.2262` → IC=+0.286 (n=1070)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2262 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.841` → IC=+0.297 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.841 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.3435` → IC=+0.307 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3435 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` < `1.6079` → IC=+0.284 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6079 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.7879` → IC=+0.286 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7879 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.290 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1926.5448` → IC=+0.301 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1926.5448 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.285 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2829` → IC=-0.191 (n=471)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2829
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1413)

- **FILTRO** `ibs_20min` > `0.7753` → IC=-0.183 (n=575)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7753
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1726)

- **PATRÓN** `ibs_20min` > `0.9101` → IC=+0.181 (n=471)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.9101 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` > `0.4514` → IC=+0.224 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4514 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.9978` → IC=+0.234 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9978 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.5846` → IC=+0.209 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5846 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.0773` → IC=+0.250 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0773 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` < `2.1113` → IC=+0.245 (n=441)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1113 (IC base=+0.009)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.258 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` > `0.1534` → IC=+0.205 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1534 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` < `0.6607` → IC=+0.192 (n=453)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.6607 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` < `1.1607` → IC=+0.206 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1607 (IC base=-0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.1651` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1651 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` < `1.8289` → IC=+0.254 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8289 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` > `2.1743` → IC=+0.244 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1743 (IC base=-0.007)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.245 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=-0.007)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7196` → IC=-0.198 (n=1028)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7196
  - _Potencial_: sin este filtro IC_bueno=+0.279 (n=1028)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.232 (n=538)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=1621)

- **FILTRO** `sigma_ewma_delta_pct` > `4.678` → IC=-0.178 (n=470)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.678
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=1689)

- **PATRÓN** `ibs_20min` > `0.7196` → IC=+0.279 (n=1028)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7196 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` > `0.8423` → IC=+0.337 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8423 (IC base=+0.040)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.527` → IC=+0.157 (n=327)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.527 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` < `0.8657` → IC=+0.301 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8657 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `0.643` → IC=+0.289 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.643 (IC base=+0.040)

- **PATRÓN** `volumen_pendiente_norm` < `0.1024` → IC=+0.293 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1024 (IC base=+0.040)
...
- **PATRÓN** `volumen_spike_ratio` < `1.443` → IC=+0.322 (n=245)
...
- **PATRÓN** `ibs_20min` > `0.6316` → IC=+0.313 (n=1263)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.509` → IC=+0.307 (n=667)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.509 (IC base=+0.280)

- **PATRÓN** `volumen_regimen` > `0.863` → IC=+0.304 (n=842)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1582` → IC=+0.292 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1582 (IC base=+0.280)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.286 (n=1346)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.280)

- **PATRÓN** `libro_liquidez` > `2619.817` → IC=+0.295 (n=842)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2619.817 (IC base=+0.280)

- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.296 (n=912)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.304 (n=1368)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3966 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` > `0.2929` → IC=+0.279 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2929 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` < `0.9457` → IC=+0.271 (n=1532)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9457 (IC base=+0.270)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.006` → IC=+0.298 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.006 (IC base=+0.270)

- **PATRÓN** `volumen_regimen` > `1.2432` → IC=+0.310 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2432 (IC base=+0.270)

- **PATRÓN** `volumen_pendiente_norm` > `0.2393` → IC=+0.339 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2393 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` < `2.5102` → IC=+0.266 (n=1201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5102 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` > `2.1642` → IC=+0.275 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1642 (IC base=+0.270)

- **PATRÓN** `libro_liquidez` > `2608.7306` → IC=+0.277 (n=912)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2608.7306 (IC base=+0.270)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2535)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.203 (n=2533)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0899` → IC=+0.186 (n=2533)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0899 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=7903)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5791` → IC=+0.217 (n=7591)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5791 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1752` → IC=+0.196 (n=3363)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1752 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.275` → IC=+0.260 (n=1558)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.275 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2156` → IC=+0.161 (n=5020)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2156 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6285` → IC=+0.161 (n=5021)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6285 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2965` → IC=+0.197 (n=1133)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2965 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5628` → IC=+0.172 (n=3200)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5628 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6282` → IC=+0.177 (n=2425)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6282 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2398.6848` → IC=+0.169 (n=5061)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2398.6848 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.182 (n=6501)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 116.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.182 (n=4816)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0802` → IC=+0.209 (n=2408)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0802 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.205 (n=2786)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.4772` → IC=+0.226 (n=7219)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4772 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2292` → IC=+0.159 (n=5215)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2292 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.272` → IC=+0.194 (n=1231)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.272 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1748` → IC=+0.152 (n=5243)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1748 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2911` → IC=+0.222 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2911 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5648` → IC=+0.165 (n=2880)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5648 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2598` → IC=+0.171 (n=2966)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2598 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.173 (n=6184)
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.263 (n=933)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3443 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.153` → IC=+0.253 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.153 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.1574` → IC=+0.234 (n=875)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1574 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` > `0.2802` → IC=+0.254 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2802 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` < `1.4191` → IC=+0.260 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4191 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1798.2686` → IC=+0.250 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1798.2686 (IC base=+0.238)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0744` → IC=+0.200 (n=378)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0744 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=1186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4088` → IC=+0.225 (n=1128)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4088 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.2093` → IC=+0.213 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2093 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.506` → IC=+0.238 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.506 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.2679` → IC=+0.163 (n=1129)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2679 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `1.0753` → IC=+0.169 (n=512)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0753 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.232` → IC=+0.197 (n=249)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4115` → IC=+0.195 (n=365)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.4115 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `15859.8442` → IC=+0.165 (n=512)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 15859.8442 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.156 (n=1237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0057 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0593` → IC=+0.204 (n=414)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5646` → IC=+0.184 (n=1234)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5646 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1334` → IC=+0.161 (n=1214)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1334 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.777` → IC=+0.203 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.777 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2096` → IC=+0.155 (n=1234)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.2096 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1575` → IC=+0.156 (n=376)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1575 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.4266` → IC=+0.144 (n=1123)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.4266 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.7497` → IC=+0.135 (n=748)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.7497 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `215.0` → IC=+0.171 (n=347)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 215.0 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.220 (n=580)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0098 (IC base=+0.198)

- **PATRÓN** `drift_60min` |x|≤ `0.2255` → IC=+0.215 (n=851)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.876` → IC=+0.277 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.876 (IC base=+0.198)

- **PATRÓN** `volumen_pendiente_norm` > `0.1335` → IC=+0.200 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1335 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` < `1.6452` → IC=+0.196 (n=403)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.6452 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `2.8719` → IC=+0.209 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8719 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=895)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.198)

- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.235 (n=1044)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0112 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.0954` → IC=+0.260 (n=348)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2421` → IC=+0.256 (n=919)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2421 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.71` → IC=+0.271 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.71 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` > `0.3581` → IC=+0.268 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3581 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` < `1.6049` → IC=+0.213 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6049 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` > `2.2257` → IC=+0.224 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2257 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `1875.8832` → IC=+0.228 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1875.8832 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.222 (n=329)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.156 (n=1275)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3828` → IC=+0.143 (n=1274)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6268` → IC=+0.170 (n=1274)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6268 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.572` → IC=+0.134 (n=1466)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.572 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.878` → IC=+0.172 (n=449)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.878 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.849` → IC=+0.147 (n=850)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.849 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.203 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.7891` → IC=+0.132 (n=770)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.7891 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4865` → IC=+0.136 (n=385)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.4865 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9930.9704` → IC=+0.162 (n=578)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 9930.9704 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.159 (n=622)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0101 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.141 (n=1403)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 5.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.204 (n=1371)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5169 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.8335` → IC=+0.217 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8335 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.71` → IC=+0.255 (n=308)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.71 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.132 (n=1372)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.2233 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` > `0.639` → IC=+0.123 (n=1371)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.639 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` < `0.1649` → IC=+0.132 (n=1379)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` < 0.1649 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.0711` → IC=+0.123 (n=576)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.0711 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` < `1.4421` → IC=+0.146 (n=442)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.4421 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1437)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `2898.521` → IC=+0.196 (n=622)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2898.521 (IC base=+0.120)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.138 (n=1050)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 50.0 (IC base=+0.120)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.150 (n=609)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0061 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.1029` → IC=+0.153 (n=462)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1029 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1398)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.207 (n=1384)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5625 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.7382` → IC=+0.138 (n=277)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.7382 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.1957` → IC=+0.137 (n=1263)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1957 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.965` → IC=+0.142 (n=224)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 8.965 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.1845` → IC=+0.120 (n=1384)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4306` → IC=+0.128 (n=412)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 2.4306 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3078.551` → IC=+0.157 (n=462)
...
- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.247 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.44 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.1462` → IC=+0.230 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1462 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` < `0.8778` → IC=+0.205 (n=1570)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8778 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.356` → IC=+0.244 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.356 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.632` → IC=+0.216 (n=1352)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.632 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2825` → IC=+0.290 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2825 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` < `2.5723` → IC=+0.194 (n=1211)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.5723 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.199 (n=1211)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4427 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2577.3142` → IC=+0.210 (n=901)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2577.3142 (IC base=+0.204)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.179 (n=596)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0089 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0996` → IC=+0.155 (n=593)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.0996 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.185 (n=896)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.5514` → IC=+0.189 (n=1588)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5514 (IC base=+0.147)
...
- **PATRÓN** `volumen_regimen` < `0.8753` → IC=+0.164 (n=1035)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8753 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `1.2111` → IC=+0.156 (n=518)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5508` → IC=+0.159 (n=570)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5508 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.152 (n=2010)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.02 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `12252.4312` → IC=+0.154 (n=593)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12252.4312 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.167 (n=1555)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 164.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.132 (n=1246)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0057 (IC base=+0.103)

- **PATRÓN** `ibs_20min` < `0.5219` → IC=+0.142 (n=1642)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.5219 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` < `1.458` → IC=+0.134 (n=599)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.458 (IC base=+0.103)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.148 (n=595)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.141 (n=611)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 5.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` < `0.6039` → IC=+0.177 (n=524)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6039 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` < `0.3005` → IC=+0.151 (n=625)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.3005 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.388` → IC=+0.158 (n=232)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.388 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `0.7175` → IC=+0.148 (n=532)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.7175 (IC base=+0.130)

- **PATRÓN** `volumen_pendiente_norm` > `0.1608` → IC=+0.207 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1608 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` < `2.1022` → IC=+0.150 (n=515)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.1022 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` > `1.4203` → IC=+0.141 (n=585)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.4203 (IC base=+0.130)

- **PATRÓN** `ballena_activa_n` < `332.0` → IC=+0.143 (n=497)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 332.0 (IC base=+0.130)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.259 (n=239)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.196)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.205 (n=181)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.221 (n=181)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=566)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `0.7033` → IC=+0.249 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7033 (IC base=+0.196)

- **PATRÓN** `dist_vwap_pct` > `0.3897` → IC=+0.212 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3897 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.052` → IC=+0.228 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.052 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` < `0.8419` → IC=+0.206 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8419 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `1.1584` → IC=+0.216 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1584 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` > `0.2607` → IC=+0.312 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2607 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `1.3913` → IC=+0.240 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3913 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.4105` → IC=+0.233 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4105 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `12322.191` → IC=+0.210 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12322.191 (IC base=+0.196)

- **PATRÓN** `ibs_20min` < `0.0789` → IC=+0.155 (n=169)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.0789 (IC base=+0.082)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `ibs_20min` > `0.5313` → IC=-0.156 (n=123)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5313
  - _Potencial_: sin este filtro IC_bueno=+0.136 (n=372)

- **FILTRO** `dist_vwap_pct` > `0.3309` → IC=-0.149 (n=35)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3309
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=460)
...
- **PATRÓN** `ibs_20min` < `0.5313` → IC=+0.136 (n=372)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.5313 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` < `1.8753` → IC=+0.137 (n=232)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.8753 (IC base=+0.063)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.200 (n=1118)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.977` → IC=+0.312 (n=734)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2447` → IC=+0.201 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2447 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=974)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.259 (n=1274)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.263 (n=1139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.1294` → IC=+0.289 (n=561)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1294 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.269 (n=1145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3505` → IC=+0.290 (n=1121)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3505 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.537` → IC=+0.264 (n=1282)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.537 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2245` → IC=+0.291 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2245 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `2.6339` → IC=+0.283 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6339 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1961.9` → IC=+0.268 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1961.9 (IC base=+0.258)
...
- **PATRÓN** `drift_60min` |x|≤ `0.084` → IC=+0.162 (n=516)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.084 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1614)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3136` → IC=+0.201 (n=1548)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3136 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.34` → IC=+0.195 (n=643)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.34 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.74` → IC=+0.174 (n=354)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 9.74 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.227` → IC=+0.151 (n=1391)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.227 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6288` → IC=+0.178 (n=516)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6288 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.162 (n=1314)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7583` → IC=+0.155 (n=995)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7583 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `15640.9429` → IC=+0.152 (n=702)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 15640.9429 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `476.0` → IC=+0.157 (n=1423)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 476.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.162 (n=1340)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0057 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.3183` → IC=+0.159 (n=1340)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3183 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.175 (n=451)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 18.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` < `0.269` → IC=+0.234 (n=894)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.269 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.6877` → IC=+0.151 (n=230)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.6877 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.165 (n=1199)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1332 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.199` → IC=+0.157 (n=642)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.199 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.161 (n=1340)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1856 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1514` → IC=+0.199 (n=363)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1514 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.4003` → IC=+0.158 (n=1242)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4003 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.0862` → IC=+0.164 (n=564)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.0862 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `423.0` → IC=+0.156 (n=1009)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 423.0 (IC base=+0.149)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.248 (n=522)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=1637)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=1593)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` > `0.6713` → IC=+0.256 (n=1397)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6713 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.81` → IC=+0.295 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.81 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` < `0.2117` → IC=+0.220 (n=1539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2117 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.8459` → IC=+0.246 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8459 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.229 (n=1102)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.232 (n=1293)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 53.0 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.238 (n=1451)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.1647` → IC=+0.241 (n=639)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3617` → IC=+0.268 (n=1278)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3617 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.278 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.748 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.3454` → IC=+0.295 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3454 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` < `1.766` → IC=+0.234 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.766 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.1985` → IC=+0.236 (n=884)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1985 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.244 (n=967)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1874.4798` → IC=+0.248 (n=658)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1874.4798 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.230 (n=1250)
...
- **PATRÓN** `drift_60min` |x|≤ `0.436` → IC=+0.143 (n=1647)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.436 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=1720)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.8769` → IC=+0.260 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8769 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.5706` → IC=+0.173 (n=481)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.5706 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.227` → IC=+0.167 (n=271)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.227 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8769` → IC=+0.156 (n=1098)
...
- **PATRÓN** `ibs_20min` < `0.6955` → IC=+0.184 (n=1348)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6955 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.7963` → IC=+0.141 (n=1560)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.7963 (IC base=+0.137)
...
- **PATRÓN** `volumen_regimen` < `0.6962` → IC=+0.149 (n=594)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6962 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `1.1852` → IC=+0.142 (n=450)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.1852 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2852` → IC=+0.248 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2852 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.443` → IC=+0.151 (n=1276)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.443 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `10927.5954` → IC=+0.206 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10927.5954 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.143 (n=1270)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 179.0 (IC base=+0.137)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.136 (n=1092)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0081 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1679)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.190 (n=1640)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4706 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.0671` → IC=+0.205 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0671 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.447` → IC=+0.233 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.447 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.8906` → IC=+0.136 (n=1091)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8906 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1651)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2912.6118` → IC=+0.250 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2912.6118 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.130 (n=1256)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 54.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.172 (n=537)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0058 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.1314` → IC=+0.160 (n=536)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1314 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.122 (n=1657)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.201 (n=1609)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2176` → IC=+0.127 (n=1297)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.2176 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.451` → IC=+0.122 (n=1555)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 3.451 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.150 (n=707)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.72 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.171 (n=250)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `1.454` → IC=+0.136 (n=482)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.454 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` > `2.5239` → IC=+0.128 (n=482)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 2.5239 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2839.872` → IC=+0.160 (n=536)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2839.872 (IC base=+0.110)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.221 (n=1093)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1711)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.210)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.213 (n=1467)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.251 (n=1641)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.164` → IC=+0.271 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.164 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` < `1.2478` → IC=+0.210 (n=1640)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2478 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.6367` → IC=+0.217 (n=1640)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6367 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.2346` → IC=+0.251 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2346 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.5104` → IC=+0.237 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5104 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.220 (n=1717)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `2616.4926` → IC=+0.224 (n=1093)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2616.4926 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.223 (n=587)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.52` → IC=+0.255 (n=1756)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.52 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.1781` → IC=+0.202 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1781 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.8853` → IC=+0.203 (n=1940)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8853 (IC base=+0.200)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=2928)

- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.158 (n=2472)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.5234` → IC=+0.159 (n=2805)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` < `0.4925` → IC=+0.143 (n=1669)
...
- **PATRÓN** `volumen_regimen` > `0.902` → IC=+0.161 (n=1196)
...
- **PATRÓN** `libro_liquidez` > `3698.7496` → IC=+0.151 (n=1870)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4871` → IC=+0.156 (n=2209)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.6833` → IC=+0.152 (n=432)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6833 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.429` → IC=+0.131 (n=2173)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.429 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.214` → IC=+0.146 (n=2199)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.214 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2459` → IC=+0.143 (n=2106)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=2928)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `6989.8968` → IC=+0.151 (n=1972)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.153 (n=758)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0075 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.161 (n=860)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0044 (IC base=+0.152)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.168 (n=302)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 4.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.5617` → IC=+0.156 (n=573)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.5617 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.8888` → IC=+0.171 (n=287)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.8888 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.9678` → IC=+0.160 (n=201)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.9678 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.4255` → IC=+0.164 (n=789)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4255 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.678` → IC=+0.161 (n=862)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.678 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.7206` → IC=+0.154 (n=768)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7206 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` < `0.111` → IC=+0.155 (n=790)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` < 0.111 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1721` → IC=+0.159 (n=253)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.1721 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5194` → IC=+0.154 (n=752)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5194 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=837)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.157 (n=723)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0084 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.3917` → IC=+0.173 (n=634)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.149 (n=511)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 11.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.7363` → IC=+0.143 (n=721)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.7363 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.1015` → IC=+0.154 (n=720)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.1015 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.6129` → IC=+0.165 (n=168)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.6129 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.384` → IC=+0.144 (n=721)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.266` → IC=+0.143 (n=654)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 4.266 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.0958` → IC=+0.154 (n=634)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.0958 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.7259` → IC=+0.144 (n=644)
...
- **PATRÓN** `libro_liquidez` > `7593.8032` → IC=+0.166 (n=720)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.214 (n=117)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.073 (n=352)

- **FILTRO** `dist_vwap_pct` > `0.1829` → IC=-0.179 (n=26)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.1829
  - _Potencial_: sin este filtro IC_bueno=+0.120 (n=301)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.200 (n=385)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.129 (n=811)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 8.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.6774` → IC=+0.206 (n=699)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0918` → IC=+0.139 (n=590)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.0918 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=630)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2424.4386` → IC=+0.144 (n=344)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2424.4386 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.057` → IC=+0.266 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.057 (IC base=+0.001)

- **PATRÓN** `dist_vwap_pct` < `0.1829` → IC=+0.120 (n=301)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` < 0.1829 (IC base=+0.001)

- **PATRÓN** `volumen_pendiente_norm` > `0.07` → IC=+0.211 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.07 (IC base=+0.001)

- **PATRÓN** `volumen_spike_ratio` < `2.5523` → IC=+0.135 (n=217)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.5523 (IC base=+0.001)

### GBM_LATE_60M#BTC#60min
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.163 (n=298)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.006 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.5273` → IC=+0.188 (n=267)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5273 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1343` → IC=+0.183 (n=143)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1343 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.573` → IC=+0.130 (n=160)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 3.573 (IC base=+0.106)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2771` → IC=+0.149 (n=35)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.2771 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.175 (n=201)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.106)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=275)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.01 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.082` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.082 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` < `0.0677` → IC=+0.122 (n=125)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.0677 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` < `0.5944` → IC=+0.191 (n=40)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.5944 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.0709` → IC=+0.239 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0709 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `2.3732` → IC=+0.167 (n=97)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.3732 (IC base=+0.052)

- **PATRÓN** `libro_liquidez` > `3376.236` → IC=+0.135 (n=72)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 3376.236 (IC base=+0.052)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.179 (n=132)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0039 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.133 (n=281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 7.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.6816` → IC=+0.230 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6816 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3362` → IC=+0.170 (n=110)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3362 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.792` → IC=+0.300 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.792 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` > `0.9516` → IC=+0.145 (n=122)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.9516 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.2877` → IC=+0.243 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2877 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` < `1.7369` → IC=+0.160 (n=145)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.7369 (IC base=+0.104)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=177)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `1767.0561` → IC=+0.189 (n=88)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 1767.0561 (IC base=+0.104)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.124 (n=123)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0061 (IC base=+0.078)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.122 (n=252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 9.0 (IC base=+0.078)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.179 (n=222)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.6744 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` > `0.198` → IC=+0.158 (n=144)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.198 (IC base=+0.078)
...
- **PATRÓN** `volumen_regimen` > `1.0643` → IC=+0.171 (n=83)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0643 (IC base=+0.078)

- **PATRÓN** `volumen_pendiente_norm` > `0.0852` → IC=+0.160 (n=101)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0852 (IC base=+0.078)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.174 (n=44)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0057 (IC base=-0.052)

- **PATRÓN** `ibs_20min` < `0.0714` → IC=+0.271 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0714 (IC base=-0.052)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.202` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.202 (IC base=-0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.1383` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1383 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` < `2.5975` → IC=+0.128 (n=49)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.5975 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` > `1.3803` → IC=+0.147 (n=49)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.3803 (IC base=-0.052)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.007` → IC=+0.133 (n=107)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 6.007 (IC base=+0.036)

- **PATRÓN** `libro_liquidez` > `3787.1326` → IC=+0.147 (n=117)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3787.1326 (IC base=+0.036)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=666)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2903.2529` → IC=+0.173 (n=224)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2903.2529 (IC base=+0.106)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1708)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.121 (n=64)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 14.0 (IC base=+0.041)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=755)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=337)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.198 (n=61)
...
- **PATRÓN** `py_entrada` < `0.47` → IC=+0.163 (n=81)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` < 0.47 (IC base=+0.028)

- **PATRÓN** `profundidad_ratio` > `105.9` → IC=+0.158 (n=77)

  - _Acción_: Kelly boost +0.79€ cuando `profundidad_ratio` > 105.9 (IC base=+0.028)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.140 (n=23)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 12.0 (IC base=+0.081)
...
- **FILTRO** `profundidad_ratio` < `99.1` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `profundidad_ratio` < 99.1
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=6)

### LIQUIDACIONES_DEPTH_FASE0#XRP#15min
- **FILTRO** `restante_min` > `10.52` → IC=-0.222 (n=16)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7398)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.172 (n=3214)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=10354)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.170 (n=3483)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=10546)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.211 (n=586)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1759)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.155 (n=624)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1888)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.203 (n=583)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=1810)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.206 (n=613)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1892)

- **FILTRO** `ibs_20min` > `0.2814` → IC=-0.164 (n=626)
...
- **FILTRO** `py_entrada` < `0.48` → IC=-0.173 (n=557)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1772)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.184 (n=616)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1890)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2711)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2876)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2882)
...
- **FILTRO** `ibs_20min` > `0.1705` → IC=-0.142 (n=118)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=358)
...
- **FILTRO** `py_entrada` < `0.395` → IC=-0.214 (n=68)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=238)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9688)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=21494)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.272 (n=7588)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=23594)

- **FILTRO** `ibs_7min` < `0.2866` → IC=-0.234 (n=7795)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2866
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=23387)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10579)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=20603)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9624)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=29373)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=9721)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=29276)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.305 (n=1225)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3918)

- **FILTRO** `ibs_7min` < `0.7098` → IC=-0.250 (n=1697)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7098
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3446)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.183 (n=1188)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3955)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1659)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=5051)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.125 (n=2276)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=4434)

- **FILTRO** `ibs_7min` > `0.7929` → IC=-0.206 (n=1677)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7929
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=5033)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1265)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4124)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1294)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4095)

- **FILTRO** `ibs_7min` < `0.7495` → IC=-0.190 (n=1347)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7495
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4042)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.170 (n=1344)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4045)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.254 (n=1354)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=4105)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.178 (n=1363)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4096)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.187 (n=1355)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4104)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1394)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3478)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.305 (n=1192)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3680)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.257 (n=1214)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3658)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.216 (n=1141)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3731)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1652)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=5507)

- **FILTRO** `ibs_7min` > `0.753` → IC=-0.177 (n=1789)

  - _Acción_: SKIP cuando `ibs_7min` > 0.753
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=5370)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1521)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3625)

- **FILTRO** `ibs_7min` < `0.742` → IC=-0.180 (n=1285)

  - _Acción_: SKIP cuando `ibs_7min` < 0.742
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3861)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.169 (n=1262)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3884)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.266 (n=1159)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4071)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.174 (n=1307)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3923)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.190 (n=1290)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3940)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=1308)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4144)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.239 (n=1352)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4100)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1783)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5633)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.271 (n=1230)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=3950)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1274)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3906)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1250)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3930)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1702)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=5321)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=904)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=730)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=2825)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.118` → IC=+0.239 (n=1083)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.118 (IC base=-0.037)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1772` → IC=+0.234 (n=1048)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1772 (IC base=-0.037)

- **PATRÓN** `ibs_15` < `0.35` → IC=+0.274 (n=1629)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.35 (IC base=-0.037)

- **PATRÓN** `dist_vwap_pct` > `0.6614` → IC=+0.282 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6614 (IC base=-0.037)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.263 (n=217)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7826` → IC=+0.231 (n=571)
...
- **PATRÓN** `ibs_15` < `0.2696` → IC=+0.278 (n=571)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2696 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.7403` → IC=+0.308 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7403 (IC base=+0.225)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.189` → IC=+0.230 (n=691)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0756` → IC=+0.218 (n=264)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0756 (IC base=-0.043)
...
- **PATRÓN** `dist_vwap_pct` > `0.7377` → IC=+0.212 (n=64)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7377 (IC base=-0.043)

- **PATRÓN** `dist_vwap_pct` < `0.9272` → IC=+0.204 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9272 (IC base=-0.043)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.037 a +0.274 en UPDOWN_GBM_15M_TARDIO (n=1629). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2696 sube el IC de +0.225 a +0.278 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=571). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.043 a +0.258 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=295). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1290 | +0.096 | +180.42€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1290 | +0.096 | +180.42€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 957 | +0.106 | +155.37€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 957 | +0.106 | +155.37€ | 2 | 7 |
...
| ✅ BALLENAS_TARDIAS | 24422 | -0.090 | -3080.65€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1431 | -0.047 | -221.52€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22991 | -0.093 | -2859.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3575 | -0.084 | -573.20€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3575 | -0.084 | -573.20€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7034 | -0.022 | -625.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7034 | -0.022 | -625.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6524 | -0.096 | -430.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6524 | -0.096 | -430.54€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5484 | -0.183 | -1068.84€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5484 | -0.183 | -1068.84€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17189 | -0.029 | +4083.35€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4500 | -0.000 | +1826.30€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12689 | -0.040 | +2257.05€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 17189 | -0.029 | +4083.35€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4500 | -0.000 | +1826.30€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12689 | -0.040 | +2257.05€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 89735 | +0.113 | -4597.66€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13652 | +0.184 | -444.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 359 | -0.093 | -50.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 69841 | +0.100 | -3886.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5883 | +0.108 | -215.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11619 | +0.098 | -999.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 44 | -0.174 | -3.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11560 | +0.100 | -984.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18150 | +0.132 | -371.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4280 | +0.202 | -146.06€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11576 | +0.112 | -176.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2252 | +0.106 | -26.26€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11660 | +0.089 | -1092.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 51 | -0.085 | -5.77€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11594 | +0.090 | -1075.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19114 | +0.123 | -409.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5277 | +0.175 | -82.34€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11697 | +0.105 | -262.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2128 | +0.097 | -56.69€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17556 | +0.114 | -1041.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3955 | +0.188 | -214.32€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 262 | -0.053 | +3.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11836 | +0.091 | -696.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1503 | +0.126 | -133.03€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11636 | +0.101 | -683.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 45 | -0.032 | +7.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11578 | +0.102 | -690.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14244 | +0.192 | -924.72€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14244 | +0.192 | -924.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3406 | +0.168 | -358.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3406 | +0.168 | -358.55€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1128 | +0.196 | -6.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1128 | +0.196 | -6.72€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3349 | +0.182 | -281.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3349 | +0.182 | -281.41€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2994 | +0.238 | -99.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 2994 | +0.238 | -99.67€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3288 | +0.194 | -192.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3288 | +0.194 | -192.12€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 670 | +0.430 | -18.45€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 670 | +0.430 | -18.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 256 | +0.434 | -4.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 256 | +0.434 | -4.38€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH | 253 | +0.437 | -2.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH#15min | 253 | +0.437 | -2.17€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 153 | +0.403 | -10.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 153 | +0.403 | -10.86€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 48947 | +0.198 | -3830.93€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 48947 | +0.198 | -3830.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8482 | +0.176 | -989.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8482 | +0.176 | -989.63€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 7812 | +0.224 | -284.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 7812 | +0.224 | -284.20€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 8449 | +0.173 | -1009.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 8449 | +0.173 | -1009.80€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 7906 | +0.219 | -303.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 7906 | +0.219 | -303.65€ | 1 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8081 | +0.203 | -532.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8081 | +0.203 | -532.24€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8217 | +0.194 | -711.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8217 | +0.194 | -711.41€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 18439 | +0.117 | +133.73€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 18439 | +0.117 | +133.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9153 | +0.122 | +131.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9153 | +0.122 | +131.61€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 9286 | +0.113 | +2.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 9286 | +0.113 | +2.12€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 1430 | +0.291 | -8.79€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 1430 | +0.291 | -8.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 638 | +0.278 | -15.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 638 | +0.278 | -15.49€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0 | 1071 | +0.078 | -36.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#240min | 371 | +0.068 | -24.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#60min | 700 | +0.083 | -12.55€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH | 844 | +0.084 | -13.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#240min | 144 | +0.089 | -1.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60_240MIN_DEPTH_FASE0#ETH#60min | 700 | +0.083 | -12.55€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 33932 | +0.097 | -1076.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 2812 | +0.089 | +16.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 31120 | +0.098 | -1092.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 19098 | +0.101 | -321.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 2812 | +0.089 | +16.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 16286 | +0.103 | -337.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH | 6315 | +0.106 | -54.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#ETH#5min | 6315 | +0.106 | -54.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL | 8519 | +0.080 | -700.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | 8519 | +0.080 | -700.50€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 24482 | +0.081 | +11509.66€ | 0 | 16 |
| ✅ GBM_LATE_15M#15min | 24482 | +0.081 | +11509.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 4080 | +0.193 | +2954.39€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 4080 | +0.193 | +2954.39€ | 0 | 19 |
| ✅ GBM_LATE_15M#BTC | 3628 | +0.176 | +2505.18€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 3628 | +0.176 | +2505.18€ | 0 | 26 |
| ✅ GBM_LATE_15M#DOGE | 4233 | +0.199 | +3175.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 4233 | +0.199 | +3175.23€ | 0 | 21 |
| ✅ GBM_LATE_15M#ETH | 3629 | +0.017 | +727.76€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 3629 | +0.017 | +727.76€ | 1 | 15 |
| ✅ GBM_LATE_15M#SOL | 3532 | -0.033 | +804.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 3532 | -0.033 | +804.74€ | 4 | 15 |
| ✅ GBM_LATE_15M#XRP | 5380 | -0.042 | +1342.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5380 | -0.042 | +1342.36€ | 4 | 15 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 25851 | +0.085 | +13469.84€ | 0 | 18 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 25851 | +0.085 | +13469.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 4898 | +0.016 | +2614.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 4898 | +0.016 | +2614.84€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 5382 | +0.014 | +1093.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 5382 | +0.014 | +1093.38€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 3665 | +0.262 | +3685.31€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 3665 | +0.262 | +3685.31€ | 0 | 20 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 4185 | +0.000 | +767.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 4185 | +0.000 | +767.60€ | 2 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 4215 | +0.027 | +1576.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 4215 | +0.027 | +1576.01€ | 3 | 16 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 3506 | +0.275 | +3732.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 3506 | +0.275 | +3732.69€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 19745 | +0.168 | +14695.92€ | 0 | 25 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 19745 | +0.168 | +14695.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 2973 | +0.206 | +2351.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 2973 | +0.206 | +2351.87€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC | 3149 | +0.148 | +2272.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC#15min | 3149 | +0.148 | +2272.07€ | 0 | 22 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE | 3089 | +0.208 | +2459.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min | 3089 | +0.208 | +2459.84€ | 0 | 19 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH | 3310 | +0.134 | +2296.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#ETH#15min | 3310 | +0.134 | +2296.92€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL | 3673 | +0.116 | +2501.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#SOL#15min | 3673 | +0.116 | +2501.68€ | 0 | 24 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP | 3551 | +0.204 | +2813.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#XRP#15min | 3551 | +0.204 | +2813.53€ | 0 | 27 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 4856 | +0.125 | +1984.50€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 4856 | +0.125 | +1984.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BNB#15min | 184 | +0.118 | +76.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC | 1386 | +0.120 | +607.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#BTC#15min | 1386 | +0.120 | +607.81€ | 0 | 18 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#DOGE#15min | 372 | +0.144 | +178.75€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH | 1397 | +0.141 | +603.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#ETH#15min | 1397 | +0.141 | +603.36€ | 0 | 15 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL | 1013 | +0.097 | +301.71€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#SOL#15min | 1013 | +0.097 | +301.71€ | 2 | 15 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 504 | +0.134 | +216.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 504 | +0.134 | +216.54€ | 0 | 27 |
| ✅ GBM_LATE_15M_TARDIO | 24602 | +0.174 | +18173.36€ | 0 | 22 |
| ✅ GBM_LATE_15M_TARDIO#15min | 24602 | +0.174 | +18173.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 3893 | +0.219 | +3260.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 3893 | +0.219 | +3260.43€ | 0 | 18 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 3849 | +0.149 | +2519.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 3849 | +0.149 | +2519.93€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 4019 | +0.226 | +3465.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 4019 | +0.226 | +3465.24€ | 0 | 21 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 3992 | +0.136 | +2683.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 3992 | +0.136 | +2683.70€ | 0 | 25 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 4322 | +0.111 | +2687.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 4322 | +0.111 | +2687.36€ | 0 | 20 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 4527 | +0.205 | +3556.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 4527 | +0.205 | +3556.70€ | 0 | 24 |
| ✅ GBM_LATE_5M | 6682 | +0.144 | +3724.62€ | 1 | 28 |
| ✅ GBM_LATE_5M#5min | 6682 | +0.144 | +3724.62€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#ETH | 2105 | +0.147 | +1153.48€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 2105 | +0.147 | +1153.48€ | 0 | 32 |
...
| ✅ GBM_LATE_60M | 1633 | +0.069 | +712.05€ | 2 | 13 |
| ✅ GBM_LATE_60M#60min | 1633 | +0.069 | +712.05€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 587 | +0.089 | +250.80€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 587 | +0.089 | +250.80€ | 0 | 14 |
| ✅ GBM_LATE_60M#ETH | 544 | +0.071 | +269.36€ | 0 | 0 |
| ✅ GBM_LATE_60M#ETH#60min | 544 | +0.071 | +269.36€ | 2 | 16 |
| ✅ GBM_LATE_60M#SOL | 502 | +0.044 | +191.89€ | 0 | 0 |
| ✅ GBM_LATE_60M#SOL#60min | 502 | +0.044 | +191.89€ | 1 | 13 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 669 | +0.062 | +124.72€ | 1 | 6 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 669 | +0.062 | +124.72€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 1841 | +0.096 | +490.45€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 1841 | +0.096 | +490.45€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 1841 | +0.096 | +490.45€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 1841 | +0.096 | +490.45€ | 0 | 2 |
...
| ✅ LIQUIDACIONES_5M | 1906 | +0.005 | +12.94€ | 5 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 1906 | +0.005 | +12.94€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB | 102 | +0.019 | -1.05€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#BNB#5min | 102 | +0.019 | -1.05€ | 0 | 1 |
...
| ✅ LIQUIDACIONES_5M#ETH | 802 | +0.027 | +23.40€ | 0 | 0 |
| ✅ LIQUIDACIONES_5M#ETH#5min | 802 | +0.027 | +23.40€ | 5 | 0 |
...
| ✅ LIQUIDACIONES_60M | 1051 | -0.049 | -32.27€ | 6 | 0 |
| ✅ LIQUIDACIONES_60M#60min | 1051 | -0.049 | -32.27€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC | 301 | -0.045 | -13.58€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#BTC#60min | 301 | -0.045 | -13.58€ | 5 | 0 |
| ✅ LIQUIDACIONES_60M#ETH | 349 | -0.038 | -5.65€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#ETH#60min | 349 | -0.038 | -5.65€ | 3 | 0 |
| ✅ LIQUIDACIONES_60M#SOL | 401 | -0.061 | -13.05€ | 0 | 0 |
| ✅ LIQUIDACIONES_60M#SOL#60min | 401 | -0.061 | -13.05€ | 3 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0 | 514 | -0.002 | +27.63€ | 2 | 2 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#15min | 246 | -0.004 | +11.04€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#5min | 268 | +0.000 | +16.59€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB | 15 | -0.022 | -0.58€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB#15min | 9 | +0.061 | +3.41€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BNB#5min | 6 | -0.075 | -3.98€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC | 133 | +0.100 | +38.19€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#15min | 62 | +0.078 | +13.81€ | 0 | 1 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#BTC#5min | 71 | +0.116 | +24.38€ | 0 | 6 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE | 84 | -0.046 | -3.57€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE#15min | 42 | -0.045 | -2.26€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#DOGE#5min | 42 | -0.045 | -1.31€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH | 81 | -0.054 | -5.93€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#15min | 38 | -0.050 | -2.48€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#ETH#5min | 43 | -0.056 | -3.46€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL | 79 | +0.056 | +12.34€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#15min | 43 | +0.033 | +5.81€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#SOL#5min | 36 | +0.079 | +6.53€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP | 122 | -0.081 | -12.82€ | 0 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#15min | 52 | -0.093 | -7.26€ | 1 | 0 |
| ✅ LIQUIDACIONES_DEPTH_FASE0#XRP#5min | 70 | -0.069 | -5.57€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M | 14262 | -0.012 | -207.12€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M#15min | 14262 | -0.012 | -207.12€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB | 578 | -0.010 | -0.50€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BNB#15min | 578 | -0.010 | -0.50€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC | 2979 | -0.021 | -60.31€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M#BTC#15min | 2979 | -0.021 | -60.31€ | 2 | 0 |
...
| ✅ MOMENTUM_IBS_15M_BALLENA | 27597 | -0.008 | +1206.55€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#15min | 27597 | -0.008 | +1206.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB | 4857 | +0.016 | +594.69€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BNB#15min | 4857 | +0.016 | +594.69€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC | 4303 | -0.029 | -57.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#BTC#15min | 4303 | -0.029 | -57.11€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE | 4898 | +0.013 | +430.34€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#DOGE#15min | 4898 | +0.013 | +430.34€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH | 4084 | -0.052 | -141.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#ETH#15min | 4084 | -0.052 | -141.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL | 4620 | -0.011 | +181.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#SOL#15min | 4620 | -0.011 | +181.36€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP | 4835 | +0.006 | +198.32€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_BALLENA#XRP#15min | 4835 | +0.006 | +198.32€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE | 5688 | -0.056 | -130.76€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#15min | 5688 | -0.056 | -130.76€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB | 1203 | +0.000 | -15.55€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BNB#15min | 1203 | +0.000 | -15.55€ | 1 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC | 1351 | -0.075 | -29.89€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#BTC#15min | 1351 | -0.075 | -29.89€ | 2 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE | 43 | -0.122 | -5.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#DOGE#15min | 43 | -0.122 | -5.42€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH | 598 | -0.120 | -22.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#ETH#15min | 598 | -0.120 | -22.44€ | 3 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL | 1646 | -0.076 | -31.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_15M_FADE#SOL#15min | 1646 | -0.076 | -31.75€ | 1 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 70179 | -0.073 | +1698.83€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 70179 | -0.073 | +1698.83€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 11853 | -0.079 | +682.51€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 11853 | -0.079 | +682.51€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 10848 | -0.093 | -476.81€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 10848 | -0.093 | -476.81€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 12031 | -0.068 | +671.45€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 12031 | -0.068 | +671.45€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 10376 | -0.093 | -145.75€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 10376 | -0.093 | -145.75€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 12868 | -0.048 | +378.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 12868 | -0.048 | +378.06€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 12203 | -0.063 | +589.37€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 12203 | -0.063 | +589.37€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 7286 | -0.023 | -107.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 7286 | -0.023 | -107.03€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 1880 | -0.016 | -13.63€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 1880 | -0.016 | -13.63€ | 1 | 0 |
...
| ✅ ORDER_FLOW_5M | 1096 | +0.108 | +371.10€ | 0 | 3 |
| ✅ ORDER_FLOW_5M#5min | 960 | +0.115 | +358.51€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M_REACTIVO | 430 | -0.058 | -48.49€ | 0 | 0 |
| ✅ ORDER_FLOW_5M_REACTIVO#5min | 430 | -0.058 | -48.49€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 2701 | -0.022 | -111.56€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 2701 | -0.022 | -111.56€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 1176 | -0.021 | -46.36€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 1176 | -0.021 | -46.36€ | 3 | 0 |
...
| ✅ STREAK_MOM_5M | 7566 | +0.022 | +105.09€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 7566 | +0.022 | +105.09€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 2127 | +0.020 | +19.86€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 2127 | +0.020 | +19.86€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 1680 | +0.035 | +50.88€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 1680 | +0.035 | +50.88€ | 1 | 0 |
| ✅ STREAK_MOM_5M#SOL | 2299 | +0.010 | -0.77€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 2299 | +0.010 | -0.77€ | 1 | 0 |
| ✅ STREAK_MOM_5M#XRP | 1460 | +0.028 | +35.12€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 1460 | +0.028 | +35.12€ | 2 | 0 |
| ✅ STRUCT_NO_15M | 7095 | +0.010 | -53.11€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 7095 | +0.010 | -53.11€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 2844 | +0.014 | -13.91€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 2844 | +0.014 | -13.91€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 2778 | +0.011 | -19.24€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 2778 | +0.011 | -19.24€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 1473 | +0.002 | -19.96€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 1473 | +0.002 | -19.96€ | 2 | 0 |
| ✅ UPDOWN_GBM | 35065 | +0.030 | +2067.72€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 9450 | +0.065 | +1668.32€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 1299 | +0.004 | +5.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 22054 | +0.020 | +370.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 2129 | +0.008 | +23.09€ | 1 | 0 |
| ✅ UPDOWN_GBM#BNB | 3495 | +0.067 | +369.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 579 | +0.147 | +223.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 29 | -0.016 | -0.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 2887 | +0.052 | +146.12€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 6501 | +0.035 | +432.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 1199 | +0.081 | +259.28€ | 0 | 10 |
| ✅ UPDOWN_GBM#BTC#240min | 354 | +0.020 | +7.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 3941 | +0.032 | +148.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 956 | +0.004 | +16.64€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 51 | -0.104 | +0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 4088 | +0.039 | +236.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 541 | +0.139 | +193.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 25 | -0.018 | -1.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3522 | +0.024 | +44.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 7470 | +0.017 | +279.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2455 | +0.045 | +267.84€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 342 | +0.006 | +7.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3903 | +0.005 | +2.05€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 727 | +0.006 | -1.48€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 43 | -0.144 | +3.56€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8432 | +0.016 | +222.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2339 | +0.025 | +161.32€ | 0 | 11 |
| ✅ UPDOWN_GBM#SOL#240min | 336 | -0.006 | -3.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5274 | +0.015 | +59.38€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 446 | +0.020 | +7.93€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 37 | -0.167 | -2.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 5077 | +0.035 | +529.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2337 | +0.079 | +562.90€ | 0 | 11 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11380 | -0.042 | +2325.11€ | 2 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11380 | -0.042 | +2325.11€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1254 | +0.201 | +720.68€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1254 | +0.201 | +720.68€ | 2 | 22 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3480 | -0.064 | +530.66€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3480 | -0.064 | +530.66€ | 3 | 6 |
...
| ✅ UPDOWN_OU_5M | 708 | -0.107 | -79.81€ | 4 | 0 |
| ✅ UPDOWN_OU_5M#5min | 708 | -0.107 | -79.81€ | 0 | 0 |
...
| 🚫 UPDOWN_OU_5M#SOL | 62 | -0.203 | -9.17€ | 0 | 0 |
| 🚫 UPDOWN_OU_5M#SOL#5min | 62 | -0.203 | -9.17€ | 2 | 0 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 521 celda(s) pasan gate riguroso completo de 2193 evaluadas (n>=40) y 3186 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.025 < 0.08 — monitorear
  - _Datos_: n=2339 IC=+0.025 PNL=+161.32€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.095 n=277/60 | contraria IC=+0.149 n=274 | gap=-0.054 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=727/40 IC=+0.006 PNL=-1.48€ | BTC#60min: n=956/40 IC=+0.004 PNL=+16.64€ | SOL#60min: n=446/40 IC=+0.020 PNL=+7.93€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.051 n=321492 | tras_1loss IC=+0.077 n=250311 | tras_2loss IC=+0.046 n=105852/40 | gap=+0.005 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1519 IC=+0.016 PNL=+14.46€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1519 IC=+0.016 PNL=+14.46€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=610 IC=-0.011 PNL=+8.63€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=610 IC=-0.011 PNL=+8.63€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.186 > 0.1 con n=2020 PNL=+1262.68€
  - _Datos_: n=2020 IC=+0.186 PNL=+1262.68€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1199 IC=+0.081 PNL=+259.28€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1199 IC=+0.081 PNL=+259.28€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.02 con n=627 PNL=+246.21€
  - _Datos_: n=627 IC=+0.125 PNL=+246.21€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=12172 IC=+0.056 PNL=+1506.60€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=12172 IC=+0.056 PNL=+1506.60€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1798 IC=+0.046 PNL=+184.91€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1798 IC=+0.046 PNL=+184.91€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=17070 IC=-0.136 PNL=+1217.45€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=17070 IC=-0.136 PNL=+1217.45€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1850 IC=+0.138 PNL=+1000.77€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1850 IC=+0.138 PNL=+1000.77€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.239 < -0.1 con n=1673 PNL=-191.88€
  - _Datos_: n=1673 IC=-0.239 PNL=-191.88€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.086 n=945) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=945 IC=+0.086 PNL=+208.91€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8481 IC=+0.176 PNL=-990.02€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8481 IC=+0.176 PNL=-990.02€
