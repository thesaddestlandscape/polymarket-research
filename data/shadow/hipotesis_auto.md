# Hipótesis automáticas — 2026-07-27 19:39 UTC
_Generado por shadow_postmortem.py sobre 38854 resoluciones (PNL=+7912.40€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.198 (n=2260)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.192 (n=2757)
...
### GBM_LATE_15M
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.133 (n=2318)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.468` → IC=+0.158 (n=328)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.468 (IC base=+0.099)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6075` → IC=+0.175 (n=631)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.225` → IC=+0.157 (n=208)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6075 sube el IC de +0.056 a +0.175 en UPDOWN_GBM#15min (n=631). Ya aplicado como kelly_boost=+0.87€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ FAVORITO_CONFIRMADO | 6826 | +0.179 | -24.04€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4499 | +0.203 | -21.88€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 8359 | +0.094 | +2505.49€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8359 | +0.094 | +2505.49€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 5582 | +0.065 | +1453.09€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5582 | +0.065 | +1453.09€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2858 | +0.034 | +251.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2595 | +0.050 | +289.61€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2120 | +0.150 | +925.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2120 | +0.150 | +925.82€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.166: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.074 n=1600 | neutral: IC=+0.019 n=1294 | overbought(IBS>0.7): IC=+0.185 n=1609
  - _Datos_: n=4800 IC=+0.102 PNL=+1243.68€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.111 n=23093 | tras_1loss IC=+0.077 n=15552 | tras_2loss IC=+0.050 n=6543/40 | gap=+0.061 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.090 n=1711/40 PNL=+332.83€ | H=15h UTC: IC=+0.116 n=1664/40 PNL=+517.02€ | H=17h UTC: IC=+0.086 n=1613/40 PNL=+272.07€ | H=19h UTC: IC=+0.142 n=1531/40 PNL=+455.19€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=309 IC=+0.002 PNL=-3.26€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=309 IC=+0.002 PNL=-3.26€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2721 IC=+0.038 PNL=+264.90€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2721 IC=+0.038 PNL=+264.90€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1116 IC=+0.056 PNL=+149.24€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1116 IC=+0.056 PNL=+149.24€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.088 > 0.08 con n=1383 PNL=+231.92€
  - _Datos_: n=1383 IC=+0.088 PNL=+231.92€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=2573 IC=+0.051 PNL=+255.89€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=2573 IC=+0.051 PNL=+255.89€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=420 IC=+0.014 PNL=+10.48€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=420 IC=+0.014 PNL=+10.48€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1266 IC=+0.031 PNL=+118.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1266 IC=+0.031 PNL=+118.69€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.159 > 0.1 con n=999 PNL=+334.50€
  - _Datos_: n=999 IC=+0.159 PNL=+334.50€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.122 > 0.08 con n=712 PNL=+195.49€
  - _Datos_: n=712 IC=+0.122 PNL=+195.49€
