# Hipótesis automáticas — 2026-07-02 01:05 UTC
_Generado por shadow_postmortem.py sobre 2505 resoluciones (PNL=-69.10€)_
...
- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.276 (n=56)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0097 (IC base=+0.108)

- **PATRÓN** `drift_60min` |x|≤ `0.7816` → IC=+0.140 (n=98)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.7816 (IC base=+0.108)

- **PATRÓN** `drift_15min` |x|≤ `0.7516` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `drift_15min` |x|≤ 0.7516 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.108)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.134 (n=39)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 11.0 (IC base=+0.108)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.222 (n=34)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0613 (IC base=+0.108)
...
- **FILTRO** `drift_15min` |x|> `0.5685` → IC=-0.132 (n=17)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0613 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.222 n=34). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ ORDER_FLOW_5M | 1502 | +0.013 | +10.74€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1366 | +0.008 | -1.85€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 286 | +0.038 | +8.78€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 286 | +0.038 | +8.78€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 753 | -0.027 | -17.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 534 | +0.000 | +7.47€ | 1 | 6 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 116 | -0.051 | -9.39€ | 4 | 0 |
| ✅ UPDOWN_GBM#BNB | 18 | -0.045 | -1.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 18 | -0.045 | -1.30€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#DOGE | 17 | -0.067 | -2.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 14 | -0.044 | -1.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 301 | -0.005 | +8.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 219 | +0.011 | +13.64€ | 5 | 6 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 19 | -0.204 | -7.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 52 | +0.000 | -1.54€ | 3 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 6 | +0.037 | +4.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 130 | -0.068 | -5.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 78 | -0.037 | -1.02€ | 5 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 23 | -0.060 | -3.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 23 | -0.140 | -2.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 61 | +0.024 | +8.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 50 | +0.077 | +12.17€ | 1 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.071) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.041 n=109 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=363 IC=-0.012 PNL=+7.30€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=78 IC=-0.037 PNL=-1.02€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.003 n=1187 | tras_1loss IC=-0.033 n=1236 | tras_2loss IC=-0.047 n=643/40 | gap=+0.050 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=22, boost estimado=+0.004. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=52/40 IC=+0.000 PNL=-1.54€ | BTC#60min: n=41/40 IC=-0.058 PNL=-5.65€ | SOL#60min: n=23/40 IC=-0.140 PNL=-2.19€
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=44 IC=+0.022 PNL=+0.86€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=44 IC=+0.022 PNL=+0.86€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=630 IC=-0.019 PNL=-4.39€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=630 IC=-0.019 PNL=-4.39€
...
**⏳ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  ...
  - _Estado_: 27/30 ops en el filtro definido (IC actual=-0.017 PNL=-1.79€)
  - _Datos_: n=27 IC=-0.017 PNL=-1.79€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=151 IC=+0.082 PNL=+35.33€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=151 IC=+0.082 PNL=+35.33€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 88/200 ops en el filtro definido (IC actual=+0.111 PNL=+23.82€)
  - _Datos_: n=88 IC=+0.111 PNL=+23.82€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 88/100 ops en el filtro definido (IC actual=+0.111 PNL=+23.82€)
  - _Datos_: n=88 IC=+0.111 PNL=+23.82€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 9/40 ops en el filtro definido (IC actual=+0.061 PNL=+2.60€)
  - _Datos_: n=9 IC=+0.061 PNL=+2.60€
