# Hipótesis automáticas — 2026-09-06 03:00 UTC
_Generado por shadow_postmortem.py sobre 304265 resoluciones (PNL=+29712.66€)_

## Patrones causales activos

### BALLENAS_CONFIRMADAS_15M
- **FILTRO** `py_entrada` < `0.705` → IC=-0.135 (n=146)
...
- **PATRÓN** `banda_hit_calibrado` > `0.6167` → IC=+0.236 (n=354)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.6167 (IC base=+0.143)

- **PATRÓN** `banda_z` > `11.552` → IC=+0.275 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.552 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.172 (n=242)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 11.0 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=368)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `3111.6433` → IC=+0.181 (n=161)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 3111.6433 (IC base=+0.143)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.127 (n=333)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` < 0.5 (IC base=+0.024)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.268 (n=257)
...
- **PATRÓN** `banda_hit_calibrado` > `0.6177` → IC=+0.260 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.6177 (IC base=+0.168)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.183 (n=288)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2945.0699` → IC=+0.176 (n=171)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2945.0699 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.465` → IC=+0.154 (n=76)

  - _Acción_: Kelly boost +0.77€ cuando `py_entrada` < 0.465 (IC base=+0.014)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.7` → IC=-0.299 (n=4051)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.7
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=12158)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `133.74` → IC=-0.324 (n=550)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.74
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1652)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` > `629.69` → IC=-0.164 (n=340)
...
- **FILTRO** `restante_s_al_confirmar` < `118.98` → IC=-0.397 (n=533)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 118.98
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=1602)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `157.1` → IC=-0.159 (n=1072)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.1
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3224)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `145.71` → IC=-0.313 (n=907)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.71
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=2722)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.149 (n=7185)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 7.0 (IC base=+0.138)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.253 (n=5358)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.179 (n=4166)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `1938.0591` → IC=+0.172 (n=3569)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1938.0591 (IC base=+0.138)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.204 (n=953)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.62` → IC=+0.176 (n=223)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.139 (n=1484)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 15.0 (IC base=+0.134)

- **PATRÓN** `py_entrada` > `0.69` → IC=+0.310 (n=594)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.251 (n=785)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1921.3104` → IC=+0.266 (n=751)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1921.3104 (IC base=+0.251)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.145 (n=364)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 15.0 (IC base=+0.134)

- **PATRÓN** `py_entrada` > `0.66` → IC=+0.259 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.66 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.145 (n=488)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `1762.6746` → IC=+0.152 (n=363)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1762.6746 (IC base=+0.134)
...
- **PATRÓN** `py_entrada` > `0.84` → IC=+0.424 (n=435)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.196 (n=853)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `939.5107` → IC=+0.196 (n=834)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.199 (n=5628)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 15.0 (IC base=+0.192)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.205 (n=3206)
...
- **PATRÓN** `libro_liquidez` > `6228.1216` → IC=+0.331 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6228.1216 (IC base=+0.192)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.182 (n=1447)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.421 (n=36)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.306)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.336 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.306)

- **PATRÓN** `libro_liquidez` > `5642.183` → IC=+0.325 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5642.183 (IC base=+0.306)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.238 (n=1278)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.191 (n=1386)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.187 (n=701)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.210 (n=19250)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.157 (n=2659)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 12.0 (IC base=+0.154)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.178 (n=3353)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.227 (n=1236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.225)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.276 (n=1493)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.168 (n=2562)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 12.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.185 (n=3349)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.228 (n=1258)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.241 (n=1630)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.132 (n=1902)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 8.0 (IC base=+0.123)

- **PATRÓN** `lag_apertura_s` < `3.28` → IC=+0.165 (n=1288)
...
- **PATRÓN** `libro_liquidez` > `1729.4046` → IC=+0.296 (n=753)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.281 (n=126)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1707.6334` → IC=+0.319 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1707.6334 (IC base=+0.296)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.429 (n=295)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.429 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.427)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.429 (n=181)
...
- **PATRÓN** `py_entrada` > `0.865` → IC=+0.407 (n=149)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.865 (IC base=+0.256)
...
- **PATRÓN** `libro_liquidez` > `1063.7596` → IC=+0.269 (n=396)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1063.7596 (IC base=+0.256)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9514` → IC=+0.212 (n=1360)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9514 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` < `0.4516` → IC=+0.228 (n=869)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4516 (IC base=+0.088)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.715` → IC=+0.157 (n=1560)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 5.715 (IC base=+0.088)

- **PATRÓN** `volumen_regimen` < `0.6277` → IC=+0.234 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6277 (IC base=+0.088)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.241 (n=427)
...
- **PATRÓN** `volumen_spike_ratio` < `2.8743` → IC=+0.182 (n=2496)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.8743 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` > `1.4721` → IC=+0.180 (n=2496)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4721 (IC base=+0.088)

- **PATRÓN** `ibs_20min` < `0.4016` → IC=+0.126 (n=3871)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.4016 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.1312` → IC=+0.145 (n=1273)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1312 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.8548` → IC=+0.145 (n=933)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8548 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `1.0473` → IC=+0.142 (n=635)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.0473 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.3022` → IC=+0.234 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3022 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` > `2.8107` → IC=+0.204 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8107 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.214 (n=872)
...
- **PATRÓN** `volumen_spike_ratio` > `1.442` → IC=+0.153 (n=817)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.442 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=775)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.189 (n=497)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 57.0 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.245 (n=425)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.240)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.254 (n=567)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.240)

- **PATRÓN** `drift_60min` |x|≤ `0.1827` → IC=+0.288 (n=423)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.253 (n=667)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.240)

- **PATRÓN** `ibs_20min` < `0.4088` → IC=+0.273 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4088 (IC base=+0.240)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.548` → IC=+0.241 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.548 (IC base=+0.240)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.37` → IC=+0.259 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.37 (IC base=+0.240)

- **PATRÓN** `volumen_pendiente_norm` < `0.0691` → IC=+0.237 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0691 (IC base=+0.240)

- **PATRÓN** `volumen_pendiente_norm` > `0.2889` → IC=+0.342 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2889 (IC base=+0.240)

- **PATRÓN** `volumen_spike_ratio` > `2.8634` → IC=+0.295 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8634 (IC base=+0.240)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.264 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.240)

- **PATRÓN** `libro_liquidez` > `1718.9242` → IC=+0.257 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1718.9242 (IC base=+0.240)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.239 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.240)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.253 (n=237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2002` → IC=+0.234 (n=471)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2002 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.232 (n=711)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.214)

- **PATRÓN** `ibs_20min` > `0.3717` → IC=+0.226 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3717 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` > `0.8223` → IC=+0.221 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8223 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `0.4456` → IC=+0.217 (n=648)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4456 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.225` → IC=+0.227 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.225 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` < `1.2518` → IC=+0.219 (n=706)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0983` → IC=+0.216 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0983 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` < `1.4783` → IC=+0.245 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4783 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `11817.8916` → IC=+0.242 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11817.8916 (IC base=+0.214)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.152 (n=763)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.006 (IC base=+0.144)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.149 (n=682)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0029 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.0782` → IC=+0.163 (n=256)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.147 (n=542)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 12.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` < `0.6614` → IC=+0.171 (n=763)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6614 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.1347` → IC=+0.170 (n=649)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1347 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7274` → IC=+0.165 (n=437)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.7274 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.4049` → IC=+0.160 (n=654)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.4049 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `12567.3384` → IC=+0.151 (n=508)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.205 (n=422)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.358` → IC=+0.271 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.358 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` < `0.104` → IC=+0.164 (n=719)
...
- **PATRÓN** `volumen_spike_ratio` < `3.7458` → IC=+0.161 (n=785)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 3.7458 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8863` → IC=+0.181 (n=701)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.8863 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=926)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.194 (n=556)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 48.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.229 (n=722)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.220)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.222 (n=645)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.228 (n=332)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_spike_ratio` > `2.3975` → IC=+0.211 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3975 (IC base=+0.220)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.234 (n=366)
...
- **PATRÓN** `dist_vwap_pct` > `0.1427` → IC=+0.148 (n=89)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.1427 (IC base=-0.039)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8133` → IC=+0.141 (n=157)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8133 (IC base=-0.039)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.399` → IC=-0.185 (n=214)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1664)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1129` → IC=+0.145 (n=29)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.1129 (IC base=-0.061)

- **PATRÓN** `volumen_spike_ratio` < `1.524` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.524 (IC base=-0.061)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.5036` → IC=-0.162 (n=385)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5036
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=750)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.183 (n=165)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=970)

- **FILTRO** `ibs_20min` > `0.7902` → IC=-0.192 (n=449)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7902
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1350)

- **FILTRO** `sigma_ewma_delta_pct` > `8.935` → IC=-0.133 (n=205)
...
- **PATRÓN** `dist_vwap_pct` > `0.1546` → IC=+0.198 (n=94)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1546 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` < `0.2317` → IC=+0.208 (n=265)
...
- **PATRÓN** `volumen_spike_ratio` < `2.313` → IC=+0.205 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.313 (IC base=-0.046)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.195 (n=103)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 22.0 (IC base=-0.046)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.164 (n=2291)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0078 (IC base=+0.080)

- **PATRÓN** `ibs_20min` > `0.3125` → IC=+0.150 (n=5048)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.3125 (IC base=+0.080)

- **PATRÓN** `dist_vwap_pct` > `1.1688` → IC=+0.292 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1688 (IC base=+0.080)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.481` → IC=+0.124 (n=2673)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 2.481 (IC base=+0.080)

- **PATRÓN** `volumen_regimen` > `0.68` → IC=+0.224 (n=1482)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.68 (IC base=+0.080)

- **PATRÓN** `volumen_pendiente_norm` < `0.1142` → IC=+0.219 (n=2464)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1142 (IC base=+0.080)

- **PATRÓN** `volumen_pendiente_norm` > `0.2513` → IC=+0.249 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2513 (IC base=+0.080)

- **PATRÓN** `volumen_spike_ratio` < `1.4881` → IC=+0.234 (n=855)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4881 (IC base=+0.080)

- **PATRÓN** `volumen_spike_ratio` > `2.8078` → IC=+0.226 (n=855)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8078 (IC base=+0.080)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.293 (n=2023)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.080)

- **PATRÓN** `ibs_20min` < `0.5834` → IC=+0.128 (n=4821)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.5834 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.7601` → IC=+0.247 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7601 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` < `0.2221` → IC=+0.219 (n=1174)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2221 (IC base=+0.051)

- **PATRÓN** `volumen_regimen` < `0.7061` → IC=+0.220 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7061 (IC base=+0.051)

- **PATRÓN** `volumen_regimen` > `1.221` → IC=+0.240 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.221 (IC base=+0.051)

- **PATRÓN** `volumen_pendiente_norm` > `0.2584` → IC=+0.334 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2584 (IC base=+0.051)

- **PATRÓN** `volumen_spike_ratio` > `2.8423` → IC=+0.259 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8423 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.253 (n=1345)
...
- **FILTRO** `ibs_20min` < `0.3333` → IC=-0.140 (n=423)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=862)

- **FILTRO** `sigma_ewma_delta_pct` > `2.488` → IC=-0.162 (n=380)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.488
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=833)

- **PATRÓN** `ibs_20min` > `0.8457` → IC=+0.250 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8457 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.776` → IC=+0.161 (n=343)
...
- **FILTRO** `ibs_20min` > `0.8608` → IC=-0.156 (n=411)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1239)

- **PATRÓN** `volumen_spike_ratio` < `1.7086` → IC=+0.136 (n=256)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.7086 (IC base=-0.008)

- **PATRÓN** `ballena_activa_n` < `290.0` → IC=+0.142 (n=163)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 290.0 (IC base=-0.008)

- **PATRÓN** `dist_vwap_pct` < `0.1366` → IC=+0.186 (n=205)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1366 (IC base=-0.020)

- **PATRÓN** `volumen_regimen` < `0.5824` → IC=+0.190 (n=69)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.5824 (IC base=-0.020)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2573` → IC=+0.289 (n=17)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2573 (IC base=-0.020)

- **PATRÓN** `volumen_spike_ratio` < `1.7423` → IC=+0.221 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7423 (IC base=-0.020)

- **PATRÓN** `volumen_spike_ratio` > `1.4236` → IC=+0.183 (n=162)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4236 (IC base=-0.020)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.290 (n=369)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.231)

- **PATRÓN** `drift_60min` |x|≤ `0.0852` → IC=+0.237 (n=272)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0852 (IC base=+0.231)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.259 (n=392)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.231)

- **PATRÓN** `ibs_20min` > `0.7143` → IC=+0.260 (n=727)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7143 (IC base=+0.231)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.365` → IC=+0.296 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.365 (IC base=+0.231)

- **PATRÓN** `volumen_pendiente_norm` < `0.1093` → IC=+0.241 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1093 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` < `2.3922` → IC=+0.234 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.3922 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` > `1.7205` → IC=+0.236 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7205 (IC base=+0.231)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.258 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.231)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.310 (n=535)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.301 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.287)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.516` → IC=+0.317 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.516 (IC base=+0.287)

- **PATRÓN** `volumen_pendiente_norm` > `0.35` → IC=+0.331 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.35 (IC base=+0.287)

- **PATRÓN** `volumen_spike_ratio` > `2.3399` → IC=+0.296 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3399 (IC base=+0.287)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.300 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.287)

- **PATRÓN** `libro_liquidez` > `1847.3847` → IC=+0.291 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1847.3847 (IC base=+0.287)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.142 (n=252)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=577)

- **FILTRO** `ibs_20min` < `0.5834` → IC=-0.161 (n=414)

  - _Acción_: SKIP cuando `ibs_20min` < 0.5834
  - _Potencial_: sin este filtro IC_bueno=+0.066 (n=415)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.140 (n=84)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1199)
...
- **FILTRO** `ibs_20min` < `0.6` → IC=-0.197 (n=549)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.228 (n=550)

- **FILTRO** `ibs_20min` > `0.75` → IC=-0.233 (n=305)

  - _Acción_: SKIP cuando `ibs_20min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=928)

- **FILTRO** `sigma_ewma_delta_pct` > `4.657` → IC=-0.144 (n=307)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.657
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=926)

- **PATRÓN** `ibs_20min` > `0.6` → IC=+0.228 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6 (IC base=+0.016)

- **PATRÓN** `dist_vwap_pct` > `0.2084` → IC=+0.303 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2084 (IC base=+0.016)

- **PATRÓN** `volumen_regimen` < `0.8684` → IC=+0.269 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8684 (IC base=+0.016)

- **PATRÓN** `volumen_regimen` > `1.1665` → IC=+0.283 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1665 (IC base=+0.016)

- **PATRÓN** `volumen_pendiente_norm` < `0.1143` → IC=+0.264 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1143 (IC base=+0.016)

- **PATRÓN** `volumen_pendiente_norm` > `0.274` → IC=+0.292 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.274 (IC base=+0.016)

- **PATRÓN** `volumen_spike_ratio` < `1.4432` → IC=+0.309 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4432 (IC base=+0.016)

- **PATRÓN** `volumen_spike_ratio` > `2.3572` → IC=+0.274 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3572 (IC base=+0.016)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.312 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.016)

- **PATRÓN** `volumen_regimen` < `1.0698` → IC=+0.141 (n=126)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.0698 (IC base=-0.026)

- **PATRÓN** `volumen_pendiente_norm` > `0.2394` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2394 (IC base=-0.026)

- **PATRÓN** `volumen_spike_ratio` < `1.6907` → IC=+0.141 (n=51)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.6907 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.173 (n=108)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 61.0 (IC base=-0.026)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0138` → IC=+0.336 (n=527)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0138 (IC base=+0.257)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.265 (n=376)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.257)

- **PATRÓN** `ibs_20min` > `0.898` → IC=+0.328 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.898 (IC base=+0.257)

- **PATRÓN** `dist_vwap_pct` > `0.1699` → IC=+0.315 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1699 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.192` → IC=+0.289 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.192 (IC base=+0.257)

- **PATRÓN** `volumen_regimen` > `0.839` → IC=+0.296 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.839 (IC base=+0.257)

- **PATRÓN** `volumen_pendiente_norm` > `0.2403` → IC=+0.291 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2403 (IC base=+0.257)

- **PATRÓN** `volumen_spike_ratio` < `2.5657` → IC=+0.265 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5657 (IC base=+0.257)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3089` → IC=+0.273 (n=566)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.381` → IC=+0.311 (n=848)
...
- **PATRÓN** `dist_vwap_pct` < `0.2763` → IC=+0.273 (n=798)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5859` → IC=+0.262 (n=691)
...
- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.205 (n=1413)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0105 (IC base=+0.164)

- **PATRÓN** `drift_60min` |x|≤ `0.3392` → IC=+0.171 (n=3731)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4418` → IC=+0.221 (n=3928)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4418 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2202` → IC=+0.164 (n=2918)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2202 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.086` → IC=+0.206 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.086 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1725` → IC=+0.161 (n=2935)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1725 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6234` → IC=+0.154 (n=2935)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6234 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2931` → IC=+0.242 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2931 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.6551` → IC=+0.191 (n=1100)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.6551 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.165 (n=2891)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.255 (n=411)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.1701` → IC=+0.308 (n=306)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1701 (IC base=+0.228)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.248 (n=478)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.228)

- **PATRÓN** `ibs_20min` < `0.2702` → IC=+0.259 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2702 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.771` → IC=+0.242 (n=499)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.771 (IC base=+0.228)

- **PATRÓN** `volumen_pendiente_norm` < `0.0675` → IC=+0.220 (n=337)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2935` → IC=+0.306 (n=60)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2935 (IC base=+0.228)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7667` → IC=+0.250 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7667 (IC base=+0.228)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.258 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.228)

- **PATRÓN** `libro_liquidez` > `1701.1448` → IC=+0.257 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1701.1448 (IC base=+0.228)

- **PATRÓN** `ballena_activa_n` < `75.0` → IC=+0.219 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 75.0 (IC base=+0.228)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.235 (n=209)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.2872` → IC=+0.168 (n=546)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4579` → IC=+0.209 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4579 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.2609` → IC=+0.225 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2609 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.787` → IC=+0.240 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.787 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `0.713` → IC=+0.176 (n=273)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.713 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `1.0799` → IC=+0.175 (n=281)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0799 (IC base=+0.163)
...
- **PATRÓN** `volumen_spike_ratio` < `1.394` → IC=+0.203 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.394 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `11188.0133` → IC=+0.191 (n=554)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11188.0133 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.181 (n=706)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.006 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.0594` → IC=+0.210 (n=236)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0594 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.178 (n=648)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 7.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` < `0.49` → IC=+0.194 (n=706)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.49 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.3175` → IC=+0.170 (n=756)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3175 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.3` → IC=+0.240 (n=148)
...
- **PATRÓN** `volumen_spike_ratio` > `1.3973` → IC=+0.165 (n=598)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.3973 (IC base=+0.156)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.157 (n=912)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.212 (n=224)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.179)

- **PATRÓN** `drift_60min` |x|≤ `0.0944` → IC=+0.205 (n=296)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0944 (IC base=+0.179)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.189 (n=226)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 17.0 (IC base=+0.179)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.194 (n=308)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.437` → IC=+0.296 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.437 (IC base=+0.179)

- **PATRÓN** `volumen_pendiente_norm` > `0.1325` → IC=+0.193 (n=255)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1325 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` > `1.896` → IC=+0.179 (n=543)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.896 (IC base=+0.179)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=701)
...
- **PATRÓN** `sigma_h` < `0.007` → IC=+0.193 (n=568)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.0851` → IC=+0.177 (n=215)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.0851 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.170 (n=656)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.4313` → IC=+0.200 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4313 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.1491` → IC=+0.181 (n=453)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1491 (IC base=+0.155)
...
- **PATRÓN** `volumen_regimen` < `0.8907` → IC=+0.157 (n=430)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8907 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `1.2177` → IC=+0.191 (n=215)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.2177 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.2935` → IC=+0.225 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2935 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `2.6202` → IC=+0.187 (n=209)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6202 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.156 (n=719)
...
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.188 (n=267)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0117 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=834)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.5283` → IC=+0.190 (n=801)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.5283 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.8902` → IC=+0.232 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8902 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.303` → IC=+0.263 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.303 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` > `0.6322` → IC=+0.120 (n=801)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` > 0.6322 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3178.9102` → IC=+0.203 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3178.9102 (IC base=+0.112)

- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.157 (n=246)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0104 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.0978` → IC=+0.149 (n=243)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0978 (IC base=+0.121)
...
- **PATRÓN** `ibs_20min` < `0.4737` → IC=+0.212 (n=727)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4737 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `1.0287` → IC=+0.141 (n=90)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 1.0287 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` < `0.1784` → IC=+0.135 (n=644)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1784 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.292` → IC=+0.154 (n=296)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.292 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` < `1.1889` → IC=+0.135 (n=727)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.1889 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` > `0.862` → IC=+0.124 (n=485)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.862 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.2717` → IC=+0.202 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2717 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `2.3851` → IC=+0.180 (n=198)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.3851 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `3156.1484` → IC=+0.165 (n=243)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3156.1484 (IC base=+0.121)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.216 (n=530)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0175 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.1668` → IC=+0.219 (n=350)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1668 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=830)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.193)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.197 (n=710)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 15.0 (IC base=+0.193)

- **PATRÓN** `ibs_20min` > `0.7255` → IC=+0.247 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7255 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.2588` → IC=+0.226 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2588 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.172` → IC=+0.239 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.172 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` < `1.2034` → IC=+0.193 (n=796)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 1.2034 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` > `0.8431` → IC=+0.220 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8431 (IC base=+0.193)

- **PATRÓN** `volumen_pendiente_norm` > `0.0832` → IC=+0.250 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0832 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` < `2.5262` → IC=+0.212 (n=755)
...
- **PATRÓN** `libro_liquidez` > `2502.8212` → IC=+0.208 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2502.8212 (IC base=+0.202)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.170 (n=307)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0093 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.166 (n=872)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.4315` → IC=+0.169 (n=920)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.673` → IC=+0.174 (n=424)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.673 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8709` → IC=+0.157 (n=497)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8709 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1833` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.1833 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.179 (n=257)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `1.4513` → IC=+0.153 (n=289)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4513 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8234` → IC=+0.144 (n=577)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8234 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.151 (n=966)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9596.597` → IC=+0.180 (n=307)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 9596.597 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.3158` → IC=+0.123 (n=621)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.3158 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.144` → IC=+0.132 (n=191)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 8.144 (IC base=+0.076)

- **PATRÓN** `volumen_pendiente_norm` > `0.1733` → IC=+0.155 (n=233)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1733 (IC base=+0.076)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.149 (n=263)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 16.0 (IC base=+0.076)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.149 (n=75)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.005 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.165 (n=165)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 10.0 (IC base=+0.091)

- **PATRÓN** `ibs_20min` > `0.5605` → IC=+0.138 (n=147)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.5605 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.8241` → IC=+0.232 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8241 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.537` → IC=+0.167 (n=79)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.537 (IC base=+0.091)

- **PATRÓN** `volumen_regimen` < `0.6919` → IC=+0.162 (n=72)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6919 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` < `2.3825` → IC=+0.135 (n=154)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.3825 (IC base=+0.091)

- **PATRÓN** `libro_liquidez` > `8276.6888` → IC=+0.157 (n=164)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 8276.6888 (IC base=+0.091)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.157 (n=106)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0029 (IC base=+0.085)

- **PATRÓN** `drift_60min` |x|≤ `0.0809` → IC=+0.126 (n=105)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.0809 (IC base=+0.085)

- **PATRÓN** `ibs_20min` < `0.6346` → IC=+0.158 (n=276)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.6346 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.213` → IC=+0.156 (n=59)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.213 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.202 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.085)

- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.167 (n=94)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 146.0 (IC base=+0.085)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.266 (n=169)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.7444` → IC=+0.301 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7444 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` > `0.154` → IC=+0.281 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.154 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` < `0.9169` → IC=+0.267 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9169 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.09` → IC=+0.298 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.09 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` < `0.8266` → IC=+0.272 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8266 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` > `1.1605` → IC=+0.328 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1605 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` > `0.1004` → IC=+0.350 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1004 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` < `1.3716` → IC=+0.265 (n=83)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.199 (n=2333)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4836` → IC=+0.210 (n=5145)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4836 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `1.0378` → IC=+0.220 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0378 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.464` → IC=+0.226 (n=2571)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.464 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.887` → IC=+0.159 (n=2361)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.887 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.197 (n=1409)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.8757` → IC=+0.173 (n=3207)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8757 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.165 (n=4802)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.02 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3790.2792` → IC=+0.181 (n=1715)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3790.2792 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.208 (n=2514)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 62.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.191 (n=4688)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0109 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.477` → IC=+0.189 (n=4684)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.477 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.188 (n=2283)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.191 (n=2116)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 7.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.235 (n=4689)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.4369` → IC=+0.166 (n=3275)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.4369 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.723` → IC=+0.210 (n=674)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.723 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.712` → IC=+0.184 (n=4352)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 2.712 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `0.6226` → IC=+0.168 (n=1098)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6226 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `1.1936` → IC=+0.163 (n=1098)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.1936 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.237` → IC=+0.244 (n=774)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.237 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.3034` → IC=+0.194 (n=1801)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.3034 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.175 (n=3556)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 138.0 (IC base=+0.183)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.239 (n=385)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.193)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.220 (n=412)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.193)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.323 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.909` → IC=+0.312 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.909 (IC base=+0.193)

- **PATRÓN** `volumen_pendiente_norm` > `0.2292` → IC=+0.274 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2292 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` < `1.469` → IC=+0.200 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.469 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` > `2.308` → IC=+0.185 (n=347)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.308 (IC base=+0.193)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=703)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.193)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.244 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.193)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.264 (n=562)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.256)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.261 (n=639)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.1918` → IC=+0.292 (n=426)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1918 (IC base=+0.256)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.263 (n=580)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.256)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.261 (n=643)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` < `0.4142` → IC=+0.296 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4142 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.535` → IC=+0.272 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.535 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.2967` → IC=+0.309 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2967 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `2.42` → IC=+0.312 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.42 (IC base=+0.256)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.274 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1515.0` → IC=+0.264 (n=571)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1515.0 (IC base=+0.256)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.269 (n=418)
...
- **PATRÓN** `ibs_20min` > `0.3282` → IC=+0.203 (n=834)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3282 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.2132` → IC=+0.203 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2132 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.756` → IC=+0.185 (n=201)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 9.756 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.298` → IC=+0.162 (n=729)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 4.298 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `1.2667` → IC=+0.163 (n=835)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2667 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.156 (n=379)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.099 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` < `0.0706` → IC=+0.166 (n=707)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.0706 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1475` → IC=+0.191 (n=228)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1475 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.3936` → IC=+0.169 (n=784)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.3936 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.7292` → IC=+0.174 (n=523)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.7292 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `10464.5794` → IC=+0.182 (n=746)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10464.5794 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `465.0` → IC=+0.171 (n=627)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 465.0 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.178 (n=747)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0061 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.172 (n=666)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0029 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.2645` → IC=+0.183 (n=657)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.2645 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=700)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.171 (n=776)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 18.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.6208` → IC=+0.209 (n=746)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6208 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.1371` → IC=+0.187 (n=649)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1371 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.846` → IC=+0.221 (n=134)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1447` → IC=+0.230 (n=198)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1447 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.4035` → IC=+0.199 (n=217)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4035 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.0524` → IC=+0.194 (n=295)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.0524 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.167 (n=963)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `289.0` → IC=+0.194 (n=184)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 289.0 (IC base=+0.168)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.230 (n=505)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0074 (IC base=+0.210)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.249 (n=361)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.6815` → IC=+0.258 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6815 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.206` → IC=+0.321 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.206 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` < `0.2192` → IC=+0.212 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2192 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` < `3.1654` → IC=+0.206 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.1654 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `1.7121` → IC=+0.207 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7121 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.236 (n=795)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `1467.8784` → IC=+0.214 (n=756)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1467.8784 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.250 (n=470)
...
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.238 (n=341)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.248 (n=272)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.231)

- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.276 (n=662)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3966 (IC base=+0.231)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.556` → IC=+0.278 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.556 (IC base=+0.231)

- **PATRÓN** `volumen_pendiente_norm` > `0.3568` → IC=+0.294 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3568 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` < `3.0442` → IC=+0.228 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0442 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` > `1.898` → IC=+0.214 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.898 (IC base=+0.231)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.240 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.231)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.205 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 26.0 (IC base=+0.231)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.157 (n=755)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.7309` → IC=+0.238 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7309 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.3636` → IC=+0.185 (n=341)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.3636 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.314` → IC=+0.168 (n=381)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 4.314 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.8979` → IC=+0.168 (n=570)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.8979 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.2073` → IC=+0.148 (n=285)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5172` → IC=+0.186 (n=272)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.5172 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.143 (n=932)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `9491.6866` → IC=+0.238 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9491.6866 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.168 (n=224)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0032 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.4356` → IC=+0.141 (n=666)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.160 (n=295)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 7.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6809` → IC=+0.171 (n=666)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6809 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.6764` → IC=+0.136 (n=739)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.6764 (IC base=+0.123)
...
- **PATRÓN** `volumen_regimen` < `1.0197` → IC=+0.126 (n=586)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0197 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `1.147` → IC=+0.134 (n=222)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 1.147 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2783` → IC=+0.261 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2783 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `1.8208` → IC=+0.144 (n=402)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8208 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9441.0647` → IC=+0.171 (n=302)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 9441.0647 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `191.0` → IC=+0.133 (n=519)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 191.0 (IC base=+0.123)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.138 (n=600)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0078 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.135 (n=600)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.095)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.179 (n=902)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.4706 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `1.0924` → IC=+0.184 (n=172)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 1.0924 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.216 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.403 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2940.9508` → IC=+0.258 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2940.9508 (IC base=+0.095)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.134 (n=679)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 63.0 (IC base=+0.095)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.203 (n=841)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `drift_60min` |x|≤ `0.6467` → IC=+0.205 (n=1044)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `1.4555` → IC=+0.197 (n=868)
...
- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.134 (n=1478)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0103 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.555` → IC=+0.130 (n=1679)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.555 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.169 (n=578)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 18.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `0.9286` → IC=+0.190 (n=560)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.9286 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.379` → IC=+0.143 (n=264)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 10.379 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.1728` → IC=+0.153 (n=465)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1728 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.4629` → IC=+0.139 (n=555)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4629 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.894` → IC=+0.143 (n=1108)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.894 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `8613.1186` → IC=+0.130 (n=761)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 8613.1186 (IC base=+0.121)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.208 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.180 (n=192)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0106 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.2956` → IC=+0.163 (n=283)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.2956 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.191 (n=380)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 9.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.988` → IC=+0.227 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.988 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.26` → IC=+0.217 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.26 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.2112` → IC=+0.178 (n=116)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.2112 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `3.4971` → IC=+0.163 (n=422)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 3.4971 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.8314` → IC=+0.157 (n=377)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.8314 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `2301.6686` → IC=+0.185 (n=141)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2301.6686 (IC base=+0.152)
...
- **FILTRO** `ibs_20min` < `0.45` → IC=-0.200 (n=28)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.247` → IC=+0.167 (n=19)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 9.247 (IC base=-0.035)
...
- **FILTRO** `ibs_20min` > `0.0952` → IC=-0.128 (n=127)
...
- **PATRÓN** `ibs_20min` < `0.0952` → IC=+0.211 (n=43)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0952 (IC base=-0.117)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0817` → IC=+0.180 (n=23)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.0817 (IC base=-0.038)

- **PATRÓN** `ibs_20min` < `0.5804` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.5804 (IC base=-0.038)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.150 (n=184)

  - _Acción_: Kelly boost +0.75€ cuando `py_entrada` > 0.5 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2733.2178` → IC=+0.176 (n=109)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2733.2178 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2240.2754` → IC=+0.130 (n=276)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2240.2754 (IC base=+0.097)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.175 (n=1634)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=4996)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.184 (n=1638)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5203)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.221 (n=260)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=794)

- **FILTRO** `ibs_20min` < `0.7376` → IC=-0.191 (n=263)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7376
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=791)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.183 (n=358)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=749)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.218 (n=289)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=886)

- **FILTRO** `ibs_20min` > `0.7067` → IC=-0.195 (n=293)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7067
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=882)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.173 (n=261)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=843)

- **FILTRO** `py_entrada` > `0.56` → IC=-0.173 (n=264)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=808)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.188 (n=254)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=771)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=1010)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=292)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=880)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=555)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=561)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=3869)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=12077)

- **FILTRO** `ibs_7min` < `0.7167` → IC=-0.234 (n=3984)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7167
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=11962)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.168 (n=5366)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=10580)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=4910)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=15308)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.172 (n=5030)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=15188)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=565)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1796)

- **FILTRO** `ibs_7min` < `0.7109` → IC=-0.252 (n=779)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7109
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1582)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.218 (n=562)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1799)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.243 (n=865)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2646)

- **FILTRO** `drift_7min_pct` |x|> `0.1143` → IC=-0.133 (n=1193)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1143
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2318)

- **FILTRO** `ibs_7min` > `0.8358` → IC=-0.197 (n=877)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8358
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2634)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.140 (n=651)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2287)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.262 (n=711)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2227)

- **FILTRO** `ibs_7min` < `0.7719` → IC=-0.192 (n=734)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7719
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2204)

- **FILTRO** `ballena_activa_n` > `164.0` → IC=-0.177 (n=734)

  - _Acción_: SKIP cuando `ballena_activa_n` > 164.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2204)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.241 (n=721)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2242)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.169 (n=1004)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1959)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.181 (n=753)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1587)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.303 (n=743)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1597)

- **FILTRO** `ibs_7min` < `0.2222` → IC=-0.288 (n=582)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2222
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1758)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.240 (n=553)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1787)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=866)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2802)

- **FILTRO** `ibs_7min` > `0.7976` → IC=-0.171 (n=916)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7976
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2752)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.260 (n=645)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2048)

- **FILTRO** `ibs_7min` < `0.7582` → IC=-0.187 (n=673)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7582
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=2020)

- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.171 (n=904)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1789)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.255 (n=679)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=2044)

- **FILTRO** `ibs_7min` > `0.2766` → IC=-0.176 (n=680)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2766
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=2043)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.186 (n=673)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2050)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.237 (n=724)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2259)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.203 (n=739)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2244)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.168 (n=947)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=2844)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.296 (n=634)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1997)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.231 (n=653)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1978)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.225 (n=635)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=1996)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.204 (n=857)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2705)

- **FILTRO** `ibs_7min` > `0.7586` → IC=-0.156 (n=890)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7586
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=2672)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1696)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.178 (n=209)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0035 (IC base=+0.144)

- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.195 (n=208)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0076 (IC base=+0.144)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1911` → IC=+0.146 (n=283)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.73€ cuando `delta_ratio_macro` |x|> 0.1911 (IC base=+0.144)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3318` → IC=+0.192 (n=310)

  - _Acción_: Kelly boost +0.96€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3318 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.184 (n=292)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 6.0 (IC base=+0.144)

- **PATRÓN** `ibs_15` > `0.5957` → IC=+0.222 (n=624)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5957 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.2685` → IC=+0.149 (n=240)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.2685 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` < `0.547` → IC=+0.145 (n=665)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.547 (IC base=+0.144)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=619)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `9601.804` → IC=+0.171 (n=208)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 9601.804 (IC base=+0.144)
...
- **PATRÓN** `libro_liquidez` > `14752.2757` → IC=+0.267 (n=58)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14752.2757 (IC base=+0.179)
...
- **FILTRO** `hora_utc` < `11.0` → IC=-0.122 (n=35)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 11.0
...
- **FILTRO** `ibs_15` < `0.2059` → IC=-0.152 (n=21)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.2059
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=63)

- **FILTRO** `sigma_ewma_delta_pct` > `7.604` → IC=-0.227 (n=20)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 7.604
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=61)

- **PATRÓN** `ibs_15` > `0.8288` → IC=+0.122 (n=96)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` > 0.8288 (IC base=+0.012)
...
- **FILTRO** `dist_vwap_pct` > `0.262` → IC=-0.333 (n=16)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.262
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=126)

- **FILTRO** `drift_15min` |x|> `0.4795` → IC=-0.148 (n=163)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.4795
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=492)

- **FILTRO** `sigma_ewma_delta_pct` > `9.378` → IC=-0.120 (n=106)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 9.378
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.179 (n=26)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0059 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` < `0.3805` → IC=+0.167 (n=52)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.3805 (IC base=+0.020)

### UPDOWN_GBM#XRP#15min
- **PATRÓN** `sigma_h` > `0.0202` → IC=+0.217 (n=58)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0202 (IC base=+0.141)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0451` → IC=+0.161 (n=172)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.80€ cuando `delta_ratio_macro` |x|> 0.0451 (IC base=+0.141)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3131` → IC=+0.218 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3131 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.206 (n=83)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.141)

- **PATRÓN** `ibs_15` > `0.4821` → IC=+0.218 (n=172)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.4821 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.1207` → IC=+0.210 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1207 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.5574` → IC=+0.140 (n=198)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5574 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.916` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.916 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `2678.0478` → IC=+0.200 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2678.0478 (IC base=+0.141)

- **PATRÓN** `ibs_15` < `0.1159` → IC=+0.184 (n=191)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` < 0.1159 (IC base=+0.032)
...
- **FILTRO** `sigma_h` > `0.0112` → IC=-0.194 (n=374)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0112
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1126)

- **FILTRO** `ibs_15` < `0.5879` → IC=-0.188 (n=168)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.5879
  - _Potencial_: sin este filtro IC_bueno=+0.242 (n=343)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.151 (n=396)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1104)

- **FILTRO** `sigma_ewma_delta_pct` > `18.817` → IC=-0.156 (n=539)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.817
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4099)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.357` → IC=+0.191 (n=221)

  - _Acción_: Kelly boost +0.95€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.357 (IC base=-0.064)

- **PATRÓN** `ibs_15` > `0.5879` → IC=+0.242 (n=343)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5879 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` < `0.172` → IC=+0.140 (n=231)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.172 (IC base=-0.064)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1261` → IC=+0.222 (n=358)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1261 (IC base=-0.065)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1115` → IC=+0.233 (n=215)
...
- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.214 (n=501)
...
- **FILTRO** `sigma_h` < `0.0038` → IC=-0.234 (n=317)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.145 (n=74)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0026 (IC base=+0.037)
...
- **PATRÓN** `dist_vwap_pct` < `0.156` → IC=+0.235 (n=32)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.156 (IC base=+0.037)
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.515` → IC=-0.135 (n=187)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 16.515
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0761` → IC=+0.164 (n=108)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.82€ cuando `delta_ratio_macro` |x|> 0.0761 (IC base=-0.051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2087` → IC=+0.183 (n=77)

  - _Acción_: Kelly boost +0.92€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2087 (IC base=-0.051)
...
- **PATRÓN** `dist_vwap_pct` < `0.2528` → IC=+0.187 (n=113)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.2528 (IC base=-0.051)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `drift_15min` |x|> `1.1964` → IC=-0.255 (n=104)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.1964
  - _Potencial_: sin este filtro IC_bueno=-0.138 (n=316)

- **FILTRO** `hora_utc` > `6.0` → IC=-0.199 (n=277)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=143)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.237 (n=74)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.152 (n=346)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0953` → IC=+0.341 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0953 (IC base=-0.062)

- **PATRÓN** `ibs_15` < `0.3448` → IC=+0.269 (n=145)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.287 (n=365)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.285)

- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.287 (n=326)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **H-SIGMA-SOL-60MIN**: `UPDOWN_GBM#SOL#60min` gana cuando sigma_h < 0.0059 (IC=+0.179 n=26). Implementar como filtro pre-predicción en shadow_predict.py.
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5957 sube el IC de +0.144 a +0.222 en UPDOWN_GBM#15min (n=624). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.4821 sube el IC de +0.141 a +0.218 en UPDOWN_GBM#XRP#15min (n=172). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1159 sube el IC de +0.032 a +0.184 en UPDOWN_GBM#XRP#15min (n=191). Ya aplicado como kelly_boost=+0.92€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5879 sube el IC de -0.064 a +0.242 en UPDOWN_GBM_15M_TARDIO (n=343). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.6819 sube el IC de +0.037 a +0.320 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=59). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3814 sube el IC de -0.051 a +0.207 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=121). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3448 sube el IC de -0.062 a +0.269 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=145). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8311 sube el IC de +0.285 a +0.317 en UPDOWN_GBM_IBS_ALTO (n=365). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 885 | +0.087 | +62.73€ | 2 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 885 | +0.087 | +62.73€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 25 | +0.056 | -0.25€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 25 | +0.056 | -0.25€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 596 | +0.102 | +48.72€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 596 | +0.102 | +48.72€ | 2 | 8 |
...
| ✅ BALLENAS_TARDIAS | 16209 | -0.118 | -2606.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1002 | -0.019 | -152.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 15207 | -0.124 | -2454.19€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2202 | -0.108 | -485.74€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2202 | -0.108 | -485.74€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1002 | -0.019 | -152.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1002 | -0.019 | -152.00€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2135 | -0.169 | -580.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2135 | -0.169 | -580.91€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 4296 | -0.061 | -397.19€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 4296 | -0.061 | -397.19€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3629 | -0.131 | -240.23€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3629 | -0.131 | -240.23€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2945 | -0.187 | -750.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2945 | -0.187 | -750.13€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 5288 | -0.080 | +1941.32€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 1509 | -0.014 | +1058.93€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 3779 | -0.106 | +882.39€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 5288 | -0.080 | +1941.32€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 1509 | -0.014 | +1058.93€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 3779 | -0.106 | +882.39€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 113 | -0.048 | -13.60€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 113 | -0.048 | -13.60€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC |