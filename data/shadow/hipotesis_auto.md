# Hipótesis automáticas — 2026-07-21 17:30 UTC
_Generado por shadow_postmortem.py sobre 27208 resoluciones (PNL=+6236.30€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.206 (n=1515)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.209 (n=1738)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=1907)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.234 (n=337)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.223)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.229 (n=385)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.227 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `4281.5138` → IC=+0.229 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4281.5138 (IC base=+0.223)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.182 (n=486)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.7417` → IC=+0.148 (n=1308)
...
| ✅ FAVORITO_CONFIRMADO | 4692 | +0.185 | +73.90€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3060 | +0.217 | +112.41€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1658 | +0.175 | -4.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1008 | +0.214 | +33.82€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 6577 | +0.098 | +2107.98€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 6577 | +0.098 | +2107.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1572 | +0.070 | +280.64€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1572 | +0.070 | +280.64€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1494 | +0.071 | +259.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1494 | +0.071 | +259.66€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3774 | +0.134 | +2034.07€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3774 | +0.134 | +2034.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 960 | +0.097 | +395.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 960 | +0.097 | +395.23€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 983 | +0.094 | +382.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 983 | +0.094 | +382.63€ | 0 | 7 |
...
| ✅ GBM_LATE_15M_TARDIO | 3745 | +0.087 | +1207.06€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3745 | +0.087 | +1207.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 897 | +0.053 | +157.96€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 897 | +0.053 | +157.96€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 904 | +0.028 | +79.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 904 | +0.028 | +79.45€ | 0 | 2 |
...
| ✅ LATE_WINDOW_5MIN | 226 | -0.018 | +0.62€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 226 | -0.018 | +0.62€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 226 | -0.018 | +0.62€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 226 | -0.018 | +0.62€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.115 n=16263 | tras_1loss IC=+0.082 n=10735 | tras_2loss IC=+0.049 n=4448/40 | gap=+0.066 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.088 n=1196/40 PNL=+255.63€ | H=15h UTC: IC=+0.148 n=1181/40 PNL=+443.93€ | H=17h UTC: IC=+0.101 n=1103/40 PNL=+235.99€ | H=19h UTC: IC=+0.122 n=993/40 PNL=+261.58€
...
**〰️ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: n=226 IC=-0.018 PNL=+0.62€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=226 IC=-0.018 PNL=+0.62€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=24741 IC=+0.113 PNL=+6313.12€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=24741 IC=+0.113 PNL=+6313.12€
