# Hipótesis automáticas — 2026-07-28 06:52 UTC
_Generado por shadow_postmortem.py sobre 39697 resoluciones (PNL=+8055.12€)_
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.186 (n=1216)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.2762` → IC=+0.189 (n=500)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.2762 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.425` → IC=+0.233 (n=578)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.697` → IC=+0.179 (n=82)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 11.697 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.139 (n=460)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0077 (IC base=+0.110)
...
- **PATRÓN** `dist_vwap_pct` > `0.312` → IC=+0.156 (n=126)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.312 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.62` → IC=+0.264 (n=197)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.673` → IC=+0.191 (n=66)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 12.673 (IC base=+0.075)
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M#BNB#15min` — IC=+0.129 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#BNB` — IC=+0.129 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M_TARDIO#BNB#15min` — IC=+0.176 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M_TARDIO#BNB` — IC=+0.176 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
...
| ✅ FAVORITO_CONFIRMADO | 6878 | +0.177 | -56.64€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4534 | +0.201 | -46.20€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 8530 | +0.093 | +2529.68€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8530 | +0.093 | +2529.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 33 | +0.129 | +4.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 33 | +0.129 | +4.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2049 | +0.072 | +351.29€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2049 | +0.072 | +351.29€ | 0 | 5 |
| ✅ GBM_LATE_15M#DOGE | 32 | +0.000 | +0.56€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 32 | +0.000 | +0.56€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1849 | +0.074 | +314.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1849 | +0.074 | +314.20€ | 0 | 6 |
| ✅ GBM_LATE_15M#SOL | 2279 | +0.082 | +768.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2279 | +0.082 | +768.00€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2288 | +0.138 | +1091.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2288 | +0.138 | +1091.63€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5771 | +0.114 | +2636.46€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5771 | +0.114 | +2636.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 25 | +0.204 | +15.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 25 | +0.204 | +15.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1496 | +0.083 | +501.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1496 | +0.083 | +501.09€ | 0 | 4 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1432 | +0.082 | +539.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1432 | +0.082 | +539.58€ | 0 | 4 |
...
| ✅ GBM_LATE_15M_TARDIO | 5758 | +0.064 | +1474.82€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5758 | +0.064 | +1474.82€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 32 | +0.176 | +8.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 32 | +0.176 | +8.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1364 | +0.026 | +146.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1364 | +0.026 | +146.53€ | 0 | 2 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 1342 | +0.023 | +239.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1342 | +0.023 | +239.94€ | 1 | 1 |
...
| ✅ UPDOWN_GBM | 2948 | +0.036 | +270.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2684 | +0.052 | +309.68€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2226 | +0.150 | +972.72€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2226 | +0.150 | +972.72€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 625 | +0.168 | +368.43€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 625 | +0.168 | +368.43€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.164: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.073 n=1692 | neutral: IC=+0.022 n=1344 | overbought(IBS>0.7): IC=+0.187 n=1654
  - _Datos_: n=5001 IC=+0.103 PNL=+1308.82€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.109 n=23553 | tras_1loss IC=+0.077 n=15927 | tras_2loss IC=+0.053 n=6693/40 | gap=+0.056 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2811 IC=+0.040 PNL=+284.45€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2811 IC=+0.040 PNL=+284.45€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=1418 PNL=+245.72€
  - _Datos_: n=1418 IC=+0.091 PNL=+245.72€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3415 IC=+0.054 PNL=+399.69€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3415 IC=+0.054 PNL=+399.69€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=698 IC=+0.199 PNL=+395.67€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=698 IC=+0.199 PNL=+395.67€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.107 > 0.08 con n=606 PNL=+184.21€
  - _Datos_: n=606 IC=+0.107 PNL=+184.21€
