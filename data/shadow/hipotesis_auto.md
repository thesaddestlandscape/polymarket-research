# Hipótesis automáticas — 2026-07-04 15:52 UTC
_Generado por shadow_postmortem.py sobre 3532 resoluciones (PNL=+78.31€)_
...
### UPDOWN_GBM#15min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.122 (n=72)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=167)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.174 (n=90)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0092 (IC base=+0.028)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.143 (n=68)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.71€ cuando `ibs_15` < 0.0613 (IC base=+0.028)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0366` → IC=+0.125 (n=22)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.62€ cuando `pct_spot_vs_ref` |x|≤ 0.0366 (IC base=+0.023)
...
- **FILTRO** `delta_ratio_macro` |x|≤ `0.0722` → IC=-0.146 (n=46)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.0722
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.148 (n=52)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0089 (IC base=+0.077)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.145 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 7.0 (IC base=+0.077)

- **PATRÓN** `ibs_15` < `0.28` → IC=+0.121 (n=64)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` < 0.28 (IC base=+0.077)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 776 | +0.090 | +178.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 776 | +0.090 | +178.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 201 | +0.047 | +25.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 201 | +0.047 | +25.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 203 | +0.027 | +10.06€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 203 | +0.027 | +10.06€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 198 | +0.140 | +74.82€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 198 | +0.140 | +74.82€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 174 | +0.153 | +67.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 174 | +0.153 | +67.77€ | 0 | 0 |
| 🚫 GBM_LATE_60M | 8 | -0.120 | -3.18€ | 0 | 0 |
| 🚫 GBM_LATE_60M#60min | 8 | -0.120 | -3.18€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN | 9 | +0.061 | +1.52€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 9 | +0.061 | +1.52€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 9 | +0.061 | +1.52€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 9 | +0.061 | +1.52€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1536 | +0.011 | +8.49€ | 1 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1400 | +0.006 | -4.10€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 269 | -0.031 | -10.72€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 269 | -0.031 | -10.72€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 302 | +0.040 | +9.67€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 918 | -0.039 | -54.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 685 | -0.018 | -25.70€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 254 | -0.043 | -34.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 183 | -0.019 | -23.33€ | 2 | 1 |
...
| ✅ UPDOWN_GBM#ETH | 381 | -0.006 | +5.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 296 | +0.010 | +12.32€ | 3 | 3 |
...
| ✅ UPDOWN_GBM#SOL | 153 | -0.087 | -12.99€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#XRP | 77 | -0.019 | +1.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 66 | +0.015 | +4.72€ | 4 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.043) — sin ventaja clara. oversold(IBS<0.3): IC=-0.024 n=187 | neutral: IC=-0.067 n=155 | overbought(IBS>0.7): IC=-0.036 n=166
  - _Datos_: n=528 IC=-0.038 PNL=-28.78€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.227 n=31 PNL=-17.74€ → FILTRAR | H=02h: IC=-0.154 n=24 PNL=-5.23€ → FILTRAR | H=03h: IC=-0.113 n=19 PNL=-5.87€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=13h: IC=+0.115 n=24 PNL=+5.54€ → BOOST | H=16h: IC=+0.167 n=25 PNL=+7.36€ → BOOST | H=20h: IC=-0.167 n=28 PNL=-9.59€ → FILTRAR

**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  - _Umbral_: n≥200 por par con delta_ratio feature en shadow
  - _Acción_: Añadir DELTA_MIN/MAX por par dict en shadow_predict.py
  - _Estado_: BTC: 165 ops con delta_ratio | SOL: 201 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.023 n=1741 | tras_1loss IC=-0.015 n=1686 | tras_2loss IC=-0.036 n=849/40 | gap=+0.059 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=26, boost estimado=+0.013. Necesita 0 más y boost>0.05
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.020 n=150/40 PNL=+6.91€ | H=15h UTC: IC=-0.016 n=151/40 PNL=-7.53€ | H=17h UTC: IC=+0.153 n=73/40 PNL=+21.60€ | H=19h UTC: IC=-0.005 n=89/40 PNL=-7.46€
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.026 n=95 | contrario_BTC IC=-0.043 n=44/40 | gap=-0.018 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-24H-GBM-BUYYES-MADRUGADA** — GBM BUY_YES en madrugada europea (05-07h UTC) — señal alcista
  ...
  - _Estado_: n=49 IC=+0.069 PNL=+7.06€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=49 IC=+0.069 PNL=+7.06€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=159 IC=-0.053 PNL=-15.86€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=159 IC=-0.053 PNL=-15.86€
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=57 IC=+0.042 PNL=+2.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=57 IC=+0.042 PNL=+2.69€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=795 IC=-0.035 PNL=-40.46€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=795 IC=-0.035 PNL=-40.46€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=414 IC=-0.048 PNL=-45.66€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=414 IC=-0.048 PNL=-45.66€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.019 < 0.02 con n=183 PNL=-23.33€
  - _Datos_: n=183 IC=-0.019 PNL=-23.33€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=302 IC=-0.013 PNL=-30.52€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=302 IC=-0.013 PNL=-30.52€
...
**〰️ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  ...
  - _Estado_: n=49 IC=+0.049 PNL=+8.83€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=49 IC=+0.049 PNL=+8.83€
...
**⏳ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: 9/30 ops en el filtro definido (IC actual=+0.061 PNL=+1.52€)
  - _Datos_: n=9 IC=+0.061 PNL=+1.52€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=250 IC=+0.000 PNL=+3.62€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=250 IC=+0.000 PNL=+3.62€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 7/40 ops en el filtro definido (IC actual=+0.019 PNL=+1.99€)
  - _Datos_: n=7 IC=+0.019 PNL=+1.99€

**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  - _Hipótesis_: Lado negativo de H-CUSTOM-CROSS-WINDOW-SPREAD-POS (mercado propio más barato que el relacionado). Mismo feature cross_window_spread, mismo origen (artículo sobre bots de Polymarket), umbral simétrico.
  - _Umbral_: 40
  - _Acción_: Si se confirma con n≥40 → considerar boost/filtro por cross_window_spread
  - _Estado_: 6/40 ops en el filtro definido (IC actual=+0.000 PNL=-1.38€)
  - _Datos_: n=6 IC=+0.000 PNL=-1.38€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1099 IC=+0.059 PNL=+163.87€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1099 IC=+0.059 PNL=+163.87€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=58 IC=-0.017 PNL=-9.38€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=58 IC=-0.017 PNL=-9.38€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.072 < -0.05 con n=556 PNL=-73.58€
  - _Datos_: n=556 IC=-0.072 PNL=-73.58€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 76/120 ops en el filtro definido (IC actual=+0.141 PNL=+14.56€)
  - _Datos_: n=76 IC=+0.141 PNL=+14.56€
...
**⏳ H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: 24/40 ops en el filtro definido (IC actual=-0.115 PNL=-5.41€)
  - _Datos_: n=24 IC=-0.115 PNL=-5.41€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=79 IC=-0.056 PNL=+10.03€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=79 IC=-0.056 PNL=+10.03€
