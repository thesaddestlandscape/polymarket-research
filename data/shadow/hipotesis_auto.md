# Hipótesis automáticas — 2026-07-02 05:35 UTC
_Generado por shadow_postmortem.py sobre 2535 resoluciones (PNL=-90.56€)_
...
|---|---|---|---|---|---|
| ✅ ORDER_FLOW_5M | 1506 | +0.014 | +12.89€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1370 | +0.009 | +0.30€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 288 | +0.041 | +9.96€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 288 | +0.041 | +9.96€ | 0 | 0 |
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 149 ops con delta_ratio | SOL: 187 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1197 | tras_1loss IC=-0.037 n=1256 | tras_2loss IC=-0.052 n=656/40 | gap=+0.055 (umbral 0.05)
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=48 IC=+0.060 PNL=+3.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=48 IC=+0.060 PNL=+3.02€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 118/200 ops en el filtro definido (IC actual=+0.033 PNL=+2.36€)
  - _Datos_: n=118 IC=+0.033 PNL=+2.36€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=118 IC=+0.033 PNL=+2.36€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=118 IC=+0.033 PNL=+2.36€
