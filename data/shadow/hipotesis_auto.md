# Hipótesis automáticas — 2026-09-14 10:57 UTC
_Generado por shadow_postmortem.py sobre 434354 resoluciones (PNL=+46287.46€)_
...
- **FILTRO** `py_entrada` < `0.385` → IC=-0.150 (n=195)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.244 (n=408)
...
- **PATRÓN** `py_entrada` > `0.385` → IC=+0.244 (n=408)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8056` → IC=+0.260 (n=302)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8056 (IC base=+0.117)

- **PATRÓN** `banda_z` > `9.189` → IC=+0.202 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 9.189 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.133 (n=314)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 11.0 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=479)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.144 (n=130)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 100.0 (IC base=+0.117)
...
- **FILTRO** `py_entrada` < `0.375` → IC=-0.129 (n=141)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.234 (n=325)
...
- **PATRÓN** `py_entrada` > `0.375` → IC=+0.234 (n=325)
...
- **PATRÓN** `banda_hit_calibrado` > `0.804` → IC=+0.263 (n=234)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.804 (IC base=+0.124)

- **PATRÓN** `banda_z` > `11.552` → IC=+0.273 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.552 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.159 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 17.0 (IC base=+0.124)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.137 (n=395)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.18` → IC=-0.259 (n=5464)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.18
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=16393)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.133 (n=1923)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=1160)

- **FILTRO** `restante_s_al_confirmar` < `138.7` → IC=-0.289 (n=770)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 138.7
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2313)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `134.98` → IC=-0.289 (n=689)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.98
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2067)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `143.98` → IC=-0.150 (n=1407)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 143.98
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4224)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.46` → IC=-0.256 (n=1273)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.46
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3819)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.77` → IC=-0.345 (n=1363)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.77
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=2769)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.33` → IC=-0.294 (n=71)

  - _Acción_: SKIP cuando `py_entrada` < 0.33
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=244)

- **FILTRO** `py_entrada` < `0.48` → IC=-0.178 (n=88)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=186)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.244 (n=7480)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.169 (n=5494)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7078.3579` → IC=+0.173 (n=1739)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7078.3579 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1295)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.356 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=1600)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `13070.3814` → IC=+0.213 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13070.3814 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1306)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.296 (n=887)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=1671)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `12645.1919` → IC=+0.203 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12645.1919 (IC base=+0.199)
...
- **PATRÓN** `py_entrada` < `0.425` → IC=+0.164 (n=549)
...
- **PATRÓN** `py_entrada` < `0.305` → IC=+0.326 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.305 (IC base=+0.233)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.235 (n=1146)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.233)

- **PATRÓN** `libro_liquidez` > `4381.435` → IC=+0.235 (n=360)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.136 (n=520)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 17.0 (IC base=+0.127)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.228 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.136 (n=613)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `1963.3865` → IC=+0.160 (n=345)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 1963.3865 (IC base=+0.127)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.194 (n=1039)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 12.0 (IC base=+0.192)

- **PATRÓN** `py_entrada` > `0.85` → IC=+0.423 (n=516)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=659)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.179 (n=2074)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2166)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.183 (n=4693)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.267 (n=1632)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.205 (n=4220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.255 (n=2155)
...
- **PATRÓN** `lag_apertura_s` < `6.48` → IC=+0.146 (n=2310)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 6.48 (IC base=+0.131)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.193 (n=1923)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` < 0.38 (IC base=+0.118)

- **PATRÓN** `restante_min` < `4.47` → IC=+0.127 (n=2352)

  - _Acción_: Kelly boost +0.64€ cuando `restante_min` < 4.47 (IC base=+0.118)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.148 (n=1953)
...
- **PATRÓN** `lag_apertura_s` < `2.78` → IC=+0.145 (n=1781)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 2.78 (IC base=+0.118)
...
- **PATRÓN** `libro_liquidez` > `1604.9934` → IC=+0.296 (n=902)
...
- **PATRÓN** `py_entrada` > `0.785` → IC=+0.327 (n=200)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.293 (n=432)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1491.7936` → IC=+0.314 (n=384)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1491.7936 (IC base=+0.293)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.442 (n=426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.431)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.438 (n=355)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.925` → IC=+0.435 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.925 (IC base=+0.431)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.433 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.431)

- **PATRÓN** `libro_liquidez` > `1854.0504` → IC=+0.439 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1854.0504 (IC base=+0.431)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.280 (n=470)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.259)

- **PATRÓN** `py_entrada` > `0.735` → IC=+0.318 (n=475)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.735 (IC base=+0.259)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.279 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1362.9219` → IC=+0.293 (n=350)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9762` → IC=+0.231 (n=1924)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9762 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` < `0.2129` → IC=+0.247 (n=1182)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2129 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.843` → IC=+0.166 (n=2232)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.843 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` < `1.2292` → IC=+0.245 (n=1442)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2292 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `1.0681` → IC=+0.250 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0681 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` < `0.1759` → IC=+0.193 (n=3889)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1759 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2534` → IC=+0.194 (n=756)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2534 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `2.8577` → IC=+0.192 (n=3753)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.8577 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `1.4716` → IC=+0.195 (n=3753)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4716 (IC base=+0.098)

- **PATRÓN** `ibs_20min` < `0.5741` → IC=+0.125 (n=7088)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.5741 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` < `0.3309` → IC=+0.164 (n=2376)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.3309 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `1.0644` → IC=+0.172 (n=1015)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 1.0644 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.169` → IC=+0.220 (n=1103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.169 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `1.4658` → IC=+0.194 (n=3728)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4658 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.203 (n=3499)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 162.0 (IC base=+0.056)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.188 (n=434)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0049 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.186 (n=431)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0076 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.3232` → IC=+0.166 (n=1292)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.271 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.034` → IC=+0.279 (n=564)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1102` → IC=+0.240 (n=432)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1102 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.231 (n=1022)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` > `0.9278` → IC=+0.253 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9278 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` > `0.2016` → IC=+0.222 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2016 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` < `0.1333` → IC=+0.215 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1333 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.89` → IC=+0.234 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.89 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.227 (n=979)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `0.8755` → IC=+0.217 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8755 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.0745` → IC=+0.216 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0745 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `1.4924` → IC=+0.229 (n=419)
...
- **PATRÓN** `libro_liquidez` > `11835.8417` → IC=+0.231 (n=874)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11835.8417 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.159 (n=922)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0048 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.161 (n=349)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6789` → IC=+0.177 (n=1047)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6789 (IC base=+0.138)
...
- **PATRÓN** `volumen_regimen` < `1.2085` → IC=+0.145 (n=1047)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2085 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.140 (n=1047)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6121 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1536` → IC=+0.200 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1536 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.152 (n=938)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4133` → IC=+0.149 (n=939)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4133 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `12702.6869` → IC=+0.150 (n=698)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12702.6869 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `312.0` → IC=+0.153 (n=569)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 312.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.190 (n=1267)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0057 (IC base=+0.178)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=1335)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.178)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.189 (n=847)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 11.0 (IC base=+0.178)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.255 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.412` → IC=+0.226 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.412 (IC base=+0.178)

- **PATRÓN** `volumen_pendiente_norm` < `0.1071` → IC=+0.188 (n=1064)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1071 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` > `1.6649` → IC=+0.183 (n=1180)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.6649 (IC base=+0.178)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.192 (n=1434)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.178)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.219 (n=1091)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.146` → IC=+0.212 (n=480)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.146 (IC base=+0.211)
...
- **PATRÓN** `ibs_20min` < `0.3896` → IC=+0.229 (n=959)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3896 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.677` → IC=+0.230 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.677 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.373` → IC=+0.213 (n=1193)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.373 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.3649` → IC=+0.269 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3649 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.3057` → IC=+0.221 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3057 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.223 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `1888.9584` → IC=+0.230 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1888.9584 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.198 (n=900)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.156 (n=88)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1597)

- **PATRÓN** `ibs_20min` > `0.9316` → IC=+0.173 (n=270)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.272` → IC=+0.137 (n=502)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.272 (IC base=+0.011)
...
- **PATRÓN** `volumen_regimen` < `0.8602` → IC=+0.139 (n=333)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.8602 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` > `0.6106` → IC=+0.140 (n=498)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6106 (IC base=-0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.2152` → IC=+0.199 (n=81)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2152 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` > `1.5018` → IC=+0.170 (n=401)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.5018 (IC base=-0.005)
...
- **FILTRO** `ibs_20min` > `0.2812` → IC=-0.127 (n=1648)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2812
  - _Potencial_: sin este filtro IC_bueno=+0.112 (n=812)

- **FILTRO** `sigma_ewma_delta_pct` > `8.602` → IC=-0.200 (n=268)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.602
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2192)
...
- **PATRÓN** `volumen_regimen` < `0.6485` → IC=+0.194 (n=70)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.6485 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` > `0.9262` → IC=+0.176 (n=140)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.9262 (IC base=-0.048)

- **PATRÓN** `volumen_pendiente_norm` < `0.1972` → IC=+0.181 (n=161)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` < 0.1972 (IC base=-0.048)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4963` → IC=+0.212 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4963 (IC base=-0.048)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.226 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=-0.048)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.627` → IC=-0.190 (n=405)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.627
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1218)

- **FILTRO** `ibs_20min` < `0.65` → IC=-0.159 (n=1071)

  - _Acción_: SKIP cuando `ibs_20min` < 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=552)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.197 (n=344)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=1279)

- **FILTRO** `ibs_20min` > `0.775` → IC=-0.196 (n=614)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1843)

- **PATRÓN** `dist_vwap_pct` > `0.8986` → IC=+0.339 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8986 (IC base=-0.085)

- **PATRÓN** `dist_vwap_pct` < `0.2456` → IC=+0.299 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2456 (IC base=-0.085)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.292 (n=190)
...
- **PATRÓN** `volumen_regimen` > `1.0971` → IC=+0.302 (n=220)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.229 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=-0.032)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.173 (n=2402)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.009 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.4586` → IC=+0.175 (n=6428)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.4586 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.6909` → IC=+0.276 (n=659)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6909 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.485` → IC=+0.142 (n=3410)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.485 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `0.6744` → IC=+0.232 (n=2173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6744 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` < `0.1137` → IC=+0.223 (n=3682)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1137 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.2482` → IC=+0.254 (n=769)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2482 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `1.4784` → IC=+0.234 (n=1290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4784 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `2.7873` → IC=+0.235 (n=1290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7873 (IC base=+0.087)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.276 (n=3354)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 103.0 (IC base=+0.087)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.135 (n=2471)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0083 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.146 (n=6523)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.56 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.8952` → IC=+0.232 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8952 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` < `0.1596` → IC=+0.229 (n=1807)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1596 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.2033` → IC=+0.256 (n=653)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2033 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.2516` → IC=+0.321 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2516 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `1.6295` → IC=+0.248 (n=1116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6295 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `2.3821` → IC=+0.253 (n=1150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3821 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.249 (n=2391)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.064)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2365` → IC=-0.147 (n=485)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2365
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1457)

- **FILTRO** `sigma_ewma_delta_pct` > `4.409` → IC=-0.156 (n=379)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.409
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=1260)

- **PATRÓN** `ibs_20min` > `0.8636` → IC=+0.256 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8636 (IC base=+0.039)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.963` → IC=+0.165 (n=509)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8576` → IC=+0.194 (n=334)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.8576 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` > `2.6662` → IC=+0.192 (n=167)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6662 (IC base=+0.039)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.209 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 57.0 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` < `0.1791` → IC=+0.471 (n=32)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7385` → IC=+0.426 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7385 (IC base=-0.019)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.463 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 64.0 (IC base=-0.019)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8328` → IC=-0.150 (n=547)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8328
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1644)

- **PATRÓN** `dist_vwap_pct` > `0.299` → IC=+0.131 (n=234)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.299 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` > `0.6498` → IC=+0.132 (n=557)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4168` → IC=+0.152 (n=202)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4168 (IC base=+0.010)

- **PATRÓN** `ballena_activa_n` < `235.0` → IC=+0.187 (n=199)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 235.0 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` < `0.1506` → IC=+0.215 (n=370)
...
- **PATRÓN** `ibs_20min` < `0.3415` → IC=+0.285 (n=914)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3415 (IC base=+0.276)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.884` → IC=+0.296 (n=351)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6234` → IC=+0.271 (n=273)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6234 (IC base=+0.276)

- **PATRÓN** `volumen_spike_ratio` > `2.2358` → IC=+0.282 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2358 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `1880.9161` → IC=+0.297 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1880.9161 (IC base=+0.276)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.263 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 37.0 (IC base=+0.276)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2335` → IC=-0.213 (n=322)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2335
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=969)

- **FILTRO** `ibs_20min` > `0.8227` → IC=-0.180 (n=429)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8227
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1291)

- **PATRÓN** `ibs_20min` > `0.8024` → IC=+0.144 (n=439)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.8024 (IC base=-0.017)

- **PATRÓN** `dist_vwap_pct` > `0.3121` → IC=+0.233 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3121 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` < `0.9335` → IC=+0.216 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9335 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` > `0.6109` → IC=+0.188 (n=245)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.6109 (IC base=-0.017)
...
- **PATRÓN** `ballena_activa_n` < `171.0` → IC=+0.237 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 171.0 (IC base=-0.017)

- **PATRÓN** `dist_vwap_pct` > `0.1148` → IC=+0.167 (n=88)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1148 (IC base=-0.026)

- **PATRÓN** `dist_vwap_pct` < `0.2663` → IC=+0.148 (n=197)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.2663 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` < `0.9651` → IC=+0.144 (n=172)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.9651 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` > `0.7226` → IC=+0.161 (n=175)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.7226 (IC base=-0.026)

- **PATRÓN** `volumen_pendiente_norm` > `0.1505` → IC=+0.316 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1505 (IC base=-0.026)

- **PATRÓN** `volumen_spike_ratio` < `1.787` → IC=+0.245 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.787 (IC base=-0.026)

- **PATRÓN** `volumen_spike_ratio` > `2.2837` → IC=+0.241 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2837 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.218 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 146.0 (IC base=-0.026)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.200 (n=780)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6667
  - _Potencial_: sin este filtro IC_bueno=+0.249 (n=788)

- **FILTRO** `ibs_20min` > `0.7188` → IC=-0.236 (n=418)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7188
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1255)

- **FILTRO** `sigma_ewma_delta_pct` > `4.705` → IC=-0.166 (n=396)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.705
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1277)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.249 (n=788)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6667 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.1802` → IC=+0.308 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1802 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.284 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8616 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6359` → IC=+0.270 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6359 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` < `0.1055` → IC=+0.274 (n=498)
...
- **PATRÓN** `ibs_20min` < `0.4118` → IC=+0.123 (n=838)
...
- **PATRÓN** `volumen_regimen` < `0.7148` → IC=+0.240 (n=144)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6339` → IC=+0.200 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.6339 (IC base=+0.000)

- **PATRÓN** `volumen_spike_ratio` > `1.5315` → IC=+0.173 (n=295)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.5315 (IC base=+0.000)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.203 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.000)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.322 (n=666)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0147 (IC base=+0.265)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.283 (n=473)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.265)

- **PATRÓN** `ibs_20min` > `0.9016` → IC=+0.337 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9016 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` > `0.2558` → IC=+0.314 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2558 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.371` → IC=+0.293 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.371 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.752` → IC=+0.265 (n=1095)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.752 (IC base=+0.265)

- **PATRÓN** `volumen_regimen` > `0.6806` → IC=+0.283 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6806 (IC base=+0.265)

- **PATRÓN** `volumen_pendiente_norm` < `0.1097` → IC=+0.269 (n=873)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5517` → IC=+0.275 (n=411)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5517 (IC base=+0.265)

- **PATRÓN** `volumen_spike_ratio` > `2.2147` → IC=+0.269 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2147 (IC base=+0.265)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.269 (n=1043)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.265)

- **PATRÓN** `libro_liquidez` > `2572.5002` → IC=+0.271 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2572.5002 (IC base=+0.265)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.271 (n=361)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.007 (IC base=+0.265)

- **PATRÓN** `sigma_h` > `0.0202` → IC=+0.293 (n=491)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3913` → IC=+0.303 (n=1083)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3913 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` > `0.5163` → IC=+0.280 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5163 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.415` → IC=+0.283 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.415 (IC base=+0.265)

- **PATRÓN** `volumen_regimen` > `1.248` → IC=+0.310 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.248 (IC base=+0.265)
...
- **PATRÓN** `volumen_spike_ratio` < `2.559` → IC=+0.261 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.559 (IC base=+0.265)

- **PATRÓN** `volumen_spike_ratio` > `1.4431` → IC=+0.256 (n=924)
...
- **PATRÓN** `libro_liquidez` > `2549.3704` → IC=+0.276 (n=722)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2549.3704 (IC base=+0.265)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.181 (n=1916)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0047 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.202 (n=1916)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.3322` → IC=+0.175 (n=5053)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3322 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=5984)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.6957` → IC=+0.230 (n=5136)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6957 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.1627` → IC=+0.199 (n=2519)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1627 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.248 (n=1187)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.2168` → IC=+0.167 (n=3838)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2168 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6223` → IC=+0.162 (n=3837)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6223 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.1069` → IC=+0.186 (n=2241)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1069 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `2.311` → IC=+0.171 (n=4791)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.311 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6798` → IC=+0.167 (n=1815)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.6798 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `3813.9417` → IC=+0.176 (n=1914)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3813.9417 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.186 (n=4652)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 124.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.185 (n=3688)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0063 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.0782` → IC=+0.204 (n=1841)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4583` → IC=+0.225 (n=5516)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4583 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.276` → IC=+0.192 (n=959)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 10.276 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.1885` → IC=+0.151 (n=4033)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1885 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6254` → IC=+0.149 (n=4032)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6254 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2918` → IC=+0.229 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2918 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `1.574` → IC=+0.166 (n=2141)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.574 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6482` → IC=+0.176 (n=1622)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6482 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.168 (n=4475)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.205 (n=436)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3158` → IC=+0.206 (n=961)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.245 (n=280)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.359` → IC=+0.181 (n=830)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.359 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.189 (n=878)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.45` → IC=+0.226 (n=830)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.45 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.211` → IC=+0.221 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.211 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.669` → IC=+0.231 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.669 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.2719` → IC=+0.181 (n=830)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 1.2719 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.196 (n=179)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2352 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `1.4112` → IC=+0.205 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4112 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `11170.0615` → IC=+0.196 (n=742)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 11170.0615 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `409.0` → IC=+0.168 (n=661)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 409.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.177 (n=826)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0049 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.2856` → IC=+0.166 (n=939)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2856 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=863)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.5158` → IC=+0.194 (n=939)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.5158 (IC base=+0.148)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.285 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.576` → IC=+0.267 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.576 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` < `0.1074` → IC=+0.189 (n=774)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1074 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `3.6506` → IC=+0.203 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6506 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.204 (n=1056)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.234 (n=790)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.218)

- **PATRÓN** `drift_60min` |x|≤ `0.2232` → IC=+0.232 (n=527)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2232 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.265 (n=283)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.249 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.666` → IC=+0.267 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.666 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.278 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3592 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `3.5209` → IC=+0.246 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5209 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1887.9956` → IC=+0.237 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.9956 (IC base=+0.218)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.190 (n=794)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0065 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.4219` → IC=+0.175 (n=903)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.4219 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=904)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.4158` → IC=+0.210 (n=903)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4158 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.1337` → IC=+0.199 (n=602)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1337 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.299` → IC=+0.250 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.299 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `0.8636` → IC=+0.171 (n=602)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8636 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `1.1989` → IC=+0.180 (n=301)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 1.1989 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2879` → IC=+0.224 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2879 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `1.4062` → IC=+0.179 (n=294)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.4062 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `2.5537` → IC=+0.185 (n=293)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.5537 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `7316.3109` → IC=+0.197 (n=602)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 7316.3109 (IC base=+0.161)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.173 (n=741)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 156.0 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.154 (n=846)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.006 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.3707` → IC=+0.141 (n=961)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3707 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.186 (n=320)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 18.0 (IC base=+0.122)

- **PATRÓN** `ibs_20min` < `0.596` → IC=+0.176 (n=961)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.596 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.1485` → IC=+0.139 (n=953)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1485 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.245` → IC=+0.188 (n=190)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 12.245 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.131 (n=641)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8615 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.127 (n=961)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.6129 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.2875` → IC=+0.192 (n=141)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2875 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` < `1.7891` → IC=+0.126 (n=565)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.7891 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `9896.1185` → IC=+0.148 (n=436)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 9896.1185 (IC base=+0.122)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.147 (n=721)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0077 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=1106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.194 (n=1078)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.5169 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.0114` → IC=+0.224 (n=230)
...
- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.123 (n=1079)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.2184 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` < `0.1682` → IC=+0.127 (n=1079)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1682 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.8026` → IC=+0.126 (n=691)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.8026 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1105)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2898.521` → IC=+0.195 (n=489)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2898.521 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.137 (n=777)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 49.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.148 (n=464)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5385` → IC=+0.207 (n=1055)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5385 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.1881` → IC=+0.135 (n=975)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1881 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.33` → IC=+0.155 (n=224)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.33 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.0447` → IC=+0.125 (n=928)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.0447 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2724` → IC=+0.185 (n=125)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2724 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.573` → IC=+0.129 (n=402)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.573 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `2.173` → IC=+0.142 (n=414)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.173 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3082.5359` → IC=+0.158 (n=352)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3082.5359 (IC base=+0.112)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` < `0.0271` → IC=+0.201 (n=1028)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0271 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0177` → IC=+0.209 (n=685)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1064)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.250 (n=922)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.72 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.1955` → IC=+0.239 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1955 (IC base=+0.200)
...
- **PATRÓN** `volumen_regimen` < `1.2039` → IC=+0.205 (n=1028)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2039 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.6896` → IC=+0.212 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6896 (IC base=+0.200)
...
- **PATRÓN** `sigma_h` > `0.0221` → IC=+0.207 (n=490)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0221 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.0896` → IC=+0.219 (n=361)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.431` → IC=+0.238 (n=1080)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.431 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.2558` → IC=+0.204 (n=1123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2558 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.723` → IC=+0.228 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.723 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6291` → IC=+0.214 (n=1080)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6291 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.286 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `2.2526` → IC=+0.194 (n=832)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2526 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4623` → IC=+0.187 (n=945)
...
- **PATRÓN** `libro_liquidez` > `2509.5314` → IC=+0.210 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2509.5314 (IC base=+0.201)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.150 (n=455)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0038 (IC base=+0.144)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.159 (n=617)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0071 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.0946` → IC=+0.158 (n=454)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0946 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.188 (n=678)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.4079` → IC=+0.171 (n=1360)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.4079 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.7834` → IC=+0.195 (n=185)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.7834 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.731` → IC=+0.173 (n=616)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.731 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.8638` → IC=+0.163 (n=778)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8638 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.1656` → IC=+0.170 (n=374)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1656 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.162 (n=433)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4339 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.823` → IC=+0.155 (n=866)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.823 (IC base=+0.144)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=1507)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8223.8718` → IC=+0.174 (n=617)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 8223.8718 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.172 (n=391)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 20.0 (IC base=+0.144)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.152 (n=472)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0037 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.124 (n=503)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 17.0 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.6326` → IC=+0.137 (n=1408)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.6326 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.836` → IC=+0.125 (n=553)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 3.836 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.1668` → IC=+0.133 (n=360)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` > 0.1668 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.122 (n=1181)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.2373 (IC base=+0.102)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.149 (n=203)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0037 (IC base=+0.120)

- **PATRÓN** `drift_60min` |x|≤ `0.0998` → IC=+0.169 (n=134)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.0998 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.169 (n=279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 10.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.9018` → IC=+0.195 (n=139)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.9018 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.6865` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.6865 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.31` → IC=+0.187 (n=145)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 3.31 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` < `0.5894` → IC=+0.192 (n=102)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.5894 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.0648` → IC=+0.134 (n=129)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.0648 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.5129` → IC=+0.131 (n=261)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.5129 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `9438.6386` → IC=+0.161 (n=305)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 9438.6386 (IC base=+0.120)
...
- **PATRÓN** `drift_60min` |x|≤ `0.336` → IC=+0.138 (n=451)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.336 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.135 (n=403)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 7.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.6091` → IC=+0.174 (n=397)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6091 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` > `0.7151` → IC=+0.136 (n=402)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.7151 (IC base=+0.115)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4163` → IC=+0.139 (n=441)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.4163 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `256.0` → IC=+0.141 (n=279)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 256.0 (IC base=+0.115)
...
- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.225 (n=140)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0067 (IC base=+0.205)

- **PATRÓN** `drift_60min` |x|≤ `0.0949` → IC=+0.232 (n=140)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.2721` → IC=+0.243 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2721 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.3742` → IC=+0.230 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3742 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.123` → IC=+0.246 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.123 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `0.8331` → IC=+0.217 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8331 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `1.156` → IC=+0.232 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.156 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2439` → IC=+0.325 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2439 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `1.3686` → IC=+0.229 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3686 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `2.0266` → IC=+0.251 (n=187)
...
- **PATRÓN** `libro_liquidez` > `12421.138` → IC=+0.225 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12421.138 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.136 (n=237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0047 (IC base=+0.091)

- **PATRÓN** `ibs_20min` < `0.3254` → IC=+0.144 (n=237)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.3254 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.534` → IC=+0.146 (n=94)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 6.534 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` > `0.1661` → IC=+0.143 (n=82)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.1661 (IC base=+0.091)
...
- **PATRÓN** `sigma_h` < `0.0232` → IC=+0.171 (n=159)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0232 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.3235` → IC=+0.169 (n=140)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3235 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.191 (n=53)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 16.0 (IC base=+0.153)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.205 (n=76)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.7477` → IC=+0.194 (n=106)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.7477 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.2178` → IC=+0.180 (n=73)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.2178 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.5163` → IC=+0.153 (n=171)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.5163 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.784` → IC=+0.193 (n=125)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.784 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `0.9954` → IC=+0.155 (n=140)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.9954 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `0.8754` → IC=+0.176 (n=106)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8754 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` < `0.093` → IC=+0.180 (n=120)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` < 0.093 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `1.4421` → IC=+0.223 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4421 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.172 (n=169)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `2681.708` → IC=+0.162 (n=72)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2681.708 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.221 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 21.0 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.0222` → IC=+0.154 (n=79)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0222 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.135 (n=61)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 16.0 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `1.0558` → IC=+0.190 (n=27)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 1.0558 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.969` → IC=+0.174 (n=44)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 4.969 (IC base=+0.099)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.099)

- **PATRÓN** `volumen_spike_ratio` > `2.5879` → IC=+0.127 (n=73)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.5879 (IC base=+0.099)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.194 (n=3278)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0085 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7541)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4765` → IC=+0.212 (n=7223)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4765 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.8812` → IC=+0.199 (n=954)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8812 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.567` → IC=+0.220 (n=3546)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.567 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.166 (n=3256)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8827 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2399` → IC=+0.185 (n=1378)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2399 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6477` → IC=+0.180 (n=2287)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.6477 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=8611)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.04 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3760.6791` → IC=+0.174 (n=2408)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3760.6791 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.194 (n=5158)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 96.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.194 (n=4419)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0066 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.472` → IC=+0.182 (n=6628)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.472 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.201 (n=2517)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.236 (n=6634)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2287` → IC=+0.164 (n=4177)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2287 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.818` → IC=+0.198 (n=961)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.818 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.6243` → IC=+0.156 (n=1526)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6243 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2027` → IC=+0.164 (n=1526)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.2027 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2896` → IC=+0.251 (n=854)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2896 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.3046` → IC=+0.189 (n=2676)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.3046 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `128.0` → IC=+0.174 (n=5507)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 128.0 (IC base=+0.180)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.222 (n=405)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_spike_ratio` < `1.559` → IC=+0.195 (n=493)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.559 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.5899` → IC=+0.188 (n=373)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.5899 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.221 (n=1075)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.194)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.220 (n=874)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.262 (n=838)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.256)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.268 (n=853)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.1976` → IC=+0.285 (n=635)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1976 (IC base=+0.256)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=858)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` < `0.3517` → IC=+0.288 (n=838)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3517 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.621` → IC=+0.266 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.621 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.2284` → IC=+0.298 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2284 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `2.7082` → IC=+0.293 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7082 (IC base=+0.256)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.257 (n=970)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1908.78` → IC=+0.269 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1908.78 (IC base=+0.256)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.253 (n=791)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 77.0 (IC base=+0.256)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.191 (n=383)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0027 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.1813` → IC=+0.159 (n=761)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1813 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1192)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.6972` → IC=+0.246 (n=761)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6972 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.3384` → IC=+0.204 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3384 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.807` → IC=+0.167 (n=268)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 9.807 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.367` → IC=+0.157 (n=1011)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.367 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.2802` → IC=+0.165 (n=1141)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4449` → IC=+0.162 (n=1088)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4449 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7617` → IC=+0.159 (n=725)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7617 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `10616.3534` → IC=+0.173 (n=1020)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 10616.3534 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `497.0` → IC=+0.167 (n=1019)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3183` → IC=+0.167 (n=1020)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6389` → IC=+0.205 (n=1020)
...
- **PATRÓN** `ibs_20min` < `0.3802` → IC=+0.267 (n=967)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3802 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.713` → IC=+0.271 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.713 (IC base=+0.227)

- **PATRÓN** `volumen_pendiente_norm` > `0.3607` → IC=+0.293 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3607 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` < `2.9684` → IC=+0.214 (n=857)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9684 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` > `2.256` → IC=+0.230 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.256 (IC base=+0.227)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.238 (n=567)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.227)

- **PATRÓN** `libro_liquidez` > `1892.3232` → IC=+0.231 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1892.3232 (IC base=+0.227)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.222 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 39.0 (IC base=+0.227)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.171 (n=539)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0038 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.4224` → IC=+0.142 (n=1223)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4224 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.7134` → IC=+0.239 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7134 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.5525` → IC=+0.187 (n=340)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.5525 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.3` → IC=+0.171 (n=526)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 4.3 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8812` → IC=+0.165 (n=816)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8812 (IC base=+0.138)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4955` → IC=+0.149 (n=517)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4955 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.7489` → IC=+0.159 (n=782)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7489 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `8917.6013` → IC=+0.234 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8917.6013 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `91.0` → IC=+0.160 (n=368)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 91.0 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.181 (n=327)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0032 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.424` → IC=+0.151 (n=981)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.424 (IC base=+0.131)
...
- **PATRÓN** `ibs_20min` < `0.6885` → IC=+0.184 (n=981)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6885 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.3472` → IC=+0.135 (n=998)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.3472 (IC base=+0.131)
...
- **PATRÓN** `volumen_regimen` < `0.8591` → IC=+0.134 (n=654)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8591 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `1.1774` → IC=+0.153 (n=327)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1774 (IC base=+0.131)
...
- **PATRÓN** `volumen_spike_ratio` < `1.557` → IC=+0.139 (n=402)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.557 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.4583` → IC=+0.168 (n=305)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.4583 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `11073.7628` → IC=+0.181 (n=327)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 11073.7628 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.136 (n=905)
...
- **PATRÓN** `ibs_20min` > `0.463` → IC=+0.174 (n=1257)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.463 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `0.9949` → IC=+0.174 (n=219)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.9949 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.395` → IC=+0.212 (n=467)
...
- **PATRÓN** `libro_liquidez` > `2917.745` → IC=+0.243 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2917.745 (IC base=+0.095)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.125 (n=917)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 53.0 (IC base=+0.095)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.172 (n=525)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0061 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.1197` → IC=+0.150 (n=398)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.209 (n=1190)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.1923` → IC=+0.135 (n=969)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1923 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.394` → IC=+0.125 (n=1144)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.394 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `0.7148` → IC=+0.158 (n=524)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7148 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.2169` → IC=+0.183 (n=181)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2169 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.4645` → IC=+0.148 (n=345)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4645 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.2251` → IC=+0.124 (n=469)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.2251 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2938.2572` → IC=+0.163 (n=396)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2938.2572 (IC base=+0.115)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.216 (n=573)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1318)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.205 (n=1127)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.310 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.1816` → IC=+0.237 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1816 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.539` → IC=+0.242 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.539 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `1.2439` → IC=+0.207 (n=1264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2439 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.209 (n=1263)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.199 (n=1472)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 18.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` < `0.5065` → IC=+0.251 (n=1390)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5065 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` < `0.2635` → IC=+0.204 (n=1292)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2635 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.954` → IC=+0.263 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.954 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.240 (n=464)
...
- **PATRÓN** `volumen_spike_ratio` < `2.241` → IC=+0.190 (n=1068)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.241 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.4453` → IC=+0.195 (n=1213)
...
- **PATRÓN** `libro_liquidez` > `2528.706` → IC=+0.200 (n=927)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2528.706 (IC base=+0.197)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.143 (n=2447)

- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.151 (n=2046)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0096 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.53` → IC=+0.149 (n=2325)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.53 (IC base=+0.140)
...
- **PATRÓN** `ibs_20min` > `0.9342` → IC=+0.208 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9342 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.1884` → IC=+0.152 (n=788)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1884 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.736` → IC=+0.154 (n=739)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 5.736 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.7118` → IC=+0.129 (n=645)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 0.7118 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.9029` → IC=+0.143 (n=976)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.9029 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1741` → IC=+0.171 (n=639)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1741 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.4578` → IC=+0.153 (n=767)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4578 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.9026` → IC=+0.156 (n=1533)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.9026 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `8564.2271` → IC=+0.150 (n=1054)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8564.2271 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.195 (n=618)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0037 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.4774` → IC=+0.162 (n=1847)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1825` → IC=+0.164 (n=813)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.1825 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.6984` → IC=+0.147 (n=318)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.6984 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.225` → IC=+0.149 (n=1825)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.225 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2534` → IC=+0.144 (n=1756)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2534 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.154 (n=877)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.5773` → IC=+0.145 (n=1828)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.5773 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.824` → IC=+0.154 (n=1219)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.824 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.143 (n=2447)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `7756.485` → IC=+0.152 (n=1650)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 7756.485 (IC base=+0.140)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.163 (n=271)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0058 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.166 (n=273)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0034 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.0919` → IC=+0.183 (n=102)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.0919 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=316)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.5194` → IC=+0.199 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5194 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.2354` → IC=+0.174 (n=139)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.2354 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `8.25` → IC=+0.163 (n=390)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 8.25 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.2549` → IC=+0.156 (n=306)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.2549 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.8157` → IC=+0.184 (n=204)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.8157 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` < `0.1076` → IC=+0.150 (n=341)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2313` → IC=+0.242 (n=29)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2313 (IC base=+0.150)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3963` → IC=+0.188 (n=139)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.3963 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `12593.9941` → IC=+0.198 (n=273)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 12593.9941 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.204 (n=376)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.3657` → IC=+0.151 (n=853)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.6044` → IC=+0.150 (n=387)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.6044 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6011` → IC=+0.170 (n=113)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6011 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.22` → IC=+0.164 (n=832)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 6.22 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8855` → IC=+0.183 (n=569)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.8855 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0692` → IC=+0.163 (n=407)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0692 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.5773` → IC=+0.147 (n=850)
...
- **PATRÓN** `libro_liquidez` > `12056.8052` → IC=+0.150 (n=762)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12056.8052 (IC base=+0.139)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.199 (n=244)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.191 (n=250)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0102 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.4195` → IC=+0.173 (n=484)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.4195 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.217 (n=210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.988` → IC=+0.237 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.988 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.311` → IC=+0.214 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.311 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2095` → IC=+0.199 (n=154)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2095 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `3.4649` → IC=+0.164 (n=549)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 3.4649 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.8346` → IC=+0.173 (n=490)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8346 (IC base=+0.163)
...
- **PATRÓN** `ibs_20min` > `0.8016` → IC=+0.164 (n=316)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.8016 (IC base=+0.138)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.144 (n=645)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `8854.7868` → IC=+0.154 (n=623)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 8854.7868 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.168 (n=495)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0071 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.5078` → IC=+0.190 (n=559)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.5078 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.160 (n=210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.168 (n=384)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 11.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.103` → IC=+0.165 (n=559)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.103 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1525` → IC=+0.159 (n=259)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1525 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.3694` → IC=+0.160 (n=568)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.3694 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.041` → IC=+0.168 (n=266)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.041 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.6473` → IC=+0.182 (n=187)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6473 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.7334` → IC=+0.155 (n=500)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7334 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.184 (n=245)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.1843` → IC=+0.166 (n=483)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.1843 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.447` → IC=+0.168 (n=549)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.447 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `8151.1111` → IC=+0.167 (n=559)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 8151.1111 (IC base=+0.152)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.98` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 6.98 (IC base=+0.028)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.190 (n=405)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.6355` → IC=+0.208 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6355 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.1296` → IC=+0.162 (n=270)
...
- **PATRÓN** `volumen_regimen` < `0.6265` → IC=+0.133 (n=227)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.6265 (IC base=+0.099)

- **PATRÓN** `volumen_pendiente_norm` > `0.2901` → IC=+0.239 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2901 (IC base=+0.099)

- **PATRÓN** `volumen_spike_ratio` < `2.5485` → IC=+0.149 (n=411)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.5485 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.138 (n=415)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.02 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.162 (n=223)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.099)
...
- **FILTRO** `ibs_20min` < `0.6744` → IC=-0.191 (n=53)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6744
  - _Potencial_: sin este filtro IC_bueno=+0.196 (n=159)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.174 (n=84)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0058 (IC base=+0.075)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.131 (n=128)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 14.0 (IC base=+0.075)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.196 (n=159)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.703` → IC=+0.185 (n=87)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 3.703 (IC base=+0.075)

- **PATRÓN** `volumen_regimen` > `1.062` → IC=+0.154 (n=53)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.062 (IC base=+0.075)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5681` → IC=+0.171 (n=141)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.5681 (IC base=+0.075)

- **PATRÓN** `libro_liquidez` > `393.6556` → IC=+0.155 (n=137)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 393.6556 (IC base=+0.075)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=450)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.106)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.122 (n=419)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2813.2668` → IC=+0.162 (n=149)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2813.2668 (IC base=+0.106)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1274)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=530)
...
- **FILTRO** `hora_utc` < `17.0` → IC=-0.122 (n=43)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 17.0
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=5905)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=998)

- **FILTRO** `libro_liquidez` < `15847.2116` → IC=-0.151 (n=253)

  - _Acción_: SKIP cuando `libro_liquidez` < 15847.2116
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=760)

### MOMENTUM_IBS_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1212)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.176 (n=2475)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=7476)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.170 (n=2551)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=7743)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.215 (n=402)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.089 (n=1255)

- **FILTRO** `ibs_20min` < `0.748` → IC=-0.175 (n=414)

  - _Acción_: SKIP cuando `ibs_20min` < 0.748
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1243)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.196 (n=416)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1306)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.220 (n=427)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=1376)

- **FILTRO** `ibs_20min` > `0.2873` → IC=-0.177 (n=450)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2873
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1353)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.198 (n=399)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1236)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.190 (n=447)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=1368)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2206)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2153)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2159)
...
- **FILTRO** `ibs_20min` > `0.9763` → IC=-0.208 (n=46)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.122 (n=141)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=7236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=16284)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.274 (n=5838)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=17682)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.235 (n=5876)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=17644)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.160 (n=7873)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=15647)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.222 (n=7308)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=22032)

- **FILTRO** `ibs_7min` > `0.2982` → IC=-0.177 (n=7333)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2982
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=22007)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.317 (n=877)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2839)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.260 (n=1225)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2491)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.206 (n=861)

  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=2855)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=3449)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1666)

- **FILTRO** `drift_7min_pct` |x|> `0.1079` → IC=-0.124 (n=1735)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1079
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3380)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.203 (n=1276)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3839)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.141 (n=956)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3180)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.251 (n=1030)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3106)

- **FILTRO** `ibs_7min` < `0.7615` → IC=-0.184 (n=1033)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7615
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=3103)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.169 (n=1029)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3107)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.259 (n=964)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3194)

- **FILTRO** `ibs_7min` > `0.2504` → IC=-0.172 (n=1039)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2504
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3119)

- **FILTRO** `ballena_activa_n` > `113.0` → IC=-0.160 (n=1405)

  - _Acción_: SKIP cuando `ballena_activa_n` > 113.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2753)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.182 (n=859)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=2653)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.323 (n=827)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2685)

- **FILTRO** `drift_7min_pct` |x|> `0.1833` → IC=-0.131 (n=1194)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1833
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=2318)

- **FILTRO** `ibs_7min` < `0.2055` → IC=-0.272 (n=878)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2055
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2634)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.217 (n=874)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=2638)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.232 (n=1255)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4101)

- **FILTRO** `ibs_7min` > `0.2658` → IC=-0.156 (n=1821)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2658
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3535)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1232)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2645)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.248 (n=928)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2949)

- **FILTRO** `ibs_7min` < `0.7478` → IC=-0.189 (n=969)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7478
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=2908)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.185 (n=960)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2917)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=967)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=2969)

- **FILTRO** `ibs_7min` > `0.2769` → IC=-0.171 (n=983)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2769
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2953)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.179 (n=974)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2962)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.236 (n=1035)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3267)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.204 (n=1063)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3239)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.176 (n=1345)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4207)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=938)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3039)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.223 (n=992)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2985)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.199 (n=982)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2995)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.200 (n=1253)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=3970)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=932)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=470)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=859)

### STREAK_MOM_5M#XRP#5min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=498)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=2229)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1150)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1158)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.192 (n=336)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0089 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.0573` → IC=+0.172 (n=336)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.0573 (IC base=+0.170)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0589` → IC=+0.174 (n=1008)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio_macro` |x|> 0.0589 (IC base=+0.170)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3414` → IC=+0.210 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3414 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.170 (n=1053)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 4.0 (IC base=+0.170)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.194 (n=485)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 6.0 (IC base=+0.170)

- **PATRÓN** `ibs_15` > `0.6154` → IC=+0.242 (n=1007)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6154 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` < `0.1053` → IC=+0.174 (n=661)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1053 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.796` → IC=+0.255 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.796 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `9114.7808` → IC=+0.186 (n=336)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.150 (n=238)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0061 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.164 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0055 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0751` → IC=+0.154 (n=105)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0751 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1408` → IC=+0.171 (n=159)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.85€ cuando `delta_ratio_macro` |x|> 0.1408 (IC base=+0.140)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2712` → IC=+0.173 (n=148)

  - _Acción_: Kelly boost +0.87€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2712 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.154 (n=238)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 16.0 (IC base=+0.140)

- **PATRÓN** `ibs_15` > `0.6959` → IC=+0.258 (n=213)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6959 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1444` → IC=+0.172 (n=184)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1444 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.024` → IC=+0.216 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.024 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=281)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `10425.7161` → IC=+0.154 (n=108)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 10425.7161 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0223` → IC=+0.245 (n=96)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0223 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0859` → IC=+0.190 (n=127)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.0859 (IC base=+0.171)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0451` → IC=+0.183 (n=288)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.91€ cuando `delta_ratio_macro` |x|> 0.0451 (IC base=+0.171)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0926` → IC=+0.276 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0926 (IC base=+0.171)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.229 (n=142)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.171)

- **PATRÓN** `ibs_15` > `0.5294` → IC=+0.263 (n=289)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5294 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` > `0.1667` → IC=+0.194 (n=155)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1667 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.3037` → IC=+0.173 (n=270)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.3037 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.796` → IC=+0.208 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.796 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.247` → IC=+0.171 (n=259)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` < 7.247 (IC base=+0.171)

- **PATRÓN** `libro_liquidez` > `2708.8088` → IC=+0.214 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2708.8088 (IC base=+0.171)

- **PATRÓN** `ibs_15` < `0.1053` → IC=+0.170 (n=310)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1194` → IC=+0.234 (n=676)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1194 (IC base=-0.051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1821` → IC=+0.232 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1821 (IC base=-0.051)

- **PATRÓN** `ibs_15` < `0.3561` → IC=+0.273 (n=1015)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3561 (IC base=-0.051)

- **PATRÓN** `dist_vwap_pct` > `0.8488` → IC=+0.252 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8488 (IC base=-0.051)

- **PATRÓN** `dist_vwap_pct` < `0.2213` → IC=+0.220 (n=945)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2213 (IC base=-0.051)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.238 (n=281)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.4066` → IC=+0.223 (n=421)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4066 (IC base=+0.217)

- **PATRÓN** `drift_15min` |x|≤ `0.7457` → IC=+0.218 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7457 (IC base=+0.217)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2029` → IC=+0.241 (n=191)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2029 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.229 (n=286)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.217)

- **PATRÓN** `ibs_15` < `0.3657` → IC=+0.264 (n=421)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `19.617` → IC=+0.261 (n=44)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.617 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.977` → IC=+0.219 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.977 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `3640.4794` → IC=+0.220 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 