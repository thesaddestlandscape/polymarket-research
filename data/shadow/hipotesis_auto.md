# Hipótesis automáticas — 2026-07-03 21:20 UTC
_Generado por shadow_postmortem.py sobre 3221 resoluciones (PNL=-26.89€)_
...
- **PATRÓN** `sigma_h` < `0.0097` → IC=+0.194 (n=83)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0097 (IC base=+0.032)

- **PATRÓN** `ibs_15` < `0.0642` → IC=+0.151 (n=61)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.75€ cuando `ibs_15` < 0.0642 (IC base=+0.032)
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.188 (n=46)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0091 (IC base=+0.087)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.192 (n=24)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 7.0 (IC base=+0.087)

- **PATRÓN** `ibs_15` < `0.0949` → IC=+0.192 (n=37)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.96€ cuando `ibs_15` < 0.0949 (IC base=+0.087)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.0949 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.192 n=37). Confirma señal de reversión media → alinear con BUY_YES.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 518 | +0.064 | +73.43€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 518 | +0.064 | +73.43€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 136 | +0.036 | +8.18€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 136 | +0.036 | +8.18€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 135 | +0.011 | +3.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 135 | +0.011 | +3.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 129 | +0.095 | +30.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 129 | +0.095 | +30.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 118 | +0.117 | +31.55€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 118 | +0.117 | +31.55€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 875 | -0.043 | -54.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 644 | -0.022 | -26.17€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 351 | -0.016 | +3.06€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 266 | +0.000 | +10.04€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.063) — sin ventaja clara. oversold(IBS<0.3): IC=-0.012 n=170 | neutral: IC=-0.074 n=146 | overbought(IBS>0.7): IC=-0.052 n=152
  - _Datos_: n=485 IC=-0.044 PNL=-29.29€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.012 n=1550 | tras_1loss IC=-0.026 n=1569 | tras_2loss IC=-0.045 n=806/40 | gap=+0.057 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=752 IC=-0.038 PNL=-40.97€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=752 IC=-0.038 PNL=-40.97€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=278 IC=-0.025 PNL=-37.80€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=278 IC=-0.025 PNL=-37.80€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=232 IC=+0.009 PNL=+10.25€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=232 IC=+0.009 PNL=+10.25€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=788 IC=+0.034 PNL=+58.67€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=788 IC=+0.034 PNL=+58.67€
