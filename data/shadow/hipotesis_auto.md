# Hipótesis automáticas — 2026-08-26 20:06 UTC
_Generado por shadow_postmortem.py sobre 165703 resoluciones (PNL=+11807.11€)_
...
- **FILTRO** `py_entrada` < `0.705` → IC=-0.167 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.276 (n=226)

- **PATRÓN** `py_entrada` > `0.725` → IC=+0.292 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.152)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.167 (n=217)

  - _Acción_: Kelly boost +0.83€ cuando `n_ballena_banda` > 20.0 (IC base=+0.152)

- **PATRÓN** `n_total_lado` > `58.0` → IC=+0.242 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 58.0 (IC base=+0.152)

- **PATRÓN** `banda_hit_calibrado` > `0.8212` → IC=+0.282 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8212 (IC base=+0.152)

- **PATRÓN** `banda_z` > `10.497` → IC=+0.253 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.497 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.189 (n=162)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 11.0 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=247)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `3094.168` → IC=+0.243 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3094.168 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `288.0` → IC=+0.315 (n=79)
...
- **PATRÓN** `py_entrada` > `0.725` → IC=+0.298 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.193)

- **PATRÓN** `n_ballena_banda` > `24.0` → IC=+0.208 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `n_ballena_banda` > 24.0 (IC base=+0.193)

- **PATRÓN** `n_total_lado` > `52.0` → IC=+0.250 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 52.0 (IC base=+0.193)

- **PATRÓN** `banda_hit_calibrado` > `0.8208` → IC=+0.300 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8208 (IC base=+0.193)

- **PATRÓN** `banda_z` > `11.788` → IC=+0.308 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.788 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.225 (n=136)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.193)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.198 (n=177)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `3827.6428` → IC=+0.271 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3827.6428 (IC base=+0.193)

- **PATRÓN** `ballena_activa_n` < `296.0` → IC=+0.324 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 296.0 (IC base=+0.193)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.46` → IC=-0.282 (n=2291)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.46
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=6874)
...
- **FILTRO** `restante_s_al_confirmar` < `158.25` → IC=-0.194 (n=625)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1875)
...
- **FILTRO** `restante_s_al_confirmar` < `152.84` → IC=-0.357 (n=523)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 152.84
  - _Potencial_: sin este filtro IC_bueno=-0.119 (n=1063)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.186 (n=5226)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=1552)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2383.976` → IC=+0.175 (n=1498)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2383.976 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.148 (n=3489)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=2877)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1847.4259` → IC=+0.184 (n=2406)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1847.4259 (IC base=+0.141)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=621)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.214 (n=763)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `12707.8694` → IC=+0.223 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12707.8694 (IC base=+0.210)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.312 (n=396)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=4404)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.170 (n=407)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.241 (n=1003)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1077)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.192 (n=537)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.194 (n=10636)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.219 (n=8308)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.189)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.127 (n=2167)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.243 (n=1841)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.237 (n=1691)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.208 (n=1421)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.129 (n=2143)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.320 (n=403)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1876.0591` → IC=+0.302 (n=564)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.341 (n=187)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1865.3389` → IC=+0.324 (n=237)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9487` → IC=+0.207 (n=724)
...
- **PATRÓN** `dist_vwap_pct` < `0.741` → IC=+0.215 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.741 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.231` → IC=+0.170 (n=888)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.231 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` < `0.6324` → IC=+0.224 (n=154)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3074` → IC=+0.139 (n=164)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` > 0.3074 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `2.4495` → IC=+0.139 (n=1021)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.4495 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.2135` → IC=+0.132 (n=1481)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2135 (IC base=+0.031)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3368` → IC=+0.217 (n=316)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3368 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.236 (n=362)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.223 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.308` → IC=+0.235 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.308 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` < `0.5508` → IC=+0.211 (n=313)
...
- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.212 (n=359)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3527` → IC=+0.263 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3527 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `11201.4083` → IC=+0.218 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11201.4083 (IC base=+0.210)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0713` → IC=+0.140 (n=145)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.0713 (IC base=+0.128)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=203)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `1919.501` → IC=+0.140 (n=195)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 1919.501 (IC base=+0.128)
...
- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.168 (n=284)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7761
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=856)

- **FILTRO** `sigma_ewma_delta_pct` > `6.558` → IC=-0.168 (n=191)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.558
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=949)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.133 (n=1245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0075 (IC base=+0.051)

- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.245 (n=915)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9429 (IC base=+0.051)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1146` → IC=+0.165 (n=1214)
...
- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.264 (n=697)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=66)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=891)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.225 (n=205)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `1.3817` → IC=+0.336 (n=126)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3817 (IC base=+0.213)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0802` → IC=+0.219 (n=464)
...
- **PATRÓN** `libro_liquidez` > `2658.4002` → IC=+0.236 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2658.4002 (IC base=+0.213)
...
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.192 (n=789)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0098 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.3263` → IC=+0.155 (n=2083)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3263 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=833)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` > `0.6193` → IC=+0.167 (n=1645)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.6193 (IC base=+0.153)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8747` → IC=+0.179 (n=1003)
...
- **PATRÓN** `ballena_activa_n` < `202.0` → IC=+0.182 (n=1072)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.308 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.285)

- **PATRÓN** `drift_60min` |x|≤ `0.199` → IC=+0.315 (n=144)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.199 (IC base=+0.285)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.331 (n=146)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.285)

- **PATRÓN** `ibs_20min` < `0.3046` → IC=+0.318 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3046 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.425` → IC=+0.330 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.425 (IC base=+0.285)

- **PATRÓN** `volumen_pendiente_norm` > `0.3816` → IC=+0.423 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3816 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` > `2.0228` → IC=+0.297 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0228 (IC base=+0.285)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.258 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.285)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.219 (n=336)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0094 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.4977` → IC=+0.201 (n=336)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4977 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.213 (n=301)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `0.4502` → IC=+0.240 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4502 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` > `0.9816` → IC=+0.236 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9816 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.328` → IC=+0.321 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.328 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` > `0.6353` → IC=+0.201 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6353 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.101` → IC=+0.235 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.101 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `1.435` → IC=+0.230 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.435 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` > `2.4478` → IC=+0.218 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4478 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.187 (n=381)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `8687.9043` → IC=+0.212 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8687.9043 (IC base=+0.184)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.185 (n=182)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 156.0 (IC base=+0.184)
...
- **PATRÓN** `sigma_h` > `0.0227` → IC=+0.190 (n=230)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0227 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.1632` → IC=+0.189 (n=223)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.1632 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.189 (n=175)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9245` → IC=+0.259 (n=338)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9245 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `1.6505` → IC=+0.254 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6505 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.053` → IC=+0.242 (n=273)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.053 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` < `1.1875` → IC=+0.160 (n=507)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1875 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `0.8237` → IC=+0.185 (n=338)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.8237 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.0804` → IC=+0.218 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0804 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `2.1481` → IC=+0.175 (n=413)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 17.0 (IC base=+0.081)

- **PATRÓN** `ibs_20min` > `0.6252` → IC=+0.146 (n=360)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.273` → IC=+0.198 (n=117)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 8.273 (IC base=+0.081)

- **PATRÓN** `volumen_pendiente_norm` > `0.1727` → IC=+0.186 (n=100)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1727 (IC base=+0.081)

- **PATRÓN** `libro_liquidez` > `2902.7974` → IC=+0.124 (n=269)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2902.7974 (IC base=+0.081)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.169 (n=164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.004 (IC base=+0.075)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.147 (n=134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 16.0 (IC base=+0.075)

- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.123 (n=367)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.6296 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.17` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.17 (IC base=+0.075)

- **PATRÓN** `volumen_regimen` < `0.6508` → IC=+0.150 (n=115)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6508 (IC base=+0.075)

- **PATRÓN** `volumen_spike_ratio` < `1.8705` → IC=+0.138 (n=208)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.8705 (IC base=+0.075)

- **PATRÓN** `libro_liquidez` > `3963.5811` → IC=+0.130 (n=244)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8738` → IC=+0.157 (n=1617)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8738 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2240)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `3847.9652` → IC=+0.195 (n=914)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 3847.9652 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.189 (n=1201)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4594` → IC=+0.202 (n=2467)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4594 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.201 (n=908)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5552` → IC=+0.250 (n=2467)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.646` → IC=+0.198 (n=2317)
...
- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.171 (n=1340)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.187 (n=388)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 8.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` > `0.3271` → IC=+0.206 (n=433)
...
- **PATRÓN** `volumen_spike_ratio` < `2.109` → IC=+0.182 (n=338)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.109 (IC base=+0.156)
...
- **PATRÓN** `libro_liquidez` > `11733.6925` → IC=+0.191 (n=289)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.288 (n=225)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.331 (n=336)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.156 (n=437)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0089 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.170 (n=398)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 8.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.3557` → IC=+0.199 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3557 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.8828` → IC=+0.206 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8828 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.521` → IC=+0.195 (n=211)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 4.521 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.6307` → IC=+0.189 (n=146)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.6307 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `1.1984` → IC=+0.162 (n=146)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.1984 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4116` → IC=+0.235 (n=134)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4116 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `5254.2901` → IC=+0.237 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5254.2901 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.195 (n=208)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 167.0 (IC base=+0.144)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `1.4593` → IC=+0.288 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.4593 (IC base=+0.170)
...
- **PATRÓN** `volumen_regimen` > `1.0357` → IC=+0.198 (n=266)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 1.0357 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.1687` → IC=+0.244 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1687 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.5572` → IC=+0.167 (n=235)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5572 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `1.8201` → IC=+0.184 (n=356)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.8201 (IC base=+0.170)
...
- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.216 (n=311)
...
- **PATRÓN** `sigma_h` < `0.0099` → IC=+0.133 (n=377)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0099 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.156 (n=158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 17.0 (IC base=+0.108)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1531` → IC=+0.159 (n=121)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.1531 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` < `1.4918` → IC=+0.142 (n=185)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4918 (IC base=+0.108)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.131 (n=407)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `8162.0536` → IC=+0.152 (n=285)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8162.0536 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.154 (n=50)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0037 (IC base=+0.079)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.144 (n=57)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 10.0 (IC base=+0.079)

- **PATRÓN** `ibs_20min` < `0.8318` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.8318 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` > `0.6467` → IC=+0.196 (n=44)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.6467 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.472` → IC=+0.161 (n=57)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 4.472 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` < `0.1016` → IC=+0.150 (n=58)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.1016 (IC base=+0.079)

- **PATRÓN** `libro_liquidez` > `12609.7541` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 12609.7541 (IC base=+0.079)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=393)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.172 (n=762)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2372)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.212 (n=740)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=2401)

- **FILTRO** `ibs_20min` > `0.2721` → IC=-0.176 (n=785)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2721
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=2356)
...
- **FILTRO** `ballena_activa_n` > `78.0` → IC=-0.169 (n=131)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.184 (n=172)
...
- **FILTRO** `drift_20min_pct` |x|> `0.2855` → IC=-0.139 (n=167)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=1901)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=5844)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.287 (n=1858)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=5887)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.235 (n=1933)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=5812)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.175 (n=2566)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=5179)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.222 (n=2376)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=7131)

- **FILTRO** `ibs_7min` > `0.7176` → IC=-0.168 (n=2376)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7176
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=7131)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=809)
...
- **FILTRO** `ibs_7min` < `0.8038` → IC=-0.165 (n=383)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8038
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1151)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.193 (n=262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=835)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.318 (n=356)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=741)

- **FILTRO** `ibs_7min` < `0.2125` → IC=-0.290 (n=274)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2125
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=823)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.275 (n=273)
...
- **FILTRO** `hora_utc` > `15.0` → IC=-0.125 (n=433)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `ibs_7min` > `0.2707` → IC=-0.171 (n=326)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2707
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=983)

- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.208 (n=323)

  - _Acción_: SKIP cuando `ballena_activa_n` > 38.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=986)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.241 (n=345)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=1121)

- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.206 (n=366)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1100)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.209 (n=355)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1111)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.176 (n=433)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1316)
...
- **FILTRO** `ibs_7min` > `0.8272` → IC=-0.153 (n=399)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1198)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1145)
...
- **PATRÓN** `ibs_15` < `0.1136` → IC=+0.136 (n=421)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.133 (n=167)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0052 (IC base=+0.014)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.509` → IC=+0.145 (n=29)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 12.509 (IC base=+0.028)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.028)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0603` → IC=+0.357 (n=47)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0603 (IC base=+0.308)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1529` → IC=+0.321 (n=93)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1529 (IC base=+0.308)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.4171` → IC=+0.389 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.4171 (IC base=+0.308)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.324 (n=151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.308)

- **PATRÓN** `ibs_15` > `0.7363` → IC=+0.373 (n=140)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7363 (IC base=+0.308)

- **PATRÓN** `dist_vwap_pct` > `0.447` → IC=+0.381 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.447 (IC base=+0.308)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.489` → IC=+0.335 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.489 (IC base=+0.308)

- **PATRÓN** `libro_liquidez` > `7885.1862` → IC=+0.357 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7885.1862 (IC base=+0.308)

- **PATRÓN** `ballena_activa_n` < `535.0` → IC=+0.384 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 535.0 (IC base=+0.308)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0534` → IC=+0.413 (n=21)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0534 (IC base=+0.342)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1506` → IC=+0.405 (n=40)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1506 (IC base=+0.342)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.357 (n=40)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.342)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.339 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.342)

- **PATRÓN** `ibs_15` > `0.7117` → IC=+0.435 (n=60)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7117 (IC base=+0.342)

- **PATRÓN** `dist_vwap_pct` > `0.4534` → IC=+0.350 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4534 (IC base=+0.342)

- **PATRÓN** `dist_vwap_pct` < `0.3445` → IC=+0.339 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3445 (IC base=+0.342)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.664` → IC=+0.400 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.664 (IC base=+0.342)

- **PATRÓN** `libro_liquidez` > `3261.6008` → IC=+0.381 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3261.6008 (IC base=+0.342)

- **PATRÓN** `ballena_activa_n` < `198.0` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 198.0 (IC base=+0.342)

### UPDOWN_GBM_15M_TARDIO
- **FILTRO** `sigma_h` > `0.0094` → IC=-0.142 (n=241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `ibs_15` < `0.4526` → IC=-0.278 (n=97)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.164 (n=293)

- **FILTRO** `sigma_ewma_delta_pct` > `17.232` → IC=-0.180 (n=332)
...
- **PATRÓN** `ibs_15` > `0.4526` → IC=+0.164 (n=293)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `drift_60min` |x|≤ `0.0629` → IC=+0.189 (n=43)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0629 (IC base=+0.047)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3269` → IC=+0.223 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3269 (IC base=+0.047)

- **PATRÓN** `ibs_15` > `0.4477` → IC=+0.188 (n=126)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.94€ cuando `ibs_15` > 0.4477 (IC base=+0.047)

- **PATRÓN** `libro_liquidez` > `9700.4747` → IC=+0.217 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9700.4747 (IC base=+0.047)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4526 sube el IC de -0.055 a +0.164 en UPDOWN_GBM_15M_TARDIO (n=293). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.4477 sube el IC de +0.047 a +0.188 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=126). Ya aplicado como kelly_boost=+0.94€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7363 sube el IC de +0.308 a +0.373 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=140). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.7117 sube el IC de +0.342 a +0.435 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=60). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 594 | +0.087 | +47.59€ | 1 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 594 | +0.087 | +47.59€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 350 | +0.114 | +36.59€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 350 | +0.114 | +36.59€ | 0 | 10 |
...
| ✅ BALLENAS_TARDIAS | 6622 | -0.102 | -959.33€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 672 | -0.090 | -121.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5950 | -0.104 | -837.82€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2161 | -0.075 | -112.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2161 | -0.075 | -112.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1586 | -0.198 | -383.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1586 | -0.198 | -383.29€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30893 | +0.114 | -1997.01€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5746 | +0.187 | -179.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21890 | +0.094 | -1728.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3150 | +0.121 | -39.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3674 | +0.061 | -637.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3649 | +0.063 | -634.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6399 | +0.134 | -124.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1619 | +0.200 | -73.70€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3642 | +0.110 | -82.69€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 6873 | +0.128 | -93.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2093 | +0.169 | -10.69€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3645 | +0.113 | -53.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1123 | +0.103 | -21.47€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6592 | +0.133 | -411.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1977 | +0.202 | -99.10€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3638 | +0.097 | -230.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 931 | +0.132 | -72.19€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3672 | +0.104 | -258.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3654 | +0.105 | -255.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5710 | +0.172 | -459.68€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5710 | +0.172 | -459.68€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1425 | +0.157 | -174.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1425 | +0.157 | -174.84€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1280 | +0.231 | -34.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1280 | +0.231 | -34.76€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1378 | +0.183 | -109.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1378 | +0.183 | -109.74€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15657 | +0.189 | -1416.57€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15657 | +0.189 | -1416.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2875 | +0.123 | -539.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2875 | +0.123 | -539.85€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2433 | +0.236 | -52.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2433 | +0.236 | -52.87€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2480 | +0.231 | -69.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2480 | +0.231 | -69.54€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2535 | +0.214 | -130.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2535 | +0.214 | -130.96€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2638 | +0.183 | -267.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2638 | +0.183 | -267.23€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 5672 | +0.135 | +208.42€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 5672 | +0.135 | +208.42€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 2853 | +0.126 | +63.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 2853 | +0.126 | +63.82€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 751 | +0.302 | +11.27€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 751 | +0.302 | +11.27€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH |