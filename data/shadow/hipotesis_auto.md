# Hipótesis automáticas — 2026-08-14 08:51 UTC
_Generado por shadow_postmortem.py sobre 25037 resoluciones (PNL=+4934.41€)_
...
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.214 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.133)

- **PATRÓN** `restante_min` < `4.17` → IC=+0.155 (n=56)

  - _Acción_: Kelly boost +0.78€ cuando `restante_min` < 4.17 (IC base=+0.133)

- **PATRÓN** `restante_min` > `4.89` → IC=+0.172 (n=59)

  - _Acción_: Kelly boost +0.86€ cuando `restante_min` > 4.89 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.169 (n=137)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 6.0 (IC base=+0.133)

- **PATRÓN** `lag_apertura_s` < `6.36` → IC=+0.190 (n=56)

  - _Acción_: Kelly boost +0.95€ cuando `lag_apertura_s` < 6.36 (IC base=+0.133)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.231 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.125)

- **PATRÓN** `py_entrada` > `0.43` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.43 (IC base=+0.125)

- **PATRÓN** `restante_min` < `4.7` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` < 4.7 (IC base=+0.125)

- **PATRÓN** `restante_min` > `4.89` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` > 4.89 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.167 (n=70)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 6.0 (IC base=+0.125)

- **PATRÓN** `lag_apertura_s` < `6.37` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 6.37 (IC base=+0.125)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.41` → IC=+0.204 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.41 (IC base=+0.139)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.267 (n=28)
...
- **PATRÓN** `hora_utc` < `3.0` → IC=+0.141 (n=37)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 3.0 (IC base=+0.139)

- **PATRÓN** `lag_apertura_s` < `3.12` → IC=+0.326 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 3.12 (IC base=+0.139)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0053` → IC=+0.135 (n=72)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0053 (IC base=+0.090)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.214 (n=26)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
| ✅ BALLENAS_TARDIAS | 518 | +0.015 | -80.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 259 | +0.178 | -1.80€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 259 | -0.147 | -78.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 45 | +0.011 | -11.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 45 | +0.011 | -11.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 259 | +0.178 | -1.80€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 259 | +0.178 | -1.80€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 39 | -0.061 | -13.15€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 39 | -0.061 | -13.15€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#ETH | 68 | -0.300 | -16.11€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#ETH#5min | 68 | -0.300 | -16.11€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 78 | -0.138 | -31.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 78 | -0.138 | -31.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 29 | -0.145 | -6.02€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 29 | -0.145 | -6.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 5075 | +0.144 | -141.61€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2080 | +0.184 | -83.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 58 | -0.067 | -20.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 626 | +0.069 | -68.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2311 | +0.133 | +30.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 115 | +0.004 | -25.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 8 | -0.040 | -1.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 104 | +0.028 | -20.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 1560 | +0.150 | +7.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 571 | +0.181 | -48.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 23 | -0.020 | -7.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 105 | +0.070 | -7.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 861 | +0.143 | +70.64€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 108 | +0.009 | -28.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 105 | +0.023 | -23.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 1671 | +0.137 | -13.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 779 | +0.173 | +3.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 11 | -0.106 | -7.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 104 | +0.028 | -14.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 777 | +0.120 | +4.21€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#SOL | 1508 | +0.164 | -85.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 711 | +0.205 | -34.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 20 | +0.045 | -0.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 104 | +0.085 | -6.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 673 | +0.134 | -44.13€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 113 | +0.161 | +3.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min |
 | 0 | 0 |
| ✅ GBM_LATE_5M#SOL | 22 | -0.042 | +1.28€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 22 | -0.042 | +1.28€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M | 27 | -0.017 | -5.51€ | 0 | 0 |
| ✅ STREAK_FADE_5M#5min | 27 | -0.017 | -5.51€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH | 8 | +0.000 | -1.39€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH#5min | 8 | +0.000 | -1.39€ | 0 | 0 |
| ✅ STREAK_FADE_5M#SOL | 10 | -0.083 | -4.76€ | 0 | 0 |
| ✅ STREAK_FADE_5M#SOL#5min | 10 | -0.083 | -4.76€ | 0 | 0 |
...
| 🚫 STREAK_MOM_5M | 9 | -0.143 | -3.59€ | 0 | 0 |
| 🚫 STREAK_MOM_5M#5min | 9 | -0.143 | -3.59€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#XRP | 130 | +0.129 | +47.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 113 | +0.152 | +48.27€ | 0 | 2 |
| ✅ UPDOWN_GBM#XRP#240min | 9 | -0.021 | -0.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 8 | +0.000 | -0.08€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 765 | -0.018 | +57.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 765 | -0.018 | +57.77€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 95 | +0.077 | +30.17€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 95 | +0.077 | +30.17€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 206 | -0.014 | +11.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 206 | -0.014 | +11.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 211 | +0.002 | +27.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 211 | +0.002 | +27.24€ | 0 | 0 |
...
| ✅ UPDOWN_OU_5M | 25 | -0.093 | -2.19€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#5min | 25 | -0.093 | -2.19€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB | 7 | +0.019 | +0.41€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB#5min | 7 | +0.019 | +0.41€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.124) — sin ventaja clara. oversold(IBS<0.3): IC=+0.027 n=273 | neutral: IC=-0.004 n=252 | overbought(IBS>0.7): IC=+0.120 n=414
  - _Datos_: n=982 IC=+0.055 PNL=+80.51€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.131 n=15200 | tras_1loss IC=+0.090 n=9492 | tras_2loss IC=+0.052 n=3855/40 | gap=+0.079 (umbral 0.05)
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=+0.029 n=68 | contrario_BTC IC=-0.064 n=37/40 | gap=-0.093 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=683 IC=+0.023 PNL=+50.40€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=683 IC=+0.023 PNL=+50.40€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=203 IC=+0.090 PNL=+18.76€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=203 IC=+0.090 PNL=+18.76€
...
**🔶 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA en BTC (IC=+0.011 n=88) pero sin cruzar ≥2 pares más — BNB: n=12 IC=+0.129; DOGE: n=9 IC=-0.021; ETH: n=131 IC=+0.102; SOL: n=50 IC=-0.038 ✓; XRP: n=113 IC=+0.152
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=252 IC=+0.075 PNL=+28.11€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=252 IC=+0.075 PNL=+28.11€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=416 IC=+0.031 PNL=+10.63€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=416 IC=+0.031 PNL=+10.63€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.146 > 0.1 con n=272 PNL=+73.15€
  - _Datos_: n=272 IC=+0.146 PNL=+73.15€
...
**🔶 H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.141 n=62) pero sin cruzar ≥2 pares más — BNB: n=6 IC=+0.037; BTC: n=21 IC=-0.152; DOGE: n=7 IC=+0.019; ETH: n=73 IC=+0.140 ✓; SOL: n=31 IC=-0.106
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=389 IC=-0.109 PNL=+70.80€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=389 IC=-0.109 PNL=+70.80€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=169 IC=+0.067 PNL=+28.57€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=169 IC=+0.067 PNL=+28.57€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.090 > 0.08 con n=203 PNL=+18.76€
  - _Datos_: n=203 IC=+0.090 PNL=+18.76€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.204 > 0.2 con n=370 PNL=+243.24€
  - _Datos_: n=370 IC=+0.204 PNL=+243.24€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.156 > 0.08 con n=152 PNL=+65.43€
  - _Datos_: n=152 IC=+0.156 PNL=+65.43€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=81 IC=+0.090 PNL=-19.50€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=81 IC=+0.090 PNL=-19.50€
