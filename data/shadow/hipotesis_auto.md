# Hipótesis automáticas — 2026-09-17 15:03 UTC
_Generado por shadow_postmortem.py sobre 482977 resoluciones (PNL=+52144.46€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.01` → IC=-0.249 (n=5949)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.01
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=17850)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `141.04` → IC=-0.268 (n=820)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.04
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2463)
...
- **FILTRO** `restante_s_al_confirmar` < `158.37` → IC=-0.243 (n=1414)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.37
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4245)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `117.08` → IC=-0.367 (n=1153)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 117.08
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=3460)
...
- **FILTRO** `py_entrada` > `0.57` → IC=-0.162 (n=134)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.197 (n=12018)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=2995)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `11413.5383` → IC=+0.191 (n=956)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11413.5383 (IC base=+0.097)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.246 (n=8232)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.171 (n=5901)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7280.4309` → IC=+0.178 (n=1863)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 7280.4309 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.209 (n=1422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=1406)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.350 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=1755)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `15192.6768` → IC=+0.221 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15192.6768 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.208 (n=1290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.210 (n=1422)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.273 (n=1242)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1821)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `14959.5303` → IC=+0.227 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14959.5303 (IC base=+0.203)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2405)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.138 (n=2056)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.85` → IC=+0.425 (n=556)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.180 (n=982)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.179 (n=1137)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=699)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.137 (n=334)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.121)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.175 (n=2256)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.177 (n=2342)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=5179)
...
- **PATRÓN** `lag_apertura_s` < `3.28` → IC=+0.152 (n=3921)
...
- **PATRÓN** `restante_min` < `4.01` → IC=+0.136 (n=1943)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 4.01 (IC base=+0.129)

- **PATRÓN** `restante_min` > `4.93` → IC=+0.146 (n=2108)
...
- **PATRÓN** `lag_apertura_s` < `2.47` → IC=+0.149 (n=1977)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.4996` → IC=+0.155 (n=5745)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.4996 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.1444` → IC=+0.245 (n=1283)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1444 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.855` → IC=+0.168 (n=2489)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.855 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `1.2224` → IC=+0.243 (n=1651)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2224 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.0681` → IC=+0.243 (n=748)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0681 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.1746` → IC=+0.191 (n=4422)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1746 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.3068` → IC=+0.202 (n=619)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3068 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.9174` → IC=+0.198 (n=2843)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.9174 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.132 (n=7880)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.57 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` > `0.5602` → IC=+0.186 (n=472)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5602 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` < `0.3377` → IC=+0.171 (n=2760)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3377 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` < `0.7035` → IC=+0.174 (n=1143)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.7035 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` > `0.8734` → IC=+0.178 (n=1731)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.8734 (IC base=+0.061)

- **PATRÓN** `volumen_pendiente_norm` > `0.244` → IC=+0.225 (n=874)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.244 (IC base=+0.061)

- **PATRÓN** `volumen_spike_ratio` > `1.587` → IC=+0.201 (n=3856)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.587 (IC base=+0.061)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.211 (n=4089)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.034` → IC=+0.276 (n=635)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.251 (n=734)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.362` → IC=+0.248 (n=1121)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.362 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.231 (n=905)
...
- **PATRÓN** `ibs_20min` < `0.6747` → IC=+0.175 (n=1176)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6747 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.126` → IC=+0.151 (n=1073)
...
- **PATRÓN** `volumen_regimen` < `1.2157` → IC=+0.145 (n=1176)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2157 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.8532` → IC=+0.142 (n=784)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.8532 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1571` → IC=+0.183 (n=317)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1571 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.4323` → IC=+0.152 (n=1066)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4323 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `13563.1426` → IC=+0.151 (n=784)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13563.1426 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `242.0` → IC=+0.161 (n=432)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 242.0 (IC base=+0.139)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.189 (n=1420)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0058 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=1494)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.252 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.505` → IC=+0.229 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.505 (IC base=+0.176)

- **PATRÓN** `volumen_pendiente_norm` < `0.1062` → IC=+0.183 (n=1205)
...
- **PATRÓN** `volumen_spike_ratio` > `3.0006` → IC=+0.198 (n=604)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 3.0006 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=1635)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.218 (n=1087)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3808` → IC=+0.234 (n=1071)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3808 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.688` → IC=+0.233 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.688 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.323` → IC=+0.219 (n=1333)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1796)

- **PATRÓN** `ibs_20min` > `0.9343` → IC=+0.177 (n=295)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.9343 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` > `0.328` → IC=+0.344 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.328 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` < `0.4826` → IC=+0.325 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4826 (IC base=+0.008)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.401` → IC=+0.136 (n=559)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.401 (IC base=+0.008)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4621` → IC=+0.330 (n=227)
...
- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.349 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 164.0 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` > `0.1669` → IC=+0.187 (n=209)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1669 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.158 (n=264)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6973 (IC base=+0.006)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5104` → IC=+0.189 (n=490)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 1.5104 (IC base=+0.006)
...
- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.129 (n=1807)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2692
  - _Potencial_: sin este filtro IC_bueno=+0.121 (n=892)

- **FILTRO** `sigma_ewma_delta_pct` > `8.637` → IC=-0.208 (n=296)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.637
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2403)
...
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.195 (n=451)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1355)

- **FILTRO** `ibs_20min` < `0.6679` → IC=-0.161 (n=1191)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6679
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=615)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.202 (n=380)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1426)

- **FILTRO** `ibs_20min` > `0.775` → IC=-0.199 (n=680)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4768` → IC=+0.244 (n=1461)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4768 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` > `2.7559` → IC=+0.237 (n=1461)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7559 (IC base=+0.088)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.277 (n=3875)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.088)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.141 (n=2728)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0086 (IC base=+0.069)

- **PATRÓN** `ibs_20min` < `0.5554` → IC=+0.151 (n=7179)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5554 (IC base=+0.069)

- **PATRÓN** `dist_vwap_pct` > `0.6734` → IC=+0.247 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6734 (IC base=+0.069)

- **PATRÓN** `dist_vwap_pct` < `0.163` → IC=+0.233 (n=2111)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.163 (IC base=+0.069)

- **PATRÓN** `volumen_regimen` < `0.7171` → IC=+0.233 (n=998)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7171 (IC base=+0.069)

- **PATRÓN** `volumen_regimen` > `1.2011` → IC=+0.250 (n=755)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2011 (IC base=+0.069)

- **PATRÓN** `volumen_pendiente_norm` > `0.2511` → IC=+0.316 (n=596)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3739` → IC=+0.255 (n=1336)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3739 (IC base=+0.069)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.258 (n=2813)
...
- **FILTRO** `ibs_20min` < `0.2379` → IC=-0.144 (n=551)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1653)

- **FILTRO** `sigma_ewma_delta_pct` > `4.372` → IC=-0.169 (n=409)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.372
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1371)

- **PATRÓN** `ibs_20min` > `0.8687` → IC=+0.256 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8687 (IC base=+0.039)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.29` → IC=+0.152 (n=749)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4401` → IC=+0.213 (n=193)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4401 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` > `2.6094` → IC=+0.197 (n=193)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.6094 (IC base=+0.039)
...
- **FILTRO** `ibs_20min` > `0.8224` → IC=-0.144 (n=600)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1801)

- **PATRÓN** `dist_vwap_pct` > `0.289` → IC=+0.139 (n=261)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.289 (IC base=+0.012)

- **PATRÓN** `dist_vwap_pct` < `0.1582` → IC=+0.136 (n=608)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1582 (IC base=+0.012)

- **PATRÓN** `volumen_regimen` > `0.6556` → IC=+0.143 (n=634)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6556 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` > `0.2196` → IC=+0.179 (n=129)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.2196 (IC base=+0.012)
...
- **PATRÓN** `volumen_regimen` > `0.5983` → IC=+0.205 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5983 (IC base=+0.002)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8204` → IC=+0.207 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8204 (IC base=+0.002)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.255 (n=1457)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.238)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.298 (n=1018)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.585` → IC=+0.280 (n=1098)
...
- **FILTRO** `ibs_20min` < `0.2479` → IC=-0.210 (n=371)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1118)
...
- **PATRÓN** `ibs_20min` > `0.8055` → IC=+0.150 (n=507)
...
- **PATRÓN** `dist_vwap_pct` > `0.122` → IC=+0.207 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.122 (IC base=-0.015)

- **PATRÓN** `volumen_regimen` < `1.1418` → IC=+0.181 (n=261)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 1.1418 (IC base=-0.015)

- **PATRÓN** `volumen_regimen` > `0.7266` → IC=+0.185 (n=233)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.7266 (IC base=-0.015)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7898` → IC=+0.250 (n=146)
...
- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.253 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 146.0 (IC base=-0.015)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6774` → IC=-0.211 (n=868)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6774
  - _Potencial_: sin este filtro IC_bueno=+0.263 (n=868)

- **FILTRO** `ibs_20min` > `0.7105` → IC=-0.234 (n=456)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7105
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1374)

- **FILTRO** `sigma_ewma_delta_pct` > `4.635` → IC=-0.175 (n=426)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.635
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=1404)

- **PATRÓN** `ibs_20min` > `0.6774` → IC=+0.263 (n=868)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6774 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.1799` → IC=+0.315 (n=370)
...
- **PATRÓN** `volumen_regimen` < `0.8657` → IC=+0.293 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8657 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.7204` → IC=+0.277 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7204 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` < `0.1058` → IC=+0.279 (n=559)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4456` → IC=+0.318 (n=196)
...
- **PATRÓN** `volumen_regimen` < `0.7154` → IC=+0.244 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7154 (IC base=+0.004)

- **PATRÓN** `volumen_pendiente_norm` < `0.1007` → IC=+0.190 (n=350)
...
- **PATRÓN** `volumen_spike_ratio` < `2.629` → IC=+0.205 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.629 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` > `1.4993` → IC=+0.182 (n=360)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4993 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.223 (n=359)
...
- **PATRÓN** `ibs_20min` > `0.9043` → IC=+0.347 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9043 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` > `0.2632` → IC=+0.318 (n=543)
...
- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.200 (n=2123)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0106 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.3373` → IC=+0.174 (n=5581)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3373 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=6613)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.582` → IC=+0.214 (n=6342)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.582 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9323` → IC=+0.218 (n=942)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9323 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.225` → IC=+0.248 (n=1310)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.225 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `1.2153` → IC=+0.162 (n=4213)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2153 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` > `0.623` → IC=+0.158 (n=4212)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.623 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.1064` → IC=+0.184 (n=2488)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1064 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `1.5654` → IC=+0.173 (n=2655)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5654 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6607` → IC=+0.170 (n=2011)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.6607 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `3828.4706` → IC=+0.168 (n=2114)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3828.4706 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.180 (n=5257)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.205 (n=2051)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4698` → IC=+0.229 (n=6150)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4698 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2208` → IC=+0.161 (n=4588)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.024` → IC=+0.253 (n=839)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.024 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.0953` → IC=+0.233 (n=635)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=810)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1746.26` → IC=+0.259 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1746.26 (IC base=+0.237)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3647` → IC=+0.170 (n=929)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3647 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=981)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.224 (n=929)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2039` → IC=+0.206 (n=543)
...
- **PATRÓN** `volumen_regimen` < `1.2593` → IC=+0.172 (n=929)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.2593 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2311` → IC=+0.186 (n=205)
...
- **PATRÓN** `libro_liquidez` > `10111.2304` → IC=+0.176 (n=929)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 10111.2304 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1052)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.162 (n=973)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 7.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` < `0.5407` → IC=+0.190 (n=1052)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.5407 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.164 (n=1073)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1332 (IC base=+0.145)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.197 (n=1055)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0059 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.1976` → IC=+0.203 (n=703)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.286 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.698` → IC=+0.271 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.698 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` < `0.2152` → IC=+0.185 (n=1012)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=1201)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.180 (n=880)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0066 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.4235` → IC=+0.165 (n=1000)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.4235 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.188 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 17.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.3943` → IC=+0.203 (n=999)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3943 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.1357` → IC=+0.187 (n=653)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1357 (IC base=+0.151)
...
- **PATRÓN** `volumen_regimen` < `0.8585` → IC=+0.161 (n=668)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8585 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `1.1941` → IC=+0.166 (n=333)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1941 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.215 (n=156)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4126` → IC=+0.165 (n=326)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4126 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `2.5102` → IC=+0.183 (n=326)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.5102 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `7103.48` → IC=+0.186 (n=666)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 7103.48 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `149.0` → IC=+0.154 (n=823)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3806` → IC=+0.146 (n=1073)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6046` → IC=+0.184 (n=1073)
...
- **PATRÓN** `volumen_regimen` < `0.8554` → IC=+0.145 (n=716)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8554 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `0.6094` → IC=+0.133 (n=1073)
...
- **PATRÓN** `volumen_spike_ratio` < `1.799` → IC=+0.141 (n=638)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.799 (IC base=+0.132)
...
- **PATRÓN** `dist_vwap_pct` > `1.0126` → IC=+0.227 (n=247)
...
- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.122 (n=1174)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2233 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.8139` → IC=+0.127 (n=751)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.8139 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1212)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.191 (n=532)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2898.7698 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.132 (n=868)
...
- **PATRÓN** `ibs_20min` > `0.7255` → IC=+0.254 (n=994)
...
- **PATRÓN** `volumen_regimen` < `1.2084` → IC=+0.208 (n=1113)
...
- **PATRÓN** `dist_vwap_pct` < `0.265` → IC=+0.203 (n=1246)
...
- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.217 (n=1188)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2447` → IC=+0.196 (n=925)
...
- **PATRÓN** `libro_liquidez` > `2545.8374` → IC=+0.214 (n=792)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2545.8374 (IC base=+0.203)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.167 (n=515)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0089 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.0981` → IC=+0.149 (n=514)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.0981 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.178 (n=765)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.3929` → IC=+0.168 (n=1541)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.3929 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.8094` → IC=+0.174 (n=213)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.8094 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.696` → IC=+0.168 (n=708)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.696 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8703` → IC=+0.157 (n=886)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8703 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.1633` → IC=+0.167 (n=424)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1633 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5517` → IC=+0.164 (n=492)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.5517 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=1719)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `2476.2478` → IC=+0.144 (n=1376)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2476.2478 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.159 (n=1319)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 160.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.151 (n=548)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0038 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.34` → IC=+0.132 (n=1446)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.34 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1659)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.145` → IC=+0.122 (n=1397)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.145 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.009` → IC=+0.135 (n=474)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1674` → IC=+0.142 (n=417)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.1674 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.136 (n=1385)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.2373 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `3608.3141` → IC=+0.123 (n=1095)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 3608.3141 (IC base=+0.117)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1096` → IC=+0.144 (n=158)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.1096 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.142 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 9.0 (IC base=+0.101)

- **PATRÓN** `ibs_20min` > `0.2836` → IC=+0.133 (n=358)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` > 0.2836 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.5042` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.5042 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.328` → IC=+0.139 (n=167)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 3.328 (IC base=+0.101)

- **PATRÓN** `volumen_regimen` < `0.7067` → IC=+0.144 (n=158)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.7067 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `10160.5257` → IC=+0.128 (n=358)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 10160.5257 (IC base=+0.101)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.152 (n=110)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 156.0 (IC base=+0.101)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.211 (n=171)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.34` → IC=+0.155 (n=508)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.34 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.151 (n=456)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 7.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.3419` → IC=+0.207 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3419 (IC base=+0.135)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.142` → IC=+0.136 (n=578)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 9.142 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.063` → IC=+0.178 (n=231)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.063 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1596` → IC=+0.215 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1596 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `2.1115` → IC=+0.160 (n=439)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1115 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4209` → IC=+0.142 (n=498)
...
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.126 (n=153)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` > 0.0085 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.133 (n=309)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 8.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.8947` → IC=+0.208 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8947 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.7744` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.7744 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.239` → IC=+0.179 (n=154)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 5.239 (IC base=+0.093)

- **PATRÓN** `volumen_regimen` < `1.0562` → IC=+0.121 (n=296)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.0562 (IC base=+0.093)

- **PATRÓN** `volumen_pendiente_norm` > `0.288` → IC=+0.160 (n=48)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.288 (IC base=+0.093)

- **PATRÓN** `volumen_spike_ratio` > `2.2214` → IC=+0.126 (n=145)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.2214 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `3071.7984` → IC=+0.219 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3071.7984 (IC base=+0.093)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.150 (n=101)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 20.0 (IC base=+0.093)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.192 (n=3654)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0087 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=8393)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.212 (n=8051)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.8882` → IC=+0.197 (n=1036)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.8882 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.767` → IC=+0.232 (n=3011)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.767 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8842` → IC=+0.167 (n=3602)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8842 (IC base=+0.164)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6354` → IC=+0.182 (n=2556)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6354 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3810.063` → IC=+0.168 (n=2680)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3810.063 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `92.0` → IC=+0.193 (n=5870)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 92.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.195 (n=4921)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0068 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4815` → IC=+0.184 (n=7373)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5605` → IC=+0.240 (n=7373)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5605 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2311` → IC=+0.163 (n=4683)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2311 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.852` → IC=+0.196 (n=1057)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 9.852 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.683` → IC=+0.184 (n=7128)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 3.683 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `1.0615` → IC=+0.156 (n=4489)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.0615 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2046` → IC=+0.158 (n=1700)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.2046 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2891` → IC=+0.247 (n=959)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2891 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.2995` → IC=+0.191 (n=3009)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2995 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.180 (n=6252)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5466` → IC=+0.182 (n=558)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5623` → IC=+0.197 (n=423)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.5623 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.215 (n=1264)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.190)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.258 (n=929)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.256)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.265 (n=1056)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0044 (IC base=+0.256)

- **PATRÓN** `drift_60min` |x|≤ `0.2039` → IC=+0.283 (n=704)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2039 (IC base=+0.256)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.268 (n=955)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` < `0.3469` → IC=+0.287 (n=928)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3469 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.416` → IC=+0.264 (n=1108)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.416 (IC base=+0.256)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8834` → IC=+0.278 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8834 (IC base=+0.256)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1102)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1747.06` → IC=+0.277 (n=703)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1747.06 (IC base=+0.256)
...
- **PATRÓN** `drift_60min` |x|≤ `0.356` → IC=+0.151 (n=1279)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.356 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1334)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.3171` → IC=+0.198 (n=1278)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3171 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.188 (n=702)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.124 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.945` → IC=+0.153 (n=433)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 6.945 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.33` → IC=+0.155 (n=1136)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.33 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6994` → IC=+0.181 (n=563)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6994 (IC base=+0.148)
...
- **PATRÓN** `ibs_20min` < `0.6377` → IC=+0.205 (n=1139)
...
- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.162 (n=1139)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.204 (IC base=+0.154)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4232` → IC=+0.168 (n=1042)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.4232 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.757` → IC=+0.160 (n=694)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.757 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `12529.5931` → IC=+0.156 (n=759)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12529.5931 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `368.0` → IC=+0.169 (n=632)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 368.0 (IC base=+0.154)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.225 (n=1284)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=1345)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.212 (n=1305)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.6709` → IC=+0.248 (n=1146)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6709 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.556` → IC=+0.301 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.556 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` < `0.2161` → IC=+0.214 (n=1244)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2161 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.9903` → IC=+0.230 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9903 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.223 (n=1473)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.238 (n=1219)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.234)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.240 (n=556)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3642` → IC=+0.269 (n=1072)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3642 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.708` → IC=+0.275 (n=433)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7946` → IC=+0.229 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7946 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.2488` → IC=+0.233 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2488 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.248 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1896.567` → IC=+0.243 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1896.567 (IC base=+0.234)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4335` → IC=+0.139 (n=1364)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.4335 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=1426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.7004` → IC=+0.230 (n=909)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7004 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.5568` → IC=+0.177 (n=363)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.5568 (IC base=+0.135)
...
- **PATRÓN** `ibs_20min` < `0.6877` → IC=+0.196 (n=1104)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.194` → IC=+0.143 (n=1032)
...
- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.151 (n=368)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.1808 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2782` → IC=+0.271 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2782 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.472` → IC=+0.172 (n=345)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.472 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `11047.6745` → IC=+0.205 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11047.6745 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.144 (n=905)
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.182 (n=1375)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.4706 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `1.0011` → IC=+0.186 (n=240)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 1.0011 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.417` → IC=+0.226 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.417 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=953)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2920.0962` → IC=+0.241 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2920.0962 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.126 (n=1030)
...
- **PATRÓN** `dist_vwap_pct` < `0.4676` → IC=+0.129 (n=1308)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4676 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.126 (n=1280)
...
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.214 (n=926)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1447)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `0.5111` → IC=+0.244 (n=1386)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5111 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.1843` → IC=+0.232 (n=782)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1843 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.371` → IC=+0.248 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.371 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `1.2484` → IC=+0.210 (n=1387)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2484 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.209 (n=1386)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6307 (IC base=+0.205)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5687` → IC=+0.240 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5687 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1409)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2584.1244` → IC=+0.209 (n=924)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2584.1244 (IC base=+0.205)
...
- **PATRÓN** `ibs_20min` < `0.5122` → IC=+0.253 (n=1528)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5122 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.2673` → IC=+0.205 (n=1427)
...
- **PATRÓN** `libro_liquidez` > `2318.1516` → IC=+0.121 (n=576)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1363)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=601)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=6618)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.179 (n=2769)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=8435)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.173 (n=2860)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=8819)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.215 (n=475)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.094 (n=1425)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.169 (n=484)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.204 (n=471)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1474)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.200 (n=454)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1418)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.194 (n=507)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1553)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=2520)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2526)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=8036)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=18095)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=6166)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=19965)

- **FILTRO** `ibs_7min` < `0.7005` → IC=-0.243 (n=6532)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7005
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=19599)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.160 (n=8880)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=17251)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=8207)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=24681)

- **FILTRO** `ibs_7min` > `0.2955` → IC=-0.176 (n=8220)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2955
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=24668)
...
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=999)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3218)

- **FILTRO** `ibs_7min` < `0.7068` → IC=-0.263 (n=1391)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7068
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2826)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.197 (n=975)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3242)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.150 (n=3826)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1889)

- **FILTRO** `drift_7min_pct` |x|> `0.1106` → IC=-0.122 (n=1943)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1106
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3772)

- **FILTRO** `ibs_7min` > `0.7979` → IC=-0.207 (n=1428)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7979
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4287)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1056)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3504)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=1076)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3484)

- **FILTRO** `ibs_7min` < `0.7551` → IC=-0.190 (n=1140)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7551
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3420)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.178 (n=1134)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3426)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.256 (n=1101)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3543)

- **FILTRO** `ibs_7min` > `0.2534` → IC=-0.170 (n=1160)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2534
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3484)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.183 (n=1153)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3491)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=970)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=2975)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.316 (n=951)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2994)

- **FILTRO** `drift_7min_pct` |x|> `0.1801` → IC=-0.132 (n=1341)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1801
  - _Potencial_: sin este filtro IC_bueno=-0.104 (n=2604)

- **FILTRO** `ibs_7min` < `0.2` → IC=-0.273 (n=977)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=2968)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.220 (n=917)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3028)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.234 (n=1414)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4609)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.154 (n=2046)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=3977)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1374)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2937)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1056)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3255)

- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.191 (n=1077)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3234)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.186 (n=1066)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3245)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1088)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3330)

- **FILTRO** `ibs_7min` > `0.274` → IC=-0.174 (n=1104)

  - _Acción_: SKIP cuando `ibs_7min` > 0.274
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3314)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1082)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3336)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.256 (n=1125)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3559)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.231 (n=1139)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3545)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.169 (n=1516)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4713)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=1346)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=3068)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.281 (n=1088)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3326)

- **FILTRO** `ibs_7min` < `0.72` → IC=-0.234 (n=1098)

  - _Acción_: SKIP cuando `ibs_7min` < 0.72
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3316)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.211 (n=1078)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3336)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.205 (n=1390)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=4469)
...
- **PATRÓN** `sigma_h` < `0.0144` → IC=+0.482 (n=55)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `dist_50` > `0.4568` → IC=+0.482 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_50` > 0.4568 (IC base=+0.477)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=588)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=594)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2418)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1256)
...
- **PATRÓN** `drift_60min` |x|≤ `0.077` → IC=+0.180 (n=505)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.077 (IC base=+0.177)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0585` → IC=+0.180 (n=1146)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.90€ cuando `delta_ratio_macro` |x|> 0.0585 (IC base=+0.177)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.185 (n=804)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.62` → IC=+0.252 (n=1146)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.836` → IC=+0.242 (n=544)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.155 (n=27)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=55)
...
- **PATRÓN** `ibs_15` < `0.1111` → IC=+0.169 (n=364)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.85€ cuando `ibs_15` < 0.1111 (IC base=+0.046)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1167` → IC=+0.235 (n=807)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1167 (IC base=-0.042)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.183` → IC=+0.242 (n=774)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.183 (IC base=-0.042)

- **PATRÓN** `ibs_15` < `0.3571` → IC=+0.282 (n=1211)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3571 (IC base=-0.042)

- **PATRÓN** `dist_vwap_pct` > `0.6509` → IC=+0.266 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6509 (IC base=-0.042)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.212 (n=331)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=997)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.227 (n=438)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=890)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.206 (n=843)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.178 (n=485)

- **FILTRO** `sigma_ewma_delta_pct` > `19.79` → IC=-0.244 (n=236)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.79
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1092)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1983` → IC=+0.255 (n=231)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `sigma_ewma_delta_pct` > `19.739` → IC=+0.232 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.739 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.02` → IC=+0.237 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12