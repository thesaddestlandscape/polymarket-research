# Hipótesis automáticas — 2026-07-01 00:47 UTC
_Generado por shadow_postmortem.py sobre 1491 resoluciones (PNL=-59.19€)_
...
- **PATRÓN** `sigma_h` > `0.0129` → IC=+0.135 (n=50)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0129 (IC base=+0.030)

- **PATRÓN** `ibs_15` < `0.1521` → IC=+0.196 (n=21)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.98€ cuando `ibs_15` < 0.1521 (IC base=+0.030)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.1521 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.196 n=21). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 495 | -0.021 | -12.65€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 306 | +0.019 | +4.57€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 214 | +0.014 | +6.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 147 | +0.030 | +6.87€ | 1 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.066) — sin ventaja clara. oversold(IBS<0.3): IC=-0.025 n=57 | neutral: IC=-0.091 n=64 | overbought(IBS>0.7): IC=-0.024 n=80
  - _Datos_: n=206 IC=-0.048 PNL=-13.78€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=396 IC=-0.015 PNL=-7.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=396 IC=-0.015 PNL=-7.02€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=239 IC=-0.010 PNL=-15.67€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=239 IC=-0.010 PNL=-15.67€
