# Hipótesis automáticas — 2026-08-17 22:41 UTC
_Generado por shadow_postmortem.py sobre 54849 resoluciones (PNL=+5856.46€)_
...
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.224 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.150)

- **PATRÓN** `restante_min` < `3.75` → IC=+0.175 (n=438)

  - _Acción_: Kelly boost +0.88€ cuando `restante_min` < 3.75 (IC base=+0.150)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.188 (n=459)

  - _Acción_: Kelly boost +0.94€ cuando `restante_min` > 4.91 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=1380)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `7.41` → IC=+0.191 (n=218)

  - _Acción_: Kelly boost +0.95€ cuando `lag_apertura_s` < 7.41 (IC base=+0.154)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.177 (n=589)

  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` < 0.43 (IC base=+0.146)

- **PATRÓN** `restante_min` < `3.87` → IC=+0.155 (n=224)

  - _Acción_: Kelly boost +0.77€ cuando `restante_min` < 3.87 (IC base=+0.146)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.207 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.95 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=690)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `profundidad_ratio_no` > `15.6` → IC=+0.189 (n=220)

  - _Acción_: Kelly boost +0.95€ cuando `profundidad_ratio_no` > 15.6 (IC base=+0.146)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.141 (n=62)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 16.0 (IC base=+0.057)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.200 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.105)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.121 (n=64)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.505 (IC base=+0.105)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.0526` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `drift_20min_pct` |x|≤ 0.0526 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2272.78` → IC=+0.136 (n=53)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2272.78 (IC base=+0.105)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `hora_utc` > `19.0` → IC=-0.177 (n=29)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 19.0
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=63)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.132 (n=55)

  - _Acción_: Kelly boost +0.66€ cuando `py_entrada` < 0.5 (IC base=+0.032)
...
### MOMENTUM_IBS_5M
- **PATRÓN** `drift_7min_pct` |x|≤ `0.0399` → IC=+0.287 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `drift_7min_pct` |x|≤ 0.0399 (IC base=+0.065)
...
- **PATRÓN** `drift_7min_pct` |x|≤ `0.0312` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `drift_7min_pct` |x|≤ 0.0312 (IC base=+0.067)

### MOMENTUM_IBS_5M_BALLENA
- **FILTRO** `hora_utc` > `20.0` → IC=-0.254 (n=59)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 20.0
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=197)

- **FILTRO** `ibs_7min` < `0.8889` → IC=-0.182 (n=83)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8889
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=173)

- **FILTRO** `py_entrada` > `0.5` → IC=-0.179 (n=26)

  - _Acción_: SKIP cuando `py_entrada` > 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=95)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `ibs_7min` < `0.9213` → IC=-0.192 (n=24)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9213
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=24)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **PATRÓN** `libro_liquidez` > `2574.0166` → IC=+0.136 (n=31)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2574.0166 (IC base=+0.021)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `drift_7min_pct` |x|> `0.0339` → IC=-0.200 (n=18)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.167 (n=34)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 18.0 (IC base=+0.087)

- **PATRÓN** `ibs_7min` > `0.9327` → IC=+0.167 (n=31)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_7min` > 0.9327 (IC base=+0.087)

- **PATRÓN** `libro_liquidez` > `2291.3892` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2291.3892 (IC base=+0.087)

### MOMENTUM_IBS_5M_FADE#BTC#5min
- **FILTRO** `drift_7min_pct` |x|> `0.0235` → IC=-0.125 (n=30)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.0235
...
- **PATRÓN** `ibs_7min` < `0.8` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_7min` < 0.8 (IC base=+0.038)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.137 (n=144)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0054 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.161 (n=119)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0063 (IC base=+0.099)
...
- **LIVE-CANDIDATA**: `UPDOWN_GBM#DOGE#15min` — IC=+0.200 n=38. Faltan ~2 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#XRP#15min` — IC=+0.088 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#XRP` — IC=+0.088 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#DOGE#15min` — IC=+0.088 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#DOGE` — IC=+0.088 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#BTC#15min` — IC=+0.118 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#BTC` — IC=+0.118 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#ETH#15min` — IC=+0.088 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_15M#ETH` — IC=+0.088 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
...
| ✅ BALLENAS_TARDIAS | 2907 | -0.125 | -470.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 417 | +0.006 | -5.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2490 | -0.147 | -465.17€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 345 | -0.195 | -105.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 345 | -0.195 | -105.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 417 | +0.006 | -5.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 417 | +0.006 | -5.08€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#DOGE | 259 | -0.232 | -156.48€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#DOGE#5min | 259 | -0.232 | -156.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 631 | -0.151 | -36.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 631 | -0.151 | -36.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 705 | -0.039 | -93.82€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 705 | -0.039 | -93.82€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP | 550 | -0.208 | -73.00€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 550 | -0.208 | -73.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 12658 | +0.115 | -747.06€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3145 | +0.179 | -119.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 95 | -0.098 | -43.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 6876 | +0.083 | -595.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2542 | +0.130 | +12.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 
 | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH | 106 | -0.009 | -7.44€ | 0 | 0 |
| ✅ STREAK_FADE_5M#ETH#5min | 106 | -0.009 | -7.44€ | 1 | 0 |
| ✅ STREAK_FADE_5M#SOL | 50 | -0.096 | -8.12€ | 0 | 0 |
| ✅ STREAK_FADE_5M#SOL#5min | 50 | -0.096 | -8.12€ | 1 | 0 |
...
| ✅ STREAK_MOM_5M | 451 | +0.021 | -1.35€ | 0 | 0 |
| ✅ STREAK_MOM_5M#5min | 451 | +0.021 | -1.35€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE | 138 | +0.007 | -1.83€ | 0 | 0 |
| ✅ STREAK_MOM_5M#DOGE#5min | 138 | +0.007 | -1.83€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH | 93 | +0.016 | +2.30€ | 0 | 0 |
| ✅ STREAK_MOM_5M#ETH#5min | 93 | +0.016 | +2.30€ | 1 | 1 |
| ✅ STREAK_MOM_5M#SOL | 114 | +0.026 | -2.03€ | 0 | 0 |
| ✅ STREAK_MOM_5M#SOL#5min | 114 | +0.026 | -2.03€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1614 | +0.020 | +87.93€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 739 | +0.098 | +137.46€ | 0 | 2 |
| ✅ UPDOWN_GBM#240min | 108 | +0.027 | +0.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 478 | -0.058 | -42.28€ | 2 | 0 |
| ✅ UPDOWN_GBM#60min | 242 | -0.016 | -7.36€ | 3 | 1 |
| ✅ UPDOWN_GBM#BNB | 62 | +0.078 | +9.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 56 | +0.103 | +10.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 5 | -0.054 | -1.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 287 | -0.002 | -9.37€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#DOGE | 199 | +0.003 | +2.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 38 | +0.200 | +17.87€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1480 | -0.041 | +155.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1480 | -0.041 | +155.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 88 | -0.067 | -1.81€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 88 | -0.067 | -1.81€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.170: overbought→boost, oversold→filtro | oversold(IBS<0.3): IC=-0.034 n=565 | neutral: IC=-0.008 n=563 | overbought(IBS>0.7): IC=+0.136 n=780
  - _Datos_: n=2037 IC=+0.041 PNL=+142.60€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=32442 | tras_1loss IC=+0.068 n=22121 | tras_2loss IC=+0.027 n=9497/40 | gap=+0.086 (umbral 0.05)
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=95/40 IC=+0.015 PNL=-0.08€ | BTC#60min: n=83/40 IC=-0.053 PNL=-8.09€ | SOL#60min: n=64/40 IC=-0.015 PNL=+0.81€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=+0.062 n=103 | contrario_BTC IC=-0.018 n=52/40 | gap=-0.080 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1489 IC=+0.021 PNL=+92.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1489 IC=+0.021 PNL=+92.02€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=184 IC=+0.011 PNL=-0.40€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=184 IC=+0.011 PNL=-0.40€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=407 IC=+0.097 PNL=+53.19€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=407 IC=+0.097 PNL=+53.19€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.104 > 0.08 con n=470 PNL=+82.60€
  - _Datos_: n=470 IC=+0.104 PNL=+82.60€
...
**🟡 H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.116 > 0.1 con n=279 PNL=+84.10€
  - _Datos_: n=279 IC=+0.116 PNL=+84.10€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=931 IC=+0.019 PNL=+19.77€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=931 IC=+0.019 PNL=+19.77€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.143 > 0.1 con n=524 PNL=+143.07€
  - _Datos_: n=524 IC=+0.143 PNL=+143.07€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1010 IC=-0.129 PNL=+120.91€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1010 IC=-0.129 PNL=+120.91€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.097 > 0.08 con n=407 PNL=+53.19€
  - _Datos_: n=407 IC=+0.097 PNL=+53.19€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=683 IC=+0.167 PNL=+354.52€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=683 IC=+0.167 PNL=+354.52€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=519 IC=+0.045 PNL=+146.91€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=519 IC=+0.045 PNL=+146.91€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=937 IC=+0.096 PNL=-209.13€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=937 IC=+0.096 PNL=-209.13€
