# Hipótesis automáticas — 2026-09-11 18:43 UTC
_Generado por shadow_postmortem.py sobre 392630 resoluciones (PNL=+41213.28€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.01` → IC=-0.269 (n=5084)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.01
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=15253)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `143.19` → IC=-0.274 (n=707)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 143.19
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2122)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `131.47` → IC=-0.304 (n=657)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 131.47
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1971)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `146.53` → IC=-0.183 (n=1318)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.53
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=3955)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `155.45` → IC=-0.265 (n=1167)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 155.45
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3502)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `159.9` → IC=-0.340 (n=1263)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 159.9
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=2565)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.5` → IC=-0.250 (n=66)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.197 (n=9597)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2575)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `11109.2605` → IC=+0.193 (n=824)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11109.2605 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.145 (n=7621)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.247 (n=6718)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.173 (n=5077)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `4718.4515` → IC=+0.173 (n=2196)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 4718.4515 (IC base=+0.136)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1191)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.354 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1465)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `14548.2775` → IC=+0.220 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14548.2775 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1093)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.268 (n=1050)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1538)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `12842.7063` → IC=+0.207 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12842.7063 (IC base=+0.202)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=521)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2087)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.186 (n=902)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=7986)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.182 (n=2027)
...
- **PATRÓN** `py_entrada` < `0.73` → IC=+0.179 (n=1923)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.249 (n=1790)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=1934)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.190 (n=811)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=3883)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.233 (n=2581)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=1680)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9696` → IC=+0.226 (n=1749)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9696 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` < `0.1581` → IC=+0.241 (n=988)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1581 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.823` → IC=+0.166 (n=2006)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.823 (IC base=+0.095)

- **PATRÓN** `volumen_regimen` < `0.6949` → IC=+0.246 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6949 (IC base=+0.095)

- **PATRÓN** `volumen_regimen` > `1.0754` → IC=+0.241 (n=582)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3831` → IC=+0.191 (n=2949)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.3831 (IC base=+0.095)

- **PATRÓN** `volumen_spike_ratio` > `1.4631` → IC=+0.194 (n=3351)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4631 (IC base=+0.095)

- **PATRÓN** `ibs_20min` < `0.583` → IC=+0.122 (n=6498)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.583 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` < `0.1358` → IC=+0.163 (n=1874)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1358 (IC base=+0.054)

- **PATRÓN** `volumen_regimen` > `0.8683` → IC=+0.165 (n=1319)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.8683 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` > `0.1676` → IC=+0.228 (n=953)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1676 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` > `1.4566` → IC=+0.193 (n=3270)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4566 (IC base=+0.054)

- **PATRÓN** `ballena_activa_n` < `174.0` → IC=+0.203 (n=3031)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.889` → IC=+0.285 (n=506)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1954` → IC=+0.283 (n=580)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1954 (IC base=+0.242)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.250 (n=790)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0651` → IC=+0.290 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0651 (IC base=+0.242)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.299` → IC=+0.252 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.299 (IC base=+0.242)
...
- **PATRÓN** `libro_spread` < `0.05` → IC=+0.246 (n=909)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.242)

- **PATRÓN** `libro_liquidez` > `1731.6648` → IC=+0.258 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1731.6648 (IC base=+0.242)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.237 (n=705)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.211 (n=299)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.0888` → IC=+0.238 (n=300)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0888 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.230 (n=898)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2228` → IC=+0.212 (n=467)
...
- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.220 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2629 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.8808` → IC=+0.217 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8808 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.1639` → IC=+0.212 (n=915)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4807` → IC=+0.226 (n=385)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4807 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.3728` → IC=+0.213 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3728 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `10981.291` → IC=+0.229 (n=897)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10981.291 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.161 (n=857)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0049 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.079` → IC=+0.167 (n=325)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.079 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.160 (n=386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.175 (n=973)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6828 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.45` → IC=+0.200 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.45 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.1873` → IC=+0.147 (n=973)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1873 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.6858` → IC=+0.142 (n=869)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6858 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.1524` → IC=+0.211 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1524 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `1.7277` → IC=+0.158 (n=577)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.7277 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4094` → IC=+0.152 (n=864)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4094 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `12882.2757` → IC=+0.154 (n=649)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.183 (n=997)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0089 (IC base=+0.182)

- **PATRÓN** `sigma_h` > `0.006` → IC=+0.193 (n=1134)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.57` → IC=+0.263 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.57 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` < `0.1062` → IC=+0.185 (n=952)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3748` → IC=+0.180 (n=148)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.3748 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` < `3.5324` → IC=+0.178 (n=1047)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 3.5324 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `1.8634` → IC=+0.193 (n=935)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.8634 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.199 (n=1260)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `43.0` → IC=+0.207 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 43.0 (IC base=+0.182)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.216 (n=984)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.209)

- **PATRÓN** `sigma_h` > `0.008` → IC=+0.213 (n=656)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.008 (IC base=+0.209)

- **PATRÓN** `drift_60min` |x|≤ `0.1545` → IC=+0.210 (n=433)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1545 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.238 (n=369)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3958` → IC=+0.233 (n=866)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3958 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.688` → IC=+0.239 (n=350)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2771` → IC=+0.218 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2771 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `1874.6847` → IC=+0.218 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1874.6847 (IC base=+0.209)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.209 (n=355)
...
- **PATRÓN** `dist_vwap_pct` > `0.1628` → IC=+0.179 (n=135)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1628 (IC base=-0.015)

- **PATRÓN** `volumen_regimen` < `1.0358` → IC=+0.131 (n=367)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0358 (IC base=-0.015)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.125 (n=417)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` > 0.6141 (IC base=-0.015)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5104` → IC=+0.165 (n=329)
...
- **FILTRO** `hora_utc` < `17.0` → IC=-0.125 (n=46)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=208)

- **FILTRO** `ibs_20min` < `0.337` → IC=-0.171 (n=83)

  - _Acción_: SKIP cuando `ibs_20min` < 0.337
  - _Potencial_: sin este filtro IC_bueno=+0.130 (n=171)

- **FILTRO** `ibs_20min` > `0.2927` → IC=-0.127 (n=1520)
...
- **PATRÓN** `ibs_20min` > `0.7353` → IC=+0.185 (n=87)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.7353 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` > `0.9864` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9864 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.5528` → IC=+0.304 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5528 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.6528` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6528 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `1.1591` → IC=+0.364 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1591 (IC base=+0.031)

- **PATRÓN** `volumen_pendiente_norm` < `0.0735` → IC=+0.320 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0735 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` < `2.4109` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4109 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.300 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 47.0 (IC base=+0.031)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.185 (n=281)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1186)
...
- **PATRÓN** `dist_vwap_pct` < `0.2702` → IC=+0.231 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2702 (IC base=-0.031)

- **PATRÓN** `volumen_regimen` > `1.0828` → IC=+0.294 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0828 (IC base=-0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.1044` → IC=+0.245 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1044 (IC base=-0.031)

- **PATRÓN** `volumen_spike_ratio` < `2.1498` → IC=+0.247 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1498 (IC base=-0.031)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.232 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.031)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.169 (n=2178)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0092 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.45` → IC=+0.172 (n=5838)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.45 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.7422` → IC=+0.272 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7422 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.463` → IC=+0.136 (n=3081)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 3.463 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` > `0.68` → IC=+0.228 (n=1943)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.68 (IC base=+0.084)

- **PATRÓN** `volumen_pendiente_norm` > `0.2479` → IC=+0.257 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2479 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `1.4779` → IC=+0.236 (n=1134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4779 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` > `2.7528` → IC=+0.237 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7528 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `106.0` → IC=+0.284 (n=2871)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 106.0 (IC base=+0.084)

- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.140 (n=2245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0085 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.5636` → IC=+0.145 (n=5925)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5636 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.6844` → IC=+0.241 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6844 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` < `0.163` → IC=+0.232 (n=1620)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.163 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.1978` → IC=+0.261 (n=579)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1978 (IC base=+0.064)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3513` → IC=+0.263 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3513 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.256 (n=2072)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.064)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3279` → IC=-0.133 (n=586)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3279
  - _Potencial_: sin este filtro IC_bueno=+0.113 (n=1192)

- **FILTRO** `sigma_ewma_delta_pct` > `2.5` → IC=-0.152 (n=432)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.5
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=974)

- **PATRÓN** `ibs_20min` > `0.8406` → IC=+0.236 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8406 (IC base=+0.032)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.942` → IC=+0.151 (n=454)
...
- **FILTRO** `ibs_20min` > `0.84` → IC=-0.159 (n=506)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1519)

- **PATRÓN** `dist_vwap_pct` > `0.323` → IC=+0.126 (n=209)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.323 (IC base=+0.004)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4147` → IC=+0.159 (n=177)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.4147 (IC base=+0.004)
...
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.282 (n=691)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3435` → IC=+0.290 (n=817)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=245)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=878)

- **FILTRO** `ibs_20min` < `0.2128` → IC=-0.206 (n=280)
...
- **FILTRO** `ibs_20min` > `0.8394` → IC=-0.180 (n=389)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=1168)

- **PATRÓN** `ibs_20min` > `0.8024` → IC=+0.125 (n=382)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` > 0.8024 (IC base=-0.025)

- **PATRÓN** `dist_vwap_pct` > `0.8148` → IC=+0.214 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8148 (IC base=-0.025)

- **PATRÓN** `dist_vwap_pct` < `0.2468` → IC=+0.169 (n=155)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.2468 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.9213` → IC=+0.198 (n=187)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.9213 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` > `0.612` → IC=+0.170 (n=189)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.612 (IC base=-0.025)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5113` → IC=+0.259 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5113 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.238 (n=82)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0571` → IC=+0.318 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0571 (IC base=-0.037)

- **PATRÓN** `volumen_spike_ratio` > `2.1518` → IC=+0.250 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1518 (IC base=-0.037)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.206 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 162.0 (IC base=-0.037)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6462` → IC=-0.199 (n=713)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6462
  - _Potencial_: sin este filtro IC_bueno=+0.246 (n=714)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.71` → IC=-0.158 (n=375)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.71
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1157)

- **PATRÓN** `ibs_20min` > `0.6462` → IC=+0.246 (n=714)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6462 (IC base=+0.023)
...
- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.283 (n=321)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.023)

- **PATRÓN** `volumen_regimen` > `0.6344` → IC=+0.261 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6344 (IC base=+0.023)
...
- **PATRÓN** `ibs_20min` < `0.129` → IC=+0.181 (n=384)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.129 (IC base=-0.003)

- **PATRÓN** `dist_vwap_pct` > `0.5424` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.5424 (IC base=-0.003)
...
- **PATRÓN** `volumen_regimen` < `1.0891` → IC=+0.198 (n=233)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.0891 (IC base=-0.003)

- **PATRÓN** `volumen_pendiente_norm` < `0.1028` → IC=+0.189 (n=223)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1028 (IC base=-0.003)
...
- **PATRÓN** `sigma_h` > `0.0143` → IC=+0.329 (n=625)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9014` → IC=+0.331 (n=625)
...
- **PATRÓN** `volumen_regimen` > `0.8528` → IC=+0.291 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8528 (IC base=+0.263)

- **PATRÓN** `volumen_pendiente_norm` < `0.1103` → IC=+0.270 (n=816)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5505` → IC=+0.272 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5505 (IC base=+0.263)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.266 (n=994)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.263)

- **PATRÓN** `libro_liquidez` > `2448.2154` → IC=+0.270 (n=837)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.283 (n=510)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.38` → IC=+0.302 (n=1026)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.385` → IC=+0.280 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.385 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `1.2434` → IC=+0.311 (n=342)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8642` → IC=+0.168 (n=2946)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.8642 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.6119` → IC=+0.174 (n=1473)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6119 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.168 (n=4023)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.244 (n=548)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.247 (n=567)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.264 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.25 (IC base=+0.240)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.854` → IC=+0.252 (n=674)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.854 (IC base=+0.240)

- **PATRÓN** `volumen_pendiente_norm` < `0.0681` → IC=+0.236 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0681 (IC base=+0.240)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8591` → IC=+0.262 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8591 (IC base=+0.240)

- **PATRÓN** `volumen_spike_ratio` > `2.621` → IC=+0.231 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.621 (IC base=+0.240)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.262 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.240)

- **PATRÓN** `libro_liquidez` > `1731.6` → IC=+0.263 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1731.6 (IC base=+0.240)

- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.236 (n=517)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.178 (n=777)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.005 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.2908` → IC=+0.171 (n=880)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.2908 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.169 (n=807)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.5111` → IC=+0.193 (n=880)
...
- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.167 (n=880)
...
- **PATRÓN** `volumen_spike_ratio` < `2.399` → IC=+0.163 (n=772)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.399 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.4049` → IC=+0.152 (n=771)
...
- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.231 (n=719)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0106 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.221 (n=479)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.218)

- **PATRÓN** `drift_60min` |x|≤ `0.091` → IC=+0.248 (n=240)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.091 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.254 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.3611` → IC=+0.251 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3611 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.677` → IC=+0.279 (n=292)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8282` → IC=+0.209 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8282 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2343` → IC=+0.223 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2343 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1875.8832` → IC=+0.235 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1875.8832 (IC base=+0.218)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3776` → IC=+0.141 (n=880)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3776 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.164 (n=346)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 17.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` < `0.5951` → IC=+0.171 (n=880)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.5951 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.142` → IC=+0.195 (n=175)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 12.142 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` < `0.8664` → IC=+0.132 (n=587)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8664 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` > `0.6144` → IC=+0.129 (n=880)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.6144 (IC base=+0.121)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7906` → IC=+0.127 (n=512)
  ...
  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.7906 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `9883.3938` → IC=+0.148 (n=399)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 9883.3938 (IC base=+0.121)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.185 (n=439)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.5283` → IC=+0.207 (n=952)
...
- **PATRÓN** `volumen_regimen` < `1.0376` → IC=+0.129 (n=838)
...
- **PATRÓN** `volumen_spike_ratio` > `2.126` → IC=+0.139 (n=369)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.126 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3140.839` → IC=+0.150 (n=318)
...
- **PATRÓN** `sigma_h` > `0.0159` → IC=+0.208 (n=672)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0159 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.0904` → IC=+0.220 (n=337)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0904 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.205 (n=503)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.206 (n=1056)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.4231` → IC=+0.243 (n=1009)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4231 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.902` → IC=+0.240 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.902 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.218 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6282 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2801` → IC=+0.312 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2801 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `2.224` → IC=+0.189 (n=770)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.224 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4571` → IC=+0.188 (n=875)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.4571 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2537.96` → IC=+0.211 (n=672)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2537.96 (IC base=+0.201)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.151 (n=551)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0073 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.185 (n=614)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.4019` → IC=+0.164 (n=1214)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.4019 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.817` → IC=+0.181 (n=158)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.817 (IC base=+0.134)
...
- **PATRÓN** `volumen_regimen` < `0.8662` → IC=+0.155 (n=685)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8662 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `1.2058` → IC=+0.134 (n=342)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 1.2058 (IC base=+0.134)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2515` → IC=+0.141 (n=1017)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.2515 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.8208` → IC=+0.144 (n=770)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8208 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.140 (n=1327)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `11909.2287` → IC=+0.181 (n=405)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 11909.2287 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.156 (n=437)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 26.0 (IC base=+0.134)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.134 (n=416)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0038 (IC base=+0.103)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.123 (n=841)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 11.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` < `0.4912` → IC=+0.141 (n=1097)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.4912 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.296` → IC=+0.149 (n=260)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 8.296 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.1673` → IC=+0.145 (n=316)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.1673 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` < `2.221` → IC=+0.129 (n=1041)
...
- **PATRÓN** `sigma_h` > `0.003` → IC=+0.127 (n=231)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` > 0.003 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.147 (n=267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 8.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.3061` → IC=+0.139 (n=258)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.3061 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3374` → IC=+0.194 (n=83)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.3374 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.034` → IC=+0.172 (n=120)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 3.034 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.7021` → IC=+0.155 (n=114)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7021 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.2866` → IC=+0.167 (n=40)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2866 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `10126.7179` → IC=+0.154 (n=258)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 10126.7179 (IC base=+0.104)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.199 (n=141)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.2764` → IC=+0.138 (n=371)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.2764 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.120 (n=406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 6.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.619` → IC=+0.165 (n=371)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.619 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.02` → IC=+0.163 (n=87)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 9.02 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` > `0.7044` → IC=+0.128 (n=377)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.7044 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.1546` → IC=+0.213 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1546 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `2.3721` → IC=+0.133 (n=412)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.233 (n=163)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0039 (IC base=+0.206)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.230 (n=124)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.249 (n=257)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.206)

- **PATRÓN** `ibs_20min` > `0.2763` → IC=+0.249 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2763 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.9684` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9684 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` < `0.226` → IC=+0.210 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.226 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.157` → IC=+0.242 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.157 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` < `0.6879` → IC=+0.239 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6879 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `1.1711` → IC=+0.236 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1711 (IC base=+0.206)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.320 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` < `1.3667` → IC=+0.224 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3667 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `2.0266` → IC=+0.255 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0266 (IC base=+0.206)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `12552.9126` → IC=+0.244 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12552.9126 (IC base=+0.206)

- **PATRÓN** `ibs_20min` < `0.3111` → IC=+0.134 (n=203)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.3111 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.09` → IC=+0.137 (n=111)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 4.09 (IC base=+0.079)
...
- **FILTRO** `dist_vwap_pct` > `0.3844` → IC=-0.222 (n=16)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=259)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.081)

- **PATRÓN** `ibs_20min` < `0.4481` → IC=+0.160 (n=207)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.4481 (IC base=+0.081)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.589` → IC=+0.191 (n=40)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 8.589 (IC base=+0.081)

- **PATRÓN** `volumen_pendiente_norm` < `0.099` → IC=+0.127 (n=183)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.099 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` < `2.4886` → IC=+0.140 (n=187)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.4886 (IC base=+0.081)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.165 (n=150)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 50.0 (IC base=+0.081)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.194 (n=2991)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0087 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=6918)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4754` → IC=+0.214 (n=6588)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4754 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9263` → IC=+0.203 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9263 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.553` → IC=+0.225 (n=3214)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.553 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8877` → IC=+0.164 (n=2992)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8877 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.1687` → IC=+0.186 (n=1800)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1687 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.8616` → IC=+0.174 (n=4158)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.8616 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.172 (n=7790)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.04 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `3847.9652` → IC=+0.172 (n=2196)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3847.9652 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.196 (n=4589)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 102.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.196 (n=4039)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0068 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4824` → IC=+0.186 (n=6049)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.4824 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=2289)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.238 (n=6049)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5597 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2351` → IC=+0.166 (n=3817)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.2351 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.78` → IC=+0.208 (n=888)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.78 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.1988` → IC=+0.165 (n=1396)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1988 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.250 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2352 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.276` → IC=+0.191 (n=2416)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.276 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `134.0` → IC=+0.178 (n=4931)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.236 (n=499)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=1102)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3684` → IC=+0.297 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3684 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.595` → IC=+0.271 (n=858)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.595 (IC base=+0.261)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.270 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.261)

- **PATRÓN** `libro_liquidez` > `1563.08` → IC=+0.270 (n=771)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1563.08 (IC base=+0.261)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.266 (n=625)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1105)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.33` → IC=+0.157 (n=932)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 4.33 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.7067` → IC=+0.180 (n=463)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.7067 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3955` → IC=+0.159 (n=999)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.3955 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7471` → IC=+0.160 (n=666)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7471 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `10708.3557` → IC=+0.175 (n=939)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 10708.3557 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `505.0` → IC=+0.164 (n=927)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 505.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.005` → IC=+0.175 (n=836)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.005 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.3278` → IC=+0.172 (n=947)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3278 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.180 (n=370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6459` → IC=+0.207 (n=947)
...
- **PATRÓN** `sigma_h` > `0.006` → IC=+0.228 (n=1007)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.006 (IC base=+0.219)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.220 (n=1013)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.6749` → IC=+0.257 (n=900)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6749 (IC base=+0.219)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.82` → IC=+0.319 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.82 (IC base=+0.219)

- **PATRÓN** `volumen_pendiente_norm` < `0.2179` → IC=+0.225 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2179 (IC base=+0.219)

- **PATRÓN** `volumen_spike_ratio` > `1.6757` → IC=+0.224 (n=931)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6757 (IC base=+0.219)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=1114)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.219)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.253 (n=724)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.237 (n=667)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.224)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.243 (n=375)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3901` → IC=+0.265 (n=880)
...
- **PATRÓN** `volumen_spike_ratio` < `2.9265` → IC=+0.215 (n=771)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9265 (IC base=+0.224)

- **PATRÓN** `volumen_spike_ratio` > `2.2419` → IC=+0.217 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2419 (IC base=+0.224)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.239 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `1880.0598` → IC=+0.229 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1880.0598 (IC base=+0.224)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.212 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 32.0 (IC base=+0.224)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4373` → IC=+0.140 (n=1113)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.4373 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.170 (n=546)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.7134` → IC=+0.239 (n=742)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7134 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.5571` → IC=+0.183 (n=314)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.5571 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7401` → IC=+0.165 (n=711)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.7401 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=1207)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9103.3274` → IC=+0.232 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9103.3274 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.147 (n=780)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0067 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.144 (n=881)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.152 (n=331)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6898` → IC=+0.177 (n=881)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6898 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.1535` → IC=+0.132 (n=397)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.1535 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.2052` → IC=+0.129 (n=813)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2052 (IC base=+0.127)
...
- **PATRÓN** `volumen_regimen` < `0.856` → IC=+0.129 (n=588)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.856 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` > `1.1729` → IC=+0.152 (n=294)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.1729 (IC base=+0.127)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4511` → IC=+0.161 (n=272)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.158 (n=436)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 17.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.4615` → IC=+0.173 (n=1161)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.4615 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `1.018` → IC=+0.178 (n=203)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 1.018 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.363` → IC=+0.220 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.363 (IC base=+0.093)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=800)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2949.3334` → IC=+0.243 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2949.3334 (IC base=+0.093)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.126 (n=831)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.174 (n=378)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.122)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1912` → IC=+0.133 (n=415)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.1912 (IC base=+0.122)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.130 (n=1168)
...
- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.221 (n=528)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.213 (n=1220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)
...
- **PATRÓN** `volumen_regimen` < `1.2398` → IC=+0.204 (n=1165)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2398 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.6218` → IC=+0.208 (n=1164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6218 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2361` → IC=+0.226 (n=206)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=1200)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2576.5049` → IC=+0.204 (n=776)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1212)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.205 (n=1366)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.202)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.253 (n=1291)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.5037` → IC=+0.202 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5037 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` < `0.1908` → IC=+0.204 (n=1151)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1908 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.584` → IC=+0.266 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.584 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `1.2318` → IC=+0.238 (n=430)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2192` → IC=+0.189 (n=980)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.2192 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.199 (n=1113)
...
- **PATRÓN** `libro_liquidez` > `2548.3818` → IC=+0.206 (n=860)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2548.3818 (IC base=+0.202)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.182 (n=1028)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=2265)

- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.145 (n=1810)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0096 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.5372` → IC=+0.137 (n=2057)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.5372 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.164 (n=830)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1894` → IC=+0.128 (n=716)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.1894 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.261` → IC=+0.150 (n=327)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 10.261 (IC base=+0.130)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4485` → IC=+0.150 (n=679)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4485 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` > `1.8774` → IC=+0.142 (n=1357)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8774 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=1359)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `8834.9833` → IC=+0.150 (n=933)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8834.9833 (IC base=+0.130)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.196 (n=574)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0037 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4837` → IC=+0.161 (n=1711)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4837 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1857` → IC=+0.157 (n=753)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.1857 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.7021` → IC=+0.150 (n=287)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.7021 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.273` → IC=+0.149 (n=1691)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.273 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.901` → IC=+0.153 (n=1081)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.901 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0714` → IC=+0.156 (n=804)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.0714 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.538` → IC=+0.145 (n=1693)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.538 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8071` → IC=+0.153 (n=1128)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.8071 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=2265)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `12051.5949` → IC=+0.157 (n=776)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12051.5949 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.156 (n=225)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.006 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0036` → IC=+0.158 (n=229)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0036 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.1024` → IC=+0.159 (n=86)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1024 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=257)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.8759` → IC=+0.163 (n=256)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.8759 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.2407` → IC=+0.156 (n=120)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2407 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.24` → IC=+0.159 (n=323)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 5.24 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1831` → IC=+0.147 (n=256)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1831 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.8157` → IC=+0.180 (n=170)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 0.8157 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.1086` → IC=+0.153 (n=286)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` < 0.1086 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.409` → IC=+0.204 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.409 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `2.5548` → IC=+0.167 (n=85)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.5548 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12660.8481` → IC=+0.191 (n=228)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 12660.8481 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.206 (n=352)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.0861` → IC=+0.168 (n=266)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0861 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.168 (n=293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1568` → IC=+0.160 (n=351)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1568 (IC base=+0.131)

- **PATRÓN** `ibs_20min` > `0.6109` → IC=+0.137 (n=362)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.6109 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.6094` → IC=+0.176 (n=106)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.6094 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.06` → IC=+0.147 (n=874)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 9.06 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `0.8778` → IC=+0.172 (n=532)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.8778 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.0677` → IC=+0.160 (n=377)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0677 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `2.508` → IC=+0.137 (n=795)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.508 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.7953` → IC=+0.145 (n=530)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.7953 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `12051.5949` → IC=+0.146 (n=713)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 12051.5949 (IC base=+0.131)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.146 (n=674)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0089 (IC base=+0.137)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.142 (n=674)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0045 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4866` → IC=+0.145 (n=674)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4866 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.176 (n=260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.8032` → IC=+0.162 (n=306)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.8032 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.9899` → IC=+0.180 (n=151)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.9899 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.4235` → IC=+0.145 (n=627)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.4235 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.821` → IC=+0.145 (n=675)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.821 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.1165` → IC=+0.144 (n=593)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1165 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.426` → IC=+0.159 (n=221)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.426 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.142 (n=616)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8919.2028` → IC=+0.151 (n=602)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8919.2028 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.180 (n=470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0073 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.5088` → IC=+0.200 (n=534)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5088 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.181 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 17.0 (IC base=+0.159)
...
- **PATRÓN** `ibs_20min` > `0.1055` → IC=+0.172 (n=534)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.1055 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` > `0.1528` → IC=+0.167 (n=253)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1528 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.3657` → IC=+0.167 (n=538)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.3657 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.058` → IC=+0.172 (n=254)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 3.058 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` < `1.1151` → IC=+0.174 (n=470)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.1151 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` > `0.7378` → IC=+0.162 (n=477)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.7378 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.0735` → IC=+0.189 (n=233)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.0735 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `2.1931` → IC=+0.178 (n=461)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.1931 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.7829` → IC=+0.184 (n=349)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.7829 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `8306.7713` → IC=+0.173 (n=534)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 8306.7713 (IC base=+0.159)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.124 (n=381)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 7.0 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2307.1726` → IC=+0.138 (n=426)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2307.1726 (IC base=+0.105)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1239)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=5310)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.181 (n=2091)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=6729)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.175 (n=2142)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=7007)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.213 (n=354)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1107)

- **FILTRO** `ibs_20min` < `0.75` → IC=-0.176 (n=365)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.201 (n=373)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1148)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.215 (n=388)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1210)

- **FILTRO** `ibs_20min` > `0.2896` → IC=-0.186 (n=399)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2896
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=1199)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.202 (n=340)
...
- **FILTRO** `py_entrada` > `0.6` → IC=-0.188 (n=399)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=1212)
...
- **FILTRO** `hora_utc` < `16.0` → IC=-0.324 (n=15)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=150)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=5199)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=15888)

- **FILTRO** `ibs_7min` < `0.711` → IC=-0.234 (n=5270)

  - _Acción_: SKIP cuando `ibs_7min` < 0.711
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=15817)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.167 (n=7068)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=14019)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.220 (n=6555)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=19854)

- **FILTRO** `ibs_7min` > `0.2989` → IC=-0.176 (n=6602)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2989
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=19807)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=777)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2482)

- **FILTRO** `ibs_7min` < `0.7063` → IC=-0.257 (n=1075)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7063
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2184)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.206 (n=763)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2496)

- **FILTRO** `py_entrada` > `0.51` → IC=-0.150 (n=3039)

  - _Acción_: SKIP cuando `py_entrada` > 0.51
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=1532)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.129 (n=1554)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3017)

- **FILTRO** `ibs_7min` > `0.8044` → IC=-0.205 (n=1142)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.143 (n=856)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2894)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.251 (n=929)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=2821)

- **FILTRO** `ibs_7min` < `0.7615` → IC=-0.185 (n=935)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7615
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2815)

- **FILTRO** `ballena_activa_n` > `163.0` → IC=-0.173 (n=935)

  - _Acción_: SKIP cuando `ballena_activa_n` > 163.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=2815)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.260 (n=871)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2905)

- **FILTRO** `ibs_7min` > `0.2503` → IC=-0.172 (n=941)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2503
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2835)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.179 (n=939)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=2837)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.175 (n=753)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=2341)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.319 (n=731)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2363)

- **FILTRO** `ibs_7min` < `0.2097` → IC=-0.273 (n=773)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2097
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=2321)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.215 (n=756)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=2338)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.225 (n=1105)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3722)

- **FILTRO** `ibs_7min` > `0.267` → IC=-0.154 (n=1641)

  - _Acción_: SKIP cuando `ibs_7min` > 0.267
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=3186)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1079)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=2410)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=833)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2656)

- **FILTRO** `ibs_7min` < `0.7511` → IC=-0.185 (n=872)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7511
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=2617)

- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.174 (n=1144)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2345)
...
- **FILTRO** `ibs_7min` > `0.2768` → IC=-0.177 (n=886)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2768
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2662)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.179 (n=881)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2667)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.235 (n=965)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2991)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.203 (n=975)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2981)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.163 (n=1248)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=3745)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.284 (n=851)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2688)

- **FILTRO** `ibs_7min` < `0.7317` → IC=-0.224 (n=884)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7317
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2655)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.209 (n=860)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2679)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.191 (n=1138)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=3556)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=2036)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1192` → IC=+0.231 (n=589)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1192 (IC base=-0.051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1809` → IC=+0.234 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1809 (IC base=-0.051)

- **PATRÓN** `ibs_15` < `0.3605` → IC=+0.272 (n=883)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3605 (IC base=-0.051)

- **PATRÓN** `dist_vwap_pct` > `0.6425` → IC=+0.256 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6425 (IC base=-0.051)
...
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.227 (n=328)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0069 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.3502` → IC=+0.224 (n=328)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3502 (IC base=+0.213)

- **PATRÓN** `drift_15min` |x|≤ `0.4175` → IC=+0.224 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4175 (IC base=+0.213)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2036` → IC=+0.237 (n=169)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2036 (IC base=+0.213)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `18.87` → IC=+0.227 (n=31)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.87 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.572` → IC=+0.218 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.572 (IC base=+0.213)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1145` → IC=+0.212 (n=130)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1145 (IC base=-0.042)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.194` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.194 (IC base=-0.042)

- **PATRÓN** `ibs_15` < `0.38` → IC=+0.242 (n=196)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.38 (IC base=-0.042)

- **PATRÓN** `dist_vwap_pct` < `0.143` → IC=+0.196 (n=179)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.143 (IC base=-0.042)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3605 sube el IC de -0.051 a +0.272 en UPDOWN_GBM_15M_TARDIO (n=883). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3605 sube el IC de +0.213 a +0.260 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=373). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.38 sube el IC de -0.042 a +0.242 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=196). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3437 sube el IC de -0.049 a +0.299 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=247). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 20337 | -0.108 | -3133.96€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1110 | -0.031 | -189.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19227 | -0.113 | -2944.09€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2829 | -0.108 | -526.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2829 | -0.108 | -526.06€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1110 | -0.031 | -189.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1110 | -0.031 | -189.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2628 | -0.100 | -615.55€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2628 | -0.100 | -615.55€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 5273 | -0.071 | -487.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5273 | -0.071 | -487.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 4669 | -0.121 | -366.70€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 4669 | -0.121 | -366.70€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 3828 | -0.175 | -948.73€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 3828 | -0.175 | -948.73€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 9057 | -0.055 | +3723.63€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 2502 | -0.011 | +1635.70€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 6555 | -0.072 | +2087.92€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 9057 | -0.055 | +3723.63€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 2502 | -0.011 | +1635.70€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 6555 | -0.072 | +2087.92€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 283 | -0.093 | -45.33€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 5 | +0.018 | +0.75€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 278 | -0.096 | -46.08€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 64305 | +0.113 | -3608.31€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 10331 | +0.182 | -322.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 245 | -0.111 | -47.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 49379 | +0.099 | -3157.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 4350 | +0.116 | -80.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 8243 | +0.092 | -869.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 34 | -0.167 | -0.75€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 8194 | +0.094 | -856.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 12748 | +0.132 | -251.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3108 | +0.203 | -86.75€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 8183 | +0.108 | -180.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1415 | +0.120 | +38.72€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 8279 | +0.087 | -880.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 39 | -0.037 | -2.52€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 8225 | +0.088 | -867.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 13861 | +0.126 | -258.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 3942 | +0.170 | -79.77€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 