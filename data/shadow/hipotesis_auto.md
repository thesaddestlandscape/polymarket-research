# Hipótesis automáticas — 2026-06-30 08:01 UTC
_Generado por shadow_postmortem.py sobre 1385 resoluciones (PNL=-52.06€)_
...
| ✅ UPDOWN_GBM | 412 | -0.015 | -10.58€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 169 | +0.021 | +1.94€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.024) — sin ventaja clara. oversold(IBS<0.3): IC=-0.050 n=38 | neutral: IC=-0.026 n=36 | overbought(IBS>0.7): IC=-0.042 n=46
  - _Datos_: n=123 IC=-0.044 PNL=-11.71€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 123 ops, 21 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=313 IC=-0.005 PNL=-4.94€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=313 IC=-0.005 PNL=-4.94€
