# Hipótesis automáticas — 2026-08-09 14:03 UTC
_Generado por shadow_postmortem.py sobre 98825 resoluciones (PNL=+14221.22€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.238 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.137)

- **PATRÓN** `restante_min` < `4.57` → IC=+0.157 (n=493)

  - _Acción_: Kelly boost +0.78€ cuando `restante_min` < 4.57 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.144 (n=684)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 8.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.138 (n=540)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 12.0 (IC base=+0.137)

- **PATRÓN** `profundidad_ratio_no` > `16.5` → IC=+0.153 (n=246)

  - _Acción_: Kelly boost +0.77€ cuando `profundidad_ratio_no` > 16.5 (IC base=+0.137)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.262 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.119)

- **PATRÓN** `restante_min` < `3.9` → IC=+0.157 (n=164)

  - _Acción_: Kelly boost +0.78€ cuando `restante_min` < 3.9 (IC base=+0.119)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.136 (n=273)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 12.0 (IC base=+0.119)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.180 (n=332)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` < 0.43 (IC base=+0.154)

- **PATRÓN** `restante_min` < `4.94` → IC=+0.167 (n=367)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` < 4.94 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.161 (n=376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 6.0 (IC base=+0.154)

- **PATRÓN** `profundidad_ratio_no` > `24.5` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio_no` > 24.5 (IC base=+0.154)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.206 (n=15)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.061)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.463` → IC=+0.167 (n=82)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 6.463 (IC base=+0.021)
...
- **PATRÓN** `hora_utc` > `9.0` → IC=+0.155 (n=27)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 9.0 (IC base=+0.045)
...
- **FILTRO** `liq_usd_total` < `573.85` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `liq_usd_total` < 573.85
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=33)

- **FILTRO** `liq_imbalance_60min` |x|≤ `0.9912` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `liq_imbalance_60min` |x|≤ 0.9912
...
- **PATRÓN** `volumen_racha` < `641424.8` → IC=+0.147 (n=49)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_racha` < 641424.8 (IC base=+0.053)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.182 (n=639)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0068 (IC base=+0.174)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.174 (n=1452)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
### UPDOWN_OU_5M
- **FILTRO** `pct_spot_vs_ref` |x|> `0.2495` → IC=-0.470 (n=31)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.2495
  - _Potencial_: sin este filtro IC_bueno=-0.182 (n=61)

- **FILTRO** `sigma_h` > `0.0061` → IC=-0.371 (n=68)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `delta_ratio_macro` |x|≤ `0.1581` → IC=-0.287 (n=45)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.1581
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min` — IC=+0.439 n=31. Faltan ~9 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL` — IC=+0.439 n=31. Faltan ~9 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `LIQUIDACIONES_60M#SOL#60min` — IC=+0.090 n=37. Faltan ~3 resoluciones para umbral n≥40. ETA: ~2h.
- **LIVE-CANDIDATA**: `LIQUIDACIONES_60M#SOL` — IC=+0.090 n=37. Faltan ~3 resoluciones para umbral n≥40. ETA: ~2h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1820 | +0.047 | -25.11€ | 0 | 4 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1820 | +0.047 | -25.11€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 843 | +0.024 | -27.37€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min |
 | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 631 | +0.086 | +96.23€ | 1 | 7 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 3520 | +0.162 | +1807.06€ | 0 | 21 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 3520 | +0.162 | +1807.06€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 380 | +0.217 | +282.19€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 420 | +0.052 | +60.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 420 | +0.052 | +60.31€ | 1 | 11 |
...
| ✅ UPDOWN_OU_5M | 340 | -0.172 | -57.65€ | 10 | 0 |
| ✅ UPDOWN_OU_5M#5min | 340 | -0.172 | -57.65€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB | 55 | -0.184 | -11.55€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB#5min | 55 | -0.184 | -11.55€ | 3 | 0 |
| ✅ UPDOWN_OU_5M#BTC | 31 | -0.167 | -4.07€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BTC#5min | 31 | -0.167 | -4.07€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.160: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.115 n=2533 | neutral: IC=+0.042 n=1969 | overbought(IBS>0.7): IC=+0.203 n=2522
  - _Datos_: n=7488 IC=+0.130 PNL=+2538.54€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.162 n=131 PNL=+61.09€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=12h: IC=+0.153 n=174 PNL=+59.38€ → BOOST | H=14h: IC=+0.133 n=178 PNL=+57.11€ → BOOST | H=16h: IC=+0.111 n=165 PNL=+42.79€ → BOOST | H=21h: IC=+0.119 n=158 PNL=+36.34€ → BOOST | H=22h: IC=+0.168 n=188 PNL=+61.92€ → BOOST
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 38 celda(s) pasan gate riguroso completo de 161 evaluadas (n>=40) y 338 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.130 n=60465 | tras_1loss IC=+0.086 n=38116 | tras_2loss IC=+0.049 n=15737/40 | gap=+0.081 (umbral 0.05)
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1511 IC=+0.064 PNL=+222.28€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1511 IC=+0.064 PNL=+222.28€
...
**🟡 H-CUSTOM-GBM-SIGMA-BAJO** — GBM con sigma_h muy bajo (<0.0018/h, p1 real) — ¿mercado dormido = más predecible?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.143 > 0.1 con n=40 PNL=+16.32€
  - _Datos_: n=40 IC=+0.143 PNL=+16.32€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=631 IC=+0.086 PNL=+96.23€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=631 IC=+0.086 PNL=+96.23€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.092 > 0.08 con n=1987 PNL=+365.46€
  - _Datos_: n=1987 IC=+0.092 PNL=+365.46€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=276 IC=+0.036 PNL=+67.45€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=276 IC=+0.036 PNL=+67.45€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=583 IC=+0.052 PNL=+62.55€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=583 IC=+0.052 PNL=+62.55€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1661 IC=+0.044 PNL=+191.73€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1661 IC=+0.044 PNL=+191.73€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.165 > 0.1 con n=1640 PNL=+570.10€
  - _Datos_: n=1640 IC=+0.165 PNL=+570.10€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=1722 IC=-0.082 PNL=+399.71€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1722 IC=-0.082 PNL=+399.71€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1491 IC=+0.069 PNL=+176.97€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1491 IC=+0.069 PNL=+176.97€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.110 > 0.08 con n=1107 PNL=+268.53€
  - _Datos_: n=1107 IC=+0.110 PNL=+268.53€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.153 > 0.08 con n=401 PNL=+114.55€
  - _Datos_: n=401 IC=+0.153 PNL=+114.55€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=1738 IC=+0.191 PNL=+1010.25€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=1738 IC=+0.191 PNL=+1010.25€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.082 > 0.08 con n=899 PNL=+166.78€
  - _Datos_: n=899 IC=+0.082 PNL=+166.78€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.117 > 0.08 con n=956 PNL=+309.88€
  - _Datos_: n=956 IC=+0.117 PNL=+309.88€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.122 > 0.08 con n=1341 PNL=+649.59€
  - _Datos_: n=1341 IC=+0.122 PNL=+649.59€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.197 > 0.08 con n=489 PNL=+18.42€
  - _Datos_: n=489 IC=+0.197 PNL=+18.42€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.267 > 0.08 con n=860 PNL=-38.69€
  - _Datos_: n=860 IC=+0.267 PNL=-38.69€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2180 IC=+0.159 PNL=-299.57€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2180 IC=+0.159 PNL=-299.57€
