# Hipótesis automáticas — 2026-07-05 04:17 UTC
_Generado por shadow_postmortem.py sobre 3739 resoluciones (PNL=+118.13€)_
...
- **PATRÓN** `sigma_h` < `0.009` → IC=+0.163 (n=93)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.009 (IC base=+0.030)

- **PATRÓN** `ibs_15` < `0.0634` → IC=+0.153 (n=70)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` < 0.0634 (IC base=+0.030)
...
- **FILTRO** `ibs_15` > `0.0936` → IC=-0.132 (n=17)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.0936
  - _Potencial_: sin este filtro IC_bueno=+0.278 (n=7)

- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0434` → IC=+0.140 (n=23)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.70€ cuando `pct_spot_vs_ref` |x|≤ 0.0434 (IC base=+0.022)
...
- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.122 (n=72)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0115 (IC base=+0.082)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.176 (n=32)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 7.0 (IC base=+0.082)

- **PATRÓN** `ibs_15` < `0.1053` → IC=+0.167 (n=46)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.1053 (IC base=+0.082)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0634 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.153 n=70). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.1053 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.167 n=46). Confirma señal de reversión media → alinear con BUY_YES.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 946 | +0.089 | +216.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 946 | +0.089 | +216.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 246 | +0.036 | +24.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 246 | +0.036 | +24.91€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 246 | +0.032 | +15.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 246 | +0.032 | +15.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 244 | +0.134 | +89.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 244 | +0.134 | +89.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 210 | +0.160 | +85.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 210 | +0.160 | +85.83€ | 0 | 0 |
| 🚫 GBM_LATE_60M | 8 | -0.120 | -3.18€ | 0 | 0 |
| 🚫 GBM_LATE_60M#60min | 8 | -0.120 | -3.18€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN | 10 | +0.042 | +0.97€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 10 | +0.042 | +0.97€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 10 | +0.042 | +0.97€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 10 | +0.042 | +0.97€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 937 | -0.039 | -52.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 701 | -0.016 | -22.80€ | 1 | 2 |
...
| ✅ WEEKLY_PRICE | 91 | -0.038 | -21.28€ | 0 | 0 |
| ✅ WEEKLY_PRICE#BTC | 32 | +0.000 | -7.68€ | 0 | 0 |
| ✅ WEEKLY_PRICE#ETH | 32 | +0.000 | -7.57€ | 0 | 0 |
| ✅ WEEKLY_PRICE#SOL | 27 | -0.121 | -6.03€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.047) — sin ventaja clara. oversold(IBS<0.3): IC=-0.015 n=194 | neutral: IC=-0.062 n=158 | overbought(IBS>0.7): IC=-0.048 n=175
  - _Datos_: n=547 IC=-0.037 PNL=-27.40€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.186 n=33 PNL=-14.53€ → FILTRAR | H=02h: IC=-0.154 n=24 PNL=-5.23€ → FILTRAR | H=03h: IC=-0.113 n=19 PNL=-5.87€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=13h: IC=+0.115 n=24 PNL=+5.54€ → BOOST | H=16h: IC=+0.167 n=25 PNL=+7.36€ → BOOST | H=20h: IC=-0.147 n=32 PNL=-9.63€ → FILTRAR
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.026 n=1861 | tras_1loss IC=-0.012 n=1778 | tras_2loss IC=-0.029 n=890/40 | gap=+0.055 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.020 n=150/40 PNL=+6.91€ | H=15h UTC: IC=-0.016 n=151/40 PNL=-7.53€ | H=17h UTC: IC=+0.170 n=89/40 PNL=+33.37€ | H=19h UTC: IC=+0.028 n=104/40 PNL=+4.58€
...
**⏳ H-WEEKLY** — Predicciones semanales de precio por par
  ...
  - _Estado_: ETH: n=32/15 IC=+0.000 PNL=-7.57€ | BTC: n=32/15 IC=+0.000 PNL=-7.68€ | SOL: n=27/15 IC=-0.121 PNL=-6.03€

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.026 n=95 | contrario_BTC IC=-0.062 n=46/40 | gap=-0.037 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=160 IC=-0.049 PNL=-15.29€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=160 IC=-0.049 PNL=-15.29€
...
**〰️ H-WEEKLY-BUYNO** — WEEKLY_PRICE BUY_NO — dirección dominante con IC muy alto
  ...
  - _Estado_: n=60 IC=+0.081 PNL=-7.39€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=60 IC=+0.081 PNL=-7.39€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=814 IC=-0.034 PNL=-39.08€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=814 IC=-0.034 PNL=-39.08€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=422 IC=-0.047 PNL=-45.67€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=422 IC=-0.047 PNL=-45.67€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.018 < 0.02 con n=193 PNL=-23.37€
  - _Datos_: n=193 IC=-0.018 PNL=-23.37€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=312 IC=-0.013 PNL=-30.56€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=312 IC=-0.013 PNL=-30.56€

**⏳ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: 30
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: 19/30 ops en el filtro definido (IC actual=-0.158 PNL=-4.29€)
  - _Datos_: n=19 IC=-0.158 PNL=-4.29€

**〰️ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  - _Hipótesis_: ETH y BTC tienen patrones opuestos: BTC funciona con momentum (drift>0.3). ETH funciona con reversión (drift<-1): 9/14 (64%) IC=+0.087. La hipótesis es que ETH tiene más mean-reversion que BTC en 15min.
  - _Umbral_: n≥20 y IC>+0.08
  - _Acción_: Si ETH drift<-1 confirma IC>0.08 con n≥20 → boost ×1.1 en ETH#15min cuando drift_15min<-1
  - _Estado_: n=53 IC=+0.045 PNL=+8.74€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=53 IC=+0.045 PNL=+8.74€
...
**⏳ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: 10/30 ops en el filtro definido (IC actual=+0.042 PNL=+0.97€)
  - _Datos_: n=10 IC=+0.042 PNL=+0.97€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=258 IC=+0.004 PNL=+6.53€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=258 IC=+0.004 PNL=+6.53€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 9/40 ops en el filtro definido (IC actual=-0.021 PNL=+0.12€)
  - _Datos_: n=9 IC=-0.021 PNL=+0.12€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=458 IC=+0.048 PNL=+37.08€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=458 IC=+0.048 PNL=+37.08€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1298 IC=+0.059 PNL=+199.27€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1298 IC=+0.059 PNL=+199.27€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=68 IC=-0.029 PNL=-10.42€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=68 IC=-0.029 PNL=-10.42€
...
**⏳ H-CUSTOM-WEEKLY-INRANGE-BUYYES** — WEEKLY_PRICE BUY_YES con in_range=1 — ¿estructuralmente sobrevalorado?
  ...
  - _Estado_: 11/25 ops en el filtro definido (IC actual=-0.106 PNL=-3.15€)
  - _Datos_: n=11 IC=-0.106 PNL=-3.15€

**⏳ H-CUSTOM-WEEKLY-PCTDIST-BUYNO** — WEEKLY_PRICE BUY_NO con pct_dist alto — cuanto más lejos del rango, más seguro
  - _Hipótesis_: Analizado 2026-07-01, n=10 (evidencia mínima): BUY_NO con pct_dist>=2.09% fue 4/4 victorias (rango 2.09%-23.4%); BUY_NO con pct_dist<8% (pero fuera del corte anterior) tuvo derrotas. Patrón: cuanto más lejos está el spot del rango objetivo al momento de la predicción, más fiable el BUY_NO. Complementa H-CUSTOM-WEEKLY-INRANGE-BUYYES.
  - _Umbral_: 25
  - _Acción_: Si se confirma con n≥25 → boost ×1.2 en WEEKLY_PRICE BUY_NO cuando pct_dist≥2
  - _Estado_: 10/25 ops en el filtro definido (IC actual=-0.042 PNL=-2.27€)
  - _Datos_: n=10 IC=-0.042 PNL=-2.27€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.071 < -0.05 con n=564 PNL=-73.59€
  - _Datos_: n=564 IC=-0.071 PNL=-73.59€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 80/120 ops en el filtro definido (IC actual=+0.134 PNL=+14.80€)
  - _Datos_: n=80 IC=+0.134 PNL=+14.80€
...
**⏳ H-CUSTOM-DAILY-BUYNO** — UPDOWN_GBM#daily BUY_NO — el sesgo anti-YES amplificado en ventanas diarias
  ...
  - _Estado_: 15/20 ops en el filtro definido (IC actual=-0.022 PNL=+8.07€)
  - _Datos_: n=15 IC=-0.022 PNL=+8.07€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=102 IC=+0.000 PNL=-8.19€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=102 IC=+0.000 PNL=-8.19€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=88 IC=-0.067 PNL=+8.81€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=88 IC=-0.067 PNL=+8.81€
