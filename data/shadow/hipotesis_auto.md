# Hipótesis automáticas — 2026-06-30 11:05 UTC
_Generado por shadow_postmortem.py sobre 1404 resoluciones (PNL=-58.45€)_
...
| ✅ UPDOWN_GBM | 431 | -0.024 | -16.98€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 136 | -0.022 | -9.73€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.032) — sin ventaja clara. oversold(IBS<0.3): IC=-0.048 n=40 | neutral: IC=-0.080 n=48 | overbought(IBS>0.7): IC=-0.058 n=50
  - _Datos_: n=142 IC=-0.069 PNL=-18.11€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 142 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=332 IC=-0.018 PNL=-11.34€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=332 IC=-0.018 PNL=-11.34€
