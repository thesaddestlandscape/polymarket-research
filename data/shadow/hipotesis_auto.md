# Hipótesis automáticas — 2026-07-26 00:54 UTC
_Generado por shadow_postmortem.py sobre 35739 resoluciones (PNL=+7581.47€)_
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.197 (n=705)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.208 (n=385)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.238 (n=185)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1576.3156` → IC=+0.215 (n=539)
...
- **PATRÓN** `dist_vwap_pct` > `0.9761` → IC=+0.133 (n=137)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.9761 (IC base=+0.095)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.159 (n=315)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 6.0 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.3725` → IC=+0.185 (n=109)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.3725 (IC base=+0.140)
...
- **PATRÓN** `dist_vwap_pct` > `0.9879` → IC=+0.164 (n=117)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.9879 (IC base=+0.123)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.932` → IC=+0.156 (n=123)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 6.932 (IC base=+0.090)
...
- **PATRÓN** `sigma_h` < `0.0169` → IC=+0.217 (n=490)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.761` → IC=+0.217 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.761 (IC base=+0.217)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6174` → IC=+0.182 (n=568)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` > 0.6174 (IC base=+0.058)

- **PATRÓN** `dist_vwap_pct` > `0.1763` → IC=+0.179 (n=194)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1763 (IC base=+0.058)
...
- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.126 (n=263)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` < 0.0063 (IC base=+0.102)

- **PATRÓN** `drift_60min` |x|≤ `0.2217` → IC=+0.139 (n=289)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.2217 (IC base=+0.102)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0855` → IC=+0.127 (n=258)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.63€ cuando `delta_ratio_macro` |x|> 0.0855 (IC base=+0.102)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.159 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 8.0 (IC base=+0.102)

- **PATRÓN** `ibs_15` > `0.7301` → IC=+0.247 (n=223)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `24.96` → IC=+0.157 (n=33)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 24.96 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` < `14.847` → IC=+0.159 (n=124)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 14.847 (IC base=+0.102)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6174 sube el IC de +0.058 a +0.182 en UPDOWN_GBM#15min (n=568). Ya aplicado como kelly_boost=+0.91€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7301 sube el IC de +0.102 a +0.247 en UPDOWN_GBM#BTC#15min (n=223). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1183 | +0.124 | +56.00€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1183 | +0.124 | +56.00€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 440 | +0.145 | +19.60€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 440 | +0.145 | +19.60€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 6378 | +0.181 | +12.36€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4200 | +0.207 | +16.10€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1872 | +0.188 | +16.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1397 | +0.203 | -31.53€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 2245 | +0.170 | -33.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1384 | +0.201 | -1.08€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 2217 | +0.187 | +22.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1382 | +0.217 | +45.94€ | 0 | 9 |
...
| ✅ GBM_LATE_15M | 7866 | +0.095 | +2411.05€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 7866 | +0.095 | +2411.05€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1903 | +0.070 | +331.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1903 | +0.070 | +331.96€ | 0 | 5 |
| ✅ GBM_LATE_15M#ETH | 1746 | +0.074 | +299.22€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1746 | +0.074 | +299.22€ | 0 | 6 |
| ✅ GBM_LATE_15M#SOL | 2116 | +0.087 | +743.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2116 | +0.087 | +743.68€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2101 | +0.143 | +1036.18€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2101 | +0.143 | +1036.18€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5080 | +0.119 | +2450.47€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5080 | +0.119 | +2450.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1326 | +0.085 | +473.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1326 | +0.085 | +473.86€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1325 | +0.086 | +462.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1325 | +0.086 | +462.11€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1277 | +0.092 | +517.63€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1277 | +0.092 | +517.63€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 1152 | +0.226 | +996.87€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 1152 | +0.226 | +996.87€ | 0 | 10 |
...
| ✅ GBM_LATE_15M_TARDIO | 5082 | +0.072 | +1410.93€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5082 | +0.072 | +1410.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1220 | +0.038 | +157.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1220 | +0.038 | +157.34€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1232 | +0.026 | +96.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1232 | +0.026 | +96.12€ | 0 | 1 |
...
| ✅ ORDER_FLOW_5M | 1675 | +0.010 | +9.44€ | 1 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1539 | +0.006 | -3.15€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 2618 | +0.036 | +247.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2355 | +0.055 | +285.52€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 559 | +0.053 | +64.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 475 | +0.087 | +78.61€ | 1 | 9 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1788 | +0.156 | +810.25€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1788 | +0.156 | +810.25€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 171 | +0.199 | +101.70€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 171 | +0.199 | +101.70€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 190 | +0.115 | +32.60€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 190 | +0.115 | +32.60€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.176: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.076 n=1403 | neutral: IC=+0.016 n=1113 | overbought(IBS>0.7): IC=+0.192 n=1418
  - _Datos_: n=4196 IC=+0.105 PNL=+1113.57€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.113 n=21341 | tras_1loss IC=+0.081 n=14191 | tras_2loss IC=+0.053 n=5908/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1022 IC=+0.058 PNL=+146.26€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1022 IC=+0.058 PNL=+146.26€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=475 IC=+0.087 PNL=+78.61€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=475 IC=+0.087 PNL=+78.61€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=1251 PNL=+220.26€
  - _Datos_: n=1251 IC=+0.091 PNL=+220.26€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1172 IC=+0.031 PNL=+115.71€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1172 IC=+0.031 PNL=+115.71€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.168 > 0.1 con n=865 PNL=+315.59€
  - _Datos_: n=865 IC=+0.168 PNL=+315.59€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=903 IC=-0.076 PNL=+220.12€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=903 IC=-0.076 PNL=+220.12€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1051 IC=+0.054 PNL=+116.23€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1051 IC=+0.054 PNL=+116.23€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.136 > 0.08 con n=618 PNL=+192.50€
  - _Datos_: n=618 IC=+0.136 PNL=+192.50€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.182 > 0.08 con n=265 PNL=+99.76€
  - _Datos_: n=265 IC=+0.182 PNL=+99.76€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.105 > 0.08 con n=540 PNL=+171.10€
  - _Datos_: n=540 IC=+0.105 PNL=+171.10€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.131 > 0.08 con n=659 PNL=+336.11€
  - _Datos_: n=659 IC=+0.131 PNL=+336.11€
