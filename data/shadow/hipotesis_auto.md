# Hipótesis automáticas — 2026-07-15 05:28 UTC
_Generado por shadow_postmortem.py sobre 14859 resoluciones (PNL=+2849.31€)_
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.209 (n=355)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.196 (n=829)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `4381.7761` → IC=+0.194 (n=469)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 4381.7761 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.165 (n=389)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 16.0 (IC base=+0.165)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.196 (n=271)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 5.0 (IC base=+0.165)

- **PATRÓN** `py_entrada` < `0.265` → IC=+0.319 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=929)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `7344.6882` → IC=+0.180 (n=270)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 7344.6882 (IC base=+0.165)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.196 (n=54)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.176 (n=35)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 7.0 (IC base=+0.179)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.210 (n=36)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `6926.0677` → IC=+0.230 (n=35)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.236 (n=157)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `5188.295` → IC=+0.261 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5188.295 (IC base=+0.230)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.218 (n=172)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4675.0354` → IC=+0.213 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4675.0354 (IC base=+0.210)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` < `13.0` → IC=+0.293 (n=27)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.635` → IC=+0.278 (n=16)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.635 (IC base=+0.241)
...
- **PATRÓN** `libro_liquidez` > `1632.5658` → IC=+0.235 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1632.5658 (IC base=+0.227)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.214 (n=82)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.200)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.206 (n=178)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.253 (n=152)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.130 (n=25)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 7.0 (IC base=+0.086)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.300 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.086)

### GBM_LATE_15M
- **PATRÓN** `dist_vwap_pct` > `1.0048` → IC=+0.139 (n=70)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 1.0048 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.493` → IC=+0.237 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.493 (IC base=+0.102)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.135 (n=1150)
...
- **PATRÓN** `dist_vwap_pct` > `0.2464` → IC=+0.145 (n=29)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.2464 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.466` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.466 (IC base=+0.078)
...
- **PATRÓN** `dist_vwap_pct` > `0.762` → IC=+0.156 (n=30)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.762 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.073` → IC=+0.138 (n=45)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 5.073 (IC base=+0.064)
...
- **PATRÓN** `sigma_h` < `0.0135` → IC=+0.142 (n=381)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0135 (IC base=+0.133)

- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.136 (n=432)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0094 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.173 (n=289)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 11.0 (IC base=+0.133)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` > `0.0225` → IC=+0.167 (n=184)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0225 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=424)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.141 (n=279)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` > `0.7064` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.7064 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.291` → IC=+0.188 (n=30)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 8.291 (IC base=+0.133)
...
- **PATRÓN** `sigma_h` > `0.012` → IC=+0.224 (n=208)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.171 (n=281)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 8.0 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.8259` → IC=+0.239 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8259 (IC base=+0.157)
...
- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.180 (n=655)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.188 (n=232)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 5.0 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` > `1.0629` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 1.0629 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.1945` → IC=+0.202 (n=381)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1945 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.927` → IC=+0.245 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.927 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.119` → IC=+0.174 (n=317)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` < 3.119 (IC base=+0.159)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.152 (n=176)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 18.0 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.3457` → IC=+0.223 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3457 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.207` → IC=+0.382 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.207 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.142 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0066 (IC base=+0.128)

- **PATRÓN** `sigma_h` > `0.0041` → IC=+0.156 (n=149)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.172 (n=59)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 5.0 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` > `0.7629` → IC=+0.188 (n=30)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.7629 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `1.215` → IC=+0.156 (n=120)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 1.215 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.42` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 5.42 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.079` → IC=+0.156 (n=91)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 10.079 (IC base=+0.128)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `3.444` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 3.444
  - _Potencial_: sin este filtro IC_bueno=+0.167 (n=85)

- **PATRÓN** `sigma_h` > `0.0131` → IC=+0.205 (n=76)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0131 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.161 (n=60)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 18.0 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.4922` → IC=+0.174 (n=44)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.4922 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `1.2199` → IC=+0.136 (n=116)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 1.2199 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.72` → IC=+0.224 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.72 (IC base=+0.131)

- **PATRÓN** `sigma_h` < `0.0124` → IC=+0.128 (n=181)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0124 (IC base=+0.099)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.152 (n=67)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 5.0 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` < `0.2663` → IC=+0.184 (n=96)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.2663 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.444` → IC=+0.167 (n=85)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` < 3.444 (IC base=+0.099)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0144` → IC=+0.149 (n=189)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0144 (IC base=+0.093)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.122 (n=281)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 8.0 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.7664` → IC=+0.171 (n=80)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.7664 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.39` → IC=+0.315 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.39 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` < `0.1754` → IC=+0.123 (n=319)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.1754 (IC base=+0.082)
...
- **PATRÓN** `dist_vwap_pct` > `0.8734` → IC=+0.147 (n=15)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.8734 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.755` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.755 (IC base=+0.086)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.140 (n=48)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0037 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` > `0.6377` → IC=+0.156 (n=30)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6377 (IC base=+0.039)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.419` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.419 (IC base=+0.039)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.123 (n=67)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 6.0 (IC base=+0.028)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.0326` → IC=+0.173 (n=157)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0326 (IC base=+0.171)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.183 (n=156)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0112 (IC base=+0.171)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.237 (n=55)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` > `0.1821` → IC=+0.182 (n=42)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1821 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `1.5825` → IC=+0.138 (n=78)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 1.5825 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.563` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.563 (IC base=+0.171)
...
### UPDOWN_GBM#15min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.138 (n=92)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.103 (n=419)

- **PATRÓN** `ibs_15` > `0.7197` → IC=+0.171 (n=256)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.85€ cuando `ibs_15` > 0.7197 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.7415` → IC=+0.197 (n=31)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.7415 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` < `0.3382` → IC=+0.149 (n=132)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.3382 (IC base=+0.025)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.266` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 15.266 (IC base=+0.025)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2227` → IC=+0.123 (n=160)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.2227 (IC base=+0.070)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.158 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 11.0 (IC base=+0.070)

- **PATRÓN** `ibs_15` < `0.9252` → IC=+0.132 (n=142)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.9252 (IC base=+0.070)

- **PATRÓN** `ibs_15` > `0.6323` → IC=+0.188 (n=142)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.94€ cuando `ibs_15` > 0.6323 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.7608` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7608 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.517` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.517 (IC base=+0.070)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7197 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.171 n=256). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6323 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.188 n=142). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2015 | +0.178 | -25.56€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1300 | +0.209 | +8.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 85 | -0.006 | -17.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 288 | +0.103 | -36.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 342 | +0.166 | +20.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 587 | +0.177 | -15.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 435 | +0.196 | -22.54€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 28 | +0.067 | -2.59€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 114 | +0.172 | +13.49€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#ETH | 714 | +0.180 | +14.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 428 | +0.221 | +22.64€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 28 | -0.133 | -11.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 144 | +0.116 | -13.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 114 | +0.181 | +16.52€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL | 708 | +0.177 | -20.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 431 | +0.214 | +12.15€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 29 | +0.048 | -3.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 134 | +0.118 | -19.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 114 | +0.138 | -9.02€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 6 | -0.037 | -4.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 6 | -0.037 | -4.17€ | 0 | 0 |
| ✅ GBM_LATE_15M | 4478 | +0.102 | +1361.30€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4478 | +0.102 | +1361.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1072 | +0.067 | +155.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1072 | +0.067 | +155.87€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1099 | +0.074 | +183.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1099 | +0.074 | +183.52€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1190 | +0.112 | +493.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1190 | +0.112 | +493.53€ | 0 | 6 |
| ✅ GBM_LATE_15M#XRP | 1117 | +0.150 | +528.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1117 | +0.150 | +528.38€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1749 | +0.150 | +1004.52€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1749 | +0.150 | +1004.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 447 | +0.126 | +226.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 447 | +0.126 | +226.51€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 463 | +0.124 | +203.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 463 | +0.124 | +203.40€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 471 | +0.105 | +198.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 471 | +0.105 | +198.23€ | 1 | 9 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO | 21 | -0.196 | -3.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 21 | -0.196 | -3.97€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 1695 | +0.081 | +442.44€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1695 | +0.081 | +442.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 418 | +0.064 | +67.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 418 | +0.064 | +67.19€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 375 | +0.009 | +5.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 375 | +0.009 | +5.93€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 426 | +0.042 | +59.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 426 | +0.042 | +59.88€ | 2 | 5 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 476 | +0.186 | +309.43€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 476 | +0.186 | +309.43€ | 0 | 10 |
...
| ✅ GBM_LATE_60M_PYCONFIRMADO | 5 | -0.089 | -2.55€ | 0 | 0 |
| ✅ GBM_LATE_60M_PYCONFIRMADO#60min | 5 | -0.089 | -2.55€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 113 | +0.091 | +30.23€ | 0 | 3 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 113 | +0.091 | +30.23€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 113 | +0.091 | +30.23€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 113 | +0.091 | +30.23€ | 0 | 3 |
...
| ✅ UPDOWN_GBM | 1534 | +0.008 | +64.97€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1277 | +0.035 | +101.49€ | 1 | 7 |
...
| ✅ UPDOWN_GBM#BTC | 395 | +0.026 | +27.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 315 | +0.065 | +40.03€ | 1 | 9 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.123) — sin ventaja clara. oversold(IBS<0.3): IC=-0.012 n=422 | neutral: IC=-0.023 n=321 | overbought(IBS>0.7): IC=+0.099 n=340
  - _Datos_: n=1144 IC=+0.024 PNL=+90.20€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.098 n=8557 | tras_1loss IC=+0.058 n=6125 | tras_2loss IC=+0.026 n=2667/40 | gap=+0.072 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.076 n=97/60 | contraria IC=+0.177 n=29 | gap=-0.102 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1407 IC=+0.015 PNL=+78.97€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1407 IC=+0.015 PNL=+78.97€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=686 IC=+0.025 PNL=+42.38€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=686 IC=+0.025 PNL=+42.38€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=315 IC=+0.065 PNL=+40.03€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=315 IC=+0.065 PNL=+40.03€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=670 IC=+0.073 PNL=+84.99€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=670 IC=+0.073 PNL=+84.99€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.204 > 0.08 con n=79 PNL=+8.34€
  - _Datos_: n=79 IC=+0.204 PNL=+8.34€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12401 IC=+0.100 PNL=+2925.19€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12401 IC=+0.100 PNL=+2925.19€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=834 IC=-0.006 PNL=+12.84€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=834 IC=-0.006 PNL=+12.84€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.164 > 0.1 con n=382 PNL=+133.11€
  - _Datos_: n=382 IC=+0.164 PNL=+133.11€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.148 > 0.08 con n=282 PNL=+88.62€
  - _Datos_: n=282 IC=+0.148 PNL=+88.62€
...
**⏳ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: 91/102 ops en el filtro definido (IC actual=-0.016 PNL=-0.21€)
  - _Datos_: n=91 IC=-0.016 PNL=-0.21€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.140 > 0.08 con n=381 PNL=+158.33€
  - _Datos_: n=381 IC=+0.140 PNL=+158.33€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.210 > 0.08 con n=122 PNL=+54.95€
  - _Datos_: n=122 IC=+0.210 PNL=+54.95€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.188 < -0.1 con n=382 PNL=-91.27€
  - _Datos_: n=382 IC=-0.188 PNL=-91.27€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.256 > 0.2 con n=281 PNL=+190.33€
  - _Datos_: n=281 IC=+0.256 PNL=+190.33€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.108 > 0.08 con n=141 PNL=+57.64€
  - _Datos_: n=141 IC=+0.108 PNL=+57.64€
