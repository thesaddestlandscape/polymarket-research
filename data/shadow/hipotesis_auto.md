# Hipótesis automáticas — 2026-06-29 21:40 UTC
_Generado por shadow_postmortem.py sobre 1317 resoluciones (PNL=-36.99€)_
...
- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.125 (n=30)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0107 (IC base=+0.067)
...
| ✅ UPDOWN_GBM | 348 | +0.011 | +4.45€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 203 | +0.056 | +10.29€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 134 | +0.051 | +5.50€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 88 | +0.067 | +2.31€ | 0 | 1 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.157: neutral→boost, oversold→filtro | oversold(IBS<0.3): IC=+0.000 n=16 | neutral: IC=+0.157 n=17 | overbought(IBS>0.7): IC=+0.038 n=24
  - _Datos_: n=59 IC=+0.074 PNL=+3.32€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 59 ops, 10 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=249 IC=+0.034 PNL=+10.09€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=249 IC=+0.034 PNL=+10.09€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=152 IC=+0.033 PNL=-2.88€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=152 IC=+0.033 PNL=-2.88€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.128 > 0.08 con n=76 PNL=+8.08€
  - _Datos_: n=76 IC=+0.128 PNL=+8.08€
