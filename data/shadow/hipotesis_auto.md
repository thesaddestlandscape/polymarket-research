# Hipótesis automáticas — 2026-07-19 04:51 UTC
_Generado por shadow_postmortem.py sobre 21927 resoluciones (PNL=+5321.10€)_
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.221 (n=632)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=1620)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.271 (n=120)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.3108` → IC=+0.128 (n=323)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.3108 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.998` → IC=+0.225 (n=169)
...
- **PATRÓN** `dist_vwap_pct` > `0.1226` → IC=+0.202 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1226 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.066` → IC=+0.294 (n=158)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.134 (n=903)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` < `0.1166` → IC=+0.155 (n=494)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1166 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.253` → IC=+0.287 (n=134)
...
- **PATRÓN** `ibs_15` > `0.7393` → IC=+0.192 (n=303)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `ibs_15` > 0.7393 (IC base=+0.035)

- **PATRÓN** `dist_vwap_pct` > `0.1333` → IC=+0.144 (n=144)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.1333 (IC base=+0.035)

- **PATRÓN** `dist_vwap_pct` < `0.5087` → IC=+0.146 (n=210)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.5087 (IC base=+0.035)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.684` → IC=+0.156 (n=30)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 23.684 (IC base=+0.035)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2359` → IC=+0.123 (n=221)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.2359 (IC base=+0.076)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.143 (n=169)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 12.0 (IC base=+0.076)

- **PATRÓN** `ibs_15` > `0.6428` → IC=+0.185 (n=182)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` > 0.6428 (IC base=+0.076)

- **PATRÓN** `dist_vwap_pct` > `0.8291` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8291 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.498` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` < 5.498 (IC base=+0.076)
...
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6428 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.185 n=182). Confirma señal de reversión media → alinear con BUY_NO.
...
| ✅ FAVORITO_CONFIRMADO | 3678 | +0.185 | +52.24€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 2386 | +0.218 | +93.26€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1067 | +0.192 | +30.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 796 | +0.209 | +0.43€ | 0 | 6 |
...
| ✅ GBM_LATE_15M | 5722 | +0.106 | +1910.19€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 5722 | +0.106 | +1910.19€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1363 | +0.077 | +248.49€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1363 | +0.077 | +248.49€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2954 | +0.154 | +1771.97€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2954 | +0.154 | +1771.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 753 | +0.117 | +357.01€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 753 | +0.117 | +357.01€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 2898 | +0.101 | +1013.26€ | 0 | 11 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2898 | +0.101 | +1013.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 696 | +0.073 | +148.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 696 | +0.073 | +148.97€ | 0 | 7 |
...
| ✅ GBM_LATE_5M | 84 | +0.081 | +5.96€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 84 | +0.081 | +5.96€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#XRP | 51 | +0.141 | +9.33€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 51 | +0.141 | +9.33€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1810 | +0.021 | +131.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1550 | +0.046 | +169.71€ | 1 | 7 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 127 | -0.058 | -10.76€ | 7 | 0 |
| ✅ UPDOWN_GBM#BNB | 128 | +0.069 | +31.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 128 | +0.069 | +31.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 459 | +0.027 | +31.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 376 | +0.064 | +45.57€ | 1 | 7 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 574 | +0.188 | +262.98€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 574 | +0.188 | +262.98€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 47 | +0.194 | +19.35€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 47 | +0.194 | +19.35€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 67 | +0.094 | +9.93€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 67 | +0.094 | +9.93€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.184: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.054 n=718 | neutral: IC=-0.005 n=529 | overbought(IBS>0.7): IC=+0.179 n=672
  - _Datos_: n=2055 IC=+0.087 PNL=+431.41€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.118 n=13177 | tras_1loss IC=+0.087 n=8554 | tras_2loss IC=+0.054 n=3494/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1679 IC=+0.028 PNL=+147.27€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1679 IC=+0.028 PNL=+147.27€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=780 IC=+0.035 PNL=+65.88€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=780 IC=+0.035 PNL=+65.88€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=376 IC=+0.064 PNL=+45.57€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=376 IC=+0.064 PNL=+45.57€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.080 > 0.08 con n=820 PNL=+122.42€
  - _Datos_: n=820 IC=+0.080 PNL=+122.42€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=729 IC=+0.043 PNL=+73.68€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=729 IC=+0.043 PNL=+73.68€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=19469 IC=+0.121 PNL=+5396.98€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=19469 IC=+0.121 PNL=+5396.98€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=930 IC=+0.004 PNL=+35.33€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=930 IC=+0.004 PNL=+35.33€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.1 con n=516 PNL=+180.81€
  - _Datos_: n=516 IC=+0.162 PNL=+180.81€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=623 IC=-0.089 PNL=+95.70€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=623 IC=-0.089 PNL=+95.70€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.138 > 0.08 con n=376 PNL=+112.13€
  - _Datos_: n=376 IC=+0.138 PNL=+112.13€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=125 IC=+0.028 PNL=+17.47€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=125 IC=+0.028 PNL=+17.47€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.133 > 0.08 con n=472 PNL=+189.74€
  - _Datos_: n=472 IC=+0.133 PNL=+189.74€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.178 > 0.08 con n=175 PNL=+66.28€
  - _Datos_: n=175 IC=+0.178 PNL=+66.28€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.235 > 0.2 con n=478 PNL=+309.62€
  - _Datos_: n=478 IC=+0.235 PNL=+309.62€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.08 con n=273 PNL=+132.52€
  - _Datos_: n=273 IC=+0.162 PNL=+132.52€
