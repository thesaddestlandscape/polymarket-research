# Hipótesis automáticas — 2026-07-02 02:16 UTC
_Generado por shadow_postmortem.py sobre 2520 resoluciones (PNL=-84.32€)_
...
- **FILTRO** `ibs_15` > `0.4968` → IC=-0.233 (n=28)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.4968
  - _Potencial_: sin este filtro IC_bueno=+0.144 (n=88)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.262 (n=61)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.078)

- **PATRÓN** `drift_15min` |x|≤ `0.7351` → IC=+0.122 (n=80)

  - _Acción_: Kelly boost +0.61€ cuando `drift_15min` |x|≤ 0.7351 (IC base=+0.078)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.177 (n=29)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.078)

- **PATRÓN** `ibs_15` < `0.4968` → IC=+0.144 (n=88)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` < 0.4968 (IC base=+0.078)
...
- **FILTRO** `pct_spot_vs_ref` |x|> `0.017` → IC=-0.150 (n=18)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
...
- **PATRÓN** `sigma_h` < `0.0124` → IC=+0.184 (n=17)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0124 (IC base=+0.129)
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.099) — sin ventaja clara. oversold(IBS<0.3): IC=+0.038 n=115 | neutral: IC=-0.060 n=114 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=378 IC=-0.024 PNL=-7.92€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.179 n=26 PNL=-12.72€ → FILTRAR | H=02h: IC=-0.154 n=15 PNL=-3.66€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1189 | tras_1loss IC=-0.036 n=1249 | tras_2loss IC=-0.049 n=650/40 | gap=+0.052 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=22, boost estimado=+0.007. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=52/40 IC=+0.000 PNL=-1.54€ | BTC#60min: n=41/40 IC=-0.058 PNL=-5.65€ | SOL#60min: n=24/40 IC=-0.154 PNL=-2.70€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=645 IC=-0.025 PNL=-19.60€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=645 IC=-0.025 PNL=-19.60€
...
**⏳ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  ...
  - _Estado_: 28/30 ops en el filtro definido (IC actual=-0.033 PNL=-2.30€)
  - _Datos_: n=28 IC=-0.033 PNL=-2.30€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.016 < 0.02 con n=157 PNL=-18.19€
  - _Datos_: n=157 IC=-0.016 PNL=-18.19€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=233 IC=+0.002 PNL=-17.11€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=233 IC=+0.002 PNL=-17.11€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=165 IC=+0.051 PNL=+20.63€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=165 IC=+0.051 PNL=+20.63€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 103/200 ops en el filtro definido (IC actual=+0.052 PNL=+8.61€)
  - _Datos_: n=103 IC=+0.052 PNL=+8.61€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=103 IC=+0.052 PNL=+8.61€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=103 IC=+0.052 PNL=+8.61€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 12/40 ops en el filtro definido (IC actual=+0.043 PNL=+0.38€)
  - _Datos_: n=12 IC=+0.043 PNL=+0.38€
