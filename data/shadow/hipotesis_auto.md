# Hipótesis automáticas — 2026-07-02 12:03 UTC
_Generado por shadow_postmortem.py sobre 2639 resoluciones (PNL=-60.44€)_
...
- **FILTRO** `ibs_15` > `0.3691` → IC=-0.149 (n=35)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.3691
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=109)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.222 (n=70)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.049)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.150 (n=38)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 14.0 (IC base=+0.049)

- **PATRÓN** `ibs_15` < `0.0714` → IC=+0.220 (n=48)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0714 (IC base=+0.049)
...
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.130 (n=44)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 10.0 (IC base=-0.027)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0714 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.220 n=48). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 75 | +0.175 | +25.04€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 75 | +0.175 | +25.04€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 20 | +0.091 | +2.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 20 | +0.091 | +2.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 21 | +0.109 | +2.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 21 | +0.109 | +2.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 15 | +0.110 | +6.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 15 | +0.110 | +6.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 19 | +0.294 | +13.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 19 | +0.294 | +13.83€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1509 | +0.014 | +12.35€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1373 | +0.009 | -0.24€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 254 | -0.019 | -7.11€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 254 | -0.019 | -7.11€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 804 | -0.035 | -35.41€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 579 | -0.011 | -9.07€ | 2 | 3 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 122 | -0.057 | -10.32€ | 5 | 0 |
| ✅ UPDOWN_GBM#BNB | 22 | -0.125 | -5.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 22 | -0.125 | -5.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 232 | -0.038 | -29.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 162 | -0.012 | -18.87€ | 2 | 1 |
...
| ✅ UPDOWN_GBM#ETH | 310 | -0.003 | +10.63€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 227 | +0.015 | +16.59€ | 4 | 7 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.086) — sin ventaja clara. oversold(IBS<0.3): IC=+0.018 n=139 | neutral: IC=-0.068 n=123 | overbought(IBS>0.7): IC=-0.043 n=138
  - _Datos_: n=414 IC=-0.029 PNL=-10.18€
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 150 ops con delta_ratio | SOL: 189 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.010 n=1260 | tras_1loss IC=-0.033 n=1292 | tras_2loss IC=-0.047 n=669/40 | gap=+0.057 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=681 IC=-0.029 PNL=-21.86€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=681 IC=-0.029 PNL=-21.86€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=368 IC=-0.046 PNL=-37.90€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=368 IC=-0.046 PNL=-37.90€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.012 < 0.02 con n=162 PNL=-18.87€
  - _Datos_: n=162 IC=-0.012 PNL=-18.87€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=241 IC=-0.002 PNL=-22.37€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=241 IC=-0.002 PNL=-22.37€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=193 IC=+0.023 PNL=+17.16€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=193 IC=+0.023 PNL=+17.16€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=222 IC=+0.076 PNL=+32.49€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=222 IC=+0.076 PNL=+32.49€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 26/40 ops en el filtro definido (IC actual=+0.036 PNL=-2.75€)
  - _Datos_: n=26 IC=+0.036 PNL=-2.75€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.072 < -0.05 con n=510 PNL=-65.82€
  - _Datos_: n=510 IC=-0.072 PNL=-65.82€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 63/120 ops en el filtro definido (IC actual=+0.146 PNL=+10.82€)
  - _Datos_: n=63 IC=+0.146 PNL=+10.82€
