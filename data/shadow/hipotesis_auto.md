# Hipótesis automáticas — 2026-07-02 00:17 UTC
_Generado por shadow_postmortem.py sobre 2488 resoluciones (PNL=-75.78€)_
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.259 (n=52)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.099)

- **PATRÓN** `drift_60min` |x|≤ `0.438` → IC=+0.130 (n=44)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.438 (IC base=+0.099)

- **PATRÓN** `drift_15min` |x|≤ `0.4139` → IC=+0.129 (n=33)

  - _Acción_: Kelly boost +0.64€ cuando `drift_15min` |x|≤ 0.4139 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.197 (n=31)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 16.0 (IC base=+0.099)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.250 (n=30)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0613 (IC base=+0.099)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0613 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.250 n=30). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 738 | -0.032 | -24.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 520 | -0.006 | +1.30€ | 1 | 5 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.114) — sin ventaja clara. oversold(IBS<0.3): IC=+0.032 n=109 | neutral: IC=-0.083 n=101 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=348 IC=-0.023 PNL=+0.58€
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=20, boost estimado=+0.003. Necesita 0 más y boost>0.05
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.000 n=1171 | tras_1loss IC=-0.034 n=1235 | tras_2loss IC=-0.048 n=642/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=615 IC=-0.025 PNL=-11.10€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=615 IC=-0.025 PNL=-11.10€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=137 IC=+0.068 PNL=+29.16€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=137 IC=+0.068 PNL=+29.16€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 71/200 ops en el filtro definido (IC actual=+0.089 PNL=+17.14€)
  - _Datos_: n=71 IC=+0.089 PNL=+17.14€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 71/100 ops en el filtro definido (IC actual=+0.089 PNL=+17.14€)
  - _Datos_: n=71 IC=+0.089 PNL=+17.14€
