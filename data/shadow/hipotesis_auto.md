# Hipótesis automáticas — 2026-06-30 01:44 UTC
_Generado por shadow_postmortem.py sobre 1346 resoluciones (PNL=-46.59€)_
...
| ✅ UPDOWN_GBM#ETH | 147 | +0.030 | +3.44€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.033) — sin ventaja clara. oversold(IBS<0.3): IC=-0.033 n=28 | neutral: IC=+0.000 n=24 | overbought(IBS>0.7): IC=-0.015 n=31
  - _Datos_: n=85 IC=-0.017 PNL=-6.75€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 85 ops, 15 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 374/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=275 IC=+0.009 PNL=+0.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=275 IC=+0.009 PNL=+0.02€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=166 IC=+0.000 PNL=-12.20€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=166 IC=+0.000 PNL=-12.20€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.086 > 0.08 con n=85 PNL=+1.31€
  - _Datos_: n=85 IC=+0.086 PNL=+1.31€
