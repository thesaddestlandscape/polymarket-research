# Hipótesis automáticas — 2026-07-19 03:17 UTC
_Generado por shadow_postmortem.py sobre 21792 resoluciones (PNL=+5256.63€)_
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.205 (n=1353)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.194)

- **PATRÓN** `py_entrada` > `0.695` → IC=+0.303 (n=601)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.197 (n=1526)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.224 (n=530)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.175)

- **PATRÓN** `py_entrada` < `0.265` → IC=+0.341 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.175)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=1608)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.175)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.224 (n=299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.213)

- **PATRÓN** `py_entrada` > `0.615` → IC=+0.271 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.615 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `11457.7879` → IC=+0.214 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11457.7879 (IC base=+0.213)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.273 (n=117)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.205)

- **PATRÓN** `py_entrada` < `0.235` → IC=+0.375 (n=110)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.306 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.143)

- **PATRÓN** `py_entrada` < `0.41` → IC=+0.229 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.41 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6464.783` → IC=+0.155 (n=85)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 6464.783 (IC base=+0.143)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.237 (n=298)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.224)

- **PATRÓN** `py_entrada` > `0.715` → IC=+0.355 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.715 (IC base=+0.224)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.225 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `4405.4574` → IC=+0.233 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4405.4574 (IC base=+0.224)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.227 (n=119)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.237 (n=211)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.218)

- **PATRÓN** `py_entrada` < `0.235` → IC=+0.382 (n=108)
...
- **PATRÓN** `py_entrada` < `0.405` → IC=+0.187 (n=65)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` < 0.405 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `4043.1829` → IC=+0.178 (n=85)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 4043.1829 (IC base=+0.143)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.127 (n=1799)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 8.0 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.5545` → IC=+0.133 (n=205)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.5545 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.998` → IC=+0.222 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.998 (IC base=+0.114)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.132 (n=1440)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0088 (IC base=+0.113)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.134 (n=1546)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 12.0 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.1645` → IC=+0.128 (n=361)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.1645 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.9045` → IC=+0.124 (n=1077)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.9045 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.174` → IC=+0.142 (n=227)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 6.174 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.016` → IC=+0.120 (n=954)

  - _Acción_: Kelly boost +0.60€ cuando `sigma_ewma_delta_pct` < 11.016 (IC base=+0.113)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.120 (n=401)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.60€ cuando `sigma_h` < 0.0064 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.6064` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.6064 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.047` → IC=+0.237 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.047 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.1355` → IC=+0.136 (n=64)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.1355 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` < `0.5188` → IC=+0.132 (n=218)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.5188 (IC base=+0.073)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.887` → IC=+0.191 (n=95)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 2.887 (IC base=+0.073)

### GBM_LATE_15M#ETH#15min
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.174 (n=136)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0045 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.8499` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.8499 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.301` → IC=+0.212 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.301 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.6735` → IC=+0.167 (n=58)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6735 (IC base=+0.077)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.518` → IC=+0.230 (n=72)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.263` → IC=-0.265 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=246)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.145 (n=201)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 18.0 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.309` → IC=+0.216 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.309 (IC base=+0.104)

- **PATRÓN** `sigma_h` < `0.013` → IC=+0.140 (n=470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.013 (IC base=+0.124)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.128 (n=533)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.009 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.171 (n=387)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 12.0 (IC base=+0.124)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` < `0.0284` → IC=+0.152 (n=547)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0284 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0155` → IC=+0.175 (n=364)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0155 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.156 (n=550)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 6.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.155 (n=488)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 15.0 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.5822` → IC=+0.245 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5822 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1144` → IC=+0.145 (n=201)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.1144 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.547` → IC=+0.278 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.547 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.194 (n=191)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0098 (IC base=+0.171)

- **PATRÓN** `sigma_h` > `0.0257` → IC=+0.203 (n=190)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.3099` → IC=+0.182 (n=86)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.3099 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.5554` → IC=+0.165 (n=314)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.5554 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.696` → IC=+0.170 (n=283)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` < 7.696 (IC base=+0.171)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0116` → IC=+0.239 (n=351)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0116 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.185 (n=760)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 12.0 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.1699` → IC=+0.208 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1699 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.074` → IC=+0.290 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.074 (IC base=+0.165)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.188 (n=1033)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0046 (IC base=+0.171)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.183 (n=519)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.171)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.199 (n=350)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 5.0 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.8782` → IC=+0.189 (n=945)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.8782 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.064` → IC=+0.227 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.064 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.053` → IC=+0.182 (n=650)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.053 (IC base=+0.171)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.130 (n=252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` < 0.0064 (IC base=+0.126)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.152 (n=225)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0029 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.180 (n=170)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 13.0 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` > `0.3606` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.3606 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.899` → IC=+0.211 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.899 (IC base=+0.126)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.140 (n=262)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0061 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0026` → IC=+0.167 (n=262)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1165` → IC=+0.138 (n=67)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.1165 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.7143` → IC=+0.133 (n=232)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.7143 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.151` → IC=+0.223 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.151 (IC base=+0.135)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.159 (n=282)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 18.0 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.5316` → IC=+0.192 (n=63)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.5316 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.8807` → IC=+0.148 (n=214)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.8807 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.066` → IC=+0.267 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.066 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.140 (n=237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0066 (IC base=+0.129)

- **PATRÓN** `sigma_h` > `0.0041` → IC=+0.138 (n=241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0041 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.156 (n=94)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 18.0 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=90)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` > `0.6273` → IC=+0.189 (n=59)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.6273 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `1.1418` → IC=+0.144 (n=254)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 1.1418 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.518` → IC=+0.243 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.518 (IC base=+0.129)
...
- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.191 (n=134)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0119 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.159 (n=209)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 12.0 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.151 (n=104)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 6.0 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.6161` → IC=+0.195 (n=57)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.6161 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.625` → IC=+0.284 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.625 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0122` → IC=+0.149 (n=249)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0122 (IC base=+0.119)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=84)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` < `0.7922` → IC=+0.160 (n=207)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.7922 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.606` → IC=+0.183 (n=165)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 2.606 (IC base=+0.119)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.017` → IC=+0.261 (n=241)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.017 (IC base=+0.255)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.270 (n=241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.264 (n=248)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.255)

- **PATRÓN** `dist_vwap_pct` > `0.2844` → IC=+0.325 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2844 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.801` → IC=+0.394 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.801 (IC base=+0.255)

- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.328 (n=254)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.300)
...
- **PATRÓN** `dist_vwap_pct` > `0.3099` → IC=+0.325 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3099 (IC base=+0.300)

- **PATRÓN** `dist_vwap_pct` < `0.5637` → IC=+0.312 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5637 (IC base=+0.300)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.458` → IC=+0.319 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.458 (IC base=+0.300)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.129 (n=324)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0053 (IC base=+0.127)

- **PATRÓN** `sigma_h` > `0.0136` → IC=+0.189 (n=323)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0136 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.134 (n=887)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 8.0 (IC base=+0.127)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.132 (n=892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 16.0 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.5433` → IC=+0.174 (n=191)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.5433 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.1183` → IC=+0.153 (n=488)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1183 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.266` → IC=+0.289 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.266 (IC base=+0.127)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.133 (n=401)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` < 6.0 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.7844` → IC=+0.128 (n=936)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.7844 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.527` → IC=+0.124 (n=243)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 3.527 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.031` → IC=+0.123 (n=834)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 11.031 (IC base=+0.105)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.149 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0045 (IC base=+0.113)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.127 (n=73)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` > 0.007 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.155 (n=201)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.5693` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.5693 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.025` → IC=+0.256 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.025 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.128 (n=92)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 17.0 (IC base=+0.081)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.887` → IC=+0.150 (n=98)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 2.887 (IC base=+0.081)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.179 (n=82)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0039 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` < `0.2777` → IC=+0.141 (n=126)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2777 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.369` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.369 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.89` → IC=+0.185 (n=52)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 7.89 (IC base=+0.045)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.135 (n=94)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 8.0 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` > `0.7129` → IC=+0.130 (n=25)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.7129 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.134 (n=91)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.958` → IC=+0.265 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.958 (IC base=+0.079)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.122 (n=88)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0083 (IC base=+0.041)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.125 (n=94)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 6.0 (IC base=+0.041)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.0282` → IC=+0.209 (n=304)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0282 (IC base=+0.208)

- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.241 (n=203)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0149 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.207 (n=281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2413` → IC=+0.263 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2413 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.976` → IC=+0.289 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.976 (IC base=+0.208)

- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.223 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0094 (IC base=+0.216)

- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.239 (n=151)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0168 (IC base=+0.216)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.236 (n=123)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` > `0.2916` → IC=+0.211 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2916 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `0.5425` → IC=+0.215 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5425 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.154` → IC=+0.227 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 10.154 (IC base=+0.216)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.125 (n=22)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 4.0 (IC base=+0.070)

- **PATRÓN** `py_entrada` < `0.505` → IC=+0.123 (n=67)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` < 0.505 (IC base=+0.070)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.593` → IC=-0.143 (n=26)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=277)

- **PATRÓN** `ibs_15` > `0.7393` → IC=+0.191 (n=302)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.95€ cuando `ibs_15` > 0.7393 (IC base=+0.033)

- **PATRÓN** `dist_vwap_pct` > `0.1333` → IC=+0.141 (n=143)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.1333 (IC base=+0.033)

- **PATRÓN** `dist_vwap_pct` < `0.5087` → IC=+0.143 (n=208)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.5087 (IC base=+0.033)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.418` → IC=+0.156 (n=30)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 23.418 (IC base=+0.033)

- **PATRÓN** `ibs_15` < `0.0263` → IC=+0.121 (n=175)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` < 0.0263 (IC base=+0.060)

- **PATRÓN** `dist_vwap_pct` > `0.4531` → IC=+0.123 (n=51)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` > 0.4531 (IC base=+0.060)

- **PATRÓN** `sigma_ewma_delta_pct` < `17.593` → IC=+0.127 (n=277)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 17.593 (IC base=+0.060)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2359` → IC=+0.122 (n=220)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.2359 (IC base=+0.075)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.143 (n=169)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 12.0 (IC base=+0.075)

- **PATRÓN** `ibs_15` > `0.6428` → IC=+0.183 (n=181)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` > 0.6428 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` > `0.8291` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8291 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.65` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` < 4.65 (IC base=+0.075)
...
- **PATRÓN** `ibs_15` > `0.7686` → IC=+0.200 (n=98)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7686 (IC base=+0.029)

- **PATRÓN** `dist_vwap_pct` < `0.5087` → IC=+0.145 (n=91)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.5087 (IC base=+0.029)

- **PATRÓN** `sigma_ewma_delta_pct` > `22.327` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 22.327 (IC base=+0.029)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.130 (n=98)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` < 0.0058 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.974` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.974 (IC base=+0.052)

- **PATRÓN** `sigma_ewma_delta_pct` < `8.229` → IC=+0.134 (n=99)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 8.229 (IC base=+0.052)
...
- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.220 (n=23)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0088 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.2258` → IC=+0.145 (n=29)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.2258 (IC base=+0.134)

- **PATRÓN** `drift_15min` |x|≤ `1.1387` → IC=+0.151 (n=64)

  - _Acción_: Kelly boost +0.76€ cuando `drift_15min` |x|≤ 1.1387 (IC base=+0.134)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1215` → IC=+0.167 (n=43)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.1215 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.167 (n=64)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 4.0 (IC base=+0.134)

- **PATRÓN** `ibs_15` < `0.0769` → IC=+0.167 (n=55)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.0769 (IC base=+0.134)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7393 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.191 n=302). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6428 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.183 n=181). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS > 0.7686 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.200 n=98). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#XRP#15min**: IBS < 0.0769 correlaciona con éxito en UPDOWN_GBM#XRP#15min (IC=+0.167 n=55). Confirma señal de reversión media → alinear con BUY_YES.
- **LIVE-CANDIDATA**: `GBM_LATE_5M#XRP#5min` — IC=+0.134 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `GBM_LATE_5M#XRP` — IC=+0.134 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min` — IC=+0.321 n=37. Faltan ~3 resoluciones para umbral n≥40. ETA: ~2h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH` — IC=+0.321 n=37. Faltan ~3 resoluciones para umbral n≥40. ETA: ~2h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#DOGE#15min` — IC=+0.278 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#DOGE` — IC=+0.278 n=34. Faltan ~6 resoluciones para umbral n≥40. ETA: ~4h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 266 | +0.142 | +15.44€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 266 | +0.142 | +15.44€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 112 | +0.158 | +6.98€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 112 | +0.158 | +6.98€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 95 | +0.149 | +5.39€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 95 | +0.149 | +5.39€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 59 | +0.090 | +3.08€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 59 | +0.090 | +3.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 3649 | +0.184 | +46.47€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 2369 | +0.217 | +87.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 154 | +0.083 | +7.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 502 | +0.099 | -74.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 624 | +0.152 | +25.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 1059 | +0.193 | +33.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 790 | +0.210 | +2.18€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 51 | +0.123 | +8.12€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 208 | +0.167 | +26.54€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH | 1295 | +0.179 | +17.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 784 | +0.221 | +46.19€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 51 | -0.009 | -8.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 252 | +0.106 | -33.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 208 | +0.152 | +12.42€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL | 1279 | +0.182 | -5.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 783 | +0.222 | +41.99€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 52 | +0.130 | +7.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 236 | +0.101 | -42.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 208 | +0.133 | -13.19€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 16 | +0.133 | +1.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 12 | +0.043 | -2.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 134 | +0.309 | +3.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 134 | +0.309 | +3.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 134 | +0.309 | +3.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 134 | +0.309 | +3.49€ | 0 | 0 |
| ✅ GBM_LATE_15M | 5703 | +0.106 | +1900.31€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 5703 | +0.106 | +1900.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1358 | +0.076 | +241.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1358 | +0.076 | +241.94€ | 0 | 6 |
| ✅ GBM_LATE_15M#ETH | 1312 | +0.079 | +249.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1312 | +0.079 | +249.07€ | 0 | 5 |
| ✅ GBM_LATE_15M#SOL | 1544 | +0.100 | +603.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1544 | +0.100 | +603.83€ | 1 | 5 |
| ✅ GBM_LATE_15M#XRP | 1489 | +0.161 | +805.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1489 | +0.161 | +805.48€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2934 | +0.153 | +1754.93€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2934 | +0.153 | +1754.93€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 748 | +0.115 | +351.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 748 | +0.115 | +351.69€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 770 | +0.119 | +367.65€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 770 | +0.119 | +367.65€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 756 | +0.115 | +337.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 756 | +0.115 | +337.61€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 660 | +0.278 | +697.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 660 | +0.278 | +697.97€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 2876 | +0.101 | +1008.13€ | 0 | 11 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2876 | +0.101 | +1008.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 691 | +0.071 | +145.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 691 | +0.071 | +145.64€ | 0 | 7 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 692 | +0.039 | +68.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 692 | +0.039 | +68.70€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 646 | +0.052 | +132.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 646 | +0.052 | +132.97€ | 1 | 6 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 847 | +0.213 | +660.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 847 | +0.213 | +660.83€ | 0 | 12 |
| ✅ GBM_LATE_5M | 71 | +0.062 | +1.85€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 71 | +0.062 | +1.85€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC | 6 | +0.037 | -0.17€ | 0 | 0 |
| ✅ GBM_LATE_5M#BTC#5min | 6 | +0.037 | -0.17€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH | 9 | +0.021 | -1.11€ | 0 | 0 |
| ✅ GBM_LATE_5M#ETH#5min | 9 | +0.021 | -1.11€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL | 17 | -0.112 | -2.29€ | 0 | 0 |
| ✅ GBM_LATE_5M#SOL#5min | 17 | -0.112 | -2.29€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP | 39 | +0.134 | +5.43€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 39 | +0.134 | +5.43€ | 0 | 0 |
...
| ✅ LEADLAG_BTC_XRP_15M | 186 | +0.032 | +12.03€ | 1 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 186 | +0.032 | +12.03€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 186 | +0.032 | +12.03€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 186 | +0.032 | +12.03€ | 1 | 2 |
...
| ✅ UPDOWN_GBM | 1799 | +0.021 | +130.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1539 | +0.046 | +168.63€ | 1 | 7 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 127 | -0.058 | -10.76€ | 7 | 0 |
| ✅ UPDOWN_GBM#BNB | 125 | +0.075 | +33.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 125 | +0.075 | +33.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 458 | +0.026 | +29.93€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 375 | +0.062 | +43.90€ | 1 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 830 | +0.025 | +44.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 737 | +0.041 | +55.30€ | 2 | 6 |
...
| ✅ UPDOWN_GBM#XRP | 129 | +0.050 | +30.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 118 | +0.075 | +33.31€ | 5 | 6 |
| 🚫 UPDOWN_GBM#XRP#5min | 11 | -0.106 | -3.29€ | 0 | 0 |
| 🚫 UPDOWN_GBM#daily | 45 | -0.202 | +1.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 57 | +0.280 | +10.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 57 | +0.280 | +10.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC | 20 | +0.182 | -1.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min | 20 | +0.182 | -1.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 37 | +0.321 | +11.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 37 | +0.321 | +11.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 561 | +0.182 | +246.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 561 | +0.182 | +246.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 45 | +0.181 | +15.79€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 45 | +0.181 | +15.79€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 66 | +0.088 | +8.93€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 66 | +0.088 | +8.93€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 34 | +0.278 | +21.29€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 34 | +0.278 | +21.29€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 139 | +0.195 | +52.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 139 | +0.195 | +52.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 142 | +0.146 | +57.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 142 | +0.146 | +57.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 135 | +0.215 | +90.30€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 135 | +0.215 | +90.30€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.187: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.053 n=710 | neutral: IC=-0.009 n=523 | overbought(IBS>0.7): IC=+0.178 n=663
  - _Datos_: n=2030 IC=+0.085 PNL=+412.65€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=07h: IC=+0.123 n=59 PNL=+26.81€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.156 n=59 PNL=+26.91€ → BOOST | H=21h: IC=+0.129 n=60 PNL=+13.15€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.117 n=13069 | tras_1loss IC=+0.087 n=8519 | tras_2loss IC=+0.054 n=3483/40 | gap=+0.062 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.089 n=122/60 | contraria IC=+0.085 n=39 | gap=+0.003 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1669 IC=+0.028 PNL=+147.85€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1669 IC=+0.028 PNL=+147.85€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=778 IC=+0.033 PNL=+62.87€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=778 IC=+0.033 PNL=+62.87€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=375 IC=+0.062 PNL=+43.90€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=375 IC=+0.062 PNL=+43.90€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.080 > 0.08 con n=815 PNL=+120.82€
  - _Datos_: n=815 IC=+0.080 PNL=+120.82€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=720 IC=+0.044 PNL=+75.61€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=720 IC=+0.044 PNL=+75.61€

**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.194 > 0.08 con n=47 PNL=+22.39€
  - _Datos_: n=47 IC=+0.194 PNL=+22.39€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=19334 IC=+0.120 PNL=+5332.51€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=19334 IC=+0.120 PNL=+5332.51€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=194 IC=+0.015 PNL=+10.14€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=194 IC=+0.015 PNL=+10.14€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=928 IC=+0.003 PNL=+32.31€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=928 IC=+0.003 PNL=+32.31€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=513 PNL=+175.84€
  - _Datos_: n=513 IC=+0.160 PNL=+175.84€
...
**🟡 H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.134 > 0.1 con n=91 PNL=+36.65€
  - _Datos_: n=91 IC=+0.134 PNL=+36.65€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=620 IC=-0.092 PNL=+88.09€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=620 IC=-0.092 PNL=+88.09€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=716 IC=+0.067 PNL=+102.70€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=716 IC=+0.067 PNL=+102.70€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.136 > 0.08 con n=374 PNL=+109.11€
  - _Datos_: n=374 IC=+0.136 PNL=+109.11€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.176 > 0.08 con n=174 PNL=+64.61€
  - _Datos_: n=174 IC=+0.176 PNL=+64.61€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.184 < -0.1 con n=463 PNL=-83.75€
  - _Datos_: n=463 IC=-0.184 PNL=-83.75€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.234 > 0.2 con n=475 PNL=+305.43€
  - _Datos_: n=475 IC=+0.234 PNL=+305.43€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.134 > 0.08 con n=266 PNL=+97.89€
  - _Datos_: n=266 IC=+0.134 PNL=+97.89€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.156 > 0.08 con n=268 PNL=+125.97€
  - _Datos_: n=268 IC=+0.156 PNL=+125.97€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.171 > 0.08 con n=341 PNL=+220.61€
  - _Datos_: n=341 IC=+0.171 PNL=+220.61€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.199 > 0.08 con n=194 PNL=+6.57€
  - _Datos_: n=194 IC=+0.199 PNL=+6.57€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.259 > 0.08 con n=280 PNL=-7.93€
  - _Datos_: n=280 IC=+0.259 PNL=-7.93€
...
**〰️ H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: n=84 IC=+0.070 PNL=+13.17€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=84 IC=+0.070 PNL=+13.17€
...
**🟡 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.278 > 0.08 con n=70 PNL=+38.88€
  - _Datos_: n=70 IC=+0.278 PNL=+38.88€
