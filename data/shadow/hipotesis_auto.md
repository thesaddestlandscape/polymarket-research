# Hipótesis automáticas — 2026-07-17 04:58 UTC
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.160: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.007 n=544 | neutral: IC=-0.015 n=402 | overbought(IBS>0.7): IC=+0.145 n=451
  - _Datos_: n=1477 IC=+0.050 PNL=+159.53€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.106 n=10634 | tras_1loss IC=+0.073 n=7290 | tras_2loss IC=+0.042 n=3081/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=15663 IC=+0.109 PNL=+3899.49€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=15663 IC=+0.109 PNL=+3899.49€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.127 > 0.08 con n=424 PNL=+160.51€
  - _Datos_: n=424 IC=+0.127 PNL=+160.51€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.256 > 0.08 con n=215 PNL=-8.06€
  - _Datos_: n=215 IC=+0.256 PNL=-8.06€
