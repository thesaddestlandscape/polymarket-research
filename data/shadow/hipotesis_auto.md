# Hipótesis automáticas — 2026-07-21 21:06 UTC
_Generado por shadow_postmortem.py sobre 27526 resoluciones (PNL=+6317.75€)_
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=706)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=2082)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `4237.941` → IC=+0.171 (n=1252)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 4237.941 (IC base=+0.170)
...
| ✅ FAVORITO_CONFIRMADO | 4750 | +0.185 | +64.66€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1384 | +0.196 | +49.96€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1679 | +0.173 | -8.62€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1663 | +0.186 | +21.00€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1046 | +0.167 | +472.91€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1046 | +0.167 | +472.91€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.189: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.057 n=959 | neutral: IC=+0.004 n=746 | overbought(IBS>0.7): IC=+0.193 n=968
  - _Datos_: n=2857 IC=+0.097 PNL=+686.08€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.114 n=16460 | tras_1loss IC=+0.083 n=10863 | tras_2loss IC=+0.050 n=4491/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=25058 IC=+0.113 PNL=+6395.64€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=25058 IC=+0.113 PNL=+6395.64€
