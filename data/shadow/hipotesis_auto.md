# Hipótesis automáticas — 2026-07-18 21:16 UTC
_Generado por shadow_postmortem.py sobre 21288 resoluciones (PNL=+5090.57€)_
...
### GBM_LATE_15M
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.127 (n=1781)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 8.0 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.7402` → IC=+0.147 (n=134)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.7402 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.033` → IC=+0.218 (n=161)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.185 (n=684)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1732` → IC=+0.206 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1732 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.061` → IC=+0.295 (n=149)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.136 (n=865)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.5295` → IC=+0.184 (n=175)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.5295 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.1187` → IC=+0.153 (n=479)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1187 (IC base=+0.129)
...
- **PATRÓN** `ibs_15` > `0.7359` → IC=+0.189 (n=297)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.94€ cuando `ibs_15` > 0.7359 (IC base=+0.033)

- **PATRÓN** `dist_vwap_pct` > `0.7265` → IC=+0.196 (n=44)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.7265 (IC base=+0.033)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `18.602` → IC=+0.159 (n=39)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 18.602 (IC base=+0.033)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7359 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.189 n=297). Confirma señal de reversión media → alinear con BUY_NO.
...
| ✅ FAVORITO_CONFIRMADO | 3542 | +0.183 | +26.49€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 2301 | +0.216 | +73.75€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 5628 | +0.105 | +1871.20€ | 0 | 8 |
| ✅ GBM_LATE_15M#15min | 5628 | +0.105 | +1871.20€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2855 | +0.151 | +1685.97€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2855 | +0.151 | +1685.97€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 2798 | +0.102 | +985.98€ | 0 | 10 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2798 | +0.102 | +985.98€ | 0 | 0 |
...
| ✅ GBM_LATE_5M | 37 | +0.013 | -0.72€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 37 | +0.013 | -0.72€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#XRP | 13 | +0.065 | +1.38€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 13 | +0.065 | +1.38€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1782 | +0.021 | +133.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1522 | +0.047 | +171.08€ | 1 | 7 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 505 | +0.182 | +218.08€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 505 | +0.182 | +218.08€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.179: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.052 n=692 | neutral: IC=-0.007 n=505 | overbought(IBS>0.7): IC=+0.172 n=630
  - _Datos_: n=1954 IC=+0.082 PNL=+385.83€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.112 n=47 PNL=-10.79€ → FILTRAR | H=07h: IC=+0.123 n=59 PNL=+26.81€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.156 n=59 PNL=+26.91€ → BOOST | H=21h: IC=+0.132 n=55 PNL=+12.80€ → BOOST | H=22h: IC=+0.103 n=76 PNL=+13.62€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=12753 | tras_1loss IC=+0.085 n=8338 | tras_2loss IC=+0.052 n=3423/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1653 IC=+0.028 PNL=+150.41€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1653 IC=+0.028 PNL=+150.41€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=769 IC=+0.033 PNL=+62.48€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=769 IC=+0.033 PNL=+62.48€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=368 IC=+0.062 PNL=+43.56€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=368 IC=+0.062 PNL=+43.56€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.080 > 0.08 con n=803 PNL=+120.48€
  - _Datos_: n=803 IC=+0.080 PNL=+120.48€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=18830 IC=+0.119 PNL=+5166.45€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=18830 IC=+0.119 PNL=+5166.45€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=191 IC=+0.013 PNL=+9.68€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=191 IC=+0.013 PNL=+9.68€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=919 IC=+0.003 PNL=+31.92€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=919 IC=+0.003 PNL=+31.92€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.161 > 0.1 con n=503 PNL=+174.49€
  - _Datos_: n=503 IC=+0.161 PNL=+174.49€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=178 IC=+0.061 PNL=+7.11€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=178 IC=+0.061 PNL=+7.11€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.138 > 0.08 con n=365 PNL=+108.72€
  - _Datos_: n=365 IC=+0.138 PNL=+108.72€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.180 > 0.08 con n=167 PNL=+64.27€
  - _Datos_: n=167 IC=+0.180 PNL=+64.27€
