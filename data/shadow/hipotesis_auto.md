# Hipótesis automáticas — 2026-09-26 21:11 UTC
_Generado por shadow_postmortem.py sobre 625578 resoluciones (PNL=+71591.32€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.2` → IC=-0.222 (n=7305)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.2
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=21918)
...
- **FILTRO** `restante_s_al_confirmar` < `165.95` → IC=-0.206 (n=1781)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.95
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=5343)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `127.5` → IC=-0.337 (n=1438)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.5
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=4314)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.205 (n=14338)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3602)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5655.0489` → IC=+0.177 (n=2296)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 5655.0489 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.138 (n=11991)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=11343)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=5822)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7845.6927` → IC=+0.176 (n=2205)
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.175 (n=337)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=2917)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.344 (n=929)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.249 (n=551)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.150 (n=481)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1313.0714` → IC=+0.149 (n=684)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1313.0714 (IC base=+0.135)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.233 (n=728)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=12005)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.226 (n=3934)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.168 (n=2892)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.73` → IC=+0.175 (n=2739)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=946)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.346 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.240)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.186 (n=2699)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.199 (n=2759)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.197 (n=2053)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=35777)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.235 (n=15927)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=7255)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=6680)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.71 (IC base=+0.176)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.225 (n=6430)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.229 (n=3231)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.267 (n=2224)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.209 (n=5928)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.257 (n=2381)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.204)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.196 (n=5974)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.299 (n=356)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4263.4949` → IC=+0.298 (n=340)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4859` → IC=+0.123 (n=8457)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.4859 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9831` → IC=+0.243 (n=2820)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9831 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.6236` → IC=+0.251 (n=2411)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6236 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.966` → IC=+0.179 (n=3233)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 5.966 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2036` → IC=+0.248 (n=2308)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2036 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.043` → IC=+0.262 (n=1046)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.043 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.3023` → IC=+0.224 (n=852)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3023 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.4616` → IC=+0.204 (n=5818)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4616 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.134 (n=10215)
...
- **PATRÓN** `dist_vwap_pct` < `0.1534` → IC=+0.175 (n=3297)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1534 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` < `0.6971` → IC=+0.187 (n=1587)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6971 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` > `1.0502` → IC=+0.176 (n=1636)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5708` → IC=+0.201 (n=5454)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5708 (IC base=+0.067)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.213 (n=5899)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.173 (n=912)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.165 (n=1776)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.178 (n=1934)
...
- **PATRÓN** `libro_liquidez` > `1817.6848` → IC=+0.237 (n=970)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1817.6848 (IC base=+0.237)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.233 (n=650)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.0832` → IC=+0.239 (n=488)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0832 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.233 (n=1538)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9028` → IC=+0.261 (n=664)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9028 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` > `0.1927` → IC=+0.217 (n=769)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1927 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.3599` → IC=+0.219 (n=1359)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3599 (IC base=+0.217)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.168 (n=595)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.7028` → IC=+0.170 (n=1520)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.7028 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1279` → IC=+0.155 (n=1363)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1279 (IC base=+0.140)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.154 (n=1410)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4221` → IC=+0.147 (n=1410)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4221 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `14087.0235` → IC=+0.145 (n=1013)
...
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.210 (n=629)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=1982)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.189 (n=1637)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1003 (IC base=+0.185)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7767` → IC=+0.193 (n=1605)
...
- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.222 (n=1440)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.6119` → IC=+0.212 (n=1633)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `libro_liquidez` > `1909.982` → IC=+0.213 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1909.982 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.217 (n=962)
...
- **PATRÓN** `ibs_20min` > `0.9463` → IC=+0.216 (n=371)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9463 (IC base=+0.029)

- **PATRÓN** `dist_vwap_pct` > `0.3596` → IC=+0.325 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3596 (IC base=+0.029)

- **PATRÓN** `dist_vwap_pct` < `0.5438` → IC=+0.330 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5438 (IC base=+0.029)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.74` → IC=+0.163 (n=743)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 4.74 (IC base=+0.029)

- **PATRÓN** `volumen_regimen` < `0.8553` → IC=+0.328 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8553 (IC base=+0.029)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3014` → IC=+0.353 (n=93)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3014 (IC base=+0.029)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2012` → IC=+0.330 (n=151)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2012 (IC base=+0.029)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2279` → IC=+0.219 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2279 (IC base=+0.019)

- **PATRÓN** `volumen_spike_ratio` > `1.5272` → IC=+0.172 (n=742)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.124 (n=2283)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=1136)

- **FILTRO** `sigma_ewma_delta_pct` > `8.724` → IC=-0.210 (n=364)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.724
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3055)
...
- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.125 (n=1136)
...
- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.257 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=-0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.1582` → IC=+0.265 (n=96)
...
- **FILTRO** `ibs_20min` > `0.7692` → IC=-0.205 (n=875)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=2638)
...
- **PATRÓN** `dist_vwap_pct` > `0.5658` → IC=+0.274 (n=219)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.622` → IC=+0.156 (n=5001)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.622 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6902` → IC=+0.251 (n=3409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6902 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2936` → IC=+0.271 (n=905)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2936 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `1.4633` → IC=+0.237 (n=2063)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4633 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6489` → IC=+0.247 (n=2064)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6489 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.269 (n=5703)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 95.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.159 (n=3531)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0091 (IC base=+0.074)

- **PATRÓN** `ibs_20min` < `0.549` → IC=+0.154 (n=9314)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.275 (n=185)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.176 (n=313)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4339 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` > `2.1457` → IC=+0.206 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1457 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.190 (n=407)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 13.0 (IC base=+0.041)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4436` → IC=+0.452 (n=82)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4436 (IC base=-0.018)
...
- **PATRÓN** `ibs_20min` > `0.8652` → IC=+0.162 (n=716)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.8652 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3015` → IC=+0.176 (n=387)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3015 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6744` → IC=+0.169 (n=884)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.6744 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` > `0.2723` → IC=+0.246 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2723 (IC base=+0.026)

- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.189 (n=323)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.4239 (IC base=+0.026)

- **PATRÓN** `volumen_spike_ratio` > `2.397` → IC=+0.162 (n=323)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.397 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `241.0` → IC=+0.186 (n=425)
...
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.289 (n=557)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.247)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.252 (n=1674)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1018` → IC=+0.261 (n=1416)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6992` → IC=+0.288 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6992 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.287 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1903.1828` → IC=+0.294 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1903.1828 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.287 (n=816)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 27.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2993` → IC=-0.173 (n=530)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2993
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1590)

- **FILTRO** `ibs_20min` > `0.7735` → IC=-0.184 (n=628)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7735
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1888)

- **PATRÓN** `ibs_20min` > `0.9105` → IC=+0.180 (n=530)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.9105 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` > `0.4282` → IC=+0.218 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4282 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` < `0.6693` → IC=+0.219 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6693 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` < `0.9898` → IC=+0.242 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9898 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` > `0.5902` → IC=+0.220 (n=615)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5025` → IC=+0.265 (n=257)
...
- **PATRÓN** `dist_vwap_pct` < `0.3438` → IC=+0.201 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3438 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `0.6439` → IC=+0.235 (n=153)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1518` → IC=+0.241 (n=187)
...
- **FILTRO** `ibs_20min` < `0.7328` → IC=-0.195 (n=1131)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7328
  - _Potencial_: sin este filtro IC_bueno=+0.280 (n=1132)
...
- **PATRÓN** `ibs_20min` > `0.7328` → IC=+0.280 (n=1132)
...
- **PATRÓN** `volumen_regimen` > `0.7279` → IC=+0.294 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7279 (IC base=+0.043)

- **PATRÓN** `volumen_pendiente_norm` < `0.0998` → IC=+0.295 (n=784)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.316 (n=719)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.316 (n=916)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_regimen` > `0.8611` → IC=+0.306 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8611 (IC base=+0.278)

- **PATRÓN** `volumen_pendiente_norm` < `0.0782` → IC=+0.282 (n=1173)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1503` → IC=+0.298 (n=592)
...
- **PATRÓN** `ibs_20min` < `0.2927` → IC=+0.316 (n=1300)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2927 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` > `0.3151` → IC=+0.281 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3151 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` < `0.2289` → IC=+0.277 (n=1350)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.173 (n=2748)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.200 (n=2740)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0901` → IC=+0.183 (n=2740)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0901 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=8574)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5745` → IC=+0.218 (n=8217)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5745 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1752` → IC=+0.194 (n=3564)
...
- **PATRÓN** `volumen_regimen` < `1.2076` → IC=+0.161 (n=5447)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2076 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6301` → IC=+0.161 (n=5447)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.240 (n=409)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.0728` → IC=+0.193 (n=408)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.0728 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.186 (n=1223)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 6.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4056` → IC=+0.227 (n=1221)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4056 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2074` → IC=+0.213 (n=717)
...
- **PATRÓN** `volumen_regimen` < `0.6875` → IC=+0.167 (n=538)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6875 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.169 (n=554)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4541` → IC=+0.161 (n=396)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.4541 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `10644.0099` → IC=+0.170 (n=1221)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.150 (n=676)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0101 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.138 (n=1530)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.5206` → IC=+0.196 (n=646)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5206 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.8` → IC=+0.255 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.8 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `1.2151` → IC=+0.130 (n=1492)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2151 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.5355` → IC=+0.135 (n=634)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.5355 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1554)
...
- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.133 (n=1143)
...
- **PATRÓN** `sigma_h` > `0.0126` → IC=+0.225 (n=1271)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0126 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=1479)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7386` → IC=+0.258 (n=1271)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7386 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.5159` → IC=+0.218 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5159 (IC base=+0.202)
...
- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.205 (n=1424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.8567` → IC=+0.222 (n=948)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1481` → IC=+0.211 (n=1210)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1481 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.4081` → IC=+0.210 (n=1374)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.175 (n=676)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0038 (IC base=+0.151)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.175 (n=674)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0088 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3504` → IC=+0.156 (n=1778)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.3504 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.169 (n=1861)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 8.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.5374` → IC=+0.189 (n=1805)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5374 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.8496` → IC=+0.176 (n=331)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.8496 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.731` → IC=+0.180 (n=911)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 3.731 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.8725` → IC=+0.170 (n=1191)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.8725 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.155 (n=1786)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6229 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1642` → IC=+0.178 (n=557)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1642 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `1.4417` → IC=+0.162 (n=651)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4417 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.825` → IC=+0.160 (n=1300)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.825 (IC base=+0.151)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.157 (n=2287)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.02 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `12367.2302` → IC=+0.157 (n=674)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12367.2302 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.172 (n=1800)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 151.0 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.137 (n=1382)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0056 (IC base=+0.111)

- **PATRÓN** `drift_60min` |x|≤ `0.3426` → IC=+0.126 (n=1824)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3426 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=2092)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.0589` → IC=+0.191 (n=691)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.0589 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.209` → IC=+0.121 (n=1856)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.209 (IC base=+0.111)
...
- **PATRÓN** `libro_liquidez` > `2764.7951` → IC=+0.121 (n=1852)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2764.7951 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.128 (n=858)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3375` → IC=+0.133 (n=496)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.3375 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=466)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.2572` → IC=+0.155 (n=496)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.2572 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.2966` → IC=+0.150 (n=175)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.2966 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.6136` → IC=+0.155 (n=166)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6136 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.0905` → IC=+0.131 (n=177)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` > 0.0905 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `10937.2581` → IC=+0.135 (n=496)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 10937.2581 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.148 (n=157)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 146.0 (IC base=+0.112)
...
- **PATRÓN** `dist_vwap_pct` < `0.3066` → IC=+0.151 (n=683)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3066 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.204 (n=211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.0954` → IC=+0.223 (n=211)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0954 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=661)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.9667` → IC=+0.265 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9667 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.1422` → IC=+0.206 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1422 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.218` → IC=+0.202 (n=559)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.218 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.052` → IC=+0.231 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.052 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` < `1.0076` → IC=+0.205 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0076 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6082` → IC=+0.207 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6082 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2643` → IC=+0.266 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2643 (IC base=+0.201)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7512` → IC=+0.228 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7512 (IC base=+0.201)
...
- **PATRÓN** `libro_liquidez` > `12439.6953` → IC=+0.223 (n=211)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12439.6953 (IC base=+0.201)
...
- **PATRÓN** `volumen_regimen` < `0.6874` → IC=+0.140 (n=262)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.6874 (IC base=+0.095)

- **PATRÓN** `volumen_pendiente_norm` > `0.1664` → IC=+0.128 (n=143)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.1664 (IC base=+0.095)
...
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.164 (n=218)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.009 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.5423` → IC=+0.135 (n=480)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.5423 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=447)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.9739` → IC=+0.229 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9739 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.433` → IC=+0.197 (n=259)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 3.433 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `1.0738` → IC=+0.149 (n=422)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0738 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.2893` → IC=+0.191 (n=66)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2893 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.4824` → IC=+0.139 (n=153)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4824 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `2.2078` → IC=+0.186 (n=208)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.2078 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.136 (n=514)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `3116.6987` → IC=+0.198 (n=160)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 3116.6987 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` < `0.5683` → IC=+0.237 (n=9589)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5683 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2497` → IC=+0.163 (n=5958)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6155` → IC=+0.193 (n=2945)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6155 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.197 (n=5681)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.211 (n=1189)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.206 (n=851)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.211 (n=1800)
...
- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.262 (n=1415)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.268 (n=1286)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.3509` → IC=+0.285 (n=1245)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3509 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.466` → IC=+0.262 (n=1484)
...
- **PATRÓN** `ibs_20min` < `0.2772` → IC=+0.234 (n=977)
...
- **PATRÓN** `dist_vwap_pct` < `0.1316` → IC=+0.165 (n=1332)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1316 (IC base=+0.152)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.303` → IC=+0.154 (n=1329)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.303 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.164 (n=1465)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1847 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1506` → IC=+0.194 (n=394)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1506 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.4046` → IC=+0.161 (n=1367)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4046 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.7551` → IC=+0.162 (n=911)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7551 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `352.0` → IC=+0.158 (n=849)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 352.0 (IC base=+0.152)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0121` → IC=+0.252 (n=575)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0121 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1804)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.811` → IC=+0.295 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.811 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.1345` → IC=+0.219 (n=1566)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1345 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `1.7731` → IC=+0.227 (n=1468)
...
- **PATRÓN** `ibs_20min` < `0.3594` → IC=+0.265 (n=1417)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3594 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.275 (n=601)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.748 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` > `0.3428` → IC=+0.303 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3428 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` < `1.7521` → IC=+0.233 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7521 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.1786` → IC=+0.234 (n=990)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1786 (IC base=+0.232)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.241 (n=1066)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `1906.3184` → IC=+0.239 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1906.3184 (IC base=+0.232)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.248 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 13.0 (IC base=+0.232)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.189 (n=605)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0035 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.433` → IC=+0.148 (n=1798)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.433 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.153 (n=1880)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 5.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.8757` → IC=+0.263 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8757 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.5708` → IC=+0.167 (n=505)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.5708 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.45` → IC=+0.170 (n=292)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 11.45 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8732` → IC=+0.156 (n=1199)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8732 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.2336` → IC=+0.216 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2336 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.5194` → IC=+0.154 (n=767)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5194 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `2.4658` → IC=+0.155 (n=581)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.4658 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `7996.0605` → IC=+0.233 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7996.0605 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.164 (n=566)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 77.0 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.171 (n=975)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0052 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4443` → IC=+0.150 (n=1462)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4443 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.173 (n=545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5824` → IC=+0.197 (n=1287)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.5824 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.1587` → IC=+0.138 (n=1267)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1587 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.146` → IC=+0.167 (n=220)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.146 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.6958` → IC=+0.152 (n=644)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6958 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1947` → IC=+0.143 (n=488)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.1947 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2905` → IC=+0.236 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2905 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4426` → IC=+0.146 (n=1389)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4426 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7203.9856` → IC=+0.195 (n=663)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 7203.9856 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `176.0` → IC=+0.141 (n=1388)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 176.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.139 (n=1197)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0081 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1848)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.4695` → IC=+0.191 (n=1794)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4695 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` < `1.0801` → IC=+0.129 (n=1579)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0801 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1809)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.131 (n=1403)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1331` → IC=+0.164 (n=578)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1331 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1791)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1732)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2216` → IC=+0.134 (n=1409)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.2216 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.486` → IC=+0.127 (n=1669)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.486 (IC base=+0.115)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4382` → IC=+0.141 (n=524)
...
- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.125 (n=1358)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 51.0 (IC base=+0.115)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.227 (n=1595)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0132 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=1865)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.285` → IC=+0.273 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.285 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` < `1.2447` → IC=+0.212 (n=1786)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2447 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.6408` → IC=+0.220 (n=1785)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6408 (IC base=+0.210)
...
- **PATRÓN** `libro_liquidez` > `2625.644` → IC=+0.219 (n=1190)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.644 (IC base=+0.210)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.213 (n=1350)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` < `0.4214` → IC=+0.268 (n=1678)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4214 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.2446` → IC=+0.208 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2446 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` < `0.9257` → IC=+0.207 (n=2126)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1798` → IC=+0.201 (n=1515)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1798 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4288` → IC=+0.201 (n=1721)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.149 (n=3215)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.185 (n=1033)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0049 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.5148` → IC=+0.171 (n=3094)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.5148 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.169 (n=1031)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 18.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.169 (n=1374)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 6.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` > `0.9412` → IC=+0.219 (n=1032)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9412 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.1783` → IC=+0.173 (n=1153)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1783 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` < `0.4687` → IC=+0.161 (n=1949)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.4687 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.215` → IC=+0.195 (n=509)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.215 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `0.6332` → IC=+0.164 (n=2078)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6332 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.197 (n=859)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `1.4563` → IC=+0.170 (n=1019)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.4563 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.8762` → IC=+0.169 (n=2037)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.8762 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.162 (n=3446)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.02 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `3959.546` → IC=+0.171 (n=2062)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3959.546 (IC base=+0.161)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.205 (n=815)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.4837` → IC=+0.166 (n=2423)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.4837 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.180 (n=887)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.18` → IC=+0.177 (n=1066)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.18 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6714` → IC=+0.171 (n=469)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6714 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.252` → IC=+0.158 (n=2416)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.252 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.101` → IC=+0.158 (n=2041)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.101 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` < `0.0966` → IC=+0.151 (n=2197)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0966 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.0721` → IC=+0.150 (n=1118)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.0721 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.5356` → IC=+0.161 (n=1053)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.5356 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.8202` → IC=+0.152 (n=1595)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8202 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=3215)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `7038.2215` → IC=+0.158 (n=2165)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 7038.2215 (IC base=+0.147)
...
- **PATRÓN** `ibs_20min` < `0.5313` → IC=+0.187 (n=694)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.5313 (IC base=+0.171)

- **PATRÓN** `ibs_20min` > `0.8838` → IC=+0.182 (n=347)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.8838 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2173` → IC=+0.178 (n=862)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.2173 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.19` → IC=+0.182 (n=930)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 4.19 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.0851` → IC=+0.173 (n=916)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.0851 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6416` → IC=+0.174 (n=1041)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6416 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.1659` → IC=+0.189 (n=313)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1659 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `2.4728` → IC=+0.177 (n=1022)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.4728 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `1.5228` → IC=+0.172 (n=914)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.5228 (IC base=+0.171)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=1038)
...
- **PATRÓN** `sigma_h` < `0.0129` → IC=+0.135 (n=269)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0129 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.151 (n=187)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 6.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.9615` → IC=+0.250 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9615 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.1983` → IC=+0.165 (n=192)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1983 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.309` → IC=+0.190 (n=69)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 7.309 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.9028` → IC=+0.146 (n=179)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.9028 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.1652` → IC=+0.191 (n=82)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1652 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `2.3559` → IC=+0.131 (n=258)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 2.3559 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `1.4296` → IC=+0.139 (n=258)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4296 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `3430.0272` → IC=+0.164 (n=239)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 3430.0272 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.134 (n=222)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 58.0 (IC base=+0.117)

- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.172 (n=245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0068 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3919` → IC=+0.181 (n=164)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.3919 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.142 (n=93)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 16.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.169 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 10.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.1364` → IC=+0.238 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1364 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.5969` → IC=+0.214 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5969 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.25` → IC=+0.145 (n=119)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 3.25 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.6777` → IC=+0.167 (n=82)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6777 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.1117` → IC=+0.205 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1117 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.611` → IC=+0.154 (n=105)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.611 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `2.1901` → IC=+0.164 (n=108)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.1901 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `3335.3834` → IC=+0.172 (n=245)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3335.3834 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.192 (n=209)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 47.0 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.181 (n=434)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.004 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.6641` → IC=+0.194 (n=794)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.6641 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.1486` → IC=+0.148 (n=478)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.1486 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.443` → IC=+0.186 (n=208)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 11.443 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.2799` → IC=+0.186 (n=119)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2799 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.1044` → IC=+0.123 (n=682)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.1044 (IC base=+0.087)

- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.135 (n=393)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2432.8034 (IC base=+0.087)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=348)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.4737` → IC=+0.185 (n=306)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4737 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.1288` → IC=+0.171 (n=159)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1288 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` < `0.0651` → IC=+0.129 (n=238)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.0651 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` < `2.0809` → IC=+0.161 (n=234)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.0809 (IC base=+0.102)
...
- **PATRÓN** `libro_liquidez` > `2919.5711` → IC=+0.173 (n=255)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2919.5711 (IC base=+0.105)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=1889)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.134 (n=389)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=466)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.162 (n=226)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` < 0.47 (IC base=+0.018)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **FILTRO** `py_entrada` > `0.6` → IC=-0.145 (n=29)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=91)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.177 (n=29)

  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` > 0.5 (IC base=+0.025)

- **PATRÓN** `restante_min` > `12.8` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 12.8 (IC base=+0.025)

- **PATRÓN** `profundidad_ratio` > `1112.4` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `profundidad_ratio` > 1112.4 (IC base=+0.025)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7679)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.169 (n=3679)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=11266)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.165 (n=3822)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=11669)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.209 (n=633)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1967)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.189 (n=660)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1990)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.207 (n=670)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=2111)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.49` → IC=-0.171 (n=643)

  - _Acción_: SKIP cuando `py_entrada` < 0.49
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1954)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.175 (n=665)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=2123)
...
- **FILTRO** `py_entrada` > `0.585` → IC=-0.208 (n=761)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2284)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3024)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.131 (n=10450)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=23618)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.275 (n=8385)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=25683)

- **FILTRO** `ibs_7min` < `0.2785` → IC=-0.235 (n=8517)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2785
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=25551)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=11522)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=22546)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=10509)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=32410)

- **FILTRO** `ibs_7min` > `0.2917` → IC=-0.177 (n=10718)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2917
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=32201)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3962)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=1345)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4319)

- **FILTRO** `ibs_7min` < `0.7113` → IC=-0.253 (n=1869)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7113
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3795)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.189 (n=1250)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4414)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1820)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=5563)

- **FILTRO** `drift_7min_pct` |x|> `0.1376` → IC=-0.130 (n=1845)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1376
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=5538)

- **FILTRO** `ibs_7min` > `0.7867` → IC=-0.208 (n=1845)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7867
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=5538)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1372)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4504)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1428)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4448)

- **FILTRO** `ibs_7min` < `0.7472` → IC=-0.193 (n=1469)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7472
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4407)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.177 (n=1458)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4418)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.263 (n=1376)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4589)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.181 (n=1489)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4476)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.182 (n=1478)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4487)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.166 (n=1313)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4081)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.304 (n=1338)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4056)

- **FILTRO** `ibs_7min` < `0.7061` → IC=-0.243 (n=1780)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7061
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3614)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.222 (n=1205)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4189)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.239 (n=1817)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=6080)

- **FILTRO** `ibs_7min` > `0.7467` → IC=-0.173 (n=1974)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7467
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=5923)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3818)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.234 (n=1659)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3961)

- **FILTRO** `ibs_7min` < `0.7397` → IC=-0.184 (n=1405)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7397
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4215)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.174 (n=1399)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4221)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.264 (n=1271)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4475)

- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.177 (n=1436)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2744
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4310)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1400)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4346)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.256 (n=1472)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4429)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.232 (n=1472)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4429)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1933)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=6242)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1836)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3777)

- **FILTRO** `ibs_7min` < `0.2982` → IC=-0.225 (n=1403)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2982
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4210)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1360)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4253)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.208 (n=1824)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=5929)
...
- **FILTRO** `ibs_7min` < `1.0` → IC=-0.125 (n=46)
  ...
  - _Acción_: SKIP cuando `ibs_7min` < 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=554)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=3017)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.189 (n=574)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0044 (IC base=+0.187)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.228 (n=572)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.0733` → IC=+0.201 (n=757)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0733 (IC base=+0.187)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2158` → IC=+0.192 (n=573)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.2158 (IC base=+0.187)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1267` → IC=+0.234 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1267 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.199 (n=1598)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 6.0 (IC base=+0.187)

- **PATRÓN** `ibs_15` > `0.6079` → IC=+0.267 (n=1716)
...
- **PATRÓN** `dist_vwap_pct` < `0.6136` → IC=+0.181 (n=1632)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.6136 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.822` → IC=+0.273 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.822 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `2959.1226` → IC=+0.196 (n=1144)
...
- **FILTRO** `sigma_ewma_delta_pct` > `24.23` → IC=-0.133 (n=28)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=413)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.6945` → IC=-0.157 (n=100)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.6945
...
- **PATRÓN** `drift_60min` |x|≤ `0.0839` → IC=+0.216 (n=199)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0839 (IC base=+0.192)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0394` → IC=+0.196 (n=452)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.5593` → IC=+0.282 (n=452)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5593 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` > `0.3546` → IC=+0.208 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3546 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` < `0.8177` → IC=+0.194 (n=524)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.8177 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.916` → IC=+0.211 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.916 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.797` → IC=+0.194 (n=456)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 10.797 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `2914.215` → IC=+0.284 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2914.215 (IC base=+0.192)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.158 (n=509)
...
- **FILTRO** `sigma_h` > `0.0128` → IC=-0.223 (n=688)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0128
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2066)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.202 (n=952)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1802)

- **FILTRO** `libro_liquidez` < `3876.6456` → IC=-0.143 (n=1817)

  - _Acción_: SKIP cuando `libro_liquidez` < 3876.6456
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=937)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1366` → IC=+0.250 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1366 (IC base=-0.066)

- **PATRÓN** `ibs_15` > `0.6409` → IC=+0.273 (n=655)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6409 (IC base=-0.066)

- **PATRÓN** `dist_vwap_pct` < `0.1073` → IC=+0.196 (n=413)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1785` → IC=+0.238 (n=1241)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1785 (IC base=-0.029)

- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.275 (n=1916)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6079 sube el IC de +0.187 a +0.267 en UPDOWN_GBM#15min (n=1716). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7064 sube el IC de +0.208 a +0.274 en UPDOWN_GBM#BTC#15min (n=379). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5593 sube el IC de +0.192 a +0.282 en UPDOWN_GBM#XRP#15min (n=452). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.054 a +0.158 en UPDOWN_GBM#XRP#15min (n=509). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6409 sube el IC de -0.066 a +0.273 en UPDOWN_GBM_15M_TARDIO (n=655). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.029 a +0.275 en UPDOWN_GBM_15M_TARDIO (n=1916). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7497 sube el IC de +0.084 a +0.331 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=181). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.34 sube el IC de -0.040 a +0.305 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=507). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8411 sube el IC de +0.292 a +0.328 en UPDOWN_GBM_IBS_ALTO (n=689). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.83 sube el IC de +0.287 a +0.316 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=378). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 29223 | -0.085 | -3898.77€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1545 | -0.035 | -223.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27678 | -0.088 | -3675.12€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 7124 | -0.089 | -453.94€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 7124 | -0.089 | -453.94€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5752 | -0.164 | -1093.17€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5752 | -0.164 | -1093.17€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 19525 | -0.026 | +3951.52€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 5076 | +0.001 | +1815.72€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 14449 | -0.036 | +2135.80€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 19525 | -0.026 | +3951.52€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 5076 | +0.001 | +1815.72€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 14449 | -0.036 | +2135.80€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 97009 | +0.113 | -4764.22€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14490 | +0.185 | -427.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 392 | -0.074 | -50.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 75882 | +0.100 | -4070.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6245 | +0.107 | -216.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12616 | +0.100 | -1018.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 46 | -0.167 | -1.52€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12555 | +0.101 | -1005.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 19597 | +0.132 | -360.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4569 | +0.203 | -129.96€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12580 | +0.112 | -183.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2406 | +0.101 | -24.07€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12655 | +0.090 | -1141.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 53 | -0.100 | -7.49€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12587 | +0.091 | -1123.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 20610 | +0.124 | -383.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5618 | +0.175 | -77.00€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12720 | +0.106 | -240.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2260 | +0.099 | -57.87€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18903 | +0.114 | -1088.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4157 | +0.189 | -219.57€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 295 | -0.032 | +3.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12872 | +0.091 | -738.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1579 | +0.128 | -134.28€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12628 | +0.099 | -771.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12568 | +0.100 | -779.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 15378 | +0.191 | -1016.75€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 15378 | +0.191 | -1016.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3648 | +0.167 | -388.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3648 | +0.167 | -388.51€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1356 | +0.197 | -15.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1356 | +0.197 | -15.88€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3597 | +0.179 | -309.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3597 | +0.179 | -309.28€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3176 | +0.239 | -103.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3176 | +0.239 | -103.82€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3522 | +0.192 | -213.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3522 | +0.192 | -213.02€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 53129 | +0.197 | -4165.65€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 53129 | +0.197 | -4165.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 9173 | +0.176 | -1060.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 9173 | +0.176 | -1060.62€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 8498 | +0.223 | -309.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 8498 | +0.223 | -309.45€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 9174 | +0.173 | -1094.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 9174 | +0.173 | -1094.15€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 8594 | +0.218 | -352.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 8594 | +0.218 | -352.00€ | 1 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 8782 | +0.203 | -575.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 8782 | +0.203 | -575.69€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 8908 | +0.193 | -773.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 8908 | +0.193 | -773.73€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 20077 | +0.117 | +166.53€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 20077 | +0.117 | +166.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 9967 | +0.121 | +141.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 9967 | +0.121 | +141.26€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 10110 | +0.113 | +25.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 10110 | +0.113 | +25.27€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 37485 | +0.098 | -1103.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 