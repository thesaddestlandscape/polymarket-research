# Hipótesis automáticas — 2026-09-21 15:15 UTC
_Generado por shadow_postmortem.py sobre 543582 resoluciones (PNL=+60642.85€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.37` → IC=-0.234 (n=6559)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.37
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=19678)
...
- **FILTRO** `restante_s_al_confirmar` < `133.45` → IC=-0.277 (n=791)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.45
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=2374)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `161.47` → IC=-0.230 (n=1546)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 161.47
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4638)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.85` → IC=-0.365 (n=1298)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.85
  - _Potencial_: sin este filtro IC_bueno=-0.120 (n=3900)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.237 (n=340)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.200 (n=13157)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3296)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `9492.3238` → IC=+0.191 (n=1426)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 9492.3238 (IC base=+0.101)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.233 (n=10099)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=5355)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `1664.1386` → IC=+0.157 (n=6033)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1664.1386 (IC base=+0.129)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1600)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.208 (n=1574)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1977)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15747.0266` → IC=+0.238 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15747.0266 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.203 (n=1416)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.203 (n=1565)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.261 (n=1422)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=2000)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `15455.9709` → IC=+0.208 (n=516)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.145 (n=328)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 7.0 (IC base=+0.112)
...
- **PATRÓN** `libro_liquidez` > `5859.5725` → IC=+0.165 (n=219)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 5859.5725 (IC base=+0.112)
...
- **PATRÓN** `libro_liquidez` > `1300.2394` → IC=+0.148 (n=615)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=1033)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.177 (n=705)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=10584)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=10171)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3633)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2477)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.183 (n=1797)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.264 (n=685)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=2547)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.187 (n=2439)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=2267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.239)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.320 (n=799)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.232 (n=2794)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.15` → IC=+0.143 (n=4387)
...
- **PATRÓN** `restante_min` < `4.07` → IC=+0.132 (n=2186)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` < 4.07 (IC base=+0.123)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.140 (n=2289)
...
- **PATRÓN** `libro_liquidez` > `1569.8406` → IC=+0.297 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1569.8406 (IC base=+0.291)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.285 (n=490)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4196.1086` → IC=+0.295 (n=310)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3581` → IC=+0.124 (n=6470)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3581 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.9809` → IC=+0.241 (n=2451)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9809 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` < `0.6097` → IC=+0.246 (n=2051)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6097 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.937` → IC=+0.177 (n=2834)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.937 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `1.2201` → IC=+0.243 (n=1964)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2201 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` > `1.0562` → IC=+0.250 (n=891)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0562 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.3071` → IC=+0.212 (n=732)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3071 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` > `1.915` → IC=+0.206 (n=3330)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.915 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.5714` → IC=+0.131 (n=8868)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5714 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5781` → IC=+0.195 (n=638)
...
- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.174 (n=2023)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5821` → IC=+0.202 (n=4512)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5821 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.211 (n=4831)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.176 (n=557)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0082 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.3429` → IC=+0.166 (n=1669)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3429 (IC base=+0.161)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.247 (n=831)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `drift_60min` |x|≤ `0.084` → IC=+0.258 (n=423)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.084 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.229 (n=1330)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.215)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.216 (n=1298)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` > `0.9089` → IC=+0.257 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9089 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` > `0.1888` → IC=+0.218 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1888 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` < `0.7257` → IC=+0.218 (n=1403)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7257 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.866` → IC=+0.249 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.866 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` < `1.2573` → IC=+0.219 (n=1269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2573 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `0.8751` → IC=+0.221 (n=846)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8751 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.0746` → IC=+0.227 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0746 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `1.4033` → IC=+0.224 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4033 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.3839` → IC=+0.219 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3839 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `15859.8442` → IC=+0.228 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15859.8442 (IC base=+0.215)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.093` → IC=+0.246 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.093 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` < `0.2133` → IC=+0.190 (n=1609)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.2133 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.3666` → IC=+0.192 (n=212)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.3666 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.9184` → IC=+0.208 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9184 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.196 (n=1098)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.02 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.223 (n=1378)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0109 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.219 (n=1233)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0066 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.5452` → IC=+0.218 (n=1378)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5452 (IC base=+0.217)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8278` → IC=+0.208 (n=550)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=874)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2046)
...
- **PATRÓN** `dist_vwap_pct` > `0.3545` → IC=+0.321 (n=132)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3545 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` < `0.7505` → IC=+0.326 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7505 (IC base=+0.020)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.724` → IC=+0.150 (n=650)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 4.724 (IC base=+0.020)

- **PATRÓN** `volumen_regimen` < `0.6001` → IC=+0.330 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6001 (IC base=+0.020)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=2021)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=1000)

- **FILTRO** `sigma_ewma_delta_pct` > `8.655` → IC=-0.207 (n=329)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.655
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2692)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=396)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1655)

- **FILTRO** `ibs_20min` > `0.7759` → IC=-0.201 (n=763)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7759
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=2290)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.194 (n=3057)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0095 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.471` → IC=+0.187 (n=8183)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.471 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `1.0273` → IC=+0.295 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0273 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.561` → IC=+0.155 (n=4342)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.561 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `0.6856` → IC=+0.243 (n=2882)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6856 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.2982` → IC=+0.263 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2982 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `1.4728` → IC=+0.239 (n=1753)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4728 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `2.7055` → IC=+0.240 (n=1752)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7055 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.267 (n=4762)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.096)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.145 (n=3089)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0089 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5522` → IC=+0.149 (n=8146)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.5522 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.957` → IC=+0.235 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.957 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1722` → IC=+0.237 (n=2395)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1722 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7162` → IC=+0.236 (n=1170)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7162 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.2049` → IC=+0.243 (n=886)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4914` → IC=+0.255 (n=1155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4914 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.3461` → IC=+0.260 (n=1571)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3461 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.263 (n=3339)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.070)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `2.676` → IC=-0.151 (n=666)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.676
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=1498)

- **PATRÓN** `ibs_20min` > `0.8938` → IC=+0.265 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8938 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.671` → IC=+0.202 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.671 (IC base=+0.047)

- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.270 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `1.4395` → IC=+0.174 (n=268)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.4395 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` > `2.142` → IC=+0.189 (n=365)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.142 (IC base=+0.047)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.176 (n=350)
...
- **FILTRO** `ibs_20min` > `0.8163` → IC=-0.149 (n=667)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=2003)

- **PATRÓN** `ibs_20min` > `0.8635` → IC=+0.160 (n=616)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8635 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` > `0.4725` → IC=+0.172 (n=242)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.4725 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` > `0.6688` → IC=+0.157 (n=751)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.288 (n=968)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0077 (IC base=+0.246)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.246 (n=1458)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.625` → IC=+0.282 (n=462)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.625 (IC base=+0.246)

- **PATRÓN** `volumen_pendiente_norm` < `0.1386` → IC=+0.260 (n=1284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1386 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `2.9319` → IC=+0.262 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9319 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.258 (n=972)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1926.3` → IC=+0.255 (n=484)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1926.3 (IC base=+0.246)
...
- **PATRÓN** `ibs_20min` < `0.2233` → IC=+0.291 (n=1010)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1991` → IC=+0.287 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1991 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.297 (n=723)
...
- **FILTRO** `ibs_20min` < `0.2753` → IC=-0.195 (n=441)
...
- **PATRÓN** `ibs_20min` > `0.9033` → IC=+0.173 (n=442)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.9033 (IC base=+0.007)

- **PATRÓN** `dist_vwap_pct` > `0.4514` → IC=+0.227 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4514 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` < `0.9865` → IC=+0.234 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9865 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` > `0.6452` → IC=+0.210 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6452 (IC base=+0.007)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1113` → IC=+0.242 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1113 (IC base=+0.007)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.261 (n=308)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.007)

- **PATRÓN** `dist_vwap_pct` > `0.1485` → IC=+0.190 (n=185)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.1485 (IC base=-0.011)

- **PATRÓN** `dist_vwap_pct` < `0.3318` → IC=+0.181 (n=346)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.3318 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` < `1.1649` → IC=+0.191 (n=357)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 1.1649 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` > `0.7204` → IC=+0.182 (n=319)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.7204 (IC base=-0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.2812` → IC=+0.280 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2812 (IC base=-0.011)
...
- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.229 (n=319)
...
- **FILTRO** `ibs_20min` < `0.7111` → IC=-0.203 (n=972)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.272 (n=975)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.233 (n=503)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=1539)
...
- **PATRÓN** `ibs_20min` > `0.7111` → IC=+0.272 (n=975)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7111 (IC base=+0.035)

- **PATRÓN** `dist_vwap_pct` > `0.8327` → IC=+0.347 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8327 (IC base=+0.035)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.568` → IC=+0.158 (n=305)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 9.568 (IC base=+0.035)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.300 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.035)

- **PATRÓN** `volumen_regimen` > `0.6366` → IC=+0.286 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6366 (IC base=+0.035)

- **PATRÓN** `volumen_pendiente_norm` < `0.1045` → IC=+0.289 (n=657)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7975` → IC=+0.304 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7975 (IC base=+0.035)
...
- **PATRÓN** `sigma_h` > `0.0162` → IC=+0.317 (n=796)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6293` → IC=+0.309 (n=1194)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6293 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `0.1939` → IC=+0.315 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1939 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.487` → IC=+0.299 (n=634)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.487 (IC base=+0.275)

- **PATRÓN** `volumen_regimen` > `0.8627` → IC=+0.301 (n=796)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1737` → IC=+0.289 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1737 (IC base=+0.275)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.280 (n=1260)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2606.2506` → IC=+0.286 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2606.2506 (IC base=+0.275)

- **PATRÓN** `ballena_activa_n` < `43.0` → IC=+0.322 (n=926)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 43.0 (IC base=+0.275)

- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.300 (n=874)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.304 (n=1312)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3966 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.5418` → IC=+0.285 (n=380)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5298` → IC=+0.268 (n=1145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5298 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.17` → IC=+0.272 (n=519)
...
- **PATRÓN** `libro_liquidez` > `2587.189` → IC=+0.277 (n=874)
...
- **PATRÓN** `sigma_h` > `0.011` → IC=+0.202 (n=2412)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.011 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0894` → IC=+0.184 (n=2413)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0894 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=7555)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5826` → IC=+0.217 (n=7235)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5826 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.17` → IC=+0.196 (n=3174)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.17 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.234` → IC=+0.259 (n=1486)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.234 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2196` → IC=+0.161 (n=4787)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2196 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6265` → IC=+0.160 (n=4786)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6265 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.194 (n=1457)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5652` → IC=+0.170 (n=3045)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5652 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6397` → IC=+0.176 (n=2306)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6397 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `3852.6349` → IC=+0.169 (n=2412)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3852.6349 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.181 (n=6150)
...
- **PATRÓN** `ibs_20min` < `0.4791` → IC=+0.226 (n=6853)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4791 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2257` → IC=+0.159 (n=4996)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2257 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.241` → IC=+0.197 (n=1164)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.241 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1802` → IC=+0.152 (n=4996)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1802 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2915` → IC=+0.224 (n=986)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2915 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5728` → IC=+0.167 (n=2721)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5728 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2773` → IC=+0.174 (n=2804)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2773 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.172 (n=5818)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3411` → IC=+0.206 (n=1241)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3411 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.198 (n=831)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 11.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.303 (n=608)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2291` → IC=+0.239 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2291 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `1.4343` → IC=+0.182 (n=1142)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0751` → IC=+0.208 (n=358)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0751 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.189 (n=1131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 5.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4118` → IC=+0.231 (n=1074)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4118 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.2003` → IC=+0.217 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2003 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.523` → IC=+0.240 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.523 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `1.2698` → IC=+0.170 (n=1074)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.2698 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` > `1.0767` → IC=+0.169 (n=487)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0767 (IC base=+0.165)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4144` → IC=+0.202 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4144 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `15793.9951` → IC=+0.177 (n=487)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 15793.9951 (IC base=+0.165)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.229 (n=548)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.199)

- **PATRÓN** `drift_60min` |x|≤ `0.2134` → IC=+0.215 (n=806)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2134 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.223 (n=406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.803` → IC=+0.282 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.803 (IC base=+0.199)

- **PATRÓN** `volumen_pendiente_norm` < `0.2114` → IC=+0.198 (n=1167)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` < 0.2114 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `2.274` → IC=+0.207 (n=762)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.274 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.212 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `1929.6932` → IC=+0.204 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1929.6932 (IC base=+0.199)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4216` → IC=+0.153 (n=376)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4216 (IC base=+0.147)
...
- **PATRÓN** `libro_liquidez` > `6941.7258` → IC=+0.185 (n=767)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6941.7258 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.149 (n=1091)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.142 (n=1205)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6177` → IC=+0.169 (n=1205)
...
- **PATRÓN** `libro_liquidez` > `9966.3147` → IC=+0.159 (n=547)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 9966.3147 (IC base=+0.122)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.162 (n=595)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0101 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.135 (n=1347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.5208` → IC=+0.201 (n=1311)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5208 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.824` → IC=+0.214 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.824 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.609` → IC=+0.256 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.609 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.2251` → IC=+0.126 (n=1312)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.2251 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.8007` → IC=+0.133 (n=843)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.8007 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1367)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2893.8059` → IC=+0.195 (n=595)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2893.8059 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.136 (n=994)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=1301)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.199)
...
- **PATRÓN** `ibs_20min` > `0.7358` → IC=+0.257 (n=1118)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7358 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` > `1.2528` → IC=+0.225 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2528 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.442` → IC=+0.244 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.442 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` < `1.2102` → IC=+0.202 (n=1252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2102 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` > `0.6187` → IC=+0.209 (n=1251)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6187 (IC base=+0.199)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.274 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2352 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` < `2.1681` → IC=+0.210 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1681 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.8081` → IC=+0.206 (n=804)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8081 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.201 (n=1314)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `2598.267` → IC=+0.202 (n=834)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2598.267 (IC base=+0.199)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.236 (n=434)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0083 (IC base=+0.206)

- **PATRÓN** `sigma_h` > `0.0223` → IC=+0.218 (n=590)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.4426` → IC=+0.247 (n=1301)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4426 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `1.1297` → IC=+0.230 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1297 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.388` → IC=+0.241 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.388 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `0.632` → IC=+0.218 (n=1301)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.632 (IC base=+0.206)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2458` → IC=+0.196 (n=1022)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2458 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `1.4586` → IC=+0.200 (n=1161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4586 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `2564.859` → IC=+0.212 (n=867)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2564.859 (IC base=+0.206)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1355` → IC=+0.153 (n=741)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1355 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.189 (n=840)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.4` → IC=+0.182 (n=1683)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.4 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.3765` → IC=+0.187 (n=503)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.3765 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.707` → IC=+0.178 (n=783)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.707 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.8739` → IC=+0.165 (n=973)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8739 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `1.2111` → IC=+0.156 (n=486)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.2111 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1641` → IC=+0.179 (n=469)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1641 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.4378` → IC=+0.160 (n=539)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.4378 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `2.5522` → IC=+0.173 (n=539)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5522 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.151 (n=1890)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `3250.4907` → IC=+0.152 (n=1121)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3250.4907 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.167 (n=1462)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3382` → IC=+0.128 (n=417)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3382 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.145 (n=376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 9.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.2439` → IC=+0.147 (n=417)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.2439 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.2868` → IC=+0.160 (n=145)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.2868 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.31` → IC=+0.134 (n=189)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.31 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `0.6134` → IC=+0.145 (n=139)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6134 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `14609.6219` → IC=+0.139 (n=278)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 14609.6219 (IC base=+0.105)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.147 (n=131)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 160.0 (IC base=+0.105)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.217 (n=224)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.206)

- **PATRÓN** `drift_60min` |x|≤ `0.0949` → IC=+0.223 (n=164)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7028` → IC=+0.273 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7028 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.3736` → IC=+0.251 (n=171)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2555` → IC=+0.340 (n=73)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2555 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` < `1.3839` → IC=+0.238 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3839 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `2.3885` → IC=+0.268 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3885 (IC base=+0.206)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=545)
...
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.157 (n=170)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0088 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.152 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 8.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` > `0.7317` → IC=+0.188 (n=334)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.7317 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `0.8569` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8569 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.239` → IC=+0.198 (n=177)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 5.239 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `0.8886` → IC=+0.139 (n=250)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.8886 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` > `0.7264` → IC=+0.137 (n=334)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.7264 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` > `0.288` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.288 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` > `2.2114` → IC=+0.156 (n=161)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.2114 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `3065.6596` → IC=+0.209 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3065.6596 (IC base=+0.116)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.156 (n=120)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 22.0 (IC base=+0.116)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.011` → IC=+0.203 (n=3065)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.011 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=9594)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.4722` → IC=+0.216 (n=9184)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4722 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9235` → IC=+0.201 (n=1290)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9235 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.606` → IC=+0.227 (n=4473)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.606 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `0.8828` → IC=+0.165 (n=4094)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8828 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2402` → IC=+0.197 (n=1719)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2402 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6194` → IC=+0.188 (n=2933)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6194 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2328.8086` → IC=+0.170 (n=6121)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2328.8086 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.194 (n=6887)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 89.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.188 (n=7316)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0091 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.484` → IC=+0.183 (n=8313)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.484 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.566` → IC=+0.238 (n=8313)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.71` → IC=+0.182 (n=8062)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.71 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7057` → IC=+0.158 (n=2534)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2856` → IC=+0.191 (n=3432)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.2856 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.189 (n=4836)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.208 (n=1050)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3474` → IC=+0.190 (n=1566)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.3474 (IC base=+0.189)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1166` → IC=+0.160 (n=1246)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1166 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.5037` → IC=+0.154 (n=1265)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5037 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `13725.8693` → IC=+0.154 (n=980)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 13725.8693 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `481.0` → IC=+0.157 (n=1348)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 481.0 (IC base=+0.149)
...
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.245 (n=670)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0098 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=1548)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=1507)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.257 (n=1320)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2145` → IC=+0.224 (n=1449)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2145 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.8894` → IC=+0.242 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8894 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=997)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1929.5555` → IC=+0.221 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1929.5555 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.240 (n=1370)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0109 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.242 (n=1222)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.2` → IC=+0.283 (n=915)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4369` → IC=+0.143 (n=1566)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4369 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1641)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8801` → IC=+0.261 (n=710)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8801 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3629` → IC=+0.168 (n=627)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.3629 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.318` → IC=+0.169 (n=258)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 11.318 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8779` → IC=+0.159 (n=1044)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5223` → IC=+0.149 (n=667)
...
- **PATRÓN** `ibs_20min` < `0.6933` → IC=+0.183 (n=1277)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6933 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.5793` → IC=+0.141 (n=1403)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5793 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.137` → IC=+0.186 (n=189)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 11.137 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8628` → IC=+0.140 (n=851)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8628 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1867` → IC=+0.142 (n=425)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4415` → IC=+0.149 (n=1204)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4415 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `11036.6607` → IC=+0.207 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11036.6607 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `182.0` → IC=+0.141 (n=1197)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 182.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.133 (n=1036)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.008 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.169 (n=578)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 17.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.186 (n=1558)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4706 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `1.0619` → IC=+0.197 (n=305)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 1.0619 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.417` → IC=+0.233 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.417 (IC base=+0.106)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=1079)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2909.4755` → IC=+0.244 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2909.4755 (IC base=+0.106)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.127 (n=1179)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1292` → IC=+0.154 (n=510)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1292 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1579)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6371` → IC=+0.205 (n=1525)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6371 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2158` → IC=+0.130 (n=1228)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2158 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.439` → IC=+0.126 (n=1474)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.439 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.7205` → IC=+0.154 (n=671)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7205 (IC base=+0.111)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2059` → IC=+0.125 (n=620)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.2059 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2851.5493` → IC=+0.163 (n=509)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2851.5493 (IC base=+0.111)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.217 (n=1036)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1620)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.207 (n=1396)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.247 (n=1553)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.8523` → IC=+0.240 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8523 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.496` → IC=+0.250 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.496 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.213 (n=1552)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6356 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2351` → IC=+0.244 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2351 (IC base=+0.205)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.214 (n=1608)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2601.1926` → IC=+0.214 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2601.1926 (IC base=+0.205)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1782)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.5207` → IC=+0.256 (n=1685)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5207 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `1.1426` → IC=+0.201 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1426 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.8572` → IC=+0.203 (n=1876)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8572 (IC base=+0.201)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2213` → IC=+0.196 (n=1322)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2213 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.201 (n=1502)
...
- **PATRÓN** `ibs_20min` > `0.9407` → IC=+0.210 (n=910)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9407 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1897` → IC=+0.162 (n=975)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1897 (IC base=+0.150)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4804` → IC=+0.153 (n=2128)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.5347` → IC=+0.137 (n=927)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5347 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.8156` → IC=+0.139 (n=1404)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8156 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2822)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7238.8989` → IC=+0.147 (n=1901)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 7238.8989 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.142` → IC=+0.160 (n=95)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 2.142 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.207 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.070)

- **PATRÓN** `libro_liquidez` > `3362.8134` → IC=+0.131 (n=158)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 3362.8134 (IC base=+0.070)

- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.154 (n=76)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0119 (IC base=+0.058)

- **PATRÓN** `drift_60min` |x|≤ `0.3919` → IC=+0.123 (n=112)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.3919 (IC base=+0.058)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.1 (IC base=+0.058)

- **PATRÓN** `dist_vwap_pct` > `0.6189` → IC=+0.142 (n=79)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6189 (IC base=+0.058)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.125 (n=835)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.5717` → IC=+0.198 (n=714)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5717 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.352` → IC=+0.179 (n=278)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.352 (IC base=+0.104)
...
- **PATRÓN** `volumen_regimen` < `0.8112` → IC=+0.126 (n=476)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 0.8112 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` > `0.98` → IC=+0.141 (n=324)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.98 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.2853` → IC=+0.216 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2853 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` < `2.1044` → IC=+0.159 (n=532)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1044 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` > `1.4015` → IC=+0.132 (n=604)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4015 (IC base=+0.104)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.133 (n=581)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.02 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `2438.1282` → IC=+0.154 (n=313)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2438.1282 (IC base=+0.104)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.124 (n=277)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 7.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.5781` → IC=+0.206 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5781 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.1296` → IC=+0.179 (n=129)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1296 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.622` → IC=+0.141 (n=151)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 3.622 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.0596` → IC=+0.130 (n=217)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0596 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` < `0.067` → IC=+0.149 (n=183)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.067 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.2692` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2692 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.197 (n=183)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.0118 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=251)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3529.3602` → IC=+0.131 (n=155)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 3529.3602 (IC base=+0.112)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.149 (n=246)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 8.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.5536` → IC=+0.217 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5536 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.3347` → IC=+0.173 (n=99)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.3347 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` > `0.6338` → IC=+0.138 (n=219)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6338 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.3021` → IC=+0.281 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3021 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.7387` → IC=+0.167 (n=130)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.7387 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `1.503` → IC=+0.136 (n=174)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.503 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.144 (n=161)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `1113.1395` → IC=+0.168 (n=215)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 1113.1395 (IC base=+0.115)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.123 (n=112)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.006 (IC base=+0.081)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.134 (n=181)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 13.0 (IC base=+0.081)

- **PATRÓN** `ibs_20min` > `0.6905` → IC=+0.192 (n=199)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.6905 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` > `0.1948` → IC=+0.157 (n=129)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1948 (IC base=+0.081)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.203` → IC=+0.220 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.203 (IC base=+0.081)

- **PATRÓN** `volumen_regimen` > `1.0632` → IC=+0.162 (n=75)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0632 (IC base=+0.081)

- **PATRÓN** `volumen_pendiente_norm` > `0.0847` → IC=+0.199 (n=91)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.0847 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` < `2.1707` → IC=+0.135 (n=179)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.1707 (IC base=+0.081)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=1563)
...
- **FILTRO** `liq_usd_total` < `73884.56` → IC=-0.120 (n=77)

  - _Acción_: SKIP cuando `liq_usd_total` < 73884.56
  - _Potencial_: sin este filtro IC_bueno=+0.200 (n=78)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7261)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.176 (n=3095)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=9730)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.173 (n=3241)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=10018)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.214 (n=551)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1658)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.172 (n=553)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.203 (n=554)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1695)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=588)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1772)
...
- **PATRÓN** `libro_liquidez` > `1725.133` → IC=+0.122 (n=765)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 1725.133 (IC base=+0.029)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.184 (n=542)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1645)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2787)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2793)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=728)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=9157)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=20442)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.275 (n=7140)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=22459)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.236 (n=7391)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=22208)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=10005)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=19594)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9221)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=27777)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=9248)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27750)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=1157)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3692)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.253 (n=1599)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3250)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.181 (n=1148)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3701)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.151 (n=4287)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=2093)

- **FILTRO** `drift_7min_pct` |x|> `0.112` → IC=-0.125 (n=2169)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.112
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4211)

- **FILTRO** `ibs_7min` > `0.7937` → IC=-0.206 (n=1594)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7937
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4786)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1204)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3939)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1234)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3909)

- **FILTRO** `ibs_7min` < `0.7526` → IC=-0.189 (n=1285)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7526
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3858)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.173 (n=1281)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3862)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.260 (n=1284)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3895)

- **FILTRO** `ibs_7min` > `0.2588` → IC=-0.174 (n=1291)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2588
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3888)

- **FILTRO** `ballena_activa_n` > `155.0` → IC=-0.186 (n=1292)

  - _Acción_: SKIP cuando `ballena_activa_n` > 155.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3887)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.171 (n=1130)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3457)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.308 (n=1118)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=3469)

- **FILTRO** `ibs_7min` < `0.1966` → IC=-0.258 (n=1146)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1966
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3441)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.212 (n=1096)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3491)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1586)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=5201)

- **FILTRO** `ibs_7min` > `0.759` → IC=-0.178 (n=1696)

  - _Acción_: SKIP cuando `ibs_7min` > 0.759
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=5091)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1566)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3302)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.243 (n=1194)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3674)

- **FILTRO** `ibs_7min` < `0.7429` → IC=-0.182 (n=1216)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7429
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3652)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.176 (n=1216)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3652)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1242)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3739)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.174 (n=1245)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3736)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.191 (n=1216)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3765)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=1223)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3992)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.229 (n=1302)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3913)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1691)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5324)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.276 (n=1153)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=3784)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.231 (n=1234)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=3703)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1181)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3756)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1639)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=5017)
...
- **PATRÓN** `dist_50` > `0.4568` → IC=+0.487 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `dist_50` > 0.4568 (IC base=+0.473)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=666)

- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=666)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1392)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1400)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.185 (n=471)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0043 (IC base=+0.184)

- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.218 (n=640)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0082 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.1627` → IC=+0.191 (n=1242)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.1627 (IC base=+0.184)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2173` → IC=+0.191 (n=471)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.2173 (IC base=+0.184)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1297` → IC=+0.224 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1297 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.197 (n=994)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 11.0 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.185 (n=1428)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 16.0 (IC base=+0.184)

- **PATRÓN** `ibs_15` > `0.6129` → IC=+0.261 (n=1411)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6129 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` > `0.4509` → IC=+0.184 (n=340)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.4509 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` < `0.5763` → IC=+0.173 (n=1388)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5763 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.122` → IC=+0.270 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.122 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `2979.0729` → IC=+0.189 (n=941)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2979.0729 (IC base=+0.184)
...
- **PATRÓN** `drift_15min` |x|≤ `0.3806` → IC=+0.210 (n=112)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3806 (IC base=+0.203)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1484` → IC=+0.269 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1484 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.226 (n=352)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.203)

- **PATRÓN** `ibs_15` > `0.7004` → IC=+0.269 (n=335)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7004 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.278 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.203)
...
- **PATRÓN** `libro_liquidez` > `15901.5027` → IC=+0.237 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15901.5027 (IC base=+0.203)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.155 (n=224)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.005 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0691` → IC=+0.160 (n=148)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0691 (IC base=+0.139)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.164 (n=224)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.82€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=+0.139)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2579` → IC=+0.164 (n=233)

  - _Acción_: Kelly boost +0.82€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2579 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.160 (n=248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.139)

- **PATRÓN** `ibs_15` > `0.6192` → IC=+0.219 (n=336)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6192 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1597` → IC=+0.162 (n=261)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1597 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.56` → IC=+0.211 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.56 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.149 (n=152)
...
- **PATRÓN** `sigma_h` > `0.0171` → IC=+0.225 (n=256)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0171 (IC base=+0.180)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0401` → IC=+0.189 (n=384)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.95€ cuando `delta_ratio_macro` |x|> 0.0401 (IC base=+0.180)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0919` → IC=+0.235 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0919 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.231 (n=128)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.180)

- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.277 (n=384)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` > `0.1228` → IC=+0.199 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1228 (IC base=+0.180)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.952` → IC=+0.181 (n=324)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 5.952 (IC base=+0.180)

- **PATRÓN** `libro_liquidez` > `2863.5754` → IC=+0.254 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2863.5754 (IC base=+0.180)
...
- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.380 (n=173)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0051 (IC base=+0.339)

- **PATRÓN** `drift_60min` |x|≤ `0.1105` → IC=+0.345 (n=256)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1105 (IC base=+0.339)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1464` → IC=+0.363 (n=253)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1464 (IC base=+0.339)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1326` → IC=+0.380 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1326 (IC base=+0.339)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.362 (n=381)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.339)

- **PATRÓN** `ibs_15` > `0.7853` → IC=+0.385 (n=380)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7853 (IC base=+0.339)

- **PATRÓN** `dist_vwap_pct` > `0.4248` → IC=+0.380 (n=115)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1804` → IC=+0.240 (n=945)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1804 (IC base=-0.040)

- **PATRÓN** `ibs_15` < `0.3542` → IC=+0.281 (n=1471)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3542 (IC base=-0.040)

- **PATRÓN** `dist_vwap_pct` > `0.651` → IC=+0.278 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.651 (IC base=-0.040)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.219 (n=368)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0069
  - _Potencial_: sin este filtro IC_bueno=-0.194 (n=1106)

- **FILTRO** `sigma_h` < `0.0033` → IC=-0.227 (n=368)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0033
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1106)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=931)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.239 (n=599)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7761` → IC=+0.232 (n=527)
...
- **PATRÓN** `ibs_15` < `0.3561` → IC=+0.265 (n=599)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3561 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.7306` → IC=+0.278 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7306 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.065` → IC=+0.248 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.065 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.254` → IC=+0.228 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.254 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3532.2389` → IC=+0.229 (n=599)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.011` → IC=-0.132 (n=305)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2444)
...
- **FILTRO** `sigma_h` > `0.0196` → IC=-0.264 (n=362)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `drift_15min` |x|> `1.198` → IC=-0.243 (n=181)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.178 (n=545)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.260 (n=181)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.173 (n=545)
...
- **PATRÓN** `ibs_15` < `0.35` → IC=+0.315 (n=409)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.35 (IC base=-0.045)

- **PATRÓN** `dist_vwap_pct` > `1.0781` → IC=+0.409 (n=53)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.294 (n=756)
...
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.306 (n=276)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0069 (IC base=+0.297)

- **PATRÓN** `drift_60min` |x|≤ `0.113` → IC=+0.301 (n=184)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.113 (IC base=+0.297)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.288` → IC=+0.337 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.288 (IC base=+0.297)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.328 (n=248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.6145` → IC=+0.300 (n=63)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.308 (n=315)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6129 sube el IC de +0.184 a +0.261 en UPDOWN_GBM#15min (n=1411). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7004 sube el IC de +0.203 a +0.269 en UPDOWN_GBM#BTC#15min (n=335). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6192 sube el IC de +0.139 a +0.219 en UPDOWN_GBM#ETH#15min (n=336). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.180 a +0.277 en UPDOWN_GBM#XRP#15min (n=384). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3542 sube el IC de -0.040 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1471). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3561 sube el IC de +0.225 a +0.265 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=599). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.045 a +0.315 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=409). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8393 sube el IC de +0.291 a +0.329 en UPDOWN_GBM_IBS_ALTO (n=617). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7853 sube el IC de +0.339 a +0.385 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=380). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.7403 sube el IC de +0.330 a +0.393 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=166). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 23446 | -0.091 | -3071.65€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1399 | -0.048 | -214.21€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22047 | -0.094 | -2857.44€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 6727 | -0.029 | -601.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6727 | -0.029 | -601.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6184 | -0.094 | -404.98€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6184 | -0.094 | -404.98€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5198 | -0.181 | -1115.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5198 | -0.181 | -1115.05€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15893 | -0.032 | +4128.50€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4178 | -0.001 | +1830.61€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11715 | -0.043 | +2297.90€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15893 | -0.032 | +4128.50€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4178 | -0.001 | +1830.61€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11715 | -0.043 | +2297.90€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1405 | -0.101 | -177.87€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 159 | -0.053 | -19.73€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1246 | -0.107 | -158.14€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 437 | -0.126 | -69.06€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 413 | -0.129 | -63.83€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 85809 | +0.113 | -4405.14€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13149 | +0.184 | -431.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 338 | -0.100 | -48.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 66628 | +0.100 | -3730.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5694 | +0.110 | -195.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11088 | +0.098 | -977.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 43 | -0.167 | -2.82€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11030 | +0.099 | -962.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 17359 | +0.132 | -357.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4102 | +0.201 | -143.31€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11043 | +0.112 | -171.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2172 | +0.108 | -20.39€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11128 | +0.088 | -1071.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 50 | -0.077 | -4.56€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11063 | +0.089 | -1055.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 18305 | +0.124 | -369.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5081 | +0.175 | -77.00€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11154 | +0.105 | -230.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2058 | +0.098 | -53.59€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 16823 | +0.115 | -969.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3830 | +0.187 | -211.36€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 241 | -0.060 | +5.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11288 | +0.092 | -642.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1464 | +0.128 | -121.41€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 11106 | +0.101 | -659.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 43 | -0.033 | +7.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 11050 | +0.102 | -667.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 