# Hipótesis automáticas — 2026-06-29 16:11 UTC
...
| ✅ UPDOWN_GBM#ETH | 120 | +0.041 | +4.01€ | 0 | 0 |
...
**⏳ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: 28/40 ops con ibs_15. oversold(IBS<0.3): IC=-0.021 n=9 | neutral: IC=+0.018 n=5 | overbought(IBS>0.7): IC=+0.000 n=12
  - _Datos_: n=28 IC=+0.000 PNL=-1.58€

**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: 28 ops, 5 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 317/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=218 IC=+0.018 PNL=+5.19€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=218 IC=+0.018 PNL=+5.19€
