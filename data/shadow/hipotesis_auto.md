# Hipótesis automáticas — 2026-08-21 23:17 UTC
_Generado por shadow_postmortem.py sobre 106617 resoluciones (PNL=+8827.41€)_
...
- **FILTRO** `py_entrada` < `0.7` → IC=-0.174 (n=84)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.260 (n=173)
...
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.260 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.7 (IC base=+0.118)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.132 (n=180)

  - _Acción_: Kelly boost +0.66€ cuando `n_ballena_banda` > 20.0 (IC base=+0.118)

- **PATRÓN** `n_total_lado` > `69.0` → IC=+0.225 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 69.0 (IC base=+0.118)

- **PATRÓN** `banda_hit_calibrado` > `0.7988` → IC=+0.260 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.7988 (IC base=+0.118)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.141 (n=129)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 11.0 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=201)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `1096.3762` → IC=+0.131 (n=193)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 1096.3762 (IC base=+0.118)
...
- **PATRÓN** `n_ballena_banda` > `26.0` → IC=+0.170 (n=98)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `n_ballena_banda` > 26.0 (IC base=+0.148)

- **PATRÓN** `n_total_lado` > `71.0` → IC=+0.250 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 71.0 (IC base=+0.148)

- **PATRÓN** `banda_z` > `10.085` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `banda_z` > 10.085 (IC base=+0.148)

- **PATRÓN** `ballenas_wallet_edge_medio` > `1.284` → IC=+0.167 (n=91)

  - _Acción_: Kelly boost +0.83€ cuando `ballenas_wallet_edge_medio` > 1.284 (IC base=+0.148)
...
- **PATRÓN** `libro_liquidez` > `4634.0182` → IC=+0.210 (n=36)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4634.0182 (IC base=+0.148)
...
- **PATRÓN** `py_entrada` > `0.6` → IC=+0.183 (n=197)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.6 (IC base=+0.134)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=907)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.309 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.7 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.295 (n=325)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4420.281` → IC=+0.160 (n=139)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 4420.281 (IC base=+0.084)

### FAVORITO_CONFIRMADO#SOL#15min
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.219 (n=233)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.84` → IC=+0.435 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.84 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.242 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.210)

- **PATRÓN** `py_entrada` < `0.31` → IC=+0.311 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.31 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `748.7377` → IC=+0.237 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 748.7377 (IC base=+0.210)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.188 (n=853)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.166 (n=870)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.187 (n=295)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.235 (n=281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.319 (n=290)
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.197 (n=539)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.71 (IC base=+0.191)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.443 (n=156)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `3965.0747` → IC=+0.449 (n=77)
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.429 (n=68)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2106.7117` → IC=+0.434 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2106.7117 (IC base=+0.411)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=6610)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.228 (n=5378)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.197)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.137 (n=679)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 8.0 (IC base=+0.118)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.163 (n=982)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` > 0.71 (IC base=+0.118)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.244 (n=451)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `5.0` → IC=+0.150 (n=877)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 5.0 (IC base=+0.129)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.225 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.141)

- **PATRÓN** `restante_min` < `3.78` → IC=+0.181 (n=437)

  - _Acción_: Kelly boost +0.91€ cuando `restante_min` < 3.78 (IC base=+0.141)

- **PATRÓN** `restante_min` > `4.89` → IC=+0.153 (n=459)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` > 4.89 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.163 (n=916)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 12.0 (IC base=+0.141)

- **PATRÓN** `lag_apertura_s` < `6.67` → IC=+0.156 (n=437)

  - _Acción_: Kelly boost +0.78€ cuando `lag_apertura_s` < 6.67 (IC base=+0.141)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.178 (n=486)

  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` < 0.37 (IC base=+0.117)

- **PATRÓN** `restante_min` < `3.95` → IC=+0.138 (n=445)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` < 3.95 (IC base=+0.117)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.164 (n=445)

  - _Acción_: Kelly boost +0.82€ cuando `restante_min` > 4.95 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.124 (n=1321)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 17.0 (IC base=+0.117)

- **PATRÓN** `lag_apertura_s` < `3.29` → IC=+0.167 (n=442)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 3.29 (IC base=+0.117)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.311 (n=506)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.330 (n=157)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2591.029` → IC=+0.342 (n=74)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.330 (n=86)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.290 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `1382.8486` → IC=+0.329 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1382.8486 (IC base=+0.278)
...
- **PATRÓN** `ibs_20min` > `0.9724` → IC=+0.260 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9724 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.1564` → IC=+0.237 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1564 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` < `1.084` → IC=+0.238 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.084 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.918` → IC=+0.218 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.918 (IC base=+0.091)

- **PATRÓN** `volumen_regimen` > `1.1082` → IC=+0.264 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1082 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` < `0.08` → IC=+0.124 (n=790)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_pendiente_norm` < 0.08 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` > `0.3171` → IC=+0.159 (n=121)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.3171 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` < `3.1816` → IC=+0.126 (n=875)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 3.1816 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` > `1.4957` → IC=+0.131 (n=875)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4957 (IC base=+0.091)

- **PATRÓN** `ibs_20min` < `0.4016` → IC=+0.131 (n=1768)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.4016 (IC base=+0.045)

- **PATRÓN** `dist_vwap_pct` < `0.1302` → IC=+0.145 (n=581)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1302 (IC base=+0.045)

- **PATRÓN** `volumen_regimen` < `0.8575` → IC=+0.134 (n=400)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8575 (IC base=+0.045)

- **PATRÓN** `volumen_regimen` > `1.2591` → IC=+0.148 (n=200)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.2591 (IC base=+0.045)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6647` → IC=+0.211 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6647 (IC base=+0.045)
...
- **PATRÓN** `ballena_activa_n` < `161.0` → IC=+0.244 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 161.0 (IC base=+0.045)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.312 (n=67)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.0798` → IC=+0.268 (n=67)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0798 (IC base=+0.236)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.267 (n=208)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.236)

- **PATRÓN** `ibs_20min` > `0.488` → IC=+0.254 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.488 (IC base=+0.236)

- **PATRÓN** `dist_vwap_pct` > `0.1813` → IC=+0.250 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1813 (IC base=+0.236)

- **PATRÓN** `dist_vwap_pct` < `1.1931` → IC=+0.250 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.1931 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.507` → IC=+0.315 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.507 (IC base=+0.236)

- **PATRÓN** `volumen_regimen` > `0.9107` → IC=+0.257 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9107 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.083` → IC=+0.255 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.083 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` > `0.2912` → IC=+0.293 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2912 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` < `1.358` → IC=+0.287 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.358 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` > `2.0438` → IC=+0.256 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0438 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `11835.8417` → IC=+0.265 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11835.8417 (IC base=+0.236)

- **PATRÓN** `ballena_activa_n` < `442.0` → IC=+0.248 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 442.0 (IC base=+0.236)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.169 (n=146)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0022 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.2458` → IC=+0.148 (n=291)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.2458 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.139 (n=311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 8.0 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.140 (n=337)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 18.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.558` → IC=+0.161 (n=331)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.558 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.1781` → IC=+0.168 (n=290)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1781 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.029` → IC=+0.233 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.029 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `0.6279` → IC=+0.146 (n=111)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6279 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `1.2387` → IC=+0.143 (n=110)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.2387 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.1112` → IC=+0.242 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1112 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `1.808` → IC=+0.169 (n=152)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.808 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.2479` → IC=+0.157 (n=103)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.2479 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.132 (n=425)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `13718.6409` → IC=+0.170 (n=110)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 13718.6409 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `230.0` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 230.0 (IC base=+0.131)
...
- **FILTRO** `ibs_20min` > `0.8848` → IC=-0.191 (n=147)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8848
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=445)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.116` → IC=+0.188 (n=46)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 12.116 (IC base=+0.006)

### GBM_LATE_15M#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.656` → IC=-0.144 (n=220)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.220 (n=23)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.005 (IC base=+0.091)

- **PATRÓN** `drift_60min` |x|≤ `0.434` → IC=+0.148 (n=52)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.434 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `23.0` → IC=+0.309 (n=19)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 23.0 (IC base=+0.091)

- **PATRÓN** `ibs_20min` > `0.3333` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.3333 (IC base=+0.091)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `ibs_20min` > `0.7457` → IC=-0.146 (n=224)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7457
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=674)

- **FILTRO** `sigma_ewma_delta_pct` > `8.124` → IC=-0.173 (n=108)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.124
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=790)
...
- **PATRÓN** `dist_vwap_pct` < `0.334` → IC=+0.221 (n=152)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.334 (IC base=-0.006)

- **PATRÓN** `volumen_regimen` < `0.6966` → IC=+0.229 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6966 (IC base=-0.006)

- **PATRÓN** `volumen_regimen` > `1.0971` → IC=+0.238 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0971 (IC base=-0.006)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.160 (n=674)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0074 (IC base=+0.055)

- **PATRÓN** `ibs_20min` > `0.9487` → IC=+0.257 (n=674)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9487 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` > `0.3426` → IC=+0.251 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3426 (IC base=+0.055)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.318` → IC=+0.133 (n=1195)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 2.318 (IC base=+0.055)

- **PATRÓN** `volumen_regimen` > `1.1848` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.1848 (IC base=+0.055)

- **PATRÓN** `volumen_pendiente_norm` > `0.3246` → IC=+0.220 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3246 (IC base=+0.055)

- **PATRÓN** `volumen_spike_ratio` > `1.6944` → IC=+0.161 (n=776)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.6944 (IC base=+0.055)

- **PATRÓN** `ballena_activa_n` < `90.0` → IC=+0.296 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 90.0 (IC base=+0.055)

- **PATRÓN** `ibs_20min` < `0.1892` → IC=+0.148 (n=1289)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.1892 (IC base=+0.037)

- **PATRÓN** `dist_vwap_pct` > `0.4705` → IC=+0.204 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4705 (IC base=+0.037)

- **PATRÓN** `volumen_regimen` > `0.63` → IC=+0.193 (n=564)
...
- **PATRÓN** `volumen_spike_ratio` > `1.6659` → IC=+0.245 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6659 (IC base=+0.037)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.236 (n=214)
...
- **PATRÓN** `volumen_regimen` < `0.5607` → IC=+0.140 (n=23)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.5607 (IC base=-0.033)

- **PATRÓN** `volumen_regimen` > `1.1074` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1074 (IC base=-0.033)
...
- **FILTRO** `ibs_20min` < `0.668` → IC=-0.122 (n=207)
...
- **FILTRO** `ibs_20min` < `0.4828` → IC=-0.150 (n=201)
...
- **PATRÓN** `ibs_20min` > `0.7879` → IC=+0.257 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7879 (IC base=+0.003)

- **PATRÓN** `dist_vwap_pct` > `0.1779` → IC=+0.236 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1779 (IC base=+0.003)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.024` → IC=+0.130 (n=79)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 7.024 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` > `1.1512` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.1512 (IC base=+0.003)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7837` → IC=+0.151 (n=61)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.7837 (IC base=+0.003)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.225 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 61.0 (IC base=+0.003)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.372 (n=131)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0094 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.221 (n=134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.913` → IC=+0.266 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.913 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` > `0.2822` → IC=+0.310 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2822 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.118` → IC=+0.261 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.118 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` > `0.8361` → IC=+0.228 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8361 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.1826` → IC=+0.269 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1826 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` < `1.984` → IC=+0.212 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.984 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.190)

- **PATRÓN** `libro_liquidez` > `2684.1264` → IC=+0.220 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2684.1264 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `41.0` → IC=+0.364 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 41.0 (IC base=+0.190)

- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.267 (n=402)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0089 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.3884` → IC=+0.275 (n=402)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3884 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.321 (n=182)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3469` → IC=+0.314 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3469 (IC base=+0.258)

- **PATRÓN** `dist_vwap_pct` < `0.7828` → IC=+0.262 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7828 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.471` → IC=+0.277 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.471 (IC base=+0.258)

- **PATRÓN** `volumen_regimen` > `1.0789` → IC=+0.304 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0789 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2516` → IC=+0.385 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2516 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `1.6295` → IC=+0.242 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6295 (IC base=+0.258)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.219 (n=571)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.174 (n=658)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 6.0 (IC base=+0.158)

- **PATRÓN** `ibs_20min` > `0.9108` → IC=+0.261 (n=1142)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9108 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` > `0.8991` → IC=+0.263 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8991 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.358` → IC=+0.289 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.358 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` > `0.7163` → IC=+0.177 (n=952)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.7163 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.1052` → IC=+0.189 (n=599)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1052 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `2.4367` → IC=+0.148 (n=1295)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.4367 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` > `1.4827` → IC=+0.146 (n=1472)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4827 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=1783)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `3299.3039` → IC=+0.210 (n=571)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3299.3039 (IC base=+0.158)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.207 (n=1504)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.007 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.3175` → IC=+0.200 (n=1503)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3175 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=703)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` < `0.3916` → IC=+0.255 (n=1505)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3916 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` < `0.1759` → IC=+0.183 (n=1169)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1759 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.616` → IC=+0.203 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.616 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.298` → IC=+0.194 (n=1509)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 5.298 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` < `1.1823` → IC=+0.164 (n=1203)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1823 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` > `0.6786` → IC=+0.171 (n=1075)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6786 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.2511` → IC=+0.239 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2511 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` < `1.6205` → IC=+0.183 (n=396)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.6205 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.8455` → IC=+0.222 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8455 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.176 (n=406)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 116.0 (IC base=+0.190)
...
- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.246 (n=69)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0023 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.225 (n=136)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0037 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.244 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` > `0.5283` → IC=+0.252 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5283 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.261 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.779` → IC=+0.318 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.779 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.9306` → IC=+0.254 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9306 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2912` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2912 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` < `1.4267` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4267 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.7306` → IC=+0.214 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7306 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `11154.7281` → IC=+0.254 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11154.7281 (IC base=+0.204)

- **PATRÓN** `sigma_h` < `0.0042` → IC=+0.191 (n=292)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0042 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.2043` → IC=+0.207 (n=257)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2043 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.192 (n=199)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 12.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` < `0.338` → IC=+0.214 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.338 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` < `0.1759` → IC=+0.196 (n=294)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.1759 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.578` → IC=+0.253 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.578 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `0.6305` → IC=+0.240 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6305 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.1146` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1146 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.7752` → IC=+0.214 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7752 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 221.0 (IC base=+0.162)
...
- **PATRÓN** `sigma_h` < `0.0095` → IC=+0.247 (n=192)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0095 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.1399` → IC=+0.293 (n=85)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1399 (IC base=+0.228)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.244 (n=174)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.228)

- **PATRÓN** `ibs_20min` > `0.4756` → IC=+0.283 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4756 (IC base=+0.228)

- **PATRÓN** `dist_vwap_pct` > `0.8082` → IC=+0.266 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8082 (IC base=+0.228)

- **PATRÓN** `dist_vwap_pct` < `0.3732` → IC=+0.239 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3732 (IC base=+0.228)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.788` → IC=+0.409 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.788 (IC base=+0.228)

- **PATRÓN** `volumen_regimen` > `0.6537` → IC=+0.253 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6537 (IC base=+0.228)

- **PATRÓN** `volumen_pendiente_norm` > `0.1034` → IC=+0.298 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1034 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` < `1.467` → IC=+0.246 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.467 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` > `2.5597` → IC=+0.278 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5597 (IC base=+0.228)

- **PATRÓN** `ballena_activa_n` < `240.0` → IC=+0.223 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 240.0 (IC base=+0.228)

- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.201 (n=286)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.3154` → IC=+0.177 (n=286)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.3154 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.152 (n=297)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 18.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` < `0.4404` → IC=+0.219 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4404 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.5365` → IC=+0.168 (n=338)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.5365 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.644` → IC=+0.267 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.644 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.1821` → IC=+0.174 (n=286)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 1.1821 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `0.6086` → IC=+0.155 (n=285)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6086 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` < `0.1694` → IC=+0.134 (n=184)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1694 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1088` → IC=+0.145 (n=74)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.1088 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `1.8946` → IC=+0.183 (n=121)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.8946 (IC base=+0.149)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **FILTRO** `ibs_20min` > `0.4762` → IC=-0.220 (n=98)

  - _Acción_: SKIP cuando `ibs_20min` > 0.4762
  - _Potencial_: sin este filtro IC_bueno=+0.207 (n=295)

- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.214 (n=145)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0074 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.149 (n=109)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 18.0 (IC base=+0.101)

- **PATRÓN** `ibs_20min` > `0.8696` → IC=+0.234 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8696 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.7694` → IC=+0.279 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7694 (IC base=+0.101)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0971` → IC=+0.135 (n=113)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.0971 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `2699.9007` → IC=+0.180 (n=145)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2699.9007 (IC base=+0.101)

- **PATRÓN** `ballena_activa_n` < `70.0` → IC=+0.213 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 70.0 (IC base=+0.101)

- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.226 (n=100)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0046 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.209 (n=139)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` < `0.4762` → IC=+0.207 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4762 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.083` → IC=+0.151 (n=41)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 7.083 (IC base=+0.100)

- **PATRÓN** `volumen_regimen` > `0.8469` → IC=+0.133 (n=197)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.8469 (IC base=+0.100)

- **PATRÓN** `volumen_pendiente_norm` > `0.094` → IC=+0.158 (n=77)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.094 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` > `2.4132` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.4132 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2385.1288` → IC=+0.176 (n=134)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2385.1288 (IC base=+0.100)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.151 (n=41)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 32.0 (IC base=+0.100)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.251 (n=235)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0067 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.2105` → IC=+0.158 (n=235)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.2105 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.195 (n=126)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 17.0 (IC base=+0.158)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.167 (n=172)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 8.0 (IC base=+0.158)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.251 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` > `0.3168` → IC=+0.231 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3168 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.341` → IC=+0.242 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.341 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `0.6141` → IC=+0.175 (n=118)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6141 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` > `0.8509` → IC=+0.179 (n=235)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 0.8509 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.251` → IC=+0.246 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.251 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `2.68` → IC=+0.176 (n=316)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.68 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` > `1.9305` → IC=+0.162 (n=211)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.9305 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.159 (n=376)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `2452.7664` → IC=+0.161 (n=352)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2452.7664 (IC base=+0.158)
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.178 (n=88)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0062 (IC base=+0.073)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.222 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.073)

- **PATRÓN** `ibs_20min` > `0.5294` → IC=+0.135 (n=264)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` > 0.5294 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` > `0.5649` → IC=+0.188 (n=30)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.5649 (IC base=+0.073)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.863` → IC=+0.278 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.863 (IC base=+0.073)
...
- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.333 (n=28)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.159 (n=42)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.038)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.167 (n=61)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 1.0 (IC base=+0.038)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.234 (n=656)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0077 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=1005)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 15.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.147 (n=718)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 6.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.9609` → IC=+0.287 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9609 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.3189` → IC=+0.226 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3189 (IC base=+0.140)
...
- **PATRÓN** `volumen_regimen` < `0.7157` → IC=+0.148 (n=544)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7157 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.0976` → IC=+0.155 (n=561)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.0976 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.2443` → IC=+0.173 (n=337)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.2443 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.888` → IC=+0.136 (n=1650)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.888 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.6261` → IC=+0.145 (n=1474)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.6261 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.151 (n=2002)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.04 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `2785.0379` → IC=+0.188 (n=889)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 2785.0379 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.218 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 162.0 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.212 (n=1787)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.3484` → IC=+0.201 (n=1786)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3484 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.207 (n=844)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.191)

- **PATRÓN** `ibs_20min` < `0.5385` → IC=+0.253 (n=1786)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5385 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` < `0.7502` → IC=+0.174 (n=1410)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.7502 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.173` → IC=+0.226 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.173 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.52` → IC=+0.194 (n=1675)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 2.52 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` < `0.612` → IC=+0.177 (n=435)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.612 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` > `1.1938` → IC=+0.184 (n=435)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.1938 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` > `0.2382` → IC=+0.240 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2382 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.3399` → IC=+0.199 (n=496)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.3399 (IC base=+0.191)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.128 (n=441)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 56.0 (IC base=+0.191)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.172 (n=114)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0026 (IC base=+0.160)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.186 (n=173)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0034 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.195 (n=260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 6.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` > `0.3308` → IC=+0.232 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3308 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.248 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.534` → IC=+0.271 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.534 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` < `0.6819` → IC=+0.163 (n=87)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6819 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `0.9222` → IC=+0.186 (n=173)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.9222 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` < `0.1037` → IC=+0.192 (n=199)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1502` → IC=+0.203 (n=62)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1502 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `2.6561` → IC=+0.215 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.6561 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.3478` → IC=+0.210 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3478 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `10236.9065` → IC=+0.231 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10236.9065 (IC base=+0.160)

- **PATRÓN** `ballena_activa_n` < `495.0` → IC=+0.211 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 495.0 (IC base=+0.160)

- **PATRÓN** `sigma_h` < `0.002` → IC=+0.194 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.002 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.3101` → IC=+0.171 (n=323)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3101 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.165 (n=326)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.169 (n=330)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 18.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` < `0.5045` → IC=+0.199 (n=323)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.5045 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` < `0.2792` → IC=+0.190 (n=308)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.2792 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.639` → IC=+0.235 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.639 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` < `0.6208` → IC=+0.209 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6208 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `1.2206` → IC=+0.182 (n=108)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.2206 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.0932` → IC=+0.283 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0932 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `1.7388` → IC=+0.208 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7388 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.184 (n=204)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.5138 (IC base=+0.160)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.162 (n=415)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `12550.5978` → IC=+0.173 (n=108)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 12550.5978 (IC base=+0.160)

- **PATRÓN** `ballena_activa_n` < `329.0` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 329.0 (IC base=+0.160)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.152 (n=87)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0022 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.004` → IC=+0.171 (n=171)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.004 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.0736` → IC=+0.159 (n=86)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0736 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.201 (n=95)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.3749` → IC=+0.218 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3749 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.1612` → IC=+0.201 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1612 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.701` → IC=+0.219 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.701 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.7618` → IC=+0.213 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7618 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `1.1336` → IC=+0.164 (n=117)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.1336 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.314 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4306` → IC=+0.231 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4306 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `3954.2434` → IC=+0.223 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3954.2434 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `233.0` → IC=+0.256 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 233.0 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.266 (n=92)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.3805` → IC=+0.148 (n=208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3805 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.132 (n=191)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.2568` → IC=+0.209 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2568 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.2764` → IC=+0.139 (n=95)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.2764 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.7287` → IC=+0.147 (n=219)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.7287 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.864` → IC=+0.267 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.864 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `0.539` → IC=+0.167 (n=70)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.539 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` < `0.0945` → IC=+0.169 (n=161)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` < 0.0945 (IC base=+0.127)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1429` → IC=+0.172 (n=135)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.1429 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `1.4569` → IC=+0.177 (n=153)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4569 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `4025.7224` → IC=+0.138 (n=139)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 4025.7224 (IC base=+0.127)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.212 (n=57)
...
- **FILTRO** `ibs_20min` > `0.5833` → IC=-0.179 (n=104)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.193 (n=317)

- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.226 (n=104)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0077 (IC base=+0.069)

- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.262 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9429 (IC base=+0.069)

- **PATRÓN** `dist_vwap_pct` > `0.6975` → IC=+0.241 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6975 (IC base=+0.069)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.987` → IC=+0.267 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.987 (IC base=+0.069)

- **PATRÓN** `libro_liquidez` > `2625.0768` → IC=+0.217 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.0768 (IC base=+0.069)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.263 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 63.0 (IC base=+0.069)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.194 (n=106)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0048 (IC base=+0.101)

- **PATRÓN** `drift_60min` |x|≤ `0.1384` → IC=+0.148 (n=140)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.1384 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.158 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 15.0 (IC base=+0.101)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.193 (n=317)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.5833 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` < `0.3753` → IC=+0.140 (n=259)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3753 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.515` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 7.515 (IC base=+0.101)

- **PATRÓN** `volumen_regimen` < `0.6972` → IC=+0.138 (n=139)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.6972 (IC base=+0.101)

- **PATRÓN** `volumen_regimen` > `1.1762` → IC=+0.130 (n=106)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 1.1762 (IC base=+0.101)

- **PATRÓN** `volumen_pendiente_norm` < `0.149` → IC=+0.152 (n=182)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` < 0.149 (IC base=+0.101)

- **PATRÓN** `volumen_spike_ratio` > `1.5536` → IC=+0.171 (n=153)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.5536 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `1233.0722` → IC=+0.157 (n=211)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1233.0722 (IC base=+0.101)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.01` → IC=+0.263 (n=137)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.01 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.0897` → IC=+0.188 (n=139)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0897 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.221 (n=138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3022` → IC=+0.263 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3022 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.825` → IC=+0.247 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.825 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `0.6067` → IC=+0.193 (n=138)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.6067 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.2398` → IC=+0.183 (n=137)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.2398 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2483` → IC=+0.254 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2483 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `2.907` → IC=+0.160 (n=363)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.907 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.6409` → IC=+0.172 (n=324)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.6409 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=438)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `2726.373` → IC=+0.167 (n=274)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2726.373 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.238 (n=139)
...
- **PATRÓN** `drift_60min` |x|≤ `0.399` → IC=+0.227 (n=459)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.399 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.265 (n=211)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` < `0.4645` → IC=+0.283 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4645 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `0.7203` → IC=+0.223 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7203 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.929` → IC=+0.250 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.929 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.8` → IC=+0.219 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.8 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.8813` → IC=+0.243 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8813 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` > `0.2419` → IC=+0.297 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2419 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.7712` → IC=+0.232 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7712 (IC base=+0.211)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.150 (n=315)

- **PATRÓN** `dist_vwap_pct` > `0.2184` → IC=+0.136 (n=86)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.2184 (IC base=+0.048)

- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.186 (n=218)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0044 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.2606` → IC=+0.177 (n=218)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2606 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.174 (n=90)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.678` → IC=+0.168 (n=248)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.678 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.4168` → IC=+0.152 (n=251)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4168 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.471` → IC=+0.143 (n=236)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 5.471 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `1.1687` → IC=+0.168 (n=218)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.1687 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` < `0.1476` → IC=+0.138 (n=241)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` < 0.1476 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `2.6912` → IC=+0.168 (n=245)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.6912 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=315)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `6531.4586` → IC=+0.188 (n=248)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 6531.4586 (IC base=+0.133)
...
- **PATRÓN** `py_entrada` > `0.495` → IC=+0.167 (n=49)
...
- **FILTRO** `ballena_activa_n` > `273.0` → IC=-0.167 (n=31)
...
- **FILTRO** `libro_liquidez` < `2162.4529` → IC=-0.250 (n=22)
...
- **PATRÓN** `libro_liquidez` > `2223.5408` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2223.5408 (IC base=+0.027)
...
- **FILTRO** `ibs_20min` > `0.942` → IC=-0.197 (n=31)
...
- **PATRÓN** `drift_20min_pct` |x|≤ `0.1191` → IC=+0.145 (n=74)

  - _Acción_: Kelly boost +0.72€ cuando `drift_20min_pct` |x|≤ 0.1191 (IC base=+0.061)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.45` → IC=-0.161 (n=364)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1113)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.254 (n=359)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1130)

- **FILTRO** `ibs_20min` > `0.2778` → IC=-0.238 (n=372)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2778
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1117)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.222 (n=52)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=162)

- **FILTRO** `ibs_20min` < `0.8306` → IC=-0.124 (n=107)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8306
  - _Potencial_: sin este filtro IC_bueno=+0.133 (n=107)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.161 (n=60)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=187)

- **FILTRO** `ibs_20min` > `0.1845` → IC=-0.180 (n=123)

  - _Acción_: SKIP cuando `ibs_20min` > 0.1845
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=124)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.128 (n=84)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.505 (IC base=+0.005)

- **PATRÓN** `libro_liquidez` > `1588.0048` → IC=+0.140 (n=73)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 1588.0048 (IC base=+0.005)

### MOMENTUM_IBS_15M_BALLENA#BTC#15min
- **FILTRO** `py_entrada` > `0.56` → IC=-0.341 (n=61)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=199)

- **FILTRO** `ibs_20min` > `0.2279` → IC=-0.288 (n=64)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2279
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=196)

- **FILTRO** `ballena_activa_n` > `87.0` → IC=-0.242 (n=64)

  - _Acción_: SKIP cuando `ballena_activa_n` > 87.0
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=196)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.150 (n=98)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.107 (n=120)

- **FILTRO** `ibs_20min` < `0.8656` → IC=-0.122 (n=109)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8656
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=109)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.250 (n=62)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=189)

- **FILTRO** `drift_20min_pct` |x|> `0.4129` → IC=-0.141 (n=62)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.4129
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=189)

- **FILTRO** `ibs_20min` > `0.2784` → IC=-0.213 (n=85)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2784
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=166)

- **PATRÓN** `ibs_20min` > `0.9506` → IC=+0.175 (n=75)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.9506 (IC base=-0.009)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` > `0.505` → IC=-0.189 (n=59)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=210)

- **FILTRO** `ballena_activa_n` > `3.0` → IC=-0.136 (n=86)

  - _Acción_: SKIP cuando `ballena_activa_n` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=183)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` > `0.6` → IC=-0.297 (n=57)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=173)

- **FILTRO** `drift_20min_pct` |x|> `0.293` → IC=-0.246 (n=57)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.293
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=173)

- **FILTRO** `ibs_20min` > `0.2222` → IC=-0.201 (n=75)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2222
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=155)

- **FILTRO** `ballena_activa_n` > `2.0` → IC=-0.222 (n=95)

  - _Acción_: SKIP cuando `ballena_activa_n` > 2.0
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=135)

- **PATRÓN** `ballena_activa_n` < `1.0` → IC=+0.121 (n=114)

  - _Acción_: Kelly boost +0.60€ cuando `ballena_activa_n` < 1.0 (IC base=+0.024)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.210 (n=60)
...
- **FILTRO** `hora_utc` > `12.0` → IC=-0.123 (n=112)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 12.0
...
- **FILTRO** `drift_20min_pct` |x|> `0.3579` → IC=-0.188 (n=78)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3579
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=154)

- **FILTRO** `ibs_20min` > `0.2917` → IC=-0.398 (n=57)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2917
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=175)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.130 (n=117)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` > 0.505 (IC base=+0.033)

- **PATRÓN** `libro_liquidez` > `2598.9726` → IC=+0.151 (n=64)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2598.9726 (IC base=+0.033)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=867)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2787)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.217 (n=913)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2741)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.167 (n=1239)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2415)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.219 (n=1073)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=3278)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.158 (n=1084)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3267)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.3` → IC=-0.309 (n=129)

  - _Acción_: SKIP cuando `py_entrada` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=389)

- **FILTRO** `ibs_7min` < `0.9422` → IC=-0.185 (n=341)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9422
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=177)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.219 (n=126)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=392)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.230 (n=194)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=486)

- **FILTRO** `drift_7min_pct` |x|> `0.1311` → IC=-0.188 (n=229)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1311
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=451)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.190 (n=169)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=511)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.249 (n=181)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=568)

- **FILTRO** `ballena_activa_n` > `95.0` → IC=-0.133 (n=254)

  - _Acción_: SKIP cuando `ballena_activa_n` > 95.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=495)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.179 (n=185)
...
- **FILTRO** `py_entrada` < `0.32` → IC=-0.340 (n=123)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=374)

- **FILTRO** `ibs_7min` < `0.2` → IC=-0.254 (n=124)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=373)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.272 (n=121)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=376)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.259 (n=168)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=584)

- **FILTRO** `ibs_7min` > `0.8413` → IC=-0.177 (n=187)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8413
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=565)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.231 (n=158)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=494)

- **FILTRO** `ibs_7min` < `0.788` → IC=-0.173 (n=163)

  - _Acción_: SKIP cuando `ibs_7min` < 0.788
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=489)

- **FILTRO** `ballena_activa_n` > `40.0` → IC=-0.183 (n=162)

  - _Acción_: SKIP cuando `ballena_activa_n` > 40.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=490)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.252 (n=155)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=487)

- **FILTRO** `ibs_7min` > `0.1692` → IC=-0.144 (n=217)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1692
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=425)

- **FILTRO** `ballena_activa_n` > `29.0` → IC=-0.192 (n=157)

  - _Acción_: SKIP cuando `ballena_activa_n` > 29.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=485)

- **FILTRO** `libro_liquidez` < `8652.1756` → IC=-0.135 (n=423)

  - _Acción_: SKIP cuando `libro_liquidez` < 8652.1756
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=219)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.189 (n=159)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=518)

- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.172 (n=169)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=508)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.207 (n=162)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=515)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.148 (n=271)

  - _Acción_: SKIP cuando `py_entrada` > 0.52
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=533)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.271 (n=138)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=423)

- **FILTRO** `ibs_7min` < `0.7479` → IC=-0.246 (n=140)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7479
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=421)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.232 (n=136)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=425)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.290 (n=179)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=539)

- **FILTRO** `drift_7min_pct` |x|> `0.138` → IC=-0.144 (n=358)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.138
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=360)

- **FILTRO** `ibs_7min` > `0.8584` → IC=-0.185 (n=179)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8584
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=539)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.146 (n=241)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=510)
...
- **PATRÓN** `delta_ratio` |x|> `0.3994` → IC=+0.141 (n=210)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.71€ cuando `delta_ratio` |x|> 0.3994 (IC base=+0.107)

- **PATRÓN** `total_vol_5m` < `381.605` → IC=+0.203 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 381.605 (IC base=+0.107)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.154 (n=53)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 4.0 (IC base=+0.003)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.143 (n=26)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 8.0 (IC base=+0.053)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.125 (n=54)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 15.0 (IC base=+0.024)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.122 (n=96)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 16.0 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `26.0` → IC=+0.130 (n=44)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 26.0 (IC base=+0.066)
...
### UPDOWN_GBM#5min
- **FILTRO** `divergencia_cvd_spot_perp` |x|> `0.2024` → IC=-0.167 (n=22)

  - _Acción_: SKIP cuando `divergencia_cvd_spot_perp` |x|> 0.2024
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=45)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `18.137` → IC=+0.155 (n=27)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 18.137 (IC base=+0.035)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.141 (n=126)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.03 (IC base=+0.035)
...
- **PATRÓN** `sigma_h` > `0.0027` → IC=+0.159 (n=39)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0027 (IC base=+0.149)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.676` → IC=+0.139 (n=70)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 8.676 (IC base=+0.045)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.167 (n=28)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0094 (IC base=+0.059)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1784` → IC=+0.167 (n=37)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.1784 (IC base=+0.059)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.049` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 14.049 (IC base=+0.059)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.03 (IC base=+0.059)
...
- **PATRÓN** `ibs_15` < `0.1667` → IC=+0.157 (n=100)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.78€ cuando `ibs_15` < 0.1667 (IC base=+0.032)
...
- **FILTRO** `sigma_h` > `0.0089` → IC=-0.184 (n=444)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0089
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1334)

- **FILTRO** `drift_15min` |x|> `0.7967` → IC=-0.132 (n=444)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.7967
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=1334)
...
- **FILTRO** `sigma_ewma_delta_pct` > `13.47` → IC=-0.204 (n=326)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 13.47
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1452)

- **PATRÓN** `ibs_15` > `0.3636` → IC=+0.146 (n=224)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.73€ cuando `ibs_15` > 0.3636 (IC base=-0.036)
...
- **FILTRO** `sigma_h` > `0.0064` → IC=-0.265 (n=100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0064
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=302)

- **FILTRO** `drift_15min` |x|> `0.7856` → IC=-0.216 (n=100)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.7856
  - _Potencial_: sin este filtro IC_bueno=-0.207 (n=302)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.240 (n=98)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.199 (n=304)

- **FILTRO** `sigma_ewma_delta_pct` > `20.323` → IC=-0.247 (n=85)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 20.323
  - _Potencial_: sin este filtro IC_bueno=-0.199 (n=317)
...
- **FILTRO** `sigma_h` > `0.0073` → IC=-0.244 (n=41)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0073
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=124)

- **FILTRO** `sigma_h` > `0.0078` → IC=-0.154 (n=212)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.373` → IC=+0.180 (n=23)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 10.373 (IC base=-0.045)
...
- **FILTRO** `hora_utc` > `6.0` → IC=-0.145 (n=119)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 6.0
  - _Potencial_: sin este filtro IC_bueno=+0.078 (n=62)

- **FILTRO** `libro_liquidez` < `2506.382` → IC=-0.181 (n=45)

  - _Acción_: SKIP cuando `libro_liquidez` < 2506.382
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=136)

- **FILTRO** `sigma_h` > `0.0085` → IC=-0.190 (n=195)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0085
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=381)

- **FILTRO** `drift_60min` |x|> `0.4892` → IC=-0.174 (n=142)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.4892
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=434)

- **FILTRO** `drift_15min` |x|> `0.8767` → IC=-0.162 (n=143)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.8767
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=433)

- **FILTRO** `sigma_ewma_delta_pct` > `14.673` → IC=-0.246 (n=69)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 14.673
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=507)

### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.385 (n=50)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0047 (IC base=+0.292)

- **PATRÓN** `drift_60min` |x|≤ `0.157` → IC=+0.307 (n=133)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.157 (IC base=+0.292)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1863` → IC=+0.343 (n=68)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1863 (IC base=+0.292)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3217` → IC=+0.396 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3217 (IC base=+0.292)
...
- **PATRÓN** `ibs_15` > `0.9701` → IC=+0.371 (n=68)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9701 (IC base=+0.292)

- **PATRÓN** `dist_vwap_pct` > `0.2663` → IC=+0.364 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2663 (IC base=+0.292)

- **PATRÓN** `dist_vwap_pct` < `0.0929` → IC=+0.319 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0929 (IC base=+0.292)

- **PATRÓN** `sigma_ewma_delta_pct` < `19.88` → IC=+0.306 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 19.88 (IC base=+0.292)

- **PATRÓN** `libro_liquidez` > `6470.4009` → IC=+0.304 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6470.4009 (IC base=+0.292)

- **PATRÓN** `ballena_activa_n` < `266.0` → IC=+0.360 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 266.0 (IC base=+0.292)

### UPDOWN_GBM_IBS_ALTO#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2` → IC=+0.278 (n=88)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.2 (IC base=+0.265)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.271 (n=59)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.265)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.281 (n=30)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0037 (IC base=+0.265)

- **PATRÓN** `drift_60min` |x|≤ `0.1826` → IC=+0.300 (n=88)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1826 (IC base=+0.265)

- **PATRÓN** `drift_15min` |x|≤ `0.6237` → IC=+0.287 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.6237 (IC base=+0.265)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0656` → IC=+0.278 (n=88)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0656 (IC base=+0.265)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.302 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.265)

- **PATRÓN** `ibs_15` > `0.9358` → IC=+0.336 (n=59)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9358 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` > `0.4105` → IC=+0.348 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4105 (IC base=+0.265)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `27.207` → IC=+0.300 (n=23)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 27.207 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.644` → IC=+0.276 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.644 (IC base=+0.265)

- **PATRÓN** `libro_liquidez` > `10634.3743` → IC=+0.286 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10634.3743 (IC base=+0.265)
...
- **H-SIGMA-ETH-60MIN**: `UPDOWN_GBM#ETH#60min` gana cuando sigma_h > 0.0094 (IC=+0.167 n=28). Implementar como filtro pre-predicción en shadow_predict.py.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1667 sube el IC de +0.032 a +0.157 en UPDOWN_GBM#XRP#15min (n=100). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.9701 sube el IC de +0.292 a +0.371 en UPDOWN_GBM_IBS_ALTO (n=68). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.9358 sube el IC de +0.265 a +0.336 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=59). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 535 | +0.066 | +41.60€ | 3 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 535 | +0.066 | +41.60€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 291 | +0.080 | +30.59€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 291 | +0.080 | +30.59€ | 1 | 9 |
...
| ✅ BALLENAS_TARDIAS | 4871 | -0.104 | -548.71€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 562 | -0.078 | -98.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 4309 | -0.107 | -449.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 603 | -0.117 | -81.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 603 | -0.117 | -81.99€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 562 | -0.078 | -98.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 562 | -0.078 | -98.81€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 