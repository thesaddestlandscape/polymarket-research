# Hipótesis automáticas — 2026-06-29 22:53 UTC
_Generado por shadow_postmortem.py sobre 1328 resoluciones (PNL=-41.91€)_
...
| ✅ UPDOWN_GBM#BTC | 114 | +0.017 | -0.81€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 138 | +0.036 | +2.18€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.042) — sin ventaja clara. oversold(IBS<0.3): IC=+0.000 n=18 | neutral: IC=+0.042 n=22 | overbought(IBS>0.7): IC=+0.033 n=28
  - _Datos_: n=70 IC=+0.028 PNL=-1.60€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 70 ops, 12 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 359/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=260 IC=+0.023 PNL=+5.17€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=260 IC=+0.023 PNL=+5.17€
