# Hipótesis automáticas — 2026-06-29 19:59 UTC
_Generado por shadow_postmortem.py sobre 1309 resoluciones (PNL=-33.24€)_
...
| ✅ UPDOWN_GBM#BTC | 105 | +0.023 | +0.92€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.108) — sin ventaja clara. oversold(IBS<0.3): IC=+0.044 n=14 | neutral: IC=+0.152 n=13 | overbought(IBS>0.7): IC=+0.083 n=22
  - _Datos_: n=51 IC=+0.123 PNL=+7.07€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 51 ops, 9 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=241 IC=+0.043 PNL=+13.84€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=241 IC=+0.043 PNL=+13.84€
