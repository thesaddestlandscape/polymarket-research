# Hipótesis automáticas — 2026-08-21 15:31 UTC
_Generado por shadow_postmortem.py sobre 102735 resoluciones (PNL=+8561.84€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `156.33` → IC=-0.262 (n=1444)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.33
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4332)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.150 (n=361)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=208)

- **FILTRO** `restante_s_al_confirmar` < `131.73` → IC=-0.326 (n=142)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 131.73
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=427)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` > `639.83` → IC=-0.241 (n=137)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` > 639.83
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=412)

- **FILTRO** `restante_s_al_confirmar` < `390.04` → IC=-0.255 (n=137)
...
- **FILTRO** `restante_s_al_confirmar` < `86.19` → IC=-0.446 (n=166)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=498)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `140.27` → IC=-0.248 (n=340)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.27
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1023)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `147.91` → IC=-0.336 (n=284)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.91
  - _Potencial_: sin este filtro IC_bueno=-0.139 (n=854)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.191 (n=3505)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=1295)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2373.8543` → IC=+0.170 (n=1248)
...
- **PATRÓN** `py_entrada` < `0.335` → IC=+0.265 (n=2022)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.184 (n=2291)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `4247.3024` → IC=+0.171 (n=954)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 4247.3024 (IC base=+0.133)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=451)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` > `0.785` → IC=+0.379 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.785 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.185)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.294 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.187 (n=554)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.01 (IC base=+0.185)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.151 (n=442)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.164 (n=385)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 15.0 (IC base=+0.138)

- **PATRÓN** `py_entrada` > `0.6` → IC=+0.185 (n=195)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.6 (IC base=+0.138)
...
- **PATRÓN** `py_entrada` < `0.395` → IC=+0.207 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.395 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `4631.2079` → IC=+0.158 (n=252)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 4631.2079 (IC base=+0.137)

### FAVORITO_CONFIRMADO#ETH#15min
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.147 (n=568)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 11.0 (IC base=+0.124)

- **PATRÓN** `py_entrada` > `0.7` → IC=+0.306 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.7 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.298 (n=330)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.288)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.295 (n=330)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2483.5698` → IC=+0.310 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2483.5698 (IC base=+0.288)
...
- **PATRÓN** `libro_liquidez` > `4420.281` → IC=+0.160 (n=139)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 4420.281 (IC base=+0.086)
...
- **PATRÓN** `py_entrada` > `0.835` → IC=+0.429 (n=222)
...
- **PATRÓN** `py_entrada` < `0.215` → IC=+0.371 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.215 (IC base=+0.213)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.233 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `739.7806` → IC=+0.239 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 739.7806 (IC base=+0.213)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.120 (n=380)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 7.0 (IC base=+0.104)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.158 (n=261)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.02 (IC base=+0.104)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.188 (n=3306)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 5.0 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.193 (n=2922)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 15.0 (IC base=+0.187)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.202 (n=1060)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.187)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.166 (n=555)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.187 (n=831)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=845)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.176 (n=369)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 7.0 (IC base=+0.161)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.184 (n=286)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` < 0.7 (IC base=+0.161)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.165 (n=467)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.73 (IC base=+0.161)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=751)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.224)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.231 (n=660)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.191 (n=821)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` < 0.74 (IC base=+0.189)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=658)
...
- **PATRÓN** `libro_liquidez` > `3939.3842` → IC=+0.449 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3939.3842 (IC base=+0.428)
...
- **PATRÓN** `py_entrada` > `0.92` → IC=+0.421 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.92 (IC base=+0.424)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.199 (n=7081)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.227 (n=5177)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.160 (n=941)

  - _Acción_: Kelly boost +0.80€ cuando `py_entrada` > 0.71 (IC base=+0.116)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.266 (n=507)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.241)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.286 (n=559)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.241)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.160 (n=580)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.240 (n=1023)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.239)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.274 (n=565)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.239 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.201)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.206 (n=919)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.131)

- **PATRÓN** `restante_min` < `3.86` → IC=+0.160 (n=843)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` < 3.86 (IC base=+0.131)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.151 (n=903)

  - _Acción_: Kelly boost +0.75€ cuando `restante_min` > 4.91 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.149 (n=1144)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 7.0 (IC base=+0.131)

- **PATRÓN** `lag_apertura_s` < `5.26` → IC=+0.153 (n=840)

  - _Acción_: Kelly boost +0.77€ cuando `lag_apertura_s` < 5.26 (IC base=+0.131)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.227 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.37 (IC base=+0.145)

- **PATRÓN** `restante_min` < `3.75` → IC=+0.183 (n=418)

  - _Acción_: Kelly boost +0.92€ cuando `restante_min` < 3.75 (IC base=+0.145)

- **PATRÓN** `restante_min` > `4.89` → IC=+0.162 (n=427)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` > 4.89 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=421)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.145)

- **PATRÓN** `lag_apertura_s` < `6.78` → IC=+0.166 (n=417)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 6.78 (IC base=+0.145)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.184 (n=464)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` < 0.37 (IC base=+0.117)

- **PATRÓN** `restante_min` < `3.95` → IC=+0.137 (n=430)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 3.95 (IC base=+0.117)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.161 (n=428)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.95 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.131 (n=859)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 11.0 (IC base=+0.117)

- **PATRÓN** `lag_apertura_s` < `3.28` → IC=+0.161 (n=423)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 3.28 (IC base=+0.117)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.315 (n=496)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.304)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.315 (n=430)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.330 (n=151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.301)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.315 (n=225)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1927.8155` → IC=+0.312 (n=195)
...
- **PATRÓN** `py_entrada` > `0.865` → IC=+0.412 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.865 (IC base=+0.272)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.285 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.272)

- **PATRÓN** `libro_liquidez` > `756.4293` → IC=+0.282 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 756.4293 (IC base=+0.272)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.126 (n=560)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 6.0 (IC base=+0.091)

- **PATRÓN** `ibs_20min` > `0.9742` → IC=+0.263 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9742 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.2288` → IC=+0.240 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2288 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` < `0.9628` → IC=+0.237 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9628 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.929` → IC=+0.218 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.929 (IC base=+0.091)

- **PATRÓN** `volumen_regimen` < `0.7174` → IC=+0.229 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7174 (IC base=+0.091)

- **PATRÓN** `volumen_regimen` > `1.1094` → IC=+0.252 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1094 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` < `0.0803` → IC=+0.123 (n=777)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` < 0.0803 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` > `0.3182` → IC=+0.153 (n=119)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.3182 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` < `3.2018` → IC=+0.122 (n=863)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 3.2018 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` > `1.5017` → IC=+0.131 (n=863)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.5017 (IC base=+0.091)

- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.134 (n=1743)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.4 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` < `0.1271` → IC=+0.145 (n=581)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1271 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` < `0.6267` → IC=+0.136 (n=196)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.6267 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` > `1.2618` → IC=+0.140 (n=195)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.2618 (IC base=+0.048)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6699` → IC=+0.221 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6699 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `2.6218` → IC=+0.216 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6218 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.255 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 136.0 (IC base=+0.048)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.272 (n=191)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.0764` → IC=+0.273 (n=64)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0764 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.267 (n=195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.234)

- **PATRÓN** `ibs_20min` > `0.488` → IC=+0.251 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.488 (IC base=+0.234)

- **PATRÓN** `dist_vwap_pct` > `0.1697` → IC=+0.248 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1697 (IC base=+0.234)

- **PATRÓN** `dist_vwap_pct` < `1.1007` → IC=+0.247 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.1007 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.507` → IC=+0.315 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.507 (IC base=+0.234)

- **PATRÓN** `volumen_regimen` < `0.7407` → IC=+0.244 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7407 (IC base=+0.234)

- **PATRÓN** `volumen_regimen` > `1.1466` → IC=+0.253 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1466 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.083` → IC=+0.258 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.083 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.2936` → IC=+0.278 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2936 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` < `1.4783` → IC=+0.276 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4783 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `1.696` → IC=+0.243 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.696 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `11800.2375` → IC=+0.275 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11800.2375 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `289.0` → IC=+0.255 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 289.0 (IC base=+0.234)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.176 (n=140)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0022 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.2337` → IC=+0.152 (n=280)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.2337 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.142 (n=294)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 8.0 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.138 (n=329)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 18.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` < `0.5454` → IC=+0.166 (n=318)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.5454 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.1704` → IC=+0.167 (n=289)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1704 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.047` → IC=+0.243 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.047 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `0.6237` → IC=+0.148 (n=106)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6237 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` > `1.256` → IC=+0.157 (n=106)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.256 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.1153` → IC=+0.247 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1153 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `1.5762` → IC=+0.201 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5762 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `13637.201` → IC=+0.167 (n=106)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 13637.201 (IC base=+0.133)

- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.202 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 249.0 (IC base=+0.133)
...
- **FILTRO** `ibs_20min` > `0.8848` → IC=-0.187 (n=145)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.873` → IC=+0.167 (n=43)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.873 (IC base=+0.000)

### GBM_LATE_15M#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `2.933` → IC=-0.131 (n=293)
...
- **FILTRO** `ibs_20min` > `0.6119` → IC=-0.125 (n=299)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6119
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=582)

- **FILTRO** `sigma_ewma_delta_pct` > `8.08` → IC=-0.170 (n=104)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.08
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=777)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.729` → IC=+0.131 (n=82)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 6.729 (IC base=-0.037)

- **PATRÓN** `volumen_regimen` < `0.7885` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.7885 (IC base=-0.037)
...
- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.250 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.3163` → IC=+0.249 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3163 (IC base=+0.052)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.305` → IC=+0.128 (n=1178)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 2.305 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.1814` → IC=+0.175 (n=198)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.1814 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.3248` → IC=+0.218 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3248 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` > `3.2314` → IC=+0.171 (n=281)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 3.2314 (IC base=+0.052)

- **PATRÓN** `ballena_activa_n` < `86.0` → IC=+0.285 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 86.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.1077` → IC=+0.165 (n=965)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.1077 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` > `0.6347` → IC=+0.207 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6347 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` < `0.2753` → IC=+0.180 (n=566)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2753 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` > `0.6268` → IC=+0.189 (n=554)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.6268 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` > `0.2628` → IC=+0.351 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2628 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` > `3.1581` → IC=+0.300 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1581 (IC base=+0.039)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.235 (n=202)
...
- **FILTRO** `ibs_20min` < `0.0856` → IC=-0.172 (n=120)
...
- **PATRÓN** `volumen_regimen` < `0.5607` → IC=+0.140 (n=23)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.5607 (IC base=-0.030)

- **PATRÓN** `volumen_regimen` > `1.1074` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1074 (IC base=-0.030)
...
- **FILTRO** `drift_60min` |x|> `0.1641` → IC=-0.147 (n=151)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.1641
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.141 (n=51)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=786)
...
- **PATRÓN** `ibs_20min` > `0.7778` → IC=+0.237 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7778 (IC base=-0.008)

- **PATRÓN** `dist_vwap_pct` > `0.1775` → IC=+0.208 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1775 (IC base=-0.008)

- **PATRÓN** `volumen_regimen` > `1.1259` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.1259 (IC base=-0.008)

- **PATRÓN** `volumen_pendiente_norm` > `0.2556` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2556 (IC base=-0.008)

- **PATRÓN** `volumen_spike_ratio` > `1.7975` → IC=+0.127 (n=57)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.7975 (IC base=-0.008)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 62.0 (IC base=-0.008)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.360 (n=127)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0089 (IC base=+0.184)
...
- **PATRÓN** `ibs_20min` > `0.913` → IC=+0.262 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.913 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` > `0.6964` → IC=+0.332 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6964 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.12` → IC=+0.260 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.12 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` > `0.8332` → IC=+0.219 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8332 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.1841` → IC=+0.273 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1841 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `1.9845` → IC=+0.208 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9845 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `2694.456` → IC=+0.215 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2694.456 (IC base=+0.184)

- **PATRÓN** `ballena_activa_n` < `41.0` → IC=+0.365 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 41.0 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.272 (n=345)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.259)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.261 (n=391)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.3797` → IC=+0.271 (n=391)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3797 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.319 (n=197)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.2727` → IC=+0.338 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2727 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` > `0.5126` → IC=+0.263 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5126 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` < `0.6981` → IC=+0.262 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6981 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.479` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.479 (IC base=+0.259)

- **PATRÓN** `volumen_regimen` > `1.0818` → IC=+0.300 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0818 (IC base=+0.259)

- **PATRÓN** `volumen_pendiente_norm` > `0.2444` → IC=+0.363 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2444 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `2.8473` → IC=+0.281 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8473 (IC base=+0.259)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.204 (n=764)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.163 (n=791)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9107` → IC=+0.258 (n=1115)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9107 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.78` → IC=+0.244 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.78 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.335` → IC=+0.290 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.335 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `0.6353` → IC=+0.165 (n=1025)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.6353 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1052` → IC=+0.183 (n=585)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1052 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `1.9769` → IC=+0.142 (n=955)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.9769 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.4889` → IC=+0.143 (n=1432)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.4889 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.166 (n=1730)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.04 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `3257.5082` → IC=+0.204 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3257.5082 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.207 (n=1477)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0069 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.2469` → IC=+0.205 (n=1299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2469 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.239 (n=750)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` < `0.3902` → IC=+0.257 (n=1477)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3902 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` < `0.4326` → IC=+0.177 (n=1329)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.4326 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.609` → IC=+0.211 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.609 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.277` → IC=+0.194 (n=1483)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 5.277 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` < `1.195` → IC=+0.167 (n=1177)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.195 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` > `0.6777` → IC=+0.174 (n=1051)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6777 (IC base=+0.192)

- **PATRÓN** `volumen_pendiente_norm` > `0.2511` → IC=+0.237 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2511 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` < `1.6205` → IC=+0.190 (n=385)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.6205 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `2.8787` → IC=+0.220 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8787 (IC base=+0.192)

- **PATRÓN** `ballena_activa_n` < `115.0` → IC=+0.180 (n=383)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 115.0 (IC base=+0.192)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.235 (n=66)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0035` → IC=+0.220 (n=130)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0035 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.243 (n=200)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.5283` → IC=+0.246 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5283 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.2322` → IC=+0.260 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2322 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.145` → IC=+0.313 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.145 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.9281` → IC=+0.250 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9281 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2969` → IC=+0.300 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2969 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `1.4441` → IC=+0.259 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4441 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `2.6612` → IC=+0.219 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6612 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `11104.1249` → IC=+0.250 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11104.1249 (IC base=+0.201)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.193 (n=285)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.004 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.2038` → IC=+0.207 (n=251)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2038 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.204 (n=204)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` < `0.3342` → IC=+0.221 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3342 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.1334` → IC=+0.196 (n=291)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.1334 (IC base=+0.167)
...
- **PATRÓN** `volumen_regimen` < `0.627` → IC=+0.232 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.627 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.0721` → IC=+0.225 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0721 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.808` → IC=+0.227 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.808 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `13319.6098` → IC=+0.170 (n=95)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 13319.6098 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `211.0` → IC=+0.219 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 211.0 (IC base=+0.167)
...
- **PATRÓN** `sigma_h` < `0.0087` → IC=+0.253 (n=180)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0087 (IC base=+0.222)

- **PATRÓN** `drift_60min` |x|≤ `0.0871` → IC=+0.306 (n=60)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0871 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.234 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.222)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.222 (n=124)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.222)

- **PATRÓN** `ibs_20min` > `0.4752` → IC=+0.287 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4752 (IC base=+0.222)

- **PATRÓN** `dist_vwap_pct` > `0.1741` → IC=+0.241 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1741 (IC base=+0.222)

- **PATRÓN** `dist_vwap_pct` < `0.3391` → IC=+0.244 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3391 (IC base=+0.222)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.711` → IC=+0.405 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.711 (IC base=+0.222)

- **PATRÓN** `volumen_regimen` > `0.6433` → IC=+0.247 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6433 (IC base=+0.222)

- **PATRÓN** `volumen_pendiente_norm` > `0.1034` → IC=+0.295 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1034 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` < `1.467` → IC=+0.229 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.467 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `2.6068` → IC=+0.263 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6068 (IC base=+0.222)

- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.209 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 221.0 (IC base=+0.222)

- **PATRÓN** `sigma_h` < `0.005` → IC=+0.204 (n=282)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.005 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.3139` → IC=+0.172 (n=282)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3139 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.166 (n=288)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.152 (n=294)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 18.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.4404` → IC=+0.222 (n=282)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4404 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.3707` → IC=+0.171 (n=326)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3707 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.607` → IC=+0.278 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.607 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.1858` → IC=+0.176 (n=282)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 1.1858 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.6086` → IC=+0.155 (n=282)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6086 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` < `0.1688` → IC=+0.134 (n=181)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1688 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2357` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.2357 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.8878` → IC=+0.186 (n=119)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.8878 (IC base=+0.150)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **FILTRO** `ibs_20min` > `0.5` → IC=-0.242 (n=91)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.208 (n=296)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.199 (n=141)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.139 (n=117)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 17.0 (IC base=+0.091)

- **PATRÓN** `ibs_20min` > `0.8621` → IC=+0.213 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8621 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.6962` → IC=+0.250 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6962 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.517` → IC=+0.240 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.517 (IC base=+0.091)

- **PATRÓN** `libro_liquidez` > `2684.3254` → IC=+0.169 (n=140)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2684.3254 (IC base=+0.091)

- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.226 (n=100)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0046 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.218 (n=133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.208 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.987` → IC=+0.182 (n=42)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 6.987 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `0.8469` → IC=+0.138 (n=194)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.8469 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.0973` → IC=+0.167 (n=76)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0973 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `2.4486` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.4486 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `2374.302` → IC=+0.187 (n=132)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2374.302 (IC base=+0.102)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 32.0 (IC base=+0.102)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.246 (n=230)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0066 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.1297` → IC=+0.154 (n=151)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1297 (IC base=+0.154)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.167 (n=136)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 6.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.244 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.2985` → IC=+0.216 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2985 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.341` → IC=+0.238 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.341 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `1.2315` → IC=+0.158 (n=343)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.2315 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `0.8419` → IC=+0.162 (n=229)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.8419 (IC base=+0.154)
...
- **PATRÓN** `volumen_spike_ratio` < `2.68` → IC=+0.170 (n=307)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.68 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.9238` → IC=+0.157 (n=205)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.9238 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=364)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `2464.9154` → IC=+0.167 (n=343)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2464.9154 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.257 (n=282)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.230)
...
- **PATRÓN** `ibs_20min` < `0.1087` → IC=+0.338 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1087 (IC base=+0.230)

- **PATRÓN** `dist_vwap_pct` < `0.1301` → IC=+0.238 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1301 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.735` → IC=+0.254 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.735 (IC base=+0.230)

- **PATRÓN** `volumen_regimen` > `0.6867` → IC=+0.265 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6867 (IC base=+0.230)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.343 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` > `3.0859` → IC=+0.291 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0859 (IC base=+0.230)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.154 (n=105)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 40.0 (IC base=+0.230)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.219 (n=638)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0075 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.159 (n=940)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9601` → IC=+0.286 (n=866)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9601 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.7097` → IC=+0.230 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7097 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.046` → IC=+0.264 (n=868)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.046 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.7107` → IC=+0.149 (n=523)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7107 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.0974` → IC=+0.143 (n=539)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.0974 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2443` → IC=+0.168 (n=329)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.2443 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.9089` → IC=+0.130 (n=1601)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 2.9089 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.9827` → IC=+0.146 (n=1067)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.9827 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.147 (n=1937)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.04 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `2747.518` → IC=+0.182 (n=866)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 2747.518 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.205 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 162.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.214 (n=1744)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0076 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.3406` → IC=+0.202 (n=1744)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3406 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.215 (n=636)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` < `0.5364` → IC=+0.256 (n=1745)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5364 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` < `0.7008` → IC=+0.178 (n=1387)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.7008 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.137` → IC=+0.225 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.137 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.516` → IC=+0.196 (n=1634)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 2.516 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` < `0.6093` → IC=+0.178 (n=421)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6093 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` > `1.2037` → IC=+0.186 (n=421)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.2037 (IC base=+0.192)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.242 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `2.7615` → IC=+0.205 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7615 (IC base=+0.192)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.128 (n=415)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 56.0 (IC base=+0.192)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.171 (n=83)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0022 (IC base=+0.154)

- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.175 (n=164)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0033 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.3308` → IC=+0.234 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3308 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.2058` → IC=+0.244 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2058 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.777` → IC=+0.265 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.777 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `0.6694` → IC=+0.182 (n=83)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6694 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `0.9223` → IC=+0.175 (n=164)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.9223 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` < `0.0752` → IC=+0.191 (n=176)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.0752 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1503` → IC=+0.189 (n=59)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1503 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.6653` → IC=+0.211 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.6653 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.3679` → IC=+0.202 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3679 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `9645.5725` → IC=+0.223 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9645.5725 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `497.0` → IC=+0.206 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 497.0 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.200 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.3094` → IC=+0.173 (n=313)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3094 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.166 (n=312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 6.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.166 (n=324)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 18.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` < `0.4925` → IC=+0.208 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4925 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` < `0.2683` → IC=+0.190 (n=308)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.2683 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.611` → IC=+0.244 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.611 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` < `0.6202` → IC=+0.210 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6202 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `0.8413` → IC=+0.176 (n=208)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8413 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.166` → IC=+0.300 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.166 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.233 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `12242.4641` → IC=+0.179 (n=104)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 12242.4641 (IC base=+0.160)

- **PATRÓN** `ballena_activa_n` < `326.0` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 326.0 (IC base=+0.160)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.155 (n=82)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0022 (IC base=+0.141)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.175 (n=81)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0069 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.0729` → IC=+0.167 (n=82)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0729 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=115)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.140 (n=87)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 6.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.3782` → IC=+0.218 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3782 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.2599` → IC=+0.201 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2599 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.544` → IC=+0.204 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.544 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.7415` → IC=+0.197 (n=107)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.7415 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.1336` → IC=+0.146 (n=111)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.1336 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.2719` → IC=+0.329 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2719 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4306` → IC=+0.229 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4306 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `3660.0242` → IC=+0.220 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3660.0242 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `233.0` → IC=+0.244 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 233.0 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.256 (n=88)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.126)

- **PATRÓN** `drift_60min` |x|≤ `0.3699` → IC=+0.152 (n=199)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.3699 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.130 (n=179)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.2448` → IC=+0.226 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2448 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` > `0.1368` → IC=+0.134 (n=110)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.1368 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.5983` → IC=+0.151 (n=210)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.5983 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.785` → IC=+0.262 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.785 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `0.5375` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.5375 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` < `0.0653` → IC=+0.176 (n=143)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` < 0.0653 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.2546` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2546 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` < `2.1206` → IC=+0.177 (n=128)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.1206 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.4473` → IC=+0.180 (n=145)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4473 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `8615.3423` → IC=+0.134 (n=91)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8615.3423 (IC base=+0.126)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.191 (n=53)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 136.0 (IC base=+0.126)

### GBM_LATE_15M_TARDIO#SOL#15min
- **FILTRO** `ibs_20min` > `0.5909` → IC=-0.186 (n=100)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5909
  - _Potencial_: sin este filtro IC_bueno=+0.197 (n=308)

- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.176 (n=100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0073 (IC base=+0.058)

- **PATRÓN** `ibs_20min` > `0.9375` → IC=+0.239 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9375 (IC base=+0.058)

- **PATRÓN** `dist_vwap_pct` > `0.6434` → IC=+0.193 (n=73)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.6434 (IC base=+0.058)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.935` → IC=+0.256 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.935 (IC base=+0.058)

- **PATRÓN** `libro_liquidez` > `2577.6856` → IC=+0.186 (n=100)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2577.6856 (IC base=+0.058)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.235 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 64.0 (IC base=+0.058)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.151 (n=270)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0072 (IC base=+0.102)

- **PATRÓN** `drift_60min` |x|≤ `0.1356` → IC=+0.150 (n=135)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1356 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.169 (n=140)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5909` → IC=+0.197 (n=308)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.5909 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.3583` → IC=+0.142 (n=255)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3583 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.476` → IC=+0.175 (n=38)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 7.476 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `0.6969` → IC=+0.135 (n=135)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.6969 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.0639` → IC=+0.124 (n=139)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 1.0639 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` < `0.1535` → IC=+0.159 (n=171)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.1535 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.5617` → IC=+0.185 (n=144)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.5617 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `1208.3226` → IC=+0.150 (n=204)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 1208.3226 (IC base=+0.102)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.257 (n=134)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0094 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.0889` → IC=+0.191 (n=134)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.0889 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=150)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 17.0 (IC base=+0.158)
...
- **PATRÓN** `dist_vwap_pct` > `0.2838` → IC=+0.253 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2838 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.839` → IC=+0.248 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.839 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `0.5999` → IC=+0.184 (n=134)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.5999 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` > `1.0463` → IC=+0.169 (n=182)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0463 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.2483` → IC=+0.254 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2483 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` > `1.6588` → IC=+0.168 (n=314)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.6588 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=423)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `3108.1723` → IC=+0.176 (n=134)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3108.1723 (IC base=+0.158)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.235 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.158)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.293 (n=298)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.3903` → IC=+0.232 (n=446)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3903 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.273 (n=223)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` < `0.4643` → IC=+0.286 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4643 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.6747` → IC=+0.225 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6747 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.929` → IC=+0.250 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.929 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.873` → IC=+0.223 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.873 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.8799` → IC=+0.246 (n=297)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7637` → IC=+0.242 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7637 (IC base=+0.213)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.153 (n=312)

- **PATRÓN** `dist_vwap_pct` > `0.2834` → IC=+0.149 (n=75)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.2834 (IC base=+0.047)

- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.213 (n=165)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0033 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.2471` → IC=+0.179 (n=216)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2471 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.185 (n=87)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.196 (n=100)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 4.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.678` → IC=+0.169 (n=246)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.678 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.4079` → IC=+0.152 (n=251)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4079 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.471` → IC=+0.144 (n=234)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 5.471 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.1687` → IC=+0.170 (n=216)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.1687 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` < `0.0956` → IC=+0.144 (n=209)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.0956 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `2.698` → IC=+0.169 (n=243)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.698 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4126` → IC=+0.137 (n=243)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4126 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=312)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `6608.3768` → IC=+0.194 (n=246)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 6608.3768 (IC base=+0.135)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.133 (n=28)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=110)

- **FILTRO** `ballena_activa_n` > `270.0` → IC=-0.190 (n=27)

  - _Acción_: SKIP cuando `ballena_activa_n` > 270.0
...
- **PATRÓN** `liq_imbalance_15min` |x|> `1.0` → IC=+0.129 (n=33)

  - _Acción_: Kelly boost +0.64€ cuando `liq_imbalance_15min` |x|> 1.0 (IC base=+0.029)
...
- **FILTRO** `libro_liquidez` < `2155.7963` → IC=-0.273 (n=20)
...
- **PATRÓN** `libro_liquidez` > `2155.7963` → IC=+0.141 (n=62)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 2155.7963 (IC base=+0.036)
...
- **FILTRO** `ibs_20min` > `0.9506` → IC=-0.233 (n=28)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.163 (n=333)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1005)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.240 (n=341)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1047)

- **FILTRO** `ibs_20min` > `0.2738` → IC=-0.227 (n=346)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2738
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1042)
...
- **FILTRO** `ibs_20min` < `0.8306` → IC=-0.140 (n=98)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8306
  - _Potencial_: sin este filtro IC_bueno=+0.144 (n=99)

- **FILTRO** `ibs_20min` > `0.1842` → IC=-0.175 (n=115)

  - _Acción_: SKIP cuando `ibs_20min` > 0.1842
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=116)

### MOMENTUM_IBS_15M_BALLENA#BTC#15min
- **FILTRO** `py_entrada` > `0.56` → IC=-0.347 (n=57)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=186)

- **FILTRO** `ibs_20min` > `0.2282` → IC=-0.320 (n=59)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2282
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=184)

- **FILTRO** `ballena_activa_n` > `87.0` → IC=-0.242 (n=60)

  - _Acción_: SKIP cuando `ballena_activa_n` > 87.0
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=183)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.148 (n=89)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=111)

- **FILTRO** `ibs_20min` < `0.8627` → IC=-0.137 (n=100)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8627
  - _Potencial_: sin este filtro IC_bueno=+0.098 (n=100)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.246 (n=57)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=177)

- **FILTRO** `ibs_20min` > `0.1803` → IC=-0.161 (n=116)

  - _Acción_: SKIP cuando `ibs_20min` > 0.1803
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=118)

- **PATRÓN** `ibs_20min` > `0.9507` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.9507 (IC base=-0.020)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` > `0.505` → IC=-0.196 (n=54)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=195)

- **FILTRO** `ballena_activa_n` > `3.0` → IC=-0.134 (n=80)
...
- **FILTRO** `py_entrada` > `0.65` → IC=-0.316 (n=47)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=167)

- **FILTRO** `drift_20min_pct` |x|> `0.2905` → IC=-0.176 (n=72)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.2905
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=142)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.336 (n=53)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=161)

- **PATRÓN** `libro_liquidez` > `2471.6906` → IC=+0.130 (n=79)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2471.6906 (IC base=+0.026)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=940)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2424)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.267 (n=836)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=2528)

- **FILTRO** `ibs_7min` < `0.7347` → IC=-0.212 (n=841)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7347
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2523)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.170 (n=1116)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=2248)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.223 (n=988)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=3076)

- **FILTRO** `ibs_7min` > `0.7066` → IC=-0.158 (n=1015)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7066
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3049)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.3` → IC=-0.312 (n=115)

  - _Acción_: SKIP cuando `py_entrada` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=361)

- **FILTRO** `ibs_7min` < `0.9422` → IC=-0.180 (n=314)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9422
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=162)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.213 (n=113)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=363)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.223 (n=182)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=445)

- **FILTRO** `drift_7min_pct` |x|> `0.1303` → IC=-0.184 (n=213)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1303
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=414)

- **FILTRO** `ibs_7min` > `0.8222` → IC=-0.183 (n=156)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8222
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=471)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.146 (n=156)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=471)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.241 (n=172)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=525)

- **FILTRO** `ballena_activa_n` > `89.0` → IC=-0.135 (n=236)

  - _Acción_: SKIP cuando `ballena_activa_n` > 89.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=461)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.169 (n=179)
...
- **PATRÓN** `delta_ratio` |x|> `0.3994` → IC=+0.143 (n=208)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.71€ cuando `delta_ratio` |x|> 0.3994 (IC base=+0.108)

- **PATRÓN** `total_vol_5m` < `381.605` → IC=+0.203 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 381.605 (IC base=+0.108)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.130 (n=52)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 14.0 (IC base=+0.025)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.132 (n=36)

  - _Acción_: Kelly boost +0.66€ cuando `py_entrada` < 0.495 (IC base=+0.025)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.127 (n=57)
  ...
  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.505 (IC base=+0.067)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.122 (n=96)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 16.0 (IC base=+0.076)

- **PATRÓN** `ballena_activa_n` < `23.0` → IC=+0.151 (n=41)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 23.0 (IC base=+0.076)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=892)
...
- **FILTRO** `ibs_15` < `0.313` → IC=-0.237 (n=17)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.313
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.676` → IC=+0.123 (n=67)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 8.676 (IC base=+0.045)
...
- **PATRÓN** `ibs_15` < `0.1579` → IC=+0.170 (n=95)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.85€ cuando `ibs_15` < 0.1579 (IC base=+0.033)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2` → IC=+0.272 (n=90)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.2 (IC base=+0.274)

- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.287 (n=45)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0023 (IC base=+0.274)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0603` → IC=+0.306 (n=34)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0603 (IC base=+0.274)

- **PATRÓN** `drift_15min` |x|≤ `0.4139` → IC=+0.287 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4139 (IC base=+0.274)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1381` → IC=+0.286 (n=68)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1381 (IC base=+0.274)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.290 (n=103)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.274)

- **PATRÓN** `ibs_15` > `0.7117` → IC=+0.337 (n=102)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7117 (IC base=+0.274)

- **PATRÓN** `dist_vwap_pct` > `0.3696` → IC=+0.397 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3696 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` > `18.976` → IC=+0.316 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.976 (IC base=+0.274)

- **PATRÓN** `libro_liquidez` > `2812.5928` → IC=+0.298 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2812.5928 (IC base=+0.274)
...
- **FILTRO** `ibs_15` < `0.3587` → IC=-0.327 (n=73)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.149 (n=220)

- **FILTRO** `sigma_h` > `0.0086` → IC=-0.183 (n=430)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0086
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=1291)
...
- **FILTRO** `sigma_ewma_delta_pct` > `13.46` → IC=-0.203 (n=315)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 13.46
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=1406)

- **PATRÓN** `ibs_15` > `0.3587` → IC=+0.149 (n=220)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.74€ cuando `ibs_15` > 0.3587 (IC base=-0.034)

- **PATRÓN** `ibs_15` < `0.531` → IC=+0.278 (n=52)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.531 (IC base=-0.093)

- **PATRÓN** `dist_vwap_pct` < `0.1453` → IC=+0.173 (n=50)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1453 (IC base=-0.093)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0059` → IC=-0.245 (n=96)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0059
  - _Potencial_: sin este filtro IC_bueno=-0.194 (n=289)

- **FILTRO** `drift_15min` |x|> `0.7467` → IC=-0.214 (n=96)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.7467
  - _Potencial_: sin este filtro IC_bueno=-0.204 (n=289)

- **FILTRO** `sigma_ewma_delta_pct` > `20.745` → IC=-0.238 (n=82)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 20.745
  - _Potencial_: sin este filtro IC_bueno=-0.198 (n=303)

- **FILTRO** `libro_liquidez` < `12365.3454` → IC=-0.216 (n=192)

  - _Acción_: SKIP cuando `libro_liquidez` < 12365.3454
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=193)

### UPDOWN_GBM_15M_TARDIO#ETH#15min
- **FILTRO** `ibs_15` < `0.6189` → IC=-0.318 (n=53)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.6189
  - _Potencial_: sin este filtro IC_bueno=+0.250 (n=54)

- **PATRÓN** `ibs_15` > `0.6189` → IC=+0.250 (n=54)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6189 (IC base=-0.032)
...
- **FILTRO** `sigma_h` > `0.0071` → IC=-0.238 (n=40)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0071
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=122)

- **FILTRO** `sigma_h` > `0.0077` → IC=-0.144 (n=206)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0077
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=401)

- **FILTRO** `sigma_ewma_delta_pct` > `12.12` → IC=-0.203 (n=99)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 12.12
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=508)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.373` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 10.373 (IC base=-0.043)
...
- **FILTRO** `sigma_h` > `0.0081` → IC=-0.196 (n=189)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0081
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=369)

- **FILTRO** `drift_60min` |x|> `0.4483` → IC=-0.181 (n=139)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.4483
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=419)

- **FILTRO** `drift_15min` |x|> `0.84` → IC=-0.152 (n=139)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.84
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=419)

- **FILTRO** `sigma_ewma_delta_pct` > `14.657` → IC=-0.268 (n=67)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 14.657
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=491)

### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.365 (n=50)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.293)

- **PATRÓN** `drift_60min` |x|≤ `0.1853` → IC=+0.300 (n=148)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1853 (IC base=+0.293)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1832` → IC=+0.341 (n=67)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1832 (IC base=+0.293)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2855` → IC=+0.400 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2855 (IC base=+0.293)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.330 (n=133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.293)

- **PATRÓN** `ibs_15` > `0.9353` → IC=+0.360 (n=98)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9353 (IC base=+0.293)

- **PATRÓN** `dist_vwap_pct` > `0.2515` → IC=+0.373 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2515 (IC base=+0.293)

- **PATRÓN** `dist_vwap_pct` < `0.0845` → IC=+0.317 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0845 (IC base=+0.293)

- **PATRÓN** `sigma_ewma_delta_pct` < `20.416` → IC=+0.303 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 20.416 (IC base=+0.293)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.290 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.293)

- **PATRÓN** `libro_liquidez` > `6215.1452` → IC=+0.300 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6215.1452 (IC base=+0.293)

- **PATRÓN** `ballena_activa_n` < `200.0` → IC=+0.357 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 200.0 (IC base=+0.293)

### UPDOWN_GBM_IBS_ALTO#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2038` → IC=+0.286 (n=87)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.2038 (IC base=+0.269)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.267 (n=58)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.269)

- **PATRÓN** `sigma_h` > `0.0036` → IC=+0.306 (n=29)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0036 (IC base=+0.269)

- **PATRÓN** `drift_60min` |x|≤ `0.1837` → IC=+0.309 (n=87)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1837 (IC base=+0.269)

- **PATRÓN** `drift_15min` |x|≤ `0.5909` → IC=+0.295 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.5909 (IC base=+0.269)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0656` → IC=+0.275 (n=87)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0656 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.314 (n=84)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.269)

- **PATRÓN** `ibs_15` > `0.9359` → IC=+0.333 (n=58)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9359 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.379 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` < `0.0994` → IC=+0.300 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0994 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `27.622` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 27.622 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.644` → IC=+0.273 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.644 (IC base=+0.269)

- **PATRÓN** `libro_liquidez` > `9958.5281` → IC=+0.286 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9958.5281 (IC base=+0.269)

### UPDOWN_GBM_IBS_ALTO#ETH#15min
- **PATRÓN** `sigma_h` > `0.0036` → IC=+0.360 (n=41)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0036 (IC base=+0.319)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0587` → IC=+0.360 (n=55)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0587 (IC base=+0.319)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.364 (n=42)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.319)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.328 (n=62)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.319)

- **PATRÓN** `ibs_15` > `0.9673` → IC=+0.400 (n=28)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9673 (IC base=+0.319)

- **PATRÓN** `dist_vwap_pct` > `0.5182` → IC=+0.444 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5182 (IC base=+0.319)

- **PATRÓN** `dist_vwap_pct` < `0.0758` → IC=+0.353 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0758 (IC base=+0.319)

- **PATRÓN** `sigma_ewma_delta_pct` < `19.469` → IC=+0.346 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 19.469 (IC base=+0.319)

- **PATRÓN** `libro_liquidez` > `10425.7161` → IC=+0.370 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10425.7161 (IC base=+0.319)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1579 sube el IC de +0.033 a +0.170 en UPDOWN_GBM#XRP#15min (n=95). Ya aplicado como kelly_boost=+0.85€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.531 sube el IC de -0.093 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=52). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6189 sube el IC de -0.032 a +0.250 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=54). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.9353 sube el IC de +0.293 a +0.360 en UPDOWN_GBM_IBS_ALTO (n=98). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.9359 sube el IC de +0.269 a +0.333 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=58). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.9673 sube el IC de +0.319 a +0.400 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=28). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7117 sube el IC de +0.274 a +0.337 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=102). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 4703 | -0.103 | -535.57€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 549 | -0.070 | -86.36€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 4154 | -0.107 | -449.21€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 569 | -0.129 | -81.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 569 | -0.129 | -81.13€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 549 | -0.070 | -86.36€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 549 | -0.070 | -86.36€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1363 | -0.006 | +34.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1363 | -0.006 | +34.25€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1138 | -0.189 | -208.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1138 | -0.189 | -208.86€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 20251 | +0.112 | -1446.23€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4199 | +0.184 | -163.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 13149 | +0.087 | -1235.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2797 | +0.129 | +1.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2214 | +0.047 | -454.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 16 | -0.089 | -1.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2193 | +0.049 | -446.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 4378 | +0.136 | -79.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1162 | +0.193 | -70.63€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2187 | +0.108 | -60.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 987 | +0.142 | +73.89€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2219 | +0.063 | -363.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 15 | +0.022 | -2.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2203 | +0.064 | -359.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 4722 | +0.127 | -80.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1547 | +0.169 | -7.32€ | 0 | 6 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2187 | +0.106 | -56.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 976 | +0.110 | -7.56€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 4505 | +0.126 | -358.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1445 | +0.199 | -79.49€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2181 | +0.078 | -205.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 834 | +0.134 | -65.23€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 2213 | +0.118 | -110.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 14 | +0.000 | -0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2198 | +0.119 | -107.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 4319 | +0.171 | -353.69€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 4319 | +0.171 | -353.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1084 | +0.165 | -123.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1084 | +0.165 | -123.28€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1077 | +0.161 | -130.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1077 | +0.161 | -130.92€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 965 | +0.224 | -37.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 965 | +0.224 | -37.45€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1025 | +0.189 | -75.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1025 | +0.189 | -75.45€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 221 | +0.428 | -5.76€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 221 | +0.428 | -5.76€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 51 | +0.424 | -0.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 51 | +0.424 | -0.38€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 9388 | +0.196 | -808.76€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 9388 | +0.196 | -808.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1755 | +0.116 | -355.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1755 | +0.116 | -355.24€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1455 | +0.241 | -29.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1455 | +0.241 | -29.69€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1639 | +0.157 | -232.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1639 | +0.157 | -232.93€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 
37€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 338 | -0.018 | -7.38€ | 2 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 75 | -0.019 | -0.59€ | 1 | 1 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 711 | -0.006 | +35.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 413 | +0.049 | +69.32€ | 0 | 8 |
| ✅ UPDOWN_GBM#XRP#240min | 22 | -0.125 | -3.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 276 | -0.079 | -30.11€ | 0 | 0 |
| 🚫 UPDOWN_GBM#daily | 45 | -0.202 | +1.33€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 135 | +0.274 | +6.42€ | 0 | 11 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 135 | +0.274 | +6.42€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 53 | +0.300 | +8.72€ | 0 | 10 |
| ✅ UPDOWN_GBM_15M_TARDIO | 2405 | -0.076 | +414.12€ | 4 | 3 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2405 | -0.076 | +414.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 200 | -0.094 | +95.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 200 | -0.094 | +95.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 484 | -0.154 | -35.74€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 484 | -0.154 | -35.74€ | 4 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 61 | +0.024 | +4.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 61 | +0.024 | +4.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 156 | +0.032 | +35.57€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 156 | +0.032 | +35.57€ | 1 | 11 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 769 | -0.054 | +197.82€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 769 | -0.054 | +197.82€ | 3 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 735 | -0.074 | +115.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 735 | -0.074 | +115.78€ | 7 | 0 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 196 | +0.293 | +142.94€ | 0 | 12 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 196 | +0.293 | +142.94€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 115 | +0.269 | +69.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 115 | +0.269 | +69.97€ | 0 | 13 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 81 | +0.319 | +72.97€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 81 | +0.319 | +72.97€ | 0 | 9 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.100) — sin ventaja clara. oversold(IBS<0.3): IC=-0.007 n=1214 | neutral: IC=+0.009 n=1260 | overbought(IBS>0.7): IC=+0.093 n=1509
  - _Datos_: n=4227 IC=+0.035 PNL=+336.23€
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 3 celda(s) pasan gate riguroso completo de 96 evaluadas (n>=40) y 418 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=-0.013 < 0.08 — monitorear
  - _Datos_: n=314 IC=-0.013 PNL=-10.41€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.088 n=58475 | tras_1loss IC=+0.048 n=43940 | tras_2loss IC=+0.010 n=19824/40 | gap=+0.079 (umbral 0.05)
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.002 n=317 | contrario_BTC IC=+0.008 n=244/40 | gap=+0.010 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3344 IC=+0.006 PNL=+83.34€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3344 IC=+0.006 PNL=+83.34€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=166 IC=+0.077 PNL=+15.61€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=166 IC=+0.077 PNL=+15.61€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=919 IC=+0.044 PNL=+67.74€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=919 IC=+0.044 PNL=+67.74€
...
**🟡 H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.122 > 0.08 con n=35 PNL=+15.12€
  - _Datos_: n=35 IC=+0.122 PNL=+15.12€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=732 IC=-0.050 PNL=-56.71€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=732 IC=-0.050 PNL=-56.71€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=933 IC=+0.027 PNL=+70.22€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=933 IC=+0.027 PNL=+70.22€
...
**🟡 H-CUSTOM-OF-VOLUMEN-ALTO** — ORDER_FLOW_5M con total_vol_5m alto — ¿volumen extremo mejora el IC?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.123 > 0.08 con n=51 PNL=+14.67€
  - _Datos_: n=51 IC=+0.123 PNL=+14.67€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=505 IC=+0.029 PNL=+35.25€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=505 IC=+0.029 PNL=+35.25€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1135 IC=+0.033 PNL=+72.61€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1135 IC=+0.033 PNL=+72.61€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.157 > 0.1 con n=645 PNL=+223.31€
  - _Datos_: n=645 IC=+0.157 PNL=+223.31€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=285 IC=+0.033 PNL=+35.30€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=285 IC=+0.033 PNL=+35.30€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=2302 IC=-0.116 PNL=+328.47€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2302 IC=-0.116 PNL=+328.47€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=423 IC=+0.133 PNL=+146.72€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=423 IC=+0.133 PNL=+146.72€
...
**⏳ H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: 178/289 ops en el filtro definido (IC actual=-0.217 PNL=-4.07€)
  - _Datos_: n=178 IC=-0.217 PNL=-4.07€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=439 IC=-0.040 PNL=+2.65€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=439 IC=-0.040 PNL=+2.65€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.184 > 0.08 con n=381 PNL=+210.22€
  - _Datos_: n=381 IC=+0.184 PNL=+210.22€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=698 IC=-0.007 PNL=+141.11€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=698 IC=-0.007 PNL=+141.11€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.243 > 0.08 con n=900 PNL=-92.05€
  - _Datos_: n=900 IC=+0.243 PNL=-92.05€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1755 IC=+0.116 PNL=-355.24€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1755 IC=+0.116 PNL=-355.24€
