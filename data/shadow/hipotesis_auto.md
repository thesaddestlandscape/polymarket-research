# Hipótesis automáticas — 2026-07-05 22:30 UTC
_Generado por shadow_postmortem.py sobre 4041 resoluciones (PNL=+192.27€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.143 (n=96)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0086 (IC base=+0.027)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.158 (n=74)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.79€ cuando `ibs_15` < 0.0613 (IC base=+0.027)
...
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0434` → IC=-0.125 (n=22)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.0434
  - _Potencial_: sin este filtro IC_bueno=+0.154 (n=24)

- **FILTRO** `ibs_15` > `0.1169` → IC=-0.132 (n=17)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.1169
  - _Potencial_: sin este filtro IC_bueno=+0.227 (n=9)

- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0434` → IC=+0.154 (n=24)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.77€ cuando `pct_spot_vs_ref` |x|≤ 0.0434 (IC base=+0.021)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1182 | +0.093 | +294.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1182 | +0.093 | +294.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 309 | +0.037 | +32.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 309 | +0.037 | +32.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 308 | +0.055 | +33.17€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 308 | +0.055 | +33.17€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 309 | +0.130 | +122.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 309 | +0.130 | +122.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 256 | +0.159 | +106.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 256 | +0.159 | +106.24€ | 0 | 0 |
...
| 🚫 STRUCT_NO_15M | 11 | -0.190 | -4.62€ | 0 | 0 |
| 🚫 STRUCT_NO_15M#15min | 11 | -0.190 | -4.62€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 5 | -0.054 | -1.56€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 5 | -0.054 | -1.56€ | 0 | 0 |
| ✅ UPDOWN_GBM | 968 | -0.037 | -53.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 729 | -0.014 | -23.96€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 271 | -0.038 | -33.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 198 | -0.015 | -23.00€ | 5 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.060) — sin ventaja clara. oversold(IBS<0.3): IC=-0.012 n=205 | neutral: IC=-0.072 n=164 | overbought(IBS>0.7): IC=-0.040 n=187
  - _Datos_: n=578 IC=-0.035 PNL=-28.69€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.029 n=2030 | tras_1loss IC=-0.005 n=1905 | tras_2loss IC=-0.023 n=945/40 | gap=+0.052 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=27, boost estimado=+0.017. Necesita 0 más y boost>0.05
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=845 IC=-0.033 PNL=-40.37€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=845 IC=-0.033 PNL=-40.37€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.015 < 0.02 con n=198 PNL=-23.00€
  - _Datos_: n=198 IC=-0.015 PNL=-23.00€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=328 IC=-0.012 PNL=-31.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=328 IC=-0.012 PNL=-31.35€
...
**⏳ H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: 11/30 ops en el filtro definido (IC actual=+0.064 PNL=+1.47€)
  - _Datos_: n=11 IC=+0.064 PNL=+1.47€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=267 IC=-0.002 PNL=+1.34€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=267 IC=-0.002 PNL=+1.34€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1591 IC=+0.060 PNL=+267.45€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1591 IC=+0.060 PNL=+267.45€
