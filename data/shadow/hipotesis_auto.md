# Hipótesis automáticas — 2026-07-15 08:02 UTC
_Generado por shadow_postmortem.py sobre 15014 resoluciones (PNL=+2912.52€)_
...
- **PATRÓN** `libro_liquidez` > `3013.3728` → IC=+0.193 (n=640)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 3013.3728 (IC base=+0.192)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=947)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `7358.3864` → IC=+0.180 (n=276)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 7358.3864 (IC base=+0.165)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2059 | +0.177 | -27.73€ | 0 | 10 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 600 | +0.179 | -12.68€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 730 | +0.179 | +13.02€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 723 | +0.176 | -23.91€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.098 n=8642 | tras_1loss IC=+0.060 n=6185 | tras_2loss IC=+0.027 n=2688/40 | gap=+0.071 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12556 IC=+0.100 PNL=+2988.40€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12556 IC=+0.100 PNL=+2988.40€
