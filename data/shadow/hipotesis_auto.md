# Hipótesis automáticas — 2026-07-28 07:21 UTC
_Generado por shadow_postmortem.py sobre 39725 resoluciones (PNL=+8052.34€)_
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.158 (n=1689)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 7.0 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.2754` → IC=+0.188 (n=501)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.2754 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.425` → IC=+0.230 (n=580)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.798` → IC=+0.179 (n=82)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 11.798 (IC base=+0.110)
...
- **PATRÓN** `dist_vwap_pct` > `0.6707` → IC=+0.163 (n=81)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.6707 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.246` → IC=+0.177 (n=122)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 7.246 (IC base=+0.118)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.124 (n=813)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0104 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.4705` → IC=+0.158 (n=328)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.4705 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.141` → IC=+0.227 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.141 (IC base=+0.094)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` > `0.4413` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.4413 (IC base=+0.074)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.673` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 12.673 (IC base=+0.074)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `12.366` → IC=+0.167 (n=64)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 12.366 (IC base=+0.056)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6075` → IC=+0.176 (n=641)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` > 0.6075 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` > `0.1672` → IC=+0.167 (n=235)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1672 (IC base=+0.056)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.225` → IC=+0.157 (n=211)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 7.225 (IC base=+0.056)
...
- **PATRÓN** `ibs_15` > `0.6679` → IC=+0.194 (n=207)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.97€ cuando `ibs_15` > 0.6679 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.038` → IC=+0.151 (n=61)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 7.038 (IC base=+0.045)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6075 sube el IC de +0.056 a +0.176 en UPDOWN_GBM#15min (n=641). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6679 sube el IC de +0.045 a +0.194 en UPDOWN_GBM#ETH#15min (n=207). Ya aplicado como kelly_boost=+0.97€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1415 | +0.096 | +27.47€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1415 | +0.096 | +27.47€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 561 | +0.090 | -1.65€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 561 | +0.090 | -1.65€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 8536 | +0.093 | +2532.02€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8536 | +0.093 | +2532.02€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 34 | +0.139 | +5.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 34 | +0.139 | +5.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2051 | +0.072 | +350.11€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2051 | +0.072 | +350.11€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5775 | +0.114 | +2634.86€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5775 | +0.114 | +2634.86€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 25 | +0.204 | +15.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 25 | +0.204 | +15.24€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1498 | +0.083 | +499.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1498 | +0.083 | +499.57€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 35 | +0.122 | +11.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 35 | +0.122 | +11.57€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1492 | +0.088 | +517.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1492 | +0.088 | +517.30€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_TARDIO | 5764 | +0.064 | +1472.90€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5764 | +0.064 | +1472.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 33 | +0.186 | +9.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 33 | +0.186 | +9.39€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1366 | +0.026 | +145.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1366 | +0.026 | +145.13€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#DOGE | 33 | +0.129 | +6.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#DOGE#15min | 33 | +0.129 | +6.51€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1392 | +0.023 | +111.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1392 | +0.023 | +111.03€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 2950 | +0.036 | +270.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2686 | +0.052 | +310.00€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#ETH | 1114 | +0.039 | +78.53€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1020 | +0.053 | +90.10€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2230 | +0.150 | +971.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2230 | +0.150 | +971.75€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 425 | +0.163 | +154.85€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 425 | +0.163 | +154.85€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_ETH_15M_HORA7 | 22 | +0.042 | +1.09€ | 0 | 0 |
| ✅ UPDOWN_GBM_ETH_15M_HORA7#15min | 22 | +0.042 | +1.09€ | 0 | 0 |
| ✅ UPDOWN_GBM_ETH_15M_HORA7#ETH | 22 | +0.042 | +1.09€ | 0 | 0 |
| ✅ UPDOWN_GBM_ETH_15M_HORA7#ETH#15min | 22 | +0.042 | +1.09€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.166: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.073 n=1692 | neutral: IC=+0.021 n=1347 | overbought(IBS>0.7): IC=+0.187 n=1659
  - _Datos_: n=5009 IC=+0.103 PNL=+1308.63€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.109 n=23574 | tras_1loss IC=+0.077 n=15932 | tras_2loss IC=+0.053 n=6696/40 | gap=+0.056 (umbral 0.05)
...
**🟡 H-24H-GBM-BUYYES-MADRUGADA** — GBM BUY_YES en madrugada europea (05-07h UTC) — señal alcista
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.097 > 0.08 con n=142 PNL=+49.23€
  - _Datos_: n=142 IC=+0.097 PNL=+49.23€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2813 IC=+0.040 PNL=+284.77€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2813 IC=+0.040 PNL=+284.77€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1131 IC=+0.056 PNL=+156.12€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1131 IC=+0.056 PNL=+156.12€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=1420 PNL=+246.04€
  - _Datos_: n=1420 IC=+0.091 PNL=+246.04€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3443 IC=+0.054 PNL=+396.91€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3443 IC=+0.054 PNL=+396.91€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1281 IC=+0.032 PNL=+125.57€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1281 IC=+0.032 PNL=+125.57€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.1 con n=1029 PNL=+349.89€
  - _Datos_: n=1029 IC=+0.162 PNL=+349.89€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=727 PNL=+202.37€
  - _Datos_: n=727 IC=+0.121 PNL=+202.37€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.107 > 0.08 con n=608 PNL=+183.02€
  - _Datos_: n=608 IC=+0.107 PNL=+183.02€
