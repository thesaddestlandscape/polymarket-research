# Hipótesis automáticas — 2026-07-20 05:41 UTC
_Generado por shadow_postmortem.py sobre 23934 resoluciones (PNL=+6126.48€)_
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.214 (n=719)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.175)

- **PATRÓN** `py_entrada` < `0.265` → IC=+0.337 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.175)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.180 (n=1796)

  - _Acción_: Kelly boost +0.90€ cuando `libro_spread` < 0.01 (IC base=+0.175)

- **PATRÓN** `libro_liquidez` > `4162.0074` → IC=+0.178 (n=1078)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 4162.0074 (IC base=+0.175)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.220 (n=284)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.210)

- **PATRÓN** `py_entrada` > `0.605` → IC=+0.258 (n=320)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.218 (n=37)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.136)

- **PATRÓN** `py_entrada` < `0.405` → IC=+0.171 (n=77)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` < 0.405 (IC base=+0.136)

- **PATRÓN** `py_entrada` > `0.355` → IC=+0.136 (n=105)

  - _Acción_: Kelly boost +0.68€ cuando `py_entrada` > 0.355 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `3899.2794` → IC=+0.189 (n=88)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 3899.2794 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.252 (n=123)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.235)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.313 (n=228)
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.243 (n=33)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.083)
...
- **PATRÓN** `dist_vwap_pct` < `0.1207` → IC=+0.126 (n=690)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.1207 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.061` → IC=+0.238 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.061 (IC base=+0.117)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.131 (n=1515)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0086 (IC base=+0.116)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.137 (n=1641)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 12.0 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` > `0.1365` → IC=+0.139 (n=386)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.1365 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.8045` → IC=+0.131 (n=1209)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.8045 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.174` → IC=+0.146 (n=261)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 6.174 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.097` → IC=+0.129 (n=1088)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 11.097 (IC base=+0.116)
...
- **PATRÓN** `dist_vwap_pct` > `0.136` → IC=+0.136 (n=64)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.136 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` < `0.466` → IC=+0.141 (n=249)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.466 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.032` → IC=+0.182 (n=108)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 3.032 (IC base=+0.079)
...
- **PATRÓN** `dist_vwap_pct` > `0.8879` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.8879 (IC base=+0.080)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.518` → IC=+0.214 (n=82)
...
- **PATRÓN** `sigma_h` < `0.0144` → IC=+0.135 (n=557)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0144 (IC base=+0.126)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.133 (n=557)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0089 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.175 (n=250)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 7.0 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.892` → IC=+0.121 (n=233)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 3.892 (IC base=+0.126)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` < `0.0267` → IC=+0.158 (n=586)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0267 (IC base=+0.156)

- **PATRÓN** `sigma_h` > `0.0148` → IC=+0.168 (n=390)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0148 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.160 (n=587)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 6.0 (IC base=+0.156)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.159 (n=391)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 11.0 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.5454` → IC=+0.222 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5454 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.1058` → IC=+0.162 (n=232)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1058 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.792` → IC=+0.290 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.792 (IC base=+0.156)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.189 (n=204)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0092 (IC base=+0.174)

- **PATRÓN** `sigma_h` > `0.0247` → IC=+0.193 (n=203)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0247 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.174 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 18.0 (IC base=+0.174)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.234 (n=231)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` < `0.5244` → IC=+0.175 (n=361)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5244 (IC base=+0.174)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.767` → IC=+0.176 (n=328)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 7.767 (IC base=+0.174)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0115` → IC=+0.227 (n=394)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.2754` → IC=+0.216 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2754 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.334` → IC=+0.246 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.334 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.190 (n=1130)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0044 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.197 (n=562)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.199 (n=390)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 5.0 (IC base=+0.176)

- **PATRÓN** `dist_vwap_pct` < `0.7697` → IC=+0.197 (n=1056)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.7697 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.124` → IC=+0.219 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.124 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.004` → IC=+0.188 (n=736)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.150 (n=287)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0059 (IC base=+0.143)

- **PATRÓN** `sigma_h` > `0.0026` → IC=+0.161 (n=287)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0026 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.183 (n=143)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 15.0 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.4426` → IC=+0.146 (n=261)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.4426 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.456` → IC=+0.203 (n=99)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.148 (n=262)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0066 (IC base=+0.131)

- **PATRÓN** `sigma_h` > `0.0035` → IC=+0.138 (n=296)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0035 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.173 (n=151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 15.0 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.154 (n=134)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 7.0 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.8699` → IC=+0.218 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8699 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.447` → IC=+0.225 (n=78)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.398` → IC=-0.145 (n=29)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.196 (n=182)
...
- **PATRÓN** `dist_vwap_pct` > `0.321` → IC=+0.174 (n=93)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.321 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.628` → IC=+0.300 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.628 (IC base=+0.129)

- **PATRÓN** `sigma_h` < `0.0121` → IC=+0.157 (n=263)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0121 (IC base=+0.125)
...
- **PATRÓN** `dist_vwap_pct` < `0.7524` → IC=+0.167 (n=223)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.7524 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.398` → IC=+0.196 (n=182)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 2.398 (IC base=+0.125)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.0164` → IC=+0.259 (n=280)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0164 (IC base=+0.257)

- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.272 (n=279)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.266 (n=246)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.257)

- **PATRÓN** `dist_vwap_pct` > `0.5552` → IC=+0.346 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5552 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.293` → IC=+0.368 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.293 (IC base=+0.257)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.323 (n=286)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.305 (n=255)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.300)

- **PATRÓN** `dist_vwap_pct` > `0.1637` → IC=+0.316 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1637 (IC base=+0.300)

- **PATRÓN** `dist_vwap_pct` < `0.5023` → IC=+0.308 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5023 (IC base=+0.300)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.644` → IC=+0.316 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.644 (IC base=+0.300)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.133 (n=363)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0053 (IC base=+0.129)

- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.176 (n=495)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0111 (IC base=+0.129)
...
- **PATRÓN** `dist_vwap_pct` > `0.4717` → IC=+0.180 (n=220)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.4717 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.1063` → IC=+0.154 (n=590)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.138 (n=451)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 6.0 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.5163` → IC=+0.141 (n=1013)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.5163 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.961` → IC=+0.134 (n=214)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 5.961 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.187` → IC=+0.134 (n=965)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 11.187 (IC base=+0.112)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.129 (n=286)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0065 (IC base=+0.086)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.140 (n=98)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 17.0 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.43` → IC=+0.139 (n=95)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 4.43 (IC base=+0.086)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.618` → IC=+0.182 (n=61)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 7.618 (IC base=+0.055)

### GBM_LATE_15M_TARDIO#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.829` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.829
  - _Potencial_: sin este filtro IC_bueno=+0.078 (n=228)

- **PATRÓN** `sigma_h` > `0.0121` → IC=+0.124 (n=107)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0121 (IC base=+0.086)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.128 (n=111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 8.0 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `0.2877` → IC=+0.125 (n=62)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.2877 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` < `0.1237` → IC=+0.122 (n=117)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.1237 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.563` → IC=+0.307 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.563 (IC base=+0.086)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.139 (n=95)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0083 (IC base=+0.051)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.126 (n=105)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 6.0 (IC base=+0.051)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` < `0.0254` → IC=+0.208 (n=344)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0254 (IC base=+0.209)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.220 (n=344)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.5454` → IC=+0.268 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5454 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` < `0.0981` → IC=+0.213 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0981 (IC base=+0.209)
...
- **PATRÓN** `dist_vwap_pct` > `0.1407` → IC=+0.214 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1407 (IC base=+0.218)

- **PATRÓN** `dist_vwap_pct` < `0.5022` → IC=+0.217 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5022 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.223` → IC=+0.229 (n=334)
...
### UPDOWN_GBM#15min
- **FILTRO** `sigma_ewma_delta_pct` > `17.593` → IC=-0.155 (n=27)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.593
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=344)

- **PATRÓN** `ibs_15` > `0.7455` → IC=+0.200 (n=321)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7455 (IC base=+0.038)

- **PATRÓN** `dist_vwap_pct` > `0.1687` → IC=+0.150 (n=138)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1687 (IC base=+0.038)

- **PATRÓN** `dist_vwap_pct` < `0.2677` → IC=+0.136 (n=193)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.2677 (IC base=+0.038)
...
- **PATRÓN** `ibs_15` < `0.0314` → IC=+0.132 (n=191)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.0314 (IC base=+0.051)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.121 (n=101)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0058 (IC base=+0.047)

- **PATRÓN** `dist_vwap_pct` > `0.9393` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.9393 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` < `8.229` → IC=+0.122 (n=109)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 8.229 (IC base=+0.047)
...
- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.134 (n=39)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0088 (IC base=+0.105)

- **PATRÓN** `drift_60min` |x|≤ `0.1792` → IC=+0.141 (n=37)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.1792 (IC base=+0.105)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1341` → IC=+0.138 (n=56)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.69€ cuando `delta_ratio_macro` |x|> 0.1341 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.136 (n=86)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 4.0 (IC base=+0.105)

- **PATRÓN** `ibs_15` < `0.1467` → IC=+0.142 (n=79)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.71€ cuando `ibs_15` < 0.1467 (IC base=+0.105)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7455 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.200 n=321). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 394 | +0.146 | +19.83€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 394 | +0.146 | +19.83€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 154 | +0.173 | +10.08€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 154 | +0.173 | +10.08€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 158 | +0.131 | -0.08€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 158 | +0.131 | -0.08€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 82 | +0.119 | +9.83€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 82 | +0.119 | +9.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 4106 | +0.187 | +70.90€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2672 | +0.218 | +98.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 175 | +0.071 | -2.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 557 | +0.105 | -75.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 702 | +0.162 | +50.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 1192 | +0.198 | +50.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 890 | +0.211 | +4.68€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 58 | +0.100 | +2.89€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 234 | +0.191 | +46.70€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH | 1461 | +0.181 | +16.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 887 | +0.221 | +45.11€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 58 | +0.000 | -9.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 282 | +0.109 | -36.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 234 | +0.157 | +16.77€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#SOL | 1435 | +0.184 | +3.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 881 | +0.224 | +51.81€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 59 | +0.107 | +3.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 261 | +0.108 | -39.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 234 | +0.136 | -12.98€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 18 | +0.135 | +1.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 14 | +0.044 | -3.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 172 | +0.316 | +8.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 172 | +0.316 | +8.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 172 | +0.316 | +8.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 172 | +0.316 | +8.41€ | 0 | 0 |
| ✅ GBM_LATE_15M | 6051 | +0.108 | +2138.66€ | 0 | 10 |
| ✅ GBM_LATE_15M#15min | 6051 | +0.108 | +2138.66€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1440 | +0.082 | +306.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1440 | +0.082 | +306.20€ | 0 | 8 |
| ✅ GBM_LATE_15M#ETH | 1377 | +0.079 | +274.68€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1377 | +0.079 | +274.68€ | 0 | 4 |
| ✅ GBM_LATE_15M#SOL | 1640 | +0.100 | +647.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1640 | +0.100 | +647.45€ | 1 | 6 |
| ✅ GBM_LATE_15M#XRP | 1594 | +0.165 | +910.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1594 | +0.165 | +910.33€ | 0 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3271 | +0.155 | +2030.08€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3271 | +0.155 | +2030.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 832 | +0.121 | +433.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 832 | +0.121 | +433.97€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 858 | +0.115 | +411.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 858 | +0.115 | +411.69€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 828 | +0.116 | +370.22€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 828 | +0.116 | +370.22€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 753 | +0.279 | +814.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 753 | +0.279 | +814.19€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 3234 | +0.104 | +1214.35€ | 0 | 10 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3234 | +0.104 | +1214.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 769 | +0.076 | +185.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 769 | +0.076 | +185.37€ | 0 | 8 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 778 | +0.041 | +93.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 778 | +0.041 | +93.03€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 735 | +0.056 | +170.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 735 | +0.056 | +170.84€ | 1 | 7 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 952 | +0.214 | +765.10€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 952 | +0.214 | +765.10€ | 0 | 13 |
| ✅ GBM_LATE_5M | 157 | +0.072 | +17.76€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 157 | +0.072 | +17.76€ | 0 | 0 |
...
| ✅ GBM_LATE_5M#XRP | 87 | +0.140 | +20.44€ | 0 | 0 |
| ✅ GBM_LATE_5M#XRP#5min | 87 | +0.140 | +20.44€ | 0 | 0 |
...
| ✅ GBM_LATE_60M#SOL#60min | 110 | -0.152 | +11.27€ | 4 | 1 |
...
| ✅ LEADLAG_BTC_XRP_15M | 212 | +0.023 | +11.76€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 212 | +0.023 | +11.76€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 212 | +0.023 | +11.76€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 212 | +0.023 | +11.76€ | 0 | 2 |
| ✅ ORDER_FLOW_5M | 1638 | +0.012 | +13.23€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#ETH#5min | 47 | -0.153 | -8.07€ | 5 | 0 |
...
| 🚫 STREAK_MOM_5M | 315 | -0.058 | -25.36€ | 7 | 0 |
...
| ✅ UPDOWN_GBM | 1906 | +0.021 | +132.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1646 | +0.045 | +170.76€ | 1 | 5 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 127 | -0.058 | -10.76€ | 5 | 0 |
| ✅ UPDOWN_GBM#BNB | 145 | +0.051 | +31.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 145 | +0.051 | +31.51€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 851 | +0.025 | +44.03€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 758 | +0.041 | +55.09€ | 1 | 6 |
...
| ✅ UPDOWN_GBM#SOL#15min | 109 | -0.050 | -6.41€ | 5 | 1 |
| 🚫 UPDOWN_GBM#SOL#5min | 23 | -0.060 | -3.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 31 | -0.106 | -2.03€ | 0 | 0 |
| 🚫 UPDOWN_GBM#SOL#daily | 12 | -0.129 | -0.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 157 | +0.041 | +30.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 146 | +0.061 | +33.88€ | 4 | 5 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 752 | +0.172 | +333.24€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 752 | +0.172 | +333.24€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 49 | +0.265 | +32.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 49 | +0.265 | +32.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 176 | +0.180 | +64.37€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 176 | +0.180 | +64.37€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 182 | +0.125 | +65.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 182 | +0.125 | +65.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 191 | +0.225 | +142.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 191 | +0.225 | +142.84€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.203: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.057 n=826 | neutral: IC=-0.014 n=605 | overbought(IBS>0.7): IC=+0.189 n=776
  - _Datos_: n=2356 IC=+0.089 PNL=+507.32€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.119 n=14486 | tras_1loss IC=+0.093 n=9253 | tras_2loss IC=+0.060 n=3730/40 | gap=+0.060 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1774 IC=+0.027 PNL=+147.44€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1774 IC=+0.027 PNL=+147.44€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=817 IC=+0.038 PNL=+74.55€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=817 IC=+0.038 PNL=+74.55€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=872 IC=+0.078 PNL=+120.54€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=872 IC=+0.078 PNL=+120.54€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=787 IC=+0.036 PNL=+64.84€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=787 IC=+0.036 PNL=+64.84€

**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.124 > 0.08 con n=91 PNL=+22.06€
  - _Datos_: n=91 IC=+0.124 PNL=+22.06€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=21476 IC=+0.123 PNL=+6202.36€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=21476 IC=+0.123 PNL=+6202.36€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=211 IC=+0.002 PNL=+0.16€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=211 IC=+0.002 PNL=+0.16€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=967 IC=+0.009 PNL=+44.00€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=967 IC=+0.009 PNL=+44.00€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.161 > 0.1 con n=571 PNL=+201.49€
  - _Datos_: n=571 IC=+0.161 PNL=+201.49€
...
**🟡 H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.105 > 0.1 con n=117 PNL=+37.24€
  - _Datos_: n=117 IC=+0.105 PNL=+37.24€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=758 IC=+0.074 PNL=+136.21€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=758 IC=+0.074 PNL=+136.21€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.136 > 0.08 con n=413 PNL=+120.79€
  - _Datos_: n=413 IC=+0.136 PNL=+120.79€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.129 > 0.08 con n=507 PNL=+194.34€
  - _Datos_: n=507 IC=+0.129 PNL=+194.34€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.136 > 0.08 con n=308 PNL=+118.65€
  - _Datos_: n=308 IC=+0.136 PNL=+118.65€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.08 con n=319 PNL=+165.15€
  - _Datos_: n=319 IC=+0.160 PNL=+165.15€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.168 > 0.08 con n=392 PNL=+263.40€
  - _Datos_: n=392 IC=+0.168 PNL=+263.40€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.190 > 0.08 con n=224 PNL=+2.38€
  - _Datos_: n=224 IC=+0.190 PNL=+2.38€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.274 > 0.08 con n=312 PNL=+1.96€
  - _Datos_: n=312 IC=+0.274 PNL=+1.96€
