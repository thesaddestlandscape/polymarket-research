# Hipótesis automáticas — 2026-08-14 10:05 UTC
_Generado por shadow_postmortem.py sobre 25423 resoluciones (PNL=+4949.82€)_
...
- **PATRÓN** `py_entrada` < `0.44` → IC=+0.171 (n=156)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` < 0.44 (IC base=+0.151)

- **PATRÓN** `restante_min` < `4.18` → IC=+0.192 (n=63)

  - _Acción_: Kelly boost +0.96€ cuando `restante_min` < 4.18 (IC base=+0.151)

- **PATRÓN** `restante_min` > `4.88` → IC=+0.167 (n=67)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` > 4.88 (IC base=+0.151)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.169 (n=137)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 6.0 (IC base=+0.151)

- **PATRÓN** `lag_apertura_s` < `6.38` → IC=+0.177 (n=63)

  - _Acción_: Kelly boost +0.88€ cuando `lag_apertura_s` < 6.38 (IC base=+0.151)
...
- **PATRÓN** `py_entrada` > `0.43` → IC=+0.174 (n=44)

  - _Acción_: Kelly boost +0.87€ cuando `py_entrada` > 0.43 (IC base=+0.130)

- **PATRÓN** `restante_min` < `4.7` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `restante_min` < 4.7 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.167 (n=70)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 6.0 (IC base=+0.130)

- **PATRÓN** `lag_apertura_s` < `7.32` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 7.32 (IC base=+0.130)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.44` → IC=+0.193 (n=73)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.44 (IC base=+0.170)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.274 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.95 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.210 (n=36)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.170)

- **PATRÓN** `lag_apertura_s` < `3.13` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 3.13 (IC base=+0.170)
...
### UPDOWN_OU_5M
- **FILTRO** `pct_spot_vs_ref` |x|> `0.1118` → IC=-0.136 (n=20)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.1118
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=10)

- **FILTRO** `drift_15min` |x|> `0.3296` → IC=-0.136 (n=20)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.3296
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=10)
...
| ✅ BALLENAS_TARDIAS | 558 | -0.007 | -103.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 262 | +0.174 | +0.82€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 296 | -0.168 | -104.67€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 51 | -0.009 | -14.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 51 | -0.009 | -14.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 262 | +0.174 | +0.82€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 262 | +0.174 | +0.82€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 45 | -0.117 | -19.58€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 45 | -0.117 | -19.58€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#ETH | 76 | -0.308 | -20.79€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#ETH#5min | 76 | -0.308 | -20.79€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 88 | -0.156 | -38.53€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 88 | -0.156 | -38.53€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 36 | -0.158 | -10.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 36 | -0.158 | -10.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 5179 | +0.142 | -150.07€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2095 | +0.185 | -81.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 58 | -0.067 | -20.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 712 | +0.064 | -80.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2314 | +0.133 | +31.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 129 | +0.004 | -28.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 8 | -0.040 | -1.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 118 | +0.025 | -23.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 1580 | +0.150 | +8.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 576 | +0.182 | -46.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 23 | -0.020 | -7.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 119 | +0.070 | -8.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 862 | +0.143 | +71.48€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 122 | +0.000 | -33.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 119 | +0.012 | -28.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 1693 | +0.137 | -14.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 784 | +0.174 | +4.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 11 | -0.106 | -7.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 119 | +0.029 | -16.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 779 | +0.120 | +4.40€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#SOL | 1527 | +0.164 | -83.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 716 | +0.206 | -33.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 20 | +0.045 | -0.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 118 | +0.092 | -6.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 673 | +0.134 | -44.13€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 128 | +0.146 | +1.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 8 | +0.040 | +0.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 119 | +0.153 | +2.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 2223 | +0.188 | -133.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 2223 | +0.188 | -133.63€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 534 | +0.181 | -50.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 534 | +0.181 | -50.85€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION |