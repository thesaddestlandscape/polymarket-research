# Hipótesis automáticas — 2026-07-15 12:36 UTC
_Generado por shadow_postmortem.py sobre 15302 resoluciones (PNL=+2982.71€)_
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.312 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.196 (n=896)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `4390.8559` → IC=+0.193 (n=506)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 4390.8559 (IC base=+0.192)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=971)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `7288.9466` → IC=+0.188 (n=283)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 7288.9466 (IC base=+0.162)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.212 (n=116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.253 (n=148)
...
- **PATRÓN** `libro_liquidez` > `1636.4687` → IC=+0.229 (n=164)
...
### GBM_LATE_15M
- **PATRÓN** `sigma_ewma_delta_pct` > `9.332` → IC=+0.216 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.332 (IC base=+0.106)
...
- **PATRÓN** `dist_vwap_pct` > `0.3108` → IC=+0.152 (n=21)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.3108 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.305` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.305 (IC base=+0.079)
...
- **FILTRO** `sigma_ewma_delta_pct` < `6.416` → IC=-0.122 (n=35)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.256 (n=39)

- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.156 (n=126)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0045 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.6633` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6633 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.416` → IC=+0.256 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.416 (IC base=+0.091)
...
- **PATRÓN** `sigma_h` < `0.0296` → IC=+0.139 (n=416)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0296 (IC base=+0.139)

- **PATRÓN** `sigma_h` > `0.0225` → IC=+0.170 (n=189)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0225 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.145 (n=438)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.431` → IC=+0.180 (n=23)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 9.431 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` > `0.012` → IC=+0.222 (n=217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.012 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.174 (n=452)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 12.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.164 (n=683)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `1.0527` → IC=+0.230 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0527 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.074` → IC=+0.300 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.074 (IC base=+0.160)
...
- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.122 (n=162)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0063 (IC base=+0.122)

- **PATRÓN** `sigma_h` > `0.0027` → IC=+0.152 (n=162)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0027 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.179 (n=110)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 12.0 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` > `0.132` → IC=+0.160 (n=45)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.132 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.412` → IC=+0.231 (n=24)
...
- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.216 (n=79)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.161 (n=184)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 18.0 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.659` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.659 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.752` → IC=+0.389 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.752 (IC base=+0.144)
...
- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.220 (n=80)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0127 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.147 (n=168)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2465` → IC=+0.189 (n=59)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.2465 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `1.0918` → IC=+0.141 (n=126)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 1.0918 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.459` → IC=+0.246 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.459 (IC base=+0.133)
...
- **PATRÓN** `sigma_h` > `0.0145` → IC=+0.160 (n=198)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0145 (IC base=+0.101)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.121 (n=531)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 15.0 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.6294` → IC=+0.174 (n=90)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.6294 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.123 (n=189)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.253` → IC=+0.297 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.253 (IC base=+0.101)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.132 (n=123)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 7.0 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.7679` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.7679 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.632` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 12.632 (IC base=+0.084)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.132 (n=66)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0043 (IC base=+0.050)

- **PATRÓN** `dist_vwap_pct` > `0.8259` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.8259 (IC base=+0.050)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.728` → IC=+0.333 (n=16)
...
- **PATRÓN** `sigma_h` < `0.0323` → IC=+0.192 (n=167)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0323 (IC base=+0.183)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.192 (n=167)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0112 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.237 (n=112)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` > `0.1821` → IC=+0.206 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1821 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `1.4833` → IC=+0.167 (n=91)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 1.4833 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.491` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 8.491 (IC base=+0.183)
...
- **PATRÓN** `dist_vwap_pct` < `0.5084` → IC=+0.144 (n=161)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.5084 (IC base=+0.025)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.266` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 15.266 (IC base=+0.025)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2141 | +0.177 | -32.85€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1383 | +0.208 | +5.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 91 | +0.016 | -14.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 304 | +0.095 | -44.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 363 | +0.163 | +20.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 623 | +0.180 | -14.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 462 | +0.196 | -25.06€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 758 | +0.179 | +11.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 456 | +0.221 | +23.24€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 30 | -0.125 | -12.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 151 | +0.108 | -16.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 121 | +0.183 | +18.21€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL | 754 | +0.173 | -26.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 459 | +0.211 | +11.12€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 31 | +0.076 | -1.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 143 | +0.107 | -23.43€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 4571 | +0.102 | +1390.08€ | 0 | 3 |
| ✅ GBM_LATE_15M#15min | 4571 | +0.102 | +1390.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1096 | +0.067 | +161.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1096 | +0.067 | +161.77€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1115 | +0.075 | +186.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1115 | +0.075 | +186.88€ | 1 | 4 |
| ✅ GBM_LATE_15M#SOL | 1215 | +0.111 | +493.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1215 | +0.111 | +493.86€ | 1 | 6 |
| ✅ GBM_LATE_15M#XRP | 1145 | +0.150 | +547.57€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1145 | +0.150 | +547.57€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1830 | +0.152 | +1063.32€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1830 | +0.152 | +1063.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 467 | +0.123 | +232.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 467 | +0.123 | +232.23€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 482 | +0.128 | +221.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 482 | +0.128 | +221.00€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 494 | +0.109 | +212.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 494 | +0.109 | +212.25€ | 1 | 10 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO | 28 | -0.133 | -2.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 28 | -0.133 | -2.07€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 1785 | +0.084 | +485.92€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1785 | +0.084 | +485.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 442 | +0.063 | +74.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 442 | +0.063 | +74.52€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 399 | +0.016 | +10.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 399 | +0.016 | +10.79€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 440 | +0.048 | +71.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 440 | +0.048 | +71.99€ | 2 | 5 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 504 | +0.186 | +328.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 504 | +0.186 | +328.61€ | 0 | 11 |
...
| ✅ UPDOWN_GBM | 1545 | +0.009 | +72.25€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1288 | +0.036 | +108.77€ | 0 | 7 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 8 | +0.120 | +2.52€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 8 | +0.120 | +2.52€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.128) — sin ventaja clara. oversold(IBS<0.3): IC=-0.006 n=429 | neutral: IC=-0.021 n=326 | overbought(IBS>0.7): IC=+0.106 n=346
  - _Datos_: n=1164 IC=+0.029 PNL=+100.20€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.099 n=8816 | tras_1loss IC=+0.061 n=6280 | tras_2loss IC=+0.028 n=2719/40 | gap=+0.071 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1418 IC=+0.016 PNL=+86.25€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1418 IC=+0.016 PNL=+86.25€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=689 IC=+0.025 PNL=+43.73€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=689 IC=+0.025 PNL=+43.73€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=318 IC=+0.066 PNL=+41.30€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=318 IC=+0.066 PNL=+41.30€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=677 IC=+0.073 PNL=+86.58€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=677 IC=+0.073 PNL=+86.58€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12844 IC=+0.101 PNL=+3058.59€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12844 IC=+0.101 PNL=+3058.59€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=837 IC=-0.005 PNL=+14.20€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=837 IC=-0.005 PNL=+14.20€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.166 > 0.1 con n=387 PNL=+136.90€
  - _Datos_: n=387 IC=+0.166 PNL=+136.90€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.148 > 0.08 con n=285 PNL=+89.98€
  - _Datos_: n=285 IC=+0.148 PNL=+89.98€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.214 > 0.08 con n=124 PNL=+57.76€
  - _Datos_: n=124 IC=+0.214 PNL=+57.76€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.255 > 0.2 con n=292 PNL=+195.98€
  - _Datos_: n=292 IC=+0.255 PNL=+195.98€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.134 > 0.08 con n=129 PNL=+40.55€
  - _Datos_: n=129 IC=+0.134 PNL=+40.55€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.115 > 0.08 con n=115 PNL=+47.23€
  - _Datos_: n=115 IC=+0.115 PNL=+47.23€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.08 con n=158 PNL=+75.31€
  - _Datos_: n=158 IC=+0.125 PNL=+75.31€
