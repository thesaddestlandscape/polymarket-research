# Hipótesis automáticas — 2026-08-27 08:45 UTC
_Generado por shadow_postmortem.py sobre 172413 resoluciones (PNL=+12501.19€)_
...
- **FILTRO** `py_entrada` < `0.705` → IC=-0.167 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.269 (n=232)

- **PATRÓN** `py_entrada` > `0.725` → IC=+0.282 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.149)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.164 (n=221)

  - _Acción_: Kelly boost +0.82€ cuando `n_ballena_banda` > 20.0 (IC base=+0.149)

- **PATRÓN** `n_total_lado` > `58.0` → IC=+0.236 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 58.0 (IC base=+0.149)

- **PATRÓN** `banda_hit_calibrado` > `0.8214` → IC=+0.259 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8214 (IC base=+0.149)

- **PATRÓN** `banda_z` > `10.822` → IC=+0.256 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.822 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.181 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 11.0 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=252)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `3111.6433` → IC=+0.239 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3111.6433 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `288.0` → IC=+0.293 (n=85)
...
- **PATRÓN** `py_entrada` > `0.725` → IC=+0.283 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.188)

- **PATRÓN** `n_ballena_banda` > `20.0` → IC=+0.198 (n=157)

  - _Acción_: Kelly boost +0.99€ cuando `n_ballena_banda` > 20.0 (IC base=+0.188)

- **PATRÓN** `n_total_lado` > `57.0` → IC=+0.248 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 57.0 (IC base=+0.188)

- **PATRÓN** `banda_hit_calibrado` > `0.8208` → IC=+0.276 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8208 (IC base=+0.188)

- **PATRÓN** `banda_z` > `11.827` → IC=+0.278 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.827 (IC base=+0.188)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.216 (n=139)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.196 (n=182)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.01 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `3827.6428` → IC=+0.253 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3827.6428 (IC base=+0.188)

- **PATRÓN** `ballena_activa_n` < `290.0` → IC=+0.303 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 290.0 (IC base=+0.188)
...
- **FILTRO** `restante_s_al_confirmar` < `147.06` → IC=-0.285 (n=2393)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=7181)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.188 (n=5405)
...
- **PATRÓN** `libro_liquidez` > `2383.976` → IC=+0.174 (n=1524)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=634)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.135 (n=1210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 5.0 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.128 (n=1033)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.180 (n=989)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 15.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.73` → IC=+0.185 (n=1106)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` < 0.73 (IC base=+0.169)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.169 (n=995)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.166 (n=1149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.167 (n=974)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.194 (n=1101)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 5.0 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.183 (n=950)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.191 (n=8781)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 12.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.221 (n=8736)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.165 (n=1504)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 12.0 (IC base=+0.164)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.214 (n=729)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.192 (n=1480)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 12.0 (IC base=+0.185)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.211 (n=1500)
...
- **PATRÓN** `restante_min` > `4.93` → IC=+0.163 (n=1499)
...
- **PATRÓN** `lag_apertura_s` < `4.46` → IC=+0.160 (n=1484)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.161 (n=798)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` > 4.94 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=2319)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.49` → IC=+0.162 (n=744)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9494` → IC=+0.210 (n=754)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9494 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.1838` → IC=+0.230 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1838 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.7288` → IC=+0.211 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7288 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.212` → IC=+0.166 (n=916)
...
- **PATRÓN** `volumen_regimen` > `1.0578` → IC=+0.241 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0578 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.3083` → IC=+0.161 (n=175)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.3083 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `2.4679` → IC=+0.141 (n=1072)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.4679 (IC base=+0.065)
...
- **PATRÓN** `dist_vwap_pct` < `0.2895` → IC=+0.144 (n=782)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.2895 (IC base=+0.030)
...
- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.207 (n=479)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 221.0 (IC base=+0.030)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.184 (n=169)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0075 (IC base=+0.120)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.165 (n=249)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 8.0 (IC base=+0.120)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2139` → IC=+0.143 (n=82)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.2139 (IC base=+0.120)
...
- **PATRÓN** `volumen_regimen` > `1.0844` → IC=+0.238 (n=170)
...
- **PATRÓN** `drift_60min` |x|≤ `0.099` → IC=+0.137 (n=199)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.099 (IC base=+0.133)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.923` → IC=+0.262 (n=120)
...
- **PATRÓN** `libro_liquidez` > `1916.3861` → IC=+0.150 (n=204)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 1916.3861 (IC base=+0.133)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=63)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=737)
...
- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.172 (n=291)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=875)

- **FILTRO** `sigma_ewma_delta_pct` > `6.649` → IC=-0.153 (n=194)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.649
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=972)
...
- **PATRÓN** `ibs_20min` < `0.0947` → IC=+0.185 (n=1203)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.0947 (IC base=+0.038)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3783` → IC=+0.294 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3783 (IC base=+0.038)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.258 (n=473)
...
- **FILTRO** `ibs_20min` > `0.8844` → IC=-0.144 (n=273)
...
- **PATRÓN** `sigma_h` < `0.0079` → IC=+0.353 (n=209)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0079 (IC base=+0.345)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.352 (n=79)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.345)

- **PATRÓN** `drift_60min` |x|≤ `0.3551` → IC=+0.352 (n=208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3551 (IC base=+0.345)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.386 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.345)

- **PATRÓN** `ibs_20min` < `0.3204` → IC=+0.358 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3204 (IC base=+0.345)

- **PATRÓN** `ibs_20min` > `0.1333` → IC=+0.344 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1333 (IC base=+0.345)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.502` → IC=+0.347 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.502 (IC base=+0.345)

- **PATRÓN** `volumen_pendiente_norm` > `0.3474` → IC=+0.389 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3474 (IC base=+0.345)

- **PATRÓN** `volumen_spike_ratio` < `3.3265` → IC=+0.337 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.3265 (IC base=+0.345)

- **PATRÓN** `volumen_spike_ratio` > `1.9918` → IC=+0.355 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9918 (IC base=+0.345)

- **PATRÓN** `libro_liquidez` > `1894.7532` → IC=+0.364 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1894.7532 (IC base=+0.345)
...
- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.199 (n=822)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0099 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.3304` → IC=+0.156 (n=2163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.3304 (IC base=+0.156)
...
- **PATRÓN** `dist_vwap_pct` > `1.1447` → IC=+0.261 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1447 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.352` → IC=+0.245 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.352 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `0.6867` → IC=+0.173 (n=1522)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6867 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.2372` → IC=+0.192 (n=465)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2372 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.2828` → IC=+0.152 (n=1945)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.2828 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.8507` → IC=+0.151 (n=1473)
...
- **PATRÓN** `libro_liquidez` > `3185.6633` → IC=+0.182 (n=1115)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3185.6633 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.177 (n=1204)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.217 (n=182)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.148)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.191 (n=273)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 11.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.306 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.076` → IC=+0.330 (n=145)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5615` → IC=+0.126 (n=287)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.5615 (IC base=+0.148)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.189 (n=117)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0071 (IC base=+0.179)

- **PATRÓN** `drift_60min` |x|≤ `0.4287` → IC=+0.179 (n=347)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.4287 (IC base=+0.179)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.208 (n=347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2046` → IC=+0.244 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2046 (IC base=+0.179)
...
- **PATRÓN** `volumen_regimen` < `1.2894` → IC=+0.185 (n=347)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 1.2894 (IC base=+0.179)

- **PATRÓN** `volumen_regimen` > `0.8896` → IC=+0.200 (n=231)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3602` → IC=+0.222 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3602 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `12164.5258` → IC=+0.204 (n=231)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.227 (n=119)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0081 (IC base=+0.153)
...
- **PATRÓN** `sigma_h` > `0.0227` → IC=+0.195 (n=237)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0227 (IC base=+0.166)
...
- **PATRÓN** `dist_vwap_pct` > `1.0022` → IC=+0.242 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0022 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.097` → IC=+0.245 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.097 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` > `0.8237` → IC=+0.189 (n=348)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.8237 (IC base=+0.166)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.178 (n=426)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.169 (n=131)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0035 (IC base=+0.077)

- **PATRÓN** `drift_60min` |x|≤ `0.0834` → IC=+0.132 (n=131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.0834 (IC base=+0.077)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.146 (n=145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 16.0 (IC base=+0.077)

- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.128 (n=393)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.6296 (IC base=+0.077)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.17` → IC=+0.192 (n=128)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 5.17 (IC base=+0.077)

- **PATRÓN** `volumen_regimen` < `0.6508` → IC=+0.153 (n=119)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6508 (IC base=+0.077)

- **PATRÓN** `volumen_spike_ratio` < `1.8672` → IC=+0.134 (n=225)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.8672 (IC base=+0.077)

- **PATRÓN** `libro_liquidez` > `9491.207` → IC=+0.139 (n=178)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 9491.207 (IC base=+0.077)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.210 (n=1303)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `1.0609` → IC=+0.258 (n=452)
...
- **PATRÓN** `libro_liquidez` > `3902.0492` → IC=+0.190 (n=954)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4602` → IC=+0.204 (n=2557)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4602 (IC base=+0.195)
...
- **PATRÓN** `ibs_20min` < `0.5575` → IC=+0.251 (n=2557)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5575 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` < `0.7031` → IC=+0.184 (n=2087)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.7031 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.354` → IC=+0.220 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.354 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.639` → IC=+0.199 (n=2409)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` < 2.639 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` < `0.6243` → IC=+0.186 (n=642)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6243 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` > `1.197` → IC=+0.188 (n=642)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.197 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.2821` → IC=+0.269 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2821 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` > `2.2742` → IC=+0.214 (n=843)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2742 (IC base=+0.195)

- **PATRÓN** `ballena_activa_n` < `178.0` → IC=+0.175 (n=1429)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 178.0 (IC base=+0.195)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.218 (n=211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.145 (n=466)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.291 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.308` → IC=+0.296 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.308 (IC base=+0.143)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.190 (n=253)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.175 (n=454)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 6.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.3282` → IC=+0.210 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3282 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.2491` → IC=+0.249 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2491 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.696` → IC=+0.202 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.696 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.160 (n=454)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2673 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.178 (n=206)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.099 (IC base=+0.155)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0884` → IC=+0.179 (n=356)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.0884 (IC base=+0.155)
...
- **PATRÓN** `libro_liquidez` > `11754.5395` → IC=+0.184 (n=302)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 11754.5395 (IC base=+0.155)
...
- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.329 (n=354)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.065` → IC=+0.313 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.065 (IC base=+0.265)

- **PATRÓN** `volumen_pendiente_norm` > `0.307` → IC=+0.288 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.307 (IC base=+0.265)

- **PATRÓN** `volumen_spike_ratio` < `3.3802` → IC=+0.257 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.3802 (IC base=+0.265)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5023` → IC=+0.167 (n=376)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.5023 (IC base=+0.156)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.183 (n=269)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 11.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` < `0.0817` → IC=+0.250 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0817 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.1616` → IC=+0.160 (n=189)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1616 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.6476` → IC=+0.179 (n=400)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6476 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.36` → IC=+0.242 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.36 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` < `0.597` → IC=+0.172 (n=126)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.597 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `1.1278` → IC=+0.195 (n=126)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 1.1278 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.2314` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2314 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.2005` → IC=+0.188 (n=280)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.2005 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.4586` → IC=+0.181 (n=318)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4586 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `9441.0647` → IC=+0.211 (n=171)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4769` → IC=+0.231 (n=575)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4769 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.223 (n=601)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` < `0.4887` → IC=+0.279 (n=653)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4887 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `1.2051` → IC=+0.224 (n=766)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.021` → IC=+0.217 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.021 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.255 (n=218)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5663` → IC=+0.235 (n=160)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5663 (IC base=+0.216)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.171 (n=812)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=2517)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.214 (n=785)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2543)

- **FILTRO** `ibs_20min` > `0.2723` → IC=-0.177 (n=831)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2723
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=2497)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.143 (n=2451)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5792)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.282 (n=1985)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=6258)

- **FILTRO** `ibs_7min` < `0.7347` → IC=-0.232 (n=2057)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7347
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=6186)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.173 (n=2796)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=5447)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.228 (n=2326)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=7726)

- **FILTRO** `ibs_7min` > `0.7192` → IC=-0.175 (n=2512)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7192
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=7540)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.261 (n=374)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1379)

- **FILTRO** `ibs_7min` > `0.8192` → IC=-0.193 (n=438)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8192
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=