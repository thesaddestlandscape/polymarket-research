# Hipótesis automáticas — 2026-07-02 08:09 UTC
_Generado por shadow_postmortem.py sobre 2579 resoluciones (PNL=-78.64€)_
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 21 | +0.283 | +6.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 21 | +0.283 | +6.77€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 6 | +0.075 | +2.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 6 | +0.075 | +2.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 5 | +0.054 | +1.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 5 | +0.054 | +1.59€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 800 | -0.036 | -36.53€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.083) — sin ventaja clara. oversold(IBS<0.3): IC=+0.014 n=138 | neutral: IC=-0.069 n=121 | overbought(IBS>0.7): IC=-0.047 n=137
  - _Datos_: n=410 IC=-0.032 PNL=-11.30€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.002 n=1208 | tras_1loss IC=-0.036 n=1268 | tras_2loss IC=-0.051 n=662/40 | gap=+0.053 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=677 IC=-0.030 PNL=-22.98€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=677 IC=-0.030 PNL=-22.98€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 162/200 ops en el filtro definido (IC actual=+0.061 PNL=+14.28€)
  - _Datos_: n=162 IC=+0.061 PNL=+14.28€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=162 IC=+0.061 PNL=+14.28€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=162 IC=+0.061 PNL=+14.28€
