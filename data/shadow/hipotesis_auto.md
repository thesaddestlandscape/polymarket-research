# Hipótesis automáticas — 2026-07-16 01:07 UTC
_Generado por shadow_postmortem.py sobre 16214 resoluciones (PNL=+3271.75€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.217 (n=401)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.184)

- **PATRÓN** `py_entrada` > `0.695` → IC=+0.292 (n=401)
...
- **PATRÓN** `libro_liquidez` > `4414.67` → IC=+0.184 (n=571)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 4414.67 (IC base=+0.184)
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.102 n=9412 | tras_1loss IC=+0.066 n=6595 | tras_2loss IC=+0.033 n=2831/40 | gap=+0.069 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13756 IC=+0.105 PNL=+3347.63€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13756 IC=+0.105 PNL=+3347.63€
