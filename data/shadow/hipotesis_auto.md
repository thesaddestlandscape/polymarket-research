# Hipótesis automáticas — 2026-07-10 17:01 UTC
_Generado por shadow_postmortem.py sobre 7885 resoluciones (PNL=+1201.44€)_
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=284)

- **PATRÓN** `ibs_15` > `0.7168` → IC=+0.120 (n=185)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.60€ cuando `ibs_15` > 0.7168 (IC base=-0.001)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0646` → IC=+0.138 (n=45)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.0646 (IC base=+0.036)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.157 (n=103)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 11.0 (IC base=+0.036)

- **PATRÓN** `ibs_15` < `0.9183` → IC=+0.146 (n=94)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.73€ cuando `ibs_15` < 0.9183 (IC base=+0.036)

- **PATRÓN** `ibs_15` > `0.8088` → IC=+0.146 (n=63)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.73€ cuando `ibs_15` > 0.8088 (IC base=+0.036)
...
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#BTC` — IC=+0.237 n=36. Faltan ~4 resoluciones para umbral n≥40. ETA: ~3h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#ETH` — IC=+0.244 n=37. Faltan ~3 resoluciones para umbral n≥40. ETA: ~2h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#SOL` — IC=+0.159 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 112 | +0.219 | +3.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#15min | 70 | +0.250 | +3.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 23 | -0.020 | -4.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 15 | +0.287 | +3.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 36 | +0.237 | +3.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 23 | +0.300 | +3.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 7 | -0.058 | -2.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 5 | +0.089 | +1.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 37 | +0.244 | +2.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 23 | +0.260 | +1.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 8 | +0.040 | -0.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 5 | +0.089 | +1.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 39 | +0.159 | -1.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 24 | +0.154 | -1.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 8 | +0.000 | -1.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 5 | +0.054 | +0.62€ | 0 | 0 |
| ✅ GBM_LATE_15M | 2936 | +0.115 | +959.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2936 | +0.115 | +959.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 740 | +0.061 | +75.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 740 | +0.061 | +75.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 747 | +0.078 | +124.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 747 | +0.078 | +124.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 757 | +0.149 | +396.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 757 | +0.149 | +396.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 692 | +0.176 | +362.94€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 692 | +0.176 | +362.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 390 | +0.171 | +167.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 390 | +0.171 | +167.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 96 | +0.184 | +41.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 96 | +0.184 | +41.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 106 | +0.167 | +48.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 106 | +0.167 | +48.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 109 | +0.086 | +15.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 109 | +0.086 | +15.13€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 482 | +0.081 | +92.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 482 | +0.081 | +92.13€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 116 | +0.093 | +12.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 116 | +0.093 | +12.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 121 | +0.045 | +8.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 121 | +0.045 | +8.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 120 | -0.041 | -1.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 120 | -0.041 | -1.17€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 125 | +0.216 | +72.06€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 125 | +0.216 | +72.06€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1226 | -0.015 | -3.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 971 | +0.014 | +33.60€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 326 | -0.003 | -6.81€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 248 | +0.036 | +6.06€ | 2 | 7 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.104) — sin ventaja clara. oversold(IBS<0.3): IC=-0.018 n=309 | neutral: IC=-0.059 n=234 | overbought(IBS>0.7): IC=+0.045 n=255
  - _Datos_: n=836 IC=-0.004 PNL=+21.87€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.074 n=4275 | tras_1loss IC=+0.027 n=3446 | tras_2loss IC=-0.012 n=1606/40 | gap=+0.086 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.147 n=49/60 | contraria IC=+0.089 n=16 | gap=+0.058 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.049 n=368/40 PNL=+44.48€ | H=15h UTC: IC=+0.077 n=372/40 PNL=+80.14€ | H=17h UTC: IC=+0.165 n=258/40 PNL=+115.65€ | H=19h UTC: IC=+0.034 n=249/40 PNL=+29.67€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=194 IC=-0.005 PNL=+6.53€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=194 IC=-0.005 PNL=+6.53€
...
**⏳ H-CUSTOM-GBM-17H-BTC** — GBM BTC a las 17h UTC — ¿edge real?
  ...
  - _Estado_: 14/15 ops en el filtro definido (IC actual=+0.219 PNL=+11.71€)
  - _Datos_: n=14 IC=+0.219 PNL=+11.71€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1103 IC=-0.009 PNL=+10.19€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1103 IC=-0.009 PNL=+10.19€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=545 IC=-0.001 PNL=-2.49€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=545 IC=-0.001 PNL=-2.49€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=248 IC=+0.036 PNL=+6.06€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=248 IC=+0.036 PNL=+6.06€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=480 IC=+0.035 PNL=+16.31€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=480 IC=+0.035 PNL=+16.31€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=5427 IC=+0.086 PNL=+1277.32€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=5427 IC=+0.086 PNL=+1277.32€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=692 IC=-0.033 PNL=-32.96€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=692 IC=-0.033 PNL=-32.96€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.168 > 0.1 con n=200 PNL=+68.98€
  - _Datos_: n=200 IC=+0.168 PNL=+68.98€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=133 IC=+0.056 PNL=+5.80€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=133 IC=+0.056 PNL=+5.80€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=379 IC=+0.046 PNL=+28.59€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=379 IC=+0.046 PNL=+28.59€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.171 > 0.08 con n=141 PNL=+43.76€
  - _Datos_: n=141 IC=+0.171 PNL=+43.76€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 58/80 ops en el filtro definido (IC actual=+0.250 PNL=+22.37€)
  - _Datos_: n=58 IC=+0.250 PNL=+22.37€
