# Hipótesis automáticas — 2026-07-02 03:17 UTC
_Generado por shadow_postmortem.py sobre 2527 resoluciones (PNL=-87.44€)_
...
- **PATRÓN** `ibs_15` < `0.4545` → IC=+0.124 (n=91)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.62€ cuando `ibs_15` < 0.4545 (IC base=+0.071)
...
- **FILTRO** `drift_60min` |x|> `0.3092` → IC=-0.132 (n=17)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.3092
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=10)
...
| ✅ UPDOWN_GBM | 774 | -0.035 | -36.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 552 | -0.009 | -9.82€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#SOL | 134 | -0.081 | -10.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 81 | -0.054 | -5.26€ | 6 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.080) — sin ventaja clara. oversold(IBS<0.3): IC=+0.021 n=119 | neutral: IC=-0.059 n=116 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=384 IC=-0.029 PNL=-11.53€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.200 n=28 PNL=-13.74€ → FILTRAR | H=02h: IC=-0.204 n=19 PNL=-6.24€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=81 IC=-0.054 PNL=-5.26€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.003 n=1193 | tras_1loss IC=-0.037 n=1252 | tras_2loss IC=-0.051 n=653/40 | gap=+0.054 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=651 IC=-0.028 PNL=-23.21€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=651 IC=-0.028 PNL=-23.21€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=169 IC=+0.044 PNL=+18.04€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=169 IC=+0.044 PNL=+18.04€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 110/200 ops en el filtro definido (IC actual=+0.036 PNL=+5.48€)
  - _Datos_: n=110 IC=+0.036 PNL=+5.48€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=110 IC=+0.036 PNL=+5.48€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=110 IC=+0.036 PNL=+5.48€
