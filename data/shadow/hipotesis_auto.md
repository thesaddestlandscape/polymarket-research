# Hipótesis automáticas — 2026-07-29 03:09 UTC
_Generado por shadow_postmortem.py sobre 41175 resoluciones (PNL=+8715.64€)_
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.193 (n=1314)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.191 (n=160)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0077 (IC base=+0.117)
...
- **PATRÓN** `libro_liquidez` > `8272.6248` → IC=+0.132 (n=251)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 8272.6248 (IC base=+0.117)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.149 (n=485)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.472` → IC=+0.275 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.472 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `3261.4804` → IC=+0.210 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3261.4804 (IC base=+0.116)
...
- **PATRÓN** `sigma_h` < `0.0169` → IC=+0.210 (n=561)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0169 (IC base=+0.206)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.232 (n=561)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1883` → IC=+0.318 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1883 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.391` → IC=+0.212 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.391 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.119` → IC=+0.200 (n=617)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.125 (n=1301)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.936` → IC=+0.239 (n=320)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.366` → IC=+0.167 (n=67)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 12.366 (IC base=+0.053)

- **PATRÓN** `libro_liquidez` > `6662.3921` → IC=+0.122 (n=231)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 6662.3921 (IC base=+0.053)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `6.702` → IC=+0.250 (n=134)
...
- **PATRÓN** `dist_vwap_pct` > `0.9583` → IC=+0.182 (n=64)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.9583 (IC base=+0.048)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.136 (n=141)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0055 (IC base=+0.058)
...
- **PATRÓN** `drift_15min` |x|≤ `0.4608` → IC=+0.149 (n=72)

  - _Acción_: Kelly boost +0.74€ cuando `drift_15min` |x|≤ 0.4608 (IC base=+0.035)
...
- **PATRÓN** `ibs_15` < `0.04` → IC=+0.158 (n=77)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.79€ cuando `ibs_15` < 0.04 (IC base=+0.072)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.04 sube el IC de +0.072 a +0.158 en UPDOWN_GBM#XRP#15min (n=77). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO#XRP` — IC=+0.149 n=35. Faltan ~5 resoluciones para umbral n≥40. ETA: ~4h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION` — IC=+0.378 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
- **LIVE-CANDIDATA**: `FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min` — IC=+0.378 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.
...
| ✅ FAVORITO_CONFIRMADO | 6956 | +0.177 | -53.30€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO#60min | 1241 | +0.152 | +74.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 2068 | +0.183 | -0.15€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 420 | +0.173 | +62.36€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 8 | +0.120 | +5.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 7 | +0.097 | +4.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 2437 | +0.167 | -48.97€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 415 | +0.136 | +10.45€ | 0 | 10 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 39 | +0.378 | +3.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 39 | +0.378 | +3.34€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 25 | +0.352 | +0.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 25 | +0.352 | +0.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC | 11 | +0.148 | +0.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min | 11 | +0.148 | +0.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH | 11 | +0.190 | +0.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min | 11 | +0.190 | +0.30€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 8876 | +0.094 | +2670.50€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 8876 | +0.094 | +2670.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 102 | +0.192 | +58.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 102 | +0.192 | +58.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 2095 | +0.069 | +345.46€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 2095 | +0.069 | +345.46€ | 0 | 6 |
| ✅ GBM_LATE_15M#DOGE | 102 | +0.096 | +20.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 102 | +0.096 | +20.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 1883 | +0.070 | +303.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1883 | +0.070 | +303.90€ | 0 | 7 |
| ✅ GBM_LATE_15M#SOL | 2335 | +0.084 | +792.23€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2335 | +0.084 | +792.23€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 2359 | +0.141 | +1149.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2359 | +0.141 | +1149.87€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 6087 | +0.119 | +2909.83€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 6087 | +0.119 | +2909.83€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE |