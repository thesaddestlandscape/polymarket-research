# Hipótesis automáticas — 2026-08-26 20:41 UTC
_Generado por shadow_postmortem.py sobre 166043 resoluciones (PNL=+11855.58€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `148.19` → IC=-0.283 (n=2295)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.19
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=6887)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `152.38` → IC=-0.170 (n=280)
...
- **FILTRO** `restante_s_al_confirmar` < `92.53` → IC=-0.437 (n=282)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 92.53
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=847)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `158.28` → IC=-0.193 (n=626)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.28
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1878)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `151.72` → IC=-0.268 (n=541)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 151.72
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1623)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `152.6` → IC=-0.358 (n=525)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 152.6
  - _Potencial_: sin este filtro IC_bueno=-0.120 (n=1066)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.186 (n=5236)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=1554)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2383.976` → IC=+0.174 (n=1500)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2383.976 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.150 (n=3514)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.261 (n=3224)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=2880)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `1847.4259` → IC=+0.184 (n=2410)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1847.4259 (IC base=+0.142)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=623)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.210)

- **PATRÓN** `py_entrada` > `0.795` → IC=+0.393 (n=204)
...
- **PATRÓN** `libro_liquidez` > `12715.6779` → IC=+0.224 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12715.6779 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.201 (n=559)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.325` → IC=+0.292 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.189 (n=795)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.01 (IC base=+0.189)

- **PATRÓN** `libro_liquidez` > `12049.3014` → IC=+0.221 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12049.3014 (IC base=+0.189)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=531)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.129 (n=1007)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 15.0 (IC base=+0.124)

- **PATRÓN** `py_entrada` > `0.69` → IC=+0.309 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.291 (n=414)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.282 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `2874.0653` → IC=+0.289 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2874.0653 (IC base=+0.282)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.194 (n=937)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.84` → IC=+0.443 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.84 (IC base=+0.189)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.261 (n=207)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.223)

- **PATRÓN** `py_entrada` < `0.245` → IC=+0.338 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.223)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.234 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `2027.0591` → IC=+0.260 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2027.0591 (IC base=+0.223)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=4410)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.201 (n=2117)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.167 (n=763)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.72` → IC=+0.173 (n=957)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.72 (IC base=+0.165)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.166 (n=970)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.71 (IC base=+0.165)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1127)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.157)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.165 (n=953)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 15.0 (IC base=+0.157)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.168 (n=408)

  - _Acción_: Kelly boost +0.84€ cuando `py_entrada` < 0.7 (IC base=+0.157)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.170 (n=565)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` > 0.73 (IC base=+0.157)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.240 (n=1005)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1078)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.193 (n=538)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` < 0.7 (IC base=+0.183)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.456 (n=204)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.935` → IC=+0.455 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.935 (IC base=+0.445)

- **PATRÓN** `libro_liquidez` > `3351.8902` → IC=+0.466 (n=145)
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.443 (n=85)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.427)

- **PATRÓN** `py_entrada` < `0.915` → IC=+0.430 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.915 (IC base=+0.427)

- **PATRÓN** `py_entrada` > `0.93` → IC=+0.427 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.93 (IC base=+0.427)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.425 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.427)

- **PATRÓN** `libro_liquidez` > `3734.4597` → IC=+0.474 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3734.4597 (IC base=+0.427)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.439 (n=47)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.444)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.447 (n=36)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.444)

- **PATRÓN** `py_entrada` > `0.92` → IC=+0.440 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.92 (IC base=+0.444)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.438 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.444)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.193 (n=10664)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.219 (n=8325)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.189)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.127 (n=2172)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.210 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.160)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.237 (n=1695)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.208 (n=1423)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.183)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.202 (n=1605)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.135)

- **PATRÓN** `restante_min` < `3.94` → IC=+0.140 (n=1432)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` < 3.94 (IC base=+0.135)

- **PATRÓN** `restante_min` > `4.93` → IC=+0.164 (n=1436)

  - _Acción_: Kelly boost +0.82€ cuando `restante_min` > 4.93 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.149 (n=2075)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 8.0 (IC base=+0.135)

- **PATRÓN** `lag_apertura_s` < `4.46` → IC=+0.162 (n=1422)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 4.46 (IC base=+0.135)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.207 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.143)

- **PATRÓN** `restante_min` < `4.27` → IC=+0.143 (n=941)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` < 4.27 (IC base=+0.143)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.177 (n=722)

  - _Acción_: Kelly boost +0.88€ cuando `restante_min` > 4.91 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.160 (n=1026)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 8.0 (IC base=+0.143)

- **PATRÓN** `lag_apertura_s` < `5.61` → IC=+0.177 (n=708)

  - _Acción_: Kelly boost +0.89€ cuando `lag_apertura_s` < 5.61 (IC base=+0.143)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.197 (n=802)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.38 (IC base=+0.127)

- **PATRÓN** `restante_min` < `4.41` → IC=+0.131 (n=949)

  - _Acción_: Kelly boost +0.65€ cuando `restante_min` < 4.41 (IC base=+0.127)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.160 (n=774)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.94 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.130 (n=2149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `3861.5788` → IC=+0.302 (n=256)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.337 (n=188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.302 (n=281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.285)

- **PATRÓN** `py_entrada` > `0.865` → IC=+0.438 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.865 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.300 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `1534.561` → IC=+0.340 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1534.561 (IC base=+0.285)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9479` → IC=+0.206 (n=725)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9479 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.2097` → IC=+0.234 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2097 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.741` → IC=+0.214 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.741 (IC base=+0.063)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.229` → IC=+0.169 (n=889)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.229 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.6325` → IC=+0.220 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6325 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `1.0578` → IC=+0.250 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0578 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.135 (n=236)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` < `2.4442` → IC=+0.139 (n=1023)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.4442 (IC base=+0.063)

- **PATRÓN** `ibs_20min` < `0.2121` → IC=+0.132 (n=1483)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2121 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.3016` → IC=+0.147 (n=749)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.3016 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.6357` → IC=+0.157 (n=240)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6357 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `1.0483` → IC=+0.146 (n=326)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.0483 (IC base=+0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.3022` → IC=+0.264 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3022 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` < `1.6146` → IC=+0.203 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6146 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` > `2.9145` → IC=+0.233 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9145 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.228 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.031)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.189 (n=162)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0076 (IC base=+0.114)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.168 (n=230)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 8.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.286 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.766` → IC=+0.324 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.766 (IC base=+0.114)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.298 (n=171)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.273)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.295 (n=86)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.273)

- **PATRÓN** `drift_60min` |x|≤ `0.1493` → IC=+0.332 (n=171)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1493 (IC base=+0.273)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.276 (n=243)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4388` → IC=+0.316 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4388 (IC base=+0.273)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.309 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.939 (IC base=+0.273)

- **PATRÓN** `volumen_pendiente_norm` < `0.0577` → IC=+0.297 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0577 (IC base=+0.273)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7889` → IC=+0.288 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7889 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` > `1.5366` → IC=+0.290 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5366 (IC base=+0.273)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.333 (n=118)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.245 (n=159)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3346` → IC=+0.215 (n=317)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3346 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.235 (n=364)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.224 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` > `0.2322` → IC=+0.233 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2322 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` < `0.992` → IC=+0.209 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.992 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.359` → IC=+0.240 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.359 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` < `0.7062` → IC=+0.214 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7062 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.253 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=+0.209)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4455` → IC=+0.260 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4455 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `11253.359` → IC=+0.219 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11253.359 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.195 (n=139)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0021 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.1677` → IC=+0.163 (n=277)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1677 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.149 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 8.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.151 (n=437)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 18.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` < `0.4271` → IC=+0.176 (n=365)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.4271 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.1429` → IC=+0.172 (n=349)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1429 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.938` → IC=+0.238 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.938 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.6331` → IC=+0.188 (n=139)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6331 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `1.0206` → IC=+0.144 (n=189)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.0206 (IC base=+0.143)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7427` → IC=+0.186 (n=208)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.7427 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.4117` → IC=+0.162 (n=312)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4117 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.143 (n=536)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `14075.3664` → IC=+0.181 (n=139)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 14075.3664 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `227.0` → IC=+0.197 (n=74)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 227.0 (IC base=+0.143)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.0713` → IC=+0.135 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.0713 (IC base=+0.127)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.924` → IC=+0.269 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.924 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=204)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `1919.501` → IC=+0.136 (n=196)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 1919.501 (IC base=+0.127)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.307 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.263)

- **PATRÓN** `drift_60min` |x|≤ `0.3852` → IC=+0.271 (n=313)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3852 (IC base=+0.263)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.281 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.297 (n=313)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.578` → IC=+0.262 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.578 (IC base=+0.263)

- **PATRÓN** `volumen_pendiente_norm` > `0.4178` → IC=+0.433 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.4178 (IC base=+0.263)

- **PATRÓN** `volumen_spike_ratio` < `3.6549` → IC=+0.228 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.6549 (IC base=+0.263)

- **PATRÓN** `volumen_spike_ratio` > `2.743` → IC=+0.236 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.743 (IC base=+0.263)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.281 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.263)

- **PATRÓN** `ballena_activa_n` < `46.0` → IC=+0.219 (n=112)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=63)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=710)

- **PATRÓN** `dist_vwap_pct` > `0.1404` → IC=+0.326 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1404 (IC base=-0.029)

- **PATRÓN** `dist_vwap_pct` < `0.278` → IC=+0.306 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.278 (IC base=-0.029)

- **PATRÓN** `volumen_regimen` < `0.8497` → IC=+0.321 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8497 (IC base=-0.029)

- **PATRÓN** `volumen_regimen` > `0.7485` → IC=+0.306 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7485 (IC base=-0.029)

- **PATRÓN** `volumen_spike_ratio` < `1.4384` → IC=+0.333 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4384 (IC base=-0.029)
...
- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.177 (n=29)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 123.0 (IC base=-0.055)
...
- **FILTRO** `ibs_20min` > `0.4872` → IC=-0.120 (n=633)

  - _Acción_: SKIP cuando `ibs_20min` > 0.4872
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=635)

- **FILTRO** `sigma_ewma_delta_pct` > `4.919` → IC=-0.154 (n=270)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.919
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=998)
...
- **FILTRO** `drift_60min` |x|> `0.5025` → IC=-0.149 (n=220)
...
- **FILTRO** `ibs_20min` > `0.775` → IC=-0.166 (n=285)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=857)

- **FILTRO** `sigma_ewma_delta_pct` > `6.581` → IC=-0.163 (n=191)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.581
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=951)
...
- **PATRÓN** `dist_vwap_pct` < `0.2029` → IC=+0.226 (n=155)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2029 (IC base=-0.032)

- **PATRÓN** `volumen_regimen` < `0.6966` → IC=+0.226 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6966 (IC base=-0.032)

- **PATRÓN** `volumen_regimen` > `1.1383` → IC=+0.246 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1383 (IC base=-0.032)

- **PATRÓN** `volumen_spike_ratio` > `1.9841` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.9841 (IC base=-0.032)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.133 (n=1247)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0075 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9425` → IC=+0.245 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9425 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `1.2538` → IC=+0.287 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2538 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.1561` → IC=+0.194 (n=315)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.1561 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` < `0.1146` → IC=+0.165 (n=1215)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.1146 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.2437` → IC=+0.206 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2437 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `1.4785` → IC=+0.187 (n=417)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.4785 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` > `2.8454` → IC=+0.173 (n=417)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.8454 (IC base=+0.052)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.264 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.0943` → IC=+0.182 (n=1172)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.0943 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` > `1.1146` → IC=+0.214 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1146 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.1474` → IC=+0.206 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1474 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `1.2342` → IC=+0.232 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2342 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.2516` → IC=+0.368 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2516 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` > `1.6267` → IC=+0.261 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6267 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.261 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.041)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2441` → IC=-0.154 (n=180)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.132` → IC=+0.182 (n=105)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 5.132 (IC base=-0.013)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3584` → IC=+0.206 (n=32)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3584 (IC base=-0.013)
...
- **PATRÓN** `drift_60min` |x|≤ `0.099` → IC=+0.207 (n=186)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.099 (IC base=+0.177)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1444` → IC=+0.186 (n=320)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1444 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.425` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.425 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` < `2.0195` → IC=+0.171 (n=150)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.0195 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `3.6591` → IC=+0.175 (n=155)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 3.6591 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.224 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.177)

- **PATRÓN** `libro_liquidez` > `1917.5696` → IC=+0.211 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1917.5696 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.186 (n=116)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 58.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.354 (n=224)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.349)

- **PATRÓN** `drift_60min` |x|≤ `0.3471` → IC=+0.354 (n=197)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3471 (IC base=+0.349)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.395 (n=150)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.349)

- **PATRÓN** `ibs_20min` < `0.3009` → IC=+0.362 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3009 (IC base=+0.349)

- **PATRÓN** `ibs_20min` > `0.1308` → IC=+0.354 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1308 (IC base=+0.349)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.402` → IC=+0.354 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.402 (IC base=+0.349)

- **PATRÓN** `volumen_pendiente_norm` > `0.1035` → IC=+0.375 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1035 (IC base=+0.349)

- **PATRÓN** `volumen_spike_ratio` < `1.7842` → IC=+0.370 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7842 (IC base=+0.349)

- **PATRÓN** `volumen_spike_ratio` > `1.997` → IC=+0.349 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.997 (IC base=+0.349)

- **PATRÓN** `libro_liquidez` > `1904.2932` → IC=+0.370 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1904.2932 (IC base=+0.349)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.333 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 22.0 (IC base=+0.349)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=66)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=894)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.573` → IC=-0.123 (n=213)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.573
...
- **PATRÓN** `ibs_20min` > `0.85` → IC=+0.252 (n=155)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.85 (IC base=-0.013)

- **PATRÓN** `dist_vwap_pct` > `0.3163` → IC=+0.253 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3163 (IC base=-0.013)

- **PATRÓN** `volumen_regimen` < `0.8598` → IC=+0.181 (n=117)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.8598 (IC base=-0.013)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4966` → IC=+0.167 (n=55)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4966 (IC base=-0.013)

- **PATRÓN** `volumen_spike_ratio` > `2.0538` → IC=+0.171 (n=74)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.0538 (IC base=-0.013)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.211 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 53.0 (IC base=-0.013)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.226 (n=206)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.8983` → IC=+0.293 (n=365)
...
- **PATRÓN** `volumen_regimen` > `0.8342` → IC=+0.249 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8342 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` < `0.0802` → IC=+0.220 (n=465)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2771` → IC=+0.264 (n=70)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2771 (IC base=+0.213)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.233 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `2658.435` → IC=+0.236 (n=365)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4819` → IC=+0.273 (n=496)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4819 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.280 (n=526)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.269)

- **PATRÓN** `ibs_20min` < `0.2766` → IC=+0.325 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2766 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` < `0.891` → IC=+0.275 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.891 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.724` → IC=+0.320 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.724 (IC base=+0.269)

- **PATRÓN** `volumen_regimen` > `1.2535` → IC=+0.305 (n=188)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.282 (n=1172)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.7858` → IC=+0.251 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7858 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.33` → IC=+0.248 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.33 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `0.6824` → IC=+0.169 (n=1471)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.6824 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.1017` → IC=+0.178 (n=842)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1017 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.2798` → IC=+0.151 (n=1868)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.2798 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.8521` → IC=+0.146 (n=1415)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8521 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=1941)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `3932.3605` → IC=+0.188 (n=790)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 3932.3605 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.171 (n=1129)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 125.0 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.202 (n=1867)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.4068` → IC=+0.199 (n=2122)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4068 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.216 (n=808)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` < `0.4088` → IC=+0.238 (n=2122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4088 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.3609` → IC=+0.177 (n=1864)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3609 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.805` → IC=+0.224 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.805 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` < `1.1778` → IC=+0.167 (n=1719)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1778 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` > `0.8617` → IC=+0.173 (n=1146)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8617 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.251 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` < `1.8761` → IC=+0.178 (n=1008)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.8761 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.6198` → IC=+0.209 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6198 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `202.0` → IC=+0.183 (n=1082)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 202.0 (IC base=+0.185)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.217 (n=175)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.2465` → IC=+0.149 (n=383)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.2465 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.204 (n=187)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.308 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.973` → IC=+0.347 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.973 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.1422` → IC=+0.163 (n=90)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1422 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.4227` → IC=+0.129 (n=305)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.4227 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.165 (n=225)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.04 (IC base=+0.143)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3308` → IC=+0.314 (n=186)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4088` → IC=+0.298 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4088 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.838` → IC=+0.285 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.838 (IC base=+0.267)

- **PATRÓN** `volumen_pendiente_norm` < `0.0799` → IC=+0.273 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0799 (IC base=+0.267)

- **PATRÓN** `volumen_pendiente_norm` > `0.3103` → IC=+0.250 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3103 (IC base=+0.267)

- **PATRÓN** `volumen_spike_ratio` < `1.7907` → IC=+0.309 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7907 (IC base=+0.267)

- **PATRÓN** `volumen_spike_ratio` > `2.8103` → IC=+0.291 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8103 (IC base=+0.267)
...
- **PATRÓN** `libro_liquidez` > `1985.6048` → IC=+0.344 (n=62)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1985.6048 (IC base=+0.267)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.296 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=+0.267)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.233 (n=114)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.209 (n=335)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.178)

- **PATRÓN** `ibs_20min` > `0.9955` → IC=+0.287 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9955 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` > `0.2093` → IC=+0.250 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2093 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.683` → IC=+0.244 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.683 (IC base=+0.178)

- **PATRÓN** `volumen_regimen` < `0.6325` → IC=+0.193 (n=112)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.6325 (IC base=+0.178)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.208 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0851 (IC base=+0.178)

- **PATRÓN** `volumen_pendiente_norm` > `0.2116` → IC=+0.258 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2116 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` < `1.3851` → IC=+0.231 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3851 (IC base=+0.178)

- **PATRÓN** `libro_liquidez` > `12066.18` → IC=+0.202 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12066.18 (IC base=+0.178)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.172 (n=431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0055 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.2908` → IC=+0.178 (n=430)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4047` → IC=+0.190 (n=430)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.4047 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1617` → IC=+0.179 (n=422)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1617 (IC base=+0.152)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.235 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `1.7385` → IC=+0.177 (n=215)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.7385 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `14200.6298` → IC=+0.164 (n=144)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 14200.6298 (IC base=+0.152)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1433` → IC=+0.161 (n=228)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1433 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.154 (n=134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 16.0 (IC base=+0.148)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2288` → IC=+0.143 (n=281)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.2288 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `1.9992` → IC=+0.198 (n=124)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.9992 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.192 (n=157)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.01 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `1962.7584` → IC=+0.172 (n=114)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1962.7584 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.306 (n=96)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.284)

- **PATRÓN** `drift_60min` |x|≤ `0.1997` → IC=+0.318 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1997 (IC base=+0.284)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.328 (n=149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.284)

- **PATRÓN** `ibs_20min` < `0.3` → IC=+0.320 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3 (IC base=+0.284)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3761` → IC=+0.426 (n=25)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3761 (IC base=+0.284)

- **PATRÓN** `volumen_spike_ratio` > `2.0029` → IC=+0.292 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0029 (IC base=+0.284)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.255 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.284)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.217 (n=337)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0094 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4977` → IC=+0.199 (n=337)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4977 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.210 (n=302)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.182)

- **PATRÓN** `ibs_20min` > `0.4502` → IC=+0.240 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4502 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` > `0.9816` → IC=+0.236 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9816 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.328` → IC=+0.321 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.328 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.198 (n=336)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 0.6356 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.1005` → IC=+0.236 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1005 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` < `1.4303` → IC=+0.221 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4303 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.4212` → IC=+0.221 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4212 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=382)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.01 (IC base=+0.182)

- **PATRÓN** `libro_liquidez` > `8688.9164` → IC=+0.208 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8688.9164 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.181 (n=183)
...
- **FILTRO** `ibs_20min` > `0.4107` → IC=-0.192 (n=131)

  - _Acción_: SKIP cuando `ibs_20min` > 0.4107
  - _Potencial_: sin este filtro IC_bueno=+0.231 (n=395)

- **PATRÓN** `sigma_h` > `0.0116` → IC=+0.204 (n=157)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.261 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.7834` → IC=+0.273 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7834 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.191` → IC=+0.287 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.191 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` > `0.6783` → IC=+0.135 (n=420)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.6783 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `1.5618` → IC=+0.127 (n=392)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.5618 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2913.4394` → IC=+0.184 (n=213)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 2913.4394 (IC base=+0.115)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.187 (n=132)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0049 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=141)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` < `0.4107` → IC=+0.231 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4107 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` < `0.2166` → IC=+0.140 (n=367)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2166 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.682` → IC=+0.192 (n=76)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 6.682 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` > `0.8568` → IC=+0.168 (n=263)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.8568 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` > `0.2196` → IC=+0.202 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2196 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` > `2.0432` → IC=+0.191 (n=121)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.0432 (IC base=+0.125)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=335)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `2065.052` → IC=+0.172 (n=263)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2065.052 (IC base=+0.125)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0227` → IC=+0.190 (n=230)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0227 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.1632` → IC=+0.190 (n=224)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1632 (IC base=+0.161)
...
- **PATRÓN** `ibs_20min` > `0.9245` → IC=+0.259 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9245 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `1.6566` → IC=+0.254 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6566 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.057` → IC=+0.242 (n=273)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.057 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` < `1.1875` → IC=+0.161 (n=508)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1875 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `0.8237` → IC=+0.185 (n=338)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.8237 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.0804` → IC=+0.218 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0804 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.175 (n=414)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6625` → IC=+0.235 (n=485)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6625 (IC base=+0.221)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.225 (n=234)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3738` → IC=+0.258 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3738 (IC base=+0.221)

- **PATRÓN** `dist_vwap_pct` < `0.8572` → IC=+0.229 (n=577)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8572 (IC base=+0.221)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.175` → IC=+0.283 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.175 (IC base=+0.221)

- **PATRÓN** `volumen_regimen` > `0.717` → IC=+0.245 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.717 (IC base=+0.221)

- **PATRÓN** `volumen_pendiente_norm` > `0.2431` → IC=+0.338 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2431 (IC base=+0.221)

- **PATRÓN** `volumen_spike_ratio` > `2.6983` → IC=+0.269 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6983 (IC base=+0.221)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.189 (n=268)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 32.0 (IC base=+0.221)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.189 (n=162)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 17.0 (IC base=+0.080)

- **PATRÓN** `ibs_20min` > `0.6242` → IC=+0.143 (n=362)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.6242 (IC base=+0.080)

- **PATRÓN** `dist_vwap_pct` > `0.7767` → IC=+0.240 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7767 (IC base=+0.080)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.287` → IC=+0.195 (n=116)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 8.287 (IC base=+0.080)
...
- **PATRÓN** `libro_liquidez` > `2902.7974` → IC=+0.125 (n=270)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2902.7974 (IC base=+0.080)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.182 (n=124)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0034 (IC base=+0.077)

- **PATRÓN** `drift_60min` |x|≤ `0.1106` → IC=+0.124 (n=163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.1106 (IC base=+0.077)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.150 (n=138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 16.0 (IC base=+0.077)

- **PATRÓN** `ibs_20min` < `0.6219` → IC=+0.124 (n=370)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.6219 (IC base=+0.077)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.192` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.192 (IC base=+0.077)

- **PATRÓN** `volumen_regimen` < `0.7418` → IC=+0.139 (n=153)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.7418 (IC base=+0.077)

- **PATRÓN** `volumen_spike_ratio` < `1.852` → IC=+0.141 (n=210)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.852 (IC base=+0.077)

- **PATRÓN** `libro_liquidez` > `3963.5811` → IC=+0.133 (n=246)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 3963.5811 (IC base=+0.077)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.259 (n=27)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.023)

- **PATRÓN** `ibs_20min` > `0.9291` → IC=+0.237 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9291 (IC base=+0.023)

- **PATRÓN** `dist_vwap_pct` > `0.2015` → IC=+0.151 (n=41)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.2015 (IC base=+0.023)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.351` → IC=+0.149 (n=35)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.351 (IC base=+0.023)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.239 (n=67)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0052` → IC=+0.214 (n=68)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0052 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.199 (n=151)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3402 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.192 (n=50)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 17.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.179 (n=135)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 14.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.6664` → IC=+0.193 (n=151)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6664 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.1967` → IC=+0.186 (n=135)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1967 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.323` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.323 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.199 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1856 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.0873` → IC=+0.330 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0873 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5164` → IC=+0.234 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5164 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2716` → IC=+0.194 (n=47)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.2716 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `137.0` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 137.0 (IC base=+0.168)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.207 (n=1246)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.154 (n=2495)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 8.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.9412` → IC=+0.288 (n=1248)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9412 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `1.0689` → IC=+0.251 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0689 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.355` → IC=+0.246 (n=1165)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.355 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.7018` → IC=+0.150 (n=856)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7018 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.0795` → IC=+0.153 (n=882)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.0795 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1643` → IC=+0.182 (n=694)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1643 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.8738` → IC=+0.157 (n=1621)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8738 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=2245)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `3867.0403` → IC=+0.193 (n=916)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 3867.0403 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.190 (n=1206)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 160.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.229 (n=1649)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.195)

- **PATRÓN** `drift_60min` |x|≤ `0.4581` → IC=+0.203 (n=2473)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4581 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=916)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.555` → IC=+0.251 (n=2473)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.555 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` < `0.7203` → IC=+0.183 (n=2028)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.7203 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.417` → IC=+0.226 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.417 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.646` → IC=+0.199 (n=2324)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` < 2.646 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` < `0.6247` → IC=+0.185 (n=624)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6247 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` > `1.193` → IC=+0.187 (n=624)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.193 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.2808` → IC=+0.272 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2808 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` > `2.2519` → IC=+0.210 (n=805)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2519 (IC base=+0.195)

- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.172 (n=1346)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 181.0 (IC base=+0.195)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.219 (n=201)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.8232` → IC=+0.247 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8232 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.503` → IC=+0.355 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.503 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2129` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2129 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.8938` → IC=+0.134 (n=241)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.8938 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.174 (n=228)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.04 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.322 (n=178)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.278)

- **PATRÓN** `drift_60min` |x|≤ `0.158` → IC=+0.316 (n=177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.158 (IC base=+0.278)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.280 (n=252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.335 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5833 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.039` → IC=+0.303 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.039 (IC base=+0.278)

- **PATRÓN** `volumen_pendiente_norm` < `0.0668` → IC=+0.284 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0668 (IC base=+0.278)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4785` → IC=+0.290 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4785 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.314 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `1995.6702` → IC=+0.346 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1995.6702 (IC base=+0.278)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 72.0 (IC base=+0.278)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.187 (n=145)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0028 (IC base=+0.156)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.214 (n=145)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.186 (n=390)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 8.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` > `0.3266` → IC=+0.207 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3266 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.2647` → IC=+0.247 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2647 (IC base=+0.156)
...
- **PATRÓN** `volumen_regimen` < `0.6489` → IC=+0.167 (n=145)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6489 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `1.0941` → IC=+0.188 (n=197)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.0941 (IC base=+0.156)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.184 (n=340)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.7052` → IC=+0.195 (n=257)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.7052 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `11753.1829` → IC=+0.192 (n=290)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11753.1829 (IC base=+0.156)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.204 (n=140)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.170)

- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.174 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0057 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.2654` → IC=+0.183 (n=367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.2654 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.177 (n=394)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 7.0 (IC base=+0.170)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.180 (n=432)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 18.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` < `0.3756` → IC=+0.218 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3756 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` < `0.7539` → IC=+0.179 (n=462)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.7539 (IC base=+0.170)
...
- **PATRÓN** `volumen_regimen` < `0.6259` → IC=+0.238 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6259 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.1496` → IC=+0.288 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1496 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `2.4765` → IC=+0.197 (n=321)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.4765 (IC base=+0.170)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=538)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `11946.4414` → IC=+0.175 (n=189)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 11946.4414 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `313.0` → IC=+0.197 (n=74)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 313.0 (IC base=+0.170)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.0718` → IC=+0.183 (n=121)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.0718 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.241 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.176)

- **PATRÓN** `ibs_20min` > `0.7131` → IC=+0.258 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7131 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.113` → IC=+0.342 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.113 (IC base=+0.176)

- **PATRÓN** `volumen_pendiente_norm` < `0.1458` → IC=+0.181 (n=268)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` < 0.1458 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` < `2.0881` → IC=+0.185 (n=128)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.0881 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `2.8216` → IC=+0.167 (n=193)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.8216 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.197 (n=176)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.01 (IC base=+0.176)

- **PATRÓN** `libro_liquidez` > `1919.501` → IC=+0.195 (n=165)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 1919.501 (IC base=+0.176)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.231 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.336 (n=150)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0059 (IC base=+0.267)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.290 (n=227)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5575` → IC=+0.335 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5575 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.093` → IC=+0.306 (n=70)
...
- **PATRÓN** `volumen_spike_ratio` < `3.4029` → IC=+0.264 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.4029 (IC base=+0.267)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.274 (n=144)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.153 (n=439)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.3491` → IC=+0.198 (n=438)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3491 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.8828` → IC=+0.206 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8828 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.499` → IC=+0.195 (n=211)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 4.499 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `0.6318` → IC=+0.191 (n=147)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.6318 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `1.1984` → IC=+0.162 (n=146)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.1984 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2675` → IC=+0.278 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2675 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.4097` → IC=+0.237 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4097 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `5255.5941` → IC=+0.231 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5255.5941 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.189 (n=210)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 167.0 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.215 (n=121)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.5098` → IC=+0.161 (n=361)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.5098 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.178 (n=253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 11.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.0802` → IC=+0.245 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0802 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1614` → IC=+0.163 (n=185)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1614 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.6649` → IC=+0.173 (n=387)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.6649 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.454` → IC=+0.250 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.454 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.596` → IC=+0.175 (n=121)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.596 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.1275` → IC=+0.183 (n=121)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.1275 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.2303` → IC=+0.337 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2303 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.1935` → IC=+0.188 (n=267)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.1935 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `9345.63` → IC=+0.205 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9345.63 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.240 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=+0.152)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.168 (n=221)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0107 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.131 (n=334)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 12.0 (IC base=+0.095)

- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.299 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `0.7681` → IC=+0.254 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7681 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.428` → IC=+0.223 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.428 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.282 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2898.7698 (IC base=+0.095)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.172 (n=263)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 68.0 (IC base=+0.095)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.180 (n=201)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0059 (IC base=+0.120)

- **PATRÓN** `drift_60min` |x|≤ `0.5138` → IC=+0.130 (n=457)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.5138 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.178 (n=212)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.120)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.126 (n=161)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 5.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` < `0.5789` → IC=+0.202 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5789 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` < `0.4633` → IC=+0.141 (n=418)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4633 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.03` → IC=+0.137 (n=447)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 3.03 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` < `0.7039` → IC=+0.155 (n=201)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7039 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.172 (n=123)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.7467` → IC=+0.168 (n=206)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.7467 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=476)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `2571.994` → IC=+0.171 (n=208)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2571.994 (IC base=+0.120)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0262` → IC=+0.211 (n=195)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9643` → IC=+0.294 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9643 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` > `1.4791` → IC=+0.286 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.4791 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.053` → IC=+0.248 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.053 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `0.6105` → IC=+0.185 (n=195)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6105 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `1.0357` → IC=+0.198 (n=266)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 1.0357 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2344` → IC=+0.250 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2344 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` < `1.5572` → IC=+0.167 (n=235)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5572 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `1.8207` → IC=+0.184 (n=356)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.8207 (IC base=+0.171)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=640)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.171)

- **PATRÓN** `libro_liquidez` > `3107.0284` → IC=+0.185 (n=195)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 3107.0284 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.217 (n=312)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4659` → IC=+0.228 (n=561)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4659 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.226 (n=593)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.214)

- **PATRÓN** `ibs_20min` < `0.4884` → IC=+0.279 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4884 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `1.2198` → IC=+0.223 (n=745)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.03` → IC=+0.218 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.03 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` > `1.2292` → IC=+0.254 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2292 (IC base=+0.214)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5474` → IC=+0.237 (n=154)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.153 (n=920)

- **PATRÓN** `sigma_h` < `0.0099` → IC=+0.132 (n=378)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0099 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.154 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 17.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` > `0.8318` → IC=+0.135 (n=195)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` > 0.8318 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `1.4176` → IC=+0.199 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.4176 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `0.7072` → IC=+0.147 (n=165)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.7072 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` > `0.9016` → IC=+0.121 (n=249)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.9016 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` > `0.1531` → IC=+0.161 (n=122)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.1531 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` < `1.4918` → IC=+0.138 (n=186)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4918 (IC base=+0.108)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=409)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `8243.4336` → IC=+0.149 (n=286)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8243.4336 (IC base=+0.108)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.206 (n=236)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.3523` → IC=+0.168 (n=618)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3523 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.164 (n=254)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6304` → IC=+0.157 (n=618)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.6304 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6298` → IC=+0.171 (n=156)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6298 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.8038` → IC=+0.145 (n=798)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.8038 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.117` → IC=+0.158 (n=314)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.117 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.046` → IC=+0.148 (n=705)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.046 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.2228` → IC=+0.161 (n=689)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2228 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.0698` → IC=+0.165 (n=335)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0698 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4775` → IC=+0.165 (n=694)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4775 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.513` → IC=+0.151 (n=620)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.513 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=920)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `8480.9204` → IC=+0.153 (n=702)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 8480.9204 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.175 (n=38)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0054 (IC base=+0.071)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.133 (n=58)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 10.0 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.6191` → IC=+0.200 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6191 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` > `0.6418` → IC=+0.196 (n=44)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.6418 (IC base=+0.071)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.472` → IC=+0.150 (n=58)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.472 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` < `0.1007` → IC=+0.139 (n=59)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.1007 (IC base=+0.071)

- **PATRÓN** `libro_liquidez` > `12609.7541` → IC=+0.179 (n=51)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 12609.7541 (IC base=+0.071)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.164 (n=394)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0063 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.3507` → IC=+0.155 (n=395)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3507 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=150)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 17.0 (IC base=+0.144)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.198 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 5.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` < `0.1587` → IC=+0.174 (n=173)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.1587 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.6202` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.6202 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.363` → IC=+0.155 (n=398)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 6.363 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `1.1826` → IC=+0.151 (n=394)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1826 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6267` → IC=+0.151 (n=393)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6267 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.0707` → IC=+0.186 (n=183)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.0707 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `2.5395` → IC=+0.160 (n=392)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.5395 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.7842` → IC=+0.146 (n=261)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7842 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `11894.422` → IC=+0.150 (n=352)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 11894.422 (IC base=+0.144)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.183 (n=184)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0091 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4393` → IC=+0.161 (n=184)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4393 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.230 (n=72)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.2929` → IC=+0.160 (n=92)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.2929 (IC base=+0.136)
...
- **PATRÓN** `dist_vwap_pct` > `1.0249` → IC=+0.207 (n=56)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0249 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.4111` → IC=+0.152 (n=179)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4111 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.264` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 11.264 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.085` → IC=+0.143 (n=208)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 7.085 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.6658` → IC=+0.181 (n=70)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6658 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.0815` → IC=+0.163 (n=96)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0815 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.2272` → IC=+0.169 (n=179)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.2272 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.135 (n=228)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `8856.6618` → IC=+0.188 (n=187)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 8856.6618 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.174 (n=210)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0088 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.4064` → IC=+0.201 (n=185)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4064 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.153 (n=70)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 18.0 (IC base=+0.151)

- **PATRÓN** `hora_utc` < `9.0` → IC=+0.183 (n=140)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 9.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.612` → IC=+0.152 (n=185)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.612 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.089` → IC=+0.184 (n=210)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.089 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.1925` → IC=+0.156 (n=88)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1925 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.3474` → IC=+0.165 (n=204)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.3474 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.347` → IC=+0.196 (n=67)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 6.347 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6723` → IC=+0.264 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6723 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` < `0.1284` → IC=+0.170 (n=213)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` < 0.1284 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.1395` → IC=+0.205 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1395 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.5125` → IC=+0.186 (n=183)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.5125 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `10385.425` → IC=+0.194 (n=70)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 10385.425 (IC base=+0.151)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.126 (n=113)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 6.0 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2605.1459` → IC=+0.204 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2605.1459 (IC base=+0.107)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.146 (n=46)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `py_entrada` < 0.495 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `3248.9834` → IC=+0.207 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3248.9834 (IC base=+0.131)
...
- **FILTRO** `ibs_20min` > `0.9593` → IC=-0.190 (n=85)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.171 (n=765)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2375)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.211 (n=742)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=2412)

- **FILTRO** `ibs_20min` > `0.2721` → IC=-0.175 (n=788)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2721
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=2366)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.228 (n=112)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=344)

- **FILTRO** `ibs_20min` < `0.7294` → IC=-0.181 (n=114)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7294
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=342)

- **FILTRO** `ibs_20min` > `0.7372` → IC=-0.135 (n=135)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7372
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=406)

### MOMENTUM_IBS_15M_BALLENA#BTC#15min
- **FILTRO** `py_entrada` > `0.57` → IC=-0.223 (n=128)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=402)

- **FILTRO** `ballena_activa_n` > `80.0` → IC=-0.164 (n=132)

  - _Acción_: SKIP cuando `ballena_activa_n` > 80.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=398)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.188 (n=200)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=271)

- **FILTRO** `ibs_20min` < `0.7277` → IC=-0.206 (n=117)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7277
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=354)
...
- **FILTRO** `ibs_20min` > `0.7596` → IC=-0.194 (n=132)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7596
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=399)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.133 (n=137)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=434)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.186 (n=151)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=407)

- **FILTRO** `ballena_activa_n` > `5.0` → IC=-0.152 (n=176)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.218 (n=115)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=381)

- **FILTRO** `drift_20min_pct` |x|> `0.2833` → IC=-0.135 (n=168)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.2833
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=328)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.164 (n=123)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=373)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.153 (n=122)

  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=374)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.218 (n=129)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=393)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.243 (n=169)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=329)

- **FILTRO** `ibs_20min` > `0.283` → IC=-0.230 (n=124)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=1901)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=5869)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.287 (n=1861)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=5909)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.236 (n=1940)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=5830)

- **FILTRO** `ballena_activa_n` > `20.0` → IC=-0.175 (n=2572)

  - _Acción_: SKIP cuando `ballena_activa_n` > 20.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=5198)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.222 (n=2382)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=7153)

- **FILTRO** `ibs_7min` > `0.7169` → IC=-0.168 (n=2383)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7169
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=7152)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.161 (n=237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=812)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.331 (n=252)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=797)

- **FILTRO** `ibs_7min` < `0.9818` → IC=-0.201 (n=691)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9818
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=358)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.263 (n=260)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=789)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=396)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1230)

- **FILTRO** `drift_7min_pct` |x|> `0.1399` → IC=-0.153 (n=552)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1399
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1074)

- **FILTRO** `ibs_7min` > `0.837` → IC=-0.189 (n=406)

  - _Acción_: SKIP cuando `ibs_7min` > 0.837
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1220)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.239 (n=378)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1160)

- **FILTRO** `ibs_7min` < `0.8038` → IC=-0.166 (n=384)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8038
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1154)

- **FILTRO** `ballena_activa_n` > `155.0` → IC=-0.180 (n=383)

  - _Acción_: SKIP cuando `ballena_activa_n` > 155.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1155)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.228 (n=380)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1197)

- **FILTRO** `ballena_activa_n` > `130.0` → IC=-0.167 (n=394)

  - _Acción_: SKIP cuando `ballena_activa_n` > 130.0
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1183)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.193 (n=262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.105 (n=839)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.317 (n=358)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=743)

- **FILTRO** `ibs_7min` < `0.2097` → IC=-0.287 (n=275)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2097
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=826)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.273 (n=275)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=826)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.262 (n=355)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1308)

- **FILTRO** `ibs_7min` > `0.8179` → IC=-0.183 (n=415)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8179
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1248)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.150 (n=389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=932)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.255 (n=329)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=992)

- **FILTRO** `ibs_7min` < `0.765` → IC=-0.187 (n=330)

  - _Acción_: SKIP cuando `ibs_7min` < 0.765
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=991)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.216 (n=325)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=996)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.126 (n=437)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=876)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.286 (n=316)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=997)

- **FILTRO** `ibs_7min` > `0.2707` → IC=-0.169 (n=327)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2707
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=986)

- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.208 (n=323)

  - _Acción_: SKIP cuando `ballena_activa_n` > 38.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=990)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.241 (n=346)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=1126)

- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.208 (n=368)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1104)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.209 (n=355)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1117)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.176 (n=433)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1322)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.277 (n=317)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=972)

- **FILTRO** `ibs_7min` < `0.7534` → IC=-0.216 (n=322)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7534
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=967)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.236 (n=309)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=980)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.265 (n=317)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1284)

- **FILTRO** `ibs_7min` > `0.8272` → IC=-0.154 (n=400)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8272
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1201)
...
- **PATRÓN** `streak_len` < `3.0` → IC=+0.132 (n=142)

  - _Acción_: Kelly boost +0.66€ cuando `streak_len` < 3.0 (IC base=+0.063)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1147)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=657)
...
- **PATRÓN** `ibs_15` < `0.1136` → IC=+0.138 (n=423)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.69€ cuando `ibs_15` < 0.1136 (IC base=+0.027)
...
- **FILTRO** `ibs_15` < `0.675` → IC=-0.220 (n=23)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.135 (n=168)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0052 (IC base=+0.017)
...
- **FILTRO** `drift_15min` |x|> `0.5559` → IC=-0.173 (n=99)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.5559
...
- **PATRÓN** `ibs_15` < `0.1282` → IC=+0.210 (n=105)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1282 (IC base=+0.050)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.398 (n=47)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0057 (IC base=+0.305)

- **PATRÓN** `drift_60min` |x|≤ `0.0582` → IC=+0.340 (n=48)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0582 (IC base=+0.305)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1529` → IC=+0.323 (n=94)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1529 (IC base=+0.305)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3943` → IC=+0.375 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3943 (IC base=+0.305)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.319 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.305)

- **PATRÓN** `ibs_15` > `0.7314` → IC=+0.374 (n=141)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7314 (IC base=+0.305)

- **PATRÓN** `dist_vwap_pct` > `0.4531` → IC=+0.357 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4531 (IC base=+0.305)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.489` → IC=+0.335 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.489 (IC base=+0.305)

- **PATRÓN** `libro_liquidez` > `7959.8654` → IC=+0.378 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7959.8654 (IC base=+0.305)

- **PATRÓN** `ballena_activa_n` < `540.0` → IC=+0.373 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 540.0 (IC base=+0.305)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1971` → IC=+0.294 (n=71)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1971 (IC base=+0.280)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.289 (n=36)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.280)

- **PATRÓN** `drift_60min` |x|≤ `0.1567` → IC=+0.308 (n=71)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1567 (IC base=+0.280)

- **PATRÓN** `drift_15min` |x|≤ `0.4366` → IC=+0.316 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4366 (IC base=+0.280)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.309 (n=87)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.4311` → IC=+0.380 (n=23)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4311 (IC base=+0.280)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.871` → IC=+0.292 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.871 (IC base=+0.280)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.328 (n=27)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0039 (IC base=+0.331)

- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.400 (n=28)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.331)

- **PATRÓN** `drift_60min` |x|≤ `0.0504` → IC=+0.370 (n=21)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0504 (IC base=+0.331)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1501` → IC=+0.384 (n=41)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1501 (IC base=+0.331)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2773` → IC=+0.344 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2773 (IC base=+0.331)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.337 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.331)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.339 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.331)

- **PATRÓN** `ibs_15` > `0.7053` → IC=+0.421 (n=61)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7053 (IC base=+0.331)

- **PATRÓN** `dist_vwap_pct` < `0.3445` → IC=+0.339 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3445 (IC base=+0.331)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.588` → IC=+0.403 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.588 (IC base=+0.331)

- **PATRÓN** `libro_liquidez` > `3261.6008` → IC=+0.360 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3261.6008 (IC base=+0.331)

- **PATRÓN** `ballena_activa_n` < `198.0` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 198.0 (IC base=+0.331)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.232` → IC=-0.178 (n=333)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.232
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2394)
...
- **PATRÓN** `ibs_15` > `0.4526` → IC=+0.162 (n=294)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` > 0.4526 (IC base=-0.056)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.095` → IC=+0.395 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.095 (IC base=-0.077)

- **PATRÓN** `ibs_15` < `0.328` → IC=+0.354 (n=128)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.328 (IC base=-0.077)

- **PATRÓN** `dist_vwap_pct` < `0.1907` → IC=+0.273 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1907 (IC base=-0.077)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.309 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=-0.077)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0064` → IC=-0.228 (n=204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0064
  - _Potencial_: sin este filtro IC_bueno=-0.193 (n=398)

- **FILTRO** `sigma_h` < `0.0027` → IC=-0.210 (n=150)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0027
  - _Potencial_: sin este filtro IC_bueno=-0.203 (n=452)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.243 (n=146)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=456)

- **FILTRO** `sigma_ewma_delta_pct` > `19.895` → IC=-0.263 (n=112)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.895
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=490)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1058` → IC=+0.250 (n=54)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1058 (IC base=+0.243)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.304 (n=54)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.243)

- **PATRÓN** `drift_15min` |x|≤ `0.4277` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4277 (IC base=+0.243)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1065` → IC=+0.270 (n=72)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1065 (IC base=+0.243)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1083` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1083 (IC base=+0.243)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.293 (n=27)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.243)

- **PATRÓN** `ibs_15` < `0.3357` → IC=+0.343 (n=81)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3357 (IC base=+0.243)

- **PATRÓN** `dist_vwap_pct` > `0.1453` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1453 (IC base=+0.243)

- **PATRÓN** `dist_vwap_pct` < `0.1097` → IC=+0.241 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1097 (IC base=+0.243)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.326` → IC=+0.277 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.326 (IC base=+0.243)

- **PATRÓN** `libro_liquidez` > `13146.4244` → IC=+0.328 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13146.4244 (IC base=+0.243)

- **PATRÓN** `ballena_activa_n` < `213.0` → IC=+0.255 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 213.0 (IC base=+0.243)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `drift_15min` |x|> `0.751` → IC=-0.183 (n=58)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.136 (n=20)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=213)

- **FILTRO** `sigma_ewma_delta_pct` > `12.727` → IC=-0.140 (n=145)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 12.727
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=793)

- **PATRÓN** `ibs_15` > `0.8125` → IC=+0.206 (n=15)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8125 (IC base=-0.100)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `drift_15min` |x|> `1.025` → IC=-0.194 (n=60)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.025
  - _Potencial_: sin este filtro IC_bueno=-0.112 (n=181)
...
- **FILTRO** `libro_liquidez` < `2584.4484` → IC=-0.191 (n=79)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.104 (n=162)

- **FILTRO** `sigma_ewma_delta_pct` > `9.144` → IC=-0.129 (n=195)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 9.144
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=676)

### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.281 (n=149)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0041 (IC base=+0.273)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0553` → IC=+0.318 (n=75)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0553 (IC base=+0.273)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1882` → IC=+0.325 (n=101)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1882 (IC base=+0.273)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.382` → IC=+0.317 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.382 (IC base=+0.273)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.305 (n=229)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.273)

- **PATRÓN** `ibs_15` > `0.8606` → IC=+0.311 (n=199)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8606 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` > `0.2998` → IC=+0.348 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2998 (IC base=+0.273)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.272 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.273)

- **PATRÓN** `libro_liquidez` > `12240.9476` → IC=+0.331 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12240.9476 (IC base=+0.273)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.298 (n=97)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.294)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.304 (n=44)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.294)

- **PATRÓN** `drift_60min` |x|≤ `0.0637` → IC=+0.322 (n=43)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0637 (IC base=+0.294)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1881` → IC=+0.370 (n=44)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1881 (IC base=+0.294)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.370 (n=67)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.294)

- **PATRÓN** `ibs_15` > `0.863` → IC=+0.343 (n=87)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.863 (IC base=+0.294)

- **PATRÓN** `dist_vwap_pct` > `0.6145` → IC=+0.413 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6145 (IC base=+0.294)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.952` → IC=+0.300 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.952 (IC base=+0.294)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.564` → IC=+0.291 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.564 (IC base=+0.294)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.302 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.294)

- **PATRÓN** `libro_liquidez` > `10425.7161` → IC=+0.414 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10425.7161 (IC base=+0.294)

- **PATRÓN** `ballena_activa_n` < `263.0` → IC=+0.306 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 263.0 (IC base=+0.294)

### UPDOWN_OU_5M
- **FILTRO** `pct_spot_vs_ref` |x|> `0.1036` → IC=-0.233 (n=28)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1282 sube el IC de +0.050 a +0.210 en UPDOWN_GBM#XRP#15min (n=105). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4526 sube el IC de -0.056 a +0.162 en UPDOWN_GBM_15M_TARDIO (n=294). Ya aplicado como kelly_boost=+0.81€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.328 sube el IC de -0.077 a +0.354 en UPDOWN_GBM_15M_TARDIO (n=128). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3357 sube el IC de +0.243 a +0.343 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=81). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_YES, IBS > 0.8125 sube el IC de -0.100 a +0.206 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=15). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8606 sube el IC de +0.273 a +0.311 en UPDOWN_GBM_IBS_ALTO (n=199). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.863 sube el IC de +0.294 a +0.343 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=87). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7314 sube el IC de +0.305 a +0.374 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=141). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8246 sube el IC de +0.280 a +0.324 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=72). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.7053 sube el IC de +0.331 a +0.421 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=61). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 596 | +0.085 | +43.58€ | 1 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 596 | +0.085 | +43.58€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 352 | +0.110 | +32.58€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 352 | +0.110 | +32.58€ | 0 | 11 |
...
| ✅ BALLENAS_TARDIAS | 6633 | -0.103 | -966.24€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 672 | -0.090 | -121.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5961 | -0.104 | -844.74€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1122 | +0.005 | -151.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1122 | +0.005 | -151.37€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 672 | -0.090 | -121.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 672 | -0.090 | -121.51€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2164 | -0.074 | -111.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2164 | -0.074 | -111.25€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1591 | -0.199 | -388.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1591 | -0.199 | -388.65€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 30946 | +0.114 | -1988.47€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5754 | +0.187 | -180.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 21932 | +0.095 | -1720.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3153 | +0.121 | -36.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3681 | +0.061 | -637.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 20 | -0.045 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3656 | +0.063 | -634.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6411 | +0.135 | -120.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1622 | +0.200 | -74.34€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3650 | +0.110 | -79.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1097 | +0.130 | +55.40€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3689 | +0.079 | -474.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 20 | +0.045 | +2.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3668 | +0.079 | -474.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6884 | +0.128 | -92.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2096 | +0.168 | -12.35€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3652 | +0.113 | -50.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1124 | +0.103 | -20.63€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6602 | +0.134 | -405.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1979 | +0.203 | -98.44€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3645 | +0.098 | -226.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 932 | +0.133 | -71.26€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3679 | +0.105 | -257.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3661 | +0.105 | -255.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5716 | +0.171 | -461.73€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5716 | +0.171 | -461.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1438 | +0.165 | -156.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1438 | +0.165 | -156.32€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1427 | +0.157 | -175.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1427 | +0.157 | -175.50€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1282 | +0.230 | -36.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1282 | +0.230 | -36.91€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1379 | +0.183 | -109.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1379 | +0.183 | -109.32€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO | 289 | +0.445 | +2.81€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#15min | 289 | +0.445 | +2.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC | 110 | +0.446 | +2.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min | 110 | +0.446 | +2.62€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH | 107 | +0.427 | -1.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH#15min | 107 | +0.427 | -1.75€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL | 69 | +0.444 | +1.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_EXTREMO#SOL#15min | 69 | +0.444 | +1.80€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15685 | +0.189 | -1421.38€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15685 | +0.189 | -1421.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2880 | +0.123 | -541.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2880 | +0.123 | -541.25€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2439 | +0.235 | -54.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2439 | +0.235 | -54.88€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 