# Hipótesis automáticas — 2026-06-30 16:00 UTC
_Generado por shadow_postmortem.py sobre 1449 resoluciones (PNL=-59.44€)_

## Patrones causales activos

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0877` → IC=+0.136 (n=20)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.68€ cuando `pct_spot_vs_ref` |x|≤ 0.0877 (IC base=+0.032)

- **PATRÓN** `drift_60min` |x|≤ `0.1331` → IC=+0.125 (n=22)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.1331 (IC base=+0.032)
...
- **PATRÓN** `ibs_15` < `0.1479` → IC=+0.237 (n=17)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1479 (IC base=+0.030)

### UPDOWN_GBM#SOL#15min
- **FILTRO** `drift_60min` |x|> `0.2945` → IC=-0.167 (n=16)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.2945
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.1479 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.237 n=17). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 457 | -0.025 | -13.82€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 274 | +0.018 | +4.02€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 100 | -0.039 | -5.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 142 | -0.021 | -10.28€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 77 | +0.032 | -2.82€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 192 | +0.015 | +5.74€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 130 | +0.030 | +5.59€ | 0 | 1 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 12 | -0.086 | -3.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 40 | +0.024 | +0.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 5 | +0.018 | +3.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 85 | -0.086 | -5.27€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#daily | 13 | +0.065 | +11.12€ | 0 | 0 |
...
| ✅ WEEKLY_PRICE | 64 | -0.015 | -15.71€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.035) — sin ventaja clara. oversold(IBS<0.3): IC=-0.038 n=50 | neutral: IC=-0.071 n=54 | overbought(IBS>0.7): IC=-0.074 n=59
  - _Datos_: n=168 IC=-0.065 PNL=-14.95€

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.000 < 0.08 — monitorear
  - _Datos_: n=42 IC=+0.000 PNL=+1.59€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 168 ops, 23 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.058 n=93/40 PNL=-3.58€ | H=15h UTC: IC=-0.019 n=102/40 PNL=-2.76€ | H=17h UTC: IC=+0.271 n=33/40 PNL=+13.52€ | H=19h UTC: IC=+0.048 n=40/40 PNL=+2.97€

**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40 en cualquier subtipo 60min
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=40/40 IC=+0.024 PNL=+0.40€ | BTC#60min: n=39/40 IC=-0.037 PNL=-3.81€ | SOL#60min: n=21/40 IC=-0.152 PNL=-2.25€

**⏳ H-WEEKLY** — Predicciones semanales de precio por par
  - _Umbral_: n≥15 por par con IC≥+0.05
  - _Acción_: Si confirma IC≥+0.10 n≥15 en SOL → considerar live semanal
  - _Estado_: ETH: n=24/15 IC=+0.000 PNL=-6.05€ | BTC: n=21/15 IC=-0.065 PNL=-7.49€ | SOL: n=19/15 IC=+0.023 PNL=-2.18€

**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  - _Umbral_: n≥200 por subtipo para calibrar parámetros Q/R del KF
  - _Acción_: Sustituir DRIFT_DAMPING por KalmanDrift en fetch_binance_klines.py
  - _Estado_: Máximo n actual en GBM: 457/200. Esperar 3+ subtypes con n≥200.
...
**⏳ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: 36/40 ops en el filtro definido (IC actual=+0.210 PNL=+9.27€)
  - _Datos_: n=36 IC=+0.210 PNL=+9.27€
...
**⏳ H-WEEKLY-BUYNO** — WEEKLY_PRICE BUY_NO — dirección dominante con IC muy alto
  ...
  - _Estado_: 42/50 ops en el filtro definido (IC actual=+0.136 PNL=-3.14€)
  - _Datos_: n=42 IC=+0.136 PNL=-3.14€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=358 IC=-0.019 PNL=-8.18€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=358 IC=-0.019 PNL=-8.18€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=83 IC=-0.053 PNL=-5.60€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=83 IC=-0.053 PNL=-5.60€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=208 IC=-0.019 PNL=-17.92€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=208 IC=-0.019 PNL=-17.92€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=77 IC=+0.032 PNL=-2.82€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=77 IC=+0.032 PNL=-2.82€

**⏳ H-CUSTOM-DRIFT15-ZONA-MUERTA** — GBM#15min drift_15min ∈ [-0.3,+0.3] — zona muerta de señal
  - _Hipótesis_: Análisis n=127 GBM#15min: cuando drift_15min está entre -0.3 y +0.3 (mercado sin dirección clara) el IC es negativo (-0.043). Cuando drift>0.3 IC=+0.100 (n=28). Cuando drift<-1 IC=+0.048 (reversión). La señal requiere mercado con dirección clara.
  - _Umbral_: 50
  - _Acción_: Filtrar señales GBM#15min cuando drift_15min ∈ [-0.3, +0.3] — validar con n≥50 antes de implementar
  - _Estado_: 42/50 ops en el filtro definido (IC actual=-0.091 PNL=-4.72€)
  - _Datos_: n=42 IC=-0.091 PNL=-4.72€

**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  - _Hipótesis_: Cuando drift_15min > 0.3%/h el GBM captura bien la dirección: IC=+0.100 n=28 en todos GBM#15min; IC=+0.152 n=13 solo BTC. El mercado tiene dirección clara y el GBM la sigue. Hipótesis: este rango es donde la señal es real.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma IC>0.10 con n≥40 → boost ×1.2 en GBM#15min cuando drift_15min>0.3
  - _Estado_: n=114 IC=+0.052 PNL=-0.98€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=114 IC=+0.052 PNL=-0.98€

**⏳ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: 30
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: 10/30 ops en el filtro definido (IC actual=+0.000 PNL=+3.41€)
  - _Datos_: n=10 IC=+0.000 PNL=+3.41€
