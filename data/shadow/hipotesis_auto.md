# Hipótesis automáticas — 2026-08-18 15:24 UTC
_Generado por shadow_postmortem.py sobre 64442 resoluciones (PNL=+6600.96€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `n_ballenas` < `5.0` → IC=-0.128 (n=2032)

  - _Acción_: SKIP cuando `n_ballenas` < 5.0
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=1375)

- **FILTRO** `restante_s_al_confirmar` < `148.64` → IC=-0.262 (n=851)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.64
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2556)
...
- **FILTRO** `restante_s_al_confirmar` < `13.5` → IC=-0.491 (n=110)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 13.5
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=226)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.156 (n=193)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.128 (n=603)

- **FILTRO** `restante_s_al_confirmar` < `245.4` → IC=-0.158 (n=597)
...
- **PATRÓN** `libro_liquidez` > `4029.3766` → IC=+0.177 (n=807)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 4029.3766 (IC base=+0.152)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.199 (n=1641)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.235 (n=357)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.255 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `restante_min` < `3.78` → IC=+0.162 (n=515)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` < 3.78 (IC base=+0.152)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.211 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.91 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.160 (n=1412)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 7.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.159 (n=1612)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `restante_min` < `3.71` → IC=+0.165 (n=255)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` < 3.71 (IC base=+0.157)

- **PATRÓN** `restante_min` > `4.88` → IC=+0.197 (n=269)

  - _Acción_: Kelly boost +0.99€ cuando `restante_min` > 4.88 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=794)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.180 (n=694)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.154 (n=711)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 7.0 (IC base=+0.146)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.157 (n=816)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `profundidad_ratio_no` > `13.0` → IC=+0.168 (n=260)

  - _Acción_: Kelly boost +0.84€ cuando `profundidad_ratio_no` > 13.0 (IC base=+0.146)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.784` → IC=+0.238 (n=590)
...
- **PATRÓN** `volumen_spike_ratio` > `1.6768` → IC=+0.128 (n=610)
...
- **PATRÓN** `ibs_20min` > `0.9441` → IC=+0.234 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9441 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `0.117` → IC=+0.177 (n=153)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.117 (IC base=+0.053)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.215` → IC=+0.131 (n=978)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 2.215 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` > `0.3352` → IC=+0.196 (n=100)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.3352 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `2.8724` → IC=+0.173 (n=289)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.8724 (IC base=+0.053)
...
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.192 (n=560)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.217` → IC=+0.136 (n=270)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.217 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.418` → IC=+0.241 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.418 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `0.6297` → IC=+0.135 (n=639)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6297 (IC base=+0.137)
...
- **PATRÓN** `libro_spread` < `0.06` → IC=+0.144 (n=1382)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.06 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `2664.3504` → IC=+0.166 (n=411)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2664.3504 (IC base=+0.137)
...
- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.250 (n=34)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0033 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.242 (n=91)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.207)

- **PATRÓN** `ibs_20min` > `0.7209` → IC=+0.253 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7209 (IC base=+0.207)

- **PATRÓN** `dist_vwap_pct` > `0.2678` → IC=+0.273 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2678 (IC base=+0.207)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.011` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.011 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` < `0.6489` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6489 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` > `0.7694` → IC=+0.222 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7694 (IC base=+0.207)

- **PATRÓN** `volumen_pendiente_norm` > `0.274` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.274 (IC base=+0.207)

- **PATRÓN** `volumen_spike_ratio` < `1.4783` → IC=+0.231 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4783 (IC base=+0.207)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.191 (n=95)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0076 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.1472` → IC=+0.158 (n=191)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.1472 (IC base=+0.149)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.816` → IC=+0.325 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.816 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` < `0.2317` → IC=+0.126 (n=225)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` < 0.2317 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.4168` → IC=+0.132 (n=36)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` > 0.4168 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.0183` → IC=+0.206 (n=100)
...
- **PATRÓN** `libro_liquidez` > `1960.841` → IC=+0.180 (n=95)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 1960.841 (IC base=+0.149)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.196 (n=504)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.329` → IC=+0.175 (n=155)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.329 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.29` → IC=+0.230 (n=1014)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.29 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.1809` → IC=+0.135 (n=349)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` > 0.1809 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `1.6939` → IC=+0.120 (n=1072)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` > 1.6939 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.123 (n=1681)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.06 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2711.1262` → IC=+0.147 (n=502)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2711.1262 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.187 (n=129)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.171 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.004 (IC base=+0.116)

- **PATRÓN** `drift_60min` |x|≤ `0.1515` → IC=+0.170 (n=92)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.1515 (IC base=+0.116)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.204 (n=52)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` < `0.376` → IC=+0.134 (n=121)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.376 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.363` → IC=+0.130 (n=44)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 9.363 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.046` → IC=+0.126 (n=121)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 6.046 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `1.4628` → IC=+0.150 (n=138)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.4628 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` < `0.2396` → IC=+0.140 (n=145)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.2396 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `2.9591` → IC=+0.159 (n=136)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.9591 (IC base=+0.116)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=168)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `7268.8224` → IC=+0.150 (n=138)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7268.8224 (IC base=+0.116)

- **PATRÓN** `ballena_activa_n` < `114.0` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 114.0 (IC base=+0.116)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.133 (n=148)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `py_entrada` < 0.5 (IC base=+0.035)
...
- **FILTRO** `ibs_20min` > `0.0723` → IC=-0.136 (n=31)
...
- **FILTRO** `py_entrada` > `0.66` → IC=-0.191 (n=40)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=86)

- **FILTRO** `drift_7min_pct` |x|> `0.1193` → IC=-0.167 (n=31)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1193
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=95)

- **FILTRO** `ibs_7min` > `0.2614` → IC=-0.167 (n=31)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2614
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=95)

- **PATRÓN** `py_entrada` < `0.53` → IC=+0.130 (n=44)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` < 0.53 (IC base=-0.023)
...
- **FILTRO** `py_entrada` > `0.515` → IC=-0.180 (n=48)
...
- **FILTRO** `py_entrada` > `0.6` → IC=-0.257 (n=68)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=83)

- **FILTRO** `ibs_7min` > `0.2771` → IC=-0.244 (n=37)
...
- **FILTRO** `ibs_7min` < `0.8376` → IC=-0.311 (n=35)
...
- **FILTRO** `libro_liquidez` < `9023.0458` → IC=-0.192 (n=92)
...
- **FILTRO** `ibs_7min` < `0.8889` → IC=-0.227 (n=53)
...
- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.291 (n=41)
...
- **FILTRO** `libro_liquidez` < `3231.6706` → IC=-0.179 (n=82)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.157 (n=65)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `py_entrada` < 0.5 (IC base=-0.024)
...
- **PATRÓN** `ibs_15` < `0.5789` → IC=+0.128 (n=385)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.64€ cuando `ibs_15` < 0.5789 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` > `0.4544` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4544 (IC base=+0.081)
...
- **FILTRO** `dist_vwap_pct` < `0.2426` → IC=-0.309 (n=19)
...
- **FILTRO** `sigma_ewma_delta_pct` > `12.785` → IC=-0.153 (n=223)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 12.785
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=889)
...
| ✅ BALLENAS_TARDIAS | 3306 | -0.114 | -516.20€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 455 | -0.021 | -16.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2851 | -0.129 | -500.07€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 791 | -0.004 | -94.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 791 | -0.004 | -94.39€ | 1 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP | 665 | -0.220 | -116.86€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 665 | -0.220 | -116.86€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 14151 | +0.117 | -786.71€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 3356 | +0.180 | -112.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 99 | -0.104 | -47.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 8108 | +0.089 | -648.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2588 | +0.132 | +22.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 1370 | +0.033 | -298.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 13 | -0.065 | -2.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 1353 | +0.036 | -290.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 3231 | +0.141 | +3.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 916 | +0.196 | -33.36€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 41 | -0.105 | -20.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 1352 | +0.113 | -6.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 922 | +0.140 | +64.54€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 1366 | +0.056 | -235.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 9 | -0.021 | -3.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 1356 | +0.057 | -229.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 3491 | +0.127 | -44.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1239 | +0.159 | -26.94€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 1347 | +0.107 | -12.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 893 | +0.117 | +3.21€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 3329 | +0.136 | -193.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1167 | +0.196 | -48.45€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 40 | +0.000 | -9.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 1349 | +0.087 | -91.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 773 | +0.139 | -44.77€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 1364 | +0.131 | -18.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 12 | +0.043 | +1.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 1351 | +0.132 | -19.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 3427 | +0.161 | -325.81€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 3427 | +0.161 | -325.81€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 5761 | +0.191 | -521.70€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 5761 | +0.191 | -521.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1079 | +0.099 | -241.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1079 | +0.099 | -241.82€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 892 | +0.251 | -5.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 892 | +0.251 | -5.12€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1015 | +0.153 | -146.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1015 | +0.153 | -146.53€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 930 | +0.223 | -36.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 930 | +0.223 | -36.45€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 895 | +0.248 | -8.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 895 | +0.248 | -8.79€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 950 | +0.195 | -82.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 950 | +0.195 | -82.99€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 2058 | +0.152 | +122.93€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 2058 | +0.152 | +122.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 1019 | +0.157 | +70.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 1019 | +0.157 | +70.99€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 1039 | +0.146 | +51.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 1039 | +0.146 | +51.94€ | 0 | 6 |
...
| ✅ GBM_LATE_15M | 4469 | +0.089 | +1592.35€ | 0 | 15 |
| ✅ GBM_LATE_15M#15min | 4469 | +0.089 | +1592.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 776 | +0.176 | +487.99€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 776 | +0.176 | +487.99€ | 0 | 17 |
| ✅ GBM_LATE_15M#BTC | 434 | +0.181 | +218.62€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 434 | +0.181 | +218.62€ | 0 | 23 |
| ✅ GBM_LATE_15M#DOGE | 779 | +0.193 | +536.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#DOGE#15min | 779 | +0.193 | +536.88€ | 0 | 18 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5484 | +0.051 | +1639.84€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5484 | +0.051 | +1639.84€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE | 660 | +0.240 | +602.56€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#DOGE#15min | 660 | +0.240 | +602.56€ | 0 | 19 |
...
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 3232 | +0.175 | +2185.81€ | 0 | 21 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 3232 | +0.175 | +2185.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB | 575 | +0.192 | +415.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BNB#15min | 575 | +0.192 | +415.91€ | 0 | 16 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#BTC |