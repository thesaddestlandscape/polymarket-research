# Hipótesis automáticas — 2026-06-29 18:24 UTC
_Generado por shadow_postmortem.py sobre 1297 resoluciones (PNL=-35.03€)_
...
**⏳ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: 39/40 ops con ibs_15. oversold(IBS<0.3): IC=+0.021 n=11 | neutral: IC=+0.106 n=11 | overbought(IBS>0.7): IC=+0.066 n=15
  - _Datos_: n=39 IC=+0.110 PNL=+5.28€

**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: 39 ops, 7 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=229 IC=+0.037 PNL=+12.05€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=229 IC=+0.037 PNL=+12.05€
