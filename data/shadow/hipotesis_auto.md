# Hipótesis automáticas — 2026-08-17 15:18 UTC
_Generado por shadow_postmortem.py sobre 50412 resoluciones (PNL=+5690.30€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.220 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.149)

- **PATRÓN** `restante_min` < `3.72` → IC=+0.168 (n=402)

  - _Acción_: Kelly boost +0.84€ cuando `restante_min` < 3.72 (IC base=+0.149)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.195 (n=405)

  - _Acción_: Kelly boost +0.98€ cuando `restante_min` > 4.91 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.159 (n=1232)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `5.53` → IC=+0.197 (n=401)

  - _Acción_: Kelly boost +0.99€ cuando `lag_apertura_s` < 5.53 (IC base=+0.149)

- **PATRÓN** `profundidad_ratio_no` > `9.0` → IC=+0.154 (n=400)

  - _Acción_: Kelly boost +0.77€ cuando `profundidad_ratio_no` > 9.0 (IC base=+0.149)
...
- **PATRÓN** `restante_min` < `3.61` → IC=+0.183 (n=200)

  - _Acción_: Kelly boost +0.92€ cuando `restante_min` < 3.61 (IC base=+0.153)

- **PATRÓN** `restante_min` > `4.87` → IC=+0.195 (n=208)

  - _Acción_: Kelly boost +0.98€ cuando `restante_min` > 4.87 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=616)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `7.6` → IC=+0.198 (n=200)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `lag_apertura_s` < 7.6 (IC base=+0.153)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.172 (n=546)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.43 (IC base=+0.143)

- **PATRÓN** `restante_min` < `3.79` → IC=+0.145 (n=201)

  - _Acción_: Kelly boost +0.73€ cuando `restante_min` < 3.79 (IC base=+0.143)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.205 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 4.95 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=616)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.152 (n=611)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 16.0 (IC base=+0.143)

- **PATRÓN** `lag_apertura_s` < `3.14` → IC=+0.204 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 3.14 (IC base=+0.143)

- **PATRÓN** `profundidad_ratio_no` > `16.3` → IC=+0.204 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio_no` > 16.3 (IC base=+0.143)
...
### MOMENTUM_IBS_5M
- **PATRÓN** `ibs_7min` > `1.0` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_7min` > 1.0 (IC base=+0.092)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0053` → IC=+0.145 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0053 (IC base=+0.102)
...
- **LIVE-CANDIDATA**: `UPDOWN_GBM#BNB#15min` — IC=+0.134 n=39. Faltan ~1 resoluciones para umbral n≥40. ETA: ~1h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 467 | +0.035 | +27.29€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 467 | +0.035 | +27.29€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 252 | +0.043 | +24.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 252 | +0.043 | +24.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 196 | +0.010 | -1.92€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 196 | +0.010 | -1.92€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 19 | +0.158 | +4.26€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 19 | +0.158 | +4.26€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS | 2665 | -0.124 | -421.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 400 | +0.012 | -15.03€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2265 | -0.148 | -406.34€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 560 | -0.149 | -18.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 560 | -0.149 | -18.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 644 | -0.051 | -91.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 644 | -0.051 | -91.46€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 497 | -0.199 | -56.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 497 | -0.199 | -56.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 11984 | +0.119 | -636.26€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3048 | +0.181 | -108.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 93 | -0.089 | -41.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 6323 | +0.088 | -498.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2520 | +0.130 | +11.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 1071 | +0.036 | -230.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 12 | -0.043 | -1.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 1055 | +0.039 | -223.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 2827 | +0.144 | +13.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 832 | +0.188 | -45.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 37 | -0.090 | -17.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 1053 | +0.122 | +17.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 905 | +0.137 | +58.93€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 1064 | +0.053 | -184.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 8 | -0.040 | -4.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 1056 | +0.055 | -180.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 3059 | +0.129 | -34.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1126 | +0.163 | -19.63€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 1055 | +0.106 | -7.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 866 | +0.116 | +1.43€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 2898 | +0.139 | -173.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1059 | +0.199 | -41.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min |
29€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#SOL#5min | 11 | +0.064 | +1.29€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP | 9 | -0.021 | -0.64€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M#XRP#5min | 9 | -0.021 | -0.64€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA | 8 | -0.040 | -1.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 8 | -0.040 | -1.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 45 | +0.011 | -0.02€ | 1 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 45 | +0.011 | -0.02€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 7 | -0.058 | -1.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 7 | -0.058 | -1.59€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 7 | +0.097 | +2.39€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 7 | +0.097 | +2.39€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE | 8 | -0.040 | -1.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#DOGE#5min | 8 | -0.040 | -1.09€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH | 8 | +0.080 | +1.86€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#ETH#5min | 8 | +0.080 | +1.86€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL | 8 | -0.080 | -2.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#SOL#5min | 8 | -0.080 | -2.06€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP | 7 | +0.019 | +0.47€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#XRP#5min | 7 | +0.019 | +0.47€ | 0 | 0 |
...
| ✅ STRUCT_NO_15M | 1671 | +0.009 | -14.40€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 1671 | +0.009 | -14.40€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 638 | +0.009 | -5.98€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 638 | +0.009 | -5.98€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 669 | +0.008 | -6.52€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 669 | +0.008 | -6.52€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 364 | +0.011 | -1.90€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 364 | +0.011 | -1.90€ | 2 | 0 |
| ✅ UPDOWN_GBM | 1525 | +0.018 | +66.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 682 | +0.094 | +112.43€ | 0 | 2 |
| ✅ UPDOWN_GBM#240min | 101 | +0.015 | -0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 459 | -0.049 | -36.05€ | 2 | 0 |
| ✅ UPDOWN_GBM#60min | 236 | -0.021 | -8.41€ | 3 | 0 |
| ✅ UPDOWN_GBM#BNB | 45 | +0.096 | +11.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 39 | +0.134 | +12.17€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#DOGE | 182 | -0.016 | -9.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 29 | +0.145 | +5.95€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 153 | -0.048 | -15.31€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1390 | -0.037 | +113.67€ | 1 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1390 | -0.037 | +113.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 74 | -0.040 | +4.26€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 74 | -0.040 | +4.26€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 282 | -0.130 | -28.49€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 282 | -0.130 | -28.49€ | 1 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 26 | -0.071 | -2.37€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 26 | -0.071 | -2.37€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 114 | +0.009 | +19.35€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 114 | +0.009 | +19.35€ | 0 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 448 | +0.009 | +89.44€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 448 | +0.009 | +89.44€ | 0 | 0 |
...
| ✅ UPDOWN_OU_5M | 293 | -0.070 | -25.97€ | 4 | 0 |
| ✅ UPDOWN_OU_5M#5min | 293 | -0.070 | -25.97€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB | 188 | -0.016 | -12.22€ | 0 | 0 |
| ✅ UPDOWN_OU_5M#BNB#5min | 188 | -0.016 | -12.22€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.158: overbought→boost, oversold→filtro | oversold(IBS<0.3): IC=-0.027 n=535 | neutral: IC=-0.003 n=517 | overbought(IBS>0.7): IC=+0.131 n=740
  - _Datos_: n=1909 IC=+0.042 PNL=+125.34€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.117 n=29984 | tras_1loss IC=+0.072 n=20068 | tras_2loss IC=+0.028 n=8542/40 | gap=+0.089 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 0 celda(s) pasan gate riguroso completo de 6 evaluadas (n>=40) y 215 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.155 > 0.08 con n=56 PNL=+18.39€
  - _Datos_: n=56 IC=+0.155 PNL=+18.39€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1400 IC=+0.018 PNL=+70.76€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1400 IC=+0.018 PNL=+70.76€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.102 > 0.1 con n=380 PNL=+53.30€
  - _Datos_: n=380 IC=+0.102 PNL=+53.30€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.103 > 0.08 con n=436 PNL=+72.09€
  - _Datos_: n=436 IC=+0.103 PNL=+72.09€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=219 IC=+0.029 PNL=+8.46€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=219 IC=+0.029 PNL=+8.46€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=882 IC=+0.021 PNL=+22.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=882 IC=+0.021 PNL=+22.02€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.144 > 0.1 con n=487 PNL=+130.90€
  - _Datos_: n=487 IC=+0.144 PNL=+130.90€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=935 IC=-0.129 PNL=+114.40€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=935 IC=-0.129 PNL=+114.40€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.102 > 0.08 con n=380 PNL=+53.30€
  - _Datos_: n=380 IC=+0.102 PNL=+53.30€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=503 IC=+0.046 PNL=+141.23€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=503 IC=+0.046 PNL=+141.23€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=873 IC=+0.097 PNL=-195.35€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=873 IC=+0.097 PNL=-195.35€
