# Hipótesis automáticas — 2026-08-22 16:24 UTC
_Generado por shadow_postmortem.py sobre 115333 resoluciones (PNL=+9025.96€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `156.97` → IC=-0.261 (n=1617)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.97
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=4856)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.127 (n=405)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=234)

- **FILTRO** `restante_s_al_confirmar` < `138.7` → IC=-0.283 (n=159)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.229 (n=5840)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.169 (n=1075)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.164 (n=667)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=3012)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `6.89` → IC=+0.143 (n=1261)
...
- **PATRÓN** `restante_min` > `4.89` → IC=+0.159 (n=526)
...
- **PATRÓN** `lag_apertura_s` < `6.49` → IC=+0.164 (n=477)

  - _Acción_: Kelly boost +0.82€ cuando `lag_apertura_s` < 6.49 (IC base=+0.143)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.133 (n=1217)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3053)
...
- **FILTRO** `ibs_7min` < `0.734` → IC=-0.229 (n=1066)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3204)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.169 (n=1442)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2828)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.230 (n=1219)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=3839)

- **FILTRO** `ibs_7min` > `0.7122` → IC=-0.171 (n=1264)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7122
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3794)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` > `16.0` → IC=-0.162 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=422)
...
- **FILTRO** `ibs_7min` < `0.8306` → IC=-0.227 (n=306)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8306
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=216)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=571)

- **FILTRO** `drift_7min_pct` |x|> `0.1413` → IC=-0.177 (n=267)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1413
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=520)

- **FILTRO** `ibs_7min` > `0.828` → IC=-0.202 (n=196)

  - _Acción_: SKIP cuando `ibs_7min` > 0.828
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=591)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.153 (n=188)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=599)
...
- **FILTRO** `py_entrada` > `0.54` → IC=-0.220 (n=216)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=659)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.272 (n=200)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=671)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.180 (n=217)
...
- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.140 (n=276)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.133 (n=137)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0028 (IC base=+0.023)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.755` → IC=+0.146 (n=77)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 8.755 (IC base=+0.023)
...
| ✅ BALLENAS_TARDIAS | 5157 | -0.105 | -553.63€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 585 | -0.084 | -109.26€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 4572 | -0.107 | -444.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 639 | -0.101 | -86.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 639 | -0.101 | -86.00€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#XRP | 1264 | -0.190 | -198.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1264 | -0.190 | -198.81€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 22431 | +0.113 | -1562.13€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4534 | +0.184 | -179.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 14913 | +0.091 | -1313.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2878 | +0.125 | -19.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2510 | +0.061 | -450.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 17 | -0.067 | -0.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2488 | +0.063 | -444.29€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 4790 | +0.134 | -106.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1257 | +0.191 | -83.06€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2480 | +0.109 | -63.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1011 | +0.135 | +62.36€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2513 | +0.068 | -388.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 16 | +0.044 | -1.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2496 | +0.068 | -385.56€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#XRP | 2509 | +0.115 | -144.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 14 | +0.000 | -0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 2494 | +0.116 | -142.57€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 10654 | +0.197 | -903.35€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 10654 | +0.197 | -903.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 1969 | +0.127 | -368.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 1969 | +0.127 | -368.21€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 1647 | +0.241 | -31.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 1647 | +0.241 | -31.46€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 1847 | +0.160 | -252.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 1847 | +0.160 | -252.35€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 1796 | +0.197 | -155.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 1796 | +0.197 | -155.16€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 3820 | +0.130 | +69.24€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 3820 | +0.130 | +69.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 1899 | +0.143 | +78.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 1899 | +0.143 | +78.15€ | 0 | 5 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 2593 | +0.101 | -104.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 269 | +0.028 | -30.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 2324 | +0.110 | -73.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 1780 | +0.094 | -72.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min | 269 | +0.028 | -30.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#5min | 1511 | +0.105 | -42.24€ | 0 | 0 |
...
| ✅ MOMENTUM_IBS_5M_BALLENA | 9328 | -0.071 | +188.85€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#5min | 9328 | -0.071 | +188.85€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB | 1399 | -0.105 | +105.03€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BNB#5min | 1399 | -0.105 | +105.03€ | 8 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC | 1740 | -0.057 | +58.95€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#BTC#5min | 1740 | -0.057 | +58.95€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE | 1455 | -0.078 | +41.14€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#DOGE#5min | 1455 | -0.078 | +41.14€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH | 1483 | -0.091 | -104.44€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#ETH#5min | 1483 | -0.091 | -104.44€ | 7 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL | 1726 | -0.046 | +28.13€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#SOL#5min | 1726 | -0.046 | +28.13€ | 4 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP | 1525 | -0.057 | +60.04€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_BALLENA#XRP#5min | 1525 | -0.057 | +60.04€ | 6 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE | 5871 | -0.008 | -101.95€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#5min | 5871 | -0.008 | -101.95€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB | 992 | -0.018 | -21.41€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BNB#5min | 992 | -0.018 | -21.41€ | 3 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC | 1064 | +0.015 | +2.15€ | 0 | 0 |
| ✅ MOMENTUM_IBS_5M_FADE#BTC#5min | 1064 | +0.015 | +2.15€ | 1 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.102) — sin ventaja clara. oversold(IBS<0.3): IC=-0.009 n=1346 | neutral: IC=+0.012 n=1421 | overbought(IBS>0.7): IC=+0.093 n=1631
  - _Datos_: n=4645 IC=+0.035 PNL=+352.87€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.086 n=65376 | tras_1loss IC=+0.046 n=49651 | tras_2loss IC=+0.008 n=22507/40 | gap=+0.077 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 3892 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=-0.008 n=354 | contrario_BTC IC=+0.014 n=280/40 | gap=+0.023 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=3717 IC=+0.007 PNL=+94.49€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=3717 IC=+0.007 PNL=+94.49€
...
**〰️ H-FUNDING-HIGH-BUYNO** — Funding rate alto (>p90 real ≈0.009%/8h) → BUY_NO tiene más edge
  ...
  - _Estado_: n=1021 IC=-0.031 PNL=-47.21€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1021 IC=-0.031 PNL=-47.21€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=2720 IC=-0.114 PNL=+389.79€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=2720 IC=-0.114 PNL=+389.79€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=1969 IC=+0.127 PNL=-368.21€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=1969 IC=+0.127 PNL=-368.21€
