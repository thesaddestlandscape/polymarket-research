# Hipótesis automáticas — 2026-06-30 01:46 UTC
_Generado por shadow_postmortem.py sobre 1347 resoluciones (PNL=-47.10€)_
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.033) — sin ventaja clara. oversold(IBS<0.3): IC=-0.033 n=28 | neutral: IC=+0.000 n=24 | overbought(IBS>0.7): IC=-0.029 n=32
  - _Datos_: n=86 IC=-0.023 PNL=-7.26€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 86 ops, 15 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 375/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=276 IC=+0.007 PNL=-0.49€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=276 IC=+0.007 PNL=-0.49€
