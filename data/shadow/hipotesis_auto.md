# Hipótesis automáticas — 2026-07-12 08:12 UTC
_Generado por shadow_postmortem.py sobre 10634 resoluciones (PNL=+1815.18€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.220 (n=266)
...
- **PATRÓN** `py_entrada` > `0.735` → IC=+0.330 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.735 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.217 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `2324.3751` → IC=+0.229 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2324.3751 (IC base=+0.217)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.229 (n=68)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.208)

- **PATRÓN** `py_entrada` > `0.695` → IC=+0.266 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.208)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.314 (n=57)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.259)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.261 (n=65)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.259)

- **PATRÓN** `py_entrada` > `0.775` → IC=+0.375 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.775 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `2838.1924` → IC=+0.288 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2838.1924 (IC base=+0.259)
...
- **PATRÓN** `hora_utc` > `19.0` → IC=+0.283 (n=21)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.665` → IC=+0.370 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.221)

- **PATRÓN** `libro_liquidez` > `1797.817` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1797.817 (IC base=+0.221)
...
- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.137 (n=428)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0152 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=1293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.116)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.122 (n=1289)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 17.0 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.1365` → IC=+0.196 (n=54)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.1365 (IC base=+0.116)
...
- **PATRÓN** `sigma_h` < `0.0162` → IC=+0.139 (n=347)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` < `0.0323` → IC=+0.183 (n=295)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0323 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0128` → IC=+0.177 (n=295)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0128 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.169 (n=297)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 6.0 (IC base=+0.166)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.185 (n=201)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.203 (n=109)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.205 (n=154)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.5148` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5148 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` < `0.1253` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.1253 (IC base=+0.166)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.193 (n=86)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 7.0 (IC base=+0.167)

- **PATRÓN** `hora_utc` < `19.0` → IC=+0.173 (n=99)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 19.0 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.1193` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1193 (IC base=+0.167)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.186 (n=33)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0034 (IC base=+0.154)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.196 (n=44)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0067 (IC base=+0.154)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.176 (n=100)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 18.0 (IC base=+0.154)
...
- **PATRÓN** `sigma_h` > `0.0126` → IC=+0.192 (n=37)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0126 (IC base=+0.111)
...
- **PATRÓN** `sigma_h` < `0.0221` → IC=+0.300 (n=58)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0221 (IC base=+0.247)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.130 (n=182)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0119 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` < `0.1438` → IC=+0.121 (n=56)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` < 0.1438 (IC base=+0.078)
...
- **PATRÓN** `dist_vwap_pct` > `0.6294` → IC=+0.147 (n=15)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.6294 (IC base=+0.021)
...
- **PATRÓN** `sigma_h` < `0.0337` → IC=+0.213 (n=99)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0337 (IC base=+0.192)

- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.203 (n=99)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.192)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.265 (n=66)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=335)

- **PATRÓN** `ibs_15` > `0.7168` → IC=+0.148 (n=211)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.74€ cuando `ibs_15` > 0.7168 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.202 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` < `0.3854` → IC=+0.177 (n=94)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3854 (IC base=+0.015)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1652` → IC=+0.128 (n=100)
  ...
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.1652 (IC base=+0.054)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.173 (n=111)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 12.0 (IC base=+0.054)

- **PATRÓN** `ibs_15` < `0.9136` → IC=+0.152 (n=110)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` < 0.9136 (IC base=+0.054)

- **PATRÓN** `ibs_15` > `0.6428` → IC=+0.161 (n=110)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.80€ cuando `ibs_15` > 0.6428 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.2438` → IC=+0.318 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2438 (IC base=+0.054)
...
- **PATRÓN** `ibs_15` > `0.8494` → IC=+0.214 (n=61)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8494 (IC base=+0.028)

- **PATRÓN** `dist_vwap_pct` < `0.2737` → IC=+0.182 (n=42)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.2737 (IC base=+0.028)
...
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS < 0.9136 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.152 n=110). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6428 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.161 n=110). Confirma señal de reversión media → alinear con BUY_NO.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS > 0.8494 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.214 n=61). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 805 | +0.180 | +1.95€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 515 | +0.210 | +1.51€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 238 | +0.188 | -2.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 172 | +0.213 | -4.33€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 284 | +0.164 | -0.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 170 | +0.203 | -0.26€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 281 | +0.189 | +5.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 171 | +0.211 | +6.06€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 3515 | +0.113 | +1133.44€ | 0 | 7 |
| ✅ GBM_LATE_15M#15min | 3515 | +0.113 | +1133.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 869 | +0.068 | +103.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 869 | +0.068 | +103.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 893 | +0.073 | +138.75€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 893 | +0.073 | +138.75€ | 0 | 1 |
| ✅ GBM_LATE_15M#SOL | 913 | +0.138 | +447.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 913 | +0.138 | +447.09€ | 0 | 6 |
| ✅ GBM_LATE_15M#XRP | 840 | +0.172 | +443.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 840 | +0.172 | +443.97€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 882 | +0.157 | +432.69€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 882 | +0.157 | +432.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 233 | +0.168 | +149.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 233 | +0.168 | +149.81€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 239 | +0.127 | +78.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 239 | +0.127 | +78.77€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 247 | +0.102 | +49.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 247 | +0.102 | +49.77€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 163 | +0.264 | +154.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 163 | +0.264 | +154.34€ | 0 | 6 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1057 | +0.080 | +237.62€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1057 | +0.080 | +237.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 245 | +0.075 | +26.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 245 | +0.075 | +26.99€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 265 | +0.006 | +6.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 265 | +0.006 | +6.35€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 275 | +0.034 | +23.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 275 | +0.034 | +23.88€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 272 | +0.201 | +180.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 272 | +0.201 | +180.40€ | 0 | 8 |
...
| ✅ UPDOWN_GBM | 1310 | -0.008 | +20.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1054 | +0.022 | +57.89€ | 1 | 4 |
...
| ✅ UPDOWN_GBM#BTC | 349 | +0.010 | +4.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 270 | +0.051 | +17.46€ | 1 | 8 |
...
| ✅ UPDOWN_GBM#ETH | 647 | +0.013 | +34.77€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 554 | +0.032 | +45.82€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.113) — sin ventaja clara. oversold(IBS<0.3): IC=-0.021 n=340 | neutral: IC=-0.046 n=256 | overbought(IBS>0.7): IC=+0.066 n=284
  - _Datos_: n=920 IC=+0.006 PNL=+45.66€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.088 n=5967 | tras_1loss IC=+0.042 n=4530 | tras_2loss IC=+0.007 n=2046/40 | gap=+0.081 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.118 n=66/60 | contraria IC=+0.045 n=20 | gap=+0.072 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1185 IC=-0.001 PNL=+34.06€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1185 IC=-0.001 PNL=+34.06€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=596 IC=+0.015 PNL=+20.80€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=596 IC=+0.015 PNL=+20.80€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=270 IC=+0.051 PNL=+17.46€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=270 IC=+0.051 PNL=+17.46€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=538 IC=+0.050 PNL=+39.20€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=538 IC=+0.050 PNL=+39.20€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.224 > 0.08 con n=56 PNL=+11.85€
  - _Datos_: n=56 IC=+0.224 PNL=+11.85€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8176 IC=+0.094 PNL=+1891.07€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8176 IC=+0.094 PNL=+1891.07€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=116 IC=+0.000 PNL=-0.40€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=116 IC=+0.000 PNL=-0.40€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=743 IC=-0.018 PNL=-9.67€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=743 IC=-0.018 PNL=-9.67€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.173 > 0.1 con n=258 PNL=+94.00€
  - _Datos_: n=258 IC=+0.173 PNL=+94.00€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.175 > 0.08 con n=192 PNL=+67.05€
  - _Datos_: n=192 IC=+0.175 PNL=+67.05€
...
**⏳ H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: 79/80 ops en el filtro definido (IC actual=+0.241 PNL=+32.30€)
  - _Datos_: n=79 IC=+0.241 PNL=+32.30€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.294 > 0.2 con n=124 PNL=+75.55€
  - _Datos_: n=124 IC=+0.294 PNL=+75.55€
...
**⏳ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 1/40 ops en el filtro definido (IC actual=+0.008 PNL=+1.92€)
  - _Datos_: n=1 IC=+0.008 PNL=+1.92€
...
**⏳ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: 2/40 ops en el filtro definido (IC actual=-0.025 PNL=-4.08€)
  - _Datos_: n=2 IC=-0.025 PNL=-4.08€
