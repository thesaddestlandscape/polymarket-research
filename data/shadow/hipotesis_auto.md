# Hipótesis automáticas — 2026-07-18 21:41 UTC
_Generado por shadow_postmortem.py sobre 21334 resoluciones (PNL=+5109.86€)_
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.192 (n=527)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.265` → IC=+0.343 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.175)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.181 (n=1571)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.175)

- **PATRÓN** `libro_liquidez` > `7379.7569` → IC=+0.176 (n=461)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7379.7569 (IC base=+0.175)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.227 (n=148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.395` → IC=+0.269 (n=292)
...
- **PATRÓN** `dist_vwap_pct` > `0.1646` → IC=+0.130 (n=336)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.1646 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.9126` → IC=+0.123 (n=1048)
...
- **PATRÓN** `dist_vwap_pct` > `0.6784` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.6784 (IC base=+0.076)
...
- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.188 (n=1009)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0046 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.183 (n=500)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.8826` → IC=+0.187 (n=917)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.174 (n=127)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 15.0 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.1165` → IC=+0.141 (n=62)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.1165 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.4662` → IC=+0.133 (n=224)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.4662 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.140 (n=231)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0067 (IC base=+0.127)

- **PATRÓN** `sigma_h` > `0.0036` → IC=+0.140 (n=262)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0036 (IC base=+0.127)
...
- **PATRÓN** `dist_vwap_pct` > `0.6273` → IC=+0.196 (n=54)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.6273 (IC base=+0.127)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.322 (n=245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.299)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.308 (n=258)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.135 (n=871)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.5395` → IC=+0.176 (n=180)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.5395 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.1193` → IC=+0.153 (n=480)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1193 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.343` → IC=+0.283 (n=127)
...
- **PATRÓN** `dist_vwap_pct` < `0.7882` → IC=+0.128 (n=911)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.7882 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.488` → IC=+0.128 (n=237)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 3.488 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.972` → IC=+0.122 (n=804)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.89` → IC=+0.192 (n=50)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 7.89 (IC base=+0.043)
...
- **PATRÓN** `dist_vwap_pct` > `0.3465` → IC=+0.128 (n=41)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.3465 (IC base=+0.084)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.09` → IC=+0.263 (n=74)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.09 (IC base=+0.084)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 229 | +0.141 | +12.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 229 | +0.141 | +12.96€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 51 | +0.066 | +1.26€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 51 | +0.066 | +1.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 3552 | +0.183 | +28.73€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 2306 | +0.216 | +76.29€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1031 | +0.191 | +24.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 769 | +0.207 | -6.36€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1264 | +0.177 | +7.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 764 | +0.219 | +39.56€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1244 | +0.182 | -3.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 762 | +0.224 | +46.06€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 5635 | +0.105 | +1871.53€ | 0 | 8 |
| ✅ GBM_LATE_15M#15min | 5635 | +0.105 | +1871.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1348 | +0.075 | +237.25€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1348 | +0.075 | +237.25€ | 0 | 5 |
| ✅ GBM_LATE_15M#ETH | 1300 | +0.078 | +246.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1300 | +0.078 | +246.95€ | 0 | 5 |
| ✅ GBM_LATE_15M#SOL | 1521 | +0.101 | +594.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1521 | +0.101 | +594.73€ | 1 | 7 |
| ✅ GBM_LATE_15M#XRP | 1466 | +0.161 | +792.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1466 | +0.161 | +792.59€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 2861 | +0.152 | +1704.23€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 2861 | +0.152 | +1704.23€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 731 | +0.115 | +348.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 731 | +0.115 | +348.77€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 752 | +0.118 | +358.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 752 | +0.118 | +358.66€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 739 | +0.111 | +319.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 739 | +0.111 | +319.53€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 639 | +0.279 | +677.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 639 | +0.279 | +677.28€ | 0 | 12 |
...
| ✅ GBM_LATE_15M_TARDIO | 2805 | +0.102 | +986.42€ | 0 | 10 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2805 | +0.102 | +986.42€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 681 | +0.070 | +141.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 681 | +0.070 | +141.34€ | 0 | 7 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 675 | +0.039 | +68.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 675 | +0.039 | +68.30€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 625 | +0.057 | +132.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 625 | +0.057 | +132.80€ | 2 | 7 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 824 | +0.213 | +643.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 824 | +0.213 | +643.98€ | 0 | 12 |
...
| ✅ UPDOWN_GBM | 1785 | +0.020 | +131.29€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1525 | +0.046 | +169.35€ | 1 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 825 | +0.024 | +41.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 732 | +0.040 | +52.45€ | 2 | 5 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 512 | +0.179 | +216.26€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 512 | +0.179 | +216.26€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 127 | +0.205 | +49.49€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 127 | +0.205 | +49.49€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 133 | +0.130 | +46.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 133 | +0.130 | +46.11€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.177: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.052 n=692 | neutral: IC=-0.008 n=506 | overbought(IBS>0.7): IC=+0.169 n=639
  - _Datos_: n=1964 IC=+0.081 PNL=+382.27€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.112 n=47 PNL=-10.79€ → FILTRAR | H=07h: IC=+0.123 n=59 PNL=+26.81€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.156 n=59 PNL=+26.91€ → BOOST | H=21h: IC=+0.117 n=58 PNL=+11.07€ → BOOST | H=22h: IC=+0.103 n=76 PNL=+13.62€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=12787 | tras_1loss IC=+0.086 n=8349 | tras_2loss IC=+0.052 n=3426/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1656 IC=+0.028 PNL=+148.67€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1656 IC=+0.028 PNL=+148.67€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=806 IC=+0.079 PNL=+118.75€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=806 IC=+0.079 PNL=+118.75€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=18876 IC=+0.119 PNL=+5185.74€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=18876 IC=+0.119 PNL=+5185.74€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=604 IC=-0.089 PNL=+93.05€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=604 IC=-0.089 PNL=+93.05€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.132 > 0.08 con n=259 PNL=+95.99€
  - _Datos_: n=259 IC=+0.132 PNL=+95.99€
