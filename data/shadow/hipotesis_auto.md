# Hipótesis automáticas — 2026-06-30 07:55 UTC
_Generado por shadow_postmortem.py sobre 1384 resoluciones (PNL=-52.56€)_
...
- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.132 (n=17)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0127 (IC base=+0.071)
...
| ✅ UPDOWN_GBM | 411 | -0.016 | -11.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 246 | +0.020 | +3.09€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 84 | +0.023 | +1.04€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 168 | +0.018 | +1.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 114 | +0.026 | +1.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 12 | -0.086 | -3.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 33 | +0.071 | +2.33€ | 0 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.027) — sin ventaja clara. oversold(IBS<0.3): IC=-0.050 n=38 | neutral: IC=-0.026 n=36 | overbought(IBS>0.7): IC=-0.053 n=45
  - _Datos_: n=122 IC=-0.048 PNL=-12.21€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 122 ops, 21 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Estado_: ETH#60min: n=33/40 IC=+0.071 PNL=+2.33€ | BTC#60min: n=33/40 IC=+0.043 PNL=-0.57€ | SOL#60min: n=18/40 IC=-0.090 PNL=-0.72€
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 411/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=312 IC=-0.006 PNL=-5.44€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=312 IC=-0.006 PNL=-5.44€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=68 IC=+0.014 PNL=+0.58€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=68 IC=+0.014 PNL=+0.58€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=188 IC=-0.016 PNL=-15.27€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=188 IC=-0.016 PNL=-15.27€
...
**⏳ H-CUSTOM-DRIFT15-ZONA-MUERTA** — GBM#15min drift_15min ∈ [-0.3,+0.3] — zona muerta de señal
  ...
  - _Estado_: 36/50 ops en el filtro definido (IC actual=-0.053 PNL=-1.97€)
  - _Datos_: n=36 IC=-0.053 PNL=-1.97€

**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  - _Hipótesis_: Cuando drift_15min > 0.3%/h el GBM captura bien la dirección: IC=+0.100 n=28 en todos GBM#15min; IC=+0.152 n=13 solo BTC. El mercado tiene dirección clara y el GBM la sigue. Hipótesis: este rango es donde la señal es real.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma IC>0.10 con n≥40 → boost ×1.2 en GBM#15min cuando drift_15min>0.3
  - _Estado_: n=101 IC=+0.053 PNL=-0.52€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=101 IC=+0.053 PNL=-0.52€
