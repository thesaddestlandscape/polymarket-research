# Hipótesis automáticas — 2026-07-15 06:56 UTC
_Generado por shadow_postmortem.py sobre 14944 resoluciones (PNL=+2912.00€)_
...
- **PATRÓN** `libro_liquidez` > `7344.6882` → IC=+0.180 (n=273)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 7344.6882 (IC base=+0.163)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.217 (n=175)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4675.0354` → IC=+0.218 (n=115)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2038 | +0.177 | -28.84€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1317 | +0.207 | +1.64€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 722 | +0.181 | +16.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 434 | +0.220 | +22.14€ | 0 | 7 |
...
| ✅ GBM_LATE_5M | 7 | -0.058 | -1.59€ | 0 | 0 |
| ✅ GBM_LATE_5M#5min | 7 | -0.058 | -1.59€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.098 n=8604 | tras_1loss IC=+0.060 n=6158 | tras_2loss IC=+0.027 n=2680/40 | gap=+0.071 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12486 IC=+0.100 PNL=+2987.88€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12486 IC=+0.100 PNL=+2987.88€
