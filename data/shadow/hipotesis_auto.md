# Hipótesis automáticas — 2026-08-26 23:54 UTC
_Generado por shadow_postmortem.py sobre 167785 resoluciones (PNL=+12117.58€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.84` → IC=-0.283 (n=2317)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.84
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=6954)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `150.56` → IC=-0.185 (n=284)
...
- **FILTRO** `restante_s_al_confirmar` < `92.72` → IC=-0.437 (n=284)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=855)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `158.3` → IC=-0.189 (n=631)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.3
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1896)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `153.18` → IC=-0.268 (n=545)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 153.18
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1638)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `152.41` → IC=-0.357 (n=531)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 152.41
  - _Potencial_: sin este filtro IC_bueno=-0.122 (n=1079)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.187 (n=5276)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1562)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2383.976` → IC=+0.174 (n=1506)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2383.976 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.147 (n=3122)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.259 (n=3252)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=2892)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1853.8416` → IC=+0.182 (n=2419)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 1853.8416 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1198)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.283 (n=473)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.217 (n=305)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.259 (n=210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=4447)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.202 (n=2124)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.171 (n=772)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.72` → IC=+0.176 (n=966)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.165 (n=1079)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.241 (n=1014)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.317 (n=358)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=1087)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.195 (n=545)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.210 (n=1446)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.183)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=1617)
...
- **PATRÓN** `restante_min` > `4.93` → IC=+0.160 (n=1456)
...
- **PATRÓN** `lag_apertura_s` < `4.46` → IC=+0.157 (n=1442)

  - _Acción_: Kelly boost +0.79€ cuando `lag_apertura_s` < 4.46 (IC base=+0.133)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.205 (n=807)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.140)

- **PATRÓN** `restante_min` < `3.91` → IC=+0.141 (n=716)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` < 3.91 (IC base=+0.140)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.167 (n=737)
...
- **PATRÓN** `lag_apertura_s` < `5.53` → IC=+0.168 (n=715)
...
- **PATRÓN** `lag_apertura_s` < `3.47` → IC=+0.163 (n=723)

  - _Acción_: Kelly boost +0.82€ cuando `lag_apertura_s` < 3.47 (IC base=+0.126)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.315 (n=408)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.825` → IC=+0.378 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.825 (IC base=+0.299)

- **PATRÓN** `libro_liquidez` > `1876.0591` → IC=+0.300 (n=567)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1876.0591 (IC base=+0.299)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.285 (n=245)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.333 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.815` → IC=+0.384 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.302)

- **PATRÓN** `libro_liquidez` > `1864.2726` → IC=+0.322 (n=239)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.307 (n=288)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.304 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.288)

- **PATRÓN** `libro_liquidez` > `1579.7923` → IC=+0.343 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1579.7923 (IC base=+0.288)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9497` → IC=+0.210 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9497 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.2069` → IC=+0.234 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2069 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.4917` → IC=+0.215 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4917 (IC base=+0.065)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.196` → IC=+0.169 (n=899)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.196 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` < `0.6325` → IC=+0.223 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6325 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `1.0608` → IC=+0.249 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0608 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.3076` → IC=+0.143 (n=169)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.3076 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `2.443` → IC=+0.144 (n=1039)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.443 (IC base=+0.065)

- **PATRÓN** `ibs_20min` < `0.2143` → IC=+0.132 (n=1494)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2143 (IC base=+0.029)

- **PATRÓN** `dist_vwap_pct` < `0.3016` → IC=+0.145 (n=753)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3016 (IC base=+0.029)

- **PATRÓN** `volumen_regimen` < `0.6362` → IC=+0.154 (n=241)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6362 (IC base=+0.029)

- **PATRÓN** `volumen_regimen` > `1.0494` → IC=+0.145 (n=328)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.0494 (IC base=+0.029)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6222` → IC=+0.198 (n=339)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6222 (IC base=+0.029)
...
- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.224 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.029)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.766` → IC=+0.325 (n=175)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.766 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.1485` → IC=+0.130 (n=117)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` > 0.1485 (IC base=+0.119)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0953` → IC=+0.226 (n=122)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0953 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.235 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.223 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.2233` → IC=+0.233 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2233 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` < `0.5452` → IC=+0.209 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5452 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.271` → IC=+0.245 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.271 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.215 (n=366)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.244 (n=166)
...
- **PATRÓN** `volumen_spike_ratio` < `1.349` → IC=+0.259 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.349 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `11282.8623` → IC=+0.220 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11282.8623 (IC base=+0.210)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0713` → IC=+0.135 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.0713 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.214 (n=152)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.275 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.923` → IC=+0.265 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.923 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=208)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `1918.3532` → IC=+0.140 (n=198)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 1918.3532 (IC base=+0.130)
...
- **FILTRO** `ibs_20min` > `0.7619` → IC=-0.160 (n=319)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=958)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.197 (n=31)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0055 (IC base=+0.042)

- **PATRÓN** `drift_60min` |x|≤ `0.2691` → IC=+0.145 (n=60)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.2691 (IC base=+0.042)

- **PATRÓN** `ibs_20min` > `0.5294` → IC=+0.156 (n=59)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.5294 (IC base=+0.042)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.511` → IC=-0.149 (n=223)
...
- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.171 (n=287)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.135 (n=1258)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0075 (IC base=+0.054)

- **PATRÓN** `ibs_20min` > `0.9461` → IC=+0.250 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9461 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `1.2746` → IC=+0.288 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2746 (IC base=+0.054)

- **PATRÓN** `volumen_regimen` > `1.1564` → IC=+0.198 (n=319)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 1.1564 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` < `0.1147` → IC=+0.167 (n=1235)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` < 0.1147 (IC base=+0.054)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4768` → IC=+0.194 (n=423)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.4768 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` > `2.8423` → IC=+0.173 (n=423)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.8423 (IC base=+0.054)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.268 (n=717)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.054)

- **PATRÓN** `ibs_20min` < `0.0952` → IC=+0.184 (n=1180)
...
- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.258 (n=453)
...
- **FILTRO** `sigma_ewma_delta_pct` > `5.189` → IC=-0.207 (n=121)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=211)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1441` → IC=+0.189 (n=326)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0145` → IC=+0.184 (n=153)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.0145 (IC base=+0.181)
...
- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.351 (n=199)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.348)

- **PATRÓN** `drift_60min` |x|≤ `0.22` → IC=+0.356 (n=151)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.22 (IC base=+0.348)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.391 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.348)

- **PATRÓN** `ibs_20min` < `0.3009` → IC=+0.360 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3009 (IC base=+0.348)

- **PATRÓN** `ibs_20min` > `0.1308` → IC=+0.356 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1308 (IC base=+0.348)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.402` → IC=+0.352 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.402 (IC base=+0.348)

- **PATRÓN** `volumen_pendiente_norm` > `0.0975` → IC=+0.377 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0975 (IC base=+0.348)

- **PATRÓN** `volumen_spike_ratio` < `1.7571` → IC=+0.351 (n=45)
...
- **PATRÓN** `dist_vwap_pct` > `0.7343` → IC=+0.259 (n=27)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7343 (IC base=-0.068)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7258` → IC=+0.154 (n=24)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7258 (IC base=-0.068)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7368` → IC=-0.122 (n=411)
...
- **PATRÓN** `ibs_20min` > `0.8519` → IC=+0.261 (n=157)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.229 (n=212)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9` → IC=+0.297 (n=368)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0802` → IC=+0.220 (n=470)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4068` → IC=+0.200 (n=2131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4097` → IC=+0.238 (n=2131)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4097 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.3624` → IC=+0.177 (n=1871)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.3624 (IC base=+0.185)
...
- **PATRÓN** `volumen_regimen` < `1.1764` → IC=+0.167 (n=1725)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1764 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` > `0.8596` → IC=+0.173 (n=1150)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2528` → IC=+0.151 (n=388)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.2528 (IC base=+0.145)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1422` → IC=+0.174 (n=93)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1422 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.131 (n=310)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4352 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=232)
...
- **PATRÓN** `drift_60min` |x|≤ `0.147` → IC=+0.162 (n=232)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.147 (IC base=+0.151)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2295` → IC=+0.145 (n=285)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.2295 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `1.9958` → IC=+0.198 (n=127)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.9958 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `3.6506` → IC=+0.136 (n=130)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 3.6506 (IC base=+0.151)
...
- **PATRÓN** `libro_liquidez` > `1961.1032` → IC=+0.178 (n=116)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 1961.1032 (IC base=+0.151)
...
- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.220 (n=344)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0093 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.5012` → IC=+0.201 (n=343)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5012 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.212 (n=311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `0.4526` → IC=+0.239 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4526 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` > `1.0396` → IC=+0.244 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0396 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.181` → IC=+0.324 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.181 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.199 (n=343)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 0.6356 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.1005` → IC=+0.243 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1005 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `1.4303` → IC=+0.217 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4303 (IC base=+0.184)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.187 (n=391)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.01 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `8688.9164` → IC=+0.210 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8688.9164 (IC base=+0.184)

- **PATRÓN** `ballena_activa_n` < `107.0` → IC=+0.187 (n=97)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 107.0 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0024` → IC=+0.250 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0024 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.3779` → IC=+0.167 (n=412)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3779 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.185 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 17.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` < `0.343` → IC=+0.214 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.343 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.3201` → IC=+0.165 (n=454)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.3201 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.302` → IC=+0.222 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.302 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.8556` → IC=+0.157 (n=275)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8556 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `0.6199` → IC=+0.156 (n=411)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8878` → IC=+0.188 (n=203)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.8878 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.147 (n=137)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 10007.3401 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.128 (n=197)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 196.0 (IC base=+0.145)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.208 (n=159)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.138 (n=434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.7959` → IC=+0.273 (n=152)
...
- **PATRÓN** `volumen_regimen` > `0.6804` → IC=+0.142 (n=426)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6804 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.2316` → IC=+0.133 (n=96)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` > 0.2316 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` > `1.5618` → IC=+0.130 (n=398)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.5618 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `3204.0646` → IC=+0.214 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3204.0646 (IC base=+0.118)
...
- **PATRÓN** `sigma_h` > `0.0227` → IC=+0.192 (n=232)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0227 (IC base=+0.164)

- **PATRÓN** `drift_60min` |x|≤ `0.1632` → IC=+0.193 (n=226)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.1632 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.201 (n=182)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9237` → IC=+0.261 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9237 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `1.6505` → IC=+0.254 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6505 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.059` → IC=+0.244 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.059 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `1.1875` → IC=+0.163 (n=512)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1875 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` > `0.8248` → IC=+0.191 (n=341)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 0.8248 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.244 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2352 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` < `2.1643` → IC=+0.179 (n=418)
...
- **PATRÓN** `libro_liquidez` > `2455.5312` → IC=+0.165 (n=512)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2455.5312 (IC base=+0.164)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.188 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 16.0 (IC base=+0.089)

- **PATRÓN** `ibs_20min` > `0.6275` → IC=+0.157 (n=374)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.6275 (IC base=+0.089)

- **PATRÓN** `dist_vwap_pct` > `0.7813` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7813 (IC base=+0.089)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.273` → IC=+0.205 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.273 (IC base=+0.089)

- **PATRÓN** `volumen_pendiente_norm` > `0.1717` → IC=+0.200 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1717 (IC base=+0.089)

- **PATRÓN** `libro_liquidez` > `2933.8417` → IC=+0.130 (n=279)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2933.8417 (IC base=+0.089)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.177 (n=125)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0034 (IC base=+0.077)

- **PATRÓN** `drift_60min` |x|≤ `0.1106` → IC=+0.123 (n=165)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.1106 (IC base=+0.077)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.138 (n=252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 11.0 (IC base=+0.077)

- **PATRÓN** `ibs_20min` < `0.6327` → IC=+0.123 (n=375)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.6327 (IC base=+0.077)
...
- **PATRÓN** `volumen_regimen` < `0.746` → IC=+0.135 (n=154)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.746 (IC base=+0.077)

- **PATRÓN** `volumen_spike_ratio` < `1.8445` → IC=+0.137 (n=213)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.8445 (IC base=+0.077)

- **PATRÓN** `libro_liquidez` > `3888.5094` → IC=+0.127 (n=250)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 3888.5094 (IC base=+0.077)
...
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.125 (n=78)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 10.0 (IC base=+0.036)

- **PATRÓN** `ibs_20min` > `0.4225` → IC=+0.123 (n=83)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` > 0.4225 (IC base=+0.036)

- **PATRÓN** `dist_vwap_pct` > `0.3836` → IC=+0.167 (n=34)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.3836 (IC base=+0.036)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.327` → IC=+0.157 (n=33)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 5.327 (IC base=+0.036)

- **PATRÓN** `libro_liquidez` > `11800.2375` → IC=+0.149 (n=55)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 11800.2375 (IC base=+0.036)
...
- **PATRÓN** `ibs_20min` < `0.5552` → IC=+0.251 (n=2489)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5552 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` < `0.7203` → IC=+0.182 (n=2036)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.7203 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.388` → IC=+0.226 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.388 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.639` → IC=+0.198 (n=2343)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` < 2.639 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` < `0.6245` → IC=+0.185 (n=627)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6245 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` > `1.193` → IC=+0.188 (n=627)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.193 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.2817` → IC=+0.271 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2817 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` > `2.257` → IC=+0.210 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.257 (IC base=+0.195)

- **PATRÓN** `ballena_activa_n` < `180.0` → IC=+0.173 (n=1362)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.218 (n=204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.169 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 6.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.8276` → IC=+0.254 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8276 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.565` → IC=+0.355 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.565 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.2156` → IC=+0.194 (n=70)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2156 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.9026` → IC=+0.140 (n=245)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.9026 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.185 (n=236)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.04 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.324 (n=180)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.337 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5833 (IC base=+0.280)

- **PATRÓN** `volumen_pendiente_norm` < `0.0668` → IC=+0.288 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0668 (IC base=+0.280)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.295 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.280)

- **PATRÓN** `volumen_spike_ratio` > `2.7082` → IC=+0.345 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7082 (IC base=+0.280)
...
- **PATRÓN** `libro_liquidez` > `1990.966` → IC=+0.348 (n=90)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1990.966 (IC base=+0.280)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.281 (n=94)
...
- **PATRÓN** `volumen_regimen` < `0.6489` → IC=+0.171 (n=147)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.6489 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.178 (n=200)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.099 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1452` → IC=+0.232 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1452 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.183 (n=345)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.7052` → IC=+0.196 (n=261)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.7052 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `11800.2375` → IC=+0.186 (n=294)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 11800.2375 (IC base=+0.155)
...
- **PATRÓN** `ibs_20min` > `0.717` → IC=+0.261 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.717 (IC base=+0.179)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2301` → IC=+0.182 (n=300)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` < 0.2301 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` < `2.0589` → IC=+0.189 (n=130)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.0589 (IC base=+0.179)
...
- **PATRÓN** `libro_liquidez` > `1918.3532` → IC=+0.198 (n=167)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 1918.3532 (IC base=+0.179)
...
- **PATRÓN** `ibs_20min` < `0.5683` → IC=+0.329 (n=342)
...
- **PATRÓN** `volumen_spike_ratio` < `3.4029` → IC=+0.259 (n=193)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.180 (n=320)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0076 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.5115` → IC=+0.164 (n=364)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.5115 (IC base=+0.152)
...
- **PATRÓN** `dist_vwap_pct` > `0.1617` → IC=+0.161 (n=187)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1617 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.6853` → IC=+0.174 (n=388)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.6853 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` < `0.596` → IC=+0.177 (n=122)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.596 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.1278` → IC=+0.191 (n=121)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.1278 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.2305` → IC=+0.333 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2305 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.1935` → IC=+0.186 (n=269)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.1935 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `9411.7254` → IC=+0.207 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9411.7254 (IC base=+0.152)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.127 (n=443)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 8.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.913` → IC=+0.306 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.913 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.7696` → IC=+0.261 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7696 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.432` → IC=+0.227 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.432 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2940.9508` → IC=+0.290 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2940.9508 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.175 (n=269)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2606` → IC=+0.140 (n=306)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.2606 (IC base=+0.121)
...
- **PATRÓN** `ibs_20min` < `0.5789` → IC=+0.203 (n=459)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.03` → IC=+0.139 (n=449)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 3.03 (IC base=+0.121)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.072` → IC=+0.177 (n=125)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.072 (IC base=+0.121)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=478)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `2581.4636` → IC=+0.171 (n=208)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2581.4636 (IC base=+0.121)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0262` → IC=+0.214 (n=197)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0262 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=229)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 17.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` > `0.9684` → IC=+0.299 (n=267)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2361` → IC=+0.255 (n=92)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8207` → IC=+0.185 (n=360)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4686` → IC=+0.228 (n=564)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4686 (IC base=+0.214)
...
- **PATRÓN** `ibs_20min` < `0.4884` → IC=+0.279 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4884 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `1.2198` → IC=+0.222 (n=750)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.02` → IC=+0.216 (n=640)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.02 (IC base=+0.214)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.155 (n=932)

- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.135 (n=395)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0098 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.160 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.8363` → IC=+0.146 (n=204)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.8363 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.5243` → IC=+0.192 (n=115)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 1.5243 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.6128` → IC=+0.157 (n=129)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6128 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` > `0.8982` → IC=+0.126 (n=257)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` > 0.8982 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.1532` → IC=+0.164 (n=129)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1532 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4918` → IC=+0.148 (n=194)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4918 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.132 (n=422)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `8331.3362` → IC=+0.151 (n=299)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8331.3362 (IC base=+0.112)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.172 (n=266)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.6298` → IC=+0.171 (n=159)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6298 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.8049` → IC=+0.147 (n=805)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.8049 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.126` → IC=+0.164 (n=316)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 4.126 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.051` → IC=+0.150 (n=716)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.051 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4699` → IC=+0.167 (n=703)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4699 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.5125` → IC=+0.154 (n=628)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5125 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=932)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `8486.696` → IC=+0.155 (n=711)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 8486.696 (IC base=+0.149)
...
- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.167 (n=55)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0037 (IC base=+0.083)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.156 (n=62)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 12.0 (IC base=+0.083)

- **PATRÓN** `ibs_20min` < `0.821` → IC=+0.167 (n=55)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.821 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` > `0.6176` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.6176 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.401` → IC=+0.162 (n=66)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 5.401 (IC base=+0.083)

- **PATRÓN** `volumen_regimen` > `0.8151` → IC=+0.151 (n=41)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.8151 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` < `0.0971` → IC=+0.147 (n=66)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.0971 (IC base=+0.083)

- **PATRÓN** `libro_liquidez` > `12732.4097` → IC=+0.202 (n=55)
...
- **PATRÓN** `liq_usd_total` > `9741.83` → IC=+0.128 (n=49)
  ...
  - _Acción_: Kelly boost +0.64€ cuando `liq_usd_total` > 9741.83 (IC base=+0.045)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.169 (n=783)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=2419)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.214 (n=753)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2433)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.177 (n=793)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=2393)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.235 (n=115)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=351)

- **FILTRO** `ibs_20min` < `0.7279` → IC=-0.195 (n=116)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.183 (n=206)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=276)

- **FILTRO** `ibs_20min` < `0.7285` → IC=-0.205 (n=120)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.131 (n=139)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.222 (n=131)
...
- **FILTRO** `ibs_20min` > `0.283` → IC=-0.234 (n=126)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=1901)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=6023)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.284 (n=1891)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=6033)

- **FILTRO** `ibs_7min` < `0.738` → IC=-0.231 (n=1981)

  - _Acción_: SKIP cuando `ibs_7min` < 0.738
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=5943)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.174 (n=2682)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=5242)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.231 (n=2225)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=7438)

- **FILTRO** `ibs_7min` > `0.72` → IC=-0.171 (n=2414)

  - _Acción_: SKIP cuando `ibs_7min` > 0.72
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=7249)
...
- **FILTRO** `py_entrada` < `0.31` → IC=-0.331 (n=259)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=811)

- **FILTRO** `ibs_7min` < `0.9833` → IC=-0.199 (n=706)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9833
  - _Potencial_: sin este filtro IC_bueno=+0.066 (n=364)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.258 (n=266)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=804)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.230 (n=405)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1243)

- **FILTRO** `drift_7min_pct` |x|> `0.1395` → IC=-0.157 (n=560)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1395
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1088)

- **FILTRO** `ibs_7min` > `0.8406` → IC=-0.193 (n=411)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8406
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=1237)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.237 (n=386)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1174)

- **FILTRO** `ibs_7min` < `0.8031` → IC=-0.167 (n=388)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8031
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1172)

- **FILTRO** `ballena_activa_n` > `155.0` → IC=-0.179 (n=387)

  - _Acción_: SKIP cuando `ballena_activa_n` > 155.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1173)
...
- **FILTRO** `ballena_activa_n` > `129.0` → IC=-0.167 (n=397)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1196)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.193 (n=262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=862)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.313 (n=361)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=763)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.284 (n=280)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=844)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.271 (n=278)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=846)
...
- **FILTRO** `ibs_7min` > `0.8192` → IC=-0.187 (n=420)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.153 (n=286)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=1056)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.263 (n=314)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1028)

- **FILTRO** `ibs_7min` < `0.765` → IC=-0.185 (n=335)

  - _Acción_: SKIP cuando `ibs_7min` < 0.765
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=1007)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.217 (n=330)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=1012)

- **FILTRO** `hora_utc` > `18.0` → IC=-0.145 (n=288)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=1043)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.290 (n=322)
...
- **FILTRO** `ballena_activa_n` > `38.0` → IC=-0.210 (n=326)

  - _Acción_: SKIP cuando `ballena_activa_n` > 38.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1005)
...
- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.200 (n=374)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.182 (n=444)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1339)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.271 (n=321)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1001)

- **FILTRO** `ibs_7min` < `0.7544` → IC=-0.208 (n=330)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7544
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=992)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.221 (n=328)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=994)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.271 (n=326)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=1298)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.159 (n=405)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1219)
...
- **PATRÓN** `streak_len` < `3.0` → IC=+0.140 (n=145)

  - _Acción_: Kelly boost +0.70€ cuando `streak_len` < 3.0 (IC base=+0.070)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=1154)
...
### UPDOWN_GBM#5min
- **FILTRO** `ibs_15` < `0.2213` → IC=-0.218 (n=115)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.2213
...
- **FILTRO** `delta_ratio_macro` |x|≤ `0.1861` → IC=-0.154 (n=24)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
  - _Acción_: SKIP cuando `delta_ratio_macro` |x|≤ 0.1861
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=25)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.134 (n=170)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.262` → IC=-0.175 (n=336)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1045` → IC=+0.263 (n=57)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
...
- **PATRÓN** `drift_60min` |x|≤ `0.2338` → IC=+0.246 (n=57)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2338 (IC base=+0.246)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1` → IC=+0.269 (n=76)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1 (IC base=+0.246)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.269 (n=76)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.246)

- **PATRÓN** `ibs_15` < `0.3357` → IC=+0.339 (n=85)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3357 (IC base=+0.246)

- **PATRÓN** `dist_vwap_pct` > `0.1628` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1628 (IC base=+0.246)

- **PATRÓN** `dist_vwap_pct` < `0.3513` → IC=+0.247 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3513 (IC base=+0.246)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.326` → IC=+0.273 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.326 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `12147.9804` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12147.9804 (IC base=+0.246)

- **PATRÓN** `ballena_activa_n` < `213.0` → IC=+0.254 (n=55)
...
- **FILTRO** `sigma_ewma_delta_pct` > `12.727` → IC=-0.144 (n=147)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 12.727
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=800)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.278 (n=151)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0041 (IC base=+0.276)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3802` → IC=+0.321 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3802 (IC base=+0.276)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.308 (n=233)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.276)

- **PATRÓN** `ibs_15` > `0.8607` → IC=+0.314 (n=202)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8607 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` > `0.3` → IC=+0.352 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3 (IC base=+0.276)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.463` → IC=+0.276 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.463 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.275 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `12245.063` → IC=+0.333 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12245.063 (IC base=+0.276)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3247 sube el IC de -0.079 a +0.352 en UPDOWN_GBM_15M_TARDIO (n=133). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3357 sube el IC de +0.246 a +0.339 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=85). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8607 sube el IC de +0.276 a +0.314 en UPDOWN_GBM_IBS_ALTO (n=202). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M