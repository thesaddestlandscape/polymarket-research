# Hipótesis automáticas — 2026-08-28 21:55 UTC
_Generado por shadow_postmortem.py sobre 193338 resoluciones (PNL=+14475.09€)_
...
- **FILTRO** `restante_s_al_confirmar` < `113.85` → IC=-0.391 (n=347)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1042)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `161.14` → IC=-0.158 (n=727)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 161.14
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2181)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `140.8` → IC=-0.309 (n=628)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.8
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1886)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.04` → IC=-0.353 (n=617)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.04
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1255)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.189 (n=5852)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=1682)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2375.6867` → IC=+0.171 (n=1620)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2375.6867 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.148 (n=3511)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=856)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.276 (n=512)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4421.0538` → IC=+0.288 (n=163)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.250 (n=238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.229 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `1946.1748` → IC=+0.243 (n=301)
...
- **PATRÓN** `py_entrada` < `0.415` → IC=+0.151 (n=434)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.196 (n=12360)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.218 (n=9844)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.191)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.136 (n=2487)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.157 (n=1673)

  - _Acción_: Kelly boost +0.79€ cuando `py_entrada` > 0.72 (IC base=+0.130)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.240 (n=2150)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.183 (n=908)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.204 (n=1113)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.167)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.233 (n=1970)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.203 (n=1798)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.134)

- **PATRÓN** `restante_min` < `3.98` → IC=+0.137 (n=1666)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` < 3.98 (IC base=+0.134)

- **PATRÓN** `restante_min` > `4.93` → IC=+0.158 (n=1781)
...
- **PATRÓN** `lag_apertura_s` < `4.22` → IC=+0.159 (n=1660)

  - _Acción_: Kelly boost +0.80€ cuando `lag_apertura_s` < 4.22 (IC base=+0.134)
...
- **PATRÓN** `restante_min` < `3.95` → IC=+0.145 (n=834)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` < 3.95 (IC base=+0.140)
...
- **PATRÓN** `lag_apertura_s` < `7.0` → IC=+0.158 (n=1091)

  - _Acción_: Kelly boost +0.79€ cuando `lag_apertura_s` < 7.0 (IC base=+0.140)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.197 (n=887)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.38 (IC base=+0.128)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.168 (n=931)

  - _Acción_: Kelly boost +0.84€ cuando `restante_min` > 4.94 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.132 (n=2503)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.37` → IC=+0.174 (n=836)
...
- **PATRÓN** `py_entrada` > `0.825` → IC=+0.385 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.825 (IC base=+0.298)

- **PATRÓN** `libro_liquidez` > `3872.2908` → IC=+0.302 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3872.2908 (IC base=+0.298)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.268` → IC=+0.155 (n=1002)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3081` → IC=+0.148 (n=197)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.3081 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `1.5817` → IC=+0.158 (n=609)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.5817 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.1158` → IC=+0.152 (n=1282)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.1158 (IC base=+0.032)

- **PATRÓN** `dist_vwap_pct` < `0.1366` → IC=+0.150 (n=803)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1366 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` < `0.6821` → IC=+0.156 (n=367)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6821 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` > `1.0494` → IC=+0.140 (n=378)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.0494 (IC base=+0.032)

- **PATRÓN** `volumen_pendiente_norm` > `0.307` → IC=+0.276 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.307 (IC base=+0.032)

- **PATRÓN** `volumen_spike_ratio` > `2.9153` → IC=+0.245 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9153 (IC base=+0.032)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.243 (n=251)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.270 (n=220)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.260 (n=294)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4216` → IC=+0.297 (n=289)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8682` → IC=+0.267 (n=148)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.155 (n=326)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0037 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.146 (n=221)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0049 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.0796` → IC=+0.173 (n=163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.0796 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.156 (n=460)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 7.0 (IC base=+0.146)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.154 (n=518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 18.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` < `0.4388` → IC=+0.181 (n=428)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.4388 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.1429` → IC=+0.173 (n=420)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1429 (IC base=+0.146)
...
- **PATRÓN** `volumen_regimen` < `0.6207` → IC=+0.187 (n=164)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6207 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.0931` → IC=+0.207 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0931 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.7599` → IC=+0.173 (n=255)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.7599 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.4117` → IC=+0.172 (n=382)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.4117 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=629)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `13919.5581` → IC=+0.195 (n=221)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 13919.5581 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `222.0` → IC=+0.170 (n=98)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 222.0 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.270 (n=385)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.255)

- **PATRÓN** `drift_60min` |x|≤ `0.4646` → IC=+0.265 (n=385)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4646 (IC base=+0.255)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.264 (n=265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.296 (n=385)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5208 (IC base=+0.255)
...
- **PATRÓN** `ballena_activa_n` < `52.0` → IC=+0.238 (n=185)
...
- **FILTRO** `ibs_20min` < `0.2846` → IC=-0.129 (n=165)
...
- **FILTRO** `drift_60min` |x|> `0.5333` → IC=-0.161 (n=249)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=485)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.136 (n=1428)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0078 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9441` → IC=+0.244 (n=1050)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9441 (IC base=+0.052)
...
- **PATRÓN** `ibs_20min` < `0.0909` → IC=+0.194 (n=1290)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.0909 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` > `0.8061` → IC=+0.223 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8061 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.2206` → IC=+0.213 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2206 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.8592` → IC=+0.212 (n=546)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2561` → IC=+0.362 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2561 (IC base=+0.041)
...
- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.273 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 48.0 (IC base=+0.041)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2441` → IC=-0.167 (n=220)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2441
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=447)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.349` → IC=+0.172 (n=126)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 5.349 (IC base=-0.005)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6985` → IC=+0.200 (n=18)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.337 (n=255)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.327)

- **PATRÓN** `drift_60min` |x|≤ `0.2567` → IC=+0.337 (n=194)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2567 (IC base=+0.327)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.359 (n=197)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.327)

- **PATRÓN** `ibs_20min` < `0.3296` → IC=+0.343 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3296 (IC base=+0.327)

- **PATRÓN** `ibs_20min` > `0.1304` → IC=+0.337 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1304 (IC base=+0.327)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.502` → IC=+0.338 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.502 (IC base=+0.327)

- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.412 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3592 (IC base=+0.327)

- **PATRÓN** `volumen_spike_ratio` < `1.7067` → IC=+0.324 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7067 (IC base=+0.327)

- **PATRÓN** `volumen_spike_ratio` > `2.4717` → IC=+0.343 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4717 (IC base=+0.327)

- **PATRÓN** `libro_liquidez` > `1870.8984` → IC=+0.369 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1870.8984 (IC base=+0.327)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.318 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.327)
...
- **FILTRO** `ibs_20min` < `0.7455` → IC=-0.134 (n=463)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7455
  - _Potencial_: sin este filtro IC_bueno=+0.214 (n=239)
...
- **PATRÓN** `volumen_regimen` < `0.8838` → IC=+0.271 (n=418)
...
- **PATRÓN** `volumen_spike_ratio` > `2.167` → IC=+0.288 (n=215)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.204 (n=1657)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0819` → IC=+0.214 (n=826)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0819 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.211 (n=1153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` < `0.4107` → IC=+0.240 (n=2475)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4107 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.914` → IC=+0.219 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.914 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` < `1.1724` → IC=+0.172 (n=1954)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.1724 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `0.6189` → IC=+0.170 (n=1954)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.6189 (IC base=+0.186)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5788` → IC=+0.178 (n=819)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.5788 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.6613` → IC=+0.211 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6613 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.194 (n=1263)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 121.0 (IC base=+0.186)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.257 (n=212)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.254)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.269 (n=240)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.254)

- **PATRÓN** `drift_60min` |x|≤ `0.2618` → IC=+0.293 (n=211)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4013` → IC=+0.285 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4013 (IC base=+0.254)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.358` → IC=+0.270 (n=268)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.324` → IC=+0.300 (n=28)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.324 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` < `1.9491` → IC=+0.281 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9491 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` > `2.8655` → IC=+0.283 (n=58)
...
- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.237 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.254)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.175 (n=490)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0059 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.2337` → IC=+0.177 (n=431)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.2337 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.176 (n=452)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 7.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` < `0.4268` → IC=+0.197 (n=490)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.4268 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.1641` → IC=+0.180 (n=488)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1641 (IC base=+0.153)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1669` → IC=+0.230 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1669 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.167 (n=382)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.5474 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `14847.8097` → IC=+0.199 (n=164)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 14847.8097 (IC base=+0.153)
...
- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.285 (n=282)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0102 (IC base=+0.261)

- **PATRÓN** `drift_60min` |x|≤ `0.2281` → IC=+0.305 (n=188)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2281 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.289 (n=188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` < `0.3046` → IC=+0.316 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3046 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.143` → IC=+0.344 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.143 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` > `0.3709` → IC=+0.443 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3709 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` > `1.6729` → IC=+0.256 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6729 (IC base=+0.261)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3825` → IC=+0.159 (n=470)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3825 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=179)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3669` → IC=+0.209 (n=414)
...
- **PATRÓN** `volumen_regimen` < `1.1685` → IC=+0.155 (n=470)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1685 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.599` → IC=+0.152 (n=470)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.599 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.1023` → IC=+0.164 (n=144)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1023 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `1.9018` → IC=+0.176 (n=242)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.9018 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.5362` → IC=+0.150 (n=121)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 2.5362 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `10925.4465` → IC=+0.167 (n=157)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 10925.4465 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.146 (n=125)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 122.0 (IC base=+0.142)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.219 (n=158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.4085` → IC=+0.237 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4085 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.9902` → IC=+0.144 (n=57)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9902 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1779` → IC=+0.157 (n=406)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1779 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.22` → IC=+0.204 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.22 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1545` → IC=+0.152 (n=446)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2196` → IC=+0.214 (n=61)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2196 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` > `2.273` → IC=+0.229 (n=105)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.273 (IC base=+0.139)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6757` → IC=+0.233 (n=552)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6757 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.232 (n=270)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3158` → IC=+0.141 (n=332)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.3158 (IC base=+0.060)
...
- **PATRÓN** `ibs_20min` < `0.0488` → IC=+0.231 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0488 (IC base=+0.058)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.217 (n=1939)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.4847` → IC=+0.200 (n=2908)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4847 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.193 (n=1097)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5628` → IC=+0.246 (n=2908)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5628 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` < `0.4369` → IC=+0.181 (n=2160)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.4369 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.42` → IC=+0.204 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.42 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.664` → IC=+0.195 (n=2731)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 2.664 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` < `0.6178` → IC=+0.188 (n=718)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6178 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` > `1.201` → IC=+0.176 (n=717)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.201 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.268 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.304` → IC=+0.208 (n=1001)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.304 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `173.0` → IC=+0.171 (n=1781)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 173.0 (IC base=+0.190)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.293 (n=225)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.271 (n=303)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.308 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.116` → IC=+0.288 (n=366)
...
- **PATRÓN** `libro_liquidez` > `1961.4408` → IC=+0.309 (n=113)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1961.4408 (IC base=+0.267)

- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.252 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 74.0 (IC base=+0.267)
...
- **PATRÓN** `ibs_20min` < `0.3927` → IC=+0.217 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3927 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.184 (n=431)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.1` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.1 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.6181` → IC=+0.242 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6181 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.146` → IC=+0.278 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.146 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.7531` → IC=+0.200 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7531 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=625)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `13169.0911` → IC=+0.179 (n=219)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 13169.0911 (IC base=+0.168)
...
- **PATRÓN** `drift_60min` |x|≤ `0.208` → IC=+0.245 (n=280)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.208 (IC base=+0.243)
...
- **PATRÓN** `ibs_20min` < `0.5541` → IC=+0.308 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5541 (IC base=+0.243)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.093` → IC=+0.265 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.093 (IC base=+0.243)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7651` → IC=+0.245 (n=100)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7651 (IC base=+0.243)

- **PATRÓN** `volumen_spike_ratio` > `2.4041` → IC=+0.220 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4041 (IC base=+0.243)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.274 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.243)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.193 (n=187)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 59.0 (IC base=+0.243)
...
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.193 (n=148)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0033 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.5098` → IC=+0.161 (n=437)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.5098 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.148 (n=157)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.298` → IC=+0.218 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.298 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.1739` → IC=+0.152 (n=202)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1739 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.457` → IC=+0.218 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.457 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.5754` → IC=+0.162 (n=146)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.5754 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `1.1518` → IC=+0.169 (n=146)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.1518 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.2395` → IC=+0.296 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2395 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `2.4663` → IC=+0.190 (n=127)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.4663 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `11684.767` → IC=+0.209 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11684.767 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.205 (n=161)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.182 (n=174)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0056 (IC base=+0.116)

- **PATRÓN** `drift_60min` |x|≤ `0.1241` → IC=+0.153 (n=174)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1241 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=247)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` < `0.5938` → IC=+0.202 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5938 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.507` → IC=+0.139 (n=494)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.507 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.097` → IC=+0.139 (n=508)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 3.097 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `0.7076` → IC=+0.155 (n=230)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7076 (IC base=+0.116)
...
- **PATRÓN** `volumen_spike_ratio` < `2.108` → IC=+0.142 (n=328)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.108 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` > `1.4441` → IC=+0.142 (n=372)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.4441 (IC base=+0.116)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=545)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2687.2246` → IC=+0.164 (n=236)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2687.2246 (IC base=+0.116)
...
- **PATRÓN** `drift_60min` |x|≤ `0.493` → IC=+0.227 (n=627)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.493 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.222 (n=668)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4944` → IC=+0.280 (n=712)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4944 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.4711` → IC=+0.226 (n=754)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2111` → IC=+0.228 (n=244)
...
- **PATRÓN** `ibs_20min` > `0.8077` → IC=+0.154 (n=380)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.8077 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.245` → IC=+0.169 (n=152)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.245 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `2.6057` → IC=+0.135 (n=275)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.6057 (IC base=+0.102)
...
- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.179 (n=110)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0099 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.178 (n=147)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 7.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` > `0.9219` → IC=+0.254 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9219 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.267` → IC=+0.278 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.267 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.2151` → IC=+0.188 (n=46)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2151 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` < `3.4649` → IC=+0.133 (n=164)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 3.4649 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` > `2.3902` → IC=+0.140 (n=109)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.3902 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `1876.5686` → IC=+0.153 (n=165)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1876.5686 (IC base=+0.124)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=128)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.098)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.123 (n=67)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.505 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2490.1288` → IC=+0.156 (n=123)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 2490.1288 (IC base=+0.098)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=947)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=2847)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.207 (n=961)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=2922)

- **FILTRO** `ibs_20min` > `0.2698` → IC=-0.172 (n=970)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2698
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2913)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.136 (n=174)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=407)

- **FILTRO** `py_entrada` < `0.5` → IC=-0.180 (n=254)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=327)

- **FILTRO** `ibs_20min` < `0.7273` → IC=-0.194 (n=145)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=436)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.214 (n=145)
...
- **FILTRO** `ibs_20min` > `0.2734` → IC=-0.209 (n=156)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=2371)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=7233)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.281 (n=2360)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=7244)

- **FILTRO** `ibs_7min` < `0.7292` → IC=-0.236 (n=2400)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7292
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=7204)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.174 (n=3240)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=6364)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=2913)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=8788)

- **FILTRO** `ibs_7min` > `0.7158` → IC=-0.173 (n=2925)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7158
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=8776)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.316 (n=318)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=987)

- **FILTRO** `ibs_7min` < `1.0` → IC=-0.190 (n=914)
...
- **FILTRO** `drift_7min_pct` |x|> `0.1331` → IC=-0.138 (n=685)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1331
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1330)

- **FILTRO** `ibs_7min` > `0.8511` → IC=-0.183 (n=503)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8511
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1512)
...
- **FILTRO** `py_entrada` > `0.61` → IC=-0.215 (n=451)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1398)

- **FILTRO** `ballena_activa_n` > `98.0` → IC=-0.163 (n=624)

  - _Acción_: SKIP cuando `ballena_activa_n` > 98.0
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1225)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.248 (n=443)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1612)

- **FILTRO** `ibs_7min` > `0.8125` → IC=-0.185 (n=513)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8125
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1542)
...
- **FILTRO** `hora_utc` > `15.0` → IC=-0.121 (n=533)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
...
- **FILTRO** `py_entrada` > `0.66` → IC=-0.266 (n=387)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1224)

- **FILTRO** `ibs_7min` > `0.1827` → IC=-0.165 (n=547)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1827
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=1064)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.187 (n=522)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1647)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.298 (n=384)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1198)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.232 (n=389)
...
- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.233 (n=388)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1194)
...
- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.124 (n=653)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1349)
...
- **PATRÓN** `delta_ratio` |x|> `0.3986` → IC=+0.135 (n=349)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.68€ cuando `delta_ratio` |x|> 0.3986 (IC base=+0.115)

- **PATRÓN** `total_vol_5m` < `456.268` → IC=+0.167 (n=109)

  - _Acción_: Kelly boost +0.83€ cuando `total_vol_5m` < 456.268 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3219.1556` → IC=+0.138 (n=125)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 3219.1556 (IC base=+0.115)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.157 (n=33)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 8.0 (IC base=+0.087)

- **PATRÓN** `total_vol_5m` < `418.1817` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `total_vol_5m` < 418.1817 (IC base=+0.087)
...
- **PATRÓN** `streak_estiramiento` < `0.2602` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `streak_estiramiento` < 0.2602 (IC base=+0.010)

### STREAK_MOM_5M#SOL#5min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=339)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.078 (n=242)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.162 (n=69)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 5.0 (IC base=+0.064)
...
- **FILTRO** `sigma_h` > `0.0099` → IC=-0.178 (n=265)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=797)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.708` → IC=-0.173 (n=362)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=2743)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0648` → IC=+0.251 (n=207)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0648 (IC base=-0.074)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2993` → IC=+0.273 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2993 (IC base=-0.074)

- **PATRÓN** `ibs_15` < `0.3676` → IC=+0.318 (n=207)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3676 (IC base=-0.074)

- **PATRÓN** `dist_vwap_pct` < `0.2505` → IC=+0.246 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2505 (IC base=-0.074)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1045` → IC=+0.265 (n=79)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1045 (IC base=+0.239)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.256 (n=117)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.250 (n=78)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.239)

- **PATRÓN** `drift_60min` |x|≤ `0.2306` → IC=+0.237 (n=78)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2306 (IC base=+0.239)

- **PATRÓN** `drift_15min` |x|≤ `0.4204` → IC=+0.281 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4204 (IC base=+0.239)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1016` → IC=+0.255 (n=104)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1016 (IC base=+0.239)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.304` → IC=+0.262 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.304 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.247 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` < `0.3707` → IC=+0.324 (n=117)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3707 (IC base=+0.239)

- **PATRÓN** `dist_vwap_pct` < `0.1254` → IC=+0.250 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1254 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.326` → IC=+0.267 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.326 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `6950.975` → IC=+0.250 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6950.975 (IC base=+0.239)

- **PATRÓN** `ballena_activa_n` < `202.0` → IC=+0.242 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 202.0 (IC base=+0.239)
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.036` → IC=-0.145 (n=119)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=963)

- **PATRÓN** `ibs_15` > `0.8125` → IC=+0.206 (n=15)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8125 (IC base=-0.108)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2219` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2219 (IC base=-0.056)

- **PATRÓN** `ibs_15` < `0.2796` → IC=+0.210 (n=36)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.214 (n=68)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.138 (n=205)

- **FILTRO** `libro_liquidez` < `2506.3298` → IC=-0.229 (n=68)

  - _Acción_: SKIP cuando `libro_liquidez` < 2506.3298
  - _Potencial_: sin este filtro IC_bueno=-0.133 (n=205)
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3676 sube el IC de -0.074 a +0.318 en UPDOWN_GBM_15M_TARDIO (n=207). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3707 sube el IC de +0.239 a +0.324 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=117). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.2796 sube el IC de -0.056 a +0.210 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=36). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 10811 | -0.096 | -1787.69€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 762 | -0.058 | -133.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 10049 | -0.099 | -1653.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1366 | -0.035 | -265.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1366 | -0.035 | -265.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 762 | -0.058 | -133.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 762 | -0.058 | -133.97€ | 3 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1389 | -0.148 | -429.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1389 | -0.148 | -429.81€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 2908 | -0.065 | -286.74€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 2908 | -0.065 | -286.74€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2514 | -0.095 | -216.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2514 | -0.095 | -216.68€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1872 | -0.165 | -455.44€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1872 | -0.165 | -455.44€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 699 | -0.059 | +345.26€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 201 | -0.003 | +81.33€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 498 | -0.082 | +263.92€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 699 | -0.059 | +345.26€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 201 | -0.003 | +81.33€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 498 | -0.082 | +263.92€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 35327 | +0.114 | -2233.41€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6381 | +0.185 | -235.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 113 | -0.083 | -46.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 25533 | +0.097 | -1898.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3300 | +0.119 | -53.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 4282 | +0.068 | -687.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 21 | -0.065 | +2.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 4256 | +0.069 | -683.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 7237 | +0.133 | -167.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1808 | +0.197 | -97.53€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 4248 | +0.109 | -99.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1139 | +0.128 | +51.64€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 4294 | +0.082 | -516.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 22 | +0.083 | +3.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 4271 | +0.082 | -518.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 7766 | +0.126 | -125.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2318 | +0.166 | -20.95€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 4251 | +0.113 | -69.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1185 | +0.101 | -26.49€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 7467 | +0.133 | -463.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2195 | +0.201 | -121.96€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 51 | +0.028 | -6.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 4245 | +0.099 | -256.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 976 | +0.132 | -78.36€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 4281 | +0.108 | -272.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 4262 | +0.108 | -271.16€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 18154 | +0.191 | -1597.69€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 18154 | +0.191 | -1597.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 3298 | +0.130 | -589.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 3298 | +0.130 | -589.28€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2839 | +0.234 | -64.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2839 | +0.234 | -64.79€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 3110 | +0.167 | -381.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 3110 | +0.167 | -381.38€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2888 | +0.226 | -99.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2888 | +0.226 | -99.17€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2964 | +0.212 | -161.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2964 | +0.212 | -161.28€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 3055 | +0.185 | -301.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 3055 | +0.185 | -301.79€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 6636 | +0.134 | +257.32€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 6636 | +0.134 | +257.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 3305 | +0.140 | +160.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 3305 | +0.140 | +160.84€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 3331 | +0.128 | +96.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 3331 | +0.128 | +96.47€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 809 | +0.298 | +1.97€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#60min | 809 | +0.298 | +1.97€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 7914 | +0.096 | -264.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#15min | 772 | +0.074 | -14.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#5min | 7142 | +0.098 | -249.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC | 5203 | +0.097 | -105.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0#BTC#15min |