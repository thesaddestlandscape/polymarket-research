# Hipótesis automáticas — 2026-09-04 22:47 UTC
_Generado por shadow_postmortem.py sobre 287232 resoluciones (PNL=+28176.39€)_
...
- **FILTRO** `py_entrada` > `0.5` → IC=-0.392 (n=81)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.138 (n=296)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.138 (n=296)

  - _Acción_: Kelly boost +0.69€ cuando `py_entrada` < 0.5 (IC base=+0.022)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.139 (n=81)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 125.0 (IC base=+0.022)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.44` → IC=-0.299 (n=3861)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.44
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=11584)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `133.8` → IC=-0.325 (n=512)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.8
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1537)
...
- **FILTRO** `restante_s_al_confirmar` < `115.55` → IC=-0.403 (n=515)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 115.55
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=1545)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `144.69` → IC=-0.311 (n=856)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.69
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2568)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `158.32` → IC=-0.378 (n=930)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.32
  - _Potencial_: sin este filtro IC_bueno=-0.101 (n=1889)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=8188)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.166 (n=2084)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2371.8003` → IC=+0.169 (n=1998)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2371.8003 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=5794)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.785` → IC=+0.375 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.785 (IC base=+0.207)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=1136)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.207)

- **PATRÓN** `libro_liquidez` > `14487.9883` → IC=+0.222 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14487.9883 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.199 (n=861)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.259 (n=827)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.191 (n=1207)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.190)

- **PATRÓN** `libro_liquidez` > `12561.7266` → IC=+0.207 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12561.7266 (IC base=+0.190)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.127 (n=676)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.143 (n=1694)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.309 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.264 (n=651)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.66` → IC=+0.263 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.66 (IC base=+0.133)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.144 (n=473)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `1532.5809` → IC=+0.157 (n=391)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 1532.5809 (IC base=+0.133)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.217 (n=405)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.203 (n=291)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.225` → IC=+0.348 (n=268)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.225 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `932.6939` → IC=+0.209 (n=798)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 932.6939 (IC base=+0.203)

### FAVORITO_CONFIRMADO#SOL#60min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.188 (n=280)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 6.0 (IC base=+0.175)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.335 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.175)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=172)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.175)

- **PATRÓN** `libro_liquidez` > `3436.2112` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 3436.2112 (IC base=+0.175)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.196 (n=6376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.201 (n=3029)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.189)

- **PATRÓN** `libro_liquidez` > `3268.7028` → IC=+0.309 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3268.7028 (IC base=+0.189)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.177 (n=1389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 15.0 (IC base=+0.164)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=1638)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.312 (n=515)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.196 (n=1565)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.191 (n=809)
...
- **PATRÓN** `libro_liquidez` > `8027.017` → IC=+0.452 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8027.017 (IC base=+0.442)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.181 (n=2691)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.72 (IC base=+0.151)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.228 (n=3148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.272 (n=1774)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.225)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=1154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.182 (n=3145)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.71 (IC base=+0.163)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=1610)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.273 (n=1130)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.238 (n=1554)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.200)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.190 (n=1121)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.28` → IC=+0.168 (n=1215)

  - _Acción_: Kelly boost +0.84€ cuando `lag_apertura_s` < 3.28 (IC base=+0.125)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.314 (n=653)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.291 (n=863)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `1758.0662` → IC=+0.293 (n=728)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1758.0662 (IC base=+0.291)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.296 (n=283)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4010.9878` → IC=+0.284 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4010.9878 (IC base=+0.277)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.340 (n=241)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.297 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.296)

- **PATRÓN** `libro_liquidez` > `1560.0097` → IC=+0.318 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1560.0097 (IC base=+0.296)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.314 (n=165)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1060.0185` → IC=+0.276 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1060.0185 (IC base=+0.260)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3614` → IC=+0.130 (n=3848)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` > 0.3614 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` < `0.4771` → IC=+0.227 (n=825)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4771 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.65` → IC=+0.152 (n=1465)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 5.65 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` < `0.626` → IC=+0.229 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.626 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.246 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=+0.084)

- **PATRÓN** `volumen_pendiente_norm` > `0.1705` → IC=+0.184 (n=663)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1705 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `2.8454` → IC=+0.179 (n=2328)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.8454 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` > `1.4731` → IC=+0.175 (n=2329)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.4731 (IC base=+0.084)

- **PATRÓN** `ibs_20min` < `0.4013` → IC=+0.128 (n=3687)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4013 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` < `0.3411` → IC=+0.146 (n=1372)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3411 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` < `0.6868` → IC=+0.144 (n=580)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6868 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` > `1.0473` → IC=+0.144 (n=597)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.0473 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.3028` → IC=+0.238 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3028 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` > `2.8125` → IC=+0.215 (n=671)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8125 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.210 (n=1548)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 122.0 (IC base=+0.042)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.185 (n=287)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0076 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.2868` → IC=+0.157 (n=858)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.271 (n=312)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2291` → IC=+0.230 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2291 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.6409` → IC=+0.140 (n=760)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.6409 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.145 (n=761)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4427 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=706)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.188 (n=508)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 64.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.264 (n=388)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.270 (n=520)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.0819` → IC=+0.321 (n=194)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0819 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.264 (n=532)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4048` → IC=+0.282 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4048 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.485` → IC=+0.264 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.485 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.213` → IC=+0.274 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.213 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` < `0.069` → IC=+0.258 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.069 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2908` → IC=+0.341 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2908 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `1.5795` → IC=+0.280 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5795 (IC base=+0.258)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.268 (n=581)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1709.5178` → IC=+0.282 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1709.5178 (IC base=+0.258)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.261 (n=416)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.242 (n=227)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.237 (n=678)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` > `0.9278` → IC=+0.243 (n=306)
...
- **PATRÓN** `dist_vwap_pct` < `0.4864` → IC=+0.221 (n=621)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4864 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.225` → IC=+0.227 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.225 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.07` → IC=+0.216 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.07 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` < `1.2518` → IC=+0.220 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2518 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.231 (n=306)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4797` → IC=+0.247 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4797 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `11046.4069` → IC=+0.239 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11046.4069 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.152 (n=489)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.004 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.003` → IC=+0.145 (n=655)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.003 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.1757` → IC=+0.148 (n=489)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.1757 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.143 (n=662)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.141 (n=516)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 12.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.6603` → IC=+0.167 (n=733)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6603 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.3375` → IC=+0.158 (n=715)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.3375 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.516` → IC=+0.228 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.516 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.6178` → IC=+0.172 (n=245)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.6178 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1492` → IC=+0.220 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1492 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.7227` → IC=+0.156 (n=417)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.7227 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.3961` → IC=+0.157 (n=625)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.3961 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12702.6869` → IC=+0.154 (n=489)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12702.6869 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `214.0` → IC=+0.174 (n=182)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 214.0 (IC base=+0.140)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.255 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.351` → IC=+0.272 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.351 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` < `0.1342` → IC=+0.160 (n=698)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.1342 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `3.8668` → IC=+0.161 (n=727)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 3.8668 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.6876` → IC=+0.176 (n=726)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.6876 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=848)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.192 (n=498)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 47.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.244 (n=663)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.386` → IC=+0.235 (n=583)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.386 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.240 (n=325)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0312` → IC=+0.294 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0312 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.768` → IC=+0.291 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.768 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.3746` → IC=+0.293 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3746 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` < `1.6985` → IC=+0.242 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6985 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `3.1107` → IC=+0.225 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1107 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `34.0` → IC=+0.228 (n=314)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=72)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1128)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8099` → IC=+0.160 (n=142)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8099 (IC base=-0.038)
...
- **FILTRO** `drift_60min` |x|> `0.5171` → IC=-0.165 (n=365)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.202 (n=129)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=946)

- **FILTRO** `ibs_20min` > `0.7885` → IC=-0.192 (n=430)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7885
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1291)

- **FILTRO** `sigma_ewma_delta_pct` > `8.971` → IC=-0.135 (n=198)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.971
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1523)
...
- **PATRÓN** `dist_vwap_pct` < `0.2521` → IC=+0.220 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2521 (IC base=-0.047)

- **PATRÓN** `volumen_regimen` > `1.295` → IC=+0.278 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.295 (IC base=-0.047)

- **PATRÓN** `volumen_pendiente_norm` > `0.2526` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2526 (IC base=-0.047)

- **PATRÓN** `volumen_spike_ratio` < `2.3156` → IC=+0.192 (n=115)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.3156 (IC base=-0.047)

- **PATRÓN** `volumen_spike_ratio` > `1.8998` → IC=+0.185 (n=87)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.8998 (IC base=-0.047)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.175 (n=1582)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0094 (IC base=+0.076)

- **PATRÓN** `ibs_20min` > `0.3` → IC=+0.145 (n=4748)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.3 (IC base=+0.076)

- **PATRÓN** `dist_vwap_pct` > `1.2305` → IC=+0.294 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2305 (IC base=+0.076)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.476` → IC=+0.123 (n=2511)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 2.476 (IC base=+0.076)

- **PATRÓN** `volumen_regimen` > `0.6802` → IC=+0.222 (n=1385)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6802 (IC base=+0.076)

- **PATRÓN** `volumen_pendiente_norm` > `0.251` → IC=+0.243 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.251 (IC base=+0.076)

- **PATRÓN** `volumen_spike_ratio` < `1.4852` → IC=+0.233 (n=785)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4852 (IC base=+0.076)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.294 (n=1814)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.076)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.131 (n=4583)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5833 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `0.7924` → IC=+0.247 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7924 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` < `0.2278` → IC=+0.221 (n=1132)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2278 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` < `0.7084` → IC=+0.221 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7084 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` > `1.2256` → IC=+0.251 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2256 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` > `0.2564` → IC=+0.338 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2564 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `2.8009` → IC=+0.279 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8009 (IC base=+0.053)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.266 (n=1218)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 68.0 (IC base=+0.053)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3057` → IC=-0.150 (n=395)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3057
  - _Potencial_: sin este filtro IC_bueno=+0.113 (n=804)

- **FILTRO** `sigma_ewma_delta_pct` > `2.454` → IC=-0.159 (n=350)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.454
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=763)

- **PATRÓN** `ibs_20min` > `0.8333` → IC=+0.223 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8333 (IC base=+0.026)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.072` → IC=+0.126 (n=450)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 2.072 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` > `0.2195` → IC=+0.343 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2195 (IC base=+0.026)

- **PATRÓN** `volumen_spike_ratio` < `1.8924` → IC=+0.228 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8924 (IC base=+0.026)

- **PATRÓN** `volumen_spike_ratio` > `1.4728` → IC=+0.229 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4728 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `38.0` → IC=+0.328 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 38.0 (IC base=+0.026)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8608` → IC=-0.160 (n=395)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8608
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1187)

- **PATRÓN** `volumen_spike_ratio` < `2.0452` → IC=+0.124 (n=309)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.0452 (IC base=-0.009)

- **PATRÓN** `ballena_activa_n` < `260.0` → IC=+0.149 (n=112)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 260.0 (IC base=-0.009)

- **PATRÓN** `dist_vwap_pct` < `0.123` → IC=+0.165 (n=183)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.123 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.8238` → IC=+0.167 (n=127)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8238 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` > `1.1078` → IC=+0.182 (n=64)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.1078 (IC base=-0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.0752` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0752 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `2.0225` → IC=+0.187 (n=129)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.0225 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.3934` → IC=+0.155 (n=146)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.3934 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `264.0` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 264.0 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0096` → IC=+0.290 (n=255)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0096 (IC base=+0.227)

- **PATRÓN** `drift_60min` |x|≤ `0.1252` → IC=+0.232 (n=337)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1252 (IC base=+0.227)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.254 (n=364)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.227)

- **PATRÓN** `ibs_20min` > `0.7059` → IC=+0.260 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7059 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.36` → IC=+0.305 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.36 (IC base=+0.227)

- **PATRÓN** `volumen_pendiente_norm` < `0.1095` → IC=+0.240 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1095 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` < `2.4328` → IC=+0.228 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4328 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` > `1.727` → IC=+0.234 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.727 (IC base=+0.227)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.255 (n=795)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5361` → IC=+0.304 (n=544)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5361 (IC base=+0.305)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.328 (n=365)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.68` → IC=+0.340 (n=179)
...
- **PATRÓN** `volumen_spike_ratio` < `3.4422` → IC=+0.297 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.4422 (IC base=+0.305)
...
- **PATRÓN** `libro_liquidez` > `1843.4629` → IC=+0.310 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1843.4629 (IC base=+0.305)
...
- **FILTRO** `hora_utc` < `9.0` → IC=-0.147 (n=236)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=531)

- **FILTRO** `ibs_20min` < `0.7898` → IC=-0.130 (n=506)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7898
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=261)

- **FILTRO** `ibs_20min` > `0.7335` → IC=-0.145 (n=423)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7335
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=822)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.135 (n=83)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1162)

- **PATRÓN** `dist_vwap_pct` > `1.6841` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6841 (IC base=-0.054)

- **PATRÓN** `volumen_regimen` < `0.9565` → IC=+0.147 (n=100)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.9565 (IC base=-0.054)

- **PATRÓN** `volumen_pendiente_norm` > `0.1662` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1662 (IC base=-0.054)

- **PATRÓN** `volumen_spike_ratio` < `2.091` → IC=+0.240 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.091 (IC base=-0.054)

- **PATRÓN** `volumen_spike_ratio` > `1.3579` → IC=+0.211 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.3579 (IC base=-0.054)

- **PATRÓN** `ballena_activa_n` < `189.0` → IC=+0.246 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 189.0 (IC base=-0.054)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.8235` → IC=-0.138 (n=677)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8235
  - _Potencial_: sin este filtro IC_bueno=+0.295 (n=349)

- **FILTRO** `ibs_20min` > `0.7568` → IC=-0.232 (n=293)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7568
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=882)

- **FILTRO** `sigma_ewma_delta_pct` > `4.709` → IC=-0.149 (n=297)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.709
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=878)

- **PATRÓN** `ibs_20min` > `0.9394` → IC=+0.334 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9394 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` > `0.5648` → IC=+0.326 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5648 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.260 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` > `1.1512` → IC=+0.291 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1512 (IC base=+0.010)

- **PATRÓN** `volumen_pendiente_norm` < `0.1143` → IC=+0.258 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1143 (IC base=+0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.274` → IC=+0.278 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.274 (IC base=+0.010)

- **PATRÓN** `volumen_spike_ratio` < `1.4503` → IC=+0.300 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4503 (IC base=+0.010)

- **PATRÓN** `volumen_spike_ratio` > `2.3531` → IC=+0.252 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3531 (IC base=+0.010)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.303 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.010)
...
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.337 (n=507)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` < `2.5673` → IC=+0.264 (n=700)
...
- **PATRÓN** `libro_liquidez` > `2468.9826` → IC=+0.260 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2468.9826 (IC base=+0.255)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.283 (n=274)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0063 (IC base=+0.277)

- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.301 (n=274)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.277)

- **PATRÓN** `drift_60min` |x|≤ `0.3199` → IC=+0.278 (n=548)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3199 (IC base=+0.277)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.287 (n=398)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.277)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.276 (n=548)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.277)

- **PATRÓN** `ibs_20min` < `0.375` → IC=+0.314 (n=821)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.375 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.5433` → IC=+0.281 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5433 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` < `0.2079` → IC=+0.280 (n=748)
...
- **PATRÓN** `volumen_regimen` > `1.2624` → IC=+0.308 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2624 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` > `0.243` → IC=+0.379 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.243 (IC base=+0.277)

- **PATRÓN** `volumen_spike_ratio` > `2.1862` → IC=+0.293 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1862 (IC base=+0.277)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0105` → IC=+0.205 (n=1332)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0105 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3421` → IC=+0.171 (n=3515)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3421 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.181 (n=1458)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.283 (n=1829)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.797` → IC=+0.233 (n=842)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.797 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.722` → IC=+0.236 (n=1613)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.722 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.6285` → IC=+0.163 (n=2702)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6285 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.1049` → IC=+0.186 (n=1499)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1049 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `2.3147` → IC=+0.164 (n=3279)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.3147 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.165 (n=4089)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.03 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `3958.3691` → IC=+0.175 (n=1332)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3958.3691 (IC base=+0.163)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.180 (n=2906)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 143.0 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.187 (n=3274)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0084 (IC base=+0.177)

- **PATRÓN** `drift_60min` |x|≤ `0.0795` → IC=+0.211 (n=1240)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0795 (IC base=+0.177)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.194 (n=1798)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4384` → IC=+0.227 (n=3720)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4384 (IC base=+0.177)

- **PATRÓN** `dist_vwap_pct` < `0.2269` → IC=+0.170 (n=2823)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.2269 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.028` → IC=+0.213 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.028 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` < `1.1714` → IC=+0.164 (n=2805)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1714 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` > `0.6221` → IC=+0.159 (n=2805)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6221 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.2933` → IC=+0.245 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2933 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `2.6529` → IC=+0.201 (n=1031)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6529 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `157.0` → IC=+0.177 (n=2680)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 157.0 (IC base=+0.177)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.266 (n=378)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.242)

- **PATRÓN** `drift_60min` |x|≤ `0.1645` → IC=+0.310 (n=283)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1645 (IC base=+0.242)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.692` → IC=+0.253 (n=463)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.692 (IC base=+0.242)

- **PATRÓN** `volumen_pendiente_norm` < `0.0672` → IC=+0.230 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0672 (IC base=+0.242)

- **PATRÓN** `volumen_pendiente_norm` > `0.2471` → IC=+0.295 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2471 (IC base=+0.242)

- **PATRÓN** `volumen_spike_ratio` < `1.9106` → IC=+0.241 (n=237)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.254 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.242)

- **PATRÓN** `libro_liquidez` > `1701.724` → IC=+0.278 (n=282)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1701.724 (IC base=+0.242)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.246 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 65.0 (IC base=+0.242)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.802` → IC=+0.233 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.802 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.6383` → IC=+0.185 (n=198)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6383 (IC base=+0.165)
...
- **PATRÓN** `libro_liquidez` > `11367.7033` → IC=+0.191 (n=529)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11367.7033 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.180 (n=680)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0061 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.0622` → IC=+0.212 (n=227)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0622 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=630)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` < `0.4851` → IC=+0.191 (n=680)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.4851 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.1998` → IC=+0.172 (n=687)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1998 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.3` → IC=+0.243 (n=142)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1584` → IC=+0.224 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1584 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.4143` → IC=+0.164 (n=572)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.4143 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.3935` → IC=+0.162 (n=572)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.3935 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `15713.1388` → IC=+0.155 (n=227)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 15713.1388 (IC base=+0.154)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1779` → IC=+0.199 (n=417)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1779 (IC base=+0.173)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.190 (n=214)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 17.0 (IC base=+0.173)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.190 (n=214)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 5.0 (IC base=+0.173)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.302 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.173)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.631` → IC=+0.316 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.631 (IC base=+0.173)

- **PATRÓN** `volumen_pendiente_norm` > `0.1321` → IC=+0.185 (n=230)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1321 (IC base=+0.173)

- **PATRÓN** `volumen_spike_ratio` < `3.1497` → IC=+0.168 (n=495)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 3.1497 (IC base=+0.173)

- **PATRÓN** `volumen_spike_ratio` > `1.7083` → IC=+0.167 (n=562)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.7083 (IC base=+0.173)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.196 (n=640)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.04 (IC base=+0.173)

- **PATRÓN** `libro_liquidez` > `1902.6156` → IC=+0.173 (n=209)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1902.6156 (IC base=+0.173)
...
- **PATRÓN** `volumen_spike_ratio` > `3.0796` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0796 (IC base=+0.230)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.207 (n=401)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.3661` → IC=+0.168 (n=528)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3661 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.173 (n=612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.436` → IC=+0.201 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.436 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.1546` → IC=+0.184 (n=416)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1546 (IC base=+0.157)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.159 (n=672)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `8843.5076` → IC=+0.189 (n=400)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 8843.5076 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.149 (n=360)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 136.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.216 (n=223)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.3796` → IC=+0.149 (n=667)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3796 (IC base=+0.129)
...
- **PATRÓN** `ibs_20min` < `0.5424` → IC=+0.180 (n=667)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.5424 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.6087` → IC=+0.142 (n=781)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.6087 (IC base=+0.129)
...
- **PATRÓN** `volumen_regimen` < `1.1531` → IC=+0.137 (n=667)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.1531 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.136 (n=668)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.6121 (IC base=+0.129)

- **PATRÓN** `volumen_pendiente_norm` > `0.1024` → IC=+0.170 (n=225)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1024 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` < `1.8383` → IC=+0.139 (n=372)
...
- **PATRÓN** `libro_liquidez` > `9785.3342` → IC=+0.139 (n=303)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 9785.3342 (IC base=+0.129)

- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.123 (n=423)
...
- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.186 (n=342)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0104 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.129 (n=791)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.5357` → IC=+0.191 (n=752)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.5357 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.145` → IC=+0.254 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.145 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.352` → IC=+0.271 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.352 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` > `0.7092` → IC=+0.127 (n=671)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.7092 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` < `0.1692` → IC=+0.130 (n=752)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1692 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `2.4992` → IC=+0.125 (n=715)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.4992 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=571)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3204.5735` → IC=+0.215 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3204.5735 (IC base=+0.114)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.185 (n=316)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` < `0.4688` → IC=+0.219 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4688 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` < `0.2472` → IC=+0.142 (n=654)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.2472 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.282` → IC=+0.158 (n=273)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.282 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` < `1.1678` → IC=+0.143 (n=685)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1678 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `0.8565` → IC=+0.142 (n=456)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.8565 (IC base=+0.130)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5448` → IC=+0.139 (n=242)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.5448 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` > `2.3625` → IC=+0.197 (n=183)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.3625 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `1452.0978` → IC=+0.150 (n=612)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 1452.0978 (IC base=+0.130)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0173` → IC=+0.216 (n=506)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0173 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.1678` → IC=+0.215 (n=335)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1678 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.200 (n=795)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.191)

- **PATRÓN** `ibs_20min` > `0.8873` → IC=+0.272 (n=506)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8873 (IC base=+0.191)

- **PATRÓN** `dist_vwap_pct` > `0.2568` → IC=+0.229 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2568 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.237 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.169 (IC base=+0.191)

- **PATRÓN** `volumen_regimen` > `0.6862` → IC=+0.209 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6862 (IC base=+0.191)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5204` → IC=+0.209 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5204 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `1.5152` → IC=+0.196 (n=643)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.5152 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=864)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.266 (n=259)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.209)

- **PATRÓN** `drift_60min` |x|≤ `0.6471` → IC=+0.217 (n=775)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6471 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.212 (n=352)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4118` → IC=+0.254 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4118 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` < `0.5153` → IC=+0.214 (n=863)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5153 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.918` → IC=+0.264 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.918 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.6912` → IC=+0.236 (n=692)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6912 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.332 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.6536` → IC=+0.232 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6536 (IC base=+0.209)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.171 (n=393)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.008 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0969` → IC=+0.146 (n=289)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.0969 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=826)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.4444` → IC=+0.171 (n=866)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.607` → IC=+0.177 (n=398)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.607 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8662` → IC=+0.160 (n=465)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8662 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.164` → IC=+0.150 (n=232)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.164 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1709` → IC=+0.174 (n=237)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1709 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.2529` → IC=+0.150 (n=713)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.2529 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.8202` → IC=+0.144 (n=540)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8202 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=902)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9305.5773` → IC=+0.187 (n=289)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 9305.5773 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.305` → IC=+0.125 (n=588)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.305 (IC base=+0.073)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.963` → IC=+0.133 (n=178)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 7.963 (IC base=+0.073)

- **PATRÓN** `volumen_pendiente_norm` > `0.1737` → IC=+0.165 (n=216)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1737 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.153 (n=327)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 22.0 (IC base=+0.073)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.278 (n=151)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.294 (n=226)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` > `0.3958` → IC=+0.285 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3958 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` > `0.1675` → IC=+0.290 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1675 (IC base=+0.259)
...
- **PATRÓN** `volumen_regimen` < `0.8258` → IC=+0.271 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8258 (IC base=+0.259)

- **PATRÓN** `volumen_regimen` > `1.1387` → IC=+0.333 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1387 (IC base=+0.259)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.372 (n=37)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3667` → IC=+0.289 (n=74)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3667 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `2.0245` → IC=+0.325 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0245 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.1322` → IC=+0.146 (n=77)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.1322 (IC base=+0.043)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.200 (n=2189)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0087 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=4862)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.298 (n=1653)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.761` → IC=+0.214 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.761 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.639` → IC=+0.224 (n=2685)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.639 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.159 (n=2226)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8827 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1676` → IC=+0.196 (n=1307)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1676 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `1.8741` → IC=+0.171 (n=3000)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8741 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.168 (n=4566)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.02 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3876.3881` → IC=+0.184 (n=1610)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 3876.3881 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.211 (n=2311)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 62.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.195 (n=4441)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0109 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.482` → IC=+0.195 (n=4440)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.482 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=2166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.240 (n=4444)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.4482` → IC=+0.171 (n=3155)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.4482 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.698` → IC=+0.215 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.698 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.703` → IC=+0.189 (n=4154)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` < 2.703 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` < `0.6224` → IC=+0.168 (n=1051)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6224 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` > `1.1954` → IC=+0.164 (n=1050)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.1954 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` > `0.2368` → IC=+0.243 (n=727)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2368 (IC base=+0.187)

- **PATRÓN** `volumen_spike_ratio` > `2.2992` → IC=+0.201 (n=1691)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2992 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.182 (n=3313)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 143.0 (IC base=+0.187)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.186 (n=269)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.327 (n=275)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2211` → IC=+0.266 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2211 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` < `1.5922` → IC=+0.187 (n=314)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.5922 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `1.8895` → IC=+0.176 (n=473)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.8895 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.232 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.238 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 79.0 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.279 (n=522)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.270)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.274 (n=591)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.270)

- **PATRÓN** `drift_60min` |x|≤ `0.1847` → IC=+0.298 (n=395)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1847 (IC base=+0.270)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.278 (n=539)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4058` → IC=+0.303 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4058 (IC base=+0.270)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.61` → IC=+0.285 (n=599)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.61 (IC base=+0.270)

- **PATRÓN** `volumen_pendiente_norm` > `0.2967` → IC=+0.316 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2967 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` > `1.5076` → IC=+0.286 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5076 (IC base=+0.270)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.275 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.270)

- **PATRÓN** `libro_liquidez` > `1477.6104` → IC=+0.281 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1477.6104 (IC base=+0.270)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.272 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 72.0 (IC base=+0.270)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.168 (n=699)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.006 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.0956` → IC=+0.167 (n=265)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0956 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.182 (n=712)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 8.0 (IC base=+0.159)

- **PATRÓN** `ibs_20min` > `0.3282` → IC=+0.206 (n=794)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1464` → IC=+0.191 (n=215)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1464 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `2.3909` → IC=+0.177 (n=745)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.3909 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.7246` → IC=+0.175 (n=496)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.7246 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `10774.9458` → IC=+0.183 (n=709)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 10774.9458 (IC base=+0.159)

- **PATRÓN** `ballena_activa_n` < `470.0` → IC=+0.176 (n=591)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 470.0 (IC base=+0.159)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.171 (n=719)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0062 (IC base=+0.164)

- **PATRÓN** `sigma_h` > `0.003` → IC=+0.167 (n=641)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.003 (IC base=+0.164)

- **PATRÓN** `drift_60min` |x|≤ `0.2721` → IC=+0.179 (n=631)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.2721 (IC base=+0.164)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.167 (n=746)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 18.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` < `0.6191` → IC=+0.203 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6191 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` < `0.1479` → IC=+0.180 (n=623)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1479 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.77` → IC=+0.215 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.77 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.6181` → IC=+0.227 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6181 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1411` → IC=+0.235 (n=187)
...
- **PATRÓN** `volumen_spike_ratio` < `1.3983` → IC=+0.194 (n=207)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.3983 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.0527` → IC=+0.194 (n=282)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.0527 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `291.0` → IC=+0.165 (n=174)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 291.0 (IC base=+0.164)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.220 (n=702)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `drift_60min` |x|≤ `0.4838` → IC=+0.240 (n=699)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `3.0432` → IC=+0.241 (n=507)
...
- **PATRÓN** `sigma_h` < `0.007` → IC=+0.159 (n=704)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.007 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.157 (n=724)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 8.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.7346` → IC=+0.240 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7346 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.3783` → IC=+0.188 (n=315)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.3783 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.047` → IC=+0.188 (n=139)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 12.047 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.8925` → IC=+0.166 (n=534)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8925 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.1991` → IC=+0.151 (n=267)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.1991 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.2741` → IC=+0.228 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2741 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `2.1443` → IC=+0.195 (n=345)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.1443 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.143 (n=875)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `9561.2883` → IC=+0.234 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9561.2883 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.152 (n=561)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0072 (IC base=+0.128)

- **PATRÓN** `drift_60min` |x|≤ `0.4454` → IC=+0.150 (n=636)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4454 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.148 (n=245)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6809` → IC=+0.175 (n=636)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6809 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.4106` → IC=+0.131 (n=643)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.4106 (IC base=+0.128)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.22` → IC=+0.131 (n=597)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 4.22 (IC base=+0.128)
...
- **PATRÓN** `libro_liquidez` > `9617.9713` → IC=+0.176 (n=288)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 9617.9713 (IC base=+0.128)

- **PATRÓN** `ballena_activa_n` < `193.0` → IC=+0.143 (n=491)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 193.0 (IC base=+0.128)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.146 (n=558)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0083 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.138 (n=565)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 12.0 (IC base=+0.095)

- **PATRÓN** `ibs_20min` > `0.4737` → IC=+0.179 (n=836)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4737 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `0.8845` → IC=+0.192 (n=209)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.8845 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.357` → IC=+0.220 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.357 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=581)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2968.0736` → IC=+0.247 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2968.0736 (IC base=+0.095)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.175 (n=266)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0059 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1302` → IC=+0.175 (n=266)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.1302 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.146 (n=388)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 15.0 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.131 (n=304)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 6.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` < `0.5909` → IC=+0.198 (n=797)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.5909 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.5134` → IC=+0.137 (n=773)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.5134 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.222` → IC=+0.136 (n=783)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 3.222 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.7141` → IC=+0.146 (n=351)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.7141 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.167 (n=268)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.5612` → IC=+0.141 (n=285)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.5612 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `2.1802` → IC=+0.139 (n=294)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.1802 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2665.5883` → IC=+0.159 (n=362)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2665.5883 (IC base=+0.117)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0279` → IC=+0.244 (n=303)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1719` → IC=+0.249 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1719 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.141` → IC=+0.249 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.141 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.2214` → IC=+0.231 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2214 (IC base=+0.200)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8201` → IC=+0.207 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8201 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=1031)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.200)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.277 (n=334)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.209)

- **PATRÓN** `sigma_h` > `0.0253` → IC=+0.229 (n=334)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0253 (IC base=+0.209)

- **PATRÓN** `drift_60min` |x|≤ `0.658` → IC=+0.209 (n=1002)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.658 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=950)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.209)
...
- **PATRÓN** `ibs_20min` < `0.4968` → IC=+0.262 (n=1002)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4968 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` < `0.2657` → IC=+0.217 (n=919)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2657 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.305` → IC=+0.282 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.305 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.7033` → IC=+0.225 (n=895)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7033 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2831` → IC=+0.308 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2831 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `1.4571` → IC=+0.201 (n=827)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4571 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.211 (n=1150)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.187 (n=730)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 35.0 (IC base=+0.209)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.129 (n=1777)

- **PATRÓN** `sigma_h` < `0.01` → IC=+0.136 (n=1377)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.01 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.4327` → IC=+0.134 (n=1377)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.4327 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.172 (n=535)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 18.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `0.9259` → IC=+0.191 (n=522)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.9259 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.472` → IC=+0.140 (n=248)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 10.472 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.783` → IC=+0.122 (n=1426)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 3.783 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.1749` → IC=+0.155 (n=424)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1749 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.4583` → IC=+0.141 (n=516)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4583 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.8939` → IC=+0.143 (n=1032)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8939 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `8943.6658` → IC=+0.137 (n=709)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 8943.6658 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.166 (n=453)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0039 (IC base=+0.126)

- **PATRÓN** `drift_60min` |x|≤ `0.5064` → IC=+0.147 (n=1345)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.5064 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.153 (n=500)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 17.0 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.146 (n=518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 5.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.2` → IC=+0.153 (n=592)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.2 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` > `1.0112` → IC=+0.131 (n=177)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 1.0112 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.341` → IC=+0.138 (n=1343)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 6.341 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `1.1015` → IC=+0.138 (n=1138)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.1015 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` < `0.1485` → IC=+0.128 (n=1345)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1485 (IC base=+0.126)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4885` → IC=+0.135 (n=1330)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.4885 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.7971` → IC=+0.133 (n=887)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.7971 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=1777)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `4285.247` → IC=+0.132 (n=1344)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 4285.247 (IC base=+0.126)
...
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.194 (n=122)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0064 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.183 (n=165)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0104 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.4334` → IC=+0.153 (n=321)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4334 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.189 (n=332)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 8.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.9677` → IC=+0.234 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9677 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.299` → IC=+0.220 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.299 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.0966` → IC=+0.167 (n=148)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0966 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `3.5716` → IC=+0.149 (n=363)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 3.5716 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `2.4093` → IC=+0.156 (n=242)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.4093 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `1761.2152` → IC=+0.150 (n=364)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 1761.2152 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.292 (n=22)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.278)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.340 (n=23)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.278)

- **PATRÓN** `ibs_20min` > `0.65` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.65 (IC base=+0.278)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.333 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 24.0 (IC base=+0.278)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.199 (n=247)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0058 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.183 (n=137)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 18.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.7788` → IC=+0.244 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7788 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.8683` → IC=+0.250 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8683 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.134` → IC=+0.245 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.134 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `0.8229` → IC=+0.154 (n=186)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8229 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.5821` → IC=+0.129 (n=278)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.5821 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2582` → IC=+0.316 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2582 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `2.2435` → IC=+0.172 (n=178)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.2435 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.4867` → IC=+0.183 (n=159)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.4867 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.167 (n=229)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.02 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `1225.5381` → IC=+0.172 (n=227)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1225.5381 (IC base=+0.097)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.221 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0056 (IC base=+0.105)

- **PATRÓN** `drift_60min` |x|≤ `0.0785` → IC=+0.182 (n=20)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.0785 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.145 (n=60)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 16.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.7788` → IC=+0.216 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7788 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.3562` → IC=+0.267 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3562 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.35` → IC=+0.250 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.35 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.1039` → IC=+0.155 (n=82)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1039 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` < `0.0635` → IC=+0.194 (n=47)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` < 0.0635 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.1451` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1451 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` < `2.0892` → IC=+0.212 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0892 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=91)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.207 (n=97)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.190 (n=56)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 17.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` > `0.6789` → IC=+0.298 (n=102)
...
- **PATRÓN** `dist_vwap_pct` < `0.1714` → IC=+0.180 (n=101)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1714 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.181` → IC=+0.300 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.181 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `0.789` → IC=+0.196 (n=77)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.789 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` > `0.5821` → IC=+0.172 (n=114)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.5821 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` < `0.1322` → IC=+0.208 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1322 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.2042` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2042 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.4015` → IC=+0.225 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4015 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=121)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `1205.3517` → IC=+0.223 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1205.3517 (IC base=+0.126)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.192 (n=50)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 18.0 (IC base=+0.044)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.158 (n=71)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.6744 (IC base=+0.044)

- **PATRÓN** `dist_vwap_pct` > `0.9526` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9526 (IC base=+0.044)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.817` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.817 (IC base=+0.044)

- **PATRÓN** `volumen_regimen` > `0.9949` → IC=+0.147 (n=32)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.9949 (IC base=+0.044)

- **PATRÓN** `volumen_pendiente_norm` > `0.0894` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0894 (IC base=+0.044)

- **PATRÓN** `volumen_spike_ratio` < `2.1854` → IC=+0.167 (n=55)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.1854 (IC base=+0.044)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.04 (IC base=+0.044)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `libro_liquidez` > `2782.0436` → IC=+0.191 (n=95)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2782.0436 (IC base=+0.100)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.122 (n=154)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.5 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `2352.3194` → IC=+0.127 (n=250)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 2352.3194 (IC base=+0.103)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=365)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.178 (n=1530)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=4616)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.185 (n=1558)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=4841)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.41` → IC=-0.224 (n=237)

  - _Acción_: SKIP cuando `py_entrada` < 0.41
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=722)

- **FILTRO** `ibs_20min` < `0.7368` → IC=-0.209 (n=239)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=720)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.167 (n=277)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=846)
...
- **FILTRO** `ballena_activa_n` > `60.0` → IC=-0.147 (n=250)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=756)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=35)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=971)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.195 (n=329)
...
- **FILTRO** `ibs_20min` > `0.7143` → IC=-0.196 (n=271)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=819)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.168 (n=257)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=773)

- **FILTRO** `py_entrada` > `0.56` → IC=-0.163 (n=250)
...
- **FILTRO** `py_entrada` > `0.61` → IC=-0.162 (n=264)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=808)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=945)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=515)
...
- **FILTRO** `ibs_20min` > `0.9939` → IC=-0.197 (n=31)

  - _Acción_: SKIP cuando `ibs_20min` > 0.9939
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.135 (n=3180)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=11773)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.282 (n=3654)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=11299)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.241 (n=3732)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=11221)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.170 (n=5065)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=9888)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=4625)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=14273)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=4709)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=14189)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=536)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1653)

- **FILTRO** `ibs_7min` < `0.7015` → IC=-0.254 (n=722)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7015
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1467)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.219 (n=539)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=1650)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.237 (n=817)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2468)

- **FILTRO** `drift_7min_pct` |x|> `0.1139` → IC=-0.130 (n=1114)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1139
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2171)

- **FILTRO** `ibs_7min` > `0.8364` → IC=-0.196 (n=820)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2465)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.133 (n=603)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=2169)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=672)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=2100)

- **FILTRO** `ibs_7min` < `0.7711` → IC=-0.195 (n=693)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7711
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2079)

- **FILTRO** `ballena_activa_n` > `168.0` → IC=-0.179 (n=689)

  - _Acción_: SKIP cuando `ballena_activa_n` > 168.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2083)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.241 (n=661)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2131)

- **FILTRO** `ballena_activa_n` > `108.0` → IC=-0.172 (n=948)

  - _Acción_: SKIP cuando `ballena_activa_n` > 108.0
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1844)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.187 (n=694)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1514)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.310 (n=699)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1509)

- **FILTRO** `ibs_7min` < `0.2167` → IC=-0.294 (n=552)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2167
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1656)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.238 (n=537)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=1671)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=798)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2608)

- **FILTRO** `ibs_7min` > `0.7964` → IC=-0.169 (n=851)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7964
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2555)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.140 (n=762)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=1766)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.263 (n=609)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=1919)

- **FILTRO** `ibs_7min` < `0.7533` → IC=-0.194 (n=632)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7533
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1896)

- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.177 (n=834)

  - _Acción_: SKIP cuando `ballena_activa_n` > 26.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1694)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.233 (n=842)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=1709)

- **FILTRO** `ibs_7min` > `0.2769` → IC=-0.178 (n=637)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2769
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=1914)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.186 (n=626)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1925)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.244 (n=673)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2123)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.205 (n=693)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2103)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.184 (n=685)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2111)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.176 (n=845)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2708)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.291 (n=600)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1860)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.236 (n=609)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1851)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.227 (n=599)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1861)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.210 (n=819)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2492)

- **FILTRO** `ibs_7min` > `0.7674` → IC=-0.162 (n=826)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7674
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2485)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=178)
...
- **PATRÓN** `streak_estiramiento` < `0.3587` → IC=+0.152 (n=67)

  - _Acción_: Kelly boost +0.76€ cuando `streak_estiramiento` < 0.3587 (IC base=+0.035)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=371)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=1625)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=909)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.163 (n=191)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0037 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.170 (n=192)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0073 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.1669` → IC=+0.138 (n=503)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.1669 (IC base=+0.135)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0597` → IC=+0.136 (n=572)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.68€ cuando `delta_ratio_macro` |x|> 0.0597 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.137 (n=615)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.5906` → IC=+0.220 (n=572)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5906 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.4411` → IC=+0.147 (n=131)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.4411 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.5711` → IC=+0.134 (n=608)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.5711 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.547` → IC=+0.229 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.547 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.142 (n=582)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `10043.6494` → IC=+0.184 (n=191)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 10043.6494 (IC base=+0.135)

### UPDOWN_GBM#5min
- **FILTRO** `sigma_ewma_delta_pct` > `7.846` → IC=-0.204 (n=42)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 7.846
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=998)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.331` → IC=+0.190 (n=27)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 20.331 (IC base=+0.005)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.260 (n=23)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1324` → IC=+0.141 (n=62)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1324 (IC base=+0.117)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1396` → IC=+0.146 (n=46)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.73€ cuando `delta_ratio_macro` |x|> 0.1396 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `20.0` → IC=+0.154 (n=24)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 20.0 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.204 (n=25)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.117)

- **PATRÓN** `ibs_15` > `0.6` → IC=+0.254 (n=63)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.1491` → IC=+0.139 (n=59)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.1491 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.576` → IC=+0.389 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.576 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=60)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `3083.8765` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3083.8765 (IC base=+0.117)

### UPDOWN_GBM#SOL#5min
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0181` → IC=-0.167 (n=49)
...
- **PATRÓN** `ibs_15` < `0.1171` → IC=+0.178 (n=178)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.89€ cuando `ibs_15` < 0.1171 (IC base=+0.033)
...
- **FILTRO** `sigma_h` > `0.0108` → IC=-0.207 (n=353)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0108
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1061)

- **FILTRO** `ibs_15` < `0.5789` → IC=-0.189 (n=162)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.5789
  - _Potencial_: sin este filtro IC_bueno=+0.228 (n=329)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=363)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.297` → IC=+0.172 (n=181)

  - _Acción_: Kelly boost +0.86€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.297 (IC base=-0.069)

- **PATRÓN** `ibs_15` > `0.5789` → IC=+0.228 (n=329)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5789 (IC base=-0.069)

- **PATRÓN** `dist_vwap_pct` < `0.1823` → IC=+0.130 (n=225)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.1823 (IC base=-0.069)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1248` → IC=+0.230 (n=331)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1248 (IC base=-0.062)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1083` → IC=+0.245 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1083 (IC base=-0.062)

- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.274 (n=498)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3696 (IC base=-0.062)

- **PATRÓN** `dist_vwap_pct` < `0.46` → IC=+0.224 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.46 (IC base=-0.062)

- **PATRÓN** `ballena_activa_n` < `128.0` → IC=+0.228 (n=461)
...
- **FILTRO** `sigma_h` > `0.0074` → IC=-0.232 (n=233)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=702)

- **FILTRO** `sigma_h` < `0.0038` → IC=-0.232 (n=308)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0038
  - _Potencial_: sin este filtro IC_bueno=-0.182 (n=627)

- **FILTRO** `sigma_ewma_delta_pct` > `19.454` → IC=-0.247 (n=168)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.454
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=767)
...
- **PATRÓN** `ibs_15` < `0.2941` → IC=+0.296 (n=214)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2941 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` > `0.1753` → IC=+0.224 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1753 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.4127` → IC=+0.212 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4127 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `18.292` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.292 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.609` → IC=+0.229 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.609 (IC base=+0.212)

- **PATRÓN** `ballena_activa_n` < `188.0` → IC=+0.214 (n=215)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.124` → IC=+0.176 (n=72)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.88€ cuando `delta_ratio_macro` |x|> 0.124 (IC base=-0.047)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.189` → IC=+0.200 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.189 (IC base=-0.047)
...
- **PATRÓN** `ibs_15` > `0.0741` → IC=+0.184 (n=96)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` > 0.0741 (IC base=-0.047)

- **PATRÓN** `dist_vwap_pct` < `0.5028` → IC=+0.196 (n=113)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.5028 (IC base=-0.047)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `libro_spread` > `0.02` → IC=-0.264 (n=53)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.166 (n=333)

- **FILTRO** `libro_liquidez` < `2501.2592` → IC=-0.229 (n=127)

  - _Acción_: SKIP cuando `libro_liquidez` < 2501.2592
  - _Potencial_: sin este filtro IC_bueno=-0.155 (n=259)
...
- **PATRÓN** `ibs_15` < `0.3448` → IC=+0.291 (n=127)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5906 sube el IC de +0.135 a +0.220 en UPDOWN_GBM#15min (n=572). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#SOL#15min**: dentro de BUY_YES, IBS > 0.6 sube el IC de +0.117 a +0.254 en UPDOWN_GBM#SOL#15min (n=63). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1171 sube el IC de +0