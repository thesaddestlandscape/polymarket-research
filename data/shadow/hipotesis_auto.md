# Hipótesis automáticas — 2026-09-21 03:17 UTC
_Generado por shadow_postmortem.py sobre 535578 resoluciones (PNL=+59417.75€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.253 (n=475)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.253 (n=475)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=543)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `2879.0602` → IC=+0.145 (n=339)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2879.0602 (IC base=+0.132)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.261 (n=374)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.261 (n=374)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.144 (n=290)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 12.0 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=458)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.1` → IC=-0.236 (n=6479)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.1
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19439)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.44` → IC=-0.242 (n=882)
...
- **FILTRO** `restante_s_al_confirmar` < `494.42` → IC=-0.152 (n=346)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1041)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `133.5` → IC=-0.277 (n=777)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.5
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=2332)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `160.57` → IC=-0.232 (n=1528)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.57
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4587)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.81` → IC=-0.364 (n=1284)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.81
  - _Potencial_: sin este filtro IC_bueno=-0.118 (n=3852)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.144 (n=2220)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 15.0 (IC base=+0.143)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.335 (n=862)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.142 (n=609)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=699)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `1296.9414` → IC=+0.148 (n=606)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.429 (n=587)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=9981)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2438)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2569)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.187 (n=2397)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 17.0 (IC base=+0.181)

- **PATRÓN** `py_entrada` < `0.73` → IC=+0.182 (n=2460)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.192 (n=2346)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 17.0 (IC base=+0.190)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.193 (n=1767)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.240 (n=11606)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.179 (n=5326)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 15.0 (IC base=+0.174)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5768)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.227 (n=5515)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.224)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.273 (n=1997)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=5704)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.222 (n=2108)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.221)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=1961)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.252 (n=2588)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.194 (n=5149)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1573.916` → IC=+0.295 (n=1030)
...
- **PATRÓN** `libro_liquidez` > `5005.426` → IC=+0.306 (n=153)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5005.426 (IC base=+0.273)
...
- **PATRÓN** `libro_liquidez` > `1466.4356` → IC=+0.313 (n=442)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3553` → IC=+0.126 (n=6365)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3553 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.9808` → IC=+0.241 (n=2411)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9808 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` < `0.5972` → IC=+0.245 (n=2017)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5972 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.929` → IC=+0.175 (n=2788)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.929 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` < `1.2124` → IC=+0.244 (n=1915)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2124 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` > `1.05` → IC=+0.246 (n=869)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.05 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.3083` → IC=+0.212 (n=710)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3083 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` > `1.9198` → IC=+0.204 (n=3260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9198 (IC base=+0.103)

- **PATRÓN** `ibs_20min` < `0.5709` → IC=+0.131 (n=8732)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5709 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5703` → IC=+0.200 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5703 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1426` → IC=+0.172 (n=2714)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1426 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7028` → IC=+0.176 (n=1312)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7028 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.173 (n=1989)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8706 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.1683` → IC=+0.225 (n=1443)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1683 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.585` → IC=+0.201 (n=4432)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.585 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.210 (n=4742)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.174 (n=551)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0081 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3418` → IC=+0.168 (n=1642)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3418 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=803)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 15.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.183 (n=622)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.069` → IC=+0.277 (n=711)
...
- **PATRÓN** `volumen_spike_ratio` > `1.44` → IC=+0.166 (n=1526)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.44 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.248 (n=1072)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.062` → IC=+0.297 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.062 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.381` → IC=+0.248 (n=1257)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.381 (IC base=+0.233)

- **PATRÓN** `volumen_pendiente_norm` > `0.2774` → IC=+0.269 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2774 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` > `2.6427` → IC=+0.255 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6427 (IC base=+0.233)

- **PATRÓN** `libro_liquidez` > `1773.4468` → IC=+0.244 (n=799)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1773.4468 (IC base=+0.233)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1138` → IC=+0.249 (n=547)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1138 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=1302)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.212)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1262)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` > `0.7274` → IC=+0.245 (n=828)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7274 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.5634` → IC=+0.217 (n=1304)
...
- **PATRÓN** `volumen_regimen` < `1.2554` → IC=+0.219 (n=1242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2554 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `0.8736` → IC=+0.213 (n=828)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8736 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` > `0.0749` → IC=+0.223 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0749 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` < `1.4033` → IC=+0.222 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4033 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.3839` → IC=+0.215 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3839 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `15816.3726` → IC=+0.224 (n=563)
...
- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.166 (n=1301)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6828 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.6769` → IC=+0.137 (n=221)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.6769 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.1254` → IC=+0.152 (n=1167)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1254 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.539` → IC=+0.156 (n=420)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 6.539 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.189` → IC=+0.136 (n=1175)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 4.189 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.2085` → IC=+0.146 (n=1301)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2085 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.8526` → IC=+0.138 (n=867)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.8526 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1571` → IC=+0.174 (n=348)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1571 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `2.4453` → IC=+0.146 (n=1192)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4453 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.7746` → IC=+0.147 (n=794)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7746 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.144 (n=1109)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 411.0 (IC base=+0.135)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.202 (n=1062)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.189 (n=1423)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.267 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.093` → IC=+0.244 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.093 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.1064` → IC=+0.191 (n=1366)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1064 (IC base=+0.185)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9269` → IC=+0.207 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9269 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.193 (n=1063)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.223 (n=1360)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0108 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.219 (n=1216)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3824` → IC=+0.231 (n=1197)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3824 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.55` → IC=+0.238 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.55 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.401` → IC=+0.218 (n=1485)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.401 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` > `0.3607` → IC=+0.275 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3607 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `1.8378` → IC=+0.208 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8378 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.2796` → IC=+0.226 (n=820)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2796 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.230 (n=852)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1861.0222` → IC=+0.230 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1861.0222 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.225 (n=801)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2010)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1672` → IC=+0.327 (n=229)
...
- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.339 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 164.0 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.1841` → IC=+0.166 (n=300)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1841 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.8558` → IC=+0.153 (n=482)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8558 (IC base=+0.009)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.175 (n=598)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=1988)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=988)

- **FILTRO** `sigma_ewma_delta_pct` > `8.642` → IC=-0.205 (n=323)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.642
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2653)
...
- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.124 (n=988)
...
- **PATRÓN** `volumen_regimen` < `1.096` → IC=+0.235 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.096 (IC base=-0.044)

- **PATRÓN** `volumen_pendiente_norm` < `0.1012` → IC=+0.232 (n=214)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4396` → IC=+0.267 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4396 (IC base=-0.044)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6412` → IC=-0.190 (n=505)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6412
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1519)

- **FILTRO** `ibs_20min` < `0.6949` → IC=-0.159 (n=1335)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=396)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1628)

- **FILTRO** `ibs_20min` > `0.7734` → IC=-0.201 (n=751)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7734
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2257)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2099` → IC=+0.256 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2099 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.4611` → IC=+0.248 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4611 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.191 (n=3004)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0094 (IC base=+0.095)

- **PATRÓN** `ibs_20min` > `0.4686` → IC=+0.186 (n=8047)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4686 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `1.0121` → IC=+0.290 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0121 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.556` → IC=+0.152 (n=4277)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.556 (IC base=+0.095)

- **PATRÓN** `volumen_regimen` < `1.1748` → IC=+0.231 (n=3155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1748 (IC base=+0.095)

- **PATRÓN** `volumen_regimen` > `0.682` → IC=+0.241 (n=2820)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.682 (IC base=+0.095)

- **PATRÓN** `volumen_pendiente_norm` > `0.2993` → IC=+0.259 (n=746)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2993 (IC base=+0.095)

- **PATRÓN** `volumen_spike_ratio` < `1.4763` → IC=+0.243 (n=1709)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4763 (IC base=+0.095)

- **PATRÓN** `volumen_spike_ratio` > `2.7163` → IC=+0.240 (n=1709)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7163 (IC base=+0.095)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.269 (n=4627)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.095)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.146 (n=3044)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0088 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5521` → IC=+0.149 (n=8024)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5521 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6789` → IC=+0.242 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6789 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1703` → IC=+0.236 (n=2362)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1703 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.238 (n=1149)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7176 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.2028` → IC=+0.241 (n=871)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4469` → IC=+0.183 (n=257)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.4469 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `2.5947` → IC=+0.198 (n=256)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.5947 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.188 (n=328)
...
- **FILTRO** `ibs_20min` > `0.817` → IC=-0.147 (n=658)

  - _Acción_: SKIP cuando `ibs_20min` > 0.817
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1975)

- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.153 (n=606)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.86 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.2936` → IC=+0.156 (n=321)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2936 (IC base=+0.020)

- **PATRÓN** `volumen_regimen` < `1.0445` → IC=+0.144 (n=722)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0445 (IC base=+0.020)

- **PATRÓN** `volumen_regimen` > `0.6606` → IC=+0.149 (n=733)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6606 (IC base=+0.020)

- **PATRÓN** `volumen_pendiente_norm` > `0.2755` → IC=+0.195 (n=103)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2755 (IC base=+0.020)

- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.195 (n=267)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.4239 (IC base=+0.020)

- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.190 (n=349)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 249.0 (IC base=+0.020)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.286 (n=953)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.257 (n=537)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.244)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=754)
...
- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.290 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3388 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.883` → IC=+0.303 (n=435)
...
- **FILTRO** `ibs_20min` < `0.7059` → IC=-0.204 (n=959)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.269 (n=960)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.232 (n=501)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1514)

- **FILTRO** `sigma_ewma_delta_pct` > `4.689` → IC=-0.176 (n=449)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.689
  - _Potencial_: sin este filtro IC_bueno=+0.066 (n=1566)

- **PATRÓN** `ibs_20min` > `0.7059` → IC=+0.269 (n=960)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.595` → IC=+0.153 (n=301)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 9.595 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` < `0.8622` → IC=+0.296 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8622 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` > `0.6364` → IC=+0.286 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6364 (IC base=+0.033)

- **PATRÓN** `volumen_pendiente_norm` < `0.105` → IC=+0.289 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.105 (IC base=+0.033)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7981` → IC=+0.304 (n=448)
...
- **PATRÓN** `dist_vwap_pct` < `0.2083` → IC=+0.220 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2083 (IC base=+0.012)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.267 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` < `0.1001` → IC=+0.208 (n=437)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2643` → IC=+0.204 (n=52)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2643 (IC base=+0.012)

- **PATRÓN** `volumen_spike_ratio` < `2.5144` → IC=+0.221 (n=446)
...
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.318 (n=784)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0161 (IC base=+0.274)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.290 (n=550)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.274)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.345 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.274)

- **PATRÓN** `dist_vwap_pct` > `0.1917` → IC=+0.314 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1917 (IC base=+0.274)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.270 (n=647)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.304 (n=1297)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.471` → IC=+0.291 (n=466)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5387` → IC=+0.266 (n=1132)
...
- **PATRÓN** `ibs_20min` > `0.5808` → IC=+0.217 (n=7096)
...
- **PATRÓN** `volumen_regimen` < `1.2156` → IC=+0.160 (n=4690)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2156 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6257` → IC=+0.157 (n=4691)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6257 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2468` → IC=+0.192 (n=1422)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2468 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5656` → IC=+0.171 (n=2983)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5656 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6498` → IC=+0.175 (n=2259)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6498 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2375.1588` → IC=+0.167 (n=4730)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2375.1588 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=6008)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.182 (n=4524)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0796` → IC=+0.202 (n=2260)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4763` → IC=+0.225 (n=6771)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4763 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2251` → IC=+0.158 (n=4954)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2251 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.239` → IC=+0.195 (n=1149)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.239 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1804` → IC=+0.152 (n=4938)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1804 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.223 (n=974)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5745` → IC=+0.166 (n=2686)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5745 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.2831` → IC=+0.173 (n=2768)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.2831 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.171 (n=5739)
...
- **PATRÓN** `ibs_20min` > `0.4138` → IC=+0.227 (n=1048)
...
- **PATRÓN** `volumen_regimen` < `0.686` → IC=+0.179 (n=462)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.686 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.2332` → IC=+0.194 (n=230)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2332 (IC base=+0.161)
...
- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.195 (n=385)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0025 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.2883` → IC=+0.154 (n=1153)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5531` → IC=+0.183 (n=1153)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5531 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1307` → IC=+0.160 (n=1158)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1307 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.856` → IC=+0.210 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.856 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2116` → IC=+0.154 (n=1153)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2116 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1575` → IC=+0.158 (n=355)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.1575 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.4481` → IC=+0.144 (n=1043)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.4481 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.763` → IC=+0.136 (n=695)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2079` → IC=+0.215 (n=790)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2079 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.223 (n=406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.294 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.786` → IC=+0.276 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.786 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` < `0.2133` → IC=+0.195 (n=1143)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=786)
...
- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.236 (n=978)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3529` → IC=+0.253 (n=978)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3529 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.729` → IC=+0.273 (n=404)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6425` → IC=+0.225 (n=300)
...
- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.227 (n=306)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.159 (n=1188)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0072 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.3811` → IC=+0.142 (n=1188)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6149` → IC=+0.170 (n=1188)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6149 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.344` → IC=+0.136 (n=1278)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.344 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.91` → IC=+0.175 (n=420)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 6.91 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `0.8548` → IC=+0.144 (n=792)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8548 (IC base=+0.122)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4874` → IC=+0.141 (n=357)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.4874 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `9988.1936` → IC=+0.160 (n=539)
...
- **FILTRO** `ibs_20min` > `0.5652` → IC=-0.182 (n=435)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.207 (n=1310)
...
- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.202 (n=1290)
...
- **PATRÓN** `volumen_regimen` < `1.2243` → IC=+0.127 (n=1291)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1344)
...
- **PATRÓN** `drift_60min` |x|≤ `0.103` → IC=+0.138 (n=437)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.103 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.207 (n=1310)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.9592` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.9592 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.1948` → IC=+0.135 (n=1197)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1948 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.438` → IC=+0.156 (n=274)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.438 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `1.0447` → IC=+0.122 (n=1152)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.0447 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.276` → IC=+0.167 (n=160)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.276 (IC base=+0.110)
...
- **PATRÓN** `volumen_spike_ratio` > `2.173` → IC=+0.124 (n=528)
...
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.208 (n=818)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.1696` → IC=+0.197 (n=540)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.255 (n=1097)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.415` → IC=+0.241 (n=586)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.415 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` < `1.209` → IC=+0.199 (n=1228)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1696` → IC=+0.207 (n=1042)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.198 (n=1284)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `2587.1988` → IC=+0.196 (n=818)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.213 (n=590)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` < `0.4426` → IC=+0.246 (n=1289)
...
- **PATRÓN** `volumen_regimen` > `0.6302` → IC=+0.216 (n=1289)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2447` → IC=+0.196 (n=1012)
...
- **PATRÓN** `libro_liquidez` > `2561.1058` → IC=+0.210 (n=859)
...
- **PATRÓN** `ibs_20min` < `0.6556` → IC=+0.132 (n=1753)
...
- **PATRÓN** `libro_liquidez` > `14590.6209` → IC=+0.144 (n=273)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 14590.6209 (IC base=+0.106)
...
- **PATRÓN** `ibs_20min` < `0.0725` → IC=+0.171 (n=150)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.0725 (IC base=+0.073)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.199 (n=3015)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=9035)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.9012` → IC=+0.197 (n=1238)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.9012 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.606` → IC=+0.226 (n=4402)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.606 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8814` → IC=+0.164 (n=4028)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8814 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2407` → IC=+0.195 (n=1683)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2407 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6244` → IC=+0.187 (n=2886)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6244 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2325.81` → IC=+0.169 (n=6019)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2325.81 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6743)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.191 (n=5471)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0069 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1443` → IC=+0.185 (n=3609)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `1.8754` → IC=+0.187 (n=4970)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.8754 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.188 (n=4753)
...
- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.210 (n=1028)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.191)

- **PATRÓN** `drift_60min` |x|≤ `0.3435` → IC=+0.192 (n=1538)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.3435 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.195 (n=749)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.191)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.203 (n=1033)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2273` → IC=+0.245 (n=280)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2273 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.5801` → IC=+0.209 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5801 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=856)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.256 (n=1065)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.256)

- **PATRÓN** `ibs_20min` < `0.3485` → IC=+0.290 (n=1030)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3485 (IC base=+0.256)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.422` → IC=+0.265 (n=1237)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.422 (IC base=+0.256)

- **PATRÓN** `volumen_pendiente_norm` > `0.2238` → IC=+0.299 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2238 (IC base=+0.256)

- **PATRÓN** `volumen_spike_ratio` > `1.8751` → IC=+0.277 (n=710)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8751 (IC base=+0.256)

- **PATRÓN** `libro_liquidez` > `1773.4468` → IC=+0.270 (n=780)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1773.4468 (IC base=+0.256)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0832` → IC=+0.167 (n=482)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0832 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=1502)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3107` → IC=+0.201 (n=1441)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.271` → IC=+0.151 (n=1292)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.271 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6272` → IC=+0.181 (n=481)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6272 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.2706` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2706 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.1195` → IC=+0.158 (n=1220)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1195 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4084` → IC=+0.153 (n=1386)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4084 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `13650.9513` → IC=+0.151 (n=961)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13650.9513 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `481.0` → IC=+0.154 (n=1318)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3178` → IC=+0.157 (n=1255)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6443` → IC=+0.191 (n=1255)
...
- **PATRÓN** `dist_vwap_pct` < `0.1283` → IC=+0.163 (n=1141)
...
- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.159 (n=1255)
...
- **PATRÓN** `ballena_activa_n` < `428.0` → IC=+0.153 (n=932)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1472)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.6721` → IC=+0.256 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6721 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.749` → IC=+0.291 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.749 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.2164` → IC=+0.222 (n=1422)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2164 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.9133` → IC=+0.247 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9133 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=964)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1931.801` → IC=+0.222 (n=484)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1931.801 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.242 (n=1351)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0108 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.241 (n=1206)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0065 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1571` → IC=+0.240 (n=595)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1571 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.267 (n=517)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.3653` → IC=+0.269 (n=1189)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3653 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.751` → IC=+0.279 (n=482)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2335` → IC=+0.236 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2335 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.252 (n=848)
...
- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.244 (n=774)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4353` → IC=+0.143 (n=1541)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_regimen` < `0.8772` → IC=+0.159 (n=1028)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.154 (n=1254)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0076 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.4405` → IC=+0.151 (n=1253)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4405 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.136 (n=569)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` < `0.6915` → IC=+0.185 (n=1253)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.6915 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.3631` → IC=+0.139 (n=1252)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.3631 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.113` → IC=+0.186 (n=189)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 11.113 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `0.6971` → IC=+0.143 (n=552)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.6971 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` > `1.1852` → IC=+0.138 (n=418)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 1.1852 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.2828` → IC=+0.253 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2828 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.149 (n=1182)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `10998.3764` → IC=+0.207 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10998.3764 (IC base=+0.133)

- **PATRÓN** `ballena_activa_n` < `183.0` → IC=+0.138 (n=1176)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 183.0 (IC base=+0.133)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.133 (n=1022)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4695` → IC=+0.186 (n=1531)
...
- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.204 (n=1503)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2141` → IC=+0.127 (n=1217)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.2141 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.124 (n=1452)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.153 (n=661)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.72 (IC base=+0.110)
...
- **PATRÓN** `libro_liquidez` > `2839.872` → IC=+0.158 (n=501)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2839.872 (IC base=+0.110)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.214 (n=1019)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1758)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.257 (n=1667)
...
- **PATRÓN** `dist_vwap_pct` < `0.8436` → IC=+0.204 (n=1861)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.201 (n=1485)
...
- **PATRÓN** `libro_liquidez` > `2568.8412` → IC=+0.202 (n=1111)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.134 (n=2806)

- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.158 (n=2386)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0093 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5227` → IC=+0.161 (n=2710)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.4583` → IC=+0.156 (n=893)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4583 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8927` → IC=+0.162 (n=1787)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8927 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=1795)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `2754.6935` → IC=+0.154 (n=2421)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2754.6935 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.193 (n=708)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0037 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.4793` → IC=+0.153 (n=2116)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4793 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.169 (n=781)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.132)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.158 (n=720)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 4.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` < `0.1778` → IC=+0.161 (n=931)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.1778 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.6865` → IC=+0.143 (n=399)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.6865 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.2426` → IC=+0.126 (n=1892)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.2426 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.238` → IC=+0.140 (n=2101)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.238 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.9017` → IC=+0.148 (n=1344)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8153` → IC=+0.140 (n=1396)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8153 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2806)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7387.0455` → IC=+0.146 (n=1891)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 7387.0455 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 1.0 (IC base=+0.058)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.32` → IC=+0.144 (n=85)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 2.32 (IC base=+0.058)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.058)

- **PATRÓN** `ibs_20min` < `0.2245` → IC=+0.162 (n=69)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.2245 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.8151` → IC=+0.160 (n=51)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.8151 (IC base=+0.052)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.125 (n=596)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` > 0.5 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `2846.2392` → IC=+0.173 (n=203)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2846.2392 (IC base=+0.108)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7230)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3048)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9559)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3182)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9876)
...
- **PATRÓN** `py_entrada` > `0.495` → IC=+0.122 (n=1455)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.495 (IC base=+0.024)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.203 (n=547)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=1658)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=577)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1745)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.165 (n=568)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1754)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.475` → IC=-0.189 (n=532)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1612)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.177 (n=581)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=1744)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2611)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2751)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2757)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8979)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=20154)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.277 (n=7016)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=22117)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.236 (n=7281)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21852)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9841)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19292)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9100)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=27399)

- **FILTRO** `ibs_7min` > `0.2947` → IC=-0.179 (n=9122)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2947
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=27377)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=1136)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3633)

- **FILTRO** `ibs_7min` < `0.7093` → IC=-0.254 (n=1573)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7093
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3196)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.180 (n=1144)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3625)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.152 (n=4235)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=2062)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.126 (n=2138)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4159)

- **FILTRO** `ibs_7min` > `0.7929` → IC=-0.206 (n=1574)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7929
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4723)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1184)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1220)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3838)

- **FILTRO** `ibs_7min` < `0.752` → IC=-0.188 (n=1264)

  - _Acción_: SKIP cuando `ibs_7min` < 0.752
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3794)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1261)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3797)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1262)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3859)

- **FILTRO** `ibs_7min` > `0.2588` → IC=-0.172 (n=1280)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2588
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3841)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1277)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3844)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.172 (n=1109)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3399)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.310 (n=1093)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3415)

- **FILTRO** `ibs_7min` < `0.1972` → IC=-0.258 (n=1127)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1972
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3381)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1090)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3418)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1561)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=5128)

- **FILTRO** `ibs_7min` > `0.7596` → IC=-0.177 (n=1672)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7596
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=5017)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1533)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3254)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.245 (n=1172)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3615)

- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.182 (n=1196)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3591)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.178 (n=1196)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3591)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1226)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3693)

- **FILTRO** `ibs_7min` > `0.2755` → IC=-0.172 (n=1228)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2755
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3691)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.191 (n=1197)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3722)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.265 (n=1201)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3935)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.229 (n=1282)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3854)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1677)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5244)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=1133)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3742)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.231 (n=1218)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3657)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1171)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3704)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1621)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4931)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=654)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2662)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.217 (n=627)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1305` → IC=+0.230 (n=468)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.187 (n=1389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 16.0 (IC base=+0.185)

- **PATRÓN** `ibs_15` > `0.6129` → IC=+0.260 (n=1383)
...
- **PATRÓN** `dist_vwap_pct` > `0.4456` → IC=+0.186 (n=326)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4456 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.5648` → IC=+0.174 (n=1362)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5648 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.106` → IC=+0.271 (n=364)
...
- **PATRÓN** `sigma_h` > `0.0235` → IC=+0.242 (n=126)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0235 (IC base=+0.178)

- **PATRÓN** `drift_60min` |x|≤ `0.085` → IC=+0.191 (n=166)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.085 (IC base=+0.178)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0401` → IC=+0.188 (n=376)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.0401 (IC base=+0.178)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.234 (n=126)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.178)

- **PATRÓN** `ibs_15` > `0.5429` → IC=+0.273 (n=376)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5429 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` > `0.1268` → IC=+0.194 (n=227)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1268 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` < `0.6263` → IC=+0.182 (n=438)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.489` → IC=+0.178 (n=337)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` < 7.489 (IC base=+0.178)

- **PATRÓN** `libro_liquidez` > `2843.9766` → IC=+0.258 (n=126)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.212 (n=598)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1797)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.118` → IC=+0.240 (n=969)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.118 (IC base=-0.039)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1785` → IC=+0.240 (n=934)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1785 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.356` → IC=+0.281 (n=1454)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.219 (n=361)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0069
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=1085)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.227 (n=477)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.185 (n=969)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.207 (n=914)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.183 (n=532)

- **FILTRO** `sigma_ewma_delta_pct` > `19.79` → IC=-0.247 (n=255)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.79
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1191)
...
- **PATRÓN** `drift_15min` |x|≤ `0.774` → IC=+0.233 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.774 (IC base=+0.226)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.241 (n=292)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.226)

- **PATRÓN** `ibs_15` < `0.273` → IC=+0.279 (n=519)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.273 (IC base=+0.226)

- **PATRÓN** `dist_vwap_pct` > `0.727` → IC=+0.279 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.727 (IC base=+0.226)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.262` → IC=+0.230 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.262 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `3504.653` → IC=+0.229 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3504.653 (IC base=+0.226)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.012` → IC=-0.133 (n=300)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2409)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1531` → IC=+0.274 (n=135)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1531 (IC base=-0.044)
...
- **PATRÓN** `ibs_15` < `0.35` → IC=+0.313 (n=404)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6129 sube el IC de +0.185 a +0.260 en UPDOWN_GBM#15min (n=1383). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5429 sube el IC de +0.178 a +0.273 en UPDOWN_GBM#XRP#15min (n=376). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.356 sube el IC de -0.039 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1454). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.273 sube el IC de +0.226 a +0.279 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=519). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.044 a +0.313 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=404). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1236 | +0.090 | +155.69€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1236 | +0.090 | +155.69€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 908 | +0.100 | +132.34€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 908 | +0.100 | +132.34€ | 2 | 8 |
...
| ✅ BALLENAS_TARDIAS | 23183 | -0.092 | -3073.26€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1387 | -0.045 | -209.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21796 | -0.095 | -2863.36€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3531 | -0.088 | -574.82€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3531 | -0.088 | -574.82€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1387 | -0.045 | -209.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1387 | -0.045 | -209.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6640 | -0.032 | -599.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6640 | -0.032 | -599.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6115 | -0.095 | -439.20€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6115 | -0.095 | -439.20€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5136 | -0.179 | -1089.22€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5136 | -0.179 | -1089.22€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15548 | -0.033 | +4119.16€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4095 | -0.002 | +1821.97€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11453 | -0.044 | +2297.19€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15548 | -0.033 | +4119.16€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4095 | -0.002 | +1821.97€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11453 | -0.044 | +2297.19€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1382 | -0.101 | -181.40€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 153 | -0.042 | -15.28€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1229 | -0.108 | -166.11€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 421 | -0.129 | -73.73€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 397 | -0.132 | -68.50€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 84732 | +0.113 | -4296.72€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13004 | +0.184 | -425.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 334 | -0.104 | -47.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 65754 | +0.100 | -3639.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5640 | +0.110 | -183.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 10944 | +0.097 | -971.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 43 | -0.167 | -2.82€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 