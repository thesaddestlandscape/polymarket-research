# Hipótesis automáticas — 2026-07-01 20:18 UTC
_Generado por shadow_postmortem.py sobre 2461 resoluciones (PNL=-88.26€)_
...
- **FILTRO** `ibs_15` > `0.2807` → IC=-0.140 (n=23)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.2807
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=46)

- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.266 (n=45)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0089 (IC base=+0.080)

- **PATRÓN** `ibs_15` < `0.0393` → IC=+0.250 (n=18)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0393 (IC base=+0.080)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0393 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.250 n=18). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 713 | -0.038 | -37.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 501 | -0.015 | -12.29€ | 2 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 220 | -0.032 | -22.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 153 | -0.010 | -13.66€ | 2 | 1 |
...
| ✅ UPDOWN_GBM#ETH | 294 | -0.013 | +0.89€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#SOL | 120 | -0.082 | -8.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 69 | -0.063 | -4.74€ | 4 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 23 | -0.060 | -3.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 22 | -0.125 | -1.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 54 | -0.018 | -0.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 43 | +0.033 | +2.90€ | 1 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.099) — sin ventaja clara. oversold(IBS<0.3): IC=+0.005 n=93 | neutral: IC=-0.094 n=94 | overbought(IBS>0.7): IC=-0.023 n=128
  - _Datos_: n=323 IC=-0.035 PNL=-11.90€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.112 n=17 PNL=-5.44€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=69 IC=-0.063 PNL=-4.74€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=-0.000 n=1157 | tras_1loss IC=-0.035 n=1216 | tras_2loss IC=-0.051 n=632/40 | gap=+0.050 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=590 IC=-0.032 PNL=-23.58€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=590 IC=-0.032 PNL=-23.58€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.010 < 0.02 con n=153 PNL=-13.66€
  - _Datos_: n=153 IC=-0.010 PNL=-13.66€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=216 IC=+0.018 PNL=-3.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=216 IC=+0.018 PNL=-3.97€

**⏳ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: 30
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: 14/30 ops en el filtro definido (IC actual=-0.087 PNL=-0.54€)
  - _Datos_: n=14 IC=-0.087 PNL=-0.54€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=118 IC=+0.042 PNL=+15.57€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=118 IC=+0.042 PNL=+15.57€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 44/200 ops en el filtro definido (IC actual=+0.065 PNL=+4.67€)
  - _Datos_: n=44 IC=+0.065 PNL=+4.67€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 44/100 ops en el filtro definido (IC actual=+0.065 PNL=+4.67€)
  - _Datos_: n=44 IC=+0.065 PNL=+4.67€
