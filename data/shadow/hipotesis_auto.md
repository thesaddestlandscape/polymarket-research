# Hipótesis automáticas — 2026-06-29 17:44 UTC
_Generado por shadow_postmortem.py sobre 1296 resoluciones (PNL=-36.53€)_
...
| ✅ UPDOWN_GBM | 327 | +0.011 | +4.91€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 188 | +0.058 | +10.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 58 | +0.100 | +9.29€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 101 | +0.015 | -1.06€ | 0 | 0 |
...
**⏳ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: 38/40 ops con ibs_15. oversold(IBS<0.3): IC=+0.021 n=11 | neutral: IC=+0.083 n=10 | overbought(IBS>0.7): IC=+0.066 n=15
  - _Datos_: n=38 IC=+0.100 PNL=+3.78€

**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: 38 ops, 7 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.051 n=87/40 PNL=+0.29€ | H=15h UTC: IC=-0.011 n=92/40 PNL=-5.07€ | H=17h UTC: IC=+0.265 n=32/40 PNL=+12.01€ | H=19h UTC: IC=-0.029 n=32/40 PNL=-0.97€

**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40 en cualquier subtipo 60min
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=25/40 IC=+0.130 PNL=+5.43€ | BTC#60min: n=20/40 IC=+0.136 PNL=+3.10€ | SOL#60min: n=13/40 IC=-0.022 PNL=+0.76€
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 327/200. Esperar 3+ subtypes con n≥200.
...
**⏳ H-CUSTOM-GBM-17H-BTC** — GBM BTC a las 17h UTC — ¿edge real?
  ...
  - _Estado_: 3/15 ops en el filtro definido (IC actual=+0.045 PNL=+1.48€)
  - _Datos_: n=3 IC=+0.045 PNL=+1.48€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=228 IC=+0.035 PNL=+10.54€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=228 IC=+0.035 PNL=+10.54€
...
**🟡 H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.100 > 0.08 con n=43 PNL=+8.32€
  - _Datos_: n=43 IC=+0.100 PNL=+8.32€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=139 IC=+0.039 PNL=-0.10€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=139 IC=+0.039 PNL=-0.10€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.147 > 0.08 con n=66 PNL=+10.33€
  - _Datos_: n=66 IC=+0.147 PNL=+10.33€
