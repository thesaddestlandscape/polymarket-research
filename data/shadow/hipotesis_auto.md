# Hipótesis automáticas — 2026-07-26 01:05 UTC
_Generado por shadow_postmortem.py sobre 35753 resoluciones (PNL=+7591.48€)_
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.200 (n=1114)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.196 (n=846)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=2747)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.226 (n=188)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6174` → IC=+0.183 (n=569)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.92€ cuando `ibs_15` > 0.6174 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.1759` → IC=+0.180 (n=195)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1759 (IC base=+0.059)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.199` → IC=+0.159 (n=177)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 7.199 (IC base=+0.059)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2217` → IC=+0.140 (n=290)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.2217 (IC base=+0.102)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0855` → IC=+0.128 (n=259)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.64€ cuando `delta_ratio_macro` |x|> 0.0855 (IC base=+0.102)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.163 (n=87)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 8.0 (IC base=+0.102)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `14.681` → IC=+0.161 (n=125)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 14.681 (IC base=+0.102)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1851` → IC=+0.126 (n=145)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.63€ cuando `delta_ratio_macro` |x|> 0.1851 (IC base=+0.049)

- **PATRÓN** `ibs_15` > `0.6814` → IC=+0.186 (n=186)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.93€ cuando `ibs_15` > 0.6814 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` < `0.6603` → IC=+0.131 (n=174)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.6603 (IC base=+0.049)

- **PATRÓN** `sigma_ewma_delta_pct` > `22.389` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 22.389 (IC base=+0.049)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6174 sube el IC de +0.059 a +0.183 en UPDOWN_GBM#15min (n=569). Ya aplicado como kelly_boost=+0.92€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7301 sube el IC de +0.102 a +0.248 en UPDOWN_GBM#BTC#15min (n=224). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6814 sube el IC de +0.049 a +0.186 en UPDOWN_GBM#ETH#15min (n=186). Ya aplicado como kelly_boost=+0.93€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ FAVORITO_CONFIRMADO | 6382 | +0.181 | +13.11€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4201 | +0.207 | +14.06€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1874 | +0.188 | +15.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1398 | +0.202 | -33.57€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 2246 | +0.170 | -32.30€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 2218 | +0.187 | +22.60€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 7867 | +0.095 | +2412.13€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 7867 | +0.095 | +2412.13€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1904 | +0.070 | +333.04€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1904 | +0.070 | +333.04€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5082 | +0.119 | +2452.65€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5082 | +0.119 | +2452.65€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1327 | +0.085 | +475.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1327 | +0.085 | +475.00€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1326 | +0.087 | +463.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1326 | +0.087 | +463.15€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_TARDIO | 5083 | +0.072 | +1411.48€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5083 | +0.072 | +1411.48€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1220 | +0.038 | +157.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1220 | +0.038 | +157.34€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1233 | +0.026 | +96.67€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1233 | +0.026 | +96.67€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 2620 | +0.037 | +249.53€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2357 | +0.055 | +288.05€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 560 | +0.053 | +65.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 476 | +0.088 | +79.99€ | 1 | 9 |
...
| ✅ UPDOWN_GBM#ETH | 1037 | +0.041 | +79.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 943 | +0.056 | +90.97€ | 0 | 6 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1790 | +0.157 | +812.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1790 | +0.157 | +812.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 171 | +0.199 | +101.70€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 171 | +0.199 | +101.70€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 191 | +0.117 | +33.68€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 191 | +0.117 | +33.68€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 157 | +0.217 | +109.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 157 | +0.217 | +109.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 351 | +0.177 | +150.56€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 351 | +0.177 | +150.56€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.176: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.076 n=1403 | neutral: IC=+0.017 n=1115 | overbought(IBS>0.7): IC=+0.192 n=1421
  - _Datos_: n=4201 IC=+0.106 PNL=+1119.53€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.113 n=21351 | tras_1loss IC=+0.081 n=14195 | tras_2loss IC=+0.053 n=5909/40 | gap=+0.060 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.058 n=163/60 | contraria IC=+0.110 n=57 | gap=-0.053 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2484 IC=+0.042 PNL=+265.25€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2484 IC=+0.042 PNL=+265.25€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1024 IC=+0.059 PNL=+148.78€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1024 IC=+0.059 PNL=+148.78€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=476 IC=+0.088 PNL=+79.99€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=476 IC=+0.088 PNL=+79.99€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.092 > 0.08 con n=1252 PNL=+221.64€
  - _Datos_: n=1252 IC=+0.092 PNL=+221.64€
...
**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.099 > 0.08 con n=320 PNL=+62.24€
  - _Datos_: n=320 IC=+0.099 PNL=+62.24€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=154 IC=+0.064 PNL=+60.28€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=154 IC=+0.064 PNL=+60.28€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1174 IC=+0.032 PNL=+118.23€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1174 IC=+0.032 PNL=+118.23€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.1 con n=867 PNL=+318.11€
  - _Datos_: n=867 IC=+0.169 PNL=+318.11€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.137 > 0.08 con n=620 PNL=+195.03€
  - _Datos_: n=620 IC=+0.137 PNL=+195.03€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.183 > 0.08 con n=266 PNL=+101.14€
  - _Datos_: n=266 IC=+0.183 PNL=+101.14€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.272 > 0.08 con n=472 PNL=-0.22€
  - _Datos_: n=472 IC=+0.272 PNL=-0.22€
