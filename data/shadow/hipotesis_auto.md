# Hipótesis automáticas — 2026-07-02 01:46 UTC
_Generado por shadow_postmortem.py sobre 2515 resoluciones (PNL=-86.61€)_
...
- **FILTRO** `ibs_15` > `0.4968` → IC=-0.224 (n=27)
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.258 (n=60)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.075)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.075)

- **PATRÓN** `ibs_15` < `0.4968` → IC=+0.132 (n=85)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.4968 (IC base=+0.075)
...
| ✅ UPDOWN_GBM | 763 | -0.033 | -35.45€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 544 | -0.009 | -10.04€ | 2 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.083) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.053 n=112 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=373 IC=-0.025 PNL=-10.22€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.208 n=22 PNL=-13.81€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1188 | tras_1loss IC=-0.036 n=1245 | tras_2loss IC=-0.050 n=647/40 | gap=+0.053 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=640 IC=-0.026 PNL=-21.90€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=640 IC=-0.026 PNL=-21.90€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=232 IC=+0.004 PNL=-15.98€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=232 IC=+0.004 PNL=-15.98€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=161 IC=+0.046 PNL=+17.82€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=161 IC=+0.046 PNL=+17.82€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 98/200 ops en el filtro definido (IC actual=+0.050 PNL=+6.31€)
  - _Datos_: n=98 IC=+0.050 PNL=+6.31€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 98/100 ops en el filtro definido (IC actual=+0.050 PNL=+6.31€)
  - _Datos_: n=98 IC=+0.050 PNL=+6.31€
