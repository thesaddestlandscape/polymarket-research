# Hipótesis automáticas — 2026-09-15 18:14 UTC
_Generado por shadow_postmortem.py sobre 455083 resoluciones (PNL=+48981.05€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.251 (n=427)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.251 (n=427)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8038` → IC=+0.258 (n=316)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8038 (IC base=+0.121)

- **PATRÓN** `banda_z` > `10.362` → IC=+0.219 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 10.362 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.136 (n=328)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 11.0 (IC base=+0.121)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.137 (n=502)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.01 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `2775.3304` → IC=+0.128 (n=315)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 2775.3304 (IC base=+0.121)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.148 (n=140)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 97.0 (IC base=+0.121)
...
- **FILTRO** `py_entrada` < `0.465` → IC=-0.130 (n=160)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.253 (n=330)
...
- **PATRÓN** `py_entrada` > `0.465` → IC=+0.253 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.465 (IC base=+0.128)
...
- **PATRÓN** `banda_hit_calibrado` > `0.7998` → IC=+0.273 (n=245)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.7998 (IC base=+0.128)

- **PATRÓN** `banda_z` > `11.438` → IC=+0.252 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.438 (IC base=+0.128)

- **PATRÓN** `ballenas_wallet_edge_medio` > `2.978` → IC=+0.133 (n=118)

  - _Acción_: Kelly boost +0.67€ cuando `ballenas_wallet_edge_medio` > 2.978 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.149 (n=263)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 11.0 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=417)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.96` → IC=-0.255 (n=5668)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.96
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=17011)
...
- **FILTRO** `restante_s_al_confirmar` < `484.43` → IC=-0.165 (n=305)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 484.43
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=917)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `135.58` → IC=-0.283 (n=704)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 135.58
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2113)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `141.36` → IC=-0.155 (n=1461)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.36
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=4384)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.37` → IC=-0.253 (n=1338)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.37
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=4017)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.97` → IC=-0.330 (n=1419)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.97
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=2881)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.236 (n=218)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.163 (n=96)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=330)

### CANDIDATA9_BOT_CONSENSO#BTC#5min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.278 (n=61)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=183)

- **FILTRO** `py_entrada` > `0.54` → IC=-0.138 (n=45)

  - _Acción_: SKIP cuando `py_entrada` > 0.54
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=177)

### CANDIDATA9_BOT_CONSENSO#ETH#5min
- **FILTRO** `py_entrada` < `0.5` → IC=-0.263 (n=78)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.245 (n=7814)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.172 (n=5671)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7167.6246` → IC=+0.177 (n=1792)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7167.6246 (IC base=+0.136)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.207 (n=1290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.349 (n=608)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1664)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `10989.8106` → IC=+0.203 (n=860)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10989.8106 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1228)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1236)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1730)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `12949.669` → IC=+0.213 (n=608)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12949.669 (IC base=+0.202)
...
- **PATRÓN** `py_entrada` < `0.425` → IC=+0.166 (n=561)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=2311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.137 (n=1970)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 15.0 (IC base=+0.136)

- **PATRÓN** `py_entrada` > `0.7` → IC=+0.327 (n=751)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.7 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.254 (n=534)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.183 (n=961)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.182 (n=1108)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.142 (n=677)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.125)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.228 (n=252)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=8992)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.220 (n=3197)
...
- **PATRÓN** `libro_liquidez` > `5339.6996` → IC=+0.343 (n=246)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2234)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.339 (n=166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.348 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.293)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.182 (n=2219)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.200 (n=2147)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.194 (n=1542)
...
- **PATRÓN** `lag_apertura_s` < `4.17` → IC=+0.149 (n=1830)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 4.17 (IC base=+0.130)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.198 (n=2012)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.38 (IC base=+0.119)

- **PATRÓN** `restante_min` < `4.48` → IC=+0.125 (n=2467)

  - _Acción_: Kelly boost +0.62€ cuando `restante_min` < 4.48 (IC base=+0.119)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.146 (n=1883)
...
- **PATRÓN** `lag_apertura_s` < `4.39` → IC=+0.145 (n=2453)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9778` → IC=+0.231 (n=2011)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9778 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.6097` → IC=+0.245 (n=1621)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6097 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.856` → IC=+0.167 (n=2331)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.856 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `0.6115` → IC=+0.254 (n=506)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6115 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.0681` → IC=+0.248 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0681 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.1755` → IC=+0.193 (n=4092)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1755 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.3097` → IC=+0.204 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3097 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.472` → IC=+0.196 (n=3945)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.472 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.569` → IC=+0.130 (n=7417)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.569 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5758` → IC=+0.180 (n=448)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.5758 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3472` → IC=+0.168 (n=2531)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3472 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `1.2069` → IC=+0.168 (n=2395)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2069 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.174 (n=1596)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8706 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.301` → IC=+0.224 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.301 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4641` → IC=+0.198 (n=3986)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4641 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.207 (n=3758)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.069` → IC=+0.281 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.069 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2807` → IC=+0.204 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2807 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.634` → IC=+0.155 (n=1246)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.634 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.168 (n=1246)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=1235)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.251 (n=905)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.1923` → IC=+0.276 (n=676)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1923 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.251 (n=692)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.234)

- **PATRÓN** `ibs_20min` < `0.058` → IC=+0.290 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.058 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.25` → IC=+0.244 (n=1133)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.25 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0926` → IC=+0.233 (n=848)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1734.6286` → IC=+0.246 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1734.6286 (IC base=+0.234)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.233 (n=454)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.003 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.1121` → IC=+0.237 (n=451)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1121 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.229 (n=1026)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.9222` → IC=+0.256 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9222 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.2143` → IC=+0.219 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2143 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.3824` → IC=+0.213 (n=970)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3824 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.859` → IC=+0.233 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.859 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.222 (n=1024)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2628 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.8746` → IC=+0.215 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8746 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.0994` → IC=+0.219 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0994 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.4925` → IC=+0.226 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4925 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.3925` → IC=+0.222 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3925 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `11907.94` → IC=+0.226 (n=915)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11907.94 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.162 (n=970)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0048 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.0766` → IC=+0.169 (n=367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.0766 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=438)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` < `0.6717` → IC=+0.178 (n=1100)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6717 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.157 (n=992)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1332 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.52` → IC=+0.184 (n=188)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 11.52 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.151 (n=1100)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2046 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6178` → IC=+0.142 (n=1100)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6178 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.1558` → IC=+0.193 (n=294)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1558 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.156 (n=991)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `13110.9149` → IC=+0.157 (n=733)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 13110.9149 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `216.0` → IC=+0.166 (n=303)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 216.0 (IC base=+0.142)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.188 (n=1325)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0057 (IC base=+0.178)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.180 (n=651)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.253 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.47` → IC=+0.233 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.47 (IC base=+0.178)

- **PATRÓN** `volumen_pendiente_norm` < `0.1064` → IC=+0.184 (n=1119)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3774` → IC=+0.184 (n=172)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.3774 (IC base=+0.178)

- **PATRÓN** `volumen_spike_ratio` > `3.0439` → IC=+0.199 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0439 (IC base=+0.178)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=1508)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.178)

- **PATRÓN** `ballena_activa_n` < `17.0` → IC=+0.192 (n=449)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 17.0 (IC base=+0.178)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.217 (n=1011)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.251 (n=431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.214)

- **PATRÓN** `ibs_20min` < `0.3822` → IC=+0.232 (n=1010)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3822 (IC base=+0.214)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.582` → IC=+0.215 (n=1351)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.582 (IC base=+0.214)

- **PATRÓN** `volumen_pendiente_norm` > `0.3649` → IC=+0.274 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3649 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` < `1.8388` → IC=+0.203 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8388 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `2.2947` → IC=+0.223 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2947 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.227 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `1888.9584` → IC=+0.230 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1888.9584 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.217 (n=426)
...
- **PATRÓN** `ibs_20min` > `0.9309` → IC=+0.169 (n=282)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.9309 (IC base=+0.007)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.272` → IC=+0.135 (n=527)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.272 (IC base=+0.007)
...
- **PATRÓN** `dist_vwap_pct` > `0.1648` → IC=+0.192 (n=186)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1648 (IC base=+0.001)

- **PATRÓN** `volumen_regimen` < `0.6944` → IC=+0.154 (n=235)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6944 (IC base=+0.001)

- **PATRÓN** `volumen_regimen` > `1.1643` → IC=+0.144 (n=178)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1643 (IC base=+0.001)

- **PATRÓN** `volumen_pendiente_norm` > `0.2689` → IC=+0.225 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2689 (IC base=+0.001)

- **PATRÓN** `volumen_spike_ratio` > `1.5036` → IC=+0.179 (n=431)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5036 (IC base=+0.001)
...
- **FILTRO** `ibs_20min` < `0.3636` → IC=-0.180 (n=95)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3636
  - _Potencial_: sin este filtro IC_bueno=+0.146 (n=193)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.128 (n=1711)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=+0.117 (n=850)

- **FILTRO** `sigma_ewma_delta_pct` > `8.613` → IC=-0.199 (n=280)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.613
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2281)

- **PATRÓN** `ibs_20min` > `0.75` → IC=+0.213 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.75 (IC base=+0.038)

- **PATRÓN** `dist_vwap_pct` > `1.1883` → IC=+0.300 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1883 (IC base=+0.038)

- **PATRÓN** `dist_vwap_pct` < `0.4558` → IC=+0.303 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4558 (IC base=+0.038)

- **PATRÓN** `volumen_regimen` < `0.5788` → IC=+0.286 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5788 (IC base=+0.038)

- **PATRÓN** `volumen_regimen` > `0.7744` → IC=+0.346 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7744 (IC base=+0.038)

- **PATRÓN** `volumen_spike_ratio` < `3.0245` → IC=+0.279 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0245 (IC base=+0.038)

- **PATRÓN** `volumen_spike_ratio` > `1.4528` → IC=+0.279 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4528 (IC base=+0.038)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.316 (n=74)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2029` → IC=+0.205 (n=198)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4885` → IC=+0.236 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4885 (IC base=-0.047)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.193 (n=424)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6536
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1273)

- **FILTRO** `ibs_20min` < `0.7812` → IC=-0.140 (n=1272)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7812
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=425)
...
- **FILTRO** `ibs_20min` > `0.7733` → IC=-0.201 (n=641)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7733
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=1926)

- **PATRÓN** `dist_vwap_pct` > `0.9672` → IC=+0.329 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9672 (IC base=-0.086)

- **PATRÓN** `dist_vwap_pct` < `0.2591` → IC=+0.297 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2591 (IC base=-0.086)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.290 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6141 (IC base=-0.086)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4665` → IC=+0.270 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4665 (IC base=-0.086)

- **PATRÓN** `volumen_spike_ratio` > `1.8015` → IC=+0.276 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8015 (IC base=-0.086)

- **PATRÓN** `dist_vwap_pct` > `1.0174` → IC=+0.263 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0174 (IC base=-0.028)

- **PATRÓN** `dist_vwap_pct` < `0.2617` → IC=+0.242 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2617 (IC base=-0.028)

- **PATRÓN** `volumen_regimen` < `0.7337` → IC=+0.242 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7337 (IC base=-0.028)

- **PATRÓN** `volumen_regimen` > `1.0842` → IC=+0.292 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0842 (IC base=-0.028)

- **PATRÓN** `volumen_pendiente_norm` > `0.1065` → IC=+0.261 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1065 (IC base=-0.028)

- **PATRÓN** `volumen_spike_ratio` < `2.2413` → IC=+0.259 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2413 (IC base=-0.028)

- **PATRÓN** `volumen_spike_ratio` > `1.4747` → IC=+0.237 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4747 (IC base=-0.028)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.242 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.028)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.175 (n=2522)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.009 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.9835` → IC=+0.289 (n=2518)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9835 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `1.0156` → IC=+0.285 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0156 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.508` → IC=+0.143 (n=3571)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.508 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6774` → IC=+0.235 (n=2290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6774 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` > `0.2487` → IC=+0.258 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2487 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` < `1.4784` → IC=+0.238 (n=1361)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4784 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` > `2.7847` → IC=+0.238 (n=1359)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7847 (IC base=+0.086)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.277 (n=3560)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.138 (n=2572)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0084 (IC base=+0.067)

- **PATRÓN** `ibs_20min` < `0.5565` → IC=+0.150 (n=6783)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5565 (IC base=+0.067)

- **PATRÓN** `dist_vwap_pct` > `0.6844` → IC=+0.245 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6844 (IC base=+0.067)

- **PATRÓN** `dist_vwap_pct` < `0.2332` → IC=+0.230 (n=2000)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2332 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.230 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` > `1.199` → IC=+0.253 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.199 (IC base=+0.067)

- **PATRÓN** `volumen_pendiente_norm` > `0.2511` → IC=+0.326 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2511 (IC base=+0.067)

- **PATRÓN** `volumen_spike_ratio` < `1.6229` → IC=+0.254 (n=1192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6229 (IC base=+0.067)

- **PATRÓN** `volumen_spike_ratio` > `2.3685` → IC=+0.255 (n=1228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3685 (IC base=+0.067)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.257 (n=2271)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.413` → IC=-0.163 (n=387)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1295)

- **PATRÓN** `ibs_20min` > `0.8649` → IC=+0.254 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8649 (IC base=+0.039)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.285` → IC=+0.151 (n=694)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 3.285 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.298 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` < `1.8491` → IC=+0.196 (n=353)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.8491 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` > `2.6662` → IC=+0.202 (n=176)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1673` → IC=+0.472 (n=34)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1673 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `1.9827` → IC=+0.446 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9827 (IC base=-0.023)
...
- **FILTRO** `ibs_20min` > `0.827` → IC=-0.147 (n=568)

  - _Acción_: SKIP cuando `ibs_20min` > 0.827
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1706)

- **PATRÓN** `dist_vwap_pct` > `0.3046` → IC=+0.139 (n=247)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.3046 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.6518` → IC=+0.134 (n=583)
...
- **PATRÓN** `ballena_activa_n` < `235.0` → IC=+0.184 (n=207)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 235.0 (IC base=+0.009)

- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.217 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1614 (IC base=+0.000)

- **PATRÓN** `volumen_regimen` > `1.1336` → IC=+0.229 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1336 (IC base=+0.000)

- **PATRÓN** `volumen_pendiente_norm` > `0.2799` → IC=+0.351 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2799 (IC base=+0.000)

- **PATRÓN** `volumen_spike_ratio` < `1.7946` → IC=+0.227 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7946 (IC base=+0.000)

- **PATRÓN** `volumen_spike_ratio` > `2.1554` → IC=+0.235 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1554 (IC base=+0.000)

- **PATRÓN** `ballena_activa_n` < `503.0` → IC=+0.214 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 503.0 (IC base=+0.000)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.268 (n=1072)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.0963` → IC=+0.249 (n=400)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0963 (IC base=+0.238)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.242 (n=599)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.526` → IC=+0.272 (n=375)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.526 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.1109` → IC=+0.256 (n=1002)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1109 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` < `1.8738` → IC=+0.240 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8738 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `3.0849` → IC=+0.249 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0849 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.255 (n=1355)
...
- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.287 (n=959)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3458` → IC=+0.312 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3458 (IC base=+0.279)

- **PATRÓN** `volumen_spike_ratio` < `1.6226` → IC=+0.279 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6226 (IC base=+0.279)

- **PATRÓN** `volumen_spike_ratio` > `2.2254` → IC=+0.283 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2254 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.288 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `1880.9161` → IC=+0.297 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1880.9161 (IC base=+0.279)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.278 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 22.0 (IC base=+0.279)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2437` → IC=-0.215 (n=342)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2437
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1028)

- **FILTRO** `ibs_20min` > `0.8142` → IC=-0.184 (n=450)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8142
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=1352)

- **PATRÓN** `ibs_20min` > `0.8027` → IC=+0.143 (n=466)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.8027 (IC base=-0.017)

- **PATRÓN** `dist_vwap_pct` > `0.3121` → IC=+0.226 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3121 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` < `0.9565` → IC=+0.208 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9565 (IC base=-0.017)

- **PATRÓN** `volumen_regimen` > `0.5518` → IC=+0.188 (n=309)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.5518 (IC base=-0.017)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7422` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7422 (IC base=-0.017)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.254 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 117.0 (IC base=-0.017)

- **PATRÓN** `dist_vwap_pct` > `0.1237` → IC=+0.180 (n=98)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1237 (IC base=-0.019)

- **PATRÓN** `dist_vwap_pct` < `0.283` → IC=+0.162 (n=226)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.283 (IC base=-0.019)

- **PATRÓN** `volumen_regimen` < `0.979` → IC=+0.170 (n=195)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.979 (IC base=-0.019)

- **PATRÓN** `volumen_regimen` > `0.7126` → IC=+0.173 (n=197)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.7126 (IC base=-0.019)

- **PATRÓN** `volumen_pendiente_norm` > `0.1508` → IC=+0.315 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1508 (IC base=-0.019)

- **PATRÓN** `volumen_spike_ratio` < `1.4214` → IC=+0.258 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4214 (IC base=-0.019)

- **PATRÓN** `volumen_spike_ratio` > `2.4157` → IC=+0.258 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4157 (IC base=-0.019)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.238 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=-0.019)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.207 (n=817)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6667
  - _Potencial_: sin este filtro IC_bueno=+0.253 (n=831)

- **FILTRO** `ibs_20min` > `0.7143` → IC=-0.237 (n=435)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1307)

- **FILTRO** `sigma_ewma_delta_pct` > `4.704` → IC=-0.170 (n=407)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.704
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1335)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.253 (n=831)
...
- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.290 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8618 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.7198` → IC=+0.274 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7198 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.1092` → IC=+0.277 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1092 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.2774` → IC=+0.333 (n=82)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4402` → IC=+0.278 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4402 (IC base=+0.025)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.322 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 55.0 (IC base=+0.025)

- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.128 (n=875)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4 (IC base=+0.002)

- **PATRÓN** `dist_vwap_pct` > `0.5842` → IC=+0.214 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5842 (IC base=+0.002)

- **PATRÓN** `dist_vwap_pct` < `0.3916` → IC=+0.182 (n=369)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.3916 (IC base=+0.002)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5839` → IC=+0.205 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5839 (IC base=+0.002)

- **PATRÓN** `volumen_spike_ratio` > `1.5045` → IC=+0.181 (n=327)
...
- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.323 (n=689)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.344 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` > `0.2668` → IC=+0.316 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2668 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.383` → IC=+0.296 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.383 (IC base=+0.269)

- **PATRÓN** `volumen_regimen` > `0.8551` → IC=+0.296 (n=689)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8551 (IC base=+0.269)

- **PATRÓN** `volumen_pendiente_norm` > `0.2365` → IC=+0.300 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2365 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` < `2.5657` → IC=+0.272 (n=968)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5657 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` > `2.2094` → IC=+0.276 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2094 (IC base=+0.269)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.272 (n=1068)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.269)

- **PATRÓN** `libro_liquidez` > `2584.5792` → IC=+0.277 (n=689)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2584.5792 (IC base=+0.269)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.278 (n=376)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0071 (IC base=+0.268)

- **PATRÓN** `sigma_h` > `0.0141` → IC=+0.291 (n=751)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0141 (IC base=+0.268)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.284 (n=558)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.268)

- **PATRÓN** `ibs_20min` < `0.3889` → IC=+0.304 (n=1126)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3889 (IC base=+0.268)

- **PATRÓN** `dist_vwap_pct` > `0.5441` → IC=+0.285 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5441 (IC base=+0.268)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.438` → IC=+0.289 (n=405)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.438 (IC base=+0.268)

- **PATRÓN** `volumen_regimen` > `1.2435` → IC=+0.312 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2435 (IC base=+0.268)

- **PATRÓN** `volumen_pendiente_norm` > `0.2419` → IC=+0.356 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2419 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` < `2.5387` → IC=+0.266 (n=966)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5387 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` > `2.1719` → IC=+0.264 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1719 (IC base=+0.268)

- **PATRÓN** `libro_liquidez` > `2563.4979` → IC=+0.274 (n=751)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2563.4979 (IC base=+0.268)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.203 (n=1993)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.3339` → IC=+0.173 (n=5253)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3339 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6241)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.6957` → IC=+0.229 (n=5334)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6957 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1644` → IC=+0.199 (n=2592)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1644 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.233` → IC=+0.250 (n=1236)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.233 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2177` → IC=+0.163 (n=3983)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2177 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6236` → IC=+0.160 (n=3982)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6236 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.1069` → IC=+0.187 (n=2341)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1069 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5672` → IC=+0.171 (n=2497)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5672 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6756` → IC=+0.170 (n=1890)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.6756 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `3822.4537` → IC=+0.173 (n=1990)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3822.4537 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.184 (n=4882)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 123.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.188 (n=3871)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0063 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.0791` → IC=+0.207 (n=1931)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0791 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.203 (n=2768)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` < `0.4595` → IC=+0.228 (n=5793)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4595 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.2249` → IC=+0.162 (n=4299)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2249 (IC base=+0.172)
...
- **PATRÓN** `volumen_regimen` < `1.1889` → IC=+0.157 (n=4232)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1889 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `0.6258` → IC=+0.152 (n=4232)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6258 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` > `0.2924` → IC=+0.232 (n=822)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2924 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `1.5751` → IC=+0.173 (n=2261)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.5751 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `2.6495` → IC=+0.179 (n=1713)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6495 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.172 (n=4757)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.207 (n=456)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3129` → IC=+0.204 (n=1006)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1055` → IC=+0.273 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1055 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.049` → IC=+0.251 (n=789)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.049 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.096` → IC=+0.235 (n=597)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8747` → IC=+0.250 (n=438)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=748)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1592.8005` → IC=+0.252 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1592.8005 (IC base=+0.237)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.246 (n=289)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.165)

- **PATRÓN** `drift_60min` |x|≤ `0.1692` → IC=+0.178 (n=578)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.1692 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.202 (n=598)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4304` → IC=+0.223 (n=867)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4304 (IC base=+0.165)
...
- **PATRÓN** `volumen_regimen` < `1.2719` → IC=+0.177 (n=867)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 1.2719 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2363` → IC=+0.191 (n=189)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2363 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` < `1.4117` → IC=+0.200 (n=278)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4117 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `9834.2432` → IC=+0.182 (n=867)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 9834.2432 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.182 (n=867)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0049 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.0583` → IC=+0.201 (n=329)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0583 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.166 (n=907)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 7.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.5226` → IC=+0.194 (n=985)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.5226 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.1378` → IC=+0.168 (n=996)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1378 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.1` → IC=+0.220 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.1 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.165 (n=985)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2113 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.188 (n=302)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.4386` → IC=+0.162 (n=876)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1073` → IC=+0.187 (n=806)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1073 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2189` → IC=+0.185 (n=284)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2189 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.681` → IC=+0.188 (n=306)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.681 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `3.6425` → IC=+0.201 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6425 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.203 (n=1106)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.225 (n=732)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.223)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.224 (n=744)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.223)

- **PATRÓN** `drift_60min` |x|≤ `0.0898` → IC=+0.250 (n=278)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.251 (n=832)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.283 (n=141)
...
- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.212 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 20.0 (IC base=+0.223)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.180 (n=829)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0065 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.4222` → IC=+0.167 (n=942)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.4222 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.165 (n=949)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.4079` → IC=+0.202 (n=942)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4079 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.1355` → IC=+0.195 (n=618)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1355 (IC base=+0.154)
...
- **PATRÓN** `volumen_regimen` < `0.8596` → IC=+0.160 (n=628)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8596 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `1.1977` → IC=+0.177 (n=314)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.1977 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.2888` → IC=+0.225 (n=147)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5331` → IC=+0.188 (n=306)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.5331 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `7289.8412` → IC=+0.192 (n=628)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 7289.8412 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.160 (n=772)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 153.0 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.163 (n=1015)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0071 (IC base=+0.128)

- **PATRÓN** `drift_60min` |x|≤ `0.3779` → IC=+0.144 (n=1015)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.3779 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.178 (n=396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.128)

- **PATRÓN** `ibs_20min` < `0.6046` → IC=+0.180 (n=1015)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6046 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.3394` → IC=+0.140 (n=1114)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3394 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.077` → IC=+0.190 (n=201)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 12.077 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.8618` → IC=+0.142 (n=677)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8618 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.130 (n=1016)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.6121 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.198 (n=147)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` < `1.7931` → IC=+0.135 (n=600)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.7931 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `2.4834` → IC=+0.142 (n=300)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.4834 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `9988.1936` → IC=+0.154 (n=461)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 9988.1936 (IC base=+0.128)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.149 (n=744)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0077 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1143)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5111` → IC=+0.196 (n=1113)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.474` → IC=+0.255 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.474 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.121 (n=1113)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.2208 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.7979` → IC=+0.126 (n=714)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.7979 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=1145)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2897.5388` → IC=+0.192 (n=505)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2897.5388 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.136 (n=810)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 49.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.153 (n=488)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0058 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.174 (n=508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.5435` → IC=+0.208 (n=1108)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5435 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.7032` → IC=+0.144 (n=200)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.7032 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.1924` → IC=+0.138 (n=1027)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1924 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.316` → IC=+0.155 (n=236)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.316 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.0407` → IC=+0.132 (n=975)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0407 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.2729` → IC=+0.187 (n=132)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2729 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.4646` → IC=+0.133 (n=322)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4646 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.1727` → IC=+0.136 (n=438)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.1727 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3082.2041` → IC=+0.161 (n=370)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3082.2041 (IC base=+0.115)
...
- **PATRÓN** `sigma_h` > `0.0179` → IC=+0.210 (n=708)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0179 (IC base=+0.200)

- **PATRÓN** `drift_60min` |x|≤ `0.1655` → IC=+0.219 (n=468)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1655 (IC base=+0.200)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1104)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.8772` → IC=+0.282 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8772 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.2344` → IC=+0.236 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2344 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.342` → IC=+0.242 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.342 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.205 (n=1063)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2089 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.6107` → IC=+0.210 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6107 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.1692` → IC=+0.257 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1692 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.1881` → IC=+0.214 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1881 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.201 (n=1082)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `2558.3544` → IC=+0.201 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2558.3544 (IC base=+0.200)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.235 (n=375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0221` → IC=+0.213 (n=510)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.218 (n=554)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4359` → IC=+0.242 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4359 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.1423` → IC=+0.224 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1423 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` < `0.2677` → IC=+0.204 (n=1168)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2677 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.312` → IC=+0.240 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.312 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `0.6289` → IC=+0.218 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6289 (IC base=+0.204)

- **PATRÓN** `volumen_pendiente_norm` > `0.2821` → IC=+0.286 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2821 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` < `2.2458` → IC=+0.198 (n=870)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.2458 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4624` → IC=+0.193 (n=989)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4624 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2527.1799` → IC=+0.214 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2527.1799 (IC base=+0.204)
...
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.155 (n=477)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0087 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0954` → IC=+0.151 (n=477)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.0954 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=713)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.3944` → IC=+0.169 (n=1431)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.3944 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.8281` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.8281 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.713` → IC=+0.168 (n=652)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.713 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8649` → IC=+0.156 (n=820)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8649 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1642` → IC=+0.167 (n=394)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1642 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.4313` → IC=+0.153 (n=456)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4313 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `2.5764` → IC=+0.157 (n=456)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5764 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.143 (n=1579)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `8135.1658` → IC=+0.159 (n=649)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 8135.1658 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.160 (n=1210)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 156.0 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.155 (n=502)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0037 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.3374` → IC=+0.127 (n=1322)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3374 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1519)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.4835` → IC=+0.157 (n=1322)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.4835 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2153` → IC=+0.123 (n=1320)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.2153 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.825` → IC=+0.132 (n=593)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 3.825 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.227` → IC=+0.123 (n=1324)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.227 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.1668` → IC=+0.141 (n=388)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.1668 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `2.2348` → IC=+0.135 (n=1262)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.2348 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.128 (n=600)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.135 (n=382)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0065 (IC base=+0.107)

- **PATRÓN** `drift_60min` |x|≤ `0.0974` → IC=+0.154 (n=128)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0974 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.139 (n=261)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 11.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` < `0.298` → IC=+0.162 (n=255)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.298 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.48` → IC=+0.160 (n=104)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 6.48 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `1.2311` → IC=+0.125 (n=382)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.2311 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` > `0.1664` → IC=+0.167 (n=91)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1664 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` > `1.5372` → IC=+0.128 (n=323)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 1.5372 (IC base=+0.107)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `dist_vwap_pct` > `0.3877` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3877
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=350)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.186 (n=135)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.078)

- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.208 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.329` → IC=+0.159 (n=133)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 5.329 (IC base=+0.078)

- **PATRÓN** `libro_liquidez` > `2970.4361` → IC=+0.193 (n=99)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2970.4361 (IC base=+0.078)

- **PATRÓN** `ibs_20min` < `0.4524` → IC=+0.168 (n=275)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.4524 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` < `0.7177` → IC=+0.150 (n=121)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7177 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `2.4929` → IC=+0.131 (n=253)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 2.4929 (IC base=+0.084)

- **PATRÓN** `libro_liquidez` > `2878.0292` → IC=+0.146 (n=125)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2878.0292 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.134 (n=219)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.194 (n=3424)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0085 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=7895)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4747` → IC=+0.213 (n=7539)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4747 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.8998` → IC=+0.202 (n=1000)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8998 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.581` → IC=+0.223 (n=3706)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.581 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8832` → IC=+0.165 (n=3390)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8832 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2403` → IC=+0.188 (n=1437)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2403 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6425` → IC=+0.185 (n=2393)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.6425 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3788.7148` → IC=+0.171 (n=2513)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3788.7148 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.195 (n=5442)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 95.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.197 (n=4628)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0066 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4748` → IC=+0.184 (n=6943)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4748 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2631)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.182)

- **PATRÓN** `ibs_20min` < `0.5567` → IC=+0.239 (n=6942)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5567 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2346` → IC=+0.164 (n=4369)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2346 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.856` → IC=+0.203 (n=994)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.856 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.703` → IC=+0.160 (n=2112)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.703 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2024` → IC=+0.161 (n=1598)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.2024 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2896` → IC=+0.253 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2896 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.3003` → IC=+0.189 (n=2815)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3003 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.178 (n=5823)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.232 (n=577)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.201 (n=607)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.318 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.378` → IC=+0.293 (n=780)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.378 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.2271` → IC=+0.245 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2271 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.186 (n=393)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.4564 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` > `2.2672` → IC=+0.198 (n=535)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.2672 (IC base=+0.195)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.224 (n=1142)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.195)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.260 (n=878)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.255)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.267 (n=890)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.255)

- **PATRÓN** `drift_60min` |x|≤ `0.1993` → IC=+0.280 (n=666)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1993 (IC base=+0.255)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.266 (n=905)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.255)

- **PATRÓN** `ibs_20min` < `0.3409` → IC=+0.285 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3409 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.62` → IC=+0.264 (n=1002)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1824` → IC=+0.155 (n=797)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1824 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1254)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.6905` → IC=+0.244 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6905 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.3464` → IC=+0.200 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3464 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.805` → IC=+0.160 (n=280)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 9.805 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.374` → IC=+0.154 (n=1058)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.374 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6938` → IC=+0.186 (n=526)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6938 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1544` → IC=+0.182 (n=328)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1544 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.4231` → IC=+0.157 (n=1141)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4231 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7608` → IC=+0.159 (n=761)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7608 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `10716.3301` → IC=+0.170 (n=1067)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 10716.3301 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `495.0` → IC=+0.164 (n=1075)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 495.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.172 (n=942)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.3225` → IC=+0.169 (n=1069)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3225 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.188 (n=421)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 17.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` < `0.6376` → IC=+0.208 (n=1069)
...
- **PATRÓN** `dist_vwap_pct` < `0.1327` → IC=+0.168 (n=978)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1327 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.3` → IC=+0.178 (n=526)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.3 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.167 (n=1069)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1917 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.1504` → IC=+0.211 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1504 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `2.4156` → IC=+0.172 (n=972)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.4156 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.5156` → IC=+0.163 (n=868)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.5156 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `12111.5999` → IC=+0.157 (n=713)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12111.5999 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `376.0` → IC=+0.166 (n=585)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 376.0 (IC base=+0.157)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.224 (n=1192)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.217 (n=1251)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.675` → IC=+0.250 (n=1062)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2179` → IC=+0.217 (n=1145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2179 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `3.0206` → IC=+0.234 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0206 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.226 (n=1351)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.246 (n=384)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.231)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.231 (n=522)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0091 (IC base=+0.231)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.258 (n=431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.231)

- **PATRÓN** `ibs_20min` < `0.3664` → IC=+0.268 (n=1014)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3664 (IC base=+0.231)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.708` → IC=+0.279 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.708 (IC base=+0.231)

- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.301 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3592 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` < `1.7875` → IC=+0.227 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7875 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` > `2.2419` → IC=+0.226 (n=685)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2419 (IC base=+0.231)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.243 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.231)

- **PATRÓN** `libro_liquidez` > `1893.56` → IC=+0.231 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1893.56 (IC base=+0.231)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.245 (n=421)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.137 (n=1279)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=1344)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.7095` → IC=+0.233 (n=853)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7095 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.3544` → IC=+0.184 (n=482)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.3544 (IC base=+0.135)
...
- **PATRÓN** `volumen_regimen` < `0.8804` → IC=+0.159 (n=853)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8804 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2746` → IC=+0.229 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2746 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.5052` → IC=+0.146 (n=541)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5052 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.4694` → IC=+0.160 (n=410)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.4694 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8770.6206` → IC=+0.230 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8770.6206 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `90.0` → IC=+0.160 (n=386)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 90.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.158 (n=1030)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0075 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.4348` → IC=+0.154 (n=1030)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4348 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=390)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6884` → IC=+0.191 (n=1030)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6884 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.2048` → IC=+0.144 (n=959)
...
- **PATRÓN** `volumen_regimen` < `0.8608` → IC=+0.143 (n=687)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8608 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.1852` → IC=+0.149 (n=343)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.1852 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.2782` → IC=+0.269 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2782 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.5565` → IC=+0.152 (n=423)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.5565 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `2.472` → IC=+0.171 (n=320)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.472 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `10976.6914` → IC=+0.187 (n=343)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 10976.6914 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `195.0` → IC=+0.144 (n=953)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 195.0 (IC base=+0.138)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.121 (n=1339)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 5.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.4673` → IC=+0.181 (n=1301)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.4673 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `1.0054` → IC=+0.193 (n=226)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 1.0054 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.447` → IC=+0.221 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.447 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=908)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2907.4324` → IC=+0.243 (n=434)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2907.4324 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.129 (n=959)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1233` → IC=+0.149 (n=417)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1233 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.152 (n=585)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.210 (n=1253)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.4731` → IC=+0.131 (n=1230)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4731 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.125 (n=1207)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.437 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.157 (n=552)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.72 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.2177` → IC=+0.168 (n=191)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.2177 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.4615` → IC=+0.140 (n=365)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4615 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.2135` → IC=+0.125 (n=497)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.2135 (IC base=+0.115)
...
- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.219 (n=595)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.557` → IC=+0.244 (n=716)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.557 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` < `1.2447` → IC=+0.205 (n=1312)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2447 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.627` → IC=+0.210 (n=1311)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.627 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2373` → IC=+0.236 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2373 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `2.5902` → IC=+0.239 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5902 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1317)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2566.7167` → IC=+0.212 (n=874)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2566.7167 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.0079` → IC=+0.237 (n=484)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0079 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0253` → IC=+0.220 (n=483)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0253 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.211 (n=698)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.201 (n=1533)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.5043` → IC=+0.255 (n=1447)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5043 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.271` → IC=+0.206 (n=1336)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.271 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.017` → IC=+0.259 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.017 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `1.2323` → IC=+0.240 (n=482)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2259` → IC=+0.195 (n=1115)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2259 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.198 (n=1266)
...
- **PATRÓN** `libro_liquidez` > `2541.6579` → IC=+0.202 (n=964)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.140 (n=2563)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.189 (n=648)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0037 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.487` → IC=+0.155 (n=1934)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.487 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.173 (n=726)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1778` → IC=+0.160 (n=851)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1778 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.7057` → IC=+0.147 (n=344)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.7057 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.273` → IC=+0.146 (n=1918)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.273 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.1144` → IC=+0.146 (n=1615)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.1144 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.152 (n=912)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.5735` → IC=+0.142 (n=1915)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.5735 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.8251` → IC=+0.149 (n=1276)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8251 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=2563)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `7756.2728` → IC=+0.150 (n=1728)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=332)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 17.0 (IC base=+0.134)
...
- **PATRÓN** `ibs_20min` > `0.6091` → IC=+0.145 (n=392)
...
- **PATRÓN** `dist_vwap_pct` < `0.228` → IC=+0.135 (n=891)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.228 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.052` → IC=+0.151 (n=946)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 9.052 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.8855` → IC=+0.179 (n=577)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.8855 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.0696` → IC=+0.162 (n=409)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0696 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `2.5736` → IC=+0.142 (n=862)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.5736 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.824` → IC=+0.149 (n=574)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.824 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `12053.6057` → IC=+0.147 (n=772)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 12053.6057 (IC base=+0.134)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5119` → IC=+0.182 (n=611)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.5119 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.174 (n=228)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 17.0 (IC base=+0.151)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.156 (n=428)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 11.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.0983` → IC=+0.166 (n=611)
...
- **PATRÓN** `dist_vwap_pct` < `0.4008` → IC=+0.152 (n=627)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4008 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.985` → IC=+0.167 (n=136)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 8.985 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6505` → IC=+0.184 (n=204)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6505 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `0.7326` → IC=+0.155 (n=546)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7326 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` < `0.1527` → IC=+0.156 (n=628)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2019` → IC=+0.165 (n=529)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.2019 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4508` → IC=+0.165 (n=600)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4508 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `8204.9591` → IC=+0.172 (n=611)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 8204.9591 (IC base=+0.151)
...
- **PATRÓN** `sigma_h` > `0.0134` → IC=+0.176 (n=35)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0134 (IC base=+0.057)

- **PATRÓN** `dist_vwap_pct` > `0.6259` → IC=+0.226 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6259 (IC base=+0.057)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.128 (n=41)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 22.0 (IC base=+0.057)

### GBM_LATE_60M
- **FILTRO** `ibs_20min` < `0.6407` → IC=-0.176 (n=183)
...
- **PATRÓN** `ibs_20min` > `0.6407` → IC=+0.213 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6407 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.1359` → IC=+0.166 (n=285)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1359 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.105` → IC=+0.212 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.105 (IC base=+0.100)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.222 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` < `2.5073` → IC=+0.151 (n=445)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.5073 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=446)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2444.1883` → IC=+0.157 (n=240)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2444.1883 (IC base=+0.100)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.176 (n=220)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0059 (IC base=+0.103)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.207 (n=80)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.5857` → IC=+0.207 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5857 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.1301` → IC=+0.196 (n=90)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1301 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.734` → IC=+0.134 (n=121)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.734 (IC base=+0.103)

- **PATRÓN** `volumen_regimen` < `1.0527` → IC=+0.127 (n=167)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0527 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` < `0.0759` → IC=+0.152 (n=133)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` < 0.0759 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.2602` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2602 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` < `2.0198` → IC=+0.189 (n=133)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.0198 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `2835.039` → IC=+0.124 (n=176)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2835.039 (IC base=+0.103)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.175 (n=149)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0049 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.142 (n=199)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 8.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.6407` → IC=+0.242 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6407 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.5424` → IC=+0.206 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5424 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.109` → IC=+0.306 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.109 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.789` → IC=+0.162 (n=128)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.789 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` > `0.932` → IC=+0.152 (n=87)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7434` → IC=+0.160 (n=95)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.7434 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `1.3826` → IC=+0.146 (n=142)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.3826 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.148 (n=200)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `1077.2861` → IC=+0.186 (n=167)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 1077.2861 (IC base=+0.117)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=485)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.126 (n=450)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` > 0.5 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2822.2308` → IC=+0.177 (n=159)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2822.2308 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=506)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2303.417` → IC=+0.127 (n=531)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 2303.417 (IC base=+0.098)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1315)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.125 (n=1004)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=5401)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=6153)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.179 (n=2589)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=7867)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=2676)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8219)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.217 (n=422)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1334)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.160 (n=445)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1493)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.198 (n=445)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1363)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.217 (n=457)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1456)

- **FILTRO** `ibs_20min` > `0.2865` → IC=-0.169 (n=478)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2865
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1435)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.203 (n=423)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2369)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2369)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2375)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7497)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=17123)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.282 (n=5697)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=18923)

- **FILTRO** `ibs_7min` < `0.7059` → IC=-0.240 (n=6133)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7059
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=18487)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.160 (n=8176)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=16444)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=7664)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=23149)

- **FILTRO** `ibs_7min` > `0.2972` → IC=-0.177 (n=7701)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2972
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=23112)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=926)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3009)

- **FILTRO** `ibs_7min` < `0.7099` → IC=-0.258 (n=1298)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7099
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2637)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.194 (n=951)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=2984)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.148 (n=3603)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.098 (n=1763)

- **FILTRO** `ibs_7min` > `0.7987` → IC=-0.207 (n=1341)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7987
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4025)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=988)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=3323)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.255 (n=999)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3312)

- **FILTRO** `ibs_7min` < `0.7595` → IC=-0.187 (n=1077)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7595
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=3234)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.170 (n=1074)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3237)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.255 (n=1019)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3340)

- **FILTRO** `ibs_7min` > `0.2506` → IC=-0.166 (n=1089)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2506
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3270)

- **FILTRO** `ballena_activa_n` > `114.0` → IC=-0.164 (n=1470)

  - _Acción_: SKIP cuando `ballena_activa_n` > 114.0
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2889)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=898)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2799)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.321 (n=885)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2812)

- **FILTRO** `drift_7min_pct` |x|> `0.1814` → IC=-0.131 (n=1256)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1814
  - _Potencial_: sin este filtro IC_bueno=-0.108 (n=2441)

- **FILTRO** `ibs_7min` < `0.2033` → IC=-0.274 (n=924)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2033
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2773)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.218 (n=892)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2805)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1323)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=4312)

- **FILTRO** `ibs_7min` > `0.2646` → IC=-0.157 (n=1915)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2646
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=3720)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1277)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=2768)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=975)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3070)

- **FILTRO** `ibs_7min` < `0.7454` → IC=-0.192 (n=1011)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7454
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3034)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.184 (n=990)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3055)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1012)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3134)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.175 (n=1036)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3110)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.179 (n=1030)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3116)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.241 (n=1106)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3363)

- **FILTRO** `ibs_7min` < `0.7241` → IC=-0.212 (n=1115)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7241
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3354)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1404)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=4421)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.124 (n=1246)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=2917)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=998)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3165)

- **FILTRO** `ibs_7min` < `0.7321` → IC=-0.229 (n=1040)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7321
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3123)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.205 (n=1023)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3140)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.205 (n=1307)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=4175)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3986` → IC=+0.133 (n=620)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.67€ cuando `delta_ratio` |x|> 0.3986 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.135 (n=560)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 6.0 (IC base=+0.121)

- **PATRÓN** `total_vol_5m` < `474.7871` → IC=+0.146 (n=207)

  - _Acción_: Kelly boost +0.73€ cuando `total_vol_5m` < 474.7871 (IC base=+0.121)
...
- **PATRÓN** `total_vol_5m` < `672.2721` → IC=+0.164 (n=111)

  - _Acción_: Kelly boost +0.82€ cuando `total_vol_5m` < 672.2721 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `73.0` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 73.0 (IC base=+0.094)
...
- **FILTRO** `sigma_h` < `0.0078` → IC=-0.302 (n=155)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0078
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=506)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=914)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2299)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1182)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.188 (n=351)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0039 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.194 (n=351)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.009 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.0548` → IC=+0.174 (n=351)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.0548 (IC base=+0.169)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0587` → IC=+0.173 (n=1051)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.87€ cuando `delta_ratio_macro` |x|> 0.0587 (IC base=+0.169)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3418` → IC=+0.205 (n=731)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3418 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.174 (n=747)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6173` → IC=+0.241 (n=1051)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6173 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.151` → IC=+0.164 (n=516)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.151 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.1089` → IC=+0.170 (n=697)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1089 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.884` → IC=+0.242 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.884 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `5120.698` → IC=+0.181 (n=477)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 5120.698 (IC base=+0.169)

### UPDOWN_GBM#60min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=336)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.200 (n=88)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.195)

- **PATRÓN** `drift_60min` |x|≤ `0.0624` → IC=+0.247 (n=89)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0624 (IC base=+0.195)

- **PATRÓN** `drift_15min` |x|≤ `0.3762` → IC=+0.214 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3762 (IC base=+0.195)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2526` → IC=+0.211 (n=88)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2526 (IC base=+0.195)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3892` → IC=+0.229 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3892 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.211 (n=275)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.195)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.194 (n=276)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 17.0 (IC base=+0.195)

- **PATRÓN** `ibs_15` > `0.7746` → IC=+0.261 (n=236)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7746 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` > `0.4066` → IC=+0.229 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4066 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` < `0.1092` → IC=+0.201 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1092 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.501` → IC=+0.252 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.501 (IC base=+0.195)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.331` → IC=+0.141 (n=62)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 20.331 (IC base=-0.005)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.178 (n=85)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0032 (IC base=+0.131)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.133 (n=115)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0056 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.0736` → IC=+0.143 (n=113)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.0736 (IC base=+0.131)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1416` → IC=+0.161 (n=169)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.80€ cuando `delta_ratio_macro` |x|> 0.1416 (IC base=+0.131)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.266` → IC=+0.165 (n=162)

  - _Acción_: Kelly boost +0.82€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.266 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.139 (n=189)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 11.0 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.139 (n=253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 16.0 (IC base=+0.131)

- **PATRÓN** `ibs_15` > `0.6524` → IC=+0.226 (n=253)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6524 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.5418` → IC=+0.139 (n=289)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5418 (IC base=+0.131)
...
- **PATRÓN** `libro_liquidez` > `10110.2635` → IC=+0.133 (n=115)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 10110.2635 (IC base=+0.131)
...
- **FILTRO** `dist_vwap_pct` > `0.5902` → IC=-0.143 (n=113)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=584)

### UPDOWN_GBM#SOL#60min
- **PATRÓN** `sigma_ewma_delta_pct` > `13.113` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.113 (IC base=-0.007)

### UPDOWN_GBM#XRP#15min
- **PATRÓN** `sigma_h` > `0.0203` → IC=+0.239 (n=136)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0669` → IC=+0.193 (n=268)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.0669 (IC base=+0.177)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0933` → IC=+0.275 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0933 (IC base=+0.177)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.225 (n=147)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.177)

- **PATRÓN** `ibs_15` > `0.5385` → IC=+0.272 (n=300)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.409` → IC=+0.177 (n=267)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 7.409 (IC base=+0.177)

- **PATRÓN** `libro_liquidez` > `2716.8736` → IC=+0.232 (n=136)
...
- **FILTRO** `ibs_15` < `0.6046` → IC=-0.184 (n=175)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.249 (n=528)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.207 (n=247)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1863)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2866` → IC=+0.219 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2866 (IC base=-0.058)

- **PATRÓN** `ibs_15` > `0.6046` → IC=+0.249 (n=528)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6046 (IC base=-0.058)

- **PATRÓN** `dist_vwap_pct` < `0.1129` → IC=+0.174 (n=323)
...
- **FILTRO** `sigma_h` > `0.007` → IC=-0.208 (n=313)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=943)

- **FILTRO** `sigma_h` < `0.0032` → IC=-0.234 (n=314)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0032
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=942)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.214 (n=802)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.175 (n=454)

- **FILTRO** `sigma_ewma_delta_pct` > `19.843` → IC=-0.248 (n=228)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.843
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1028)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.158 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0026 (IC base=+0.071)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2023` → IC=+0.245 (n=53)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2023 (IC base=+0.071)
...
- **PATRÓN** `dist_vwap_pct` > `0.1129` → IC=+0.250 (n=78)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1129 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.4975` → IC=+0.273 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4975 (IC base=+0.071)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.295 (n=344)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0043 (IC base=+0.283)

- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.283 (n=515)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0028 (IC base=+0.283)

- **PATRÓN** `drift_60min` |x|≤ `0.057` → IC=+0.310 (n=172)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.057 (IC base=+0.283)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1424` → IC=+0.291 (n=343)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1424 (IC base=+0.283)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1084` → IC=+0.326 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1084 (IC base=+0.283)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.300 (n=534)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.283)

- **PATRÓN** `ibs_15` > `0.8357` → IC=+0.324 (n=515)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8357 (IC base=+0.283)

- **PATRÓN** `dist_vwap_pct` > `0.2735` → IC=+0.325 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2735 (IC base=+0.283)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.754` → IC=+0.314 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.754 (IC base=+0.283)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.287 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `12407.0839` → IC=+0.301 (n=234)
...
- **PATRÓN** `sigma_h` > `0.0052` → IC=+0.276 (n=96)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0052 (IC base=+0.276)

- **PATRÓN** `drift_60min` |x|≤ `0.0602` → IC=+0.306 (n=96)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3724` → IC=+0.295 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3724 (IC base=+0.276)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.332 (n=135)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.276)

- **PATRÓN** `ibs_15` > `0.8593` → IC=+0.302 (n=256)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8593 (IC base=+0.276)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `23.865` → IC=+0.333 (n=64)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.865 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `11990.51` → IC=+0.298 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11990.51 (IC base=+0.276)

### UPDOWN_GBM_IBS_ALTO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.306 (n=153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.291)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.296 (n=229)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1466` → IC=+0.306 (n=153)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1466 (IC base=+0.291)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.288` → IC=+0.333 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.288 (IC base=+0.291)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.319 (n=219)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.291)

- **PATRÓN** `ibs_15` > `0.8527` → IC=+0.336 (n=229)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.4534` → IC=+0.297 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4534 (IC base=+0.291)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.72` → IC=+0.316 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.72 (IC base=+0.291)

- **PATRÓN** `sigma_ewma_delta_pct` < `18.976` → IC=+0.293 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 18.976 (IC base=+0.291)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.302 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.291)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.294 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 158.0 (IC base=+0.291)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6173 sube el IC de +0.169 a +0.241 en UPDOWN_GBM#15min (n=1051). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7746 sube el IC de +0.195 a +0.261 en UPDOWN_GBM#BTC#15min (n=236). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6524 sube el IC de +0.131 a +0.226 en UPDOWN_GBM#ETH#15min (n=253). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5385 sube el IC de +0.177 a +0.272 en UPDOWN_GBM#XRP#15min (n=300). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6046 sube el IC de -0.058 a +0.249 en UPDOWN_GBM_15M_TARDIO (n=528). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8098 sube el IC de +0.071 a +0.338 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=103). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3667 sube el IC de -0.043 a +0.246 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=230). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8357 sube el IC de +0.283 a +0.324 en UPDOWN_GBM_IBS_ALTO (n=515). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.
35€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 273 | +0.122 | +84.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#240min | 19 | -0.023 | -0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#5min | 1856 | +0.066 | +124.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 4400 | +0.031 | +291.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 786 | +0.083 | +184.75€ | 0 | 13 |
| ✅ UPDOWN_GBM#BTC#240min | 263 | +0.025 | +7.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#5min | 2663 | +0.026 | +95.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 649 | +0.001 | +2.92€ | 0 | 1 |
| ✅ UPDOWN_GBM#BTC#daily | 39 | -0.110 | +1.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 2940 | +0.033 | +95.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 229 | +0.106 | +55.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 16 | +0.000 | -0.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 2695 | +0.026 | +40.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 4979 | +0.016 | +197.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1815 | +0.043 | +192.18€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 250 | +0.008 | +8.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 2353 | +0.003 | -0.27€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 527 | -0.009 | -7.41€ | 1 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 34 | -0.139 | +4.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 6469 | +0.016 | +147.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 1774 | +0.022 | +100.97€ | 1 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 244 | -0.008 | -2.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 4134 | +0.017 | +55.10€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 289 | -0.009 | -6.04€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 28 | -0.133 | -0.08€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 3752 | +0.040 | +415.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 1723 | +0.079 | +423.10€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 132 | -0.015 | -3.58€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 1897 | +0.008 | -4.39€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 8842 | -0.049 | +1836.34€ | 3 | 7 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 8842 | -0.049 | +1836.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 403 | -0.053 | +344.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 403 | -0.053 | +344.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 1688 | -0.131 | -15.34€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 1688 | -0.131 | -15.34€ | 4 | 6 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 2841 | -0.062 | +446.12€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 2841 | -0.062 | +446.12€ | 4 | 5 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 2816 | -0.077 | +469.27€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 2816 | -0.077 | +469.27€ | 2 | 3 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 686 | +0.283 | +548.09€ | 0 | 11 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 686 | +0.283 | +548.09€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC | 381 | +0.276 | +288.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#BTC#15min | 381 | +0.276 | +288.87€ | 0 | 11 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH | 305 | +0.291 | +259.22€ | 0 | 0 |
| ✅ UPDOWN_GBM_IBS_ALTO#ETH#15min | 305 | +0.291 | +259.22€ | 0 | 13 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 450 celda(s) pasan gate riguroso completo de 2038 evaluadas (n>=40) y 2993 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.023 < 0.08 — monitorear
  - _Datos_: n=1772 IC=+0.023 PNL=+101.99€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.098 n=177/60 | contraria IC=+0.114 n=156 | gap=-0.016 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar

**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  - _Umbral_: n_overlaps≥20 y IC_overlap > IC_base + 0.05
  - _Acción_: Cambiar _aplicar_kelly_compuesto: match por activo, no market_id
  - _Estado_: n_overlaps=235, boost estimado=+0.005. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=525/40 IC=-0.009 PNL=-7.39€ | BTC#60min: n=648/40 IC=+0.000 PNL=+2.43€ | SOL#60min: n=288/40 IC=-0.007 PNL=-5.53€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.054 n=255021 | tras_1loss IC=+0.071 n=199476 | tras_2loss IC=+0.039 n=85584/40 | gap=+0.015 (umbral 0.05)
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.199 > 0.08 con n=260 PNL=+167.89€
  - _Datos_: n=260 IC=+0.199 PNL=+167.89€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1073 IC=-0.006 PNL=-16.78€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1073 IC=-0.006 PNL=-16.78€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=388 IC=+0.000 PNL=+6.30€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=388 IC=+0.000 PNL=+6.30€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.1 con n=1400 PNL=+778.81€
  - _Datos_: n=1400 IC=+0.169 PNL=+778.81€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=785 IC=+0.083 PNL=+185.31€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=785 IC=+0.083 PNL=+185.31€
...
**🔶 H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.242 n=60) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=60 IC=+0.242 PNL=+35.06€
...
**🟡 H-CUSTOM-OF-EDGE-ALTO** — ORDER_FLOW_5M: edge alto (>0.20) rinde mejor que edge cerca del suelo
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.128 > 0.02 con n=552 PNL=+222.10€
  - _Datos_: n=552 IC=+0.128 PNL=+222.10€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=7957 IC=+0.049 PNL=+892.29€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=7957 IC=+0.049 PNL=+892.29€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1321 IC=+0.050 PNL=+162.32€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1321 IC=+0.050 PNL=+162.32€
...
**🟡 H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.137 > 0.1 con n=246 PNL=+78.73€
  - _Datos_: n=246 IC=+0.137 PNL=+78.73€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=13232 IC=-0.143 PNL=+647.60€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=13232 IC=-0.143 PNL=+647.60€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1466 IC=+0.142 PNL=+796.65€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1466 IC=+0.142 PNL=+796.65€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.242 < -0.1 con n=1350 PNL=-201.04€
  - _Datos_: n=1350 IC=-0.242 PNL=-201.04€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.098 n=707) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=707 IC=+0.098 PNL=+183.34€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=6894 IC=+0.169 PNL=-885.14€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=6894 IC=+0.169 PNL=-885.14€
...
**🟡 H-CUSTOM-GBMLATE15M-SOL-RESCATE-PRECIO** — GBM_LATE_15M#SOL#15min#BUY_YES (pausada 05-Ago) -- posible rescate con filtro py en [0.45,0.55)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.216 > 0.1 con n=100 PNL=+63.73€
  - _Datos_: n=100 IC=+0.216 PNL=+63.73€
