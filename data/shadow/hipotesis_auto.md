# Hipótesis automáticas — 2026-06-30 06:07 UTC
_Generado por shadow_postmortem.py sobre 1374 resoluciones (PNL=-50.33€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.06` → IC=+0.150 (n=18)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `pct_spot_vs_ref` |x|≤ 0.06 (IC base=+0.042)

- **PATRÓN** `drift_60min` |x|≤ `0.15` → IC=+0.167 (n=19)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.15 (IC base=+0.042)
...
| ✅ UPDOWN_GBM | 402 | -0.012 | -9.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 239 | +0.027 | +4.63€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 82 | +0.024 | +1.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 127 | +0.004 | -5.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 70 | +0.042 | -1.36€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.019) — sin ventaja clara. oversold(IBS<0.3): IC=-0.026 n=36 | neutral: IC=-0.045 n=31 | overbought(IBS>0.7): IC=-0.033 n=43
  - _Datos_: n=113 IC=-0.039 PNL=-10.49€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 113 ops, 19 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 402/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=303 IC=-0.002 PNL=-3.73€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=303 IC=-0.002 PNL=-3.73€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=181 IC=-0.008 PNL=-13.73€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=181 IC=-0.008 PNL=-13.73€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=70 IC=+0.042 PNL=-1.36€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=70 IC=+0.042 PNL=-1.36€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=97 IC=+0.066 PNL=+0.49€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=97 IC=+0.066 PNL=+0.49€
