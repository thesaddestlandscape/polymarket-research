# Hipótesis automáticas — 2026-07-24 19:54 UTC
_Generado por shadow_postmortem.py sobre 33449 resoluciones (PNL=+7380.09€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.199 (n=2115)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=2389)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.217 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=593)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.214 (n=180)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1585.2799` → IC=+0.220 (n=498)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.168` → IC=+0.164 (n=123)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.718` → IC=-0.283 (n=21)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=479)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.167 (n=1147)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0071 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.148 (n=1209)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `1.0454` → IC=+0.217 (n=97)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0454 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.8008` → IC=+0.135 (n=1783)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.8008 (IC base=+0.133)
...
- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.123 (n=409)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0112 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.118` → IC=+0.139 (n=333)
...
- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.121 (n=354)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.60€ cuando `sigma_h` < 0.0106 (IC base=+0.066)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7622` → IC=+0.240 (n=394)
...
- **PATRÓN** `dist_vwap_pct` > `0.1814` → IC=+0.197 (n=173)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1814 (IC base=+0.060)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1829` → IC=+0.128 (n=135)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.64€ cuando `delta_ratio_macro` |x|> 0.1829 (IC base=+0.046)

- **PATRÓN** `ibs_15` > `0.6814` → IC=+0.194 (n=171)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.97€ cuando `ibs_15` > 0.6814 (IC base=+0.046)

- **PATRÓN** `dist_vwap_pct` > `0.1647` → IC=+0.143 (n=82)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.1647 (IC base=+0.046)

- **PATRÓN** `dist_vwap_pct` < `0.6858` → IC=+0.132 (n=150)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.6858 (IC base=+0.046)

- **PATRÓN** `sigma_ewma_delta_pct` > `30.643` → IC=+0.227 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 30.643 (IC base=+0.046)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.7622 sube el IC de +0.060 a +0.240 en UPDOWN_GBM#15min (n=394). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6814 sube el IC de +0.046 a +0.194 en UPDOWN_GBM#ETH#15min (n=171). Ya aplicado como kelly_boost=+0.97€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 992 | +0.135 | +56.63€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 992 | +0.135 | +56.63€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 12 | +0.086 | +1.81€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 12 | +0.086 | +1.81€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 381 | +0.145 | +19.48€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 381 | +0.145 | +19.48€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 375 | +0.147 | +15.51€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 375 | +0.147 | +15.51€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 5921 | +0.187 | +89.98€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#15min | 3891 | +0.213 | +76.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 257 | +0.064 | -16.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 741 | +0.127 | -53.11€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 2089 | +0.174 | -6.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1281 | +0.208 | +21.88€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 85 | -0.017 | -20.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 379 | +0.130 | -25.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 344 | +0.144 | +17.32€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#SOL | 2061 | +0.192 | +49.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1283 | +0.222 | +64.52€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 329 | +0.310 | +11.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 329 | +0.310 | +11.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 329 | +0.310 | +11.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 329 | +0.310 | +11.47€ | 0 | 0 |
| ✅ GBM_LATE_15M | 7522 | +0.097 | +2344.87€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 7522 | +0.097 | +2344.87€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1830 | +0.067 | +309.27€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1830 | +0.067 | +309.27€ | 0 | 5 |
| ✅ GBM_LATE_15M#ETH | 1674 | +0.076 | +291.96€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1674 | +0.076 | +291.96€ | 0 | 6 |
| ✅ GBM_LATE_15M#SOL | 2026 | +0.088 | +712.56€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 2026 | +0.088 | +712.56€ | 1 | 3 |
| ✅ GBM_LATE_15M#XRP | 1992 | +0.149 | +1031.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1992 | +0.149 | +1031.08€ | 0 | 14 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 4712 | +0.124 | +2340.47€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 4712 | +0.124 | +2340.47€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1192 | +0.096 | +488.78€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1192 | +0.096 | +488.78€ | 0 | 6 |
...
| ✅ GBM_LATE_15M_TARDIO | 4746 | +0.075 | +1359.69€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 4746 | +0.075 | +1359.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1151 | +0.034 | +142.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1151 | +0.034 | +142.66€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1148 | +0.027 | +83.85€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1148 | +0.027 | +83.85€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 1098 | +0.038 | +219.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 1098 | +0.038 | +219.62€ | 1 | 2 |
...
| ✅ UPDOWN_GBM | 2489 | +0.035 | +234.99€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2226 | +0.055 | +273.51€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 1002 | +0.038 | +71.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 908 | +0.053 | +82.75€ | 0 | 7 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 146 | +0.311 | +33.62€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 146 | +0.311 | +33.62€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1592 | +0.167 | +758.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1592 | +0.167 | +758.78€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 320 | +0.177 | +135.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 320 | +0.177 | +135.31€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 382 | +0.112 | +115.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 382 | +0.112 | +115.11€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.181: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.070 n=1309 | neutral: IC=+0.023 n=1015 | overbought(IBS>0.7): IC=+0.204 n=1284
  - _Datos_: n=3851 IC=+0.108 PNL=+1053.27€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=20057 | tras_1loss IC=+0.083 n=13192 | tras_2loss IC=+0.052 n=5468/40 | gap=+0.063 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.091 n=1489/40 PNL=+299.73€ | H=15h UTC: IC=+0.145 n=1431/40 PNL=+537.39€ | H=17h UTC: IC=+0.095 n=1414/40 PNL=+271.23€ | H=19h UTC: IC=+0.135 n=1330/40 PNL=+366.64€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=273 IC=-0.002 PNL=-6.92€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=273 IC=-0.002 PNL=-6.92€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2357 IC=+0.041 PNL=+249.74€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2357 IC=+0.041 PNL=+249.74€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=962 IC=+0.060 PNL=+147.95€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=962 IC=+0.060 PNL=+147.95€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.096 > 0.08 con n=1182 PNL=+220.53€
  - _Datos_: n=1182 IC=+0.096 PNL=+220.53€
...
**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.108 > 0.08 con n=289 PNL=+61.31€
  - _Datos_: n=289 IC=+0.108 PNL=+61.31€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1112 IC=+0.031 PNL=+117.40€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1112 IC=+0.031 PNL=+117.40€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.180 > 0.1 con n=783 PNL=+311.38€
  - _Datos_: n=783 IC=+0.180 PNL=+311.38€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.148 > 0.08 con n=558 PNL=+194.19€
  - _Datos_: n=558 IC=+0.148 PNL=+194.19€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.108 > 0.08 con n=460 PNL=+125.44€
  - _Datos_: n=460 IC=+0.108 PNL=+125.44€
