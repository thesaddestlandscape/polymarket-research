# Hipótesis automáticas — 2026-07-12 14:52 UTC
_Generado por shadow_postmortem.py sobre 11044 resoluciones (PNL=+2015.88€)_
...
- **PATRÓN** `py_entrada` > `0.585` → IC=+0.245 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.585 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `2790.6958` → IC=+0.223 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2790.6958 (IC base=+0.211)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=404)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `5910.4373` → IC=+0.165 (n=162)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 5910.4373 (IC base=+0.149)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.227 (n=53)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.194 (n=70)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 15.0 (IC base=+0.186)

- **PATRÓN** `py_entrada` > `0.605` → IC=+0.231 (n=76)
...
- **PATRÓN** `libro_liquidez` > `6497.9556` → IC=+0.224 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6497.9556 (IC base=+0.210)
...
- **PATRÓN** `py_entrada` < `0.605` → IC=+0.259 (n=27)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.605 (IC base=+0.250)

- **PATRÓN** `py_entrada` > `0.765` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.765 (IC base=+0.250)

- **PATRÓN** `libro_liquidez` > `4211.4102` → IC=+0.324 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4211.4102 (IC base=+0.250)
...
- **PATRÓN** `py_entrada` > `0.705` → IC=+0.389 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.705 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `1877.4208` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1877.4208 (IC base=+0.225)
...
### GBM_LATE_15M
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=1343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.122 (n=1339)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 17.0 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.4454` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.4454 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.1403` → IC=+0.199 (n=71)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.1403 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.126` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.126 (IC base=+0.117)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.148 (n=925)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0091 (IC base=+0.111)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.140 (n=938)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 11.0 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.5163` → IC=+0.167 (n=133)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.5163 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.327` → IC=+0.250 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.327 (IC base=+0.111)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `dist_vwap_pct` < `0.1111` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1111 (IC base=+0.085)
...
- **PATRÓN** `sigma_h` < `0.0161` → IC=+0.139 (n=358)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.177 (n=153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0101 (IC base=+0.154)
...
- **PATRÓN** `dist_vwap_pct` < `0.1605` → IC=+0.220 (n=23)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1605 (IC base=+0.154)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` < `0.0319` → IC=+0.184 (n=305)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0319 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.014` → IC=+0.180 (n=273)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.014 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.170 (n=310)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1286` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1286 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0172` → IC=+0.187 (n=231)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0172 (IC base=+0.180)

- **PATRÓN** `sigma_h` > `0.0299` → IC=+0.203 (n=116)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0299 (IC base=+0.180)
...
- **PATRÓN** `dist_vwap_pct` > `0.2667` → IC=+0.184 (n=17)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.2667 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.098` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.098 (IC base=+0.180)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.194 (n=321)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.4274` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4274 (IC base=+0.174)

- **PATRÓN** `dist_vwap_pct` < `0.1221` → IC=+0.204 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1221 (IC base=+0.174)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.442` → IC=+0.315 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.442 (IC base=+0.174)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.177 (n=367)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.2169` → IC=+0.255 (n=104)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.160 (n=101)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0058 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.217 (n=90)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.167 (n=91)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.181 (n=70)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0049 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.171 (n=74)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 12.0 (IC base=+0.148)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.167 (n=106)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 17.0 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.4153` → IC=+0.262 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4153 (IC base=+0.148)
...
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.200 (n=58)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.171 (n=77)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 15.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.241 (n=52)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0086 (IC base=+0.105)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=41)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.2052` → IC=+0.284 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2052 (IC base=+0.105)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.0186` → IC=+0.326 (n=67)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0186 (IC base=+0.269)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.297 (n=62)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0135` → IC=+0.125 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0135 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` < `0.1111` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1111 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.79` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.79 (IC base=+0.079)

- **PATRÓN** `sigma_h` > `0.0124` → IC=+0.150 (n=141)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0124 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` < `0.503` → IC=+0.128 (n=127)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.503 (IC base=+0.082)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.076)
...
- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.244 (n=37)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0083 (IC base=+0.037)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.143 (n=40)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 6.0 (IC base=+0.037)

- **PATRÓN** `dist_vwap_pct` < `0.1776` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1776 (IC base=+0.037)
...
- **PATRÓN** `sigma_h` > `0.0314` → IC=+0.250 (n=38)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0314 (IC base=+0.214)
...
- **PATRÓN** `dist_vwap_pct` < `0.2531` → IC=+0.206 (n=32)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=347)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.121 (n=238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 13.0 (IC base=+0.018)

- **PATRÓN** `ibs_15` > `0.5859` → IC=+0.121 (n=291)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` > 0.5859 (IC base=+0.018)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.193 (n=73)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.018)

- **PATRÓN** `dist_vwap_pct` < `0.3809` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.3809 (IC base=+0.018)

- **PATRÓN** `ibs_15` < `0.0512` → IC=+0.132 (n=131)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.0512 (IC base=+0.028)
...
- **PATRÓN** `ibs_15` > `0.7622` → IC=+0.213 (n=85)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7622 (IC base=+0.030)

- **PATRÓN** `dist_vwap_pct` < `0.4961` → IC=+0.162 (n=63)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.4961 (IC base=+0.030)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS > 0.7622 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.213 n=85). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 922 | +0.180 | +2.10€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 594 | +0.208 | +6.76€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 271 | +0.181 | -6.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 198 | +0.200 | -10.26€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 327 | +0.169 | +3.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 197 | +0.208 | +6.49€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 322 | +0.188 | +4.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 197 | +0.214 | +10.50€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 3607 | +0.114 | +1190.09€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 3607 | +0.114 | +1190.09€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 887 | +0.069 | +113.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 887 | +0.069 | +113.97€ | 0 | 1 |
| ✅ GBM_LATE_15M#ETH | 913 | +0.072 | +142.44€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 913 | +0.072 | +142.44€ | 0 | 3 |
| ✅ GBM_LATE_15M#SOL | 940 | +0.139 | +464.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 940 | +0.139 | +464.86€ | 0 | 8 |
| ✅ GBM_LATE_15M#XRP | 867 | +0.174 | +468.82€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 867 | +0.174 | +468.82€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 968 | +0.164 | +530.45€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 968 | +0.164 | +530.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 254 | +0.164 | +166.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 254 | +0.164 | +166.04€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 259 | +0.124 | +90.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 259 | +0.124 | +90.58€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 271 | +0.119 | +86.44€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 271 | +0.119 | +86.44€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 184 | +0.280 | +187.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 184 | +0.280 | +187.38€ | 0 | 5 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1131 | +0.081 | +274.36€ | 1 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1131 | +0.081 | +274.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 262 | +0.076 | +34.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 262 | +0.076 | +34.81€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 280 | +0.004 | +5.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 280 | +0.004 | +5.52€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 296 | +0.037 | +36.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 296 | +0.037 | +36.66€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 293 | +0.202 | +197.37€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 293 | +0.202 | +197.37€ | 0 | 8 |
...
| ✅ UPDOWN_GBM | 1326 | -0.007 | +25.79€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1070 | +0.022 | +63.25€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#ETH | 656 | +0.014 | +35.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 563 | +0.033 | +46.32€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.123) — sin ventaja clara. oversold(IBS<0.3): IC=-0.023 n=344 | neutral: IC=-0.048 n=259 | overbought(IBS>0.7): IC=+0.075 n=292
  - _Datos_: n=936 IC=+0.007 PNL=+51.02€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.156 n=30 PNL=-6.41€ → FILTRAR | H=07h: IC=+0.110 n=39 PNL=+13.58€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.110 n=39 PNL=+9.83€ → BOOST | H=17h: IC=+0.130 n=44 PNL=+14.88€ → BOOST | H=22h: IC=+0.108 n=49 PNL=+7.56€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.091 n=6242 | tras_1loss IC=+0.045 n=4665 | tras_2loss IC=+0.011 n=2092/40 | gap=+0.080 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1199 IC=-0.000 PNL=+39.78€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1199 IC=-0.000 PNL=+39.78€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=608 IC=+0.018 PNL=+28.21€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=608 IC=+0.018 PNL=+28.21€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=551 IC=+0.051 PNL=+46.10€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=551 IC=+0.051 PNL=+46.10€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=432 IC=+0.011 PNL=+15.72€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=432 IC=+0.011 PNL=+15.72€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.246 > 0.08 con n=61 PNL=+16.08€
  - _Datos_: n=61 IC=+0.246 PNL=+16.08€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8586 IC=+0.097 PNL=+2091.76€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8586 IC=+0.097 PNL=+2091.76€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=755 IC=-0.015 PNL=-2.26€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=755 IC=-0.015 PNL=-2.26€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.173 > 0.1 con n=270 PNL=+101.41€
  - _Datos_: n=270 IC=+0.173 PNL=+101.41€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.175 > 0.08 con n=204 PNL=+74.46€
  - _Datos_: n=204 IC=+0.175 PNL=+74.46€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.236 n=85) pero sin cruzar ≥2 pares más — ETH: n=107 IC=+0.142 ✓; SOL: n=7 IC=-0.019; XRP: n=5 IC=+0.018
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.304 > 0.2 con n=141 PNL=+96.25€
  - _Datos_: n=141 IC=+0.304 PNL=+96.25€
...
**⏳ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 11/40 ops en el filtro definido (IC actual=+0.064 PNL=+8.20€)
  - _Datos_: n=11 IC=+0.064 PNL=+8.20€

**⏳ H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: 40
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: 10/40 ops en el filtro definido (IC actual=+0.042 PNL=+7.77€)
  - _Datos_: n=10 IC=+0.042 PNL=+7.77€
...
**⏳ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: 17/40 ops en el filtro definido (IC actual=+0.157 PNL=+13.20€)
  - _Datos_: n=17 IC=+0.157 PNL=+13.20€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.151 > 0.08 con n=61 PNL=-4.38€
  - _Datos_: n=61 IC=+0.151 PNL=-4.38€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.314 > 0.08 con n=68 PNL=+7.28€
  - _Datos_: n=68 IC=+0.314 PNL=+7.28€
