# Hipótesis automáticas — 2026-08-07 11:18 UTC
_Generado por shadow_postmortem.py sobre 85785 resoluciones (PNL=+13605.25€)_
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.155 (n=3175)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 7.0 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.2918` → IC=+0.170 (n=811)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.2918 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.976` → IC=+0.243 (n=1284)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.976 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `2048.9027` → IC=+0.152 (n=3042)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2048.9027 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.004` → IC=+0.162 (n=3069)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.6135` → IC=+0.147 (n=318)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.841` → IC=+0.147 (n=2528)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `8.224` → IC=+0.333 (n=40)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 8.224 (IC base=+0.271)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.229 (n=105)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.364` → IC=+0.181 (n=227)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.364 (IC base=+0.180)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.322` → IC=+0.231 (n=199)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.322 (IC base=+0.180)

- **PATRÓN** `libro_liquidez` > `1377.5082` → IC=+0.207 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1377.5082 (IC base=+0.180)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.348 (n=31)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0076 (IC base=+0.306)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.308 (n=45)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.306)

- **PATRÓN** `drift_60min` |x|≤ `0.1429` → IC=+0.324 (n=15)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1429 (IC base=+0.306)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.350 (n=18)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.306)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.324 (n=49)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.280)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.326 (n=130)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.280)

- **PATRÓN** `dist_vwap_pct` > `0.361` → IC=+0.297 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.361 (IC base=+0.280)

- **PATRÓN** `dist_vwap_pct` < `0.0981` → IC=+0.285 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0981 (IC base=+0.280)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.737` → IC=+0.386 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.737 (IC base=+0.280)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.299 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.280)

- **PATRÓN** `libro_liquidez` > `2581.7526` → IC=+0.288 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2581.7526 (IC base=+0.280)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.976` → IC=+0.212 (n=1219)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.976 (IC base=+0.097)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_ewma_delta_pct` > `13.216` → IC=+0.170 (n=104)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 13.216 (IC base=+0.066)
...
- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.186 (n=909)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.7531` → IC=+0.265 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7531 (IC base=+0.175)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.188 (n=799)
...
| ✅ BALLENAS_TARDIAS | 1669 | -0.076 | -252.31€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 360 | +0.193 | -46.26€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 1309 | -0.151 | -206.05€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB | 297 | -0.319 | -72.96€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB#5min | 297 | -0.319 | -72.96€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 269 | -0.109 | -4.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 269 | -0.109 | -4.99€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 22570 | +0.120 | -525.50€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5840 | +0.194 | -104.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 435 | +0.049 | -40.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 14520 | +0.090 | -437.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 