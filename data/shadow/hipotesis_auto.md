# Hipótesis automáticas — 2026-07-27 06:04 UTC
_Generado por shadow_postmortem.py sobre 37856 resoluciones (PNL=+7863.84€)_
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.192 (n=1607)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.194 (n=122)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 8.0 (IC base=+0.194)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.238 (n=124)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `8622.5915` → IC=+0.208 (n=46)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8622.5915 (IC base=+0.194)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.171 (n=141)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 5.0 (IC base=+0.152)
...
- **PATRÓN** `py_entrada` < `0.575` → IC=+0.160 (n=51)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `py_entrada` < 0.575 (IC base=+0.152)

- **PATRÓN** `py_entrada` > `0.575` → IC=+0.162 (n=143)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` > 0.575 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.183 (n=143)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.152)
...
- **PATRÓN** `py_entrada` < `0.64` → IC=+0.199 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.64 (IC base=+0.180)

- **PATRÓN** `py_entrada` > `0.575` → IC=+0.182 (n=149)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.575 (IC base=+0.180)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.202 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.180)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.146 (n=405)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 8.0 (IC base=+0.095)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.148 (n=921)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.156 (n=347)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 6.0 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.3347` → IC=+0.189 (n=120)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.3347 (IC base=+0.138)
...
- **PATRÓN** `dist_vwap_pct` > `0.2694` → IC=+0.197 (n=486)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.2694 (IC base=+0.149)
...
- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.155 (n=1350)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.4048` → IC=+0.125 (n=337)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.4048 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.238` → IC=+0.141 (n=299)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 8.238 (IC base=+0.120)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.447` → IC=+0.142 (n=188)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 4.447 (IC base=+0.092)
...
- **PATRÓN** `dist_vwap_pct` > `0.1126` → IC=+0.168 (n=197)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.1126 (IC base=+0.129)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.377` → IC=+0.195 (n=57)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 12.377 (IC base=+0.068)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1360 | +0.103 | +35.63€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1360 | +0.103 | +35.63€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | -0.35€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M