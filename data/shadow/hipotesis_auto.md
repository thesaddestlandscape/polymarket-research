# Hipótesis automáticas — 2026-09-22 17:34 UTC
_Generado por shadow_postmortem.py sobre 560695 resoluciones (PNL=+62527.53€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.13` → IC=-0.231 (n=6743)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.13
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=20232)
...
- **FILTRO** `restante_s_al_confirmar` < `496.69` → IC=-0.147 (n=355)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1067)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `134.67` → IC=-0.278 (n=830)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.67
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2490)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `163.42` → IC=-0.228 (n=1598)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 163.42
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4796)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `124.36` → IC=-0.362 (n=1343)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 124.36
  - _Potencial_: sin este filtro IC_bueno=-0.123 (n=4031)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.201 (n=13379)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3350)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5553.0459` → IC=+0.174 (n=2136)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5553.0459 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.140 (n=10684)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.233 (n=10382)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=5453)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `7663.8833` → IC=+0.172 (n=2052)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7663.8833 (IC base=+0.128)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.208 (n=1566)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1616)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.352 (n=740)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=2024)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15781.2955` → IC=+0.229 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15781.2955 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.203 (n=1450)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1608)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=2052)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `13906.4284` → IC=+0.207 (n=721)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.154 (n=2696)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.246 (n=635)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.239 (n=1426)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.234)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.154 (n=440)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1302.9991` → IC=+0.152 (n=627)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.229 (n=684)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.203)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.171 (n=1045)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=10900)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=10458)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3685)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2532)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.184 (n=1845)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=2328)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.202 (n=32295)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.232 (n=17551)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.199)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6572)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.45` → IC=+0.143 (n=2245)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 3.45 (IC base=+0.122)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.194 (n=2463)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.38 (IC base=+0.114)

- **PATRÓN** `restante_min` < `4.18` → IC=+0.126 (n=2284)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.18 (IC base=+0.114)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.137 (n=2455)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` > 4.96 (IC base=+0.114)

- **PATRÓN** `lag_apertura_s` < `2.31` → IC=+0.141 (n=2280)

  - _Acción_: Kelly boost +0.71€ cuando `lag_apertura_s` < 2.31 (IC base=+0.114)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.322 (n=752)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1565.7184` → IC=+0.298 (n=1058)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1565.7184 (IC base=+0.293)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.301 (n=329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4208.4907` → IC=+0.301 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4208.4907 (IC base=+0.278)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.337 (n=359)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1466.4356` → IC=+0.316 (n=454)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4748` → IC=+0.121 (n=7593)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4748 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.982` → IC=+0.242 (n=2532)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.982 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8312` → IC=+0.247 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8312 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.6234` → IC=+0.246 (n=2106)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6234 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.929` → IC=+0.178 (n=2932)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.929 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.05` → IC=+0.255 (n=923)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.05 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3055` → IC=+0.214 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3055 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.911` → IC=+0.206 (n=3446)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.911 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5708` → IC=+0.132 (n=9154)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5708 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5918` → IC=+0.192 (n=696)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.5918 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1474` → IC=+0.172 (n=2838)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1474 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.175 (n=1392)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6986 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `1.0537` → IC=+0.175 (n=1435)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0537 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.219 (n=1516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5775` → IC=+0.200 (n=4718)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5775 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.209 (n=5064)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=+0.062)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.179 (n=574)
...
- **PATRÓN** `drift_60min` |x|≤ `0.346` → IC=+0.166 (n=1721)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.346 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.166 (n=830)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=669)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.117` → IC=+0.271 (n=743)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0853` → IC=+0.249 (n=437)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0853 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.229 (n=1379)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.214)

- **PATRÓN** `ibs_20min` > `0.9894` → IC=+0.268 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9894 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` > `0.1958` → IC=+0.221 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1958 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `0.577` → IC=+0.217 (n=1361)
...
- **PATRÓN** `volumen_regimen` < `1.2558` → IC=+0.217 (n=1311)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2558 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` > `1.0844` → IC=+0.223 (n=594)
...
- **PATRÓN** `ibs_20min` < `0.6849` → IC=+0.169 (n=1361)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6849 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1275` → IC=+0.158 (n=1208)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1275 (IC base=+0.137)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.206` → IC=+0.141 (n=1238)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.206 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2049` → IC=+0.148 (n=1361)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2049 (IC base=+0.137)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.142` → IC=+0.257 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.142 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` < `0.2114` → IC=+0.191 (n=1666)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3626` → IC=+0.198 (n=220)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.3626 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `2.8806` → IC=+0.205 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8806 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.198 (n=1165)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.02 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `1942.5784` → IC=+0.191 (n=558)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 1942.5784 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0113` → IC=+0.224 (n=1430)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0113 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.5811` → IC=+0.215 (n=1429)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.688` → IC=+0.237 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.688 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.425` → IC=+0.214 (n=1561)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.425 (IC base=+0.214)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8718` → IC=+0.226 (n=590)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8718 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.223 (n=936)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `1865.08` → IC=+0.226 (n=648)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1865.08 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.216 (n=1084)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.153 (n=93)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=2105)
...
- **PATRÓN** `volumen_regimen` < `0.8511` → IC=+0.157 (n=514)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8511 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` > `0.2242` → IC=+0.209 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2242 (IC base=+0.012)

- **PATRÓN** `volumen_spike_ratio` > `1.5133` → IC=+0.173 (n=641)
...
- **FILTRO** `hora_utc` < `17.0` → IC=-0.161 (n=57)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=303)

- **FILTRO** `ibs_20min` < `0.2667` → IC=-0.196 (n=90)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2667
  - _Potencial_: sin este filtro IC_bueno=+0.136 (n=270)

- **FILTRO** `ibs_20min` > `0.2581` → IC=-0.126 (n=2083)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2581
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=1028)
...
- **PATRÓN** `ibs_20min` > `0.7727` → IC=+0.228 (n=123)
...
- **PATRÓN** `dist_vwap_pct` < `0.5528` → IC=+0.275 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5528 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` < `0.5788` → IC=+0.263 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5788 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `0.7744` → IC=+0.308 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7744 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` < `0.0747` → IC=+0.311 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0747 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `2.2644` → IC=+0.292 (n=94)
...
- **PATRÓN** `ibs_20min` < `0.2581` → IC=+0.123 (n=1028)
...
- **FILTRO** `drift_60min` |x|> `0.6451` → IC=-0.184 (n=530)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6451
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1592)

- **FILTRO** `ibs_20min` < `0.7013` → IC=-0.157 (n=1400)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7013
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=722)
...
- **FILTRO** `ibs_20min` > `0.7734` → IC=-0.204 (n=786)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7734
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=2361)

- **PATRÓN** `dist_vwap_pct` > `0.7547` → IC=+0.305 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7547 (IC base=-0.069)

- **PATRÓN** `dist_vwap_pct` < `0.2607` → IC=+0.319 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2607 (IC base=-0.069)

- **PATRÓN** `volumen_regimen` > `0.6166` → IC=+0.303 (n=313)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5298` → IC=+0.295 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5298 (IC base=-0.069)

- **PATRÓN** `volumen_spike_ratio` > `1.8015` → IC=+0.293 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8015 (IC base=-0.069)

- **PATRÓN** `dist_vwap_pct` > `0.7986` → IC=+0.274 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7986 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.7407` → IC=+0.245 (n=308)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1035` → IC=+0.274 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1035 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `2.1777` → IC=+0.251 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1777 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.4469` → IC=+0.247 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4469 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.197 (n=3167)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.4711` → IC=+0.188 (n=8485)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4711 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.7446` → IC=+0.288 (n=1027)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7446 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.569` → IC=+0.156 (n=4496)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.569 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `0.6849` → IC=+0.245 (n=2997)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6849 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.2977` → IC=+0.263 (n=804)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2977 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `1.4706` → IC=+0.238 (n=1817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4706 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `2.6883` → IC=+0.237 (n=1817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6883 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.268 (n=4962)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.096)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.147 (n=3171)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.009 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.55` → IC=+0.151 (n=8374)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.55 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.2417` → IC=+0.239 (n=2600)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2417 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` < `0.7109` → IC=+0.237 (n=1220)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7109 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.2035` → IC=+0.247 (n=924)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2035 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.303 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` < `1.4857` → IC=+0.254 (n=1208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4857 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.3302` → IC=+0.258 (n=1641)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3302 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.261 (n=3494)
...
- **PATRÓN** `ibs_20min` > `0.8909` → IC=+0.264 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8909 (IC base=+0.044)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.303` → IC=+0.164 (n=897)
...
- **PATRÓN** `ibs_20min` > `0.8632` → IC=+0.157 (n=637)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8632 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` > `0.1245` → IC=+0.165 (n=490)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1245 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` < `1.0445` → IC=+0.144 (n=766)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0445 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` > `0.6686` → IC=+0.158 (n=778)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4226` → IC=+0.196 (n=284)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.4226 (IC base=+0.024)

- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.189 (n=371)
...
- **PATRÓN** `volumen_regimen` > `0.6093` → IC=+0.210 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6093 (IC base=+0.002)

- **PATRÓN** `volumen_pendiente_norm` < `0.0729` → IC=+0.208 (n=440)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4584` → IC=+0.221 (n=159)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.248 (n=1508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.246)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.742` → IC=+0.283 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.742 (IC base=+0.246)

- **PATRÓN** `volumen_pendiente_norm` < `0.1384` → IC=+0.258 (n=1329)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1384 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `2.898` → IC=+0.258 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.898 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.258 (n=1033)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1934.9386` → IC=+0.256 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1934.9386 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.307 (n=796)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.5945` → IC=+0.284 (n=1190)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2252` → IC=+0.287 (n=1047)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2252 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.808` → IC=+0.299 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.808 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.3423` → IC=+0.306 (n=184)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7825` → IC=+0.287 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7825 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.291 (n=773)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1917.8409` → IC=+0.299 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1917.8409 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.289 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 19.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.28` → IC=-0.193 (n=460)
...
- **FILTRO** `ibs_20min` > `0.7785` → IC=-0.182 (n=561)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1687)

- **PATRÓN** `ibs_20min` > `0.9075` → IC=+0.180 (n=461)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.9075 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` > `0.4586` → IC=+0.225 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4586 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` < `0.9969` → IC=+0.230 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9969 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` > `0.5808` → IC=+0.205 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5808 (IC base=+0.008)

- **PATRÓN** `volumen_pendiente_norm` > `0.0791` → IC=+0.253 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0791 (IC base=+0.008)

- **PATRÓN** `volumen_spike_ratio` < `1.4963` → IC=+0.254 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4963 (IC base=+0.008)

- **PATRÓN** `ballena_activa_n` < `101.0` → IC=+0.253 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 101.0 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` > `0.1525` → IC=+0.199 (n=197)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1525 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` < `0.6579` → IC=+0.191 (n=428)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.6579 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.201 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1615 (IC base=-0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.1645` → IC=+0.267 (n=88)
...
- **FILTRO** `ibs_20min` < `0.7143` → IC=-0.203 (n=1003)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.277 (n=1010)

- **FILTRO** `ibs_20min` > `0.6905` → IC=-0.233 (n=529)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6905
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1588)

- **FILTRO** `sigma_ewma_delta_pct` > `4.685` → IC=-0.180 (n=464)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.685
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=1653)

- **PATRÓN** `ibs_20min` > `0.7143` → IC=+0.277 (n=1010)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7143 (IC base=+0.037)

- **PATRÓN** `dist_vwap_pct` > `0.8327` → IC=+0.343 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8327 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.527` → IC=+0.158 (n=320)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 9.527 (IC base=+0.037)

- **PATRÓN** `volumen_regimen` < `0.8646` → IC=+0.297 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8646 (IC base=+0.037)

- **PATRÓN** `volumen_regimen` > `0.6388` → IC=+0.290 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6388 (IC base=+0.037)

- **PATRÓN** `volumen_pendiente_norm` < `0.1042` → IC=+0.292 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1042 (IC base=+0.037)

- **PATRÓN** `volumen_pendiente_norm` > `0.2264` → IC=+0.290 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2264 (IC base=+0.037)

- **PATRÓN** `volumen_spike_ratio` < `1.7985` → IC=+0.310 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7985 (IC base=+0.037)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.314 (n=615)
...
- **PATRÓN** `ibs_20min` > `0.63` → IC=+0.312 (n=1236)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.63 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.1997` → IC=+0.320 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1997 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.495` → IC=+0.302 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.495 (IC base=+0.279)

- **PATRÓN** `volumen_regimen` > `0.8627` → IC=+0.304 (n=823)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5142` → IC=+0.291 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5142 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.284 (n=1311)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `2615.2506` → IC=+0.294 (n=823)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2615.2506 (IC base=+0.279)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.169 (n=2492)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.205 (n=2490)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0111 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.3547` → IC=+0.175 (n=6568)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3547 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=7807)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5789` → IC=+0.217 (n=7463)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5789 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1738` → IC=+0.195 (n=3292)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1738 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.275` → IC=+0.259 (n=1539)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.275 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.160 (n=4943)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2184 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.628` → IC=+0.160 (n=4941)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.628 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.246` → IC=+0.195 (n=1507)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.246 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5622` → IC=+0.171 (n=3144)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5622 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6287` → IC=+0.176 (n=2381)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6287 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2397.9754` → IC=+0.168 (n=4975)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2397.9754 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.182 (n=6372)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 117.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.181 (n=4727)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.0799` → IC=+0.206 (n=2365)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0799 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2735)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` < `0.4773` → IC=+0.225 (n=7085)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4773 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` < `0.2283` → IC=+0.158 (n=5126)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2283 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.239` → IC=+0.189 (n=1203)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 10.239 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `1.176` → IC=+0.149 (n=5152)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.176 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2911` → IC=+0.219 (n=1020)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2911 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.2636` → IC=+0.170 (n=2906)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2636 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `119.0` → IC=+0.171 (n=6049)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 119.0 (IC base=+0.166)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.186 (n=425)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0083 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.3418` → IC=+0.205 (n=1277)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.246 (n=817)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3427` → IC=+0.264 (n=909)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3427 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.095` → IC=+0.253 (n=985)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.095 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0955` → IC=+0.236 (n=753)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2759` → IC=+0.246 (n=733)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2759 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1789.5548` → IC=+0.247 (n=606)
...
- **PATRÓN** `volumen_regimen` < `1.2679` → IC=+0.163 (n=1112)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2679 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `1.0753` → IC=+0.168 (n=504)
...
- **PATRÓN** `libro_liquidez` > `15833.0774` → IC=+0.170 (n=504)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 15833.0774 (IC base=+0.160)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.231 (n=566)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.2226` → IC=+0.217 (n=831)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2226 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.227 (n=423)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=665)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.876` → IC=+0.280 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.876 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` < `0.2101` → IC=+0.199 (n=1205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2101 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.1057` → IC=+0.201 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1057 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `2.8829` → IC=+0.209 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8829 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.214 (n=863)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `1937.4232` → IC=+0.208 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1937.4232 (IC base=+0.201)

- **PATRÓN** `sigma_h` < `0.0111` → IC=+0.236 (n=1025)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0111 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.0954` → IC=+0.257 (n=343)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0954 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.278 (n=359)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.220)

- **PATRÓN** `ibs_20min` < `0.2436` → IC=+0.255 (n=901)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2436 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.704` → IC=+0.266 (n=429)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2254` → IC=+0.227 (n=629)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2254 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `1868.6968` → IC=+0.221 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1868.6968 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.221 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 12.0 (IC base=+0.220)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.174 (n=1051)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0067 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.159 (n=1193)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1257)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.3868` → IC=+0.198 (n=1193)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.3868 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.157` → IC=+0.180 (n=804)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.157 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.887` → IC=+0.227 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.887 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `1.048` → IC=+0.149 (n=1050)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.048 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `0.6318` → IC=+0.150 (n=1193)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6318 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.2935` → IC=+0.204 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2935 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `1.5356` → IC=+0.151 (n=514)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.5356 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `2.5403` → IC=+0.173 (n=389)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5403 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `6954.443` → IC=+0.186 (n=795)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6954.443 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.146 (n=1132)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 166.0 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.153 (n=1251)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0073 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.3836` → IC=+0.140 (n=1251)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3836 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.175 (n=491)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1582` → IC=+0.142 (n=1204)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1582 (IC base=+0.121)
...
- **PATRÓN** `volumen_regimen` < `0.8485` → IC=+0.145 (n=834)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8485 (IC base=+0.121)
...
- **PATRÓN** `libro_liquidez` > `9966.3147` → IC=+0.159 (n=567)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.160 (n=612)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0101 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.138 (n=1385)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.202 (n=1349)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5169 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.8335` → IC=+0.216 (n=410)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8335 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.679` → IC=+0.254 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.679 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `1.2243` → IC=+0.129 (n=1349)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2243 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` > `0.6372` → IC=+0.120 (n=1349)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` > 0.6372 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` < `0.1651` → IC=+0.130 (n=1353)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1651 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `2.4817` → IC=+0.128 (n=1301)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.4817 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1408)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2897.5388` → IC=+0.195 (n=612)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2897.5388 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.136 (n=1028)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.215 (n=859)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=1344)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7368` → IC=+0.261 (n=1152)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7368 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `1.2985` → IC=+0.232 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2985 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.509` → IC=+0.246 (n=608)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.509 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2103` → IC=+0.205 (n=1289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2103 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.8611` → IC=+0.222 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8611 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.2336` → IC=+0.271 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2336 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` < `2.1492` → IC=+0.213 (n=1094)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1492 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.8015` → IC=+0.209 (n=829)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8015 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1361)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2792.9766` → IC=+0.205 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2792.9766 (IC base=+0.202)
...
- **PATRÓN** `drift_60min` |x|≤ `0.089` → IC=+0.220 (n=444)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.089 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.222 (n=650)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.247 (n=1333)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.44 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `1.1311` → IC=+0.226 (n=166)
...
- **PATRÓN** `volumen_regimen` > `0.6303` → IC=+0.216 (n=1332)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4476` → IC=+0.199 (n=1191)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4476 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2572.7602` → IC=+0.207 (n=888)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2572.7602 (IC base=+0.203)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1349` → IC=+0.153 (n=767)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1349 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.188 (n=875)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.5522` → IC=+0.188 (n=1555)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5522 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.8519` → IC=+0.192 (n=287)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.8519 (IC base=+0.146)
...
- **PATRÓN** `volumen_regimen` < `0.8754` → IC=+0.163 (n=1012)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8754 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.701` → IC=+0.151 (n=1355)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.701 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1639` → IC=+0.176 (n=480)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1639 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.163 (n=558)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5495` → IC=+0.160 (n=557)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5495 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=1961)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12208.3999` → IC=+0.148 (n=580)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 12208.3999 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.164 (n=1517)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 165.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.129 (n=1216)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0057 (IC base=+0.101)

- **PATRÓN** `ibs_20min` < `0.0568` → IC=+0.191 (n=607)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.0568 (IC base=+0.101)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.146 (n=580)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=519)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.128)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.130 (n=600)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 17.0 (IC base=+0.128)

- **PATRÓN** `ibs_20min` < `0.6039` → IC=+0.178 (n=511)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6039 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.2972` → IC=+0.153 (n=614)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.2972 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.388` → IC=+0.148 (n=225)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.388 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `1.063` → IC=+0.164 (n=263)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.063 (IC base=+0.128)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1128` → IC=+0.151 (n=502)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.1128 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `1.4203` → IC=+0.138 (n=570)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4203 (IC base=+0.128)

- **PATRÓN** `ballena_activa_n` < `331.0` → IC=+0.143 (n=482)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 331.0 (IC base=+0.128)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0958` → IC=+0.216 (n=174)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0958 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.246 (n=262)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` > `0.7051` → IC=+0.254 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7051 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` > `0.3803` → IC=+0.237 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3803 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.976` → IC=+0.239 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.976 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` < `0.8432` → IC=+0.211 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8432 (IC base=+0.199)
...
- **PATRÓN** `volumen_spike_ratio` > `2.405` → IC=+0.240 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.405 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=576)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `12298.0783` → IC=+0.204 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12298.0783 (IC base=+0.199)

- **PATRÓN** `ibs_20min` < `0.0811` → IC=+0.163 (n=161)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.0811 (IC base=+0.075)
...
- **PATRÓN** `volumen_regimen` < `1.0712` → IC=+0.138 (n=335)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.0712 (IC base=+0.123)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2097` → IC=+0.163 (n=164)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.2097 (IC base=+0.123)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=9931)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.4721` → IC=+0.216 (n=9496)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4721 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.9501` → IC=+0.207 (n=1376)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9501 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.614` → IC=+0.227 (n=4616)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.614 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.165 (n=4235)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8827 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2402` → IC=+0.200 (n=1784)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2402 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6131` → IC=+0.188 (n=3036)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6131 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2339.988` → IC=+0.171 (n=6330)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2339.988 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `88.0` → IC=+0.195 (n=7151)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 88.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.187 (n=7562)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0092 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1458` → IC=+0.187 (n=3783)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.1458 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=3244)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5657` → IC=+0.237 (n=8592)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5657 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2428` → IC=+0.161 (n=5303)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2428 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.935` → IC=+0.196 (n=1208)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 9.935 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.719` → IC=+0.182 (n=8331)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.719 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7048` → IC=+0.159 (n=2611)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.7048 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2052` → IC=+0.152 (n=1978)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2052 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2882` → IC=+0.238 (n=1122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2882 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `1.8641` → IC=+0.187 (n=5231)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.8641 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.190 (n=4983)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 48.0 (IC base=+0.180)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.208 (n=539)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.188)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.221 (n=539)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.3513` → IC=+0.189 (n=1617)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.320 (n=577)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5862` → IC=+0.202 (n=508)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5862 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.258 (n=1242)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_spike_ratio` > `1.8671` → IC=+0.275 (n=755)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8671 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1786.74` → IC=+0.267 (n=827)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1786.74 (IC base=+0.258)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0845` → IC=+0.163 (n=508)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0845 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1595)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3136` → IC=+0.201 (n=1524)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3136 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.1298` → IC=+0.185 (n=877)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1298 (IC base=+0.147)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.233` → IC=+0.149 (n=1364)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.233 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6277` → IC=+0.176 (n=508)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6277 (IC base=+0.147)
...
- **PATRÓN** `ibs_20min` < `0.2667` → IC=+0.235 (n=876)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2667 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.6888` → IC=+0.151 (n=227)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.6888 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.1318` → IC=+0.167 (n=1182)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1318 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.199` → IC=+0.154 (n=631)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.199 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.160 (n=1314)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4209` → IC=+0.169 (n=406)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.4209 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.159 (n=811)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `425.0` → IC=+0.157 (n=984)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 425.0 (IC base=+0.149)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0116` → IC=+0.246 (n=510)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0116 (IC base=+0.219)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=1606)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.219)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=1561)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.219)

- **PATRÓN** `ibs_20min` > `0.6723` → IC=+0.258 (n=1366)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6723 (IC base=+0.219)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.27` → IC=+0.299 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.27 (IC base=+0.219)

- **PATRÓN** `volumen_pendiente_norm` < `0.2117` → IC=+0.222 (n=1500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2117 (IC base=+0.219)

- **PATRÓN** `volumen_spike_ratio` > `2.8669` → IC=+0.244 (n=659)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8669 (IC base=+0.219)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.230 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.219)

- **PATRÓN** `libro_liquidez` > `1941.7448` → IC=+0.223 (n=510)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1941.7448 (IC base=+0.219)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.234 (n=1255)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 53.0 (IC base=+0.219)

- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.240 (n=1420)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0112 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.164` → IC=+0.240 (n=625)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3623` → IC=+0.269 (n=1249)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3623 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.722` → IC=+0.277 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.722 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` > `0.3454` → IC=+0.289 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3454 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` < `1.766` → IC=+0.234 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.766 (IC base=+0.234)

- **PATRÓN** `volumen_spike_ratio` > `2.1999` → IC=+0.237 (n=862)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1999 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.245 (n=930)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1866.5527` → IC=+0.247 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1866.5527 (IC base=+0.234)

- **PATRÓN** `ballena_activa_n` < `31.0` → IC=+0.238 (n=816)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4364` → IC=+0.143 (n=1619)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4364 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.151 (n=1698)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8796` → IC=+0.262 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8796 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3665` → IC=+0.170 (n=653)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3665 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.19` → IC=+0.162 (n=673)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.19 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8781` → IC=+0.158 (n=1080)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8781 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2836` → IC=+0.219 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2836 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5194` → IC=+0.150 (n=689)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5194 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4706` → IC=+0.153 (n=522)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.4706 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8151.5866` → IC=+0.231 (n=734)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8151.5866 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.156 (n=498)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 80.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.161 (n=1157)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0066 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4461` → IC=+0.154 (n=1315)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4461 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.170 (n=492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6936` → IC=+0.185 (n=1315)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6936 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.8062` → IC=+0.140 (n=1516)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.151 (n=1243)
...
- **PATRÓN** `dist_vwap_pct` < `0.2176` → IC=+0.129 (n=1272)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2176 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.454` → IC=+0.124 (n=1525)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.226` → IC=+0.165 (n=243)
...
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.218 (n=1070)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.214 (n=1679)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.249 (n=1605)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5146 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` > `0.4916` → IC=+0.240 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4916 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.512` → IC=+0.252 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.512 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.216 (n=1605)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6356 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2342` → IC=+0.248 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2342 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.5136` → IC=+0.239 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5136 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1673)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `2611.3002` → IC=+0.216 (n=1070)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2611.3002 (IC base=+0.209)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.207 (n=1220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` < `0.5207` → IC=+0.254 (n=1729)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5207 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` < `0.8766` → IC=+0.202 (n=1912)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8766 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.724` → IC=+0.264 (n=244)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2111` → IC=+0.192 (n=1361)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2111 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4358` → IC=+0.198 (n=1546)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4358 (IC base=+0.199)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.137 (n=2882)

- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.158 (n=2435)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0093 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.150 (n=2471)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5256` → IC=+0.159 (n=2767)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.5256 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.162 (n=1101)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.942` → IC=+0.211 (n=922)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.942 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1908` → IC=+0.158 (n=997)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1908 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4998` → IC=+0.141 (n=1641)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.4998 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.152` → IC=+0.183 (n=453)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 10.152 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.9026` → IC=+0.163 (n=1170)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4574` → IC=+0.156 (n=911)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4574 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8876` → IC=+0.162 (n=1822)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8876 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3669.584` → IC=+0.153 (n=1844)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3669.584 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.193 (n=725)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0038 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4865` → IC=+0.153 (n=2173)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4865 (IC base=+0.135)
...
- **PATRÓN** `ibs_20min` < `0.1841` → IC=+0.162 (n=957)
...
- **PATRÓN** `dist_vwap_pct` < `0.4318` → IC=+0.128 (n=2141)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.4318 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.212` → IC=+0.144 (n=2163)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.212 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.2467` → IC=+0.139 (n=2071)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.2467 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4255` → IC=+0.143 (n=716)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4255 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.8118` → IC=+0.141 (n=1432)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8118 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.137 (n=2882)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `6949.6369` → IC=+0.149 (n=1941)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 6949.6369 (IC base=+0.135)
...
- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.154 (n=713)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0084 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3946` → IC=+0.169 (n=627)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.1015` → IC=+0.153 (n=712)
...
- **PATRÓN** `dist_vwap_pct` < `0.3831` → IC=+0.143 (n=713)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.3831 (IC base=+0.140)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.34` → IC=+0.143 (n=648)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 4.34 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.6434` → IC=+0.167 (n=238)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6434 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.7259` → IC=+0.144 (n=636)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1931` → IC=+0.153 (n=615)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.1931 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.7743` → IC=+0.158 (n=466)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7743 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `7593.5796` → IC=+0.167 (n=712)
...
- **PATRÓN** `ibs_20min` > `0.9583` → IC=+0.217 (n=90)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9583 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.157` → IC=+0.211 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.157 (IC base=+0.087)
...
- **PATRÓN** `libro_liquidez` > `3405.6492` → IC=+0.146 (n=176)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 3405.6492 (IC base=+0.087)

- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.200 (n=88)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0119 (IC base=+0.097)

- **PATRÓN** `drift_60min` |x|≤ `0.3995` → IC=+0.141 (n=129)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3995 (IC base=+0.097)
...
- **PATRÓN** `ibs_20min` < `0.1538` → IC=+0.187 (n=65)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.1538 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.6223` → IC=+0.170 (n=95)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6223 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.061` → IC=+0.141 (n=37)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 9.061 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.1131` → IC=+0.150 (n=155)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.1131 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `3219.8531` → IC=+0.134 (n=192)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 3219.8531 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.150 (n=161)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 55.0 (IC base=+0.097)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.133 (n=789)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 8.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.557` → IC=+0.188 (n=755)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.557 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.1483` → IC=+0.164 (n=423)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1483 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.465` → IC=+0.216 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.465 (IC base=+0.099)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0983` → IC=+0.146 (n=566)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.0983 (IC base=+0.099)

- **PATRÓN** `volumen_spike_ratio` > `1.4005` → IC=+0.126 (n=643)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.4005 (IC base=+0.099)
...
- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.153 (n=332)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2432.8034 (IC base=+0.099)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.125 (n=118)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0061 (IC base=+0.074)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.135 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 13.0 (IC base=+0.074)

- **PATRÓN** `ibs_20min` > `0.6786` → IC=+0.174 (n=213)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.6786 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.1957` → IC=+0.150 (n=138)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1957 (IC base=+0.074)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0847` → IC=+0.173 (n=99)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0847 (IC base=+0.074)
...
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.127 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.0057 (IC base=+0.085)
...
- **PATRÓN** `ibs_20min` > `0.6522` → IC=+0.163 (n=238)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.6522 (IC base=+0.085)

- **PATRÓN** `dist_vwap_pct` > `0.47` → IC=+0.172 (n=56)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.47 (IC base=+0.085)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.179 (n=104)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 18.0 (IC base=+0.177)

- **PATRÓN** `ibs_20min` < `0.7619` → IC=+0.196 (n=44)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.7619 (IC base=+0.177)

- **PATRÓN** `dist_vwap_pct` > `0.6434` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6434 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.688` → IC=+0.221 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.688 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` < `0.7968` → IC=+0.265 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7968 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.1641` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1641 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` < `1.396` → IC=+0.389 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.396 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.179 (n=76)

  - _Acción_: Kelly boost +0.90€ cuando `libro_spread` < 0.06 (IC base=+0.177)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=1642)
...
- **PATRÓN** `liq_usd_total` > `80598.37` → IC=+0.182 (n=83)

  - _Acción_: Kelly boost +0.91€ cuando `liq_usd_total` > 80598.37 (IC base=+0.036)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.143 (n=82)

  - _Acción_: Kelly boost +0.71€ cuando `py_entrada` < 0.495 (IC base=+0.036)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=733)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=327)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7338)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.173 (n=3176)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=10103)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.171 (n=3420)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=10300)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.213 (n=563)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1728)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.173 (n=560)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1894)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.201 (n=579)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.108 (n=1757)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.206 (n=601)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1847)

- **FILTRO** `ibs_20min` > `0.283` → IC=-0.164 (n=611)

  - _Acción_: SKIP cuando `ibs_20min` > 0.283
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1837)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.176 (n=553)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1721)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.182 (n=605)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1841)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2673)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2831)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=9434)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=21166)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=7418)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=23182)

- **FILTRO** `ibs_7min` < `0.29` → IC=-0.235 (n=7648)

  - _Acción_: SKIP cuando `ibs_7min` < 0.29
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=22952)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10368)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=20232)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=9460)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=28701)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.180 (n=9511)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=28650)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.135 (n=1544)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3491)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1202)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3833)

- **FILTRO** `ibs_7min` < `0.7099` → IC=-0.251 (n=1660)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7099
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3375)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.183 (n=1171)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3864)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.261 (n=1632)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=4936)

- **FILTRO** `drift_7min_pct` |x|> `0.1119` → IC=-0.125 (n=2232)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1119
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4336)

- **FILTRO** `ibs_7min` > `0.7945` → IC=-0.208 (n=1640)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7945
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4928)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4065)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1272)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4030)

- **FILTRO** `ibs_7min` < `0.7498` → IC=-0.192 (n=1325)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7498
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3977)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.172 (n=1322)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3980)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.254 (n=1320)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=4015)

- **FILTRO** `ibs_7min` > `0.2595` → IC=-0.177 (n=1332)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2595
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=4003)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.188 (n=1326)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4009)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.169 (n=1352)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3415)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.309 (n=1163)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=3604)

- **FILTRO** `ibs_7min` < `0.1963` → IC=-0.259 (n=1191)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1963
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3576)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.215 (n=1123)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3644)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1624)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5382)

- **FILTRO** `ibs_7min` > `0.7539` → IC=-0.178 (n=1751)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7539
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5255)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.49` → IC=-0.166 (n=3209)

  - _Acción_: SKIP cuando `py_entrada` < 0.49
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1832)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.180 (n=1259)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3782)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.169 (n=1235)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3806)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.265 (n=1138)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3987)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.174 (n=1281)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3844)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.192 (n=1253)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3872)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.263 (n=1274)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4088)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1320)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4042)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1740)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=5511)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.252 (n=1625)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3468)

- **FILTRO** `ibs_7min` < `0.7024` → IC=-0.228 (n=1273)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7024
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3820)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1222)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3871)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1680)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5196)
...
- **PATRÓN** `streak_estiramiento` < `0.4159` → IC=+0.204 (n=79)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `streak_estiramiento` < 0.4159 (IC base=+0.036)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=702)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=2784)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1423)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1431)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0752` → IC=+0.200 (n=652)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2136` → IC=+0.194 (n=495)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `delta_ratio_macro` |x|> 0.2136 (IC base=+0.187)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1268` → IC=+0.233 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1268 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.197 (n=1382)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6079` → IC=+0.262 (n=1481)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6079 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` > `0.2942` → IC=+0.195 (n=532)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.2942 (IC base=+0.187)
...
- **PATRÓN** `libro_liquidez` > `2985.1852` → IC=+0.192 (n=987)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2985.1852 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.207 (n=801)
...
- **FILTRO** `dist_vwap_pct` > `0.7011` → IC=-0.150 (n=98)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=815)
...
- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.158 (n=443)
...
- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.336 (n=132)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 166.0 (IC base=+0.327)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.188 (n=830)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1670)

- **FILTRO** `libro_liquidez` < `3915.9217` → IC=-0.134 (n=1650)

  - _Acción_: SKIP cuando `libro_liquidez` < 3915.9217
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=850)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.220 (n=380)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1142)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.228 (n=380)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1142)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=966)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=556)

- **FILTRO** `sigma_ewma_delta_pct` > `19.716` → IC=-0.252 (n=272)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.716
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1250)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.987` → IC=-0.133 (n=311)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2523)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6079 sube el IC de +0.187 a +0.262 en UPDOWN_GBM#15min (n=1481). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.045 a +0.158 en UPDOWN_GBM#XRP#15min (n=443). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.039 a +0.275 en UPDOWN_GBM_15M_TARDIO (n=1570). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 24029 | -0.091 | -3085.89€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1422 | -0.046 | -216.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22607 | -0.093 | -2869.89€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3568 | -0.084 | -575.55€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3568 | -0.084 | -575.55€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1422 | -0.046 | -216.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1422 | -0.046 | -216.00€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6897 | -0.024 | -601.80€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6897 | -0.024 | -601.80€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6394 | -0.095 | -425.26€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6394 | -0.095 | -425.26€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5374 | -0.183 | -1106.23€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5374 | -0.183 | -1106.23€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 16659 | -0.030 | +4119.52€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4370 | -0.000 | +1836.97€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12289 | -0.041 | +2282.55€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 16659 | -0.030 | +4119.52€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4370 | -0.000 | +1836.97€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12289 | -0.041 | +2282.55€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1450 | -0.103 | -188.95€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 168 | -0.053 | -21.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1282 | -0.109 | -167.59€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 472 | -0.129 | -77.44€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 448 | -0.131 | -72.21€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 88162 | +0.113 | -4457.18€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13449 | +0.185 | -427.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 351 | -0.095 | -49.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 68556 | +0.100 | -3781.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 
81€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 926 | +0.004 | +16.92€ | 1 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 51 | -0.104 | +0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 3978 | +0.039 | +229.48€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 495 | +0.140 | +182.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 25 | -0.018 | -1.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 3458 | +0.025 | +48.55€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 7228 | +0.018 | +287.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 2400 | +0.044 | +265.26€ | 0 | 11 |
| ✅ UPDOWN_GBM#ETH#240min | 334 | +0.006 | +7.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#5min | 3748 | +0.007 | +10.83€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 703 | +0.008 | +0.60€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#daily | 43 | -0.144 | +3.56€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 8237 | +0.016 | +211.35€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 2295 | +0.023 | +151.67€ | 0 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 328 | -0.006 | -3.12€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5146 | +0.014 | +56.85€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 431 | +0.022 | +8.64€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 37 | -0.167 | -2.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 4955 | +0.035 | +523.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2295 | +0.078 | +554.55€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 205 | -0.002 | -2.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2455 | -0.001 | -28.28€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 229 | +0.327 | +68.16€ | 0 | 13 |
| ✅ UPDOWN_GBM_15M_TARDIO | 11130 | -0.044 | +2268.76€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11130 | -0.044 | +2268.76€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 657 | -0.048 | +325.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 657 | -0.048 | +325.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2088 | -0.124 | +24.15€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2088 | -0.124 | +24.15€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 305 | +0.165 | +183.46€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 305 | +0.165 | +183.46€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1224 | +0.201 | +701.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1224 | +0.201 | +701.69€ | 2 | 21 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3419 | -0.065 | +517.26€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3419 | -0.065 | +517.26€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3437 | -0.079 | +516.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3437 | -0.079 | +516.47€ | 2 | 4 |
...
**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  ...
  - _Estado_: 518 celda(s) pasan gate riguroso completo de 2173 evaluadas (n>=40) y 3178 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.023 < 0.08 — monitorear
  - _Datos_: n=2292 IC=+0.023 PNL=+148.14€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.091 n=262/60 | contraria IC=+0.150 n=258 | gap=-0.059 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=703/40 IC=+0.008 PNL=+0.60€ | BTC#60min: n=924/40 IC=+0.004 PNL=+15.61€ | SOL#60min: n=431/40 IC=+0.022 PNL=+8.64€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.051 n=314840 | tras_1loss IC=+0.076 n=245117 | tras_2loss IC=+0.045 n=103778/40 | gap=+0.006 (umbral 0.05)
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.213 > 0.08 con n=354 PNL=+248.61€
  - _Datos_: n=354 IC=+0.213 PNL=+248.61€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1482 IC=+0.018 PNL=+15.88€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1482 IC=+0.018 PNL=+15.88€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.187 > 0.1 con n=1969 PNL=+1236.22€
  - _Datos_: n=1969 IC=+0.187 PNL=+1236.22€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1161 IC=+0.080 PNL=+250.11€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1161 IC=+0.080 PNL=+250.11€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=11770 IC=+0.057 PNL=+1480.72€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=11770 IC=+0.057 PNL=+1480.72€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1760 IC=+0.045 PNL=+182.18€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1760 IC=+0.045 PNL=+182.18€
...
**🟡 H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.127 > 0.1 con n=365 PNL=+103.58€
  - _Datos_: n=365 IC=+0.127 PNL=+103.58€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=16696 IC=-0.137 PNL=+1129.40€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=16696 IC=-0.137 PNL=+1129.40€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1813 IC=+0.137 PNL=+970.97€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1813 IC=+0.137 PNL=+970.97€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.238 < -0.1 con n=1641 PNL=-176.39€
  - _Datos_: n=1641 IC=-0.238 PNL=-176.39€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.089 n=922) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=922 IC=+0.089 PNL=+210.37€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8310 IC=+0.176 PNL=-963.49€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8310 IC=+0.176 PNL=-963.49€
...
**🟡 H-CUSTOM-GBMLATE15M-SOL-RESCATE-PRECIO** — GBM_LATE_15M#SOL#15min#BUY_YES (pausada 05-Ago) -- posible rescate con filtro py en [0.45,0.55)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.197 > 0.1 con n=130 PNL=+75.57€
  - _Datos_: n=130 IC=+0.197 PNL=+75.57€
