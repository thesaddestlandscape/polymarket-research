# Hipótesis automáticas — 2026-09-24 15:07 UTC
_Generado por shadow_postmortem.py sobre 590697 resoluciones (PNL=+66172.55€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.98` → IC=-0.234 (n=7027)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.98
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=21090)
...
- **FILTRO** `restante_s_al_confirmar` < `165.02` → IC=-0.226 (n=1685)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.02
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5055)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.203 (n=13779)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=3469)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5625.8819` → IC=+0.177 (n=2208)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=2109)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `15975.8246` → IC=+0.242 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15975.8246 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1510)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.200)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1678)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=2144)
...
- **PATRÓN** `libro_liquidez` > `1302.9991` → IC=+0.149 (n=653)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1302.9991 (IC base=+0.138)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=1077)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.252 (n=825)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.247)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.247 (n=832)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.184 (n=2720)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.185 (n=2603)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=2411)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.239)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.320 (n=855)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.174 (n=6163)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 7.0 (IC base=+0.172)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=6156)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.209 (n=5603)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.194 (n=5668)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `lag_apertura_s` < `3.41` → IC=+0.143 (n=2363)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 3.41 (IC base=+0.123)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.190 (n=2555)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.38 (IC base=+0.114)

- **PATRÓN** `restante_min` < `4.19` → IC=+0.127 (n=2397)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.19 (IC base=+0.114)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.135 (n=2602)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 4.96 (IC base=+0.114)

- **PATRÓN** `lag_apertura_s` < `2.29` → IC=+0.139 (n=2392)

  - _Acción_: Kelly boost +0.69€ cuando `lag_apertura_s` < 2.29 (IC base=+0.114)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.322 (n=775)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.291)

- **PATRÓN** `py_entrada` > `0.815` → IC=+0.381 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `4093.3151` → IC=+0.312 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4093.3151 (IC base=+0.291)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.303 (n=339)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4254.8679` → IC=+0.301 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4254.8679 (IC base=+0.278)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.333 (n=370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1466.3152` → IC=+0.309 (n=470)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.442 (n=429)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.436)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.440 (n=430)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` < `0.6336` → IC=+0.249 (n=2255)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6336 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.346` → IC=+0.186 (n=2120)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 8.346 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2119` → IC=+0.247 (n=2155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2119 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0495` → IC=+0.258 (n=977)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0495 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.3047` → IC=+0.218 (n=800)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3047 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.9074` → IC=+0.206 (n=3646)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9074 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.5694` → IC=+0.134 (n=9642)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.5694 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.6159` → IC=+0.195 (n=702)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.6159 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.1531` → IC=+0.174 (n=3065)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1531 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` < `0.6989` → IC=+0.181 (n=1485)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6989 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `0.8704` → IC=+0.175 (n=2249)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8704 (IC base=+0.065)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5708` → IC=+0.201 (n=5065)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5708 (IC base=+0.065)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.211 (n=5455)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.269 (n=702)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4344` → IC=+0.163 (n=1691)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4344 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.248 (n=1217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.241 (n=1230)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.234)

- **PATRÓN** `ibs_20min` < `0.0531` → IC=+0.294 (n=599)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.428` → IC=+0.246 (n=1412)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.428 (IC base=+0.234)

- **PATRÓN** `volumen_pendiente_norm` < `0.0923` → IC=+0.230 (n=1166)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6222` → IC=+0.240 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6222 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1801.6295` → IC=+0.234 (n=907)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0842` → IC=+0.255 (n=459)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0842 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.233 (n=1442)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` > `0.9886` → IC=+0.270 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9886 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` > `0.2018` → IC=+0.221 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2018 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.741` → IC=+0.220 (n=1528)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.741 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.827` → IC=+0.255 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.827 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` < `1.2558` → IC=+0.219 (n=1376)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2558 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `0.8736` → IC=+0.225 (n=917)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7475` → IC=+0.218 (n=899)
...
- **PATRÓN** `libro_liquidez` > `16033.3314` → IC=+0.225 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16033.3314 (IC base=+0.217)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.262` → IC=+0.160 (n=230)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.262 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.261` → IC=+0.141 (n=1306)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.261 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.2085` → IC=+0.149 (n=1435)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2114` → IC=+0.189 (n=1768)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8344` → IC=+0.205 (n=763)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5998` → IC=+0.214 (n=1523)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.7726` → IC=+0.204 (n=613)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.153 (n=99)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=2206)
...
- **PATRÓN** `dist_vwap_pct` > `0.1965` → IC=+0.181 (n=337)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1965 (IC base=+0.018)

- **PATRÓN** `volumen_regimen` < `0.8504` → IC=+0.163 (n=553)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8504 (IC base=+0.018)
...
- **PATRÓN** `volumen_spike_ratio` > `1.518` → IC=+0.176 (n=693)
...
- **FILTRO** `ibs_20min` > `0.2561` → IC=-0.125 (n=2172)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2561
  - _Potencial_: sin este filtro IC_bueno=+0.128 (n=1071)

- **FILTRO** `sigma_ewma_delta_pct` > `8.672` → IC=-0.211 (n=347)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.672
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2896)
...
- **PATRÓN** `ibs_20min` < `0.2561` → IC=+0.128 (n=1071)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.2561 (IC base=-0.041)

- **PATRÓN** `dist_vwap_pct` > `0.6927` → IC=+0.258 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6927 (IC base=-0.041)
...
- **FILTRO** `drift_60min` |x|> `0.6622` → IC=-0.184 (n=561)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6622
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1687)

- **FILTRO** `ibs_20min` < `0.7105` → IC=-0.155 (n=1483)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7105
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=765)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.202 (n=410)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1838)
...
- **PATRÓN** `volumen_regimen` > `1.092` → IC=+0.280 (n=343)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3196` → IC=+0.256 (n=1757)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3196 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.262 (n=3760)
...
- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.266 (n=690)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.269 (n=171)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1457` → IC=+0.196 (n=396)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1042` → IC=+0.258 (n=1340)
...
- **PATRÓN** `libro_liquidez` > `1958.275` → IC=+0.253 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1958.275 (IC base=+0.245)
...
- **FILTRO** `ibs_20min` < `0.2846` → IC=-0.186 (n=489)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2846
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1469)
...
- **PATRÓN** `ibs_20min` > `0.9105` → IC=+0.179 (n=490)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.9105 (IC base=+0.011)

- **PATRÓN** `dist_vwap_pct` > `0.4545` → IC=+0.224 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4545 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` < `0.9898` → IC=+0.233 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9898 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` > `0.5875` → IC=+0.209 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5875 (IC base=+0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.1655` → IC=+0.256 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1655 (IC base=+0.011)
...
- **PATRÓN** `dist_vwap_pct` < `0.6852` → IC=+0.202 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6852 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.210 (n=422)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1518` → IC=+0.241 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1518 (IC base=-0.005)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.250 (n=386)
...
- **FILTRO** `ibs_20min` < `0.72` → IC=-0.200 (n=1064)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.280 (n=1064)

- **FILTRO** `ibs_20min` > `0.6857` → IC=-0.228 (n=553)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.705` → IC=-0.179 (n=484)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=1729)

- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.280 (n=1064)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.72 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` > `0.8477` → IC=+0.332 (n=242)
...
- **PATRÓN** `volumen_regimen` < `0.8758` → IC=+0.301 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8758 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `0.7306` → IC=+0.293 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7306 (IC base=+0.040)

- **PATRÓN** `volumen_pendiente_norm` < `0.1024` → IC=+0.291 (n=727)
...
- **PATRÓN** `volumen_spike_ratio` < `1.422` → IC=+0.324 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.422 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.312 (n=657)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0975` → IC=+0.209 (n=517)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4844` → IC=+0.220 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4844 (IC base=+0.015)

- **PATRÓN** `volumen_spike_ratio` > `1.5706` → IC=+0.201 (n=466)
...
- **PATRÓN** `ibs_20min` > `0.6319` → IC=+0.311 (n=1299)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6319 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.2054` → IC=+0.317 (n=768)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2054 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.574` → IC=+0.300 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.574 (IC base=+0.277)

- **PATRÓN** `volumen_regimen` > `0.8622` → IC=+0.302 (n=866)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.170 (n=2607)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.201 (n=2607)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.187 (n=2605)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=8138)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5775` → IC=+0.217 (n=7814)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5775 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.176` → IC=+0.196 (n=3397)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.176 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.35` → IC=+0.254 (n=1600)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.35 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2136` → IC=+0.160 (n=5170)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2136 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6297` → IC=+0.161 (n=5170)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6297 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2448` → IC=+0.192 (n=1581)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2448 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5596` → IC=+0.170 (n=3297)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5596 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6221` → IC=+0.176 (n=2498)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6221 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2401.9008` → IC=+0.169 (n=5209)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2401.9008 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.180 (n=6736)
...
- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.227 (n=7476)
...
- **PATRÓN** `volumen_regimen` < `1.1756` → IC=+0.151 (n=5420)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5615` → IC=+0.167 (n=2991)
...
- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.172 (n=6439)
...
- **PATRÓN** `ibs_20min` > `0.8969` → IC=+0.276 (n=889)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2301` → IC=+0.232 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2301 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.179 (n=1233)
...
- **PATRÓN** `volumen_regimen` < `1.2679` → IC=+0.164 (n=1163)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2679 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0768` → IC=+0.169 (n=527)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0768 (IC base=+0.162)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5005` → IC=+0.183 (n=497)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.5005 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `15957.2347` → IC=+0.165 (n=527)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 15957.2347 (IC base=+0.162)
...
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.218 (n=438)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.198)

- **PATRÓN** `drift_60min` |x|≤ `0.2296` → IC=+0.214 (n=875)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2296 (IC base=+0.198)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.863` → IC=+0.277 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.863 (IC base=+0.198)

- **PATRÓN** `volumen_pendiente_norm` > `0.1319` → IC=+0.198 (n=511)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1319 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` < `1.6328` → IC=+0.199 (n=416)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6328 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `2.8468` → IC=+0.211 (n=565)
...
- **PATRÓN** `libro_liquidez` > `1958.7575` → IC=+0.202 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1958.7575 (IC base=+0.198)
...
- **PATRÓN** `libro_liquidez` > `6488.9388` → IC=+0.184 (n=833)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6488.9388 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.146 (n=1187)
...
- **PATRÓN** `ibs_20min` > `0.5167` → IC=+0.203 (n=1410)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.733` → IC=+0.251 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.733 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.129 (n=1412)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2233 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.6434` → IC=+0.122 (n=1410)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6434 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.071` → IC=+0.123 (n=592)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.071 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.5459` → IC=+0.141 (n=599)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.5459 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1476)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `2892.276` → IC=+0.199 (n=639)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2892.276 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.136 (n=1086)
...
- **PATRÓN** `sigma_h` > `0.0223` → IC=+0.206 (n=634)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.4379` → IC=+0.246 (n=1395)
...
- **PATRÓN** `dist_vwap_pct` < `0.9141` → IC=+0.203 (n=1632)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9141 (IC base=+0.203)
...
- **PATRÓN** `volumen_regimen` > `0.6295` → IC=+0.215 (n=1395)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2138` → IC=+0.194 (n=1102)
...
- **PATRÓN** `libro_liquidez` > `2591.9144` → IC=+0.207 (n=930)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.179 (n=621)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0089 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.0997` → IC=+0.153 (n=620)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3918` → IC=+0.180 (n=1859)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.3918 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.3941` → IC=+0.182 (n=554)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.3941 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.719` → IC=+0.175 (n=851)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.719 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8754` → IC=+0.163 (n=1089)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8754 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.2111` → IC=+0.154 (n=544)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2111 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1652` → IC=+0.173 (n=515)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1652 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4385` → IC=+0.168 (n=597)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4385 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5431` → IC=+0.154 (n=597)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.5431 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.151 (n=2110)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12404.1481` → IC=+0.161 (n=620)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12404.1481 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.166 (n=1639)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 162.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.137 (n=1306)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0057 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1972)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` < `0.5143` → IC=+0.147 (n=1717)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.5143 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` < `0.2132` → IC=+0.122 (n=1739)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2132 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` < `2.2258` → IC=+0.124 (n=1652)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.2258 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2736.3413` → IC=+0.122 (n=1743)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3457` → IC=+0.125 (n=467)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3457 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.151 (n=439)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 8.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2517` → IC=+0.144 (n=467)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.2517 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3087` → IC=+0.163 (n=161)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.3087 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6182` → IC=+0.152 (n=156)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6182 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `14977.1636` → IC=+0.142 (n=311)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 14977.1636 (IC base=+0.104)
...
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.184 (n=188)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.009 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.5315` → IC=+0.134 (n=413)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.5315 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=385)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` > `0.7317` → IC=+0.203 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7317 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` > `0.6447` → IC=+0.211 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6447 (IC base=+0.130)
...
- **PATRÓN** `volumen_regimen` < `1.0712` → IC=+0.150 (n=364)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.0712 (IC base=+0.130)

- **PATRÓN** `volumen_pendiente_norm` > `0.1866` → IC=+0.169 (n=119)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1866 (IC base=+0.130)

- **PATRÓN** `volumen_spike_ratio` > `2.2136` → IC=+0.169 (n=179)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.2136 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=449)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.130)

- **PATRÓN** `libro_liquidez` > `3074.7539` → IC=+0.200 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3074.7539 (IC base=+0.130)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.207 (n=3329)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=10411)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.216 (n=9990)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.9721` → IC=+0.205 (n=1391)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9721 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.633` → IC=+0.226 (n=4832)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.633 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8818` → IC=+0.164 (n=4449)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8818 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2401` → IC=+0.199 (n=1864)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2401 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.601` → IC=+0.187 (n=3198)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.601 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2342.9304` → IC=+0.172 (n=6655)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.9304 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.194 (n=7600)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 87.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.191 (n=6048)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.007 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1485` → IC=+0.189 (n=3988)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `2.632` → IC=+0.192 (n=2770)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.632 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.192 (n=5342)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.225 (n=565)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.3602` → IC=+0.191 (n=1696)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.324 (n=610)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.261 (n=1187)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.257)

- **PATRÓN** `drift_60min` |x|≤ `0.1282` → IC=+0.283 (n=583)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1282 (IC base=+0.257)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.267 (n=1196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.257)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.258 (n=1216)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.257)

- **PATRÓN** `ibs_20min` < `0.3478` → IC=+0.289 (n=1166)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3478 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.537` → IC=+0.262 (n=1328)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.537 (IC base=+0.257)
...
- **PATRÓN** `libro_liquidez` > `1800.66` → IC=+0.262 (n=883)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1800.66 (IC base=+0.257)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0846` → IC=+0.162 (n=533)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0846 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1671)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3102` → IC=+0.204 (n=1599)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3102 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.3442` → IC=+0.197 (n=644)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.242` → IC=+0.154 (n=1435)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.242 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.629` → IC=+0.180 (n=533)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.274` → IC=+0.151 (n=1253)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.274 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.1967` → IC=+0.162 (n=1384)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1967 (IC base=+0.151)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.160 (n=1285)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2117` → IC=+0.221 (n=1595)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2117 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.8376` → IC=+0.240 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8376 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=1166)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0116` → IC=+0.238 (n=1508)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0116 (IC base=+0.232)

- **PATRÓN** `drift_60min` |x|≤ `0.453` → IC=+0.234 (n=1327)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.453 (IC base=+0.232)
...
- **PATRÓN** `ibs_20min` < `0.3594` → IC=+0.269 (n=1327)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7564` → IC=+0.232 (n=610)
...
- **PATRÓN** `libro_liquidez` > `1883.375` → IC=+0.243 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1883.375 (IC base=+0.232)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.230 (n=1307)
...
- **PATRÓN** `volumen_regimen` < `0.8764` → IC=+0.155 (n=1133)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8764 (IC base=+0.137)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4486` → IC=+0.154 (n=1390)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7027` → IC=+0.184 (n=1390)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.7027 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.6029` → IC=+0.144 (n=1543)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.6029 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.146` → IC=+0.181 (n=205)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 11.146 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.6962` → IC=+0.150 (n=612)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6962 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.1938` → IC=+0.145 (n=463)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.1938 (IC base=+0.138)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4426` → IC=+0.152 (n=1317)
...
- **PATRÓN** `volumen_regimen` < `0.8936` → IC=+0.133 (n=1126)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8936 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1698)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.249 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.129 (n=1298)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1704)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.204 (n=1649)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.486` → IC=+0.124 (n=1595)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.486 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.152 (n=726)
...
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.219 (n=1125)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1758)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.208)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.209 (n=1515)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.249 (n=1690)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` > `0.2021` → IC=+0.234 (n=993)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2021 (IC base=+0.208)
...
- **PATRÓN** `volumen_regimen` < `1.0716` → IC=+0.211 (n=1486)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0716 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `0.6386` → IC=+0.215 (n=1688)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5104` → IC=+0.238 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5104 (IC base=+0.208)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1778)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `2625.644` → IC=+0.221 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.644 (IC base=+0.208)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.208 (n=1271)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.255 (n=1807)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5172 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.245` → IC=+0.202 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.245 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.9212` → IC=+0.203 (n=2017)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9212 (IC base=+0.200)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2023` → IC=+0.195 (n=1429)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2023 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4316` → IC=+0.195 (n=1623)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=3014)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.157 (n=2529)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0092 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.150 (n=2569)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5223` → IC=+0.159 (n=2873)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.942` → IC=+0.209 (n=958)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.942 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1868` → IC=+0.157 (n=1046)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1868 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4917` → IC=+0.143 (n=1758)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.4917 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.187` → IC=+0.174 (n=471)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 10.187 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.9007` → IC=+0.158 (n=1241)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.9007 (IC base=+0.150)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8851` → IC=+0.161 (n=1892)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8851 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3758.6743` → IC=+0.150 (n=1915)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3758.6743 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.196 (n=760)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0038 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.161 (n=2000)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.3831 (IC base=+0.137)
...
- **PATRÓN** `dist_vwap_pct` < `0.431` → IC=+0.130 (n=2258)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.431 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.273` → IC=+0.147 (n=2263)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0972` → IC=+0.139 (n=2056)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.153 (n=797)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0073 (IC base=+0.151)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.161 (n=906)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0043 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3873` → IC=+0.154 (n=796)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3873 (IC base=+0.151)
...
- **PATRÓN** `ibs_20min` < `0.5623` → IC=+0.157 (n=604)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.5623 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.8888` → IC=+0.165 (n=302)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.8888 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.9678` → IC=+0.160 (n=201)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.9678 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.4256` → IC=+0.162 (n=851)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.4256 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.678` → IC=+0.161 (n=906)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.678 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.0856` → IC=+0.154 (n=796)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.0856 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `0.7181` → IC=+0.155 (n=809)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7181 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` < `0.1098` → IC=+0.153 (n=835)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.1098 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.0795` → IC=+0.158 (n=390)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0795 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `1.4364` → IC=+0.168 (n=296)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4364 (IC base=+0.151)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.156 (n=894)
...
- **PATRÓN** `ibs_20min` < `0.7363` → IC=+0.144 (n=770)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.7363 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.0998` → IC=+0.148 (n=770)
...
- **PATRÓN** `dist_vwap_pct` < `0.3872` → IC=+0.139 (n=790)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.3872 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.376` → IC=+0.147 (n=698)
...
- **PATRÓN** `volumen_regimen` > `0.7259` → IC=+0.141 (n=688)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7829` → IC=+0.145 (n=503)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7829 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `7577.2758` → IC=+0.166 (n=770)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.129 (n=846)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1542` → IC=+0.159 (n=441)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1542 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.442` → IC=+0.206 (n=192)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2818` → IC=+0.194 (n=106)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2818 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.0912` → IC=+0.136 (n=622)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.0912 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.120 (n=659)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.02 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2424.4386` → IC=+0.142 (n=361)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.161 (n=311)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.006 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.124 (n=325)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.5161` → IC=+0.188 (n=280)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5161 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1366` → IC=+0.182 (n=146)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1366 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.067` → IC=+0.127 (n=247)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.067 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` < `0.0678` → IC=+0.136 (n=215)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` < 0.0678 (IC base=+0.106)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0118` → IC=+0.173 (n=212)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=1757)
...
- **PATRÓN** `liq_usd_total` > `73884.56` → IC=+0.163 (n=93)

  - _Acción_: Kelly boost +0.82€ cuando `liq_usd_total` > 73884.56 (IC base=+0.029)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.159 (n=89)

  - _Acción_: Kelly boost +0.80€ cuando `py_entrada` < 0.495 (IC base=+0.029)

### LIQUIDACIONES_5M#ETH#5min
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=776)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.178 (n=234)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=272)

- **FILTRO** `restante_min` < `3.45` → IC=-0.143 (n=124)

  - _Acción_: SKIP cuando `restante_min` < 3.45
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=382)

- **FILTRO** `hora_utc` < `12.0` → IC=-0.130 (n=252)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=254)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.182 (n=20)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 16.0 (IC base=+0.051)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.232 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.59 (IC base=+0.134)

- **PATRÓN** `restante_min` > `3.98` → IC=+0.167 (n=34)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` > 3.98 (IC base=+0.134)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=27)

- **FILTRO** `profundidad_ratio` < `39.2` → IC=-0.196 (n=21)
...
- **FILTRO** `profundidad_ratio` < `26.3` → IC=-0.222 (n=16)

  - _Acción_: SKIP cuando `profundidad_ratio` < 26.3
  - _Potencial_: sin este filtro IC_bueno=+0.129 (n=33)

- **PATRÓN** `profundidad_ratio` > `26.3` → IC=+0.129 (n=33)

  - _Acción_: Kelly boost +0.64€ cuando `profundidad_ratio` > 26.3 (IC base=+0.010)
...
- **FILTRO** `py_entrada` > `0.54` → IC=-0.182 (n=20)

  - _Acción_: SKIP cuando `py_entrada` > 0.54
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=23)

### LIQUIDACIONES_DEPTH_FASE0#XRP#15min
- **FILTRO** `hora_utc` < `12.0` → IC=-0.210 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=31)

- **FILTRO** `profundidad_ratio` < `22.6` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `profundidad_ratio` < 22.6
...
- **FILTRO** `profundidad_ratio` < `26.8` → IC=-0.167 (n=52)
...
- **FILTRO** `lag_apertura_s` > `68.38` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `lag_apertura_s` > 68.38
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=28)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7492)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.165 (n=3497)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10537)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.167 (n=3623)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=10908)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.152 (n=641)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1961)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.189 (n=612)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1866)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=635)
...
- **FILTRO** `py_entrada` < `0.485` → IC=-0.172 (n=599)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1822)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.175 (n=635)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1967)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2752)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2940)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9940)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=22208)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7849)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=24299)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.235 (n=8031)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=24117)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=10921)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21227)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9899)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=30413)

- **FILTRO** `ibs_7min` > `0.2927` → IC=-0.178 (n=10076)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2927
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=30236)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.135 (n=1628)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3691)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1269)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4050)

- **FILTRO** `ibs_7min` < `0.7111` → IC=-0.249 (n=1754)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7111
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3565)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.185 (n=1222)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=4097)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.260 (n=1710)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5211)

- **FILTRO** `drift_7min_pct` |x|> `0.1122` → IC=-0.125 (n=2352)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1122
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4569)

- **FILTRO** `ibs_7min` > `0.789` → IC=-0.205 (n=1730)

  - _Acción_: SKIP cuando `ibs_7min` > 0.789
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=5191)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=4252)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1338)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4213)

- **FILTRO** `ibs_7min` < `0.7478` → IC=-0.193 (n=1387)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7478
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=4164)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.175 (n=1382)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4169)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1406)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4229)

- **FILTRO** `ibs_7min` > `0.2601` → IC=-0.176 (n=1408)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2601
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4227)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.181 (n=1407)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4228)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1430)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=3616)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1238)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3808)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.259 (n=1257)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3789)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1170)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3876)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.236 (n=1693)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5716)

- **FILTRO** `ibs_7min` > `0.7456` → IC=-0.175 (n=1851)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7456
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5558)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1705)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3595)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.231 (n=1567)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3733)

- **FILTRO** `ibs_7min` < `0.741` → IC=-0.180 (n=1325)

  - _Acción_: SKIP cuando `ibs_7min` < 0.741
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3975)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.170 (n=1305)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3995)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.264 (n=1200)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=4214)

- **FILTRO** `ibs_7min` > `0.2747` → IC=-0.176 (n=1353)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2747
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4061)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1344)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4070)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.257 (n=1361)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4246)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.239 (n=1396)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4211)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1828)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=5838)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1716)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3609)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.228 (n=1318)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4007)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1295)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4030)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.205 (n=1739)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5528)
...
- **FILTRO** `sigma_h` > `0.0073` → IC=-0.378 (n=39)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=786)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2893)
...
- **PATRÓN** `ibs_15` < `0.1163` → IC=+0.159 (n=470)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.79€ cuando `ibs_15` < 0.1163 (IC base=+0.048)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.218 (n=653)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1961)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.190 (n=883)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1731)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.223 (n=398)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=1196)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.230 (n=398)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1196)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.210 (n=1009)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.843` → IC=-0.248 (n=288)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1306)
...
- **PATRÓN** `dist_vwap_pct` > `0.4921` → IC=+0.206 (n=90)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4921 (IC base=-0.041)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1163 sube el IC de +0.048 a +0.159 en UPDOWN_GBM#XRP#15min (n=470). Ya aplicado como kelly_boost=+0.79€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.034 a +0.277 en UPDOWN_GBM_15M_TARDIO (n=1732). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO