# Hipótesis automáticas — 2026-07-01 23:34 UTC
_Generado por shadow_postmortem.py sobre 2481 resoluciones (PNL=-80.82€)_
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.250 (n=50)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.092)

- **PATRÓN** `drift_60min` |x|≤ `0.4305` → IC=+0.122 (n=43)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4305 (IC base=+0.092)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.125 (n=22)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 19.0 (IC base=+0.092)

- **PATRÓN** `ibs_15` < `0.1194` → IC=+0.227 (n=42)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1194 (IC base=+0.092)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.1194 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.227 n=42). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 733 | -0.035 | -29.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 515 | -0.009 | -3.75€ | 1 | 4 |
...
| ✅ UPDOWN_GBM#ETH | 298 | -0.010 | +3.40€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#SOL | 124 | -0.079 | -7.29€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 72 | -0.054 | -3.04€ | 4 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.132) — sin ventaja clara. oversold(IBS<0.3): IC=+0.032 n=107 | neutral: IC=-0.100 n=98 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=343 IC=-0.028 PNL=-4.47€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=72 IC=-0.054 PNL=-3.04€
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=-0.000 n=1167 | tras_1loss IC=-0.034 n=1232 | tras_2loss IC=-0.049 n=641/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=610 IC=-0.028 PNL=-16.15€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=610 IC=-0.028 PNL=-16.15€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=219 IC=+0.020 PNL=-3.56€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=219 IC=+0.020 PNL=-3.56€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=132 IC=+0.060 PNL=+24.11€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=132 IC=+0.060 PNL=+24.11€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 64/200 ops en el filtro definido (IC actual=+0.076 PNL=+12.10€)
  - _Datos_: n=64 IC=+0.076 PNL=+12.10€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 64/100 ops en el filtro definido (IC actual=+0.076 PNL=+12.10€)
  - _Datos_: n=64 IC=+0.076 PNL=+12.10€
