# Hipótesis automáticas — 2026-09-25 00:31 UTC
_Generado por shadow_postmortem.py sobre 596649 resoluciones (PNL=+67246.70€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.04` → IC=-0.232 (n=7073)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.04
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=21222)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `138.32` → IC=-0.250 (n=926)
...
- **FILTRO** `restante_s_al_confirmar` < `499.92` → IC=-0.150 (n=364)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1094)
...
- **FILTRO** `restante_s_al_confirmar` < `165.09` → IC=-0.221 (n=1705)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.09
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=5118)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `126.3` → IC=-0.356 (n=1391)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 126.3
  - _Potencial_: sin este filtro IC_bueno=-0.119 (n=4175)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.204 (n=13860)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=3493)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5639.5091` → IC=+0.178 (n=2225)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.136 (n=13797)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.127)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=10900)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=5663)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7817.4436` → IC=+0.174 (n=2139)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7817.4436 (IC base=+0.127)
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.352 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=2126)
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.170 (n=325)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.337 (n=962)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.235 (n=1486)
...
- **PATRÓN** `py_entrada` > `0.665` → IC=+0.241 (n=245)
...
- **PATRÓN** `libro_liquidez` > `1311.0387` → IC=+0.151 (n=657)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.200 (n=10980)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.226 (n=3803)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.174 (n=2641)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.182 (n=1945)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.246 (n=841)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.185 (n=2613)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 17.0 (IC base=+0.180)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.185 (n=2251)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.194 (n=2556)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 17.0 (IC base=+0.192)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.195 (n=1970)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.236 (n=15260)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.181 (n=4720)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 12.0 (IC base=+0.176)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=6378)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.266 (n=2108)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.256 (n=2280)
...
- **PATRÓN** `restante_min` > `4.96` → IC=+0.134 (n=2634)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` > 4.96 (IC base=+0.113)

- **PATRÓN** `lag_apertura_s` < `2.29` → IC=+0.138 (n=2423)
...
- **PATRÓN** `libro_liquidez` > `4098.7742` → IC=+0.309 (n=369)
...
- **PATRÓN** `libro_liquidez` > `4262.2927` → IC=+0.297 (n=328)
...
- **PATRÓN** `libro_liquidez` > `1466.3152` → IC=+0.311 (n=474)
...
- **PATRÓN** `py_entrada` < `0.935` → IC=+0.440 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.935 (IC base=+0.437)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.448 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.437)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.438 (n=577)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.437)

- **PATRÓN** `libro_liquidez` > `2546.95` → IC=+0.436 (n=324)
...
- **PATRÓN** `py_entrada` > `0.735` → IC=+0.314 (n=499)
...
- **PATRÓN** `libro_liquidez` > `1367.7996` → IC=+0.289 (n=368)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4858` → IC=+0.122 (n=8085)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4858 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9831` → IC=+0.243 (n=2696)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9831 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.85` → IC=+0.251 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.85 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.3998` → IC=+0.250 (n=2011)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3998 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.344` → IC=+0.186 (n=2139)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 8.344 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2099` → IC=+0.247 (n=2189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2099 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0456` → IC=+0.257 (n=993)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0456 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.304` → IC=+0.218 (n=808)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.304 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.9062` → IC=+0.206 (n=3694)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9062 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.134 (n=9746)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.57 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` > `0.6181` → IC=+0.198 (n=724)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.6181 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` < `0.697` → IC=+0.183 (n=1502)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.697 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `1.0526` → IC=+0.177 (n=1547)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0526 (IC base=+0.066)

- **PATRÓN** `volumen_pendiente_norm` > `0.1673` → IC=+0.226 (n=1627)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1673 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.5695` → IC=+0.202 (n=5132)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5695 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.212 (n=5531)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3528` → IC=+0.166 (n=1825)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.164 (n=1707)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.448` → IC=+0.247 (n=1431)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2765` → IC=+0.262 (n=183)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.228 (n=933)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.216)

- **PATRÓN** `drift_60min` |x|≤ `0.0853` → IC=+0.249 (n=465)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.216 (n=1413)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.9871` → IC=+0.269 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9871 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` > `0.2074` → IC=+0.218 (n=749)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2074 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `0.5806` → IC=+0.220 (n=1460)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5806 (IC base=+0.216)
...
- **PATRÓN** `ibs_20min` < `0.6944` → IC=+0.172 (n=1450)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6944 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.531` → IC=+0.140 (n=326)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.531 (IC base=+0.140)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.254` → IC=+0.158 (n=232)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.254 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.282` → IC=+0.143 (n=1320)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.282 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2035` → IC=+0.150 (n=1450)
...
- **PATRÓN** `volumen_spike_ratio` > `1.415` → IC=+0.149 (n=1339)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.190 (n=1793)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=1597)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.199` → IC=+0.250 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.199 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` < `0.2104` → IC=+0.188 (n=1795)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2104 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.3587` → IC=+0.198 (n=236)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.3587 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.8308` → IC=+0.204 (n=773)
...
- **PATRÓN** `sigma_h` < `0.0116` → IC=+0.220 (n=1540)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0116 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.6053` → IC=+0.215 (n=1540)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0637` → IC=+0.247 (n=678)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.57` → IC=+0.212 (n=1670)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.57 (IC base=+0.212)

- **PATRÓN** `volumen_pendiente_norm` > `0.3558` → IC=+0.268 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3558 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` < `1.7716` → IC=+0.203 (n=621)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7716 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.2024` → IC=+0.221 (n=940)
...
- **PATRÓN** `libro_liquidez` > `1889.461` → IC=+0.225 (n=699)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.157 (n=100)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=2221)
...
- **PATRÓN** `dist_vwap_pct` > `0.1425` → IC=+0.188 (n=376)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1425 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `0.8475` → IC=+0.167 (n=559)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.177 (n=701)
...
- **FILTRO** `ibs_20min` > `0.2553` → IC=-0.125 (n=2194)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2553
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=1081)

- **FILTRO** `sigma_ewma_delta_pct` > `8.672` → IC=-0.208 (n=351)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.672
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2924)
...
- **PATRÓN** `ibs_20min` < `0.2553` → IC=+0.127 (n=1081)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2553 (IC base=-0.042)
...
- **FILTRO** `drift_60min` |x|> `0.6576` → IC=-0.184 (n=568)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1708)

- **FILTRO** `ibs_20min` < `0.7143` → IC=-0.156 (n=1499)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=777)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.203 (n=415)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1861)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.202 (n=831)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=2510)

- **PATRÓN** `dist_vwap_pct` > `0.8527` → IC=+0.314 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8527 (IC base=-0.067)

- **PATRÓN** `dist_vwap_pct` < `0.2747` → IC=+0.315 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2747 (IC base=-0.067)

- **PATRÓN** `volumen_regimen` < `0.9817` → IC=+0.288 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9817 (IC base=-0.067)

- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.299 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6271 (IC base=-0.067)

- **PATRÓN** `volumen_pendiente_norm` < `0.1006` → IC=+0.295 (n=320)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8242` → IC=+0.295 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8242 (IC base=-0.067)

- **PATRÓN** `dist_vwap_pct` > `0.9121` → IC=+0.272 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9121 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` < `0.7359` → IC=+0.252 (n=337)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1485` → IC=+0.258 (n=576)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1485 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.4322` → IC=+0.247 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4322 (IC base=-0.023)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.244 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.196 (n=3381)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0098 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4762` → IC=+0.189 (n=9057)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.4762 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7776` → IC=+0.290 (n=1077)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7776 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.595` → IC=+0.156 (n=4762)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.595 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6889` → IC=+0.247 (n=3225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6889 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2949` → IC=+0.267 (n=855)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2949 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4663` → IC=+0.240 (n=1954)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4663 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6662` → IC=+0.242 (n=1953)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6662 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.267 (n=5375)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.155 (n=3366)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5476` → IC=+0.155 (n=8885)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.5476 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` > `1.0444` → IC=+0.243 (n=484)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0444 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` < `0.2514` → IC=+0.238 (n=2803)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2514 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` < `0.7088` → IC=+0.240 (n=1309)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7088 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` > `1.205` → IC=+0.247 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.205 (IC base=+0.073)

- **PATRÓN** `volumen_pendiente_norm` > `0.2444` → IC=+0.304 (n=742)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2444 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `1.604` → IC=+0.258 (n=1726)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.604 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `2.3173` → IC=+0.257 (n=1778)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3173 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.263 (n=3805)
...
- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.269 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8935 (IC base=+0.045)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.787` → IC=+0.208 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.787 (IC base=+0.045)

- **PATRÓN** `volumen_pendiente_norm` > `0.2239` → IC=+0.270 (n=172)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.177 (n=295)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4339 (IC base=+0.045)

- **PATRÓN** `volumen_spike_ratio` > `2.1457` → IC=+0.200 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1457 (IC base=+0.045)

- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.179 (n=391)
...
- **PATRÓN** `ibs_20min` > `0.862` → IC=+0.160 (n=677)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.862 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3147` → IC=+0.177 (n=379)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.3147 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6717` → IC=+0.166 (n=835)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.6717 (IC base=+0.026)
...
- **PATRÓN** `ballena_activa_n` < `245.0` → IC=+0.193 (n=398)
...
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.289 (n=533)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.248 (n=1421)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.245)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=851)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.245)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.706` → IC=+0.281 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.706 (IC base=+0.245)

- **PATRÓN** `volumen_pendiente_norm` < `0.1041` → IC=+0.259 (n=1356)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1041 (IC base=+0.245)
...
- **PATRÓN** `libro_liquidez` > `1961.3384` → IC=+0.253 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1961.3384 (IC base=+0.245)

- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.316 (n=579)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0098 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.6107` → IC=+0.283 (n=1277)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `2.7396` → IC=+0.288 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7396 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.287 (n=865)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1878.6984` → IC=+0.299 (n=579)
...
- **FILTRO** `ibs_20min` < `0.2871` → IC=-0.182 (n=495)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2871
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1487)

- **FILTRO** `ibs_20min` > `0.7745` → IC=-0.185 (n=599)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7745
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1798)

- **PATRÓN** `ibs_20min` > `0.822` → IC=+0.156 (n=675)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.822 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` > `0.4586` → IC=+0.225 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4586 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` < `0.709` → IC=+0.209 (n=583)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.709 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` < `0.9865` → IC=+0.235 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9865 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` > `0.5867` → IC=+0.210 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5867 (IC base=+0.014)

- **PATRÓN** `volumen_pendiente_norm` > `0.0806` → IC=+0.259 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0806 (IC base=+0.014)

- **PATRÓN** `volumen_spike_ratio` < `1.5113` → IC=+0.265 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5113 (IC base=+0.014)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.244 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` > `0.1559` → IC=+0.211 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1559 (IC base=-0.005)

- **PATRÓN** `dist_vwap_pct` < `0.6853` → IC=+0.202 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6853 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.212 (n=425)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8268` → IC=+0.267 (n=255)
...
- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.254 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=-0.005)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.725` → IC=-0.197 (n=1074)

  - _Acción_: SKIP cuando `ibs_20min` < 0.725
  - _Potencial_: sin este filtro IC_bueno=+0.282 (n=1075)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.233 (n=553)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1680)

- **FILTRO** `sigma_ewma_delta_pct` > `4.705` → IC=-0.180 (n=486)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.705
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=1747)

- **PATRÓN** `ibs_20min` > `0.725` → IC=+0.282 (n=1075)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.725 (IC base=+0.043)

- **PATRÓN** `dist_vwap_pct` > `0.8548` → IC=+0.337 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8548 (IC base=+0.043)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.595` → IC=+0.164 (n=340)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 9.595 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` < `0.8679` → IC=+0.304 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8679 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` > `0.7299` → IC=+0.293 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7299 (IC base=+0.043)

- **PATRÓN** `volumen_pendiente_norm` < `0.1034` → IC=+0.293 (n=737)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1034 (IC base=+0.043)

- **PATRÓN** `volumen_pendiente_norm` > `0.2245` → IC=+0.300 (n=148)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.314 (n=670)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.316 (n=877)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0168 (IC base=+0.277)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.284 (n=1376)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.277)

- **PATRÓN** `ibs_20min` > `0.9117` → IC=+0.345 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9117 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.2098` → IC=+0.316 (n=786)
...
- **PATRÓN** `volumen_regimen` > `0.8611` → IC=+0.302 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8611 (IC base=+0.277)

- **PATRÓN** `volumen_pendiente_norm` < `0.0798` → IC=+0.280 (n=1118)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1495` → IC=+0.294 (n=566)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1495 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1409)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2627.455` → IC=+0.292 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2627.455 (IC base=+0.277)
...
- **PATRÓN** `ibs_20min` < `0.3939` → IC=+0.305 (n=1417)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.494` → IC=+0.289 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.494 (IC base=+0.272)

- **PATRÓN** `volumen_regimen` < `0.6412` → IC=+0.277 (n=473)
...
- **PATRÓN** `ibs_20min` > `0.5764` → IC=+0.218 (n=7893)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5764 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1776` → IC=+0.196 (n=3457)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1776 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.347` → IC=+0.255 (n=1615)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.347 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2107` → IC=+0.160 (n=5226)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2107 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6297` → IC=+0.161 (n=5228)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6297 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2956` → IC=+0.195 (n=1181)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2956 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.559` → IC=+0.169 (n=3333)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.559 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6194` → IC=+0.177 (n=2524)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6194 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2402.7795` → IC=+0.169 (n=5262)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2402.7795 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `115.0` → IC=+0.181 (n=6801)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 115.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.183 (n=5036)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0814` → IC=+0.208 (n=2516)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4792` → IC=+0.227 (n=7542)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4792 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9259` → IC=+0.148 (n=732)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.9259 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2339` → IC=+0.158 (n=5461)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2339 (IC base=+0.167)
...
- **PATRÓN** `volumen_regimen` < `1.1737` → IC=+0.152 (n=5461)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3446` → IC=+0.206 (n=1344)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3446 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=1416)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.191 (n=977)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 12.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` > `0.8961` → IC=+0.277 (n=896)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8961 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.313 (n=602)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.180 (n=1243)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4355 (IC base=+0.183)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0745` → IC=+0.201 (n=392)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4061` → IC=+0.228 (n=1175)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4061 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.2122` → IC=+0.212 (n=700)
...
- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.164 (n=1175)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2628 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `1.0736` → IC=+0.169 (n=533)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0736 (IC base=+0.163)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5013` → IC=+0.182 (n=502)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5013 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `15975.8246` → IC=+0.164 (n=533)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2072` → IC=+0.199 (n=390)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2072 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` < `1.6272` → IC=+0.199 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6272 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `2.8416` → IC=+0.214 (n=571)
...
- **PATRÓN** `libro_liquidez` > `1962.2402` → IC=+0.201 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1962.2402 (IC base=+0.198)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4364` → IC=+0.159 (n=1263)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4364 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1327)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.375` → IC=+0.198 (n=1263)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.375 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.1621` → IC=+0.180 (n=842)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1621 (IC base=+0.144)
...
- **PATRÓN** `volumen_regimen` < `1.0385` → IC=+0.145 (n=1111)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0385 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6254` → IC=+0.149 (n=1263)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6254 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4219` → IC=+0.152 (n=412)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4219 (IC base=+0.144)
...
- **PATRÓN** `libro_liquidez` > `6488.9388` → IC=+0.185 (n=842)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6488.9388 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.149 (n=1199)
...
- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.211 (n=1446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `1.0165` → IC=+0.143 (n=194)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 1.0165 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.2006` → IC=+0.138 (n=1330)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2006 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.966` → IC=+0.138 (n=233)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 8.966 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.6359` → IC=+0.137 (n=483)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.6359 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2754` → IC=+0.170 (n=177)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2754 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.4538` → IC=+0.129 (n=432)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4538 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.4248` → IC=+0.131 (n=432)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 2.4248 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2178.1059` → IC=+0.147 (n=963)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2178.1059 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=909)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.205 (n=616)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.74` → IC=+0.259 (n=1219)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.74 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.5175` → IC=+0.222 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5175 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.242 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.204 (n=1365)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6251` → IC=+0.212 (n=1364)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1479` → IC=+0.211 (n=1159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1479 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.409` → IC=+0.207 (n=1317)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.409 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1452)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2820.5354` → IC=+0.210 (n=619)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2820.5354 (IC base=+0.201)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.160 (n=633)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0039 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.180 (n=630)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0089 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.1004` → IC=+0.152 (n=631)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1004 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=961)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.3875` → IC=+0.179 (n=1892)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.3875 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.8833` → IC=+0.184 (n=302)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.8833 (IC base=+0.146)
...
- **PATRÓN** `volumen_regimen` < `0.8709` → IC=+0.163 (n=1110)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8709 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `0.6979` → IC=+0.150 (n=1487)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6979 (IC base=+0.146)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4413` → IC=+0.162 (n=608)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4413 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5338` → IC=+0.152 (n=608)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.5338 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2148)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12439.6953` → IC=+0.160 (n=630)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12439.6953 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `160.0` → IC=+0.168 (n=1668)
...
- **PATRÓN** `ibs_20min` < `0.6591` → IC=+0.138 (n=1970)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.6591 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2153` → IC=+0.121 (n=1746)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4556` → IC=+0.139 (n=633)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4556 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2751.2995` → IC=+0.123 (n=1760)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2751.2995 (IC base=+0.110)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3457` → IC=+0.123 (n=476)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3457 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.148 (n=427)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 9.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2515` → IC=+0.142 (n=476)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.2515 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3129` → IC=+0.155 (n=169)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.3129 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6136` → IC=+0.146 (n=159)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6136 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `15024.4373` → IC=+0.146 (n=317)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 15024.4373 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `146.0` → IC=+0.151 (n=150)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 146.0 (IC base=+0.104)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.184 (n=194)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0089 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.5317` → IC=+0.135 (n=425)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.5317 (IC base=+0.132)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.1` → IC=+0.203 (n=190)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.1 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `1.0674` → IC=+0.149 (n=374)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0674 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.1825` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1825 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `2.2078` → IC=+0.172 (n=184)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.2078 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=462)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `3081.1151` → IC=+0.201 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3081.1151 (IC base=+0.132)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.206 (n=3364)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.216 (n=10097)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.9852` → IC=+0.204 (n=1426)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9852 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.623` → IC=+0.226 (n=4862)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.623 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `0.8802` → IC=+0.166 (n=4501)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8802 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.201 (n=1391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.5988` → IC=+0.187 (n=3235)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.5988 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `1789.2648` → IC=+0.171 (n=10092)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 1789.2648 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `86.0` → IC=+0.195 (n=7671)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 86.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0054` → IC=+0.195 (n=4026)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0054 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.149` → IC=+0.189 (n=4027)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.239 (n=9147)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.034` → IC=+0.201 (n=1287)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.034 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.731` → IC=+0.182 (n=8844)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.731 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.7043` → IC=+0.163 (n=2763)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.7043 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2037` → IC=+0.153 (n=2093)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2037 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2882` → IC=+0.244 (n=1204)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2882 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.6294` → IC=+0.193 (n=2798)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.6294 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.194 (n=5404)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3602` → IC=+0.191 (n=1710)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.3602 (IC base=+0.190)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.063` → IC=+0.314 (n=761)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.063 (IC base=+0.190)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5477` → IC=+0.183 (n=711)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.5477 (IC base=+0.190)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.259 (n=897)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1294` → IC=+0.284 (n=591)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.537` → IC=+0.264 (n=1346)
...
- **PATRÓN** `libro_liquidez` > `1803.98` → IC=+0.264 (n=895)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1803.98 (IC base=+0.259)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.191 (n=539)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.3086` → IC=+0.204 (n=1617)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3086 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1328` → IC=+0.185 (n=923)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1328 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.74` → IC=+0.171 (n=369)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 9.74 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.249` → IC=+0.154 (n=1457)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.249 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.6277` → IC=+0.180 (n=539)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6277 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2671` → IC=+0.200 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2671 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.1148` → IC=+0.162 (n=1375)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1148 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.7575` → IC=+0.156 (n=1041)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7575 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `15748.4784` → IC=+0.157 (n=733)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 15748.4784 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `473.0` → IC=+0.159 (n=1492)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 473.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1399)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6558` → IC=+0.196 (n=1398)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.274` → IC=+0.153 (n=1265)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.274 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.164 (n=1398)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.160 (n=1300)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `2.0873` → IC=+0.167 (n=589)
...
- **PATRÓN** `sigma_h` > `0.012` → IC=+0.248 (n=545)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` < `0.0116` → IC=+0.239 (n=1525)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0116 (IC base=+0.232)

- **PATRÓN** `drift_60min` |x|≤ `0.1677` → IC=+0.237 (n=671)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.36` → IC=+0.269 (n=1342)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.36 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.766` → IC=+0.275 (n=567)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7551` → IC=+0.230 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7551 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.1905` → IC=+0.238 (n=933)
...
- **PATRÓN** `libro_liquidez` > `1947.5084` → IC=+0.245 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1947.5084 (IC base=+0.232)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4384` → IC=+0.146 (n=1717)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.376` → IC=+0.163 (n=681)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.376 (IC base=+0.137)
...
- **PATRÓN** `volumen_regimen` < `0.8735` → IC=+0.157 (n=1145)
...
- **PATRÓN** `volumen_spike_ratio` > `1.768` → IC=+0.151 (n=1109)
...
- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.150 (n=541)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4471` → IC=+0.155 (n=1400)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7021` → IC=+0.185 (n=1400)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.7021 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.6035` → IC=+0.144 (n=1551)
...
- **PATRÓN** `volumen_regimen` < `0.6927` → IC=+0.152 (n=616)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6927 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.152 (n=1328)
...
- **PATRÓN** `ballena_activa_n` < `178.0` → IC=+0.146 (n=1322)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 178.0 (IC base=+0.139)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.138 (n=1140)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.191 (n=1711)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.451` → IC=+0.232 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.451 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.8906` → IC=+0.136 (n=1139)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8906 (IC base=+0.113)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1716)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.132 (n=1320)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.474` → IC=+0.124 (n=1606)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5014` → IC=+0.128 (n=500)
...
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.218 (n=1139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.210 (n=1520)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.249 (n=1709)
...
- **PATRÓN** `volumen_regimen` < `1.2401` → IC=+0.210 (n=1708)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2401 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `0.6407` → IC=+0.216 (n=1708)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5079` → IC=+0.235 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5079 (IC base=+0.208)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1798)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `2625.3363` → IC=+0.220 (n=1139)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.3363 (IC base=+0.208)
...
- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.255 (n=1823)
...
- **PATRÓN** `dist_vwap_pct` < `0.9333` → IC=+0.203 (n=2024)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9333 (IC base=+0.201)
...
- **PATRÓN** `volumen_regimen` > `1.2357` → IC=+0.233 (n=608)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1989` → IC=+0.197 (n=1442)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.1989 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4324` → IC=+0.197 (n=1638)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.4324 (IC base=+0.201)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=3056)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.161 (n=2563)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0092 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.5214` → IC=+0.162 (n=2913)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.165 (n=1286)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.1887` → IC=+0.166 (n=1085)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1887 (IC base=+0.153)
...
- **PATRÓN** `volumen_regimen` > `0.8968` → IC=+0.160 (n=1267)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.8968 (IC base=+0.153)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4563` → IC=+0.165 (n=959)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4563 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.8826` → IC=+0.163 (n=1917)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8826 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=2021)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `8275.452` → IC=+0.157 (n=1320)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 8275.452 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.197 (n=769)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0038 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4897` → IC=+0.157 (n=2304)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.164 (n=771)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.6915` → IC=+0.157 (n=441)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6915 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.303` → IC=+0.149 (n=2292)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.303 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1012` → IC=+0.149 (n=1938)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1012 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` < `0.097` → IC=+0.142 (n=2085)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.097 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.2204` → IC=+0.145 (n=491)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.2204 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `1.4246` → IC=+0.152 (n=759)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4246 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8123` → IC=+0.143 (n=1516)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8123 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=3056)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `7202.6889` → IC=+0.152 (n=2058)
...
- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.161 (n=818)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0073 (IC base=+0.158)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.166 (n=928)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0043 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.3873` → IC=+0.160 (n=816)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.3873 (IC base=+0.158)
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.165 (n=317)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 4.0 (IC base=+0.158)

- **PATRÓN** `ibs_20min` < `0.5618` → IC=+0.162 (n=619)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.5618 (IC base=+0.158)

- **PATRÓN** `ibs_20min` > `0.8888` → IC=+0.169 (n=309)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.8888 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` > `0.9555` → IC=+0.165 (n=207)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.9555 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` < `0.4319` → IC=+0.166 (n=864)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.4319 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.662` → IC=+0.166 (n=929)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` < 6.662 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `1.0845` → IC=+0.159 (n=816)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.0845 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` > `0.7159` → IC=+0.161 (n=829)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.7159 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` < `0.107` → IC=+0.160 (n=853)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.107 (IC base=+0.158)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4358` → IC=+0.175 (n=303)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4358 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.163 (n=916)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.158)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.155 (n=781)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0083 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.3961` → IC=+0.172 (n=688)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.155 (n=522)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `ibs_20min` > `0.0993` → IC=+0.147 (n=781)
...
- **PATRÓN** `volumen_regimen` > `0.7236` → IC=+0.141 (n=698)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.7236 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.0742` → IC=+0.166 (n=330)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0742 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.2019` → IC=+0.154 (n=675)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.2019 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.7829` → IC=+0.146 (n=510)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7829 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `7577.2758` → IC=+0.168 (n=781)
...
- **PATRÓN** `ibs_20min` > `0.6731` → IC=+0.206 (n=742)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6731 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `0.1549` → IC=+0.155 (n=456)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0922` → IC=+0.135 (n=631)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.0922 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.120 (n=493)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.141 (n=366)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.125 (n=315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 7.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.5161` → IC=+0.186 (n=285)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.5161 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.1379` → IC=+0.173 (n=151)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.1379 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `1.067` → IC=+0.129 (n=251)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.067 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` < `0.1558` → IC=+0.137 (n=260)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` < 0.1558 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` < `2.0105` → IC=+0.174 (n=216)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.0105 (IC base=+0.104)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3433` → IC=+0.167 (n=103)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.3433 (IC base=+0.052)
...
- **PATRÓN** `ibs_20min` > `0.6789` → IC=+0.235 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6789 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.129` → IC=+0.162 (n=155)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.129 (IC base=+0.107)
...
- **PATRÓN** `volumen_regimen` > `0.9419` → IC=+0.146 (n=128)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.9419 (IC base=+0.107)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7335` → IC=+0.171 (n=153)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.7335 (IC base=+0.107)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=188)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `1133.0595` → IC=+0.159 (n=247)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1133.0595 (IC base=+0.107)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=1784)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=160)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.135 (n=376)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=197)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.124 (n=155)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=424)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.185 (n=147)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` < 0.47 (IC base=+0.011)
...
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.210 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.59 (IC base=+0.109)

- **PATRÓN** `restante_min` > `3.82` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `restante_min` > 3.82 (IC base=+0.109)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.167 (n=34)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 12.0 (IC base=+0.109)

- **PATRÓN** `lag_apertura_s` < `60.77` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 60.77 (IC base=+0.109)

- **PATRÓN** `profundidad_ratio` > `67.7` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `profundidad_ratio` > 67.7 (IC base=+0.109)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.202 (n=45)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=24)

- **FILTRO** `profundidad_ratio` < `20.4` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `profundidad_ratio` < 20.4
...
- **PATRÓN** `py_entrada` < `0.59` → IC=+0.122 (n=43)
  ...
  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.59 (IC base=+0.031)

- **PATRÓN** `restante_min` > `3.86` → IC=+0.136 (n=31)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` > 3.86 (IC base=+0.031)

- **PATRÓN** `lag_apertura_s` < `91.63` → IC=+0.128 (n=41)

  - _Acción_: Kelly boost +0.64€ cuando `lag_apertura_s` < 91.63 (IC base=+0.031)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7526)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.166 (n=3533)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10658)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.168 (n=3654)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.152 (n=645)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=1986)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.192 (n=618)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1890)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=640)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1989)

- **FILTRO** `ibs_20min` > `0.2812` → IC=-0.162 (n=657)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2812
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1972)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.173 (n=604)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1845)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.176 (n=641)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1990)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2775)
...
- **FILTRO** `py_entrada` < `0.415` → IC=-0.214 (n=197)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=597)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9954)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=22544)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7954)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=24544)

- **FILTRO** `ibs_7min` < `0.285` → IC=-0.235 (n=8124)

  - _Acción_: SKIP cuando `ibs_7min` < 0.285
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=24374)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11034)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21464)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=9987)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=30759)

- **FILTRO** `ibs_7min` > `0.2923` → IC=-0.178 (n=10184)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2923
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=30562)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.135 (n=1631)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3752)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.309 (n=1283)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4100)

- **FILTRO** `ibs_7min` < `0.7117` → IC=-0.249 (n=1776)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7117
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3607)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.186 (n=1226)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=4157)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.261 (n=1726)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=5275)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.125 (n=2380)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4621)

- **FILTRO** `ibs_7min` > `0.788` → IC=-0.206 (n=1750)

  - _Acción_: SKIP cuando `ibs_7min` > 0.788
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=5251)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1301)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4305)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1356)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4250)

- **FILTRO** `ibs_7min` < `0.7471` → IC=-0.191 (n=1401)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7471
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4205)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.177 (n=1401)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=4205)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1421)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4274)

- **FILTRO** `ibs_7min` > `0.2605` → IC=-0.178 (n=1423)
...
- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.182 (n=1421)
  ...
  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4274)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.165 (n=1242)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3862)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1259)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3845)

- **FILTRO** `ibs_7min` < `0.7077` → IC=-0.242 (n=1683)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7077
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3421)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.221 (n=1180)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3924)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1712)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5777)

- **FILTRO** `ibs_7min` > `0.7456` → IC=-0.174 (n=1871)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7456
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=5618)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1708)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3655)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.232 (n=1585)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3778)

- **FILTRO** `ibs_7min` < `0.7406` → IC=-0.180 (n=1340)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7406
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=4023)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.170 (n=1314)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4049)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.259 (n=1364)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4101)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.177 (n=1366)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4099)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.254 (n=1384)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4280)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.233 (n=1401)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4263)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1842)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5911)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1737)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3641)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1331)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4047)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1308)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4070)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.206 (n=1751)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=5592)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1084)
...
- **PATRÓN** `delta_ratio` |x|> `0.398` → IC=+0.126 (n=744)
  ...
  - _Acción_: Kelly boost +0.63€ cuando `delta_ratio` |x|> 0.398 (IC base=+0.110)
...
- **FILTRO** `sigma_h` > `0.0053` → IC=-0.281 (n=80)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0053
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2919)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.187 (n=1684)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 17.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6061` → IC=+0.267 (n=1613)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6061 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.1183` → IC=+0.187 (n=838)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1183 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.6272` → IC=+0.178 (n=1540)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6272 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.77` → IC=+0.280 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.77 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `2972.1985` → IC=+0.196 (n=1075)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=615)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0678` → IC=+0.149 (n=166)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0678 (IC base=+0.136)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2344` → IC=+0.180 (n=126)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.90€ cuando `delta_ratio_macro` |x|> 0.2344 (IC base=+0.136)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2579` → IC=+0.159 (n=268)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.141 (n=393)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 17.0 (IC base=+0.136)

- **PATRÓN** `ibs_15` > `0.6602` → IC=+0.254 (n=336)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `libro_liquidez` > `9475.4181` → IC=+0.159 (n=171)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 9475.4181 (IC base=+0.136)
...
- **FILTRO** `dist_vwap_pct` > `0.5695` → IC=-0.135 (n=124)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=902)
...
- **PATRÓN** `sigma_h` > `0.0235` → IC=+0.257 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0235 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0864` → IC=+0.209 (n=187)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0864 (IC base=+0.186)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0393` → IC=+0.190 (n=424)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.95€ cuando `delta_ratio_macro` |x|> 0.0393 (IC base=+0.186)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0893` → IC=+0.250 (n=110)
...
- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.282 (n=424)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.1329` → IC=+0.209 (n=256)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `10.743` → IC=+0.187 (n=423)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 10.743 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `2914.215` → IC=+0.278 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2914.215 (IC base=+0.186)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.379 (n=138)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.341)
...
- **PATRÓN** `ibs_15` > `0.7863` → IC=+0.385 (n=414)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.193 (n=899)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1746)

- **FILTRO** `libro_liquidez` < `3905.4186` → IC=-0.138 (n=1745)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1206` → IC=+0.248 (n=1173)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1206 (IC base=-0.033)

- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.278 (n=1760)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3469 (IC base=-0.033)

- **PATRÓN** `dist_vwap_pct` > `0.7029` → IC=+0.302 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7029 (IC base=-0.033)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.223 (n=402)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=1207)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.230 (n=402)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1207)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=1023)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=586)

- **FILTRO** `sigma_ewma_delta_pct` > `19.79` → IC=-0.249 (n=289)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.79
  - _Potencial_: sin este filtro IC_bueno=-0.187 (n=1320)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.268 (n=231)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.229)

- **PATRÓN** `drift_60min` |x|≤ `0.4443` → IC=+0.230 (n=691)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4443 (IC base=+0.229)

- **PATRÓN** `drift_15min` |x|≤ `0.7872` → IC=+0.234 (n=608)
...
- **PATRÓN** `ibs_15` < `0.3453` → IC=+0.268 (n=691)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3453 (IC base=+0.229)

- **PATRÓN** `dist_vwap_pct` > `0.778` → IC=+0.312 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.778 (IC base=+0.229)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.189` → IC=+0.236 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.189 (IC base=+0.229)

- **PATRÓN** `libro_liquidez` > `3544.1821` → IC=+0.229 (n=691)
...
- **FILTRO** `sigma_h` > `0.0102` → IC=-0.247 (n=156)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.140 (n=470)
...
- **FILTRO** `drift_15min` |x|> `0.888` → IC=-0.266 (n=156)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.134 (n=470)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1334` → IC=+0.285 (n=212)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3437` → IC=+0.306 (n=468)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.304 (n=442)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0553` → IC=+0.330 (n=221)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0553 (IC base=+0.295)
...
- **PATRÓN** `ibs_15` > `0.8393` → IC=+0.330 (n=663)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8393 (IC base=+0.295)

- **PATRÓN** `dist_vwap_pct` > `0.1578` → IC=+0.324 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1578 (IC base=+0.295)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.298 (n=810)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6061 sube el IC de +0.186 a +0.267 en UPDOWN_GBM#15min (n=1613). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6602 sube el IC de +0.136 a +0.254 en UPDOWN_GBM#ETH#15min (n=336). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.186 a +0.282 en UPDOWN_GBM#XRP#15min (n=424). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3469 sube el IC de -0.033 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=1760). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3453 sube el IC de +0.229 a +0.268 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=691). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_YES, IBS > 0.8889 sube el IC de -0.167 a +0.350 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=18). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3437 sube el IC de -0.043 a +0.306 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=468). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8393 sube el IC de +0.295 a +0.330 en UPDOWN_GBM_IBS_ALTO (n=663). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8489 sube el IC de +0.303 a +0.342 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=296). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7863 sube el IC de +0.341 a +0.385 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=414). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 28295 | -0.091 | -3809.78€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1458 | -0.049 | -217.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 26837 | -0.093 | -3591.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3704 | -0.093 | -599.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3704 | -0.093 | -599.81€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1458 | -0.049 | -217.91€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1458 | -0.049 | -217.91€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3479 | -0.096 | -791.31€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3479 | -0.096 | -791.31€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7265 | -0.023 | -676.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7265 | -0.023 | -676.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6823 | -0.096 | -442.43€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6823 | -0.096 | -442.43€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5566 | -0.178 | -1081.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5566 | -0.178 | -1081.39€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 18250 | -0.028 | +4031.99€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4767 | +0.000 | +1822.89€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 13483 | -0.038 | +2209.10€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 18250 | -0.028 | +4031.99€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4767 | +0.000 | +1822.89€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 13483 | -0.038 | +2209.10€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 93090 | +0.112 | -4744.19€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14045 | +0.185 | -446.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 374 | -0.082 | -50.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 72619 | +0.100 | -4027.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6052 | +0.107 | -219.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12077 | +0.098 | -1016.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 45 | -0.160 | -0.32€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12017 | +0.100 | -1004.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18829 | +0.131 | -380.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4425 | +0.203 | -138.00€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12041 | +0.111 | -196.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2321 | +0.104 | -24.18€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12118 | +0.089 | -1124.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 52 | -0.093 | -6.98€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12051 | +0.090 | -1106.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19805 | +0.123 | -407.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5436 | +0.175 | -86.17€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12168 | +0.105 | -257.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2189 | +0.098 | -54.44€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18168 | +0.113 | -1090.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4040 | +0.188 | -223.03€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 277 | -0.041 | +3.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12309 | +0.091 | -730.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1542 | +0.125 | -140.91€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12093 | +0.100 | -724.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12033 | +0.101 | -732.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14769 | +0.191 | -973.87€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14769 | +0.191 | -973.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3517 | +0.168 | -369.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3517 | +0.168 | -369.64€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1232 | +0.195 | -13.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1232 | +0.195 | -13.69€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3463 | +0.180 | -297.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3463 | +0.180 | -297.23€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3078 | +0.239 | -97.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3078 | +0.239 | -97.79€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3400 | +0.192 | -209.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 3400 | +0.192 | -209.27€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 50863 | +0.197 | -3993.58€ | 3 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 50863 | +0.197 | -3993.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 8800 | +0.176 | -1018.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 8800 | +0.176 | -1018.55€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 