# Hipótesis automáticas — 2026-08-27 07:17 UTC
_Generado por shadow_postmortem.py sobre 171595 resoluciones (PNL=+12498.33€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.28` → IC=-0.286 (n=2381)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.28
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=7144)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `143.21` → IC=-0.208 (n=296)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 143.21
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=891)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `concentracion_yes` < `1.0` → IC=-0.122 (n=125)

  - _Acción_: SKIP cuando `concentracion_yes` < 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=564)

- **FILTRO** `n_ballenas` < `6.0` → IC=-0.171 (n=168)

  - _Acción_: SKIP cuando `n_ballenas` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=521)

- **FILTRO** `restante_s_al_confirmar` < `390.04` → IC=-0.276 (n=172)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 390.04
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=517)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `97.9` → IC=-0.426 (n=295)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 97.9
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=885)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `159.37` → IC=-0.184 (n=646)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 159.37
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1938)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `154.55` → IC=-0.260 (n=557)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.55
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1673)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `117.26` → IC=-0.387 (n=413)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 117.26
  - _Potencial_: sin este filtro IC_bueno=-0.139 (n=1242)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.188 (n=5378)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.170 (n=1578)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2385.1288` → IC=+0.174 (n=1521)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.158 (n=4313)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 7.0 (IC base=+0.142)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.259 (n=3318)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=2935)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `1861.0239` → IC=+0.182 (n=2453)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 1861.0239 (IC base=+0.142)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.222 (n=632)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.209 (n=781)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.195 (n=185)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.287 (n=472)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.285 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `2911.6657` → IC=+0.294 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2911.6657 (IC base=+0.285)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.193 (n=633)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 12.0 (IC base=+0.190)

- **PATRÓN** `py_entrada` > `0.84` → IC=+0.442 (n=310)
...
- **PATRÓN** `libro_liquidez` > `2065.7928` → IC=+0.240 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2065.7928 (IC base=+0.222)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.165 (n=969)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.193 (n=1095)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 5.0 (IC base=+0.181)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.182 (n=944)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 15.0 (IC base=+0.181)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.199 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.7 (IC base=+0.181)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.458 (n=211)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `3363.9486` → IC=+0.467 (n=149)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.449 (n=76)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.447)

- **PATRÓN** `py_entrada` > `0.925` → IC=+0.455 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.925 (IC base=+0.447)

- **PATRÓN** `libro_liquidez` > `12599.6821` → IC=+0.476 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12599.6821 (IC base=+0.447)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO#ETH#15min
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.445 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.429)

- **PATRÓN** `py_entrada` < `0.915` → IC=+0.432 (n=42)
...
- **PATRÓN** `libro_liquidez` > `3939.3842` → IC=+0.475 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3939.3842 (IC base=+0.429)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.164 (n=1491)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 12.0 (IC base=+0.164)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.214 (n=722)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.289 (n=680)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.247 (n=1178)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9479` → IC=+0.206 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9479 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.186` → IC=+0.229 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.186 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` < `0.487` → IC=+0.211 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.487 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.206` → IC=+0.168 (n=911)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3083` → IC=+0.157 (n=173)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.3083 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `2.4495` → IC=+0.142 (n=1064)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.4495 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.2133` → IC=+0.131 (n=1525)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2133 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.1302` → IC=+0.148 (n=712)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.1302 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.6331` → IC=+0.161 (n=249)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6331 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `1.0596` → IC=+0.147 (n=338)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.0596 (IC base=+0.031)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6241` → IC=+0.194 (n=357)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.6241 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` > `2.929` → IC=+0.233 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.929 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `222.0` → IC=+0.214 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 222.0 (IC base=+0.031)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.182 (n=168)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0075 (IC base=+0.119)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.164 (n=245)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 8.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.287 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.769` → IC=+0.326 (n=176)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.284 (n=179)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.269)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0689` → IC=+0.337 (n=90)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0689 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.277 (n=249)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.269)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.279 (n=242)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.269)

- **PATRÓN** `ibs_20min` < `0.4375` → IC=+0.307 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4375 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.304 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.939 (IC base=+0.269)

- **PATRÓN** `volumen_pendiente_norm` > `0.2336` → IC=+0.289 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2336 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` < `1.8169` → IC=+0.295 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8169 (IC base=+0.269)
...
- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.280 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 58.0 (IC base=+0.269)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.229 (n=249)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_spike_ratio` < `1.447` → IC=+0.244 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.447 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `11282.8623` → IC=+0.216 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11282.8623 (IC base=+0.205)

- **PATRÓN** `ballena_activa_n` < `369.0` → IC=+0.202 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 369.0 (IC base=+0.205)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.178 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0022 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0741` → IC=+0.171 (n=144)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.0741 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.151 (n=399)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 7.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.147 (n=432)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 17.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.5892` → IC=+0.166 (n=432)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.5892 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1371` → IC=+0.166 (n=369)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1371 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.938` → IC=+0.221 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.938 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.6279` → IC=+0.178 (n=144)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6279 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.025` → IC=+0.146 (n=196)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.025 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.0937` → IC=+0.216 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0937 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.7479` → IC=+0.174 (n=219)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.7479 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4122` → IC=+0.161 (n=328)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.4122 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=557)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `14177.8639` → IC=+0.192 (n=144)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 14177.8639 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `223.0` → IC=+0.183 (n=80)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 223.0 (IC base=+0.140)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.912` → IC=+0.269 (n=119)
...
- **PATRÓN** `libro_liquidez` > `1917.5696` → IC=+0.149 (n=203)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1917.5696 (IC base=+0.132)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.296 (n=145)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.264)

- **PATRÓN** `drift_60min` |x|≤ `0.1276` → IC=+0.288 (n=144)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1276 (IC base=+0.264)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.554` → IC=+0.266 (n=361)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7662` → IC=+0.239 (n=136)
...
- **PATRÓN** `ballena_activa_n` < `28.0` → IC=+0.239 (n=86)
...
- **FILTRO** `ibs_20min` > `0.7619` → IC=-0.162 (n=320)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7619
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=971)

- **FILTRO** `sigma_ewma_delta_pct` > `4.936` → IC=-0.157 (n=275)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.936
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=1016)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.161 (n=122)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=548)

- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.171 (n=290)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7761
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=873)

- **FILTRO** `sigma_ewma_delta_pct` > `6.654` → IC=-0.156 (n=193)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.654
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=970)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.134 (n=1283)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0075 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9461` → IC=+0.245 (n=942)
...
- **PATRÓN** `volumen_regimen` > `1.1596` → IC=+0.199 (n=323)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 1.1596 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` < `0.1146` → IC=+0.169 (n=1261)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` < 0.1146 (IC base=+0.052)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4787` → IC=+0.197 (n=433)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.4787 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` > `2.8423` → IC=+0.173 (n=432)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.8423 (IC base=+0.052)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.268 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.052)

- **PATRÓN** `ibs_20min` < `0.0939` → IC=+0.185 (n=1199)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.0939 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` > `1.1079` → IC=+0.214 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1079 (IC base=+0.040)

- **PATRÓN** `dist_vwap_pct` < `0.2083` → IC=+0.205 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2083 (IC base=+0.040)

- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.213 (n=755)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3927` → IC=+0.293 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3927 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.262 (n=469)
...
- **FILTRO** `ibs_20min` < `0.2469` → IC=-0.147 (n=182)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=372)

- **FILTRO** `sigma_ewma_delta_pct` > `2.09` → IC=-0.175 (n=232)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.142` → IC=+0.188 (n=107)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 5.142 (IC base=-0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2009` → IC=+0.382 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2009 (IC base=-0.009)

- **PATRÓN** `volumen_spike_ratio` > `2.3584` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3584 (IC base=-0.009)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8844` → IC=-0.142 (n=272)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8844
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=820)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.0714` → IC=+0.218 (n=147)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.996` → IC=+0.294 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.996 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` < `0.1395` → IC=+0.188 (n=338)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1395 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.4203` → IC=+0.179 (n=51)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.4203 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` < `1.9992` → IC=+0.196 (n=159)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.9992 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `3.5399` → IC=+0.179 (n=163)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 3.5399 (IC base=+0.181)
...
- **PATRÓN** `sigma_h` < `0.0079` → IC=+0.357 (n=208)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0079 (IC base=+0.351)

- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.366 (n=80)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.351)

- **PATRÓN** `drift_60min` |x|≤ `0.2221` → IC=+0.362 (n=157)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2221 (IC base=+0.351)
...
- **PATRÓN** `ibs_20min` < `0.3077` → IC=+0.356 (n=235)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3077 (IC base=+0.351)

- **PATRÓN** `ibs_20min` > `0.1308` → IC=+0.355 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1308 (IC base=+0.351)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.535` → IC=+0.353 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.535 (IC base=+0.351)

- **PATRÓN** `volumen_pendiente_norm` > `0.3474` → IC=+0.389 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3474 (IC base=+0.351)
...
- **PATRÓN** `libro_liquidez` > `1894.7532` → IC=+0.364 (n=79)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1894.7532 (IC base=+0.351)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `sigma_h` > `0.0066` → IC=-0.150 (n=115)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0066
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=349)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=66)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=905)
...
- **FILTRO** `ibs_20min` > `0.748` → IC=-0.174 (n=222)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=668)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.603` → IC=-0.132 (n=218)
...
- **PATRÓN** `dist_vwap_pct` > `0.3259` → IC=+0.264 (n=104)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3259 (IC base=-0.011)

- **PATRÓN** `volumen_regimen` < `0.8598` → IC=+0.191 (n=121)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.8598 (IC base=-0.011)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4917` → IC=+0.178 (n=57)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4917 (IC base=-0.011)

- **PATRÓN** `volumen_spike_ratio` > `2.0524` → IC=+0.183 (n=77)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.0524 (IC base=-0.011)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.228 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=-0.011)
...
- **PATRÓN** `ibs_20min` > `0.898` → IC=+0.297 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.898 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` > `1.381` → IC=+0.336 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.381 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.118` → IC=+0.273 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.118 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `0.8369` → IC=+0.249 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8369 (IC base=+0.215)
...
- **PATRÓN** `libro_liquidez` > `2452.9003` → IC=+0.226 (n=559)
...
- **PATRÓN** `dist_vwap_pct` < `0.8801` → IC=+0.275 (n=656)
...
- **PATRÓN** `volumen_regimen` > `1.2589` → IC=+0.308 (n=191)
...
- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.255 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 42.0 (IC base=+0.269)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.197 (n=816)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0099 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.3297` → IC=+0.156 (n=2149)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.3297 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.182 (n=891)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.284 (n=1212)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `1.145` → IC=+0.259 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.145 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.341` → IC=+0.247 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.341 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `0.6867` → IC=+0.171 (n=1513)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6867 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.1017` → IC=+0.183 (n=873)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1017 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.2822` → IC=+0.152 (n=1932)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.2822 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.8508` → IC=+0.150 (n=1463)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8508 (IC base=+0.156)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.167 (n=1994)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `3185.6633` → IC=+0.182 (n=1108)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3185.6633 (IC base=+0.156)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.176 (n=1188)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 121.0 (IC base=+0.156)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.198 (n=1926)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0074 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.4119` → IC=+0.198 (n=2188)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.4119 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.214 (n=821)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` < `0.4062` → IC=+0.236 (n=2188)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4062 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.3554` → IC=+0.177 (n=1919)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3554 (IC base=+0.185)
...
- **PATRÓN** `volumen_regimen` < `1.176` → IC=+0.167 (n=1764)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.176 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` > `0.8585` → IC=+0.172 (n=1176)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8585 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.2892` → IC=+0.246 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2892 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` < `1.8834` → IC=+0.177 (n=1053)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.8834 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.6473` → IC=+0.216 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6473 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `197.0` → IC=+0.183 (n=1147)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 197.0 (IC base=+0.185)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.189 (n=268)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 11.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.304 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.029` → IC=+0.338 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.029 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1485` → IC=+0.180 (n=95)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1485 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.5557` → IC=+0.126 (n=284)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.5557 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.172 (n=242)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4292` → IC=+0.180 (n=345)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.4292 (IC base=+0.179)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=364)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.179)

- **PATRÓN** `ibs_20min` > `0.9987` → IC=+0.274 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9987 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` > `0.2059` → IC=+0.243 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2059 (IC base=+0.179)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.697` → IC=+0.236 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.697 (IC base=+0.179)

- **PATRÓN** `volumen_regimen` < `1.2894` → IC=+0.186 (n=345)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 1.2894 (IC base=+0.179)

- **PATRÓN** `volumen_regimen` > `0.886` → IC=+0.194 (n=230)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 0.886 (IC base=+0.179)
...
- **PATRÓN** `volumen_spike_ratio` < `1.378` → IC=+0.213 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.378 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `12140.2539` → IC=+0.203 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12140.2539 (IC base=+0.179)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.197 (n=196)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0026 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.2896` → IC=+0.171 (n=442)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.2896 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=399)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 7.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.4154` → IC=+0.187 (n=442)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.4154 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.1544` → IC=+0.172 (n=437)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1544 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.387` → IC=+0.228 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.387 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.7208` → IC=+0.217 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7208 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.219 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.7416` → IC=+0.171 (n=223)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.7416 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `14245.6725` → IC=+0.164 (n=147)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 14245.6725 (IC base=+0.147)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.147` → IC=+0.164 (n=236)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.147 (IC base=+0.153)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.904` → IC=+0.302 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.904 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` < `0.2246` → IC=+0.146 (n=292)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.2246 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `1.9887` → IC=+0.204 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9887 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `3.6406` → IC=+0.144 (n=133)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 3.6406 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `1958.5384` → IC=+0.183 (n=118)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1958.5384 (IC base=+0.153)
...
- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.219 (n=350)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0093 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.5012` → IC=+0.201 (n=349)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5012 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.203 (n=355)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.182)

- **PATRÓN** `ibs_20min` > `0.4526` → IC=+0.237 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4526 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` > `1.0396` → IC=+0.236 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0396 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.194` → IC=+0.314 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.194 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `0.6366` → IC=+0.194 (n=348)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4212` → IC=+0.230 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4212 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=398)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.182)

- **PATRÓN** `libro_liquidez` > `8688.9164` → IC=+0.205 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8688.9164 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.174 (n=191)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 156.0 (IC base=+0.182)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.255 (n=141)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.3788` → IC=+0.169 (n=421)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3788 (IC base=+0.150)
...
- **PATRÓN** `ibs_20min` < `0.1115` → IC=+0.249 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1115 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.3222` → IC=+0.170 (n=467)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3222 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.227` → IC=+0.212 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.227 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.1582` → IC=+0.164 (n=421)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1582 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.6199` → IC=+0.160 (n=421)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6199 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1001` → IC=+0.169 (n=125)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1001 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.8878` → IC=+0.193 (n=210)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.8878 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.157 (n=141)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 10007.3401 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `195.0` → IC=+0.136 (n=207)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 195.0 (IC base=+0.150)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` > `0.6182` → IC=+0.133 (n=483)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.6182 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0962` → IC=+0.121 (n=172)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_pendiente_norm` > 0.0962 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `1.5608` → IC=+0.130 (n=403)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.5608 (IC base=+0.117)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.193 (n=135)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0097 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.208 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` < `0.4062` → IC=+0.227 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4062 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.217` → IC=+0.140 (n=379)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.217 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.686` → IC=+0.191 (n=79)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 6.686 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` < `1.2004` → IC=+0.133 (n=404)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.2004 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` > `0.8568` → IC=+0.164 (n=269)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.8568 (IC base=+0.124)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2407` → IC=+0.202 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2407 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `2071.8704` → IC=+0.172 (n=269)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2071.8704 (IC base=+0.124)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0227` → IC=+0.193 (n=236)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0227 (IC base=+0.164)

- **PATRÓN** `drift_60min` |x|≤ `0.1638` → IC=+0.193 (n=229)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.1638 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.199 (n=184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 17.0 (IC base=+0.164)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.167 (n=235)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 7.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.9211` → IC=+0.262 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9211 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `1.6195` → IC=+0.248 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6195 (IC base=+0.164)
...
- **PATRÓN** `volumen_regimen` > `0.8237` → IC=+0.187 (n=346)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.8237 (IC base=+0.164)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1643` → IC=+0.176 (n=424)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.1643 (IC base=+0.164)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.169 (n=131)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0035 (IC base=+0.079)

- **PATRÓN** `drift_60min` |x|≤ `0.1135` → IC=+0.126 (n=172)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.1135 (IC base=+0.079)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.146 (n=145)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 16.0 (IC base=+0.079)

- **PATRÓN** `ibs_20min` < `0.6219` → IC=+0.129 (n=391)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.6219 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.192` → IC=+0.198 (n=127)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 5.192 (IC base=+0.079)

- **PATRÓN** `volumen_regimen` < `0.6527` → IC=+0.153 (n=119)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6527 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` < `1.8672` → IC=+0.137 (n=224)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.8672 (IC base=+0.079)

- **PATRÓN** `libro_liquidez` > `9491.207` → IC=+0.139 (n=178)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 9491.207 (IC base=+0.079)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.208 (n=1296)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.293 (n=1291)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9429 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `1.0645` → IC=+0.256 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0645 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.34` → IC=+0.247 (n=1194)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.34 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.8788` → IC=+0.149 (n=1342)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8788 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `1.0786` → IC=+0.154 (n=914)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.0786 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1651` → IC=+0.185 (n=724)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1651 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.8689` → IC=+0.162 (n=1686)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8689 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2321)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `2497.8056` → IC=+0.176 (n=1898)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2497.8056 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `71.0` → IC=+0.196 (n=981)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 71.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.226 (n=1703)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.46` → IC=+0.205 (n=2548)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.252 (n=2548)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5556 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` < `0.7036` → IC=+0.186 (n=2080)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.7036 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.354` → IC=+0.222 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.354 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.645` → IC=+0.201 (n=2397)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.645 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `0.6245` → IC=+0.187 (n=640)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6245 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `1.1954` → IC=+0.193 (n=640)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.1954 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.2825` → IC=+0.275 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2825 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.2742` → IC=+0.217 (n=839)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2742 (IC base=+0.197)

- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.180 (n=1422)
...
- **PATRÓN** `ibs_20min` > `0.8271` → IC=+0.256 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8271 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.431` → IC=+0.351 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.431 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2129` → IC=+0.207 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2129 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.9052` → IC=+0.142 (n=252)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.9052 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=249)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.142)
...
- **PATRÓN** `libro_liquidez` > `1989.2275` → IC=+0.332 (n=93)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1989.2275 (IC base=+0.277)

- **PATRÓN** `ballena_activa_n` < `72.0` → IC=+0.271 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 72.0 (IC base=+0.277)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.175 (n=152)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.175 (n=450)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 6.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.3271` → IC=+0.208 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3271 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.2504` → IC=+0.247 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2504 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.699` → IC=+0.207 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.699 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.160 (n=451)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2673 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `1.0941` → IC=+0.175 (n=204)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0941 (IC base=+0.154)
...
- **PATRÓN** `volumen_spike_ratio` < `2.109` → IC=+0.180 (n=354)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.109 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.694` → IC=+0.196 (n=268)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.694 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `11757.2155` → IC=+0.182 (n=300)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 11757.2155 (IC base=+0.154)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.172 (n=196)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0047 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.2645` → IC=+0.183 (n=377)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.2645 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 7.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.181 (n=446)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 18.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.376` → IC=+0.220 (n=377)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.376 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.739` → IC=+0.177 (n=478)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.739 (IC base=+0.168)
...
- **PATRÓN** `volumen_regimen` > `1.186` → IC=+0.169 (n=143)
  ...
  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.186 (IC base=+0.168)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4777` → IC=+0.193 (n=333)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.4777 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.5036` → IC=+0.189 (n=297)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.5036 (IC base=+0.168)
...
- **PATRÓN** `libro_liquidez` > `12099.1189` → IC=+0.175 (n=195)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 12099.1189 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `310.0` → IC=+0.175 (n=78)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 310.0 (IC base=+0.168)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.242 (n=176)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.096` → IC=+0.348 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.096 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` < `0.2259` → IC=+0.186 (n=310)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2259 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` < `2.0211` → IC=+0.213 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0211 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `3.6777` → IC=+0.174 (n=139)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 3.6777 (IC base=+0.181)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.204 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.181)

- **PATRÓN** `libro_liquidez` > `1854.4986` → IC=+0.201 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1854.4986 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.225 (n=78)
...
- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.333 (n=352)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.025` → IC=+0.316 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.025 (IC base=+0.269)

- **PATRÓN** `volumen_pendiente_norm` > `0.307` → IC=+0.288 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.307 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` < `3.3802` → IC=+0.265 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.3802 (IC base=+0.269)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.154 (n=455)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.345` → IC=+0.200 (n=455)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.433` → IC=+0.200 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.433 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.6268` → IC=+0.182 (n=152)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6268 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `1.193` → IC=+0.162 (n=152)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.193 (IC base=+0.143)
...
- **PATRÓN** `volumen_spike_ratio` > `1.3991` → IC=+0.197 (n=420)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.3991 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `5254.2901` → IC=+0.228 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5254.2901 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.182 (n=221)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 166.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.187 (n=330)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0076 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.5023` → IC=+0.168 (n=375)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.5023 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.188 (n=267)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 11.0 (IC base=+0.159)

- **PATRÓN** `ibs_20min` < `0.0802` → IC=+0.248 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0802 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` > `0.1614` → IC=+0.165 (n=189)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1614 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.6545` → IC=+0.181 (n=399)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6545 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.36` → IC=+0.242 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.36 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` < `0.597` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.597 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` > `1.1278` → IC=+0.201 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1278 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.2311` → IC=+0.344 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2311 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `2.2005` → IC=+0.190 (n=279)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.2005 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.4586` → IC=+0.183 (n=317)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.4586 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `9462.6339` → IC=+0.215 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9462.6339 (IC base=+0.159)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.235 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=+0.159)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.172 (n=230)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0108 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.161 (n=178)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 18.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.310 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `1.0494` → IC=+0.279 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0494 (IC base=+0.099)
...
- **PATRÓN** `libro_liquidez` > `2940.9508` → IC=+0.284 (n=169)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2940.9508 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.172 (n=285)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 68.0 (IC base=+0.099)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.183 (n=156)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0053 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.2632` → IC=+0.142 (n=311)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.2632 (IC base=+0.122)
...
- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.202 (n=467)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5833 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.454` → IC=+0.139 (n=425)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.454 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.042` → IC=+0.142 (n=456)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 3.042 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `0.7061` → IC=+0.152 (n=205)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7061 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` > `1.0671` → IC=+0.124 (n=211)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 1.0671 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.0719` → IC=+0.179 (n=129)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0456` → IC=+0.149 (n=280)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.0456 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` > `1.7367` → IC=+0.168 (n=212)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.7367 (IC base=+0.122)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=484)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `2581.4636` → IC=+0.171 (n=211)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2581.4636 (IC base=+0.122)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0266` → IC=+0.219 (n=201)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0266 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.195 (n=231)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 17.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` > `0.9643` → IC=+0.296 (n=273)
...
- **PATRÓN** `volumen_regimen` < `0.611` → IC=+0.180 (n=201)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.611 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `1.0357` → IC=+0.198 (n=273)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 1.0357 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` > `0.1717` → IC=+0.255 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1717 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `1.8207` → IC=+0.186 (n=368)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.8207 (IC base=+0.172)
...
- **PATRÓN** `libro_liquidez` > `3101.1726` → IC=+0.185 (n=201)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 3101.1726 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.214 (n=330)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4769` → IC=+0.232 (n=573)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4769 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.225 (n=598)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.218 (n=694)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` < `0.4884` → IC=+0.281 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4884 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `1.2095` → IC=+0.226 (n=763)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.032` → IC=+0.218 (n=648)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.032 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.258 (n=217)
...
- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.181 (n=365)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 37.0 (IC base=+0.217)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.152 (n=969)

- **PATRÓN** `sigma_h` < `0.0099` → IC=+0.137 (n=431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0099 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.160 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.118)

- **PATRÓN** `ibs_20min` > `0.9375` → IC=+0.154 (n=163)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.9375 (IC base=+0.118)

- **PATRÓN** `dist_vwap_pct` > `1.4075` → IC=+0.197 (n=120)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 1.4075 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.2` → IC=+0.183 (n=77)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 10.2 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `0.6136` → IC=+0.152 (n=136)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6136 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.8929` → IC=+0.136 (n=270)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.8929 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.2701` → IC=+0.181 (n=70)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.2701 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.3912` → IC=+0.154 (n=160)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.3912 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=444)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `7480.2551` → IC=+0.155 (n=326)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 7480.2551 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.196 (n=248)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0035 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.3481` → IC=+0.164 (n=650)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3481 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.153 (n=650)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.6296 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.085` → IC=+0.157 (n=738)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.085 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.1703` → IC=+0.160 (n=310)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1703 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` < `0.3612` → IC=+0.142 (n=727)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3612 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.056` → IC=+0.152 (n=331)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 4.056 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.039` → IC=+0.151 (n=740)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.039 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.2164` → IC=+0.159 (n=723)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2164 (IC base=+0.146)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0717` → IC=+0.158 (n=352)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0717 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.4869` → IC=+0.164 (n=730)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.4869 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.5136` → IC=+0.150 (n=652)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.5136 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=969)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `10654.8111` → IC=+0.158 (n=492)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 10654.8111 (IC base=+0.146)
...
- **PATRÓN** `ibs_20min` > `0.8876` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.8876 (IC base=+0.077)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.181 (n=224)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0096 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.4407` → IC=+0.168 (n=197)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.4407 (IC base=+0.147)
...
- **PATRÓN** `ibs_20min` < `0.175` → IC=+0.162 (n=75)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.175 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.7903` → IC=+0.173 (n=102)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.7903 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `1.1055` → IC=+0.212 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1055 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.4091` → IC=+0.165 (n=189)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4091 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.126` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 11.126 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.678` → IC=+0.149 (n=223)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.678 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6457` → IC=+0.188 (n=75)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6457 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1754` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1754 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `1.4096` → IC=+0.207 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4096 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `8850.2598` → IC=+0.188 (n=200)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 8850.2598 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` < `0.0054` → IC=+0.175 (n=152)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0054 (IC base=+0.059)

- **PATRÓN** `ibs_20min` > `0.649` → IC=+0.201 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.649 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.1249` → IC=+0.149 (n=72)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.1249 (IC base=+0.059)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.41` → IC=+0.224 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.41 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` < `0.0801` → IC=+0.233 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0801 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4999` → IC=+0.271 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4999 (IC base=+0.059)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.142 (n=121)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=+0.059)

- **PATRÓN** `libro_liquidez` > `2484.2771` → IC=+0.132 (n=74)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2484.2771 (IC base=+0.059)
...
- **PATRÓN** `ibs_20min` > `0.7741` → IC=+0.202 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7741 (IC base=+0.060)

- **PATRÓN** `dist_vwap_pct` > `0.1642` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1642 (IC base=+0.060)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.414` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 16.414 (IC base=+0.060)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.149 (n=55)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 15.0 (IC base=+0.026)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2185` → IC=+0.146 (n=46)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.2185 (IC base=+0.092)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.214 (n=26)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.092)

- **PATRÓN** `ibs_20min` < `0.3394` → IC=+0.155 (n=56)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.3394 (IC base=+0.092)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.519` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 3.519 (IC base=+0.092)

- **PATRÓN** `volumen_regimen` < `1.1843` → IC=+0.121 (n=56)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.1843 (IC base=+0.092)

- **PATRÓN** `libro_liquidez` > `3771.3449` → IC=+0.121 (n=56)

  - _Acción_: Kelly boost +0.60€ cuando `libro_liquidez` > 3771.3449 (IC base=+0.092)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.173 (n=808)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2493)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.211 (n=777)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=2536)

- **FILTRO** `ibs_20min` > `0.2709` → IC=-0.172 (n=828)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2709
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=2485)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.242 (n=118)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=360)

- **FILTRO** `ibs_20min` < `0.7265` → IC=-0.203 (n=119)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7265
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=359)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.193 (n=187)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=368)

- **FILTRO** `ibs_20min` > `0.7585` → IC=-0.200 (n=138)
...
- **FILTRO** `py_entrada` > `0.515` → IC=-0.180 (n=145)

  - _Acción_: SKIP cuando `py_entrada` > 0.515
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=442)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.148 (n=143)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=444)

### MOMENTUM_IBS_15M_BALLENA#SOL#15min
- **FILTRO** `py_entrada` > `0.62` → IC=-0.215 (n=121)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=398)

- **FILTRO** `drift_20min_pct` |x|> `0.3785` → IC=-0.149 (n=129)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3785
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=390)

- **FILTRO** `ibs_20min` > `0.2759` → IC=-0.164 (n=129)
...
- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.154 (n=128)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=391)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.274 (n=131)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=399)

- **FILTRO** `ibs_20min` > `0.2761` → IC=-0.216 (n=132)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.143 (n=2406)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5764)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.282 (n=1965)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=6205)

- **FILTRO** `ibs_7min` < `0.7352` → IC=-0.233 (n=2042)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7352
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=6128)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.174 (n=2771)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=5399)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.228 (n=2305)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=7684)

- **FILTRO** `ibs_7min` > `0.7159` → IC=-0.173 (n=2497)
...
- **FILTRO** `ibs_7min` < `0.9797` → IC=-0.202 (n=727)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9797
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=375)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.259 (n=272)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=830)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.221 (n=425)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1283)

- **FILTRO** `drift_7min_pct` |x|> `0.1378` → IC=-0.156 (n=579)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1378
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1129)

- **FILTRO** `ibs_7min` > `0.8378` → IC=-0.192 (n=426)
...
- **FILTRO** `py_entrada` < `0.37` → IC=-0.252 (n=369)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1238)

- **FILTRO** `ibs_7min` < `0.8007` → IC=-0.163 (n=401)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8007
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1206)

- **FILTRO** `ballena_activa_n` > `155.0` → IC=-0.176 (n=399)

  - _Acción_: SKIP cuando `ballena_activa_n` > 155.0
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1208)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.220 (n=401)
...
- **FILTRO** `ballena_activa_n` > `129.0` → IC=-0.169 (n=406)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1229)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.192 (n=378)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=783)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.314 (n=375)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=786)

- **FILTRO** `ibs_7min` < `0.2127` → IC=-0.288 (n=290)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2127
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=871)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.276 (n=288)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=873)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.260 (n=369)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1373)

- **FILTRO** `ibs_7min` > `0.8164` → IC=-0.189 (n=435)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8164
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1307)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.153 (n=427)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=955)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.261 (n=324)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1058)

- **FILTRO** `ibs_7min` < `0.7615` → IC=-0.183 (n=345)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7615
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1037)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.216 (n=336)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=1046)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.133 (n=456)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=921)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.276 (n=341)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1036)

- **FILTRO** `ibs_7min` > `0.1827` → IC=-0.162 (n=468)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1827
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=909)
...
- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.198 (n=389)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1175)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.191 (n=377)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1187)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.185 (n=452)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1395)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.124 (n=445)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=909)

- **FILTRO** `py_entrada` < `0.39` → IC=-0.267 (n=337)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1017)

- **FILTRO** `ibs_7min` < `0.7534` → IC=-0.211 (n=337)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7534
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1017)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.224 (n=338)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1016)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.271 (n=347)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=1333)

- **FILTRO** `ibs_7min` > `0.8393` → IC=-0.163 (n=419)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8393
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1261)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.123 (n=157)
  ...
  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.505 (IC base=+0.074)

- **PATRÓN** `streak_len` < `3.0` → IC=+0.142 (n=149)

  - _Acción_: Kelly boost +0.71€ cuando `streak_len` < 3.0 (IC base=+0.074)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=1173)
...
- **PATRÓN** `ibs_15` < `0.1149` → IC=+0.140 (n=434)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.70€ cuando `ibs_15` < 0.1149 (IC base=+0.028)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.131 (n=177)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0053 (IC base=+0.019)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.138 (n=45)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.010)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1957` → IC=+0.321 (n=149)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1957 (IC base=+0.312)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1528` → IC=+0.330 (n=98)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1528 (IC base=+0.312)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3802` → IC=+0.384 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3802 (IC base=+0.312)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.333 (n=136)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.312)

- **PATRÓN** `ibs_15` > `0.7314` → IC=+0.379 (n=147)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7314 (IC base=+0.312)

- **PATRÓN** `dist_vwap_pct` > `0.447` → IC=+0.367 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.447 (IC base=+0.312)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.489` → IC=+0.343 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.489 (IC base=+0.312)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.313 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.312)

- **PATRÓN** `libro_liquidez` > `7959.8654` → IC=+0.382 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7959.8654 (IC base=+0.312)

- **PATRÓN** `ballena_activa_n` < `540.0` → IC=+0.382 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 540.0 (IC base=+0.312)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1971` → IC=+0.303 (n=74)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1971 (IC base=+0.288)
...
- **PATRÓN** `drift_60min` |x|≤ `0.16` → IC=+0.316 (n=74)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.16 (IC base=+0.288)

- **PATRÓN** `drift_15min` |x|≤ `0.4155` → IC=+0.321 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4155 (IC base=+0.288)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.325 (n=78)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.288)

- **PATRÓN** `ibs_15` > `0.7363` → IC=+0.326 (n=84)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7363 (IC base=+0.288)

- **PATRÓN** `dist_vwap_pct` > `0.4267` → IC=+0.385 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4267 (IC base=+0.288)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.871` → IC=+0.300 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.871 (IC base=+0.288)

- **PATRÓN** `libro_liquidez` > `8557.9163` → IC=+0.375 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8557.9163 (IC base=+0.288)

- **PATRÓN** `ballena_activa_n` < `480.0` → IC=+0.444 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 480.0 (IC base=+0.288)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0771` → IC=+0.400 (n=28)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0771 (IC base=+0.337)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1322` → IC=+0.386 (n=42)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1322 (IC base=+0.337)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2771` → IC=+0.353 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2771 (IC base=+0.337)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.344 (n=43)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.337)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.339 (n=60)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.337)

- **PATRÓN** `ibs_15` > `0.7117` → IC=+0.439 (n=63)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7117 (IC base=+0.337)

- **PATRÓN** `dist_vwap_pct` > `0.4682` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4682 (IC base=+0.337)

- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.337)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.588` → IC=+0.406 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.588 (IC base=+0.337)

- **PATRÓN** `libro_liquidez` > `3271.2182` → IC=+0.364 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3271.2182 (IC base=+0.337)
...
- **FILTRO** `sigma_h` > `0.0094` → IC=-0.147 (n=247)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0094
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=744)

- **FILTRO** `ibs_15` < `0.4545` → IC=-0.270 (n=98)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.4545
  - _Potencial_: sin este filtro IC_bueno=+0.161 (n=296)

- **FILTRO** `sigma_ewma_delta_pct` > `17.302` → IC=-0.174 (n=342)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.302
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2469)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3433` → IC=+0.144 (n=133)

  - _Acción_: Kelly boost +0.72€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3433 (IC base=-0.059)

- **PATRÓN** `ibs_15` > `0.6853` → IC=+0.269 (n=197)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6853 (IC base=-0.059)

- **PATRÓN** `delta_ratio_macro` |x|> `0.133` → IC=+0.282 (n=99)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.133 (IC base=-0.077)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1036` → IC=+0.372 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1036 (IC base=-0.077)

- **PATRÓN** `ibs_15` < `0.3247` → IC=+0.340 (n=148)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3247 (IC base=-0.077)

- **PATRÓN** `dist_vwap_pct` < `0.1156` → IC=+0.269 (n=141)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0603` → IC=+0.189 (n=43)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0603 (IC base=+0.043)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3346` → IC=+0.231 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3346 (IC base=+0.043)

- **PATRÓN** `ibs_15` > `0.4477` → IC=+0.179 (n=129)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` > 0.4477 (IC base=+0.043)

- **PATRÓN** `libro_liquidez` > `9700.4747` → IC=+0.205 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9700.4747 (IC base=+0.043)

- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1045` → IC=+0.281 (n=62)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1045 (IC base=+0.266)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.309 (n=61)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.266)

- **PATRÓN** `drift_60min` |x|≤ `0.2361` → IC=+0.266 (n=62)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2361 (IC base=+0.266)

- **PATRÓN** `drift_15min` |x|≤ `0.4277` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4277 (IC base=+0.266)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1` → IC=+0.286 (n=82)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1 (IC base=+0.266)
...
- **PATRÓN** `ibs_15` < `0.328` → IC=+0.351 (n=92)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.328 (IC base=+0.266)

- **PATRÓN** `dist_vwap_pct` < `0.3303` → IC=+0.271 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3303 (IC base=+0.266)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.326` → IC=+0.296 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.326 (IC base=+0.266)

- **PATRÓN** `libro_liquidez` > `12249.9576` → IC=+0.318 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12249.9576 (IC base=+0.266)

- **PATRÓN** `ballena_activa_n` < `206.0` → IC=+0.297 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 206.0 (IC base=+0.266)
...
- **FILTRO** `sigma_ewma_delta_pct` > `15.595` → IC=-0.151 (n=107)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=861)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0527` → IC=+0.323 (n=77)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0527 (IC base=+0.279)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1881` → IC=+0.322 (n=105)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1881 (IC base=+0.279)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3802` → IC=+0.325 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3802 (IC base=+0.279)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.311 (n=236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.279)

- **PATRÓN** `ibs_15` > `0.9641` → IC=+0.358 (n=104)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9641 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.2998` → IC=+0.353 (n=107)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.292` → IC=+0.277 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.292 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.277 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `12245.063` → IC=+0.335 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12245.063 (IC base=+0.279)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1871` → IC=+0.280 (n=130)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1871 (IC base=+0.259)

- **PATRÓN** `drift_15min` |x|≤ `0.6671` → IC=+0.259 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.6671 (IC base=+0.259)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1438` → IC=+0.284 (n=86)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1438 (IC base=+0.259)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3917` → IC=+0.303 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3917 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.283 (n=95)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.259)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.257 (n=134)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.259)

- **PATRÓN** `ibs_15` > `0.9676` → IC=+0.336 (n=59)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9676 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` > `0.3041` → IC=+0.347 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3041 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` > `24.523` → IC=+0.306 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 24.523 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.915` → IC=+0.262 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.915 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `13561.3229` → IC=+0.322 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13561.3229 (IC base=+0.259)

### UPDOWN_GBM_IBS_ALTO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.304 (n=100)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0072 (IC base=+0.300)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.312 (n=46)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.300)

- **PATRÓN** `drift_60min` |x|≤ `0.057` → IC=+0.326 (n=44)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.057 (IC base=+0.300)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1879` → IC=+0.375 (n=46)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1879 (IC base=+0.300)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2968` → IC=+0.357 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2968 (IC base=+0.300)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.345 (n=95)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.300)

- **PATRÓN** `ibs_15` > `0.864` → IC=+0.348 (n=90)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.864 (IC base=+0.300)

- **PATRÓN** `dist_vwap_pct` > `0.6525` → IC=+0.417 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6525 (IC base=+0.300)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.98` → IC=+0.304 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.98 (IC base=+0.300)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.664` → IC=+0.298 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.664 (IC base=+0.300)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.308 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.300)

- **PATRÓN** `libro_liquidez` > `10425.7161` → IC=+0.417 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10425.7161 (IC base=+0.300)

- **PATRÓN** `ballena_activa_n` < `263.0` → IC=+0.314 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 263.0 (IC base=+0.300)

### UPDOWN_OU_5M
- **FILTRO** `pct_spot_vs_ref` |x|> `0.1173` → IC=-0.241 (n=25)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.1173
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=49)

- **FILTRO** `sigma_h` > `0.0065` → IC=-0.200 (n=18)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0065
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6853 sube el IC de -0.059 a +0.269 en UPDOWN_GBM_15M_TARDIO (n=197). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3247 sube el IC de -0.077 a +0.340 en UPDOWN_GBM_15M_TARDIO (n=148). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.4477 sube el IC de +0.043 a +0.179 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=129). Ya aplicado como kelly_boost=+0.90€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.328 sube el IC de +0.266 a +0.351 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=92). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.9641 sube el IC de +0.279 a +0.358 en UPDOWN_GBM_IBS_ALTO (n=104). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.9676 sube el IC de +0.259 a +0.336 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=59). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.864 sube el IC de +0.300 a +0.348 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=90). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7314 sube el IC de +0.312 a +0.379 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=147). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.7363 sube el IC de +0.288 a +0.326 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=84). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.7117 sube el IC de +0.337 a +0.439 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=63). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 6846 | -0.103 | -1048.19€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 689 | -0.088 | -127.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 6157 | -0.105 | -920.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1187 | -0.005 | -188.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1187 | -0.005 | -188.28€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 689 | -0.088 | -127.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 689 | -0.088 | -127.54€ | 3 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 359 | -0.137 | -154.67€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 359 | -0.137 | -154.67€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 726 | -0.136 | -38.65€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 726 | -0.136 | -38.65€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2230 | -0.072 | -107.44€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2230 | -0.072 | -107.44€ | 1 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP | 1655 | -0.201 | -431.61€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 1655 | -0.201 | -431.61€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 31862 | +0.115 | -2006.65€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5882 | +0.186 | -206.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 22690 | +0.097 | -1708.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3183 | +0.120 | -41.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3808 | +0.063 | -648.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 21 | -0.065 | +2.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3782 | +0.065 | -644.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6585 | +0.133 | -153.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1660 | +0.195 | -98.20€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3777 | +0.109 | -88.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1106 | +0.129 | +55.64€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3816 | +0.081 | -472.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 21 | +0.065 | +3.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3794 | +0.081 | -473.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 7070 | +0.128 | -83.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2142 | +0.168 | -10.14€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3778 | +0.115 | -40.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1138 | +0.102 | -23.76€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6777 | +0.136 | -395.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2021 | +0.203 | -102.72€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3771 | +0.102 | -209.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 939 | +0.132 | -73.43€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3806 | +0.107 | -253.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 