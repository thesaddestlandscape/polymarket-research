# Hipótesis automáticas — 2026-09-25 08:56 UTC
_Generado por shadow_postmortem.py sobre 602266 resoluciones (PNL=+68129.10€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=494)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.123 (n=494)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.495 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.148 (n=177)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 94.0 (IC base=+0.051)
...
- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.157 (n=138)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 95.0 (IC base=+0.052)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.07` → IC=-0.231 (n=7120)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.07
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=21363)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `137.87` → IC=-0.250 (n=933)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 137.87
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=2802)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `500.82` → IC=-0.149 (n=368)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 500.82
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1104)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `125.44` → IC=-0.307 (n=870)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.44
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2611)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `165.28` → IC=-0.217 (n=1721)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.28
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=5164)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `126.93` → IC=-0.353 (n=1401)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 126.93
  - _Potencial_: sin este filtro IC_bueno=-0.117 (n=4205)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.205 (n=13950)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=3522)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5652.3116` → IC=+0.178 (n=2241)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.138 (n=526)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.137 (n=668)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=549)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `1302.9991` → IC=+0.148 (n=663)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.434 (n=631)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.246 (n=861)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.242)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.245 (n=862)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2080.8345` → IC=+0.440 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2080.8345 (IC base=+0.430)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.175 (n=6261)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 7.0 (IC base=+0.172)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.189 (n=6270)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.266 (n=2125)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.221)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.210 (n=5687)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.297 (n=559)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1450.7635` → IC=+0.306 (n=478)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4857` → IC=+0.122 (n=8162)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4857 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9836` → IC=+0.244 (n=2721)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9836 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.8442` → IC=+0.247 (n=493)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8442 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` < `0.6336` → IC=+0.249 (n=2313)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6336 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.343` → IC=+0.187 (n=2158)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 8.343 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2103` → IC=+0.246 (n=2218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2103 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0457` → IC=+0.259 (n=1006)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0457 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.304` → IC=+0.222 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.304 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.4634` → IC=+0.202 (n=5604)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4634 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.571` → IC=+0.135 (n=9835)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.571 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` > `0.6159` → IC=+0.200 (n=727)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6159 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` < `0.1552` → IC=+0.175 (n=3121)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1552 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` < `0.6977` → IC=+0.184 (n=1518)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6977 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `0.8683` → IC=+0.176 (n=2299)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8683 (IC base=+0.066)

- **PATRÓN** `volumen_pendiente_norm` > `0.1671` → IC=+0.227 (n=1645)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1671 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.5694` → IC=+0.202 (n=5192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5694 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.212 (n=5601)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3502` → IC=+0.166 (n=1841)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.448` → IC=+0.248 (n=1448)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.448 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.092` → IC=+0.232 (n=1197)
...
- **PATRÓN** `libro_liquidez` > `1807.5508` → IC=+0.239 (n=928)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1807.5508 (IC base=+0.236)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.232 (n=622)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0032 (IC base=+0.216)

- **PATRÓN** `drift_60min` |x|≤ `0.0853` → IC=+0.246 (n=470)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0853 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.231 (n=1475)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.216)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.216 (n=1432)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.9861` → IC=+0.272 (n=471)
...
- **PATRÓN** `dist_vwap_pct` < `0.576` → IC=+0.220 (n=1475)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.576 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.631` → IC=+0.261 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.631 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` < `1.2558` → IC=+0.219 (n=1408)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2558 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `0.8746` → IC=+0.225 (n=939)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7506` → IC=+0.216 (n=921)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7506 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.3766` → IC=+0.232 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3766 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `12518.8764` → IC=+0.219 (n=1258)
...
- **PATRÓN** `ibs_20min` < `0.3275` → IC=+0.199 (n=978)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.3275 (IC base=+0.142)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.236` → IC=+0.161 (n=234)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 11.236 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.274` → IC=+0.145 (n=1337)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 4.274 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.153 (n=1466)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.204 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.1564` → IC=+0.179 (n=388)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1564 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.154 (n=1356)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4292 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.4185` → IC=+0.151 (n=1356)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4185 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `14091.9548` → IC=+0.147 (n=977)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 14091.9548 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `235.0` → IC=+0.164 (n=561)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 235.0 (IC base=+0.142)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.210 (n=604)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0117 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1901)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.190 (n=1624)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.265 (n=716)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.199` → IC=+0.250 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.199 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.2102` → IC=+0.186 (n=1814)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2102 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` > `0.3585` → IC=+0.204 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3585 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `2.833` → IC=+0.204 (n=782)
...
- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.223 (n=1371)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.6053` → IC=+0.214 (n=1558)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `2.1997` → IC=+0.221 (n=952)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1997 (IC base=+0.212)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.216 (n=1056)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `1896.6084` → IC=+0.223 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1896.6084 (IC base=+0.212)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.217 (n=933)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.150 (n=101)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=2237)

- **PATRÓN** `ibs_20min` > `0.9456` → IC=+0.214 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9456 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` < `0.7929` → IC=+0.333 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7929 (IC base=+0.025)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.741` → IC=+0.160 (n=721)
...
- **PATRÓN** `ballena_activa_n` < `161.0` → IC=+0.330 (n=322)
...
- **PATRÓN** `volumen_regimen` < `0.8497` → IC=+0.165 (n=565)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8497 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` > `1.1597` → IC=+0.151 (n=282)
...
- **PATRÓN** `volumen_spike_ratio` > `1.518` → IC=+0.178 (n=709)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.125 (n=2212)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=1090)

- **FILTRO** `sigma_ewma_delta_pct` > `8.685` → IC=-0.207 (n=353)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.685
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2949)
...
- **FILTRO** `drift_60min` |x|> `0.6559` → IC=-0.185 (n=575)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1726)

- **FILTRO** `ibs_20min` < `0.7179` → IC=-0.153 (n=1518)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.201 (n=416)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1885)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.203 (n=840)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2534)

- **PATRÓN** `dist_vwap_pct` > `0.8213` → IC=+0.310 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8213 (IC base=-0.066)

- **PATRÓN** `dist_vwap_pct` < `0.2747` → IC=+0.310 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2747 (IC base=-0.066)

- **PATRÓN** `volumen_regimen` < `0.9776` → IC=+0.285 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9776 (IC base=-0.066)

- **PATRÓN** `volumen_regimen` > `0.616` → IC=+0.302 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.616 (IC base=-0.066)

- **PATRÓN** `volumen_pendiente_norm` < `0.1011` → IC=+0.293 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1011 (IC base=-0.066)

- **PATRÓN** `volumen_spike_ratio` < `2.1377` → IC=+0.293 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1377 (IC base=-0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.8125` → IC=+0.292 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8125 (IC base=-0.066)
...
- **PATRÓN** `volumen_regimen` > `1.2596` → IC=+0.285 (n=258)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1434` → IC=+0.257 (n=583)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1434 (IC base=-0.022)

- **PATRÓN** `volumen_spike_ratio` > `1.5272` → IC=+0.247 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5272 (IC base=-0.022)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.197 (n=3418)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0098 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4765` → IC=+0.189 (n=9154)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4765 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.7595` → IC=+0.289 (n=1082)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7595 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.608` → IC=+0.158 (n=4815)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.608 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.249 (n=3267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6895 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2947` → IC=+0.269 (n=868)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2947 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4663` → IC=+0.240 (n=1980)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4663 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6637` → IC=+0.243 (n=1977)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6637 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.267 (n=5449)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.157 (n=3400)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0091 (IC base=+0.074)

- **PATRÓN** `ibs_20min` < `0.5487` → IC=+0.155 (n=8975)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.5487 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.7279` → IC=+0.240 (n=636)
...
- **PATRÓN** `volumen_regimen` < `0.7092` → IC=+0.242 (n=1324)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7092 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` > `1.2044` → IC=+0.248 (n=1003)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6022` → IC=+0.262 (n=1750)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6022 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` > `2.3089` → IC=+0.258 (n=1803)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3089 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.266 (n=3860)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.074)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2584` → IC=-0.146 (n=705)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2584
  - _Potencial_: sin este filtro IC_bueno=+0.108 (n=2116)

- **FILTRO** `sigma_ewma_delta_pct` > `4.536` → IC=-0.159 (n=540)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.536
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1814)

- **PATRÓN** `ibs_20min` > `0.8935` → IC=+0.269 (n=708)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2229` → IC=+0.270 (n=176)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1547` → IC=+0.199 (n=406)
...
- **PATRÓN** `ibs_20min` > `0.8635` → IC=+0.159 (n=685)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8635 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3147` → IC=+0.177 (n=379)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.3147 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6744` → IC=+0.170 (n=846)
...
- **PATRÓN** `volumen_spike_ratio` < `1.425` → IC=+0.198 (n=309)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.425 (IC base=+0.026)

- **PATRÓN** `volumen_spike_ratio` > `2.3807` → IC=+0.153 (n=309)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.3807 (IC base=+0.026)

- **PATRÓN** `ballena_activa_n` < `243.0` → IC=+0.196 (n=403)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 243.0 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` < `0.1614` → IC=+0.224 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1614 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `0.8539` → IC=+0.227 (n=383)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4434` → IC=+0.226 (n=177)
...
- **PATRÓN** `libro_liquidez` > `1800.8228` → IC=+0.247 (n=1076)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1800.8228 (IC base=+0.245)

- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.320 (n=587)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0099 (IC base=+0.283)

- **PATRÓN** `drift_60min` |x|≤ `0.6107` → IC=+0.284 (n=1291)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2252` → IC=+0.289 (n=1136)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2252 (IC base=+0.283)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.812` → IC=+0.296 (n=509)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7291` → IC=+0.289 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7291 (IC base=+0.283)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.287 (n=867)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.283)

- **PATRÓN** `libro_liquidez` > `1883.1265` → IC=+0.299 (n=586)
...
- **FILTRO** `ibs_20min` < `0.294` → IC=-0.184 (n=501)

  - _Acción_: SKIP cuando `ibs_20min` < 0.294
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1506)

- **FILTRO** `ibs_20min` > `0.7753` → IC=-0.188 (n=604)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7753
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1815)

- **PATRÓN** `ibs_20min` > `0.8224` → IC=+0.160 (n=683)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8224 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` > `0.4473` → IC=+0.223 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4473 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` < `0.7002` → IC=+0.214 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7002 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` < `0.9969` → IC=+0.238 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9969 (IC base=+0.014)

- **PATRÓN** `volumen_regimen` > `0.5902` → IC=+0.215 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5902 (IC base=+0.014)

- **PATRÓN** `volumen_pendiente_norm` > `0.1662` → IC=+0.268 (n=140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1662 (IC base=+0.014)
...
- **PATRÓN** `ballena_activa_n` < `149.0` → IC=+0.246 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 149.0 (IC base=+0.014)

- **PATRÓN** `dist_vwap_pct` > `0.1552` → IC=+0.212 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1552 (IC base=-0.005)

- **PATRÓN** `dist_vwap_pct` < `0.6847` → IC=+0.201 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6847 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `1.1649` → IC=+0.214 (n=431)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5364` → IC=+0.236 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5364 (IC base=-0.005)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.253 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=-0.005)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7258` → IC=-0.196 (n=1085)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7258
  - _Potencial_: sin este filtro IC_bueno=+0.280 (n=1086)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.235 (n=557)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1694)

- **FILTRO** `sigma_ewma_delta_pct` > `4.709` → IC=-0.184 (n=491)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.709
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=1760)

- **PATRÓN** `ibs_20min` > `0.7258` → IC=+0.280 (n=1086)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7258 (IC base=+0.043)

- **PATRÓN** `dist_vwap_pct` > `0.8494` → IC=+0.339 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8494 (IC base=+0.043)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.606` → IC=+0.169 (n=345)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 9.606 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.306 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.043)

- **PATRÓN** `volumen_regimen` > `0.7306` → IC=+0.297 (n=716)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7306 (IC base=+0.043)

- **PATRÓN** `volumen_pendiente_norm` < `0.1022` → IC=+0.294 (n=745)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4182` → IC=+0.328 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4182 (IC base=+0.043)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.316 (n=681)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.588` → IC=+0.301 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.588 (IC base=+0.276)

- **PATRÓN** `volumen_regimen` > `0.8606` → IC=+0.301 (n=886)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8606 (IC base=+0.276)

- **PATRÓN** `volumen_pendiente_norm` > `0.2814` → IC=+0.324 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2814 (IC base=+0.276)

- **PATRÓN** `volumen_spike_ratio` > `2.1495` → IC=+0.294 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1495 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.282 (n=1426)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `2632.9944` → IC=+0.292 (n=886)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2632.9944 (IC base=+0.276)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.170 (n=2664)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.202 (n=2658)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.187 (n=2655)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=8279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.576` → IC=+0.219 (n=7964)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.576 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1772` → IC=+0.196 (n=3469)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1772 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.347` → IC=+0.255 (n=1632)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.347 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.160 (n=5272)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2113 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6307` → IC=+0.161 (n=5272)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6307 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2957` → IC=+0.197 (n=1191)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2957 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.559` → IC=+0.168 (n=3362)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.559 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6202` → IC=+0.177 (n=2547)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6202 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2404.8169` → IC=+0.169 (n=5309)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2404.8169 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `115.0` → IC=+0.181 (n=6880)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 115.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.183 (n=5079)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0812` → IC=+0.208 (n=2539)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.48` → IC=+0.227 (n=7612)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.48 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.9221` → IC=+0.146 (n=739)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.9221 (IC base=+0.168)
...
- **PATRÓN** `volumen_regimen` < `1.1736` → IC=+0.152 (n=5509)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2526` → IC=+0.171 (n=3140)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2526 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `115.0` → IC=+0.174 (n=6568)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.190 (n=615)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0075 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.3426` → IC=+0.207 (n=1357)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3426 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=1425)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 5.0 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.193 (n=912)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 11.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` > `0.8969` → IC=+0.279 (n=904)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8969 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.310 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.122 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2301` → IC=+0.235 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2301 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.181 (n=1256)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0742` → IC=+0.195 (n=395)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.0742 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=1247)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4049` → IC=+0.228 (n=1185)
...
- **PATRÓN** `volumen_regimen` < `1.2629` → IC=+0.163 (n=1185)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2629 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0753` → IC=+0.170 (n=537)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4541` → IC=+0.161 (n=384)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.4541 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `11871.8913` → IC=+0.169 (n=1058)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 11871.8913 (IC base=+0.162)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.224 (n=607)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0101 (IC base=+0.199)

- **PATRÓN** `drift_60min` |x|≤ `0.2325` → IC=+0.216 (n=892)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2325 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.220 (n=463)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.877` → IC=+0.271 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.877 (IC base=+0.199)

- **PATRÓN** `volumen_pendiente_norm` > `0.2072` → IC=+0.203 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2072 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` < `1.6285` → IC=+0.200 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6285 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `2.847` → IC=+0.213 (n=576)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.847 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=946)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `1966.82` → IC=+0.199 (n=446)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 1966.82 (IC base=+0.199)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.159 (n=1272)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4324 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1331)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.375` → IC=+0.198 (n=1272)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.375 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1604` → IC=+0.180 (n=843)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1604 (IC base=+0.143)
...
- **PATRÓN** `volumen_regimen` < `1.0413` → IC=+0.145 (n=1119)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0413 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6279` → IC=+0.148 (n=1272)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5103` → IC=+0.169 (n=415)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.5103 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6271.1406` → IC=+0.182 (n=848)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 6271.1406 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `163.0` → IC=+0.148 (n=1210)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 163.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.154 (n=1339)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0072 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.3836` → IC=+0.143 (n=1339)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3836 (IC base=+0.124)
...
- **PATRÓN** `dist_vwap_pct` < `0.5831` → IC=+0.133 (n=1556)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.5831 (IC base=+0.124)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4402` → IC=+0.141 (n=463)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4402 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=1503)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.197 (n=652)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.119)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.137 (n=1094)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=919)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1428)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.74` → IC=+0.259 (n=1233)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.578` → IC=+0.242 (n=650)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.578 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` < `1.2034` → IC=+0.203 (n=1379)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2034 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `0.6237` → IC=+0.212 (n=1379)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6237 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2334` → IC=+0.265 (n=262)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2334 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `2.1485` → IC=+0.211 (n=1173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1485 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4095` → IC=+0.208 (n=1332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4095 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.204 (n=1470)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `2827.677` → IC=+0.210 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2827.677 (IC base=+0.201)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.164 (n=644)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0039 (IC base=+0.147)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.175 (n=642)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0088 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.1369` → IC=+0.155 (n=845)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1369 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=961)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.5405` → IC=+0.188 (n=1714)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5405 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.8649` → IC=+0.182 (n=306)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.8649 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.699` → IC=+0.174 (n=869)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.699 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.8735` → IC=+0.165 (n=1126)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8735 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `0.7005` → IC=+0.151 (n=1509)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.7005 (IC base=+0.147)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4385` → IC=+0.164 (n=617)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4385 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.825` → IC=+0.152 (n=1233)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.825 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.151 (n=2181)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `12451.6072` → IC=+0.159 (n=640)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12451.6072 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.168 (n=1697)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 158.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.140 (n=1335)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0056 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.3445` → IC=+0.127 (n=1757)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3445 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.126 (n=2012)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.6606` → IC=+0.140 (n=1998)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.6606 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.2152` → IC=+0.123 (n=1776)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.2152 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.126 (n=792)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 0.6986 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.1652` → IC=+0.125 (n=494)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_pendiente_norm` > 0.1652 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4529` → IC=+0.143 (n=642)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4529 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2755.5763` → IC=+0.125 (n=1784)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 2755.5763 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.123 (n=812)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 29.0 (IC base=+0.112)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3432` → IC=+0.122 (n=482)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.3432 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.150 (n=452)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 8.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2515` → IC=+0.145 (n=482)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.2515 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3081` → IC=+0.157 (n=170)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.3081 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6213` → IC=+0.150 (n=161)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6213 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `15011.8449` → IC=+0.141 (n=321)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 15011.8449 (IC base=+0.104)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.193 (n=200)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.208 (n=622)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.193)

- **PATRÓN** `ibs_20min` > `0.9719` → IC=+0.272 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9719 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.1568` → IC=+0.207 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1568 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.2301` → IC=+0.195 (n=526)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` < 0.2301 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.042` → IC=+0.227 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.042 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` < `0.836` → IC=+0.201 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.836 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` > `1.1584` → IC=+0.213 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1584 (IC base=+0.193)

- **PATRÓN** `volumen_pendiente_norm` > `0.2624` → IC=+0.275 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2624 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` < `1.3982` → IC=+0.229 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3982 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` > `2.4379` → IC=+0.234 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4379 (IC base=+0.193)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `12439.6953` → IC=+0.223 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12439.6953 (IC base=+0.193)
...
- **FILTRO** `dist_vwap_pct` > `0.3436` → IC=-0.139 (n=34)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.094 (n=498)
...
- **PATRÓN** `ibs_20min` < `0.5217` → IC=+0.152 (n=400)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5217 (IC base=+0.079)

- **PATRÓN** `volumen_regimen` < `0.7082` → IC=+0.137 (n=177)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.7082 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` < `1.8403` → IC=+0.155 (n=250)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.8403 (IC base=+0.079)

- **PATRÓN** `libro_liquidez` > `2554.7355` → IC=+0.127 (n=266)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 2554.7355 (IC base=+0.079)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.129 (n=343)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 42.0 (IC base=+0.079)
...
- **PATRÓN** `drift_60min` |x|≤ `0.356` → IC=+0.191 (n=1726)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.195 (n=1173)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 11.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.328 (n=624)
...
- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.265 (n=1358)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.270 (n=1222)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.467` → IC=+0.264 (n=1420)
...
- **PATRÓN** `libro_liquidez` > `1806.4548` → IC=+0.265 (n=904)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1703)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.3085` → IC=+0.205 (n=1633)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.242` → IC=+0.155 (n=1472)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.242 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.629` → IC=+0.178 (n=545)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.629 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.2666` → IC=+0.199 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2666 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.1148` → IC=+0.161 (n=1388)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1148 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.4047` → IC=+0.156 (n=1578)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.4047 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `15752.6972` → IC=+0.159 (n=740)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 15752.6972 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `473.0` → IC=+0.158 (n=1511)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2581` → IC=+0.168 (n=1243)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6603` → IC=+0.198 (n=1413)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.6603 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.6891` → IC=+0.157 (n=231)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.6891 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.1343` → IC=+0.168 (n=1275)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1343 (IC base=+0.154)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.274` → IC=+0.154 (n=1280)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.274 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `1.1894` → IC=+0.166 (n=1413)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.1894 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.1514` → IC=+0.199 (n=377)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1514 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.4071` → IC=+0.161 (n=1315)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4071 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.166 (n=876)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `420.0` → IC=+0.158 (n=1071)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 420.0 (IC base=+0.154)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.012` → IC=+0.247 (n=551)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.012 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=1727)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1676)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` < `0.0117` → IC=+0.239 (n=1540)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0117 (IC base=+0.233)

- **PATRÓN** `drift_60min` |x|≤ `0.1677` → IC=+0.237 (n=678)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1677 (IC base=+0.233)
...
- **PATRÓN** `ibs_20min` < `0.0152` → IC=+0.310 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0152 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.76` → IC=+0.274 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.76 (IC base=+0.233)

- **PATRÓN** `volumen_pendiente_norm` > `0.3437` → IC=+0.308 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3437 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` < `1.7536` → IC=+0.233 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7536 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` > `2.1878` → IC=+0.236 (n=943)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1878 (IC base=+0.233)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.240 (n=1044)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.233)

- **PATRÓN** `libro_liquidez` > `1951.7572` → IC=+0.246 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1951.7572 (IC base=+0.233)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.231 (n=1346)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.44` → IC=+0.167 (n=283)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.44 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8764` → IC=+0.157 (n=1156)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8764 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5214` → IC=+0.152 (n=739)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.5214 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.767` → IC=+0.150 (n=1119)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.767 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8051.1298` → IC=+0.231 (n=786)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8051.1298 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `91.0` → IC=+0.150 (n=713)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 91.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.155 (n=1414)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0076 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.4464` → IC=+0.153 (n=1414)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7021` → IC=+0.184 (n=1414)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.7021 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.5977` → IC=+0.142 (n=1567)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.5977 (IC base=+0.138)
...
- **PATRÓN** `volumen_regimen` < `0.6962` → IC=+0.153 (n=623)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6962 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.1921` → IC=+0.143 (n=472)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.151 (n=1341)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `7268.5561` → IC=+0.201 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7268.5561 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `178.0` → IC=+0.145 (n=1341)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 178.0 (IC base=+0.138)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.141 (n=1149)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0081 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1769)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.192 (n=1727)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.4706 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.0865` → IC=+0.204 (n=353)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0865 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.493` → IC=+0.236 (n=647)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.493 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.8928` → IC=+0.135 (n=1150)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8928 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1732)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.249 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.133 (n=1339)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1728)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1675)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.22` → IC=+0.132 (n=1369)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.22 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.486` → IC=+0.127 (n=1618)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4467` → IC=+0.144 (n=504)
...
- **PATRÓN** `ibs_20min` < `0.4224` → IC=+0.267 (n=1619)
...
- **PATRÓN** `dist_vwap_pct` < `0.9274` → IC=+0.203 (n=2045)
...
- **PATRÓN** `volumen_regimen` > `1.2347` → IC=+0.235 (n=614)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1859` → IC=+0.198 (n=1458)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.1859 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4305` → IC=+0.197 (n=1656)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4305 (IC base=+0.201)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=3097)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.166 (n=2609)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0091 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.5175` → IC=+0.165 (n=2965)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.5175 (IC base=+0.156)
...
- **PATRÓN** `ibs_20min` > `0.9415` → IC=+0.214 (n=988)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9415 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.1887` → IC=+0.167 (n=1087)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1887 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.4846` → IC=+0.152 (n=1838)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4846 (IC base=+0.156)
...
- **PATRÓN** `volumen_regimen` > `0.8972` → IC=+0.168 (n=1302)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.8972 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.1712` → IC=+0.191 (n=816)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1712 (IC base=+0.156)
...
- **PATRÓN** `drift_60min` |x|≤ `0.487` → IC=+0.158 (n=2335)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.303` → IC=+0.150 (n=2319)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.303 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.9002` → IC=+0.158 (n=1489)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.9002 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.0966` → IC=+0.143 (n=2113)
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.174 (n=422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 4.0 (IC base=+0.169)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.180 (n=179)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 8.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` < `0.5452` → IC=+0.196 (n=268)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.5452 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.2159` → IC=+0.177 (n=190)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.2159 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.3742` → IC=+0.171 (n=390)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.3742 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.129` → IC=+0.179 (n=26)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 10.129 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.415` → IC=+0.177 (n=425)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` < 2.415 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.231` → IC=+0.176 (n=402)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3035` → IC=+0.300 (n=43)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3035 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `1.4485` → IC=+0.199 (n=134)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4485 (IC base=+0.169)
...
- **PATRÓN** `libro_liquidez` > `12575.9809` → IC=+0.217 (n=359)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.168 (n=843)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0072 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.169 (n=957)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0043 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.383` → IC=+0.168 (n=842)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.383 (IC base=+0.163)
...
- **PATRÓN** `ibs_20min` < `0.5596` → IC=+0.167 (n=638)
...
- **PATRÓN** `dist_vwap_pct` < `0.4235` → IC=+0.172 (n=892)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.4235 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.12` → IC=+0.173 (n=858)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` < 4.12 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.0865` → IC=+0.164 (n=842)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.0865 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.7181` → IC=+0.166 (n=855)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 0.7181 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` < `0.1056` → IC=+0.164 (n=879)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.1056 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.078` → IC=+0.172 (n=415)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5168` → IC=+0.164 (n=838)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.5168 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=949)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.187 (n=266)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0041 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.3907` → IC=+0.175 (n=702)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.159 (n=544)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `ibs_20min` > `0.0954` → IC=+0.151 (n=798)
...
- **PATRÓN** `dist_vwap_pct` < `0.3876` → IC=+0.144 (n=818)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.3876 (IC base=+0.144)
...
- **PATRÓN** `volumen_regimen` > `0.7262` → IC=+0.146 (n=713)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.7262 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` < `0.1513` → IC=+0.146 (n=823)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.1513 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2051` → IC=+0.157 (n=688)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.2051 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `1.783` → IC=+0.146 (n=521)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.783 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `7571.9816` → IC=+0.170 (n=798)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1808)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.125 (n=62)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=748)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.131 (n=63)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` < 0.495 (IC base=+0.003)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.124 (n=408)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=213)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.179 (n=166)

  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` < 0.47 (IC base=+0.011)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` < `0.55` → IC=+0.174 (n=44)

  - _Acción_: Kelly boost +0.87€ cuando `py_entrada` < 0.55 (IC base=+0.039)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.56` → IC=+0.211 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.56 (IC base=+0.084)

- **PATRÓN** `profundidad_ratio` > `46.0` → IC=+0.136 (n=75)

  - _Acción_: Kelly boost +0.68€ cuando `profundidad_ratio` > 46.0 (IC base=+0.084)
...
- **FILTRO** `py_entrada` > `0.519` → IC=-0.155 (n=27)
...
- **FILTRO** `lag_apertura_s` > `70.81` → IC=-0.318 (n=31)

  - _Acción_: SKIP cuando `lag_apertura_s` > 70.81
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=32)

- **FILTRO** `profundidad_ratio` < `67.5` → IC=-0.197 (n=31)
...
- **PATRÓN** `py_entrada` < `0.45` → IC=+0.237 (n=17)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.45 (IC base=+0.008)

- **PATRÓN** `profundidad_ratio` > `46.5` → IC=+0.167 (n=31)

  - _Acción_: Kelly boost +0.83€ cuando `profundidad_ratio` > 46.5 (IC base=+0.008)
...
- **FILTRO** `py_entrada` > `0.49` → IC=-0.122 (n=35)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7556)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.166 (n=3570)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10760)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.167 (n=3686)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=11151)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.208 (n=612)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1878)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.152 (n=650)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=2008)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.192 (n=625)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1914)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=644)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=2012)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.174 (n=609)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1869)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.176 (n=647)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=2015)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=10193)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=22583)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=8038)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=24738)

- **FILTRO** `ibs_7min` < `0.2821` → IC=-0.235 (n=8189)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2821
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=24587)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11125)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21651)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=10084)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=31079)

- **FILTRO** `ibs_7min` > `0.2923` → IC=-0.177 (n=10289)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2923
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=30874)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.136 (n=1664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3761)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=1294)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4131)

- **FILTRO** `ibs_7min` < `0.7111` → IC=-0.250 (n=1789)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7111
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3636)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.186 (n=1230)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4195)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.262 (n=1741)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5338)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.126 (n=2405)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4674)

- **FILTRO** `ibs_7min` > `0.788` → IC=-0.207 (n=1769)

  - _Acción_: SKIP cuando `ibs_7min` > 0.788
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=5310)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1334)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4320)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1369)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4285)

- **FILTRO** `ibs_7min` < `0.7471` → IC=-0.191 (n=1413)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7471
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4241)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.177 (n=1412)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4242)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.255 (n=1436)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=4313)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.178 (n=1435)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=4314)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.183 (n=1435)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4314)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1470)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3679)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1275)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3874)

- **FILTRO** `ibs_7min` < `0.7063` → IC=-0.244 (n=1699)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7063
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3450)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1727)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5840)

- **FILTRO** `ibs_7min` > `0.7456` → IC=-0.172 (n=1890)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1755)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3660)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.241 (n=1333)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4082)

- **FILTRO** `ibs_7min` < `0.7406` → IC=-0.180 (n=1353)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7406
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=4062)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.171 (n=1324)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4091)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1378)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4137)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.177 (n=1378)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4137)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.184 (n=1356)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4159)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.253 (n=1402)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4313)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.233 (n=1419)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4296)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1855)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5974)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1758)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3660)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.228 (n=1349)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4069)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1314)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4104)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.205 (n=1772)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5652)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1095)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=2941)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1495)
...
- **FILTRO** `dist_vwap_pct` > `0.5722` → IC=-0.135 (n=124)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=917)
...
- **FILTRO** `sigma_h` > `0.0129` → IC=-0.222 (n=667)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=2003)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.195 (n=905)
...
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.221 (n=406)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1221)
...
- **FILTRO** `hora_utc` > `7.0` → IC=-0.210 (n=1025)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3453 sube el IC de -0.031 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1798). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1334 | +0.100 | +201.07€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1334 | +0.100 | +201.07€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 995 | +0.109 | +172.94€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 995 | +0.109 | +172.94€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 253 | +0.057 | +9.47€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 253 | +0.057 | +9.47€ | 6 | 6 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 28483 | -0.090 | -3839.41€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1472 | -0.049 | -222.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27011 | -0.092 | -3617.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3735 | -0.096 | -622.09€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3735 | -0.096 | -622.09€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1472 | -0.049 | -222.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1472 | -0.049 | -222.28€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3481 | -0.097 | -793.45€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3481 | -0.097 | -793.45€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7304 | -0.022 | -678.15€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7304 | -0.022 | -678.15€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6885 | -0.093 | -432.40€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6885 | -0.093 | -432.40€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5606 | -0.176 | -1091.04€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5606 | -0.176 | -1091.04€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 18477 | -0.028 | +4014.53€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4816 | -0.000 | +1816.68€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 13661 | -0.037 | +2197.85€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 18477 | -0.028 | +4014.53€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4816 | -0.000 | +1816.68€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 13661 | -0.037 | +2197.85€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 93831 | +0.112 | -4748.17€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14123 | +0.185 | -420.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 378 | -0.082 | -50.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 73241 | +0.100 | -4060.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6089 | +0.107 | -217.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12180 | +0.098 | -1034.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 45 | -0.160 | -0.32€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12120 | +0.099 | -1022.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18980 | +0.131 | -370.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4459 | +0.204 | -130.19€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12143 | +0.111 | -203.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2336 | +0.103 | -15.09€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12219 | +0.089 | -1122.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 52 | -0.093 | -6.98€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12152 | +0.091 | -1104.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 19954 | +0.123 | -401.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5465 | +0.175 | -79.16€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12273 | +0.105 | -254.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2204 | +0.098 | -59.50€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18304 | +0.113 | -1089.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4055 | +0.188 | -212.43€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 281 | -0.041 | +3.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12419 | +0.091 | -738.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1549 | +0.125 | -142.42€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12194 | +0.100 | -728.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12134 | +0.101 | -736.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 14883 | +0.191 | -988.33€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 14883 | +0.191 | -988.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3541 | +0.167 | -373.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3541 | +0.167 | -373.45€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1253 | +0.195 | -14.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1253 | +0.195 | -14.11€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3490 | +0.179 | -302.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 