# Hipótesis automáticas — 2026-09-26 11:32 UTC
_Generado por shadow_postmortem.py sobre 619459 resoluciones (PNL=+70470.39€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=505)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.125 (n=505)

  - _Acción_: Kelly boost +0.63€ cuando `py_entrada` < 0.495 (IC base=+0.054)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.145 (n=184)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 94.0 (IC base=+0.054)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.119 (n=371)
...
- **PATRÓN** `libro_liquidez` > `11799.9463` → IC=+0.130 (n=144)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 11799.9463 (IC base=+0.058)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.169 (n=140)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 94.0 (IC base=+0.058)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.26` → IC=-0.224 (n=7268)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.26
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=21809)
...
- **FILTRO** `restante_s_al_confirmar` < `166.11` → IC=-0.209 (n=1772)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 166.11
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=5316)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `127.7` → IC=-0.342 (n=1430)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 127.7
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=4291)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.206 (n=14240)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3589)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5676.6756` → IC=+0.178 (n=2285)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2192)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1563)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.207 (n=1737)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2221)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.136 (n=539)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 11.0 (IC base=+0.104)

- **PATRÓN** `py_entrada` < `0.44` → IC=+0.142 (n=837)
...
- **PATRÓN** `libro_liquidez` > `5830.4537` → IC=+0.162 (n=223)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 5830.4537 (IC base=+0.104)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.236 (n=1526)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.139 (n=683)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1313.4858` → IC=+0.151 (n=678)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1313.4858 (IC base=+0.137)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.434 (n=648)
...
- **PATRÓN** `libro_liquidez` > `1448.5782` → IC=+0.308 (n=487)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.437 (n=598)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.446 (n=166)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.439)

- **PATRÓN** `py_entrada` < `0.925` → IC=+0.451 (n=181)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.439 (n=275)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4861` → IC=+0.123 (n=8387)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.4861 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9829` → IC=+0.243 (n=2796)
...
- **PATRÓN** `dist_vwap_pct` < `0.156` → IC=+0.252 (n=1696)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.156 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.974` → IC=+0.180 (n=3210)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 5.974 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.2021` → IC=+0.247 (n=2287)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2021 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` > `1.0422` → IC=+0.261 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0422 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.3029` → IC=+0.224 (n=846)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3029 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `1.4608` → IC=+0.204 (n=5775)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4608 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.571` → IC=+0.133 (n=10118)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.571 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` > `0.6067` → IC=+0.204 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6067 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.186 (n=1573)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6973 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `1.0497` → IC=+0.176 (n=1620)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0497 (IC base=+0.066)

- **PATRÓN** `volumen_pendiente_norm` > `0.1675` → IC=+0.226 (n=1709)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1675 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.5708` → IC=+0.201 (n=5391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5708 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `132.0` → IC=+0.211 (n=5818)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 132.0 (IC base=+0.066)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.185 (n=629)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3487` → IC=+0.168 (n=1885)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.168 (n=1272)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 11.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.271 (n=737)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.268 (n=811)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.122 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.213 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.165 (n=1767)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.177 (n=1923)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.04 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.245 (n=1284)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.235)

- **PATRÓN** `drift_60min` |x|≤ `0.09` → IC=+0.276 (n=479)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0519` → IC=+0.292 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0519 (IC base=+0.235)
...
- **PATRÓN** `dist_vwap_pct` > `0.1998` → IC=+0.220 (n=761)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1998 (IC base=+0.217)

- **PATRÓN** `dist_vwap_pct` < `0.5643` → IC=+0.221 (n=1520)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5643 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.779` → IC=+0.263 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.779 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` < `1.2501` → IC=+0.219 (n=1450)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2501 (IC base=+0.217)

- **PATRÓN** `volumen_regimen` > `1.0767` → IC=+0.227 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0767 (IC base=+0.217)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3804` → IC=+0.233 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3804 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `11163.5207` → IC=+0.225 (n=1449)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11163.5207 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.162 (n=1011)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0038 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0761` → IC=+0.165 (n=505)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3305` → IC=+0.192 (n=1008)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.3305 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1308` → IC=+0.155 (n=1355)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.301` → IC=+0.144 (n=1379)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 4.301 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.149 (n=1512)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1913 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.8498` → IC=+0.140 (n=1008)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.8498 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1561` → IC=+0.176 (n=402)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1561 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.152 (n=1402)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.42` → IC=+0.147 (n=1401)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.42 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `14092.9821` → IC=+0.146 (n=1008)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 14092.9821 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `233.0` → IC=+0.168 (n=580)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.191 (n=1961)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 5.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.189 (n=1678)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.185)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.264 (n=732)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.184` → IC=+0.256 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.184 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.2074` → IC=+0.187 (n=1874)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2074 (IC base=+0.185)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7984` → IC=+0.203 (n=808)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7984 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1311)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.221 (n=1419)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.6121` → IC=+0.211 (n=1612)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0643` → IC=+0.245 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0643 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.626` → IC=+0.234 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.626 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.57` → IC=+0.211 (n=1750)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.57 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.3508` → IC=+0.273 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3508 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` < `1.7621` → IC=+0.205 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7621 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.1841` → IC=+0.217 (n=988)
...
- **PATRÓN** `libro_liquidez` > `1907.76` → IC=+0.218 (n=731)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1907.76 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `23.0` → IC=+0.215 (n=961)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.144 (n=102)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=2284)
...
- **PATRÓN** `volumen_regimen` < `0.6874` → IC=+0.169 (n=385)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.6874 (IC base=+0.019)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5239` → IC=+0.174 (n=734)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.5239 (IC base=+0.019)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.124 (n=2263)

  - _Acción_: SKIP cuando `ibs_20min` > 0.25
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1126)

- **FILTRO** `sigma_ewma_delta_pct` > `8.708` → IC=-0.212 (n=363)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.708
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=3026)
...
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.183 (n=592)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1778)

- **FILTRO** `ibs_20min` < `0.7193` → IC=-0.154 (n=1564)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7193
  - _Potencial_: sin este filtro IC_bueno=+0.103 (n=806)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.199 (n=450)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1920)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.204 (n=862)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=2614)
...
- **PATRÓN** `dist_vwap_pct` > `0.8839` → IC=+0.271 (n=168)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8839 (IC base=-0.022)

- **PATRÓN** `volumen_regimen` < `0.6536` → IC=+0.251 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6536 (IC base=-0.022)

- **PATRÓN** `volumen_regimen` > `1.2467` → IC=+0.287 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2467 (IC base=-0.022)

- **PATRÓN** `volumen_pendiente_norm` > `0.1044` → IC=+0.277 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1044 (IC base=-0.022)

- **PATRÓN** `volumen_spike_ratio` < `2.1392` → IC=+0.257 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1392 (IC base=-0.022)

- **PATRÓN** `volumen_spike_ratio` > `1.5239` → IC=+0.250 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5239 (IC base=-0.022)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.197 (n=3529)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0098 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.4756` → IC=+0.187 (n=9451)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4756 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `1.0669` → IC=+0.287 (n=879)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0669 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.619` → IC=+0.156 (n=4958)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.619 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.250 (n=3374)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6895 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2936` → IC=+0.272 (n=896)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2936 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `1.4641` → IC=+0.236 (n=2043)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4641 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6474` → IC=+0.246 (n=2042)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6474 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.268 (n=5649)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 96.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.159 (n=3495)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0091 (IC base=+0.074)

- **PATRÓN** `ibs_20min` < `0.5495` → IC=+0.155 (n=9225)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6001` → IC=+0.260 (n=1820)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6001 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` > `2.2963` → IC=+0.260 (n=1876)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2963 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.267 (n=4019)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.074)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2583` → IC=-0.146 (n=729)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2583
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=2189)

- **FILTRO** `sigma_ewma_delta_pct` > `4.552` → IC=-0.161 (n=556)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.552
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1862)

- **PATRÓN** `ibs_20min` > `0.8947` → IC=+0.264 (n=731)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.277 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.043)

- **PATRÓN** `volumen_spike_ratio` < `1.433` → IC=+0.173 (n=310)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.433 (IC base=+0.043)

- **PATRÓN** `volumen_spike_ratio` > `2.1367` → IC=+0.201 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1367 (IC base=+0.043)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.186 (n=399)
...
- **PATRÓN** `ibs_20min` > `0.8648` → IC=+0.161 (n=708)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8648 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3086` → IC=+0.175 (n=383)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3086 (IC base=+0.026)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.168 (n=874)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6736 (IC base=+0.026)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4243` → IC=+0.189 (n=320)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.4243 (IC base=+0.026)
...
- **PATRÓN** `ballena_activa_n` < `242.0` → IC=+0.188 (n=421)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 242.0 (IC base=+0.026)

- **PATRÓN** `dist_vwap_pct` < `0.155` → IC=+0.217 (n=621)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.155 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` > `1.0197` → IC=+0.233 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0197 (IC base=+0.006)
...
- **PATRÓN** `ballena_activa_n` < `460.0` → IC=+0.217 (n=559)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.251 (n=1656)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.247)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.248 (n=1671)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.247)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.298 (n=875)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.247)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.691` → IC=+0.283 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.691 (IC base=+0.247)

- **PATRÓN** `volumen_pendiente_norm` < `0.1032` → IC=+0.260 (n=1405)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1032 (IC base=+0.247)

- **PATRÓN** `volumen_spike_ratio` > `3.3644` → IC=+0.262 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.3644 (IC base=+0.247)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.252 (n=1157)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.247)

- **PATRÓN** `libro_liquidez` > `1976.375` → IC=+0.251 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1976.375 (IC base=+0.247)

- **PATRÓN** `sigma_h` > `0.01` → IC=+0.312 (n=606)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.01 (IC base=+0.281)

- **PATRÓN** `drift_60min` |x|≤ `0.1743` → IC=+0.288 (n=588)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0909` → IC=+0.287 (n=892)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7377` → IC=+0.286 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7377 (IC base=+0.281)

- **PATRÓN** `volumen_spike_ratio` > `2.6992` → IC=+0.291 (n=562)
...
- **PATRÓN** `libro_liquidez` > `1900.3784` → IC=+0.294 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1900.3784 (IC base=+0.281)

- **PATRÓN** `ballena_activa_n` < `28.0` → IC=+0.285 (n=821)
...
- **FILTRO** `ibs_20min` < `0.2961` → IC=-0.177 (n=522)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1566)

- **FILTRO** `ibs_20min` > `0.7732` → IC=-0.184 (n=622)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7732
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1869)

- **PATRÓN** `ibs_20min` > `0.9118` → IC=+0.177 (n=522)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.9118 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` > `0.4372` → IC=+0.218 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4372 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` < `0.6801` → IC=+0.215 (n=619)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6801 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `0.9869` → IC=+0.239 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9869 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` > `0.5928` → IC=+0.216 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5928 (IC base=+0.013)

- **PATRÓN** `volumen_pendiente_norm` > `0.0768` → IC=+0.262 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0768 (IC base=+0.013)

- **PATRÓN** `volumen_spike_ratio` < `1.5053` → IC=+0.260 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5053 (IC base=+0.013)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.263 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 62.0 (IC base=+0.013)
...
- **FILTRO** `ibs_20min` < `0.7317` → IC=-0.195 (n=1121)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7317
  - _Potencial_: sin este filtro IC_bueno=+0.278 (n=1121)

- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.238 (n=570)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6875
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1732)

- **FILTRO** `sigma_ewma_delta_pct` > `4.71` → IC=-0.189 (n=503)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.71
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1799)

- **PATRÓN** `ibs_20min` > `0.7317` → IC=+0.278 (n=1121)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.65` → IC=+0.170 (n=353)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.65 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.304 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` > `0.7281` → IC=+0.293 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7281 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.295 (n=777)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.318 (n=909)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.74` → IC=+0.323 (n=1218)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.74 (IC base=+0.278)

- **PATRÓN** `dist_vwap_pct` > `0.2129` → IC=+0.316 (n=800)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2129 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.623` → IC=+0.302 (n=712)
...
- **PATRÓN** `libro_liquidez` > `2633.3465` → IC=+0.291 (n=909)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2633.3465 (IC base=+0.278)

- **PATRÓN** `sigma_h` > `0.0154` → IC=+0.302 (n=977)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3913` → IC=+0.306 (n=1465)
...
- **PATRÓN** `dist_vwap_pct` < `0.2283` → IC=+0.276 (n=1332)
...
- **PATRÓN** `volumen_regimen` > `1.2433` → IC=+0.309 (n=489)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4255` → IC=+0.282 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4255 (IC base=+0.275)

- **PATRÓN** `volumen_spike_ratio` > `2.1415` → IC=+0.275 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1415 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2625.3622` → IC=+0.278 (n=977)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.3622 (IC base=+0.275)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.173 (n=2736)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.200 (n=2726)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0113 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0903` → IC=+0.185 (n=2727)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0903 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.180 (n=8508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.5741` → IC=+0.218 (n=8169)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5741 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1761` → IC=+0.194 (n=3545)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1761 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.352` → IC=+0.256 (n=1669)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.352 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2087` → IC=+0.160 (n=5410)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2087 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6316` → IC=+0.161 (n=5410)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6316 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2425` → IC=+0.195 (n=1648)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2425 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5578` → IC=+0.167 (n=3450)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5578 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6117` → IC=+0.177 (n=2614)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6117 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2409.2447` → IC=+0.169 (n=5445)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2409.2447 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `112.0` → IC=+0.181 (n=7075)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 112.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.183 (n=5212)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0812` → IC=+0.210 (n=2604)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.5595` → IC=+0.165 (n=3135)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.5595 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2488` → IC=+0.171 (n=3229)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2488 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `114.0` → IC=+0.174 (n=6773)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 114.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.214 (n=463)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.19` → IC=+0.328 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.19 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2299` → IC=+0.240 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2299 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `1.4361` → IC=+0.183 (n=1284)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4361 (IC base=+0.183)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=1415)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.235 (n=409)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.0733` → IC=+0.190 (n=405)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.0733 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=1281)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4049` → IC=+0.226 (n=1213)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4049 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.211` → IC=+0.214 (n=711)
...
- **PATRÓN** `volumen_regimen` < `0.6876` → IC=+0.166 (n=534)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6876 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `1.0702` → IC=+0.170 (n=550)
...
- **PATRÓN** `ibs_20min` < `0.5687` → IC=+0.187 (n=1315)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5687 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1334` → IC=+0.160 (n=1307)
...
- **PATRÓN** `volumen_regimen` < `1.1967` → IC=+0.158 (n=1315)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1967 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.1543` → IC=+0.153 (n=402)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1543 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.4443` → IC=+0.146 (n=1203)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.4443 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.4225` → IC=+0.137 (n=1203)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4225 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `213.0` → IC=+0.163 (n=375)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2363` → IC=+0.217 (n=916)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2363 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.206 (n=1422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1022` → IC=+0.200 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1022 (IC base=+0.199)
...
- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.235 (n=1007)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0102 (IC base=+0.216)

- **PATRÓN** `drift_60min` |x|≤ `0.2471` → IC=+0.237 (n=763)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2471 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.271 (n=395)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` < `0.3493` → IC=+0.247 (n=1144)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3493 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.735` → IC=+0.257 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.735 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` > `0.3528` → IC=+0.262 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3528 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` < `1.7653` → IC=+0.211 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7653 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.1982` → IC=+0.231 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1982 (IC base=+0.216)

- **PATRÓN** `ballena_activa_n` < `11.0` → IC=+0.211 (n=362)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4312` → IC=+0.158 (n=1306)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4312 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1369)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.3743` → IC=+0.196 (n=1306)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3743 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1546` → IC=+0.178 (n=861)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1546 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.979` → IC=+0.227 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.979 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.0376` → IC=+0.146 (n=1150)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0376 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6254` → IC=+0.148 (n=1306)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6254 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.2902` → IC=+0.201 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2902 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.427` → IC=+0.153 (n=427)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.427 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `2.5051` → IC=+0.168 (n=426)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.5051 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `6237.095` → IC=+0.182 (n=871)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 6237.095 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.147 (n=1249)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 162.0 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.152 (n=1370)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0072 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.143 (n=1370)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6462` → IC=+0.171 (n=1370)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6462 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.3635` → IC=+0.135 (n=1481)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.3635 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.963` → IC=+0.163 (n=485)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 6.963 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `0.8485` → IC=+0.148 (n=914)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7994` → IC=+0.138 (n=832)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.7994 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `10015.5876` → IC=+0.160 (n=621)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 10015.5876 (IC base=+0.122)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.153 (n=672)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0101 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=1515)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.118)

- **PATRÓN** `ibs_20min` > `0.5152` → IC=+0.204 (n=1480)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5152 (IC base=+0.118)

- **PATRÓN** `dist_vwap_pct` > `0.5215` → IC=+0.196 (n=640)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5215 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.76` → IC=+0.259 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.76 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.130 (n=1480)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2145 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.0705` → IC=+0.123 (n=621)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.0705 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.5371` → IC=+0.137 (n=629)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5371 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1547)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `2898.8632` → IC=+0.194 (n=671)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2898.8632 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.133 (n=1130)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1519)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `1.0217` → IC=+0.138 (n=216)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 1.0217 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2097` → IC=+0.140 (n=1378)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2097 (IC base=+0.115)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4523` → IC=+0.131 (n=450)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4523 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.4154` → IC=+0.133 (n=450)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 2.4154 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2761.3271` → IC=+0.160 (n=680)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2761.3271 (IC base=+0.115)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=942)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `drift_60min` |x|≤ `0.293` → IC=+0.202 (n=942)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.293 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1465)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7396` → IC=+0.257 (n=1261)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.577` → IC=+0.242 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.577 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.205 (n=1412)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.8579` → IC=+0.221 (n=941)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8579 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.2322` → IC=+0.268 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2322 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` < `2.1485` → IC=+0.210 (n=1201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1485 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.4081` → IC=+0.210 (n=1365)
...
- **PATRÓN** `libro_liquidez` > `2829.711` → IC=+0.206 (n=640)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2829.711 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0117` → IC=+0.225 (n=642)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0117 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0173` → IC=+0.208 (n=975)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0173 (IC base=+0.204)

- **PATRÓN** `drift_60min` |x|≤ `0.0917` → IC=+0.222 (n=487)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4375` → IC=+0.245 (n=1459)
...
- **PATRÓN** `volumen_regimen` > `0.6325` → IC=+0.215 (n=1459)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1921` → IC=+0.195 (n=1158)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.1921 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `1.4348` → IC=+0.200 (n=1316)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4348 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2599.2247` → IC=+0.209 (n=973)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2599.2247 (IC base=+0.204)
...
- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.176 (n=665)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0088 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.3552` → IC=+0.152 (n=1755)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.3552 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.186 (n=992)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.7496` → IC=+0.209 (n=1329)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7496 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.8623` → IC=+0.177 (n=329)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.8623 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.719` → IC=+0.177 (n=897)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.719 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.871` → IC=+0.167 (n=1173)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.871 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.2084` → IC=+0.159 (n=588)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.2084 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1641` → IC=+0.179 (n=549)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1641 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `1.4413` → IC=+0.162 (n=642)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4413 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.5152` → IC=+0.162 (n=642)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.5152 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.154 (n=2261)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.02 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `12390.1326` → IC=+0.160 (n=665)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 12390.1326 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.169 (n=1772)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 152.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.136 (n=1372)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0056 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=2069)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.6667` → IC=+0.137 (n=2057)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.6667 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2116` → IC=+0.121 (n=1838)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2116 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.6992` → IC=+0.130 (n=815)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 0.6992 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.1657` → IC=+0.130 (n=512)
...
- **PATRÓN** `libro_liquidez` > `2764.7951` → IC=+0.121 (n=1836)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2764.7951 (IC base=+0.110)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.127 (n=847)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 29.0 (IC base=+0.110)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.126 (n=327)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` < 0.0039 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.3431` → IC=+0.128 (n=490)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3431 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.154 (n=457)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 8.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.2558` → IC=+0.154 (n=489)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.2558 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.3035` → IC=+0.149 (n=172)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.3035 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.6213` → IC=+0.157 (n=164)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6213 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `11003.4334` → IC=+0.133 (n=489)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 11003.4334 (IC base=+0.110)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.139 (n=156)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 147.0 (IC base=+0.110)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.200 (n=218)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.3387` → IC=+0.154 (n=646)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3387 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.143 (n=659)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.6055` → IC=+0.182 (n=568)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6055 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.3076` → IC=+0.150 (n=681)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.3076 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1128` → IC=+0.157 (n=560)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1128 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.42` → IC=+0.147 (n=636)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.42 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `325.0` → IC=+0.153 (n=542)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.219 (n=208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=648)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `0.9667` → IC=+0.267 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9667 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` > `0.1507` → IC=+0.207 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1507 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` < `0.2231` → IC=+0.198 (n=550)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.2231 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.948` → IC=+0.227 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.948 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `1.0076` → IC=+0.200 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0076 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `1.156` → IC=+0.219 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.156 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.2622` → IC=+0.272 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2622 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `1.4004` → IC=+0.221 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4004 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.7512` → IC=+0.223 (n=410)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7512 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `12453.6384` → IC=+0.219 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12453.6384 (IC base=+0.197)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5427` → IC=+0.131 (n=470)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.5427 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.167 (n=434)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `1.0699` → IC=+0.147 (n=414)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0699 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.181` → IC=+0.172 (n=132)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.181 (IC base=+0.131)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.206 (n=3497)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=10933)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.308 (n=3532)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` > `0.9658` → IC=+0.203 (n=1491)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9658 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.348` → IC=+0.244 (n=2640)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.348 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `0.88` → IC=+0.166 (n=4677)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.88 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2882` → IC=+0.203 (n=1447)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2882 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.5872` → IC=+0.188 (n=3365)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.5872 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `1794.1561` → IC=+0.172 (n=10486)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1794.1561 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `85.0` → IC=+0.195 (n=8037)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 85.0 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=6335)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1489` → IC=+0.190 (n=4180)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1489 (IC base=+0.181)
...
- **PATRÓN** `ibs_20min` < `0.5686` → IC=+0.236 (n=9497)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5686 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2507` → IC=+0.162 (n=5901)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2507 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.033` → IC=+0.199 (n=1329)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.033 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.732` → IC=+0.183 (n=9183)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.732 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.704` → IC=+0.163 (n=2865)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.704 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2015` → IC=+0.155 (n=2170)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2015 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2872` → IC=+0.240 (n=1249)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2872 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.613` → IC=+0.193 (n=2915)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.613 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.195 (n=5605)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3541` → IC=+0.192 (n=1768)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.196 (n=1201)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.227` → IC=+0.152 (n=1517)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.227 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.6272` → IC=+0.178 (n=560)
...
- **PATRÓN** `ibs_20min` < `0.6612` → IC=+0.193 (n=1457)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6612 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.6843` → IC=+0.154 (n=235)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.6843 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1328` → IC=+0.165 (n=1322)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1328 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.471` → IC=+0.159 (n=244)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.471 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.303` → IC=+0.153 (n=1321)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.303 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.1835` → IC=+0.163 (n=1457)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1835 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1509` → IC=+0.195 (n=391)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1509 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.160 (n=1359)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7561` → IC=+0.162 (n=906)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7561 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `351.0` → IC=+0.158 (n=841)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 351.0 (IC base=+0.151)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0122` → IC=+0.251 (n=569)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0122 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1783)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1731)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.217)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.809` → IC=+0.294 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.809 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` < `0.135` → IC=+0.219 (n=1549)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.135 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `1.6227` → IC=+0.224 (n=1629)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6227 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.227 (n=1194)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1912.76` → IC=+0.218 (n=774)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1912.76 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0118` → IC=+0.238 (n=1592)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0118 (IC base=+0.230)

- **PATRÓN** `drift_60min` |x|≤ `0.1698` → IC=+0.236 (n=700)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0159` → IC=+0.309 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0159 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.273 (n=592)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7484` → IC=+0.230 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7484 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` > `2.1761` → IC=+0.234 (n=977)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1761 (IC base=+0.230)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.239 (n=1060)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.230)

- **PATRÓN** `libro_liquidez` > `1904.2932` → IC=+0.237 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1904.2932 (IC base=+0.230)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.227 (n=1387)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 53.0 (IC base=+0.230)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.185 (n=599)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0035 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4353` → IC=+0.146 (n=1785)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4353 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.151 (n=1863)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.876` → IC=+0.261 (n=809)
...
- **PATRÓN** `volumen_regimen` < `0.873` → IC=+0.155 (n=1190)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4598` → IC=+0.153 (n=577)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 2.4598 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `8015.433` → IC=+0.231 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8015.433 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.160 (n=557)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 77.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.172 (n=967)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0052 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4451` → IC=+0.151 (n=1450)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4451 (IC base=+0.136)
...
- **PATRÓN** `ibs_20min` < `0.5812` → IC=+0.196 (n=1276)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.5812 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.1612` → IC=+0.139 (n=1254)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1612 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.146` → IC=+0.174 (n=216)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 11.146 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.6927` → IC=+0.150 (n=638)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6927 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1921` → IC=+0.141 (n=483)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.148 (n=1377)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4416 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7239.2543` → IC=+0.195 (n=657)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 7239.2543 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `176.0` → IC=+0.141 (n=1372)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 176.0 (IC base=+0.136)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.141 (n=1188)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0082 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1830)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.191 (n=1782)
...
- **PATRÓN** `volumen_regimen` < `0.8936` → IC=+0.134 (n=1187)
...
- **PATRÓN** `libro_liquidez` > `2897.5388` → IC=+0.250 (n=594)
...
- **PATRÓN** `volumen_spike_ratio` < `1.44` → IC=+0.139 (n=519)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.44 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2812.4722` → IC=+0.173 (n=573)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2812.4722 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.125 (n=1348)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 51.0 (IC base=+0.114)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.227 (n=1582)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0132 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.216 (n=1845)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.210)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.212 (n=1586)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` > `0.6` → IC=+0.259 (n=1589)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` > `0.2101` → IC=+0.233 (n=1031)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2101 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.275` → IC=+0.274 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.275 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` < `1.2439` → IC=+0.212 (n=1771)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2439 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.64` → IC=+0.218 (n=1770)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.64 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.2333` → IC=+0.253 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2333 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.5002` → IC=+0.236 (n=571)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5002 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1849)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `2839.1078` → IC=+0.221 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2839.1078 (IC base=+0.210)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.226 (n=629)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0092 (IC base=+0.203)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.223 (n=629)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0256 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.210 (n=1324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.203)

- **PATRÓN** `ibs_20min` < `0.4224` → IC=+0.266 (n=1660)
...
- **PATRÓN** `dist_vwap_pct` < `0.9187` → IC=+0.205 (n=2096)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9187 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.169` → IC=+0.253 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.169 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `1.2333` → IC=+0.240 (n=629)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2333 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.282` → IC=+0.271 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.282 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `2.1798` → IC=+0.199 (n=1497)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1798 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4305` → IC=+0.199 (n=1701)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4305 (IC base=+0.203)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.147 (n=3188)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.170 (n=2697)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0091 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.5163` → IC=+0.169 (n=3064)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.5163 (IC base=+0.159)
...
- **PATRÓN** `dist_vwap_pct` > `0.1831` → IC=+0.169 (n=1135)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1831 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.4753` → IC=+0.158 (n=1923)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.4753 (IC base=+0.159)
...
- **PATRÓN** `volumen_regimen` > `0.635` → IC=+0.162 (n=2053)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.635 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.1706` → IC=+0.196 (n=846)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8762` → IC=+0.168 (n=2019)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.8762 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.161 (n=2188)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.01 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `8262.3226` → IC=+0.166 (n=1389)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 8262.3226 (IC base=+0.159)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.201 (n=803)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.4848` → IC=+0.164 (n=2403)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.18` → IC=+0.174 (n=1057)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.18 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.6744` → IC=+0.170 (n=465)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6744 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.225` → IC=+0.158 (n=2396)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.225 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.2441` → IC=+0.152 (n=2301)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2441 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` < `0.0965` → IC=+0.149 (n=2180)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0965 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.072` → IC=+0.147 (n=1107)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.072 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.5338` → IC=+0.158 (n=1044)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.5338 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.8153` → IC=+0.148 (n=1582)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.8153 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.147 (n=3188)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `7138.5133` → IC=+0.158 (n=2147)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 7138.5133 (IC base=+0.146)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.176 (n=905)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0072 (IC base=+0.169)

- **PATRÓN** `sigma_h` > `0.0041` → IC=+0.170 (n=1033)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0041 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.3808` → IC=+0.175 (n=905)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3808 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.183 (n=393)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 17.0 (IC base=+0.169)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.177 (n=354)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 4.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` < `0.535` → IC=+0.185 (n=686)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.535 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.8854` → IC=+0.178 (n=343)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.8854 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` < `0.4048` → IC=+0.180 (n=963)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.4048 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.178` → IC=+0.180 (n=921)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 4.178 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.0789` → IC=+0.170 (n=905)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.0789 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6413` → IC=+0.173 (n=1029)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6413 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.1655` → IC=+0.187 (n=308)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1655 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `2.4717` → IC=+0.174 (n=1010)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.4717 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `1.5228` → IC=+0.172 (n=904)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.5228 (IC base=+0.169)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.196 (n=284)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0041 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.49` → IC=+0.180 (n=845)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.49 (IC base=+0.154)
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.166 (n=566)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 10.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` < `0.7429` → IC=+0.159 (n=845)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.7429 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.0954` → IC=+0.164 (n=845)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.0954 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.6082` → IC=+0.174 (n=185)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.6082 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.605` → IC=+0.162 (n=870)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.605 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `0.6452` → IC=+0.194 (n=282)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.6452 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `0.7215` → IC=+0.155 (n=755)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7215 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` < `0.1513` → IC=+0.156 (n=874)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` < 0.1513 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` > `0.0735` → IC=+0.170 (n=356)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.0735 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.1958` → IC=+0.170 (n=729)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.1958 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `7540.0498` → IC=+0.173 (n=845)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7540.0498 (IC base=+0.154)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `sigma_h` < `0.0132` → IC=+0.120 (n=256)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.60€ cuando `sigma_h` < 0.0132 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.138 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 11.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.243 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.2115` → IC=+0.150 (n=181)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.2115 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.348` → IC=+0.181 (n=67)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 7.348 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `0.9116` → IC=+0.124 (n=171)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 0.9116 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.1626` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1626 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.4296` → IC=+0.131 (n=247)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4296 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `4120.2748` → IC=+0.136 (n=116)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 4120.2748 (IC base=+0.105)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.168 (n=239)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0069 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.6706` → IC=+0.156 (n=239)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.6706 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.185 (n=106)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 6.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.1364` → IC=+0.232 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1364 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.6027` → IC=+0.224 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6027 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.617` → IC=+0.136 (n=127)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 2.617 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.9502` → IC=+0.154 (n=160)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.9502 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` < `0.1103` → IC=+0.199 (n=194)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` < 0.1103 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `1.6095` → IC=+0.144 (n=102)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.6095 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `2.1871` → IC=+0.139 (n=106)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.1871 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `3335.3834` → IC=+0.164 (n=239)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 3335.3834 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.181 (n=202)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 47.0 (IC base=+0.134)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.185 (n=427)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.004 (IC base=+0.088)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.193 (n=786)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.6667 (IC base=+0.088)

- **PATRÓN** `dist_vwap_pct` > `0.1542` → IC=+0.150 (n=470)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1542 (IC base=+0.088)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.442` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 11.442 (IC base=+0.088)

- **PATRÓN** `volumen_pendiente_norm` > `0.2799` → IC=+0.178 (n=116)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.2799 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` < `2.0999` → IC=+0.125 (n=672)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.0999 (IC base=+0.088)

- **PATRÓN** `libro_liquidez` > `2435.8886` → IC=+0.136 (n=388)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.154 (n=333)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0059 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=343)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.4737` → IC=+0.184 (n=302)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.4737 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.1318` → IC=+0.175 (n=155)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.1318 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` < `0.067` → IC=+0.129 (n=235)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.067 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` < `2.0413` → IC=+0.161 (n=231)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.0413 (IC base=+0.102)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.152 (n=219)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.005 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.131 (n=307)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 7.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.6632` → IC=+0.220 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6632 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.3368` → IC=+0.181 (n=117)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.3368 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.499` → IC=+0.300 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.499 (IC base=+0.099)

- **PATRÓN** `volumen_pendiente_norm` > `0.2766` → IC=+0.207 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2766 (IC base=+0.099)

- **PATRÓN** `volumen_spike_ratio` < `1.7354` → IC=+0.161 (n=163)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.7354 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `1133.2011` → IC=+0.155 (n=262)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=736)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.5 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2923.1096` → IC=+0.175 (n=250)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2923.1096 (IC base=+0.109)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=1876)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.125 (n=62)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=773)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=375)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.131 (n=372)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=440)

- **PATRÓN** `py_entrada` < `0.47` → IC=+0.173 (n=218)

  - _Acción_: Kelly boost +0.86€ cuando `py_entrada` < 0.47 (IC base=+0.019)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **FILTRO** `py_entrada` > `0.54` → IC=-0.121 (n=56)
...
- **PATRÓN** `py_entrada` < `0.54` → IC=+0.151 (n=61)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `py_entrada` < 0.54 (IC base=+0.021)
...
- **FILTRO** `profundidad_ratio` < `48.0` → IC=-0.122 (n=43)
...
- **PATRÓN** `profundidad_ratio` > `48.0` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `profundidad_ratio` > 48.0 (IC base=+0.023)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.176 (n=35)
...
- **PATRÓN** `py_entrada` < `0.58` → IC=+0.182 (n=42)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` < 0.58 (IC base=+0.019)

- **PATRÓN** `restante_min` > `13.48` → IC=+0.200 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 13.48 (IC base=+0.019)

- **PATRÓN** `lag_apertura_s` < `90.9` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 90.9 (IC base=+0.019)

- **PATRÓN** `profundidad_ratio` > `4.1` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `profundidad_ratio` > 4.1 (IC base=+0.019)
...
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.43 (IC base=+0.012)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.180 (n=23)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 16.0 (IC base=+0.012)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7643)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.167 (n=3652)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=11138)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.166 (n=3793)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=11520)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.209 (n=628)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1944)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.186 (n=652)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1973)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.208 (n=663)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=2084)

- **FILTRO** `ibs_20min` > `0.281` → IC=-0.165 (n=685)

  - _Acción_: SKIP cuando `ibs_20min` > 0.281
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=2062)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.49` → IC=-0.170 (n=640)

  - _Acción_: SKIP cuando `py_entrada` < 0.49
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1925)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.175 (n=662)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=2092)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2828)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=796)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.131 (n=10450)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=23265)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=8301)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=25414)

- **FILTRO** `ibs_7min` < `0.2791` → IC=-0.236 (n=8424)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2791
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=25291)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11423)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=22292)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.231 (n=10406)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=32046)

- **FILTRO** `ibs_7min` > `0.2923` → IC=-0.178 (n=10610)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2923
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=31842)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3900)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=1331)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4271)

- **FILTRO** `ibs_7min` < `0.7111` → IC=-0.252 (n=1848)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7111
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=3754)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.188 (n=1246)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4356)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.260 (n=1803)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5494)

- **FILTRO** `drift_7min_pct` |x|> `0.111` → IC=-0.125 (n=2478)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.111
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4819)

- **FILTRO** `ibs_7min` > `0.7872` → IC=-0.208 (n=1824)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7872
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=5473)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1372)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4443)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1413)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4402)

- **FILTRO** `ibs_7min` < `0.7472` → IC=-0.194 (n=1453)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7472
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4362)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.176 (n=1450)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=4365)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.263 (n=1363)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=4543)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.180 (n=1476)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2609
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4430)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.182 (n=1470)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4436)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.166 (n=1508)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=3815)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.304 (n=1318)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4005)

- **FILTRO** `ibs_7min` < `0.7059` → IC=-0.245 (n=1746)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7059
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3577)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.223 (n=1198)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=4125)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1797)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=6015)

- **FILTRO** `ibs_7min` > `0.75` → IC=-0.172 (n=1948)

  - _Acción_: SKIP cuando `ibs_7min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=5864)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3762)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1648)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3916)
...
- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.173 (n=1390)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4174)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.259 (n=1419)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=4267)

- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.178 (n=1421)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2744
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4265)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.184 (n=1387)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4299)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.257 (n=1450)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4400)

- **FILTRO** `ibs_7min` < `0.2963` → IC=-0.236 (n=1462)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2963
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=4388)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1916)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=6168)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1820)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3741)

- **FILTRO** `ibs_7min` < `0.298` → IC=-0.225 (n=1389)

  - _Acción_: SKIP cuando `ibs_7min` < 0.298
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4172)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1352)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4209)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.208 (n=1806)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5861)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1107)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3978` → IC=+0.127 (n=770)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.63€ cuando `delta_ratio` |x|> 0.3978 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=694)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 6.0 (IC base=+0.112)

- **PATRÓN** `total_vol_5m` < `469.512` → IC=+0.145 (n=257)

  - _Acción_: Kelly boost +0.72€ cuando `total_vol_5m` < 469.512 (IC base=+0.112)
...
- **FILTRO** `sigma_h` > `0.0067` → IC=-0.200 (n=48)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `streak_len` > `5.0` → IC=-0.147 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=187)
...
- **PATRÓN** `streak_estiramiento` < `0.4787` → IC=+0.131 (n=63)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `streak_estiramiento` < 0.4787 (IC base=+0.034)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.155 (n=27)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=625)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=752)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=2999)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=1527)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1535)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.221 (n=771)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0087 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0509` → IC=+0.205 (n=567)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0509 (IC base=+0.186)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2145` → IC=+0.188 (n=566)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.2145 (IC base=+0.186)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1268` → IC=+0.231 (n=604)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1268 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=1575)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6071` → IC=+0.267 (n=1699)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=666)
...
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.142 (n=397)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0064 (IC base=+0.133)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.148 (n=265)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.005 (IC base=+0.133)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2337` → IC=+0.167 (n=133)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.2337 (IC base=+0.133)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.263` → IC=+0.149 (n=286)

  - _Acción_: Kelly boost +0.75€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.263 (IC base=+0.133)
...
- **PATRÓN** `ibs_15` > `0.6559` → IC=+0.254 (n=355)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6559 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.1133` → IC=+0.154 (n=284)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.1133 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.918` → IC=+0.208 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.918 (IC base=+0.133)
...
- **FILTRO** `dist_vwap_pct` > `0.7048` → IC=-0.146 (n=97)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1002)
...
- **PATRÓN** `drift_60min` |x|≤ `0.085` → IC=+0.224 (n=197)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.085 (IC base=+0.191)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0394` → IC=+0.194 (n=446)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.5556` → IC=+0.282 (n=447)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.8136` → IC=+0.193 (n=516)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.8136 (IC base=+0.191)
...
- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.154 (n=504)
...
- **PATRÓN** `ibs_15` > `0.6409` → IC=+0.273 (n=653)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6409 (IC base=-0.066)

- **PATRÓN** `dist_vwap_pct` < `0.2727` → IC=+0.190 (n=523)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.2727 (IC base=-0.066)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1198` → IC=+0.251 (n=1259)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1198 (IC base=-0.029)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1785` → IC=+0.239 (n=1223)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1785 (IC base=-0.029)

- **PATRÓN** `ibs_15` < `0.3488` → IC=+0.276 (n=1889)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.164 (n=397)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.152 (n=274)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0059 (IC base=+0.151)
...
- **PATRÓN** `drift_15min` |x|≤ `0.4157` → IC=+0.179 (n=104)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `drift_15min` |x|≤ 0.4157 (IC base=+0.151)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0609` → IC=+0.155 (n=311)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.77€ cuando `delta_ratio_macro` |x|> 0.0609 (IC base=+0.151)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2968` → IC=+0.233 (n=215)
...
- **PATRÓN** `ibs_15` > `0.6675` → IC=+0.264 (n=311)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6675 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.4658` → IC=+0.156 (n=88)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.4658 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1047` → IC=+0.189 (n=223)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.1047 (IC base=+0.151)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.164 (n=397)
...
- **PATRÓN** `ibs_15` < `0.2692` → IC=+0.284 (n=641)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0198` → IC=-0.260 (n=398)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0198
  - _Potencial_: sin este filtro IC_bueno=-0.141 (n=399)

- **FILTRO** `drift_15min` |x|> `1.2555` → IC=-0.266 (n=199)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.2555
  - _Potencial_: sin este filtro IC_bueno=-0.178 (n=598)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.265 (n=198)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=599)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1344` → IC=+0.295 (n=227)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1344 (IC base=-0.041)
...
- **PATRÓN** `ibs_15` < `0.3429` → IC=+0.306 (n=499)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3429 (IC base=-0.041)

- **PATRÓN** `dist_vwap_pct` > `0.8999` → IC=+0.338 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8999 (IC base=-0.041)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0552` → IC=+0.331 (n=229)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0552 (IC base=+0.292)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.307 (n=272)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.297)

- **PATRÓN** `sigma_h` > `0.0038` → IC=+0.297 (n=309)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0038 (IC base=+0.297)

- **PATRÓN** `drift_60min` |x|≤ `0.1119` → IC=+0.304 (n=207)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1119 (IC base=+0.297)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.328 (n=300)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.297)

- **PATRÓN** `ibs_15` > `0.8539` → IC=+0.339 (n=309)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8539 (IC base=+0.297)

- **PATRÓN** `dist_vwap_pct` > `0.6245` → IC=+0.306 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6245 (IC base=+0.297)

- **PATRÓN** `dist_vwap_pct` < `0.1133` → IC=+0.301 (n=204)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.303 (n=349)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6071 sube el IC de +0.186 a +0.267 en UPDOWN_GBM#15min (n=1699). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6559 sube el IC de +0.133 a +0.254 en UPDOWN_GBM#ETH#15min (n=355). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5556 sube el IC de +0.191 a +0.282 en UPDOWN_GBM#XRP#15min (n=447). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.052 a +0.154 en UPDOWN_GBM#XRP#15min (n=504). Ya aplicado como kelly_boost=+0.77€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6409 sube el IC de -0.066 a +0.273 en UPDOWN_GBM_15M_TARDIO (n=653). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3488 sube el IC de -0.029 a +0.276 en UPDOWN_GBM_15M_TARDIO (n=1889). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6675 sube el IC de +0.151 a +0.264 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=311). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2692 sube el IC de +0.232 a +0.284 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=641). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3429 sube el IC de -0.041 a +0.306 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=499). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8423 sube el IC de +0.292 a +0.328 en UPDOWN_GBM_IBS_ALTO (n=685). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8539 sube el IC de +0.297 a +0.339 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=309). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1345 | +0.101 | +204.75€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1345 | +0.101 | +204.75€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 1005 | +0.111 | +177.89€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 1005 | +0.111 | +177.89€ | 2 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 254 | +0.055 | +8.21€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 254 | +0.055 | +8.21€ | 6 | 6 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 29077 | -0.086 | -3886.00€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1524 | -0.039 | -226.32€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27553 | -0.089 | -3659.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3800 | -0.099 | -625.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3800 | -0.099 | -625.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1524 | -0.039 | -226.32€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1524 | -0.039 | -226.32€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 3484 | -0.096 | -788.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 3484 | -0.096 | -788.92€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 7460 | -0.020 | -703.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7460 | -0.020 | -703.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 7088 | -0.089 | -451.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 7088 | -0.089 | -451.87€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5721 | -0.166 | -1089.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5721 | -0.166 | -1089.50€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 19244 | -0.027 | +3965.73€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 5007 | +0.001 | +1818.71€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 14237 | -0.036 | +2147.02€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 19244 | -0.027 | +3965.73€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 5007 | +0.001 | +1818.71€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 14237 | -0.036 | +2147.02€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 96168 | +0.113 | -4749.93€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14405 | +0.185 | -437.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 387 | -0.076 | -50.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 75177 | +0.100 | -4042.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 6199 | +0.107 | -219.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 12500 | +0.099 | -1024.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 46 | -0.167 | -1.52€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 12439 | +0.101 | -1010.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 19445 | +0.132 | -381.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4554 | +0.203 | -148.05€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 12463 | +0.112 | -187.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2386 | +0.102 | -23.98€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 12538 | +0.090 | -1126.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 53 | -0.100 | -7.49€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 12470 | +0.092 | -1107.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 20436 | +0.124 | -380.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5580 | +0.175 | -79.20€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 12600 | +0.106 | -236.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2244 | +0.099 | -56.01€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 18737 | +0.114 | -1087.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 4125 | +0.189 | -209.53€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 290 | -0.034 | +3.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 12753 | +0.091 | -741.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1569 | +0.126 | -139.50€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 12512 | +0.100 | -750.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 47 | -0.031 | +8.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 12452 | +0.101 | -757.99€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 15253 | +0.191 | -1006.64€ | 1 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 15253 | +0.191 | -1006.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 3620 | +0.167 | -381.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 3620 | +0.167 | -381.16€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 1331 | +0.195 | -18.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 1331 | +0.195 | -18.51€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 3572 | +0.180 | -306.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 3572 | +0.180 | -306.00€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 3153 | +0.239 | -103.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 3153 | +0.239 | -103.84€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 3498 | +0.192 | -210.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 