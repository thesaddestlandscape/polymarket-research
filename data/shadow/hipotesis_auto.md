# Hipótesis automáticas — 2026-08-19 14:21 UTC
_Generado por shadow_postmortem.py sobre 76366 resoluciones (PNL=+8067.78€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `154.18` → IC=-0.250 (n=1018)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.18
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3061)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `120.54` → IC=-0.401 (n=109)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 120.54
  - _Potencial_: sin este filtro IC_bueno=-0.117 (n=327)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` > `641.6` → IC=-0.290 (n=117)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` > 641.6
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=355)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `71.35` → IC=-0.466 (n=143)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 71.35
...
- **FILTRO** `concentracion_yes` < `1.0` → IC=-0.135 (n=72)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=929)

- **FILTRO** `n_ballenas` < `4.0` → IC=-0.139 (n=239)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=762)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `150.74` → IC=-0.313 (n=201)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 150.74
  - _Potencial_: sin este filtro IC_bueno=-0.200 (n=605)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.183 (n=2644)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.7 (IC base=+0.090)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=719)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.219 (n=3682)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.230 (n=829)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.224)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.226 (n=852)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.243 (n=748)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.242)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.271 (n=409)
...
- **PATRÓN** `restante_min` < `3.74` → IC=+0.170 (n=304)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=941)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.154)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.163 (n=823)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.168 (n=824)

  - _Acción_: Kelly boost +0.84€ cuando `py_entrada` < 0.43 (IC base=+0.140)

- **PATRÓN** `restante_min` < `3.9` → IC=+0.153 (n=312)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` < 3.9 (IC base=+0.140)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.197 (n=335)

  - _Acción_: Kelly boost +0.99€ cuando `restante_min` > 4.94 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.142 (n=959)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 5.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.148 (n=950)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 17.0 (IC base=+0.140)

- **PATRÓN** `lag_apertura_s` < `3.37` → IC=+0.210 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 3.37 (IC base=+0.140)

- **PATRÓN** `profundidad_ratio_no` > `10.7` → IC=+0.140 (n=309)

  - _Acción_: Kelly boost +0.70€ cuando `profundidad_ratio_no` > 10.7 (IC base=+0.140)
...
- **PATRÓN** `dist_vwap_pct` > `0.4164` → IC=+0.286 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4164 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.694` → IC=+0.232 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.694 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `1.294` → IC=+0.243 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.294 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.8707` → IC=+0.246 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8707 (IC base=+0.097)
...
- **PATRÓN** `sigma_h` < `0.0019` → IC=+0.336 (n=53)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0019 (IC base=+0.259)

- **PATRÓN** `sigma_h` > `0.0035` → IC=+0.267 (n=41)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0035 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.0774` → IC=+0.282 (n=53)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0774 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.302 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` > `0.5906` → IC=+0.279 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5906 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` > `0.3135` → IC=+0.312 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3135 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.34` → IC=+0.344 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.34 (IC base=+0.259)

- **PATRÓN** `volumen_regimen` < `0.6608` → IC=+0.314 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6608 (IC base=+0.259)

- **PATRÓN** `volumen_regimen` > `0.7493` → IC=+0.264 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7493 (IC base=+0.259)

- **PATRÓN** `volumen_pendiente_norm` < `0.1907` → IC=+0.298 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1907 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` < `1.4811` → IC=+0.357 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4811 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `12448.5931` → IC=+0.307 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12448.5931 (IC base=+0.259)

- **PATRÓN** `ballena_activa_n` < `360.0` → IC=+0.329 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 360.0 (IC base=+0.259)
...
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.195 (n=624)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1231` → IC=+0.165 (n=422)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1231 (IC base=+0.142)
...
- **PATRÓN** `volumen_regimen` < `1.2091` → IC=+0.142 (n=725)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2091 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6346` → IC=+0.144 (n=725)
...
- **PATRÓN** `volumen_spike_ratio` < `2.644` → IC=+0.121 (n=1000)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 2.644 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.5437` → IC=+0.122 (n=1137)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 1.5437 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.150 (n=1390)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.05 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `2764.0859` → IC=+0.180 (n=458)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2764.0859 (IC base=+0.142)
...
- **PATRÓN** `sigma_h` < `0.0018` → IC=+0.267 (n=41)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0018 (IC base=+0.207)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.273 (n=42)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0034 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.256 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.207)

- **PATRÓN** `ibs_20min` > `0.655` → IC=+0.282 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.655 (IC base=+0.207)

- **PATRÓN** `dist_vwap_pct` > `0.2796` → IC=+0.297 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2796 (IC base=+0.207)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.973` → IC=+0.317 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.973 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` < `1.4105` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.4105 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` > `0.9086` → IC=+0.223 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9086 (IC base=+0.207)

- **PATRÓN** `volumen_pendiente_norm` > `0.3409` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3409 (IC base=+0.207)

- **PATRÓN** `volumen_spike_ratio` < `1.4872` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4872 (IC base=+0.207)

- **PATRÓN** `libro_liquidez` > `8500.2314` → IC=+0.271 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8500.2314 (IC base=+0.207)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.202 (n=542)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9631` → IC=+0.285 (n=736)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9631 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `0.2157` → IC=+0.180 (n=311)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.2157 (IC base=+0.123)
...
- **PATRÓN** `volumen_spike_ratio` > `1.6907` → IC=+0.127 (n=1174)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.6907 (IC base=+0.123)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.127 (n=1624)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.05 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `2802.0526` → IC=+0.163 (n=541)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2802.0526 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.192 (n=245)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 147.0 (IC base=+0.123)
...
- **FILTRO** `ibs_20min` < `0.3434` → IC=-0.207 (n=56)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3434
  - _Potencial_: sin este filtro IC_bueno=+0.253 (n=168)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.170 (n=113)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0027 (IC base=+0.137)

- **PATRÓN** `sigma_h` > `0.0031` → IC=+0.158 (n=77)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0031 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.172 (n=172)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.3434` → IC=+0.253 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3434 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3557` → IC=+0.291 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3557 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.391` → IC=+0.274 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.391 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.6746` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6746 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `0.9223` → IC=+0.149 (n=112)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.9223 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` < `0.1584` → IC=+0.191 (n=124)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1584 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.8883` → IC=+0.224 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.8883 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `5059.1554` → IC=+0.186 (n=151)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 5059.1554 (IC base=+0.137)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.169 (n=167)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=503)
...
- **FILTRO** `ibs_20min` > `0.1884` → IC=-0.219 (n=30)
...
- **PATRÓN** `py_entrada` < `0.69` → IC=+0.128 (n=84)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` < 0.69 (IC base=+0.046)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.0814` → IC=+0.122 (n=35)

  - _Acción_: Kelly boost +0.61€ cuando `drift_20min_pct` |x|≤ 0.0814 (IC base=+0.046)
...
- **FILTRO** `libro_liquidez` < `12090.1192` → IC=-0.134 (n=69)

  - _Acción_: SKIP cuando `libro_liquidez` < 12090.1192
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.130 (n=44)

  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` < 0.5 (IC base=-0.009)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.185 (n=363)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1212)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.271 (n=383)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1192)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.237 (n=390)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=1185)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.196 (n=525)

  - _Acción_: SKIP cuando `ballena_activa_n` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1050)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.170 (n=453)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=1485)
...
- **FILTRO** `ballena_activa_n` > `89.0` → IC=-0.173 (n=108)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.171 (n=71)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=223)
...
- **FILTRO** `ibs_7min` < `1.0` → IC=-0.144 (n=144)

  - _Acción_: SKIP cuando `ibs_7min` < 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=150)

- **FILTRO** `ballena_activa_n` > `17.0` → IC=-0.233 (n=73)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.191 (n=79)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=263)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=728)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.3156` → IC=+0.167 (n=34)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.3156 (IC base=+0.043)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.128 (n=49)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 4.0 (IC base=+0.043)

- **PATRÓN** `ibs_15` < `0.0769` → IC=+0.149 (n=35)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.74€ cuando `ibs_15` < 0.0769 (IC base=+0.043)
...
- **FILTRO** `sigma_ewma_delta_pct` > `12.654` → IC=-0.162 (n=258)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1019)
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.224 (n=56)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=219)

- **FILTRO** `libro_liquidez` < `13620.7369` → IC=-0.216 (n=206)
...
| ✅ BALLENAS_TARDIAS | 3693 | -0.112 | -573.32€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min |