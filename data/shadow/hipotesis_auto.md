# Hipótesis automáticas — 2026-06-30 00:58 UTC
_Generado por shadow_postmortem.py sobre 1341 resoluciones (PNL=-45.16€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1022` → IC=+0.125 (n=22)
  ...
  - _Acción_: Kelly boost +0.62€ cuando `pct_spot_vs_ref` |x|≤ 0.1022 (IC base=+0.045)

- **PATRÓN** `drift_60min` |x|≤ `0.2032` → IC=+0.132 (n=17)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.2032 (IC base=+0.045)
...
|---|---|---|---|---|---|
| ✅ ORDER_FLOW_5M | 784 | +0.013 | +7.94€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 648 | +0.003 | -4.65€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M#SOL | 146 | +0.020 | +1.72€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#SOL#5min | 146 | +0.020 | +1.72€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 370 | -0.003 | -4.72€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 217 | +0.039 | +5.26€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 72 | +0.054 | +5.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 117 | +0.004 | -5.02€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 64 | +0.045 | -0.93€ | 0 | 2 |
| ✅ UPDOWN_GBM#BTC#240min | 5 | -0.089 | -2.96€ | 0 | 0 |
| 🚫 UPDOWN_GBM#BTC#5min | 16 | -0.133 | -6.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 28 | +0.067 | +0.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 145 | +0.031 | +2.65€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 96 | +0.041 | +0.55€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 12 | -0.086 | -3.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 28 | +0.100 | +4.34€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.093) — sin ventaja clara. oversold(IBS<0.3): IC=-0.052 n=27 | neutral: IC=+0.042 n=22 | overbought(IBS>0.7): IC=+0.000 n=30
  - _Datos_: n=81 IC=-0.006 PNL=-5.85€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 81 ops, 14 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 73 ops con delta_ratio | SOL: 85 ops con delta_ratio
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Estado_: ETH#60min: n=28/40 IC=+0.100 PNL=+4.34€ | BTC#60min: n=28/40 IC=+0.067 PNL=+0.59€ | SOL#60min: n=16/40 IC=-0.044 PNL=+0.30€
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 370/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-OF-MADRUGADA** — ORDER_FLOW de madrugada (0h-6h UTC) BTC+SOL — ¿neutralizar?
  ...
  - _Estado_: n=37 IC=+0.013 PNL=+0.32€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=37 IC=+0.013 PNL=+0.32€

**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  - _Hipótesis_: Cuando la volatilidad horaria es muy alta el GBM puede sobreestimar el edge. Testear.
  - _Umbral_: n≥30 y IC<-0.05
  - _Acción_: Filtrar señales GBM cuando sigma_h > 0.002 si se confirma IC negativo
  - _Estado_: n=271 IC=+0.013 PNL=+0.92€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=271 IC=+0.013 PNL=+0.92€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=57 IC=+0.042 PNL=+4.26€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=57 IC=+0.042 PNL=+4.26€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=164 IC=+0.006 PNL=-10.51€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=164 IC=+0.006 PNL=-10.51€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=64 IC=+0.045 PNL=-0.93€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=64 IC=+0.045 PNL=-0.93€

**⏳ H-CUSTOM-DRIFT15-ZONA-MUERTA** — GBM#15min drift_15min ∈ [-0.3,+0.3] — zona muerta de señal
  - _Hipótesis_: Análisis n=127 GBM#15min: cuando drift_15min está entre -0.3 y +0.3 (mercado sin dirección clara) el IC es negativo (-0.043). Cuando drift>0.3 IC=+0.100 (n=28). Cuando drift<-1 IC=+0.048 (reversión). La señal requiere mercado con dirección clara.
  - _Umbral_: 50
  - _Acción_: Filtrar señales GBM#15min cuando drift_15min ∈ [-0.3, +0.3] — validar con n≥50 antes de implementar
  - _Estado_: 30/50 ops en el filtro definido (IC actual=+0.000 PNL=+0.10€)
  - _Datos_: n=30 IC=+0.000 PNL=+0.10€

**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  - _Hipótesis_: Cuando drift_15min > 0.3%/h el GBM captura bien la dirección: IC=+0.100 n=28 en todos GBM#15min; IC=+0.152 n=13 solo BTC. El mercado tiene dirección clara y el GBM la sigue. Hipótesis: este rango es donde la señal es real.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma IC>0.10 con n≥40 → boost ×1.2 en GBM#15min cuando drift_15min>0.3
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.100 > 0.08 con n=83 PNL=+3.01€
  - _Datos_: n=83 IC=+0.100 PNL=+3.01€
...
**⏳ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  ...
  - _Estado_: 18/20 ops en el filtro definido (IC actual=+0.135 PNL=+3.88€)
  - _Datos_: n=18 IC=+0.135 PNL=+3.88€
