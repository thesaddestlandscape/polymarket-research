# Hipótesis automáticas — 2026-08-08 03:28 UTC
_Generado por shadow_postmortem.py sobre 90052 resoluciones (PNL=+13711.23€)_
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.360 (n=55)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.262)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.283 (n=67)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.262)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.272 (n=55)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 13.0 (IC base=+0.262)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.018` → IC=+0.272 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.018 (IC base=+0.262)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.736` → IC=+0.341 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.736 (IC base=+0.262)

- **PATRÓN** `libro_liquidez` > `1263.2483` → IC=+0.272 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1263.2483 (IC base=+0.262)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.215 (n=293)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0034 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.3614` → IC=+0.211 (n=289)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3614 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.263 (n=196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.758` → IC=+0.227 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.758 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `1512.1099` → IC=+0.208 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1512.1099 (IC base=+0.196)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.167 (n=28)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.006 (IC base=+0.095)

- **PATRÓN** `drift_60min` |x|≤ `0.2441` → IC=+0.174 (n=41)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.2441 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.198 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 10.0 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `1755.237` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1755.237 (IC base=+0.095)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.187 (n=483)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0062 (IC base=+0.175)
...
| ✅ BALLENAS_TARDIAS | 1932 | -0.089 | -370.86€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 383 | +0.204 | -42.96€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 1549 | -0.162 | -327.90€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 325 | -0.060 | -10.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 325 | -0.060 | -10.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 326 | -0.198 | -63.14€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 326 | -0.198 | -63.14€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 301 | -0.045 | -114.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 301 | -0.045 | -114.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 23942 | +0.118 | -575.86€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5992 | +0.195 | -86.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 438 | +0.052 | -37.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 15681 | +0.088 | -503.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1831 | +0.139 | +52.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2496 | +0.086 | -120.14€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 11 | +0.021 | -0.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2480 | +0.086 | -122.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5206 | +0.129 | -91.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1889 | +0.183 | -92.95€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 140 | +0.056 | -14.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2485 | +0.087 | -48.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 692 | +0.148 | +64.28€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2494 | +0.078 | -137.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 15 | +0.243 | +10.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2478 | +0.076 | -150.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 5631 | +0.135 | -24.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2002 | +0.198 | +12.28€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 144 | -0.014 | -31.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2891 | +0.100 | -17.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 594 | +0.131 | +11.87€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5591 | +0.136 | -153.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2036 | +0.205 | -14.73€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 146 | +0.108 | +4.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2864 | +0.088 | -119.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min |