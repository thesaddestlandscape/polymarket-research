# Hipótesis automáticas — 2026-07-02 15:25 UTC
_Generado por shadow_postmortem.py sobre 2703 resoluciones (PNL=-55.67€)_
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.143 (n=40)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 14.0 (IC base=+0.046)

- **PATRÓN** `ibs_15` < `0.0669` → IC=+0.206 (n=49)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0669 (IC base=+0.046)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.124` → IC=+0.173 (n=47)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.87€ cuando `pct_spot_vs_ref` |x|≤ 0.124 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0158` → IC=+0.173 (n=47)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0158 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.9082` → IC=+0.150 (n=38)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.9082 (IC base=+0.141)

- **PATRÓN** `drift_15min` |x|≤ `0.688` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `drift_15min` |x|≤ 0.688 (IC base=+0.141)
...
- **PATRÓN** `ibs_15` < `0.0787` → IC=+0.340 (n=23)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0787 (IC base=+0.141)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 122 | +0.137 | +33.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 122 | +0.137 | +33.08€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 33 | +0.100 | +5.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 33 | +0.100 | +5.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 32 | +0.059 | +2.79€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 32 | +0.059 | +2.79€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 817 | -0.036 | -38.62€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 592 | -0.013 | -12.27€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 313 | -0.002 | +12.46€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 230 | +0.017 | +18.41€ | 2 | 6 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.076) — sin ventaja clara. oversold(IBS<0.3): IC=+0.010 n=143 | neutral: IC=-0.066 n=127 | overbought(IBS>0.7): IC=-0.045 n=143
  - _Datos_: n=427 IC=-0.032 PNL=-13.38€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.010 n=1291 | tras_1loss IC=-0.032 n=1322 | tras_2loss IC=-0.044 n=682/40 | gap=+0.054 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=23, boost estimado=+0.007. Necesita 0 más y boost>0.05
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.038 n=117/40 PNL=+0.58€ | H=15h UTC: IC=+0.009 n=106/40 PNL=+4.14€ | H=17h UTC: IC=+0.221 n=41/40 PNL=+14.13€ | H=19h UTC: IC=+0.028 n=51/40 PNL=+1.21€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=694 IC=-0.030 PNL=-25.06€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=694 IC=-0.030 PNL=-25.06€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=196 IC=+0.020 PNL=+16.96€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=196 IC=+0.020 PNL=+16.96€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=286 IC=+0.066 PNL=+37.25€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=286 IC=+0.066 PNL=+37.25€
