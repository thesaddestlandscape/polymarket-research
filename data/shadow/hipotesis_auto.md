# Hipótesis automáticas — 2026-09-24 07:42 UTC
_Generado por shadow_postmortem.py sobre 585929 resoluciones (PNL=+65543.05€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.95` → IC=-0.234 (n=6998)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.95
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=20994)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `138.17` → IC=-0.248 (n=920)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 138.17
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2761)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `497.2` → IC=-0.146 (n=360)
...
- **FILTRO** `restante_s_al_confirmar` < `164.76` → IC=-0.226 (n=1671)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.76
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5013)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.63` → IC=-0.357 (n=1381)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.203 (n=13700)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=3442)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `5621.0485` → IC=+0.176 (n=2194)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 5621.0485 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.139 (n=11252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 17.0 (IC base=+0.127)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.136 (n=13755)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.127)

- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=10736)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5606)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7792.686` → IC=+0.175 (n=2113)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7792.686 (IC base=+0.127)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1694)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2093)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `15921.9108` → IC=+0.236 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15921.9108 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1498)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1666)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1517)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=2133)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.146 (n=351)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 7.0 (IC base=+0.107)

- **PATRÓN** `py_entrada` < `0.44` → IC=+0.145 (n=814)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.237 (n=1468)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `3730.6434` → IC=+0.233 (n=624)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.139 (n=652)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 17.0 (IC base=+0.137)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.237 (n=241)
...
- **PATRÓN** `libro_liquidez` > `1302.4168` → IC=+0.149 (n=648)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.167 (n=187)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.02 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `1261.7454` → IC=+0.155 (n=224)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 1261.7454 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.146 (n=306)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 17.0 (IC base=+0.113)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.204 (n=295)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=11280)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.200 (n=10826)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.225 (n=3764)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.251 (n=804)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.245)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.245 (n=811)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=6110)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=2086)
...
- **PATRÓN** `py_entrada` > `0.815` → IC=+0.385 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `4089.2185` → IC=+0.314 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4089.2185 (IC base=+0.291)
...
- **PATRÓN** `py_entrada` > `0.805` → IC=+0.342 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.805 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `4246.1312` → IC=+0.301 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4246.1312 (IC base=+0.278)
...
- **PATRÓN** `py_entrada` > `0.795` → IC=+0.384 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.795 (IC base=+0.294)

- **PATRÓN** `libro_liquidez` > `1462.5909` → IC=+0.311 (n=468)
...
- **PATRÓN** `py_entrada` < `0.93` → IC=+0.455 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.93 (IC base=+0.443)

- **PATRÓN** `py_entrada` > `0.91` → IC=+0.441 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.91 (IC base=+0.443)
...
- **PATRÓN** `libro_liquidez` > `2007.6359` → IC=+0.461 (n=100)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2007.6359 (IC base=+0.443)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4824` → IC=+0.121 (n=7925)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.4824 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9835` → IC=+0.243 (n=2642)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9835 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8443` → IC=+0.250 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8443 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.6343` → IC=+0.249 (n=2224)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6343 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.967` → IC=+0.176 (n=3043)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.967 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.2107` → IC=+0.247 (n=2131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2107 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0495` → IC=+0.257 (n=966)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0495 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3045` → IC=+0.217 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3045 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.4645` → IC=+0.201 (n=5414)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4645 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.57` → IC=+0.133 (n=9567)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.57 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` > `0.6098` → IC=+0.193 (n=702)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.6098 (IC base=+0.065)

- **PATRÓN** `dist_vwap_pct` < `0.1515` → IC=+0.174 (n=3030)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1515 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.181 (n=1473)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6986 (IC base=+0.065)

- **PATRÓN** `volumen_regimen` > `1.0526` → IC=+0.175 (n=1516)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0526 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.1677` → IC=+0.221 (n=1597)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1677 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` > `1.5708` → IC=+0.201 (n=5013)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5708 (IC base=+0.065)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.211 (n=5404)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 136.0 (IC base=+0.065)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.182 (n=598)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3487` → IC=+0.166 (n=1793)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3487 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=866)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 15.0 (IC base=+0.160)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.169 (n=1207)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 11.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.269 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.15` → IC=+0.269 (n=768)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.15 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.2806` → IC=+0.213 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2806 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.4349` → IC=+0.163 (n=1676)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4349 (IC base=+0.160)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.250 (n=1204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.235)

- **PATRÓN** `drift_60min` |x|≤ `0.0913` → IC=+0.283 (n=449)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0542` → IC=+0.293 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0542 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.428` → IC=+0.247 (n=1399)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.428 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` < `0.0922` → IC=+0.231 (n=1153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0922 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` > `0.2765` → IC=+0.258 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2765 (IC base=+0.235)

- **PATRÓN** `volumen_spike_ratio` > `1.8407` → IC=+0.237 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8407 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1800.0096` → IC=+0.237 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1800.0096 (IC base=+0.235)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.228 (n=910)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.216)

- **PATRÓN** `drift_60min` |x|≤ `0.0837` → IC=+0.252 (n=454)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0837 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.232 (n=1423)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.9918` → IC=+0.268 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9918 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` > `0.1993` → IC=+0.221 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1993 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` < `0.5859` → IC=+0.219 (n=1426)
...
- **PATRÓN** `volumen_regimen` < `1.2524` → IC=+0.219 (n=1362)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2524 (IC base=+0.216)

- **PATRÓN** `volumen_regimen` > `1.0825` → IC=+0.226 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0825 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` > `0.2778` → IC=+0.237 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2778 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` < `1.7478` → IC=+0.219 (n=890)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7478 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.368` → IC=+0.225 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.368 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `16018.063` → IC=+0.221 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16018.063 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.152 (n=1422)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0056 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0755` → IC=+0.162 (n=474)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0755 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` < `0.6918` → IC=+0.172 (n=1422)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6918 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.132` → IC=+0.158 (n=1271)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.132 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.209` → IC=+0.164 (n=227)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 11.209 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.261` → IC=+0.141 (n=1297)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.261 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.2035` → IC=+0.151 (n=1422)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.2035 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.096` → IC=+0.172 (n=511)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.096 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.4238` → IC=+0.153 (n=1312)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4238 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.4221` → IC=+0.146 (n=1311)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4221 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `14063.0346` → IC=+0.145 (n=948)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 14063.0346 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.148 (n=1231)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 411.0 (IC base=+0.139)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0115` → IC=+0.210 (n=585)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0115 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=1839)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 5.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.190 (n=1571)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.261 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.193` → IC=+0.253 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.193 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` < `0.2116` → IC=+0.188 (n=1750)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.2116 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.3612` → IC=+0.197 (n=232)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.3612 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.847` → IC=+0.203 (n=755)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.847 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.193 (n=1262)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.221 (n=1508)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0115 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.591` → IC=+0.214 (n=1507)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.591 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.250 (n=571)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.213)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.216 (n=713)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` < `0.0625` → IC=+0.247 (n=663)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0625 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.635` → IC=+0.246 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.635 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.3561` → IC=+0.268 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3561 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.7743` → IC=+0.209 (n=606)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7743 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.2145` → IC=+0.220 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2145 (IC base=+0.213)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.221 (n=1032)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `1881.2284` → IC=+0.229 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1881.2284 (IC base=+0.213)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.212 (n=1164)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.213)

### GBM_LATE_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.160 (n=98)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=2189)

- **PATRÓN** `ibs_20min` > `0.9435` → IC=+0.216 (n=354)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9435 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` > `0.3636` → IC=+0.325 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3636 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` < `0.7929` → IC=+0.332 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7929 (IC base=+0.022)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.712` → IC=+0.157 (n=700)
...
- **PATRÓN** `volumen_regimen` > `1.2004` → IC=+0.344 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2004 (IC base=+0.022)

- **PATRÓN** `volumen_pendiente_norm` < `0.1818` → IC=+0.319 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1818 (IC base=+0.022)

- **PATRÓN** `volumen_pendiente_norm` > `0.3097` → IC=+0.341 (n=86)
...
- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.332 (n=308)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 162.0 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` > `0.6787` → IC=+0.191 (n=137)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.6787 (IC base=+0.016)

- **PATRÓN** `volumen_regimen` < `0.8486` → IC=+0.163 (n=547)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8486 (IC base=+0.016)

- **PATRÓN** `volumen_pendiente_norm` > `0.2258` → IC=+0.220 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2258 (IC base=+0.016)

- **PATRÓN** `volumen_spike_ratio` > `1.518` → IC=+0.175 (n=685)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.518 (IC base=+0.016)
...
- **FILTRO** `ibs_20min` > `0.2558` → IC=-0.124 (n=2158)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2558
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=1064)

- **FILTRO** `sigma_ewma_delta_pct` > `8.653` → IC=-0.208 (n=347)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.653
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2875)
...
- **PATRÓN** `ibs_20min` < `0.2558` → IC=+0.127 (n=1064)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2558 (IC base=-0.041)

- **PATRÓN** `dist_vwap_pct` > `0.6886` → IC=+0.258 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6886 (IC base=-0.041)

- **PATRÓN** `volumen_regimen` < `0.7131` → IC=+0.240 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7131 (IC base=-0.041)

- **PATRÓN** `volumen_regimen` > `0.9027` → IC=+0.218 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9027 (IC base=-0.041)

- **PATRÓN** `volumen_pendiente_norm` < `0.102` → IC=+0.235 (n=266)
...
- **PATRÓN** `volumen_regimen` < `0.9872` → IC=+0.294 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9872 (IC base=-0.067)

- **PATRÓN** `volumen_regimen` > `0.6226` → IC=+0.306 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6226 (IC base=-0.067)

- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.297 (n=309)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1123` → IC=+0.297 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1123 (IC base=-0.067)

- **PATRÓN** `dist_vwap_pct` > `0.8742` → IC=+0.268 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8742 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` < `0.7387` → IC=+0.250 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7387 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` > `1.0842` → IC=+0.281 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0842 (IC base=-0.024)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1538` → IC=+0.255 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1538 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` > `1.434` → IC=+0.244 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.434 (IC base=-0.024)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.196 (n=3313)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0097 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.475` → IC=+0.188 (n=8867)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.475 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.7667` → IC=+0.289 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7667 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.593` → IC=+0.156 (n=4691)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.593 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.247 (n=3145)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6895 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2958` → IC=+0.263 (n=839)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2958 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `1.4678` → IC=+0.241 (n=1907)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4678 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6706` → IC=+0.236 (n=1907)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6706 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.267 (n=5231)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.153 (n=3312)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0091 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.5472` → IC=+0.153 (n=8728)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5472 (IC base=+0.073)

- **PATRÓN** `dist_vwap_pct` < `0.247` → IC=+0.239 (n=2764)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.247 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` < `0.7092` → IC=+0.239 (n=1284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7092 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` > `1.2033` → IC=+0.246 (n=974)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2033 (IC base=+0.073)

- **PATRÓN** `volumen_pendiente_norm` > `0.2969` → IC=+0.302 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2969 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `1.6062` → IC=+0.256 (n=1687)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6062 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `2.3202` → IC=+0.256 (n=1739)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3202 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.262 (n=3719)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.073)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.535` → IC=-0.159 (n=523)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.535
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1758)

- **PATRÓN** `ibs_20min` > `0.8933` → IC=+0.267 (n=684)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2229` → IC=+0.272 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2229 (IC base=+0.046)

- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.178 (n=287)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4339 (IC base=+0.046)

- **PATRÓN** `volumen_spike_ratio` > `2.1445` → IC=+0.191 (n=390)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.1445 (IC base=+0.046)

- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.180 (n=370)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 14.0 (IC base=+0.046)
...
- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.159 (n=663)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.86 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1247` → IC=+0.172 (n=504)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1247 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.6718` → IC=+0.164 (n=813)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6718 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.2732` → IC=+0.218 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2732 (IC base=+0.025)

- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.199 (n=297)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4239 (IC base=+0.025)

- **PATRÓN** `ballena_activa_n` < `246.0` → IC=+0.190 (n=388)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 246.0 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` < `0.1603` → IC=+0.220 (n=566)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1603 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` > `0.6119` → IC=+0.212 (n=551)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6119 (IC base=+0.004)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4434` → IC=+0.225 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4434 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` > `2.1598` → IC=+0.237 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1598 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `473.0` → IC=+0.213 (n=504)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 473.0 (IC base=+0.004)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.285 (n=523)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.245)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=1648)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.245)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.248 (n=1398)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.245)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=838)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.245)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.742` → IC=+0.280 (n=499)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.742 (IC base=+0.245)

- **PATRÓN** `volumen_pendiente_norm` < `0.1373` → IC=+0.257 (n=1397)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1373 (IC base=+0.245)

- **PATRÓN** `volumen_spike_ratio` > `3.4394` → IC=+0.260 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4394 (IC base=+0.245)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.254 (n=1117)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.245)

- **PATRÓN** `libro_liquidez` > `1955.62` → IC=+0.254 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1955.62 (IC base=+0.245)

- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.316 (n=569)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.6005` → IC=+0.284 (n=1253)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2222` → IC=+0.289 (n=1102)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2222 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.819` → IC=+0.298 (n=494)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5947` → IC=+0.289 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5947 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.7489` → IC=+0.285 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7489 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.290 (n=850)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1874.6847` → IC=+0.296 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1874.6847 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.284 (n=745)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2842` → IC=-0.185 (n=484)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2842
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1454)

- **FILTRO** `ibs_20min` > `0.7753` → IC=-0.185 (n=588)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7753
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=1765)

- **PATRÓN** `ibs_20min` > `0.9107` → IC=+0.178 (n=485)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.9107 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` > `0.4514` → IC=+0.224 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4514 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` < `0.7048` → IC=+0.206 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7048 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` < `0.9865` → IC=+0.233 (n=484)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9865 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` > `0.5867` → IC=+0.210 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5867 (IC base=+0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.0806` → IC=+0.253 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0806 (IC base=+0.010)
...
- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.240 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` > `0.1552` → IC=+0.205 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1552 (IC base=-0.006)

- **PATRÓN** `dist_vwap_pct` < `0.6852` → IC=+0.198 (n=482)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.6852 (IC base=-0.006)

- **PATRÓN** `volumen_regimen` < `1.0055` → IC=+0.213 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0055 (IC base=-0.006)

- **PATRÓN** `volumen_pendiente_norm` > `0.1645` → IC=+0.273 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1645 (IC base=-0.006)

- **PATRÓN** `volumen_spike_ratio` < `1.8269` → IC=+0.258 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8269 (IC base=-0.006)

- **PATRÓN** `volumen_spike_ratio` > `2.1743` → IC=+0.238 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1743 (IC base=-0.006)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.247 (n=381)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.006)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7196` → IC=-0.199 (n=1052)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7196
  - _Potencial_: sin este filtro IC_bueno=+0.281 (n=1052)

- **FILTRO** `ibs_20min` > `0.6857` → IC=-0.226 (n=550)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6857
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1651)

- **FILTRO** `sigma_ewma_delta_pct` > `4.678` → IC=-0.178 (n=479)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.678
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=1722)

- **PATRÓN** `ibs_20min` > `0.7196` → IC=+0.281 (n=1052)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7196 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` > `0.8467` → IC=+0.335 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8467 (IC base=+0.041)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.606` → IC=+0.161 (n=334)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 9.606 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.8696` → IC=+0.301 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8696 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `0.7298` → IC=+0.294 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7298 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` < `0.1016` → IC=+0.293 (n=717)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1016 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.2243` → IC=+0.299 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2243 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` < `1.4267` → IC=+0.325 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4267 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.312 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.041)

- **PATRÓN** `ibs_20min` < `0.5789` → IC=+0.121 (n=1453)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.5789 (IC base=+0.015)

- **PATRÓN** `dist_vwap_pct` < `0.2135` → IC=+0.218 (n=488)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0974` → IC=+0.210 (n=511)
...
- **PATRÓN** `volumen_spike_ratio` < `2.481` → IC=+0.219 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.481 (IC base=+0.015)

- **PATRÓN** `volumen_spike_ratio` > `1.5762` → IC=+0.199 (n=463)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.5762 (IC base=+0.015)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.236 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=+0.015)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.317 (n=859)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0168 (IC base=+0.277)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.295 (n=608)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.277)

- **PATRÓN** `ibs_20min` > `0.9111` → IC=+0.345 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9111 (IC base=+0.277)

- **PATRÓN** `dist_vwap_pct` > `0.2027` → IC=+0.318 (n=763)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2027 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.561` → IC=+0.300 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.561 (IC base=+0.277)

- **PATRÓN** `volumen_regimen` > `0.8622` → IC=+0.303 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8622 (IC base=+0.277)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1554` → IC=+0.291 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1554 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.283 (n=1379)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2625.8761` → IC=+0.293 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.8761 (IC base=+0.277)

- **PATRÓN** `sigma_h` > `0.0152` → IC=+0.296 (n=929)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.273 (n=694)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` < `0.3947` → IC=+0.304 (n=1394)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3947 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.2984` → IC=+0.278 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2984 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` < `0.968` → IC=+0.272 (n=1572)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.968 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.011` → IC=+0.295 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.011 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` < `0.6391` → IC=+0.273 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6391 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `1.2434` → IC=+0.305 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2434 (IC base=+0.271)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.338 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` < `1.4342` → IC=+0.269 (n=409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4342 (IC base=+0.271)

- **PATRÓN** `volumen_spike_ratio` > `2.1556` → IC=+0.276 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1556 (IC base=+0.271)

- **PATRÓN** `libro_liquidez` > `2618.2402` → IC=+0.276 (n=929)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2618.2402 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2584)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.199 (n=2582)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0899` → IC=+0.185 (n=2582)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0899 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=8036)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5789` → IC=+0.216 (n=7737)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5789 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1752` → IC=+0.196 (n=3378)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1752 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.352` → IC=+0.254 (n=1590)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.352 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2117` → IC=+0.159 (n=5119)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2117 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6287` → IC=+0.160 (n=5119)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6287 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2448` → IC=+0.193 (n=1559)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2448 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5599` → IC=+0.171 (n=3265)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5599 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.621` → IC=+0.174 (n=2473)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.621 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2400.9842` → IC=+0.168 (n=5158)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2400.9842 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.180 (n=6654)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 116.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.183 (n=4953)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0806` → IC=+0.207 (n=2473)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4787` → IC=+0.227 (n=7416)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4787 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2317` → IC=+0.159 (n=5394)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2317 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.342` → IC=+0.196 (n=1259)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.342 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1736` → IC=+0.152 (n=5377)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1736 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2914` → IC=+0.221 (n=1068)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2914 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5615` → IC=+0.168 (n=2965)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5615 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2561` → IC=+0.170 (n=3054)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2561 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.173 (n=6384)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 117.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.222 (n=440)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.181)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.188 (n=440)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0083 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.3425` → IC=+0.206 (n=1320)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3425 (IC base=+0.181)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.193 (n=884)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 11.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.301 (n=650)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.15` → IC=+0.310 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.15 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2298` → IC=+0.235 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2298 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.178 (n=1220)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4352 (IC base=+0.181)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.238 (n=850)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.238)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.251 (n=862)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.1881` → IC=+0.292 (n=642)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1881 (IC base=+0.238)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.244 (n=863)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.265 (n=962)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.25` → IC=+0.252 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.25 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.1583` → IC=+0.234 (n=904)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4206` → IC=+0.264 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4206 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1803.58` → IC=+0.245 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1803.58 (IC base=+0.238)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.232 (n=386)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.0742` → IC=+0.200 (n=384)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0742 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.183 (n=1212)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` > `0.4056` → IC=+0.225 (n=1152)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4056 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.211` → IC=+0.213 (n=684)
...
- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.162 (n=1152)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2628 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `1.0753` → IC=+0.168 (n=522)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0753 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.2815` → IC=+0.200 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2815 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` < `1.5013` → IC=+0.184 (n=492)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.5013 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `15931.8012` → IC=+0.160 (n=522)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 15931.8012 (IC base=+0.160)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.159 (n=1263)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0057 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.2906` → IC=+0.160 (n=1261)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.2906 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=421)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 18.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.5649` → IC=+0.187 (n=1261)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5649 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1336` → IC=+0.163 (n=1249)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1336 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.828` → IC=+0.204 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.828 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.158 (n=1261)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.2113 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1572` → IC=+0.151 (n=385)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.1572 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.147 (n=1150)
...
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.215 (n=433)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.2279` → IC=+0.215 (n=867)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2279 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1340)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.290 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.868` → IC=+0.278 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.868 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.1325` → IC=+0.197 (n=506)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1325 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `1.6401` → IC=+0.201 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6401 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.8516` → IC=+0.208 (n=559)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8516 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=928)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `1956.62` → IC=+0.203 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1956.62 (IC base=+0.197)

- **PATRÓN** `sigma_h` < `0.0114` → IC=+0.230 (n=1079)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0114 (IC base=+0.219)

- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.252 (n=361)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.219)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.276 (n=378)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.219)

- **PATRÓN** `ibs_20min` < `0.2407` → IC=+0.257 (n=948)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2407 (IC base=+0.219)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.269 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.748 (IC base=+0.219)

- **PATRÓN** `volumen_pendiente_norm` > `0.3579` → IC=+0.268 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3579 (IC base=+0.219)

- **PATRÓN** `volumen_spike_ratio` < `1.7818` → IC=+0.217 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7818 (IC base=+0.219)

- **PATRÓN** `volumen_spike_ratio` > `3.4055` → IC=+0.231 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.4055 (IC base=+0.219)

- **PATRÓN** `libro_liquidez` > `1884.0848` → IC=+0.221 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1884.0848 (IC base=+0.219)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.215 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 12.0 (IC base=+0.219)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.171 (n=1090)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0066 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.4327` → IC=+0.158 (n=1239)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4327 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1296)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` > `0.375` → IC=+0.196 (n=1239)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.375 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.1604` → IC=+0.180 (n=823)
...
- **PATRÓN** `volumen_regimen` < `1.0405` → IC=+0.144 (n=1090)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0405 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6254` → IC=+0.149 (n=1239)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6254 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2464` → IC=+0.195 (n=260)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2464 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `1.5375` → IC=+0.149 (n=534)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5375 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.529` → IC=+0.166 (n=405)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.529 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `6271.1406` → IC=+0.182 (n=826)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 6271.1406 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.145 (n=1176)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 164.0 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.154 (n=1311)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.383` → IC=+0.143 (n=1311)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6381` → IC=+0.171 (n=1311)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6381 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.363` → IC=+0.136 (n=1417)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.363 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.933` → IC=+0.170 (n=459)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 6.933 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8476` → IC=+0.147 (n=874)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8476 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2908` → IC=+0.198 (n=190)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2908 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.789` → IC=+0.134 (n=794)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.789 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.159 (n=594)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 10007.3401 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.153 (n=633)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0101 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=1421)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.118)

- **PATRÓN** `ibs_20min` > `0.5172` → IC=+0.203 (n=1395)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.731` → IC=+0.251 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.731 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.131 (n=1395)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2184 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.6417` → IC=+0.122 (n=1395)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6417 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` > `0.0705` → IC=+0.122 (n=586)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.0705 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.5459` → IC=+0.144 (n=593)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5459 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1460)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `2892.276` → IC=+0.198 (n=633)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2892.276 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.136 (n=1073)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 50.0 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.154 (n=626)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0061 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.1034` → IC=+0.154 (n=475)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1034 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1437)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.210 (n=1423)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.9994` → IC=+0.144 (n=186)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9994 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.1993` → IC=+0.139 (n=1312)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.1993 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.527` → IC=+0.142 (n=297)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 7.527 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.1725` → IC=+0.122 (n=1423)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.1725 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2754` → IC=+0.169 (n=173)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.2754 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4527` → IC=+0.130 (n=425)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4527 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.4205` → IC=+0.130 (n=425)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.4205 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `1466.1456` → IC=+0.134 (n=1271)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 1466.1456 (IC base=+0.114)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.214 (n=890)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1382)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.206 (n=613)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.202)

- **PATRÓN** `ibs_20min` > `0.7396` → IC=+0.260 (n=1193)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7396 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.5039` → IC=+0.221 (n=637)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5039 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.241 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2075` → IC=+0.205 (n=1336)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2075 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.8587` → IC=+0.221 (n=890)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8587 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.2322` → IC=+0.270 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2322 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.213 (n=1135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1508 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.7991` → IC=+0.209 (n=861)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7991 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1421)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2614.4054` → IC=+0.207 (n=890)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2614.4054 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0087` → IC=+0.228 (n=462)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0087 (IC base=+0.203)

- **PATRÓN** `sigma_h` > `0.0172` → IC=+0.205 (n=923)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0172 (IC base=+0.203)

- **PATRÓN** `drift_60min` |x|≤ `0.0896` → IC=+0.224 (n=462)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.438` → IC=+0.246 (n=1384)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.438 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `1.2049` → IC=+0.225 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2049 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` < `0.9018` → IC=+0.203 (n=1615)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9018 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.425` → IC=+0.242 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.425 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6291` → IC=+0.216 (n=1384)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6291 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2833` → IC=+0.290 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2833 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `2.2138` → IC=+0.193 (n=1093)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2138 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4377` → IC=+0.199 (n=1242)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4377 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2587.456` → IC=+0.206 (n=923)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2587.456 (IC base=+0.203)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.179 (n=611)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0089 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.0996` → IC=+0.151 (n=611)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.0996 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=922)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.3929` → IC=+0.179 (n=1833)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.3929 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.8726` → IC=+0.191 (n=286)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.8726 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.728` → IC=+0.175 (n=845)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.728 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8739` → IC=+0.163 (n=1072)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8739 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.2058` → IC=+0.152 (n=536)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2058 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.178 (n=510)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4385` → IC=+0.167 (n=589)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4385 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5403` → IC=+0.158 (n=588)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5403 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=2078)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12366.3016` → IC=+0.156 (n=611)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12366.3016 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.167 (n=1609)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 162.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.139 (n=1287)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0057 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.122 (n=1941)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 5.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` < `0.5212` → IC=+0.146 (n=1697)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5212 (IC base=+0.107)

- **PATRÓN** `volumen_spike_ratio` < `2.2271` → IC=+0.124 (n=1633)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.2271 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `3883.3874` → IC=+0.126 (n=1285)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 3883.3874 (IC base=+0.107)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2746` → IC=+0.160 (n=542)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.2746 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.147 (n=551)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 7.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` < `0.6012` → IC=+0.180 (n=542)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6012 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.3066` → IC=+0.155 (n=654)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.3066 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.384` → IC=+0.156 (n=239)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 4.384 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `1.208` → IC=+0.139 (n=616)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.208 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.7151` → IC=+0.149 (n=550)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.7151 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1594` → IC=+0.202 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1594 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `2.1022` → IC=+0.156 (n=533)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1022 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4187` → IC=+0.146 (n=606)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4187 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `386.0` → IC=+0.148 (n=583)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 386.0 (IC base=+0.135)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.258 (n=250)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.0958` → IC=+0.208 (n=190)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0958 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.208 (n=590)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` > `0.7028` → IC=+0.243 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7028 (IC base=+0.192)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.93` → IC=+0.221 (n=249)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.93 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` < `1.0194` → IC=+0.195 (n=500)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 1.0194 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` > `1.1544` → IC=+0.213 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1544 (IC base=+0.192)

- **PATRÓN** `volumen_pendiente_norm` > `0.2624` → IC=+0.277 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2624 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` < `1.3975` → IC=+0.241 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3975 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `2.4036` → IC=+0.225 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4036 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `12367.2302` → IC=+0.208 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12367.2302 (IC base=+0.192)

- **PATRÓN** `ibs_20min` < `0.1536` → IC=+0.150 (n=235)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.1536 (IC base=+0.088)

- **PATRÓN** `volumen_pendiente_norm` > `0.1667` → IC=+0.122 (n=125)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.1667 (IC base=+0.088)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **FILTRO** `ibs_20min` > `0.5172` → IC=-0.154 (n=128)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5172
  - _Potencial_: sin este filtro IC_bueno=+0.144 (n=386)

- **FILTRO** `dist_vwap_pct` > `0.3429` → IC=-0.149 (n=35)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.3429
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=479)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.181 (n=183)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0089 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.5281` → IC=+0.132 (n=403)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.5281 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.204 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7333 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.6296` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6296 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.1` → IC=+0.213 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.1 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `1.0697` → IC=+0.149 (n=354)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0697 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.288` → IC=+0.195 (n=57)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.288 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.2151` → IC=+0.176 (n=174)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.2151 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=438)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `3065.6596` → IC=+0.191 (n=134)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 3065.6596 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.144 (n=386)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.5172 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.8498` → IC=+0.146 (n=241)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.8498 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.122 (n=220)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 24.0 (IC base=+0.070)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.206 (n=3298)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=10293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=9901)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.9719` → IC=+0.207 (n=1385)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9719 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.628` → IC=+0.225 (n=4793)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.628 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.8812` → IC=+0.165 (n=4409)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8812 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2395` → IC=+0.199 (n=1850)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2395 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6001` → IC=+0.186 (n=3168)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6001 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2342.8724` → IC=+0.171 (n=6596)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2342.8724 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.194 (n=7517)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 87.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.192 (n=5995)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.007 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.1474` → IC=+0.189 (n=3952)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.1474 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.205 (n=3403)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5658` → IC=+0.238 (n=8980)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5658 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.247` → IC=+0.163 (n=5575)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.247 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.025` → IC=+0.203 (n=1256)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.025 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.732` → IC=+0.182 (n=8696)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.732 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7044` → IC=+0.162 (n=2720)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.7044 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2882` → IC=+0.240 (n=1179)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2882 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.632` → IC=+0.192 (n=2744)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.632 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.192 (n=5280)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.222 (n=560)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.3528` → IC=+0.189 (n=1681)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.197 (n=1140)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 11.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.324 (n=601)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.541` → IC=+0.343 (n=381)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.541 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2734` → IC=+0.251 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2734 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.55` → IC=+0.183 (n=698)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.55 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.5711` → IC=+0.199 (n=529)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.5711 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=1013)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.259 (n=1312)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.263 (n=1173)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.1282` → IC=+0.286 (n=577)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1282 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.269 (n=1178)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.259 (n=1198)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3469` → IC=+0.290 (n=1154)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3469 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.467` → IC=+0.264 (n=1372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.467 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2802` → IC=+0.282 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2802 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` < `1.5452` → IC=+0.255 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5452 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `1.8682` → IC=+0.271 (n=802)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8682 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1799.71` → IC=+0.264 (n=874)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1799.71 (IC base=+0.258)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.191 (n=528)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0028 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.0841` → IC=+0.159 (n=528)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0841 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1651)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3086` → IC=+0.203 (n=1584)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3086 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.3428` → IC=+0.197 (n=639)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.3428 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.755` → IC=+0.167 (n=364)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 9.755 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.251` → IC=+0.153 (n=1421)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.251 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6305` → IC=+0.179 (n=528)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6305 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2669` → IC=+0.200 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2669 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.1149` → IC=+0.163 (n=1346)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.1149 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7577` → IC=+0.154 (n=1019)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7577 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `15736.5198` → IC=+0.157 (n=718)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 15736.5198 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `476.0` → IC=+0.158 (n=1459)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 476.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.166 (n=1372)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3229` → IC=+0.162 (n=1372)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2689` → IC=+0.236 (n=915)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2689 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1332` → IC=+0.168 (n=1240)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1332 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.471` → IC=+0.162 (n=229)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 11.471 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.1894` → IC=+0.165 (n=1372)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1894 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1517` → IC=+0.195 (n=369)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1517 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4038` → IC=+0.160 (n=1273)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4038 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.162 (n=849)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `422.0` → IC=+0.159 (n=1035)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 422.0 (IC base=+0.151)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.242 (n=534)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.225 (n=1672)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1627)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` > `0.6709` → IC=+0.256 (n=1430)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6709 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.797` → IC=+0.295 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.797 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` < `0.212` → IC=+0.221 (n=1581)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.212 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.844` → IC=+0.240 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.844 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=1150)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.240 (n=1494)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0115 (IC base=+0.233)

- **PATRÓN** `drift_60min` |x|≤ `0.1659` → IC=+0.239 (n=657)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `drift_60min` |x|≤ `0.4373` → IC=+0.144 (n=1687)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4373 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1758)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.8773` → IC=+0.260 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8773 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.3697` → IC=+0.165 (n=664)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.3697 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.203` → IC=+0.159 (n=704)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.203 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8748` → IC=+0.154 (n=1124)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8748 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2371` → IC=+0.212 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2371 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.5214` → IC=+0.149 (n=718)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5214 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.7664` → IC=+0.147 (n=1087)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.7664 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8055.3183` → IC=+0.231 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8055.3183 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `79.0` → IC=+0.145 (n=522)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 79.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.156 (n=1380)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0076 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4451` → IC=+0.154 (n=1378)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7027` → IC=+0.182 (n=1378)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.7027 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.5983` → IC=+0.143 (n=1525)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.5983 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.146` → IC=+0.176 (n=202)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 11.146 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.147 (n=919)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8616 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `1.1867` → IC=+0.141 (n=460)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.1867 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2875` → IC=+0.241 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2875 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.443` → IC=+0.151 (n=1306)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.443 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `10912.0017` → IC=+0.210 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10912.0017 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `179.0` → IC=+0.145 (n=1306)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 179.0 (IC base=+0.137)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.135 (n=1114)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0081 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1710)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.190 (n=1674)
...
- **PATRÓN** `volumen_regimen` < `0.8919` → IC=+0.134 (n=1114)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8919 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1683)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2898.8632` → IC=+0.248 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2898.8632 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.130 (n=1287)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 54.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.176 (n=547)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0057 (IC base=+0.113)

- **PATRÓN** `drift_60min` |x|≤ `0.1316` → IC=+0.159 (n=546)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.1316 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1688)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.204 (n=1639)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.219` → IC=+0.131 (n=1338)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.219 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.463` → IC=+0.123 (n=1580)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.463 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.7169` → IC=+0.154 (n=720)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7169 (IC base=+0.113)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4462` → IC=+0.142 (n=492)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4462 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.5014` → IC=+0.128 (n=492)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` > 2.5014 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2824.0599` → IC=+0.164 (n=546)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2824.0599 (IC base=+0.113)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.218 (n=1116)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1740)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.210 (n=1497)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.249 (n=1674)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5146 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` > `0.2017` → IC=+0.234 (n=987)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2017 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.285` → IC=+0.267 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.285 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` < `1.0716` → IC=+0.211 (n=1474)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0716 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.6381` → IC=+0.215 (n=1674)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6381 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2342` → IC=+0.248 (n=292)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1761)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `2622.2007` → IC=+0.221 (n=1116)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2622.2007 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.227 (n=598)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0089 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.219 (n=600)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.255 (n=1792)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5172 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.2304` → IC=+0.201 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2304 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.9142` → IC=+0.203 (n=1997)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9142 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.826` → IC=+0.261 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.826 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.2333` → IC=+0.233 (n=598)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2333 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.264 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2827 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2014` → IC=+0.195 (n=1416)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2014 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4316` → IC=+0.196 (n=1608)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=2984)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.158 (n=2506)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0092 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.151 (n=2540)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.4017` → IC=+0.155 (n=2502)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4017 (IC base=+0.150)
...
- **PATRÓN** `ibs_20min` > `0.9429` → IC=+0.210 (n=948)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9429 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1853` → IC=+0.155 (n=1039)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1853 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.489` → IC=+0.144 (n=1717)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.489 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.174` → IC=+0.176 (n=467)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 10.174 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `0.9005` → IC=+0.160 (n=1221)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.9005 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1721` → IC=+0.184 (n=777)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1721 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.4565` → IC=+0.157 (n=937)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4565 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8844` → IC=+0.162 (n=1872)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8844 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3735.1792` → IC=+0.152 (n=1895)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3735.1792 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.195 (n=751)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0038 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4861` → IC=+0.155 (n=2250)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4861 (IC base=+0.137)
...
- **PATRÓN** `ibs_20min` < `0.0862` → IC=+0.172 (n=750)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.0862 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.6865` → IC=+0.151 (n=431)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.6865 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.429` → IC=+0.130 (n=2227)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.429 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.265` → IC=+0.146 (n=2242)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.265 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2455` → IC=+0.142 (n=2148)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2455 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` < `0.0976` → IC=+0.138 (n=2035)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` < 0.0976 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0728` → IC=+0.144 (n=1041)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.0728 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.4257` → IC=+0.147 (n=741)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4257 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.8123` → IC=+0.142 (n=1481)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8123 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.139 (n=2984)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `7022.3118` → IC=+0.150 (n=2010)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7022.3118 (IC base=+0.137)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.167 (n=127)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.003 (IC base=+0.152)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.174 (n=127)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0064 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.0895` → IC=+0.190 (n=127)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.0895 (IC base=+0.152)
...
- **PATRÓN** `ibs_20min` < `0.5452` → IC=+0.188 (n=251)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5452 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.3825` → IC=+0.158 (n=366)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.3825 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.401` → IC=+0.163 (n=399)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 2.401 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.2682` → IC=+0.153 (n=376)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2682 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `0.8476` → IC=+0.188 (n=251)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.8476 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.3101` → IC=+0.291 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3101 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `1.4485` → IC=+0.188 (n=126)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.4485 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `2.6734` → IC=+0.211 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6734 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `12451.0907` → IC=+0.192 (n=336)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 12451.0907 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.161 (n=886)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0043 (IC base=+0.153)
...
- **PATRÓN** `ibs_20min` < `0.2969` → IC=+0.158 (n=390)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.2969 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.7919` → IC=+0.168 (n=402)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.7919 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.9785` → IC=+0.167 (n=199)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.9785 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.4234` → IC=+0.164 (n=820)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4234 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.739` → IC=+0.162 (n=888)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.739 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `0.8944` → IC=+0.155 (n=592)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8944 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `0.7178` → IC=+0.156 (n=792)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7178 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.0781` → IC=+0.163 (n=381)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0781 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `1.4358` → IC=+0.168 (n=290)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4358 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=872)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `9250.3506` → IC=+0.154 (n=591)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 9250.3506 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.153 (n=751)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0084 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.1521` → IC=+0.182 (n=331)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.1521 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.165 (n=264)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.154 (n=501)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 10.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.748` → IC=+0.143 (n=751)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.748 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.1016` → IC=+0.149 (n=750)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.1016 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6221` → IC=+0.167 (n=166)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6221 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.3802` → IC=+0.142 (n=760)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3802 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.87` → IC=+0.161 (n=119)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 10.87 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.352` → IC=+0.143 (n=684)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.352 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.647` → IC=+0.172 (n=251)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.647 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.7274` → IC=+0.141 (n=670)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.7274 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0738` → IC=+0.166 (n=315)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0738 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.1958` → IC=+0.155 (n=647)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.1958 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.7791` → IC=+0.148 (n=490)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.7791 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `7583.3835` → IC=+0.165 (n=750)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 7583.3835 (IC base=+0.139)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `ibs_20min` > `0.9583` → IC=+0.220 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9583 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.247` → IC=+0.181 (n=45)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 9.247 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.086)

- **PATRÓN** `libro_liquidez` > `3421.4081` → IC=+0.136 (n=193)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 3421.4081 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.146 (n=213)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0069 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.5327` → IC=+0.137 (n=188)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.5327 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.160 (n=148)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 10.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.1508` → IC=+0.203 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1508 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.5986` → IC=+0.176 (n=100)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.5986 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.711` → IC=+0.133 (n=118)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 2.711 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` < `0.0898` → IC=+0.173 (n=163)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` < 0.0898 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3291.3893` → IC=+0.142 (n=213)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 3291.3893 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.157 (n=202)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 60.0 (IC base=+0.112)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0813` → IC=+0.137 (n=612)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.0813 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=651)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2418.9216` → IC=+0.145 (n=356)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2418.9216 (IC base=+0.095)
...
- **PATRÓN** `ibs_20min` > `0.6731` → IC=+0.177 (n=230)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.6731 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` > `0.198` → IC=+0.153 (n=145)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.198 (IC base=+0.071)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.387` → IC=+0.173 (n=102)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 5.387 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.0639` → IC=+0.159 (n=86)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.0639 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` > `0.2443` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2443 (IC base=+0.071)
...
- **FILTRO** `volumen_spike_ratio` > `1.3344` → IC=-0.352 (n=25)

  - _Acción_: SKIP cuando `volumen_spike_ratio` > 1.3344
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.122 (n=689)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2914.5894` → IC=+0.170 (n=231)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2914.5894 (IC base=+0.106)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=1724)
...
- **PATRÓN** `liq_n` > `18.0` → IC=+0.214 (n=47)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `liq_n` > 18.0 (IC base=+0.028)

- **PATRÓN** `liq_usd_total` > `80598.37` → IC=+0.163 (n=87)

  - _Acción_: Kelly boost +0.81€ cuando `liq_usd_total` > 80598.37 (IC base=+0.028)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.151 (n=84)

  - _Acción_: Kelly boost +0.76€ cuando `py_entrada` < 0.495 (IC base=+0.028)

### LIQUIDACIONES_5M#ETH#5min
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=767)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.125 (n=62)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=721)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.122 (n=80)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=625)
...
- **FILTRO** `py_entrada` < `0.44` → IC=-0.143 (n=208)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=497)

- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=347)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.198 (n=127)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=297)

- **FILTRO** `restante_min` < `3.32` → IC=-0.139 (n=106)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.144 (n=99)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=325)

- **FILTRO** `profundidad_ratio` < `41.5` → IC=-0.121 (n=212)

  - _Acción_: SKIP cuando `profundidad_ratio` < 41.5
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=212)

- **PATRÓN** `py_entrada` < `0.48` → IC=+0.175 (n=112)

  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` < 0.48 (IC base=+0.035)

- **PATRÓN** `profundidad_ratio` > `100.7` → IC=+0.188 (n=107)

  - _Acción_: Kelly boost +0.94€ cuando `profundidad_ratio` > 100.7 (IC base=+0.035)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` < `0.56` → IC=+0.210 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.56 (IC base=+0.110)

- **PATRÓN** `restante_min` > `10.79` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `restante_min` > 10.79 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.182 (n=20)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 16.0 (IC base=+0.110)

- **PATRÓN** `lag_apertura_s` < `239.64` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 239.64 (IC base=+0.110)

- **PATRÓN** `profundidad_ratio` > `247.8` → IC=+0.210 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio` > 247.8 (IC base=+0.110)

### LIQUIDACIONES_DEPTH_FASE0#BTC#5min
- **PATRÓN** `py_entrada` < `0.58` → IC=+0.244 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.58 (IC base=+0.135)

- **PATRÓN** `restante_min` < `3.1` → IC=+0.154 (n=24)

  - _Acción_: Kelly boost +0.77€ cuando `restante_min` < 3.1 (IC base=+0.135)

- **PATRÓN** `restante_min` > `3.99` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` > 3.99 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.273 (n=20)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.135)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.214 (n=19)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.135)

- **PATRÓN** `lag_apertura_s` < `60.77` → IC=+0.262 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `lag_apertura_s` < 60.77 (IC base=+0.135)

- **PATRÓN** `profundidad_ratio` > `79.6` → IC=+0.245 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio` > 79.6 (IC base=+0.135)
...
- **FILTRO** `restante_min` > `10.36` → IC=-0.167 (n=16)
...
- **FILTRO** `profundidad_ratio` < `56.2` → IC=-0.294 (n=32)
...
- **FILTRO** `restante_min` < `3.73` → IC=-0.309 (n=19)

  - _Acción_: SKIP cuando `restante_min` < 3.73
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=20)

- **FILTRO** `lag_apertura_s` > `76.24` → IC=-0.309 (n=19)
...
- **FILTRO** `restante_min` < `2.68` → IC=-0.289 (n=17)
...
- **FILTRO** `profundidad_ratio` < `25.8` → IC=-0.152 (n=44)

  - _Acción_: SKIP cuando `profundidad_ratio` < 25.8
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=7468)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.167 (n=3471)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10434)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.167 (n=3597)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=10810)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.152 (n=633)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1946)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.190 (n=611)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1844)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.201 (n=631)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=1945)

- **FILTRO** `ibs_20min` > `0.2812` → IC=-0.162 (n=643)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2812
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1933)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.171 (n=594)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1802)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.177 (n=632)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1948)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2744)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2922)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2928)
...
- **FILTRO** `py_entrada` < `0.395` → IC=-0.214 (n=68)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=244)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9919)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=21964)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7781)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=24102)

- **FILTRO** `ibs_7min` < `0.2857` → IC=-0.235 (n=7960)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2857
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=23923)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10833)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21050)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9811)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=30153)

- **FILTRO** `ibs_7min` > `0.2931` → IC=-0.178 (n=9988)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2931
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=29976)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.134 (n=1624)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3641)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=1256)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4009)

- **FILTRO** `ibs_7min` < `0.7104` → IC=-0.249 (n=1737)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7104
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3528)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.184 (n=1212)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4053)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.260 (n=1696)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5172)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.124 (n=2332)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4536)

- **FILTRO** `ibs_7min` > `0.7889` → IC=-0.205 (n=1716)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7889
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=5152)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4211)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.249 (n=1327)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4183)

- **FILTRO** `ibs_7min` < `0.7482` → IC=-0.191 (n=1375)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7482
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4135)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.172 (n=1375)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4135)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1391)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=4196)

- **FILTRO** `ibs_7min` > `0.2602` → IC=-0.177 (n=1396)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2602
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=4191)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.182 (n=1391)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=4196)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1426)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3562)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1222)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3766)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.257 (n=1242)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3746)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1161)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3827)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.236 (n=1681)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=5665)

- **FILTRO** `ibs_7min` > `0.7467` → IC=-0.176 (n=1836)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7467
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5510)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1703)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3557)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.231 (n=1553)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3707)

- **FILTRO** `ibs_7min` < `0.7413` → IC=-0.182 (n=1315)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7413
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3945)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.170 (n=1294)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3966)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1339)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=4025)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.177 (n=1340)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4024)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.186 (n=1325)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4039)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.259 (n=1352)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4221)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1389)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4184)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1811)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=5788)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1700)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3587)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1306)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3981)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.215 (n=1284)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4003)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1728)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5472)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1068)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1151)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.398` → IC=+0.124 (n=734)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.62€ cuando `delta_ratio` |x|> 0.398 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.127 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 14.0 (IC base=+0.109)
...
- **PATRÓN** `streak_estiramiento` < `0.4763` → IC=+0.150 (n=58)

  - _Acción_: Kelly boost +0.75€ cuando `streak_estiramiento` < 0.4763 (IC base=+0.040)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=767)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=773)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=716)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=2873)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1462)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1470)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.217 (n=712)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0085 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.0748` → IC=+0.202 (n=692)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0748 (IC base=+0.186)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2129` → IC=+0.196 (n=524)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.98€ cuando `delta_ratio_macro` |x|> 0.2129 (IC base=+0.186)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1267` → IC=+0.228 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1267 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.197 (n=1459)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6077` → IC=+0.265 (n=1571)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6077 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.1171` → IC=+0.188 (n=821)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1171 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.6102` → IC=+0.177 (n=1509)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6102 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.833` → IC=+0.276 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.833 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `2975.4354` → IC=+0.194 (n=1047)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=593)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.152 (n=162)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0041 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.160 (n=245)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0051 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.0674` → IC=+0.152 (n=162)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.0674 (IC base=+0.135)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2316` → IC=+0.180 (n=123)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.90€ cuando `delta_ratio_macro` |x|> 0.2316 (IC base=+0.135)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.258` → IC=+0.158 (n=261)

  - _Acción_: Kelly boost +0.79€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.258 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.158 (n=270)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 11.0 (IC base=+0.135)

- **PATRÓN** `ibs_15` > `0.662` → IC=+0.248 (n=328)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.1604` → IC=+0.149 (n=289)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1604 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.307` → IC=+0.204 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.307 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `9475.4181` → IC=+0.163 (n=167)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 9475.4181 (IC base=+0.135)
...
- **FILTRO** `ibs_15` > `0.2168` → IC=-0.219 (n=30)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **FILTRO** `dist_vwap_pct` > `0.5688` → IC=-0.135 (n=124)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=897)
...
- **PATRÓN** `sigma_h` > `0.0237` → IC=+0.259 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0237 (IC base=+0.187)

- **PATRÓN** `drift_60min` |x|≤ `0.0864` → IC=+0.210 (n=184)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0864 (IC base=+0.187)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0389` → IC=+0.191 (n=416)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0904` → IC=+0.245 (n=108)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0904 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.229 (n=142)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.187)

- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.282 (n=416)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` > `0.1302` → IC=+0.209 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1302 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.8104` → IC=+0.187 (n=480)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.8104 (IC base=+0.187)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `10.785` → IC=+0.190 (n=414)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` < 10.785 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `2911.6654` → IC=+0.273 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2911.6654 (IC base=+0.187)

- **PATRÓN** `ibs_15` < `0.1159` → IC=+0.160 (n=466)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.80€ cuando `ibs_15` < 0.1159 (IC base=+0.046)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.219 (n=649)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1950)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1199` → IC=+0.244 (n=1143)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1199 (IC base=-0.034)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.177` → IC=+0.234 (n=1107)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.177 (IC base=-0.034)

- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.276 (n=1714)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3457 (IC base=-0.034)

- **PATRÓN** `dist_vwap_pct` > `0.6876` → IC=+0.287 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6876 (IC base=-0.034)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.218 (n=395)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=1188)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.231 (n=395)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1188)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=999)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.177 (n=584)

- **FILTRO** `sigma_ewma_delta_pct` > `19.79` → IC=-0.245 (n=284)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.79
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1299)

- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.162 (n=149)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0028 (IC base=+0.080)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2023` → IC=+0.285 (n=77)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2023 (IC base=+0.080)
...
- **PATRÓN** `dist_vwap_pct` < `0.5746` → IC=+0.274 (n=184)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5746 (IC base=+0.080)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.262 (n=225)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0044 (IC base=+0.224)

- **PATRÓN** `drift_15min` |x|≤ `0.7869` → IC=+0.231 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7869 (IC base=+0.224)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2036` → IC=+0.256 (n=305)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2036 (IC base=+0.224)
...
- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.264 (n=673)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3469 (IC base=+0.224)

- **PATRÓN** `dist_vwap_pct` > `0.778` → IC=+0.302 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.778 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.806` → IC=+0.246 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.806 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.254` → IC=+0.229 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.254 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `3551.8492` → IC=+0.224 (n=672)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1021` → IC=+0.336 (n=199)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1021 (IC base=-0.045)

- **PATRÓN** `ibs_15` < `0.3429` → IC=+0.305 (n=460)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3429 (IC base=-0.045)

- **PATRÓN** `dist_vwap_pct` > `0.8964` → IC=+0.344 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8964 (IC base=-0.045)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0856` → IC=+0.210 (n=29)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0856 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `0