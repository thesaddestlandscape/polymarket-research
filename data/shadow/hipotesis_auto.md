# Hipótesis automáticas — 2026-07-02 02:00 UTC
_Generado por shadow_postmortem.py sobre 2517 resoluciones (PNL=-88.26€)_
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.258 (n=60)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.071)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.177 (n=29)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 17.0 (IC base=+0.071)

- **PATRÓN** `ibs_15` < `0.4968` → IC=+0.132 (n=85)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.66€ cuando `ibs_15` < 0.4968 (IC base=+0.071)
...
- **PATRÓN** `sigma_h` < `0.0124` → IC=+0.184 (n=17)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0124 (IC base=+0.118)
...
| ✅ UPDOWN_GBM | 765 | -0.035 | -37.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 545 | -0.010 | -11.17€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#DOGE | 20 | -0.136 | -6.50€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 17 | -0.112 | -5.60€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#XRP | 64 | +0.000 | +2.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 53 | +0.045 | +6.05€ | 1 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.091) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=113 | neutral: IC=-0.060 n=114 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=375 IC=-0.028 PNL=-11.86€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.231 n=24 PNL=-15.45€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1188 | tras_1loss IC=-0.037 n=1247 | tras_2loss IC=-0.051 n=648/40 | gap=+0.053 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=22, boost estimado=+0.008. Necesita 0 más y boost>0.05
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=642 IC=-0.028 PNL=-23.54€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=642 IC=-0.028 PNL=-23.54€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=162 IC=+0.043 PNL=+16.69€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=162 IC=+0.043 PNL=+16.69€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 100/200 ops en el filtro definido (IC actual=+0.039 PNL=+4.67€)
  - _Datos_: n=100 IC=+0.039 PNL=+4.67€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=100 IC=+0.039 PNL=+4.67€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=100 IC=+0.039 PNL=+4.67€
