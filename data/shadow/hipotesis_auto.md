# Hipótesis automáticas — 2026-08-10 14:08 UTC
_Generado por shadow_postmortem.py sobre 105155 resoluciones (PNL=+14822.44€)_
...
- **PATRÓN** `restante_min` < `4.64` → IC=+0.137 (n=728)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 4.64 (IC base=+0.130)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.142 (n=370)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` > 4.91 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.144 (n=1005)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 8.0 (IC base=+0.130)

- **PATRÓN** `lag_apertura_s` < `5.6` → IC=+0.147 (n=363)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 5.6 (IC base=+0.130)

- **PATRÓN** `profundidad_ratio_no` > `16.5` → IC=+0.159 (n=367)

  - _Acción_: Kelly boost +0.79€ cuando `profundidad_ratio_no` > 16.5 (IC base=+0.130)
...
- **PATRÓN** `restante_min` < `4.59` → IC=+0.138 (n=363)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` < 4.59 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.132 (n=504)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `restante_min` > `4.7` → IC=+0.156 (n=367)

  - _Acción_: Kelly boost +0.78€ cuando `restante_min` > 4.7 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=501)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.143)

- **PATRÓN** `lag_apertura_s` < `17.83` → IC=+0.154 (n=365)

  - _Acción_: Kelly boost +0.77€ cuando `lag_apertura_s` < 17.83 (IC base=+0.143)

- **PATRÓN** `profundidad_ratio_no` > `24.0` → IC=+0.204 (n=184)
...
### LIQUIDACIONES_5M
- **FILTRO** `liq_usd_total` < `911.42` → IC=-0.324 (n=15)

  - _Acción_: SKIP cuando `liq_usd_total` < 911.42
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=31)
...
- **FILTRO** `hora_utc` < `13.0` → IC=-0.177 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
| ✅ BALLENAS_TARDIAS | 3018 | -0.059 | -614.95€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 475 | +0.219 | -43.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2543 | -0.111 | -571.40€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 13311 | +0.200 | -978.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 13311 | +0.200 | -978.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2381 | +0.160 | -326.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2381 | +0.160 | -326.20€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2304 | +0.185 | -240.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2304 | +0.185 | -240.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 2155 | +0.219 | -79.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 2155 | +0.219 | -79.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 2165 | +0.217 | -97.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 2165 | +0.217 | -97.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 2196 | +0.197 | -181.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 2196 | +0.197 | -181.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 1451 | +0.130 | +21.44€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 1451 | +0.130 | +21.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 722 | +0.117 | -6.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 722 | +0.117 | -6.11€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 729 | +0.143 | +27.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 729 | +0.143 | +27.54€ | 0 | 6 |
...
| ✅ LIQUIDACIONES_5M | 81 | -0.175 | -15.61€ | 5 | 0 |
| ✅ LIQUIDACIONES_5M#5min | 81 | -0.175 | -15.61€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.132 n=64492 | tras_1loss IC=+0.087 n=40413 | tras_2loss IC=+0.050 n=16644/40 | gap=+0.082 (umbral 0.05)
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2381 IC=+0.160 PNL=-326.20€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2381 IC=+0.160 PNL=-326.20€
