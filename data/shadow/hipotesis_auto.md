# Hipótesis automáticas — 2026-08-21 22:54 UTC
_Generado por shadow_postmortem.py sobre 106490 resoluciones (PNL=+8835.54€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `156.77` → IC=-0.262 (n=1503)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.77
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4511)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.141 (n=380)
...
- **FILTRO** `restante_s_al_confirmar` < `138.64` → IC=-0.309 (n=150)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=452)
...
- **FILTRO** `restante_s_al_confirmar` < `368.32` → IC=-0.268 (n=140)
...
- **FILTRO** `restante_s_al_confirmar` < `143.44` → IC=-0.242 (n=359)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=1078)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `169.07` → IC=-0.329 (n=389)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 169.07
  - _Potencial_: sin este filtro IC_bueno=-0.127 (n=792)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=3597)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.143 (n=2389)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.194 (n=406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.6` → IC=+0.183 (n=197)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.6 (IC base=+0.135)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=906)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.294 (n=324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.195` → IC=+0.414 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.195 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `3221.4895` → IC=+0.312 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3221.4895 (IC base=+0.285)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.218 (n=232)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.247 (n=152)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.211)

- **PATRÓN** `py_entrada` < `0.31` → IC=+0.314 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.31 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `748.7377` → IC=+0.238 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 748.7377 (IC base=+0.211)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.120 (n=385)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.159 (n=262)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.02 (IC base=+0.104)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.190 (n=3397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.199 (n=1779)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.73 (IC base=+0.189)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.168 (n=579)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.187 (n=852)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.166 (n=869)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.216 (n=290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.198 (n=538)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=6599)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.197)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.228 (n=5373)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.163 (n=980)

  - _Acción_: Kelly boost +0.81€ cuando `py_entrada` > 0.71 (IC base=+0.119)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.269 (n=418)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.166 (n=647)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.249 (n=1051)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.243 (n=449)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.229 (n=470)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.239 (n=580)
...
- **PATRÓN** `restante_min` < `3.88` → IC=+0.157 (n=881)
...
- **PATRÓN** `lag_apertura_s` < `4.99` → IC=+0.149 (n=875)
...
- **PATRÓN** `restante_min` < `3.95` → IC=+0.137 (n=444)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.311 (n=505)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.825` → IC=+0.387 (n=166)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.329 (n=156)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.795` → IC=+0.377 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.795 (IC base=+0.301)

- **PATRÓN** `libro_liquidez` > `2591.029` → IC=+0.342 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2591.029 (IC base=+0.301)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.412 (n=180)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4013` → IC=+0.131 (n=1767)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.4013 (IC base=+0.045)

- **PATRÓN** `dist_vwap_pct` < `0.1302` → IC=+0.145 (n=581)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1302 (IC base=+0.045)

- **PATRÓN** `volumen_regimen` < `0.8575` → IC=+0.133 (n=399)
...
- **PATRÓN** `volumen_spike_ratio` > `3.1445` → IC=+0.219 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1445 (IC base=+0.045)

- **PATRÓN** `ballena_activa_n` < `155.0` → IC=+0.248 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 155.0 (IC base=+0.045)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0867` → IC=+0.167 (n=145)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0867 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.138 (n=310)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5573` → IC=+0.160 (n=330)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.5573 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` < `0.1757` → IC=+0.168 (n=290)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1757 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.029` → IC=+0.233 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.029 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` < `0.6267` → IC=+0.152 (n=110)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6267 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `1.2387` → IC=+0.143 (n=110)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.2387 (IC base=+0.130)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7866` → IC=+0.173 (n=151)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.7866 (IC base=+0.130)
...
- **PATRÓN** `libro_liquidez` > `13718.6409` → IC=+0.170 (n=110)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 13718.6409 (IC base=+0.130)

- **PATRÓN** `ballena_activa_n` < `254.0` → IC=+0.161 (n=60)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 254.0 (IC base=+0.130)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.116` → IC=+0.188 (n=46)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 12.116 (IC base=+0.008)
...
- **FILTRO** `ibs_20min` > `0.7425` → IC=-0.146 (n=224)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7425
...
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.159 (n=675)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0074 (IC base=+0.056)

- **PATRÓN** `ibs_20min` > `0.9491` → IC=+0.259 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9491 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` > `0.3426` → IC=+0.251 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3426 (IC base=+0.056)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.317` → IC=+0.133 (n=1196)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 2.317 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `1.1848` → IC=+0.189 (n=207)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.1848 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.3246` → IC=+0.220 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3246 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `1.6944` → IC=+0.161 (n=776)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.6944 (IC base=+0.056)
...
- **FILTRO** `ibs_20min` < `0.0923` → IC=-0.172 (n=123)

  - _Acción_: SKIP cuando `ibs_20min` < 0.0923
...
- **FILTRO** `ibs_20min` < `0.4099` → IC=-0.129 (n=157)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4099
...
- **PATRÓN** `ibs_20min` > `0.7857` → IC=+0.248 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7857 (IC base=+0.001)

- **PATRÓN** `dist_vwap_pct` > `0.1779` → IC=+0.236 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1779 (IC base=+0.001)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.975` → IC=+0.134 (n=80)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 6.975 (IC base=+0.001)

- **PATRÓN** `volumen_regimen` > `1.1512` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 1.1512 (IC base=+0.001)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7837` → IC=+0.151 (n=61)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.7837 (IC base=+0.001)

- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.225 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 61.0 (IC base=+0.001)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.185 (n=599)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 17.0 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.162 (n=850)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.8958` → IC=+0.266 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8958 (IC base=+0.159)
...
- **PATRÓN** `volumen_regimen` > `0.8884` → IC=+0.184 (n=710)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 0.8884 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.1053` → IC=+0.188 (n=598)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1053 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `2.438` → IC=+0.148 (n=1295)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.438 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.4835` → IC=+0.146 (n=1471)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4835 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=1782)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `3299.2146` → IC=+0.212 (n=571)
...
- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.243 (n=68)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0023 (IC base=+0.207)

- **PATRÓN** `sigma_h` > `0.0036` → IC=+0.225 (n=136)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0036 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=212)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.266 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.207)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.779` → IC=+0.318 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.779 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` > `0.9306` → IC=+0.254 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9306 (IC base=+0.207)

- **PATRÓN** `volumen_pendiente_norm` > `0.2917` → IC=+0.281 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2917 (IC base=+0.207)

- **PATRÓN** `volumen_spike_ratio` < `1.427` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.427 (IC base=+0.207)

- **PATRÓN** `volumen_spike_ratio` > `1.7331` → IC=+0.212 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7331 (IC base=+0.207)

- **PATRÓN** `libro_liquidez` > `11121.9309` → IC=+0.261 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11121.9309 (IC base=+0.207)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3484` → IC=+0.201 (n=1785)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3484 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.206 (n=841)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` < `0.5371` → IC=+0.254 (n=1783)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5371 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` < `0.7418` → IC=+0.174 (n=1410)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.7418 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.17` → IC=+0.227 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.17 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.52` → IC=+0.194 (n=1672)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 2.52 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` < `0.6119` → IC=+0.177 (n=434)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6119 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` > `1.1938` → IC=+0.183 (n=434)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.1938 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.2382` → IC=+0.240 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2382 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` < `1.8801` → IC=+0.185 (n=728)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.8801 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.3399` → IC=+0.198 (n=495)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.3399 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.127 (n=440)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 56.0 (IC base=+0.190)
...
- **PATRÓN** `sigma_h` < `0.002` → IC=+0.194 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.002 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.3101` → IC=+0.170 (n=322)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3101 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.164 (n=325)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.159)
...
- **PATRÓN** `ibs_20min` < `0.4957` → IC=+0.201 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4957 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.2777` → IC=+0.190 (n=308)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.2777 (IC base=+0.159)
...
- **PATRÓN** `volumen_regimen` > `1.2206` → IC=+0.182 (n=108)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.2206 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.0932` → IC=+0.283 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0932 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `1.7388` → IC=+0.208 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7388 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.161 (n=414)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `12550.5978` → IC=+0.173 (n=108)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 12550.5978 (IC base=+0.159)

- **PATRÓN** `ballena_activa_n` < `329.0` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 329.0 (IC base=+0.159)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3805` → IC=+0.148 (n=208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3805 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.130 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.146` → IC=+0.134 (n=121)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.146 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.7287` → IC=+0.147 (n=219)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.7287 (IC base=+0.126)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0923` → IC=+0.165 (n=159)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` < 0.0923 (IC base=+0.126)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1429` → IC=+0.169 (n=134)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.1429 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.5496` → IC=+0.176 (n=137)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.5496 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `4025.7224` → IC=+0.136 (n=138)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3965` → IC=+0.230 (n=457)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3965 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.264 (n=210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` < `0.4643` → IC=+0.284 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4643 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` < `0.7191` → IC=+0.224 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7191 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.929` → IC=+0.250 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.929 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.8` → IC=+0.218 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.8 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.8799` → IC=+0.243 (n=305)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.152 (n=314)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2606` → IC=+0.177 (n=218)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2606 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.181 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.676` → IC=+0.171 (n=247)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.676 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.4168` → IC=+0.152 (n=251)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4168 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.471` → IC=+0.146 (n=235)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 5.471 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.1687` → IC=+0.168 (n=218)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.1687 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` < `0.1425` → IC=+0.143 (n=239)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.1425 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `2.6912` → IC=+0.171 (n=244)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.6912 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.4126` → IC=+0.138 (n=244)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4126 (IC base=+0.134)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=314)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `6569.3282` → IC=+0.191 (n=247)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 6569.3282 (IC base=+0.134)
...
- **FILTRO** `liq_usd_total` < `433.59` → IC=-0.136 (n=20)
...
- **PATRÓN** `libro_liquidez` > `2223.5408` → IC=+0.160 (n=45)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2223.5408 (IC base=+0.022)
...
- **PATRÓN** `ibs_20min` < `0.8452` → IC=+0.121 (n=56)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.8452 (IC base=+0.056)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.163 (n=363)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=1109)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.253 (n=358)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1126)

- **FILTRO** `ibs_20min` > `0.278` → IC=-0.239 (n=370)
...
- **FILTRO** `ibs_20min` < `0.8288` → IC=-0.120 (n=106)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8288
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=107)
...
- **FILTRO** `ibs_20min` > `0.1846` → IC=-0.177 (n=122)

  - _Acción_: SKIP cuando `ibs_20min` > 0.1846
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=124)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.123 (n=83)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.505 (IC base=+0.002)

- **PATRÓN** `libro_liquidez` > `1523.5048` → IC=+0.127 (n=73)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 1523.5048 (IC base=+0.002)
...
- **FILTRO** `ibs_20min` < `0.8649` → IC=-0.127 (n=108)
...
- **PATRÓN** `ibs_20min` > `0.9506` → IC=+0.171 (n=74)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.9506 (IC base=-0.011)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` > `0.505` → IC=-0.200 (n=58)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=209)

- **FILTRO** `ballena_activa_n` > `3.0` → IC=-0.144 (n=85)
...
- **PATRÓN** `ballena_activa_n` < `1.0` → IC=+0.121 (n=114)
  ...
  - _Acción_: Kelly boost +0.60€ cuando `ballena_activa_n` < 1.0 (IC base=+0.022)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.210 (n=60)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.113 (n=192)
...
- **FILTRO** `py_entrada` > `0.65` → IC=-0.333 (n=52)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=179)

- **FILTRO** `drift_20min_pct` |x|> `0.347` → IC=-0.188 (n=78)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.347
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=153)

- **FILTRO** `ibs_20min` > `0.2884` → IC=-0.381 (n=57)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2884
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=174)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.136 (n=116)

  - _Acción_: Kelly boost +0.68€ cuando `py_entrada` > 0.505 (IC base=+0.035)

- **PATRÓN** `libro_liquidez` > `2472.967` → IC=+0.136 (n=86)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2472.967 (IC base=+0.035)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=862)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=2781)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.217 (n=907)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2736)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.167 (n=1230)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2413)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.219 (n=1072)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=3274)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.158 (n=1084)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3262)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.3` → IC=-0.308 (n=128)

  - _Acción_: SKIP cuando `py_entrada` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=387)

- **FILTRO** `ibs_7min` < `0.9412` → IC=-0.186 (n=339)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9412
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=176)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.221 (n=127)
...
- **FILTRO** `py_entrada` < `0.38` → IC=-0.247 (n=180)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=566)

- **FILTRO** `ballena_activa_n` > `94.0` → IC=-0.131 (n=253)

  - _Acción_: SKIP cuando `ballena_activa_n` > 94.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=493)
...
- **FILTRO** `py_entrada` < `0.32` → IC=-0.339 (n=122)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=373)

- **FILTRO** `ibs_7min` < `0.2` → IC=-0.252 (n=123)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=372)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.271 (n=120)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.259 (n=168)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=583)
...
- **FILTRO** `libro_liquidez` < `1598.9332` → IC=-0.184 (n=17)

  - _Acción_: SKIP cuando `libro_liquidez` < 1598.9332
...
### UPDOWN_GBM#5min
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0044` → IC=-0.132 (n=210)
...
- **PATRÓN** `dist_vwap_pct` < `0.16` → IC=+0.130 (n=71)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.16 (IC base=+0.033)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.69` → IC=+0.143 (n=26)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 17.69 (IC base=+0.033)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.138 (n=125)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.03 (IC base=+0.033)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.175` → IC=+0.167 (n=37)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.175 (IC base=+0.054)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.173 (n=53)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.03 (IC base=+0.054)
...
- **FILTRO** `sigma_h` > `0.0089` → IC=-0.185 (n=443)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0089
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1331)

- **FILTRO** `drift_15min` |x|> `0.7958` → IC=-0.134 (n=443)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.7958
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=1331)
...
- **FILTRO** `sigma_ewma_delta_pct` > `13.477` → IC=-0.203 (n=325)
...
- **FILTRO** `sigma_h` > `0.0063` → IC=-0.275 (n=100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0063
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=301)

- **FILTRO** `drift_15min` |x|> `0.7739` → IC=-0.226 (n=100)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.7739
  - _Potencial_: sin este filtro IC_bueno=-0.206 (n=301)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.247 (n=97)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `20.323` → IC=-0.247 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.201 (n=316)
...
- **FILTRO** `sigma_h` > `0.0078` → IC=-0.149 (n=212)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `sigma_h` > `0.0085` → IC=-0.195 (n=195)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0085
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=380)

- **FILTRO** `drift_60min` |x|> `0.4874` → IC=-0.183 (n=143)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.4874
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=432)

- **FILTRO** `drift_15min` |x|> `0.8758` → IC=-0.169 (n=143)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
...
- **FILTRO** `sigma_ewma_delta_pct` > `14.673` → IC=-0.246 (n=69)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=506)
...
| ✅ BALLENAS_TARDIAS | 4865 | -0.104 | -545.67€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 561 | -0.077 | -97.74€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 4304 | -0.107 | -447.94€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 602 | -0.116 | -80.92€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 602 | -0.116 | -80.92€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 561 | -0.077 | -97.74€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 561 | -0.077 | -97.74€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1437 | -0.009 | +39.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1437 | -0.009 | +39.25€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1181 | -0.194 | -212.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1181 | -0.194 | -212.81€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 20907 | +0.112 | -1487.52€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4301 | +0.184 | -169.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 13679 | +0.088 | -1264.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2821 | +0.128 | -4.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2303 | +0.051 | -454.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 16 | -0.089 | -1.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2282 | +0.053 | -446.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 4502 | +0.135 | -95.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1191 | +0.192 | -78.13€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2275 | +0.106 | -67.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 994 | +0.141 | +71.96€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 