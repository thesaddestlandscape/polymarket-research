# Hipótesis automáticas — 2026-07-01 22:44 UTC
_Generado por shadow_postmortem.py sobre 2475 resoluciones (PNL=-89.13€)_
...
- **PATRÓN** `sigma_h` < `0.009` → IC=+0.260 (n=48)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.009 (IC base=+0.078)

- **PATRÓN** `ibs_15` < `0.2802` → IC=+0.130 (n=52)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.65€ cuando `ibs_15` < 0.2802 (IC base=+0.078)
...
| ✅ UPDOWN_GBM | 727 | -0.039 | -38.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 510 | -0.014 | -11.60€ | 2 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.116) — sin ventaja clara. oversold(IBS<0.3): IC=+0.010 n=102 | neutral: IC=-0.106 n=97 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=337 IC=-0.037 PNL=-12.77€
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=20, boost estimado=+0.007. Necesita 0 más y boost>0.05
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=-0.002 n=1164 | tras_1loss IC=-0.035 n=1229 | tras_2loss IC=-0.050 n=640/40 | gap=+0.048 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=604 IC=-0.033 PNL=-24.46€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=604 IC=-0.033 PNL=-24.46€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=127 IC=+0.043 PNL=+16.26€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=127 IC=+0.043 PNL=+16.26€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 58/200 ops en el filtro definido (IC actual=+0.033 PNL=+3.80€)
  - _Datos_: n=58 IC=+0.033 PNL=+3.80€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 58/100 ops en el filtro definido (IC actual=+0.033 PNL=+3.80€)
  - _Datos_: n=58 IC=+0.033 PNL=+3.80€
