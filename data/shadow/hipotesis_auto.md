# Hipótesis automáticas — 2026-09-03 16:12 UTC
_Generado por shadow_postmortem.py sobre 269334 resoluciones (PNL=+25112.94€)_
...
- **FILTRO** `py_entrada` > `0.5` → IC=-0.392 (n=81)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=271)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.123 (n=271)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.5 (IC base=+0.003)
...
- **PATRÓN** `py_entrada` < `0.475` → IC=+0.131 (n=82)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `py_entrada` < 0.475 (IC base=-0.020)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.66` → IC=-0.297 (n=3646)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.66
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=10938)
...
- **FILTRO** `restante_s_al_confirmar` > `649.08` → IC=-0.155 (n=236)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` > 649.08
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=711)
...
- **FILTRO** `restante_s_al_confirmar` < `113.85` → IC=-0.403 (n=481)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=1445)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `141.52` → IC=-0.314 (n=809)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.192 (n=7790)
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.254 (n=4848)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.185 (n=3806)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1926.7157` → IC=+0.176 (n=3249)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 1926.7157 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.198 (n=820)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 7.0 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.198 (n=905)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.189 (n=1157)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.144 (n=1618)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 5.0 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.140 (n=1367)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.266 (n=614)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.260)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.263 (n=694)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.261 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.260)

- **PATRÓN** `libro_liquidez` > `1939.4936` → IC=+0.269 (n=665)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.208 (n=17054)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.189)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=3499)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.178 (n=2489)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.181 (n=2937)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.71 (IC base=+0.163)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.236 (n=1482)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `restante_min` > `4.93` → IC=+0.152 (n=2451)
...
- **PATRÓN** `lag_apertura_s` < `4.17` → IC=+0.154 (n=2279)
...
- **PATRÓN** `lag_apertura_s` < `7.04` → IC=+0.151 (n=1495)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.159 (n=1287)

  - _Acción_: Kelly boost +0.79€ cuando `restante_min` > 4.94 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.131 (n=3440)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3559` → IC=+0.129 (n=3579)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` > 0.3559 (IC base=+0.080)

- **PATRÓN** `dist_vwap_pct` > `0.8405` → IC=+0.226 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8405 (IC base=+0.080)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.547` → IC=+0.152 (n=1370)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1719` → IC=+0.180 (n=610)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1719 (IC base=+0.080)

- **PATRÓN** `volumen_spike_ratio` < `2.8852` → IC=+0.176 (n=2125)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.8852 (IC base=+0.080)

- **PATRÓN** `volumen_spike_ratio` > `1.4763` → IC=+0.171 (n=2125)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.4763 (IC base=+0.080)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.203 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.080)

- **PATRÓN** `ibs_20min` < `0.4065` → IC=+0.127 (n=3460)
...
- **PATRÓN** `volumen_regimen` < `0.6862` → IC=+0.153 (n=534)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8566` → IC=+0.215 (n=601)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8566 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `129.0` → IC=+0.212 (n=1361)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.271 (n=482)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.262)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.270 (n=537)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.270 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.262)

- **PATRÓN** `libro_liquidez` > `1702.9231` → IC=+0.280 (n=353)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.235 (n=650)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1784` → IC=+0.220 (n=394)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.05` → IC=+0.215 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.05 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.216 (n=624)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1084` → IC=+0.228 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1084 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `11865.8018` → IC=+0.239 (n=557)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1766` → IC=+0.154 (n=458)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1766 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.142 (n=618)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 8.0 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.140 (n=687)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 17.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.6565` → IC=+0.165 (n=687)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.6565 (IC base=+0.139)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.151` → IC=+0.209 (n=170)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.151 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `1.7307` → IC=+0.153 (n=387)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.7307 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.41` → IC=+0.156 (n=579)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.41 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.140 (n=890)
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.250 (n=606)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.3699` → IC=+0.242 (n=533)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3699 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.237 (n=291)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.237)
...
- **PATRÓN** `ibs_20min` < `0.0415` → IC=+0.299 (n=202)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0415 (IC base=+0.237)
...
- **PATRÓN** `dist_vwap_pct` > `0.3391` → IC=+0.333 (n=28)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3391 (IC base=-0.037)

- **PATRÓN** `dist_vwap_pct` < `0.1477` → IC=+0.274 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1477 (IC base=-0.037)

- **PATRÓN** `volumen_regimen` < `0.6313` → IC=+0.346 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6313 (IC base=-0.037)

- **PATRÓN** `volumen_regimen` > `1.3249` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.3249 (IC base=-0.037)

- **PATRÓN** `volumen_pendiente_norm` > `0.2291` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2291 (IC base=-0.037)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9887` → IC=+0.287 (n=45)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9887 (IC base=-0.037)

- **PATRÓN** `ballena_activa_n` < `176.0` → IC=+0.274 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 176.0 (IC base=-0.037)
...
- **FILTRO** `drift_60min` |x|> `0.531` → IC=-0.160 (n=342)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=665)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.174 (n=1478)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0094 (IC base=+0.070)

- **PATRÓN** `ibs_20min` > `0.2857` → IC=+0.139 (n=4432)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.2857 (IC base=+0.070)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0869` → IC=+0.214 (n=1977)
...
- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.302 (n=1586)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 96.0 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5834` → IC=+0.131 (n=4301)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.5834 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.7476` → IC=+0.264 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7476 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` < `0.2265` → IC=+0.222 (n=1054)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2265 (IC base=+0.051)

- **PATRÓN** `volumen_regimen` < `0.7154` → IC=+0.233 (n=484)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4365` → IC=+0.274 (n=564)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4365 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.271 (n=1083)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.384` → IC=-0.167 (n=316)
...
- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.357 (n=131)
...
- **PATRÓN** `ballena_activa_n` < `290.0` → IC=+0.142 (n=132)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 290.0 (IC base=-0.017)
...
- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.322 (n=442)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0061 (IC base=+0.309)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.324 (n=351)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.703` → IC=+0.332 (n=153)
...
- **PATRÓN** `volumen_spike_ratio` < `3.4973` → IC=+0.307 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.4973 (IC base=+0.309)

- **PATRÓN** `volumen_spike_ratio` > `2.4031` → IC=+0.322 (n=268)
...
- **FILTRO** `ibs_20min` < `0.8` → IC=-0.145 (n=627)
...
- **FILTRO** `ibs_20min` > `0.7568` → IC=-0.226 (n=275)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=828)
...
- **PATRÓN** `dist_vwap_pct` > `0.3189` → IC=+0.299 (n=167)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3189 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` < `0.87` → IC=+0.239 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.87 (IC base=+0.003)

- **PATRÓN** `volumen_regimen` > `1.1627` → IC=+0.300 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1627 (IC base=+0.003)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4503` → IC=+0.294 (n=95)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4503 (IC base=+0.003)

- **PATRÓN** `volumen_spike_ratio` > `2.3419` → IC=+0.240 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3419 (IC base=+0.003)
...
- **PATRÓN** `volumen_regimen` > `1.0965` → IC=+0.301 (n=355)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.166 (n=732)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.4762` → IC=+0.169 (n=771)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.4762 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.8496` → IC=+0.236 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8496 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.588` → IC=+0.175 (n=361)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.588 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8791` → IC=+0.154 (n=414)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8791 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `0.6967` → IC=+0.146 (n=555)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.6967 (IC base=+0.136)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2857` → IC=+0.146 (n=631)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.2857 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.8649` → IC=+0.144 (n=478)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8649 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=578)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `6332.2628` → IC=+0.179 (n=257)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 6332.2628 (IC base=+0.136)
...
- **FILTRO** `hora_utc` < `10.0` → IC=-0.186 (n=33)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.161 (n=125)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.161 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 10.0 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.9398` → IC=+0.232 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9398 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.817` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.817 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.673` → IC=+0.190 (n=56)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 3.673 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.3825` → IC=+0.140 (n=109)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.3825 (IC base=+0.087)

- **PATRÓN** `libro_liquidez` > `11005.6828` → IC=+0.148 (n=106)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 11005.6828 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.6193` → IC=+0.148 (n=231)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.6193 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.142` → IC=+0.147 (n=49)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 9.142 (IC base=+0.064)
...
- **PATRÓN** `ballena_activa_n` < `148.0` → IC=+0.183 (n=77)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 148.0 (IC base=+0.064)
...
- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.198 (n=4147)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0108 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.4819` → IC=+0.197 (n=4148)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.242 (n=4148)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5625 (IC base=+0.188)

- **PATRÓN** `dist_vwap_pct` < `0.4384` → IC=+0.173 (n=2959)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.4384 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.669` → IC=+0.213 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.669 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.581` → IC=+0.190 (n=4088)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3089` → IC=+0.204 (n=1559)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3089 (IC base=+0.188)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.181 (n=3020)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.285 (n=491)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.274)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.280 (n=552)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_spike_ratio` > `1.5014` → IC=+0.295 (n=437)
...
- **PATRÓN** `libro_liquidez` > `1456.1771` → IC=+0.279 (n=483)
...
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.242 (n=293)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.481` → IC=+0.293 (n=196)
...
- **PATRÓN** `volumen_spike_ratio` < `3.0513` → IC=+0.243 (n=461)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1332` → IC=+0.167 (n=250)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.1332 (IC base=+0.114)
...
- **PATRÓN** `ibs_20min` < `0.6` → IC=+0.199 (n=749)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.5076` → IC=+0.140 (n=725)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5076 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.187` → IC=+0.138 (n=740)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 3.187 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.8807` → IC=+0.135 (n=499)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8807 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.0726` → IC=+0.159 (n=247)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0726 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.144 (n=200)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4564 (IC base=+0.114)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5271` → IC=+0.217 (n=831)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5271 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.216 (n=453)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.213)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.218 (n=1000)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.265 (n=957)
...
- **PATRÓN** `volumen_regimen` > `0.7057` → IC=+0.225 (n=844)
...
- **PATRÓN** `drift_60min` |x|≤ `0.556` → IC=+0.130 (n=1472)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.022` → IC=+0.123 (n=1496)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 6.022 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` > `0.9016` → IC=+0.124 (n=653)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.9016 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.1741` → IC=+0.151 (n=402)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.1741 (IC base=+0.120)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9037` → IC=+0.141 (n=971)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.9037 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `8926.6094` → IC=+0.134 (n=668)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8926.6094 (IC base=+0.120)
...
- **PATRÓN** `libro_liquidez` > `2469.6086` → IC=+0.136 (n=193)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.177 (n=1426)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=4280)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.187 (n=1455)
...
- **FILTRO** `py_entrada` < `0.4` → IC=-0.243 (n=204)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=665)

- **FILTRO** `ibs_20min` < `0.7324` → IC=-0.212 (n=217)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7324
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=652)
...
- **FILTRO** `ibs_20min` > `0.7296` → IC=-0.154 (n=258)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7296
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=777)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.165 (n=231)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=745)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.144 (n=259)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=704)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.201 (n=222)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=685)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=4023)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=9955)
...
- **FILTRO** `ibs_7min` < `0.7115` → IC=-0.248 (n=3493)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7115
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=10485)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.169 (n=4678)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=9300)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.219 (n=4332)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=13244)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=4389)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=13187)
...
- **FILTRO** `py_entrada` < `0.31` → IC=-0.319 (n=505)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1528)
...
- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.226 (n=505)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=1528)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.141 (n=2036)

  - _Acción_: SKIP cuando `py_entrada` > 0.52
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1021)

- **FILTRO** `drift_7min_pct` |x|> `0.1143` → IC=-0.130 (n=1037)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1143
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2020)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.191 (n=764)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2293)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=572)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=2042)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.258 (n=635)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1979)

- **FILTRO** `ibs_7min` < `0.7711` → IC=-0.196 (n=653)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7711
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1961)

- **FILTRO** `ballena_activa_n` > `168.0` → IC=-0.177 (n=649)

  - _Acción_: SKIP cuando `ballena_activa_n` > 168.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=1965)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.245 (n=601)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=2020)

- **FILTRO** `ballena_activa_n` > `106.0` → IC=-0.177 (n=888)
...
- **FILTRO** `hora_utc` < `9.0` → IC=-0.184 (n=656)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.096 (n=1409)
...
- **FILTRO** `ibs_7min` < `0.2105` → IC=-0.293 (n=515)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=1550)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.249 (n=489)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=1576)
...
- **FILTRO** `ibs_7min` > `0.8` → IC=-0.171 (n=785)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.258 (n=581)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1791)

- **FILTRO** `ibs_7min` < `0.7509` → IC=-0.196 (n=593)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7509
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=1779)

- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.175 (n=802)

  - _Acción_: SKIP cuando `ballena_activa_n` > 26.0
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=1570)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.238 (n=773)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.180 (n=795)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=2507)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.123 (n=739)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1548)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.297 (n=559)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1728)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.247 (n=568)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1719)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.229 (n=548)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1739)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.253 (n=604)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2465)

- **FILTRO** `ibs_7min` > `0.7752` → IC=-0.161 (n=767)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7752
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2302)
...
- **FILTRO** `T_h` > `135.9709` → IC=-0.151 (n=64)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.428` → IC=-0.205 (n=59)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=754)
...
- **PATRÓN** `ibs_15` < `0.1304` → IC=+0.177 (n=159)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.89€ cuando `ibs_15` < 0.1304 (IC base=+0.032)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.140 (n=337)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1241` → IC=+0.244 (n=287)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1241 (IC base=-0.066)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1036` → IC=+0.247 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1036 (IC base=-0.066)

- **PATRÓN** `ibs_15` < `0.3707` → IC=+0.273 (n=430)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3707 (IC base=-0.066)

- **PATRÓN** `dist_vwap_pct` > `0.7445` → IC=+0.214 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7445 (IC base=-0.066)

- **PATRÓN** `dist_vwap_pct` < `0.2567` → IC=+0.218 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2567 (IC base=-0.066)

- **PATRÓN** `ballena_activa_n` < `52.0` → IC=+0.227 (n=262)
...
- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.249 (n=217)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.215)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.217 (n=217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0045 (IC base=+0.215)

- **PATRÓN** `drift_60min` |x|≤ `0.4455` → IC=+0.226 (n=217)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4455 (IC base=+0.215)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0918` → IC=+0.235 (n=194)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0918 (IC base=+0.215)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.287 (n=73)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.215)

- **PATRÓN** `ibs_15` < `0.3811` → IC=+0.281 (n=217)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3811 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` > `0.7711` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7711 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.224` → IC=+0.231 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.224 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `4425.7357` → IC=+0.214 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4425.7357 (IC base=+0.215)

- **PATRÓN** `ballena_activa_n` < `161.0` → IC=+0.213 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 161.0 (IC base=+0.215)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `sigma_h` > `0.0104` → IC=-0.247 (n=81)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `drift_15min` |x|> `0.6949` → IC=-0.234 (n=111)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.6949
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=216)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=117)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1209` → IC=+0.156 (n=62)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.78€ cuando `delta_ratio_macro` |x|> 0.1209 (IC base=-0.049)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.182` → IC=+0.200 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.182 (IC base=-0.049)

- **PATRÓN** `ibs_15` < `0.38` → IC=+0.216 (n=93)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.38 (IC base=-0.049)

- **PATRÓN** `dist_vwap_pct` < `0.2307` → IC=+0.182 (n=86)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.2307 (IC base=-0.049)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.155 (n=82)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 42.0 (IC base=-0.049)
...
- **PATRÓN** `T_h` > `145.9915` → IC=+0.420 (n=285)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `T_h` > 145.9915 (IC base=+0.342)

- **PATRÓN** `ratio` > `1.012` → IC=+0.312 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `ratio` > 1.012 (IC base=+0.342)
...
### WEEKLY_PRICE#SOL
- **PATRÓN** `T_h` > `127.3918` → IC=+0.426 (n=336)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1304 sube el IC de +0.032 a +0.177 en UPDOWN_GBM#XRP#15min (n=159). Ya aplicado como kelly_boost=+0.89€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3707 sube el IC de -0.066 a +0.273 en UPDOWN_GBM_15M_TARDIO (n=430). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3811 sube el IC de +0.215 a +0.281 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=217). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_YES, IBS > 0.8182 sube el IC de -0.126 a +0.222 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=16). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.38 sube el IC de -0.049 a +0.216 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=93). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 787 | +0.087 | +42.75€ | 2 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 787 | +0.087 | +42.75€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 19 | +0.068 | +1.20€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 19 | +0.068 | +1.20€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 513 | +0.106 | +34.98€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 513 | +0.106 | +34.98€ | 2 | 10 |
...
| ✅ BALLENAS_TARDIAS | 14584 | -0.111 | -2437.99€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 947 | -0.009 | -141.02€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 
13€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 1640 | +0.016 | -3.13€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 916 | -0.003 | -17.08€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 916 | -0.003 | -17.08€ | 2 | 0 |
| ✅ UPDOWN_GBM | 9371 | +0.009 | +276.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 3312 | +0.038 | +322.64€ | 0 | 11 |
| ✅ UPDOWN_GBM#240min | 402 | +0.007 | +6.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 5018 | -0.007 | -52.67€ | 1 | 0 |
...
| ✅ UPDOWN_GBM#DOGE | 1050 | +0.000 | +0.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 127 | +0.089 | +26.72€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 9 | +0.021 | +0.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 914 | -0.013 | -26.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 2010 | +0.000 | +15.89€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 965 | +0.023 | +37.38€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#SOL | 2715 | +0.005 | +14.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 861 | +0.003 | +8.28€ | 1 | 6 |
...
| ✅ UPDOWN_GBM#XRP | 1495 | +0.015 | +108.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 810 | +0.051 | +137.64€ | 0 | 10 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 5499 | -0.067 | +1207.42€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 5499 | -0.067 | +1207.42€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 507 | +0.158 | +250.99€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 507 | +0.158 | +250.99€ | 2 | 14 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1789 | -0.063 | +348.45€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1789 | -0.063 | +348.45€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1686 | -0.086 | +336.51€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1686 | -0.086 | +336.51€ | 4 | 5 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.090) — sin ventaja clara. oversold(IBS<0.3): IC=+0.027 n=3342 | neutral: IC=+0.002 n=3651 | overbought(IBS>0.7): IC=+0.091 n=3657
  - _Datos_: n=11084 IC=+0.041 PNL=+1152.48€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=861 IC=+0.003 PNL=+8.28€

**🟡 H-WEEKLY** — Predicciones semanales de precio por par
  - _Umbral_: n≥15 por par con IC≥+0.05
  - _Acción_: Si confirma IC≥+0.10 n≥15 en SOL → considerar live semanal
  - _Estado_: ETH: n=454/15 IC=+0.274 PNL=+132.22€ | BTC: n=440/15 IC=+0.224 PNL=+21.91€ | SOL: n=483/15 IC=+0.372 PNL=+447.74€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.067 n=150653 | tras_1loss IC=+0.051 n=118393 | tras_2loss IC=+0.014 n=53156/40 | gap=+0.053 (umbral 0.05)
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 9309 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**🟡 H-WEEKLY-BUYNO** — WEEKLY_PRICE BUY_NO — dirección dominante con IC muy alto
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.335 > 0.1 con n=1165 PNL=+602.78€
  - _Datos_: n=1165 IC=+0.335 PNL=+602.78€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=9094 IC=+0.006 PNL=+222.91€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=9094 IC=+0.006 PNL=+222.91€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=1929 IC=+0.030 PNL=+168.96€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1929 IC=+0.030 PNL=+168.96€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2453 IC=+0.014 PNL=+101.64€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2453 IC=+0.014 PNL=+101.64€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=667 IC=+0.032 PNL=+21.47€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=667 IC=+0.032 PNL=+21.47€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.134 > 0.08 con n=151 PNL=+50.52€
  - _Datos_: n=151 IC=+0.134 PNL=+50.52€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=27075 IC=+0.102 PNL=+8504.23€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=27075 IC=+0.102 PNL=+8504.23€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=1267 IC=+0.030 PNL=+75.34€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1267 IC=+0.030 PNL=+75.34€
...
**🟡 H-CUSTOM-WEEKLY-PCTDIST-BUYNO** — WEEKLY_PRICE BUY_NO con pct_dist alto — cuanto más lejos del rango, más seguro
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.443 > 0.1 con n=717 PNL=+630.65€
  - _Datos_: n=717 IC=+0.443 PNL=+630.65€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=2245 IC=+0.029 PNL=+182.82€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2245 IC=+0.029 PNL=+182.82€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=635 IC=+0.032 PNL=+68.71€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=635 IC=+0.032 PNL=+68.71€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=7508 IC=-0.142 PNL=+366.56€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=7508 IC=-0.142 PNL=+366.56€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=915 IC=+0.139 PNL=+462.68€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=915 IC=+0.139 PNL=+462.68€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.237 < -0.1 con n=831 PNL=-105.13€
  - _Datos_: n=831 IC=-0.237 PNL=-105.13€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=2125 IC=+0.138 PNL=+1225.39€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=2125 IC=+0.138 PNL=+1225.39€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.184 > 0.08 con n=826 PNL=+532.09€
  - _Datos_: n=826 IC=+0.184 PNL=+532.09€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.105 n=287) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=287 IC=+0.105 PNL=+75.59€
...
**🔶 H-CUSTOM-WEEKLY-SOL-BUYNO-PRECIO-ALTO** — WEEKLY_PRICE SOL BUY_NO -- edge fuerte concentrado en precio alto (py>=0.45), posible pero sin fill-ability medida
  ...
  - _Estado_: SEÑAL POSITIVA en SOL (IC=+0.422 n=282) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=282 IC=+0.422 PNL=+388.41€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=4437 IC=+0.147 PNL=-708.12€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=4437 IC=+0.147 PNL=-708.12€
