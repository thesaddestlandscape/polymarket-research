# Hipótesis automáticas — 2026-07-03 16:17 UTC
_Generado por shadow_postmortem.py sobre 3139 resoluciones (PNL=-38.80€)_
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.146 (n=46)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 15.0 (IC base=+0.036)

- **PATRÓN** `ibs_15` < `0.0669` → IC=+0.161 (n=60)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` < 0.0669 (IC base=+0.036)
...
- **PATRÓN** `sigma_h` < `0.0136` → IC=+0.152 (n=21)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0136 (IC base=+0.095)

- **PATRÓN** `drift_15min` |x|≤ `0.7351` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `drift_15min` |x|≤ 0.7351 (IC base=+0.095)

## Estrategias nuevas sugeridas
_Derivadas de los patrones aprendidos:_

- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0669 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.161 n=60). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 451 | +0.048 | +53.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 451 | +0.048 | +53.47€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 116 | +0.009 | +2.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 116 | +0.009 | +2.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 117 | -0.021 | -0.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 117 | -0.021 | -0.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 112 | +0.105 | +28.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 112 | +0.105 | +28.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 106 | +0.102 | +23.53€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 106 | +0.102 | +23.53€ | 0 | 0 |
...
| ✅ ORDER_FLOW_5M | 1526 | +0.013 | +11.71€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1390 | +0.009 | -0.88€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BNB#5min | 191 | +0.049 | +7.28€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC | 262 | -0.023 | -8.16€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#BTC#5min | 262 | -0.023 | -8.16€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 871 | -0.042 | -50.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 640 | -0.020 | -22.01€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#XRP | 74 | -0.013 | +2.15€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 63 | +0.023 | +5.44€ | 4 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Datos_: n=481 IC=-0.042 PNL=-25.13€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.200 n=28 PNL=-13.74€ → FILTRAR | H=02h: IC=-0.180 n=23 PNL=-6.09€ → FILTRAR | H=03h: IC=-0.110 n=15 PNL=-5.87€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.154 n=24 PNL=+5.70€ → BOOST | H=20h: IC=-0.143 n=26 PNL=-5.82€ → FILTRAR | H=23h: IC=+0.158 n=19 PNL=+11.81€ → BOOST

**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  - _Umbral_: n≥200 por par con delta_ratio feature en shadow
  - _Acción_: Añadir DELTA_MIN/MAX por par dict en shadow_predict.py
  - _Estado_: BTC: 158 ops con delta_ratio | SOL: 198 ops con delta_ratio
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.010 n=1503 | tras_1loss IC=-0.030 n=1542 | tras_2loss IC=-0.046 n=797/40 | gap=+0.055 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=26, boost estimado=+0.014. Necesita 0 más y boost>0.05
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.052 n=132/40 PNL=-4.05€ | H=15h UTC: IC=-0.004 n=135/40 PNL=-0.84€ | H=17h UTC: IC=+0.200 n=58/40 PNL=+21.47€ | H=19h UTC: IC=-0.013 n=72/40 PNL=-9.58€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=748 IC=-0.037 PNL=-36.81€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=748 IC=-0.037 PNL=-36.81€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=228 IC=+0.013 PNL=+14.41€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=228 IC=+0.013 PNL=+14.41€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=706 IC=+0.028 PNL=+46.76€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=706 IC=+0.028 PNL=+46.76€
...
**⏳ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: 40/50 ops en el filtro definido (IC actual=+0.095 PNL=+7.52€)
  - _Datos_: n=40 IC=+0.095 PNL=+7.52€
