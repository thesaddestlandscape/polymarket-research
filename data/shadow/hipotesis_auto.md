# Hipótesis automáticas — 2026-07-02 00:26 UTC
_Generado por shadow_postmortem.py sobre 2489 resoluciones (PNL=-74.55€)_
...
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.259 (n=52)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.101)

- **PATRÓN** `drift_60min` |x|≤ `0.438` → IC=+0.138 (n=45)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.438 (IC base=+0.101)

- **PATRÓN** `drift_15min` |x|≤ `0.4139` → IC=+0.139 (n=34)

  - _Acción_: Kelly boost +0.69€ cuando `drift_15min` |x|≤ 0.4139 (IC base=+0.101)
...
- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.250 (n=30)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0613 (IC base=+0.101)
...
| ✅ UPDOWN_GBM | 739 | -0.032 | -23.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 521 | -0.005 | +2.54€ | 1 | 5 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 115 | -0.056 | -9.93€ | 5 | 0 |
| ✅ UPDOWN_GBM#BNB | 15 | -0.066 | -0.86€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 15 | -0.066 | -0.86€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.108) — sin ventaja clara. oversold(IBS<0.3): IC=+0.032 n=109 | neutral: IC=-0.077 n=102 | overbought(IBS>0.7): IC=-0.027 n=129
  - _Datos_: n=349 IC=-0.021 PNL=+1.82€
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.001 n=1172 | tras_1loss IC=-0.034 n=1235 | tras_2loss IC=-0.048 n=642/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=616 IC=-0.024 PNL=-9.87€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=616 IC=-0.024 PNL=-9.87€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=138 IC=+0.071 PNL=+30.40€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=138 IC=+0.071 PNL=+30.40€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 72/200 ops en el filtro definido (IC actual=+0.095 PNL=+18.38€)
  - _Datos_: n=72 IC=+0.095 PNL=+18.38€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 72/100 ops en el filtro definido (IC actual=+0.095 PNL=+18.38€)
  - _Datos_: n=72 IC=+0.095 PNL=+18.38€
