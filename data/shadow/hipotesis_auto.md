# Hipótesis automáticas — 2026-07-12 12:03 UTC
_Generado por shadow_postmortem.py sobre 10875 resoluciones (PNL=+1892.35€)_
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.324 (n=146)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `2363.0481` → IC=+0.234 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2363.0481 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=121)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.198 (n=250)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 12.0 (IC base=+0.159)

- **PATRÓN** `py_entrada` < `0.275` → IC=+0.331 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=383)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `5897.7268` → IC=+0.184 (n=153)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 5897.7268 (IC base=+0.159)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.245 (n=49)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.194)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.206 (n=66)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.194)

- **PATRÓN** `py_entrada` > `0.605` → IC=+0.233 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.605 (IC base=+0.194)

- **PATRÓN** `libro_liquidez` > `8874.3159` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 8874.3159 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.258 (n=64)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.231)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.246 (n=61)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.231)

- **PATRÓN** `py_entrada` < `0.225` → IC=+0.380 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.225 (IC base=+0.231)

- **PATRÓN** `libro_liquidez` > `6497.9556` → IC=+0.261 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 6497.9556 (IC base=+0.231)

### FAVORITO_CONFIRMADO#ETH#15min
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.303 (n=64)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.255)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.257 (n=72)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.255)

- **PATRÓN** `py_entrada` > `0.765` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.765 (IC base=+0.255)

- **PATRÓN** `libro_liquidez` > `3061.4104` → IC=+0.289 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3061.4104 (IC base=+0.255)
...
- **PATRÓN** `py_entrada` > `0.705` → IC=+0.412 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.705 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `1873.3412` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1873.3412 (IC base=+0.223)
...
- **PATRÓN** `py_entrada` < `0.245` → IC=+0.315 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `1648.9469` → IC=+0.238 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1648.9469 (IC base=+0.208)
...
### GBM_LATE_15M
- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.139 (n=436)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0151 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=1322)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 6.0 (IC base=+0.115)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.120 (n=877)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` < 11.0 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.1365` → IC=+0.202 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1365 (IC base=+0.115)

- **PATRÓN** `sigma_h` > `0.0121` → IC=+0.161 (n=623)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.505` → IC=+0.178 (n=119)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.505 (IC base=+0.110)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `dist_vwap_pct` < `0.1111` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1111 (IC base=+0.084)

### GBM_LATE_15M#ETH#15min
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.143 (n=110)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0045 (IC base=+0.090)

- **PATRÓN** `dist_vwap_pct` > `0.4454` → IC=+0.132 (n=17)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.4454 (IC base=+0.090)

### GBM_LATE_15M#SOL#15min
- **PATRÓN** `sigma_h` < `0.0162` → IC=+0.138 (n=354)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0162 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.163 (n=161)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 16.0 (IC base=+0.122)
...
- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.167 (n=151)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0102 (IC base=+0.154)
...
- **PATRÓN** `dist_vwap_pct` < `0.0879` → IC=+0.262 (n=19)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0879 (IC base=+0.154)

### GBM_LATE_15M#XRP#15min
- **PATRÓN** `sigma_h` < `0.032` → IC=+0.180 (n=301)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.032 (IC base=+0.165)

- **PATRÓN** `sigma_h` > `0.0142` → IC=+0.179 (n=269)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0142 (IC base=+0.165)
...
- **PATRÓN** `dist_vwap_pct` < `0.1277` → IC=+0.278 (n=16)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1277 (IC base=+0.165)
...
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.185 (n=309)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.3729` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.3729 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.1193` → IC=+0.200 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1193 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.173 (n=353)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.2032` → IC=+0.268 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2032 (IC base=+0.152)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.211 (n=88)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0029 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.181 (n=92)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 7.0 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.163 (n=99)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.159)

- **PATRÓN** `dist_vwap_pct` < `0.1221` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1221 (IC base=+0.159)
...
- **PATRÓN** `sigma_h` < `0.0033` → IC=+0.167 (n=34)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0033 (IC base=+0.142)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.188 (n=46)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0067 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.162 (n=69)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.557` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.557 (IC base=+0.142)
...
- **PATRÓN** `sigma_h` < `0.008` → IC=+0.250 (n=38)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.008 (IC base=+0.103)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.174 (n=41)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` < 5.0 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` < `0.1136` → IC=+0.274 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1136 (IC base=+0.103)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.0214` → IC=+0.315 (n=63)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0214 (IC base=+0.265)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.308 (n=45)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
### GBM_LATE_15M_TARDIO
- **FILTRO** `sigma_ewma_delta_pct` < `8.976` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` < 8.976
  - _Potencial_: sin este filtro IC_bueno=+0.346 (n=11)

- **PATRÓN** `sigma_h` > `0.0135` → IC=+0.127 (n=140)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` > 0.0135 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` < `0.1095` → IC=+0.138 (n=67)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1095 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.79` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.79 (IC base=+0.075)

- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.152 (n=136)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0127 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` < `0.1536` → IC=+0.188 (n=75)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` < 0.1536 (IC base=+0.084)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` > `0.003` → IC=+0.122 (n=96)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` > 0.003 (IC base=+0.081)
...
- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.203 (n=35)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0083 (IC base=+0.039)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.143 (n=40)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 6.0 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` < `0.1589` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1589 (IC base=+0.039)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.237 (n=17)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 10.0 (IC base=+0.214)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.495 (IC base=+0.214)
...
- **PATRÓN** `libro_liquidez` > `2668.5634` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2668.5634 (IC base=+0.062)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=340)

- **PATRÓN** `ibs_15` > `0.7177` → IC=+0.151 (n=213)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` > 0.7177 (IC base=+0.017)

- **PATRÓN** `dist_vwap_pct` > `0.1647` → IC=+0.214 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1647 (IC base=+0.017)

- **PATRÓN** `dist_vwap_pct` < `0.3809` → IC=+0.183 (n=99)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.3809 (IC base=+0.017)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2361` → IC=+0.122 (n=133)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.2361 (IC base=+0.056)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.167 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 11.0 (IC base=+0.056)

- **PATRÓN** `ibs_15` < `0.9136` → IC=+0.149 (n=112)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.75€ cuando `ibs_15` < 0.9136 (IC base=+0.056)

- **PATRÓN** `ibs_15` > `0.6428` → IC=+0.167 (n=112)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` > 0.6428 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` > `0.2179` → IC=+0.333 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2179 (IC base=+0.056)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7177 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.151 n=213). Confirma señal de reversión media → alinear con BUY_NO.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6428 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.167 n=112). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 876 | +0.189 | +23.20€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 561 | +0.216 | +14.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 37 | +0.064 | +1.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 131 | +0.086 | -10.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 147 | +0.205 | +18.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 258 | +0.196 | +4.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 187 | +0.214 | -3.04€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 310 | +0.176 | +8.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 186 | +0.213 | +6.40€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.043 | -1.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 63 | +0.100 | -4.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 49 | +0.186 | +7.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL | 306 | +0.195 | +10.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 186 | +0.218 | +11.12€ | 0 | 8 |
...
| ✅ GBM_LATE_15M | 3568 | +0.112 | +1147.06€ | 0 | 7 |
| ✅ GBM_LATE_15M#15min | 3568 | +0.112 | +1147.06€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 879 | +0.069 | +105.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 879 | +0.069 | +105.14€ | 0 | 1 |
| ✅ GBM_LATE_15M#ETH | 905 | +0.071 | +133.80€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 905 | +0.071 | +133.80€ | 0 | 2 |
| ✅ GBM_LATE_15M#SOL | 928 | +0.138 | +453.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 928 | +0.138 | +453.07€ | 0 | 8 |
| ✅ GBM_LATE_15M#XRP | 856 | +0.172 | +455.05€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 856 | +0.172 | +455.05€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 930 | +0.160 | +466.40€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 930 | +0.160 | +466.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 244 | +0.167 | +152.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 244 | +0.167 | +152.20€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 251 | +0.121 | +78.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 251 | +0.121 | +78.64€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 261 | +0.112 | +63.89€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 261 | +0.112 | +63.89€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 174 | +0.273 | +171.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 174 | +0.273 | +171.66€ | 0 | 5 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1103 | +0.079 | +246.41€ | 1 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1103 | +0.079 | +246.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 255 | +0.076 | +28.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 255 | +0.076 | +28.34€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 276 | +0.000 | +1.81€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 276 | +0.000 | +1.81€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 286 | +0.035 | +24.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 286 | +0.035 | +24.74€ | 0 | 3 |
...
| ✅ LEADLAG_BTC_XRP_15M | 65 | +0.127 | +20.54€ | 0 | 2 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 65 | +0.127 | +20.54€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 65 | +0.127 | +20.54€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 65 | +0.127 | +20.54€ | 0 | 2 |
...
| ✅ STREAK_FADE_5M | 158 | -0.050 | -12.25€ | 4 | 0 |
| ✅ STREAK_FADE_5M#5min | 158 | -0.050 | -12.25€ | 0 | 0 |
...
| ✅ STREAK_FADE_5M#XRP | 55 | +0.009 | -1.35€ | 0 | 0 |
| ✅ STREAK_FADE_5M#XRP#5min | 55 | +0.009 | -1.35€ | 0 | 1 |
...
| ✅ UPDOWN_GBM | 1316 | -0.007 | +21.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1060 | +0.023 | +59.03€ | 1 | 4 |
...
| ✅ UPDOWN_GBM#BTC | 353 | +0.010 | +3.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 274 | +0.051 | +16.60€ | 1 | 8 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.121) — sin ventaja clara. oversold(IBS<0.3): IC=-0.021 n=340 | neutral: IC=-0.048 n=257 | overbought(IBS>0.7): IC=+0.072 n=288
  - _Datos_: n=926 IC=+0.007 PNL=+46.80€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6127 | tras_1loss IC=+0.044 n=4611 | tras_2loss IC=+0.010 n=2074/40 | gap=+0.080 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.120 n=69/60 | contraria IC=+0.045 n=20 | gap=+0.074 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1189 IC=-0.000 PNL=+35.57€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1189 IC=-0.000 PNL=+35.57€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=601 IC=+0.017 PNL=+23.48€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=601 IC=+0.017 PNL=+23.48€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=274 IC=+0.051 PNL=+16.60€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=274 IC=+0.051 PNL=+16.60€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=544 IC=+0.051 PNL=+40.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=544 IC=+0.051 PNL=+40.35€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.238 > 0.08 con n=59 PNL=+14.43€
  - _Datos_: n=59 IC=+0.238 PNL=+14.43€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=49 IC=+0.069 PNL=+28.53€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=49 IC=+0.069 PNL=+28.53€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8417 IC=+0.096 PNL=+1968.23€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8417 IC=+0.096 PNL=+1968.23€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=118 IC=+0.000 PNL=-0.31€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=118 IC=+0.000 PNL=-0.31€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=748 IC=-0.016 PNL=-6.99€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=748 IC=-0.016 PNL=-6.99€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.175 > 0.1 con n=263 PNL=+96.67€
  - _Datos_: n=263 IC=+0.175 PNL=+96.67€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.178 > 0.08 con n=197 PNL=+69.72€
  - _Datos_: n=197 IC=+0.178 PNL=+69.72€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.238 n=82) pero sin cruzar ≥2 pares más — ETH: n=103 IC=+0.148 ✓; SOL: n=7 IC=-0.019; XRP: n=5 IC=+0.018
  - _Datos_: n=82 IC=+0.238 PNL=+32.97€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.159 < -0.1 con n=309 PNL=-46.59€
  - _Datos_: n=309 IC=-0.159 PNL=-46.59€
...
**⏳ H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 5/40 ops en el filtro definido (IC actual=+0.018 PNL=+0.89€)
  - _Datos_: n=5 IC=+0.018 PNL=+0.89€
...
**⏳ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: 10/40 ops en el filtro definido (IC actual=+0.042 PNL=+3.40€)
  - _Datos_: n=10 IC=+0.042 PNL=+3.40€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.336 > 0.08 con n=65 PNL=+10.56€
  - _Datos_: n=65 IC=+0.336 PNL=+10.56€
...
**⏳ H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: 33/40 ops en el filtro definido (IC actual=+0.214 PNL=+20.16€)
  - _Datos_: n=33 IC=+0.214 PNL=+20.16€
